var ut=Object.defineProperty;var ht=(e,t,n)=>t in e?ut(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var S=(e,t,n)=>ht(e,typeof t!="symbol"?t+"":t,n);import{_ as vt}from"./assets/preload-helper-CTOgD26E.js";class st{constructor(){S(this,"registryByUrl",new Map);S(this,"registryById",new Map)}clear(){this.registryByUrl.clear(),this.registryById.clear()}keys(){return this.registryByUrl.keys()}add(t){this.registryByUrl.set(t.url,t),this.registryById.set(t.id,t)}register(t,n,r,a,i){const l=typeof t=="object"?t.type:t;if(typeof t=="object"){const o=t;if(o instanceof O||o instanceof A||o instanceof F||o instanceof $)throw new TypeError(`[vitest] Cannot register a mock that is already defined. Expected a JSON representation from \`MockedModule.toJSON\`, instead got "${o.type}". Use "registry.add()" to update a mock instead.`);if(o.type==="automock"){const c=O.fromJSON(o);return this.add(c),c}else if(o.type==="autospy"){const c=A.fromJSON(o);return this.add(c),c}else if(o.type==="redirect"){const c=$.fromJSON(o);return this.add(c),c}else throw o.type==="manual"?new Error("Cannot set serialized manual mock. Define a factory function manually with `ManualMockedModule.fromJSON()`."):new Error(`Unknown mock type: ${o.type}`)}if(typeof n!="string")throw new TypeError("[vitest] Mocks require a raw string.");if(typeof a!="string")throw new TypeError("[vitest] Mocks require a url string.");if(typeof r!="string")throw new TypeError("[vitest] Mocks require an id string.");if(l==="manual"){if(typeof i!="function")throw new TypeError("[vitest] Manual mocks require a factory function.");const o=new F(n,r,a,i);return this.add(o),o}else if(l==="automock"||l==="autospy"){const o=l==="automock"?new O(n,r,a):new A(n,r,a);return this.add(o),o}else if(l==="redirect"){if(typeof i!="string")throw new TypeError("[vitest] Redirect mocks require a redirect string.");const o=new $(n,r,a,i);return this.add(o),o}else throw new Error(`[vitest] Unknown mock type: ${l}`)}delete(t){this.registryByUrl.delete(t)}get(t){return this.registryByUrl.get(t)}getById(t){return this.registryById.get(t)}has(t){return this.registryByUrl.has(t)}}class O{constructor(t,n,r){S(this,"type","automock");this.raw=t,this.id=n,this.url=r}static fromJSON(t){return new A(t.raw,t.id,t.url)}toJSON(){return{type:this.type,url:this.url,raw:this.raw,id:this.id}}}class A{constructor(t,n,r){S(this,"type","autospy");this.raw=t,this.id=n,this.url=r}static fromJSON(t){return new A(t.raw,t.id,t.url)}toJSON(){return{type:this.type,url:this.url,id:this.id,raw:this.raw}}}class ${constructor(t,n,r,a){S(this,"type","redirect");this.raw=t,this.id=n,this.url=r,this.redirect=a}static fromJSON(t){return new $(t.raw,t.id,t.url,t.redirect)}toJSON(){return{type:this.type,url:this.url,raw:this.raw,id:this.id,redirect:this.redirect}}}class F{constructor(t,n,r,a){S(this,"cache");S(this,"type","manual");this.raw=t,this.id=n,this.url=r,this.factory=a}async resolve(){if(this.cache)return this.cache;let t;try{t=await this.factory()}catch(n){const r=new Error('[vitest] There was an error when mocking a module. If you are using "vi.mock" factory, make sure there are no top level variables inside, since this call is hoisted to top of the file. Read more: https://vitest.dev/api/vi.html#vi-mock');throw r.cause=n,r}if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError(`[vitest] vi.mock("${this.raw}", factory?: () => unknown) is not returning an object. Did you mean to return an object with a "default" key?`);return this.cache=t}static fromJSON(t,n){return new F(t.raw,t.id,t.url,n)}toJSON(){return{type:this.type,url:this.url,id:this.id,raw:this.raw}}}function bt(e,t,n={}){const r=new Array,a=new xt,i=(c,w,f)=>{try{return c[w]=f,!0}catch{return!1}},l=(c,w)=>{const f=H(c),h=f==="Module"||!!c.__esModule;for(const{key:b,descriptor:z}of Y(c,h,e.globalConstructors)){if(!h&&z.get){try{Object.defineProperty(w,b,z)}catch{}continue}if(kt(b,f))continue;const u=c[b],s=a.getId(u);if(s!==void 0){r.push(()=>i(w,b,a.getMockedValue(s)));continue}const d=H(u);if(Array.isArray(u)){i(w,b,[]);continue}const C=d.includes("Function")&&typeof u=="function";if((!C||u._isMockFunction)&&d!=="Object"&&d!=="Module"){i(w,b,u);continue}if(i(w,b,C?u:{})){if(C){let y=function(){if(this instanceof w[b])for(const{key:q,descriptor:T}of Y(this,!1,e.globalConstructors)){if(T.get)continue;const L=this[q];if(H(L).includes("Function")&&typeof L=="function"){const B=this[q],p=P(this,q).mockImplementation(B),E=p.mockReset;p.mockRestore=p.mockReset=()=>(E.call(p),p.mockImplementation(B),p)}}};if(!e.spyOn)throw new Error("[@vitest/mocker] `spyOn` is not defined. This is a Vitest error. Please open a new issue with reproduction.");const P=e.spyOn,M=P(w,b);if(e.type==="automock"){M.mockImplementation(y);const q=M.mockReset;M.mockRestore=M.mockReset=()=>(q.call(M),M.mockImplementation(y),M)}Object.defineProperty(w[b],"length",{value:0})}a.track(u,w[b]),l(u,w[b])}}},o=n;l(t,o);for(const c of r)c();return o}class xt{constructor(){S(this,"idMap",new Map);S(this,"mockedValueMap",new Map)}getId(t){return this.idMap.get(t)}getMockedValue(t){return this.mockedValueMap.get(t)}track(t,n){const r=this.idMap.size;return this.idMap.set(t,r),this.mockedValueMap.set(r,n),r}}function H(e){return Object.prototype.toString.apply(e).slice(8,-1)}function kt(e,t){return t.includes("Function")&&typeof e=="string"&&["arguments","callee","caller","length","name"].includes(e)}function Y(e,t,n){const{Map:r,Object:a,Function:i,RegExp:l,Array:o}=n,c=new r;let w=e;do{if(w===a.prototype||w===i.prototype||w===l.prototype)break;yt(w,f=>{const h=a.getOwnPropertyDescriptor(w,f);h&&c.set(f,{key:f,descriptor:h})})}while(w=a.getPrototypeOf(w));if(t&&!c.has("default")&&"default"in e){const f=a.getOwnPropertyDescriptor(e,"default");f&&c.set("default",{key:"default",descriptor:f})}return o.from(c.values())}function yt(e,t){const n=typeof t=="function"?t:r=>t.add(r);Object.getOwnPropertyNames(e).forEach(n),Object.getOwnPropertySymbols(e).forEach(n)}const _t=/^[A-Za-z]:\//;function lt(e=""){return e&&e.replace(/\\/g,"/").replace(_t,t=>t.toUpperCase())}const zt=/^[/\\]{2}/,qt=/^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/,St=/^[A-Za-z]:$/,Ct=/.(\.[^./]+|\.)$/,It=function(e){if(e.length===0)return".";e=lt(e);const t=e.match(zt),n=K(e),r=e[e.length-1]==="/";return e=Mt(e,!n),e.length===0?n?"/":r?"./":".":(r&&(e+="/"),St.test(e)&&(e+="/"),t?n?`//${e}`:`//./${e}`:n&&!K(e)?`/${e}`:e)},Et=function(...e){let t="";for(const n of e)if(n)if(t.length>0){const r=t[t.length-1]==="/",a=n[0]==="/";r&&a?t+=n.slice(1):t+=r||a?n:`/${n}`}else t+=n;return It(t)};function Mt(e,t){let n="",r=0,a=-1,i=0,l=null;for(let o=0;o<=e.length;++o){if(o<e.length)l=e[o];else{if(l==="/")break;l="/"}if(l==="/"){if(!(a===o-1||i===1))if(i===2){if(n.length<2||r!==2||n[n.length-1]!=="."||n[n.length-2]!=="."){if(n.length>2){const c=n.lastIndexOf("/");c===-1?(n="",r=0):(n=n.slice(0,c),r=n.length-1-n.lastIndexOf("/")),a=o,i=0;continue}else if(n.length>0){n="",r=0,a=o,i=0;continue}}t&&(n+=n.length>0?"/..":"..",r=2)}else n.length>0?n+=`/${e.slice(a+1,o)}`:n=e.slice(a+1,o),r=o-a-1;a=o,i=0}else l==="."&&i!==-1?++i:i=-1}return n}const K=function(e){return qt.test(e)},Pt=function(e){if(e==="..")return"";const t=Ct.exec(lt(e));return t&&t[1]||""};var Tt={reset:[0,0],bold:[1,22,"\x1B[22m\x1B[1m"],dim:[2,22,"\x1B[22m\x1B[2m"],italic:[3,23],underline:[4,24],inverse:[7,27],hidden:[8,28],strikethrough:[9,29],black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],gray:[90,39],bgBlack:[40,49],bgRed:[41,49],bgGreen:[42,49],bgYellow:[43,49],bgBlue:[44,49],bgMagenta:[45,49],bgCyan:[46,49],bgWhite:[47,49],blackBright:[90,39],redBright:[91,39],greenBright:[92,39],yellowBright:[93,39],blueBright:[94,39],magentaBright:[95,39],cyanBright:[96,39],whiteBright:[97,39],bgBlackBright:[100,49],bgRedBright:[101,49],bgGreenBright:[102,49],bgYellowBright:[103,49],bgBlueBright:[104,49],bgMagentaBright:[105,49],bgCyanBright:[106,49],bgWhiteBright:[107,49]},Nt=Object.entries(Tt);function Z(e){return String(e)}Z.open="";Z.close="";function At(e=!1){let t=typeof process<"u"?process:void 0,n=(t==null?void 0:t.env)||{},r=(t==null?void 0:t.argv)||[];return!("NO_COLOR"in n||r.includes("--no-color"))&&("FORCE_COLOR"in n||r.includes("--color")||(t==null?void 0:t.platform)==="win32"||e&&n.TERM!=="dumb"||"CI"in n)||typeof window<"u"&&!!window.chrome}function $t(e=!1){let t=At(e),n=(l,o,c,w)=>{let f="",h=0;do f+=l.substring(h,w)+c,h=w+o.length,w=l.indexOf(o,h);while(~w);return f+l.substring(h)},r=(l,o,c=l)=>{let w=f=>{let h=String(f),b=h.indexOf(o,l.length);return~b?l+n(h,o,c,b)+o:l+h+o};return w.open=l,w.close=o,w},a={isColorSupported:t},i=l=>`\x1B[${l}m`;for(let[l,o]of Nt)a[l]=t?r(i(o[0]),i(o[1]),o[2]):Z;return a}$t();function ct(e,t){return t.forEach(function(n){n&&typeof n!="string"&&!Array.isArray(n)&&Object.keys(n).forEach(function(r){if(r!=="default"&&!(r in e)){var a=Object.getOwnPropertyDescriptor(n,r);Object.defineProperty(e,r,a.get?a:{enumerable:!0,get:function(){return n[r]}})}})}),Object.freeze(e)}function dt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var D={exports:{}},x={};/**
* @license React
...
*/var G;function Lt(){if(G)return x;G=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),i=Symbol.for("react.consumer"),l=Symbol.for("react.context"),o=Symbol.for("react.forward_ref"),c=Symbol.for("react.suspense"),w=Symbol.for("react.suspense_list"),f=Symbol.for("react.memo"),h=Symbol.for("react.lazy"),b=Symbol.for("react.view_transition"),z=Symbol.for("react.client.reference");function u(s){if(typeof s=="object"&&s!==null){var d=s.$$typeof;switch(d){case e:switch(s=s.type,s){case n:case a:case r:case c:case w:case b:return s;default:switch(s=s&&s.$$typeof,s){case l:case o:case h:case f:return s;case i:return s;default:return d}}case t:return d}}}return x.ContextConsumer=i,x.ContextProvider=l,x.Element=e,x.ForwardRef=o,x.Fragment=n,x.Lazy=h,x.Memo=f,x.Portal=t,x.Profiler=a,x.StrictMode=r,x.Suspense=c,x.SuspenseList=w,x.isContextConsumer=function(s){return u(s)===i},x.isContextProvider=function(s){return u(s)===l},x.isElement=function(s){return typeof s=="object"&&s!==null&&s.$$typeof===e},x.isForwardRef=function(s){return u(s)===o},x.isFragment=function(s){return u(s)===n},x.isLazy=function(s){return u(s)===h},x.isMemo=function(s){return u(s)===f},x.isPortal=function(s){return u(s)===t},x.isProfiler=function(s){return u(s)===a},x.isStrictMode=function(s){return u(s)===r},x.isSuspense=function(s){return u(s)===c},x.isSuspenseList=function(s){return u(s)===w},x.isValidElementType=function(s){return typeof s=="string"||typeof s=="function"||s===n||s===a||s===r||s===c||s===w||typeof s=="object"&&s!==null&&(s.$$typeof===h||s.$$typeof===f||s.$$typeof===l||s.$$typeof===i||s.$$typeof===o||s.$$typeof===z||s.getModuleId!==void 0)},x.typeOf=u,x}var Q;function Bt(){return Q||(Q=1,D.exports=Lt()),D.exports}var pt=Bt(),Rt=dt(pt),Vt=ct({__proto__:null,default:Rt},[pt]),j={exports:{}},v={};/**
* @license React
