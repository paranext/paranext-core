var ut=Object.defineProperty;var ht=(n,t,e)=>t in n?ut(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var S=(n,t,e)=>ht(n,typeof t!="symbol"?t+"":t,e);import{_ as vt}from"./assets/preload-helper-CTOgD26E.js";class st{constructor(){S(this,"registryByUrl",new Map);S(this,"registryById",new Map)}clear(){this.registryByUrl.clear(),this.registryById.clear()}keys(){return this.registryByUrl.keys()}add(t){this.registryByUrl.set(t.url,t),this.registryById.set(t.id,t)}register(t,e,r,a,i){const l=typeof t=="object"?t.type:t;if(typeof t=="object"){const o=t;if(o instanceof O||o instanceof N||o instanceof $||o instanceof A)throw new TypeError(`[vitest] Cannot register a mock that is already defined. Expected a JSON representation from \`MockedModule.toJSON\`, instead got "${o.type}". Use "registry.add()" to update a mock instead.`);if(o.type==="automock"){const c=O.fromJSON(o);return this.add(c),c}else if(o.type==="autospy"){const c=N.fromJSON(o);return this.add(c),c}else if(o.type==="redirect"){const c=A.fromJSON(o);return this.add(c),c}else throw o.type==="manual"?new Error("Cannot set serialized manual mock. Define a factory function manually with `ManualMockedModule.fromJSON()`."):new Error(`Unknown mock type: ${o.type}`)}if(typeof e!="string")throw new TypeError("[vitest] Mocks require a raw string.");if(typeof a!="string")throw new TypeError("[vitest] Mocks require a url string.");if(typeof r!="string")throw new TypeError("[vitest] Mocks require an id string.");if(l==="manual"){if(typeof i!="function")throw new TypeError("[vitest] Manual mocks require a factory function.");const o=new $(e,r,a,i);return this.add(o),o}else if(l==="automock"||l==="autospy"){const o=l==="automock"?new O(e,r,a):new N(e,r,a);return this.add(o),o}else if(l==="redirect"){if(typeof i!="string")throw new TypeError("[vitest] Redirect mocks require a redirect string.");const o=new A(e,r,a,i);return this.add(o),o}else throw new Error(`[vitest] Unknown mock type: ${l}`)}delete(t){this.registryByUrl.delete(t)}get(t){return this.registryByUrl.get(t)}getById(t){return this.registryById.get(t)}has(t){return this.registryByUrl.has(t)}}class O{constructor(t,e,r){S(this,"type","automock");this.raw=t,this.id=e,this.url=r}static fromJSON(t){return new N(t.raw,t.id,t.url)}toJSON(){return{type:this.type,url:this.url,raw:this.raw,id:this.id}}}class N{constructor(t,e,r){S(this,"type","autospy");this.raw=t,this.id=e,this.url=r}static fromJSON(t){return new N(t.raw,t.id,t.url)}toJSON(){return{type:this.type,url:this.url,id:this.id,raw:this.raw}}}class A{constructor(t,e,r,a){S(this,"type","redirect");this.raw=t,this.id=e,this.url=r,this.redirect=a}static fromJSON(t){return new A(t.raw,t.id,t.url,t.redirect)}toJSON(){return{type:this.type,url:this.url,raw:this.raw,id:this.id,redirect:this.redirect}}}class ${constructor(t,e,r,a){S(this,"cache");S(this,"type","manual");this.raw=t,this.id=e,this.url=r,this.factory=a}async resolve(){if(this.cache)return this.cache;let t;try{t=await this.factory()}catch(e){const r=new Error('[vitest] There was an error when mocking a module. If you are using "vi.mock" factory, make sure there are no top level variables inside, since this call is hoisted to top of the file. Read more: https://vitest.dev/api/vi.html#vi-mock');throw r.cause=e,r}if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError(`[vitest] vi.mock("${this.raw}", factory?: () => unknown) is not returning an object. Did you mean to return an object with a "default" key?`);return this.cache=t}static fromJSON(t,e){return new $(t.raw,t.id,t.url,e)}toJSON(){return{type:this.type,url:this.url,id:this.id,raw:this.raw}}}function bt(n,t,e={}){const r=new Array,a=new xt,i=(c,f,g)=>{try{return c[f]=g,!0}catch{return!1}},l=(c,f)=>{const g=j(c),h=g==="Module"||!!c.__esModule;for(const{key:b,descriptor:z}of Y(c,h,n.globalConstructors)){if(!h&&z.get){try{Object.defineProperty(f,b,z)}catch{}continue}if(kt(b,g))continue;const u=c[b],s=a.getId(u);if(s!==void 0){r.push(()=>i(f,b,a.getMockedValue(s)));continue}const d=j(u);if(Array.isArray(u)){i(f,b,[]);continue}const C=d.includes("Function")&&typeof u=="function";if((!C||u._isMockFunction)&&d!=="Object"&&d!=="Module"){i(f,b,u);continue}if(i(f,b,C?u:{})){if(C){let y=function(){if(this instanceof f[b])for(const{key:U,descriptor:E}of Y(this,!1,n.globalConstructors)){if(E.get)continue;const L=this[U];if(j(L).includes("Function")&&typeof L=="function"){const B=this[U],p=I(this,U).mockImplementation(B),q=p.mockReset;p.mockRestore=p.mockReset=()=>(q.call(p),p.mockImplementation(B),p)}}};if(!n.spyOn)throw new Error("[@vitest/mocker] `spyOn` is not defined. This is a Vitest error. Please open a new issue with reproduction.");const I=n.spyOn,F=I(f,b);if(n.type==="automock"){F.mockImplementation(y);const U=F.mockReset;F.mockRestore=F.mockReset=()=>(U.call(F),F.mockImplementation(y),F)}Object.defineProperty(f[b],"length",{value:0})}a.track(u,f[b]),l(u,f[b])}}},o=e;l(t,o);for(const c of r)c();return o}class xt{constructor(){S(this,"idMap",new Map);S(this,"mockedValueMap",new Map)}getId(t){return this.idMap.get(t)}getMockedValue(t){return this.mockedValueMap.get(t)}track(t,e){const r=this.idMap.size;return this.idMap.set(t,r),this.mockedValueMap.set(r,e),r}}function j(n){return Object.prototype.toString.apply(n).slice(8,-1)}function kt(n,t){return t.includes("Function")&&typeof n=="string"&&["arguments","callee","caller","length","name"].includes(n)}function Y(n,t,e){const{Map:r,Object:a,Function:i,RegExp:l,Array:o}=e,c=new r;let f=n;do{if(f===a.prototype||f===i.prototype||f===l.prototype)break;yt(f,g=>{const h=a.getOwnPropertyDescriptor(f,g);h&&c.set(g,{key:g,descriptor:h})})}while(f=a.getPrototypeOf(f));if(t&&!c.has("default")&&"default"in n){const g=a.getOwnPropertyDescriptor(n,"default");g&&c.set("default",{key:"default",descriptor:g})}return o.from(c.values())}function yt(n,t){const e=typeof t=="function"?t:r=>t.add(r);Object.getOwnPropertyNames(n).forEach(e),Object.getOwnPropertySymbols(n).forEach(e)}const _t=/^[A-Za-z]:\//;function lt(n=""){return n&&n.replace(/\\/g,"/").replace(_t,t=>t.toUpperCase())}const zt=/^[/\\]{2}/,Ut=/^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/,St=/^[A-Za-z]:$/,Ct=/.(\.[^./]+|\.)$/,Tt=function(n){if(n.length===0)return".";n=lt(n);const t=n.match(zt),e=G(n),r=n[n.length-1]==="/";return n=Ft(n,!e),n.length===0?e?"/":r?"./":".":(r&&(n+="/"),St.test(n)&&(n+="/"),t?e?`//${n}`:`//./${n}`:e&&!G(n)?`/${n}`:n)},qt=function(...n){let t="";for(const e of n)if(e)if(t.length>0){const r=t[t.length-1]==="/",a=e[0]==="/";r&&a?t+=e.slice(1):t+=r||a?e:`/${e}`}else t+=e;return Tt(t)};function Ft(n,t){let e="",r=0,a=-1,i=0,l=null;for(let o=0;o<=n.length;++o){if(o<n.length)l=n[o];else{if(l==="/")break;l="/"}if(l==="/"){if(!(a===o-1||i===1))if(i===2){if(e.length<2||r!==2||e[e.length-1]!=="."||e[e.length-2]!=="."){if(e.length>2){const c=e.lastIndexOf("/");c===-1?(e="",r=0):(e=e.slice(0,c),r=e.length-1-e.lastIndexOf("/")),a=o,i=0;continue}else if(e.length>0){e="",r=0,a=o,i=0;continue}}t&&(e+=e.length>0?"/..":"..",r=2)}else e.length>0?e+=`/${n.slice(a+1,o)}`:e=n.slice(a+1,o),r=o-a-1;a=o,i=0}else l==="."&&i!==-1?++i:i=-1}return e}const G=function(n){return Ut.test(n)},It=function(n){if(n==="..")return"";const t=Ct.exec(lt(n));return t&&t[1]||""};var Et={reset:[0,0],bold:[1,22,"\x1B[22m\x1B[1m"],dim:[2,22,"\x1B[22m\x1B[2m"],italic:[3,23],underline:[4,24],inverse:[7,27],hidden:[8,28],strikethrough:[9,29],black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],gray:[90,39],bgBlack:[40,49],bgRed:[41,49],bgGreen:[42,49],bgYellow:[43,49],bgBlue:[44,49],bgMagenta:[45,49],bgCyan:[46,49],bgWhite:[47,49],blackBright:[90,39],redBright:[91,39],greenBright:[92,39],yellowBright:[93,39],blueBright:[94,39],magentaBright:[95,39],cyanBright:[96,39],whiteBright:[97,39],bgBlackBright:[100,49],bgRedBright:[101,49],bgGreenBright:[102,49],bgYellowBright:[103,49],bgBlueBright:[104,49],bgMagentaBright:[105,49],bgCyanBright:[106,49],bgWhiteBright:[107,49]},Pt=Object.entries(Et);function K(n){return String(n)}K.open="";K.close="";function Nt(n=!1){let t=typeof process<"u"?process:void 0,e=(t==null?void 0:t.env)||{},r=(t==null?void 0:t.argv)||[];return!("NO_COLOR"in e||r.includes("--no-color"))&&("FORCE_COLOR"in e||r.includes("--color")||(t==null?void 0:t.platform)==="win32"||n&&e.TERM!=="dumb"||"CI"in e)||typeof window<"u"&&!!window.chrome}function At(n=!1){let t=Nt(n),e=(l,o,c,f)=>{let g="",h=0;do g+=l.substring(h,f)+c,h=f+o.length,f=l.indexOf(o,h);while(~f);return g+l.substring(h)},r=(l,o,c=l)=>{let f=g=>{let h=String(g),b=h.indexOf(o,l.length);return~b?l+e(h,o,c,b)+o:l+h+o};return f.open=l,f.close=o,f},a={isColorSupported:t},i=l=>`\x1B[${l}m`;for(let[l,o]of Pt)a[l]=t?r(i(o[0]),i(o[1]),o[2]):K;return a}At();function ct(n,t){return t.forEach(function(e){e&&typeof e!="string"&&!Array.isArray(e)&&Object.keys(e).forEach(function(r){if(r!=="default"&&!(r in n)){var a=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(n,r,a.get?a:{enumerable:!0,get:function(){return e[r]}})}})}),Object.freeze(n)}function dt(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var V={exports:{}},x={};/**
* @license React
...
*/var Q;function Lt(){if(Q)return x;Q=1;var n=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),e=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),i=Symbol.for("react.consumer"),l=Symbol.for("react.context"),o=Symbol.for("react.forward_ref"),c=Symbol.for("react.suspense"),f=Symbol.for("react.suspense_list"),g=Symbol.for("react.memo"),h=Symbol.for("react.lazy"),b=Symbol.for("react.view_transition"),z=Symbol.for("react.client.reference");function u(s){if(typeof s=="object"&&s!==null){var d=s.$$typeof;switch(d){case n:switch(s=s.type,s){case e:case a:case r:case c:case f:case b:return s;default:switch(s=s&&s.$$typeof,s){case l:case o:case h:case g:return s;case i:return s;default:return d}}case t:return d}}}return x.ContextConsumer=i,x.ContextProvider=l,x.Element=n,x.ForwardRef=o,x.Fragment=e,x.Lazy=h,x.Memo=g,x.Portal=t,x.Profiler=a,x.StrictMode=r,x.Suspense=c,x.SuspenseList=f,x.isContextConsumer=function(s){return u(s)===i},x.isContextProvider=function(s){return u(s)===l},x.isElement=function(s){return typeof s=="object"&&s!==null&&s.$$typeof===n},x.isForwardRef=function(s){return u(s)===o},x.isFragment=function(s){return u(s)===e},x.isLazy=function(s){return u(s)===h},x.isMemo=function(s){return u(s)===g},x.isPortal=function(s){return u(s)===t},x.isProfiler=function(s){return u(s)===a},x.isStrictMode=function(s){return u(s)===r},x.isSuspense=function(s){return u(s)===c},x.isSuspenseList=function(s){return u(s)===f},x.isValidElementType=function(s){return typeof s=="string"||typeof s=="function"||s===e||s===a||s===r||s===c||s===f||typeof s=="object"&&s!==null&&(s.$$typeof===h||s.$$typeof===g||s.$$typeof===l||s.$$typeof===i||s.$$typeof===o||s.$$typeof===z||s.getModuleId!==void 0)},x.typeOf=u,x}var Z;function Bt(){return Z||(Z=1,V.exports=Lt()),V.exports}var pt=Bt(),Rt=dt(pt),Dt=ct({__proto__:null,default:Rt},[pt]),X={exports:{}},v={};/**
* @license React
...
* This source code is licensed under the MIT license found in the
* LICENSE file in the root directory of this source tree.
*/var tt;function Mt(){if(tt)return v;tt=1;var n=Symbol.for("react.element"),t=Symbol.for("react.portal"),e=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),i=Symbol.for("react.provider"),l=Symbol.for("react.context"),o=Symbol.for("react.server_context"),c=Symbol.for("react.forward_ref"),f=Symbol.for("react.suspense"),g=Symbol.for("react.suspense_list"),h=Symbol.for("react.memo"),b=Symbol.for("react.lazy"),z=Symbol.for("react.offscreen"),u;u=Symbol.for("react.module.reference");function s(d){if(typeof d=="object"&&d!==null){var C=d.$$typeof;switch(C){case n:switch(d=d.type,d){case e:case a:case r:case f:case g:return d;default:switch(d=d&&d.$$typeof,d){case o:case l:case c:case b:case h:case i:return d;default:return C}}case t:return C}}}return v.ContextConsumer=l,v.ContextProvider=i,v.Element=n,v.ForwardRef=c,v.Fragment=e,v.Lazy=b,v.Memo=h,v.Portal=t,v.Profiler=a,v.StrictMode=r,v.Suspense=f,v.SuspenseList=g,v.isAsyncMode=function(){return!1},v.isConcurrentMode=function(){return!1},v.isContextConsumer=function(d){return s(d)===l},v.isContextProvider=function(d){return s(d)===i},v.isElement=function(d){return typeof d=="object"&&d!==null&&d.$$typeof===n},v.isForwardRef=function(d){return s(d)===c},v.isFragment=function(d){return s(d)===e},v.isLazy=function(d){return s(d)===b},v.isMemo=function(d){return s(d)===h},v.isPortal=function(d){return s(d)===t},v.isProfiler=function(d){return s(d)===a},v.isStrictMode=function(d){return s(d)===r},v.isSuspense=function(d){return s(d)===f},v.isSuspenseList=function(d){return s(d)===g},v.isValidElementType=function(d){return typeof d=="string"||typeof d=="function"||d===e||d===a||d===r||d===f||d===g||d===z||typeof d=="object"&&d!==null&&(d.$$typeof===b||d.$$typeof===h||d.$$typeof===i||d.$$typeof===l||d.$$typeof===c||d.$$typeof===u||d.getModuleId!==void 0)},v.typeOf=s,v}var et;function Ot(){return et||(et=1,X.exports=Mt()),X.exports}var ft=Ot(),$t=dt(ft),jt=ct({__proto__:null,default:$t},[ft]);const Vt=["isAsyncMode","isConcurrentMode","isContextConsumer","isContextProvider","isElement","isForwardRef","isFragment","isLazy","isMemo","isPortal","isProfiler","isStrictMode","isSuspense","isSuspenseList","isValidElementType"];Object.fromEntries(Vt.map(n=>[n,t=>jt[n](t)||Dt[n](t)]));let Xt=()=>"Promise{…}";try{const{getPromiseDetails:n,kPending:t,kRejected:e}=process.binding("util");Array.isArray(n(Promise.resolve()))&&(Xt=(r,a)=>{const[i,l]=n(r);return i===t?"Promise{<pending>}":`Promise${i===e?"!":""}{${a.inspect(l,a)}}`})}catch{}function Wt(n){const{message:t="$$stack trace error",stackTraceLimit:e=1}=n||{},r=Error.stackTraceLimit,a=Error.prepareStackTrace;Error.stackTraceLimit=e,Error.prepareStackTrace=o=>o.stack;const l=new Error(t).stack||"";return Error.prepareStackTrace=a,Error.stackTraceLimit=r,l}var W,nt;function Jt(){if(nt)return W;nt=1;var n,t,e,r,a,i,l,o,c,f,g,h,b,z,u,s,d,C,I;return b=/\/(?![*\/])(?:\[(?:(?![\]\\]).|\\.)*\]|(?![\/\\]).|\\.)*(\/[$_\u200C\u200D\p{ID_Continue}]*|\\)?/uy,h=/--|\+\+|=>|\.{3}|\??\.(?!\d)|(?:&&|\|\||\?\?|[+\-%&|^]|\*{1,2}|<{1,2}|>{1,3}|!=?|={1,2}|\/(?![\/*]))=?|[?~,:;[\](){}]/y,n=/(\x23?)(?=[$_\p{ID_Start}\\])(?:[$_\u200C\u200D\p{ID_Continue}]|\\u[\da-fA-F]{4}|\\u\{[\da-fA-F]+\})+/uy,u=/(['"])(?:(?!\1)[^\\\n\r]|\\(?:\r\n|[^]))*(\1)?/y,g=/(?:0[xX][\da-fA-F](?:_?[\da-fA-F])*|0[oO][0-7](?:_?[0-7])*|0[bB][01](?:_?[01])*)n?|0n|[1-9](?:_?\d)*n|(?:(?:0(?!\d)|0\d*[89]\d*|[1-9](?:_?\d)*)(?:\.(?:\d(?:_?\d)*)?)?|\.\d(?:_?\d)*)(?:[eE][+-]?\d(?:_?\d)*)?|0[0-7]+/y,s=/[`}](?:[^`\\$]|\\[^]|\$(?!\{))*(`|\$\{)?/y,I=/[\t\v\f\ufeff\p{Zs}]+/uy,o=/\r?\n|[\r\u2028\u2029]/y,c=/\/\*(?:[^*]|\*(?!\/))*(\*\/)?/y,z=/\/\/.*/y,e=/[<>.:={}]|\/(?![\/*])/y,t=/[$_\p{ID_Start}][$_\u200C\u200D\p{ID_Continue}-]*/uy,r=/(['"])(?:(?!\1)[^])*(\1)?/y,a=/[^<>{}]+/y,C=/^(?:[\/+-]|\.{3}|\?(?:InterpolationIn(?:JSX|Template)|NoLineTerminatorHere|NonExpressionParenEnd|UnaryIncDec))?$|[{}([,;<>=*%&|^!~?:]$/,d=/^(?:=>|[;\]){}]|else|\?(?:NoLineTerminatorHere|NonExpressionParenEnd))?$/,i=/^(?:await|case|default|delete|do|else|instanceof|new|return|throw|typeof|void|yield)$/,l=/^(?:return|throw|yield)$/,f=RegExp(o.source),W=function*(y,{jsx:F=!1}={}){var U,E,L,w,m,B,p,q,H,T,R,k,D,_;for({length:B}=y,w=0,m="",_=[{tag:"JS"}],U=[],R=0,k=!1;w<B;){switch(q=_[_.length-1],q.tag){case"JS":case"JSNonExpressionParen":case"InterpolationInTemplate":case"InterpolationInJSX":if(y[w]==="/"&&(C.test(m)||i.test(m))&&(b.lastIndex=w,p=b.exec(y))){w=b.lastIndex,m=p[0],k=!0,yield{type:"RegularExpressionLiteral",value:p[0],closed:p[1]!==void 0&&p[1]!=="\\"};continue}if(h.lastIndex=w,p=h.exec(y)){switch(D=p[0],H=h.lastIndex,T=D,D){case"(":m==="?NonExpressionParenKeyword"&&_.push({tag:"JSNonExpressionParen",nesting:R}),R++,k=!1;break;case")":R--,k=!0,q.tag==="JSNonExpressionParen"&&R===q.nesting&&(_.pop(),T="?NonExpressionParenEnd",k=!1);break;case"{":h.lastIndex=0,L=!d.test(m)&&(C.test(m)||i.test(m)),U.push(L),k=!1;break;case"}":switch(q.tag){case"InterpolationInTemplate":if(U.length===q.nesting){s.lastIndex=w,p=s.exec(y),w=s.lastIndex,m=p[0],p[1]==="${"?(m="?InterpolationInTemplate",k=!1,yield{type:"TemplateMiddle",value:p[0]}):(_.pop(),k=!0,yield{type:"TemplateTail",value:p[0],closed:p[1]==="`"});continue}break;case"InterpolationInJSX":if(U.length===q.nesting){_.pop(),w+=1,m="}",yield{type:"JSXPunctuator",value:"}"};continue}}k=U.pop(),T=k?"?ExpressionBraceEnd":"}";break;case"]":k=!0;break;case"++":case"--":T=k?"?PostfixIncDec":"?UnaryIncDec";break;case"<":if(F&&(C.test(m)||i.test(m))){_.push({tag:"JSXTag"}),w+=1,m="<",yield{type:"JSXPunctuator",value:D};continue}k=!1;break;default:k=!1}w=H,m=T,yield{type:"Punctuator",value:D};continue}if(n.lastIndex=w,p=n.exec(y)){switch(w=n.lastIndex,T=p[0],p[0]){case"for":case"if":case"while":case"with":m!=="."&&m!=="?."&&(T="?NonExpressionParenKeyword")}m=T,k=!i.test(p[0]),yield{type:p[1]==="#"?"PrivateIdentifier":"IdentifierName",value:p[0]};continue}if(u.lastIndex=w,p=u.exec(y)){w=u.lastIndex,m=p[0],k=!0,yield{type:"StringLiteral",value:p[0],closed:p[2]!==void 0};continue}if(g.lastIndex=w,p=g.exec(y)){w=g.lastIndex,m=p[0],k=!0,yield{type:"NumericLiteral",value:p[0]};continue}if(s.lastIndex=w,p=s.exec(y)){w=s.lastIndex,m=p[0],p[1]==="${"?(m="?InterpolationInTemplate",_.push({tag:"InterpolationInTemplate",nesting:U.length}),k=!1,yield{type:"TemplateHead",value:p[0]}):(k=!0,yield{type:"NoSubstitutionTemplate",value:p[0],closed:p[1]==="`"});continue}break;case"JSXTag":case"JSXTagEnd":if(e.lastIndex=w,p=e.exec(y)){switch(w=e.lastIndex,T=p[0],p[0]){case"<":_.push({tag:"JSXTag"});break;case">":_.pop(),m==="/"||q.tag==="JSXTagEnd"?(T="?JSX",k=!0):_.push({tag:"JSXChildren"});break;case"{":_.push({tag:"InterpolationInJSX",nesting:U.length}),T="?InterpolationInJSX",k=!1;break;case"/":m==="<"&&(_.pop(),_[_.length-1].tag==="JSXChildren"&&_.pop(),_.push({tag:"JSXTagEnd"}))}m=T,yield{type:"JSXPunctuator",value:p[0]};continue}if(t.lastIndex=w,p=t.exec(y)){w=t.lastIndex,m=p[0],yield{type:"JSXIdentifier",value:p[0]};continue}if(r.lastIndex=w,p=r.exec(y)){w=r.lastIndex,m=p[0],yield{type:"JSXString",value:p[0],closed:p[2]!==void 0};continue}break;case"JSXChildren":if(a.lastIndex=w,p=a.exec(y)){w=a.lastIndex,m=p[0],yield{type:"JSXText",value:p[0]};continue}switch(y[w]){case"<":_.push({tag:"JSXTag"}),w++,m="<",yield{type:"JSXPunctuator",value:"<"};continue;case"{":_.push({tag:"InterpolationInJSX",nesting:U.length}),w++,m="?InterpolationInJSX",k=!1,yield{type:"JSXPunctuator",value:"{"};continue}}if(I.lastIndex=w,p=I.exec(y)){w=I.lastIndex,yield{type:"WhiteSpace",value:p[0]};continue}if(o.lastIndex=w,p=o.exec(y)){w=o.lastIndex,k=!1,l.test(m)&&(m="?NoLineTerminatorHere"),yield{type:"LineTerminatorSequence",value:p[0]};continue}if(c.lastIndex=w,p=c.exec(y)){w=c.lastIndex,f.test(p[0])&&(k=!1,l.test(m)&&(m="?NoLineTerminatorHere")),yield{type:"MultiLineComment",value:p[0],closed:p[1]!==void 0};continue}if(z.lastIndex=w,p=z.exec(y)){w=z.lastIndex,k=!1,yield{type:"SingleLineComment",value:p[0]};continue}E=String.fromCodePoint(y.codePointAt(w)),w+=E.length,m=E,k=!1,yield{type:q.tag.startsWith("JSX")?"JSXInvalid":"Invalid",value:E}}},W}Jt();var wt={keyword:["break","case","catch","continue","debugger","default","do","else","finally","for","function","if","return","switch","throw","try","var","const","while","with","new","this","super","class","extends","export","import","null","true","false","in","instanceof","typeof","void","delete"],strict:["implements","interface","let","package","private","protected","public","static","yield"]};new Set(wt.keyword);new Set(wt.strict);const rt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",Kt=new Uint8Array(64),Ht=new Uint8Array(128);for(let n=0;n<rt.length;n++){const t=rt.charCodeAt(n);Kt[n]=t,Ht[t]=n}var at;(function(n){n[n.Empty=1]="Empty",n[n.Hash=2]="Hash",n[n.Query=3]="Query",n[n.RelativePath=4]="RelativePath",n[n.AbsolutePath=5]="AbsolutePath",n[n.SchemeRelative=6]="SchemeRelative",n[n.Absolute=7]="Absolute"})(at||(at={}));const Yt=/^[A-Za-z]:\//;function Gt(n=""){return n&&n.replace(/\\/g,"/").replace(Yt,t=>t.toUpperCase())}const Qt=/^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/;function Zt(){return typeof process<"u"&&typeof process.cwd=="function"?process.cwd().replace(/\\/g,"/"):"/"}const te=function(...n){n=n.map(r=>Gt(r));let t="",e=!1;for(let r=n.length-1;r>=-1&&!e;r--){const a=r>=0?n[r]:Zt();!a||a.length===0||(t=`${a}/${t}`,e=ot(a))}return t=ee(t,!e),e&&!ot(t)?`/${t}`:t.length>0?t:"."};function ee(n,t){let e="",r=0,a=-1,i=0,l=null;for(let o=0;o<=n.length;++o){if(o<n.length)l=n[o];else{if(l==="/")break;l="/"}if(l==="/"){if(!(a===o-1||i===1))if(i===2){if(e.length<2||r!==2||e[e.length-1]!=="."||e[e.length-2]!=="."){if(e.length>2){const c=e.lastIndexOf("/");c===-1?(e="",r=0):(e=e.slice(0,c),r=e.length-1-e.lastIndexOf("/")),a=o,i=0;continue}else if(e.length>0){e="",r=0,a=o,i=0;continue}}t&&(e+=e.length>0?"/..":"..",r=2)}else e.length>0?e+=`/${n.slice(a+1,o)}`:e=n.slice(a+1,o),r=o-a-1;a=o,i=0}else l==="."&&i!==-1?++i:i=-1}return e}const ot=function(n){return Qt.test(n)},gt=/^\s*at .*(?:\S:\d+|\(native\))/m,ne=/^(?:eval@)?(?:\[native code\])?$/;function mt(n){if(!n.includes(":"))return[n];const e=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(n.replace(/^\(|\)$/g,""));if(!e)return[n];let r=e[1];if(r.startsWith("async ")&&(r=r.slice(6)),r.startsWith("http:")||r.startsWith("https:")){const a=new URL(r);a.searchParams.delete("import"),a.searchParams.delete("browserv"),r=a.pathname+a.hash+a.search}if(r.startsWith("/@fs/")){const a=/^\/@fs\/[a-zA-Z]:\//.test(r);r=r.slice(a?5:4)}return[r,e[2]||void 0,e[3]||void 0]}function re(n){let t=n.trim();if(ne.test(t)||(t.includes(" > eval")&&(t=t.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g,":$1")),!t.includes("@")&&!t.includes(":")))return null;const e=/((.*".+"[^@]*)?[^@]*)(@)/,r=t.match(e),a=r&&r[1]?r[1]:void 0,[i,l,o]=mt(t.replace(e,""));return!i||!l||!o?null:{file:i,method:a||"",line:Number.parseInt(l),column:Number.parseInt(o)}}function ae(n){const t=n.trim();return gt.test(t)?oe(t):re(t)}function oe(n){let t=n.trim();if(!gt.test(t))return null;t.includes("(eval ")&&(t=t.replace(/eval code/g,"eval").replace(/(\(eval at [^()]*)|(,.*$)/g,""));let e=t.replace(/^\s+/,"").replace(/\(eval code/g,"(").replace(/^.*?\s+/,"");const r=e.match(/ (\(.+\)$)/);e=r?e.replace(r[0],""):e;const[a,i,l]=mt(r?r[1]:e);let o=r&&e||"",c=a&&["eval","<anonymous>"].includes(a)?void 0:a;return!c||!i||!l?null:(o.startsWith("async ")&&(o=o.slice(6)),c.startsWith("file://")&&(c=c.slice(7)),c=c.startsWith("node:")||c.startsWith("internal:")?c:te(c),o&&(o=o.replace(/__vite_ssr_import_\d+__\./g,"")),{method:o,file:c,line:Number.parseInt(i),column:Number.parseInt(l)})}function ie(n){const t=(n==null?void 0:n.globalThisKey)||"__vitest_mocker__";function e(){return typeof globalThis[t]<"u"?globalThis[t]:new Proxy({},{get(r,a){throw new Error(`Vitest mocker was not initialized in this environment. vi.${String(a)}() is forbidden.`)}})}return{hoisted(r){if(typeof r!="function")throw new TypeError(`vi.hoisted() expects a function, but received a ${typeof r}`);return r()},mock(r,a){if(typeof r!="string")throw new TypeError(`vi.mock() expects a string path, but received a ${typeof r}`);const i=P("mock");e().queueMock(r,i,typeof a=="function"?()=>a(()=>e().importActual(r,i)):a)},unmock(r){if(typeof r!="string")throw new TypeError(`vi.unmock() expects a string path, but received a ${typeof r}`);e().queueUnmock(r,P("unmock"))},doMock(r,a){if(typeof r!="string")throw new TypeError(`vi.doMock() expects a string path, but received a ${typeof r}`);const i=P("doMock");e().queueMock(r,i,typeof a=="function"?()=>a(()=>e().importActual(r,i)):a)},doUnmock(r){if(typeof r!="string")throw new TypeError(`vi.doUnmock() expects a string path, but received a ${typeof r}`);e().queueUnmock(r,P("doUnmock"))},async importActual(r){return e().importActual(r,P("importActual"))},async importMock(r){return e().importMock(r,P("importMock"))}}}function P(n){const e=Wt({stackTraceLimit:5}).split(`
`),r=e.findIndex(i=>i.includes(` at Object.${n}`)||i.includes(`${n}@`)),a=ae(e[r+1]);return(a==null?void 0:a.file)||""}const{now:it}=Date;class se{constructor(t,e,r,a){S(this,"registry",new st);S(this,"queue",new Set);S(this,"mockedIds",new Set);this.interceptor=t,this.rpc=e,this.spyOn=r,this.config=a}async prepare(){this.queue.size&&await Promise.all([...this.queue.values()])}async resolveFactoryModule(t){const e=this.registry.get(t);if(!e||e.type!=="manual")throw new Error(`Mock ${t} wasn't registered. This is probably a Vitest error. Please, open a new issue with reproduction.`);return await e.resolve()}getFactoryModule(t){const e=this.registry.get(t);if(!e||e.type!=="manual")throw new Error(`Mock ${t} wasn't registered. This is probably a Vitest error. Please, open a new issue with reproduction.`);if(!e.cache)throw new Error(`Mock ${t} wasn't resolved. This is probably a Vitest error. Please, open a new issue with reproduction.`);return e.cache}async invalidate(){const t=Array.from(this.mockedIds);t.length&&(await this.rpc.invalidate(t),await this.interceptor.invalidate(),this.registry.clear())}async importActual(t,e){const r=await this.rpc.resolveId(t,e);if(r==null)throw new Error(`[vitest] Cannot resolve "${t}" imported from "${e}"`);const a=It(r.id),i=new URL(r.url,location.href),l=`_vitest_original&ext${a}`,o=`${i.pathname}${i.search?`${i.search}&${l}`:`?${l}`}${i.hash}`;return this.wrapDynamicImport(()=>import(o)).then(c=>{if(!r.optimized||typeof c.default>"u")return c;const f=c.default;return f!=null&&f.__esModule?f:{...typeof f=="object"&&!Array.isArray(f)||typeof f=="function"?f:{},default:f}})}async importMock(t,e){await this.prepare();const{resolvedId:r,resolvedUrl:a,redirectUrl:i}=await this.rpc.resolveMock(t,e,{mock:"auto"}),l=this.resolveMockPath(M(a));let o=this.registry.get(l);if(!o)if(i){const c=new URL(this.resolveMockPath(M(i)),location.href).toString();o=new A(t,r,l,c)}else o=new O(t,r,l);if(o.type==="manual")return await o.resolve();if(o.type==="automock"||o.type==="autospy"){const c=new URL(`/@id/${r}`,location.href),f=c.search?`${c.search}&t=${it()}`:`?t=${it()}`,g=await vt(()=>import(`${c.pathname}${f}&mock=${o.type}${c.hash}`),[],import.meta.url);return this.mockObject(g,o.type)}return import(o.redirect)}mockObject(t,e="automock"){return bt({globalConstructors:{Object,Function,Array,Map,RegExp},spyOn:this.spyOn,type:e},t)}queueMock(t,e,r){const a=this.rpc.resolveMock(t,e,{mock:typeof r=="function"?"factory":r!=null&&r.spy?"spy":"auto"}).then(async({redirectUrl:i,resolvedId:l,resolvedUrl:o,needsInterop:c,mockType:f})=>{const g=this.resolveMockPath(M(o));this.mockedIds.add(l);const h=typeof r=="function"?async()=>{const u=await r();return c?{default:u}:u}:void 0,b=typeof i=="string"?new URL(this.resolveMockPath(M(i)),location.href).toString():null;let z;f==="manual"?z=this.registry.register("manual",t,l,g,h):f==="autospy"?z=this.registry.register("autospy",t,l,g):f==="redirect"?z=this.registry.register("redirect",t,l,g,b):z=this.registry.register("automock",t,l,g),await this.interceptor.register(z)}).finally(()=>{this.queue.delete(a)});this.queue.add(a)}queueUnmock(t,e){const r=this.rpc.resolveId(t,e).then(async a=>{if(!a)return;const i=this.resolveMockPath(M(a.url));this.mockedIds.add(a.id),this.registry.delete(i),await this.interceptor.delete(i)}).finally(()=>{this.queue.delete(r)});this.queue.add(r)}wrapDynamicImport(t){return typeof t=="function"?new Promise((r,a)=>{this.prepare().finally(()=>{t().then(r,a)})}):t}resolveMockPath(t){const e=this.config,r=qt("/@fs/",e.root);return t.startsWith(e.root)?t.slice(e.root.length):t.startsWith(r)?t.slice(r.length):t}}const le=/(\?|&)v=\w{8}/;function M(n){return n.replace(le,"")}class ce{constructor(){S(this,"mocks",new st)}async register(t){this.mocks.add(t)}async delete(t){this.mocks.delete(t)}async invalidate(){this.mocks.clear()}}const J=n=>{switch(n){case"resolveId":return Promise.resolve({id:"",url:"",optimized:!1});case"resolveMock":return Promise.resolve({mockType:"dummy",resolvedId:"",resolvedUrl:"",redirectUrl:"",needsInterop:!1});case"invalidate":return Promise.resolve()}};class de extends se{queueMock(){}}function pe(n){const t=new de(n("__vitest_mocker__"),{resolveId(e,r){return J("resolveId")},resolveMock(e,r,a){return J("resolveMock")},async invalidate(e){return J("invalidate")}},(...e)=>globalThis.__STORYBOOK_MODULE_TEST__.spyOn(...e),{root:""});return globalThis.__vitest_mocker__=t,ie({globalThisKey:"__vitest_mocker__"})}globalThis.__STORYBOOK_MOCKER__=pe(()=>new ce);function fe(n,t="top"){if(!n||typeof document>"u")return;const e=document.head||document.querySelector("head"),r=e.querySelector(":first-child"),a=document.createElement("style");a.appendChild(document.createTextNode(n)),t==="top"&&r?e.insertBefore(a,r):e.appendChild(a)}fe(`
      @font-face {
...
/*
 * Charis SIL for Storybook: the same faces the application declares, for every story that renders
 * Scripture text.
 *
 * The application inlines src/renderer/styles/fonts.css into each web view; neither Storybook loads
 * that stylesheet, and the vendored \`usj-nodes.css\` deliberately declares no faces of its own — so
 * without this file a Scripture story has no Charis SIL declaration from any source and renders in
 * a system serif with synthesized bold and italic. Both \`.storybook/preview.ts\` files load it, so a
 * story gets the faces wherever it runs and whichever stylesheet it reaches \`usj-nodes.css\`
 * through.
 *
 * Copied from fonts.css rather than \`@import\`ed from Google so that an offline or network-restricted
 * run — \`@storybook/addon-vitest\` runs stories as tests — keeps the faces instead of silently
 * losing them, the way the application's inlined copy does. \`fonts.test.ts\` pins every face here
 * against fonts.css face for face, so the two cannot drift.
 *
 * Charis SIL only: it is the family the vendored chain leads with, and the one whose \`local()\`-only
 * rules were removed from \`usj-nodes.css\`. The rest of the application's stack lives in fonts.css
 * with \`--scripture-font-stack\`, which Storybook does not load.
 */

/* #region downloaded faces, preferring an installed copy — from fonts.css */
...
@font-face {
  ...
  src:
    local('Charis SIL'),
    local('CharisSIL-Regular'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWK_kV3l-s-Q8govXvKnPDsYwZ2.woff2')
      format('woff2');
...
@font-face {
  ...
  src:
    local('Charis SIL'),
    local('CharisSIL-Regular'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWK_kV3l-s-Q8govXvKnPnsYwZ2.woff2')
      format('woff2');
...
@font-face {
  ...
  src:
    local('Charis SIL'),
    local('CharisSIL-Regular'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWK_kV3l-s-Q8govXvKnPLsYwZ2.woff2')
      format('woff2');
  unicode-range:
...
@font-face {
  ...
  src:
    local('Charis SIL'),
    local('CharisSIL-Regular'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWK_kV3l-s-Q8govXvKnPPsYwZ2.woff2')
      format('woff2');
  unicode-range:
...
@font-face {
  ...
  src:
    local('Charis SIL'),
    local('CharisSIL-Regular'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWK_kV3l-s-Q8govXvKnP3sYw.woff2') format('woff2');
  unicode-range:
...
@font-face {
  ...
  src:
    ...
    local('CharisSIL-Bold'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWJ_kV3l-s-Q8govXvKlEbJdjRXQ0SX.woff2')
      format('woff2');
  unicode-range: U+0460-052F, U+1C80-1C8A, U+20B4, U+2DE0-2DFF, U+A640-A69F, U+FE2E-FE2F;
}
...
@font-face {
  ...
  src:
    local('Charis SIL Bold'),
    local('CharisSIL-Bold'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWJ_kV3l-s-Q8govXvKlEbJdj1XQ0SX.woff2')
      format('woff2');
  unicode-range: U+0301, U+0400-045F, U+0490-0491, U+04B0-04B1, U+2116;
}
...
@font-face {
  ...
  src:
    local('Charis SIL Bold'),
    local('CharisSIL-Bold'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWJ_kV3l-s-Q8govXvKlEbJdjZXQ0SX.woff2')
      format('woff2');
  unicode-range:
    U+0102-0103, U+0110-0111, U+0128-0129, U+0168-0169, U+01A0-01A1, U+01AF-01B0, U+0300-0301,
    U+0303-0304, U+0308-0309, U+0323, U+0329, U+1EA0-1EF9, U+20AB;
...
@font-face {
  ...
  src:
    local('Charis SIL Bold'),
    local('CharisSIL-Bold'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWJ_kV3l-s-Q8govXvKlEbJdjdXQ0SX.woff2')
      format('woff2');
  unicode-range:
    U+0100-02BA, U+02BD-02C5, U+02C7-02CC, U+02CE-02D7, U+02DD-02FF, U+0304, U+0308, U+0329,
    U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F,
...
@font-face {
  ...
  src:
    local('Charis SIL Bold'),
    local('CharisSIL-Bold'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWJ_kV3l-s-Q8govXvKlEbJdjlXQw.woff2')
      format('woff2');
  unicode-range:
    U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329,
    U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
...
@font-face {
  ...
  src:
    ...
    local('CharisSIL-Italic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWI_kV3l-s-Q8govXvKnPjcbB5yfn0.woff2')
      format('woff2');
  unicode-range: U+0460-052F, U+1C80-1C8A, U+20B4, U+2DE0-2DFF, U+A640-A69F, U+FE2E-FE2F;
}
...
@font-face {
  ...
  src:
    local('Charis SIL Italic'),
    local('CharisSIL-Italic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWI_kV3l-s-Q8govXvKnPjcZR5yfn0.woff2')
      format('woff2');
  unicode-range: U+0301, U+0400-045F, U+0490-0491, U+04B0-04B1, U+2116;
}
...
@font-face {
  ...
  src:
    local('Charis SIL Italic'),
    local('CharisSIL-Italic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWI_kV3l-s-Q8govXvKnPjcbh5yfn0.woff2')
      format('woff2');
  unicode-range:
    U+0102-0103, U+0110-0111, U+0128-0129, U+0168-0169, U+01A0-01A1, U+01AF-01B0, U+0300-0301,
    U+0303-0304, U+0308-0309, U+0323, U+0329, U+1EA0-1EF9, U+20AB;
...
@font-face {
  ...
  src:
    local('Charis SIL Italic'),
    local('CharisSIL-Italic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWI_kV3l-s-Q8govXvKnPjcbx5yfn0.woff2')
      format('woff2');
  unicode-range:
    U+0100-02BA, U+02BD-02C5, U+02C7-02CC, U+02CE-02D7, U+02DD-02FF, U+0304, U+0308, U+0329,
    U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F,
...
@font-face {
  ...
  src:
    local('Charis SIL Italic'),
    local('CharisSIL-Italic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWI_kV3l-s-Q8govXvKnPjcYR5y.woff2')
      format('woff2');
  unicode-range:
    U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329,
    U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
...
@font-face {
  ...
  src:
    ...
    local('CharisSIL-BoldItalic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWX_kV3l-s-Q8govXvKnPjU2jtnTFyT9ko.woff2')
      format('woff2');
  unicode-range: U+0460-052F, U+1C80-1C8A, U+20B4, U+2DE0-2DFF, U+A640-A69F, U+FE2E-FE2F;
}
...
@font-face {
  ...
  src:
    local('Charis SIL Bold Italic'),
    local('CharisSIL-BoldItalic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWX_kV3l-s-Q8govXvKnPjU2jtnRVyT9ko.woff2')
      format('woff2');
  unicode-range: U+0301, U+0400-045F, U+0490-0491, U+04B0-04B1, U+2116;
}
...
@font-face {
  ...
  src:
    local('Charis SIL Bold Italic'),
    local('CharisSIL-BoldItalic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWX_kV3l-s-Q8govXvKnPjU2jtnTlyT9ko.woff2')
      format('woff2');
  unicode-range:
    U+0102-0103, U+0110-0111, U+0128-0129, U+0168-0169, U+01A0-01A1, U+01AF-01B0, U+0300-0301,
    U+0303-0304, U+0308-0309, U+0323, U+0329, U+1EA0-1EF9, U+20AB;
...
@font-face {
  ...
  src:
    local('Charis SIL Bold Italic'),
    local('CharisSIL-BoldItalic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWX_kV3l-s-Q8govXvKnPjU2jtnT1yT9ko.woff2')
      format('woff2');
  unicode-range:
    U+0100-02BA, U+02BD-02C5, U+02C7-02CC, U+02CE-02D7, U+02DD-02FF, U+0304, U+0308, U+0329,
    U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F,
...
@font-face {
  ...
  src:
    local('Charis SIL Bold Italic'),
    local('CharisSIL-BoldItalic'),
    url('https://fonts.gstatic.com/s/charissil/v2/oPWX_kV3l-s-Q8govXvKnPjU2jtnQVyT.woff2')
      format('woff2');
  unicode-range:
    U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329,
    U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
...
/* #endregion downloaded faces, preferring an installed copy — from fonts.css */

/* #region installed-only faces for what the downloads above leave out — from fonts.css */

/*
 * Google serves Charis SIL as five subsets with no Greek at all, 8 of the 112 combining marks, and
 * nothing above the BMP. The \`local()\`-only rules this file replaces carried no \`unicode-range\`, so
 * wherever the font is installed they were the only face covering the rest — without these, a bare
 * Greek alpha in a Scripture story falls out of the family mid-line and lands on Times New Roman,
 * the next entry in the vendored chain. Disjoint from the downloads above by construction, so a
 * face that errors because the font is not installed is never a candidate for a codepoint a
 * downloadable face could serve.
 */
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: local('Charis SIL'), local('CharisSIL-Regular');
  unicode-range:
    U+02CD, U+02D8-02D9, U+02DB, U+0302, U+0305-0307, U+030A-0322, U+0324-0328, U+032A-03FF,
    U+0530-1C7F, U+1C8B-1CFF, U+1DC0-1DFF, U+1F00-1FFF, U+2070-209F, U+20C1-2112, U+2114-2115,
    U+2117-2121, U+2123-2190, U+2192, U+2194-2211, U+2213-2214, U+2216-2C5F, U+2C80-2DDF,
    U+2E00-A63F, U+A6A0-A71F, U+A800-FE2D, U+FE30-FEFE, U+FF00-FFFC, U+FFFE-10FFFF;
}
...
@font-face {
  ...
  font-style: normal;
  font-weight: 700;
  src: local('Charis SIL Bold'), local('CharisSIL-Bold');
  unicode-range:
    U+02CD, U+02D8-02D9, U+02DB, U+0302, U+0305-0307, U+030A-0322, U+0324-0328, U+032A-03FF,
    U+0530-1C7F, U+1C8B-1CFF, U+1DC0-1DFF, U+1F00-1FFF, U+2070-209F, U+20C1-2112, U+2114-2115,
    U+2117-2121, U+2123-2190, U+2192, U+2194-2211, U+2213-2214, U+2216-2C5F, U+2C80-2DDF,
...
@font-face {
  ...
  font-style: italic;
  font-weight: 400;
  src: local('Charis SIL Italic'), local('CharisSIL-Italic');
  unicode-range:
    U+02CD, U+02D8-02D9, U+02DB, U+0302, U+0305-0307, U+030A-0322, U+0324-0328, U+032A-03FF,
    U+0530-1C7F, U+1C8B-1CFF, U+1DC0-1DFF, U+1F00-1FFF, U+2070-209F, U+20C1-2112, U+2114-2115,
    U+2117-2121, U+2123-2190, U+2192, U+2194-2211, U+2213-2214, U+2216-2C5F, U+2C80-2DDF,
...
@font-face {
  ...
  font-style: italic;
  font-weight: 700;
  src: local('Charis SIL Bold Italic'), local('CharisSIL-BoldItalic');
  unicode-range:
    U+02CD, U+02D8-02D9, U+02DB, U+0302, U+0305-0307, U+030A-0322, U+0324-0328, U+032A-03FF,
    U+0530-1C7F, U+1C8B-1CFF, U+1DC0-1DFF, U+1F00-1FFF, U+2070-209F, U+20C1-2112, U+2114-2115,
    U+2117-2121, U+2123-2190, U+2192, U+2194-2211, U+2213-2214, U+2216-2C5F, U+2C80-2DDF,
...
/* #endregion installed-only faces for what the downloads above leave out — from fonts.css */
/* Based on scripture-editors' packages/platform/src/usj-nodes.css:
   ...
   - The source's four \`local()\`-only Charis SIL \`@font-face\` rules are dropped. */
...
/* Don't declare Scripture fonts here. A \`local()\`-only face errors where the font is not installed,
   and an erroring face makes the family unusable at that weight and style instead of deferring to a
   working declaration — which drops bold and italic Scripture text onto a system font. The app
   declares Charis SIL in src/renderer/styles/fonts.css; neither Storybook loads that stylesheet, so
   .storybook/scripture-fonts.css carries a copy of the same faces — copied rather than fetched, so
   a network-restricted run keeps them. It is loaded from BOTH Storybooks' previews rather than from
   one story's stylesheet, because the stories that reach this file arrive by several routes and
   through both Storybooks. fonts.test.ts pins that copy against fonts.css face for face, and fails
   if either preview stops loading it. */
/* Fallback chain for the editor's generated project stylesheet, which emits
   \`font-family: "<project font>", var(--usj-font-fallback, serif)\`. On \`.usfm\` so the unformatted
   view gets it too. Diverges from the editor library's copy, which hard-codes the chain: this
   points at Platform.Bible's own stack in src/renderer/styles/fonts.css, inlined into every web
   view. The literal chain is the library's, and applies where fonts.css is not loaded. */
.usfm {
  --usj-font-fallback: var(
    --scripture-font-stack,
    'Charis SIL',
    'Times New Roman',
    'Liberation Serif',
    'DejaVu Serif',
...
.usfm.formatted-font {
  /* Same \`serif\` fallback the generated project rules carry: a \`var()\` whose property turns out to
     be invalid at computed-value time takes the whole declaration with it, dropping Scripture text
     onto the inherited UI font. */
  font-family: var(--usj-font-fallback, serif);
  font-size: 12pt;
}
...
/* Indent compensation: each marker's --para-indent must equal its text-spacing margin-left above,
   ...
   the same margin in both directions. The platform-scripture-editor extension's
   usj-nodes-scss-coverage.test.ts enforces this for margins set in THIS file and asserts the block
   matches the shipping copy.
   \\tr needs no entry: a real row is a <tr>, not a .para. The obsolete \\tr1 and \\tr2 still convert
   to plain paragraphs, so they do.
   Out of scope: an "auto" text direction. The editor sets no dir attribute for it, so the
   ...
   note in the editor's ArrowNavigationPlugin. */
...
/* --verse-text-start mirrors the negative text-indent (hanging indent) of poetry-style
   ...
   usj-nodes-scss-coverage.test.ts keeps it in step with text-indent regardless. */
.psc-gutter-markers.text-spacing .usfm_q,
.psc-gutter-markers.text-spacing .usfm_q1 {
...
/* ── Active text focus box ────────────────────────────────────────────────────
   ...
   .psc-gutter-markers the box also takes in the marker glyph (the rule below);
   --verse-text-start is a fallback start that no marker in this file wins today.
   Without the gutter class that variable defaults to 0px, so poetry alignment is
   approximate. */
...
/* In gutter-marker mode, the paragraph marker (\\p, \\q1, etc.) is absolutely positioned in the
   ...
   inline-start so the box surrounds the marker too — using min() against the hanging-indent
   text start (--verse-text-start). For every marker in this file the marker's own column is
   further into the gutter, so it is what wins today. */
