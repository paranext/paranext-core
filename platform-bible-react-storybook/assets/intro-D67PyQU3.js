...
`,e.jsxs(n.p,{children:["Use ",e.jsx(n.code,{children:"ExampleBlock"})," and ",e.jsx(n.code,{children:"ExampleBlockGroup"})," from ",e.jsx(n.code,{children:"@/storybook/example-block.component"})," to annotate Do / Don't / Tip patterns in any MDX doc page."]}),`
