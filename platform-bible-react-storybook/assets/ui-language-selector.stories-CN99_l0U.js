import{j as s}from"./jsx-runtime-CpJVLSOc.js";import{r as V}from"./iframe-yPAa1VDz.js";import{c as D}from"./shadcn-ui.util-DMJ19wEV.js";import{S as J,a as $,b as B,c as H,d as Y}from"./select-wkYm0ptx.js";import{L as F}from"./label-bNx9NLAp.js";import{T as W}from"./theme-provider.component-DixGqTDZ.js";import"./index-BPGejIto.js";import"./index-DcnJBkHD.js";import"./index-BaQP4hhM.js";import"./index-CrNzMSiX.js";import"./index-C99YDX8w.js";import"./index-BI6grIak.js";import"./index-OsuKPKfK.js";import"./index-ctT1G4HE.js";import"./index-DxDigvl0.js";import"./index-CgWi8wAG.js";import"./index-Cz-YcScH.js";import"./index-DVCRKRbD.js";import"./index-Cw0TAvo3.js";import"./index-DHqLgwnr.js";import"./floating-ui.react-dom-OoAXyBqi.js";import"./floating-ui.dom-DCpBEVSC.js";import"./index-DOMlVbt-.js";import"./index-5ThZyF2R.js";import"./index-CF-tLLH3.js";import"./index-T4bvVDRr.js";import"./index-CKLcROOb.js";import"./index-CrjidT_H.js";import"./index-BPbCuWFR.js";import"./chevron-down-Dgiw2quU.js";import"./createLucideIcon-BDjl8ByP.js";import"./check-3chwUSWF.js";const M=(e,a)=>e[a]??a;function o({knownUiLanguages:e,primaryLanguage:a="en",fallbackLanguages:t=[],onLanguagesChange:m,onPrimaryLanguageChange:d,onFallbackLanguagesChange:h,localizedStrings:q,className:K}){const O=M(q,"%settings_uiLanguageSelector_selectFallbackLanguages%"),[R,p]=V.useState(!1),G=n=>{d&&d(n),m&&m([n,...t.filter(g=>g!==n)]),h&&t.find(g=>g===n)&&h([...t.filter(g=>g!==n)]),p(!1)},L=(n,g)=>{var y,b,k,S,w,C;const f=g!==n?((b=(y=e[n])==null?void 0:y.uiNames)==null?void 0:b[g])??((S=(k=e[n])==null?void 0:k.uiNames)==null?void 0:S.en):void 0;return f?`${(w=e[n])==null?void 0:w.autonym} (${f})`:(C=e[n])==null?void 0:C.autonym};return s.jsxs("div",{className:D("pr-twp tw-max-w-sm",K),children:[s.jsxs(J,{name:"uiLanguage",value:a,onValueChange:G,open:R,onOpenChange:n=>p(n),children:[s.jsx($,{children:s.jsx(B,{})}),s.jsx(H,{className:"tw-z-[250]",children:Object.keys(e).map(n=>s.jsx(Y,{value:n,children:L(n,a)},n))})]}),a!=="en"&&s.jsxs(s.Fragment,{children:[s.jsx(F,{className:"tw-ms-3",children:O}),s.jsx("div",{className:"tw-ms-3",children:s.jsxs(F,{children:["Currently:"," ",(t==null?void 0:t.length)>0?`${t.map(n=>L(n,a)).join(", ")}`:`default (${e.en.autonym})`]})})]})]})}o.__docgenInfo={description:`A component for selecting the user interface language and managing fallback languages. Allows
...
}`,...(I=(E=c.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};const ve=["Default","WithFallbackLanguages","LimitedLanguages","AsianLanguages"];export{c as AsianLanguages,i as Default,u as LimitedLanguages,l as WithFallbackLanguages,ve as __namedExportsOrder,Ue as default};
