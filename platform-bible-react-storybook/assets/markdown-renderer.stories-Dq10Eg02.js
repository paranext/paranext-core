import{j as a}from"./jsx-runtime-B8v8HYgF.js";import{M as T}from"./markdown-renderer.component-KKSEMmcX.js";import{T as j}from"./theme-provider.component-D55AK_jg.js";import"./iframe-wA5_ufbN.js";import"./shadcn-ui.util-DMJ19wEV.js";const R={title:"Advanced/MarkdownRenderer",component:T,tags:["autodocs"],decorators:[v=>a.jsx(j,{children:a.jsx("div",{className:"tw-max-w-4xl tw-p-4",children:a.jsx(v,{})})})],argTypes:{markdown:{control:"text"},className:{control:"text"},anchorTarget:{control:"select",options:["_blank","_self","_parent","_top"]}}},e={args:{markdown:`# Hello World
