import{j as e}from"./jsx-runtime-BqcUmbcY.js";import{B as u}from"./button-DYE7RU8d.js";import{I as m}from"./input-C3oppNdn.js";import{r as f,a as w}from"./iframe-ZKpGX0KN.js";import{c as a}from"./utils-BPbySc-g.js";import{S as y}from"./search-OuidiqMY.js";import{X as b}from"./x-BrH3yvxn.js";const n=f.forwardRef(({value:r,onSearch:s,placeholder:o,isFullWidth:i,className:l,isDisabled:p=!1,id:c},h)=>{const t=w();return e.jsxs("div",{id:c,className:a("tw:relative",{"tw:w-full":i},l),children:[e.jsx(y,{className:a("tw:absolute tw:top-1/2 tw:h-4 tw:w-4 tw:-translate-y-1/2 tw:transform tw:opacity-50",{"tw:right-3":t==="rtl"},{"tw:left-3":t==="ltr"})}),e.jsx(m,{ref:h,className:"tw:w-full tw:text-ellipsis tw:pe-9 tw:ps-9",placeholder:o,value:r,onChange:d=>s(d.target.value),disabled:p}),r&&e.jsxs(u,{variant:"ghost",size:"icon",className:a("tw:absolute tw:top-1/2 tw:h-7 tw:-translate-y-1/2 tw:transform tw:hover:bg-transparent",{"tw:left-0":t==="rtl"},{"tw:right-0":t==="ltr"}),onClick:()=>{s("")},children:[e.jsx(b,{className:"tw:h-4 tw:w-4"}),e.jsx("span",{className:"tw:sr-only",children:"Clear"})]})]})});n.displayName="SearchBar";n.__docgenInfo={description:`A search bar component with a search icon and a clear button when the search query is not empty.
