import{r as g,j as n}from"./iframe-DlHZf3Mf.js";import"./index-D7R6UePp.js";import{c as D}from"./utils-BPbySc-g.js";import{Z as B}from"./z-index-CoNkaVR8.js";import{S as J,a as H,b as Y,c as Z,d as $}from"./select-DRjRgpnS.js";import{L as M}from"./label-CVQAnUiG.js";import{L as X}from"./scripture-util-CIEEBU92-DFh2FVNP.js";import"./preload-helper-CTOgD26E.js";import"./index.es-LuWhpyxP.js";import"./index-D2t4nnj1.js";import"./createReactComponent-DmqfEhuE.js";import"./IconCheck-Cmfptwaf.js";import"./index-BaQP4hhM.js";import"./index-DgSXEhYl.js";import"./index-DoEngwzP.js";import"./index-D-Zpaie_.js";import"./index-BsYkzU57.js";import"./index-DPlOqNfc.js";import"./index-DBGo_7pW.js";import"./index-DwkXEaN0.js";import"./index-nFXyW1uq.js";import"./index-BQjQT5_6.js";import"./index-rfCQCPEE.js";import"./index-CwogW9J1.js";import"./index-C7jFbNlB.js";import"./index-JCra-ll0.js";import"./index-BxcXJXbY.js";const Q=(a,t)=>a[t]??t;function b({knownUiLanguages:a,primaryLanguage:t="en",fallbackLanguages:s=[],onLanguagesChange:l,onPrimaryLanguageChange:u,onFallbackLanguagesChange:c,localizedStrings:y,className:L,id:S}){const o=Q(y,"%settings_uiLanguageSelector_fallbackLanguages%"),[V,k]=g.useState(!1),W=e=>{u&&u(e),l&&l([e,...s.filter(r=>r!==e)]),c&&s.find(r=>r===e)&&c([...s.filter(r=>r!==e)]),k(!1)},w=(e,r)=>{var j,U,z,N,T,v;const _=r!==e?((U=(j=a[e])==null?void 0:j.uiNames)==null?void 0:U[r])??((N=(z=a[e])==null?void 0:z.uiNames)==null?void 0:N.en):void 0;return _?`${(T=a[e])==null?void 0:T.autonym} (${_})`:(v=a[e])==null?void 0:v.autonym};return n.jsxs("div",{id:S,className:D("pr-twp tw:max-w-sm",L),children:[n.jsxs(J,{name:"uiLanguage",value:t,onValueChange:W,open:V,onOpenChange:e=>k(e),children:[n.jsx(H,{children:n.jsx(Y,{})}),n.jsx(Z,{style:{zIndex:B},children:Object.keys(a).map(e=>n.jsx($,{value:e,children:w(e,t)},e))})]}),t!=="en"&&n.jsx("div",{className:"tw:pt-3",children:n.jsx(M,{className:"tw:font-normal tw:text-muted-foreground",children:X(o,{fallbackLanguages:(s==null?void 0:s.length)>0?s.map(e=>w(e,t)).join(", "):a.en.autonym})})})]})}b.__docgenInfo={description:`A component for selecting the user interface language and managing fallback languages. Allows
