import{j as o}from"./jsx-runtime-0n10FHbf.js";import{B as A}from"./button-D-EhjlNU.js";import{S as ge,a as fe,b as ye,c as we,e as Ce,d as Se}from"./select-Dr9YBsUo.js";import{T as be,b as Ne,c as V,d as ve,e as ke,f as Re}from"./table-D25v_dmY.js";import{c as j}from"./shadcn-ui.util-DMJ19wEV.js";import{n as q,m as H,v as M,e as I}from"./index-DgvB8rDJ.js";import{u as xe,f as G,b as Te,c as De,d as Ee,e as je}from"./index-CTsfBhww.js";import{r as d,a as Me}from"./iframe-CrA6hLjd.js";import{C as Ie}from"./chevron-down-DTIZ-Jnu.js";import{C as Ge}from"./chevron-right-CfICeDgn.js";import{C as Ae}from"./chevron-left-D9XDZc7t.js";import{T as qe}from"./theme-provider.component-EJf0MO_U.js";import"./index-C-euXnQ_.js";import"./index-BPbCuWFR.js";import"./index-JsiFs-1C.js";import"./index-BwPvjrzS.js";import"./index-BaQP4hhM.js";import"./index-DTAXz6r9.js";import"./index-BTa3HrhZ.js";import"./index-CQ3ZZfds.js";import"./index-CztYIw5n.js";import"./index-XnAP8DkX.js";import"./index-Hm4JIHjh.js";import"./index-DhziNXYZ.js";import"./index-LhGV0FVu.js";import"./floating-ui.react-dom-CgjoH1Zw.js";import"./index-DeQzfF6i.js";import"./index-BI-xLmJE.js";import"./index-CTBXtQXg.js";import"./index-B48o4cvK.js";import"./index-_Tv5pBjX.js";import"./index-DpWuK4cO.js";import"./index-BRjJA3cc.js";import"./index-D6V8voRD.js";import"./index-Bh1weZxB.js";import"./check-DktvhHtE.js";import"./createLucideIcon-DgczJKdr.js";import"./chevron-up-CWqxiD3N.js";import"./index-RSIxtB2F.js";import"./preload-helper-CTOgD26E.js";const p="scrBook",Oe="scrRef",g="source",Be="details",Je="Scripture Reference",Ve="Scripture Book",ne="Type",He="Details";function $e(e,c){const i=c??!1;return[{accessorFn:t=>`${t.start.book} ${t.start.chapterNum}:${t.start.verseNum}`,id:p,header:(e==null?void 0:e.scriptureReferenceColumnName)??Je,cell:t=>{const n=t.row.original;return t.row.getIsGrouped()?H.bookIdToEnglishName(n.start.book):t.row.groupingColumnId===p?M(n.start):void 0},getGroupingValue:t=>H.bookIdToNumber(t.start.book),sortingFn:(t,n)=>q(t.original.start,n.original.start),enableGrouping:!0},{accessorFn:t=>M(t.start),id:Oe,header:void 0,cell:t=>{const n=t.row.original;return t.row.getIsGrouped()?void 0:M(n.start)},sortingFn:(t,n)=>q(t.original.start,n.original.start),enableGrouping:!1},{accessorFn:t=>t.source.displayName,id:g,header:i?(e==null?void 0:e.typeColumnName)??ne:void 0,cell:t=>i||t.row.getIsGrouped()?t.getValue():void 0,getGroupingValue:t=>t.source.id,sortingFn:(t,n)=>t.original.source.displayName.localeCompare(n.original.source.displayName),enableGrouping:!0},{accessorFn:t=>t.detail,id:Be,header:(e==null?void 0:e.detailsColumnName)??He,cell:t=>t.getValue(),enableGrouping:!1}]}const Ue=e=>{if(!("offset"in e.start))throw new Error("No offset available in range start");if(e.end&&!("offset"in e.end))throw new Error("No offset available in range end");const{offset:c}=e.start;let i=0;return e.end&&({offset:i}=e.end),!e.end||q(e.start,e.end)===0?`${I(e.start)}+${c}`:`${I(e.start)}+${c}-${I(e.end)}+${i}`},$=e=>`${Ue({start:e.start,end:e.end})} ${e.source.displayName} ${e.detail}`;function O({sources:e,showColumnHeaders:c=!1,showSourceColumn:i=!1,scriptureReferenceColumnName:t,scriptureBookGroupName:n,typeColumnName:u,detailsColumnName:m,onRowSelected:l,id:R}){const[h,B]=d.useState([]),[ie,x]=d.useState([{id:p,desc:!1}]),[J,ce]=d.useState({}),T=d.useMemo(()=>e.flatMap(r=>r.data.map(s=>({...s,source:r.source}))),[e]),ue=d.useMemo(()=>$e({scriptureReferenceColumnName:t,typeColumnName:u,detailsColumnName:m},i),[t,u,m,i]);d.useEffect(()=>{h.includes(g)?x([{id:g,desc:!1},{id:p,desc:!1}]):x([{id:p,desc:!1}])},[h]);const w=xe({data:T,columns:ue,state:{grouping:h,sorting:ie,rowSelection:J},onGroupingChange:B,onSortingChange:x,onRowSelectionChange:ce,getExpandedRowModel:je(),getGroupedRowModel:Ee(),getCoreRowModel:De(),getSortedRowModel:Te(),getRowId:$,autoResetExpanded:!1,enableMultiRowSelection:!1,enableSubRowSelection:!1});d.useEffect(()=>{if(l){const r=w.getSelectedRowModel().rowsById,s=Object.keys(r);if(s.length===1){const f=T.find(a=>$(a)===s[0])||void 0;f&&l(f)}}},[J,T,l,w]);const D=n??Ve,E=u??ne,le=[{label:"No Grouping",value:[]},{label:`Group by ${D}`,value:[p]},{label:`Group by ${E}`,value:[g]},{label:`Group by ${D} and ${E}`,value:[p,g]},{label:`Group by ${E} and ${D}`,value:[g,p]}],de=r=>{B(JSON.parse(r))},pe=(r,s)=>{!r.getIsGrouped()&&!r.getIsSelected()&&r.getToggleSelectedHandler()(s)},me=(r,s)=>r.getIsGrouped()?"":j("banded-row",s%2===0?"even":"odd"),he=(r,s,f)=>{if(!((r==null?void 0:r.length)===0||s.depth<f.column.getGroupedIndex())){if(s.getIsGrouped())switch(s.depth){case 1:return"tw-ps-4";default:return}switch(s.depth){case 1:return"tw-ps-8";case 2:return"tw-ps-12";default:return}}};return o.jsxs("div",{id:R,className:"pr-twp tw-flex tw-h-full tw-w-full tw-flex-col",children:[!c&&o.jsxs(ge,{value:JSON.stringify(h),onValueChange:r=>{de(r)},children:[o.jsx(fe,{className:"tw-mb-1 tw-mt-2",children:o.jsx(ye,{})}),o.jsx(we,{position:"item-aligned",children:o.jsx(Ce,{children:le.map(r=>o.jsx(Se,{value:JSON.stringify(r.value),children:r.label},r.label))})})]}),o.jsxs(be,{className:"tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0",children:[c&&o.jsx(Ne,{children:w.getHeaderGroups().map(r=>o.jsx(V,{children:r.headers.filter(s=>s.column.columnDef.header).map(s=>o.jsx(ve,{colSpan:s.colSpan,className:"top-0 tw-sticky",children:s.isPlaceholder?void 0:o.jsxs("div",{children:[s.column.getCanGroup()?o.jsx(A,{variant:"ghost",title:`Toggle grouping by ${s.column.columnDef.header}`,onClick:s.column.getToggleGroupingHandler(),type:"button",children:s.column.getIsGrouped()?"🛑":"👊 "}):void 0," ",G(s.column.columnDef.header,s.getContext())]})},s.id))},r.id))}),o.jsx(ke,{children:w.getRowModel().rows.map((r,s)=>{const f=Me();return o.jsx(V,{"data-state":r.getIsSelected()?"selected":"",className:j(me(r,s)),onClick:a=>pe(r,a),children:r.getVisibleCells().map(a=>{if(!(a.getIsPlaceholder()||a.column.columnDef.enableGrouping&&!a.getIsGrouped()&&(a.column.columnDef.id!==g||!i)))return o.jsx(Re,{className:j(a.column.columnDef.id,"tw-p-[1px]",he(h,r,a)),children:a.getIsGrouped()?o.jsxs(A,{variant:"link",onClick:r.getToggleExpandedHandler(),type:"button",children:[r.getIsExpanded()&&o.jsx(Ie,{}),!r.getIsExpanded()&&(f==="ltr"?o.jsx(Ge,{}):o.jsx(Ae,{}))," ",G(a.column.columnDef.cell,a.getContext())," (",r.subRows.length,")"]}):G(a.column.columnDef.cell,a.getContext())},a.id)})},r.id)})})]})]})}O.__docgenInfo={description:`Component to display a combined list of detailed items from one or more sources, where the items
...
}`,...(te=(ee=N.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var re,se,oe;v.parameters={...v.parameters,docs:{...(re=v.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: args => {
...
}`,...(oe=(se=v.parameters)==null?void 0:se.docs)==null?void 0:oe.source}}};const Mt=["Default","CustomColumnNames","EmptyState","SingleCheck","Interactive"];export{S as CustomColumnNames,C as Default,b as EmptyState,v as Interactive,N as SingleCheck,Mt as __namedExportsOrder,jt as default};
