import{j as t}from"./jsx-runtime-Dr4sgJAZ.js";import{r as A}from"./iframe-DvY_I9Yw.js";import{c as b}from"./shadcn-ui.util-DMJ19wEV.js";import{C as K}from"./card-CYTCi5dN.js";import{P as O}from"./index-DOKkQ3oI.js";import{F as D,u as a}from"./footnotes.usj.data-D5KR1Ezq.js";import{T as G}from"./theme-provider.component-CvyICePi.js";import"./circle-alert-00oLXD_U.js";import"./createLucideIcon-CMaxIgo_.js";import"./index-C3mJiya3.js";const J=(e,o)=>e[o]??o;function h({className:e,footnotes:o,layout:n="horizontal",listId:u,selectedFootnote:p,showMarkers:N=!0,suppressFormatting:E=!1,formatCaller:R,onFootnoteSelected:f,localizedStrings:w}){const B=w?J(w,"%webView_footnoteList_header%"):"Footnotes",P=R??O(o,void 0),U=r=>{f&&f(r)};return t.jsxs(t.Fragment,{children:[n==="vertical"&&t.jsx("div",{className:"tw-mb-2 tw-font-semibold",children:B}),t.jsx("div",{role:"listbox","aria-label":"Footnotes",className:b(n==="horizontal"?"tw-table tw-border-collapse":"tw-flex tw-flex-col tw-gap-1",!E&&"formatted-font",e),children:o.map((r,g)=>{const y=r===p,W=`${u}-${g}`;return t.jsx(K,{role:"option","aria-selected":y,"data-marker":r.marker,className:b(f&&"tw-cursor-pointer","tw-rounded-sm tw-border-0 tw-bg-transparent tw-shadow-none",y&&"tw-bg-muted/70",n==="horizontal"?"horizontal tw-table-row":"vertical tw-block tw-px-1 tw-py-0 tw-text-sm"),onClick:()=>U(r),children:t.jsx(D,{footnote:r,layout:n,formatCaller:()=>P(r.caller,g),showMarkers:N})},W)})})]})}h.__docgenInfo={description:"`FootnoteList` is a component that provides a read-only display of a list of USFM/JSX footnote.",methods:[],displayName:"FootnoteList",props:{className:{required:!1,tsType:{name:"string"},description:"Optional additional class name for styling"},footnotes:{required:!0,tsType:{name:"Array",elements:[{name:"MarkerObject"}],raw:"MarkerObject[]"},description:"The footnotes to display (typically from JSX). See {@link FootnoteItemProps.footnote}"},layout:{required:!1,tsType:{name:"union",raw:"'horizontal' | 'vertical'",elements:[{name:"literal",value:"'horizontal'"},{name:"literal",value:"'vertical'"}]},description:`Determines how footnotes are displayed:
