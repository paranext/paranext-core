import{j as e}from"./jsx-runtime-BqcUmbcY.js";import{T as r,M as u}from"./tab-dropdown-menu.component-BYTW447j.js";import{T as p}from"./tab-toolbar-container.component-C0Nb9B2f.js";import{E as h}from"./ellipsis-vertical-zAV0VPx6.js";function f({onSelectProjectMenuItem:s,onSelectViewInfoMenuItem:i,projectMenuData:t,tabViewMenuData:n,id:l,className:m,startAreaChildren:o,centerAreaChildren:a,endAreaChildren:c,menuButtonIcon:d}){return e.jsxs(p,{className:`tw:w-full tw:border ${m}`,id:l,children:[t&&e.jsx(r,{onSelectMenuItem:s,menuData:t,tabLabel:"Project",icon:d??e.jsx(u,{}),buttonVariant:"ghost"}),o&&e.jsx("div",{className:"tw:flex tw:h-full tw:shrink tw:grow-[10] tw:flex-row tw:flex-wrap tw:items-start tw:gap-x-1 tw:gap-y-2 tw:overflow-clip",children:o}),a&&e.jsx("div",{className:"tw:flex tw:h-full tw:shrink tw:grow-[1] tw:basis-0 tw:flex-row tw:flex-wrap tw:items-start tw:justify-center tw:gap-x-1 tw:gap-y-2 tw:overflow-clip tw:@sm:basis-auto",children:a}),e.jsxs("div",{className:"tw:flex tw:h-full tw:shrink tw:grow-[1] tw:flex-row-reverse tw:flex-wrap tw:items-start tw:gap-x-1 tw:gap-y-2 tw:overflow-clip",children:[n&&e.jsx(r,{onSelectMenuItem:i,menuData:n,tabLabel:"View Info",icon:e.jsx(h,{}),className:"tw:h-full"}),c]})]})}f.__docgenInfo={description:`Toolbar that holds the project menu icon on one side followed by three different areas/categories
...
side in ltr, left side in rtl). Recommended for secondary tools and view options.`}}};export{f as T};
