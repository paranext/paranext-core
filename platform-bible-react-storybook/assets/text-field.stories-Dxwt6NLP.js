...
Based on shadcn-ui Input component with additional features like error states and full-width support.
...
}`,...(W=(I=c.parameters)==null?void 0:I.docs)==null?void 0:W.source}}};var C,k,R;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    label: 'Email',
    placeholder: 'user@example.com',
    hasError: true,
  ...
  render: () => {
    ...
    return <form onSubmit={handleSubmit} className="tw:max-w-md tw:space-y-4">
        ...
        <button type="submit" className="tw:rounded tw:bg-blue-500 tw:px-4 tw:py-2 tw:text-white tw:hover:bg-blue-600">
          Submit Form
        </button>
      </form>;
  },
...
}`,...(X=(Q=T.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};const xe=["Default","WithHelperText","Required","WithError","Disabled","FullWidth","NoLabel","WithDefaultValue","Controlled","InteractiveExample"];export{g as Controlled,u as Default,h as Disabled,f as FullWidth,T as InteractiveExample,b as NoLabel,c as Required,x as WithDefaultValue,p as WithError,m as WithHelperText,xe as __namedExportsOrder,be as default};
