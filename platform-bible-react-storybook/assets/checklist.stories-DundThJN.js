...
@returns A react node representing the label text and any additional elements (e.g. links) for
  the checkbox associated with that item`}}};const{fn:u}=__STORYBOOK_MODULE_TEST__,te={title:"Basics/Checklist",component:m,tags:["autodocs"],decorators:[e=>n.jsx(N,{children:n.jsx(e,{})})],argTypes:{handleSelectListItem:{action:"item selected"},listItems:{control:"object"},selectedListItems:{control:"object"}}},d={args:{listItems:["Item 1","Item 2","Item 3","Item 4"],selectedListItems:["Item 2"],handleSelectListItem:u()}},p={render:e=>{const[c,r]=f.useState(["Box B","Box E"]),l=(s,i)=>{var a;r(i?t=>[...t,s]:t=>t.filter(o=>o!==s)),(a=e.handleSelectListItem)==null||a.call(e,s,i)};return n.jsx(E,{children:n.jsx(_,{className:"tw:h-64 tw:w-full tw:overflow-auto tw:p-4",children:n.jsx(m,{...e,selectedListItems:c,handleSelectListItem:l})})})},args:{listItems:["Box A","Box B","Box C","Box D","Box E","Box F"],selectedListItems:["Box B","Box E"],handleSelectListItem:u()},parameters:{docs:{description:{story:"A checklist displayed inside a card container, similar to the original example."}}}},h={render:e=>{const[c,r]=f.useState([]),l=(s,i)=>{var a;r(i?t=>[...t,s]:t=>t.filter(o=>o!==s)),(a=e.handleSelectListItem)==null||a.call(e,s,i)};return n.jsx("div",{className:"tw:h-96 tw:w-80",children:n.jsx(m,{...e,selectedListItems:c,handleSelectListItem:l})})},args:{listItems:Array.from({length:20},(e,c)=>`Item ${c+1}`),selectedListItems:[],handleSelectListItem:u()},parameters:{docs:{description:{story:"A checklist with many items to demonstrate scrolling behavior."}}}},I={render:e=>{const[c,r]=f.useState(e.selectedListItems||[]),l=(s,i)=>{var a;r(i?t=>[...t,s]:t=>t.filter(o=>o!==s)),(a=e.handleSelectListItem)==null||a.call(e,s,i)};return n.jsx(m,{...e,selectedListItems:c,handleSelectListItem:l})},args:{listItems:["Apple","Banana","Cherry","Date","Elderberry"],selectedListItems:["Banana","Date"],handleSelectListItem:u()},parameters:{docs:{description:{story:"An interactive checklist where you can select and deselect items."}}}};var g,S,x;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
...
}`,...(A=(k=I.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};const se=["Default","InCard","ManyItems","Interactive"];export{d as Default,p as InCard,I as Interactive,h as ManyItems,se as __namedExportsOrder,te as default};
