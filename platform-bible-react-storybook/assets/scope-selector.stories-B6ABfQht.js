...
}`,...(to=(oo=U.parameters)==null?void 0:oo.docs)==null?void 0:to.source}}};var so,ro,co;X.parameters={...X.parameters,docs:{...(so=X.parameters)==null?void 0:so.docs,source:{originalSource:`{
  render: () => {
...
}`,...(co=(ro=X.parameters)==null?void 0:ro.docs)==null?void 0:co.source}}};var ao,no,lo;Y.parameters={...Y.parameters,docs:{...(ao=Y.parameters)==null?void 0:ao.docs,source:{originalSource:`{
  render: () => {
...
}`,...(lo=(no=Y.parameters)==null?void 0:no.docs)==null?void 0:lo.source}}};var io,po,_o;Z.parameters={...Z.parameters,docs:{...(io=Z.parameters)==null?void 0:io.docs,source:{originalSource:`{
  render: () => {
    const [scope, setScope] = useState<ScopeWithRange>('chapter');
    const [selectedBookIds, setSelectedBookIds] = useState<string[]>([]);
...
}`,...(Bo=(Vo=te.parameters)==null?void 0:Vo.docs)==null?void 0:Bo.source}}};const zs=["BookScope","ChapterScope","VerseScope","DropdownVariant","RangeScope","DropdownVariantWithRange","SelectedBooksScope","WithLocalizedSpanishBookNames","WithLocalizedGermanBookNames"];export{U as BookScope,X as ChapterScope,Z as DropdownVariant,Q as DropdownVariantWithRange,$ as RangeScope,ee as SelectedBooksScope,Y as VerseScope,te as WithLocalizedGermanBookNames,oe as WithLocalizedSpanishBookNames,zs as __namedExportsOrder,fs as default};
