import{r as g,j as n}from"./iframe-BKgemRh8.js";import"./index-D7R6UePp.js";import{c as D}from"./utils-BPbySc-g.js";import{Z as B}from"./z-index-CoNkaVR8.js";import{S as J,a as H,b as Y,c as Z,d as $}from"./select-BMTiXIU-.js";import{L as M}from"./label-lBjWviSe.js";import{L as X}from"./scripture-util-A_1QUftH-D53X2Fsv.js";import"./preload-helper-CTOgD26E.js";import"./index.es-LuWhpyxP.js";import"./index-D2t4nnj1.js";import"./createReactComponent-CTJHBWV5.js";import"./IconCheck-AEpd7XOj.js";import"./index-BaQP4hhM.js";import"./index-C8es8i9D.js";import"./index-BVYxFj06.js";import"./index-ywlZNr8t.js";import"./index-C93DrdLf.js";import"./index-Dq8ueH-k.js";import"./index-VMrod6fs.js";import"./index-DFFzh_ru.js";import"./index-CydVGB-y.js";import"./index-BRrynz2M.js";import"./index-fE0IAtRj.js";import"./index-DFtKyvFu.js";import"./index-yyz9vigC.js";import"./index-DSBRtqdf.js";import"./index-FgQIszvO.js";const Q=(a,t)=>a[t]??t;function b({knownUiLanguages:a,primaryLanguage:t="en",fallbackLanguages:s=[],onLanguagesChange:l,onPrimaryLanguageChange:u,onFallbackLanguagesChange:c,localizedStrings:y,className:L,id:S}){const o=Q(y,"%settings_uiLanguageSelector_fallbackLanguages%"),[V,k]=g.useState(!1),W=e=>{u&&u(e),l&&l([e,...s.filter(r=>r!==e)]),c&&s.find(r=>r===e)&&c([...s.filter(r=>r!==e)]),k(!1)},w=(e,r)=>{var j,U,z,N,T,v;const _=r!==e?((U=(j=a[e])==null?void 0:j.uiNames)==null?void 0:U[r])??((N=(z=a[e])==null?void 0:z.uiNames)==null?void 0:N.en):void 0;return _?`${(T=a[e])==null?void 0:T.autonym} (${_})`:(v=a[e])==null?void 0:v.autonym};return n.jsxs("div",{id:S,className:D("pr-twp tw:max-w-sm",L),children:[n.jsxs(J,{name:"uiLanguage",value:t,onValueChange:W,open:V,onOpenChange:e=>k(e),children:[n.jsx(H,{children:n.jsx(Y,{})}),n.jsx(Z,{style:{zIndex:B},children:Object.keys(a).map(e=>n.jsx($,{value:e,children:w(e,t)},e))})]}),t!=="en"&&n.jsx("div",{className:"tw:pt-3",children:n.jsx(M,{className:"tw:font-normal tw:text-muted-foreground",children:X(o,{fallbackLanguages:(s==null?void 0:s.length)>0?s.map(e=>w(e,t)).join(", "):a.en.autonym})})})]})}b.__docgenInfo={description:`A component for selecting the user interface language and managing fallback languages. Allows
