import{j as e}from"./jsx-runtime-Dp1lb1Uf.js";import{r as W}from"./iframe-bGuH-Abg.js";import{c as Z}from"./shadcn-ui.util-DMJ19wEV.js";import{E as K,a as Y}from"./error-dump.component-JDA8r_g7.js";import{P as X,a as $,b as J}from"./popover-OKJ4Fsc_.js";import{L as Q}from"./label-CJfTsZjw.js";import{B as c}from"./badge-DS36Mpp6.js";import{B as m}from"./button-C2duuinP.js";import{c as O}from"./createLucideIcon-DYoKyj6y.js";import{C as u}from"./circle-x-Bk56_fHc.js";import"./index-B8OM6TYd.js";import"./index-DDdVzcAn.js";import"./index-z4Q_vUym.js";import"./index-DzkNuuhM.js";import"./index-DL8D4WRY.js";import"./index-Cum9p26y.js";import"./index-BkoBbs9Y.js";import"./index-BhiuDxmi.js";import"./index-1rRh4qjs.js";import"./index-9OUeuJVn.js";import"./index-Da_NMWbH.js";import"./floating-ui.react-dom-GvR0HUTI.js";import"./floating-ui.dom-DCpBEVSC.js";import"./index-DNIXYOBq.js";import"./index-Py-aa8T1.js";import"./index-BWEqzBJi.js";import"./index-CxVRFFEA.js";import"./index-Cp9fuXBs.js";import"./index-BPbCuWFR.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const re=[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]],h=O("TriangleAlert",re);Object.freeze([...Y,"%webView_error_dump_copied_message%"]);function r({errorDetails:p,handleCopyNotify:g,localizedStrings:w,children:M,className:F}){const[q,f]=W.useState(!1),G=()=>{f(!0),g&&g()},U=H=>{H||f(!1)};return e.jsxs(X,{onOpenChange:U,children:[e.jsx($,{asChild:!0,children:M}),e.jsxs(J,{className:Z("tw-min-w-80 tw-max-w-96",F),children:[q&&w["%webView_error_dump_copied_message%"]&&e.jsx(Q,{children:w["%webView_error_dump_copied_message%"]}),e.jsx(K,{errorDetails:p,handleCopyNotify:G,localizedStrings:w})]})]})}r.__docgenInfo={description:"A popover component that displays detailed error information using the ErrorDump component.",methods:[],displayName:"ErrorPopover",props:{localizedStrings:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  [localizedKey in (typeof ERROR_POPOVER_STRING_KEYS)[number]]?: string;
}`,signature:{properties:[{key:{name:"unknown[number]",raw:"(typeof ERROR_POPOVER_STRING_KEYS)[number]",required:!1},value:{name:"string"}}]}},description:"List of localized strings to localize the strings in this component. Relevant keys can be\nfound in `ERROR_POPOVER_STRING_KEYS`"},className:{required:!1,tsType:{name:"string"},description:"Optional CSS classes to insert into the `PopoverContent`"}}};const Ve={title:"Advanced/ErrorPopover",component:r,tags:["autodocs"],parameters:{docs:{description:{component:`
...
Performance: 2.3ms render time`,localizedStrings:{"%webView_error_dump_header%":"Debug Information","%webView_error_dump_info_message%":"Component state and performance details for debugging.","%webView_error_dump_copied_message%":"Debug details copied to clipboard!"},children:e.jsxs(m,{variant:"ghost",size:"sm",children:[e.jsx(te,{className:"tw-mr-2 tw-h-4 tw-w-4"}),"Debug Info"]})},parameters:{docs:{description:{story:"Using the ErrorPopover to show debug information instead of error details."}}}},n={args:{errorDetails:`Critical System Error: Database Connection Failed
...
}`,...(V=(R=n.parameters)==null?void 0:R.docs)==null?void 0:V.source}}};var T,B,z;d.parameters={...d.parameters,docs:{...(T=d.parameters)==null?void 0:T.docs,source:{originalSource:`{
...
}`,...(z=(B=d.parameters)==null?void 0:B.docs)==null?void 0:z.source}}};var I,A,L;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(L=(A=l.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};const Te=["Default","WithErrorIcon","ErrorBadge","DebugInfo","LargeError","InlineErrorIndicator","MultipleErrorSources"];export{i as DebugInfo,o as Default,s as ErrorBadge,d as InlineErrorIndicator,n as LargeError,l as MultipleErrorSources,a as WithErrorIcon,Te as __namedExportsOrder,Ve as default};
