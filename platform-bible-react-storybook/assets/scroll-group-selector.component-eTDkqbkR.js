import{b as g,j as o}from"./iframe-BLkHDPc2.js";import"./index-D-9MTPZD.js";import{Y as r,u as s}from"./scripture-util-BiADhCws-RVM_j59p.js";import"./index.es-LuWhpyxP.js";import{S as h,a as S,b as y,c as I,d as z}from"./select-B_RqIaAC.js";import{c as G}from"./utils-BPbySc-g.js";import{Z as w}from"./z-index-CoNkaVR8.js";function b({availableScrollGroupIds:i,scrollGroupId:n,onChangeScrollGroupId:a,localizedStrings:d={},size:c="sm",className:u,id:p,disabled:m}){const l={...r,...Object.fromEntries(Object.entries(d).map(([e,t])=>[e,e===t&&e in r?r[e]:t]))},f=g();return o.jsxs(h,{value:`${n}`,onValueChange:e=>a(e==="undefined"?void 0:parseInt(e,10)),disabled:m,children:[o.jsx(S,{size:c,className:G("pr-twp tw:w-auto",u),children:o.jsx(y,{placeholder:l[s(n)]??n})}),o.jsx(I,{id:p,align:f==="rtl"?"end":"start",style:{zIndex:w},children:i.map(e=>o.jsx(z,{value:`${e}`,children:l[s(e)]},`${e}`))})]})}b.__docgenInfo={description:"Selector component for choosing a scroll group",methods:[],displayName:"ScrollGroupSelector",props:{availableScrollGroupIds:{required:!0,tsType:{name:"Array",elements:[{name:"unknown"}],raw:"(ScrollGroupId | undefined)[]"},description:"List of scroll group ids to show to the user. Either a `ScrollGroupId` or `undefined` for no\nscroll group"},scrollGroupId:{required:!0,tsType:{name:"union",raw:"ScrollGroupId | undefined",elements:[{name:"ScrollGroupId"},{name:"undefined"}]},description:"Currently selected scroll group id. `undefined` for no scroll group"},onChangeScrollGroupId:{required:!0,tsType:{name:"signature",type:"function",raw:"(newScrollGroupId: ScrollGroupId | undefined) => void",signature:{arguments:[{type:{name:"union",raw:"ScrollGroupId | undefined",elements:[{name:"ScrollGroupId"},{name:"undefined"}]},name:"newScrollGroupId"}],return:{name:"void"}}},description:"Callback function run when the user tries to change the scroll group id"},localizedStrings:{required:!1,tsType:{name:"LanguageStrings"},description:`Localized strings to use for displaying scroll group ids. Must be an object whose keys are
