import{j as e,M as i}from"./iframe-D69FfaBZ.js";import{useMDXComponents as s}from"./index-4vQpFkAA.js";import"./preload-helper-CTOgD26E.js";function o(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Guidelines/Component Choices"}),`
...
`,e.jsx(n.h2,{id:"zero-states",children:"Zero states"}),`
`,e.jsx(n.p,{children:"When a list, grid, or panel has nothing to show, say so — do not leave the region blank."}),`
`,e.jsx(n.p,{children:"For a plain one-line message, use"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://paranext.github.io/paranext-core/platform-bible-react-storybook/?path=/docs/basics-emptystate--docs",rel:"nofollow",children:"EmptyState"})," - takes a single localized ",e.jsx(n.code,{children:"message"})," and renders it in a ",e.jsx(n.code,{children:'role="status"'})," region"]}),`
`]}),`
`,e.jsx(n.p,{children:"For a zero state that needs media, a heading, or a call to action, use"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://paranext.github.io/paranext-core/platform-bible-react-storybook/?path=/docs/shadcn-empty--docs",rel:"nofollow",children:"Empty"})," - the composition ",e.jsx(n.code,{children:"Empty"})," / ",e.jsx(n.code,{children:"EmptyHeader"})," / ",e.jsx(n.code,{children:"EmptyMedia"})," / ",e.jsx(n.code,{children:"EmptyTitle"})," / ",e.jsx(n.code,{children:"EmptyDescription"})," / ",e.jsx(n.code,{children:"EmptyContent"})]}),`
`]}),`
`,e.jsx(n.p,{children:"Make sure to"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:'Say what is empty and what the user can do next, not just "No items"'}),`
`,e.jsxs(n.li,{children:["Add ",e.jsx(n.code,{children:'role="status"'})," yourself when using ",e.jsx(n.code,{children:"Empty"})," for a region whose content just changed, and keep that element mounted across the change so it is announced"]}),`
`,e.jsxs(n.li,{children:["Pass a border width (",e.jsx(n.code,{children:"tw:border"}),") when you want ",e.jsx(n.code,{children:"Empty"}),"'s dashed outline - the component sets the dashed style only"]}),`
`,e.jsxs(n.li,{children:["Nest your own heading element inside ",e.jsx(n.code,{children:"EmptyTitle"})," when the zero state is a region's entire content, since ",e.jsx(n.code,{children:"EmptyTitle"})," renders a ",e.jsx(n.code,{children:"<div>"})]}),`
