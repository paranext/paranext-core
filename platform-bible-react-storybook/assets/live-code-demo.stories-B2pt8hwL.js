import{j as t}from"./jsx-runtime-BmxVfNc0.js";import{B as r}from"./button-BkIaKqaq.js";import{I as b}from"./input-CIR4eapg.js";import{r as p,m as a}from"./iframe-jgBMr6l2.js";const I={"@/components/shadcn-ui/button":{Button:r},"@/components/shadcn-ui/input":{Input:b}};function N(){const[c,k]=p.useState("Hello, World!"),[i,d]=p.useState(0);return t.jsxs("div",{className:"tw-space-y-4 tw-p-4",children:[t.jsx("h2",{className:"tw-text-xl tw-font-bold",children:"Live Code Editor Demo"}),t.jsxs("div",{className:"tw-space-y-2",children:[t.jsx(b,{value:c,onChange:B=>k(B.target.value),placeholder:"Type something..."}),t.jsxs("p",{className:"tw-text-sm tw-text-gray-600",children:["You typed: ",c]})]}),t.jsxs("div",{className:"tw-space-y-2",children:[t.jsxs(r,{onClick:()=>d(i+1),children:["Clicked ",i," times"]}),t.jsx(r,{variant:"outline",onClick:()=>d(0),children:"Reset"})]})]})}const T={title:"Demo/Live Code Editor",component:N,tags:["!autodocs"],parameters:{componentSubtitle:"Interactive code editing examples"}},e={parameters:{docs:{description:{story:"Simple HTML/React editing, perfect for getting started"}}}};a(e,{code:`export default function SimpleTest() {
  return (
