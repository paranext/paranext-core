import{j as g}from"./jsx-runtime-BqcUmbcY.js";import{r as f}from"./iframe-BHmqropO.js";import{P as p}from"./index-CnlRi_gH.js";import{B as L,u as Ae}from"./book-chapter-control.component-CbqdzWpX.js";import"./preload-helper-CTOgD26E.js";import"./index.es-LuWhpyxP.js";import"./index-D2t4nnj1.js";import"./book-item.utils-096pl97F.js";import"./command-BqbYvq6X.js";import"./index-HITqkW98.js";import"./index-LvyWW8IL.js";import"./index-DjK6IG68.js";import"./index-UjzIuQMd.js";import"./index-BPGg1F8F.js";import"./index-NEI_WhtD.js";import"./index-CjxCei4R.js";import"./index-n0j6oQ2N.js";import"./index-CeTIBNqW.js";import"./index-BXsshLTm.js";import"./index-CwAAGKSY.js";import"./index-6ro3N_77.js";import"./index-gGi3k2st.js";import"./utils-BPbySc-g.js";import"./dialog-BbWtmIFE.js";import"./z-index-BATlIu8s.js";import"./button-BWDiQROe.js";import"./index-BnuTq2W6.js";import"./createReactComponent-Da4XkcvS.js";import"./input-group-DezHPZ7u.js";import"./input-C3oppNdn.js";import"./IconCheck-_0E-rNes.js";import"./check-BJGVTHjG.js";import"./createLucideIcon-BS6rFxVB.js";import"./popover-M_Q-0-2g.js";import"./index-CondEtzp.js";import"./index-CxA1nSMl.js";import"./chevron-right-Ddr-SM12.js";import"./arrow-right-6jIJnpXq.js";const{expect:i,fn:V,screen:M,waitFor:Se,within:c}=__STORYBOOK_MODULE_TEST__;function Ve({scrRef:a,handleSubmit:o,...n}){const[s,e]=f.useState(a),t=f.useCallback(d=>{e(d),o(d)},[o]);return g.jsxs("div",{className:"tw:p-4",children:[g.jsx(L,{...n,scrRef:s,handleSubmit:t}),g.jsxs("div",{className:"tw:mt-4 tw:text-sm tw:text-gray-600",children:["Current Reference: ",JSON.stringify(s,void 0,2)]})]})}const l="combobox",m="combobox",k="option";async function w(){const a=M.getByRole("dialog");return await Se(()=>i(a).toHaveStyle("opacity: 1")),await i(a).toBeVisible(),a}async function u(){const a=M.queryByRole("dialog");a?await Se(()=>i(a).toHaveAttribute("data-state","closed")):i(a).not.toBeInTheDocument()}function r(){return M.getByRole("dialog")}const Bt={title:"Advanced/BookChapterControl",component:L,tags:["autodocs"],args:{scrRef:p,handleSubmit:V(a=>console.log("Scripture reference changed:",a))},render:a=>g.jsx(Ve,{...a})},b={args:{scrRef:p}},C={args:{scrRef:{book:"PSA",chapterNum:135,verseNum:10}}},R={args:{scrRef:p,getActiveBookIds:()=>["GEN","EXO","MAT","JHN","ROM","REV"]},parameters:{docs:{description:{story:"Shows the component with a limited set of available books."}}}},B={args:{scrRef:p,className:"tw:w-64 tw:bg-blue-50 tw:rounded-xl tw:p-4"},parameters:{docs:{description:{story:"Shows the component with custom styling applied to the trigger button."}}}},I={args:{scrRef:p,getActiveBookIds:()=>[]},parameters:{docs:{description:{story:"Shows the component with an empty list of available books."}}}},T={args:{scrRef:{book:"ROM",chapterNum:8,verseNum:1}},play:async({canvas:a,userEvent:o,step:n,args:s})=>{await n("Open the book chapter control",async()=>{const e=a.getByRole(l);await i(e).toBeInTheDocument(),await o.click(e)}),await n("Select Romans book",async()=>{const e=await w(),t=c(e).getByText("Romans");await i(t).toBeInTheDocument(),await o.click(t)}),await n("Verify chapter grid is displayed for Romans",async()=>{const e=r(),t=c(e).getByRole(k,{name:"8"});await i(t).toBeInTheDocument()}),await n("Verify the correct number of chapters is shown for Romans",async()=>{const e=r(),t=c(e).getAllByRole(k);await i(t.length).toBe(16)}),await n("Select a different chapter",async()=>{const e=r(),t=c(e).getByRole(k,{name:"12"});await o.click(t)}),await n("Verify the different chapter number is selected",async()=>{await u();const e=a.getByRole(l);await i(e).toHaveTextContent("Romans 12:1"),await i(s.handleSubmit).toHaveBeenCalledWith({book:"ROM",chapterNum:12,verseNum:1})})},parameters:{docs:{description:{story:`
...
The localization is provided through the \`localizedBookNames\` prop, which maps English book IDs to their localized equivalents.
        `}}}},x={args:{scrRef:p,handleSubmit:V(),localizedBookNames:Pe},parameters:{docs:{description:{story:`
...
Note: This example includes a subset of books to demonstrate the localization feature. In practice, you would provide localized names for all available books.
        `}}}},Le={"%scripture_section_ot_long%":"Antiguo Testamento","%scripture_section_nt_long%":"Nuevo Testamento","%scripture_section_dc_long%":"Deuterocanónicos","%scripture_section_extra_long%":"Material Extra"},D={args:{scrRef:p,handleSubmit:V(),localizedBookNames:Ee,localizedStrings:Le},parameters:{docs:{description:{story:`
...
This demonstrates the full localization capabilities of the component.
        `}}}};function Me({scrRef:a,handleSubmit:o,...n}){const[s,e]=f.useState(a),[t,d]=f.useState([{book:"GEN",chapterNum:1,verseNum:1},{book:"MAT",chapterNum:5,verseNum:3},{book:"JHN",chapterNum:3,verseNum:16},{book:"ROM",chapterNum:8,verseNum:28}]),y=Ae(t,d,(h,P)=>h.book===P.book&&h.chapterNum===P.chapterNum&&h.verseNum===P.verseNum),xe=f.useCallback(h=>{e(h),o(h)},[o]),De=f.useCallback(h=>{y(h)},[y]);return g.jsxs("div",{className:"tw:p-4",children:[g.jsx(L,{...n,scrRef:s,handleSubmit:xe,recentSearches:t,onAddRecentSearch:De}),g.jsxs("div",{className:"tw:mt-4 tw:text-sm tw:text-gray-600",children:["Current Reference: ",JSON.stringify(s,void 0,2)]}),g.jsxs("div",{className:"tw:mt-2 tw:text-sm tw:text-gray-500",children:["Recent Searches:"," ",t.map(h=>`${h.book} ${h.chapterNum}:${h.verseNum}`).join(", ")]})]})}const A={args:{scrRef:p},render:a=>g.jsx(Me,{...a}),parameters:{docs:{description:{story:"BookChapterControl with recent searches functionality. Click the clock icon in the search input to see recent scripture references."}}}};var H,J,G;b.parameters={...b.parameters,docs:{...(H=b.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
...
}`,...(Oe=(ze=A.parameters)==null?void 0:ze.docs)==null?void 0:Oe.source}}};const It=["Default","WithSpecificBook","WithLimitedBooks","WithCustomTrigger","EmptyBookList","ChapterSelectionDemo","SmartParsingDemo","BookSearchAndNavigation","SingleChapterBookDemo","KeyboardNavigation","ComprehensiveInteractionTest","WithLocalizedSpanishBookNames","WithLocalizedFrenchBookNames","WithLocalizedSectionNames","WithRecentSearches"];export{v as BookSearchAndNavigation,T as ChapterSelectionDemo,S as ComprehensiveInteractionTest,b as Default,I as EmptyBookList,O as KeyboardNavigation,z as SingleChapterBookDemo,N as SmartParsingDemo,B as WithCustomTrigger,R as WithLimitedBooks,x as WithLocalizedFrenchBookNames,D as WithLocalizedSectionNames,E as WithLocalizedSpanishBookNames,A as WithRecentSearches,C as WithSpecificBook,It as __namedExportsOrder,Bt as default};
