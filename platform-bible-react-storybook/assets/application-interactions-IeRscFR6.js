...
`,e.jsxs(t.p,{children:["See also: ",e.jsx(t.a,{href:"./dismissal-patterns.mdx",children:"Dismissal Patterns"})," for how transient surfaces (menus, popovers, hover cards) should close on outside interaction."]}),`
...
`,e.jsx(t.p,{children:"Floating tabs can be docked back into the dock layout of the window they are floating above by dragging and dropping them back into the tab header bar."}),`
...
`]}),`
`,e.jsx("iframe",{src:"https://embed.figma.com/board/qAjw7U4EcXbi7UDpMwYGsD/Design-System-Content?node-id=1-2&t=QZDawBfx1n2dOTjC-4&embed-host=paratext-design-system",width:"100%",height:"400",style:{border:"none"},children:e.jsx(t.p,{children:"Your browser does not support iframes."})})]})}function c(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{c as default};
