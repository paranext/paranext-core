import{j as e,M as i}from"./iframe-B3Hdsuua.js";import{useMDXComponents as s}from"./index-CPHW9Uq4.js";import"./preload-helper-CTOgD26E.js";function t(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Guidelines/Component Choices"}),`
...
`]}),`
`,e.jsx("iframe",{src:"https://embed.figma.com/design/hJirMCWP9O9riw39Gd5zyl/Design-System-Figma?node-id=0-1&embed-host=paratext-design-system",width:"100%",height:"400",style:{border:"none"},children:e.jsx(n.p,{children:"Your browser does not support iframes."})})]})}function a(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{a as default};
