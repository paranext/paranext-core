import{j as e,M as o}from"./iframe-B0SQx0Dh.js";import{useMDXComponents as r}from"./index-CFldQ4j7.js";import"./button-a6Tl9Rn8.js";import"./example-block.component-Gq3gjMdZ.js";import"./preload-helper-CTOgD26E.js";import"./index-BnuTq2W6.js";import"./utils-BPbySc-g.js";import"./index-qbLaGPe4.js";import"./createLucideIcon-C-GohNEF.js";import"./info-Bg-6e0o0.js";import"./chevron-down-t5rW5RHl.js";function s(t){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Guidelines/Design Principles"}),`
...
`,e.jsxs(n.p,{children:["Button ",e.jsx(n.em,{children:"labels"})," — the words, and which apply model they express — are covered in ",e.jsx(n.a,{href:"?path=/docs/guidelines-applying-changes--docs#microcopy",children:"Applying Changes"}),". In short: avoid ",e.jsx(n.strong,{children:"OK"})," (users dismiss it without reading), and use a specific action verb so the label says what will happen. This page owns how dialog buttons ",e.jsx(n.strong,{children:"look and arrange"})," (order, variant, icon, above); Applying Changes owns what they ",e.jsx(n.strong,{children:"say"}),"."]}),`
...
`,e.jsxs(n.p,{children:['One such exception: when a menu closes after pointer use, focus returns to its trigger without the ring. See "Restore focus on close" in ',e.jsx(n.a,{href:"?path=/docs/guidelines-dismissal-patterns--docs#accessibility",children:"Dismissal Patterns"}),"."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Definition of Done:"})," when you add, change, or remove any keyboard shortcut — a ",e.jsx(n.code,{children:"keydown"}),"/",e.jsx(n.code,{children:"keyup"})," handler, an Electron accelerator or ",e.jsx(n.code,{children:"before-input-event"})," branch, or a ",e.jsx(n.code,{children:"useHotkeys"})," binding — you must add, update, or remove its entry in the single catalog data file ",e.jsx(n.code,{children:"src/shared/data/keyboard-shortcuts.data.ts"})," as part of the same change. A shortcut change that leaves the catalog stale is not done."]}),`
`,e.jsxs(n.p,{children:["See also: ",e.jsx(n.a,{href:"./responsiveness.mdx",children:"Responsiveness"})," for minimum width requirements and container query guidance."]})]})}function j(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{j as default};
