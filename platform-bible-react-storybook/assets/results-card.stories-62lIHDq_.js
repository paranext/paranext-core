import{j as e}from"./jsx-runtime-DjwPZ1qe.js";import{T}from"./theme-provider.component-aAHNiFZW.js";import{r as G}from"./iframe-mszaHKTI.js";import{D as q,a as I,b as R,c as l}from"./dropdown-menu-CmxzWfPV.js";import{c as y}from"./shadcn-ui.util-DMJ19wEV.js";import{B}from"./button-uM_Iry5f.js";import{E as O}from"./ellipsis-DssG4eLf.js";import{B as g}from"./badge-Bk-DD5Bt.js";import{B as _}from"./book-open-vcr-mMS7.js";import{C as A}from"./copy-jKADhgO2.js";import{E as F}from"./external-link-1ykjK3Z6.js";import{S as L}from"./settings-DAoE9T4w.js";import"./menu.context-BDGVYAmm.js";import"./index-DTAXz6r9.js";import"./index-Dc40g3aH.js";import"./index-C4jFLmSR.js";import"./index-DP-x0oVj.js";import"./index-CQ6xKPGp.js";import"./index-Djvce50F.js";import"./index-BuRlEbzG.js";import"./index-C-zhRbhI.js";import"./index-CIe-IBRk.js";import"./index-BHVI_MEy.js";import"./index-BrGRNFQO.js";import"./floating-ui.react-dom-DGiL-_s8.js";import"./index-BpQE19-o.js";import"./index-XrIWveux.js";import"./index-DnppBRsl.js";import"./index-ChXZoXma.js";import"./index-BIgf1sv7.js";import"./index-CylxkBQ4.js";import"./index-682Zt-sV.js";import"./index-Ba8dNyeu.js";import"./index-TBEhrRPo.js";import"./index-BPbCuWFR.js";import"./check-Dzv0_x3j.js";import"./createLucideIcon-B1igjBw4.js";import"./circle-BQ187C3w.js";import"./chevron-right-BAv9Lj0g.js";function h({cardKey:a,isSelected:r,onSelect:n,isDenied:o,isHidden:d=!1,className:t,children:i,dropdownContent:c,additionalSelectedContent:s,accentColor:u}){const K=f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),n())};return e.jsxs("div",{hidden:d,onClick:n,onKeyDown:K,role:"button",tabIndex:0,"aria-pressed":r,className:y("tw-relative tw-min-w-36 tw-rounded-xl tw-border tw-shadow-none hover:tw-bg-muted/50",{"tw-opacity-50 hover:tw-opacity-100":o&&!r},{"tw-bg-accent":r},{"tw-bg-transparent":!r},t),children:[e.jsxs("div",{className:"tw-flex tw-flex-col tw-gap-2 tw-p-4",children:[e.jsxs("div",{className:"tw-flex tw-justify-between tw-overflow-hidden",children:[e.jsx("div",{className:"tw-min-w-0 tw-flex-1",children:i}),r&&c&&e.jsxs(q,{children:[e.jsx(I,{className:y(u&&"tw-me-1"),asChild:!0,children:e.jsx(B,{className:"tw-m-1 tw-h-6 tw-w-6",variant:"ghost",size:"icon",children:e.jsx(O,{})})}),e.jsx(R,{align:"end",children:c})]})]}),r&&s&&e.jsx("div",{className:"tw-w-fit tw-min-w-0 tw-max-w-full tw-overflow-hidden",children:s})]}),u&&e.jsx("div",{className:`tw-absolute tw-right-0 tw-top-0 tw-h-full tw-w-2 tw-rounded-r-xl ${u}`})]},a)}h.__docgenInfo={description:`ResultsCard is a base component for displaying scripture-related results in a card format, even
though it is not based on the Card component. It provides common functionality like selection
state, dropdown menus, and expandable content.`,methods:[],displayName:"ResultsCard",props:{cardKey:{required:!0,tsType:{name:"string"},description:"Unique key for the card"},isSelected:{required:!0,tsType:{name:"boolean"},description:"Whether this card is currently selected/focused"},onSelect:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback function called when the card is clicked"},isDenied:{required:!1,tsType:{name:"boolean"},description:"Whether the content of this card are in a denied state"},isHidden:{required:!1,tsType:{name:"boolean"},description:"Whether the card should be hidden",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes to apply to the card"},children:{required:!0,tsType:{name:"ReactNode"},description:"Main content to display on the card"},dropdownContent:{required:!1,tsType:{name:"ReactNode"},description:"Content to show in the dropdown menu when selected"},additionalSelectedContent:{required:!1,tsType:{name:"ReactNode"},description:"Additional content to show below the main content when selected"},accentColor:{required:!1,tsType:{name:"string"},description:"Color to use for the card's accent border"}}};const{fn:M}=__STORYBOOK_MODULE_TEST__,Ee={title:"Basics/ResultsCard",component:h,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...(E=(j=p.parameters)==null?void 0:j.docs)==null?void 0:E.source}}};const Ge=["Default","CheckCards","FindCards"];export{w as CheckCards,m as Default,p as FindCards,Ge as __namedExportsOrder,Ee as default};
