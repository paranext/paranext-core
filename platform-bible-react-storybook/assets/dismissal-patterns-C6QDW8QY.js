import{j as e,M as o}from"./iframe-QtFa4wfL.js";import{useMDXComponents as i}from"./index-CVK1QpBu.js";import"./preload-helper-CTOgD26E.js";function t(n){const s={a:"a",blockquote:"blockquote",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Guidelines/Dismissal Patterns"}),`
...
users are stranded on a closed surface's dead anchor. Restoring focus is not the same as showing a
focus ring: after a close the user drove with the pointer, the ring would sit on a control the
pointer has left. Suppress the ring for that case rather than withholding the focus — see
`,e.jsx(s.code,{children:"TabDropdownMenu"}),", which marks its trigger with ",e.jsx(s.code,{children:"data-quiet-focus"}),` and clears the mark on the next
keydown. The ring stays under forced colors (Windows High Contrast), where it is the only focus
indicator left. For why the browser's own "focus without the indicator" option is not usable here,
see the `,e.jsx(s.code,{children:"adr-menu-close-focus-restores-without-the-ring"}),` entry in
`,e.jsx(s.code,{children:".context/standards/Architecture-Decisions.md"}),". The helpers behind this (",e.jsx(s.code,{children:"QUIET_FOCUS_*"}),`,
`,e.jsx(s.code,{children:"useInteractionModality"}),`) are internal to this library for now and not exported, so an extension
cannot reuse them yet.`]}),`
...
(see `,e.jsx(s.code,{children:"src/renderer/services/web-view.service-shard.ts"}),"). Two consequences for dismissal:"]}),`
