import{j as e}from"./jsx-runtime-B0mj53Uj.js";import{I as t}from"./input-Dcoe_3fh.js";import{r as u}from"./iframe-9Zhl2CkU.js";import"./shadcn-ui.util-DMJ19wEV.js";import"./preload-helper-CTOgD26E.js";const A={title:"Shadcn/Input",component:t,tags:["autodocs"],argTypes:{placeholder:{control:"text"},disabled:{control:"boolean"},className:{control:"text"}},decorators:[a=>e.jsx(a,{})]},o={args:{placeholder:"Enter text..."}},n={args:{placeholder:"Disabled input",disabled:!0}},i={args:{placeholder:"Playground Input"}},d={render:a=>{const[s,r]=u.useState("");return e.jsxs("div",{className:"tw-max-w-md tw-space-y-4",children:[e.jsx(t,{...a,value:s,onChange:l=>r(l.target.value),"aria-label":"Test input"}),e.jsxs("div",{className:"tw-text-sm tw-text-gray-600",children:[e.jsxs("p",{children:["Current value: ",e.jsx("code",{children:s})]}),e.jsx("p",{children:"Use the Code Editor tab to modify this input in real-time!"})]})]})},args:{placeholder:"Type here to test..."},parameters:{docs:{description:{story:"This story allows live code editing. Try adding validation, changing the placeholder, or adding event handlers."}}}},c={render:()=>{const[a,s]=u.useState(""),[r,l]=u.useState(""),F=B=>{const p=B.target.value;s(p),p.length<3&&p.length>0?l("Must be at least 3 characters"):l("")};return e.jsxs("div",{className:"tw-max-w-md tw-space-y-2",children:[e.jsx(t,{value:a,onChange:F,placeholder:"Enter at least 3 characters",className:r?"tw-border-red-500":""}),r&&e.jsx("p",{className:"tw-text-sm tw-text-red-500",children:r}),e.jsx("p",{className:"tw-text-sm tw-text-gray-600",children:"Edit this validation logic in the Code Editor!"})]})},parameters:{docs:{description:{story:"An input with validation logic that you can edit and experiment with in real-time."}}}},m={render:()=>e.jsxs("div",{className:"tw-space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"default-input",className:"tw-mb-2 tw-block tw-text-sm tw-font-medium",children:"Default Shadcn Input"}),e.jsx(t,{id:"default-input",placeholder:"Default styling"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"small-input",className:"tw-mb-2 tw-block tw-text-sm tw-font-medium",children:"Small Input (8px height)"}),e.jsx(t,{id:"small-input",placeholder:"Small input",className:"tw-h-8"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"bvc-input",className:"tw-mb-2 tw-block tw-text-sm tw-font-medium",children:"BVC Style Input"}),e.jsx(t,{id:"bvc-input",placeholder:"Book-chapter-control style",className:"tw-box-border tw-gap-2.5 tw-rounded-lg tw-border tw-border-solid tw-border-black tw-bg-white tw-py-2 tw-pl-4 tw-pr-3 tw-font-medium tw-text-slate-900 tw-shadow-none tw-outline-none"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"ring-input",className:"tw-mb-2 tw-block tw-text-sm tw-font-medium",children:"Custom Ring Color"}),e.jsx(t,{id:"ring-input",placeholder:"Custom focus ring",className:"focus-visible:tw-ring-[color:hsl(240,5%,64.9%)]"})]})]}),parameters:{docs:{description:{story:"Various input styling examples showing different visual approaches."}}}};var h,w,g;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(I=c.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};var k,T,D;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(D=(T=m.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};const U=["Default","Disabled","Playground","LiveEditable","WithValidation","CustomStyles"];export{m as CustomStyles,o as Default,n as Disabled,d as LiveEditable,i as Playground,c as WithValidation,U as __namedExportsOrder,A as default};
