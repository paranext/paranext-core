import{j as e}from"./jsx-runtime-BqcUmbcY.js";import{r as B}from"./iframe-DVzoy_2T.js";import{D as v,a as b,b as k,c as m}from"./dropdown-menu-Bzupk4zM.js";import{c as g}from"./utils-BPbySc-g.js";import{B as C}from"./button-BrOu8u1B.js";import{E as N}from"./ellipsis-vertical-B1caevSs.js";import{B as S}from"./badge-DEBHUNEJ.js";import{B as F}from"./book-open-DWNDOnwC.js";import{C as L}from"./copy-CRFeZdyb.js";import{E as M}from"./external-link-CWBuvhOs.js";import{S as $}from"./settings-m3IwIM_I.js";import"./preload-helper-CTOgD26E.js";import"./menu.context-BfhkbfQa.js";import"./index-BnuTq2W6.js";import"./IconCheck-H0BOuOQn.js";import"./createReactComponent-CpHwkYPO.js";import"./IconChevronRight-DsInCE4j.js";import"./index-CDGua9s3.js";import"./index-B5PLzNQN.js";import"./index-Du4Fy0Y1.js";import"./index-CNXBC9Lw.js";import"./index-KL7XIe3I.js";import"./index-A3oOgNwG.js";import"./index-CwSQyPQw.js";import"./index-DZERpc4P.js";import"./index-eje3GdQb.js";import"./index-B_MVzxYV.js";import"./index-CoAlinuw.js";import"./index-BiRvx9Ci.js";import"./index-BZ5WnZXT.js";import"./index-CxCaaAIH.js";import"./index-Do5K9IBo.js";import"./index-CaKLRLTq.js";import"./createLucideIcon-jHIlWQwE.js";function f({cardKey:s,isSelected:a,onSelect:n,isDenied:o,isHidden:r=!1,className:t,children:i,selectedButtons:c,hoverButtons:d,dropdownContent:l,additionalContent:x,accentColor:w,showDropdownOnHover:_=!1}){const A=y=>{(y.key==="Enter"||y.key===" ")&&(y.preventDefault(),n())};return e.jsxs("div",{hidden:r,onClick:n,onKeyDown:A,role:"button",tabIndex:0,"aria-pressed":a,className:g("tw:group tw:relative tw:min-w-36 tw:rounded-xl tw:border tw:shadow-none tw:hover:bg-muted/50",{"tw:opacity-50 tw:hover:opacity-100":o&&!a},{"tw:bg-accent":a},{"tw:bg-transparent":!a},t),children:[e.jsxs("div",{className:"tw:flex tw:flex-col tw:gap-2 tw:p-4",children:[e.jsxs("div",{className:"tw:flex tw:justify-between tw:overflow-hidden",children:[e.jsx("div",{className:"tw:min-w-0 tw:flex-1",children:i}),a&&c,!a&&d&&e.jsx("div",{className:"tw:invisible tw:group-hover:visible",children:d}),!a&&_&&l&&e.jsx("div",{className:"tw:invisible tw:group-hover:visible",children:e.jsxs(v,{children:[e.jsx(b,{className:g(w&&"tw:me-1"),asChild:!0,children:e.jsx(C,{className:"tw:m-1 tw:h-6 tw:w-6",variant:"ghost",size:"icon",children:e.jsx(N,{})})}),e.jsx(k,{align:"end",children:l})]})}),a&&l&&e.jsxs(v,{children:[e.jsx(b,{className:g(w&&"tw:me-1"),asChild:!0,children:e.jsx(C,{className:"tw:m-1 tw:h-6 tw:w-6",variant:"ghost",size:"icon",children:e.jsx(N,{})})}),e.jsx(k,{align:"end",children:l})]})]}),x&&e.jsx("div",{className:"tw:w-fit tw:min-w-0 tw:max-w-full tw:overflow-hidden",children:x})]}),w&&e.jsx("div",{className:`tw:absolute tw:right-0 tw:top-0 tw:h-full tw:w-2 tw:rounded-r-xl ${w}`})]},s)}f.__docgenInfo={description:`ResultsCard is a base component for displaying scripture-related results in a card format, even
though it is not based on the Card component. It provides common functionality like selection
state, dropdown menus, and expandable content.`,methods:[],displayName:"ResultsCard",props:{cardKey:{required:!0,tsType:{name:"string"},description:"Unique key for the card"},isSelected:{required:!0,tsType:{name:"boolean"},description:"Whether this card is currently selected/focused"},onSelect:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback function called when the card is clicked"},isDenied:{required:!1,tsType:{name:"boolean"},description:"Whether the content of this card are in a denied state"},isHidden:{required:!1,tsType:{name:"boolean"},description:"Whether the card should be hidden",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes to apply to the card"},children:{required:!0,tsType:{name:"ReactNode"},description:"Main content to display on the card"},selectedButtons:{required:!1,tsType:{name:"ReactNode"},description:"Additional buttons to show to the end of the card when selected, before the dropdown menu"},hoverButtons:{required:!1,tsType:{name:"ReactNode"},description:"Additional buttons to show when the card is hovered but not selected"},dropdownContent:{required:!1,tsType:{name:"ReactNode"},description:"Content to show in the dropdown menu when selected"},showDropdownOnHover:{required:!1,tsType:{name:"boolean"},description:"Whether to show the dropdown menu button on hover even when not selected. Defaults to false",defaultValue:{value:"false",computed:!1}},additionalContent:{required:!1,tsType:{name:"ReactNode"},description:"Additional content to show below the main content"},accentColor:{required:!1,tsType:{name:"string"},description:"Color to use for the card's accent border"}}};const{fn:V}=__STORYBOOK_MODULE_TEST__,Ne={title:"Basics/ResultsCard",component:f,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...(E=(D=h.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};var G,q,K;p.parameters={...p.parameters,docs:{...(G=p.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => {
...
}`,...(K=(q=p.parameters)==null?void 0:q.docs)==null?void 0:K.source}}};var T,R,I;u.parameters={...u.parameters,docs:{...(T=u.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
...
}`,...(I=(R=u.parameters)==null?void 0:R.docs)==null?void 0:I.source}}};const Se=["Default","CheckCards","FindCards"];export{p as CheckCards,h as Default,u as FindCards,Se as __namedExportsOrder,Ne as default};
