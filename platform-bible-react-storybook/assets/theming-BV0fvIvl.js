...
`,e.jsxs(t.p,{children:[`The app's main process loads built-in theme definitions from
`,e.jsx(t.a,{href:"https://github.com/paranext/paranext-core/blob/main/src/shared/data/themes.data.json",rel:"nofollow",children:"themes.data.json"}),`
(Platform and Paratext families) and applies the same HSL tokens as `,e.jsx(t.code,{children:"index.css"}),` for those (see
`,e.jsx(t.a,{href:"https://github.com/paranext/paranext-core/blob/main/src/main/services/theme.service-host.ts",rel:"nofollow",children:"theme.service-host.ts"}),`).
...
Colors`}),"."]}),`
`,e.jsx(a,{})]})}function k(s={}){const{wrapper:t}={...r(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(o,{...s})}):o(s)}export{k as default};
