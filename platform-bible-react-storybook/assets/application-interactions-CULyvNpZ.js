import{j as e,M as i}from"./iframe-BsyM1WCI.js";import{useMDXComponents as r}from"./index-YeGm0KFP.js";import"./preload-helper-CTOgD26E.js";function o(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Guidelines/Interactions"}),`
...
`,e.jsx(t.p,{children:"Closable tabs can be closed with a middle click anywhere on the tab header, not just on its close button. This works on tab headers in the overflow menu too."}),`
...
`]}),`
`,e.jsx("iframe",{src:"https://embed.figma.com/board/qAjw7U4EcXbi7UDpMwYGsD/Design-System-Content?node-id=1-2&t=QZDawBfx1n2dOTjC-4&embed-host=paratext-design-system",width:"100%",height:"400",style:{border:"none"},children:e.jsx(t.p,{children:"Your browser does not support iframes."})})]})}function c(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{c as default};
