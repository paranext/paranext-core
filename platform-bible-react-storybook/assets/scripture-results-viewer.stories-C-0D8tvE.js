import{r as d,j as n,b as ge}from"./iframe-Db0yrjdZ.js";import{B as A}from"./button-CRMK9Nqo.js";import{S as fe,a as ye,b as we,c as Ce,e as be,d as Se}from"./select-D23ZaLIK.js";import{T as Ne,b as ke,c as V,d as ve,e as Re,f as xe}from"./table-CYgfzjrD.js";import{c as j}from"./utils-BPbySc-g.js";import{c as H}from"./index.es-LuWhpyxP.js";import{u as Te,f as I,b as De,c as Ee,d as je,e as Ie}from"./index-HYia69tB.js";import"./index-BKT-qVtu.js";import{C as Me}from"./chevron-down-y1pdiIcY.js";import{a as Ge,C as Ae}from"./chevron-right-wjHuylFv.js";import{f as q,b as M,I as G}from"./scripture-util-BNsEPlLA-BT_1BsIP.js";import"./preload-helper-CTOgD26E.js";import"./index-BnuTq2W6.js";import"./index-xLgDz77E.js";import"./z-index-CoNkaVR8.js";import"./IconSelector-CZbezAvx.js";import"./createReactComponent-DZ3MqOeR.js";import"./IconCheck-GkMByHWf.js";import"./index-BaQP4hhM.js";import"./index-_nZ8VTuX.js";import"./index--w3j8_cI.js";import"./index-BlcXSPTz.js";import"./index-JjLkhp_p.js";import"./index-C-sYFee8.js";import"./index-CkQXDgc8.js";import"./index-HMAF8pjF.js";import"./index-CkiBBR0t.js";import"./index-BPY64oKT.js";import"./index-CeCw3txk.js";import"./index-B4oXjowB.js";import"./index-CcY03qax.js";import"./index-DTnr8bKi.js";import"./index-D2t4nnj1.js";import"./index-wk9rVj3k.js";import"./createLucideIcon-BiwobKvO.js";const p="scrBook",qe="scrRef",g="source",Oe="details",Be="Scripture Reference",Je="Scripture Book",ne="Type",Ve="Details";function He(e,c){const i=c??!1;return[{accessorFn:t=>`${t.start.book} ${t.start.chapterNum}:${t.start.verseNum}`,id:p,header:(e==null?void 0:e.scriptureReferenceColumnName)??Be,cell:t=>{const o=t.row.original;return t.row.getIsGrouped()?H.bookIdToEnglishName(o.start.book):t.row.groupingColumnId===p?M(o.start):void 0},getGroupingValue:t=>H.bookIdToNumber(t.start.book),sortingFn:(t,o)=>q(t.original.start,o.original.start),enableGrouping:!0},{accessorFn:t=>M(t.start),id:qe,header:void 0,cell:t=>{const o=t.row.original;return t.row.getIsGrouped()?void 0:M(o.start)},sortingFn:(t,o)=>q(t.original.start,o.original.start),enableGrouping:!1},{accessorFn:t=>t.source.displayName,id:g,header:i?(e==null?void 0:e.typeColumnName)??ne:void 0,cell:t=>i||t.row.getIsGrouped()?t.getValue():void 0,getGroupingValue:t=>t.source.id,sortingFn:(t,o)=>t.original.source.displayName.localeCompare(o.original.source.displayName),enableGrouping:!0},{accessorFn:t=>t.detail,id:Oe,header:(e==null?void 0:e.detailsColumnName)??Ve,cell:t=>t.getValue(),enableGrouping:!1}]}const $e=e=>{if(!("offset"in e.start))throw new Error("No offset available in range start");if(e.end&&!("offset"in e.end))throw new Error("No offset available in range end");const{offset:c}=e.start;let i=0;return e.end&&({offset:i}=e.end),!e.end||q(e.start,e.end)===0?`${G(e.start)}+${c}`:`${G(e.start)}+${c}-${G(e.end)}+${i}`},$=e=>`${$e({start:e.start,end:e.end})} ${e.source.displayName} ${e.detail}`;function O({sources:e,showColumnHeaders:c=!1,showSourceColumn:i=!1,scriptureReferenceColumnName:t,scriptureBookGroupName:o,typeColumnName:u,detailsColumnName:m,onRowSelected:l,id:R}){const[h,B]=d.useState([]),[ie,x]=d.useState([{id:p,desc:!1}]),[J,ce]=d.useState({}),T=d.useMemo(()=>e.flatMap(r=>r.data.map(s=>({...s,source:r.source}))),[e]),ue=d.useMemo(()=>He({scriptureReferenceColumnName:t,typeColumnName:u,detailsColumnName:m},i),[t,u,m,i]);d.useEffect(()=>{h.includes(g)?x([{id:g,desc:!1},{id:p,desc:!1}]):x([{id:p,desc:!1}])},[h]);const w=Te({data:T,columns:ue,state:{grouping:h,sorting:ie,rowSelection:J},onGroupingChange:B,onSortingChange:x,onRowSelectionChange:ce,getExpandedRowModel:Ie(),getGroupedRowModel:je(),getCoreRowModel:Ee(),getSortedRowModel:De(),getRowId:$,autoResetExpanded:!1,enableMultiRowSelection:!1,enableSubRowSelection:!1});d.useEffect(()=>{if(l){const r=w.getSelectedRowModel().rowsById,s=Object.keys(r);if(s.length===1){const f=T.find(a=>$(a)===s[0])||void 0;f&&l(f)}}},[J,T,l,w]);const D=o??Je,E=u??ne,le=[{label:"No Grouping",value:[]},{label:`Group by ${D}`,value:[p]},{label:`Group by ${E}`,value:[g]},{label:`Group by ${D} and ${E}`,value:[p,g]},{label:`Group by ${E} and ${D}`,value:[g,p]}],de=r=>{B(JSON.parse(r))},pe=(r,s)=>{!r.getIsGrouped()&&!r.getIsSelected()&&r.getToggleSelectedHandler()(s)},me=(r,s)=>r.getIsGrouped()?"":j("banded-row",s%2===0?"even":"odd"),he=(r,s,f)=>{if(!((r==null?void 0:r.length)===0||s.depth<f.column.getGroupedIndex())){if(s.getIsGrouped())switch(s.depth){case 1:return"tw:ps-4";default:return}switch(s.depth){case 1:return"tw:ps-8";case 2:return"tw:ps-12";default:return}}};return n.jsxs("div",{id:R,className:"pr-twp tw:flex tw:h-full tw:w-full tw:flex-col",children:[!c&&n.jsxs(fe,{value:JSON.stringify(h),onValueChange:r=>{de(r)},children:[n.jsx(ye,{className:"tw:mb-1 tw:mt-2",children:n.jsx(we,{})}),n.jsx(Ce,{position:"item-aligned",children:n.jsx(be,{children:le.map(r=>n.jsx(Se,{value:JSON.stringify(r.value),children:r.label},r.label))})})]}),n.jsxs(Ne,{className:"tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0",children:[c&&n.jsx(ke,{children:w.getHeaderGroups().map(r=>n.jsx(V,{children:r.headers.filter(s=>s.column.columnDef.header).map(s=>n.jsx(ve,{colSpan:s.colSpan,className:"tw:sticky top-0",children:s.isPlaceholder?void 0:n.jsxs("div",{children:[s.column.getCanGroup()?n.jsx(A,{variant:"ghost",title:`Toggle grouping by ${s.column.columnDef.header}`,onClick:s.column.getToggleGroupingHandler(),type:"button",children:s.column.getIsGrouped()?"🛑":"👊 "}):void 0," ",I(s.column.columnDef.header,s.getContext())]})},s.id))},r.id))}),n.jsx(Re,{children:w.getRowModel().rows.map((r,s)=>{const f=ge();return n.jsx(V,{"data-state":r.getIsSelected()?"selected":"",className:j(me(r,s)),onClick:a=>pe(r,a),children:r.getVisibleCells().map(a=>{if(!(a.getIsPlaceholder()||a.column.columnDef.enableGrouping&&!a.getIsGrouped()&&(a.column.columnDef.id!==g||!i)))return n.jsx(xe,{className:j(a.column.columnDef.id,"tw:p-[1px]",he(h,r,a)),children:a.getIsGrouped()?n.jsxs(A,{variant:"link",onClick:r.getToggleExpandedHandler(),type:"button",children:[r.getIsExpanded()&&n.jsx(Me,{}),!r.getIsExpanded()&&(f==="ltr"?n.jsx(Ge,{}):n.jsx(Ae,{}))," ",I(a.column.columnDef.cell,a.getContext())," (",r.subRows.length,")"]}):I(a.column.columnDef.cell,a.getContext())},a.id)})},r.id)})})]})]})}O.__docgenInfo={description:`Component to display a combined list of detailed items from one or more sources, where the items
...
}`,...(X=(L=C.parameters)==null?void 0:L.docs)==null?void 0:X.source}}};var z,K,Z;b.parameters={...b.parameters,docs:{...(z=b.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    sources: staticSources,
...
}`,...(Z=(K=b.parameters)==null?void 0:K.docs)==null?void 0:Z.source}}};var _,W,Q;S.parameters={...S.parameters,docs:{...(_=S.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    sources: [],
    scriptureReferenceColumnName: 'Scripture Reference',
    typeColumnName: 'Check Type',
...
}`,...(Q=(W=S.parameters)==null?void 0:W.docs)==null?void 0:Q.source}}};var Y,ee,te;N.parameters={...N.parameters,docs:{...(Y=N.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    sources: [{
...
}`,...(oe=(se=k.parameters)==null?void 0:se.docs)==null?void 0:oe.source}}};const Rt=["Default","CustomColumnNames","EmptyState","SingleCheck","Interactive"];export{b as CustomColumnNames,C as Default,S as EmptyState,k as Interactive,N as SingleCheck,Rt as __namedExportsOrder,vt as default};
