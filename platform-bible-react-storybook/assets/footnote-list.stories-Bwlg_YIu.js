...
@default false`,defaultValue:{value:"false",computed:!1}},formatCaller:{required:!1,tsType:{name:"signature",type:"function",raw:"(caller: string | undefined, index: number) => string | undefined",signature:{arguments:[{type:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},name:"caller"},{type:{name:"number"},name:"index"}],return:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]}}},description:"A function that can interpret the two special footnote caller codes defined by USFM, `+` and\n`-` in order to display (or suppress display of) a meaningful caller in the context where this\nis being used."},onFootnoteSelected:{required:!1,tsType:{name:"signature",type:"function",raw:"(footnote: MarkerObject, index: number, listId: string | number) => void",signature:{arguments:[{type:{name:"MarkerObject"},name:"footnote"},{type:{name:"number"},name:"index"},{type:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},name:"listId"}],return:{name:"void"}}},description:"Callback to handle clicking/selecting a footnote in the list"}}};const we={title:"Advanced/FootnoteList",component:j,tags:["autodocs"],decorators:[n=>e.jsx("div",{className:"tw:h-[300px] tw:overflow-hidden tw:border tw:border-slate-300 tw:p-4",children:e.jsx(n,{})})],argTypes:{layout:{control:{type:"radio"},options:["horizontal","vertical"]}}};function b({footnotes:n=[],listId:u="default-list-id",...a}={}){const[o,s]=m.useState();return e.jsx(j,{...a,footnotes:n,listId:u,selectedFootnote:o,onFootnoteSelected:i=>s(i)})}function K({footnotes:n=[],listId:u="default-list-id",showMarkers:a,...o}={}){const[s,i]=m.useState();return e.jsxs(ee,{direction:o.layout==="horizontal"?"vertical":"horizontal",className:"tw:h-full tw:min-h-0 tw:w-full",children:[e.jsx(S,{className:"tw:flex tw:min-h-0 tw:flex-col",children:e.jsx("div",{className:"tw:flex tw:min-h-0 tw:flex-1 tw:flex-col",children:e.jsxs("p",{children:[e.jsx("sup",{children:"11"}),"In the beginning",a?e.jsx("span",{className:"tw:text-blue-400",children:"\\f + \\fr 1.11 \\fr* This is a simple footnote \\f"}):e.jsx("sup",{children:"a"}),"..."]})})}),e.jsxs(e.Fragment,{children:[e.jsx(te,{}),e.jsx(S,{defaultSize:39,className:"tw:flex tw:min-h-0 tw:flex-col tw:bg-sidebar tw:pb-0 tw:pl-2 tw:pr-0 tw:pt-2",minSize:15,maxSize:85,children:e.jsx("div",{className:"tw:flex tw:min-h-0 tw:flex-1 tw:flex-col",children:e.jsx(b,{...o,footnotes:n,listId:u,selectedFootnote:s,showMarkers:a,onFootnoteSelected:x=>i(x)})})})]})]})}const f={render:b,args:{footnotes:c,listId:"storybook-Basic",showMarkers:!1,layout:"horizontal"}},h={render:b,args:{footnotes:c,listId:"storybook-WithCustomCallerFormatting",showMarkers:!0,layout:"horizontal",formatCaller:A(c,["†","‡","⁂","★","☆"])}},w={render:b,args:{footnotes:c,listId:"storybook-Raw",showMarkers:!0,layout:"horizontal",formatCaller:n=>n}},g={render:K,args:{footnotes:c,listId:"storybook-Formatted",showMarkers:!1,layout:"vertical"}},y={render:K,args:{footnotes:c,listId:"storybook-ShowMarkers",showMarkers:!0,layout:"vertical",formatCaller:n=>n}};var C,I,M;f.parameters={...f.parameters,docs:{...(C=f.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: Template,
  args: {
...
}`,...(U=(L=y.parameters)==null?void 0:L.docs)==null?void 0:U.source}}};const ge=["Basic","WithCustomCallerFormatting","Raw","Formatted","ShowMarkers"];export{f as Basic,g as Formatted,w as Raw,y as ShowMarkers,h as WithCustomCallerFormatting,ge as __namedExportsOrder,we as default};
