...
\`\`\``,methods:[],displayName:"PopoverPortalContainerProvider",props:{container:{required:!0,tsType:{name:"union",raw:"HTMLElement | null",elements:[{name:"HTMLElement"},{name:"null"}]},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};Pe.__docgenInfo={description:"@inheritdoc Popover",methods:[],displayName:"PopoverTrigger"};export{he as P,Pe as a,Ce as b,we as c,ge as d};
