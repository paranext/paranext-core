import{j as s}from"./jsx-runtime-41bNZknh.js";import{r as V}from"./iframe-DezKLm1V.js";import{c as D}from"./shadcn-ui.util-DMJ19wEV.js";import{S as J,a as $,b as B,c as H,d as Y}from"./select-Dr6ovA2M.js";import{L as F}from"./label-Brsh7Jn1.js";import{T as W}from"./theme-provider.component-DJidomi1.js";import"./index-Cm_lBpWX.js";import"./index-bmjVsPBM.js";import"./index-BaQP4hhM.js";import"./index-DCZ4hzzP.js";import"./index-Ds3a2SEj.js";import"./index-yLsKtSDm.js";import"./index-DnT6kkIn.js";import"./index-CUlupESh.js";import"./index-D0KJGRUa.js";import"./index-DRzs5cDs.js";import"./index-C_lQNFk6.js";import"./index-GymTf0II.js";import"./index-CGW-eGMe.js";import"./index-5i6OQTW1.js";import"./floating-ui.react-dom-DRRlu4dy.js";import"./index-Cl2ghorV.js";import"./index-C4F-WIu_.js";import"./index-bv5lnDsn.js";import"./index--VrIerAB.js";import"./index-SLflGqxF.js";import"./index-CQaoPSAz.js";import"./index-BPbCuWFR.js";import"./chevron-down-DiYI-0EF.js";import"./createLucideIcon-DTaFhFy2.js";import"./check-sRo6ZDjs.js";const M=(e,a)=>e[a]??a;function o({knownUiLanguages:e,primaryLanguage:a="en",fallbackLanguages:t=[],onLanguagesChange:m,onPrimaryLanguageChange:d,onFallbackLanguagesChange:h,localizedStrings:q,className:K}){const O=M(q,"%settings_uiLanguageSelector_selectFallbackLanguages%"),[R,p]=V.useState(!1),G=n=>{d&&d(n),m&&m([n,...t.filter(g=>g!==n)]),h&&t.find(g=>g===n)&&h([...t.filter(g=>g!==n)]),p(!1)},L=(n,g)=>{var y,b,k,S,w,C;const f=g!==n?((b=(y=e[n])==null?void 0:y.uiNames)==null?void 0:b[g])??((S=(k=e[n])==null?void 0:k.uiNames)==null?void 0:S.en):void 0;return f?`${(w=e[n])==null?void 0:w.autonym} (${f})`:(C=e[n])==null?void 0:C.autonym};return s.jsxs("div",{className:D("pr-twp tw-max-w-sm",K),children:[s.jsxs(J,{name:"uiLanguage",value:a,onValueChange:G,open:R,onOpenChange:n=>p(n),children:[s.jsx($,{children:s.jsx(B,{})}),s.jsx(H,{className:"tw-z-[250]",children:Object.keys(e).map(n=>s.jsx(Y,{value:n,children:L(n,a)},n))})]}),a!=="en"&&s.jsxs(s.Fragment,{children:[s.jsx(F,{className:"tw-ms-3",children:O}),s.jsx("div",{className:"tw-ms-3",children:s.jsxs(F,{children:["Currently:"," ",(t==null?void 0:t.length)>0?`${t.map(n=>L(n,a)).join(", ")}`:`default (${e.en.autonym})`]})})]})]})}o.__docgenInfo={description:`A component for selecting the user interface language and managing fallback languages. Allows
