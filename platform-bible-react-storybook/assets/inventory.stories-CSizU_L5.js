import{j as e}from"./jsx-runtime-B57USwOM.js";import{A as Se,D as ke}from"./data-table.component-P7iX4KpS.js";import{T as Te,b as be,c as W,d as M,e as _e,f as U}from"./table-BVa7zTck.js";import{m as je}from"./index.es-D4jfZzAn.js";import{D as z,p as q}from"./index-DNL2LXP3.js";import{r as u}from"./iframe-BIgrU_gL.js";import{C as Ce}from"./checkbox-DH02V7k6.js";import{I as Re}from"./input-D4JIoRmo.js";import{L as Ne}from"./label-DvoC0I20.js";import{S as B,a as P,b as $,c as K,d as y}from"./select-C44mE1cS.js";import{B as _}from"./button-BiEapoBh.js";import{T as Ve,a as E}from"./toggle-group-DDtYLDbu.js";import{C as Ae}from"./circle-check-CaV6rupt.js";import{C as qe}from"./circle-x-C7WTTOEr.js";import{C as Ee}from"./circle-help-DRfP7bwH.js";import{A as De}from"./arrow-up-C1s7wqSf.js";import{c as ze}from"./createLucideIcon-zWNoUrH3.js";import{T as Oe}from"./theme-provider.component-BDnlctNn.js";import"./index-CV0obnxz.js";import"./dropdown-menu-BDSm-YWV.js";import"./index-DFZqcCQS.js";import"./index-BPbCuWFR.js";import"./shadcn-ui.util-DMJ19wEV.js";import"./index-DTAXz6r9.js";import"./index-g45Whb6K.js";import"./index-QE61htb2.js";import"./index-NRjMMBFI.js";import"./index-qxytAG8i.js";import"./index-CwP3KLOH.js";import"./index-BJiVrZLO.js";import"./index-COxZgPI9.js";import"./index-CT1JCy7J.js";import"./index-Cfepox31.js";import"./index-DPcdlNoP.js";import"./floating-ui.react-dom-QEVz-clS.js";import"./index-DPhNMXhP.js";import"./index-BH-5r4K8.js";import"./index-Cp_DkjYg.js";import"./index-BV0VDXur.js";import"./index-CdHlF7wd.js";import"./index-CSwAbQR1.js";import"./index-DUTTfggM.js";import"./index-BfIrR0qS.js";import"./index-BuMmGbu1.js";import"./check-BGA574xZ.js";import"./circle-BSQPDpSP.js";import"./chevron-right-DoYomeIw.js";import"./filter-De3sba5U.js";import"./arrow-right-4gcNuT6b.js";import"./chevron-left-JcKEi_qV.js";import"./skeleton-Bqv-wBuw.js";import"./index-CvOKcZNv.js";import"./index-BaQP4hhM.js";import"./index-DryNFfgW.js";import"./chevron-down-CCzsZuG8.js";import"./chevron-up-DAtJUkaP.js";import"./index-Czfav6j7.js";/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const He=[["path",{d:"M12 5v14",key:"s699le"}],["path",{d:"m19 12-7 7-7-7",key:"1idqje"}]],Ge=ze("ArrowDown",He);function re({occurrenceData:o,setScriptureReference:t,localizedStrings:r}){const s=r["%webView_inventory_occurrences_table_header_reference%"],n=r["%webView_inventory_occurrences_table_header_occurrence%"],c=u.useMemo(()=>{const a=[];return o.forEach(d=>{a.some(p=>z(p,d))||a.push(d)}),a},[o]);return e.jsxs(Te,{stickyHeader:!0,children:[e.jsx(be,{stickyHeader:!0,children:e.jsxs(W,{children:[e.jsx(M,{children:s}),e.jsx(M,{children:n})]})}),e.jsx(_e,{children:c.length>0&&c.map(a=>e.jsxs(W,{onClick:()=>{t(a.reference)},children:[e.jsx(U,{children:`${je.bookIdToEnglishName(a.reference.book)} ${a.reference.chapterNum}:${a.reference.verseNum}`}),e.jsx(U,{children:a.text})]},`${a.reference.book} ${a.reference.chapterNum}:${a.reference.verseNum}-${a.text}`))})]})}re.__docgenInfo={description:`Table that shows occurrences of specified inventory item(s). The first column shows the related
...
languages`}}};const j=o=>o==="asc"?e.jsx(De,{className:"tw-ms-2 tw-h-4 tw-w-4"}):o==="desc"?e.jsx(Ge,{className:"tw-ms-2 tw-h-4 tw-w-4"}):e.jsx(Se,{className:"tw-ms-2 tw-h-4 tw-w-4"}),We=o=>({accessorKey:"item",accessorFn:t=>t.items[0],header:({column:t})=>e.jsxs(_,{variant:"ghost",onClick:()=>t.toggleSorting(void 0),children:[o,j(t.getIsSorted())]})}),Me=(o,t)=>({accessorKey:`item${t}`,accessorFn:r=>r.items[t],header:({column:r})=>e.jsxs(_,{variant:"ghost",onClick:()=>r.toggleSorting(void 0),children:[o,j(r.getIsSorted())]})}),Ue=o=>({accessorKey:"count",header:({column:t})=>e.jsx("div",{className:"tw-flex tw-justify-end tw-tabular-nums",children:e.jsxs(_,{variant:"ghost",onClick:()=>t.toggleSorting(void 0),children:[o,j(t.getIsSorted())]})}),cell:({row:t})=>e.jsx("div",{className:"tw-flex tw-justify-end",children:t.getValue("count")})}),D=(o,t,r,s,n,c)=>{let a=[...r];o.forEach(p=>{t==="approved"?a.includes(p)||a.push(p):a=a.filter(x=>x!==p)}),s(a);let d=[...n];o.forEach(p=>{t==="unapproved"?d.includes(p)||d.push(p):d=d.filter(x=>x!==p)}),c(d)},Be=(o,t,r,s,n)=>({accessorKey:"status",header:({column:c})=>e.jsx("div",{className:"tw-flex tw-justify-center",children:e.jsxs(_,{variant:"ghost",onClick:()=>c.toggleSorting(void 0),children:[o,j(c.getIsSorted())]})}),cell:({row:c})=>{const a=c.getValue("status"),d=c.getValue("item");return e.jsxs(Ve,{value:a,variant:"outline",type:"single",children:[e.jsx(E,{onClick:p=>{p.stopPropagation(),D([d],"approved",t,r,s,n)},value:"approved",children:e.jsx(Ae,{})}),e.jsx(E,{onClick:p=>{p.stopPropagation(),D([d],"unapproved",t,r,s,n)},value:"unapproved",children:e.jsx(qe,{})}),e.jsx(E,{onClick:p=>{p.stopPropagation(),D([d],"unknown",t,r,s,n)},value:"unknown",children:e.jsx(Ee,{})})]})}}),Pe=(o,t,r)=>r.includes(o)?"unapproved":t.includes(o)?"approved":"unknown",$e=(o,t,r)=>{let s=o;return t!=="all"&&(s=s.filter(n=>t==="approved"&&n.status==="approved"||t==="unapproved"&&n.status==="unapproved"||t==="unknown"&&n.status==="unknown")),r!==""&&(s=s.filter(n=>n.items[0].includes(r))),s},Ke=(o,t,r)=>{const s=[];return o.forEach(n=>{const c=s.find(a=>z(a.items,q(n.inventoryText)?[n.inventoryText]:n.inventoryText));if(c)c.count+=1,c.occurrences.push({reference:n.verseRef,text:n.verse});else{const a={items:q(n.inventoryText)?[n.inventoryText]:n.inventoryText,count:1,status:Pe(q(n.inventoryText)?n.inventoryText:n.inventoryText[0],t,r),occurrences:[{reference:n.verseRef,text:n.verse}]};s.push(a)}}),s},m=(o,t)=>o[t]??t;function S({inventoryItems:o,setVerseRef:t,localizedStrings:r,additionalItemsLabels:s,approvedItems:n,unapprovedItems:c,scope:a,onScopeChange:d,columns:p,id:x,areInventoryItemsLoading:oe=!1}){const se=m(r,"%webView_inventory_all%"),ie=m(r,"%webView_inventory_approved%"),ae=m(r,"%webView_inventory_unapproved%"),ce=m(r,"%webView_inventory_unknown%"),pe=m(r,"%webView_inventory_scope_currentBook%"),ue=m(r,"%webView_inventory_scope_chapter%"),de=m(r,"%webView_inventory_scope_verse%"),le=m(r,"%webView_inventory_filter_text%"),me=m(r,"%webView_inventory_show_additional_items%"),he=m(r,"%webView_inventory_no_results%"),[v,ve]=u.useState(!1),[C,fe]=u.useState("all"),[R,ye]=u.useState(""),[N,V]=u.useState([]),A=u.useMemo(()=>{const i=o??[];return i.length===0?[]:Ke(i,n,c)},[o,n,c]),w=u.useMemo(()=>{if(v)return A;const i=[];return A.forEach(l=>{const h=l.items[0],f=i.find(g=>g.items[0]===h);f?(f.count+=l.count,f.occurrences=f.occurrences.concat(l.occurrences)):i.push({items:[h],count:l.count,occurrences:l.occurrences,status:l.status})}),i},[v,A]),I=u.useMemo(()=>w.length===0?[]:$e(w,C,R),[w,C,R]),we=u.useMemo(()=>{var h,f;if(!v)return p;const i=(h=s==null?void 0:s.tableHeaders)==null?void 0:h.length;if(!i)return p;const l=[];for(let g=0;g<i;g++)l.push(Me(((f=s==null?void 0:s.tableHeaders)==null?void 0:f[g])||"Additional Item",g+1));return[...l,...p]},[s==null?void 0:s.tableHeaders,p,v]);u.useEffect(()=>{I.length===0?V([]):I.length===1&&V(I[0].items)},[I]);const ge=(i,l)=>{l.setRowSelection(()=>{const h={};return h[i.index]=!0,h}),V(i.original.items)},xe=i=>{if(i==="book"||i==="chapter"||i==="verse")d(i);else throw new Error(`Invalid scope value: ${i}`)},Ie=i=>{if(i==="all"||i==="approved"||i==="unapproved"||i==="unknown")fe(i);else throw new Error(`Invalid status filter value: ${i}`)},G=u.useMemo(()=>{if(w.length===0||N.length===0)return[];const i=w.filter(l=>z(v?l.items:[l.items[0]],N));if(i.length>1)throw new Error("Selected item is not unique");return i.length===0?[]:i[0].occurrences},[N,v,w]);return e.jsxs("div",{id:x,className:"pr-twp tw-flex tw-h-full tw-flex-col",children:[e.jsxs("div",{className:"tw-flex tw-items-stretch",children:[e.jsxs(B,{onValueChange:i=>Ie(i),defaultValue:C,children:[e.jsx(P,{className:"tw-m-1",children:e.jsx($,{placeholder:"Select filter"})}),e.jsxs(K,{children:[e.jsx(y,{value:"all",children:se}),e.jsx(y,{value:"approved",children:ie}),e.jsx(y,{value:"unapproved",children:ae}),e.jsx(y,{value:"unknown",children:ce})]})]}),e.jsxs(B,{onValueChange:i=>xe(i),defaultValue:a,children:[e.jsx(P,{className:"tw-m-1",children:e.jsx($,{placeholder:"Select scope"})}),e.jsxs(K,{children:[e.jsx(y,{value:"book",children:pe}),e.jsx(y,{value:"chapter",children:ue}),e.jsx(y,{value:"verse",children:de})]})]}),e.jsx(Re,{className:"tw-m-1 tw-rounded-md tw-border",placeholder:le,value:R,onChange:i=>{ye(i.target.value)}}),s&&e.jsxs("div",{className:"tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border",children:[e.jsx(Ce,{className:"tw-m-1",checked:v,onCheckedChange:i=>{ve(i)}}),e.jsx(Ne,{className:"tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap",children:(s==null?void 0:s.checkboxText)??me})]})]}),e.jsx("div",{className:"tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border",children:e.jsx(ke,{columns:we,data:I,onRowClickHandler:ge,stickyHeader:!0,isLoading:oe,noResultsMessage:he})}),G.length>0&&e.jsx("div",{className:"tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border",children:e.jsx(re,{occurrenceData:G,setScriptureReference:t,localizedStrings:r})})]})}S.__docgenInfo={description:"Inventory component that is used to view and control the status of provided project settings",methods:[],displayName:"Inventory",props:{inventoryItems:{required:!0,tsType:{name:"union",raw:"InventoryItem[] | undefined",elements:[{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  /**
...
}`,...(te=(ee=b.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};const Zt=["Default","RepeatedWords","EmptyInventory"];export{k as Default,b as EmptyInventory,T as RepeatedWords,Zt as __namedExportsOrder,Qt as default};
