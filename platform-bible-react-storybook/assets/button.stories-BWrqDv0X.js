import{j as n}from"./jsx-runtime-BqcUmbcY.js";import{B as r}from"./button-BrOu8u1B.js";import"./index-BnuTq2W6.js";import"./utils-BPbySc-g.js";import"./index-KL7XIe3I.js";import"./iframe-DVzoy_2T.js";import"./preload-helper-CTOgD26E.js";const{expect:t,fn:c}=__STORYBOOK_MODULE_TEST__,Dt={title:"Shadcn/Button",component:r,tags:["autodocs","test"],argTypes:{variant:{options:["default","destructive","outline","secondary","ghost","link"],control:{type:"select"}},size:{options:["default","sm","lg","icon"],control:{type:"select"}},disabled:{control:"boolean"},className:{control:"text"}}},l={args:{children:"Default Button",variant:"default",size:"default"}},d={render:a=>n.jsxs("div",{className:"tw:space-y-4",children:[n.jsx(r,{...a,children:a.children||"Click me!"}),n.jsx("p",{className:"tw:text-sm tw:text-gray-600",children:"Use the Code Editor tab to modify this button in real-time!"})]}),args:{children:"Editable Button",variant:"default"},parameters:{docs:{description:{story:"This story allows live code editing. Try changing the variant, size, or adding click handlers in the Code Editor panel."}}}},u={render:()=>n.jsxs("div",{className:"tw:flex tw:flex-wrap tw:gap-2",children:[n.jsx(r,{variant:"default",children:"Default"}),n.jsx(r,{variant:"destructive",children:"Destructive"}),n.jsx(r,{variant:"outline",children:"Outline"}),n.jsx(r,{variant:"secondary",children:"Secondary"}),n.jsx(r,{variant:"ghost",children:"Ghost"}),n.jsx(r,{variant:"link",children:"Link"})]}),parameters:{docs:{description:{story:"All button variants displayed together. Try editing this code to add new variants or modify existing ones."}}}},m={render:()=>n.jsxs("div",{className:"tw:flex tw:flex-wrap tw:items-center tw:gap-4",children:[n.jsxs("div",{className:"tw:flex tw:items-center tw:gap-2",children:[n.jsx("span",{className:"tw:text-sm",children:"default:"}),n.jsx(r,{size:"default",children:"Button"})]}),n.jsxs("div",{className:"tw:flex tw:items-center tw:gap-2",children:[n.jsx("span",{className:"tw:text-sm",children:"sm:"}),n.jsx(r,{size:"sm",children:"Button"})]}),n.jsxs("div",{className:"tw:flex tw:items-center tw:gap-2",children:[n.jsx("span",{className:"tw:text-sm",children:"lg:"}),n.jsx(r,{size:"lg",children:"Button"})]}),n.jsxs("div",{className:"tw:flex tw:items-center tw:gap-2",children:[n.jsx("span",{className:"tw:text-sm",children:"icon:"}),n.jsx(r,{size:"icon",children:"★"})]})]}),parameters:{docs:{description:{story:"All button sizes displayed together."}}}},p={args:{children:"Destructive Button",variant:"destructive"}},v={args:{children:"Outline Button",variant:"outline"}},w={args:{children:"Secondary Button",variant:"secondary"}},b={args:{children:"Ghost Button",variant:"ghost"}},h={args:{children:"Link Button",variant:"link"}},g={args:{children:"Disabled Button",disabled:!0}},B={args:{children:"Playground Button",variant:"default",size:"default"}},y={args:{children:"Click Me",variant:"default",onClick:c()},play:async({args:a,canvas:o,userEvent:s})=>{const e=o.getByRole("button",{name:/click me/i});await t(e).toBeInTheDocument(),await t(e).toBeVisible(),await s.click(e),await t(a.onClick).toHaveBeenCalled(),await t(a.onClick).toHaveBeenCalledTimes(1)}},x={args:{children:"Disabled Button",disabled:!0,onClick:c()},play:async({args:a,canvas:o})=>{const s=o.getByRole("button",{name:/disabled button/i});await t(s).toBeInTheDocument(),await t(s).toBeDisabled(),await t(a.onClick).not.toHaveBeenCalled()}},f={args:{children:"Variant Test",variant:"destructive",onClick:c()},play:async({args:a,canvas:o,userEvent:s})=>{const e=o.getByRole("button",{name:/variant test/i});await t(e).toBeInTheDocument(),await t(e).toHaveClass("tw:bg-destructive/10"),await s.click(e),await t(a.onClick).toHaveBeenCalledTimes(1),await s.hover(e),await t(e).toBeInTheDocument(),await s.unhover(e),await t(e).toBeInTheDocument()}},C={args:{children:"Size Test",size:"lg",onClick:c()},play:async({args:a,canvas:o,userEvent:s})=>{const e=o.getByRole("button",{name:/size test/i});await t(e).toBeInTheDocument(),await t(e).toHaveClass("tw:h-9"),await s.dblClick(e),await t(a.onClick).toHaveBeenCalledTimes(2),e.focus(),await t(e).toHaveFocus(),e.blur(),await t(e).not.toHaveFocus()}},k={args:{children:"Complex Test Button",variant:"default",onClick:c()},play:async({args:a,canvas:o,userEvent:s,step:e})=>{await e("Initial button verification",async()=>{const i=o.getByRole("button",{name:/complex test button/i});await t(i).toBeInTheDocument(),await t(i).toBeVisible(),await t(i).toBeEnabled()}),await e("Mouse interactions",async()=>{const i=o.getByRole("button",{name:/complex test button/i});await s.hover(i),await s.unhover(i),await s.click(i),await t(a.onClick).toHaveBeenCalledTimes(1)}),await e("Keyboard interactions",async()=>{const i=o.getByRole("button",{name:/complex test button/i});i.focus(),await t(i).toHaveFocus(),await s.keyboard("{Enter}"),await t(a.onClick).toHaveBeenCalledTimes(2),await s.keyboard(" "),await t(a.onClick).toHaveBeenCalledTimes(3)}),await e("Final verification",async()=>{const i=o.getByRole("button",{name:/complex test button/i});await t(i).toBeInTheDocument(),await t(a.onClick).toHaveBeenCalledTimes(3)})}};var T,D,S;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
