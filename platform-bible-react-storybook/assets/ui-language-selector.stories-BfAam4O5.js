import{j as s}from"./jsx-runtime-CmmzXrJH.js";import{r as V}from"./iframe-BsWDzEyf.js";import{c as D}from"./shadcn-ui.util-DMJ19wEV.js";import{S as J,a as $,b as B,c as H,d as Y}from"./select-B8Q0XAE9.js";import{L as F}from"./label-DgqGWOsJ.js";import{T as W}from"./theme-provider.component-BNxwmm-T.js";import"./index-CqneOVt3.js";import"./index-DyqAgL90.js";import"./index-BaQP4hhM.js";import"./index-BmxpoD00.js";import"./index-C7pTuPyx.js";import"./index-CGLCu9Fs.js";import"./index-oFr0vt4y.js";import"./index-BQaOy-SC.js";import"./index-CydhS8Qm.js";import"./index-wa1Rj05D.js";import"./index-BIXxjs8L.js";import"./index-BDx8jCae.js";import"./index-BMMJmLEn.js";import"./index-S3OpJ3qQ.js";import"./floating-ui.react-dom-DGCtlWi3.js";import"./index-DmqIdAoO.js";import"./index-Cncz7Tev.js";import"./index-Bnf4O7S7.js";import"./index-qNVv6Ogk.js";import"./index-BGE-opHk.js";import"./index-BhGT0fAg.js";import"./index-BPbCuWFR.js";import"./chevron-down-BoBCDFcd.js";import"./createLucideIcon-Z6nNrFZk.js";import"./check-Cgcd5_F1.js";const M=(e,a)=>e[a]??a;function o({knownUiLanguages:e,primaryLanguage:a="en",fallbackLanguages:t=[],onLanguagesChange:m,onPrimaryLanguageChange:d,onFallbackLanguagesChange:h,localizedStrings:q,className:K}){const O=M(q,"%settings_uiLanguageSelector_selectFallbackLanguages%"),[R,p]=V.useState(!1),G=n=>{d&&d(n),m&&m([n,...t.filter(g=>g!==n)]),h&&t.find(g=>g===n)&&h([...t.filter(g=>g!==n)]),p(!1)},L=(n,g)=>{var y,b,k,S,w,C;const f=g!==n?((b=(y=e[n])==null?void 0:y.uiNames)==null?void 0:b[g])??((S=(k=e[n])==null?void 0:k.uiNames)==null?void 0:S.en):void 0;return f?`${(w=e[n])==null?void 0:w.autonym} (${f})`:(C=e[n])==null?void 0:C.autonym};return s.jsxs("div",{className:D("pr-twp tw-max-w-sm",K),children:[s.jsxs(J,{name:"uiLanguage",value:a,onValueChange:G,open:R,onOpenChange:n=>p(n),children:[s.jsx($,{children:s.jsx(B,{})}),s.jsx(H,{className:"tw-z-[250]",children:Object.keys(e).map(n=>s.jsx(Y,{value:n,children:L(n,a)},n))})]}),a!=="en"&&s.jsxs(s.Fragment,{children:[s.jsx(F,{className:"tw-ms-3",children:O}),s.jsx("div",{className:"tw-ms-3",children:s.jsxs(F,{children:["Currently:"," ",(t==null?void 0:t.length)>0?`${t.map(n=>L(n,a)).join(", ")}`:`default (${e.en.autonym})`]})})]})]})}o.__docgenInfo={description:`A component for selecting the user interface language and managing fallback languages. Allows
