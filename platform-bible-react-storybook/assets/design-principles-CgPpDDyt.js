import{j as e,M as a}from"./iframe-DlHZf3Mf.js";import{useMDXComponents as o}from"./index-DCrUOgva.js";import{B as s}from"./button-CH3NjS7l.js";import{E as d,a as i}from"./example-block.component-D6i9xVlj.js";import"./preload-helper-CTOgD26E.js";import"./index-BnuTq2W6.js";import"./utils-BPbySc-g.js";import"./index-DPlOqNfc.js";import"./createLucideIcon-DbC0KmkZ.js";import"./info-CCQNmmAG.js";import"./chevron-down-BomOh4z5.js";function r(t){const n={a:"a",blockquote:"blockquote",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Guidelines/Design Principles"}),`
...
`,e.jsxs(d,{children:[e.jsx(i,{variant:"avoid",preview:e.jsxs(n.div,{style:{display:"flex",gap:"8px"},children:[e.jsx(s,{variant:"secondary",children:"Cancel"}),e.jsx(s,{children:"OK"})]}),children:e.jsx(n.p,{children:"Neither label explains what will happen — users dismiss without reading."})}),e.jsx(i,{variant:"prefer",preview:e.jsxs(n.div,{style:{display:"flex",gap:"8px"},children:[e.jsx(s,{variant:"secondary",children:"Discard"}),e.jsx(s,{children:"Comment"})]}),children:e.jsx(n.p,{children:"Both actions are self-evident — the choice is clear without reading surrounding text."})})]}),`
...
`,e.jsxs(n.p,{children:["See also: ",e.jsx(n.a,{href:"./responsiveness.mdx",children:"Responsiveness"})," for minimum width requirements and container query guidance."]})]})}function b(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{b as default};
