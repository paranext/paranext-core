import{j as e}from"./jsx-runtime-0Go213k1.js";import{B as t}from"./badge-Bjo-WX-N.js";import{T as F}from"./theme-provider.component-B0ilSNzl.js";import{X as E}from"./x-B7I-m6G5.js";import{c as M}from"./createLucideIcon-BX3vbOio.js";import{C as O}from"./circle-alert-DiSzobf_.js";import{S as R}from"./star-DFJ5ZNeF.js";import{I as L}from"./info-DYCnWWob.js";import"./iframe-bNjfC5uw.js";import"./preload-helper-CTOgD26E.js";import"./index-BPbCuWFR.js";import"./shadcn-ui.util-DMJ19wEV.js";/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const P=[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]],m=M("CircleCheckBig",P),{fn:s}=__STORYBOOK_MODULE_TEST__,Z={title:"Shadcn/Badge",component:t,tags:["autodocs","test"],argTypes:{variant:{options:["default","destructive","outline","secondary","muted"],control:{type:"select"}},className:{control:"text"}},decorators:[a=>e.jsx(F,{children:e.jsx("div",{className:"tw-p-4",children:e.jsx(a,{})})})]},r={render:a=>e.jsx(t,{...a,children:"Default Badge"}),args:{variant:"default"},parameters:{docs:{description:{story:"A basic badge with the default variant."}}}},i={render:()=>e.jsxs("div",{className:"tw-flex tw-flex-wrap tw-gap-2",children:[e.jsx(t,{variant:"default",children:"Default"}),e.jsx(t,{variant:"destructive",children:"Destructive"}),e.jsx(t,{variant:"outline",children:"Outline"}),e.jsx(t,{variant:"secondary",children:"Secondary"}),e.jsx(t,{variant:"muted",children:"Muted"})]}),parameters:{docs:{description:{story:"All available badge variants displayed together."}}}},c={render:()=>e.jsxs("div",{className:"tw-flex tw-flex-wrap tw-gap-2",children:[e.jsxs(t,{variant:"default",children:[e.jsx(R,{className:"tw-me-1 tw-h-3 tw-w-3"}),"Featured"]}),e.jsxs(t,{variant:"destructive",children:[e.jsx(O,{className:"tw-me-1 tw-h-3 tw-w-3"}),"Error"]}),e.jsxs(t,{variant:"secondary",children:[e.jsx(m,{className:"tw-me-1 tw-h-3 tw-w-3"}),"Completed"]}),e.jsxs(t,{variant:"outline",children:[e.jsx(L,{className:"tw-me-1 tw-h-3 tw-w-3"}),"Info"]})]}),parameters:{docs:{description:{story:"Badges can include icons to provide additional context."}}}},n={render:()=>e.jsxs("div",{className:"tw-flex tw-flex-wrap tw-gap-2",children:[e.jsx(t,{className:"tw-cursor-pointer hover:tw-opacity-80",onClick:s(),variant:"default",children:"Clickable Badge"}),e.jsxs(t,{className:"tw-cursor-pointer hover:tw-opacity-80",onClick:s(),variant:"destructive",children:["Remove ",e.jsx(E,{className:"tw-ms-1 tw-h-3 tw-w-3"})]}),e.jsxs(t,{className:"tw-cursor-pointer hover:tw-opacity-80",onClick:s(),variant:"outline",children:["Select ",e.jsx(m,{className:"tw-ms-1 tw-h-3 tw-w-3"})]})]}),parameters:{docs:{description:{story:"Badges can be made clickable for interactive functionality."}}}},o={render:()=>e.jsxs(t,{className:"tw-cursor-pointer hover:tw-opacity-80",onClick:s(),variant:"destructive",children:["Dismissible ",e.jsx(E,{className:"tw-ms-1 tw-h-3 tw-w-3"})]}),parameters:{docs:{description:{story:"A badge with a close icon that can be dismissed."}}}},d={render:()=>e.jsxs("div",{className:"tw-space-y-2",children:[e.jsxs("div",{className:"tw-flex tw-items-center tw-gap-2",children:[e.jsx("span",{className:"tw-text-sm",children:"Status:"}),e.jsxs(t,{variant:"secondary",children:[e.jsx(m,{className:"tw-me-1 tw-h-3 tw-w-3"}),"Active"]})]}),e.jsxs("div",{className:"tw-flex tw-items-center tw-gap-2",children:[e.jsx("span",{className:"tw-text-sm",children:"Priority:"}),e.jsxs(t,{variant:"destructive",children:[e.jsx(O,{className:"tw-me-1 tw-h-3 tw-w-3"}),"High"]})]}),e.jsxs("div",{className:"tw-flex tw-items-center tw-gap-2",children:[e.jsx("span",{className:"tw-text-sm",children:"Type:"}),e.jsx(t,{variant:"outline",children:"Feature"})]})]}),parameters:{docs:{description:{story:"Badges used to display status information in a structured layout."}}}},l={render:a=>e.jsx(t,{...a,children:"Interactive Badge"}),args:{variant:"default",className:"tw-cursor-pointer hover:tw-opacity-80",onClick:s()},parameters:{docs:{description:{story:"An interactive badge where you can experiment with different properties using the controls."}}}};var p,w,u;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
...
}`,...(T=(_=l.parameters)==null?void 0:_.docs)==null?void 0:T.source}}};const $=["Default","Variants","WithIcons","Clickable","DismissibleBadge","StatusBadges","Interactive"];export{n as Clickable,r as Default,o as DismissibleBadge,l as Interactive,d as StatusBadges,i as Variants,c as WithIcons,$ as __namedExportsOrder,Z as default};
