import{j as s}from"./iframe-25ZW9MS6.js";import{R as j,D as g}from"./LexicalTable.prod-BAD2GdMM.js";import{P as K,c as H,b as U}from"./popover-Bp_7phnZ.js";import{F as G}from"./footnote-editor.component-CYTKRmgC.js";import{l as W}from"./index-BwGqfxvI.js";import{a as Y}from"./cancel-accept-buttons.component-CNtqBVq2.js";import{a as z}from"./undo-redo-buttons.component-CtCA7s4Z.js";import{a as J}from"./marker-menu.component-B3btcKZK.js";import"./preload-helper-CTOgD26E.js";import"./utils-BPbySc-g.js";import"./z-index-DiGYIwoM.js";import"./content-zoom-area.context-BIoPBDJ7.js";import"./index-wXkS81st.js";import"./index-B69je-EC.js";import"./index-DTsSkeTM.js";import"./index-Bj6UdOd8.js";import"./index-C6wB8dB5.js";import"./index-Debo8KO_.js";import"./index-DRNveUqL.js";import"./index-X7oh8j-w.js";import"./index-C8Btyat7.js";import"./index-BZjkuUnZ.js";import"./floating-ui.dom-CQVRXqPN.js";import"./index-CZQ9f2kG.js";import"./index-BLBYE--f.js";import"./button-hQ8AB81B.js";import"./index-BnuTq2W6.js";import"./button-group-LD48N9bl.js";import"./separator-C_INHtyT.js";import"./tooltip-CqClp5Nr.js";import"./index-BvjdbOee.js";import"./platform.util-Dj487_od.js";import"./dropdown-menu-CYH3j2q5.js";import"./menu.context-DwdnXNZ7.js";import"./IconChevronRight-BJUVMz4C.js";import"./index-BG_TB2ko.js";import"./index-HdcTGxCT.js";import"./createReactComponent-Boi20Vm_.js";import"./IconCheck-BZVOGkaD.js";import"./input-Blcj-Yfl.js";import"./createLucideIcon-B3OEF0Z6.js";import"./scripture-util-DArajUVn-BzQhUzBK.js";import"./index.es-CXoS8DB2.js";import"./index-DCo3rgjq.js";import"./copy-DtsKB8JA.js";import"./index-C77E7Q-s.js";import"./x-D0BJ-pJ5.js";import"./check-CCahCEJH.js";import"./kbd-B_Bt11KV.js";import"./index-D8rZSbDD.js";import"./command-_FWXsECT.js";import"./index-DyxEYbz5.js";import"./dialog-CVkDvRko.js";import"./input-group-DjM44cN1.js";const V=Object.freeze([...J,...Object.entries(W).map(([,t])=>t.description).filter(t=>!!t),"%footnoteEditor_callerDropdown_item_custom%","%footnoteEditor_callerDropdown_item_generated%","%footnoteEditor_callerDropdown_item_hidden%","%footnoteEditor_callerDropdown_label%","%footnoteEditor_callerDropdown_tooltip%","%footnoteEditor_copyButton_tooltip%","%footnoteEditor_noteType_crossReference_label%","%footnoteEditor_noteType_endNote_label%","%footnoteEditor_noteType_footnote_label%","%footnoteEditor_noteType_tooltip%","%footnoteEditor_noteTypeDropdown_label%","%footnoteEditor_saveButton_tooltip%",...z,...Y]);function $(){const t=V.map(e=>[e,e]);return Object.fromEntries(t)}const Q={book:"GEN",chapterNum:1,verseNum:1,verse:"1"},X={insert:{note:{style:"f",caller:"+",contents:{ops:[{insert:"1:1 ",attributes:{char:{style:"fr",closed:"false"}}},{insert:"sentinel note text",attributes:{char:{style:"ft",closed:"false"}}}]}}}},Z={insert:{note:{style:"f",caller:"+",contents:{ops:[{insert:"1:1 ",attributes:{char:{style:"fr",closed:"false"}}},{insert:"first paragraph ",attributes:{char:{style:"ft",closed:"false"}}},{insert:"second paragraph ",attributes:{char:{style:"fp",closed:"false",cid:"fp-1"}}},{insert:"third paragraph",attributes:{char:{style:"fp",closed:"false",cid:"fp-2"}}}]}}}},tt={markerMode:"editable",hasSpacing:!0,isFormattedFont:!0},{expect:n,userEvent:q,waitFor:h}=__STORYBOOK_MODULE_TEST__;function C(){const t=document.querySelector(".editor-input");return t==null?void 0:t.__lexicalEditor}function d(t){return t.getEditorState().read(()=>j().getChildrenSize())}function f(t){return t.getEditorState().read(()=>{const e=[],r=o=>{if(o.getType()==="char"){const i=o;typeof i.getMarker=="function"&&e.push(i.getMarker())}g(o)&&o.getChildren().forEach(r)},a=j().getChildren().flatMap(o=>g(o)?o.getChildren():[]).find(o=>o.getType()==="note");return a&&g(a)&&a.getChildren().forEach(r),e})}async function w(){await h(()=>n(C()).toBeTruthy(),{timeout:4e3}),await new Promise(r=>{setTimeout(r,400)});const t=document.querySelector(".editor-input"),e=C();if(!(t instanceof HTMLElement)||!e)throw new Error("popover editor did not mount");return{editorInput:t,lexical:e}}function S(t){t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",bubbles:!0,cancelable:!0}))}const ee={title:"Advanced/FootnoteEditor",component:G,tags:["test"]};function E({noteOps:t=[X]}){return s.jsxs(K,{open:!0,children:[s.jsx(H,{className:"tw:absolute",style:{top:120,left:120}}),s.jsx(U,{className:"tw:w-max tw:min-w-[500px] tw:p-[10px]",children:s.jsx(G,{noteOps:t,onClose:()=>{},scrRef:Q,noteKey:void 0,editorOptions:{view:tt},defaultMarkerMenuTrigger:"\\",localizedStrings:$()})})]})}const p={render:()=>s.jsx(E,{}),play:async()=>{const{editorInput:t,lexical:e}=await w();n(d(e)).toBe(1),n(f(e)).not.toContain("fp"),t.focus(),await q.keyboard("{Enter}"),await h(()=>n(f(e)).toContain("fp")),n(d(e)).toBe(1)}},c={render:()=>s.jsx(E,{noteOps:[Z]}),play:async()=>{const{editorInput:t}=await w(),e=t.querySelector("span.note");if(!e)throw new Error("expanded note span not found");n(e.classList.contains("expanded")).toBe(!0);const r=e.querySelector("span.usfm_ft"),a=e.querySelectorAll("span.usfm_fp");if(!r)throw new Error("\\ft span not found");n(a).toHaveLength(2);const o=r.getBoundingClientRect(),i=a[0].getBoundingClientRect(),u=a[1].getBoundingClientRect();n(i.top).toBeGreaterThan(o.top),n(u.top).toBeGreaterThan(i.top);const y=e.querySelector('span.closing[data-marker="f"]');if(!y)throw new Error("\\f* closer glyph not found");const x=y.getBoundingClientRect();n(x.top).toBeLessThan(u.bottom),n(x.bottom).toBeGreaterThan(u.top),n(t.textContent).not.toContain(`
