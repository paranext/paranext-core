import{j as s}from"./iframe-BLouS63C.js";import{R as j,D as g}from"./LexicalTable.prod-DjETO6fU.js";import{P as K,c as H,b as U}from"./popover-DMtu4R9Y.js";import{F as G}from"./footnote-editor.component-5bnFX8jj.js";import{Z as W}from"./index-mGkT7YiS.js";import{a as Y}from"./cancel-accept-buttons.component-Bkc8KBQ9.js";import{a as z}from"./undo-redo-buttons.component-D5YqIR0B.js";import{a as J}from"./marker-menu.component-D_NQ1dzB.js";import"./preload-helper-CTOgD26E.js";import"./utils-BPbySc-g.js";import"./z-index-DiGYIwoM.js";import"./index-BJI4uwE5.js";import"./index-CHiGwW9C.js";import"./index-BZHZa2Al.js";import"./index-BXTkrbmv.js";import"./index-CKZ_WzNU.js";import"./index-Bi6vM45r.js";import"./index-BYpYHQSQ.js";import"./index-Dnc0Ht0Z.js";import"./index-ddkEJgJn.js";import"./index-CHsdSc2l.js";import"./floating-ui.dom-CQVRXqPN.js";import"./index-dtNwL1Yi.js";import"./index-DdoOfSqE.js";import"./button-DkEoLQZ3.js";import"./index-BnuTq2W6.js";import"./button-group-r5F3lQOa.js";import"./separator-3KwGM8kI.js";import"./tooltip-CJO8ctpM.js";import"./index-CrdBEV0e.js";import"./platform.util-Dj487_od.js";import"./dropdown-menu-CVACmcaL.js";import"./menu.context-BnCFrB0O.js";import"./IconChevronRight-BsicRiZI.js";import"./index-Dt1hruos.js";import"./index-B5ku4Z5Y.js";import"./createReactComponent-ChkUQwtL.js";import"./IconCheck-iMS4ghXR.js";import"./input-DdHzlEzQ.js";import"./createLucideIcon-CnYUWbE3.js";import"./scripture-util-DArajUVn-CPHPTCtZ.js";import"./index.es-CXoS8DB2.js";import"./index-DCo3rgjq.js";import"./copy-BaEKeufI.js";import"./index-C77E7Q-s.js";import"./x-CYUfxdGw.js";import"./check-BKmE5aQx.js";import"./kbd-B9HNtLB-.js";import"./index-D8rZSbDD.js";import"./command-DhoZS6hs.js";import"./index-CtaTf5_H.js";import"./dialog-RT-NBuMG.js";import"./input-group-CmJhcCTe.js";const V=Object.freeze([...J,...Object.entries(W).map(([,t])=>t.description).filter(t=>!!t),"%footnoteEditor_callerDropdown_item_custom%","%footnoteEditor_callerDropdown_item_generated%","%footnoteEditor_callerDropdown_item_hidden%","%footnoteEditor_callerDropdown_label%","%footnoteEditor_callerDropdown_tooltip%","%footnoteEditor_copyButton_tooltip%","%footnoteEditor_noteType_crossReference_label%","%footnoteEditor_noteType_endNote_label%","%footnoteEditor_noteType_footnote_label%","%footnoteEditor_noteType_tooltip%","%footnoteEditor_noteTypeDropdown_label%","%footnoteEditor_saveButton_tooltip%",...z,...Y]);function Z(){const t=V.map(e=>[e,e]);return Object.fromEntries(t)}const $={book:"GEN",chapterNum:1,verseNum:1,verse:"1"},Q={insert:{note:{style:"f",caller:"+",contents:{ops:[{insert:"1:1 ",attributes:{char:{style:"fr",closed:"false"}}},{insert:"sentinel note text",attributes:{char:{style:"ft",closed:"false"}}}]}}}},X={insert:{note:{style:"f",caller:"+",contents:{ops:[{insert:"1:1 ",attributes:{char:{style:"fr",closed:"false"}}},{insert:"first paragraph ",attributes:{char:{style:"ft",closed:"false"}}},{insert:"second paragraph ",attributes:{char:{style:"fp",closed:"false",cid:"fp-1"}}},{insert:"third paragraph",attributes:{char:{style:"fp",closed:"false",cid:"fp-2"}}}]}}}},tt={markerMode:"editable",hasSpacing:!0,isFormattedFont:!0},{expect:n,userEvent:q,waitFor:h}=__STORYBOOK_MODULE_TEST__;function C(){const t=document.querySelector(".editor-input");return t==null?void 0:t.__lexicalEditor}function d(t){return t.getEditorState().read(()=>j().getChildrenSize())}function f(t){return t.getEditorState().read(()=>{const e=[],r=o=>{if(o.getType()==="char"){const i=o;typeof i.getMarker=="function"&&e.push(i.getMarker())}g(o)&&o.getChildren().forEach(r)},a=j().getChildren().flatMap(o=>g(o)?o.getChildren():[]).find(o=>o.getType()==="note");return a&&g(a)&&a.getChildren().forEach(r),e})}async function w(){await h(()=>n(C()).toBeTruthy(),{timeout:4e3}),await new Promise(r=>{setTimeout(r,400)});const t=document.querySelector(".editor-input"),e=C();if(!(t instanceof HTMLElement)||!e)throw new Error("popover editor did not mount");return{editorInput:t,lexical:e}}function S(t){t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",bubbles:!0,cancelable:!0}))}const te={title:"Advanced/FootnoteEditor",component:G,tags:["test"]};function E({noteOps:t=[Q]}){return s.jsxs(K,{open:!0,children:[s.jsx(H,{className:"tw:absolute",style:{top:120,left:120}}),s.jsx(U,{className:"tw:w-max tw:min-w-[500px] tw:p-[10px]",children:s.jsx(G,{noteOps:t,onClose:()=>{},scrRef:$,noteKey:void 0,editorOptions:{view:tt},defaultMarkerMenuTrigger:"\\",localizedStrings:Z()})})]})}const p={render:()=>s.jsx(E,{}),play:async()=>{const{editorInput:t,lexical:e}=await w();n(d(e)).toBe(1),n(f(e)).not.toContain("fp"),t.focus(),await q.keyboard("{Enter}"),await h(()=>n(f(e)).toContain("fp")),n(d(e)).toBe(1)}},c={render:()=>s.jsx(E,{noteOps:[X]}),play:async()=>{const{editorInput:t}=await w(),e=t.querySelector("span.note");if(!e)throw new Error("expanded note span not found");n(e.classList.contains("expanded")).toBe(!0);const r=e.querySelector("span.usfm_ft"),a=e.querySelectorAll("span.usfm_fp");if(!r)throw new Error("\\ft span not found");n(a).toHaveLength(2);const o=r.getBoundingClientRect(),i=a[0].getBoundingClientRect(),u=a[1].getBoundingClientRect();n(i.top).toBeGreaterThan(o.top),n(u.top).toBeGreaterThan(i.top);const y=e.querySelector('span.closing[data-marker="f"]');if(!y)throw new Error("\\f* closer glyph not found");const x=y.getBoundingClientRect();n(x.top).toBeLessThan(u.bottom),n(x.bottom).toBeGreaterThan(u.top),n(t.textContent).not.toContain(`
