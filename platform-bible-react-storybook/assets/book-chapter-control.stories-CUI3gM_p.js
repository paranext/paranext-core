import{j as m}from"./jsx-runtime-B7VQ_UGD.js";import{r as f}from"./iframe-hVnludCD.js";import{T as p}from"./index-CmLeGMp1.js";import{B as L,u as Ve}from"./book-chapter-control.component-BK7eWnan.js";import{T as Se}from"./theme-provider.component-jvb69FPq.js";import"./index-D2w9gCAG.js";import"./book-item.utils-C3_bfjJL.js";import"./command-Ch7UHLK-.js";import"./index-Cn8XN8C9.js";import"./index-DTAXz6r9.js";import"./index-DUpBdKYq.js";import"./index-34ihhmVi.js";import"./index-Cct4eh4K.js";import"./index-DH4U3imX.js";import"./index-DHMqt8JU.js";import"./index-BW6oqNc5.js";import"./index-BLIJc0Nq.js";import"./index-DW7_Au2H.js";import"./index-pHsrwaUn.js";import"./index-1Q_Gj5T0.js";import"./index-Cqrmo211.js";import"./index-DDXlcyCx.js";import"./index-DAVNvmxS.js";import"./index-B9dFRn_k.js";import"./shadcn-ui.util-DMJ19wEV.js";import"./dialog-DJszwAZd.js";import"./index-Czfav6j7.js";import"./x-F7N2r6Bg.js";import"./createLucideIcon-DbdeXMYF.js";import"./search-BA9XBzra.js";import"./index.es-D4jfZzAn.js";import"./check-DodFOtSU.js";import"./button-DdAvf5la.js";import"./index-BPbCuWFR.js";import"./popover-CknQxVi7.js";import"./index-B-yHJ0dV.js";import"./floating-ui.react-dom-D1fWklu8.js";import"./index-ziRGe1oU.js";import"./index-GnII8x_M.js";import"./chevron-left-BscxnUnY.js";import"./chevron-right-CCHaaS7G.js";import"./arrow-right-BIvuukzw.js";const{expect:i,fn:V,screen:M,waitFor:Ee,within:c}=__STORYBOOK_MODULE_TEST__;function Pe({scrRef:a,handleSubmit:o,...n}){const[s,e]=f.useState(a),t=f.useCallback(d=>{e(d),o(d)},[o]);return m.jsx(Se,{children:m.jsxs("div",{className:"tw-p-4",children:[m.jsx(L,{...n,scrRef:s,handleSubmit:t}),m.jsxs("div",{className:"tw-mt-4 tw-text-sm tw-text-gray-600",children:["Current Reference: ",JSON.stringify(s,void 0,2)]})]})})}const l="combobox",w="combobox",k="option";async function g(){const a=M.getByRole("dialog");return await Ee(()=>i(a).toHaveStyle("opacity: 1")),await i(a).toBeVisible(),a}async function u(){const a=M.queryByRole("dialog");a?await Ee(()=>i(a).toHaveAttribute("data-state","closed")):i(a).not.toBeInTheDocument()}function r(){return M.getByRole("dialog")}const zt={title:"Advanced/BookChapterControl",component:L,tags:["autodocs"],args:{scrRef:p,handleSubmit:V(a=>console.log("Scripture reference changed:",a))},render:a=>m.jsx(Pe,{...a})},b={args:{scrRef:p}},C={args:{scrRef:{book:"PSA",chapterNum:135,verseNum:10}}},R={args:{scrRef:p,getActiveBookIds:()=>["GEN","EXO","MAT","JHN","ROM","REV"]},parameters:{docs:{description:{story:"Shows the component with a limited set of available books."}}}},B={args:{scrRef:p,className:"tw-w-64 tw-bg-blue-50 tw-rounded-xl tw-p-4"},parameters:{docs:{description:{story:"Shows the component with custom styling applied to the trigger button."}}}},T={args:{scrRef:p,getActiveBookIds:()=>[]},parameters:{docs:{description:{story:"Shows the component with an empty list of available books."}}}},I={args:{scrRef:{book:"ROM",chapterNum:8,verseNum:1}},play:async({canvas:a,userEvent:o,step:n,args:s})=>{await n("Open the book chapter control",async()=>{const e=a.getByRole(l);await i(e).toBeInTheDocument(),await o.click(e)}),await n("Select Romans book",async()=>{const e=await g(),t=c(e).getByText("Romans");await i(t).toBeInTheDocument(),await o.click(t)}),await n("Verify chapter grid is displayed for Romans",async()=>{const e=r(),t=c(e).getByRole(k,{name:"8"});await i(t).toBeInTheDocument()}),await n("Verify the correct number of chapters is shown for Romans",async()=>{const e=r(),t=c(e).getAllByRole(k);await i(t.length).toBe(16)}),await n("Select a different chapter",async()=>{const e=r(),t=c(e).getByRole(k,{name:"12"});await o.click(t)}),await n("Verify the different chapter number is selected",async()=>{await u();const e=a.getByRole(l);await i(e).toHaveTextContent("Romans 12:1"),await i(s.handleSubmit).toHaveBeenCalledWith({book:"ROM",chapterNum:12,verseNum:1})})},parameters:{docs:{description:{story:`
...
}`,...(X=(Z=B.parameters)==null?void 0:Z.docs)==null?void 0:X.source}}};var $,Q,Y;T.parameters={...T.parameters,docs:{...($=T.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    getActiveBookIds: () => []
  },
...
}`,...(Y=(Q=T.parameters)==null?void 0:Q.docs)==null?void 0:Y.source}}};var ee,te,ne;I.parameters={...I.parameters,docs:{...(ee=I.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  args: {
    scrRef: {
      book: 'ROM',
      chapterNum: 8,
...
}`,...(ne=(te=I.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var oe,ae,ie;N.parameters={...N.parameters,docs:{...(oe=N.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(Be=(Re=x.parameters)==null?void 0:Re.docs)==null?void 0:Be.source}}};var Te,Ie,Ne;D.parameters={...D.parameters,docs:{...(Te=D.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    handleSubmit: fn(),
    localizedBookNames: spanishBookNames,
...
}`,...(Ne=(Ie=D.parameters)==null?void 0:Ie.docs)==null?void 0:Ne.source}}};var ve,ze,Oe;A.parameters={...A.parameters,docs:{...(ve=A.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
...
}`,...(Oe=(ze=A.parameters)==null?void 0:ze.docs)==null?void 0:Oe.source}}};const Ot=["Default","WithSpecificBook","WithLimitedBooks","WithCustomTrigger","EmptyBookList","ChapterSelectionDemo","SmartParsingDemo","BookSearchAndNavigation","SingleChapterBookDemo","KeyboardNavigation","ComprehensiveInteractionTest","WithLocalizedSpanishBookNames","WithLocalizedFrenchBookNames","WithLocalizedSectionNames","WithRecentSearches"];export{v as BookSearchAndNavigation,I as ChapterSelectionDemo,S as ComprehensiveInteractionTest,b as Default,T as EmptyBookList,O as KeyboardNavigation,z as SingleChapterBookDemo,N as SmartParsingDemo,B as WithCustomTrigger,R as WithLimitedBooks,x as WithLocalizedFrenchBookNames,D as WithLocalizedSectionNames,E as WithLocalizedSpanishBookNames,A as WithRecentSearches,C as WithSpecificBook,Ot as __namedExportsOrder,zt as default};
