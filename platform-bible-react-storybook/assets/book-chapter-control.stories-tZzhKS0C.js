import{j as u,r as b}from"./iframe-CsghpkMy.js";import"./index-BnMb6O87.js";import{B as _,u as $e}from"./book-chapter-control.component-NyoJwOEP.js";import{z as p}from"./scripture-util-CIEEBU92-Dw9itcOy.js";import"./preload-helper-CTOgD26E.js";import"./index.es-LuWhpyxP.js";import"./index-D2t4nnj1.js";import"./book-item.utils-BeWWS2qR.js";import"./command-CI4nMQJ-.js";import"./index-BKOnyp93.js";import"./index-kkulAiT2.js";import"./index-v78PCpsp.js";import"./index-CRyqq9LD.js";import"./index-BUM--q3Z.js";import"./index-Cu4tOs5Y.js";import"./index-COPDFBt5.js";import"./index-C18VL2gu.js";import"./index-fljO0bKx.js";import"./index-BZeWIhZO.js";import"./index-BB60gguN.js";import"./utils-BPbySc-g.js";import"./dialog-aOdIROo-.js";import"./z-index-CoNkaVR8.js";import"./button-D0Rq_U4M.js";import"./index-BnuTq2W6.js";import"./createReactComponent-mgHzqZZ3.js";import"./input-group-CekJp4OF.js";import"./input-CbJBIjuK.js";import"./IconCheck-Cu3sMnfZ.js";import"./check-DkrEbJsC.js";import"./createLucideIcon-BXLVz5Yd.js";import"./popover-J3kVakdb.js";import"./index-qLj3dUYW.js";import"./index-CT4e56tM.js";import"./chevron-right-CxWfKKCz.js";import"./arrow-left-BGXOopSz.js";import"./arrow-right-Cb0aAbFF.js";const{expect:r,fn:k,screen:U,waitFor:qe,within:c}=__STORYBOOK_MODULE_TEST__,Qe={GEN:{1:31,2:25,3:24},PSA:{23:6,117:2,119:176,135:21},MAT:{1:25,5:48,15:39},JHN:{3:36},ROM:{8:39,12:21},"1CO":{13:13},REV:{22:21},OBA:{1:21}};function J(a,o){var n;return((n=Qe[a])==null?void 0:n[o])??30}function Ye({scrRef:a,handleSubmit:o,...n}){const[i,e]=b.useState(a),t=b.useCallback(d=>{e(d),o(d)},[o]);return u.jsxs("div",{className:"tw:p-4",children:[u.jsx(_,{...n,scrRef:i,handleSubmit:t}),u.jsxs("div",{className:"tw:mt-4 tw:text-sm tw:text-gray-600",children:["Current Reference: ",JSON.stringify(i,void 0,2)]})]})}const l="combobox",m="combobox",g="option";async function w(){const a=U.getByRole("dialog");return await qe(()=>r(a).toHaveStyle("opacity: 1")),await r(a).toBeVisible(),a}async function y(){const a=U.queryByRole("dialog");a?await qe(()=>r(a).toHaveAttribute("data-state","closed")):r(a).not.toBeInTheDocument()}function s(){return U.getByRole("dialog")}const Jt={title:"Advanced/BookChapterControl",component:_,tags:["autodocs"],args:{scrRef:p,handleSubmit:k(a=>console.log("Scripture reference changed:",a)),onOpenChange:k()},render:a=>u.jsx(Ye,{...a})},R={args:{scrRef:p}},C={args:{scrRef:{book:"PSA",chapterNum:135,verseNum:10}}},v={args:{scrRef:p,getActiveBookIds:()=>["GEN","EXO","MAT","JHN","ROM","REV"]},parameters:{docs:{description:{story:"Shows the component with a limited set of available books."}}}},B={args:{scrRef:p,className:"tw:w-64 tw:bg-blue-50 tw:rounded-xl tw:p-4"},parameters:{docs:{description:{story:"Shows the component with custom styling applied to the trigger button."}}}},T={args:{scrRef:p,getActiveBookIds:()=>[]},parameters:{docs:{description:{story:"Shows the component with an empty list of available books."}}}},N={args:{scrRef:{book:"ROM",chapterNum:8,verseNum:1}},play:async({canvas:a,userEvent:o,step:n,args:i})=>{await n("Open the book chapter control",async()=>{const e=a.getByRole(l);await r(e).toBeInTheDocument(),await o.click(e)}),await n("Select Romans book",async()=>{const e=await w(),t=c(e).getByText("Romans");await r(t).toBeInTheDocument(),await o.click(t)}),await n("Verify chapter grid is displayed for Romans",async()=>{const e=s(),t=c(e).getByRole(g,{name:"8"});await r(t).toBeInTheDocument()}),await n("Verify the correct number of chapters is shown for Romans",async()=>{const e=s(),t=c(e).getAllByRole(g);await r(t.length).toBe(16)}),await n("Select a different chapter",async()=>{const e=s(),t=c(e).getByRole(g,{name:"12"});await o.click(t)}),await n("Verify the different chapter number is selected",async()=>{await y();const e=a.getByRole(l);await r(e).toHaveTextContent("Romans 12:1"),await r(i.handleSubmit).toHaveBeenCalledWith({book:"ROM",chapterNum:12,verseNum:1})})},parameters:{docs:{description:{story:`
...
The localization is provided through the \`localizedBookNames\` prop, which maps English book IDs to their localized equivalents.
        `}}}},A={args:{scrRef:p,handleSubmit:k(),localizedBookNames:et},parameters:{docs:{description:{story:`
...
Note: This example includes a subset of books to demonstrate the localization feature. In practice, you would provide localized names for all available books.
        `}}}},tt={"%scripture_section_ot_long%":"Antiguo Testamento","%scripture_section_nt_long%":"Nuevo Testamento","%scripture_section_dc_long%":"Deuterocanónicos","%scripture_section_extra_long%":"Material Extra"},V={args:{scrRef:p,handleSubmit:k(),localizedBookNames:Ke,localizedStrings:tt},parameters:{docs:{description:{story:`
...
This demonstrates the full localization capabilities of the component.
        `}}}};function nt({scrRef:a,handleSubmit:o,...n}){const[i,e]=b.useState(a),[t,d]=b.useState([{book:"GEN",chapterNum:1,verseNum:1},{book:"MAT",chapterNum:5,verseNum:3},{book:"JHN",chapterNum:3,verseNum:16},{book:"ROM",chapterNum:8,verseNum:28}]),f=$e(t,d,(h,G)=>h.book===G.book&&h.chapterNum===G.chapterNum&&h.verseNum===G.verseNum),Ze=b.useCallback(h=>{e(h),o(h)},[o]),Xe=b.useCallback(h=>{f(h)},[f]);return u.jsxs("div",{className:"tw:p-4",children:[u.jsx(_,{...n,scrRef:i,handleSubmit:Ze,recentSearches:t,onAddRecentSearch:Xe}),u.jsxs("div",{className:"tw:mt-4 tw:text-sm tw:text-gray-600",children:["Current Reference: ",JSON.stringify(i,void 0,2)]}),u.jsxs("div",{className:"tw:mt-2 tw:text-sm tw:text-gray-500",children:["Recent Searches:"," ",t.map(h=>`${h.book} ${h.chapterNum}:${h.verseNum}`).join(", ")]})]})}const D={args:{scrRef:{book:"REV",chapterNum:22,verseNum:21},getEndVerse:J,disableReferencesUpTo:{book:"MAT",chapterNum:5,verseNum:10}},parameters:{docs:{description:{story:`
...
picking a reference before the "start".
        `}}}},M={args:{scrRef:{book:"JHN",chapterNum:3,verseNum:16},getEndVerse:J},parameters:{docs:{description:{story:`
...
chapter-verse separator (e.g. "John 3:" or "John 3:16") shows a verse grid below the top match.
        `}}}},P={args:{scrRef:p,getEndVerse:J},play:async({canvas:a,userEvent:o,step:n,args:i})=>{await n("Open control and type reference with colon",async()=>{const e=a.getByRole(l);await o.click(e),await w();const t=s(),d=c(t).getByRole(m);await o.type(d,"John 3:")}),await n("Click verse 16 from the verse grid",async()=>{const e=s(),t=await c(e).findByRole(g,{name:"16"});await o.click(t)}),await n("Verify submission with selected verse",async()=>{await r(i.handleSubmit).toHaveBeenCalledWith({book:"JHN",chapterNum:3,verseNum:16}),await y()})},parameters:{docs:{description:{story:'Typing a reference with the chapter-verse separator present (e.g. "John 3:") shows the verse grid so the user can pick a verse.'}}}},L={args:{scrRef:p,getEndVerse:J},play:async({canvas:a,userEvent:o,step:n,args:i})=>{await n("Open control and click Matthew",async()=>{const e=a.getByRole(l);await o.click(e),await w();const t=s(),d=c(t).getByText("Matthew");await o.click(d)}),await n("Click chapter 5 from chapter grid",async()=>{const e=s(),t=await c(e).findByRole(g,{name:"5"});await o.click(t)}),await n("Verify verse grid appears (did not submit yet)",async()=>{await r(i.handleSubmit).not.toHaveBeenCalled();const e=s(),t=await c(e).findByRole(g,{name:"3"});await r(t).toBeInTheDocument()}),await n("Click verse 3 to submit",async()=>{const e=s(),t=c(e).getByRole(g,{name:"3"});await o.click(t)}),await n("Verify submission",async()=>{await r(i.handleSubmit).toHaveBeenCalledWith({book:"MAT",chapterNum:5,verseNum:3}),await y()})},parameters:{docs:{description:{story:"After selecting a chapter from the chapter grid, the control shows a verse grid instead of submitting immediately. The user then picks the verse to finalize the reference."}}}},H={args:{scrRef:p},render:a=>u.jsx(nt,{...a}),parameters:{docs:{description:{story:"BookChapterControl with recent searches functionality. Click the clock icon in the search input to see recent scripture references."}}}};var W,F,j;R.parameters={...R.parameters,docs:{...(W=R.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  }
}`,...(j=(F=R.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var q,K,Z;C.parameters={...C.parameters,docs:{...(q=C.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    scrRef: {
      book: 'PSA',
      chapterNum: 135,
...
}`,...(Z=(K=C.parameters)==null?void 0:K.docs)==null?void 0:Z.source}}};var X,$,Q;v.parameters={...v.parameters,docs:{...(X=v.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
...
}`,...(Q=($=v.parameters)==null?void 0:$.docs)==null?void 0:Q.source}}};var Y,ee,te;B.parameters={...B.parameters,docs:{...(Y=B.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
...
}`,...(te=(ee=B.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ne,oe,ae;T.parameters={...T.parameters,docs:{...(ne=T.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    getActiveBookIds: () => []
  },
...
}`,...(re=(se=N.parameters)==null?void 0:se.docs)==null?void 0:re.source}}};var ce,de,le;I.parameters={...I.parameters,docs:{...(ce=I.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(le=(de=I.parameters)==null?void 0:de.docs)==null?void 0:le.source}}};var pe,he,me;z.parameters={...z.parameters,docs:{...(pe=z.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(ye=(ge=O.parameters)==null?void 0:ge.docs)==null?void 0:ye.source}}};var ue,fe,be;S.parameters={...S.parameters,docs:{...(ue=S.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  args: {
    scrRef: {
      book: 'MAT',
      chapterNum: 15,
...
}`,...(be=(fe=S.parameters)==null?void 0:fe.docs)==null?void 0:be.source}}};var ke,Re,Ce;E.parameters={...E.parameters,docs:{...(ke=E.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(Ce=(Re=E.parameters)==null?void 0:Re.docs)==null?void 0:Ce.source}}};var ve,Be,Te;x.parameters={...x.parameters,docs:{...(ve=x.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    handleSubmit: fn(),
...
}`,...(Te=(Be=x.parameters)==null?void 0:Be.docs)==null?void 0:Te.source}}};var Ne,Ie,ze;A.parameters={...A.parameters,docs:{...(Ne=A.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    handleSubmit: fn(),
...
}`,...(ze=(Ie=A.parameters)==null?void 0:Ie.docs)==null?void 0:ze.source}}};var Oe,Se,Ee;V.parameters={...V.parameters,docs:{...(Oe=V.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    handleSubmit: fn(),
    localizedBookNames: spanishBookNames,
...
}`,...(Ee=(Se=V.parameters)==null?void 0:Se.docs)==null?void 0:Ee.source}}};var xe,Ae,Ve;D.parameters={...D.parameters,docs:{...(xe=D.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  args: {
    scrRef: {
      book: 'REV',
      chapterNum: 22,
...
}`,...(Ve=(Ae=D.parameters)==null?void 0:Ae.docs)==null?void 0:Ve.source}}};var De,Me,Pe;M.parameters={...M.parameters,docs:{...(De=M.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    scrRef: {
      book: 'JHN',
      chapterNum: 3,
...
}`,...(Pe=(Me=M.parameters)==null?void 0:Me.docs)==null?void 0:Pe.source}}};var Le,He,Je;P.parameters={...P.parameters,docs:{...(Le=P.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    getEndVerse: sampleGetEndVerse
  },
...
}`,...(Je=(He=P.parameters)==null?void 0:He.docs)==null?void 0:Je.source}}};var Ge,_e,Ue;L.parameters={...L.parameters,docs:{...(Ge=L.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef,
    getEndVerse: sampleGetEndVerse
  },
...
}`,...(Ue=(_e=L.parameters)==null?void 0:_e.docs)==null?void 0:Ue.source}}};var We,Fe,je;H.parameters={...H.parameters,docs:{...(We=H.parameters)==null?void 0:We.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
...
}`,...(je=(Fe=H.parameters)==null?void 0:Fe.docs)==null?void 0:je.source}}};const Gt=["Default","WithSpecificBook","WithLimitedBooks","WithCustomTrigger","EmptyBookList","ChapterSelectionDemo","SmartParsingDemo","BookSearchAndNavigation","SingleChapterBookDemo","KeyboardNavigation","ComprehensiveInteractionTest","WithLocalizedSpanishBookNames","WithLocalizedFrenchBookNames","WithLocalizedSectionNames","WithDisabledReferences","WithVerseSelection","VerseSelectionByTyping","VerseSelectionFromChapterGrid","WithRecentSearches"];export{z as BookSearchAndNavigation,N as ChapterSelectionDemo,E as ComprehensiveInteractionTest,R as Default,T as EmptyBookList,S as KeyboardNavigation,O as SingleChapterBookDemo,I as SmartParsingDemo,P as VerseSelectionByTyping,L as VerseSelectionFromChapterGrid,B as WithCustomTrigger,D as WithDisabledReferences,v as WithLimitedBooks,A as WithLocalizedFrenchBookNames,V as WithLocalizedSectionNames,x as WithLocalizedSpanishBookNames,H as WithRecentSearches,C as WithSpecificBook,M as WithVerseSelection,Gt as __namedExportsOrder,Jt as default};
