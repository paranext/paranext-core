import{j as u}from"./jsx-runtime-CmmzXrJH.js";import{r as S}from"./iframe-BsWDzEyf.js";import{v as l}from"./index-D2SfiHnw.js";import{B as dt}from"./book-chapter-control.component-heoetoiM.js";import{T as ht}from"./theme-provider.component-BNxwmm-T.js";import"./button-ChiQlUI2.js";import"./index-CydhS8Qm.js";import"./index-BQaOy-SC.js";import"./index-BPbCuWFR.js";import"./shadcn-ui.util-DMJ19wEV.js";import"./command-C-DxzeGy.js";import"./index-dhKKE-PO.js";import"./index-BmxpoD00.js";import"./index-C7pTuPyx.js";import"./index-oFr0vt4y.js";import"./index-qNVv6Ogk.js";import"./index-CqneOVt3.js";import"./index-DyqAgL90.js";import"./index-BMMJmLEn.js";import"./index-S3OpJ3qQ.js";import"./index-CQ0vOd05.js";import"./index-Cncz7Tev.js";import"./index-BDx8jCae.js";import"./index-d5Sb9NkV.js";import"./dialog-tB8qlvri.js";import"./x-aUSh_7pU.js";import"./createLucideIcon-Z6nNrFZk.js";import"./search-DluD_SEp.js";import"./popover-B8Y2kLQ2.js";import"./index-BIXxjs8L.js";import"./floating-ui.react-dom-DGCtlWi3.js";import"./index-DmqIdAoO.js";import"./index-Bnf4O7S7.js";import"./index.es-D4jfZzAn.js";import"./chevron-left-B78jQq2x.js";import"./chevron-right-BAcysohD.js";import"./arrow-right-KoG1RX-P.js";const{expect:a,fn:lt,screen:E,waitFor:wt,within:r}=__STORYBOOK_MODULE_TEST__;function mt({scrRef:s,handleSubmit:o,...n}){const[c,t]=S.useState(s),e=S.useCallback(d=>{t(d),o(d)},[o]);return u.jsx(ht,{children:u.jsxs("div",{className:"tw-p-4",children:[u.jsx(dt,{...n,scrRef:c,handleSubmit:e}),u.jsxs("div",{className:"tw-mt-4 tw-text-sm tw-text-gray-600",children:["Current Reference: ",JSON.stringify(c,void 0,2)]})]})})}const p="combobox",w="combobox",g="option";async function h(){const s=E.getByRole("dialog");return await wt(()=>a(s).toHaveStyle("opacity: 1")),await a(s).toBeVisible(),s}async function m(){const s=E.queryByRole("dialog");s?await wt(()=>a(s).toHaveAttribute("data-state","closed")):a(s).not.toBeInTheDocument()}function i(){return E.getByRole("dialog")}const Zt={title:"Advanced/BookChapterControl",component:dt,tags:["autodocs"],args:{scrRef:l,handleSubmit:lt(s=>console.log("Scripture reference changed:",s))},render:s=>u.jsx(mt,{...s})},f={args:{scrRef:l}},b={args:{scrRef:{book:"PSA",chapterNum:135,verseNum:10}}},k={args:{scrRef:l,getActiveBookIds:()=>["GEN","EXO","MAT","JHN","ROM","REV"]},parameters:{docs:{description:{story:"Shows the component with a limited set of available books."}}}},C={args:{scrRef:l,className:"tw-w-64 tw-bg-blue-50 tw-rounded-xl tw-p-4"},parameters:{docs:{description:{story:"Shows the component with custom styling applied to the trigger button."}}}},R={args:{scrRef:l,getActiveBookIds:()=>[]},parameters:{docs:{description:{story:"Shows the component with an empty list of available books."}}}},B={args:{scrRef:{book:"ROM",chapterNum:8,verseNum:1}},play:async({canvas:s,userEvent:o,step:n,args:c})=>{await n("Open the book chapter control",async()=>{const t=s.getByRole(p);await a(t).toBeInTheDocument(),await o.click(t)}),await n("Select Romans book",async()=>{const t=await h(),e=r(t).getByText("Romans");await a(e).toBeInTheDocument(),await o.click(e)}),await n("Verify chapter grid is displayed for Romans",async()=>{const t=i(),e=r(t).getByRole(g,{name:"8"});await a(e).toBeInTheDocument()}),await n("Verify the correct number of chapters is shown for Romans",async()=>{const t=i(),e=r(t).getAllByRole(g);await a(e.length).toBe(16)}),await n("Select a different chapter",async()=>{const t=i(),e=r(t).getByRole(g,{name:"12"});await o.click(e)}),await n("Verify the different chapter number is selected",async()=>{await m();const t=s.getByRole(p);await a(t).toHaveTextContent("Romans 12:1"),await a(c.handleSubmit).toHaveBeenCalledWith({book:"ROM",chapterNum:12,verseNum:1})})},parameters:{docs:{description:{story:`
...
7. Verifies the selection updates to Romans 12:1 and the dropdown closes
        `}}}},v={args:{scrRef:l},play:async({canvas:s,userEvent:o,step:n,args:c})=>{await n("Open the component and test smart parsing",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n('Test complete reference parsing: "John 3:16"',async()=>{const t=i(),e=r(t).getByRole(w);await o.clear(e),await o.type(e,"John 3:16");const d=await r(t).findByText("JHN 3:16");await a(d).toBeInTheDocument(),await o.click(d),await a(c.handleSubmit).toHaveBeenCalledWith({book:"JHN",chapterNum:3,verseNum:16})}),await n('Test book with chapter parsing: "Romans 8"',async()=>{const t=s.getByRole(p);await o.click(t);const e=i(),d=r(e).getByRole(w);await o.clear(d),await o.type(d,"Roma 8");const y=await r(e).findByText("ROM 8:1");await a(y).toBeInTheDocument(),await o.click(y),await a(c.handleSubmit).toHaveBeenCalledWith({book:"ROM",chapterNum:8,verseNum:1})}),await n('Test book ID parsing: "1CO 13:4"',async()=>{const t=s.getByRole(p);await o.click(t);const e=i(),d=r(e).getByRole(w);await o.clear(d),await o.type(d,"1 co 13:4");const y=await r(e).findByText("1CO 13:4");await a(y).toBeInTheDocument(),await o.click(y),await a(c.handleSubmit).toHaveBeenCalledWith({book:"1CO",chapterNum:13,verseNum:4})})},parameters:{docs:{description:{story:`
...
8. Validates that all selections properly call handleSubmit with the expected SerializedVerseRef objects
        `}}}},T={args:{scrRef:l},play:async({canvas:s,userEvent:o,step:n,args:c})=>{await n("Open the component",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n("Type search query for Psalms",async()=>{const t=i(),e=r(t).getByRole(w);await o.type(e,"Psalms")}),await n("Verify Psalms appears in search results",async()=>{const t=i(),e=await r(t).findByText("Psalms");await a(e).toBeInTheDocument()}),await n("Click Psalms to navigate to chapter view",async()=>{const t=i(),e=r(t).getByText("Psalms");await o.click(e)}),await n("Verify chapter grid shows many chapters for Psalms",async()=>{const t=i(),e=r(t).getAllByRole(g);await a(e.length).toBeGreaterThan(50)}),await n("Select chapter 23",async()=>{const t=i(),e=r(t).getByRole(g,{name:"23"});await o.click(e)}),await n("Verify submission and component closes",async()=>{await a(c.handleSubmit).toHaveBeenCalledWith({book:"PSA",chapterNum:23,verseNum:1}),await m()}),await n("Reopen component for back navigation test",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n("Search for Romans",async()=>{const t=i(),e=r(t).getByRole(w);await o.type(e,"Ro")}),await n("Click Romans to enter chapter view",async()=>{const t=i(),e=await r(t).findByText("Romans");await o.click(e)}),await n("Click back button to return to book search",async()=>{const t=i(),e=await r(t).findByRole("button");await o.click(e)}),await n("Verify back navigation returns to search mode",async()=>{const t=i(),e=r(t).getByRole(w);await a(e).toBeInTheDocument(),await a(e).toHaveFocus()})},parameters:{docs:{description:{story:`
...
12. Verifying focus management during navigation
        `}}}},I={args:{scrRef:l},play:async({canvas:s,userEvent:o,step:n,args:c})=>{await n("Open component for Obadiah test",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n("Verify Obadiah appears in book list",async()=>{const t=i(),e=await r(t).findByText("Obadiah");await a(e).toBeInTheDocument()}),await n("Click Obadiah to select immediately",async()=>{const t=i(),e=r(t).getByText("Obadiah");await o.click(e)}),await n("Verify Obadiah submits immediately without chapter grid",async()=>{await a(c.handleSubmit).toHaveBeenCalledWith({book:"OBA",chapterNum:1,verseNum:1}),await m()}),await n("Open component for Odes test",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n("Search for Odes",async()=>{const t=i(),e=r(t).getByRole(w);await o.clear(e),await o.type(e,"Ode")}),await n("Verify Odes smart parsing result appears",async()=>{const t=i(),e=await r(t).findByText("ODA 1:1");await a(e).toBeInTheDocument()}),await n("Click Odes result to submit",async()=>{const t=i(),e=r(t).getByText("ODA 1:1");await o.click(e)}),await n("Verify Odes submission",async()=>{await a(c.handleSubmit).toHaveBeenCalledWith({book:"ODA",chapterNum:1,verseNum:1}),await m()})},parameters:{docs:{description:{story:`
...
10. Verifying the component closes after keyboard selection
        `}}}},x={args:{scrRef:l},play:async({canvas:s,userEvent:o,step:n,args:c})=>{await n("Open component for filtering test",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n("Type partial search term for John books",async()=>{const t=i(),e=r(t).getByRole(w);await o.type(e,"joh")}),await n("Verify multiple John books appear in results",async()=>{const t=i(),e=r(t).getAllByText(/john/i);await a(e.length).toBe(4)}),await n("Continue typing to select specific John book",async()=>{const t=i(),e=r(t).getByRole(w);await o.type(e,"n")}),await n("Click John book to enter chapter view",async()=>{const t=i(),e=r(t).getByText("John");await a(e).toBeInTheDocument(),await o.click(e)}),await n("Test first Escape key press in chapter view",async()=>{await o.keyboard("{Escape}");const t=i();a(t).toBeVisible()}),await n("Test second Escape key press to close component",async()=>{await o.keyboard("{Escape}"),await m()}),await n("Verify trigger returns to original value",async()=>{const t=s.getByRole(p);await a(t).toHaveTextContent("Genesis 1:1")}),await n("Open component for rapid switching test",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n("Search for first book (Obadiah)",async()=>{const t=i(),e=r(t).getByRole(w);await o.clear(e),await o.type(e,"obad")}),await n("Click Obadiah smart parsing result",async()=>{const t=i(),e=await r(t).findByText("OBA 1:1");await o.click(e)}),await n("Verify first book submission",async()=>{await a(c.handleSubmit).toHaveBeenCalledWith({book:"OBA",chapterNum:1,verseNum:1}),await m()}),await n("Immediately open component for second book",async()=>{const t=s.getByRole(p);await o.click(t),await h()}),await n("Search for second book with specific reference",async()=>{const t=i(),e=r(t).getByRole(w);await o.clear(e),await o.type(e,"Rev 22:21")}),await n("Click Revelation smart parsing result",async()=>{const t=i(),e=await r(t).findByText("REV 22:21");await o.click(e)}),await n("Verify second book submission",async()=>{await a(c.handleSubmit).toHaveBeenCalledWith({book:"REV",chapterNum:22,verseNum:21}),await m()})},parameters:{docs:{description:{story:`
...
}`,...(z=(F=B.parameters)==null?void 0:F.docs)==null?void 0:z.source}}};var X,Y,Q;v.parameters={...v.parameters,docs:{...(X=v.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(Q=(Y=v.parameters)==null?void 0:Y.docs)==null?void 0:Q.source}}};var Z,$,tt;T.parameters={...T.parameters,docs:{...(Z=T.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(tt=($=T.parameters)==null?void 0:$.docs)==null?void 0:tt.source}}};var et,nt,ot;I.parameters={...I.parameters,docs:{...(et=I.parameters)==null?void 0:et.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(ot=(nt=I.parameters)==null?void 0:nt.docs)==null?void 0:ot.source}}};var at,it,rt;O.parameters={...O.parameters,docs:{...(at=O.parameters)==null?void 0:at.docs,source:{originalSource:`{
  args: {
    scrRef: {
      book: 'MAT',
      chapterNum: 15,
...
}`,...(rt=(it=O.parameters)==null?void 0:it.docs)==null?void 0:rt.source}}};var st,ct,pt;x.parameters={...x.parameters,docs:{...(st=x.parameters)==null?void 0:st.docs,source:{originalSource:`{
  args: {
    scrRef: defaultScrRef
  },
  play: async ({
...
}`,...(pt=(ct=x.parameters)==null?void 0:ct.docs)==null?void 0:pt.source}}};const $t=["Default","WithSpecificBook","WithLimitedBooks","WithCustomTrigger","EmptyBookList","ChapterSelectionDemo","SmartParsingDemo","BookSearchAndNavigation","SingleChapterBookDemo","KeyboardNavigation","ComprehensiveInteractionTest"];export{T as BookSearchAndNavigation,B as ChapterSelectionDemo,x as ComprehensiveInteractionTest,f as Default,R as EmptyBookList,O as KeyboardNavigation,I as SingleChapterBookDemo,v as SmartParsingDemo,C as WithCustomTrigger,k as WithLimitedBooks,b as WithSpecificBook,$t as __namedExportsOrder,Zt as default};
