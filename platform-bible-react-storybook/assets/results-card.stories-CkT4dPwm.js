import{j as e}from"./jsx-runtime-B0mj53Uj.js";import{T}from"./theme-provider.component-DjAzKAD4.js";import{r as G}from"./iframe-9Zhl2CkU.js";import{D as q,a as I,b as R,c as l}from"./dropdown-menu-CvZWwXV0.js";import{c as y}from"./shadcn-ui.util-DMJ19wEV.js";import{B}from"./button-SlL39imj.js";import{E as O}from"./ellipsis-CLV2kRR8.js";import{B as g}from"./badge-C8okuFcV.js";import{B as _}from"./book-open-agvdKl9f.js";import{C as A}from"./copy-CkcWm0_V.js";import{E as F}from"./external-link-DNNi4uCq.js";import{S as L}from"./settings-4k3FEQKG.js";import"./preload-helper-CTOgD26E.js";import"./index-Cit3Y4jb.js";import"./index-BPbCuWFR.js";import"./index-DTAXz6r9.js";import"./index-BSPEc8l8.js";import"./index-Dj-VCL0K.js";import"./index-Cn-FdYao.js";import"./index-BxWNdA6r.js";import"./index-zIv3hLbJ.js";import"./index-eZTIp-nj.js";import"./index-BWKubMEI.js";import"./index-D-ktTNAQ.js";import"./index-BUTdLPnK.js";import"./index-BtLdhcm0.js";import"./floating-ui.react-dom-CwX0otsg.js";import"./index-BcL1YFU6.js";import"./index-w3Oj2mU8.js";import"./index-CaWqlVwm.js";import"./index-D5gf-719.js";import"./index-Ch6-ikge.js";import"./index-BLg3_FZ3.js";import"./index-DyBgsuyh.js";import"./index-CGUQXvUO.js";import"./index-CO0yGGT5.js";import"./check-D2EzCwfD.js";import"./createLucideIcon-D4vYydla.js";import"./circle-DN9IQ6fZ.js";import"./chevron-right-C-RcsKXv.js";function h({cardKey:a,isSelected:r,onSelect:n,isDenied:o,isHidden:d=!1,className:t,children:i,dropdownContent:c,additionalSelectedContent:s,accentColor:u}){const K=f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),n())};return e.jsxs("div",{hidden:d,onClick:n,onKeyDown:K,role:"button",tabIndex:0,"aria-pressed":r,className:y("tw-relative tw-min-w-36 tw-rounded-xl tw-border tw-shadow-none hover:tw-bg-muted/50",{"tw-opacity-50 hover:tw-opacity-100":o&&!r},{"tw-bg-accent":r},{"tw-bg-transparent":!r},t),children:[e.jsxs("div",{className:"tw-flex tw-flex-col tw-gap-2 tw-p-4",children:[e.jsxs("div",{className:"tw-flex tw-justify-between tw-overflow-hidden",children:[e.jsx("div",{className:"tw-min-w-0 tw-flex-1",children:i}),r&&c&&e.jsxs(q,{children:[e.jsx(I,{className:y(u&&"tw-me-1"),asChild:!0,children:e.jsx(B,{className:"tw-m-1 tw-h-6 tw-w-6",variant:"ghost",size:"icon",children:e.jsx(O,{})})}),e.jsx(R,{align:"end",children:c})]})]}),r&&s&&e.jsx("div",{className:"tw-w-fit tw-min-w-0 tw-max-w-full tw-overflow-hidden",children:s})]}),u&&e.jsx("div",{className:`tw-absolute tw-right-0 tw-top-0 tw-h-full tw-w-2 tw-rounded-r-xl ${u}`})]},a)}h.__docgenInfo={description:`ResultsCard is a base component for displaying scripture-related results in a card format, even
though it is not based on the Card component. It provides common functionality like selection
state, dropdown menus, and expandable content.`,methods:[],displayName:"ResultsCard",props:{cardKey:{required:!0,tsType:{name:"string"},description:"Unique key for the card"},isSelected:{required:!0,tsType:{name:"boolean"},description:"Whether this card is currently selected/focused"},onSelect:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback function called when the card is clicked"},isDenied:{required:!1,tsType:{name:"boolean"},description:"Whether the content of this card are in a denied state"},isHidden:{required:!1,tsType:{name:"boolean"},description:"Whether the card should be hidden",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes to apply to the card"},children:{required:!0,tsType:{name:"ReactNode"},description:"Main content to display on the card"},dropdownContent:{required:!1,tsType:{name:"ReactNode"},description:"Content to show in the dropdown menu when selected"},additionalSelectedContent:{required:!1,tsType:{name:"ReactNode"},description:"Additional content to show below the main content when selected"},accentColor:{required:!1,tsType:{name:"string"},description:"Color to use for the card's accent border"}}};const{fn:M}=__STORYBOOK_MODULE_TEST__,Ge={title:"Basics/ResultsCard",component:h,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...(E=(j=p.parameters)==null?void 0:j.docs)==null?void 0:E.source}}};const De=["Default","CheckCards","FindCards"];export{w as CheckCards,m as Default,p as FindCards,De as __namedExportsOrder,Ge as default};
