 ...
 * files under `src/` can import it without pulling the webpack-only command-service stub into `tsc`
 * typecheck. That stub reads this same module instance at call time. See
