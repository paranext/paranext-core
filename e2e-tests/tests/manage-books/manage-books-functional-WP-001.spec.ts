...
test.describe('Manage Books Functional Tests (WP-001 — Unified Dialog Wiring)', () => {
  ...
  test.fixme(
    'should open Manage Books unified dialog from the Project menu',
    async ({ mainPage }) => {
  ...
  test.fixme(
    'should expose Manage Books only when a scripture project is the active context (BHV-400/412)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
  ...
  // @scenario TS-049
  test.fixme(
    'should render dialog with action toggle, project header, grid, and apply footer (View default)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      ...
      await expect(frame.getByRole('button', { name: /View/i })).toBeVisible();
      await expect(frame.getByRole('button', { name: /Create/i })).toBeVisible();
      await expect(frame.getByRole('button', { name: /Import/i })).toBeVisible();
      await expect(frame.getByRole('button', { name: /Copy/i })).toBeVisible();
      await expect(frame.getByRole('button', { name: /Delete/i })).toBeVisible();
  ...
  // @scenario TS-049
  test.fixme(
    'should display the present-book check indicator on books that exist in the active project',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
      ...
      const presentChip = frame.getByRole('button', { name: /Existing/i });
  ...
  // @scenario TS-082
  test.fixme(
    'should populate the project-selector header dropdown with real ScrText projects (filterProjects)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should reflect the active editor project in the dialog header at open',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      ...
      await expect(
        mainPage.locator('.dock-tab').filter({ hasNotText: 'Home' }).first(),
  ...
  test.fixme(
    'should switch to Delete mode and reveal Delete-specific apply footer label',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should toggle book selection via grid pill click and update apply-button enablement',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should show a destructive-confirm dialog with Cancel-default before deleting (BHV-310, A2)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should fire onDeleteBooks when destructive-confirm Delete is accepted, then refresh',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  // @scenario TS-072
  test.fixme(
    'should reveal the Create-mode method dropdown when Create action is selected',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should select books in Create mode and enable the Create apply button (EVD-012)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should reveal the model-project picker when "Based on" creation method is chosen (EVD-013)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should render the Copy-mode source-project picker and disable apply until source is chosen',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
      ...
      await frame.getByRole('button', { name: /Copy/i }).first().click();
  ...
  test.fixme(
    'should populate Copy-mode comparison badges once a source project is selected (EVD-032)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
      ...
      const stateFilters = frame.getByRole('button', { name: /^(All|New|Newer|Older|Same)$/i });
  ...
  test.fixme(
    'should toggle "Select all visible" via the grid header checkbox (Copy mode bulk select)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should switch to Import mode and auto-open the file picker on first entry (BHV-318, A8)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
      ...
      const importToggle = frame.getByRole('button', { name: /Import/i }).first();
  ...
  // @scenario TS-058
  test.fixme(
    'should preserve per-action selection when the user toggles between action modes',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  // @scenario TS-051
  test.fixme(
    'VAL-105.1: should disable the chapter/verse method when only non-canonical books are selected (A6)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  // @scenario TS-052
  test.fixme(
    'VAL-100: should keep apply disabled when "Based on" method is chosen but no model project is picked',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should render an empty-state message when no books match the active filter',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  // @scenario TS-049, TS-089
  test.fixme(
    'should close the dialog (web view tab dismissed) when Close is clicked from View mode (EVD-003)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  test.fixme(
    'should disable the apply button while a mutation is in flight and show the spinner (A3)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
  ...
  // @scenario TS-049
  test.fixme(
    'should render the books-present subtitle reflecting the canonical book count (BHV-300)',
    async ({ mainPage }) => {
      await waitForAppReady(mainPage);
      await mainPage
        .getByRole('menuitem', { name: /Project|Tools/i })
