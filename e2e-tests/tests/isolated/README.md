...
- `scripture-editor/` (one Electron per test) — tests for Standard-view editor behaviors: view
  defaults, marker palette, attribute-display settle, type-through save echo, annotation positions
