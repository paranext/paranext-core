...
namespace TestParanextDataProvider
{
    ...
    internal class DummyScrStylesheet : ScrStylesheet
    {
        ...
        /// </summary>
        public DummyScrStylesheet()
            : base("Dummy Style Sheet")
        {
            AddTag(
                "v",
                TextProperties.scVerse | TextProperties.scPublishable,
                ScrTextType.scVerseText,
            ...
            AddTag(
                ...
                TextProperties.scParagraph
                    | TextProperties.scNonpublishable
                    | TextProperties.scNonvernacular
                    | TextProperties.scBook,
                ScrTextType.scOther,
                ScrStyleType.scParagraphStyle,
                ""
            );
            AddTag(
                "ip",
            ...
            AddTag(
                "c",
                TextProperties.scChapter | TextProperties.scPublishable,
                ScrTextType.scOther,
                ScrStyleType.scParagraphStyle,
                "id"
            );
            ...
            AddTag(
                "em",
                TextProperties.scPublishable | TextProperties.scVernacular,
                0 /* no specific text type*/
                ,
                ScrStyleType.scCharacterStyle,
        ...
        private void AddTag(
            ...
            ScrTextType textType,
            ScrStyleType styleType,
            string occursUnder,
            string endMarker = "",
