...
describe('isWarmFilesystemCache', () => {
  ...
  // `shipping-set.js` (or make this function always return `false`) and `shipping-set.test.ts`'s
  ...
  it('is cold when a filesystem cache is configured with no cacheDirectory', () => {
