...
const configuration: webpack.Configuration = {
  resolve: {
    // Must add extensions lib path here so eslint knows about the types provided by extensions
    // Must add our special module config path so eslint knows about it as well
    modules: [webpackPaths.extensionsLibPath, webpackPaths.srcDeclarationsPath],
  },
};
