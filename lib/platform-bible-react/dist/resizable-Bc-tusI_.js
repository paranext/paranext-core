...
import { Section as J, MODIFIER_KEYS as ge, normalizeProjectId as at, getLocalizeKeyForScrollGroupId as be, getSectionForBook as Ne } from "platform-bible-utils";
...
const Se = 600, Ja = 650, Bt = 400, Ee = 450, Te = 500, ze = 550, Ua = 650, Xa = 700, Pt = F(
...
const Ue = ["input", "select", "textarea", "button"], Xe = ["button", "textbox"], Gr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
    ...
    (w) => {
      ...
      if (!!(v && N && v.contains(N) && N !== v) && I(N)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          if (c === -1) return;
          let m;
          w.key === "ArrowDown" ? m = Math.min(c + 1, k.length - 1) : m = Math.max(c - 1, 0), m !== c && (w.preventDefault(), w.stopPropagation(), (U = k[m]) == null || U.focus());
          return;
        }
        return;
      }
...
function jr({ className: t, children: e, ...a }) {
  const r = O();
  return /* @__PURE__ */ n(
    E.SubContent,
    {
...
function Wr({
  ...
  const [q, T] = B(!1), S = it(null), R = H(
    (D) => {
      var M;
      const V = (M = t.find((K) => K.label === D)) == null ? void 0 : M.value;
      V && a(
        e.includes(V) ? e.filter((K) => K !== V) : [...e, V]
      );
    },
    [t, e, a]
  ), U = () => p || r, k = g ?? q, c = I ?? T, [m, h] = B(k), [C, b] = B(e);
  m !== k && (h(k), k && b(e));
  const X = Z(() => {
    if (!w) return t;
    const D = t.filter((M) => M.starred).sort((M, K) => M.label.localeCompare(K.label)), V = t.filter((M) => !M.starred).sort((M, K) => {
      const vt = C.includes(M.value), xt = C.includes(K.value);
      return vt && !xt ? -1 : !vt && xt ? 1 : M.label.localeCompare(K.label);
    });
    return [...D, ...V];
  }, [t, C, w]), ut = () => {
    const D = t.map((V) => V.value);
    b(D), a(D);
  }, Qt = () => {
    b([]), a([]);
  };
        ...
        /* @__PURE__ */ n(Ht, { children: X.map((D) => /* @__PURE__ */ f(
          Ft,
          {
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ n(le, { className: "tw:h-4 tw:w-4" }),
...
function ba({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  ...
  let _;
  e === "project" ? t.openGroups.length > 0 && (_ = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ n(st, { variant: "secondary", children: ot(R) }, R)) })) : t.scrollGroupId !== void 0 && (_ = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ga,
      {
  ...
  return /* @__PURE__ */ f(Ut, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ n(Xt, { asChild: !0, children: q }),
    /* @__PURE__ */ f(
      Wt,
      {
        side: "top",
  ...
  return /* @__PURE__ */ f(Vt, { open: e, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ n(
      Jt,
      {
        ...
        children: /* @__PURE__ */ n(kt, { delayDuration: 400, children: /* @__PURE__ */ f(Mt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            ...
            /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: q, children: `${I.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
...
const ro = (t, e, a) => ka(t, e).every((r) => a.includes(r));
function Ia(t, e) {
  return [
...
function no({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ n(
    "p",
    {
      role: "status",
...
//# sourceMappingURL=resizable-Bc-tusI_.js.map
