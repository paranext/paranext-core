...
import { Slot as Pt, Dialog as Q, Separator as Se, Popover as wt, Tooltip as lt, DropdownMenu as E, Label as ye, RadioGroup as _t } from "radix-ui";
...
import M, { useState as H, useRef as pt, useCallback as J, createContext as Te, useContext as _e, useEffect as Ct, useMemo as at, Fragment as Ce, forwardRef as Qt } from "react";
import { ChevronsUpDown as te, Check as ee, Star as Le, Group as je, ArrowRight as Ae, Loader2 as Ge, ChevronDown as Pe, Search as Re, X as De, AlertTriangle as ze, LoaderCircle as Be } from "lucide-react";
import { Section as ot, MODIFIER_KEYS as Oe, normalizeProjectId as D, compareProjectsByName as Me, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, formatProjectName as ae, getLocalizeKeyForScrollGroupId as He, hasDistinctFullName as Ue, getSectionForBook as $e } from "platform-bible-utils";
...
import { extendTailwindMerge as Fe, twMerge as Ve } from "tailwind-merge";
const Je = Fe({ prefix: "tw" });
function Lt(t) {
  const e = [];
  let a = "", o = 0;
...
function d(...t) {
  ...
  }), Ve(r.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = o.get(u);
    return m ? qe(u, m) : u;
  }).join(" ");
}
const oe = 600, re = 650, Eo = 400, We = 450, Ze = 500, To = 510, _o = 520, Ye = 675, Co = 690, Lo = 700, jo = 800, ne = rt(
...
function Do({
  ...
  return /* @__PURE__ */ p(Qe, { children: [
    /* @__PURE__ */ n(ta, { className: o, style: r }),
    /* @__PURE__ */ p(
      Q.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(Q.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(X, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ke, {}),
...
function Bo({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(Q.Close, { asChild: !0, children: /* @__PURE__ */ n(X, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function ea({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ n(
    "input",
    {
      type: e,
...
function ce({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ p(aa, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        st.Input,
        {
      ...
      /* @__PURE__ */ n(ra, { children: /* @__PURE__ */ n(Ie, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const na = [
  ...
  var e;
  return ((e = na[t]) == null ? void 0 : e.chapters) ?? -1;
}, ia = C.allBookIds.filter(
...
const Wo = Object.fromEntries(
  ia.map((t) => [t, C.bookIdToEnglishName(t)])
);
function Zo(t, e, a) {
  const o = e.trim().toLowerCase();
  if (!o) return !1;
  const r = C.bookIdToEnglishName(t), s = a == null ? void 0 : a.get(t);
...
function mt(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && ua(o)
  );
}
const Yo = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
...
const or = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function wa({
  className: t,
...
const { PortalContainerProvider: ma, usePortalContainer: fa } = me(), ir = ma;
function he({
  className: t,
  align: e = "center",
  sideOffset: a = 4,
...
const { PortalContainerProvider: ha, usePortalContainer: ga } = me(), wr = ha;
function Ht({
  className: t,
  sideOffset: e = 0,
...
const ba = /^%[^%]*%$/;
function ge(t) {
  return t !== void 0 && !ba.test(t) && t.trim() !== "";
}
function T(t, e) {
  return ge(t) ? t : e;
}
...
function va({ variant: t = "default", ...e }) {
  const a = q(), o = M.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ n(be.Provider, { value: o, children: /* @__PURE__ */ n(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function pr({
  ...t
}) {
...
function ka({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ n(
    E.Label,
    {
...
const Ea = ["input", "select", "textarea", "button"], Ta = ["button", "textbox"], Er = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
  ...
  const r = pt(null), [s, i] = H(void 0), [l, u] = H(void 0), m = J(
    ...
    if (w.isContentEditable || Ea.includes(g)) return !0;
    const N = w.getAttribute("role");
    if (N && Ta.includes(N)) return !0;
    ...
    (w) => {
      ...
      if (!!(h && g && h.contains(g) && g !== h) && y(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          if (U === -1) return;
          let W;
          w.key === "ArrowDown" ? W = Math.min(U + 1, x.length - 1) : W = Math.max(U - 1, 0), W !== U && (w.preventDefault(), w.stopPropagation(), (P = x[W]) == null || P.focus());
          return;
        }
        return;
      }
      ...
      switch (w.key) {
        case "ArrowDown":
          L = Math.min(tt + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          L = Math.max(tt - 1, 0), w.preventDefault();
          break;
        case "Home":
...
function Dr({
  ...
  const [F, tt] = H(!1), L = pt(null), et = J(
    (k) => {
      var B;
      const Y = (B = t.find((V) => V.label === k)) == null ? void 0 : B.value;
      Y && a(
        e.includes(Y) ? e.filter((V) => V !== Y) : [...e, Y]
      );
    },
    [t, e, a]
  ), P = () => m || o, x = f ?? F, U = y ?? tt, [W, Z] = H(x), [it, z] = H(e);
  W !== x && (Z(x), x && z(e));
  const ht = at(() => {
    if (!w) return t;
    const k = t.filter((B) => B.starred).sort((B, V) => B.label.localeCompare(V.label)), Y = t.filter((B) => !B.starred).sort((B, V) => {
      const bt = it.includes(B.value), Nt = it.includes(V.value);
      return bt && !Nt ? -1 : !bt && Nt ? 1 : B.label.localeCompare(V.label);
    });
    return [...k, ...Y];
  }, [t, it, w]), gt = () => {
  ...
  return /* @__PURE__ */ n("div", { id: K, className: h, children: /* @__PURE__ */ p(fe, { open: x, onOpenChange: U, children: [
    ...
    /* @__PURE__ */ n(he, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(le, { children: [
      ...
      /* @__PURE__ */ n(Ga, { isEnabled: g, scrollerRef: L, children: /* @__PURE__ */ p(de, { ref: L, children: [
...
function zr(t, e, a) {
  ...
  if (Ra(t) || Oe.has(t.key) || t.key === "Dead")
    return "passed";
...
function Ka(t) {
  ...
  return [
    ve(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[dt.lastUsedAt]) == "number" ? vt : $a;
      },
...
function ft(t) {
  return ca[He(t)] ?? String(t);
}
const Yt = "platform.footerAction", Xa = {
...
function Wa({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: y
  } = Na(), [I, w] = H(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, N = m || I, h = J(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), y();
  }, [y]), K = /* @__PURE__ */ n(ee, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let F;
  e === "project" ? t.openGroups.length > 0 && (F = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((P) => /* @__PURE__ */ n(St, { variant: "secondary", children: ft(P) }, P)) })) : t.scrollGroupId !== void 0 && (F = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      qa,
      {
        ...
        /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              ...
              Ue(t) && /* @__PURE__ */ n("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        F
  ...
  ), L = t.scrollGroupId !== void 0 ? ft(t.scrollGroupId) : void 0, et = t.isBoundButClosed && L ? a.boundButClosedTooltip.replace("{group}", L) : void 0;
...
function Za({
  ...
  const r = e !== ct;
  return /* @__PURE__ */ p(va, { children: [
    /* @__PURE__ */ p(Ot, { children: [
      /* @__PURE__ */ n(Mt, { asChild: !0, children: /* @__PURE__ */ n(xa, { asChild: !0, children: /* @__PURE__ */ n(
        X,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      Sa,
      {
        ...
        style: { zIndex: re },
        children: [
          /* @__PURE__ */ n(ka, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(ya, { value: e, onValueChange: a, children: [
...
function Jr(t) {
  const [e, a] = H(!1), [o, r] = H(""), s = at(() => Ja(t.localizedStrings), [t.localizedStrings]), i = at(() => {
    ...
    () => Ya(i, t.defaultGrouping),
    [i, t.defaultGrouping]
  ), f = l ?? m, y = pt(null), [I, w] = H(void 0), g = J((c) => {
    a(c), c || (r(""), w(void 0));
  }, []);
  Ct(() => {
    if (!e) return;
  ...
  const N = at(() => t.mode === "project" ? Tt({
    ...
    (c) => c === void 0 ? void 0 : $.get(D(c)),
    [$]
  ), { renderProjectIndicator: F } = t, tt = J(
    (c) => F ? F(c.project) : void 0,
    [F]
  ), L = !!F, et = !!t.footerAction && h.length === 0, P = at(() => {
    if (f === ct) return Gt(h);
    const c = i.find((b) => b.id === f);
    return c ? Ua(h, c) : Gt(h);
  }, [h, f, i]), x = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, j = D(c.projectId), O = (G) => D(G.projectId) === j && G.scrollGroupId === c.scrollGroupId, A = b.some(O) ? b.filter((G) => !O(G)) : [
          ...b.filter((G) => !O(G)),
  ...
  }, Z = t.mode === "project" ? t.renderTriggerLabel : void 0, it = t.mode === "project" ? t.triggerLabelFormat : void 0, z = at(() => {
    switch (t.mode) {
      case "project": {
        ...
        return c && it === "shortNameAndFullName" && (b = ae(c)), { node: b, title: b, hasSelection: !!c };
      }
      case "project-multi": {
  ...
  Ct(() => {
    ...
    return j.observe(c, { box: "border-box" }), () => j.disconnect();
  }, []);
  let k;
  t.isLoading ? k = /* @__PURE__ */ n(Ge, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : gt ? k = void 0 : t.mode === "project-multi" ? k = /* @__PURE__ */ n(te, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : k = /* @__PURE__ */ n(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const Y = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? x : void 0, B = s.ariaLabel && z.hasSelection && z.title ? `${s.ariaLabel}: ${z.accessibleTitle ?? z.title}` : s.ariaLabel || void 0, V = /* @__PURE__ */ p(
    X,
    {
      ref: ht,
    ...
    /* @__PURE__ */ n(Mt, { asChild: !0, children: /* @__PURE__ */ n(At, { asChild: !0, children: V }) }),
    /* @__PURE__ */ n(Ht, { dir: "auto", children: z.title })
  ] }) }) : /* @__PURE__ */ n(At, { asChild: !0, children: V }), Nt = i.length > 1;
        ...
        children: /* @__PURE__ */ n(Xt, { delayDuration: 400, children: /* @__PURE__ */ p(
          le,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(X, { variant: "ghost", size: "sm", onClick: W, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(de, { children: [
                ...
                P.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(we, { heading: Qa(c, s), children: c.rows.map((j) => /* @__PURE__ */ n(
                          Wa,
                          {
                            row: j,
                            mode: t.mode,
                        ...
                        b < P.length - 1 && /* @__PURE__ */ n(Ft, { alwaysRender: !0 })
                      ]
                    },
...
const qr = (t, e, a) => ao(t, e).every((o) => a.includes(o));
function oo(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => C.bookIdToNumber(o) > 0).sort((o, r) => C.bookIdToNumber(o) - C.bookIdToNumber(r)).map((o) => da(o, e));
}
function Wr(t, e, a, o) {
  ...
  const i = oo(t, o);
  if (i.length !== 0)
    return i.length <= eo ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
...
function Qr({
  ...
  return /* @__PURE__ */ p(ro, { className: d(s), role: r, children: [
    /* @__PURE__ */ p(no, { children: [
      /* @__PURE__ */ n(io, { variant: "icon", children: o ?? /* @__PURE__ */ n(ze, {}) }),
      /* @__PURE__ */ n(lo, { children: t })
    ] }),
    a && /* @__PURE__ */ n(co, { children: /* @__PURE__ */ n(X, { onClick: () => a(), children: e }) })
  ] });
}
const uo = Qt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Be, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-C_A_0ssf.js.map
