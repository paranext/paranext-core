import { jsx as r, jsxs as p, Fragment as xe } from "react/jsx-runtime";
import { Slot as Tt, Dialog as Z, Separator as ye, Popover as ut, Tooltip as rt, DropdownMenu as E, Label as Se, RadioGroup as yt, ToggleGroup as Xt } from "radix-ui";
import { IconX as ke, IconCheck as _t, IconSearch as Ie, IconChevronLeft as Ee, IconChevronRight as Te } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as tt } from "class-variance-authority";
import C, { useState as q, useRef as ht, useCallback as J, createContext as _e, useContext as Ce, useMemo as Q, useEffect as Bt, Fragment as Le, forwardRef as qt } from "react";
import { ChevronsUpDown as Zt, Check as Wt, Star as Ge, Group as je, ArrowRight as Ae, Loader2 as ze, ChevronDown as Re, Search as De, X as Pe, AlertTriangle as Be, LoaderCircle as Oe } from "lucide-react";
import { Section as et, MODIFIER_KEYS as Me, normalizeProjectId as M, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, getLocalizeKeyForScrollGroupId as He, getSectionForBook as Ue } from "platform-bible-utils";
...
import { extendTailwindMerge as Ke, twMerge as Fe } from "tailwind-merge";
const Ve = Ke({ prefix: "tw" });
function St(t) {
  const e = [];
  let a = "", o = 0;
...
function d(...t) {
  ...
  }), Fe(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = o.get(u);
    return m ? Xe(u, m) : u;
  }).join(" ");
}
const Yt = 600, Qt = 650, vo = 400, qe = 450, Ze = 500, xo = 510, yo = 520, We = 675, So = 690, ko = 700, Io = 800, te = tt(
...
function To({ ...t }) {
  return /* @__PURE__ */ r(Z.Root, { "data-slot": "dialog", ...t });
}
function _o({ ...t }) {
  return /* @__PURE__ */ r(Z.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function Ye({ ...t }) {
  return /* @__PURE__ */ r(Z.Portal, { "data-slot": "dialog-portal", ...t });
}
function Co({ ...t }) {
  return /* @__PURE__ */ r(Z.Close, { "data-slot": "dialog-close", ...t });
}
function Qe({
  className: t,
...
function Lo({
  ...
  return /* @__PURE__ */ p(Ye, { children: [
    /* @__PURE__ */ r(Qe, { className: o, style: n }),
    /* @__PURE__ */ p(
      Z.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ r(Z.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(X, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ r(ke, {}),
...
function jo({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ r(Z.Close, { asChild: !0, children: /* @__PURE__ */ r(X, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function ta({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ r(
    "input",
    {
      type: e,
...
function re({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(ea, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ r(
        ot.Input,
        {
      ...
      /* @__PURE__ */ r(oa, { children: /* @__PURE__ */ r(Ie, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Ko = Object.fromEntries(
  sa.map((t) => [t, L.bookIdToEnglishName(t)])
);
function Fo(t, e, a) {
...
const Vo = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
...
const Wo = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function ua({
  className: t,
...
const pa = /^%[^%]*%$/;
function we(t) {
  return t !== void 0 && !pa.test(t) && t.trim() !== "";
}
function T(t, e) {
  return we(t) ? t : e;
}
function ma() {
  const [t, e] = q(!1), a = ht(null), o = J(() => {
    const s = a.current;
...
function fa({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(pe.Provider, { value: o, children: /* @__PURE__ */ r(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function sr({
  ...t
}) {
...
function Na({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ r(
    E.Label,
    {
...
function wr({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        s === "rtl" ? /* @__PURE__ */ r(Ee, { className: "tw:ms-auto" }) : /* @__PURE__ */ r(Te, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const ya = ["input", "select", "textarea", "button"], Sa = ["button", "textbox"], xr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
}) => {
  const n = ht(null), [s, i] = q(void 0), [l, u] = q(void 0), m = J(
    (w) => {
      i(w);
    ...
    if (w.isContentEditable || ya.includes(g)) return !0;
    const v = w.getAttribute("role");
    if (v && Sa.includes(v)) return !0;
    const h = w.getAttribute("tabindex");
    return h !== void 0 && h !== "-1";
  }, I = J(
    (w) => {
      var R;
      const g = w.target, v = (y) => y ? document.getElementById(y) : void 0, h = v(l), $ = v(s);
  ...
  const l = C.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), Ta(w, g, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), Ea(l, v, f.key);
...
function Gr({
  ...
  return /* @__PURE__ */ r("div", { id: h, className: g, children: /* @__PURE__ */ p(de, { open: y, onOpenChange: f ?? K, children: [
    /* @__PURE__ */ r(It, { asChild: !0, children: /* @__PURE__ */ p(
      X,
      {
        variant: v,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ r(Zt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(ue, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(oe, { children: [
      /* @__PURE__ */ r(
        re,
        {
      ...
      /* @__PURE__ */ p(ne, { children: [
        /* @__PURE__ */ r(se, { children: l }),
        /* @__PURE__ */ r(ie, { children: z.map((S) => /* @__PURE__ */ p(
          Lt,
          {
            value: S.label,
            onSelect: F,
...
function jr(t, e, a) {
  ...
  if (Ca(t) || Me.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (O(t), a.dismiss(), "ended") : (O(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (O(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (O(t), a.dismiss(), "ended") : t.key === "Backspace" || fe[o].test(t.key) ? (O(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && O(t), a.dismiss(), "ended");
}
function Ar(t, e) {
  var a;
...
function Da(t, e) {
  if (e.id === "openTabs") return za(t);
  if (e.id === "selection") return Ra(t, e);
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const m = [...u].sort(
      (I, w) => {
        var g;
        return ((g = e.compareProjects) == null ? void 0 : g.call(e, I.project, w.project)) || at(I, w);
      }
...
function Ba(t) {
  ...
  return [
    he(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[dt.lastUsedAt]) == "number" ? mt : Pa;
      },
...
function pt(t) {
  return la[He(t)] ?? String(t);
}
const Jt = "platform.footerAction", Ua = {
...
function Ka({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = ma(), [I, w] = q(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || I, h = J(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), k();
  }, [k]), K = /* @__PURE__ */ r(Wt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let F;
  e === "project" ? t.openGroups.length > 0 && (F = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ r(gt, { variant: "secondary", children: pt(R) }, R)) })) : t.scrollGroupId !== void 0 && (F = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ r(
      $a,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      X,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ae, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  return /* @__PURE__ */ p(jt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ r(At, { asChild: !0, children: W }),
    /* @__PURE__ */ p(
      zt,
      {
        side: "top",
...
function Fa({
  ...
  return /* @__PURE__ */ p(fa, { children: [
    /* @__PURE__ */ p(jt, { children: [
      /* @__PURE__ */ r(At, { asChild: !0, children: /* @__PURE__ */ r(ha, { asChild: !0, children: /* @__PURE__ */ r(
        X,
        {
          variant: "ghost",
          size: "sm",
      ...
      /* @__PURE__ */ r(zt, { children: o.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ p(
      ga,
      {
        ...
        style: { zIndex: Qt },
        children: [
          /* @__PURE__ */ r(Na, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(ba, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ r(Kt, { value: nt, children: o.groupByNone }),
            /* @__PURE__ */ r(va, {}),
...
function Ur(t) {
  const [e, a] = q(!1), [o, n] = q(""), s = Q(() => Ha(t.localizedStrings), [t.localizedStrings]), i = Q(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(he(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      Oa({
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, k = ht(null), [I, w] = q(void 0), g = J((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  Bt(() => {
    if (!e) return;
  ...
  const v = Q(() => t.mode === "project" ? xt({
    ...
    [F]
  ), z = !!F, Y = !!t.footerAction && h.length === 0, R = Q(() => {
    if (f === nt) return Et(h);
    const c = i.find((b) => b.id === f);
    return c ? Da(h, c) : Et(h);
  }, [h, f, i]), y = (c) => {
  ...
  let lt;
  t.isLoading ? lt = /* @__PURE__ */ r(ze, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : it ? lt = void 0 : t.mode === "project-multi" ? lt = /* @__PURE__ */ r(Zt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : lt = /* @__PURE__ */ r(Re, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  ...
  ), Ne = P.title ? /* @__PURE__ */ r($t, { delayDuration: 400, children: /* @__PURE__ */ p(jt, { children: [
    /* @__PURE__ */ r(At, { asChild: !0, children: /* @__PURE__ */ r(It, { asChild: !0, children: Pt }) }),
    /* @__PURE__ */ r(zt, { children: P.title })
  ] }) }) : /* @__PURE__ */ r(It, { asChild: !0, children: Pt }), ve = i.length > 1;
  return /* @__PURE__ */ p(de, { open: e, onOpenChange: g, children: [
    Ne,
    /* @__PURE__ */ r(
      ue,
      {
        ...
        children: /* @__PURE__ */ r($t, { delayDuration: 400, children: /* @__PURE__ */ p(
          oe,
          {
            shouldFilter: !1,
            value: Y ? I ?? Jt : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ p(ne, { children: [
                /* @__PURE__ */ r(se, { children: s.commandEmptyMessage }),
                R.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ r(ie, { heading: Ja(c, s), children: c.rows.map((B) => /* @__PURE__ */ r(
                          Ka,
                          {
                            row: B,
                            mode: t.mode,
                        ...
                        b < R.length - 1 && /* @__PURE__ */ r(Mt, { alwaysRender: !0 })
                      ]
                    },
...
const Kr = (t, e, a) => Za(t, e).every((o) => a.includes(o));
function Wa(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => L.bookIdToNumber(o) > 0).sort((o, n) => L.bookIdToNumber(o) - L.bookIdToNumber(n)).map((o) => da(o, e));
}
function Fr(t, e, a, o) {
  ...
  const i = Wa(t, o);
  if (i.length !== 0)
    return i.length <= qa ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
...
function Xr({
  ...
  return /* @__PURE__ */ p(Ya, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(Qa, { children: [
      /* @__PURE__ */ r(eo, { variant: "icon", children: o ?? /* @__PURE__ */ r(Be, {}) }),
      /* @__PURE__ */ r(ao, { children: t })
    ] }),
    a && /* @__PURE__ */ r(oo, { children: /* @__PURE__ */ r(X, { onClick: () => a(), children: e }) })
  ] });
}
const ro = qt(({ className: t, ...e }, a) => /* @__PURE__ */ r(Oe, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-hujhStja.js.map
