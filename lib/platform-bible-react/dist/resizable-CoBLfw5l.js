import { jsx as r, jsxs as p, Fragment as _e } from "react/jsx-runtime";
import { Slot as Tt, Dialog as q, Separator as Ce, Popover as ut, Tooltip as rt, DropdownMenu as T, Label as Le, RadioGroup as St, ToggleGroup as qt } from "radix-ui";
import { IconX as Ae, IconCheck as _t, IconSearch as ze, IconChevronRight as Ge } from "@tabler/icons-react";
import { Canon as A } from "@sillsdev/scripture";
import { cva as tt } from "class-variance-authority";
import L, { createContext as Wt, useContext as Yt, useState as Z, useRef as ht, useCallback as J, useMemo as Q, useEffect as Mt, Fragment as je, forwardRef as Qt } from "react";
import { ChevronsUpDown as te, Check as ee, Star as Re, Group as Oe, ArrowRight as Pe, Loader2 as De, ChevronDown as Be, Search as Me, X as He, AlertTriangle as Ue, LoaderCircle as $e } from "lucide-react";
import { Section as et, MODIFIER_KEYS as Fe, normalizeProjectId as M, compareProjectsByName as Ke, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as ct, formatProjectName as ae, getLocalizeKeyForScrollGroupId as Ve, hasDistinctFullName as Je, getSectionForBook as Xe } from "platform-bible-utils";
...
import { extendTailwindMerge as qe, twMerge as We } from "tailwind-merge";
const Ye = qe({ prefix: "tw" });
function yt(t) {
  const e = [];
  let a = "", o = 0;
...
function c(...t) {
  ...
  }), We(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = o.get(u);
    return m ? ta(u, m) : u;
  }).join(" ");
}
const oe = 600, re = 650, Ao = 400, ea = 450, aa = 500, zo = 510, Go = 520, oa = 675, jo = 690, Ro = 700, Oo = 800, ne = tt(
...
function Ho({
  ...
  return /* @__PURE__ */ p(ra, { children: [
    /* @__PURE__ */ r(na, { className: o, style: n }),
    /* @__PURE__ */ p(
      q.Content,
      {
...
function ce({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(ia, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ r(
        ot.Input,
        {
      ...
      /* @__PURE__ */ r(ca, { children: /* @__PURE__ */ r(ze, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const er = Object.fromEntries(
  wa.map((t) => [t, A.bookIdToEnglishName(t)])
);
function ar(t, e, a) {
...
const or = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
...
const wr = "data-platform-content-zoom-root", pr = "data-platform-content-zoom-popup", va = "--platform-content-zoom-", Na = "--platform-content-zoom-default", xa = "main", Sa = "--platform-content-zoom-popup-factor", me = Wt(void 0);
function mr({ area: t, children: e }) {
  return /* @__PURE__ */ r(me.Provider, { value: t ?? "", children: e });
}
function zt() {
  return Yt(me);
}
...
const he = L.createContext(null);
function fr({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ r(he.Provider, { value: t, children: e });
}
function ge({
  className: t,
  align: e = "center",
  ...
  const s = U(), i = L.useContext(he), l = zt();
  return (
...
function ka({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(ve.Provider, { value: o, children: /* @__PURE__ */ r(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Nr({
  ...t
}) {
...
function Er({
  ...
  return /* @__PURE__ */ p(
    T.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ r(Ge, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const Ga = ["input", "select", "textarea", "button"], ja = ["button", "textbox"], Rr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
  ...
  const n = ht(null), [s, i] = Z(void 0), [l, u] = Z(void 0), m = J(
    ...
    (w) => {
      ...
      switch (w.key) {
        case "ArrowDown":
          O = Math.min(W + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          O = Math.max(W - 1, 0), w.preventDefault();
          break;
        case "Home":
...
function Kr({
  ...
  return /* @__PURE__ */ r("div", { id: h, className: g, children: /* @__PURE__ */ p(fe, { open: S, onOpenChange: f ?? F, children: [
    ...
    /* @__PURE__ */ r(ge, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(le, { children: [
      /* @__PURE__ */ r(
        ce,
        {
      ...
      /* @__PURE__ */ p(de, { children: [
        ...
        /* @__PURE__ */ r(we, { children: O.map((y) => /* @__PURE__ */ p(
          Lt,
          {
            value: y.label,
            onSelect: K,
...
function Vr(t, e, a) {
  ...
  if (Ma(t) || Fe.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (B(t), a.dismiss(), "ended") : (B(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (B(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (B(t), a.dismiss(), "ended") : t.key === "Backspace" || xe[o].test(t.key) ? (B(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && B(t), a.dismiss(), "ended");
}
function Jr(t, e) {
  var a;
...
function Za(t) {
  ...
  return [
    Se(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[ct.lastUsedAt]) == "number" ? mt : Xa;
      },
...
function to({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = pt(t);
  return e ? /* @__PURE__ */ r(
    gt,
    {
...
function eo({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: I
  } = Ia(), [k, w] = Z(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, N = m || k, h = J(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), I();
  }, [I]), F = /* @__PURE__ */ r(ee, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let K;
  e === "project" ? t.openGroups.length > 0 && (K = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((P) => /* @__PURE__ */ r(gt, { variant: "secondary", children: pt(P) }, P)) })) : t.scrollGroupId !== void 0 && (K = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      X,
      {
        ...
        children: [
          /* @__PURE__ */ r(Pe, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
        ...
        /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              ...
              Je(t) && /* @__PURE__ */ r("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        K
  ...
  ), O = t.scrollGroupId !== void 0 ? pt(t.scrollGroupId) : void 0, Y = t.isBoundButClosed && O ? a.boundButClosedTooltip.replace("{group}", O) : void 0;
  return /* @__PURE__ */ p(jt, { open: N, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ p(
      Ot,
      {
        ...
        children: [
          /* @__PURE__ */ r("div", { className: "tw:font-semibold", dir: "auto", children: ae(t) }),
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && O && /* @__PURE__ */ p("div", { className: "tw:text-sm", children: [
...
function ao({
  ...
  return /* @__PURE__ */ p(ka, { children: [
    /* @__PURE__ */ p(jt, { children: [
      /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(Ea, { asChild: !0, children: /* @__PURE__ */ r(
        X,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      _a,
      {
        ...
        style: { zIndex: re },
        children: [
          /* @__PURE__ */ r(La, { children: o.groupSectionLabel }),
...
function an(t) {
  const [e, a] = Z(!1), [o, n] = Z(""), s = Q(() => Ya(t.localizedStrings), [t.localizedStrings]), i = Q(() => {
  ...
  const N = Q(() => t.mode === "project" ? xt({
    ...
    [K]
  ), O = !!K, Y = !!t.footerAction && h.length === 0, P = Q(() => {
    if (f === nt) return Et(h);
    const d = i.find((b) => b.id === f);
    return d ? Ja(h, d) : Et(h);
  }, [h, f, i]), S = (d) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, G = M(d.projectId), H = (R) => M(R.projectId) === G && R.scrollGroupId === d.scrollGroupId, j = b.some(H) ? b.filter((R) => !H(R)) : [
          ...b.filter((R) => !H(R)),
    ...
    switch (t.mode) {
      case "project": {
        ...
        return d && D === "shortNameAndFullName" && (b = ae(d)), { node: b, title: b, hasSelection: !!d };
      }
      case "project-multi": {
        ...
        const b = [];
        if (d.forEach((j) => {
          const R = F(j.projectId);
          R && b.push({ project: R, scrollGroupId: j.scrollGroupId });
        }), b.length === 0) {
          const j = s.buttonPlaceholder;
          return { node: j, title: j, hasSelection: !1 };
        }
        const G = b.map(
          ({ project: j, scrollGroupId: R }) => R === void 0 ? j.shortName : `${j.shortName} (${pt(R)})`
  ...
  Mt(() => {
    ...
    const G = new ResizeObserver((H) => {
      H.forEach((j) => {
        const [R] = j.borderBoxSize;
        b(R ? R.inlineSize : d.getBoundingClientRect().width);
      });
    });
    return G.observe(d, { box: "border-box" }), () => G.disconnect();
  }, []);
  let lt;
  t.isLoading ? lt = /* @__PURE__ */ r(De, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : it ? lt = void 0 : t.mode === "project-multi" ? lt = /* @__PURE__ */ r(te, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : lt = /* @__PURE__ */ r(Be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const Ie = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? S : void 0, ke = s.ariaLabel && E.hasSelection && E.title ? `${s.ariaLabel}: ${E.accessibleTitle ?? E.title}` : s.ariaLabel || void 0, Bt = /* @__PURE__ */ p(
    X,
    {
      ref: st,
  ...
  ), Ee = E.title ? /* @__PURE__ */ r(Kt, { delayDuration: 400, children: /* @__PURE__ */ p(jt, { children: [
    /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(kt, { asChild: !0, children: Bt }) }),
    /* @__PURE__ */ r(Ot, { dir: "auto", children: E.title })
  ] }) }) : /* @__PURE__ */ r(kt, { asChild: !0, children: Bt }), Te = i.length > 1;
        ...
        children: /* @__PURE__ */ r(Kt, { delayDuration: 400, children: /* @__PURE__ */ p(
          le,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ p(de, { children: [
                /* @__PURE__ */ r(ue, { children: s.commandEmptyMessage }),
                P.map((d, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ r(we, { heading: ro(d, s), children: d.rows.map((G) => /* @__PURE__ */ r(
                          eo,
                          {
                            row: G,
                            mode: t.mode,
...
const rn = (t, e, a) => io(t, e).every((o) => a.includes(o));
function lo(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => A.bookIdToNumber(o) > 0).sort((o, n) => A.bookIdToNumber(o) - A.bookIdToNumber(n)).map((o) => fa(o, e));
}
function nn(t, e, a, o) {
  ...
  const i = lo(t, o);
  if (i.length !== 0)
    return i.length <= so ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
function sn({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ r(
    "p",
    {
      role: "status",
...
function cn({
  ...
  return /* @__PURE__ */ p(co, { className: c(s), role: n, children: [
    /* @__PURE__ */ p(uo, { children: [
      /* @__PURE__ */ r(po, { variant: "icon", children: o ?? /* @__PURE__ */ r(Ue, {}) }),
      /* @__PURE__ */ r(mo, { children: t })
    ] }),
    a && /* @__PURE__ */ r(fo, { children: /* @__PURE__ */ r(X, { onClick: () => a(), children: e }) })
  ] });
}
const ho = Qt(({ className: t, ...e }, a) => /* @__PURE__ */ r($e, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CoBLfw5l.js.map
