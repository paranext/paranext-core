...
import { Slot as zt, Dialog as Q, Separator as Te, Popover as wt, Tooltip as lt, DropdownMenu as E, Label as _e, RadioGroup as _t, ToggleGroup as te } from "radix-ui";
import { IconX as Ce, IconCheck as Rt, IconSearch as Le, IconChevronRight as Ge } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as ot } from "class-variance-authority";
import C, { useState as H, useRef as pt, useCallback as X, createContext as Ae, useContext as je, useEffect as Ct, useMemo as at, Fragment as ee, forwardRef as ae } from "react";
import { ChevronsUpDown as oe, Check as re, Star as ze, Group as Re, ArrowRight as De, Loader2 as Pe, ChevronDown as Be, Search as Oe, X as Me, AlertTriangle as He, LoaderCircle as Ue } from "lucide-react";
import { Section as rt, MODIFIER_KEYS as $e, split as ne, slice as Ke, normalizeProjectId as P, compareProjectsByName as Fe, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, formatProjectName as se, getLocalizeKeyForScrollGroupId as Ve, hasDistinctFullName as Je, getSectionForBook as Xe } from "platform-bible-utils";
...
import { extendTailwindMerge as We, twMerge as Ze } from "tailwind-merge";
...
function c(...t) {
  ...
  }), Ze(r.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = o.get(u);
    return m ? ta(u, m) : u;
  }).join(" ");
}
const ie = 600, le = 650, jo = 400, ea = 450, aa = 500, zo = 510, Ro = 520, oa = 675, Do = 690, Po = 700, Bo = 800, ce = ot(
...
function pe({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ p(ia, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(ca, { children: /* @__PURE__ */ n(Le, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const _a = ["input", "select", "textarea", "button"], Ca = ["button", "textbox"], zr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
  ...
  const r = pt(null), [s, i] = H(void 0), [l, u] = H(void 0), m = X(
    ...
    if (w.isContentEditable || _a.includes(g)) return !0;
    const N = w.getAttribute("role");
    if (N && Ca.includes(N)) return !0;
...
function yt({ className: t, variant: e = "default", asChild: a = !1, ...o }) {
...
function Kr({
  ...
  const [V, tt] = H(!1), G = pt(null), et = X(
    ...
    [t, e, a]
  ), R = () => m || o, x = f ?? V, U = S ?? tt, [W, Z] = H(x), [it, B] = H(e);
  W !== x && (Z(x), x && B(e));
  const ht = at(() => {
    if (!w) return t;
  ...
  return /* @__PURE__ */ n("div", { id: F, className: h, children: /* @__PURE__ */ p(be, { open: x, onOpenChange: U, children: [
    /* @__PURE__ */ n(At, { asChild: !0, children: /* @__PURE__ */ p(
      q,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ n(oe, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ n(ve, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(we, { children: [
      /* @__PURE__ */ n(
        pe,
        {
          placeholder: r ?? o,
      ...
      /* @__PURE__ */ n(Ra, { isEnabled: g, scrollerRef: G, children: /* @__PURE__ */ p(me, { ref: G, children: [
        /* @__PURE__ */ n(fe, { children: u }),
        /* @__PURE__ */ n(he, { children: ht.map((k) => /* @__PURE__ */ p(
          Pt,
          {
            value: k.label,
            onSelect: et,
            ...
            children: [
              ...
              k.starred && /* @__PURE__ */ n(ze, { className: "tw:h-4 tw:w-4" }),
...
function Fr(t, e, a) {
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || ke[o].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && D(t), a.dismiss(), "ended");
}
function Vr(t, e) {
  var a;
...
function $a(t) {
  const e = ne(t, "");
  let a = 0;
  for (; a < e.length && Ua.has(e[a]); )
    a += 1;
  if (a === 0) return;
  const o = e.slice(0, a), r = Ke(t, a);
  return r ? [...o, r] : o;
}
function Ka(t) {
  const e = [];
...
function Fa(t) {
  const e = $a(t);
  return e ? { keycaps: e, separator: "" } : { keycaps: Ka(t), separator: "+" };
}
function Xr({ hint: t }) {
  const { keycaps: e, separator: a } = Fa(t);
  return e.length === 1 ? /* @__PURE__ */ n(Wt, { children: e[0] }) : /* @__PURE__ */ n(Ha, { dir: "ltr", children: e.map((o, r) => (
    ...
    /* @__PURE__ */ p(ee, { children: [
      r > 0 && a && /* @__PURE__ */ n("span", { children: a }),
      /* @__PURE__ */ n(Wt, { children: o })
    ] }, r)
  )) });
}
function Va(t) {
  ...
  return t.projects.forEach((r) => {
    ...
    s.forEach((i) => {
      o.push({
        ...
        openGroups: [],
        isSelected: Zt(a, r.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: r.isDisabled === !0,
        disabledReason: r.disabledReason,
...
function Ja(t) {
  const e = t.filter(Yt).sort(nt), a = t.filter((r) => !Yt(r)).sort(nt);
  if (e.length === 0)
...
function y(t, e) {
  const a = t[e];
  if (!(typeof a != "string" || !xe(a)))
    return a;
}
const vt = "recent", Wa = "other";
function Ie(t) {
  return {
    id: "openTabs",
    label: t ?? "Open tabs"
...
function Za(t) {
  ...
  return [
    Ie(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[dt.lastUsedAt]) == "number" ? vt : Wa;
      },
...
function ao({ scrollGroupId: t, isBoundButClosed: e }) {
  ...
  ) : /* @__PURE__ */ n(yt, { variant: "secondary", children: a });
}
function oo({
  row: t,
  mode: e,
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: S
  } = va(), [I, w] = H(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, N = m || I, h = X(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), S();
  }, [S]), F = /* @__PURE__ */ n(re, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let V;
  e === "project" ? t.openGroups.length > 0 && (V = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ n(yt, { variant: "secondary", children: ft(R) }, R)) })) : t.scrollGroupId !== void 0 && (V = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ao,
      {
...
function ro({
  ...
  return /* @__PURE__ */ p(xa, { children: [
    /* @__PURE__ */ p(Ot, { children: [
      /* @__PURE__ */ n(Mt, { asChild: !0, children: /* @__PURE__ */ n(ya, { asChild: !0, children: /* @__PURE__ */ n(
        q,
        {
          variant: "ghost",
          size: "sm",
...
function tn(t) {
  const [e, a] = H(!1), [o, r] = H(""), s = at(() => to(t.localizedStrings), [t.localizedStrings]), i = at(() => {
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, S = pt(null), [I, w] = H(void 0), g = X((d) => {
    a(d), d || (r(""), w(void 0));
  }, []);
  Ct(() => {
    if (!e) return;
  ...
  const N = at(() => t.mode === "project" ? Tt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, A = P(d.projectId), M = (z) => P(z.projectId) === A && z.scrollGroupId === d.scrollGroupId, j = b.some(M) ? b.filter((z) => !M(z)) : [
          ...b.filter((z) => !M(z)),
    ...
    switch (t.mode) {
      case "project": {
        ...
        return d && it === "shortNameAndFullName" && (b = se(d)), { node: b, title: b, hasSelection: !!d };
      }
      case "project-multi": {
        ...
        const b = [];
        if (d.forEach((j) => {
          const z = F(j.projectId);
          z && b.push({ project: z, scrollGroupId: j.scrollGroupId });
        }), b.length === 0) {
          const j = s.buttonPlaceholder;
          return { node: j, title: j, hasSelection: !1 };
        }
        const A = b.map(
          ({ project: j, scrollGroupId: z }) => z === void 0 ? j.shortName : `${j.shortName} (${ft(z)})`
        ).join(", "), M = b.length.toString();
        return {
          node: /* @__PURE__ */ p(Ee, { children: [
            /* @__PURE__ */ n(yt, { variant: "muted", className: "tw:shrink-0", children: M }),
            /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: A })
          ] }),
          title: `${M} ${A}`,
          hasSelection: !0
        };
  ...
  Ct(() => {
    ...
    const A = new ResizeObserver((M) => {
      M.forEach((j) => {
        const [z] = j.borderBoxSize;
        b(z ? z.inlineSize : d.getBoundingClientRect().width);
      });
    });
    return A.observe(d, { box: "border-box" }), () => A.disconnect();
  }, []);
  let k;
  t.isLoading ? k = /* @__PURE__ */ n(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : gt ? k = void 0 : t.mode === "project-multi" ? k = /* @__PURE__ */ n(oe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : k = /* @__PURE__ */ n(Be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const Y = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? x : void 0, O = s.ariaLabel && B.hasSelection && B.title ? `${s.ariaLabel}: ${B.accessibleTitle ?? B.title}` : s.ariaLabel || void 0, J = /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ n(Mt, { asChild: !0, children: /* @__PURE__ */ n(At, { asChild: !0, children: J }) }),
    /* @__PURE__ */ n(Ht, { dir: "auto", children: B.title })
  ] }) }) : /* @__PURE__ */ n(At, { asChild: !0, children: J }), Nt = i.length > 1;
  return /* @__PURE__ */ p(be, { open: e, onOpenChange: g, children: [
    bt,
    /* @__PURE__ */ n(
      ve,
      {
              ...
              /* @__PURE__ */ p(me, { children: [
                ...
                R.map((d, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(he, { heading: so(d, s), children: d.rows.map((A) => /* @__PURE__ */ n(
                          oo,
                          {
                            row: A,
                            mode: t.mode,
        ...
        children: [
          ...
          t && /* @__PURE__ */ p(
            q,
            {
              ...
              children: [
                /* @__PURE__ */ n(Me, { className: "tw:h-4 tw:w-4" }),
...
const an = (t, e, a) => co(t, e).every((o) => a.includes(o));
function uo(t, e) {
  return [
...
function rn({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ n(
    "p",
    {
      role: "status",
...
function sn({
  ...
  return /* @__PURE__ */ p(wo, { className: c(s), role: r, children: [
    /* @__PURE__ */ p(po, { children: [
      /* @__PURE__ */ n(fo, { variant: "icon", children: o ?? /* @__PURE__ */ n(He, {}) }),
      /* @__PURE__ */ n(ho, { children: t })
    ] }),
    a && /* @__PURE__ */ n(go, { children: /* @__PURE__ */ n(q, { onClick: () => a(), children: e }) })
  ] });
}
const bo = ae(({ className: t, ...e }, a) => /* @__PURE__ */ n(Ue, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DodcNFuZ.js.map
