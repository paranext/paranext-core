...
} });`:Je(12,p?` (${p})`:"",JSON.stringify(h.main)));return Pt(h,"light",Y,n),Pt(h,"dark",D,n),h.contrastText||(h.contrastText=d(h.main)),h},b={dark:Or,light:At};return process.env.NODE_ENV!=="production"&&(b[r]||console.error(`MUI: The palette mode \`${r}\` is not supported.`)),ve(M({common:M({},nr),mode:r,primary:f({color:s,name:"primary"}),secondary:f({color:a,name:"secondary",mainShade:"A400",lightShade:"A200",darkShade:"A700"}),error:f({color:c,name:"error"}),warning:f({color:l,name:"warning"}),info:f({color:u,name:"info"}),success:f({color:i,name:"success"}),grey:ma,contrastThreshold:t,getContrastText:d,augmentColor:f,tonalOffset:n},b[r]),o)}const Ra=["fontFamily","fontSize","fontWeightLight","fontWeightRegular","fontWeightMedium","fontWeightBold","htmlFontSize","allVariants","pxToRem"];function $a(e){return Math.round(e*1e5)/1e5}const Mt={textTransform:"uppercase"},It='"Roboto", "Helvetica", "Arial", sans-serif';function Aa(e,r){const t=typeof r=="function"?r(e):r,{fontFamily:n=It,fontSize:o=14,fontWeightLight:s=300,fontWeightRegular:a=400,fontWeightMedium:c=500,fontWeightBold:u=700,htmlFontSize:i=16,allVariants:l,pxToRem:d}=t,f=Ne(t,Ra);process.env.NODE_ENV!=="production"&&(typeof o!="number"&&console.error("MUI: `fontSize` is required to be a number."),typeof i!="number"&&console.error("MUI: `htmlFontSize` is required to be a number."));const b=o/14,y=d||(S=>`${S/i*b}rem`),h=(S,Y,D,P,m)=>M({fontFamily:n,fontWeight:S,fontSize:y(Y),lineHeight:D},n===It?{letterSpacing:`${$a(P/Y)}em`}:{},m,l),p={h1:h(s,96,1.167,-1.5),h2:h(s,60,1.2,-.5),h3:h(a,48,1.167,0),h4:h(a,34,1.235,.25),h5:h(a,24,1.334,0),h6:h(c,20,1.6,.15),subtitle1:h(a,16,1.75,.15),subtitle2:h(c,14,1.57,.1),body1:h(a,16,1.5,.15),body2:h(a,14,1.43,.15),button:h(c,14,1.75,.4,Mt),caption:h(a,12,1.66,.4),overline:h(a,12,2.66,1,Mt),inherit:{fontFamily:"inherit",fontWeight:"inherit",fontSize:"inherit",lineHeight:"inherit",letterSpacing:"inherit"}};return ve(M({htmlFontSize:i,pxToRem:y,fontFamily:n,fontSize:o,fontWeightLight:s,fontWeightRegular:a,fontWeightMedium:c,fontWeightBold:u},p),f,{clone:!1})}const Pa=.2,Ma=.14,Ia=.12;function F(...e){return[`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Pa})`,`${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Ma})`,`${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Ia})`].join(",")}const Ba=["none",F(0,2,1,-1,0,1,1,0,0,1,3,0),F(0,3,1,-2,0,2,2,0,0,1,5,0),F(0,3,3,-2,0,3,4,0,0,1,8,0),F(0,2,4,-1,0,4,5,0,0,1,10,0),F(0,3,5,-1,0,5,8,0,0,1,14,0),F(0,3,5,-1,0,6,10,0,0,1,18,0),F(0,4,5,-2,0,7,10,1,0,2,16,1),F(0,5,5,-3,0,8,10,1,0,3,14,2),F(0,5,6,-3,0,9,12,1,0,3,16,2),F(0,6,6,-3,0,10,14,1,0,4,18,3),F(0,6,7,-4,0,11,15,1,0,4,20,3),F(0,7,8,-4,0,12,17,2,0,5,22,4),F(0,7,8,-4,0,13,19,2,0,5,24,4),F(0,7,9,-4,0,14,21,2,0,5,26,4),F(0,8,9,-5,0,15,22,2,0,6,28,5),F(0,8,10,-5,0,16,24,2,0,6,30,5),F(0,8,11,-5,0,17,26,2,0,6,32,5),F(0,9,11,-5,0,18,28,2,0,7,34,6),F(0,9,12,-6,0,19,29,2,0,7,36,6),F(0,10,13,-6,0,20,31,3,0,8,38,7),F(0,10,13,-6,0,21,33,3,0,8,40,7),F(0,10,14,-6,0,22,35,3,0,8,42,7),F(0,11,14,-7,0,23,36,3,0,9,44,8),F(0,11,15,-7,0,24,38,3,0,9,46,8)],ja=Ba,Da=["duration","easing","delay"],Va={easeInOut:"cubic-bezier(0.4, 0, 0.2, 1)",easeOut:"cubic-bezier(0.0, 0, 0.2, 1)",easeIn:"cubic-bezier(0.4, 0, 1, 1)",sharp:"cubic-bezier(0.4, 0, 0.6, 1)"},za={shortest:150,shorter:200,short:250,standard:300,complex:375,enteringScreen:225,leavingScreen:195};function Bt(e){return`${Math.round(e)}ms`}function La(e){if(!e)return 0;const r=e/36;return Math.round((4+15*r**.25+r/5)*10)}function qa(e){const r=M({},Va,e.easing),t=M({},za,e.duration);return M({getAutoHeightDuration:La,create:(o=["all"],s={})=>{const{duration:a=t.standard,easing:c=r.easeInOut,delay:u=0}=s,i=Ne(s,Da);if(process.env.NODE_ENV!=="production"){const l=f=>typeof f=="string",d=f=>!isNaN(parseFloat(f));!l(o)&&!Array.isArray(o)&&console.error('MUI: Argument "props" must be a string or Array.'),!d(a)&&!l(a)&&console.error(`MUI: Argument "duration" must be a number or a string but found ${a}.`),l(c)||console.error('MUI: Argument "easing" must be a string.'),!d(u)&&!l(u)&&console.error('MUI: Argument "delay" must be a number or a string.'),typeof s!="object"&&console.error(["MUI: Secong argument of transition.create must be an object.","Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
`)),Object.keys(i).length!==0&&console.error(`MUI: Unrecognized argument(s) [${Object.keys(i).join(",")}].`)}return(Array.isArray(o)?o:[o]).map(l=>`${l} ${typeof a=="string"?a:Bt(a)} ${c} ${typeof u=="string"?u:Bt(u)}`).join(",")}},e,{easing:r,duration:t})}const Xa={mobileStepper:1e3,fab:1050,speedDial:1050,appBar:1100,drawer:1200,modal:1300,snackbar:1400,tooltip:1500},Ja=Xa,Ha=["breakpoints","mixins","spacing","palette","transitions","typography","shape"];function Ga(e={},...r){const{mixins:t={},palette:n={},transitions:o={},typography:s={}}=e,a=Ne(e,Ha);if(e.vars)throw new Error(process.env.NODE_ENV!=="production"?"MUI: `vars` is a private field used for CSS variables support.\nPlease use another name.":Je(18));const c=_a(n),u=Hr(e);let i=ve(u,{mixins:da(u.breakpoints,t),palette:c,shadows:ja.slice(),typography:Aa(c,s),transitions:qa(o),zIndex:M({},Ja)});if(i=ve(i,a),i=r.reduce((l,d)=>ve(l,d),i),process.env.NODE_ENV!=="production"){const l=["active","checked","completed","disabled","error","expanded","focused","focusVisible","required","selected"],d=(f,b)=>{let y;for(y in f){const h=f[y];if(l.indexOf(y)!==-1&&Object.keys(h).length>0){if(process.env.NODE_ENV!=="production"){const p=zr("",y);console.error([`MUI: The \`${b}\` component increases the CSS specificity of the \`${y}\` internal state.`,"You can not override it like this: ",JSON.stringify(f,null,2),"",`Instead, you need to use the '&.${p}' syntax:`,JSON.stringify({root:{[`&.${p}`]:h}},null,2),"","https://mui.com/r/state-classes-guide"].join(`
`))}f[y]={}}}};Object.keys(i.components).forEach(f=>{const b=i.components[f].styleOverrides;b&&f.indexOf("Mui")===0&&d(b,f)})}return i.unstable_sxConfig=M({},Xr,a==null?void 0:a.unstable_sxConfig),i.unstable_sx=function(d){return Jr({sx:d,theme:this})},i}const Fa=Ga(),yn=Fa,vn="$$material";function Ua({props:e,name:r}){return ia({props:e,name:r,defaultTheme:yn,themeId:vn})}const Ka=e=>lr(e)&&e!=="classes",Wa=sa({themeId:vn,defaultTheme:yn,rootShouldForwardProp:Ka}),Ya=Wa;function Za(e){return zr("MuiSvgIcon",e)}Ko("MuiSvgIcon",["root","colorPrimary","colorSecondary","colorAction","colorError","colorDisabled","fontSizeInherit","fontSizeSmall","fontSizeMedium","fontSizeLarge"]);const Qa=["children","className","color","component","fontSize","htmlColor","inheritViewBox","titleAccess","viewBox"],ei=e=>{const{color:r,fontSize:t,classes:n}=e,o={root:["root",r!=="inherit"&&`color${ge(r)}`,`fontSize${ge(t)}`]};return Jo(o,Za,n)},ri=Ya("svg",{name:"MuiSvgIcon",slot:"Root",overridesResolver:(e,r)=>{const{ownerState:t}=e;return[r.root,t.color!=="inherit"&&r[`color${ge(t.color)}`],r[`fontSize${ge(t.fontSize)}`]]}})(({theme:e,ownerState:r})=>{var t,n,o,s,a,c,u,i,l,d,f,b,y;return{userSelect:"none",width:"1em",height:"1em",display:"inline-block",fill:r.hasSvgAsChild?void 0:"currentColor",flexShrink:0,transition:(t=e.transitions)==null||(n=t.create)==null?void 0:n.call(t,"fill",{duration:(o=e.transitions)==null||(o=o.duration)==null?void 0:o.shorter}),fontSize:{inherit:"inherit",small:((s=e.typography)==null||(a=s.pxToRem)==null?void 0:a.call(s,20))||"1.25rem",medium:((c=e.typography)==null||(u=c.pxToRem)==null?void 0:u.call(c,24))||"1.5rem",large:((i=e.typography)==null||(l=i.pxToRem)==null?void 0:l.call(i,35))||"2.1875rem"}[r.fontSize],color:(d=(f=(e.vars||e).palette)==null||(f=f[r.color])==null?void 0:f.main)!=null?d:{action:(b=(e.vars||e).palette)==null||(b=b.action)==null?void 0:b.active,disabled:(y=(e.vars||e).palette)==null||(y=y.action)==null?void 0:y.disabled,inherit:void 0}[r.color]}}),Fr=rr.forwardRef(function(r,t){const n=Ua({props:r,name:"MuiSvgIcon"}),{children:o,className:s,color:a="inherit",component:c="svg",fontSize:u="medium",htmlColor:i,inheritViewBox:l=!1,titleAccess:d,viewBox:f="0 0 24 24"}=n,b=Ne(n,Qa),y=rr.isValidElement(o)&&o.type==="svg",h=M({},n,{color:a,component:c,fontSize:u,instanceFontSize:r.fontSize,inheritViewBox:l,viewBox:f,hasSvgAsChild:y}),p={};l||(p.viewBox=f);const S=ei(h);return E.jsxs(ri,M({as:c,className:Wo(S.root,s),focusable:"false",color:i,"aria-hidden":d?void 0:!0,role:d?"img":void 0,ref:t},p,b,y&&o.props,{ownerState:h,children:[y?o.props.children:o,d?E.jsx("title",{children:d}):null]}))});process.env.NODE_ENV!=="production"&&(Fr.propTypes={children:G.node,classes:G.object,className:G.string,color:G.oneOfType([G.oneOf(["inherit","action","disabled","primary","secondary","error","info","success","warning"]),G.string]),component:G.elementType,fontSize:G.oneOfType([G.oneOf(["inherit","large","medium","small"]),G.string]),htmlColor:G.string,inheritViewBox:G.bool,shapeRendering:G.string,sx:G.oneOfType([G.arrayOf(G.oneOfType([G.func,G.object,G.bool])),G.func,G.object]),titleAccess:G.string,viewBox:G.string});Fr.muiName="SvgIcon";const jt=Fr;function ti(e,r){function t(n,o){return E.jsx(jt,M({"data-testid":`${r}Icon`,ref:o},n,{children:e}))}return process.env.NODE_ENV!=="production"&&(t.displayName=`${r}Icon`),t.muiName=jt.muiName,rr.memo(rr.forwardRef(t))}const ni=ti(E.jsx("path",{d:"M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"}),"Menu");function oi({menu:e,dataHandler:r,commandHandler:t,className:n,id:o,children:s}){const[a,c]=Q.useState(!1),[u,i]=Q.useState(!1),l=Q.useCallback(()=>{a&&c(!1),i(!1)},[a]),d=Q.useCallback(S=>{S.stopPropagation(),c(Y=>{const D=!Y;return D&&S.shiftKey?i(!0):D||i(!1),D})},[]),f=Q.useRef(null),[b,y]=Q.useState(0);Q.useEffect(()=>{a&&f.current&&y(f.current.clientHeight)},[a]);const h=Q.useCallback(S=>(l(),t(S)),[t,l]);let p=e;return!p&&r&&(p=r(u)),E.jsx("div",{ref:f,style:{position:"relative"},children:E.jsx(Z.AppBar,{position:"static",id:o,children:E.jsxs(Z.Toolbar,{className:`papi-toolbar ${n??""}`,variant:"dense",children:[p?E.jsx(Z.IconButton,{edge:"start",className:`papi-menuButton ${n??""}`,color:"inherit","aria-label":"open drawer",onClick:d,children:E.jsx(ni,{})}):void 0,s?E.jsx("div",{className:"papi-menu-children",children:s}):void 0,p?E.jsx(Z.Drawer,{className:`papi-menu-drawer ${n??""}`,anchor:"left",variant:"persistent",open:a,onClose:l,PaperProps:{className:"papi-menu-drawer-paper",style:{top:b}},children:E.jsx(zt,{commandHandler:h,columns:p.columns})}):void 0]})})})}const si=(e,r)=>{Q.useEffect(()=>{if(!e)return()=>{};const t=e(r);return()=>{t()}},[e,r])},xn=(e,r,t=!0)=>{const[n,o]=Q.useState(()=>r),[s,a]=Q.useState(!0);return Q.useEffect(()=>{let c=!0;return a(!!e),(async()=>{if(e){const u=await e();c&&(o(()=>u),a(!1))}})(),()=>{c=!1,t||o(()=>r)}},[e,r,t]),[n,s]},_r=()=>!1,ai=(e,r)=>{const[t]=xn(Q.useCallback(async()=>{if(!e)return _r;const n=await Promise.resolve(e(r));return async()=>n()},[r,e]),_r,!1);Q.useEffect(()=>()=>{t!==_r&&t()},[t])};exports.Button=Oe;exports.ChapterRangeSelector=En;exports.Checkbox=Dt;exports.ComboBox=ur;exports.GridMenu=zt;exports.IconButton=kn;exports.LabelPosition=Ae;exports.MenuItem=Vt;exports.RefSelector=Eo;exports.SearchBar=So;exports.Slider=ko;exports.Snackbar=wo;exports.Switch=Co;exports.Table=Oo;exports.TextField=tr;exports.Toolbar=oi;exports.useEvent=si;exports.useEventAsync=ai;exports.usePromise=xn;function ii(e,r="top"){if(!e||typeof document>"u")return;const t=document.head||document.querySelector("head"),n=t.querySelector(":first-child"),o=document.createElement("style");o.appendChild(document.createTextNode(e)),r==="top"&&n?t.insertBefore(o,n):t.appendChild(o)}ii(`.papi-button {
  border: 0;
  border-radius: 3em;
  cursor: pointer;
