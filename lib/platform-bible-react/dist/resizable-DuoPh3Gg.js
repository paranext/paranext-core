...
import { Slot as ht, Dialog as $, Popover as et, Tooltip as Y, Label as ee, RadioGroup as mt, ToggleGroup as Gt, Separator as ae, DropdownMenu as E } from "radix-ui";
import { IconX as re, IconSearch as oe, IconCheck as gt, IconChevronRight as ne } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as B, useRef as it, useCallback as H, createContext as se, useContext as ie, useEffect as At, useMemo as q, Fragment as le, forwardRef as Dt } from "react";
import { cva as V } from "class-variance-authority";
import { ChevronsUpDown as Lt, Check as Rt, Star as de, Filter as ce, ArrowRight as ue, Loader2 as we, ChevronDown as me, Search as fe, X as pe, AlertTriangle as he, LoaderCircle as ge } from "lucide-react";
import { Section as J, MODIFIER_KEYS as be, normalizeProjectId as at, getLocalizeKeyForScrollGroupId as Ne, getSectionForBook as ve } from "platform-bible-utils";
...
import { extendTailwindMerge as ye, twMerge as Ie } from "tailwind-merge";
const ke = ye({ prefix: "tw" });
function ft(t) {
  const e = [];
  let a = "", r = 0;
...
function Ce(t) {
  ...
  const e = ft(t), a = e.findIndex((s) => s.startsWith("-tw-"));
  if (a !== -1) {
    const s = e[a].slice(4);
...
function Se(t, e) {
  ...
  const a = ft(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), o = a[a.length - 1], s = ft(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && o.startsWith("-")) {
    const u = o.slice(1);
    return [...r, `-tw-${u}`].join(":");
  }
...
function d(...t) {
  const e = xe(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return ke(e);
  const a = e.split(" ").filter(Boolean), r = /* @__PURE__ */ new Map(), o = [];
  return a.forEach((u) => {
    const p = Ce(u);
    r.set(p.normalized, p.original), o.push(p.normalized);
  }), Ie(o.join(" ")).split(" ").filter(Boolean).map((u) => {
    const p = r.get(u);
    return p ? Se(u, p) : u;
  }).join(" ");
}
const Bt = 600, Ja = 650, Ua = 400, Ee = 450, Te = 500, ze = 550, Xa = 650, Wa = 700, Za = 800, Ot = V(
...
function O({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(Ot({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
  ...
  return /* @__PURE__ */ f(Ge, { children: [
    ...
    /* @__PURE__ */ f(
      $.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n($.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(O, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(re, {}),
...
function rr({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n($.Close, { asChild: !0, children: /* @__PURE__ */ n(O, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function _t({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(Le, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        W.Input,
        {
      ...
      /* @__PURE__ */ n(Be, { children: /* @__PURE__ */ n(oe, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Vt({
  ...
  return /* @__PURE__ */ f(
    W.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ n(gt, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
const pr = Object.fromEntries(
  _e.map((t) => [t, G.bookIdToEnglishName(t)])
);
function hr(t, e, a) {
...
function Xt({
  ...
  return /* @__PURE__ */ n(
    Y.Trigger,
    {
      ...
      className: e ? d(Ot({ variant: e }), t) : t,
      ...a
    }
  );
}
function Wt({
  ...
  return /* @__PURE__ */ n(Y.Portal, { children: /* @__PURE__ */ f(
    Y.Content,
    {
...
const Ue = ["input", "select", "textarea", "button"], Xe = ["button", "textbox"], Dr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = it(null), [s, i] = B(void 0), [l, u] = B(void 0), p = H(
    (w) => {
      i(w);
      const N = t.find((v) => v.id === w);
      N && (e == null || e(N));
      const y = document.getElementById(w);
      y && (y.scrollIntoView({ block: "center" }), y.focus()), o.current && o.current.setAttribute("aria-activedescendant", w);
    },
    [e, t]
  ), g = H(
    (w) => {
      const N = t.find((y) => y.id === w);
      N && (u((y) => y === w ? void 0 : w), a == null || a(N));
    },
    [a, t]
  ), k = (w) => {
    if (!w) return !1;
    const N = w.tagName.toLowerCase();
    if (w.isContentEditable || Ue.includes(N)) return !0;
    const y = w.getAttribute("role");
    if (y && Xe.includes(y)) return !0;
    const v = w.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, A = H(
    (w) => {
      var U;
      const N = w.target, y = (I) => I ? document.getElementById(I) : void 0, v = y(l), _ = y(s);
      if (!!(v && N && v.contains(N) && N !== v) && k(N)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !N.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const I = t.find((c) => c.id === l);
            I && p(I.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const c = I.findIndex((h) => h === N);
          if (c === -1) return;
          let m;
          w.key === "ArrowDown" ? m = Math.min(c + 1, I.length - 1) : m = Math.max(c - 1, 0), m !== c && (w.preventDefault(), w.stopPropagation(), (U = I[m]) == null || U.focus());
          return;
        }
        return;
      }
      const T = t.findIndex((I) => I.id === s);
      let S = T;
      switch (w.key) {
        case "ArrowDown":
          S = Math.min(T + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          S = Math.max(T - 1, 0), w.preventDefault();
          break;
        case "Home":
          S = 0, w.preventDefault();
          break;
        case "End":
          S = t.length - 1, w.preventDefault();
          break;
        case " ":
        case "Enter":
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(E.ItemIndicator, { children: /* @__PURE__ */ n(gt, {}) })
          }
        ),
        e
      ]
...
function Ct({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ n(
    E.Label,
    {
...
function rt(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && ta(r)
  );
}
function Vr({
  className: t,
  ...
  z.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        rt(i, '[tabindex]:not([tabindex="-1"])').forEach((g) => {
...
function na({
  ...
  return e ? (
    ...
    /* @__PURE__ */ f("div", { className: "tw:relative tw:flex tw:min-h-0 tw:flex-col", children: [
      t,
      r && /* @__PURE__ */ n(
        "div",
        {
...
function qr({
  ...
  const [Z, T] = B(!1), S = it(null), R = H(
    (D) => {
      var M;
      const F = (M = t.find((K) => K.label === D)) == null ? void 0 : M.value;
      F && a(
        e.includes(F) ? e.filter((K) => K !== F) : [...e, F]
      );
    },
    [t, e, a]
  ), U = () => p || r, I = g ?? Z, c = k ?? T, [m, h] = B(I), [C, b] = B(e);
  m !== I && (h(I), I && b(e));
  const X = q(() => {
    if (!w) return t;
    const D = t.filter((M) => M.starred).sort((M, K) => M.label.localeCompare(K.label)), F = t.filter((M) => !M.starred).sort((M, K) => {
      const vt = C.includes(M.value), xt = C.includes(K.value);
      return vt && !xt ? -1 : !vt && xt ? 1 : M.label.localeCompare(K.label);
    });
    return [...D, ...F];
  }, [t, C, w]), ut = () => {
    const D = t.map((F) => F.value);
    b(D), a(D);
  }, te = () => {
    b([]), a([]);
  };
  return /* @__PURE__ */ n("div", { id: j, className: v, children: /* @__PURE__ */ f(Ft, { open: I, onOpenChange: c, children: [
    /* @__PURE__ */ n(pt, { asChild: !0, children: /* @__PURE__ */ f(
      O,
      {
        variant: _,
        role: "combobox",
        ...
        children: [
          /* @__PURE__ */ f("div", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-center tw:gap-2", children: [
            y && /* @__PURE__ */ n("div", { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50", children: /* @__PURE__ */ n("span", { className: "tw:flex tw:h-full tw:w-full tw:items-center tw:justify-center", children: y }) }),
            /* @__PURE__ */ n(
              "span",
              {
                className: d(
          ...
          /* @__PURE__ */ n(Lt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ n(Jt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Mt, { children: [
      /* @__PURE__ */ n(
        _t,
        {
          placeholder: o ?? r,
      ...
      s && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: ut, children: i }),
        /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: te, children: l })
      ] }),
      /* @__PURE__ */ n(na, { isEnabled: N, scrollerRef: S, children: /* @__PURE__ */ f(jt, { ref: S, children: [
        /* @__PURE__ */ n($t, { children: u }),
        /* @__PURE__ */ n(Ht, { children: X.map((D) => /* @__PURE__ */ f(
          Vt,
          {
            value: D.label,
            onSelect: R,
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ n(de, { className: "tw:h-4 tw:w-4" }),
...
function Yr(t, e, a) {
  ...
  if (ia(t) || be.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (L(t), a.dismiss(), "ended") : (L(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (L(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (L(t), a.dismiss(), "ended") : t.key === "Backspace" || Yt[r].test(t.key) ? (L(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && L(t), a.dismiss(), "ended");
}
function Qr(t, e) {
  var a;
...
function to(t) {
  ...
  o.current += 1;
  const w = o.current, N = a ? "backslash" : "selection", y = { kind: N, token: w, filter: "", items: e };
  N === "backslash" && r && (y.shouldSpaceCommit = r), s(y), u({
...
function ba({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    onPointerLeave: p
  } = Ve(), [g, k] = B(!1), A = !!(t.language || t.languageCode), w = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = l || g, y = H(() => {
    if (w) {
      k(!0);
      return;
    }
    ...
    k(!1), p();
  }, [p]), _ = /* @__PURE__ */ n(Rt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let j;
  e === "project" ? t.openGroups.length > 0 && (j = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ n(st, { variant: "secondary", children: ot(R) }, R)) })) : t.scrollGroupId !== void 0 && (j = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ga,
      {
    ...
    t.isBoundButClosed && o && /* @__PURE__ */ f(
      O,
      {
        ...
        children: [
          /* @__PURE__ */ n(ue, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  const Z = /* @__PURE__ */ f(
    Vt,
    {
      ...
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: _ }),
        /* @__PURE__ */ f(
          "span",
          {
            ref: i,
  ...
  ), T = t.scrollGroupId !== void 0 ? ot(t.scrollGroupId) : void 0, S = t.isBoundButClosed && T ? a.boundButClosedTooltip.replace("{group}", T) : void 0;
  return /* @__PURE__ */ f(Ut, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ n(Xt, { asChild: !0, children: Z }),
    /* @__PURE__ */ f(
      Wt,
      {
        side: "top",
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && T && /* @__PURE__ */ f("div", { className: "tw:text-sm", children: [
          ...
          S && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: S }),
  ...
  return /* @__PURE__ */ f(Ze, { children: [
    /* @__PURE__ */ n(qe, { asChild: !0, children: /* @__PURE__ */ n(
      O,
      {
        ...
        children: /* @__PURE__ */ n(ce, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ f(
      Ye,
      {
        ...
        style: { zIndex: Qt },
        children: [
          /* @__PURE__ */ n(Ct, { children: o.groupSectionLabel }),
          /* @__PURE__ */ n(
            kt,
            {
              checked: t,
          ...
          r && /* @__PURE__ */ f(zt, { children: [
            /* @__PURE__ */ n(Qe, {}),
            /* @__PURE__ */ n(Ct, { children: o.filterSectionLabel }),
            /* @__PURE__ */ n(
              kt,
              {
                checked: !!a,
...
function ro(t) {
  const [e, a] = B(!1), [r, o] = B(""), [s, i] = B(t.defaultGroupByOpenTabs ?? !0), [l, u] = B(!1), p = it(null), g = H((c) => {
    a(c), c || o("");
  }, []);
  At(() => {
    if (!e) return;
  ...
  const k = pa(t.localizedStrings), A = q(() => t.mode === "project" ? wt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
  }) : t.mode === "project-multi" ? wt({
    mode: "project-multi",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), w = q(() => {
    const c = r.trim().toLowerCase();
    let m = A;
    return c && (m = m.filter(
      (h) => h.shortName.toLowerCase().includes(c) || h.fullName.toLowerCase().includes(c) || (h.language ?? "").toLowerCase().includes(c) || (h.languageCode ?? "").toLowerCase().includes(c)
    )), t.mode === "project-multi" && l && (m = m.filter((h) => h.isSelected)), m;
  }, [A, r, t.mode, l]), N = q(
    () => t.groupByVersification ? ma(
      w,
    ...
    return t.projects.forEach((m) => {
      ...
      h.forEach((b) => {
        C.has(b.scrollGroupId) || (C.add(b.scrollGroupId), c.push({ projectId: m.id, scrollGroupId: b.scrollGroupId }));
      });
    }), c;
  }, [t.mode, t.projects, t.openTabs]), v = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const m = t.selection.pairs, h = (b) => b.projectId === c.projectId && b.scrollGroupId === c.scrollGroupId, C = m.some(h) ? m.filter((b) => !h(b)) : [...m, { projectId: c.projectId, scrollGroupId: c.scrollGroupId }];
        t.onChangeSelection({ pairs: C }), C.length === 0 && l && u(!1);
        return;
      }
    ...
    if (t.mode !== "project-multi") return;
    const c = t.selection.pairs, m = new Set(c.map((C) => `${C.projectId}:${C.scrollGroupId ?? ""}`)), h = [...c];
    y.forEach((C) => {
      const b = `${C.projectId}:${C.scrollGroupId ?? ""}`;
      m.has(b) || (m.add(b), h.push(C));
    ...
    switch (t.mode) {
      case "project": {
        const c = t.projects.find((h) => h.id === t.selection.projectId);
      ...
      case "project-multi": {
        ...
        const m = [];
        if (c.forEach((b) => {
          const X = t.projects.find((ut) => ut.id === b.projectId);
          X && m.push({ project: X, scrollGroupId: b.scrollGroupId });
        }), m.length === 0) {
          const b = t.buttonPlaceholder ?? "";
          return { node: b, title: b };
        }
        if (t.getSelectedText) {
          const b = t.getSelectedText(m);
          return { node: b, title: b };
        }
        const h = m.map(
          ({ project: b, scrollGroupId: X }) => X === void 0 ? b.shortName : `${b.shortName} (${ot(X)})`
        ).join(", ");
        if (m.length === 1) return { node: h, title: h };
        const C = m.length.toString();
        return {
          node: /* @__PURE__ */ f(zt, { children: [
            /* @__PURE__ */ n(st, { variant: "muted", className: "tw:shrink-0", children: C }),
      ...
      case "projectScrollGroup": {
        const c = t.projects.find((C) => C.id === t.selection.projectId);
        if (!c) {
  ...
  let S;
  t.isLoading ? S = /* @__PURE__ */ n(we, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? S = void 0 : t.mode === "project-multi" ? S = /* @__PURE__ */ n(Lt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : S = /* @__PURE__ */ n(me, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const R = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? v : void 0, U = /* @__PURE__ */ f(
    O,
    {
  ...
  ), I = T.title ? /* @__PURE__ */ n(It, { delayDuration: 400, children: /* @__PURE__ */ f(Ut, { children: [
    /* @__PURE__ */ n(Xt, { asChild: !0, children: /* @__PURE__ */ n(pt, { asChild: !0, children: U }) }),
    /* @__PURE__ */ n(Wt, { children: T.title })
  ] }) }) : /* @__PURE__ */ n(pt, { asChild: !0, children: U });
  return /* @__PURE__ */ f(Ft, { open: e, onOpenChange: g, children: [
    I,
    /* @__PURE__ */ n(
      Jt,
      {
        ...
        children: /* @__PURE__ */ n(It, { delayDuration: 400, children: /* @__PURE__ */ f(Mt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: j, children: `${k.selectAll} (${y.length.toString()})` }),
            /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: Z, children: `${k.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(jt, { children: [
            ...
            N.map((c, m) => (
              ...
              /* @__PURE__ */ f(le, { children: [
                /* @__PURE__ */ n(Ht, { heading: va(c, k), children: c.rows.map((h) => /* @__PURE__ */ n(
                  ba,
                  {
                    row: h,
                    mode: t.mode,
        ...
        children: [
          ...
          t && /* @__PURE__ */ f(
            O,
            {
              ...
              children: [
                /* @__PURE__ */ n(pe, { className: "tw:h-4 tw:w-4" }),
...
const no = (t, e, a) => Ia(t, e).every((r) => a.includes(r));
function ka(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, o) => G.bookIdToNumber(r) - G.bookIdToNumber(o)).map((r) => He(r, e));
}
function so(t, e, a, r) {
...
function co({
  ...
  return /* @__PURE__ */ f(Ca, { className: d(s), role: o, children: [
    /* @__PURE__ */ f(Sa, { children: [
      /* @__PURE__ */ n(Ta, { variant: "icon", children: r ?? /* @__PURE__ */ n(he, {}) }),
      /* @__PURE__ */ n(za, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ga, { children: /* @__PURE__ */ n(O, { onClick: () => a(), children: e }) })
  ] });
}
const Aa = Dt(({ className: t, ...e }, a) => /* @__PURE__ */ n(ge, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DuoPh3Gg.js.map
