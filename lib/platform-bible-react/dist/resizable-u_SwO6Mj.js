<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-Dnp2Wyft.js
import { jsx as n, jsxs as m, Fragment as re } from "react/jsx-runtime";
import { Slot as vt, Dialog as K, Separator as oe, Popover as ot, Tooltip as tt, DropdownMenu as C, Label as ne, RadioGroup as ht, ToggleGroup as Rt } from "radix-ui";
import { IconX as se, IconSearch as ie, IconCheck as xt, IconChevronRight as le } from "@tabler/icons-react";
import { Canon as z } from "@sillsdev/scripture";
import { cva as X } from "class-variance-authority";
import G, { useState as J, useRef as dt, useCallback as V, createContext as de, useContext as ce, useMemo as q, useEffect as Ct, Fragment as ue, forwardRef as Pt } from "react";
import { ChevronsUpDown as Bt, Check as Ot, Star as we, Group as pe, ArrowRight as me, Loader2 as fe, ChevronDown as he, Search as ge, X as be, AlertTriangle as Ne, LoaderCircle as ve } from "lucide-react";
import { Section as Z, MODIFIER_KEYS as xe, normalizeProjectId as R, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as at, getLocalizeKeyForScrollGroupId as ye, getSectionForBook as Se } from "platform-bible-utils";
...
import { Slot as ut, Dialog as M, Popover as q, Tooltip as X, Label as Ut, RadioGroup as lt, ToggleGroup as kt, Separator as Xt, DropdownMenu as S } from "radix-ui";
import { IconX as Wt, IconCheck as wt, IconSearch as Zt, IconChevronRight as qt } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as _, useRef as mt, useCallback as j, createContext as Yt, useContext as Qt, useMemo as U, useEffect as te, Fragment as ee, forwardRef as Ct } from "react";
import { cva as $ } from "class-variance-authority";
import { ChevronsUpDown as St, Check as Et, Star as ae, Filter as re, ArrowRight as oe, Loader2 as ne, ChevronDown as se, Search as ie, X as le, AlertTriangle as de, LoaderCircle as ce } from "lucide-react";
import { Section as F, MODIFIER_KEYS as ue, normalizeProjectId as Y, getLocalizeKeyForScrollGroupId as we, getSectionForBook as me } from "platform-bible-utils";
import { filterAndRankItems as ht } from "@eten-tech-foundation/platform-editor";
import { Command as K } from "cmdk";
>>>>>>>> 32f33c498dd (fix: address review findings on draft durability and filter state):lib/platform-bible-react/dist/resizable-u_SwO6Mj.js
import "@eten-tech-foundation/scripture-utilities";
import * as yt from "react-resizable-panels";
import { clsx as ke } from "clsx";
import { extendTailwindMerge as Ie, twMerge as Ee } from "tailwind-merge";
const _e = Ie({ prefix: "tw" });
function gt(t) {
  const e = [];
  let a = "", r = 0;
...
function d(...t) {
  const e = ke(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return _e(e);
  const a = e.split(" ").filter(Boolean), r = /* @__PURE__ */ new Map(), o = [];
  return a.forEach((u) => {
    const f = Te(u);
    r.set(f.normalized, f.original), o.push(f.normalized);
  }), Ee(o.join(" ")).split(" ").filter(Boolean).map((u) => {
    const f = r.get(u);
    return f ? Ce(u, f) : u;
  }).join(" ");
}
const Mt = 600, Ht = 650, er = 400, Ge = 450, ze = 500, je = 675, ar = 690, rr = 700, or = 800, Ut = X(
...
function Ft({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ m(Re, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        Q.Input,
        {
      ...
      /* @__PURE__ */ n(Be, { children: /* @__PURE__ */ n(ie, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Ze({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Qt.Provider, { value: r, children: /* @__PURE__ */ n(C.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Ar({
  ...t
}) {
...
function Mr({
  ...
  return /* @__PURE__ */ m(
    C.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ n(le, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const ra = ["input", "select", "textarea", "button"], oa = ["button", "textbox"], Wr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
    ...
    (w) => {
      ...
      if (!!(b && g && b.contains(g) && g !== b) && k(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const O = y.findIndex((P) => P === g);
          if (O === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(O + 1, y.length - 1) : S = Math.max(O - 1, 0), S !== O && (w.preventDefault(), w.stopPropagation(), (_ = y[S]) == null || _.focus());
          return;
        }
        return;
      }
...
function no({
  ...
  return /* @__PURE__ */ n("div", { id: b, className: g, children: /* @__PURE__ */ m(Zt, { open: y, onOpenChange: h ?? W, children: [
    ...
    /* @__PURE__ */ n(Yt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Kt, { children: [
      ...
      /* @__PURE__ */ m(Jt, { children: [
        ...
        /* @__PURE__ */ n(Xt, { children: j.map((S) => /* @__PURE__ */ m(
          Wt,
          {
            value: S.label,
            onSelect: B,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ n(we, { className: "tw:h-4 tw:w-4" }),
...
function so(t, e, a) {
  ...
  if (ca(t) || xe.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || ee[r].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && D(t), a.dismiss(), "ended");
}
function io(t, e) {
  var a;
  ...
  if (t.mode === "project") {
    ...
    return t.projects.map((s) => {
      ...
      return {
        ...
        isSelected: o !== void 0 && R(o) === R(s.id),
        isMuted: i.length === 0,
        isBoundButClosed: !1,
  ...
  return t.projects.forEach((o) => {
    ...
    s.forEach((i) => {
      r.push({
        ...
        openGroups: [],
        isSelected: At(a, o.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: o.isDisabled === !0,
        disabledReason: o.disabledReason,
...
const _t = "Selected", Tt = "Unselected";
function Dt(t) {
...
function ha(t, e) {
  const a = t.filter((i) => i.isSelected).sort(Y), r = t.filter((i) => !i.isSelected).sort(Y), o = (i, l) => {
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? _t : Tt;
  }, s = [];
...
function va(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? _t : e.unselectedSectionHeading ?? Tt
  };
}
function mo(t) {
  return {
...
const xa = 100, ya = {
  ...
  autoSelectionUnselectedSectionHeading: Tt,
...
function Ea({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: k
  } = We(), [E, w] = J(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = f || E, b = V(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), k();
  }, [k]), W = /* @__PURE__ */ n(Ot, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let B;
  e === "project" ? t.openGroups.length > 0 && (B = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((_) => /* @__PURE__ */ n(ct, { variant: "secondary", children: st(_) }, _)) })) : t.scrollGroupId !== void 0 && (B = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Ia,
      {
    ...
    t.isBoundButClosed && o && /* @__PURE__ */ m(
      H,
      {
        ...
        children: [
          /* @__PURE__ */ n(me, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  return /* @__PURE__ */ m(kt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(It, { asChild: !0, children: $ }),
    /* @__PURE__ */ m(
      Et,
      {
        side: "top",
...
function _a({
  ...
  return /* @__PURE__ */ m(Ze, { children: [
    /* @__PURE__ */ m(kt, { children: [
      /* @__PURE__ */ n(It, { asChild: !0, children: /* @__PURE__ */ n(qe, { asChild: !0, children: /* @__PURE__ */ n(
        H,
        {
          variant: "ghost",
          size: "sm",
      ...
      /* @__PURE__ */ n(Et, { children: r.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ m(
      Ye,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(Qe, { value: e, onValueChange: a, children: [
...
function ft(t, e) {
  if (e === void 0) return;
  const a = R(e);
  return t.find((r) => R(r.id) === a);
}
function go(t) {
  const [e, a] = J(!1), [r, o] = J(""), s = Sa(t.localizedStrings), i = q(() => {
  ...
  const w = q(() => t.mode === "project" ? mt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const p = t.selection.pairs, T = R(c.projectId), I = (A) => R(A.projectId) === T && A.scrollGroupId === c.scrollGroupId, L = p.some(I) ? p.filter((A) => !I(A)) : [
          ...p.filter((A) => !I(A)),
  ...
  let _;
  t.isLoading ? _ = /* @__PURE__ */ n(fe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : j ? _ = void 0 : t.mode === "project-multi" ? _ = /* @__PURE__ */ n(Bt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : _ = /* @__PURE__ */ n(he, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  ...
  return /* @__PURE__ */ m(Zt, { open: e, onOpenChange: E, children: [
    S,
    /* @__PURE__ */ n(
      Yt,
      {
        ...
        children: /* @__PURE__ */ n(jt, { delayDuration: 400, children: /* @__PURE__ */ m(Kt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ m(Jt, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Xt, { heading: Ca(c, s), children: c.rows.map((T) => {
                      var I;
                      return /* @__PURE__ */ n(
                        Ea,
                        {
...
function So({
  ...
  return /* @__PURE__ */ m(Aa, { className: d(s), role: o, children: [
    /* @__PURE__ */ m(Da, { children: [
      /* @__PURE__ */ n(Pa, { variant: "icon", children: r ?? /* @__PURE__ */ n(Ne, {}) }),
      /* @__PURE__ */ n(Ba, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Oa, { children: /* @__PURE__ */ n(H, { onClick: () => a(), children: e }) })
  ] });
}
const Ma = Pt(({ className: t, ...e }, a) => /* @__PURE__ */ n(ve, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-B4e5BhTX.js
//# sourceMappingURL=resizable-B4e5BhTX.js.map
========
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-Dnp2Wyft.js
//# sourceMappingURL=resizable-Dnp2Wyft.js.map
========
//# sourceMappingURL=resizable-u_SwO6Mj.js.map
>>>>>>>> 32f33c498dd (fix: address review findings on draft durability and filter state):lib/platform-bible-react/dist/resizable-u_SwO6Mj.js
>>>>>>>> b26823a3880 (fix: address review findings on draft durability and filter state):lib/platform-bible-react/dist/resizable-u_SwO6Mj.js
