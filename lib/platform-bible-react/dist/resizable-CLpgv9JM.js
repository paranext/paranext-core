...
import G, { useState as X, useRef as xt, useCallback as K, createContext as we, useContext as me, useMemo as Q, useEffect as fe, Fragment as pe, forwardRef as Ot } from "react";
import { cva as W } from "class-variance-authority";
import { ChevronsUpDown as Bt, Check as Pt, Star as he, Settings2 as ge, ArrowRight as be, Loader2 as Ne, ChevronDown as ve, Search as xe, X as ye, AlertTriangle as ke, LoaderCircle as Ie } from "lucide-react";
import { Section as q, MODIFIER_KEYS as Se, normalizeProjectId as z, getLocalizeKeyForScrollGroupId as Ce, getSectionForBook as Ee } from "platform-bible-utils";
  ...
  return /* @__PURE__ */ f(Me, { children: [
    ...
    /* @__PURE__ */ f(
      J.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(J.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(de, {}),
...
function Nr({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ o(J.Close, { asChild: !0, children: /* @__PURE__ */ o(U, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
const Ar = Object.fromEntries(
  Je.map((t) => [t, A.bookIdToEnglishName(t)])
);
function Dr(t, e, a) {
...
const ea = ["input", "select", "textarea", "button"], aa = ["button", "textbox"], Xr = ({
  ...
  const n = xt(null), [s, i] = X(void 0), [l, c] = X(void 0), m = K(
    ...
    (u) => {
      var V;
      const b = u.target, g = (x) => x ? document.getElementById(x) : void 0, N = g(l), D = g(s);
      if (!!(N && b && N.contains(b) && b !== N) && v(b)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const j = x.findIndex((O) => O === b);
          if (j === -1) return;
          let C;
          u.key === "ArrowDown" ? C = Math.min(j + 1, x.length - 1) : C = Math.max(j - 1, 0), C !== j && (u.preventDefault(), u.stopPropagation(), (V = x[C]) == null || V.focus());
          return;
        }
        return;
      }
      ...
      switch (u.key) {
        case "ArrowDown":
          M = Math.min(P + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          M = Math.max(P - 1, 0), u.preventDefault();
          break;
        case "Home":
          M = 0, u.preventDefault();
          break;
        case "End":
          M = t.length - 1, u.preventDefault();
          break;
        case " ":
        case "Enter":
...
function wn({
  ...
  const [D, H] = X(!1), Y = K(
    (C) => {
      var B;
      const O = (B = t.find((F) => F.label === C)) == null ? void 0 : B.value;
      O && a(
    ...
    if (!S) return t;
    const C = t.filter((B) => B.starred).sort((B, F) => B.label.localeCompare(F.label)), O = t.filter((B) => !B.starred).sort((B, F) => {
      const lt = e.includes(B.value), Z = e.includes(F.value);
      return lt && !Z ? -1 : !lt && Z ? 1 : B.label.localeCompare(F.label);
    });
    return [...C, ...O];
  }, [t, e, S]), _ = () => {
    a(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ o("div", { id: N, className: b, children: /* @__PURE__ */ f(Jt, { open: x, onOpenChange: h ?? H, children: [
    ...
    /* @__PURE__ */ o(Wt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Ut, { children: [
      ...
      n && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: _, children: s }),
        /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: V, children: i })
      ] }),
      /* @__PURE__ */ f(Ht, { children: [
        /* @__PURE__ */ o(Vt, { children: l }),
        /* @__PURE__ */ o(Ft, { children: M.map((C) => /* @__PURE__ */ f(
          Kt,
          {
            value: C.label,
            onSelect: Y,
...
function mn(t, e, a) {
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (R(t), a.dismiss(), "ended") : (R(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (R(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (R(t), a.dismiss(), "ended") : t.key === "Backspace" || ee[r].test(t.key) ? (R(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && R(t), a.dismiss(), "ended");
}
function fn(t, e) {
  var a;
...
function Na(t) {
  ...
  return t.forEach((a) => {
    const r = z(a.projectId), n = e.get(r), s = {
...
function Gt(t, e, a) {
  const r = z(e);
  return t.some(
    (n) => z(n.projectId) === r && n.scrollGroupId === a
  );
}
function ft(t) {
  ...
  return t.projects.forEach((n) => {
    ...
    if (n.scrollGroupId === void 0 || r.some(
      (i) => z(i.projectId) === z(n.projectId) && i.scrollGroupId === n.scrollGroupId
    ))
      return;
    const s = t.projects.find(
      (i) => z(i.id) === z(n.projectId)
    );
    s && r.push({
...
function Dt(t, e) {
  if (!e)
    return [{ kind: "flat", rows: [...t].sort(L) }];
  const a = t.filter(At).sort(L), r = t.filter((s) => !At(s)).sort(L);
  if (a.length === 0)
...
function ka(t, e, a) {
  ...
  }), r.sort((i, l) => (l.lastUsedAt ?? 0) - (i.lastUsedAt ?? 0)), n.sort(L);
  const s = [];
...
function Sa(t, e) {
  let a = Lt.get(t);
  a || (a = /* @__PURE__ */ new Set(), Lt.set(t, a)), !a.has(e) && (a.add(e), console.warn(
    `ProjectSelector: duplicate custom section id "${e}" — matching is unaffected because each section buckets by its own \`match\`, but sections sharing an id collide as React keys, which can cause stale or misapplied rendering.`
  ));
}
function Ca(t, e, a, r) {
  if (e.length === 0)
  ...
  t.forEach((v) => {
    const S = i(z(v.projectId));
    S < 0 ? c.push(v) : l[S].push(v);
  });
  const m = (v, S) => {
    const { compare: u } = S;
    return u ? [...v].sort((b, g) => {
      const N = a.get(z(b.projectId)), D = a.get(z(g.projectId));
      if (!N || !D) return L(b, g);
      const H = u(N, D);
      return H !== 0 ? H : L(b, g);
    }) : [...v].sort(L);
...
function Ta(t) {
  const { filterAriaLabel: e, ...a } = t ?? {}, r = { ...Ea, ...a };
  return e && !a.viewOptionsAriaLabel && (r.viewOptionsAriaLabel = e), r;
}
function it(t) {
...
function Da({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: v
  } = qe(), [S, u] = X(!1), b = !!(t.language || t.languageCode), g = b || !!(t.typeName ?? t.type) || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = m || S, D = K(() => {
    if (g) {
      u(!0);
      return;
    }
  ...
  let P;
  e === "project" ? t.openGroups.length > 0 && (P = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((x) => /* @__PURE__ */ o(ct, { variant: "secondary", children: it(x) }, x)) })) : t.scrollGroupId !== void 0 && (P = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Aa,
      {
  ...
  const M = /* @__PURE__ */ f(
    Kt,
    {
      ...
      children: [
        ...
        (t.typeName ?? t.type) && /* @__PURE__ */ o("span", { className: "tw:sr-only", children: t.typeName ?? t.type }),
        P
      ]
    }
  ), _ = t.scrollGroupId !== void 0 ? it(t.scrollGroupId) : void 0, V = t.isBoundButClosed && _ ? a.boundButClosedTooltip.replace("{group}", _) : void 0;
  return /* @__PURE__ */ f(Zt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ o(qt, { asChild: !0, children: M }),
    /* @__PURE__ */ f(
      Yt,
      {
        side: "top",
        ...
        children: [
          ...
          (t.typeName ?? t.type) && /* @__PURE__ */ o("div", { className: "tw:text-sm", children: t.typeName ?? t.type }),
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && _ && /* @__PURE__ */ f("div", { className: "tw:text-sm", children: [
...
function bn(t) {
  ...
  const u = Ta(t.localizedStrings), b = Q(() => t.mode === "project" ? ft({
    ...
    () => new Map(t.projects.map((w) => [z(w.id), w])),
    [t.projects]
  ), { renderProjectIndicator: D } = t, H = K(
    (w) => {
      if (!D) return;
      const p = N.get(z(w.projectId));
      return p ? D(p) : void 0;
    },
    [D, N]
  ), {
    lastUsedRecentSectionHeading: Y,
    lastUsedOtherSectionHeading: P,
    languageUnknownSectionHeading: M,
    versificationUnknownSectionHeading: _,
    typeUnknownSectionHeading: V,
    customUnmatchedSectionHeading: x
  } = u, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Dt(g, !0);
  ...
  }, [t.mode, t.projects, t.openTabs]), O = (w) => {
  ...
  const ne = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? O : void 0, It = /* @__PURE__ */ f(
    U,
    {
      ...
      Wt,
      {
        ...
        children: /* @__PURE__ */ o(Ct, { delayDuration: 400, children: /* @__PURE__ */ f(Ut, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: F, children: `${u.selectAll} (${C.length.toString()})` }),
            /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: lt, children: `${u.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(Ht, { children: [
...
function Ua(t, e) {
  ...
  ].filter((r) => A.bookIdToNumber(r) > 0).sort((r, n) => A.bookIdToNumber(r) - A.bookIdToNumber(n)).map((r) => Ze(r, e));
}
function xn(t, e, a, r) {
...
function In({
  ...
  return /* @__PURE__ */ f($a, { className: d(s), role: n, children: [
    ...
    a && /* @__PURE__ */ o(Ja, { children: /* @__PURE__ */ o(U, { onClick: () => a(), children: e }) })
  ] });
}
...
//# sourceMappingURL=resizable-CLpgv9JM.js.map
