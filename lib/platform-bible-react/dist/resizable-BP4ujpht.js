...
import { Slot as Nt, Dialog as J, Popover as nt, Tooltip as et, Label as ie, RadioGroup as ht, ToggleGroup as Dt, Separator as le, DropdownMenu as E } from "radix-ui";
...
import j, { useState as X, useRef as _t, useCallback as K, createContext as we, useContext as pe, useMemo as Q, useEffect as me, Fragment as fe, forwardRef as Rt } from "react";
import { cva as W } from "class-variance-authority";
import { ChevronsUpDown as Lt, Check as Pt, Star as he, SlidersHorizontal as ge, ArrowRight as be, Loader2 as Ne, ChevronDown as ve, Search as _e, X as xe, AlertTriangle as ye, LoaderCircle as ke } from "lucide-react";
import { Section as Z, MODIFIER_KEYS as Ie, normalizeProjectId as F, getLocalizeKeyForScrollGroupId as Ce, getSectionForBook as Se } from "platform-bible-utils";
...
import { extendTailwindMerge as je, twMerge as Te } from "tailwind-merge";
...
function c(...t) {
  ...
  }), Te(o.join(" ")).split(" ").filter(Boolean).map((d) => {
    const p = r.get(d);
    return p ? Ae(d, p) : d;
  }).join(" ");
}
const De = 600, Vt = 650, cr = 400, Re = 450, Le = 500, Pe = 550, dr = 650, ur = 700, Ot = W(
...
function M({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: c(Ot({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
  ...
  return /* @__PURE__ */ m(Ve, { children: [
    ...
    /* @__PURE__ */ m(
      J.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(J.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ m(M, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ce, {}),
...
function $t({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ m(Be, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(Ue, { children: /* @__PURE__ */ n(de, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Tr = Object.fromEntries(
  Je.map((t) => [t, T.bookIdToEnglishName(t)])
);
function zr(t, e, a) {
...
function Zt({
  ...
  return /* @__PURE__ */ n(
    et.Trigger,
    {
      ...
      className: e ? c(Ot({ variant: e }), t) : t,
      ...a
    }
  );
}
...
const ea = ["input", "select", "textarea", "button"], aa = ["button", "textbox"], Jr = ({
  ...
  const o = _t(null), [s, i] = X(void 0), [l, d] = X(void 0), p = K(
    (u) => {
      i(u);
    ...
    (u) => {
      var U;
      const b = u.target, g = (_) => _ ? document.getElementById(_) : void 0, N = g(l), z = g(s);
      if (!!(N && b && N.contains(b) && b !== N) && v(b)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !b.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const _ = t.find((O) => O.id === l);
            _ && p(_.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const O = _.findIndex((D) => D === b);
          if (O === -1) return;
          let C;
          u.key === "ArrowDown" ? C = Math.min(O + 1, _.length - 1) : C = Math.max(O - 1, 0), C !== O && (u.preventDefault(), u.stopPropagation(), (U = _[C]) == null || U.focus());
          return;
        }
        return;
      }
      const L = t.findIndex((_) => _.id === s);
      let P = L;
      switch (u.key) {
        case "ArrowDown":
          P = Math.min(L + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          P = Math.max(L - 1, 0), u.preventDefault();
          break;
        case "Home":
...
function to({ className: t, children: e, ...a }) {
  const r = B();
  return /* @__PURE__ */ n(
    E.SubContent,
    {
...
function uo({
  ...
  const [z, $] = X(!1), Y = K(
    (C) => {
      var R;
      const D = (R = t.find((H) => H.label === C)) == null ? void 0 : R.value;
      D && a(
        e.includes(D) ? e.filter((H) => H !== D) : [...e, D]
      );
    },
    [t, e, a]
  ), L = () => d || r, P = Q(() => {
    if (!I) return t;
    const C = t.filter((R) => R.starred).sort((R, H) => R.label.localeCompare(H.label)), D = t.filter((R) => !R.starred).sort((R, H) => {
      const lt = e.includes(R.value), q = e.includes(H.value);
      return lt && !q ? -1 : !lt && q ? 1 : R.label.localeCompare(H.label);
    });
    return [...C, ...D];
  }, [t, e, I]), V = () => {
    a(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ n("div", { id: N, className: b, children: /* @__PURE__ */ m(Jt, { open: _, onOpenChange: h ?? $, children: [
    ...
    /* @__PURE__ */ n(Wt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Bt, { children: [
      /* @__PURE__ */ n(
        $t,
        {
      ...
      o && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(M, { variant: "ghost", size: "sm", onClick: V, children: s }),
        /* @__PURE__ */ n(M, { variant: "ghost", size: "sm", onClick: U, children: i })
      ] }),
      /* @__PURE__ */ m(Ut, { children: [
        /* @__PURE__ */ n(Ht, { children: l }),
        /* @__PURE__ */ n(Ft, { children: P.map((C) => /* @__PURE__ */ m(
          Kt,
          {
            value: C.label,
            onSelect: Y,
            ...
            children: [
              ...
              C.starred && /* @__PURE__ */ n(he, { className: "tw:h-4 tw:w-4" }),
...
function Gt(t, e) {
  if (!e)
    return [{ kind: "flat", rows: [...t].sort(G) }];
  const a = t.filter(zt).sort(G), r = t.filter((s) => !zt(s)).sort(G);
  if (a.length === 0)
...
function ya(t, e, a) {
  ...
  }), r.sort((i, l) => (l.lastUsedAt ?? 0) - (i.lastUsedAt ?? 0)), o.sort(G);
  const s = [];
...
function Ia(t) {
  At.has(t) || (At.add(t), console.warn(
...
function Ga({
  ...
  const {
    ...
    u(!1), v();
  }, [v]), Y = /* @__PURE__ */ n(Pt, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let L;
  e === "project" ? t.openGroups.length > 0 && (L = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((_) => /* @__PURE__ */ n(dt, { variant: "secondary", children: it(_) }, _)) })) : t.scrollGroupId !== void 0 && (L = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      za,
      {
    ...
    t.isBoundButClosed && o && /* @__PURE__ */ m(
      M,
      {
        ...
        "aria-label": a["%webView_project_selector_open_button_label%"],
        title: a["%webView_project_selector_open_button_label%"],
        children: [
          /* @__PURE__ */ n(be, { className: "tw:h-3 tw:w-3" }),
          a["%webView_project_selector_open_button_label%"]
        ]
      }
    )
  ] }));
  ...
  ), V = t.scrollGroupId !== void 0 ? it(t.scrollGroupId) : void 0, U = t.isBoundButClosed && V ? a["%webView_project_selector_bound_but_closed_tooltip%"].replace("{group}", V) : void 0;
  return /* @__PURE__ */ m(qt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ n(Zt, { asChild: !0, children: P }),
    /* @__PURE__ */ m(
      Yt,
      {
        side: "top",
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && V && /* @__PURE__ */ m("div", { className: "tw:text-sm", children: [
  ...
  return /* @__PURE__ */ m(oa, { children: [
    /* @__PURE__ */ n(na, { asChild: !0, children: /* @__PURE__ */ n(
      M,
      {
        ...
        "aria-label": i["%webView_project_selector_view_options_aria_label%"],
        "aria-pressed": l,
        title: i["%webView_project_selector_view_options_aria_label%"],
      ...
      sa,
      {
        ...
        children: [
          t.length > 0 && /* @__PURE__ */ m(ft, { children: [
            /* @__PURE__ */ n(Et, { children: i["%webView_project_selector_group_section_label%"] }),
            /* @__PURE__ */ m(
              la,
              {
                value: e,
                ...
                children: [
                  /* @__PURE__ */ n(St, { value: "none", children: i["%webView_project_selector_filter_group_none%"] }),
                  t.map((d) => /* @__PURE__ */ n(St, { value: d, children: Ra(d, i) }, d))
                ]
              }
            )
          ] }),
          s && /* @__PURE__ */ m(ft, { children: [
            ...
            /* @__PURE__ */ n(Et, { children: i["%webView_project_selector_filter_section_label%"] }),
            /* @__PURE__ */ n(
              ia,
              {
                checked: !!o,
                ...
                children: i["%webView_project_selector_filter_show_selected_only%"]
              }
            )
          ] })
        ]
...
function bo(t) {
  const [e, a] = X(!1), [r, o] = X(""), s = t.availableGroupings ?? ja, i = Aa(
    s,
    t.defaultGrouping,
    t.defaultGroupByOpenTabs
  ), [l, d] = X(i), [p, h] = X(!1), v = _t(null), I = K((w) => {
    a(w), w || o("");
  }, []);
  me(() => {
    if (!e) return;
  ...
  const u = Ea(t.localizedStrings), b = Q(() => t.mode === "project" ? mt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    )), t.mode === "project-multi" && p && (f = f.filter((x) => x.isSelected)), f;
  }, [b, r, t.mode, p]), N = Q(
    () => new Map(t.projects.map((w) => [F(w.id), w])),
    [t.projects]
  ), { renderProjectIndicator: z } = t, $ = K(
    (w) => {
      if (!z) return;
    ...
    [z, N]
  ), Y = u["%webView_project_selector_last_used_recent_section_heading%"], L = u["%webView_project_selector_last_used_other_section_heading%"], P = u["%webView_project_selector_language_unknown_section_heading%"], V = u["%webView_project_selector_versification_unknown_section_heading%"], U = u["%webView_project_selector_type_unknown_section_heading%"], _ = u["%webView_project_selector_custom_unmatched_section_heading%"], O = Q(() => {
    switch (l) {
      case "openTabs":
        return Gt(g, !0);
      case "lastUsed":
    ...
    return t.projects.forEach((f) => {
      ...
      x.forEach((y) => {
        S.has(y.scrollGroupId) || (S.add(y.scrollGroupId), w.push({ projectId: f.id, scrollGroupId: y.scrollGroupId }));
      });
    }), w;
  }, [t.mode, t.projects, t.openTabs]), D = (w) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const f = t.selection.pairs, x = (y) => y.projectId === w.projectId && y.scrollGroupId === w.scrollGroupId, S = f.some(x) ? f.filter((y) => !x(y)) : [...f, { projectId: w.projectId, scrollGroupId: w.scrollGroupId }];
        t.onChangeSelection({ pairs: S }), S.length === 0 && p && h(!1);
        return;
      }
    ...
    if (t.mode !== "project-multi") return;
    const w = t.selection.pairs, f = new Set(w.map((S) => `${S.projectId}:${S.scrollGroupId ?? ""}`)), x = [...w];
    C.forEach((S) => {
      const y = `${S.projectId}:${S.scrollGroupId ?? ""}`;
      f.has(y) || (f.add(y), x.push(S));
    ...
    switch (t.mode) {
      case "project": {
        const w = t.projects.find((x) => x.id === t.selection.projectId);
      ...
      case "project-multi": {
        ...
        const f = [];
        if (w.forEach((y) => {
          const rt = t.projects.find((se) => se.id === y.projectId);
          rt && f.push({ project: rt, scrollGroupId: y.scrollGroupId });
        }), f.length === 0) {
          const y = t.buttonPlaceholder ?? "";
          return { node: y, title: y };
        }
        if (t.getSelectedText) {
          const y = t.getSelectedText(f);
          return { node: y, title: y };
        }
        const x = f.map(
          ({ project: y, scrollGroupId: rt }) => rt === void 0 ? y.shortName : `${y.shortName} (${it(rt)})`
        ).join(", ");
        if (f.length === 1) return { node: x, title: x };
        const S = f.length.toString();
        return {
          node: /* @__PURE__ */ m(ft, { children: [
            /* @__PURE__ */ n(dt, { variant: "muted", className: "tw:shrink-0", children: S }),
      ...
      case "projectScrollGroup": {
        const w = t.projects.find((S) => S.id === t.selection.projectId);
        if (!w) {
  ...
  ), ne = q.title ? /* @__PURE__ */ n(Ct, { delayDuration: 400, children: /* @__PURE__ */ m(qt, { children: [
  ...
  return /* @__PURE__ */ m(Jt, { open: e, onOpenChange: I, children: [
    ...
    /* @__PURE__ */ n(
      Wt,
      {
        ...
        children: /* @__PURE__ */ n(Ct, { delayDuration: 400, children: /* @__PURE__ */ m(Bt, { shouldFilter: !1, children: [
          /* @__PURE__ */ m("div", { className: "tw:flex tw:items-center tw:border-b tw:pe-2", children: [
            /* @__PURE__ */ n("div", { className: "tw:flex-1", children: /* @__PURE__ */ n(
              $t,
              {
                value: r,
                onValueChange: o,
                placeholder: u["%webView_project_selector_search_placeholder%"],
          ...
          t.mode === "project-multi" && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(M, { variant: "ghost", size: "sm", onClick: H, children: `${u["%webView_project_selector_select_all%"]} (${C.length.toString()})` }),
            /* @__PURE__ */ n(M, { variant: "ghost", size: "sm", onClick: lt, children: `${u["%webView_project_selector_clear_all%"]} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ m(Ut, { children: [
            /* @__PURE__ */ n(Ht, { children: t.commandEmptyMessage ?? "No projects found" }),
            O.map((w, f) => (
              ...
              /* @__PURE__ */ m(fe, { children: [
                /* @__PURE__ */ n(Ft, { heading: Pa(w, u), children: w.rows.map((x) => /* @__PURE__ */ n(
                  Ga,
                  {
                    row: x,
                    mode: t.mode,
...
function Ba(t, e) {
  ...
  ].filter((r) => T.bookIdToNumber(r) > 0).sort((r, o) => T.bookIdToNumber(r) - T.bookIdToNumber(o)).map((r) => qe(r, e));
}
function _o(t, e, a, r) {
...
function ko({
  ...
  return /* @__PURE__ */ m($a, { className: c(s), role: o, children: [
    /* @__PURE__ */ m(Ua, { children: [
      /* @__PURE__ */ n(Fa, { variant: "icon", children: r ?? /* @__PURE__ */ n(ye, {}) }),
      /* @__PURE__ */ n(Ka, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ja, { children: /* @__PURE__ */ n(M, { onClick: () => a(), children: e }) })
  ] });
}
const Xa = Rt(({ className: t, ...e }, a) => /* @__PURE__ */ n(ke, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BP4ujpht.js.map
