...
function bn(t) {
  ...
  const u = Ta(t.localizedStrings), b = Q(() => t.mode === "project" ? pt({
    ...
    [A, N]
  ), { lastUsedRecentSectionHeading: Y } = u, { lastUsedOtherSectionHeading: B } = u, { languageUnknownSectionHeading: P } = u, { versificationUnknownSectionHeading: M } = u, { typeUnknownSectionHeading: H } = u, { customUnmatchedSectionHeading: x } = u, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Rt(g, !0);
      case "lastUsed":
...
function In({
  ...
  return /* @__PURE__ */ m(Ha, { className: d(s), role: n, children: [
    ...
    a && /* @__PURE__ */ o(Xa, { children: /* @__PURE__ */ o(_, { onClick: () => a(), children: e }) })
  ] });
}
...
//# sourceMappingURL=resizable-DGEsQHep.js.map
