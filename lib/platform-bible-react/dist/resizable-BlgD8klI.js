...
import { Slot as Nt, Dialog as J, Popover as ot, Tooltip as et, Label as le, RadioGroup as ht, ToggleGroup as Bt, Separator as de, DropdownMenu as T } from "radix-ui";
...
import { Section as Z, MODIFIER_KEYS as Ce, normalizeProjectId as F, compareProjectsByName as Ee, formatProjectName as Te, getLocalizeKeyForScrollGroupId as ze, hasDistinctFullName as Ge, getSectionForBook as Ae } from "platform-bible-utils";
...
const Me = 600, _t = 650, mr = 400, je = 450, _e = 500, Ue = 550, fr = 650, pr = 700, Ut = W(
...
function Vt({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ m(Fe, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ o(Je, { children: /* @__PURE__ */ o(ue, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function hn(t, e, a) {
  ...
  if (ba(t) || Ce.has(t.key) || t.key === "Dead")
    return "passed";
...
const Da = "platform.footerAction", ne = [
  "openTabs",
  "lastUsed",
  "language",
  "versification",
        ...
        /* @__PURE__ */ m(
          "span",
          {
            ...
            children: [
              ...
              Ge(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        B
  ...
  return /* @__PURE__ */ m(Zt, { open: N, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ m(
      Qt,
      {
        ...
        style: { zIndex: _t },
        children: [
          /* @__PURE__ */ o("div", { className: "tw:font-semibold", children: t.fullName ?? t.shortName }),
            ...
            /* @__PURE__ */ m(
              ua,
              {
                ...
                children: [
                  ...
                  t.map((c) => /* @__PURE__ */ o(zt, { value: c, children: ja(c, i) }, c))
                ]
              }
            )
          ] }),
  ...
  const u = Aa(t.localizedStrings), b = Q(() => t.mode === "project" ? pt({
    ...
    switch (t.mode) {
      case "project": {
        ...
        return w && t.triggerLabelFormat === "shortNameAndFullName" && (p = Te(w)), { node: p, title: p };
      }
      case "project-multi": {
          ...
          /* @__PURE__ */ m(Ft, { children: [
            ...
            j.map((w, p) => (
              ...
              /* @__PURE__ */ m(he, { children: [
                /* @__PURE__ */ o(Jt, { heading: Ua(w, u), children: w.rows.map((y) => /* @__PURE__ */ o(
                  Ba,
                  {
                    row: y,
                    mode: t.mode,
...
function En({
  ...
  return /* @__PURE__ */ m(Ka, { className: d(s), role: n, children: [
    /* @__PURE__ */ m(Ja, { children: [
      /* @__PURE__ */ o(Wa, { variant: "icon", children: r ?? /* @__PURE__ */ o(Ie, {}) }),
      /* @__PURE__ */ o(qa, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Za, { children: /* @__PURE__ */ o(_, { onClick: () => a(), children: e }) })
  ] });
}
const Ya = Ot(({ className: t, ...e }, a) => /* @__PURE__ */ o(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BlgD8klI.js.map
