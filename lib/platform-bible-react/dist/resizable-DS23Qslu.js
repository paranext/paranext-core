...
import { Slot as xt, Dialog as V, Separator as ie, Popover as st, Tooltip as at, DropdownMenu as E, Label as le, RadioGroup as gt, ToggleGroup as Mt } from "radix-ui";
...
import C, { useState as J, useRef as ut, useCallback as F, createContext as we, useContext as pe, useMemo as Y, useEffect as zt, Fragment as me, forwardRef as Ht } from "react";
import { ChevronsUpDown as Ut, Check as $t, Star as fe, Group as he, ArrowRight as ge, Loader2 as be, ChevronDown as Ne, Search as ve, X as xe, AlertTriangle as ye, LoaderCircle as Se } from "lucide-react";
import { Section as W, MODIFIER_KEYS as ke, normalizeProjectId as Q, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as ot, getLocalizeKeyForScrollGroupId as Ie, getSectionForBook as Ee } from "platform-bible-utils";
...
function l(...t) {
  ...
  }), Ce(o.join(" ")).split(" ").filter(Boolean).map((w) => {
    const p = r.get(w);
    return p ? ze(w, p) : w;
  }).join(" ");
}
const Kt = 600, Ft = 650, or = 400, Le = 450, Ae = 500, Re = 675, nr = 690, sr = 700, ir = 800, Vt = X(
...
function U({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: l(Vt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
  ...
  return /* @__PURE__ */ f(De, { children: [
    ...
    /* @__PURE__ */ f(
      V.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(V.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(de, {}),
...
function mr({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(V.Close, { asChild: !0, children: /* @__PURE__ */ n(U, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Wt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(Be, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        tt.Input,
        {
...
function _t({
  ...
  return /* @__PURE__ */ n(
    at.Trigger,
    {
      ...
      className: e ? l(Vt({ variant: e }), t) : t,
      ...a
    }
  );
}
...
function Ye({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(ae.Provider, { value: r, children: /* @__PURE__ */ n(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Or({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(E.ItemIndicator, { children: /* @__PURE__ */ n(yt, {}) })
          }
        ),
        e
      ]
...
const na = ["input", "select", "textarea", "button"], sa = ["button", "textbox"], Yr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = ut(null), [s, i] = J(void 0), [c, w] = J(void 0), p = F(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(N && g && N.contains(g) && g !== N) && b(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const j = S.findIndex((D) => D === g);
          if (j === -1) return;
          let k;
          u.key === "ArrowDown" ? k = Math.min(j + 1, S.length - 1) : k = Math.max(j - 1, 0), k !== j && (u.preventDefault(), u.stopPropagation(), (q = S[k]) == null || q.focus());
          return;
        }
        return;
      }
...
function lo({
  ...
  const [H, $] = J(!1), et = F(
    (k) => {
      var P;
      const D = (P = t.find((K) => K.label === k)) == null ? void 0 : P.value;
      D && a(
        e.includes(D) ? e.filter((K) => K !== D) : [...e, D]
      );
    },
    [t, e, a]
  ), B = () => w || r, _ = Y(() => {
    if (!I) return t;
    const k = t.filter((P) => P.starred).sort((P, K) => P.label.localeCompare(K.label)), D = t.filter((P) => !P.starred).sort((P, K) => {
      const d = e.includes(P.value), h = e.includes(K.value);
      return d && !h ? -1 : !d && h ? 1 : P.label.localeCompare(K.label);
    });
    return [...k, ...D];
  }, [t, e, I]), R = () => {
    a(t.map((k) => k.value));
  ...
  return /* @__PURE__ */ n("div", { id: N, className: g, children: /* @__PURE__ */ f(Qt, { open: S, onOpenChange: m ?? $, children: [
    ...
    /* @__PURE__ */ n(ee, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Xt, { children: [
      /* @__PURE__ */ n(
        Wt,
        {
        ...
        /* @__PURE__ */ n(Yt, { children: _.map((k) => /* @__PURE__ */ f(
          kt,
          {
            ...
            children: [
              ...
              k.starred && /* @__PURE__ */ n(fe, { className: "tw:h-4 tw:w-4" }),
...
function co(t, e, a) {
  ...
  if (wa(t) || ke.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (O(t), a.dismiss(), "ended") : (O(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (O(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (O(t), a.dismiss(), "ended") : t.key === "Backspace" || oe[r].test(t.key) ? (O(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && O(t), a.dismiss(), "ended");
}
function uo(t, e) {
  var a;
...
const Ct = "Selected", Gt = "Unselected";
function Bt(t) {
...
function ga(t) {
  const e = t.filter(Bt).sort(Z), a = t.filter((o) => !Bt(o)).sort(Z);
  if (e.length === 0)
...
function ba(t, e) {
  const a = t.filter((i) => i.isSelected).sort(Z), r = t.filter((i) => !i.isSelected).sort(Z), o = (i, c) => {
    ...
    return typeof w == "string" && w.length > 0 ? w : i === "selected" ? Ct : Gt;
  }, s = [];
...
function Na(t, e) {
  ...
  const c = [...a.entries()].map(([p, m]) => {
    var u;
    const b = s(m), I = ((u = e.getSectionHeading) == null ? void 0 : u.call(
      e,
      p,
      b.map((g) => g.project)
    )) ?? p;
    return { key: p, heading: I, rows: b };
  });
...
function xa(t) {
  ...
  return [
    ne(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[ot.lastUsedAt]) == "number" ? dt : va;
      },
...
function ya(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? Ct : e.unselectedSectionHeading ?? Gt
  };
}
function go(t) {
  return {
...
const Ea = "platform.footerAction", _a = {
...
function Ca({
  ...
  const {
    ...
    onPointerEnter: p,
    onPointerLeave: m
  } = qe(), [b, I] = J(!1), u = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, g = w || b, x = F(() => {
    if (u) {
      I(!0);
      return;
    }
    ...
    I(!1), m();
  }, [m]), H = /* @__PURE__ */ n($t, { className: l("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let $;
  e === "project" ? t.openGroups.length > 0 && ($ = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ n(wt, { variant: "secondary", children: lt(R) }, R)) })) : t.scrollGroupId !== void 0 && ($ = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Ta,
      {
  ...
  return /* @__PURE__ */ f(Et, { open: g, delayDuration: 400, children: [
    /* @__PURE__ */ n(_t, { asChild: !0, children: et }),
    /* @__PURE__ */ f(
      Tt,
      {
        side: "top",
...
function Ga({
  ...
  return /* @__PURE__ */ f(Ye, { children: [
    /* @__PURE__ */ f(Et, { children: [
      /* @__PURE__ */ n(_t, { asChild: !0, children: /* @__PURE__ */ n(Qe, { asChild: !0, children: /* @__PURE__ */ n(
        U,
        {
          variant: "ghost",
          size: "sm",
...
function vo(t) {
  const [e, a] = J(!1), [r, o] = J(""), s = Ia(t.localizedStrings), i = Y(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const d = [];
    return t.openTabs.length > 0 && d.push(ne(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && d.push(
      ya({
  ...
  const u = Y(() => t.mode === "project" ? ht({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const h = t.selection.pairs, T = Q(d.projectId), z = (A) => Q(A.projectId) === T && A.scrollGroupId === d.scrollGroupId, L = h.some(z) ? h.filter((A) => !z(A)) : [
          ...h.filter((A) => !z(A)),
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const h = [];
        if (d.forEach((L) => {
          const A = t.projects.find((se) => se.id === L.projectId);
        ...
        ).join(", "), z = h.length.toString();
        return {
          node: /* @__PURE__ */ f(jt, { children: [
            /* @__PURE__ */ n(wt, { variant: "muted", className: "tw:shrink-0", children: z }),
      ...
      case "projectScrollGroup": {
        const d = t.projects.find((z) => z.id === t.selection.projectId);
        if (!d) {
  ...
  }, [t, s.buttonPlaceholder]), R = ut(null), [q, S] = J(!1);
  zt(() => {
    const d = R.current;
    if (!d) return;
    const h = (z) => {
  ...
  let j;
  t.isLoading ? j = /* @__PURE__ */ n(be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : q ? j = void 0 : t.mode === "project-multi" ? j = /* @__PURE__ */ n(Ut, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : j = /* @__PURE__ */ n(Ne, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const k = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? $ : void 0, D = /* @__PURE__ */ f(
    U,
    {
      ref: R,
  ...
  ), P = _.title ? /* @__PURE__ */ n(Dt, { delayDuration: 400, children: /* @__PURE__ */ f(Et, { children: [
    /* @__PURE__ */ n(_t, { asChild: !0, children: /* @__PURE__ */ n(Nt, { asChild: !0, children: D }) }),
    /* @__PURE__ */ n(Tt, { children: _.title })
  ] }) }) : /* @__PURE__ */ n(Nt, { asChild: !0, children: D }), K = i.length > 1;
  return /* @__PURE__ */ f(Qt, { open: e, onOpenChange: I, children: [
    P,
    /* @__PURE__ */ n(
      ee,
      {
        ...
        children: /* @__PURE__ */ n(Dt, { delayDuration: 400, children: /* @__PURE__ */ f(Xt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ f(Zt, { children: [
            ...
            H.map((d, h) => (
              ...
              /* @__PURE__ */ f(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Yt, { heading: za(d, s), children: d.rows.map((T) => /* @__PURE__ */ n(
                      Ca,
                      {
                        row: T,
                        mode: t.mode,
                    ...
                    h < H.length - 1 && /* @__PURE__ */ n(At, {})
                  ]
                },
                `${d.kind}:${d.groupingId ?? ""}:${d.key ?? d.label ?? ""}`
              )
            )),
            t.footerAction && /* @__PURE__ */ f(jt, { children: [
...
function Da(t, e) {
  ...
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, o) => G.bookIdToNumber(r) - G.bookIdToNumber(o)).map((r) => Je(r, e));
}
function So(t, e, a, r) {
...
function Eo({
  ...
  return /* @__PURE__ */ f(Oa, { className: l(s), role: o, children: [
    /* @__PURE__ */ f(Pa, { children: [
      /* @__PURE__ */ n(Ma, { variant: "icon", children: r ?? /* @__PURE__ */ n(ye, {}) }),
      /* @__PURE__ */ n(Ha, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ua, { children: /* @__PURE__ */ n(U, { onClick: () => a(), children: e }) })
  ] });
}
const $a = Ht(({ className: t, ...e }, a) => /* @__PURE__ */ n(Se, { size: 35, className: l("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DS23Qslu.js.map
