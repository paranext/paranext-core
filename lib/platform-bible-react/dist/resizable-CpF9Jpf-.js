...
import { Slot as jt, Dialog as Y, Separator as Le, Popover as mt, Tooltip as ct, DropdownMenu as k, Label as Ae, RadioGroup as _t, ToggleGroup as ee } from "radix-ui";
import { IconX as ze, IconCheck as Rt, IconSearch as Ge, IconChevronRight as je } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as at } from "class-variance-authority";
import C, { createContext as ae, useContext as oe, useState as H, useRef as ft, useCallback as X, useEffect as Ct, useMemo as et, Fragment as Re, forwardRef as re } from "react";
...
import { Section as rt, MODIFIER_KEYS as Ke, normalizeProjectId as D, compareProjectsByName as Ve, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as wt, formatProjectName as ie, getLocalizeKeyForScrollGroupId as Je, hasDistinctFullName as Xe, getSectionForBook as Ze } from "platform-bible-utils";
...
function Z({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(de({ variant: e, size: a, className: t })),
      ...r
    }
  );
}
  ...
  return /* @__PURE__ */ p(na, { children: [
    ...
    /* @__PURE__ */ p(
      Y.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(Y.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(Z, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ze, {}),
...
function Vo({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(Y.Close, { asChild: !0, children: /* @__PURE__ */ n(Z, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function me({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ p(la, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(da, { children: /* @__PURE__ */ n(Ge, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Ne({ ...t }) {
  return /* @__PURE__ */ n(mt.Root, { "data-slot": "popover", ...t });
}
function zt({ ...t }) {
  return /* @__PURE__ */ n(mt.Trigger, { "data-slot": "popover-trigger", ...t });
}
...
function Se({
  ...
  return (
    ...
    /* @__PURE__ */ n(mt.Portal, { container: i ?? void 0, children: /* @__PURE__ */ n(
      mt.Content,
      {
...
function vr({ ...t }) {
  return /* @__PURE__ */ n(mt.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
function Ht({ ...t }) {
  return /* @__PURE__ */ n(ct.Root, { "data-slot": "tooltip", ...t });
}
function Ut({
  className: t,
  variant: e,
  ...
  return /* @__PURE__ */ n(
    ct.Trigger,
    {
      ...
      className: e ? d(de({ variant: e }), t) : t,
      ...a
    }
  );
}
function $t({
  ...
  const l = Bt();
  return /* @__PURE__ */ n(ct.Portal, { children: /* @__PURE__ */ p(
    ct.Content,
    {
...
function Ea({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Ie.Provider, { value: o, children: /* @__PURE__ */ n(k.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function yr({
  ...t
}) {
  return /* @__PURE__ */ n(k.Portal, { "data-slot": "dropdown-menu-portal", ...t });
}
function Ta({
  ...t
}) {
  return /* @__PURE__ */ n(k.Trigger, { "data-slot": "dropdown-menu-trigger", ...t });
}
...
function Ca({
  ...
  const i = $(), l = Bt();
  return /* @__PURE__ */ n(k.Portal, { children: /* @__PURE__ */ n(
    k.Content,
    {
...
function Ir({ ...t }) {
  return /* @__PURE__ */ n(k.Group, { "data-slot": "dropdown-menu-group", ...t });
}
function kr({
  className: t,
  inset: e,
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(k.ItemIndicator, { children: /* @__PURE__ */ n(Rt, {}) })
          }
        ),
        e
      ]
...
function La({
  ...
  return /* @__PURE__ */ n(k.RadioGroup, { "data-slot": "dropdown-menu-radio-group", ...t });
}
function qt({
  className: t,
  children: e,
...
function _r({ ...t }) {
  return /* @__PURE__ */ n(k.Sub, { "data-slot": "dropdown-menu-sub", ...t });
}
function Cr({
  className: t,
  inset: e,
  ...
  return /* @__PURE__ */ p(
    k.SubTrigger,
    {
      ...
      className: d(
        ...
        t,
        // CUSTOM: Apply variant-driven styles from menu context
        Et({ variant: r.variant })
      ),
      ...o,
      children: [
        a,
        /* @__PURE__ */ n(je, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const ja = ["input", "select", "textarea", "button"], Ra = ["button", "textbox"], Dr = ({
  ...
  const r = ft(null), [s, i] = H(void 0), [l, u] = H(void 0), m = X(
    (w) => {
      i(w);
    ...
    (w) => {
      ...
      const Q = t.findIndex((x) => x.id === s);
      let A = Q;
      switch (w.key) {
        case "ArrowDown":
          A = Math.min(Q + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          A = Math.max(Q - 1, 0), w.preventDefault();
          break;
        case "Home":
  ...
  C.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        ht(i, '[tabindex]:not([tabindex="-1"])').forEach((f) => {
    ...
    const a = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const r = t.current ? ht(t.current) : [], s = r.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
function Xr({
  ...
  const [V, Q] = H(!1), A = ft(null), tt = X(
    (E) => {
      var B;
      const O = (B = t.find((q) => q.label === E)) == null ? void 0 : B.value;
      O && a(
        e.includes(O) ? e.filter((q) => q !== O) : [...e, O]
      );
    },
    [t, e, a]
  ), R = () => m || o, x = f ?? V, U = y ?? Q, [W, ot] = H(x), [nt, lt] = H(e);
  W !== x && (ot(x), x && lt(e));
  const J = et(() => {
    if (!w) return t;
    const E = t.filter((B) => B.starred).sort((B, q) => B.label.localeCompare(q.label)), O = t.filter((B) => !B.starred).sort((B, q) => {
      const ut = nt.includes(B.value), Nt = nt.includes(q.value);
      return ut && !Nt ? -1 : !ut && Nt ? 1 : B.label.localeCompare(q.label);
    });
    return [...E, ...O];
  }, [t, nt, w]), bt = () => {
    const E = t.map((O) => O.value);
    lt(E), a(E);
  }, vt = () => {
    lt([]), a([]);
  };
  return /* @__PURE__ */ n("div", { id: K, className: h, children: /* @__PURE__ */ p(Ne, { open: x, onOpenChange: U, children: [
    ...
    /* @__PURE__ */ n(Se, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(pe, { children: [
      ...
      s && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(Z, { variant: "ghost", size: "sm", onClick: bt, children: i }),
        /* @__PURE__ */ n(Z, { variant: "ghost", size: "sm", onClick: vt, children: l })
      ] }),
      /* @__PURE__ */ n(Ha, { isEnabled: g, scrollerRef: A, children: /* @__PURE__ */ p(fe, { ref: A, children: [
        /* @__PURE__ */ n(he, { children: u }),
        /* @__PURE__ */ n(ge, { children: J.map((E) => /* @__PURE__ */ p(
          Pt,
          {
            value: E.label,
            onSelect: tt,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ n(Oe, { className: "tw:h-4 tw:w-4" }),
...
function Ua(t, e, a) {
  if (!e) return [...t];
  const o = [...t], r = pt(e).toLowerCase();
  return a === "passive" ? Vt({
    query: r,
    items: o,
    filter: (s) => pt(s.label).toLowerCase().startsWith(r),
    sortBy: "label"
  }) : Vt({
    query: r,
    items: o,
    filter: (s) => pt(s.label).toLowerCase().includes(r),
    sortBy: "label"
  });
}
function $a(t) {
...
function Zr(t, e, a) {
  ...
  if (t.key === " ") {
    ...
    P(t);
    const i = pt(e.filter).toLowerCase(), l = e.items.find(
      (u) => pt(u.marker).toLowerCase() === i
    );
    return l && a.commitItem(l.marker), a.dismiss(), "ended";
  }
  return t.key === "*" ? o === "selection" && e.filter === "" ? (P(t), a.dismiss(), "ended") : (P(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (P(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (P(t), a.dismiss(), "ended") : t.key === "Backspace" || Ee[o].test(t.key) ? (P(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && P(t), a.dismiss(), "ended");
}
function Wr(t, e) {
  var a;
...
function Gt(t) {
  return [{ kind: "flat", rows: [...t].sort(st) }];
}
function Xa(t) {
  const e = t.filter(Qt).sort(st), a = t.filter((r) => !Qt(r)).sort(st);
  if (e.length === 0)
...
function Za(t, e) {
  const a = t.filter((i) => i.isSelected).sort(st), o = t.filter((i) => !i.isSelected).sort(st), r = (i, l) => {
    var m;
...
function Wa(t, e) {
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const m = [...u].sort(
      (I, w) => {
        var g;
        return ((g = e.compareProjects) == null ? void 0 : g.call(e, I.project, w.project)) || st(I, w);
      }
...
function Ya(t) {
  ...
  return [
    Te(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[wt.lastUsedAt]) == "number" ? xt : qa;
      },
      getSectionHeading: (a) => a === xt ? e.lastUsedRecentSectionHeading ?? "Recently used" : e.lastUsedOtherSectionHeading ?? "Other",
      ...
      compareSections: (a, o) => a.key === xt ? -1 : o.key === xt ? 1 : 0
    },
    {
      id: "language",
      ...
      getGroupKey: (a) => {
        var r;
        const o = (r = a.customData) == null ? void 0 : r[wt.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var r;
        const o = (r = a.customData) == null ? void 0 : r[wt.type];
        return typeof o == "string" ? o : void 0;
      },
      ...
      getSectionHeading: (a, o) => {
        ...
        const r = o.find(
          (l) => {
            var u;
            return typeof ((u = l.customData) == null ? void 0 : u[wt.typeName]) == "string";
          }
        ), s = (i = r == null ? void 0 : r.customData) == null ? void 0 : i[wt.typeName];
...
function ro({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: y
  } = ka(), [I, w] = H(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || I, h = X(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), y();
  }, [y]), K = /* @__PURE__ */ n(se, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let V;
  e === "project" ? t.openGroups.length > 0 && (V = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ n(yt, { variant: "secondary", children: gt(R) }, R)) })) : t.scrollGroupId !== void 0 && (V = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      oo,
      {
  ...
  ), A = t.scrollGroupId !== void 0 ? gt(t.scrollGroupId) : void 0, tt = t.isBoundButClosed && A ? a.boundButClosedTooltip.replace("{group}", A) : void 0;
  return /* @__PURE__ */ p(Ht, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(Ut, { asChild: !0, children: Q }),
    /* @__PURE__ */ p(
      $t,
      {
        side: "top",
        ...
        children: [
          ...
          tt && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: tt }),
      ...
      Ca,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ p(La, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(qt, { value: dt, children: o.groupByNone }),
            /* @__PURE__ */ n(za, {}),
...
function so(t, e) {
  ...
  return t.some((a) => a.id === "openTabs") ? "openTabs" : dt;
}
function nn(t) {
  const [e, a] = H(!1), [o, r] = H(""), s = et(() => eo(t.localizedStrings), [t.localizedStrings]), i = et(() => {
    ...
    const c = [];
    return t.openTabs.length > 0 && c.push(Te(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      Qa({
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, y = ft(null), [I, w] = H(void 0), g = X((c) => {
    a(c), c || (r(""), w(void 0));
  }, []);
  Ct(() => {
    if (!e) return;
  ...
  const v = et(() => t.mode === "project" ? Tt({
    ...
    () => new Map(t.projects.map((c) => [D(c.id), c])),
    [t.projects]
  ), K = X(
    (c) => c === void 0 ? void 0 : F.get(D(c)),
    [F]
  ), { renderProjectIndicator: V } = t, Q = X(
    (c) => V ? V(c.project) : void 0,
    [V]
  ), A = !!V, tt = !!t.footerAction && h.length === 0, R = et(() => {
    if (f === dt) return Gt(h);
    const c = i.find((b) => b.id === f);
    return c ? Wa(h, c) : Gt(h);
  }, [h, f, i]), x = (c) => {
    if (c && t.shouldRunFooterActionWhenEmpty && t.footerAction && v.length === 0) {
      t.footerAction.onSelect();
      return;
    }
    g(c);
  }, U = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, z = D(c.projectId), M = (j) => D(j.projectId) === z && j.scrollGroupId === c.scrollGroupId, G = b.some(M) ? b.filter((j) => !M(j)) : [
          ...b.filter((j) => !M(j)),
  ...
  }, nt = t.mode === "project" ? t.renderTriggerLabel : void 0, lt = t.mode === "project" ? t.triggerLabelFormat : void 0, J = et(() => {
    switch (t.mode) {
      case "project": {
        const c = K(t.selection.projectId);
        if (nt)
          return { node: nt(c), title: "", hasSelection: !!c };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && lt === "shortNameAndFullName" && (b = ie(c)), { node: b, title: b, hasSelection: !!c };
      }
      case "project-multi": {
        ...
        const z = b.map(
          ({ project: G, scrollGroupId: j }) => j === void 0 ? G.shortName : `${G.shortName} (${gt(j)})`
  ...
  Ct(() => {
    ...
    return z.observe(c, { box: "border-box" }), () => z.disconnect();
  }, []);
  let O;
  t.isLoading ? O = /* @__PURE__ */ n(Be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : vt ? O = void 0 : t.mode === "project-multi" ? O = /* @__PURE__ */ n(ne, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : O = /* @__PURE__ */ n(Me, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const B = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? U : void 0, q = s.ariaLabel && J.hasSelection && J.title ? `${s.ariaLabel}: ${J.accessibleTitle ?? J.title}` : s.ariaLabel || void 0, ut = /* @__PURE__ */ p(
    Z,
    {
      ref: bt,
      ...
      className: d(
        ...
        // wide case.
        vt && "tw:px-0.5 tw:text-xs",
        t.buttonClassName
      ),
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof J.node == "string" ? /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", dir: "auto", children: J.node }) : J.node }),
        O
      ]
    }
  ), Nt = J.title ? /* @__PURE__ */ n(Wt, { delayDuration: 400, children: /* @__PURE__ */ p(Ht, { children: [
    /* @__PURE__ */ n(Ut, { asChild: !0, children: /* @__PURE__ */ n(zt, { asChild: !0, children: ut }) }),
    /* @__PURE__ */ n($t, { dir: "auto", children: J.title })
  ] }) }) : /* @__PURE__ */ n(zt, { asChild: !0, children: ut }), _e = i.length > 1;
  return /* @__PURE__ */ p(Ne, { open: e, onOpenChange: x, children: [
    Nt,
    /* @__PURE__ */ n(
      Se,
      {
        ...
        children: /* @__PURE__ */ n(Wt, { delayDuration: 400, children: /* @__PURE__ */ p(
          pe,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(Z, { variant: "ghost", size: "sm", onClick: ot, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(fe, { children: [
                ...
                R.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(ge, { heading: io(c, s), children: c.rows.map((z) => /* @__PURE__ */ n(
                          ro,
                          {
                            row: z,
                            mode: t.mode,
...
function wn({
  ...
  return /* @__PURE__ */ p(po, { className: d(s), role: r, children: [
...
const vo = re(({ className: t, ...e }, a) => /* @__PURE__ */ n(Fe, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CpF9Jpf-.js.map
