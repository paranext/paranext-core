...
export declare function getPreviousChapterRef(scrRef: SerializedVerseRef, availableBooks: string[]): SerializedVerseRef | undefined;
/** Next chapter (verse 1), rolling into the next book's chapter 1 at the last chapter. */
export declare function getNextChapterRef(scrRef: SerializedVerseRef, availableBooks: string[]): SerializedVerseRef | undefined;
...
export declare function getPreviousVerseRef(scrRef: SerializedVerseRef): SerializedVerseRef;
/** Next verse in the same chapter (no upper bound). */
export declare function getNextVerseRef(scrRef: SerializedVerseRef): SerializedVerseRef;
