...
`)),b!==null&&xe<b){const Ne=xe-b;xe-=Ne,ie.horizontal+=Ne}else if(je>at){const Ne=je-at;xe-=Ne,ie.horizontal+=Ne}return{top:`${Math.round(Pe)}px`,left:`${Math.round(xe)}px`,transformOrigin:is(ie)}},[c,v,U,Z,b]),[R,B]=N.useState(x),H=N.useCallback(()=>{const te=$.current;if(!te)return;const I=X(te);I.top!==null&&(te.style.top=I.top),I.left!==null&&(te.style.left=I.left),te.style.transformOrigin=I.transformOrigin,B(!0)},[X]);N.useEffect(()=>(A&&window.addEventListener("scroll",H),()=>window.removeEventListener("scroll",H)),[c,A,H]);const J=(te,I)=>{_&&_(te,I),H()},G=()=>{B(!1)};N.useEffect(()=>{x&&H()}),N.useImperativeHandle(l,()=>x?{updatePosition:()=>{H()}}:null,[x,H]),N.useEffect(()=>{if(!x)return;const te=Zs(()=>{H()}),I=en(c);return I.addEventListener("resize",te),()=>{te.clear(),I.removeEventListener("resize",te)}},[c,x,H]);let q=S;S==="auto"&&!C.muiSupportAuto&&(q=void 0);const Y=h||(c?Oe(ir(c)).body:void 0),K=(o=w==null?void 0:w.root)!=null?o:$h,W=(a=w==null?void 0:w.paper)!=null?a:Yi,Q=Dt({elementType:W,externalSlotProps:j({},O,{style:R?O.style:j({},O.style,{opacity:0})}),additionalProps:{elevation:d,ref:z},ownerState:D,className:Ce(M.paper,O==null?void 0:O.className)}),ee=Dt({elementType:K,externalSlotProps:(k==null?void 0:k.root)||{},externalForwardedProps:E,additionalProps:{ref:n,slotProps:{backdrop:{invisible:!0}},container:Y,open:x},ownerState:D,className:Ce(M.root,u)}),{slotProps:se}=ee,L=he(ee,Ph);return p.jsx(K,j({},L,!ci(K)&&{slotProps:se,disableScrollLock:A},{children:p.jsx(C,j({appear:!0,in:x,onEntering:J,onExited:G,timeout:q},V,{children:p.jsx(W,j({},Q,{children:g}))}))}))});process.env.NODE_ENV!=="production"&&(Ki.propTypes={action:So,anchorEl:sn(i.oneOfType([pt,i.func]),e=>{if(e.open&&(!e.anchorReference||e.anchorReference==="anchorEl")){const t=ir(e.anchorEl);if(t&&t.nodeType===1){const n=t.getBoundingClientRect();if(process.env.NODE_ENV!=="test"&&n.top===0&&n.left===0&&n.right===0&&n.bottom===0)return new Error(["MUI: The `anchorEl` prop provided to the component is invalid.","The anchor element should be part of the document layout.","Make sure the element is present in the document or that it's not display none."].join(`
