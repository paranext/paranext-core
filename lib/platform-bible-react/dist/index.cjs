...
`))},[JSON.stringify(t)])}const c=$.useCallback(d=>{a||i(d)},[]);return[l,c]}function co(e){const t=$.useRef(e);return Xt(()=>{t.current=e}),$.useRef((...n)=>(0,t.current)(...n)).current}function Tt(...e){return $.useMemo(()=>e.every(t=>t==null)?null:t=>{e.forEach(n=>{lr(n,t)})},e)}const Ua={};function ou(e,t){const n=$.useRef(Ua);return n.current===Ua&&(n.current=e(t)),n}const au=[];function su(e){$.useEffect(e,au)}class Bn{constructor(){this.currentId=null,this.clear=()=>{this.currentId!==null&&(clearTimeout(this.currentId),this.currentId=null)},this.disposeEffect=()=>this.clear}static create(){return new Bn}start(t,n){this.clear(),this.currentId=setTimeout(()=>{this.currentId=null,n()},t)}}function hn(){const e=ou(Bn.create).current;return su(e.disposeEffect),e}let Nr=!0,uo=!1;const iu=new Bn,lu={text:!0,search:!0,url:!0,tel:!0,email:!0,password:!0,number:!0,date:!0,month:!0,week:!0,time:!0,datetime:!0,"datetime-local":!0};function cu(e){const{type:t,tagName:n}=e;return!!(n==="INPUT"&&lu[t]&&!e.readOnly||n==="TEXTAREA"&&!e.readOnly||e.isContentEditable)}function du(e){e.metaKey||e.altKey||e.ctrlKey||(Nr=!0)}function Kr(){Nr=!1}function uu(){this.visibilityState==="hidden"&&uo&&(Nr=!0)}function pu(e){e.addEventListener("keydown",du,!0),e.addEventListener("mousedown",Kr,!0),e.addEventListener("pointerdown",Kr,!0),e.addEventListener("touchstart",Kr,!0),e.addEventListener("visibilitychange",uu,!0)}function wu(e){const{target:t}=e;try{return t.matches(":focus-visible")}catch{}return Nr||cu(t)}function yi(){const e=$.useCallback(a=>{a!=null&&pu(a.ownerDocument)},[]),t=$.useRef(!1);function n(){return t.current?(uo=!0,iu.start(100,()=>{uo=!1}),t.current=!1,!0):!1}function r(a){return wu(a)?(t.current=!0,!0):!1}return{isFocusVisibleRef:t,onFocus:r,onBlur:n,ref:e}}function Ni(e,t){const n=R({},t);return Object.keys(e).forEach(r=>{if(r.toString().match(/^(components|slots)$/))n[r]=R({},e[r],n[r]);else if(r.toString().match(/^(componentsProps|slotProps)$/)){const a=e[r]||{},s=t[r];n[r]={},!s||!Object.keys(s)?n[r]=a:!a||!Object.keys(a)?n[r]=s:(n[r]=R({},s),Object.keys(a).forEach(i=>{n[r][i]=Ni(a[i],s[i])}))}else n[r]===void 0&&(n[r]=e[r])}),n}function Uo(e,t,n=void 0){const r={};return Object.keys(e).forEach(a=>{r[a]=e[a].reduce((s,i)=>{if(i){const l=t(i);l!==""&&s.push(l),n&&n[i]&&s.push(n[i])}return s},[]).join(" ")}),r}const qa=e=>e,fu=()=>{let e=qa;return{configure(t){e=t},generate(t){return e(t)},reset(){e=qa}}},mu=fu(),ji=mu,ki={active:"active",checked:"checked",completed:"completed",disabled:"disabled",error:"error",expanded:"expanded",focused:"focused",focusVisible:"focusVisible",open:"open",readOnly:"readOnly",required:"required",selected:"selected"};function jr(e,t,n="Mui"){const r=ki[t];return r?`${n}-${r}`:`${ji.generate(e)}-${t}`}function Si(e,t,n="Mui"){const r={};return t.forEach(a=>{r[a]=jr(e,a,n)}),r}function hu(e,t=Number.MIN_SAFE_INTEGER,n=Number.MAX_SAFE_INTEGER){return Math.max(t,Math.min(e,n))}function ke(e,t){if(e==null)return{};var n={},r=Object.keys(e),a,s;for(s=0;s<r.length;s++)a=r[s],!(t.indexOf(a)>=0)&&(n[a]=e[a]);return n}const gu=["values","unit","step"],bu=e=>{const t=Object.keys(e).map(n=>({key:n,val:e[n]}))||[];return t.sort((n,r)=>n.val-r.val),t.reduce((n,r)=>R({},n,{[r.key]:r.val}),{})};function vu(e){const{values:t={xs:0,sm:600,md:900,lg:1200,xl:1536},unit:n="px",step:r=5}=e,a=ke(e,gu),s=bu(t),i=Object.keys(s);function l(w){return`@media (min-width:${typeof t[w]=="number"?t[w]:w}${n})`}function c(w){return`@media (max-width:${(typeof t[w]=="number"?t[w]:w)-r/100}${n})`}function d(w,b){const x=i.indexOf(b);return`@media (min-width:${typeof t[w]=="number"?t[w]:w}${n}) and (max-width:${(x!==-1&&typeof t[i[x]]=="number"?t[i[x]]:b)-r/100}${n})`}function u(w){return i.indexOf(w)+1<i.length?d(w,i[i.indexOf(w)+1]):l(w)}function f(w){const b=i.indexOf(w);return b===0?l(i[1]):b===i.length-1?c(i[b]):d(w,i[i.indexOf(w)+1]).replace("@media","@media not all and")}return R({keys:i,values:s,up:l,down:c,between:d,only:u,not:f,unit:n},a)}const xu={borderRadius:4},yu=xu,Nu=process.env.NODE_ENV!=="production"?p.oneOfType([p.number,p.string,p.object,p.array]):{},wt=Nu;function jn(e,t){return t?rt(e,t,{clone:!1}):e}const qo={xs:0,sm:600,md:900,lg:1200,xl:1536},Ha={keys:["xs","sm","md","lg","xl"],up:e=>`@media (min-width:${qo[e]}px)`};function ot(e,t,n){const r=e.theme||{};if(Array.isArray(t)){const s=r.breakpoints||Ha;return t.reduce((i,l,c)=>(i[s.up(s.keys[c])]=n(t[c]),i),{})}if(typeof t=="object"){const s=r.breakpoints||Ha;return Object.keys(t).reduce((i,l)=>{if(Object.keys(s.values||qo).indexOf(l)!==-1){const c=s.up(l);i[c]=n(t[l],l)}else{const c=l;i[c]=t[c]}return i},{})}return n(t)}function ju(e={}){var t;return((t=e.keys)==null?void 0:t.reduce((r,a)=>{const s=e.up(a);return r[s]={},r},{}))||{}}function ku(e,t){return e.reduce((n,r)=>{const a=n[r];return(!a||Object.keys(a).length===0)&&delete n[r],n},t)}function kr(e,t,n=!0){if(!t||typeof t!="string")return null;if(e&&e.vars&&n){const r=`vars.${t}`.split(".").reduce((a,s)=>a&&a[s]?a[s]:null,e);if(r!=null)return r}return t.split(".").reduce((r,a)=>r&&r[a]!=null?r[a]:null,e)}function cr(e,t,n,r=n){let a;return typeof e=="function"?a=e(n):Array.isArray(e)?a=e[n]||r:a=kr(e,n)||r,t&&(a=t(a,r,e)),a}function xe(e){const{prop:t,cssProperty:n=e.prop,themeKey:r,transform:a}=e,s=i=>{if(i[t]==null)return null;const l=i[t],c=i.theme,d=kr(c,r)||{};return ot(i,l,f=>{let w=cr(d,a,f);return f===w&&typeof f=="string"&&(w=cr(d,a,`${t}${f==="default"?"":Ze(f)}`,f)),n===!1?w:{[n]:w}})};return s.propTypes=process.env.NODE_ENV!=="production"?{[t]:wt}:{},s.filterProps=[t],s}function Su(e){const t={};return n=>(t[n]===void 0&&(t[n]=e(n)),t[n])}const Eu={m:"margin",p:"padding"},Cu={t:"Top",r:"Right",b:"Bottom",l:"Left",x:["Left","Right"],y:["Top","Bottom"]},Xa={marginX:"mx",marginY:"my",paddingX:"px",paddingY:"py"},Tu=Su(e=>{if(e.length>2)if(Xa[e])e=Xa[e];else return[e];const[t,n]=e.split(""),r=Eu[t],a=Cu[n]||"";return Array.isArray(a)?a.map(s=>r+s):[r+a]}),Sr=["m","mt","mr","mb","ml","mx","my","margin","marginTop","marginRight","marginBottom","marginLeft","marginX","marginY","marginInline","marginInlineStart","marginInlineEnd","marginBlock","marginBlockStart","marginBlockEnd"],Er=["p","pt","pr","pb","pl","px","py","padding","paddingTop","paddingRight","paddingBottom","paddingLeft","paddingX","paddingY","paddingInline","paddingInlineStart","paddingInlineEnd","paddingBlock","paddingBlockStart","paddingBlockEnd"],Ru=[...Sr,...Er];function zn(e,t,n,r){var a;const s=(a=kr(e,t,!1))!=null?a:n;return typeof s=="number"?i=>typeof i=="string"?i:(process.env.NODE_ENV!=="production"&&typeof i!="number"&&console.error(`MUI: Expected ${r} argument to be a number or a string, got ${i}.`),s*i):Array.isArray(s)?i=>typeof i=="string"?i:(process.env.NODE_ENV!=="production"&&(Number.isInteger(i)?i>s.length-1&&console.error([`MUI: The value provided (${i}) overflows.`,`The supported values are: ${JSON.stringify(s)}.`,`${i} > ${s.length-1}, you need to add the missing values.`].join(`
`)):console.error([`MUI: The \`theme.${t}\` array type cannot be combined with non integer values.You should either use an integer value that can be used as index, or define the \`theme.${t}\` as a number.`].join(`
`))),s[i]):typeof s=="function"?s:(process.env.NODE_ENV!=="production"&&console.error([`MUI: The \`theme.${t}\` value (${s}) is invalid.`,"It should be a number, an array or a function."].join(`
`)),()=>{})}function Ei(e){return zn(e,"spacing",8,"spacing")}function Vn(e,t){if(typeof t=="string"||t==null)return t;const n=Math.abs(t),r=e(n);return t>=0?r:typeof r=="number"?-r:`-${r}`}function Ou(e,t){return n=>e.reduce((r,a)=>(r[a]=Vn(t,n),r),{})}function _u(e,t,n,r){if(t.indexOf(n)===-1)return null;const a=Tu(n),s=Ou(a,r),i=e[n];return ot(e,i,s)}function Ci(e,t){const n=Ei(e.theme);return Object.keys(e).map(r=>_u(e,t,r,n)).reduce(jn,{})}function ge(e){return Ci(e,Sr)}ge.propTypes=process.env.NODE_ENV!=="production"?Sr.reduce((e,t)=>(e[t]=wt,e),{}):{};ge.filterProps=Sr;function be(e){return Ci(e,Er)}be.propTypes=process.env.NODE_ENV!=="production"?Er.reduce((e,t)=>(e[t]=wt,e),{}):{};be.filterProps=Er;process.env.NODE_ENV!=="production"&&Ru.reduce((e,t)=>(e[t]=wt,e),{});function Pu(e=8){if(e.mui)return e;const t=Ei({spacing:e}),n=(...r)=>(process.env.NODE_ENV!=="production"&&(r.length<=4||console.error(`MUI: Too many arguments provided, expected between 0 and 4, got ${r.length}`)),(r.length===0?[1]:r).map(s=>{const i=t(s);return typeof i=="number"?`${i}px`:i}).join(" "));return n.mui=!0,n}function Cr(...e){const t=e.reduce((r,a)=>(a.filterProps.forEach(s=>{r[s]=a}),r),{}),n=r=>Object.keys(r).reduce((a,s)=>t[s]?jn(a,t[s](r)):a,{});return n.propTypes=process.env.NODE_ENV!=="production"?e.reduce((r,a)=>Object.assign(r,a.propTypes),{}):{},n.filterProps=e.reduce((r,a)=>r.concat(a.filterProps),[]),n}function Ve(e){return typeof e!="number"?e:`${e}px solid`}function Ue(e,t){return xe({prop:e,themeKey:"borders",transform:t})}const Iu=Ue("border",Ve),Mu=Ue("borderTop",Ve),$u=Ue("borderRight",Ve),Au=Ue("borderBottom",Ve),Du=Ue("borderLeft",Ve),Bu=Ue("borderColor"),zu=Ue("borderTopColor"),Vu=Ue("borderRightColor"),Fu=Ue("borderBottomColor"),Lu=Ue("borderLeftColor"),Gu=Ue("outline",Ve),Uu=Ue("outlineColor"),Tr=e=>{if(e.borderRadius!==void 0&&e.borderRadius!==null){const t=zn(e.theme,"shape.borderRadius",4,"borderRadius"),n=r=>({borderRadius:Vn(t,r)});return ot(e,e.borderRadius,n)}return null};Tr.propTypes=process.env.NODE_ENV!=="production"?{borderRadius:wt}:{};Tr.filterProps=["borderRadius"];Cr(Iu,Mu,$u,Au,Du,Bu,zu,Vu,Fu,Lu,Tr,Gu,Uu);const Rr=e=>{if(e.gap!==void 0&&e.gap!==null){const t=zn(e.theme,"spacing",8,"gap"),n=r=>({gap:Vn(t,r)});return ot(e,e.gap,n)}return null};Rr.propTypes=process.env.NODE_ENV!=="production"?{gap:wt}:{};Rr.filterProps=["gap"];const Or=e=>{if(e.columnGap!==void 0&&e.columnGap!==null){const t=zn(e.theme,"spacing",8,"columnGap"),n=r=>({columnGap:Vn(t,r)});return ot(e,e.columnGap,n)}return null};Or.propTypes=process.env.NODE_ENV!=="production"?{columnGap:wt}:{};Or.filterProps=["columnGap"];const _r=e=>{if(e.rowGap!==void 0&&e.rowGap!==null){const t=zn(e.theme,"spacing",8,"rowGap"),n=r=>({rowGap:Vn(t,r)});return ot(e,e.rowGap,n)}return null};_r.propTypes=process.env.NODE_ENV!=="production"?{rowGap:wt}:{};_r.filterProps=["rowGap"];const qu=xe({prop:"gridColumn"}),Hu=xe({prop:"gridRow"}),Xu=xe({prop:"gridAutoFlow"}),Yu=xe({prop:"gridAutoColumns"}),Wu=xe({prop:"gridAutoRows"}),Ku=xe({prop:"gridTemplateColumns"}),Ju=xe({prop:"gridTemplateRows"}),Zu=xe({prop:"gridTemplateAreas"}),Qu=xe({prop:"gridArea"});Cr(Rr,Or,_r,qu,Hu,Xu,Yu,Wu,Ku,Ju,Zu,Qu);function Ut(e,t){return t==="grey"?t:e}const ep=xe({prop:"color",themeKey:"palette",transform:Ut}),tp=xe({prop:"bgcolor",cssProperty:"backgroundColor",themeKey:"palette",transform:Ut}),np=xe({prop:"backgroundColor",themeKey:"palette",transform:Ut});Cr(ep,tp,np);function De(e){return e<=1&&e!==0?`${e*100}%`:e}const rp=xe({prop:"width",transform:De}),Ho=e=>{if(e.maxWidth!==void 0&&e.maxWidth!==null){const t=n=>{var r,a;const s=((r=e.theme)==null||(r=r.breakpoints)==null||(r=r.values)==null?void 0:r[n])||qo[n];return s?((a=e.theme)==null||(a=a.breakpoints)==null?void 0:a.unit)!=="px"?{maxWidth:`${s}${e.theme.breakpoints.unit}`}:{maxWidth:s}:{maxWidth:De(n)}};return ot(e,e.maxWidth,t)}return null};Ho.filterProps=["maxWidth"];const op=xe({prop:"minWidth",transform:De}),ap=xe({prop:"height",transform:De}),sp=xe({prop:"maxHeight",transform:De}),ip=xe({prop:"minHeight",transform:De});xe({prop:"size",cssProperty:"width",transform:De});xe({prop:"size",cssProperty:"height",transform:De});const lp=xe({prop:"boxSizing"});Cr(rp,Ho,op,ap,sp,ip,lp);const cp={border:{themeKey:"borders",transform:Ve},borderTop:{themeKey:"borders",transform:Ve},borderRight:{themeKey:"borders",transform:Ve},borderBottom:{themeKey:"borders",transform:Ve},borderLeft:{themeKey:"borders",transform:Ve},borderColor:{themeKey:"palette"},borderTopColor:{themeKey:"palette"},borderRightColor:{themeKey:"palette"},borderBottomColor:{themeKey:"palette"},borderLeftColor:{themeKey:"palette"},outline:{themeKey:"borders",transform:Ve},outlineColor:{themeKey:"palette"},borderRadius:{themeKey:"shape.borderRadius",style:Tr},color:{themeKey:"palette",transform:Ut},bgcolor:{themeKey:"palette",cssProperty:"backgroundColor",transform:Ut},backgroundColor:{themeKey:"palette",transform:Ut},p:{style:be},pt:{style:be},pr:{style:be},pb:{style:be},pl:{style:be},px:{style:be},py:{style:be},padding:{style:be},paddingTop:{style:be},paddingRight:{style:be},paddingBottom:{style:be},paddingLeft:{style:be},paddingX:{style:be},paddingY:{style:be},paddingInline:{style:be},paddingInlineStart:{style:be},paddingInlineEnd:{style:be},paddingBlock:{style:be},paddingBlockStart:{style:be},paddingBlockEnd:{style:be},m:{style:ge},mt:{style:ge},mr:{style:ge},mb:{style:ge},ml:{style:ge},mx:{style:ge},my:{style:ge},margin:{style:ge},marginTop:{style:ge},marginRight:{style:ge},marginBottom:{style:ge},marginLeft:{style:ge},marginX:{style:ge},marginY:{style:ge},marginInline:{style:ge},marginInlineStart:{style:ge},marginInlineEnd:{style:ge},marginBlock:{style:ge},marginBlockStart:{style:ge},marginBlockEnd:{style:ge},displayPrint:{cssProperty:!1,transform:e=>({"@media print":{display:e}})},display:{},overflow:{},textOverflow:{},visibility:{},whiteSpace:{},flexBasis:{},flexDirection:{},flexWrap:{},justifyContent:{},alignItems:{},alignContent:{},order:{},flex:{},flexGrow:{},flexShrink:{},alignSelf:{},justifyItems:{},justifySelf:{},gap:{style:Rr},rowGap:{style:_r},columnGap:{style:Or},gridColumn:{},gridRow:{},gridAutoFlow:{},gridAutoColumns:{},gridAutoRows:{},gridTemplateColumns:{},gridTemplateRows:{},gridTemplateAreas:{},gridArea:{},position:{},zIndex:{themeKey:"zIndex"},top:{},right:{},bottom:{},left:{},boxShadow:{themeKey:"shadows"},width:{transform:De},maxWidth:{style:Ho},minWidth:{transform:De},height:{transform:De},maxHeight:{transform:De},minHeight:{transform:De},boxSizing:{},fontFamily:{themeKey:"typography"},fontSize:{themeKey:"typography"},fontStyle:{themeKey:"typography"},fontWeight:{themeKey:"typography"},letterSpacing:{},textTransform:{},lineHeight:{},textAlign:{},typography:{cssProperty:!1,themeKey:"typography"}},Xo=cp;function dp(...e){const t=e.reduce((r,a)=>r.concat(Object.keys(a)),[]),n=new Set(t);return e.every(r=>n.size===Object.keys(r).length)}function up(e,t){return typeof e=="function"?e(t):e}function pp(){function e(n,r,a,s){const i={[n]:r,theme:a},l=s[n];if(!l)return{[n]:r};const{cssProperty:c=n,themeKey:d,transform:u,style:f}=l;if(r==null)return null;if(d==="typography"&&r==="inherit")return{[n]:r};const w=kr(a,d)||{};return f?f(i):ot(i,r,x=>{let m=cr(w,u,x);return x===m&&typeof x=="string"&&(m=cr(w,u,`${n}${x==="default"?"":Ze(x)}`,x)),c===!1?m:{[c]:m}})}function t(n){var r;const{sx:a,theme:s={}}=n||{};if(!a)return null;const i=(r=s.unstable_sxConfig)!=null?r:Xo;function l(c){let d=c;if(typeof c=="function")d=c(s);else if(typeof c!="object")return c;if(!d)return null;const u=ju(s.breakpoints),f=Object.keys(u);let w=u;return Object.keys(d).forEach(b=>{const x=up(d[b],s);if(x!=null)if(typeof x=="object")if(i[b])w=jn(w,e(b,x,s,i));else{const m=ot({theme:s},x,g=>({[b]:g}));dp(m,x)?w[b]=t({sx:x,theme:s}):w=jn(w,m)}else w=jn(w,e(b,x,s,i))}),ku(f,w)}return Array.isArray(a)?a.map(l):l(a)}return t}const Ti=pp();Ti.filterProps=["sx"];const Yo=Ti;function wp(e,t){const n=this;return n.vars&&typeof n.getColorSchemeSelector=="function"?{[n.getColorSchemeSelector(e).replace(/(\[[^\]]+\])/,"*:where($1)")]:t}:n.palette.mode===e?t:{}}const fp=["breakpoints","palette","spacing","shape"];function Wo(e={},...t){const{breakpoints:n={},palette:r={},spacing:a,shape:s={}}=e,i=ke(e,fp),l=vu(n),c=Pu(a);let d=rt({breakpoints:l,direction:"ltr",components:{},palette:R({mode:"light"},r),spacing:c,shape:R({},yu,s)},i);return d.applyStyles=wp,d=t.reduce((u,f)=>rt(u,f),d),d.unstable_sxConfig=R({},Xo,i==null?void 0:i.unstable_sxConfig),d.unstable_sx=function(f){return Yo({sx:f,theme:this})},d}function mp(e){return Object.keys(e).length===0}function Ri(e=null){const t=$.useContext(eo.ThemeContext);return!t||mp(t)?e:t}const hp=Wo();function Oi(e=hp){return Ri(e)}const gp=["ownerState"],bp=["variants"],vp=["name","slot","skipVariantsResolver","skipSx","overridesResolver"];function xp(e){return Object.keys(e).length===0}function yp(e){return typeof e=="string"&&e.charCodeAt(0)>96}function tr(e){return e!=="ownerState"&&e!=="theme"&&e!=="sx"&&e!=="as"}const Np=Wo(),Ya=e=>e&&e.charAt(0).toLowerCase()+e.slice(1);function Kn({defaultTheme:e,theme:t,themeId:n}){return xp(t)?e:t[n]||t}function jp(e){return e?(t,n)=>n[e]:null}function nr(e,t){let{ownerState:n}=t,r=ke(t,gp);const a=typeof e=="function"?e(R({ownerState:n},r)):e;if(Array.isArray(a))return a.flatMap(s=>nr(s,R({ownerState:n},r)));if(a&&typeof a=="object"&&Array.isArray(a.variants)){const{variants:s=[]}=a;let l=ke(a,bp);return s.forEach(c=>{let d=!0;typeof c.props=="function"?d=c.props(R({ownerState:n},r,n)):Object.keys(c.props).forEach(u=>{(n==null?void 0:n[u])!==c.props[u]&&r[u]!==c.props[u]&&(d=!1)}),d&&(Array.isArray(l)||(l=[l]),l.push(typeof c.style=="function"?c.style(R({ownerState:n},r,n)):c.style))}),l}return a}function kp(e={}){const{themeId:t,defaultTheme:n=Np,rootShouldForwardProp:r=tr,slotShouldForwardProp:a=tr}=e,s=i=>Yo(R({},i,{theme:Kn(R({},i,{defaultTheme:n,themeId:t}))}));return s.__mui_systemSx=!0,(i,l={})=>{eo.internal_processStyles(i,v=>v.filter(P=>!(P!=null&&P.__mui_systemSx)));const{name:c,slot:d,skipVariantsResolver:u,skipSx:f,overridesResolver:w=jp(Ya(d))}=l,b=ke(l,vp),x=u!==void 0?u:d&&d!=="Root"&&d!=="root"||!1,m=f||!1;let g;process.env.NODE_ENV!=="production"&&c&&(g=`${c}-${Ya(d||"Root")}`);let j=tr;d==="Root"||d==="root"?j=r:d?j=a:yp(i)&&(j=void 0);const S=eo(i,R({shouldForwardProp:j,label:g},b)),E=v=>typeof v=="function"&&v.__emotion_real!==v||Nt(v)?P=>nr(v,R({},P,{theme:Kn({theme:P.theme,defaultTheme:n,themeId:t})})):v,k=(v,...P)=>{let D=E(v);const T=P?P.map(E):[];c&&w&&T.push(M=>{const ee=Kn(R({},M,{defaultTheme:n,themeId:t}));if(!ee.components||!ee.components[c]||!ee.components[c].styleOverrides)return null;const O=ee.components[c].styleOverrides,V={};return Object.entries(O).forEach(([A,B])=>{V[A]=nr(B,R({},M,{theme:ee}))}),w(M,V)}),c&&!x&&T.push(M=>{var ee;const O=Kn(R({},M,{defaultTheme:n,themeId:t})),V=O==null||(ee=O.components)==null||(ee=ee[c])==null?void 0:ee.variants;return nr({variants:V},R({},M,{theme:O}))}),m||T.push(s);const _=T.length-P.length;if(Array.isArray(v)&&_>0){const M=new Array(_).fill("");D=[...v,...M],D.raw=[...v.raw,...M]}const L=S(D,...T);if(process.env.NODE_ENV!=="production"){let M;c&&(M=`${c}${Ze(d||"")}`),M===void 0&&(M=`Styled(${Xd(i)})`),L.displayName=M}return i.muiName&&(L.muiName=i.muiName),L};return S.withConfig&&(k.withConfig=S.withConfig),k}}function Sp(e){const{theme:t,name:n,props:r}=e;return!t||!t.components||!t.components[n]||!t.components[n].defaultProps?r:Ni(t.components[n].defaultProps,r)}function Ep({props:e,name:t,defaultTheme:n,themeId:r}){let a=Oi(n);return r&&(a=a[r]||a),Sp({theme:a,name:t,props:e})}function Ko(e,t=0,n=1){return process.env.NODE_ENV!=="production"&&(e<t||e>n)&&console.error(`MUI: The value provided ${e} is out of range [${t}, ${n}].`),hu(e,t,n)}function Cp(e){e=e.slice(1);const t=new RegExp(`.{1,${e.length>=6?2:1}}`,"g");let n=e.match(t);return n&&n[0].length===1&&(n=n.map(r=>r+r)),n?`rgb${n.length===4?"a":""}(${n.map((r,a)=>a<3?parseInt(r,16):Math.round(parseInt(r,16)/255*1e3)/1e3).join(", ")})`:""}function Rt(e){if(e.type)return e;if(e.charAt(0)==="#")return Rt(Cp(e));const t=e.indexOf("("),n=e.substring(0,t);if(["rgb","rgba","hsl","hsla","color"].indexOf(n)===-1)throw new Error(process.env.NODE_ENV!=="production"?`MUI: Unsupported \`${e}\` color.
The following formats are supported: #nnn, #nnnnnn, rgb(), rgba(), hsl(), hsla(), color().`:Ht(9,e));let r=e.substring(t+1,e.length-1),a;if(n==="color"){if(r=r.split(" "),a=r.shift(),r.length===4&&r[3].charAt(0)==="/"&&(r[3]=r[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(a)===-1)throw new Error(process.env.NODE_ENV!=="production"?`MUI: unsupported \`${a}\` color space.
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.`:Ht(10,a))}else r=r.split(",");return r=r.map(s=>parseFloat(s)),{type:n,values:r,colorSpace:a}}function Pr(e){const{type:t,colorSpace:n}=e;let{values:r}=e;return t.indexOf("rgb")!==-1?r=r.map((a,s)=>s<3?parseInt(a,10):a):t.indexOf("hsl")!==-1&&(r[1]=`${r[1]}%`,r[2]=`${r[2]}%`),t.indexOf("color")!==-1?r=`${n} ${r.join(" ")}`:r=`${r.join(", ")}`,`${t}(${r})`}function Tp(e){e=Rt(e);const{values:t}=e,n=t[0],r=t[1]/100,a=t[2]/100,s=r*Math.min(a,1-a),i=(d,u=(d+n/30)%12)=>a-s*Math.max(Math.min(u-3,9-u,1),-1);let l="rgb";const c=[Math.round(i(0)*255),Math.round(i(8)*255),Math.round(i(4)*255)];return e.type==="hsla"&&(l+="a",c.push(t[3])),Pr({type:l,values:c})}function Wa(e){e=Rt(e);let t=e.type==="hsl"||e.type==="hsla"?Rt(Tp(e)).values:e.values;return t=t.map(n=>(e.type!=="color"&&(n/=255),n<=.03928?n/12.92:((n+.055)/1.055)**2.4)),Number((.2126*t[0]+.7152*t[1]+.0722*t[2]).toFixed(3))}function Ka(e,t){const n=Wa(e),r=Wa(t);return(Math.max(n,r)+.05)/(Math.min(n,r)+.05)}function _i(e,t){return e=Rt(e),t=Ko(t),(e.type==="rgb"||e.type==="hsl")&&(e.type+="a"),e.type==="color"?e.values[3]=`/${t}`:e.values[3]=t,Pr(e)}function Rp(e,t){if(e=Rt(e),t=Ko(t),e.type.indexOf("hsl")!==-1)e.values[2]*=1-t;else if(e.type.indexOf("rgb")!==-1||e.type.indexOf("color")!==-1)for(let n=0;n<3;n+=1)e.values[n]*=1-t;return Pr(e)}function Op(e,t){if(e=Rt(e),t=Ko(t),e.type.indexOf("hsl")!==-1)e.values[2]+=(100-e.values[2])*t;else if(e.type.indexOf("rgb")!==-1)for(let n=0;n<3;n+=1)e.values[n]+=(255-e.values[n])*t;else if(e.type.indexOf("color")!==-1)for(let n=0;n<3;n+=1)e.values[n]+=(1-e.values[n])*t;return Pr(e)}function _p(e,t){return R({toolbar:{minHeight:56,[e.up("xs")]:{"@media (orientation: landscape)":{minHeight:48}},[e.up("sm")]:{minHeight:64}}},t)}const Pp={black:"#000",white:"#fff"},Rn=Pp,Ip={50:"#fafafa",100:"#f5f5f5",200:"#eeeeee",300:"#e0e0e0",400:"#bdbdbd",500:"#9e9e9e",600:"#757575",700:"#616161",800:"#424242",900:"#212121",A100:"#f5f5f5",A200:"#eeeeee",A400:"#bdbdbd",A700:"#616161"},Mp=Ip,$p={50:"#f3e5f5",100:"#e1bee7",200:"#ce93d8",300:"#ba68c8",400:"#ab47bc",500:"#9c27b0",600:"#8e24aa",700:"#7b1fa2",800:"#6a1b9a",900:"#4a148c",A100:"#ea80fc",A200:"#e040fb",A400:"#d500f9",A700:"#aa00ff"},Dt=$p,Ap={50:"#ffebee",100:"#ffcdd2",200:"#ef9a9a",300:"#e57373",400:"#ef5350",500:"#f44336",600:"#e53935",700:"#d32f2f",800:"#c62828",900:"#b71c1c",A100:"#ff8a80",A200:"#ff5252",A400:"#ff1744",A700:"#d50000"},Bt=Ap,Dp={50:"#fff3e0",100:"#ffe0b2",200:"#ffcc80",300:"#ffb74d",400:"#ffa726",500:"#ff9800",600:"#fb8c00",700:"#f57c00",800:"#ef6c00",900:"#e65100",A100:"#ffd180",A200:"#ffab40",A400:"#ff9100",A700:"#ff6d00"},un=Dp,Bp={50:"#e3f2fd",100:"#bbdefb",200:"#90caf9",300:"#64b5f6",400:"#42a5f5",500:"#2196f3",600:"#1e88e5",700:"#1976d2",800:"#1565c0",900:"#0d47a1",A100:"#82b1ff",A200:"#448aff",A400:"#2979ff",A700:"#2962ff"},zt=Bp,zp={50:"#e1f5fe",100:"#b3e5fc",200:"#81d4fa",300:"#4fc3f7",400:"#29b6f6",500:"#03a9f4",600:"#039be5",700:"#0288d1",800:"#0277bd",900:"#01579b",A100:"#80d8ff",A200:"#40c4ff",A400:"#00b0ff",A700:"#0091ea"},Vt=zp,Vp={50:"#e8f5e9",100:"#c8e6c9",200:"#a5d6a7",300:"#81c784",400:"#66bb6a",500:"#4caf50",600:"#43a047",700:"#388e3c",800:"#2e7d32",900:"#1b5e20",A100:"#b9f6ca",A200:"#69f0ae",A400:"#00e676",A700:"#00c853"},Ft=Vp,Fp=["mode","contrastThreshold","tonalOffset"],Ja={text:{primary:"rgba(0, 0, 0, 0.87)",secondary:"rgba(0, 0, 0, 0.6)",disabled:"rgba(0, 0, 0, 0.38)"},divider:"rgba(0, 0, 0, 0.12)",background:{paper:Rn.white,default:Rn.white},action:{active:"rgba(0, 0, 0, 0.54)",hover:"rgba(0, 0, 0, 0.04)",hoverOpacity:.04,selected:"rgba(0, 0, 0, 0.08)",selectedOpacity:.08,disabled:"rgba(0, 0, 0, 0.26)",disabledBackground:"rgba(0, 0, 0, 0.12)",disabledOpacity:.38,focus:"rgba(0, 0, 0, 0.12)",focusOpacity:.12,activatedOpacity:.12}},Jr={text:{primary:Rn.white,secondary:"rgba(255, 255, 255, 0.7)",disabled:"rgba(255, 255, 255, 0.5)",icon:"rgba(255, 255, 255, 0.5)"},divider:"rgba(255, 255, 255, 0.12)",background:{paper:"#121212",default:"#121212"},action:{active:Rn.white,hover:"rgba(255, 255, 255, 0.08)",hoverOpacity:.08,selected:"rgba(255, 255, 255, 0.16)",selectedOpacity:.16,disabled:"rgba(255, 255, 255, 0.3)",disabledBackground:"rgba(255, 255, 255, 0.12)",disabledOpacity:.38,focus:"rgba(255, 255, 255, 0.12)",focusOpacity:.12,activatedOpacity:.24}};function Za(e,t,n,r){const a=r.light||r,s=r.dark||r*1.5;e[t]||(e.hasOwnProperty(n)?e[t]=e[n]:t==="light"?e.light=Op(e.main,a):t==="dark"&&(e.dark=Rp(e.main,s)))}function Lp(e="light"){return e==="dark"?{main:zt[200],light:zt[50],dark:zt[400]}:{main:zt[700],light:zt[400],dark:zt[800]}}function Gp(e="light"){return e==="dark"?{main:Dt[200],light:Dt[50],dark:Dt[400]}:{main:Dt[500],light:Dt[300],dark:Dt[700]}}function Up(e="light"){return e==="dark"?{main:Bt[500],light:Bt[300],dark:Bt[700]}:{main:Bt[700],light:Bt[400],dark:Bt[800]}}function qp(e="light"){return e==="dark"?{main:Vt[400],light:Vt[300],dark:Vt[700]}:{main:Vt[700],light:Vt[500],dark:Vt[900]}}function Hp(e="light"){return e==="dark"?{main:Ft[400],light:Ft[300],dark:Ft[700]}:{main:Ft[800],light:Ft[500],dark:Ft[900]}}function Xp(e="light"){return e==="dark"?{main:un[400],light:un[300],dark:un[700]}:{main:"#ed6c02",light:un[500],dark:un[900]}}function Yp(e){const{mode:t="light",contrastThreshold:n=3,tonalOffset:r=.2}=e,a=ke(e,Fp),s=e.primary||Lp(t),i=e.secondary||Gp(t),l=e.error||Up(t),c=e.info||qp(t),d=e.success||Hp(t),u=e.warning||Xp(t);function f(m){const g=Ka(m,Jr.text.primary)>=n?Jr.text.primary:Ja.text.primary;if(process.env.NODE_ENV!=="production"){const j=Ka(m,g);j<3&&console.error([`MUI: The contrast ratio of ${j}:1 for ${g} on ${m}`,"falls below the WCAG recommended absolute minimum contrast ratio of 3:1.","https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
...
The color object needs to have a \`main\` property or a \`${j}\` property.`:Ht(11,g?` (${g})`:"",j));if(typeof m.main!="string")throw new Error(process.env.NODE_ENV!=="production"?`MUI: The color${g?` (${g})`:""} provided to augmentColor(color) is invalid.
...
} });`:Ht(12,g?` (${g})`:"",JSON.stringify(m.main)));return Za(m,"light",S,r),Za(m,"dark",E,r),m.contrastText||(m.contrastText=f(m.main)),m},b={dark:Jr,light:Ja};return process.env.NODE_ENV!=="production"&&(b[t]||console.error(`MUI: The palette mode \`${t}\` is not supported.`)),rt(R({common:R({},Rn),mode:t,primary:w({color:s,name:"primary"}),secondary:w({color:i,name:"secondary",mainShade:"A400",lightShade:"A200",darkShade:"A700"}),error:w({color:l,name:"error"}),warning:w({color:u,name:"warning"}),info:w({color:c,name:"info"}),success:w({color:d,name:"success"}),grey:Mp,contrastThreshold:n,getContrastText:f,augmentColor:w,tonalOffset:r},b[t]),a)}const Wp=["fontFamily","fontSize","fontWeightLight","fontWeightRegular","fontWeightMedium","fontWeightBold","htmlFontSize","allVariants","pxToRem"];function Kp(e){return Math.round(e*1e5)/1e5}const Qa={textTransform:"uppercase"},es='"Roboto", "Helvetica", "Arial", sans-serif';function Jp(e,t){const n=typeof t=="function"?t(e):t,{fontFamily:r=es,fontSize:a=14,fontWeightLight:s=300,fontWeightRegular:i=400,fontWeightMedium:l=500,fontWeightBold:c=700,htmlFontSize:d=16,allVariants:u,pxToRem:f}=n,w=ke(n,Wp);process.env.NODE_ENV!=="production"&&(typeof a!="number"&&console.error("MUI: `fontSize` is required to be a number."),typeof d!="number"&&console.error("MUI: `htmlFontSize` is required to be a number."));const b=a/14,x=f||(j=>`${j/d*b}rem`),m=(j,S,E,k,v)=>R({fontFamily:r,fontWeight:j,fontSize:x(S),lineHeight:E},r===es?{letterSpacing:`${Kp(k/S)}em`}:{},v,u),g={h1:m(s,96,1.167,-1.5),h2:m(s,60,1.2,-.5),h3:m(i,48,1.167,0),h4:m(i,34,1.235,.25),h5:m(i,24,1.334,0),h6:m(l,20,1.6,.15),subtitle1:m(i,16,1.75,.15),subtitle2:m(l,14,1.57,.1),body1:m(i,16,1.5,.15),body2:m(i,14,1.43,.15),button:m(l,14,1.75,.4,Qa),caption:m(i,12,1.66,.4),overline:m(i,12,2.66,1,Qa),inherit:{fontFamily:"inherit",fontWeight:"inherit",fontSize:"inherit",lineHeight:"inherit",letterSpacing:"inherit"}};return rt(R({htmlFontSize:d,pxToRem:x,fontFamily:r,fontSize:a,fontWeightLight:s,fontWeightRegular:i,fontWeightMedium:l,fontWeightBold:c},g),w,{clone:!1})}const Zp=.2,Qp=.14,ew=.12;function me(...e){return[`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Zp})`,`${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Qp})`,`${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${ew})`].join(",")}const tw=["none",me(0,2,1,-1,0,1,1,0,0,1,3,0),me(0,3,1,-2,0,2,2,0,0,1,5,0),me(0,3,3,-2,0,3,4,0,0,1,8,0),me(0,2,4,-1,0,4,5,0,0,1,10,0),me(0,3,5,-1,0,5,8,0,0,1,14,0),me(0,3,5,-1,0,6,10,0,0,1,18,0),me(0,4,5,-2,0,7,10,1,0,2,16,1),me(0,5,5,-3,0,8,10,1,0,3,14,2),me(0,5,6,-3,0,9,12,1,0,3,16,2),me(0,6,6,-3,0,10,14,1,0,4,18,3),me(0,6,7,-4,0,11,15,1,0,4,20,3),me(0,7,8,-4,0,12,17,2,0,5,22,4),me(0,7,8,-4,0,13,19,2,0,5,24,4),me(0,7,9,-4,0,14,21,2,0,5,26,4),me(0,8,9,-5,0,15,22,2,0,6,28,5),me(0,8,10,-5,0,16,24,2,0,6,30,5),me(0,8,11,-5,0,17,26,2,0,6,32,5),me(0,9,11,-5,0,18,28,2,0,7,34,6),me(0,9,12,-6,0,19,29,2,0,7,36,6),me(0,10,13,-6,0,20,31,3,0,8,38,7),me(0,10,13,-6,0,21,33,3,0,8,40,7),me(0,10,14,-6,0,22,35,3,0,8,42,7),me(0,11,14,-7,0,23,36,3,0,9,44,8),me(0,11,15,-7,0,24,38,3,0,9,46,8)],nw=tw,rw=["duration","easing","delay"],ow={easeInOut:"cubic-bezier(0.4, 0, 0.2, 1)",easeOut:"cubic-bezier(0.0, 0, 0.2, 1)",easeIn:"cubic-bezier(0.4, 0, 1, 1)",sharp:"cubic-bezier(0.4, 0, 0.6, 1)"},aw={shortest:150,shorter:200,short:250,standard:300,complex:375,enteringScreen:225,leavingScreen:195};function ts(e){return`${Math.round(e)}ms`}function sw(e){if(!e)return 0;const t=e/36;return Math.round((4+15*t**.25+t/5)*10)}function iw(e){const t=R({},ow,e.easing),n=R({},aw,e.duration);return R({getAutoHeightDuration:sw,create:(a=["all"],s={})=>{const{duration:i=n.standard,easing:l=t.easeInOut,delay:c=0}=s,d=ke(s,rw);if(process.env.NODE_ENV!=="production"){const u=w=>typeof w=="string",f=w=>!isNaN(parseFloat(w));!u(a)&&!Array.isArray(a)&&console.error('MUI: Argument "props" must be a string or Array.'),!f(i)&&!u(i)&&console.error(`MUI: Argument "duration" must be a number or a string but found ${i}.`),u(l)||console.error('MUI: Argument "easing" must be a string.'),!f(c)&&!u(c)&&console.error('MUI: Argument "delay" must be a number or a string.'),typeof s!="object"&&console.error(["MUI: Secong argument of transition.create must be an object.","Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
`)),Object.keys(d).length!==0&&console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`)}return(Array.isArray(a)?a:[a]).map(u=>`${u} ${typeof i=="string"?i:ts(i)} ${l} ${typeof c=="string"?c:ts(c)}`).join(",")}},e,{easing:t,duration:n})}const lw={mobileStepper:1e3,fab:1050,speedDial:1050,appBar:1100,drawer:1200,modal:1300,snackbar:1400,tooltip:1500},cw=lw,dw=["breakpoints","mixins","spacing","palette","transitions","typography","shape"];function uw(e={},...t){const{mixins:n={},palette:r={},transitions:a={},typography:s={}}=e,i=ke(e,dw);if(e.vars)throw new Error(process.env.NODE_ENV!=="production"?"MUI: `vars` is a private field used for CSS variables support.\nPlease use another name.":Ht(18));const l=Yp(r),c=Wo(e);let d=rt(c,{mixins:_p(c.breakpoints,n),palette:l,shadows:nw.slice(),typography:Jp(l,s),transitions:iw(a),zIndex:R({},cw)});if(d=rt(d,i),d=t.reduce((u,f)=>rt(u,f),d),process.env.NODE_ENV!=="production"){const u=["active","checked","completed","disabled","error","expanded","focused","focusVisible","required","selected"],f=(w,b)=>{let x;for(x in w){const m=w[x];if(u.indexOf(x)!==-1&&Object.keys(m).length>0){if(process.env.NODE_ENV!=="production"){const g=jr("",x);console.error([`MUI: The \`${b}\` component increases the CSS specificity of the \`${x}\` internal state.`,"You can not override it like this: ",JSON.stringify(w,null,2),"",`Instead, you need to use the '&.${g}' syntax:`,JSON.stringify({root:{[`&.${g}`]:m}},null,2),"","https://mui.com/r/state-classes-guide"].join(`
`))}w[x]={}}}};Object.keys(d.components).forEach(w=>{const b=d.components[w].styleOverrides;b&&w.indexOf("Mui")===0&&f(b,w)})}return d.unstable_sxConfig=R({},Xo,i==null?void 0:i.unstable_sxConfig),d.unstable_sx=function(f){return Yo({sx:f,theme:this})},d}const pw=uw(),Jo=pw,Zo="$$material";function Qo({props:e,name:t}){return Ep({props:e,name:t,defaultTheme:Jo,themeId:Zo})}const ww=e=>tr(e)&&e!=="classes",fw=kp({themeId:Zo,defaultTheme:Jo,rootShouldForwardProp:ww}),Fn=fw;function mw(e){return jr("MuiSvgIcon",e)}Si("MuiSvgIcon",["root","colorPrimary","colorSecondary","colorAction","colorError","colorDisabled","fontSizeInherit","fontSizeSmall","fontSizeMedium","fontSizeLarge"]);const hw=["children","className","color","component","fontSize","htmlColor","inheritViewBox","titleAccess","viewBox"],gw=e=>{const{color:t,fontSize:n,classes:r}=e,a={root:["root",t!=="inherit"&&`color${Ze(t)}`,`fontSize${Ze(n)}`]};return Uo(a,mw,r)},bw=Fn("svg",{name:"MuiSvgIcon",slot:"Root",overridesResolver:(e,t)=>{const{ownerState:n}=e;return[t.root,n.color!=="inherit"&&t[`color${Ze(n.color)}`],t[`fontSize${Ze(n.fontSize)}`]]}})(({theme:e,ownerState:t})=>{var n,r,a,s,i,l,c,d,u,f,w,b,x;return{userSelect:"none",width:"1em",height:"1em",display:"inline-block",fill:t.hasSvgAsChild?void 0:"currentColor",flexShrink:0,transition:(n=e.transitions)==null||(r=n.create)==null?void 0:r.call(n,"fill",{duration:(a=e.transitions)==null||(a=a.duration)==null?void 0:a.shorter}),fontSize:{inherit:"inherit",small:((s=e.typography)==null||(i=s.pxToRem)==null?void 0:i.call(s,20))||"1.25rem",medium:((l=e.typography)==null||(c=l.pxToRem)==null?void 0:c.call(l,24))||"1.5rem",large:((d=e.typography)==null||(u=d.pxToRem)==null?void 0:u.call(d,35))||"2.1875rem"}[t.fontSize],color:(f=(w=(e.vars||e).palette)==null||(w=w[t.color])==null?void 0:w.main)!=null?f:{action:(b=(e.vars||e).palette)==null||(b=b.action)==null?void 0:b.active,disabled:(x=(e.vars||e).palette)==null||(x=x.action)==null?void 0:x.disabled,inherit:void 0}[t.color]}}),ea=$.forwardRef(function(t,n){const r=Qo({props:t,name:"MuiSvgIcon"}),{children:a,className:s,color:i="inherit",component:l="svg",fontSize:c="medium",htmlColor:d,inheritViewBox:u=!1,titleAccess:f,viewBox:w="0 0 24 24"}=r,b=ke(r,hw),x=$.isValidElement(a)&&a.type==="svg",m=R({},r,{color:i,component:l,fontSize:c,instanceFontSize:t.fontSize,inheritViewBox:u,viewBox:w,hasSvgAsChild:x}),g={};u||(g.viewBox=w);const j=gw(m);return o.jsxs(bw,R({as:l,className:ct(j.root,s),focusable:"false",color:d,"aria-hidden":f?void 0:!0,role:f?"img":void 0,ref:n},g,b,x&&a.props,{ownerState:m,children:[x?a.props.children:a,f?o.jsx("title",{children:f}):null]}))});process.env.NODE_ENV!=="production"&&(ea.propTypes={children:p.node,classes:p.object,className:p.string,color:p.oneOfType([p.oneOf(["inherit","action","disabled","primary","secondary","error","info","success","warning"]),p.string]),component:p.elementType,fontSize:p.oneOfType([p.oneOf(["inherit","large","medium","small"]),p.string]),htmlColor:p.string,inheritViewBox:p.bool,shapeRendering:p.string,sx:p.oneOfType([p.arrayOf(p.oneOfType([p.func,p.object,p.bool])),p.func,p.object]),titleAccess:p.string,viewBox:p.string});ea.muiName="SvgIcon";const ns=ea;function Pi(e,t){function n(r,a){return o.jsx(ns,R({"data-testid":`${t}Icon`,ref:a},r,{children:e}))}return process.env.NODE_ENV!=="production"&&(n.displayName=`${t}Icon`),n.muiName=ns.muiName,$.memo($.forwardRef(n))}const vw={configure:e=>{process.env.NODE_ENV!=="production"&&console.warn(["MUI: `ClassNameGenerator` import from `@mui/material/utils` is outdated and might cause unexpected issues.","","You should use `import { unstable_ClassNameGenerator } from '@mui/material/className'` instead","","The detail of the issue: https://github.com/mui/material-ui/issues/30011#issuecomment-1024993401","","The updated documentation: https://mui.com/guides/classname-generator/"].join(`
`)),ji.configure(e)}},xw=Object.freeze(Object.defineProperty({__proto__:null,capitalize:Ze,createChainedFunction:Wd,createSvgIcon:Pi,debounce:Kd,deprecatedPropType:Jd,isMuiElement:Zd,ownerDocument:ir,ownerWindow:Qd,requirePropFactory:eu,setRef:lr,unstable_ClassNameGenerator:vw,unstable_useEnhancedEffect:Xt,unstable_useId:vi,unsupportedProp:ru,useControlled:xi,useEventCallback:co,useForkRef:Tt,useIsFocusVisible:yi},Symbol.toStringTag,{value:"Module"})),yw=Rd(xw);var rs;function Nw(){return rs||(rs=1,function(e){"use client";Object.defineProperty(e,"__esModule",{value:!0}),Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.createSvgIcon}});var t=yw}(Gr)),Gr}var jw=Od;Object.defineProperty(Fo,"__esModule",{value:!0});var Ii=Fo.default=void 0,kw=jw(Nw()),Sw=o;Ii=Fo.default=(0,kw.default)((0,Sw.jsx)("path",{d:"m10 17 5-5-5-5z"}),"ArrowRight");function Ew(e){return typeof e=="string"}function gn(e,t,n){return e===void 0||Ew(e)?t:R({},t,{ownerState:R({},t.ownerState,n)})}const Cw={disableDefaultClasses:!1},Tw=$.createContext(Cw);function Rw(e){const{disableDefaultClasses:t}=$.useContext(Tw);return n=>t?"":e(n)}function Ow(e,t=[]){if(e===void 0)return{};const n={};return Object.keys(e).filter(r=>r.match(/^on[A-Z]/)&&typeof e[r]=="function"&&!t.includes(r)).forEach(r=>{n[r]=e[r]}),n}function _w(e,t,n){return typeof e=="function"?e(t,n):e}function os(e){if(e===void 0)return{};const t={};return Object.keys(e).filter(n=>!(n.match(/^on[A-Z]/)&&typeof e[n]=="function")).forEach(n=>{t[n]=e[n]}),t}function Pw(e){const{getSlotProps:t,additionalProps:n,externalSlotProps:r,externalForwardedProps:a,className:s}=e;if(!t){const b=ct(n==null?void 0:n.className,s,a==null?void 0:a.className,r==null?void 0:r.className),x=R({},n==null?void 0:n.style,a==null?void 0:a.style,r==null?void 0:r.style),m=R({},n,a,r);return b.length>0&&(m.className=b),Object.keys(x).length>0&&(m.style=x),{props:m,internalRef:void 0}}const i=Ow(R({},a,r)),l=os(r),c=os(a),d=t(i),u=ct(d==null?void 0:d.className,n==null?void 0:n.className,s,a==null?void 0:a.className,r==null?void 0:r.className),f=R({},d==null?void 0:d.style,n==null?void 0:n.style,a==null?void 0:a.style,r==null?void 0:r.style),w=R({},d,n,c,l);return u.length>0&&(w.className=u),Object.keys(f).length>0&&(w.style=f),{props:w,internalRef:d.ref}}const Iw=["elementType","externalSlotProps","ownerState","skipResolvingSlotProps"];function Mw(e){var t;const{elementType:n,externalSlotProps:r,ownerState:a,skipResolvingSlotProps:s=!1}=e,i=ke(e,Iw),l=s?{}:_w(r,a),{props:c,internalRef:d}=Pw(R({},i,{externalSlotProps:l})),u=Tt(d,l==null?void 0:l.ref,(t=e.additionalProps)==null?void 0:t.ref);return gn(n,R({},c,{ref:u}),a)}const Mi="base";function $w(e){return`${Mi}--${e}`}function Aw(e,t){return`${Mi}-${e}-${t}`}function $i(e,t){const n=ki[t];return n?$w(n):Aw(e,t)}function Dw(e,t){const n={};return t.forEach(r=>{n[r]=$i(e,r)}),n}function Bw(e){return typeof e=="function"?e():e}const dr=$.forwardRef(function(t,n){const{children:r,container:a,disablePortal:s=!1}=t,[i,l]=$.useState(null),c=Tt($.isValidElement(r)?r.ref:null,n);if(Xt(()=>{s||l(Bw(a)||document.body)},[a,s]),Xt(()=>{if(i&&!s)return lr(n,i),()=>{lr(n,null)}},[n,i,s]),s){if($.isValidElement(r)){const d={ref:c};return $.cloneElement(r,d)}return o.jsx($.Fragment,{children:r})}return o.jsx($.Fragment,{children:i&&Jl.createPortal(r,i)})});process.env.NODE_ENV!=="production"&&(dr.propTypes={children:p.node,container:p.oneOfType([Tn,p.func]),disablePortal:p.bool});process.env.NODE_ENV!=="production"&&(dr["propTypes"]=Ld(dr.propTypes));var Oe="top",Le="bottom",Ge="right",_e="left",ta="auto",Ln=[Oe,Le,Ge,_e],Yt="start",On="end",zw="clippingParents",Ai="viewport",pn="popper",Vw="reference",as=Ln.reduce(function(e,t){return e.concat([t+"-"+Yt,t+"-"+On])},[]),Di=[].concat(Ln,[ta]).reduce(function(e,t){return e.concat([t,t+"-"+Yt,t+"-"+On])},[]),Fw="beforeRead",Lw="read",Gw="afterRead",Uw="beforeMain",qw="main",Hw="afterMain",Xw="beforeWrite",Yw="write",Ww="afterWrite",Kw=[Fw,Lw,Gw,Uw,qw,Hw,Xw,Yw,Ww];function Qe(e){return e?(e.nodeName||"").toLowerCase():null}function Be(e){if(e==null)return window;if(e.toString()!=="[object Window]"){var t=e.ownerDocument;return t&&t.defaultView||window}return e}function Ot(e){var t=Be(e).Element;return e instanceof t||e instanceof Element}function Fe(e){var t=Be(e).HTMLElement;return e instanceof t||e instanceof HTMLElement}function na(e){if(typeof ShadowRoot>"u")return!1;var t=Be(e).ShadowRoot;return e instanceof t||e instanceof ShadowRoot}function Jw(e){var t=e.state;Object.keys(t.elements).forEach(function(n){var r=t.styles[n]||{},a=t.attributes[n]||{},s=t.elements[n];!Fe(s)||!Qe(s)||(Object.assign(s.style,r),Object.keys(a).forEach(function(i){var l=a[i];l===!1?s.removeAttribute(i):s.setAttribute(i,l===!0?"":l)}))})}function Zw(e){var t=e.state,n={popper:{position:t.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(t.elements.popper.style,n.popper),t.styles=n,t.elements.arrow&&Object.assign(t.elements.arrow.style,n.arrow),function(){Object.keys(t.elements).forEach(function(r){var a=t.elements[r],s=t.attributes[r]||{},i=Object.keys(t.styles.hasOwnProperty(r)?t.styles[r]:n[r]),l=i.reduce(function(c,d){return c[d]="",c},{});!Fe(a)||!Qe(a)||(Object.assign(a.style,l),Object.keys(s).forEach(function(c){a.removeAttribute(c)}))})}}const Qw={name:"applyStyles",enabled:!0,phase:"write",fn:Jw,effect:Zw,requires:["computeStyles"]};function Ke(e){return e.split("-")[0]}var jt=Math.max,ur=Math.min,Wt=Math.round;function po(){var e=navigator.userAgentData;return e!=null&&e.brands&&Array.isArray(e.brands)?e.brands.map(function(t){return t.brand+"/"+t.version}).join(" "):navigator.userAgent}function Bi(){return!/^((?!chrome|android).)*safari/i.test(po())}function Kt(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!1);var r=e.getBoundingClientRect(),a=1,s=1;t&&Fe(e)&&(a=e.offsetWidth>0&&Wt(r.width)/e.offsetWidth||1,s=e.offsetHeight>0&&Wt(r.height)/e.offsetHeight||1);var i=Ot(e)?Be(e):window,l=i.visualViewport,c=!Bi()&&n,d=(r.left+(c&&l?l.offsetLeft:0))/a,u=(r.top+(c&&l?l.offsetTop:0))/s,f=r.width/a,w=r.height/s;return{width:f,height:w,top:u,right:d+f,bottom:u+w,left:d,x:d,y:u}}function ra(e){var t=Kt(e),n=e.offsetWidth,r=e.offsetHeight;return Math.abs(t.width-n)<=1&&(n=t.width),Math.abs(t.height-r)<=1&&(r=t.height),{x:e.offsetLeft,y:e.offsetTop,width:n,height:r}}function zi(e,t){var n=t.getRootNode&&t.getRootNode();if(e.contains(t))return!0;if(n&&na(n)){var r=t;do{if(r&&e.isSameNode(r))return!0;r=r.parentNode||r.host}while(r)}return!1}function at(e){return Be(e).getComputedStyle(e)}function ef(e){return["table","td","th"].indexOf(Qe(e))>=0}function ft(e){return((Ot(e)?e.ownerDocument:e.document)||window.document).documentElement}function Ir(e){return Qe(e)==="html"?e:e.assignedSlot||e.parentNode||(na(e)?e.host:null)||ft(e)}function ss(e){return!Fe(e)||at(e).position==="fixed"?null:e.offsetParent}function tf(e){var t=/firefox/i.test(po()),n=/Trident/i.test(po());if(n&&Fe(e)){var r=at(e);if(r.position==="fixed")return null}var a=Ir(e);for(na(a)&&(a=a.host);Fe(a)&&["html","body"].indexOf(Qe(a))<0;){var s=at(a);if(s.transform!=="none"||s.perspective!=="none"||s.contain==="paint"||["transform","perspective"].indexOf(s.willChange)!==-1||t&&s.willChange==="filter"||t&&s.filter&&s.filter!=="none")return a;a=a.parentNode}return null}function Gn(e){for(var t=Be(e),n=ss(e);n&&ef(n)&&at(n).position==="static";)n=ss(n);return n&&(Qe(n)==="html"||Qe(n)==="body"&&at(n).position==="static")?t:n||tf(e)||t}function oa(e){return["top","bottom"].indexOf(e)>=0?"x":"y"}function kn(e,t,n){return jt(e,ur(t,n))}function nf(e,t,n){var r=kn(e,t,n);return r>n?n:r}function Vi(){return{top:0,right:0,bottom:0,left:0}}function Fi(e){return Object.assign({},Vi(),e)}function Li(e,t){return t.reduce(function(n,r){return n[r]=e,n},{})}var rf=function(t,n){return t=typeof t=="function"?t(Object.assign({},n.rects,{placement:n.placement})):t,Fi(typeof t!="number"?t:Li(t,Ln))};function of(e){var t,n=e.state,r=e.name,a=e.options,s=n.elements.arrow,i=n.modifiersData.popperOffsets,l=Ke(n.placement),c=oa(l),d=[_e,Ge].indexOf(l)>=0,u=d?"height":"width";if(!(!s||!i)){var f=rf(a.padding,n),w=ra(s),b=c==="y"?Oe:_e,x=c==="y"?Le:Ge,m=n.rects.reference[u]+n.rects.reference[c]-i[c]-n.rects.popper[u],g=i[c]-n.rects.reference[c],j=Gn(s),S=j?c==="y"?j.clientHeight||0:j.clientWidth||0:0,E=m/2-g/2,k=f[b],v=S-w[u]-f[x],P=S/2-w[u]/2+E,D=kn(k,P,v),T=c;n.modifiersData[r]=(t={},t[T]=D,t.centerOffset=D-P,t)}}function af(e){var t=e.state,n=e.options,r=n.element,a=r===void 0?"[data-popper-arrow]":r;a!=null&&(typeof a=="string"&&(a=t.elements.popper.querySelector(a),!a)||zi(t.elements.popper,a)&&(t.elements.arrow=a))}const sf={name:"arrow",enabled:!0,phase:"main",fn:of,effect:af,requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function Jt(e){return e.split("-")[1]}var lf={top:"auto",right:"auto",bottom:"auto",left:"auto"};function cf(e,t){var n=e.x,r=e.y,a=t.devicePixelRatio||1;return{x:Wt(n*a)/a||0,y:Wt(r*a)/a||0}}function is(e){var t,n=e.popper,r=e.popperRect,a=e.placement,s=e.variation,i=e.offsets,l=e.position,c=e.gpuAcceleration,d=e.adaptive,u=e.roundOffsets,f=e.isFixed,w=i.x,b=w===void 0?0:w,x=i.y,m=x===void 0?0:x,g=typeof u=="function"?u({x:b,y:m}):{x:b,y:m};b=g.x,m=g.y;var j=i.hasOwnProperty("x"),S=i.hasOwnProperty("y"),E=_e,k=Oe,v=window;if(d){var P=Gn(n),D="clientHeight",T="clientWidth";if(P===Be(n)&&(P=ft(n),at(P).position!=="static"&&l==="absolute"&&(D="scrollHeight",T="scrollWidth")),P=P,a===Oe||(a===_e||a===Ge)&&s===On){k=Le;var _=f&&P===v&&v.visualViewport?v.visualViewport.height:P[D];m-=_-r.height,m*=c?1:-1}if(a===_e||(a===Oe||a===Le)&&s===On){E=Ge;var L=f&&P===v&&v.visualViewport?v.visualViewport.width:P[T];b-=L-r.width,b*=c?1:-1}}var M=Object.assign({position:l},d&&lf),ee=u===!0?cf({x:b,y:m},Be(n)):{x:b,y:m};if(b=ee.x,m=ee.y,c){var O;return Object.assign({},M,(O={},O[k]=S?"0":"",O[E]=j?"0":"",O.transform=(v.devicePixelRatio||1)<=1?"translate("+b+"px, "+m+"px)":"translate3d("+b+"px, "+m+"px, 0)",O))}return Object.assign({},M,(t={},t[k]=S?m+"px":"",t[E]=j?b+"px":"",t.transform="",t))}function df(e){var t=e.state,n=e.options,r=n.gpuAcceleration,a=r===void 0?!0:r,s=n.adaptive,i=s===void 0?!0:s,l=n.roundOffsets,c=l===void 0?!0:l,d={placement:Ke(t.placement),variation:Jt(t.placement),popper:t.elements.popper,popperRect:t.rects.popper,gpuAcceleration:a,isFixed:t.options.strategy==="fixed"};t.modifiersData.popperOffsets!=null&&(t.styles.popper=Object.assign({},t.styles.popper,is(Object.assign({},d,{offsets:t.modifiersData.popperOffsets,position:t.options.strategy,adaptive:i,roundOffsets:c})))),t.modifiersData.arrow!=null&&(t.styles.arrow=Object.assign({},t.styles.arrow,is(Object.assign({},d,{offsets:t.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:c})))),t.attributes.popper=Object.assign({},t.attributes.popper,{"data-popper-placement":t.placement})}const uf={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:df,data:{}};var Jn={passive:!0};function pf(e){var t=e.state,n=e.instance,r=e.options,a=r.scroll,s=a===void 0?!0:a,i=r.resize,l=i===void 0?!0:i,c=Be(t.elements.popper),d=[].concat(t.scrollParents.reference,t.scrollParents.popper);return s&&d.forEach(function(u){u.addEventListener("scroll",n.update,Jn)}),l&&c.addEventListener("resize",n.update,Jn),function(){s&&d.forEach(function(u){u.removeEventListener("scroll",n.update,Jn)}),l&&c.removeEventListener("resize",n.update,Jn)}}const wf={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:pf,data:{}};var ff={left:"right",right:"left",bottom:"top",top:"bottom"};function rr(e){return e.replace(/left|right|bottom|top/g,function(t){return ff[t]})}var mf={start:"end",end:"start"};function ls(e){return e.replace(/start|end/g,function(t){return mf[t]})}function aa(e){var t=Be(e),n=t.pageXOffset,r=t.pageYOffset;return{scrollLeft:n,scrollTop:r}}function sa(e){return Kt(ft(e)).left+aa(e).scrollLeft}function hf(e,t){var n=Be(e),r=ft(e),a=n.visualViewport,s=r.clientWidth,i=r.clientHeight,l=0,c=0;if(a){s=a.width,i=a.height;var d=Bi();(d||!d&&t==="fixed")&&(l=a.offsetLeft,c=a.offsetTop)}return{width:s,height:i,x:l+sa(e),y:c}}function gf(e){var t,n=ft(e),r=aa(e),a=(t=e.ownerDocument)==null?void 0:t.body,s=jt(n.scrollWidth,n.clientWidth,a?a.scrollWidth:0,a?a.clientWidth:0),i=jt(n.scrollHeight,n.clientHeight,a?a.scrollHeight:0,a?a.clientHeight:0),l=-r.scrollLeft+sa(e),c=-r.scrollTop;return at(a||n).direction==="rtl"&&(l+=jt(n.clientWidth,a?a.clientWidth:0)-s),{width:s,height:i,x:l,y:c}}function ia(e){var t=at(e),n=t.overflow,r=t.overflowX,a=t.overflowY;return/auto|scroll|overlay|hidden/.test(n+a+r)}function Gi(e){return["html","body","#document"].indexOf(Qe(e))>=0?e.ownerDocument.body:Fe(e)&&ia(e)?e:Gi(Ir(e))}function Sn(e,t){var n;t===void 0&&(t=[]);var r=Gi(e),a=r===((n=e.ownerDocument)==null?void 0:n.body),s=Be(r),i=a?[s].concat(s.visualViewport||[],ia(r)?r:[]):r,l=t.concat(i);return a?l:l.concat(Sn(Ir(i)))}function wo(e){return Object.assign({},e,{left:e.x,top:e.y,right:e.x+e.width,bottom:e.y+e.height})}function bf(e,t){var n=Kt(e,!1,t==="fixed");return n.top=n.top+e.clientTop,n.left=n.left+e.clientLeft,n.bottom=n.top+e.clientHeight,n.right=n.left+e.clientWidth,n.width=e.clientWidth,n.height=e.clientHeight,n.x=n.left,n.y=n.top,n}function cs(e,t,n){return t===Ai?wo(hf(e,n)):Ot(t)?bf(t,n):wo(gf(ft(e)))}function vf(e){var t=Sn(Ir(e)),n=["absolute","fixed"].indexOf(at(e).position)>=0,r=n&&Fe(e)?Gn(e):e;return Ot(r)?t.filter(function(a){return Ot(a)&&zi(a,r)&&Qe(a)!=="body"}):[]}function xf(e,t,n,r){var a=t==="clippingParents"?vf(e):[].concat(t),s=[].concat(a,[n]),i=s[0],l=s.reduce(function(c,d){var u=cs(e,d,r);return c.top=jt(u.top,c.top),c.right=ur(u.right,c.right),c.bottom=ur(u.bottom,c.bottom),c.left=jt(u.left,c.left),c},cs(e,i,r));return l.width=l.right-l.left,l.height=l.bottom-l.top,l.x=l.left,l.y=l.top,l}function Ui(e){var t=e.reference,n=e.element,r=e.placement,a=r?Ke(r):null,s=r?Jt(r):null,i=t.x+t.width/2-n.width/2,l=t.y+t.height/2-n.height/2,c;switch(a){case Oe:c={x:i,y:t.y-n.height};break;case Le:c={x:i,y:t.y+t.height};break;case Ge:c={x:t.x+t.width,y:l};break;case _e:c={x:t.x-n.width,y:l};break;default:c={x:t.x,y:t.y}}var d=a?oa(a):null;if(d!=null){var u=d==="y"?"height":"width";switch(s){case Yt:c[d]=c[d]-(t[u]/2-n[u]/2);break;case On:c[d]=c[d]+(t[u]/2-n[u]/2);break}}return c}function _n(e,t){t===void 0&&(t={});var n=t,r=n.placement,a=r===void 0?e.placement:r,s=n.strategy,i=s===void 0?e.strategy:s,l=n.boundary,c=l===void 0?zw:l,d=n.rootBoundary,u=d===void 0?Ai:d,f=n.elementContext,w=f===void 0?pn:f,b=n.altBoundary,x=b===void 0?!1:b,m=n.padding,g=m===void 0?0:m,j=Fi(typeof g!="number"?g:Li(g,Ln)),S=w===pn?Vw:pn,E=e.rects.popper,k=e.elements[x?S:w],v=xf(Ot(k)?k:k.contextElement||ft(e.elements.popper),c,u,i),P=Kt(e.elements.reference),D=Ui({reference:P,element:E,strategy:"absolute",placement:a}),T=wo(Object.assign({},E,D)),_=w===pn?T:P,L={top:v.top-_.top+j.top,bottom:_.bottom-v.bottom+j.bottom,left:v.left-_.left+j.left,right:_.right-v.right+j.right},M=e.modifiersData.offset;if(w===pn&&M){var ee=M[a];Object.keys(L).forEach(function(O){var V=[Ge,Le].indexOf(O)>=0?1:-1,A=[Oe,Le].indexOf(O)>=0?"y":"x";L[O]+=ee[A]*V})}return L}function yf(e,t){t===void 0&&(t={});var n=t,r=n.placement,a=n.boundary,s=n.rootBoundary,i=n.padding,l=n.flipVariations,c=n.allowedAutoPlacements,d=c===void 0?Di:c,u=Jt(r),f=u?l?as:as.filter(function(x){return Jt(x)===u}):Ln,w=f.filter(function(x){return d.indexOf(x)>=0});w.length===0&&(w=f);var b=w.reduce(function(x,m){return x[m]=_n(e,{placement:m,boundary:a,rootBoundary:s,padding:i})[Ke(m)],x},{});return Object.keys(b).sort(function(x,m){return b[x]-b[m]})}function Nf(e){if(Ke(e)===ta)return[];var t=rr(e);return[ls(e),t,ls(t)]}function jf(e){var t=e.state,n=e.options,r=e.name;if(!t.modifiersData[r]._skip){for(var a=n.mainAxis,s=a===void 0?!0:a,i=n.altAxis,l=i===void 0?!0:i,c=n.fallbackPlacements,d=n.padding,u=n.boundary,f=n.rootBoundary,w=n.altBoundary,b=n.flipVariations,x=b===void 0?!0:b,m=n.allowedAutoPlacements,g=t.options.placement,j=Ke(g),S=j===g,E=c||(S||!x?[rr(g)]:Nf(g)),k=[g].concat(E).reduce(function(F,K){return F.concat(Ke(K)===ta?yf(t,{placement:K,boundary:u,rootBoundary:f,padding:d,flipVariations:x,allowedAutoPlacements:m}):K)},[]),v=t.rects.reference,P=t.rects.popper,D=new Map,T=!0,_=k[0],L=0;L<k.length;L++){var M=k[L],ee=Ke(M),O=Jt(M)===Yt,V=[Oe,Le].indexOf(ee)>=0,A=V?"width":"height",B=_n(t,{placement:M,boundary:u,rootBoundary:f,altBoundary:w,padding:d}),q=V?O?Ge:_e:O?Le:Oe;v[A]>P[A]&&(q=rr(q));var re=rr(q),ae=[];if(s&&ae.push(B[ee]<=0),l&&ae.push(B[q]<=0,B[re]<=0),ae.every(function(F){return F})){_=M,T=!1;break}D.set(M,ae)}if(T)for(var N=x?3:1,C=function(K){var Y=k.find(function(W){var H=D.get(W);if(H)return H.slice(0,K).every(function(Z){return Z})});if(Y)return _=Y,"break"},G=N;G>0;G--){var U=C(G);if(U==="break")break}t.placement!==_&&(t.modifiersData[r]._skip=!0,t.placement=_,t.reset=!0)}}const kf={name:"flip",enabled:!0,phase:"main",fn:jf,requiresIfExists:["offset"],data:{_skip:!1}};function ds(e,t,n){return n===void 0&&(n={x:0,y:0}),{top:e.top-t.height-n.y,right:e.right-t.width+n.x,bottom:e.bottom-t.height+n.y,left:e.left-t.width-n.x}}function us(e){return[Oe,Ge,Le,_e].some(function(t){return e[t]>=0})}function Sf(e){var t=e.state,n=e.name,r=t.rects.reference,a=t.rects.popper,s=t.modifiersData.preventOverflow,i=_n(t,{elementContext:"reference"}),l=_n(t,{altBoundary:!0}),c=ds(i,r),d=ds(l,a,s),u=us(c),f=us(d);t.modifiersData[n]={referenceClippingOffsets:c,popperEscapeOffsets:d,isReferenceHidden:u,hasPopperEscaped:f},t.attributes.popper=Object.assign({},t.attributes.popper,{"data-popper-reference-hidden":u,"data-popper-escaped":f})}const Ef={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:Sf};function Cf(e,t,n){var r=Ke(e),a=[_e,Oe].indexOf(r)>=0?-1:1,s=typeof n=="function"?n(Object.assign({},t,{placement:e})):n,i=s[0],l=s[1];return i=i||0,l=(l||0)*a,[_e,Ge].indexOf(r)>=0?{x:l,y:i}:{x:i,y:l}}function Tf(e){var t=e.state,n=e.options,r=e.name,a=n.offset,s=a===void 0?[0,0]:a,i=Di.reduce(function(u,f){return u[f]=Cf(f,t.rects,s),u},{}),l=i[t.placement],c=l.x,d=l.y;t.modifiersData.popperOffsets!=null&&(t.modifiersData.popperOffsets.x+=c,t.modifiersData.popperOffsets.y+=d),t.modifiersData[r]=i}const Rf={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:Tf};function Of(e){var t=e.state,n=e.name;t.modifiersData[n]=Ui({reference:t.rects.reference,element:t.rects.popper,strategy:"absolute",placement:t.placement})}const _f={name:"popperOffsets",enabled:!0,phase:"read",fn:Of,data:{}};function Pf(e){return e==="x"?"y":"x"}function If(e){var t=e.state,n=e.options,r=e.name,a=n.mainAxis,s=a===void 0?!0:a,i=n.altAxis,l=i===void 0?!1:i,c=n.boundary,d=n.rootBoundary,u=n.altBoundary,f=n.padding,w=n.tether,b=w===void 0?!0:w,x=n.tetherOffset,m=x===void 0?0:x,g=_n(t,{boundary:c,rootBoundary:d,padding:f,altBoundary:u}),j=Ke(t.placement),S=Jt(t.placement),E=!S,k=oa(j),v=Pf(k),P=t.modifiersData.popperOffsets,D=t.rects.reference,T=t.rects.popper,_=typeof m=="function"?m(Object.assign({},t.rects,{placement:t.placement})):m,L=typeof _=="number"?{mainAxis:_,altAxis:_}:Object.assign({mainAxis:0,altAxis:0},_),M=t.modifiersData.offset?t.modifiersData.offset[t.placement]:null,ee={x:0,y:0};if(P){if(s){var O,V=k==="y"?Oe:_e,A=k==="y"?Le:Ge,B=k==="y"?"height":"width",q=P[k],re=q+g[V],ae=q-g[A],N=b?-T[B]/2:0,C=S===Yt?D[B]:T[B],G=S===Yt?-T[B]:-D[B],U=t.elements.arrow,F=b&&U?ra(U):{width:0,height:0},K=t.modifiersData["arrow#persistent"]?t.modifiersData["arrow#persistent"].padding:Vi(),Y=K[V],W=K[A],H=kn(0,D[B],F[B]),Z=E?D[B]/2-N-H-Y-L.mainAxis:C-H-Y-L.mainAxis,Q=E?-D[B]/2+N+H+W+L.mainAxis:G+H+W+L.mainAxis,ue=t.elements.arrow&&Gn(t.elements.arrow),I=ue?k==="y"?ue.clientTop||0:ue.clientLeft||0:0,je=(O=M==null?void 0:M[k])!=null?O:0,z=q+Z-je-I,ye=q+Q-je,qe=kn(b?ur(re,z):re,q,b?jt(ae,ye):ae);P[k]=qe,ee[k]=qe-q}if(l){var mt,Ce=k==="x"?Oe:_e,qn=k==="x"?Le:Ge,He=P[v],It=v==="y"?"height":"width",ht=He+g[Ce],Mt=He-g[qn],$t=[Oe,_e].indexOf(j)!==-1,At=(mt=M==null?void 0:M[v])!=null?mt:0,gt=$t?ht:He-D[It]-T[It]-At+L.altAxis,rn=$t?He+D[It]+T[It]-At-L.altAxis:Mt,Hn=b&&$t?nf(gt,He,rn):kn(b?gt:ht,He,b?rn:Mt);P[v]=Hn,ee[v]=Hn-He}t.modifiersData[r]=ee}}const Mf={name:"preventOverflow",enabled:!0,phase:"main",fn:If,requiresIfExists:["offset"]};function $f(e){return{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}}function Af(e){return e===Be(e)||!Fe(e)?aa(e):$f(e)}function Df(e){var t=e.getBoundingClientRect(),n=Wt(t.width)/e.offsetWidth||1,r=Wt(t.height)/e.offsetHeight||1;return n!==1||r!==1}function Bf(e,t,n){n===void 0&&(n=!1);var r=Fe(t),a=Fe(t)&&Df(t),s=ft(t),i=Kt(e,a,n),l={scrollLeft:0,scrollTop:0},c={x:0,y:0};return(r||!r&&!n)&&((Qe(t)!=="body"||ia(s))&&(l=Af(t)),Fe(t)?(c=Kt(t,!0),c.x+=t.clientLeft,c.y+=t.clientTop):s&&(c.x=sa(s))),{x:i.left+l.scrollLeft-c.x,y:i.top+l.scrollTop-c.y,width:i.width,height:i.height}}function zf(e){var t=new Map,n=new Set,r=[];e.forEach(function(s){t.set(s.name,s)});function a(s){n.add(s.name);var i=[].concat(s.requires||[],s.requiresIfExists||[]);i.forEach(function(l){if(!n.has(l)){var c=t.get(l);c&&a(c)}}),r.push(s)}return e.forEach(function(s){n.has(s.name)||a(s)}),r}function Vf(e){var t=zf(e);return Kw.reduce(function(n,r){return n.concat(t.filter(function(a){return a.phase===r}))},[])}function Ff(e){var t;return function(){return t||(t=new Promise(function(n){Promise.resolve().then(function(){t=void 0,n(e())})})),t}}function Lf(e){var t=e.reduce(function(n,r){var a=n[r.name];return n[r.name]=a?Object.assign({},a,r,{options:Object.assign({},a.options,r.options),data:Object.assign({},a.data,r.data)}):r,n},{});return Object.keys(t).map(function(n){return t[n]})}var ps={placement:"bottom",modifiers:[],strategy:"absolute"};function ws(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return!t.some(function(r){return!(r&&typeof r.getBoundingClientRect=="function")})}function Gf(e){e===void 0&&(e={});var t=e,n=t.defaultModifiers,r=n===void 0?[]:n,a=t.defaultOptions,s=a===void 0?ps:a;return function(l,c,d){d===void 0&&(d=s);var u={placement:"bottom",orderedModifiers:[],options:Object.assign({},ps,s),modifiersData:{},elements:{reference:l,popper:c},attributes:{},styles:{}},f=[],w=!1,b={state:u,setOptions:function(j){var S=typeof j=="function"?j(u.options):j;m(),u.options=Object.assign({},s,u.options,S),u.scrollParents={reference:Ot(l)?Sn(l):l.contextElement?Sn(l.contextElement):[],popper:Sn(c)};var E=Vf(Lf([].concat(r,u.options.modifiers)));return u.orderedModifiers=E.filter(function(k){return k.enabled}),x(),b.update()},forceUpdate:function(){if(!w){var j=u.elements,S=j.reference,E=j.popper;if(ws(S,E)){u.rects={reference:Bf(S,Gn(E),u.options.strategy==="fixed"),popper:ra(E)},u.reset=!1,u.placement=u.options.placement,u.orderedModifiers.forEach(function(L){return u.modifiersData[L.name]=Object.assign({},L.data)});for(var k=0;k<u.orderedModifiers.length;k++){if(u.reset===!0){u.reset=!1,k=-1;continue}var v=u.orderedModifiers[k],P=v.fn,D=v.options,T=D===void 0?{}:D,_=v.name;typeof P=="function"&&(u=P({state:u,options:T,name:_,instance:b})||u)}}}},update:Ff(function(){return new Promise(function(g){b.forceUpdate(),g(u)})}),destroy:function(){m(),w=!0}};if(!ws(l,c))return b;b.setOptions(d).then(function(g){!w&&d.onFirstUpdate&&d.onFirstUpdate(g)});function x(){u.orderedModifiers.forEach(function(g){var j=g.name,S=g.options,E=S===void 0?{}:S,k=g.effect;if(typeof k=="function"){var v=k({state:u,name:j,instance:b,options:E}),P=function(){};f.push(v||P)}})}function m(){f.forEach(function(g){return g()}),f=[]}return b}}var Uf=[wf,_f,uf,Qw,Rf,kf,Mf,sf,Ef],qf=Gf({defaultModifiers:Uf});const qi="Popper";function Hf(e){return $i(qi,e)}Dw(qi,["root"]);const Xf=["anchorEl","children","direction","disablePortal","modifiers","open","placement","popperOptions","popperRef","slotProps","slots","TransitionProps","ownerState"],Yf=["anchorEl","children","container","direction","disablePortal","keepMounted","modifiers","open","placement","popperOptions","popperRef","style","transition","slotProps","slots"];function Wf(e,t){if(t==="ltr")return e;switch(e){case"bottom-end":return"bottom-start";case"bottom-start":return"bottom-end";case"top-end":return"top-start";case"top-start":return"top-end";default:return e}}function pr(e){return typeof e=="function"?e():e}function Mr(e){return e.nodeType!==void 0}function Kf(e){return!Mr(e)}const Jf=()=>Uo({root:["root"]},Rw(Hf)),Zf={},Qf=$.forwardRef(function(t,n){var r;const{anchorEl:a,children:s,direction:i,disablePortal:l,modifiers:c,open:d,placement:u,popperOptions:f,popperRef:w,slotProps:b={},slots:x={},TransitionProps:m}=t,g=ke(t,Xf),j=$.useRef(null),S=Tt(j,n),E=$.useRef(null),k=Tt(E,w),v=$.useRef(k);Xt(()=>{v.current=k},[k]),$.useImperativeHandle(w,()=>E.current,[]);const P=Wf(u,i),[D,T]=$.useState(P),[_,L]=$.useState(pr(a));$.useEffect(()=>{E.current&&E.current.forceUpdate()}),$.useEffect(()=>{a&&L(pr(a))},[a]),Xt(()=>{if(!_||!d)return;const A=re=>{T(re.placement)};if(process.env.NODE_ENV!=="production"&&_&&Mr(_)&&_.nodeType===1){const re=_.getBoundingClientRect();process.env.NODE_ENV!=="test"&&re.top===0&&re.left===0&&re.right===0&&re.bottom===0&&console.warn(["MUI: The `anchorEl` prop provided to the component is invalid.","The anchor element should be part of the document layout.","Make sure the element is present in the document or that it's not display none."].join(`
`))}let B=[{name:"preventOverflow",options:{altBoundary:l}},{name:"flip",options:{altBoundary:l}},{name:"onUpdate",enabled:!0,phase:"afterWrite",fn:({state:re})=>{A(re)}}];c!=null&&(B=B.concat(c)),f&&f.modifiers!=null&&(B=B.concat(f.modifiers));const q=qf(_,j.current,R({placement:P},f,{modifiers:B}));return v.current(q),()=>{q.destroy(),v.current(null)}},[_,l,c,d,f,P]);const M={placement:D};m!==null&&(M.TransitionProps=m);const ee=Jf(),O=(r=x.root)!=null?r:"div",V=Mw({elementType:O,externalSlotProps:b.root,externalForwardedProps:g,additionalProps:{role:"tooltip",ref:S},ownerState:t,className:ee.root});return o.jsx(O,R({},V,{children:typeof s=="function"?s(M):s}))}),Hi=$.forwardRef(function(t,n){const{anchorEl:r,children:a,container:s,direction:i="ltr",disablePortal:l=!1,keepMounted:c=!1,modifiers:d,open:u,placement:f="bottom",popperOptions:w=Zf,popperRef:b,style:x,transition:m=!1,slotProps:g={},slots:j={}}=t,S=ke(t,Yf),[E,k]=$.useState(!0),v=()=>{k(!1)},P=()=>{k(!0)};if(!c&&!u&&(!m||E))return null;let D;if(s)D=s;else if(r){const L=pr(r);D=L&&Mr(L)?ir(L).body:ir(null).body}const T=!u&&c&&(!m||E)?"none":void 0,_=m?{in:u,onEnter:v,onExited:P}:void 0;return o.jsx(dr,{disablePortal:l,container:D,children:o.jsx(Qf,R({anchorEl:r,direction:i,disablePortal:l,modifiers:d,ref:n,open:m?!E:u,placement:f,popperOptions:w,popperRef:b,slotProps:g,slots:j},S,{style:R({position:"fixed",top:0,left:0,display:T},x),TransitionProps:_,children:a}))})});process.env.NODE_ENV!=="production"&&(Hi.propTypes={anchorEl:Lo(p.oneOfType([Tn,p.object,p.func]),e=>{if(e.open){const t=pr(e.anchorEl);if(t&&Mr(t)&&t.nodeType===1){const n=t.getBoundingClientRect();if(process.env.NODE_ENV!=="test"&&n.top===0&&n.left===0&&n.right===0&&n.bottom===0)return new Error(["MUI: The `anchorEl` prop provided to the component is invalid.","The anchor element should be part of the document layout.","Make sure the element is present in the document or that it's not display none."].join(`
