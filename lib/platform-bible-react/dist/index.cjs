...
`)):(c._=!0,y=b.replace(us,""));const O=l(y,c);return c._=w,c.o=E,O}),m:n,g:d}},h:(s,l,c)=>e(s.m?"ol":"ul",{key:c.k,start:s.g},s.p.map(function(d,m){return e("li",{key:m},l(d,c))}))}}const ib=/^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,lb=/^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,Tl=[sl,il,ll,cl,ul,pl,dl,fl,yl,El,wl,kl],cb=[...Tl,/^[^\n]+(?:  \n|\n{2,})/,ho,go];function pb(e){return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g,"a").replace(/[çÇ]/g,"c").replace(/[ðÐ]/g,"d").replace(/[ÈÉÊËéèêë]/g,"e").replace(/[ÏïÎîÍíÌì]/g,"i").replace(/[Ññ]/g,"n").replace(/[øØœŒÕõÔôÓóÒò]/g,"o").replace(/[ÜüÛûÚúÙù]/g,"u").replace(/[ŸÿÝý]/g,"y").replace(/[^a-z0-9- ]/gi,"").replace(/ /gi,"-").toLowerCase()}function ub(e){return Xg.test(e)?"right":qg.test(e)?"center":Wg.test(e)?"left":null}function fs(e,t,n){const r=n.$;n.$=!0;const o=t(e.trim(),n);n.$=r;let a=[[]];return o.forEach(function(s,l){s.type==="tableSeparator"?l!==0&&l!==o.length-1&&a.push([]):(s.type!=="text"||o[l+1]!=null&&o[l+1].type!=="tableSeparator"||(s.v=s.v.replace(Gg,"")),a[a.length-1].push(s))}),a}function db(e,t,n){n._=!0;const r=fs(e[1],t,n),o=e[2].replace(Hg,"").split("|").map(ub),a=function(s,l,c){return s.trim().split(`
...
`,a.trim()));const o=r.trimEnd();return o==""?null:[r,o]}function qt(e){try{if(decodeURIComponent(e).replace(/[^A-Za-z0-9/:]/g,"").match(/^\s*(javascript|vbscript|data(?!:image)):/i))return}catch{return null}return e}function hs(e){return e.replace(rb,"$1")}function lr(e,t,n){const r=n._||!1,o=n.u||!1;n._=!0,n.u=!0;const a=e(t,n);return n._=r,n.u=o,a}function mb(e,t,n){const r=n._||!1,o=n.u||!1;n._=!1,n.u=!0;const a=e(t,n);return n._=r,n.u=o,a}function hb(e,t,n){return n._=!1,e(t,n)}const Yr=(e,t,n)=>({v:lr(t,e[1],n)});function Kr(){return{}}function Jr(){return null}function gb(...e){return e.filter(Boolean).join(" ")}function Zr(e,t,n){let r=e;const o=t.split(".");for(;o.length&&(r=r[o[0]],r!==void 0);)o.shift();return r||n}var oe;function bb(e,t={}){t.overrides=t.overrides||{},t.slugify=t.slugify||pb,t.namedCodesToUnicode=t.namedCodesToUnicode?jt({},ps,t.namedCodesToUnicode):ps;const n=t.createElement||N.createElement;function r(u,h,...f){const b=Zr(t.overrides,`${u}.props`,{});return n(function(x,j){const w=Zr(j,x);return w?typeof w=="function"||typeof w=="object"&&"render"in w?w:Zr(j,`${x}.component`,x):x}(u,t.overrides),jt({},h,b,{className:gb(h==null?void 0:h.className,b.className)||void 0}),...f)}function o(u){let h=!1;t.forceInline?h=!0:t.forceBlock||(h=Fg.test(u)===!1);const f=m(d(h?u:`${u.trimEnd().replace(tb,"")}

`,{_:h}));for(;typeof f[f.length-1]=="string"&&!f[f.length-1].trim();)f.pop();if(t.wrapper===null)return f;const b=t.wrapper||(h?"span":"div");let x;if(f.length>1||t.forceWrapper)x=f;else{if(f.length===1)return x=f[0],typeof x=="string"?r("span",{key:"outer"},x):x;x=null}return N.createElement(b,{key:"outer"},x)}function a(u){const h=u.match(bg);return h?h.reduce(function(f,b,x){const j=b.indexOf("=");if(j!==-1){const w=function(C){return C.indexOf("-")!==-1&&C.match(jg)===null&&(C=C.replace(Ag,function(I,D){return D.toUpperCase()})),C}(b.slice(0,j)).trim(),E=function(C){const I=C[0];return(I==='"'||I==="'")&&C.length>=2&&C[C.length-1]===I?C.slice(1,-1):C}(b.slice(j+1).trim()),y=cs[w]||w,O=f[y]=function(C,I){return C==="style"?I.split(/;\s?/).reduce(function(D,L){const k=L.slice(0,L.indexOf(":"));return D[k.replace(/(-[a-z])/g,S=>S[1].toUpperCase())]=L.slice(k.length+1).trim(),D},{}):C==="href"?qt(I):(I.match($g)&&(I=I.slice(1,I.length-1)),I==="true"||I!=="false"&&I)}(w,E);typeof O=="string"&&(ho.test(O)||go.test(O))&&(f[y]=N.cloneElement(o(O.trim()),{key:x}))}else b!=="style"&&(f[cs[b]||b]=!0);return f},{}):null}const s=[],l={},c={blockQuote:{t:it(sl),i:oe.HIGH,l:(u,h,f)=>({v:h(u[0].replace(wg,""),f)}),h:(u,h,f)=>r("blockquote",{key:f.k},h(u.v,f))},breakLine:{t:vn(xg),i:oe.HIGH,l:Kr,h:(u,h,f)=>r("br",{key:f.k})},breakThematic:{t:it(Eg),i:oe.HIGH,l:Kr,h:(u,h,f)=>r("hr",{key:f.k})},codeBlock:{t:it(ll),i:oe.MAX,l:u=>({v:u[0].replace(/^ {4}/gm,"").replace(/\n+$/,""),M:void 0}),h:(u,h,f)=>r("pre",{key:f.k},r("code",jt({},u.O,{className:u.M?`lang-${u.M}`:""}),u.v))},codeFenced:{t:it(il),i:oe.MAX,l:u=>({O:a(u[3]||""),v:u[4],M:u[2]||void 0,type:"codeBlock"})},codeInline:{t:bt(kg),i:oe.LOW,l:u=>({v:u[2]}),h:(u,h,f)=>r("code",{key:f.k},u.v)},footnote:{t:it(Cg),i:oe.MAX,l:u=>(s.push({I:u[2],j:u[1]}),{}),h:Jr},footnoteReference:{t:gt(Sg),i:oe.HIGH,l:u=>({v:u[1],B:`#${t.slugify(u[1])}`}),h:(u,h,f)=>r("a",{key:f.k,href:qt(u.B)},r("sup",{key:f.k},u.v))},gfmTask:{t:gt(Rg),i:oe.HIGH,l:u=>({R:u[1].toLowerCase()==="x"}),h:(u,h,f)=>r("input",{checked:u.R,key:f.k,readOnly:!0,type:"checkbox"})},heading:{t:it(t.enforceAtxHeadings?pl:cl),i:oe.HIGH,l:(u,h,f)=>({v:lr(h,u[2],f),T:t.slugify(u[2]),C:u[1].length}),h:(u,h,f)=>r(`h${u.C}`,{id:u.T,key:f.k},h(u.v,f))},headingSetext:{t:it(ul),i:oe.MAX,l:(u,h,f)=>({v:lr(h,u[1],f),C:u[2]==="="?1:2,type:"heading"})},htmlComment:{t:vn(dl),i:oe.HIGH,l:()=>({}),h:Jr},image:{t:bt(lb),i:oe.HIGH,l:u=>({D:u[1],B:hs(u[2]),F:u[3]}),h:(u,h,f)=>r("img",{key:f.k,alt:u.D||void 0,title:u.F||void 0,src:qt(u.B)})},link:{t:gt(ib),i:oe.LOW,l:(u,h,f)=>({v:mb(h,u[1],f),B:hs(u[2]),F:u[3]}),h:(u,h,f)=>r("a",{key:f.k,href:qt(u.B),title:u.F},h(u.v,f))},linkAngleBraceStyleDetector:{t:gt(Ig),i:oe.MAX,l:u=>({v:[{v:u[1],type:"text"}],B:u[1],type:"link"})},linkBareUrlDetector:{t:(u,h)=>h.N?null:gt(_g)(u,h),i:oe.MAX,l:u=>({v:[{v:u[1],type:"text"}],B:u[1],F:void 0,type:"link"})},linkMailtoDetector:{t:gt(Mg),i:oe.MAX,l(u){let h=u[1],f=u[1];return vg.test(f)||(f="mailto:"+f),{v:[{v:h.replace("mailto:",""),type:"text"}],B:f,type:"link"}}},orderedList:ds(r,1),unorderedList:ds(r,2),newlineCoalescer:{t:it(Tg),i:oe.LOW,l:Kr,h:()=>`
`},paragraph:{t:fb,i:oe.LOW,l:Yr,h:(u,h,f)=>r("p",{key:f.k},h(u.v,f))},ref:{t:gt(Dg),i:oe.MAX,l:u=>(l[u[1]]={B:u[2],F:u[4]},{}),h:Jr},refImage:{t:bt(Bg),i:oe.MAX,l:u=>({D:u[1]||void 0,P:u[2]}),h:(u,h,f)=>r("img",{key:f.k,alt:u.D,src:qt(l[u.P].B),title:l[u.P].F})},refLink:{t:gt(Lg),i:oe.MAX,l:(u,h,f)=>({v:h(u[1],f),Z:h(u[0].replace(Vg,"\\$1"),f),P:u[2]}),h:(u,h,f)=>l[u.P]?r("a",{key:f.k,href:qt(l[u.P].B),title:l[u.P].F},h(u.v,f)):r("span",{key:f.k},h(u.Z,f))},table:{t:it(fl),i:oe.HIGH,l:db,h:(u,h,f)=>r("table",{key:f.k},r("thead",null,r("tr",null,u.L.map(function(b,x){return r("th",{key:x,style:ms(u,x)},h(b,f))}))),r("tbody",null,u.A.map(function(b,x){return r("tr",{key:x},b.map(function(j,w){return r("td",{key:w,style:ms(u,w)},h(j,f))}))})))},tableSeparator:{t:function(u,h){return h.$?(h._=!0,Ug.exec(u)):null},i:oe.HIGH,l:function(){return{type:"tableSeparator"}},h:()=>" | "},text:{t:vn(eb),i:oe.MIN,l:u=>({v:u[0].replace(Pg,(h,f)=>t.namedCodesToUnicode[f]?t.namedCodesToUnicode[f]:h)}),h:u=>u.v},textBolded:{t:bt(Yg),i:oe.MED,l:(u,h,f)=>({v:h(u[2],f)}),h:(u,h,f)=>r("strong",{key:f.k},h(u.v,f))},textEmphasized:{t:bt(Kg),i:oe.LOW,l:(u,h,f)=>({v:h(u[2],f)}),h:(u,h,f)=>r("em",{key:f.k},h(u.v,f))},textEscaped:{t:bt(Qg),i:oe.HIGH,l:u=>({v:u[1],type:"text"})},textMarked:{t:bt(Jg),i:oe.LOW,l:Yr,h:(u,h,f)=>r("mark",{key:f.k},h(u.v,f))},textStrikethroughed:{t:bt(Zg),i:oe.LOW,l:Yr,h:(u,h,f)=>r("del",{key:f.k},h(u.v,f))}};t.disableParsingRawHTML!==!0&&(c.htmlBlock={t:vn(ho),i:oe.HIGH,l(u,h,f){const[,b]=u[3].match(nb),x=new RegExp(`^${b}`,"gm"),j=u[3].replace(x,""),w=(E=j,cb.some(I=>I.test(E))?hb:lr);var E;const y=u[1].toLowerCase(),O=gg.indexOf(y)!==-1;f.N=f.N||y==="a";const C=O?u[3]:w(h,j,f);return f.N=!1,{O:a(u[2]),v:C,G:O,H:O?y:u[1]}},h:(u,h,f)=>r(u.H,jt({key:f.k},u.O),u.G?u.v:h(u.v,f))},c.htmlSelfClosing={t:vn(go),i:oe.HIGH,l:u=>({O:a(u[2]||""),H:u[1]}),h:(u,h,f)=>r(u.H,jt({},u.O,{key:f.k}))});const d=function(u){let h=Object.keys(u);function f(b,x){let j=[],w="";for(;b;){let E=0;for(;E<h.length;){const y=h[E],O=u[y],C=O.t(b,x,w);if(C){const I=C[0];b=b.substring(I.length);const D=O.l(C,f,x);D.type==null&&(D.type=y),j.push(D),w=I;break}E++}}return j}return h.sort(function(b,x){let j=u[b].i,w=u[x].i;return j!==w?j-w:b<x?-1:1}),function(b,x){return f(function(j){return j.replace(Ng,`
`).replace(Og,"").replace(zg,"    ")}(b),x)}}(c),m=(v=function(u){return function(h,f,b){return u[h.type].h(h,f,b)}}(c),function u(h,f={}){if(Array.isArray(h)){const b=f.k,x=[];let j=!1;for(let w=0;w<h.length;w++){f.k=w;const E=u(h[w],f),y=typeof E=="string";y&&j?x[x.length-1]+=E:E!==null&&x.push(E),j=y}return f.k=b,x}return v(h,u,f)});var v;const g=o(e);return s.length?r("div",null,g,r("footer",{key:"footer"},s.map(function(u){return r("div",{id:t.slugify(u.j),key:u.j},u.j,m(d(u.I,{_:!0})))}))):g}(function(e){e[e.MAX=0]="MAX",e[e.HIGH=1]="HIGH",e[e.MED=2]="MED",e[e.LOW=3]="LOW",e[e.MIN=4]="MIN"})(oe||(oe={}));const vb=e=>{let{children:t,options:n}=e,r=function(o,a){if(o==null)return{};var s,l,c={},d=Object.keys(o);for(l=0;l<d.length;l++)a.indexOf(s=d[l])>=0||(c[s]=o[s]);return c}(e,hg);return N.cloneElement(bb(t,n),r)};function yb({markdown:e}){return p.jsx("div",{className:"pr-prose",children:p.jsx(vb,{children:e})})}const wb=(e,t)=>{T.useEffect(()=>{if(!e)return()=>{};const n=e(t);return()=>{n()}},[e,t])},Qr=()=>!1,xb=(e,t)=>{const[n]=br(T.useCallback(async()=>{if(!e)return Qr;const r=await Promise.resolve(e(t));return async()=>r()},[t,e]),Qr,{preserveValue:!1});T.useEffect(()=>()=>{n!==Qr&&n()},[n])},Nl=T.forwardRef(({className:e,...t},n)=>p.jsx("div",{ref:n,className:F("pr-rounded-lg pr-border pr-bg-card pr-text-card-foreground pr-shadow-sm",e),...t}));Nl.displayName="Card";const Cl=T.forwardRef(({className:e,...t},n)=>p.jsx("div",{ref:n,className:F("pr-flex pr-flex-col pr-space-y-1.5 pr-p-6",e),...t}));Cl.displayName="CardHeader";const Sl=T.forwardRef(({className:e,...t},n)=>p.jsx("h3",{ref:n,className:F("pr-text-2xl pr-font-semibold pr-leading-none pr-tracking-tight",e),...t,children:t.children}));Sl.displayName="CardTitle";const Ol=T.forwardRef(({className:e,...t},n)=>p.jsx("p",{ref:n,className:F("pr-text-sm pr-text-muted-foreground",e),...t}));Ol.displayName="CardDescription";const Rl=T.forwardRef(({className:e,...t},n)=>p.jsx("div",{ref:n,className:F("pr-p-6 pr-pt-0",e),...t}));Rl.displayName="CardContent";const Pl=T.forwardRef(({className:e,...t},n)=>p.jsx("div",{ref:n,className:F("pr-flex pr-items-center pr-p-6 pr-pt-0",e),...t}));Pl.displayName="CardFooter";const Eb=bo.cva("pr-relative pr-w-full pr-rounded-lg pr-border pr-p-4 [&>svg~*]:pr-pl-7 [&>svg+div]:pr-translate-y-[-3px] [&>svg]:pr-absolute [&>svg]:pr-left-4 [&>svg]:pr-top-4 [&>svg]:pr-text-foreground",{variants:{variant:{default:"pr-bg-background pr-text-foreground",destructive:"pr-border-destructive/50 pr-text-destructive dark:pr-border-destructive [&>svg]:pr-text-destructive"}},defaultVariants:{variant:"default"}}),jl=T.forwardRef(({className:e,variant:t,...n},r)=>p.jsx("div",{ref:r,role:"alert",className:F(Eb({variant:t}),e),...n}));jl.displayName="Alert";const $l=T.forwardRef(({className:e,...t},n)=>p.jsxs("h5",{ref:n,className:F("pr-mb-1 pr-font-medium pr-leading-none pr-tracking-tight",e),...t,children:[t.children," "]}));$l.displayName="AlertTitle";const _l=T.forwardRef(({className:e,...t},n)=>p.jsx("div",{ref:n,className:F("pr-text-sm [&_p]:pr-leading-relaxed",e),...t}));_l.displayName="AlertDescription";const Ml=T.forwardRef(({className:e,...t},n)=>p.jsxs(wn.Root,{ref:n,className:F("pr-relative pr-flex pr-w-full pr-touch-none pr-select-none pr-items-center",e),...t,children:[p.jsx(wn.Track,{className:"pr-relative pr-h-2 pr-w-full pr-grow pr-overflow-hidden pr-rounded-full pr-bg-secondary",children:p.jsx(wn.Range,{className:"pr-absolute pr-h-full pr-bg-primary"})}),p.jsx(wn.Thumb,{className:"pr-block pr-h-5 pr-w-5 pr-rounded-full pr-border-2 pr-border-primary pr-bg-background pr-ring-offset-background pr-transition-colors focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2 disabled:pr-pointer-events-none disabled:pr-opacity-50"})]}));Ml.displayName=wn.Root.displayName;const Il=T.forwardRef(({className:e,...t},n)=>p.jsx(to.Root,{className:F("pr-peer pr-inline-flex pr-h-6 pr-w-11 pr-shrink-0 pr-cursor-pointer pr-items-center pr-rounded-full pr-border-2 pr-border-transparent pr-transition-colors focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2 focus-visible:pr-ring-offset-background disabled:pr-cursor-not-allowed disabled:pr-opacity-50 data-[state=checked]:pr-bg-primary data-[state=unchecked]:pr-bg-input",e),...t,ref:n,children:p.jsx(to.Thumb,{className:F("pr-pointer-events-none pr-block pr-h-5 pr-w-5 pr-rounded-full pr-bg-background pr-shadow-lg pr-ring-0 pr-transition-transform data-[state=checked]:pr-translate-x-5 data-[state=unchecked]:pr-translate-x-0")})}));Il.displayName=to.Root.displayName;exports.Alert=jl;exports.AlertDescription=_l;exports.AlertTitle=$l;exports.BookChapterControl=$c;exports.Button=ye;exports.Card=Nl;exports.CardContent=Rl;exports.CardDescription=Ol;exports.CardFooter=Pl;exports.CardHeader=Cl;exports.CardTitle=Sl;exports.ChapterRangeSelector=Hc;exports.CharacterInventory=ug;exports.Checkbox=Us;exports.Checklist=Gc;exports.ComboBox=no;exports.ContextMenu=zh;exports.DataTable=Is;exports.DownloadButton=dg;exports.DropdownMenu=xo;exports.DropdownMenuCheckboxItem=ko;exports.DropdownMenuContent=vr;exports.DropdownMenuGroup=bc;exports.DropdownMenuItem=Eo;exports.DropdownMenuLabel=Dn;exports.DropdownMenuPortal=vc;exports.DropdownMenuRadioGroup=wc;exports.DropdownMenuRadioItem=Ss;exports.DropdownMenuSeparator=yr;exports.DropdownMenuShortcut=Os;exports.DropdownMenuSub=yc;exports.DropdownMenuSubContent=Cs;exports.DropdownMenuSubTrigger=Ns;exports.DropdownMenuTrigger=Ts;exports.GridMenu=Li;exports.HamburgerMenuButton=Ji;exports.IconButton=Gh;exports.Input=Bn;exports.Label=Xo;exports.LabelPosition=Rt;exports.MarkdownRenderer=yb;exports.MenuItem=qo;exports.RemoveButton=fg;exports.ScriptureResultsViewer=Zh;exports.SearchBar=eg;exports.Select=Pn;exports.SelectContent=Jt;exports.SelectGroup=$s;exports.SelectItem=Ye;exports.SelectLabel=_s;exports.SelectScrollDownButton=No;exports.SelectScrollUpButton=To;exports.SelectSeparator=Ms;exports.SelectTrigger=Kt;exports.SelectValue=jn;exports.ShadCnSlider=Ml;exports.ShadCnSwitch=Il;exports.Slider=tg;exports.Snackbar=ng;exports.Switch=rg;exports.Table=Ln;exports.TableBody=Fn;exports.TableCaption=Ps;exports.TableCell=Mt;exports.TableFooter=Rs;exports.TableHead=Yt;exports.TableHeader=Vn;exports.TableRow=lt;exports.Tabs=ag;exports.TabsContent=nl;exports.TabsList=el;exports.TabsTrigger=tl;exports.TextField=Qi;exports.Toolbar=og;exports.UpdateButton=mg;exports.VerticalTabs=rl;exports.VerticalTabsContent=al;exports.VerticalTabsList=ol;exports.VerticalTabsTrigger=sg;exports.buttonVariants=js;exports.useEvent=wb;exports.useEventAsync=xb;exports.usePromise=br;function kb(e,t="top"){if(!e||typeof document>"u")return;const n=document.head||document.querySelector("head"),r=n.querySelector(":first-child"),o=document.createElement("style");o.appendChild(document.createTextNode(e)),t==="top"&&r?n.insertBefore(o,r):n.appendChild(o)}kb(`/*
