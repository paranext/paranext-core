...
(c) Sindre Sorhus
@license MIT
*/var Pr,ha;function wd(){if(ha)return Pr;ha=1;var e=Object.getOwnPropertySymbols,t=Object.prototype.hasOwnProperty,n=Object.prototype.propertyIsEnumerable;function r(s){if(s==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(s)}function o(){try{if(!Object.assign)return!1;var s=new String("abc");if(s[5]="de",Object.getOwnPropertyNames(s)[0]==="5")return!1;for(var i={},l=0;l<10;l++)i["_"+String.fromCharCode(l)]=l;var c=Object.getOwnPropertyNames(i).map(function(u){return i[u]});if(c.join("")!=="0123456789")return!1;var d={};return"abcdefghijklmnopqrst".split("").forEach(function(u){d[u]=u}),Object.keys(Object.assign({},d)).join("")==="abcdefghijklmnopqrst"}catch{return!1}}return Pr=o()?Object.assign:function(s,i){for(var l,c=r(s),d,u=1;u<arguments.length;u++){l=Object(arguments[u]);for(var m in l)t.call(l,m)&&(c[m]=l[m]);if(e){d=e(l);for(var f=0;f<d.length;f++)n.call(l,d[f])&&(c[d[f]]=l[d[f]])}}return c},Pr}var Ir,ga;function Co(){if(ga)return Ir;ga=1;var e="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return Ir=e,Ir}var $r,ba;function Js(){return ba||(ba=1,$r=Function.call.bind(Object.prototype.hasOwnProperty)),$r}var Mr,va;function fd(){if(va)return Mr;va=1;var e=function(){};if(process.env.NODE_ENV!=="production"){var t=Co(),n={},r=Js();e=function(s){var i="Warning: "+s;typeof console<"u"&&console.error(i);try{throw new Error(i)}catch{}}}function o(s,i,l,c,d){if(process.env.NODE_ENV!=="production"){for(var u in s)if(r(s,u)){var m;try{if(typeof s[u]!="function"){var f=Error((c||"React class")+": "+l+" type `"+u+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof s[u]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw f.name="Invariant Violation",f}m=s[u](i,u,c,l,null,t)}catch(v){m=v}if(m&&!(m instanceof Error)&&e((c||"React class")+": type specification of "+l+" `"+u+"` is invalid; the type checker function must return `null` or an `Error` but returned a "+typeof m+". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."),m instanceof Error&&!(m.message in n)){n[m.message]=!0;var b=d?d():"";e("Failed "+l+" type: "+m.message+(b??""))}}}}return o.resetWarningCache=function(){process.env.NODE_ENV!=="production"&&(n={})},Mr=o,Mr}var Dr,xa;function md(){if(xa)return Dr;xa=1;var e=Ks(),t=wd(),n=Co(),r=Js(),o=fd(),s=function(){};process.env.NODE_ENV!=="production"&&(s=function(l){var c="Warning: "+l;typeof console<"u"&&console.error(c);try{throw new Error(c)}catch{}});function i(){return null}return Dr=function(l,c){var d=typeof Symbol=="function"&&Symbol.iterator,u="@@iterator";function m(y){var T=y&&(d&&y[d]||y[u]);if(typeof T=="function")return T}var f="<<anonymous>>",b={array:k("array"),bigint:k("bigint"),bool:k("boolean"),func:k("function"),number:k("number"),object:k("object"),string:k("string"),symbol:k("symbol"),any:P(),arrayOf:E,element:j(),elementType:x(),instanceOf:O,node:_(),objectOf:U,oneOf:A,oneOfType:C,shape:D,exact:$};function v(y,T){return y===T?y!==0||1/y===1/T:y!==y&&T!==T}function w(y,T){this.message=y,this.data=T&&typeof T=="object"?T:{},this.stack=""}w.prototype=Error.prototype;function h(y){if(process.env.NODE_ENV!=="production")var T={},z=0;function F(X,q,H,G,J,Q,ue){if(G=G||f,Q=Q||H,ue!==n){if(c){var I=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use `PropTypes.checkPropTypes()` to call them. Read more at http://fb.me/use-check-prop-types");throw I.name="Invariant Violation",I}else if(process.env.NODE_ENV!=="production"&&typeof console<"u"){var xe=G+":"+H;!T[xe]&&z<3&&(s("You are manually calling a React.PropTypes validation function for the `"+Q+"` prop on `"+G+"`. This is deprecated and will throw in the standalone `prop-types` package. You may be seeing this warning due to a third-party PropTypes library. See https://fb.me/react-warning-dont-call-proptypes for details."),T[xe]=!0,z++)}}return q[H]==null?X?q[H]===null?new w("The "+J+" `"+Q+"` is marked as required "+("in `"+G+"`, but its value is `null`.")):new w("The "+J+" `"+Q+"` is marked as required in "+("`"+G+"`, but its value is `undefined`.")):null:y(q,H,G,J,Q)}var V=F.bind(null,!1);return V.isRequired=F.bind(null,!0),V}function k(y){function T(z,F,V,X,q,H){var G=z[F],J=L(G);if(J!==y){var Q=te(G);return new w("Invalid "+X+" `"+q+"` of type "+("`"+Q+"` supplied to `"+V+"`, expected ")+("`"+y+"`."),{expectedType:y})}return null}return h(T)}function P(){return h(i)}function E(y){function T(z,F,V,X,q){if(typeof y!="function")return new w("Property `"+q+"` of component `"+V+"` has invalid PropType notation inside arrayOf.");var H=z[F];if(!Array.isArray(H)){var G=L(H);return new w("Invalid "+X+" `"+q+"` of type "+("`"+G+"` supplied to `"+V+"`, expected an array."))}for(var J=0;J<H.length;J++){var Q=y(H,J,V,X,q+"["+J+"]",n);if(Q instanceof Error)return Q}return null}return h(T)}function j(){function y(T,z,F,V,X){var q=T[z];if(!l(q)){var H=L(q);return new w("Invalid "+V+" `"+X+"` of type "+("`"+H+"` supplied to `"+F+"`, expected a single ReactElement."))}return null}return h(y)}function x(){function y(T,z,F,V,X){var q=T[z];if(!e.isValidElementType(q)){var H=L(q);return new w("Invalid "+V+" `"+X+"` of type "+("`"+H+"` supplied to `"+F+"`, expected a single ReactElement type."))}return null}return h(y)}function O(y){function T(z,F,V,X,q){if(!(z[F]instanceof y)){var H=y.name||f,G=oe(z[F]);return new w("Invalid "+X+" `"+q+"` of type "+("`"+G+"` supplied to `"+V+"`, expected ")+("instance of `"+H+"`."))}return null}return h(T)}function A(y){if(!Array.isArray(y))return process.env.NODE_ENV!=="production"&&(arguments.length>1?s("Invalid arguments supplied to oneOf, expected an array, got "+arguments.length+" arguments. A common mistake is to write oneOf(x, y, z) instead of oneOf([x, y, z])."):s("Invalid argument supplied to oneOf, expected an array.")),i;function T(z,F,V,X,q){for(var H=z[F],G=0;G<y.length;G++)if(v(H,y[G]))return null;var J=JSON.stringify(y,function(ue,I){var xe=te(I);return xe==="symbol"?String(I):I});return new w("Invalid "+X+" `"+q+"` of value `"+String(H)+"` "+("supplied to `"+V+"`, expected one of "+J+"."))}return h(T)}function U(y){function T(z,F,V,X,q){if(typeof y!="function")return new w("Property `"+q+"` of component `"+V+"` has invalid PropType notation inside objectOf.");var H=z[F],G=L(H);if(G!=="object")return new w("Invalid "+X+" `"+q+"` of type "+("`"+G+"` supplied to `"+V+"`, expected an object."));for(var J in H)if(r(H,J)){var Q=y(H,J,V,X,q+"."+J,n);if(Q instanceof Error)return Q}return null}return h(T)}function C(y){if(!Array.isArray(y))return process.env.NODE_ENV!=="production"&&s("Invalid argument supplied to oneOfType, expected an instance of array."),i;for(var T=0;T<y.length;T++){var z=y[T];if(typeof z!="function")return s("Invalid argument supplied to oneOfType. Expected an array of check functions, but received "+se(z)+" at index "+T+"."),i}function F(V,X,q,H,G){for(var J=[],Q=0;Q<y.length;Q++){var ue=y[Q],I=ue(V,X,q,H,G,n);if(I==null)return null;I.data&&r(I.data,"expectedType")&&J.push(I.data.expectedType)}var xe=J.length>0?", expected one of type ["+J.join(", ")+"]":"";return new w("Invalid "+H+" `"+G+"` supplied to "+("`"+q+"`"+xe+"."))}return h(F)}function _(){function y(T,z,F,V,X){return Z(T[z])?null:new w("Invalid "+V+" `"+X+"` supplied to "+("`"+F+"`, expected a ReactNode."))}return h(y)}function S(y,T,z,F,V){return new w((y||"React class")+": "+T+" type `"+z+"."+F+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+V+"`.")}function D(y){function T(z,F,V,X,q){var H=z[F],G=L(H);if(G!=="object")return new w("Invalid "+X+" `"+q+"` of type `"+G+"` "+("supplied to `"+V+"`, expected `object`."));for(var J in y){var Q=y[J];if(typeof Q!="function")return S(V,X,q,J,te(Q));var ue=Q(H,J,V,X,q+"."+J,n);if(ue)return ue}return null}return h(T)}function $(y){function T(z,F,V,X,q){var H=z[F],G=L(H);if(G!=="object")return new w("Invalid "+X+" `"+q+"` of type `"+G+"` "+("supplied to `"+V+"`, expected `object`."));var J=t({},z[F],y);for(var Q in J){var ue=y[Q];if(r(y,Q)&&typeof ue!="function")return S(V,X,q,Q,te(ue));if(!ue)return new w("Invalid "+X+" `"+q+"` key `"+Q+"` supplied to `"+V+"`.\nBad object: "+JSON.stringify(z[F],null,"  ")+`
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Na;function kd(){if(Na)return ce;Na=1;var e=Symbol.for("react.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),s=Symbol.for("react.provider"),i=Symbol.for("react.context"),l=Symbol.for("react.server_context"),c=Symbol.for("react.forward_ref"),d=Symbol.for("react.suspense"),u=Symbol.for("react.suspense_list"),m=Symbol.for("react.memo"),f=Symbol.for("react.lazy"),b=Symbol.for("react.offscreen"),v;v=Symbol.for("react.module.reference");function w(h){if(typeof h=="object"&&h!==null){var k=h.$$typeof;switch(k){case e:switch(h=h.type,h){case n:case o:case r:case d:case u:return h;default:switch(h=h&&h.$$typeof,h){case l:case i:case c:case f:case m:case s:return h;default:return k}}case t:return k}}}return ce.ContextConsumer=i,ce.ContextProvider=s,ce.Element=e,ce.ForwardRef=c,ce.Fragment=n,ce.Lazy=f,ce.Memo=m,ce.Portal=t,ce.Profiler=o,ce.StrictMode=r,ce.Suspense=d,ce.SuspenseList=u,ce.isAsyncMode=function(){return!1},ce.isConcurrentMode=function(){return!1},ce.isContextConsumer=function(h){return w(h)===i},ce.isContextProvider=function(h){return w(h)===s},ce.isElement=function(h){return typeof h=="object"&&h!==null&&h.$$typeof===e},ce.isForwardRef=function(h){return w(h)===c},ce.isFragment=function(h){return w(h)===n},ce.isLazy=function(h){return w(h)===f},ce.isMemo=function(h){return w(h)===m},ce.isPortal=function(h){return w(h)===t},ce.isProfiler=function(h){return w(h)===o},ce.isStrictMode=function(h){return w(h)===r},ce.isSuspense=function(h){return w(h)===d},ce.isSuspenseList=function(h){return w(h)===u},ce.isValidElementType=function(h){return typeof h=="string"||typeof h=="function"||h===n||h===o||h===r||h===d||h===u||h===b||typeof h=="object"&&h!==null&&(h.$$typeof===f||h.$$typeof===m||h.$$typeof===s||h.$$typeof===i||h.$$typeof===c||h.$$typeof===v||h.getModuleId!==void 0)},ce.typeOf=w,ce}var de={};/**
 * @license React
 * react-is.development.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
...
`))}return h}const f=({color:w,name:h,mainShade:k=500,lightShade:P=300,darkShade:E=700})=>{if(w=R({},w),!w.main&&w[k]&&(w.main=w[k]),!w.hasOwnProperty("main"))throw new Error(process.env.NODE_ENV!=="production"?`MUI: The color${h?` (${h})`:""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${k}\` property.`:zt(11,h?` (${h})`:"",k));if(typeof w.main!="string")throw new Error(process.env.NODE_ENV!=="production"?`MUI: The color${h?` (${h})`:""} provided to augmentColor(color) is invalid.
