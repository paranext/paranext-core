 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wa;function pp(){return wa||(wa=1,process.env.NODE_ENV!=="production"&&function(){var e=typeof Symbol=="function"&&Symbol.for,t=e?Symbol.for("react.element"):60103,n=e?Symbol.for("react.portal"):60106,r=e?Symbol.for("react.fragment"):60107,o=e?Symbol.for("react.strict_mode"):60108,a=e?Symbol.for("react.profiler"):60114,s=e?Symbol.for("react.provider"):60109,l=e?Symbol.for("react.context"):60110,p=e?Symbol.for("react.async_mode"):60111,f=e?Symbol.for("react.concurrent_mode"):60111,m=e?Symbol.for("react.forward_ref"):60112,v=e?Symbol.for("react.suspense"):60113,g=e?Symbol.for("react.suspense_list"):60120,d=e?Symbol.for("react.memo"):60115,h=e?Symbol.for("react.lazy"):60116,u=e?Symbol.for("react.block"):60121,b=e?Symbol.for("react.fundamental"):60117,x=e?Symbol.for("react.responder"):60118,j=e?Symbol.for("react.scope"):60119;function w(L){return typeof L=="string"||typeof L=="function"||L===r||L===f||L===a||L===o||L===v||L===g||typeof L=="object"&&L!==null&&(L.$$typeof===h||L.$$typeof===d||L.$$typeof===s||L.$$typeof===l||L.$$typeof===m||L.$$typeof===b||L.$$typeof===x||L.$$typeof===j||L.$$typeof===u)}function k(L){if(typeof L=="object"&&L!==null){var te=L.$$typeof;switch(te){case t:var I=L.type;switch(I){case p:case f:case r:case a:case o:case v:return I;default:var ie=I&&I.$$typeof;switch(ie){case l:case m:case h:case d:case s:return ie;default:return te}}case n:return te}}}var y=p,C=f,S=l,_=s,D=t,V=m,E=r,O=h,$=d,z=n,U=a,A=o,B=v,J=!1;function Z(L){return J||(J=!0,console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")),R(L)||k(L)===p}function R(L){return k(L)===f}function M(L){return k(L)===l}function H(L){return k(L)===s}function K(L){return typeof L=="object"&&L!==null&&L.$$typeof===t}function G(L){return k(L)===m}function q(L){return k(L)===r}function X(L){return k(L)===h}function Y(L){return k(L)===d}function W(L){return k(L)===n}function Q(L){return k(L)===a}function ee(L){return k(L)===o}function se(L){return k(L)===v}pe.AsyncMode=y,pe.ConcurrentMode=C,pe.ContextConsumer=S,pe.ContextProvider=_,pe.Element=D,pe.ForwardRef=V,pe.Fragment=E,pe.Lazy=O,pe.Memo=$,pe.Portal=z,pe.Profiler=U,pe.StrictMode=A,pe.Suspense=B,pe.isAsyncMode=Z,pe.isConcurrentMode=R,pe.isContextConsumer=M,pe.isContextProvider=H,pe.isElement=K,pe.isForwardRef=G,pe.isFragment=q,pe.isLazy=X,pe.isMemo=Y,pe.isPortal=W,pe.isProfiler=Q,pe.isStrictMode=ee,pe.isSuspense=se,pe.isValidElementType=w,pe.typeOf=k}()),pe}var xa;function Ys(){return xa||(xa=1,process.env.NODE_ENV==="production"?tr.exports=cp():tr.exports=pp()),tr.exports}/*
object-assign
(c) Sindre Sorhus
@license MIT
*/var Fr,ka;function dp(){if(ka)return Fr;ka=1;var e=Object.getOwnPropertySymbols,t=Object.prototype.hasOwnProperty,n=Object.prototype.propertyIsEnumerable;function r(a){if(a==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(a)}function o(){try{if(!Object.assign)return!1;var a=new String("abc");if(a[5]="de",Object.getOwnPropertyNames(a)[0]==="5")return!1;for(var s={},l=0;l<10;l++)s["_"+String.fromCharCode(l)]=l;var p=Object.getOwnPropertyNames(s).map(function(m){return s[m]});if(p.join("")!=="0123456789")return!1;var f={};return"abcdefghijklmnopqrst".split("").forEach(function(m){f[m]=m}),Object.keys(Object.assign({},f)).join("")==="abcdefghijklmnopqrst"}catch{return!1}}return Fr=o()?Object.assign:function(a,s){for(var l,p=r(a),f,m=1;m<arguments.length;m++){l=Object(arguments[m]);for(var v in l)t.call(l,v)&&(p[v]=l[v]);if(e){f=e(l);for(var g=0;g<f.length;g++)n.call(l,f[g])&&(p[f[g]]=l[f[g]])}}return p},Fr}var zr,Ea;function Ro(){if(Ea)return zr;Ea=1;var e="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return zr=e,zr}var Ur,Na;function Ks(){return Na||(Na=1,Ur=Function.call.bind(Object.prototype.hasOwnProperty)),Ur}var Hr,Ta;function up(){if(Ta)return Hr;Ta=1;var e=function(){};if(process.env.NODE_ENV!=="production"){var t=Ro(),n={},r=Ks();e=function(a){var s="Warning: "+a;typeof console<"u"&&console.error(s);try{throw new Error(s)}catch{}}}function o(a,s,l,p,f){if(process.env.NODE_ENV!=="production"){for(var m in a)if(r(a,m)){var v;try{if(typeof a[m]!="function"){var g=Error((p||"React class")+": "+l+" type `"+m+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof a[m]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw g.name="Invariant Violation",g}v=a[m](s,m,p,l,null,t)}catch(h){v=h}if(v&&!(v instanceof Error)&&e((p||"React class")+": type specification of "+l+" `"+m+"` is invalid; the type checker function must return `null` or an `Error` but returned a "+typeof v+". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."),v instanceof Error&&!(v.message in n)){n[v.message]=!0;var d=f?f():"";e("Failed "+l+" type: "+v.message+(d??""))}}}}return o.resetWarningCache=function(){process.env.NODE_ENV!=="production"&&(n={})},Hr=o,Hr}var Gr,Ca;function fp(){if(Ca)return Gr;Ca=1;var e=Ys(),t=dp(),n=Ro(),r=Ks(),o=up(),a=function(){};process.env.NODE_ENV!=="production"&&(a=function(l){var p="Warning: "+l;typeof console<"u"&&console.error(p);try{throw new Error(p)}catch{}});function s(){return null}return Gr=function(l,p){var f=typeof Symbol=="function"&&Symbol.iterator,m="@@iterator";function v(R){var M=R&&(f&&R[f]||R[m]);if(typeof M=="function")return M}var g="<<anonymous>>",d={array:x("array"),bigint:x("bigint"),bool:x("boolean"),func:x("function"),number:x("number"),object:x("object"),string:x("string"),symbol:x("symbol"),any:j(),arrayOf:w,element:k(),elementType:y(),instanceOf:C,node:V(),objectOf:_,oneOf:S,oneOfType:D,shape:O,exact:$};function h(R,M){return R===M?R!==0||1/R===1/M:R!==R&&M!==M}function u(R,M){this.message=R,this.data=M&&typeof M=="object"?M:{},this.stack=""}u.prototype=Error.prototype;function b(R){if(process.env.NODE_ENV!=="production")var M={},H=0;function K(q,X,Y,W,Q,ee,se){if(W=W||g,ee=ee||Y,se!==n){if(p){var L=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use `PropTypes.checkPropTypes()` to call them. Read more at http://fb.me/use-check-prop-types");throw L.name="Invariant Violation",L}else if(process.env.NODE_ENV!=="production"&&typeof console<"u"){var te=W+":"+Y;!M[te]&&H<3&&(a("You are manually calling a React.PropTypes validation function for the `"+ee+"` prop on `"+W+"`. This is deprecated and will throw in the standalone `prop-types` package. You may be seeing this warning due to a third-party PropTypes library. See https://fb.me/react-warning-dont-call-proptypes for details."),M[te]=!0,H++)}}return X[Y]==null?q?X[Y]===null?new u("The "+Q+" `"+ee+"` is marked as required "+("in `"+W+"`, but its value is `null`.")):new u("The "+Q+" `"+ee+"` is marked as required in "+("`"+W+"`, but its value is `undefined`.")):null:R(X,Y,W,Q,ee)}var G=K.bind(null,!1);return G.isRequired=K.bind(null,!0),G}function x(R){function M(H,K,G,q,X,Y){var W=H[K],Q=A(W);if(Q!==R){var ee=B(W);return new u("Invalid "+q+" `"+X+"` of type "+("`"+ee+"` supplied to `"+G+"`, expected ")+("`"+R+"`."),{expectedType:R})}return null}return b(M)}function j(){return b(s)}function w(R){function M(H,K,G,q,X){if(typeof R!="function")return new u("Property `"+X+"` of component `"+G+"` has invalid PropType notation inside arrayOf.");var Y=H[K];if(!Array.isArray(Y)){var W=A(Y);return new u("Invalid "+q+" `"+X+"` of type "+("`"+W+"` supplied to `"+G+"`, expected an array."))}for(var Q=0;Q<Y.length;Q++){var ee=R(Y,Q,G,q,X+"["+Q+"]",n);if(ee instanceof Error)return ee}return null}return b(M)}function k(){function R(M,H,K,G,q){var X=M[H];if(!l(X)){var Y=A(X);return new u("Invalid "+G+" `"+q+"` of type "+("`"+Y+"` supplied to `"+K+"`, expected a single ReactElement."))}return null}return b(R)}function y(){function R(M,H,K,G,q){var X=M[H];if(!e.isValidElementType(X)){var Y=A(X);return new u("Invalid "+G+" `"+q+"` of type "+("`"+Y+"` supplied to `"+K+"`, expected a single ReactElement type."))}return null}return b(R)}function C(R){function M(H,K,G,q,X){if(!(H[K]instanceof R)){var Y=R.name||g,W=Z(H[K]);return new u("Invalid "+q+" `"+X+"` of type "+("`"+W+"` supplied to `"+G+"`, expected ")+("instance of `"+Y+"`."))}return null}return b(M)}function S(R){if(!Array.isArray(R))return process.env.NODE_ENV!=="production"&&(arguments.length>1?a("Invalid arguments supplied to oneOf, expected an array, got "+arguments.length+" arguments. A common mistake is to write oneOf(x, y, z) instead of oneOf([x, y, z])."):a("Invalid argument supplied to oneOf, expected an array.")),s;function M(H,K,G,q,X){for(var Y=H[K],W=0;W<R.length;W++)if(h(Y,R[W]))return null;var Q=JSON.stringify(R,function(se,L){var te=B(L);return te==="symbol"?String(L):L});return new u("Invalid "+q+" `"+X+"` of value `"+String(Y)+"` "+("supplied to `"+G+"`, expected one of "+Q+"."))}return b(M)}function _(R){function M(H,K,G,q,X){if(typeof R!="function")return new u("Property `"+X+"` of component `"+G+"` has invalid PropType notation inside objectOf.");var Y=H[K],W=A(Y);if(W!=="object")return new u("Invalid "+q+" `"+X+"` of type "+("`"+W+"` supplied to `"+G+"`, expected an object."));for(var Q in Y)if(r(Y,Q)){var ee=R(Y,Q,G,q,X+"."+Q,n);if(ee instanceof Error)return ee}return null}return b(M)}function D(R){if(!Array.isArray(R))return process.env.NODE_ENV!=="production"&&a("Invalid argument supplied to oneOfType, expected an instance of array."),s;for(var M=0;M<R.length;M++){var H=R[M];if(typeof H!="function")return a("Invalid argument supplied to oneOfType. Expected an array of check functions, but received "+J(H)+" at index "+M+"."),s}function K(G,q,X,Y,W){for(var Q=[],ee=0;ee<R.length;ee++){var se=R[ee],L=se(G,q,X,Y,W,n);if(L==null)return null;L.data&&r(L.data,"expectedType")&&Q.push(L.data.expectedType)}var te=Q.length>0?", expected one of type ["+Q.join(", ")+"]":"";return new u("Invalid "+Y+" `"+W+"` supplied to "+("`"+X+"`"+te+"."))}return b(K)}function V(){function R(M,H,K,G,q){return z(M[H])?null:new u("Invalid "+G+" `"+q+"` supplied to "+("`"+K+"`, expected a ReactNode."))}return b(R)}function E(R,M,H,K,G){return new u((R||"React class")+": "+M+" type `"+H+"."+K+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+G+"`.")}function O(R){function M(H,K,G,q,X){var Y=H[K],W=A(Y);if(W!=="object")return new u("Invalid "+q+" `"+X+"` of type `"+W+"` "+("supplied to `"+G+"`, expected `object`."));for(var Q in R){var ee=R[Q];if(typeof ee!="function")return E(G,q,X,Q,B(ee));var se=ee(Y,Q,G,q,X+"."+Q,n);if(se)return se}return null}return b(M)}function $(R){function M(H,K,G,q,X){var Y=H[K],W=A(Y);if(W!=="object")return new u("Invalid "+q+" `"+X+"` of type `"+W+"` "+("supplied to `"+G+"`, expected `object`."));var Q=t({},H[K],R);for(var ee in Q){var se=R[ee];if(r(R,ee)&&typeof se!="function")return E(G,q,X,ee,B(se));if(!se)return new u("Invalid "+q+" `"+X+"` key `"+ee+"` supplied to `"+G+"`.\nBad object: "+JSON.stringify(H[K],null,"  ")+`
Valid keys: `+JSON.stringify(Object.keys(R),null,"  "));var L=se(Y,ee,G,q,X+"."+ee,n);if(L)return L}return null}return b(M)}function z(R){switch(typeof R){case"number":case"string":case"undefined":return!0;case"boolean":return!R;case"object":if(Array.isArray(R))return R.every(z);if(R===null||l(R))return!0;var M=v(R);if(M){var H=M.call(R),K;if(M!==R.entries){for(;!(K=H.next()).done;)if(!z(K.value))return!1}else for(;!(K=H.next()).done;){var G=K.value;if(G&&!z(G[1]))return!1}}else return!1;return!0;default:return!1}}function U(R,M){return R==="symbol"?!0:M?M["@@toStringTag"]==="Symbol"||typeof Symbol=="function"&&M instanceof Symbol:!1}function A(R){var M=typeof R;return Array.isArray(R)?"array":R instanceof RegExp?"object":U(M,R)?"symbol":M}function B(R){if(typeof R>"u"||R===null)return""+R;var M=A(R);if(M==="object"){if(R instanceof Date)return"date";if(R instanceof RegExp)return"regexp"}return M}function J(R){var M=B(R);switch(M){case"array":case"object":return"an "+M;case"boolean":case"date":case"regexp":return"a "+M;default:return M}}function Z(R){return!R.constructor||!R.constructor.name?g:R.constructor.name}return d.checkPropTypes=o,d.resetWarningCache=o.resetWarningCache,d.PropTypes=d,d},Gr}var qr,Sa;function mp(){if(Sa)return qr;Sa=1;var e=Ro();function t(){}function n(){}return n.resetWarningCache=t,qr=function(){function r(s,l,p,f,m,v){if(v!==e){var g=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw g.name="Invariant Violation",g}}r.isRequired=r;function o(){return r}var a={array:r,bigint:r,bool:r,func:r,number:r,object:r,string:r,symbol:r,any:r,arrayOf:o,element:r,elementType:r,instanceOf:o,node:r,objectOf:o,oneOf:o,oneOfType:o,shape:o,exact:o,checkPropTypes:n,resetWarningCache:t};return a.PropTypes=a,a},qr}if(process.env.NODE_ENV!=="production"){var hp=Ys(),gp=!0;so.exports=fp()(hp.isElement,gp)}else so.exports=mp()();var bp=so.exports;const i=sp(bp);function vp(e){const{prototype:t={}}=e;return!!t.isReactComponent}function Js(e,t,n,r,o){const a=e[t],s=o||t;if(a==null||typeof window>"u")return null;let l;const p=a.type;return typeof p=="function"&&!vp(p)&&(l="Did you accidentally use a plain function component for an element instead?"),l!==void 0?new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`):null}const Zs=ln(i.element,Js);Zs.isRequired=ln(i.element.isRequired,Js);const Gn=Zs;function yp(e){const{prototype:t={}}=e;return!!t.isReactComponent}function wp(e,t,n,r,o){const a=e[t],s=o||t;if(a==null||typeof window>"u")return null;let l;return typeof a=="function"&&!yp(a)&&(l="Did you accidentally provide a plain function component instead?"),l!==void 0?new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`):null}const xp=ln(i.elementType,wp),kp="exact-prop: ​";function Qs(e){return process.env.NODE_ENV==="production"?e:P({},e,{[kp]:t=>{const n=Object.keys(t).filter(r=>!e.hasOwnProperty(r));return n.length>0?new Error(`The following props are not supported: ${n.map(r=>`\`${r}\``).join(", ")}. Please remove them.`):null}})}function Qt(e){let t="https://mui.com/production-error/?code="+e;for(let n=1;n<arguments.length;n+=1)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified MUI error #"+e+"; visit "+t+" for the full message."}var io={exports:{}},de={};/**
 * @license React
 * react-is.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
...
`)),b!==null&&xe<b){const Te=xe-b;xe-=Te,ie.horizontal+=Te}else if(Pe>at){const Te=Pe-at;xe-=Te,ie.horizontal+=Te}return{top:`${Math.round(Re)}px`,left:`${Math.round(xe)}px`,transformOrigin:us(ie)}},[p,v,B,J,b]),[R,M]=T.useState(x),H=T.useCallback(()=>{const te=$.current;if(!te)return;const I=Z(te);I.top!==null&&(te.style.top=I.top),I.left!==null&&(te.style.left=I.left),te.style.transformOrigin=I.transformOrigin,M(!0)},[Z]);T.useEffect(()=>(D&&window.addEventListener("scroll",H),()=>window.removeEventListener("scroll",H)),[p,D,H]);const K=(te,I)=>{_&&_(te,I),H()},G=()=>{M(!1)};T.useEffect(()=>{x&&H()}),T.useImperativeHandle(l,()=>x?{updatePosition:()=>{H()}}:null,[x,H]),T.useEffect(()=>{if(!x)return;const te=ti(()=>{H()}),I=en(p);return I.addEventListener("resize",te),()=>{te.clear(),I.removeEventListener("resize",te)}},[p,x,H]);let q=S;S==="auto"&&!C.muiSupportAuto&&(q=void 0);const X=h||(p?Oe(cr(p)).body:void 0),Y=(o=w==null?void 0:w.root)!=null?o:Hh,W=(a=w==null?void 0:w.paper)!=null?a:Ji,Q=Bt({elementType:W,externalSlotProps:P({},O,{style:R?O.style:P({},O.style,{opacity:0})}),additionalProps:{elevation:u,ref:z},ownerState:U,className:Ce(A.paper,O==null?void 0:O.className)}),ee=Bt({elementType:Y,externalSlotProps:(k==null?void 0:k.root)||{},externalForwardedProps:E,additionalProps:{ref:n,slotProps:{backdrop:{invisible:!0}},container:X,open:x},ownerState:U,className:Ce(A.root,d)}),{slotProps:se}=ee,L=me(ee,zh);return c.jsx(Y,P({},L,!wi(Y)&&{slotProps:se,disableScrollLock:D},{children:c.jsx(C,P({appear:!0,in:x,onEntering:K,onExited:G,timeout:q},V,{children:c.jsx(W,P({},Q,{children:g}))}))}))});process.env.NODE_ENV!=="production"&&(Zi.propTypes={action:Po,anchorEl:ln(i.oneOfType([pt,i.func]),e=>{if(e.open&&(!e.anchorReference||e.anchorReference==="anchorEl")){const t=cr(e.anchorEl);if(t&&t.nodeType===1){const n=t.getBoundingClientRect();if(process.env.NODE_ENV!=="test"&&n.top===0&&n.left===0&&n.right===0&&n.bottom===0)return new Error(["MUI: The `anchorEl` prop provided to the component is invalid.","The anchor element should be part of the document layout.","Make sure the element is present in the document or that it's not display none."].join(`
`))}else return new Error(["MUI: The `anchorEl` prop provided to the component is invalid.",`It should be an Element or PopoverVirtualElement instance but it's \`${t}\` instead.`].join(`
`))}return null}),anchorOrigin:i.shape({horizontal:i.oneOfType([i.oneOf(["center","left","right"]),i.number]).isRequired,vertical:i.oneOfType([i.oneOf(["bottom","center","top"]),i.number]).isRequired}),anchorPosition:i.shape({left:i.number.isRequired,top:i.number.isRequired}),anchorReference:i.oneOf(["anchorEl","anchorPosition","none"]),children:i.node,classes:i.object,className:i.string,container:i.oneOfType([pt,i.func]),disableScrollLock:i.bool,elevation:li,marginThreshold:i.number,onClose:i.func,open:i.bool.isRequired,PaperProps:i.shape({component:xp}),slotProps:i.shape({paper:i.oneOfType([i.func,i.object]),root:i.oneOfType([i.func,i.object])}),slots:i.shape({paper:i.elementType,root:i.elementType}),sx:i.oneOfType([i.arrayOf(i.oneOfType([i.func,i.object,i.bool])),i.func,i.object]),transformOrigin:i.shape({horizontal:i.oneOfType([i.oneOf(["center","left","right"]),i.number]).isRequired,vertical:i.oneOfType([i.oneOf(["bottom","center","top"]),i.number]).isRequired}),TransitionComponent:i.elementType,transitionDuration:i.oneOfType([i.oneOf(["auto"]),i.number,i.shape({appear:i.number,enter:i.number,exit:i.number})]),TransitionProps:i.object});const Gh=Zi;function qh(e){return rt("MuiMenu",e)}xt("MuiMenu",["root","paper","list"]);const Wh=["onEntering"],Xh=["autoFocus","children","className","disableAutoFocusItem","MenuListProps","onClose","open","PaperProps","PopoverClasses","transitionDuration","TransitionProps","variant","slots","slotProps"],Yh={vertical:"top",horizontal:"right"},Kh={vertical:"top",horizontal:"left"},Jh=e=>{const{classes:t}=e;return ft({root:["root"],paper:["paper"],list:["list"]},qh,t)},Zh=je(Gh,{shouldForwardProp:e=>bi(e)||e==="classes",name:"MuiMenu",slot:"Root",overridesResolver:(e,t)=>t.root})({}),Qh=je(Ji,{name:"MuiMenu",slot:"Paper",overridesResolver:(e,t)=>t.paper})({maxHeight:"calc(100% - 96px)",WebkitOverflowScrolling:"touch"}),eg=je(yh,{name:"MuiMenu",slot:"List",overridesResolver:(e,t)=>t.list})({outline:0}),Qi=T.forwardRef(function(t,n){var r,o;const a=mt({props:t,name:"MuiMenu"}),{autoFocus:s=!0,children:l,className:p,disableAutoFocusItem:f=!1,MenuListProps:m={},onClose:v,open:g,PaperProps:d={},PopoverClasses:h,transitionDuration:u="auto",TransitionProps:{onEntering:b}={},variant:x="selectedMenu",slots:j={},slotProps:w={}}=a,k=me(a.TransitionProps,Wh),y=me(a,Xh),C=Jn(),S=C.direction==="rtl",_=P({},a,{autoFocus:s,disableAutoFocusItem:f,MenuListProps:m,onEntering:b,PaperProps:d,transitionDuration:u,TransitionProps:k,variant:x}),D=Jh(_),V=s&&!f&&g,E=T.useRef(null),O=(Z,R)=>{E.current&&E.current.adjustStyleForScrollbar(Z,C),b&&b(Z,R)},$=Z=>{Z.key==="Tab"&&(Z.preventDefault(),v&&v(Z,"tabKeyDown"))};let z=-1;T.Children.map(l,(Z,R)=>{T.isValidElement(Z)&&(process.env.NODE_ENV!=="production"&&dr.isFragment(Z)&&console.error(["MUI: The Menu component doesn't accept a Fragment as a child.","Consider providing an array instead."].join(`
`)),Z.props.disabled||(x==="selectedMenu"&&Z.props.selected||z===-1)&&(z=R))});const U=(r=j.paper)!=null?r:Qh,A=(o=w.paper)!=null?o:d,B=Bt({elementType:j.root,externalSlotProps:w.root,ownerState:_,className:[D.root,p]}),J=Bt({elementType:U,externalSlotProps:A,ownerState:_,className:D.paper});return c.jsx(Zh,P({onClose:v,anchorOrigin:{vertical:"bottom",horizontal:S?"right":"left"},transformOrigin:S?Yh:Kh,slots:{paper:U,root:j.root},slotProps:{root:B,paper:J},open:g,ref:n,transitionDuration:u,TransitionProps:P({onEntering:O},k),ownerState:_},y,{classes:h,children:c.jsx(eg,P({onKeyDown:$,actions:E,autoFocus:s&&(z===-1||f),autoFocusItem:V,variant:x},m,{className:Ce(D.list,m.className),children:l}))}))});process.env.NODE_ENV!=="production"&&(Qi.propTypes={anchorEl:i.oneOfType([pt,i.func]),autoFocus:i.bool,children:i.node,classes:i.object,className:i.string,disableAutoFocusItem:i.bool,MenuListProps:i.object,onClose:i.func,open:i.bool.isRequired,PaperProps:i.object,PopoverClasses:i.object,slotProps:i.shape({paper:i.oneOfType([i.func,i.object]),root:i.oneOfType([i.func,i.object])}),slots:i.shape({paper:i.elementType,root:i.elementType}),sx:i.oneOfType([i.arrayOf(i.oneOfType([i.func,i.object,i.bool])),i.func,i.object]),transitionDuration:i.oneOfType([i.oneOf(["auto"]),i.number,i.shape({appear:i.number,enter:i.number,exit:i.number})]),TransitionProps:i.object,variant:i.oneOf(["menu","selectedMenu"])});const tg=Qi;function ng({className:e,commandHandler:t,menuDefinition:n,children:r}){var f;const[o,a]=N.useState(void 0),s=N.useCallback(m=>{m.preventDefault(),a(o===void 0?{mouseX:m.clientX+2,mouseY:m.clientY-6}:void 0)},[o]),l=N.useCallback(()=>{a(void 0)},[]),p=N.useMemo(()=>{if(o!==void 0)return{top:o.mouseY,left:o.mouseX}},[o]);return(((f=n==null?void 0:n.items)==null?void 0:f.length)??0)===0||!r?r:c.jsxs("div",{className:`papi-context-menu-target ${e??""}`,onContextMenu:s,children:[r,c.jsx(tg,{className:`papi-context-menu ${e??""}`,open:o!==void 0,onClose:l,anchorReference:"anchorPosition",anchorPosition:p,children:c.jsx(Ko,{menuDefinition:n,commandHandler:t,onClick:l})})]})}function rg(e){return{preserveValue:!0,...e}}const yr=(e,t,n={})=>{const r=N.useRef(t);r.current=t;const o=N.useRef(n);o.current=rg(o.current);const[a,s]=N.useState(()=>r.current),[l,p]=N.useState(!0);return N.useEffect(()=>{let f=!0;return p(!!e),(async()=>{if(e){const m=await e();f&&(s(()=>m),p(!1))}})(),()=>{f=!1,o.current.preserveValue||s(()=>r.current)}},[e]),[a,l]},og=vi(c.jsx("path",{d:"M3 18h18v-2H3zm0-5h18v-2H3zm0-7v2h18V6z"}),"Menu");function el({menuProvider:e,normalMenu:t,fullMenu:n,commandHandler:r,containerRef:o,className:a,ariaLabelPrefix:s,children:l}){const[p,f]=N.useState(!1),[m,v]=N.useState(!1),g=N.useCallback(()=>{p&&f(!1),v(!1)},[p]),d=N.useCallback(k=>{k.stopPropagation(),f(y=>{const C=!y;return C&&k.shiftKey?v(!0):C||v(!1),C})},[]),h=N.useCallback(k=>(g(),r(k)),[r,g]),[u,b]=N.useState({top:1,left:1});N.useEffect(()=>{if(p){const k=o==null?void 0:o.current;if(k){const y=k.getBoundingClientRect(),C=window.scrollY,S=window.scrollX,_=y.top+C+k.clientHeight,D=y.left+S;b({top:_,left:D})}}},[p,o]);const[x]=yr(N.useCallback(async()=>(e==null?void 0:e(!1))??t,[e,t,p]),t),[j]=yr(N.useCallback(async()=>(e==null?void 0:e(!0))??n??x,[e,n,x,p]),n??x),w=m&&j?j:x;return c.jsxs(c.Fragment,{children:[c.jsx(Ee.IconButton,{sx:{paddingTop:0,paddingBottom:0},edge:"start",className:`papi-menuButton ${a??""}`,color:"inherit","aria-label":`${s??""} menu button`,onClick:d,children:l??c.jsx(og,{})}),c.jsx(Ee.Drawer,{className:`papi-menu-drawer ${a??""}`,anchor:"left",variant:"temporary",open:p,onClose:g,PaperProps:{className:"papi-menu-drawer-paper",style:{top:u.top,left:u.left}},children:w?c.jsx(zi,{className:a,id:`${s??""} main menu`,commandHandler:h,multiColumnMenu:w}):void 0})]})}function ag({id:e,label:t,isDisabled:n=!1,tooltip:r,isTooltipSuppressed:o=!1,adjustMarginToAlignToEdge:a=!1,size:s="medium",className:l,onClick:p,children:f}){return c.jsx(Ee.IconButton,{id:e,disabled:n,edge:a,size:s,"aria-label":t,title:o?void 0:r??t,className:`papi-icon-button ${l??""}`,onClick:p,children:f})}const yt="scrBook",sg="scrRef",jt="source",ig="details",lg="Scripture Reference",cg="Scripture Book",tl="Type",pg="Details";function dg(e,t){const n=t??!1;return[{accessorFn:r=>`${fe.bookNumberToId(r.start.bookNum)} ${r.start.chapterNum}:${r.start.verseNum}`,id:yt,header:(e==null?void 0:e.scriptureReferenceColumnName)??lg,cell:r=>{const o=r.row.original;return r.row.getIsGrouped()?fe.bookNumberToEnglishName(o.start.bookNum):r.row.groupingColumnId===yt?He.formatScrRef(o.start):void 0},getGroupingValue:r=>r.start.bookNum,sortingFn:(r,o)=>He.compareScrRefs(r.original.start,o.original.start),enableGrouping:!0},{accessorFn:r=>He.formatScrRef(r.start),id:sg,header:void 0,cell:r=>{const o=r.row.original;return r.row.getIsGrouped()?void 0:He.formatScrRef(o.start)},sortingFn:(r,o)=>He.compareScrRefs(r.original.start,o.original.start),enableGrouping:!1},{accessorFn:r=>r.source.displayName,id:jt,header:n?(e==null?void 0:e.typeColumnName)??tl:void 0,cell:r=>n||r.row.getIsGrouped()?r.getValue():void 0,getGroupingValue:r=>r.source.id,sortingFn:(r,o)=>r.original.source.displayName.localeCompare(o.original.source.displayName),enableGrouping:!0},{accessorFn:r=>r.detail,id:ig,header:(e==null?void 0:e.detailsColumnName)??pg,cell:r=>r.getValue(),enableGrouping:!1}]}function ug({sources:e,showColumnHeaders:t=!1,showSourceColumn:n=!1,scriptureReferenceColumnName:r,scriptureBookGroupName:o,typeColumnName:a,detailsColumnName:s,onRowSelected:l}){const[p,f]=N.useState([]),[m,v]=N.useState([{id:yt,desc:!1}]),[g,d]=N.useState(()=>e.flatMap(E=>{const O=E.source;return E.data.map($=>({...$,source:O}))})),[h,u]=N.useState({});N.useEffect(()=>{d(()=>e.flatMap(E=>{const O=E.source;return E.data.map($=>({...$,source:O}))}))},[e]);const b=N.useMemo(()=>dg({scriptureReferenceColumnName:r,typeColumnName:a,detailsColumnName:s},n),[r,a,s,n]);N.useEffect(()=>{p.includes(jt)?v([{id:jt,desc:!1},{id:yt,desc:!1}]):v([{id:yt,desc:!1}])},[p]);const x=N.useCallback((E,O)=>!O||He.compareScrRefs(E,O)===0?`${He.scrRefToBBBCCCVVV(E)}`:`${He.scrRefToBBBCCCVVV(E)}-${He.scrRefToBBBCCCVVV(O)}`,[]),j=N.useCallback(E=>`${x(E.start,E.end)} ${E.source} ${E.detail}`,[x]),w=Se.useReactTable({data:g,columns:b,state:{grouping:p,sorting:m,rowSelection:h},onGroupingChange:f,onSortingChange:v,onRowSelectionChange:u,getExpandedRowModel:Se.getExpandedRowModel(),getGroupedRowModel:Se.getGroupedRowModel(),getCoreRowModel:Se.getCoreRowModel(),getSortedRowModel:Se.getSortedRowModel(),getRowId:j,autoResetExpanded:!1,enableMultiRowSelection:!1,enableSubRowSelection:!1});N.useEffect(()=>{if(l){const E=w.getSelectedRowModel().rowsById,O=Object.keys(E);if(O.length===1){const $=g.find(z=>j(z)===O[0])||void 0;$&&l($)}}},[h,g,j,l,w]);const k=o??cg,y=a??tl,C=[{label:"No Grouping",value:[]},{label:`Group by ${k}`,value:[yt]},{label:`Group by ${y}`,value:[jt]},{label:`Group by ${k} and ${y}`,value:[yt,jt]},{label:`Group by ${y} and ${k}`,value:[jt,yt]}],S=E=>{f(JSON.parse(E))},_=(E,O)=>{!E.getIsGrouped()&&!E.getIsSelected()&&E.getToggleSelectedHandler()(O)},D=(E,O)=>E.getIsGrouped()?"":F("banded-row",O%2===0?"even":"odd"),V=(E,O,$)=>{if(!((E==null?void 0:E.length)===0||O.depth<$.column.getGroupedIndex())){if(O.getIsGrouped())switch(O.depth){case 1:return"pr-ps-4";default:return}switch(O.depth){case 1:return"pr-ps-8";case 2:return"pr-ps-12";default:return}}};return c.jsxs("div",{className:"pr-twp pr-flex pr-h-full pr-w-full pr-flex-col",children:[!t&&c.jsxs($n,{value:JSON.stringify(p),onValueChange:E=>{S(E)},children:[c.jsx(Kt,{className:"pr-mb-1 pr-mt-2",children:c.jsx(_n,{})}),c.jsx(Jt,{position:"item-aligned",children:c.jsx(_s,{children:C.map(E=>c.jsx(Ke,{value:JSON.stringify(E.value),children:E.label},E.label))})})]}),c.jsxs(zn,{className:"pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0",children:[t&&c.jsx(Un,{children:w.getHeaderGroups().map(E=>c.jsx(lt,{children:E.headers.filter(O=>O.column.columnDef.header).map(O=>c.jsx(Zt,{colSpan:O.colSpan,className:"top-0 pr-sticky",children:O.isPlaceholder?void 0:c.jsxs("div",{children:[O.column.getCanGroup()?c.jsx(be,{variant:"ghost",title:`Toggle grouping by ${O.column.columnDef.header}`,onClick:O.column.getToggleGroupingHandler(),type:"button",children:O.column.getIsGrouped()?"🛑":"👊 "}):void 0," ",Se.flexRender(O.column.columnDef.header,O.getContext())]})},O.id))},E.id))}),c.jsx(Hn,{children:w.getRowModel().rows.map((E,O)=>c.jsx(lt,{"data-state":E.getIsSelected()?"selected":"",className:F(D(E,O)),onClick:$=>_(E,$),children:E.getVisibleCells().map($=>{if(!($.getIsPlaceholder()||$.column.columnDef.enableGrouping&&!$.getIsGrouped()&&($.column.columnDef.id!==jt||!n)))return c.jsx(It,{className:F($.column.columnDef.id,"pr-p-[1px]",V(p,E,$)),children:(()=>$.getIsGrouped()?c.jsxs(be,{variant:"ghost",onClick:E.getToggleExpandedHandler(),type:"button",children:[E.getIsExpanded()?"👇":"👉"," ",Se.flexRender($.column.columnDef.cell,$.getContext())," (",E.subRows.length,")"]}):Se.flexRender($.column.columnDef.cell,$.getContext()))()},$.id)})},E.id))})]})]})}const fg=wo.cva("pr-text-sm pr-font-medium pr-leading-none peer-disabled:pr-cursor-not-allowed peer-disabled:pr-opacity-70"),Jo=N.forwardRef(({className:e,...t},n)=>c.jsx(xs.Root,{ref:n,className:F(fg(),e),...t}));Jo.displayName=xs.Root.displayName;function nl({id:e,isDisabled:t=!1,hasError:n=!1,isFullWidth:r=!1,helperText:o,label:a,placeholder:s,isRequired:l=!1,className:p,defaultValue:f,value:m,onChange:v,onFocus:g,onBlur:d}){return c.jsxs("div",{className:F("pr-inline-grid pr-items-center pr-gap-1.5",{"pr-w-full":r}),children:[c.jsx(Jo,{htmlFor:e,className:F({"pr-text-red-600":n,"pr-hidden":!a}),children:`${a}${l?"*":""}`}),c.jsx(Ln,{id:e,disabled:t,placeholder:s,required:l,className:F(p,{"pr-border-red-600":n}),defaultValue:f,value:m,onChange:v,onFocus:g,onBlur:d}),c.jsx("p",{className:F({"pr-hidden":!o}),children:o})]})}function mg({onSearch:e,placeholder:t,isFullWidth:n}){const[r,o]=N.useState(""),a=s=>{o(s),e(s)};return c.jsx(nl,{isFullWidth:n,className:"search-bar-input",placeholder:t,value:r,onChange:s=>a(s.target.value)})}function hg({id:e,isDisabled:t=!1,orientation:n="horizontal",min:r=0,max:o=100,step:a=1,showMarks:s=!1,defaultValue:l,value:p,valueLabelDisplay:f="off",className:m,onChange:v,onChangeCommitted:g}){return c.jsx(Ee.Slider,{id:e,disabled:t,orientation:n,min:r,max:o,step:a,marks:s,defaultValue:l,value:p,valueLabelDisplay:f,className:`papi-slider ${n} ${m??""}`,onChange:v,onChangeCommitted:g})}function gg({autoHideDuration:e=void 0,id:t,isOpen:n=!1,className:r,onClose:o,anchorOrigin:a={vertical:"bottom",horizontal:"left"},ContentProps:s,children:l}){const p={action:(s==null?void 0:s.action)||l,message:s==null?void 0:s.message,className:r};return c.jsx(Ee.Snackbar,{autoHideDuration:e??void 0,open:n,onClose:o,anchorOrigin:a,id:t,ContentProps:p})}function bg({id:e,isChecked:t,isDisabled:n=!1,hasError:r=!1,className:o,onChange:a}){return c.jsx(Ee.Switch,{id:e,checked:t,disabled:n,className:`papi-switch ${r?"error":""} ${o??""}`,onChange:a})}function vg({menuProvider:e,commandHandler:t,className:n,id:r,children:o}){const a=N.useRef(void 0);return c.jsx("div",{ref:a,style:{position:"relative"},children:c.jsx(Ee.AppBar,{position:"static",id:r,children:c.jsxs(Ee.Toolbar,{className:`papi-toolbar ${n??""}`,variant:"dense",children:[e?c.jsx(el,{commandHandler:t,containerRef:a,menuProvider:e}):void 0,o?c.jsx("div",{className:"papi-toolbar-children",children:o}):void 0]})})})}const yg=De.Root,rl=N.forwardRef(({className:e,...t},n)=>c.jsx(De.List,{ref:n,className:F("pr-inline-flex pr-h-10 pr-items-center pr-justify-center pr-rounded-md pr-bg-muted pr-p-1 pr-text-muted-foreground",e),...t}));rl.displayName=De.List.displayName;const ol=N.forwardRef(({className:e,...t},n)=>c.jsx(De.Trigger,{ref:n,className:F("pr-inline-flex pr-items-center pr-justify-center pr-whitespace-nowrap pr-rounded-sm pr-px-3 pr-py-1.5 pr-text-sm pr-font-medium pr-ring-offset-background pr-transition-all hover:pr-text-foreground focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2 disabled:pr-pointer-events-none disabled:pr-opacity-50 data-[state=active]:pr-bg-background data-[state=active]:pr-text-foreground data-[state=active]:pr-shadow-sm",e),...t}));ol.displayName=De.Trigger.displayName;const al=N.forwardRef(({className:e,...t},n)=>c.jsx(De.Content,{ref:n,className:F("pr-mt-2 pr-ring-offset-background focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2",e),...t}));al.displayName=De.Content.displayName;const sl=N.forwardRef(({className:e,...t},n)=>c.jsx(De.Root,{orientation:"vertical",ref:n,className:F("pr-flex pr-gap-1 pr-rounded-md pr-text-muted-foreground",e),...t}));sl.displayName=De.List.displayName;const il=N.forwardRef(({className:e,...t},n)=>c.jsx(De.List,{ref:n,className:F("pr-flex-fit pr-mlk-items-center pr-w-[124px] pr-justify-center pr-rounded-md pr-bg-muted pr-p-1 pr-text-muted-foreground",e),...t}));il.displayName=De.List.displayName;const wg=N.forwardRef(({className:e,...t},n)=>c.jsx(De.Trigger,{ref:n,...t,className:F("overflow-clip pr-inline-flex pr-w-[116px] pr-cursor-pointer pr-items-center pr-justify-center pr-break-words pr-rounded-sm pr-border-0 pr-bg-muted pr-px-3 pr-py-1.5 pr-text-sm pr-font-medium pr-text-inherit pr-ring-offset-background pr-transition-all hover:pr-text-foreground focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2 disabled:pr-pointer-events-none disabled:pr-opacity-50 data-[state=active]:pr-bg-background data-[state=active]:pr-text-foreground data-[state=active]:pr-shadow-sm",e)})),ll=N.forwardRef(({className:e,...t},n)=>c.jsx(De.Content,{ref:n,className:F("mt-2 pr-ms-5 pr-flex-grow pr-text-foreground pr-ring-offset-background focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2",e),...t}));ll.displayName=De.Content.displayName;function xg({isInstalling:e,handleClick:t,buttonText:n,className:r,...o}){return c.jsx(be,{className:F("pr-h-8 pr-rounded-md pr-text-white pr-transition pr-duration-300 pr-ease-in-out hover:pr-bg-blue-700",{"pr-cursor-not-allowed pr-bg-blue-700":e,"pr-bg-blue-600":!e,"pr-bg-white pr-text-blue-600 hover:pr-text-white":!n,"pr-w-20":n},r),onClick:t,...o,children:e?c.jsx(re.LoaderCircle,{size:15,className:"pr-animate-spin"}):c.jsxs(c.Fragment,{children:[c.jsx(re.Download,{size:25,className:F("pr-h-4 pr-w-4",{"pr-mr-1":n})}),n]})})}function kg({isEnabling:e,handleClick:t,className:n,...r}){return c.jsx(be,{className:F("pr-h-8 pr-rounded-md pr-bg-blue-600 pr-px-4 pr-text-white pr-transition pr-duration-300 pr-ease-in-out hover:pr-bg-blue-700",{"pr-cursor-not-allowed pr-bg-blue-700":e},n),onClick:t,...r,children:e?c.jsxs(c.Fragment,{children:[c.jsx(re.LoaderCircle,{size:15,className:"pr-mr-1 pr-animate-spin pr-text-white"}),"Enabling..."]}):"Enable"})}function Eg({isDisabling:e,handleClick:t,className:n,...r}){return c.jsx(be,{className:F("pr-h-8 pr-rounded-md pr-bg-gray-300 pr-text-black pr-transition pr-duration-300 pr-ease-in-out hover:pr-bg-gray-400",{"pr-cursor-not-allowed pr-bg-gray-400":e},n),onClick:t,...r,children:e?c.jsxs(c.Fragment,{children:[c.jsx(re.LoaderCircle,{size:15,className:"pr-mr-1 pr-animate-spin pr-text-black"}),"Disabling..."]}):"Disable"})}function Ng({isUpdating:e,handleClick:t,className:n,...r}){return c.jsx(be,{className:F("pr-h-8 pr-rounded-md pr-bg-blue-600 pr-px-4 pr-text-white pr-transition pr-duration-300 pr-ease-in-out hover:pr-bg-blue-700 hover:pr-text-white",{"pr-cursor-not-allowed pr-bg-blue-700":e},n),onClick:t,...r,children:e?c.jsxs(c.Fragment,{children:[c.jsx(re.LoaderCircle,{size:15,className:"pr-mr-1 pr-animate-spin pr-text-white"}),"Updating..."]}):"Update"})}function $t(){return $t=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},$t.apply(this,arguments)}const Tg=["children","options"],fs=["allowFullScreen","allowTransparency","autoComplete","autoFocus","autoPlay","cellPadding","cellSpacing","charSet","className","classId","colSpan","contentEditable","contextMenu","crossOrigin","encType","formAction","formEncType","formMethod","formNoValidate","formTarget","frameBorder","hrefLang","inputMode","keyParams","keyType","marginHeight","marginWidth","maxLength","mediaGroup","minLength","noValidate","radioGroup","readOnly","rowSpan","spellCheck","srcDoc","srcLang","srcSet","tabIndex","useMap"].reduce((e,t)=>(e[t.toLowerCase()]=t,e),{for:"htmlFor"}),ms={amp:"&",apos:"'",gt:">",lt:"<",nbsp:" ",quot:"“"},Cg=["style","script"],Sg=/([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi,Og=/mailto:/i,jg=/\n{2,}$/,cl=/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/,Rg=/^ *> ?/gm,Pg=/^ {2,}\n/,$g=/^(?:( *[-*_])){3,} *(?:\n *)+\n/,pl=/^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/,dl=/^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/,_g=/^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/,Mg=/^(?:\n *)*\n/,Ig=/\r\n?/g,Dg=/^\[\^([^\]]+)](:.*)\n/,Ag=/^\[\^([^\]]+)]/,Bg=/\f/g,Lg=/^\s*?\[(x|\s)\]/,ul=/^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/,fl=/^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/,ml=/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/,vo=/^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i,Vg=/&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi,hl=/^<!--[\s\S]*?(?:-->)/,Fg=/^(data|aria|x)-[a-z_][a-z\d_.-]*$/,yo=/^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i,zg=/^\{.*\}$/,Ug=/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/,Hg=/^<([^ >]+@[^ >]+)>/,Gg=/^<([^ >]+:\/[^ >]+)>/,qg=/-([a-z])?/gi,gl=/^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/,Wg=/^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/,Xg=/^!\[([^\]]*)\] ?\[([^\]]*)\]/,Yg=/^\[([^\]]*)\] ?\[([^\]]*)\]/,Kg=/(\[|\])/g,Jg=/(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/,Zg=/\t/g,Qg=/^ *\| */,eb=/(^ *\||\| *$)/g,tb=/ *$/,nb=/^ *:-+: *$/,rb=/^ *:-+ *$/,ob=/^ *-+: *$/,ab=/^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/,sb=/^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/,ib=/^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/,lb=/^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/,cb=/^\\([^0-9A-Za-z\s])/,pb=/^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i,db=/^\n+/,ub=/^([ \t]*)/,fb=/\\([^\\])/g,hs=/ *\n+$/,mb=/(?:^|\n)( *)$/,Zo="(?:\\d+\\.)",Qo="(?:[*+-])";function bl(e){return"( *)("+(e===1?Zo:Qo)+") +"}const vl=bl(1),yl=bl(2);function wl(e){return new RegExp("^"+(e===1?vl:yl))}const hb=wl(1),gb=wl(2);function xl(e){return new RegExp("^"+(e===1?vl:yl)+"[^\\n]*(?:\\n(?!\\1"+(e===1?Zo:Qo)+" )[^\\n]*)*(\\n|$)","gm")}const kl=xl(1),El=xl(2);function Nl(e){const t=e===1?Zo:Qo;return new RegExp("^( *)("+t+") [\\s\\S]+?(?:\\n{2,}(?! )(?!\\1"+t+" (?!"+t+" ))\\n*|\\s*\\n*$)")}const Tl=Nl(1),Cl=Nl(2);function gs(e,t){const n=t===1,r=n?Tl:Cl,o=n?kl:El,a=n?hb:gb;return{t(s,l,p){const f=mb.exec(p);return f&&(l.o||!l._&&!l.u)?r.exec(s=f[1]+s):null},i:ae.HIGH,l(s,l,p){const f=n?+s[2]:void 0,m=s[0].replace(jg,`
