"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const k=require("react/jsx-runtime"),de=require("@mui/material"),se=require("react"),ot=require("@mui/styled-engine"),un=require("react-dom"),Se=require("platform-bible-utils"),_t=require("react-data-grid");function Er(e){const n=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const t in e)if(t!=="default"){const r=Object.getOwnPropertyDescriptor(e,t);Object.defineProperty(n,t,r.get?r:{enumerable:!0,get:()=>e[t]})}}return n.default=e,Object.freeze(n)}const O=Er(se),mo=Er(un);function De({id:e,isDisabled:n=!1,className:t,onClick:r,onContextMenu:o,children:i}){return k.jsx(de.Button,{id:e,disabled:n,className:`papi-button ${t??""}`,onClick:r,onContextMenu:o,children:i})}function wn({id:e,title:n,isDisabled:t=!1,isClearable:r=!0,hasError:o=!1,isFullWidth:i=!1,width:a,options:c=[],className:l,value:u,onChange:d,onFocus:p,onBlur:f,getOptionLabel:y}){return k.jsx(de.Autocomplete,{id:e,disablePortal:!0,disabled:t,disableClearable:!r,fullWidth:i,options:c,className:`papi-combo-box ${o?"error":""} ${l??""}`,value:u,onChange:d,onFocus:p,onBlur:f,getOptionLabel:y,renderInput:g=>k.jsx(de.TextField,{...g,error:o,fullWidth:i,disabled:t,label:n,style:{width:a}})})}function bo({startChapter:e,endChapter:n,handleSelectStartChapter:t,handleSelectEndChapter:r,isDisabled:o,chapterCount:i}){const a=se.useMemo(()=>Array.from({length:i},(u,d)=>d+1),[i]),c=(u,d)=>{t(d),d>n&&r(d)},l=(u,d)=>{r(d),d<e&&t(d)};return k.jsxs(k.Fragment,{children:[k.jsx(de.FormControlLabel,{className:"book-selection-chapter-form-label start",disabled:o,control:k.jsx(wn,{onChange:(u,d)=>c(u,d),className:"book-selection-chapter",isClearable:!1,options:a,getOptionLabel:u=>u.toString(),value:e,isDisabled:o},"start chapter"),label:"Chapters",labelPlacement:"start"}),k.jsx(de.FormControlLabel,{className:"book-selection-chapter-form-label end",disabled:o,control:k.jsx(wn,{onChange:(u,d)=>l(u,d),className:"book-selection-chapter",isClearable:!1,options:a,getOptionLabel:u=>u.toString(),value:n,isDisabled:o},"end chapter"),label:"to",labelPlacement:"start"})]})}var Ve=(e=>(e.After="after",e.Before="before",e.Above="above",e.Below="below",e))(Ve||{});function Tr({id:e,isChecked:n,labelText:t="",labelPosition:r=Ve.After,isIndeterminate:o=!1,isDefaultChecked:i,isDisabled:a=!1,hasError:c=!1,className:l,onChange:u}){const d=k.jsx(de.Checkbox,{id:e,checked:n,indeterminate:o,defaultChecked:i,disabled:a,className:`papi-checkbox ${c?"error":""} ${l??""}`,onChange:u});let p;if(t){const f=r===Ve.Before||r===Ve.Above,y=k.jsx("span",{className:`papi-checkbox-label ${c?"error":""} ${l??""}`,children:t}),g=r===Ve.Before||r===Ve.After,b=g?y:k.jsx("div",{children:y}),h=g?d:k.jsx("div",{children:d});p=k.jsxs(de.FormLabel,{className:`papi-checkbox ${r.toString()}`,disabled:a,error:c,children:[f&&b,h,!f&&b]})}else p=d;return p}function $t(e,n,t){return e?k.jsx(de.ListItemIcon,{children:k.jsx("img",{src:e,alt:`${t?"Leading":"Trailing"} icon for ${n}`})}):void 0}function kr(e){const{onClick:n,name:t,allowForLeadingIcons:r=!0,iconPathBefore:o=void 0,iconPathAfter:i=void 0,hasAutoFocus:a=!1,className:c,isDense:l=!0,hasDisabledGutters:u=!1,hasDivider:d=!1,focusVisibleClassName:p,id:f,children:y}=e;return k.jsx(de.MenuItem,{sx:{lineHeight:.8},autoFocus:a,className:c,dense:l,disableGutters:u,divider:d,focusVisibleClassName:p,onClick:n,id:f,children:t?k.jsxs(k.Fragment,{children:[$t(o,t,!0),k.jsx(de.ListItemText,{primary:t,inset:!o&&r}),$t(i,t,!1)]}):y})}function ft({commandHandler:e,className:n,items:t,id:r,onClick:o}){const i=(t==null?void 0:t.find(a=>a.iconPathBefore!==void 0))!==void 0;return k.jsx("div",{id:r,className:`papi-menu ${n??""}`,children:t==null?void 0:t.map((a,c)=>k.jsx(kr,{className:`papi-menu-item ${a.className}`,allowForLeadingIcons:i,onClick:()=>{o&&o(),e(a)},...a},c))})}function go({commandHandler:e,name:n,className:t,items:r,id:o}){return k.jsxs(de.Grid,{id:o,item:!0,xs:"auto",className:`papi-menu-column ${t??""}`,children:[k.jsx("h3",{className:`papi-menu-column-header ${t??""}`,children:n}),k.jsx(ft,{commandHandler:e,items:r})]})}function Sr({commandHandler:e,className:n,columns:t,id:r}){return k.jsx(de.Grid,{container:!0,spacing:0,className:`papi-multi-column-menu ${n??""}`,columns:t.length,id:r,children:t.map((o,i)=>k.jsx(go,{commandHandler:e,name:o.name,className:n,items:o.items},i))})}function yo({id:e,label:n,isDisabled:t=!1,tooltip:r,isTooltipSuppressed:o=!1,adjustMarginToAlignToEdge:i=!1,size:a="medium",className:c,onClick:l,children:u}){return k.jsx(de.IconButton,{id:e,disabled:t,edge:i,size:a,"aria-label":n,title:o?void 0:r??n,className:`papi-icon-button ${c??""}`,onClick:l,children:u})}function S(){return S=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},S.apply(this,arguments)}function ce(e,n){if(e==null)return{};var t={},r=Object.keys(e),o,i;for(i=0;i<r.length;i++)o=r[i],!(n.indexOf(o)>=0)&&(t[o]=e[o]);return t}function vo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var it={exports:{}},ne={};/**
 * @license React
