...
.dark\\:tw-border-destructive:where(.tw-dark, .tw-dark *) {
  border-color: hsl(var(--destructive));
}
.dark\\:tw-text-rose-400:where(.tw-dark, .tw-dark *) {
  --tw-text-opacity: 1;
  color: rgb(251 113 133 / var(--tw-text-opacity, 1));
}
.dark\\:tw-text-sky-400:where(.tw-dark, .tw-dark *) {
  --tw-text-opacity: 1;
  color: rgb(56 189 248 / var(--tw-text-opacity, 1));
}
.dark\\:tw-text-teal-400:where(.tw-dark, .tw-dark *) {
  --tw-text-opacity: 1;
