...
=======
"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const e=require("react/jsx-runtime"),s=require("react"),dr=require("clsx"),cr=require("tailwind-merge"),ft=require("class-variance-authority"),me=require("@radix-ui/react-dropdown-menu"),N=require("lucide-react"),x=require("platform-bible-utils"),yt=require("@radix-ui/react-slot"),pr=require("@radix-ui/react-label"),ur=require("@radix-ui/react-radio-group"),mr=require("@radix-ui/react-popover"),Y=require("cmdk"),hr=require("@radix-ui/react-dialog"),X=require("@tanstack/react-table"),gr=require("@radix-ui/react-select"),fr=require("markdown-to-jsx"),br=require("@radix-ui/react-checkbox"),xr=require("@radix-ui/react-toggle-group"),vr=require("@radix-ui/react-toggle"),yr=require("@radix-ui/react-separator"),Nr=require("@radix-ui/react-tooltip"),kr=require("@radix-ui/react-tabs"),jr=require("@radix-ui/react-menubar"),Sr=require("react-hotkeys-hook"),Cr=require("@radix-ui/react-avatar"),He=require("sonner"),Rr=require("@radix-ui/react-slider"),Tr=require("@radix-ui/react-switch");function L(t){const n=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(t){for(const r in t)if(r!=="default"){const a=Object.getOwnPropertyDescriptor(t,r);Object.defineProperty(n,r,a.get?a:{enumerable:!0,get:()=>t[r]})}}return n.default=t,Object.freeze(n)}const E=L(me),Ye=L(pr),Et=L(ur),Bt=L(mr),nt=L(hr),F=L(gr),le=L(br),$t=L(xr),Ke=L(vr),Ue=L(yr),At=L(Nr),K=L(kr),B=L(jr),Nt=L(Cr),Mt=L(Rr),de=L(Tr),_r=cr.extendTailwindMerge({prefix:"tw-"});function d(...t){return _r(dr.clsx(t))}const bt=s.forwardRef(({className:t,type:n,...r},a)=>e.jsx("input",{type:n,className:d("pr-twp tw-flex tw-h-10 tw-rounded-md tw-border tw-border-input tw-bg-background tw-px-3 tw-py-2 tw-text-sm tw-ring-offset-background file:tw-border-0 file:tw-bg-transparent file:tw-text-sm file:tw-font-medium file:tw-text-foreground placeholder:tw-text-muted-foreground focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-cursor-not-allowed disabled:tw-opacity-50",t),ref:a,...r}));bt.displayName="Input";const Ir=s.forwardRef(({handleSearch:t,handleKeyDown:n,handleOnClick:r,handleSubmit:a,className:o,...i},l)=>e.jsx("div",{className:"tw-relative",children:e.jsx(bt,{...i,type:"text",className:d("tw-box-border tw-w-[200px] tw-gap-2.5 tw-rounded-lg tw-border tw-border-solid tw-bg-background tw-py-2 tw-pe-2 tw-ps-4 tw-font-medium tw-shadow-none tw-outline-none",o),onChange:w=>t(w.target.value),onKeyDown:w=>{w.key==="Enter"?(a(),w.preventDefault()):n(w)},onClick:r,ref:l})})),he=s.createContext(void 0);function Q(){const t=s.useContext(he);if(!t)throw new Error("useMenuContext must be used within a MenuContext.Provider.");return t}const rt=ft.cva("",{variants:{variant:{default:"",muted:"hover:tw-bg-muted hover:tw-text-foreground focus:tw-bg-muted focus:tw-text-foreground data-[state=open]:tw-bg-muted data-[state=open]:tw-text-foreground"}},defaultVariants:{variant:"default"}}),zr="layoutDirection";function O(){const t=localStorage.getItem(zr);return t==="rtl"?t:"ltr"}const Ht=E.Trigger,ge=E.Group,Je=E.Portal,We=E.Sub,Mr=E.RadioGroup;function Pt({variant:t="default",...n}){const r=s.useMemo(()=>({variant:t}),[t]);return e.jsx(he.Provider,{value:r,children:e.jsx(E.Root,{...n})})}const fe=s.forwardRef(({className:t,inset:n,children:r,...a},o)=>{const i=Q();return e.jsxs(E.SubTrigger,{ref:o,className:d("tw-flex tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-px-2 tw-py-1.5 tw-text-sm tw-outline-none focus:tw-bg-accent data-[state=open]:tw-bg-accent",n&&"tw-pl-8",t,rt({variant:i.variant})),...a,children:[r,e.jsx(N.ChevronRight,{className:"tw-ml-auto tw-h-4 tw-w-4"})]})});fe.displayName=E.SubTrigger.displayName;const be=s.forwardRef(({className:t,...n},r)=>e.jsx(E.SubContent,{ref:r,className:d("pr-twp tw-z-50 tw-min-w-[8rem] tw-overflow-hidden tw-rounded-md tw-border tw-bg-popover tw-p-1 tw-text-popover-foreground tw-shadow-lg data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0 data-[state=closed]:tw-zoom-out-95 data-[state=open]:tw-zoom-in-95 data-[side=bottom]:tw-slide-in-from-top-2 data-[side=left]:tw-slide-in-from-right-2 data-[side=right]:tw-slide-in-from-left-2 data-[side=top]:tw-slide-in-from-bottom-2",t),...n}));be.displayName=E.SubContent.displayName;const kt=s.forwardRef(({className:t,sideOffset:n=4,children:r,...a},o)=>{const i=O();return e.jsx(E.Portal,{children:e.jsx(E.Content,{ref:o,sideOffset:n,className:d("pr-twp tw-z-50 tw-min-w-[8rem] tw-overflow-hidden tw-rounded-md tw-border tw-bg-popover tw-p-1 tw-text-popover-foreground tw-shadow-md data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0 data-[state=closed]:tw-zoom-out-95 data-[state=open]:tw-zoom-in-95 data-[side=bottom]:tw-slide-in-from-top-2 data-[side=left]:tw-slide-in-from-right-2 data-[side=right]:tw-slide-in-from-left-2 data-[side=top]:tw-slide-in-from-bottom-2",t),...a,children:e.jsx("div",{dir:i,children:r})})})});kt.displayName=E.Content.displayName;const Yt=s.forwardRef(({className:t,inset:n,...r},a)=>{const o=O(),i=Q();return e.jsx(E.Item,{ref:a,className:d("tw-flex tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-px-2 tw-py-1.5 tw-text-sm tw-outline-none tw-transition-colors focus:tw-bg-accent data-[disabled]:tw-pointer-events-none data-[disabled]:tw-opacity-50",n&&"tw-pl-8",t,rt({variant:i.variant})),...r,dir:o})});Yt.displayName=E.Item.displayName;const Kt=s.forwardRef(({className:t,children:n,checked:r,...a},o)=>{const i=Q();return e.jsxs(E.CheckboxItem,{ref:o,className:d("tw-relative tw-flex tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-py-1.5 tw-pe-2 tw-ps-8 tw-text-sm tw-outline-none tw-transition-colors focus:tw-bg-accent focus:tw-text-accent-foreground data-[disabled]:tw-pointer-events-none data-[disabled]:tw-opacity-50",t,rt({variant:i.variant})),checked:r,...a,children:[e.jsx("span",{className:"tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2",children:e.jsx(E.ItemIndicator,{children:e.jsx(N.Check,{className:"tw-h-4 tw-w-4"})})}),n]})});Kt.displayName=E.CheckboxItem.displayName;const xe=s.forwardRef(({className:t,children:n,...r},a)=>{const o=Q();return e.jsxs(E.RadioItem,{ref:a,className:d("tw-relative tw-flex tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-py-1.5 tw-pe-2 tw-ps-8 tw-text-sm tw-outline-none tw-transition-colors focus:tw-bg-accent focus:tw-text-accent-foreground data-[disabled]:tw-pointer-events-none data-[disabled]:tw-opacity-50",t,rt({variant:o.variant})),...r,children:[e.jsx("span",{className:"tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2",children:e.jsx(E.ItemIndicator,{children:e.jsx(N.Circle,{className:"tw-h-2 tw-w-2 tw-fill-current"})})}),n]})});xe.displayName=E.RadioItem.displayName;const Ft=s.forwardRef(({className:t,inset:n,...r},a)=>e.jsx(E.Label,{ref:a,className:d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold",n&&"tw-pl-8",t),...r}));Ft.displayName=E.Label.displayName;const jt=s.forwardRef(({className:t,...n},r)=>e.jsx(E.Separator,{ref:r,className:d("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted",t),...n}));jt.displayName=E.Separator.displayName;function Ze({className:t,...n}){return e.jsx("span",{className:d("tw-ms-auto tw-text-xs tw-tracking-widest tw-opacity-60",t),...n})}Ze.displayName="DropdownMenuShortcut";var Dr=Object.defineProperty,Er=(t,n,r)=>n in t?Dr(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,R=(t,n,r)=>Er(t,typeof n!="symbol"?n+"":n,r);const mt=["GEN","EXO","LEV","NUM","DEU","JOS","JDG","RUT","1SA","2SA","1KI","2KI","1CH","2CH","EZR","NEH","EST","JOB","PSA","PRO","ECC","SNG","ISA","JER","LAM","EZK","DAN","HOS","JOL","AMO","OBA","JON","MIC","NAM","HAB","ZEP","HAG","ZEC","MAL","MAT","MRK","LUK","JHN","ACT","ROM","1CO","2CO","GAL","EPH","PHP","COL","1TH","2TH","1TI","2TI","TIT","PHM","HEB","JAS","1PE","2PE","1JN","2JN","3JN","JUD","REV","TOB","JDT","ESG","WIS","SIR","BAR","LJE","S3Y","SUS","BEL","1MA","2MA","3MA","4MA","1ES","2ES","MAN","PS2","ODA","PSS","JSA","JDB","TBS","SST","DNT","BLT","XXA","XXB","XXC","XXD","XXE","XXF","XXG","FRT","BAK","OTH","3ES","EZA","5EZ","6EZ","INT","CNC","GLO","TDX","NDX","DAG","PS3","2BA","LBA","JUB","ENO","1MQ","2MQ","3MQ","REP","4BA","LAO"],ve=["XXA","XXB","XXC","XXD","XXE","XXF","XXG","FRT","BAK","OTH","INT","CNC","GLO","TDX","NDX"],Qe=["Genesis","Exodus","Leviticus","Numbers","Deuteronomy","Joshua","Judges","Ruth","1 Samuel","2 Samuel","1 Kings","2 Kings","1 Chronicles","2 Chronicles","Ezra","Nehemiah","Esther (Hebrew)","Job","Psalms","Proverbs","Ecclesiastes","Song of Songs","Isaiah","Jeremiah","Lamentations","Ezekiel","Daniel (Hebrew)","Hosea","Joel","Amos","Obadiah","Jonah","Micah","Nahum","Habakkuk","Zephaniah","Haggai","Zechariah","Malachi","Matthew","Mark","Luke","John","Acts","Romans","1 Corinthians","2 Corinthians","Galatians","Ephesians","Philippians","Colossians","1 Thessalonians","2 Thessalonians","1 Timothy","2 Timothy","Titus","Philemon","Hebrews","James","1 Peter","2 Peter","1 John","2 John","3 John","Jude","Revelation","Tobit","Judith","Esther Greek","Wisdom of Solomon","Sirach (Ecclesiasticus)","Baruch","Letter of Jeremiah","Song of 3 Young Men","Susanna","Bel and the Dragon","1 Maccabees","2 Maccabees","3 Maccabees","4 Maccabees","1 Esdras (Greek)","2 Esdras (Latin)","Prayer of Manasseh","Psalm 151","Odes","Psalms of Solomon","Joshua A. *obsolete*","Judges B. *obsolete*","Tobit S. *obsolete*","Susanna Th. *obsolete*","Daniel Th. *obsolete*","Bel Th. *obsolete*","Extra A","Extra B","Extra C","Extra D","Extra E","Extra F","Extra G","Front Matter","Back Matter","Other Matter","3 Ezra *obsolete*","Apocalypse of Ezra","5 Ezra (Latin Prologue)","6 Ezra (Latin Epilogue)","Introduction","Concordance ","Glossary ","Topical Index","Names Index","Daniel Greek","Psalms 152-155","2 Baruch (Apocalypse)","Letter of Baruch","Jubilees","Enoch","1 Meqabyan","2 Meqabyan","3 Meqabyan","Reproof (Proverbs 25-31)","4 Baruch (Rest of Baruch)","Laodiceans"],Ge=qr();function St(t,n=!0){return n&&(t=t.toUpperCase()),t in Ge?Ge[t]:0}function ye(t){return St(t)>0}function Br(t){const n=typeof t=="string"?St(t):t;return n>=40&&n<=66}function Vr(t){return(typeof t=="string"?St(t):t)<=39}function tn(t){return t<=66}function Ar(t){const n=typeof t=="string"?St(t):t;return rn(n)&&!tn(n)}function*Pr(){for(let t=1;t<=mt.length;t++)yield t}const Fr=1,en=mt.length;function Or(){return["XXA","XXB","XXC","XXD","XXE","XXF","XXG"]}function Ne(t,n="***"){const r=t-1;return r<0||r>=mt.length?n:mt[r]}function nn(t){return t<=0||t>en?"******":Qe[t-1]}function Gr(t){return nn(St(t))}function rn(t){const n=typeof t=="number"?Ne(t):t;return ye(n)&&!ve.includes(n)}function Lr(t){const n=typeof t=="number"?Ne(t):t;return ye(n)&&ve.includes(n)}function Xr(t){return Qe[t-1].includes("*obsolete*")}function qr(){const t={};for(let n=0;n<mt.length;n++)t[mt[n]]=n+1;return t}const P={allBookIds:mt,nonCanonicalIds:ve,bookIdToNumber:St,isBookIdValid:ye,isBookNT:Br,isBookOT:Vr,isBookOTNT:tn,isBookDC:Ar,allBookNumbers:Pr,firstBook:Fr,lastBook:en,extraBooks:Or,bookNumberToId:Ne,bookNumberToEnglishName:nn,bookIdToEnglishName:Gr,isCanonical:rn,isExtraMaterial:Lr,isObsolete:Xr};var tt=(t=>(t[t.Unknown=0]="Unknown",t[t.Original=1]="Original",t[t.Septuagint=2]="Septuagint",t[t.Vulgate=3]="Vulgate",t[t.English=4]="English",t[t.RussianProtestant=5]="RussianProtestant",t[t.RussianOrthodox=6]="RussianOrthodox",t))(tt||{});const J=class{constructor(n){if(R(this,"name"),R(this,"fullPath"),R(this,"isPresent"),R(this,"hasVerseSegments"),R(this,"isCustomized"),R(this,"baseVersification"),R(this,"scriptureBooks"),R(this,"_type"),n==null)throw new Error("Argument undefined");typeof n=="string"?(this.name=n,this._type=tt[n]):(this._type=n,this.name=tt[n])}get type(){return this._type}equals(n){return!n.type||!this.type?!1:n.type===this.type}};R(J,"Original",new J(tt.Original)),R(J,"Septuagint",new J(tt.Septuagint)),R(J,"Vulgate",new J(tt.Vulgate)),R(J,"English",new J(tt.English)),R(J,"RussianProtestant",new J(tt.RussianProtestant)),R(J,"RussianOrthodox",new J(tt.RussianOrthodox));let pt=J;function Le(t,n){const r=n[0];for(let a=1;a<n.length;a++)t=t.split(n[a]).join(r);return t.split(r)}var an=(t=>(t[t.Valid=0]="Valid",t[t.UnknownVersification=1]="UnknownVersification",t[t.OutOfRange=2]="OutOfRange",t[t.VerseOutOfOrder=3]="VerseOutOfOrder",t[t.VerseRepeated=4]="VerseRepeated",t))(an||{});const H=class I{constructor(n,r,a,o){if(R(this,"firstChapter"),R(this,"lastChapter"),R(this,"lastVerse"),R(this,"hasSegmentsDefined"),R(this,"text"),R(this,"BBBCCCVVVS"),R(this,"longHashCode"),R(this,"versification"),R(this,"rtlMark","‏"),R(this,"_bookNum",0),R(this,"_chapterNum",0),R(this,"_verseNum",0),R(this,"_verse"),a==null&&o==null)if(n!=null&&typeof n=="string"){const i=n,l=r!=null&&r instanceof pt?r:void 0;this.setEmpty(l),this.parse(i)}else if(n!=null&&typeof n=="number"){const i=r!=null&&r instanceof pt?r:void 0;this.setEmpty(i),this._verseNum=n%I.chapterDigitShifter,this._chapterNum=Math.floor(n%I.bookDigitShifter/I.chapterDigitShifter),this._bookNum=Math.floor(n/I.bookDigitShifter)}else if(r==null)if(n!=null&&n instanceof I){const i=n;this._bookNum=i.bookNum,this._chapterNum=i.chapterNum,this._verseNum=i.verseNum,this._verse=i.verse,this.versification=i.versification}else{if(n==null)return;const i=n instanceof pt?n:I.defaultVersification;this.setEmpty(i)}else throw new Error("VerseRef constructor not supported.");else if(n!=null&&r!=null&&a!=null)if(typeof n=="string"&&typeof r=="string"&&typeof a=="string")this.setEmpty(o),this.updateInternal(n,r,a);else if(typeof n=="number"&&typeof r=="number"&&typeof a=="number")this._bookNum=n,this._chapterNum=r,this._verseNum=a,this.versification=o??I.defaultVersification;else throw new Error("VerseRef constructor not supported.");else throw new Error("VerseRef constructor not supported.")}static isVerseParseable(n){return n.length>0&&"0123456789".includes(n[0])&&!n.endsWith(this.verseRangeSeparator)&&!n.endsWith(this.verseSequenceIndicator)}static tryParse(n){let r;try{return r=new I(n),{success:!0,verseRef:r}}catch(a){if(a instanceof _t)return r=new I,{success:!1,verseRef:r};throw a}}static getBBBCCCVVV(n,r,a){return n%I.bcvMaxValue*I.bookDigitShifter+(r>=0?r%I.bcvMaxValue*I.chapterDigitShifter:0)+(a>=0?a%I.bcvMaxValue:0)}static fromJSON(n){const{book:r,chapterNum:a,verseNum:o,verse:i,versificationStr:l}=n,w=i||o.toString();let c;return l&&(c=new pt(l)),r?new I(r,a.toString(),w,c):new I}static tryGetVerseNum(n){let r;if(!n)return r=-1,{success:!0,vNum:r};r=0;let a;for(let o=0;o<n.length;o++){if(a=n[o],a<"0"||a>"9")return o===0&&(r=-1),{success:!1,vNum:r};if(r=r*10+ +a-0,r>I.bcvMaxValue)return r=-1,{success:!1,vNum:r}}return{success:!0,vNum:r}}get isDefault(){return this.bookNum===0&&this.chapterNum===0&&this.verseNum===0&&this.versification==null}get hasMultiple(){return this._verse!=null&&(this._verse.includes(I.verseRangeSeparator)||this._verse.includes(I.verseSequenceIndicator))}get book(){return P.bookNumberToId(this.bookNum,"")}set book(n){this.bookNum=P.bookIdToNumber(n)}get chapter(){return this.isDefault||this._chapterNum<0?"":this._chapterNum.toString()}set chapter(n){const r=+n;this._chapterNum=Number.isInteger(r)?r:-1}get verse(){return this._verse!=null?this._verse:this.isDefault||this._verseNum<0?"":this._verseNum.toString()}set verse(n){const{success:r,vNum:a}=I.tryGetVerseNum(n);this._verse=r?void 0:n.replace(this.rtlMark,""),this._verseNum=a,!(this._verseNum>=0)&&({vNum:this._verseNum}=I.tryGetVerseNum(this._verse))}get bookNum(){return this._bookNum}set bookNum(n){if(n<=0||n>P.lastBook)throw new _t("BookNum must be greater than zero and less than or equal to last book");this._bookNum=n}get chapterNum(){return this._chapterNum}set chapterNum(n){this.chapterNum=n}get verseNum(){return this._verseNum}set verseNum(n){this._verseNum=n}get versificationStr(){var n;return(n=this.versification)==null?void 0:n.name}set versificationStr(n){this.versification=this.versification!=null?new pt(n):void 0}get valid(){return this.validStatus===0}get validStatus(){return this.validateVerse(I.verseRangeSeparators,I.verseSequenceIndicators)}get BBBCCC(){return I.getBBBCCCVVV(this._bookNum,this._chapterNum,0)}get BBBCCCVVV(){return I.getBBBCCCVVV(this._bookNum,this._chapterNum,this._verseNum)}get isExcluded(){return!1}parse(n){if(n=n.replace(this.rtlMark,""),n.includes("/")){const i=n.split("/");if(n=i[0],i.length>1)try{const l=+i[1].trim();this.versification=new pt(tt[l])}catch{throw new _t("Invalid reference : "+n)}}const r=n.trim().split(" ");if(r.length!==2)throw new _t("Invalid reference : "+n);const a=r[1].split(":"),o=+a[0];if(a.length!==2||P.bookIdToNumber(r[0])===0||!Number.isInteger(o)||o<0||!I.isVerseParseable(a[1]))throw new _t("Invalid reference : "+n);this.updateInternal(r[0],a[0],a[1])}simplify(){this._verse=void 0}clone(){return new I(this)}toString(){const n=this.book;return n===""?"":`${n} ${this.chapter}:${this.verse}`}toJSON(){let n=this.verse;(n===""||n===this.verseNum.toString())&&(n=void 0);const r={book:this.book,chapterNum:this.chapterNum,verseNum:this.verseNum,verse:n,versificationStr:this.versificationStr};return n||delete r.verse,r}equals(n){return n instanceof I?n._bookNum===this._bookNum&&n._chapterNum===this._chapterNum&&n._verseNum===this._verseNum&&n.verse===this.verse&&(n.versification==null&&this.versification==null||n.versification!=null&&this.versification!=null&&n.versification.equals(this.versification)):!1}allVerses(n=!1,r=I.verseRangeSeparators,a=I.verseSequenceIndicators){if(this._verse==null||this.chapterNum<=0)return[this.clone()];const o=[],i=Le(this._verse,a);for(const l of i.map(w=>Le(w,r))){const w=this.clone();w.verse=l[0];const c=w.verseNum;if(o.push(w),l.length>1){const p=this.clone();if(p.verse=l[1],!n)for(let h=c+1;h<p.verseNum;h++){const f=new I(this._bookNum,this._chapterNum,h,this.versification);this.isExcluded||o.push(f)}o.push(p)}}return o}validateVerse(n,r){if(!this.verse)return this.internalValid;let a=0;for(const o of this.allVerses(!0,n,r)){const i=o.internalValid;if(i!==0)return i;const l=o.BBBCCCVVV;if(a>l)return 3;if(a===l)return 4;a=l}return 0}get internalValid(){return this.versification==null?1:this._bookNum<=0||this._bookNum>P.lastBook?2:(P.isCanonical(this._bookNum),0)}setEmpty(n=I.defaultVersification){this._bookNum=0,this._chapterNum=-1,this._verse=void 0,this.versification=n}updateInternal(n,r,a){this.bookNum=P.bookIdToNumber(n),this.chapter=r,this.verse=a}};R(H,"defaultVersification",pt.English),R(H,"verseRangeSeparator","-"),R(H,"verseSequenceIndicator",","),R(H,"verseRangeSeparators",[H.verseRangeSeparator]),R(H,"verseSequenceIndicators",[H.verseSequenceIndicator]),R(H,"chapterDigitShifter",1e3),R(H,"bookDigitShifter",H.chapterDigitShifter*H.chapterDigitShifter),R(H,"bcvMaxValue",H.chapterDigitShifter-1),R(H,"ValidStatusType",an);class _t extends Error{}const $r=s.forwardRef(({bookId:t,handleSelectBook:n,isSelected:r,handleHighlightBook:a,handleKeyDown:o,bookType:i,children:l},w)=>e.jsxs(Yt,{ref:w,textValue:t,className:d("tw-mx-1 tw-flex-col tw-items-start tw-px-1 tw-font-normal tw-text-foreground/80",{"tw-bg-amber-50 tw-text-yellow-900 data-[highlighted]:tw-bg-amber-100":r}),onSelect:c=>{c.preventDefault(),n()},onKeyDown:c=>{o(c)},onFocus:a,onMouseMove:a,children:[e.jsx("span",{className:d("tw-border-b-0 tw-border-e-0 tw-border-s-2 tw-border-t-0 tw-border-solid tw-px-2",{"tw-font-bold":r,"tw-border-s-red-200":i.toLowerCase()==="ot","tw-border-s-purple-200":i.toLowerCase()==="nt","tw-border-s-indigo-200":i.toLowerCase()==="dc"}),children:P.bookIdToEnglishName(t)}),r&&e.jsx("div",{children:l})]},t));function Hr({handleSelectChapter:t,endChapter:n,activeChapter:r,highlightedChapter:a,handleHighlightedChapter:o}){const i=Array.from({length:n},(w,c)=>c+1),l=s.useCallback(w=>{o(w)},[o]);return e.jsx("div",{className:d("tw-flex tw-flex-wrap tw-items-start tw-justify-start tw-self-stretch"),children:i.map(w=>e.jsx("div",{className:d("tw-box-content tw-flex tw-h-4 tw-w-4 tw-cursor-pointer tw-items-center tw-justify-end tw-rounded-md tw-p-2 tw-text-amber-800",{"tw-font-semibold tw-text-amber-900":w===r,"tw-bg-amber-200":w===a}),onClick:c=>{c.preventDefault(),c.stopPropagation(),t(w)},role:"button",onKeyDown:c=>{c.key==="Enter"&&t(w)},tabIndex:0,onMouseMove:()=>l(w),children:w},w))})}const ke=P.allBookIds.filter(t=>!P.isObsolete(P.bookIdToNumber(t))),Yr={OT:"Old Testament",NT:"New Testament",DC:"Deuterocanon"},Xe=["OT","NT","DC"],Kr=96,Ur=[/^(\w+)$/i,/^(\w+)(?:\s(\d+))$/i,/^(\w+)(?:\s(\d+):(\d+))$/i],It=t=>x.getChaptersForBook(P.bookIdToNumber(t));function Jr(){return ke.map(n=>P.bookIdToEnglishName(n))}function Wr(t){return Jr().includes(t)}function Zr(t){const n=t.toLowerCase().replace(/^\w/,r=>r.toUpperCase());if(Wr(n))return ke.find(a=>P.bookIdToEnglishName(a)===n)}function Qr({scrRef:t,handleSubmit:n,className:r,getActiveBookIds:a}){const o=O(),[i,l]=s.useState(""),[w,c]=s.useState(t.book),[p,h]=s.useState(t.chapterNum??0),[f,m]=s.useState(t.book),[u,g]=s.useState(!1),[j,S]=s.useState(u),y=s.useRef(void 0),v=s.useRef(void 0),z=s.useRef(void 0),q=s.useCallback(C=>{const M=a?a():ke;return{OT:M.filter(A=>P.isBookOT(A)),NT:M.filter(A=>P.isBookNT(A)),DC:M.filter(A=>P.isBookDC(A))}[C].filter(A=>{const b=P.bookIdToEnglishName(A).toLowerCase(),_=i.replace(/[^a-zA-Z]/g,"").toLowerCase();return b.includes(_)||A.toLowerCase().includes(_)})},[i,a]),U=C=>{l(C)},lt=s.useRef(!1),dt=s.useCallback(C=>{if(lt.current){lt.current=!1;return}g(C)},[]),k=s.useCallback((C,M,A,b)=>{if(h(t.book!==C?1:t.chapterNum),M||It(C)===-1){n({book:C,chapterNum:A??1,verseNum:b??1}),g(!1),l("");return}c(w!==C?C:""),g(!M)},[n,t.book,t.chapterNum,w]),T=C=>{C<=0||C>It(w)||k(w,!0,C)},$=s.useCallback(()=>{Ur.forEach(C=>{const M=C.exec(i);if(M){const[A,b=void 0,_=void 0]=M.slice(1),Z=Zr(A);(P.isBookIdValid(A)||Z)&&k(Z??A,!0,b?parseInt(b,10):1,_?parseInt(_,10):1)}}),y.current.blur()},[k,i]),V=s.useCallback(C=>{u?(C.key==="ArrowDown"||C.key==="ArrowUp")&&(z!=null&&z.current?z.current.focus():v.current&&v.current.focus(),C.preventDefault()):g(!0)},[u]),re=C=>{const{key:M}=C;M==="ArrowRight"||M==="ArrowLeft"||M==="ArrowDown"||M==="ArrowUp"||M==="Enter"||y.current.dispatchEvent(new KeyboardEvent("keydown",{key:M}))},ae=C=>{const{key:M}=C;if(f===w){if(M==="Enter"){C.preventDefault(),k(w,!0,p);return}const A=M==="ArrowRight"&&!o||M==="ArrowRight"&&o==="ltr"||M==="ArrowLeft"&&o==="rtl",b=M==="ArrowLeft"&&!o||M==="ArrowLeft"&&o==="ltr"||M==="ArrowRight"&&o==="rtl";let _=0;if(A)if(p<It(f))_=1;else{C.preventDefault();return}else if(b)if(p>1)_=-1;else{C.preventDefault();return}else M==="ArrowDown"?_=6:M==="ArrowUp"&&(_=-6);p+_<=0||p+_>It(f)?h(0):_!==0&&(h(p+_),C.preventDefault())}};return s.useEffect(()=>{w===f?w===t.book?h(t.chapterNum):h(1):h(0)},[f,t.book,t.chapterNum,w]),s.useLayoutEffect(()=>{S(u)},[u]),s.useLayoutEffect(()=>{const C=setTimeout(()=>{if(j&&v.current&&z.current&&!i){const A=z.current.offsetTop-Kr;v.current.scrollTo({top:A,behavior:"instant"})}},10);return()=>{clearTimeout(C)}},[j,i]),e.jsx("div",{className:"pr-twp tw-flex tw-bg-transparent",children:e.jsxs(Pt,{modal:!1,open:u,onOpenChange:dt,children:[e.jsx(Ht,{asChild:!0,children:e.jsx(Ir,{ref:y,value:i,handleSearch:U,handleKeyDown:V,handleOnClick:()=>{c(t.book),m(t.book),h(t.chapterNum>0?t.chapterNum:0),g(!0),l(x.formatScrRef(t,"English")),y.current.focus()},onFocus:()=>{lt.current=!0},onBlur:()=>{l("")},handleSubmit:$,placeholder:x.formatScrRef(t,"English"),className:r})}),e.jsx(kt,{className:"tw-m-1 tw-overflow-y-auto tw-p-0 tw-font-normal tw-text-foreground/80",style:{width:"233px",maxHeight:"500px",zIndex:"250"},onKeyDown:re,align:o==="ltr"?"start":"end",ref:v,children:e.jsx("div",{className:"rtl:tw-ps-2",children:Xe.map((C,M)=>{const A=q(C);return A.length>0&&e.jsxs("div",{children:[e.jsx(Ft,{className:"tw-font-semibold tw-text-foreground/80",children:Yr[C]}),A.map(b=>e.jsx("div",{children:e.jsx($r,{bookId:b,handleSelectBook:()=>k(b,!1),isSelected:w===b,handleHighlightBook:()=>m(b),handleKeyDown:ae,bookType:C,ref:_=>{w===b&&(z.current=_)},children:e.jsx(Hr,{handleSelectChapter:T,endChapter:It(b),activeChapter:t.book===b?t.chapterNum:0,highlightedChapter:p,handleHighlightedChapter:_=>{h(_)}})})},b)),Xe.length-1!==M?e.jsx(jt,{}):void 0]},C)})})})]})})}const on=ft.cva("pr-twp tw-inline-flex tw-items-center tw-justify-center tw-gap-2 tw-whitespace-nowrap tw-rounded-md tw-text-sm tw-font-medium tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50 [&_svg]:tw-pointer-events-none [&_svg]:tw-size-4 [&_svg]:tw-shrink-0",{variants:{variant:{default:"tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/90",destructive:"tw-bg-destructive tw-text-destructive-foreground hover:tw-bg-destructive/90",outline:"tw-border tw-border-input tw-bg-background hover:tw-bg-accent hover:tw-text-accent-foreground",secondary:"tw-bg-secondary tw-text-secondary-foreground hover:tw-bg-secondary/80",ghost:"hover:tw-bg-accent hover:tw-text-accent-foreground",link:"tw-text-primary tw-underline-offset-4 hover:tw-underline"},size:{default:"tw-h-10 tw-px-4 tw-py-2",sm:"tw-h-9 tw-rounded-md tw-px-3",lg:"tw-h-11 tw-rounded-md tw-px-8",icon:"tw-h-10 tw-w-10"}},defaultVariants:{variant:"default",size:"default"}}),D=s.forwardRef(({className:t,variant:n,size:r,asChild:a=!1,...o},i)=>{const l=a?yt.Slot:"button";return e.jsx(l,{className:d(on({variant:n,size:r,className:t})),ref:i,...o})});D.displayName="Button";const ta=ft.cva("tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"),G=s.forwardRef(({className:t,...n},r)=>e.jsx(Ye.Root,{ref:r,className:d("pr-twp",ta(),t),...n}));G.displayName=Ye.Root.displayName;const je=s.forwardRef(({className:t,...n},r)=>{const a=O();return e.jsx(Et.Root,{className:d("pr-twp tw-grid tw-gap-2",t),...n,ref:r,dir:a})});je.displayName=Et.Root.displayName;const Lt=s.forwardRef(({className:t,...n},r)=>e.jsx(Et.Item,{ref:r,className:d("pr-twp tw-aspect-square tw-h-4 tw-w-4 tw-rounded-full tw-border tw-border-primary tw-text-primary tw-ring-offset-background focus:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-cursor-not-allowed disabled:tw-opacity-50",t),...n,children:e.jsx(Et.Indicator,{className:"tw-flex tw-items-center tw-justify-center",children:e.jsx(N.Circle,{className:"tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current"})})}));Lt.displayName=Et.Item.displayName;const Se=Bt.Root,Ce=Bt.Trigger,Ut=s.forwardRef(({className:t,align:n="center",sideOffset:r=4,...a},o)=>{const i=O();return e.jsx(Bt.Portal,{children:e.jsx(Bt.Content,{ref:o,align:n,sideOffset:r,className:d("pr-twp tw-z-50 tw-w-72 tw-rounded-md tw-border tw-bg-popover tw-p-4 tw-text-popover-foreground tw-shadow-md tw-outline-none data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0 data-[state=closed]:tw-zoom-out-95 data-[state=open]:tw-zoom-in-95 data-[side=bottom]:tw-slide-in-from-top-2 data-[side=left]:tw-slide-in-from-right-2 data-[side=right]:tw-slide-in-from-left-2 data-[side=top]:tw-slide-in-from-bottom-2",t),...a,dir:i})})});Ut.displayName=Bt.Content.displayName;const ea=nt.Portal,sn=s.forwardRef(({className:t,...n},r)=>e.jsx(nt.Overlay,{ref:r,className:d("tw-fixed tw-inset-0 tw-z-50 tw-bg-black/80 data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0",t),...n}));sn.displayName=nt.Overlay.displayName;const na=s.forwardRef(({className:t,children:n,...r},a)=>{const o=O();return e.jsxs(ea,{children:[e.jsx(sn,{}),e.jsxs(nt.Content,{ref:a,className:d("pr-twp tw-fixed tw-left-[50%] tw-top-[50%] tw-z-50 tw-grid tw-w-full tw-max-w-lg tw-translate-x-[-50%] tw-translate-y-[-50%] tw-gap-4 tw-border tw-bg-background tw-p-6 tw-shadow-lg tw-duration-200 data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0 data-[state=closed]:tw-zoom-out-95 data-[state=open]:tw-zoom-in-95 data-[state=closed]:tw-slide-out-to-left-1/2 data-[state=closed]:tw-slide-out-to-top-[48%] data-[state=open]:tw-slide-in-from-left-1/2 data-[state=open]:tw-slide-in-from-top-[48%] sm:tw-rounded-lg",t),...r,dir:o,children:[n,e.jsxs(nt.Close,{className:d("tw-absolute tw-top-4 tw-rounded-sm tw-opacity-70 tw-ring-offset-background tw-transition-opacity hover:tw-opacity-100 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-ring focus:tw-ring-offset-2 disabled:tw-pointer-events-none data-[state=open]:tw-bg-accent data-[state=open]:tw-text-muted-foreground",{"tw-right-4":o==="ltr"},{"tw-left-4":o==="rtl"}),children:[e.jsx(N.X,{className:"tw-h-4 tw-w-4"}),e.jsx("span",{className:"tw-sr-only",children:"Close"})]})]})]})});na.displayName=nt.Content.displayName;const ra=s.forwardRef(({className:t,...n},r)=>e.jsx(nt.Title,{ref:r,className:d("tw-text-lg tw-font-semibold tw-leading-none tw-tracking-tight",t),...n}));ra.displayName=nt.Title.displayName;const aa=s.forwardRef(({className:t,...n},r)=>e.jsx(nt.Description,{ref:r,className:d("tw-text-sm tw-text-muted-foreground",t),...n}));aa.displayName=nt.Description.displayName;const Re=s.forwardRef(({className:t,...n},r)=>e.jsx(Y.Command,{ref:r,className:d("tw-flex tw-h-full tw-w-full tw-flex-col tw-overflow-hidden tw-rounded-md tw-bg-popover tw-text-popover-foreground",t),...n}));Re.displayName=Y.Command.displayName;const Te=s.forwardRef(({className:t,...n},r)=>{const a=O();return e.jsxs("div",{className:"tw-flex tw-items-center tw-border-b tw-px-3",dir:a,children:[e.jsx(N.Search,{className:"tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50"}),e.jsx(Y.Command.Input,{ref:r,className:d("tw-flex tw-h-11 tw-w-full tw-rounded-md tw-bg-transparent tw-py-3 tw-text-sm tw-outline-none placeholder:tw-text-muted-foreground disabled:tw-cursor-not-allowed disabled:tw-opacity-50",t),...n})]})});Te.displayName=Y.Command.Input.displayName;const _e=s.forwardRef(({className:t,...n},r)=>e.jsx(Y.Command.List,{ref:r,className:d("tw-max-h-[300px] tw-overflow-y-auto tw-overflow-x-hidden",t),...n}));_e.displayName=Y.Command.List.displayName;const Ie=s.forwardRef((t,n)=>e.jsx(Y.Command.Empty,{ref:n,className:"tw-py-6 tw-text-center tw-text-sm",...t}));Ie.displayName=Y.Command.Empty.displayName;const wn=s.forwardRef(({className:t,...n},r)=>e.jsx(Y.Command.Group,{ref:r,className:d("tw-overflow-hidden tw-p-1 tw-text-foreground [&_[cmdk-group-heading]]:tw-px-2 [&_[cmdk-group-heading]]:tw-py-1.5 [&_[cmdk-group-heading]]:tw-text-xs [&_[cmdk-group-heading]]:tw-font-medium [&_[cmdk-group-heading]]:tw-text-muted-foreground",t),...n}));wn.displayName=Y.Command.Group.displayName;const oa=s.forwardRef(({className:t,...n},r)=>e.jsx(Y.Command.Separator,{ref:r,className:d("tw--mx-1 tw-h-px tw-bg-border",t),...n}));oa.displayName=Y.Command.Separator.displayName;const ze=s.forwardRef(({className:t,...n},r)=>e.jsx(Y.Command.Item,{ref:r,className:d("tw-relative tw-flex tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-px-2 tw-py-1.5 tw-text-sm tw-outline-none data-[disabled=true]:tw-pointer-events-none data-[selected=true]:tw-bg-accent data-[selected=true]:tw-text-accent-foreground data-[disabled=true]:tw-opacity-50",t),...n}));ze.displayName=Y.Command.Item.displayName;function sa(t){return typeof t=="string"?t:typeof t=="number"?t.toString():t.label}function Xt({id:t,options:n=[],className:r,buttonClassName:a,popoverContentClassName:o,value:i,onChange:l=()=>{},getOptionLabel:w=sa,icon:c=void 0,buttonPlaceholder:p="",textPlaceholder:h="",commandEmptyMessage:f="No option found",buttonVariant:m="outline",alignDropDown:u="start",isDisabled:g=!1,...j}){const[S,y]=s.useState(!1);return e.jsxs(Se,{open:S,onOpenChange:y,...j,children:[e.jsx(Ce,{asChild:!0,children:e.jsxs(D,{variant:m,role:"combobox","aria-expanded":S,id:t,className:d("tw-flex tw-w-[200px] tw-items-center tw-justify-between tw-overflow-hidden",a??r),disabled:g,children:[e.jsxs("div",{className:"tw-flex tw-flex-1 tw-items-center tw-overflow-hidden",children:[c&&e.jsx("div",{className:"tw-pe-2",children:c}),e.jsx("span",{className:d("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"),children:i?w(i):p})]}),e.jsx(N.ChevronsUpDown,{className:"tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50"})]})}),e.jsx(Ut,{align:u,className:d("tw-w-[200px] tw-p-0",o),children:e.jsxs(Re,{children:[e.jsx(Te,{placeholder:h,className:"tw-text-inherit"}),e.jsx(Ie,{children:f}),e.jsx(_e,{children:n.map(v=>e.jsxs(ze,{value:w(v),onSelect:()=>{l(v),y(!1)},children:[e.jsx(N.Check,{className:d("tw-me-2 tw-h-4 tw-w-4",{"tw-opacity-0":!i||w(i)!==w(v)})}),w(v)]},w(v)))})]})})]})}function ln({startChapter:t,endChapter:n,handleSelectStartChapter:r,handleSelectEndChapter:a,isDisabled:o=!1,chapterCount:i}){const l=s.useMemo(()=>Array.from({length:i},(p,h)=>h+1),[i]),w=p=>{r(p),p>n&&a(p)},c=p=>{a(p),p<t&&r(p)};return e.jsxs(e.Fragment,{children:[e.jsx(G,{htmlFor:"start-chapters-combobox",children:"Chapters"}),e.jsx(Xt,{isDisabled:o,onChange:w,buttonClassName:"tw-me-2 tw-ms-2 tw-w-20",options:l,getOptionLabel:p=>p.toString(),value:t},"start chapter"),e.jsx(G,{htmlFor:"end-chapters-combobox",children:"to"}),e.jsx(Xt,{isDisabled:o,onChange:c,buttonClassName:"tw-ms-2 tw-w-20",options:l,getOptionLabel:p=>p.toString(),value:n},"end chapter")]})}var dn=(t=>(t.CURRENT_BOOK="current book",t.CHOOSE_BOOKS="choose books",t))(dn||{});const ia=Object.freeze(["%webView_bookSelector_currentBook%","%webView_bookSelector_choose%","%webView_bookSelector_chooseBooks%"]),oe=(t,n)=>t[n]??n;function wa({handleBookSelectionModeChange:t,currentBookName:n,onSelectBooks:r,selectedBookIds:a,chapterCount:o,endChapter:i,handleSelectEndChapter:l,startChapter:w,handleSelectStartChapter:c,localizedStrings:p}){const h=oe(p,"%webView_bookSelector_currentBook%"),f=oe(p,"%webView_bookSelector_choose%"),m=oe(p,"%webView_bookSelector_chooseBooks%"),[u,g]=s.useState("current book"),j=S=>{g(S),t(S)};return e.jsx(je,{className:"pr-twp tw-flex",value:u,onValueChange:S=>j(S),children:e.jsxs("div",{className:"tw-flex tw-w-full tw-flex-col tw-gap-4",children:[e.jsxs("div",{className:"tw-grid tw-grid-cols-[25%,25%,50%]",children:[e.jsxs("div",{className:"tw-flex tw-items-center",children:[e.jsx(Lt,{value:"current book"}),e.jsx(G,{className:"tw-ms-1",children:h})]}),e.jsx(G,{className:"tw-flex tw-items-center",children:n}),e.jsx("div",{className:"tw-flex tw-items-center tw-justify-end",children:e.jsx(ln,{isDisabled:u==="choose books",handleSelectStartChapter:c,handleSelectEndChapter:l,chapterCount:o,startChapter:w,endChapter:i})})]}),e.jsxs("div",{className:"tw-grid tw-grid-cols-[25%,50%,25%]",children:[e.jsxs("div",{className:"tw-flex tw-items-center",children:[e.jsx(Lt,{value:"choose books"}),e.jsx(G,{className:"tw-ms-1",children:m})]}),e.jsx(G,{className:"tw-flex tw-items-center",children:a.map(S=>P.bookIdToEnglishName(S)).join(", ")}),e.jsx(D,{disabled:u==="current book",onClick:()=>r(),children:f})]})]})})}function la({table:t}){return e.jsxs(Pt,{children:[e.jsx(me.DropdownMenuTrigger,{asChild:!0,children:e.jsxs(D,{variant:"outline",size:"sm",className:"tw-ml-auto tw-hidden tw-h-8 lg:tw-flex",children:[e.jsx(N.FilterIcon,{className:"tw-mr-2 tw-h-4 tw-w-4"}),"View"]})}),e.jsxs(kt,{align:"end",className:"tw-w-[150px]",children:[e.jsx(Ft,{children:"Toggle columns"}),e.jsx(jt,{}),t.getAllColumns().filter(n=>n.getCanHide()).map(n=>e.jsx(Kt,{className:"tw-capitalize",checked:n.getIsVisible(),onCheckedChange:r=>n.toggleVisibility(!!r),children:n.id},n.id))]})]})}const ht=F.Root,cn=F.Group,gt=F.Value,st=s.forwardRef(({className:t,children:n,...r},a)=>{const o=O();return e.jsxs(F.Trigger,{ref:a,className:d("tw-flex tw-h-10 tw-w-full tw-items-center tw-justify-between tw-rounded-md tw-border tw-border-input tw-bg-background tw-px-3 tw-py-2 tw-text-sm tw-ring-offset-background placeholder:tw-text-muted-foreground focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-ring focus:tw-ring-offset-2 disabled:tw-cursor-not-allowed disabled:tw-opacity-50 [&>span]:tw-line-clamp-1",t),...r,dir:o,children:[n,e.jsx(F.Icon,{asChild:!0,children:e.jsx(N.ChevronDown,{className:"tw-h-4 tw-w-4 tw-opacity-50"})})]})});st.displayName=F.Trigger.displayName;const Me=s.forwardRef(({className:t,...n},r)=>e.jsx(F.ScrollUpButton,{ref:r,className:d("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1",t),...n,children:e.jsx(N.ChevronUp,{className:"tw-h-4 tw-w-4"})}));Me.displayName=F.ScrollUpButton.displayName;const De=s.forwardRef(({className:t,...n},r)=>e.jsx(F.ScrollDownButton,{ref:r,className:d("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1",t),...n,children:e.jsx(N.ChevronDown,{className:"tw-h-4 tw-w-4"})}));De.displayName=F.ScrollDownButton.displayName;const it=s.forwardRef(({className:t,children:n,position:r="popper",...a},o)=>{const i=O();return e.jsx(F.Portal,{children:e.jsxs(F.Content,{ref:o,className:d("pr-twp tw-relative tw-z-50 tw-max-h-96 tw-min-w-[8rem] tw-overflow-hidden tw-rounded-md tw-border tw-bg-popover tw-text-popover-foreground tw-shadow-md data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0 data-[state=closed]:tw-zoom-out-95 data-[state=open]:tw-zoom-in-95 data-[side=bottom]:tw-slide-in-from-top-2 data-[side=left]:tw-slide-in-from-right-2 data-[side=right]:tw-slide-in-from-left-2 data-[side=top]:tw-slide-in-from-bottom-2",r==="popper"&&"data-[side=bottom]:tw-translate-y-1 data-[side=left]:tw--translate-x-1 data-[side=right]:tw-translate-x-1 data-[side=top]:tw--translate-y-1",t),position:r,...a,children:[e.jsx(Me,{}),e.jsx(F.Viewport,{className:d("tw-p-1",r==="popper"&&"tw-h-[var(--radix-select-trigger-height)] tw-w-full tw-min-w-[var(--radix-select-trigger-width)]"),children:e.jsx("div",{dir:i,children:n})}),e.jsx(De,{})]})})});it.displayName=F.Content.displayName;const pn=s.forwardRef(({className:t,...n},r)=>e.jsx(F.Label,{ref:r,className:d("tw-py-1.5 tw-pl-8 tw-pr-2 tw-text-sm tw-font-semibold",t),...n}));pn.displayName=F.Label.displayName;const W=s.forwardRef(({className:t,children:n,...r},a)=>e.jsxs(F.Item,{ref:a,className:d("tw-relative tw-flex tw-w-full tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-py-1.5 tw-pe-2 tw-ps-8 tw-text-sm tw-outline-none focus:tw-bg-accent focus:tw-text-accent-foreground data-[disabled]:tw-pointer-events-none data-[disabled]:tw-opacity-50",t),...r,children:[e.jsx("span",{className:"tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center",children:e.jsx(F.ItemIndicator,{children:e.jsx(N.Check,{className:"tw-h-4 tw-w-4"})})}),e.jsx(F.ItemText,{children:n})]}));W.displayName=F.Item.displayName;const un=s.forwardRef(({className:t,...n},r)=>e.jsx(F.Separator,{ref:r,className:d("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted",t),...n}));un.displayName=F.Separator.displayName;function da({table:t}){return e.jsx("div",{className:"tw-flex tw-items-center tw-justify-between tw-px-2 tw-pb-3 tw-pt-3",children:e.jsxs("div",{className:"tw-flex tw-items-center tw-space-x-6 lg:tw-space-x-8",children:[e.jsxs("div",{className:"tw-flex-1 tw-text-sm tw-text-muted-foreground",children:[t.getFilteredSelectedRowModel().rows.length," of"," ",t.getFilteredRowModel().rows.length," row(s) selected"]}),e.jsxs("div",{className:"tw-flex tw-items-center tw-space-x-2",children:[e.jsx("p",{className:"tw-text-nowrap tw-text-sm tw-font-medium",children:"Rows per page"}),e.jsxs(ht,{value:`${t.getState().pagination.pageSize}`,onValueChange:n=>{t.setPageSize(Number(n))},children:[e.jsx(st,{className:"tw-h-8 tw-w-[70px]",children:e.jsx(gt,{placeholder:t.getState().pagination.pageSize})}),e.jsx(it,{side:"top",children:[10,20,30,40,50].map(n=>e.jsx(W,{value:`${n}`,children:n},n))})]})]}),e.jsxs("div",{className:"tw-flex tw-w-[100px] tw-items-center tw-justify-center tw-text-sm tw-font-medium",children:["Page ",t.getState().pagination.pageIndex+1," of ",t.getPageCount()]}),e.jsxs("div",{className:"tw-flex tw-items-center tw-space-x-2",children:[e.jsxs(D,{variant:"outline",size:"icon",className:"tw-hidden tw-h-8 tw-w-8 tw-p-0 lg:tw-flex",onClick:()=>t.setPageIndex(0),disabled:!t.getCanPreviousPage(),children:[e.jsx("span",{className:"tw-sr-only",children:"Go to first page"}),e.jsx(N.ArrowLeftIcon,{className:"tw-h-4 tw-w-4"})]}),e.jsxs(D,{variant:"outline",size:"icon",className:"tw-h-8 tw-w-8 tw-p-0",onClick:()=>t.previousPage(),disabled:!t.getCanPreviousPage(),children:[e.jsx("span",{className:"tw-sr-only",children:"Go to previous page"}),e.jsx(N.ChevronLeftIcon,{className:"tw-h-4 tw-w-4"})]}),e.jsxs(D,{variant:"outline",size:"icon",className:"tw-h-8 tw-w-8 tw-p-0",onClick:()=>t.nextPage(),disabled:!t.getCanNextPage(),children:[e.jsx("span",{className:"tw-sr-only",children:"Go to next page"}),e.jsx(N.ChevronRightIcon,{className:"tw-h-4 tw-w-4"})]}),e.jsxs(D,{variant:"outline",size:"icon",className:"tw-hidden tw-h-8 tw-w-8 tw-p-0 lg:tw-flex",onClick:()=>t.setPageIndex(t.getPageCount()-1),disabled:!t.getCanNextPage(),children:[e.jsx("span",{className:"tw-sr-only",children:"Go to last page"}),e.jsx(N.ArrowRightIcon,{className:"tw-h-4 tw-w-4"})]})]})]})})}const ca=`
