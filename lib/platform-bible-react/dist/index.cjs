 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hn;function Rt(){return Hn||(Hn=1,process.env.NODE_ENV!=="production"&&function(){var e=typeof Symbol=="function"&&Symbol.for,n=e?Symbol.for("react.element"):60103,r=e?Symbol.for("react.portal"):60106,t=e?Symbol.for("react.fragment"):60107,o=e?Symbol.for("react.strict_mode"):60108,a=e?Symbol.for("react.profiler"):60114,i=e?Symbol.for("react.provider"):60109,l=e?Symbol.for("react.context"):60110,c=e?Symbol.for("react.async_mode"):60111,s=e?Symbol.for("react.concurrent_mode"):60111,u=e?Symbol.for("react.forward_ref"):60112,h=e?Symbol.for("react.suspense"):60113,d=e?Symbol.for("react.suspense_list"):60120,v=e?Symbol.for("react.memo"):60115,m=e?Symbol.for("react.lazy"):60116,p=e?Symbol.for("react.block"):60121,f=e?Symbol.for("react.fundamental"):60117,S=e?Symbol.for("react.responder"):60118,Z=e?Symbol.for("react.scope"):60119;function B(x){return typeof x=="string"||typeof x=="function"||x===t||x===s||x===a||x===o||x===h||x===d||typeof x=="object"&&x!==null&&(x.$$typeof===m||x.$$typeof===v||x.$$typeof===i||x.$$typeof===l||x.$$typeof===u||x.$$typeof===f||x.$$typeof===S||x.$$typeof===Z||x.$$typeof===p)}function C(x){if(typeof x=="object"&&x!==null){var le=x.$$typeof;switch(le){case n:var k=x.type;switch(k){case c:case s:case t:case a:case o:case h:return k;default:var je=k&&k.$$typeof;switch(je){case l:case u:case m:case v:case i:return je;default:return le}}case r:return le}}}var b=c,re=s,ae=l,be=i,pe=n,T=u,W=t,ne=m,ie=v,U=r,he=a,te=o,ve=h,_e=!1;function Pe(x){return _e||(_e=!0,console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")),y(x)||C(x)===c}function y(x){return C(x)===s}function w(x){return C(x)===l}function R(x){return C(x)===i}function N(x){return typeof x=="object"&&x!==null&&x.$$typeof===n}function E(x){return C(x)===u}function P(x){return C(x)===t}function _(x){return C(x)===m}function O(x){return C(x)===v}function j(x){return C(x)===r}function z(x){return C(x)===a}function I(x){return C(x)===o}function oe(x){return C(x)===h}V.AsyncMode=b,V.ConcurrentMode=re,V.ContextConsumer=ae,V.ContextProvider=be,V.Element=pe,V.ForwardRef=T,V.Fragment=W,V.Lazy=ne,V.Memo=ie,V.Portal=U,V.Profiler=he,V.StrictMode=te,V.Suspense=ve,V.isAsyncMode=Pe,V.isConcurrentMode=y,V.isContextConsumer=w,V.isContextProvider=R,V.isElement=N,V.isForwardRef=E,V.isFragment=P,V.isLazy=_,V.isMemo=O,V.isPortal=j,V.isProfiler=z,V.isStrictMode=I,V.isSuspense=oe,V.isValidElementType=B,V.typeOf=C}()),V}var Wn;function jr(){return Wn||(Wn=1,process.env.NODE_ENV==="production"?Ze.exports=Ot():Ze.exports=Rt()),Ze.exports}/*
object-assign
(c) Sindre Sorhus
@license MIT
*/var gn,Xn;function $t(){if(Xn)return gn;Xn=1;var e=Object.getOwnPropertySymbols,n=Object.prototype.hasOwnProperty,r=Object.prototype.propertyIsEnumerable;function t(a){if(a==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(a)}function o(){try{if(!Object.assign)return!1;var a=new String("abc");if(a[5]="de",Object.getOwnPropertyNames(a)[0]==="5")return!1;for(var i={},l=0;l<10;l++)i["_"+String.fromCharCode(l)]=l;var c=Object.getOwnPropertyNames(i).map(function(u){return i[u]});if(c.join("")!=="0123456789")return!1;var s={};return"abcdefghijklmnopqrst".split("").forEach(function(u){s[u]=u}),Object.keys(Object.assign({},s)).join("")==="abcdefghijklmnopqrst"}catch{return!1}}return gn=o()?Object.assign:function(a,i){for(var l,c=t(a),s,u=1;u<arguments.length;u++){l=Object(arguments[u]);for(var h in l)n.call(l,h)&&(c[h]=l[h]);if(e){s=e(l);for(var d=0;d<s.length;d++)r.call(l,s[d])&&(c[s[d]]=l[s[d]])}}return c},gn}var bn,Yn;function $n(){if(Yn)return bn;Yn=1;var e="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return bn=e,bn}var yn,Kn;function Ir(){return Kn||(Kn=1,yn=Function.call.bind(Object.prototype.hasOwnProperty)),yn}var vn,Jn;function At(){if(Jn)return vn;Jn=1;var e=function(){};if(process.env.NODE_ENV!=="production"){var n=$n(),r={},t=Ir();e=function(a){var i="Warning: "+a;typeof console<"u"&&console.error(i);try{throw new Error(i)}catch{}}}function o(a,i,l,c,s){if(process.env.NODE_ENV!=="production"){for(var u in a)if(t(a,u)){var h;try{if(typeof a[u]!="function"){var d=Error((c||"React class")+": "+l+" type `"+u+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof a[u]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw d.name="Invariant Violation",d}h=a[u](i,u,c,l,null,n)}catch(m){h=m}if(h&&!(h instanceof Error)&&e((c||"React class")+": type specification of "+l+" `"+u+"` is invalid; the type checker function must return `null` or an `Error` but returned a "+typeof h+". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."),h instanceof Error&&!(h.message in r)){r[h.message]=!0;var v=s?s():"";e("Failed "+l+" type: "+h.message+(v??""))}}}}return o.resetWarningCache=function(){process.env.NODE_ENV!=="production"&&(r={})},vn=o,vn}var xn,Zn;function Pt(){if(Zn)return xn;Zn=1;var e=jr(),n=$t(),r=$n(),t=Ir(),o=At(),a=function(){};process.env.NODE_ENV!=="production"&&(a=function(l){var c="Warning: "+l;typeof console<"u"&&console.error(c);try{throw new Error(c)}catch{}});function i(){return null}return xn=function(l,c){var s=typeof Symbol=="function"&&Symbol.iterator,u="@@iterator";function h(y){var w=y&&(s&&y[s]||y[u]);if(typeof w=="function")return w}var d="<<anonymous>>",v={array:S("array"),bigint:S("bigint"),bool:S("boolean"),func:S("function"),number:S("number"),object:S("object"),string:S("string"),symbol:S("symbol"),any:Z(),arrayOf:B,element:C(),elementType:b(),instanceOf:re,node:T(),objectOf:be,oneOf:ae,oneOfType:pe,shape:ne,exact:ie};function m(y,w){return y===w?y!==0||1/y===1/w:y!==y&&w!==w}function p(y,w){this.message=y,this.data=w&&typeof w=="object"?w:{},this.stack=""}p.prototype=Error.prototype;function f(y){if(process.env.NODE_ENV!=="production")var w={},R=0;function N(P,_,O,j,z,I,oe){if(j=j||d,I=I||O,oe!==r){if(c){var x=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use `PropTypes.checkPropTypes()` to call them. Read more at http://fb.me/use-check-prop-types");throw x.name="Invariant Violation",x}else if(process.env.NODE_ENV!=="production"&&typeof console<"u"){var le=j+":"+O;!w[le]&&R<3&&(a("You are manually calling a React.PropTypes validation function for the `"+I+"` prop on `"+j+"`. This is deprecated and will throw in the standalone `prop-types` package. You may be seeing this warning due to a third-party PropTypes library. See https://fb.me/react-warning-dont-call-proptypes for details."),w[le]=!0,R++)}}return _[O]==null?P?_[O]===null?new p("The "+z+" `"+I+"` is marked as required "+("in `"+j+"`, but its value is `null`.")):new p("The "+z+" `"+I+"` is marked as required in "+("`"+j+"`, but its value is `undefined`.")):null:y(_,O,j,z,I)}var E=N.bind(null,!1);return E.isRequired=N.bind(null,!0),E}function S(y){function w(R,N,E,P,_,O){var j=R[N],z=te(j);if(z!==y){var I=ve(j);return new p("Invalid "+P+" `"+_+"` of type "+("`"+I+"` supplied to `"+E+"`, expected ")+("`"+y+"`."),{expectedType:y})}return null}return f(w)}function Z(){return f(i)}function B(y){function w(R,N,E,P,_){if(typeof y!="function")return new p("Property `"+_+"` of component `"+E+"` has invalid PropType notation inside arrayOf.");var O=R[N];if(!Array.isArray(O)){var j=te(O);return new p("Invalid "+P+" `"+_+"` of type "+("`"+j+"` supplied to `"+E+"`, expected an array."))}for(var z=0;z<O.length;z++){var I=y(O,z,E,P,_+"["+z+"]",r);if(I instanceof Error)return I}return null}return f(w)}function C(){function y(w,R,N,E,P){var _=w[R];if(!l(_)){var O=te(_);return new p("Invalid "+E+" `"+P+"` of type "+("`"+O+"` supplied to `"+N+"`, expected a single ReactElement."))}return null}return f(y)}function b(){function y(w,R,N,E,P){var _=w[R];if(!e.isValidElementType(_)){var O=te(_);return new p("Invalid "+E+" `"+P+"` of type "+("`"+O+"` supplied to `"+N+"`, expected a single ReactElement type."))}return null}return f(y)}function re(y){function w(R,N,E,P,_){if(!(R[N]instanceof y)){var O=y.name||d,j=Pe(R[N]);return new p("Invalid "+P+" `"+_+"` of type "+("`"+j+"` supplied to `"+E+"`, expected ")+("instance of `"+O+"`."))}return null}return f(w)}function ae(y){if(!Array.isArray(y))return process.env.NODE_ENV!=="production"&&(arguments.length>1?a("Invalid arguments supplied to oneOf, expected an array, got "+arguments.length+" arguments. A common mistake is to write oneOf(x, y, z) instead of oneOf([x, y, z])."):a("Invalid argument supplied to oneOf, expected an array.")),i;function w(R,N,E,P,_){for(var O=R[N],j=0;j<y.length;j++)if(m(O,y[j]))return null;var z=JSON.stringify(y,function(oe,x){var le=ve(x);return le==="symbol"?String(x):x});return new p("Invalid "+P+" `"+_+"` of value `"+String(O)+"` "+("supplied to `"+E+"`, expected one of "+z+"."))}return f(w)}function be(y){function w(R,N,E,P,_){if(typeof y!="function")return new p("Property `"+_+"` of component `"+E+"` has invalid PropType notation inside objectOf.");var O=R[N],j=te(O);if(j!=="object")return new p("Invalid "+P+" `"+_+"` of type "+("`"+j+"` supplied to `"+E+"`, expected an object."));for(var z in O)if(t(O,z)){var I=y(O,z,E,P,_+"."+z,r);if(I instanceof Error)return I}return null}return f(w)}function pe(y){if(!Array.isArray(y))return process.env.NODE_ENV!=="production"&&a("Invalid argument supplied to oneOfType, expected an instance of array."),i;for(var w=0;w<y.length;w++){var R=y[w];if(typeof R!="function")return a("Invalid argument supplied to oneOfType. Expected an array of check functions, but received "+_e(R)+" at index "+w+"."),i}function N(E,P,_,O,j){for(var z=[],I=0;I<y.length;I++){var oe=y[I],x=oe(E,P,_,O,j,r);if(x==null)return null;x.data&&t(x.data,"expectedType")&&z.push(x.data.expectedType)}var le=z.length>0?", expected one of type ["+z.join(", ")+"]":"";return new p("Invalid "+O+" `"+j+"` supplied to "+("`"+_+"`"+le+"."))}return f(N)}function T(){function y(w,R,N,E,P){return U(w[R])?null:new p("Invalid "+E+" `"+P+"` supplied to "+("`"+N+"`, expected a ReactNode."))}return f(y)}function W(y,w,R,N,E){return new p((y||"React class")+": "+w+" type `"+R+"."+N+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+E+"`.")}function ne(y){function w(R,N,E,P,_){var O=R[N],j=te(O);if(j!=="object")return new p("Invalid "+P+" `"+_+"` of type `"+j+"` "+("supplied to `"+E+"`, expected `object`."));for(var z in y){var I=y[z];if(typeof I!="function")return W(E,P,_,z,ve(I));var oe=I(O,z,E,P,_+"."+z,r);if(oe)return oe}return null}return f(w)}function ie(y){function w(R,N,E,P,_){var O=R[N],j=te(O);if(j!=="object")return new p("Invalid "+P+" `"+_+"` of type `"+j+"` "+("supplied to `"+E+"`, expected `object`."));var z=n({},R[N],y);for(var I in z){var oe=y[I];if(t(y,I)&&typeof oe!="function")return W(E,P,_,I,ve(oe));if(!oe)return new p("Invalid "+P+" `"+_+"` key `"+I+"` supplied to `"+E+"`.\nBad object: "+JSON.stringify(R[N],null,"  ")+`
Valid keys: `+JSON.stringify(Object.keys(y),null,"  "));var x=oe(O,I,E,P,_+"."+I,r);if(x)return x}return null}return f(w)}function U(y){switch(typeof y){case"number":case"string":case"undefined":return!0;case"boolean":return!y;case"object":if(Array.isArray(y))return y.every(U);if(y===null||l(y))return!0;var w=h(y);if(w){var R=w.call(y),N;if(w!==y.entries){for(;!(N=R.next()).done;)if(!U(N.value))return!1}else for(;!(N=R.next()).done;){var E=N.value;if(E&&!U(E[1]))return!1}}else return!1;return!0;default:return!1}}function he(y,w){return y==="symbol"?!0:w?w["@@toStringTag"]==="Symbol"||typeof Symbol=="function"&&w instanceof Symbol:!1}function te(y){var w=typeof y;return Array.isArray(y)?"array":y instanceof RegExp?"object":he(w,y)?"symbol":w}function ve(y){if(typeof y>"u"||y===null)return""+y;var w=te(y);if(w==="object"){if(y instanceof Date)return"date";if(y instanceof RegExp)return"regexp"}return w}function _e(y){var w=ve(y);switch(w){case"array":case"object":return"an "+w;case"boolean":case"date":case"regexp":return"a "+w;default:return w}}function Pe(y){return!y.constructor||!y.constructor.name?d:y.constructor.name}return v.checkPropTypes=o,v.resetWarningCache=o.resetWarningCache,v.PropTypes=v,v},xn}var wn,Qn;function jt(){if(Qn)return wn;Qn=1;var e=$n();function n(){}function r(){}return r.resetWarningCache=n,wn=function(){function t(i,l,c,s,u,h){if(h!==e){var d=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw d.name="Invariant Violation",d}}t.isRequired=t;function o(){return t}var a={array:t,bigint:t,bool:t,func:t,number:t,object:t,string:t,symbol:t,any:t,arrayOf:o,element:t,elementType:t,instanceOf:o,node:t,objectOf:o,oneOf:o,oneOfType:o,shape:o,exact:o,checkPropTypes:r,resetWarningCache:n};return a.PropTypes=a,a},wn}if(process.env.NODE_ENV!=="production"){var It=jr(),Mt=!0;Cn.exports=Pt()(It.isElement,Mt)}else Cn.exports=jt()();var Bt=Cn.exports;const q=Nt(Bt);function Fe(e){let n="https://mui.com/production-error/?code="+e;for(let r=1;r<arguments.length;r+=1)n+="&args[]="+encodeURIComponent(arguments[r]);return"Minified MUI error #"+e+"; visit "+n+" for the full message."}var Tn={exports:{}},F={};/**
 * @license React
 * react-is.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
...
} });`:Fe(12,f?` (${f})`:"",JSON.stringify(p.main)));return pr(p,"light",Z,t),pr(p,"dark",B,t),p.contrastText||(p.contrastText=h(p.main)),p},v={dark:kn,light:fr};return process.env.NODE_ENV!=="production"&&(v[n]||console.error(`MUI: The palette mode \`${n}\` is not supported.`)),ge(M({common:M({},Xe),mode:n,primary:d({color:a,name:"primary"}),secondary:d({color:i,name:"secondary",mainShade:"A400",lightShade:"A200",darkShade:"A700"}),error:d({color:l,name:"error"}),warning:d({color:u,name:"warning"}),info:d({color:c,name:"info"}),success:d({color:s,name:"success"}),grey:ba,contrastThreshold:r,getContrastText:h,augmentColor:d,tonalOffset:t},v[n]),o)}const Aa=["fontFamily","fontSize","fontWeightLight","fontWeightRegular","fontWeightMedium","fontWeightBold","htmlFontSize","allVariants","pxToRem"];function Pa(e){return Math.round(e*1e5)/1e5}const hr={textTransform:"uppercase"},mr='"Roboto", "Helvetica", "Arial", sans-serif';function ja(e,n){const r=typeof n=="function"?n(e):n,{fontFamily:t=mr,fontSize:o=14,fontWeightLight:a=300,fontWeightRegular:i=400,fontWeightMedium:l=500,fontWeightBold:c=700,htmlFontSize:s=16,allVariants:u,pxToRem:h}=r,d=Se(r,Aa);process.env.NODE_ENV!=="production"&&(typeof o!="number"&&console.error("MUI: `fontSize` is required to be a number."),typeof s!="number"&&console.error("MUI: `htmlFontSize` is required to be a number."));const v=o/14,m=h||(S=>`${S/s*v}rem`),p=(S,Z,B,C,b)=>M({fontFamily:t,fontWeight:S,fontSize:m(Z),lineHeight:B},t===mr?{letterSpacing:`${Pa(C/Z)}em`}:{},b,u),f={h1:p(a,96,1.167,-1.5),h2:p(a,60,1.2,-.5),h3:p(i,48,1.167,0),h4:p(i,34,1.235,.25),h5:p(i,24,1.334,0),h6:p(l,20,1.6,.15),subtitle1:p(i,16,1.75,.15),subtitle2:p(l,14,1.57,.1),body1:p(i,16,1.5,.15),body2:p(i,14,1.43,.15),button:p(l,14,1.75,.4,hr),caption:p(i,12,1.66,.4),overline:p(i,12,2.66,1,hr),inherit:{fontFamily:"inherit",fontWeight:"inherit",fontSize:"inherit",lineHeight:"inherit",letterSpacing:"inherit"}};return ge(M({htmlFontSize:s,pxToRem:m,fontFamily:t,fontSize:o,fontWeightLight:a,fontWeightRegular:i,fontWeightMedium:l,fontWeightBold:c},f),d,{clone:!1})}const Ia=.2,Ma=.14,Ba=.12;function H(...e){return[`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Ia})`,`${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Ma})`,`${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Ba})`].join(",")}const za=["none",H(0,2,1,-1,0,1,1,0,0,1,3,0),H(0,3,1,-2,0,2,2,0,0,1,5,0),H(0,3,3,-2,0,3,4,0,0,1,8,0),H(0,2,4,-1,0,4,5,0,0,1,10,0),H(0,3,5,-1,0,5,8,0,0,1,14,0),H(0,3,5,-1,0,6,10,0,0,1,18,0),H(0,4,5,-2,0,7,10,1,0,2,16,1),H(0,5,5,-3,0,8,10,1,0,3,14,2),H(0,5,6,-3,0,9,12,1,0,3,16,2),H(0,6,6,-3,0,10,14,1,0,4,18,3),H(0,6,7,-4,0,11,15,1,0,4,20,3),H(0,7,8,-4,0,12,17,2,0,5,22,4),H(0,7,8,-4,0,13,19,2,0,5,24,4),H(0,7,9,-4,0,14,21,2,0,5,26,4),H(0,8,9,-5,0,15,22,2,0,6,28,5),H(0,8,10,-5,0,16,24,2,0,6,30,5),H(0,8,11,-5,0,17,26,2,0,6,32,5),H(0,9,11,-5,0,18,28,2,0,7,34,6),H(0,9,12,-6,0,19,29,2,0,7,36,6),H(0,10,13,-6,0,20,31,3,0,8,38,7),H(0,10,13,-6,0,21,33,3,0,8,40,7),H(0,10,14,-6,0,22,35,3,0,8,42,7),H(0,11,14,-7,0,23,36,3,0,9,44,8),H(0,11,15,-7,0,24,38,3,0,9,46,8)],Da=za,Va=["duration","easing","delay"],Fa={easeInOut:"cubic-bezier(0.4, 0, 0.2, 1)",easeOut:"cubic-bezier(0.0, 0, 0.2, 1)",easeIn:"cubic-bezier(0.4, 0, 1, 1)",sharp:"cubic-bezier(0.4, 0, 0.6, 1)"},La={shortest:150,shorter:200,short:250,standard:300,complex:375,enteringScreen:225,leavingScreen:195};function gr(e){return`${Math.round(e)}ms`}function Ua(e){if(!e)return 0;const n=e/36;return Math.round((4+15*n**.25+n/5)*10)}function qa(e){const n=M({},Fa,e.easing),r=M({},La,e.duration);return M({getAutoHeightDuration:Ua,create:(o=["all"],a={})=>{const{duration:i=r.standard,easing:l=n.easeInOut,delay:c=0}=a,s=Se(a,Va);if(process.env.NODE_ENV!=="production"){const u=d=>typeof d=="string",h=d=>!isNaN(parseFloat(d));!u(o)&&!Array.isArray(o)&&console.error('MUI: Argument "props" must be a string or Array.'),!h(i)&&!u(i)&&console.error(`MUI: Argument "duration" must be a number or a string but found ${i}.`),u(l)||console.error('MUI: Argument "easing" must be a string.'),!h(c)&&!u(c)&&console.error('MUI: Argument "delay" must be a number or a string.'),typeof a!="object"&&console.error(["MUI: Secong argument of transition.create must be an object.","Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
`)),Object.keys(s).length!==0&&console.error(`MUI: Unrecognized argument(s) [${Object.keys(s).join(",")}].`)}return(Array.isArray(o)?o:[o]).map(u=>`${u} ${typeof i=="string"?i:gr(i)} ${l} ${typeof c=="string"?c:gr(c)}`).join(",")}},e,{easing:n,duration:r})}const Ga={mobileStepper:1e3,fab:1050,speedDial:1050,appBar:1100,drawer:1200,modal:1300,snackbar:1400,tooltip:1500},Ha=Ga,Wa=["breakpoints","mixins","spacing","palette","transitions","typography","shape"];function Xa(e={},...n){const{mixins:r={},palette:t={},transitions:o={},typography:a={}}=e,i=Se(e,Wa);if(e.vars)throw new Error(process.env.NODE_ENV!=="production"?"MUI: `vars` is a private field used for CSS variables support.\nPlease use another name.":Fe(18));const l=$a(t),c=Bn(e);let s=ge(c,{mixins:ha(c.breakpoints,r),palette:l,shadows:Da.slice(),typography:ja(l,a),transitions:qa(o),zIndex:M({},Ha),applyDarkStyles(u){return this.vars?{[this.getColorSchemeSelector("dark").replace(/(\[[^\]]+\])/,":where($1)")]:u}:this.palette.mode==="dark"?u:{}}});if(s=ge(s,i),s=n.reduce((u,h)=>ge(u,h),s),process.env.NODE_ENV!=="production"){const u=["active","checked","completed","disabled","error","expanded","focused","focusVisible","required","selected"],h=(d,v)=>{let m;for(m in d){const p=d[m];if(u.indexOf(m)!==-1&&Object.keys(p).length>0){if(process.env.NODE_ENV!=="production"){const f=An("",m);console.error([`MUI: The \`${v}\` component increases the CSS specificity of the \`${m}\` internal state.`,"You can not override it like this: ",JSON.stringify(d,null,2),"",`Instead, you need to use the '&.${f}' syntax:`,JSON.stringify({root:{[`&.${f}`]:p}},null,2),"","https://mui.com/r/state-classes-guide"].join(`
`))}d[m]={}}}};Object.keys(s.components).forEach(d=>{const v=s.components[d].styleOverrides;v&&d.indexOf("Mui")===0&&h(v,d)})}return s.unstable_sxConfig=M({},In,i==null?void 0:i.unstable_sxConfig),s.unstable_sx=function(h){return Mn({sx:h,theme:this})},s}const Ya=Xa(),Ur=Ya,qr="$$material";function Ka({props:e,name:n}){return la({props:e,name:n,defaultTheme:Ur,themeId:qr})}const Ja=e=>Qe(e)&&e!=="classes",Za=sa({themeId:qr,defaultTheme:Ur,rootShouldForwardProp:Ja}),Qa=Za;function ei(e){return An("MuiSvgIcon",e)}Xt("MuiSvgIcon",["root","colorPrimary","colorSecondary","colorAction","colorError","colorDisabled","fontSizeInherit","fontSizeSmall","fontSizeMedium","fontSizeLarge"]);const ni=["children","className","color","component","fontSize","htmlColor","inheritViewBox","titleAccess","viewBox"],ri=e=>{const{color:n,fontSize:r,classes:t}=e,o={root:["root",n!=="inherit"&&`color${ye(n)}`,`fontSize${ye(r)}`]};return Ut(o,ei,t)},ti=Qa("svg",{name:"MuiSvgIcon",slot:"Root",overridesResolver:(e,n)=>{const{ownerState:r}=e;return[n.root,r.color!=="inherit"&&n[`color${ye(r.color)}`],n[`fontSize${ye(r.fontSize)}`]]}})(({theme:e,ownerState:n})=>{var r,t,o,a,i,l,c,s,u,h,d,v,m;return{userSelect:"none",width:"1em",height:"1em",display:"inline-block",fill:n.hasSvgAsChild?void 0:"currentColor",flexShrink:0,transition:(r=e.transitions)==null||(t=r.create)==null?void 0:t.call(r,"fill",{duration:(o=e.transitions)==null||(o=o.duration)==null?void 0:o.shorter}),fontSize:{inherit:"inherit",small:((a=e.typography)==null||(i=a.pxToRem)==null?void 0:i.call(a,20))||"1.25rem",medium:((l=e.typography)==null||(c=l.pxToRem)==null?void 0:c.call(l,24))||"1.5rem",large:((s=e.typography)==null||(u=s.pxToRem)==null?void 0:u.call(s,35))||"2.1875rem"}[n.fontSize],color:(h=(d=(e.vars||e).palette)==null||(d=d[n.color])==null?void 0:d.main)!=null?h:{action:(v=(e.vars||e).palette)==null||(v=v.action)==null?void 0:v.active,disabled:(m=(e.vars||e).palette)==null||(m=m.action)==null?void 0:m.disabled,inherit:void 0}[n.color]}}),Dn=se.forwardRef(function(n,r){const t=Ka({props:n,name:"MuiSvgIcon"}),{children:o,className:a,color:i="inherit",component:l="svg",fontSize:c="medium",htmlColor:s,inheritViewBox:u=!1,titleAccess:h,viewBox:d="0 0 24 24"}=t,v=Se(t,ni),m=se.isValidElement(o)&&o.type==="svg",p=M({},t,{color:i,component:l,fontSize:c,instanceFontSize:n.fontSize,inheritViewBox:u,viewBox:d,hasSvgAsChild:m}),f={};u||(f.viewBox=d);const S=ri(p);return g.jsxs(ti,M({as:l,className:yr(S.root,a),focusable:"false",color:s,"aria-hidden":h?void 0:!0,role:h?"img":void 0,ref:r},f,v,m&&o.props,{ownerState:p,children:[m?o.props.children:o,h?g.jsx("title",{children:h}):null]}))});process.env.NODE_ENV!=="production"&&(Dn.propTypes={children:q.node,classes:q.object,className:q.string,color:q.oneOfType([q.oneOf(["inherit","action","disabled","primary","secondary","error","info","success","warning"]),q.string]),component:q.elementType,fontSize:q.oneOfType([q.oneOf(["inherit","large","medium","small"]),q.string]),htmlColor:q.string,inheritViewBox:q.bool,shapeRendering:q.string,sx:q.oneOfType([q.arrayOf(q.oneOfType([q.func,q.object,q.bool])),q.func,q.object]),titleAccess:q.string,viewBox:q.string});Dn.muiName="SvgIcon";const br=Dn;function oi(e,n){function r(t,o){return g.jsx(br,M({"data-testid":`${n}Icon`,ref:o},t,{children:e}))}return process.env.NODE_ENV!=="production"&&(r.displayName=`${n}Icon`),r.muiName=br.muiName,se.memo(se.forwardRef(r))}const ai=oi(g.jsx("path",{d:"M3 18h18v-2H3zm0-5h18v-2H3zm0-7v2h18V6z"}),"Menu");function ii({menu:e,dataHandler:n,commandHandler:r,className:t,id:o,children:a}){const[i,l]=G.useState(!1),[c,s]=G.useState(!1),u=G.useCallback(()=>{i&&l(!1),s(!1)},[i]),h=G.useCallback(S=>{S.stopPropagation(),l(Z=>{const B=!Z;return B&&S.shiftKey?s(!0):B||s(!1),B})},[]),d=G.useRef(void 0),[v,m]=G.useState(0);G.useEffect(()=>{i&&d.current&&m(d.current.clientHeight)},[i]);const p=G.useCallback(S=>(u(),r(S)),[r,u]);let f=e;return!f&&n&&(f=n(c)),g.jsx("div",{ref:d,style:{position:"relative"},children:g.jsx(ee.AppBar,{position:"static",id:o,children:g.jsxs(ee.Toolbar,{className:`papi-toolbar ${t??""}`,variant:"dense",children:[f?g.jsx(ee.IconButton,{edge:"start",className:`papi-menuButton ${t??""}`,color:"inherit","aria-label":"open drawer",onClick:h,children:g.jsx(ai,{})}):void 0,a?g.jsx("div",{className:"papi-menu-children",children:a}):void 0,f?g.jsx(ee.Drawer,{className:`papi-menu-drawer ${t??""}`,anchor:"left",variant:"persistent",open:i,onClose:u,PaperProps:{className:"papi-menu-drawer-paper",style:{top:v}},children:g.jsx(Ar,{commandHandler:p,columns:f.columns})}):void 0]})})})}const si=(e,n)=>{G.useEffect(()=>{if(!e)return()=>{};const r=e(n);return()=>{r()}},[e,n])};function ci(e){return{preserveValue:!0,...e}}const Gr=(e,n,r={})=>{const t=G.useRef(n);t.current=n;const o=G.useRef(r);o.current=ci(o.current);const[a,i]=G.useState(()=>t.current),[l,c]=G.useState(!0);return G.useEffect(()=>{let s=!0;return c(!!e),(async()=>{if(e){const u=await e();s&&(i(()=>u),c(!1))}})(),()=>{s=!1,o.current.preserveValue||i(()=>t.current)}},[e]),[a,l]},Sn=()=>!1,li=(e,n)=>{const[r]=Gr(G.useCallback(async()=>{if(!e)return Sn;const t=await Promise.resolve(e(n));return async()=>t()},[n,e]),Sn,{preserveValue:!1});G.useEffect(()=>()=>{r!==Sn&&r()},[r])};exports.BookChapterControl=bt;exports.Button=Oe;exports.ChapterRangeSelector=yt;exports.Checkbox=Rr;exports.ComboBox=nn;exports.GridMenu=Ar;exports.IconButton=xt;exports.LabelPosition=Re;exports.MenuItem=$r;exports.RefSelector=wt;exports.SearchBar=kt;exports.Slider=St;exports.Snackbar=Et;exports.Switch=Ct;exports.Table=_t;exports.TextField=We;exports.Toolbar=ii;exports.useEvent=si;exports.useEventAsync=li;exports.usePromise=Gr;function ui(e,n="top"){if(!e||typeof document>"u")return;const r=document.head||document.querySelector("head"),t=r.querySelector(":first-child"),o=document.createElement("style");o.appendChild(document.createTextNode(e)),n==="top"&&t?r.insertBefore(o,t):r.appendChild(o)}ui(`.papi-checkbox {
