...
`))}return g}const v=({color:d,name:g,mainShade:x=500,lightShade:C=300,darkShade:N=700})=>{if(d=_({},d),!d.main&&d[x]&&(d.main=d[x]),!d.hasOwnProperty("main"))throw new Error(process.env.NODE_ENV!=="production"?`MUI: The color${g?` (${g})`:""} provided to augmentColor(color) is invalid.
