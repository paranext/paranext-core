...
var ms = (t, e, n) => e in t ? us(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var yt = (t, e, n) => ms(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as lt } from "react/jsx-runtime";
import v, { forwardRef as sn, useRef as H, useMemo as F, useState as R, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as Y, Component as fs, createElement as jr, Suspense as hs, Fragment as ho } from "react";
import { Command as Tt } from "cmdk";
import { X as Ve, Search as go, Check as jt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Jn, ChevronRight as Me, ArrowLeft as gs, ArrowRight as bs, Circle as Tn, ChevronDown as je, BoldIcon as vs, ItalicIcon as xs, AtSign as bo, Pencil as ys, Trash2 as Ns, ArrowUp as vo, MoreHorizontal as ks, MailOpen as _s, Mail as Cs, ChevronUp as xo, FilterIcon as Es, ArrowLeftIcon as Ts, ChevronLeftIcon as Rs, ChevronRightIcon as Ss, ArrowRightIcon as Ds, Copy as yo, Filter as Ms, User as Is, Link as Os, CircleHelp as As, ChevronsUpDown as No, Star as Ps, Undo as $s, Redo as Ls, SquareX as ko, FunctionSquare as _o, SquareSigma as Co, Ban as Vs, AlertCircle as Zn, CircleCheckIcon as js, CircleXIcon as zs, CircleHelpIcon as Fs, ArrowUpIcon as Bs, ArrowDownIcon as Ks, PanelLeft as Gs, PanelRight as Us, ScrollText as qs, MenuIcon as Hs, Menu as Ys, EllipsisVertical as Xs, MoreVertical as Ws, LoaderCircle as Js, GripVertical as Zs } from "lucide-react";
import { clsx as Qs } from "clsx";
import { extendTailwindMerge as ti } from "tailwind-merge";
import * as Mt from "@radix-ui/react-dialog";
import { Canon as ut } from "@sillsdev/scripture";
import { includes as dn, Section as X, getChaptersForBook as ei, formatScrRef as ve, getSectionForBook as Je, formatRelativeDate as ni, formatReplacementString as be, sanitizeHtml as ri, NumberFormat as oi, formatBytes as ai, getCurrentLocale as si, usfmMarkers as hn, getFormatCallerFunction as ii, deepEqual as li, isString as Kr, compareScrRefs as Qn, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as To, $getRoot as we, $createParagraphNode as Rn, $getSelection as Vt, HISTORY_MERGE_TAG as br, ParagraphNode as Ro, TextNode as So, $isTokenOrSegmented as wi, $getCharacterOffsets as ci, $cloneWithPropertiesEphemeral as di, $findMatchingParent as Do, $isElementNode as ie, $isRangeSelection as Ne, CLEAR_EDITOR_COMMAND as Mo, COMMAND_PRIORITY_EDITOR as Io, mergeRegister as ce, shallowMergeConfig as pi, defineExtension as qt, safeCast as ln, createState as ui, FORMAT_TEXT_COMMAND as Oo, $isNodeSelection as Ao, COMMAND_PRIORITY_LOW as Po, RootNode as mi, LineBreakNode as fi, TabNode as hi, $isEditorState as gi, createCommand as bi, CLICK_COMMAND as vi, isDOMNode as xi, $getNodeFromDOMNode as yi, $createNodeSelection as Ni, $setSelection as ki, DecoratorNode as tr, $getState as _i, toggleTextFormatType as Gr, TEXT_TYPE_TO_FORMAT as Ci, $setState as Ei, addClassNamesToElement as $o, $create as Ti, $getNodeByKey as Ri, removeClassNamesFromElement as Si, KEY_TAB_COMMAND as Di, $isBlockElementNode as vn, $createRangeSelection as Mi, $normalizeSelection__EXPERIMENTAL as Ii, OUTDENT_CONTENT_COMMAND as Oi, INDENT_CONTENT_COMMAND as Ur, INSERT_TAB_COMMAND as Ai, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Pi, $isParagraphNode as $i, $isTextNode as xn, SELECTION_CHANGE_COMMAND as Lo, getRegisteredNode as Li, isHTMLElement as Vi, isDocumentFragment as qr, isDOMDocumentNode as ji, ArtificialNode__DO_NOT_USE as Vo, $createLineBreakNode as jo, $isRootOrShadowRoot as zi, isBlockDomNode as Hr, isInlineDomNode as Yr, $insertNodes as Fi } from "lexical";
import * as ke from "@radix-ui/react-tooltip";
import { TooltipTrigger as Bi } from "@radix-ui/react-tooltip";
import { HeadingNode as Ki, QuoteNode as Gi, registerRichText as Ui } from "@lexical/rich-text";
import { flushSync as qi, createPortal as Hi } from "react-dom";
import { $isTableSelection as Yi } from "@lexical/table";
...
import { useReactTable as Ko, getFilteredRowModel as Wi, getSortedRowModel as Go, getPaginationRowModel as Ji, getCoreRowModel as Uo, flexRender as Ze, getGroupedRowModel as Zi, getExpandedRowModel as Qi } from "@tanstack/react-table";
...
const al = ti({ prefix: "tw-" });
function h(...t) {
  return al(Qs(t));
}
const Be = 250, qo = 300, sl = 400, il = 450, ll = 500, wl = "layoutDirection";
function mt() {
  const t = localStorage.getItem(wl);
  return t === "rtl" ? t : "ltr";
}
const cl = Mt.Root, vp = Mt.Trigger, dl = Mt.Portal, xp = Mt.Close, Ho = v.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: o,
    className: h(
...
const Yo = v.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, s) => {
  const i = mt();
  return /* @__PURE__ */ p(dl, { children: [
    /* @__PURE__ */ r(Ho, { className: n }),
    /* @__PURE__ */ p(
      Mt.Content,
      {
        ref: s,
...
const Wo = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Title,
  {
    ref: n,
...
ul.displayName = Mt.Description.displayName;
...
ee.displayName = Tt.displayName;
const Ke = v.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
...
const ne = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Tt.List,
  {
    ref: n,
...
ne.displayName = Tt.List.displayName;
const wn = v.forwardRef((t, e) => /* @__PURE__ */ r(Tt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
wn.displayName = Tt.Empty.displayName;
...
const Ht = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Tt.Item,
  {
    ref: n,
    className: h(
...
const ta = sn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? ze : "button", { className: h(ea({ variant: e, size: n, className: t })), ref: s, ...a })
);
B.displayName = "Button";
const re = Ie.Root, ue = Ie.Trigger, fl = Ie.Anchor, Yt = v.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = mt();
...
function sr(t, e, n) {
  return `${t} ${xe[t]}${e ? ` ${Nr(t, e)} ${De(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function hl({
  recentSearches: t,
  onSearchItemSelect: e,
  renderItem: n = (m) => String(m),
  getItemKey: o = (m) => String(m),
  ...
  const [m, u] = R(!1), g = d !== void 0, x = g ? d : m, b = (y) => {
    g || u(y), f == null || f(y);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ p(re, { open: x, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(Ut, { heading: s, children: t.map((y) => /* @__PURE__ */ p(
      Ht,
      {
        onSelect: () => N(y),
...
function yp(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function Np({
  ...
  const c = mt(), [d, f] = R(!1), [m, u] = R(""), [g, x] = R(""), [b, N] = R("books"), [y, k] = R(void 0), [C, j] = R(!1), z = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), S = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
  ...
  }), [$]), P = F(() => Object.values(O).flat(), [O]), W = F(() => {
    if (!g.trim()) return O;
    const D = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (D) => {
      const _ = b === "chapters" ? y : I == null ? void 0 : I.book;
      _ && (V({
        book: _,
        chapterNum: D,
        verseNum: 1
      }), f(!1), N("books"), k(void 0), x(""));
    },
    [V, b, y, I]
  ), It = K(
    (D) => {
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: _, isDigit: L } = Xr(D.key);
      if (b === "chapters") {
        if (D.key === "Backspace") {
        ...
        if (_ || L) {
          if (D.preventDefault(), D.stopPropagation(), N("books"), k(void 0), L && y) {
            const U = xe[y];
            x(`${U} ${D.key}`);
          } else
            x(D.key);
      ...
      if ((b === "chapters" || b === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        const U = b === "chapters" ? y : I == null ? void 0 : I.book;
        if (!U) return;
        const q = (() => {
          if (!m) return 1;
          const ct = m.match(/(\d+)$/);
        ...
        switch (D.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            tt = q === 0 ? it : Math.max(1, q - bt);
            break;
          case "ArrowDown":
            tt = q === 0 ? 1 : Math.min(it, q + bt);
            break;
          default:
            return;
        }
        tt !== q && (D.preventDefault(), D.stopPropagation(), u(sr(U, a, tt)), setTimeout(() => {
          const ct = S.current[tt];
  ...
  return At(() => {
    const D = setTimeout(() => {
      if (d && b === "books" && M.current && E.current) {
        const _ = M.current, L = E.current, U = L.offsetTop, q = _.clientHeight, it = L.clientHeight, tt = U - q / 2 + it / 2;
        _.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), u(sr(t.book));
  ...
  }, [b, y, I, t.book, t.chapterNum]), /* @__PURE__ */ p(re, { open: d, onOpenChange: G, children: [
    /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ r(
      B,
      {
      ...
      ee,
      {
        ...
        children: [
          b === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            y && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: De(y, a) })
          ] }),
          !C && /* @__PURE__ */ p(ne, { ref: M, children: [
...
), ht = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Eo.Root, { ref: n, className: h("pr-twp", xl(), t), ...e }));
ht.displayName = Eo.Root.displayName;
const _r = v.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    nn.Root,
    {
...
const yn = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nn.Item,
  {
    ref: n,
    className: h(
...
function ir({
  ...
  const [k, C] = R(!1), j = c ?? w, z = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], A = (M, E) => {
    const S = w(M), V = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, $ = `${E ?? ""}${S}${V ?? ""}`;
    return /* @__PURE__ */ p(
      Ht,
      {
        value: S,
  ...
  return /* @__PURE__ */ p(re, { open: k, onOpenChange: C, ...y, children: [
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(ee, { children: [
          /* @__PURE__ */ r(Ke, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(wn, { children: u }),
          /* @__PURE__ */ r(ne, { children: z(e) ? e.map((M) => /* @__PURE__ */ r(Ut, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
function Cp({
  ...
  const d = jn(c, "%webView_bookSelector_currentBook%"), f = jn(c, "%webView_bookSelector_choose%"), m = jn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = R(
    "current book"
    /* CurrentBook */
  ), x = (b) => {
    g(b), t(b);
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(ht, { className: "tw-ms-1", children: m })
          ] }),
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, _l = ra ? At : Y, un = { tag: br };
function Cl({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = kl(null, o), d = To({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (f) => i(f, d), theme: o });
    return function(f, m) {
      if (m !== null) {
        if (m === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Rn();
            u.append(g);
            const x = ra ? document.activeElement : null;
            (Vt() !== null || x !== null && x === f.getRootElement()) && g.select();
          }
        }, un);
        else if (m !== null) switch (typeof m) {
          case "string": {
            const u = f.parseEditorState(m);
            f.setEditorState(u, un);
            break;
          }
          case "object":
            f.setEditorState(m, un);
            break;
          case "function":
            f.update(() => {
              we().isEmpty() && m(f);
  ...
  }, []), r(na.Provider, { value: n, children: e });
}
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function Tl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return El(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: w }) => {
      e && s.size === 0 && i.size === 0 || t && w.has(br) || l.isEmpty() || n(a, o, w);
    });
  }, [o, t, e, n]), null;
}
const Cr = {
  ...
  mark: "",
  markOverlap: ""
}, kt = ke.Provider, Ct = ke.Root, Et = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  ke.Trigger,
  {
    ref: o,
    className: e ? h(ea({ variant: e }), t) : t,
    ...n
  }
));
Et.displayName = ke.Trigger.displayName;
const _t = v.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(ke.Portal, { children: /* @__PURE__ */ r(
  ke.Content,
  {
    ref: a,
    sideOffset: e,
...
_t.displayName = ke.Content.displayName;
const Er = [
  Ki,
  Ro,
  So,
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function Ol(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Al() {
  return function(t) {
    const [e] = Xt(), n = F(() => t(e), [e, t]), [o, a] = R(() => n.initialValueFn()), s = H(o);
    return Il(() => {
...
function Pl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !wi(e) && o !== null) {
    const [a, s] = o, i = t.isBackward(), l = a.getNode(), w = s.getNode(), c = e.is(l), d = e.is(w);
    if (c || d) {
      const [f, m] = ci(t), u = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let b, N = 0;
      u ? (N = f > m ? m : f, b = f > m ? f : m) : g ? (N = i ? m : f, b = void 0) : x && (N = 0, b = i ? f : m);
      const y = e.__text.slice(N, b);
      y !== e.__text && (n === "clone" && (e = di(e)), e.__text = y);
    }
  }
  return e;
}
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ll = oa && "documentMode" in document ? document.documentMode : null;
!(!oa || !("InputEvent" in window) || Ll) && "getTargetRanges" in new window.InputEvent("input");
function Vl(t) {
  const e = Do(t, (n) => ie(n) && !n.isInline());
  return ie(e) || $l(4, t.__key), e;
}
function jl(t) {
  const e = Vt();
  if (!Ne(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Do(s, (c) => ie(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
Nt.prototype.brand = zl, Nt.prototype.h = function() {
  return !0;
...
} }), he.prototype = new Nt(), he.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === gn)) return !0;
  if (this.g = gn, this.f |= 1, this.i > 0 && !aa(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    Qr(this), Z = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ia(this), Qr(this), le++;
  const t = Z;
...
function la() {
  const t = we(), e = Vt(), n = Rn();
  t.clear(), t.append(n), e !== null && n.select(), Ne(e) && (e.format = 0);
}
function wa(t, e = la) {
  return t.registerCommand(Mo, (n) => (t.update(e), !0), Io);
}
qt({ build: (t, e, n) => Mn(e), config: ln({ $onClear: la }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return de(() => wa(t, o.value));
} });
function Gl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Fn = ui("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ca extends tr {
  $config() {
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [ca], register: (t, e, n) => t.registerCommand(Oo, (o) => {
  const a = Vt();
  if (Ao(a) || Ne(a)) for (const s of a.getNodes()) Ul(s) && s.toggleFormat(o);
  return !1;
}, Po) });
function da(t, e) {
  let n;
...
const cr = qt({ build: (t) => da(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function pa(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const n = t, o = e;
    for (const a in o) n[a] = pa(n[a], o[a]);
    return t;
  }
  return e;
}
const Rr = 0, dr = 1, ua = 2, Bn = 3, mn = 4, Re = 5, Kn = 6, Ye = 7;
function Gn(t) {
  return t.id === Rr;
}
function ma(t) {
...
function ql(t) {
  return function(e) {
    return e.id === dr;
  }(t) || et(305, String(t.id), String(dr)), Object.assign(t, { id: ua });
}
...
class Yl {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, w, c) {
      return Object.assign(l, { config: w, id: Bn, registerState: c });
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== mn && et(307, String(n.id), String(Re)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  register(e, n) {
    this._signal = n;
    const o = this.state;
    o.id !== Re && et(308, String(o.id), String(Re));
...
const Wl = qt({ config: ln({ setOptions: to, updateOptions: to }), init: ({ $initialEditorState: t = Xl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (gi(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [mi, So, fi, hi, Ro] }), eo = Symbol.for("@lexical/extension/LexicalBuilder");
function no() {
}
function Jl(t) {
  throw t;
...
class tn {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Gn(s) || et(300, i, a || "[unknown]"), Gn(l = s) || et(304, String(l.id), String(Rr)), s = Object.assign(l, { id: dr }), o.state = s;
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: f } = d;
      if (f.onError !== void 0 && (e.onError = f.onError), f.disableEvents !== void 0 && (e.disableEvents = f.disableEvents), f.parentEditor !== void 0 && (e.parentEditor = f.parentEditor), f.editable !== void 0 && (e.editable = f.editable), f.namespace !== void 0 && (e.namespace = f.namespace), f.$initialEditorState !== void 0 && (e.$initialEditorState = f.$initialEditorState), f.nodes) for (const m of Gl(f)) {
        if (typeof m != "function") {
          const u = o.get(m.replace);
          u && et(302, f.name, m.replace.name, u.extension.name), o.set(m.replace, d);
        }
        n.add(m);
      }
      if (f.html) {
...
const Zl = /* @__PURE__ */ new Set(), ro = qt({ build(t, e, n) {
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = da(() => {
  }, () => de(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let w, c = !1;
    o.value.read(() => {
      if (Vt()) for (const [d, f] of l.entries()) {
        if (f.size === 0) {
          l.delete(d);
          continue;
        }
        const m = Ri(d), u = m && m.isSelected() || !1;
        c = c || u !== (!!i && i.has(d)), u && (w = w || /* @__PURE__ */ new Set(), w.add(d));
      }
    }), !c && w && i && w.size === i.size || (s.value = w);
  }));
  return { watchNodeKey: function(i) {
    const l = Bl(() => (s.value || Zl).has(i)), { watchedNodeKeys: w } = a.peek();
    let c = w.get(i);
    const d = c !== void 0;
...
bi("INSERT_HORIZONTAL_RULE_COMMAND");
class Oe extends tr {
  static getType() {
...
qt({ dependencies: [cr, ro], name: "@lexical/extension/HorizontalRule", nodes: () => [Oe], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(ro).output, a = rn({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return ce(t.registerCommand(vi, (i) => {
    if (xi(i.target)) {
      const l = yi(i.target);
      if (tw(l)) return function(w, c = !1) {
        const d = Vt(), f = w.isSelected(), m = w.getKey();
        let u;
        c && Ao(d) ? u = d : (u = Ni(), ki(u)), f ? u.delete(m) : u.add(m);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Po), t.registerMutationListener(Oe, (i, l) => {
    Fl(() => {
      let w = !1;
      const { nodeSelections: c } = a.peek();
      for (const [d, f] of i.entries()) if (f === "destroyed") c.delete(d), w = !0;
      else {
        const m = c.get(d), u = t.getElementByKey(d);
        m ? m.domNode.value = u : (w = !0, c.set(d, { domNode: rn(u), selectedSignal: o(d) }));
      }
      w && (a.value = { nodeSelections: c });
    });
  }), de(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: w } of a.value.nodeSelections.values()) i.push(de(() => {
      const c = l.value;
      c && (w.value ? $o(c, s) : Si(c, s));
    }));
    return ce(...i);
  }));
} });
...
function ew(t, e, n = ha) {
  return ce(t.registerCommand(Di, (o) => {
    const a = Vt();
    if (!Ne(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((m) => vn(m) && m.canIndent()).length > 0) return !0;
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), f = Vl(d);
      if (f.canIndent()) {
        const m = f.getKey();
        let u = Mi();
        if (u.anchor.set(m, 0, "element"), u.focus.set(m, 0, "element"), u = Ii(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Oi : Ur : Ai;
    return t.dispatchCommand(s, void 0);
  }, Io), t.registerCommand(Ur, () => {
...
qt({ build: (t, e, n) => Mn(e), config: ln({ $canIndent: ha, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return de(() => {
    if (!o.value) return ew(t, a, s);
  });
} });
const nw = qt({ name: "@lexical/react/ReactProvider" });
function rw() {
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (Ne(g)) {
                ...
                if (xn(b) && c >= 0 && d >= 0 && (N = c, y = c + d, g.setTextNodeRange(b, N, b, y)), N === y && f === "" || (g.insertRawText(f), b = x.getNode()), xn(b)) {
                  N = m, y = m + u;
                  const k = b.getTextContentSize();
                  N = N > k ? k : N, y = y > k ? k : y, g.setTextNodeRange(b, N, b, y);
                }
...
qt({ build: (t, e, n) => Mn(e), config: ln({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => de(() => n.getOutput().disabled.value ? void 0 : ba(t)) });
function sw(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
function iw({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, s] = R(() => n.getDecorators());
    return Sr(() => n.registerDecoratorListener((i) => {
      qi(() => {
        s(i);
      });
    }), [n]), Y(() => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (m) => n._onError(m), children: r(hs, { fallback: null, children: a[c] }) }), f = n.getElementByKey(c);
        f !== null && i.push(Hi(d, f, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function oo(t) {
  return t.getEditorState().read(ga(t.isComposing()));
}
function ww({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Xt();
  return function(a) {
    Sr(() => ce(Ui(a), ba(a)), [a]);
  }(o), p(lt, { children: [t, r(cw, { content: e }), r(lw, { editor: o, ErrorBoundary: n })] });
}
...
const pw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function uw({ onClear: t }) {
  const [e] = Xt();
  return pw(() => wa(e, t), [e, t]), null;
}
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function mw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: d, ariaOwns: f, ariaRequired: m, autoCapitalize: u, className: g, id: x, role: b = "textbox", spellCheck: N = !0, style: y, tabIndex: k, "data-testid": C, ...j }, z) {
  const [A, M] = R(t.isEditable()), E = K((V) => {
  ...
  return va(() => (M(t.isEditable()), t.registerEditableListener((V) => {
    M(V);
  })), [t]), r("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? n : "none", "aria-controls": A ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": A && b === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": d, "aria-owns": A ? f : void 0, "aria-readonly": !A || void 0, "aria-required": m, autoCapitalize: u, className: g, contentEditable: A, "data-testid": C, id: x, ref: S, role: b, spellCheck: N, style: y, tabIndex: k, ...j });
}
const fw = sn(mw);
function ao(t) {
  return t.getEditorState().read(ga(t.isComposing()));
...
function gw(t, e) {
  ...
  return p(lt, { children: [r(fw, { editor: a, ...o, ref: e }), n != null && r(bw, { editor: a, content: n })] });
}
...
function yw() {
  const [t, e] = R(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(cl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Yo, { children: [
      /* @__PURE__ */ r(Xo, { children: /* @__PURE__ */ r(Wo, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = K(
    (s, i, l = !1) => {
...
function Nw({
  ...
  const [e] = Xt(), [n, o] = R(e), [a, s] = R("paragraph"), [i, l] = yw(), w = () => {
  };
...
const Na = pe(
  ...
  {
    ref: a,
    className: h(Na({ variant: e, size: n, className: t })),
    ...o
  }
));
_w.displayName = zo.Root.displayName;
const ka = v.createContext({
  size: "default",
  variant: "default"
}), Dr = v.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = mt();
  return /* @__PURE__ */ r(
    Sn.Root,
    {
...
function Cw() {
  const { activeEditor: t } = ya(), [e, n] = R([]), o = K((a) => {
    if (Ne(a) || Yi(a)) {
      const s = [];
      so.forEach(({ format: i }) => {
...
function Sw(t, e) {
  const n = ji(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
...
function _a(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = ie(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && xn(e) && (i = Pl(o, e, "clone"));
  const l = ie(i) ? i.getChildren() : [], w = Li(t, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = _a(t, g, m, o);
    !a && ie(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Vi(d) || qr(d)) && d.append(m), n.append(d), f) {
      const u = f.call(i, d);
      u && (qr(d) ? d.replaceChildren(u) : d.replaceWith(u));
    }
  } else n.append(m);
  return a;
}
const Ca = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Ea(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (Ca.has(t.nodeName)) return i;
  let l = null;
  ...
  let m = [];
  const u = (l == null || !zi(l)) && (l != null && vn(l) || o);
  for (let g = 0; g < f.length; g++) m.push(...Ea(f[g], e, n, u, new Map(a), l));
  return d != null && (m = d(m)), Hr(t) && (m = Mw(t, m, u ? () => {
    const g = new Vo();
    return n.push(g), g;
  } : Rn)), l == null ? m.length > 0 ? i = i.concat(m) : Hr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Yr(g.nextSibling) && Yr(g.previousSibling);
  }(t) && (i = i.concat(jo())) : ie(l) && l.append(...m), i;
}
function Mw(t, e, n) {
...
function Ep({
  ...
  const [a, s] = R(Ow), [i, l] = R(void 0), [w, c] = R(!1), d = H(void 0), f = H(null);
  Y(() => {
    let N = !0;
    const y = f.current;
    if (!y) return;
  ...
  const m = K(() => {
    ...
    const N = kn(a);
    e(N, i);
  }, [a, e, i]), u = o["%commentEditor_placeholder%"] ?? "Type your comment here...", g = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", x = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", b = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
          /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(B, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Ve, {}) }) }),
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(re, { open: w, onOpenChange: c, children: [
      /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ p(
        B,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(
        Yt,
        {
          ...
          children: /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(ne, { children: t.map((N) => /* @__PURE__ */ r(
            Ht,
            {
              onSelect: () => {
                l(N === "" ? void 0 : N), c(!1);
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ r("span", { children: qn(N, o) })
            },
            N || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Ir(N) && (N.preventDefault(), N.stopPropagation(), Lt(a) && m());
        },
        onKeyDown: (N) => {
          Mr(N), (N.key === "Enter" || N.key === " ") && N.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          Nn,
          {
...
const Tp = Object.freeze([
...
], Aw = ["input", "select", "textarea", "button"], Pw = ["button", "textbox"], $w = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = H(null), [s, i] = R(void 0), [l, w] = R(void 0), c = K(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || Aw.includes(g)) return !0;
    ...
    (u) => {
      var A;
      const g = u.target, x = (M) => M ? document.getElementById(M) : void 0, b = x(l), N = x(s);
      if (!!(b && g && b.contains(g) && g !== b) && f(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (E === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(E + 1, M.length - 1) : S = Math.max(E - 1, 0), S !== E && (u.preventDefault(), u.stopPropagation(), (A = M[S]) == null || A.focus());
          return;
        }
        return;
      }
      const C = t.findIndex((M) => M.id === s);
      let j = C;
      switch (u.key) {
        case "ArrowDown":
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: h("pr-twp", Lw({ variant: e }), t), ...n })
);
Ae.displayName = "Badge";
const Sa = v.forwardRef(
...
const zw = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
zw.displayName = "CardDescription";
...
const Pe = v.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Bo.Root,
  {
    ref: a,
    decorative: n,
...
const Ma = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Fe.Root,
  {
    ref: n,
    className: h(
...
Ma.displayName = Fe.Root.displayName;
const Bw = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Fe.Image,
  {
    ref: n,
...
Bw.displayName = Fe.Image.displayName;
...
Ia.displayName = Fe.Fallback.displayName;
const Or = En(void 0);
function Ft() {
  const t = gr(Or);
  if (!t)
...
}), Ge = nt.Trigger, Oa = nt.Group, Kw = nt.Portal, Gw = nt.Sub, Uw = nt.RadioGroup;
...
const Aa = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    nt.SubTrigger,
    {
...
const Pa = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ r(
    nt.SubContent,
    {
...
const _n = v.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = mt(), s = Ft();
  return /* @__PURE__ */ r(
    nt.Item,
    {
...
const $a = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt(), s = Ft();
  return /* @__PURE__ */ p(
    nt.RadioItem,
    {
...
$a.displayName = nt.RadioItem.displayName;
const cn = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  nt.Label,
  {
    ref: o,
...
cn.displayName = nt.Label.displayName;
...
function io({
  ...
  }, [t.date, n]), b = F(() => t.user, [t.user]), N = F(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = F(() => ri(t.contents), [t.contents]), k = F(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          _n,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), f(Iw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ma, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Ia, { className: "tw-text-xs tw-font-medium", children: N }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ p(Ae, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              bn(t.assignedUser, n)
            ] })
          ] }),
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: m,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : Ir(C) && (C.preventDefault(), C.stopPropagation(), Lt(d) && g());
              },
              onKeyDown: (C) => {
        ...
        k && /* @__PURE__ */ p(Ee, { children: [
          /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ks, {}) }) }),
...
function Hw({
  ...
  const [A, M] = R(lo), [E, S] = R(
    void 0
  ), V = o, [$, O] = R(!1), [P, W] = R(!1), [I, J] = R(!1), [St, Pt] = R(!1), [It, gt] = R(!1), [pt, G] = R(C), [at, st] = R(!1), wt = H(void 0), [xt, Wt] = R(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Bt = F(() => e.filter((T) => !T.deleted), [e]);
  Y(() => {
    let T = !0;
    if (!o || !k) {
      Wt(/* @__PURE__ */ new Map());
  ...
  const Jt = F(() => Bt[0], [Bt]), Te = H(null), ae = H(void 0), Zt = K(() => {
    var T;
    (T = ae.current) == null || T.call(ae), M(lo);
  }, []), He = K(() => {
    const T = !pt;
  ...
  }, [s, n]), L = F(() => Bt.slice(1), [Bt]), U = F(() => L.length ?? 0, [L.length]), q = F(() => U > 0, [U]), it = F(() => $ || U <= 2 ? L : L.slice(-2), [L, U, $]), tt = F(() => $ || U <= 2 ? 0 : U - 2, [U, $]), bt = F(
    () => U === 1 ? D.singleReply : be(D.multipleReplies, { count: U }),
    [U, D]
  ), ct = F(
    () => tt === 1 ? D.singleReply : be(D.multipleReplies, { count: tt }),
    [tt, D]
  );
  Y(() => {
    !o && P && q && W(!1);
  ...
  const Dt = K(
    async (T) => {
      ...
      vt && await f({ threadId: w, contents: vt }) && Zt();
    },
    [
      Zt,
      A,
    ...
    async (T) => {
      const vt = Lt(A) ? kn(A) : void 0, ft = await f({
        ...T,
        contents: vt,
        assignedUser: E ?? T.assignedUser
      });
      return ft && vt && Zt(), ft && E !== void 0 && S(void 0), ft;
    },
    [Zt, A, f, E]
  );
  return /* @__PURE__ */ r(
    Sa,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ p(Da, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              B,
              {
                ...
                children: pt ? /* @__PURE__ */ r(_s, {}) : /* @__PURE__ */ r(Cs, {})
              }
            ),
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ p(re, { open: I, onOpenChange: J, children: [
                      /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ r(
                        B,
                        {
                          size: "icon",
...
function Sp({
  ...
  const [N, y] = R(/* @__PURE__ */ new Set()), [k, C] = R();
  Y(() => {
    g && (y((O) => new Set(O).add(g)), C(g));
  }, [g]);
  const j = n.filter(
    ...
    (O) => {
      y((P) => new Set(P).add(O.id)), C(O.id), x == null || x(O.id);
    },
    [x]
  ), M = K(
    (O) => {
    ...
    [N, x]
  ), { listboxRef: E, activeId: S, handleKeyDown: V } = $w({
    options: z,
    onOptionSelect: A
  }), $ = K(
    (O) => {
      O.key === "Escape" ? (k && N.has(k) && (y((P) => {
        const W = new Set(P);
        return W.delete(k), W;
...
function Yw({ table: t }) {
  return /* @__PURE__ */ p(Ee, { children: [
    /* @__PURE__ */ r(Xi, { asChild: !0, children: /* @__PURE__ */ p(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const $e = dt.Root, Xw = dt.Group, Le = dt.Value, Ww = pe(
...
), _e = v.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      className: h(Ww({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
La.displayName = dt.ScrollUpButton.displayName;
...
Va.displayName = dt.ScrollDownButton.displayName;
const Ce = v.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = mt();
...
Jw.displayName = dt.Label.displayName;
const Ot = v.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  dt.Item,
  {
    ref: o,
    className: h(
...
Zw.displayName = dt.Separator.displayName;
function Qw({ table: t }) {
      ...
      /* @__PURE__ */ p(
        $e,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Ce, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(Ot, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const On = v.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: h(
...
const An = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", t), ...e }));
An.displayName = "TableBody";
const ec = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
...
const ye = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
const ac = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function sc({
  ...
  var z;
  const [d, f] = R([]), [m, u] = R([]), [g, x] = R({}), [b, N] = R({}), y = F(() => e ?? [], [e]), k = Ko({
    data: y,
    columns: t,
    getCoreRowModel: Uo(),
  ...
  let j;
  return w ? j = Array.from({ length: 10 }).map((E, S) => `skeleton-row-${S}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(ye, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((z = k.getRowModel().rows) == null ? void 0 : z.length) > 0 ? j = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    Qt,
    {
      onClick: () => i(A, k),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((M) => /* @__PURE__ */ r(ye, { children: Ze(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    A.id
  )) : j = /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(ye, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Yw, { table: k }),
    /* @__PURE__ */ p(In, { stickyHeader: s, children: [
      /* @__PURE__ */ r(On, { stickyHeader: s, children: k.getHeaderGroups().map((A) => /* @__PURE__ */ r(Qt, { children: A.headers.map((M) => /* @__PURE__ */ r(an, { className: "tw-p-0", children: M.isPlaceholder ? void 0 : Ze(M.column.columnDef.header, M.getContext()) }, M.id)) }, A.id)) }),
...
function Dp({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(tl, { options: s, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(yo, {}) })
        ] }),
...
var wc = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(wc || {});
function Op({ id: t, label: e, groups: n }) {
  const [o, a] = R(
    ...
    i((m) => (m[c] = d, { ...m }));
    const f = n[c].items.find((m) => m.id === d);
    f ? f.onUpdate(d) : console.error(`Could not find dropdown radio item with id '${d}'!`);
  };
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(Ee, { children: [
    /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ p(B, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(me, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Oa, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((f, m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][m],
        ...
        Uw,
        {
          ...
          children: c.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r($a, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, c.label)) })
...
function cc({ id: t, versionHistory: e }) {
  ...
  function s(l) {
    const w = new Date(l), c = new Date(a.getTime() - w.getTime()), d = c.getUTCFullYear() - 1970, f = c.getUTCMonth(), m = c.getUTCDate() - 1;
    let u = "";
    return d > 0 ? u = `${d.toString()} year${d === 1 ? "" : "s"} ago` : f > 0 ? u = `${f.toString()} month${f === 1 ? "" : "s"} ago` : m === 0 ? u = "today" : u = `${m.toString()} day${m === 1 ? "" : "s"} ago`, u;
  }
...
function Pp({
  ...
  const i = F(() => ai(n), [n]), w = ((c) => {
    const d = new Intl.DisplayNames(si(), { type: "language" });
...
function dc({
  ...
  return /* @__PURE__ */ r("div", { id: b, className: g, children: /* @__PURE__ */ p(re, { open: M, onOpenChange: d ?? y, children: [
    /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ p(
      B,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ee, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(B, { variant: "ghost", size: "sm", onClick: z, children: s }),
        /* @__PURE__ */ r(B, { variant: "ghost", size: "sm", onClick: A, children: i })
      ] }),
      /* @__PURE__ */ p(ne, { children: [
        /* @__PURE__ */ r(wn, { children: l }),
        /* @__PURE__ */ r(Ut, { children: j.map((S) => /* @__PURE__ */ p(
          Ht,
          {
            value: S.label,
            onSelect: k,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ r(Ps, { className: "tw-h-4 tw-w-4" }),
...
function $p({
  ...
  return /* @__PURE__ */ p("div", { id: f, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: e.map((m) => {
      var u;
      return /* @__PURE__ */ p(Ae, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          B,
          {
            variant: "ghost",
            ...
            onClick: () => n(e.filter((g) => g !== m)),
            children: /* @__PURE__ */ r(Ve, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (u = t.find((g) => g.value === m)) == null ? void 0 : u.label
      ] }, m);
...
function mc({ children: t, editorRef: e }) {
  const n = H(null);
  return Y(() => {
    var i;
    const o = /Macintosh/i.test(navigator.userAgent), a = ((i = n.current) == null ? void 0 : i.querySelector(".editor-input")) ?? void 0, s = (l) => {
      ...
      if (o) {
        ...
        if (!l.ctrlKey) return;
        !l.shiftKey && w === "z" ? (l.preventDefault(), (f = e.current) == null || f.undo()) : (w === "y" || l.shiftKey && w === "z") && (l.preventDefault(), (m = e.current) == null || m.redo());
      }
    };
...
const fc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(lt, { children: [
...
function hc({
  ...
  const s = H(null), i = H(null), l = H(!1), [w, c] = R(t), [d, f] = R(n), [m, u] = R(!1);
  Y(() => {
    c(t);
  }, [t]), Y(() => {
    d !== n && f(n);
  ...
  const g = (b) => {
    l.current = !1, u(b), b || (w !== "custom" || d ? (e(w), o(d)) : (c(t), f(n)));
  }, x = (b) => {
    var N, y, k, C;
    b.stopPropagation(), document.activeElement === i.current && b.key === "ArrowDown" || b.key === "ArrowRight" ? ((N = s.current) == null || N.focus(), l.current = !0) : document.activeElement === s.current && b.key === "ArrowUp" ? ((y = i.current) == null || y.focus(), l.current = !1) : document.activeElement === s.current && b.key === "ArrowLeft" && ((k = s.current) == null ? void 0 : k.selectionStart) === 0 && ((C = i.current) == null || C.focus(), l.current = !1), w === "custom" && b.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ p(Ee, { open: m, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: fc(t, a, n) }) }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            te,
            {
              ...
              onClick: (b) => {
                var N;
                b.stopPropagation(), l.current = !0, (N = s.current) == null || N.focus();
              },
...
const gc = (t, e) => t === "f" ? /* @__PURE__ */ p(lt, { children: [
  /* @__PURE__ */ r(_o, {}),
  " ",
...
function vc({
  ...
  return /* @__PURE__ */ p(Ee, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Bi, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: gc(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: bc(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(me, { style: { zIndex: qo }, children: [
...
function yc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Vs, { className: e, size: 16 });
}
function uo({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ p(
    Ht,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(yc, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
...
function Nc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = R(""), [s, i] = F(() => {
  ...
  return /* @__PURE__ */ p(ee, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(ne, { children: [
      /* @__PURE__ */ r(wn, { children: t["%markerMenu_noResults%"] }),
      ...
      i.length > 0 && /* @__PURE__ */ p(lt, { children: [
        s.length > 0 && /* @__PURE__ */ r(yr, { alwaysRender: !0 }),
...
function Lp({
  ...
  const d = H(null), f = H(null), m = H(null), u = H(null);
  At(() => {
    if (!u.current) return;
    const { width: _ } = u.current.getBoundingClientRect();
    _ > 0 && (u.current.style.width = `${_}px`);
  }, []);
  const [g, x] = R("generated"), [b, N] = R("*"), [y, k] = R("f"), [C, j] = R(!1), [z, A] = R(!0), [M, E] = R(!1), S = H(!1), V = H(""), [$, O] = R(!1), [P, W] = R(), [I, J] = R(), [St, Pt] = R(), [It, gt] = R(), pt = H(null), G = F(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (L && pn("note", L)) {
      ...
      let tt = "custom";
      it === er ? tt = "generated" : it === nr ? tt = "hidden" : it && N(it), x(tt), k(((q = L.insert.note) == null ? void 0 : q.style) ?? "f"), _ = setTimeout(() => {
        var bt;
        (bt = d.current) == null || bt.applyUpdate([L]);
      }, 0);
    }
    return () => {
      _ && clearTimeout(_);
  ...
  const st = K(
    (_, L, U = !1) => {
      ...
      if (q && pn("note", q)) {
        if (q.insert.note) {
          let ct;
          _ === "custom" ? ct = L : _ === "generated" ? ct = er : ct = nr, q.insert.note.caller = ct;
        }
        n == null || n([q]), U && c && s && ((bt = c.current) == null || bt.replaceEmbedUpdate(s, [q]));
      }
    },
    [s, n, c]
  ), wt = K(() => {
  ...
  const Bt = () => {
    var L;
    const _ = (L = f.current) == null ? void 0 : L.getElementsByClassName("editor-input")[0];
    ...
    if (L && pn("note", L)) {
      ...
      y !== "x" && _ === "x" ? ct == null || ct.forEach((Dt) => _c(Dt)) : y === "x" && _ !== "x" && (ct == null || ct.forEach((Dt) => Cc(Dt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
    ...
    (_) => {
      ...
      if (L && pn("note", L)) {
        _.content.length > 1 && setTimeout(() => {
          var $t;
          ($t = d.current) == null || $t.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const ct = (it = L.insert.note) == null ? void 0 : it.style, Dt = (bt = (tt = L.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (ct || j(!1), j(
          ct === "x" ? !!(Dt != null && Dt.every(($t) => {
            var vt, ft;
          ...
          S.current = !0, V.current = JSON.stringify(L), A(!0);
          return;
        }
        A(JSON.stringify(L) === V.current), st(g, b);
      } else
        j(!1), A(!0);
    },
    [g, b, st]
    ...
    if (m.current && at.length && _ && _.rangeCount > 0) {
      const L = _.getRangeAt(0).getBoundingClientRect(), U = m.current.getBoundingClientRect();
  ...
  return Y(() => {
    ...
    var U;
    const _ = ((U = f.current) == null ? void 0 : U.querySelector(".editor-input")) ?? void 0, L = (q) => {
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
            /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(B, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(Ve, {}) }) }),
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(mc, { editorRef: d, children: /* @__PURE__ */ r(
              nl,
              {
                options: G,
                onStateChange: Zt,
...
function Sc({
  ...
  /* @__PURE__ */ p("span", { className: h("note-caller tw-inline-block", { formatted: s }), children: [
    a,
    " "
  ] }), f = i && /* @__PURE__ */ p(lt, { children: [
    Ar(t.marker, [i], o, !1),
    " "
  ] }), m = e === "horizontal" ? "horizontal" : "vertical", u = o ? "marker-visible" : "", g = e === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", x = h(m, u);
  return /* @__PURE__ */ p(lt, { children: [
    /* @__PURE__ */ p("div", { className: h("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", x), children: [
      w,
      d
    ] }),
    /* @__PURE__ */ r("div", { className: h("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", x), children: f }),
    /* @__PURE__ */ r(
      "div",
      {
        className: h(
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: Tc(t.marker, l, o, c) })
      }
    )
  ] });
}
function jp({
  ...
  const d = w ?? ii(n, void 0), f = (y, k) => {
    c == null || c(y, k, a);
  }, m = s ? n.findIndex((y) => y === s) : -1, [u, g] = R(m), x = (y, k, C) => {
    if (n.length)
      switch (y.key) {
        case "Enter":
        case " ":
...
function Mc({
  ...
  return /* @__PURE__ */ p(In, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(An, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Qt,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ r(ye, { className: o, children: Dc(l.text) })
        ]
      },
...
const Pr = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rr.Root,
  {
    ref: n,
    className: h(
...
const Ic = (t) => {
  ...
  if (t === "desc")
    return /* @__PURE__ */ r(Ks, { className: "tw-h-4 tw-w-4" });
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ p(Dr, { value: i, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        en,
        {
          onClick: (w) => {
            w.stopPropagation(), Hn(
              [l],
              "approved",
              e,
              n,
  ...
  return e ? e[1] : "";
}, Ac = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", qp = Object.freeze([
...
function Hp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), b = Kt(n, "%webView_inventory_unknown%"), N = Kt(n, "%webView_inventory_scope_currentBook%"), y = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), j = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), z = Kt(n, "%webView_inventory_no_results%"), [A, M] = R(!1), [E, S] = R("all"), [V, $] = R(""), [O, P] = R([]), W = F(() => {
    const G = t ?? [];
    return G.length === 0 ? [] : $c(G, a, s);
  }, [t, a, s]), I = F(() => {
    if (A) return W;
    const G = [];
    return W.forEach((at) => {
  ...
  }, [A, W]), J = F(() => I.length === 0 ? [] : Pc(I, E, V), [I, E, V]), St = F(() => {
    var st, wt;
    if (!A) return w;
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        $e,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(_e, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Le, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ p($e, { onValueChange: (G) => It(G), defaultValue: i, children: [
        /* @__PURE__ */ r(_e, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Le, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Ce, { children: [
...
const Lc = "16rem", Vc = "3rem", za = v.createContext(void 0);
function $n() {
  const t = v.useContext(za);
  if (!t)
...
const Fa = v.forwardRef(
  ({
    ...
    const [c, d] = v.useState(t), f = e ?? c, m = v.useCallback(
      (k) => {
        const C = typeof k == "function" ? k(f) : k;
        n ? n(C) : d(C);
      },
      [n, f]
    ), u = v.useCallback(() => m((k) => !k), [m]), g = f ? "expanded" : "collapsed", N = mt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = v.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: m,
    ...
    return /* @__PURE__ */ r(za.Provider, { value: y, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Ba = v.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = $n();
...
const jc = v.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = $n();
  return /* @__PURE__ */ p(
    B,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Gs, {}) : /* @__PURE__ */ r(Us, {}),
...
const Fc = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  qe,
  {
    ref: n,
    "data-sidebar": "input",
...
Kc.displayName = "SidebarFooter";
const Gc = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pe,
  {
    ref: n,
...
const mr = v.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? ze : "div",
  {
    ref: o,
...
const Uc = v.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? ze : "button",
  {
    ref: o,
...
Uc.displayName = "SidebarGroupAction";
...
const qc = pe(
  ...
  ({
    ...
    const w = t ? ze : "button", { state: c } = $n(), d = /* @__PURE__ */ r(
      w,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: h(qc({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Hc = v.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? ze : "button",
  {
    ref: a,
...
Hc.displayName = "SidebarMenuAction";
const Yc = v.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
const Xc = v.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Zc = v.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? ze : "a",
  {
    ref: s,
...
function Qc({
  ...
  return /* @__PURE__ */ r(
    Ba,
    {
      ...
      children: /* @__PURE__ */ p(Ga, { children: [
        /* @__PURE__ */ p(ur, { children: [
          /* @__PURE__ */ r(mr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(Ua, { children: Object.entries(e).map(([m, u]) => /* @__PURE__ */ r(qa, { children: /* @__PURE__ */ r(
            Ha,
            {
              onClick: () => c(m),
              isActive: f(m),
    ...
    /* @__PURE__ */ p(
      Fa,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ka, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const se = "scrBook", td = "scrRef", ge = "source", ed = "details", nd = "Scripture Reference", rd = "Scripture Book", Ya = "Type", od = "Details";
function ad(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ut.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === se ? ve(a.start) : void 0;
      },
...
}, mo = (t) => `${sd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Xp({
  sources: t,
  ...
  const [c, d] = R([]), [f, m] = R([{ id: se, desc: !1 }]), [u, g] = R({}), x = F(
  ...
  Y(() => {
    if (l) {
      const E = N.getSelectedRowModel().rowsById, S = Object.keys(E);
      if (S.length === 1) {
        const V = x.find(($) => mo($) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, x, l, N]);
  const y = a ?? rd, k = s ?? Ya, C = [
  ...
  }, A = (E, S) => E.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), M = (E, S, V) => {
    if (!((E == null ? void 0 : E.length) === 0 || S.depth < V.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ p(
      $e,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ce, { position: "item-aligned", children: /* @__PURE__ */ r(Xw, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(In, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: N.getHeaderGroups().map((E) => /* @__PURE__ */ r(Qt, { children: E.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(an, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          Ze(S.column.columnDef.header, S.getContext())
        ] }) }, S.id)
      )) }, E.id)) }),
      /* @__PURE__ */ r(An, { children: N.getRowModel().rows.map((E, S) => {
        const V = mt();
        return /* @__PURE__ */ r(
          Qt,
          {
            ...
            children: E.getVisibleCells().map(($) => {
              if (!($.getIsPlaceholder() || $.column.columnDef.enableGrouping && !$.getIsGrouped() && ($.column.columnDef.id !== ge || !n)))
                return /* @__PURE__ */ r(
                  ye,
                  {
                    className: h(
                    ...
                    children: $.getIsGrouped() ? /* @__PURE__ */ p(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ r(Me, {}) : /* @__PURE__ */ r(Jn, {})),
                          " ",
...
}), Xa = (t, e, n) => Lr(t, e).every((o) => n.includes(o));
function id({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Lr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], w = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    B,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: h(
        Xa(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: ml(
        t,
...
function ld({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: m, ntLong: u, dcLong: g, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [b, N] = R(!1), [y, k] = R(""), C = H(void 0), j = H(!1);
  if (t.length !== ut.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const z = F(() => ut.allBookIds.filter(
    ...
    (P) => {
      ...
      n(
        Xa(z, P, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, z]
  ), $ = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
            ...
            ee,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(B, { variant: "ghost", size: "sm", onClick: $, children: w }),
                  /* @__PURE__ */ r(B, { variant: "ghost", size: "sm", onClick: O, children: c })
                ] }),
                /* @__PURE__ */ p(ne, { children: [
                  /* @__PURE__ */ r(wn, { children: d }),
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Yn ? Yn : fo
      ).map((P) => /* @__PURE__ */ r(Ae, { className: "hover:tw-bg-secondary", variant: "secondary", children: De(P, a) }, P)),
      e.length > Yn && /* @__PURE__ */ r(
        Ae,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - fo} ${f}`
        }
      )
    ] })
  ] });
...
function Jp({
  ...
  const c = fe(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), m = fe(i, "%webView_scope_selector_current_book%"), u = fe(i, "%webView_scope_selector_choose_books%"), g = fe(i, "%webView_scope_selector_scope%"), x = fe(i, "%webView_scope_selector_select_books%"), b = [
      ...
      /* @__PURE__ */ r(
        _r,
        {
          ...
          children: N.map(({ value: y, label: k, id: C }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(yn, { className: "tw-me-2", value: y, id: C }),
...
const Ja = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ p(Gw, { children: [
    /* @__PURE__ */ r(Aa, { children: l.label }),
    /* @__PURE__ */ r(Kw, { children: /* @__PURE__ */ r(Pa, { children: Ja(
      t,
      e,
      Wa(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(Ee, { variant: s, children: [
    /* @__PURE__ */ r(Ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Hs, {}) }) }),
    /* @__PURE__ */ r(me, { align: "start", style: { zIndex: Be }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(ho, { children: [
      /* @__PURE__ */ r(Oa, { children: /* @__PURE__ */ r(kt, { children: Ja(e.groups, e.items, w, t) }) }),
      c < d.length - 1 && /* @__PURE__ */ r(Ue, {})
    ] }, w)) })
  ] });
}
...
function nu({
  ...
  return /* @__PURE__ */ p(Za, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      hr,
      {
        onSelectMenuItem: t,
...
const Qa = v.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Rt.Root,
    {
...
ts.displayName = Rt.List.displayName;
const wd = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Trigger,
  {
    ref: n,
    ...e,
...
)), es = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Content,
  {
    ref: n,
    className: h(
...
es.displayName = Rt.Content.displayName;
function ou({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(Qa, { children: [
      /* @__PURE__ */ r(ts, { children: t.map((l) => /* @__PURE__ */ r(wd, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(es, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function cd({ ...t }) {
...
const ns = v.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = v.useMemo(
    () => ({
      variant: e
    }),
...
const rs = v.forwardRef(({ className: t, ...e }, n) => {
  const o = Ft();
  return /* @__PURE__ */ r(
    rt.Trigger,
    {
...
const os = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    rt.SubTrigger,
    {
...
const ss = v.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Ft();
...
const is = v.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
const pd = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    rt.CheckboxItem,
    {
...
pd.displayName = rt.CheckboxItem.displayName;
const ud = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ p(
    rt.RadioItem,
    {
...
ud.displayName = rt.RadioItem.displayName;
const md = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  rt.Label,
  {
    ref: o,
    className: h("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
md.displayName = rt.Label.displayName;
const ls = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Separator,
  {
    ref: n,
    className: h("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
function fd({
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, f) => {
    var g, x, b, N;
    d.preventDefault();
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Xe(s, [m, u]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Xe(i, [m, u]);
        break;
      case "alt+n":
        (b = l.current) == null || b.focus(), Xe(l, [m, u]);
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), Xe(w, [m, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(ns, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, f]) => typeof d == "boolean" || typeof f == "boolean" ? 0 : d.order - f.order).map(([d, f]) => /* @__PURE__ */ p(cd, { children: [
      /* @__PURE__ */ r(rs, { ref: c(d), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        ss,
        {
          style: { zIndex: Be },
          children: /* @__PURE__ */ r(kt, { children: ws(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
...
function iu({
  ...
  const c = hd(
    ...
    var N, y, k, C, j, z;
    const b = x !== g ? ((y = (N = t[g]) == null ? void 0 : N.uiNames) == null ? void 0 : y[x]) ?? ((C = (k = t[g]) == null ? void 0 : k.uiNames) == null ? void 0 : C.en) : void 0;
    return b ? `${(j = t[g]) == null ? void 0 : j.autonym} (${b})` : (z = t[g]) == null ? void 0 : z.autonym;
  };
  return /* @__PURE__ */ p("div", { id: w, className: h("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(ht, { className: "tw-font-normal tw-text-muted-foreground", children: be(c, {
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            c && (e || m && g) && /* @__PURE__ */ r(
              ...
              {
                className: h(
                  !e && m && "tw-invisible group-hover:tw-visible"
                ),
                children: /* @__PURE__ */ p(Ee, { children: [
                  /* @__PURE__ */ r(Ge, { className: h(f && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(
                    B,
                    {
...
const bd = sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Js, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
...
), xd = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Nd = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Nd.displayName = "AlertDescription";
const du = ot.Root, pu = ot.Trigger, uu = ot.Group, mu = ot.Portal, fu = ot.Sub, hu = ot.RadioGroup, kd = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: h(
...
kd.displayName = ot.SubTrigger.displayName;
...
_d.displayName = ot.SubContent.displayName;
const Cd = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: h(
...
Cd.displayName = ot.Content.displayName;
const Ed = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ot.Item,
  {
    ref: o,
    className: h(
...
Ed.displayName = ot.Item.displayName;
const Td = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ot.CheckboxItem,
  {
    ref: a,
    className: h(
...
Td.displayName = ot.CheckboxItem.displayName;
const Rd = v.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ot.RadioItem,
  {
    ref: o,
    className: h(
...
Rd.displayName = ot.RadioItem.displayName;
const Sd = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ot.Label,
  {
    ref: o,
    className: h(
...
const Dd = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ot.Separator,
  {
    ref: n,
...
Dd.displayName = ot.Separator.displayName;
...
const gu = zt.Trigger, Od = zt.Portal, bu = zt.Close, ds = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
ds.displayName = zt.Overlay.displayName;
const Ad = v.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = v.useContext(cs), i = {
...
Ld.displayName = zt.Title.displayName;
...
Vd.displayName = zt.Description.displayName;
const jd = v.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  or.Root,
  {
    ref: o,
    className: h(
...
jd.displayName = or.Root.displayName;
function vu({
  className: t,
  ...e
}) {
...
function yu({
  ...
  return /* @__PURE__ */ r(
    xr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Zs, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Nu({ ...t }) {
...
const zd = v.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ p(
    We.Root,
    {
...
zd.displayName = We.Root.displayName;
...
Fd.displayName = ar.Root.displayName;
const ku = Rt.Root, Bd = v.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Rt.List,
    {
...
Bd.displayName = Rt.List.displayName;
...
Kd.displayName = Rt.Trigger.displayName;
...
export {
  ...
  _d as ContextMenuSubContent,
  kd as ContextMenuSubTrigger,
  pu as ContextMenuTrigger,
  sc as DataTable,
  cl as Dialog,
  xp as DialogClose,
  Yo as DialogContent,
  ul as DialogDescription,
  pl as DialogFooter,
  Xo as DialogHeader,
  Ho as DialogOverlay,
  dl as DialogPortal,
  ...
  Hp as Inventory,
  ht as Label,
  xc as MARKER_MENU_STRING_KEYS,
  Dp as MarkdownRenderer,
  Nc as MarkerMenu,
  Ap as MoreInfo,
  dc as MultiSelectComboBox,
  ...
  pc as UNDO_REDO_BUTTONS_STRING_KEYS,
  iu as UiLanguageSelector,
  uc as UndoRedoButtons,
  Qa as VerticalTabs,
  es as VerticalTabsContent,
  ts as VerticalTabsList,
  wd as VerticalTabsTrigger,
