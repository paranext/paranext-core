...
var hs = (e, t, n) => t in e ? ms(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var ft = (e, t, n) => hs(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as rn, useRef as Z, useMemo as B, useState as M, useCallback as z, useLayoutEffect as Ht, createContext as En, useContext as br, useEffect as Y, Component as fs, createElement as jr, Suspense as gs, createRef as bs, Fragment as bo } from "react";
import { Command as yt } from "cmdk";
import { X as Ae, Search as vo, Check as Dt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Gr, ChevronLeft as Qn, ChevronRight as Te, ArrowLeft as vs, ArrowRight as xs, Circle as Tn, ChevronDown as be, BoldIcon as ys, ItalicIcon as Ns, UnderlineIcon as ks, StrikethroughIcon as _s, AtSign as xo, Pencil as Cs, Trash2 as Es, ArrowUp as yo, MoreHorizontal as No, ChevronUp as tr, FilterIcon as Ts, ArrowLeftIcon as Ss, ChevronLeftIcon as Rs, ChevronRightIcon as Ds, ArrowRightIcon as Ms, Copy as ko, Filter as Os, User as Is, Link as As, CircleHelp as Vs, ChevronsUpDown as _o, Star as Ps, SquareX as Co, FunctionSquare as Eo, SquareSigma as To, AlertCircle as er, CircleCheckIcon as $s, CircleXIcon as Ls, CircleHelpIcon as Bs, ArrowUpIcon as js, ArrowDownIcon as zs, ArrowUpDownIcon as Fs, PanelLeft as Gs, PanelRight as Ks, ScrollText as Hs, MenuIcon as Xs, Menu as Us, EllipsisVertical as Ys, LoaderCircle as qs, GripVertical as Js } from "lucide-react";
import { clsx as Ws } from "clsx";
import { extendTailwindMerge as Zs } from "tailwind-merge";
import * as Rt from "@radix-ui/react-dialog";
import { includes as pn, Section as H, getChaptersForBook as Qs, formatScrRef as te, getSectionForBook as Ue, formatRelativeDate as ti, formatReplacementString as me, sanitizeHtml as ei, parseParatextHtml as Kr, hasCustomParatextTags as ni, NumberFormat as ri, formatBytes as oi, getCurrentLocale as ai, getFormatCallerFunction as si, deepEqual as So, isString as Bn, compareScrRefs as nr, scrRefToBBBCCCVVV as jn, getLocalizeKeyForScrollGroupId as W, formatScrRefRange as ii } from "platform-bible-utils";
...
import { createEditor as Do, $getRoot as ne, $createParagraphNode as Sn, $getSelection as Xt, HISTORY_MERGE_TAG as vr, ParagraphNode as Mo, TextNode as Oo, $isTokenOrSegmented as li, $getCharacterOffsets as wi, $cloneWithPropertiesEphemeral as ci, $findMatchingParent as di, $isElementNode as he, CLEAR_EDITOR_COMMAND as Io, COMMAND_PRIORITY_EDITOR as Ao, $isRangeSelection as Qe, shallowMergeConfig as pi, defineExtension as Yt, safeCast as on, RootNode as ui, LineBreakNode as mi, TabNode as hi, $isEditorState as fi, createCommand as gi, CLICK_COMMAND as bi, isDOMNode as vi, $getNodeFromDOMNode as xi, $isNodeSelection as yi, $createNodeSelection as Ni, $setSelection as ki, COMMAND_PRIORITY_LOW as _i, DecoratorNode as Ci, $create as Ei, $getNodeByKey as Ti, INDENT_CONTENT_COMMAND as Hr, COMMAND_PRIORITY_CRITICAL as xr, KEY_TAB_COMMAND as Si, $createRangeSelection as Ri, $normalizeSelection__EXPERIMENTAL as Di, OUTDENT_CONTENT_COMMAND as Mi, INSERT_TAB_COMMAND as Oi, $isBlockElementNode as vn, $isDecoratorNode as Ii, $isParagraphNode as Ai, $isTextNode as xn, SELECTION_CHANGE_COMMAND as Vo, FORMAT_TEXT_COMMAND as Vi, getRegisteredNode as Pi, isHTMLElement as $i, isDocumentFragment as Xr, isDOMDocumentNode as Li, ArtificialNode__DO_NOT_USE as Po, $createLineBreakNode as $o, $isRootOrShadowRoot as Bi, isBlockDomNode as Ur, isInlineDomNode as Yr, $insertNodes as ji } from "lexical";
import * as an from "@radix-ui/react-tooltip";
import { TooltipTrigger as zi } from "@radix-ui/react-tooltip";
import { HeadingNode as Fi, QuoteNode as Gi, registerRichText as Ki } from "@lexical/rich-text";
import { flushSync as Hi, createPortal as Xi } from "react-dom";
...
import { useReactTable as zo, getFilteredRowModel as qi, getSortedRowModel as Fo, getPaginationRowModel as Ji, getCoreRowModel as Go, flexRender as Ye, getGroupedRowModel as Wi, getExpandedRowModel as Zi } from "@tanstack/react-table";
...
const sl = Rt.Root, il = Rt.Portal, Ko = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Rt.Overlay,
  {
    ref: n,
    className: h(
...
Ho.displayName = Rt.Content.displayName;
...
Uo.displayName = Rt.Title.displayName;
const ll = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Rt.Description,
  {
    ref: n,
...
Yo.displayName = yt.Separator.displayName;
...
var wl = Object.defineProperty, cl = (e, t, n) => t in e ? wl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, K = (e, t, n) => cl(e, typeof t != "symbol" ? t + "" : t, n);
const ve = [
  "GEN",
  "EXO",
  "LEV",
...
const xt = class X {
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new de(i)), n ? new X(n, r.toString(), l, c) : new X();
  }
  /**
...
K(xt, "defaultVersification", de.English), K(xt, "verseRangeSeparator", "-"), K(xt, "verseSequenceIndicator", ","), K(xt, "verseRangeSeparators", [xt.verseRangeSeparator]), K(xt, "verseSequenceIndicators", [xt.verseSequenceIndicator]), K(xt, "chapterDigitShifter", 1e3), K(xt, "bookDigitShifter", xt.chapterDigitShifter * xt.chapterDigitShifter), K(xt, "bcvMaxValue", xt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
K(xt, "ValidStatusType", ea);
...
const ra = Q.allBookIds.filter(
  (e) => !Q.isObsolete(Q.bookIdToNumber(e))
), fe = Object.fromEntries(
  ra.map((e) => [e, Q.bookIdToEnglishName(e)])
);
function Er(e, t, n) {
...
const oa = rn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Ve : "button", { className: h(Nl({ variant: t, size: n, className: e })), ref: s, ...a })
);
$.displayName = "Button";
const se = Se.Root, ie = Se.Trigger, vp = Se.Anchor, Wt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = dt();
...
function kl({
  ...
  return /* @__PURE__ */ d(se, { open: c, onOpenChange: w, children: [
    /* @__PURE__ */ o(ie, { asChild: !0, children: /* @__PURE__ */ o(
      $,
      {
        variant: "ghost",
        size: "icon",
...
function xp(e, t, n = (a, s) => a === s, r = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, r - 1)];
...
function yp({
  ...
  const w = dt(), [p, m] = M(!1), [f, u] = M(""), [g, x] = M(""), [v, k] = M("books"), [N, T] = M(void 0), [V, j] = M(!1), A = Z(void 0), y = Z(void 0), C = Z(void 0), E = Z(void 0), _ = Z({}), I = z(
    ...
    [H.OT]: P.filter((U) => Q.isBookOT(U)),
    [H.NT]: P.filter((U) => Q.isBookNT(U)),
    [H.DC]: P.filter((U) => Q.isBookDC(U)),
    [H.Extra]: P.filter((U) => Q.extraBooks().includes(U))
  ...
  return Ht(() => {
    ...
    /* @__PURE__ */ o(Wt, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      qt,
      {
        ref: A,
        onKeyDown: ke,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: wt.map(({ onClick: O, disabled: U, title: st, icon: S }) => /* @__PURE__ */ o(
              $,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ o(
              $,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ o(vs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(xs, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ee(N, a) })
          ] }),
              ...
              !D && Object.entries(F).map(([O, U]) => {
                if (U.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ o(Ut, { heading: wn(O), children: U.map((st) => /* @__PURE__ */ o(
                      oa,
                      {
                        bookId: st,
                        onSelect: (S) => pt(S),
...
), ct = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Ro.Root, { ref: n, className: h("pr-twp", Tl(), e), ...t }));
...
const yn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ze.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ o(Ze.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ o(Tn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
...
function wr({
  ...
  return /* @__PURE__ */ d(se, { open: N, onOpenChange: T, ...k, children: [
    /* @__PURE__ */ o(ie, { asChild: !0, children: /* @__PURE__ */ d(
      $,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ o(
      Wt,
      {
        ...
        children: /* @__PURE__ */ d(qt, { children: [
          ...
          /* @__PURE__ */ o(Jt, { children: j(t) ? t.map((y) => /* @__PURE__ */ o(Ut, { heading: y.groupHeading, children: y.options.map((C) => A(C, y.groupHeading)) }, y.groupHeading)) : t.map((y) => A(y)) })
        ] })
      }
    )
  ] });
    ...
    Tr,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ o(ct, { className: "tw-flex tw-items-center", children: r.map((v) => Q.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ o(
            $,
            {
...
const sa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = sa ? Ht : Y, mn = { tag: vr };
function Il({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Ml(null, r), p = Do({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Sn();
            u.append(g);
            const x = sa ? document.activeElement : null;
  ...
  }, []), o(aa.Provider, { value: n, children: t });
}
const Al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function Vl({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return Al(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: c }) => {
      t && s.size === 0 && i.size === 0 || e && c.has(vr) || l.isEmpty() || n(a, r, c);
    });
  }, [r, e, t, n]), null;
}
const Sr = {
  ...
  mark: "",
  markOverlap: ""
}, Tt = an.Provider, Pt = an.Root, Gt = an.Trigger, St = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  an.Content,
  {
    ref: r,
    sideOffset: t,
...
function Bl({ children: e, onError: t }) {
  return o($l, { fallback: o("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
const jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function zl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function Fl() {
  return function(e) {
    const [t] = Lt(), n = B(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = Z(r);
    return jl(() => {
...
const ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = ia && "documentMode" in document ? document.documentMode : null;
!(!ia || !("InputEvent" in window) || Hl) && "getTargetRanges" in new window.InputEvent("input");
function la(...e) {
  const t = [];
...
function Qr(e) {
  const t = di(e, (n) => he(n) && !n.isInline());
  return he(t) || Kl(4, e.__key), t;
}
function Ul(e, t) {
  const n = [];
...
function Dr(e) {
  ...
  e.x = void 0, e.s = void 0, pa(e);
}
function Wl(e) {
  if (q !== this) throw new Error("Out-of-order effect");
  da(this), q = e, this.f &= -2, 8 & this.f && Dr(this), Dn();
}
function Ce(e, t) {
...
gt.prototype.brand = Yl, gt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, pa(this), no(this), ee++;
  const e = q;
  return q = this, Wl.bind(this, e);
...
Yt({ build: (e, t, n) => Mn(t), config: on({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
  return oe(() => r.disabled.value ? void 0 : e.registerRootListener((a) => {
    e.focus(() => {
...
Yt({ build: (e, t, n) => Mn(t), config: on({ $onClear: ua }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return oe(() => ma(e, r.value));
} });
function Zl(e) {
...
const dr = Yt({ build: (e) => ha(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function fa(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = fa(n[a], r[a]);
    return e;
  }
  return t;
}
const Mr = 0, pr = 1, ga = 2, Kn = 3, hn = 4, _e = 5, Hn = 6, Ke = 7;
function Xn(e) {
  return e.id === Mr;
}
function ba(e) {
...
function Ql(e) {
  return function(t) {
    return t.id === pr;
  }(e) || tt(305, String(e.id), String(pr)), Object.assign(e, { id: ga });
}
...
const rw = Yt({ config: on({ setOptions: ro, updateOptions: ro }), init: ({ $initialEditorState: e = nw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
  const a = r.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (fi(s)) e.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ui, Oo, mi, hi, Mo] }), oo = Symbol.for("@lexical/extension/LexicalBuilder");
function ao() {
}
function ow(e) {
  throw e;
...
class Je {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(Do({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [oo]: this });
  ...
  buildEditor() {
    ...
    return t = re(this.registerEditor(r), () => r.setRootElement(null)), r;
  }
...
const aw = /* @__PURE__ */ new Set(), so = Yt({ build(e, t, n) {
  const r = n.getDependency(dr).output, a = tn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ha(() => {
  }, () => oe(() => {
...
Yt({ dependencies: [dr, so], name: "@lexical/extension/HorizontalRule", nodes: [Re], register(e, t, n) {
  ...
  return re(e.registerCommand(bi, (i) => {
    if (vi(i.target)) {
      const l = xi(i.target);
      if (iw(l)) return function(c, w = !1) {
        const p = Xt(), m = c.isSelected(), f = c.getKey();
        let u;
        w && yi(p) ? u = p : (u = Ni(), ki(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, _i), e.registerMutationListener(Re, (i, l) => {
    ql(() => {
      let c = !1;
      ...
      for (const [p, m] of i.entries()) if (m === "destroyed") w.delete(p), c = !0;
        ...
        f ? f.domNode.value = u : (c = !0, w.set(p, { domNode: tn(u), selectedSignal: r(p) }));
      }
...
function lw(e, t) {
  return re(e.registerCommand(Si, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Ul(i, (f) => vn(f) && f.canIndent() ? f : null).length > 0) return !0;
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, p = w.getNode(), m = Qr(p);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Ri();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Di(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(r) ? n.shiftKey ? Mi : Hr : Oi;
    return e.dispatchCommand(a, void 0);
  }, Ao), e.registerCommand(Hr, () => {
...
const ww = Yt({ name: "@lexical/react/ReactProvider" });
function cw() {
...
Yt({ build: (e, t, n) => Mn(t), config: on({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => oe(() => n.getOutput().disabled.value ? void 0 : ya(e)) });
function uw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
  ...
  return function(n, r) {
    ...
    return Or(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = o(r, { onError: (f) => n._onError(f), children: o(gs, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
...
function io(e) {
  return e.getEditorState().read(xa(e.isComposing()));
}
function fw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [r] = Lt();
  return function(a) {
    Or(() => re(Ki(a), ya(a)), [a]);
  }(r), d(lt, { children: [e, o(gw, { content: t }), o(hw, { editor: r, ErrorBoundary: n })] });
}
...
const vw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function xw({ onClear: e }) {
  const [t] = Lt();
  return vw(() => ma(t, e), [t, e]), null;
}
const Na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function yw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: k = !0, style: N, tabIndex: T, "data-testid": V, ...j }, A) {
  ...
  return Na(() => (C(e.isEditable()), e.registerEditableListener((I) => {
    C(I);
...
function _w(e, t) {
  ...
  return d(lt, { children: [o(Nw, { editor: a, ...r, ref: t }), n != null && o(Cw, { editor: a, content: n })] });
}
...
function Tw({
  ...
  return /* @__PURE__ */ o(ka.Provider, { value: i, children: s });
}
function _a() {
  const e = br(ka);
  if (!e)
...
function Sw() {
  const [e, t] = M(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(sl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ho, { children: [
      /* @__PURE__ */ o(Xo, { children: /* @__PURE__ */ o(Uo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Rw({
  ...
  const [t] = Lt(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Sw(), c = () => {
  };
...
), Mw = b.forwardRef(({ className: e, variant: t, size: n, ...r }, a) => /* @__PURE__ */ o(
  Lo.Root,
  {
    ref: a,
    className: h(Ca({ variant: t, size: n, className: e })),
    ...r
  }
));
...
const wo = [
  ...
  { format: "underline", icon: ks, label: "Underline" },
  { format: "strikethrough", icon: _s, label: "Strikethrough" }
];
function Ow() {
  const { activeEditor: e } = _a(), [t, n] = M([]), r = z((a) => {
    if (Qe(a) || Ui(a)) {
      const s = [];
      wo.forEach(({ format: i }) => {
  ...
  return Dw(r), /* @__PURE__ */ o(
    Ir,
    {
      ...
      variant: "outline",
      size: "sm",
      children: wo.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ o(
        We,
        {
          value: a,
          "aria-label": i,
...
function Aw({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ o(Rw, { children: () => /* @__PURE__ */ o("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ o(Ow, {}) }) }),
...
function Pw(e, t) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Po && i.insertAfter($o());
    for (const i of s) {
...
function $w(e, t) {
  ...
  const n = document.createElement("div"), r = ne().getChildren();
...
function Ta(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Ta(e, g, f, r);
    !a && he(t) && x && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
...
function Ra(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  ...
  let f = [];
  const u = (l == null || !Bi(l)) && (l != null && vn(l) || r);
  for (let g = 0; g < m.length; g++) f.push(...Ra(m[g], t, n, u, new Map(a), l));
  return p != null && (f = p(f)), Ur(e) && (f = Lw(e, f, u ? () => {
    const g = new Po();
    return n.push(g), g;
  ...
  }(e) && (i = i.concat($o())) : he(l) && l.append(...f), i;
}
function Lw(e, t, n) {
...
function Bw(e) {
  ...
  const t = e.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Bo({
...
function Cp({
  ...
  const [a, s] = M(jw), [i, l] = M(void 0), [c, w] = M(!1), p = Z(void 0), m = Z(null);
  Y(() => {
    let k = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d(Pt, { children: [
    ...
    /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ d(se, { open: c, onOpenChange: w, children: [
      /* @__PURE__ */ o(ie, { asChild: !0, children: /* @__PURE__ */ d(
        $,
        {
          variant: "outline",
          ...
          disabled: e.length === 0,
          children: [
            /* @__PURE__ */ o(xo, { className: "tw-h-4 tw-w-4" }),
      ...
      /* @__PURE__ */ o(
        Wt,
        {
          ...
          children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: e.map((k) => /* @__PURE__ */ o(
            $t,
            {
              onSelect: () => {
                l(k === "" ? void 0 : k), w(!1);
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ o("span", { children: Yn(k, r) })
            },
            k || "unassigned"
          )) }) })
        }
...
const Ep = Object.freeze([
  ...
  "%no_comments%"
], zw = ["input", "select", "textarea", "button"], Fw = ["button", "textbox"], Gw = ({
  options: e,
  onFocusChange: t,
  onOptionSelect: n,
  onCharacterPress: r
  ...
  const a = Z(null), [s, i] = M(void 0), [l, c] = M(void 0), w = z(
    ...
    if (u.isContentEditable || zw.includes(g)) return !0;
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: h("pr-twp", Kw({ variant: t }), e), ...n })
);
...
const Uw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
Me.displayName = jo.Root.displayName;
...
Ia.displayName = Pe.Root.displayName;
...
qw.displayName = Pe.Image.displayName;
...
Aa.displayName = Pe.Fallback.displayName;
const Vr = En(void 0);
function Ot() {
  const e = br(Vr);
  if (!e)
...
}), Be = rt.Trigger, Va = rt.Group, Jw = rt.Portal, Ww = rt.Sub, Zw = rt.RadioGroup;
function Ne({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Vr.Provider, { value: n, children: /* @__PURE__ */ o(rt.Root, { ...t }) });
}
const Pa = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    rt.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ o(Te, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
...
$a.displayName = rt.SubContent.displayName;
const le = b.forwardRef(({ className: e, sideOffset: t = 4, children: n, ...r }, a) => {
  const s = dt();
...
const La = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    rt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(Tn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
});
La.displayName = rt.RadioItem.displayName;
...
function co({
  ...
  const v = z(() => {
    ...
    if (r && w)
      return /* @__PURE__ */ d(lt, { children: [
        !ni(e.contents) && /* @__PURE__ */ d(
          _n,
          {
            onClick: () => {
              f(!0), g(Bw(Kr(e.contents))), c == null || c(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ia, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Aa, { className: "tw-text-xs tw-font-medium", children: V }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            /* @__PURE__ */ o("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: N }),
        ...
        A && /* @__PURE__ */ d(Ne, { children: [
          /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(No, {}) }) }),
          /* @__PURE__ */ o(le, { align: "end", children: A })
        ] })
      ]
    }
  );
...
function tc({
  ...
  return /* @__PURE__ */ o(
    Ma,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ d(Oa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          wn && /* @__PURE__ */ o(De, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: wn }),
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            A && /* @__PURE__ */ o(
              $,
              {
                ...
                children: V ? /* @__PURE__ */ o(tr, {}) : /* @__PURE__ */ o(be, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
        ...
        /* @__PURE__ */ d(lt, { children: [
          cn && !r && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          r && /* @__PURE__ */ d(lt, { children: [
            ...
            $n.map((S) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              co,
              {
                comment: S,
                localizedStrings: n,
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    R !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: me(
                    ...
                    /* @__PURE__ */ d(se, { open: P, onOpenChange: G, children: [
                      ...
                      /* @__PURE__ */ o(
                        Wt,
                        {
                          ...
                          children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: u == null ? void 0 : u.map((S) => /* @__PURE__ */ o(
                            $t,
                            {
                              onSelect: () => {
                                F(S !== s ? S : void 0), G(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ o("span", { children: bn(S, n) })
                            },
                            S || "unassigned"
                          )) }) })
                        }
...
function Sp({
  ...
  const N = n.filter(
    ...
    [g]
  ), { listboxRef: A, activeId: y, handleKeyDown: C } = Gw({
    options: T,
    onOptionSelect: V
  }), E = z(
    (_) => {
...
function ec({ table: e }) {
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Yi, { asChild: !0, children: /* @__PURE__ */ d($, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(Ts, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Oe = it.Root, nc = it.Group, Ie = it.Value, rc = ae(
  ...
  return /* @__PURE__ */ d(
    it.Trigger,
    {
      className: h(rc({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
...
Ba.displayName = it.ScrollUpButton.displayName;
...
ja.displayName = it.ScrollDownButton.displayName;
...
oc.displayName = it.Label.displayName;
...
ac.displayName = it.Separator.displayName;
function sc({ table: e }) {
...
function en(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && ic(r)
  );
}
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), dc(u, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), cc(l, x, p.key);
...
function uc({
  ...
  var A;
  const [p, m] = M([]), [f, u] = M([]), [g, x] = M({}), [v, k] = M({}), N = B(() => t ?? [], [t]), T = zo({
    data: N,
    columns: e,
    getCoreRowModel: Go(),
  ...
  let j;
  return c ? j = Array.from({ length: 10 }).map((E, _) => `skeleton-row-${_}`).map((E) => /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(ge, { colSpan: V.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(ur, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((A = T.getRowModel().rows) == null ? void 0 : A.length) > 0 ? j = T.getRowModel().rows.map((y) => /* @__PURE__ */ o(
    Ft,
    {
      onClick: () => i(y, T),
      "data-state": y.getIsSelected() && "selected",
      children: y.getVisibleCells().map((C) => /* @__PURE__ */ o(ge, { children: Ye(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    y.id
  )) : j = /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(ge, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(ec, { table: T }),
    /* @__PURE__ */ d(On, { stickyHeader: s, children: [
      /* @__PURE__ */ o(In, { stickyHeader: s, children: T.getHeaderGroups().map((y) => /* @__PURE__ */ o(Ft, { children: y.headers.map((C) => /* @__PURE__ */ o(nn, { children: C.isPlaceholder ? void 0 : Ye(C.column.columnDef.header, C.getContext()) }, C.id)) }, y.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o($, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(ko, {}) })
        ] }),
...
function Mp({
  ...
  return /* @__PURE__ */ d(se, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ o(ie, { asChild: !0, children: r }),
...
var fc = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(fc || {});
function Op({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ d($, { variant: "default", children: [
      /* @__PURE__ */ o(Os, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(be, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ o(le, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ o(ln, { children: w.label }),
      /* @__PURE__ */ o(Va, { children: w.itemType === 0 ? /* @__PURE__ */ o(lt, { children: w.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Kt,
        {
          checked: r[p][f],
        ...
        Zw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(La, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ o(je, {})
    ] }, w.label)) })
...
function gc({ id: e, versionHistory: t }) {
...
function Ap({
  ...
  const i = B(() => oi(n), [n]), c = ((w) => {
    const p = new Intl.DisplayNames(ai(), { type: "language" });
  ...
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ o(gc, { versionHistory: a }),
...
function bc({
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(se, { open: C, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ o(ie, { asChild: !0, children: /* @__PURE__ */ d(
      $,
      {
        variant: x,
        ...
        children: [
          ...
          /* @__PURE__ */ o(_o, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(Wt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(qt, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: y, children: i })
      ] }),
...
const vc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(lt, { children: [
...
function xc({
  ...
  return /* @__PURE__ */ d(Ne, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d(Pt, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o($, { variant: "outline", className: "tw-h-6", children: vc(e, a, n) }) }) }),
...
const yc = (e, t) => e === "f" ? /* @__PURE__ */ d(lt, { children: [
  /* @__PURE__ */ o(Eo, {}),
  " ",
...
function kc({
  ...
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d(Pt, { children: [
      /* @__PURE__ */ o(zi, { asChild: !0, children: /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o($, { variant: "outline", className: "tw-h-6", children: yc(e, n) }) }) }),
      /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: Nc(e, n) }) })
    ] }) }),
...
function Pp({
  ...
  const c = Z(null), w = bs(), [p, m] = M("generated"), [f, u] = M("*"), [g, x] = M("f"), [v, k] = M(!1), N = B(
    () => ({
      ...i,
  ...
  const T = z(() => {
    ...
    if (C && un("note", C)) {
      ...
      g !== "x" && y === "x" ? R == null || R.forEach((F) => _c(F)) : g === "x" && y !== "x" && (R == null || R.forEach((F) => Cc(F))), (G = c.current) == null || G.applyUpdate([{ delete: 1 }, C]);
    }
  }, A = () => {
    var C, E, _, I, P;
    const y = (E = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : E.at(0);
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d(Pt, { children: [
            /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o($, { onClick: V, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(ko, {}) }) }),
  ...
  return /* @__PURE__ */ d(lt, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(lt, { children: Ec(e.marker, l, r, w) })
      }
    )
  ] });
}
        ...
        "ul",
        {
          ...
          children: n.map((N, T) => {
            ...
            return /* @__PURE__ */ d(lt, { children: [
              ...
              T < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(Me, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
  ...
  return /* @__PURE__ */ d(On, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ o(An, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Ft,
      {
        ...
        children: [
          /* @__PURE__ */ o(ge, { children: te(l.reference, "English") }),
          /* @__PURE__ */ o(ge, { className: r, children: Rc(l.text) })
        ]
      },
...
const Vn = (e) => e === "asc" ? /* @__PURE__ */ o(js, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(zs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Fs, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Bp = (e) => ({
  accessorKey: "item",
  ...
  return t ? t[1] : "";
}, Oc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Hp = Object.freeze([
...
function Xp({
  ...
  }, [A, R]), D = B(() => F.length === 0 ? [] : Ic(F, C, _), [F, C, _]), J = B(() => {
    var bt, mt;
    if (!A) return c;
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Oe,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(ye, { children: [
              ...
              /* @__PURE__ */ o(Ct, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Oe, { onValueChange: (L) => Bt(L), defaultValue: i, children: [
        ...
        /* @__PURE__ */ d(ye, { children: [
          ...
          /* @__PURE__ */ o(Ct, { value: "chapter", children: k }),
          /* @__PURE__ */ o(Ct, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ o(
        ze,
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(ct, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? V })
      ] })
    ] }),
    ...
    wt.length > 0 && /* @__PURE__ */ o("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ o(
      Dc,
      {
        classNameForText: m,
        occurrenceData: wt,
...
const Vc = "16rem", Pc = "3rem", Fa = b.createContext(void 0);
function Pn() {
  const e = b.useContext(Fa);
  if (!e)
...
const Ga = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ o(Fa.Provider, { value: N, children: /* @__PURE__ */ o(Tt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ka = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Pn();
...
const $c = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Pn();
  return /* @__PURE__ */ d(
    $,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ o(Gs, {}) : /* @__PURE__ */ o(Ks, {}),
...
const Bc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  ze,
  {
    ref: n,
    "data-sidebar": "input",
...
const Gc = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Ve : "button",
  {
    ref: r,
...
Gc.displayName = "SidebarGroupAction";
...
const Kc = ae(
  ...
  ({
    ...
    const c = e ? Ve : "button", { state: w } = Pn(), p = /* @__PURE__ */ o(
      c,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": t,
        className: h(Kc({ variant: n, size: r }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o(St, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : p;
  }
);
qa.displayName = "SidebarMenuButton";
const Hc = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? Ve : "button",
  {
    ref: a,
...
const Uc = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
Uc.displayName = "SidebarMenuSkeleton";
...
const Jc = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? Ve : "a",
  {
    ref: s,
    ...
    Ka,
    {
      ...
      children: /* @__PURE__ */ d(Xa, { children: [
        /* @__PURE__ */ d(mr, { children: [
          ...
          /* @__PURE__ */ o(fr, { children: /* @__PURE__ */ o(Ua, { children: Object.entries(t).map(([f, u]) => /* @__PURE__ */ o(Ya, { children: /* @__PURE__ */ o(
            qa,
            {
              onClick: () => w(f),
              isActive: m(f),
...
const Qt = "scrBook", Zc = "scrRef", ue = "source", Qc = "details", td = "Scripture Reference", ed = "Scripture Book", Ja = "Type", nd = "Details";
function rd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: Qt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? td,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? Q.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Qt ? te(a.start) : void 0;
      },
    ...
    {
      accessorFn: (r) => te(r.start),
      id: Zc,
      header: void 0,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? void 0 : te(a.start);
      },
      sortingFn: (r, a) => nr(r.original.start, a.original.start),
      enableGrouping: !1
    },
    {
      ...
      id: ue,
      header: n ? (e == null ? void 0 : e.typeColumnName) ?? Ja : void 0,
...
}, ho = (e) => `${od({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Jp({
  sources: e,
    ...
    !t && /* @__PURE__ */ d(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ye, { position: "item-aligned", children: /* @__PURE__ */ o(nc, { children: V.map((E) => /* @__PURE__ */ o(Ct, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(On, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(In, { children: k.getHeaderGroups().map((E) => /* @__PURE__ */ o(Ft, { children: E.headers.filter((_) => _.column.columnDef.header).map((_) => (
      ...
      /* @__PURE__ */ o(An, { children: k.getRowModel().rows.map((E, _) => {
        const I = dt();
        return /* @__PURE__ */ o(
          Ft,
          {
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      $,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ o(Te, {}) : /* @__PURE__ */ o(Qn, {})),
                          " ",
...
}), Wa = (e, t, n) => Br(e, t).every((r) => n.includes(r));
function ad({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ o(
    $,
    {
      ...
      onClick: () => r(e),
      className: h(
        Wa(t, e, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: yl(
        e,
...
function sd({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], c = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], m = r["%webView_book_selector_more%"], { otLong: f, ntLong: u, dcLong: g, extraLong: x } = {
  ...
  const A = B(() => Q.allBookIds.filter(
    ...
    (R) => {
      ...
      n(
        Wa(A, R, t) ? t.filter((D) => !F.includes(D)) : [.../* @__PURE__ */ new Set([...t, ...F])]
      );
    },
    [t, n, A]
  ), P = () => {
            ...
            qt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: P, children: c }),
                  /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: G, children: w })
                ] }),
                /* @__PURE__ */ d(Jt, { children: [
                  ...
                  Object.values(H).map((R, F) => {
                    ...
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(bo, { children: [
                        ...
                        F < Object.values(H).length - 1 && /* @__PURE__ */ o(Yo, {})
                      ] }, R);
                  })
                ] })
              ]
      ...
      /* @__PURE__ */ o(
        Tr,
        {
          ...
          children: k.map(({ value: N, label: T, id: V }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(yn, { className: "tw-me-2", value: N, id: V }),
            /* @__PURE__ */ o(ct, { htmlFor: V, children: T })
          ] }, V))
        }
      )
    ] }),
    e === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ o(ct, { children: x }),
      /* @__PURE__ */ o(
        sd,
        {
          availableBookInfo: r,
      ...
      children: [
        ...
        /* @__PURE__ */ o(
          ye,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ o(Ct, { value: `${w}`, children: l[W(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Qa = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  ) : /* @__PURE__ */ d(Ww, { children: [
    /* @__PURE__ */ o(Pa, { children: l.label }),
    /* @__PURE__ */ o(Jw, { children: /* @__PURE__ */ o($a, { children: Qa(
      e,
      t,
      Za(e, l.id),
      r
...
function gr({
  ...
  return /* @__PURE__ */ d(Ne, { variant: s, children: [
    /* @__PURE__ */ o(Be, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o($, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Xs, {}) }) }),
    /* @__PURE__ */ o(le, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(bo, { children: [
      /* @__PURE__ */ o(Va, { children: /* @__PURE__ */ o(Tt, { children: Qa(t.groups, t.items, c, e) }) }),
      w < p.length - 1 && /* @__PURE__ */ o(je, {})
    ] }, c)) })
  ] });
}
...
function ru({
  ...
  return /* @__PURE__ */ d(ts, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ o(
      gr,
      {
        onSelectMenuItem: e,
...
function ou({
  ...
  return /* @__PURE__ */ o(ts, { className: "tw-pointer-events-none", id: n, children: t && /* @__PURE__ */ o(
    gr,
    {
      onSelectMenuItem: e,
      menuData: t,
...
const ns = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Nt.List,
  {
    ref: n,
    className: h(
...
)), rs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Nt.Content,
  {
    ref: n,
    className: h(
...
function au({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(es, { children: [
      /* @__PURE__ */ o(ns, { children: e.map((l) => /* @__PURE__ */ o(id, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ o(rs, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function ld({ ...e }) {
...
const os = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  const a = b.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ o(Vr.Provider, { value: a, children: /* @__PURE__ */ o(
    ot.Root,
    {
      ref: r,
      className: h(
...
os.displayName = ot.Root.displayName;
...
as.displayName = ot.Trigger.displayName;
const ss = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    ot.SubTrigger,
    {
...
ss.displayName = ot.SubTrigger.displayName;
const is = b.forwardRef(({ className: e, ...t }, n) => {
  const r = Ot();
  return /* @__PURE__ */ o(
    ot.SubContent,
    {
...
is.displayName = ot.SubContent.displayName;
const ls = b.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: r = 8, ...a }, s) => {
  const i = Ot();
...
ls.displayName = ot.Content.displayName;
const ws = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = Ot();
  return /* @__PURE__ */ o(
    ot.Item,
    {
...
ws.displayName = ot.Item.displayName;
const cd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    ot.CheckboxItem,
    {
...
const dd = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    ot.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(ot.ItemIndicator, { children: /* @__PURE__ */ o(Tn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
...
const He = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(Pt, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        ws,
        {
          onClick: () => {
            r(w);
          ...
          children: [
            w.iconPathBefore && /* @__PURE__ */ o(Cn, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
            w.label,
            w.iconPathAfter && /* @__PURE__ */ o(Cn, { icon: w.iconPathAfter, menuLabel: w.label })
          ]
        },
        `menubar-item-${w.label}-${w.command}`
      ) : /* @__PURE__ */ d(wd, { children: [
        /* @__PURE__ */ o(ss, { children: w.label }),
        /* @__PURE__ */ o(is, { children: ds(
          e,
          t,
          Za(e, w.id),
          r
      ...
      w.tooltip && /* @__PURE__ */ o(St, { children: w.tooltip })
    ] }, `tooltip-${w.label}-${"command" in w ? w.command : w.id}`)), c = [...l];
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ o(cs, {}, `separator-${s}`)), c;
  });
};
function ud({
  menuData: e,
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), He(i, [f, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), He(l, [f, u]);
        break;
      case "alt+h":
        (k = c.current) == null || k.focus(), He(c, [f, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ o(os, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(ld, { children: [
      /* @__PURE__ */ o(as, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        ls,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Tt, { children: ds(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function lu({
  ...
  return /* @__PURE__ */ d("div", { id: c, className: h("pr-twp tw-max-w-sm", l), children: [
    ...
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(ct, { className: "tw-font-normal tw-text-muted-foreground", children: me(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, t)).join(", ") : e.en.autonym
    }) }) })
  ] });
}
function hd({ item: e, createLabel: t, createComplexLabel: n }) {
  ...
  return /* @__PURE__ */ d("div", { className: h("tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none"), children: [
    /* @__PURE__ */ d(
      $,
      {
        ...
        onClick: a,
        className: h("tw-me-2 tw-inline tw-h-4 tw-p-0 tw-text-start", r),
        children: [
          /* @__PURE__ */ o("span", { className: h({ "tw-me-2": i === "allText" }), children: t ? ii(e, t, s) : te(
            e,
      ...
      children: [
        /* @__PURE__ */ d("div", { className: h("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": t }), children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            /* @__PURE__ */ d(
              "div",
              {
                ...
                children: [
                  ...
                  f && /* @__PURE__ */ o("div", { className: "tw-flex tw-gap-2 tw-whitespace-normal tw-break-words", children: f }),
                  i && /* @__PURE__ */ o(
                    "div",
                    {
                      className: h(
            ...
            t && l && /* @__PURE__ */ o("div", { className: "tw-p-1", children: /* @__PURE__ */ d(Ne, { children: [
              /* @__PURE__ */ o(Be, { className: w, asChild: !0, children: /* @__PURE__ */ o($, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(No, {}) }) }),
              /* @__PURE__ */ o(le, { align: "end", children: l })
            ] }) })
          ] }),
...
const gd = rn(({ className: e, ...t }, n) => /* @__PURE__ */ o(qs, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
), vd = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const yd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
yd.displayName = "AlertDescription";
const uu = at.Root, mu = at.Trigger, hu = at.Group, fu = at.Portal, gu = at.Sub, bu = at.RadioGroup, Nd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  at.SubTrigger,
  {
    ref: a,
    className: h(
...
Nd.displayName = at.SubTrigger.displayName;
...
kd.displayName = at.SubContent.displayName;
const _d = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(at.Portal, { children: /* @__PURE__ */ o(
  at.Content,
  {
    ref: n,
    className: h(
...
_d.displayName = at.Content.displayName;
...
Cd.displayName = at.Item.displayName;
const Ed = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  at.CheckboxItem,
  {
    ref: a,
    className: h(
...
Ed.displayName = at.CheckboxItem.displayName;
const Td = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  at.RadioItem,
  {
    ref: r,
    className: h(
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(at.ItemIndicator, { children: /* @__PURE__ */ o(Tn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
...
Rd.displayName = at.Separator.displayName;
...
Dd.displayName = "ContextMenuShortcut";
...
function Md({
  ...
  return /* @__PURE__ */ o(ps.Provider, { value: r, children: /* @__PURE__ */ o(
    Mt.Root,
    {
...
const vu = Mt.Trigger, Od = Mt.Portal, xu = Mt.Close, us = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Mt.Overlay,
  {
    ref: n,
...
us.displayName = Mt.Overlay.displayName;
const Id = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Pd.displayName = Mt.Title.displayName;
...
$d.displayName = Mt.Description.displayName;
const Ld = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  sr.Root,
  {
    ref: r,
    className: h(
...
Ld.displayName = sr.Root.displayName;
function yu({
  className: e,
  ...t
}) {
...
function ku({
  ...
  return /* @__PURE__ */ o(
    yr.PanelResizeHandle,
    {
      ...
      ...n,
      children: e && /* @__PURE__ */ o("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ o(Js, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function _u({ ...e }) {
...
const Bd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ d(
    Xe.Root,
    {
...
Bd.displayName = Xe.Root.displayName;
const jd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    ir.Root,
    {
...
jd.displayName = ir.Root.displayName;
const Cu = Nt.Root, zd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    Nt.List,
    {
...
zd.displayName = Nt.List.displayName;
...
Fd.displayName = Nt.Trigger.displayName;
...
export {
  ...
  fc as DropdownMenuItemType,
  ln as DropdownMenuLabel,
  Jw as DropdownMenuPortal,
