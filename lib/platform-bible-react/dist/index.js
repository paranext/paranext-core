...
import { c as b, g as $e, a as Vr, C as er, L as Kn, t as ks, u as tn, T as Vt, b as bt, d as xt, e as yt, f as Hn, A as ba, r as se, D as je, h as Te, i as Fe, j as cr, k as We, B as et, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Je, p as De, q as Ts, s as qn, P as lr, v as Dr, w as dr, y as wr, z as Da, E as Ma, F as Eo, G as ur, H as Oa, J as $t, R as To, K as xa, M as io, N as so, O as co, Q as lo, S as Gn, U as da, V as So, W as Fr, X as Ur, Y as yr, Z as Ss, _ as ir, $ as Ze, a0 as Ue, a1 as Ye, a2 as kr, a3 as Ro, a4 as Do, a5 as ya, a6 as Mo, a7 as Wn, a8 as Rs, a9 as Ds, aa as Ms, ab as wo, ac as Yn, ad as Ia, ae as Os, af as Xn, ag as Is, ah as zs, ai as Ps, aj as en, ak as As, al as $s, am as Vs, an as Zn, ao as Jn, ap as Oo, aq as Ls, ar as Qn, as as Ka, at as rn, au as Ha, av as Bs, aw as js, ax as Fs, ay as Us, az as Ks, aA as Hs, aB as qs, aC as Gs, aD as Ws, aE as Io, aF as zo, aG as Ys, aH as Xs } from "./resizable-ehLO8YVZ.js";
import { aI as bf, aJ as xf, aK as yf, aL as kf, aM as _f, aN as Nf, aO as Cf, aP as Ef, aQ as Tf, aR as Sf, aS as Rf, aT as Df, aU as Mf, aV as Of, aW as If, aX as zf, aY as Pf, aZ as Af, a_ as $f, a$ as Vf, b0 as Lf, b1 as Bf, b2 as jf, b3 as Ff, b4 as Uf, b5 as Kf, b6 as Hf, b7 as qf, b8 as Gf, b9 as Wf, ba as Yf, bb as Xf, bc as Zf, bd as Jf, be as Qf, bf as tm, bg as em, bh as rm, bi as am } from "./resizable-ehLO8YVZ.js";
...
function Ya({
  ...
  const B = De(), U = dd(), [O, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [G, $] = _(
    void 0
    ...
    if (!M) return;
    const v = D.startsWith(`${M.book} `) ? D : "", q = na(v), lt = Ar(v);
    return {
      book: M.book,
  ...
  const { otLong: Tt, ntLong: Gt, dcLong: ar, extraLong: Ke } = {
    ...
    (v) => {
      ...
      const { isLetter: Ft, isDigit: Wt } = mn(v.key);
...
function hw(t, e, r = qi) {
  return Be(t.registerCommand(Il, (o) => {
    ...
    const s = function(i) {
      ...
      const c = i.anchor, d = i.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Gd(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let f = Pl();
...
const Fw = "verseText", vh = Object.freeze([
...
const Xw = {
  ...
  var gr;
  const [ot, I] = _({}), X = z ?? ot, G = X.editorState ?? Xw, $ = X.assignedUser, at = k !== void 0, ut = L(X);
  ut.current = X;
  const dt = V(
    (T) => {
...
function Lh({
  ...
  const [g, E] = _("generated"), [y, C] = _("generated"), [N, A] = _("*"), [B, U] = _("*"), [O, S] = _("f"), [D, W] = _(!1), [Y, z] = _(!0), [k, ot] = _(!1), I = L(!1), X = L(""), [G, $] = _(!1), [at, ut] = _(), [dt, tt] = _(), [pt, kt] = _(), [mt, Rt] = _(), jt = L(null), Pt = L(
    void 0
    ...
    qu,
    {
      ...
      children: /* @__PURE__ */ u(Wu, { children: [
        /* @__PURE__ */ u(Ln, { children: [
          ...
          /* @__PURE__ */ a(jn, { children: /* @__PURE__ */ a(Yu, { children: Object.entries(e).map(([g, E]) => /* @__PURE__ */ a(Xu, { children: /* @__PURE__ */ a(
            Ju,
            {
              onClick: () => p(g),
              isActive: x(g),
...
const qe = "scrBook", tp = "scrRef", nr = "source", ep = "details", rp = "Scripture Reference", ap = "Scripture Book", ls = "Type", op = "Details";
function np(t, e) {
  const r = e ?? !1;
  return [
    {
...
function dg({
  ...
  Z(() => {
    if (c) {
      ...
      if (D.length === 1) {
        const W = x.find((Y) => Fn(Y) === D[0]) || void 0;
        W && c(W);
      }
    }
  }, [f, x, c, E]);
...
function ug({
  ...
  const B = Ut(
  ...
  ] }), mt = e ? pt.filter((F) => e.includes(F.value)) : pt, Rt = g ?? Ga, jt = h ?? Rt, Pt = f ?? Rt, fe = () => {
    ...
    [r, n, g, s]
  ), Zt = mt.find((F) => F.value === t), ze = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? jc(jt, Pt, {
  ...
  const [He, Ba] = _(null), [Ae, fr] = _(null), [mr, ja] = _(null), Jr = 200, [Fa, Qr] = _(!1);
  Z(() => {
