...
var Ht = (t, e, n) => Ti(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as it } from "react/jsx-runtime";
import b, { forwardRef as zn, useRef as q, useMemo as z, useState as D, useCallback as G, useEffect as J, useLayoutEffect as te, createContext as hr, useContext as uo, Component as Si, createElement as Fo, Suspense as Ri, Fragment as mo } from "react";
import { Command as Jt } from "cmdk";
import { X as vn, Search as Ca, Check as Xt, Clock as zo, ChevronsLeft as Ko, ChevronsRight as qo, ChevronLeft as qr, ChevronRight as un, ArrowLeft as Ii, ArrowRight as Ea, Circle as gr, ChevronDown as Me, BoldIcon as Di, ItalicIcon as Oi, AtSign as Ta, Pencil as Mi, Trash2 as Ai, ArrowUp as Sa, MoreHorizontal as Pi, MailOpen as $i, Mail as ji, ChevronUp as Ra, FilterIcon as Li, ArrowLeftIcon as Vi, ChevronLeftIcon as Bi, ChevronRightIcon as Gi, ArrowRightIcon as Fi, Copy as Ia, Filter as Da, User as zi, Link as Ki, CircleHelp as qi, ChevronsUpDown as fo, Star as Hi, Undo as Ui, Redo as Yi, SquareX as Oa, FunctionSquare as Ma, SquareSigma as Aa, Ban as Xi, AlertCircle as Hr, CircleCheckIcon as Wi, CircleXIcon as Ji, CircleHelpIcon as Zi, ArrowUpIcon as Qi, ArrowDownIcon as tl, PanelLeft as el, PanelRight as nl, ScrollText as rl, MenuIcon as ol, Menu as al, EllipsisVertical as sl, MoreVertical as Ho, LoaderCircle as il, GripVertical as ll } from "lucide-react";
...
import { includes as Xn, Section as Q, getChaptersForBook as wl, formatScrRef as Ie, getSectionForBook as An, formatRelativeDate as pl, formatReplacementString as Qe, sanitizeHtml as ul, NumberFormat as ml, formatBytes as fl, getCurrentLocale as hl, usfmMarkers as tr, getFormatCallerFunction as gl, deepEqual as bl, isString as Uo, compareScrRefs as Ur, scrRefToBBBCCCVVV as Er, defaultScrRef as Tr, formatScrRefRange as vl, getLocalizeKeyForScrollGroupId as st } from "platform-bible-utils";
...
import { createEditor as $a, $getRoot as Ae, $createParagraphNode as yn, $getSelection as Wt, HISTORY_MERGE_TAG as ho, ParagraphNode as ja, TextNode as La, $isTokenOrSegmented as xl, $getCharacterOffsets as yl, $cloneWithPropertiesEphemeral as Nl, $getPreviousSelection as kl, $isRangeSelection as ye, $caretFromPoint as _l, $getSiblingCaret as Va, $getChildCaret as Cl, $getAdjacentChildCaret as El, $isChildCaret as Tl, $normalizeCaret as Sl, $setSelectionFromCaretRange as Rl, $getCollapsedCaretRange as Il, $getCaretInDirection as Yo, $splitAtPointCaretNext as Dl, $isTextPointCaret as Ol, $findMatchingParent as Ba, $isElementNode as De, mergeRegister as Pe, getDOMTextNode as Ml, isHTMLElement as Ga, CLEAR_EDITOR_COMMAND as Fa, COMMAND_PRIORITY_EDITOR as go, shallowMergeConfig as Al, defineExtension as ae, safeCast as on, createState as Pl, FORMAT_TEXT_COMMAND as za, $isNodeSelection as Ka, COMMAND_PRIORITY_LOW as qa, RootNode as $l, LineBreakNode as jl, TabNode as Ll, $isEditorState as Vl, createCommand as Bl, CLICK_COMMAND as Gl, isDOMNode as Fl, $getNodeFromDOMNode as zl, $createNodeSelection as Kl, $setSelection as ql, $getEditor as Hl, DecoratorNode as Yr, $getState as Ul, toggleTextFormatType as Xo, TEXT_TYPE_TO_FORMAT as Yl, $setState as Xl, addClassNamesToElement as Ha, $create as Wl, $getNodeByKey as Jl, removeClassNamesFromElement as Zl, KEY_TAB_COMMAND as Ql, $isBlockElementNode as or, $createRangeSelection as tc, $normalizeSelection__EXPERIMENTAL as ec, OUTDENT_CONTENT_COMMAND as nc, INDENT_CONTENT_COMMAND as Wo, INSERT_TAB_COMMAND as rc, COMMAND_PRIORITY_CRITICAL as bo, $isDecoratorNode as oc, $isParagraphNode as ac, $isTextNode as ar, SELECTION_CHANGE_COMMAND as Ua, getRegisteredNode as sc, isDocumentFragment as Jo, isDOMDocumentNode as ic, ArtificialNode__DO_NOT_USE as Ya, $createLineBreakNode as Xa, $isRootOrShadowRoot as lc, isBlockDomNode as Zo, isInlineDomNode as Qo, $insertNodes as cc } from "lexical";
import * as en from "@radix-ui/react-tooltip";
import { TooltipTrigger as dc } from "@radix-ui/react-tooltip";
import { HeadingNode as wc, QuoteNode as pc, registerRichText as uc } from "@lexical/rich-text";
import { flushSync as mc, createPortal as fc } from "react-dom";
...
import { useReactTable as Qa, getFilteredRowModel as bc, getSortedRowModel as ts, getPaginationRowModel as vc, getCoreRowModel as es, flexRender as Pn, getGroupedRowModel as xc, getExpandedRowModel as yc } from "@tanstack/react-table";
import * as kt from "@radix-ui/react-select";
import Nc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Xr, HIDDEN_NOTE_CALLER as Wr, getDefaultViewOptions as kc, isInsertEmbedOpOfType as Wn, Editorial as _c } from "@eten-tech-foundation/platform-editor";
import * as Jr from "@radix-ui/react-checkbox";
import * as Zt from "@radix-ui/react-tabs";
...
import { toast as bf } from "sonner";
import * as Mn from "@radix-ui/react-slider";
import * as Qr from "@radix-ui/react-switch";
const Tc = dl({ prefix: "tw-" });
function h(...t) {
  return Tc(cl(t));
}
const Kn = 250, ns = 300, xo = 400, Sc = 450, Rc = 500, Ic = 550, Dc = "layoutDirection";
function _t() {
  const t = localStorage.getItem(Dc);
  return t === "rtl" ? t : "ltr";
}
const to = ee.Root, sm = ee.Trigger, Oc = ee.Portal, im = ee.Close, rs = b.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  ee.Overlay,
  {
    ref: o,
    className: h(
...
sr.displayName = ee.Content.displayName;
...
lr.displayName = ee.Title.displayName;
...
Mc.displayName = ee.Description.displayName;
...
an.displayName = Jt.Input.displayName;
...
Ee.displayName = Jt.List.displayName;
const kn = b.forwardRef((t, e) => /* @__PURE__ */ r(Jt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
kn.displayName = Jt.Empty.displayName;
...
oe.displayName = Jt.Group.displayName;
...
vr.displayName = Jt.Separator.displayName;
...
se.displayName = Jt.Item.displayName;
...
const Te = mn.Root, Le = mn.Trigger, Pc = mn.Anchor, cs = b.createContext(null);
function Sr({
  container: t,
  children: e
}) {
...
function $c({
  ...
  return /* @__PURE__ */ p(Te, { open: w, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(pe, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ce, { children: /* @__PURE__ */ r(Ee, { children: /* @__PURE__ */ r(oe, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      se,
      {
        onSelect: () => f(u),
...
function lm(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function na({
  ...
  if (t)
    return /* @__PURE__ */ r(oe, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: xe(t) }, (l, d) => d + 1).map((l) => {
...
function Ir({
  ...
  const fe = G(() => {
    ...
    const _ = M;
    $(void 0), Y(void 0), _ ? (L(_), E("chapters"), k("")) : vt();
  }, [M, vt]), Rt = G((_) => {
    ...
    [w]
  ), We = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Sn = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Rn = G(
    (_) => {
              ...
              v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
                ...
                /* @__PURE__ */ r(
                  F,
                  {
                    ...
                    children: R === "ltr" ? /* @__PURE__ */ r(Ii, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ea, { className: "tw-h-4 tw-w-4" })
                  }
                ),
                  ...
                  !A && Object.entries(me).map(([_, U]) => {
                    if (U.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ r(oe, { heading: yt(_), children: U.map((Z) => /* @__PURE__ */ r(
                          is,
                          {
                            bookId: Z,
                            onSelect: (It) => B(It),
...
), Tt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Pa.Root, { ref: n, className: h("pr-twp", Fc(), t), ...e }));
    ...
    /* @__PURE__ */ r(
      pe,
      {
        ...
        children: /* @__PURE__ */ p(Ce, { children: [
          ...
          /* @__PURE__ */ r(Ee, { children: k(e) ? e.map((C) => /* @__PURE__ */ r(oe, { heading: C.groupHeading, children: C.options.map((v) => T(v, C.groupHeading)) }, C.groupHeading)) : e.map((C) => T(C)) })
        ] })
      }
    )
  ] });
...
const ps = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hc = ps ? te : J, Jn = { tag: ho };
function Uc({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, c = qc(null, o), w = $a({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (m) => i(m, w), theme: o });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (Wt() !== null || y !== null && y === m.getRootElement()) && g.select();
          }
        }, Jn);
...
const Yc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : J;
function Xc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = Se();
  return Yc(() => {
...
class Jc extends Si {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && Zc(e.resetKeys, a)) {
      var s, i;
...
const td = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : J;
function ed(t) {
...
const us = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ad = us && "documentMode" in document ? document.documentMode : null;
!(!us || !("InputEvent" in window) || ad) && "getTargetRanges" in new window.InputEvent("input");
function ve(t) {
  return `${t}px`;
}
const sd = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function id(t, e, n) {
  let o = null, a = null, s = null, i = [];
  const l = document.createElement("div");
  function d() {
    o === null && dr(182), a === null && dr(183);
    const { left: m, top: f } = a.getBoundingClientRect(), u = rd(t, e);
    var g, y;
    ...
    w.read(() => {
      ...
      if ((k || T) && S !== null && V !== null) {
        const C = function(v, E, P, L, M, $, H) {
          ...
          return Y.setStart(...oa(E, P, L)), Y.setEnd(...oa(M, $, H)), Y;
        }(t, f, g, S, u, N, V);
        d(), d = id(t, C, e);
      }
...
function dd(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? n !== null && (n(), n = null) : n === null && (n = cd(t, e));
  };
...
function pd(t) {
  const e = Wt() || kl();
  let n;
  if (ye(e)) n = _l(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), l = i[i.length - 1];
      l && (n = Va(l, "next"));
    }
    n = n || Cl(Ae(), "previous").getFlipped().insert(yn());
  }
  const o = ud(t, n), a = El(o), s = Tl(a) ? Sl(a) : o;
  return Rl(Il(s)), t.getLatest();
}
function ud(t, e, n) {
  let o = Yo(e, "next");
  for (let a = o; a; a = Dl(a, n)) o = a;
  return Ol(o) && dr(283), o.insert(t.isInline() ? yn().append(t) : t), Yo(Va(t.getLatest(), "next"), e.direction);
}
function md(t) {
  const e = Wt();
  if (!ye(e)) return !1;
...
let wr, Oe = 0, pr = 0, gd = 0, oo = 0, nr = 0;
function sa(t) {
  if (ot === void 0) return;
  let e = t.n;
...
Ut.prototype.brand = fd, Ut.prototype.h = function() {
  return !0;
...
} }), Je.prototype = new Ut(), Je.prototype.h = function() {
...
ae({ build: (t, e, n) => _n(e), config: on({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function gs() {
  const t = Ae(), e = Wt(), n = yn();
  t.clear(), t.append(n), e !== null && n.select(), ye(e) && (e.format = 0);
}
function bs(t, e = gs) {
  return t.registerCommand(Fa, (n) => (t.update(e), !0), go);
}
ae({ build: (t, e, n) => _n(e), config: on({ $onClear: gs }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const Mr = Pl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class vs extends Yr {
  $config() {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [vs], register: (t, e, n) => t.registerCommand(za, (o) => {
  const a = Wt();
  if (Ka(a) || ye(a)) for (const s of a.getNodes()) yd(s) && s.toggleFormat(o);
  return !1;
}, qa) });
function xs(t, e) {
  let n;
...
const ao = ae({ build: (t) => xs(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
class _d {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Al;
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || kd;
  }
  getPeerNameSet() {
...
const Ed = ae({ config: on({ setOptions: la, updateOptions: la }), init: ({ $initialEditorState: t = Cd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (Vl(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [$l, La, jl, Ll, ja] }), ca = Symbol.for("@lexical/extension/LexicalBuilder");
function da() {
}
function Td(t) {
  throw t;
...
class pn {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && wt(298, o.name), !a) {
      a = new _d(this, o), this.extensionNameMap.set(o.name, a);
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of l) {
      const { extension: m } = w;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of xd(m)) {
...
ae({ dependencies: [ao, wa], name: "@lexical/extension/HorizontalRule", nodes: () => [fn], register(t, e, n) {
  ...
  return Pe(t.registerCommand(Rd, (i) => {
    const l = Wt();
    if (!ye(l)) return !1;
    ...
    return !0;
  }, go), t.registerCommand(Gl, (i) => {
    if (Fl(i.target)) {
      const l = zl(i.target);
      if (Dd(l)) return function(d, c = !1) {
        const w = Wt(), m = d.isSelected(), f = d.getKey();
        let u;
        c && Ka(w) ? u = w : (u = Kl(), ql(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(Ne(() => {
      const c = l.value;
      c && (d.value ? Ha(c, s) : Zl(c, s));
    }));
    return Pe(...i);
  }));
} });
ae({ build: (t, e) => _n({ inheritEditableFromParent: e.inheritEditableFromParent }), config: on({ $getParentEditor: function() {
  const t = Hl();
...
ae({ build: (t, e, n) => _n(e), config: on({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, n) => {
  const o = n.getOutput();
  return Ne(() => {
...
function Od(t, e, n = _s) {
  return Pe(t.registerCommand(Ql, (o) => {
    const a = Wt();
    if (!ye(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((f) => or(f) && f.canIndent()).length > 0) return !0;
      const l = i.anchor, d = i.focus, c = d.isBefore(l) ? d : l, w = c.getNode(), m = wd(w);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = tc();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = ec(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? nc : Wo : rc;
    return t.dispatchCommand(s, void 0);
  }, go), t.registerCommand(Wo, () => {
    const o = typeof e == "number" ? e : e ? e.peek() : null, a = Wt();
    if (!ye(a)) return !1;
...
ae({ build: (t, e, n) => _n(e), config: on({ $canIndent: _s, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return Ne(() => {
    if (!o.value) return Od(t, a, s);
  });
} });
const Md = ae({ name: "@lexical/react/ReactProvider" });
function Ad() {
...
ae({ build: (t, e, n) => _n(e), config: on({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => Ne(() => n.getOutput().disabled.value ? void 0 : Es(t)) });
function jd(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return Ro(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const c = l[d], w = r(o, { onError: (f) => n._onError(f), children: r(Ri, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(fc(w, m, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function Vd({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(Md.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && jd(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(Ld, { editor: t, ErrorBoundary: e });
}
function pa(t) {
  return t.getEditorState().read(Cs(t.isComposing()));
}
function Bd({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Se();
  return function(a) {
    Ro(() => Pe(uc(a), Es(a)), [a]);
  }(o), p(it, { children: [t, r(Gd, { content: e }), r(Vd, { editor: o, ErrorBoundary: n })] });
}
...
const zd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : J;
function Kd({ onClear: t }) {
  const [e] = Se();
  return zd(() => bs(e, t), [e, t]), null;
}
const Ts = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : J;
function qd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: c, ariaMultiline: w, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: N = !0, style: R, tabIndex: I, "data-testid": S, ...V }, k) {
...
function Yd(t, e) {
  ...
  return p(it, { children: [r(Hd, { editor: a, ...o, ref: e }), n != null && r(Xd, { editor: a, content: n })] });
}
...
function Qd({
  ...
  const [e] = Se(), [n, o] = D(e), [a, s] = D("paragraph"), [i, l] = Zd(), d = () => {
  };
...
ew.displayName = Wa.Root.displayName;
...
const ma = [
  { format: "bold", icon: Di, label: "Bold" },
...
function ow({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Qd, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(nw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        Bd,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(Wd, { placeholder: t }) }),
          ErrorBoundary: Qc
        }
      ),
...
function sw(t, e) {
  const n = ic(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
...
function Os(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && ar(e) && (i = od(o, e, "clone"));
  const l = De(i) ? i.getChildren() : [], d = sc(t, i.getType());
  let c;
...
function As(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let f = [];
  const u = (l == null || !lc(l)) && (l != null && or(l) || o);
  for (let g = 0; g < m.length; g++) f.push(...As(m[g], e, n, u, new Map(a), l));
  return w != null && (f = w(f)), Zo(t) && (f = lw(t, f, u ? () => {
    const g = new Ya();
    return n.push(g), g;
...
function pm({
  ...
  const [a, s] = D(dw), [i, l] = D(void 0), [d, c] = D(!1), w = q(void 0), m = q(null);
  J(() => {
    let N = !0;
    const R = m.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Oo(N) && (N.preventDefault(), N.stopPropagation(), le(a) && f());
        },
        onKeyDown: (N) => {
...
const um = Object.freeze([
...
], ww = ["input", "select", "textarea", "button"], pw = ["button", "textbox"], uw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
  ...
  const a = q(null), [s, i] = D(void 0), [l, d] = D(void 0), c = G(
    ...
    if (u.isContentEditable || ww.includes(g)) return !0;
    const y = u.getAttribute("role");
    if (y && pw.includes(y)) return !0;
...
const gw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
vw.displayName = Nn.Image.displayName;
...
}), $e = mt.Trigger, Gs = mt.Group, xw = mt.Portal, yw = mt.Sub, Nw = mt.RadioGroup;
...
const ce = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = _t(), i = ue();
  return /* @__PURE__ */ p(
    mt.CheckboxItem,
    {
      ...
      dir: s,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(mt.ItemIndicator, { children: /* @__PURE__ */ r(Xt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
ce.displayName = mt.CheckboxItem.displayName;
...
const He = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  mt.Label,
  {
    ref: o,
...
He.displayName = mt.Label.displayName;
...
function fa({
  ...
  const u = G(
    ...
    [t.user]
  ), R = z(() => ul(t.contents), [t.contents]), I = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ p(
          qe,
          {
            onClick: (S) => {
              S.stopPropagation(), c(!0), m(cw(t.contents)), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), u()) : Oo(S) && (S.preventDefault(), S.stopPropagation(), le(w) && g());
              },
              onKeyDown: (S) => {
        ...
        I && /* @__PURE__ */ p(_e, { children: [
          /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Pi, {}) }) }),
...
function _w({
  ...
  const [T, C] = D(ha), [v, E] = D(
    void 0
  ), P = o, [L, M] = D(!1), [$, H] = D(!1), [Y, tt] = D(!1), [St, Ft] = D(!1), [jt, lt] = D(!1), [gt, K] = D(S), [nt, ct] = D(!1), rt = q(void 0), [at, zt] = D(/* @__PURE__ */ new Map());
  J(() => {
    let O = !0;
    return (async () => {
  ...
  const Kt = z(() => Ot[0], [Ot]), me = q(null), A = q(void 0), Qt = G(() => {
    var O;
  ...
  }, [s, n]), X = z(() => Ot.slice(1), [Ot]), et = z(() => X.length ?? 0, [X.length]), dt = z(() => et > 0, [et]), vt = z(() => L || et <= 2 ? X : X.slice(-2), [X, et, L]), xt = z(() => L || et <= 2 ? 0 : et - 2, [et, L]), Rt = z(
    () => et === 1 ? Mt.singleReply : Qe(Mt.multipleReplies, { count: et }),
    [et, Mt]
  ), bt = z(
    () => xt === 1 ? Mt.singleReply : Qe(Mt.multipleReplies, { count: xt }),
    [xt, Mt]
  );
  J(() => {
    !o && $ && dt && H(!1);
  ...
  const Ct = G(
    async (O) => {
      ...
      yt && await m({ threadId: d, contents: yt }) && Qt();
    },
    [
      Qt,
      T,
    ...
    async (O) => {
      const yt = le(T) ? mr(T) : void 0, ut = await m({
        ...O,
        contents: yt,
        assignedUser: v ?? O.assignedUser
      });
      return ut && yt && Qt(), ut && v !== void 0 && E(void 0), ut;
    },
    [Qt, T, m, v]
  );
  if (Kt)
            ...
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              ...
              /* @__PURE__ */ r(
                F,
                {
                  ...
                  children: gt ? /* @__PURE__ */ r($i, {}) : /* @__PURE__ */ r(ji, {})
                }
              ),
              jt && w !== "Resolved" && /* @__PURE__ */ r(
                F,
                {
                  ...
                  children: /* @__PURE__ */ r(Xt, { className: "tw-h-4 tw-w-4" })
                }
              )
            ] }),
            ...
            o && /* @__PURE__ */ p(it, { children: [
              ...
              x !== !1 && (!$ || le(T)) && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  onKeyDownCapture: (O) => {
                    Oo(O) && (O.preventDefault(), O.stopPropagation(), (le(T) || v !== void 0) && Ct());
                  },
                  onKeyDown: (O) => {
...
function fm({
  ...
  const V = n.filter(
    ...
    [N, y]
  ), { listboxRef: v, activeId: E, handleKeyDown: P } = uw({
    options: k,
    onOptionSelect: T
  }), L = G(
    (M) => {
...
function Cw({ table: t }) {
  return /* @__PURE__ */ p(_e, { children: [
    /* @__PURE__ */ r(gc, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Li, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const gn = kt.Root, Ew = kt.Group, bn = kt.Value, Tw = Ue(
...
Sw.displayName = kt.Label.displayName;
const re = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  kt.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(kt.ItemIndicator, { children: /* @__PURE__ */ r(Xt, { className: "tw-h-4 tw-w-4" }) }) }),
...
Rw.displayName = kt.Separator.displayName;
function Iw({ table: t }) {
  ...
  const l = b.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Pw(u, g, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Aw(l, y, w.key);
...
function hm({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Nc, { options: s, children: e })
    }
  );
}
...
function vm({ id: t, label: e, groups: n }) {
  const [o, a] = D(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(_e, { children: [
    ...
    /* @__PURE__ */ r(de, { children: n.map((c, w) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(He, { children: c.label }),
...
function ym({
  ...
  const i = z(() => fl(n), [n]), d = ((c) => {
    const w = new Intl.DisplayNames(hl(), { type: "language" });
        ...
        /* @__PURE__ */ r(oe, { children: V.map((E) => /* @__PURE__ */ p(
          se,
          {
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ r(Hi, { className: "tw-h-4 tw-w-4" }),
...
const Hw = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(it, { children: [
...
function Uw({
  ...
  return /* @__PURE__ */ p(_e, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Bt, { children: [
      /* @__PURE__ */ r(Gt, { asChild: !0, children: /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Hw(t, a, n) }) }) }),
    ...
    /* @__PURE__ */ p(
      de,
      {
        ...
        children: [
          /* @__PURE__ */ r(He, { children: a["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ r(je, {}),
          /* @__PURE__ */ r(
            ce,
            {
...
const Yw = (t, e) => t === "f" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ r(Ma, {}),
  " ",
...
function Ww({
  ...
  return /* @__PURE__ */ p(_e, { children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Bt, { children: [
      /* @__PURE__ */ r(dc, { asChild: !0, children: /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Yw(t, n) }) }) }),
      /* @__PURE__ */ r($t, { children: /* @__PURE__ */ r("p", { children: Xw(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(de, { style: { zIndex: ns }, children: [
      /* @__PURE__ */ r(He, { children: n["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ r(je, {}),
      /* @__PURE__ */ p(
        ce,
        {
...
function xa({
  ...
  return /* @__PURE__ */ p(
    se,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Zw, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
...
function Qw({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = D(""), [s, i] = z(() => {
...
function km({
  ...
  const [g, y] = D("generated"), [x, N] = D("*"), [R, I] = D("f"), [S, V] = D(!1), [k, T] = D(!0), [C, v] = D(!1), E = q(!1), P = q(""), [L, M] = D(!1), [$, H] = D(), [Y, tt] = D(), [St, Ft] = D(), [jt, lt] = D(), gt = q(null), K = z(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...i.view ?? kc(), noteMode: "expanded" }
    }),
    [i, l]
  ), nt = z(
    () => tp(
  ...
  const Ot = () => {
    ...
    if (X && Wn("note", X)) {
      ...
      R !== "x" && B === "x" ? bt == null || bt.forEach((Ct) => ep(Ct)) : R === "x" && B !== "x" && (bt == null || bt.forEach((Ct) => np(Ct))), (Rt = w.current) == null || Rt.applyUpdate([X, { delete: 1 }]);
    }
  }, Qt = (B) => {
  ...
  return J(() => {
    ...
    const B = ((et = m.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, X = (dt) => {
      !L && B && document.activeElement === B && dt.key === l ? (dt.preventDefault(), Mt()) : L && dt.key === "Escape" && (dt.preventDefault(), M(!1));
    };
    return document.addEventListener("keydown", X), () => {
      document.removeEventListener("keydown", X);
    };
  }, [L, Mt, l]), /* @__PURE__ */ p(it, { children: [
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(qw, { editorRef: w, children: /* @__PURE__ */ r(
              _c,
              {
                options: K,
                onStateChange: Qt,
  ...
  return /* @__PURE__ */ p(it, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(it, { children: op(t.marker, l, o, c) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ r(kr, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Re,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(tn, { className: o, children: ip(l.text) })
        ]
      },
...
const cp = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(Qi, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
  ...
  return e ? e[1] : "";
}, wp = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Om = Object.freeze([
...
function Mm({
  ...
  const u = be(n, "%webView_inventory_all%"), g = be(n, "%webView_inventory_approved%"), y = be(n, "%webView_inventory_unapproved%"), x = be(n, "%webView_inventory_unknown%"), N = be(n, "%webView_inventory_scope_currentBook%"), R = be(n, "%webView_inventory_scope_chapter%"), I = be(n, "%webView_inventory_scope_verse%"), S = be(n, "%webView_inventory_filter_text%"), V = be(
    n,
    "%webView_inventory_show_additional_items%"
  ), k = be(n, "%webView_inventory_no_results%"), [T, C] = D(!1), [v, E] = D("all"), [P, L] = D(""), [M, $] = D([]), H = z(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : up(K, a, s);
  }, [t, a, s]), Y = z(() => {
    if (T) return H;
    const K = [];
    return H.forEach((nt) => {
  ...
  }, [T, H]), tt = z(() => Y.length === 0 ? [] : pp(Y, v, P), [Y, v, P]), St = z(() => {
    var ct, rt;
    if (!T) return d;
...
function vp({ scrollGroupId: t, isBoundButClosed: e }) {
  const n = Fn(t);
  return e ? /* @__PURE__ */ r(
    ke,
    {
...
function xp({ row: t, mode: e, strings: n, onClick: o, onOpen: a }) {
  const s = !!(t.language || t.languageCode), i = /* @__PURE__ */ r(Xt, { className: h("tw-h-4 tw-w-4", t.isSelected ? "tw-opacity-100" : "tw-opacity-0") });
  let l = null;
...
function yp({
  ...
  return /* @__PURE__ */ p(_e, { children: [
    ...
    /* @__PURE__ */ p(de, { align: "end", className: "tw-w-56", style: { zIndex: xo }, children: [
      /* @__PURE__ */ r(He, { children: a.groupSectionLabel }),
      /* @__PURE__ */ r(
        ce,
        {
          checked: t,
      ...
      o && /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ r(je, {}),
        /* @__PURE__ */ r(He, { children: a.filterSectionLabel }),
        /* @__PURE__ */ r(
          ce,
          {
            checked: !!n,
...
function Am(t) {
  const [e, n] = D(!1), [o, a] = D(""), [s, i] = D(t.defaultGroupByOpenTabs ?? !0), [l, d] = D(!1), c = gp(t.localizedStrings), w = z(() => t.mode === "project" ? Br({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
        ...
        children: /* @__PURE__ */ r(Pt, { delayDuration: 200, children: /* @__PURE__ */ p(Ce, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ p(Ee, { children: [
            ...
            f.map((k, T) => /* @__PURE__ */ p(mo, { children: [
              /* @__PURE__ */ r(oe, { heading: Np(k, c), children: k.rows.map((C) => /* @__PURE__ */ r(
                xp,
                {
                  row: C,
                  mode: t.mode,
...
const kp = "16rem", _p = "3rem", Ys = b.createContext(void 0);
function Cr() {
...
const Cp = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Cr();
  return /* @__PURE__ */ p(
    F,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(el, {}) : /* @__PURE__ */ r(nl, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
Cp.displayName = "SidebarTrigger";
...
Ip.displayName = "SidebarSeparator";
...
const Dp = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? xn : "button",
  {
    ref: o,
...
Dp.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const d = t ? xn : "button", { state: c } = Cr(), w = /* @__PURE__ */ r(
      d,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: h(Op({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Mp = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? xn : "button",
  {
    ref: a,
...
Mp.displayName = "SidebarMenuAction";
...
Ap.displayName = "SidebarMenuBadge";
const Pp = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Pp.displayName = "SidebarMenuSkeleton";
...
$p.displayName = "SidebarMenuSub";
const jp = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
jp.displayName = "SidebarMenuSubItem";
const Lp = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? xn : "a",
  {
    ref: s,
...
const ze = "scrBook", Bp = "scrRef", Ze = "source", Gp = "details", Fp = "Scripture Reference", zp = "Scripture Book", ni = "Type", Kp = "Details";
function qp(t, e) {
  const n = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: Gp,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Kp,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, ka = (t) => `${Hp({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function $m({
  sources: t,
  ...
  J(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const P = y.find((L) => ka(L) === E[0]) || void 0;
        P && l(P);
      }
    }
  }, [u, y, l, N]);
  const R = a ?? zp, I = s ?? ni, S = [
    ...
    !e && /* @__PURE__ */ p(
      gn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(rn, { position: "item-aligned", children: /* @__PURE__ */ r(Ew, { children: S.map((v) => /* @__PURE__ */ r(re, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
...
function Lm({
  ...
  const S = At(
  ...
  ], K = (j, W, Yt = !1) => /* @__PURE__ */ p(it, { children: [
    j,
    W && !Yt && /* @__PURE__ */ p("span", { className: "tw-text-muted-foreground", children: [
      ": ",
      W
    ] })
  ] }), nt = e ? gt.filter((j) => e.includes(j.value)) : gt, ct = g ?? Tr, rt = w ?? ct, at = m ?? ct, zt = () => {
  }, Ot = q(null), Kt = q(null), me = q(!1), A = q(null), Qt = q(!1), [fe, Mt] = D(void 0), B = q(!1), X = q(!1), et = q(null), dt = G((j) => {
    if (j) {
    ...
    [n, a, g, s]
  ), Ct = nt.find((j) => j.value === t), Lt = () => t === "selectedBooks" && a.length > 0 ? a.map((j) => j.toUpperCase()).join(", ") : t === "range" ? vl(rt, at, {
  ...
  ), yt = nt.find((j) => j.value === "selectedBooks"), ut = nt.find((j) => j.value === "range"), [Be, Ye] = D(!1), [Xe, sn] = D(void 0), [Ge, En] = D(void 0), [Fe, Tn] = D(void 0), [We, Sn] = D(void 0), [Rn, qn] = D([]), Hn = c === "dropdown" && Xe === "selectedBooks", _ = /* @__PURE__ */ r(
    Yp,
    {
      availableBookInfo: o,
  ...
  ), U = fe === "end", Z = fe === "start", It = "tw-text-muted-foreground", ne = c === "dropdown" && Xe === "range", ln = ne ? Tn : xt, cn = ne ? Sn : u ? Rt : zt, Vt = /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-wrap tw-items-end tw-gap-4", children: [
  ...
  const Lo = G(
    (j) => {
      En(j), Tn(rt), Sn(at), qn(a), Ye(!1), sn(j);
    },
    [rt, at, a]
  ), Vo = G(() => {
    Ge !== void 0 && (Ge === "range" ? (Fe && (f == null || f(Fe)), We && (u == null || u(We))) : Ge === "selectedBooks" && s(Rn), bt(Ge), sn(void 0), En(void 0));
  }, [
    Ge,
    Fe,
    We,
    ...
    j || (sn(void 0), En(void 0));
  }, []), Bo = G((j) => {
    var W;
    j.preventDefault(), (W = Nt.current) == null || W.focus();
  }, []), Go = (j) => t === j ? /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Xt, { className: "tw-h-4 tw-w-4" }) }) : void 0;
  return /* @__PURE__ */ p("div", { id: d, className: "tw-grid tw-gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      !R && /* @__PURE__ */ r(Tt, { children: L }),
      c === "dropdown" ? /* @__PURE__ */ p(_e, { open: Be, onOpenChange: Ye, children: [
        ...
        /* @__PURE__ */ r(
          de,
          {
            ...
            children: /* @__PURE__ */ p(Sr, { container: Un, children: [
              O.map(({ value: j, label: W, dropdownLabel: Yt, scrRefSuffix: In, id: Ci }) => /* @__PURE__ */ p(
                qe,
                {
                  ref: Dt(j),
                  ...
                  children: [
                    t === j && /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Xt, { className: "tw-h-4 tw-w-4" }) }),
                    K(Yt ?? W, In, ki)
                  ]
                },
                Ci
              ...
              y && /* @__PURE__ */ p(it, { children: [
                /* @__PURE__ */ r(je, {}),
                /* @__PURE__ */ r(He, { className: "tw-px-2 tw-py-1.5 tw-text-xs tw-font-medium tw-text-muted-foreground", children: jt }),
                /* @__PURE__ */ r(
                  qe,
                  {
                    ref: A,
                    ...
                    onSelect: (j) => {
                      ...
                      Qt.current || (Yt = (W = Kt.current) == null ? void 0 : W.querySelector("button")) == null || Yt.click();
                    },
                    children: /* @__PURE__ */ r(
                      "div",
                      {
        ...
        ko,
        {
          ...
          children: nt.map(({ value: j, label: W, scrRefSuffix: Yt, id: In }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(cr, { className: "tw-me-2", value: j, id: In }),
    ...
    c === "radio" && t === "range" && Vt,
    c === "dropdown" && yt && /* @__PURE__ */ r(to, { open: Xe === "selectedBooks", onOpenChange: Yn, children: /* @__PURE__ */ r(
      sr,
      {
        ref: xi,
        onCloseAutoFocus: Bo,
        onEscapeKeyDown: (j) => {
          ge != null && ge.querySelector('[data-state="open"]') && j.preventDefault();
        },
    ...
    c === "dropdown" && ut && /* @__PURE__ */ r(to, { open: Xe === "range", onOpenChange: Yn, children: /* @__PURE__ */ r(
      sr,
      {
        ref: he,
        onCloseAutoFocus: Bo,
...
const ai = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Gt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r(xw, { children: /* @__PURE__ */ r(zs, { children: ai(
      t,
      e,
      oi(t, l.id),
      o
...
function po({
  ...
  return /* @__PURE__ */ p(_e, { variant: s, children: [
    /* @__PURE__ */ r($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(ol, {}) }) }),
...
ii.displayName = Zt.List.displayName;
...
li.displayName = Zt.List.displayName;
...
ci.displayName = Zt.Content.displayName;
function qm({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(ii, { children: [
      /* @__PURE__ */ r(li, { children: t.map((l) => /* @__PURE__ */ r(Wp, { value: l.value, children: l.value }, l.key)) }),
...
const Qp = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = ue();
  return /* @__PURE__ */ p(
    ft.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ft.ItemIndicator, { children: /* @__PURE__ */ r(Xt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Qp.displayName = ft.CheckboxItem.displayName;
const tu = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ue();
  return /* @__PURE__ */ p(
    ft.RadioItem,
    {
...
tu.displayName = ft.RadioItem.displayName;
const eu = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ft.Label,
  {
    ref: o,
    className: h("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
eu.displayName = ft.Label.displayName;
...
function nu({
  ...
  if (Cc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, m) => {
    ...
    return /* @__PURE__ */ r(di, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, m]) => typeof w == "boolean" || typeof m == "boolean" ? 0 : w.order - m.order).map(([w, m]) => /* @__PURE__ */ p(Jp, { children: [
...
function ou({ item: t, createLabel: e, createComplexLabel: n }) {
...
const au = zn(({ className: t, ...e }, n) => /* @__PURE__ */ r(il, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
au.displayName = "Spinner";
function Zm({
  id: t,
  isDisabled: e = !1,
  hasError: n = !1,
...
), iu = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
iu.displayName = "Alert";
const lu = b.forwardRef(
...
lu.displayName = "AlertTitle";
const cu = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
cu.displayName = "AlertDescription";
const Qm = ht.Root, tf = ht.Trigger, ef = ht.Group, nf = ht.Portal, rf = ht.Sub, of = ht.RadioGroup, du = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ht.SubTrigger,
  {
    ref: a,
    className: h(
...
du.displayName = ht.SubTrigger.displayName;
...
wu.displayName = ht.SubContent.displayName;
const pu = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ht.Portal, { children: /* @__PURE__ */ r(
  ht.Content,
  {
    ref: n,
    className: h(
...
pu.displayName = ht.Content.displayName;
...
uu.displayName = ht.Item.displayName;
const mu = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ht.CheckboxItem,
  {
    ref: a,
    className: h(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ht.ItemIndicator, { children: /* @__PURE__ */ r(Xt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
mu.displayName = ht.CheckboxItem.displayName;
const fu = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ht.RadioItem,
  {
    ref: o,
    className: h(
...
fu.displayName = ht.RadioItem.displayName;
const hu = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ht.Label,
  {
    ref: o,
    className: h(
...
hu.displayName = ht.Label.displayName;
...
gu.displayName = ht.Separator.displayName;
...
bu.displayName = "ContextMenuShortcut";
...
vu.displayName = "Drawer";
const af = we.Trigger, xu = we.Portal, sf = we.Close, vi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  we.Overlay,
  {
    ref: n,
...
const yu = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
_u.displayName = we.Title.displayName;
...
Cu.displayName = we.Description.displayName;
const Eu = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Zr.Root,
  {
    ref: o,
    className: h(
...
Eu.displayName = Zr.Root.displayName;
function lf({
  className: t,
  ...e
}) {
...
function df({
  ...
  return /* @__PURE__ */ r(
    vo.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(ll, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function wf({ ...t }) {
...
const Tu = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ p(
    Mn.Root,
    {
...
Tu.displayName = Mn.Root.displayName;
...
const pf = Zt.Root, Ru = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ r(
    Zt.List,
    {
...
Ru.displayName = Zt.List.displayName;
...
Iu.displayName = Zt.Trigger.displayName;
...
Du.displayName = Zt.Content.displayName;
const Ou = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
      className: h(
...
export {
  iu as Alert,
  cu as AlertDescription,
  lu as AlertTitle,
  Vs as Avatar,
  Bs as AvatarFallback,
  vw as AvatarImage,
  cm as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  dm as BOOK_SELECTOR_STRING_KEYS,
  ke as Badge,
  Ir as BookChapterControl,
  ro as BookSelectionMode,
  wm as BookSelector,
  F as Button,
  um as COMMENT_EDITOR_STRING_KEYS,
  mm as COMMENT_LIST_STRING_KEYS,
  js as Card,
  Ls as CardContent,
  ...
  fm as CommentList,
  Qm as ContextMenu,
  mu as ContextMenuCheckboxItem,
  pu as ContextMenuContent,
  ef as ContextMenuGroup,
  uu as ContextMenuItem,
  hu as ContextMenuLabel,
  nf as ContextMenuPortal,
  of as ContextMenuRadioGroup,
  fu as ContextMenuRadioItem,
  gu as ContextMenuSeparator,
  bu as ContextMenuShortcut,
  rf as ContextMenuSub,
  wu as ContextMenuSubContent,
  du as ContextMenuSubTrigger,
  tf as ContextMenuTrigger,
  jw as DataTable,
  to as Dialog,
  im as DialogClose,
  sr as DialogContent,
  ...
  gm as ERROR_POPOVER_STRING_KEYS,
  qw as EditorKeyboardShortcuts,
  Vw as ErrorDump,
  bm as ErrorPopover,
  _m as FOOTNOTE_EDITOR_STRING_KEYS,
  Nm as Filter,
  vm as FilterDropdown,
  ym as Footer,
  km as FootnoteEditor,
  sp as FootnoteItem,
  Cm as FootnoteList,
  ...
  Mm as Inventory,
  Tt as Label,
  Wm as LinkedScrRefButton,
  Jw as MARKER_MENU_STRING_KEYS,
  hm as MarkdownRenderer,
  Qw as MarkerMenu,
  xm as MoreInfo,
  Fw as MultiSelectComboBox,
  qm as NavigationContentSearch,
  Te as Popover,
  Pc as PopoverAnchor,
  ...
  Jm as ResultsCard,
  jm as SCOPE_SELECTOR_STRING_KEYS,
  Lm as ScopeSelector,
  $m as ScriptureResultsViewer,
  Vm as ScrollGroupSelector,
  $o as SearchBar,
  gn as Select,
  rn as SelectContent,
  Ew as SelectGroup,
  ...
  hn as Separator,
  Bm as SettingsList,
  Fm as SettingsListHeader,
  Gm as SettingsListItem,
  Vp as SettingsSidebar,
  Pm as SettingsSidebarContentSearch,
  Ws as Sidebar,
  ...
  Ym as UiLanguageSelector,
  Kw as UndoRedoButtons,
  ii as VerticalTabs,
  ...
  Rc as Z_INDEX_MODAL,
  Sc as Z_INDEX_MODAL_BACKDROP,
  xo as Z_INDEX_OVERLAY,
  mw as badgeVariants,
  ls as buttonVariants,
  h as cn,
  Br as computeRows,
  Dm as getBookIdFromUSFM,
  _r as getInventoryHeader,
  Rm as getLinesFromUSFM,
  Im as getNumberFromUSFM,
  wp as getStatusForItem,
  Hm as getToolbarOSReservedSpaceClassName,
  Tm as inventoryCountColumn,
  Em as inventoryItemColumn,
  Sm as inventoryStatusColumn,
  fp as partitionAndSort,
