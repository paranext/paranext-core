...
var At = (t, e, r) => Vi(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Bt, Z as Li, B, c as f, a as Fi, C as Ae, P as Pe, b as Ke, d as Ie, e as qe, f as Ge, g as xe, h as Er, i as ea, T as ie, S as or, j as se, k as ce, l as le, D as Je, m as kr, n as Me, o as Oe, p as $e, u as ji, q as Tr, s as Ze, t as je, v as Sa, w as ln, x as Bi, y as Ui, z as dn, A as wn, E as Ki, F as qi, G as Gi, H as Hi, I as wa, J as ua, K as wr, L as Yi, M as Wi, N as Xi, O as Ji, Q as Zi, R as zr, U as Ha } from "./resizable-CUvCloPJ.js";
import { V as Wh, W as Xh, X as Jh, Y as Zh, _ as Qh, $ as tg, a0 as eg, a1 as rg, a2 as ag } from "./resizable-CUvCloPJ.js";
import { jsx as a, jsxs as u, Fragment as ot } from "react/jsx-runtime";
import { Canon as ht } from "@sillsdev/scripture";
import { includes as Ar, Section as tt, getChaptersForBook as Qi, formatScrRef as Se, getSectionForBook as br, formatRelativeDate as ts, formatReplacementString as ze, sanitizeHtml as es, NumberFormat as rs, formatBytes as as, getCurrentLocale as os, usfmMarkers as jr, getFormatCallerFunction as ns, deepEqual as is, isString as vo, compareScrRefs as Da, scrRefToBBBCCCVVV as pa, defaultScrRef as ha, formatScrRefRange as ss, getLocalizeKeyForScrollGroupId as bo } from "platform-bible-utils";
import { Check as Be, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as Ma, ChevronRight as Oa, ArrowLeft as cs, ArrowRight as ls, ChevronDown as nr, BoldIcon as ds, ItalicIcon as ws, X as ra, AtSign as un, Pencil as us, Trash2 as ps, ArrowUp as pn, MoreHorizontal as hs, MailOpen as gs, Mail as fs, ChevronUp as ms, FilterIcon as vs, ArrowLeftIcon as bs, ChevronLeftIcon as xs, ChevronRightIcon as ys, ArrowRightIcon as ks, Copy as hn, Filter as _s, User as Ns, Link as Cs, CircleHelp as Es, ChevronsUpDown as gn, Star as Ts, Undo as zs, Redo as Ss, SquareX as fn, FunctionSquare as mn, SquareSigma as vn, Ban as Ds, AlertCircle as $a, CircleCheckIcon as Ms, CircleXIcon as Os, CircleHelpIcon as $s, ArrowUpIcon as Rs, ArrowDownIcon as As, Search as Ps, LoaderCircle as Is, ScrollText as Vs, MenuIcon as Ls, Menu as Fs, EllipsisVertical as js, MoreVertical as _o } from "lucide-react";
import ft, { useRef as j, useMemo as F, useState as C, useCallback as L, useEffect as H, useLayoutEffect as Ft, createContext as Ya, useContext as bn, Component as Bs, createElement as No, Suspense as Us, forwardRef as aa, Fragment as xn } from "react";
import { Dialog as ye, Label as Ks, RadioGroup as Ra, ToggleGroup as yn, Slot as ur, Avatar as Wa, Select as It, Checkbox as Co, Tabs as fe, Menubar as Ne, ContextMenu as Ot, Progress as Eo, Slider as Pr, Switch as To } from "radix-ui";
import { createEditor as kn, $getRoot as Ue, $createParagraphNode as Sr, $getSelection as jt, HISTORY_MERGE_TAG as Xa, ParagraphNode as _n, TextNode as Nn, $getPreviousSelection as qs, $isRangeSelection as ke, $caretFromPoint as Gs, $getSiblingCaret as Cn, $getChildCaret as Hs, $getAdjacentChildCaret as Ys, $isChildCaret as Ws, $normalizeCaret as Xs, $setSelectionFromCaretRange as Js, $getCollapsedCaretRange as Zs, $getCaretInDirection as zo, $splitAtPointCaretNext as Qs, $isTextPointCaret as tc, $findMatchingParent as En, $isElementNode as _r, mergeRegister as Re, getDOMTextNode as ec, isHTMLElement as rc, CLEAR_EDITOR_COMMAND as Tn, COMMAND_PRIORITY_EDITOR as Ja, shallowMergeConfig as ac, defineExtension as de, safeCast as Qe, createState as oc, FORMAT_TEXT_COMMAND as zn, $isNodeSelection as Sn, COMMAND_PRIORITY_LOW as Dn, RootNode as nc, LineBreakNode as ic, TabNode as sc, $isEditorState as cc, createCommand as lc, CLICK_COMMAND as dc, isDOMNode as wc, $getNodeFromDOMNode as uc, $createNodeSelection as pc, $setSelection as hc, $getEditor as gc, DecoratorNode as Aa, $getState as fc, toggleTextFormatType as So, TEXT_TYPE_TO_FORMAT as mc, $setState as vc, addClassNamesToElement as Mn, $create as bc, $getNodeByKey as xc, removeClassNamesFromElement as yc, KEY_TAB_COMMAND as kc, $isBlockElementNode as _c, $createRangeSelection as Nc, $normalizeSelection__EXPERIMENTAL as Cc, OUTDENT_CONTENT_COMMAND as Ec, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as Tc, COMMAND_PRIORITY_CRITICAL as Za, $isDecoratorNode as zc, $isParagraphNode as Sc, $isTextNode as Pa, SELECTION_CHANGE_COMMAND as On, $insertNodes as Dc } from "lexical";
import { HeadingNode as Mc, QuoteNode as Oc, registerRichText as $c } from "@lexical/rich-text";
import { flushSync as Rc, createPortal as Ac } from "react-dom";
import { IconX as Pc, IconCheck as oa, IconChevronDown as Ic, IconChevronUp as Vc, IconSelector as Lc, IconLayoutSidebar as Fc, IconLayoutSidebarRight as jc, IconChevronRight as $n, IconLoader as Bc, IconAlertOctagon as Uc, IconAlertTriangle as Kc, IconInfoCircle as qc, IconCircleCheck as Gc } from "@tabler/icons-react";
import { $isTableSelection as Hc } from "@lexical/table";
import { cva as Dr } from "class-variance-authority";
import { createHeadlessEditor as Rn } from "@lexical/headless";
import { $generateHtmlFromNodes as Yc, $generateNodesFromDOM as Wc } from "@lexical/html";
import { useReactTable as An, getFilteredRowModel as Xc, getSortedRowModel as Pn, getPaginationRowModel as Jc, getCoreRowModel as In, flexRender as xr, getGroupedRowModel as Zc, getExpandedRowModel as Qc } from "@tanstack/react-table";
import tl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Va, getDefaultViewOptions as el, isInsertEmbedOpOfType as Ir, Editorial as rl, getMarkerMenuItems as al, defaultStyleInfo as ol } from "@eten-tech-foundation/platform-editor";
...
const Ln = ht.allBookIds.filter(
  (t) => !ht.isObsolete(ht.bookIdToNumber(t))
), he = Object.fromEntries(
  Ln.map((t) => [t, ht.bookIdToEnglishName(t)])
);
function to(t, e, r) {
  const o = e.trim().toLowerCase();
  if (!o) return !1;
  const n = ht.bookIdToEnglishName(t), i = r == null ? void 0 : r.get(t);
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ u(
        Ae,
        {
          ...
          "aria-label": `${ht.bookIdToEnglishName(e)} (${e.toLocaleUpperCase()})`,
          disabled: w,
...
function fa({
  ...
  const T = Bt(), [N, y] = C(!1), [I, K] = C(""), [V, O] = C(""), [_, z] = C("books"), [P, S] = C(void 0), [D, W] = C(
    void 0
  ), [q, R] = C(void 0), [rt, at] = C(!1), nt = j(null), Ut = j(!1), xt = j(void 0), $t = j(void 0), U = j(void 0), ct = j(void 0), lt = j({}), dt = j({}), wt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Kt = F(() => o ? o() : Ln, [o]), _t = F(() => ({
    [tt.OT]: Kt.filter((G) => ht.isBookOT(G)),
    [tt.NT]: Kt.filter((G) => ht.isBookNT(G)),
    [tt.DC]: Kt.filter((G) => ht.isBookDC(G)),
    [tt.Extra]: Kt.filter((G) => ht.extraBooks().includes(G))
  }), [Kt]), Jt = F(() => Object.values(_t).flat(), [_t]), Ct = F(() => {
    if (!V.trim()) return _t;
    const x = {
      [tt.OT]: [],
      [tt.NT]: [],
    ...
    return [tt.OT, tt.NT, tt.DC, tt.Extra].forEach((Q) => {
      x[Q] = _t[Q].filter((Et) => to(Et, V, n));
    }), x;
  }, [_t, V, n]), M = F(
    () => gl(V, Jt, n),
    [V, Jt, n]
  ...
  const bt = L(() => {
    ...
    (x) => {
      const G = D ?? (M == null ? void 0 : M.book), Q = q ?? (M == null ? void 0 : M.chapterNum);
      !G || !Q || (wt({
        book: G,
        chapterNum: Q,
        verseNum: x
    ...
    z("books"), S(void 0), W(void 0), R(void 0), setTimeout(() => {
      $t.current && $t.current.focus();
    }, 0);
  }, []), Gt = L(() => {
    const x = D;
    W(void 0), R(void 0), x ? (S(x), z("chapters"), K("")) : Qt();
  }, [D, Qt]), St = L((x) => {
    y(x), x && (z("books"), S(void 0), W(void 0), R(void 0), O(""));
    ...
    () => pl(V),
    [V]
  ), Y = F(() => !l || !M || !M.chapterNum || !X ? !1 : l(M.book, M.chapterNum) > 0, [l, M, X]), st = L(
    (x) => w ? Oo(x, w) : !1,
    [w]
  ), gt = L(
    (x) => (G) => w ? hl(x, G, w) : !1,
    ...
    (x, G) => (Q) => w ? ga(x, G, Q, w) : !1,
    [w]
  ), ut = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", mt = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Nt = L(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && M && M.chapterNum !== void 0 && M.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), bt());
    },
    [p, M, bt]
  ), Yt = L(
    (x) => {
      var ae, tr, hr;
      if (x.ctrlKey) return;
      const { isLetter: G, isDigit: Q } = $o(x.key);
      if ((_ === "chapters" || _ === "verses") && (x.key === " " || x.key === "Enter")) {
        ...
        const Dt = (ae = xt.current) == null ? void 0 : ae.querySelector(
      ...
      if ((_ === "chapters" || _ === "books" && M) && Et) {
        ...
        if (!Rt) return;
        _ === "chapters" && ((hr = xt.current) == null || hr.focus());
        const yt = (() => {
          if (!I) return 1;
          const Xt = I.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            yt !== 0 && (vt = yt > 1 ? yt - 1 : Dt);
            break;
          case "ArrowRight":
            yt !== 0 && (vt = yt < Dt ? yt + 1 : 1);
            break;
          case "ArrowUp":
            vt = yt === 0 ? Dt : Math.max(1, yt - Wt);
            break;
          case "ArrowDown":
            vt = yt === 0 ? 1 : Math.min(Dt, yt + Wt);
            break;
          default:
            return;
        }
        vt !== yt && (x.preventDefault(), x.stopPropagation(), K(
          `${Rt} ${he[Rt] || ""} ${vt}`
        ), setTimeout(() => {
          const Xt = lt.current[vt];
    ...
    const { isLetter: G, isDigit: Q } = $o(x.key);
    (G || Q) && (x.preventDefault(), O((ae) => ae + x.key), $t.current.focus(), at(!1));
  }, []);
  return Ft(() => {
    const x = setTimeout(() => {
      if (N && _ === "books" && U.current && ct.current) {
        const G = U.current, Q = ct.current, Et = Q.offsetTop, ae = G.clientHeight, tr = Q.clientHeight, hr = Et - ae / 2 + tr / 2;
        G.scrollTo({
          top: Math.max(0, hr),
          behavior: "smooth"
        }), K(jn(t.book));
    ...
    if (_ === "chapters" && P) {
      ...
      K(
        ...
        if (U.current)
          if (x) {
            const Q = lt.current[t.chapterNum];
    ...
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: G } = x;
          N && nt.current && G instanceof Node && nt.current.contains(G) && (Ut.current = !0, St(!1));
        },
        onCloseAutoFocus: k,
        children: /* @__PURE__ */ u(
          qe,
          {
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Zt.map(({ onClick: x, disabled: G, title: Q, icon: Et }) => /* @__PURE__ */ a(
                  B,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  B,
                  {
                    ...
                    tabIndex: -1,
                    children: T === "ltr" ? /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ls, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                ...
                /* @__PURE__ */ a(
                  "span",
                  {
                    ...
                    children: _ === "verses" ? mt : ut
                  }
                )
              ] }),
              !rt && /* @__PURE__ */ u(Ge, { ref: U, children: [
                _ === "books" && /* @__PURE__ */ u(ot, { children: [
                  !M && Object.entries(Ct).map(([x, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: ue(x), children: G.map((Q) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: Q,
                            onSelect: (Et) => Vt(Et),
                  ...
                  M && /* @__PURE__ */ a(xe, { children: /* @__PURE__ */ a(
                    Ae,
                    {
                      ...
                      children: Se(
                        ...
                        n ? Qa(M.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  M && Y && M.chapterNum && l && /* @__PURE__ */ u(ot, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Ao,
                      {
                        ...
                        onVerseSelect: qt,
                        setVerseRef: Z,
                        isVerseDisabled: et(M.book, M.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  M && !Y && be(M.book) > 1 && /* @__PURE__ */ u(ot, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Fe(M.book, n) }),
                      /* @__PURE__ */ a("span", { children: ut })
                    ] }),
                    /* @__PURE__ */ a(
                      Ro,
                      {
    ...
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        children: /* @__PURE__ */ u(qe, { children: [
          /* @__PURE__ */ a(Er, { placeholder: h, className: "tw:text-inherit" }),
...
function Qu({
  ...
  const w = ma(l, "%webView_bookSelector_currentBook%"), p = ma(l, "%webView_bookSelector_choose%"), h = ma(l, "%webView_bookSelector_chooseBooks%"), [g, m] = C(
    "current book"
    /* CurrentBook */
  ), k = (v) => {
    m(v), t(v);
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(kt, { className: "tw:ms-1", children: h })
          ] }),
          /* @__PURE__ */ a(kt, { className: "tw:flex tw:items-center", children: o.map((v) => ht.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            B,
            {
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = qn ? Ft : H, Vr = { tag: Xa };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const m = Sr();
            g.append(m);
            const k = qn ? document.activeElement : null;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function Sl(t) {
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = Gn && "documentMode" in document ? document.documentMode : null;
!(!Gn || !("InputEvent" in window) || Ol) && "getTargetRanges" in new window.InputEvent("input");
function ve(t) {
  return `${t}px`;
}
  ...
  function l(w) {
    w.read(() => {
      ...
      if ((K || V) && y !== null && I !== null) {
        const O = function(_, z, P, S, D, W, q) {
          const R = (_._window ? _._window.document : document).createRange();
          return R.setStart(...Io(z, P, S)), R.setEnd(...Io(D, W, q)), R;
        }(t, h, m, y, g, E, I);
        d(), d = Rl(t, O, e);
      }
...
function Vl(t) {
  const e = En(t, (r) => _r(r) && !r.isInline());
  return _r(e) || Yr(4, t.__key), e;
}
function Ll(t) {
  const e = jt() || qs();
  let r;
  if (ke(e)) r = Gs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Cn(c, "next"));
    }
    r = r || Hs(Ue(), "previous").getFlipped().insert(Sr());
  }
  const o = Fl(t, r), n = Ys(o), i = Ws(n) ? Xs(n) : o;
  return Js(Zs(i)), t.getLatest();
}
function Fl(t, e, r) {
  let o = zo(e, "next");
  for (let n = o; n; n = Qs(n, r)) o = n;
  return tc(o) && Yr(283), o.insert(t.isInline() ? Sr().append(t) : t), zo(Cn(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = jt();
  if (!ke(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = En(i, (l) => _r(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Wr, De = 0, Xr = 0, Kl = 0, Ua = 0, Ur = 0;
function Lo(t) {
  if (it === void 0) return;
  let e = t.n;
...
function Gl(t) {
  ...
  Yn(this), it = t, this.f &= -2, 8 & this.f && ao(this), na();
}
function rr(t, e) {
...
Pt.prototype.brand = Bl, Pt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      De !== 0 && Xr === 0 && e.l !== Ua && (e.l = Ua, Wr = { S: e, v: e.v, i: e.i, o: Wr });
    })(this), this.v = t, this.i++, Ur++, De++;
    try {
  ...
  if (this.g = Ur, this.f |= 1, this.i > 0 && !Hn(this)) return this.f &= -2, !0;
  const t = it;
  try {
    Fo(this), it = this;
    const e = this.x();
  ...
  return it = t, Yn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Wn(this), Fo(this), De++;
  const t = it;
  return it = this, Gl.bind(this, t);
...
function Xn() {
  const t = Ue(), e = jt(), r = Sr();
  t.clear(), t.append(r), e !== null && r.select(), ke(e) && (e.format = 0);
}
function Jn(t, e = Xn) {
  return t.registerCommand(Tn, (r) => (t.update(e), !0), Ja);
}
de({ build: (t, e, r) => pr(e), config: Qe({ $onClear: Xn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return _e(() => Jn(t, o.value));
} });
function Hl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ba = oc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Zn extends Aa {
  $config() {
    return this.config("decorator-text", { extends: Aa, stateConfigs: [{ flat: !0, stateConfig: ba }] });
  }
  getFormat() {
    return fc(this, ba);
  }
...
de({ name: "@lexical/extension/DecoratorText", nodes: () => [Zn], register: (t, e, r) => t.registerCommand(zn, (o) => {
  const n = jt();
  if (Sn(n) || ke(n)) for (const i of n.getNodes()) Yl(i) && i.toggleFormat(o);
  return !1;
}, Dn) });
function Qn(t, e) {
  let r;
...
const Ka = de({ build: (t) => Qn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const oo = 0, qa = 1, ei = 2, xa = 3, Lr = 4, er = 5, ya = 6, fr = 7;
function ka(t) {
  return t.id === oo;
}
function ri(t) {
...
function Wl(t) {
  return function(e) {
    return e.id === qa;
  }(t) || pt(305, String(t.id), String(qa)), Object.assign(t, { id: ei });
}
...
class Jl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Lr && pt(307, String(r.id), String(er)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ya && pt(310, String(r.id), String(ya)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Lr;
    }(e) || pt(313, String(e.id), String(Lr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= xa;
    }(e) || pt(314, String(e.id), String(xa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= fr;
    }(e) || pt(316, String(e.id), String(fr)), e;
  }
...
const Ql = de({ config: Qe({ setOptions: jo, updateOptions: jo }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [nc, Nn, ic, sc, _n] }), Bo = Symbol.for("@lexical/extension/LexicalBuilder");
function Uo() {
}
function td(t) {
  throw t;
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[Bo];
    return r && (r.PACKAGE_VERSION !== _a && pt(292, r.PACKAGE_VERSION, _a), r instanceof ar || pt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ka(i) || pt(300, s, n || "[unknown]"), ka(c = i) || pt(304, String(c.id), String(oo)), i = Object.assign(c, { id: qa }), o.state = i;
...
const ed = /* @__PURE__ */ new Set(), Ko = de({ build(t, e, r) {
  const o = r.getDependency(Ka).output, n = Nr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Qn(() => {
  }, () => _e(() => {
...
}, dependencies: [Ka], name: "@lexical/extension/NodeSelection" }), rd = lc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends Aa {
  static getType() {
...
de({ dependencies: [Ka, Ko], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Ko).output, n = Nr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Re(t.registerCommand(rd, (s) => {
    const c = jt();
    if (!ke(c)) return !1;
    ...
    return !0;
  }, Ja), t.registerCommand(dc, (s) => {
    if (wc(s.target)) {
      const c = uc(s.target);
      if (od(c)) return function(d, l = !1) {
        const w = jt(), p = d.isSelected(), h = d.getKey();
        let g;
        l && Sn(w) ? g = w : (g = pc(), hc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Dn), t.registerMutationListener(ir, (s, c) => {
    Ul(() => {
      let d = !1;
...
function nd(t, e, r = ai) {
  return Re(t.registerCommand(kc, (o) => {
    const n = jt();
    if (!ke(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => _c(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Vl(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Nc();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = Cc(g), g.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Ec : Do : Tc;
...
de({ build: (t, e, r) => pr(e), config: Qe({ $canIndent: ai, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return _e(() => {
    if (!o.value) return nd(t, n, i);
  });
} });
const id = de({ name: "@lexical/react/ReactProvider" });
function sd() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ke(m)) {
                ...
                if (Pa(v) && l >= 0 && w >= 0 && (E = l, T = l + w, m.setTextNodeRange(v, E, v, T)), E === T && p === "" || (m.insertRawText(p), v = k.getNode()), Pa(v)) {
                  E = h, T = h + g;
...
de({ build: (t, e, r) => pr(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => _e(() => r.getOutput().disabled.value ? void 0 : ni(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const io = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
  ...
  return function(r, o) {
    ...
    return io(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (h) => r._onError(h), children: a(Us, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
        p !== null && s.push(Ac(w, p, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function pd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    io(() => Re($c(n), ni(n)), [n]);
  }(o), u(ot, { children: [t, a(hd, { content: e }), a(ud, { editor: o, ErrorBoundary: r })] });
}
...
const fd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function md({ onClear: t }) {
  const [e] = Ce();
  return fd(() => Jn(e, t), [e, t]), null;
}
const ii = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function vd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: m, id: k, role: v = "textbox", spellCheck: E = !0, style: T, tabIndex: N, "data-testid": y, ...I }, K) {
  ...
  return ii(() => (O(t.isEditable()), t.registerEditableListener((P) => {
    O(P);
...
function yd(t, e) {
  ...
  return u(ot, { children: [a(bd, { editor: n, ...o, ref: e }), r != null && a(kd, { editor: n, content: r })] });
}
...
function Ed({
  ...
  const [e] = Ce(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = Cd(), d = () => {
  };
...
function Sd() {
  const { activeEditor: t } = ci(), [e, r] = C([]), o = L((n) => {
    if (ke(n) || Hc(n)) {
      const i = [];
      Ho.forEach(({ format: s }) => {
...
function $d(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Wc(e, n);
      Ue().clear(), Dc(i);
    },
    {
      discrete: !0
...
function ep({
  ...
  const [i, s] = C(Ad), [c, d] = C(n), [l, w] = C(!1), p = j(void 0), h = j(null);
  H(() => {
    let v = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : lo(v) && (v.preventDefault(), v.stopPropagation(), oe(i) && g());
        },
        onKeyDown: (v) => {
...
function Wo({
  ...
  const g = L(
    ...
    [t.user]
  ), T = F(() => es(t.contents), [t.contents]), N = F(() => {
    if (o && c)
      return /* @__PURE__ */ u(ot, { children: [
        /* @__PURE__ */ u(
          Je,
          {
            onClick: (y) => {
              y.stopPropagation(), l(!0), p($d(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Vd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ld, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (y) => {
                y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), g()) : lo(y) && (y.preventDefault(), y.stopPropagation(), oe(w) && m());
              },
              onKeyDown: (y) => {
                so(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
              },
              onClick: (y) => {
                y.stopPropagation();
              },
        ...
        N && /* @__PURE__ */ u(Me, { children: [
          /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(hs, {}) }) }),
...
function Fd({
  ...
  const [O, _] = C(Xo), [z, P] = C(), [S, D] = C(), W = o, [q, R] = C(!1), [rt, at] = C(!1), [nt, Ut] = C(!1), [xt, $t] = C(!1), [U, ct] = C(!1), [lt, dt] = C(y), [wt, Kt] = C(!1), _t = j(void 0), [Jt, Ct] = C(/* @__PURE__ */ new Map());
  H(() => {
    let b = !0;
    return (async () => {
      const X = T ? await T(d) : !1;
      b && ct(X);
    })(), () => {
      b = !1;
    };
  ...
  H(() => {
    ...
    M.current === "idle" && (M.current = "pending"), xt ? M.current === "pending" && V !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
  ...
  const bt = F(() => Tt[0], [Tt]), qt = j(null), Vt = j(void 0), zt = L(() => {
    var b;
    (b = Vt.current) == null || b.call(Vt), _(Xo);
  }, []), Ve = L(() => {
    const b = !lt;
    dt(b), Kt(!b), m == null || m(d, b);
  }, [lt, m, d]);
  H(() => {
    R(!1);
  }, [o]), H(() => {
    if (o && !lt && !wt) {
      ...
      return _t.current = b, () => clearTimeout(b);
    }
  ...
  const ee = L(
    async (b) => {
      ...
      Z && await p({ threadId: d, contents: Z }) && zt();
    },
    [
      zt,
      O,
    ...
    async (b) => {
      const Z = oe(O) ? Zr(O) : void 0, X = b.status ? b.assignedUser : z ?? b.assignedUser, Y = await p({
        ...b,
        contents: Z,
        assignedUser: X
      });
      return Y && (X !== void 0 && D(X), Z && zt()), Y;
    },
    [zt, O, p, z]
  );
  if (Tt.length !== 0)
        ...
        children: /* @__PURE__ */ u(Id, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              Qt && /* @__PURE__ */ a(kr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Qt }),
              /* @__PURE__ */ a(
                B,
                {
                  variant: "ghost",
                  ...
                  children: lt ? /* @__PURE__ */ a(gs, {}) : /* @__PURE__ */ a(fs, {})
                }
              ),
            ...
            /* @__PURE__ */ a(
              Wo,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: at,
                canEditOrDelete: (!rt && Jt.get(bt.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(ot, { children: [
              ...
              we.map((b) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Wo,
                {
                  ...
                  handleDeleteComment: g,
                  onEditingChange: at,
                  canEditOrDelete: (!rt && Jt.get(b.id)) ?? !1
                }
              ) }, b.id)),
              v !== !1 && (!rt || oe(O)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (b) => {
                    lo(b) && (b.preventDefault(), b.stopPropagation(), (oe(O) || z !== void 0 && z !== S) && ee());
                  },
                  onKeyDown: (b) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      ...
                      /* @__PURE__ */ u(Pe, { open: nt, onOpenChange: Ut, children: [
                        /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ a(
                          B,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !xt || !k || k.length === 0 || !k.includes(s),
                          ...
                          Ie,
                          {
                            ...
                            children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(Ge, { children: k == null ? void 0 : k.map((b) => /* @__PURE__ */ a(
                              Ae,
                              {
                                ...
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: qr(b, r) })
                              },
                              b || "unassigned"
                            )) }) })
                          }
...
function lp({
  ...
  const [E, T] = C(/* @__PURE__ */ new Set()), [N, y] = C(), [I, K] = C(), V = L(
    async (R) => {
      const rt = await i(R);
      return rt !== void 0 && R.assignedUser !== void 0 && R.assignedUser !== "" && K(R.assignedUser), rt;
    },
    [i]
  );
  H(() => {
  ...
  const O = r.filter(
    (R) => R.comments.some((rt) => !rt.deleted)
  ), _ = O.map((R) => ({ id: R.id })), z = L(
    (R) => {
      T((rt) => new Set(rt).add(R.id)), y(R.id), k == null || k(R.id);
    },
    [k]
  ), P = L(
    (R) => {
      ...
      }), y(R), k == null || k(rt ? void 0 : R);
    },
    [E, k]
  ), { listboxRef: S, activeId: D, handleKeyDown: W } = ji({
    options: _,
    onOptionSelect: z
  }), q = L(
    (R) => {
      R.key === "Escape" ? (N && E.has(N) && (T((rt) => {
        const at = new Set(rt);
        return at.delete(N), at;
      }), y(void 0), k == null || k(void 0)), R.preventDefault(), R.stopPropagation()) : W(R);
    },
    [N, E, W, k]
  );
  return /* @__PURE__ */ a(
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    It.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(It.Icon, { asChild: !0, children: /* @__PURE__ */ a(Lc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Cr(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Gd(o)
  );
}
function ia({
  className: t,
  ...
  const c = ft.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Wd(g, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Yd(c, k, w.key);
...
function Xd({
  ...
  var K;
  const [w, p] = C([]), [h, g] = C([]), [m, k] = C({}), [v, E] = C({}), T = F(() => e ?? [], [e]), N = An({
    data: T,
    columns: t,
    getCoreRowModel: In(),
  ...
  return d ? I = Array.from({ length: 10 }).map((_, z) => `skeleton-row-${z}`).map((_) => /* @__PURE__ */ a(ge, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ne, { colSpan: y.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Sa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, _)) : ((K = N.getRowModel().rows) == null ? void 0 : K.length) > 0 ? I = N.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ...
    n && /* @__PURE__ */ a(jd, { table: N }),
    /* @__PURE__ */ u(ia, { stickyHeader: i, children: [
      /* @__PURE__ */ a(wo, { stickyHeader: i, children: N.getHeaderGroups().map((V) => /* @__PURE__ */ a(ge, { children: V.headers.map((O) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: O.isPlaceholder ? void 0 : xr(O.column.columnDef.header, O.getContext()) }, O.id)) }, V.id)) }),
...
function hp({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(tl, { options: i, children: e })
    }
  );
}
...
function mp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Me, { children: [
    ...
    /* @__PURE__ */ a($e, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(ln, { children: l.itemType === 0 ? /* @__PURE__ */ a(ot, { children: l.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        je,
        {
          checked: o[w][h],
        ...
        Bi,
        {
          ...
          children: l.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Ui, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Ze, {})
    ] }, l.label)) })
...
function fi({
  ...
  const [E, T] = C(!1), N = L(
    ...
    const z = t.filter((S) => S.starred).sort((S, D) => S.label.localeCompare(D.label)), P = t.filter((S) => !S.starred).sort((S, D) => {
      const W = e.includes(S.value), q = e.includes(D.value);
      return W && !q ? -1 : !W && q ? 1 : S.label.localeCompare(D.label);
    });
    return [...z, ...P];
  }, [t, e, h]), K = () => {
    r(t.map((z) => z.value));
        ...
        /* @__PURE__ */ a(xe, { children: I.map((z) => /* @__PURE__ */ u(
          Ae,
          {
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Ts, { className: "tw:h-4 tw:w-4" }),
...
function rw(t, e, r) {
  return t.key === "Shift" || t.key === "Control" || t.key === "Alt" || t.key === "Meta" ? "passed" : t.ctrlKey || t.metaKey || t.altKey ? (r.dismiss(), "ended") : t.key === "ArrowDown" || t.key === "ArrowUp" ? (mr(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue") : t.key === "Enter" ? (mr(t), r.commit(), "ended") : t.key === "Escape" ? (mr(t), r.dismiss(), "ended") : e.kind === "backslash" && (t.key === " " || t.key === "*") ? (r.dismiss(), "ended") : t.key === "Backspace" || ew[e.kind].test(t.key) ? (e.kind !== "backslash" && mr(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && mr(t), r.dismiss(), "ended");
}
...
function ow({
  ...
  const d = F(() => /Macintosh/i.test(navigator.userAgent), []), l = tn(n, "%undoButton_tooltip%"), w = tn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(co, { children: [
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(
        B,
...
const iw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ot, { children: [
...
function sw({
  ...
  return /* @__PURE__ */ u(Me, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
const cw = (t, e) => t === "f" ? /* @__PURE__ */ u(ot, { children: [
  /* @__PURE__ */ a(mn, {}),
  " ",
...
function dw({
  ...
  return /* @__PURE__ */ u(Me, { children: [
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
      /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("p", { children: lw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u($e, { style: { zIndex: dn }, children: [
  ...
  return /* @__PURE__ */ u(
    Ae,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Ki, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
...
function yp({
  ...
  const [v, E] = C("generated"), [T, N] = C("generated"), [y, I] = C("*"), [K, V] = C("*"), [O, _] = C("f"), [z, P] = C(!1), [S, D] = C(!0), [W, q] = C(!1), R = j(!1), rt = j(""), [at, nt] = C(!1), [Ut, xt] = C(), [$t, U] = C(), [ct, lt] = C(), [dt, wt] = C(), Kt = j(null), _t = j(void 0), Jt = j(0), Ct = F(
    () => ({
      ...c,
      ...
      markerMenuTrigger: d,
      hasExternalUI: !0,
      view: { ...c.view ?? el(), noteMode: "expanded" }
    }),
    [c, d]
  ...
  H(() => {
    ...
    if (b && Ir("note", b)) {
      const Y = (Z = b.insert.note) == null ? void 0 : Z.caller;
      let st = "custom";
      Y === Ia ? st = "generated" : Y === Va ? st = "hidden" : Y && (I(Y), V(Y)), E(st), N(st), _(((X = b.insert.note) == null ? void 0 : X.style) ?? "f"), $ = setTimeout(() => {
        var et, ut, mt;
        const gt = M.current === "editable" ? [{ retain: bw }, b] : [b];
        (et = h.current) == null || et.applyUpdate(gt), s && ((ut = h.current) == null || ut.selectNote(0), (mt = h.current) == null || mt.focus());
      }, 0);
    }
    return () => {
      $ && clearTimeout($);
  ...
  const bt = L(
    ($, b, Z = !1) => {
      var Y, st, gt;
      const X = (st = (Y = h.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : st.at(0);
      if (X && Ir("note", X)) {
        if (X.insert.note) {
          let et;
          $ === "custom" ? et = b : $ === "generated" ? et = Ia : et = Va, X.insert.note.caller = et;
        }
        r == null || r([X]), Z && w && i && ((gt = w.current) == null || gt.replaceEmbedUpdate(i, [X]));
      }
    },
    [i, r, w]
  ), qt = L(() => {
  ...
  const Ve = () => {
    ...
    var Z, X, Y, st, gt;
    _($);
    const b = (X = (Z = h.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : X.at(0);
    if (b && Ir("note", b)) {
      b.insert.note && (b.insert.note.style = $);
      const et = (st = (Y = b.insert.note) == null ? void 0 : Y.contents) == null ? void 0 : st.ops;
      O !== "x" && $ === "x" ? et == null || et.forEach((ut) => fw(ut)) : O === "x" && $ !== "x" && (et == null || et.forEach((ut) => mw(ut))), (gt = h.current) == null || gt.applyUpdate([b, { delete: 1 }]);
    }
  }, St = ($) => {
    wt($.contextMarker), q($.canRedo);
  }, Ht = L(
    ($) => {
      var Z, X, Y, st, gt;
      const b = (X = (Z = h.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : X.at(0);
      if (b && Ir("note", b)) {
        ...
        const et = (Y = b.insert.note) == null ? void 0 : Y.style, ut = (gt = (st = b.insert.note) == null ? void 0 : st.contents) == null ? void 0 : gt.ops;
        if (et || P(!1), P(
          et === "x" ? !!(ut != null && ut.every((mt) => {
            var Yt, re;
          ...
          R.current = !0, rt.current = JSON.stringify(b), D(!0);
          return;
        }
        D(JSON.stringify(b) === rt.current), bt(v, y);
      } else
        P(!1), D(!0);
    },
    [v, y, bt]
    ...
    if (m.current && Tt.length && $ && $.rangeCount > 0) {
      const b = $.getRangeAt(0).getBoundingClientRect(), Z = m.current.getBoundingClientRect();
      xt(b.left - Z.left), U(b.top - Z.top), lt(b.height), nt(!0);
    }
  }, [Tt, m]), te = L(
    ($, b, Z) => {
      const { anchorRect: X } = $;
      if (!p || !X) return;
      const { passive: Y, literalPrefixLanded: st } = Z;
      Jt.current += 1;
      const gt = Jt.current;
      _t.current = {
        kind: Y ? "backslash" : "selection",
        token: gt,
        literalPrefixLanded: st,
        filter: "",
        items: b
      }, p.show(b.map(gw), X, Y).then((et) => {
        var ut, mt, Nt;
        if (rn(_t, gt), et !== void 0) {
          const Yt = b.find((re) => re.marker === et);
          Yt && ((ut = h.current) == null || ut.applyMarkerMenuSelection(Yt, {
            trigger: "backslash",
            literalPrefixLanded: st
          })), (mt = h.current) == null || mt.focus();
        } else Y || (Nt = h.current) == null || Nt.focus();
      }).catch(() => {
        var et;
        rn(_t, gt), Y || (et = h.current) == null || et.focus();
      });
    },
    [p]
  );
  H(() => {
    ...
    var $;
    at && (($ = Kt.current) == null || $.focus());
  }, [at]), H(() => {
    var Z, X;
    const $ = ((Z = g.current) == null ? void 0 : Z.querySelector(".editor-input")) ?? void 0;
    if (((X = Ct.view) == null ? void 0 : X.markerMode) === "editable") {
      if (!p) return () => {
      };
      const Y = (st) => {
        var Nt;
        ...
        const gt = _t.current;
        if (gt) {
          rw(st, gt, p) === "ended" && (_t.current = void 0);
          return;
        }
        if (st.key !== d) return;
        const et = (Nt = h.current) == null ? void 0 : Nt.getMarkerMenuContext();
        if (!et) return;
        const ut = al(Ct.styleInfo ?? ol, et);
        if (ut.length === 0) return;
        const mt = !et.hasTextSelection;
        mt || (st.preventDefault(), st.stopPropagation()), te(et, ut, { passive: mt, literalPrefixLanded: mt });
      };
    ...
    const b = (Y) => {
      !at && $ && document.activeElement === $ && Y.key === d ? (Y.preventDefault(), we()) : at && Y.key === "Escape" && (Y.preventDefault(), nt(!1));
    };
  ...
  return /* @__PURE__ */ u(ot, { children: [
    ...
    /* @__PURE__ */ u(Pe, { open: at, children: [
      /* @__PURE__ */ a(
        qi,
        {
          className: "tw:absolute",
  ...
  return /* @__PURE__ */ u(ot, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ot, { children: xw(t.marker, c, o, l) })
      }
    )
  ] });
}
...
function Nw({
  ...
  return /* @__PURE__ */ u(ia, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(wo, { stickyHeader: !0, children: /* @__PURE__ */ u(ge, { children: [
    ...
    /* @__PURE__ */ a(sa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ge,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ne, { className: o, children: _w(c.text) })
        ]
      },
...
const Cw = (t) => {
...
}, ca = (t, e, r) => /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
  /* @__PURE__ */ u(
    ce,
    {
  ...
  return e ? e[1] : "";
}, Tw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Dp = Object.freeze([
...
function Mp({
  ...
  const g = me(r, "%webView_inventory_all%"), m = me(r, "%webView_inventory_approved%"), k = me(r, "%webView_inventory_unapproved%"), v = me(r, "%webView_inventory_unknown%"), E = me(r, "%webView_inventory_scope_currentBook%"), T = me(r, "%webView_inventory_scope_chapter%"), N = me(r, "%webView_inventory_scope_verse%"), y = me(r, "%webView_inventory_filter_text%"), I = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), K = me(r, "%webView_inventory_no_results%"), [V, O] = C(!1), [_, z] = C("all"), [P, S] = C(""), [D, W] = C([]), q = F(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : Sw(U, n, i);
  }, [t, n, i]), R = F(() => {
    if (V) return q;
    const U = [];
    return q.forEach((ct) => {
      const lt = ct.items[0], dt = U.find(
        (wt) => wt.items[0] === lt
      );
      dt ? (dt.count += ct.count, dt.occurrences = dt.occurrences.concat(ct.occurrences)) : U.push({
        items: [lt],
        count: ct.count,
  ...
  }, [V, q]), rt = F(() => R.length === 0 ? [] : zw(R, _, P), [R, _, P]), at = F(() => {
    var lt, dt;
    if (!V) return d;
    const U = (lt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : lt.length;
    if (!U) return d;
    const ct = [];
  ...
  H(() => {
    rt.length === 0 ? W([]) : rt.length === 1 && W(rt[0].items);
  }, [rt]);
  const nt = (U, ct) => {
    ct.setRowSelection(() => {
      const dt = {};
      return dt[U.index] = !0, dt;
    });
    const lt = U.original.items;
    W(lt), h && lt.length > 0 && h(lt[0]);
  }, Ut = (U) => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
        /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(kt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? I })
        ] }) }),
...
const bi = aa(({ className: t, ...e }, r) => /* @__PURE__ */ a(Is, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Ea({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(ot, { children: [
      /* @__PURE__ */ a(ge, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(ne, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(kt, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        ge,
        {
          ...
          children: [
            /* @__PURE__ */ a(ne, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(ot, { children: [
...
function $p({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = F(
    () => t.filter((D) => !r || D.type === r).filter((D) => Mw(D, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: k, hasMore: v } = Dw(g), E = F(
  ...
  return /* @__PURE__ */ u(ot, { children: [
    /* @__PURE__ */ a(Gr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Hr, { children: N }) }),
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(bi, {}) }),
      T && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: _ }),
      !T && !e && /* @__PURE__ */ a(ia, { children: /* @__PURE__ */ u(sa, { children: [
        /* @__PURE__ */ a(Ea, { label: K, resources: p }),
        /* @__PURE__ */ a(Ea, { label: V, resources: h, onSelect: i }),
        /* @__PURE__ */ a(
          Ea,
          {
            label: O,
...
const Ow = "16rem", $w = "3rem", xi = ft.createContext(void 0);
function da() {
  const t = ft.useContext(xi);
  if (!t)
...
function Rp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    B,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Fc, {}) : /* @__PURE__ */ a(jc, {}),
...
function jw({
  ...
  const c = t ? ur.Root : "button", { state: d } = da(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(Fw({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Aw,
    {
      ...
      children: /* @__PURE__ */ u(Iw, { children: [
        /* @__PURE__ */ u(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(Vw, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(Lw, { children: /* @__PURE__ */ a(
            jw,
            {
              onClick: () => l(g),
              isActive: h(g),
...
const Le = "scrBook", Uw = "scrRef", Xe = "source", Kw = "details", qw = "Scripture Reference", Gw = "Scripture Book", yi = "Type", Hw = "Details";
function Yw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ht.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Le ? Se(n.start) : void 0;
      },
...
}, sn = (t) => `${Ww({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Yp({
  sources: t,
  ...
  const E = An({
    ...
    getExpandedRowModel: Qc(),
    getGroupedRowModel: Zc(),
    getCoreRowModel: In(),
    getSortedRowModel: Pn(),
    getRowId: sn,
    autoResetExpanded: !1,
  ...
  H(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const P = k.find((S) => sn(S) === z[0]) || void 0;
        P && c(P);
      }
    }
  }, [g, k, c, E]);
  const T = n ?? Gw, N = i ?? yi, y = [
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Bd, { children: y.map((_) => /* @__PURE__ */ a(pe, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ia, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(wo, { children: E.getHeaderGroups().map((_) => /* @__PURE__ */ a(ge, { children: _.headers.filter((z) => z.column.columnDef.header).map((z) => (
        ...
        /* @__PURE__ */ a(Qr, { colSpan: z.colSpan, className: "tw:sticky top-0", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          xr(z.column.columnDef.header, z.getContext())
        ] }) }, z.id)
      )) }, _.id)) }),
      /* @__PURE__ */ a(sa, { children: E.getRowModel().rows.map((_, z) => {
        const P = Bt();
        return /* @__PURE__ */ a(
          ge,
          {
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ a(Oa, {}) : /* @__PURE__ */ a(Ma, {})),
                          " ",
...
function ki(t) {
  ...
  return ht.allBookIds.filter(
    (e, r) => t[r] === "1" && !ht.isObsolete(ht.bookIdToNumber(e))
  );
}
function po(t, e) {
  return t.filter((r) => {
...
const _i = (t, e, r) => po(t, e).every((o) => r.includes(o));
function Xw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: m } = {
    ...
    (S, D = !1) => {
      if (!D || !N.current) {
        r(
          e.includes(S) ? e.filter((nt) => nt !== S) : [...e, S]
        ), N.current = S;
        return;
      }
      const W = I.findIndex((nt) => nt === N.current), q = I.findIndex((nt) => nt === S);
      if (W === -1 || q === -1) return;
      const [R, rt] = [
        Math.min(W, q),
        Math.max(W, q)
      ], at = I.slice(R, rt + 1).map((nt) => nt);
      r(
        e.includes(S) ? e.filter((nt) => !at.includes(nt)) : [.../* @__PURE__ */ new Set([...e, ...at])]
      );
    },
    [e, r, I]
  ), O = (S) => {
                ...
                Object.values(tt).map((S, D) => {
                  ...
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(xn, { children: [
                      ...
                      D < Object.values(tt).length - 1 && /* @__PURE__ */ a(wn, {})
                    ] }, S);
                })
              ] })
            ]
...
function Jw({
  ...
  return /* @__PURE__ */ a(
    B,
    {
      ...
      onClick: () => o(t),
      className: f(
        _i(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: dl(
        t,
...
function Zw({
  ...
  const i = o["%webView_book_selector_more%"], s = F(
    ...
    (d) => {
      ...
      r(
        _i(s, d, e) ? e.filter((w) => !l.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...l])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ta ? Ta : cn
      ).map((d) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Fe(d, n) }, d)),
...
function Xp({
  ...
  const y = Mt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), z = Mt(s, "%webView_scope_selector_current_book%"), P = Mt(s, "%webView_scope_selector_choose_books%"), S = Mt(s, "%webView_scope_selector_scope%"), D = Mt(s, "%webView_scope_selector_select_books%"), W = Mt(s, "%webView_scope_selector_range%"), q = Mt(s, "%webView_scope_selector_select_range%"), R = Mt(s, "%webView_scope_selector_range_start%"), rt = Mt(s, "%webView_scope_selector_range_end%"), at = Mt(s, "%webView_scope_selector_ok%"), nt = Mt(s, "%webView_scope_selector_cancel%"), Ut = Mt(s, "%webView_scope_selector_navigate%"), xt = (A) => {
    if (!m) return;
  ...
  ], U = (A, J, Lt = !1) => /* @__PURE__ */ u(ot, { children: [
    A,
    J && !Lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), ct = e ? $t.filter((A) => e.includes(A.value)) : $t, lt = m ?? ha, dt = w ?? lt, wt = p ?? lt, Kt = () => {
  }, _t = j(null), Jt = j(null), Ct = j(!1), M = j(null), Tt = j(!1), [bt, qt] = C(void 0), Vt = j(!1), zt = j(!1), Ve = j(null), Zt = L((A) => {
    if (A) {
      qt("start"), Vt.current = !1;
      return;
    }
    qt((J) => J === "start" ? void 0 : J), Vt.current && (Vt.current = !1, requestAnimationFrame(() => {
      var Lt;
      const J = (Lt = _t.current) == null ? void 0 : Lt.querySelector("button");
      J == null || J.click();
    }));
  }, []), Qt = L((A) => {
    if (A) {
    ...
    [r, n, m, i]
  ), we = ct.find((A) => A.value === t), te = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? ss(dt, wt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : we ? U(we.label, we.scrRefSuffix) : t, Ee = ct.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), ue = ct.find((A) => A.value === "selectedBooks"), ee = ct.find((A) => A.value === "range"), [$, b] = C(!1), [Z, X] = C(void 0), [Y, st] = C(void 0), [gt, et] = C(void 0), [ut, mt] = C(void 0), [Nt, Yt] = C([]), re = l === "dropdown" && Z === "selectedBooks", x = /* @__PURE__ */ a(
    Zw,
    {
      availableBookInfo: o,
  ...
  ), G = bt === "end", Q = bt === "start", Et = "tw:text-muted-foreground", ae = l === "dropdown" && Z === "range", tr = ae ? et : Gt, Rt = ae ? mt : g ? St : Kt, yt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-start", className: f(G && Et), children: R }),
      /* @__PURE__ */ a(
        fa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: _t, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-end", className: f(Q && Et), children: rt }),
      /* @__PURE__ */ a(
        fa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: ae ? gt ?? dt : dt,
          onOpenChange: Qt,
          onCloseAutoFocus: (A) => {
            var J;
            zt.current && (zt.current = !1, A.preventDefault(), (J = Ve.current) == null || J.focus());
          },
          className: f(Q && Et),
          modal: !0,
          align: "start"
  ...
  const [Xt, Ye] = C(null), [Or, Mi] = C(null), [$r, Oi] = C(null), $i = 200, [Ri, Ai] = C(!1);
  H(() => {
    if (!$r || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([J]) => {
      Ai(J.contentRect.width < $i);
    });
    return A.observe($r), () => A.disconnect();
  }, [$r]);
  const ho = L(
    (A) => {
      st(A), et(dt), mt(wt), Yt(n), b(!1), X(A);
    },
    [dt, wt, n]
  ), go = L(() => {
    Y !== void 0 && (Y === "range" ? (gt && (h == null || h(gt)), ut && (g == null || g(ut))) : Y === "selectedBooks" && i(Nt), Ht(Y), X(void 0), st(void 0));
  }, [
    Y,
    gt,
    ut,
    ...
    A || (X(void 0), st(void 0));
  }, []), fo = L((A) => {
    var J;
    A.preventDefault(), (J = Wt.current) == null || J.focus();
  }, []), mo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Be, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !T && /* @__PURE__ */ a(kt, { children: S }),
      l === "dropdown" ? /* @__PURE__ */ u(Me, { open: $, onOpenChange: b, children: [
        ...
        /* @__PURE__ */ a(
          $e,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(wa, { container: $r, children: [
              Ee.map(({ value: A, label: J, dropdownLabel: Lt, scrRefSuffix: gr, id: Pi }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: vt(A),
              ...
              k && /* @__PURE__ */ u(ot, { children: [
                /* @__PURE__ */ a(Ze, {}),
                /* @__PURE__ */ a(Tr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Ut }),
                /* @__PURE__ */ a(
                  Je,
                  {
                    ref: M,
                    ...
                    onSelect: (A) => {
                      ...
                      Tt.current || (Lt = (J = Jt.current) == null ? void 0 : J.querySelector("button")) == null || Lt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          fa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var J;
                              A.preventDefault(), (J = M.current) == null || J.focus();
                            },
                            modal: !0,
                            className: "tw:w-full tw:min-w-0 tw:max-w-none tw:justify-between tw:px-2 tw:font-normal",
                            triggerContent: /* @__PURE__ */ u(ot, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Se(m ?? ha, "id") }),
                              /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Un,
        {
          ...
          children: ct.map(({ value: A, label: J, scrRefSuffix: Lt, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ja, { className: "tw:me-2", value: A, id: gr }),
            /* @__PURE__ */ a(kt, { htmlFor: gr, children: U(J, Lt) })
          ] }, gr))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { children: D }),
      x
    ] }),
    l === "radio" && t === "range" && yt,
    l === "dropdown" && ue && /* @__PURE__ */ a(La, { open: Z === "selectedBooks", onOpenChange: Rr, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Mi,
        onCloseAutoFocus: fo,
        ...
        children: /* @__PURE__ */ u(wa, { container: Or, children: [
          ...
          /* @__PURE__ */ u(Mo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Rr(!1), children: nt }),
            /* @__PURE__ */ a(B, { onClick: go, children: at })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ee && /* @__PURE__ */ a(La, { open: Z === "range", onOpenChange: Rr, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Ye,
        onCloseAutoFocus: fo,
        ...
        children: /* @__PURE__ */ u(wa, { container: Xt, children: [
          /* @__PURE__ */ a(Gr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Hr, { children: q }) }),
          yt,
          /* @__PURE__ */ u(Mo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Rr(!1), children: nt }),
            /* @__PURE__ */ a(B, { ref: Ve, onClick: go, children: at })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: wr },
            children: t.map((l) => /* @__PURE__ */ a(pe, { value: `${l}`, children: c[bo(l)] }, `${l}`))
          }
        )
      ]
    }
...
const Ci = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(ce, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Wi, { children: c.label }),
    /* @__PURE__ */ a(Xi, { children: /* @__PURE__ */ a(Ji, { children: Ci(
      t,
      e,
      Ni(t, c.id),
      o
...
function Ga({
  ...
  return /* @__PURE__ */ u(Me, { variant: i, children: [
    /* @__PURE__ */ a(Oe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ls, {}) }) }),
    /* @__PURE__ */ a($e, { align: "start", style: { zIndex: wr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(xn, { children: [
      /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(ie, { children: Ci(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Ze, {})
    ] }, d)) })
  ] });
}
const Ei = ft.forwardRef(
...
const Ti = ft.forwardRef(({ className: t, ...e }, r) => {
  const o = Bt();
  return /* @__PURE__ */ a(
    fe.Root,
    {
...
const zi = ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.List,
  {
    ref: r,
    className: f(
...
zi.displayName = fe.List.displayName;
const eu = ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Trigger,
  {
    ref: r,
    ...e,
...
)), Si = ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Content,
  {
    ref: r,
    className: f(
...
Si.displayName = fe.Content.displayName;
function ah({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ti, { children: [
      /* @__PURE__ */ a(zi, { children: t.map((c) => /* @__PURE__ */ a(eu, { value: c.value, children: c.value }, c.key)) }),
...
function ru({
  ...
  return /* @__PURE__ */ a(Zi.Provider, { value: o, children: /* @__PURE__ */ a(
    Ne.Root,
    {
      "data-slot": "menubar",
      className: f(
...
function du({
  ...
  return /* @__PURE__ */ u(
    Ne.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a($n, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(du, { children: l.label }),
        /* @__PURE__ */ a(wu, { children: Di(
          t,
          e,
          Ni(t, l.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(cu, {}, `separator-${i}`)), d;
  });
};
function uu({
  menuData: t,
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), vr(i, [h, g]);
        break;
      case "alt+l":
        (k = s.current) == null || k.focus(), vr(s, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), vr(c, [h, g]);
        break;
      case "alt+h":
        (E = d.current) == null || E.focus(), vr(d, [h, g]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ a(ru, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(au, { children: [
      /* @__PURE__ */ a(nu, { ref: l(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        iu,
        {
          style: { zIndex: wr },
          children: /* @__PURE__ */ a(ie, { children: Di(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ih({
  ...
  return /* @__PURE__ */ u("div", { id: d, className: f("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(kt, { className: "tw:font-normal tw:text-muted-foreground", children: ze(l, {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Me, { children: [
              /* @__PURE__ */ a(Oe, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(_o, {}) }) }),
...
function yh({
  ...
  return /* @__PURE__ */ u(
    Ot.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a($n, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function jh({
  ...
  return /* @__PURE__ */ a(
    fe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", bu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  Wh as DropdownMenuShortcut,
  Yi as DropdownMenuSub,
  Ji as DropdownMenuSubContent,
  ...
  pw as MarkerMenu,
  vp as MoreInfo,
  fi as MultiSelectComboBox,
  ah as NavigationContentSearch,
  Pe as Popover,
  qi as PopoverAnchor,
  Ie as PopoverContent,
  Xh as PopoverDescription,
  Jh as PopoverHeader,
  ...
  tg as ResizablePanel,
  eg as ResizablePanelGroup,
  $p as ResourcePickerDialog,
  ch as ResultsCard,
  ...
  rw as handleMarkerPaletteSessionKeyDown,
