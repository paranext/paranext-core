...
import { ChevronRight as ci, Check as Sn, Circle as di, X as fo, Search as pi, ChevronsUpDown as ui, FilterIcon as tl, ChevronDown as ar, ChevronUp as el, ArrowLeftIcon as nl, ChevronLeftIcon as rl, ChevronRightIcon as ol, ArrowRightIcon as al, CircleCheckIcon as il, CircleXIcon as sl, CircleHelpIcon as ll, ArrowUpIcon as cl, ArrowDownIcon as dl, ArrowUpDownIcon as pl, Star as ul, PanelLeft as wl, PanelRight as fl, ChevronLeft as ml, LoaderCircle as hl, Download as gl, Filter as bl, User as vl, Link as yl, CircleHelp as xl } from "lucide-react";
import { getChaptersForBook as Nl, deepEqual as mo, substring as kl, formatScrRef as Mr, compareScrRefs as Jr, scrRefToBBBCCCVVV as Ar, getLocalizeKeyForScrollGroupId as pt, NumberFormat as El, formatBytes as Sl } from "platform-bible-utils";
...
import { useReactTable as fi, getFilteredRowModel as Tl, getSortedRowModel as mi, getPaginationRowModel as Cl, getCoreRowModel as hi, flexRender as fn, getGroupedRowModel as Ol, getExpandedRowModel as Rl } from "@tanstack/react-table";
...
import { MenuItem as Il, ListItemText as Ml, ListItemIcon as vi, Menu as Al, Grid as yi, List as Dl, IconButton as xi, Drawer as jl, AppBar as Bl, Toolbar as Vl } from "@mui/material";
...
const ho = ft.Root, Ni = ft.Trigger, Yl = ft.Group, $m = ft.Portal, Im = ft.Sub, Mm = ft.RadioGroup, Hl = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  ft.SubTrigger,
  {
    ref: o,
    className: N(
...
Hl.displayName = ft.SubTrigger.displayName;
const ql = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ft.SubContent,
  {
    ref: n,
    className: N(
...
ql.displayName = ft.SubContent.displayName;
...
const xo = ot.allBookIds.filter((t) => !ot.isObsolete(ot.bookIdToNumber(t))), dc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, wa = ["OT", "NT", "DC"], pc = 96, uc = [
  /^(\w+)$/i,
...
], on = (t) => Nl(ot.bookIdToNumber(t));
function wc() {
  return xo.map((e) => ot.bookIdToEnglishName(e));
}
function fc(t) {
  return wc().includes(t);
}
function mc(t) {
...
function Dm({ scrRef: t, handleSubmit: e, getActiveBookIds: n }) {
  const r = xt(), [o, a] = ut(""), [i, l] = ut(
    ...
    uc.forEach(($) => {
      const F = o.match($);
      if (F) {
        const [B, D = void 0, U = void 0] = F.slice(1), nt = mc(B);
  ...
  return se(() => {
    ...
    const $ = setTimeout(() => {
      if (v && k.current && T.current) {
        const B = T.current.offsetTop - pc;
      ...
      sr,
      {
        ...
        children: /* @__PURE__ */ s("div", { className: "rtl:tw-ps-2", children: wa.map(($, F) => {
          ...
          return B.length > 0 && /* @__PURE__ */ x("div", { children: [
            /* @__PURE__ */ s(lr, { className: "tw-font-semibold tw-text-foreground/80", children: dc[$] }),
...
const hc = We(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? qe : "button", { className: N(hc({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const gc = We(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), At = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(wi.Root, { ref: n, className: N("pr-twp", gc(), t), ...e }));
...
const bc = qt.Portal, Mi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  qt.Overlay,
  {
    ref: n,
    className: N(
...
vc.displayName = qt.Content.displayName;
...
yc.displayName = qt.Title.displayName;
...
xc.displayName = qt.Description.displayName;
...
Nc.displayName = _t.Separator.displayName;
...
function eo({
  ...
  const [h, k] = ut(!1);
  return /* @__PURE__ */ x($i, { open: h, onOpenChange: k, ...m, children: [
...
var Sc = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(Sc || {});
...
function Bm({
  ...
  const p = Dr(d, "%webView_bookSelector_currentBook%"), f = Dr(d, "%webView_bookSelector_choose%"), w = Dr(d, "%webView_bookSelector_chooseBooks%"), [g, v] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), m = (h) => {
    v(h), t(h);
...
const Ve = bt.Root, Cc = bt.Group, ze = bt.Value, Ne = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = xt();
  return /* @__PURE__ */ x(
    bt.Trigger,
    {
...
Oc.displayName = bt.Label.displayName;
...
Rc.displayName = bt.Separator.displayName;
function _c({ table: t }) {
...
function Ic({
  ...
  var h;
  const [l, c] = ut([]), [d, p] = ut([]), [f, w] = ut({}), [g, v] = ut({}), m = fi({
    data: e,
    columns: t,
    getCoreRowModel: hi(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ s(Tc, { table: m }),
    /* @__PURE__ */ x(dr, { stickyHeader: a, children: [
      /* @__PURE__ */ s(pr, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ s(ie, { children: k.headers.map((T) => /* @__PURE__ */ s(yn, { children: T.isPlaceholder ? void 0 : fn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
      /* @__PURE__ */ s(ur, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ s(
        ie,
        {
          onClick: () => i(k, m),
...
}, jc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Bi = We(
...
), Bc = S.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  gi.Root,
  {
    ref: o,
...
Bc.displayName = gi.Root.displayName;
...
const wr = (t) => t === "asc" ? /* @__PURE__ */ s(cl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(dl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(pl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Vm = (t) => ({
  accessorKey: "item",
  ...
  return Ac(t).forEach((p) => {
    p.startsWith("\\id") && (i = Dc(p), l = 0, c = 0), p.startsWith("\\c") && (l = fa(p), c = 0), p.startsWith("\\v") && (c = fa(p), l === 0 && (l = e.chapterNum));
    let f = o.exec(p) ?? void 0;
    for (; f; ) {
      const w = [];
      f.forEach((h) => w.push(h));
      const g = f.index, v = a.find((h) => mo(h.items, w)), m = {
        reference: {
...
function Gm({
  ...
  const f = Zt(n, "%webView_inventory_all%"), w = Zt(n, "%webView_inventory_approved%"), g = Zt(n, "%webView_inventory_unapproved%"), v = Zt(n, "%webView_inventory_unknown%"), m = Zt(n, "%webView_inventory_scope_currentBook%"), h = Zt(n, "%webView_inventory_scope_chapter%"), k = Zt(n, "%webView_inventory_scope_verse%"), T = Zt(n, "%webView_inventory_filter_text%"), C = Zt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [I, V] = ut("all"), [R, P] = ut(""), [G, A] = ut([]), Q = Ct(() => l ? r instanceof RegExp ? Fc(
    l,
    t,
    a,
    i,
...
function Lc({
  ...
  return /* @__PURE__ */ s("div", { className: d, children: /* @__PURE__ */ x($i, { open: p, onOpenChange: f, children: [
    /* @__PURE__ */ s(Ii, { asChild: !0, children: /* @__PURE__ */ x(
      wt,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ s(No, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(ko, { children: [
      ...
      /* @__PURE__ */ x(So, { children: [
        ...
        /* @__PURE__ */ s(Ai, { children: v.map((m) => {
          ...
          return /* @__PURE__ */ x(
            Co,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ s("div", { className: "tw-w-4", children: m.starred && /* @__PURE__ */ s(ul, { className: "tw-h-4 tw-w-4" }) }),
...
function Um({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(Li, { children: [
      /* @__PURE__ */ s(Gi, { children: t.map((i) => /* @__PURE__ */ s(Gc, { value: i.value, children: i.value }, i.key)) }),
...
const Uc = Tn.Provider, Xc = Tn.Root, Yc = Tn.Trigger, Xi = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  Tn.Content,
  {
    ref: r,
    sideOffset: e,
...
const Hc = "16rem", qc = "3rem", Yi = S.createContext(void 0);
function fr() {
...
const Hi = S.forwardRef(
  ({
    ...
    return /* @__PURE__ */ s(Yi.Provider, { value: T, children: /* @__PURE__ */ s(Uc, { delayDuration: 0, children: /* @__PURE__ */ s(
      "div",
      {
        style: (
...
const Wc = S.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = fr();
  return /* @__PURE__ */ x(
    wt,
    {
...
td.displayName = "SidebarSeparator";
...
const ed = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? qe : "button",
  {
    ref: r,
  ...
  ({
    ...
    const c = t ? qe : "button", { state: d } = fr(), p = /* @__PURE__ */ s(
      c,
      {
        ...
        "data-size": r,
        "data-active": e,
        className: N(nd({ variant: n, size: r }), a),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ x(Xc, { children: [
      /* @__PURE__ */ s(Yc, { asChild: !0, children: p }),
      /* @__PURE__ */ s(Xi, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
Qi.displayName = "SidebarMenuButton";
const rd = S.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ s(
  e ? qe : "button",
  {
    ref: o,
...
const ad = S.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
...
const ld = S.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ s(
  t ? qe : "a",
  {
    ref: a,
    ...
    qi,
    {
      ...
      children: /* @__PURE__ */ x(Ki, { children: [
        /* @__PURE__ */ x(no, { children: [
          ...
          /* @__PURE__ */ s(oo, { children: /* @__PURE__ */ s(Ji, { children: e.map((f) => /* @__PURE__ */ s(Zi, { children: /* @__PURE__ */ s(
            Qi,
            {
              className: N(
...
function Xm({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-box-border tw-flex tw-h-full tw-flex-col tw-p-3", children: [
    ...
    /* @__PURE__ */ x(Hi, { id: t, className: "tw-h-full tw-flex-1 tw-gap-4 tw-overflow-auto", children: [
      /* @__PURE__ */ s(
        cd,
        {
          extensionLabels: e,
      ...
      /* @__PURE__ */ s(Wi, { className: "tw-overflow-y-auto", children: r })
    ] })
  ] });
}
const oe = "scrBook", dd = "scrRef", fe = "source", pd = "details", ud = "Scripture Reference", wd = "Scripture Book", ts = "Type", fd = "Details";
function md(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: oe,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? ud,
      cell: (r) => {
...
}, ha = (t) => `${hd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ym({
  sources: t,
    ...
    !e && /* @__PURE__ */ x(
      Ve,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(ke, { position: "item-aligned", children: /* @__PURE__ */ s(Cc, { children: C.map((R) => /* @__PURE__ */ s(Bt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(dr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(pr, { children: h.getHeaderGroups().map((R) => /* @__PURE__ */ s(ie, { children: R.headers.filter((P) => P.column.columnDef.header).map((P) => (
      ...
      /* @__PURE__ */ s(ur, { children: h.getRowModel().rows.map((R, P) => {
        const G = xt();
        return /* @__PURE__ */ s(
          ie,
          {
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ x(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (G === "ltr" ? /* @__PURE__ */ s(ci, {}) : /* @__PURE__ */ s(ml, {})),
                          " ",
...
var ya;
function rs() {
  return ya || (ya = 1, process.env.NODE_ENV === "production" ? zn.exports = vd() : zn.exports = yd()), zn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function kd() {
  if (Sa) return Xr;
  Sa = 1;
  var t = rs(), e = xd(), n = /* @__PURE__ */ Po(), r = /* @__PURE__ */ os(), o = /* @__PURE__ */ Nd(), a = function() {
  };
...
function Sd() {
  ...
  if (Ca = 1, process.env.NODE_ENV !== "production") {
    var t = rs(), e = !0;
    Vn.exports = /* @__PURE__ */ kd()(t.isElement, e);
  } else
    Vn.exports = /* @__PURE__ */ Ed()();
  return Vn.exports;
}
var Td = /* @__PURE__ */ Sd();
const u = /* @__PURE__ */ es(Td);
function Cd(t) {
  const {
    prototype: e = {}
  } = t;
...
function as(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Cd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${i}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
var _a;
function $d() {
  return _a || (_a = 1, process.env.NODE_ENV === "production" ? Fn.exports = _d() : Fn.exports = Pd()), Fn.exports;
}
var Pa = $d();
...
function is(t, e = "") {
  return t.displayName || t.name || Md(t) || e;
}
function $a(t, e, n) {
  const r = is(e);
...
function pn() {
  const t = Ud(Cn.create).current;
  return Yd(t.disposeEffect), t;
}
let mr = !0, io = !1;
const Hd = new Cn(), qd = {
  text: !0,
...
function Wd(t) {
  ...
  return !!(n === "INPUT" && qd[e] && !t.readOnly || n === "TEXTAREA" && !t.readOnly || t.isContentEditable);
}
function Kd(t) {
...
function Zd(t) {
  t.addEventListener("keydown", Kd, !0), t.addEventListener("mousedown", Hr, !0), t.addEventListener("pointerdown", Hr, !0), t.addEventListener("touchstart", Hr, !0), t.addEventListener("visibilitychange", Jd, !0);
}
function Qd(t) {
  const {
    target: e
...
function ds() {
  const t = j.useCallback((o) => {
    o != null && Zd(o.ownerDocument);
  }, []), e = j.useRef(!1);
  function n() {
    return e.current ? (io = !0, Hd.start(100, () => {
      io = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
    return Qd(o) ? (e.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: e,
    onFocus: r,
...
function ep(t, e = Number.MIN_SAFE_INTEGER, n = Number.MAX_SAFE_INTEGER) {
...
const np = ["values", "unit", "step"], rp = (t) => {
...
function op(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = kt(t, np), a = rp(e), i = Object.keys(a);
  function l(w) {
...
function vt(t) {
  const {
    ...
    return te(i, l, (f) => {
      let w = Zn(d, o, f);
      return f === w && typeof f == "string" && (w = Zn(d, o, `${e}${f === "default" ? "" : Wt(f)}`, f)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
const cp = {
  ...
  if (t.length > 2)
    if (Ba[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = cp[e], o = dp[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), br = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], vr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], up = [...br, ...vr];
function On(t, e, n, r) {
  var o;
...
function fp(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = pp(n), a = wp(o, r), i = t[n];
  return te(t, i, a);
}
function hs(t, e) {
  const n = ms(t.theme);
  return Object.keys(t).map((r) => fp(t, e, r, n)).reduce(mn, {});
}
function ht(t) {
  return hs(t, br);
}
...
gt.filterProps = vr;
process.env.NODE_ENV !== "production" && up.reduce((t, e) => (t[e] = le, t), {});
function mp(t = 8) {
  if (t.mui)
    return t;
  const e = ms({
...
const hp = Gt("border", Vt), gp = Gt("borderTop", Vt), bp = Gt("borderRight", Vt), vp = Gt("borderBottom", Vt), yp = Gt("borderLeft", Vt), xp = Gt("borderColor"), Np = Gt("borderTopColor"), kp = Gt("borderRightColor"), Ep = Gt("borderBottomColor"), Sp = Gt("borderLeftColor"), Tp = Gt("outline", Vt), Cp = Gt("outlineColor"), xr = (t) => {
...
yr(hp, gp, bp, vp, yp, xp, Np, kp, Ep, Sp, xr, Tp, Cp);
const Nr = (t) => {
...
yr(Nr, kr, Er, Op, Rp, _p, Pp, $p, Ip, Mp, Ap, Dp);
function Be(t, e) {
  return e === "grey" ? e : t;
}
const jp = vt({
...
function qp() {
  function t(n, r, o, a) {
    ...
    return f ? f(i) : te(i, r, (v) => {
      let m = Zn(w, p, v);
      return v === m && typeof v == "string" && (m = Zn(w, p, `${n}${v === "default" ? "" : Wt(v)}`, v)), c === !1 ? m : {
        [c]: m
      };
    });
  }
...
const Kp = ["breakpoints", "palette", "spacing", "shape"];
function jo(t = {}, ...e) {
  const {
    breakpoints: n = {},
    palette: r = {},
  ...
  return d.applyStyles = Wp, d = e.reduce((p, f) => Qt(p, f), d), d.unstable_sxConfig = _({}, Do, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return Sr({
      sx: f,
      theme: this
    });
...
const Qp = ["ownerState"], tu = ["variants"], eu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function nu(t) {
  return Object.keys(t).length === 0;
}
function ru(t) {
...
const ou = jo(), Va = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Ln({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function iu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    $l(i, (b) => b.filter((I) => !(I != null && I.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = au(Va(d))
    } = l, g = kt(l, eu), v = p !== void 0 ? p : (
    ...
    let k = Hn;
    d === "Root" || d === "root" ? k = r : d ? k = o : ru(i) && (k = void 0);
    const T = _l(i, _({
      shouldForwardProp: k,
      label: h
      ...
      if (process.env.NODE_ENV !== "production") {
        let A;
        c && (A = `${c}${Wt(d || "")}`), A === void 0 && (A = `Styled(${Ad(i)})`), G.displayName = A;
      }
...
function Bo(t, e = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (t < e || t > n) && console.error(`MUI: The value provided ${t} is out of range [${e}, ${n}].`), ep(t, e, n);
}
function cu(t) {
  t = t.slice(1);
...
function za(t) {
  t = Se(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Se(du(t)).values : t.values;
...
const Nn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, mu = ["mode", "contrastThreshold", "tonalOffset"], La = {
...
function Ga(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = uu(t.main, o) : e === "dark" && (t.dark = pu(t.main, a)));
}
function hu(t = "light") {
  return t === "dark" ? {
    main: Ie[200],
...
function Nu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = kt(t, mu), a = t.primary || hu(e), i = t.secondary || gu(e), l = t.error || bu(e), c = t.info || vu(e), d = t.success || yu(e), p = t.warning || xu(e);
  function f(m) {
    const h = Fa(m, qr.text.primary) >= n ? qr.text.primary : La.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Fa(m, h);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ga(m, "light", T, r), Ga(m, "dark", C, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, g = {
    dark: qr,
    light: La
  };
...
function Mu(t) {
  const e = _({}, Pu, t.easing), n = _({}, $u, t.duration);
  return _({
...
const Au = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Du = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function ju(t = {}, ...e) {
  const {
    mixins: n = {},
    palette: r = {},
...
`));
  ...
  return d.unstable_sxConfig = _({}, Do, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return Sr({
      sx: f,
      theme: this
    });
...
const Bu = (t) => Hn(t) && t !== "classes", _n = iu({
  themeId: zo,
  defaultTheme: Vo,
  rootShouldForwardProp: Bu
});
function Vu(t) {
...
const zu = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Fu = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
  ...
  const r = Fo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, zu), v = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), Xu = /* @__PURE__ */ gd(Uu);
var Ha;
function Yu() {
...
function Hu() {
  ...
  var e = t(/* @__PURE__ */ Yu()), n = Ks;
  return an.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), an;
}
var qu = /* @__PURE__ */ Hu();
const Wu = /* @__PURE__ */ es(qu);
function Ku(t) {
  return typeof t == "string";
}
function un(t, e, n) {
  return t === void 0 || Ku(t) ? e : _({}, e, {
    ownerState: _({}, e.ownerState, n)
  });
}
const Ju = {
  disableDefaultClasses: !1
}, Zu = /* @__PURE__ */ j.createContext(Ju);
function Qu(t) {
  const {
...
function nw(t) {
  ...
  const i = tw(_({}, o, r)), l = Wa(r), c = Wa(o), d = e(i), p = ve(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
process.env.NODE_ENV !== "production" && (tr.propTypes = Rd(tr.propTypes));
var Ot = "top", Ft = "bottom", Lt = "right", Rt = "left", Lo = "auto", Pn = [Ot, Ft, Lt, Rt], Ue = "start", kn = "end", cw = "clippingParents", Ns = "viewport", ln = "popper", dw = "reference", Ka = /* @__PURE__ */ Pn.reduce(function(t, e) {
  return t.concat([e + "-" + Ue, e + "-" + kn]);
}, []), ks = /* @__PURE__ */ [].concat(Pn, [Lo]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Ue, e + "-" + kn]);
}, []), pw = "beforeRead", uw = "read", ww = "afterRead", fw = "beforeMain", mw = "main", hw = "afterMain", gw = "beforeWrite", bw = "write", vw = "afterWrite", yw = [pw, uw, ww, fw, mw, hw, gw, bw, vw];
function Kt(t) {
...
function $n(t) {
  for (var e = Dt(t), n = Ja(t); n && Ew(n) && ee(n).position === "static"; )
    n = Ja(n);
  return n && (Kt(n) === "html" || Kt(n) === "body" && ee(n).position === "static") ? e : n || Sw(t) || e;
}
function Xo(t) {
...
function Ow(t) {
  ...
  if (!(!a || !i)) {
    var f = Cw(o.padding, n), w = Uo(a), g = c === "y" ? Ot : Rt, v = c === "y" ? Ft : Lt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = $n(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, E = f[g], b = T - w[p] - f[v], I = T / 2 - w[p] / 2 + C, V = hn(E, I, b), R = c;
...
function ti(t, e, n) {
  return e === Ns ? lo(Vw(t, n)) : Te(e) ? Fw(e, n) : lo(zw(ce(t)));
}
function Lw(t) {
...
function Gw(t, e, n, r) {
  var o = e === "clippingParents" ? Lw(t) : [].concat(e), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, d) {
    var p = ti(t, d, r);
...
function En(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? cw : l, d = n.rootBoundary, p = d === void 0 ? Ns : d, f = n.elementContext, w = f === void 0 ? ln : f, g = n.altBoundary, v = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Cs(typeof h != "number" ? h : Os(h, Pn)), T = w === ln ? dw : ln, C = t.rects.popper, E = t.elements[v ? T : w], b = Gw(Te(E) ? E : E.contextElement || ce(t.elements.popper), c, p, i), I = Ye(t.elements.reference), V = _s({
    reference: I,
    element: C,
    placement: o
...
function Uw(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? ks : c, p = He(r), f = p ? l ? Ka : Ka.filter(function(v) {
    return He(v) === p;
...
function Yw(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Ht(h), T = k === h, C = c || (T || !v ? [Wn(h)] : Xw(h)), E = [h].concat(C).reduce(function(L, K) {
      return L.concat(Ht(K) === Lo ? Uw(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
...
function qw(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, i = En(e, {
    ...
    altBoundary: !0
  }), c = ei(i, r), d = ei(l, o, a), p = ni(c), f = ni(d);
  e.modifiersData[n] = {
...
function nf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = En(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Ht(e.placement), T = He(e.placement), C = !T, E = Xo(k), b = ef(E), I = e.modifiersData.popperOffsets, V = e.rects.reference, R = e.rects.popper, P = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, G = typeof P == "number" ? {
    mainAxis: P,
    altAxis: P
  ...
  if (I) {
    if (a) {
      var $, F = E === "y" ? Ot : Rt, B = E === "y" ? Ft : Lt, D = E === "y" ? "height" : "width", U = I[E], nt = U + h[F], at = U - h[B], y = g ? -R[D] / 2 : 0, O = T === Ue ? V[D] : R[D], X = T === Ue ? -R[D] : -V[D], Y = e.elements.arrow, L = g && Y ? Uo(Y) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var de, St = E === "x" ? Ot : Rt, Mn = E === "x" ? Ft : Lt, Xt = I[b], Ce = b === "y" ? "height" : "width", pe = Xt + h[St], Oe = Xt - h[Mn], Re = [Ot, Rt].indexOf(k) !== -1, _e = (de = A == null ? void 0 : A[b]) != null ? de : 0, ue = Re ? pe : Xt - V[Ce] - R[Ce] - _e + G.altAxis, Ze = Re ? Xt + V[Ce] + R[Ce] - _e - G.altAxis : Oe, An = g && Re ? Tw(ue, Xt, Ze) : hn(g ? ue : pe, Xt, g ? Ze : Oe);
      I[b] = An, Q[b] = An - Xt;
    }
    e.modifiersData[r] = Q;
  }
...
function lf(t, e, n) {
  n === void 0 && (n = !1);
  var r = zt(e), o = zt(e) && sf(e), a = ce(e), i = Ye(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  qo(a)) && (l = af(e)), zt(e) ? (c = Ye(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Ho(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = df(uf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (oi(T, C)) {
            p.rects = {
              reference: lf(T, $n(C), p.options.strategy === "fixed"),
              popper: Uo(C)
...
var ff = [Dw, tf, Mw, kw, Zw, Hw, rf, _w, Ww], mf = /* @__PURE__ */ wf({
  defaultModifiers: ff
});
const hf = "Popper";
function gf(t) {
...
const bf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], vf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function yf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Nf = () => Io({
  root: ["root"]
}, Qu(gf)), kf = {}, Ef = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, h = kt(e, bf), k = j.useRef(null), T = Ee(k, n), C = j.useRef(null), E = Ee(C, w), b = j.useRef(E);
  Ge(() => {
    b.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const I = yf(p, i), [V, R] = j.useState(I), [P, G] = j.useState(nr(o));
  j.useEffect(() => {
...
`));
  ...
  const Q = Nf(), $ = (r = v.root) != null ? r : "div", F = ow({
    elementType: $,
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, T = kt(e, vf), [C, E] = j.useState(!0), b = () => {
    E(!1);
  }, I = () => {
    E(!0);
  };
...
`));
      } else if (!e || typeof e.getBoundingClientRect != "function" || xf(e) && e.contextElement != null && e.contextElement.nodeType !== 1)
...
var Tf = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.shape({
  enter: u.number,
  exit: u.number,
  appear: u.number
}).isRequired]) : null;
...
const Rf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function uo(t) {
  return `scale(${t}, ${t ** 2})`;
}
const _f = {
  ...
  const {
  ...
  } = e, k = kt(e, Rf), T = pn(), C = j.useRef(), E = $s(), b = j.useRef(null), I = Ee(b, a.ref, n), V = (B) => (D) => {
    if (B) {
      const U = b.current;
      D === void 0 ? B(U) : B(U, D);
    }
    ...
    m === "auto" ? (at = E.transitions.getAutoHeightDuration(B.clientHeight), C.current = at) : at = D, B.style.transition = [E.transitions.create("opacity", {
      ...
      easing: nt
    })].join(","), B.style.opacity = 0, B.style.transform = uo(0.75), f && f(B);
  }), $ = V(w);
...
rr.muiSupportAuto = !0;
const Pf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], $f = _n(Ps, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = gs(), a = Fo({
    ...
    slots: C,
    slotProps: E
  } = a, b = kt(a, Pf), I = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, V = _({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const ae = fs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), Mf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Af(t) {
  return Math.round(t * 1e5) / 1e5;
}
const Df = (t) => {
...
const Ms = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const I = Fo({
    ...
    TransitionProps: Nt
  } = I, z = kt(I, Mf), yt = /* @__PURE__ */ j.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
...
`));
  const Xs = j.useMemo(() => {
    ...
    touch: pe.current
  }), Ir = Df(nn), ia = (r = (o = Z.popper) != null ? o : P.Popper) != null ? r : jf, sa = (a = (i = (l = Z.transition) != null ? l : P.Transition) != null ? i : M) != null ? a : rr, la = (c = (d = Z.tooltip) != null ? d : P.Tooltip) != null ? c : Bf, ca = (p = (f = Z.arrow) != null ? f : P.Arrow) != null ? p : Vf, Ys = un(ia, _({}, H, (w = J.popper) != null ? w : G.popper, {
    className: ve(Ir.popper, H == null ? void 0 : H.className, (g = (v = J.popper) != null ? v : G.popper) == null ? void 0 : g.className)
  }), nn), Hs = un(sa, _({}, Nt, (m = J.transition) != null ? m : G.transition), nn), qs = un(la, _({}, (h = J.tooltip) != null ? h : G.tooltip, {
  ...
  const {
    ...
    Il,
    {
      ...
      children: n ? /* @__PURE__ */ x(ne, { children: [
        ...
        f ? /* @__PURE__ */ s(vi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(Wu, {}) }) : li(i, n, !1)
      ] }) : h
    }
  );
...
const Ff = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function js(t) {
...
const In = or(({ className: t, ...e }, n) => /* @__PURE__ */ s(hl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
), Wf = S.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: N(qf({ variant: e }), t), ...n }));
Wf.displayName = "Alert";
...
const Jf = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: N("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
function Qf({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ s("div", { className: N("pr-twp", Zf({ variant: e }), t), ...n });
}
...
const rm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("p", { ref: n, className: N("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
rm.displayName = "CardDescription";
...
const im = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ x(
    dn.Root,
    {
...
im.displayName = dn.Root.displayName;
...
sm.displayName = Qr.Root.displayName;
const nh = Pt.Root, lm = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    Pt.List,
    {
...
const cm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Trigger,
  {
    ref: n,
    className: N(
...
cm.displayName = Pt.Trigger.displayName;
...
dm.displayName = Pt.Content.displayName;
function rh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ s(
    wt,
    {
      ...
      children: t ? /* @__PURE__ */ s(In, { size: 15 }) : /* @__PURE__ */ x(ne, { children: [
        /* @__PURE__ */ s(gl, { size: 25, className: N("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
const pm = or((t, e) => /* @__PURE__ */ x(
  wt,
  {
    ...
    ...t,
    children: [
      /* @__PURE__ */ s(bl, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ s(
        ar,
        {
...
function lh({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ x(ho, { children: [
    /* @__PURE__ */ s(Ni, { asChild: !0, children: /* @__PURE__ */ s(pm, {}) }),
    /* @__PURE__ */ s(sr, { children: e.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ s(lr, { children: n.label }),
      /* @__PURE__ */ s(Yl, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(go, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(Ei, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(cr, {})
    ] }, n.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ x("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ s(vl, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ x("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ x(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ s(yl, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ x(
...
function wm({ id: t, versionHistory: e }) {
...
function ph({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ x("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ s(wm, { versionHistory: o }),
...
function uh({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ s("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ x(Qf, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ s(
          wt,
          {
            variant: "ghost",
...
export {
  ...
  Qf as Badge,
  Dm as BookChapterControl,
  Sc as BookSelectionMode,
  Bm as BookSelector,
  wt as Button,
  tm as Card,
  om as CardContent,
  ...
  Im as DropdownMenuSub,
  ql as DropdownMenuSubContent,
  ...
  ph as Footer,
  Uf as GridMenu,
  Hf as HamburgerMenuButton,
  Lm as INVENTORY_STRING_KEYS,
  Zm as IconButton,
  Ke as Input,
  rh as InstallButton,
  Gm as Inventory,
  ...
  Ym as ScriptureResultsViewer,
  Hm as ScrollGroupSelector,
  Fi as SearchBar,
  Ve as Select,
  ke as SelectContent,
  Cc as SelectGroup,
  ...
  Wm as SettingsListItem,
  cd as SettingsSidebar,
  Xm as SettingsSidebarContentSearch,
  im as Slider,
  eh as Sonner,
  In as Spinner,
  sm as Switch,
  ...
  zm as inventoryCountColumn,
  Vm as inventoryItemColumn,
  Fm as inventoryStatusColumn,
  bh as sonner,
  fh as useEvent,
  mh as useEventAsync,
  wo as usePromise
