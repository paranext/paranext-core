...
import { c as v, g as Ee, a as Ba, C as ke, A as ie, P as De, b as We, B as q, d as Oe, e as Me, f as $e, h as xe, i as Ai, k as Pi, j as Vi, E as ji, l as Fa, r as pe, m as Li, n as cn, o as Qr, p as ta, L as Nt, R as Ua, q as qr, D as _a, s as Na, t as Ca, u as Ea, T as ln, v as Vr, w as Pt, x as Ka, y as Vt, z as jt, F as Lt, G as dn, H as qa, I as Ge, J as kr, K as Ie, M as Ae, N as Pe, S as _r, O as er, Q as Bi, U as Er, V as Ye, W as ze, Z as Xe, X as Te, Y as rr, _ as Ga, $ as Ha, a0 as Gr, a1 as Ya, a2 as wn, a3 as Fi, a4 as Ui, a5 as Ki, a6 as Ta, a7 as un, a8 as ea, a9 as pn, aa as qi, ab as Gi, ac as Hi, ad as Yi, ae as hn, af as Wi, ag as sa, ah as bo, ai as ca, aj as Xi, ak as Ji, al as Zi, am as Qi, an as ts, ao as Tr, ap as Wa, aq as es, ar as rs } from "./resizable-aPuquhT0.js";
import { as as Xh, at as Jh, au as Zh, av as Qh, aw as tg, ax as eg, ay as rg, az as ag, aA as og, aB as ng, aC as ig, aD as sg, aE as cg, aF as lg, aG as dg, aH as wg, aI as ug, aJ as pg, aK as hg, aL as gg, aM as fg, aN as mg, aO as vg, aP as bg, aQ as xg } from "./resizable-aPuquhT0.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Se, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as za, ChevronRight as Sa, ArrowLeft as as, ArrowRight as os, ChevronDown as nr, BoldIcon as ns, ItalicIcon as is, X as Xa, AtSign as gn, Pencil as ss, Trash2 as cs, ArrowUp as fn, MoreHorizontal as ls, MailOpen as ds, Mail as ws, ChevronUp as us, FilterIcon as ps, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as fs, ArrowRightIcon as ms, Copy as mn, Filter as vs, User as bs, Link as xs, CircleHelp as ys, Undo as ks, Redo as _s, SquareX as vn, FunctionSquare as bn, SquareSigma as xn, Ban as Ns, AlertCircle as Ra, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as zs, ArrowDownIcon as Ss, ScrollText as Rs, ChevronsUpDown as Ds, MenuIcon as Os, Menu as Ms, EllipsisVertical as $s, MoreVertical as Is } from "lucide-react";
import { Section as dt, getChaptersForBook as As, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ps, formatReplacementString as He, sanitizeHtml as Ja, NumberFormat as yn, formatBytes as Vs, getCurrentLocale as js, usfmMarkers as jr, getFormatCallerFunction as Ls, deepEqual as Bs, isString as _o, compareScrRefs as Da, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as No, formatReplacementStringToArray as Co, collectUsjMarkers as Us } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Ks, useLayoutEffect as Qt, createContext as Za, useContext as kn, Component as qs, createElement as Eo, Suspense as Gs, forwardRef as _n, useId as To, Fragment as ra } from "react";
...
import { createEditor as En, $getRoot as Re, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as Qa, ParagraphNode as Tn, TextNode as zn, $getPreviousSelection as ac, $isRangeSelection as we, $caretFromPoint as oc, $getSiblingCaret as Sn, $getChildCaret as nc, $getAdjacentChildCaret as ic, $isChildCaret as sc, $normalizeCaret as cc, $setSelectionFromCaretRange as lc, $getCollapsedCaretRange as dc, $getCaretInDirection as zo, $splitAtPointCaretNext as wc, $isTextPointCaret as uc, $findMatchingParent as Rn, $isElementNode as Nr, mergeRegister as ye, getDOMTextNode as pc, isHTMLElement as hc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as to, shallowMergeConfig as gc, defineExtension as re, safeCast as Je, createState as fc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as Mn, COMMAND_PRIORITY_LOW as $n, RootNode as mc, LineBreakNode as vc, TabNode as bc, $isEditorState as xc, createCommand as yc, CLICK_COMMAND as kc, isDOMNode as _c, $getNodeFromDOMNode as Nc, $createNodeSelection as Cc, $setSelection as Ec, $getEditor as Tc, DecoratorNode as Oa, $getState as zc, toggleTextFormatType as So, TEXT_TYPE_TO_FORMAT as Sc, $setState as Rc, addClassNamesToElement as In, $create as Dc, $getNodeByKey as Oc, removeClassNamesFromElement as Mc, KEY_TAB_COMMAND as $c, $isBlockElementNode as Ic, $createRangeSelection as Ac, $normalizeSelection__EXPERIMENTAL as Pc, OUTDENT_CONTENT_COMMAND as Vc, INDENT_CONTENT_COMMAND as Ro, INSERT_TAB_COMMAND as jc, COMMAND_PRIORITY_CRITICAL as eo, $isDecoratorNode as Lc, $isParagraphNode as Bc, $isTextNode as Ma, SELECTION_CHANGE_COMMAND as An, $insertNodes as Fc } from "lexical";
...
import { Avatar as ro, Select as Gt, Checkbox as Do, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Oo, Slider as Or, Switch as Mo } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as $a, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as rl, isInsertEmbedOpOfType as Mr, Editorial as al } from "@eten-tech-foundation/platform-editor";
import { cva as ao } from "class-variance-authority";
...
function ua({
  ...
  const B = pe(), [z, I] = _(!1), [A, C] = _(""), [P, U] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      x[rt] = Ft[rt].filter((At) => Fa(At, P, n));
    }), x;
  }, [Ft, P, n]), R = D(
    () => ul(P, Jt, n),
    [P, Jt, n]
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = qn ? Qt : H, Ir = { tag: Qa };
...
function bl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return vl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: l }) => {
      e && i.size === 0 && s.size === 0 || t && l.has(Qa) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const oo = {
...
let Yr, be = 0, Wr = 0, Ll = 0, Pa = 0, Br = 0;
function Bo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Fl(t) {
  ...
  Yn(this), nt = t, this.f &= -2, 8 & this.f && io(this), oa();
}
function tr(t, e) {
...
function Jn(t, e = Xn) {
  return t.registerCommand(Dn, (r) => (t.update(e), !0), to);
}
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Zn], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Xt();
  if (Mn(n) || we(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function Qn(t, e) {
  let r;
...
const Va = re({ build: (t) => Qn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, ja = 1, ei = 2, fa = 3, Ar = 4, Qe = 5, ma = 6, mr = 7;
function va(t) {
  return t.id === so;
}
function ri(t) {
...
class or {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      va(i) || lt(300, s, n || "[unknown]"), va(c = i) || lt(304, String(c.id), String(so)), i = Object.assign(c, { id: ja }), o.state = i;
...
const Jl = /* @__PURE__ */ new Set(), Go = re({ build(t, e, r) {
  const o = r.getDependency(Va).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Qn(() => {
  }, () => ue(() => {
...
}, dependencies: [Va], name: "@lexical/extension/NodeSelection" }), Zl = yc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends Oa {
  static getType() {
...
re({ dependencies: [Va, Go], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return ye(t.registerCommand(Zl, (s) => {
    ...
    return !0;
  }, to), t.registerCommand(kc, (s) => {
    if (_c(s.target)) {
      const c = Nc(s.target);
      if (td(c)) return function(l, d = !1) {
        const w = Xt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Mn(w) ? g = w : (g = Cc(), Ec(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (we(f)) {
                ...
                if (Ma(m) && d >= 0 && w >= 0 && (E = d, y = d + w, f.setTextNodeRange(m, E, m, y)), E === y && p === "" || (f.insertRawText(p), m = b.getNode()), Ma(m)) {
                  E = h, y = h + g;
...
const Sd = "verseText", Wu = Object.freeze([
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : uo(m) && (m.preventDefault(), m.stopPropagation(), ee(i) && g());
        },
        onKeyDown: (m) => {
          wo(m), (m.key === "Enter" || m.key === " ") && m.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Xr,
          {
...
function Jo({
  ...
  const g = L(
    ...
    [t.user]
  ), y = D(() => Ja(t.contents), [t.contents]), N = D(
...
function mi({
  ...
  const [k, J] = _(Zo), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Bt] = _(!1), [K, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(O), [Ot, Ft] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
...
function Wd({
  ...
  var z;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [m, E] = _({}), y = D(() => e ?? [], [e]), N = Vn({
    data: y,
    columns: t,
    getCoreRowModel: Ln(),
  ...
  return l ? B = Array.from({ length: 10 }).map((C, P) => `skeleton-row-${P}`).map((C) => /* @__PURE__ */ a(Te, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Ga, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ha, { stickyHeader: i, children: N.getHeaderGroups().map((I) => /* @__PURE__ */ a(Te, { children: I.headers.map((A) => /* @__PURE__ */ a(Gr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : xr(A.column.columnDef.header, A.getContext()) }, A.id)) }, I.id)) }),
...
function wp({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ u(Ka, { children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      ...
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(ct, { children: [
          " ",
          /* @__PURE__ */ a(Ta, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      ...
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(ct, { children: [
          " ",
          /* @__PURE__ */ a(Ta, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function gp({
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === $a ? st = "generated" : it === Ia ? st = "hidden" : it && (N(it), B(it)), b(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), V = setTimeout(() => {
        var ht;
  ...
  const ut = L(
    (V, Q, et = !1) => {
      ...
      if (ot && Mr("note", ot)) {
        if (ot.insert.note) {
          let pt;
          V === "custom" ? pt = Q : V === "generated" ? pt = $a : pt = Ia, ot.insert.note.caller = pt;
        }
...
function xw({
  ...
  return /* @__PURE__ */ u(Ga, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ha, { stickyHeader: !0, children: /* @__PURE__ */ u(Te, { children: [
...
const yw = (t) => {
  ...
  return e ? e[1] : "";
}, _w = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Np = Object.freeze([
    ...
    Sw,
    {
      ...
      children: /* @__PURE__ */ u(Dw, { children: [
        /* @__PURE__ */ u(rn, { children: [
          ...
          /* @__PURE__ */ a(on, { children: /* @__PURE__ */ a(Ow, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Mw, { children: /* @__PURE__ */ a(
            Iw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Uw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Da(t.start, t.end) === 0 ? `${la(t.start)}+${e}` : `${la(t.start)}+${e}-${la(t.end)}+${r}`;
...
function Lp({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ga, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ha, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Te, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
      ...
      /* @__PURE__ */ a(Ya, { children: E.getRowModel().rows.map((C, P) => {
        const U = pe();
        return /* @__PURE__ */ a(
          Te,
          {
                    ...
                    children: k.getIsGrouped() ? /* @__PURE__ */ u(
                      q,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ a(Sa, {}) : /* @__PURE__ */ a(za, {})),
                          " ",
...
function Fp({
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Ut, ce] = _(null), Ue = 200, [Di, Oi] = _(!1);
  H(() => {
  ...
  }, []), vo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
        ...
        /* @__PURE__ */ a(
          Pe,
          {
            ...
            children: /* @__PURE__ */ u(sa, { container: Ut, children: [
              st.map(({ value: M, label: X, dropdownLabel: Yt, scrRefSuffix: fr, id: Mi }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: Ne(M),
    ...
    d === "radio" && t === "range" && At,
    d === "dropdown" && ht && /* @__PURE__ */ a(_a, { open: zt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: ft,
        onCloseAutoFocus: mo,
        ...
        children: /* @__PURE__ */ u(sa, { container: _t, children: [
          /* @__PURE__ */ a(Ca, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ea, { children: U }) }),
          hr,
    ...
    d === "dropdown" && pt && /* @__PURE__ */ a(_a, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: kt,
        onCloseAutoFocus: mo,
...
function nh({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function sh({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = D(() => {
    const c = new yn(o);
    return (l) => c.format(l);
...
export {
  ...
  op as AvatarImage,
  Gu as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  ...
  Wu as CONFLICT_NOTE_STRING_KEYS,
  ...
  Wd as DataTable,
  rh as DestructiveKeyConfirmation,
  _a as Dialog,
  Jh as DialogClose,
  Na as DialogContent,
  ...
  vw as FootnoteItem,
  mp as FootnoteList,
  Qp as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Np as INVENTORY_STRING_KEYS,
  ea as Input,
  th as InterfaceLanguagePicker,
  Cp as Inventory,
  Ta as Kbd,
  ag as KbdGroup,
  Nt as Label,
