...
import b, { forwardRef as nn, useRef as X, useMemo as F, useState as T, useCallback as G, useLayoutEffect as Wt, createContext as kn, useContext as pr, useEffect as q, Component as os, createElement as Pr, Suspense as as, Fragment as wo } from "react";
...
function Wd({
  ...
  const w = ft(), [p, u] = T(!1), [h, f] = T(""), [g, x] = T(""), [v, y] = T("books"), [N, _] = T(void 0), [k, z] = T(!1), L = X(void 0), R = X(void 0), $ = X(void 0), C = X(void 0), S = X({}), V = G(
    ...
    (E) => {
      if (E.ctrlKey) return;
      const { isLetter: Y, isDigit: nt } = Kr(E.key);
      if (v === "chapters") {
        if (E.key === "Backspace") {
...
const Nr = 0, sr = 1, ra = 2, Vn = 3, dn = 4, _e = 5, jn = 6, Ge = 7;
function zn(t) {
  return t.id === Nr;
}
function oa(t) {
...
function ow() {
  const { activeEditor: t } = ca(), [e, n] = T([]), o = G((a) => {
    if (Ze(a) || Ai(a)) {
      const i = [];
      no.forEach(({ format: s }) => {
...
function Xw({
  ...
  return /* @__PURE__ */ d(ke, { children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ti, { asChild: !0, children: /* @__PURE__ */ r(ze, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: Hw(t, n) }) }) }),
...
const uc = "16rem", mc = "3rem", Sa = b.createContext(void 0);
function In() {
...
const oe = "scrBook", Dc = "scrRef", fe = "source", Mc = "details", Oc = "Scripture Reference", Ic = "Scripture Book", La = "Type", Ac = "Details";
function Pc(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, io = (t) => `${$c({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function kp({
  sources: t,
...
function Op({
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Ba, { children: [
      /* @__PURE__ */ r(Ga, { children: t.map((l) => /* @__PURE__ */ r(jc, { value: l.value, children: l.value }, l.key)) }),
...
function qc({
  ...
  if (Gi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(zc, { children: [
...
const Yc = nn(({ className: t, ...e }, n) => /* @__PURE__ */ r($s, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
const qp = Vt.Trigger, wd = Vt.Portal, Up = Vt.Close, ts = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vt.Overlay,
  {
    ref: n,
