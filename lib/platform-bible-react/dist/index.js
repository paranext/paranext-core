...
const hs = C.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ y(
  we.Item,
  {
    ref: r,
    className: pe(
...
const vs = C.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ ne(
  we.CheckboxItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ y("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ y(we.ItemIndicator, { children: /* @__PURE__ */ y(rs, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
...
function Vh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ee(""), [o, i] = Ee(
    ...
    ge.bookNumberToId(e.bookNum)
  ), [d, g] = Ee(!1), [f, p] = Ee(d), h = Ct(void 0), m = Ct(void 0), v = Ct(void 0), w = Ne(
    (P) => pu(P).filter(($) => {
  ...
  }, [f]), /* @__PURE__ */ y("div", { children: /* @__PURE__ */ ne(ms, { modal: !1, open: d, onOpenChange: S, children: [
        ...
        children: [
          ...
          ni.map(
            (P, $) => w(P).length > 0 && /* @__PURE__ */ ne("div", { children: [
              ...
              ni.length - 1 !== $ ? /* @__PURE__ */ y(po, {}) : void 0
            ] }, P)
          )
        ]
      }
...
function $c(e) {
  const {
    ...
    open: d,
    rootRef: g
  } = e, f = C.useRef({}), p = C.useRef(null), h = C.useRef(null), m = Ge(h, g), [v, w] = C.useState(!d), k = Oc(u);
  let x = !0;
...
function Jc(e) {
  ...
  if (!(!i || !s)) {
    var g = Yc(o.padding, n), f = vo(i), p = u === "y" ? Me : Ie, h = u === "y" ? Ue : qe, m = n.rects.reference[d] + n.rects.reference[u] - s[u] - n.rects.popper[d], v = s[u] - n.rects.reference[u], w = kn(i), k = w ? u === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = m / 2 - v / 2, S = g[p], b = k - f[d] - g[h], T = k / 2 - f[d] / 2 + x, O = gn(S, T, b), D = u;
...
function xn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, a = n.boundary, u = a === void 0 ? Nc : a, c = n.rootBoundary, d = c === void 0 ? js : c, g = n.elementContext, f = g === void 0 ? rn : g, p = n.altBoundary, h = p === void 0 ? !1 : p, m = n.padding, v = m === void 0 ? 0 : m, w = qs(typeof v != "number" ? v : Ws(v, Pn)), k = f === rn ? Mc : rn, x = e.rects.popper, S = e.elements[h ? k : f], b = pd(kt(S) ? S : S.contextElement || ht(e.elements.popper), u, d, s), T = qt(e.elements.reference), O = Ks({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
...
function md(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !0 : s, u = n.fallbackPlacements, c = n.padding, d = n.boundary, g = n.rootBoundary, f = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, m = n.allowedAutoPlacements, v = t.options.placement, w = Ke(v), k = w === v, x = u || (k || !h ? [Gn(v)] : gd(v)), S = [v].concat(x).reduce(function(z, G) {
...
function Rd(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !1 : s, u = n.boundary, c = n.rootBoundary, d = n.altBoundary, g = n.padding, f = n.tether, p = f === void 0 ? !0 : f, h = n.tetherOffset, m = h === void 0 ? 0 : h, v = xn(t, {
    ...
    padding: g,
    altBoundary: d
  }), w = Ke(t.placement), k = Wt(t.placement), x = !k, S = bo(w), b = Ed(S), T = t.modifiersData.popperOffsets, O = t.rects.reference, D = t.rects.popper, V = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, L = typeof V == "number" ? {
    mainAxis: V,
    altAxis: V
  ...
  if (T) {
    ...
    if (a) {
      var Oe, be = S === "x" ? Me : Ie, bt = S === "x" ? Ue : qe, _e = T[b], Qe = b === "y" ? "height" : "width", Ae = _e + v[be], et = _e - v[bt], Ce = [Me, Ie].indexOf(w) !== -1, _t = (Oe = P == null ? void 0 : P[b]) != null ? Oe : 0, yt = Ce ? Ae : _e - O[Qe] - D[Qe] - _t + L.altAxis, Yt = Ce ? _e + O[Qe] + D[Qe] - _t - L.altAxis : et, Nn = p && Ce ? Kc(yt, _e, Yt) : gn(p ? yt : Ae, _e, p ? Yt : et);
      T[b] = Nn, $[b] = Nn - _e;
    }
    t.modifiersData[r] = $;
  }
...
const Hd = () => at({
  ...
  } = t, v = fe(t, Ld), w = C.useRef(null), k = Ge(w, n), x = C.useRef(null), S = Ge(x, f), b = C.useRef(S);
  Tt(() => {
    b.current = S;
...
`));
  ...
  return /* @__PURE__ */ ne(C.Fragment, {
    children: [/* @__PURE__ */ C.cloneElement(se, je), /* @__PURE__ */ y(Xo, E({
      as: W ?? la,
      placement: q,
      anchorEl: ee ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ ne(Yo, E({}, tl, {
          children: [ie, O ? /* @__PURE__ */ y(Jo, E({}, nl, {
            ref: Qe
          })) : null]
        }))
      }))
...
function Wi(e, t, n) {
  return e ? /* @__PURE__ */ y(ss, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ y("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function fa(e) {
  const {
    onClick: t,
    ...
    El,
    {
      ...
      children: n ? /* @__PURE__ */ ne(rr, { children: [
        ...
        g ? /* @__PURE__ */ y(ss, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ y(pa, {}) }) : Wi(s, n, !1)
      ] }) : v
    }
  );
...
function yg(e) {
  const [t, n] = Ee(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (c) => {
    ...
    ), /* @__PURE__ */ y(Mo, { ...e, includedGroups: c });
  };
  return /* @__PURE__ */ ne(rr, { children: [
...
function xg(e) {
  ...
  )), /* @__PURE__ */ y(Mo, { ...e, includedGroups: i });
}
function Sg({
  commandHandler: e,
  menuDefinition: t,
...
const vh = ye.Root, bh = ye.Value, Ba = C.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ne(
  ye.Trigger,
  {
    ...
    children: [
      t,
      /* @__PURE__ */ y(ye.Icon, { asChild: !0, children: /* @__PURE__ */ y(os, { className: "pr-h-4 pr-w-4 pr-opacity-50" }) })
    ]
  }
));
...
const za = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  ye.ScrollDownButton,
  {
    ...
    className: pe("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
    ...t,
    children: /* @__PURE__ */ y(os, { className: "pr-h-4 pr-w-4" })
  }
));
...
const Ga = C.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ne(
  ye.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ y("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ y(ye.ItemIndicator, { children: /* @__PURE__ */ y(rs, { className: "pr-h-4 pr-w-4" }) }) }),
...
function Xh({
  ...
  var p;
  const [o, i] = Ee([]), [s, a] = Ee([]), [u, c] = Ee({}), [d, g] = Ee({}), f = fh({
    data: t,
    columns: e,
    getCoreRowModel: nh(),
  ...
  return /* @__PURE__ */ ne("div", { children: [
    r && /* @__PURE__ */ y(Sh, { table: f }),
    /* @__PURE__ */ y("div", { className: "pr-rounded-md pr-border", children: /* @__PURE__ */ ne(Fa, { children: [
      /* @__PURE__ */ y(Da, { children: f.getHeaderGroups().map((h) => /* @__PURE__ */ y(Xn, { children: h.headers.map((m) => /* @__PURE__ */ y(La, { children: m.isPlaceholder ? void 0 : ts(m.column.columnDef.header, m.getContext()) }, m.id)) }, h.id)) }),
      /* @__PURE__ */ y(Va, { children: (p = f.getRowModel().rows) != null && p.length ? f.getRowModel().rows.map((h) => /* @__PURE__ */ y(Xn, { "data-state": h.getIsSelected() && "selected", children: h.getVisibleCells().map((m) => /* @__PURE__ */ y(so, { children: ts(m.column.columnDef.cell, m.getContext()) }, m.id)) }, h.id)) : /* @__PURE__ */ y(Xn, { children: /* @__PURE__ */ y(so, { colSpan: e.length, className: "pr-h-24 pr-text-center", children: "No results." }) }) })
    ] }) }),
