...
import { c as v, g as ue, a as xr, C as _e, u as $o, T as Dt, b as Ot, d as Mt, e as $t, A as ie, P as De, f as We, B as H, h as Oe, i as Me, j as $e, k as ye, x as Xi, l as Ji, m as Zi, n as Qi, o as so, r as fe, p as ts, q as Cn, s as la, t as da, L as Nt, R as co, v as ea, D as Ba, w as Fa, y as Ua, z as Ka, E as En, F as qr, G as lo, H as Tn, I as wo, J as qe, K as _r, M as Ie, N as Pe, O as Ae, S as Nr, Q as er, U as es, V as Tr, W as Ge, X as Se, Z as Ye, Y as Ee, _ as rr, $ as uo, a0 as po, a1 as ra, a2 as ho, a3 as Sn, a4 as rs, a5 as as, a6 as os, a7 as Ha, a8 as zn, a9 as wa, aa as Rn, ab as ns, ac as is, ad as ss, ae as cs, af as Dn, ag as On, ah as go, ai as ls, aj as Mn, ak as Ca, al as Io, am as Ea, an as ds, ao as ws, ap as us, aq as ps, ar as hs, as as Sr, at as fo, au as gs, av as fs } from "./resizable-Ci-qItiT.js";
import { aw as Eg, ax as Tg, ay as Sg, az as zg, aA as Rg, aB as Dg, aC as Og, aD as Mg, aE as $g, aF as Ig, aG as Pg, aH as Ag, aI as Vg, aJ as jg, aK as Lg, aL as Bg, aM as Fg, aN as Ug, aO as Kg, aP as Hg, aQ as qg, aR as Gg, aS as Wg, aT as Yg } from "./resizable-Ci-qItiT.js";
import { jsx as a, jsxs as u, Fragment as nt } from "react/jsx-runtime";
import { Canon as Rt } from "@sillsdev/scripture";
import { Check as ze, Clock as Po, ChevronsLeft as Ao, ChevronsRight as Vo, ChevronLeft as qa, ChevronRight as Ga, ArrowLeft as ms, ArrowRight as vs, ChevronDown as nr, BoldIcon as bs, ItalicIcon as xs, X as mo, AtSign as $n, Pencil as ys, Trash2 as ks, ArrowUp as In, MoreHorizontal as _s, MailOpen as Ns, Mail as Cs, ChevronUp as Es, FilterIcon as Ts, ArrowLeftIcon as Ss, ChevronLeftIcon as zs, ChevronRightIcon as Rs, ArrowRightIcon as Ds, Copy as Pn, Filter as Os, User as Ms, Link as $s, CircleHelp as Is, Undo as Ps, Redo as As, SquareX as An, FunctionSquare as Vn, SquareSigma as jn, Ban as Vs, AlertCircle as Wa, CircleCheckIcon as js, CircleXIcon as Ls, CircleHelpIcon as Bs, ArrowUpIcon as Fs, ArrowDownIcon as Us, ScrollText as Ks, ChevronsUpDown as Hs, MenuIcon as qs, Menu as Gs, EllipsisVertical as Ws, MoreVertical as Ys } from "lucide-react";
import { Section as _t, getChaptersForBook as Xs, formatScrRef as be, formatReplacementString as Te, getSectionForBook as Gr, formatRelativeDate as Js, sanitizeHtml as vo, NumberFormat as Ln, formatBytes as Zs, getCurrentLocale as Qs, usfmMarkers as Wr, getFormatCallerFunction as tc, deepEqual as ec, isString as jo, compareScrRefs as Ya, scrRefToBBBCCCVVV as Ta, defaultScrRef as Sa, formatScrRefRange as rc, getLocalizeKeyForScrollGroupId as Lo, formatReplacementStringToArray as Bo, collectUsjMarkers as ac } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as M, createContext as ua, useContext as bo, useState as k, useEffect as G, useCallback as j, useImperativeHandle as oc, useLayoutEffect as Yt, Component as nc, createElement as Fo, Suspense as ic, forwardRef as Bn, useId as Uo, Fragment as pa } from "react";
import { IconSelector as Fn, IconCheck as ha, IconChevronDown as sc, IconChevronUp as cc, IconLayoutSidebar as lc, IconLayoutSidebarRight as dc, IconChevronRight as Un, IconSearch as wc, IconLoader as uc, IconAlertOctagon as pc, IconAlertTriangle as hc, IconInfoCircle as gc, IconCircleCheck as fc } from "@tabler/icons-react";
import { createEditor as Kn, $getRoot as Re, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as xo, ParagraphNode as Hn, TextNode as qn, $getPreviousSelection as mc, $isRangeSelection as he, $caretFromPoint as vc, $getSiblingCaret as Gn, $getChildCaret as bc, $getAdjacentChildCaret as xc, $isChildCaret as yc, $normalizeCaret as kc, $setSelectionFromCaretRange as _c, $getCollapsedCaretRange as Nc, $getCaretInDirection as Ko, $splitAtPointCaretNext as Cc, $isTextPointCaret as Ec, $findMatchingParent as Wn, $isElementNode as Cr, mergeRegister as ke, getDOMTextNode as Tc, isHTMLElement as Sc, CLEAR_EDITOR_COMMAND as Yn, COMMAND_PRIORITY_EDITOR as yo, shallowMergeConfig as zc, defineExtension as ae, safeCast as Xe, createState as Rc, FORMAT_TEXT_COMMAND as Xn, $isNodeSelection as Jn, COMMAND_PRIORITY_LOW as Zn, RootNode as Dc, LineBreakNode as Oc, TabNode as Mc, $isEditorState as $c, createCommand as Ic, CLICK_COMMAND as Pc, isDOMNode as Ac, $getNodeFromDOMNode as Vc, $createNodeSelection as jc, $setSelection as Lc, $getEditor as Bc, DecoratorNode as Xa, $getState as Fc, toggleTextFormatType as Ho, TEXT_TYPE_TO_FORMAT as Uc, $setState as Kc, addClassNamesToElement as Qn, $create as Hc, $getNodeByKey as qc, removeClassNamesFromElement as Gc, KEY_TAB_COMMAND as Wc, $isBlockElementNode as Yc, $createRangeSelection as Xc, $normalizeSelection__EXPERIMENTAL as Jc, OUTDENT_CONTENT_COMMAND as Zc, INDENT_CONTENT_COMMAND as qo, INSERT_TAB_COMMAND as Qc, COMMAND_PRIORITY_CRITICAL as ko, $isDecoratorNode as tl, $isParagraphNode as el, $isTextNode as Ja, SELECTION_CHANGE_COMMAND as ti, $insertNodes as rl } from "lexical";
...
import { Avatar as _o, Select as Ht, Checkbox as Go, Slot as Rr, Tabs as se, Menubar as me, ContextMenu as It, Progress as Wo, Slider as Lr, Switch as Yo } from "radix-ui";
import { useReactTable as ri, getFilteredRowModel as wl, getSortedRowModel as ai, getPaginationRowModel as ul, getCoreRowModel as oi, flexRender as yr, getGroupedRowModel as pl, getExpandedRowModel as hl } from "@tanstack/react-table";
import gl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Za, HIDDEN_NOTE_CALLER as Qa, getDefaultViewOptions as fl, isInsertEmbedOpOfType as Br, Editorial as ml } from "@eten-tech-foundation/platform-editor";
...
import { useTheme as bl } from "next-themes";
import { Toaster as xl } from "sonner";
import { toast as Jg } from "sonner";
...
function ni({
  ...
  const g = F(!1), f = () => {
    ...
    () => xr(e, l),
    [e, l]
  ), y = !!p && !w, N = `${m} (${T})`, $ = y ? h || `${N}, ${p}` : N, B = /* @__PURE__ */ u(
    _e,
    {
      ref: t,
      value: d || `${e} ${Rt.bookIdToEnglishName(e)}`,
      onSelect: f,
      onMouseDown: b,
      role: "option",
      "aria-selected": r,
...
let to = "keyboard", Xo = !1;
function kl() {
  Xo || typeof document > "u" || (Xo = !0, document.addEventListener(
    "pointerdown",
    () => {
      to = "pointer";
    },
...
function _l({
  ...
  const {
    ...
    null
  ), B = n && e !== void 0, C = i ?? (e !== void 0 && !n);
  G(() => {
    var S;
    kl();
    const Y = (S = $.current) == null ? void 0 : S.closest('button, [role="combobox"], [tabindex]');
    if (!Y) return;
    const R = (K) => !!K && K.scrollWidth > K.clientWidth, X = () => {
      to !== "pointer" && (C || R(h.current) || R(l.current)) && N(!0);
    }, _ = () => N(!1);
    return Y.addEventListener("focus", X), Y.addEventListener("blur", _), () => {
      Y.removeEventListener("focus", X), Y.removeEventListener("blur", _);
    };
  }, [C, h, l]);
  const V = j(() => {
    C && T(!0), f(), B && w();
  ...
  const z = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), P = B ? (
  ...
  return (
    ...
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(
      Ot,
      {
        ...
        children: [
          /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ref: $,
              onPointerEnter: V,
...
function Nl({
  ...
  return /* @__PURE__ */ u(De, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Oe, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(ye, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      _e,
      {
        onSelect: () => T(y),
...
function Jo(t, e) {
  return Rt.bookIdToNumber(t) < Rt.bookIdToNumber(e.book);
}
function Sl(t, e, r) {
  const o = Rt.bookIdToNumber(t) - Rt.bookIdToNumber(r.book);
  return o < 0 ? !0 : o > 0 ? !1 : e < r.chapterNum;
}
function za(t, e, r, o) {
  const n = Rt.bookIdToNumber(t) - Rt.bookIdToNumber(o.book);
  ...
  const o = El.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && l) {
          const g = ((f) => Object.keys(ie).find(
            (b) => ie[b].toLowerCase() === f.toLowerCase()
          ))(c);
...
function eo(t) {
  return {
    [_t.OT]: t.filter((e) => Rt.isBookOT(e)),
    [_t.NT]: t.filter((e) => Rt.isBookNT(e)),
    [_t.DC]: t.filter((e) => Rt.isBookDC(e)),
    [_t.Extra]: t.filter((e) => Rt.extraBooks().includes(e))
  };
}
function Rl(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), i = n.size === 0 ? t : Rt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
...
function si({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(ye, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function Ra({
  ...
  const V = fe(), A = yl(), z = C ?? A, [P, U] = k(!1), [L, Y] = k(""), [R, X] = k(""), [_, S] = k("books"), [K, ot] = k(void 0), [Q, dt] = k(
    void 0
  ), [st, q] = k(void 0), [it, pt] = k(!1), [ht, vt] = k(!1), At = F(null), gt = F(!1), Ct = F(void 0), Vt = F(void 0), yt = F(void 0), Jt = F(void 0), oe = F({}), Qt = F({}), ct = j(
    (x) => {
      e(x), l && l(x);
    },
    [e, l]
    ...
    reachableBooks: I,
    projectBooks: Z,
    booksOutsideProject: rt
  } = M(
    () => Rl(Tt, jt),
    [Tt, jt]
  ), et = rt.has(t.book), wt = M(() => R.trim() ? eo(
    I.filter((x) => so(x, R, i))
  ) : ht ? te : ce, [
    ce,
    te,
  ...
  const ut = j(() => {
    if (E) {
      const x = E.chapterNum ?? 1, J = E.verseNum ?? 1;
      if (p && za(E.book, x, J, p))
        return;
      ct({
        book: E.book,
        chapterNum: x,
    ...
    (x) => {
      const J = Q ?? (E == null ? void 0 : E.book), tt = st ?? (E == null ? void 0 : E.chapterNum);
      !J || !tt || (ct({
        book: J,
        chapterNum: tt,
        verseNum: x
    ...
    (x) => {
      const J = _ === "chapters" ? K : E == null ? void 0 : E.book;
      if (J) {
        if (w && w(J, x) > 1) {
          dt(J), q(x), S("verses"), Y("");
          return;
    ...
    S("books"), ot(void 0), dt(void 0), q(void 0), setTimeout(() => {
      Vt.current && Vt.current.focus();
    }, 0);
  }, []), O = j(() => {
    const x = Q;
    dt(void 0), q(void 0), x ? (ot(x), S("chapters"), Y("")) : Zt();
  }, [Q, Zt]), mt = j(
    (x) => {
      U(x), x && (S("books"), ot(void 0), dt(void 0), q(void 0), X(""), vt(et));
    },
    [et]
  );
  G(() => {
  ...
  G(() => {
    var x;
    Et !== 0 && ((x = Vt.current) == null || x.focus());
  }, [Et]), oc(
    $,
    () => ({
      open: () => {
  ...
  const { otLong: je, ntLong: Je, dcLong: ur, extraLong: pr } = {
    ...
    (x) => E ? !!E.chapterNum && !x.toString().includes(E.chapterNum.toString()) : !1,
    [E]
  ), Mr = M(
    () => be(
      t,
      i ? ue(t.book, i) : "English"
    ),
    [t, i]
  ), Ze = M(
    () => z >= Yr.TIGHT ? xr(t.book, i) : ue(t.book, i),
    [t.book, i, z]
  ), Le = `${t.chapterNum}:${t.verseNum}`, $r = j((x) => (J) => {
    oe.current[x] = J;
  }, []), ba = j((x) => (J) => {
    Qt.current[x] = J;
  }, []), Ir = M(
    () => Tl(R),
    [R]
  ), hr = M(() => !w || !E || !E.chapterNum || !Ir ? !1 : w(E.book, E.chapterNum) > 0, [w, E, Ir]), Pr = _ === "books" && !it && !R.trim() && rt.size > 0, gr = j(
    (x) => p ? Jo(x, p) : !1,
    [p]
  ), fr = j(
    (x) => (J) => p ? Sl(x, J, p) : !1,
    ...
    (x, J) => (tt) => p ? za(x, J, tt, p) : !1,
    [p]
  ), Ar = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", Fe = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) || "Select verse", xa = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", Ue = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", ya = j(
    (x) => Te(Ue, {
      book: `${ue(x, i)} (${xr(
        x,
        i
    ...
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), h && h.includes(x.key) && E && E.chapterNum !== void 0 && E.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), ut());
    },
    [h, E, ut]
  ), Vr = j(
    (x) => {
      var W, kt, le;
      if (x.ctrlKey) return;
      const { isLetter: J, isDigit: tt } = Zo(x.key);
      if ((_ === "chapters" || _ === "verses") && (x.key === " " || x.key === "Enter")) {
        ...
        const Gt = (W = Ct.current) == null ? void 0 : W.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (Gt) {
          x.preventDefault(), x.stopPropagation(), Gt.click();
          return;
        }
      }
      if ((_ === "chapters" || _ === "verses") && (J || tt)) {
        x.preventDefault(), x.stopPropagation();
        return;
      }
      if (_ === "chapters" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), Zt();
        return;
      }
      if (_ === "verses" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), O();
        return;
      }
      const D = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key);
      if (_ === "verses" && D) {
        const Ft = Q, St = st;
        if (!Ft || !St || !w) return;
        const Gt = w(Ft, St);
        if (!Gt) return;
        (kt = Ct.current) == null || kt.focus();
        const xt = (() => {
          if (!L) return 1;
          const mr = L.match(/:(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            xt !== 0 && (de = xt > 1 ? xt - 1 : Gt);
            break;
          case "ArrowRight":
            xt !== 0 && (de = xt < Gt ? xt + 1 : 1);
            break;
          case "ArrowUp":
            de = xt === 0 ? Gt : Math.max(1, xt - Ne);
            break;
          case "ArrowDown":
            de = xt === 0 ? 1 : Math.min(Gt, xt + Ne);
            break;
          default:
            return;
        }
        de !== xt && (x.preventDefault(), x.stopPropagation(), Y(
          `${Ft} ${ie[Ft] || ""} ${St}:${de}`
        ), setTimeout(() => {
          const mr = Qt.current[de];
          mr && mr.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((_ === "chapters" || _ === "books" && E) && D) {
        const Ft = _ === "chapters" ? K : E == null ? void 0 : E.book;
        if (!Ft) return;
        _ === "chapters" && ((le = Ct.current) == null || le.focus());
        const St = (() => {
          if (!L) return 1;
          const Ne = L.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            St !== 0 && (xt = St > 1 ? St - 1 : Gt);
            break;
          case "ArrowRight":
            St !== 0 && (xt = St < Gt ? St + 1 : 1);
            break;
          case "ArrowUp":
            xt = St === 0 ? Gt : Math.max(1, St - de);
            break;
          case "ArrowDown":
            xt = St === 0 ? 1 : Math.min(Gt, St + de);
            break;
          default:
            return;
        }
        xt !== St && (x.preventDefault(), x.stopPropagation(), Y(
          `${Ft} ${ie[Ft] || ""} ${xt}`
        ), setTimeout(() => {
          const Ne = oe.current[xt];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (D = Vt.current) == null || D.focus();
      return;
    }
    const { isLetter: J, isDigit: tt } = Zo(x.key);
    (J || tt) && (x.preventDefault(), X((W) => W + x.key), Vt.current.focus(), pt(!1));
  }, []);
  return Yt(() => {
    const x = setTimeout(() => {
      if (P && _ === "books" && yt.current && Jt.current) {
        const J = yt.current, tt = Jt.current, D = tt.offsetTop, W = J.clientHeight, kt = tt.clientHeight, le = D - W / 2 + kt / 2;
        J.scrollTo({
          top: Math.max(0, le),
          behavior: "smooth"
        }), Y(ii(t.book));
    ...
    if (_ === "chapters" && K) {
      const x = K === t.book, J = x ? t.chapterNum : 1;
      Y(
        `${K} ${ie[K] || ""} ${J}`
      ), setTimeout(() => {
        if (yt.current)
          if (x) {
            const tt = oe.current[t.chapterNum];
  ...
  }, [_, K, E, t.book, t.chapterNum]), Yt(() => {
    if (_ === "verses" && Q && st !== void 0) {
      const x = Q === t.book && st === t.chapterNum, J = x ? t.verseNum : 1;
      Y(
        `${Q} ${ie[Q] || ""} ${st}:${J}`
      ), setTimeout(() => {
        if (yt.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(De, { open: P, onOpenChange: mt, modal: y, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      H,
      {
        ...
        onClick: (x) => {
          gt.current && (gt.current = !1, x.preventDefault());
        },
        children: [
          g ?? /* @__PURE__ */ a(
            _l,
            {
              primary: Ze,
              secondary: Le,
              showSecondary: z < Yr.MINIMUM,
              isPartial: z >= Yr.TIGHT,
              fullText: Mr
            }
          ),
          b && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: J } = x;
          P && At.current && J instanceof Node && At.current.contains(J) && (gt.current = !0, mt(!1));
        },
        onCloseAutoFocus: T,
        children: /* @__PURE__ */ u(
          Me,
          {
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: qt.map(
                  ({ onClick: x, disabled: J, title: tt, icon: D }) => /* @__PURE__ */ a(
                    H,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  H,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: _ === "verses" ? O : Zt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: V === "ltr" ? /* @__PURE__ */ a(ms, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(vs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                _ === "chapters" && K && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ue(K, i) }),
                _ === "verses" && Q && st !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ue(Q, i)} ${st}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: _ === "verses" ? Fe : Ar
                  }
                )
              ] }),
              !it && /* @__PURE__ */ u($e, { ref: yt, children: [
                _ === "books" && /* @__PURE__ */ u(nt, { children: [
                  !E && Object.entries(wt).map(([x, J]) => {
                    if (J.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ye, { heading: Dr(x), children: J.map((tt) => /* @__PURE__ */ a(
                          ni,
                          {
                            bookId: tt,
                            onSelect: (D) => Pt(D),
                            section: Gr(tt),
                            commandValue: `${tt} ${ie[tt]}`,
                            ref: tt === t.book ? Jt : void 0,
                            localizedBookNames: i,
                            disabled: gr(tt),
                            dimmedReason: rt.has(tt) ? xa : void 0,
                            dimmedDescription: rt.has(tt) ? ya(tt) : void 0
                          },
                          tt
                        )) }, x)
                      );
                  }),
                  E && /* @__PURE__ */ a(ye, { children: /* @__PURE__ */ a(
                    _e,
                    {
                      value: `${E.book} ${ie[E.book]} ${E.chapterNum || ""}:${E.verseNum || ""})}`,
                      onSelect: ut,
                      disabled: !!p && za(
                        E.book,
                        E.chapterNum ?? 1,
                      ...
                      children: be(
                        ...
                        i ? xr(E.book, i) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  E && hr && E.chapterNum && w && /* @__PURE__ */ u(nt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${ue(E.book, i)} ${E.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      tn,
                      {
                        ...
                        endVerse: w(E.book, E.chapterNum),
                        scrRef: t,
                        onVerseSelect: ft,
                        setVerseRef: ba,
                        isVerseDisabled: Be(E.book, E.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  E && !hr && ar(E.book) > 1 && /* @__PURE__ */ u(nt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: ue(E.book, i) }),
                      /* @__PURE__ */ a("span", { children: Ar })
                    ] }),
                    /* @__PURE__ */ a(
                      Qo,
                      {
                        ...
                        setChapterRef: $r,
                        isChapterDimmed: Or,
                        isChapterDisabled: fr(E.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                _ === "chapters" && K && /* @__PURE__ */ a(
                  Qo,
                  {
                    bookId: K,
                    scrRef: t,
                    onChapterSelect: Lt,
                    setChapterRef: $r,
                    isChapterDisabled: fr(K),
                    className: "tw:p-4"
                  }
                ),
                _ === "verses" && Q && st !== void 0 && w && /* @__PURE__ */ a(
                  tn,
                  {
                    bookId: Q,
                    chapterNum: st,
              ...
              Pr && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                H,
                {
                  variant: "ghost",
                  size: "sm",
...
function en({
  ...
  const [N, $] = k(!1), B = d ?? l, C = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], V = (A, z) => {
    const P = l(A), U = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, L = `${z ?? ""}${P}${U ?? ""}`;
    return /* @__PURE__ */ u(
      _e,
      {
        value: P,
  ...
  return /* @__PURE__ */ u(De, { open: N, onOpenChange: $, ...y, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      H,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        children: /* @__PURE__ */ u(Me, { children: [
          /* @__PURE__ */ a(la, { placeholder: h, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(da, { children: g }),
          /* @__PURE__ */ a($e, { children: C(e) ? e.map((A) => /* @__PURE__ */ a(ye, { heading: A.groupHeading, children: A.options.map((z) => V(z, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(ye, { children: e.map((A) => V(A)) }) })
        ] })
      }
    )
  ] });
...
function vp({
  ...
  const w = Da(d, "%webView_bookSelector_currentBook%"), p = Da(d, "%webView_bookSelector_choose%"), h = Da(d, "%webView_bookSelector_chooseBooks%"), [g, f] = k(
    "current book"
    /* CurrentBook */
  ), b = (m) => {
    f(m), t(m);
    ...
    co,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Nt, { className: "tw:flex tw:items-center", children: o.map((m) => Rt.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            H,
            {
...
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $l = li ? Yt : G, Ur = { tag: xo };
function Il({ initialConfig: t, children: e }) {
  const r = M(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Ml(null, o), w = Kn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = zr();
            g.append(f);
            const b = li ? document.activeElement : null;
            (Xt() !== null || b !== null && b === p.getRootElement()) && f.select();
          }
        }, Ur);
  ...
  }, []), a(ci.Provider, { value: r, children: e });
}
const Pl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function Al({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = ve();
  return Pl(() => {
...
class jl extends nc {
  constructor(e) {
    super(e), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = Oa;
  }
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && Ll(e.resetKeys, n)) {
      var i, s;
...
const Fl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function Ul(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Kl() {
  return function(t) {
    const [e] = ve(), r = M(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = F(o);
    return Fl(() => {
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ql = di && "documentMode" in document ? document.documentMode : null;
!(!di || !("InputEvent" in window) || ql) && "getTargetRanges" in new window.InputEvent("input");
function pe(t) {
  return `${t}px`;
}
...
function Wl(t, e, r) {
  ...
  function l() {
    ...
    for (let T = 0; T < g.length; T++) {
      const y = g[T], N = s[T] || document.createElement("div"), $ = N.style;
      $.position !== "absolute" && ($.position = "absolute", m = !0);
      const B = pe(y.left - p);
      $.left !== B && ($.left = B, m = !0);
      const C = pe(y.top - h);
      $.top !== C && (N.style.top = C, m = !0);
      const V = pe(y.width);
      $.width !== V && (N.style.width = V, m = !0);
      const A = pe(y.height);
      $.height !== A && (N.style.height = A, m = !0), N.parentNode !== c && (c.append(N), m = !0), s[T] = N;
    }
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(A) {
        const z = A.getStartEndPoints();
        return A.isBackward() ? [z[1], z[0]] : z;
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, T = g.getNode(), y = T.getKey(), N = g.offset, $ = t.getElementByKey(b), B = t.getElementByKey(y), C = r === null || $ !== o || m !== n || b !== r.getKey(), V = i === null || B !== s || N !== c || y !== i.getKey();
      if ((C || V) && $ !== null && B !== null) {
        const A = function(z, P, U, L, Y, R, X) {
          const _ = (z._window ? z._window.document : document).createRange();
          return _.setStart(...rn(P, U, L)), _.setEnd(...rn(Y, R, X)), _;
        }(t, h, f, $, g, T, B);
        l(), l = Wl(t, A, e);
      }
      r = f, o = $, n = m, i = T, s = B, c = N;
    });
  }
...
function Zl(t) {
  const e = Wn(t, (r) => Cr(r) && !r.isInline());
  return Cr(e) || aa(4, t.__key), e;
}
function Ql(t) {
  const e = Xt() || mc();
  let r;
  if (he(e)) r = vc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Gn(c, "next"));
    }
    r = r || bc(Re(), "previous").getFlipped().insert(zr());
  }
  const o = td(t, r), n = xc(o), i = yc(n) ? kc(n) : o;
  return _c(Nc(i)), t.getLatest();
}
function td(t, e, r) {
  let o = Ko(e, "next");
  for (let n = o; n; n = Cc(n, r)) o = n;
  return Ec(o) && aa(283), o.insert(t.isInline() ? zr().append(t) : t), Ko(Gn(t.getLatest(), "next"), e.direction);
}
function ed(t) {
  const e = Xt();
  if (!he(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Wn(i, (d) => Cr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function fa() {
  ...
  for (!function() {
    ...
    let r = kr;
    for (kr = void 0, na++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && wi(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
let oa, xe = 0, na = 0, od = 0, ao = 0, Jr = 0;
function on(t) {
  if (at === void 0) return;
  let e = t.n;
...
function Ke(t, e) {
  Kt.call(this, void 0), this.x = t, this.s = void 0, this.g = Jr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function nd(t, e) {
  return new Ke(t, e);
}
...
function id(t) {
  ...
  ui(this), at = t, this.f &= -2, 8 & this.f && To(this), fa();
}
function tr(t, e) {
...
Kt.prototype.brand = rd, Kt.prototype.h = function() {
  return !0;
}, Kt.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : an(() => {
    var r;
  ...
  if (this.t !== void 0) {
    const e = t.e, r = t.x;
    e !== void 0 && (e.x = r, t.e = void 0), r !== void 0 && (r.e = e, t.x = void 0), t === this.t && (this.t = r, r === void 0 && an(() => {
      var o;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      xe !== 0 && na === 0 && e.l !== ao && (e.l = ao, oa = { S: e, v: e.v, i: e.i, o: oa });
  ...
  if (this.g = Jr, this.f |= 1, this.i > 0 && !wi(this)) return this.f &= -2, !0;
  const t = at;
  try {
    nn(this), at = this;
    const e = this.x();
  ...
  return at = t, ui(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, pi(this), nn(this), xe++;
  const t = at;
  return at = this, id.bind(this, t);
...
ae({ build: (t, e, r) => wr(e), config: Xe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function hi() {
  const t = Re(), e = Xt(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), he(e) && (e.format = 0);
}
function gi(t, e = hi) {
  return t.registerCommand(Yn, (r) => (t.update(e), !0), yo);
}
ae({ build: (t, e, r) => wr(e), config: Xe({ $onClear: hi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ge(() => gi(t, o.value));
} });
function sd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Ma = Rc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class fi extends Xa {
  $config() {
    return this.config("decorator-text", { extends: Xa, stateConfigs: [{ flat: !0, stateConfig: Ma }] });
  }
  getFormat() {
    return Fc(this, Ma);
  }
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [fi], register: (t, e, r) => t.registerCommand(Xn, (o) => {
  const n = Xt();
  if (Jn(n) || he(n)) for (const i of n.getNodes()) cd(i) && i.toggleFormat(o);
  return !1;
}, Zn) });
function mi(t, e) {
  let r;
...
const oo = ae({ build: (t) => mi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function vi(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = vi(r[n], o[n]);
    return t;
  }
  return e;
}
const So = 0, no = 1, bi = 2, $a = 3, Kr = 4, Qe = 5, Ia = 6, vr = 7;
function Pa(t) {
  return t.id === So;
}
function xi(t) {
...
function ld(t) {
  return function(e) {
    return e.id === no;
  }(t) || lt(305, String(t.id), String(no)), Object.assign(t, { id: bi });
}
...
class wd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Kr && lt(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ia && lt(310, String(r.id), String(Ia)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Kr;
    }(e) || lt(313, String(e.id), String(Kr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= $a;
    }(e) || lt(314, String(e.id), String($a)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= vr;
    }(e) || lt(316, String(e.id), String(vr)), e;
  }
...
const pd = ae({ config: Xe({ setOptions: sn, updateOptions: sn }), init: ({ $initialEditorState: t = ud }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if ($c(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [Dc, qn, Oc, Mc, Hn] }), cn = Symbol.for("@lexical/extension/LexicalBuilder");
function ln() {
}
function hd(t) {
  throw t;
...
class or {
  ...
  static maybeFromEditor(e) {
    const r = e[cn];
    return r && (r.PACKAGE_VERSION !== Aa && lt(292, r.PACKAGE_VERSION, Aa), r instanceof or || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Pa(i) || lt(300, s, n || "[unknown]"), Pa(c = i) || lt(304, String(c.id), String(So)), i = Object.assign(c, { id: no }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of sd(p)) {
        if (typeof h != "function") {
          const g = o.get(h.replace);
          g && lt(302, p.name, h.replace.name, g.extension.name), o.set(h.replace, w);
        }
        r.add(h);
      }
      if (p.html) {
...
const gd = /* @__PURE__ */ new Set(), dn = ae({ build(t, e, r) {
  const o = r.getDependency(oo).output, n = Er({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = mi(() => {
  }, () => ge(() => {
...
}, dependencies: [oo], name: "@lexical/extension/NodeSelection" }), fd = Ic("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends Xa {
  static getType() {
...
ae({ dependencies: [oo, dn], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(dn).output, n = Er({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ke(t.registerCommand(fd, (s) => {
    const c = Xt();
    if (!he(c)) return !1;
    ...
    return !0;
  }, yo), t.registerCommand(Pc, (s) => {
    if (Ac(s.target)) {
      const c = Vc(s.target);
      if (vd(c)) return function(l, d = !1) {
        const w = Xt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Jn(w) ? g = w : (g = jc(), Lc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Zn), t.registerMutationListener(ir, (s, c) => {
    ad(() => {
      let l = !1;
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(ge(() => {
      const d = c.value;
      d && (l.value ? Qn(d, i) : Gc(d, i));
    }));
    return ke(...s);
  }));
} });
ae({ build: (t, e) => wr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Xe({ $getParentEditor: function() {
  const t = Bc();
...
ae({ build: (t, e, r) => wr(e), config: Xe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ge(() => {
...
function bd(t, e, r = yi) {
  return ke(t.registerCommand(Wc, (o) => {
    const n = Xt();
    if (!he(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Yc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Zl(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Xc();
...
ae({ build: (t, e, r) => wr(e), config: Xe({ $canIndent: yi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ge(() => {
    if (!o.value) return bd(t, n, i);
  });
} });
const xd = ae({ name: "@lexical/react/ReactProvider" });
function yd() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (he(f)) {
                ...
                if (Ja(m) && d >= 0 && w >= 0 && (T = d, y = d + w, f.setTextNodeRange(m, T, m, y)), T === y && p === "" || (f.insertRawText(p), m = b.getNode()), Ja(m)) {
                  T = h, y = h + g;
                  const N = m.getTextContentSize();
                  T = T > N ? N : T, y = y > N ? N : y, f.setTextNodeRange(m, T, m, y);
                }
...
ae({ build: (t, e, r) => wr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ge(() => r.getOutput().disabled.value ? void 0 : _i(t)) });
function Nd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Ro = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
...
function Td({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Ro(() => ke(nl(n), _i(n)), [n]);
  }(o), u(nt, { children: [t, a(Sd, { content: e }), a(Ed, { editor: o, ErrorBoundary: r })] });
}
...
const Rd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function Dd({ onClear: t }) {
  const [e] = ve();
  return Rd(() => gi(e, t), [e, t]), null;
}
const Ni = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function Od({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: T = !0, style: y, tabIndex: N, "data-testid": $, ...B }, C) {
  const [V, A] = k(t.isEditable()), z = j((U) => {
    U && U.ownerDocument && U.ownerDocument.defaultView ? t.setRootElement(U) : t.setRootElement(null);
  }, [t]), P = M(() => /* @__PURE__ */ function(...U) {
    return (L) => {
      for (const Y of U) typeof Y == "function" ? Y(L) : Y != null && (Y.current = L);
    };
  }(C, z), [z, C]);
  return Ni(() => (A(t.isEditable()), t.registerEditableListener((U) => {
    A(U);
  })), [t]), a("div", { "aria-activedescendant": V ? e : void 0, "aria-autocomplete": V ? r : "none", "aria-controls": V ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": V && m === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": V ? p : void 0, "aria-readonly": !V || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: V, "data-testid": $, id: b, ref: P, role: m, spellCheck: T, style: y, tabIndex: N, ...B });
}
const Md = Bn(Od);
function un(t) {
  return t.getEditorState().read(ki(t.isComposing()));
...
function Id(t, e) {
  ...
  return u(nt, { children: [a(Md, { editor: n, ...o, ref: e }), r != null && a(Pd, { editor: n, content: r })] });
}
function Pd({ content: t, editor: e }) {
  const r = function(s) {
    ...
    return Ni(() => {
      ...
      return d(), ke(s.registerUpdateListener(() => {
        d();
  ...
  if (Yt(() => (n(e.isEditable()), e.registerEditableListener((s) => {
    n(s);
  })), [e]), !r) return null;
  let i = null;
...
function Ld({
  ...
  const [e] = ve(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = jd(), l = () => {
  };
...
function Fd() {
  const { activeEditor: t } = Ei(), [e, r] = k([]), o = j((n) => {
    if (he(n) || cl(n)) {
      const i = [];
      pn.forEach(({ format: s }) => {
  ...
  return Bd(o), /* @__PURE__ */ a(
    En,
    {
      ...
      variant: "outline",
      size: "sm",
      children: pn.map(({ format: n, icon: i, label: s }) => /* @__PURE__ */ a(
        qr,
        {
          value: n,
          "aria-label": s,
...
function Si(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : Si(e.children)
  ) : !1;
}
function re(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? Si(t.root.children) : !1;
}
function qd(t) {
  if (!t || t.trim() === "")
...
function Ri({
  ...
  const s = hn(o, "%cancelButton_tooltip%"), c = i ?? hn(o, "%acceptButton_tooltip%");
  return /* @__PURE__ */ u(lo, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
...
const Gd = "verseText", bp = Object.freeze([
...
function xp({
  ...
  const [i, s] = k(Wd), [c, l] = k(n), [d, w] = k(!1), p = F(void 0), h = F(null);
  G(() => {
    let m = !0;
    const T = h.current;
    if (!T) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(De, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
        H,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ a(
        Oe,
        {
          ...
          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: t.map((m) => /* @__PURE__ */ a(
            _e,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: Va(m, o) })
            },
            m || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : Oo(m) && (m.preventDefault(), m.stopPropagation(), re(i) && g());
        },
        onKeyDown: (m) => {
...
function gn({
  ...
  const g = j(
    ...
    const C = new Date(t.date), V = Js(
      C,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), A = C.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    return Te(r["%comment_dateAtTime%"], {
      date: V,
      time: A
    });
    ...
    [t.user]
  ), y = M(() => vo(t.contents), [t.contents]), N = M(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), $ = !!t.conflictResolutionAction && !N, B = M(() => {
    if (o && c)
      return /* @__PURE__ */ u(nt, { children: [
        /* @__PURE__ */ u(
          qe,
          {
            onClick: (C) => {
              C.stopPropagation(), d(!0), p(qd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Zd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Qd, { className: "tw:text-xs tw:font-medium", children: T }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : Oo(C) && (C.preventDefault(), C.stopPropagation(), re(w) && f());
              },
              onKeyDown: (C) => {
        ...
        B && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(_s, {}) }) }),
          /* @__PURE__ */ a(Ae, { align: "end", children: B })
        ] })
      ]
    }
  );
...
function Ii({
  ...
  const [L, Y] = k(fn), [R, X] = k(), [_, S] = k(), K = o, [ot, Q] = k(!1), [dt, st] = k(!1), [q, it] = k(!1), [pt, ht] = k(!1), [vt, At] = k(!1), [gt, Ct] = k($), [Vt, yt] = k(!1), Jt = F(void 0), [oe, Qt] = k(/* @__PURE__ */ new Map());
  G(() => {
    let O = !0;
    return (async () => {
      const Et = y ? await y(l) : !1;
      O && At(Et);
    })(), () => {
      O = !1;
    };
    ...
    let O = !0;
    if (!o) {
      ht(!1), Qt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Et = T ? await T(l) : !1;
      O && ht(Et);
    })(), () => {
      O = !1;
    };
  ...
  G(() => {
    if (!o) {
      ct.current !== "idle" && (X(void 0), S(void 0), ct.current = "idle");
      return;
    }
    ct.current === "idle" && (ct.current = "pending"), pt ? ct.current === "pending" && V !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    V !== i && (X(V), ct.current = "auto-populated") : ct.current === "auto-populated" && (X(void 0), ct.current = "pending");
  }, [o, V, pt, i]);
  const Tt = M(
    () => A ?? e.filter((O) => !O.deleted),
    [A, e]
  );
  G(() => {
    let O = !0;
  ...
  const jt = M(() => Tt[0], [Tt]), ce = F(null), te = F(void 0), I = j(() => {
    var O;
    (O = te.current) == null || O.call(te), Y(fn);
  }, []), Z = j(() => {
    const O = !gt;
    Ct(O), yt(!O), f == null || f(l, O);
  }, [gt, f, l]);
  G(() => {
    Q(!1);
  }, [o]), G(() => {
    if (o && !gt && !Vt) {
      ...
      return Jt.current = O, () => clearTimeout(O);
    }
  ...
  const rt = M(
    ...
    const O = Zr(i, r);
    return Te(r["%comment_assigned_to%"], {
      assignedUser: O
    });
  }, [i, r]), wt = M(() => Tt.slice(1), [Tt]), E = M(() => wt.length ?? 0, [wt.length]), bt = M(() => E > 0, [E]), ut = M(() => ot || E <= 2 ? wt : wt.slice(-2), [wt, E, ot]), ft = M(() => ot || E <= 2 ? 0 : E - 2, [E, ot]), Pt = M(
    () => E === 1 ? rt.singleReply : Te(rt.multipleReplies, { count: E }),
    [E, rt]
  ), Lt = M(
    () => ft === 1 ? rt.singleReply : Te(rt.multipleReplies, { count: ft }),
    [ft, rt]
  );
  G(() => {
    !o && dt && bt && st(!1);
  ...
  const Bt = j(
    async (O) => {
      ...
      mt && await p({ threadId: l, contents: mt }) && I();
    },
    [
      I,
      L,
    ...
    async (O) => {
      const mt = re(L) ? sa(L) : void 0, Et = O.status ? O.assignedUser : R ?? O.assignedUser, ee = await p({
        ...O,
        contents: mt,
        assignedUser: Et
      });
      return ee && (Et !== void 0 && S(Et), mt && I()), ee;
    },
    [I, L, p, R]
  );
  ...
  const Zt = /* @__PURE__ */ a(
    gn,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: qt,
      handleUpdateComment: h,
      handleDeleteComment: g,
      onEditingChange: st,
      canEditOrDelete: (!dt && oe.get(jt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Jd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            et && /* @__PURE__ */ a(_r, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: et }),
            /* @__PURE__ */ a(
              H,
              {
                variant: "ghost",
                ...
                children: gt ? /* @__PURE__ */ a(Ns, {}) : /* @__PURE__ */ a(Cs, {})
              }
            ),
            P === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: vt && w !== "Resolved",
                  onClick: () => qt({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(nt, { children: [
          ...
          o && /* @__PURE__ */ u(nt, { children: [
            U && ut.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ft > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (O) => {
                  O.stopPropagation(), Q(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (O) => {
                  (O.key === "Enter" || O.key === " ") && (O.preventDefault(), O.stopPropagation(), Q(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Nr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Lt }),
                    ot ? /* @__PURE__ */ a(Es, {}) : /* @__PURE__ */ a(nr, {})
                  ] })
                ]
              }
            ),
            ut.map((O) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              gn,
              {
                comment: O,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: st,
                canEditOrDelete: (!dt && oe.get(O.id)) ?? !1
              }
            ) }, O.id)),
            m !== !1 && (!dt || re(L)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (O) => {
                  Oo(O) && (O.preventDefault(), O.stopPropagation(), (re(L) || R !== void 0 && R !== _) && Bt());
                },
                onKeyDown: (O) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    R !== void 0 && (re(L) || R !== _) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Te(
                    ...
                    /* @__PURE__ */ u(De, { open: q, onOpenChange: it, children: [
                      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(
                        H,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !pt || !b || b.length === 0 || !b.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        Oe,
                        {
                          ...
                          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: b == null ? void 0 : b.map((O) => /* @__PURE__ */ a(
                            _e,
                            {
                              onSelect: () => {
                                X(O !== i ? O : void 0), ct.current = "user-selected", S(void 0), it(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Zr(O, r) })
                            },
                            O || "unassigned"
                          )) }) })
                        }
...
), ew = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Qr = (t) => ew(vo(t));
function ta({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function rw({
  ...
  const [s, c] = k("accept"), l = Uo(), d = Uo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = M(
    () => Qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = M(
    () => Qr(t.acceptedText ?? ""),
    ...
    () => Qr(t.mergedText ?? ""),
    [t.mergedText]
  ), y = M(() => vo(t.contents), [t.contents]);
  if (!Oi(t))
    return /* @__PURE__ */ a(ta, { html: y });
  const N = (_) => {
    c(_ === "reject" || _ === "merge" ? _ : "accept");
  }, $ = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", B = g ? [
    {
      value: "merge",
  ...
  let z;
  V ? z = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (z = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const P = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: P }), L = (_) => _ ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: _ }) : U, Y = () => {
    const _ = o ?? "accept";
    return _ === "merged" ? t.mergedText ? /* @__PURE__ */ a(ta, { html: T }) : U : L(_ === "reject" ? t.rejectedResultText : t.resultText);
  }, R = (_) => p && _.value === "reject", X = (_) => {
    const S = f === _.value, K = `${d}-${_.value}`, ot = R(_);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(nt, { children: [
        ...
        /* @__PURE__ */ a(
          co,
          {
            ...
            children: C.map((_) => R(_) ? /* @__PURE__ */ a(Dt, { delayDuration: 0, children: /* @__PURE__ */ u(Ot, { children: [
              /* @__PURE__ */ a(Mt, { asChild: !0, children: X(_) }),
              /* @__PURE__ */ a($t, { children: $ })
            ] }) }, _.value) : X(_))
          }
        ),
        /* @__PURE__ */ a(Dt, { delayDuration: 0, children: /* @__PURE__ */ u(Ot, { children: [
          /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:inline-flex tw:self-start", children: /* @__PURE__ */ a(
            H,
            {
              size: "sm",
              disabled: A,
...
function sw(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = iw({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function zp({
  ...
  const [y, N] = k(/* @__PURE__ */ new Set()), [$, B] = k(), [C, V] = k(), A = j(
    async (S) => {
      const K = await i(S);
      return K !== void 0 && S.assignedUser !== void 0 && S.assignedUser !== "" && V(S.assignedUser), K;
    },
    [i]
  );
  G(() => {
    f && (N((S) => new Set(S).add(f)), B(f));
  }, [f]);
  const z = r.filter(
    (S) => S.comments.some((K) => !K.deleted)
  ), P = z.map((S) => ({ id: S.id })), U = j(
    (S) => {
      N((K) => new Set(K).add(S.id)), B(S.id), b == null || b(S.id);
    },
    [b]
  ), L = j(
    (S) => {
      ...
      }), B(S), b == null || b(K ? void 0 : S);
    },
    [y, b]
  ), { listboxRef: Y, activeId: R, handleKeyDown: X } = es({
    options: P,
    onOptionSelect: U
  }), _ = j(
    (S) => {
      S.key === "Escape" ? ($ && y.has($) && (N((K) => {
        const ot = new Set(K);
        return ot.delete($), ot;
      }), B(void 0), b == null || b(void 0)), S.preventDefault(), S.stopPropagation()) : X(S);
    },
    [$, y, X, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: z.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(sw, { ...K, conflictResolution: T }) : /* @__PURE__ */ a(Ii, { ...K })
          },
          S.id
        );
      })
...
function cw({ table: t }) {
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Ts, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(Ae, { align: "end", className: "tw:w-[150px]", children: [
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ht.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ht.Icon, { asChild: !0, children: /* @__PURE__ */ a(Fn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ne({
  ...
  return /* @__PURE__ */ u(
    Ht.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ht.ItemIndicator, { children: /* @__PURE__ */ a(ha, { className: "tw:pointer-events-none" }) }) }),
...
function pw({
  ...
  var C;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, T] = k({}), y = M(() => e ?? [], [e]), N = ri({
    data: y,
    columns: t,
    getCoreRowModel: oi(),
  ...
  }), $ = N.getVisibleFlatColumns();
  let B;
  return l ? B = Array.from({ length: 10 }).map((z, P) => `skeleton-row-${P}`).map((z) => /* @__PURE__ */ a(Ee, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: $.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((C = N.getRowModel().rows) == null ? void 0 : C.length) > 0 ? B = N.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    Ee,
    {
      onClick: () => s(V, N),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map((A) => /* @__PURE__ */ a(rr, { children: yr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    V.id
  )) : B = /* @__PURE__ */ a(Ee, { children: /* @__PURE__ */ a(rr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(cw, { table: N }),
    /* @__PURE__ */ u(uo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(po, { stickyHeader: i, children: N.getHeaderGroups().map((V) => /* @__PURE__ */ a(Ee, { children: V.headers.map((A) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : yr(A.column.columnDef.header, A.getContext()) }, A.id)) }, V.id)) }),
      /* @__PURE__ */ a(ho, { children: B })
    ] }),
...
function gw({
  ...
  const n = mn(r, "%webView_error_dump_header%"), i = mn(r, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(H, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Pn, {}) })
        ] }),
...
function $p({
  ...
  return /* @__PURE__ */ u(De, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Oe, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Ip({ id: t, label: e, groups: r }) {
  const [o, n] = k(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "default", children: [
      /* @__PURE__ */ a(Os, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(nr, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Ae, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Tr, { children: d.label }),
      /* @__PURE__ */ a(Sn, { children: d.itemType === 0 ? /* @__PURE__ */ a(nt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Se,
        {
          checked: o[w][h],
...
function bw({
  ...
  const l = wo(), d = vn(n, "%undoButton_tooltip%"), w = vn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(lo, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ a(
        H,
    ...
    e && /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ a(
        H,
        {
          "aria-label": w,
...
const yw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(nt, { children: [
...
function kw({
  ...
  const i = F(null), s = F(null), c = F(!1), [l, d] = k(t), [w, p] = k(r), [h, g] = k(!1);
  G(() => {
    d(t);
  }, [t]), G(() => {
    w !== r && p(r);
  ...
  const f = (m) => {
    ...
    var T, y, N, $;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((T = i.current) == null || T.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && (($ = s.current) == null || $.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Ie, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: yw(t, n, r) }) }) }),
...
const _w = (t, e) => t === "f" ? /* @__PURE__ */ u(nt, { children: [
  /* @__PURE__ */ a(Vn, {}),
  " ",
  ...
  return t === "f" && (r = e["%footnoteEditor_noteType_footnote_label%"]), Te(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: r
  });
};
function Cw({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: _w(t, r) }) }) }),
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: Nw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { style: { zIndex: zn }, children: [
...
function bn({
  ...
  return /* @__PURE__ */ u(
    _e,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(Sw, { state: t.selectionState }),
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Tw, { icon: t.icon }) }) }),
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(ns, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function zw({
  ...
  return /* @__PURE__ */ u(Me, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u($e, { children: [
      ...
      /* @__PURE__ */ a(ye, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          bn,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(nt, { children: [
        s.length > 0 && /* @__PURE__ */ a(Rn, { alwaysRender: !0 }),
        /* @__PURE__ */ a(ye, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            bn,
            {
...
function jp({
  ...
  const w = F(null), p = F(null), h = F(null), g = F(null);
  Yt(() => {
    if (!g.current) return;
    const { width: I } = g.current.getBoundingClientRect();
    I > 0 && (g.current.style.width = `${I}px`);
  }, []);
  const [f, b] = k("generated"), [m, T] = k("generated"), [y, N] = k("*"), [$, B] = k("*"), [C, V] = k("f"), [A, z] = k(!1), [P, U] = k(!0), [L, Y] = k(!1), R = F(!1), X = F(""), [_, S] = k(!1), [K, ot] = k(), [Q, dt] = k(), [st, q] = k(), [it, pt] = k(), ht = F(null), vt = M(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? fl(), noteMode: "expanded" }
    }),
    [s, c]
  ), At = M(
    () => Rw(
  ...
  G(() => {
    ...
    if (Z && Br("note", Z)) {
      const wt = (rt = Z.insert.note) == null ? void 0 : rt.caller;
      let E = "custom";
      wt === Za ? E = "generated" : wt === Qa ? E = "hidden" : wt && (N(wt), B(wt)), b(E), T(E), V(((et = Z.insert.note) == null ? void 0 : et.style) ?? "f"), I = setTimeout(() => {
        var bt;
        (bt = w.current) == null || bt.applyUpdate([Z]);
      }, 0);
    }
    return () => {
      I && clearTimeout(I);
  ...
  const gt = j(
    (I, Z, rt = !1) => {
      var wt, E, bt;
      const et = (E = (wt = w.current) == null ? void 0 : wt.getNoteOps(0)) == null ? void 0 : E.at(0);
      if (et && Br("note", et)) {
        if (et.insert.note) {
          let ut;
          I === "custom" ? ut = Z : I === "generated" ? ut = Za : ut = Qa, et.insert.note.caller = ut;
        }
        r == null || r([et]), rt && d && i && ((bt = d.current) == null || bt.replaceEmbedUpdate(i, [et]));
      }
    },
    [i, r, d]
  ), Ct = j(() => {
  ...
  const yt = F({ book: n.book, chapterNum: n.chapterNum });
  Yt(() => {
    (yt.current.book !== n.book || yt.current.chapterNum !== n.chapterNum) && (yt.current = { book: n.book, chapterNum: n.chapterNum }, Vt.current());
  }, [n.book, n.chapterNum]);
  const Jt = () => {
    var Z;
    const I = (Z = p.current) == null ? void 0 : Z.getElementsByClassName("editor-input")[0];
    ...
    var rt, et, wt, E, bt;
    V(I);
    const Z = (et = (rt = w.current) == null ? void 0 : rt.getNoteOps(0)) == null ? void 0 : et.at(0);
    if (Z && Br("note", Z)) {
      Z.insert.note && (Z.insert.note.style = I);
      const ut = (E = (wt = Z.insert.note) == null ? void 0 : wt.contents) == null ? void 0 : E.ops;
      C !== "x" && I === "x" ? ut == null || ut.forEach((ft) => Dw(ft)) : C === "x" && I !== "x" && (ut == null || ut.forEach((ft) => Ow(ft))), (bt = w.current) == null || bt.applyUpdate([Z, { delete: 1 }]);
    }
  }, Tt = (I) => {
    pt(I.contextMarker), Y(I.canRedo);
  }, jt = j(
    (I) => {
      var rt, et, wt, E, bt;
      const Z = (et = (rt = w.current) == null ? void 0 : rt.getNoteOps(0)) == null ? void 0 : et.at(0);
      if (Z && Br("note", Z)) {
        I.content.length > 1 && setTimeout(() => {
          var Pt;
          (Pt = w.current) == null || Pt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const ut = (wt = Z.insert.note) == null ? void 0 : wt.style, ft = (bt = (E = Z.insert.note) == null ? void 0 : E.contents) == null ? void 0 : bt.ops;
        if (ut || z(!1), z(
          ut === "x" ? !!(ft != null && ft.every((Pt) => {
            var Bt, qt;
            if (!((Bt = Pt.attributes) != null && Bt.char)) return !0;
            const Lt = ((qt = Pt.attributes) == null ? void 0 : qt.char).style;
          ...
          R.current = !0, X.current = JSON.stringify(Z), U(!0);
          return;
        }
        U(JSON.stringify(Z) === X.current), gt(f, y);
      } else
        z(!1), U(!0);
    },
    [f, y, gt]
    ...
    if (h.current && At.length && I && I.rangeCount > 0) {
      const Z = I.getRangeAt(0).getBoundingClientRect(), rt = h.current.getBoundingClientRect();
      ot(Z.left - rt.left), dt(Z.top - rt.top), q(Z.height), S(!0);
    }
  }, [At, h]);
  G(() => {
    const I = () => {
    ...
    var I;
    _ && ((I = ht.current) == null || I.focus());
  }, [_]), G(() => {
    var rt;
    const I = ((rt = p.current) == null ? void 0 : rt.querySelector(".editor-input")) ?? void 0, Z = (et) => {
      !_ && I && document.activeElement === I && et.key === c ? (et.preventDefault(), ce()) : _ && et.key === "Escape" && (et.preventDefault(), S(!1));
    };
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
              /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ a(
                H,
                {
                  "aria-label": te,
              ...
              /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: te }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(nt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(nt, { children: $w(t.marker, c, o, d) })
      }
    )
  ] });
}
function Bp({
  ...
  const w = l ?? tc(r, void 0), p = (y, N) => {
    d == null || d(y, N, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = k(h), b = (y, N, $) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), d == null || d(N, $, n);
          break;
      }
  }, m = (y) => {
    if (r.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), f((N) => Math.min(N + 1, r.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), f((N) => Math.max(N - 1, 0));
          break;
      }
  }, T = F([]);
  return G(() => {
        ...
        "ul",
        {
          ...
          children: r.map((y, N) => {
            ...
            return /* @__PURE__ */ u(nt, { children: [
              ...
              N < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Nr, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function Vw({
  ...
  return /* @__PURE__ */ u(uo, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(po, { stickyHeader: !0, children: /* @__PURE__ */ u(Ee, { children: [
    ...
    /* @__PURE__ */ a(ho, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ee,
      {
        ...
        children: [
          /* @__PURE__ */ a(rr, { children: be(c.reference, "English") }),
          /* @__PURE__ */ a(rr, { className: o, children: Aw(c.text) })
        ]
      },
...
const jw = (t) => {
...
}, ma = (t, e, r) => /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
  /* @__PURE__ */ u(
    Mt,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(En, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          qr,
          {
            onClick: (l) => {
  ...
  return e ? e[1] : "";
}, Bw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Wp = Object.freeze([
...
function Yp({
  ...
  const g = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), b = we(r, "%webView_inventory_unapproved%"), m = we(r, "%webView_inventory_unknown%"), T = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), N = we(r, "%webView_inventory_scope_verse%"), $ = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = we(r, "%webView_inventory_no_results%"), [V, A] = k(!1), [z, P] = k("all"), [U, L] = k(""), [Y, R] = k([]), X = M(() => {
    const q = t ?? [];
    return q.length === 0 ? [] : Uw(q, n, i);
  }, [t, n, i]), _ = M(() => {
    if (V) return X;
    const q = [];
    return X.forEach((it) => {
      const pt = it.items[0], ht = q.find(
        (vt) => vt.items[0] === pt
      );
      ht ? (ht.count += it.count, ht.occurrences = ht.occurrences.concat(it.occurrences)) : q.push({
        items: [pt],
        count: it.count,
  ...
  }, [V, X]), S = M(() => _.length === 0 ? [] : Fw(_, z, U), [_, z, U]), K = M(() => {
    var pt, ht;
    if (!V) return l;
  ...
  G(() => {
    S.length === 0 ? R([]) : S.length === 1 && R(S[0].items);
  }, [S]);
  const ot = (q, it) => {
    it.setRowSelection(() => {
      const ht = {};
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        sr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(dr, { children: [
              /* @__PURE__ */ a(ne, { value: "all", children: g }),
              /* @__PURE__ */ a(ne, { value: "approved", children: f }),
              /* @__PURE__ */ a(ne, { value: "unapproved", children: b }),
              /* @__PURE__ */ a(ne, { value: "unknown", children: m })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(sr, { onValueChange: (q) => Q(q), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(dr, { children: [
          ...
          /* @__PURE__ */ a(ne, { value: "chapter", children: y }),
      ...
      o && /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
        /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            Ai,
            {
          ...
          /* @__PURE__ */ a(Nt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? B })
        ] }) }),
        /* @__PURE__ */ a($t, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const Kw = "16rem", Hw = "3rem", Vi = Wt.createContext(void 0);
function va() {
...
function qw({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    (N) => {
      const $ = typeof N == "function" ? N(w) : N;
      r ? r($) : d($);
    },
    [r, w]
  ), h = Wt.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", m = fe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = Wt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Qw({
  ...
  const c = t ? Rr.Root : "button", { state: l } = va(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Zw({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ u(Ot, { children: [
    /* @__PURE__ */ a(Mt, { asChild: !0, children: d }),
    /* @__PURE__ */ a(
      $t,
      {
        side: "right",
...
function tu({
  ...
  return /* @__PURE__ */ a(
    Gw,
    {
      ...
      children: /* @__PURE__ */ u(Yw, { children: [
        /* @__PURE__ */ u(xn, { children: [
          /* @__PURE__ */ a(yn, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(kn, { children: /* @__PURE__ */ a(Xw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Jw, { children: /* @__PURE__ */ a(
            Qw,
            {
              onClick: () => d(g),
              isActive: h(g),
        ...
        /* @__PURE__ */ u(xn, { children: [
          ...
          /* @__PURE__ */ a(kn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(Ks, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  ss,
                  {
                    mode: "project",
...
const Ce = "scrBook", eu = "scrRef", He = "source", ru = "details", au = "Scripture Reference", ou = "Scripture Book", ji = "Type", nu = "Details";
function iu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Ce,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? au,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? Rt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ce ? be(n.start) : void 0;
      },
      getGroupingValue: (o) => Rt.bookIdToNumber(o.start.book),
...
}, _n = (t) => `${su({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function dh({
  sources: t,
  ...
  const [d, w] = k([]), [p, h] = k([{ id: Ce, desc: !1 }]), [g, f] = k({}), b = M(
    () => t.flatMap((z) => z.data.map((P) => ({
      ...P,
      source: z.source
    }))),
    [t]
  ...
  G(() => {
    if (c) {
      const z = T.getSelectedRowModel().rowsById, P = Object.keys(z);
      if (P.length === 1) {
        const U = b.find((L) => _n(L) === P[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, b, c, T]);
  const y = n ?? ou, N = i ?? ji, $ = [
    ...
    !z.getIsGrouped() && !z.getIsSelected() && z.getToggleSelectedHandler()(P);
  }, V = (z, P) => z.getIsGrouped() ? "" : v("banded-row", P % 2 === 0 ? "even" : "odd"), A = (z, P, U) => {
    if (!((z == null ? void 0 : z.length) === 0 || P.depth < U.column.getGroupedIndex())) {
      if (P.getIsGrouped())
        switch (P.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(lw, { children: $.map((z) => /* @__PURE__ */ a(ne, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: T.getHeaderGroups().map((z) => /* @__PURE__ */ a(Ee, { children: z.headers.filter((P) => P.column.columnDef.header).map((P) => (
        ...
        /* @__PURE__ */ a(ra, { colSpan: P.colSpan, className: "tw:sticky top-0", children: P.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          yr(P.column.columnDef.header, P.getContext())
        ] }) }, P.id)
      )) }, z.id)) }),
      /* @__PURE__ */ a(ho, { children: T.getRowModel().rows.map((z, P) => {
        const U = fe();
        return /* @__PURE__ */ a(
          Ee,
          {
            ...
            children: z.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== He || !r)))
                return /* @__PURE__ */ a(
                  rr,
                  {
                    className: v(
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      H,
                      {
                        ...
                        type: "button",
                        children: [
                          z.getIsExpanded() && /* @__PURE__ */ a(nr, {}),
                          !z.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ a(Ga, {}) : /* @__PURE__ */ a(qa, {})),
                          " ",
                          yr(L.column.columnDef.cell, L.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function cu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [m, T] = k(!1), [y, N] = k(""), $ = F(void 0), B = F(!1), C = M(
    () => On(t),
    [t]
  ), V = M(() => {
    if (!y.trim()) {
    ...
    (R, X = !1) => {
      if (!X || !$.current) {
        r(
          e.includes(R) ? e.filter((dt) => dt !== R) : [...e, R]
        ), $.current = R;
        return;
      }
      const _ = C.findIndex((dt) => dt === $.current), S = C.findIndex((dt) => dt === R);
      if (_ === -1 || S === -1) return;
      const [K, ot] = [
        Math.min(_, S),
        Math.max(_, S)
      ], Q = C.slice(K, ot + 1).map((dt) => dt);
      r(
        e.includes(R) ? e.filter((dt) => !Q.includes(dt)) : [.../* @__PURE__ */ new Set([...e, ...Q])]
      );
    },
    [e, r, C]
  ), z = (R) => {
    A(R, B.current), B.current = !1;
  }, P = (R, X) => {
    R.preventDefault(), A(X, R.shiftKey);
  }, U = () => {
    r(C.map((R) => R));
  }, L = () => {
    r([]);
    ...
    () => Object.values(_t).filter(
      (R) => (i == null ? void 0 : i[R]) !== void 0 && go(C, R).length === 0
    ).map((R) => ({ section: R, explanation: i == null ? void 0 : i[R] })),
    [i, C]
  );
  return /* @__PURE__ */ u(
    De,
          ...
          Oe,
          {
            ...
            children: /* @__PURE__ */ u(
              Me,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (R) => {
                  R.key === "Enter" && (B.current = R.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    la,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(H, { variant: "ghost", size: "sm", onClick: L, children: w })
                  ] }),
                  /* @__PURE__ */ u($e, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(da, { children: p }),
                    Object.values(_t).filter((R) => V[R].length > 0).map((R, X) => {
                      const _ = V[R];
                      return /* @__PURE__ */ u(pa, { children: [
                        X > 0 && /* @__PURE__ */ a(Rn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          ye,
                          {
                            heading: Cn(R, h, g, f, b),
                            children: _.map((S) => /* @__PURE__ */ a(
                              ni,
                              {
                                bookId: S,
                                isSelected: e.includes(S),
                                onSelect: () => z(S),
                                onMouseDown: (K) => P(K, S),
                                section: Gr(S),
                                showCheck: !0,
                  ...
                  Y.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Y.map(({ section: R, explanation: X }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: X }, R)) })
                ]
              }
            )
          }
...
function du({
  ...
  return /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Ot, { children: [
    /* @__PURE__ */ a(Mt, { asChild: !0, children: /* @__PURE__ */ a(
      lu,
      {
        className: o,
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === La ? La : Nn
      ).map((d) => /* @__PURE__ */ a(_r, { className: "tw:hover:bg-secondary", variant: "secondary", children: ue(d, n) }, d)),
      e.length > La && /* @__PURE__ */ a(
        _r,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - Nn} ${s}`
        }
      )
    ] })
  ] });
...
function uh({
  ...
  const B = zt(
    s,
    "%webView_scope_selector_selected_text%"
  ), C = zt(s, "%webView_scope_selector_verse%"), V = zt(s, "%webView_scope_selector_chapter%"), A = zt(s, "%webView_scope_selector_book%"), z = zt(
    s,
    "%webView_scope_selector_current_verse%"
  ), P = zt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), U = zt(s, "%webView_scope_selector_current_book%"), L = zt(s, "%webView_scope_selector_choose_books%"), Y = zt(s, "%webView_scope_selector_scope%"), R = zt(s, "%webView_scope_selector_select_books%"), X = zt(s, "%webView_scope_selector_range%"), _ = zt(s, "%webView_scope_selector_select_range%"), S = zt(s, "%webView_scope_selector_range_start%"), K = zt(s, "%webView_scope_selector_range_end%"), ot = zt(s, "%webView_scope_selector_ok%"), Q = zt(s, "%webView_scope_selector_cancel%"), dt = zt(s, "%webView_scope_selector_navigate%"), st = (D) => {
    if (!b) return;
    const W = b.book.toUpperCase();
    switch (D) {
      case "verse":
        return be(b, "id");
      case "chapter":
        return `${W} ${b.chapterNum}`;
      case "book":
        return W;
      default:
        return;
  ...
  ], it = (D, W, kt = !1) => /* @__PURE__ */ u(nt, { children: [
    D,
    W && !kt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      W
    ] })
  ] }), pt = e ? q.filter((D) => e.includes(D.value)) : q, ht = b ?? Sa, vt = p ?? ht, At = h ?? ht, gt = () => {
  }, Ct = F(null), Vt = F(null), yt = F(!1), Jt = F(null), oe = F(!1), [Qt, ct] = k(void 0), Tt = F(!1), jt = F(!1), ce = F(null), te = j((D) => {
    if (D) {
      ct("start"), Tt.current = !1;
      return;
    }
    ct((W) => W === "start" ? void 0 : W), Tt.current && (Tt.current = !1, requestAnimationFrame(() => {
      var kt;
      const W = (kt = Ct.current) == null ? void 0 : kt.querySelector("button");
      W == null || W.click();
    }));
  }, []), I = j((D) => {
    if (D) {
    ...
    (D) => {
      g == null || g(D), f == null || f(D), Tt.current = !0;
    },
    [g, f]
  ), rt = j(
    (D) => {
      f == null || f(D), jt.current = !0;
    },
    [f]
  ), et = j(
    (D) => {
      r(D), D === "selectedBooks" && n.length === 0 && (b != null && b.book) && i([b.book]);
    },
    [r, n, b, i]
  ), wt = pt.find((D) => D.value === t), E = () => t === "selectedBooks" && n.length > 0 ? n.map((D) => D.toUpperCase()).join(", ") : t === "range" ? rc(vt, At, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : wt ? it(wt.label, wt.scrRefSuffix) : t, bt = pt.filter(
    (D) => D.value !== "selectedBooks" && D.value !== "range"
  ), ut = pt.find((D) => D.value === "selectedBooks"), ft = pt.find((D) => D.value === "range"), [Pt, Lt] = k(!1), [Bt, qt] = k(void 0), [Zt, O] = k(void 0), [mt, Et] = k(void 0), [ee, je] = k(void 0), [Je, ur] = k([]), pr = w === "dropdown" && Bt === "selectedBooks", Dr = /* @__PURE__ */ a(
    uu,
    {
      availableBookInfo: o,
  ...
  ), Or = Qt === "end", Mr = Qt === "start", Ze = "tw:text-muted-foreground", Le = w === "dropdown" && Bt === "range", $r = Le ? Et : Z, Ir = Le ? je : f ? rt : gt, hr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: v(Or && Ze), children: S }),
      /* @__PURE__ */ a(
        Ra,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ct, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: v(Mr && Ze), children: K }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
          ...
          localizedStrings: T,
          getEndVerse: y,
          disableReferencesUpTo: Le ? mt ?? vt : vt,
          onOpenChange: I,
          onCloseAutoFocus: (D) => {
            var W;
            jt.current && (jt.current = !1, D.preventDefault(), (W = ce.current) == null || W.focus());
          },
          className: v(Mr && Ze),
          modal: !0,
          align: "start"
  ...
  G(() => {
    ...
    const W = requestAnimationFrame(() => {
      D = requestAnimationFrame(() => {
        var kt;
        (kt = Pr.current[t]) == null || kt.focus();
      });
    });
    return () => {
      cancelAnimationFrame(W), D && cancelAnimationFrame(D);
    };
  }, [Pt, t]);
  const [Be, Ar] = k(null), [Fe, xa] = k(null), [Ue, ya] = k(null), ka = 200, [_a, Na] = k(!1);
  G(() => {
    if (!Ue || typeof ResizeObserver > "u") return;
    const D = new ResizeObserver(([W]) => {
      Na(W.contentRect.width < ka);
    });
    return D.observe(Ue), () => D.disconnect();
  }, [Ue]);
  const Vr = j(
    (D) => {
      O(D), Et(vt), je(At), ur(n), Lt(!1), qt(D);
    },
    [vt, At, n]
  ), jr = j(() => {
    Zt !== void 0 && (Zt === "range" ? (mt && (g == null || g(mt)), ee && (f == null || f(ee))) : Zt === "selectedBooks" && i(Je), et(Zt), qt(void 0), O(void 0));
  }, [
    Zt,
    mt,
    ee,
    ...
    D || (qt(void 0), O(void 0));
  }, []), J = j((D) => {
    var W;
    D.preventDefault(), (W = fr.current) == null || W.focus();
  }, []), tt = (D) => t === D ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ze, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !N && /* @__PURE__ */ a(Nt, { children: Y }),
      w === "dropdown" ? /* @__PURE__ */ u(Ie, { open: Pt, onOpenChange: Lt, children: [
        /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ u(
          H,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: E() }),
              /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          Ae,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Ca, { container: Ue, children: [
              bt.map(({ value: D, label: W, dropdownLabel: kt, scrRefSuffix: le, id: Ft }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: gr(D),
                  className: "tw:relative tw:ps-8 data-[highlighted]:tw:bg-accent data-[highlighted]:tw:text-accent-foreground",
                  onSelect: () => et(D),
                  "data-selected": t === D ? "true" : void 0,
                  children: [
                    t === D && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ze, { className: "tw:h-4 tw:w-4" }) }),
                    it(kt ?? W, le, _a)
                  ]
                },
                Ft
              ...
              m && /* @__PURE__ */ u(nt, { children: [
                /* @__PURE__ */ a(Ge, {}),
                /* @__PURE__ */ a(Tr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: dt }),
                /* @__PURE__ */ a(
                  qe,
                  {
                    ref: Jt,
                    ...
                    onSelect: (D) => {
                      var W, kt;
                      if (D.preventDefault(), yt.current) {
                        yt.current = !1;
                        return;
                      }
                      oe.current || (kt = (W = Vt.current) == null ? void 0 : W.querySelector("button")) == null || kt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (D) => {
                          const W = D.target instanceof HTMLElement ? D.target : void 0;
                          W != null && W.closest("button") && (yt.current = !0, requestAnimationFrame(() => {
                            yt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          Ra,
                          {
                            ...
                            onCloseAutoFocus: (D) => {
                              var W;
                              D.preventDefault(), (W = Jt.current) == null || W.focus();
                            },
                            modal: !0,
                            className: "tw:w-full tw:min-w-0 tw:max-w-none tw:justify-between tw:px-2 tw:font-normal",
                            triggerContent: /* @__PURE__ */ u(nt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: be(b ?? Sa, "id") }),
                              /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        co,
        {
          ...
          children: pt.map(({ value: D, label: W, scrRefSuffix: kt, id: le }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ea, { className: "tw:me-2", value: D, id: le }),
            /* @__PURE__ */ a(Nt, { htmlFor: le, children: it(W, kt) })
          ] }, le))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { children: R }),
      Dr
    ] }),
    w === "radio" && t === "range" && hr,
    w === "dropdown" && ut && /* @__PURE__ */ a(Ba, { open: Bt === "selectedBooks", onOpenChange: x, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: xa,
        onCloseAutoFocus: J,
        onEscapeKeyDown: (D) => {
          Fe != null && Fe.querySelector('[data-state="open"]') && D.preventDefault();
        },
        children: /* @__PURE__ */ u(Ca, { container: Fe, children: [
          /* @__PURE__ */ a(Ua, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ka, { children: L }) }),
          Dr,
          /* @__PURE__ */ u(Io, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => x(!1), children: Q }),
            /* @__PURE__ */ a(H, { onClick: jr, children: ot })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && ft && /* @__PURE__ */ a(Ba, { open: Bt === "range", onOpenChange: x, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Ar,
        onCloseAutoFocus: J,
        onEscapeKeyDown: (D) => {
          Be != null && Be.querySelector('[data-state="open"]') && D.preventDefault();
        },
        children: /* @__PURE__ */ u(Ca, { container: Be, children: [
          /* @__PURE__ */ a(Ua, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ka, { children: _ }) }),
          hr,
          /* @__PURE__ */ u(Io, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => x(!1), children: Q }),
            /* @__PURE__ */ a(H, { ref: ce, onClick: jr, children: ot })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: l[Lo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Bi = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Mt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    qe,
    {
      onClick: () => {
        o(c);
    ...
    /* @__PURE__ */ a(us, { children: /* @__PURE__ */ a(ps, { children: Bi(
      t,
      e,
      Li(t, c.id),
      o
...
function io({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    /* @__PURE__ */ a(Pe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(H, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(qs, {}) }) }),
    /* @__PURE__ */ a(Ae, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(pa, { children: [
      /* @__PURE__ */ a(Sn, { children: /* @__PURE__ */ a(Dt, { children: Bi(e.groups, e.items, l, t) }) }),
...
const mu = Object.freeze([520, 420, 340]), Ui = Wt.forwardRef(
  ({ id: t, className: e, children: r, shrinkStep: o }, n) => {
    const [i, s] = k(void 0), c = F(n);
    c.current = n;
    const l = j((p) => {
      s(p ?? void 0);
      const h = c.current;
...
Ki.displayName = se.List.displayName;
...
Hi.displayName = se.List.displayName;
const vu = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Trigger,
  {
    ref: r,
    ...e,
...
)), qi = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Content,
  {
    ref: r,
    className: v(
...
qi.displayName = se.Content.displayName;
function bh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ki, { children: [
      /* @__PURE__ */ a(Hi, { children: t.map((c) => /* @__PURE__ */ a(vu, { value: c.value, children: c.value }, c.key)) }),
...
const br = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(Mt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        Nu,
        {
          onClick: () => {
            o(d);
        ...
        /* @__PURE__ */ a(Tu, { children: d.label }),
        /* @__PURE__ */ a(Su, { children: Gi(
          t,
          e,
          Li(t, d.id),
          o
...
function zu({
  ...
  if (vl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(bu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(xu, { children: [
      /* @__PURE__ */ a(ku, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        _u,
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Dt, { children: Gi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const Ru = Object.freeze([950, 800, 700]);
function xh(t) {
  switch (t) {
    case void 0:
      return;
...
function yh({
  ...
  return /* @__PURE__ */ a(No.Provider, { value: b, children: /* @__PURE__ */ a(
    "div",
    {
...
function kh({
  ...
  const d = Du(
    ...
    var T, y, N, $, B, C;
    const m = b !== f ? ((y = (T = t[f]) == null ? void 0 : T.uiNames) == null ? void 0 : y[b]) ?? (($ = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : $.en) : void 0;
    return m ? `${(B = t[f]) == null ? void 0 : B.autonym} (${m})` : (C = t[f]) == null ? void 0 : C.autonym;
  };
      ...
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: Ye },
              children: Object.keys(t).map((f) => /* @__PURE__ */ a(ne, { value: f, children: g(f, e) }, f))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Nt, { className: "tw:font-normal tw:text-muted-foreground", children: Te(d, {
...
function Nh({
  ...
  return /* @__PURE__ */ u(Me, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(gs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        "input",
        {
      ...
      /* @__PURE__ */ a(fs, { children: /* @__PURE__ */ a(wc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u($e, { children: [
...
function Eh({
  ...
  const c = t ? Bo(r, { key: o }).join("") : "", {
    anchorRect: l,
    message: d,
    confirmingKeyLabel: w,
    showArrow: p
  } = Iu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
    ...
    /* @__PURE__ */ u(Ot, { open: t, onOpenChange: () => {
      ...
      /* @__PURE__ */ a(
        $t,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Bo(d, {
            key: /* @__PURE__ */ a(
              Ha,
              {
                className: v(
            ...
            d && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ie, { children: [
                  /* @__PURE__ */ a(Pe, { className: v(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    H,
                    {
                  ...
                  /* @__PURE__ */ a(Ae, { align: "end", children: d })
                ] })
              }
            )
          ] }),
...
function Sh({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function Rh({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = M(() => {
    const c = new Ln(o);
    return (l) => c.format(l);
...
function $h({ ...t }) {
  return /* @__PURE__ */ a(It.Root, { "data-slot": "context-menu", ...t });
}
function Ih({
  className: t,
  ...e
...
function Ph({ ...t }) {
  return /* @__PURE__ */ a(It.Group, { "data-slot": "context-menu-group", ...t });
}
function Ah({ ...t }) {
  return /* @__PURE__ */ a(It.Portal, { "data-slot": "context-menu-portal", ...t });
}
function Vh({ ...t }) {
  return /* @__PURE__ */ a(It.Sub, { "data-slot": "context-menu-sub", ...t });
}
function jh({
  ...t
}) {
  return /* @__PURE__ */ a(It.RadioGroup, { "data-slot": "context-menu-radio-group", ...t });
}
function Lh({
  className: t,
...
function Kh({
  ...
  return /* @__PURE__ */ u(
    It.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(It.ItemIndicator, { children: /* @__PURE__ */ a(ha, {}) }) }),
        e
      ]
    }
  );
...
function Zh({
  ...
  const n = fe();
  return /* @__PURE__ */ u(Au, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Vu, {}),
    /* @__PURE__ */ u(
      Ve.Content,
      {
...
function hg({
  ...
  return /* @__PURE__ */ a(
    se.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Lu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function yg(t) {
  const e = M(() => ac(t).slice().sort().join(" "), [t]);
...
export {
  ...
  Yd as COMMENT_LIST_ELEMENT_ID,
  kp as COMMENT_LIST_STRING_KEYS,
  bp as CONFLICT_NOTE_STRING_KEYS,
  ...
  Hh as ContextMenuRadioItem,
  Gh as ContextMenuSeparator,
  Wh as ContextMenuShortcut,
  Vh as ContextMenuSub,
  Uh as ContextMenuSubContent,
  Fh as ContextMenuSubTrigger,
  Ih as ContextMenuTrigger,
  pw as DataTable,
  Eh as DestructiveKeyConfirmation,
  Ba as Dialog,
  Tg as DialogClose,
  Fa as DialogContent,
  ...
  Ka as DialogTitle,
  Dg as DialogTrigger,
  du as DisabledActionTooltip,
  lu as DisabledTooltipWrapper,
  Yh as Drawer,
  Jh as DrawerClose,
  Zh as DrawerContent,
  ...
  Pw as FootnoteItem,
  Bp as FootnoteList,
  _h as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Wp as INVENTORY_STRING_KEYS,
  wa as Input,
  Nh as InterfaceLanguagePicker,
  Yp as Inventory,
  Ha as Kbd,
  Mg as KbdGroup,
  Nt as Label,
  ...
  Th as ResultsCard,
  wh as SCOPE_SELECTOR_STRING_KEYS,
  pu as SELECT_BOOKS_STRING_KEYS,
  Yr as SHRINK_STEP,
  uh as ScopeSelector,
  ...
  lh as SettingsSidebarContentSearch,
  No as ShrinkStepContext,
  Gw as Sidebar,
  Yw as SidebarContent,
  th as SidebarFooter,
  xn as SidebarGroup,
  rh as SidebarGroupAction,
  ...
  Ww as SidebarInset,
  Xw as SidebarMenu,
  ah as SidebarMenuAction,
  oh as SidebarMenuBadge,
  Qw as SidebarMenuButton,
  Jw as SidebarMenuItem,
  nh as SidebarMenuSkeleton,
  ih as SidebarMenuSub,
  ch as SidebarMenuSubButton,
  sh as SidebarMenuSubItem,
  qw as SidebarProvider,
  Jp as SidebarRail,
  eh as SidebarSeparator,
  ...
  Ug as Z_INDEX_FIRST_RUN,
  zn as Z_INDEX_FOOTNOTE_EDITOR,
  Kg as Z_INDEX_MODAL,
  Hg as Z_INDEX_MODAL_BACKDROP,
  cs as Z_INDEX_OVERLAY,
  qg as badgeVariants,
  Gg as buttonGroupVariants,
  Wg as buttonVariants,
  v as cn,
  Gp as getBookIdFromUSFM,
  _p as getCommentThreadElementId,
  ...
  Fi as useShrinkStep,
  yl as useShrinkStepValue,
  va as useSidebar,
  xg as useStylesheet,
  _g as useTabIconSelection,
  $o as useTruncationTooltip,
  Fu as useViewVisibility
};
