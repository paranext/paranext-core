...
import m, { forwardRef as ue, useState as O, createContext as Ar, useContext as zr, useCallback as G, useRef as q, useMemo as J, useEffect as ct, useLayoutEffect as bn, Fragment as On } from "react";
import { Check as _t, CircleSlash as Br, ChevronRight as qe, Circle as Je, X as We, Search as Mn, ChevronsUpDown as Ze, FilterIcon as Ir, ChevronDown as me, ChevronUp as Pr, ArrowLeftIcon as jr, ChevronLeftIcon as Fr, ChevronRightIcon as Xr, ArrowRightIcon as $r, Copy as Gr, Filter as Lr, User as Hr, Link as Yr, CircleHelp as Ur, Star as Kr, CircleCheckIcon as qr, CircleXIcon as Jr, CircleHelpIcon as Wr, ArrowUpIcon as Zr, ArrowDownIcon as Qr, ArrowUpDownIcon as ta, PanelLeft as ea, PanelRight as na, ScrollText as ra, ChevronLeft as aa, MenuIcon as oa, Menu as sa, EllipsisVertical as ia, LoaderCircle as wa } from "lucide-react";
    ...
    return /* @__PURE__ */ d("div", { className: "tw-relative tw-max-w-48", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          ...
          onKeyDown: (u) => {
            u.key === "Enter" ? (a(), u.preventDefault()) : e(u);
          },
          onClick: n,
          onFocus: (u) => {
            var h;
            b(!0), (h = c.onFocus) == null || h.call(c, u);
          },
          onBlur: (u) => {
            var h;
            b(!1), (h = c.onBlur) == null || h.call(c, u);
          },
          ref: l
        }
      ),
...
const Xn = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ d(
    X.SubTrigger,
    {
...
const $n = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  X.SubContent,
  {
    ref: n,
    className: p(
...
const re = m.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = Z();
...
const ge = m.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = Z(), s = ut();
  return /* @__PURE__ */ r(
    X.Item,
    {
...
const nn = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ d(
    X.CheckboxItem,
    {
...
const Gn = m.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ d(
    X.RadioItem,
    {
...
const be = m.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
...
function ei({
  ...
  const o = Z(), [s, i] = O(
    () => Mt(t, "English")
  ), [w, c] = O(""), [l, f] = O(t.book), [b, u] = O(t.chapterNum ?? 0), [h, v] = O(t.book), [y, k] = O(!1), [_, N] = O(y), [A, z] = O(!1), [B, mt] = O(), U = q(void 0), C = q(void 0), x = q(void 0), j = q(void 0), R = G(
    (g) => {
      if (g.trim())
        return kn.reduce(
          (D, S) => {
            ...
            const Y = S.exec(g);
            if (Y) {
              const [F, Rt = void 0, se = void 0] = Y.slice(1), it = _n(F) ?? (M.isBookIdValid(F) ? F.toLocaleUpperCase() : void 0);
              if (it) {
    ...
    if (!(!B || !B.chapterNum))
      return B.verseNum ? [B.chapterNum] : Array.from({ length: It(h) }, (g, D) => D + 1).filter(
        (g) => {
          var D;
    ...
    (g) => {
      const D = a ? a() : sn;
      return {
        OT: D.filter((S) => M.isBookOT(S)),
        NT: D.filter((S) => M.isBookNT(S)),
        DC: D.filter((S) => M.isBookDC(S))
      }[g].filter((S) => {
        const Y = Jn[S].toLowerCase(), F = w.length > 0 && /^\d/.test(w) ? (
        ...
        S.toLowerCase() === F : Y.includes(F) || // Match partial book name
    ...
    i(Mt(t, "English")), c(""), f(t.book), v(t.book);
  }, [t]), gt = G((g) => {
    if (K.current) {
      K.current = !1;
      return;
    ...
    (g, D, S, Y) => {
      if (u(t.book !== g ? 1 : t.chapterNum), D || It(g) === -1) {
        e({
          book: g,
          chapterNum: S ?? 1,
          verseNum: Y ?? 1
    ...
    kn.forEach((g) => {
      const D = g.exec(w);
      if (D) {
        const [S, Y = void 0, F = void 0] = D.slice(1), Rt = _n(S);
        (M.isBookIdValid(S) || Rt) && ot(
          Rt ?? S,
          !0,
          Y ? parseInt(Y, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    (g) => {
      if (!y)
        ...
        return;
      } else g.key === "ArrowDown" ? (j != null && j.current ? j.current.focus() : x != null && x.current ? x.current.focus() : C.current && C.current.focus(), g.preventDefault()) : g.key === "Escape" && document.activeElement === U.current && (k(!1), g.preventDefault(), g.stopPropagation());
      if (document.activeElement === U.current) {
        ...
        if (!A && g.key === ":") {
          ...
          if (S) {
            const Y = S[1], F = Y.endsWith(":") ? `${Y}` : `${Y}:`;
            T(F), z(!0), g.preventDefault();
          }
        }
        vn.has(g.key) || z(!0);
      }
    ...
    (g, D) => {
      ...
      if (Cn.has(S)) {
        if (h === l || tt === 1) {
          const F = tt === 1 ? h : l;
          if (S === "Enter") {
            g.preventDefault(), ot(F, !0, b);
            return;
          }
          const Rt = S === "ArrowRight" && !o || S === "ArrowRight" && o === "ltr" || S === "ArrowLeft" && o === "rtl", se = S === "ArrowLeft" && !o || S === "ArrowLeft" && o === "ltr" || S === "ArrowRight" && o === "rtl", Oe = Array.from(
            { length: It(h) },
            (ie, Et) => Et + 1
          ), it = l !== h || tt === 1 ? L ?? Oe : Oe, dt = it.indexOf(b);
          let yt = b;
          if (Rt)
  ...
  return ct(() => {
    tt === 1 ? u(1) : l === h ? l === t.book ? u(t.chapterNum) : u(1) : u(0);
  }, [h, t.book, t.chapterNum, l, tt]), ct(() => {
    if (!L || tt > 1) return;
    L.indexOf(b) === -1 && u(L[0]);
  }, [h, b, l, L, tt]), ct(() => {
    et();
    ...
    const g = setTimeout(() => {
      var D, S;
      if (_ && C.current && x.current) {
        const F = x.current.offsetTop - Ha;
        C.current.scrollTo({ top: F, behavior: "instant" }), U.current.focus();
      }
  ...
  }, [_, et]), /* @__PURE__ */ d(fe, { modal: !1, open: y, onOpenChange: gt, children: [
    /* @__PURE__ */ r(en, { asChild: !0, children: /* @__PURE__ */ r(
      ka,
      {
        ...
        handleKeyDown: Dr,
        handleOnClick: () => {
          f(t.book), v(t.book), u(t.chapterNum > 0 ? t.chapterNum : 0), U.current.focus();
        },
        onFocus: () => {
          ...
          Q.map((g, D) => /* @__PURE__ */ d("div", { children: [
            ...
            g.books.map((S, Y) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Xa,
              {
                ...
                shouldExpandChildren: l.toLowerCase() === S.toLowerCase() || tt === 1,
                handleHighlightBook: () => v(S),
                handleKeyDown: (F) => Mr(F, Y),
                bookType: g.bookType,
                ref: (F) => {
                  l === S && (x.current = F);
                },
                children: /* @__PURE__ */ r(
                  $a,
                  {
                    ...
                    highlightedChapter: l === h || tt === 1 ? b : 0,
...
), W = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(An.Root, { ref: n, className: p("pr-twp", Ua(), t), ...e }));
...
const ve = Qt.Root, xe = Qt.Trigger, ae = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = Z();
...
const Ka = ft.Portal, Wn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: p(
...
const qa = m.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = Z();
...
const Ce = m.forwardRef((t, e) => /* @__PURE__ */ r(rt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
const Zn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Separator,
  {
    ref: n,
...
function He({
  ...
  const [k, _] = O(!1);
  return /* @__PURE__ */ d(ve, { open: k, onOpenChange: _, ...y, children: [
...
function ri({
  ...
  const f = Be(l, "%webView_bookSelector_currentBook%"), b = Be(l, "%webView_bookSelector_choose%"), u = Be(l, "%webView_bookSelector_chooseBooks%"), [h, v] = O(
    "current book"
    /* CURRENT_BOOK */
  ), y = (k) => {
    v(k), t(k);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(W, { className: "tw-ms-1", children: f })
          ] }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(W, { className: "tw-ms-1", children: u })
          ] }),
          /* @__PURE__ */ r(W, { className: "tw-flex tw-items-center", children: a.map((k) => M.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
const Ft = H.Root, no = H.Group, Xt = H.Value, ro = St(
...
const Bt = m.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = Z();
...
const ao = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  H.Label,
  {
    ref: n,
...
const wt = m.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  H.Item,
  {
    ref: a,
    className: p(
...
const oo = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  H.Separator,
  {
    ref: n,
    className: p("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
const Re = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: p("[&_tr:last-child]:tw-border-0", t), ...e }));
Re.displayName = "TableBody";
const wo = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
...
const Ct = m.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a, ...o }, s) => {
  ...
  const w = (u, h, v) => {
    let y;
    return v === "ArrowDown" && h < u.length - 1 ? y = u[h + 1] : v === "ArrowUp" && h > 0 && (y = u[h - 1]), y ? (requestAnimationFrame(() => y.focus()), !0) : !1;
  }, c = (u, h, v) => {
    let y;
    return v === "ArrowLeft" && h > 0 ? y = u[h - 1] : v === "ArrowRight" && h < u.length - 1 && (y = u[h + 1]), y ? (requestAnimationFrame(() => y.focus()), !0) : !1;
  }, l = m.useMemo(
    ...
    const v = h.closest("table"), y = v ? (
      // getFocusableElements returns an HTMLElement[] but we are filtering for HTMLTableRowElements
      // eslint-disable-next-line no-type-assertion/no-type-assertion
      te(v).filter(
        (N) => N.tagName === "TR"
      )
    ) : [], k = y.indexOf(h), _ = l.indexOf(
      // activeElement is generic Element, so we need to cast it to HTMLElement
      // eslint-disable-next-line no-type-assertion/no-type-assertion
      document.activeElement
    );
    if (u.key === "ArrowDown" || u.key === "ArrowUp")
      u.preventDefault(), w(y, k, u.key);
    else if (u.key === "ArrowLeft" || u.key === "ArrowRight")
      u.preventDefault(), c(l, _, u.key);
    else if (u.key === "Escape") {
      u.preventDefault();
      const N = h.closest("table");
      N && N.focus();
    } else if (u.key === "Tab") {
      u.preventDefault();
      return;
...
function po({
  ...
  var k;
  const [w, c] = O([]), [l, f] = O([]), [b, u] = O({}), [h, v] = O({}), y = zn({
    data: e,
    columns: t,
    getCoreRowModel: In(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(eo, { table: y }),
    /* @__PURE__ */ d(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Te, { stickyHeader: s, children: y.getHeaderGroups().map((_) => /* @__PURE__ */ r(Ct, { children: _.headers.map((N) => /* @__PURE__ */ r(ee, { children: N.isPlaceholder ? void 0 : Jt(N.column.columnDef.header, N.getContext()) }, N.id)) }, _.id)) }),
      /* @__PURE__ */ r(Re, { children: (k = y.getRowModel().rows) != null && k.length ? y.getRowModel().rows.map((_) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(_, y),
          "data-state": _.getIsSelected() && "selected",
          children: _.getVisibleCells().map((N) => /* @__PURE__ */ r($t, { children: Jt(N.column.columnDef.cell, N.getContext()) }, N.id))
        },
        _.id
...
function ii({ id: t, label: e, groups: n }) {
  const [a, o] = O(
    ...
    i((u) => (u[l] = f, { ...u }));
    const b = n[l].items.find((u) => u.id === f);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(fe, { children: [
    ...
    /* @__PURE__ */ r(re, { children: n.map((l, f) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(be, { children: l.label }),
      /* @__PURE__ */ r(Fn, { children: l.itemType === 0 ? /* @__PURE__ */ r(pe, { children: l.items.map((b, u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        nn,
        {
          checked: a[f][u],
          onCheckedChange: () => w(f, u),
          children: b.label
        }
      ) }, b.id)) }) : /* @__PURE__ */ r(
        Ta,
...
function wi({
  ...
  }).format(Object.values(n).reduce((f, b) => f + b, 0)), l = () => {
...
function ho({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const c = new Date(w), l = new Date(o.getTime() - c.getTime()), f = l.getUTCFullYear() - 1970, b = l.getUTCMonth(), u = l.getUTCDate() - 1;
    let h = "";
    return f > 0 ? h = `${f.toString()} year${f === 1 ? "" : "s"} ago` : b > 0 ? h = `${b.toString()} month${b === 1 ? "" : "s"} ago` : u === 0 ? h = "today" : h = `${u.toString()} day${u === 1 ? "" : "s"} ago`, h;
  }
...
const fo = St(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: p("pr-twp", fo({ variant: e }), t), ...n })
);
...
function go({
  ...
  const [b, u] = O(!1), h = G(
    (k) => {
      var N;
      const _ = (N = t.find((A) => A.label === k)) == null ? void 0 : N.value;
      _ && a(
        n.includes(_) ? n.filter((A) => A !== _) : [...n, _]
      );
    },
    [t, n, a]
  ), v = () => i || o, y = J(() => {
    if (!c) return t;
    const k = t.filter((N) => N.starred).sort((N, A) => N.label.localeCompare(A.label)), _ = t.filter((N) => !N.starred).sort((N, A) => {
      const z = n.includes(N.value), B = n.includes(A.value);
      return z && !B ? -1 : !z && B ? 1 : N.label.localeCompare(A.label);
    });
    return [...k, ..._];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: f, children: /* @__PURE__ */ d(ve, { open: b, onOpenChange: u, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(ae, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(ye, { children: [
      ...
      /* @__PURE__ */ d(ke, { children: [
        ...
        /* @__PURE__ */ r(ln, { children: y.map((k) => {
...
function di({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((u) => {
      var h;
      return /* @__PURE__ */ d(de, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          I,
          {
            ...
            onClick: () => a(n.filter((v) => v !== u)),
            children: /* @__PURE__ */ r(We, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (h = t.find((v) => v.value === u)) == null ? void 0 : h.label
      ] }, u);
...
), vo = m.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Pn.Root,
  {
    ref: o,
...
const nr = m.createContext({
  size: "default",
  variant: "default"
}), rr = m.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = Z();
  return /* @__PURE__ */ r(
    he.Root,
    {
...
const we = m.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const Ee = (t) => t === "asc" ? /* @__PURE__ */ r(Zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ta, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ci = (t) => ({
  accessorKey: "item",
...
function bi({
  ...
  const l = bt(n, "%webView_inventory_all%"), f = bt(n, "%webView_inventory_approved%"), b = bt(n, "%webView_inventory_unapproved%"), u = bt(n, "%webView_inventory_unknown%"), h = bt(n, "%webView_inventory_scope_currentBook%"), v = bt(n, "%webView_inventory_scope_chapter%"), y = bt(n, "%webView_inventory_scope_verse%"), k = bt(n, "%webView_inventory_filter_text%"), _ = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [N, A] = O(!1), [z, B] = O("all"), [mt, U] = O(""), [C, x] = O([]), j = J(() => t.length === 0 ? [] : ko(t, o, s), [t, o, s]), R = J(() => {
    if (N) return j;
    const T = [];
    return j.forEach((K) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Ft,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(Bt, { children: [
              ...
              /* @__PURE__ */ r(wt, { value: "unknown", children: u })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Ft, { onValueChange: (T) => Tt(T), defaultValue: i, children: [
        /* @__PURE__ */ r(zt, { className: "tw-m-1", children: /* @__PURE__ */ r(Xt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Bt, { children: [
          /* @__PURE__ */ r(wt, { value: "book", children: h }),
          /* @__PURE__ */ r(wt, { value: "chapter", children: v }),
          /* @__PURE__ */ r(wt, { value: "verse", children: y })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Ht,
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(W, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? _ })
      ] })
    ] }),
...
const cn = m.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  jn.Root,
  {
    ref: o,
    decorative: n,
...
cn.displayName = jn.Root.displayName;
...
const pn = ne.Provider, un = ne.Root, mn = ne.Trigger, De = m.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ne.Content,
  {
    ref: a,
    sideOffset: e,
...
const Co = "16rem", _o = "3rem", ar = m.createContext(void 0);
function Ve() {
...
const or = m.forwardRef(
  ({
    ...
    const [l, f] = m.useState(t), b = e ?? l, u = m.useCallback(
      (A) => {
        const z = typeof A == "function" ? A(b) : A;
        n ? n(z) : f(z);
      },
      [n, b]
    ), h = m.useCallback(() => u((A) => !A), [u]), v = b ? "expanded" : "collapsed", _ = Z() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = m.useMemo(
      () => ({
        state: v,
        open: b,
        setOpen: u,
...
const sr = m.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Ve();
...
const So = m.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Ve();
  return /* @__PURE__ */ d(
    I,
    {
...
const Oo = m.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Gt : "button",
  {
    ref: a,
...
const Mo = St(
  ...
  ({
    ...
    const c = t ? Gt : "button", { state: l } = Ve(), f = /* @__PURE__ */ r(
      c,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: p(Mo({ variant: n, size: a }), s),
        ...i
      }
    );
...
const Ao = m.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Gt : "button",
  {
    ref: o,
...
const Bo = m.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
const jo = m.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Gt : "a",
  {
    ref: s,
...
jo.displayName = "SidebarMenuSubButton";
function Fo({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  const l = G(
    ...
    (u) => {
      const h = n.find((v) => v.projectId === u);
      return h ? h.projectName : u;
    },
    [n]
  ), b = G(
    ...
    sr,
    {
      ...
      children: /* @__PURE__ */ d(wr, { children: [
        /* @__PURE__ */ d(Ye, { children: [
          ...
          /* @__PURE__ */ r(Ke, { children: /* @__PURE__ */ r(lr, { children: Object.entries(e).map(([u, h]) => /* @__PURE__ */ r(dr, { children: /* @__PURE__ */ r(
            cr,
            {
              onClick: () => l(u),
              isActive: b(u),
...
}, En = (t) => `${Uo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function xi({
  sources: t,
  ...
  const [c, l] = O([]), [f, b] = O([{ id: Nt, desc: !1 }]), [u, h] = O({}), v = J(
    () => t.flatMap((C) => C.data.map((x) => ({
      ...x,
      source: C.source
    }))),
    [t]
  ...
  ct(() => {
    if (w) {
      const C = k.getSelectedRowModel().rowsById, x = Object.keys(C);
      if (x.length === 1) {
        const j = v.find((R) => En(R) === x[0]) || void 0;
        j && w(j);
      }
    }
  }, [u, v, w, k]);
  const _ = o ?? Lo, N = s ?? pr, A = [
    ...
    !C.getIsGrouped() && !C.getIsSelected() && C.getToggleSelectedHandler()(x);
  }, mt = (C, x) => C.getIsGrouped() ? "" : p("banded-row", x % 2 === 0 ? "even" : "odd"), U = (C, x, j) => {
    if (!((C == null ? void 0 : C.length) === 0 || x.depth < j.column.getGroupedIndex())) {
      if (x.getIsGrouped())
        switch (x.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Bt, { position: "item-aligned", children: /* @__PURE__ */ r(no, { children: A.map((C) => /* @__PURE__ */ r(wt, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Se, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Te, { children: k.getHeaderGroups().map((C) => /* @__PURE__ */ r(Ct, { children: C.headers.filter((x) => x.column.columnDef.header).map((x) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(ee, { colSpan: x.colSpan, className: "top-0 tw-sticky", children: x.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Re, { children: k.getRowModel().rows.map((C, x) => {
        const j = Z();
        return /* @__PURE__ */ r(
          Ct,
          {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (j === "ltr" ? /* @__PURE__ */ r(qe, {}) : /* @__PURE__ */ r(aa, {})),
                          " ",
...
function Zo({
  ...
  const z = J(() => M.allBookIds.filter(
    ...
    (x, j = !1) => {
      if (!j || !N.current) {
        n(
          e.includes(x) ? e.filter((Q) => Q !== x) : [...e, x]
        ), N.current = x;
        return;
      }
      const R = z.findIndex((Q) => Q === N.current), L = z.findIndex((Q) => Q === x);
      if (R === -1 || L === -1) return;
      const [lt, xt] = [
        Math.min(R, L),
        Math.max(R, L)
      ...
      n(
        e.includes(x) ? e.filter((Q) => !Tt.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...Tt])]
      );
    },
    [e, n, z]
  ), mt = G(
    (x) => {
      const j = fn(z, x).map((R) => R);
      n(
        ur(z, x, e) ? e.filter((R) => !j.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...j])]
      );
    },
    [e, n, z]
  ), U = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(kt).map((x) => /* @__PURE__ */ r(
      Wo,
      {
        section: x,
        availableBookIds: z,
    ...
    /* @__PURE__ */ d(ve, { open: k, onOpenChange: _, children: [
      /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ d(
        I,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(ae, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
        ...
        {
          onKeyDown: (x) => {
            x.key === "Enter" && (A.current = x.shiftKey);
          },
          children: [
            ...
            /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              ...
              /* @__PURE__ */ r(I, { variant: "ghost", size: "sm", onClick: C, children: l })
            ] }),
            /* @__PURE__ */ d(ke, { children: [
              /* @__PURE__ */ r(Ce, { children: f }),
              Object.values(kt).map((x, j) => {
                const R = z.filter(
                  (L) => Pt(L) === x
                );
                if (R.length !== 0)
                  return /* @__PURE__ */ d(On, { children: [
                    ...
                    j < Object.values(kt).length - 1 && /* @__PURE__ */ r(Zn, {})
                  ] }, x);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var j;
        return /* @__PURE__ */ r(de, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((j = o.get(x)) == null ? void 0 : j.localizedName) || M.bookIdToEnglishName(x) || x }, x);
      }),
...
function Ni({
  ...
  const c = Dt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), b = Dt(i, "%webView_scope_selector_current_book%"), u = Dt(i, "%webView_scope_selector_choose_books%"), h = Dt(i, "%webView_scope_selector_scope%"), v = Dt(i, "%webView_scope_selector_select_books%"), y = [
  ...
  ], k = e ? y.filter((_) => e.includes(_.value)) : y;
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        wn,
        {
          ...
          children: k.map(({ value: _, label: N, id: A }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(le, { className: "tw-me-2", value: _, id: A }),
...
const vr = m.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = m.useMemo(
    () => ({
      variant: e
    }),
...
const yr = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ d(
    $.SubTrigger,
    {
...
const kr = m.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ut();
...
const Cr = m.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ r(
    $.Item,
    {
...
const ns = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ d(
    $.CheckboxItem,
    {
...
const rs = m.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ d(
    $.RadioItem,
    {
...
const as = m.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: a,
    className: p("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
const Kt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((l) => l.group === s).sort((l, f) => l.order - f.order).map((l) => /* @__PURE__ */ d(un, { children: [
...
function os({
  ...
  const o = q(void 0), s = q(void 0), i = q(void 0), w = q(void 0), c = q(void 0), l = (f) => {
    switch (f) {
      case "platform.app":
        return s;
  ...
  if (xa(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (f, b) => {
    var v, y, k, _;
    f.preventDefault();
    const u = { key: "Escape", code: "Escape", keyCode: 27, bubbles: !0 }, h = { key: " ", code: "Space", keyCode: 32, bubbles: !0 };
    switch (b.hotkey) {
      case "alt":
        Kt(s, [u]);
        break;
      case "alt+p":
        (v = s.current) == null || v.focus(), Kt(s, [u, h]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Kt(i, [u, h]);
        break;
      case "alt+n":
        (k = w.current) == null || k.focus(), Kt(w, [u, h]);
        break;
      case "alt+h":
        (_ = c.current) == null || _.focus(), Kt(c, [u, h]);
        break;
    }
  }), ct(() => {
    ...
    return /* @__PURE__ */ r(vr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, f]) => typeof f == "object").sort(([, f], [, b]) => typeof f == "boolean" || typeof b == "boolean" ? 0 : f.order - b.order).map(([f, b]) => /* @__PURE__ */ d(ts, { children: [
      /* @__PURE__ */ r(xr, { ref: l(f), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        kr,
        {
          className: "tw-z-[250]",
...
function Vi({
  ...
  const c = ss(
    ...
    o && o(h), a && a([h, ...n.filter((v) => v !== h)]), s && n.find((v) => v === h) && s([...n.filter((v) => v !== h)]), f(!1);
  }, u = (h, v) => {
    var k, _, N, A, z, B;
    const y = v !== h ? ((_ = (k = t[h]) == null ? void 0 : k.uiNames) == null ? void 0 : _[v]) ?? ((A = (N = t[h]) == null ? void 0 : N.uiNames) == null ? void 0 : A.en) : void 0;
    return y ? `${(z = t[h]) == null ? void 0 : z.autonym} (${y})` : (B = t[h]) == null ? void 0 : B.autonym;
  };
  return /* @__PURE__ */ d("div", { className: p("pr-twp tw-max-w-sm", w), children: [
      ...
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((h) => /* @__PURE__ */ r(wt, { value: h, children: u(h, e) }, h))
            }
          )
        ]
      }
    ...
    e !== "en" && /* @__PURE__ */ d(pe, { children: [
      ...
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ d(W, { children: [
        "Currently:",
        " ",
        (n == null ? void 0 : n.length) > 0 ? `${n.map((h) => u(h, e)).join(", ")}` : `default (${t.en.autonym})`
      ] }) })
    ] })
  ] });
}
...
const ws = ue(({ className: t, ...e }, n) => /* @__PURE__ */ r(wa, { size: 35, className: p("tw-animate-spin", t), ...e, ref: n }));
...
), ds = m.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: p(ls({ variant: e }), t), ...n }));
...
const ps = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: p("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const vs = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: p("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Ai = pt.Trigger, ks = pt.Portal, zi = pt.Close, Rr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
const Cs = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
...
const Es = m.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Ge.Root,
  {
    ref: a,
    className: p(
...
Es.displayName = Ge.Root.displayName;
function Bi({ ...t }) {
  return /* @__PURE__ */ r(
    ya,
    {
...
Vs.displayName = Le.Root.displayName;
const Ii = at.Root, Os = m.forwardRef(({ className: t, ...e }, n) => {
  const a = Z();
  return /* @__PURE__ */ r(
    at.List,
    {
...
const Is = (t, e, n = {}) => {
  ...
  const o = q(null), [s, i] = O(void 0), [w, c] = O(void 0), l = G(
    (u) => {
      ...
      v && (v.scrollIntoView({ block: "center" }), v.focus()), o.current && o.current.setAttribute("aria-activedescendant", u);
    },
    [e, t]
  ), f = G(
    (u) => {
      const h = t.find((v) => v.id === u);
      h && (c((v) => v === u ? void 0 : u), n == null || n(h));
    },
    [n, t]
  ), b = G(
    (u) => {
      const h = t.findIndex((k) => k.id === s);
      let v = h;
      switch (u.key) {
        case "ArrowDown":
          v = Math.min(h + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          v = Math.max(h - 1, 0), u.preventDefault();
          break;
        case "Home":
        ...
        case " ":
        case "Enter":
          s && f(s), u.preventDefault(), u.stopPropagation();
          return;
        default:
          u.key.length === 1 && !u.metaKey && !u.ctrlKey && !u.altKey && (a == null || a(u.key), u.preventDefault());
          return;
      }
      const y = t[v];
      y && l(y.id);
