import es, { jsxs as de, jsx as T, Fragment as $r } from "react/jsx-runtime";
import * as x from "react";
import Nt, { forwardRef as ts, useState as Ge, useRef as Nn, useCallback as Ke, useMemo as Bt, useEffect as Fn } from "react";
import { getChaptersForBook as xi, offsetBook as vo, FIRST_SCR_BOOK_NUM as ns, offsetChapter as yo, FIRST_SCR_CHAPTER_NUM as rs, offsetVerse as xo, FIRST_SCR_VERSE_NUM as os } from "platform-bible-utils";
import * as ge from "@radix-ui/react-dropdown-menu";
import { ChevronRight as is, Check as as, Circle as ss, History as ls, Tally1 as wo, ChevronUp as cs } from "lucide-react";
import xe, { clsx as us } from "clsx";
import { twMerge as ds } from "tailwind-merge";
import { Button as ps, Autocomplete as fs, TextField as wi, FormControlLabel as Eo, FormLabel as hs, Checkbox as ms, MenuItem as gs, ListItemText as bs, ListItemIcon as Ei, Menu as vs, Grid as Ti, List as ys, IconButton as ki, Paper as xs, Slider as ws, Snackbar as Es, Switch as Ts, AppBar as ks, Toolbar as Os, Drawer as Ss } from "@mui/material";
...
const Ws = ge.Root, qs = ge.Trigger, Gs = x.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ de(
  ge.SubTrigger,
  {
    ref: o,
    className: Qe(
...
const Ar = x.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ T(
  ge.Item,
  {
    ref: r,
    className: Qe(
...
Ar.displayName = ge.Item.displayName;
const Xs = x.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ de(
  ge.CheckboxItem,
  {
    ref: o,
    className: Qe(
...
const Ys = x.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ de(
  ge.RadioItem,
  {
    ref: r,
    className: Qe(
...
function gh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = me, [r, o] = Ge(""), [i, s] = Ge(""), l = Nn(void 0), c = Ke(
    (g) => ({
    ...
    o(g);
  }, f = Ke((g) => xi(me.bookIdToNumber(g)), []), p = (g) => {
    s(i !== g ? g : ""), f(g) === -1 && t({
  ...
  return /* @__PURE__ */ de("div", { children: [
    /* @__PURE__ */ de(Ws, { children: [
      ...
      /* @__PURE__ */ de($i, { style: { width: "300px", height: "500px", overflowY: "auto" }, children: [
        /* @__PURE__ */ T(
          Ar,
          {
            onSelect: (g) => {
              g.preventDefault(), l.current.focus(), console.log("Attempt to give focus to input");
            },
            children: "Give focus to input"
          }
        ),
        tl.map((g) => /* @__PURE__ */ de("div", { children: [
          /* @__PURE__ */ T(Mi, { children: el[g] }),
          ...
          g === "OT" || g === "NT" ? /* @__PURE__ */ T(_i, {}) : void 0
        ] }, g))
      ] })
    ] }),
    /* @__PURE__ */ T(
...
function nl({
  ...
  let f;
  if (n) {
    const p = r === Ct.Before || r === Ct.Above, v = /* @__PURE__ */ T("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), g = r === Ct.Before || r === Ct.After, m = g ? v : /* @__PURE__ */ T("div", { children: v }), h = g ? d : /* @__PURE__ */ T("div", { children: d });
    f = /* @__PURE__ */ de(
      hs,
      {
...
function il() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = g, ie.Memo = v, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === u || b === i || b === o || b === f || b === p || typeof b == "object" && b !== null && (b.$$typeof === g || b.$$typeof === v || b.$$typeof === s || b.$$typeof === l || b.$$typeof === d || b.$$typeof === h || b.$$typeof === E || b.$$typeof === $ || b.$$typeof === m);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function al() {
  return So || (So = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(N) {
      ...
      N === r || N === u || N === i || N === o || N === f || N === p || typeof N == "object" && N !== null && (N.$$typeof === g || N.$$typeof === v || N.$$typeof === s || N.$$typeof === l || N.$$typeof === d || N.$$typeof === h || N.$$typeof === E || N.$$typeof === $ || N.$$typeof === m);
    }
    function w(N) {
    ...
    var b = c, S = u, P = l, D = s, A = t, I = d, B = r, z = g, q = v, _ = n, L = i, R = o, j = f, Q = !1;
    function Z(N) {
...
var Po;
function Ai() {
  return Po || (Po = 1, process.env.NODE_ENV === "production" ? wn.exports = il() : wn.exports = al()), wn.exports;
}
/*
object-assign
(c) Sindre Sorhus
  ...
  return lr = function(l, c) {
    ...
    function h(O) {
      ...
      function K(U, W, G, H, X, Y, ne) {
        ...
        return W[G] == null ? U ? W[G] === null ? new m("The " + X + " `" + Y + "` is marked as required " + ("in `" + H + "`, but its value is `null`.")) : new m("The " + X + " `" + Y + "` is marked as required in " + ("`" + H + "`, but its value is `undefined`.")) : null : O(W, G, H, X, Y);
      }
      var F = K.bind(null, !1);
    ...
    function w() {
      function O(M, V, K, F, U) {
        ...
        if (!l(W)) {
          var G = R(W);
          return new m("Invalid " + F + " `" + U + "` of type " + ("`" + G + "` supplied to `" + K + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(O);
    ...
    function b() {
      function O(M, V, K, F, U) {
        ...
        if (!e.isValidElementType(W)) {
          var G = R(W);
          return new m("Invalid " + F + " `" + U + "` of type " + ("`" + G + "` supplied to `" + K + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(O);
    ...
    function S(O) {
      function M(V, K, F, U, W) {
        if (!(V[K] instanceof O)) {
          ...
          return new m("Invalid " + U + " `" + W + "` of type " + ("`" + H + "` supplied to `" + F + "`, expected ") + ("instance of `" + G + "`."));
        }
        return null;
      }
      return h(M);
    ...
    function P(O) {
      ...
      function M(V, K, F, U, W) {
        ...
        return new m("Invalid " + U + " `" + W + "` of value `" + String(G) + "` " + ("supplied to `" + F + "`, expected one of " + X + "."));
      }
      return h(M);
    }
    function D(O) {
    ...
    function A(O) {
      ...
      function K(F, U, W, G, H) {
        ...
        return new m("Invalid " + G + " `" + H + "` supplied to " + ("`" + W + "`" + J + "."));
      }
      return h(K);
    }
    function I() {
      function O(M, V, K, F, U) {
        return _(M[V]) ? null : new m("Invalid " + F + " `" + U + "` supplied to " + ("`" + K + "`, expected a ReactNode."));
      }
      return h(O);
    }
...
function xl() {
  return Ao || (Ao = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), v = Symbol.for("react.offscreen"), g = !1, m = !1, h = !1, E = !1, $ = !1, y;
    y = Symbol.for("react.module.reference");
    function w(C) {
      return !!(typeof C == "string" || typeof C == "function" || C === n || C === o || $ || C === r || C === u || C === d || E || C === v || g || m || h || typeof C == "object" && C !== null && (C.$$typeof === p || C.$$typeof === f || C.$$typeof === i || C.$$typeof === s || C.$$typeof === c || // This needs to include all possible module reference object
...
function Bl() {
  this.visibilityState === "hidden" && Tr && (Vn = !0);
}
function Ll(e) {
  e.addEventListener("keydown", jl, !0), e.addEventListener("mousedown", ur, !0), e.addEventListener("pointerdown", ur, !0), e.addEventListener("touchstart", ur, !0), e.addEventListener("visibilitychange", Bl, !0);
}
function Fl(e) {
  const {
    target: t
...
function Jl(e) {
  ...
  if (!t) {
    const v = xe(n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), g = k({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), m = k({}, n, o, r);
    return v.length > 0 && (m.className = v), Object.keys(g).length > 0 && (m.style = g), {
      props: m,
      internalRef: void 0
    };
  }
  const s = ea(k({}, o, r)), l = Vo(r), c = Vo(o), u = t(s), d = xe(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), p = k({}, u, n, c, l);
...
function _n(e) {
  const {
    ...
    isEnabled: s = sc,
    open: l
  } = e, c = x.useRef(!1), u = x.useRef(null), d = x.useRef(null), f = x.useRef(null), p = x.useRef(null), v = x.useRef(!1), g = x.useRef(null), m = De(t.ref, g), h = x.useRef(null);
  x.useEffect(() => {
    !l || !g.current || (v.current = !n);
  }, [n, l]), x.useEffect(() => {
    if (!l || !g.current)
      return;
    const y = we(g.current);
...
`)), g.current.setAttribute("tabIndex", "-1")), v.current && g.current.focus()), () => {
    ...
    const y = we(g.current), w = (P) => {
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (D = i(g.current)), D.length > 0) {
        var A, I;
        const B = !!((A = h.current) != null && A.shiftKey && ((I = h.current) == null ? void 0 : I.key) === "Tab"), z = D[0], q = D[D.length - 1];
...
function bc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = x.useRef({}), v = x.useRef(null), g = x.useRef(null), m = De(g, f), [h, E] = x.useState(!d), $ = mc(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const w = () => we(v.current), b = () => (p.current.modalRef = g.current, p.current.mount = v.current, p.current), S = () => {
    o.mount(b(), {
      disableScrollLock: r
    ...
    v.current = R, R && (d && D() ? S() : g.current && en(g.current, y));
  }), I = x.useCallback(() => {
    o.remove(b(), y);
  }, [y, o]);
  x.useEffect(() => () => {
...
var Se = "top", je = "bottom", Be = "right", Pe = "left", Br = "auto", pn = [Se, je, Be, Pe], It = "start", sn = "end", vc = "clippingParents", ra = "viewport", Gt = "popper", yc = "reference", Ho = /* @__PURE__ */ pn.reduce(function(e, t) {
...
function Ic(e) {
  ...
  var o = zn(e);
  for (Lr(o) && (o = o.host); Ae(o) && ["html", "body"].indexOf(ze(o)) < 0; ) {
    var i = Je(o);
...
function fn(e) {
  for (var t = Me(e), n = Wo(e); n && _c(n) && Je(n).position === "static"; )
    n = Wo(n);
...
function jc(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Fe(n.placement), c = Vr(l), u = [Pe, Be].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = Dc(o.padding, n), p = Fr(i), v = c === "y" ? Se : Pe, g = c === "y" ? je : Be, m = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], h = s[c] - n.rects.reference[c], E = fn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = m / 2 - h / 2, w = f[v], b = $ - p[d] - f[g], S = $ / 2 - p[d] / 2 + y, P = tn(w, S, b), D = c;
...
function qo(e) {
  ...
  if (v = z.x, m = z.y, c) {
    var q;
    return Object.assign({}, B, (q = {}, q[w] = $ ? "0" : "", q[y] = E ? "0" : "", q.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + v + "px, " + m + "px)" : "translate3d(" + v + "px, " + m + "px, 0)", q));
  }
  return Object.assign({}, B, (t = {}, t[w] = $ ? m + "px" : "", t[y] = E ? v + "px" : "", t.transform = "", t));
}
function zc(e) {
...
function ua(e) {
  return ["html", "body", "#document"].indexOf(ze(e)) >= 0 ? e.ownerDocument.body : Ae(e) && Hr(e) ? e : ua(zn(e));
}
function nn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? vc : l, u = n.rootBoundary, d = u === void 0 ? ra : u, f = n.elementContext, p = f === void 0 ? Gt : f, v = n.altBoundary, g = v === void 0 ? !1 : v, m = n.padding, h = m === void 0 ? 0 : m, E = la(typeof h != "number" ? h : ca(h, pn)), $ = p === Gt ? yc : Gt, y = e.rects.popper, w = e.elements[g ? $ : p], b = Zc(bt(w) ? w : w.contextElement || at(e.elements.popper), c, d, s), S = Dt(e.elements.reference), P = da({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
...
function Qc(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? oa : c, d = jt(r), f = d ? l ? Ho : Ho.filter(function(g) {
    return jt(g) === d;
  }) : pn, p = f.filter(function(g) {
...
function tu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, v = n.flipVariations, g = v === void 0 ? !0 : v, m = n.allowedAutoPlacements, h = t.options.placement, E = Fe(h), $ = E === h, y = c || ($ || !g ? [Sn(h)] : eu(h)), w = [h].concat(y).reduce(function(F, U) {
      return F.concat(Fe(U) === Br ? Qc(t, {
        placement: U,
        boundary: d,
        rootBoundary: f,
        padding: u,
...
function du(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, v = p === void 0 ? !0 : p, g = n.tetherOffset, m = g === void 0 ? 0 : g, h = ln(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), E = Fe(t.placement), $ = jt(t.placement), y = !$, w = Vr(E), b = uu(w), S = t.modifiersData.popperOffsets, P = t.rects.reference, D = t.rects.popper, A = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, I = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (S) {
    if (i) {
      var q, _ = w === "y" ? Se : Pe, L = w === "y" ? je : Be, R = w === "y" ? "height" : "width", j = S[w], Q = j + h[_], Z = j - h[L], O = v ? -D[R] / 2 : 0, M = $ === It ? P[R] : D[R], V = $ === It ? -D[R] : -P[R], K = t.elements.arrow, F = v && K ? Fr(K) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : sa(), W = U[_], G = U[L], H = tn(0, P[R], F[R]), X = y ? P[R] / 2 - O - H - W - I.mainAxis : M - H - W - I.mainAxis, Y = y ? -P[R] / 2 + O + H + G + I.mainAxis : V + H + G + I.mainAxis, ne = t.elements.arrow && fn(t.elements.arrow), N = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (q = B == null ? void 0 : B[w]) != null ? q : 0, C = j + X - J - N, re = j + Y - J, ve = tn(v ? In(Q, C) : Q, j, v ? ft(Z, re) : Z);
      S[w] = ve, z[w] = ve - j;
    }
    if (l) {
      var Te, he = w === "x" ? Se : Pe, lt = w === "x" ? je : Be, ke = S[b], He = b === "y" ? "height" : "width", Ce = ke + h[he], We = ke - h[lt], ye = [Se, Pe].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[b]) != null ? Te : 0, ct = ye ? Ce : ke - P[He] - D[He] - yt + I.altAxis, Vt = ye ? ke + P[He] + D[He] - yt - I.altAxis : We, bn = v && ye ? Ac(ct, ke, Vt) : tn(v ? ct : Ce, ke, v ? Vt : We);
      S[b] = bn, z[b] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
const Ru = () => et({
  ...
  } = t, h = ce(t, Ou), E = x.useRef(null), $ = De(E, n), y = x.useRef(null), w = De(y, p), b = x.useRef(w);
  mt(() => {
    b.current = w;
  }, [w]), x.useImperativeHandle(p, () => y.current, []);
  const S = Pu(d, s), [P, D] = x.useState(S), [A, I] = x.useState(An(o));
  x.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && A && Un(A) && A.nodeType === 1) {
...
`));
  ...
  const z = Ru(), q = (r = g.root) != null ? r : "div", _ = gt({
    elementType: q,
  ...
  if (i)
    ...
    const I = An(r);
    P = I && Un(I) ? we(I).body : we(null).body;
  }
...
function be(e) {
  const {
    ...
    return Ze(s, l, (f) => {
      let p = Dn(u, o, f);
      return f === p && typeof f == "string" && (p = Dn(u, o, `${t}${f === "default" ? "" : Ve(f)}`, f)), n === !1 ? p : {
        [n]: p
      };
    });
  };
...
const Ku = Le("border", Ie), Xu = Le("borderTop", Ie), Yu = Le("borderRight", Ie), Ju = Le("borderBottom", Ie), Zu = Le("borderLeft", Ie), Qu = Le("borderColor"), ed = Le("borderTopColor"), td = Le("borderRightColor"), nd = Le("borderBottomColor"), rd = Le("borderLeftColor"), od = Le("outline", Ie), id = Le("outlineColor"), Kn = (e) => {
...
Gn(Ku, Xu, Yu, Ju, Zu, Qu, ed, td, nd, rd, Kn, od, id);
const Xn = (e) => {
...
Gn(Xn, Yn, Jn, ad, sd, ld, cd, ud, dd, pd, fd, hd);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const md = be({
...
function Pd() {
  function e(n, r, o, i) {
    ...
    const p = Hn(o, u) || {};
    return f ? f(s) : Ze(s, r, (g) => {
      let m = Dn(p, d, g);
      return g === m && typeof g == "string" && (m = Dn(p, d, `${n}${g === "default" ? "" : Ve(g)}`, g)), c === !1 ? m : {
        [c]: m
      };
    });
  }
...
function Xr(e = {}, ...t) {
  ...
  return u.applyStyles = Cd, u = t.reduce((d, f) => Xe(d, f), u), u.unstable_sxConfig = k({}, Gr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Kr({
      sx: f,
      theme: this
    });
...
const jd = Xr(), ti = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Tn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Ld(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: p = Bd(ti(u))
    } = l, v = ce(l, Id), g = d !== void 0 ? d : (
    ...
    const $ = Ps(s, k({
      shouldForwardProp: E,
      label: h
    }, v)), y = (b) => typeof b == "function" && b.__emotion_real !== b || pt(b) ? (S) => Cn(b, k({}, S, {
      theme: Tn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
...
const Gd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ot = tp, np = ["mode", "contrastThreshold", "tonalOffset"], oi = {
...
function cp(e) {
  ...
  function f(m) {
    const h = ri(m, pr.text.primary) >= n ? pr.text.primary : oi.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = ri(m, h);
...
} });` : Mt(12, h ? ` (${h})` : "", JSON.stringify(m.main)));
    return ii(m, "light", $, r), ii(m, "dark", y, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, v = {
    dark: pr,
    light: oi
  };
  return process.env.NODE_ENV !== "production" && (v[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), Xe(k({
...
function pp(e, t) {
  ...
  const v = o / 14, g = f || ((E) => `${E / u * v}rem`), m = (E, $, y, w, b) => k({
    fontFamily: r,
    fontWeight: E,
    fontSize: g($),
...
const Pp = Sp(), Jr = Pp, Zr = "$$material", ya = (e) => Pn(e) && e !== "classes", Cp = Ld({
  themeId: Zr,
  defaultTheme: Jr,
...
function gn() {
  const e = va(Jr);
  return process.env.NODE_ENV !== "production" && x.useDebugValue(e), e[Zr] || e;
}
function tt({
  props: e,
  name: t
...
const _p = {
...
}, fr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Qr = /* @__PURE__ */ x.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
    ...
    let O;
    m === "auto" ? (O = w.transitions.getAutoHeightDuration(L.clientHeight), y.current = O) : O = j, L.style.transition = [w.transitions.create("opacity", {
      duration: O,
      delay: Q
    ...
    let Z;
    m === "auto" ? (Z = w.transitions.getAutoHeightDuration(L.clientHeight), y.current = Z) : Z = R, L.style.transition = [w.transitions.create("opacity", {
      duration: Z,
      delay: j
    }), w.transitions.create("transform", {
  ...
  return /* @__PURE__ */ T(h, k({
    ...
    onExiting: B,
    addEndListener: (L) => {
      m === "auto" && $.start(y.current || 0, L), r && r(b.current, L);
    },
...
}, ui = Ip, Ap = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Dp = Ee(fa, {
  name: "MuiPopper",
  slot: "Root",
...
const Oa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, v, g, m, h, E, $, y, w, b;
  const S = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: D
  }), ve = gn(), Te = ve.direction === "rtl", [he, lt] = x.useState(), [ke, He] = x.useState(null), Ce = x.useRef(!1), We = _ || Z, ye = Jt(), yt = Jt(), ct = Jt(), Vt = Jt(), [bn, ro] = Hi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const oo = (ee) => {
    ...
    (ee) => {
      di.start(800 + M, () => {
        kn = !1;
      }), ro(!1), K && qe && K(ee), ye.start(ve.transitions.duration.shortest, () => {
        Ce.current = !1;
      });
    }
  ), er = (ee) => {
    ...
    onFocus: Ua,
    ref: Ha
  } = Wi(), [, so] = x.useState(!1), lo = (ee) => {
    za(ee), ao.current === !1 && (so(!1), io(ee));
  }, co = (ee) => {
    he || lt(ee.currentTarget), Ua(ee), ao.current === !0 && (so(!0), er(ee));
  }, uo = (ee) => {
    Ce.current = !0;
    const Re = re.props;
  ...
  B ? (Ut.title = !qe && nr && !q ? ne : null, Ut["aria-describedby"] = qe ? Qn : null) : (Ut["aria-label"] = nr ? ne : null, Ut["aria-labelledby"] = qe && !nr ? Qn : null);
...
`));
  ...
  const Ht = {};
  L || (_e.onTouchStart = Wa, _e.onTouchEnd = qa), q || (_e.onMouseOver = On(po, _e.onMouseOver), _e.onMouseLeave = On(fo, _e.onMouseLeave), We || (Ht.onMouseOver = po, Ht.onMouseLeave = fo)), z || (_e.onFocus = On(co, _e.onFocus), _e.onBlur = On(lo, _e.onBlur), We || (Ht.onFocus = co, Ht.onBlur = lo)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Xa = x.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Ce.current
  }), rr = Vp(Wt), ho = (r = (o = Y.popper) != null ? o : A.Popper) != null ? r : zp, mo = (i = (s = (l = Y.transition) != null ? l : A.Transition) != null ? s : N) != null ? i : Nr, go = (c = (u = Y.tooltip) != null ? u : A.Tooltip) != null ? c : Up, bo = (d = (f = Y.arrow) != null ? f : A.Arrow) != null ? d : Hp, Ya = Zt(ho, k({}, H, (p = X.popper) != null ? p : I.popper, {
    className: xe(rr.popper, H == null ? void 0 : H.className, (v = (g = X.popper) != null ? g : I.popper) == null ? void 0 : v.className)
  }), Wt), Ja = Zt(mo, k({}, J, (m = X.transition) != null ? m : I.transition), Wt), Za = Zt(go, k({}, (h = X.tooltip) != null ? h : I.tooltip, {
    className: xe(rr.tooltip, (E = ($ = X.tooltip) != null ? $ : I.tooltip) == null ? void 0 : E.className)
  }), Wt), Qa = Zt(bo, k({}, (y = X.arrow) != null ? y : I.arrow, {
    className: xe(rr.arrow, (w = (b = X.arrow) != null ? b : I.arrow) == null ? void 0 : w.className)
  }), Wt);
  return /* @__PURE__ */ de(x.Fragment, {
...
}), to = /* @__PURE__ */ x.forwardRef(function(t, n) {
  const r = tt({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, v = ce(r, Kp), g = /* @__PURE__ */ x.isValidElement(o) && o.type === "svg", m = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
var Ca = eo.default = void 0, nf = tf(ef()), rf = es;
Ca = eo.default = (0, nf.default)(/* @__PURE__ */ (0, rf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function hi(e, t, n) {
...
function Ra(e) {
  const {
    ...
    gs,
    {
      ...
      onClick: t,
      id: m,
      children: n ? /* @__PURE__ */ de($r, { children: [
        hi(i, n, !0),
        /* @__PURE__ */ T(bs, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ T(Ei, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ T(Ca, {}) }) : hi(s, n, !1)
      ] }) : h
    }
  );
...
const Ia = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  } = t, p = ce(t, gf), v = x.useRef(null), g = x.useRef({
    keys: [],
    repeating: !0,
  ...
  const m = (y) => {
    const w = v.current, b = y.key, S = we(w).activeElement;
    if (b === "ArrowDown")
      y.preventDefault(), Yt(w, S, u, c, mr);
    else if (b === "ArrowUp")
      y.preventDefault(), Yt(w, S, u, c, mi);
    else if (b === "Home")
      y.preventDefault(), Yt(w, null, u, c, mr);
    else if (b === "End")
      ...
      P.previousKeyMatched && (I || Yt(w, S, !1, c, mr, P)) ? y.preventDefault() : P.previousKeyMatched = !1;
    }
    d && d(y);
  }, h = De(v, n);
  let E = -1;
...
const bf = Ia, vf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], yf = {
  ...
  const r = gn(), o = {
    ...
    _.style.webkitTransition = r.transitions.create("opacity", L), _.style.transition = r.transitions.create("opacity", L), v && v(_);
  }), z = S(g);
  return /* @__PURE__ */ T($, k({
    appear: s,
    in: u,
...
const Ef = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Tf = (e) => {
  ...
  const s = tt({
    ...
    component: u,
    invisible: p
  }), w = Tf(y), b = (r = g.root) != null ? r : f.root;
  return /* @__PURE__ */ T(h, k({
    in: v,
    timeout: E
  }, $, {
...
const Pf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Cf = (e) => {
  ...
  return !I && !z && (!K || V) ? null : /* @__PURE__ */ T(an, {
    ...
    children: /* @__PURE__ */ de(G, k({}, ne, {
      children: [!A && d ? /* @__PURE__ */ T(H, k({}, N)) : null, /* @__PURE__ */ T(_n, {
        disableEnforceFocus: w,
        disableAutoFocus: y,
        disableRestoreFocus: P,
        isEnabled: M,
...
`));
    ...
    vertical: gi(J, b.vertical),
    horizontal: bi(J, b.horizontal)
    ...
    const lt = Te + C.height, ke = he + C.width, He = _t(Rn(c)), Ce = He.innerHeight - h, We = He.innerWidth - h;
    if (h !== null && Te < h) {
      const ye = Te - h;
      Te -= ye, re.vertical += ye;
    } else if (h !== null && lt > Ce) {
      const ye = lt - Ce;
      Te -= ye, re.vertical += ye;
    }
...
`)), h !== null && he < h) {
  ...
  }, [c, f, j, Q, h]), [O, M] = x.useState(E), V = x.useCallback(() => {
    const J = q.current;
    if (!J)
      return;
    const C = Z(J);
  ...
  const W = g || (c ? we(Rn(c)).body : void 0), G = (o = y == null ? void 0 : y.root) != null ? o : zf, H = (i = y == null ? void 0 : y.paper) != null ? i : La, X = gt({
    elementType: H,
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || _ === -1) && (_ = O));
  ...
  const L = (r = $.paper) != null ? r : Jf, R = (o = y.paper) != null ? o : v, j = gt({
    elementType: $.root,
...
function Sh({
  ...
  return /* @__PURE__ */ T("div", { ref: f, style: { position: "relative" }, children: /* @__PURE__ */ T(ks, { position: "static", id: r, children: /* @__PURE__ */ de(Os, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    m ? /* @__PURE__ */ T(
      ki,
      {
        edge: "start",
