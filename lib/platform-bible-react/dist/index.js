...
import Yt, { useRef as B, useMemo as A, createContext as ua, useContext as bo, useState as _, useEffect as W, useCallback as L, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Uo, Suspense as pc, forwardRef as Fn, useId as Ko, Fragment as pa } from "react";
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (be(f)) {
                ...
                if (Ja(v) && d >= 0 && w >= 0 && (R = d, y = d + w, f.setTextNodeRange(v, R, v, y)), R === y && p === "" || (f.insertRawText(p), v = b.getNode()), Ja(v)) {
                  R = h, y = h + g;
...
function Xp({
  ...
  W(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let st = "custom";
      et === Za ? st = "generated" : et === Qa ? st = "hidden" : et && ($(et), U(et)), R(st), C(st), D(((P = x.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
  ...
  const Ft = L(
    ...
    (S, F) => {
      ...
      let x;
      S === "custom" ? x = F : S === "generated" ? x = Za : x = Qa, G.insert.note.caller !== x && (G.insert.note.caller = x, (et = h.current) == null || et.applyUpdate([G, { delete: 1 }]));
    },
    []
  ), kt = L(() => {
    var S;
...
function _h({
  ...
  ] }), gt = e ? J.filter((O) => e.includes(O.value)) : J, ft = b ?? Sa, mt = p ?? ft, Jt = h ?? ft, vt = () => {
                        ...
                        children: /* @__PURE__ */ a(
                          za,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(lt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ne(b ?? Sa, "id") }),
                              /* @__PURE__ */ a(lr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
...
const Zu = (t, e, r = {}) => {
  ...
  W(() => {
    r(!1), n(!1), c(() => t ? l(t) : void 0);
  }, [t, l]);
  const [d, w] = Zu(s, void 0), p = B(t);
  p.current = t;
  const h = L(() => {
    const g = p.current;
    g && (r(!1), n(!1), c(() => l(g)));
