...
import { c as v, g as Me, a as Ka, C as ze, A as pe, P as Pe, b as rr, B as Y, d as Ve, e as Le, f as je, h as Te, i as ji, k as Bi, j as Fi, E as Ui, l as qa, r as ye, m as Ki, n as wn, o as ta, p as ea, L as zt, R as Ga, q as Gr, D as Ea, s as Ta, t as Sa, u as za, T as un, v as Lr, w as jt, x as Ha, y as Bt, z as Ft, F as Ut, G as pn, H as Ya, I as Qe, J as Nr, K as Be, M as Fe, N as Ue, S as Cr, O as sr, Q as qi, U as Sr, V as er, W as $e, Z as ar, X as Oe, Y as cr, _ as Wa, $ as Xa, a0 as Hr, a1 as Ja, a2 as hn, a3 as Gi, a4 as Hi, a5 as Yi, a6 as Ra, a7 as gn, a8 as ra, a9 as fn, aa as Wi, ab as Xi, ac as Ji, ad as Zi, ae as mn, af as Qi, ag as la, ah as yo, ai as da, aj as ts, ak as es, al as rs, am as as, an as os, ao as zr, ap as Za, aq as ns, ar as is } from "./resizable-CoRZwNAR.js";
import { as as gg, at as fg, au as mg, av as vg, aw as bg, ax as xg, ay as yg, az as kg, aA as _g, aB as Ng, aC as Cg, aD as Eg, aE as Tg, aF as Sg, aG as zg, aH as Rg, aI as Dg, aJ as Mg, aK as Og, aL as $g, aM as Ig, aN as Ag, aO as Pg, aP as Vg, aQ as Lg } from "./resizable-CoRZwNAR.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Ie, Clock as ko, ChevronsLeft as _o, ChevronsRight as No, ChevronLeft as Da, ChevronRight as Ma, ArrowLeft as ss, ArrowRight as cs, ChevronDown as wr, BoldIcon as ls, ItalicIcon as ds, X as Qa, AtSign as vn, Pencil as ws, Trash2 as us, ArrowUp as bn, MoreHorizontal as ps, MailOpen as hs, Mail as gs, ChevronUp as fs, FilterIcon as ms, ArrowLeftIcon as vs, ChevronLeftIcon as bs, ChevronRightIcon as xs, ArrowRightIcon as ys, Copy as xn, Filter as ks, User as _s, Link as Ns, CircleHelp as Cs, Undo as Es, Redo as Ts, SquareX as yn, FunctionSquare as kn, SquareSigma as _n, Ban as Ss, AlertCircle as Oa, CircleCheckIcon as zs, CircleXIcon as Rs, CircleHelpIcon as Ds, ArrowUpIcon as Ms, ArrowDownIcon as Os, ScrollText as $s, ChevronsUpDown as Is, MenuIcon as As, Menu as Ps, EllipsisVertical as Vs, MoreVertical as Ls } from "lucide-react";
import { Section as ut, getChaptersForBook as js, formatScrRef as Ce, getSectionForBook as yr, formatRelativeDate as Bs, formatReplacementString as tr, sanitizeHtml as to, NumberFormat as Nn, formatBytes as Fs, getCurrentLocale as Us, usfmMarkers as jr, getFormatCallerFunction as Ks, deepEqual as qs, isString as Co, compareScrRefs as $a, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Gs, getLocalizeKeyForScrollGroupId as Eo, formatReplacementStringToArray as To, collectUsjMarkers as Hs } from "platform-bible-utils";
import Jt, { useRef as K, useMemo as I, useState as N, useCallback as L, useEffect as G, useImperativeHandle as Ys, useLayoutEffect as ne, createContext as eo, useContext as Cn, Component as Ws, createElement as So, Suspense as Xs, forwardRef as En, useId as zo, Fragment as aa } from "react";
...
import { createEditor as zn, $getRoot as Ae, $createParagraphNode as Rr, $getSelection as ee, HISTORY_MERGE_TAG as ro, ParagraphNode as Rn, TextNode as Dn, $getPreviousSelection as sc, $isRangeSelection as be, $caretFromPoint as cc, $getSiblingCaret as Mn, $getChildCaret as lc, $getAdjacentChildCaret as dc, $isChildCaret as wc, $normalizeCaret as uc, $setSelectionFromCaretRange as pc, $getCollapsedCaretRange as hc, $getCaretInDirection as Ro, $splitAtPointCaretNext as gc, $isTextPointCaret as fc, $findMatchingParent as On, $isElementNode as Er, mergeRegister as Se, getDOMTextNode as mc, isHTMLElement as vc, CLEAR_EDITOR_COMMAND as $n, COMMAND_PRIORITY_EDITOR as ao, shallowMergeConfig as bc, defineExtension as se, safeCast as or, createState as xc, FORMAT_TEXT_COMMAND as In, $isNodeSelection as An, COMMAND_PRIORITY_LOW as Pn, RootNode as yc, LineBreakNode as kc, TabNode as _c, $isEditorState as Nc, createCommand as Cc, CLICK_COMMAND as Ec, isDOMNode as Tc, $getNodeFromDOMNode as Sc, $createNodeSelection as zc, $setSelection as Rc, $getEditor as Dc, DecoratorNode as Ia, $getState as Mc, toggleTextFormatType as Do, TEXT_TYPE_TO_FORMAT as Oc, $setState as $c, addClassNamesToElement as Vn, $create as Ic, $getNodeByKey as Ac, removeClassNamesFromElement as Pc, KEY_TAB_COMMAND as Vc, $isBlockElementNode as Lc, $createRangeSelection as jc, $normalizeSelection__EXPERIMENTAL as Bc, OUTDENT_CONTENT_COMMAND as Fc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Uc, COMMAND_PRIORITY_CRITICAL as oo, $isDecoratorNode as Kc, $isParagraphNode as qc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Ln, $insertNodes as Gc } from "lexical";
...
import { Avatar as no, Select as Zt, Checkbox as Oo, Slot as Dr, Tabs as he, Menubar as ke, ContextMenu as At, Progress as $o, Slider as Or, Switch as Io } from "radix-ui";
import { useReactTable as Bn, getFilteredRowModel as el, getSortedRowModel as Fn, getPaginationRowModel as rl, getCoreRowModel as Un, flexRender as kr, getGroupedRowModel as al, getExpandedRowModel as ol } from "@tanstack/react-table";
import nl from "markdown-to-jsx";
import { filterAndRankItems as Ao, GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as Va, getDefaultViewOptions as il, isInsertEmbedOpOfType as $r, getMarkerMenuItems as sl, defaultStyleInfo as cl, Editorial as ll } from "@eten-tech-foundation/platform-editor";
...
function ha({
  ...
  const F = ye(), [D, $] = N(!1), [P, S] = N(""), [V, W] = N(""), [_, rt] = N("books"), [U, Z] = N(void 0), [M, O] = N(
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((it) => {
      y[it] = Gt[it].filter((Lt) => qa(Lt, V, n));
    }), y;
  }, [Gt, V, n]), R = I(
    () => vl(V, yt, n),
    [V, yt, n]
  ...
  const { otLong: oe, ntLong: Qt, dcLong: ge, extraLong: C } = {
    ...
    () => fl(V),
    [V]
  ), at = I(() => !d || !R || !R.chapterNum || !B ? !1 : d(R.book, R.chapterNum) > 0, [d, R, B]), dt = L(
    (y) => w ? Po(y, w) : !1,
    [w]
  ), ht = L(
    (y) => (X) => w ? ml(y, X, w) : !1,
                  ...
                  !R && Object.entries(Vt).map(([y, X]) => {
                    if (X.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Te, { heading: j(y), children: X.map((it) => /* @__PURE__ */ a(
                          Kn,
                          {
                            bookId: it,
                            onSelect: (Lt) => qe(Lt),
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, kl = Yn ? ne : G, Ar = { tag: ro };
...
let Wr, Ee = 0, Xr = 0, Gl = 0, ja = 0, Fr = 0;
function Ko(t) {
  if (ct === void 0) return;
  let e = t.n;
...
function Yl(t) {
  ...
  Jn(this), ct = t, this.f &= -2, 8 & this.f && co(this), ia();
}
function ir(t, e) {
...
const lo = 0, Fa = 1, oi = 2, va = 3, Pr = 4, nr = 5, ba = 6, br = 7;
function xa(t) {
  return t.id === lo;
}
function ni(t) {
...
function Jl(t) {
  return function(e) {
    return e.id === Fa;
  }(t) || wt(305, String(t.id), String(Fa)), Object.assign(t, { id: oi });
}
...
class dr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      xa(i) || wt(300, s, n || "[unknown]"), xa(c = i) || wt(304, String(c.id), String(lo)), i = Object.assign(c, { id: Fa }), o.state = i;
  ...
  return Se(t.registerCommand(Vc, (o) => {
    ...
    const i = function(s) {
      ...
      if (p.canIndent()) {
        const h = p.getKey();
        let g = jc();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = Bc(g), g.anchor.is(d)) return !0;
      }
      return !1;
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (be(f)) {
                ...
                if (Aa(m) && d >= 0 && w >= 0 && (E = d, T = d + w, f.setTextNodeRange(m, E, m, T)), E === T && p === "" || (f.insertRawText(p), m = x.getNode()), Aa(m)) {
                  E = h, T = h + g;
...
const Id = "verseText", cp = Object.freeze([
...
function tn({
  ...
  const g = L(
    ...
    [t.user]
  ), T = I(() => to(t.contents), [t.contents]), k = I(
...
function xi({
  ...
  const j = L(
    ...
    async (b) => {
      const Q = ie(_) ? Zr(_) : void 0, B = b.status ? b.assignedUser : U ?? b.assignedUser, at = await p({
        ...b,
        contents: Q,
        assignedUser: B
      });
      return at && (B !== void 0 && O(B), Q && le()), at;
    },
    [le, _, p, U]
  );
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            ...
            m !== !1 && (!Ot || ie(_)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (b) => {
                  ho(b) && (b.preventDefault(), b.stopPropagation(), (ie(_) || U !== void 0 && U !== M) && j());
                },
                onKeyDown: (b) => {
...
), Ud = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Kr = (t) => Ud(to(t));
function qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      !w && !h && /* @__PURE__ */ u(lt, { children: [
        ...
        /* @__PURE__ */ a(
          Ga,
          {
            ...
            children: D.map((M) => U(M) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Bt, { children: [
...
function ew({
  ...
  var D;
  const [w, p] = N([]), [h, g] = N([]), [f, x] = N({}), [m, E] = N({}), T = I(() => e ?? [], [e]), k = Bn({
    data: T,
    columns: t,
    getCoreRowModel: Un(),
  ...
  return l ? F = Array.from({ length: 10 }).map((S, V) => `skeleton-row-${V}`).map((S) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: z.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((D = k.getRowModel().rows) == null ? void 0 : D.length) > 0 ? F = k.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Wa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Xa, { stickyHeader: i, children: k.getHeaderGroups().map(($) => /* @__PURE__ */ a(Oe, { children: $.headers.map((P) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : kr(P.column.columnDef.header, P.getContext()) }, P.id)) }, $.id)) }),
...
function Sp({
  ...
  const yt = L(() => {
    var q, b, Q;
    const C = (q = h.current) == null ? void 0 : q.querySelector(".editor-input"), j = C == null ? void 0 : C.querySelector("span.note"), tt = (Q = (b = h.current) == null ? void 0 : b.ownerDocument.getSelection()) == null ? void 0 : Q.anchorNode;
    return !!j && !!tt && j.contains(tt);
  }, []);
  G(() => {
    var b, Q;
    let C, j, tt;
    ...
    if (q && $r("note", q)) {
      const B = (b = q.insert.note) == null ? void 0 : b.caller;
      let at = "custom";
      B === Pa ? at = "generated" : B === Va ? at = "hidden" : B && (z(B), D(B)), m(at), T(at), P(((Q = q.insert.note) == null ? void 0 : Q.style) ?? "f"), C = setTimeout(() => {
        var dt, ht, ft;
        (dt = p.current) == null || dt.applyUpdate([q]), (ht = p.current) == null || ht.selectNote(0), (ft = p.current) == null || ft.focus(), j = requestAnimationFrame(() => {
          tt = setTimeout(() => {
            var Nt, $t;
    ...
    return () => {
      C && clearTimeout(C), j !== void 0 && cancelAnimationFrame(j), tt !== void 0 && clearTimeout(tt);
    };
  }, [e, i, yt]);
  const Vt = L(
    (C, j, tt = !1) => {
      ...
      if (q && $r("note", q)) {
        if (q.insert.note) {
          let at;
          C === "custom" ? at = j : C === "generated" ? at = Pa : at = Va, q.insert.note.caller = at;
        }
        r == null || r([q]), tt && d && i && ((B = d.current) == null || B.replaceEmbedUpdate(i, [q]));
      }
    },
    [i, r, d]
  ), R = L(() => {
  ...
  const re = () => {
    var j;
    const C = (j = h.current) == null ? void 0 : j.getElementsByClassName("editor-input")[0];
    ...
    var tt, q, b, Q, B;
    P(C);
    const j = (q = (tt = p.current) == null ? void 0 : tt.getNoteOps(0)) == null ? void 0 : q.at(0);
    if (j && $r("note", j)) {
      j.insert.note && (j.insert.note.style = C);
      const at = (Q = (b = j.insert.note) == null ? void 0 : b.contents) == null ? void 0 : Q.ops;
      $ !== "x" && C === "x" ? at == null || at.forEach((dt) => Cw(dt)) : $ === "x" && C !== "x" && (at == null || at.forEach((dt) => Ew(dt))), (B = p.current) == null || B.applyUpdate([j, { delete: 1 }]);
    }
  }, Ge = (C) => {
    ...
    (C) => {
      ...
      if (j && $r("note", j)) {
        ...
        const at = (b = j.insert.note) == null ? void 0 : b.style, dt = (B = (Q = j.insert.note) == null ? void 0 : Q.contents) == null ? void 0 : B.ops;
        if (at || V(!1), V(
          ...
          Z.current = !0, M.current = JSON.stringify(j), _(!0);
          return;
        }
        _(JSON.stringify(j) === M.current), Vt(x, k);
      } else
        V(!1), _(!0);
    },
    [x, k, Vt]
    ...
    if (g.current && Gt.length && C && C.rangeCount > 0) {
      const j = C.getRangeAt(0).getBoundingClientRect(), tt = g.current.getBoundingClientRect();
      Pt(j.left - tt.left), Kt(j.top - tt.top), nt(j.height), J(!0);
    }
  }, [Gt, g]), Rt = K(() => {
  }), Dt = L(
    (C, j, tt) => {
      ...
      qt.current = {
        ...
        if (_a(qt, Q), B !== void 0) {
          ...
          const He = j.find((de) => de.marker === B);
        ...
        var B;
        _a(qt, Q), b || (B = p.current) == null || B.focus();
      });
    },
    [w]
  ), Ht = L(() => {
    ...
    if (!C) return !1;
    const j = sl(xt.styleInfo ?? cl, C);
    return j.length === 0 ? !1 : (Dt(C, j, { passive: !C.hasTextSelection }), !0);
    ...
    (C) => {
      ...
      dw(C, j, {
        ...
        commitItem: (q) => {
          var Q;
          const b = j.items.find((B) => B.marker === q);
  ...
  G(() => {
    ...
    if (((q = xt.view) == null ? void 0 : q.markerMode) === "editable") {
      const b = (B) => {
        var dt, ht, ft, Nt;
        if (yi(B) || !C || document.activeElement !== C) return;
        if (qt.current && w) {
          Rt.current(B);
          return;
        }
        if (B.key === "Enter" && !yt()) {
          B.preventDefault(), B.stopPropagation(), (dt = p.current) == null || dt.selectNote(0), (ht = p.current) == null || ht.focus();
          return;
        }
        if (w && B.key === c) {
          if (!yt()) {
            B.preventDefault(), B.stopPropagation(), (ft = p.current) == null || ft.selectNote(0), (Nt = p.current) == null || Nt.focus();
            return;
          }
          Ht() && (B.preventDefault(), B.stopPropagation());
        }
      }, Q = () => {
        var B, at;
        !C || document.activeElement !== C || yt() || ((B = p.current) == null || B.selectNote(0), (at = p.current) == null || at.focus());
      };
    ...
    var tt;
    const C = ((tt = h.current) == null ? void 0 : tt.querySelector(".editor-input")) ?? void 0, j = () => {
      var q, b;
      !C || document.activeElement !== C || yt() || ((q = p.current) == null || q.selectNote(0), (b = p.current) == null || b.focus());
    };
    return document.addEventListener("pointerup", j), document.addEventListener("selectionchange", j), () => {
      document.removeEventListener("pointerup", j), document.removeEventListener("selectionchange", j);
    };
  }, [yt]);
...
function Mw({
  ...
  return /* @__PURE__ */ u(Wa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Xa, { stickyHeader: !0, children: /* @__PURE__ */ u(Oe, { children: [
...
function Qp({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Wa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Xa, { children: E.getHeaderGroups().map((S) => /* @__PURE__ */ a(Oe, { children: S.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(Ja, { children: E.getRowModel().rows.map((S, V) => {
        const W = ye();
        return /* @__PURE__ */ a(
          Oe,
          {
                    ...
                    children: _.getIsGrouped() ? /* @__PURE__ */ u(
                      Y,
                      {
                        ...
                        children: [
                          ...
                          !S.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
...
function eh({
  ...
  ), Ht = nt.find((A) => A.value === "selectedBooks"), oe = nt.find((A) => A.value === "range"), [Qt, ge] = N(!1), [C, j] = N(void 0), [tt, q] = N(void 0), [b, Q] = N(void 0), [B, at] = N(void 0), [dt, ht] = N([]), ft = d === "dropdown" && C === "selectedBooks", Nt = /* @__PURE__ */ a(
    ou,
    {
      availableBookInfo: o,
  ...
  const mo = L(
    (A) => {
      q(A), Q(st), at(gt), ht(n), ge(!1), j(A);
    },
    [st, gt, n]
  ), vo = L(() => {
    tt !== void 0 && (tt === "range" ? (b && (h == null || h(b)), B && (g == null || g(B))) : tt === "selectedBooks" && i(dt), Et(tt), j(void 0), q(void 0));
  }, [
    tt,
    b,
    B,
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      d === "dropdown" ? /* @__PURE__ */ u(Be, { open: Qt, onOpenChange: ge, children: [
    ...
    d === "dropdown" && oe && /* @__PURE__ */ a(Ea, { open: C === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ta,
      {
        ...
        children: /* @__PURE__ */ u(la, { container: Mt, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: Z }) }),
          Lt,
          /* @__PURE__ */ u(yo, { children: [
            /* @__PURE__ */ a(Y, { variant: "outline", onClick: () => Mr(!1), children: ot }),
...
function Ua({
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ue, { align: "start", style: { zIndex: ar }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(jt, { children: zi(e.groups, e.items, l, t) }) }),
