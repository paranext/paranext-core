...
var Lt = (t, e, r) => Ai(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Se, a as Ba, C as Ce, A as ie, P as Me, b as We, B as U, d as $e, e as Ie, f as Ae, h as xe, i as Vi, k as Pi, j as ji, E as Li, l as Fa, r as pe, m as Bi, n as dn, o as Qr, p as ta, L as Nt, R as Ua, q as qr, D as _a, s as Na, t as Ca, u as Ea, T as wn, v as Pr, w as Ut, x as Ka, y as Kt, z as qt, F as Gt, G as un, H as qa, I as qe, J as kr, K as ye, M as ke, N as _e, S as _r, O as er, Q as Fi, U as Er, V as He, W as De, Z as Xe, X as Re, Y as rr, _ as Ga, $ as Ha, a0 as Gr, a1 as Ya, a2 as pn, a3 as Ui, a4 as Ki, a5 as qi, a6 as Ta, a7 as hn, a8 as ea, a9 as gn, aa as Gi, ab as Hi, ac as Yi, ad as Wi, ae as fn, af as Xi, ag as ia, ah as xo, ai as sa, aj as Ji, ak as Zi, al as Qi, am as ts, an as es, ao as Tr, ap as Wa, aq as rs, ar as as } from "./resizable-C2eEiE_z.js";
...
import { Check as Ye, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as za, ChevronRight as Sa, ArrowLeft as os, ArrowRight as ns, ChevronDown as nr, BoldIcon as is, ItalicIcon as ss, X as Xa, AtSign as mn, Pencil as cs, Trash2 as ls, ArrowUp as vn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as bn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as xn, FunctionSquare as yn, SquareSigma as kn, Minus as Cs, Ban as Es, AlertCircle as Ra, CircleCheckIcon as Ts, CircleXIcon as zs, CircleHelpIcon as Ss, ArrowUpIcon as Rs, ArrowDownIcon as Ds, ScrollText as Os, ChevronsUpDown as Ms, MenuIcon as $s, Menu as Is, EllipsisVertical as As, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Vs, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ps, formatReplacementString as Ge, sanitizeHtml as Ja, NumberFormat as js, formatBytes as Ls, getCurrentLocale as Bs, usfmMarkers as jr, getFormatCallerFunction as Fs, deepEqual as Us, isString as Co, compareScrRefs as Da, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as Eo, formatReplacementStringToArray as To, collectUsjMarkers as qs } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as O, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Gs, useLayoutEffect as Qt, createContext as Za, useContext as _n, Component as Hs, createElement as zo, Suspense as Ys, forwardRef as Nn, useId as So, Fragment as Qa } from "react";
import { IconSelector as Cn, IconCheck as ra, IconChevronDown as Ws, IconChevronUp as Xs, IconLayoutSidebar as Js, IconLayoutSidebarRight as Zs, IconChevronRight as En, IconSearch as Qs, IconLoader as tc, IconAlertOctagon as ec, IconAlertTriangle as rc, IconInfoCircle as ac, IconCircleCheck as oc } from "@tabler/icons-react";
import { createEditor as Tn, $getRoot as Oe, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as zn, TextNode as Sn, $getPreviousSelection as nc, $isRangeSelection as we, $caretFromPoint as ic, $getSiblingCaret as Rn, $getChildCaret as sc, $getAdjacentChildCaret as cc, $isChildCaret as lc, $normalizeCaret as dc, $setSelectionFromCaretRange as wc, $getCollapsedCaretRange as uc, $getCaretInDirection as Ro, $splitAtPointCaretNext as pc, $isTextPointCaret as hc, $findMatchingParent as Dn, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as gc, isHTMLElement as fc, CLEAR_EDITOR_COMMAND as On, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as mc, defineExtension as re, safeCast as Je, createState as vc, FORMAT_TEXT_COMMAND as Mn, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as In, RootNode as bc, LineBreakNode as xc, TabNode as yc, $isEditorState as kc, createCommand as _c, CLICK_COMMAND as Nc, isDOMNode as Cc, $getNodeFromDOMNode as Ec, $createNodeSelection as Tc, $setSelection as zc, $getEditor as Sc, DecoratorNode as Oa, $getState as Rc, toggleTextFormatType as Do, TEXT_TYPE_TO_FORMAT as Dc, $setState as Oc, addClassNamesToElement as An, $create as Mc, $getNodeByKey as $c, removeClassNamesFromElement as Ic, KEY_TAB_COMMAND as Ac, $isBlockElementNode as Vc, $createRangeSelection as Pc, $normalizeSelection__EXPERIMENTAL as jc, OUTDENT_CONTENT_COMMAND as Lc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Bc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Fc, $isParagraphNode as Uc, $isTextNode as Ma, SELECTION_CHANGE_COMMAND as Vn, $insertNodes as Kc } from "lexical";
...
import { Avatar as ao, Select as Ft, Checkbox as Mo, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as $o, Slider as Or, Switch as Io } from "radix-ui";
import { useReactTable as jn, getFilteredRowModel as Qc, getSortedRowModel as Ln, getPaginationRowModel as tl, getCoreRowModel as Bn, flexRender as xr, getGroupedRowModel as el, getExpandedRowModel as rl } from "@tanstack/react-table";
import al from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as $a, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as ol, isInsertEmbedOpOfType as Mr, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
function ll({
  ...
  return /* @__PURE__ */ u(Me, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a($e, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Ce,
      {
        onSelect: () => g(h),
...
function wa({
  ...
  const B = pe(), [z, I] = _(!1), [A, C] = _(""), [V, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
  ...
  const Ct = L(() => {
    ...
    I(b), b && (J("books"), Y(void 0), $(void 0), Z(void 0), K(""));
  }, []);
  H(() => {
    D && it(!1);
  }, [D, it]);
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vl = Gn ? Qt : H, Ir = { tag: to };
function bl({ initialConfig: t, children: e }) {
  const r = O(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = ml(null, o), w = Tn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Rl = Hn && "documentMode" in document ? document.documentMode : null;
!(!Hn || !("InputEvent" in window) || Rl) && "getTargetRanges" in new window.InputEvent("input");
function de(t) {
  return `${t}px`;
}
...
function Vl(t) {
  ...
  if (we(e)) r = ic(e.focus, "next");
    ...
    r = r || sc(Oe(), "previous").getFlipped().insert(zr());
  }
...
function Pl(t, e, r) {
  ...
  return hc(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), Ro(Rn(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = Xt();
  if (!we(e)) return !1;
...
let Yr, be = 0, Wr = 0, Fl = 0, Va = 0, Br = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
const ha = vc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends Oa {
  $config() {
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Mn, (o) => {
  const n = Xt();
  if ($n(n) || we(n)) for (const i of n.getNodes()) Gl(i) && i.toggleFormat(o);
  return !1;
}, In) });
function ti(t, e) {
  let r;
...
const co = 0, ja = 1, ri = 2, ga = 3, Ar = 4, Qe = 5, fa = 6, mr = 7;
function ma(t) {
  return t.id === co;
}
function ai(t) {
...
}, name: "@lexical/extension/InitialState", nodes: [bc, Sn, xc, yc, zn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function Zl(t) {
  throw t;
...
class or {
  ...
  static maybeFromEditor(e) {
    const r = e[Go];
    return r && (r.PACKAGE_VERSION !== va && lt(292, r.PACKAGE_VERSION, va), r instanceof or || lt(293)), r;
  }
  static fromEditor(e) {
...
const Ql = /* @__PURE__ */ new Set(), Yo = re({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = Ul(() => (i.value || Ql).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const w = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), w || (d.set(s, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [Pa], name: "@lexical/extension/NodeSelection" }), td = _c("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends Oa {
  static getType() {
  ...
  return Ne(t.registerCommand(td, (s) => {
    ...
    if (Cc(s.target)) {
      ...
      if (rd(c)) return function(d, l = !1) {
        ...
        let h;
        l && $n(w) ? h = w : (h = Tc(), zc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  ...
  return Ne(t.registerCommand(Ac, (o) => {
    ...
    const i = function(s) {
      ...
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Pc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = jc(h), h.anchor.is(l)) return !0;
      }
      return !1;
...
function fd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: g, autoCapitalize: h, className: f, id: x, role: v = "textbox", spellCheck: E = !0, style: k, tabIndex: N, "data-testid": D, ...B }, z) {
  ...
  return si(() => (A(t.isEditable()), t.registerEditableListener((K) => {
    A(K);
...
function Nd({
  ...
  const [e] = ge(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = _d(), d = () => {
  };
...
function Zu({
  ...
  const [i, s] = _(Od), [c, d] = _(n), [l, w] = _(!1), p = F(void 0), g = F(null);
  H(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
    ...
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (z) => {
              z.stopPropagation(), l(!0), p(Rd(t.contents)), s == null || s(!0);
            },
            children: [
...
), jd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => jd(Ja(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function qd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Kd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(qd, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(vi, { ...W })
          },
          $.id
        );
      })
...
function Jd({
  ...
  return d ? B = Array.from({ length: 10 }).map((C, V) => `skeleton-row-${V}`).map((C) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: D.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    I.id
  )) : B = /* @__PURE__ */ a(Re, { children: /* @__PURE__ */ a(rr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function uw({ state: t }) {
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        t === "all" && /* @__PURE__ */ a(Ye, { size: 16 }),
        t === "partial" && /* @__PURE__ */ a(Cs, { size: 16 }),
...
function mp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [D, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Vt, q] = _(), [tt, wt] = _(), at = F(null), mt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === $a ? st = "generated" : it === Ia ? st = "hidden" : it && (N(it), B(it)), x(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var ht;
  ...
  const ut = L(
    (P, Q, et = !1) => {
      ...
      if (ot && Mr("note", ot)) {
        if (ot.insert.note) {
          let pt;
          P === "custom" ? pt = Q : P === "generated" ? pt = $a : pt = Ia, ot.insert.note.caller = pt;
        }
  ...
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: vw(t.marker, c, o, l) })
      }
    )
  ] });
}
...
function Tp({
  ...
  }, [I, Y]), $ = O(() => T.length === 0 ? [] : Ew(T, C, K), [T, C, K]), W = O(() => {
    var wt, at;
    if (!I) return d;
...
const zw = "16rem", Sw = "3rem", yi = Wt.createContext(void 0);
function na() {
    ...
    Dw,
    {
      ...
      children: /* @__PURE__ */ u(Mw, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a($w, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Iw, { children: /* @__PURE__ */ a(
            Vw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const ze = "scrBook", jw = "scrRef", Ke = "source", Lw = "details", Bw = "Scripture Reference", Fw = "Scripture Book", ki = "Type", Uw = "Details";
function Kw(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: D.map((C) => /* @__PURE__ */ a(ne, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function Kp({
  ...
  ), ht = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [gt, Mt] = _(!1), [zt, Ht] = _(void 0), [$t, Pe] = _(void 0), [S, It] = _(void 0), [xt, oe] = _(void 0), [je, ur] = _([]), pr = l === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Yw,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", Le = l === "dropdown" && zt === "range", b = Le ? It : P, rt = Le ? oe : h ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const fo = L(
    (M) => {
      Pe(M), It(at), oe(mt), ur(n), Mt(!1), Ht(M);
    },
    [at, mt, n]
  ), mo = L(() => {
...
function La({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Qa, { children: [
...
function Jp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(zi, { children: [
      /* @__PURE__ */ a(Si, { children: t.map((c) => /* @__PURE__ */ a(Jw, { value: c.value, children: c.value }, c.key)) }),
...
function rh({
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(rs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(as, { children: /* @__PURE__ */ a(Qs, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { children: [
