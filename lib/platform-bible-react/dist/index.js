...
import { Avatar as ko, Select as Xt, Checkbox as Go, Slot as Or, Tabs as we, Menubar as ke, ContextMenu as $t, Progress as Wo, Slider as Br, Switch as Yo } from "radix-ui";
...
function Ra({
  ...
  const U = ye(), V = zl(), D = T ?? V, [K, Y] = _(!1), [H, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [q, nt] = _(void 0), [at, pt] = _(
    void 0
...
function nd(t, e = od) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, R = g.getNode(), y = R.getKey(), C = g.offset, E = t.getElementByKey(b), $ = t.getElementByKey(y), T = r === null || E !== o || v !== n || b !== r.getKey(), U = i === null || $ !== s || C !== c || y !== i.getKey();
      if ((T || U) && E !== null && $ !== null) {
...
function ld(t, e, r) {
  ...
  return Oc(o) && aa(283), o.insert(t.isInline() ? Mr().append(t) : t), Ko(Gn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = ee();
  if (!be(e)) return !1;
...
function Pi({
  ...
  const Vt = A(() => kt[0], [kt]), ie = F(null), se = F(void 0), Ut = j(() => {
    var x;
    (x = se.current) == null || x.call(se), Q(fn);
  }, []), Ke = j(() => {
    const x = !vt;
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            ...
            v !== !1 && (!pt || oe(H)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  Do(x) && (x.preventDefault(), x.stopPropagation(), (oe(H) || I !== void 0 && I !== N) && S());
                },
                onKeyDown: (x) => {
...
function ww({
  ...
  const [s, c] = _("accept"), l = Uo(), d = Uo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = A(
    () => Qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Qr(t.acceptedText ?? ""),
...
function Vp({
  ...
  const D = r.filter(
    ...
    (z) => {
      C((q) => new Set(q).add(z.id)), $(z.id), b == null || b(z.id);
    },
    [b]
  ), H = j(
    (z) => {
    ...
    (z) => {
      ...
      }), $(void 0), b == null || b(void 0)), z.preventDefault(), z.stopPropagation()) : tt(z);
    },
    [E, y, tt, b]
  );
  return /* @__PURE__ */ a(
...
function kw({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, R] = _({}), y = A(() => e ?? [], [e]), C = ri({
    data: y,
    columns: t,
    getCoreRowModel: oi(),
...
function Wp({
  ...
  var pe;
  const h = F(null), g = F(null), f = F(null), b = F(null);
  te(() => {
    if (!b.current) return;
  ...
  const Tt = j(() => {
    var x, L, P;
    const S = (x = g.current) == null ? void 0 : x.querySelector(".editor-input"), B = S == null ? void 0 : S.querySelector("span.note"), G = (P = (L = g.current) == null ? void 0 : L.ownerDocument.getSelection()) == null ? void 0 : P.anchorNode;
  ...
  W(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let st = "custom";
      et === Ja ? st = "generated" : et === Za ? st = "hidden" : et && ($(et), U(et)), R(st), C(st), D(((P = x.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
  ...
  const Ft = j(
    ...
    (S, B) => {
      ...
      let x;
      S === "custom" ? x = B : S === "generated" ? x = Ja : x = Za, G.insert.note.caller !== x && (G.insert.note.caller = x, (et = h.current) == null || et.applyUpdate([G, { delete: 1 }]));
    },
    []
  ), kt = j(() => {
    var S;
...
function Xp({
  ...
  const p = d ?? sc(r, void 0), h = (E, $) => {
    w == null || w(E, $, n);
  }, g = i ? r.findIndex((E) => E === i) : -1, [f, b] = _(g), v = (E, $, T) => {
    if (r.length)
      switch (E.key) {
        case "Enter":
        case " ":
    ...
    if (r.length)
      switch (E.key) {
        case "ArrowDown":
          E.preventDefault(), b(($) => Math.min($ + 1, r.length - 1));
          break;
        case "ArrowUp":
          E.preventDefault(), b(($) => Math.max($ - 1, 0));
          break;
      }
  }, y = F([]);
  W(() => {
...
function oh({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), b = fe(r, "%webView_inventory_unapproved%"), v = fe(r, "%webView_inventory_unknown%"), R = fe(r, "%webView_inventory_scope_currentBook%"), y = fe(r, "%webView_inventory_scope_chapter%"), C = fe(r, "%webView_inventory_scope_verse%"), E = fe(r, "%webView_inventory_filter_text%"), $ = fe(
    r,
    "%webView_inventory_show_additional_items%"
...
function bh({
  ...
  W(() => {
    if (c) {
      ...
      if (K.length === 1) {
        const Y = b.find((H) => _n(H) === K[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, R]);
                    ...
                    children: H.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(qa, {}) : /* @__PURE__ */ a(Ha, {})),
                          " ",
...
function yh({
  ...
  ] }), gt = e ? J.filter((O) => e.includes(O.value)) : J, ft = b ?? Ta, mt = p ?? ft, Jt = h ?? ft, vt = () => {
  ...
  ), Lt = gt.find((O) => O.value === "selectedBooks"), Ht = gt.find((O) => O.value === "range"), [ue, pe] = _(!1), [S, B] = _(void 0), [G, x] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", jt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
...
qi.displayName = we.Content.displayName;
function Sh({
  tabList: t,
  searchValue: e,
  onSearch: r,
...
function zh({
  ...
  return /* @__PURE__ */ a(_o.Provider, { value: b, children: /* @__PURE__ */ a(
    "div",
    {
...
function Dh({
  ...
  const d = Bu(
    ...
    var R, y, C, E, $, T;
    const v = b !== f ? ((y = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : y[b]) ?? ((E = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
