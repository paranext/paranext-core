...
import Yt, { useRef as F, useMemo as A, createContext as ua, useContext as vo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Uo, Suspense as pc, forwardRef as Fn, useId as Ko, Fragment as pa } from "react";
...
function ld(t, e, r) {
  ...
  return Oc(o) && aa(283), o.insert(t.isInline() ? Mr().append(t) : t), Ho(Wn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = ee();
  if (!be(e)) return !1;
...
}, name: "@lexical/extension/InitialState", nodes: [Vc, Gn, Lc, jc, qn] }), ln = Symbol.for("@lexical/extension/LexicalBuilder");
function dn() {
}
function _d(t) {
  throw t;
  ...
  return Te(t.registerCommand(Cd, (s) => {
    ...
    if (Kc(s.target)) {
      ...
      if (Td(c)) return function(l, d = !1) {
        ...
        let g;
        d && Zn(w) ? g = w : (g = qc(), Gc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function Pi({
  ...
  const [H, Q] = _(mn), [I, tt] = _(), [N, z] = _(), q = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(E), [At, bt] = _(!1), Bt = F(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let b = !0;
    return (async () => {
