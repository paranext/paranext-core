...
import { includes as pn, Section as q, getChaptersForBook as wi, formatScrRef as xe, getSectionForBook as Ye, formatRelativeDate as pi, formatReplacementString as ve, sanitizeHtml as ui, NumberFormat as mi, formatBytes as fi, getCurrentLocale as hi, usfmMarkers as gn, getFormatCallerFunction as gi, deepEqual as bi, isString as to, compareScrRefs as tr, scrRefToBBBCCCVVV as Vn, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import { useReactTable as ta, getFilteredRowModel as sl, getSortedRowModel as ea, getPaginationRowModel as il, getCoreRowModel as na, flexRender as Xe, getGroupedRowModel as ll, getExpandedRowModel as cl } from "@tanstack/react-table";
...
const ln = 250, pa = 300, tn = 400, bl = 450, vl = 500, Kt = le.Root, ue = le.Trigger, Sr = le.Anchor, Mt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = wt();
...
function Bp({
  ...
  const c = wt(), [p, u] = T(!1), [h, m] = T(""), [g, x] = T(""), [v, y] = T("books"), [N, _] = T(void 0), [k, B] = T(!1), V = H(void 0), R = H(void 0), L = H(void 0), C = H(void 0), S = H({}), j = $(
    ...
    [q.OT]: z.filter((X) => dt.isBookOT(X)),
    [q.NT]: z.filter((X) => dt.isBookNT(X)),
    [q.DC]: z.filter((X) => dt.isBookDC(X)),
    [q.Extra]: z.filter((X) => dt.extraBooks().includes(X))
...
Dr.displayName = Qe.Root.displayName;
...
function lr({
  ...
  const [N, _] = T(!1), k = d ?? l, B = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], V = (R, L) => {
...
Xt({ dependencies: [wr, fo], name: "@lexical/extension/HorizontalRule", nodes: () => [Ie], register(t, e, n) {
  ...
  return de(t.registerCommand(Si, (i) => {
    ...
    return !1;
  }, Ho), t.registerMutationListener(Ie, (i, l) => {
    Ul(() => {
      let d = !1;
...
function Sc() {
  const { activeEditor: t } = Oa(), [e, n] = T([]), o = $((a) => {
    if (ke(a) || ol(a)) {
      const s = [];
      bo.forEach(({ format: i }) => {
          ...
          o && /* @__PURE__ */ w(et, { children: [
            ...
            v !== !1 && (!A || Pt(R)) && /* @__PURE__ */ w(
              "div",
              {
                ...
                onKeyDownCapture: (O) => {
                  Vr(O) && (O.preventDefault(), O.stopPropagation(), (Pt(R) || C !== void 0) && qr());
                },
                onKeyDown: (O) => {
...
function Yc({ table: t }) {
  return /* @__PURE__ */ w(me, { children: [
    /* @__PURE__ */ r(al, { asChild: !0, children: /* @__PURE__ */ w(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function sd({
  ...
  let B;
  return d ? B = Array.from({ length: 10 }).map((C, S) => `skeleton-row-${S}`).map((C) => /* @__PURE__ */ r(ee, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ur, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? B = _.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    ee,
    {
      onClick: () => i(R, _),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ w("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Oo, {}) })
        ] }),
...
function gd({
  ...
  return /* @__PURE__ */ w(me, { children: [
    /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ w(Lt, { children: [
      /* @__PURE__ */ r(Zi, { asChild: !0, children: /* @__PURE__ */ r(Te, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: fd(t, n) }) }) }),
...
function ru({
  ...
  const W = $(() => {
    ...
    if (D && un("note", D)) {
      ...
      v !== "x" && P === "x" ? ut == null || ut.forEach((yt) => Nd(yt)) : v === "x" && P !== "x" && (ut == null || ut.forEach((yt) => kd(yt))), (xt = c.current) == null || xt.applyUpdate([D, { delete: 1 }]);
    }
  }, It = (P) => {
    var U, Z, Q, lt, xt, ut;
...
function Bd({
  ...
  return /* @__PURE__ */ w(et, { children: [
    ...
    /* @__PURE__ */ r(_r, { children: /* @__PURE__ */ r(F, { onClick: e, children: t.okLabel ?? Qa }) })
  ] });
}
function Kd({
  options: t,
  ...
  return /* @__PURE__ */ w(et, { children: [
    ...
    /* @__PURE__ */ w(_r, { children: [
      /* @__PURE__ */ r(F, { variant: "outline", onClick: n, children: t.cancelLabel ?? Vd }),
      /* @__PURE__ */ r(F, { variant: t.destructive ? "destructive" : "default", onClick: e, children: t.okLabel ?? Qa })
    ] })
  ] });
}
function Gd(t) {
...
function gu({
  ...
  const p = $(
    ...
    Wt,
    {
      ...
      onKeyDown: p,
      children: [
        /* @__PURE__ */ r(Ee, { ref: c, placeholder: a }),
...
function Dw({
  ...
  const V = K(() => dt.allBookIds.filter(
    ...
    (A) => {
      const Y = Hr(V, A).map((M) => M);
      n(
        cs(V, A, e) ? e.filter((M) => !Y.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...Y])]
      );
    },
    [e, n, V]
  ), z = () => {
            ...
            Wt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: z, children: d }),
...
function gr({
  ...
  return /* @__PURE__ */ w(me, { variant: s, children: [
    /* @__PURE__ */ r(Te, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(oi, {}) }) }),
        ...
        /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ w(me, { children: [
              /* @__PURE__ */ r(Te, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Do, {}) }) }),
