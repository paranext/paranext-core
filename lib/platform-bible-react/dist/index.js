...
import { c as m, g as Se, a as Ka, C as Ce, A as ie, P as Me, b as Ye, B as U, d as $e, e as Ie, f as Ae, h as xe, i as ji, k as Bi, j as Fi, E as Ui, l as qa, r as se, m as Ki, n as un, o as ra, p as aa, L as Nt, R as Ga, q as Hr, D as Ea, s as Ta, t as za, u as Sa, T as pn, v as jr, w as Gt, x as Ha, y as Ht, z as Yt, F as Wt, G as hn, H as Ya, I as qe, J as kr, K as ye, M as ke, N as _e, S as _r, O as tr, Q as qi, U as Er, V as He, W as De, Z as We, X as Re, Y as er, _ as Wa, $ as Xa, a0 as Yr, a1 as Ja, a2 as gn, a3 as Gi, a4 as Hi, a5 as Yi, a6 as ko, a7 as fn, a8 as oa, a9 as mn, aa as Wi, ab as Xi, ac as Ji, ad as Zi, ae as vn, af as Qi, ag as la, ah as _o, ai as da, aj as ts, ak as es, al as rs, am as as, an as os, ao as Tr, ap as Za, aq as ns, ar as is, as as ss } from "./resizable-C_uryyUe.js";
...
import { Check as or, Clock as No, ChevronsLeft as Co, ChevronsRight as Eo, ChevronLeft as Ra, ChevronRight as Da, ArrowLeft as cs, ArrowRight as ls, ChevronDown as nr, BoldIcon as ds, ItalicIcon as ws, X as Qa, AtSign as bn, Pencil as us, Trash2 as ps, ArrowUp as xn, MoreHorizontal as hs, MailOpen as gs, Mail as fs, ChevronUp as ms, FilterIcon as vs, ArrowLeftIcon as bs, ChevronLeftIcon as xs, ChevronRightIcon as ys, ArrowRightIcon as ks, Copy as yn, Filter as _s, User as Ns, Link as Cs, CircleHelp as Es, Undo as Ts, Redo as zs, SquareX as kn, FunctionSquare as _n, SquareSigma as Nn, Ban as Ss, AlertCircle as Oa, CircleCheckIcon as Rs, CircleXIcon as Ds, CircleHelpIcon as Os, ArrowUpIcon as Ms, ArrowDownIcon as $s, ScrollText as Is, ChevronsUpDown as As, MenuIcon as Ps, Menu as Vs, EllipsisVertical as Ls, MoreVertical as To } from "lucide-react";
import { Section as dt, getChaptersForBook as js, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Bs, formatReplacementString as Ge, sanitizeHtml as to, NumberFormat as Fs, formatBytes as Us, getCurrentLocale as Ks, usfmMarkers as Br, getFormatCallerFunction as qs, deepEqual as Gs, isString as zo, compareScrRefs as Ma, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Hs, getLocalizeKeyForScrollGroupId as So, collectUsjMarkers as Ys } from "platform-bible-utils";
import qt, { useRef as F, useMemo as O, useState as _, useCallback as j, useEffect as q, useImperativeHandle as Ws, useLayoutEffect as Qt, createContext as eo, useContext as Cn, Component as Xs, createElement as Ro, Suspense as Js, forwardRef as En, useId as Wr, Fragment as Tn } from "react";
import { IconSelector as zn, IconCheck as na, IconChevronDown as Zs, IconChevronUp as Qs, IconLayoutSidebar as tc, IconLayoutSidebarRight as ec, IconChevronRight as Sn, IconSearch as rc, IconLoader as ac, IconAlertOctagon as oc, IconAlertTriangle as nc, IconInfoCircle as ic, IconCircleCheck as sc } from "@tabler/icons-react";
import { createEditor as Rn, $getRoot as Oe, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as ro, ParagraphNode as Dn, TextNode as On, $getPreviousSelection as cc, $isRangeSelection as ue, $caretFromPoint as lc, $getSiblingCaret as Mn, $getChildCaret as dc, $getAdjacentChildCaret as wc, $isChildCaret as uc, $normalizeCaret as pc, $setSelectionFromCaretRange as hc, $getCollapsedCaretRange as gc, $getCaretInDirection as Do, $splitAtPointCaretNext as fc, $isTextPointCaret as mc, $findMatchingParent as $n, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as vc, isHTMLElement as bc, CLEAR_EDITOR_COMMAND as In, COMMAND_PRIORITY_EDITOR as ao, shallowMergeConfig as xc, defineExtension as re, safeCast as Xe, createState as yc, FORMAT_TEXT_COMMAND as An, $isNodeSelection as Pn, COMMAND_PRIORITY_LOW as Vn, RootNode as kc, LineBreakNode as _c, TabNode as Nc, $isEditorState as Cc, createCommand as Ec, CLICK_COMMAND as Tc, isDOMNode as zc, $getNodeFromDOMNode as Sc, $createNodeSelection as Rc, $setSelection as Dc, $getEditor as Oc, DecoratorNode as $a, $getState as Mc, toggleTextFormatType as Oo, TEXT_TYPE_TO_FORMAT as $c, $setState as Ic, addClassNamesToElement as Ln, $create as Ac, $getNodeByKey as Pc, removeClassNamesFromElement as Vc, KEY_TAB_COMMAND as Lc, $isBlockElementNode as jc, $createRangeSelection as Bc, $normalizeSelection__EXPERIMENTAL as Fc, OUTDENT_CONTENT_COMMAND as Uc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Kc, COMMAND_PRIORITY_CRITICAL as oo, $isDecoratorNode as qc, $isParagraphNode as Gc, $isTextNode as Ia, SELECTION_CHANGE_COMMAND as jn, $insertNodes as Hc } from "lexical";
...
import { Avatar as no, Select as Ft, Checkbox as $o, Slot as Sr, Tabs as ce, Menubar as he, ContextMenu as Rt, Progress as Io, Slider as Or, Switch as Ao } from "radix-ui";
import { useReactTable as Fn, getFilteredRowModel as rl, getSortedRowModel as Un, getPaginationRowModel as al, getCoreRowModel as Kn, flexRender as xr, getGroupedRowModel as ol, getExpandedRowModel as nl } from "@tanstack/react-table";
import il from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Aa, HIDDEN_NOTE_CALLER as Pa, getDefaultViewOptions as sl, isInsertEmbedOpOfType as Mr, Editorial as cl } from "@eten-tech-foundation/platform-editor";
      ...
      if (s) {
        ...
        if (!w && d) {
          const h = ((f) => Object.keys(ie).find(
            (y) => ie[y].toLowerCase() === f.toLowerCase()
          ))(c);
...
function ha({
  ...
  const B = se(), [T, M] = _(!1), [I, E] = _(""), [A, K] = _(""), [b, X] = _("books"), [L, Y] = _(void 0), [z, P] = _(
    void 0
  ), [W, Z] = _(void 0), [Dt, Tt] = _(!1), Pt = F(null), G = F(!1), tt = F(void 0), wt = F(void 0), at = F(void 0), mt = F(void 0), ae = F({}), ut = F({}), bt = j(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Ot = O(() => o ? o() : Ki, [o]), Vt = O(() => ({
    [dt.OT]: Ot.filter((H) => vt.isBookOT(H)),
    [dt.NT]: Ot.filter((H) => vt.isBookNT(H)),
    [dt.DC]: Ot.filter((H) => vt.isBookDC(H)),
    [dt.Extra]: Ot.filter((H) => vt.extraBooks().includes(H))
  }), [Ot]), Jt = O(() => Object.values(Vt).flat(), [Vt]), fe = O(() => {
    if (!A.trim()) return Vt;
    const x = {
      [dt.OT]: [],
      [dt.NT]: [],
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      x[rt] = Vt[rt].filter((At) => qa(At, A, n));
    }), x;
  }, [Vt, A, n]), R = O(
    () => ml(A, Jt, n),
    [A, Jt, n]
  ...
  const Ct = j(() => {
    if (R) {
      const x = R.chapterNum ?? 1, H = R.verseNum ?? 1;
      if (w && pa(R.book, x, H, w))
        return;
      bt({
        book: R.book,
        chapterNum: x,
    ...
    (x) => {
      const H = z ?? (R == null ? void 0 : R.book), rt = W ?? (R == null ? void 0 : R.chapterNum);
      !H || !rt || (bt({
        book: H,
        chapterNum: rt,
        verseNum: x
    ...
    (x) => {
      const H = b === "chapters" ? L : R == null ? void 0 : R.book;
      if (H) {
        if (l && l(H, x) > 1) {
          P(H), Z(x), X("verses"), E("");
          return;
    ...
    X("books"), Y(void 0), P(void 0), Z(void 0), setTimeout(() => {
      wt.current && wt.current.focus();
    }, 0);
  }, []), ot = j(() => {
    const x = z;
    P(void 0), Z(void 0), x ? (Y(x), X("chapters"), E("")) : et();
  }, [z, et]), it = j((x) => {
    M(x), x && (X("books"), Y(void 0), P(void 0), Z(void 0), K(""));
  }, []);
  q(() => {
    D && it(!1);
  }, [D, it]);
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    () => gl(A),
    [A]
  ), oe = O(() => !l || !R || !R.chapterNum || !xt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, xt]), Le = j(
    (x) => w ? Po(x, w) : !1,
    [w]
  ), ur = j(
    (x) => (H) => w ? fl(x, H, w) : !1,
    ...
    (x) => {
      ...
      if ((b === "chapters" || b === "verses") && (x.key === " " || x.key === "Enter")) {
      ...
      if ((b === "chapters" || b === "verses") && (H || rt)) {
        x.preventDefault(), x.stopPropagation();
        return;
      }
      if (b === "chapters" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), et();
        return;
      }
      if (b === "verses" && x.key === "Backspace") {
      ...
      if (b === "verses" && At) {
        ...
        Lt !== ft && (x.preventDefault(), x.stopPropagation(), E(
          `${Et} ${ie[Et] || ""} ${kt}:${Lt}`
        ), setTimeout(() => {
      ...
      if ((b === "chapters" || b === "books" && R) && At) {
        const Et = b === "chapters" ? L : R == null ? void 0 : R.book;
        if (!Et) return;
        b === "chapters" && ((Be = tt.current) == null || Be.focus());
        const kt = (() => {
          if (!I) return 1;
          const le = I.match(/(\d+)$/);
        ...
        ft !== kt && (x.preventDefault(), x.stopPropagation(), E(
          `${Et} ${ie[Et] || ""} ${ft}`
        ), setTimeout(() => {
    ...
    const { isLetter: H, isDigit: rt } = Vo(x.key);
    (H || rt) && (x.preventDefault(), K((me) => me + x.key), wt.current.focus(), Tt(!1));
  }, []);
  return Qt(() => {
    const x = setTimeout(() => {
      if (T && b === "books" && at.current && mt.current) {
        const H = at.current, rt = mt.current, At = rt.offsetTop, me = H.clientHeight, Te = rt.clientHeight, Be = At - me / 2 + Te / 2;
        H.scrollTo({
          top: Math.max(0, Be),
          behavior: "smooth"
        }), E(Gn(t.book));
  ...
  }, [b, L, R, t.book, t.chapterNum]), Qt(() => {
    if (b === "verses" && z && W !== void 0) {
      const x = z === t.book && W === t.chapterNum, H = x ? t.verseNum : 1;
      E(
        `${z} ${ie[z] || ""} ${W}:${H}`
      ), setTimeout(() => {
        if (at.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Me, { open: T, onOpenChange: it, modal: C, children: [
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: H } = x;
          T && Pt.current && H instanceof Node && Pt.current.contains(H) && (G.current = !0, it(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Ie,
              ...
              b === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  U,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: b === "verses" ? ot : et,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: B === "ltr" ? /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ls, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                b === "chapters" && L && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Se(L, n) }),
                b === "verses" && z && W !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Se(z, n)} ${W}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: b === "verses" ? gr : hr
                  }
                )
              ] }),
              !Dt && /* @__PURE__ */ u(Ae, { ref: at, children: [
                b === "books" && /* @__PURE__ */ u(ct, { children: [
                  !R && Object.entries(fe).map(([x, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: Ut(x), children: H.map((rt) => /* @__PURE__ */ a(
                          qn,
                          {
                            bookId: rt,
                            onSelect: (At) => Ee(At),
                ...
                b === "verses" && z && W !== void 0 && l && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: z,
                    chapterNum: W,
...
function Bo({
  ...
  const [N, D] = _(!1), B = l ?? d, T = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], M = (I, E) => {
    const A = d(I), K = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, b = `${E ?? ""}${A}${K ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: A,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ie, { children: [
          ...
          /* @__PURE__ */ a(Ae, { children: T(e) ? e.map((I) => /* @__PURE__ */ a(xe, { heading: I.groupHeading, children: I.options.map((E) => M(E, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((I) => M(I)) }) })
        ] })
      }
    )
  ] });
...
const Wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yl = Wn ? Qt : q, Ir = { tag: ro };
function kl({ initialConfig: t, children: e }) {
  const r = O(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = xl(null, o), w = Rn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
        if (g === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            const f = zr();
            h.append(f);
            const y = Wn ? document.activeElement : null;
            (Xt() !== null || y !== null && y === p.getRootElement()) && f.select();
          }
        }, Ir);
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : q;
...
const Sl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : q;
function Rl(t) {
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = Xn && "documentMode" in document ? document.documentMode : null;
!(!Xn || !("InputEvent" in window) || Ml) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
...
function Il(t, e, r) {
  ...
  function d() {
    ...
    for (let C = 0; C < h.length; C++) {
      const k = h[C], N = s[C] || document.createElement("div"), D = N.style;
      D.position !== "absolute" && (D.position = "absolute", v = !0);
      const B = we(k.left - p);
      D.left !== B && (D.left = B, v = !0);
      const T = we(k.top - g);
      D.top !== T && (N.style.top = T, v = !0);
      const M = we(k.width);
      D.width !== M && (N.style.width = M, v = !0);
      const I = we(k.height);
      D.height !== I && (N.style.height = I, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[C] = N;
    }
...
function Pl(t, e = Al) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), y = f.getKey(), v = g.offset, C = h.getNode(), k = C.getKey(), N = h.offset, D = t.getElementByKey(y), B = t.getElementByKey(k), T = r === null || D !== o || v !== n || y !== r.getKey(), M = i === null || B !== s || N !== c || k !== i.getKey();
      if ((T || M) && D !== null && B !== null) {
        const I = function(E, A, K, b, X, L, Y) {
          const z = (E._window ? E._window.document : document).createRange();
          return z.setStart(...Fo(A, K, b)), z.setEnd(...Fo(X, L, Y)), z;
        }(t, g, f, D, h, C, B);
        d(), d = Il(t, I, e);
      }
      r = f, o = D, n = v, i = C, s = B, c = N;
    });
  }
...
function jl(t) {
  const e = Xt() || cc();
  let r;
  if (ue(e)) r = lc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Mn(c, "next"));
    }
    r = r || dc(Oe(), "previous").getFlipped().insert(zr());
  }
  const o = Bl(t, r), n = wc(o), i = uc(n) ? pc(n) : o;
  return hc(gc(i)), t.getLatest();
}
function Bl(t, e, r) {
  let o = Do(e, "next");
  for (let n = o; n; n = fc(n, r)) o = n;
  return mc(o) && Xr(283), o.insert(t.isInline() ? zr().append(t) : t), Do(Mn(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = Xt();
  if (!ue(e)) return !1;
...
let Jr, be = 0, Zr = 0, ql = 0, La = 0, Ur = 0;
function Ko(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Hl(t) {
  ...
  Zn(this), nt = t, this.f &= -2, 8 & this.f && lo(this), ia();
}
function Qe(t, e) {
...
Bt.prototype.brand = Ul, Bt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Qn(this), qo(this), be++;
  const t = nt;
  return nt = this, Hl.bind(this, t);
...
function ei(t, e = ti) {
  return t.registerCommand(In, (r) => (t.update(e), !0), ao);
}
re({ build: (t, e, r) => wr(e), config: Xe({ $onClear: ti }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const ma = yc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ri extends $a {
  $config() {
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [ri], register: (t, e, r) => t.registerCommand(An, (o) => {
  const n = Xt();
  if (Pn(n) || ue(n)) for (const i of n.getNodes()) Wl(i) && i.toggleFormat(o);
  return !1;
}, Vn) });
function ai(t, e) {
  let r;
...
const ja = re({ build: (t) => ai(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const wo = 0, Ba = 1, ni = 2, va = 3, Ar = 4, Ze = 5, ba = 6, mr = 7;
function xa(t) {
  return t.id === wo;
}
function ii(t) {
...
function Xl(t) {
  return function(e) {
    return e.id === Ba;
  }(t) || lt(305, String(t.id), String(Ba)), Object.assign(t, { id: ni });
}
...
const td = re({ config: Xe({ setOptions: Go, updateOptions: Go }), init: ({ $initialEditorState: t = Ql }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [kc, On, _c, Nc, Dn] }), Ho = Symbol.for("@lexical/extension/LexicalBuilder");
function Yo() {
}
function ed(t) {
  throw t;
...
const rd = /* @__PURE__ */ new Set(), Wo = re({ build(t, e, r) {
  const o = r.getDependency(ja).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ai(() => {
  }, () => pe(() => {
    ...
    o.value.read(() => {
      if (Xt()) for (const [w, p] of c.entries()) {
        ...
        const g = Pc(w), h = g && g.isSelected() || !1;
...
}, dependencies: [ja], name: "@lexical/extension/NodeSelection" }), ad = Ec("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends $a {
  static getType() {
...
re({ dependencies: [ja, Wo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ne(t.registerCommand(ad, (s) => {
    const c = Xt();
    if (!ue(c)) return !1;
    ...
    return !0;
  }, ao), t.registerCommand(Tc, (s) => {
    if (zc(s.target)) {
      const c = Sc(s.target);
      if (nd(c)) return function(d, l = !1) {
        const w = Xt(), p = d.isSelected(), g = d.getKey();
        let h;
        l && Pn(w) ? h = w : (h = Rc(), Dc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function id(t, e, r = si) {
  return Ne(t.registerCommand(Lc, (o) => {
    const n = Xt();
    if (!ue(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => jc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Ll(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Bc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Fc(h), h.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Uc : Mo : Kc;
...
re({ build: (t, e, r) => wr(e), config: Xe({ $canIndent: si, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return pe(() => {
    if (!o.value) return id(t, n, i);
  });
} });
const sd = re({ name: "@lexical/react/ReactProvider" });
function cd() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                const y = f.anchor;
                let v = y.getNode(), C = 0, k = 0;
                if (Ia(v) && l >= 0 && w >= 0 && (C = l, k = l + w, f.setTextNodeRange(v, C, v, k)), C === k && p === "" || (f.insertRawText(p), v = y.getNode()), Ia(v)) {
                  C = g, k = g + h;
                  const N = v.getTextContentSize();
                  C = C > N ? N : C, k = k > N ? N : k, f.setTextNodeRange(v, C, v, k);
                }
...
re({ build: (t, e, r) => wr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : li(t)) });
function wd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const po = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : q;
...
function hd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    po(() => Ne(Xc(n), li(n)), [n]);
  }(o), u(ct, { children: [t, a(gd, { content: e }), a(pd, { editor: o, ErrorBoundary: r })] });
}
...
function kd(t, e) {
  ...
  return u(ct, { children: [a(xd, { editor: n, ...o, ref: e }), r != null && a(_d, { editor: n, content: r })] });
}
...
function Td({
  ...
  const [e] = ge(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Ed(), d = () => {
  };
...
function Sd() {
  const { activeEditor: t } = ui(), [e, r] = _([]), o = j((n) => {
    if (ue(n) || Qc(n)) {
      const i = [];
      Zo.forEach(({ format: s }) => {
...
function Dd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Td, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Sd, {}) }) }),
...
const $d = "verseText", ep = Object.freeze([
...
function rp({
  ...
  const [i, s] = _(Id), [c, d] = _(n), [l, w] = _(!1), p = F(void 0), g = F(null);
  q(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
...
function tn({
  ...
  }, [t.date, r]), v = O(() => t.user, [t.user]), C = O(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = O(() => to(t.contents), [t.contents]), N = O(
    ...
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (T) => {
              T.stopPropagation(), l(!0), p(Md(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), h()) : go(T) && (T.preventDefault(), T.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (T) => {
        ...
        B && /* @__PURE__ */ u(ye, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(hs, {}) }) }),
...
function yi({
  ...
  const [b, X] = _(en), [L, Y] = _(), [z, P] = _(), W = o, [Z, Dt] = _(!1), [Tt, Pt] = _(!1), [G, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(D), [Ot, Vt] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  q(() => {
    let S = !0;
    return (async () => {
  ...
  q(() => {
    if (!o) {
      yt.current !== "idle" && (Y(void 0), P(void 0), yt.current = "idle");
      return;
    }
    yt.current === "idle" && (yt.current = "pending"), wt ? yt.current === "pending" && M !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    M !== i && (Y(M), yt.current = "auto-populated") : yt.current === "auto-populated" && (Y(void 0), yt.current = "pending");
  }, [o, M, wt, i]);
  const Ct = O(
  ...
  const Zt = O(() => Ct[0], [Ct]), Ee = F(null), te = F(void 0), V = j(() => {
    var S;
    (S = te.current) == null || S.call(te), X(en);
  }, []), Q = j(() => {
    const S = !ut;
    bt(S), Vt(!S), f == null || f(d, S);
  }, [ut, f, d]);
  q(() => {
    Dt(!1);
  }, [o]), q(() => {
  ...
  const Ut = j(
    ...
    async (S) => {
      const It = ee(b) ? ta(b) : void 0, xt = S.status ? S.assignedUser : L ?? S.assignedUser, oe = await p({
        ...S,
        contents: It,
        assignedUser: xt
      });
      return oe && (xt !== void 0 && P(xt), It && V()), oe;
    },
    [V, b, p, L]
  );
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              U,
              {
                ...
                children: ut ? /* @__PURE__ */ a(gs, {}) : /* @__PURE__ */ a(fs, {})
              }
            ),
            A === void 0 ? (
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            v !== !1 && (!Tt || ee(b)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  go(S) && (S.preventDefault(), S.stopPropagation(), (ee(b) || L !== void 0 && L !== z) && Ut());
                },
                onKeyDown: (S) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    L !== void 0 && (ee(b) || L !== z) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
                    ...
                    /* @__PURE__ */ u(Me, { open: G, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ a(
                        U,
                        {
                          ...
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !wt || !y || y.length === 0 || !y.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ae, { children: y == null ? void 0 : y.map((S) => /* @__PURE__ */ a(
                            Ce,
                            {
                              onSelect: () => {
                                Y(S !== i ? S : void 0), yt.current = "user-selected", P(void 0), tt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Kr(S, r) })
                            },
                            S || "unassigned"
                          )) }) })
                        }
...
), Fd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => Fd(to(t));
function Gr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Ud({
  ...
  const [s, c] = _("accept"), d = Wr(), l = Wr(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, y = O(
    () => qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = O(
    () => qr(t.acceptedText ?? ""),
  ...
  let E;
  M ? E = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (E = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const A = e["%conflict_note_no_result%"] ?? "No result preview available.", K = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: A }), b = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : K, X = () => {
    const z = o ?? "accept";
    return z === "merged" ? t.mergedText ? /* @__PURE__ */ a(Gr, { html: C }) : K : b(z === "reject" ? t.rejectedResultText : t.resultText);
  }, L = (z) => p && z.value === "reject", Y = (z) => {
    const P = f === z.value, W = `${l}-${z.value}`, Z = L(z);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          className: m(
            ...
            P ? "tw:border-border tw:bg-accent/50" : "tw:border-transparent tw:hover:bg-accent/30",
      ...
      !w && !g && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          Ga,
          {
            ...
            children: T.map((z) => L(z) ? /* @__PURE__ */ a(Gt, { delayDuration: 0, children: /* @__PURE__ */ u(Ht, { children: [
              /* @__PURE__ */ a(Yt, { asChild: !0, children: Y(z) }),
...
function Yd(t) {
  ...
  } = t, c = O(() => e.filter((C) => !C.deleted), [e]), d = O(
...
function wp({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [D, B] = _(), [T, M] = _(), I = j(
    async (P) => {
      const W = await i(P);
      return W !== void 0 && P.assignedUser !== void 0 && P.assignedUser !== "" && M(P.assignedUser), W;
    },
    [i]
  );
  q(() => {
    f && (N((P) => new Set(P).add(f)), B(f));
  }, [f]);
  const E = r.filter(
    (P) => P.comments.some((W) => !W.deleted)
  ), A = E.map((P) => ({ id: P.id })), K = j(
    (P) => {
      N((W) => new Set(W).add(P.id)), B(P.id), y == null || y(P.id);
    },
    [y]
  ), b = j(
    (P) => {
      ...
      N((Z) => {
        const Dt = new Set(Z);
        return Dt.has(P) ? Dt.delete(P) : Dt.add(P), Dt;
      }), B(P), y == null || y(W ? void 0 : P);
    },
    [k, y]
  ), { listboxRef: X, activeId: L, handleKeyDown: Y } = qi({
    options: A,
    onOptionSelect: K
  }), z = j(
    (P) => {
      P.key === "Escape" ? (D && k.has(D) && (N((W) => {
        const Z = new Set(W);
        return Z.delete(D), Z;
      }), B(void 0), y == null || y(void 0)), P.preventDefault(), P.stopPropagation()) : Y(P);
    },
    [D, k, Y, y]
  );
  return /* @__PURE__ */ a(
      ...
      children: E.map((P) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: P.type === "Conflict" ? /* @__PURE__ */ a(Yd, { ...W, conflictResolution: C }) : /* @__PURE__ */ a(yi, { ...W })
          },
          P.id
        );
      })
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ft.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ft.Icon, { asChild: !0, children: /* @__PURE__ */ a(zn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function tw({
  ...
  var T;
  const [w, p] = _([]), [g, h] = _([]), [f, y] = _({}), [v, C] = _({}), k = O(() => e ?? [], [e]), N = Fn({
    data: k,
    columns: t,
    getCoreRowModel: Kn(),
  ...
  let B;
  return d ? B = Array.from({ length: 10 }).map((E, A) => `skeleton-row-${A}`).map((E) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: D.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((T = N.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = N.getRowModel().rows.map((M) => /* @__PURE__ */ a(
    Re,
    {
      onClick: () => s(M, N),
      "data-state": M.getIsSelected() && "selected",
      children: M.getVisibleCells().map((I) => /* @__PURE__ */ a(er, { children: xr(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    M.id
    ...
    n && /* @__PURE__ */ a(Wd, { table: N }),
    /* @__PURE__ */ u(Wa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Xa, { stickyHeader: i, children: N.getHeaderGroups().map((M) => /* @__PURE__ */ a(Re, { children: M.headers.map((I) => /* @__PURE__ */ a(Yr, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : xr(I.column.columnDef.header, I.getContext()) }, I.id)) }, M.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(U, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(yn, {}) })
        ] }),
...
function mp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ye, { children: [
    ...
    /* @__PURE__ */ a(_e, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(gn, { children: l.itemType === 0 ? /* @__PURE__ */ a(ct, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        De,
        {
          checked: o[w][g],
...
const cw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ct, { children: [
...
function lw({
  ...
  const f = (v) => {
    ...
    var C, k, N, D;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((D = s.current) == null || D.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: cw(t, n, r) }) }) }),
...
const dw = (t, e) => t === "f" ? /* @__PURE__ */ u(ct, { children: [
  /* @__PURE__ */ a(_n, {}),
  " ",
...
function uw({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: dw(t, r) }) }) }),
      /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ a("p", { children: ww(t, r) }) })
    ] }) }),
...
function yp({
  ...
  const [f, y] = _("generated"), [v, C] = _("generated"), [k, N] = _("*"), [D, B] = _("*"), [T, M] = _("f"), [I, E] = _(!1), [A, K] = _(!0), [b, X] = _(!1), L = F(!1), Y = F(""), [z, P] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Pt, G] = _(), [tt, wt] = _(), at = F(null), mt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  q(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Aa ? st = "generated" : it === Pa ? st = "hidden" : it && (N(it), B(it)), y(st), C(st), M(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), V = setTimeout(() => {
        var ht;
  ...
  const Jt = () => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      T !== "x" && V === "x" ? pt == null || pt.forEach((gt) => mw(gt)) : T === "x" && V !== "x" && (pt == null || pt.forEach((gt) => vw(gt))), (ht = w.current) == null || ht.applyUpdate([Q, { delete: 1 }]);
    }
  }, Ct = (V) => {
    wt(V.contextMarker), X(V.canRedo);
  }, Zt = j(
    (V) => {
      var et, ot, it, st, ht;
      const Q = (ot = (et = w.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : ot.at(0);
      if (Q && Mr("note", Q)) {
        ...
        if (pt || E(!1), E(
          ...
          L.current = !0, Y.current = JSON.stringify(Q), K(!0);
          return;
        }
    ...
    if (g.current && ae.length && V && V.rangeCount > 0) {
      ...
      Z(Q.left - et.left), Tt(Q.top - et.top), G(Q.height), P(!0);
    }
  }, [ae, g]);
  q(() => {
    const V = () => {
    ...
    var V;
    z && ((V = at.current) == null || V.focus());
  }, [z]), q(() => {
    var et;
    const V = ((et = p.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, Q = (ot) => {
      !z && V && document.activeElement === V && ot.key === c ? (ot.preventDefault(), Ee()) : z && ot.key === "Escape" && (ot.preventDefault(), P(!1));
    };
...
function kw({
  ...
  /* @__PURE__ */ u("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    fo(t.marker, [s], o, !1),
    " "
  ] }), g = e === "horizontal" ? "horizontal" : "vertical", h = o ? "marker-visible" : "", f = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", y = m(g, h);
  return /* @__PURE__ */ u(ct, { children: [
    /* @__PURE__ */ u("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", y), children: [
      d,
      w
    ] }),
    /* @__PURE__ */ a("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", y), children: p }),
    /* @__PURE__ */ a(
      "div",
      {
        className: m(
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: xw(t.marker, c, o, l) })
      }
    )
  ] });
}
function _p({
  ...
  const w = d ?? qs(r, void 0), p = (k, N) => {
    l == null || l(k, N, n);
  }, g = i ? r.findIndex((k) => k === i) : -1, [h, f] = _(g), y = (k, N, D) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
...
}, sa = (t, e, r) => /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
  /* @__PURE__ */ u(
    Yt,
    {
...
function Dp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), y = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), C = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), D = de(r, "%webView_inventory_filter_text%"), B = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = de(r, "%webView_inventory_no_results%"), [M, I] = _(!1), [E, A] = _("all"), [K, b] = _(""), [X, L] = _([]), Y = O(() => {
    const G = t ?? [];
  ...
  }, [M, Y]), P = O(() => z.length === 0 ? [] : zw(z, E, K), [z, E, K]), W = O(() => {
    var wt, at;
    if (!M) return d;
  ...
  q(() => {
    P.length === 0 ? L([]) : P.length === 1 && L(P[0].items);
  }, [P]);
  const Z = (G, tt) => {
    tt.setRowSelection(() => {
      const at = {};
    ...
    if (z.length === 0 || X.length === 0) return [];
    const G = z.filter((tt) => Gs(
        ...
        sr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(dr, { children: [
              ...
              /* @__PURE__ */ a(ne, { value: "unapproved", children: y }),
              /* @__PURE__ */ a(ne, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(sr, { onValueChange: (G) => Dt(G), defaultValue: s, children: [
...
const Rw = "16rem", Dw = "3rem", Ni = qt.createContext(void 0);
function ca() {
  const t = qt.useContext(Ni);
  if (!t)
...
function Ow({
  ...
  const [d, l] = qt.useState(t), w = e ?? d, p = qt.useCallback(
    ...
    [r, w]
  ), g = qt.useCallback(() => p((N) => !N), [p]), h = w ? "expanded" : "collapsed", v = se() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = qt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function jw({
  ...
  const l = j(
    ...
    (h) => {
      const f = r.find((y) => y.projectId === h);
    ...
    Mw,
    {
      ...
      children: /* @__PURE__ */ u(Iw, { children: [
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(Aw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Pw, { children: /* @__PURE__ */ a(
            Lw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const ze = "scrBook", Bw = "scrRef", Ke = "source", Fw = "details", Uw = "Scripture Reference", Kw = "Scripture Book", Ci = "Type", qw = "Details";
function Gw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Gp({
  ...
  const [l, w] = _([]), [p, g] = _([{ id: ze, desc: !1 }]), [h, f] = _({}), y = O(
    () => t.flatMap((E) => E.data.map((A) => ({
      ...A,
      source: E.source
    }))),
    [t]
  ...
  q(() => {
    if (c) {
      const E = C.getSelectedRowModel().rowsById, A = Object.keys(E);
      if (A.length === 1) {
        const K = y.find((b) => ln(b) === A[0]) || void 0;
        K && c(K);
      }
    }
  }, [h, y, c, C]);
  const k = n ?? Kw, N = i ?? Ci, D = [
    ...
    !E.getIsGrouped() && !E.getIsSelected() && E.getToggleSelectedHandler()(A);
  }, M = (E, A) => E.getIsGrouped() ? "" : m("banded-row", A % 2 === 0 ? "even" : "odd"), I = (E, A, K) => {
    if (!((E == null ? void 0 : E.length) === 0 || A.depth < K.column.getGroupedIndex())) {
      if (A.getIsGrouped())
        switch (A.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Xd, { children: D.map((E) => /* @__PURE__ */ a(ne, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Wa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Xa, { children: C.getHeaderGroups().map((E) => /* @__PURE__ */ a(Re, { children: E.headers.filter((A) => A.column.columnDef.header).map((A) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Yr, { colSpan: A.colSpan, className: "tw:sticky top-0", children: A.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Ja, { children: C.getRowModel().rows.map((E, A) => {
        const K = se();
        return /* @__PURE__ */ a(
          Re,
          {
            ...
            children: E.getVisibleCells().map((b) => {
              if (!(b.getIsPlaceholder() || b.column.columnDef.enableGrouping && !b.getIsGrouped() && (b.column.columnDef.id !== Ke || !r)))
                return /* @__PURE__ */ a(
                  er,
                  {
                    className: m(
                    ...
                    children: b.getIsGrouped() ? /* @__PURE__ */ u(
                      U,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ a(Da, {}) : /* @__PURE__ */ a(Ra, {})),
                          " ",
...
const Ti = (t, e, r) => mo(t, e).every((o) => r.includes(o));
function Yw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [y, v] = _(!1), [C, k] = _(""), N = F(void 0), D = F(!1), B = O(
    () => Ei(t),
    [t]
  ), T = O(() => {
    if (!C.trim()) {
    ...
    (b, X = !1) => {
      ...
      const L = B.findIndex((Z) => Z === N.current), Y = B.findIndex((Z) => Z === b);
      if (L === -1 || Y === -1) return;
      const [z, P] = [
        Math.min(L, Y),
        Math.max(L, Y)
      ], W = B.slice(z, P + 1).map((Z) => Z);
      r(
        e.includes(b) ? e.filter((Z) => !W.includes(Z)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, r, B]
  ), I = (b) => {
    M(b, D.current), D.current = !1;
  }, E = (b, X) => {
    b.preventDefault(), M(X, b.shiftKey);
  }, A = () => {
    r(B.map((b) => b));
  }, K = () => {
    r([]);
          ...
          Ie,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: A, children: d }),
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: K, children: l })
              ] }),
              /* @__PURE__ */ u(Ae, { children: [
                /* @__PURE__ */ a(aa, { children: w }),
                Object.values(dt).map((b, X) => {
                  const L = T[b];
                  if (L.length !== 0)
                    return /* @__PURE__ */ u(Tn, { children: [
                      /* @__PURE__ */ a(
                        xe,
                        {
                          heading: un(b, p, g, h, f),
                          children: L.map((Y) => /* @__PURE__ */ a(
                            qn,
                            {
                              bookId: Y,
                      ...
                      X < Object.values(dt).length - 1 && /* @__PURE__ */ a(mn, {})
                    ] }, b);
                })
              ] })
            ]
...
function Yp({
  ...
  const D = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = St(s, "%webView_scope_selector_verse%"), T = St(s, "%webView_scope_selector_chapter%"), M = St(s, "%webView_scope_selector_book%"), I = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = St(
    s,
    "%webView_scope_selector_current_chapter%"
  ), A = St(s, "%webView_scope_selector_current_book%"), K = St(s, "%webView_scope_selector_choose_books%"), b = St(s, "%webView_scope_selector_scope%"), X = St(s, "%webView_scope_selector_select_books%"), L = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), z = St(s, "%webView_scope_selector_range_start%"), P = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Dt = St(s, "%webView_scope_selector_navigate%"), Tt = ($) => {
    if (!f) return;
  ...
  ], G = ($, J, Kt = !1) => /* @__PURE__ */ u(ct, { children: [
    $,
    J && !Kt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? Pt.filter(($) => e.includes($.value)) : Pt, wt = f ?? ua, at = w ?? wt, mt = p ?? wt, ae = () => {
  }, ut = F(null), bt = F(null), Ot = F(!1), Vt = F(null), Jt = F(!1), [fe, R] = _(void 0), yt = F(!1), Ct = F(!1), Zt = F(null), Ee = j(($) => {
    if ($) {
      R("start"), yt.current = !1;
      return;
    }
    R((J) => J === "start" ? void 0 : J), yt.current && (yt.current = !1, requestAnimationFrame(() => {
      var Kt;
    ...
    [r, n, f, i]
  ), ot = tt.find(($) => $.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map(($) => $.toUpperCase()).join(", ") : t === "range" ? Hs(at, mt, {
  ...
  ), ht = tt.find(($) => $.value === "selectedBooks"), pt = tt.find(($) => $.value === "range"), [gt, Mt] = _(!1), [zt, Ut] = _(void 0), [$t, Ve] = _(void 0), [S, It] = _(void 0), [xt, oe] = _(void 0), [Le, ur] = _([]), pr = l === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Xw,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Je = "tw:text-muted-foreground", je = l === "dropdown" && zt === "range", x = je ? It : V, rt = je ? oe : h ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: m(gr && Je), children: z }),
      /* @__PURE__ */ a(
        ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ut, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: m(Rr && Je), children: P }),
      /* @__PURE__ */ a(
        ha,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: C,
          disableReferencesUpTo: je ? S ?? at : at,
          onOpenChange: te,
          onCloseAutoFocus: ($) => {
            var J;
            Ct.current && (Ct.current = !1, $.preventDefault(), (J = Zt.current) == null || J.focus());
          },
          className: m(Rr && Je),
          modal: !0,
          align: "start"
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Lt, le] = _(null), Fe = 200, [Ii, Ai] = _(!1);
  q(() => {
    if (!Lt || typeof ResizeObserver > "u") return;
    const $ = new ResizeObserver(([J]) => {
      Ai(J.contentRect.width < Fe);
    });
    return $.observe(Lt), () => $.disconnect();
  }, [Lt]);
  const vo = j(
    ($) => {
      Ve($), It(at), oe(mt), ur(n), Mt(!1), Ut($);
    },
    [at, mt, n]
  ), bo = j(() => {
    $t !== void 0 && ($t === "range" ? (S && (g == null || g(S)), xt && (h == null || h(xt))) : $t === "selectedBooks" && i(Le), et($t), Ut(void 0), Ve(void 0));
  }, [
    $t,
    S,
    xt,
    ...
    var J;
    $.preventDefault(), (J = Be.current) == null || J.focus();
  }, []), yo = ($) => t === $ ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Nt, { children: b }),
      l === "dropdown" ? /* @__PURE__ */ u(ye, { open: gt, onOpenChange: Mt, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            children: /* @__PURE__ */ u(la, { container: Lt, children: [
              st.map(({ value: $, label: J, dropdownLabel: Kt, scrRefSuffix: fr, id: Pi }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Te($),
                ...
                /* @__PURE__ */ a(
                  qe,
                  {
                    ...
                    onSelect: ($) => {
                      ...
                      Jt.current || (Kt = (J = bt.current) == null ? void 0 : J.querySelector("button")) == null || Kt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: ($) => {
                          const J = $.target instanceof HTMLElement ? $.target : void 0;
                        ...
                        children: /* @__PURE__ */ a(
                          ha,
                          {
                            ...
                            onCloseAutoFocus: ($) => {
                              var J;
                              $.preventDefault(), (J = Vt.current) == null || J.focus();
                            },
                            modal: !0,
        ...
        Ga,
        {
          ...
          children: tt.map(({ value: $, label: J, scrRefSuffix: Kt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Hr, { className: "tw:me-2", value: $, id: fr }),
            /* @__PURE__ */ a(Nt, { htmlFor: fr, children: G(J, Kt) })
          ] }, fr))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { children: X }),
      hr
    ] }),
    l === "radio" && t === "range" && At,
    l === "dropdown" && ht && /* @__PURE__ */ a(Ea, { open: zt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: ft,
        onCloseAutoFocus: xo,
        ...
        children: /* @__PURE__ */ u(la, { container: _t, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: K }) }),
          hr,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Dr(!1), children: Z }),
            /* @__PURE__ */ a(U, { onClick: bo, children: W })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && pt && /* @__PURE__ */ a(Ea, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: kt,
        onCloseAutoFocus: xo,
        ...
        children: /* @__PURE__ */ u(la, { container: Et, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: Y }) }),
          At,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Dr(!1), children: Z }),
            /* @__PURE__ */ a(U, { ref: Zt, onClick: bo, children: W })
          ] })
        ] })
      }
    ) })
...
const Si = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Yt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(rs, { children: /* @__PURE__ */ a(as, { children: Si(
      t,
      e,
      zi(t, c.id),
      o
...
function Fa({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ps, {}) }) }),
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Tn, { children: [
      /* @__PURE__ */ a(gn, { children: /* @__PURE__ */ a(Gt, { children: Si(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(He, {})
    ] }, d)) })
  ] });
}
const Ri = qt.forwardRef(
...
const Di = qt.forwardRef(({ className: t, ...e }, r) => {
  const o = se();
  return /* @__PURE__ */ a(
    ce.Root,
    {
...
const Oi = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.List,
  {
    ref: r,
    className: m(
...
const Qw = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Trigger,
  {
    ref: r,
    ...e,
...
)), Mi = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Content,
  {
    ref: r,
    className: m(
  ...
  if (ll(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), vr(s, [g, h]);
        break;
      case "alt+n":
...
function oh({
  ...
  const l = wu(
    ...
    var C, k, N, D, B, T;
    const v = y !== f ? ((k = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : k[y]) ?? ((D = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : D.en) : void 0;
...
function ih({
  ...
  const [s, c] = _(""), d = O(
    ...
    return d.filter(({ keywords: y }) => y.some((v) => v.toLowerCase().includes(f)));
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(ns, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(is, { children: /* @__PURE__ */ a(rc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(ye, { children: [
              /* @__PURE__ */ a(ke, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(To, {}) }) }),
...
const Ua = 288, wn = 176, Vr = 12, Lr = 6;
function _u(t) {
...
function Cu(t, e) {
  const r = (n) => Math.max(8, Math.min(n, window.innerWidth - Ua - 8)), o = (n) => Math.max(8, Math.min(n, window.innerHeight - wn - 8));
  switch (e) {
    case "top":
      return {
        top: o(t.top - Vr - wn),
    ...
    case "left":
      return { top: o(t.top), left: r(t.left - Ua - Vr) };
    case "right":
      return { top: o(t.top), left: r(t.left + t.width + Vr) };
    default:
      return { top: o(t.top + t.height + Vr), left: r(t.left) };
  }
}
function Xh({
  steps: t,
  ...
  const [d, l] = _([]), [w, p] = _(0), [g, h] = _(void 0), f = F(null), y = Wr(), v = Wr();
  q(() => {
    e && (l(t.filter((b) => !!document.querySelector(b.target))), p(0));
  }, [e, t]);
  const C = d[w];
  q(() => {
    if (!e || !C) return;
    ...
    var b;
    e && C && ((b = f.current) == null || b.focus());
  }, [e, C]);
  const k = w === d.length - 1, N = w === 0, D = j(() => {
    k ? r() : p((b) => b + 1);
  }, [k, r]), B = j(() => {
    N || p((b) => b - 1);
  }, [N]);
  if (q(() => {
    if (!e) return;
    const b = (X) => {
      X.key === "Escape" && (X.stopPropagation(), o());
    };
    return window.addEventListener("keydown", b, !0), () => window.removeEventListener("keydown", b, !0);
  }, [e, o]), !e || !C || !g) return null;
  const T = Nu(C.side ?? "bottom"), M = Cu(g, T), I = g.left - Lr, E = g.top - Lr, A = g.width + Lr * 2, K = g.height + Lr * 2;
  return /* @__PURE__ */ u(
    "div",
    {
      role: "dialog",
      ...
      children: [
        /* @__PURE__ */ u(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ a("defs", { children: /* @__PURE__ */ u("mask", { id: y, children: [
                /* @__PURE__ */ a("rect", { width: "100%", height: "100%", fill: "white" }),
                /* @__PURE__ */ a("rect", { x: I, y: E, width: A, height: K, rx: "6", fill: "black" })
              ] }) }),
              /* @__PURE__ */ a("rect", { width: "100%", height: "100%", fill: "rgba(0,0,0,0.55)", mask: `url(#${y})` })
            ]
          }
        ),
        /* @__PURE__ */ u(
          "div",
          {
            ...
            style: { top: M.top, left: M.left, width: Ua },
            children: [
              /* @__PURE__ */ u("p", { className: "tw:text-xs tw:text-muted-foreground", children: [
                w + 1,
                " / ",
                d.length
              ] }),
              /* @__PURE__ */ a("h3", { className: "tw:text-sm tw:font-semibold", children: C.title }),
              /* @__PURE__ */ a("p", { id: v, className: "tw:text-sm tw:text-muted-foreground", children: C.description }),
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between tw:pt-1", children: [
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: o, children: s }),
                /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
                  !N && /* @__PURE__ */ a(U, { variant: "outline", size: "sm", onClick: B, children: i }),
                  /* @__PURE__ */ a(U, { ref: f, size: "sm", onClick: D, children: k ? c : n })
                ] })
              ] })
            ]
          }
