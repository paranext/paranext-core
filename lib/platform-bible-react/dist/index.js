...
import u, { useCallback as X, useMemo as G, useState as I, useRef as Y, useLayoutEffect as cn, createContext as _r, useContext as Sr, useEffect as Et, forwardRef as Cn, Fragment as _n } from "react";
...
import { X as He, Search as Sn, ChevronsLeft as pn, ChevronsRight as un, ChevronLeft as Ie, ChevronRight as At, ArrowLeft as Er, ArrowRight as Vr, Circle as he, ChevronsUpDown as Ye, Check as _t, FilterIcon as Mr, ChevronDown as fe, ChevronUp as Dr, ArrowLeftIcon as zr, ChevronLeftIcon as Or, ChevronRightIcon as Ir, ArrowRightIcon as Ar, Copy as Pr, Filter as Br, User as jr, Link as $r, CircleHelp as Xr, Star as Fr, CircleCheckIcon as Gr, CircleXIcon as Lr, CircleHelpIcon as Hr, ArrowUpIcon as Yr, ArrowDownIcon as Ur, ArrowUpDownIcon as qr, PanelLeft as Kr, PanelRight as Jr, ScrollText as Wr, MenuIcon as Zr, Menu as Qr, EllipsisVertical as ta, LoaderCircle as ea } from "lucide-react";
import * as mt from "@radix-ui/react-dialog";
import * as Qt from "@radix-ui/react-popover";
import { getChaptersForBook as na, formatScrRef as Jt, NumberFormat as ra, formatBytes as aa, deepEqual as Ue, isString as Te, compareScrRefs as Ae, scrRefToBBBCCCVVV as Re, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
import * as Tn from "@radix-ui/react-label";
import * as te from "@radix-ui/react-radio-group";
import { useReactTable as Rn, getFilteredRowModel as oa, getSortedRowModel as En, getPaginationRowModel as sa, getCoreRowModel as Vn, flexRender as Wt, getGroupedRowModel as ia, getExpandedRowModel as wa } from "@tanstack/react-table";
import * as B from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as la } from "@radix-ui/react-dropdown-menu";
import * as F from "@radix-ui/react-select";
import da from "markdown-to-jsx";
...
import { Toaster as pa } from "sonner";
import { toast as Wi } from "sonner";
import * as Kt from "@radix-ui/react-slider";
import * as je from "@radix-ui/react-switch";
const ua = Rr({ prefix: "tw-" });
function c(...t) {
  return ua(Tr(t));
}
const ma = Ct(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Xt : "button", { className: c(ma({ variant: e, size: n, className: t })), ref: s, ...o })
);
z.displayName = "Button";
const ha = "layoutDirection";
function U() {
  const t = localStorage.getItem(ha);
  return t === "rtl" ? t : "ltr";
}
const fa = mt.Portal, zn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
    className: c(
...
const ga = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = U();
...
ga.displayName = mt.Content.displayName;
...
ba.displayName = mt.Title.displayName;
...
va.displayName = mt.Description.displayName;
...
const be = u.forwardRef((t, e) => /* @__PURE__ */ r(tt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
const On = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.Separator,
  {
    ref: n,
...
const Vt = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.Item,
  {
    ref: n,
    className: c(
...
const ie = Qt.Root, we = Qt.Trigger, Gt = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = U();
...
var xa = Object.defineProperty, ya = (t, e, n) => e in t ? xa(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => ya(t, typeof e != "symbol" ? e + "" : e, n);
const Mt = [
  "GEN",
  "EXO",
  "LEV",
...
const Q = class M {
  ...
  static fromJSON(e) {
    ...
    let p;
    return i && (p = new Tt(i)), n ? new M(n, a.toString(), w, p) : new M();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Tt(pt[i]);
        } catch {
    ...
    if (a.length !== 2 || D.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !M.isVerseParseable(a[1]))
      throw new Ut("Invalid reference : " + e);
  ...
  allVerses(e = !1, n = M.verseRangeSeparators, a = M.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], s = hn(this._verse, a);
    for (const i of s.map((w) => hn(w, n))) {
      const w = this.clone();
      w.verse = i[0];
      const p = w.verseNum;
...
const Xn = D.allBookIds.filter(
  (t) => !D.isObsolete(D.bookIdToNumber(t))
), ot = Object.fromEntries(
  Xn.map((t) => [t, D.bookIdToEnglishName(t)])
), Da = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon",
  ...
  const n = za.reduce(
    (a, o) => {
      ...
      if (s) {
        ...
        let l;
        const m = i.toLowerCase(), g = e.filter((h) => ot[h].toLowerCase().includes(m) || h.toLowerCase().includes(m));
        if (g.length === 1 && ([l] = g), !l && w && D.isBookIdValid(i)) {
...
function Ia(t, e, n, a) {
  const o = X(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const l = e[p - 1], m = Math.max(ut(l), 1);
        a({
          book: l,
          chapterNum: m,
          verseNum: 1
...
function bn({
  ...
  if (t)
    return /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ut(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Vt,
      {
        value: `${t} ${ot[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ni({
  ...
  const o = U(), [s, i] = I(!1), [w, p] = I(""), [l, m] = I(""), [g, h] = I("books"), [f, b] = I(void 0), [_, k] = I(!1), S = Y(void 0), x = Y(void 0), V = Y(void 0), A = Y(void 0), W = Y({}), nt = G(() => a ? a() : Xn, [a]), it = G(() => ({
  ...
  return cn(() => {
  ...
  }, [g, f, y, t.book, t.chapterNum]), /* @__PURE__ */ d(ie, { open: s, onOpenChange: rt, children: [
    ...
    /* @__PURE__ */ r(Gt, { forceMount: !0, className: "tw-z-[250] tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      ae,
      {
        ref: S,
        onKeyDown: ht,
        ...
        children: [
          g === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                tabIndex: -1,
                children: o === "ltr" ? /* @__PURE__ */ r(Er, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Vr, { className: "tw-h-4 tw-w-4" })
              }
            ),
          ...
          !_ && /* @__PURE__ */ d(se, { ref: V, children: [
            g === "books" && /* @__PURE__ */ d(Zt, { children: [
              ...
              y && ut(y.book) > 1 && /* @__PURE__ */ d(Zt, { children: [
...
), L = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Tn.Root, { ref: n, className: c("pr-twp", Aa(), t), ...e }));
L.displayName = Tn.Root.displayName;
const We = u.forwardRef(({ className: t, ...e }, n) => {
  const a = U();
  return /* @__PURE__ */ r(
    te.Root,
    {
...
const pe = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  te.Item,
  {
    ref: n,
    className: c(
...
function ai({
  ...
  const m = Ve(l, "%webView_bookSelector_currentBook%"), g = Ve(l, "%webView_bookSelector_choose%"), h = Ve(l, "%webView_bookSelector_chooseBooks%"), [f, b] = I(
    "current book"
    /* CURRENT_BOOK */
  ), _ = (k) => {
    b(k), t(k);
    ...
    We,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(L, { className: "tw-flex tw-items-center", children: a.map((k) => D.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
}), Fn = B.Trigger, Gn = B.Group, $a = B.Portal, Xa = B.Sub, Fa = B.RadioGroup;
...
const Ln = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = lt();
  return /* @__PURE__ */ d(
    B.SubTrigger,
    {
...
const ve = u.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = U();
...
const Yn = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = U(), s = lt();
  return /* @__PURE__ */ r(
    B.Item,
    {
...
const tn = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = lt();
  return /* @__PURE__ */ d(
    B.CheckboxItem,
    {
...
const Un = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = lt();
  return /* @__PURE__ */ d(
    B.RadioItem,
    {
...
const en = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  B.Label,
  {
    ref: a,
...
function La({ table: t }) {
  return /* @__PURE__ */ d(Qe, { children: [
    /* @__PURE__ */ r(la, { asChild: !0, children: /* @__PURE__ */ d(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Bt = F.Root, Ha = F.Group, jt = F.Value, Ya = Ct(
...
), Dt = u.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = U();
  return /* @__PURE__ */ d(
    F.Trigger,
    {
      className: c(Ya({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
const zt = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = U();
...
Ua.displayName = F.Label.displayName;
const st = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  F.Item,
  {
    ref: a,
    className: c(
...
qa.displayName = F.Separator.displayName;
function Ka({ table: t }) {
...
const ye = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
...
const ke = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: c("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function no({
  ...
  var k;
  const [w, p] = I([]), [l, m] = I([]), [g, h] = I({}), [f, b] = I({}), _ = Rn({
    data: e,
    columns: t,
    getCoreRowModel: Vn(),
    ...n && { getPaginationRowModel: sa() },
    onSortingChange: p,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(ye, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ne, { stickyHeader: s, children: _.getHeaderGroups().map((S) => /* @__PURE__ */ r(kt, { children: S.headers.map((x) => /* @__PURE__ */ r(ne, { children: x.isPlaceholder ? void 0 : Wt(x.column.columnDef.header, x.getContext()) }, x.id)) }, S.id)) }),
...
function oi({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: c("pr-twp tw-prose", n), children: /* @__PURE__ */ r(da, { options: o, children: e }) });
}
...
function ao({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Pr, {}) })
    ] }),
...
function ii({
  ...
  return /* @__PURE__ */ d(ie, { onOpenChange: (l) => {
    ...
    /* @__PURE__ */ d(Gt, { className: c("tw-min-w-80 tw-max-w-96", o), children: [
      s && n["%webView_error_dump_copied_message%"] && /* @__PURE__ */ r(L, { children: n["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ r(
        ao,
        {
          errorDetails: t,
...
function wi({ id: t, label: e, groups: n }) {
  const [a, o] = I(
    ...
    i((h) => (h[l] = m, { ...h }));
    const g = n[l].items.find((h) => h.id === m);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Qe, { children: [
    /* @__PURE__ */ r(Fn, { asChild: !0, children: /* @__PURE__ */ d(z, { variant: "default", children: [
      /* @__PURE__ */ r(Br, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(fe, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ve, { children: n.map((l, m) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(en, { children: l.label }),
      /* @__PURE__ */ r(Gn, { children: l.itemType === 0 ? /* @__PURE__ */ r(Zt, { children: l.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        tn,
        {
          checked: a[m][h],
        ...
        Fa,
        {
          ...
          children: l.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Un, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(xe, {})
    ] }, l.label)) })
...
function li({
  ...
  }).format(Object.values(n).reduce((m, g) => m + g, 0)), l = () => {
...
function so({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const p = new Date(w), l = new Date(o.getTime() - p.getTime()), m = l.getUTCFullYear() - 1970, g = l.getUTCMonth(), h = l.getUTCDate() - 1;
    let f = "";
...
function di({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(o).length > 0 && /* @__PURE__ */ r(so, { versionHistory: o }),
...
const io = Ct(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: c("pr-twp", io({ variant: e }), t), ...n })
);
...
function wo({
  ...
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ d(ie, { open: g, onOpenChange: h, children: [
    /* @__PURE__ */ r(we, { asChild: !0, children: /* @__PURE__ */ d(
      z,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(ae, { children: [
...
function lo({
  ...
  return /* @__PURE__ */ d(ye, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(ke, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      kt,
      {
        onClick: () => {
          e(i.reference);
        ...
        children: [
          /* @__PURE__ */ r($t, { children: `${D.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
const nn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pe.Root,
  {
    ref: n,
    className: c(
...
), co = u.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Mn.Root,
  {
    ref: o,
...
co.displayName = Mn.Root.displayName;
...
const ce = u.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const Ce = (t) => t === "asc" ? /* @__PURE__ */ r(Yr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), pi = (t) => ({
  accessorKey: "item",
  ...
  let i = [...n];
  t.forEach((p) => {
    e === "approved" ? i.includes(p) || i.push(p) : i = i.filter((l) => l !== p);
  }), a(i);
  let w = [...o];
  t.forEach((p) => {
  ...
  return e ? e[1] : "";
}, uo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", bi = Object.freeze([
...
function vi({
  ...
  const l = gt(n, "%webView_inventory_all%"), m = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = I(!1), [A, W] = I("all"), [nt, it] = I(""), [C, v] = I([]), y = G(() => t.length === 0 ? [] : ho(t, o, s), [t, o, s]), E = G(() => {
    if (x) return y;
    const T = [];
    return y.forEach((q) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(Bt, { onValueChange: (T) => dt(T), defaultValue: i, children: [
...
const rn = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Dn.Root,
  {
    ref: o,
    decorative: n,
...
const an = re.Provider, on = re.Root, sn = re.Trigger, _e = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  re.Content,
  {
    ref: a,
    sideOffset: e,
...
const fo = "16rem", go = "3rem", Qn = u.createContext(void 0);
function Se() {
...
const tr = u.forwardRef(
  ({
    ...
    const [l, m] = u.useState(t), g = e ?? l, h = u.useCallback(
      (V) => {
        const A = typeof V == "function" ? V(g) : V;
        n ? n(A) : m(A);
      },
      [n, g]
    ), f = u.useCallback(() => h((V) => !V), [h]), b = g ? "expanded" : "collapsed", S = U() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = u.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Qn.Provider, { value: x, children: /* @__PURE__ */ r(an, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const bo = u.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Se();
  return /* @__PURE__ */ d(
    z,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(Kr, {}) : /* @__PURE__ */ r(Jr, {}),
...
const Fe = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Xt : "div",
  {
    ref: a,
...
const Co = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Xt : "button",
  {
    ref: a,
...
const _o = Ct(
  ...
  ({
    ...
    const p = t ? Xt : "button", { state: l } = Se(), m = /* @__PURE__ */ r(
      p,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: c(_o({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(_e, { side: "right", align: "center", hidden: l !== "collapsed", ...o })
    ] })) : m;
  }
);
...
const wn = Cn(
  ({ value: t, onSearch: e, placeholder: n, isFullWidth: a, className: o, isDisabled: s = !1 }, i) => {
    const w = U();
    return /* @__PURE__ */ d("div", { className: c("tw-relative", { "tw-w-full": a }, o), children: [
      /* @__PURE__ */ r(
        Sn,
        {
          className: c(
...
const yt = "scrBook", zo = "scrRef", Rt = "source", Oo = "details", Io = "Scripture Reference", Ao = "Scripture Book", ir = "Type", Po = "Details";
function Bo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? D.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === yt ? Jt(o.start) : void 0;
      },
...
}, Nn = (t) => `${jo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function yi({
  sources: t,
  ...
  const [p, l] = I([]), [m, g] = I([{ id: yt, desc: !1 }]), [h, f] = I({}), b = G(
  ...
  const k = Rn({
    ...
    getExpandedRowModel: wa(),
    getGroupedRowModel: ia(),
    getCoreRowModel: Vn(),
    getSortedRowModel: En(),
    getRowId: Nn,
    autoResetExpanded: !1,
    ...
    !e && /* @__PURE__ */ d(
      Bt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(zt, { position: "item-aligned", children: /* @__PURE__ */ r(Ha, { children: V.map((C) => /* @__PURE__ */ r(st, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
}), wr = (t, e, n) => ln(t, e).every((a) => n.includes(a));
function Fo({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
...
function Go({
  ...
  const s = ln(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], p = o["%scripture_section_dc_short%"], l = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
      ...
      onClick: () => a(t),
      className: c(
        wr(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Xo(
        t,
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var y;
        return /* @__PURE__ */ r(ue, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((y = o.get(v)) == null ? void 0 : y.localizedName) || D.bookIdToEnglishName(v) || v }, v);
      }),
...
function ki({
  ...
  const p = St(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), g = St(i, "%webView_scope_selector_current_book%"), h = St(i, "%webView_scope_selector_choose_books%"), f = St(i, "%webView_scope_selector_scope%"), b = St(i, "%webView_scope_selector_select_books%"), _ = [
...
function Ci({
  ...
  return /* @__PURE__ */ d(
    Bt,
    {
      ...
      children: [
        /* @__PURE__ */ r(Dt, { size: o, className: c("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          jt,
          {
            placeholder: i[P(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          zt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((p) => /* @__PURE__ */ r(st, { value: `${p}`, children: i[P(p)] }, `${p}`))
          }
        )
      ]
    }
...
const dr = (t, e, n, a) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(on, { children: [
  /* @__PURE__ */ r(sn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r($a, { children: /* @__PURE__ */ r(Hn, { children: dr(
      t,
      e,
      lr(t, w.id),
      a
...
function Le({
  ...
  return /* @__PURE__ */ d(Qe, { variant: s, children: [
    /* @__PURE__ */ r(Fn, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(z, { variant: i, size: "icon", children: a ?? /* @__PURE__ */ r(Zr, {}) }) }),
    /* @__PURE__ */ r(ve, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, l]) => typeof p == "boolean" || typeof l == "boolean" ? 0 : p.order - l.order).map(([p], l, m) => /* @__PURE__ */ d(_n, { children: [
      /* @__PURE__ */ r(Gn, { children: /* @__PURE__ */ r(an, { children: dr(e.groups, e.items, p, t) }) }),
      l < m.length - 1 && /* @__PURE__ */ r(xe, {})
    ] }, p)) })
  ] });
}
...
function Ri({
  ...
  return /* @__PURE__ */ d(cr, { className: `tw-w-full tw-border tw-bg-background ${s}`, id: o, children: [
    n && /* @__PURE__ */ r(
      Le,
      {
        onSelectMenuItem: t,
...
function Ei({
  ...
  return /* @__PURE__ */ r(cr, { className: `tw-pointer-events-none ${a}`, id: n, children: e && /* @__PURE__ */ r(
    Le,
    {
      onSelectMenuItem: t,
      menuData: e,
...
ur.displayName = et.List.displayName;
...
function Vi({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(pr, { children: [
      /* @__PURE__ */ r(ur, { children: t.map((i) => /* @__PURE__ */ r(Ho, { value: i.value, children: i.value }, i.key)) }),
...
const qo = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = lt();
  return /* @__PURE__ */ d(
    j.CheckboxItem,
    {
...
qo.displayName = j.CheckboxItem.displayName;
...
Ko.displayName = j.RadioItem.displayName;
const Jo = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: a,
    className: c("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Jo.displayName = j.Label.displayName;
...
const qt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((l) => l.group === s).sort((l, m) => l.order - m.order).map((l) => /* @__PURE__ */ d(on, { children: [
      /* @__PURE__ */ r(sn, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
        xr,
        {
          ...
          children: [
            l.iconPathBefore && /* @__PURE__ */ r(me, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
            l.label,
            l.iconPathAfter && /* @__PURE__ */ r(me, { icon: l.iconPathAfter, menuLabel: l.label })
          ]
        },
    ...
    return w.length > 0 && i < o.length - 1 && p.push(/* @__PURE__ */ r(yr, {}, `separator-${s}`)), p;
  });
};
function Wo({
  menuData: t,
  ...
  const o = Y(void 0), s = Y(void 0), i = Y(void 0), w = Y(void 0), p = Y(void 0), l = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (ca(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (_ = i.current) == null || _.focus(), qt(i, [h, f]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ r(hr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ d(Yo, { children: [
      /* @__PURE__ */ r(fr, { ref: l(m), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        vr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(an, { children: Nr(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
const ts = Cn(({ className: t, ...e }, n) => /* @__PURE__ */ r(ea, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
function Ii({
  ...
  return /* @__PURE__ */ d("div", { className: c("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": a }), children: [
    /* @__PURE__ */ r(
      L,
      {
        htmlFor: t,
...
), ns = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: c(es({ variant: e }), t), ...n }));
...
const as = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: c("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
ss.displayName = Ft.Image.displayName;
...
is.displayName = Ft.Fallback.displayName;
...
const cs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Ai = $.Root, Pi = $.Trigger, Bi = $.Group, ji = $.Portal, $i = $.Sub, Xi = $.RadioGroup, ms = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  $.SubTrigger,
  {
    ref: o,
    className: c(
...
ms.displayName = $.SubTrigger.displayName;
...
const fs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r($.Portal, { children: /* @__PURE__ */ r(
  $.Content,
  {
    ref: n,
    className: c(
...
const gs = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Item,
  {
    ref: a,
    className: c(
...
const bs = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ d(
  $.CheckboxItem,
  {
    ref: o,
    className: c(
...
const vs = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  $.RadioItem,
  {
    ref: a,
    className: c(
...
const Fi = wt.Trigger, Cs = wt.Portal, Gi = wt.Close, Cr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
...
const _s = u.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = u.useContext(kr), i = {
...
Ms.displayName = Kt.Root.displayName;
...
const Hi = et.Root, zs = u.forwardRef(({ className: t, ...e }, n) => {
  const a = U();
  return /* @__PURE__ */ r(
    et.List,
    {
...
const Bs = (t, e, n = {}) => {
  ...
  const o = Y(null), [s, i] = I(void 0), [w, p] = I(void 0), l = X(
    (h) => {
      i(h);
...
export {
  ...
  ts as Spinner,
  Ds as Switch,
  Le as TabDropdownMenu,
  Ei as TabFloatingMenuButton,
  Ri as TabToolbar,
  ye as Table,
  ke as TableBody,
  eo as TableCaption,
  ...
  Mi as getToolbarOSReservedSpaceClassName,
  ui as inventoryCountColumn,
  pi as inventoryItemColumn,
  mi as inventoryStatusColumn,
