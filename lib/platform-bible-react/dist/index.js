import sl, { jsx as s, jsxs as N, Fragment as Zt } from "react/jsx-runtime";
...
import ye, { clsx as ll } from "clsx";
...
import { ChevronRight as go, Check as Je, Circle as bo, X as vo, Search as fi, ChevronsUpDown as mi, FilterIcon as pl, ChevronDown as cr, ChevronUp as ul, ArrowLeftIcon as wl, ChevronLeftIcon as fl, ChevronRightIcon as ml, ArrowRightIcon as hl, CircleCheckIcon as gl, CircleXIcon as bl, CircleHelpIcon as vl, ArrowUpIcon as yl, ArrowDownIcon as xl, ArrowUpDownIcon as Nl, Star as kl, PanelLeft as El, PanelRight as Sl, ScrollText as Tl, ChevronLeft as Cl, LoaderCircle as Rl, Download as Ol, Filter as _l, User as Pl, Link as Il, CircleHelp as $l } from "lucide-react";
import { getChaptersForBook as Ml, deepEqual as yo, substring as Al, formatScrRef as Br, compareScrRefs as eo, scrRefToBBBCCCVVV as Vr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Dl, formatBytes as jl } from "platform-bible-utils";
...
import { useReactTable as gi, getFilteredRowModel as Bl, getSortedRowModel as bi, getPaginationRowModel as Vl, getCoreRowModel as vi, flexRender as gn, getGroupedRowModel as zl, getExpandedRowModel as Fl } from "@tanstack/react-table";
...
import { MenuItem as Xl, ListItemText as Yl, ListItemIcon as Ni, Menu as Hl, Grid as ki, List as ql, IconButton as Ei, Drawer as Wl } from "@mui/material";
...
const xo = ft.Root, Si = ft.Trigger, nc = ft.Group, qm = ft.Portal, Wm = ft.Sub, Km = ft.RadioGroup, rc = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  ft.SubTrigger,
  {
    ref: o,
    className: y(
...
rc.displayName = ft.SubTrigger.displayName;
...
oc.displayName = ft.SubContent.displayName;
...
const To = at.allBookIds.filter((t) => !at.isObsolete(at.bookIdToNumber(t))), yc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ba = ["OT", "NT", "DC"], xc = 96, Nc = [
  /^(\w+)$/i,
      ...
      pr,
      {
        ...
        children: /* @__PURE__ */ s("div", { className: "rtl:tw-ps-2", children: ba.map((j, M) => {
          ...
          return A.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ s(ur, { className: "tw-font-semibold tw-text-foreground/80", children: yc[j] }),
...
const Tc = Re(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? Ze : "button", { className: y(Tc({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const Cc = Re(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Dt = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(hi.Root, { ref: n, className: y("pr-twp", Cc(), t), ...e }));
...
const Rc = Wt.Portal, ji = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Wt.Overlay,
  {
    ref: n,
    className: y(
...
_c.displayName = Wt.Title.displayName;
const Pc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Wt.Description,
  {
    ref: n,
...
Pc.displayName = Wt.Description.displayName;
...
const Ic = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Separator,
  {
    ref: n,
...
Ic.displayName = Pt.Separator.displayName;
...
function Dc({ table: t }) {
  return /* @__PURE__ */ N(xo, { children: [
    /* @__PURE__ */ s(dl, { asChild: !0, children: /* @__PURE__ */ N(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ s(pl, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Le = vt.Root, jc = vt.Group, Ge = vt.Value, ke = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(
    vt.Trigger,
    {
...
const Vi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ s(ul, { className: "tw-h-4 tw-w-4" })
  }
));
...
const Bc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.Label,
  {
    ref: n,
...
Bc.displayName = vt.Label.displayName;
...
Vc.displayName = vt.Separator.displayName;
function zc({ table: t }) {
      ...
      /* @__PURE__ */ N(
        wt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s(ml, { className: "tw-h-4 tw-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ N(
        wt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s(hl, { className: "tw-h-4 tw-w-4" })
          ]
        }
      )
    ] })
...
const Fc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "tfoot",
  {
    ref: n,
...
const Lc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "caption",
  {
    ref: n,
...
}, Hc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Fi = Re(
...
), qc = E.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  yi.Root,
  {
    ref: o,
...
qc.displayName = yi.Root.displayName;
...
const gr = (t) => t === "asc" ? /* @__PURE__ */ s(yl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), eh = (t) => ({
  accessorKey: "item",
  ...
  return Xc(t).forEach((p) => {
    p.startsWith("\\id") && (i = Yc(p), l = 0, c = 0), p.startsWith("\\c") && (l = va(p), c = 0), p.startsWith("\\v") && (c = va(p), l === 0 && (l = e.chapterNum));
    ...
    for (; f; ) {
      ...
      const h = f.index, b = a.find((g) => yo(g.items, w)), m = {
        ...
        text: Al(p, Math.max(0, h - 25), Math.min(h + 25, p.length))
      };
      if (b)
...
function ah({
  ...
  const f = te(n, "%webView_inventory_all%"), w = te(n, "%webView_inventory_approved%"), h = te(n, "%webView_inventory_unapproved%"), b = te(n, "%webView_inventory_unknown%"), m = te(n, "%webView_inventory_scope_currentBook%"), g = te(n, "%webView_inventory_scope_chapter%"), k = te(n, "%webView_inventory_scope_verse%"), T = te(n, "%webView_inventory_filter_text%"), C = te(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = ut(!1), [P, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Rt(() => l ? r instanceof RegExp ? Jc(
    l,
    t,
    a,
    i,
          ...
          return /* @__PURE__ */ N(
            Io,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ s("div", { className: "tw-w-4", children: m.starred && /* @__PURE__ */ s(kl, { className: "tw-h-4 tw-w-4" }) }),
...
const Qc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  It.Trigger,
  {
    ref: n,
    ...e,
...
function ih({
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(Xi, { children: [
      /* @__PURE__ */ s(Yi, { children: t.map((i) => /* @__PURE__ */ s(Qc, { value: i.value, children: i.value }, i.key)) }),
...
const td = Rn.Provider, ed = Rn.Root, nd = Rn.Trigger, qi = E.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  Rn.Content,
  {
    ref: r,
    sideOffset: e,
...
const rd = "16rem", od = "3rem", Wi = E.createContext(void 0);
function br() {
...
const Ki = E.forwardRef(
  ({
    ...
    return /* @__PURE__ */ s(Wi.Provider, { value: T, children: /* @__PURE__ */ s(td, { delayDuration: 0, children: /* @__PURE__ */ s(
      "div",
      {
        style: (
...
const ad = E.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    wt,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ s(El, {}) : /* @__PURE__ */ s(Sl, {}),
...
const sd = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Qe,
  {
    ref: n,
    "data-sidebar": "input",
...
const dd = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Mo,
  {
    ref: n,
...
const pd = E.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? Ze : "button",
  {
    ref: r,
  ...
  ({
    ...
    const c = t ? Ze : "button", { state: d } = br(), p = /* @__PURE__ */ s(
      c,
      {
        ...
        "data-size": r,
        "data-active": e,
        className: y(ud({ variant: n, size: r }), a),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ s(nd, { asChild: !0, children: p }),
      /* @__PURE__ */ s(qi, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
ns.displayName = "SidebarMenuButton";
const wd = E.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ s(
  e ? Ze : "button",
  {
    ref: o,
...
const bd = E.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ s(
  t ? Ze : "a",
  {
    ref: a,
...
const ae = "scrBook", yd = "scrRef", me = "source", xd = "details", Nd = "Scripture Reference", kd = "Scripture Book", rs = "Type", Ed = "Details";
function Sd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, xa = (t) => `${Td({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function lh({
  sources: t,
    ...
    !e && /* @__PURE__ */ N(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(Ee, { position: "item-aligned", children: /* @__PURE__ */ s(jc, { children: C.map((R) => /* @__PURE__ */ s(Vt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ N(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ s(go, {}) : /* @__PURE__ */ s(Cl, {})),
                          " ",
...
var Sa;
function is() {
  return Sa || (Sa = 1, process.env.NODE_ENV === "production" ? Gn.exports = Od() : Gn.exports = _d()), Gn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function $d() {
  if (_a) return Wr;
  _a = 1;
  var t = is(), e = Pd(), n = /* @__PURE__ */ Do(), r = /* @__PURE__ */ ss(), o = /* @__PURE__ */ Id(), a = function() {
  };
...
function Ad() {
  ...
  if (Ia = 1, process.env.NODE_ENV !== "production") {
    var t = is(), e = !0;
    Ln.exports = /* @__PURE__ */ $d()(t.isElement, e);
  } else
    Ln.exports = /* @__PURE__ */ Md()();
  return Ln.exports;
}
var Dd = /* @__PURE__ */ Ad();
const u = /* @__PURE__ */ os(Dd);
function jd(t) {
  const {
    prototype: e = {}
  } = t;
...
function ls(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !jd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${i}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
var Aa;
function Ld() {
  return Aa || (Aa = 1, process.env.NODE_ENV === "production" ? Un.exports = zd() : Un.exports = Fd()), Un.exports;
}
var Da = Ld();
...
function fn() {
  const t = tp(On.create).current;
  return np(t.disposeEffect), t;
}
let vr = !0, po = !1;
const rp = new On(), op = {
  text: !0,
...
function ap(t) {
  ...
  return !!(n === "INPUT" && op[e] && !t.readOnly || n === "TEXTAREA" && !t.readOnly || t.isContentEditable);
}
function ip(t) {
...
function lp(t) {
  t.addEventListener("keydown", ip, !0), t.addEventListener("mousedown", Jr, !0), t.addEventListener("pointerdown", Jr, !0), t.addEventListener("touchstart", Jr, !0), t.addEventListener("visibilitychange", sp, !0);
}
function cp(t) {
  const {
    target: e
...
function ws() {
  const t = B.useCallback((o) => {
    o != null && lp(o.ownerDocument);
  }, []), e = B.useRef(!1);
  function n() {
    return e.current ? (po = !0, rp.start(100, () => {
      po = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
    return cp(o) ? (e.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: e,
    onFocus: r,
...
function pp(t, e = Number.MIN_SAFE_INTEGER, n = Number.MAX_SAFE_INTEGER) {
...
const up = ["values", "unit", "step"], wp = (t) => {
...
function fp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = St(t, up), a = wp(e), i = Object.keys(a);
  function l(w) {
...
function vs(t, e) {
  const n = bs(t.theme);
  return Object.keys(t).map((r) => Ep(t, e, r, n)).reduce(bn, {});
}
function gt(t) {
  return vs(t, Nr);
}
...
bt.filterProps = kr;
process.env.NODE_ENV !== "production" && Np.reduce((t, e) => (t[e] = ce, t), {});
function Sp(t = 8) {
  if (t.mui)
    return t;
  const e = bs({
...
const Tp = Ut("border", zt), Cp = Ut("borderTop", zt), Rp = Ut("borderRight", zt), Op = Ut("borderBottom", zt), _p = Ut("borderLeft", zt), Pp = Ut("borderColor"), Ip = Ut("borderTopColor"), $p = Ut("borderRightColor"), Mp = Ut("borderBottomColor"), Ap = Ut("borderLeftColor"), Dp = Ut("outline", zt), jp = Ut("outlineColor"), Sr = (t) => {
...
Er(Tp, Cp, Rp, Op, _p, Pp, Ip, $p, Mp, Ap, Sr, Dp, jp);
const Tr = (t) => {
...
Er(Tr, Cr, Rr, Bp, Vp, zp, Fp, Lp, Gp, Up, Xp, Yp);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const Hp = yt({
...
function Lo(t = {}, ...e) {
  ...
  return d.applyStyles = au, d = e.reduce((p, f) => ee(p, f), d), d.unstable_sxConfig = _({}, Fo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return Or({
      sx: f,
      theme: this
    });
...
const fu = Lo(), Ua = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Xn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function hu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Ul(i, (v) => v.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = mu(Ua(d))
    } = l, h = St(l, pu), b = p !== void 0 ? p : (
    ...
    const T = Ll(i, _({
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Kt(d || "")}`), D === void 0 && (D = `Styled(${Xd(i)})`), L.displayName = D;
      }
...
function Go(t, e = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (t < e || t > n) && console.error(`MUI: The value provided ${t} is out of range [${e}, ${n}].`), pp(t, e, n);
}
function vu(t) {
  t = t.slice(1);
...
function Xa(t) {
  t = Te(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Te(yu(t)).values : t.values;
...
const Sn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, Su = ["mode", "contrastThreshold", "tonalOffset"], Ha = {
...
function Iu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = St(t, Su), a = t.primary || Tu(e), i = t.secondary || Cu(e), l = t.error || Ru(e), c = t.info || Ou(e), d = t.success || _u(e), p = t.warning || Pu(e);
  function f(m) {
...
const Du = 0.2, ju = 0.14, Bu = 0.12;
function ht(...t) {
  return [`${t[0]}px ${t[1]}px ${t[2]}px ${t[3]}px rgba(0,0,0,${Du})`, `${t[4]}px ${t[5]}px ${t[6]}px ${t[7]}px rgba(0,0,0,${ju})`, `${t[8]}px ${t[9]}px ${t[10]}px ${t[11]}px rgba(0,0,0,${Bu})`].join(",");
}
const Vu = ["none", ht(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ht(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ht(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ht(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ht(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ht(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ht(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ht(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ht(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ht(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ht(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ht(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ht(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ht(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ht(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ht(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ht(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ht(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ht(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ht(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ht(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ht(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ht(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ht(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], zu = ["duration", "easing", "delay"], Fu = {
...
function Uu(t) {
  const e = _({}, Fu, t.easing), n = _({}, Lu, t.duration);
  return _({
...
const qu = (t) => Kn(t) && t !== "classes", In = hu({
  themeId: Xo,
  defaultTheme: Uo,
...
const Ku = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ju = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
  ...
  const r = Yo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, h = St(r, Ku), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), ew = /* @__PURE__ */ Cd(tw);
var Za;
function nw() {
...
function rw() {
  ...
  var e = t(/* @__PURE__ */ nw()), n = sl;
  return cn.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), cn;
}
var ow = /* @__PURE__ */ rw();
const aw = /* @__PURE__ */ os(ow);
function iw(t) {
  return typeof t == "string";
}
function mn(t, e, n) {
  return t === void 0 || iw(t) ? e : _({}, e, {
    ownerState: _({}, e.ownerState, n)
  });
}
const sw = {
  disableDefaultClasses: !1
}, lw = /* @__PURE__ */ B.createContext(sw);
function cw(t) {
  const {
...
function uw(t) {
  ...
  const i = dw(_({}, o, r)), l = ti(r), c = ti(o), d = e(i), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
  return p.length > 0 && (w.className = p), Object.keys(f).length > 0 && (w.style = f), {
    props: w,
    internalRef: d.ref
  };
}
const ww = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function fw(t) {
  var e;
  const {
    elementType: n,
...
const rr = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  return /* @__PURE__ */ s(B.Fragment, {
    children: i && /* @__PURE__ */ Kl.createPortal(r, i)
  });
});
...
process.env.NODE_ENV !== "production" && (rr.propTypes = Vd(rr.propTypes));
var Ot = "top", Lt = "bottom", Gt = "right", _t = "left", Ho = "auto", $n = [Ot, Lt, Gt, _t], He = "start", Tn = "end", vw = "clippingParents", Ss = "viewport", pn = "popper", yw = "reference", ei = /* @__PURE__ */ $n.reduce(function(t, e) {
  return t.concat([e + "-" + He, e + "-" + Tn]);
}, []), Ts = /* @__PURE__ */ [].concat($n, [Ho]).reduce(function(t, e) {
  return t.concat([e, e + "-" + He, e + "-" + Tn]);
}, []), xw = "beforeRead", Nw = "read", kw = "afterRead", Ew = "beforeMain", Sw = "main", Tw = "afterMain", Cw = "beforeWrite", Rw = "write", Ow = "afterWrite", _w = [xw, Nw, kw, Ew, Sw, Tw, Cw, Rw, Ow];
function Jt(t) {
...
function Mn(t) {
  for (var e = jt(t), n = ni(t); n && Mw(n) && re(n).position === "static"; )
    n = ni(n);
  return n && (Jt(n) === "html" || Jt(n) === "body" && re(n).position === "static") ? e : n || Aw(t) || e;
}
function Ko(t) {
...
function Bw(t) {
  ...
  if (!(!a || !i)) {
    var f = jw(o.padding, n), w = Wo(a), h = c === "y" ? Ot : _t, b = c === "y" ? Lt : Gt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], g = i[c] - n.rects.reference[c], k = Mn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - g / 2, S = f[h], v = T - w[p] - f[b], P = T / 2 - w[p] / 2 + C, F = vn(S, P, v), R = c;
...
function ai(t, e, n) {
  return e === Ss ? wo(Ww(t, n)) : Ce(e) ? Jw(e, n) : wo(Kw(de(t)));
}
function Zw(t) {
...
function Qw(t, e, n, r) {
  var o = e === "clippingParents" ? Zw(t) : [].concat(e), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, d) {
    var p = ai(t, d, r);
...
function Cn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? vw : l, d = n.rootBoundary, p = d === void 0 ? Ss : d, f = n.elementContext, w = f === void 0 ? pn : f, h = n.altBoundary, b = h === void 0 ? !1 : h, m = n.padding, g = m === void 0 ? 0 : m, k = _s(typeof g != "number" ? g : Ps(g, $n)), T = w === pn ? yw : pn, C = t.rects.popper, S = t.elements[b ? T : w], v = Qw(Ce(S) ? S : S.contextElement || de(t.elements.popper), c, p, i), P = We(t.elements.reference), F = $s({
    reference: P,
    element: C,
    placement: o
...
function nf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, h = n.flipVariations, b = h === void 0 ? !0 : h, m = n.allowedAutoPlacements, g = e.options.placement, k = qt(g), T = k === g, C = c || (T || !b ? [Zn(g)] : ef(g)), S = [g].concat(C).reduce(function(z, K) {
      return z.concat(qt(K) === Ho ? tf(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
...
function wf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, h = w === void 0 ? !0 : w, b = n.tetherOffset, m = b === void 0 ? 0 : b, g = Cn(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = qt(e.placement), T = Ke(e.placement), C = !T, S = Ko(k), v = uf(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    ...
    if (l) {
      var pe, Tt = S === "x" ? Ot : _t, jn = S === "x" ? Lt : Gt, Yt = P[v], _e = v === "y" ? "height" : "width", ue = Yt + g[Tt], Pe = Yt - g[jn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (pe = D == null ? void 0 : D[v]) != null ? pe : 0, we = Ie ? ue : Yt - F[_e] - R[_e] - $e + L.altAxis, en = Ie ? Yt + F[_e] + R[_e] - $e - L.altAxis : Pe, Bn = h && Ie ? Dw(we, Yt, en) : vn(h ? we : ue, Yt, h ? en : Pe);
      P[v] = Bn, tt[v] = Bn - Yt;
    }
...
function bf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && gf(e), a = de(e), i = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Qo(a)) && (l = hf(e)), Ft(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Zo(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = yf(Nf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (ci(T, C)) {
            p.rects = {
              reference: bf(T, Mn(C), p.options.strategy === "fixed"),
              popper: Wo(C)
...
var Ef = [Yw, pf, Uw, $w, cf, rf, ff, zw, af], Sf = /* @__PURE__ */ kf({
  defaultModifiers: Ef
});
const Tf = "Popper";
function Cf(t) {
...
const If = () => Bo({
  root: ["root"]
}, cw(Cf)), $f = {}, Mf = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, g = St(e, Rf), k = B.useRef(null), T = Se(k, n), C = B.useRef(null), S = Se(C, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
  }, [S]), B.useImperativeHandle(w, () => C.current, []);
  const P = _f(p, i), [F, R] = B.useState(P), [I, L] = B.useState(ar(o));
  B.useEffect(() => {
...
`));
  ...
  const tt = If(), J = (r = b.root) != null ? r : "div", j = fw({
    elementType: J,
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, T = St(e, Of), [C, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
...
`));
      } else if (!e || typeof e.getBoundingClientRect != "function" || Pf(e) && e.contextElement != null && e.contextElement.nodeType !== 1)
...
var Df = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.shape({
  enter: u.number,
  exit: u.number,
  appear: u.number
}).isRequired]) : null;
...
const zf = {
  ...
  } = e, k = St(e, Vf), T = fn(), C = B.useRef(), S = As(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
ir.muiSupportAuto = !0;
const Ff = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Lf = In(Ms, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ys(), a = Yo({
    ...
    slots: C,
    slotProps: S
  } = a, v = St(a, Ff), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const ie = gs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), Uf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Xf(t) {
  return Math.round(t * 1e5) / 1e5;
}
const Yf = (t) => {
...
const js = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = Yo({
    ...
    TransitionProps: kt
  } = P, V = St(P, Uf), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
...
`));
  ...
  const na = (et) => {
    ...
    Ws(et), oa.current === !1 && (aa(!1), ra(et));
  }, sa = (et) => {
    Tt || jn(et.currentTarget), Ks(et), oa.current === !0 && (aa(!0), Mr(et));
  }, la = (et) => {
    ue.current = !0;
    const $t = xt.props;
  ...
  const tl = Se(xt.ref, Js, jn, n);
  !dt && dt !== 0 && (Qt = !1);
  const Ar = B.useRef(), el = (et) => {
    const $t = xt.props;
...
`));
  ...
  const on = {};
  M || (Bt.onTouchStart = Zs, Bt.onTouchEnd = Qs), J || (Bt.onMouseOver = qn(ca, Bt.onMouseOver), Bt.onMouseLeave = qn(da, Bt.onMouseLeave), Pe || (on.onMouseOver = ca, on.onMouseLeave = da)), tt || (Bt.onFocus = qn(sa, Bt.onFocus), Bt.onBlur = qn(ia, Bt.onBlur), Pe || (on.onFocus = sa, on.onBlur = ia)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const nl = B.useMemo(() => {
    var et;
    let $t = [{
    ...
    touch: ue.current
  }), jr = Yf(an), pa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : Hf, ua = (a = (i = (l = Q.transition) != null ? l : I.Transition) != null ? i : $) != null ? a : ir, wa = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : qf, fa = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : Wf, rl = mn(pa, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ye(jr.popper, Y == null ? void 0 : Y.className, (h = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : h.className)
  }), an), ol = mn(ua, _({}, kt, (m = Z.transition) != null ? m : L.transition), an), al = mn(wa, _({}, (g = Z.tooltip) != null ? g : L.tooltip, {
    className: ye(jr.tooltip, (k = (T = Z.tooltip) != null ? T : L.tooltip) == null ? void 0 : k.className)
  }), an), il = mn(fa, _({}, (C = Z.arrow) != null ? C : L.arrow, {
  ...
  return /* @__PURE__ */ N(B.Fragment, {
    children: [/* @__PURE__ */ B.cloneElement(xt, Bt), /* @__PURE__ */ s(pa, _({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(wa, _({}, al, {
          children: [dt, F ? /* @__PURE__ */ s(fa, _({}, il, {
            ref: _e
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Xl,
    {
      ...
      children: n ? /* @__PURE__ */ N(Zt, { children: [
        wi(a, n, !0),
        /* @__PURE__ */ s(Yl, { primary: n, inset: !a && o }),
        f ? /* @__PURE__ */ s(Ni, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(aw, {}) }) : wi(i, n, !1)
      ] }) : g
    }
  );
...
const Jf = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function zs(t) {
  ...
  return /* @__PURE__ */ N(
    ki,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ s(ql, { id: n, dense: !0, className: a ?? "", children: /* @__PURE__ */ s(
          Zf,
          {
            commandHandler: t,
            menuDefinition: e,
...
const An = lr(({ className: t, ...e }, n) => /* @__PURE__ */ s(Rl, { size: 35, className: y("tw-animate-spin", t), ...e, ref: n }));
...
function om({ ...t }) {
  return /* @__PURE__ */ s(mt.Menu, { ...t });
}
function am({ ...t }) {
  return /* @__PURE__ */ s(mt.Sub, { "data-slot": "menubar-sub", ...t });
}
...
Ls.displayName = mt.Root.displayName;
...
Gs.displayName = mt.Trigger.displayName;
const Us = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    mt.SubTrigger,
    {
...
Us.displayName = mt.SubTrigger.displayName;
const Xs = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Oe();
  return /* @__PURE__ */ s(
    mt.SubContent,
    {
...
Xs.displayName = mt.SubContent.displayName;
const Ys = E.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: r = 8, ...o }, a) => {
  const i = Oe();
  return /* @__PURE__ */ s(mt.Portal, { children: /* @__PURE__ */ s(
    mt.Content,
    {
      ref: a,
      align: e,
...
Ys.displayName = mt.Content.displayName;
...
const im = E.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    mt.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ s("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(mt.ItemIndicator, { children: /* @__PURE__ */ s(Je, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
im.displayName = mt.CheckboxItem.displayName;
const sm = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ N(
    mt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ s("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(mt.ItemIndicator, { children: /* @__PURE__ */ s(bo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
sm.displayName = mt.RadioItem.displayName;
const lm = E.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ s(
  mt.Label,
  {
    ref: r,
    className: y("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
lm.displayName = mt.Label.displayName;
const qs = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  mt.Separator,
  {
    ref: n,
    className: y("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
qs.displayName = mt.Separator.displayName;
function cm({
  menuProvider: t,
  commandHandler: e,
  variant: n
  ...
  const [r] = sr(
    ...
    var c;
    return (c = Object.entries(i).find(
      ([, d]) => "menuItem" in d && d.menuItem === l
    )) == null ? void 0 : c[0];
  }, a = (i, l, c) => {
    if (!c) return;
    const d = Object.entries(i).filter(
      ([p, f]) => "column" in f && f.column === c || p === c
    ).sort(([, p], [, f]) => p.order - f.order);
    return d.flatMap(([p], f) => {
      const w = l.filter((b) => b.group === p).sort((b, m) => b.order - m.order).map(
        (b) => "command" in b ? /* @__PURE__ */ s(
          Hs,
          {
            onClick: () => {
              e(b);
          ...
          b.command
        ) : /* @__PURE__ */ N(am, { children: [
          /* @__PURE__ */ s(Us, { children: b.label }),
          /* @__PURE__ */ s(Xs, { children: a(i, l, o(i, b.id)) })
        ] }, b.id)
      ), h = [...w];
      return w.length > 0 && f < d.length - 1 && h.push(/* @__PURE__ */ s(qs, {}, `${p}-separator`)), h;
    });
  };
  if (r)
    return /* @__PURE__ */ s(Ls, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(r.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, l]) => typeof i == "boolean" || typeof l == "boolean" ? 0 : i.order - l.order).map(([i, l]) => /* @__PURE__ */ N(om, { children: [
      /* @__PURE__ */ s(Gs, { children: typeof l == "object" && "label" in l && l.label }),
      /* @__PURE__ */ s(Ys, { children: a(r.groups, r.items, i) })
    ] }, i)) });
}
function hh({
  menuProvider: t,
...
), pm = E.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: y(dm({ variant: e }), t), ...n }));
...
um.displayName = "AlertTitle";
const wm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: y("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
wm.displayName = "AlertDescription";
const fm = Re(
...
function mm({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ s("div", { className: y("pr-twp", fm({ variant: e }), t), ...n });
}
...
bm.displayName = "CardTitle";
const vm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
Nm.displayName = wn.Root.displayName;
const km = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ s(
    ro.Root,
    {
...
km.displayName = ro.Root.displayName;
const bh = It.Root, Em = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ s(
    It.List,
    {
...
Em.displayName = It.List.displayName;
...
Sm.displayName = It.Trigger.displayName;
const Tm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  It.Content,
  {
    ref: n,
    className: y(
...
Tm.displayName = It.Content.displayName;
function vh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ s(
    wt,
    {
      ...
      children: t ? /* @__PURE__ */ s(An, { size: 15 }) : /* @__PURE__ */ N(Zt, { children: [
        /* @__PURE__ */ s(Ol, { size: 25, className: y("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function kh({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: y("pr-twp tw-prose", n), children: /* @__PURE__ */ s(Zl, { options: o, children: e }) });
}
const Cm = lr((t, e) => /* @__PURE__ */ N(
  wt,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ s(_l, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ s(
        cr,
        {
...
var Rm = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Rm || {});
function Eh({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ N(xo, { children: [
    /* @__PURE__ */ s(Si, { asChild: !0, children: /* @__PURE__ */ s(Cm, {}) }),
    /* @__PURE__ */ s(pr, { children: e.map((n) => /* @__PURE__ */ N("div", { children: [
      /* @__PURE__ */ s(ur, { children: n.label }),
      /* @__PURE__ */ s(nc, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(No, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(Ci, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(wr, {})
    ] }, n.label)) })
  ] }) });
}
function Sh({ id: t, message: e }) {
      ...
      children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ s(Pl, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ N("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ N(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ s(Il, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ N(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ s($l, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function Om({ id: t, versionHistory: e }) {
...
function Ch({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ N("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ s(Om, { versionHistory: o }),
...
function Rh({
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ s("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ N(mm, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ s(
          wt,
          {
            variant: "ghost",
...
export {
  ...
  um as AlertTitle,
  Qm as BOOK_SELECTOR_STRING_KEYS,
  mm as Badge,
  Zm as BookChapterControl,
