...
var Ht = (t, e, r) => Li(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Me, a as Ua, C as ze, A as pe, P as Pe, b as er, B as H, d as Ve, e as Le, f as Fe, h as Te, i as Fi, k as ji, j as Bi, E as Ui, l as Ka, r as ye, m as Ki, n as wn, o as ta, p as ea, L as zt, R as qa, q as Gr, D as Ca, s as Ea, t as Ta, u as Sa, T as un, v as Lr, w as Lt, x as Ga, y as Ft, z as jt, F as Bt, G as pn, H as Ha, I as Ze, J as Nr, K as je, M as Be, N as Ue, S as Cr, O as sr, Q as qi, U as Sr, V as tr, W as $e, Z as rr, X as Oe, Y as cr, _ as Ya, $ as Wa, a0 as Hr, a1 as Xa, a2 as hn, a3 as Gi, a4 as Hi, a5 as Yi, a6 as za, a7 as gn, a8 as ra, a9 as fn, aa as Wi, ab as Xi, ac as Ji, ad as Zi, ae as mn, af as Qi, ag as ca, ah as yo, ai as la, aj as ts, ak as es, al as rs, am as as, an as os, ao as zr, ap as Ja, aq as ns, ar as is } from "./resizable-C3AVzTx2.js";
import { as as ig, at as sg, au as cg, av as lg, aw as dg, ax as wg, ay as ug, az as pg, aA as hg, aB as gg, aC as fg, aD as mg, aE as vg, aF as bg, aG as xg, aH as yg, aI as kg, aJ as _g, aK as Ng, aL as Cg, aM as Eg, aN as Tg, aO as Sg, aP as zg, aQ as Rg } from "./resizable-C3AVzTx2.js";
...
import { Section as ut, getChaptersForBook as Fs, formatScrRef as Ce, getSectionForBook as yr, formatRelativeDate as js, formatReplacementString as Qe, sanitizeHtml as Qa, NumberFormat as Nn, formatBytes as Bs, getCurrentLocale as Us, usfmMarkers as Fr, getFormatCallerFunction as Ks, deepEqual as qs, isString as Co, compareScrRefs as Oa, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as Gs, getLocalizeKeyForScrollGroupId as Eo, formatReplacementStringToArray as To, collectUsjMarkers as Hs } from "platform-bible-utils";
import re, { useRef as j, useMemo as $, useState as N, useCallback as L, useEffect as X, useImperativeHandle as Ys, useLayoutEffect as ae, createContext as to, useContext as Cn, Component as Ws, createElement as So, Suspense as Xs, forwardRef as En, useId as zo, Fragment as aa } from "react";
...
import { Avatar as oo, Select as Wt, Checkbox as Oo, Slot as Dr, Tabs as he, Menubar as ke, ContextMenu as It, Progress as $o, Slider as Or, Switch as Io } from "radix-ui";
import { useReactTable as jn, getFilteredRowModel as el, getSortedRowModel as Bn, getPaginationRowModel as rl, getCoreRowModel as Un, flexRender as kr, getGroupedRowModel as al, getExpandedRowModel as ol } from "@tanstack/react-table";
import nl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Aa, HIDDEN_NOTE_CALLER as Pa, getDefaultViewOptions as il, isInsertEmbedOpOfType as $r, Editorial as sl, getMarkerMenuItems as cl, defaultStyleInfo as ll } from "@eten-tech-foundation/platform-editor";
...
function pa({
  ...
  const B = ye(), [R, A] = N(!1), [P, S] = N(""), [V, Y] = N(""), [y, rt] = N("books"), [F, Z] = N(void 0), [D, M] = N(
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((it) => {
      x[it] = Jt[it].filter((Vt) => Ka(Vt, V, n));
    }), x;
  }, [Jt, V, n]), z = $(
    () => vl(V, Kt, n),
    [V, Kt, n]
  ...
  const { otLong: ie, ntLong: Zt, dcLong: T, extraLong: U } = {
    ...
    (x) => {
      var Ne, Re, Ye;
      if (x.ctrlKey) return;
      const { isLetter: W, isDigit: it } = Po(x.key);
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, kl = Yn ? ae : X, Ar = { tag: eo };
...
const Nl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : X;
...
const Rl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : X;
function Dl(t) {
    ...
    w.read(() => {
      ...
      if ((R || A) && O !== null && B !== null) {
        const P = function(S, V, Y, y, rt, F, Z) {
          ...
          return D.setStart(...jo(V, Y, y)), D.setEnd(...jo(rt, F, Z)), D;
        }(t, h, f, O, g, E, B);
        l(), l = Al(t, P, e);
      }
...
let Wr, Ee = 0, Xr = 0, Gl = 0, La = 0, Br = 0;
function Uo(t) {
  if (lt === void 0) return;
  let e = t.n;
...
function Yl(t) {
  ...
  Jn(this), lt = t, this.f &= -2, 8 & this.f && co(this), na();
}
function ir(t, e) {
...
Yt.prototype.brand = Kl, Yt.prototype.h = function() {
  return !0;
  ...
  if (this.g = Br, this.f |= 1, this.i > 0 && !Xn(this)) return this.f &= -2, !0;
  const t = lt;
  try {
    Ko(this), lt = this;
    const e = this.x();
  ...
  return lt = t, Jn(this), this.f &= -2, !0;
...
le({ build: (t, e, r) => mr(e), config: ar({ $onClear: Qn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
le({ name: "@lexical/extension/DecoratorText", nodes: () => [ei], register: (t, e, r) => t.registerCommand(In, (o) => {
  const n = oe();
...
const Fa = le({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const lo = 0, ja = 1, oi = 2, ma = 3, Pr = 4, or = 5, va = 6, br = 7;
function ba(t) {
  return t.id === lo;
}
function ni(t) {
...
const ed = le({ config: ar({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = td }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [yc, Dn, kc, _c, Rn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function rd(t) {
  throw t;
...
const ad = /* @__PURE__ */ new Set(), Yo = le({ build(t, e, r) {
  const o = r.getDependency(Fa).output, n = Tr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ri(() => {
  }, () => xe(() => {
...
}, dependencies: [Fa], name: "@lexical/extension/NodeSelection" }), od = Cc("INSERT_HORIZONTAL_RULE_COMMAND");
class ur extends $a {
  static getType() {
...
le({ dependencies: [Fa, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
...
le({ build: (t, e, r) => mr(e), config: ar({ $canIndent: ii, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return xe(() => {
    if (!o.value) return sd(t, n, i);
  });
} });
const cd = le({ name: "@lexical/react/ReactProvider" });
function ld() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (be(f)) {
                ...
                if (Ia(m) && d >= 0 && w >= 0 && (E = d, _ = d + w, f.setTextNodeRange(m, E, m, _)), E === _ && p === "" || (f.insertRawText(p), m = b.getNode()), Ia(m)) {
                  E = h, _ = h + g;
...
le({ build: (t, e, r) => mr(e), config: ar({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => xe(() => r.getOutput().disabled.value ? void 0 : ci(t)) });
function ud(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : X;
...
const vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : X;
function bd({ onClear: t }) {
  const [e] = _e();
  return vd(() => ti(e, t), [e, t]), null;
}
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : X;
...
function sp({
  ...
  const [i, s] = N(Ad), [c, l] = N(n), [d, w] = N(!1), p = j(void 0), h = j(null);
  X(() => {
    let m = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : ho(m) && (m.preventDefault(), m.stopPropagation(), ce(i) && g());
        },
        onKeyDown: (m) => {
...
function Qo({
    ...
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (R) => {
              R.stopPropagation(), d(!0), p($d(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Fd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(jd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (R) => {
                R.key === "Escape" ? (R.preventDefault(), R.stopPropagation(), g()) : ho(R) && (R.preventDefault(), R.stopPropagation(), ce(w) && f());
              },
              onKeyDown: (R) => {
                po(R), (R.key === "Enter" || R.key === " ") && R.stopPropagation();
              },
              onClick: (R) => {
                R.stopPropagation();
              },
        ...
        B && /* @__PURE__ */ u(je, { children: [
          /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ps, {}) }) }),
...
function xi({
  ...
  const [y, rt] = N(tn), [F, Z] = N(), [D, M] = N(), J = o, [at, At] = N(!1), [Mt, Ut] = N(!1), [q, nt] = N(!1), [pt, ct] = N(!1), [ft, Xt] = N(!1), [Nt, yt] = N(O), [vt, Jt] = N(!1), Kt = j(void 0), [Pt, z] = N(/* @__PURE__ */ new Map());
  X(() => {
    let k = !0;
    return (async () => {
  ...
  const qt = $(() => Ct[0], [Ct]), qe = j(null), de = j(void 0), we = L(() => {
    var k;
    (k = de.current) == null || k.call(de), rt(tn);
  }, []), Ge = L(() => {
    const k = !Nt;
          ...
          o && /* @__PURE__ */ u(dt, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    at ? /* @__PURE__ */ a(fs, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            ...
            m !== !1 && (!Mt || ce(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (k) => {
                  ho(k) && (k.preventDefault(), k.stopPropagation(), (ce(y) || F !== void 0 && F !== D) && ot());
                },
                onKeyDown: (k) => {
                  po(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Jr,
...
function Kd({
  ...
  const [s, c] = N("accept"), l = zo(), d = zo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = $(
    () => Kr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = $(
    () => Kr(t.acceptedText ?? ""),
    ...
    if (e === "Resolved") {
      for (let _ = o.length - 1; _ >= 0; _ -= 1)
        if (o[_].status === "Resolved")
          return vi(o[_].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function fp({
  ...
  const S = r.filter(
    ...
    [_, b]
  ), { listboxRef: rt, activeId: F, handleKeyDown: Z } = qi({
    options: V,
    onOptionSelect: Y
  }), D = L(
    (M) => {
      ...
      children: S.map((M) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: M.type === "Conflict" ? /* @__PURE__ */ a(Wd, { ...J, conflictResolution: E }) : /* @__PURE__ */ a(xi, { ...J })
          },
          M.id
        );
      })
...
function gr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Wt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Wt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Tn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ew({
  ...
  var R;
  const [w, p] = N([]), [h, g] = N([]), [f, b] = N({}), [m, E] = N({}), _ = $(() => e ?? [], [e]), C = jn({
    data: _,
    columns: t,
    getCoreRowModel: Un(),
  ...
  return l ? B = Array.from({ length: 10 }).map((S, V) => `skeleton-row-${V}`).map((S) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((R = C.getRowModel().rows) == null ? void 0 : R.length) > 0 ? B = C.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Ya, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Wa, { stickyHeader: i, children: C.getHeaderGroups().map((A) => /* @__PURE__ */ a(Oe, { children: A.headers.map((P) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : kr(P.column.columnDef.header, P.getContext()) }, P.id)) }, A.id)) }),
...
function kp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(je, { children: [
    ...
    /* @__PURE__ */ a(Ue, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(hn, { children: d.itemType === 0 ? /* @__PURE__ */ a(dt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        $e,
        {
          checked: o[w][h],
...
function sw(t, e, r) {
  var o;
  return yi(t) || t.key === "Shift" || t.key === "Control" || t.key === "Alt" || t.key === "Meta" ? "passed" : t.ctrlKey || t.metaKey || t.altKey ? (r.dismiss(), "ended") : t.key === "ArrowDown" || t.key === "ArrowUp" ? (nr(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue") : t.key === "Enter" ? (nr(t), r.commit(), "ended") : t.key === "Escape" ? (nr(t), r.dismiss(), "ended") : e.kind === "backslash" && (t.key === " " || t.key === "*") ? t.key === " " && ((o = e.shouldSpaceCommit) != null && o.call(e, e.filter)) ? (nr(t), r.commit(), "ended") : (r.dismiss(), "ended") : e.kind === "backslash" && t.key === "Backspace" && e.filter === "" ? (r.dismiss(), "ended") : t.key === "Backspace" || iw[e.kind].test(t.key) ? (e.kind !== "backslash" && nr(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && nr(t), r.dismiss(), "ended");
}
function rn(t, e) {
  var r;
...
const ww = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(dt, { children: [
...
function uw({
  ...
  return /* @__PURE__ */ u(je, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: ww(t, n, r) }) }) }),
...
const pw = (t, e) => t === "f" ? /* @__PURE__ */ u(dt, { children: [
  /* @__PURE__ */ a(kn, {}),
  " ",
...
function gw({
  ...
  return /* @__PURE__ */ u(je, { children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: pw(t, r) }) }) }),
      /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ a("p", { children: hw(t, r) }) })
    ] }) }),
...
function Ep({
  ...
  X(() => {
    ...
    if (Q && $r("note", Q)) {
      ...
      let K = "custom";
      G === Aa ? K = "generated" : G === Pa ? K = "hidden" : G && (O(G), R(G)), m(K), _(K), P(((k = Q.insert.note) == null ? void 0 : k.style) ?? "f"), T = setTimeout(() => {
        var ht, gt, kt;
        const st = Jt.current === "editable" ? [{ retain: Cw }, Q] : [Q];
  ...
  const z = L(
    (T, U, ot = !1) => {
      ...
      if (Q && $r("note", Q)) {
        if (Q.insert.note) {
          let K;
          T === "custom" ? K = U : T === "generated" ? K = Aa : K = Pa, Q.insert.note.caller = K;
        }
  ...
  const qe = () => {
    ...
    if (U && $r("note", U)) {
      ...
      A !== "x" && T === "x" ? K == null || K.forEach((st) => kw(st)) : A === "x" && T !== "x" && (K == null || K.forEach((st) => _w(st))), (G = p.current) == null || G.applyUpdate([U, { delete: 1 }]);
    }
  }, Et = (T) => {
    ...
    (T, U, ot) => {
      ...
      Xt.current = {
        ...
        var K;
        rn(Xt, G), tt || (K = p.current) == null || K.focus();
      });
    },
    [w]
  );
  X(() => {
    ...
    if (((Q = vt.view) == null ? void 0 : Q.markerMode) === "editable") {
      const tt = (G) => {
        var kt, _t, Qt, ge, te;
        if (yi(G) || !T || document.activeElement !== T) return;
        const K = Xt.current;
        if (K && w) {
          sw(G, K, w) === "ended" && (Xt.current = void 0);
          return;
        }
        if (G.key === "Enter" && !Pt()) {
        ...
        if (!st) return;
        const ht = cl(vt.styleInfo ?? ll, st);
  ...
  return /* @__PURE__ */ u(dt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(dt, { children: Ew(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Xa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { className: o, children: zw(c.text) })
        ]
      },
...
const Dw = (t) => {
  ...
  return e ? e[1] : "";
}, Ow = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ip = Object.freeze([
...
function Ap({
  ...
  }, [A, Z]), M = $(() => D.length === 0 ? [] : $w(D, S, Y), [D, S, Y]), J = $(() => {
    var pt, ct;
    if (!A) return l;
...
const Aw = "16rem", Pw = "3rem", Ni = re.createContext(void 0);
function sa() {
  const t = re.useContext(Ni);
  if (!t)
    ...
    Lw,
    {
      ...
      children: /* @__PURE__ */ u(jw, { children: [
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(Bw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Uw, { children: /* @__PURE__ */ a(
            qw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const De = "scrBook", Hw = "scrRef", Je = "source", Yw = "details", Ww = "Scripture Reference", Xw = "Scripture Book", Ci = "Type", Jw = "Details";
function Zw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, ln = (t) => `${Qw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Jp({
  sources: t,
  ...
  X(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const Y = b.find((y) => ln(y) === V[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, E]);
  const _ = n ?? Xw, C = i ?? Ci, O = [
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(Jd, { children: O.map((S) => /* @__PURE__ */ a(ue, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
                    ...
                    children: y.getIsGrouped() ? /* @__PURE__ */ u(
                      H,
                      {
                        ...
                        children: [
                          ...
                          !S.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Da, {}) : /* @__PURE__ */ a(Ra, {})),
                          " ",
...
function Qp({
  ...
  const O = $t(
    ...
    [r, n, f, i]
  ), se = nt.find((I) => I.value === t), Ot = () => t === "selectedBooks" && n.length > 0 ? n.map((I) => I.toUpperCase()).join(", ") : t === "range" ? Gs(ct, ft, {
  ...
  const [Dt, Tt] = N(null), [St, mt] = N(null), [Gt, fe] = N(null), We = 200, [Ii, Ai] = N(!1);
  X(() => {
    if (!Gt || typeof ResizeObserver > "u") return;
    const I = new ResizeObserver(([et]) => {
      Ai(et.contentRect.width < We);
    });
  ...
  }, []), xo = (I) => t === I ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ie, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
        ...
        /* @__PURE__ */ a(
          Ue,
          {
            ...
            children: /* @__PURE__ */ u(ca, { container: Gt, children: [
              Rt.map(({ value: I, label: et, dropdownLabel: ee, scrRefSuffix: vr, id: Pi }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: Re(I),
    ...
    d === "radio" && t === "range" && Vt,
    d === "dropdown" && ne && /* @__PURE__ */ a(Ca, { open: U === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: mt,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(ca, { container: St, children: [
          /* @__PURE__ */ a(Ta, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: Y }) }),
          _t,
          /* @__PURE__ */ u(yo, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Mr(!1), children: at }),
            /* @__PURE__ */ a(H, { onClick: vo, children: J })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && ie && /* @__PURE__ */ a(Ca, { open: U === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: Tt,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(ca, { container: Dt, children: [
          ...
          /* @__PURE__ */ u(yo, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Mr(!1), children: at }),
            /* @__PURE__ */ a(H, { ref: qt, onClick: vo, children: J })
          ] })
        ] })
      }
    ) })
...
function Ba({
  ...
  return /* @__PURE__ */ u(je, { variant: i, children: [
    /* @__PURE__ */ a(Be, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(H, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(As, {}) }) }),
    /* @__PURE__ */ a(Ue, { align: "start", style: { zIndex: rr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(Lt, { children: zi(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(tr, {})
    ] }, l)) })
  ] });
}
const Ri = re.forwardRef(
...
const Di = re.forwardRef(({ className: t, ...e }, r) => {
  const o = ye();
  return /* @__PURE__ */ a(
    he.Root,
    {
...
const Mi = re.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.List,
  {
    ref: r,
    className: v(
...
const nu = re.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
...
)), Oi = re.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Content,
  {
    ref: r,
    className: v(
...
function ih({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Di, { children: [
      /* @__PURE__ */ a(Mi, { children: t.map((c) => /* @__PURE__ */ a(nu, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (dl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(iu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(su, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: rr },
          children: /* @__PURE__ */ a(Lt, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Xh({
  ...
  return /* @__PURE__ */ a(
    he.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Eu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function rg(t) {
  const e = $(() => Hs(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const zu = () => {
  const [t, e] = N(
...
export {
  ...
  au as SELECT_BOOKS_STRING_KEYS,
  Qp as ScopeSelector,
