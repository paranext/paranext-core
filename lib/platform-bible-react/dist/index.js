...
import { X as Ue, Search as Vn, Check as Ct, ChevronsLeft as gn, ChevronsRight as bn, ChevronLeft as Pe, ChevronRight as Pt, ArrowLeft as Br, ArrowRight as zr, Circle as fe, ChevronsUpDown as Ke, FilterIcon as jr, ChevronDown as ge, ChevronUp as $r, ArrowLeftIcon as Lr, ChevronLeftIcon as Xr, ChevronRightIcon as Fr, ArrowRightIcon as Gr, Copy as Hr, Filter as Yr, User as Ur, Link as Kr, CircleHelp as qr, Star as Jr, CircleCheckIcon as Wr, CircleXIcon as Zr, CircleHelpIcon as Qr, ArrowUpIcon as ta, ArrowDownIcon as ea, ArrowUpDownIcon as na, PanelLeft as ra, PanelRight as aa, ScrollText as oa, MenuIcon as sa, Menu as ia, EllipsisVertical as wa, LoaderCircle as la } from "lucide-react";
import { clsx as da } from "clsx";
import { extendTailwindMerge as ca } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { getLocalizedBookName as At, getLocalizedBookId as qe, Section as P, ALL_ENGLISH_BOOK_NAMES as Vt, doesBookMatchQuery as Je, getChaptersForBook as pa, ALL_BOOK_IDS as ua, getSectionLongName as Mn, formatScrRef as Wt, getSectionForBook as Zt, NumberFormat as ma, formatBytes as ha, deepEqual as We, isString as Te, compareScrRefs as Be, scrRefToBBBCCCVVV as Ee, getSectionShortName as fa, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
...
import { useReactTable as In, getFilteredRowModel as ga, getSortedRowModel as On, getPaginationRowModel as ba, getCoreRowModel as An, flexRender as Qt, getGroupedRowModel as va, getExpandedRowModel as xa } from "@tanstack/react-table";
import * as L from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as ya } from "@radix-ui/react-dropdown-menu";
import * as K from "@radix-ui/react-select";
import Na from "markdown-to-jsx";
...
import { useHotkeys as ka } from "react-hotkeys-hook";
...
const Ra = ft.Portal, zn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
const Ta = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
...
Ta.displayName = ft.Content.displayName;
...
Ea.displayName = ft.Title.displayName;
...
Va.displayName = ft.Description.displayName;
...
var Ma = Object.defineProperty, Da = (t, e, n) => e in t ? Ma(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => Da(t, typeof e != "symbol" ? e + "" : e, n);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
const it = class V {
  ...
  static fromJSON(e) {
    ...
    let p;
    return i && (p = new Tt(i)), n ? new V(n, a.toString(), w, p) : new V();
  }
  /**
   ...
   */
  get book() {
    return G.bookNumberToId(this.bookNum, "");
  }
  set book(e) {
    this.bookNum = G.bookIdToNumber(e);
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Tt(mt[i]);
        } catch {
    ...
    if (a.length !== 2 || G.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !V.isVerseParseable(a[1]))
      throw new Kt("Invalid reference : " + e);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > G.lastBook ? 2 : (G.isCanonical(this._bookNum), 0);
  }
  setEmpty(e = V.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = e;
  }
  updateInternal(e, n, a) {
    this.bookNum = G.bookIdToNumber(e), this.chapter = n, this.verse = a;
  }
};
...
const Yn = Ye(
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ l(
          ...
          {
            ref: c,
            value: p || `${t} ${G.bookIdToEnglishName(t)}`,
            onSelect: g,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
            "aria-label": `${G.bookIdToEnglishName(t)} (${t.toLocaleUpperCase()})`,
            className: s,
            children: [
              i && /* @__PURE__ */ r(
                Ct,
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Lt : "button", { className: d(Fa({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
function di({
  ...
  const i = et(), [w, p] = I(!1), [c, m] = I(""), [g, h] = I(""), [f, b] = I("books"), [v, x] = I(void 0), [C, y] = I(!1), M = nt(void 0), z = nt(void 0), W = nt(void 0), Y = nt(void 0), gt = nt({}), k = H(() => a ? a() : ua, [a]), T = H(() => ({
    [P.OT]: k.filter((O) => G.isBookOT(O)),
    [P.NT]: k.filter((O) => G.isBookNT(O)),
    [P.DC]: k.filter((O) => G.isBookDC(O)),
    [P.Extra]: k.filter((O) => G.extraBooks().includes(O))
    ...
    [f, j]
  ), { otLong: Z, ntLong: ot, dcLong: q, extraLong: bt } = {
    ...
    (N) => {
      ...
      if ((f === "chapters" || f === "books" && _) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key)) {
        ...
        vt !== st && (N.preventDefault(), N.stopPropagation(), m(Le(at, o, vt)), setTimeout(() => {
    ...
    const { isLetter: O, isDigit: J } = yn(N.key);
    (O || J) && (N.preventDefault(), h((at) => at + N.key), z.current.focus(), y(!1));
  }, []);
  return fn(() => {
    const N = setTimeout(() => {
      ...
      se,
      {
        ...
        children: [
          f === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            v && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: At(v, o) })
          ] }),
          !C && /* @__PURE__ */ l(we, { ref: W, children: [
            f === "books" && /* @__PURE__ */ l(te, { children: [
              ...
              _ && ht(_.book) > 1 && /* @__PURE__ */ l(te, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: At(_.book, o) }),
                /* @__PURE__ */ r(
                  Nn,
                  {
                    bookId: _.book,
...
), Q = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Dn.Root, { ref: n, className: d("pr-twp", Ua(), t), ...e }));
    ...
    en,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Q, { className: "tw-flex tw-items-center", children: a.map((x) => G.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            D,
            {
...
}), Un = L.Trigger, Kn = L.Group, Wa = L.Portal, Za = L.Sub, Qa = L.RadioGroup;
function rn({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(nn.Provider, { value: n, children: /* @__PURE__ */ r(L.Root, { ...e }) });
}
const qn = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    L.SubTrigger,
    {
...
qn.displayName = L.SubTrigger.displayName;
const Jn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  L.SubContent,
  {
    ref: n,
...
Jn.displayName = L.SubContent.displayName;
...
xe.displayName = L.Content.displayName;
const Wn = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = et(), s = ut();
  return /* @__PURE__ */ r(
    L.Item,
    {
...
Wn.displayName = L.Item.displayName;
const an = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    L.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
an.displayName = L.CheckboxItem.displayName;
const Zn = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ l(
    L.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(fe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Zn.displayName = L.RadioItem.displayName;
...
on.displayName = L.Label.displayName;
...
to.displayName = "DropdownMenuShortcut";
function eo({ table: t }) {
  return /* @__PURE__ */ l(rn, { children: [
    /* @__PURE__ */ r(ya, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const zt = K.Root, no = K.Group, jt = K.Value, ro = _t(
  ...
  return /* @__PURE__ */ l(
    K.Trigger,
    {
      className: d(ro({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
ao.displayName = K.Label.displayName;
...
oo.displayName = K.Separator.displayName;
function so({ table: t }) {
...
const kt = u.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a = !1, ...o }, s) => {
  ...
  const w = u.useMemo(
    ...
    (m) => {
      ...
      if (m.key === "ArrowDown" || m.key === "ArrowUp")
        m.preventDefault(), po(f, b, m.key);
      else if (m.key === "ArrowLeft" || m.key === "ArrowRight")
        m.preventDefault(), co(w, v, m.key);
...
function mo({
  ...
  var x;
  const [w, p] = I([]), [c, m] = I([]), [g, h] = I({}), [f, b] = I({}), v = In({
    data: e,
    columns: t,
    getCoreRowModel: An(),
    ...n && { getPaginationRowModel: ba() },
    onSortingChange: p,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(eo, { table: v }),
    /* @__PURE__ */ l(Ne, { stickyHeader: s, children: [
      /* @__PURE__ */ r(ke, { stickyHeader: s, children: v.getHeaderGroups().map((C) => /* @__PURE__ */ r(kt, { children: C.headers.map((y) => /* @__PURE__ */ r(ae, { children: y.isPlaceholder ? void 0 : Qt(y.column.columnDef.header, y.getContext()) }, y.id)) }, C.id)) }),
...
function mi({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = H(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Na, { options: o, children: e }) });
}
const ho = Object.freeze([
  "%webView_error_dump_header%",
  "%webView_error_dump_info_message%"
]), Cn = (t, e) => t[e] ?? e;
function fo({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
...
var go = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(go || {});
function gi({ id: t, label: e, groups: n }) {
  const [a, o] = I(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(rn, { children: [
    /* @__PURE__ */ r(Un, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "default", children: [
...
function bo({ id: t, versionHistory: e }) {
...
function vi({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(o).length > 0 && /* @__PURE__ */ r(bo, { versionHistory: o }),
...
const vo = _t(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", vo({ variant: e }), t), ...n })
);
  ...
  return /* @__PURE__ */ l(Ne, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Ce, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      kt,
      {
        ...
        children: [
          /* @__PURE__ */ r($t, { children: `${G.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
No.displayName = Pn.Root.displayName;
...
const pe = u.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const _e = (t) => t === "asc" ? /* @__PURE__ */ r(ta, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ea, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(na, { className: "tw-ms-2 tw-h-4 tw-w-4" }), yi = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Co = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ri = Object.freeze([
...
function Ti({
  ...
  const c = xt(n, "%webView_inventory_all%"), m = xt(n, "%webView_inventory_approved%"), g = xt(n, "%webView_inventory_unapproved%"), h = xt(n, "%webView_inventory_unknown%"), f = xt(n, "%webView_inventory_scope_currentBook%"), b = xt(n, "%webView_inventory_scope_chapter%"), v = xt(n, "%webView_inventory_scope_verse%"), x = xt(n, "%webView_inventory_filter_text%"), C = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, M] = I(!1), [z, W] = I("all"), [Y, gt] = I(""), [k, T] = I([]), rt = H(() => t.length === 0 ? [] : So(t, o, s), [t, o, s]), B = H(() => {
    if (y) return rt;
    const S = [];
    return rt.forEach((Z) => {
...
const Ro = "16rem", To = "3rem", ar = u.createContext(void 0);
function Re() {
...
const or = u.forwardRef(
  ({
    ...
    const [c, m] = u.useState(t), g = e ?? c, h = u.useCallback(
      ...
      [n, g]
    ), f = u.useCallback(() => h((M) => !M), [h]), b = g ? "expanded" : "collapsed", C = et() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = u.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
...
const Eo = u.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Re();
  return /* @__PURE__ */ l(
    D,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(ra, {}) : /* @__PURE__ */ r(aa, {}),
...
const Po = _t(
  ...
  ({
    ...
    const p = t ? Lt : "button", { state: c } = Re(), m = /* @__PURE__ */ r(
      p,
      {
        ref: w,
...
const jo = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
jo.displayName = "SidebarMenuSkeleton";
...
const Nt = "scrBook", Go = "scrRef", Et = "source", Ho = "details", Yo = "Scripture Reference", Uo = "Scripture Book", pr = "Type", Ko = "Details";
function qo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Nt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Yo,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? G.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === Nt ? Wt(o.start) : void 0;
      },
      getGroupingValue: (a) => G.bookIdToNumber(a.start.book),
    ...
    },
    {
      ...
      id: Ho,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Ko,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
}, Sn = (t) => `${Jo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Vi({
  sources: t,
    ...
    !e && /* @__PURE__ */ l(
      zt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ot, { position: "item-aligned", children: /* @__PURE__ */ r(no, { children: M.map((k) => /* @__PURE__ */ r(ct, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
...
}), ur = (t, e, n) => un(t, e).every((a) => n.includes(a));
function Wo({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = un(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], p = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    D,
    {
      variant: "outline",
...
function Zo({
  ...
  if (t.length !== G.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const Y = H(() => G.allBookIds.filter(
    (R, tt) => t[tt] === "1" && !G.isObsolete(G.bookIdToNumber(R))
  ), [t]), gt = H(() => {
    if (!y.trim()) {
      const U = {
        [P.OT]: [],
    ...
    (R, tt = !1) => {
      ...
      const U = Y.findIndex((q) => q === z.current), j = Y.findIndex((q) => q === R);
      if (U === -1 || j === -1) return;
      const [S, Z] = [
        Math.min(U, j),
        Math.max(U, j)
    ...
    (R) => {
      ...
      n(
        ur(Y, R, e) ? e.filter((U) => !tt.includes(U)) : [.../* @__PURE__ */ new Set([...e, ...tt])]
      );
    },
    [e, n, Y]
  ), _ = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Ie ? Ie : Rn
      ).map((R) => /* @__PURE__ */ r(me, { className: "hover:tw-bg-secondary", variant: "secondary", children: At(R, o) }, R)),
...
const hr = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ l(Za, { children: [
    /* @__PURE__ */ r(qn, { children: w.label }),
    /* @__PURE__ */ r(Wa, { children: /* @__PURE__ */ r(Jn, { children: hr(
      t,
      e,
      mr(t, w.id),
      a
...
function Tn({
  ...
  return /* @__PURE__ */ l(rn, { variant: s, children: [
    /* @__PURE__ */ r(Un, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(D, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(sa, {}) }) }),
...
vr.displayName = X.Root.displayName;
...
xr.displayName = X.Trigger.displayName;
...
yr.displayName = X.SubTrigger.displayName;
...
Nr.displayName = X.SubContent.displayName;
...
kr.displayName = X.Content.displayName;
...
Cr.displayName = X.Item.displayName;
...
ns.displayName = X.CheckboxItem.displayName;
...
rs.displayName = X.RadioItem.displayName;
...
as.displayName = X.Label.displayName;
...
const qt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, m) => c.order - m.order).map((c) => /* @__PURE__ */ l(dn, { children: [
...
function os({
  ...
  const o = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), p = nt(void 0), c = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (ka(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    var b, v, x, C;
    m.preventDefault();
    ...
    return /* @__PURE__ */ r(vr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ l(ts, { children: [
      /* @__PURE__ */ r(xr, { ref: c(m), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        kr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(ln, { children: Sr(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
const ws = Ye(({ className: t, ...e }, n) => /* @__PURE__ */ r(la, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), ds = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(ls({ variant: e }), t), ...n }));
...
const ps = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
us.displayName = Xt.Root.displayName;
...
hs.displayName = Xt.Fallback.displayName;
...
const vs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Gi = F.Root, Hi = F.Trigger, Yi = F.Group, Ui = F.Portal, Ki = F.Sub, qi = F.RadioGroup, Ns = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  F.SubTrigger,
  {
    ref: o,
    className: d(
...
Ns.displayName = F.SubTrigger.displayName;
...
ks.displayName = F.SubContent.displayName;
const Cs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(F.Portal, { children: /* @__PURE__ */ r(
  F.Content,
  {
    ref: n,
    className: d(
...
Cs.displayName = F.Content.displayName;
const _s = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  F.Item,
  {
    ref: a,
    className: d(
...
_s.displayName = F.Item.displayName;
const Ss = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ l(
  F.CheckboxItem,
  {
    ref: o,
    className: d(
...
const Rs = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  F.RadioItem,
  {
    ref: a,
    className: d(
...
Es.displayName = F.Separator.displayName;
...
Vs.displayName = "ContextMenuShortcut";
...
const Ji = pt.Trigger, Ds = pt.Portal, Wi = pt.Close, Tr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
const Is = u.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = u.useContext(Rr), i = {
...
const zs = u.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  je.Root,
  {
    ref: a,
    className: d(
...
const js = u.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ l(
    Jt.Root,
    {
...
const Qi = lt.Root, Ls = u.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    lt.List,
    {
...
Ls.displayName = lt.List.displayName;
...
Xs.displayName = lt.Trigger.displayName;
...
Fs.displayName = lt.Content.displayName;
const Gs = u.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
...
const Ys = (t, e, n = {}) => {
  ...
  a.current = e;
  const o = nt(n);
  o.current = Hs(o.current);
  const [s, i] = I(() => a.current), [w, p] = I(!0);
  return Mt(() => {
    let c = !0;
    return p(!!t), (async () => {
      if (t) {
  ...
  const o = nt(null), [s, i] = I(void 0), [w, p] = I(void 0), c = $(
    (h) => {
      i(h);
...
export {
  ...
  ms as AvatarImage,
  ci as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  pi as BOOK_SELECTOR_STRING_KEYS,
  me as Badge,
  ...
  we as CommandList,
  Gi as ContextMenu,
  Ss as ContextMenuCheckboxItem,
  Cs as ContextMenuContent,
  Yi as ContextMenuGroup,
  _s as ContextMenuItem,
  Ts as ContextMenuLabel,
  Ui as ContextMenuPortal,
  qi as ContextMenuRadioGroup,
  Rs as ContextMenuRadioItem,
  Es as ContextMenuSeparator,
  Vs as ContextMenuShortcut,
  Ki as ContextMenuSub,
  ks as ContextMenuSubContent,
  ...
  ho as ERROR_DUMP_STRING_KEYS,
  hi as ERROR_POPOVER_STRING_KEYS,
  fo as ErrorDump,
  fi as ErrorPopover,
  xi as Filter,
  gi as FilterDropdown,
  vi as Footer,
  Ri as INVENTORY_STRING_KEYS,
  ce as Input,
  Ti as Inventory,
  Q as Label,
  mi as MarkdownRenderer,
  bi as MoreInfo,
  xo as MultiSelectComboBox,
  zi as NavigationContentSearch,
  le as Popover,
  ...
  Ei as SettingsSidebarContentSearch,
  sr as Sidebar,
  ...
  Ci as getLinesFromUSFM,
  _i as getNumberFromUSFM,
