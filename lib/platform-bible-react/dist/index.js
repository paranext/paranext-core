...
import { c as v, g as Ne, a as Dr, C as je, u as Do, T as Bt, b as Ft, d as Ut, e as Kt, A as xe, P as We, f as dr, B as Y, h as Ye, i as Xe, j as Ze, k as Ve, x as ts, l as es, m as rs, I as as, n as so, r as Se, o as os, p as _n, q as ua, s as pa, L as zt, R as co, t as oa, D as Ba, v as Fa, w as Ua, y as Ka, z as Nn, E as Xr, F as lo, G as Cn, H as wo, J as cr, K as Pr, M as Je, N as Qe, O as tr, S as $r, Q as gr, U as ns, V as Lr, W as lr, X as He, Z as wr, Y as Ue, _ as fr, $ as uo, a0 as po, a1 as na, a2 as ho, a3 as En, a4 as is, a5 as ss, a6 as cs, a7 as Ha, a8 as Tn, a9 as ha, aa as ls, ab as Sn, ac as ds, ad as ws, ae as us, af as Mo, ag as ps, ah as hs, ai as gs, aj as fs, ak as Rn, al as zn, am as go, an as ms, ao as Dn, ap as Ca, aq as Oo, ar as Ea, as as vs, at as bs, au as xs, av as ys, aw as ks, ax as jr, ay as fo, az as _s, aA as Ns } from "./resizable-5NEfrGIS.js";
import { aB as $g, aC as Ag, aD as Vg, aE as Lg, aF as jg, aG as Bg, aH as Fg, aI as Ug, aJ as Kg, aK as Hg, aL as qg, aM as Gg, aN as Wg, aO as Yg, aP as Xg, aQ as Zg, aR as Jg, aS as Qg, aT as tf, aU as ef, aV as rf, aW as af, aX as of, aY as nf, aZ as sf, a_ as cf, a$ as lf, b0 as df, b1 as wf, b2 as uf, b3 as pf, b4 as hf, b5 as gf, b6 as ff, b7 as mf, b8 as vf, b9 as bf } from "./resizable-5NEfrGIS.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as qe, Clock as Io, ChevronsLeft as Po, ChevronsRight as $o, ChevronLeft as qa, ChevronRight as Ga, ArrowLeft as Cs, ArrowRight as Es, ChevronDown as br, BoldIcon as Ts, ItalicIcon as Ss, X as mo, AtSign as Mn, Pencil as Rs, Trash2 as zs, ArrowUp as On, MoreHorizontal as Ds, MailOpen as Ms, Mail as Os, ChevronUp as Is, FilterIcon as Ps, ArrowLeftIcon as $s, ChevronLeftIcon as As, ChevronRightIcon as Vs, ArrowRightIcon as Ls, Copy as In, Filter as js, User as Bs, Link as Fs, CircleHelp as Us, Undo as Ks, Redo as Hs, SquareX as Pn, FunctionSquare as $n, SquareSigma as An, Ban as qs, AlertCircle as Wa, CircleCheckIcon as Gs, CircleXIcon as Ws, CircleHelpIcon as Ys, ArrowUpIcon as Xs, ArrowDownIcon as Zs, ScrollText as Js, ChevronsUpDown as Qs, MenuIcon as tc, Menu as ec, EllipsisVertical as rc, MoreVertical as ac } from "lucide-react";
import { Section as Rt, getChaptersForBook as oc, formatScrRef as $e, formatReplacementString as Ke, getSectionForBook as Zr, formatRelativeDate as nc, sanitizeHtml as vo, NumberFormat as Vn, formatBytes as ic, getCurrentLocale as sc, usfmMarkers as Jr, deepEqual as Ln, isPlatformError as cc, ABORTED as lc, getErrorMessage as dc, getFormatCallerFunction as wc, isString as Ao, compareScrRefs as Ya, scrRefToBBBCCCVVV as Ta, defaultScrRef as Sa, formatScrRefRange as uc, getLocalizeKeyForScrollGroupId as Vo, formatReplacementStringToArray as Lo, collectUsjMarkers as pc } from "platform-bible-utils";
import ne, { useRef as U, useMemo as A, createContext as Br, useContext as ga, useState as k, useEffect as G, useCallback as j, useImperativeHandle as jn, useLayoutEffect as te, Component as hc, createElement as jo, Suspense as gc, forwardRef as Bn, useId as Bo, Fragment as xr } from "react";
import { IconSelector as Fn, IconCheck as fa, IconChevronDown as fc, IconChevronUp as mc, IconLayoutSidebar as vc, IconLayoutSidebarRight as bc, IconChevronRight as Un, IconSearch as xc, IconLoader as yc, IconAlertOctagon as kc, IconAlertTriangle as _c, IconInfoCircle as Nc, IconCircleCheck as Cc } from "@tabler/icons-react";
import { createEditor as Kn, $getRoot as Ge, $createParagraphNode as Fr, $getSelection as ie, HISTORY_MERGE_TAG as bo, ParagraphNode as Hn, TextNode as qn, $getPreviousSelection as Ec, $isRangeSelection as Ee, $caretFromPoint as Tc, $getSiblingCaret as Gn, $getChildCaret as Sc, $getAdjacentChildCaret as Rc, $isChildCaret as zc, $normalizeCaret as Dc, $setSelectionFromCaretRange as Mc, $getCollapsedCaretRange as Oc, $getCaretInDirection as Fo, $splitAtPointCaretNext as Ic, $isTextPointCaret as Pc, $findMatchingParent as Wn, $isElementNode as Ar, mergeRegister as Le, getDOMTextNode as $c, isHTMLElement as Ac, CLEAR_EDITOR_COMMAND as Yn, COMMAND_PRIORITY_EDITOR as xo, shallowMergeConfig as Vc, defineExtension as ge, safeCast as ur, createState as Lc, FORMAT_TEXT_COMMAND as Xn, $isNodeSelection as Zn, COMMAND_PRIORITY_LOW as Jn, RootNode as jc, LineBreakNode as Bc, TabNode as Fc, $isEditorState as Uc, createCommand as Kc, CLICK_COMMAND as Hc, isDOMNode as qc, $getNodeFromDOMNode as Gc, $createNodeSelection as Wc, $setSelection as Yc, $getEditor as Xc, DecoratorNode as Xa, $getState as Zc, toggleTextFormatType as Uo, TEXT_TYPE_TO_FORMAT as Jc, $setState as Qc, addClassNamesToElement as Qn, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as rl, KEY_TAB_COMMAND as al, $isBlockElementNode as ol, $createRangeSelection as nl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as Ko, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as yo, $isDecoratorNode as ll, $isParagraphNode as dl, $isTextNode as Za, SELECTION_CHANGE_COMMAND as ti, $insertNodes as wl } from "lexical";
...
import { Avatar as ko, Select as ee, Checkbox as Ho, Slot as Ur, Tabs as ye, Menubar as Re, ContextMenu as Ht, Progress as qo, Slider as Kr, Switch as Go } from "radix-ui";
import { useReactTable as ri, getFilteredRowModel as xl, getSortedRowModel as ai, getPaginationRowModel as yl, getCoreRowModel as oi, flexRender as Mr, getGroupedRowModel as kl, getExpandedRowModel as _l } from "@tanstack/react-table";
...
function ii({
  ...
  const g = U(!1), m = () => {
    ...
    () => Dr(e, l),
    [e, l]
  ), x = !!p && !w, E = `${b} (${z})`, $ = x ? h || `${E}, ${p}` : E, K = /* @__PURE__ */ u(
    je,
    {
      ref: t,
...
function Il({
  ...
  G(() => {
    var D;
    Ol();
    const Q = (D = $.current) == null ? void 0 : D.closest('button, [role="combobox"], [tabindex]');
    if (!Q) return;
    const _ = (W) => !!W && W.scrollWidth > W.clientWidth, et = () => {
      to !== "pointer" && (C || _(h.current) || _(l.current)) && E(!0);
    }, R = () => E(!1);
    return Q.addEventListener("focus", et), Q.addEventListener("blur", R), () => {
      Q.removeEventListener("focus", et), Q.removeEventListener("blur", R);
    };
  }, [C, h, l]);
  const B = j(() => {
    C && z(!0), m(), K && w();
  ...
  const S = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), N = K ? (
        ...
        children: [
          /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                P,
                P && I && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                I
              ]
            }
          ) }),
...
function Pl({
  ...
  const [h, g] = k(!1), m = w !== void 0, f = m ? w : h, b = (x) => {
    m || g(x), p == null || p(x);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(We, { open: f, onOpenChange: b, children: [
    /* @__PURE__ */ a(dr, { asChild: !0, children: /* @__PURE__ */ a(
      Y,
      {
        variant: d,
        size: "icon",
    ...
    /* @__PURE__ */ a(Ye, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ a(Ze, { children: /* @__PURE__ */ a(Ve, { heading: i, children: t.map((x) => /* @__PURE__ */ u(
      je,
      {
        onSelect: () => z(x),
...
function Ip(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
  ...
  const o = Al.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && l) {
          const g = ((m) => Object.keys(xe).find(
            (f) => xe[f].toLowerCase() === m.toLowerCase()
          ))(c);
...
function eo(t) {
  return {
    [Rt.OT]: t.filter((e) => jt.isBookOT(e)),
    [Rt.NT]: t.filter((e) => jt.isBookNT(e)),
    [Rt.DC]: t.filter((e) => jt.isBookDC(e)),
    [Rt.Extra]: t.filter((e) => jt.extraBooks().includes(e))
  };
}
function Bl(t, e) {
...
function di({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function za({
  ...
  const C = Se(), B = Ml(), [V, S] = k(!1), [N, P] = k(""), [I, Q] = k(""), [_, et] = k("books"), [R, D] = k(void 0), [W, st] = k(
    void 0
  ), [ot, pt] = k(void 0), [Ot, X] = k(!1), [ct, it] = k(!1), gt = U(null), vt = U(!1), Dt = U(void 0), _t = U(void 0), Xt = U(void 0), fe = U(void 0), se = U({}), re = U({}), Mt = j(
    (y) => {
      e(y), l && l(y);
    },
    [e, l]
    ...
    projectBooksBySection: It,
    reachableBooksBySection: Pt,
    reachableBooks: $t,
    projectBooks: de,
    ...
    () => Bl(le, ft),
    [le, ft]
  ), ae = kt.has(t.book), ce = A(() => I.trim() ? eo(
    $t.filter((y) => so(y, I, i))
  ) : ct ? Pt : It, [
    It,
    Pt,
  ...
  const bt = j(() => {
    ...
    (y) => {
      const rt = _ === "chapters" ? R : M == null ? void 0 : M.book;
      if (rt) {
        if (w && w(rt, y) > 1) {
          st(rt), pt(y), et("verses"), P("");
          return;
        }
        Mt({
          book: rt,
    ...
    et("books"), D(void 0), st(void 0), pt(void 0), setTimeout(() => {
      _t.current && _t.current.focus();
    }, 0);
  }, []), ue = j(() => {
    const y = W;
    st(void 0), pt(void 0), y ? (D(y), et("chapters"), P("")) : At();
  }, [W, At]), Gt = j(
    (y) => {
      S(y), y && (et("books"), D(void 0), st(void 0), pt(void 0), Q(""), it(ae));
    },
    [ae]
  );
  G(() => {
  ...
  const { otLong: Ct, ntLong: Wt, dcLong: ve, extraLong: Me } = {
    ...
    () => $e(
      t,
      i ? Ne(t.book, i) : "English"
    ),
    [t, i]
  ), or = A(
    () => B >= Or.TIGHT ? Dr(t.book, i) : Ne(t.book, i),
    [t.book, i, B]
  ), nr = `${t.chapterNum}:${t.verseNum}`, T = j((y) => (rt) => {
    se.current[y] = rt;
  }, []), F = j((y) => (rt) => {
    re.current[y] = rt;
  }, []), Z = A(
    () => Vl(I),
    [I]
  ), q = A(() => !w || !M || !M.chapterNum || !Z ? !1 : w(M.book, M.chapterNum) > 0, [w, M, Z]), J = _ === "books" && !Ot && !I.trim() && kt.size > 0, H = j(
    (y) => p ? Yo(y, p) : !1,
    [p]
  ), nt = j(
    (y) => (rt) => p ? Ll(y, rt, p) : !1,
    ...
    [p]
  ), mt = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", yt = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) || "Select verse", Vt = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", St = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", pe = j(
    (y) => Ke(St, {
      book: `${Ne(y, i)} (${Dr(
        y,
        i
    ...
    [St, i]
  ), Ie = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", ya = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", ka = j(
    (y) => {
    ...
    (y) => {
      ...
      if ((_ === "chapters" || _ === "verses") && (y.key === " " || y.key === "Enter")) {
        const wt = y.target instanceof HTMLElement ? y.target : void 0;
        if (!!(wt != null && wt.closest(
          'button, a, input, select, textarea, [role="button"]'
        ))) {
          y.stopPropagation();
          return;
        }
        const Yt = (Pe = Dt.current) == null ? void 0 : Pe.querySelector(
      ...
      if ((_ === "chapters" || _ === "verses") && (rt || at)) {
        y.preventDefault(), y.stopPropagation();
        return;
      }
      if (_ === "chapters" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), At();
        return;
      }
      ...
      if (_ === "verses" && oe) {
        ...
        switch (y.key) {
          case "ArrowLeft":
            Et !== 0 && (ke = Et > 1 ? Et - 1 : Yt);
            break;
          case "ArrowRight":
            Et !== 0 && (ke = Et < Yt ? Et + 1 : 1);
            break;
          case "ArrowUp":
            ke = Et === 0 ? Yt : Math.max(1, Et - Be);
            break;
          case "ArrowDown":
            ke = Et === 0 ? 1 : Math.min(Yt, Et + Be);
            break;
          default:
            return;
        }
        ke !== Et && (y.preventDefault(), y.stopPropagation(), P(
          `${wt} ${xe[wt] || ""} ${xt}:${ke}`
        ), setTimeout(() => {
          const Tr = re.current[ke];
          Tr && Tr.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((_ === "chapters" || _ === "books" && M) && oe) {
        const wt = _ === "chapters" ? R : M == null ? void 0 : M.book;
        if (!wt) return;
        _ === "chapters" && ((tt = Dt.current) == null || tt.focus());
        const xt = (() => {
          if (!N) return 1;
          const Be = N.match(/(\d+)$/);
        ...
        switch (y.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Et = xt === 0 ? Yt : Math.max(1, xt - ke);
            break;
          case "ArrowDown":
            Et = xt === 0 ? 1 : Math.min(Yt, xt + ke);
            break;
          default:
            return;
        }
        Et !== xt && (y.preventDefault(), y.stopPropagation(), P(
          `${wt} ${xe[wt] || ""} ${Et}`
        ), setTimeout(() => {
          const Be = se.current[Et];
    ...
    if (y.key === "ArrowUp" || y.key === "ArrowDown") {
      (oe = _t.current) == null || oe.focus();
      return;
    }
    const { isLetter: rt, isDigit: at } = Xo(y.key);
    (rt || at) && (y.preventDefault(), Q((Pe) => Pe + y.key), _t.current.focus(), X(!1));
  }, []);
  return te(() => {
    const y = setTimeout(() => {
      if (V && _ === "books" && Xt.current && fe.current) {
        const rt = Xt.current, at = fe.current, oe = at.offsetTop, Pe = rt.clientHeight, L = at.clientHeight, tt = oe - Pe / 2 + L / 2;
        rt.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), P(li(t.book));
    ...
    if (_ === "chapters" && R) {
      const y = R === t.book, rt = y ? t.chapterNum : 1;
      P(
        `${R} ${xe[R] || ""} ${rt}`
      ), setTimeout(() => {
        if (Xt.current)
  ...
  }, [_, R, M, t.book, t.chapterNum]), te(() => {
    if (_ === "verses" && W && ot !== void 0) {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(We, { open: V, onOpenChange: Gt, modal: x, children: [
    ...
    /* @__PURE__ */ a(
      Ye,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: rt } = y;
          V && gt.current && rt instanceof Node && gt.current.contains(rt) && (vt.current = !0, Gt(!1));
        },
        onCloseAutoFocus: z,
        children: /* @__PURE__ */ u(
          Xe,
          {
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: De.map(
                ...
                /* @__PURE__ */ a(
                  Y,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: _ === "verses" ? ue : At,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: C === "ltr" ? /* @__PURE__ */ a(Cs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Es, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                _ === "chapters" && R && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ne(R, i) }),
                _ === "verses" && W && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ne(W, i)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: _ === "verses" ? yt : mt
                  }
                )
              ] }),
              !Ot && /* @__PURE__ */ u(Ze, { ref: Xt, children: [
                _ === "books" && /* @__PURE__ */ u(ht, { children: [
                  !M && Object.entries(ce).map(([y, rt]) => {
                    if (rt.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Ve, { heading: Oe(y), children: rt.map((at) => /* @__PURE__ */ a(
                          ii,
                          {
                            bookId: at,
                            onSelect: (oe) => we(oe),
                            section: Zr(at),
                            commandValue: `${at} ${xe[at]}`,
                            ref: at === t.book ? fe : void 0,
                            localizedBookNames: i,
                            disabled: H(at),
                            dimmedReason: kt.has(at) ? Vt : void 0,
                            dimmedDescription: kt.has(at) ? pe(at) : void 0
                          },
                          at
                        )) }, y)
                      );
                  }),
                  M && /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(
                    je,
                    {
                  ...
                  M && q && M.chapterNum && w && /* @__PURE__ */ u(ht, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ne(M.book, i)} ${M.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Jo,
                      {
                        ...
                        onVerseSelect: Tt,
                        setVerseRef: F,
                        isVerseDisabled: dt(M.book, M.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  M && !q && mr(M.book) > 1 && /* @__PURE__ */ u(ht, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ne(M.book, i) }),
                      /* @__PURE__ */ a("span", { children: mt })
                    ] }),
                    /* @__PURE__ */ a(
                      Zo,
                      {
                        ...
                        setChapterRef: T,
                        isChapterDimmed: rr,
                        isChapterDisabled: nt(M.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                _ === "chapters" && R && /* @__PURE__ */ a(
                  Zo,
                  {
                    bookId: R,
                    scrRef: t,
                    onChapterSelect: Zt,
                    setChapterRef: T,
                    isChapterDisabled: nt(R),
                    className: "tw:p-4"
                  }
                ),
                _ === "verses" && W && ot !== void 0 && w && /* @__PURE__ */ a(
                  Jo,
                  {
                    bookId: W,
                    chapterNum: ot,
...
function Qo({
  ...
  const [E, $] = k(!1), K = d ?? l, C = (V) => V.length > 0 && typeof V[0] == "object" && "options" in V[0], B = (V, S) => {
    const N = l(V), P = typeof V == "object" && "secondaryLabel" in V ? V.secondaryLabel : void 0, I = `${S ?? ""}${N}${P ?? ""}`;
    return /* @__PURE__ */ u(
      je,
      {
        value: N,
  ...
  return /* @__PURE__ */ u(We, { open: E, onOpenChange: $, ...x, children: [
    /* @__PURE__ */ a(dr, { asChild: !0, children: /* @__PURE__ */ u(
      Y,
      {
        variant: m,
    ...
    /* @__PURE__ */ a(
      Ye,
      {
        ...
        children: /* @__PURE__ */ u(Xe, { children: [
          ...
          /* @__PURE__ */ a(pa, { children: g }),
          /* @__PURE__ */ a(Ze, { children: C(e) ? e.map((V) => /* @__PURE__ */ a(Ve, { heading: V.groupHeading, children: V.options.map((S) => B(S, V.groupHeading)) }, V.groupHeading)) : /* @__PURE__ */ a(Ve, { children: e.map((V) => B(V)) }) })
        ] })
      }
    )
  ] });
...
function Ap({
  ...
  const w = Da(d, "%webView_bookSelector_currentBook%"), p = Da(d, "%webView_bookSelector_choose%"), h = Da(d, "%webView_bookSelector_chooseBooks%"), [g, m] = k(
    "current book"
    /* CurrentBook */
  ), f = (b) => {
    m(b), t(b);
    ...
    co,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(zt, { className: "tw:flex tw:items-center", children: o.map((b) => jt.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ a(
            Y,
            {
...
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = ui ? te : G, qr = { tag: bo };
...
function ed() {
  return function(t) {
    const [e] = ze(), r = A(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = U(o);
    return Ql(() => {
...
function nd(t, e, r) {
  ...
  function l() {
    ...
    for (let z = 0; z < g.length; z++) {
      const x = g[z], E = s[z] || document.createElement("div"), $ = E.style;
      $.position !== "absolute" && ($.position = "absolute", b = !0);
      const K = Ce(x.left - p);
      $.left !== K && ($.left = K, b = !0);
      const C = Ce(x.top - h);
      $.top !== C && (E.style.top = C, b = !0);
      const B = Ce(x.width);
      $.width !== B && (E.style.width = B, b = !0);
      const V = Ce(x.height);
      $.height !== V && (E.style.height = V, b = !0), E.parentNode !== c && (c.append(E), b = !0), s[z] = E;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    d(), o = h, n = g, i = new MutationObserver((m) => {
      ...
      if (f !== o || b !== n) return p();
      for (const z of m) if (!c.contains(z.target)) return l();
    }), i.observe(g, od), l();
  });
  return () => {
    w(), d();
...
function sd(t, e = id) {
  ...
  function d(w) {
    w.read(() => {
      const p = ie();
      if (!Ee(p)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, g] = function(V) {
        const S = V.getStartEndPoints();
        return V.isBackward() ? [S[1], S[0]] : S;
      }(p), m = h.getNode(), f = m.getKey(), b = h.offset, z = g.getNode(), x = z.getKey(), E = g.offset, $ = t.getElementByKey(f), K = t.getElementByKey(x), C = r === null || $ !== o || b !== n || f !== r.getKey(), B = i === null || K !== s || E !== c || x !== i.getKey();
      if ((C || B) && $ !== null && K !== null) {
        const V = function(S, N, P, I, Q, _, et) {
          const R = (S._window ? S._window.document : document).createRange();
          return R.setStart(...tn(N, P, I)), R.setEnd(...tn(Q, _, et)), R;
        }(t, h, m, $, g, z, K);
        l(), l = nd(t, V, e);
      }
      r = m, o = $, n = b, i = z, s = K, c = E;
    });
  }
...
function ld(t) {
  const e = Wn(t, (r) => Ar(r) && !r.isInline());
  return Ar(e) || ia(4, t.__key), e;
}
function dd(t) {
  const e = ie() || Ec();
  let r;
  if (Ee(e)) r = Tc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Gn(c, "next"));
    }
    r = r || Sc(Ge(), "previous").getFlipped().insert(Fr());
  }
...
function wd(t, e, r) {
  ...
  return Pc(o) && ia(283), o.insert(t.isInline() ? Fr().append(t) : t), Fo(Gn(t.getLatest(), "next"), e.direction);
}
function ud(t) {
  const e = ie();
  if (!Ee(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Wn(i, (d) => Ar(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let sa, Ae = 0, ca = 0, gd = 0, ao = 0, ta = 0;
function rn(t) {
  if (lt === void 0) return;
  let e = t.n;
...
function md(t) {
  ...
  gi(this), lt = t, this.f &= -2, 8 & this.f && Co(this), va();
}
function hr(t, e) {
...
Qt.prototype.brand = pd, Qt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ae !== 0 && ca === 0 && e.l !== ao && (e.l = ao, sa = { S: e, v: e.v, i: e.i, o: sa });
    })(this), this.v = t, this.i++, ta++, Ae++;
    try {
...
} }), ir.prototype = new Qt(), ir.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === ta)) return !0;
  if (this.g = ta, this.f |= 1, this.i > 0 && !hi(this)) return this.f &= -2, !0;
  const t = lt;
  try {
    an(this), lt = this;
    const e = this.x();
...
}, ir.prototype.S = function(t) {
  if (this.t === void 0) {
    this.f |= 36;
    for (let e = this.s; e !== void 0; e = e.n) e.S.S(e);
  }
  Qt.prototype.S.call(this, t);
}, ir.prototype.U = function(t) {
...
}, Object.defineProperty(ir.prototype, "value", { get() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, fi(this), an(this), Ae++;
  const t = lt;
...
ge({ build: (t, e, r) => Er(e), config: ur({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
  return Te(() => o.disabled.value ? void 0 : t.registerRootListener((n) => {
    t.focus(() => {
...
function mi() {
  const t = Ge(), e = ie(), r = Fr();
  t.clear(), t.append(r), e !== null && r.select(), Ee(e) && (e.format = 0);
}
function vi(t, e = mi) {
  return t.registerCommand(Yn, (r) => (t.update(e), !0), xo);
}
ge({ build: (t, e, r) => Er(e), config: ur({ $onClear: mi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Te(() => vi(t, o.value));
} });
function vd(t) {
...
ge({ name: "@lexical/extension/DecoratorText", nodes: () => [bi], register: (t, e, r) => t.registerCommand(Xn, (o) => {
  const n = ie();
  if (Zn(n) || Ee(n)) for (const i of n.getNodes()) bd(i) && i.toggleFormat(o);
  return !1;
}, Jn) });
function xi(t, e) {
  let r;
...
const Eo = 0, no = 1, ki = 2, Ia = 3, Gr = 4, pr = 5, Pa = 6, Rr = 7;
function $a(t) {
  return t.id === Eo;
}
function _i(t) {
...
function xd(t) {
  return function(e) {
    return e.id === no;
  }(t) || ut(305, String(t.id), String(no)), Object.assign(t, { id: ki });
}
...
class kd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Gr && ut(307, String(r.id), String(pr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Gr;
    }(e) || ut(313, String(e.id), String(Gr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Rr;
    }(e) || ut(316, String(e.id), String(Rr)), e;
  }
...
const Nd = ge({ config: ur({ setOptions: on, updateOptions: on }), init: ({ $initialEditorState: t = _d }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class vr {
  ...
  static maybeFromEditor(e) {
    const r = e[nn];
    return r && (r.PACKAGE_VERSION !== Aa && ut(292, r.PACKAGE_VERSION, Aa), r instanceof vr || ut(293)), r;
  }
  static fromEditor(e) {
...
const Ed = /* @__PURE__ */ new Set(), cn = ge({ build(t, e, r) {
  const o = r.getDependency(oo).output, n = Vr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = xi(() => {
  }, () => Te(() => {
...
ge({ dependencies: [oo, cn], name: "@lexical/extension/HorizontalRule", nodes: () => [yr], register(t, e, r) {
  ...
  return Le(t.registerCommand(Td, (s) => {
    const c = ie();
    if (!Ee(c)) return !1;
    ...
    return !1;
  }, Jn), t.registerMutationListener(yr, (s, c) => {
    hd(() => {
      let l = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = g : (l = !0, d.set(w, { domNode: Vr(g), selectedSignal: o(w) }));
      }
      l && (n.value = { nodeSelections: d });
    });
  }), Te(() => {
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(Te(() => {
      const d = c.value;
...
ge({ build: (t, e) => Er({ inheritEditableFromParent: e.inheritEditableFromParent }), config: ur({ $getParentEditor: function() {
  const t = Xc();
  return vr.fromEditor(t), t;
}, inheritEditableFromParent: !1 }), init: (t, e, r) => {
  const o = e.$getParentEditor();
  t.parentEditor = o, t.theme = t.theme || o._config.theme;
}, name: "@lexical/extension/NestedEditor", register: (t, e, r) => Te(() => {
...
ge({ build: (t, e, r) => Er(e), config: ur({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Te(() => {
...
ge({ build: (t, e, r) => Er(e), config: ur({ $canIndent: Ni, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (Ee(m)) {
                const f = m.anchor;
                let b = f.getNode(), z = 0, x = 0;
                if (Za(b) && d >= 0 && w >= 0 && (z = d, x = d + w, m.setTextNodeRange(b, z, b, x)), z === x && p === "" || (m.insertRawText(p), b = f.getNode()), Za(b)) {
                  z = h, x = h + g;
                  const E = b.getTextContentSize();
                  z = z > E ? E : z, x = x > E ? E : x, m.setTextNodeRange(b, z, b, x);
                }
...
ge({ build: (t, e, r) => Er(e), config: ur({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Te(() => r.getOutput().disabled.value ? void 0 : Ei(t)) });
function Pd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function Zd({
  ...
  const [e] = ze(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = Xd(), l = () => {
  };
...
function Qd() {
  const { activeEditor: t } = Ri(), [e, r] = k([]), o = j((n) => {
    if (Ee(n) || ml(n)) {
      const i = [];
      wn.forEach(({ format: s }) => {
...
const ow = "verseText", Vp = Object.freeze([
...
function Lp({
  ...
  const [i, s] = k(nw), [c, l] = k(n), [d, w] = k(!1), p = U(void 0), h = U(null);
  G(() => {
    let b = !0;
    const z = h.current;
    if (!z) return;
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(We, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ye,
        {
          ...
          children: /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ a(Ze, { children: t.map((b) => /* @__PURE__ */ a(
            je,
            {
              onSelect: () => {
                l(b || void 0), w(!1);
...
function pn({
  ...
  }, [t.date, r]), b = A(() => t.user, [t.user]), z = A(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), x = A(() => vo(t.contents), [t.contents]), E = A(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), $ = !!t.conflictResolutionAction && !E, K = A(() => {
    if (o && c)
      return /* @__PURE__ */ u(ht, { children: [
        /* @__PURE__ */ u(
          cr,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(lw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(dw, { className: "tw:text-xs tw:font-medium", children: z }) }),
        ...
        K && /* @__PURE__ */ u(Je, { children: [
          /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(Y, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ds, {}) }) }),
...
function Vi({
  ...
  rootContentSlot: S,
  resolveActionSlot: N,
  spaceRootContentFromReplies: P = !1
}) {
  const [I, Q] = k(hn), [_, et] = k(), [R, D] = k(), W = o, [st, ot] = k(!1), [pt, Ot] = k(!1), [X, ct] = k(!1), [it, gt] = k(!1), [vt, Dt] = k(!1), [_t, Xt] = k($), [fe, se] = k(!1), re = U(void 0), [Mt, le] = k(/* @__PURE__ */ new Map());
  G(() => {
    let O = !0;
    return (async () => {
      const Ct = x ? await x(l) : !1;
      O && Dt(Ct);
    })(), () => {
      O = !1;
    };
  ...
  G(() => {
    if (!o) {
      ft.current !== "idle" && (et(void 0), D(void 0), ft.current = "idle");
      return;
    }
    ft.current === "idle" && (ft.current = "pending"), it ? ft.current === "pending" && B !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    B !== i && (et(B), ft.current = "auto-populated") : ft.current === "auto-populated" && (et(void 0), ft.current = "pending");
  }, [o, B, it, i]);
  const It = A(
    () => V ?? e.filter((O) => !O.deleted),
    [V, e]
  );
  G(() => {
    let O = !0;
  ...
  const Pt = A(() => It[0], [It]), $t = U(null), de = U(void 0), kt = j(() => {
    var O;
    (O = de.current) == null || O.call(de), Q(hn);
  }, []), ae = j(() => {
    const O = !_t;
  ...
  }, [i, r]), qt = A(() => It.slice(1), [It]), bt = A(() => qt.length ?? 0, [qt.length]), Tt = A(() => bt > 0, [bt]), we = A(() => st || bt <= 2 ? qt : qt.slice(-2), [qt, bt, st]), Zt = A(() => st || bt <= 2 ? 0 : bt - 2, [bt, st]), me = A(
    () => bt === 1 ? ce.singleReply : Ke(ce.multipleReplies, { count: bt }),
    [bt, ce]
  ), De = A(
    () => Zt === 1 ? ce.singleReply : Ke(ce.multipleReplies, { count: Zt }),
    [Zt, ce]
  );
  G(() => {
    !o && pt && Tt && Ot(!1);
  ...
  const At = j(
    async (O) => {
      ...
      Nt && await p({ threadId: l, contents: Nt }) && kt();
    },
    [
      kt,
      I,
    ...
    async (O) => {
      const Nt = he(I) ? da(I) : void 0, Ct = O.status ? O.assignedUser : _ ?? O.assignedUser, Wt = await p({
        ...O,
        contents: Nt,
        assignedUser: Ct
      });
      return Wt && (Ct !== void 0 && D(Ct), Nt && kt()), Wt;
    },
    [kt, I, p, _]
  );
  ...
  const Gt = /* @__PURE__ */ a(
    pn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Ot,
      canEditOrDelete: (!pt && Mt.get(Pt.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    sw,
    {
      ...
      className: v(
        ...
        {
          "tw:bg-primary-foreground": !o && w !== "Resolved" && _t,
          "tw:bg-background": o && w !== "Resolved" && _t,
          "tw:bg-muted": w === "Resolved",
          "tw:bg-accent": !_t && !o && w !== "Resolved"
        }
      ),
      onClick: () => {
        c(l);
      ...
      children: /* @__PURE__ */ u(cw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            M && /* @__PURE__ */ a(Pr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: M }),
            /* @__PURE__ */ a(
              Y,
              {
                variant: "ghost",
                ...
                "aria-label": _t ? r["%comment_aria_mark_as_unread%"] ?? "Mark as unread" : r["%comment_aria_mark_as_read%"] ?? "Mark as read",
                children: _t ? /* @__PURE__ */ a(Ms, {}) : /* @__PURE__ */ a(Os, {})
              }
            ),
            N === void 0 ? (
        ...
        /* @__PURE__ */ u(ht, { children: [
          ...
          !o && he(I) && /* @__PURE__ */ a(
            ...
            {
              editorSerializedState: I,
              onSerializedChange: (O) => Q(O),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(ht, { children: [
            P && we.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Zt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a($r, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: De }),
                    st ? /* @__PURE__ */ a(Is, {}) : /* @__PURE__ */ a(br, {})
                  ] })
                ]
              }
            ),
            we.map((O) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              pn,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: Ot,
                canEditOrDelete: (!pt && Mt.get(O.id)) ?? !1
              }
            ) }, O.id)),
            b !== !1 && (!pt || he(I)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (O) => {
                  zo(O) && (O.preventDefault(), O.stopPropagation(), (he(I) || _ !== void 0 && _ !== R) && At());
                },
                onKeyDown: (O) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    _ !== void 0 && (he(I) || _ !== R) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ke(
                    ...
                    /* @__PURE__ */ u(We, { open: X, onOpenChange: ct, children: [
                      /* @__PURE__ */ a(dr, { asChild: !0, children: /* @__PURE__ */ a(
                        Y,
                        {
                          ...
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !it || !f || f.length === 0 || !f.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        Ye,
                        {
                          ...
                          children: /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ a(Ze, { children: f == null ? void 0 : f.map((O) => /* @__PURE__ */ a(
                            je,
                            {
                              onSelect: () => {
                                et(O !== i ? O : void 0), ft.current = "user-selected", D(void 0), ct(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function pw({
  ...
  const [s, c] = k("accept"), l = Bo(), d = Bo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", m = p ? "accept" : s, f = A(
    () => ra(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = A(
    () => ra(t.acceptedText ?? ""),
  ...
  const E = (R) => {
    c(R === "reject" || R === "merge" ? R : "accept");
  }, $ = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", K = g ? [
    {
      value: "merge",
  ...
  let S;
  B ? S = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (S = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const N = e["%conflict_note_no_result%"] ?? "No result preview available.", P = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: N }), I = (R) => R ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: R }) : P, Q = () => {
    const R = o ?? "accept";
    return R === "merged" ? t.mergedText ? /* @__PURE__ */ a(aa, { html: z }) : P : I(R === "reject" ? t.rejectedResultText : t.resultText);
  }, _ = (R) => p && R.value === "reject", et = (R) => {
    const D = m === R.value, W = `${d}-${R.value}`, st = _(R);
    return (
        ...
        "label",
        {
          ...
          children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a("span", { "aria-hidden": !0, className: "tw:font-medium", children: R.label })
            ] }),
            ...
            /* @__PURE__ */ a("span", { id: l, className: "tw:sr-only", children: $ }),
            /* @__PURE__ */ a(aa, { html: R.html })
          ]
        },
        R.value
      )
  ...
  return (
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", onClick: (R) => R.stopPropagation(), children: [
      ...
      !w && !h && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(
          co,
          {
            ...
            children: C.map((R) => _(R) ? /* @__PURE__ */ a(Bt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
              /* @__PURE__ */ a(Ut, { asChild: !0, children: et(R) }),
...
function vw(t) {
  ...
  } = t, c = A(() => e.filter((z) => !z.deleted), [e]), l = A(
    () => c.find((z) => z.conflictType) ?? c[0],
    [c]
...
function Wp({
  ...
  const [x, E] = k(/* @__PURE__ */ new Set()), [$, K] = k(), [C, B] = k(), V = j(
    async (D) => {
      const W = await i(D);
      return W !== void 0 && D.assignedUser !== void 0 && D.assignedUser !== "" && B(D.assignedUser), W;
    },
    [i]
  );
  G(() => {
    m && (E((D) => new Set(D).add(m)), K(m));
  }, [m]);
  const S = r.filter(
    (D) => D.comments.some((W) => !W.deleted)
  ), N = S.map((D) => ({ id: D.id })), P = j(
    (D) => {
      E((W) => new Set(W).add(D.id)), K(D.id), f == null || f(D.id);
    },
    [f]
  ), I = j(
    (D) => {
      ...
      }), K(D), f == null || f(W ? void 0 : D);
    },
    [x, f]
  ), { listboxRef: Q, activeId: _, handleKeyDown: et } = ns({
    options: N,
    onOptionSelect: P
  }), R = j(
    (D) => {
      D.key === "Escape" ? ($ && x.has($) && (E((W) => {
        const st = new Set(W);
        return st.delete($), st;
      }), K(void 0), f == null || f(void 0)), D.preventDefault(), D.stopPropagation()) : et(D);
    },
    [$, x, et, f]
  );
  return /* @__PURE__ */ a(
      ...
      children: S.map((D) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: D.type === "Conflict" ? /* @__PURE__ */ a(vw, { ...W, conflictResolution: z }) : /* @__PURE__ */ a(Vi, { ...W })
          },
          D.id
        );
      })
...
function bw({ table: t }) {
  return /* @__PURE__ */ u(Je, { children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(Y, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      ...
      /* @__PURE__ */ u(
        kr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(Cr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(be, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Nw({
  ...
  var C;
  const [w, p] = k([]), [h, g] = k([]), [m, f] = k({}), [b, z] = k({}), x = A(() => e ?? [], [e]), E = ri({
    data: x,
    columns: t,
    getCoreRowModel: oi(),
  ...
  }), $ = E.getVisibleFlatColumns();
  let K;
  return l ? K = Array.from({ length: 10 }).map((S, N) => `skeleton-row-${N}`).map((S) => /* @__PURE__ */ a(Ue, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(fr, { colSpan: $.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(gr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((C = E.getRowModel().rows) == null ? void 0 : C.length) > 0 ? K = E.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    Ue,
    {
      onClick: () => s(B, E),
      "data-state": B.getIsSelected() && "selected",
      children: B.getVisibleCells().map((V) => /* @__PURE__ */ a(fr, { children: Mr(V.column.columnDef.cell, V.getContext()) }, V.id))
    },
    B.id
  )) : K = /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(fr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(bw, { table: E }),
    /* @__PURE__ */ u(uo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(po, { stickyHeader: i, children: E.getHeaderGroups().map((B) => /* @__PURE__ */ a(Ue, { children: B.headers.map((V) => /* @__PURE__ */ a(na, { className: "tw:p-0", children: V.isPlaceholder ? void 0 : Mr(V.column.columnDef.header, V.getContext()) }, V.id)) }, B.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(Y, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(In, {}) })
        ] }),
...
function Qp({
  ...
  return /* @__PURE__ */ u(We, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Ye, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function th({ id: t, label: e, groups: r }) {
  const [o, n] = k(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Je, { children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(Y, { variant: "default", children: [
...
const Rw = ["marker", "note-category"];
function zw(t, e) {
  let r = t.parentElement;
  for (; r && r !== e; ) {
    const { classList: o } = r;
    if (Rw.some((n) => o.contains(n))) return !0;
    r = r.parentElement;
  }
  return !1;
}
...
function Mw(t, e, r) {
  ...
  if (n.nodeType === Node.ELEMENT_NODE) {
    const d = n.childNodes[i], w = d ? Dw(d) : void 0;
    if (!w) return "end";
    n = w, i = 0;
  }
...
const $w = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ht, { children: [
...
function Aw({
  ...
  const n = U(null), i = U(null), s = U(!1), [c, l] = k(t), [d, w] = k(e), [p, h] = k(!1), g = U(!1), m = U(c);
  m.current = c;
  const f = U(d);
  f.current = d, G(() => {
    l(t);
  ...
  const b = (x) => {
    if (s.current = !1, h(x), !x) {
      const E = m.current, $ = f.current;
      E !== "custom" || $ ? (E !== t || $ !== e) && r(E, $) : (l(t), w(e));
    }
  }, z = (x) => {
    var E, $, K, C;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((E = n.current) == null || E.focus(), s.current = !0) : document.activeElement === n.current && x.key === "ArrowUp" ? (($ = i.current) == null || $.focus(), s.current = !1) : document.activeElement === n.current && x.key === "ArrowLeft" && ((K = n.current) == null ? void 0 : K.selectionStart) === 0 && ((C = i.current) == null || C.focus(), s.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === n.current) && b(!1);
  };
  return /* @__PURE__ */ u(Je, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(Y, { variant: "outline", className: "tw:h-6", children: $w(t, o, e) }) }) }),
...
const Vw = (t, e) => t === "f" ? /* @__PURE__ */ u(ht, { children: [
  /* @__PURE__ */ a($n, {}),
  " ",
...
function jw({
  ...
  return /* @__PURE__ */ u(Je, { children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(Y, { variant: "outline", className: "tw:h-6", children: Vw(t, r) }) }) }),
...
function Kw({
  ...
  return /* @__PURE__ */ u(Xe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ze, { children: [
      ...
      /* @__PURE__ */ a(Ve, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          mn,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(Ve, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            mn,
            {
...
function oh({
  ...
  var nr;
  const f = U(null), b = U(null), z = U(null), x = U(null), E = U(i);
  G(() => {
    E.current = i;
  }, [i]);
  const $ = U(h);
  ...
  const K = j(() => {
    var F, Z;
    const T = $.current;
    T !== void 0 && T !== "end" ? (F = f.current) == null || F.selectNoteTextOffset(0, T.utf16Offset) : (Z = f.current) == null || Z.selectNote(0);
  }, []);
  te(() => {
    if (w || !x.current) return;
    const { width: T } = x.current.getBoundingClientRect();
    T > 0 && (x.current.style.width = `${T}px`);
  }, [w]);
  const [C, B] = k("generated"), [V, S] = k("generated"), [N, P] = k("*"), [I, Q] = k("*"), [_, et] = k("f"), [R, D] = k(!1), [W, st] = k(!0), [ot, pt] = k(!1), Ot = U(!1), X = U(""), ct = U(void 0), [it, gt] = k(!1), [vt, Dt] = k(), [_t, Xt] = k(), [fe, se] = k(), [re, Mt] = k(), le = U(null), ft = U(
    void 0
  ), It = U(0), Pt = U(void 0), $t = A(
    () => ({
      ...s,
  ...
  G(() => {
    var T;
    it || (T = f.current) == null || T.focus();
  }, [_, it]);
  const kt = j(() => {
    var q, J, H;
    const T = (q = b.current) == null ? void 0 : q.querySelector(".editor-input"), F = T == null ? void 0 : T.querySelector("span.note"), Z = (H = (J = b.current) == null ? void 0 : J.ownerDocument.getSelection()) == null ? void 0 : H.anchorNode;
    return !!F && !!Z && F.contains(Z);
  }, []), ae = j(
    (T = !1) => {
      var Z, q, J;
      m == null || m();
      const F = (q = (Z = f.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : q.at(0);
      if (F && Sr("note", F) && (r == null || r([F]), T && d && E.current)) {
    ...
    (T, F) => {
      var J, H, nt;
      const Z = (H = (J = f.current) == null ? void 0 : J.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (!Z || !Sr("note", Z) || !Z.insert.note) return;
      let q;
      T === "custom" ? q = F : T === "generated" ? q = Ja : q = Qa, Z.insert.note.caller !== q && (Z.insert.note.caller = q, (nt = f.current) == null || nt.applyUpdate([Z, { delete: 1 }]));
    },
    []
  ), M = U(void 0), qt = U(ae);
  G(() => {
  ...
  G(() => {
    var J, H;
    let T, F, Z;
    Ot.current = !1, Pt.current = void 0, st(!0);
    const q = e == null ? void 0 : e.at(0);
    if (ct.current = q, q && Sr("note", q)) {
      const nt = (J = q.insert.note) == null ? void 0 : J.caller;
      let dt = "custom";
      nt === Ja ? dt = "generated" : nt === Qa ? dt = "hidden" : nt && (P(nt), Q(nt)), B(dt), S(dt), et(((H = q.insert.note) == null ? void 0 : H.style) ?? "f"), T = setTimeout(() => {
        var yt, Vt, St, pe;
        const mt = (Vt = (yt = f.current) == null ? void 0 : yt.getNoteOps(0)) == null ? void 0 : Vt.at(0);
        (St = f.current) == null || St.applyUpdate(mt ? [q, { delete: 1 }] : [q]), K(), (pe = f.current) == null || pe.focus(), F = requestAnimationFrame(() => {
          Z = setTimeout(() => {
            var Ie;
            kt() || (K(), (Ie = f.current) == null || Ie.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      Tt(), $.current = void 0, T && clearTimeout(T), F !== void 0 && cancelAnimationFrame(F), Z !== void 0 && clearTimeout(Z);
    };
  }, [e, Tt, kt, K]), te(() => () => Tt(), [Tt]);
  const Zt = j(() => {
    var T;
    M.current !== void 0 && (ft.current || (T = f.current) == null || T.commitPendingMarkerEdits(), Tt());
  }, [Tt]);
  jn(p, () => ({ flushPendingEdits: Zt }), [Zt]);
  const me = j(() => {
    var T;
    ft.current || (T = f.current) == null || T.commitPendingMarkerEdits(), w ? Tt() : (bt(), ae(!0)), o();
  }, [bt, Tt, w, o, ae]), De = U(me);
  te(() => {
    De.current = me;
  });
  const At = U({ book: n.book, chapterNum: n.chapterNum });
  te(() => {
    (At.current.book !== n.book || At.current.chapterNum !== n.chapterNum) && (At.current = { book: n.book, chapterNum: n.chapterNum }, De.current());
  }, [n.book, n.chapterNum]);
  const ue = () => {
    var F;
    const T = (F = b.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    T != null && T.textContent && navigator.clipboard.writeText(T.textContent);
  }, Gt = j(
    (T, F) => {
      m == null || m(), B(T), P(F), ce(T, F), w && Tt();
    },
    [ce, Tt, w, m]
  ), O = (T) => {
    var Z, q, J, H, nt;
    ...
    const F = (q = (Z = f.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : q.at(0);
    if (F && Sr("note", F)) {
      F.insert.note && (F.insert.note.style = T);
      const dt = (H = (J = F.insert.note) == null ? void 0 : J.contents) == null ? void 0 : H.ops;
      _ !== "x" && T === "x" ? dt == null || dt.forEach((mt) => Gw(mt)) : _ === "x" && T !== "x" && (dt == null || dt.forEach((mt) => Ww(mt))), (nt = f.current) == null || nt.applyUpdate([F, { delete: 1 }]);
    }
  }, Nt = (T) => {
    Mt(T.contextMarker), pt(T.canRedo);
  }, Ct = j(
    (T) => {
      var Z, q, J, H, nt;
      const F = (q = (Z = f.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : q.at(0);
      if (F && Sr("note", F)) {
        T.content.length > 1 && setTimeout(() => {
          var yt;
          (yt = f.current) == null || yt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const dt = (J = F.insert.note) == null ? void 0 : J.style, mt = (nt = (H = F.insert.note) == null ? void 0 : H.contents) == null ? void 0 : nt.ops;
        if (dt || D(!1), D(
          dt === "x" ? !!(mt != null && mt.every((yt) => {
            var St, pe;
            if (!((St = yt.attributes) != null && St.char)) return !0;
            const Vt = ((pe = yt.attributes) == null ? void 0 : pe.char).style;
          ...
          Ot.current = !0, X.current = JSON.stringify(F), st(!0);
          return;
        }
        st(JSON.stringify(F) === X.current), ae(), w && we();
      } else
        D(!1), st(!0);
    },
    [w, ae, we]
    ...
    if (z.current && de.length && T && T.rangeCount > 0) {
      const F = T.getRangeAt(0).getBoundingClientRect(), Z = z.current.getBoundingClientRect();
      Dt(F.left - Z.left), Xt(F.top - Z.top), se(F.height), gt(!0);
    }
  }, [de, z]), ve = U(() => {
  }), Me = j(
    (T, F, Z) => {
      const { anchorRect: q } = T;
      if (!g || !q) return;
      const { passive: J } = Z;
      ws({
        items: F,
        ...
        sessionCounterRef: It,
        setSession: (H) => {
          ft.current = H;
        },
        clearSessionIfCurrent: (H) => Mo(ft, H),
        ...
        restoreSelectionIfLost: () => {
          ...
          if (!((H = f.current) != null && H.getSelection())) {
            const mt = Pt.current;
            mt ? (nt = f.current) == null || nt.setSelection(mt) : (dt = f.current) == null || dt.selectNote(0);
          }
        },
        focusEditor: () => {
          var H;
    ...
    var Z;
    const T = (Z = f.current) == null ? void 0 : Z.getMarkerMenuContext();
    if (!T) return !1;
    const F = El($t.styleInfo ?? Tl, T);
    return F.length === 0 ? !1 : (Me(T, F, { passive: !T.hasTextSelection }), !0);
  }, [Me, $t.styleInfo]), rr = j(
    (T) => {
      const F = ft.current;
      if (!F || !g) return;
      us(T, F, {
        ...
        commitTyped: (q) => {
          var J;
          return (J = f.current) == null ? void 0 : J.commitTypedMarker(q);
        },
        commitTypedAndReopen: (q) => {
          var J;
          (J = f.current) == null || J.commitTypedMarker(q, { trailingSpace: !1 }), Oe();
        },
        commitTypedCloser: (q) => {
          var J;
          return (J = f.current) == null ? void 0 : J.commitTypedCloser(q);
        },
        commitItem: (q) => {
          var H;
          const J = F.items.find((nt) => nt.marker === q);
          J && ((H = f.current) == null || H.applyMarkerMenuSelection(J, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  G(() => {
    ...
    const T = (F) => {
      var J, H;
      const Z = (J = b.current) == null ? void 0 : J.querySelector(".editor-input");
      if (!Z || F.target !== Z) return;
      const q = (H = f.current) == null ? void 0 : H.getSelection();
      q && (Pt.current = q);
    };
    ...
    var T;
    it && ((T = le.current) == null || T.focus());
  }, [it]), G(() => {
    var Z;
    const T = () => {
      var q;
      return ((q = b.current) == null ? void 0 : q.querySelector(".editor-input")) ?? void 0;
    };
    if (((Z = $t.view) == null ? void 0 : Z.markerMode) === "editable") {
      const q = (H) => {
        var mt, yt, Vt, St;
        if (hs(H)) return;
        const nt = T();
        ...
        if (H.key === "Enter" && !kt()) {
          H.preventDefault(), H.stopPropagation(), (mt = f.current) == null || mt.selectNote(0), (yt = f.current) == null || yt.focus();
          return;
        }
        if (g && H.key === c) {
          if (!kt()) {
            H.preventDefault(), H.stopPropagation(), (Vt = f.current) == null || Vt.selectNote(0), (St = f.current) == null || St.focus();
            return;
          }
          Oe() && (H.preventDefault(), H.stopPropagation());
        }
      }, J = () => {
        var nt, dt;
        const H = T();
        !H || document.activeElement !== H || kt() || ((nt = f.current) == null || nt.selectNote(0), (dt = f.current) == null || dt.focus());
      };
      return document.addEventListener("keydown", q, { capture: !0 }), document.addEventListener("paste", J, { capture: !0 }), () => {
        document.removeEventListener("keydown", q, { capture: !0 }), document.removeEventListener("paste", J, { capture: !0 });
      };
    }
    const F = (q) => {
      const J = T();
      !it && J && document.activeElement === J && q.key === c ? (q.preventDefault(), Wt()) : it && q.key === "Escape" && (q.preventDefault(), gt(!1));
    };
    ...
    Wt,
    c,
    (nr = $t.view) == null ? void 0 : nr.markerMode,
    $t.styleInfo,
    g,
    Oe,
    kt
    ...
    const T = () => {
      var q, J, H;
      const F = ((q = b.current) == null ? void 0 : q.querySelector(".editor-input")) ?? void 0;
      if (!F || document.activeElement !== F) return;
      const Z = document.getSelection();
      Z && !Z.isCollapsed || kt() || ((J = f.current) == null || J.selectNote(0), (H = f.current) == null || H.focus());
    };
  ...
  const ar = l["%footnoteEditor_copyButton_tooltip%"], or = /* @__PURE__ */ a(
    Iw,
    {
      onUndoClick: () => {
        var T;
  ...
  return /* @__PURE__ */ u(ht, { children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ u("div", { className: "tw:flex", children: [
            ...
            !w && /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(lo, { children: [
              or,
              /* @__PURE__ */ a(
                Oi,
                {
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
                  ...
                  /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ a("p", { children: ar }) })
                ] }) }) })
              ]
            }
          )
    ...
    /* @__PURE__ */ u(We, { open: it, children: [
      /* @__PURE__ */ a(
        ps,
        {
          className: "tw:absolute",
...
function ih({
  ...
  const m = d ?? wc(r, void 0), f = g ? h : void 0, b = U([]), z = (N, P, I) => {
    if (p) {
      const Q = b.current[P], _ = Q ? Mw(I.clientX, I.clientY, Q) : "end";
      p(N, P, n, _);
      return;
    }
    w == null || w(N, P, n);
  }, x = i ? r.findIndex((N) => N === i) : -1, [E, $] = k(x), K = (N) => {
    var P;
    $(N), N >= 0 && N < b.current.length && ((P = b.current[N]) == null || P.focus());
  }, C = (N, P, I) => {
    if (r.length)
      switch (N.key) {
        case "Enter":
          N.preventDefault(), p ? p(P, I, n, "end") : w == null || w(P, I, n);
          break;
        case " ":
          N.preventDefault(), w == null || w(P, I, n);
          break;
      }
  }, B = r.length - 1, V = (N) => {
    if (r.length && !(N.target !== N.currentTarget && !(N.target instanceof HTMLElement && N.target.closest('li[role="option"]'))))
      switch (N.key) {
        case "ArrowDown":
          N.preventDefault(), K(Yr(E, 1, B, f));
          break;
        case "ArrowUp":
          N.preventDefault(), K(Yr(E, -1, B, f));
          break;
  ...
  return G(() => {
    var N;
    S < 0 || S >= b.current.length || (N = b.current[S]) == null || N.scrollIntoView({ block: "nearest" });
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ a(
        "ul",
        {
          ...
          children: r.map((N, P) => {
            const I = N === i, Q = P === h && !!g, _ = Q ? ru : `${n}-${P}`, et = P < r.length - 1 && o === "vertical" && /* @__PURE__ */ a($r, { tabIndex: -1, className: "tw:col-span-2" });
            return Q ? /* @__PURE__ */ u(xr, { children: [
              /* @__PURE__ */ a(
                "li",
                {
                  "data-state": "editing",
  ...
  return /* @__PURE__ */ u(uo, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(ho, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ue,
      {
        ...
        children: [
          /* @__PURE__ */ a(fr, { children: $e(c.reference, "English") }),
          /* @__PURE__ */ a(fr, { className: o, children: au(c.text) })
        ]
      },
...
const nu = (t) => {
...
}, ba = (t, e, r) => /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
  /* @__PURE__ */ u(
    Ut,
    {
  ...
  return e ? e[1] : "";
}, su = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ph = Object.freeze([
...
function hh({
  ...
  const g = _e(r, "%webView_inventory_all%"), m = _e(r, "%webView_inventory_approved%"), f = _e(r, "%webView_inventory_unapproved%"), b = _e(r, "%webView_inventory_unknown%"), z = _e(r, "%webView_inventory_scope_currentBook%"), x = _e(r, "%webView_inventory_scope_chapter%"), E = _e(r, "%webView_inventory_scope_verse%"), $ = _e(r, "%webView_inventory_filter_text%"), K = _e(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = _e(r, "%webView_inventory_no_results%"), [B, V] = k(!1), [S, N] = k("all"), [P, I] = k(""), [Q, _] = k([]), et = A(() => {
    const X = t ?? [];
    return X.length === 0 ? [] : lu(X, n, i);
  }, [t, n, i]), R = A(() => {
    if (B) return et;
    const X = [];
    return et.forEach((ct) => {
      const it = ct.items[0], gt = X.find(
        (vt) => vt.items[0] === it
      );
      gt ? (gt.count += ct.count, gt.occurrences = gt.occurrences.concat(ct.occurrences)) : X.push({
        items: [it],
        count: ct.count,
  ...
  }, [B, et]), D = A(() => R.length === 0 ? [] : cu(R, S, P), [R, S, P]), W = A(() => {
    var it, gt;
    if (!B) return l;
    const X = (it = o == null ? void 0 : o.tableHeaders) == null ? void 0 : it.length;
    if (!X) return l;
    const ct = [];
  ...
  G(() => {
    D.length === 0 ? _([]) : D.length === 1 && _(D[0].items);
  }, [D]);
  const st = (X, ct) => {
    ct.setRowSelection(() => {
      const gt = {};
    ...
    const it = X.original.items;
    _(it), h && it.length > 0 && h(it[0]);
  }, ot = (X) => {
        ...
        kr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(Cr, { children: [
              /* @__PURE__ */ a(be, { value: "all", children: g }),
              /* @__PURE__ */ a(be, { value: "approved", children: m }),
              /* @__PURE__ */ a(be, { value: "unapproved", children: f }),
              /* @__PURE__ */ a(be, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(kr, { onValueChange: (X) => ot(X), defaultValue: s, children: [
        /* @__PURE__ */ a(Nr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(_r, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(Cr, { children: [
          /* @__PURE__ */ a(be, { value: "book", children: z }),
          /* @__PURE__ */ a(be, { value: "chapter", children: x }),
          /* @__PURE__ */ a(be, { value: "verse", children: E })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ha,
...
const du = "16rem", wu = "3rem", Fi = ne.createContext(void 0);
function xa() {
...
function uu({
  ...
  const [l, d] = ne.useState(t), w = e ?? l, p = ne.useCallback(
    (E) => {
      const $ = typeof E == "function" ? E(w) : E;
      r ? r($) : d($);
    },
    [r, w]
  ), h = ne.useCallback(() => p((E) => !E), [p]), g = w ? "expanded" : "collapsed", b = Se() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = ne.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Fi.Provider, { value: z, children: /* @__PURE__ */ a(
    "div",
    {
...
function gh({ className: t, onClick: e, ...r }) {
...
function bu({
  ...
  const c = t ? Ur.Root : "button", { state: l } = xa(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(vu({ variant: r, size: o }), i),
      ...s
    }
  );
...
function xu({
  ...
  return /* @__PURE__ */ a(
    pu,
    {
      ...
      children: /* @__PURE__ */ u(gu, { children: [
        /* @__PURE__ */ u(vn, { children: [
          /* @__PURE__ */ a(bn, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(xn, { children: /* @__PURE__ */ a(fu, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(mu, { children: /* @__PURE__ */ a(
            bu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Fe = "scrBook", yu = "scrRef", sr = "source", ku = "details", _u = "Scripture Reference", Nu = "Scripture Book", Ui = "Type", Cu = "Details";
function Eu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Fe,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? _u,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? jt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Fe ? $e(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: ku,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Cu,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, yn = (t) => `${Tu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Rh({
  sources: t,
  ...
  const [d, w] = k([]), [p, h] = k([{ id: Fe, desc: !1 }]), [g, m] = k({}), f = A(
    () => t.flatMap((S) => S.data.map((N) => ({
      ...N,
      source: S.source
    }))),
    [t]
  ...
  G(() => {
    if (c) {
      const S = z.getSelectedRowModel().rowsById, N = Object.keys(S);
      if (N.length === 1) {
        const P = f.find((I) => yn(I) === N[0]) || void 0;
        P && c(P);
      }
    }
  }, [g, f, c, z]);
  const x = n ?? Nu, E = i ?? Ui, $ = [
    ...
    !S.getIsGrouped() && !S.getIsSelected() && S.getToggleSelectedHandler()(N);
  }, B = (S, N) => S.getIsGrouped() ? "" : v("banded-row", N % 2 === 0 ? "even" : "odd"), V = (S, N, P) => {
    if (!((S == null ? void 0 : S.length) === 0 || N.depth < P.column.getGroupedIndex())) {
      if (N.getIsGrouped())
        switch (N.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      kr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Cr, { position: "item-aligned", children: /* @__PURE__ */ a(xw, { children: $.map((S) => /* @__PURE__ */ a(be, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: z.getHeaderGroups().map((S) => /* @__PURE__ */ a(Ue, { children: S.headers.filter((N) => N.column.columnDef.header).map((N) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(na, { colSpan: N.colSpan, className: "tw:sticky top-0", children: N.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Mr(N.column.columnDef.header, N.getContext())
        ] }) }, N.id)
      )) }, S.id)) }),
      /* @__PURE__ */ a(ho, { children: z.getRowModel().rows.map((S, N) => {
        const P = Se();
        return /* @__PURE__ */ a(
          Ue,
          {
            ...
            className: v(B(S, N)),
            onClick: (I) => C(S, I),
            children: S.getVisibleCells().map((I) => {
              if (!(I.getIsPlaceholder() || I.column.columnDef.enableGrouping && !I.getIsGrouped() && (I.column.columnDef.id !== sr || !r)))
                return /* @__PURE__ */ a(
                  fr,
                  {
                    className: v(
                    ...
                    children: I.getIsGrouped() ? /* @__PURE__ */ u(
                      Y,
                      {
                        ...
                        type: "button",
                        children: [
                          S.getIsExpanded() && /* @__PURE__ */ a(br, {}),
                          !S.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ a(Ga, {}) : /* @__PURE__ */ a(qa, {})),
                          " ",
                          Mr(I.column.columnDef.cell, I.getContext()),
                          " (",
                          S.subRows.length,
                          ")"
                        ]
...
function Su({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: m, extraLong: f } = {
  ...
  }, [b, z] = k(!1), [x, E] = k(""), $ = U(void 0), K = U(!1), C = A(
    () => zn(t),
    [t]
  ), B = A(() => {
    if (!x.trim()) {
    ...
    (_, et = !1) => {
      ...
      const R = C.findIndex((pt) => pt === $.current), D = C.findIndex((pt) => pt === _);
      if (R === -1 || D === -1) return;
      const [W, st] = [
        Math.min(R, D),
        Math.max(R, D)
      ], ot = C.slice(W, st + 1).map((pt) => pt);
      r(
    ...
    V(_, K.current), K.current = !1;
  }, N = (_, et) => {
    _.preventDefault(), V(et, _.shiftKey);
  }, P = () => {
    r(C.map((_) => _));
  }, I = () => {
    r([]);
    ...
    () => Object.values(Rt).filter(
      (_) => (i == null ? void 0 : i[_]) !== void 0 && go(C, _).length === 0
    ).map((_) => ({ section: _, explanation: i == null ? void 0 : i[_] })),
    [i, C]
  );
  return /* @__PURE__ */ u(
    We,
          ...
          Ye,
          {
            ...
            children: /* @__PURE__ */ u(
              Xe,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (_) => {
                  _.key === "Enter" && (K.current = _.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    ua,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(Y, { variant: "ghost", size: "sm", onClick: I, children: w })
                  ] }),
                  /* @__PURE__ */ u(Ze, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(pa, { children: p }),
                    Object.values(Rt).filter((_) => B[_].length > 0).map((_, et) => {
                      const R = B[_];
                      return /* @__PURE__ */ u(xr, { children: [
                        et > 0 && /* @__PURE__ */ a(Sn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Ve,
                          {
                            heading: _n(_, h, g, m, f),
                            children: R.map((D) => /* @__PURE__ */ a(
                              ii,
                              {
                                bookId: D,
                  ...
                  Q.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Q.map(({ section: _, explanation: et }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: et }, _)) })
                ]
              }
            )
          }
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ja ? ja : kn
      ).map((d) => /* @__PURE__ */ a(Pr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ne(d, n) }, d)),
...
function Dh({
  ...
  const K = Lt(
    s,
    "%webView_scope_selector_selected_text%"
  ), C = Lt(s, "%webView_scope_selector_verse%"), B = Lt(s, "%webView_scope_selector_chapter%"), V = Lt(s, "%webView_scope_selector_book%"), S = Lt(
    s,
    "%webView_scope_selector_current_verse%"
  ), N = Lt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), P = Lt(s, "%webView_scope_selector_current_book%"), I = Lt(s, "%webView_scope_selector_choose_books%"), Q = Lt(s, "%webView_scope_selector_scope%"), _ = Lt(s, "%webView_scope_selector_select_books%"), et = Lt(s, "%webView_scope_selector_range%"), R = Lt(s, "%webView_scope_selector_select_range%"), D = Lt(s, "%webView_scope_selector_range_start%"), W = Lt(s, "%webView_scope_selector_range_end%"), st = Lt(s, "%webView_scope_selector_ok%"), ot = Lt(s, "%webView_scope_selector_cancel%"), pt = Lt(s, "%webView_scope_selector_navigate%"), Ot = (L) => {
    if (!f) return;
  ...
  ], ct = (L, tt, wt = !1) => /* @__PURE__ */ u(ht, { children: [
    L,
    tt && !wt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), it = e ? X.filter((L) => e.includes(L.value)) : X, gt = f ?? Sa, vt = p ?? gt, Dt = h ?? gt, _t = () => {
  }, Xt = U(null), fe = U(null), se = U(!1), re = U(null), Mt = U(!1), [le, ft] = k(void 0), It = U(!1), Pt = U(!1), $t = U(null), de = j((L) => {
    if (L) {
      ft("start"), It.current = !1;
      return;
    }
    ft((tt) => tt === "start" ? void 0 : tt), It.current && (It.current = !1, requestAnimationFrame(() => {
      var wt;
      const tt = (wt = Xt.current) == null ? void 0 : wt.querySelector("button");
      tt == null || tt.click();
    }));
  }, []), kt = j((L) => {
    if (L) {
    ...
    (L) => {
      g == null || g(L), m == null || m(L), It.current = !0;
    },
    [g, m]
  ), ce = j(
    (L) => {
      m == null || m(L), Pt.current = !0;
    },
    [m]
  ), M = j(
    (L) => {
    ...
    [r, n, f, i]
  ), qt = it.find((L) => L.value === t), bt = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? uc(vt, Dt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : qt ? ct(qt.label, qt.scrRefSuffix) : t, Tt = it.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), we = it.find((L) => L.value === "selectedBooks"), Zt = it.find((L) => L.value === "range"), [me, De] = k(!1), [At, ue] = k(void 0), [Gt, O] = k(void 0), [Nt, Ct] = k(void 0), [Wt, ve] = k(void 0), [Me, Oe] = k([]), rr = w === "dropdown" && At === "selectedBooks", ar = /* @__PURE__ */ a(
    Mu,
    {
      availableBookInfo: o,
      selectedBookIds: rr ? Me : n,
      onChangeSelectedBookIds: rr ? Oe : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), or = le === "end", nr = le === "start", T = "tw:text-muted-foreground", F = w === "dropdown" && At === "range", Z = F ? Ct : ae, J = F ? ve : m ? ce : _t, H = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-start", className: v(or && T), children: D }),
      /* @__PURE__ */ a(
        za,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Xt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-end", className: v(nr && T), children: W }),
      /* @__PURE__ */ a(
        za,
        {
          id: "scope-range-end",
          ...
          localizedStrings: z,
          getEndVerse: x,
          disableReferencesUpTo: F ? Nt ?? vt : vt,
          onOpenChange: kt,
          onCloseAutoFocus: (L) => {
            var tt;
            Pt.current && (Pt.current = !1, L.preventDefault(), (tt = $t.current) == null || tt.focus());
          },
          className: v(nr && T),
          modal: !0,
          align: "start"
  ...
  const [yt, Vt] = k(null), [St, pe] = k(null), [Ie, ya] = k(null), ka = 200, [_a, Na] = k(!1);
  G(() => {
    if (!Ie || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([tt]) => {
      Na(tt.contentRect.width < ka);
    });
    return L.observe(Ie), () => L.disconnect();
  }, [Ie]);
  const y = j(
    (L) => {
      O(L), Ct(vt), ve(Dt), Oe(n), De(!1), ue(L);
    },
    [vt, Dt, n]
  ), rt = j(() => {
    Gt !== void 0 && (Gt === "range" ? (Nt && (g == null || g(Nt)), Wt && (m == null || m(Wt))) : Gt === "selectedBooks" && i(Me), M(Gt), ue(void 0), O(void 0));
  }, [
    Gt,
    Nt,
    Wt,
    ...
    L || (ue(void 0), O(void 0));
  }, []), oe = j((L) => {
    var tt;
    L.preventDefault(), (tt = mt.current) == null || tt.focus();
  }, []), Pe = (L) => t === L ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(qe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(zt, { children: Q }),
      w === "dropdown" ? /* @__PURE__ */ u(Je, { open: me, onOpenChange: De, children: [
        ...
        /* @__PURE__ */ a(
          tr,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Ca, { container: Ie, children: [
              Tt.map(({ value: L, label: tt, dropdownLabel: wt, scrRefSuffix: xt, id: Yt }) => /* @__PURE__ */ u(
                cr,
                {
                  ref: dt(L),
                  ...
                  children: [
                    t === L && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(qe, { className: "tw:h-4 tw:w-4" }) }),
                    ct(wt ?? tt, xt, _a)
                  ]
                },
                Yt
              ...
              b && /* @__PURE__ */ u(ht, { children: [
                /* @__PURE__ */ a(lr, {}),
                /* @__PURE__ */ a(Lr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: pt }),
                /* @__PURE__ */ a(
                  cr,
                  {
                    ref: re,
                    ...
                    onSelect: (L) => {
                      var tt, wt;
                      if (L.preventDefault(), se.current) {
                        se.current = !1;
                        return;
                      }
                      Mt.current || (wt = (tt = fe.current) == null ? void 0 : tt.querySelector("button")) == null || wt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          za,
                          {
                            ...
                            onCloseAutoFocus: (L) => {
                              var tt;
                              L.preventDefault(), (tt = re.current) == null || tt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(ht, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: $e(f ?? Sa, "id") }),
                              /* @__PURE__ */ a(br, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        co,
        {
          ...
          children: it.map(({ value: L, label: tt, scrRefSuffix: wt, id: xt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(oa, { className: "tw:me-2", value: L, id: xt }),
            /* @__PURE__ */ a(zt, { htmlFor: xt, children: ct(tt, wt) })
          ] }, xt))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { children: _ }),
      ar
    ] }),
    w === "radio" && t === "range" && H,
    w === "dropdown" && we && /* @__PURE__ */ a(Ba, { open: At === "selectedBooks", onOpenChange: at, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: pe,
        onCloseAutoFocus: oe,
        onEscapeKeyDown: (L) => {
          St != null && St.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(Ca, { container: St, children: [
          /* @__PURE__ */ a(Ua, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ka, { children: I }) }),
          ar,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(Y, { variant: "outline", onClick: () => at(!1), children: ot }),
            /* @__PURE__ */ a(Y, { onClick: rt, children: st })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Zt && /* @__PURE__ */ a(Ba, { open: At === "range", onOpenChange: at, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Vt,
        onCloseAutoFocus: oe,
        onEscapeKeyDown: (L) => {
          yt != null && yt.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(Ca, { container: yt, children: [
          /* @__PURE__ */ a(Ua, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ka, { children: R }) }),
          H,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(Y, { variant: "outline", onClick: () => at(!1), children: ot }),
            /* @__PURE__ */ a(Y, { ref: $t, onClick: rt, children: st })
          ] })
        ] })
      }
    ) })
...
function Mh({
  ...
  return /* @__PURE__ */ u(
    kr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(Nr, { size: n, className: v("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          _r,
          {
        ...
        /* @__PURE__ */ a(
          Cr,
          {
            ...
            style: { zIndex: wr },
            children: t.map((w) => /* @__PURE__ */ a(be, { value: `${w}`, children: l[Vo(w)] }, `${w}`))
          }
        )
      ]
    }
...
function io({
  ...
  return /* @__PURE__ */ u(Je, { variant: i, children: [
    /* @__PURE__ */ a(Qe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(Y, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(tc, {}) }) }),
    /* @__PURE__ */ a(tr, { align: "start", style: { zIndex: wr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(xr, { children: [
      /* @__PURE__ */ a(En, { children: /* @__PURE__ */ a(Bt, { children: Hi(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(lr, {})
    ] }, l)) })
  ] });
}
const Pu = 8;
...
const Au = Object.freeze([520, 420, 340]), Gi = ne.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    const [n, i] = k(void 0), s = U(o);
    s.current = o;
    const c = j((p) => {
      i(p ?? void 0);
      const h = s.current;
      typeof h == "function" ? h(p) : h && (h.current = p);
    }, []), l = qi(n, Au), d = ci() ?? l, w = d >= Or.MINIMUM;
...
Wi.displayName = ye.List.displayName;
...
Yi.displayName = ye.List.displayName;
const Vu = ne.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ye.Trigger,
  {
    ref: r,
    ...e,
...
Xi.displayName = ye.Content.displayName;
function Vh({
  tabList: t,
  searchValue: e,
  onSearch: r,
...
function ju({ ...t }) {
  return /* @__PURE__ */ a(Re.Menu, { "data-slot": "menubar-menu", ...t });
}
function Bu({ ...t }) {
  return /* @__PURE__ */ a(Re.Portal, { "data-slot": "menubar-portal", ...t });
}
function Fu({
  className: t,
  ...e
...
function Uu({
  ...
  const i = jr();
  return /* @__PURE__ */ a(Bu, { children: /* @__PURE__ */ a(
    Re.Content,
    {
...
function qu({ ...t }) {
  return /* @__PURE__ */ a(Re.Sub, { "data-slot": "menubar-sub", ...t });
}
function Gu({
  className: t,
  inset: e,
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(Gu, { children: d.label }),
        /* @__PURE__ */ a(Wu, { children: Zi(
          t,
          e,
          Ki(t, d.id),
          o
  ...
  if (Rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), zr(i, [h, g]);
        break;
      case "alt+l":
        (f = s.current) == null || f.focus(), zr(s, [h, g]);
        break;
      case "alt+n":
        (b = c.current) == null || b.focus(), zr(c, [h, g]);
        break;
      case "alt+h":
        (z = l.current) == null || z.focus(), zr(l, [h, g]);
        break;
    }
  }), G(() => {
    ...
    return /* @__PURE__ */ a(Lu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(ju, { children: [
      /* @__PURE__ */ a(Fu, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        Uu,
        {
          style: { zIndex: wr },
...
const Xu = Object.freeze([950, 800, 700]);
function Lh(t) {
  switch (t) {
    case void 0:
      return;
...
function jh({
  ...
  const [w, p] = k(void 0), h = j(
    (f) => p(f ?? void 0),
    []
  ), g = qi(w, Xu), m = ci() ?? g;
  return /* @__PURE__ */ a(ma.Provider, { value: m, children: /* @__PURE__ */ a(
    "div",
    {
...
function Bh({
  ...
  const d = Zu(
    ...
    var z, x, E, $, K, C;
    const b = f !== m ? ((x = (z = t[m]) == null ? void 0 : z.uiNames) == null ? void 0 : x[f]) ?? (($ = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : $.en) : void 0;
      ...
      kr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: wr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(be, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
...
function Uh({
  ...
  return /* @__PURE__ */ u(Xe, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
...
function Hh({
  ...
  const c = t ? Lo(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = ep(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
      ...
      /* @__PURE__ */ a(
        Kt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Lo(d, {
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(xr, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
            ...
            d && (e || h && m) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Je, { children: [
                  /* @__PURE__ */ a(Qe, { className: v(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    Y,
                    {
...
function Wh({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = A(() => {
    const c = new Vn(o);
    return (l) => c.format(l);
...
function ng({
  ...
  return /* @__PURE__ */ u(
    Ht.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Ht.ItemIndicator, { children: /* @__PURE__ */ a(fa, {}) }) }),
        e
      ]
    }
  );
...
function _g({
  ...
  return /* @__PURE__ */ a(
    ye.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", op({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
const ip = (t, e, r = {}) => {
  ...
  const [e, r] = k(!1), [o, n] = k(!1), [i, s] = k(0), c = U(void 0), l = A(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
...
function zg(t) {
  const e = A(() => pc(t).slice().sort().join(" "), [t]);
...
function Og({ value: t, children: e }) {
  return /* @__PURE__ */ a(si.Provider, { value: t, children: /* @__PURE__ */ a(ma.Provider, { value: t, children: e }) });
}
function lp(t, e = "top") {
...
export {
  ...
  Vp as CONFLICT_NOTE_STRING_KEYS,
  ...
  Yh as ContextMenu,
  ng as ContextMenuCheckboxItem,
  eg as ContextMenuContent,
  Zh as ContextMenuGroup,
  rg as ContextMenuItem,
  sg as ContextMenuLabel,
  Jh as ContextMenuPortal,
  tg as ContextMenuRadioGroup,
  ig as ContextMenuRadioItem,
  cg as ContextMenuSeparator,
  lg as ContextMenuShortcut,
  Qh as ContextMenuSub,
  og as ContextMenuSubContent,
  ag as ContextMenuSubTrigger,
  Xh as ContextMenuTrigger,
  Nw as DataTable,
  ...
  Ka as DialogTitle,
  Kg as DialogTrigger,
  zu as DisabledActionTooltip,
  Ru as DisabledTooltipWrapper,
  dg as Drawer,
  ug as DrawerClose,
  pg as DrawerContent,
  ...
  Ew as ErrorDump,
  Qp as ErrorPopover,
  nh as FOOTNOTE_EDITOR_STRING_KEYS,
  ah as Filter,
  th as FilterDropdown,
  rh as Footer,
  oh as FootnoteEditor,
  eu as FootnoteItem,
  ih as FootnoteList,
  Yw as INLINE_APPLY_DEBOUNCE_MS,
  Fh as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  ...
  Zp as MarkdownRenderer,
  Kw as MarkerMenu,
  eh as MoreInfo,
  cs as MultiSelectComboBox,
  Vh as NavigationContentSearch,
  We as Popover,
  ps as PopoverAnchor,
  ...
  af as ResizableHandle,
  of as ResizablePanel,
  nf as ResizablePanelGroup,
  qh as ResultsCard,
  sf as RetryableErrorView,
  zh as SCOPE_SELECTOR_STRING_KEYS,
  Ou as SELECT_BOOKS_STRING_KEYS,
  Or as SHRINK_STEP,
  Dh as ScopeSelector,
  ...
  _h as SidebarMenuBadge,
  bu as SidebarMenuButton,
  mu as SidebarMenuItem,
  Nh as SidebarMenuSkeleton,
  Ch as SidebarMenuSub,
  Th as SidebarMenuSubButton,
  Eh as SidebarMenuSubItem,
  uu as SidebarProvider,
  fh as SidebarRail,
  xh as SidebarSeparator,
  gh as SidebarTrigger,
  gr as Skeleton,
  xg as Slider,
  bg as Sonner,
  cf as Spinner,
  ...
  gf as Z_INDEX_ONBOARDING_TOUR,
  fs as Z_INDEX_OVERLAY,
  ff as badgeVariants,
  mf as buttonGroupVariants,
  vf as buttonVariants,
  v as cn,
  uh as getBookIdFromUSFM,
  Mw as getCaretPositionFromClick,
  Fp as getCommentThreadElementId,
  ba as getInventoryHeader,
  dh as getLinesFromUSFM,
  wh as getNumberFromUSFM,
  su as getStatusForItem,
  ...
  Eg as useEvent,
  Tg as useEventAsync,
  zg as useExtraValidMarkers,
  ns as useListbox,
  ip as usePromise,
  Ip as useRecentSearches,
  Sg as useRetryablePromise,
  Dg as useRunWhenVisible,
  qi as useShrinkStep,
  ci as useShrinkStepOverride,
  Ml as useShrinkStepValue,
  xa as useSidebar,
  Rg as useStylesheet,
  Mg as useTabIconSelection,
  Do as useTruncationTooltip,
  sp as useViewVisibility
};
