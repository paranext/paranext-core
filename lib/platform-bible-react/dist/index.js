...
import { c as m, g as me, a as _r, C as Se, u as Io, T as Dt, b as Mt, d as Ot, e as It, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Zi, l as Qi, m as ts, I as es, n as so, r as ye, o as rs, p as Tn, q as la, s as da, L as Et, R as co, t as ea, D as Ba, v as Fa, w as Ua, y as Ka, z as Sn, E as Gr, F as lo, G as Rn, H as wo, J as Je, K as Er, M as je, N as Be, O as Fe, S as Tr, Q as nr, U as as, V as zr, W as Ze, X as Oe, Z as tr, Y as De, _ as ir, $ as uo, a0 as po, a1 as ra, a2 as ho, a3 as zn, a4 as os, a5 as ns, a6 as is, a7 as Ha, a8 as Dn, a9 as wa, aa as ss, ab as Mn, ac as cs, ad as ls, ae as ds, af as $o, ag as ws, ah as us, ai as ps, aj as hs, ak as On, al as In, am as go, an as gs, ao as $n, ap as Ca, aq as Po, ar as Ea, as as fs, at as ms, au as vs, av as bs, aw as xs, ax as Dr, ay as fo, az as ys, aA as ks } from "./resizable-C3OJPqMk.js";
import { aB as Vg, aC as Lg, aD as jg, aE as Bg, aF as Fg, aG as Ug, aH as Kg, aI as Hg, aJ as Gg, aK as qg, aL as Wg, aM as Yg, aN as Xg, aO as Jg, aP as Zg, aQ as Qg, aR as tf, aS as ef, aT as rf, aU as af, aV as of, aW as nf, aX as sf, aY as cf } from "./resizable-C3OJPqMk.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as zt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Ao, ChevronsLeft as Vo, ChevronsRight as Lo, ChevronLeft as Ga, ChevronRight as qa, ArrowLeft as _s, ArrowRight as Ns, ChevronDown as lr, BoldIcon as Cs, ItalicIcon as Es, X as mo, AtSign as Pn, Pencil as Ts, Trash2 as Ss, ArrowUp as An, MoreHorizontal as Rs, MailOpen as zs, Mail as Ds, ChevronUp as Ms, FilterIcon as Os, ArrowLeftIcon as Is, ChevronLeftIcon as $s, ChevronRightIcon as Ps, ArrowRightIcon as As, Copy as Vn, Filter as Vs, User as Ls, Link as js, CircleHelp as Bs, Undo as Fs, Redo as Us, SquareX as Ln, FunctionSquare as jn, SquareSigma as Bn, Ban as Ks, AlertCircle as Wa, CircleCheckIcon as Hs, CircleXIcon as Gs, CircleHelpIcon as qs, ArrowUpIcon as Ws, ArrowDownIcon as Ys, ScrollText as Xs, ChevronsUpDown as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as tc, MoreVertical as ec } from "lucide-react";
import { Section as Ct, getChaptersForBook as rc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as qr, formatRelativeDate as ac, sanitizeHtml as vo, NumberFormat as Fn, formatBytes as oc, getCurrentLocale as nc, usfmMarkers as Wr, isPlatformError as ic, ABORTED as sc, getErrorMessage as cc, getFormatCallerFunction as lc, deepEqual as dc, isString as jo, compareScrRefs as Ya, scrRefToBBBCCCVVV as Ta, defaultScrRef as Sa, formatScrRefRange as wc, getLocalizeKeyForScrollGroupId as Bo, formatReplacementStringToArray as Fo, collectUsjMarkers as uc } from "platform-bible-utils";
...
function Jp({
  ...
  const Ft = j(
    ...
    (R, B) => {
      ...
      let x;
      R === "custom" ? x = B : R === "generated" ? x = Za : x = Qa, q.insert.note.caller !== x && (q.insert.note.caller = x, (et = h.current) == null || et.applyUpdate([q, { delete: 1 }]));
    },
    []
  ), kt = j(() => {
    var R;
