...
const Tt = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Group,
  {
    ref: n,
    className: d(
...
Tt.displayName = wt.Group.displayName;
...
var Ka = Object.defineProperty, qa = (t, e, n) => e in t ? Ka(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, D = (t, e, n) => qa(t, typeof e != "symbol" ? e + "" : e, n);
const Lt = [
  "GEN",
  "EXO",
  "LEV",
...
D(ct, "Original", new ct(gt.Original)), D(ct, "Septuagint", new ct(gt.Septuagint)), D(ct, "Vulgate", new ct(gt.Vulgate)), D(ct, "English", new ct(gt.English)), D(ct, "RussianProtestant", new ct(gt.RussianProtestant)), D(ct, "RussianOrthodox", new ct(gt.RussianOrthodox));
let Ot = ct;
function In(t, e) {
  const n = e[0];
...
const it = class P {
    ...
    if (D(this, "firstChapter"), D(this, "lastChapter"), D(this, "lastVerse"), D(this, "hasSegmentsDefined"), D(this, "text"), D(this, "BBBCCCVVVS"), D(this, "longHashCode"), D(this, "versification"), D(this, "rtlMark", "‏"), D(this, "_bookNum", 0), D(this, "_chapterNum", 0), D(this, "_verseNum", 0), D(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof P) {
          ...
          if (e == null) return;
          const s = e instanceof Ot ? e : P.defaultVersification;
          this.setEmpty(s);
        }
      else
      ...
      if (typeof e == "string" && typeof n == "string" && typeof a == "string")
        ...
        this._bookNum = e, this._chapterNum = n, this._verseNum = a, this.versification = o ?? P.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
  ...
  static tryParse(e) {
    let n;
    try {
      return n = new P(e), { success: !0, verseRef: n };
    } catch (a) {
      if (a instanceof re)
        return n = new P(), { success: !1, verseRef: n };
      throw a;
    }
  }
  /**
  ...
  static getBBBCCCVVV(e, n, a) {
    return e % P.bcvMaxValue * P.bookDigitShifter + (n >= 0 ? n % P.bcvMaxValue * P.chapterDigitShifter : 0) + (a >= 0 ? a % P.bcvMaxValue : 0);
  }
  /**
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Ot(i)), n ? new P(n, a.toString(), w, u) : new P();
  }
  /**
  ...
  set verse(e) {
    const { success: n, vNum: a } = P.tryGetVerseNum(e);
    this._verse = n ? void 0 : e.replace(this.rtlMark, ""), this._verseNum = a, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = P.tryGetVerseNum(this._verse));
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Ot(gt[i]);
        } catch {
    ...
    if (a.length !== 2 || X.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !P.isVerseParseable(a[1]))
      throw new re("Invalid reference : " + e);
   ...
   */
  allVerses(e = !1, n = P.verseRangeSeparators, a = P.verseSequenceIndicators) {
...
D(it, "defaultVersification", Ot.English), D(it, "verseRangeSeparator", "-"), D(it, "verseSequenceIndicator", ","), D(it, "verseRangeSeparators", [it.verseRangeSeparator]), D(it, "verseSequenceIndicators", [it.verseSequenceIndicator]), D(it, "chapterDigitShifter", 1e3), D(it, "bookDigitShifter", it.chapterDigitShifter * it.chapterDigitShifter), D(it, "bcvMaxValue", it.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
D(it, "ValidStatusType", er);
...
const rr = X.allBookIds.filter(
  (t) => !X.isObsolete(X.bookIdToNumber(t))
), Pt = Object.fromEntries(
  rr.map((t) => [t, X.bookIdToEnglishName(t)])
);
function cn(t, e, n) {
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        className: d(
          ...
          {
            "tw-border-s-red-200": o === O.OT,
            "tw-border-s-purple-200": o === O.NT,
            "tw-border-s-indigo-200": o === O.DC,
            "tw-border-s-amber-200": o === O.Extra
          }
        ),
        children: /* @__PURE__ */ l(
          Bt,
          {
            ref: c,
            value: u || `${t} ${X.bookIdToEnglishName(t)}`,
            onSelect: f,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
...
function Ue(t, e, n) {
  return `${t} ${Pt[t]}${e ? ` ${ln(t, e)} ${Ht(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function wo({
  recentSearches: t,
  ...
  return /* @__PURE__ */ l(te, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(Gt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Wt, { children: /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(Tt, { heading: s, children: t.map((p) => /* @__PURE__ */ l(
      Bt,
      {
        onSelect: () => c(p),
  ...
  const a = lo.reduce(
    (o, s) => {
      ...
      if (i) {
        ...
        if (!p && u) {
          const g = ((b) => Object.keys(Pt).find(
            (x) => Pt[x].toLowerCase() === b.toLowerCase()
          ))(w);
...
function An({
  ...
  if (t)
    return /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ r("div", { className: d("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: bt(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Bt,
      {
        value: `${t} ${Pt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Ii({
  ...
  const c = at(), [p, f] = z(!1), [h, g] = z(""), [b, x] = z(""), [N, I] = z("books"), [y, R] = z(void 0), [F, L] = z(!1), A = nt(void 0), E = nt(void 0), j = nt(void 0), k = nt(void 0), C = nt({}), $ = H(
    (v) => {
      e(v), w && w(v);
    },
    [e, w]
  ), V = J(() => a ? a() : rr, [a]), Z = J(() => ({
    [O.OT]: V.filter((B) => X.isBookOT(B)),
    [O.NT]: V.filter((B) => X.isBookNT(B)),
    [O.DC]: V.filter((B) => X.isBookDC(B)),
    [O.Extra]: V.filter((B) => X.extraBooks().includes(B))
  }), [V]), S = J(() => Object.values(Z).flat(), [Z]), q = J(() => {
    if (!b.trim()) return Z;
    const v = {
      [O.OT]: [],
      [O.NT]: [],
    ...
    return [O.OT, O.NT, O.DC, O.Extra].forEach((et) => {
    ...
    (v) => {
      const B = N === "chapters" ? y : _ == null ? void 0 : _.book;
      B && ($({
        book: B,
        chapterNum: v,
        verseNum: 1
      }), f(!1), I("books"), R(void 0), x(""));
    },
    [$, N, y, _]
  ), Dt = H(
    (v) => {
    ...
    (v) => _ ? !!_.chapterNum && !v.toString().includes(_.chapterNum.toString()) : !1,
    [_]
  ), Hr = J(
    () => Ft(
      t,
    ...
    (v) => {
      if (v.ctrlKey) return;
      const { isLetter: B, isDigit: et } = On(v.key);
      if (N === "chapters") {
        if (v.key === "Backspace") {
        ...
        if (B || et) {
          if (v.preventDefault(), v.stopPropagation(), I("books"), R(void 0), et && y) {
            const ot = Pt[y];
            x(`${ot} ${v.key}`);
          } else
            x(v.key);
      ...
      if ((N === "chapters" || N === "books" && _) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ot = N === "chapters" ? y : _ == null ? void 0 : _.book;
        if (!ot) return;
        const st = (() => {
          if (!h) return 1;
          const ne = h.match(/(\d+)$/);
        ...
        switch (v.key) {
          case "ArrowLeft":
            st !== 0 && (Nt = st > 1 ? st - 1 : Mt);
            break;
          case "ArrowRight":
            st !== 0 && (Nt = st < Mt ? st + 1 : 1);
            break;
          case "ArrowUp":
            Nt = st === 0 ? Mt : Math.max(1, st - Sn);
            break;
          case "ArrowDown":
            Nt = st === 0 ? 1 : Math.min(Mt, st + Sn);
            break;
          default:
            return;
        }
    ...
    const { isLetter: B, isDigit: et } = On(v.key);
    (B || et) && (v.preventDefault(), x((ot) => ot + v.key), E.current.focus(), L(!1));
  }, []);
  return Tn(() => {
    const v = setTimeout(() => {
      if (p && N === "books" && j.current && k.current) {
        const B = j.current, et = k.current, ot = et.offsetTop, st = B.clientHeight, Mt = et.clientHeight, Nt = ot - st / 2 + Mt / 2;
        B.scrollTo({
          top: Math.max(0, Nt),
          behavior: "smooth"
        }), g(Ue(t.book));
    ...
    if (N === "chapters" && y) {
      ...
      setTimeout(() => {
        if (j.current)
          if (v) {
            const B = C.current[t.chapterNum];
  ...
  }, [N, y, _, t.book, t.chapterNum]), /* @__PURE__ */ l(te, { open: p, onOpenChange: mt, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ r(
      M,
      {
      ...
      Wt,
      {
        ...
        children: [
          N === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: T.map(({ onClick: v, disabled: B, title: et, icon: ot }) => /* @__PURE__ */ r(
              M,
              {
                variant: "ghost",
                size: "sm",
          ...
          !F && /* @__PURE__ */ l(Zt, { ref: j, children: [
            N === "books" && /* @__PURE__ */ l(kt, { children: [
              !_ && Object.entries(q).map(([v, B]) => {
                if (B.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Tt, { heading: Xr(v), children: B.map((et) => /* @__PURE__ */ r(
                      ar,
                      {
                        bookId: et,
                        onSelect: (ot) => xt(ot),
                        section: se(et),
                        commandValue: `${et} ${Pt[et]}`,
              ...
              _ && /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ r(
                Bt,
                {
                  value: `${_.book} ${Pt[_.book]} ${_.chapterNum || ""}:${_.verseNum || ""})}`,
                  onSelect: Q,
                  ...
                  children: Ft(
                    ...
                    o ? ln(_.book, o) : void 0
                  )
                },
                "top-match"
              ) }),
              _ && bt(_.book) > 1 && /* @__PURE__ */ l(kt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ht(_.book, o) }),
                /* @__PURE__ */ r(
                  An,
                  {
                    bookId: _.book,
...
function Ke({
  ...
  const [y, R] = z(!1), F = u ?? w, L = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], A = (E, j) => {
    const k = w(E), C = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, $ = `${j ?? ""}${k}${C ?? ""}`;
    return /* @__PURE__ */ l(
      Bt,
      {
        value: k,
        ...
        children: [
          /* @__PURE__ */ r(
            Et,
            {
              className: d("tw-me-2 tw-h-4 tw-w-4 tw-shrink-0", {
                "tw-opacity-0": !s || w(s) !== k
              })
            }
          ),
          /* @__PURE__ */ l("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: [
            k,
            C && /* @__PURE__ */ l("span", { className: "tw-text-muted-foreground", children: [
              " · ",
              C
            ] })
          ] })
  ...
  return /* @__PURE__ */ l(te, { open: y, onOpenChange: R, ...I, children: [
      ...
      M,
      {
        ...
        children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: d("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: s ? F(s) : p })
          ] }),
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ l(Wt, { children: [
          /* @__PURE__ */ r(ue, { placeholder: f, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(Ce, { children: h }),
          /* @__PURE__ */ r(Zt, { children: L(e) ? e.map((E) => /* @__PURE__ */ r(Tt, { heading: E.groupHeading, children: E.options.map((j) => A(j, E.groupHeading)) }, E.groupHeading)) : e.map((E) => A(E)) })
        ] })
      }
    )
  ] });
...
function Pi({
  ...
  const p = Pe(c, "%webView_bookSelector_currentBook%"), f = Pe(c, "%webView_bookSelector_choose%"), h = Pe(c, "%webView_bookSelector_chooseBooks%"), [g, b] = z(
    "current book"
    /* CURRENT_BOOK */
  ), x = (N) => {
    b(N), t(N);
...
const mn = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    Y.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Y.ItemIndicator, { children: /* @__PURE__ */ r(Et, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
function yo({ table: t }) {
  return /* @__PURE__ */ l(_e, { children: [
    /* @__PURE__ */ r(La, { asChild: !0, children: /* @__PURE__ */ l(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Ut = W.Root, No = W.Group, Kt = W.Value, ko = Vt(
...
const dt = m.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  W.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(W.ItemIndicator, { children: /* @__PURE__ */ r(Et, { className: "tw-h-4 tw-w-4" }) }) }),
...
function Io({
  ...
  var A;
  const [p, f] = z([]), [h, g] = z([]), [b, x] = z({}), [N, I] = z({}), y = J(() => e ?? [], [e]), R = Xn({
    data: y,
    columns: t,
    getCoreRowModel: Hn(),
  ...
  }), F = R.getVisibleFlatColumns();
  let L;
  return u ? L = Array.from({ length: 10 }).map((k, C) => `skeleton-row-${C}`).map((k) => /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(zt, { colSpan: F.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(qe, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((A = R.getRowModel().rows) == null ? void 0 : A.length) > 0 ? L = R.getRowModel().rows.map((E) => /* @__PURE__ */ r(
    Ct,
    {
      onClick: () => i(E, R),
      "data-state": E.getIsSelected() && "selected",
      children: E.getVisibleCells().map((j) => /* @__PURE__ */ r(zt, { children: ie(j.column.columnDef.cell, j.getContext()) }, j.id))
    },
    E.id
  )) : L = /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(zt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ l("div", { className: "pr-twp", id: w, children: [
    o && /* @__PURE__ */ r(yo, { table: R }),
    /* @__PURE__ */ l(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Te, { stickyHeader: s, children: R.getHeaderGroups().map((E) => /* @__PURE__ */ r(Ct, { children: E.headers.map((j) => /* @__PURE__ */ r(de, { children: j.isPlaceholder ? void 0 : ie(j.column.columnDef.header, j.getContext()) }, j.id)) }, E.id)) }),
...
function ji({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(_e, { children: [
    ...
    /* @__PURE__ */ r(me, { children: n.map((c, p) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(or, { children: c.itemType === 0 ? /* @__PURE__ */ r(kt, { children: c.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        mn,
        {
          checked: a[p][h],
        ...
        vo,
        {
          ...
          children: c.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(lr, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(Re, {})
    ] }, c.label)) })
...
function zo({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const u = new Date(w), c = new Date(o.getTime() - u.getTime()), p = c.getUTCFullYear() - 1970, f = c.getUTCMonth(), h = c.getUTCDate() - 1;
    let g = "";
...
function $o({
  ...
  const [I, y] = z(!1), R = H(
    (C) => {
      var V;
      const $ = (V = t.find((Z) => Z.label === C)) == null ? void 0 : V.value;
      $ && n(
        e.includes($) ? e.filter((Z) => Z !== $) : [...e, $]
      );
    },
    [t, e, n]
  ), F = () => u || a, L = J(() => {
    if (!h) return t;
    const C = t.filter((V) => V.starred).sort((V, Z) => V.label.localeCompare(Z.label)), $ = t.filter((V) => !V.starred).sort((V, Z) => {
      const S = e.includes(V.value), q = e.includes(Z.value);
      return S && !q ? -1 : !S && q ? 1 : V.label.localeCompare(Z.label);
    });
    return [...C, ...$];
  }, [t, e, h]), A = () => {
    n(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ r("div", { id: N, className: b, children: /* @__PURE__ */ l(te, { open: j, onOpenChange: p ?? y, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ l(
      M,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(Wt, { children: [
      ...
      o && /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(M, { variant: "ghost", size: "sm", onClick: A, children: s }),
        /* @__PURE__ */ r(M, { variant: "ghost", size: "sm", onClick: E, children: i })
      ] }),
      /* @__PURE__ */ l(Zt, { children: [
        /* @__PURE__ */ r(Ce, { children: w }),
        /* @__PURE__ */ r(Tt, { children: L.map((C) => /* @__PURE__ */ l(
          Bt,
          {
            value: C.label,
            onSelect: R,
...
function Go({
  ...
  return /* @__PURE__ */ l(kt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: d("textual-note-body", g), children: w && w.length > 0 && /* @__PURE__ */ r(kt, { children: jo(t.marker, w, a, c) }) })
  ] });
}
...
function Fi({
  ...
  const p = c ? Ko(c, "%webView_footnoteList_header%") : "Footnotes", f = w ?? Ma(e, void 0), h = (y, R) => {
    u == null || u(y, R, a);
  }, g = o ? e.findIndex((y) => y === o) : 0, [b, x] = z(g), N = (y) => {
    if (e.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), x((R) => Math.min(R + 1, e.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), x((R) => Math.max(R - 1, 0));
          break;
        case "Enter":
        case " ":
          y.preventDefault(), u == null || u(e[b], b, a);
          break;
      }
  }, I = nt([]);
  return St(() => {
    var y;
    b >= 0 && b < I.current.length && ((y = I.current[b]) == null || y.focus());
  }, [b]), /* @__PURE__ */ l(kt, { children: [
  ...
  return /* @__PURE__ */ l(Se, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Ee, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      Ct,
      {
        ...
        children: [
          /* @__PURE__ */ r(zt, { children: `${X.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(zt, { children: i.text })
        ]
      },
...
function Zi({
  ...
  const f = ft(n, "%webView_inventory_all%"), h = ft(n, "%webView_inventory_approved%"), g = ft(n, "%webView_inventory_unapproved%"), b = ft(n, "%webView_inventory_unknown%"), x = ft(n, "%webView_inventory_scope_currentBook%"), N = ft(n, "%webView_inventory_scope_chapter%"), I = ft(n, "%webView_inventory_scope_verse%"), y = ft(n, "%webView_inventory_filter_text%"), R = ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), F = ft(n, "%webView_inventory_no_results%"), [L, A] = z(!1), [E, j] = z("all"), [k, C] = z(""), [$, V] = z([]), Z = J(() => {
    const T = t ?? [];
    return T.length === 0 ? [] : ts(T, o, s);
  }, [t, o, s]), S = J(() => {
    if (L) return Z;
    const T = [];
    return Z.forEach((tt) => {
      const mt = tt.items[0], ht = T.find(
        (yt) => yt.items[0] === mt
      );
      ht ? (ht.count += tt.count, ht.occurrences = ht.occurrences.concat(tt.occurrences)) : T.push({
        items: [mt],
        count: tt.count,
  ...
  }, [L, Z]), q = J(() => S.length === 0 ? [] : Qo(S, E, k), [S, E, k]), _ = J(() => {
    var mt, ht;
    if (!L) return u;
    const T = (mt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : mt.length;
    if (!T) return u;
    const tt = [];
    ...
    return [...tt, ...u];
  }, [a == null ? void 0 : a.tableHeaders, u, L]);
  St(() => {
  ...
  return /* @__PURE__ */ l("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Ut, { onValueChange: (T) => xt(T), defaultValue: i, children: [
        /* @__PURE__ */ r($t, { className: "tw-m-1", children: /* @__PURE__ */ r(Kt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(jt, { children: [
          /* @__PURE__ */ r(dt, { value: "book", children: x }),
          /* @__PURE__ */ r(dt, { value: "chapter", children: N }),
          /* @__PURE__ */ r(dt, { value: "verse", children: I })
        ] })
      ] }),
      /* @__PURE__ */ r(
        he,
...
const br = m.forwardRef(
  ({
    ...
    const [c, p] = m.useState(t), f = e ?? c, h = m.useCallback(
      ...
      [n, f]
    ), g = m.useCallback(() => h((R) => !R), [h]), b = f ? "expanded" : "collapsed", I = at() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = m.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(gr.Provider, { value: y, children: /* @__PURE__ */ r(vn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const cs = Vt(
  ...
  ({
    ...
    const u = t ? qt : "button", { state: c } = Me(), p = /* @__PURE__ */ r(
      u,
      {
        ref: w,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(De, { side: "right", align: "center", hidden: c !== "collapsed", ...o })
    ] })) : p;
  }
);
...
const Rt = "scrBook", bs = "scrRef", At = "source", vs = "details", xs = "Scripture Reference", ys = "Scripture Book", _r = "Type", Ns = "Details";
function ks(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? X.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === Rt ? Ft(o.start) : void 0;
      },
...
function tw({
  ...
  const [c, p] = z([]), [f, h] = z([{ id: Rt, desc: !1 }]), [g, b] = z({}), x = J(
    () => t.flatMap((k) => k.data.map((C) => ({
      ...C,
      source: k.source
    }))),
    [t]
  ...
  St(() => {
    if (w) {
      const k = I.getSelectedRowModel().rowsById, C = Object.keys(k);
      if (C.length === 1) {
        const $ = x.find((V) => Ln(V) === C[0]) || void 0;
        $ && w($);
      }
    }
  }, [g, x, w, I]);
  const y = o ?? ys, R = s ?? _r, F = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Rt] },
    { label: `Group by ${R}`, value: [At] },
    {
  ...
  }, E = (k, C) => k.getIsGrouped() ? "" : d("banded-row", C % 2 === 0 ? "even" : "odd"), j = (k, C, $) => {
    ...
    !e && /* @__PURE__ */ l(
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(No, { children: F.map((k) => /* @__PURE__ */ r(dt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Se, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Te, { children: I.getHeaderGroups().map((k) => /* @__PURE__ */ r(Ct, { children: k.headers.filter((C) => C.column.columnDef.header).map((C) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(de, { colSpan: C.colSpan, className: "top-0 tw-sticky", children: C.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(Ee, { children: I.getRowModel().rows.map((k, C) => {
        const $ = at();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            children: k.getVisibleCells().map((V) => {
              if (!(V.getIsPlaceholder() || V.column.columnDef.enableGrouping && !V.getIsGrouped() && (V.column.columnDef.id !== At || !n)))
                return /* @__PURE__ */ r(
                  zt,
                  {
                    className: d(
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ l(
                      M,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ r(Ne, {}),
                          !k.getIsExpanded() && ($ === "ltr" ? /* @__PURE__ */ r(Yt, {}) : /* @__PURE__ */ r(Be, {})),
                          " ",
                          ie(V.column.columnDef.cell, V.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
function Rs({
  ...
  }, [N, I] = z(!1), [y, R] = z(""), F = nt(void 0), L = nt(!1);
  if (t.length !== X.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const A = J(() => X.allBookIds.filter(
    (S, q) => t[q] === "1" && !X.isObsolete(X.bookIdToNumber(S))
  ), [t]), E = J(() => {
    if (!y.trim()) {
      const _ = {
        [O.OT]: [],
    ...
    (S, q = !1) => {
      ...
      const _ = A.findIndex((T) => T === F.current), Q = A.findIndex((T) => T === S);
      if (_ === -1 || Q === -1) return;
      const [xt, Xt] = [
        Math.min(_, Q),
        Math.max(_, Q)
      ], Dt = A.slice(xt, Xt + 1).map((T) => T);
      n(
        e.includes(S) ? e.filter((T) => !Dt.includes(T)) : [.../* @__PURE__ */ new Set([...e, ...Dt])]
      );
    },
    [e, n, A]
  ), k = (S) => {
    j(S, L.current), L.current = !1;
  }, C = (S, q) => {
    S.preventDefault(), j(q, S.shiftKey);
  }, $ = H(
    (S) => {
      const q = kn(A, S).map((_) => _);
      n(
        Rr(A, S, e) ? e.filter((_) => !q.includes(_)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, A]
  ), V = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(O).map((S) => /* @__PURE__ */ r(
      _s,
      {
        section: S,
        availableBookIds: A,
                    ...
                    if (_.length !== 0)
                      return /* @__PURE__ */ l(jn, { children: [
                        /* @__PURE__ */ r(
                          Tt,
                          {
                            heading: nr(S, h, g, b, x),
                            children: _.map((Q) => /* @__PURE__ */ r(
                              ar,
                              {
                                bookId: Q,
                        ...
                        q < Object.values(O).length - 1 && /* @__PURE__ */ r(qn, {})
                      ] }, S);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Le ? Le : $n
      ).map((S) => /* @__PURE__ */ r(ve, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ht(S, o) }, S)),
...
function nw({
  ...
  const c = It(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = It(i, "%webView_scope_selector_current_book%"), g = It(i, "%webView_scope_selector_choose_books%"), b = It(i, "%webView_scope_selector_scope%"), x = It(i, "%webView_scope_selector_select_books%"), N = [
  ...
  ], I = e ? N.filter((y) => e.includes(y.value)) : N;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        dn,
        {
          ...
          children: I.map(({ value: y, label: R, id: F }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(be, { className: "tw-me-2", value: y, id: F }),
            /* @__PURE__ */ r(rt, { htmlFor: F, children: R })
          ] }, F))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(dt, { value: `${c}`, children: w[G(c)] }, `${c}`))
          }
        )
      ]
    }
...
Mr.displayName = lt.Content.displayName;
function lw({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
Ir.displayName = U.Root.displayName;
...
const Vs = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    U.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(U.ItemIndicator, { children: /* @__PURE__ */ r(Et, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
Ms.displayName = U.Label.displayName;
...
const ae = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ l(xn, { children: [
      ...
      c.tooltip && /* @__PURE__ */ r(De, { children: c.tooltip })
  ...
  if (ja(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), ae(w, [h, g]);
        break;
      case "alt+h":
        (I = u.current) == null || I.focus(), ae(u, [h, g]);
        break;
    }
  }), St(() => {
    ...
    return /* @__PURE__ */ r(Ir, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ l(Ts, { children: [
      /* @__PURE__ */ r(Or, { ref: c(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        zr,
        {
          className: "tw-z-[250]",
...
function pw({
  ...
  const c = Os(
    ...
    var I, y, R, F, L, A;
    const N = x !== b ? ((y = (I = t[b]) == null ? void 0 : I.uiNames) == null ? void 0 : y[x]) ?? ((F = (R = t[b]) == null ? void 0 : R.uiNames) == null ? void 0 : F.en) : void 0;
    return N ? `${(L = t[b]) == null ? void 0 : L.autonym} (${N})` : (A = t[b]) == null ? void 0 : A.autonym;
  };
  return /* @__PURE__ */ l("div", { id: u, className: d("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(rt, { className: "tw-font-normal tw-text-muted-foreground", children: Ia(c, {
...
const fw = K.Root, gw = K.Trigger, bw = K.Group, vw = K.Portal, xw = K.Sub, yw = K.RadioGroup, Fs = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  K.SubTrigger,
  {
    ref: o,
    className: d(
...
const Ks = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ l(
  K.CheckboxItem,
  {
    ...
    ...a,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(K.ItemIndicator, { children: /* @__PURE__ */ r(Et, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
...
const mi = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = z(void 0), [w, u] = z(void 0), c = H(
    (h) => {
      i(h);
