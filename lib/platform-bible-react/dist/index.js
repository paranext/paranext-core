...
import { c as v, g as Ae, a as Fr, C as tr, L as Gn, u as an, T as zt, b as kt, d as _t, e as Nt, A as _a, D as Be, f as Se, h as je, i as cr, j as Ge, B as tt, x as Cs, k as Es, l as Ts, I as Ss, m as Ro, n as Xe, r as Oe, o as Rs, p as Wn, P as lr, q as Rr, s as dr, t as wr, v as za, w as Pa, y as Do, z as ur, E as Aa, F as It, R as Oo, G as Na, H as co, J as lo, K as wo, M as uo, N as Yn, O as ha, Q as Mo, S as qr, U as Gr, V as xr, W as Ds, X as ir, Y as Ze, Z as Fe, _ as We, $ as yr, a0 as Io, a1 as zo, a2 as Ca, a3 as Po, a4 as Zn, a5 as Os, a6 as Ms, a7 as Is, a8 as po, a9 as Xn, aa as $a, ab as zs, ac as Jn, ad as Ps, ae as As, af as $s, ag as on, ah as Vs, ai as Ls, aj as Bs, ak as Qn, al as ti, am as Ao, an as js, ao as ei, ap as qa, aq as nn, ar as Ga, as as Fs, at as Us, au as Ks, av as Hs, aw as qs, ax as Gs, ay as Xr, az as $o, aA as Ws, aB as Ys } from "./resizable-DOlm3N_b.js";
...
import { Avatar as Uo, Select as Jt, Checkbox as fn, Slot as ea, Tabs as be, Menubar as Me, ContextMenu as Ft, Progress as mn, Slider as ca, Switch as vn } from "radix-ui";
import { useReactTable as Ei, getFilteredRowModel as Yl, getSortedRowModel as Ti, getPaginationRowModel as Zl, getCoreRowModel as Si, flexRender as Ur, getGroupedRowModel as Xl, getExpandedRowModel as Jl } from "@tanstack/react-table";
import Ql from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as vo, HIDDEN_NOTE_CALLER as bo, getDefaultViewOptions as td, isInsertEmbedOpOfType as $r, getMarkerMenuItems as ed, defaultStyleInfo as rd, Editorial as ad } from "@eten-tech-foundation/platform-editor";
...
function ud({
  ...
  J(() => {
    ...
    const y = (X) => !!X && X.scrollWidth > X.clientWidth, et = () => {
      xo !== "pointer" && (B || y(h.current) || y(d.current)) && C(!0);
    }, Z = () => C(!1);
...
function fd({
  ...
  const [h, f] = N(!1), [b, x] = N(!1), g = Ta(), T = V(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, hd), P = re(s, gd), B = (R) => {
  ...
  return /* @__PURE__ */ u(Be, { open: C, onOpenChange: B, modal: !1, children: [
    /* @__PURE__ */ a(zt, { children: E ? /* @__PURE__ */ u(kt, { open: b, onOpenChange: U, children: [
  ...
  const o = vd.reduce(
    (n, s) => {
      ...
      if (i) {
        ...
        if (!w && d) {
          const f = ((b) => Object.keys(_a).find(
            (x) => _a[x].toLowerCase() === b.toLowerCase()
          ))(c);
...
function Xa({
  ...
  const B = Oe(), U = dd(), [I, O] = N(!1), [R, W] = N(""), [Y, at] = N(""), [y, et] = N("books"), [Z, A] = N(void 0), [X, F] = N(
    void 0
  ), [G, ut] = N(void 0), [mt, K] = N(!1), [gt, vt] = N(!1), [lt, Dt] = N(!1), [xt, Ot] = N(!1), xe = V(null), Qt = V(!1), $t = V(void 0), Ct = V(void 0), Ut = V(void 0), pe = V(void 0), he = V({}), se = V({}), bt = $(
    (m) => {
      e(m), d && d(m);
    },
    [e, d]
    ...
    () => kd(oe, ce),
    [oe, ce]
  ), D = Tt.has(t.book), H = z(() => Y.trim() ? ko(
    ne.filter((m) => Ro(m, Y, s))
  ) : gt ? te : ye, [
    ye,
    te,
    ne,
    ...
    if (!_) return;
    const m = R.startsWith(`${_.book} `) ? R : "", q = la(m), it = Br(m);
    return {
      book: _.book,
  ...
  const L = $(() => {
    ...
    et("books"), A(void 0), F(void 0), ut(void 0), Ot(!1), setTimeout(() => {
      var m;
      (m = Ct.current) == null || m.focus();
    }, 0);
  }, []), ge = $(() => {
    const m = X;
    F(void 0), ut(void 0), m ? (A(m), et("chapters"), W("")) : yt();
  }, [X, yt]), Kt = $(
    (m) => {
      O(m), m && (et("books"), A(void 0), F(void 0), ut(void 0), at(""), Ot(!1), Dt(!1), vt(D));
    },
    [D]
  );
  J(() => {
  ...
  const { otLong: _e, ntLong: Ne, dcLong: rr, extraLong: ar } = {
    ...
    () => U >= Kr.TIGHT ? Fr(t.book, s) : Ae(t.book, s),
    [t.book, s, U]
  ), zr = `${t.chapterNum}:${t.verseNum}`, Ke = $((m) => (q) => {
    he.current[m] = q;
  }, []), S = $((m) => (q) => {
    se.current[m] = q;
  }, []), nt = z(
    () => bd(Y),
    [Y]
  ), st = z(() => !w || !_ || !_.chapterNum || !nt ? !1 : w(_.book, _.chapterNum) > 0, [w, _, nt]), Ht = y === "books" && !mt && !Y.trim() && Tt.size > 0, Pr = $(
    (m) => p ? yn(m, p) : !1,
    [p]
  ), Pe = $(
    (m) => (q) => p ? xd(m, q, p) : !1,
    ...
    (m) => {
      ...
      if ((y === "chapters" || y === "verses") && (m.key === " " || m.key === "Enter")) {
        ...
        const de = (() => {
          if (y === "verses") {
            const Ar = X, rn = G, Ha = la(R);
            return !Ar || !rn || Ha === void 0 ? void 0 : {
              isDisabled: gr(Ar, rn)(Ha),
              activate: () => ot(Ha)
            };
          }
          const Gt = Z, me = Br(R);
  ...
  const rt = _ ? `${_.book} ${_.chapterNum ?? ""} ${_.verseNum ?? ""} ${st}` : "", Pt = V(""), le = V(""), fe = z(() => {
              ...
              y === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Pa, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: Et.map(
                ...
                /* @__PURE__ */ u(kt, { children: [
                  /* @__PURE__ */ a(_t, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": ra,
                      children: B === "ltr" ? /* @__PURE__ */ a(Zs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Xs, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                      ...
                      return (
                        ...
                        /* @__PURE__ */ a(Xe, { heading: ze(m), children: q.map((it) => /* @__PURE__ */ a(
                          Di,
                          {
                            ...
                            dimmedDescription: Tt.has(it) ? oa(it) : void 0
                          },
                          it
                        )) }, m)
                      );
                  ...
                  _ && M && /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ u(
                    tr,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: Fr(_.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
...
function yh({
  ...
  const w = Ja(l, "%webView_bookSelector_currentBook%"), p = Ja(l, "%webView_bookSelector_choose%"), h = Ja(l, "%webView_bookSelector_chooseBooks%"), [f, b] = N(
    "current book"
    /* CurrentBook */
  ), x = (g) => {
    b(g), t(g);
...
const Pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dd = Pi ? Xt : J, wa = { tag: Bo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (f.isEmpty()) {
            ...
            (ae() !== null || x !== null && x === p.getRootElement()) && b.select();
          }
        }, wa);
...
const Md = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : J;
...
const Vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : J;
function Ld(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Bd() {
  return function(t) {
    const [e] = Ie(), r = z(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), s = V(o);
    return Vd(() => {
...
function qd(t, e = Hd) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), b = h.getNode(), x = b.getKey(), g = h.offset, T = f.getNode(), k = T.getKey(), C = f.offset, E = t.getElementByKey(x), P = t.getElementByKey(k), B = r === null || E !== o || g !== n || x !== r.getKey(), U = s === null || P !== i || C !== c || k !== s.getKey();
      if ((B || U) && E !== null && P !== null) {
        const I = function(O, R, W, Y, at, y, et) {
          const Z = (O._window ? O._window.document : document).createRange();
          return Z.setStart(...Cn(R, W, Y)), Z.setEnd(...Cn(at, y, et)), Z;
        }(t, h, b, E, f, T, P);
        d(), d = Kd(t, I, e);
      }
      r = b, o = E, n = g, s = T, i = P, c = C;
    });
  }
...
function Yd(t) {
  ...
  if (Re(e)) r = rl(e.focus, "next");
    ...
    r = r || al(Qe(), "previous").getFlipped().insert(ta());
  }
...
function Zd(t, e, r) {
  ...
  return dl(o) && Sa(283), o.insert(t.isInline() ? ta().append(t) : t), pn(mi(t.getLatest(), "next"), e.direction);
}
function Xd(t) {
  const e = ae();
  if (!Re(e)) return !1;
...
let Ra, Ve = 0, Da = 0, tw = 0, Co = 0, ba = 0;
function Tn(t) {
  if (wt === void 0) return;
  let e = t.n;
...
function or(t, e) {
  Yt.call(this, void 0), this.x = t, this.s = void 0, this.g = ba - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function ew(t, e) {
  return new or(t, e);
}
...
function rw(t) {
  ...
  Vi(this), wt = t, this.f &= -2, 8 & this.f && qo(this), Ba();
}
function br(t, e) {
...
Yt.prototype.brand = Jd, Yt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ve !== 0 && Da === 0 && e.l !== Co && (e.l = Co, Ra = { S: e, v: e.v, i: e.i, o: Ra });
  ...
  if (this.g = ba, this.f |= 1, this.i > 0 && !$i(this)) return this.f &= -2, !0;
  const t = wt;
  try {
    Sn(this), wt = this;
    const e = this.x();
...
const Go = 0, To = 1, Hi = 2, eo = 3, ua = 4, vr = 5, ro = 6, Vr = 7;
function ao(t) {
  return t.id === Go;
}
function qi(t) {
...
const ww = /* @__PURE__ */ new Set(), Mn = ue({ build(t, e, r) {
  const o = r.getDependency(Eo).output, n = Yr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Ui(() => {
  }, () => De(() => {
...
ue({ dependencies: [Eo, Mn], name: "@lexical/extension/HorizontalRule", nodes: () => [Nr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Mn).output, n = Yr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (Re(b)) {
                ...
                if (mo(g) && l >= 0 && w >= 0 && (T = l, k = l + w, b.setTextNodeRange(g, T, g, k)), T === k && p === "" || (b.insertRawText(p), g = x.getNode()), mo(g)) {
                  T = h, k = h + f;
                  const C = g.getTextContentSize();
                  T = T > C ? C : T, k = k > C ? C : k, b.setTextNodeRange(g, T, g, k);
                }
...
const Yo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : J;
...
const Ew = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : J;
...
function Vn({
  ...
  const w = Mr(), [p, h] = N(), f = d ?? p, x = f !== void 0 && o, g = l !== void 0, T = $(
    (y) => {
      g || h(y), l == null || l(y);
    },
    [g, l]
  ...
  const E = $(
    ...
    [t.user]
  ), O = z(() => Vo(t.contents), [t.contents]), R = z(
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Yw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Zw, { className: "tw:text-xs tw:font-medium", children: I }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          x && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: k,
              onKeyDownCapture: (y) => {
                y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), E()) : Xo(y) && (y.preventDefault(), y.stopPropagation(), ie(f) && P());
              },
              onKeyDown: (y) => {
...
const Xw = {
  ...
  var Ke;
  const et = Mr(), [Z, A] = N({}), X = at ?? Z, F = X.editorState ?? Xw, G = X.assignedUser, ut = y !== void 0, mt = V(X);
  mt.current = X;
  const K = $(
    (S) => {
      const nt = { ...mt.current, ...S };
      mt.current = nt, ut || A(nt), y == null || y(l, $n(nt) ? void 0 : nt);
    },
    [ut, y, l]
  ), gt = $(
    (S, nt) => {
      ...
      nt === void 0 ? delete st[S] : st[S] = nt, K({
        commentEdits: jr(st) ? st : void 0
      });
    },
    [X.commentEdits, K]
  ), [vt, lt] = N(), Dt = n, [xt, Ot] = N(!1), [xe, Qt] = N(!1), [$t, Ct] = N(!1), [Ut, pe] = N(!1), [he, se] = N(!1), [bt, oe] = N(P), [ce, ye] = N(!1), te = V(void 0), [ne, ke] = N(/* @__PURE__ */ new Map());
  J(() => {
    let S = !0;
    return (async () => {
  ...
  _.current = l, J(() => () => {
    var nt;
    const { current: S } = mt;
    S.assignedUser !== void 0 && S.assignedUser === D.current && S.editorState === void 0 && !jr(S.commentEdits) && ((nt = H.current) == null || nt.call(H, _.current, void 0));
  }, []);
  const M = z(
  ...
  const ot = z(() => M[0], [M]), dt = V(null), ct = V(void 0), pt = $(() => {
    var S;
  ...
  const ze = $(
    ...
    async (S) => {
      const nt = ie(F) ? Ma(F) : void 0, st = S.status ? S.assignedUser : G ?? S.assignedUser, Ht = await h({
        ...S,
        contents: nt,
        assignedUser: st
      });
  ...
  const hr = !Ut || !g || g.length === 0 || !g.includes(c), Ir = !ie(F) && (G === void 0 || G === vt), zr = /* @__PURE__ */ a(
    Vn,
    {
      comment: ot,
      localizedStrings: o,
          ...
          n && /* @__PURE__ */ u(ht, { children: [
            ...
            T !== !1 && (!L || ie(F)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  Xo(S) && (S.preventDefault(), S.stopPropagation(), (ie(F) || G !== void 0 && G !== vt) && ze());
                },
                onKeyDown: (S) => {
                ...
                children: /* @__PURE__ */ a(
                  Oa,
                  {
                    ...
                    actions: /* @__PURE__ */ u(ht, { children: [
                      G !== void 0 && (ie(F) || G !== vt) ? /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ye(
                        we(
                          "%comment_assigning_to%",
                          o,
                          ...
                          dr,
                          {
                            ...
                            children: /* @__PURE__ */ a(wr, { children: /* @__PURE__ */ a(ur, { children: g == null ? void 0 : g.map((S) => /* @__PURE__ */ a(
                              tr,
                              {
                                ...
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: xa(S, o) })
                              },
                              S || "unassigned"
                            )) }) })
                          }
...
), Qw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ya = (t) => Qw(Vo(t));
function ka({ html: t }) {
  const e = Mr();
  return /* @__PURE__ */ a(
    "div",
...
function tu({
  ...
  const [i, c] = N("accept"), d = Ta(), l = Ta(), w = Mr(), p = r === "loading", h = r === "accept", f = r === "none", b = r === "acceptRejectOrMerge", x = h ? "accept" : i, g = z(
    () => ya(t.rejectedText ?? ""),
    [t.rejectedText]
  ), T = z(
    () => ya(t.acceptedText ?? ""),
    ...
    () => ya(t.mergedText ?? ""),
    [t.mergedText]
  ), C = z(() => Vo(t.contents), [t.contents]);
  if (!is(t))
    return /* @__PURE__ */ a(ka, { html: C });
  const E = (A) => {
    c(A === "reject" || A === "merge" ? A : "accept");
  }, P = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", B = b ? [
    {
      value: "merge",
  ...
  const W = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: W }), at = (A) => A ? /* @__PURE__ */ a(
    ...
    const A = o ?? "accept";
    return A === "merged" ? t.mergedText ? /* @__PURE__ */ a(ka, { html: k }) : Y : at(A === "reject" ? t.rejectedResultText : t.resultText);
  }, et = (A) => h && A.value === "reject", Z = (A) => {
    const X = x === A.value, F = `${l}-${A.value}`, G = et(A);
    return (
...
function Ih({
  ...
  const [E, P] = N(/* @__PURE__ */ new Set()), [B, U] = N(), [I, O] = N(), R = $(
    async (F) => {
      const G = await s(F);
      return G !== void 0 && F.assignedUser !== void 0 && F.assignedUser !== "" && O(F.assignedUser), G;
    },
    [s]
  );
  J(() => {
    b && (P((F) => new Set(F).add(b)), U(b));
  }, [b]);
  const W = r.filter(
    (F) => F.comments.some((G) => !G.deleted)
  ), Y = W.map((F) => ({ id: F.id })), at = $(
    (F) => {
      P((G) => new Set(G).add(F.id)), U(F.id), x == null || x(F.id);
    },
    [x]
  ), y = $(
    (F) => {
      ...
      P((ut) => {
        const mt = new Set(ut);
        return mt.has(F) ? mt.delete(F) : mt.add(F), mt;
      }), U(F), x == null || x(G ? void 0 : F);
    },
    [E, x]
  ), { listboxRef: et, activeId: Z, handleKeyDown: A } = Ds({
    options: Y,
    onOptionSelect: at
  }), X = $(
    (F) => {
      F.key === "Escape" ? (B && E.has(B) && (P((G) => {
        const ut = new Set(G);
        return ut.delete(B), ut;
      }), U(void 0), x == null || x(void 0)), F.preventDefault(), F.stopPropagation()) : A(F);
    },
    [B, E, A, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: W.map((F) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: F.type === "Conflict" ? /* @__PURE__ */ a(nu, { ...G, conflictResolution: T }) : /* @__PURE__ */ a(ls, { ...G })
          },
          F.id
        );
      })
...
function uu({
  ...
  var B;
  const [w, p] = N([]), [h, f] = N([]), [b, x] = N({}), [g, T] = N({}), k = z(() => e ?? [], [e]), C = Ei({
    data: k,
    columns: t,
    getCoreRowModel: Si(),
  ...
  return d ? P = Array.from({ length: 10 }).map((O, R) => `skeleton-row-${R}`).map((O) => /* @__PURE__ */ a(We, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(yr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(xr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, O)) : ((B = C.getRowModel().rows) == null ? void 0 : B.length) > 0 ? P = C.getRowModel().rows.map((U) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Io, { stickyHeader: s, children: [
      /* @__PURE__ */ a(zo, { stickyHeader: s, children: C.getHeaderGroups().map((U) => /* @__PURE__ */ a(We, { children: U.headers.map((I) => /* @__PURE__ */ a(Ca, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : Ur(I.column.columnDef.header, I.getContext()) }, I.id)) }, U.id)) }),
      /* @__PURE__ */ a(Po, { children: P })
    ] }),
...
function Nu({
  ...
  const n = V(null), s = V(null), i = V(!1), [c, d] = N(t), [l, w] = N(e), [p, h] = N(!1), f = V(!1), b = V(c);
  b.current = c;
  const x = V(l);
  x.current = l, J(() => {
    d(t);
...
function Mu(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, i]) => {
    s.push(
      ...i.map((c) => ({
        marker: c,
        title: r[fa[c].description] ?? fa[c].description,
        action: () => {
          var d;
...
function Kh({
  ...
  var Tt;
  const h = V(null), f = V(null), b = V(null);
  Xt(() => {
    if (!b.current) return;
    const D = parseFloat(getComputedStyle(b.current).width);
    D > 0 && (b.current.style.width = `${D}px`);
  }, []);
  const [x, g] = N("generated"), [T, k] = N("generated"), [C, E] = N("*"), [P, B] = N("*"), [U, I] = N("f"), [O, R] = N(!1), [W, Y] = N(!0), [at, y] = N(!1), et = V(!1), Z = V(""), [A, X] = N(!1), F = xu(), [G, ut] = N(), mt = V(null), K = V(
    void 0
  ), gt = V(0), vt = V(void 0), lt = z(
    () => ({
      ...i,
  ...
  J(() => {
    ...
    if (M && $r("note", M)) {
      ...
      let dt = "custom";
      ot === vo ? dt = "generated" : ot === bo ? dt = "hidden" : ot && (E(ot), B(ot)), g(dt), k(dt), I(((L = M.insert.note) == null ? void 0 : L.style) ?? "f"), D = setTimeout(() => {
        var ct, pt, Et;
  ...
  const Ot = $(
    ...
    (D, H) => {
      ...
      let M;
      D === "custom" ? M = H : D === "generated" ? M = vo : M = bo, _.insert.note.caller !== M && (_.insert.note.caller = M, (ot = h.current) == null || ot.applyUpdate([_, { delete: 1 }]));
    },
    []
  ), Qt = $(() => {
    var D;
  ...
  const Ut = () => {
    ...
    if (H && $r("note", H)) {
      ...
      U !== "x" && D === "x" ? dt == null || dt.forEach((ct) => zu(ct)) : U === "x" && D !== "x" && (dt == null || dt.forEach((ct) => Pu(ct))), (ot = h.current) == null || ot.applyUpdate([H, { delete: 1 }]);
    }
  }, se = (D) => {
    ...
    (D, H, _) => {
      ...
      As({
        ...
        clearSessionIfCurrent: (L) => on(K, L),
        ...
        onShowError: (L) => {
          (!Pc(L) || L.code !== Ac) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${$c(L)}`
          );
        }
      });
    },
  ...
  return /* @__PURE__ */ u(ht, { children: [
    ...
    /* @__PURE__ */ u(lr, { open: A, children: [
      /* @__PURE__ */ a(Vs, { virtualRef: F.virtualRef }),
      /* @__PURE__ */ a(
        dr,
        {
...
const Hh = Object.freeze([
  ...Su,
  ...Object.entries(fa).map(([, t]) => t.description).filter((t) => !!t),
...
function Lu({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Jo(t.marker, [i], o, !1),
    " "
  ] }), f = !!d, b = !!w, x = !!p, g = e === "horizontal" ? "horizontal" : "vertical", T = o ? "marker-visible" : "", k = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = v(g, T);
  return /* @__PURE__ */ u(ht, { children: [
...
function qh({
  ...
  const p = l ?? Vc(r, void 0), h = (E, P) => {
    w == null || w(E, P, n);
  }, f = s ? r.findIndex((E) => E === s) : -1, [b, x] = N(f), g = (E, P, B) => {
    if (r.length)
      switch (E.key) {
        case "Enter":
        case " ":
  ...
  J(() => {
    var E;
    b >= 0 && b < k.current.length && ((E = k.current[b]) == null || E.focus());
  }, [b]);
...
function tg({
  ...
  const f = Ee(r, "%webView_inventory_all%"), b = Ee(r, "%webView_inventory_approved%"), x = Ee(r, "%webView_inventory_unapproved%"), g = Ee(r, "%webView_inventory_unknown%"), T = Ee(r, "%webView_inventory_scope_currentBook%"), k = Ee(r, "%webView_inventory_scope_chapter%"), C = Ee(r, "%webView_inventory_scope_verse%"), E = Ee(r, "%webView_inventory_filter_text%"), P = Ee(
    r,
    "%webView_inventory_show_additional_items%"
  ...
  }, [U, et]), A = z(() => Z.length === 0 ? [] : Hu(Z, O, W), [Z, O, W]), X = z(() => {
    var vt, lt;
    if (!U) return d;
...
function rp({
  ...
  const c = t ? ea.Root : "button", { state: d } = Fa(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(ep({ variant: r, size: o }), s),
      ...i
    }
  );
...
function gg({
  ...
  const [l, w] = N([]), [p, h] = N([{ id: He, desc: !1 }]), [f, b] = N({}), x = z(
  ...
  J(() => {
    if (c) {
      ...
      if (R.length === 1) {
        const W = x.find((Y) => Hn(Y) === R[0]) || void 0;
        W && c(W);
      }
    }
  }, [f, x, c, T]);
  const k = n ?? sp, C = s ?? us, E = [
  ...
  }, U = (O, R) => O.getIsGrouped() ? "" : v("banded-row", R % 2 === 0 ? "even" : "odd"), I = (O, R, W) => {
    ...
    !e && /* @__PURE__ */ u(
      Cr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Sr, { position: "item-aligned", children: /* @__PURE__ */ a(cu, { children: E.map((O) => /* @__PURE__ */ a(ve, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Io, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(zo, { children: T.getHeaderGroups().map((O) => /* @__PURE__ */ a(We, { children: O.headers.filter((R) => R.column.columnDef.header).map((R) => (
      ...
      /* @__PURE__ */ a(Po, { children: T.getRowModel().rows.map((O, R) => {
        const W = Oe();
        return /* @__PURE__ */ a(
          We,
          {
                    ...
                    children: Y.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        children: [
                          ...
                          !O.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(Nc, {}) : /* @__PURE__ */ a(Cc, {})),
                          " ",
...
function wp({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: b, extraLong: x } = {
  ...
  }, [g, T] = N(!1), [k, C] = N(""), E = V(void 0), P = V(!1), B = z(
    () => ti(t),
    [t]
  ), U = z(() => {
    if (!k.trim()) {
    ...
    () => Object.values(Mt).filter(
      (y) => (s == null ? void 0 : s[y]) !== void 0 && Ao(B, y).length === 0
...
function mg({
  ...
  const B = Bt(
  ...
  ] }), lt = e ? gt.filter((j) => e.includes(j.value)) : gt, Dt = g ?? Ya, xt = h ?? Dt, Ot = f ?? Dt, xe = () => {
  }, Qt = V(null), $t = V(null), Ct = V(!1), Ut = V(null), pe = V(!1), [he, se] = N(void 0), bt = V(!1), oe = V(!1), ce = V(null), ye = $((j) => {
    if (j) {
    ...
    (j) => {
      b == null || b(j), x == null || x(j), bt.current = !0;
    },
    [b, x]
  ), ke = $(
    (j) => {
    ...
    [r, n, g, s]
  ), D = lt.find((j) => j.value === t), H = () => t === "selectedBooks" && n.length > 0 ? n.map((j) => j.toUpperCase()).join(", ") : t === "range" ? Bc(xt, Ot, {
  ...
  ), M = lt.find((j) => j.value === "selectedBooks"), Q = lt.find((j) => j.value === "range"), [L, ot] = N(!1), [dt, ct] = N(void 0), [pt, Et] = N(void 0), [Rt, yt] = N(void 0), [ge, Kt] = N(void 0), [Vt, Ue] = N([]), _e = p === "dropdown" && dt === "selectedBooks", Ne = /* @__PURE__ */ a(
    hp,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { ref: Qt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(It, { htmlFor: "scope-range-end", className: v(ar && ze), children: F }),
      /* @__PURE__ */ a(
        Xa,
        {
          id: "scope-range-end",
  ...
  const [Ht, Pr] = N(null), [Pe, gr] = N(null), [fr, Ua] = N(null), ra = 200, [Ka, aa] = N(!1);
  J(() => {
    if (!fr || typeof ResizeObserver > "u") return;
    const j = new ResizeObserver(([rt]) => {
      aa(rt.contentRect.width < ra);
    });
    return j.observe(fr), () => j.disconnect();
  }, [fr]);
  const oa = $(
    (j) => {
      Et(j), yt(xt), Kt(Ot), Ue(n), ot(!1), ct(j);
    },
    [xt, Ot, n]
  ), na = $(() => {
    pt !== void 0 && (pt === "range" ? (Rt && (b == null || b(Rt)), ge && (x == null || x(ge))) : pt === "selectedBooks" && s(Vt), Tt(pt), ct(void 0), Et(void 0));
  }, [
    pt,
    Rt,
    ge,
  ...
  }, []), sa = (j) => t === j ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Je, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          Xa,
                          {
                            ...
                            onCloseAutoFocus: (j) => {
                              var rt;
                              j.preventDefault(), (rt = Ut.current) == null || rt.focus();
                            },
                            modal: !0,
    ...
    p === "radio" && t === "range" && Ke,
    p === "dropdown" && M && /* @__PURE__ */ a(co, { open: dt === "selectedBooks", onOpenChange: mr, children: /* @__PURE__ */ a(
      lo,
      {
        ref: gr,
        onCloseAutoFocus: ia,
        ...
        children: /* @__PURE__ */ u(qa, { container: Pe, children: [
          /* @__PURE__ */ a(wo, { className: "tw:pe-8", children: /* @__PURE__ */ a(uo, { children: at }) }),
          Ne,
          /* @__PURE__ */ u(nn, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => mr(!1), children: ut }),
            /* @__PURE__ */ a(tt, { onClick: na, children: G })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && Q && /* @__PURE__ */ a(co, { open: dt === "range", onOpenChange: mr, children: /* @__PURE__ */ a(
      lo,
      {
        ref: Pr,
        onCloseAutoFocus: ia,
        onEscapeKeyDown: (j) => {
          Ht != null && Ht.querySelector('[data-state="open"]') && j.preventDefault();
        },
        children: /* @__PURE__ */ u(qa, { container: Ht, children: [
          /* @__PURE__ */ a(wo, { className: "tw:pe-8", children: /* @__PURE__ */ a(uo, { children: A }) }),
          Ke,
          /* @__PURE__ */ u(nn, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => mr(!1), children: ut }),
            /* @__PURE__ */ a(tt, { ref: ce, onClick: na, children: G })
          ] })
        ] })
      }
    ) })
...
function So({
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    ...
    /* @__PURE__ */ a(je, { align: "start", style: { zIndex: Fe }, children: w.map(({ columnKey: h, label: f }, b) => {
      const x = `${l}-${h}`;
      return /* @__PURE__ */ u(Qr, { children: [
...
const xp = Object.freeze([520, 420, 340]), vs = Zt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = ms(n, xp), l = Mi() ?? d, w = l >= Kr.MINIMUM;
  ...
  if (od(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), Lr(s, [h, f]);
        break;
      case "alt+l":
...
function Eg({
  ...
  return /* @__PURE__ */ a(La.Provider, { value: b, children: /* @__PURE__ */ a(
    "div",
    {
...
function Tg({
  ...
  const l = Pp(
    ...
    var T, k, C, E, P, B;
    const g = x !== b ? ((k = (T = t[b]) == null ? void 0 : T.uiNames) == null ? void 0 : k[x]) ?? ((E = (C = t[b]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
    return g ? `${(P = t[b]) == null ? void 0 : P.autonym} (${g})` : (B = t[b]) == null ? void 0 : B.autonym;
  };
...
function Rg({
  ...
  const [i, c] = N(""), d = z(
    ...
    return d.filter(({ keywords: x }) => x.some((g) => g.toLowerCase().includes(b)));
  }, [d, i]), w = d.length > 1, p = o["%firstRun_language_search_placeholder%"] ?? "", h = o["%firstRun_language_noResults%"] ?? "", f = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(wr, { id: s, className: v("pr-twp", n), shouldFilter: !1, children: [
...
function Hg({
  ...
  return /* @__PURE__ */ u(
    Ft.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Ft.ItemIndicator, { children: /* @__PURE__ */ a(Va, {}) }) }),
        e
      ]
    }
  );
...
function df({
  ...
  return /* @__PURE__ */ a(
    be.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Fp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
const Kp = (t, e, r = {}) => {
  ...
  const [e, r] = N(!1), [o, n] = N(!1), [s, i] = N(0), c = V(void 0), d = z(() => {
    if (!t) return;
    const h = async () => {
      try {
        const f = await t();
...
function mf(t) {
  const e = z(() => jc(t).slice().sort().join(" "), [t]);
