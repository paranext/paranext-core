...
var Ii = (t, e, r) => e in t ? Pi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Pt = (t, e, r) => Ii(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Kt, Z as Vi, B as U, c as g, a as Li, g as Oe, b as Wa, C as Ee, A as ne, P as Te, d as Ve, e as ze, f as Le, h as Be, i as de, m as Bi, j as Xa, k as Fi, l as wn, n as Er, o as ra, T as Zt, S as rr, p as Qt, q as te, s as ee, D as He, t as kr, u as ke, v as _e, w as Ne, x as ji, y as Tr, z as Ye, E as Ae, F as Ra, G as un, H as Ui, I as Ki, J as pn, K as hn, L as qi, M as Gi, N as Hi, O as Yi, Q as Wi, R as pa, Y as ha, U as lr, V as Xi, W as Ji, X as Zi, _ as Qi, $ as ts, a0 as zr, a1 as Ja } from "./resizable-CTzNXoVx.js";
import { a2 as Xh, a3 as Jh, a4 as Zh, a5 as Qh, a6 as tg, a7 as eg, a8 as rg, a9 as ag, aa as og } from "./resizable-CTzNXoVx.js";
import { jsx as a, jsxs as u, Fragment as rt } from "react/jsx-runtime";
import { Canon as ft } from "@sillsdev/scripture";
import { Check as Pe, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as $a, ChevronRight as Ma, ArrowLeft as es, ArrowRight as rs, ChevronDown as ar, BoldIcon as as, ItalicIcon as os, X as aa, AtSign as gn, Pencil as ns, Trash2 as is, ArrowUp as fn, MoreHorizontal as ss, MailOpen as cs, Mail as ls, ChevronUp as ds, FilterIcon as ws, ArrowLeftIcon as us, ChevronLeftIcon as ps, ChevronRightIcon as hs, ArrowRightIcon as gs, Copy as mn, Filter as fs, User as ms, Link as vs, CircleHelp as bs, ChevronsUpDown as vn, Star as xs, Undo as ys, Redo as ks, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as _s, AlertCircle as Oa, CircleCheckIcon as Ns, CircleXIcon as Cs, CircleHelpIcon as Es, ArrowUpIcon as Ts, ArrowDownIcon as zs, Search as Ss, LoaderCircle as Ds, ScrollText as Rs, MenuIcon as $s, Menu as Ms, EllipsisVertical as Os, MoreVertical as No } from "lucide-react";
import { Section as ct, getChaptersForBook as As, formatScrRef as xe, getSectionForBook as br, formatRelativeDate as Ps, formatReplacementString as be, sanitizeHtml as Is, NumberFormat as Vs, formatBytes as Ls, getCurrentLocale as Bs, usfmMarkers as jr, getFormatCallerFunction as Fs, deepEqual as js, isString as Co, compareScrRefs as Aa, scrRefToBBBCCCVVV as ga, defaultScrRef as fa, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as Eo } from "platform-bible-utils";
import lt, { useRef as K, useMemo as V, useState as k, useCallback as B, useEffect as W, useImperativeHandle as Ks, useLayoutEffect as Ht, createContext as Za, useContext as kn, Component as qs, createElement as To, Suspense as Gs, forwardRef as oa, Fragment as _n } from "react";
import { Dialog as we, Label as Hs, RadioGroup as Pa, ToggleGroup as Nn, Slot as dr, Avatar as Qa, Select as Vt, Checkbox as zo, Tabs as se, Menubar as he, ContextMenu as zt, Progress as So, Slider as Pr, Switch as Do } from "radix-ui";
import { createEditor as Cn, $getRoot as Ie, $createParagraphNode as Sr, $getSelection as Ut, HISTORY_MERGE_TAG as to, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Ys, $isRangeSelection as ue, $caretFromPoint as Ws, $getSiblingCaret as zn, $getChildCaret as Xs, $getAdjacentChildCaret as Js, $isChildCaret as Zs, $normalizeCaret as Qs, $setSelectionFromCaretRange as tc, $getCollapsedCaretRange as ec, $getCaretInDirection as Ro, $splitAtPointCaretNext as rc, $isTextPointCaret as ac, $findMatchingParent as Sn, $isElementNode as _r, mergeRegister as Ce, getDOMTextNode as oc, isHTMLElement as nc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as ic, defineExtension as re, safeCast as We, createState as sc, FORMAT_TEXT_COMMAND as Rn, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as Mn, RootNode as cc, LineBreakNode as lc, TabNode as dc, $isEditorState as wc, createCommand as uc, CLICK_COMMAND as pc, isDOMNode as hc, $getNodeFromDOMNode as gc, $createNodeSelection as fc, $setSelection as mc, $getEditor as vc, DecoratorNode as Ia, $getState as bc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as xc, $setState as yc, addClassNamesToElement as On, $create as kc, $getNodeByKey as _c, removeClassNamesFromElement as Nc, KEY_TAB_COMMAND as Cc, $isBlockElementNode as Ec, $createRangeSelection as Tc, $normalizeSelection__EXPERIMENTAL as zc, OUTDENT_CONTENT_COMMAND as Sc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Dc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Rc, $isParagraphNode as $c, $isTextNode as Va, SELECTION_CHANGE_COMMAND as An, $insertNodes as Mc } from "lexical";
import { HeadingNode as Oc, QuoteNode as Ac, registerRichText as Pc } from "@lexical/rich-text";
import { flushSync as Ic, createPortal as Vc } from "react-dom";
import { IconX as Lc, IconCheck as na, IconChevronDown as Bc, IconChevronUp as Fc, IconSelector as jc, IconLayoutSidebar as Uc, IconLayoutSidebarRight as Kc, IconChevronRight as Pn, IconLoader as qc, IconAlertOctagon as Gc, IconAlertTriangle as Hc, IconInfoCircle as Yc, IconCircleCheck as Wc } from "@tabler/icons-react";
...
import { useReactTable as Vn, getFilteredRowModel as Qc, getSortedRowModel as Ln, getPaginationRowModel as tl, getCoreRowModel as Bn, flexRender as xr, getGroupedRowModel as el, getExpandedRowModel as rl } from "@tanstack/react-table";
import al from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as La, HIDDEN_NOTE_CALLER as Ba, getDefaultViewOptions as ol, isInsertEmbedOpOfType as Ir, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
import { toast as ig } from "sonner";
function Fa({ ...t }) {
  return /* @__PURE__ */ a(we.Root, { "data-slot": "dialog", ...t });
}
function Gu({ ...t }) {
  return /* @__PURE__ */ a(we.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function ll({ ...t }) {
  return /* @__PURE__ */ a(we.Portal, { "data-slot": "dialog-portal", ...t });
}
function Hu({ ...t }) {
  return /* @__PURE__ */ a(we.Close, { "data-slot": "dialog-close", ...t });
}
function dl({
  className: t,
...
function ja({
  ...
  const s = Kt();
  return /* @__PURE__ */ u(ll, { children: [
    /* @__PURE__ */ a(dl, { className: o }),
    /* @__PURE__ */ u(
      we.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(we.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Lc, {}),
...
function Oo({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(we.Close, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ u(
        Ee,
        {
          ...
          "aria-label": `${ft.bookIdToEnglishName(e)} (${e.toLocaleUpperCase()})`,
          disabled: w,
...
function wl({
  ...
  return /* @__PURE__ */ u(Te, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(ze, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(de, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Ee,
      {
        onSelect: () => f(h),
...
function Xu(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function ao(t, e) {
  return Bi(ft.bookIdToNumber(t));
}
function ia(t, e, r) {
  const o = ft.bookIdToNumber(t);
  let n, i = r === "next" ? 1 / 0 : -1 / 0;
  return e.forEach((s) => {
    const c = ft.bookIdToNumber(s);
    (r === "next" ? c > o && c < i : c < o && c > i) && (n = s, i = c);
  }), n;
}
function ul(t, e, r) {
  ...
  const i = ia(o, e, "previous");
  if (i)
    return {
      book: i,
      chapterNum: Math.max(ao(i), 1),
      verseNum: 1
    };
}
function pl(t, e, r) {
  const { book: o, chapterNum: n } = t;
  if (e.includes(o) && n < ao(o))
    return { book: o, chapterNum: n + 1, verseNum: 1 };
  const i = ia(o, e, "next");
  if (i)
...
function hl(t, e, r) {
  const { book: o, chapterNum: n, verseNum: i } = t;
  if (e === void 0 || e.includes(o))
    return i > 1 ? { book: o, chapterNum: n, verseNum: i - 1 } : i === 1 && n === 1 ? { book: o, chapterNum: 1, verseNum: 0 } : { book: o, chapterNum: n, verseNum: 0 };
  if (e === void 0) return;
  const s = ia(o, e, "previous");
  if (!s) return;
  const c = Math.max(ao(s), 1);
  return { book: s, chapterNum: c, verseNum: Math.max(1, 1) };
}
function gl(t, e, r) {
  const { book: o, chapterNum: n, verseNum: i } = t;
  if (e === void 0 || e.includes(o))
    return { book: o, chapterNum: n, verseNum: i + 1 };
  const s = ia(o, e, "next");
  if (s)
  ...
  const o = ml.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && l) {
          const h = ((m) => Object.keys(ne).find(
            (x) => ne[x].toLowerCase() === m.toLowerCase()
          ))(c);
...
function Un({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(de, { children: /* @__PURE__ */ a("div", { className: g("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function va({
  ...
  const _ = Kt(), [I, q] = k(!1), [L, R] = k(""), [z, E] = k(""), [D, S] = k("books"), [$, X] = k(void 0), [F, M] = k(
    void 0
  ), [Y, mt] = k(void 0), [dt, qt] = k(!1), Rt = K(null), Lt = K(!1), j = K(void 0), tt = K(void 0), et = K(void 0), nt = K(void 0), bt = K({}), Yt = K({}), it = B(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), $t = V(() => o ? o() : Fi, [o]), Et = V(() => ({
    [ct.OT]: $t.filter((H) => ft.isBookOT(H)),
    [ct.NT]: $t.filter((H) => ft.isBookNT(H)),
    [ct.DC]: $t.filter((H) => ft.isBookDC(H)),
    [ct.Extra]: $t.filter((H) => ft.extraBooks().includes(H))
  }), [$t]), yt = V(() => Object.values(Et).flat(), [Et]), Bt = V(() => {
    if (!z.trim()) return Et;
    const b = {
      [ct.OT]: [],
      [ct.NT]: [],
  ...
  const Mt = B(() => {
    ...
    S("books"), X(void 0), M(void 0), mt(void 0), setTimeout(() => {
      tt.current && tt.current.focus();
    }, 0);
  }, []), ot = B(() => {
    const b = F;
    M(void 0), mt(void 0), b ? (X(b), S("chapters"), R("")) : G();
  }, [F, G]), Z = B((b) => {
    q(b), b && (S("books"), X(void 0), M(void 0), mt(void 0), E(""));
  }, []);
  W(() => {
    y && Z(!1);
  }, [y, Z]);
  ...
  const { otLong: xt, ntLong: wt, dcLong: kt, extraLong: C } = {
    ...
    () => vl(z),
    [z]
  ), je = V(() => !d || !O || !O.chapterNum || !ur ? !1 : d(O.book, O.chapterNum) > 0, [d, O, ur]), $r = B(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), Xe = B(
    (b) => (H) => w ? bl(b, H, w) : !1,
    ...
    (b, H) => (Q) => w ? ma(b, H, Q, w) : !1,
    [w]
  ), hr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", gr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Mr = B(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && O && O.chapterNum !== void 0 && O.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), Mt());
    },
    [p, O, Mt]
  ), Or = B(
    (b) => {
      var me, Ue, $e;
      if (b.ctrlKey) return;
      const { isLetter: H, isDigit: Q } = Po(b.key);
      if ((D === "chapters" || D === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const Dt = (me = j.current) == null ? void 0 : me.querySelector(
      ...
      const At = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(b.key);
      if (D === "verses" && At) {
        const St = F, vt = Y;
        if (!St || !vt || !d) return;
        const Dt = d(St, vt);
        ...
        const pt = (() => {
          if (!L) return 1;
          const Ke = L.match(/:(\d+)$/);
          return Ke ? parseInt(Ke[1], 10) : 0;
        })();
        let Wt = pt;
        const Gt = 6;
        switch (b.key) {
          case "ArrowLeft":
            pt !== 0 && (Wt = pt > 1 ? pt - 1 : Dt);
            break;
          case "ArrowRight":
            pt !== 0 && (Wt = pt < Dt ? pt + 1 : 1);
            break;
          case "ArrowUp":
            Wt = pt === 0 ? Dt : Math.max(1, pt - Gt);
            break;
          case "ArrowDown":
            Wt = pt === 0 ? 1 : Math.min(Dt, pt + Gt);
            break;
          default:
            return;
        }
        Wt !== pt && (b.preventDefault(), b.stopPropagation(), R(
          ...
          const Ke = Yt.current[Wt];
          Ke && Ke.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((D === "chapters" || D === "books" && O) && At) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            vt !== 0 && (pt = vt > 1 ? vt - 1 : Dt);
            break;
          case "ArrowRight":
            vt !== 0 && (pt = vt < Dt ? vt + 1 : 1);
            break;
          case "ArrowUp":
            pt = vt === 0 ? Dt : Math.max(1, vt - Wt);
            break;
          case "ArrowDown":
            pt = vt === 0 ? 1 : Math.min(Dt, vt + Wt);
            break;
          default:
            return;
        }
        pt !== vt && (b.preventDefault(), b.stopPropagation(), R(
          `${St} ${ne[St] || ""} ${pt}`
        ), setTimeout(() => {
          const Gt = bt.current[pt];
          Gt && Gt.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
      }
    },
    [
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (At = tt.current) == null || At.focus();
      return;
    }
    const { isLetter: H, isDigit: Q } = Po(b.key);
    (H || Q) && (b.preventDefault(), E((me) => me + b.key), tt.current.focus(), qt(!1));
  }, []);
  return Ht(() => {
    const b = setTimeout(() => {
      if (I && D === "books" && et.current && nt.current) {
        const H = et.current, Q = nt.current, At = Q.offsetTop, me = H.clientHeight, Ue = Q.clientHeight, $e = At - me / 2 + Ue / 2;
        H.scrollTo({
          top: Math.max(0, $e),
          behavior: "smooth"
        }), R(jn(t.book));
    ...
    if (D === "chapters" && $) {
      ...
      R(
        ...
        if (et.current)
          if (b) {
            const Q = bt.current[t.chapterNum];
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Te, { open: I, onOpenChange: Z, modal: v, children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(
      U,
      {
        ref: Rt,
        ...
        onClick: (b) => {
          Lt.current && (Lt.current = !1, b.preventDefault());
        },
        children: f ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Ct })
      }
    ) }),
    /* @__PURE__ */ a(
      ze,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: H } = b;
          I && Rt.current && H instanceof Node && Rt.current.contains(H) && (Lt.current = !0, Z(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          Le,
            ...
            children: [
              D === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: P.map(
                  ({ onClick: b, disabled: H, title: Q, icon: At }) => /* @__PURE__ */ a(
                    U,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  U,
                  {
                    ...
                    tabIndex: -1,
                    children: _ === "ltr" ? /* @__PURE__ */ a(es, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(rs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                ...
                /* @__PURE__ */ a(
                  "span",
                  {
                    ...
                    children: D === "verses" ? gr : hr
                  }
                )
              ] }),
              !dt && /* @__PURE__ */ u(Be, { ref: et, children: [
                D === "books" && /* @__PURE__ */ u(rt, { children: [
                  !O && Object.entries(Bt).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(de, { heading: ut(b), children: H.map((Q) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: Q,
                            onSelect: (At) => Se(At),
                  ...
                  O && /* @__PURE__ */ a(de, { children: /* @__PURE__ */ a(
                    Ee,
                    {
                  ...
                  O && je && O.chapterNum && d && /* @__PURE__ */ u(rt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Vo,
                      {
                        ...
                        onVerseSelect: Ot,
                        setVerseRef: Re,
                        isVerseDisabled: pr(O.book, O.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  O && !je && tr(O.book) > 1 && /* @__PURE__ */ u(rt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
function Lo({
  ...
  const [y, _] = k(!1), I = d ?? l, q = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], L = (R, z) => {
    ...
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(
      U,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ar, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(
      ze,
      {
        ...
        children: /* @__PURE__ */ u(Le, { children: [
          ...
          /* @__PURE__ */ a(Be, { children: q(e) ? e.map((R) => /* @__PURE__ */ a(de, { heading: R.groupHeading, children: R.options.map((z) => L(z, R.groupHeading)) }, R.groupHeading)) : /* @__PURE__ */ a(de, { children: e.map((R) => L(R)) }) })
        ] })
      }
    )
  ] });
...
function Qu({
  ...
  const w = ba(d, "%webView_bookSelector_currentBook%"), p = ba(d, "%webView_bookSelector_choose%"), f = ba(d, "%webView_bookSelector_chooseBooks%"), [h, m] = k(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    m(v), t(v);
    ...
    Kn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:flex tw:items-center", children: o.map((v) => ft.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            U,
            {
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = Gn ? Ht : W, Lr = { tag: to };
function Cl({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = _l(null, o), w = Cn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, f) {
      if (f !== null) {
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : W;
function Tl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = ge();
  return El(() => {
...
const $l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : W;
function Ml(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ol() {
  return function(t) {
    const [e] = ge(), r = V(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = K(o);
    return $l(() => {
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = Hn && "documentMode" in document ? document.documentMode : null;
!(!Hn || !("InputEvent" in window) || Pl) && "getTargetRanges" in new window.InputEvent("input");
function le(t) {
  return `${t}px`;
}
...
function Vl(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: f } = n.getBoundingClientRect(), h = Al(t, e);
    var m, x;
    c.isConnected || (x = c, (m = n).insertBefore(x, m.firstChild));
    let v = !1;
    for (let T = 0; T < h.length; T++) {
      const N = h[T], y = s[T] || document.createElement("div"), _ = y.style;
  ...
  const w = t.registerRootListener(function p() {
    ...
    if (!nc(h)) return d();
    d(), o = f, n = h, i = new MutationObserver((m) => {
...
function Bl(t, e = Ll) {
  ...
  function d(w) {
    w.read(() => {
      ...
      const [f, h] = function(R) {
        const z = R.getStartEndPoints();
        return R.isBackward() ? [z[1], z[0]] : z;
      }(p), m = f.getNode(), x = m.getKey(), v = f.offset, T = h.getNode(), N = T.getKey(), y = h.offset, _ = t.getElementByKey(x), I = t.getElementByKey(N), q = r === null || _ !== o || v !== n || x !== r.getKey(), L = i === null || I !== s || y !== c || N !== i.getKey();
      if ((q || L) && _ !== null && I !== null) {
        const R = function(z, E, D, S, $, X, F) {
          const M = (z._window ? z._window.document : document).createRange();
          return M.setStart(...Bo(E, D, S)), M.setEnd(...Bo($, X, F)), M;
        }(t, f, m, _, h, T, I);
        l(), l = Vl(t, R, e);
      }
      r = m, o = _, n = v, i = T, s = I, c = y;
    });
  }
...
function jl(t) {
  const e = Sn(t, (r) => _r(r) && !r.isInline());
  return _r(e) || Wr(4, t.__key), e;
}
function Ul(t) {
  const e = Ut() || Ys();
  let r;
  if (ue(e)) r = Ws(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = zn(c, "next"));
    }
    r = r || Xs(Ie(), "previous").getFlipped().insert(Sr());
  }
  const o = Kl(t, r), n = Js(o), i = Zs(n) ? Qs(n) : o;
  return tc(ec(i)), t.getLatest();
}
function Kl(t, e, r) {
  let o = Ro(e, "next");
  for (let n = o; n; n = rc(n, r)) o = n;
  return ac(o) && Wr(283), o.insert(t.isInline() ? Sr().append(t) : t), Ro(zn(t.getLatest(), "next"), e.direction);
}
function ql(t) {
  const e = Ut();
  if (!ue(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Sn(i, (d) => _r(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Xr, ye = 0, Jr = 0, Yl = 0, qa = 0, Kr = 0;
function jo(t) {
  if (at === void 0) return;
  let e = t.n;
...
function qe(t, e) {
  It.call(this, void 0), this.x = t, this.s = void 0, this.g = Kr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Wl(t, e) {
  return new qe(t, e);
}
...
function Xl(t) {
  ...
  Wn(this), at = t, this.f &= -2, 8 & this.f && io(this), sa();
}
function Qe(t, e) {
...
It.prototype.brand = Gl, It.prototype.h = function() {
  return !0;
}, It.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : Fo(() => {
    var r;
  ...
  if (this.t !== void 0) {
    const e = t.e, r = t.x;
    e !== void 0 && (e.x = r, t.e = void 0), r !== void 0 && (r.e = e, t.x = void 0), t === this.t && (this.t = r, r === void 0 && Fo(() => {
      var o;
      (o = this.Z) == null || o.call(this);
    }));
  }
}, It.prototype.subscribe = function(t) {
  return pe(() => {
...
}, Object.defineProperty(It.prototype, "value", { get() {
  const t = jo(this);
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ye !== 0 && Jr === 0 && e.l !== qa && (e.l = qa, Xr = { S: e, v: e.v, i: e.i, o: Xr });
    })(this), this.v = t, this.i++, Kr++, ye++;
    try {
...
} }), qe.prototype = new It(), qe.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Kr)) return !0;
  if (this.g = Kr, this.f |= 1, this.i > 0 && !Yn(this)) return this.f &= -2, !0;
  const t = at;
  try {
    Uo(this), at = this;
    const e = this.x();
  ...
  return at = t, Wn(this), this.f &= -2, !0;
}, qe.prototype.S = function(t) {
  if (this.t === void 0) {
    this.f |= 36;
    for (let e = this.s; e !== void 0; e = e.n) e.S.S(e);
  }
  It.prototype.S.call(this, t);
}, qe.prototype.U = function(t) {
  if (this.t !== void 0 && (It.prototype.U.call(this, t), this.t === void 0)) {
    this.f &= -33;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Xn(this), Uo(this), ye++;
  const t = at;
  return at = this, Xl.bind(this, t);
}, Qe.prototype.N = function() {
...
re({ build: (t, e, r) => wr(e), config: We({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Jn() {
  const t = Ie(), e = Ut(), r = Sr();
  t.clear(), t.append(r), e !== null && r.select(), ue(e) && (e.format = 0);
}
function Zn(t, e = Jn) {
  return t.registerCommand(Dn, (r) => (t.update(e), !0), eo);
}
re({ build: (t, e, r) => wr(e), config: We({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return pe(() => Zn(t, o.value));
} });
function Jl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ya = sc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends Ia {
  $config() {
    return this.config("decorator-text", { extends: Ia, stateConfigs: [{ flat: !0, stateConfig: ya }] });
  }
  getFormat() {
    return bc(this, ya);
  }
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Rn, (o) => {
  const n = Ut();
  if ($n(n) || ue(n)) for (const i of n.getNodes()) Zl(i) && i.toggleFormat(o);
  return !1;
}, Mn) });
function ti(t, e) {
  let r;
...
const Ga = re({ build: (t) => ti(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, Ha = 1, ri = 2, ka = 3, Br = 4, Ze = 5, _a = 6, mr = 7;
function Na(t) {
  return t.id === so;
}
function ai(t) {
...
function Ql(t) {
  return function(e) {
    return e.id === Ha;
  }(t) || st(305, String(t.id), String(Ha)), Object.assign(t, { id: ri });
}
...
class ed {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : ic;
    for (const o of this.configs) e = r(e, o);
    return e;
  }
  init(e) {
    const r = this.state;
    ai(r) || st(306, String(r.id));
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Br && st(307, String(r.id), String(Ze)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== mr && st(309, String(o.id), String(mr)), this.state = function(s) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== _a && st(310, String(r.id), String(_a)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Br;
    }(e) || st(313, String(e.id), String(Br)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= ka;
    }(e) || st(314, String(e.id), String(ka)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= mr;
    }(e) || st(316, String(e.id), String(mr)), e;
  }
...
const ad = re({ config: We({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = rd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (wc(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [cc, Tn, lc, dc, En] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Go() {
}
function od(t) {
  throw t;
...
class er {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Ca, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[qo];
    return r && (r.PACKAGE_VERSION !== Ca && st(292, r.PACKAGE_VERSION, Ca), r instanceof er || st(293)), r;
  }
  static fromEditor(e) {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && st(298, o.name), !n) {
      n = new ed(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Na(i) || st(300, s, n || "[unknown]"), Na(c = i) || st(304, String(c.id), String(so)), i = Object.assign(c, { id: Ha }), o.state = i;
    ...
    for (const o of this.extensionNameMap.values()) Na(o.state) && r(o);
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const f of Jl(p)) {
        if (typeof f != "function") {
          const h = o.get(f.replace);
          h && st(302, p.name, f.replace.name, h.extension.name), o.set(f.replace, w);
        }
        r.add(f);
      }
      if (p.html) {
    ...
    return e.onError || (e.onError = od), e;
  }
}
const nd = /* @__PURE__ */ new Set(), Ho = re({ build(t, e, r) {
  const o = r.getDependency(Ga).output, n = Nr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ti(() => {
  }, () => pe(() => {
...
re({ dependencies: [Ga, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [or], register(t, e, r) {
  ...
  return Ce(t.registerCommand(id, (s) => {
    const c = Ut();
    if (!ue(c)) return !1;
    ...
    return !0;
  }, eo), t.registerCommand(pc, (s) => {
    if (hc(s.target)) {
      const c = gc(s.target);
      if (cd(c)) return function(l, d = !1) {
        const w = Ut(), p = l.isSelected(), f = l.getKey();
        let h;
        d && $n(w) ? h = w : (h = fc(), mc(h)), p ? h.delete(f) : h.add(f);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Mn), t.registerMutationListener(or, (s, c) => {
    Hl(() => {
      let l = !1;
      const { nodeSelections: d } = n.peek();
      for (const [w, p] of s.entries()) if (p === "destroyed") d.delete(w), l = !0;
      else {
        const f = d.get(w), h = t.getElementByKey(w);
        f ? f.domNode.value = h : (l = !0, d.set(w, { domNode: Nr(h), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(pe(() => {
      const d = c.value;
      d && (l.value ? On(d, i) : Nc(d, i));
    }));
    return Ce(...s);
  }));
} });
re({ build: (t, e) => wr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: We({ $getParentEditor: function() {
  const t = vc();
...
re({ build: (t, e, r) => wr(e), config: We({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return pe(() => {
    if (!o.disabled.value) return Fl(t, o.onReposition.value);
  });
} });
function oi(t) {
  return t.canBeEmpty();
}
function ld(t, e, r = oi) {
  return Ce(t.registerCommand(Cc, (o) => {
    const n = Ut();
    if (!ue(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((f) => Ec(f) && f.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = jl(w);
      if (p.canIndent()) {
        const f = p.getKey();
        let h = Tc();
        if (h.anchor.set(f, 0, "element"), h.focus.set(f, 0, "element"), h = zc(h), h.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Sc : Mo : Dc;
    return t.dispatchCommand(i, void 0);
  }, eo), t.registerCommand(Mo, () => {
...
re({ build: (t, e, r) => wr(e), config: We({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return pe(() => {
    if (!o.value) return ld(t, n, i);
  });
} });
const dd = re({ name: "@lexical/react/ReactProvider" });
function wd() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ue(m)) {
                ...
                if (Va(v) && d >= 0 && w >= 0 && (T = d, N = d + w, m.setTextNodeRange(v, T, v, N)), T === N && p === "" || (m.insertRawText(p), v = x.getNode()), Va(v)) {
                  T = f, N = f + h;
...
re({ build: (t, e, r) => wr(e), config: We({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function hd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : W;
  ...
  return function(r, o) {
    ...
    return lo(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (f) => r._onError(f), children: a(Gs, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && s.push(Vc(w, p, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function fd({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(dd.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && hd(320, n);
      return !0;
    }
    return !1;
...
function md({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = ge();
  return function(n) {
    lo(() => Ce(Pc(n), ii(n)), [n]);
  }(o), u(rt, { children: [t, a(vd, { content: e }), a(fd, { editor: o, ErrorBoundary: r })] });
}
...
function bd({ defaultSelection: t }) {
  const [e] = ge();
  return W(() => {
    e.focus(() => {
...
const xd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : W;
function yd({ onClear: t }) {
  const [e] = ge();
  return xd(() => Zn(e, t), [e, t]), null;
}
const si = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : W;
function kd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: f, autoCapitalize: h, className: m, id: x, role: v = "textbox", spellCheck: T = !0, style: N, tabIndex: y, "data-testid": _, ...I }, q) {
  const [L, R] = k(t.isEditable()), z = B((D) => {
    D && D.ownerDocument && D.ownerDocument.defaultView ? t.setRootElement(D) : t.setRootElement(null);
  }, [t]), E = V(() => /* @__PURE__ */ function(...D) {
    return (S) => {
      for (const $ of D) typeof $ == "function" ? $(S) : $ != null && ($.current = S);
    };
  }(q, z), [z, q]);
  return si(() => (R(t.isEditable()), t.registerEditableListener((D) => {
    R(D);
  })), [t]), a("div", { "aria-activedescendant": L ? e : void 0, "aria-autocomplete": L ? r : "none", "aria-controls": L ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": L && v === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": L ? p : void 0, "aria-readonly": !L || void 0, "aria-required": f, autoCapitalize: h, className: m, contentEditable: L, "data-testid": _, id: x, ref: E, role: v, spellCheck: T, style: N, tabIndex: y, ...I });
}
const _d = oa(kd);
function Wo(t) {
  return t.getEditorState().read(ni(t.isComposing()));
...
function Cd(t, e) {
  ...
  return u(rt, { children: [a(_d, { editor: n, ...o, ref: e }), r != null && a(Ed, { editor: n, content: r })] });
}
function Ed({ content: t, editor: e }) {
  const r = function(s) {
    const [c, l] = k(() => Wo(s));
    return si(() => {
      function d() {
...
function Sd() {
  const [t, e] = k(void 0), r = B(() => {
    e(void 0);
  }, []), o = V(() => {
    if (t === void 0)
      return;
    const { title: i, content: s } = t;
    return /* @__PURE__ */ a(Fa, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(ja, { children: [
      /* @__PURE__ */ a(Hr, { children: /* @__PURE__ */ a(Yr, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = B(
    (i, s, c = !1) => {
...
function Dd({
  ...
  const [e] = ge(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = Sd(), l = () => {
  };
...
function Md() {
  const { activeEditor: t } = li(), [e, r] = k([]), o = B((n) => {
    if (ue(n) || Xc(n)) {
      const i = [];
      Xo.forEach(({ format: s }) => {
...
function Ad({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:relative", children: [
      ...
      e && /* @__PURE__ */ a(bd, { defaultSelection: "rootEnd" }),
...
function ep({
  ...
  const [i, s] = k(Ld), [c, l] = k(n), [d, w] = k(!1), p = K(void 0), f = K(null);
  W(() => {
    let v = !0;
    const T = f.current;
    if (!T) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
      ...
      /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(
        U,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: Ea(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        ze,
        {
          ...
          children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Be, { children: t.map((v) => /* @__PURE__ */ a(
            Ee,
            {
              onSelect: () => {
                l(v || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: Ea(v, o) })
            },
            v || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : po(v) && (v.preventDefault(), v.stopPropagation(), Xt(i) && h());
        },
        onKeyDown: (v) => {
...
function Zo({
  ...
  }, [t.date, r]), v = V(() => t.user, [t.user]), T = V(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), N = V(() => Is(t.contents), [t.contents]), y = V(() => {
    if (o && c)
      return /* @__PURE__ */ u(rt, { children: [
        /* @__PURE__ */ u(
          He,
          {
            onClick: (_) => {
              _.stopPropagation(), d(!0), p(Id(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(jd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ud, { className: "tw:text-xs tw:font-medium", children: T }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), h()) : po(_) && (_.preventDefault(), _.stopPropagation(), Xt(w) && m());
              },
              onKeyDown: (_) => {
        ...
        y && /* @__PURE__ */ u(ke, { children: [
          /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ss, {}) }) }),
...
function Kd({
  ...
  const [R, z] = k(Qo), [E, D] = k(), [S, $] = k(), X = o, [F, M] = k(!1), [Y, mt] = k(!1), [dt, qt] = k(!1), [Rt, Lt] = k(!1), [j, tt] = k(!1), [et, nt] = k(_), [bt, Yt] = k(!1), it = K(void 0), [$t, Et] = k(/* @__PURE__ */ new Map());
  W(() => {
    let C = !0;
    return (async () => {
  ...
  W(() => {
    if (!o) {
      yt.current !== "idle" && (D(void 0), $(void 0), yt.current = "idle");
      return;
    }
    yt.current === "idle" && (yt.current = "pending"), Rt ? yt.current === "pending" && L !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    L !== i && (D(L), yt.current = "auto-populated") : yt.current === "auto-populated" && (D(void 0), yt.current = "pending");
  }, [o, L, Rt, i]);
  const Bt = V(() => e.filter((C) => !C.deleted), [e]);
  W(() => {
    let C = !0;
    if (!o || !y) {
      Et(/* @__PURE__ */ new Map());
  ...
  const O = V(() => Bt[0], [Bt]), ae = K(null), Mt = K(void 0), Ot = B(() => {
    var C;
    (C = Mt.current) == null || C.call(Mt), z(Qo);
  }, []), Se = B(() => {
    const C = !et;
  ...
  }, [i, r]), P = V(() => Bt.slice(1), [Bt]), G = V(() => P.length ?? 0, [P.length]), ot = V(() => G > 0, [G]), Z = V(() => F || G <= 2 ? P : P.slice(-2), [P, G, F]), ht = V(() => F || G <= 2 ? 0 : G - 2, [G, F]), Nt = V(
    () => G === 1 ? Ft.singleReply : be(Ft.multipleReplies, { count: G }),
    [G, Ft]
  ), xt = V(
    () => ht === 1 ? Ft.singleReply : be(Ft.multipleReplies, { count: ht }),
    [ht, Ft]
  );
  W(() => {
    !o && Y && ot && mt(!1);
  ...
  const wt = B(
    async (C) => {
      ...
      ut && await p({ threadId: l, contents: ut }) && Ot();
    },
    [
      Ot,
      R,
    ...
    async (C) => {
      const ut = Xt(R) ? Qr(R) : void 0, gt = C.status ? C.assignedUser : E ?? C.assignedUser, Ct = await p({
        ...C,
        contents: ut,
        assignedUser: gt
      });
      return Ct && (gt !== void 0 && $(gt), ut && Ot()), Ct;
    },
    [Ot, R, p, E]
  );
  if (Bt.length !== 0)
    return /* @__PURE__ */ a(
      Bd,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ u(Fd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              fe && /* @__PURE__ */ a(kr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: fe }),
              /* @__PURE__ */ a(
                U,
                {
                  variant: "ghost",
                  ...
                  children: et ? /* @__PURE__ */ a(cs, {}) : /* @__PURE__ */ a(ls, {})
                }
              ),
            ...
            /* @__PURE__ */ a(
              Zo,
              {
                ...
                handleDeleteComment: h,
                onEditingChange: mt,
                canEditOrDelete: (!Y && $t.get(O.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(rt, { children: [
              ...
              Z.map((C) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Zo,
                {
                  ...
                  handleDeleteComment: h,
                  onEditingChange: mt,
                  canEditOrDelete: (!Y && $t.get(C.id)) ?? !1
                }
              ) }, C.id)),
              v !== !1 && (!Y || Xt(R)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (C) => {
                    po(C) && (C.preventDefault(), C.stopPropagation(), (Xt(R) || E !== void 0 && E !== S) && wt());
                  },
                  onKeyDown: (C) => {
                    wo(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Zr,
                      ...
                      /* @__PURE__ */ u(Te, { open: dt, onOpenChange: qt, children: [
                        ...
                        /* @__PURE__ */ a(
                          ze,
                          {
                            ...
                            children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Be, { children: x == null ? void 0 : x.map((C) => /* @__PURE__ */ a(
                              Ee,
                              {
                                onSelect: () => {
                                  D(C !== i ? C : void 0), yt.current = "user-selected", $(void 0), qt(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: Gr(C, r) })
                              },
                              C || "unassigned"
                            )) }) })
                          }
...
function lp({
  ...
  const [T, N] = k(/* @__PURE__ */ new Set()), [y, _] = k(), [I, q] = k(), L = B(
    async (M) => {
      const Y = await i(M);
  ...
  const R = r.filter(
    ...
    [T, x]
  ), { listboxRef: S, activeId: $, handleKeyDown: X } = ji({
    options: z,
    onOptionSelect: E
  }), F = B(
    (M) => {
...
function sr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Vt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Vt.Icon, { asChild: !0, children: /* @__PURE__ */ a(jc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function oe({
  ...
  return /* @__PURE__ */ u(
    Vt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Vt.ItemIndicator, { children: /* @__PURE__ */ a(na, { className: "tw:pointer-events-none" }) }) }),
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ u(
        nr,
        {
          ...
          children: [
            /* @__PURE__ */ a(sr, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(ir, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(cr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(oe, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Cr(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Xd(o)
  );
}
function ca({
  className: t,
...
function tw({
  ...
  var q;
  const [w, p] = k([]), [f, h] = k([]), [m, x] = k({}), [v, T] = k({}), N = V(() => e ?? [], [e]), y = Vn({
    data: N,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  let I;
  return l ? I = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ie, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Jt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Ra, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((q = y.getRowModel().rows) == null ? void 0 : q.length) > 0 ? I = y.getRowModel().rows.map((L) => /* @__PURE__ */ a(
    ie,
    {
      onClick: () => s(L, y),
      "data-state": L.getIsSelected() && "selected",
      children: L.getVisibleCells().map((R) => /* @__PURE__ */ a(Jt, { children: xr(R.column.columnDef.cell, R.getContext()) }, R.id))
    },
    L.id
  )) : I = /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ a(Jt, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(qd, { table: y }),
    /* @__PURE__ */ u(ca, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ho, { stickyHeader: i, children: y.getHeaderGroups().map((L) => /* @__PURE__ */ a(ie, { children: L.headers.map((R) => /* @__PURE__ */ a(ta, { className: "tw:p-0", children: R.isPlaceholder ? void 0 : xr(R.column.columnDef.header, R.getContext()) }, R.id)) }, L.id)) }),
...
function fp({
  ...
  return /* @__PURE__ */ u(Te, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(ze, { id: i, className: g("tw:min-w-80 tw:max-w-96", n), children: [
...
function mp({ id: t, label: e, groups: r }) {
  const [o, n] = k(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ke, { children: [
    /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "default", children: [
      /* @__PURE__ */ a(fs, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(ar, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Ne, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Tr, { children: d.label }),
      /* @__PURE__ */ a(un, { children: d.itemType === 0 ? /* @__PURE__ */ a(rt, { children: d.items.map((p, f) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ae,
        {
          checked: o[w][f],
        ...
        Ui,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Ki, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Ye, {})
    ] }, d.label)) })
...
function bp({
  ...
  const s = V(() => Ls(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(Bs(), { type: "language" });
...
function mi({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Te, { open: R, onOpenChange: w ?? N, children: [
    ...
    /* @__PURE__ */ a(ze, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Le, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: L, children: s })
      ] }),
      /* @__PURE__ */ u(Be, { children: [
        /* @__PURE__ */ a(ra, { children: c }),
        /* @__PURE__ */ a(de, { children: I.map((E) => /* @__PURE__ */ u(
          Ee,
          {
            value: E.label,
            onSelect: y,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ a(xs, { className: "tw:h-4 tw:w-4" }),
...
function yp({ className: t, ...e }) {
  return /* @__PURE__ */ a(
    ...
    {
      "data-slot": "kbd-group",
      className: g("pr-twp tw:inline-flex tw:items-center tw:gap-1", t),
      ...e
    }
  );
}
...
function iw({
  ...
  const l = V(() => /Macintosh/i.test(navigator.userAgent), []), d = an(n, "%undoButton_tooltip%"), w = an(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(uo, { children: [
    /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ u(Qt, { children: [
      /* @__PURE__ */ a(te, { asChild: !0, children: /* @__PURE__ */ a(
        U,
      ...
      /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(rt, { children: [
          " ",
          /* @__PURE__ */ a(rn, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ u(Qt, { children: [
      ...
      /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(rt, { children: [
          " ",
          /* @__PURE__ */ a(rn, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
  ...
  return W(() => {
    ...
    const i = /Macintosh/i.test(navigator.userAgent), s = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      ...
      if (i) {
        ...
        if (!d.ctrlKey) return;
        !d.shiftKey && w === "z" ? (d.preventDefault(), r && ((h = e.current) == null || h.undo())) : (w === "y" || d.shiftKey && w === "z") && (d.preventDefault(), o && ((m = e.current) == null || m.redo()));
      }
    };
    return document.addEventListener("keydown", c), () => document.removeEventListener("keydown", c);
  }, [o, r, e]), /* @__PURE__ */ a("div", { ref: n, children: t });
}
const cw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(rt, { children: [
...
function lw({
  ...
  const i = K(null), s = K(null), c = K(!1), [l, d] = k(t), [w, p] = k(r), [f, h] = k(!1);
  W(() => {
    d(t);
  }, [t]), W(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(ke, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ u(Qt, { children: [
      /* @__PURE__ */ a(te, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: cw(t, n, r) }) }) }),
...
const dw = (t, e) => t === "f" ? /* @__PURE__ */ u(rt, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function uw({
  ...
  return /* @__PURE__ */ u(ke, { children: [
    /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ u(Qt, { children: [
      /* @__PURE__ */ a(te, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: dw(t, r) }) }) }),
      /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ a("p", { children: ww(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ne, { style: { zIndex: pn }, children: [
...
function hw({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? _s, { className: e, size: 16 });
}
function on({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ u(
    Ee,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(hw, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
...
function gw({
  ...
  return /* @__PURE__ */ u(Le, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Be, { children: [
      ...
      /* @__PURE__ */ a(de, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          on,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(rt, { children: [
        ...
        /* @__PURE__ */ a(de, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            on,
            {
...
function kp({
  ...
  const w = K(null), p = K(null), f = K(null), h = K(null);
  Ht(() => {
    if (!h.current) return;
    const { width: P } = h.current.getBoundingClientRect();
    P > 0 && (h.current.style.width = `${P}px`);
  }, []);
  const [m, x] = k("generated"), [v, T] = k("generated"), [N, y] = k("*"), [_, I] = k("*"), [q, L] = k("f"), [R, z] = k(!1), [E, D] = k(!0), [S, $] = k(!1), X = K(!1), F = K(""), [M, Y] = k(!1), [mt, dt] = k(), [qt, Rt] = k(), [Lt, j] = k(), [tt, et] = k(), nt = K(null), bt = V(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (G && Ir("note", G)) {
      ...
      let Nt = "custom";
      ht === La ? Nt = "generated" : ht === Ba ? Nt = "hidden" : ht && (y(ht), I(ht)), x(Nt), T(Nt), L(((Z = G.insert.note) == null ? void 0 : Z.style) ?? "f"), P = setTimeout(() => {
        var xt;
        (xt = w.current) == null || xt.applyUpdate([G]);
      }, 0);
    }
    return () => {
      P && clearTimeout(P);
  ...
  const it = B(
    (P, G, ot = !1) => {
      var ht, Nt, xt;
      const Z = (Nt = (ht = w.current) == null ? void 0 : ht.getNoteOps(0)) == null ? void 0 : Nt.at(0);
      if (Z && Ir("note", Z)) {
        if (Z.insert.note) {
          let wt;
          P === "custom" ? wt = G : P === "generated" ? wt = La : wt = Ba, Z.insert.note.caller = wt;
        }
        r == null || r([Z]), ot && d && i && ((xt = d.current) == null || xt.replaceEmbedUpdate(i, [Z]));
      }
    },
    [i, r, d]
  ), $t = B(() => {
  ...
  const yt = K({ book: n.book, chapterNum: n.chapterNum });
  Ht(() => {
    (yt.current.book !== n.book || yt.current.chapterNum !== n.chapterNum) && (yt.current = { book: n.book, chapterNum: n.chapterNum }, Et.current());
  }, [n.book, n.chapterNum]);
  const Bt = () => {
    var G;
    ...
    if (G && Ir("note", G)) {
      ...
      const wt = (Nt = (ht = G.insert.note) == null ? void 0 : ht.contents) == null ? void 0 : Nt.ops;
      q !== "x" && P === "x" ? wt == null || wt.forEach((kt) => mw(kt)) : q === "x" && P !== "x" && (wt == null || wt.forEach((kt) => vw(kt))), (xt = w.current) == null || xt.applyUpdate([G, { delete: 1 }]);
    }
  }, Ot = (P) => {
    ...
    (P) => {
      ...
      if (G && Ir("note", G)) {
        ...
        const wt = (ht = G.insert.note) == null ? void 0 : ht.style, kt = (xt = (Nt = G.insert.note) == null ? void 0 : Nt.contents) == null ? void 0 : xt.ops;
        if (wt || z(!1), z(
          wt === "x" ? !!(kt != null && kt.every((C) => {
            var gt, Ct;
            if (!((gt = C.attributes) != null && gt.char)) return !0;
            const ut = ((Ct = C.attributes) == null ? void 0 : Ct.char).style;
    ...
    if (f.current && Yt.length && P && P.rangeCount > 0) {
      ...
      dt(G.left - ot.left), Rt(G.top - ot.top), j(G.height), Y(!0);
    }
  }, [Yt, f]);
  W(() => {
    const P = () => {
    ...
    const P = ((ot = p.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0, G = (Z) => {
      !M && P && document.activeElement === P && Z.key === c ? (Z.preventDefault(), Ft()) : M && Z.key === "Escape" && (Z.preventDefault(), Y(!1));
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ u(Qt, { children: [
              ...
              /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ a("p", { children: fe }) })
            ] }) }) })
          ]
        }
      )
      ...
      if (typeof i == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(Oa, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
  ...
  return /* @__PURE__ */ u(rt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(rt, { children: xw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Np({
  ...
  const w = l ?? Fs(r, void 0), p = (N, y) => {
    d == null || d(N, y, n);
  }, f = i ? r.findIndex((N) => N === i) : -1, [h, m] = k(f), x = (N, y, _) => {
    if (r.length)
      switch (N.key) {
        case "Enter":
        case " ":
  ...
  return W(() => {
    var N;
    h >= 0 && h < T.current.length && ((N = T.current[h]) == null || N.focus());
  }, [h]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((N, y) => {
            ...
            return /* @__PURE__ */ u(rt, { children: [
              ...
              y < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(rr, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function Nw({
  ...
  return /* @__PURE__ */ u(ca, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(ho, { stickyHeader: !0, children: /* @__PURE__ */ u(ie, { children: [
      /* @__PURE__ */ a(ta, { children: n }),
      /* @__PURE__ */ a(ta, { children: i })
    ] }) }),
    /* @__PURE__ */ a(la, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ie,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ a(Jt, { className: o, children: _w(c.text) })
        ]
      },
...
const Cw = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ a(Ts, { className: "tw:h-4 tw:w-4" });
  if (t === "desc")
    return /* @__PURE__ */ a(zs, { className: "tw:h-4 tw:w-4" });
}, da = (t, e, r) => /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ u(Qt, { children: [
  /* @__PURE__ */ u(
    te,
    {
  ...
  header: ({ column: e }) => da(e, t)
}), Ew = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (r) => r.items[e],
  header: ({ column: r }) => da(r, t)
}), Ep = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => da(e, t, "tw:justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: i }) => da(i, t, "tw:justify-center"),
  cell: ({ row: i }) => {
  ...
  return e ? e[1] : "";
}, Tw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Rp = Object.freeze([
...
function $p({
  ...
  const h = ce(r, "%webView_inventory_all%"), m = ce(r, "%webView_inventory_approved%"), x = ce(r, "%webView_inventory_unapproved%"), v = ce(r, "%webView_inventory_unknown%"), T = ce(r, "%webView_inventory_scope_currentBook%"), N = ce(r, "%webView_inventory_scope_chapter%"), y = ce(r, "%webView_inventory_scope_verse%"), _ = ce(r, "%webView_inventory_filter_text%"), I = ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), q = ce(r, "%webView_inventory_no_results%"), [L, R] = k(!1), [z, E] = k("all"), [D, S] = k(""), [$, X] = k([]), F = V(() => {
    const j = t ?? [];
    return j.length === 0 ? [] : Sw(j, n, i);
  }, [t, n, i]), M = V(() => {
    if (L) return F;
    const j = [];
    return F.forEach((tt) => {
  ...
  }, [L, F]), Y = V(() => M.length === 0 ? [] : zw(M, z, D), [M, z, D]), mt = V(() => {
    var et, nt;
    if (!L) return l;
    ...
    for (let bt = 0; bt < j; bt++)
      tt.push(
        Ew(
          ((nt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : nt[bt]) || "Additional Item",
          bt + 1
        )
      );
    return [...tt, ...l];
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        nr,
        {
          onValueChange: (j) => Rt(j),
          defaultValue: z,
          children: [
            /* @__PURE__ */ a(sr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(ir, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(cr, { children: [
              /* @__PURE__ */ a(oe, { value: "all", children: h }),
      ...
      /* @__PURE__ */ u(nr, { onValueChange: (j) => qt(j), defaultValue: s, children: [
        /* @__PURE__ */ a(sr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(ir, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(cr, { children: [
      ...
      o && /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ u(Qt, { children: [
        /* @__PURE__ */ a(te, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? I })
        ] }) }),
        /* @__PURE__ */ a(ee, { children: (o == null ? void 0 : o.checkboxText) ?? I })
      ] }) })
    ] }),
...
const xi = oa(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ds, { size: 35, className: g("tw:animate-spin", t), ...e, ref: r }));
xi.displayName = "Spinner";
function Dw(t, e = 50) {
  const [r, o] = k(e), n = K(null);
  return W(() => {
    o(e);
  }, [t, e]), W(() => {
...
function za({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(rt, { children: [
      /* @__PURE__ */ a(ie, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(Jt, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        ie,
        {
...
function Op({
  ...
  const [s, c] = k(""), [l, d] = k([]), w = V(
    () => t.filter(($) => !r || $.type === r).filter(($) => Rw($, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: x, hasMore: v } = Dw(h), T = V(
    () => Array.from(new Set(t.map(($) => $.bestLanguageName))).map(($) => ({
      label: $,
      value: $
    })),
    [t]
  ), N = p.length === 0 && f.length === 0 && h.length === 0, y = ve(n, "%resourcePicker_title%"), _ = ve(n, "%resourcePicker_search_placeholder%"), I = ve(n, "%resourcePicker_language_filter_any%"), q = ve(
    n,
    "%resourcePicker_section_already_selected%"
  ), L = ve(n, "%resourcePicker_section_installed%"), R = ve(
    n,
    "%resourcePicker_section_available_to_download%"
  ), z = ve(n, "%resourcePicker_no_results%"), E = ve(n, "%resourcePicker_showing_count%"), D = V(() => {
    ...
    return be(
      ve(n, "%resourcePicker_language_filter_multipleSelected%"),
      {
        selectCount: l.length
      }
    );
  }, [l, T, I, n]), S = s.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(rt, { children: [
    /* @__PURE__ */ a(Hr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Yr, { children: y }) }),
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !N && !e && /* @__PURE__ */ a(ca, { children: /* @__PURE__ */ u(la, { children: [
        /* @__PURE__ */ a(za, { label: q, resources: p }),
        /* @__PURE__ */ a(za, { label: L, resources: f, onSelect: i }),
        /* @__PURE__ */ a(
          za,
          {
            label: R,
        ...
        v && /* @__PURE__ */ a(ie, { className: "tw:border-0", children: /* @__PURE__ */ a(Jt, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: x, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const $w = "16rem", Mw = "3rem", yi = lt.createContext(void 0);
function ua() {
  const t = lt.useContext(yi);
  if (!t)
...
function Ow({
  ...
  const [l, d] = lt.useState(t), w = e ?? l, p = lt.useCallback(
    ...
    [r, w]
  ), f = lt.useCallback(() => p((y) => !y), [p]), h = w ? "expanded" : "collapsed", v = Kt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = lt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Ap({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    U,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Uc, {}) : /* @__PURE__ */ a(Kc, {}),
...
function Fw({
  ...
  const c = t ? dr.Root : "button", { state: l } = ua(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: g(Bw({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Aw,
    {
      ...
      children: /* @__PURE__ */ u(Iw, { children: [
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(Vw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(Lw, { children: /* @__PURE__ */ a(
            Fw,
            {
              onClick: () => d(h),
              isActive: f(h),
        ...
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(Rs, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  Hi,
                  {
                    mode: "project",
...
const Me = "scrBook", Uw = "scrRef", Ge = "source", Kw = "details", qw = "Scripture Reference", Gw = "Scripture Book", ki = "Type", Hw = "Details";
function Yw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ft.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Me ? xe(n.start) : void 0;
      },
...
const Ww = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Aa(t.start, t.end) === 0 ? `${ga(t.start)}+${e}` : `${ga(t.start)}+${e}-${ga(t.end)}+${r}`;
}, ln = (t) => `${Ww({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Wp({
  sources: t,
  ...
  const [d, w] = k([]), [p, f] = k([{ id: Me, desc: !1 }]), [h, m] = k({}), x = V(
  ...
  W(() => {
    if (c) {
      ...
      if (E.length === 1) {
        const D = x.find((S) => ln(S) === E[0]) || void 0;
        D && c(D);
      }
    }
  }, [h, x, c, T]);
  const N = n ?? Gw, y = i ?? ki, _ = [
  ...
  }, L = (z, E) => z.getIsGrouped() ? "" : g("banded-row", E % 2 === 0 ? "even" : "odd"), R = (z, E, D) => {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      nr,
      {
        ...
        children: [
          /* @__PURE__ */ a(sr, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(ir, {}) }),
          /* @__PURE__ */ a(cr, { position: "item-aligned", children: /* @__PURE__ */ a(Gd, { children: _.map((z) => /* @__PURE__ */ a(oe, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ca, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(ho, { children: T.getHeaderGroups().map((z) => /* @__PURE__ */ a(ie, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ta, { colSpan: E.colSpan, className: "tw:sticky top-0", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          xr(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, z.id)) }),
      /* @__PURE__ */ a(la, { children: T.getRowModel().rows.map((z, E) => {
        const D = Kt();
        return /* @__PURE__ */ a(
          ie,
          {
                  ...
                  Jt,
                  {
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ u(
                      U,
                      {
                        ...
                        type: "button",
                        children: [
                          z.getIsExpanded() && /* @__PURE__ */ a(ar, {}),
                          !z.getIsExpanded() && (D === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a($a, {})),
                          " ",
                          xr(S.column.columnDef.cell, S.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function _i(t) {
  if (t.length !== ft.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  return ft.allBookIds.filter(
    (e, r) => t[r] === "1" && !ft.isObsolete(ft.bookIdToNumber(e))
  );
}
function fo(t, e) {
  return t.filter((r) => {
...
const Ni = (t, e, r) => fo(t, e).every((o) => r.includes(o));
function Xw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: h, extraLong: m } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, v] = k(!1), [T, N] = k(""), y = K(void 0), _ = K(!1), I = V(
    () => _i(t),
    [t]
  ), q = V(() => {
    if (!T.trim()) {
    ...
    (S, $ = !1) => {
      ...
      const X = I.findIndex((dt) => dt === y.current), F = I.findIndex((dt) => dt === S);
      if (X === -1 || F === -1) return;
      const [M, Y] = [
        Math.min(X, F),
        Math.max(X, F)
      ], mt = I.slice(M, Y + 1).map((dt) => dt);
      r(
        e.includes(S) ? e.filter((dt) => !mt.includes(dt)) : [.../* @__PURE__ */ new Set([...e, ...mt])]
      );
    },
    [e, r, I]
  ), R = (S) => {
    L(S, _.current), _.current = !1;
  }, z = (S, $) => {
    S.preventDefault(), L($, S.shiftKey);
  }, E = () => {
    r(I.map((S) => S));
  }, D = () => {
    r([]);
                ...
                Object.values(ct).map((S, $) => {
                  ...
                  if (X.length !== 0)
                    return /* @__PURE__ */ u(_n, { children: [
                      ...
                      $ < Object.values(ct).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, S);
                })
              ] })
            ]
...
function Zw({
  ...
  const i = o["%webView_book_selector_more%"], s = V(
    ...
    (l) => {
      ...
      r(
        Ni(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Sa ? Sa : dn
      ).map((l) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Oe(l, n) }, l)),
...
function Jp({
  ...
  const _ = Tt(
    s,
    "%webView_scope_selector_selected_text%"
  ), I = Tt(s, "%webView_scope_selector_verse%"), q = Tt(s, "%webView_scope_selector_chapter%"), L = Tt(s, "%webView_scope_selector_book%"), R = Tt(
    s,
    "%webView_scope_selector_current_verse%"
  ), z = Tt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), E = Tt(s, "%webView_scope_selector_current_book%"), D = Tt(s, "%webView_scope_selector_choose_books%"), S = Tt(s, "%webView_scope_selector_scope%"), $ = Tt(s, "%webView_scope_selector_select_books%"), X = Tt(s, "%webView_scope_selector_range%"), F = Tt(s, "%webView_scope_selector_select_range%"), M = Tt(s, "%webView_scope_selector_range_start%"), Y = Tt(s, "%webView_scope_selector_range_end%"), mt = Tt(s, "%webView_scope_selector_ok%"), dt = Tt(s, "%webView_scope_selector_cancel%"), qt = Tt(s, "%webView_scope_selector_navigate%"), Rt = (A) => {
    if (!m) return;
  ...
  ], j = (A, J, jt = !1) => /* @__PURE__ */ u(rt, { children: [
    A,
    J && !jt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? Lt.filter((A) => e.includes(A.value)) : Lt, et = m ?? fa, nt = w ?? et, bt = p ?? et, Yt = () => {
  }, it = K(null), $t = K(null), Et = K(!1), yt = K(null), Bt = K(!1), [O, ae] = k(void 0), Mt = K(!1), Ot = K(!1), Se = K(null), Ft = B((A) => {
    if (A) {
      ae("start"), Mt.current = !1;
      return;
    }
    ae((J) => J === "start" ? void 0 : J), Mt.current && (Mt.current = !1, requestAnimationFrame(() => {
      var jt;
      const J = (jt = it.current) == null ? void 0 : jt.querySelector("button");
      J == null || J.click();
    }));
  }, []), fe = B((A) => {
    if (A) {
    ...
    (A) => {
      f == null || f(A), h == null || h(A), Mt.current = !0;
    },
    [f, h]
  ), G = B(
    (A) => {
      h == null || h(A), Ot.current = !0;
    },
    [h]
  ), ot = B(
    (A) => {
    ...
    [r, n, m, i]
  ), Z = tt.find((A) => A.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Us(nt, bt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Z ? j(Z.label, Z.scrRefSuffix) : t, Nt = tt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), xt = tt.find((A) => A.value === "selectedBooks"), wt = tt.find((A) => A.value === "range"), [kt, C] = k(!1), [ut, gt] = k(void 0), [Ct, De] = k(void 0), [Re, ur] = k(void 0), [je, $r] = k(void 0), [Xe, pr] = k([]), hr = d === "dropdown" && ut === "selectedBooks", gr = /* @__PURE__ */ a(
    Zw,
    {
      availableBookInfo: o,
      selectedBookIds: hr ? Xe : n,
      onChangeSelectedBookIds: hr ? pr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), Mr = O === "end", Or = O === "start", Je = "tw:text-muted-foreground", b = d === "dropdown" && ut === "range", H = b ? ur : P, At = b ? $r : h ? G : Yt, me = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: g(Mr && Je), children: M }),
      /* @__PURE__ */ a(
        va,
        {
    ...
    /* @__PURE__ */ u("div", { ref: it, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: g(Or && Je), children: Y }),
      /* @__PURE__ */ a(
        va,
        {
          id: "scope-range-end",
          ...
          onCloseAutoFocus: (A) => {
            var J;
            Ot.current && (Ot.current = !1, A.preventDefault(), (J = Se.current) == null || J.focus());
          },
          className: g(Or && Je),
          modal: !0,
          align: "start"
  ...
  const [vt, Dt] = k(null), [pt, Wt] = k(null), [Gt, Ke] = k(null), $i = 200, [Mi, Oi] = k(!1);
  W(() => {
    if (!Gt || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([J]) => {
      Oi(J.contentRect.width < $i);
    });
    return A.observe(Gt), () => A.disconnect();
  }, [Gt]);
  const mo = B(
    (A) => {
      De(A), ur(nt), $r(bt), pr(n), C(!1), gt(A);
    },
    [nt, bt, n]
  ), vo = B(() => {
    Ct !== void 0 && (Ct === "range" ? (Re && (f == null || f(Re)), je && (h == null || h(je))) : Ct === "selectedBooks" && i(Xe), ot(Ct), gt(void 0), De(void 0));
  }, [
    Ct,
    Re,
    je,
    ...
    var J;
    A.preventDefault(), (J = St.current) == null || J.focus();
  }, []), xo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Pe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !N && /* @__PURE__ */ a(_t, { children: S }),
      d === "dropdown" ? /* @__PURE__ */ u(ke, { open: kt, onOpenChange: C, children: [
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(pa, { container: Gt, children: [
              Nt.map(({ value: A, label: J, dropdownLabel: jt, scrRefSuffix: fr, id: Ai }) => /* @__PURE__ */ u(
                He,
                {
                  ref: $e(A),
              ...
              x && /* @__PURE__ */ u(rt, { children: [
                /* @__PURE__ */ a(Ye, {}),
                /* @__PURE__ */ a(Tr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: qt }),
                /* @__PURE__ */ a(
                  He,
                  {
                    ref: yt,
                    ...
                    onSelect: (A) => {
                      var J, jt;
                      if (A.preventDefault(), Et.current) {
                        Et.current = !1;
                        return;
                      }
                      Bt.current || (jt = (J = $t.current) == null ? void 0 : J.querySelector("button")) == null || jt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          J != null && J.closest("button") && (Et.current = !0, requestAnimationFrame(() => {
                            Et.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          va,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var J;
                              A.preventDefault(), (J = yt.current) == null || J.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(rt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: xe(m ?? fa, "id") }),
                              /* @__PURE__ */ a(ar, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Kn,
        {
          ...
          children: tt.map(({ value: A, label: J, scrRefSuffix: jt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Ua, { className: "tw:me-2", value: A, id: fr }),
            /* @__PURE__ */ a(_t, { htmlFor: fr, children: j(J, jt) })
          ] }, fr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && me,
    d === "dropdown" && xt && /* @__PURE__ */ a(Fa, { open: ut === "selectedBooks", onOpenChange: Ar, children: /* @__PURE__ */ a(
      ja,
      {
        ref: Wt,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(pa, { container: pt, children: [
          /* @__PURE__ */ a(Hr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Yr, { children: D }) }),
          gr,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Ar(!1), children: dt }),
            /* @__PURE__ */ a(U, { onClick: vo, children: mt })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && wt && /* @__PURE__ */ a(Fa, { open: ut === "range", onOpenChange: Ar, children: /* @__PURE__ */ a(
      ja,
      {
        ref: Dt,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(pa, { container: vt, children: [
          /* @__PURE__ */ a(Hr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Yr, { children: F }) }),
          me,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Ar(!1), children: dt }),
            /* @__PURE__ */ a(U, { ref: Se, onClick: vo, children: mt })
          ] })
        ] })
      }
    ) })
...
function Zp({
  ...
  return /* @__PURE__ */ u(
    nr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(sr, { size: n, className: g("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          ir,
          {
        ...
        /* @__PURE__ */ a(
          cr,
          {
            ...
            style: { zIndex: lr },
            children: t.map((w) => /* @__PURE__ */ a(oe, { value: `${w}`, children: l[Eo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ei = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(te, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Zi, { children: /* @__PURE__ */ a(Qi, { children: Ei(
      t,
      e,
      Ci(t, c.id),
      o
...
function Ya({
  ...
  return /* @__PURE__ */ u(ke, { variant: i, children: [
    /* @__PURE__ */ a(_e, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a($s, {}) }) }),
    /* @__PURE__ */ a(Ne, { align: "start", style: { zIndex: lr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(_n, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Zt, { children: Ei(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(Ye, {})
    ] }, l)) })
  ] });
}
const Ti = lt.forwardRef(
...
const zi = lt.forwardRef(({ className: t, ...e }, r) => {
  const o = Kt();
  return /* @__PURE__ */ a(
    se.Root,
    {
...
zi.displayName = se.List.displayName;
const Si = lt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.List,
  {
    ref: r,
    className: g(
...
Si.displayName = se.List.displayName;
const eu = lt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Trigger,
  {
    ref: r,
    ...e,
...
)), Di = lt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Content,
  {
    ref: r,
    className: g(
...
Di.displayName = se.Content.displayName;
function oh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(zi, { children: [
      /* @__PURE__ */ a(Si, { children: t.map((c) => /* @__PURE__ */ a(eu, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), vr(i, [f, h]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), vr(s, [f, h]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), vr(c, [f, h]);
        break;
      case "alt+h":
        (T = l.current) == null || T.focus(), vr(l, [f, h]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(ru, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(au, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: lr },
          children: /* @__PURE__ */ a(Zt, { children: Ri(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function sh({
  ...
  const d = pu(
    ...
    return v ? `${(I = t[m]) == null ? void 0 : I.autonym} (${v})` : (q = t[m]) == null ? void 0 : q.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: g("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ u(
      nr,
      {
        name: "uiLanguage",
        ...
        onOpenChange: (m) => p(m),
        children: [
          /* @__PURE__ */ a(sr, { children: /* @__PURE__ */ a(ir, {}) }),
          /* @__PURE__ */ a(
            cr,
            {
              style: { zIndex: lr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(oe, { value: m, children: h(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(_t, { className: "tw:font-normal tw:text-muted-foreground", children: be(d, {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(ke, { children: [
              /* @__PURE__ */ a(_e, { className: g(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
  ...
  return /* @__PURE__ */ u("div", { className: g("tw:inline-grid tw:items-center tw:gap-1.5", { "tw:w-full": o }), children: [
    ...
    /* @__PURE__ */ a(
      Rr,
      {
        ...
        placeholder: s,
        required: c,
        className: g(l, { "tw:border-red-600": r }),
        defaultValue: d,
        value: w,
        onChange: p,
        onFocus: f,
...
function Nh({
  ...
  return /* @__PURE__ */ u(
    zt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(zt.ItemIndicator, { children: /* @__PURE__ */ a(na, {}) }) }),
        e
      ]
    }
  );
...
function $h({
  ...
  const n = Kt();
  return /* @__PURE__ */ u(mu, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(vu, {}),
    /* @__PURE__ */ u(
      Fe.Content,
      {
...
function Vh({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    cl,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(Wc, { className: "tw:size-4" }),
...
function jh({
  ...
  return /* @__PURE__ */ a(
    se.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: g("pr-twp", bu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
ku(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  wh as Alert,
  ph as AlertDescription,
  uh as AlertTitle,
  jd as Avatar,
  Ud as AvatarFallback,
  cp as AvatarImage,
  Ju as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  Zu as BOOK_SELECTOR_STRING_KEYS,
  kr as Badge,
  va as BookChapterControl,
  Ka as BookSelectionMode,
  Qu as BookSelector,
  U as Button,
  uo as ButtonGroup,
  hi as ButtonGroupSeparator,
  tp as ButtonGroupText,
  ...
  xp as Filter,
  mp as FilterDropdown,
  bp as Footer,
  kp as FootnoteEditor,
  kw as FootnoteItem,
  Np as FootnoteList,
  Rp as INVENTORY_STRING_KEYS,
  Rr as Input,
  $p as Inventory,
  rn as Kbd,
  yp as KbdGroup,
  ...
  Jh as PopoverDescription,
  Zh as PopoverHeader,
  pa as PopoverPortalContainerProvider,
  Qh as PopoverTitle,
  Ve as PopoverTrigger,
  Ih as Progress,
  Mp as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  Kn as RadioGroup,
  ...
  Kp as SidebarMenuSkeleton,
  qp as SidebarMenuSub,
  Hp as SidebarMenuSubButton,
