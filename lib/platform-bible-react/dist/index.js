...
import W, { forwardRef as Eo, useCallback as Ne, useState as fe, useRef as _t, useEffect as Ue, useLayoutEffect as ma, useMemo as Kt } from "react";
...
import Se, { clsx as tc } from "clsx";
...
function tp({ table: e }) {
  return /* @__PURE__ */ F(Ro, { children: [
    /* @__PURE__ */ m(rc, { asChild: !0, children: /* @__PURE__ */ F(Oe, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
...
function kv({
  ...
  const g = ht(n, "%webView_inventory_all%"), p = ht(n, "%webView_inventory_approved%"), h = ht(n, "%webView_inventory_unapproved%"), u = ht(n, "%webView_inventory_unknown%"), b = ht(n, "%webView_inventory_scope_book%"), x = ht(n, "%webView_inventory_scope_chapter%"), C = ht(n, "%webView_inventory_scope_verse%"), w = ht(n, "%webView_inventory_filter_text%"), [E, y] = fe([]), [N, O] = fe("all"), [_, A] = fe(""), [L, k] = fe(""), S = Ne(
    (B, Z) => {
      ...
      let Q = [...o];
      B.forEach((M) => {
        Z === "approved" ? Q.includes(M) || Q.push(M) : Q = Q.filter((U) => U !== M);
      }), a(Q);
      let R = [...i];
      B.forEach((M) => {
...
Ui.displayName = Ae.Input.displayName;
...
const Wi = W.forwardRef((e, t) => /* @__PURE__ */ m(Ae.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
...
const Ru = Ye("border", He), Pu = Ye("borderTop", He), $u = Ye("borderRight", He), _u = Ye("borderBottom", He), Mu = Ye("borderLeft", He), Iu = Ye("borderColor"), Au = Ye("borderTopColor"), Du = Ye("borderRightColor"), Bu = Ye("borderBottomColor"), ju = Ye("borderLeftColor"), Lu = Ye("outline", He), Vu = Ye("outlineColor"), Cr = (e) => {
...
function Of(e) {
  ...
  const i = Es(P({}, o, r)), l = Ka(r), c = Ka(o), d = t(i), f = Se(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), g = P({}, d, n, c, l);
...
var Me = "top", Xe = "bottom", qe = "right", Ie = "left", Ho = "auto", Hn = [Me, Xe, qe, Ie], en = "start", Dn = "end", Xf = "clippingParents", Ns = "viewport", hn = "popper", qf = "reference", Qa = /* @__PURE__ */ Hn.reduce(function(e, t) {
...
function nn(e, t, n) {
  ...
  var i = jt(e) ? Fe(e) : window, l = i.visualViewport, c = !Ss() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, f = (r.top + (c && l ? l.offsetTop : 0)) / a, v = r.width / o, g = r.height / a;
  return {
    width: v,
    height: g,
    top: f,
...
function dm(e) {
  ...
  if (!(!a || !i)) {
    var v = um(o.padding, n), g = Go(a), p = c === "y" ? Me : Ie, h = c === "y" ? Xe : qe, u = n.rects.reference[f] + n.rects.reference[c] - i[c] - n.rects.popper[f], b = i[c] - n.rects.reference[c], x = Un(a), C = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, E = v[p], y = C - g[f] - v[h], N = C / 2 - g[f] / 2 + w, O = Sn(E, N, y), _ = c;
...
function ti(e) {
  ...
  if (d) {
    ...
    if (N === Fe(n) && (N = kt(n), pt(N).position !== "static" && l === "absolute" && (O = "scrollHeight", _ = "scrollWidth")), N = N, o === Me || (o === Ie || o === qe) && a === Dn) {
      E = Xe;
...
function Bn(e, t) {
  ...
  if (g === hn && k) {
    ...
    Object.keys(L).forEach(function($) {
      var z = [qe, Xe].indexOf($) >= 0 ? 1 : -1, H = [Me, Xe].indexOf($) >= 0 ? "y" : "x";
      L[$] += S[H] * z;
    });
  }
  return L;
...
function Pm(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, f = n.boundary, v = n.rootBoundary, g = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, u = n.allowedAutoPlacements, b = t.options.placement, x = Ze(b), C = x === b, w = c || (C || !h ? [rr(b)] : Rm(b)), E = [b].concat(w).reduce(function(G, X) {
      ...
      var k = E[L], S = Ze(k), $ = rn(k) === en, z = [Me, Xe].indexOf(S) >= 0, H = z ? "width" : "height", D = Bn(t, {
        placement: k,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
...
function Vm(e) {
  ...
  if (N) {
    if (a) {
      var $, z = E === "y" ? Me : Ie, H = E === "y" ? Xe : qe, D = E === "y" ? "height" : "width", B = N[E], Z = B + b[z], Q = B - b[H], R = p ? -_[D] / 2 : 0, M = C === en ? O[D] : _[D], U = C === en ? -_[D] : -O[D], J = t.elements.arrow, G = p && J ? Go(J) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var Pe, xe = E === "x" ? Me : Ie, Tt = E === "x" ? Xe : qe, $e = N[y], rt = y === "y" ? "height" : "width", Be = $e + b[xe], ot = $e - b[Tt], Te = [Me, Ie].indexOf(x) !== -1, Lt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, Nt = Te ? Be : $e - O[rt] - _[rt] - Lt + L.altAxis, sn = Te ? $e + O[rt] + _[rt] - Lt - L.altAxis : ot, Wn = p && Te ? pm(Nt, $e, sn) : Sn(p ? Nt : Be, $e, p ? sn : ot);
      N[y] = Wn, S[y] = Wn - $e;
    }
    t.modifiersData[r] = S;
  }
...
`));
  ...
  if (a)
    ...
    const L = mr(r);
    O = L && Ir(L) ? Ce(L).body : Ce(null).body;
  }
...
const Fs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const N = ft({
    ...
    children: _
  }), ke = Gn(), Pe = ke.direction === "rtl", [xe, Tt] = T.useState(), [$e, rt] = T.useState(null), Be = T.useRef(!1), ot = z || Q, Te = wn(), Lt = wn(), Nt = wn(), sn = wn(), [Wn, ea] = os({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const ta = (re) => {
    ...
    Be.current && re.type !== "touchstart" || (xe && xe.removeAttribute("title"), Lt.clear(), Nt.clear(), D || Qn && B ? Lt.start(Qn ? B : D, () => {
      ta(re);
    }) : ta(re));
  }, na = (re) => {
    Lt.clear(), Nt.start(M, () => {
  ...
  const Br = T.useRef(), Cl = (re) => {
    const je = se.props;
    je.onMouseMove && je.onMouseMove(re), gn = {
      x: re.clientX,
      y: re.clientY
...
`));
  ...
  const pn = {};
  H || (ze.onTouchStart = Nl, ze.onTouchEnd = Ol), $ || (ze.onMouseOver = er(la, ze.onMouseOver), ze.onMouseLeave = er(ca, ze.onMouseLeave), ot || (pn.onMouseOver = la, pn.onMouseLeave = ca)), S || (ze.onFocus = er(ia, ze.onFocus), ze.onBlur = er(aa, ze.onBlur), ot || (pn.onFocus = ia, pn.onBlur = aa)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Rl = T.useMemo(() => {
    var re;
    let je = [{
    ...
    className: Se(Lr.popper, q == null ? void 0 : q.className, (p = (h = ee.popper) != null ? h : L.popper) == null ? void 0 : p.className)
  }), un), $l = xn(ua, P({}, ne, (u = ee.transition) != null ? u : L.transition), un), _l = xn(da, P({}, (b = ee.tooltip) != null ? b : L.tooltip, {
    className: Se(Lr.tooltip, (x = (C = ee.tooltip) != null ? C : L.tooltip) == null ? void 0 : x.className)
  }), un), Ml = xn(fa, P({}, (w = ee.arrow) != null ? w : L.arrow, {
    className: Se(Lr.arrow, (E = (y = ee.arrow) != null ? y : L.arrow) == null ? void 0 : E.className)
  }), un);
  return /* @__PURE__ */ F(T.Fragment, {
...
const Wh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Xh = (e) => {
  ...
  const K = (r = (o = z == null ? void 0 : z.root) != null ? o : x.Root) != null ? r : qh, q = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : x.Backdrop) != null ? a : f, ee = (l = $ == null ? void 0 : $.root) != null ? l : C.root, te = (c = $ == null ? void 0 : $.backdrop) != null ? c : C.backdrop, ie = Bt({
    ...
    ownerState: G,
    className: Se(g, ee == null ? void 0 : ee.className, X == null ? void 0 : X.root, !G.open && G.exited && (X == null ? void 0 : X.hidden))
  }), j = Bt({
    elementType: q,
...
const ig = (e) => {
  ...
  const i = ft({
    ...
    const ne = or(c), I = ne && ne.nodeType === 1 ? ne : Ce($.current).body, se = I.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const Tt = Pe + I.height, $e = xe + I.width, rt = Qt(or(c)), Be = rt.innerHeight - b, ot = rt.innerWidth - b;
    if (b !== null && Pe < b) {
      const Te = Pe - b;
...
`)), b !== null && xe < b) {
  ...
  const Y = h || (c ? Ce(or(c)).body : void 0), K = (o = w == null ? void 0 : w.root) != null ? o : sg, q = (a = w == null ? void 0 : w.paper) != null ? a : Zs, ee = Bt({
    elementType: q,
    ...
    ownerState: H,
    className: Se(D.paper, S == null ? void 0 : S.className)
  }), te = Bt({
    elementType: K,
...
const Iv = De.Root, Pg = W.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.List,
  {
    ref: n,
    className: V(
