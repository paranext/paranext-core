...
import u, { useCallback as $, useMemo as F, useState as P, useRef as L, useLayoutEffect as ln, createContext as kr, useContext as Cr, useEffect as Tt, forwardRef as kn, Fragment as Cn } from "react";
...
import { X as Fe, Search as _n, ChevronsLeft as dn, ChevronsRight as cn, ChevronLeft as ze, ChevronRight as Wt, ArrowLeft as Tr, ArrowRight as Rr, Circle as Ge, ChevronsUpDown as Le, Check as Mt, FilterIcon as Er, ChevronDown as me, ChevronUp as Vr, ArrowLeftIcon as Dr, ChevronLeftIcon as Mr, ChevronRightIcon as zr, ArrowRightIcon as Or, Copy as Ar, Filter as Br, User as Pr, Link as Ir, CircleHelp as jr, Star as $r, CircleCheckIcon as Xr, CircleXIcon as Fr, CircleHelpIcon as Gr, ArrowUpIcon as Lr, ArrowDownIcon as Hr, ArrowUpDownIcon as Yr, PanelLeft as Ur, PanelRight as qr, ScrollText as Kr, MenuIcon as Jr, Menu as Wr, EllipsisVertical as Zr, LoaderCircle as Qr } from "lucide-react";
import * as ut from "@radix-ui/react-dialog";
import * as Zt from "@radix-ui/react-popover";
import { getChaptersForBook as ta, formatScrRef as qt, NumberFormat as ea, formatBytes as na, deepEqual as He, isString as _e, compareScrRefs as Oe, scrRefToBBBCCCVVV as Se, getLocalizeKeyForScrollGroupId as B } from "platform-bible-utils";
import * as Sn from "@radix-ui/react-label";
import * as Qt from "@radix-ui/react-radio-group";
import { useReactTable as Tn, getFilteredRowModel as ra, getSortedRowModel as Rn, getPaginationRowModel as aa, getCoreRowModel as En, flexRender as Kt, getGroupedRowModel as oa, getExpandedRowModel as sa } from "@tanstack/react-table";
import * as I from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as ia } from "@radix-ui/react-dropdown-menu";
import * as X from "@radix-ui/react-select";
import wa from "markdown-to-jsx";
...
const pa = kt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? jt : "button", { className: c(pa({ variant: e, size: n, className: t })), ref: s, ...o })
);
z.displayName = "Button";
const ua = "layoutDirection";
function Y() {
  const t = localStorage.getItem(ua);
  return t === "rtl" ? t : "ltr";
}
const ma = ut.Portal, Mn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
    className: c(
...
Mn.displayName = ut.Overlay.displayName;
const ha = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = Y();
  return /* @__PURE__ */ l(ma, { children: [
    /* @__PURE__ */ r(Mn, {}),
    /* @__PURE__ */ l(
      ut.Content,
      {
...
ha.displayName = ut.Content.displayName;
...
fa.displayName = ut.Title.displayName;
const ga = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Description,
  {
    ref: n,
...
ga.displayName = ut.Description.displayName;
...
const ae = u.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(_n, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      Q.Input,
      {
        ref: n,
...
const fe = u.forwardRef((t, e) => /* @__PURE__ */ r(Q.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
zn.displayName = Q.Separator.displayName;
...
const se = Zt.Root, ie = Zt.Trigger, Xt = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = Y();
...
var ba = Object.defineProperty, va = (t, e, n) => e in t ? ba(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => va(t, typeof e != "symbol" ? e + "" : e, n);
const Et = [
  "GEN",
  "EXO",
  "LEV",
...
*/
R(Z, "ValidStatusType", jn);
class Ht extends Error {
}
const $n = M.allBookIds.filter(
  (t) => !M.isObsolete(M.bookIdToNumber(t))
), at = Object.fromEntries(
  $n.map((t) => [t, M.bookIdToEnglishName(t)])
), Va = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon",
  ...
  const n = Da.reduce(
    (a, o) => {
      ...
      if (s) {
        ...
        let d;
        const m = i.toLowerCase(), g = e.filter((h) => at[h].toLowerCase().includes(m) || h.toLowerCase().includes(m));
        if (g.length === 1 && ([d] = g), !d && w && M.isBookIdValid(i)) {
...
function za(t, e, n, a) {
  const o = $(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const d = e[p - 1], m = Math.max(pt(d), 1);
        a({
          book: d,
          chapterNum: m,
          verseNum: 1
...
function Ls({
  ...
  const o = Y(), [s, i] = P(!1), [w, p] = P(""), [d, m] = P(""), [g, h] = P("books"), [f, b] = P(void 0), [_, k] = P(!1), S = L(void 0), x = L(void 0), V = L(void 0), A = L(void 0), J = L({}), et = F(() => a ? a() : $n, [a]), st = F(() => ({
    ...
    if (!d.trim()) return st;
    const N = d.toLowerCase().trim(), O = { OT: [], NT: [], DC: [], Extra: [] };
    return ["OT", "NT", "DC", "Extra"].forEach((W) => {
      O[W] = st[W].filter((q) => at[q].toLowerCase().includes(N) || q.toLowerCase().includes(N));
    }), O;
  }, [st, d]), y = F(
    () => Ma(d, C),
    [d, C]
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: O, isDigit: G } = mn(N.key);
      if (g === "chapters") {
        if (N.key === "Backspace") {
          N.preventDefault(), N.stopPropagation(), lt();
          return;
        }
        if (O || G) {
          if (N.preventDefault(), N.stopPropagation(), h("books"), b(void 0), G && f) {
            const W = at[f];
            m(`${W} ${N.key}`);
          } else
            m(N.key);
      ...
      if ((g === "chapters" || g === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key)) {
        const W = g === "chapters" ? f : y == null ? void 0 : y.book;
        if (!W) return;
        const q = (() => {
          if (!w) return 1;
          const Lt = w.match(/(\d+)$/);
        ...
        ht !== q && (N.preventDefault(), N.stopPropagation(), p(hn(W, ht)), setTimeout(() => {
    ...
    const { isLetter: O, isDigit: G } = mn(N.key);
    (O || G) && (N.preventDefault(), m((W) => W + N.key), x.current.focus(), k(!1));
  }, []);
  return ln(() => {
    const N = setTimeout(() => {
      if (s && g === "books" && V.current && A.current) {
  ...
  }, [g, f, y, t.book, t.chapterNum]), /* @__PURE__ */ l(se, { open: s, onOpenChange: nt, children: [
      ...
      re,
      {
        ...
        children: [
          g === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Gt.map(({ onClick: N, disabled: O, title: G, icon: W }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                tabIndex: -1,
                children: o === "ltr" ? /* @__PURE__ */ r(Tr, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Rr, { className: "tw-h-4 tw-w-4" })
              }
            ),
            /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: at[f || ""] || "" })
          ] }),
          !_ && /* @__PURE__ */ l(oe, { ref: V, children: [
            g === "books" && /* @__PURE__ */ l(Jt, { children: [
              !y && Object.entries(v).map(([N, O]) => {
                if (O.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses BookType as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(At, { heading: Va[N], children: O.map((G) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: c(
              ...
              y && pt(y.book) > 1 && /* @__PURE__ */ l(Jt, { children: [
...
), H = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Sn.Root, { ref: n, className: c("pr-twp", Oa(), t), ...e }));
H.displayName = Sn.Root.displayName;
const Ke = u.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    Qt.Root,
    {
...
function Ie({
  ...
  const [k, S] = P(!1);
  return /* @__PURE__ */ l(se, { open: k, onOpenChange: S, ..._, children: [
    ...
    /* @__PURE__ */ r(
      Xt,
      {
        ...
        children: /* @__PURE__ */ l(re, { children: [
          /* @__PURE__ */ r(ae, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(fe, { children: g }),
          /* @__PURE__ */ r(oe, { children: e.map((x) => /* @__PURE__ */ l(
            Rt,
            {
              value: w(x),
              onSelect: () => {
...
function Ys({
  ...
  const m = Re(d, "%webView_bookSelector_currentBook%"), g = Re(d, "%webView_bookSelector_choose%"), h = Re(d, "%webView_bookSelector_chooseBooks%"), [f, b] = P(
    "current book"
    /* CURRENT_BOOK */
  ), _ = (k) => {
    b(k), t(k);
...
}), Xn = I.Trigger, Fn = I.Group, Ia = I.Portal, ja = I.Sub, $a = I.RadioGroup;
...
const Gn = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = wt();
  return /* @__PURE__ */ l(
    I.SubTrigger,
    {
...
Gn.displayName = I.SubTrigger.displayName;
...
Ln.displayName = I.SubContent.displayName;
const ge = u.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = Y();
...
const Hn = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = Y(), s = wt();
  return /* @__PURE__ */ r(
    I.Item,
    {
...
Hn.displayName = I.Item.displayName;
...
const Yn = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = wt();
  return /* @__PURE__ */ l(
    I.RadioItem,
    {
...
Yn.displayName = I.RadioItem.displayName;
const Qe = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  I.Label,
  {
    ref: a,
...
function Fa({ table: t }) {
  return /* @__PURE__ */ l(We, { children: [
    /* @__PURE__ */ r(ia, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Bt = X.Root, Ga = X.Group, Pt = X.Value, La = kt(
...
), Vt = u.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = Y();
  return /* @__PURE__ */ l(
    X.Trigger,
    {
      className: c(La({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
Un.displayName = X.ScrollUpButton.displayName;
...
qn.displayName = X.ScrollDownButton.displayName;
const Dt = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = Y();
...
Ha.displayName = X.Label.displayName;
const ot = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  X.Item,
  {
    ref: a,
    className: c(
...
function te(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (a) => !a.hasAttribute("disabled") && !a.getAttribute("aria-hidden") && qa(a)
  );
}
const ve = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
  ...
  u.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        te(i, '[tabindex]:not([tabindex="-1"])').forEach((m) => {
...
const xe = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: c(
...
const ye = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: c("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const Nt = u.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a = !1, ...o }, s) => {
  ...
  const w = u.useMemo(
    ...
    (m) => {
      ...
      if (m.key === "ArrowDown" || m.key === "ArrowUp")
        m.preventDefault(), Za(f, b, m.key);
      else if (m.key === "ArrowLeft" || m.key === "ArrowRight")
        m.preventDefault(), Wa(w, _, m.key);
...
const It = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function to({
  ...
  var k;
  const [w, p] = P([]), [d, m] = P([]), [g, h] = P({}), [f, b] = P({}), _ = Tn({
    data: e,
    columns: t,
    getCoreRowModel: En(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(Fa, { table: _ }),
    /* @__PURE__ */ l(ve, { stickyHeader: s, children: [
      /* @__PURE__ */ r(xe, { stickyHeader: s, children: _.getHeaderGroups().map((S) => /* @__PURE__ */ r(Nt, { children: S.headers.map((x) => /* @__PURE__ */ r(ee, { children: x.isPlaceholder ? void 0 : Kt(x.column.columnDef.header, x.getContext()) }, x.id)) }, S.id)) }),
      /* @__PURE__ */ r(ye, { children: (k = _.getRowModel().rows) != null && k.length ? _.getRowModel().rows.map((S) => /* @__PURE__ */ r(
        Nt,
        {
          onClick: () => i(S, _),
          "data-state": S.getIsSelected() && "selected",
          children: S.getVisibleCells().map((x) => /* @__PURE__ */ r(It, { children: Kt(x.column.columnDef.cell, x.getContext()) }, x.id))
        },
        S.id
    ...
    n && a && /* @__PURE__ */ r(Ua, { table: _ })
  ] });
}
function Us({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = F(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: c("pr-twp tw-prose", n), children: /* @__PURE__ */ r(wa, { options: o, children: e }) });
}
const qs = Object.freeze([
  "%webView_error_dump_header%",
  "%webView_error_dump_info_message%"
]), bn = (t, e) => t[e] ?? e;
function eo({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const a = bn(n, "%webView_error_dump_header%"), o = bn(n, "%webView_error_dump_info_message%");
  function s() {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Ar, {}) })
    ] }),
...
var no = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(no || {});
function Js({ id: t, label: e, groups: n }) {
  const [a, o] = P(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(We, { children: [
    /* @__PURE__ */ r(Xn, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "default", children: [
      /* @__PURE__ */ r(Br, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(me, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ge, { children: n.map((d, m) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(Qe, { children: d.label }),
      /* @__PURE__ */ r(Fn, { children: d.itemType === 0 ? /* @__PURE__ */ r(Jt, { children: d.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Ze,
        {
          checked: a[m][h],
        ...
        $a,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Yn, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(be, {})
    ] }, d.label)) })
...
function ro({ id: t, versionHistory: e }) {
...
function Zs({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(o).length > 0 && /* @__PURE__ */ r(ro, { versionHistory: o }),
...
const ao = kt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: c("pr-twp", ao({ variant: e }), t), ...n })
);
...
function oo({
  ...
  const [g, h] = P(!1), f = $(
    ...
    const k = t.filter((x) => x.starred).sort((x, V) => x.label.localeCompare(V.label)), S = t.filter((x) => !x.starred).sort((x, V) => {
      const A = n.includes(x.value), J = n.includes(V.value);
      return A && !J ? -1 : !A && J ? 1 : x.label.localeCompare(V.label);
    });
    return [...k, ...S];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(se, { open: g, onOpenChange: h, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ l(
      z,
      {
        variant: "ghost",
          ...
          return /* @__PURE__ */ l(
            Rt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: k.starred && /* @__PURE__ */ r($r, { className: "tw-h-4 tw-w-4" }) }),
...
), io = u.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Vn.Root,
  {
    ref: o,
    className: c(Kn({ variant: e, size: n, className: t })),
    ...a
  }
));
io.displayName = Vn.Root.displayName;
const Jn = u.createContext({
  size: "default",
  variant: "default"
}), Wn = u.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = Y();
  return /* @__PURE__ */ r(
    he.Root,
    {
...
Wn.displayName = he.Root.displayName;
const de = u.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = u.useContext(Jn);
  return /* @__PURE__ */ r(
    he.Item,
    {
      ref: s,
...
const Ne = (t) => t === "asc" ? /* @__PURE__ */ r(Lr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Yr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ti = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(Wn, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        de,
        {
          onClick: (p) => {
  ...
  return e ? e[1] : "";
}, lo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", si = Object.freeze([
...
function ii({
  ...
  const d = ft(n, "%webView_inventory_all%"), m = ft(n, "%webView_inventory_approved%"), g = ft(n, "%webView_inventory_unapproved%"), h = ft(n, "%webView_inventory_unknown%"), f = ft(n, "%webView_inventory_scope_currentBook%"), b = ft(n, "%webView_inventory_scope_chapter%"), _ = ft(n, "%webView_inventory_scope_verse%"), k = ft(n, "%webView_inventory_filter_text%"), S = ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = P(!1), [A, J] = P("all"), [et, st] = P(""), [C, v] = P([]), y = F(() => t.length === 0 ? [] : po(t, o, s), [t, o, s]), E = F(() => {
    if (x) return y;
    const T = [];
    return y.forEach((U) => {
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Bt, { onValueChange: (T) => lt(T), defaultValue: i, children: [
        ...
        /* @__PURE__ */ l(Dt, { children: [
          ...
          /* @__PURE__ */ r(ot, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ r(
        we,
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(H, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? S })
      ] })
    ] }),
...
const en = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Dn.Root,
  {
    ref: o,
    decorative: n,
...
en.displayName = Dn.Root.displayName;
...
const nn = ne.Provider, rn = ne.Root, an = ne.Trigger, ke = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ne.Content,
  {
    ref: a,
    sideOffset: e,
...
const uo = "16rem", mo = "3rem", Zn = u.createContext(void 0);
function Ce() {
...
const Qn = u.forwardRef(
  ({
    ...
    const [d, m] = u.useState(t), g = e ?? d, h = u.useCallback(
      ...
      [n, g]
    ), f = u.useCallback(() => h((V) => !V), [h]), b = g ? "expanded" : "collapsed", S = Y() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = u.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Zn.Provider, { value: x, children: /* @__PURE__ */ r(nn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
Qn.displayName = "SidebarProvider";
const tr = u.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Ce();
...
tr.displayName = "Sidebar";
const ho = u.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Ce();
  return /* @__PURE__ */ l(
    z,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(Ur, {}) : /* @__PURE__ */ r(qr, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
ho.displayName = "SidebarTrigger";
...
er.displayName = "SidebarInset";
const go = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  we,
  {
    ref: n,
    "data-sidebar": "input",
...
xo.displayName = "SidebarSeparator";
...
const yo = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? jt : "button",
  {
    ref: a,
...
yo.displayName = "SidebarGroupAction";
...
const No = kt(
  ...
  ({
    ...
    const p = t ? jt : "button", { state: d } = Ce(), m = /* @__PURE__ */ r(
      p,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: c(No({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(an, { asChild: !0, children: m }),
      /* @__PURE__ */ r(ke, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : m;
  }
);
or.displayName = "SidebarMenuButton";
const ko = u.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? jt : "button",
  {
    ref: o,
...
ko.displayName = "SidebarMenuAction";
...
const _o = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(vn, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          vn,
          {
...
_o.displayName = "SidebarMenuSkeleton";
...
So.displayName = "SidebarMenuSub";
const To = u.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
To.displayName = "SidebarMenuSubItem";
const Ro = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? jt : "a",
  {
    ref: s,
...
function Eo({
  ...
  return /* @__PURE__ */ r(
    tr,
    {
      ...
      children: /* @__PURE__ */ l(nr, { children: [
        /* @__PURE__ */ l(je, { children: [
          /* @__PURE__ */ r($e, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Xe, { children: /* @__PURE__ */ r(rr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(ar, { children: /* @__PURE__ */ r(
            or,
            {
              onClick: () => d(h),
              isActive: g(h),
    ...
    /* @__PURE__ */ l(
      Qn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(er, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const xt = "scrBook", Vo = "scrRef", St = "source", Do = "details", Mo = "Scripture Reference", zo = "Scripture Book", sr = "Type", Oo = "Details";
function Ao(t, e) {
  const n = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: St,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? sr : void 0,
...
}, xn = (t) => `${Bo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function li({
  sources: t,
  ...
  const [p, d] = P([]), [m, g] = P([{ id: xt, desc: !1 }]), [h, f] = P({}), b = F(
  ...
  Tt(() => {
    if (w) {
      ...
      if (v.length === 1) {
        const y = b.find((E) => xn(E) === v[0]) || void 0;
        y && w(y);
      }
    }
  }, [h, b, w, k]);
  const S = o ?? zo, x = s ?? sr, V = [
  ...
  }, et = (C, v) => C.getIsGrouped() ? "" : c("banded-row", v % 2 === 0 ? "even" : "odd"), st = (C, v, y) => {
    ...
    !e && /* @__PURE__ */ l(
      Bt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Dt, { position: "item-aligned", children: /* @__PURE__ */ r(Ga, { children: V.map((C) => /* @__PURE__ */ r(ot, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ l(
                      z,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (y === "ltr" ? /* @__PURE__ */ r(Wt, {}) : /* @__PURE__ */ r(ze, {})),
                          " ",
...
}), ir = (t, e, n) => sn(t, e).every((a) => n.includes(a));
function jo({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
...
function Xo({
  ...
  const A = F(() => M.allBookIds.filter(
    ...
    (v, y = !1) => {
      ...
      const E = A.findIndex((nt) => nt === x.current), K = A.findIndex((nt) => nt === v);
      if (E === -1 || K === -1) return;
      const [zt, Gt] = [
        Math.min(E, K),
        Math.max(E, K)
    ...
    (v) => {
      const y = sn(A, v).map((E) => E);
      n(
        ir(A, v, e) ? e.filter((E) => !y.includes(E)) : [.../* @__PURE__ */ new Set([...e, ...y])]
      );
    },
    [e, n, A]
  ), st = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(se, { open: k, onOpenChange: S, children: [
      /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ l(
        z,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(Xt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
        re,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l(oe, { children: [
              /* @__PURE__ */ r(fe, { children: m }),
              Object.values(yt).map((v, y) => {
                const E = A.filter(
                  (K) => Ot(K) === v
                );
                if (E.length !== 0)
                  return /* @__PURE__ */ l(Cn, { children: [
                    ...
                    y < Object.values(yt).length - 1 && /* @__PURE__ */ r(zn, {})
                  ] }, v);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var y;
        return /* @__PURE__ */ r(pe, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((y = o.get(v)) == null ? void 0 : y.localizedName) || M.bookIdToEnglishName(v) || v }, v);
      }),
...
function ci({
  ...
  const p = Ct(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), g = Ct(i, "%webView_scope_selector_current_book%"), h = Ct(i, "%webView_scope_selector_choose_books%"), f = Ct(i, "%webView_scope_selector_scope%"), b = Ct(i, "%webView_scope_selector_select_books%"), _ = [
      ...
      /* @__PURE__ */ r(
        Ke,
        {
          ...
          children: k.map(({ value: S, label: x, id: V }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(ce, { className: "tw-me-2", value: S, id: V }),
            /* @__PURE__ */ r(H, { htmlFor: V, children: x })
          ] }, V))
        }
      )
    ] }),
...
const lr = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(an, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(Ia, { children: /* @__PURE__ */ r(Ln, { children: lr(
      t,
      e,
      wr(t, w.id),
      a
...
function Nn({
  ...
  return /* @__PURE__ */ l(We, { variant: s, children: [
    /* @__PURE__ */ r(Xn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Jr, {}) }) }),
    /* @__PURE__ */ r(ge, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w], p, d) => /* @__PURE__ */ l(Cn, { children: [
      /* @__PURE__ */ r(Fn, { children: /* @__PURE__ */ r(nn, { children: lr(e.groups, e.items, w, t) }) }),
...
cr.displayName = tt.List.displayName;
const Fo = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.Trigger,
  {
    ref: n,
    ...e,
...
)), pr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.Content,
  {
    ref: n,
    className: c(
...
pr.displayName = tt.Content.displayName;
function gi({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(dr, { children: [
      /* @__PURE__ */ r(cr, { children: t.map((i) => /* @__PURE__ */ r(Fo, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(pr, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function Go({ ...t }) {
...
const ur = u.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = u.useMemo(
    () => ({
      variant: e
    }),
...
mr.displayName = j.Trigger.displayName;
const hr = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = wt();
  return /* @__PURE__ */ l(
    j.SubTrigger,
    {
...
fr.displayName = j.SubContent.displayName;
const gr = u.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = wt();
...
gr.displayName = j.Content.displayName;
const br = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = wt();
  return /* @__PURE__ */ r(
    j.Item,
    {
...
br.displayName = j.Item.displayName;
const Ho = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = wt();
  return /* @__PURE__ */ l(
    j.CheckboxItem,
    {
...
Ho.displayName = j.CheckboxItem.displayName;
const Yo = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = wt();
  return /* @__PURE__ */ l(
    j.RadioItem,
    {
...
const Uo = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: a,
    className: c("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
vr.displayName = j.Separator.displayName;
const Yt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((d) => d.group === s).sort((d, m) => d.order - m.order).map((d) => /* @__PURE__ */ l(rn, { children: [
      /* @__PURE__ */ r(an, { asChild: !0, children: "command" in d ? /* @__PURE__ */ l(
        ...
        /* @__PURE__ */ r(hr, { children: d.label }),
        /* @__PURE__ */ r(fr, { children: xr(
          t,
          e,
          wr(t, d.id),
          a
    ...
    return w.length > 0 && i < o.length - 1 && p.push(/* @__PURE__ */ r(vr, {}, `separator-${s}`)), p;
  });
};
function qo({
  menuData: t,
  ...
  if (la(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    var b, _, k, S;
    m.preventDefault();
    ...
    switch (g.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), Yt(s, [h, f]);
        break;
      case "alt+l":
        (_ = i.current) == null || _.focus(), Yt(i, [h, f]);
        break;
      case "alt+n":
        (k = w.current) == null || k.focus(), Yt(w, [h, f]);
        break;
      case "alt+h":
        (S = p.current) == null || S.focus(), Yt(p, [h, f]);
        break;
    }
  }), Tt(() => {
    ...
    return /* @__PURE__ */ r(ur, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ l(Go, { children: [
      /* @__PURE__ */ r(mr, { ref: d(m), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        gr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(nn, { children: xr(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function xi({
  ...
  const p = Ko(
    ...
    return _ ? `${(A = t[f]) == null ? void 0 : A.autonym} (${_})` : (J = t[f]) == null ? void 0 : J.autonym;
  };
...
function Jo({ item: t, createLabel: e, createComplexLabel: n }) {
...
const Wo = kn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Qr, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
), Qo = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: c(Zo({ variant: e }), t), ...n }));
...
const es = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: c("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
ns.displayName = $t.Root.displayName;
...
rs.displayName = $t.Image.displayName;
...
as.displayName = $t.Fallback.displayName;
...
const ws = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const ki = it.Trigger, ps = it.Portal, Ci = it.Close, Nr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  it.Overlay,
  {
    ref: n,
...
Nr.displayName = it.Overlay.displayName;
const us = u.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = u.useContext(yr), i = {
...
fs.displayName = it.Title.displayName;
...
gs.displayName = it.Description.displayName;
const bs = u.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Be.Root,
  {
    ref: a,
    className: c(
...
bs.displayName = Be.Root.displayName;
function _i({ ...t }) {
  return /* @__PURE__ */ r(
    da,
    {
...
vs.displayName = Ut.Root.displayName;
...
xs.displayName = Pe.Root.displayName;
const Si = tt.Root, ys = u.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    tt.List,
    {
...
ys.displayName = tt.List.displayName;
const Ns = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.Trigger,
  {
    ref: n,
...
Ns.displayName = tt.Trigger.displayName;
...
ks.displayName = tt.Content.displayName;
...
export {
  ...
  Ks as ErrorPopover,
  Qs as Filter,
  Js as FilterDropdown,
  Zs as Footer,
  si as INVENTORY_STRING_KEYS,
  we as Input,
  ii as Inventory,
  H as Label,
  Us as MarkdownRenderer,
  Ws as MoreInfo,
  oo as MultiSelectComboBox,
  ...
  or as SidebarMenuButton,
  ar as SidebarMenuItem,
  _o as SidebarMenuSkeleton,
