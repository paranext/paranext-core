...
var vs = (t, e, r) => e in t ? ms(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var re = (t, e, r) => vs(t, typeof e != "symbol" ? e + "" : e, r);
import { c as x, g as je, a as Lr, C as sr, L as Fn, u as Zo, T as $t, b as Dt, d as Ot, e as Mt, A as ba, D as He, f as Oe, h as qe, i as Or, j as tr, B as tt, x as bs, k as xs, l as ys, I as ks, m as No, n as or, r as ze, o as _s, p as Un, P as hr, q as Mr, s as gr, t as fr, v as Ra, w as Da, y as Co, z as mr, E as Oa, F as At, R as Eo, G as xa, H as oo, J as no, K as io, M as so, N as Kn, O as da, Q as To, S as Ur, U as Kr, V as kr, W as Ns, X as wr, Y as ar, Z as Ge, _ as er, $ as _r, a0 as So, a1 as Ro, a2 as ya, a3 as Do, a4 as Hn, a5 as Cs, a6 as Es, a7 as Ts, a8 as co, a9 as qn, aa as Ma, ab as Ss, ac as Gn, ad as Rs, ae as Ds, af as Os, ag as Jo, ah as Ms, ai as Is, aj as zs, ak as Wn, al as Yn, am as Oo, an as Ps, ao as Xn, ap as Fa, aq as Qo, ar as Ua, as as As, at as $s, au as Vs, av as Ls, aw as Bs, ax as Gr, ay as Mo, az as js, aA as Fs } from "./resizable-DWUA1ZY3.js";
...
import { Check as nr, Clock as tn, ChevronsLeft as en, ChevronsRight as rn, ChevronUp as Zn, ChevronDown as ur, ArrowLeft as Us, ArrowRight as Ks, BoldIcon as Hs, ItalicIcon as qs, X as Io, AtSign as Jn, Pencil as Gs, Trash2 as Ws, ArrowUp as Qn, MoreHorizontal as Ys, MailOpen as Xs, Mail as Zs, FilterIcon as Js, ArrowLeftIcon as Qs, ChevronLeftIcon as tc, ChevronRightIcon as ec, ArrowRightIcon as rc, Copy as ti, Filter as ac, User as oc, Link as nc, CircleHelp as ic, Undo as sc, Redo as cc, SquareX as ei, FunctionSquare as ri, SquareSigma as ai, Ban as lc, AlertCircle as dc, CircleCheckIcon as wc, CircleXIcon as uc, CircleHelpIcon as pc, ArrowUpIcon as hc, ArrowDownIcon as gc, ScrollText as fc, ChevronRight as mc, ChevronLeft as vc, ChevronsUpDown as bc, MenuIcon as xc, Menu as yc, EllipsisVertical as kc, MoreVertical as _c } from "lucide-react";
import { Section as Pt, compareScrRefs as ka, getChaptersForBook as Nc, formatScrRef as Fe, formatReplacementString as rr, getSectionForBook as wa, formatRelativeDate as Cc, sanitizeHtml as zo, NumberFormat as oi, formatBytes as Ec, getCurrentLocale as Tc, usfmMarkers as ua, deepEqual as ni, isPlatformError as Sc, ABORTED as Rc, getErrorMessage as Dc, getFormatCallerFunction as Oc, isString as an, scrRefToBBBCCCVVV as Ka, defaultScrRef as Ha, formatScrRefRange as Mc, getLocalizeKeyForScrollGroupId as on, formatReplacementStringToArray as nn, collectUsjMarkers as Ic } from "platform-bible-utils";
import de, { useRef as B, useMemo as V, createContext as Wr, useContext as Ia, useState as _, useEffect as W, useCallback as L, useId as lo, useImperativeHandle as ii, useLayoutEffect as Xt, Fragment as pr, Component as zc, createElement as sn, Suspense as Pc, forwardRef as si } from "react";
import { IconSelector as ci, IconCheck as za, IconChevronDown as Ac, IconChevronUp as $c, IconLayoutSidebar as Vc, IconLayoutSidebarRight as Lc, IconChevronRight as li, IconSearch as Bc, IconLoader as jc, IconAlertOctagon as Fc, IconAlertTriangle as Uc, IconInfoCircle as Kc, IconCircleCheck as Hc } from "@tabler/icons-react";
import { createEditor as di, $getRoot as ir, $createParagraphNode as Yr, $getSelection as we, HISTORY_MERGE_TAG as Po, ParagraphNode as wi, TextNode as ui, $getPreviousSelection as qc, $isRangeSelection as Me, $caretFromPoint as Gc, $getSiblingCaret as pi, $getChildCaret as Wc, $getAdjacentChildCaret as Yc, $isChildCaret as Xc, $normalizeCaret as Zc, $setSelectionFromCaretRange as Jc, $getCollapsedCaretRange as Qc, $getCaretInDirection as cn, $splitAtPointCaretNext as tl, $isTextPointCaret as el, $findMatchingParent as hi, $isElementNode as Hr, mergeRegister as Ke, getDOMTextNode as rl, isHTMLElement as al, CLEAR_EDITOR_COMMAND as gi, COMMAND_PRIORITY_EDITOR as Ao, shallowMergeConfig as ol, defineExtension as ke, safeCast as vr, createState as nl, FORMAT_TEXT_COMMAND as fi, $isNodeSelection as mi, COMMAND_PRIORITY_LOW as vi, RootNode as il, LineBreakNode as sl, TabNode as cl, $isEditorState as ll, createCommand as dl, CLICK_COMMAND as wl, isDOMNode as ul, $getNodeFromDOMNode as pl, $createNodeSelection as hl, $setSelection as gl, $getEditor as fl, DecoratorNode as wo, $getState as ml, toggleTextFormatType as ln, TEXT_TYPE_TO_FORMAT as vl, $setState as bl, addClassNamesToElement as bi, $create as xl, $getNodeByKey as yl, removeClassNamesFromElement as kl, KEY_TAB_COMMAND as _l, $isBlockElementNode as Nl, $createRangeSelection as Cl, $normalizeSelection__EXPERIMENTAL as El, OUTDENT_CONTENT_COMMAND as Tl, INDENT_CONTENT_COMMAND as dn, INSERT_TAB_COMMAND as Sl, COMMAND_PRIORITY_CRITICAL as $o, $isDecoratorNode as Rl, $isParagraphNode as Dl, $isTextNode as uo, SELECTION_CHANGE_COMMAND as xi, $insertNodes as Ol } from "lexical";
...
import { createHeadlessEditor as yi } from "@lexical/headless";
import { $generateHtmlFromNodes as Vl, $generateNodesFromDOM as Ll } from "@lexical/html";
import { Avatar as Vo, Select as oe, Checkbox as wn, Slot as Xr, Tabs as Te, Menubar as Pe, ContextMenu as qt, Progress as un, Slider as aa, Switch as pn } from "radix-ui";
import { useReactTable as ki, getFilteredRowModel as Bl, getSortedRowModel as _i, getPaginationRowModel as jl, getCoreRowModel as Ni, flexRender as Br, getGroupedRowModel as Fl, getExpandedRowModel as Ul } from "@tanstack/react-table";
import Kl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as po, HIDDEN_NOTE_CALLER as ho, getDefaultViewOptions as Hl, isInsertEmbedOpOfType as Pr, getMarkerMenuItems as ql, defaultStyleInfo as Gl, Editorial as Wl } from "@eten-tech-foundation/platform-editor";
...
function Ei({
  ...
  const m = B(!1), f = () => {
    ...
    () => Lr(e, l),
    [e, l]
  ), C = !!h && !p, P = `${E} (${k})`, K = C ? g || `${P}, ${h}` : P, N = /* @__PURE__ */ u(
    sr,
    {
      ref: t,
      value: d || `${e} ${Ht.bookIdToEnglishName(e)}`,
      onSelect: f,
      onMouseDown: v,
      role: "option",
      "aria-selected": r,
...
let go = "keyboard", gn = !1;
function rd() {
  gn || typeof document > "u" || (gn = !0, document.addEventListener(
    "pointerdown",
    () => {
      go = "pointer";
    },
...
function ad({
  ...
  const {
    ...
    onPointerEnter: m,
    onPointerLeave: f
  } = Zo(), [v, E] = _(!1), [k, C] = _(!1), P = B(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), K = n && e !== void 0, N = s ?? (e !== void 0 && !n);
  W(() => {
    var R;
    rd();
    const X = (R = P.current) == null ? void 0 : R.closest('button, [role="combobox"], [tabindex]');
    if (!X) return;
    const y = (Y) => !!Y && Y.scrollWidth > Y.clientWidth, et = () => {
      go !== "pointer" && (N || y(h.current) || y(l.current)) && C(!0);
    }, I = () => C(!1);
    return X.addEventListener("focus", et), X.addEventListener("blur", I), () => {
      X.removeEventListener("focus", et), X.removeEventListener("blur", I);
    };
  }, [N, h, l]);
  const j = L(() => {
    N && E(!0), m(), K && w();
  ...
  const O = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), D = K ? (
        ...
        children: [
          /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                T,
                T && M && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                M
              ]
            }
          ) }),
          /* @__PURE__ */ a(Mt, { children: i })
        ]
      }
    ) })
  );
...
function sd({
  ...
  const [h, g] = _(!1), [m, f] = _(!1), v = lo(), E = B(!1), k = w !== void 0, C = k ? w : h, P = n === "" ? "" : le(n, nd), K = le(s, id), N = (D) => {
    D || (E.current = !0, f(!1)), k || g(D), p == null || p(D);
  }, j = (D) => {
    if (D && E.current) {
      E.current = !1;
      return;
  ...
  const $ = (D) => {
    ...
    tt,
    {
      ...
      children: /* @__PURE__ */ a(tn, { className: "tw:h-4 tw:w-4" })
    }
  );
  return /* @__PURE__ */ u(He, { open: C, onOpenChange: N, modal: !1, children: [
    /* @__PURE__ */ a($t, { children: P ? /* @__PURE__ */ u(Dt, { open: m, onOpenChange: j, children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: O }) }),
      /* @__PURE__ */ a(Mt, { children: P })
        ...
        children: [
          ...
          t.map((D) => /* @__PURE__ */ u(
            tr,
            {
              ...
              children: [
                /* @__PURE__ */ a(tn, { className: "tw:me-2 tw:h-4 tw:w-4 tw:opacity-50" }),
...
function pd(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : Ht.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
  ), i = mo(s), c = Object.values(i).flat(), l = mo(t);
  return {
...
function gd({
  ...
  switch (o === "rtl" ? hd(e) : e) {
    ...
    case "ArrowRight":
      return t < r ? t + 1 : 1;
    case "ArrowUp":
      return Math.max(1, t - vo);
    case "ArrowDown":
      return Math.min(r, t + vo);
    default:
      return t;
  }
}
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(or, { children: /* @__PURE__ */ a(
      "div",
      {
        ...
        style: { gridTemplateColumns: `repeat(${vo}, minmax(0, 1fr))` },
...
function Ga({
  ...
  const N = ze(), j = ed(), [$, O] = _(!1), [D, T] = _(""), [M, X] = _(""), [y, et] = _("books"), [I, R] = _(void 0), [Y, st] = _(
    void 0
  ), [ot, ut] = _(void 0), [Ct, J] = _(!1), [ct, ht] = _(!1), [nt, Et] = _(!1), [ne, bt] = _(!1), Se = B(null), _e = B(!1), Bt = B(void 0), xt = B(void 0), Gt = B(void 0), fe = B(void 0), It = B({}), gt = B({}), vt = L(
    (b) => {
      e(b), l && l(b);
    },
    [e, l]
    ...
    () => pd(ue, jt),
    [ue, jt]
  ), Tt = kt.has(t.book), se = V(() => M.trim() ? mo(
    yt.filter((b) => No(b, M, s))
  ) : ct ? Zt : ie, [
    ie,
    Zt,
    yt,
    ...
    if (!z) return;
    const b = D.startsWith(`${z.book} `) ? D : "", q = oa(b), at = Vr(b);
    return {
      book: z.book,
      chapterNum: at ?? z.chapterNum ?? 1,
      verseNum: q ?? z.verseNum ?? 1
    };
  }, [z, D]), me = B(!1);
  W(() => {
    if (!me.current) {
  ...
  const Jt = L(() => {
    ...
    (b) => {
      const q = Y ?? (z == null ? void 0 : z.book), at = ot ?? (z == null ? void 0 : z.chapterNum);
      !q || !at || (vt({
        book: q,
        chapterNum: at,
        verseNum: b
    ...
    (b) => {
      const q = y === "chapters" ? I : z == null ? void 0 : z.book;
      if (q) {
        if (w && w(q, b) > 1) {
          st(q), ut(b), et("verses"), T("");
          return;
        }
        vt({
          book: q,
    ...
    et("books"), R(void 0), st(void 0), ut(void 0), bt(!1), setTimeout(() => {
      var b;
      (b = xt.current) == null || b.focus();
    }, 0);
  }, []), he = L(() => {
    const b = Y;
    st(void 0), ut(void 0), b ? (R(b), et("chapters"), T("")) : Wt();
  }, [Y, Wt]), ge = L(
    (b) => {
      O(b), b && (et("books"), R(void 0), st(void 0), ut(void 0), X(""), bt(!1), Et(!1), ht(Tt));
    },
    [Tt]
  );
  W(() => {
  ...
  W(() => {
    var b;
    Ve !== 0 && ((b = xt.current) == null || b.focus());
  }, [Ve]), ii(
    P,
    () => ({
      open: () => {
  ...
  const { otLong: We, ntLong: Ye, dcLong: Xe, extraLong: Ze } = {
    ...
    () => Fe(
      t,
      s ? je(t.book, s) : "English"
    ),
    [t, s]
  ), G = V(
    () => j >= jr.TIGHT ? Lr(t.book, s) : je(t.book, s),
    [t.book, s, j]
  ), Q = `${t.chapterNum}:${t.verseNum}`, H = L((b) => (q) => {
    It.current[b] = q;
  }, []), it = L((b) => (q) => {
    gt.current[b] = q;
  }, []), wt = V(
    () => dd(M),
    [M]
  ), dt = V(() => !w || !z || !z.chapterNum || !wt ? !1 : w(z.book, z.chapterNum) > 0, [w, z, wt]), St = y === "books" && !Ct && !M.trim() && kt.size > 0, Ft = L(
    (b) => p ? fn(b, p) : !1,
    [p]
  ), Rt = L(
    (b) => (q) => p ? wd(b, q, p) : !1,
    ...
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), h && h.includes(b.key) && z && z.chapterNum !== void 0 && z.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), Jt());
    },
    [h, z, Jt]
  ), ra = L(
    (b) => {
      ...
      if (!(!!q && !!((Wo = Bt.current) != null && Wo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (b.key === "Tab") {
        const Lt = Bt.current ? md(Bt.current) : [];
        if (Lt.length === 0) {
          b.preventDefault(), b.stopPropagation();
          return;
        }
        const xe = Lt[Lt.length - 1], ee = b.shiftKey ? Lt[0] : xe;
        document.activeElement === ee && (b.preventDefault(), b.stopPropagation(), (b.shiftKey ? xe : Lt[0]).focus());
        return;
      }
      const { isLetter: Ut, isDigit: Yt } = hn(b.key);
      if ((y === "chapters" || y === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const xe = (() => {
          if (y === "verses") {
            const zr = Y, Xo = ot, ja = oa(D);
            return !zr || !Xo || ja === void 0 ? void 0 : {
              isDisabled: te(zr, Xo)(ja),
              activate: () => Qt(ja)
            };
          }
          const ee = I, Ce = Vr(D);
      ...
      if (y === "books" && z && !Ct && b.key === "Enter" && !(q !== xt.current && !!(q != null && q.closest('button, a, input, select, textarea, [role="button"]')))) {
        b.preventDefault(), b.stopPropagation(), Jt();
        return;
      }
      if ((y === "chapters" || y === "verses") && (Ut || Yt)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (b.key === "Backspace" && (y === "chapters" || y === "verses")) {
        b.preventDefault(), b.stopPropagation(), y === "verses" ? he() : Wt();
        return;
      }
      if (!Ql(b.key) || Ct) return;
      if (y === "books" && !ne && (b.key === "ArrowLeft" || b.key === "ArrowRight")) {
        const Lt = q === xt.current ? xt.current : void 0, xe = (Lt == null ? void 0 : Lt.selectionStart) ?? 0, ee = (Lt == null ? void 0 : Lt.selectionEnd) ?? 0, Ce = N === "rtl" ? b.key === "ArrowRight" : b.key === "ArrowLeft";
        if (!!Lt && (xe !== ee || (Ce ? xe > 0 : ee < Lt.value.length))) return;
      }
      if (b.shiftKey || y === "books" && q !== xt.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const Nt = (() => {
        const Lt = y === "books" && z && dt && z.chapterNum ? { bookId: z.book, chapterNum: z.chapterNum } : void 0, xe = y === "verses" ? { bookId: Y, chapterNum: ot } : Lt;
        if (xe) {
          const { bookId: ee, chapterNum: Ce } = xe;
          return !ee || !Ce || !w ? void 0 : {
            max: w(ee, Ce),
            current: oa(D) ?? 0,
            buildValue: (zr) => pa(ee, Ce, zr),
            refs: gt,
        ...
        if (y === "chapters" || y === "books" && z && Qe(z.book) > 1) {
          const ee = y === "chapters" ? I : z == null ? void 0 : z.book;
          return ee ? {
            max: Qe(ee),
            current: Vr(D) ?? 0,
            buildValue: (Ce) => Nr(ee, Ce),
            refs: It,
      ...
      y === "books" && bt(!0), Nt.takeFocus && ((Yo = Bt.current) == null || Yo.focus());
      const ce = gd({
        current: Nt.current,
        key: b.key,
        max: Nt.max,
      ...
      if (b.preventDefault(), b.stopPropagation(), ce === Nt.current) return;
      T(Nt.buildValue(ce));
      const Go = Nt.refs.current[ce];
      Go && Go.scrollIntoView({ block: "nearest", behavior: "smooth" });
    },
    [
      y,
      z,
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (Ut = xt.current) == null || Ut.focus();
      return;
    }
    const { isLetter: q, isDigit: at } = hn(b.key);
    (q || at) && (b.preventDefault(), X((Nt) => Nt + b.key), (Yt = xt.current) == null || Yt.focus(), J(!1));
  }, []);
  Xt(() => {
    const b = setTimeout(() => {
      if ($ && y === "books" && Gt.current && fe.current) {
        const q = Gt.current, at = fe.current, Ut = at.offsetTop, Yt = q.clientHeight, Nt = at.clientHeight, ce = Ut - Yt / 2 + Nt / 2;
        q.scrollTo({
          top: Math.max(0, ce),
          behavior: "smooth"
        }), T(fo(t.book));
    ...
    if (y === "chapters" && I) {
      ...
      T(Nr(I, q)), setTimeout(() => {
        if (Gt.current)
          if (b) {
            const at = It.current[t.chapterNum];
  ...
  }, [y, I, z, t.book, t.chapterNum]), Xt(() => {
    if (y === "verses" && Y && ot !== void 0) {
      const b = Y === t.book && ot === t.chapterNum, q = b ? t.verseNum : 1;
      T(
        pa(Y, ot, q)
      ), setTimeout(() => {
        if (Gt.current)
  ...
  const rt = z ? `${z.book} ${z.chapterNum ?? ""} ${z.verseNum ?? ""} ${dt}` : "", Vt = B(""), be = B(""), Ne = V(() => {
    if (y !== "books" || !z || Ct) return;
    const { book: b, chapterNum: q, verseNum: at } = z;
    if (dt && q && w)
      return {
        max: w(b, q),
        initial: at ?? (b === t.book && q === t.chapterNum ? t.verseNum : 1),
        parse: oa,
        buildValue: (Yt) => pa(b, q, Yt)
      };
    const Ut = Qe(b);
    if (!(Ut <= 1))
      return {
  ...
  return Xt(() => {
    if (y !== "books" || !z || !Ne || Ne.max <= 0) {
      Vt.current = "";
      return;
    }
    const { max: b, initial: q, parse: at, buildValue: Ut } = Ne, Yt = (Nt) => {
      const ce = at(Nt);
      return ce !== void 0 && ce >= 1 && ce <= b && Nt === Ut(ce) ? ce : void 0;
    };
    if (Vt.current !== rt) {
      Vt.current = rt;
      const Nt = Ut(Math.min(Math.max(q, 1), b));
      be.current = Nt, T(Nt);
      return;
    }
    if (Yt(D) !== void 0) {
    ...
    T(
      Yt(be.current) !== void 0 ? be.current : Ut(Math.min(Math.max(q, 1), b))
    );
  }, [y, z, Ne, rt, D]), /* @__PURE__ */ u(hr, { open: $, onOpenChange: ge, modal: k, children: [
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            ad,
            {
              primary: G,
              secondary: Q,
              showSecondary: j < jr.MINIMUM,
              isPartial: j >= jr.TIGHT,
              fullText: Z
            }
          ),
          f && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      gr,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: q } = b;
          $ && Se.current && q instanceof Node && Se.current.contains(q) && (_e.current = !0, ge(!1));
        },
        onCloseAutoFocus: E,
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onFocus: (b) => {
                    Et(b.target !== xt.current);
                  },
                  onBlur: (b) => {
                    b.currentTarget.contains(b.relatedTarget) || Et(!1);
                  },
                  children: [
                    /* @__PURE__ */ u("div", { className: "tw:relative tw:flex-1", children: [
                      ...
                      c && c.length > 0 && /* @__PURE__ */ a(
                        ...
                        {
                          recentSearches: c,
                          onSearchItemSelect: A,
                          renderItem: (b) => Fe(b, "English"),
                    ...
                    /* @__PURE__ */ a(Da, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: zt.map(
                      ({ onClick: b, disabled: q, title: at, icon: Ut, group: Yt }, Nt) => {
                        const ce = /* @__PURE__ */ a(
                          tt,
                          {
                            variant: "ghost",
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(pr, { children: [
                            Nt > 0 && Yt !== zt[Nt - 1].group && /* @__PURE__ */ a(Co, {}),
                            q ? (
                              ...
                              /* @__PURE__ */ a("span", { title: at, className: "tw:inline-flex", children: ce })
                            ) : /* @__PURE__ */ u(Dt, { children: [
                              /* @__PURE__ */ a(Ot, { asChild: !0, children: ce }),
                              /* @__PURE__ */ a(Mt, { children: at })
                            ] })
                          ] }, `${Yt}-${Nt}`)
                        );
                      }
                ...
                /* @__PURE__ */ u(Dt, { children: [
                  /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      variant: "ghost",
                      size: "sm",
                      onClick: y === "verses" ? he : Wt,
                      className: "tw:me-2 tw:h-6 tw:w-6 tw:p-0",
                      tabIndex: -1,
                      "aria-label": Zr,
                      children: N === "ltr" ? /* @__PURE__ */ a(Us, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ks, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                  /* @__PURE__ */ a(Mt, { children: Zr })
                ] }),
                y === "chapters" && I && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: je(I, s) }),
                y === "verses" && Y && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${je(Y, s)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? La : Be
                  }
                )
              ] }),
              !Ct && /* @__PURE__ */ u(mr, { ref: Gt, children: [
                y === "books" && /* @__PURE__ */ u(mt, { children: [
                  !z && Object.entries(se).map(([b, q]) => {
                    if (q.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(or, { heading: S(b), children: q.map((at) => /* @__PURE__ */ a(
                          Ei,
                          {
                            bookId: at,
                            onSelect: (Ut) => pe(Ut),
                            section: wa(at),
                            commandValue: fo(at),
                            suppressKeyboardHighlight: nt,
                            ref: at === t.book ? fe : void 0,
                            localizedBookNames: s,
                            disabled: Ft(at),
                            dimmedReason: kt.has(at) ? Ba : void 0,
                            dimmedDescription: kt.has(at) ? Qr(at) : void 0
                          },
                          at
                        )) }, b)
                      );
                  }),
                  z && ft && /* @__PURE__ */ a(or, { children: /* @__PURE__ */ u(
                    sr,
                    {
                      value: od,
                      onSelect: Jt,
                      ...
                      children: [
                        /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1", children: Fe(
                          ft,
                          je(z.book, s)
                        ) }),
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: Lr(z.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  z && dt && z.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  z && !dt && Qe(z.book) > 1 && // No heading here either, for the same reason as the verse preview above:
                  ...
                  /* @__PURE__ */ a(
                    mn,
                    {
                      ...
                      setChapterRef: H,
                      isChapterDimmed: F,
                      isChapterDisabled: Rt(z.book),
                      suppressKeyboardHighlight: nt,
                      className: "tw:px-4 tw:pb-4"
                    }
                  )
                ] }),
                y === "chapters" && I && /* @__PURE__ */ a(
                  mn,
                  {
                    bookId: I,
                    scrRef: t,
                    onChapterSelect: ve,
                    setChapterRef: H,
                    isChapterDisabled: Rt(I),
                    className: "tw:p-4"
                  }
                ),
                y === "verses" && Y && ot !== void 0 && w && /* @__PURE__ */ a(
                  vn,
                  {
                    bookId: Y,
                    chapterNum: ot,
              ...
              St && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                tt,
                {
                  variant: "ghost",
                  size: "sm",
...
function bn({
  ...
  const [C, P] = _(!1), K = d ?? l, N = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], j = ($, O) => {
    const D = l($), T = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, M = `${O ?? ""}${D}${T ?? ""}`;
    return /* @__PURE__ */ u(
      sr,
      {
        value: D,
        ...
        children: [
          ...
          /* @__PURE__ */ u("span", { className: "tw:flex-1 tw:overflow-hidden tw:text-ellipsis tw:whitespace-nowrap", children: [
            D,
            T && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
              " · ",
              T
            ] })
          ] })
  ...
  return /* @__PURE__ */ u(hr, { open: C, onOpenChange: P, ...k, children: [
    /* @__PURE__ */ a(Mr, { asChild: !0, children: /* @__PURE__ */ u(
      tt,
      {
        variant: m,
    ...
    /* @__PURE__ */ a(
      gr,
      {
        ...
        style: s,
        children: /* @__PURE__ */ u(fr, { children: [
          /* @__PURE__ */ a(
            Ra,
            {
              placeholder: h,
          ...
          /* @__PURE__ */ a(mr, { children: N(e) ? e.map(($) => /* @__PURE__ */ a(or, { heading: $.groupHeading, children: $.options.map((O) => j(O, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(or, { children: e.map(($) => j($)) }) })
        ] })
      }
    )
  ] });
...
var bo = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(bo || {});
((t) => {
...
function ph({
  ...
  const w = Wa(d, "%webView_bookSelector_currentBook%"), p = Wa(d, "%webView_bookSelector_choose%"), h = Wa(d, "%webView_bookSelector_chooseBooks%"), [g, m] = _(
    "current book"
    /* CurrentBook */
  ), f = (v) => {
    m(v), t(v);
    ...
    Eo,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(At, { className: "tw:flex tw:items-center", children: o.map((v) => Ht.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            tt,
            {
...
const Oi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yd = Oi ? Xt : W, ia = { tag: Po };
function kd({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: l } = t, d = xd(null, o), w = di({ editable: t.editable, html: l, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const m = Yr();
            g.append(m);
            const f = Oi ? document.activeElement : null;
            (we() !== null || f !== null && f === p.getRootElement()) && m.select();
          }
        }, ia);
...
const _d = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
...
const Rd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
function Dd(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Od() {
  return function(t) {
    const [e] = Ae(), r = V(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), s = B(o);
    return Rd(() => {
...
const Mi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Id = Mi && "documentMode" in document ? document.documentMode : null;
!(!Mi || !("InputEvent" in window) || Id) && "getTargetRanges" in new window.InputEvent("input");
function De(t) {
  return `${t}px`;
}
...
function Pd(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < g.length; E++) {
      const k = g[E], C = i[E] || document.createElement("div"), P = C.style;
      P.position !== "absolute" && (P.position = "absolute", v = !0);
      const K = De(k.left - p);
      P.left !== K && (P.left = K, v = !0);
      const N = De(k.top - h);
      P.top !== N && (C.style.top = N, v = !0);
      const j = De(k.width);
      P.width !== j && (C.style.width = j, v = !0);
      const $ = De(k.height);
      P.height !== $ && (C.style.height = $, v = !0), C.parentNode !== c && (c.append(C), v = !0), i[E] = C;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    if (!al(g)) return d();
    d(), o = h, n = g, s = new MutationObserver((m) => {
      const f = t.getRootElement(), v = f && f.parentElement;
      if (f !== o || v !== n) return p();
      for (const E of m) if (!c.contains(E.target)) return l();
    }), s.observe(g, zd), l();
  });
  return () => {
    w(), d();
...
function $d(t, e = Ad) {
  ...
  function d(w) {
    w.read(() => {
      const p = we();
      if (!Me(p)) return r = null, n = null, s = null, c = null, l(), void (l = () => {
      });
      const [h, g] = function($) {
        const O = $.getStartEndPoints();
        return $.isBackward() ? [O[1], O[0]] : O;
      }(p), m = h.getNode(), f = m.getKey(), v = h.offset, E = g.getNode(), k = E.getKey(), C = g.offset, P = t.getElementByKey(f), K = t.getElementByKey(k), N = r === null || P !== o || v !== n || f !== r.getKey(), j = s === null || K !== i || C !== c || k !== s.getKey();
      if ((N || j) && P !== null && K !== null) {
        const $ = function(O, D, T, M, X, y, et) {
          const I = (O._window ? O._window.document : document).createRange();
          return I.setStart(...xn(D, T, M)), I.setEnd(...xn(X, y, et)), I;
        }(t, h, m, P, g, E, K);
        l(), l = Pd(t, $, e);
      }
      r = m, o = P, n = v, s = E, i = K, c = C;
    });
  }
  return d(t.getEditorState()), Ke(t.registerUpdateListener(({ editorState: w }) => d(w)), () => {
    l();
  });
}
function Vd(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? r !== null && (r(), r = null) : r === null && (r = $d(t, e));
  };
...
function Ld(t) {
  const e = hi(t, (r) => Hr(r) && !r.isInline());
  return Hr(e) || _a(4, t.__key), e;
}
function Bd(t) {
  const e = we() || qc();
  let r;
  if (Me(e)) r = Gc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = pi(c, "next"));
    }
    r = r || Wc(ir(), "previous").getFlipped().insert(Yr());
  }
  const o = jd(t, r), n = Yc(o), s = Xc(n) ? Zc(n) : o;
  return Jc(Qc(s)), t.getLatest();
}
function jd(t, e, r) {
  let o = cn(e, "next");
  for (let n = o; n; n = tl(n, r)) o = n;
  return el(o) && _a(283), o.insert(t.isInline() ? Yr().append(t) : t), cn(pi(t.getLatest(), "next"), e.direction);
}
function Fd(t) {
  const e = we();
  if (!Me(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(i)) continue;
    const c = hi(s, (d) => Hr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function Aa() {
  ...
  for (!function() {
    ...
    for (Fr = void 0, Ca++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && Ii(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
let Na, Ue = 0, Ca = 0, Hd = 0, xo = 0, ga = 0;
function kn(t) {
  if (lt === void 0) return;
  let e = t.n;
...
function lr(t, e) {
  ae.call(this, void 0), this.x = t, this.s = void 0, this.g = ga - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function qd(t, e) {
  return new lr(t, e);
}
...
function jo(t) {
  ...
  t.x = void 0, t.s = void 0, Pi(t);
}
function Gd(t) {
  if (lt !== this) throw new Error("Out-of-order effect");
  zi(this), lt = t, this.f &= -2, 8 & this.f && jo(this), Aa();
}
function yr(t, e) {
...
ae.prototype.brand = Ud, ae.prototype.h = function() {
  return !0;
}, ae.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : yn(() => {
    var r;
  ...
  if (this.t !== void 0) {
    const e = t.e, r = t.x;
    e !== void 0 && (e.x = r, t.e = void 0), r !== void 0 && (r.e = e, t.x = void 0), t === this.t && (this.t = r, r === void 0 && yn(() => {
      var o;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ue !== 0 && Ca === 0 && e.l !== xo && (e.l = xo, Na = { S: e, v: e.v, i: e.i, o: Na });
    })(this), this.v = t, this.i++, ga++, Ue++;
    try {
...
} }), lr.prototype = new ae(), lr.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === ga)) return !0;
  if (this.g = ga, this.f |= 1, this.i > 0 && !Ii(this)) return this.f &= -2, !0;
  const t = lt;
  try {
    _n(this), lt = this;
    const e = this.x();
  ...
  return lt = t, zi(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Pi(this), _n(this), Ue++;
  const t = lt;
...
ke({ build: (t, e, r) => Ir(e), config: vr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
  return Ie(() => o.disabled.value ? void 0 : t.registerRootListener((n) => {
    t.focus(() => {
...
function Ai() {
  const t = ir(), e = we(), r = Yr();
  t.clear(), t.append(r), e !== null && r.select(), Me(e) && (e.format = 0);
}
function $i(t, e = Ai) {
  return t.registerCommand(gi, (r) => (t.update(e), !0), Ao);
}
ke({ build: (t, e, r) => Ir(e), config: vr({ $onClear: Ai }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Ie(() => $i(t, o.value));
} });
function Wd(t) {
...
class Vi extends wo {
  $config() {
    return this.config("decorator-text", { extends: wo, stateConfigs: [{ flat: !0, stateConfig: Xa }] });
  }
  getFormat() {
    return ml(this, Xa);
  }
  getFormatFlags(e, r) {
    return ln(this.getFormat(), e, r);
  }
  hasFormat(e) {
    const r = vl[e];
  ...
  toggleFormat(e) {
    const r = this.getFormat(), o = ln(r, e, null);
...
ke({ name: "@lexical/extension/DecoratorText", nodes: () => [Vi], register: (t, e, r) => t.registerCommand(fi, (o) => {
  const n = we();
  if (mi(n) || Me(n)) for (const s of n.getNodes()) Yd(s) && s.toggleFormat(o);
  return !1;
}, vi) });
function Li(t, e) {
  let r;
...
const yo = ke({ build: (t) => Li(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function Bi(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = Bi(r[n], o[n]);
    return t;
  }
  return e;
}
const Fo = 0, ko = 1, ji = 2, Za = 3, sa = 4, xr = 5, Ja = 6, Ar = 7;
function Qa(t) {
  return t.id === Fo;
}
function Fi(t) {
...
function Xd(t) {
  return function(e) {
    return e.id === ko;
  }(t) || pt(305, String(t.id), String(ko)), Object.assign(t, { id: ji });
}
...
class Jd {
  ...
  build(e) {
    ...
    this.state = function(s, i, c) {
      return Object.assign(s, { id: xr, output: i, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    ...
    return this.state = function(s) {
      return Object.assign(s, { id: Ja });
    }(o), () => {
      const s = this.state;
      s.id !== Ar && pt(309, String(o.id), String(Ar)), this.state = function(i) {
...
const tw = ke({ config: vr({ setOptions: Nn, updateOptions: Nn }), init: ({ $initialEditorState: t = Qd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: s } = n;
    if (ll(s)) t.setEditorState(s, r);
...
}, name: "@lexical/extension/InitialState", nodes: [il, ui, sl, cl, wi] }), Cn = Symbol.for("@lexical/extension/LexicalBuilder");
function En() {
}
function ew(t) {
  throw t;
...
class Cr {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(di({ ...o, ...r ? { onError: (s) => {
      r(s, n);
    } } : {} }), { [Cn]: this });
  ...
  buildEditor() {
    ...
    return e = Ke(this.registerEditor(o), () => o.setRootElement(null)), o;
  }
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Qa(s) || pt(300, i, n || "[unknown]"), Qa(c = s) || pt(304, String(c.id), String(Fo)), s = Object.assign(c, { id: ko }), o.state = s;
      const l = this.outgoingConfigEdges.get(i);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, i);
      }
      s = Xd(s), o.state = s, e.push(o);
    };
...
const rw = /* @__PURE__ */ new Set(), Tn = ke({ build(t, e, r) {
  const o = r.getDependency(yo).output, n = qr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Li(() => {
  }, () => Ie(() => {
  ...
  return { watchNodeKey: function(i) {
    const c = qd(() => (s.value || rw).has(i)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(i);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(i, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [yo], name: "@lexical/extension/NodeSelection" }), aw = dl("INSERT_HORIZONTAL_RULE_COMMAND");
class Er extends wo {
  static getType() {
...
ke({ dependencies: [yo, Tn], name: "@lexical/extension/HorizontalRule", nodes: () => [Er], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Tn).output, n = qr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Ke(t.registerCommand(aw, (i) => {
    const c = we();
    if (!Me(c)) return !1;
    ...
    return !0;
  }, Ao), t.registerCommand(wl, (i) => {
    if (ul(i.target)) {
      const c = pl(i.target);
      if (nw(c)) return function(l, d = !1) {
        const w = we(), p = l.isSelected(), h = l.getKey();
        let g;
        d && mi(w) ? g = w : (g = hl(), gl(g)), p ? g.delete(h) : g.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  }, vi), t.registerMutationListener(Er, (i, c) => {
    Kd(() => {
      let l = !1;
    ...
    const i = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) i.push(Ie(() => {
      const d = c.value;
      d && (l.value ? bi(d, s) : kl(d, s));
    }));
    return Ke(...i);
  }));
} });
ke({ build: (t, e) => Ir({ inheritEditableFromParent: e.inheritEditableFromParent }), config: vr({ $getParentEditor: function() {
  const t = fl();
  return Cr.fromEditor(t), t;
}, inheritEditableFromParent: !1 }), init: (t, e, r) => {
  const o = e.$getParentEditor();
  t.parentEditor = o, t.theme = t.theme || o._config.theme;
}, name: "@lexical/extension/NestedEditor", register: (t, e, r) => Ie(() => {
...
ke({ build: (t, e, r) => Ir(e), config: vr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ie(() => {
...
function iw(t, e, r = Ui) {
  return Ke(t.registerCommand(_l, (o) => {
    const n = we();
    if (!Me(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => Nl(h) && h.canIndent()).length > 0) return !0;
      const c = i.anchor, l = i.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Ld(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Cl();
      ...
      return !1;
    }(n) ? o.shiftKey ? Tl : dn : Sl;
    return t.dispatchCommand(s, void 0);
  }, Ao), t.registerCommand(dn, () => {
...
ke({ build: (t, e, r) => Ir(e), config: vr({ $canIndent: Ui, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: s } = r.getOutput();
  return Ie(() => {
    if (!o.value) return iw(t, n, s);
  });
} });
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (Me(m)) {
                const f = m.anchor;
                let v = f.getNode(), E = 0, k = 0;
                if (uo(v) && d >= 0 && w >= 0 && (E = d, k = d + w, m.setTextNodeRange(v, E, v, k)), E === k && p === "" || (m.insertRawText(p), v = f.getNode()), uo(v)) {
                  E = h, k = h + g;
                  const C = v.getTextContentSize();
                  E = E > C ? C : E, k = k > C ? C : k, m.setTextNodeRange(v, E, v, k);
                }
...
ke({ build: (t, e, r) => Ir(e), config: vr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ie(() => r.getOutput().disabled.value ? void 0 : Hi(t)) });
function ww(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Ko = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
...
function Sn(t) {
  return t.getEditorState().read(Ki(t.isComposing()));
}
function hw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Ae();
  return function(n) {
    Ko(() => Ke(zl(n), Hi(n)), [n]);
  }(o), u(mt, { children: [t, a(gw, { content: e }), a(pw, { editor: o, ErrorBoundary: r })] });
}
function gw({ content: t }) {
  const [e] = Ae(), r = function(n) {
    ...
    return Ko(() => {
      ...
      return c(), Ke(n.registerUpdateListener(() => {
        c();
...
const mw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
function vw({ onClear: t }) {
  const [e] = Ae();
  return mw(() => $i(e, t), [e, t]), null;
}
const qi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
function bw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: m, id: f, role: v = "textbox", spellCheck: E = !0, style: k, tabIndex: C, "data-testid": P, ...K }, N) {
  const [j, $] = _(t.isEditable()), O = L((T) => {
    T && T.ownerDocument && T.ownerDocument.defaultView ? t.setRootElement(T) : t.setRootElement(null);
  }, [t]), D = V(() => /* @__PURE__ */ function(...T) {
    return (M) => {
      for (const X of T) typeof X == "function" ? X(M) : X != null && (X.current = M);
    };
  }(N, O), [O, N]);
  return qi(() => ($(t.isEditable()), t.registerEditableListener((T) => {
    $(T);
  })), [t]), a("div", { "aria-activedescendant": j ? e : void 0, "aria-autocomplete": j ? r : "none", "aria-controls": j ? o : void 0, "aria-describedby": n, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": j && v === "combobox" ? !!i : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": j ? p : void 0, "aria-readonly": !j || void 0, "aria-required": h, autoCapitalize: g, className: m, contentEditable: j, "data-testid": P, id: f, ref: D, role: v, spellCheck: E, style: k, tabIndex: C, ...K });
}
const xw = si(bw);
function Rn(t) {
  return t.getEditorState().read(Ki(t.isComposing()));
...
function kw(t, e) {
  ...
  return u(mt, { children: [a(xw, { editor: n, ...o, ref: e }), r != null && a(_w, { editor: n, content: r })] });
}
function _w({ content: t, editor: e }) {
  const r = function(i) {
    ...
    return qi(() => {
      ...
      return d(), Ke(i.registerUpdateListener(() => {
        d();
...
function Ew() {
  const [t, e] = _(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(oo, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(no, { children: [
      /* @__PURE__ */ a(io, { children: /* @__PURE__ */ a(so, { children: s }) }),
      i
    ] }) });
  }, [t, r]), n = L(
    (s, i, c = !1) => {
...
function Tw({
  ...
  const [e] = Ae(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Ew(), l = () => {
  };
...
function Rw() {
  const { activeEditor: t } = Wi(), [e, r] = _([]), o = L((n) => {
    if (Me(n) || $l(n)) {
      const s = [];
      Dn.forEach(({ format: i }) => {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ a(
          kd,
          {
            ...
            children: /* @__PURE__ */ u($t, { children: [
...
function Iw(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), s = Ll(e, n);
      ir().clear(), Ol(s);
    },
    {
      discrete: !0
...
function Ji({
  ...
  return /* @__PURE__ */ u(Da, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        tt,
        {
          "aria-label": i,
      ...
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: i }) })
    ] }) }),
    /* @__PURE__ */ a(Co, {}),
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: c }) })
    ] }) })
  ] });
}
...
function gh({
  ...
  const [s, i] = _(Pw), [c, l] = _(n), [d, w] = _(!1), p = B(void 0), h = B(null);
  W(() => {
    let v = !0;
    const E = h.current;
    if (!E) return;
  ...
  const g = L(() => {
    ...
    const v = Ta(s);
    e(v, c);
  }, [s, e, c]), m = o["%commentEditor_placeholder%"] ?? "Type your comment here...", f = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(hr, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(Mr, { asChild: !0, children: /* @__PURE__ */ u(
        tt,
        {
          variant: "outline",
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ a(Jn, { className: "tw:h-4 tw:w-4" }),
      ...
      /* @__PURE__ */ a(
        gr,
        {
          ...
          children: /* @__PURE__ */ a(fr, { children: /* @__PURE__ */ a(mr, { children: t.map((v) => /* @__PURE__ */ a(
            sr,
            {
              onSelect: () => {
                l(v || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : qo(v) && (v.preventDefault(), v.stopPropagation(), ye(s) && g());
        },
        onKeyDown: (v) => {
          Ho(v), (v.key === "Enter" || v.key === " ") && v.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Ea,
          {
...
function Mn({
  ...
  const g = L(
    (N) => {
      N && N.stopPropagation(), d(!1), p(void 0), i == null || i(!1);
    },
    [i]
  ), m = L(
    async (N) => {
    ...
    [t.user]
  ), k = V(() => zo(t.contents), [t.contents]), C = V(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), P = !!t.conflictResolutionAction && !C, K = V(() => {
    if (o && c)
      return /* @__PURE__ */ u(mt, { children: [
        /* @__PURE__ */ u(
          tr,
          {
            onClick: (N) => {
              N.stopPropagation(), d(!0), p(Iw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Lw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Bw, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), g()) : qo(N) && (N.preventDefault(), N.stopPropagation(), ye(w) && m());
              },
              onKeyDown: (N) => {
                Ho(N), (N.key === "Enter" || N.key === " ") && N.stopPropagation();
              },
              onClick: (N) => {
                N.stopPropagation();
              },
          ...
          !l && /* @__PURE__ */ u(mt, { children: [
            t.status === "Resolved" && !P && /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: r["%comment_status_resolved%"] }),
            ...
            P ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: es(t.conflictResolutionAction) === "merged" ? r["%conflict_note_outcome_combined%"] ?? "Combined both changes." : r["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: x(
        ...
        K && /* @__PURE__ */ u(He, { children: [
          /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ys, {}) }) }),
          /* @__PURE__ */ a(qe, { align: "end", children: K })
        ] })
      ]
    }
  );
...
function as({
  ...
  rootContentSlot: O,
  resolveActionSlot: D,
  spaceRootContentFromReplies: T = !1
}) {
  const [M, X] = _(In), [y, et] = _(), [I, R] = _(), Y = o, [st, ot] = _(!1), [ut, Ct] = _(!1), [J, ct] = _(!1), [ht, nt] = _(!1), [Et, ne] = _(!1), [bt, Se] = _(P), [_e, Bt] = _(!1), xt = B(void 0), [Gt, fe] = _(/* @__PURE__ */ new Map());
  W(() => {
    let A = !0;
    return (async () => {
    ...
    let A = !0;
    if (!o) {
      nt(!1), fe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const _t = E ? await E(l) : !1;
      A && nt(_t);
    })(), () => {
      A = !1;
    };
  ...
  W(() => {
    if (!o) {
      It.current !== "idle" && (et(void 0), R(void 0), It.current = "idle");
      return;
    }
    It.current === "idle" && (It.current = "pending"), ht ? It.current === "pending" && j !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    j !== s && (et(j), It.current = "auto-populated") : It.current === "auto-populated" && (et(void 0), It.current = "pending");
  }, [o, j, ht, s]);
  const gt = V(
    () => $ ?? e.filter((A) => !A.deleted),
    [$, e]
  );
  W(() => {
    let A = !0;
  ...
  const vt = V(() => gt[0], [gt]), ue = B(null), jt = B(void 0), ie = L(() => {
    var A;
    (A = jt.current) == null || A.call(jt), X(In);
  }, []), Zt = L(() => {
    const A = !bt;
    Se(A), Bt(!A), m == null || m(l, A);
  }, [bt, m, l]);
  W(() => {
    ot(!1);
  }, [o]), W(() => {
    if (o && !bt && !_e) {
      ...
      return xt.current = A, () => clearTimeout(A);
    }
  ...
  const yt = V(
    ...
    const A = fa(s, r);
    return rr(r["%comment_assigned_to%"], {
      assignedUser: A
    });
  }, [s, r]), kt = V(() => gt.slice(1), [gt]), Tt = V(() => kt.length ?? 0, [kt.length]), se = V(() => Tt > 0, [Tt]), z = V(() => st || Tt <= 2 ? kt : kt.slice(-2), [kt, Tt, st]), ft = V(() => st || Tt <= 2 ? 0 : Tt - 2, [Tt, st]), me = V(
    () => Tt === 1 ? yt.singleReply : rr(yt.multipleReplies, { count: Tt }),
    [Tt, yt]
  ), Jt = V(
    () => ft === 1 ? yt.singleReply : rr(yt.multipleReplies, { count: ft }),
    [ft, yt]
  );
  W(() => {
    !o && ut && se && Ct(!1);
  ...
  const Qt = L(
    async (A) => {
      ...
      zt && await p({ threadId: l, contents: zt }) && ie();
    },
    [
      ie,
      M,
    ...
    async (A) => {
      const zt = ye(M) ? Ta(M) : void 0, _t = A.status ? A.assignedUser : y ?? A.assignedUser, Wt = await p({
        ...A,
        contents: zt,
        assignedUser: _t
      });
      return Wt && (_t !== void 0 && R(_t), zt && ie()), Wt;
    },
    [ie, M, p, y]
  );
  ...
  const ve = /* @__PURE__ */ a(
    Mn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Ct,
      canEditOrDelete: (!ut && Gt.get(vt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Vw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            $e && /* @__PURE__ */ a(Ur, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: $e }),
            /* @__PURE__ */ a(
              tt,
              {
                variant: "ghost",
        ...
        /* @__PURE__ */ u(mt, { children: [
          se && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          !o && ye(M) && /* @__PURE__ */ a(
            Ea,
            {
              ...
              onSerializedChange: (A) => X(A),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(mt, { children: [
            T && z.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ft > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (A) => {
                  A.stopPropagation(), ot(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (A) => {
                  (A.key === "Enter" || A.key === " ") && (A.preventDefault(), A.stopPropagation(), ot(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Kr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Jt }),
                    st ? /* @__PURE__ */ a(Zn, {}) : /* @__PURE__ */ a(ur, {})
                  ] })
                ]
              }
            ),
            z.map((A) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Mn,
              {
                comment: A,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Ct,
                canEditOrDelete: (!ut && Gt.get(A.id)) ?? !1
              }
            ) }, A.id)),
            v !== !1 && (!ut || ye(M)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (A) => {
                  qo(A) && (A.preventDefault(), A.stopPropagation(), (ye(M) || y !== void 0 && y !== I) && Qt());
                },
                onKeyDown: (A) => {
                  Ho(A), (A.key === "Enter" || A.key === " ") && A.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Ea,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    y !== void 0 && (ye(M) || y !== I) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: rr(
                    ...
                    /* @__PURE__ */ u(hr, { open: J, onOpenChange: ct, children: [
                      /* @__PURE__ */ a(Mr, { asChild: !0, children: /* @__PURE__ */ a(
                        tt,
                        {
                          ...
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !ht || !f || f.length === 0 || !f.includes(i),
                      ...
                      /* @__PURE__ */ a(
                        gr,
                        {
                          ...
                          align: "end",
                          onKeyDown: (A) => {
                            A.key === "Escape" && (A.stopPropagation(), ct(!1));
                          },
                          children: /* @__PURE__ */ a(fr, { children: /* @__PURE__ */ a(mr, { children: f == null ? void 0 : f.map((A) => /* @__PURE__ */ a(
                            sr,
                            {
                              onSelect: () => {
                                et(A !== s ? A : void 0), It.current = "user-selected", R(void 0), ct(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: fa(A, r) })
                            },
                            A || "unassigned"
                          )) }) })
                        }
...
), Fw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ma = (t) => Fw(zo(t));
function va({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Uw({
  ...
  const [i, c] = _("accept"), l = lo(), d = lo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", m = p ? "accept" : i, f = V(
    () => ma(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = V(
    () => ma(t.acceptedText ?? ""),
    ...
    () => ma(t.mergedText ?? ""),
    [t.mergedText]
  ), k = V(() => zo(t.contents), [t.contents]);
  if (!ts(t))
    return /* @__PURE__ */ a(va, { html: k });
  const C = (I) => {
    c(I === "reject" || I === "merge" ? I : "accept");
  }, P = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", K = g ? [
    {
      value: "merge",
  ...
  let O;
  j ? O = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : s || (O = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const D = e["%conflict_note_no_result%"] ?? "No result preview available.", T = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: D }), M = (I) => I ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: I }) : T, X = () => {
    const I = o ?? "accept";
    return I === "merged" ? t.mergedText ? /* @__PURE__ */ a(va, { html: E }) : T : M(I === "reject" ? t.rejectedResultText : t.resultText);
  }, y = (I) => p && I.value === "reject", et = (I) => {
    const R = m === I.value, Y = `${d}-${I.value}`, st = y(I);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: l, className: "tw:sr-only", children: P }),
            /* @__PURE__ */ a(va, { html: I.html })
          ]
        },
        I.value
      )
      ...
      !w && !h && /* @__PURE__ */ u(mt, { children: [
        ...
        /* @__PURE__ */ a(
          Eo,
          {
            ...
            children: N.map((I) => y(I) ? /* @__PURE__ */ a($t, { delayDuration: 0, children: /* @__PURE__ */ u(Dt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: et(I) }),
              /* @__PURE__ */ a(Mt, { children: P })
            ] }) }, I.value) : et(I))
          }
        ),
        /* @__PURE__ */ a($t, { delayDuration: 0, children: /* @__PURE__ */ u(Dt, { children: [
    ...
    if (e === "Resolved") {
      for (let k = o.length - 1; k >= 0; k -= 1)
        if (o[k].status === "Resolved")
          return es(o[k].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
  return { conflictOptions: s, isResolving: c, resolve: m, resolvedResolution: v, showResolveCheck: s !== "loading" && s !== "none" };
}
function Ww(t) {
  const {
    comments: e,
...
function Nh({
  ...
  const [k, C] = _(/* @__PURE__ */ new Set()), [P, K] = _(), [N, j] = _(), $ = L(
    async (R) => {
      const Y = await s(R);
      return Y !== void 0 && R.assignedUser !== void 0 && R.assignedUser !== "" && j(R.assignedUser), Y;
    },
    [s]
  );
  W(() => {
    m && (C((R) => new Set(R).add(m)), K(m));
  }, [m]);
  const O = r.filter(
    (R) => R.comments.some((Y) => !Y.deleted)
  ), D = O.map((R) => ({ id: R.id })), T = L(
    (R) => {
      C((Y) => new Set(Y).add(R.id)), K(R.id), f == null || f(R.id);
    },
    [f]
  ), M = L(
    (R) => {
      ...
      C((st) => {
        const ot = new Set(st);
        return ot.has(R) ? ot.delete(R) : ot.add(R), ot;
      }), K(R), f == null || f(Y ? void 0 : R);
    },
    [k, f]
  ), { listboxRef: X, activeId: y, handleKeyDown: et } = Ns({
    options: D,
    onOptionSelect: T
  }), I = L(
    (R) => {
      R.key === "Escape" ? (P && k.has(P) && (C((Y) => {
        const st = new Set(Y);
        return st.delete(P), st;
      }), K(void 0), f == null || f(void 0)), R.preventDefault(), R.stopPropagation()) : et(R);
    },
    [P, k, et, f]
  );
  return /* @__PURE__ */ a(
      ...
      children: O.map((R) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: R.type === "Conflict" ? /* @__PURE__ */ a(Ww, { ...Y, conflictResolution: E }) : /* @__PURE__ */ a(as, { ...Y })
          },
          R.id
        );
      })
...
function Yw({ table: t }) {
  return /* @__PURE__ */ u(He, { children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(tt, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function Rr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    oe.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(oe.Icon, { asChild: !0, children: /* @__PURE__ */ a(ci, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Ee({
  ...
  return /* @__PURE__ */ u(
    oe.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(oe.ItemIndicator, { children: /* @__PURE__ */ a(za, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        Tr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(Dr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(Ee, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function tu({
  ...
  var N;
  const [w, p] = _([]), [h, g] = _([]), [m, f] = _({}), [v, E] = _({}), k = V(() => e ?? [], [e]), C = ki({
    data: k,
    columns: t,
    getCoreRowModel: Ni(),
  ...
  }), P = C.getVisibleFlatColumns();
  let K;
  return l ? K = Array.from({ length: 10 }).map((O, D) => `skeleton-row-${D}`).map((O) => /* @__PURE__ */ a(er, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(_r, { colSpan: P.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(kr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, O)) : ((N = C.getRowModel().rows) == null ? void 0 : N.length) > 0 ? K = C.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    er,
    {
      onClick: () => i(j, C),
      "data-state": j.getIsSelected() && "selected",
      children: j.getVisibleCells().map(($) => /* @__PURE__ */ a(_r, { children: Br($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    j.id
  )) : K = /* @__PURE__ */ a(er, { children: /* @__PURE__ */ a(_r, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Yw, { table: C }),
    /* @__PURE__ */ u(So, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Ro, { stickyHeader: s, children: C.getHeaderGroups().map((j) => /* @__PURE__ */ a(er, { children: j.headers.map(($) => /* @__PURE__ */ a(ya, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : Br($.column.columnDef.header, $.getContext()) }, $.id)) }, j.id)) }),
      /* @__PURE__ */ a(Do, { children: K })
    ] }),
...
function Th({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(Kl, { options: s, children: e })
    }
  );
}
...
function ru({
  ...
  const n = zn(r, "%webView_error_dump_header%"), s = zn(r, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(tt, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ a(ti, {}) })
        ] }),
...
function Rh({
  ...
  return /* @__PURE__ */ u(hr, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(Mr, { asChild: !0, children: o }),
    /* @__PURE__ */ u(gr, { id: s, className: x("tw:min-w-80 tw:max-w-96", n), children: [
...
function Dh({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(He, { children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(tt, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(qe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Hn, { children: d.itemType === 0 ? /* @__PURE__ */ a(mt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ar,
        {
          checked: o[w][h],
      ...
      return /* @__PURE__ */ u(Ur, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          tt,
          {
            ...
            children: /* @__PURE__ */ a(Io, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function du({
  ...
  const l = To(), d = Pn(n, "%undoButton_tooltip%"), w = Pn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Da, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        tt,
      ...
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u("p", { children: [
        d,
    ...
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(Co, {}),
    e && /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        tt,
        {
          "aria-label": w,
...
function wu({
  ...
  return W(() => {
    var l;
    const s = To(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, m;
...
const uu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(mt, { children: [
...
function pu({
  ...
  const n = B(null), s = B(null), i = B(!1), [c, l] = _(t), [d, w] = _(e), [p, h] = _(!1), g = B(!1), m = B(c);
  m.current = c;
  const f = B(d);
  f.current = d, W(() => {
    l(t);
  ...
  const v = (k) => {
    if (i.current = !1, h(k), !k) {
      const C = m.current, P = f.current;
      C !== "custom" || P ? (C !== t || P !== e) && r(C, P) : (l(t), w(e));
    }
  }, E = (k) => {
    var C, P, K, N;
    k.stopPropagation(), document.activeElement === s.current && k.key === "ArrowDown" || k.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), i.current = !0) : document.activeElement === n.current && k.key === "ArrowUp" ? ((P = s.current) == null || P.focus(), i.current = !1) : document.activeElement === n.current && k.key === "ArrowLeft" && ((K = n.current) == null ? void 0 : K.selectionStart) === 0 && ((N = s.current) == null || N.focus(), i.current = !1), c === "custom" && k.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && v(!1);
  };
  return /* @__PURE__ */ u(He, { open: p, onOpenChange: v, children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: uu(t, o, e) }) }) }),
      /* @__PURE__ */ a(Mt, { children: o["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      qe,
      {
...
const hu = (t, e) => t === "f" ? /* @__PURE__ */ u(mt, { children: [
  /* @__PURE__ */ a(ri, {}),
  " ",
...
function fu({
  ...
  return /* @__PURE__ */ u(He, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: hu(t, r) }) }) }),
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: gu(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(qe, { style: { zIndex: qn }, children: [
  ...
  return /* @__PURE__ */ u(
    sr,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Rs, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function xu({
  ...
  return /* @__PURE__ */ u(fr, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      Ra,
      {
    ...
    /* @__PURE__ */ u(mr, { children: [
      ...
      /* @__PURE__ */ a(or, { children: i.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          An,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(mt, { children: [
        ...
        /* @__PURE__ */ a(or, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            An,
            {
...
function zh({
  ...
  var Ze;
  const f = B(null), v = B(null), E = B(null), k = B(null), C = B(s);
  W(() => {
    C.current = s;
  }, [s]);
  const P = B(h);
  ...
  const K = L(() => {
    var F, Z;
    const S = P.current;
    S !== void 0 && S !== "end" ? (F = f.current) == null || F.selectNoteTextOffset(0, S.utf16Offset) : (Z = f.current) == null || Z.selectNote(0);
  }, []);
  Xt(() => {
    if (w || !k.current) return;
    const { width: S } = k.current.getBoundingClientRect();
    S > 0 && (k.current.style.width = `${S}px`);
  }, [w]);
  const [N, j] = _("generated"), [$, O] = _("generated"), [D, T] = _("*"), [M, X] = _("*"), [y, et] = _("f"), [I, R] = _(!1), [Y, st] = _(!0), [ot, ut] = _(!1), Ct = B(!1), J = B(""), ct = B(!1), ht = B(void 0), [nt, Et] = _(!1), [ne, bt] = _(), [Se, _e] = _(), [Bt, xt] = _(), [Gt, fe] = _(), It = B(null), gt = B(
    void 0
  ), vt = B(0), ue = B(void 0), jt = V(
    () => ({
      ...i,
  ...
  W(() => {
    var S;
    nt || (S = f.current) == null || S.focus();
  }, [y, nt]);
  const Zt = L(() => {
    var G, Q, H;
    const S = (G = v.current) == null ? void 0 : G.querySelector(".editor-input"), F = S == null ? void 0 : S.querySelector("span.note"), Z = (H = (Q = v.current) == null ? void 0 : Q.ownerDocument.getSelection()) == null ? void 0 : H.anchorNode;
    return !!F && !!Z && F.contains(Z);
  }, []), yt = L(
    (S = !1) => {
      var Z, G, Q;
      m == null || m();
      const F = (G = (Z = f.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : G.at(0);
      if (F && Pr("note", F) && (r == null || r([F]), S && d && C.current)) {
        if (w && ni(F, ht.current)) return;
        ht.current = F, (Q = d.current) == null || Q.replaceEmbedUpdate(C.current, [F]);
      }
    },
    [w, r, m, d]
  ), $e = L(
    (S, F) => {
      var Q, H, it;
      const Z = (H = (Q = f.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (!Z || !Pr("note", Z) || !Z.insert.note) return;
      let G;
      S === "custom" ? G = F : S === "generated" ? G = po : G = ho, Z.insert.note.caller !== G && (Z.insert.note.caller = G, (it = f.current) == null || it.applyUpdate([Z, { delete: 1 }]));
    },
    []
  ), kt = B(void 0), Tt = B(yt);
  W(() => {
  ...
  const se = L(() => {
    ...
    kt.current !== void 0 && (se(), Tt.current(!0));
  }, [se]), ft = L(() => {
    se(), kt.current = setTimeout(() => {
      kt.current = void 0, Tt.current(!0);
    }, Cu);
  }, [se]);
  W(() => {
    var Q, H;
    let S, F, Z;
    Ct.current = !1, ct.current = !1, ue.current = void 0, st(!0);
    const G = e == null ? void 0 : e.at(0);
    if (ht.current = G, G && Pr("note", G)) {
      const it = (Q = G.insert.note) == null ? void 0 : Q.caller;
      let wt = "custom";
      it === po ? wt = "generated" : it === ho ? wt = "hidden" : it && (T(it), X(it)), j(wt), O(wt), et(((H = G.insert.note) == null ? void 0 : H.style) ?? "f"), S = setTimeout(() => {
        var St, Ft, Rt, te;
        const dt = (Ft = (St = f.current) == null ? void 0 : St.getNoteOps(0)) == null ? void 0 : Ft.at(0);
        (Rt = f.current) == null || Rt.applyUpdate(dt ? [G, { delete: 1 }] : [G]), K(), (te = f.current) == null || te.focus(), F = requestAnimationFrame(() => {
          Z = setTimeout(() => {
            var Be;
            Zt() || (K(), (Be = f.current) == null || Be.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      z(), P.current = void 0, S && clearTimeout(S), F !== void 0 && cancelAnimationFrame(F), Z !== void 0 && clearTimeout(Z);
    };
  }, [e, z, Zt, K]), Xt(() => () => z(), [z]);
  const me = L(() => {
    var S;
    ct.current && (gt.current || (S = f.current) == null || S.commitPendingMarkerEdits(), z());
  }, [z]);
  ii(p, () => ({ flushPendingEdits: me }), [me]);
  const Jt = L(() => {
    var S, F;
    if (!gt.current) {
      const Z = (S = v.current) == null ? void 0 : S.querySelector(".editor-input");
      Z != null && Z.contains(Z.ownerDocument.activeElement) && Z.blur(), (F = f.current) == null || F.commitPendingMarkerEdits();
    }
    w ? z() : (se(), yt(!0)), o();
  }, [se, z, w, o, yt]), Qt = B(Jt);
  Xt(() => {
  ...
  const pe = B({ book: n.book, chapterNum: n.chapterNum });
  Xt(() => {
    (pe.current.book !== n.book || pe.current.chapterNum !== n.chapterNum) && (pe.current = { book: n.book, chapterNum: n.chapterNum }, Qt.current());
  }, [n.book, n.chapterNum]);
  const ve = () => {
    var F;
    const S = (F = v.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    S != null && S.textContent && navigator.clipboard.writeText(S.textContent);
  }, A = L(
    (S, F) => {
      m == null || m(), j(S), T(F), $e(S, F), w && z();
    },
    [$e, z, w, m]
  ), zt = (S) => {
    var Z, G, Q, H, it;
    ...
    if (F && Pr("note", F)) {
      ...
      const wt = (H = (Q = F.insert.note) == null ? void 0 : Q.contents) == null ? void 0 : H.ops;
      y !== "x" && S === "x" ? wt == null || wt.forEach((dt) => _u(dt)) : y === "x" && S !== "x" && (wt == null || wt.forEach((dt) => Nu(dt))), (it = f.current) == null || it.applyUpdate([F, { delete: 1 }]);
    }
  }, _t = (S) => {
    fe(S.contextMarker), ut(S.canRedo);
  }, Wt = L(
    (S) => {
      var Z, G, Q, H, it;
      const F = (G = (Z = f.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : G.at(0);
      if (F && Pr("note", F)) {
        S.content.length > 1 && setTimeout(() => {
          var St;
          (St = f.current) == null || St.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const wt = (Q = F.insert.note) == null ? void 0 : Q.style, dt = (it = (H = F.insert.note) == null ? void 0 : H.contents) == null ? void 0 : it.ops;
        if (wt || R(!1), R(
          wt === "x" ? !!(dt != null && dt.every((St) => {
            var Rt, te;
            if (!((Rt = St.attributes) != null && Rt.char)) return !0;
            const Ft = ((te = St.attributes) == null ? void 0 : te.char).style;
          ...
          Ct.current = !0, J.current = JSON.stringify(F), st(!0);
          return;
        }
        ct.current = !0, st(JSON.stringify(F) === J.current), yt(), w && ft();
      } else
        R(!1), st(!0);
    },
    [w, yt, ft]
    ...
    if (E.current && ie.length && S && S.rangeCount > 0) {
      const F = S.getRangeAt(0).getBoundingClientRect(), Z = E.current.getBoundingClientRect();
      bt(F.left - Z.left), _e(F.top - Z.top), xt(F.height), Et(!0);
    }
  }, [ie, E]), ge = B(() => {
  }), Ve = L(
    (S, F, Z) => {
      const { anchorRect: G } = S;
      if (!g || !G) return;
      const { passive: Q } = Z;
      Ds({
        items: F,
        ...
        clearSessionIfCurrent: (H) => Jo(gt, H),
        ...
        restoreSelectionIfLost: () => {
          var H, it, wt;
          if (!((H = f.current) != null && H.getSelection())) {
            const dt = ue.current;
            dt ? (it = f.current) == null || it.setSelection(dt) : (wt = f.current) == null || wt.selectNote(0);
          }
        },
        focusEditor: () => {
          var H;
          return (H = f.current) == null ? void 0 : H.focus();
        },
        applyItem: (H) => {
          var it;
          return (it = f.current) == null ? void 0 : it.applyMarkerMenuSelection(H, {
            trigger: "backslash",
        ...
        onShowError: (H) => {
          (!Sc(H) || H.code !== Rc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Dc(H)}`
          );
        }
      });
    },
    ...
    var Z;
    const S = (Z = f.current) == null ? void 0 : Z.getMarkerMenuContext();
    if (!S) return !1;
    const F = ql(jt.styleInfo ?? Gl, S);
    return F.length === 0 ? !1 : (Ve(S, F, { passive: !S.hasTextSelection }), !0);
  }, [Ve, jt.styleInfo]), We = L(
    (S) => {
      const F = gt.current;
      if (!F || !g) return;
      Os(S, F, {
        ...
        commitTyped: (G) => {
          var Q;
          return (Q = f.current) == null ? void 0 : Q.commitTypedMarker(G);
        },
        commitTypedAndReopen: (G) => {
          var Q;
          (Q = f.current) == null || Q.commitTypedMarker(G, { trailingSpace: !1 }), Le();
        },
        commitTypedCloser: (G) => {
          var Q;
          return (Q = f.current) == null ? void 0 : Q.commitTypedCloser(G);
        },
        commitItem: (G) => {
          var H;
          const Q = F.items.find((it) => it.marker === G);
          Q && ((H = f.current) == null || H.applyMarkerMenuSelection(Q, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  W(() => {
    ...
    const S = (F) => {
      var Q, H;
      const Z = (Q = v.current) == null ? void 0 : Q.querySelector(".editor-input");
      if (!Z || F.target !== Z) return;
      const G = (H = f.current) == null ? void 0 : H.getSelection();
      G && (ue.current = G);
    };
    ...
    if (((Z = jt.view) == null ? void 0 : Z.markerMode) === "editable") {
      const G = (H) => {
        var dt, St, Ft, Rt;
        if (Is(H)) return;
        const it = S();
        ...
        if (w && H.key === "Escape") {
          H.preventDefault(), H.stopPropagation(), Qt.current();
          return;
        }
        if (H.key === "Enter" && !Zt()) {
          H.preventDefault(), H.stopPropagation(), (dt = f.current) == null || dt.selectNote(0), (St = f.current) == null || St.focus();
          return;
        }
        if (g && H.key === c) {
          if (!Zt()) {
            H.preventDefault(), H.stopPropagation(), (Ft = f.current) == null || Ft.selectNote(0), (Rt = f.current) == null || Rt.focus();
            return;
          }
          Le() && (H.preventDefault(), H.stopPropagation());
        }
      }, Q = () => {
        var it, wt;
        const H = S();
        !H || document.activeElement !== H || Zt() || ((it = f.current) == null || it.selectNote(0), (wt = f.current) == null || wt.focus());
      };
      return document.addEventListener("keydown", G, { capture: !0 }), document.addEventListener("paste", Q, { capture: !0 }), () => {
        document.removeEventListener("keydown", G, { capture: !0 }), document.removeEventListener("paste", Q, { capture: !0 });
      };
    }
    const F = (G) => {
      const Q = S();
      !nt && Q && document.activeElement === Q && G.key === c ? (G.preventDefault(), he()) : nt && G.key === "Escape" ? (G.preventDefault(), Et(!1)) : w && G.key === "Escape" && Q && document.activeElement === Q && (G.preventDefault(), Qt.current());
    };
    ...
    he,
    c,
    (Ze = jt.view) == null ? void 0 : Ze.markerMode,
    jt.styleInfo,
    g,
    Le,
    Zt
    ...
    const S = () => {
      var G, Q, H;
      const F = ((G = v.current) == null ? void 0 : G.querySelector(".editor-input")) ?? void 0;
      if (!F || document.activeElement !== F) return;
      const Z = document.getSelection();
      Z && !Z.isCollapsed || Zt() || ((Q = f.current) == null || Q.selectNote(0), (H = f.current) == null || H.focus());
    };
  ...
  const Ye = l["%footnoteEditor_copyButton_tooltip%"], Xe = /* @__PURE__ */ a(
    du,
    {
      onUndoClick: () => {
        var S;
        return (S = f.current) == null ? void 0 : S.undo();
      },
      onRedoClick: () => {
        var S;
        return (S = f.current) == null ? void 0 : S.redo();
      },
      canUndo: !Y,
      canRedo: ot,
      localizedStrings: l
  ...
  return /* @__PURE__ */ u(mt, { children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ u("div", { className: "tw:flex", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:gap-4", children: [
              /* @__PURE__ */ a(
                fu,
                {
                  isTypeSwitchable: I,
          ...
          /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:end-0", children: /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
                  /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      "aria-label": Ye,
                  ...
                  /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: Ye }) })
                ] }) }) })
              ]
            }
          )
    ...
    /* @__PURE__ */ u(hr, { open: nt, children: [
      /* @__PURE__ */ a(
        Ms,
        {
          className: "tw:absolute",
...
function Ru(t, e, r = !0, o = void 0, n = void 0) {
  ...
  const c = s.length > 0;
  return c || s.push([]), s.map((l, d) => {
    const w = d === 0, p = d === s.length - 1;
    return (
      ...
      /* @__PURE__ */ u("p", { className: "notetext", children: [
        w && !c && /* @__PURE__ */ a("span", { className: "note-placeholder", children: Tu }),
        w && n,
        ns(t, l, r),
        p && o
      ] }, `${t ?? "note"}-p${d}`)
...
function ns(t, e, r = !0, o = !1) {
  if (!(!e || e.length === 0))
    return e.map((n, s) => {
      const i = `${t ?? "note"}-${s}`;
      return typeof n == "string" ? /* @__PURE__ */ a("span", { className: x(`usfm_${t}`), children: n }, i) : Du(n, i, r, o);
    });
}
function Du(t, e, r, o = !1) {
  const { marker: n } = t, s = `${o ? "+" : ""}${n}`;
  return /* @__PURE__ */ u("span", { children: [
    n ? r && /* @__PURE__ */ a("span", { className: "marker", children: `\\${s}${os}` }) : /* @__PURE__ */ a(
      dc,
      {
    ...
    n && r && Su(t) && /* @__PURE__ */ a("span", { className: "marker", children: `\\${s}*` })
  ] }, e);
}
function Ou({
  footnote: t,
  ...
  const n = r ? r(t.caller) : t.caller, s = n !== t.caller, i = o ? /* @__PURE__ */ a("span", { className: "marker", children: `\\${t.marker}` }) : void 0, c = o ? /* @__PURE__ */ a("span", { className: "marker", children: `\\${t.marker}*` }) : void 0, l = t.category ? (
    ...
    /* @__PURE__ */ u("span", { className: "note-category", children: [
      o && /* @__PURE__ */ a("span", { className: "marker", children: `\\cat${os}` }),
      t.category,
  ...
  /* @__PURE__ */ a("span", { className: x("note-caller tw:inline-block", { formatted: s }), children: n }), w = e === "horizontal" ? "horizontal" : "vertical", p = o ? "marker-visible" : "", h = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", g = x(w, p);
  return /* @__PURE__ */ u(mt, { children: [
...
function Ah({
  ...
  editingFootnoteIndex: g,
  renderEditingFootnote: m
}) {
  const f = w ?? Oc(o, void 0), v = m ? g : void 0, E = B([]), k = (T, M, X) => {
    if (h) {
      const y = E.current[M], et = y ? cu(X.clientX, X.clientY, y) : "end";
      h(T, M, s, et);
      return;
    }
    p == null || p(T, M, s);
  }, C = i ? o.findIndex((T) => T === i) : -1, [P, K] = _(C), N = (T) => {
    var M;
    K(T), T >= 0 && T < E.current.length && ((M = E.current[T]) == null || M.focus());
  }, j = (T, M, X) => {
    if (o.length)
      switch (T.key) {
        case "Enter":
          T.preventDefault(), h ? h(M, X, s, "end") : p == null || p(M, X, s);
          break;
        case " ":
          T.preventDefault(), p == null || p(M, X, s);
          break;
      }
  }, $ = o.length - 1, O = (T) => {
    if (o.length && !(T.target !== T.currentTarget && !(T.target instanceof HTMLElement && T.target.closest('li[role="option"]'))))
      switch (T.key) {
        case "ArrowDown":
          T.preventDefault(), N(la(P, 1, $, v));
          break;
        case "ArrowUp":
          T.preventDefault(), N(la(P, -1, $, v));
          break;
  ...
  const D = i ? o.findIndex((T) => T === i) : -1;
  return W(() => {
    var T;
    D < 0 || D >= E.current.length || (T = E.current[D]) == null || T.scrollIntoView({ block: "nearest" });
  }, [D, c]), // Every row is its own tab stop (see the row `tabIndex` below), so the list is not one as
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ a(
        "ul",
        {
          ...
          children: o.map((T, M) => {
            const X = T === i, y = M === g && !!m, et = y ? Mu : `${s}-${M}`, I = M < o.length - 1 && n === "vertical" && /* @__PURE__ */ a(Kr, { tabIndex: -1, className: "tw:col-span-2" });
...
function zu({
  ...
  return /* @__PURE__ */ u(So, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ro, { stickyHeader: !0, children: /* @__PURE__ */ u(er, { children: [
    ...
    /* @__PURE__ */ a(Do, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      er,
      {
        ...
        children: [
          /* @__PURE__ */ a(_r, { children: Fe(c.reference, "English") }),
...
const Pu = (t) => {
...
}, $a = (t, e, r) => /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
  /* @__PURE__ */ u(
    Ot,
    {
  ...
  /* @__PURE__ */ a(Mt, { side: "bottom", children: e })
] }) }), $h = (t) => ({
  accessorKey: "item",
  ...
  accessorKey: "status",
  header: ({ column: s }) => $a(s, t, "tw:justify-center"),
  cell: ({ row: s }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(Kn, { value: i, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          da,
          {
            onClick: (l) => {
  ...
  const n = an(o.key) ? o.key : o.key[0];
  return {
    items: an(o.key) ? [o.key] : o.key,
    count: o.count,
...
function Kh({
  ...
  const g = Re(r, "%webView_inventory_all%"), m = Re(r, "%webView_inventory_approved%"), f = Re(r, "%webView_inventory_unapproved%"), v = Re(r, "%webView_inventory_unknown%"), E = Re(r, "%webView_inventory_scope_currentBook%"), k = Re(r, "%webView_inventory_scope_chapter%"), C = Re(r, "%webView_inventory_scope_verse%"), P = Re(r, "%webView_inventory_filter_text%"), K = Re(
    r,
    "%webView_inventory_show_additional_items%"
  ), N = Re(r, "%webView_inventory_no_results%"), [j, $] = _(!1), [O, D] = _("all"), [T, M] = _(""), [X, y] = _([]), et = V(() => {
    const J = t ?? [];
    return J.length === 0 ? [] : Lu(J, n, s);
  }, [t, n, s]), I = V(() => {
    if (j) return et;
    const J = [];
    return et.forEach((ct) => {
      const ht = ct.items[0], nt = J.find(
        (Et) => Et.items[0] === ht
      );
      nt ? (nt.count += ct.count, nt.occurrences = nt.occurrences.concat(ct.occurrences)) : J.push({
        items: [ht],
        count: ct.count,
  ...
  }, [j, et]), R = V(() => I.length === 0 ? [] : Vu(I, O, T), [I, O, T]), Y = V(() => {
    var ht, nt;
    if (!j) return l;
    const J = (ht = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ht.length;
    if (!J) return l;
    const ct = [];
    for (let Et = 0; Et < J; Et++)
      ct.push(
        Au(
          ((nt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : nt[Et]) || "Additional Item",
          Et + 1
        )
      );
    return [...ct, ...l];
  ...
  const st = (J, ct) => {
    ct.setRowSelection(() => {
      const nt = {};
      return nt[J.index] = !0, nt;
    });
    const ht = J.original.items;
    y(ht), h && ht.length > 0 && h(ht[0]);
  }, ot = (J) => {
    ...
    if (I.length === 0 || X.length === 0) return [];
    const J = I.filter((ct) => ni(
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        Tr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(Dr, { children: [
              /* @__PURE__ */ a(Ee, { value: "all", children: g }),
              /* @__PURE__ */ a(Ee, { value: "approved", children: m }),
              /* @__PURE__ */ a(Ee, { value: "unapproved", children: f }),
              /* @__PURE__ */ a(Ee, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(Tr, { onValueChange: (J) => ot(J), defaultValue: i, children: [
        /* @__PURE__ */ a(Rr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(Sr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(Dr, { children: [
          /* @__PURE__ */ a(Ee, { value: "book", children: E }),
          /* @__PURE__ */ a(Ee, { value: "chapter", children: k }),
          /* @__PURE__ */ a(Ee, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Ma,
      ...
      o && /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
        /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(At, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? K })
        ] }) }),
        /* @__PURE__ */ a(Mt, { children: (o == null ? void 0 : o.checkboxText) ?? K })
      ] }) })
    ] }),
...
const Bu = "16rem", ju = "3rem", ss = de.createContext(void 0);
function Va() {
  const t = de.useContext(ss);
  if (!t)
...
function Fu({
  ...
  const [l, d] = de.useState(t), w = e ?? l, p = de.useCallback(
    (C) => {
      const P = typeof C == "function" ? C(w) : C;
      r ? r(P) : d(P);
    },
    [r, w]
  ), h = de.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", v = ze() === "ltr" ? i : i === "primary" ? "secondary" : "primary", E = de.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(ss.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
...
function Yu({
  ...
  const c = t ? Xr.Root : "button", { state: l } = Va(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: x(Wu({ variant: r, size: o }), s),
      ...i
    }
  );
  return n ? /* @__PURE__ */ u(Dt, { children: [
    ...
    Uu,
    {
      ...
      children: /* @__PURE__ */ u(Hu, { children: [
        /* @__PURE__ */ u($n, { children: [
          /* @__PURE__ */ a(Vn, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(Ln, { children: /* @__PURE__ */ a(qu, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(Gu, { children: /* @__PURE__ */ a(
            Yu,
            {
              onClick: () => d(g),
              isActive: h(g),
        ...
        /* @__PURE__ */ u($n, { children: [
          /* @__PURE__ */ a(Vn, { className: "tw:text-sm", children: i }),
...
const Je = "scrBook", Zu = "scrRef", dr = "source", Ju = "details", Qu = "Scripture Reference", tp = "Scripture Book", cs = "Type", ep = "Details";
function rp(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Ht.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Je ? Fe(n.start) : void 0;
      },
    ...
    {
      accessorFn: (o) => Fe(o.start),
      id: Zu,
      header: void 0,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? void 0 : Fe(n.start);
      },
      sortingFn: (o, n) => ka(o.original.start, n.original.start),
      enableGrouping: !1
    },
    {
      ...
      id: dr,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? cs : void 0,
...
}, Bn = (t) => `${ap({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ng({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Je, desc: !1 }]), [g, m] = _({}), f = V(
  ...
  W(() => {
    if (c) {
      const O = E.getSelectedRowModel().rowsById, D = Object.keys(O);
      if (D.length === 1) {
        const T = f.find((M) => Bn(M) === D[0]) || void 0;
        T && c(T);
      }
    }
  }, [g, f, c, E]);
  const k = n ?? tp, C = s ?? cs, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [Je] },
    { label: `Group by ${C}`, value: [dr] },
    {
  ...
  }, j = (O, D) => O.getIsGrouped() ? "" : x("banded-row", D % 2 === 0 ? "even" : "odd"), $ = (O, D, T) => {
    if (!((O == null ? void 0 : O.length) === 0 || D.depth < T.column.getGroupedIndex())) {
      if (D.getIsGrouped())
        switch (D.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      Tr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Dr, { position: "item-aligned", children: /* @__PURE__ */ a(Xw, { children: P.map((O) => /* @__PURE__ */ a(Ee, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(So, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ro, { children: E.getHeaderGroups().map((O) => /* @__PURE__ */ a(er, { children: O.headers.filter((D) => D.column.columnDef.header).map((D) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ya, { colSpan: D.colSpan, className: "tw:sticky top-0", children: D.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Br(D.column.columnDef.header, D.getContext())
        ] }) }, D.id)
      )) }, O.id)) }),
      /* @__PURE__ */ a(Do, { children: E.getRowModel().rows.map((O, D) => {
        const T = ze();
        return /* @__PURE__ */ a(
          er,
          {
            ...
            children: O.getVisibleCells().map((M) => {
              if (!(M.getIsPlaceholder() || M.column.columnDef.enableGrouping && !M.getIsGrouped() && (M.column.columnDef.id !== dr || !r)))
                return /* @__PURE__ */ a(
                  _r,
                  {
                    className: x(
                    ...
                    children: M.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !O.getIsExpanded() && (T === "ltr" ? /* @__PURE__ */ a(mc, {}) : /* @__PURE__ */ a(vc, {})),
                          " ",
                          Br(M.column.columnDef.cell, M.getContext()),
                          " (",
                          O.subRows.length,
                          ")"
                        ]
...
function op({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: m, extraLong: f } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, E] = _(!1), [k, C] = _(""), P = B(void 0), K = B(!1), N = V(
    () => Yn(t),
    [t]
  ), j = V(() => {
    if (!k.trim()) {
    ...
    (y, et = !1) => {
      ...
      const I = N.findIndex((ut) => ut === P.current), R = N.findIndex((ut) => ut === y);
      if (I === -1 || R === -1) return;
      const [Y, st] = [
        Math.min(I, R),
        Math.max(I, R)
      ], ot = N.slice(Y, st + 1).map((ut) => ut);
      r(
        e.includes(y) ? e.filter((ut) => !ot.includes(ut)) : [.../* @__PURE__ */ new Set([...e, ...ot])]
      );
    },
    [e, r, N]
  ), O = (y) => {
    $(y, K.current), K.current = !1;
  }, D = (y, et) => {
    y.preventDefault(), $(et, y.shiftKey);
  }, T = () => {
    r(N.map((y) => y));
  }, M = () => {
    r([]);
    ...
    () => Object.values(Pt).filter(
      (y) => (s == null ? void 0 : s[y]) !== void 0 && Oo(N, y).length === 0
          ...
          gr,
          {
            ...
            children: /* @__PURE__ */ u(
              fr,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (y) => {
                  y.key === "Enter" && (K.current = y.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    Ra,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(tt, { variant: "ghost", size: "sm", onClick: M, children: w })
                  ] }),
                  /* @__PURE__ */ u(mr, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(Oa, { children: p }),
                    Object.values(Pt).filter((y) => j[y].length > 0).map((y, et) => {
                      const I = j[y];
                      return /* @__PURE__ */ u(pr, { children: [
                        et > 0 && /* @__PURE__ */ a(Gn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          or,
                          {
                            heading: Un(y, h, g, m, f),
                            children: I.map((R) => /* @__PURE__ */ a(
                              Ei,
                              {
                                bookId: R,
                  ...
                  X.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: X.map(({ section: y, explanation: et }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: et }, y)) })
                ]
              }
            )
          }
...
function ip({
  ...
  return /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
    /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
      np,
      {
        className: o,
    ...
    t && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { className: "tw:max-w-xs tw:whitespace-pre-line", children: e }) })
  ] }) });
}
function sp({
  section: t,
...
function cp({
  ...
  const i = o["%webView_book_selector_more%"], c = V(
    ...
    (d) => {
      ...
      r(
        Xn(c, d, e) ? e.filter((p) => !w.includes(p)) : [.../* @__PURE__ */ new Set([...e, ...w])]
      );
    },
    [e, r, c]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ao ? ao : jn
      ).map((d) => /* @__PURE__ */ a(Ur, { className: "tw:hover:bg-secondary", variant: "secondary", children: je(d, n) }, d)),
...
function sg({
  ...
  const N = Kt(
    i,
    "%webView_scope_selector_selected_text%"
  ), j = Kt(i, "%webView_scope_selector_verse%"), $ = Kt(i, "%webView_scope_selector_chapter%"), O = Kt(i, "%webView_scope_selector_book%"), D = Kt(
    i,
    "%webView_scope_selector_current_verse%"
  ), T = Kt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), M = Kt(i, "%webView_scope_selector_current_book%"), X = Kt(i, "%webView_scope_selector_choose_books%"), y = Kt(i, "%webView_scope_selector_scope%"), et = Kt(i, "%webView_scope_selector_select_books%"), I = Kt(i, "%webView_scope_selector_range%"), R = Kt(i, "%webView_scope_selector_select_range%"), Y = Kt(i, "%webView_scope_selector_range_start%"), st = Kt(i, "%webView_scope_selector_range_end%"), ot = Kt(i, "%webView_scope_selector_ok%"), ut = Kt(i, "%webView_scope_selector_cancel%"), Ct = Kt(i, "%webView_scope_selector_navigate%"), J = (U) => {
    if (!v) return;
    ...
    { value: "selectedBooks", label: X, id: "scope-selected" },
    { value: "range", label: I, id: "scope-range" }
  ], ht = (U, rt, Vt = !1) => /* @__PURE__ */ u(mt, { children: [
    U,
    rt && !Vt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      rt
    ] })
  ] }), nt = e ? ct.filter((U) => e.includes(U.value)) : ct, Et = v ?? Ha, ne = h ?? Et, bt = g ?? Et, Se = () => {
  }, _e = B(null), Bt = B(null), xt = B(!1), Gt = B(null), fe = B(!1), [It, gt] = _(void 0), vt = B(!1), ue = B(!1), jt = B(null), ie = L((U) => {
    if (U) {
      gt("start"), vt.current = !1;
      return;
    }
    gt((rt) => rt === "start" ? void 0 : rt), vt.current && (vt.current = !1, requestAnimationFrame(() => {
      var Vt;
      const rt = (Vt = _e.current) == null ? void 0 : Vt.querySelector("button");
      rt == null || rt.click();
    }));
  }, []), Zt = L((U) => {
    if (U) {
    ...
    gt((rt) => rt === "end" ? void 0 : rt);
  }, []), yt = L(
    (U) => {
      m == null || m(U), f == null || f(U), vt.current = !0;
    },
    [m, f]
  ), $e = L(
    (U) => {
      f == null || f(U), ue.current = !0;
    },
    [f]
  ), kt = L(
    (U) => {
      r(U), U === "selectedBooks" && n.length === 0 && (v != null && v.book) && s([v.book]);
    },
    [r, n, v, s]
  ), Tt = nt.find((U) => U.value === t), se = () => t === "selectedBooks" && n.length > 0 ? n.map((U) => U.toUpperCase()).join(", ") : t === "range" ? Mc(ne, bt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Tt ? ht(Tt.label, Tt.scrRefSuffix) : t, z = nt.filter(
    (U) => U.value !== "selectedBooks" && U.value !== "range"
  ), ft = nt.find((U) => U.value === "selectedBooks"), me = nt.find((U) => U.value === "range"), [Jt, Qt] = _(!1), [pe, ve] = _(void 0), [A, zt] = _(void 0), [_t, Wt] = _(void 0), [he, ge] = _(void 0), [Ve, Le] = _([]), We = p === "dropdown" && pe === "selectedBooks", Ye = /* @__PURE__ */ a(
    cp,
    {
      availableBookInfo: o,
      selectedBookIds: We ? Ve : n,
      onChangeSelectedBookIds: We ? Le : s,
      localizedStrings: i,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Xe = It === "end", Ze = It === "start", S = "tw:text-muted-foreground", F = p === "dropdown" && pe === "range", Z = F ? Wt : yt, Q = F ? ge : f ? $e : Se, H = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(At, { htmlFor: "scope-range-start", className: x(Xe && S), children: Y }),
      /* @__PURE__ */ a(
        Ga,
        {
    ...
    /* @__PURE__ */ u("div", { ref: _e, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(At, { htmlFor: "scope-range-end", className: x(Ze && S), children: st }),
      /* @__PURE__ */ a(
        Ga,
        {
          id: "scope-range-end",
          ...
          localizedStrings: k,
          getEndVerse: C,
          disableReferencesUpTo: F ? _t ?? ne : ne,
          onOpenChange: Zt,
          onCloseAutoFocus: (U) => {
            var rt;
            ue.current && (ue.current = !1, U.preventDefault(), (rt = jt.current) == null || rt.focus());
          },
          className: x(Ze && S),
          modal: !0,
          align: "start"
  ...
  const [St, Ft] = _(null), [Rt, te] = _(null), [Be, La] = _(null), Zr = 200, [Ba, Jr] = _(!1);
  W(() => {
    if (!Be || typeof ResizeObserver > "u") return;
    const U = new ResizeObserver(([rt]) => {
      Jr(rt.contentRect.width < Zr);
    });
    return U.observe(Be), () => U.disconnect();
  }, [Be]);
  const Qr = L(
    (U) => {
      zt(U), Wt(ne), ge(bt), Le(n), Qt(!1), ve(U);
    },
    [ne, bt, n]
  ), ta = L(() => {
    A !== void 0 && (A === "range" ? (_t && (m == null || m(_t)), he && (f == null || f(he))) : A === "selectedBooks" && s(Ve), kt(A), ve(void 0), zt(void 0));
  }, [
    A,
    _t,
    he,
    ...
    U || (ve(void 0), zt(void 0));
  }, []), ea = L((U) => {
    var rt;
    U.preventDefault(), (rt = dt.current) == null || rt.focus();
  }, []), ra = (U) => t === U ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !P && /* @__PURE__ */ a(At, { children: y }),
      p === "dropdown" ? /* @__PURE__ */ u(He, { open: Jt, onOpenChange: Qt, children: [
        /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(
          tt,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: se() }),
              /* @__PURE__ */ a(ur, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          qe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Fa, { container: Be, children: [
              z.map(({ value: U, label: rt, dropdownLabel: Vt, scrRefSuffix: be, id: Ne }) => {
                const b = d == null ? void 0 : d[U];
                return /* @__PURE__ */ u(
                  tr,
                  {
                    ref: wt(U),
                    ...
                    children: [
                      t === U && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-4 tw:w-4" }) }),
                      /* @__PURE__ */ u("span", { className: "tw:flex tw:min-w-0 tw:flex-col tw:gap-0.5", children: [
                        /* @__PURE__ */ a("span", { className: "tw:flex tw:items-center tw:gap-1.5", children: ht(Vt ?? rt, be, Ba) }),
              ...
              E && /* @__PURE__ */ u(mt, { children: [
                ...
                /* @__PURE__ */ a(
                  tr,
                  {
                    ...
                    onSelect: (U) => {
                      var rt, Vt;
                      if (U.preventDefault(), xt.current) {
                        xt.current = !1;
                        return;
                      }
                      fe.current || (Vt = (rt = Bt.current) == null ? void 0 : rt.querySelector("button")) == null || Vt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (U) => {
                          ...
                          rt != null && rt.closest("button") && (xt.current = !0, requestAnimationFrame(() => {
                            xt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          Ga,
                          {
                            ...
                            onCloseAutoFocus: (U) => {
                              var rt;
                              U.preventDefault(), (rt = Gt.current) == null || rt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(mt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Fe(v ?? Ha, "id") }),
                              /* @__PURE__ */ a(ur, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Eo,
        {
          ...
          children: nt.map(({ value: U, label: rt, scrRefSuffix: Vt, id: be }) => {
            const Ne = d == null ? void 0 : d[U];
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
                /* @__PURE__ */ a(
                  xa,
                  {
                    ...
                    id: be,
                    disabled: !!Ne,
                    "aria-describedby": Ne ? `${be}-explanation` : void 0
                  }
                ),
                /* @__PURE__ */ a(At, { htmlFor: be, children: ht(rt, Vt) })
              ] }),
              Ne && // Indented to clear the radio so it reads as belonging to this row's label.
              /* @__PURE__ */ a(
                "span",
                {
                  id: `${be}-explanation`,
    ...
    p === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(At, { children: et }),
      Ye
    ] }),
    p === "radio" && t === "range" && H,
    p === "dropdown" && ft && /* @__PURE__ */ a(oo, { open: pe === "selectedBooks", onOpenChange: br, children: /* @__PURE__ */ a(
      no,
      {
        ref: te,
        onCloseAutoFocus: ea,
        onEscapeKeyDown: (U) => {
          Rt != null && Rt.querySelector('[data-state="open"]') && U.preventDefault();
        },
        children: /* @__PURE__ */ u(Fa, { container: Rt, children: [
          /* @__PURE__ */ a(io, { className: "tw:pe-8", children: /* @__PURE__ */ a(so, { children: X }) }),
          Ye,
          /* @__PURE__ */ u(Qo, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => br(!1), children: ut }),
            /* @__PURE__ */ a(tt, { onClick: ta, children: ot })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && me && /* @__PURE__ */ a(oo, { open: pe === "range", onOpenChange: br, children: /* @__PURE__ */ a(
      no,
      {
        ref: Ft,
        onCloseAutoFocus: ea,
        onEscapeKeyDown: (U) => {
          St != null && St.querySelector('[data-state="open"]') && U.preventDefault();
        },
        children: /* @__PURE__ */ u(Fa, { container: St, children: [
          /* @__PURE__ */ a(io, { className: "tw:pe-8", children: /* @__PURE__ */ a(so, { children: R }) }),
          H,
          /* @__PURE__ */ u(Qo, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => br(!1), children: ut }),
            /* @__PURE__ */ a(tt, { ref: jt, onClick: ta, children: ot })
          ] })
        ] })
      }
    ) })
...
function cg({
  ...
  return /* @__PURE__ */ u(
    Tr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(Rr, { size: n, className: x("pr-twp tw:w-auto", s), children: /* @__PURE__ */ a(
          Sr,
          {
            placeholder: l[on(e)] ?? e
          }
        ) }),
        /* @__PURE__ */ a(
          Dr,
          {
            ...
            style: { zIndex: Ge },
            children: t.map((w) => /* @__PURE__ */ a(Ee, { value: `${w}`, children: l[on(w)] }, `${w}`))
          }
        )
      ]
    }
...
const ds = (t, e, r, o) => r ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === r || s === r
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Dt, { children: [
  /* @__PURE__ */ a(Ot, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a($s, { children: c.label }),
    /* @__PURE__ */ a(Vs, { children: /* @__PURE__ */ a(Ls, { children: ds(
      t,
      e,
      ls(t, c.id),
      o
  ...
  c.tooltip && /* @__PURE__ */ a(Mt, { children: c.tooltip })
...
function _o({
  ...
  return /* @__PURE__ */ u(He, { variant: s, children: [
    /* @__PURE__ */ a(Oe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(tt, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(xc, {}) }) }),
    /* @__PURE__ */ a(qe, { align: "start", style: { zIndex: Ge }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(pr, { children: [
      /* @__PURE__ */ a(Hn, { children: /* @__PURE__ */ a($t, { children: ds(e.groups, e.items, l, t) }) }),
...
const pp = Object.freeze([520, 420, 340]), us = de.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    const [n, s] = _(void 0), i = B(o);
    i.current = o;
    const c = L((p) => {
      s(p ?? void 0);
      const h = i.current;
      typeof h == "function" ? h(p) : h && (h.current = p);
    }, []), l = ws(n, pp), d = Si() ?? l, w = d >= jr.MINIMUM;
...
function ug({
  ...
  return /* @__PURE__ */ u(us, { className: `tw:w-full tw:border-b ${s}`, id: n, children: [
    r && /* @__PURE__ */ a(
      _o,
      {
        onSelectMenuItem: t,
...
function pg({
  ...
  return /* @__PURE__ */ a(us, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    _o,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const ps = de.forwardRef(({ className: t, ...e }, r) => {
  const o = ze();
  return /* @__PURE__ */ a(
    Te.Root,
    {
...
ps.displayName = Te.List.displayName;
const hs = de.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.List,
  {
    ref: r,
    className: x(
...
hs.displayName = Te.List.displayName;
const hp = de.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.Trigger,
  {
    ref: r,
    ...e,
...
)), gs = de.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.Content,
  {
    ref: r,
    className: x(
...
gs.displayName = Te.Content.displayName;
function hg({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ps, { children: [
      /* @__PURE__ */ a(hs, { children: t.map((c) => /* @__PURE__ */ a(hp, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(gs, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function gp({
  ...
  return /* @__PURE__ */ a(Bs.Provider, { value: o, children: /* @__PURE__ */ a(
    Pe.Root,
    {
      "data-slot": "menubar",
      className: x(
...
function fp({ ...t }) {
  return /* @__PURE__ */ a(Pe.Menu, { "data-slot": "menubar-menu", ...t });
}
function mp({ ...t }) {
  return /* @__PURE__ */ a(Pe.Portal, { "data-slot": "menubar-portal", ...t });
}
function vp({
  className: t,
  ...e
...
function kp({ ...t }) {
  return /* @__PURE__ */ a(Pe.Sub, { "data-slot": "menubar-sub", ...t });
}
function _p({
  className: t,
  inset: e,
  ...
  return /* @__PURE__ */ u(
    Pe.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(li, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
...
const $r = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    const c = e.filter((d) => d.group === s).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Dt, { children: [
      ...
      d.tooltip && /* @__PURE__ */ a(Mt, { children: d.tooltip })
    ] }, `tooltip-${d.label}-${"command" in d ? d.command : d.id}`)), l = [...c];
    return c.length > 0 && i < n.length - 1 && l.push(/* @__PURE__ */ a(yp, {}, `separator-${s}`)), l;
  });
};
function Cp({
  menuData: t,
  ...
  if (Yl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = s.current) == null || m.focus(), $r(s, [h, g]);
        break;
      case "alt+l":
        (f = i.current) == null || f.focus(), $r(i, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), $r(c, [h, g]);
        break;
      case "alt+h":
        (E = l.current) == null || E.focus(), $r(l, [h, g]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(gp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(fp, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ge },
          children: /* @__PURE__ */ a($t, { children: fs(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function mg({
  ...
  const d = Tp(
    ...
    n && n(m), o && o([m, ...r.filter((f) => f !== m)]), s && r.find((f) => f === m) && s([...r.filter((f) => f !== m)]), p(!1);
  }, g = (m, f) => {
    var E, k, C, P, K, N;
    const v = f !== m ? ((k = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : k[f]) ?? ((P = (C = t[m]) == null ? void 0 : C.uiNames) == null ? void 0 : P.en) : void 0;
    return v ? `${(K = t[m]) == null ? void 0 : K.autonym} (${v})` : (N = t[m]) == null ? void 0 : N.autonym;
  };
      ...
      Tr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: Ge },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(Ee, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(At, { className: "tw:font-normal tw:text-muted-foreground", children: rr(d, {
...
function bg({
  ...
  return /* @__PURE__ */ u(fr, { id: s, className: x("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(js, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        "input",
        {
      ...
      /* @__PURE__ */ a(Fs, { children: /* @__PURE__ */ a(Bc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(mr, { children: [
...
function yg({
  ...
  const c = t ? nn(r, { key: o }).join("") : "", {
    anchorRect: l,
    message: d,
    confirmingKeyLabel: w,
    showArrow: p
  } = Op(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
  return /* @__PURE__ */ u($t, { children: [
    /* @__PURE__ */ a("span", { role: "status", className: "tw:sr-only", children: c }),
    /* @__PURE__ */ u(Dt, { open: t, onOpenChange: () => {
    }, children: [
      /* @__PURE__ */ a(
        Ot,
        {
      ...
      /* @__PURE__ */ a(
        Mt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: nn(d, {
            key: /* @__PURE__ */ a(
              co,
              {
                className: x(
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(pr, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
            ...
            d && (e || h && m) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(He, { children: [
                  /* @__PURE__ */ a(Oe, { className: x(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
...
function Ng({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: i.map((c) => {
    let l = "upcoming";
    return c === s ? l = "active" : c < s && (l = "complete"), /* @__PURE__ */ u(pr, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(nr, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function Ig({
  ...
  return /* @__PURE__ */ u(
    qt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(li, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function Pg({
  ...
  return /* @__PURE__ */ u(
    qt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(qt.ItemIndicator, { children: /* @__PURE__ */ a(za, {}) }) }),
        e
      ]
    }
  );
...
const Ap = (t, e, r = {}) => {
  ...
  const [e, r] = _(!1), [o, n] = _(!1), [s, i] = _(0), c = B(void 0), l = V(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
...
function df({ value: t, children: e }) {
  return /* @__PURE__ */ a(Ti.Provider, { value: t, children: /* @__PURE__ */ a(Pa.Provider, { value: t, children: e }) });
}
function Lp(t, e = "top") {
...
export {
  ...
  Ti as ShrinkStepOverrideContext,
  Uu as Sidebar,
  ...
  ps as VerticalTabs,
  gs as VerticalTabsContent,
  hs as VerticalTabsList,
