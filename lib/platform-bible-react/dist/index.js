import { jsxs as ae, jsx as y, Fragment as Xr } from "react/jsx-runtime";
import * as ie from "react";
import { forwardRef as Yr, useState as Ee, useRef as Qe, useCallback as Ne, useMemo as _n, useEffect as on } from "react";
...
var Et = Object.defineProperty, Ct = (e, n, r) => n in e ? Et(e, n, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[n] = r, A = (e, n, r) => (Ct(e, typeof n != "symbol" ? n + "" : n, r), r);
const Oe = [
  "GEN",
  "EXO",
  "LEV",
...
*/
A(ye, "ValidStatusType", $r);
class Ue extends Error {
}
function we(...e) {
  return it(at(e));
}
const Bt = Y.Root, zt = Y.Trigger, Dt = ie.forwardRef(({ className: e, inset: n, children: r, ...t }, o) => /* @__PURE__ */ ae(
  Y.SubTrigger,
  {
    ref: o,
    className: we(
    ...
    children: [
      r,
      /* @__PURE__ */ y(Qr, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
Dt.displayName = Y.SubTrigger.displayName;
const jt = ie.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ y(
  Y.SubContent,
  {
    ref: r,
    className: we(
...
jt.displayName = Y.SubContent.displayName;
const Rr = ie.forwardRef(({ className: e, sideOffset: n = 4, ...r }, t) => /* @__PURE__ */ y(Y.Portal, { children: /* @__PURE__ */ y(
  Y.Content,
  {
    ref: t,
    sideOffset: n,
...
Rr.displayName = Y.Content.displayName;
const Ar = ie.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ y(
  Y.Item,
  {
    ref: t,
    className: we(
...
Ar.displayName = Y.Item.displayName;
const Vt = ie.forwardRef(({ className: e, children: n, checked: r, ...t }, o) => /* @__PURE__ */ ae(
  Y.CheckboxItem,
  {
    ...
    ...t,
    children: [
      /* @__PURE__ */ y("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ y(Y.ItemIndicator, { children: /* @__PURE__ */ y(et, { className: "pr-h-4 pr-w-4" }) }) }),
      n
    ]
  }
));
Vt.displayName = Y.CheckboxItem.displayName;
const Ft = ie.forwardRef(({ className: e, children: n, ...r }, t) => /* @__PURE__ */ ae(
  Y.RadioItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ y("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ y(Y.ItemIndicator, { children: /* @__PURE__ */ y(nt, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      n
    ]
  }
));
Ft.displayName = Y.RadioItem.displayName;
const Pr = ie.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ y(
  Y.Label,
  {
    ref: t,
...
Pr.displayName = Y.Label.displayName;
const Ir = ie.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ y(
  Y.Separator,
  {
    ref: r,
...
Ir.displayName = Y.Separator.displayName;
...
const Lt = Yr(
  ({ handleSearch: e, ...n }, r) => /* @__PURE__ */ ae("div", { className: "input-container", children: [
    /* @__PURE__ */ y(
      Mr,
      {
        ...n,
    ...
    /* @__PURE__ */ y("div", { className: "history-icon-container", children: /* @__PURE__ */ y(
      rt,
      {
        size: 16,
        onClick: () => {
    ...
    /* @__PURE__ */ y(
      Ar,
      {
        ...
        children: /* @__PURE__ */ ae("div", { children: [
          /* @__PURE__ */ y(tt, { className: `book-color-label ${t.toLowerCase()}` }),
...
function Li({ scrRef: e, handleSubmit: n }) {
  const { allBookIds: r } = Z, [t, o] = Ee(""), [a, i] = Ee(""), l = Qe(void 0), c = Ne(
    ...
    o(m);
  }, h = Ne((m) => xr(Z.bookIdToNumber(m)), []), d = (m) => {
    i(a !== m ? m : ""), h(m) === -1 && n({
  ...
  return /* @__PURE__ */ y("div", { children: /* @__PURE__ */ ae(Bt, { children: [
    /* @__PURE__ */ y(zt, { asChild: !0, children: /* @__PURE__ */ y(
      Lt,
      {
        ref: l,
        value: t,
    ...
    /* @__PURE__ */ y(Rr, { className: "menu-content", children: Ht.map((m) => /* @__PURE__ */ ae("div", { children: [
      /* @__PURE__ */ y(Pr, { className: "menu-label", children: Wt[m] }),
      ...
      m === "OT" || m === "NT" ? /* @__PURE__ */ y(Ir, {}) : void 0
    ] }, m)) })
  ] }) });
}
function Ae({
...
function Wi({ scrRef: e, handleSubmit: n, id: r }) {
  ...
  return /* @__PURE__ */ ae("span", { id: r, children: [
    ...
    /* @__PURE__ */ y(Ae, { onClick: () => n(Un(e, 1)), children: ">" })
  ] });
}
function Hi({ onSearch: e, placeholder: n, isFullWidth: r }) {
  ...
  return /* @__PURE__ */ y(ft, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ y(
    en,
    {
      isFullWidth: r,
...
const Jt = ({ onChange: e, disabled: n, checked: r, ...t }) => /* @__PURE__ */ y(
  qt,
  {
    ...t,
    isChecked: r,
...
function he(e, n, r = {
  ...
  return Se(e) && Se(n) && Object.keys(n).forEach((o) => {
    o !== "__proto__" && (Se(n[o]) && o in e && Se(e[o]) ? t[o] = he(e[o], n[o], r) : r.clone ? t[o] = Se(n[o]) ? Br(n[o]) : n[o] : t[o] = n[o]);
  }), t;
}
function Zt(e) {
...
function eo() {
  return Yn || (Yn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var g = c, ee = s, te = l, me = i, fe = n, T = u, H = t, Q = m, oe = v, U = r, pe = a, ne = o, be = h, Te = !1;
    function $e(w) {
...
function to() {
  if (nr)
    return wn;
  nr = 1;
  var e = zr(), n = no(), r = Rn(), t = Dr(), o = ro(), a = function() {
  };
...
function lo() {
  return or || (or = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var ee = i, te = a, me = e, fe = c, T = r, H = d, Q = h, oe = n, U = o, pe = t, ne = s, be = u, Te = !1, $e = !1;
    function b(k) {
...
function So(e) {
  const {
    ...
    unit: r = "px",
    step: t = 5
  } = e, o = xe(e, xo), a = ko(n), i = Object.keys(a);
  function l(d) {
...
const Eo = {
  borderRadius: 4
}, Co = Eo, To = process.env.NODE_ENV !== "production" ? G.oneOfType([G.number, G.string, G.object, G.array]) : {}, Ce = To;
function We(e, n) {
  return n ? he(e, n, {
    clone: !1
...
X.filterProps = cn;
process.env.NODE_ENV !== "production" && Po.reduce((e, n) => (e[n] = Ce, e), {});
function Bo(e = 8) {
  if (e.mui)
    return e;
  const n = Fr({
...
const zo = de("border", ue), Do = de("borderTop", ue), jo = de("borderRight", ue), Vo = de("borderBottom", ue), Fo = de("borderLeft", ue), Lo = de("borderColor"), Uo = de("borderTopColor"), Go = de("borderRightColor"), Wo = de("borderBottomColor"), Ho = de("borderLeftColor"), qo = de("outline", ue), Xo = de("outlineColor"), un = (e) => {
...
ln(zo, Do, jo, Vo, Fo, Lo, Uo, Go, Wo, Ho, un, qo, Xo);
const dn = (e) => {
...
function ga() {
  ...
  function n(r) {
    ...
    function l(c) {
      ...
      if (!s)
        return null;
      const u = _o(a.breakpoints), h = Object.keys(u);
      let d = u;
...
const Ta = (e, n) => n.components && n.components[e] && n.components[e].styleOverrides ? n.components[e].styleOverrides : null, rn = (e) => {
  ...
  return r && r.forEach((i) => {
    ...
    l && (typeof i.props == "function" ? o.push(n[`callback${a}`]) : o.push(n[Gr(i.props)])), typeof i.props == "function" && (a += 1);
  }), o;
}, Na = (e, n, r, t) => {
  var o;
...
const Oa = zn(), dr = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Ze({
  defaultTheme: e,
  theme: n,
  themeId: r
...
function Ra(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    St(i, (C) => C.filter((g) => !(g != null && g.__mui_systemSx)));
    const {
      name: c,
      slot: s,
    ...
    const J = xt(i, B({
      ...
      const ee = g ? g.map((T) => {
        ...
        if (Se(T)) {
          let H = T, Q;
          return T && T.variants && (Q = T.variants, delete H.variants, H = (oe) => {
            let U = T;
      ...
      if (Se(C)) {
        let T;
        C && C.variants && (T = C.variants, delete te.variants, te = (H) => {
          let Q = C;
          return tn(H, rn(T), T).forEach((U) => {
            Q = he(Q, U);
          }), Q;
        });
      } else
      ...
      if (process.env.NODE_ENV !== "production") {
        let T;
        c && (T = `${c}${ge(s || "")}`), T === void 0 && (T = `Styled(${po(i)})`), fe.displayName = T;
      }
...
const ja = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, ze = qa, Xa = ["mode", "contrastThreshold", "tonalOffset"], mr = {
...
function gr(e, n, r, t) {
  ...
  e[n] || (e.hasOwnProperty(r) ? e[n] = e[r] : n === "light" ? e.light = za(e.main, o) : n === "dark" && (e.dark = Ba(e.main, a)));
}
function Ya(e = "light") {
  return e === "dark" ? {
    main: Me[200],
...
function ni(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = xe(e, Xa), a = e.primary || Ya(n), i = e.secondary || Ka(n), l = e.error || Ja(n), c = e.info || Za(n), s = e.success || Qa(n), u = e.warning || ei(n);
  function h(p) {
    const f = hr(p, kn.text.primary) >= r ? kn.text.primary : mr.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const S = hr(p, f);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return gr(p, "light", J, t), gr(p, "dark", z, t), p.contrastText || (p.contrastText = h(p.main)), p;
  }, v = {
    dark: kn,
    light: mr
  };
...
function oi(e, n) {
  ...
  const v = o / 14, m = h || ((S) => `${S / s * v}rem`), p = (S, J, z, C, g) => B({
    ...
    button: p(l, 14, 1.75, 0.4, br),
    caption: p(i, 12, 1.66, 0.4),
    overline: p(i, 12, 2.66, 1, br),
...
function hi(e) {
  const n = B({}, di, e.easing), r = B({}, fi, e.duration);
  return B({
...
const Ci = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ti = (e) => {
  ...
  const t = wi({
    ...
    titleAccess: h,
    viewBox: d = "0 0 24 24"
  } = t, v = xe(t, Ci), m = /* @__PURE__ */ ie.isValidElement(o) && o.type === "svg", p = B({}, t, {
    color: i,
    component: l,
    fontSize: c,
...
function Ji({
  ...
  let f = e;
  return !f && n && (f = n(c)), /* @__PURE__ */ y("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ y(gt, { position: "static", id: o, children: /* @__PURE__ */ ae(bt, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ y(
      Er,
      {
        edge: "start",
    ...
    f ? /* @__PURE__ */ y(
      yt,
      {
        ...
        children: /* @__PURE__ */ y(Kt, { commandHandler: p, columns: f.columns })
      }
    ) : void 0
  ] }) }) });
}
