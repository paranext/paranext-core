...
const nl = C.forwardRef(
  ({ className: e, ...t }, n) => /* @__PURE__ */ x("thead", { ref: n, className: ee("[&_tr]:pr-border-b", e), ...t })
);
nl.displayName = "TableHeader";
const rl = C.forwardRef(
  ({ className: e, ...t }, n) => /* @__PURE__ */ x("tbody", { ref: n, className: ee("[&_tr:last-child]:pr-border-0", e), ...t })
);
