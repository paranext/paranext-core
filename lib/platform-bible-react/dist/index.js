...
function Xv({ groups: e }) {
  return /* @__PURE__ */ _(Ro, { children: [
    ...
    /* @__PURE__ */ u(vn, { children: e.map((t) => /* @__PURE__ */ _("div", { children: [
      /* @__PURE__ */ u(Ar, { children: t.label }),
      /* @__PURE__ */ u(Wc, { children: t.items.map((r) => /* @__PURE__ */ u("div", { children: r.itemType === 0 ? /* @__PURE__ */ u(Po, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ u(Vi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ u(yn, {})
    ] }, t.label)) })
  ] });
}
