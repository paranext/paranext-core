...
var li = (t, e, r) => e in t ? si(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var _t = (t, e, r) => li(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Slot as ke, Dialog as Ht, Popover as rr, Label as ui, RadioGroup as oa, Tooltip as Le, ToggleGroup as Mo, Separator as pi, Avatar as ka, DropdownMenu as vt, Select as Ct, Checkbox as Ka, Tabs as Bt, Menubar as Jt, ContextMenu as bt, Progress as Ga, Slider as dr, Switch as qa } from "radix-ui";
import { cva as Zt } from "class-variance-authority";
import { IconX as gi, IconCheck as $e, IconSearch as hi, IconChevronRight as _a, IconChevronDown as fi, IconChevronUp as mi, IconSelector as vi, IconLayoutSidebar as bi, IconLayoutSidebarRight as xi, IconLoader as yi, IconAlertOctagon as ki, IconAlertTriangle as _i, IconInfoCircle as Ni, IconCircleCheck as Ci } from "@tabler/icons-react";
import { Canon as ct } from "@sillsdev/scripture";
import { includes as wr, Section as W, getChaptersForBook as Ei, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as zi, formatReplacementString as oe, sanitizeHtml as Ti, NumberFormat as Si, formatBytes as Di, getCurrentLocale as Ri, usfmMarkers as mr, getFormatCallerFunction as Mi, deepEqual as $i, isString as Ha, compareScrRefs as na, scrRefToBBBCCCVVV as Br, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
import { Check as nr, Clock as Wa, ChevronsLeft as Ya, ChevronsRight as Xa, ChevronLeft as ia, ChevronRight as sa, ArrowLeft as Oi, ArrowRight as Ai, ChevronDown as Rr, BoldIcon as Ii, ItalicIcon as Pi, X as Mr, AtSign as $o, Pencil as Li, Trash2 as Vi, ArrowUp as Oo, MoreHorizontal as ji, MailOpen as Fi, Mail as Bi, ChevronUp as Ui, FilterIcon as Ki, ArrowLeftIcon as Gi, ChevronLeftIcon as qi, ChevronRightIcon as Hi, ArrowRightIcon as Wi, Copy as Ao, Filter as Yi, User as Xi, Link as Ji, CircleHelp as Zi, ChevronsUpDown as Io, Star as Qi, Undo as ts, Redo as es, SquareX as Po, FunctionSquare as Lo, SquareSigma as Vo, Ban as rs, AlertCircle as la, CircleCheckIcon as as, CircleXIcon as os, CircleHelpIcon as ns, ArrowUpIcon as is, ArrowDownIcon as ss, Search as ls, LoaderCircle as cs, ScrollText as ds, MenuIcon as ws, Menu as us, EllipsisVertical as ps, MoreVertical as Ja } from "lucide-react";
import tt, { forwardRef as ir, useRef as q, useMemo as P, useState as T, useCallback as j, useLayoutEffect as $t, createContext as $r, useContext as Na, useEffect as K, Component as gs, createElement as Za, Suspense as hs, Fragment as jo } from "react";
import { createEditor as Fo, $getRoot as le, $createParagraphNode as We, $getSelection as zt, HISTORY_MERGE_TAG as Ca, ParagraphNode as Bo, TextNode as Uo, $isTokenOrSegmented as fs, $getCharacterOffsets as ms, $cloneWithPropertiesEphemeral as vs, $getPreviousSelection as bs, $isRangeSelection as Wt, $caretFromPoint as xs, $getSiblingCaret as Ko, $getChildCaret as ys, $getAdjacentChildCaret as ks, $isChildCaret as _s, $normalizeCaret as Ns, $setSelectionFromCaretRange as Cs, $getCollapsedCaretRange as Es, $getCaretInDirection as Qa, $splitAtPointCaretNext as zs, $isTextPointCaret as Ts, $findMatchingParent as Go, $isElementNode as ie, mergeRegister as ce, getDOMTextNode as Ss, isHTMLElement as qo, CLEAR_EDITOR_COMMAND as Ho, COMMAND_PRIORITY_EDITOR as Ea, shallowMergeConfig as Ds, defineExtension as Lt, safeCast as Oe, createState as Rs, FORMAT_TEXT_COMMAND as Wo, $isNodeSelection as Yo, COMMAND_PRIORITY_LOW as Xo, RootNode as Ms, LineBreakNode as $s, TabNode as Os, $isEditorState as As, createCommand as Is, CLICK_COMMAND as Ps, isDOMNode as Ls, $getNodeFromDOMNode as Vs, $createNodeSelection as js, $setSelection as Fs, $getEditor as Bs, DecoratorNode as ca, $getState as Us, toggleTextFormatType as to, TEXT_TYPE_TO_FORMAT as Ks, $setState as Gs, addClassNamesToElement as Jo, $create as qs, $getNodeByKey as Hs, removeClassNamesFromElement as Ws, KEY_TAB_COMMAND as Ys, $isBlockElementNode as yr, $createRangeSelection as Xs, $normalizeSelection__EXPERIMENTAL as Js, OUTDENT_CONTENT_COMMAND as Zs, INDENT_CONTENT_COMMAND as eo, INSERT_TAB_COMMAND as Qs, COMMAND_PRIORITY_CRITICAL as za, $isDecoratorNode as tl, $isParagraphNode as el, $isTextNode as kr, SELECTION_CHANGE_COMMAND as Zo, getRegisteredNode as rl, isDocumentFragment as ro, isDOMDocumentNode as al, ArtificialNode__DO_NOT_USE as Qo, $createLineBreakNode as tn, $isRootOrShadowRoot as ol, isBlockDomNode as ao, isInlineDomNode as oo, $insertNodes as nl } from "lexical";
import { HeadingNode as il, QuoteNode as sl, registerRichText as ll } from "@lexical/rich-text";
import { flushSync as cl, createPortal as dl } from "react-dom";
import { $isTableSelection as wl } from "@lexical/table";
import { createHeadlessEditor as en } from "@lexical/headless";
import { useReactTable as rn, getFilteredRowModel as ul, getSortedRowModel as an, getPaginationRowModel as pl, getCoreRowModel as on, flexRender as tr, getGroupedRowModel as gl, getExpandedRowModel as hl } from "@tanstack/react-table";
import fl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as da, HIDDEN_NOTE_CALLER as wa, getDefaultViewOptions as ml, isInsertEmbedOpOfType as ur, Editorial as vl } from "@eten-tech-foundation/platform-editor";
...
function _l(t) {
  ...
  const e = ua(t), r = e.findIndex((i) => i.startsWith("-tw-"));
  if (r !== -1) {
    const i = e[r].slice(4);
...
function Nl(t, e) {
  ...
  const r = ua(t);
  if (r[0] !== "tw") return t;
  const o = r.slice(1, -1), n = r[r.length - 1], i = ua(e), s = i.some((c) => c.startsWith("-tw-")), l = i.some((c) => c.startsWith("!tw-"));
  if (s && n.startsWith("-")) {
    const c = n.slice(1);
    return [...o, `-tw-${c}`].join(":");
  }
...
function f(...t) {
  const e = ci(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return kl(e);
  const r = e.split(" ").filter(Boolean), o = /* @__PURE__ */ new Map(), n = [];
  return r.forEach((c) => {
    const d = _l(c);
    o.set(d.normalized, d.original), n.push(d.normalized);
  }), wi(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const d = o.get(c);
    return d ? Nl(c, d) : c;
  }).join(" ");
}
const Ye = 250, nn = 300, Cl = 400, El = 450, zl = 500, sn = Zt(
...
function lr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u($l, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        Me.Input,
        {
      ...
      /* @__PURE__ */ a(Al, { children: /* @__PURE__ */ a(hi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const un = ct.allBookIds.filter(
  (t) => !ct.isObsolete(ct.bookIdToNumber(t))
), Re = Object.fromEntries(
  un.map((t) => [t, ct.bookIdToEnglishName(t)])
);
function Da(t, e, r) {
...
function pa(t, e, r) {
  return `${t} ${Re[t]}${e ? ` ${Sa(t, e)} ${Ve(t, e)}` : ""}${r ? ` ${r}` : ""}`;
}
function Vl({
  recentSearches: t,
...
function Iu({
  ...
  const d = lt(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, N] = T("books"), [x, _] = T(void 0), [k, $] = T(!1), V = q(void 0), A = q(void 0), C = q(void 0), z = q(void 0), E = q({}), O = j(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
  ...
  }), [D]), I = P(() => Object.values(F).flat(), [F]), G = P(() => {
    if (!m.trim()) return F;
    const M = {
      [W.OT]: [],
      [W.NT]: [],
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: H, isDigit: Z } = no(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
          M.preventDefault(), M.stopPropagation(), Tt();
          return;
        }
        if (H || Z) {
          if (M.preventDefault(), M.stopPropagation(), N("books"), _(void 0), Z && x) {
            const wt = Re[x];
            b(`${wt} ${M.key}`);
          } else
            b(M.key);
      ...
      if ((v === "chapters" || v === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        ...
        R !== ot && (M.preventDefault(), M.stopPropagation(), p(pa(wt, n, R)), setTimeout(() => {
    ...
    const { isLetter: H, isDigit: Z } = no(M.key);
    (H || Z) && (M.preventDefault(), b((wt) => wt + M.key), A.current.focus(), $(!1));
  }, []);
  return $t(() => {
    const M = setTimeout(() => {
      if (w && v === "books" && C.current && z.current) {
        const H = C.current, Z = z.current, wt = Z.offsetTop, ot = H.clientHeight, St = Z.clientHeight, R = wt - ot / 2 + St / 2;
        H.scrollTo({
          top: Math.max(0, R),
          behavior: "smooth"
        }), p(pa(t.book));
      ...
      Ne,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ee.map(({ onClick: M, disabled: H, title: Z, icon: wt }) => /* @__PURE__ */ a(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ a(
              L,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a(Oi, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ai, { className: "tw:h-4 tw:w-4" })
              }
            ),
          ...
          !k && /* @__PURE__ */ u(Ce, { ref: C, children: [
            v === "books" && /* @__PURE__ */ u(et, { children: [
              !y && Object.entries(G).map(([M, H]) => {
                if (H.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ a(Yt, { heading: ge(M), children: H.map((Z) => /* @__PURE__ */ a(
                      pn,
                      {
                        bookId: Z,
                        onSelect: (wt) => ft(wt),
              ...
              y && /* @__PURE__ */ a(Yt, { children: /* @__PURE__ */ a(
                de,
                {
                  ...
                  children: De(
                    ...
                    n ? Sa(y.book, n) : void 0
                  )
                },
                "top-match"
              ) }),
              y && qt(y.book) > 1 && /* @__PURE__ */ u(et, { children: [
...
function _r({
  ...
  const [_, k] = T(!1), $ = d ?? c, V = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
...
function Kl({
  ...
  return /* @__PURE__ */ u(et, { children: [
    /* @__PURE__ */ a(ht, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ a(
      _r,
      {
        isDisabled: n,
    ...
    /* @__PURE__ */ a(ht, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ a(
      _r,
      {
        isDisabled: n,
...
function Vu({
  ...
  const w = Kr(d, "%webView_bookSelector_currentBook%"), g = Kr(d, "%webView_bookSelector_choose%"), h = Kr(d, "%webView_bookSelector_chooseBooks%"), [p, m] = T(
    "current book"
    /* CurrentBook */
  ), b = (v) => {
    m(v), t(v);
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_25%_50%]", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(ht, { className: "tw:ms-1", children: w })
          ] }),
          /* @__PURE__ */ a(ht, { className: "tw:flex tw:items-center", children: e }),
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(ht, { className: "tw:ms-1", children: h })
          ] }),
          /* @__PURE__ */ a(ht, { className: "tw:flex tw:items-center", children: o.map((v) => ct.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            L,
            {
...
const fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ql = fn ? $t : K, pr = { tag: Ca };
function Hl({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: c } = t, d = Gl(null, o), w = Fo({ editable: t.editable, html: c, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
        if (h === void 0) g.update(() => {
          ...
          if (p.isEmpty()) {
            const m = We();
            p.append(m);
            const b = fn ? document.activeElement : null;
...
const Wl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Yl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return Wl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(Ca) || l.isEmpty() || r(n, o, c);
    });
  }, [o, t, e, r]), null;
}
const Ra = {
...
function Ql({ children: t, onError: e }) {
...
const tc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function ec(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function rc() {
  return function(t) {
    const [e] = Qt(), r = P(() => t(e), [e, t]), [o, n] = T(() => r.initialValueFn()), i = q(o);
    return tc(() => {
...
const mn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, nc = mn && "documentMode" in document ? document.documentMode : null;
!(!mn || !("InputEvent" in window) || nc) && "getTargetRanges" in new window.InputEvent("input");
function Gt(t) {
  return `${t}px`;
}
...
function sc(t, e, r) {
  ...
  function c() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = ac(t, e);
    var m, b;
...
function cc(t, e = lc) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, N = p.getNode(), x = N.getKey(), _ = p.offset, k = t.getElementByKey(b), $ = t.getElementByKey(x), V = r === null || k !== o || v !== n || b !== r.getKey(), A = i === null || $ !== s || _ !== l || x !== i.getKey();
      if ((V || A) && k !== null && $ !== null) {
        const C = function(z, E, O, D, F, I, G) {
          const y = (z._window ? z._window.document : document).createRange();
          return y.setStart(...so(E, O, D)), y.setEnd(...so(F, I, G)), y;
        }(t, h, m, k, p, N, $);
        c(), c = sc(t, C, e);
      }
      r = m, o = k, n = v, i = N, s = $, l = _;
    });
  }
...
function dc(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = cc(t, e));
  };
...
function wc(t) {
  const e = Go(t, (r) => ie(r) && !r.isInline());
  return ie(e) || Nr(4, t.__key), e;
}
function uc(t) {
  const e = zt() || bs();
  let r;
  if (Wt(e)) r = xs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (r = Ko(l, "next"));
    }
    r = r || ys(le(), "previous").getFlipped().insert(We());
  }
  const o = pc(t, r), n = ks(o), i = _s(n) ? Ns(n) : o;
  return Cs(Es(i)), t.getLatest();
}
function pc(t, e, r) {
  let o = Qa(e, "next");
  for (let n = o; n; n = zs(n, r)) o = n;
  return Ts(o) && Nr(283), o.insert(t.isInline() ? We().append(t) : t), Qa(Ko(t.getLatest(), "next"), e.direction);
}
function gc(t) {
  const e = zt();
  if (!Wt(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const l = Go(i, (d) => ie(d) && !d.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
function Ar() {
  ...
  for (!function() {
    ...
    for (er = void 0, Er++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && vn(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
let Cr, se = 0, Er = 0, mc = 0, fa = 0, vr = 0;
function co(t) {
  if (X === void 0) return;
  let e = t.n;
...
function Te(t, e) {
  Nt.call(this, void 0), this.x = t, this.s = void 0, this.g = vr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function vc(t, e) {
  return new Te(t, e);
}
...
function bc(t) {
  ...
  bn(this), X = t, this.f &= -2, 8 & this.f && $a(this), Ar();
}
function Pe(t, e) {
...
Nt.prototype.brand = hc, Nt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      se !== 0 && Er === 0 && e.l !== fa && (e.l = fa, Cr = { S: e, v: e.v, i: e.i, o: Cr });
    })(this), this.v = t, this.i++, vr++, se++;
    try {
  ...
  if (this.g = vr, this.f |= 1, this.i > 0 && !vn(this)) return this.f &= -2, !0;
  const t = X;
  try {
    wo(this), X = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, xn(this), wo(this), se++;
  const t = X;
  return X = this, bc.bind(this, t);
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $onClear: yn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Xt(() => kn(t, o.value));
} });
function xc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const qr = Rs("format", { parse: (t) => typeof t == "number" ? t : 0 });
class _n extends ca {
  $config() {
    return this.config("decorator-text", { extends: ca, stateConfigs: [{ flat: !0, stateConfig: qr }] });
  }
  getFormat() {
    return Us(this, qr);
  }
...
Lt({ name: "@lexical/extension/DecoratorText", nodes: () => [_n], register: (t, e, r) => t.registerCommand(Wo, (o) => {
  const n = zt();
  if (Yo(n) || Wt(n)) for (const i of n.getNodes()) yc(i) && i.toggleFormat(o);
  return !1;
}, Xo) });
function Nn(t, e) {
  let r;
...
const ma = Lt({ build: (t) => Nn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function Cn(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = Cn(r[n], o[n]);
    return t;
  }
  return e;
}
const Oa = 0, va = 1, En = 2, Hr = 3, gr = 4, Ie = 5, Wr = 6, Je = 7;
function Yr(t) {
  return t.id === Oa;
}
function zn(t) {
...
function kc(t) {
  return function(e) {
    return e.id === va;
  }(t) || Q(305, String(t.id), String(va)), Object.assign(t, { id: En });
}
...
class Nc {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(l, c, d) {
      return Object.assign(l, { config: c, id: Hr, registerState: d });
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Wr && Q(310, String(r.id), String(Wr)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Hr;
    }(e) || Q(314, String(e.id), String(Hr)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const Ec = Lt({ config: Oe({ setOptions: uo, updateOptions: uo }), init: ({ $initialEditorState: t = Cc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (As(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [Ms, Uo, $s, Os, Bo] }), po = Symbol.for("@lexical/extension/LexicalBuilder");
function go() {
}
function zc(t) {
  throw t;
...
class je {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Xr, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[po];
    return r && (r.PACKAGE_VERSION !== Xr && Q(292, r.PACKAGE_VERSION, Xr), r instanceof je || Q(293)), r;
  }
  static fromEditor(e) {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && Q(298, o.name), !n) {
      n = new Nc(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var l;
      Yr(i) || Q(300, s, n || "[unknown]"), Yr(l = i) || Q(304, String(l.id), String(Oa)), i = Object.assign(l, { id: va }), o.state = i;
      const c = this.outgoingConfigEdges.get(s);
      if (c) for (const d of c.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = kc(i), o.state = i, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = zc), e;
  }
}
const Tc = /* @__PURE__ */ new Set(), ho = Lt({ build(t, e, r) {
  const o = r.getDependency(ma).output, n = ar({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Nn(() => {
  }, () => Xt(() => {
...
Lt({ dependencies: [ma, ho], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(ho).output, n = ar({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ce(t.registerCommand(Sc, (s) => {
    const l = zt();
    if (!Wt(l)) return !1;
    ...
    return !0;
  }, Ea), t.registerCommand(Ps, (s) => {
    if (Ls(s.target)) {
      const l = Vs(s.target);
      if (Rc(l)) return function(c, d = !1) {
        const w = zt(), g = c.isSelected(), h = c.getKey();
        let p;
        d && Yo(w) ? p = w : (p = js(), Fs(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Xo), t.registerMutationListener(Fe, (s, l) => {
    fc(() => {
      let c = !1;
...
function Mc(t, e, r = Tn) {
  return ce(t.registerCommand(Ys, (o) => {
    const n = zt();
    if (!Wt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => yr(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), g = wc(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Xs();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = Js(p), p.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Zs : eo : Qs;
    return t.dispatchCommand(i, void 0);
  }, Ea), t.registerCommand(eo, () => {
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: Tn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Xt(() => {
    if (!o.value) return Mc(t, n, i);
  });
} });
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Xt(() => r.getOutput().disabled.value ? void 0 : Dn(t)) });
function Pc(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Lc({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    ...
    return Ia(() => r.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = a(o, { onError: (h) => r._onError(h), children: a(hs, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(dl(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
}
function Vc({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    const o = je.maybeFromEditor(r);
    if (o && o.hasExtensionByName($c.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Pc(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Lc, { editor: t, ErrorBoundary: e });
}
function fo(t) {
  return t.getEditorState().read(Sn(t.isComposing()));
}
function jc({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Qt();
  return function(n) {
    Ia(() => ce(ll(n), Dn(n)), [n]);
  }(o), u(et, { children: [t, a(Fc, { content: e }), a(Vc, { editor: o, ErrorBoundary: r })] });
}
...
const Uc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Kc({ onClear: t }) {
  const [e] = Qt();
  return Uc(() => kn(e, t), [e, t]), null;
}
const Rn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Gc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: N = !0, style: x, tabIndex: _, "data-testid": k, ...$ }, V) {
  ...
  return Rn(() => (C(t.isEditable()), t.registerEditableListener((O) => {
    C(O);
...
function Wc(t, e) {
  ...
  return u(et, { children: [a(qc, { editor: n, ...o, ref: e }), r != null && a(Yc, { editor: n, content: r })] });
}
function Yc({ content: t, editor: e }) {
  ...
  if ($t(() => (n(e.isEditable()), e.registerEditableListener((s) => {
    n(s);
  })), [e]), !r) return null;
  let i = null;
...
function Jc({
  ...
  return /* @__PURE__ */ a(Mn.Provider, { value: s, children: i });
}
function $n() {
  const t = Na(Mn);
  if (!t)
...
function Zc() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Sl, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ml, { children: [
...
function Qc({
  ...
  const [e] = Qt(), [r, o] = T(e), [n, i] = T("paragraph"), [s, l] = Zc(), c = () => {
  };
...
function rd() {
  ...
  return td(o), /* @__PURE__ */ a(
    An,
    {
      ...
      variant: "outline",
      size: "sm",
      children: vo.map(({ format: n, icon: i, label: s }) => /* @__PURE__ */ a(
        br,
        {
          value: n,
          "aria-label": s,
...
function od({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Qc, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(rd, {}) }) }),
      ...
      /* @__PURE__ */ a(
        jc,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Xc, { placeholder: t }) }),
          ErrorBoundary: Ql
        }
      ),
      e && /* @__PURE__ */ a(Bc, { defaultSelection: "rootEnd" }),
...
function id(t, e) {
  const r = al(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
  for (const i of r) if (!Pn.has(i.nodeName)) {
    const s = Ln(i, t, n, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
...
function In(t, e, r, o = null) {
  let n = o === null || e.isSelected(o);
  const i = ie(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && kr(e) && (s = oc(o, e, "clone"));
  const l = ie(s) ? s.getChildren() : [], c = rl(t, s.getType());
  let d;
...
const Pn = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Ln(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (Pn.has(t.nodeName)) return s;
  let l = null;
  ...
  let h = [];
  const p = (l == null || !ol(l)) && (l != null && yr(l) || o);
  for (let m = 0; m < g.length; m++) h.push(...Ln(g[m], e, r, p, new Map(n), l));
  return w != null && (h = w(h)), ao(t) && (h = ld(t, h, p ? () => {
    const m = new Qo();
    return r.push(m), m;
  } : We)), l == null ? h.length > 0 ? s = s.concat(h) : ao(t) && function(m) {
    return m.nextSibling == null || m.previousSibling == null ? !1 : oo(m.nextSibling) && oo(m.previousSibling);
  }(t) && (s = s.concat(tn())) : ie(l) && l.append(...h), s;
}
function ld(t, e, r) {
...
function jn(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : jn(e.children)
  ) : !1;
}
function Mt(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? jn(t.root.children) : !1;
}
function cd(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = id(e, n);
      le().clear(), nl(i);
    },
    {
      discrete: !0
...
function Un({
  ...
  const s = bo(o, "%cancelButton_tooltip%"), l = i ?? bo(o, "%acceptButton_tooltip%");
...
function Fu({
  ...
  const [i, s] = T(wd), [l, c] = T(n), [d, w] = T(!1), g = q(void 0), h = q(null);
  K(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
      ...
      /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(
        L,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: Jr(l !== void 0 ? l : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        ue,
        {
          ...
          children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: t.map((v) => /* @__PURE__ */ a(
            de,
            {
              ...
              children: /* @__PURE__ */ a("span", { children: Jr(v, o) })
            },
            v || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : Va(v) && (v.preventDefault(), v.stopPropagation(), Mt(i) && p());
        },
        onKeyDown: (v) => {
...
const Bu = Object.freeze([
...
], ud = ["input", "select", "textarea", "button"], pd = ["button", "textbox"], gd = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
  ...
  const n = q(null), [i, s] = T(void 0), [l, c] = T(void 0), d = j(
    ...
    if (p.isContentEditable || ud.includes(m)) return !0;
    const b = p.getAttribute("role");
    if (b && pd.includes(b)) return !0;
    ...
    (p) => {
      ...
      switch (p.key) {
        case "ArrowDown":
          $ = Math.min(k + 1, t.length - 1), p.preventDefault();
          break;
        case "ArrowUp":
          $ = Math.max(k - 1, 0), p.preventDefault();
          break;
        case "Home":
          $ = 0, p.preventDefault();
          break;
        case "End":
          $ = t.length - 1, p.preventDefault();
          break;
        case " ":
        case "Enter":
      ...
      children: [
        /* @__PURE__ */ a(
          "span",
          {
            ...
            children: /* @__PURE__ */ a(vt.ItemIndicator, { children: /* @__PURE__ */ a($e, {}) })
          }
        ),
        e
      ]
...
function Cd({ className: t, children: e, ...r }) {
  const o = lt();
  return /* @__PURE__ */ a(
    vt.SubContent,
    {
...
function xo({
  ...
  }, [t.date, r]), v = P(() => t.user, [t.user]), N = P(
    () => t.user.split(" ").map((k) => k[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), x = P(() => Ti(t.contents), [t.contents]), _ = P(() => {
    if (o && l)
      return /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ u(
          ba,
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(cd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(vd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(bd, { className: "tw:text-xs tw:font-medium", children: N }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), p()) : Va(k) && (k.preventDefault(), k.stopPropagation(), Mt(w) && m());
              },
              onKeyDown: (k) => {
                Pa(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
        ...
        _ && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ji, {}) }) }),
...
function Ed({
  ...
  const [C, z] = T(yo), [E, O] = T(), [D, F] = T(), I = o, [G, y] = T(!1), [Y, ft] = T(!1), [nt, te] = T(!1), [ee, Tt] = T(!1), [U, it] = T(!1), [at, dt] = T(k), [Et, ge] = T(!1), xt = q(void 0), [he, re] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
      const gt = x ? await x(c) : !1;
      S && it(gt);
    })(), () => {
      S = !1;
    };
  ...
  const Vt = P(() => e.filter((S) => !S.deleted), [e]);
  K(() => {
    let S = !0;
    if (!o || !_) {
      re(/* @__PURE__ */ new Map());
  ...
  const ae = P(() => Vt[0], [Vt]), M = q(null), H = q(void 0), Z = j(() => {
    var S;
    (S = H.current) == null || S.call(H), z(yo);
  }, []), wt = j(() => {
    const S = !at;
  ...
  }, [i, r]), R = P(() => Vt.slice(1), [Vt]), B = P(() => R.length ?? 0, [R.length]), rt = P(() => B > 0, [B]), st = P(() => G || B <= 2 ? R : R.slice(-2), [R, B, G]), ut = P(() => G || B <= 2 ? 0 : B - 2, [B, G]), kt = P(
  ...
  const mt = j(
    async (S) => {
      ...
      pt && await g({ threadId: c, contents: pt }) && Z();
    },
    [
      Z,
      C,
    ...
    async (S) => {
      const pt = Mt(C) ? Tr(C) : void 0, gt = S.status ? S.assignedUser : E ?? S.assignedUser, jt = await g({
        ...S,
        contents: pt,
        assignedUser: gt
      });
      return jt && (gt !== void 0 && F(gt), pt && Z()), jt;
    },
    [Z, C, g, E]
  );
  if (Vt.length !== 0)
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                L,
                {
                  ...
                  children: at ? /* @__PURE__ */ a(Fi, {}) : /* @__PURE__ */ a(Bi, {})
                }
              ),
            ...
            o && /* @__PURE__ */ u(et, { children: [
              ...
              v !== !1 && (!Y || Mt(C)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (S) => {
                    Va(S) && (S.preventDefault(), S.stopPropagation(), (Mt(C) || E !== void 0 && E !== D) && mt());
                  },
                  onKeyDown: (S) => {
                    Pa(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      zr,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (Mt(C) || E !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: oe(
...
function Xu({
  ...
  const [N, x] = T(/* @__PURE__ */ new Set()), [_, k] = T(), [$, V] = T(), A = j(
    async (y) => {
      const Y = await i(y);
  ...
  const C = r.filter(
    ...
    (y) => {
      x((Y) => new Set(Y).add(y.id)), k(y.id), b == null || b(y.id);
    },
    [b]
  ), O = j(
    (y) => {
      ...
      }), k(y), b == null || b(Y ? void 0 : y);
    },
    [N, b]
  ), { listboxRef: D, activeId: F, handleKeyDown: I } = gd({
    options: z,
    onOptionSelect: E
  }), G = j(
    (y) => {
      y.key === "Escape" ? (_ && N.has(_) && (x((Y) => {
        const ft = new Set(Y);
        return ft.delete(_), ft;
      }), k(void 0), b == null || b(void 0)), y.preventDefault(), y.stopPropagation()) : I(y);
    },
    [_, N, I, b]
  );
  return /* @__PURE__ */ a(
...
function qe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ct.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ct.Icon, { asChild: !0, children: /* @__PURE__ */ a(vi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Ft({
  ...
  return /* @__PURE__ */ u(
    Ct.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ct.ItemIndicator, { children: /* @__PURE__ */ a($e, { className: "tw:pointer-events-none" }) }) }),
  ...
  const l = tt.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Ad(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Od(l, b, w.key);
...
function Id({
  ...
  var V;
  const [w, g] = T([]), [h, p] = T([]), [m, b] = T({}), [v, N] = T({}), x = P(() => e ?? [], [e]), _ = rn({
    data: x,
    columns: t,
    getCoreRowModel: on(),
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(xa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? $ = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ne,
    {
      onClick: () => s(A, _),
    ...
    A.id
  )) : $ = /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ a(ve, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(zd, { table: _ }),
    /* @__PURE__ */ u(Pr, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Fa, { stickyHeader: i, children: _.getHeaderGroups().map((A) => /* @__PURE__ */ a(ne, { children: A.headers.map((C) => /* @__PURE__ */ a(Sr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : tr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
      /* @__PURE__ */ a(Lr, { children: $ })
    ] }),
...
function ep({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(fl, { options: i, children: e })
    }
  );
}
...
function Ld({
  ...
  const n = _o(r, "%webView_error_dump_header%"), i = _o(r, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Ao, {}) })
        ] }),
...
function ap({
  ...
  return /* @__PURE__ */ u(we, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(ue, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
      s && r["%webView_error_dump_copied_message%"] && /* @__PURE__ */ a(ht, { children: r["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ a(
        Ld,
        {
          errorDetails: t,
...
function op({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(be, { children: [
    ...
    /* @__PURE__ */ a(ye, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Kn, { children: d.itemType === 0 ? /* @__PURE__ */ a(et, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        me,
        {
          checked: o[w][h],
        ...
        yd,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(kd, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(cr, {})
    ] }, d.label)) })
...
function jd({ id: t, versionHistory: e }) {
...
function ip({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(jd, { versionHistory: n }),
...
function Gn({
  ...
  const [N, x] = T(!1), _ = j(
    ...
    const E = t.filter((D) => D.starred).sort((D, F) => D.label.localeCompare(F.label)), O = t.filter((D) => !D.starred).sort((D, F) => {
      const I = e.includes(D.value), G = e.includes(F.value);
      return I && !G ? -1 : !I && G ? 1 : D.label.localeCompare(F.label);
    });
    return [...E, ...O];
  }, [t, e, h]), V = () => {
    r(t.map((E) => E.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(we, { open: C, onOpenChange: w ?? x, children: [
    ...
    /* @__PURE__ */ a(ue, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
      ...
      /* @__PURE__ */ u(Ce, { children: [
        ...
        /* @__PURE__ */ a(Yt, { children: $.map((E) => /* @__PURE__ */ u(
          de,
          {
            value: E.label,
            onSelect: _,
...
function Bd({
  ...
  const c = P(() => /Macintosh/i.test(navigator.userAgent), []), d = Co(n, "%undoButton_tooltip%"), w = Co(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(La, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
        L,
      ...
      /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(et, { children: [
          " ",
          /* @__PURE__ */ a(No, { children: c ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (l === "secondary" || l === "default") && /* @__PURE__ */ a(Fn, {}),
    e && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      ...
      /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(et, { children: [
          " ",
          /* @__PURE__ */ a(No, { children: c ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const Kd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(et, { children: [
...
function Gd({
  ...
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: Kd(t, n, r) }) }) }),
...
function Wd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: qd(t, r) }) }) }),
      /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ a("p", { children: Hd(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(ye, { style: { zIndex: nn }, children: [
...
function Xd({ icon: t, className: e }) {
...
function Eo({
  ...
  return /* @__PURE__ */ u(
    de,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Xd, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
...
function Jd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = T(""), [i, s] = P(() => {
...
function lp({
  ...
  const [m, b] = T("generated"), [v, N] = T("generated"), [x, _] = T("*"), [k, $] = T("*"), [V, A] = T("f"), [C, z] = T(!1), [E, O] = T(!0), [D, F] = T(!1), I = q(!1), G = q(""), [y, Y] = T(!1), [ft, nt] = T(), [te, ee] = T(), [Tt, U] = T(), [it, at] = T(), dt = q(null), Et = P(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...s.view ?? ml(), noteMode: "expanded" }
    }),
    [s, l]
  ), ge = P(
    () => Zd(
  ...
  K(() => {
    ...
    if (B && ur("note", B)) {
      ...
      let kt = "custom";
      ut === da ? kt = "generated" : ut === wa ? kt = "hidden" : ut && (_(ut), $(ut)), b(kt), N(kt), A(((st = B.insert.note) == null ? void 0 : st.style) ?? "f"), R = setTimeout(() => {
        var Dt;
  ...
  const xt = j(
    (R, B, rt = !1) => {
      ...
      if (st && ur("note", st)) {
        if (st.insert.note) {
          let mt;
          R === "custom" ? mt = B : R === "generated" ? mt = da : mt = wa, st.insert.note.caller = mt;
        }
  ...
  const Vt = () => {
    ...
    if (B && ur("note", B)) {
      ...
      V !== "x" && R === "x" ? mt == null || mt.forEach((Rt) => Qd(Rt)) : V === "x" && R !== "x" && (mt == null || mt.forEach((Rt) => tw(Rt))), (Dt = w.current) == null || Dt.applyUpdate([B, { delete: 1 }]);
    }
  }, Z = (R) => {
      ...
      if (B && ur("note", B)) {
        ...
        if (mt || z(!1), z(
          mt === "x" ? !!(Rt != null && Rt.every((S) => {
            var gt, jt;
            if (!((gt = S.attributes) != null && gt.char)) return !0;
            const pt = ((jt = S.attributes) == null ? void 0 : jt.char).style;
          ...
          I.current = !0, G.current = JSON.stringify(B), O(!0);
          return;
        }
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ a(et, { children: rw(t.marker, l, o, d) })
      }
    )
  ] });
}
...
function iw({
  ...
  return /* @__PURE__ */ u(Pr, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Fa, { stickyHeader: !0, children: /* @__PURE__ */ u(ne, { children: [
    ...
    /* @__PURE__ */ a(Lr, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ve, { className: o, children: nw(l.text) })
        ]
      },
...
const sw = (t) => {
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ u(An, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
      /* @__PURE__ */ a(
        br,
        {
          onClick: (c) => {
            c.stopPropagation(), Zr(
              [l],
              "approved",
              e,
              r,
  ...
  return e ? e[1] : "";
}, cw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", mp = Object.freeze([
...
function vp({
  ...
  const p = Ut(r, "%webView_inventory_all%"), m = Ut(r, "%webView_inventory_approved%"), b = Ut(r, "%webView_inventory_unapproved%"), v = Ut(r, "%webView_inventory_unknown%"), N = Ut(r, "%webView_inventory_scope_currentBook%"), x = Ut(r, "%webView_inventory_scope_chapter%"), _ = Ut(r, "%webView_inventory_scope_verse%"), k = Ut(r, "%webView_inventory_filter_text%"), $ = Ut(
    r,
    "%webView_inventory_show_additional_items%"
  ), V = Ut(r, "%webView_inventory_no_results%"), [A, C] = T(!1), [z, E] = T("all"), [O, D] = T(""), [F, I] = T([]), G = P(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : ww(U, n, i);
  }, [t, n, i]), y = P(() => {
    if (A) return G;
    const U = [];
    return G.forEach((it) => {
  ...
  }, [A, G]), Y = P(() => y.length === 0 ? [] : dw(y, z, O), [y, z, O]), ft = P(() => {
    var at, dt;
    if (!A) return c;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(Ke, { onValueChange: (U) => te(U), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(He, { children: [
          /* @__PURE__ */ a(Ft, { value: "book", children: N }),
          /* @__PURE__ */ a(Ft, { value: "chapter", children: x }),
          /* @__PURE__ */ a(Ft, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ a(
        sr,
      ...
      o && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
        /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(ht, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? $ })
        ] }) }),
        /* @__PURE__ */ a(Pt, { children: (o == null ? void 0 : o.checkboxText) ?? $ })
      ] }) })
    ] }),
...
function bp({
  ...
  const c = [];
  e.length > 0 && c.push({
    groupHeading: i.recentProjectsHeading ?? "Recent",
    options: e.map(Qr)
  }), r.length > 0 && c.push({
    groupHeading: i.allProjectsHeading ?? "All projects",
    options: r.map(Qr)
  });
  const d = t ? Qr(t) : void 0;
  return /* @__PURE__ */ a(
    _r,
    {
      options: c,
      value: d,
      onChange: (w) => o(w.projectId),
      getOptionLabel: (w) => w.label,
      buttonPlaceholder: n ? i.loadingPlaceholder ?? "..." : i.selectPlaceholder ?? "Select project",
      textPlaceholder: i.searchPlaceholder ?? "Search projects...",
      commandEmptyMessage: i.noResultsMessage ?? "No projects found",
      buttonClassName: l,
      ariaLabel: s,
      isDisabled: n
    }
...
const Wn = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(cs, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function ta({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(et, { children: [
      /* @__PURE__ */ a(ht, { className: "tw:text-xs tw:uppercase tw:tracking-wider tw:text-muted-foreground", children: t }),
...
function yp({
  ...
  const [s, l] = T(""), [c, d] = T([]), w = P(
    () => t.filter((I) => !r || I.type === r).filter((I) => pw(I, s)).filter(
      (I) => c.length === 0 || c.includes(I.bestLanguageName)
    ),
    [t, r, s, c]
  ), g = P(
    () => w.filter((I) => o == null ? void 0 : o.includes(I.dblEntryUid)),
    [w, o]
  ), h = P(
    () => w.filter((I) => I.installed && !(o != null && o.includes(I.dblEntryUid))),
    [w, o]
  ), p = P(
    () => w.filter(
      (I) => !I.installed && !(o != null && o.includes(I.dblEntryUid))
    ),
    [w, o]
  ), { visibleItems: m, sentinelRef: b, hasMore: v } = uw(p), N = P(
    () => Array.from(new Set(t.map((I) => I.bestLanguageName))).map((I) => ({
      label: I,
      value: I
    })),
    [t]
  ), x = g.length === 0 && h.length === 0 && p.length === 0, _ = Kt(n, "%resourcePicker_title%"), k = Kt(n, "%resourcePicker_search_placeholder%"), $ = Kt(n, "%resourcePicker_language_filter_any%"), V = Kt(
    n,
    "%resourcePicker_section_already_selected%"
  ), A = Kt(n, "%resourcePicker_section_installed%"), C = Kt(
    n,
    "%resourcePicker_section_available_to_download%"
  ), z = Kt(n, "%resourcePicker_button_use%"), E = Kt(n, "%resourcePicker_no_results%"), O = Kt(n, "%resourcePicker_showing_count%"), D = P(() => {
    if (c.length === N.length || c.length === 0)
      return $;
    if (c.length === 1) {
      const I = N.find((G) => G.value === c[0]);
      if (I) return I.label;
    }
    return oe(
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(Wn, {}) }),
      !x && !e && /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ a(ta, { label: V, resources: g }),
        /* @__PURE__ */ a(
          ta,
          {
            label: A,
...
const gw = "16rem", hw = "3rem", Yn = tt.createContext(void 0);
function Fr() {
  const t = tt.useContext(Yn);
  if (!t)
...
function fw({
  ...
  const [c, d] = tt.useState(t), w = e ?? c, g = tt.useCallback(
    ...
    [r, w]
  ), h = tt.useCallback(() => g((_) => !_), [g]), p = w ? "expanded" : "collapsed", v = lt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = tt.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
  ...
  return /* @__PURE__ */ a(Yn.Provider, { value: N, children: /* @__PURE__ */ a(
    "div",
    {
...
function kp({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = Fr();
  return /* @__PURE__ */ u(
    L,
    {
...
function _w({
  ...
  const l = t ? ke.Root : "button", { state: c } = Fr(), d = /* @__PURE__ */ a(
    l,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(kw({ variant: r, size: o }), i),
      ...s
    }
  );
...
function Rp({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      ...r,
      children: [
        e && /* @__PURE__ */ a(xa, { className: "tw:size-4 tw:rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ a(
          xa,
          {
...
function Nw({
  ...
  return /* @__PURE__ */ a(
    mw,
    {
      ...
      children: /* @__PURE__ */ u(bw, { children: [
        /* @__PURE__ */ u(zo, { children: [
          /* @__PURE__ */ a(To, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(So, { children: /* @__PURE__ */ a(xw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(yw, { children: /* @__PURE__ */ a(
            _w,
            {
              onClick: () => d(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ u(zo, { children: [
          /* @__PURE__ */ a(To, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(So, { className: "tw:pl-3", children: /* @__PURE__ */ a(
            _r,
            {
              buttonVariant: "ghost",
...
const fe = "scrBook", Cw = "scrRef", Se = "source", Ew = "details", zw = "Scripture Reference", Tw = "Scripture Book", Xn = "Type", Sw = "Details";
function Dw(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: Se,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? Xn : void 0,
    ...
    },
    {
      ...
      id: Ew,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Sw,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, Do = (t) => `${Rw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ip({
  sources: t,
  ...
  K(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const O = b.find((D) => Do(D) === E[0]) || void 0;
        O && l(O);
      }
    }
  }, [p, b, l, N]);
  const x = n ?? Tw, _ = i ?? Xn, k = [
    ...
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(Td, { children: k.map((z) => /* @__PURE__ */ a(Ft, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Pr, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Fa, { children: N.getHeaderGroups().map((z) => /* @__PURE__ */ a(ne, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
      ...
      /* @__PURE__ */ a(Lr, { children: N.getRowModel().rows.map((z, E) => {
        const O = lt();
        return /* @__PURE__ */ a(
          ne,
          {
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ a(sa, {}) : /* @__PURE__ */ a(ia, {})),
                          " ",
...
const Zn = (t, e, r) => Ua(t, e).every((o) => r.includes(o));
function Mw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: g, ntLong: h, dcLong: p, extraLong: m } = {
  ...
  }, [b, v] = T(!1), [N, x] = T(""), _ = q(void 0), k = q(!1), $ = P(
    () => Jn(t),
    [t]
  ), V = P(() => {
    if (!N.trim()) {
    ...
    (D, F = !1) => {
      ...
      const I = $.findIndex((nt) => nt === _.current), G = $.findIndex((nt) => nt === D);
      if (I === -1 || G === -1) return;
      const [y, Y] = [
        Math.min(I, G),
        Math.max(I, G)
      ], ft = $.slice(y, Y + 1).map((nt) => nt);
      r(
                ...
                Object.values(W).map((D, F) => {
                  ...
                  if (I.length !== 0)
                    return /* @__PURE__ */ u(jo, { children: [
                      ...
                      F < Object.values(W).length - 1 && /* @__PURE__ */ a(dn, {})
                    ] }, D);
                })
              ] })
            ]
...
function Ow({
  ...
  const i = o["%webView_book_selector_more%"], s = P(
    ...
    (c) => {
      ...
      r(
        Zn(s, c, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
      ...
      /* @__PURE__ */ a(
        gn,
        {
          ...
          children: N.map(({ value: x, label: _, id: k }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ga, { className: "tw:me-2", value: x, id: k }),
            /* @__PURE__ */ a(ht, { htmlFor: k, children: _ })
          ] }, k))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(ht, { children: b }),
      /* @__PURE__ */ a(
        Ow,
        {
          availableBookInfo: o,
...
const ti = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ u(_d, { children: [
    /* @__PURE__ */ a(Nd, { children: l.label }),
    /* @__PURE__ */ a(xd, { children: /* @__PURE__ */ a(Cd, { children: ti(
      t,
      e,
      Qn(t, l.id),
      o
...
function ya({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(L, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ws, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(jo, { children: [
      /* @__PURE__ */ a(Kn, { children: /* @__PURE__ */ a(Ot, { children: ti(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(cr, {})
    ] }, c)) })
  ] });
}
const ei = tt.forwardRef(
...
const ri = tt.forwardRef(({ className: t, ...e }, r) => {
  const o = lt();
  return /* @__PURE__ */ a(
    Bt.Root,
    {
...
ri.displayName = Bt.List.displayName;
const ai = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.List,
  {
    ref: r,
    className: f(
...
const Iw = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.Trigger,
  {
    ref: r,
    ...e,
...
)), oi = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.Content,
  {
    ref: r,
    className: f(
...
oi.displayName = Bt.Content.displayName;
function Gp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ri, { children: [
      /* @__PURE__ */ a(ai, { children: t.map((l) => /* @__PURE__ */ a(Iw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ a(oi, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Pw({
...
function Fw({
  ...
  const i = pe();
  return /* @__PURE__ */ a(Vw, { children: /* @__PURE__ */ a(
    Jt.Content,
    {
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    ...
    return l.length > 0 && s < n.length - 1 && c.push(/* @__PURE__ */ a(Uw, {}, `separator-${i}`)), c;
  });
};
function Hw({
  menuData: t,
  ...
  if (bl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, N;
    w.preventDefault();
    ...
    return /* @__PURE__ */ a(Pw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(Lw, { children: [
      /* @__PURE__ */ a(jw, { ref: d(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        Fw,
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Ot, { children: ni(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Wp({
  ...
  const d = Ww(
    ...
    return v ? `${($ = t[m]) == null ? void 0 : $.autonym} (${v})` : (V = t[m]) == null ? void 0 : V.autonym;
  };
  return /* @__PURE__ */ u("div", { id: c, className: f("pr-twp tw:max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(ht, { className: "tw:font-normal tw:text-muted-foreground", children: oe(d, {
      fallbackLanguages: (r == null ? void 0 : r.length) > 0 ? r.map((m) => p(m, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function Yw({ item: t, createLabel: e, createComplexLabel: r }) {
  return e ? /* @__PURE__ */ a(ht, { children: e(t) }) : r ? /* @__PURE__ */ a(ht, { children: r(t) }) : /* @__PURE__ */ a(ht, { children: t });
}
function Yp({
  id: t,
  className: e,
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(be, { children: [
              /* @__PURE__ */ a(xe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(L, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ja, {}) }) }),
...
function wg({
  ...
  return /* @__PURE__ */ u(
    bt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(bt.ItemIndicator, { children: /* @__PURE__ */ a($e, {}) }) }),
        e
      ]
    }
  );
...
function bg({
  ...
  const n = lt();
  return /* @__PURE__ */ u(Jw, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Zw, {}),
    /* @__PURE__ */ u(
      _e.Content,
      {
...
export {
  ...
  Bn as CANCEL_ACCEPT_BUTTONS_STRING_KEYS,
  Bu as COMMENT_EDITOR_STRING_KEYS,
  Uu as COMMENT_LIST_STRING_KEYS,
  Un as CancelAcceptButtons,
  fd as Card,
  md as CardContent,
  qu as CardDescription,
  Hu as CardFooter,
  Ku as CardHeader,
  Gu as CardTitle,
  ...
  Aw as SELECT_BOOKS_STRING_KEYS,
  Lp as ScopeSelector,
  ...
  Ke as Select,
  Ow as SelectBooks,
  Mw as SelectBooksPicker,
  He as SelectContent,
  Td as SelectGroup,
  Ft as SelectItem,
  Ju as SelectLabel,
  Dd as SelectScrollDownButton,
  Sd as SelectScrollUpButton,
  ...
  Nw as SettingsSidebar,
  Ap as SettingsSidebarContentSearch,
  mw as Sidebar,
  bw as SidebarContent,
  Ep as SidebarFooter,
  zo as SidebarGroup,
  Tp as SidebarGroupAction,
  So as SidebarGroupContent,
