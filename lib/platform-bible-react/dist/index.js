...
var Rs = (t, e, n) => e in t ? Es(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var xt = (t, e, n) => Rs(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as wt } from "react/jsx-runtime";
import v, { forwardRef as fn, useRef as H, useMemo as z, useState as D, useCallback as B, useLayoutEffect as Vt, createContext as $n, useContext as Cr, useEffect as Y, Component as Ts, createElement as Xr, Suspense as Ss, Fragment as So } from "react";
import { Command as Tt } from "cmdk";
import { X as qe, Search as Do, Check as zt, Clock as Wr, ChevronsLeft as Jr, ChevronsRight as Zr, ChevronLeft as ar, ChevronRight as je, ArrowLeft as Ds, ArrowRight as Ms, Circle as Ln, ChevronDown as He, BoldIcon as Os, ItalicIcon as Is, AtSign as Mo, Pencil as As, Trash2 as Ps, ArrowUp as Oo, MoreHorizontal as $s, MailOpen as Ls, Mail as Vs, ChevronUp as Io, FilterIcon as js, ArrowLeftIcon as Fs, ChevronLeftIcon as zs, ChevronRightIcon as Bs, ArrowRightIcon as Ks, Copy as Ao, Filter as Us, User as Gs, Link as qs, CircleHelp as Hs, ChevronsUpDown as Po, Star as Ys, Undo as Xs, Redo as Ws, SquareX as $o, FunctionSquare as Lo, SquareSigma as Vo, Ban as Js, AlertCircle as sr, CircleCheckIcon as Zs, CircleXIcon as Qs, CircleHelpIcon as ti, ArrowUpIcon as ei, ArrowDownIcon as ni, PanelLeft as ri, PanelRight as oi, ScrollText as ai, MenuIcon as si, Menu as ii, EllipsisVertical as li, MoreVertical as Qr, LoaderCircle as ci, GripVertical as wi } from "lucide-react";
import { clsx as di } from "clsx";
import { extendTailwindMerge as pi } from "tailwind-merge";
import * as It from "@radix-ui/react-dialog";
import { Canon as pt } from "@sillsdev/scripture";
import { includes as bn, Section as X, getChaptersForBook as ui, formatScrRef as Ee, getSectionForBook as sn, formatRelativeDate as mi, formatReplacementString as Ce, sanitizeHtml as fi, NumberFormat as hi, formatBytes as gi, getCurrentLocale as bi, usfmMarkers as kn, getFormatCallerFunction as vi, deepEqual as xi, isString as to, compareScrRefs as ir, scrRefToBBBCCCVVV as Gn, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import * as jo from "@radix-ui/react-label";
import * as dn from "@radix-ui/react-radio-group";
import { createEditor as Fo, $getRoot as se, $createParagraphNode as Xe, $getSelection as Rt, HISTORY_MERGE_TAG as Er, ParagraphNode as zo, TextNode as Bo, $isTokenOrSegmented as yi, $getCharacterOffsets as Ni, $cloneWithPropertiesEphemeral as ki, $getPreviousSelection as _i, $isRangeSelection as Yt, $caretFromPoint as Ci, $getSiblingCaret as Ko, $getChildCaret as Ei, $getAdjacentChildCaret as Ri, $isChildCaret as Ti, $normalizeCaret as Si, $setSelectionFromCaretRange as Di, $getCollapsedCaretRange as Mi, $getCaretInDirection as eo, $splitAtPointCaretNext as Oi, $isTextPointCaret as Ii, $findMatchingParent as Uo, $isElementNode as re, mergeRegister as ie, getDOMTextNode as Ai, isHTMLElement as Go, CLEAR_EDITOR_COMMAND as qo, COMMAND_PRIORITY_EDITOR as Rr, shallowMergeConfig as Pi, defineExtension as jt, safeCast as Ie, createState as $i, FORMAT_TEXT_COMMAND as Ho, $isNodeSelection as Yo, COMMAND_PRIORITY_LOW as Xo, RootNode as Li, LineBreakNode as Vi, TabNode as ji, $isEditorState as Fi, createCommand as zi, CLICK_COMMAND as Bi, isDOMNode as Ki, $getNodeFromDOMNode as Ui, $createNodeSelection as Gi, $setSelection as qi, $getEditor as Hi, DecoratorNode as lr, $getState as Yi, toggleTextFormatType as no, TEXT_TYPE_TO_FORMAT as Xi, $setState as Wi, addClassNamesToElement as Wo, $create as Ji, $getNodeByKey as Zi, removeClassNamesFromElement as Qi, KEY_TAB_COMMAND as tl, $isBlockElementNode as En, $createRangeSelection as el, $normalizeSelection__EXPERIMENTAL as nl, OUTDENT_CONTENT_COMMAND as rl, INDENT_CONTENT_COMMAND as ro, INSERT_TAB_COMMAND as ol, COMMAND_PRIORITY_CRITICAL as Tr, $isDecoratorNode as al, $isParagraphNode as sl, $isTextNode as Rn, SELECTION_CHANGE_COMMAND as Jo, getRegisteredNode as il, isDocumentFragment as oo, isDOMDocumentNode as ll, ArtificialNode__DO_NOT_USE as Zo, $createLineBreakNode as Qo, $isRootOrShadowRoot as cl, isBlockDomNode as ao, isInlineDomNode as so, $insertNodes as wl } from "lexical";
import * as Se from "@radix-ui/react-tooltip";
import { TooltipTrigger as dl } from "@radix-ui/react-tooltip";
import { HeadingNode as pl, QuoteNode as ul, registerRichText as ml } from "@lexical/rich-text";
import { flushSync as fl, createPortal as hl } from "react-dom";
import { $isTableSelection as gl } from "@lexical/table";
import * as Vn from "@radix-ui/react-toggle-group";
...
import { useReactTable as ra, getFilteredRowModel as vl, getSortedRowModel as oa, getPaginationRowModel as xl, getCoreRowModel as aa, flexRender as ln, getGroupedRowModel as yl, getExpandedRowModel as Nl } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import kl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as cr, HIDDEN_NOTE_CALLER as wr, getDefaultViewOptions as _l, isInsertEmbedOpOfType as vn, Editorial as Cl } from "@eten-tech-foundation/platform-editor";
...
import * as pr from "@radix-ui/react-progress";
...
const Tl = pi({ prefix: "tw-" });
function h(...t) {
  return Tl(di(t));
}
const Je = 250, sa = 300, Sl = 400, Dl = 450, Ml = 500, Ol = "layoutDirection";
function ut() {
  const t = localStorage.getItem(Ol);
  return t === "rtl" ? t : "ltr";
}
const Il = It.Root, Jp = It.Trigger, Al = It.Portal, Zp = It.Close, ia = v.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  It.Overlay,
  {
    ref: o,
    className: h(
...
ia.displayName = It.Overlay.displayName;
const la = v.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, s) => {
  const i = ut();
...
la.displayName = It.Content.displayName;
...
wa.displayName = It.Title.displayName;
const $l = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  It.Description,
  {
    ref: n,
...
$l.displayName = It.Description.displayName;
...
const Ze = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(Do, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      Tt.Input,
      {
        ref: n,
...
Ze.displayName = Tt.Input.displayName;
...
const hn = v.forwardRef((t, e) => /* @__PURE__ */ r(Tt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
hn.displayName = Tt.Empty.displayName;
...
Dr.displayName = Tt.Separator.displayName;
...
da.displayName = "CommandShortcut";
const pa = (t, e, n, o, a) => {
  switch (t) {
    case X.OT:
...
const ua = pt.allBookIds.filter(
  (t) => !pt.isObsolete(pt.bookIdToNumber(t))
), Re = Object.fromEntries(
  ua.map((t) => [t, pt.bookIdToEnglishName(t)])
);
function Or(t, e, n) {
  const o = e.trim().toLowerCase();
  if (!o) return !1;
  const a = pt.bookIdToEnglishName(t), s = n == null ? void 0 : n.get(t);
  return !!(bn(a.toLowerCase(), o) || bn(t.toLowerCase(), o) || (s ? bn(s.localizedName.toLowerCase(), o) || bn(s.localizedId.toLowerCase(), o) : !1));
}
const ma = fn(
  ({
    bookId: t,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ye : "button", { className: h(fa({ variant: e, size: n, className: t })), ref: s, ...a })
);
F.displayName = "Button";
const de = Fe.Root, xe = Fe.Trigger, Vl = Fe.Anchor, Zt = v.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = ut();
  return /* @__PURE__ */ r(Fe.Portal, { children: /* @__PURE__ */ r(
    Fe.Content,
    {
      ref: s,
      align: e,
...
Zt.displayName = Fe.Content.displayName;
function mr(t, e, n) {
  return `${t} ${Re[t]}${e ? ` ${Mr(t, e)} ${Le(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function jl({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(de, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Zt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ r(we, { children: /* @__PURE__ */ r(Xt, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      Jt,
      {
        onSelect: () => f(u),
...
function Qp(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
      ...
      if (i) {
        ...
        if (!d && c) {
          const u = ((g) => Object.keys(Re).find(
            (y) => Re[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function lo({
  ...
  if (t)
    return /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Ht(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Jt,
      {
        value: `${t} ${Re[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function tu({
  ...
  const w = ut(), [d, m] = D(!1), [f, u] = D(""), [g, y] = D(""), [b, C] = D("books"), [x, _] = D(void 0), [k, $] = D(!1), j = H(void 0), A = H(void 0), E = H(void 0), S = H(void 0), T = H({}), P = B(
    (O) => {
      e(O), l && l(O);
    },
    [e, l]
  ), I = z(() => o ? o() : ua, [o]), q = z(() => ({
    [X.OT]: I.filter((R) => pt.isBookOT(R)),
    [X.NT]: I.filter((R) => pt.isBookNT(R)),
    [X.DC]: I.filter((R) => pt.isBookDC(R)),
    [X.Extra]: I.filter((R) => pt.extraBooks().includes(R))
  }), [I]), V = z(() => Object.values(q).flat(), [q]), W = z(() => {
    if (!g.trim()) return q;
    const O = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (O) => {
      const R = b === "chapters" ? x : N == null ? void 0 : N.book;
      R && (P({
        book: R,
        chapterNum: O,
        verseNum: 1
      }), m(!1), C("books"), _(void 0), y(""));
    },
    [P, b, x, N]
  ), Dt = B(
    (O) => {
    ...
    (O) => {
      ...
      m(O), O && (C("books"), _(void 0), y(""));
    },
    [b, _t]
  ), { otLong: ct, ntLong: Z, dcLong: ft, extraLong: vt } = {
    ...
    (O) => N ? !!N.chapterNum && !O.toString().includes(N.chapterNum.toString()) : !1,
    [N]
  ), Ae = z(
    () => Ee(
      t,
    ...
    (O) => {
      if (O.ctrlKey) return;
      const { isLetter: R, isDigit: L } = io(O.key);
      if (b === "chapters") {
        if (O.key === "Backspace") {
          O.preventDefault(), O.stopPropagation(), _t();
          return;
        }
        if (R || L) {
          if (O.preventDefault(), O.stopPropagation(), C("books"), _(void 0), L && x) {
            const J = Re[x];
            y(`${J} ${O.key}`);
          } else
            y(O.key);
      ...
      if ((b === "chapters" || b === "books" && N) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        const J = b === "chapters" ? x : N == null ? void 0 : N.book;
        if (!J) return;
        const G = (() => {
          if (!f) return 1;
          const lt = f.match(/(\d+)$/);
        ...
        et !== G && (O.preventDefault(), O.stopPropagation(), u(mr(J, a, et)), setTimeout(() => {
          const lt = T.current[et];
    ...
    const { isLetter: R, isDigit: L } = io(O.key);
    (R || L) && (O.preventDefault(), y((J) => J + O.key), A.current.focus(), $(!1));
  }, []);
  return Vt(() => {
    const O = setTimeout(() => {
      if (d && b === "books" && E.current && S.current) {
        const R = E.current, L = S.current, J = L.offsetTop, G = R.clientHeight, it = L.clientHeight, et = J - G / 2 + it / 2;
        R.scrollTo({
          top: Math.max(0, et),
          behavior: "smooth"
        }), u(mr(t.book));
    ...
    if (b === "chapters" && x) {
      ...
      setTimeout(() => {
        if (E.current)
          if (O) {
            const R = T.current[t.chapterNum];
  ...
  }, [b, x, N, t.book, t.chapterNum]), /* @__PURE__ */ p(de, { open: d, onOpenChange: K, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
      ...
      ce,
      {
        ...
        children: [
          b === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ht.map(({ onClick: O, disabled: R, title: L, icon: J }) => /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              F,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(Ds, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ms, { className: "tw-h-4 tw-w-4" })
              }
            ),
            x && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Le(x, a) })
          ] }),
          !k && /* @__PURE__ */ p(we, { ref: E, children: [
            b === "books" && /* @__PURE__ */ p(wt, { children: [
              !N && Object.entries(W).map(([O, R]) => {
                if (R.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Xt, { heading: ue(O), children: R.map((L) => /* @__PURE__ */ r(
                      ma,
                      {
                        bookId: L,
                        onSelect: (J) => mt(J),
              ...
              N && /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r(
                Jt,
                {
                  value: `${N.book} ${Re[N.book]} ${N.chapterNum || ""}:${N.verseNum || ""})}`,
                  onSelect: U,
                  ...
                  children: Ee(
                    ...
                    a ? Mr(N.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              N && Ht(N.book) > 1 && /* @__PURE__ */ p(wt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Le(N.book, a) }),
                /* @__PURE__ */ r(
                  lo,
                  {
                    bookId: N.book,
...
), gt = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(jo.Root, { ref: n, className: h("pr-twp", Kl(), t), ...e }));
gt.displayName = jo.Root.displayName;
const Ir = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ r(
    dn.Root,
    {
...
Ir.displayName = dn.Root.displayName;
const Tn = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dn.Item,
  {
    ref: n,
    className: h(
    ...
    ...e,
    children: /* @__PURE__ */ r(dn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Ln, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Tn.displayName = dn.Item.displayName;
function Ul(t) {
...
function fr({
  ...
  const [_, k] = D(!1), $ = w ?? c, j = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], A = (E, S) => {
    const T = c(E), P = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, I = `${S ?? ""}${T}${P ?? ""}`;
    return /* @__PURE__ */ p(
      Jt,
      {
        value: T,
  ...
  return /* @__PURE__ */ p(de, { open: _, onOpenChange: k, ...x, children: [
    ...
    /* @__PURE__ */ r(
      Zt,
      {
        ...
        children: /* @__PURE__ */ p(ce, { children: [
          /* @__PURE__ */ r(Ze, { placeholder: f, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(hn, { children: u }),
          /* @__PURE__ */ r(we, { children: j(e) ? e.map((E) => /* @__PURE__ */ r(Xt, { heading: E.groupHeading, children: E.options.map((S) => A(S, E.groupHeading)) }, E.groupHeading)) : e.map((E) => A(E)) })
        ] })
      }
    )
  ] });
...
var hr = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(hr || {});
((t) => {
...
function ru({
  ...
  const d = Hn(w, "%webView_bookSelector_currentBook%"), m = Hn(w, "%webView_bookSelector_choose%"), f = Hn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = D(
    "current book"
    /* CurrentBook */
  ), y = (b) => {
    g(b), t(b);
    ...
    Ir,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(gt, { className: "tw-flex tw-items-center", children: o.map((b) => pt.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ r(
            F,
            {
...
const ga = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = ga ? Vt : Y, xn = { tag: Er };
function Yl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = ql(null, o), d = Fo({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Xe();
            u.append(g);
            const y = ga ? document.activeElement : null;
            (Rt() !== null || y !== null && y === m.getRootElement()) && g.select();
          }
        }, xn);
  ...
  }, []), r(ha.Provider, { value: n, children: e });
}
const Xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function Wl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return Xl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: c }) => {
      e && s.size === 0 && i.size === 0 || t && c.has(Er) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const Ar = {
  ...
  mark: "",
  markOverlap: ""
}, Nt = Se.Provider, Ct = Se.Root, Et = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Se.Trigger,
  {
    ref: o,
    className: e ? h(fa({ variant: e }), t) : t,
    ...n
  }
));
Et.displayName = Se.Trigger.displayName;
const kt = v.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(Se.Portal, { children: /* @__PURE__ */ r(
  Se.Content,
  {
    ref: a,
    sideOffset: e,
...
kt.displayName = Se.Content.displayName;
const Pr = [
  pl,
  zo,
  Bo,
...
class Zl extends Ts {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && Ql(e.resetKeys, a)) {
      var s, i;
...
function tc({ children: t, onError: e }) {
  return r(Zl, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const ec = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function nc(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function rc() {
  return function(t) {
    const [e] = Qt(), n = z(() => t(e), [e, t]), [o, a] = D(() => n.initialValueFn()), s = H(o);
    return ec(() => {
...
function oc(t, e) {
  ...
  for (let w = 0; w < c; w++) {
    const d = i[w], m = l && l.top <= d.top && l.top + l.height > d.top && l.left + l.width > d.left, f = d.width + s === o.width;
    m || f ? (i.splice(w--, 1), c--) : l = d;
  }
  return i;
}
function ac(t, e, n = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !yi(e) && o !== null) {
    const [a, s] = o, i = t.isBackward(), l = a.getNode(), c = s.getNode(), w = e.is(l), d = e.is(c);
    if (w || d) {
      const [m, f] = Ni(t), u = l.is(c), g = e.is(i ? c : l), y = e.is(i ? l : c);
      let b, C = 0;
      u ? (C = m > f ? f : m, b = m > f ? m : f) : g ? (C = i ? f : m, b = void 0) : y && (C = 0, b = i ? m : f);
      const x = e.__text.slice(C, b);
      x !== e.__text && (n === "clone" && (e = ki(e)), e.__text = x);
    }
  }
  return e;
}
...
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, sc = ba && "documentMode" in document ? document.documentMode : null;
!(!ba || !("InputEvent" in window) || sc) && "getTargetRanges" in new window.InputEvent("input");
function qt(t) {
  return `${t}px`;
}
const ic = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function lc(t, e, n) {
  let o = null, a = null, s = null, i = [];
  const l = document.createElement("div");
  function c() {
    o === null && Sn(182), a === null && Sn(183);
    const { left: m, top: f } = a.getBoundingClientRect(), u = oc(t, e);
    var g, y;
    l.isConnected || (y = l, (g = a).insertBefore(y, g.firstChild));
    let b = !1;
    for (let C = 0; C < u.length; C++) {
      const x = u[C], _ = i[C] || document.createElement("div"), k = _.style;
  ...
  const d = t.registerRootListener(function m() {
    ...
    if (!Go(u)) return w();
    w(), o = f, a = u, s = new MutationObserver((g) => {
      const y = t.getRootElement(), b = y && y.parentElement;
      if (y !== o || b !== a) return m();
      for (const C of g) if (!l.contains(C.target)) return c();
    }), s.observe(u, ic), c();
  });
  return () => {
    d(), w();
...
function wc(t, e = cc) {
  let n = null, o = null, a = null, s = null, i = null, l = null, c = () => {
  };
  function w(d) {
    d.read(() => {
      const m = Rt();
      if (!Yt(m)) return n = null, a = null, s = null, l = null, c(), void (c = () => {
      });
      const [f, u] = function(E) {
        const S = E.getStartEndPoints();
        return E.isBackward() ? [S[1], S[0]] : S;
      }(m), g = f.getNode(), y = g.getKey(), b = f.offset, C = u.getNode(), x = C.getKey(), _ = u.offset, k = t.getElementByKey(y), $ = t.getElementByKey(x), j = n === null || k !== o || b !== a || y !== n.getKey(), A = s === null || $ !== i || _ !== l || x !== s.getKey();
      if ((j || A) && k !== null && $ !== null) {
        const E = function(S, T, P, I, q, V, W) {
          const N = (S._window ? S._window.document : document).createRange();
          return N.setStart(...co(T, P, I)), N.setEnd(...co(q, V, W)), N;
        }(t, f, g, k, u, C, $);
        c(), c = lc(t, E, e);
      }
      n = g, o = k, a = b, s = C, i = $, l = _;
    });
  }
  return w(t.getEditorState()), ie(t.registerUpdateListener(({ editorState: d }) => w(d)), () => {
    c();
  });
}
function dc(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? n !== null && (n(), n = null) : n === null && (n = wc(t, e));
  };
...
function pc(t) {
  const e = Uo(t, (n) => re(n) && !n.isInline());
  return re(e) || Sn(4, t.__key), e;
}
function uc(t) {
  const e = Rt() || _i();
  let n;
  if (Yt(e)) n = Ci(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), l = i[i.length - 1];
      l && (n = Ko(l, "next"));
    }
    n = n || Ei(se(), "previous").getFlipped().insert(Xe());
  }
  const o = mc(t, n), a = Ri(o), s = Ti(a) ? Si(a) : o;
  return Di(Mi(s)), t.getLatest();
}
function mc(t, e, n) {
  let o = eo(e, "next");
  for (let a = o; a; a = Oi(a, n)) o = a;
  return Ii(o) && Sn(283), o.insert(t.isInline() ? Xe().append(t) : t), eo(Ko(t.getLatest(), "next"), e.direction);
}
function fc(t) {
  const e = Rt();
  if (!Yt(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Uo(s, (w) => re(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
const hc = Symbol.for("preact-signals");
function jn() {
  if (oe > 1) return void oe--;
  let t, e = !1;
  for (!function() {
    let n = Dn;
    for (Dn = void 0; n !== void 0; ) n.S.v === n.v && (n.S.i = n.i), n = n.o;
  }(); cn !== void 0; ) {
    let n = cn;
    for (cn = void 0, Mn++; n !== void 0; ) {
      const o = n.u;
      if (n.u = void 0, n.f &= -3, !(8 & n.f) && va(n)) try {
        n.c();
      } catch (a) {
        e || (t = a, e = !0);
      }
...
let Dn, oe = 0, Mn = 0, bc = 0, gr = 0, _n = 0;
function po(t) {
  if (Q === void 0) return;
  let e = t.n;
...
function ke(t, e) {
  yt.call(this, void 0), this.x = t, this.s = void 0, this.g = _n - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function vc(t, e) {
  return new ke(t, e);
}
...
function $r(t) {
  ...
  t.x = void 0, t.s = void 0, ya(t);
}
function xc(t) {
  if (Q !== this) throw new Error("Out-of-order effect");
  xa(this), Q = t, this.f &= -2, 8 & this.f && $r(this), jn();
}
function $e(t, e) {
...
yt.prototype.brand = hc, yt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      oe !== 0 && Mn === 0 && e.l !== gr && (e.l = gr, Dn = { S: e, v: e.v, i: e.i, o: Dn });
    })(this), this.v = t, this.i++, _n++, oe++;
    try {
...
} }), ke.prototype = new yt(), ke.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === _n)) return !0;
  if (this.g = _n, this.f |= 1, this.i > 0 && !va(this)) return this.f &= -2, !0;
  const t = Q;
  try {
    uo(this), Q = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ya(this), uo(this), oe++;
  const t = Q;
  return Q = this, xc.bind(this, t);
...
jt({ build: (t, e, n) => Qe(e), config: Ie({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function Na() {
  const t = se(), e = Rt(), n = Xe();
  t.clear(), t.append(n), e !== null && n.select(), Yt(e) && (e.format = 0);
}
function ka(t, e = Na) {
  return t.registerCommand(qo, (n) => (t.update(e), !0), Rr);
}
jt({ build: (t, e, n) => Qe(e), config: Ie({ $onClear: Na }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return Wt(() => ka(t, o.value));
} });
function yc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Xn = $i("format", { parse: (t) => typeof t == "number" ? t : 0 });
class _a extends lr {
  $config() {
    return this.config("decorator-text", { extends: lr, stateConfigs: [{ flat: !0, stateConfig: Xn }] });
  }
  getFormat() {
    return Yi(this, Xn);
  }
  getFormatFlags(e, n) {
    return no(this.getFormat(), e, n);
  }
  hasFormat(e) {
    const n = Xi[e];
  ...
  toggleFormat(e) {
    const n = this.getFormat(), o = no(n, e, null);
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [_a], register: (t, e, n) => t.registerCommand(Ho, (o) => {
  const a = Rt();
  if (Yo(a) || Yt(a)) for (const s of a.getNodes()) Nc(s) && s.toggleFormat(o);
  return !1;
}, Xo) });
function Ca(t, e) {
  let n;
...
const br = jt({ build: (t) => Ca(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Lr = 0, vr = 1, Ra = 2, Wn = 3, yn = 4, Pe = 5, Jn = 6, rn = 7;
function Zn(t) {
  return t.id === Lr;
}
function Ta(t) {
...
function kc(t) {
  return function(e) {
    return e.id === vr;
  }(t) || nt(305, String(t.id), String(vr)), Object.assign(t, { id: Ra });
}
...
class Cc {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Pi;
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, c, w) {
      return Object.assign(l, { config: c, id: Wn, registerState: w });
    }(n, this.mergeConfigs(), o);
    let i;
    this.state = s, this.extension.init && (i = this.extension.init(e, s.config, o)), this.state = function(l, c, w) {
      return Object.assign(l, { id: yn, initResult: c, registerState: w });
    }(s, i, a);
  }
  build(e) {
    const n = this.state;
    let o;
    n.id !== yn && nt(307, String(n.id), String(Pe)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
    const a = { ...n.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(s, i, l) {
      return Object.assign(s, { id: Pe, output: i, registerState: l });
    }(n, o, a);
  }
  register(e, n) {
    this._signal = n;
    ...
    return this.state = function(s) {
      return Object.assign(s, { id: Jn });
    }(o), () => {
      const s = this.state;
      s.id !== rn && nt(309, String(o.id), String(rn)), this.state = function(i) {
        return Object.assign(i, { id: Pe });
      }(s), a && a();
    };
  }
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Jn && nt(310, String(n.id), String(Jn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= yn;
    }(e) || nt(313, String(e.id), String(yn)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Wn;
    }(e) || nt(314, String(e.id), String(Wn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || _c;
  }
  getPeerNameSet() {
...
const Rc = jt({ config: Ie({ setOptions: mo, updateOptions: mo }), init: ({ $initialEditorState: t = Ec }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Li, Bo, Vi, ji, zo] }), fo = Symbol.for("@lexical/extension/LexicalBuilder");
function ho() {
}
function Tc(t) {
  throw t;
...
class Ve {
  ...
  static fromExtensions(e) {
    const n = [Nn(Rc)];
    for (const o of e) n.push(Nn(o));
    return new Ve(n);
  }
  static maybeFromEditor(e) {
    const n = e[fo];
    return n && (n.PACKAGE_VERSION !== Qn && nt(292, n.PACKAGE_VERSION, Qn), n instanceof Ve || nt(293)), n;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Fo({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [fo]: this });
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && nt(298, o.name), !a) {
      a = new Cc(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Zn(s) || nt(300, i, a || "[unknown]"), Zn(l = s) || nt(304, String(l.id), String(Lr)), s = Object.assign(l, { id: vr }), o.state = s;
      const c = this.outgoingConfigEdges.get(i);
      if (c) for (const w of c.keys()) {
        const d = this.extensionNameMap.get(w);
        d && n(d, i);
      }
      s = kc(s), o.state = s, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: m } = d;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of yc(m)) {
...
const Sc = /* @__PURE__ */ new Set(), go = jt({ build(t, e, n) {
  const o = n.getDependency(br).output, a = pn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Ca(() => {
  }, () => Wt(() => {
...
jt({ dependencies: [br, go], name: "@lexical/extension/HorizontalRule", nodes: () => [ze], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(go).output, a = pn({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return ie(t.registerCommand(Dc, (i) => {
    const l = Rt();
    if (!Yt(l)) return !1;
    ...
    return !0;
  }, Rr), t.registerCommand(Bi, (i) => {
    if (Ki(i.target)) {
      const l = Ui(i.target);
      if (Oc(l)) return function(c, w = !1) {
        const d = Rt(), m = c.isSelected(), f = c.getKey();
        let u;
        w && Yo(d) ? u = d : (u = Gi(), qi(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Xo), t.registerMutationListener(ze, (i, l) => {
    gc(() => {
      let c = !1;
      ...
      for (const [d, m] of i.entries()) if (m === "destroyed") w.delete(d), c = !0;
        ...
        f ? f.domNode.value = u : (c = !0, w.set(d, { domNode: pn(u), selectedSignal: o(d) }));
      }
    ...
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) i.push(Wt(() => {
      const w = l.value;
      w && (c.value ? Wo(w, s) : Qi(w, s));
    }));
    return ie(...i);
  }));
} });
jt({ build: (t, e) => Qe({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ie({ $getParentEditor: function() {
  const t = Hi();
...
jt({ build: (t, e, n) => Qe(e), config: Ie({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, n) => {
  const o = n.getOutput();
  return Wt(() => {
    if (!o.disabled.value) return dc(t, o.onReposition.value);
  });
} });
function Sa(t) {
  return t.canBeEmpty();
}
function Ic(t, e, n = Sa) {
  return ie(t.registerCommand(tl, (o) => {
    const a = Rt();
    if (!Yt(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((f) => En(f) && f.canIndent()).length > 0) return !0;
      const l = i.anchor, c = i.focus, w = c.isBefore(l) ? c : l, d = w.getNode(), m = pc(d);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = el();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = nl(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? rl : ro : ol;
    return t.dispatchCommand(s, void 0);
  }, Rr), t.registerCommand(ro, () => {
...
jt({ build: (t, e, n) => Qe(e), config: Ie({ $canIndent: Sa, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return Wt(() => {
    if (!o.value) return Ic(t, a, s);
  });
} });
const Ac = jt({ name: "@lexical/react/ReactProvider" });
function Pc() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Yt(g)) {
                const y = g.anchor;
                let b = y.getNode(), C = 0, x = 0;
                if (Rn(b) && w >= 0 && d >= 0 && (C = w, x = w + d, g.setTextNodeRange(b, C, b, x)), C === x && m === "" || (g.insertRawText(m), b = y.getNode()), Rn(b)) {
                  C = f, x = f + u;
                  const _ = b.getTextContentSize();
                  C = C > _ ? _ : C, x = x > _ ? _ : x, g.setTextNodeRange(b, C, b, x);
                }
...
jt({ build: (t, e, n) => Qe(e), config: Ie({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => Wt(() => n.getOutput().disabled.value ? void 0 : Ma(t)) });
function Vc(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const jr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function jc({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, s] = D(() => n.getDecorators());
    return jr(() => n.registerDecoratorListener((i) => {
      fl(() => {
        s(i);
      });
    }), [n]), Y(() => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], d = r(o, { onError: (f) => n._onError(f), children: r(Ss, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(hl(d, m, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function Fc({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    return !1;
  }(t) ? null : r(jc, { editor: t, ErrorBoundary: e });
}
function bo(t) {
...
function zc({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    jr(() => ie(ml(a), Ma(a)), [a]);
  }(o), p(wt, { children: [t, r(Bc, { content: e }), r(Fc, { editor: o, ErrorBoundary: n })] });
}
function Bc({ content: t }) {
...
function Kc({ defaultSelection: t }) {
  const [e] = Qt();
  return Y(() => {
    e.focus(() => {
...
const Uc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function Gc({ onClear: t }) {
  const [e] = Qt();
  return Uc(() => ka(e, t), [e, t]), null;
}
const Oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function qc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: y, role: b = "textbox", spellCheck: C = !0, style: x, tabIndex: _, "data-testid": k, ...$ }, j) {
  const [A, E] = D(t.isEditable()), S = B((P) => {
  ...
  return Oa(() => (E(t.isEditable()), t.registerEditableListener((P) => {
    E(P);
  })), [t]), r("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? n : "none", "aria-controls": A ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": A && b === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": d, "aria-owns": A ? m : void 0, "aria-readonly": !A || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: A, "data-testid": k, id: y, ref: T, role: b, spellCheck: C, style: x, tabIndex: _, ...$ });
}
const Hc = fn(qc);
function vo(t) {
  return t.getEditorState().read(Da(t.isComposing()));
...
function Xc(t, e) {
  ...
  return p(wt, { children: [r(Hc, { editor: a, ...o, ref: e }), n != null && r(Wc, { editor: a, content: n })] });
}
function Wc({ content: t, editor: e }) {
  const n = function(i) {
    const [l, c] = D(() => vo(i));
    return Oa(() => {
      function w() {
      ...
      return w(), ie(i.registerUpdateListener(() => {
        w();
  ...
  if (Vt(() => (a(e.isEditable()), e.registerEditableListener((i) => {
    a(i);
  })), [e]), !n) return null;
  let s = null;
...
function Zc({
  ...
  return /* @__PURE__ */ r(Ia.Provider, { value: i, children: s });
}
function Aa() {
  const t = Cr(Ia);
  if (!t)
...
function Qc() {
  const [t, e] = D(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Il, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(la, { children: [
      /* @__PURE__ */ r(ca, { children: /* @__PURE__ */ r(wa, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = B(
    (s, i, l = !1) => {
...
function tw({
  ...
  const [e] = Qt(), [n, o] = D(e), [a, s] = D("paragraph"), [i, l] = Qc(), c = () => {
  };
...
), nw = v.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  ta.Root,
  {
    ref: a,
...
nw.displayName = ta.Root.displayName;
const $a = v.createContext({
  size: "default",
  variant: "default"
}), Fr = v.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = ut();
  return /* @__PURE__ */ r(
    Vn.Root,
    {
...
wn.displayName = Vn.Item.displayName;
const xo = [
...
function rw() {
  const { activeEditor: t } = Aa(), [e, n] = D([]), o = B((a) => {
    if (Yt(a) || gl(a)) {
      const s = [];
      xo.forEach(({ format: i }) => {
  ...
  return ew(o), /* @__PURE__ */ r(
    Fr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: xo.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        wn,
        {
          value: a,
          "aria-label": i,
          onClick: () => {
            t.dispatchCommand(Ho, a);
          },
      ...
      /* @__PURE__ */ r(
        zc,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(Jc, { placeholder: t }) }),
          ErrorBoundary: tc
        }
      ),
      e && /* @__PURE__ */ r(Kc, { defaultSelection: "rootEnd" }),
...
function iw(t, e) {
  const n = ll(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  for (const s of n) if (!Va.has(s.nodeName)) {
    const i = ja(s, t, a, !1);
    i !== null && (o = o.concat(i));
  }
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Zo && i.insertAfter(Qo());
    for (const i of s) {
...
function La(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = re(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && Rn(e) && (i = ac(o, e, "clone"));
  const l = re(i) ? i.getChildren() : [], c = il(t, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = La(t, g, f, o);
    !a && re(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Go(d) || oo(d)) && d.append(f), n.append(d), m) {
      const u = m.call(i, d);
      u && (oo(d) ? d.replaceChildren(u) : d.replaceWith(u));
    }
  } else n.append(f);
  return a;
}
const Va = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function ja(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (Va.has(t.nodeName)) return i;
  let l = null;
  const c = function(g, y) {
    const { nodeName: b } = g, C = y._htmlConversions.get(b.toLowerCase());
    let x = null;
  ...
  let f = [];
  const u = (l == null || !cl(l)) && (l != null && En(l) || o);
  for (let g = 0; g < m.length; g++) f.push(...ja(m[g], e, n, u, new Map(a), l));
  return d != null && (f = d(f)), ao(t) && (f = cw(t, f, u ? () => {
    const g = new Zo();
    return n.push(g), g;
  } : Xe)), l == null ? f.length > 0 ? i = i.concat(f) : ao(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : so(g.nextSibling) && so(g.previousSibling);
  }(t) && (i = i.concat(Qo())) : re(l) && l.append(...f), i;
}
function cw(t, e, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    const l = e[i];
    if (En(l)) o && !l.getFormat() && l.setFormat(o), a.push(l);
    else if (s.push(l), i === e.length - 1 || i < e.length - 1 && En(e[i + 1])) {
      const c = n();
...
function ou({
  ...
  const [s, i] = D(dw), [l, c] = D(a), [w, d] = D(!1), m = H(void 0), f = H(null);
  Y(() => {
    let x = !0;
    const _ = f.current;
    if (!_) return;
  ...
  const u = B(() => {
    ...
    const x = In(s);
    e(x, l);
  }, [s, e, l]), g = o["%commentEditor_placeholder%"] ?? "Type your comment here...", y = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", b = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", C = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      /* @__PURE__ */ r("span", { className: "tw-text-sm tw-font-medium", children: C }),
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
          /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(qe, {}) }) }),
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: b }) })
        ] }) }),
        /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(de, { open: w, onOpenChange: d, children: [
      /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ p(
        F,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ r("span", { children: tr(l !== void 0 ? l : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ r(
        Zt,
        {
          ...
          children: /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ r(we, { children: t.map((x) => /* @__PURE__ */ r(
            Jt,
            {
              onSelect: () => {
                c(x || void 0), d(!1);
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ r("span", { children: tr(x, o) })
            },
            x || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (x) => {
          x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), n()) : Br(x) && (x.preventDefault(), x.stopPropagation(), $t(s) && u());
        },
        onKeyDown: (x) => {
          zr(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          On,
          {
...
const au = Object.freeze([
  ...
  const a = H(null), [s, i] = D(void 0), [l, c] = D(void 0), w = B(
    (u) => {
      i(u);
    ...
    (u) => {
      var A;
      const g = u.target, y = (E) => E ? document.getElementById(E) : void 0, b = y(l), C = y(s);
      if (!!(b && g && b.contains(g) && g !== b) && m(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const E = t.find((S) => S.id === l);
            E && w(E.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const S = E.findIndex((P) => P === g);
          if (S === -1) return;
          let T;
          u.key === "ArrowDown" ? T = Math.min(S + 1, E.length - 1) : T = Math.max(S - 1, 0), T !== S && (u.preventDefault(), u.stopPropagation(), (A = E[T]) == null || A.focus());
          return;
        }
        return;
      }
...
const bw = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Ke = v.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  na.Root,
  {
    ref: a,
    decorative: n,
...
Ke.displayName = na.Root.displayName;
...
Ua.displayName = We.Root.displayName;
const xw = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  We.Image,
  {
    ref: n,
...
xw.displayName = We.Image.displayName;
...
Ga.displayName = We.Fallback.displayName;
const Kr = $n(void 0);
function Kt() {
  const t = Cr(Kr);
  if (!t)
...
}), De = ot.Trigger, qa = ot.Group, yw = ot.Portal, Nw = ot.Sub, kw = ot.RadioGroup;
function be({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Kr.Provider, { value: n, children: /* @__PURE__ */ r(ot.Root, { ...e }) });
}
const Ha = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Kt();
  return /* @__PURE__ */ p(
    ot.SubTrigger,
    {
...
Ha.displayName = ot.SubTrigger.displayName;
const Ya = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ut();
  return /* @__PURE__ */ r(
    ot.SubContent,
    {
...
Ya.displayName = ot.SubContent.displayName;
...
le.displayName = ot.Content.displayName;
const An = v.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = ut(), s = Kt();
  return /* @__PURE__ */ r(
    ot.Item,
    {
...
An.displayName = ot.Item.displayName;
...
ae.displayName = ot.CheckboxItem.displayName;
const Xa = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ut(), s = Kt();
  return /* @__PURE__ */ p(
    ot.RadioItem,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(Ln, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Xa.displayName = ot.RadioItem.displayName;
const gn = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ot.Label,
  {
    ref: o,
...
gn.displayName = ot.Label.displayName;
const tn = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ot.Separator,
  {
    ref: n,
...
tn.displayName = ot.Separator.displayName;
...
function yo({
  ...
  const u = B(
    (k) => {
      k && k.stopPropagation(), w(!1), m(void 0), i == null || i(!1);
    },
    [i]
  ), g = B(
    async (k) => {
  ...
  }, [t.date, n]), b = z(() => t.user, [t.user]), C = z(
    () => t.user.split(" ").map((k) => k[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), x = z(() => fi(t.contents), [t.contents]), _ = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(wt, { children: [
        /* @__PURE__ */ p(
          An,
          {
            onClick: (k) => {
              k.stopPropagation(), w(!0), m(ww(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ua, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Ga, { className: "tw-text-xs tw-font-medium", children: C }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), u()) : Br(k) && (k.preventDefault(), k.stopPropagation(), $t(d) && g());
              },
              onKeyDown: (k) => {
                zr(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
        ...
        _ && /* @__PURE__ */ p(be, { children: [
          /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r($s, {}) }) }),
...
function Cw({
  ...
  const [E, S] = D(No), [T, P] = D(), [I, q] = D(), V = o, [W, N] = D(!1), [U, mt] = D(!1), [bt, Dt] = D(!1), [ht, _t] = D(!1), [K, ct] = D(!1), [Z, ft] = D(k), [vt, ue] = D(!1), me = H(void 0), [Ae, fe] = D(/* @__PURE__ */ new Map());
  Y(() => {
    let M = !0;
    return (async () => {
      const Pt = x ? await x(c) : !1;
      M && ct(Pt);
    })(), () => {
      M = !1;
    };
    ...
    let M = !0;
    if (!o) {
      _t(!1), fe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Pt = C ? await C(c) : !1;
      M && _t(Pt);
    })(), () => {
      M = !1;
    };
  ...
  Y(() => {
    if (!o) {
      Mt.current !== "idle" && (P(void 0), q(void 0), Mt.current = "idle");
      return;
    }
    Mt.current === "idle" && (Mt.current = "pending"), ht ? Mt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    A !== s && (P(A), Mt.current = "auto-populated") : Mt.current === "auto-populated" && (P(void 0), Mt.current = "pending");
  }, [o, A, ht, s]);
  const Ft = z(() => e.filter((M) => !M.deleted), [e]);
  Y(() => {
    let M = !0;
    if (!o || !_) {
      fe(/* @__PURE__ */ new Map());
  ...
  const te = z(() => Ft[0], [Ft]), O = H(null), R = H(void 0), L = B(() => {
    var M;
    (M = R.current) == null || M.call(R), S(No);
  }, []), J = B(() => {
    const M = !Z;
    ft(M), ue(!M), g == null || g(c, M);
  }, [Z, g, c]);
  Y(() => {
    N(!1);
  }, [o]), Y(() => {
    if (o && !Z && !vt) {
      ...
      return me.current = M, () => clearTimeout(M);
    }
  ...
  }, [s, n]), et = z(() => Ft.slice(1), [Ft]), rt = z(() => et.length ?? 0, [et.length]), lt = z(() => rt > 0, [rt]), At = z(() => W || rt <= 2 ? et : et.slice(-2), [et, rt, W]), Ot = z(() => W || rt <= 2 ? 0 : rt - 2, [rt, W]), ee = z(
    () => rt === 1 ? G.singleReply : Ce(G.multipleReplies, { count: rt }),
    [rt, G]
  ), ye = z(
    () => Ot === 1 ? G.singleReply : Ce(G.multipleReplies, { count: Ot }),
    [Ot, G]
  );
  Y(() => {
    !o && U && lt && mt(!1);
  ...
  const he = B(
    async (M) => {
      ...
      Ut && await m({ threadId: c, contents: Ut }) && L();
    },
    [
      L,
      E,
    ...
    async (M) => {
      const Ut = $t(E) ? In(E) : void 0, Pt = M.status ? M.assignedUser : T ?? M.assignedUser, nn = await m({
        ...M,
        contents: Ut,
        assignedUser: Pt
      });
      return nn && (Pt !== void 0 && q(Pt), Ut && L()), nn;
    },
    [L, E, m, T]
  );
  if (Ft.length !== 0)
    return /* @__PURE__ */ r(
      Ba,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ p(Ka, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              it && /* @__PURE__ */ r(Be, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: it }),
              /* @__PURE__ */ r(
                F,
                {
                  variant: "ghost",
                  ...
                  children: Z ? /* @__PURE__ */ r(Ls, {}) : /* @__PURE__ */ r(Vs, {})
                }
              ),
              ...
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ p("span", { className: t, children: [
                    te.contextBefore,
                    /* @__PURE__ */ r("span", { className: "tw-font-bold", children: te.selectedText }),
                    te.contextAfter
                  ] })
                ]
              }
            ...
            /* @__PURE__ */ r(
              yo,
              {
                ...
                handleDeleteComment: u,
                onEditingChange: mt,
                canEditOrDelete: (!U && Ae.get(te.id)) ?? !1,
          ...
          /* @__PURE__ */ p(wt, { children: [
            lt && !o && /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Ke, {}) }),
              /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: ee })
            ] }),
            !o && $t(E) && /* @__PURE__ */ r(
              On,
              {
              ...
              Ot > 0 && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Ke, {}) }),
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                      /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: ye }),
                      W ? /* @__PURE__ */ r(Io, {}) : /* @__PURE__ */ r(He, {})
                    ] })
                  ]
                }
              ),
              At.map((M) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
                yo,
                {
                  comment: M,
                  localizedStrings: n,
                  ...
                  handleDeleteComment: u,
                  onEditingChange: mt,
                  canEditOrDelete: (!U && Ae.get(M.id)) ?? !1
                }
              ) }, M.id)),
              b !== !1 && (!U || $t(E)) && /* @__PURE__ */ p(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (M) => {
                    Br(M) && (M.preventDefault(), M.stopPropagation(), ($t(E) || T !== void 0 && T !== I) && he());
                  },
                  onKeyDown: (M) => {
                    zr(M), (M.key === "Enter" || M.key === " ") && M.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ r(
                      On,
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      T !== void 0 && ($t(E) || T !== I) && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: Ce(
                      ...
                      /* @__PURE__ */ p(de, { open: bt, onOpenChange: Dt, children: [
                        /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
                          F,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ r(
                          Zt,
                          {
                            ...
                            children: /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ r(we, { children: y == null ? void 0 : y.map((M) => /* @__PURE__ */ r(
                              Jt,
                              {
                                onSelect: () => {
                                  P(M !== s ? M : void 0), Mt.current = "user-selected", q(void 0), Dt(!1);
                                },
                                className: "tw-flex tw-items-center",
...
function iu({
  ...
  const [C, x] = D(/* @__PURE__ */ new Set()), [_, k] = D(), [$, j] = D(), A = B(
    async (N) => {
      const U = await s(N);
      return U !== void 0 && N.assignedUser !== void 0 && N.assignedUser !== "" && j(N.assignedUser), U;
    },
    [s]
  );
  Y(() => {
    g && (x((N) => new Set(N).add(g)), k(g));
  }, [g]);
  const E = n.filter(
    (N) => N.comments.some((U) => !U.deleted)
  ), S = E.map((N) => ({ id: N.id })), T = B(
    (N) => {
      x((U) => new Set(U).add(N.id)), k(N.id), y == null || y(N.id);
    },
    [y]
  ), P = B(
    (N) => {
      ...
      }), k(N), y == null || y(U ? void 0 : N);
    },
    [C, y]
  ), { listboxRef: I, activeId: q, handleKeyDown: V } = mw({
    options: S,
    onOptionSelect: T
  }), W = B(
    (N) => {
      N.key === "Escape" ? (_ && C.has(_) && (x((U) => {
        const mt = new Set(U);
        return mt.delete(_), mt;
      }), k(void 0), y == null || y(void 0)), N.preventDefault(), N.stopPropagation()) : V(N);
    },
    [_, C, V, y]
  );
  return /* @__PURE__ */ r(
...
function Ew({ table: t }) {
  return /* @__PURE__ */ p(be, { children: [
    /* @__PURE__ */ r(bl, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Ue = dt.Root, Rw = dt.Group, Ge = dt.Value, Tw = ve(
...
), Me = v.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = ut();
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(dt.Icon, { asChild: !0, children: /* @__PURE__ */ r(He, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Me.displayName = dt.Trigger.displayName;
const Wa = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.ScrollUpButton,
  {
    ref: n,
    ...
    ...e,
    children: /* @__PURE__ */ r(Io, { className: "tw-h-4 tw-w-4" })
  }
));
Wa.displayName = dt.ScrollUpButton.displayName;
...
Ja.displayName = dt.ScrollDownButton.displayName;
const Oe = v.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = ut();
...
Oe.displayName = dt.Content.displayName;
...
Sw.displayName = dt.Label.displayName;
const Lt = v.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  dt.Item,
  {
    ref: o,
    className: h(
...
Lt.displayName = dt.Item.displayName;
...
Dw.displayName = dt.Separator.displayName;
function Mw({ table: t }) {
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ p(
        Ue,
        {
          ...
          children: [
            /* @__PURE__ */ r(Me, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ge, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(Oe, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(Lt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const zn = v.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: h(
...
const Bn = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const ne = v.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const l = v.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), $w(u, g, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), Pw(l, y, d.key);
...
function Vw({
  ...
  var j;
  const [d, m] = D([]), [f, u] = D([]), [g, y] = D({}), [b, C] = D({}), x = z(() => e ?? [], [e]), _ = ra({
    data: x,
    columns: t,
    getCoreRowModel: aa(),
    ...n && { getPaginationRowModel: xl() },
    onSortingChange: m,
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((S, T) => `skeleton-row-${T}`).map((S) => /* @__PURE__ */ r(ne, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Te, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(xr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, S)) : ((j = _.getRowModel().rows) == null ? void 0 : j.length) > 0 ? $ = _.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    ne,
    {
      onClick: () => i(A, _),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((E) => /* @__PURE__ */ r(Te, { children: ln(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    A.id
  )) : $ = /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(Te, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Ew, { table: _ }),
    /* @__PURE__ */ p(Fn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(zn, { stickyHeader: s, children: _.getHeaderGroups().map((A) => /* @__PURE__ */ r(ne, { children: A.headers.map((E) => /* @__PURE__ */ r(mn, { className: "tw-p-0", children: E.isPlaceholder ? void 0 : ln(E.column.columnDef.header, E.getContext()) }, E.id)) }, A.id)) }),
...
function lu({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(kl, { options: s, children: e })
    }
  );
}
...
function Fw({
  ...
  const a = _o(n, "%webView_error_dump_header%"), s = _o(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Ao, {}) })
        ] }),
...
function wu({
  ...
  return /* @__PURE__ */ p(de, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(Zt, { id: s, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
function du({ id: t, label: e, groups: n }) {
  const [o, a] = D(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(be, { children: [
    /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "default", children: [
      /* @__PURE__ */ r(Us, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(He, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(le, { children: n.map((w, d) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(gn, { children: w.label }),
      /* @__PURE__ */ r(qa, { children: w.itemType === 0 ? /* @__PURE__ */ r(wt, { children: w.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        ae,
        {
          checked: o[d][f],
        ...
        kw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Xa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(tn, {})
    ] }, w.label)) })
...
function uu({
  ...
  const i = z(() => gi(n), [n]), c = ((w) => {
    const d = new Intl.DisplayNames(bi(), { type: "language" });
...
function Kw({
  ...
  const [C, x] = D(!1), _ = B(
    (T) => {
      var I;
      const P = (I = t.find((q) => q.label === T)) == null ? void 0 : I.value;
      P && n(
        e.includes(P) ? e.filter((q) => q !== P) : [...e, P]
      );
    },
    [t, e, n]
  ), k = () => c || o, $ = z(() => {
    if (!f) return t;
    const T = t.filter((I) => I.starred).sort((I, q) => I.label.localeCompare(q.label)), P = t.filter((I) => !I.starred).sort((I, q) => {
      const V = e.includes(I.value), W = e.includes(q.value);
      return V && !W ? -1 : !V && W ? 1 : I.label.localeCompare(q.label);
    });
    return [...T, ...P];
  }, [t, e, f]), j = () => {
    n(t.map((T) => T.value));
  ...
  return /* @__PURE__ */ r("div", { id: b, className: g, children: /* @__PURE__ */ p(de, { open: E, onOpenChange: d ?? x, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(Zt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ce, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: A, children: i })
      ] }),
      /* @__PURE__ */ p(we, { children: [
        /* @__PURE__ */ r(hn, { children: l }),
        /* @__PURE__ */ r(Xt, { children: $.map((T) => /* @__PURE__ */ p(
          Jt,
          {
            value: T.label,
            onSelect: _,
            ...
            children: [
              ...
              T.starred && /* @__PURE__ */ r(Ys, { className: "tw-h-4 tw-w-4" }),
...
function qw({ children: t, editorRef: e }) {
  const n = H(null);
  return Y(() => {
    var i;
...
const Hw = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(wt, { children: [
...
function Yw({
  ...
  const s = H(null), i = H(null), l = H(!1), [c, w] = D(t), [d, m] = D(n), [f, u] = D(!1);
  Y(() => {
    w(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  const g = (b) => {
    ...
    var C, x, _, k;
    b.stopPropagation(), document.activeElement === i.current && b.key === "ArrowDown" || b.key === "ArrowRight" ? ((C = s.current) == null || C.focus(), l.current = !0) : document.activeElement === s.current && b.key === "ArrowUp" ? ((x = i.current) == null || x.focus(), l.current = !1) : document.activeElement === s.current && b.key === "ArrowLeft" && ((_ = s.current) == null ? void 0 : _.selectionStart) === 0 && ((k = i.current) == null || k.focus(), l.current = !1), c === "custom" && b.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ p(be, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Hw(t, a, n) }) }) }),
    ...
    /* @__PURE__ */ p(
      le,
      {
        ...
        children: [
          /* @__PURE__ */ r(gn, { children: a["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ r(tn, {}),
          /* @__PURE__ */ r(
            ae,
            {
...
const Xw = (t, e) => t === "f" ? /* @__PURE__ */ p(wt, { children: [
  /* @__PURE__ */ r(Lo, {}),
  " ",
...
function Jw({
  ...
  return /* @__PURE__ */ p(be, { children: [
    /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(dl, { asChild: !0, children: /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Xw(t, n) }) }) }),
      /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: Ww(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(le, { style: { zIndex: sa }, children: [
      /* @__PURE__ */ r(gn, { children: n["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ r(tn, {}),
      /* @__PURE__ */ p(
        ae,
        {
...
function Qw({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Js, { className: e, size: 16 });
}
function Eo({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ p(
    Jt,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ r(da, { className: "tw-font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function td({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  ...
  return /* @__PURE__ */ p(ce, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(we, { children: [
      /* @__PURE__ */ r(hn, { children: t["%markerMenu_noResults%"] }),
      ...
      i.length > 0 && /* @__PURE__ */ p(wt, { children: [
        s.length > 0 && /* @__PURE__ */ r(Dr, { alwaysRender: !0 }),
...
function ed(t, e, n, o) {
  ...
  return Object.entries(a.children).forEach(([, i]) => {
    s.push(
      ...i.map((l) => ({
        marker: l,
        title: n[kn[l].description] ?? kn[l].description,
        action: () => {
          var c;
...
function fu({
  ...
  Vt(() => {
    if (!u.current) return;
    const { width: R } = u.current.getBoundingClientRect();
    R > 0 && (u.current.style.width = `${R}px`);
  }, []);
  const [g, y] = D("generated"), [b, C] = D("*"), [x, _] = D("f"), [k, $] = D(!1), [j, A] = D(!0), [E, S] = D(!1), T = H(!1), P = H(""), [I, q] = D(!1), [V, W] = D(), [N, U] = D(), [mt, bt] = D(), [Dt, ht] = D(), _t = H(null), K = z(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...i.view ?? _l(), noteMode: "expanded" }
    }),
    [i, l]
  ), ct = z(
    () => ed(
  ...
  Y(() => {
    ...
    if (L && vn("note", L)) {
      const it = (J = L.insert.note) == null ? void 0 : J.caller;
      let et = "custom";
      it === cr ? et = "generated" : it === wr ? et = "hidden" : it && C(it), y(et), _(((G = L.insert.note) == null ? void 0 : G.style) ?? "f"), R = setTimeout(() => {
        var rt;
        (rt = d.current) == null || rt.applyUpdate([L]);
      }, 0);
    }
    return () => {
      R && clearTimeout(R);
  ...
  const Z = B(
    (R, L, J = !1) => {
      ...
      if (G && vn("note", G)) {
        if (G.insert.note) {
          let lt;
          R === "custom" ? lt = L : R === "generated" ? lt = cr : lt = wr, G.insert.note.caller = lt;
        }
        n == null || n([G]), J && w && s && ((rt = w.current) == null || rt.replaceEmbedUpdate(s, [G]));
      }
    },
    [s, n, w]
  ), ft = B(() => {
  ...
  const ue = H({ book: a.book, chapterNum: a.chapterNum });
  Vt(() => {
    (ue.current.book !== a.book || ue.current.chapterNum !== a.chapterNum) && (ue.current = { book: a.book, chapterNum: a.chapterNum }, vt.current());
  }, [a.book, a.chapterNum]);
  const me = () => {
    var L;
    const R = (L = m.current) == null ? void 0 : L.getElementsByClassName("editor-input")[0];
    ...
    var J, G, it, et, rt;
    _(R);
    const L = (G = (J = d.current) == null ? void 0 : J.getNoteOps(0)) == null ? void 0 : G.at(0);
    if (L && vn("note", L)) {
      L.insert.note && (L.insert.note.style = R);
      const lt = (et = (it = L.insert.note) == null ? void 0 : it.contents) == null ? void 0 : et.ops;
      x !== "x" && R === "x" ? lt == null || lt.forEach((At) => nd(At)) : x === "x" && R !== "x" && (lt == null || lt.forEach((At) => rd(At))), (rt = d.current) == null || rt.applyUpdate([L, { delete: 1 }]);
    }
  }, Ft = (R) => {
    ht(R.contextMarker), S(R.canRedo);
  }, te = B(
    (R) => {
      var J, G, it, et, rt;
      const L = (G = (J = d.current) == null ? void 0 : J.getNoteOps(0)) == null ? void 0 : G.at(0);
      if (L && vn("note", L)) {
        R.content.length > 1 && setTimeout(() => {
          var Ot;
          (Ot = d.current) == null || Ot.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const lt = (it = L.insert.note) == null ? void 0 : it.style, At = (rt = (et = L.insert.note) == null ? void 0 : et.contents) == null ? void 0 : rt.ops;
        if (lt || $(!1), $(
          lt === "x" ? !!(At != null && At.every((Ot) => {
            var ye, he;
            if (!((ye = Ot.attributes) != null && ye.char)) return !0;
            const ee = ((he = Ot.attributes) == null ? void 0 : he.char).style;
            return ee === "xt" || ee === "xo" || ee === "xq";
          })) : !!(At != null && At.every((Ot) => {
            var ye, he;
            if (!((ye = Ot.attributes) != null && ye.char)) return !0;
            const ee = ((he = Ot.attributes) == null ? void 0 : he.char).style;
            return ee === "ft" || ee === "fr" || ee === "fq";
          }))
        ), !T.current) {
          T.current = !0, P.current = JSON.stringify(L), A(!0);
          return;
        }
        A(JSON.stringify(L) === P.current), Z(g, b);
      } else
        $(!1), A(!0);
    },
    [g, b, Z]
    ...
    if (f.current && ct.length && R && R.rangeCount > 0) {
      const L = R.getRangeAt(0).getBoundingClientRect(), J = f.current.getBoundingClientRect();
      W(L.left - J.left), U(L.top - J.top), bt(L.height), q(!0);
    }
  }, [ct, f]);
  return Y(() => {
    const R = () => {
    ...
    var R;
    I && ((R = _t.current) == null || R.focus());
  }, [I]), Y(() => {
    var J;
    const R = ((J = m.current) == null ? void 0 : J.querySelector(".editor-input")) ?? void 0, L = (G) => {
      !I && R && document.activeElement === R && G.key === l ? (G.preventDefault(), O()) : I && G.key === "Escape" && (G.preventDefault(), q(!1));
    };
    return document.addEventListener("keydown", L), () => {
      document.removeEventListener("keydown", L);
    };
  }, [I, O, l]), /* @__PURE__ */ p(wt, { children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          /* @__PURE__ */ r(
            Gw,
            {
              onUndoClick: () => {
                var R;
                return (R = d.current) == null ? void 0 : R.undo();
              },
              onRedoClick: () => {
                var R;
                return (R = d.current) == null ? void 0 : R.redo();
              },
              canUndo: !j,
              canRedo: E,
              localizedStrings: c
          ...
          /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
            ...
            /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: c["%footnoteEditor_saveButton_tooltip%"] }) })
          ] }) }),
          /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
            /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(qe, {}) }) }),
            /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: c["%footnoteEditor_cancelButton_tooltip%"] }) })
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(qw, { editorRef: d, children: /* @__PURE__ */ r(
              Cl,
              {
                options: K,
                onStateChange: Ft,
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
              ...
              /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: c["%footnoteEditor_copyButton_tooltip%"] }) })
            ] }) }) })
          ]
        }
      )
...
const hu = Object.freeze([
  ...Zw,
  ...Object.entries(kn).map(([, t]) => t.description).filter((t) => !!t),
  ...
  return /* @__PURE__ */ p(wt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(wt, { children: ad(t.marker, l, o, w) })
      }
    )
  ] });
}
function gu({
  ...
  const d = c ?? vi(n, void 0), m = (x, _) => {
    w == null || w(x, _, a);
  }, f = s ? n.findIndex((x) => x === s) : -1, [u, g] = D(f), y = (x, _, k) => {
    if (n.length)
      switch (x.key) {
        case "Enter":
        case " ":
          x.preventDefault(), w == null || w(_, k, a);
          break;
      }
  }, b = (x) => {
    if (n.length)
      switch (x.key) {
        case "ArrowDown":
          x.preventDefault(), g((_) => Math.min(_ + 1, n.length - 1));
          break;
        case "ArrowUp":
          x.preventDefault(), g((_) => Math.max(_ - 1, 0));
          break;
      }
  }, C = H([]);
  return Y(() => {
    var x;
    u >= 0 && u < C.current.length && ((x = C.current[u]) == null || x.focus());
  }, [u]), /* @__PURE__ */ r(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((x, _) => {
            ...
            return /* @__PURE__ */ p(wt, { children: [
              ...
              _ < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(Ke, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function cd({
  ...
  return /* @__PURE__ */ p(Fn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(zn, { stickyHeader: !0, children: /* @__PURE__ */ p(ne, { children: [
      /* @__PURE__ */ r(mn, { children: a }),
      /* @__PURE__ */ r(mn, { children: s })
    ] }) }),
    /* @__PURE__ */ r(Bn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      ne,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          /* @__PURE__ */ r(Te, { children: Ee(l.reference, "English") }),
          /* @__PURE__ */ r(Te, { className: o, children: ld(l.text) })
        ]
      },
...
Gr.displayName = dr.Root.displayName;
const wd = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(ei, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(ni, { className: "tw-h-4 tw-w-4" });
}, Kn = (t, e, n) => /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
  /* @__PURE__ */ p(
    Et,
    {
  ...
  header: ({ column: e }) => Kn(e, t)
}), dd = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (n) => n.items[e],
  header: ({ column: n }) => Kn(n, t)
}), vu = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => Kn(e, t, "tw-justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: s }) => Kn(s, t, "tw-justify-center"),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ p(Fr, { value: i, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        wn,
        {
          onClick: (c) => {
            c.stopPropagation(), er(
              [l],
              "approved",
              e,
              n,
  ...
  return e ? e[1] : "";
}, pd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", _u = Object.freeze([
...
function Cu({
  ...
  const u = Gt(n, "%webView_inventory_all%"), g = Gt(n, "%webView_inventory_approved%"), y = Gt(n, "%webView_inventory_unapproved%"), b = Gt(n, "%webView_inventory_unknown%"), C = Gt(n, "%webView_inventory_scope_currentBook%"), x = Gt(n, "%webView_inventory_scope_chapter%"), _ = Gt(n, "%webView_inventory_scope_verse%"), k = Gt(n, "%webView_inventory_filter_text%"), $ = Gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Gt(n, "%webView_inventory_no_results%"), [A, E] = D(!1), [S, T] = D("all"), [P, I] = D(""), [q, V] = D([]), W = z(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : md(K, a, s);
  }, [t, a, s]), N = z(() => {
    if (A) return W;
    const K = [];
    return W.forEach((ct) => {
      const Z = ct.items[0], ft = K.find(
        (vt) => vt.items[0] === Z
      );
      ft ? (ft.count += ct.count, ft.occurrences = ft.occurrences.concat(ct.occurrences)) : K.push({
        items: [Z],
        count: ct.count,
  ...
  }, [A, W]), U = z(() => N.length === 0 ? [] : ud(N, S, P), [N, S, P]), mt = z(() => {
    var Z, ft;
    if (!A) return c;
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        Ue,
        {
          ...
          defaultValue: S,
          children: [
            /* @__PURE__ */ r(Me, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ge, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ p(Oe, { children: [
              /* @__PURE__ */ r(Lt, { value: "all", children: u }),
              /* @__PURE__ */ r(Lt, { value: "approved", children: g }),
              /* @__PURE__ */ r(Lt, { value: "unapproved", children: y }),
              /* @__PURE__ */ r(Lt, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(Ue, { onValueChange: (K) => Dt(K), defaultValue: i, children: [
        /* @__PURE__ */ r(Me, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ge, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Oe, { children: [
          /* @__PURE__ */ r(Lt, { value: "book", children: C }),
          /* @__PURE__ */ r(Lt, { value: "chapter", children: x }),
          /* @__PURE__ */ r(Lt, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ r(
        en,
      ...
      o && /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ p(Ct, { children: [
        /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-w-fit tw-min-w-[26px] tw-items-center tw-rounded-md tw-border", children: [
          ...
          /* @__PURE__ */ r(gt, { className: "tw-m-1 tw-truncate", children: (o == null ? void 0 : o.checkboxText) ?? $ })
        ] }) }),
        /* @__PURE__ */ r(kt, { children: (o == null ? void 0 : o.checkboxText) ?? $ })
      ] }) })
    ] }),
...
const fd = "16rem", hd = "3rem", Qa = v.createContext(void 0);
function Un() {
...
const ts = v.forwardRef(
  ({
    ...
    const [w, d] = v.useState(t), m = e ?? w, f = v.useCallback(
      ...
      [n, m]
    ), u = v.useCallback(() => f((_) => !_), [f]), g = m ? "expanded" : "collapsed", C = ut() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = v.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(Qa.Provider, { value: x, children: /* @__PURE__ */ r(Nt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const es = v.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Un();
...
const gd = v.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Un();
  return /* @__PURE__ */ p(
    F,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(ri, {}) : /* @__PURE__ */ r(oi, {}),
...
const Nr = v.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ye : "div",
  {
    ref: o,
...
Nr.displayName = "SidebarGroupLabel";
const kd = v.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ye : "button",
  {
    ref: o,
...
const _d = ve(
  ...
  ({
    ...
    const c = t ? Ye : "button", { state: w } = Un(), d = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: h(_d({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(kt, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : d;
  }
);
ss.displayName = "SidebarMenuButton";
const Cd = v.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ye : "button",
  {
    ref: a,
...
Cd.displayName = "SidebarMenuAction";
...
const Rd = v.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(xr, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          xr,
          {
...
const Dd = v.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ye : "a",
  {
    ref: s,
...
function Md({
  ...
  return /* @__PURE__ */ r(
    es,
    {
      ...
      children: /* @__PURE__ */ p(rs, { children: [
        /* @__PURE__ */ p(yr, { children: [
          /* @__PURE__ */ r(Nr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(kr, { children: /* @__PURE__ */ r(os, { children: Object.entries(e).map(([f, u]) => /* @__PURE__ */ r(as, { children: /* @__PURE__ */ r(
            ss,
            {
              onClick: () => w(f),
              isActive: m(f),
        ...
        /* @__PURE__ */ p(yr, { children: [
          /* @__PURE__ */ r(Nr, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ r(kr, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            fr,
            {
              buttonVariant: "ghost",
...
const ge = "scrBook", Od = "scrRef", _e = "source", Id = "details", Ad = "Scripture Reference", Pd = "Scripture Book", is = "Type", $d = "Details";
function Ld(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? pt.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === ge ? Ee(a.start) : void 0;
      },
...
const Vd = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || ir(t.start, t.end) === 0 ? `${Gn(t.start)}+${e}` : `${Gn(t.start)}+${e}-${Gn(t.end)}+${n}`;
}, Ro = (t) => `${Vd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ru({
  sources: t,
  ...
  const [w, d] = D([]), [m, f] = D([{ id: ge, desc: !1 }]), [u, g] = D({}), y = z(
  ...
  Y(() => {
    if (l) {
      const S = C.getSelectedRowModel().rowsById, T = Object.keys(S);
      if (T.length === 1) {
        const P = y.find((I) => Ro(I) === T[0]) || void 0;
        P && l(P);
      }
    }
  }, [u, y, l, C]);
  const x = a ?? Pd, _ = s ?? is, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [ge] },
    { label: `Group by ${_}`, value: [_e] },
    {
  ...
  }, A = (S, T) => S.getIsGrouped() ? "" : h("banded-row", T % 2 === 0 ? "even" : "odd"), E = (S, T, P) => {
    if (!((S == null ? void 0 : S.length) === 0 || T.depth < P.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ p("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ p(
      Ue,
      {
        ...
        children: [
          /* @__PURE__ */ r(Me, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ge, {}) }),
          /* @__PURE__ */ r(Oe, { position: "item-aligned", children: /* @__PURE__ */ r(Rw, { children: k.map((S) => /* @__PURE__ */ r(Lt, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Fn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(zn, { children: C.getHeaderGroups().map((S) => /* @__PURE__ */ r(ne, { children: S.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ r(Bn, { children: C.getRowModel().rows.map((S, T) => {
        const P = ut();
        return /* @__PURE__ */ r(
          ne,
          {
            ...
            children: S.getVisibleCells().map((I) => {
              if (!(I.getIsPlaceholder() || I.column.columnDef.enableGrouping && !I.getIsGrouped() && (I.column.columnDef.id !== _e || !n)))
                return /* @__PURE__ */ r(
                  Te,
                  {
                    className: h(
                    ...
                    children: I.getIsGrouped() ? /* @__PURE__ */ p(
                      F,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          S.getIsExpanded() && /* @__PURE__ */ r(He, {}),
                          !S.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(je, {}) : /* @__PURE__ */ r(ar, {})),
                          " ",
                          ln(I.column.columnDef.cell, I.getContext()),
                          " (",
                          S.subRows.length,
                          ")"
                        ]
...
}), ls = (t, e, n) => Hr(t, e).every((o) => n.includes(o));
function jd({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Hr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
...
function Fd({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: f, ntLong: u, dcLong: g, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [b, C] = D(!1), [x, _] = D(""), k = H(void 0), $ = H(!1);
  if (t.length !== pt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const j = z(() => pt.allBookIds.filter(
    (V, W) => t[W] === "1" && !pt.isObsolete(pt.bookIdToNumber(V))
  ), [t]), A = z(() => {
    if (!x.trim()) {
      const N = {
        [X.OT]: [],
    ...
    (V, W = !1) => {
      if (!W || !k.current) {
        n(
          e.includes(V) ? e.filter((ht) => ht !== V) : [...e, V]
        ), k.current = V;
        return;
      }
      const N = j.findIndex((ht) => ht === k.current), U = j.findIndex((ht) => ht === V);
      if (N === -1 || U === -1) return;
      const [mt, bt] = [
        Math.min(N, U),
        Math.max(N, U)
      ], Dt = j.slice(mt, bt + 1).map((ht) => ht);
      n(
        e.includes(V) ? e.filter((ht) => !Dt.includes(ht)) : [.../* @__PURE__ */ new Set([...e, ...Dt])]
      );
    },
    [e, n, j]
  ), S = (V) => {
    E(V, $.current), $.current = !1;
  }, T = (V, W) => {
    V.preventDefault(), E(W, V.shiftKey);
  }, P = B(
    (V) => {
      const W = Hr(j, V).map((N) => N);
      n(
        ls(j, V, e) ? e.filter((N) => !W.includes(N)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), I = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(X).map((V) => /* @__PURE__ */ r(
      jd,
      {
        section: V,
        availableBookIds: j,
        ...
        children: [
          ...
          /* @__PURE__ */ r(Zt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ p(
            ce,
            {
              shouldFilter: !1,
              onKeyDown: (V) => {
                V.key === "Enter" && ($.current = V.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Ze,
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: q, children: w })
                ] }),
                /* @__PURE__ */ p(we, { children: [
                  /* @__PURE__ */ r(hn, { children: d }),
                  Object.values(X).map((V, W) => {
                    const N = A[V];
                    if (N.length !== 0)
                      return /* @__PURE__ */ p(So, { children: [
                        ...
                        W < Object.values(X).length - 1 && /* @__PURE__ */ r(Dr, {})
                      ] }, V);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === nr ? nr : To
      ).map((V) => /* @__PURE__ */ r(Be, { className: "hover:tw-bg-secondary", variant: "secondary", children: Le(V, a) }, V)),
      e.length > nr && /* @__PURE__ */ r(
        Be,
        {
...
function Su({
  ...
  const w = Ne(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), f = Ne(i, "%webView_scope_selector_current_book%"), u = Ne(i, "%webView_scope_selector_choose_books%"), g = Ne(i, "%webView_scope_selector_scope%"), y = Ne(i, "%webView_scope_selector_select_books%"), b = [
  ...
  ], C = e ? b.filter((x) => e.includes(x.value)) : b;
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Ir,
        {
          ...
          children: C.map(({ value: x, label: _, id: k }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Tn, { className: "tw-me-2", value: x, id: k }),
            /* @__PURE__ */ r(gt, { htmlFor: k, children: _ })
          ] }, k))
        }
      )
    ] }),
...
function Du({
  ...
  return /* @__PURE__ */ p(
    Ue,
    {
      ...
      children: [
        /* @__PURE__ */ r(Me, { size: a, className: h("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Ge,
          {
        ...
        /* @__PURE__ */ r(
          Oe,
          {
            ...
            style: { zIndex: Je },
            children: t.map((w) => /* @__PURE__ */ r(Lt, { value: `${w}`, children: l[tt(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Pn({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
const ws = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Et, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    An,
    {
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ r(Pn, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ r(Pn, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ p(Nw, { children: [
    /* @__PURE__ */ r(Ha, { children: l.label }),
    /* @__PURE__ */ r(yw, { children: /* @__PURE__ */ r(Ya, { children: ws(
      t,
      e,
      cs(t, l.id),
      o
...
function _r({
  ...
  return /* @__PURE__ */ p(be, { variant: s, children: [
    /* @__PURE__ */ r(De, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(si, {}) }) }),
    /* @__PURE__ */ r(le, { align: "start", style: { zIndex: Je }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(So, { children: [
      /* @__PURE__ */ r(qa, { children: /* @__PURE__ */ r(Nt, { children: ws(e.groups, e.items, c, t) }) }),
      w < d.length - 1 && /* @__PURE__ */ r(tn, {})
    ] }, c)) })
  ] });
}
...
function Au({
  ...
  return /* @__PURE__ */ p(ds, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      _r,
      {
        onSelectMenuItem: t,
...
const ps = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ r(
    St.Root,
    {
...
ps.displayName = St.List.displayName;
...
us.displayName = St.List.displayName;
...
)), ms = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Content,
  {
    ref: n,
    className: h(
...
ms.displayName = St.Content.displayName;
function $u({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(ps, { children: [
      /* @__PURE__ */ r(us, { children: t.map((l) => /* @__PURE__ */ r(zd, { value: l.value, children: l.value }, l.key)) }),
...
const fs = v.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = v.useMemo(
    () => ({
      variant: e
    }),
...
fs.displayName = at.Root.displayName;
const hs = v.forwardRef(({ className: t, ...e }, n) => {
  const o = Kt();
  return /* @__PURE__ */ r(
    at.Trigger,
    {
...
hs.displayName = at.Trigger.displayName;
const gs = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Kt();
  return /* @__PURE__ */ p(
    at.SubTrigger,
    {
      ...
      className: h(
        ...
        e && "tw-pl-8",
        pe({ variant: s.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...o,
...
gs.displayName = at.SubTrigger.displayName;
...
bs.displayName = at.SubContent.displayName;
const vs = v.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Kt();
...
const xs = v.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Kt();
  return /* @__PURE__ */ r(
    at.Item,
    {
...
xs.displayName = at.Item.displayName;
...
Ud.displayName = at.CheckboxItem.displayName;
const Gd = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Kt();
  return /* @__PURE__ */ p(
    at.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(at.ItemIndicator, { children: /* @__PURE__ */ r(Ln, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
qd.displayName = at.Label.displayName;
...
ys.displayName = at.Separator.displayName;
const on = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
    ...
    const l = e.filter((w) => w.group === s).sort((w, d) => w.order - d.order).map((w) => /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: "command" in w ? /* @__PURE__ */ p(
        xs,
        {
          ...
          children: [
            w.iconPathBefore && /* @__PURE__ */ r(Pn, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
            w.label,
            w.iconPathAfter && /* @__PURE__ */ r(Pn, { icon: w.iconPathAfter, menuLabel: w.label })
          ]
        },
        `menubar-item-${w.label}-${w.command}`
      ) : /* @__PURE__ */ p(Kd, { children: [
        /* @__PURE__ */ r(gs, { children: w.label }),
      ...
      w.tooltip && /* @__PURE__ */ r(kt, { children: w.tooltip })
...
function Hd({
  ...
  const a = H(void 0), s = H(void 0), i = H(void 0), l = H(void 0), c = H(void 0), w = (d) => {
    switch (d) {
      case "platform.app":
        return s;
  ...
  if (El(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    var g, y, b, C;
    d.preventDefault();
    ...
    switch (m.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (C = c.current) == null || C.focus(), on(c, [f, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(fs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(Bd, { children: [
      /* @__PURE__ */ r(hs, { ref: w(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        vs,
        {
          style: { zIndex: Je },
          children: /* @__PURE__ */ r(Nt, { children: Ns(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
...
function ju({
  ...
  const w = Yd(
    ...
    var C, x, _, k, $, j;
    const b = y !== g ? ((x = (C = t[g]) == null ? void 0 : C.uiNames) == null ? void 0 : x[y]) ?? ((k = (_ = t[g]) == null ? void 0 : _.uiNames) == null ? void 0 : k.en) : void 0;
    return b ? `${($ = t[g]) == null ? void 0 : $.autonym} (${b})` : (j = t[g]) == null ? void 0 : j.autonym;
  };
  return /* @__PURE__ */ p("div", { id: c, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ p(
      Ue,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(Me, { children: /* @__PURE__ */ r(Ge, {}) }),
          /* @__PURE__ */ r(
            Oe,
            {
              style: { zIndex: Je },
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(Lt, { value: g, children: u(g, e) }, g))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(gt, { className: "tw-font-normal tw-text-muted-foreground", children: Ce(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function Xd({ item: t, createLabel: e, createComplexLabel: n }) {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && w && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(be, { children: [
              /* @__PURE__ */ r(De, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Qr, {}) }) }),
              /* @__PURE__ */ r(le, { align: "end", children: w })
            ] }) }),
            e && w && /* @__PURE__ */ p(be, { children: [
              /* @__PURE__ */ r(De, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Qr, {}) }) }),
              /* @__PURE__ */ r(le, { align: "end", children: w })
            ] })
          ] }),
...
const Wd = fn(({ className: t, ...e }, n) => /* @__PURE__ */ r(ci, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
...
), Zd = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Qd.displayName = "AlertTitle";
const tp = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
tp.displayName = "AlertDescription";
const Ku = st.Root, Uu = st.Trigger, Gu = st.Group, qu = st.Portal, Hu = st.Sub, Yu = st.RadioGroup, ep = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  st.SubTrigger,
  {
    ref: a,
    className: h(
...
ep.displayName = st.SubTrigger.displayName;
...
np.displayName = st.SubContent.displayName;
const rp = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(st.Portal, { children: /* @__PURE__ */ r(
  st.Content,
  {
    ref: n,
    className: h(
...
rp.displayName = st.Content.displayName;
const op = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  st.Item,
  {
    ref: o,
    className: h(
...
op.displayName = st.Item.displayName;
const ap = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  st.CheckboxItem,
  {
    ref: a,
    className: h(
...
ap.displayName = st.CheckboxItem.displayName;
const sp = v.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  st.RadioItem,
  {
    ref: o,
    className: h(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(st.ItemIndicator, { children: /* @__PURE__ */ r(Ln, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
sp.displayName = st.RadioItem.displayName;
const ip = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  st.Label,
  {
    ref: o,
    className: h(
...
ip.displayName = st.Label.displayName;
...
lp.displayName = st.Separator.displayName;
...
cp.displayName = "ContextMenuShortcut";
const ks = v.createContext({
  direction: "bottom"
});
function wp({
...
wp.displayName = "Drawer";
const Xu = Bt.Trigger, dp = Bt.Portal, Wu = Bt.Close, _s = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Overlay,
  {
    ref: n,
...
_s.displayName = Bt.Overlay.displayName;
const pp = v.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = v.useContext(ks), i = {
...
fp.displayName = Bt.Title.displayName;
const hp = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Description,
  {
    ref: n,
    className: h("tw-text-sm tw-text-muted-foreground", t),
...
hp.displayName = Bt.Description.displayName;
const gp = v.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  pr.Root,
  {
    ref: o,
    className: h(
...
gp.displayName = pr.Root.displayName;
function Ju({
  className: t,
  ...e
}) {
...
function Qu({
  ...
  return /* @__PURE__ */ r(
    Sr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(wi, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function tm({ ...t }) {
...
const bp = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ p(
    an.Root,
    {
...
bp.displayName = an.Root.displayName;
const vp = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ r(
    ur.Root,
    {
...
vp.displayName = ur.Root.displayName;
const em = St.Root, xp = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ r(
    St.List,
    {
...
xp.displayName = St.List.displayName;
...
yp.displayName = St.Trigger.displayName;
const Np = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Content,
  {
    ref: n,
...
Np.displayName = St.Content.displayName;
...
export {
  ...
  xw as AvatarImage,
  eu as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  nu as BOOK_SELECTOR_STRING_KEYS,
  Be as Badge,
  tu as BookChapterControl,
  hr as BookSelectionMode,
  ru as BookSelector,
  F as Button,
  au as COMMENT_EDITOR_STRING_KEYS,
  su as COMMENT_LIST_STRING_KEYS,
  Ba as Card,
  Ka as CardContent,
  ...
  iu as CommentList,
  Ku as ContextMenu,
  ap as ContextMenuCheckboxItem,
  rp as ContextMenuContent,
  Gu as ContextMenuGroup,
  op as ContextMenuItem,
  ip as ContextMenuLabel,
  qu as ContextMenuPortal,
  Yu as ContextMenuRadioGroup,
  sp as ContextMenuRadioItem,
  lp as ContextMenuSeparator,
  cp as ContextMenuShortcut,
  Hu as ContextMenuSub,
  np as ContextMenuSubContent,
  ep as ContextMenuSubTrigger,
  ...
  cu as ERROR_POPOVER_STRING_KEYS,
  qw as EditorKeyboardShortcuts,
  Fw as ErrorDump,
  wu as ErrorPopover,
  hu as FOOTNOTE_EDITOR_STRING_KEYS,
  mu as Filter,
  du as FilterDropdown,
  uu as Footer,
  fu as FootnoteEditor,
  id as FootnoteItem,
  gu as FootnoteList,
  _u as INVENTORY_STRING_KEYS,
  en as Input,
  Cu as Inventory,
  gt as Label,
  ...
  Su as ScopeSelector,
  Ru as ScriptureResultsViewer,
  Du as ScrollGroupSelector,
  qr as SearchBar,
  Ue as Select,
  Oe as SelectContent,
  Rw as SelectGroup,
  ...
  Ke as Separator,
  Mu as SettingsList,
  Iu as SettingsListHeader,
  Ou as SettingsListItem,
  Md as SettingsSidebar,
  Eu as SettingsSidebarContentSearch,
  es as Sidebar,
  rs as SidebarContent,
  yd as SidebarFooter,
  yr as SidebarGroup,
  kd as SidebarGroupAction,
  ...
  ns as SidebarInset,
  os as SidebarMenu,
  Cd as SidebarMenuAction,
  Ed as SidebarMenuBadge,
  ss as SidebarMenuButton,
  as as SidebarMenuItem,
  Rd as SidebarMenuSkeleton,
  Td as SidebarMenuSub,
  Dd as SidebarMenuSubButton,
  Sd as SidebarMenuSubItem,
  ...
  h as cn,
  ku as getBookIdFromUSFM,
  Kn as getInventoryHeader,
  yu as getLinesFromUSFM,
  Nu as getNumberFromUSFM,
  pd as getStatusForItem,
  Lu as getToolbarOSReservedSpaceClassName,
  vu as inventoryCountColumn,
  bu as inventoryItemColumn,
