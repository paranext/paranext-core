...
var Yt = (t, e, r) => Vi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Oe, a as Fa, C as ze, A as pe, P as Ve, b as er, B as H, d as Le, e as je, f as Be, h as Te, i as Li, k as ji, j as Bi, E as Fi, l as Ua, r as ye, m as Ui, n as wn, o as ta, p as ea, L as Rt, R as Ka, q as Gr, D as Na, s as Ca, t as Ea, u as Ta, T as un, v as Lr, w as Bt, x as qa, y as Ft, z as Ut, F as Kt, G as pn, H as Ga, I as Ze, J as Nr, K as Fe, M as Ue, N as Ke, S as Cr, O as ir, Q as Ki, U as Sr, V as tr, W as Ie, Z as rr, X as $e, Y as sr, _ as Ha, $ as Ya, a0 as Hr, a1 as Wa, a2 as hn, a3 as qi, a4 as Gi, a5 as Hi, a6 as Sa, a7 as gn, a8 as ra, a9 as fn, aa as Yi, ab as Wi, ac as Xi, ad as Ji, ae as mn, af as Zi, ag as ca, ah as xo, ai as la, aj as Qi, ak as ts, al as es, am as rs, an as as, ao as zr, ap as Xa, aq as os, ar as ns } from "./resizable-C3AVzTx2.js";
...
import { Avatar as ao, Select as Jt, Checkbox as Mo, Slot as Dr, Tabs as he, Menubar as ke, ContextMenu as At, Progress as Oo, Slider as Or, Switch as $o } from "radix-ui";
import { useReactTable as Bn, getFilteredRowModel as tl, getSortedRowModel as Fn, getPaginationRowModel as el, getCoreRowModel as Un, flexRender as kr, getGroupedRowModel as rl, getExpandedRowModel as al } from "@tanstack/react-table";
...
function ul({
  ...
  return /* @__PURE__ */ u(Ve, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Le, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Te, { heading: i, children: t.map((E) => /* @__PURE__ */ u(
      ze,
      {
        onSelect: () => C(E),
...
function pa({
  ...
  const j = ye(), [D, $] = N(!1), [P, S] = N(""), [V, Y] = N(""), [_, et] = N("books"), [B, X] = N(void 0), [M, O] = N(
    void 0
  ), [W, ot] = N(void 0), [Pt, Ot] = N(!1), qt = F(null), q = F(!1), it = F(void 0), gt = F(void 0), lt = F(void 0), ft = F(void 0), Zt = F({}), Ct = F({}), xt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Et = I(() => o ? o() : Ui, [o]), Gt = I(() => ({
    [ht.OT]: Et.filter((K) => bt.isBookOT(K)),
    [ht.NT]: Et.filter((K) => bt.isBookNT(K)),
    [ht.DC]: Et.filter((K) => bt.isBookDC(K)),
    [ht.Extra]: Et.filter((K) => bt.extraBooks().includes(K))
  }), [Et]), yt = I(() => Object.values(Gt).flat(), [Gt]), Vt = I(() => {
    if (!V.trim()) return Gt;
    const x = {
      [ht.OT]: [],
      [ht.NT]: [],
    ...
    return [ht.OT, ht.NT, ht.DC, ht.Extra].forEach((ct) => {
      x[ct] = Gt[ct].filter((jt) => Ua(jt, V, n));
    }), x;
  }, [Gt, V, n]), R = I(
    () => ml(V, yt, n),
    [V, yt, n]
  ...
  const _t = L(() => {
    if (R) {
      const x = R.chapterNum ?? 1, K = R.verseNum ?? 1;
      if (w && ua(R.book, x, K, w))
        return;
      xt({
        book: R.book,
        chapterNum: x,
    ...
    (x) => {
      const K = M ?? (R == null ? void 0 : R.book), ct = W ?? (R == null ? void 0 : R.chapterNum);
      !K || !ct || (xt({
        book: K,
        chapterNum: ct,
        verseNum: x
    ...
    (x) => {
      const K = _ === "chapters" ? B : R == null ? void 0 : R.book;
      if (K) {
        if (d && d(K, x) > 1) {
          O(K), ot(x), et("verses"), S("");
          return;
        }
        xt({
          book: K,
    ...
    $(x), x && (et("books"), X(void 0), O(void 0), ot(void 0), Y(""));
  }, []);
  G(() => {
    z && $t(!1);
  }, [z, $t]);
  ...
  const { otLong: T, ntLong: U, dcLong: nt, extraLong: J } = {
    ...
    () => gl(V),
    [V]
  ), ut = I(() => !d || !R || !R.chapterNum || !at ? !1 : d(R.book, R.chapterNum) > 0, [d, R, at]), mt = L(
    (x) => w ? Ao(x, w) : !1,
    [w]
  ), Nt = L(
    (x) => (K) => w ? fl(x, K, w) : !1,
    ...
    (x, K) => (ct) => w ? ua(x, K, ct, w) : !1,
    [w]
  ), ne = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Re = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", mr = L(
    (x) => {
    ...
    (x) => {
      var Ne, De, Ye;
      if (x.ctrlKey) return;
      const { isLetter: K, isDigit: ct } = Po(x.key);
      if ((_ === "chapters" || _ === "verses") && (x.key === " " || x.key === "Enter")) {
        ...
        const zt = (Ne = it.current) == null ? void 0 : Ne.querySelector(
      ...
      const jt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key);
      if (_ === "verses" && jt) {
        const Mt = M, St = W;
        if (!Mt || !St || !d) return;
        const zt = d(Mt, St);
        if (!zt) return;
        (De = it.current) == null || De.focus();
        const vt = (() => {
          if (!P) return 1;
          const We = P.match(/:(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            vt !== 0 && (Ht = vt > 1 ? vt - 1 : zt);
            break;
          case "ArrowRight":
            vt !== 0 && (Ht = vt < zt ? vt + 1 : 1);
            break;
          case "ArrowUp":
            Ht = vt === 0 ? zt : Math.max(1, vt - ge);
            break;
          case "ArrowDown":
            Ht = vt === 0 ? 1 : Math.min(zt, vt + ge);
            break;
          default:
            return;
        }
        Ht !== vt && (x.preventDefault(), x.stopPropagation(), S(
          `${Mt} ${pe[Mt] || ""} ${St}:${Ht}`
        ), setTimeout(() => {
          const We = Ct.current[Ht];
          We && We.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((_ === "chapters" || _ === "books" && R) && jt) {
        const Mt = _ === "chapters" ? B : R == null ? void 0 : R.book;
        if (!Mt) return;
        _ === "chapters" && ((Ye = it.current) == null || Ye.focus());
        const St = (() => {
          if (!P) return 1;
          const ge = P.match(/(\d+)$/);
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            vt = St === 0 ? zt : Math.max(1, St - Ht);
            break;
          case "ArrowDown":
            vt = St === 0 ? 1 : Math.min(zt, St + Ht);
            break;
          default:
            return;
        }
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (jt = gt.current) == null || jt.focus();
      return;
    }
    const { isLetter: K, isDigit: ct } = Po(x.key);
    (K || ct) && (x.preventDefault(), Y((Ne) => Ne + x.key), gt.current.focus(), Ot(!1));
  }, []);
  return ie(() => {
    const x = setTimeout(() => {
      if (D && _ === "books" && lt.current && ft.current) {
        const K = lt.current, ct = ft.current, jt = ct.offsetTop, Ne = K.clientHeight, De = ct.clientHeight, Ye = jt - Ne / 2 + De / 2;
        K.scrollTo({
          top: Math.max(0, Ye),
          behavior: "smooth"
        }), S(qn(t.book));
    ...
    if (_ === "chapters" && B) {
      const x = B === t.book, K = x ? t.chapterNum : 1;
      S(
        `${B} ${pe[B] || ""} ${K}`
      ), setTimeout(() => {
        if (lt.current)
          if (x) {
            const ct = Zt.current[t.chapterNum];
  ...
  }, [_, B, R, t.book, t.chapterNum]), ie(() => {
    if (_ === "verses" && M && W !== void 0) {
      const x = M === t.book && W === t.chapterNum, K = x ? t.verseNum : 1;
      S(
        `${M} ${pe[M] || ""} ${W}:${K}`
      ), setTimeout(() => {
        if (lt.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ve, { open: D, onOpenChange: $t, modal: C, children: [
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: K } = x;
          D && qt.current && K instanceof Node && qt.current.contains(K) && (q.current = !0, $t(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          je,
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: He.map(
                  ({ onClick: x, disabled: K, title: ct, icon: jt }) => /* @__PURE__ */ a(
                    H,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  H,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: _ === "verses" ? ae : Tt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: j === "ltr" ? /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                _ === "chapters" && B && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Oe(B, n) }),
                _ === "verses" && M && W !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Oe(M, n)} ${W}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: _ === "verses" ? Re : ne
                  }
                )
              ] }),
              !Pt && /* @__PURE__ */ u(Be, { ref: lt, children: [
                _ === "books" && /* @__PURE__ */ u(wt, { children: [
                  !R && Object.entries(Vt).map(([x, K]) => {
                    if (K.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Te, { heading: Z(x), children: K.map((ct) => /* @__PURE__ */ a(
                          Kn,
                          {
                            bookId: ct,
                            onSelect: (jt) => Ge(jt),
                            section: yr(ct),
                            commandValue: `${ct} ${pe[ct]}`,
                  ...
                  R && ut && R.chapterNum && d && /* @__PURE__ */ u(wt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Oe(R.book, n)} ${R.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Lo,
                      {
                        ...
                        onVerseSelect: re,
                        setVerseRef: rt,
                        isVerseDisabled: we(R.book, R.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  R && !ut && cr(R.book) > 1 && /* @__PURE__ */ u(wt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Oe(R.book, n) }),
...
function jo({
  ...
  const [k, z] = N(!1), j = d ?? l, D = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], $ = (P, S) => {
    const V = l(P), Y = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, _ = `${S ?? ""}${V}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      ze,
      {
        value: V,
  ...
  return /* @__PURE__ */ u(Ve, { open: k, onOpenChange: z, ...E, children: [
    /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ u(
      H,
      {
        variant: f,
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yl = Yn ? ie : G, Ar = { tag: to };
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ie : G;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ie : G;
function Rl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Dl() {
  return function(t) {
    const [e] = _e(), r = I(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = F(o);
    return zl(() => {
...
function Pl(t, e = Al) {
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((D || $) && z !== null && j !== null) {
        const P = function(S, V, Y, _, et, B, X) {
          const M = (S._window ? S._window.document : document).createRange();
          return M.setStart(...Bo(V, Y, _)), M.setEnd(...Bo(et, B, X)), M;
        }(t, h, f, z, g, C, j);
        l(), l = Il(t, P, e);
      }
...
function jl(t) {
  ...
  if (be(e)) r = sc(e.focus, "next");
    ...
    r = r || cc(Pe(), "previous").getFlipped().insert(Rr());
  }
...
function Bl(t, e, r) {
  ...
  return gc(o) && Yr(283), o.insert(t.isInline() ? Rr().append(t) : t), zo(Mn(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = ee();
  if (!be(e)) return !1;
...
let Wr, Ee = 0, Xr = 0, ql = 0, Va = 0, Fr = 0;
function Uo(t) {
  if (dt === void 0) return;
  let e = t.n;
...
function Xe(t, e) {
  Wt.call(this, void 0), this.x = t, this.s = void 0, this.g = Fr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Gl(t, e) {
  return new Xe(t, e);
}
...
Wt.prototype.brand = Ul, Wt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Zn(this), Ko(this), Ee++;
  const t = dt;
...
ce({ build: (t, e, r) => fr(e), config: ar({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Qn() {
  const t = Pe(), e = ee(), r = Rr();
  t.clear(), t.append(r), e !== null && r.select(), be(e) && (e.format = 0);
}
function ti(t, e = Qn) {
  return t.registerCommand($n, (r) => (t.update(e), !0), eo);
}
ce({ build: (t, e, r) => fr(e), config: ar({ $onClear: Qn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
ce({ name: "@lexical/extension/DecoratorText", nodes: () => [ei], register: (t, e, r) => t.registerCommand(In, (o) => {
  const n = ee();
  if (An(n) || be(n)) for (const i of n.getNodes()) Wl(i) && i.toggleFormat(o);
  return !1;
}, Pn) });
function ri(t, e) {
  let r;
...
const La = ce({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const co = 0, ja = 1, oi = 2, ma = 3, Pr = 4, or = 5, va = 6, br = 7;
function ba(t) {
  return t.id === co;
}
function ni(t) {
...
class Zl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Pr && pt(307, String(r.id), String(or)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== br && pt(309, String(o.id), String(br)), this.state = function(s) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= br;
    }(e) || pt(316, String(e.id), String(br)), e;
  }
...
const td = ce({ config: ar({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Ql }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const rd = /* @__PURE__ */ new Set(), Yo = ce({ build(t, e, r) {
  const o = r.getDependency(La).output, n = Tr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ri(() => {
  }, () => xe(() => {
...
ce({ dependencies: [La, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Yo).output, n = Tr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
...
ce({ build: (t, e) => fr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: ar({ $getParentEditor: function() {
  const t = Rc();
...
ce({ build: (t, e, r) => fr(e), config: ar({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return xe(() => {
...
ce({ build: (t, e, r) => fr(e), config: ar({ $canIndent: ii, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ce({ build: (t, e, r) => fr(e), config: ar({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => xe(() => r.getOutput().disabled.value ? void 0 : ci(t)) });
function wd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ie : G;
...
function hd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    wo(() => Se(Yc(n), ci(n)), [n]);
  }(o), u(wt, { children: [t, a(gd, { content: e }), a(pd, { editor: o, ErrorBoundary: r })] });
}
...
const md = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ie : G;
function vd({ onClear: t }) {
  const [e] = _e();
  return md(() => ti(e, t), [e, t]), null;
}
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ie : G;
function bd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: C = !0, style: E, tabIndex: k, "data-testid": z, ...j }, D) {
  const [$, P] = N(t.isEditable()), S = L((Y) => {
    Y && Y.ownerDocument && Y.ownerDocument.defaultView ? t.setRootElement(Y) : t.setRootElement(null);
  }, [t]), V = I(() => /* @__PURE__ */ function(...Y) {
    return (_) => {
      for (const et of Y) typeof et == "function" ? et(_) : et != null && (et.current = _);
    };
  }(D, S), [S, D]);
  return li(() => (P(t.isEditable()), t.registerEditableListener((Y) => {
    P(Y);
...
function kd(t, e) {
  ...
  return u(wt, { children: [a(xd, { editor: n, ...o, ref: e }), r != null && a(_d, { editor: n, content: r })] });
}
function _d({ content: t, editor: e }) {
  ...
  if (ie(() => (n(e.isEditable()), e.registerEditableListener((s) => {
    n(s);
  })), [e]), !r) return null;
  let i = null;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ve, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Le,
        {
          ...
          children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: t.map((m) => /* @__PURE__ */ a(
            ze,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : po(m) && (m.preventDefault(), m.stopPropagation(), se(i) && g());
        },
        onKeyDown: (m) => {
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (D) => {
                D.key === "Escape" ? (D.preventDefault(), D.stopPropagation(), g()) : po(D) && (D.preventDefault(), D.stopPropagation(), se(w) && f());
              },
              onKeyDown: (D) => {
        ...
        j && /* @__PURE__ */ u(Fe, { children: [
          /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(us, {}) }) }),
          /* @__PURE__ */ a(Ke, { align: "end", children: j })
        ] })
      ]
    }
  );
...
function xi({
  ...
  const [_, et] = N(tn), [B, X] = N(), [M, O] = N(), W = o, [ot, Pt] = N(!1), [Ot, qt] = N(!1), [q, it] = N(!1), [gt, lt] = N(!1), [ft, Zt] = N(!1), [Ct, xt] = N(z), [Et, Gt] = N(!1), yt = F(void 0), [Vt, R] = N(/* @__PURE__ */ new Map());
  G(() => {
    let y = !0;
    return (async () => {
  ...
  const re = I(() => _t[0], [_t]), Ge = F(null), le = F(void 0), de = L(() => {
    var y;
    (y = le.current) == null || y.call(le), et(tn);
  }, []), He = L(() => {
    const y = !Ct;
    xt(y), Gt(!y), f == null || f(l, y);
  }, [Ct, f, l]);
  G(() => {
    Pt(!1);
  }, [o]), G(() => {
  ...
  }, [i, r]), $t = I(() => _t.slice(1), [_t]), Dt = I(() => $t.length ?? 0, [$t.length]), oe = I(() => Dt > 0, [Dt]), T = I(() => ot || Dt <= 2 ? $t : $t.slice(-2), [$t, Dt, ot]), U = I(() => ot || Dt <= 2 ? 0 : Dt - 2, [Dt, ot]), nt = I(
    () => Dt === 1 ? Tt.singleReply : Qe(Tt.multipleReplies, { count: Dt }),
    [Dt, Tt]
  ), J = I(
    () => U === 1 ? Tt.singleReply : Qe(Tt.multipleReplies, { count: U }),
    [U, Tt]
  );
  G(() => {
    !o && Ot && oe && qt(!1);
  ...
  const Z = L(
    async (y) => {
      ...
      rt && await p({ threadId: l, contents: rt }) && de();
    },
    [
      de,
      _,
    ...
    async (y) => {
      const rt = se(_) ? Zr(_) : void 0, at = y.status ? y.assignedUser : B ?? y.assignedUser, ut = await p({
        ...y,
        contents: rt,
        assignedUser: at
      });
      return ut && (at !== void 0 && O(at), rt && de()), ut;
    },
    [de, _, p, B]
  );
      ...
      children: /* @__PURE__ */ u(Vd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        ...
        /* @__PURE__ */ u(wt, { children: [
          ...
          o && /* @__PURE__ */ u(wt, { children: [
            Y && T.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            U > 0 && /* @__PURE__ */ u(
              "div",
              {
            ...
            m !== !1 && (!Ot || se(_)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (y) => {
                  po(y) && (y.preventDefault(), y.stopPropagation(), (se(_) || B !== void 0 && B !== M) && Z());
                },
                onKeyDown: (y) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    B !== void 0 && (se(_) || B !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Qe(
                    ...
                    /* @__PURE__ */ u(Ve, { open: q, onOpenChange: it, children: [
                      /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ a(
                        H,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Le,
                        {
                          ...
                          children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: b == null ? void 0 : b.map((y) => /* @__PURE__ */ a(
                            ze,
                            {
                              onSelect: () => {
...
function Ud({
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), _ = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : Y, et = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: C }) : Y : _(M === "reject" ? t.rejectedResultText : t.resultText);
      ...
      !w && !h && /* @__PURE__ */ u(wt, { children: [
        ...
        /* @__PURE__ */ a(
          Ka,
          {
            ...
            children: D.map((M) => B(M) ? /* @__PURE__ */ a(Bt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
              /* @__PURE__ */ a(Ut, { asChild: !0, children: X(M) }),
              /* @__PURE__ */ a(Kt, { children: z })
            ] }) }, M.value) : X(M))
          }
        ),
...
function Wd({ table: t }) {
  return /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function hr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Jt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Jt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Tn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ue({
  ...
  return /* @__PURE__ */ u(
    Jt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Jt.ItemIndicator, { children: /* @__PURE__ */ a(oa, { className: "tw:pointer-events-none" }) }) }),
...
function tw({
  ...
  let j;
  return l ? j = Array.from({ length: 10 }).map((S, V) => `skeleton-row-${V}`).map((S) => /* @__PURE__ */ a($e, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(sr, { colSpan: z.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((D = k.getRowModel().rows) == null ? void 0 : D.length) > 0 ? j = k.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    $e,
    {
      onClick: () => s($, k),
      "data-state": $.getIsSelected() && "selected",
      children: $.getVisibleCells().map((P) => /* @__PURE__ */ a(sr, { children: kr(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    $.id
  )) : j = /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(sr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Wd, { table: k }),
    /* @__PURE__ */ u(Ha, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ya, { stickyHeader: i, children: k.getHeaderGroups().map(($) => /* @__PURE__ */ a($e, { children: $.headers.map((P) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : kr(P.column.columnDef.header, P.getContext()) }, P.id)) }, $.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(H, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(xn, {}) })
        ] }),
...
function xp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(Ke, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(hn, { children: d.itemType === 0 ? /* @__PURE__ */ a(wt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ie,
        {
          checked: o[w][h],
...
function sw(t, e, r) {
  ...
  if (t.key === "ArrowDown" || t.key === "ArrowUp")
    return fe(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue";
  if (t.key === "Enter")
    return fe(t), nw(
  ...
  if (t.key === "Escape")
    return fe(t), r.dismiss(), "ended";
  if (t.key === " ") {
    if (e.kind === "backslash")
      return fe(t), (o = e.shouldSpaceCommit) != null && o.call(e, e.filter) ? (r.commit(), "ended") : (r.commitTyped(e.filter), r.dismiss(), "ended");
    if (e.kind === "selection") {
      fe(t);
      const n = e.items.find((i) => i.marker === e.filter);
      return n && r.commitItem(n.marker), r.dismiss(), "ended";
    }
    return fe(t), e.filter += " ", r.update({ filterText: e.filter }), "continue";
  }
  return t.key === "*" && e.kind === "backslash" ? (fe(t), r.commitTypedCloser(e.filter), r.dismiss(), "ended") : t.key === "Backspace" && e.filter === "" ? (fe(t), r.dismiss(), "ended") : t.key === "Backspace" || iw[e.kind].test(t.key) ? (fe(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && fe(t), r.dismiss(), "ended");
}
function rn(t, e) {
  var r;
...
const ww = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(wt, { children: [
...
function uw({
  ...
  return /* @__PURE__ */ u(Fe, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: ww(t, n, r) }) }) }),
...
const pw = (t, e) => t === "f" ? /* @__PURE__ */ u(wt, { children: [
  /* @__PURE__ */ a(kn, {}),
  " ",
...
function gw({
  ...
  return /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: pw(t, r) }) }) }),
      /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ a("p", { children: hw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ke, { style: { zIndex: gn }, children: [
...
function Np({
  ...
  const [b, m] = N("generated"), [C, E] = N("generated"), [k, z] = N("*"), [j, D] = N("*"), [$, P] = N("f"), [S, V] = N(!1), [Y, _] = N(!0), [et, B] = N(!1), X = F(!1), M = F(""), [O, W] = N(!1), [ot, Pt] = N(), [Ot, qt] = N(), [q, it] = N(), [gt, lt] = N(), ft = F(null), Zt = F(void 0), Ct = F(0), xt = F(void 0), Et = I(
    () => ({
      ...s,
  ...
  G(() => {
    ...
    if (J && $r("note", J)) {
      const Q = (Z = J.insert.note) == null ? void 0 : Z.caller;
      let y = "custom";
      Q === Ia ? y = "generated" : Q === Aa ? y = "hidden" : Q && (z(Q), D(Q)), m(y), E(y), P(((st = J.insert.note) == null ? void 0 : st.style) ?? "f"), T = setTimeout(() => {
        var rt, at, ut;
        (rt = p.current) == null || rt.applyUpdate([J]), (at = p.current) == null || at.selectNote(0), (ut = p.current) == null || ut.focus(), U = requestAnimationFrame(() => {
          nt = setTimeout(() => {
            var mt, Nt;
  ...
  const Vt = L(
    (T, U, nt = !1) => {
      ...
      if (J && $r("note", J)) {
        ...
        r == null || r([J]), nt && d && i && ((Q = d.current) == null || Q.replaceEmbedUpdate(i, [J]));
      }
    },
    [i, r, d]
  ), R = L(() => {
    var T;
    Zt.current || (T = p.current) == null || T.commitPendingMarkerEdits(), Vt(b, k, !0), o();
  }, [b, k, o, Vt]), kt = F(R);
  ie(() => {
    kt.current = R;
  });
  ...
  const re = () => {
    ...
    if (U && $r("note", U)) {
      ...
      $ !== "x" && T === "x" ? y == null || y.forEach((rt) => kw(rt)) : $ === "x" && T !== "x" && (y == null || y.forEach((rt) => _w(rt))), (Q = p.current) == null || Q.applyUpdate([U, { delete: 1 }]);
    }
  }, He = (T) => {
    ...
    (T) => {
      ...
      if (U && $r("note", U)) {
        ...
        const y = (Z = U.insert.note) == null ? void 0 : Z.style, rt = (Q = (st = U.insert.note) == null ? void 0 : st.contents) == null ? void 0 : Q.ops;
        if (y || V(!1), V(
          y === "x" ? !!(rt != null && rt.every((at) => {
            var mt, Nt;
            if (!((mt = at.attributes) != null && mt.char)) return !0;
            const ut = ((Nt = at.attributes) == null ? void 0 : Nt.char).style;
    ...
    if (g.current && Gt.length && T && T.rangeCount > 0) {
      const U = T.getRangeAt(0).getBoundingClientRect(), nt = g.current.getBoundingClientRect();
      Pt(U.left - nt.left), qt(U.top - nt.top), it(U.height), W(!0);
    }
  }, [Gt, g]), $t = L(
    (T, U, nt) => {
      ...
      Zt.current = {
        ...
        filter: "",
        items: U
      }, w.show(U.map(yw), J, Z).then((Q) => {
        var y, rt, at, ut, mt, Nt;
        if (rn(Zt, st), Q !== void 0) {
          if (!((y = p.current) != null && y.getSelection())) {
            const ne = xt.current;
            ne ? (rt = p.current) == null || rt.setSelection(ne) : (at = p.current) == null || at.selectNote(0);
          }
          (ut = p.current) == null || ut.focus();
          const we = U.find((ne) => ne.marker === Q);
          we && ((mt = p.current) == null || mt.applyMarkerMenuSelection(we, {
            trigger: "backslash",
        ...
        } else Z || (Nt = p.current) == null || Nt.focus();
      }).catch(() => {
        var Q;
        rn(Zt, st), Z || (Q = p.current) == null || Q.focus();
      });
    },
    [w]
  );
  G(() => {
    ...
    if (((J = Et.view) == null ? void 0 : J.markerMode) === "editable") {
      const Z = (Q) => {
        var mt, Nt, we, ne, Re;
        if (yi(Q) || !T || document.activeElement !== T) return;
        const y = Zt.current;
        if (y && w) {
          sw(Q, y, {
            ...
            update: (Qt) => w.update(Qt),
            commit: () => w.commit(),
            dismiss: () => w.dismiss(),
            commitTyped: (Qt) => {
              var Lt;
              return (Lt = p.current) == null ? void 0 : Lt.commitTypedMarker(Qt);
            },
            commitTypedCloser: (Qt) => {
              var Lt;
              return (Lt = p.current) == null ? void 0 : Lt.commitTypedCloser(Qt);
            },
            commitItem: (Qt) => {
              var x;
              const Lt = y.items.find((K) => K.marker === Qt);
              Lt && ((x = p.current) == null || x.applyMarkerMenuSelection(Lt, {
                trigger: "backslash",
                literalPrefixLanded: !1
              }));
            }
          }) === "ended" && (Zt.current = void 0);
          return;
        }
        if (Q.key === "Enter" && !yt()) {
          Q.preventDefault(), Q.stopPropagation(), (mt = p.current) == null || mt.selectNote(0), (Nt = p.current) == null || Nt.focus();
          return;
        }
        if (!w || Q.key !== c) return;
        if (!yt()) {
          Q.preventDefault(), Q.stopPropagation(), (we = p.current) == null || we.selectNote(0), (ne = p.current) == null || ne.focus();
          return;
        }
        const rt = (Re = p.current) == null ? void 0 : Re.getMarkerMenuContext();
        if (!rt) return;
        const at = sl(Et.styleInfo ?? cl, rt);
        if (at.length === 0) return;
        const ut = !rt.hasTextSelection;
        Q.preventDefault(), Q.stopPropagation(), $t(rt, at, { passive: ut });
      }, st = () => {
        var Q, y;
        !T || document.activeElement !== T || yt() || ((Q = p.current) == null || Q.selectNote(0), (y = p.current) == null || y.focus());
      };
    ...
    const U = (Z) => {
      !O && T && document.activeElement === T && Z.key === c ? (Z.preventDefault(), ae()) : O && Z.key === "Escape" && (Z.preventDefault(), W(!1));
    };
    ...
    ae,
    c,
    (oe = Et.view) == null ? void 0 : oe.markerMode,
    Et.styleInfo,
    w,
    $t,
    yt
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
              ...
              /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ a("p", { children: Dt }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(wt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(wt, { children: Cw(t.marker, c, o, d) })
      }
    )
  ] });
}
...
function zw({
  ...
  return /* @__PURE__ */ u(Ha, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ya, { stickyHeader: !0, children: /* @__PURE__ */ u($e, { children: [
    ...
    /* @__PURE__ */ a(Wa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      $e,
      {
        ...
        children: [
          /* @__PURE__ */ a(sr, { children: Ce(c.reference, "English") }),
...
}, ia = (t, e, r) => /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
  /* @__PURE__ */ u(
    Ut,
    {
...
function $p({
  ...
  const g = me(r, "%webView_inventory_all%"), f = me(r, "%webView_inventory_approved%"), b = me(r, "%webView_inventory_unapproved%"), m = me(r, "%webView_inventory_unknown%"), C = me(r, "%webView_inventory_scope_currentBook%"), E = me(r, "%webView_inventory_scope_chapter%"), k = me(r, "%webView_inventory_scope_verse%"), z = me(r, "%webView_inventory_filter_text%"), j = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), D = me(r, "%webView_inventory_no_results%"), [$, P] = N(!1), [S, V] = N("all"), [Y, _] = N(""), [et, B] = N([]), X = I(() => {
    const q = t ?? [];
    ...
    const q = [];
    return X.forEach((it) => {
      const gt = it.items[0], lt = q.find(
        (ft) => ft.items[0] === gt
      );
      lt ? (lt.count += it.count, lt.occurrences = lt.occurrences.concat(it.occurrences)) : q.push({
        items: [gt],
        count: it.count,
  ...
  }, [$, X]), O = I(() => M.length === 0 ? [] : Ow(M, S, Y), [M, S, Y]), W = I(() => {
    var gt, lt;
    if (!$) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(ur, { onValueChange: (q) => Pt(q), defaultValue: s, children: [
        /* @__PURE__ */ a(hr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(pr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(gr, { children: [
          /* @__PURE__ */ a(ue, { value: "book", children: C }),
          /* @__PURE__ */ a(ue, { value: "chapter", children: E }),
      ...
      o && /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
        ...
        /* @__PURE__ */ a(Kt, { children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] }) })
    ] }),
...
const Iw = "16rem", Aw = "3rem", _i = Xt.createContext(void 0);
function sa() {
  const t = Xt.useContext(_i);
  if (!t)
...
function Pw({
  ...
  const [l, d] = Xt.useState(t), w = e ?? l, p = Xt.useCallback(
    ...
    [r, w]
  ), h = Xt.useCallback(() => p((k) => !k), [p]), g = w ? "expanded" : "collapsed", m = ye() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Xt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
const Me = "scrBook", Gw = "scrRef", Je = "source", Hw = "details", Yw = "Scripture Reference", Ww = "Scripture Book", Ni = "Type", Xw = "Details";
function Jw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? bt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Me ? Ce(n.start) : void 0;
      },
...
function Wp({
  ...
  const [d, w] = N([]), [p, h] = N([{ id: Me, desc: !1 }]), [g, f] = N({}), b = I(
  ...
  G(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const Y = b.find((_) => ln(_) === V[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, C]);
  ...
  }, $ = (S, V) => S.getIsGrouped() ? "" : v("banded-row", V % 2 === 0 ? "even" : "odd"), P = (S, V, Y) => {
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gr, { position: "item-aligned", children: /* @__PURE__ */ a(Xd, { children: z.map((S) => /* @__PURE__ */ a(ue, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: C.getHeaderGroups().map((S) => /* @__PURE__ */ a($e, { children: S.headers.filter((V) => V.column.columnDef.header).map((V) => (
        ...
        return /* @__PURE__ */ a(
          $e,
          {
            ...
            children: S.getVisibleCells().map((_) => {
              if (!(_.getIsPlaceholder() || _.column.columnDef.enableGrouping && !_.getIsGrouped() && (_.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  sr,
                  {
                    className: v(
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === _a ? _a : dn
      ).map((l) => /* @__PURE__ */ a(Nr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Oe(l, n) }, l)),
...
function Jp({
  ...
  const z = It(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = It(s, "%webView_scope_selector_current_book%"), Y = It(s, "%webView_scope_selector_choose_books%"), _ = It(s, "%webView_scope_selector_scope%"), et = It(s, "%webView_scope_selector_select_books%"), B = It(s, "%webView_scope_selector_range%"), X = It(s, "%webView_scope_selector_select_range%"), M = It(s, "%webView_scope_selector_range_start%"), O = It(s, "%webView_scope_selector_range_end%"), W = It(s, "%webView_scope_selector_ok%"), ot = It(s, "%webView_scope_selector_cancel%"), Pt = It(s, "%webView_scope_selector_navigate%"), Ot = (A) => {
    if (!f) return;
  ...
  ], q = (A, tt, te = !1) => /* @__PURE__ */ u(wt, { children: [
    A,
    tt && !te && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), it = e ? qt.filter((A) => e.includes(A.value)) : qt, gt = f ?? wa, lt = w ?? gt, ft = p ?? gt, Zt = () => {
  }, Ct = F(null), xt = F(null), Et = F(!1), Gt = F(null), yt = F(!1), [Vt, R] = N(void 0), kt = F(!1), _t = F(!1), re = F(null), Ge = L((A) => {
    if (A) {
      R("start"), kt.current = !1;
      return;
    }
    R((tt) => tt === "start" ? void 0 : tt), kt.current && (kt.current = !1, requestAnimationFrame(() => {
      var te;
    ...
    [r, n, f, i]
  ), ae = it.find((A) => A.value === t), $t = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? qs(lt, ft, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ae ? q(ae.label, ae.scrRefSuffix) : t, Dt = it.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), oe = it.find((A) => A.value === "selectedBooks"), T = it.find((A) => A.value === "range"), [U, nt] = N(!1), [J, Z] = N(void 0), [st, Q] = N(void 0), [y, rt] = N(void 0), [at, ut] = N(void 0), [mt, Nt] = N([]), we = d === "dropdown" && J === "selectedBooks", ne = /* @__PURE__ */ a(
    eu,
    {
      availableBookInfo: o,
      selectedBookIds: we ? mt : n,
      onChangeSelectedBookIds: we ? Nt : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), Re = Vt === "end", mr = Vt === "start", Qt = "tw:text-muted-foreground", Lt = d === "dropdown" && J === "range", x = Lt ? rt : de, ct = Lt ? ut : g ? He : Zt, jt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Rt, { htmlFor: "scope-range-start", className: v(Re && Qt), children: M }),
      /* @__PURE__ */ a(
        pa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ct, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Rt, { htmlFor: "scope-range-end", className: v(mr && Qt), children: O }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: m,
          getEndVerse: C,
          disableReferencesUpTo: Lt ? y ?? lt : lt,
          onOpenChange: le,
          onCloseAutoFocus: (A) => {
            var tt;
            _t.current && (_t.current = !1, A.preventDefault(), (tt = re.current) == null || tt.focus());
          },
          className: v(mr && Qt),
          modal: !0,
          align: "start"
  ...
  const [Mt, St] = N(null), [zt, vt] = N(null), [Ht, ge] = N(null), We = 200, [$i, Ii] = N(!1);
  G(() => {
    if (!Ht || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([tt]) => {
      Ii(tt.contentRect.width < We);
    });
    return A.observe(Ht), () => A.disconnect();
  }, [Ht]);
  const fo = L(
    (A) => {
      Q(A), rt(lt), ut(ft), Nt(n), nt(!1), Z(A);
    },
    [lt, ft, n]
  ), mo = L(() => {
    st !== void 0 && (st === "range" ? (y && (h == null || h(y)), at && (g == null || g(at))) : st === "selectedBooks" && i(mt), Tt(st), Z(void 0), Q(void 0));
  }, [
    st,
    y,
    at,
    ...
    var tt;
    A.preventDefault(), (tt = Ye.current) == null || tt.focus();
  }, []), bo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ae, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(Rt, { children: _ }),
      d === "dropdown" ? /* @__PURE__ */ u(Fe, { open: U, onOpenChange: nt, children: [
        ...
        /* @__PURE__ */ a(
          Ke,
          {
            ...
            children: /* @__PURE__ */ u(ca, { container: Ht, children: [
              Dt.map(({ value: A, label: tt, dropdownLabel: te, scrRefSuffix: vr, id: Ai }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: De(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ae, { className: "tw:h-4 tw:w-4" }) }),
                    q(te ?? tt, vr, $i)
                  ]
                },
                Ai
                ...
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ...
                    onSelect: (A) => {
                      ...
                      yt.current || (te = (tt = xt.current) == null ? void 0 : tt.querySelector("button")) == null || te.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          tt != null && tt.closest("button") && (Et.current = !0, requestAnimationFrame(() => {
                            Et.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          pa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var tt;
                              A.preventDefault(), (tt = Gt.current) == null || tt.focus();
                            },
                            modal: !0,
        ...
        Ka,
        {
          ...
          children: it.map(({ value: A, label: tt, scrRefSuffix: te, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: vr }),
            /* @__PURE__ */ a(Rt, { htmlFor: vr, children: q(tt, te) })
          ] }, vr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && jt,
    d === "dropdown" && oe && /* @__PURE__ */ a(Na, { open: J === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ca,
      {
        ref: vt,
        onCloseAutoFocus: vo,
        ...
        children: /* @__PURE__ */ u(ca, { container: zt, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Mr(!1), children: ot }),
            /* @__PURE__ */ a(H, { onClick: mo, children: W })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && T && /* @__PURE__ */ a(Na, { open: J === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ca,
      {
        ...
        children: /* @__PURE__ */ u(ca, { container: Mt, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Mr(!1), children: ot }),
            /* @__PURE__ */ a(H, { ref: re, onClick: mo, children: W })
          ] })
        ] })
      }
    ) })
...
function Ba({
  ...
  return /* @__PURE__ */ u(Fe, { variant: i, children: [
    /* @__PURE__ */ a(Ue, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(H, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Is, {}) }) }),
    /* @__PURE__ */ a(Ke, { align: "start", style: { zIndex: rr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(Bt, { children: Si(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(tr, {})
    ] }, l)) })
  ] });
}
const zi = Xt.forwardRef(
...
const Ri = Xt.forwardRef(({ className: t, ...e }, r) => {
  const o = ye();
  return /* @__PURE__ */ a(
    he.Root,
    {
...
const Di = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.List,
  {
    ref: r,
    className: v(
...
const ou = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
  ...
  if (ll(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (C = l.current) == null || C.focus(), xr(l, [h, g]);
        break;
    }
  }), G(() => {
    ...
    return /* @__PURE__ */ a(nu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(iu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: rr },
          children: /* @__PURE__ */ a(Bt, { children: Oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function sh({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Rt, { className: "tw:font-normal tw:text-muted-foreground", children: Qe(d, {
