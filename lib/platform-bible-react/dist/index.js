...
import { V as ng, W as ig, X as sg, Y as cg, _ as lg, $ as dg, a0 as wg, a1 as ug, a2 as pg } from "./resizable-CX1Q8cJa.js";
...
import { Check as Ve, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as $a, ChevronRight as Ma, ArrowLeft as hs, ArrowRight as gs, ChevronDown as or, BoldIcon as fs, ItalicIcon as ms, X as na, AtSign as gn, Pencil as vs, Trash2 as bs, ArrowUp as fn, MoreHorizontal as xs, MailOpen as ys, Mail as ks, ChevronUp as _s, FilterIcon as Ns, ArrowLeftIcon as Cs, ChevronLeftIcon as Es, ChevronRightIcon as Ts, ArrowRightIcon as zs, Copy as mn, Filter as Ss, User as Ds, Link as Os, CircleHelp as Rs, ChevronsUpDown as vn, Star as $s, Undo as Ms, Redo as As, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Ps, AlertCircle as Aa, CircleCheckIcon as Is, CircleXIcon as Vs, CircleHelpIcon as Ls, ArrowUpIcon as js, ArrowDownIcon as Fs, Search as Bs, LoaderCircle as Us, ScrollText as Ks, MenuIcon as qs, Menu as Gs, EllipsisVertical as Hs, MoreVertical as Eo } from "lucide-react";
import pt, { useRef as G, useMemo as P, useState as N, useCallback as B, useEffect as W, useLayoutEffect as te, createContext as Xa, useContext as kn, Component as Ys, createElement as To, Suspense as Ws, forwardRef as ia, useId as zo, Fragment as _n } from "react";
import { Dialog as ve, Label as Xs, RadioGroup as Pa, ToggleGroup as Nn, Slot as wr, Avatar as Ja, Select as Ft, Checkbox as So, Tabs as pe, Menubar as ye, ContextMenu as $t, Progress as Do, Slider as Pr, Switch as Oo } from "radix-ui";
import { createEditor as Cn, $getRoot as Le, $createParagraphNode as Tr, $getSelection as Ht, HISTORY_MERGE_TAG as Za, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Js, $isRangeSelection as be, $caretFromPoint as Zs, $getSiblingCaret as zn, $getChildCaret as Qs, $getAdjacentChildCaret as tc, $isChildCaret as ec, $normalizeCaret as rc, $setSelectionFromCaretRange as ac, $getCollapsedCaretRange as oc, $getCaretInDirection as Ro, $splitAtPointCaretNext as nc, $isTextPointCaret as ic, $findMatchingParent as Sn, $isElementNode as yr, mergeRegister as De, getDOMTextNode as sc, isHTMLElement as cc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as Qa, shallowMergeConfig as lc, defineExtension as se, safeCast as Je, createState as dc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as Rn, COMMAND_PRIORITY_LOW as $n, RootNode as wc, LineBreakNode as uc, TabNode as pc, $isEditorState as hc, createCommand as gc, CLICK_COMMAND as fc, isDOMNode as mc, $getNodeFromDOMNode as vc, $createNodeSelection as bc, $setSelection as xc, $getEditor as yc, DecoratorNode as Ia, $getState as kc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as _c, $setState as Nc, addClassNamesToElement as Mn, $create as Cc, $getNodeByKey as Ec, removeClassNamesFromElement as Tc, KEY_TAB_COMMAND as zc, $isBlockElementNode as Sc, $createRangeSelection as Dc, $normalizeSelection__EXPERIMENTAL as Oc, OUTDENT_CONTENT_COMMAND as Rc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as $c, COMMAND_PRIORITY_CRITICAL as to, $isDecoratorNode as Mc, $isParagraphNode as Ac, $isTextNode as Va, SELECTION_CHANGE_COMMAND as An, $insertNodes as Pc } from "lexical";
import { HeadingNode as Ic, QuoteNode as Vc, registerRichText as Lc } from "@lexical/rich-text";
import { flushSync as jc, createPortal as Fc } from "react-dom";
import { IconX as Bc, IconCheck as sa, IconChevronDown as Uc, IconChevronUp as Kc, IconSelector as qc, IconLayoutSidebar as Gc, IconLayoutSidebarRight as Hc, IconChevronRight as Pn, IconLoader as Yc, IconAlertOctagon as Wc, IconAlertTriangle as Xc, IconInfoCircle as Jc, IconCircleCheck as Zc } from "@tabler/icons-react";
...
import { useReactTable as Vn, getFilteredRowModel as rl, getSortedRowModel as Ln, getPaginationRowModel as al, getCoreRowModel as jn, flexRender as vr, getGroupedRowModel as ol, getExpandedRowModel as nl } from "@tanstack/react-table";
import il from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as La, HIDDEN_NOTE_CALLER as ja, getDefaultViewOptions as sl, isInsertEmbedOpOfType as Ir, Editorial as cl } from "@eten-tech-foundation/platform-editor";
...
function ba({
  ...
  const k = Yt(), [_, R] = N(!1), [j, T] = N(""), [$, M] = N(""), [x, D] = N("books"), [L, C] = N(void 0), [z, q] = N(
    void 0
  ), [U, A] = N(void 0), [F, et] = N(!1), Z = G(null), Nt = G(!1), mt = G(void 0), Tt = G(void 0), H = G(void 0), at = G(void 0), vt = G({}), ct = G({}), lt = B(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  }), [Wt]), Xt = P(() => Object.values(dt).flat(), [dt]), ee = P(() => {
    if (!$.trim()) return dt;
    const b = {
      [tt.OT]: [],
      [tt.NT]: [],
  ...
  const ce = B(() => {
    ...
    D("books"), C(void 0), q(void 0), A(void 0), setTimeout(() => {
      Tt.current && Tt.current.focus();
    }, 0);
  }, []), V = B(() => {
    const b = z;
    q(void 0), A(void 0), b ? (C(b), D("chapters"), T("")) : Pt();
  }, [z, Pt]), J = B((b) => {
    R(b), b && (D("books"), C(void 0), q(void 0), A(void 0), M(""));
    ...
    () => ml($),
    [$]
  ), Dt = P(() => !l || !O || !O.chapterNum || !It ? !1 : l(O.book, O.chapterNum) > 0, [l, O, It]), Ke = B(
    (b) => w ? Po(b, w) : !1,
    [w]
  ), S = B(
    (b) => (Y) => w ? vl(b, Y, w) : !1,
    ...
    const { isLetter: Y, isDigit: Q } = Io(b.key);
    (Y || Q) && (b.preventDefault(), M((oe) => oe + b.key), Tt.current.focus(), et(!1));
  }, []);
  return te(() => {
    const b = setTimeout(() => {
              ...
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  K,
                  {
                    ...
                    tabIndex: -1,
                    children: k === "ltr" ? /* @__PURE__ */ a(hs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(gs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
...
function jo({
  ...
  const [_, R] = N(!1), j = l ?? d, T = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], $ = (M, x) => {
    const D = d(M), L = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, C = `${x ?? ""}${D}${L ?? ""}`;
    return /* @__PURE__ */ u(
      Oe,
      {
        value: D,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          ...
          /* @__PURE__ */ a(Be, { children: T(e) ? e.map((M) => /* @__PURE__ */ a(me, { heading: M.groupHeading, children: M.options.map((x) => $(x, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(me, { children: e.map((M) => $(M)) }) })
        ] })
      }
    )
  ] });
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = Hn ? te : W, Vr = { tag: Za };
function Cl({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = _l(null, o), w = Cn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
...
const Rl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function $l(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ml() {
  return function(t) {
    const [e] = ke(), r = P(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = G(o);
    return Rl(() => {
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = Yn && "documentMode" in document ? document.documentMode : null;
!(!Yn || !("InputEvent" in window) || Pl) && "getTargetRanges" in new window.InputEvent("input");
function ge(t) {
  return `${t}px`;
}
...
function Vl(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: g } = n.getBoundingClientRect(), h = Al(t, e);
    var m, y;
    ...
    for (let E = 0; E < h.length; E++) {
      ...
      const M = ge(k.height);
      R.height !== M && (_.style.height = M, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[E] = _;
    }
  ...
  function l(w) {
    w.read(() => {
      ...
      const [g, h] = function(M) {
        const x = M.getStartEndPoints();
        return M.isBackward() ? [x[1], x[0]] : x;
      ...
      if ((T || $) && R !== null && j !== null) {
        const M = function(x, D, L, C, z, q, U) {
          const A = (x._window ? x._window.document : document).createRange();
          return A.setStart(...Fo(D, L, C)), A.setEnd(...Fo(z, q, U)), A;
        }(t, g, m, R, h, E, j);
        d(), d = Vl(t, M, e);
      }
...
function Ul(t) {
  const e = Ht() || Js();
  let r;
  if (be(e)) r = Zs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = zn(c, "next"));
    }
    r = r || Qs(Le(), "previous").getFlipped().insert(Tr());
  }
  const o = Kl(t, r), n = tc(o), i = ec(n) ? rc(n) : o;
  return ac(oc(i)), t.getLatest();
}
function Kl(t, e, r) {
  let o = Ro(e, "next");
  for (let n = o; n; n = nc(n, r)) o = n;
  return ic(o) && Jr(283), o.insert(t.isInline() ? Tr().append(t) : t), Ro(zn(t.getLatest(), "next"), e.direction);
}
function ql(t) {
  const e = Ht();
  if (!be(e)) return !1;
...
let Zr, Ee = 0, Qr = 0, Yl = 0, Ka = 0, Ur = 0;
function Uo(t) {
  if (it === void 0) return;
  let e = t.n;
...
jt.prototype.brand = Gl, jt.prototype.h = function() {
  return !0;
...
const ka = dc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ti extends Ia {
  $config() {
...
se({ name: "@lexical/extension/DecoratorText", nodes: () => [ti], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Ht();
  if (Rn(n) || be(n)) for (const i of n.getNodes()) Zl(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function ei(t, e) {
  let r;
...
class ed {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : lc;
...
const ad = se({ config: Je({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = rd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (hc(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [wc, Tn, uc, pc, En] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function od(t) {
  throw t;
...
class rr {
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const g of Jl(p)) {
...
const nd = /* @__PURE__ */ new Set(), Yo = se({ build(t, e, r) {
...
se({ dependencies: [qa, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return De(t.registerCommand(id, (s) => {
    const c = Ht();
    if (!be(c)) return !1;
    ...
    return !0;
  }, Qa), t.registerCommand(fc, (s) => {
    if (mc(s.target)) {
      const c = vc(s.target);
      if (cd(c)) return function(d, l = !1) {
        const w = Ht(), p = d.isSelected(), g = d.getKey();
        let h;
        l && Rn(w) ? h = w : (h = bc(), xc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function ld(t, e, r = ni) {
  return De(t.registerCommand(zc, (o) => {
    const n = Ht();
    if (!be(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => Sc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Bl(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Dc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Oc(h), h.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Rc : Mo : $c;
...
const dd = se({ name: "@lexical/react/ReactProvider" });
function wd() {
...
const xd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function yd({ onClear: t }) {
  const [e] = ke();
  return xd(() => Qn(e, t), [e, t]), null;
}
...
function Dd({
  ...
  const [e] = ke(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Sd(), d = () => {
  };
...
function Ad({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Dd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a($d, {}) }) }),
...
const Ld = "verseText", lp = Object.freeze([
...
function dp({
  ...
  const [i, s] = N(jd), [c, d] = N(n), [l, w] = N(!1), p = G(void 0), g = G(null);
  W(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
...
function Qo({
  ...
  const h = B(
    ...
    [t.user]
  ), k = P(() => Wa(t.contents), [t.contents]), _ = P(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), R = !!t.conflictResolutionAction && !_, j = P(() => {
    if (o && c)
      return /* @__PURE__ */ u(rt, { children: [
        /* @__PURE__ */ u(
          We,
          {
            onClick: (T) => {
              T.stopPropagation(), l(!0), p(Id(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Ud, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Kd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        ...
        j && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(xs, {}) }) }),
...
function ki({
  ...
  const [C, z] = N(tn), [q, U] = N(), [A, F] = N(), et = o, [Z, Nt] = N(!1), [mt, Tt] = N(!1), [H, at] = N(!1), [vt, ct] = N(!1), [lt, Wt] = N(!1), [dt, Xt] = N(R), [ee, O] = N(!1), re = G(void 0), [ce, Jt] = N(/* @__PURE__ */ new Map());
  W(() => {
    let S = !0;
    return (async () => {
  ...
  const ae = P(() => zt[0], [zt]), Me = G(null), Pt = G(void 0), V = B(() => {
    var S;
  ...
  }, [i, r]), ht = P(() => zt.slice(1), [zt]), st = P(() => ht.length ?? 0, [ht.length]), bt = P(() => st > 0, [st]), gt = P(() => Z || st <= 2 ? ht : ht.slice(-2), [ht, st, Z]), xt = P(() => Z || st <= 2 ? 0 : st - 2, [st, Z]), Mt = P(
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              K,
              {
                ...
                children: dt ? /* @__PURE__ */ a(ys, {}) : /* @__PURE__ */ a(ks, {})
              }
            ),
            D === void 0 ? (
          ...
          o && /* @__PURE__ */ u(rt, { children: [
            ...
            v !== !1 && (!mt || ne(C)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  po(S) && (S.preventDefault(), S.stopPropagation(), (ne(C) || q !== void 0 && q !== A) && It());
                },
                onKeyDown: (S) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    q !== void 0 && (ne(C) || q !== A) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ne(
...
), Gd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Gr = (t) => Gd(Wa(t));
function Hr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Hd({
  ...
  const [s, c] = N("accept"), d = zo(), l = zo(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", m = p ? "accept" : s, y = P(
    () => Gr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = P(
    () => Gr(t.acceptedText ?? ""),
    ...
    () => Gr(t.mergedText ?? ""),
    [t.mergedText]
  ), k = P(() => Wa(t.contents), [t.contents]);
  if (!bi(t))
    return /* @__PURE__ */ a(Hr, { html: k });
  const _ = (A) => {
    c(A === "reject" || A === "merge" ? A : "accept");
  ...
  const D = e["%conflict_note_no_result%"] ?? "No result preview available.", L = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: D }), C = (A) => A ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: A }) : L, z = () => {
    const A = o ?? "accept";
    return A === "merged" ? t.mergedText ? /* @__PURE__ */ a(Hr, { html: E }) : L : C(A === "reject" ? t.rejectedResultText : t.resultText);
  }, q = (A) => p && A.value === "reject", U = (A) => {
    const F = m === A.value, et = `${l}-${A.value}`, Z = q(A);
    return (
        ...
        "label",
        {
          ...
          children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a("span", { "aria-hidden": !0, className: "tw:font-medium", children: A.label })
            ] }),
  ...
  return (
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", onClick: (A) => A.stopPropagation(), children: [
      ...
      !w && !g && /* @__PURE__ */ u(rt, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: T.map((A) => q(A) ? /* @__PURE__ */ a(Ut, { delayDuration: 0, children: /* @__PURE__ */ u(Kt, { children: [
              /* @__PURE__ */ a(qt, { asChild: !0, children: U(A) }),
...
function Zd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Jd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function vp({
  ...
  const [k, _] = N(/* @__PURE__ */ new Set()), [R, j] = N(), [T, $] = N(), M = B(
    async (F) => {
      const et = await i(F);
      ...
      children: x.map((F) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: F.type === "Conflict" ? /* @__PURE__ */ a(Zd, { ...et, conflictResolution: E }) : /* @__PURE__ */ a(ki, { ...et })
          },
          F.id
        );
      })
  ...
  const c = pt.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), sw(h, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), iw(c, y, w.key);
...
function cw({
  ...
  var T;
  const [w, p] = N([]), [g, h] = N([]), [m, y] = N({}), [v, E] = N({}), k = P(() => e ?? [], [e]), _ = Vn({
    data: k,
    columns: t,
    getCoreRowModel: jn(),
  ...
  return d ? j = Array.from({ length: 10 }).map((x, D) => `skeleton-row-${D}`).map((x) => /* @__PURE__ */ a(ue, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ie, { colSpan: R.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? j = _.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    ue,
    {
      ...
      children: $.getVisibleCells().map((M) => /* @__PURE__ */ a(ie, { children: vr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    $.id
    ...
    /* @__PURE__ */ u(la, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ho, { stickyHeader: i, children: _.getHeaderGroups().map(($) => /* @__PURE__ */ a(ue, { children: $.headers.map((M) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : vr(M.column.columnDef.header, M.getContext()) }, M.id)) }, $.id)) }),
...
function Ep({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(K, { variant: "default", children: [
      /* @__PURE__ */ a(Ss, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
...
function _i({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Re, { open: M, onOpenChange: w ?? k, children: [
    /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ u(
      K,
      {
        variant: y,
        ...
        /* @__PURE__ */ a(me, { children: j.map((D) => /* @__PURE__ */ u(
          Oe,
          {
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ a($s, { className: "tw:h-4 tw:w-4" }),
...
const fw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(rt, { children: [
...
function mw({
  ...
  return /* @__PURE__ */ u(Te, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: fw(t, n, r) }) }) }),
...
const vw = (t, e) => t === "f" ? /* @__PURE__ */ u(rt, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function xw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: vw(t, r) }) }) }),
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: bw(t, r) }) })
    ] }) }),
...
function kw({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Ps, { className: e, size: 16 });
}
function nn({
  item: t,
  localizedStrings: e
...
function Op({
  ...
  const [m, y] = N("generated"), [v, E] = N("generated"), [k, _] = N("*"), [R, j] = N("*"), [T, $] = N("f"), [M, x] = N(!1), [D, L] = N(!0), [C, z] = N(!1), q = G(!1), U = G(""), [A, F] = N(!1), [et, Z] = N(), [Nt, mt] = N(), [Tt, H] = N(), [at, vt] = N(), ct = G(null), lt = P(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const re = () => {
    ...
    if (J && Ir("note", J)) {
      ...
      T !== "x" && V === "x" ? gt == null || gt.forEach((xt) => Cw(xt)) : T === "x" && V !== "x" && (gt == null || gt.forEach((xt) => Ew(xt))), (bt = w.current) == null || bt.applyUpdate([J, { delete: 1 }]);
    }
  }, zt = (V) => {
  ...
  W(() => {
    ...
    var V;
    A && ((V = ct.current) == null || V.focus());
  }, [A]), W(() => {
    var ot;
    const V = ((ot = p.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0, J = (nt) => {
      !A && V && document.activeElement === V && nt.key === c ? (nt.preventDefault(), Me()) : A && nt.key === "Escape" && (nt.preventDefault(), F(!1));
    };
  ...
  return /* @__PURE__ */ u(rt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(rt, { children: zw(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(da, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ue,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ie, { className: o, children: Ow(c.text) })
        ]
      },
...
const $w = (t) => {
  ...
  return e ? e[1] : "";
}, Aw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", jp = Object.freeze([
...
function Fp({
  ...
  const h = he(r, "%webView_inventory_all%"), m = he(r, "%webView_inventory_approved%"), y = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), E = he(r, "%webView_inventory_scope_currentBook%"), k = he(r, "%webView_inventory_scope_chapter%"), _ = he(r, "%webView_inventory_scope_verse%"), R = he(r, "%webView_inventory_filter_text%"), j = he(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = he(r, "%webView_inventory_no_results%"), [$, M] = N(!1), [x, D] = N("all"), [L, C] = N(""), [z, q] = N([]), U = P(() => {
    const H = t ?? [];
    return H.length === 0 ? [] : Iw(H, n, i);
  }, [t, n, i]), A = P(() => {
    if ($) return U;
    const H = [];
    return U.forEach((at) => {
  ...
  }, [$, U]), F = P(() => A.length === 0 ? [] : Pw(A, x, L), [A, x, L]), et = P(() => {
    var vt, ct;
    if (!$) return d;
  ...
  const Z = (H, at) => {
    ...
    if (A.length === 0 || z.length === 0) return [];
    const H = A.filter((at) => us(
      $ ? at.items : [at.items[0]],
      z
    ));
...
const Ei = ia(({ className: t, ...e }, r) => /* @__PURE__ */ a(Us, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Up({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = P(
    () => t.filter((z) => !r || z.type === r).filter((z) => Lw(z, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = Vw(h), E = P(
    ...
    n,
    "%resourcePicker_section_already_selected%"
  ), $ = _e(n, "%resourcePicker_section_installed%"), M = _e(
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = _e(n, "%resourcePicker_no_results%"), D = _e(n, "%resourcePicker_showing_count%"), L = P(() => {
...
const jw = "16rem", Fw = "3rem", Ti = pt.createContext(void 0);
function pa() {
...
function Kp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    K,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Gc, {}) : /* @__PURE__ */ a(Hc, {}),
...
function Ww({
  ...
  const c = t ? wr.Root : "button", { state: d } = pa(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(Yw({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Uw,
    {
      ...
      children: /* @__PURE__ */ u(qw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Gw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(Hw, { children: /* @__PURE__ */ a(
            Ww,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const Ae = "scrBook", Jw = "scrRef", Ye = "source", Zw = "details", Qw = "Scripture Reference", tu = "Scripture Book", zi = "Type", eu = "Details";
function ru(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, dn = (t) => `${au({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function oh({
  sources: t,
  ...
  const [l, w] = N([]), [p, g] = N([{ id: Ae, desc: !1 }]), [h, m] = N({}), y = P(
  ...
  }, $ = (x, D) => x.getIsGrouped() ? "" : f("banded-row", D % 2 === 0 ? "even" : "odd"), M = (x, D, L) => {
    ...
    !e && /* @__PURE__ */ u(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(tw, { children: R.map((x) => /* @__PURE__ */ a(de, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
...
function ou({
  ...
  }, [y, v] = N(!1), [E, k] = N(""), _ = G(void 0), R = G(!1), j = P(
    () => Si(t),
    [t]
  ), T = P(() => {
    if (!E.trim()) {
...
function ih({
  ...
  const R = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = Rt(s, "%webView_scope_selector_verse%"), T = Rt(s, "%webView_scope_selector_chapter%"), $ = Rt(s, "%webView_scope_selector_book%"), M = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), x = Rt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), D = Rt(s, "%webView_scope_selector_current_book%"), L = Rt(s, "%webView_scope_selector_choose_books%"), C = Rt(s, "%webView_scope_selector_scope%"), z = Rt(s, "%webView_scope_selector_select_books%"), q = Rt(s, "%webView_scope_selector_range%"), U = Rt(s, "%webView_scope_selector_select_range%"), A = Rt(s, "%webView_scope_selector_range_start%"), F = Rt(s, "%webView_scope_selector_range_end%"), et = Rt(s, "%webView_scope_selector_ok%"), Z = Rt(s, "%webView_scope_selector_cancel%"), Nt = Rt(s, "%webView_scope_selector_navigate%"), mt = (I) => {
    if (!m) return;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: f(Y && Et), children: A }),
      /* @__PURE__ */ a(
        ba,
        {
...
function Ha({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(K, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(qs, {}) }) }),
...
const lu = pt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Trigger,
  {
    ref: r,
    ...e,
...
function ph({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Mi, { children: [
      /* @__PURE__ */ a(Ai, { children: t.map((c) => /* @__PURE__ */ a(lu, { value: c.value, children: c.value }, c.key)) }),
  ...
  return /* @__PURE__ */ a(
    wl,
    {
      ...
      icons: {
        ...
        info: /* @__PURE__ */ a(Jc, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(Xc, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(Wc, { className: "tw:size-4" }),
