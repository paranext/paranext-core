...
import m, { forwardRef as Qe, useRef as et, useMemo as Y, useState as O, useCallback as G, useLayoutEffect as Rn, createContext as qr, useContext as Jr, useEffect as Rt, Fragment as Ln } from "react";
import { Command as it } from "cmdk";
import { X as tn, Search as jn, Check as Tt, Clock as Tn, ChevronsLeft as En, ChevronsRight as Vn, ChevronLeft as je, ChevronRight as Yt, ArrowLeft as Wr, ArrowRight as Zr, Circle as xe, ChevronsUpDown as en, FilterIcon as Qr, ChevronDown as ye, ChevronUp as ta, ArrowLeftIcon as ea, ChevronLeftIcon as na, ChevronRightIcon as ra, ArrowRightIcon as aa, Copy as oa, Filter as sa, User as ia, Link as wa, CircleHelp as la, Star as ca, AlertCircle as Be, CircleCheckIcon as da, CircleXIcon as pa, CircleHelpIcon as ua, ArrowUpIcon as ma, ArrowDownIcon as ha, ArrowUpDownIcon as fa, PanelLeft as ga, PanelRight as ba, ScrollText as va, MenuIcon as xa, Menu as ya, EllipsisVertical as Na, LoaderCircle as ka, GripVertical as Ca } from "lucide-react";
import { clsx as _a } from "clsx";
import { extendTailwindMerge as Sa } from "tailwind-merge";
import * as vt from "@radix-ui/react-dialog";
import { includes as he, Section as D, getChaptersForBook as Ra, formatScrRef as Ft, getSectionForBook as se, NumberFormat as Ta, formatBytes as Ea, getCurrentLocale as Va, getFormatCallerFunction as Da, deepEqual as nn, isString as Me, compareScrRefs as Ge, scrRefToBBBCCCVVV as Ie, getLocalizeKeyForScrollGroupId as L, formatReplacementString as Ma } from "platform-bible-utils";
...
import { useReactTable as Gn, getFilteredRowModel as Ia, getSortedRowModel as Xn, getPaginationRowModel as Oa, getCoreRowModel as Fn, flexRender as ie, getGroupedRowModel as Aa, getExpandedRowModel as Pa } from "@tanstack/react-table";
...
import { toast as Mw } from "sonner";
...
const st = class I {
  constructor(e, n, a, o) {
    if (V(this, "firstChapter"), V(this, "lastChapter"), V(this, "lastVerse"), V(this, "hasSegmentsDefined"), V(this, "text"), V(this, "BBBCCCVVVS"), V(this, "longHashCode"), V(this, "versification"), V(this, "rtlMark", "‏"), V(this, "_bookNum", 0), V(this, "_chapterNum", 0), V(this, "_verseNum", 0), V(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, i = n != null && n instanceof It ? n : void 0;
        ...
        if (e != null && e instanceof I) {
          ...
          if (e == null) return;
          const s = e instanceof It ? e : I.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new It(i)), n ? new I(n, a.toString(), w, u) : new I();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new It(gt[i]);
        } catch {
    ...
    if (a.length !== 2 || j.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !I.isVerseParseable(a[1]))
      throw new re("Invalid reference : " + e);
...
function ln(t, e, n) {
  ...
  return !!(he(o.toLowerCase(), a) || he(t.toLowerCase(), a) || (s ? he(s.localizedName.toLowerCase(), a) || he(s.localizedId.toLowerCase(), a) : !1));
}
const rr = Qe(
  ({
    bookId: t,
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? qt : "button", { className: d(so({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
function Ye(t, e, n) {
  return `${t} ${At[t]}${e ? ` ${wn(t, e)} ${Ht(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function io({
  recentSearches: t,
...
function Mi({
  ...
  const l = rt(), [p, b] = O(!1), [h, f] = O(""), [g, y] = O(""), [k, T] = O("books"), [v, N] = O(void 0), [M, z] = O(!1), P = et(void 0), U = et(void 0), K = et(void 0), _ = et(void 0), E = et({}), J = G(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
  ), B = Y(() => a ? a() : nr, [a]), dt = Y(() => ({
    [D.OT]: B.filter(($) => j.isBookOT($)),
    [D.NT]: B.filter(($) => j.isBookNT($)),
    [D.DC]: B.filter(($) => j.isBookDC($)),
    [D.Extra]: B.filter(($) => j.extraBooks().includes($))
    ...
    return [D.OT, D.NT, D.DC, D.Extra].forEach((tt) => {
      x[tt] = dt[tt].filter((at) => ln(at, g, o));
    }), x;
  }, [dt, g, o]), C = Y(
    () => lo(g, R, o),
    [g, R, o]
    ...
    (x) => {
      const $ = k === "chapters" ? v : C == null ? void 0 : C.book;
      $ && (J({
        book: $,
        chapterNum: x,
        verseNum: 1
      }), b(!1), T("books"), N(void 0), y(""));
    },
    [J, k, v, C]
  ), Vt = G(
    (x) => {
    ...
    (x) => {
      if (x.ctrlKey) return;
      const { isLetter: $, isDigit: tt } = In(x.key);
      if (k === "chapters") {
        if (x.key === "Backspace") {
          x.preventDefault(), x.stopPropagation(), Q();
          return;
        }
        if ($ || tt) {
          if (x.preventDefault(), x.stopPropagation(), T("books"), N(void 0), tt && v) {
            const at = At[v];
            y(`${at} ${x.key}`);
          } else
            y(x.key);
      ...
      if ((k === "chapters" || k === "books" && C) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        const at = k === "chapters" ? v : C == null ? void 0 : C.book;
        if (!at) return;
        const ot = (() => {
          if (!h) return 1;
          const ne = h.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            ot !== 0 && (Nt = ot > 1 ? ot - 1 : Dt);
            break;
          case "ArrowRight":
            ot !== 0 && (Nt = ot < Dt ? ot + 1 : 1);
            break;
          case "ArrowUp":
            Nt = ot === 0 ? Dt : Math.max(1, ot - Sn);
            break;
          case "ArrowDown":
            Nt = ot === 0 ? 1 : Math.min(Dt, ot + Sn);
            break;
          default:
            return;
        }
        Nt !== ot && (x.preventDefault(), x.stopPropagation(), f(Ye(at, o, Nt)), setTimeout(() => {
    ...
    const { isLetter: $, isDigit: tt } = In(x.key);
    ($ || tt) && (x.preventDefault(), y((at) => at + x.key), U.current.focus(), z(!1));
  }, []);
  return Rn(() => {
    const x = setTimeout(() => {
      if (p && k === "books" && K.current && _.current) {
        const $ = K.current, tt = _.current, at = tt.offsetTop, ot = $.clientHeight, Dt = tt.clientHeight, Nt = at - ot / 2 + Dt / 2;
        $.scrollTo({
          top: Math.max(0, Nt),
          behavior: "smooth"
        }), f(Ye(t.book));
  ...
  }, [k, v, C, t.book, t.chapterNum]), /* @__PURE__ */ c(te, { open: p, onOpenChange: mt, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ r(
      A,
      {
      ...
      Wt,
      {
        ...
        children: [
          k === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: S.map(({ onClick: x, disabled: $, title: tt, icon: at }) => /* @__PURE__ */ r(
              A,
              {
                variant: "ghost",
                size: "sm",
          ...
          !M && /* @__PURE__ */ c(Zt, { ref: K, children: [
            k === "books" && /* @__PURE__ */ c(kt, { children: [
              !C && Object.entries(W).map(([x, $]) => {
                if ($.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(zt, { heading: Xr(x), children: $.map((tt) => /* @__PURE__ */ r(
                      rr,
                      {
                        bookId: tt,
                        onSelect: (at) => xt(at),
                        section: se(tt),
                        commandValue: `${tt} ${At[tt]}`,
              ...
              C && /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(
                Bt,
                {
                  ...
                  children: Ft(
                    ...
                    o ? wn(C.book, o) : void 0
                  )
                },
                "top-match"
              ) }),
              C && bt(C.book) > 1 && /* @__PURE__ */ c(kt, { children: [
...
), nt = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Bn.Root, { ref: n, className: d("pr-twp", po(), t), ...e }));
nt.displayName = Bn.Root.displayName;
...
function Ue({
  ...
  const [k, T] = O(!1);
  return /* @__PURE__ */ c(te, { open: k, onOpenChange: T, ...y, children: [
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ c(Wt, { children: [
          ...
          /* @__PURE__ */ r(Zt, { children: e.map((v) => /* @__PURE__ */ c(
            Bt,
            {
              value: w(v),
              onSelect: () => {
...
function Ai({
  ...
  const p = Ae(l, "%webView_bookSelector_currentBook%"), b = Ae(l, "%webView_bookSelector_choose%"), h = Ae(l, "%webView_bookSelector_chooseBooks%"), [f, g] = O(
    "current book"
    /* CURRENT_BOOK */
  ), y = (k) => {
    g(k), t(k);
    ...
    cn,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(nt, { className: "tw-flex tw-items-center", children: a.map((k) => j.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            A,
            {
...
}), ar = X.Trigger, or = X.Group, fo = X.Portal, go = X.Sub, bo = X.RadioGroup;
function pn({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(dn.Provider, { value: n, children: /* @__PURE__ */ r(X.Root, { ...e }) });
}
...
sr.displayName = X.SubTrigger.displayName;
...
ir.displayName = X.SubContent.displayName;
const Ce = m.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = rt();
...
wr.displayName = X.Item.displayName;
const un = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ c(
    X.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(Tt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
un.displayName = X.CheckboxItem.displayName;
const lr = m.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ c(
    X.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(xe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
lr.displayName = X.RadioItem.displayName;
const mn = m.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
...
_e.displayName = X.Separator.displayName;
...
function xo({ table: t }) {
  return /* @__PURE__ */ c(pn, { children: [
    /* @__PURE__ */ r(za, { asChild: !0, children: /* @__PURE__ */ c(A, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Ut = q.Root, yo = q.Group, Kt = q.Value, No = Et(
...
Lt.displayName = q.Trigger.displayName;
...
jt.displayName = q.Content.displayName;
...
ko.displayName = q.Label.displayName;
const ct = m.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ c(
  q.Item,
  {
    ref: a,
    className: d(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(q.ItemIndicator, { children: /* @__PURE__ */ r(Tt, { className: "tw-h-4 tw-w-4" }) }) }),
...
Co.displayName = q.Separator.displayName;
function _o({ table: t }) {
...
const Re = m.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: d(
...
function Mo({
  ...
  var P;
  const [p, b] = O([]), [h, f] = O([]), [g, y] = O({}), [k, T] = O({}), v = Y(() => e ?? [], [e]), N = Gn({
    data: v,
    columns: t,
    getCoreRowModel: Fn(),
  ...
  let z;
  return u ? z = Array.from({ length: 10 }).map((_, E) => `skeleton-row-${E}`).map((_) => /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(Pt, { colSpan: M.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(Ke, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((P = N.getRowModel().rows) == null ? void 0 : P.length) > 0 ? z = N.getRowModel().rows.map((U) => /* @__PURE__ */ r(
    Ct,
    {
      onClick: () => i(U, N),
      "data-state": U.getIsSelected() && "selected",
      children: U.getVisibleCells().map((K) => /* @__PURE__ */ r(Pt, { children: ie(K.column.columnDef.cell, K.getContext()) }, K.id))
    },
    U.id
    ...
    o && /* @__PURE__ */ r(xo, { table: N }),
    /* @__PURE__ */ c(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Re, { stickyHeader: s, children: N.getHeaderGroups().map((U) => /* @__PURE__ */ r(Ct, { children: U.headers.map((K) => /* @__PURE__ */ r(de, { children: K.isPlaceholder ? void 0 : ie(K.column.columnDef.header, K.getContext()) }, K.id)) }, U.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(A, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(oa, {}) })
        ] }),
...
function Li({ id: t, label: e, groups: n }) {
  const [a, o] = O(
    ...
    i((h) => (h[l] = p, { ...h }));
    const b = n[l].items.find((h) => h.id === p);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(pn, { children: [
    /* @__PURE__ */ r(ar, { asChild: !0, children: /* @__PURE__ */ c(A, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(Ce, { children: n.map((l, p) => /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ r(or, { children: l.itemType === 0 ? /* @__PURE__ */ r(kt, { children: l.items.map((b, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        un,
        {
          checked: a[p][h],
        ...
        bo,
        {
          ...
          children: l.items.map((b) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(lr, { value: b.id, children: b.label }) }, b.id))
        }
      ) }),
      /* @__PURE__ */ r(_e, {})
    ] }, l.label)) })
...
function ji({
  ...
  }).format(Object.values(n).reduce((p, b) => p + b, 0)), l = () => {
...
function Po({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const u = new Date(w), l = new Date(o.getTime() - u.getTime()), p = l.getUTCFullYear() - 1970, b = l.getUTCMonth(), h = l.getUTCDate() - 1;
    let f = "";
...
function $o({
  ...
  const [h, f] = O(!1), g = G(
    (T) => {
      var N;
      const v = (N = t.find((M) => M.label === T)) == null ? void 0 : N.value;
      v && a(
        n.includes(v) ? n.filter((M) => M !== v) : [...n, v]
      );
    },
    [t, n, a]
  ), y = () => i || o, k = Y(() => {
    if (!u) return t;
    const T = t.filter((N) => N.starred).sort((N, M) => N.label.localeCompare(M.label)), v = t.filter((N) => !N.starred).sort((N, M) => {
      const z = n.includes(N.value), P = n.includes(M.value);
      return z && !P ? -1 : !z && P ? 1 : N.label.localeCompare(M.label);
    });
    return [...T, ...v];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { id: b, className: p, children: /* @__PURE__ */ c(te, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ c(
      A,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(Wt, { children: [
      /* @__PURE__ */ r(ue, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ c(Zt, { children: [
        /* @__PURE__ */ r(ke, { children: s }),
        /* @__PURE__ */ r(zt, { children: k.map((T) => {
          const v = e ? e(T) : void 0;
          return /* @__PURE__ */ c(
            Bt,
            {
              value: T.label,
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: T.starred && /* @__PURE__ */ r(ca, { className: "tw-h-4 tw-w-4" }) }),
  ...
  return /* @__PURE__ */ c("div", { id: h, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      ...
      return /* @__PURE__ */ c(be, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        ...
        (g = t.find((y) => y.value === f)) == null ? void 0 : g.label
      ] }, f);
...
function Bo({
  ...
  return /* @__PURE__ */ c(kt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: d("textual-note-body", f), children: w && w.length > 0 && /* @__PURE__ */ r(kt, { children: Lo(t.marker, w, a, l) }) })
  ] });
}
...
function Xi({
  ...
  const p = l ? Uo(l, "%webView_footnoteList_header%") : "Footnotes", b = w ?? Da(e, void 0), h = (v, N) => {
    u && u(v, N, a);
  }, f = o ? e.findIndex((v) => v === o) : 0, [g, y] = O(f), k = (v) => {
    if (e.length)
      switch (v.key) {
        case "ArrowDown":
          v.preventDefault(), y((N) => Math.min(N + 1, e.length - 1));
          break;
        case "ArrowUp":
          v.preventDefault(), y((N) => Math.max(N - 1, 0));
          break;
        case "Enter":
        case " ":
  ...
  return Rt(() => {
    var v;
    g >= 0 && g < T.current.length && ((v = T.current[g]) == null || v.focus());
  }, [g]), /* @__PURE__ */ c(kt, { children: [
...
function Ko({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = Y(() => {
    const i = [];
    return t.forEach((w) => {
  ...
  return /* @__PURE__ */ c(Se, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Te, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      Ct,
      {
        ...
        children: [
          /* @__PURE__ */ r(Pt, { children: `${j.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
fn.displayName = Xe.Root.displayName;
...
const fe = m.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const Ee = (t) => t === "asc" ? /* @__PURE__ */ r(ma, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ha, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fa, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Fi = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ c(A, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Ee(e.getIsSorted())
  ] })
}), Jo = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ c(A, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    Ee(n.getIsSorted())
  ] })
}), Hi = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ c(A, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Ee(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ c(A, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    Ee(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
...
function Wi({
  ...
  const b = ft(n, "%webView_inventory_all%"), h = ft(n, "%webView_inventory_approved%"), f = ft(n, "%webView_inventory_unapproved%"), g = ft(n, "%webView_inventory_unknown%"), y = ft(n, "%webView_inventory_scope_currentBook%"), k = ft(n, "%webView_inventory_scope_chapter%"), T = ft(n, "%webView_inventory_scope_verse%"), v = ft(n, "%webView_inventory_filter_text%"), N = ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), M = ft(n, "%webView_inventory_no_results%"), [z, P] = O(!1), [U, K] = O("all"), [_, E] = O(""), [J, B] = O([]), dt = Y(() => {
    const S = t ?? [];
    return S.length === 0 ? [] : Qo(S, o, s);
  }, [t, o, s]), R = Y(() => {
    if (z) return dt;
    const S = [];
    return dt.forEach((Q) => {
  ...
  }, [z, dt]), W = Y(() => R.length === 0 ? [] : Zo(R, U, _), [R, U, _]), C = Y(() => {
    var mt, ht;
    if (!z) return u;
  ...
  return /* @__PURE__ */ c("div", { id: l, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Ut,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ c(jt, { children: [
              /* @__PURE__ */ r(ct, { value: "all", children: b }),
      ...
      a && /* @__PURE__ */ c("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(nt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? N })
      ] })
    ] }),
...
const gn = m.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Yn.Root,
  {
    ref: o,
    decorative: n,
...
const bn = pe.Provider, vn = pe.Root, xn = pe.Trigger, Ve = m.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  pe.Content,
  {
    ref: a,
    sideOffset: e,
...
const br = m.forwardRef(
  ({
    ...
    const [l, p] = m.useState(t), b = e ?? l, h = m.useCallback(
      (N) => {
        const M = typeof N == "function" ? N(b) : N;
        n ? n(M) : p(M);
      },
      [n, b]
    ), f = m.useCallback(() => h((N) => !N), [h]), g = b ? "expanded" : "collapsed", T = rt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", v = m.useMemo(
      () => ({
        state: g,
        open: b,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(gr.Provider, { value: v, children: /* @__PURE__ */ r(bn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Je = m.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? qt : "div",
  {
    ref: a,
...
const ls = Et(
  ...
  ({
    ...
    const u = t ? qt : "button", { state: l } = De(), p = /* @__PURE__ */ r(
      u,
      {
        ref: w,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Ve, { side: "right", align: "center", hidden: l !== "collapsed", ...o })
    ] })) : p;
  }
);
...
const St = "scrBook", gs = "scrRef", Ot = "source", bs = "details", vs = "Scripture Reference", xs = "Scripture Book", _r = "Type", ys = "Details";
function Ns(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? j.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === St ? Ft(o.start) : void 0;
      },
      getGroupingValue: (a) => j.bookIdToNumber(a.start.book),
      sortingFn: (a, o) => Ge(a.original.start, o.original.start),
      enableGrouping: !0
    },
    {
...
function Qi({
  ...
  const [l, p] = O([]), [b, h] = O([{ id: St, desc: !1 }]), [f, g] = O({}), y = Y(
  ...
  Rt(() => {
    if (w) {
      ...
      if (E.length === 1) {
        const J = y.find((B) => zn(B) === E[0]) || void 0;
        J && w(J);
      }
    }
  }, [f, y, w, T]);
  const v = o ?? xs, N = s ?? _r, M = [
    ...
    !e && /* @__PURE__ */ c(
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(yo, { children: M.map((_) => /* @__PURE__ */ r(ct, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
        ...
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            children: _.getVisibleCells().map((B) => {
              if (!(B.getIsPlaceholder() || B.column.columnDef.enableGrouping && !B.getIsGrouped() && (B.column.columnDef.id !== Ot || !n)))
                return /* @__PURE__ */ r(
                  Pt,
                  {
                    className: d(
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ c(
                      A,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (J === "ltr" ? /* @__PURE__ */ r(Yt, {}) : /* @__PURE__ */ r(je, {})),
                          " ",
...
}), Sr = (t, e, n) => Nn(t, e).every((a) => n.includes(a));
function Cs({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Nn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], l = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    A,
    {
      variant: "outline",
...
function _s({
  ...
  }, [k, T] = O(!1), [v, N] = O(""), M = et(void 0), z = et(!1);
  ...
  const P = Y(() => j.allBookIds.filter(
    ...
    (R, W = !1) => {
      ...
      const C = P.findIndex((S) => S === M.current), Z = P.findIndex((S) => S === R);
      if (C === -1 || Z === -1) return;
      const [xt, Xt] = [
        Math.min(C, Z),
        Math.max(C, Z)
      ], Vt = P.slice(xt, Xt + 1).map((S) => S);
      n(
    ...
    K(R, z.current), z.current = !1;
  }, E = (R, W) => {
    R.preventDefault(), K(W, R.shiftKey);
  }, J = G(
    (R) => {
      const W = Nn(P, R).map((C) => C);
      n(
        Sr(P, R, e) ? e.filter((C) => !W.includes(C)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, P]
  ), B = () => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-space-y-2", children: [
            ...
            Wt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(A, { variant: "ghost", size: "sm", onClick: B, children: u }),
                  /* @__PURE__ */ r(A, { variant: "ghost", size: "sm", onClick: dt, children: l })
                ] }),
                /* @__PURE__ */ c(Zt, { children: [
                  /* @__PURE__ */ r(ke, { children: p }),
                  Object.values(D).map((R, W) => {
                    const C = U[R];
                    if (C.length !== 0)
                      return /* @__PURE__ */ c(Ln, { children: [
                        /* @__PURE__ */ r(
                          zt,
                          {
                            heading: er(R, h, f, g, y),
                            children: C.map((Z) => /* @__PURE__ */ r(
                              rr,
                              {
                                bookId: Z,
                        ...
                        W < Object.values(D).length - 1 && /* @__PURE__ */ r(Kn, {})
                      ] }, R);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ c("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === ze ? ze : $n
      ).map((R) => /* @__PURE__ */ r(be, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ht(R, o) }, R)),
...
function ew({
  ...
  const l = Mt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Mt(i, "%webView_scope_selector_current_book%"), f = Mt(i, "%webView_scope_selector_choose_books%"), g = Mt(i, "%webView_scope_selector_scope%"), y = Mt(i, "%webView_scope_selector_select_books%"), k = [
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        cn,
        {
          ...
          children: T.map(({ value: v, label: N, id: M }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(ge, { className: "tw-me-2", value: v, id: M }),
            /* @__PURE__ */ r(nt, { htmlFor: M, children: N })
          ] }, M))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(nt, { children: y }),
      /* @__PURE__ */ r(
        _s,
        {
          availableBookInfo: a,
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((l) => /* @__PURE__ */ r(ct, { value: `${l}`, children: w[L(l)] }, `${l}`))
          }
        )
      ]
    }
...
function Ze({
  ...
  return /* @__PURE__ */ c(pn, { variant: s, children: [
    /* @__PURE__ */ r(ar, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(A, { variant: i, size: "icon", children: a ?? /* @__PURE__ */ r(xa, {}) }) }),
    /* @__PURE__ */ r(Ce, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, l]) => typeof u == "boolean" || typeof l == "boolean" ? 0 : u.order - l.order).map(([u], l, p) => /* @__PURE__ */ c(Ln, { children: [
      /* @__PURE__ */ r(or, { children: /* @__PURE__ */ r(bn, { children: Tr(e.groups, e.items, u, t) }) }),
...
Ds.displayName = F.Label.displayName;
...
function Ms({
  ...
  const o = et(void 0), s = et(void 0), i = et(void 0), w = et(void 0), u = et(void 0), l = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (La(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, b) => {
    var g, y, k, T;
    p.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), ae(s, [h, f]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), ae(i, [h, f]);
        break;
      case "alt+n":
        (k = w.current) == null || k.focus(), ae(w, [h, f]);
        break;
      case "alt+h":
        (T = u.current) == null || T.focus(), ae(u, [h, f]);
        break;
    }
  }), Rt(() => {
    ...
    return /* @__PURE__ */ r(Ir, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, b]) => typeof p == "boolean" || typeof b == "boolean" ? 0 : p.order - b.order).map(([p, b]) => /* @__PURE__ */ c(Rs, { children: [
      /* @__PURE__ */ r(Or, { ref: l(p), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        zr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(bn, { children: jr(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function dw({
  ...
  const l = Is(
    ...
    o && o(g), a && a([g, ...n.filter((y) => y !== g)]), s && n.find((y) => y === g) && s([...n.filter((y) => y !== g)]), b(!1);
  }, f = (g, y) => {
    var T, v, N, M, z, P;
    const k = y !== g ? ((v = (T = t[g]) == null ? void 0 : T.uiNames) == null ? void 0 : v[y]) ?? ((M = (N = t[g]) == null ? void 0 : N.uiNames) == null ? void 0 : M.en) : void 0;
    return k ? `${(z = t[g]) == null ? void 0 : z.autonym} (${k})` : (P = t[g]) == null ? void 0 : P.autonym;
  };
      ...
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(ct, { value: g, children: f(g, e) }, g))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(nt, { className: "tw-font-normal tw-text-muted-foreground", children: Ma(l, {
...
const As = Qe(({ className: t, ...e }, n) => /* @__PURE__ */ r(ka, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
const Ls = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Ls.displayName = "AlertDescription";
...
js.displayName = Jt.Root.displayName;
...
const mw = H.Root, hw = H.Trigger, fw = H.Group, gw = H.Portal, bw = H.Sub, vw = H.RadioGroup, Xs = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ c(
  H.SubTrigger,
  {
    ref: o,
    className: d(
...
Xs.displayName = H.SubTrigger.displayName;
...
Fs.displayName = H.SubContent.displayName;
...
const Us = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ c(
  H.CheckboxItem,
  {
    ...
    ...a,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(H.ItemIndicator, { children: /* @__PURE__ */ r(Tt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
...
ai.displayName = pt.Description.displayName;
...
si.displayName = oe.Root.displayName;
...
const ui = (t, e, n = {}) => {
  ...
  const o = et(null), [s, i] = O(void 0), [w, u] = O(void 0), l = G(
    (h) => {
      i(h);
