...
import { r as jt, Z as Ii, B, c as g, a as Vi, C as Te, P as ze, b as Ie, d as Se, e as Ve, f as Le, g as pe, h as kr, i as Qr, T as te, S as Qe, j as ee, k as re, l as ae, D as Ge, m as vr, n as _e, o as Ne, p as Ce, u as Li, q as _r, s as He, t as Re, v as za, w as sn, x as Fi, y as ji, z as cn, A as ln, E as Bi, F as Ui, G as Ki, H as qi, I as da, J as wa, K as ta, L as Gi, M as Hi, N as Yi, O as Wi, Q as Xi, R as Nr, U as Ga } from "./resizable-CUvCloPJ.js";
import { V as Bh, W as Uh, X as Kh, Y as qh, _ as Gh, $ as Hh, a0 as Yh, a1 as Wh, a2 as Xh } from "./resizable-CUvCloPJ.js";
import { jsx as a, jsxs as u, Fragment as tt } from "react/jsx-runtime";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as Mr, Section as Z, getChaptersForBook as Ji, formatScrRef as ye, getSectionForBook as gr, formatRelativeDate as Zi, formatReplacementString as xe, sanitizeHtml as Qi, NumberFormat as ts, formatBytes as es, getCurrentLocale as rs, usfmMarkers as Lr, getFormatCallerFunction as as, deepEqual as os, isString as mo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as ns, getLocalizeKeyForScrollGroupId as vo } from "platform-bible-utils";
import { Check as Ae, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronLeft as Da, ChevronRight as Oa, ArrowLeft as is, ArrowRight as ss, ChevronDown as tr, BoldIcon as cs, ItalicIcon as ls, X as ea, AtSign as dn, Pencil as ds, Trash2 as ws, ArrowUp as wn, MoreHorizontal as us, MailOpen as ps, Mail as hs, ChevronUp as gs, FilterIcon as fs, ArrowLeftIcon as ms, ChevronLeftIcon as vs, ChevronRightIcon as bs, ArrowRightIcon as xs, Copy as un, Filter as ys, User as ks, Link as _s, CircleHelp as Ns, ChevronsUpDown as pn, Star as Cs, Undo as Es, Redo as Ts, SquareX as hn, FunctionSquare as gn, SquareSigma as fn, Ban as zs, AlertCircle as $a, CircleCheckIcon as Ss, CircleXIcon as Ds, CircleHelpIcon as Os, ArrowUpIcon as $s, ArrowDownIcon as Ms, Search as Rs, LoaderCircle as As, ScrollText as Ps, MenuIcon as Is, Menu as Vs, EllipsisVertical as Ls, MoreVertical as ko } from "lucide-react";
import ut, { useRef as q, useMemo as F, useState as N, useCallback as L, useEffect as Y, useLayoutEffect as Xt, createContext as Ha, useContext as mn, Component as Fs, createElement as _o, Suspense as js, forwardRef as ra, Fragment as vn } from "react";
import { Dialog as he, Label as Bs, RadioGroup as Ma, ToggleGroup as bn, Slot as ir, Avatar as Ya, Select as Pt, Checkbox as No, Tabs as le, Menubar as me, ContextMenu as St, Progress as Co, Slider as Rr, Switch as Eo } from "radix-ui";
import { createEditor as xn, $getRoot as Pe, $createParagraphNode as Cr, $getSelection as Ft, HISTORY_MERGE_TAG as Wa, ParagraphNode as yn, TextNode as kn, $getPreviousSelection as Us, $isRangeSelection as ge, $caretFromPoint as Ks, $getSiblingCaret as _n, $getChildCaret as qs, $getAdjacentChildCaret as Gs, $isChildCaret as Hs, $normalizeCaret as Ys, $setSelectionFromCaretRange as Ws, $getCollapsedCaretRange as Xs, $getCaretInDirection as To, $splitAtPointCaretNext as Js, $isTextPointCaret as Zs, $findMatchingParent as Nn, $isElementNode as br, mergeRegister as Ee, getDOMTextNode as Qs, isHTMLElement as tc, CLEAR_EDITOR_COMMAND as Cn, COMMAND_PRIORITY_EDITOR as Xa, shallowMergeConfig as ec, defineExtension as oe, safeCast as Ye, createState as rc, FORMAT_TEXT_COMMAND as En, $isNodeSelection as Tn, COMMAND_PRIORITY_LOW as zn, RootNode as ac, LineBreakNode as oc, TabNode as nc, $isEditorState as ic, createCommand as sc, CLICK_COMMAND as cc, isDOMNode as lc, $getNodeFromDOMNode as dc, $createNodeSelection as wc, $setSelection as uc, $getEditor as pc, DecoratorNode as Ra, $getState as hc, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as gc, $setState as fc, addClassNamesToElement as Sn, $create as mc, $getNodeByKey as vc, removeClassNamesFromElement as bc, KEY_TAB_COMMAND as xc, $isBlockElementNode as yc, $createRangeSelection as kc, $normalizeSelection__EXPERIMENTAL as _c, OUTDENT_CONTENT_COMMAND as Nc, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as Cc, COMMAND_PRIORITY_CRITICAL as Ja, $isDecoratorNode as Ec, $isParagraphNode as Tc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Dn, $insertNodes as zc } from "lexical";
...
import { useReactTable as Mn, getFilteredRowModel as Yc, getSortedRowModel as Rn, getPaginationRowModel as Wc, getCoreRowModel as An, flexRender as fr, getGroupedRowModel as Xc, getExpandedRowModel as Jc } from "@tanstack/react-table";
import Zc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as Qc, isInsertEmbedOpOfType as Ar, Editorial as tl } from "@eten-tech-foundation/platform-editor";
...
function ga({
  ...
  const C = jt(), [k, _] = N(!1), [I, j] = N(""), [V, $] = N(""), [x, z] = N("books"), [A, D] = N(void 0), [O, W] = N(
    void 0
  ), [K, M] = N(void 0), [Q, mt] = N(!1), ct = q(null), Bt = q(!1), bt = q(void 0), Dt = q(void 0), U = q(void 0), rt = q(void 0), ot = q({}), nt = q({}), it = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const Vt = L(() => {
    ...
    [w]
  ), Be = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", lr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", dr = L(
    (b) => {
    ...
    (b) => {
      ...
      if ((x === "chapters" || x === "books" && S) && Et) {
        ...
        if (!Mt) return;
        x === "chapters" && ((wr = bt.current) == null || wr.focus());
        const _t = (() => {
          if (!I) return 1;
          const Wt = I.match(/(\d+)$/);
  ...
  return Xt(() => {
    const b = setTimeout(() => {
      if (k && x === "books" && U.current && rt.current) {
        const G = U.current, J = rt.current, Et = J.offsetTop, Jt = G.clientHeight, We = J.clientHeight, wr = Et - Jt / 2 + We / 2;
        G.scrollTo({
          top: Math.max(0, wr),
          behavior: "smooth"
        }), j(Ln(t.book));
              ...
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  B,
                  {
                    ...
                    tabIndex: -1,
                    children: C === "ltr" ? /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" })
                  }
                ),
...
const Un = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Un ? Xt : Y, Pr = { tag: Wa };
...
function El() {
  return function(t) {
    const [e] = ve(), r = F(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = q(o);
    return Nl(() => {
...
function Rl(t) {
  const e = Nn(t, (r) => br(r) && !r.isInline());
...
function Al(t) {
  ...
  if (ge(e)) r = Ks(e.focus, "next");
    ...
    r = r || qs(Pe(), "previous").getFlipped().insert(Cr());
  }
...
function Pl(t, e, r) {
  ...
  return Zs(o) && Gr(283), o.insert(t.isInline() ? Cr().append(t) : t), To(_n(t.getLatest(), "next"), e.direction);
}
function Il(t) {
  const e = Ft();
  if (!ge(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Nn(i, (l) => br(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Hr, ke = 0, Yr = 0, Fl = 0, Ba = 0, jr = 0;
function Vo(t) {
  if (et === void 0) return;
  let e = t.n;
...
At.prototype.brand = Vl, At.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ke !== 0 && Yr === 0 && e.l !== Ba && (e.l = Ba, Hr = { S: e, v: e.v, i: e.i, o: Hr });
...
oe({ build: (t, e, r) => sr(e), config: Ye({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Yn() {
  const t = Pe(), e = Ft(), r = Cr();
  t.clear(), t.append(r), e !== null && r.select(), ge(e) && (e.format = 0);
}
function Wn(t, e = Yn) {
  return t.registerCommand(Cn, (r) => (t.update(e), !0), Xa);
}
oe({ build: (t, e, r) => sr(e), config: Ye({ $onClear: Yn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [Xn], register: (t, e, r) => t.registerCommand(En, (o) => {
  const n = Ft();
  if (Tn(n) || ge(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, zn) });
function Jn(t, e) {
  let r;
...
const ao = 0, Ka = 1, Qn = 2, ba = 3, Ir = 4, Xe = 5, xa = 6, pr = 7;
function ya(t) {
  return t.id === ao;
}
function ti(t) {
...
class Hl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && lt(307, String(r.id), String(Xe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const Wl = oe({ config: Ye({ setOptions: Fo, updateOptions: Fo }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const Jl = /* @__PURE__ */ new Set(), Uo = oe({ build(t, e, r) {
  const o = r.getDependency(Ua).output, n = xr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Jn(() => {
  }, () => fe(() => {
...
oe({ dependencies: [Ua, Uo], name: "@lexical/extension/HorizontalRule", nodes: () => [er], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Uo).output, n = xr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ee(t.registerCommand(Zl, (s) => {
    const c = Ft();
    if (!ge(c)) return !1;
    ...
    Ll(() => {
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        f ? f.domNode.value = h : (d = !0, l.set(w, { domNode: xr(h), selectedSignal: o(w) }));
      }
...
oe({ build: (t, e) => sr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ye({ $getParentEditor: function() {
  const t = pc();
...
oe({ build: (t, e, r) => sr(e), config: Ye({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return fe(() => {
...
function ed(t, e, r = ei) {
  return Ee(t.registerCommand(xc, (o) => {
    const n = Ft();
    if (!ge(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
oe({ build: (t, e, r) => sr(e), config: Ye({ $canIndent: ei, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
oe({ build: (t, e, r) => sr(e), config: Ye({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => fe(() => r.getOutput().disabled.value ? void 0 : ai(t)) });
function id(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function yd() {
  const [t, e] = N(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Va, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(La, { children: [
      /* @__PURE__ */ a(Kr, { children: /* @__PURE__ */ a(qr, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function kd({
  ...
  const [e] = ve(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = yd(), d = () => {
  };
...
function Cd() {
  const { activeEditor: t } = ii(), [e, r] = N([]), o = L((n) => {
    if (ge(n) || qc(n)) {
      const i = [];
      Go.forEach(({ format: s }) => {
...
function Hu({
  ...
  const [i, s] = N(Od), [c, d] = N(n), [l, w] = N(!1), p = q(void 0), f = q(null);
  Y(() => {
    let v = !0;
    const T = f.current;
    if (!T) return;
...
function Yo({
  ...
  const h = L(
    ...
    [t.user]
  ), C = F(() => Qi(t.contents), [t.contents]), k = F(() => {
    if (o && c)
      return /* @__PURE__ */ u(tt, { children: [
        /* @__PURE__ */ u(
          Ge,
    ...
    "div",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ u(_e, { children: [
          /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(us, {}) }) }),
...
function Pd({
  ...
  const Ot = F(() => e.filter((E) => !E.deleted), [e]);
  Y(() => {
    let E = !0;
    if (!o || !k) {
      Kt(/* @__PURE__ */ new Map());
  ...
  const gt = L(
    ...
    async (E) => {
      const wt = Zt($) ? Xr($) : void 0, pt = E.status ? E.assignedUser : z ?? E.assignedUser, kt = await p({
        ...E,
        contents: wt,
        assignedUser: pt
      });
        ...
        children: /* @__PURE__ */ u(Md, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              Ht && /* @__PURE__ */ a(vr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Ht }),
              /* @__PURE__ */ a(
                B,
                {
                  variant: "ghost",
                  ...
                  children: ot ? /* @__PURE__ */ a(ps, {}) : /* @__PURE__ */ a(hs, {})
                }
              ),
...
function ep({
  ...
  const [T, C] = N(/* @__PURE__ */ new Set()), [k, _] = N(), [I, j] = N(), V = L(
    async (M) => {
      const Q = await i(M);
...
function Gd({
  ...
  var j;
  const [w, p] = N([]), [f, h] = N([]), [m, y] = N({}), [v, T] = N({}), C = F(() => e ?? [], [e]), k = Mn({
    data: C,
    columns: t,
    getCoreRowModel: An(),
  ...
  return d ? I = Array.from({ length: 10 }).map((x, z) => `skeleton-row-${z}`).map((x) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? I = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ce,
    {
      ...
      children: V.getVisibleCells().map(($) => /* @__PURE__ */ a(Qt, { children: fr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    V.id
    ...
    n && /* @__PURE__ */ a(Id, { table: k }),
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(lo, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map(($) => /* @__PURE__ */ a(Jr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : fr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
        ...
        /* @__PURE__ */ a(pe, { children: I.map((z) => /* @__PURE__ */ u(
          Te,
          {
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Cs, { className: "tw:h-4 tw:w-4" }),
...
function ew({
  ...
  return /* @__PURE__ */ u(_e, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: tw(t, n, r) }) }) }),
...
function ow({
  ...
  return /* @__PURE__ */ u(_e, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: rw(t, r) }) }) }),
...
function hp({
  ...
  const [m, y] = N("generated"), [v, T] = N("generated"), [C, k] = N("*"), [_, I] = N("*"), [j, V] = N("f"), [$, x] = N(!1), [z, A] = N(!0), [D, O] = N(!1), W = q(!1), K = q(""), [M, Q] = N(!1), [mt, ct] = N(), [Bt, bt] = N(), [Dt, U] = N(), [rt, ot] = N(), nt = q(null), it = F(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
function Np({
  ...
  const h = de(r, "%webView_inventory_all%"), m = de(r, "%webView_inventory_approved%"), y = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), T = de(r, "%webView_inventory_scope_currentBook%"), C = de(r, "%webView_inventory_scope_chapter%"), k = de(r, "%webView_inventory_scope_verse%"), _ = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), j = de(r, "%webView_inventory_no_results%"), [V, $] = N(!1), [x, z] = N("all"), [A, D] = N(""), [O, W] = N([]), K = F(() => {
    const U = t ?? [];
  ...
  }, [V, K]), Q = F(() => M.length === 0 ? [] : xw(M, x, A), [M, x, A]), mt = F(() => {
    var ot, nt;
    if (!V) return d;
...
function Ep({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = F(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = kw(h), T = F(
    ...
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = be(n, "%resourcePicker_no_results%"), z = be(n, "%resourcePicker_showing_count%"), A = F(() => {
  ...
  return /* @__PURE__ */ u(tt, { children: [
    /* @__PURE__ */ a(Kr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(qr, { children: k }) }),
...
const Nw = "16rem", Cw = "3rem", vi = ut.createContext(void 0);
function la() {
...
function Mw({
  ...
  const c = t ? ir.Root : "button", { state: d } = la(), l = /* @__PURE__ */ a(
    c,
    {
...
const $e = "scrBook", Aw = "scrRef", qe = "source", Pw = "details", Iw = "Scripture Reference", Vw = "Scripture Book", bi = "Type", Lw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function jp({
  ...
  const [l, w] = N([]), [p, f] = N([{ id: $e, desc: !1 }]), [h, m] = N({}), y = F(
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      rr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(nr, { position: "item-aligned", children: /* @__PURE__ */ a(Vd, { children: _.map((x) => /* @__PURE__ */ a(ie, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(na, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(lo, { children: T.getHeaderGroups().map((x) => /* @__PURE__ */ a(ce, { children: x.headers.filter((z) => z.column.columnDef.header).map((z) => (
        ...
        /* @__PURE__ */ a(Jr, { colSpan: z.colSpan, className: "tw:sticky top-0", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
...
function Bw({
  ...
  }, [y, v] = N(!1), [T, C] = N(""), k = q(void 0), _ = q(!1), I = F(
    () => xi(t),
    [t]
  ), j = F(() => {
    if (!T.trim()) {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ea ? Ea : nn
      ).map((d) => /* @__PURE__ */ a(vr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Me(d, n) }, d)),
...
function Up({
  ...
  }, vt = q(null), Ut = q(null), Kt = q(!1), S = q(null), Ot = q(!1), [Vt, ne] = N(void 0), qt = q(!1), $t = q(!1), De = q(null), Gt = L((R) => {
    if (R) {
  ...
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, E] = N(!1), [wt, pt] = N(void 0), [kt, je] = N(void 0), [Oe, cr] = N(void 0), [Be, lr] = N(void 0), [dr, zr] = N([]), Sr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    Kw,
    {
      availableBookInfo: o,
  ...
  ), G = Vt === "end", J = Vt === "start", Et = "tw:text-muted-foreground", Jt = l === "dropdown" && wt === "range", We = Jt ? cr : P, Mt = Jt ? lr : h ? H : It, _t = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Wt, Ue] = N(null), [Dr, Si] = N(null), [Or, Di] = N(null), Oi = 200, [$i, Mi] = N(!1);
  Y(() => {
  ...
  const po = L(
    (R) => {
      je(R), cr(nt), lr(it), zr(n), E(!1), pt(R);
    },
    [nt, it, n]
  ), ho = L(() => {
    kt !== void 0 && (kt === "range" ? (Oe && (f == null || f(Oe)), Be && (h == null || h(Be))) : kt === "selectedBooks" && i(dr), st(kt), pt(void 0), je(void 0));
  }, [
    kt,
    Oe,
    Be,
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(_e, { open: Ct, onOpenChange: E, children: [
        ...
        /* @__PURE__ */ a(
          Ce,
          {
            ...
            children: /* @__PURE__ */ u(da, { container: Or, children: [
              xt.map(({ value: R, label: X, dropdownLabel: Lt, scrRefSuffix: ur, id: Ri }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: ft(R),
        ...
        jn,
        {
          ...
          children: rt.map(({ value: R, label: X, scrRefSuffix: Lt, id: ur }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Fa, { className: "tw:me-2", value: R, id: ur }),
            /* @__PURE__ */ a(Nt, { htmlFor: ur, children: U(X, Lt) })
          ] }, ur))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && _t,
    l === "dropdown" && yt && /* @__PURE__ */ a(Va, { open: wt === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      La,
      {
        ref: Si,
        onCloseAutoFocus: go,
        onEscapeKeyDown: (R) => {
          Dr != null && Dr.querySelector('[data-state="open"]') && R.preventDefault();
        },
        children: /* @__PURE__ */ u(da, { container: Dr, children: [
          /* @__PURE__ */ a(Kr, { className: "tw:pe-8", children: /* @__PURE__ */ a(qr, { children: A }) }),
          b,
    ...
    l === "dropdown" && gt && /* @__PURE__ */ a(Va, { open: wt === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      La,
      {
        ref: Ue,
        onCloseAutoFocus: go,
        ...
        children: /* @__PURE__ */ u(da, { container: Wt, children: [
          /* @__PURE__ */ a(Kr, { className: "tw:pe-8", children: /* @__PURE__ */ a(qr, { children: K }) }),
          _t,
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => $r(!1), children: ct }),
...
function qa({
  ...
  return /* @__PURE__ */ u(_e, { variant: i, children: [
    /* @__PURE__ */ a(Ne, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Is, {}) }) }),
    /* @__PURE__ */ a(Ce, { align: "start", style: { zIndex: ta }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(vn, { children: [
  ...
  if (el(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), hr(i, [f, h]);
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), hr(s, [f, h]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), hr(c, [f, h]);
        break;
      case "alt+h":
        (T = d.current) == null || T.focus(), hr(d, [f, h]);
        break;
    }
  }), Y(() => {
