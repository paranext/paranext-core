...
var ds = (t, e, r) => e in t ? ls(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Yt = (t, e, r) => ds(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as he, a as Dr, C as Ke, L as Bn, u as Xo, T as zt, b as _t, d as Nt, e as Ct, A as wa, D as ze, f as xe, h as Oe, i as xr, j as Ae, B as J, x as ws, k as us, l as ps, I as hs, m as bo, n as Be, r as _e, o as gs, p as Fn, P as tr, q as yr, s as er, t as rr, v as ya, w as ka, y as xo, z as ar, E as _a, F as Mt, R as yo, G as ua, H as Za, J as Qa, K as to, M as eo, N as Un, O as ea, Q as ko, S as Or, U as Ir, V as wr, W as fs, X as Ze, Y as je, Z as Ie, _ as Ve, $ as ur, a0 as _o, a1 as No, a2 as pa, a3 as Co, a4 as Kn, a5 as ms, a6 as vs, a7 as bs, a8 as ro, a9 as Hn, aa as Na, ab as xs, ac as qn, ad as ys, ae as ks, af as _s, ag as Jo, ah as Ns, ai as Cs, aj as Es, ak as Ts, al as Gn, am as Yn, an as Eo, ao as Ss, ap as Wn, aq as $a, ar as Zo, as as Aa, at as Rs, au as Ds, av as Ms, aw as zs, ax as Os, ay as Ar, az as To, aA as Is, aB as Ps } from "./resizable-BZsJZ3qc.js";
import { aC as rf, aD as af, aE as of, aF as nf, aG as sf, aH as cf, aI as lf, aJ as df, aK as wf, aL as uf, aM as pf, aN as hf, aO as gf, aP as ff, aQ as mf, aR as vf, aS as bf, aT as xf, aU as yf, aV as kf, aW as _f, aX as Nf, aY as Cf, aZ as Ef, a_ as Tf, a$ as Sf, b0 as Rf } from "./resizable-BZsJZ3qc.js";
import { jsx as a, jsxs as u, Fragment as wt } from "react/jsx-runtime";
import { Canon as Vt } from "@sillsdev/scripture";
import { Check as Fe, Clock as Qo, ChevronsLeft as tn, ChevronsRight as en, ChevronUp as Xn, ChevronDown as Qe, ArrowLeft as $s, ArrowRight as As, BoldIcon as Vs, ItalicIcon as Ls, X as So, AtSign as Jn, Pencil as js, Trash2 as Bs, ArrowUp as Zn, MoreHorizontal as Fs, MailOpen as Us, Mail as Ks, FilterIcon as Hs, ArrowLeftIcon as qs, ChevronLeftIcon as Gs, ChevronRightIcon as Ys, ArrowRightIcon as Ws, Copy as Qn, Filter as Xs, User as Js, Link as Zs, CircleHelp as Qs, Undo as tc, Redo as ec, SquareX as ti, FunctionSquare as ei, SquareSigma as ri, Ban as rc, AlertCircle as ao, CircleCheckIcon as ac, CircleXIcon as oc, CircleHelpIcon as nc, ArrowUpIcon as ic, ArrowDownIcon as sc, ScrollText as cc, ChevronRight as lc, ChevronLeft as dc, ChevronsUpDown as wc, MenuIcon as uc, Menu as pc, EllipsisVertical as hc, MoreVertical as gc } from "lucide-react";
import { Section as Dt, compareScrRefs as ha, getChaptersForBook as fc, formatScrRef as Re, formatReplacementString as Le, getSectionForBook as ra, formatRelativeDate as mc, sanitizeHtml as Ro, NumberFormat as ai, formatBytes as vc, getCurrentLocale as bc, usfmMarkers as aa, isPlatformError as xc, ABORTED as yc, getErrorMessage as kc, getFormatCallerFunction as _c, deepEqual as Nc, isString as rn, scrRefToBBBCCCVVV as Va, defaultScrRef as La, formatScrRefRange as Cc, getLocalizeKeyForScrollGroupId as an, formatReplacementStringToArray as on, collectUsjMarkers as Ec } from "platform-bible-utils";
import Xt, { useRef as U, useMemo as V, createContext as Ca, useContext as Do, useState as N, useEffect as Y, useCallback as F, useId as oo, useImperativeHandle as Tc, useLayoutEffect as Jt, Fragment as Vr, Component as Sc, createElement as nn, Suspense as Rc, forwardRef as oi } from "react";
import { IconSelector as ni, IconCheck as Ea, IconChevronDown as Dc, IconChevronUp as Mc, IconLayoutSidebar as zc, IconLayoutSidebarRight as Oc, IconChevronRight as ii, IconSearch as Ic, IconLoader as Pc, IconAlertOctagon as $c, IconAlertTriangle as Ac, IconInfoCircle as Vc, IconCircleCheck as Lc } from "@tabler/icons-react";
import { createEditor as si, $getRoot as Ue, $createParagraphNode as Lr, $getSelection as ae, HISTORY_MERGE_TAG as Mo, ParagraphNode as ci, TextNode as li, $getPreviousSelection as jc, $isRangeSelection as ye, $caretFromPoint as Bc, $getSiblingCaret as di, $getChildCaret as Fc, $getAdjacentChildCaret as Uc, $isChildCaret as Kc, $normalizeCaret as Hc, $setSelectionFromCaretRange as qc, $getCollapsedCaretRange as Gc, $getCaretInDirection as sn, $splitAtPointCaretNext as Yc, $isTextPointCaret as Wc, $findMatchingParent as wi, $isElementNode as Pr, mergeRegister as Me, getDOMTextNode as Xc, isHTMLElement as Jc, CLEAR_EDITOR_COMMAND as ui, COMMAND_PRIORITY_EDITOR as zo, shallowMergeConfig as Zc, defineExtension as de, safeCast as or, createState as Qc, FORMAT_TEXT_COMMAND as pi, $isNodeSelection as hi, COMMAND_PRIORITY_LOW as gi, RootNode as tl, LineBreakNode as el, TabNode as rl, $isEditorState as al, createCommand as ol, CLICK_COMMAND as nl, isDOMNode as il, $getNodeFromDOMNode as sl, $createNodeSelection as cl, $setSelection as ll, $getEditor as dl, DecoratorNode as no, $getState as wl, toggleTextFormatType as cn, TEXT_TYPE_TO_FORMAT as ul, $setState as pl, addClassNamesToElement as fi, $create as hl, $getNodeByKey as gl, removeClassNamesFromElement as fl, KEY_TAB_COMMAND as ml, $isBlockElementNode as vl, $createRangeSelection as bl, $normalizeSelection__EXPERIMENTAL as xl, OUTDENT_CONTENT_COMMAND as yl, INDENT_CONTENT_COMMAND as ln, INSERT_TAB_COMMAND as kl, COMMAND_PRIORITY_CRITICAL as Oo, $isDecoratorNode as _l, $isParagraphNode as Nl, $isTextNode as io, SELECTION_CHANGE_COMMAND as mi, $insertNodes as Cl } from "lexical";
import { HeadingNode as El, QuoteNode as Tl, registerRichText as Sl } from "@lexical/rich-text";
import { flushSync as Rl, createPortal as Dl } from "react-dom";
import { $isTableSelection as Ml } from "@lexical/table";
import { createHeadlessEditor as vi } from "@lexical/headless";
import { $generateHtmlFromNodes as zl, $generateNodesFromDOM as Ol } from "@lexical/html";
import { Avatar as Io, Select as Zt, Checkbox as dn, Slot as jr, Tabs as fe, Menubar as Ne, ContextMenu as Lt, Progress as wn, Slider as Wr, Switch as un } from "radix-ui";
import { useReactTable as bi, getFilteredRowModel as Il, getSortedRowModel as xi, getPaginationRowModel as Pl, getCoreRowModel as yi, flexRender as Mr, getGroupedRowModel as $l, getExpandedRowModel as Al } from "@tanstack/react-table";
import Vl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as so, HIDDEN_NOTE_CALLER as co, getDefaultViewOptions as Ll, isInsertEmbedOpOfType as Er, getMarkerMenuItems as jl, defaultStyleInfo as Bl, Editorial as Fl } from "@eten-tech-foundation/platform-editor";
...
import { toast as Mf } from "sonner";
...
let lo = "keyboard", hn = !1;
function Xl() {
  hn || typeof document > "u" || (hn = !0, document.addEventListener(
    "pointerdown",
    () => {
      lo = "pointer";
    },
...
function Jl({
  ...
  Y(() => {
    ...
    const $ = (G) => !!G && G.scrollWidth > G.clientWidth, et = () => {
      lo !== "pointer" && (T || $(h.current) || $(l.current)) && E(!0);
    }, _ = () => E(!1);
...
const Zl = "top-match", Ql = "Show recent searches", td = "Recent";
function ed({
  recentSearches: t,
  ...
  const [h, g] = N(!1), [f, y] = N(!1), b = oo(), R = U(!1), k = w !== void 0, E = k ? w : h, C = n === "" ? "" : re(n, Ql), I = re(s, td), T = (P) => {
  ...
  const A = (P) => {
    ...
    J,
    {
      ...
      children: /* @__PURE__ */ a(Qo, { className: "tw:h-4 tw:w-4" })
    }
  );
  return /* @__PURE__ */ u(ze, { open: E, onOpenChange: T, modal: !1, children: [
    /* @__PURE__ */ a(zt, { children: C ? /* @__PURE__ */ u(_t, { open: f, onOpenChange: j, children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: M }) }),
        ...
        children: [
          ...
          t.map((P) => /* @__PURE__ */ u(
            Ae,
            {
              ...
              children: [
                /* @__PURE__ */ a(Qo, { className: "tw:me-2 tw:h-4 tw:w-4 tw:opacity-50" }),
...
function Yp(t, e, r = (n, s) => n === s, o = 15) {
  return (n) => {
    const s = t.filter(
      (c) => !r(c, n)
    ), i = [n, ...s.slice(0, o - 1)];
...
const ia = {
  ...
  ia.BOOK_ONLY,
  ia.BOOK_CHAPTER,
  ia.BOOK_CHAPTER_VERSE
];
function od(t) {
  return ia.BOOK_CHAPTER_VERSE.test(t.trim());
}
function gn(t, e) {
  ...
  const o = ad.reduce(
    (n, s) => {
      ...
      if (i) {
        ...
        if (!w && l) {
          const g = ((f) => Object.keys(wa).find(
            (y) => wa[y].toLowerCase() === f.toLowerCase()
          ))(c);
...
function uo(t) {
  return {
    [Dt.OT]: t.filter((e) => Vt.isBookOT(e)),
    [Dt.NT]: t.filter((e) => Vt.isBookNT(e)),
    [Dt.DC]: t.filter((e) => Vt.isBookDC(e)),
    [Dt.Extra]: t.filter((e) => Vt.extraBooks().includes(e))
  };
}
function sd(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : Vt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
  ), i = uo(s), c = Object.values(i).flat(), l = uo(t);
  return {
...
function ld({
  ...
  switch (o === "rtl" ? cd(e) : e) {
    ...
    case "ArrowRight":
      return t < r ? t + 1 : 1;
    case "ArrowUp":
      return Math.max(1, t - po);
    case "ArrowDown":
      return Math.min(r, t + po);
    default:
      return t;
  }
}
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(
      "div",
      {
        ...
        style: { gridTemplateColumns: `repeat(${po}, minmax(0, 1fr))` },
...
function Ba({
  ...
  const j = _e(), A = Wl(), M = T ?? A, [P, W] = N(!1), [B, Q] = N(""), [$, et] = N(""), [_, z] = N("books"), [G, it] = N(void 0), [ot, pt] = N(
    void 0
  ), [ct, Z] = N(void 0), [nt, gt] = N(!1), [ft, mt] = N(!1), Qt = U(null), vt = U(!1), Ft = U(void 0), Et = U(void 0), bt = U(void 0), Ut = U(void 0), Ot = U({}), Kt = U({}), lt = F(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
    ...
    projectBooksBySection: we,
    reachableBooksBySection: ue,
    reachableBooks: Ht,
    projectBooks: qe,
    ...
    if (!D) return;
    const v = B.startsWith(`${D.book} `) ? B : "", q = Xr(v), at = Rr(v);
    return {
      book: D.book,
  ...
  const It = F(() => {
    ...
    z("books"), it(void 0), pt(void 0), Z(void 0), setTimeout(() => {
      var v;
      (v = Et.current) == null || v.focus();
    }, 0);
  }, []), H = F(() => {
    const v = ot;
    pt(void 0), Z(void 0), v ? (it(v), z("chapters"), Q("")) : x();
  }, [ot, x]), O = F(
    (v) => {
      W(v), v && (z("books"), it(void 0), pt(void 0), Z(void 0), et(""), mt(se));
    },
    [se]
  );
  Y(() => {
  ...
  Y(() => {
    var v;
    rt !== 0 && ((v = Et.current) == null || v.focus());
  }, [rt]), Tc(
    C,
    () => ({
      open: () => {
  ...
  const { otLong: ht, ntLong: kt, dcLong: St, extraLong: Pt } = {
    ...
    () => M >= oa.TIGHT ? Dr(t.book, s) : he(t.book, s),
    [t.book, s, M]
  ), Da = `${t.chapterNum}:${t.verseNum}`, Ma = F((v) => (q) => {
    Ot.current[v] = q;
  }, []), Fr = F((v) => (q) => {
    Kt.current[v] = q;
  }, []), _r = V(
    () => od($),
    [$]
  ), me = V(() => !w || !D || !D.chapterNum || !_r ? !1 : w(D.book, D.chapterNum) > 0, [w, D, _r]), Nr = _ === "books" && !nt && !$.trim() && qt.size > 0, Ur = F(
    (v) => p ? gn(v, p) : !1,
    [p]
  ), Te = F(
    (v) => (q) => p ? nd(v, q, p) : !1,
    ...
    (v) => {
      ...
      if (!(!!q && !!((Go = Ft.current) != null && Go.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      const { isLetter: $t, isDigit: Bt } = pn(v.key);
      if ((_ === "chapters" || _ === "verses") && (v.key === " " || v.key === "Enter")) {
        ...
        const Se = (() => {
          if (_ === "verses") {
            const Cr = ot, Wo = ct, Pa = Xr(B);
            return !Cr || !Wo || Pa === void 0 ? void 0 : {
              isDisabled: ir(Cr, Wo)(Pa),
              activate: () => oe(Pa)
            };
          }
          const ie = G, pe = Rr(B);
        ...
        if (Se) {
          v.preventDefault(), v.stopPropagation(), Se.isDisabled || Se.activate();
          return;
        }
      }
      if (_ === "books" && D && !nt && v.key === "Enter" && !(q !== Et.current && !!(q != null && q.closest('button, a, input, select, textarea, [role="button"]')))) {
        v.preventDefault(), v.stopPropagation(), It();
        return;
      }
      if ((_ === "chapters" || _ === "verses") && ($t || Bt)) {
      ...
      if (!Gl(v.key) || nt) return;
      if (_ === "books" && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const ce = q === Et.current ? Et.current : void 0, Se = (ce == null ? void 0 : ce.selectionStart) ?? 0, ie = (ce == null ? void 0 : ce.selectionEnd) ?? 0, pe = j === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
        if (!!ce && (Se !== ie || (pe ? Se > 0 : ie < ce.value.length))) return;
      }
      if (v.shiftKey || _ === "books" && q !== Et.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const xt = (() => {
        const ce = _ === "books" && D && me && D.chapterNum ? { bookId: D.book, chapterNum: D.chapterNum } : void 0, Se = _ === "verses" ? { bookId: ot, chapterNum: ct } : ce;
        if (Se) {
          const { bookId: ie, chapterNum: pe } = Se;
          return !ie || !pe || !w ? void 0 : {
            max: w(ie, pe),
            current: Xr(B) ?? 0,
            buildValue: (Cr) => na(ie, pe, Cr),
            refs: Kt,
        ...
        if (_ === "chapters" || _ === "books" && D && $e(D.book) > 1) {
          const ie = _ === "chapters" ? G : D == null ? void 0 : D.book;
          return ie ? {
            max: $e(ie),
            current: Rr(B) ?? 0,
            buildValue: (pe) => pr(ie, pe),
            refs: Ot,
      ...
      xt.takeFocus && ((Yo = Ft.current) == null || Yo.focus());
      const ee = ld({
        current: xt.current,
        key: v.key,
        max: xt.max,
      ...
      if (v.preventDefault(), v.stopPropagation(), ee === xt.current) return;
      Q(xt.buildValue(ee));
      const qo = xt.refs.current[ee];
    ...
    if (v.key === "ArrowUp" || v.key === "ArrowDown") {
      ($t = Et.current) == null || $t.focus();
      return;
    }
    const { isLetter: q, isDigit: at } = pn(v.key);
    (q || at) && (v.preventDefault(), et((xt) => xt + v.key), (Bt = Et.current) == null || Bt.focus(), gt(!1));
  }, []);
  Jt(() => {
    const v = setTimeout(() => {
      if (P && _ === "books" && bt.current && Ut.current) {
        const q = bt.current, at = Ut.current, $t = at.offsetTop, Bt = q.clientHeight, xt = at.clientHeight, ee = $t - Bt / 2 + xt / 2;
        q.scrollTo({
          top: Math.max(0, ee),
          behavior: "smooth"
        }), Q(wo(t.book));
    ...
    if (_ === "verses" && ot && ct !== void 0) {
      ...
      Q(
        ...
        if (bt.current)
          if (v) {
            const at = Kt.current[t.verseNum];
            at && at.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            bt.current.scrollTo({ top: 0 });
        Ft.current && Ft.current.focus();
  ...
  const cr = D ? `${D.book} ${D.chapterNum ?? ""} ${D.verseNum ?? ""} ${me}` : "", L = U(""), tt = U(""), Rt = V(() => {
    if (_ !== "books" || !D || nt) return;
  ...
  return Jt(() => {
    if (_ !== "books" || !D || !Rt || Rt.max <= 0) {
      L.current = "";
      return;
    }
    const { max: v, initial: q, parse: at, buildValue: $t } = Rt, Bt = (xt) => {
      const ee = at(xt);
      return ee !== void 0 && ee >= 1 && ee <= v && xt === $t(ee) ? ee : void 0;
    };
    if (L.current !== cr) {
      L.current = cr;
      const xt = $t(Math.min(Math.max(q, 1), v));
      tt.current = xt, Q(xt);
      return;
    }
    if (Bt(B) !== void 0) {
    ...
    Q(
      Bt(tt.current) !== void 0 ? tt.current : $t(Math.min(Math.max(q, 1), v))
    );
  }, [_, D, Rt, cr, B]), /* @__PURE__ */ u(tr, { open: P, onOpenChange: O, modal: k, children: [
    /* @__PURE__ */ a(yr, { asChild: !0, children: /* @__PURE__ */ u(
      J,
      {
        ref: Qt,
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            Jl,
            {
              primary: Ge,
              secondary: Da,
              showSecondary: M < oa.MINIMUM,
              isPartial: M >= oa.TIGHT,
              fullText: nr
            }
          ),
          y && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      er,
      {
        ...
        onPointerDownOutside: (v) => {
          const { target: q } = v;
          P && Qt.current && q instanceof Node && Qt.current.contains(q) && (vt.current = !0, O(!1));
        },
        onCloseAutoFocus: R,
        children: /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(
          rr,
          {
            ...
            shouldFilter: !1,
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: m("tw:flex tw:items-end", nt && "tw:pb-1"), children: [
                ...
                /* @__PURE__ */ a(ka, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: X.map(
                  ({ onClick: v, disabled: q, title: at, icon: $t, group: Bt }, xt) => {
                    const ee = /* @__PURE__ */ a(
                      J,
                      {
                        variant: "ghost",
                    ...
                    return (
                      ...
                      /* @__PURE__ */ u(Vr, { children: [
                        xt > 0 && Bt !== X[xt - 1].group && /* @__PURE__ */ a(xo, {}),
                        q ? (
                          ...
                          /* @__PURE__ */ a(Nt, { asChild: !0, children: ee }),
                ...
                /* @__PURE__ */ u(_t, { children: [
                  /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
                    J,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": We,
                      children: j === "ltr" ? /* @__PURE__ */ a($s, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(As, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                  /* @__PURE__ */ a(Ct, { children: We })
                ] }),
                _ === "chapters" && G && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: he(G, s) }),
                _ === "verses" && ot && ct !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${he(ot, s)} ${ct}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: _ === "verses" ? Kr : Ye
                  }
                )
              ] }),
              !nt && /* @__PURE__ */ u(ar, { ref: bt, children: [
                _ === "books" && /* @__PURE__ */ u(wt, { children: [
                  !D && Object.entries(te).map(([v, q]) => {
                    if (q.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Be, { heading: ne(v), children: q.map((at) => /* @__PURE__ */ a(
                          ki,
                          {
                            bookId: at,
                            onSelect: ($t) => Ee($t),
                            section: ra(at),
                            commandValue: wo(at),
                            ref: at === t.book ? Ut : void 0,
                            localizedBookNames: s,
                            disabled: Ur(at),
                            dimmedReason: qt.has(at) ? za : void 0,
                            dimmedDescription: qt.has(at) ? Oa(at) : void 0
                          },
                          at
                        )) }, v)
                      );
                  }),
                  D && yt && /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ u(
                    Ke,
                    {
                      value: Zl,
                      onSelect: It,
                      ...
                      children: [
                        /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1", children: Re(
                          yt,
                          he(D.book, s)
                        ) }),
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: Dr(D.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  D && me && D.chapterNum && w && /* @__PURE__ */ u(wt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${he(D.book, s)} ${D.chapterNum}` }),
                  ...
                  D && !me && $e(D.book) > 1 && /* @__PURE__ */ u(wt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: he(D.book, s) }),
              ...
              Nr && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                J,
                {
                  variant: "ghost",
                  size: "sm",
...
function vn({
  ...
  return /* @__PURE__ */ u(tr, { open: E, onOpenChange: C, ...k, children: [
    /* @__PURE__ */ a(yr, { asChild: !0, children: /* @__PURE__ */ u(
      J,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      er,
      {
        ...
        children: /* @__PURE__ */ u(rr, { children: [
          ...
          /* @__PURE__ */ a(_a, { children: g }),
          /* @__PURE__ */ a(ar, { children: T(e) ? e.map((A) => /* @__PURE__ */ a(Be, { heading: A.groupHeading, children: A.options.map((M) => j(M, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(Be, { children: e.map((A) => j(A)) }) })
        ] })
      }
    )
  ] });
...
var ho = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(ho || {});
((t) => {
...
function Jp({
  ...
  const w = Fa(d, "%webView_bookSelector_currentBook%"), p = Fa(d, "%webView_bookSelector_choose%"), h = Fa(d, "%webView_bookSelector_chooseBooks%"), [g, f] = N(
    "current book"
    /* CurrentBook */
  ), y = (b) => {
    f(b), t(b);
    ...
    yo,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Mt, { className: "tw:flex tw:items-center", children: o.map((b) => Vt.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ a(
            J,
            {
...
const Ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, pd = Ci ? Jt : Y, Zr = { tag: Mo };
function hd({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: l } = t, d = ud(null, o), w = si({ editable: t.editable, html: l, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = Lr();
            g.append(f);
            const y = Ci ? document.activeElement : null;
            (ae() !== null || y !== null && y === p.getRootElement()) && f.select();
          }
        }, Zr);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const g = p.parseEditorState(h);
            p.setEditorState(g, Zr);
            break;
          }
          case "object":
            p.setEditorState(h, Zr);
            break;
          case "function":
            p.update(() => {
              Ue().isEmpty() && h(p);
  ...
  }, []), a(Ni.Provider, { value: r, children: e });
}
const gd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function fd({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Ce();
  return gd(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: s, dirtyLeaves: i, prevEditorState: c, tags: l }) => {
      e && s.size === 0 && i.size === 0 || t && l.has(Mo) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const Ao = {
...
function xd({ children: t, onError: e }) {
...
const yd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function kd(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function _d() {
  return function(t) {
    const [e] = Ce(), r = V(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), s = U(o);
    return yd(() => {
...
const Ei = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cd = Ei && "documentMode" in document ? document.documentMode : null;
!(!Ei || !("InputEvent" in window) || Cd) && "getTargetRanges" in new window.InputEvent("input");
function be(t) {
  return `${t}px`;
}
...
function Td(t, e, r) {
  ...
  function l() {
    o === null && ga(182), n === null && ga(183);
    const { left: p, top: h } = n.getBoundingClientRect(), g = Nd(t, e);
    var f, y;
    ...
    w.read(() => {
      ...
      if ((T || j) && C !== null && I !== null) {
        const A = function(M, P, W, B, Q, $, et) {
          ...
          return _.setStart(...bn(P, W, B)), _.setEnd(...bn(Q, $, et)), _;
        }(t, h, f, C, g, R, I);
        l(), l = Td(t, A, e);
      }
...
function Dd(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? r !== null && (r(), r = null) : r === null && (r = Rd(t, e));
  };
...
function Md(t) {
  const e = wi(t, (r) => Pr(r) && !r.isInline());
  return Pr(e) || ga(4, t.__key), e;
}
function zd(t) {
  const e = ae() || jc();
  let r;
  if (ye(e)) r = Bc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = di(c, "next"));
    }
    r = r || Fc(Ue(), "previous").getFlipped().insert(Lr());
  }
  const o = Od(t, r), n = Uc(o), s = Kc(n) ? Hc(n) : o;
  return qc(Gc(s)), t.getLatest();
}
function Od(t, e, r) {
  let o = sn(e, "next");
  for (let n = o; n; n = Yc(n, r)) o = n;
  return Wc(o) && ga(283), o.insert(t.isInline() ? Lr().append(t) : t), sn(di(t.getLatest(), "next"), e.direction);
}
function Id(t) {
  const e = ae();
  if (!ye(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(i)) continue;
    const c = wi(s, (d) => Pr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function Ta() {
  ...
  for (!function() {
    let r = fa;
    for (fa = void 0; r !== void 0; ) r.S.v === r.v && (r.S.i = r.i), r = r.o;
  }(); zr !== void 0; ) {
    let r = zr;
    for (zr = void 0, ma++; r !== void 0; ) {
      const o = r.u;
...
let fa, De = 0, ma = 0, Ad = 0, go = 0, sa = 0;
function yn(t) {
  if (st === void 0) return;
  let e = t.n;
...
function Xe(t, e) {
  Wt.call(this, void 0), this.x = t, this.s = void 0, this.g = sa - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Vd(t, e) {
  return new Xe(t, e);
}
...
function Ld(t) {
  ...
  Si(this), st = t, this.f &= -2, 8 & this.f && Lo(this), Ta();
}
function dr(t, e) {
...
function kr(t, e = {}) {
  const r = {};
  for (const o in t) {
    const n = e[o], s = $r(n === void 0 ? t[o] : n);
    r[o] = s;
  }
  return r;
}
Wt.prototype.brand = Pd, Wt.prototype.h = function() {
  ...
  if (t !== this.v) {
    if (ma > 100) throw new Error("Cycle detected");
    (function(e) {
      De !== 0 && ma === 0 && e.l !== go && (e.l = go, fa = { S: e, v: e.v, i: e.i, o: fa });
    })(this), this.v = t, this.i++, sa++, De++;
    try {
  ...
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === sa)) return !0;
  if (this.g = sa, this.f |= 1, this.i > 0 && !Ti(this)) return this.f &= -2, !0;
  const t = st;
  try {
    kn(this), st = this;
    const e = this.x();
  ...
  return st = t, Si(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ri(this), kn(this), De++;
  const t = st;
  return st = this, Ld.bind(this, t);
}, dr.prototype.N = function() {
  2 & this.f || (this.f |= 2, this.u = zr, zr = this);
}, dr.prototype.d = function() {
  this.f |= 8, 1 & this.f || Lo(this);
}, dr.prototype.dispose = function() {
  this.d();
};
de({ build: (t, e, r) => kr(e), config: or({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Di() {
  const t = Ue(), e = ae(), r = Lr();
  t.clear(), t.append(r), e !== null && r.select(), ye(e) && (e.format = 0);
}
function Mi(t, e = Di) {
  return t.registerCommand(ui, (r) => (t.update(e), !0), zo);
}
de({ build: (t, e, r) => kr(e), config: or({ $onClear: Di }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ke(() => Mi(t, o.value));
} });
function jd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Ka = Qc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class zi extends no {
  $config() {
    return this.config("decorator-text", { extends: no, stateConfigs: [{ flat: !0, stateConfig: Ka }] });
  }
  getFormat() {
    return wl(this, Ka);
  }
  getFormatFlags(e, r) {
    return cn(this.getFormat(), e, r);
  }
  hasFormat(e) {
    const r = ul[e];
  ...
  toggleFormat(e) {
    const r = this.getFormat(), o = cn(r, e, null);
...
de({ name: "@lexical/extension/DecoratorText", nodes: () => [zi], register: (t, e, r) => t.registerCommand(pi, (o) => {
  const n = ae();
  if (hi(n) || ye(n)) for (const s of n.getNodes()) Bd(s) && s.toggleFormat(o);
  return !1;
}, gi) });
function Oi(t, e) {
  let r;
...
const fo = de({ build: (t) => Oi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const jo = 0, mo = 1, Pi = 2, Ha = 3, Qr = 4, lr = 5, qa = 6, Tr = 7;
function Ga(t) {
  return t.id === jo;
}
function $i(t) {
...
function Fd(t) {
  return function(e) {
    return e.id === mo;
  }(t) || ut(305, String(t.id), String(mo)), Object.assign(t, { id: Pi });
}
...
class Kd {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(c, l, d) {
      return Object.assign(c, { config: l, id: Ha, registerState: d });
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Qr && ut(307, String(r.id), String(lr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
    const n = { ...r.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(s, i, c) {
      return Object.assign(s, { id: lr, output: i, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== lr && ut(308, String(o.id), String(lr));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(s) {
      return Object.assign(s, { id: qa });
    }(o), () => {
      const s = this.state;
      s.id !== Tr && ut(309, String(o.id), String(Tr)), this.state = function(i) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== qa && ut(310, String(r.id), String(qa)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Qr;
    }(e) || ut(313, String(e.id), String(Qr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Ha;
    }(e) || ut(314, String(e.id), String(Ha)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || Ud;
  }
  getPeerNameSet() {
...
const qd = de({ config: or({ setOptions: _n, updateOptions: _n }), init: ({ $initialEditorState: t = Hd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: s } = n;
    if (al(s)) t.setEditorState(s, r);
...
}, name: "@lexical/extension/InitialState", nodes: [tl, li, el, rl, ci] }), Nn = Symbol.for("@lexical/extension/LexicalBuilder");
function Cn() {
}
function Gd(t) {
  throw t;
...
class hr {
  ...
  static fromExtensions(e) {
    const r = [ta(qd)];
    for (const o of e) r.push(ta(o));
    return new hr(r);
  }
  static maybeFromEditor(e) {
    const r = e[Nn];
    return r && (r.PACKAGE_VERSION !== Ya && ut(292, r.PACKAGE_VERSION, Ya), r instanceof hr || ut(293)), r;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(si({ ...o, ...r ? { onError: (s) => {
      r(s, n);
    } } : {} }), { [Nn]: this });
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ga(s) || ut(300, i, n || "[unknown]"), Ga(c = s) || ut(304, String(c.id), String(jo)), s = Object.assign(c, { id: mo }), o.state = s;
      const l = this.outgoingConfigEdges.get(i);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, i);
      }
      s = Fd(s), o.state = s, e.push(o);
    };
    for (const o of this.extensionNameMap.values()) Ga(o.state) && r(o);
...
const Yd = /* @__PURE__ */ new Set(), En = de({ build(t, e, r) {
  const o = r.getDependency(fo).output, n = $r({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Oi(() => {
  }, () => ke(() => {
...
de({ dependencies: [fo, En], name: "@lexical/extension/HorizontalRule", nodes: () => [gr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(En).output, n = $r({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Me(t.registerCommand(Wd, (i) => {
    const c = ae();
    if (!ye(c)) return !1;
    ...
    return !0;
  }, zo), t.registerCommand(nl, (i) => {
    if (il(i.target)) {
      const c = sl(i.target);
      if (Jd(c)) return function(l, d = !1) {
        const w = ae(), p = l.isSelected(), h = l.getKey();
        let g;
        d && hi(w) ? g = w : (g = cl(), ll(g)), p ? g.delete(h) : g.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  }, gi), t.registerMutationListener(gr, (i, c) => {
    $d(() => {
      let l = !1;
      ...
      for (const [w, p] of i.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = g : (l = !0, d.set(w, { domNode: $r(g), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) i.push(ke(() => {
      const d = c.value;
      d && (l.value ? fi(d, s) : fl(d, s));
    }));
    return Me(...i);
  }));
} });
de({ build: (t, e) => kr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: or({ $getParentEditor: function() {
  const t = dl();
...
de({ build: (t, e, r) => kr(e), config: or({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ke(() => {
...
function Zd(t, e, r = Ai) {
  return Me(t.registerCommand(ml, (o) => {
    const n = ae();
    if (!ye(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => vl(h) && h.canIndent()).length > 0) return !0;
      const c = i.anchor, l = i.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Md(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = bl();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = xl(g), g.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? yl : ln : kl;
    return t.dispatchCommand(s, void 0);
  }, zo), t.registerCommand(ln, () => {
...
de({ build: (t, e, r) => kr(e), config: or({ $canIndent: Ai, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: s } = r.getOutput();
  return ke(() => {
    if (!o.value) return Zd(t, n, s);
  });
} });
const Qd = de({ name: "@lexical/react/ReactProvider" });
function tw() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ye(f)) {
                ...
                if (io(b) && d >= 0 && w >= 0 && (R = d, k = d + w, f.setTextNodeRange(b, R, b, k)), R === k && p === "" || (f.insertRawText(p), b = y.getNode()), io(b)) {
                  R = h, k = h + g;
...
de({ build: (t, e, r) => kr(e), config: or({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ke(() => r.getOutput().disabled.value ? void 0 : Li(t)) });
function aw(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Fo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function ow({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    ...
    return Fo(() => r.registerDecoratorListener((i) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(Rc, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && i.push(Dl(w, p, d));
      }
      return i;
    }, [o, n, r]);
  }(t, e);
...
function nw({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Qd.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && aw(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(ow, { editor: t, ErrorBoundary: e });
}
function Tn(t) {
  return t.getEditorState().read(Vi(t.isComposing()));
}
function iw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Ce();
  return function(n) {
    Fo(() => Me(Sl(n), Li(n)), [n]);
  }(o), u(wt, { children: [t, a(sw, { content: e }), a(nw, { editor: o, ErrorBoundary: r })] });
}
...
const lw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function dw({ onClear: t }) {
  const [e] = Ce();
  return lw(() => Mi(e, t), [e, t]), null;
}
const ji = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function ww({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: y, role: b = "textbox", spellCheck: R = !0, style: k, tabIndex: E, "data-testid": C, ...I }, T) {
  ...
  return ji(() => (A(t.isEditable()), t.registerEditableListener((W) => {
    A(W);
...
function hw(t, e) {
  ...
  return u(wt, { children: [a(uw, { editor: n, ...o, ref: e }), r != null && a(gw, { editor: n, content: r })] });
}
...
function mw({
  ...
  return /* @__PURE__ */ a(Bi.Provider, { value: i, children: s });
}
function Fi() {
  const t = Do(Bi);
  if (!t)
...
function vw() {
  const [t, e] = N(void 0), r = F(() => {
    ...
    return /* @__PURE__ */ a(Za, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Qa, { children: [
      /* @__PURE__ */ a(to, { children: /* @__PURE__ */ a(eo, { children: s }) }),
      i
    ] }) });
  }, [t, r]), n = F(
    (s, i, c = !1) => {
...
function bw({
  ...
  const [e] = Ce(), [r, o] = N(e), [n, s] = N("paragraph"), [i, c] = vw(), l = () => {
  };
...
function yw() {
  const { activeEditor: t } = Fi(), [e, r] = N([]), o = F((n) => {
    if (ye(n) || Ml(n)) {
      const s = [];
      Rn.forEach(({ format: i }) => {
...
function _w({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(bw, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(yw, {}) }) }),
      ...
      /* @__PURE__ */ a(
        iw,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ a(fw, { placeholder: t }) }),
          ErrorBoundary: xd
        }
      ),
      e && /* @__PURE__ */ a(cw, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(kw, { onClear: r }),
      /* @__PURE__ */ a(dw, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ a(
          hd,
          {
            ...
            children: /* @__PURE__ */ u(zt, { children: [
              /* @__PURE__ */ a(_w, { placeholder: n, autoFocus: s, onClear: i }),
              /* @__PURE__ */ a(
                fd,
                {
...
function Cw(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), s = Ol(e, n);
      Ue().clear(), Cl(s);
    },
    {
      discrete: !0
...
function qi({
  ...
  return /* @__PURE__ */ u(ka, { children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
        J,
        {
          "aria-label": i,
...
const Ew = "verseText", Zp = Object.freeze([
...
function Qp({
  ...
  const [s, i] = N(Tw), [c, l] = N(n), [d, w] = N(!1), p = U(void 0), h = U(null);
  Y(() => {
    let b = !0;
    const R = h.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
      ...
      /* @__PURE__ */ a(yr, { asChild: !0, children: /* @__PURE__ */ u(
        J,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: Wa(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        er,
        {
          ...
          children: /* @__PURE__ */ a(rr, { children: /* @__PURE__ */ a(ar, { children: t.map((b) => /* @__PURE__ */ a(
            Ke,
            {
              ...
              children: /* @__PURE__ */ a("span", { children: Wa(b, o) })
            },
            b || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : Ko(b) && (b.preventDefault(), b.stopPropagation(), le(s) && g());
        },
        onKeyDown: (b) => {
...
function Mn({
  ...
  const g = F(
    ...
    [t.user]
  ), k = V(() => Ro(t.contents), [t.contents]), E = V(
    ...
    if (o && c)
      return /* @__PURE__ */ u(wt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(Cw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Mw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(zw, { className: "tw:text-xs tw:font-medium", children: R }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : Ko(T) && (T.preventDefault(), T.stopPropagation(), le(w) && f());
              },
              onKeyDown: (T) => {
          ...
          !l && /* @__PURE__ */ u(wt, { children: [
            ...
            C ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: Wi(t.conflictResolutionAction) === "merged" ? r["%conflict_note_outcome_combined%"] ?? "Combined both changes." : r["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: m(
        ...
        I && /* @__PURE__ */ u(ze, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Fs, {}) }) }),
          /* @__PURE__ */ a(Oe, { align: "end", children: I })
        ] })
      ]
    }
  );
...
function Ji({
  ...
  const [B, Q] = N(zn), [$, et] = N(), [_, z] = N(), G = o, [it, ot] = N(!1), [pt, ct] = N(!1), [Z, nt] = N(!1), [gt, ft] = N(!1), [mt, Qt] = N(!1), [vt, Ft] = N(C), [Et, bt] = N(!1), Ut = U(void 0), [Ot, Kt] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
  ...
  const jt = V(() => Tt[0], [Tt]), we = U(null), ue = U(void 0), Ht = F(() => {
    var x;
    (x = ue.current) == null || x.call(ue), Q(zn);
  }, []), qe = F(() => {
    const x = !vt;
    Ft(x), bt(!x), f == null || f(l, x);
  }, [vt, f, l]);
  Y(() => {
    ot(!1);
  }, [o]), Y(() => {
  ...
  }, [s, r]), te = V(() => Tt.slice(1), [Tt]), D = V(() => te.length ?? 0, [te.length]), yt = V(() => D > 0, [D]), Gt = V(() => it || D <= 2 ? te : te.slice(-2), [te, D, it]), It = V(() => it || D <= 2 ? 0 : D - 2, [D, it]), oe = V(
    () => D === 1 ? qt.singleReply : Le(qt.multipleReplies, { count: D }),
    [D, qt]
  ), Ee = V(
    () => It === 1 ? qt.singleReply : Le(qt.multipleReplies, { count: It }),
    [It, qt]
  );
  Y(() => {
    !o && pt && yt && ct(!1);
  ...
  const S = F(
    async (x) => {
      ...
      H && await p({ threadId: l, contents: H }) && Ht();
    },
    [
      Ht,
      B,
    ...
    async (x) => {
      const H = le(B) ? ba(B) : void 0, O = x.status ? x.assignedUser : $ ?? x.assignedUser, rt = await p({
        ...x,
        contents: H,
        assignedUser: O
      });
      return rt && (O !== void 0 && z(O), H && Ht()), rt;
    },
    [Ht, B, p, $]
  );
      ...
      children: /* @__PURE__ */ u(Dw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            se && /* @__PURE__ */ a(Or, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: se }),
            /* @__PURE__ */ a(
              J,
              {
                variant: "ghost",
                ...
                children: vt ? /* @__PURE__ */ a(Us, {}) : /* @__PURE__ */ a(Ks, {})
              }
            ),
            P === void 0 ? (
        ...
        /* @__PURE__ */ u(wt, { children: [
          ...
          o && /* @__PURE__ */ u(wt, { children: [
            W && Gt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            It > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    it ? /* @__PURE__ */ a(Xn, {}) : /* @__PURE__ */ a(Qe, {})
                  ] })
                ]
              }
            ),
            Gt.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Mn,
              {
                comment: x,
                localizedStrings: r,
            ...
            b !== !1 && (!pt || le(B)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  Ko(x) && (x.preventDefault(), x.stopPropagation(), (le(B) || $ !== void 0 && $ !== _) && S());
                },
                onKeyDown: (x) => {
                  Uo(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    va,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    $ !== void 0 && (le(B) || $ !== _) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Le(
                    ...
                    /* @__PURE__ */ u(tr, { open: Z, onOpenChange: nt, children: [
                      /* @__PURE__ */ a(yr, { asChild: !0, children: /* @__PURE__ */ a(
                        J,
                        {
                          size: "icon",
                          variant: "outline",
                      ...
                      /* @__PURE__ */ a(
                        er,
                        {
                          ...
                          align: "end",
                          onKeyDown: (x) => {
                            x.key === "Escape" && (x.stopPropagation(), nt(!1));
                          },
                          children: /* @__PURE__ */ a(rr, { children: /* @__PURE__ */ a(ar, { children: y == null ? void 0 : y.map((x) => /* @__PURE__ */ a(
                            Ke,
                            {
                              onSelect: () => {
                                et(x !== s ? x : void 0), lt.current = "user-selected", z(void 0), nt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: ca(x, r) })
                            },
                            x || "unassigned"
                          )) }) })
                        }
...
), Iw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), la = (t) => Iw(Ro(t));
function da({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Pw({
  ...
  const [i, c] = N("accept"), l = oo(), d = oo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : i, y = V(
    () => la(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = V(
    () => la(t.acceptedText ?? ""),
    ...
    () => la(t.mergedText ?? ""),
    [t.mergedText]
  ), k = V(() => Ro(t.contents), [t.contents]);
  if (!Yi(t))
    return /* @__PURE__ */ a(da, { html: k });
  const E = (_) => {
  ...
  const P = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: P }), B = (_) => _ ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: _ }) : W, Q = () => {
    const _ = o ?? "accept";
    return _ === "merged" ? t.mergedText ? /* @__PURE__ */ a(da, { html: R }) : W : B(_ === "reject" ? t.rejectedResultText : t.resultText);
  }, $ = (_) => p && _.value === "reject", et = (_) => {
    const z = f === _.value, G = `${d}-${_.value}`, it = $(_);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(wt, { children: [
        ...
        /* @__PURE__ */ a(
          yo,
          {
            ...
            children: T.map((_) => $(_) ? /* @__PURE__ */ a(zt, { delayDuration: 0, children: /* @__PURE__ */ u(_t, { children: [
              /* @__PURE__ */ a(Nt, { asChild: !0, children: et(_) }),
              /* @__PURE__ */ a(Ct, { children: C })
            ] }) }, _.value) : et(_))
          }
        ),
        /* @__PURE__ */ a(zt, { delayDuration: 0, children: /* @__PURE__ */ u(_t, { children: [
    ...
    if (e === "Resolved") {
      for (let k = o.length - 1; k >= 0; k -= 1)
        if (o[k].status === "Resolved")
          return Wi(o[k].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function ch({
  ...
  const M = r.filter(
    ...
    [k, y]
  ), { listboxRef: Q, activeId: $, handleKeyDown: et } = fs({
    options: P,
    onOptionSelect: W
  }), _ = F(
    (z) => {
      ...
      children: M.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(jw, { ...G, conflictResolution: R }) : /* @__PURE__ */ a(Ji, { ...G })
          },
          z.id
        );
      })
...
function vr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Zt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Zt.Icon, { asChild: !0, children: /* @__PURE__ */ a(ni, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ge({
  ...
  return /* @__PURE__ */ u(
    Zt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Zt.ItemIndicator, { children: /* @__PURE__ */ a(Ea, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        fr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(br, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ge, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function qw({
  ...
  var T;
  const [w, p] = N([]), [h, g] = N([]), [f, y] = N({}), [b, R] = N({}), k = V(() => e ?? [], [e]), E = bi({
    data: k,
    columns: t,
    getCoreRowModel: yi(),
    ...r && { getPaginationRowModel: Pl() },
    onSortingChange: p,
    getSortedRowModel: xi(),
  ...
  let I;
  return l ? I = Array.from({ length: 10 }).map((M, P) => `skeleton-row-${P}`).map((M) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ur, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(wr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, M)) : ((T = E.getRowModel().rows) == null ? void 0 : T.length) > 0 ? I = E.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    Ve,
    {
      onClick: () => i(j, E),
      "data-state": j.getIsSelected() && "selected",
      children: j.getVisibleCells().map((A) => /* @__PURE__ */ a(ur, { children: Mr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    j.id
  )) : I = /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(ur, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Bw, { table: E }),
    /* @__PURE__ */ u(_o, { stickyHeader: s, children: [
      /* @__PURE__ */ a(No, { stickyHeader: s, children: E.getHeaderGroups().map((j) => /* @__PURE__ */ a(Ve, { children: j.headers.map((A) => /* @__PURE__ */ a(pa, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : Mr(A.column.columnDef.header, A.getContext()) }, A.id)) }, j.id)) }),
      /* @__PURE__ */ a(Co, { children: I })
    ] }),
...
function wh({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(Vl, { options: s, children: e })
    }
  );
}
...
function Yw({
  ...
  const n = On(r, "%webView_error_dump_header%"), s = On(r, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(J, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ a(Qn, {}) })
        ] }),
...
function ph({
  ...
  return /* @__PURE__ */ u(tr, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ a(yr, { asChild: !0, children: o }),
    /* @__PURE__ */ u(er, { id: s, className: m("tw:min-w-80 tw:max-w-96", n), children: [
...
function hh({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ze, { children: [
    ...
    /* @__PURE__ */ a(Oe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(xr, { children: d.label }),
      /* @__PURE__ */ a(Kn, { children: d.itemType === 0 ? /* @__PURE__ */ a(wt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        je,
        {
          checked: o[w][h],
        ...
        ms,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(vs, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Ze, {})
    ] }, d.label)) })
...
function Zw({
  ...
  const l = ko(), d = In(n, "%undoButton_tooltip%"), w = In(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(ka, { children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
        J,
      ...
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(wt, { children: [
          " ",
          /* @__PURE__ */ a(ro, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(xo, {}),
    e && /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
        J,
        {
          "aria-label": w,
      ...
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(wt, { children: [
          " ",
          /* @__PURE__ */ a(ro, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function Qw({
  ...
  return Y(() => {
    var l;
    const s = ko(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
const tu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(wt, { children: [
...
function eu({
  ...
  return /* @__PURE__ */ u(ze, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: tu(t, o, e) }) }) }),
    ...
    /* @__PURE__ */ u(
      Oe,
      {
        ...
        children: [
          /* @__PURE__ */ a(xr, { children: o["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(Ze, {}),
          /* @__PURE__ */ a(
            je,
            {
          ...
          /* @__PURE__ */ a(
            je,
            {
              ...
              children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ a("span", { className: "tw:w-10 tw:text-center", children: co })
              ] })
            }
          ),
          /* @__PURE__ */ a(
...
const ru = (t, e) => t === "f" ? /* @__PURE__ */ u(wt, { children: [
  /* @__PURE__ */ a(ei, {}),
  " ",
...
function ou({
  ...
  return /* @__PURE__ */ u(ze, { children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: ru(t, r) }) }) }),
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: au(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Oe, { style: { zIndex: Hn }, children: [
...
function iu({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? rc, { className: e, size: 16 });
}
function su({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
...
function Pn({
  ...
  return /* @__PURE__ */ u(
    Ke,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(su, { state: t.selectionState }),
...
function cu({
  ...
  return /* @__PURE__ */ u(rr, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(ar, { children: [
      /* @__PURE__ */ a(_a, { children: t["%markerMenu_noResults%"] }),
      ...
      c.length > 0 && /* @__PURE__ */ u(wt, { children: [
        i.length > 0 && /* @__PURE__ */ a(qn, { alwaysRender: !0 }),
...
function lu(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, i]) => {
    s.push(
      ...i.map((c) => ({
        marker: c,
        title: r[aa[c].description] ?? aa[c].description,
        action: () => {
          var l;
...
function vh({
  ...
  const [b, R] = N("generated"), [k, E] = N("generated"), [C, I] = N("*"), [T, j] = N("*"), [A, M] = N("f"), [P, W] = N(!1), [B, Q] = N(!0), [$, et] = N(!1), _ = U(!1), z = U(""), [G, it] = N(!1), [ot, pt] = N(), [ct, Z] = N(), [nt, gt] = N(), [ft, mt] = N(), Qt = U(null), vt = U(
    void 0
  ), Ft = U(0), Et = U(void 0), bt = V(
    () => ({
      ...i,
  ...
  Y(() => {
    var H, O;
    let S, K, X;
    _.current = !1, Et.current = void 0, Q(!0);
    const x = e == null ? void 0 : e.at(0);
    if (x && Er("note", x)) {
      const rt = (H = x.insert.note) == null ? void 0 : H.caller;
      let dt = "custom";
      rt === so ? dt = "generated" : rt === co ? dt = "hidden" : rt && (I(rt), j(rt)), R(dt), E(dt), M(((O = x.insert.note) == null ? void 0 : O.style) ?? "f"), S = setTimeout(() => {
        var ht, kt, St;
        (ht = h.current) == null || ht.applyUpdate([x]), (kt = h.current) == null || kt.selectNote(0), (St = h.current) == null || St.focus(), K = requestAnimationFrame(() => {
          X = setTimeout(() => {
            var Pt, ne;
            Ot() || ((Pt = h.current) == null || Pt.selectNote(0), (ne = h.current) == null || ne.focus());
          }, 0);
        });
      }, 0);
    }
  ...
  const Kt = F(
    (S = !1) => {
      ...
      K && Er("note", K) && (r == null || r([K]), S && d && s && ((H = d.current) == null || H.replaceEmbedUpdate(s, [K])));
    },
    [s, r, p, d]
  ), lt = F(
    (S, K) => {
      ...
      if (!X || !Er("note", X) || !X.insert.note) return;
      let x;
      S === "custom" ? x = K : S === "generated" ? x = so : x = co, X.insert.note.caller !== x && (X.insert.note.caller = x, (rt = h.current) == null || rt.applyUpdate([X, { delete: 1 }]));
    },
    []
  ), Tt = F(() => {
    var S;
    vt.current || (S = h.current) == null || S.commitPendingMarkerEdits(), Kt(!0), o();
  }, [o, Kt]), jt = U(Tt);
  Jt(() => {
    jt.current = Tt;
  });
  const we = U({ book: n.book, chapterNum: n.chapterNum });
  Jt(() => {
    (we.current.book !== n.book || we.current.chapterNum !== n.chapterNum) && (we.current = { book: n.book, chapterNum: n.chapterNum }, jt.current());
  }, [n.book, n.chapterNum]);
  const ue = () => {
    var K;
    ...
    if (K && Er("note", K)) {
      ...
      A !== "x" && S === "x" ? dt == null || dt.forEach((ht) => wu(ht)) : A === "x" && S !== "x" && (dt == null || dt.forEach((ht) => uu(ht))), (rt = h.current) == null || rt.applyUpdate([K, { delete: 1 }]);
    }
  }, qt = (S) => {
      ...
      if (K && Er("note", K)) {
        ...
        if (dt || W(!1), W(
          dt === "x" ? !!(ht != null && ht.every((kt) => {
            ...
            const St = ((ne = kt.attributes) == null ? void 0 : ne.char).style;
        ...
        Q(JSON.stringify(K) === z.current), Kt();
      } else
        W(!1), Q(!0);
    },
    [Kt]
    ...
    if (f.current && Ut.length && S && S.rangeCount > 0) {
      ...
      pt(K.left - X.left), Z(K.top - X.top), gt(K.height), it(!0);
    }
  }, [Ut, f]), D = U(() => {
  }), yt = F(
    (S, K, X) => {
      ...
      ks({
        ...
        clearSessionIfCurrent: (O) => Jo(vt, O),
        ...
        onShowError: (O) => {
          (!xc(O) || O.code !== yc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${kc(O)}`
          );
        }
      });
    },
    ...
    (S) => {
      ...
      _s(S, K, {
        ...
        commitTypedAndReopen: (x) => {
          var H;
          (H = h.current) == null || H.commitTypedMarker(x, { trailingSpace: !1 }), Gt();
        },
        commitTypedCloser: (x) => {
          var H;
  ...
  Y(() => {
    ...
    if (((X = bt.view) == null ? void 0 : X.markerMode) === "editable") {
      const x = (O) => {
        ...
        if (w && O.key === c) {
          ...
          Gt() && (O.preventDefault(), O.stopPropagation());
        }
      }, H = () => {
        var rt, dt;
        const O = S();
    ...
    const K = (x) => {
      const H = S();
      !G && H && document.activeElement === H && x.key === c ? (x.preventDefault(), te()) : G && x.key === "Escape" && (x.preventDefault(), it(!1));
    };
    ...
    te,
    c,
    (Ee = bt.view) == null ? void 0 : Ee.markerMode,
    bt.styleInfo,
    w,
    Gt,
    Ot
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
              /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
                J,
                {
                  "aria-label": oe,
              ...
              /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: oe }) })
            ] }) }) })
          ]
        }
      )
...
const bh = Object.freeze([
  ...nu,
  ...Object.entries(aa).map(([, t]) => t.description).filter((t) => !!t),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(ao, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
  ...
  return /* @__PURE__ */ u(wt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(wt, { children: hu(t.marker, c, o, d) })
      }
    )
  ] });
}
...
function vu({
  ...
  return /* @__PURE__ */ u(_o, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(No, { stickyHeader: !0, children: /* @__PURE__ */ u(Ve, { children: [
      /* @__PURE__ */ a(pa, { children: n }),
      /* @__PURE__ */ a(pa, { children: s })
    ] }) }),
    /* @__PURE__ */ a(Co, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      Ve,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(ur, { children: Re(c.reference, "English") }),
          /* @__PURE__ */ a(ur, { className: o, children: mu(c.text) })
        ]
      },
...
const bu = (t) => {
...
}, Sa = (t, e, r) => /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
  /* @__PURE__ */ u(
    Nt,
    {
  ...
  accessorKey: "status",
  header: ({ column: s }) => Sa(s, t, "tw:justify-center"),
  cell: ({ row: s }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(Un, { value: i, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          ea,
          {
            onClick: (l) => {
              l.stopPropagation(), Xa(
                [c],
                "approved",
                e,
                r,
  ...
  return e ? e[1] : "";
}, yu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Th = Object.freeze([
  ...
  const n = rn(o.key) ? o.key : o.key[0];
  return {
    items: rn(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || yu(n, e, r),
...
function Sh({
  ...
  const g = ve(r, "%webView_inventory_all%"), f = ve(r, "%webView_inventory_approved%"), y = ve(r, "%webView_inventory_unapproved%"), b = ve(r, "%webView_inventory_unknown%"), R = ve(r, "%webView_inventory_scope_currentBook%"), k = ve(r, "%webView_inventory_scope_chapter%"), E = ve(r, "%webView_inventory_scope_verse%"), C = ve(r, "%webView_inventory_filter_text%"), I = ve(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = ve(r, "%webView_inventory_no_results%"), [j, A] = N(!1), [M, P] = N("all"), [W, B] = N(""), [Q, $] = N([]), et = V(() => {
    const Z = t ?? [];
    return Z.length === 0 ? [] : _u(Z, n, s);
  }, [t, n, s]), _ = V(() => {
    if (j) return et;
    const Z = [];
    return et.forEach((nt) => {
      const gt = nt.items[0], ft = Z.find(
        (mt) => mt.items[0] === gt
      );
      ft ? (ft.count += nt.count, ft.occurrences = ft.occurrences.concat(nt.occurrences)) : Z.push({
        items: [gt],
        count: nt.count,
  ...
  }, [j, et]), z = V(() => _.length === 0 ? [] : ku(_, M, W), [_, M, W]), G = V(() => {
    var gt, ft;
    if (!j) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        fr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(br, { children: [
              ...
              /* @__PURE__ */ a(ge, { value: "unapproved", children: y }),
              /* @__PURE__ */ a(ge, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(fr, { onValueChange: (Z) => ot(Z), defaultValue: i, children: [
        ...
        /* @__PURE__ */ u(br, { children: [
          ...
          /* @__PURE__ */ a(ge, { value: "verse", children: E })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Na,
      ...
      o && /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
        /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Mt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? I })
        ] }) }),
...
const Nu = "16rem", Cu = "3rem", Qi = Xt.createContext(void 0);
function Ra() {
  const t = Xt.useContext(Qi);
  if (!t)
...
function Eu({
  ...
  const [l, d] = Xt.useState(t), w = e ?? l, p = Xt.useCallback(
    ...
    [r, w]
  ), h = Xt.useCallback(() => p((E) => !E), [p]), g = w ? "expanded" : "collapsed", b = _e() === "ltr" ? i : i === "primary" ? "secondary" : "primary", R = Xt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Qi.Provider, { value: R, children: /* @__PURE__ */ a(
    "div",
    {
...
function Rh({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = Ra();
  return /* @__PURE__ */ u(
    J,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(zc, {}) : /* @__PURE__ */ a(Oc, {}),
...
function Ou({
  ...
  const c = t ? jr.Root : "button", { state: l } = Ra(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: m(zu({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Tu,
    {
      ...
      children: /* @__PURE__ */ u(Ru, { children: [
        /* @__PURE__ */ u($n, { children: [
          ...
          /* @__PURE__ */ a(Vn, { children: /* @__PURE__ */ a(Du, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Mu, { children: /* @__PURE__ */ a(
            Ou,
            {
              onClick: () => d(g),
              isActive: h(g),
    ...
    /* @__PURE__ */ u(
      Eu,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Su, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Pe = "scrBook", Pu = "scrRef", Je = "source", $u = "details", Au = "Scripture Reference", Vu = "Scripture Book", ts = "Type", Lu = "Details";
function ju(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Vt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Pe ? Re(n.start) : void 0;
      },
      getGroupingValue: (o) => Vt.bookIdToNumber(o.start.book),
      sortingFn: (o, n) => ha(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id: Je,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? ts : void 0,
...
const Bu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || ha(t.start, t.end) === 0 ? `${Va(t.start)}+${e}` : `${Va(t.start)}+${e}-${Va(t.end)}+${r}`;
}, Ln = (t) => `${Bu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Uh({
  sources: t,
  ...
  const [d, w] = N([]), [p, h] = N([{ id: Pe, desc: !1 }]), [g, f] = N({}), y = V(
  ...
  Y(() => {
    if (c) {
      ...
      if (P.length === 1) {
        const W = y.find((B) => Ln(B) === P[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, y, c, R]);
  const k = n ?? Vu, E = s ?? ts, C = [
    ...
    !e && /* @__PURE__ */ u(
      fr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(br, { position: "item-aligned", children: /* @__PURE__ */ a(Fw, { children: C.map((M) => /* @__PURE__ */ a(ge, { value: JSON.stringify(M.value), children: M.label }, M.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(_o, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(No, { children: R.getHeaderGroups().map((M) => /* @__PURE__ */ a(Ve, { children: M.headers.filter((P) => P.column.columnDef.header).map((P) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(pa, { colSpan: P.colSpan, className: "tw:sticky top-0", children: P.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Mr(P.column.columnDef.header, P.getContext())
        ] }) }, P.id)
      )) }, M.id)) }),
      /* @__PURE__ */ a(Co, { children: R.getRowModel().rows.map((M, P) => {
        const W = _e();
        return /* @__PURE__ */ a(
          Ve,
          {
                  ...
                  ur,
                  {
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        type: "button",
                        children: [
                          M.getIsExpanded() && /* @__PURE__ */ a(Qe, {}),
                          !M.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(lc, {}) : /* @__PURE__ */ a(dc, {})),
                          " ",
                          Mr(B.column.columnDef.cell, B.getContext()),
                          " (",
                          M.subRows.length,
                          ")"
                        ]
...
function Fu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: y } = {
    ...
    () => Object.values(Dt).filter(
      ($) => (s == null ? void 0 : s[$]) !== void 0 && Eo(T, $).length === 0
        ...
        /* @__PURE__ */ a(yr, { asChild: !0, children: /* @__PURE__ */ u(
          J,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a(wc, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
              ...
              rr,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u(ar, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(_a, { children: p }),
                    Object.values(Dt).filter(($) => j[$].length > 0).map(($, et) => {
                      const _ = j[$];
                      return /* @__PURE__ */ u(Vr, { children: [
                        et > 0 && /* @__PURE__ */ a(qn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Be,
                          {
                            heading: Fn($, h, g, f, y),
...
function Ku({
  ...
  return /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
    /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
      Uu,
      {
        className: o,
...
function Hu({
  ...
  const i = Eo(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    J,
    {
      variant: "outline",
      size: "sm",
...
function qu({
  ...
  const i = o["%webView_book_selector_more%"], c = V(
    ...
    (d) => {
      const w = Eo(c, d).map((p) => p);
      r(
        Wn(c, d, e) ? e.filter((p) => !w.includes(p)) : [.../* @__PURE__ */ new Set([...e, ...w])]
      );
    },
    [e, r, c]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ja ? Ja : jn
      ).map((d) => /* @__PURE__ */ a(Or, { className: "tw:hover:bg-secondary", variant: "secondary", children: he(d, n) }, d)),
...
function Hh({
  ...
  const I = At(
  ...
  ], nt = (L, tt, Rt = !1) => /* @__PURE__ */ u(wt, { children: [
    L,
    tt && !Rt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), gt = e ? Z.filter((L) => e.includes(L.value)) : Z, ft = y ?? La, mt = p ?? ft, Qt = h ?? ft, vt = () => {
  }, Ft = U(null), Et = U(null), bt = U(!1), Ut = U(null), Ot = U(!1), [Kt, lt] = N(void 0), Tt = U(!1), jt = U(!1), we = U(null), ue = F((L) => {
    if (L) {
    ...
    lt((tt) => tt === "start" ? void 0 : tt), Tt.current && (Tt.current = !1, requestAnimationFrame(() => {
      var Rt;
      const tt = (Rt = Ft.current) == null ? void 0 : Rt.querySelector("button");
      tt == null || tt.click();
    }));
  }, []), Ht = F((L) => {
    if (L) {
    ...
    (L) => {
      g == null || g(L), f == null || f(L), Tt.current = !0;
    },
    [g, f]
  ), qt = F(
    (L) => {
    ...
    [r, n, y, s]
  ), te = gt.find((L) => L.value === t), D = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? Cc(mt, Qt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : te ? nt(te.label, te.scrRefSuffix) : t, yt = gt.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), Gt = gt.find((L) => L.value === "selectedBooks"), It = gt.find((L) => L.value === "range"), [oe, Ee] = N(!1), [S, K] = N(void 0), [X, x] = N(void 0), [H, O] = N(void 0), [rt, dt] = N(void 0), [ht, kt] = N([]), St = w === "dropdown" && S === "selectedBooks", Pt = /* @__PURE__ */ a(
    qu,
    {
      availableBookInfo: o,
  ...
  ), ne = Kt === "end", Br = Kt === "start", nr = "tw:text-muted-foreground", Ge = w === "dropdown" && S === "range", Da = Ge ? O : qe, Fr = Ge ? dt : f ? qt : vt, _r = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-start", className: m(ne && nr), children: z }),
      /* @__PURE__ */ a(
        Ba,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ft, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-end", className: m(Br && nr), children: G }),
      /* @__PURE__ */ a(
        Ba,
        {
          id: "scope-range-end",
          ...
          localizedStrings: R,
          getEndVerse: k,
          disableReferencesUpTo: Ge ? H ?? mt : mt,
          onOpenChange: Ht,
          onCloseAutoFocus: (L) => {
            var tt;
            jt.current && (jt.current = !1, L.preventDefault(), (tt = we.current) == null || tt.focus());
          },
          className: m(Br && nr),
          modal: !0,
          align: "start"
  ...
  const [Te, ir] = N(null), [Ye, Kr] = N(null), [We, za] = N(null), Hr = 200, [Oa, Ia] = N(!1);
  Y(() => {
    if (!We || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([tt]) => {
      Ia(tt.contentRect.width < Hr);
    });
    return L.observe(We), () => L.disconnect();
  }, [We]);
  const qr = F(
    (L) => {
      x(L), O(mt), dt(Qt), kt(n), Ee(!1), K(L);
    },
    [mt, Qt, n]
  ), Gr = F(() => {
    X !== void 0 && (X === "range" ? (H && (g == null || g(H)), rt && (f == null || f(rt))) : X === "selectedBooks" && s(ht), se(X), K(void 0), x(void 0));
  }, [
    X,
    H,
    rt,
    ...
    var tt;
    L.preventDefault(), (tt = Ur.current) == null || tt.focus();
  }, []), cr = (L) => t === L ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(Mt, { children: Q }),
      w === "dropdown" ? /* @__PURE__ */ u(ze, { open: oe, onOpenChange: Ee, children: [
        ...
        /* @__PURE__ */ a(
          Oe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u($a, { container: We, children: [
              yt.map(({ value: L, label: tt, dropdownLabel: Rt, scrRefSuffix: v, id: q }) => /* @__PURE__ */ u(
                Ae,
                {
                  ref: Nr(L),
                  ...
                  children: [
                    t === L && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) }),
                    nt(Rt ?? tt, v, Oa)
                  ]
                },
                q
              ...
              b && /* @__PURE__ */ u(wt, { children: [
                /* @__PURE__ */ a(Ze, {}),
                /* @__PURE__ */ a(xr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: pt }),
                /* @__PURE__ */ a(
                  Ae,
                  {
                    ref: Ut,
                    ...
                    onSelect: (L) => {
                      ...
                      Ot.current || (Rt = (tt = Et.current) == null ? void 0 : tt.querySelector("button")) == null || Rt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          Ba,
                          {
                            ...
                            onCloseAutoFocus: (L) => {
                              var tt;
                              L.preventDefault(), (tt = Ut.current) == null || tt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(wt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Re(y ?? La, "id") }),
                              /* @__PURE__ */ a(Qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        yo,
        {
          ...
          children: gt.map(({ value: L, label: tt, scrRefSuffix: Rt, id: v }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ua, { className: "tw:me-2", value: L, id: v }),
            /* @__PURE__ */ a(Mt, { htmlFor: v, children: nt(tt, Rt) })
          ] }, v))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && _r,
    w === "dropdown" && Gt && /* @__PURE__ */ a(Za, { open: S === "selectedBooks", onOpenChange: sr, children: /* @__PURE__ */ a(
      Qa,
      {
        ref: Kr,
        onCloseAutoFocus: Yr,
        onEscapeKeyDown: (L) => {
          Ye != null && Ye.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u($a, { container: Ye, children: [
          /* @__PURE__ */ a(to, { className: "tw:pe-8", children: /* @__PURE__ */ a(eo, { children: B }) }),
          Pt,
          /* @__PURE__ */ u(Zo, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => sr(!1), children: ot }),
            /* @__PURE__ */ a(J, { onClick: Gr, children: it })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && It && /* @__PURE__ */ a(Za, { open: S === "range", onOpenChange: sr, children: /* @__PURE__ */ a(
      Qa,
      {
        ref: ir,
        onCloseAutoFocus: Yr,
        ...
        children: /* @__PURE__ */ u($a, { container: Te, children: [
          /* @__PURE__ */ a(to, { className: "tw:pe-8", children: /* @__PURE__ */ a(eo, { children: _ }) }),
          _r,
          /* @__PURE__ */ u(Zo, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => sr(!1), children: ot }),
            /* @__PURE__ */ a(J, { ref: we, onClick: Gr, children: it })
          ] })
        ] })
      }
    ) })
...
function qh({
  ...
  return /* @__PURE__ */ u(
    fr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(vr, { size: n, className: m("pr-twp tw:w-auto", s), children: /* @__PURE__ */ a(
          mr,
          {
            placeholder: l[an(e)] ?? e
          }
        ) }),
        /* @__PURE__ */ a(
          br,
          {
            ...
            style: { zIndex: Ie },
            children: t.map((w) => /* @__PURE__ */ a(ge, { value: `${w}`, children: l[an(w)] }, `${w}`))
          }
        )
      ]
    }
...
function xa({ icon: t, menuLabel: e, leading: r }) {
  return t ? /* @__PURE__ */ a(
    "img",
    {
...
const rs = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    Ae,
    {
      ...
      children: [
        c.iconPathBefore && /* @__PURE__ */ a(xa, { icon: c.iconPathBefore, menuLabel: c.label, leading: !0 }),
        c.label,
        c.iconPathAfter && /* @__PURE__ */ a(xa, { icon: c.iconPathAfter, menuLabel: c.label })
      ]
    },
    `dropdown-menu-item-${c.label}-${c.command}`
  ) : /* @__PURE__ */ u(Rs, { children: [
    /* @__PURE__ */ a(Ds, { children: c.label }),
    /* @__PURE__ */ a(Ms, { children: /* @__PURE__ */ a(zs, { children: rs(
      t,
      e,
      es(t, c.id),
      o
...
function vo({
  ...
  return /* @__PURE__ */ u(ze, { variant: s, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(J, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(uc, {}) }) }),
    /* @__PURE__ */ a(Oe, { align: "start", style: { zIndex: Ie }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Vr, { children: [
      /* @__PURE__ */ a(Kn, { children: /* @__PURE__ */ a(zt, { children: rs(e.groups, e.items, l, t) }) }),
...
const Ju = Object.freeze([520, 420, 340]), os = Xt.forwardRef(
  ({ id: t, className: e, children: r, shrinkStep: o }, n) => {
    ...
    return /* @__PURE__ */ a($o.Provider, { value: w, children: /* @__PURE__ */ a(
      "div",
      {
        ref: l,
...
const ns = Xt.forwardRef(({ className: t, ...e }, r) => {
  const o = _e();
  return /* @__PURE__ */ a(
    fe.Root,
    {
...
ns.displayName = fe.List.displayName;
const is = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.List,
  {
    ref: r,
    className: m(
...
is.displayName = fe.List.displayName;
const Zu = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Trigger,
  {
    ref: r,
    ...e,
...
)), ss = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Content,
  {
    ref: r,
    className: m(
...
ss.displayName = fe.Content.displayName;
function Zh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ns, { children: [
      /* @__PURE__ */ a(is, { children: t.map((c) => /* @__PURE__ */ a(Zu, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(ss, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function Qu({
...
function sp({
  ...
  return /* @__PURE__ */ u(
    Ne.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(ii, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
...
const Sr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    const c = e.filter((d) => d.group === s).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        op,
        {
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ a(xa, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ a(xa, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(ip, { children: [
        /* @__PURE__ */ a(sp, { children: d.label }),
        /* @__PURE__ */ a(cp, { children: cs(
          t,
          e,
          es(t, d.id),
          o
    ...
    return c.length > 0 && i < n.length - 1 && l.push(/* @__PURE__ */ a(np, {}, `separator-${s}`)), l;
  });
};
function lp({
  menuData: t,
  ...
  if (Ul(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Sr(i, [h, g]);
        break;
      case "alt+n":
        (b = c.current) == null || b.focus(), Sr(c, [h, g]);
        break;
      case "alt+h":
        (R = l.current) == null || R.focus(), Sr(l, [h, g]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(Qu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tp, { children: [
      /* @__PURE__ */ a(rp, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        ap,
        {
          style: { zIndex: Ie },
          children: /* @__PURE__ */ a(zt, { children: cs(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const dp = Object.freeze([950, 800, 700]);
function Qh(t) {
  switch (t) {
    case void 0:
      return;
...
function tg({
  ...
  return /* @__PURE__ */ a($o.Provider, { value: y, children: /* @__PURE__ */ a(
    "div",
    {
...
function eg({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Mt, { className: "tw:font-normal tw:text-muted-foreground", children: Le(d, {
...
function ag({
  ...
  return /* @__PURE__ */ u(rr, { id: s, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(Is, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(Ps, { children: /* @__PURE__ */ a(Ic, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(ar, { children: [
      /* @__PURE__ */ a(_a, { children: h }),
      d.map(({ tag: f, info: y }) => {
        const b = f === e;
        return /* @__PURE__ */ u(
          Ke,
...
function ng({
  ...
  const c = t ? on(r, { key: o }).join("") : "", {
    anchorRect: l,
    message: d,
    confirmingKeyLabel: w,
    showArrow: p
  } = gp(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
    ...
    /* @__PURE__ */ u(_t, { open: t, onOpenChange: () => {
      ...
      /* @__PURE__ */ a(
        Ct,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: on(d, {
            key: /* @__PURE__ */ a(
              ro,
              {
                className: m(
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(Vr, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
            ...
            d && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(ze, { children: [
                  /* @__PURE__ */ a(xe, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    J,
                    {
                  ...
                  /* @__PURE__ */ a(Oe, { align: "end", children: d })
                ] })
              }
            )
          ] }),
...
function sg({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function lg({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: i.map((c) => {
    let l = "upcoming";
    return c === s ? l = "active" : c < s && (l = "complete"), /* @__PURE__ */ u(Vr, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function vg({
  ...
  return /* @__PURE__ */ u(
    Lt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(ii, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function xg({
  ...
  return /* @__PURE__ */ u(
    Lt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Lt.ItemIndicator, { children: /* @__PURE__ */ a(Ea, {}) }) }),
        e
      ]
    }
  );
...
function Sg({
  ...
  const n = _e();
  return /* @__PURE__ */ u(fp, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(mp, {}),
    /* @__PURE__ */ u(
      He.Content,
      {
  ...
  return /* @__PURE__ */ a(
    Hl,
    {
      ...
      icons: {
        ...
        error: /* @__PURE__ */ a($c, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(Pc, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function Kg({
  ...
  return /* @__PURE__ */ a(
    fe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", bp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Jg(t) {
  const e = V(() => Ec(t).slice().sort().join(" "), [t]);
...
_p(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  th as COMMENT_EDITOR_STRING_KEYS,
  Sw as COMMENT_LIST_ELEMENT_ID,
  eh as COMMENT_LIST_STRING_KEYS,
  Zp as CONFLICT_NOTE_STRING_KEYS,
  qi as CancelAcceptButtons,
  Rw as Card,
  Dw as CardContent,
  nh as CardDescription,
  ih as CardFooter,
  ah as CardHeader,
  oh as CardTitle,
  wd as ChapterRangeSelector,
  Zi as Checkbox,
  og as CheckboxGroup,
  hp as Checklist,
  vn as ComboBox,
  ...
  dg as ContextMenu,
  xg as ContextMenuCheckboxItem,
  fg as ContextMenuContent,
  ug as ContextMenuGroup,
  mg as ContextMenuItem,
  kg as ContextMenuLabel,
  pg as ContextMenuPortal,
  gg as ContextMenuRadioGroup,
  yg as ContextMenuRadioItem,
  _g as ContextMenuSeparator,
  Ng as ContextMenuShortcut,
  hg as ContextMenuSub,
  bg as ContextMenuSubContent,
  vg as ContextMenuSubTrigger,
  wg as ContextMenuTrigger,
  qw as DataTable,
  ng as DestructiveKeyConfirmation,
  Za as Dialog,
  sf as DialogClose,
  Qa as DialogContent,
  ...
  Yw as ErrorDump,
  ph as ErrorPopover,
  bh as FOOTNOTE_EDITOR_STRING_KEYS,
  mh as Filter,
  ...
  hf as PopoverDescription,
  gf as PopoverHeader,
  $a as PopoverPortalContainerProvider,
  ff as PopoverTitle,
  yr as PopoverTrigger,
  Lg as Progress,
  yo as RadioGroup,
  ua as RadioGroupItem,
  ed as RecentSearches,
  mf as ResizableHandle,
  vf as ResizablePanel,
  ...
  Fh as SettingsSidebarContentSearch,
  $o as ShrinkStepContext,
  Tu as Sidebar,
  ...
  xf as Spinner,
  Fg as Switch,
  vo as TabDropdownMenu,
  Jh as TabFloatingMenu,
  Xh as TabToolbar,
  _o as Table,
  Co as TableBody,
  yf as TableCaption,
  ...
  eg as UiLanguageSelector,
  Zw as UndoRedoButtons,
  ns as VerticalTabs,
  ss as VerticalTabsContent,
  is as VerticalTabsList,
  Zu as VerticalTabsTrigger,
  lg as WizardStepper,
  Ie as Z_INDEX_ABOVE_DOCK,
  Hn as Z_INDEX_ABOVE_POPOVER,
  _f as Z_INDEX_FIRST_RUN,
  Nf as Z_INDEX_MODAL,
  Cf as Z_INDEX_MODAL_BACKDROP,
  Ts as Z_INDEX_OVERLAY,
  Ef as badgeVariants,
  Tf as buttonGroupVariants,
  Sf as buttonVariants,
  m as cn,
  Eh as getBookIdFromUSFM,
  rh as getCommentThreadElementId,
  Sa as getInventoryHeader,
  Nh as getLinesFromUSFM,
  Ch as getNumberFromUSFM,
  yu as getStatusForItem,
  Qh as getToolbarOSReservedSpaceClassName,
  kh as inventoryCountColumn,
  yh as inventoryItemColumn,
  _h as inventoryStatusColumn,
  ko as isMacOs,
  Rf as isWindows,
