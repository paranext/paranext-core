...
var ht = (t, e, n) => Za(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as c, Fragment as at } from "react/jsx-runtime";
import b, { forwardRef as tn, useRef as W, useMemo as V, useState as A, useCallback as G, useLayoutEffect as Ft, createContext as xn, useContext as dr, useEffect as H, Component as Qa, createElement as Dr, Suspense as ts, createRef as es, Fragment as oo } from "react";
import { Command as vt } from "cmdk";
import { X as Me, Search as ao, Check as Dt, Clock as Mr, ChevronsLeft as Or, ChevronsRight as Ir, ChevronLeft as qn, ChevronRight as _e, ArrowLeft as ns, ArrowRight as rs, Circle as yn, ChevronDown as Oe, BoldIcon as os, ItalicIcon as as, UnderlineIcon as ss, StrikethroughIcon as is, AtSign as so, Pencil as ls, Trash2 as ws, ArrowUp as io, MoreHorizontal as lo, MailOpen as ds, Mail as cs, ChevronUp as wo, FilterIcon as ps, ArrowLeftIcon as us, ChevronLeftIcon as ms, ChevronRightIcon as fs, ArrowRightIcon as hs, Copy as co, Filter as gs, User as bs, Link as vs, CircleHelp as xs, ChevronsUpDown as po, Star as ys, SquareX as uo, FunctionSquare as mo, SquareSigma as fo, AlertCircle as Hn, CircleCheckIcon as Ns, CircleXIcon as ks, CircleHelpIcon as _s, ArrowUpIcon as Cs, ArrowDownIcon as Es, PanelLeft as Rs, PanelRight as Ts, ScrollText as Ss, MenuIcon as Ds, Menu as Ms, EllipsisVertical as Os, LoaderCircle as Is, GripVertical as As } from "lucide-react";
import { clsx as Ps } from "clsx";
import { extendTailwindMerge as $s } from "tailwind-merge";
import * as St from "@radix-ui/react-dialog";
import { Canon as ot } from "@sillsdev/scripture";
import { includes as an, Section as q, getChaptersForBook as Ls, formatScrRef as ue, getSectionForBook as Ke, formatRelativeDate as Vs, formatReplacementString as pe, sanitizeHtml as js, NumberFormat as zs, formatBytes as Fs, getCurrentLocale as Bs, getFormatCallerFunction as Gs, deepEqual as Ks, isString as Ar, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as X } from "platform-bible-utils";
...
import { createEditor as go, $getRoot as te, $createParagraphNode as Nn, $getSelection as Bt, HISTORY_MERGE_TAG as cr, ParagraphNode as bo, TextNode as vo, $isTokenOrSegmented as Us, $getCharacterOffsets as qs, $cloneWithPropertiesEphemeral as Hs, $findMatchingParent as Ys, $isElementNode as me, CLEAR_EDITOR_COMMAND as xo, COMMAND_PRIORITY_EDITOR as yo, $isRangeSelection as We, mergeRegister as ee, shallowMergeConfig as Xs, defineExtension as Kt, safeCast as en, RootNode as Ws, LineBreakNode as Js, TabNode as Zs, $isEditorState as Qs, createCommand as ti, CLICK_COMMAND as ei, isDOMNode as ni, $getNodeFromDOMNode as ri, $isNodeSelection as oi, $createNodeSelection as ai, $setSelection as si, COMMAND_PRIORITY_LOW as ii, DecoratorNode as li, addClassNamesToElement as No, $create as wi, $getNodeByKey as di, removeClassNamesFromElement as ci, KEY_TAB_COMMAND as pi, $isBlockElementNode as un, $createRangeSelection as ui, $normalizeSelection__EXPERIMENTAL as mi, OUTDENT_CONTENT_COMMAND as fi, INDENT_CONTENT_COMMAND as Pr, INSERT_TAB_COMMAND as hi, COMMAND_PRIORITY_CRITICAL as pr, $isDecoratorNode as gi, $isParagraphNode as bi, $isTextNode as mn, SELECTION_CHANGE_COMMAND as ko, FORMAT_TEXT_COMMAND as vi, getRegisteredNode as xi, isHTMLElement as yi, isDocumentFragment as $r, isDOMDocumentNode as Ni, ArtificialNode__DO_NOT_USE as _o, $createLineBreakNode as Co, $isRootOrShadowRoot as ki, isBlockDomNode as Lr, isInlineDomNode as Vr, $insertNodes as _i } from "lexical";
import * as Ae from "@radix-ui/react-tooltip";
import { TooltipTrigger as Ci } from "@radix-ui/react-tooltip";
import { HeadingNode as Ei, QuoteNode as Ri, registerRichText as Ti } from "@lexical/rich-text";
import { flushSync as Si, createPortal as Di } from "react-dom";
import { $isTableSelection as Mi } from "@lexical/table";
...
import { DropdownMenuTrigger as Oi } from "@radix-ui/react-dropdown-menu";
import { useReactTable as So, getFilteredRowModel as Ii, getSortedRowModel as Do, getPaginationRowModel as Ai, getCoreRowModel as Mo, flexRender as Ue, getGroupedRowModel as Pi, getExpandedRowModel as $i } from "@tanstack/react-table";
import * as rt from "@radix-ui/react-select";
import Li from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Xn, HIDDEN_NOTE_CALLER as Wn, getDefaultViewOptions as Vi, isInsertEmbedOpOfType as sn, Editorial as ji } from "@eten-tech-foundation/platform-editor";
...
import { Toaster as Fi } from "sonner";
import { toast as Qp } from "sonner";
import * as Ge from "@radix-ui/react-slider";
import * as Qn from "@radix-ui/react-switch";
const Bi = $s({ prefix: "tw-" });
function f(...t) {
  return Bi(Ps(t));
}
const Gi = "layoutDirection";
function wt() {
  const t = localStorage.getItem(Gi);
  return t === "rtl" ? t : "ltr";
}
const Ki = St.Root, Ui = St.Portal, Oo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Overlay,
  {
    ref: n,
    className: f(
...
Oo.displayName = St.Overlay.displayName;
const Io = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = wt();
  return /* @__PURE__ */ c(Ui, { children: [
    /* @__PURE__ */ r(Oo, {}),
    /* @__PURE__ */ c(
      St.Content,
      {
...
Io.displayName = St.Content.displayName;
...
Po.displayName = St.Title.displayName;
...
qi.displayName = St.Description.displayName;
...
const zo = tn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: f(Fo({ variant: e, size: n, className: t })), ref: s, ...a })
);
j.displayName = "Button";
const oe = Ce.Root, ae = Ce.Trigger, Bc = Ce.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = wt();
...
function Yi({
  ...
  return /* @__PURE__ */ c(oe, { open: d, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Ht, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Gt, { heading: s, children: t.map((m) => /* @__PURE__ */ c(
      $t,
      {
        onSelect: () => p(m),
...
function Gc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function zr({
  ...
  if (t)
    return /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Pt(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      $t,
      {
        value: `${t} ${fe[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Kc({
  ...
  const w = wt(), [p, m] = A(!1), [h, u] = A(""), [g, x] = A(""), [v, y] = A("books"), [N, C] = A(void 0), [S, $] = A(!1), L = W(void 0), k = W(void 0), R = W(void 0), E = W(void 0), T = W({}), P = G(
  ...
  }), [_]), D = V(() => Object.values(z).flat(), [z]), F = V(() => {
    if (!g.trim()) return z;
    const I = {
      [q.OT]: [],
      [q.NT]: [],
    ...
    [v, _t]
  ), { otLong: et, ntLong: ft, dcLong: dt, extraLong: mt } = {
    ...
    (I) => {
      ...
      if ((v === "chapters" || v === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(I.key)) {
        const ct = v === "chapters" ? N : O == null ? void 0 : O.book;
        if (!ct) return;
        const st = (() => {
          if (!h) return 1;
          const Jt = h.match(/(\d+)$/);
        ...
        switch (I.key) {
          case "ArrowLeft":
            st !== 0 && (Ct = st > 1 ? st - 1 : Vt);
            break;
          case "ArrowRight":
            st !== 0 && (Ct = st < Vt ? st + 1 : 1);
            break;
          case "ArrowUp":
            Ct = st === 0 ? Vt : Math.max(1, st - ze);
            break;
          case "ArrowDown":
            Ct = st === 0 ? 1 : Math.min(Vt, st + ze);
            break;
          default:
            return;
        }
        Ct !== st && (I.preventDefault(), I.stopPropagation(), u(tr(ct, a, Ct)), setTimeout(() => {
          const Jt = T.current[Ct];
    ...
    const { isLetter: K, isDigit: nt } = jr(I.key);
    (K || nt) && (I.preventDefault(), x((ct) => ct + I.key), k.current.focus(), $(!1));
  }, []);
  return Ft(() => {
    const I = setTimeout(() => {
      if (p && v === "books" && R.current && E.current) {
        const K = R.current, nt = E.current, ct = nt.offsetTop, st = K.clientHeight, Vt = nt.clientHeight, Ct = ct - st / 2 + Vt / 2;
        K.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(tr(t.book));
  ...
  }, [v, N, O, t.book, t.chapterNum]), /* @__PURE__ */ c(oe, { open: p, onOpenChange: B, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
      j,
      {
      ...
      Ut,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ut.map(({ onClick: I, disabled: K, title: nt, icon: ct }) => /* @__PURE__ */ r(
              j,
              {
                variant: "ghost",
                size: "sm",
          ...
          !S && /* @__PURE__ */ c(qt, { ref: R, children: [
            v === "books" && /* @__PURE__ */ c(at, { children: [
              ...
              O && Pt(O.book) > 1 && /* @__PURE__ */ c(at, { children: [
...
), lt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ho.Root, { ref: n, className: f("pr-twp", Zi(), t), ...e }));
...
const fn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Xe.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Xe.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(yn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
fn.displayName = Xe.Item.displayName;
function Qi(t) {
...
function er({
  ...
  const [N, C] = A(!1), S = d ?? l, $ = (k) => k.length > 0 && typeof k[0] == "object" && "options" in k[0], L = (k, R) => {
  ...
  return /* @__PURE__ */ c(oe, { open: N, onOpenChange: C, ...y, children: [
...
const Go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, rl = Go ? Ft : H, ln = { tag: cr };
function ol({ initialConfig: t, children: e }) {
  const n = V(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = nl(null, o), p = go({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (m) => i(m, p), theme: o });
    return function(m, h) {
      if (h !== null) {
...
const al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function sl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return al(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      e && s.size === 0 && i.size === 0 || t && d.has(cr) || l.isEmpty() || n(a, o, d);
    });
  }, [o, t, e, n]), null;
}
const gr = {
  ...
  mark: "",
  markOverlap: ""
}, Nt = Ae.Provider, Rt = Ae.Root, Tt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Ae.Trigger,
  {
    ref: o,
    className: e ? f(Fo({ variant: e }), t) : t,
    ...n
  }
));
Tt.displayName = Ae.Trigger.displayName;
const kt = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  Ae.Content,
  {
    ref: o,
    sideOffset: e,
...
class ll extends Qa {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && wl(e.resetKeys, a)) {
      var s, i;
...
function dl({ children: t, onError: e }) {
  return r(ll, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const cl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function pl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function ul() {
  return function(t) {
    const [e] = Lt(), n = V(() => t(e), [e, t]), [o, a] = A(() => n.initialValueFn()), s = W(o);
    return cl(() => {
...
const Ko = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, hl = Ko && "documentMode" in document ? document.documentMode : null;
!(!Ko || !("InputEvent" in window) || hl) && "getTargetRanges" in new window.InputEvent("input");
function Fr(t) {
  const e = Ys(t, (n) => me(n) && !n.isInline());
  return me(e) || fl(4, t.__key), e;
}
...
function de(t, e) {
  gt.call(this, void 0), this.x = t, this.s = void 0, this.g = cn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function vl(t, e) {
  return new de(t, e);
}
...
function xl(t) {
  ...
  qo(this), Y = t, this.f &= -2, 8 & this.f && vr(this), _n();
}
function Ne(t, e) {
...
gt.prototype.brand = gl, gt.prototype.h = function() {
  return !0;
  ...
  if (this.g = cn, this.f |= 1, this.i > 0 && !Uo(this)) return this.f &= -2, !0;
  const t = Y;
  try {
    Kr(this), Y = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ho(this), Kr(this), Qt++;
  const t = Y;
  return Y = this, xl.bind(this, t);
...
Kt({ build: (t, e, n) => Cn(e), config: en({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
Kt({ build: (t, e, n) => Cn(e), config: en({ $onClear: Yo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const rr = Kt({ build: (t) => Wo(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const xr = 0, or = 1, Zo = 2, Ln = 3, wn = 4, ye = 5, Vn = 6, Fe = 7;
function jn(t) {
  return t.id === xr;
}
function Qo(t) {
...
function Nl(t) {
  return function(e) {
    return e.id === or;
  }(t) || J(305, String(t.id), String(or)), Object.assign(t, { id: Zo });
}
...
class _l {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Xs;
...
const El = Kt({ config: en({ setOptions: Ur, updateOptions: Ur }), init: ({ $initialEditorState: t = Cl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (Qs(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [Ws, vo, Js, Zs, bo] }), qr = Symbol.for("@lexical/extension/LexicalBuilder");
function Hr() {
}
function Rl(t) {
  throw t;
...
class He {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && J(298, o.name), !a) {
      a = new _l(this, o), this.extensionNameMap.set(o.name, a);
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = Rl), e;
  }
}
const Tl = /* @__PURE__ */ new Set(), Yr = Kt({ build(t, e, n) {
  const o = n.getDependency(rr).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Wo(() => {
  }, () => ne(() => {
  ...
  return { watchNodeKey: function(i) {
    const l = vl(() => (s.value || Tl).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
Kt({ dependencies: [rr, Yr], name: "@lexical/extension/HorizontalRule", nodes: () => [Ee], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(Yr).output, a = Je({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return ee(t.registerCommand(ei, (i) => {
    if (ni(i.target)) {
      const l = ri(i.target);
      if (Dl(l)) return function(d, w = !1) {
        const p = Bt(), m = d.isSelected(), h = d.getKey();
        let u;
        w && oi(p) ? u = p : (u = ai(), si(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, ii), t.registerMutationListener(Ee, (i, l) => {
    bl(() => {
      let d = !1;
    ...
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(ne(() => {
      const w = l.value;
      w && (d.value ? No(w, s) : ci(w, s));
    }));
    return ee(...i);
  }));
} });
function Ml(t, e) {
  return ee(t.registerCommand(pi, (n) => {
    const o = Bt();
    if (!We(o)) return !1;
    n.preventDefault();
    const a = function(s) {
      if (s.getNodes().filter((m) => un(m) && m.canIndent()).length > 0) return !0;
      const i = s.anchor, l = s.focus, d = l.isBefore(i) ? l : i, w = d.getNode(), p = Fr(w);
      if (p.canIndent()) {
        const m = p.getKey();
        let h = ui();
        if (h.anchor.set(m, 0, "element"), h.focus.set(m, 0, "element"), h = mi(h), h.anchor.is(d)) return !0;
      }
      return !1;
    }(o) ? n.shiftKey ? fi : Pr : hi;
...
Kt({ build: (t, e, n) => Cn(e), config: en({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a } = n.getOutput();
  return ne(() => {
    if (!o.value) return Ml(t, a);
  });
} });
const Ol = Kt({ name: "@lexical/react/ReactProvider" });
function Il() {
...
Kt({ build: (t, e, n) => Cn(e), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ne(() => n.getOutput().disabled.value ? void 0 : na(t)) });
function $l(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return yr(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], p = r(o, { onError: (h) => n._onError(h), children: r(ts, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(Di(p, m, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
}
function Vl({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    const o = He.maybeFromEditor(n);
    if (o && o.hasExtensionByName(Ol.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && $l(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(Ll, { editor: t, ErrorBoundary: e });
}
function Xr(t) {
  return t.getEditorState().read(ea(t.isComposing()));
}
function jl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Lt();
  return function(a) {
    yr(() => ee(Ti(a), na(a)), [a]);
  }(o), c(at, { children: [t, r(zl, { content: e }), r(Vl, { editor: o, ErrorBoundary: n })] });
}
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function Gl({ onClear: t }) {
  const [e] = Lt();
  return Bl(() => Xo(e, t), [e, t]), null;
}
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function Kl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: C, "data-testid": S, ...$ }, L) {
...
function Hl(t, e) {
  ...
  return c(at, { children: [r(Ul, { editor: a, ...o, ref: e }), n != null && r(Yl, { editor: a, content: n })] });
}
function Yl({ content: t, editor: e }) {
  const n = function(i) {
    const [l, d] = A(() => Wr(i));
    return ra(() => {
      function w() {
...
function Jl() {
  const [t, e] = A(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Ki, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Io, { children: [
...
function Zl({
  ...
  const [e] = Lt(), [n, o] = A(e), [a, s] = A("paragraph"), [i, l] = Jl(), d = () => {
  };
...
function ew() {
  const { activeEditor: t } = aa(), [e, n] = A([]), o = G((a) => {
    if (We(a) || Mi(a)) {
      const s = [];
      Jr.forEach(({ format: i }) => {
...
function rw({
  ...
  return /* @__PURE__ */ c("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Zl, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(ew, {}) }) }),
      ...
      /* @__PURE__ */ r(
        jl,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(Xl, { placeholder: t }) }),
          ErrorBoundary: dl
        }
      ),
      e && /* @__PURE__ */ r(Fl, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(nw, { onClear: n }),
      /* @__PURE__ */ r(Gl, {})
    ] })
  ] });
}
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ r(
          ol,
          {
            ...
            children: /* @__PURE__ */ c(Nt, { children: [
...
function aw(t, e) {
  const n = Ni(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
...
function la(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && mn(e) && (i = ml(o, e, "clone"));
  const l = me(i) ? i.getChildren() : [], d = xi(t, i.getType());
  let w;
  ...
  if (a && !s) {
    if ((yi(p) || $r(p)) && p.append(h), n.append(p), m) {
      const u = m.call(i, p);
...
function da(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !ki(l)) && (l != null && un(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...da(m[g], e, n, u, new Map(a), l));
  return p != null && (h = p(h)), Lr(t) && (h = iw(t, h, u ? () => {
    const g = new _o();
    return n.push(g), g;
...
function lw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = aw(e, a);
      te().clear(), _i(s);
    },
    {
      discrete: !0
...
function Yc({
  ...
  const [a, s] = A(ww), [i, l] = A(void 0), [d, w] = A(!1), p = W(void 0), m = W(null);
  H(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ c("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
        ...
        /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: g }) })
        ] }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : y.key === "Enter" && y.shiftKey && (y.preventDefault(), y.stopPropagation(), Et(a) && h());
        },
        onKeyDown: (y) => {
...
const Xc = Object.freeze([
...
], dw = ["input", "select", "textarea", "button"], cw = ["button", "textbox"], pw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = W(null), [s, i] = A(void 0), [l, d] = A(void 0), w = G(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || dw.includes(g)) return !0;
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", uw({ variant: e }), t), ...n })
);
...
const hw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
bw.displayName = Pe.Image.displayName;
...
}), Le = Z.Trigger, ga = Z.Group, vw = Z.Portal, xw = Z.Sub, yw = Z.RadioGroup;
...
ba.displayName = Z.SubTrigger.displayName;
...
va.displayName = Z.SubContent.displayName;
...
const zt = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ c(
    Z.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Z.ItemIndicator, { children: /* @__PURE__ */ r(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
xa.displayName = Z.RadioItem.displayName;
...
Ve.displayName = Z.Separator.displayName;
...
Nw.displayName = "DropdownMenuShortcut";
function pn(t, e) {
...
function Zr({
  ...
  const u = G(() => {
    ...
    [t.user]
  ), N = V(() => js(t.contents), [t.contents]), C = V(() => {
    if (o && l)
      return /* @__PURE__ */ c(at, { children: [
        /* @__PURE__ */ c(
          bn,
          {
            onClick: () => {
              w(!0), m(lw(t.contents)), i == null || i(!0);
            },
            children: [
      ...
      children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ c(Re, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              pn(t.assignedUser, n)
            ] })
          ] }),
        ...
        C && /* @__PURE__ */ c(ve, { children: [
          /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(lo, {}) }) }),
...
function kw({
  ...
  const [$, L] = A(Qr), k = o, [R, E] = A(!1), [T, P] = A(!1), [_, z] = A(!1), [D, F] = A(void 0), [O, U] = A(!1), [it, bt] = A(!1), [pt, ut] = A(C), [_t, B] = A(!1), et = W(void 0), [ft, dt] = A(/* @__PURE__ */ new Map());
  H(() => {
    let M = !0;
    return (async () => {
      const It = y ? await y(d) : !1;
      M && bt(It);
    })(), () => {
      M = !1;
    };
    ...
    let M = !0;
    if (!o) {
      U(!1), dt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const It = v ? await v(d) : !1;
      M && U(It);
    })(), () => {
      M = !1;
    };
  }, [o, d, v]);
  const mt = V(() => e.filter((M) => !M.deleted), [e]);
  H(() => {
    let M = !0;
    if (!o || !N) {
      dt(/* @__PURE__ */ new Map());
  ...
  const ie = V(() => mt[0], [mt]), Mn = W(null), xe = W(void 0), Xt = G(() => {
    var M;
    (M = xe.current) == null || M.call(xe), L(Qr);
  }, []), On = G(() => {
    const M = !pt;
    ut(M), B(!M), u == null || u(d, M);
  }, [pt, u, d]);
  H(() => {
    E(!1);
  }, [o]), H(() => {
  ...
  const Wt = V(
  ...
  }, [s, n]), I = V(() => mt.slice(1), [mt]), K = V(() => I.length ?? 0, [I.length]), nt = V(() => K > 0, [K]), ct = V(() => R || K <= 2 ? I : I.slice(-2), [I, K, R]), st = V(() => R || K <= 2 ? 0 : K - 2, [K, R]), Vt = V(
    ...
    M && await p({ threadId: d, contents: M }) && Xt();
  }, [Xt, $, p, D, d]), Jt = G(
    async (M) => {
      const le = Et($) ? gn($) : void 0, It = await p({
        ...M,
        contents: le,
        assignedUser: D ?? M.assignedUser
      });
      return It && le && Xt(), It && D !== void 0 && F(void 0), It;
    },
    [Xt, $, p, D]
  );
  return /* @__PURE__ */ r(
    ua,
    {
      ...
      children: /* @__PURE__ */ c(ma, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              j,
              {
                ...
                children: pt ? /* @__PURE__ */ r(ds, {}) : /* @__PURE__ */ r(cs, {})
              }
            ),
        ...
        /* @__PURE__ */ c(at, { children: [
          nt && !o && /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          o && /* @__PURE__ */ c(at, { children: [
            ...
            ct.map((M) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Zr,
              {
                comment: M,
                localizedStrings: n,
            ...
            x !== !1 && (!T || Et($)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (M) => {
                  M.key === "Enter" && M.shiftKey && (M.preventDefault(), M.stopPropagation(), (Et($) || D !== void 0) && ze());
                },
                onKeyDown: (M) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ c(oe, { open: _, onOpenChange: z, children: [
                      /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
                        j,
                        {
                          size: "icon",
...
function Jc({
  ...
  const S = n.filter(
    ...
    [v, x]
  ), { listboxRef: R, activeId: E, handleKeyDown: T } = pw({
    options: $,
    onOptionSelect: L
  }), P = G(
    (_) => {
...
function _w({ table: t }) {
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(Oi, { asChild: !0, children: /* @__PURE__ */ c(j, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Se = rt.Root, Cw = rt.Group, De = rt.Value, Ew = re(
  ...
  return /* @__PURE__ */ c(
    rt.Trigger,
    {
      className: f(Ew({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
Rw.displayName = rt.Label.displayName;
const yt = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  rt.Item,
  {
    ref: o,
    className: f(
...
Tw.displayName = rt.Separator.displayName;
function Sw({ table: t }) {
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), Aw(u, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), Iw(l, x, p.key);
...
function $w({
  ...
  var L;
  const [p, m] = A([]), [h, u] = A([]), [g, x] = A({}), [v, y] = A({}), N = V(() => e ?? [], [e]), C = So({
    data: N,
    columns: t,
    getCoreRowModel: Mo(),
    ...n && { getPaginationRowModel: Ai() },
    onSortingChange: m,
    getSortedRowModel: Do(),
    onColumnFiltersChange: u,
    getFilteredRowModel: Ii(),
  ...
  return d ? $ = Array.from({ length: 10 }).map((E, T) => `skeleton-row-${T}`).map((E) => /* @__PURE__ */ r(jt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(he, { colSpan: S.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ar, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((L = C.getRowModel().rows) == null ? void 0 : L.length) > 0 ? $ = C.getRowModel().rows.map((k) => /* @__PURE__ */ r(
    ...
    k.id
  )) : $ = /* @__PURE__ */ r(jt, { children: /* @__PURE__ */ r(he, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(_w, { table: C }),
    /* @__PURE__ */ c(En, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Rn, { stickyHeader: s, children: C.getHeaderGroups().map((k) => /* @__PURE__ */ r(jt, { children: k.headers.map((R) => /* @__PURE__ */ r(Qe, { className: "tw-p-0", children: R.isPlaceholder ? void 0 : Ue(R.column.columnDef.header, R.getContext()) }, R.id)) }, k.id)) }),
...
function Zc({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Li, { options: s, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(co, {}) })
        ] }),
...
function tp({
  ...
  return /* @__PURE__ */ c(oe, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ c(Ht, { id: s, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function ep({ id: t, label: e, groups: n }) {
  const [o, a] = A(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(ve, { children: [
    ...
    /* @__PURE__ */ r(se, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ r(ga, { children: w.itemType === 0 ? /* @__PURE__ */ r(at, { children: w.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        zt,
        {
          checked: o[p][h],
...
function rp({
  ...
  const i = V(() => Fs(n), [n]), d = ((w) => {
    const p = new Intl.DisplayNames(Bs(), { type: "language" });
...
function Fw({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ c(oe, { open: R, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ c(
      j,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(Ut, { children: [
      ...
      a && /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: L, children: s }),
        /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: k, children: i })
      ] }),
      /* @__PURE__ */ c(qt, { children: [
        /* @__PURE__ */ r(nn, { children: l }),
        /* @__PURE__ */ r(Gt, { children: $.map((T) => /* @__PURE__ */ c(
          $t,
          {
            value: T.label,
            onSelect: C,
...
const Bw = (t, e, n) => t === "generated" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
function Gw({
  ...
  const s = W(null), i = W(null), l = W(!1), [d, w] = A(t), [p, m] = A(n), [h, u] = A(!1);
  H(() => {
    w(t);
  }, [t]), H(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var y, N, C, S;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((C = s.current) == null ? void 0 : C.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ c(ve, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
      /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "outline", className: "tw-h-6", children: Bw(t, a, n) }) }) }),
...
const Kw = (t, e) => t === "f" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ r(mo, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ r(fo, {}),
  " ",
...
function qw({
  ...
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
      /* @__PURE__ */ r(Ci, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "outline", className: "tw-h-6", children: Kw(t, n) }) }) }),
      /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: Uw(t, n) }) })
    ] }) }),
...
function ap({
  ...
  const d = W(null), w = es(), [p, m] = A("generated"), [h, u] = A("*"), [g, x] = A("f"), [v, y] = A(!1), N = V(
    () => ({
      ...i,
      markerMenuTrigger: i.markerMenuTrigger ?? "\\",
      hasExternalUI: !0,
      view: { ...i.view ?? Vi(), noteMode: "expanded" }
    }),
    [i]
  );
  H(() => {
    ...
    if (R && sn("note", R)) {
      ...
      P === Xn ? _ = "generated" : P === Wn ? _ = "hidden" : P && u(P), m(_), x(((T = R.insert.note) == null ? void 0 : T.style) ?? "f"), k = setTimeout(() => {
        var z;
        (z = d.current) == null || z.applyUpdate([R]);
      }, 0);
    }
    return () => {
      k && clearTimeout(k);
  ...
  const C = G(() => {
    ...
    if (R && sn("note", R)) {
      ...
      g !== "x" && k === "x" ? D == null || D.forEach((F) => Hw(F)) : g === "x" && k !== "x" && (D == null || D.forEach((F) => Yw(F))), (z = d.current) == null || z.applyUpdate([R, { delete: 1 }]);
    }
  }, L = (k) => {
    var E, T, P, _, z;
    const R = (T = (E = d.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : T.at(0);
    if (R && sn("note", R)) {
      k.content.length > 1 && setTimeout(() => {
        var O;
        (O = d.current) == null || O.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: l["%footnoteEditor_cancelButton_tooltip%"] }) })
        ] }) }),
        /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
          /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(
            j,
          ...
          /* @__PURE__ */ r(kt, { children: l["%footnoteEditor_saveButton_tooltip%"] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
            /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(j, { onClick: S, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(co, {}) }) }),
            /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r("p", { children: l["%footnoteEditor_copyButton_tooltip%"] }) })
          ] }) }) })
        ]
      }
    )
...
function Zw({
  ...
  return /* @__PURE__ */ c(at, { children: [
    /* @__PURE__ */ c("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", x), children: [
      d,
      p
    ] }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(at, { children: Ww(t.marker, l, o, w) })
      }
    )
  ] });
}
...
function td({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], s = n["%webView_inventory_occurrences_table_header_occurrence%"], i = V(() => {
  ...
  return /* @__PURE__ */ c(En, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Tn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ c(
      jt,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ r(he, { className: o, children: Qw(l.text) })
        ]
      },
...
const ed = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(Cs, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(Es, { className: "tw-h-4 tw-w-4" });
}, Sn = (t, e, n) => /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ c(Rt, { children: [
  /* @__PURE__ */ c(
    Tt,
    {
  ...
  header: ({ column: e }) => Sn(e, t)
}), nd = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (n) => n.items[e],
  header: ({ column: n }) => Sn(n, t)
}), wp = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => Sn(e, t, "tw-justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: s }) => Sn(s, t, "tw-justify-center"),
  cell: ({ row: s }) => {
  ...
  return e ? e[1] : "";
}, rd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", mp = Object.freeze([
...
function fp({
  ...
  const u = At(n, "%webView_inventory_all%"), g = At(n, "%webView_inventory_approved%"), x = At(n, "%webView_inventory_unapproved%"), v = At(n, "%webView_inventory_unknown%"), y = At(n, "%webView_inventory_scope_currentBook%"), N = At(n, "%webView_inventory_scope_chapter%"), C = At(n, "%webView_inventory_scope_verse%"), S = At(n, "%webView_inventory_filter_text%"), $ = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = At(n, "%webView_inventory_no_results%"), [k, R] = A(!1), [E, T] = A("all"), [P, _] = A(""), [z, D] = A([]), F = V(() => {
    const B = t ?? [];
    return B.length === 0 ? [] : ad(B, a, s);
  }, [t, a, s]), O = V(() => {
    if (k) return F;
    const B = [];
    return F.forEach((et) => {
      const ft = et.items[0], dt = B.find(
        (mt) => mt.items[0] === ft
      );
      dt ? (dt.count += et.count, dt.occurrences = dt.occurrences.concat(et.occurrences)) : B.push({
        items: [ft],
        count: et.count,
  ...
  }, [k, F]), U = V(() => O.length === 0 ? [] : od(O, E, P), [O, E, P]), it = V(() => {
    var ft, dt;
    if (!k) return d;
    ...
    for (let mt = 0; mt < B; mt++)
      et.push(
        nd(
          ((dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt[mt]) || "Additional Item",
          mt + 1
        )
      );
    return [...et, ...d];
  ...
  return /* @__PURE__ */ c("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ c(Se, { onValueChange: (B) => pt(B), defaultValue: i, children: [
...
function gp({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = A(""), a = V(() => {
  ...
  return /* @__PURE__ */ c(Ut, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ c(qt, { children: [
      ...
      /* @__PURE__ */ r(Gt, { children: a.map((s) => /* @__PURE__ */ c(
        $t,
        {
...
const sd = "16rem", id = "3rem", _a = b.createContext(void 0);
function Dn() {
...
const Ca = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(_a.Provider, { value: N, children: /* @__PURE__ */ r(Nt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const ld = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ c(
    j,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Rs, {}) : /* @__PURE__ */ r(Ts, {}),
...
ud.displayName = "SidebarSeparator";
...
const md = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: o,
...
md.displayName = "SidebarGroupAction";
...
const fd = re(
  ...
  ({
    ...
    const d = t ? Ie : "button", { state: w } = Dn(), p = /* @__PURE__ */ r(
      d,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: f(fd({ variant: n, size: o }), s),
        ...i
      }
    );
...
const hd = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: a,
...
const bd = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const yd = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ie : "a",
  {
    ref: s,
...
yd.displayName = "SidebarMenuSubButton";
function Nd({
  id: t,
  extensionLabels: e,
  projectInfo: n,
...
const Zt = "scrBook", kd = "scrRef", ce = "source", _d = "details", Cd = "Scripture Reference", Ed = "Scripture Book", Oa = "Type", Rd = "Details";
function Td(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, no = (t) => `${Sd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function vp({
  sources: t,
  ...
  const [w, p] = A([]), [m, h] = A([{ id: Zt, desc: !1 }]), [u, g] = A({}), x = V(
    ...
    !e && /* @__PURE__ */ c(
      Se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(be, { position: "item-aligned", children: /* @__PURE__ */ r(Cw, { children: S.map((E) => /* @__PURE__ */ r(yt, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
        ...
        return /* @__PURE__ */ r(
          jt,
          {
            ...
            children: E.getVisibleCells().map((_) => {
              if (!(_.getIsPlaceholder() || _.column.columnDef.enableGrouping && !_.getIsGrouped() && (_.column.columnDef.id !== ce || !n)))
                return /* @__PURE__ */ r(
                  he,
                  {
                    className: f(
                    ...
                    children: _.getIsGrouped() ? /* @__PURE__ */ c(
                      j,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          " ",
                          Ue(_.column.columnDef.cell, _.getContext()),
                          " (",
                          E.subRows.length,
                          ")"
                        ]
...
}), Ia = (t, e, n) => Tr(t, e).every((o) => n.includes(o));
function Dd({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Tr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    j,
    {
      variant: "outline",
...
function Md({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
  ...
  const L = V(() => ot.allBookIds.filter(
    ...
    (D) => {
      ...
      n(
        Ia(L, D, e) ? e.filter((O) => !F.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...F])]
      );
    },
    [e, n, L]
  ), _ = () => {
            ...
            Ut,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: _, children: d }),
                  /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: z, children: w })
                ] }),
                /* @__PURE__ */ c(qt, { children: [
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        hr,
        {
          ...
          children: y.map(({ value: N, label: C, id: S }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
...
const Pa = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Rt, { children: [
  /* @__PURE__ */ r(Tt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    ...
    /* @__PURE__ */ r(vw, { children: /* @__PURE__ */ r(va, { children: Pa(
      t,
      e,
      Aa(t, l.id),
      o
...
function wr({
  ...
  return /* @__PURE__ */ c(ve, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(j, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ds, {}) }) }),
    /* @__PURE__ */ r(se, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(oo, { children: [
      /* @__PURE__ */ r(ga, { children: /* @__PURE__ */ r(Nt, { children: Pa(e.groups, e.items, d, t) }) }),
...
ja.displayName = xt.Content.displayName;
function Tp({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(La, { children: [
      /* @__PURE__ */ r(Va, { children: t.map((l) => /* @__PURE__ */ r(Od, { value: l.value, children: l.value }, l.key)) }),
...
za.displayName = Q.Root.displayName;
...
Fa.displayName = Q.Trigger.displayName;
const Ba = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ot();
  return /* @__PURE__ */ c(
    Q.SubTrigger,
...
Ga.displayName = Q.SubContent.displayName;
...
Ua.displayName = Q.Item.displayName;
const Pd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ c(
    Q.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Pd.displayName = Q.CheckboxItem.displayName;
const $d = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ot();
  return /* @__PURE__ */ c(
    Q.RadioItem,
    {
...
$d.displayName = Q.RadioItem.displayName;
...
Ld.displayName = Q.Label.displayName;
...
qa.displayName = Q.Separator.displayName;
const Be = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Rt, { children: [
  ...
  if (zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Be(i, [h, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Be(l, [h, u]);
        break;
      case "alt+h":
        (y = d.current) == null || y.focus(), Be(d, [h, u]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ r(za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ c(Id, { children: [
      /* @__PURE__ */ r(Fa, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        Ka,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Nt, { children: Ha(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ c(ve, { children: [
              /* @__PURE__ */ r(Le, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(j, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(lo, {}) }) }),
...
const Fd = tn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Is, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
const Ud = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Ud.displayName = "AlertDescription";
const Pp = tt.Root, $p = tt.Trigger, Lp = tt.Group, Vp = tt.Portal, jp = tt.Sub, zp = tt.RadioGroup, qd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  tt.SubTrigger,
  {
    ref: a,
    className: f(
...
qd.displayName = tt.SubTrigger.displayName;
...
Hd.displayName = tt.SubContent.displayName;
const Yd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(tt.Portal, { children: /* @__PURE__ */ r(
  tt.Content,
  {
    ref: n,
    className: f(
...
Yd.displayName = tt.Content.displayName;
...
Xd.displayName = tt.Item.displayName;
const Wd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ c(
  tt.CheckboxItem,
  {
    ref: a,
    className: f(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(tt.ItemIndicator, { children: /* @__PURE__ */ r(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
Wd.displayName = tt.CheckboxItem.displayName;
const Jd = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  tt.RadioItem,
  {
    ref: o,
    className: f(
...
Qd.displayName = tt.Separator.displayName;
...
ec.displayName = "Drawer";
const Fp = Mt.Trigger, nc = Mt.Portal, Bp = Mt.Close, Xa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
...
Xa.displayName = Mt.Overlay.displayName;
const rc = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
sc.displayName = Mt.Title.displayName;
...
ic.displayName = Mt.Description.displayName;
const lc = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Zn.Root,
  {
    ref: o,
    className: f(
...
lc.displayName = Zn.Root.displayName;
function Gp({
  className: t,
  ...e
}) {
...
function Up({
  ...
  return /* @__PURE__ */ r(
    ur.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(As, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function qp({ ...t }) {
...
const wc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ c(
    Ge.Root,
    {
...
wc.displayName = Ge.Root.displayName;
const dc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ r(
    Qn.Root,
    {
...
dc.displayName = Qn.Root.displayName;
const Hp = xt.Root, cc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ r(
    xt.List,
    {
...
cc.displayName = xt.List.displayName;
...
pc.displayName = xt.Trigger.displayName;
...
uc.displayName = xt.Content.displayName;
...
export {
  ...
  bw as AvatarImage,
  Uc as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  qc as BOOK_SELECTOR_STRING_KEYS,
  Re as Badge,
  Kc as BookChapterControl,
  el as BookSelectionMode,
  Hc as BookSelector,
  j as Button,
  Xc as COMMENT_EDITOR_STRING_KEYS,
  Wc as COMMENT_LIST_STRING_KEYS,
  ua as Card,
  ma as CardContent,
  ...
  Qc as ERROR_POPOVER_STRING_KEYS,
  Vw as ErrorDump,
  tp as ErrorPopover,
  ...
  fp as Inventory,
  lt as Label,
  hp as MARKER_MENU_STRING_KEYS,
  Zc as MarkdownRenderer,
  gp as MarkerMenu,
  np as MoreInfo,
  Fw as MultiSelectComboBox,
  Tp as NavigationContentSearch,
  oe as Popover,
  Bc as PopoverAnchor,
  ...
  Yi as RecentSearches,
  Up as ResizableHandle,
  Kp as ResizablePanel,
  Gp as ResizablePanelGroup,
  Ip as ResultsCard,
  ...
  Te as Separator,
  kp as SettingsList,
  Cp as SettingsListHeader,
  _p as SettingsListItem,
  ...
  bd as SidebarMenuSkeleton,
  vd as SidebarMenuSub,
  yd as SidebarMenuSubButton,
  xd as SidebarMenuSubItem,
  Ca as SidebarProvider,
  wd as SidebarRail,
  ud as SidebarSeparator,
