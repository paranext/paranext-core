...
const ga = fn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Ae : "button", { className: h(ba({ variant: e, size: n, className: t })), ref: i, ...a })
);
F.displayName = "Button";
const fe = Fe.Root, ve = Fe.Trigger, Kl = Fe.Anchor, ee = v.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, i) => {
  const s = ft();
...
ee.displayName = Fe.Content.displayName;
function fr(t, e, n) {
  return `${t} ${Te[t]}${e ? ` ${Ir(t, e)} ${Ve(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function Gl({
  recentSearches: t,
      ...
      ue,
      {
        ...
        children: [
          x === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            y && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ve(y, a) })
          ] }),
          !N && /* @__PURE__ */ p(me, { ref: R, children: [
            x === "books" && /* @__PURE__ */ p(st, { children: [
              ...
              T && Xt(T.book) > 1 && /* @__PURE__ */ p(st, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ve(T.book, a) }),
                /* @__PURE__ */ r(
                  wo,
                  {
                    bookId: T.book,
...
jt({ build: (t, e, n) => Je(e), config: Pe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
jt({ build: (t, e, n) => Je(e), config: Pe({ $onClear: Ca }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const jr = 0, xr = 1, Da = 2, Jn = 3, Nn = 4, $e = 5, Zn = 6, rn = 7;
function Qn(t) {
  return t.id === jr;
}
function Ma(t) {
...
class Dc {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== Nn && nt(307, String(n.id), String($e)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
    const a = { ...n.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(i, s, l) {
      return Object.assign(i, { id: $e, output: s, registerState: l });
    }(n, o, a);
  }
  register(e, n) {
    this._signal = n;
    const o = this.state;
    o.id !== $e && nt(308, String(o.id), String($e));
...
const Oc = jt({ config: Pe({ setOptions: ho, updateOptions: ho }), init: ({ $initialEditorState: t = Mc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class je {
  ...
  static maybeFromEditor(e) {
    const n = e[go];
    return n && (n.PACKAGE_VERSION !== tr && nt(292, n.PACKAGE_VERSION, tr), n instanceof je || nt(293)), n;
  }
  static fromEditor(e) {
...
jt({ dependencies: [vr, vo], name: "@lexical/extension/HorizontalRule", nodes: () => [Be], register(t, e, n) {
  ...
  return we(t.registerCommand(Pc, (s) => {
    ...
    return !1;
  }, Zo), t.registerMutationListener(Be, (s, l) => {
    Nc(() => {
      let w = !1;
...
jt({ build: (t, e) => Je({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Pe({ $getParentEditor: function() {
  const t = Zs();
...
jt({ build: (t, e, n) => Je(e), config: Pe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, n) => {
  const o = n.getOutput();
  return Zt(() => {
...
jt({ build: (t, e, n) => Je(e), config: Pe({ $canIndent: Oa, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
...
jt({ build: (t, e, n) => Je(e), config: Pe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => Zt(() => n.getOutput().disabled.value ? void 0 : Aa(t)) });
function Kc(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
function Ha({
  ...
  const s = ko(o, "%cancelButton_tooltip%"), l = i ?? ko(o, "%acceptButton_tooltip%");
  return /* @__PURE__ */ p(Gr, { children: [
    ...
    /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
      ...
      /* @__PURE__ */ r(Ot, { children: /* @__PURE__ */ r("p", { children: l }) })
    ] }) })
  ] });
}
function En(t, e) {
...
const Qa = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ p(
    rt.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ r(ze, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
        ...
        children: /* @__PURE__ */ p(Xa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              X && /* @__PURE__ */ r(Ke, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: X }),
              /* @__PURE__ */ r(
                F,
                {
                  variant: "ghost",
...
const Ge = dt.Root, Iw = dt.Group, Ue = dt.Value, Aw = pe(
  ...
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(dt.Icon, { asChild: !0, children: /* @__PURE__ */ r(qe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
const ri = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.ScrollDownButton,
  {
    ...
    className: h("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ r(qe, { className: "tw-h-4 tw-w-4" })
  }
));
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ p(
        Ge,
        {
          ...
          children: [
            /* @__PURE__ */ r(Oe, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ue, { placeholder: t.getState().pagination.pageSize }) }),
...
function bu({ id: t, label: e, groups: n }) {
  const [o, a] = D(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(be, { children: [
    /* @__PURE__ */ r(Me, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "default", children: [
      ...
      e,
      /* @__PURE__ */ r(qe, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
...
const hd = (t) => {
  ...
  return e ? e[1] : "";
}, bd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Mu = Object.freeze([
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        Ge,
        {
          ...
          defaultValue: _,
          children: [
            /* @__PURE__ */ r(Oe, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ue, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ p(Ge, { onValueChange: (K) => Ft(K), defaultValue: s, children: [
        /* @__PURE__ */ r(Oe, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ue, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Ie, { children: [
...
const Dd = pe(
  ...
  ({
    ...
    const w = t ? Ae : "button", { state: c } = Un(), d = /* @__PURE__ */ r(
      w,
      {
        ref: l,
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ p(
      Ge,
      {
        ...
        children: [
          /* @__PURE__ */ r(Oe, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ue, {}) }),
                  ...
                  Re,
                  {
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ p(
                      F,
                      {
                        ...
                        type: "button",
                        children: [
                          _.getIsExpanded() && /* @__PURE__ */ r(qe, {}),
                          !_.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(ze, {}) : /* @__PURE__ */ r(ir, {})),
                          " ",
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === rr ? rr : Mo
      ).map((I) => /* @__PURE__ */ r(Ke, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ve(I, a) }, I)),
  ...
  return /* @__PURE__ */ p("div", { id: w, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ p(
      Ge,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(Oe, { children: /* @__PURE__ */ r(Ue, {}) }),
          /* @__PURE__ */ r(
            Ie,
            {
              style: { zIndex: Xe },
...
const Wu = at.Root, Ju = at.Trigger, Zu = at.Group, Qu = at.Portal, tm = at.Sub, em = at.RadioGroup, sp = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  at.SubTrigger,
  {
    ref: a,
    className: h(
...
const nm = Kt.Trigger, gp = Kt.Portal, rm = Kt.Close, Di = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Kt.Overlay,
  {
    ref: n,
...
const lm = Tt.Root, Ep = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ft();
  return /* @__PURE__ */ r(
    Tt.List,
    {
...
export {
  ...
  hu as ERROR_POPOVER_STRING_KEYS,
  Zw as EditorKeyboardShortcuts,
  qw as ErrorDump,
  gu as ErrorPopover,
  ku as FOOTNOTE_EDITOR_STRING_KEYS,
  yu as Filter,
  bu as FilterDropdown,
  xu as Footer,
  Nu as FootnoteEditor,
  ud as FootnoteItem,
  _u as FootnoteList,
  Mu as INVENTORY_STRING_KEYS,
  Qe as Input,
  Ou as Inventory,
  Nr as Kbd,
  gt as Label,
  od as MARKER_MENU_STRING_KEYS,
  fu as MarkdownRenderer,
  id as MarkerMenu,
  vu as MoreInfo,
  ...
  $u as ScopeSelector,
  Au as ScriptureResultsViewer,
  Lu as ScrollGroupSelector,
  Xr as SearchBar,
  Ge as Select,
  Ie as SelectContent,
  Iw as SelectGroup,
