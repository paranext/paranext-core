import { jsx as r, jsxs as l, Fragment as Ue } from "react/jsx-runtime";
import u, { forwardRef as Ke, useState as P, createContext as Or, useContext as Mr, useCallback as Y, useRef as Q, useMemo as q, useEffect as dt, useLayoutEffect as bn, Fragment as Dn } from "react";
import { Check as Ct, CircleSlash as zr, ChevronRight as qe, Circle as Je, X as We, Search as On, ChevronsUpDown as Ze, FilterIcon as Br, ChevronDown as ce, ChevronUp as Ir, ArrowLeftIcon as Ar, ChevronLeftIcon as Pr, ChevronRightIcon as Fr, ArrowRightIcon as jr, Filter as Xr, User as Gr, Link as $r, CircleHelp as Lr, Star as Hr, CircleCheckIcon as Yr, CircleXIcon as Ur, CircleHelpIcon as Kr, ArrowUpIcon as qr, ArrowDownIcon as Jr, ArrowUpDownIcon as Wr, PanelLeft as Zr, PanelRight as Qr, ScrollText as ta, ChevronLeft as ea, MenuIcon as na, Menu as ra, EllipsisVertical as aa, LoaderCircle as oa, Copy as sa } from "lucide-react";
...
import { formatScrRef as Ot, MODIFIER_KEYS as vn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Qe, isString as Ve, compareScrRefs as Ae, scrRefToBBBCCCVVV as De, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
...
import { useReactTable as zn, getFilteredRowModel as ua, getSortedRowModel as Bn, getPaginationRowModel as ma, getCoreRowModel as In, flexRender as Jt, getGroupedRowModel as ha, getExpandedRowModel as fa } from "@tanstack/react-table";
...
const ya = Ke(
  ({
    ...
    return /* @__PURE__ */ l("div", { className: "tw-relative tw-max-w-48", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          ...
          className: d(
            ...
            i && (s ? "focus-visible:tw-ring-green-600" : w && "focus-visible:tw-ring-destructive"),
            o
          ),
      ...
      g && i && (s ? /* @__PURE__ */ r(Ct, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-green-600" }) : w && /* @__PURE__ */ r(zr, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-destructive" }))
    ] });
  }
), tn = Or(void 0);
function pt() {
...
const en = X.Trigger, Xe = X.Group, ka = X.Portal, Ca = X.Sub, _a = X.RadioGroup;
...
Fn.displayName = X.SubTrigger.displayName;
...
jn.displayName = X.SubContent.displayName;
...
const ie = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = pt();
  return /* @__PURE__ */ l(
    X.CheckboxItem,
    {
...
const Ge = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = pt();
  return /* @__PURE__ */ l(
    X.RadioItem,
    {
...
Ge.displayName = X.RadioItem.displayName;
...
const et = class O {
  constructor(e, n, a, o) {
    if (E(this, "firstChapter"), E(this, "lastChapter"), E(this, "lastVerse"), E(this, "hasSegmentsDefined"), E(this, "text"), E(this, "BBBCCCVVVS"), E(this, "longHashCode"), E(this, "versification"), E(this, "rtlMark", "‏"), E(this, "_bookNum", 0), E(this, "_chapterNum", 0), E(this, "_verseNum", 0), E(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, w = n != null && n instanceof Vt ? n : void 0;
  ...
  static fromJSON(e) {
    ...
    let c;
    return w && (c = new Vt(w)), n ? new O(n, a.toString(), i, c) : new O();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const w = +s[1].trim();
          this.versification = new Vt(ut[w]);
        } catch {
...
E(et, "defaultVersification", Vt.English), E(et, "verseRangeSeparator", "-"), E(et, "verseSequenceIndicator", ","), E(et, "verseRangeSeparators", [et.verseRangeSeparator]), E(et, "verseSequenceIndicators", [et.verseSequenceIndicator]), E(et, "chapterDigitShifter", 1e3), E(et, "bookDigitShifter", et.chapterDigitShifter * et.chapterDigitShifter), E(et, "bcvMaxValue", et.chapterDigitShifter - 1), /**
...
function ja({
  ...
  const w = Array.from({ length: e }, (c, p) => p + 1), i = Y(
    (c) => {
      o(c);
    },
    [o]
  );
  return /* @__PURE__ */ r("div", { className: d("tw-flex tw-flex-wrap tw-items-start tw-justify-start tw-self-stretch"), children: w.map((c) => /* @__PURE__ */ r(
    "div",
    {
      className: d(
...
const Nn = 6, on = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), Un = Object.fromEntries(
...
function Js({
  ...
  const o = W(), [s, w] = P(
    () => Ot(t, "English")
  ), [i, c] = P(""), [p, g] = P(t.book), [v, f] = P(t.chapterNum ?? 0), [h, C] = P(t.book), [T, N] = P(!1), [x, S] = P(T), [V, I] = P(!1), [z, ft] = P(), H = Q(void 0), y = Q(void 0), b = Q(void 0), B = Q(void 0), R = Y(
    (m) => {
      if (m.trim())
        return kn.reduce(
          (D, _) => {
            ...
            const U = _.exec(m);
            if (U) {
              const [j, Tt = void 0, ae = void 0] = U.slice(1), st = _n(j) ?? (M.isBookIdValid(j) ? j.toLocaleUpperCase() : void 0);
              if (st) {
    ...
    if (!(!z || !z.chapterNum))
      return z.verseNum ? [z.chapterNum] : Array.from({ length: At(h) }, (m, D) => D + 1).filter(
        (m) => {
          var D;
          return (z == null ? void 0 : z.chapterNum) && m.toString().includes((D = z == null ? void 0 : z.chapterNum) == null ? void 0 : D.toString());
        }
      );
  }, [h, z]), it = q(() => {
    const m = R(s.trim());
    ...
    (m) => {
      ...
      return {
        ...
        const U = Un[_].toLowerCase(), j = i.length > 0 && /^\d/.test(i) ? (
          // consider edge case where the first character is a digit (e.g. "3JN")
          i.charAt(0) + i.slice(1).replace(/[^a-zA-Z]/g, "").toLowerCase()
        ) : i.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    () => Z.reduce((m, D) => m + D.books.length, 0),
    [Z]
  ), L = Y(
    (m) => {
      w(m), c(m), ft(R(m.trim()));
    ...
    w(Ot(t, "English")), c(""), g(t.book), C(t.book);
  }, [t]), bt = Y((m) => {
    if (ot.current) {
      ot.current = !1;
      return;
    ...
    (m, D, _, U) => {
      if (f(t.book !== m ? 1 : t.chapterNum), D || At(m) === -1) {
        e({
          book: m,
          chapterNum: _ ?? 1,
          verseNum: U ?? 1
    ...
    kn.forEach((m) => {
      const D = m.exec(i);
      if (D) {
        const [_, U = void 0, j = void 0] = D.slice(1), Tt = _n(_);
        (M.isBookIdValid(_) || Tt) && It(
          Tt ?? _,
          !0,
          U ? parseInt(U, 10) : 1,
          j ? parseInt(j, 10) : 1
    ...
    (m) => {
      ...
      if (document.activeElement === H.current) {
        if (/^[a-zA-Z]$/.test(m.key) && (L(it ? i + m.key : m.key), I(!0), m.preventDefault()), /^\d$/.test(m.key)) {
          const D = s;
          if (V)
            L(i + m.key);
          else {
    ...
    vn.has(m.key) || (m.key === "Tab" && m.shiftKey && (H.current.focus(), m.preventDefault()), m.stopPropagation(), H.current.focus(), H.current.dispatchEvent(new KeyboardEvent("keydown", { ...m, view: void 0 })));
  }, []), Er = Y(
    (m) => {
      const { key: D } = m;
      Cn.has(D) || (re(m), m.preventDefault());
    },
    [re]
  ), Vr = Y((m) => {
    const { key: D } = m;
    D === "ArrowUp" && (m.preventDefault(), H.current.focus());
  }, []), Dr = Y(
    (m, D) => {
      const { key: _ } = m;
      if (Cn.has(_)) {
        if (h === p || k === 1) {
          const j = k === 1 ? h : p;
          if (_ === "Enter") {
            m.preventDefault(), It(j, !0, v);
            return;
          }
          const Tt = _ === "ArrowRight" && !o || _ === "ArrowRight" && o === "ltr" || _ === "ArrowLeft" && o === "rtl", ae = _ === "ArrowLeft" && !o || _ === "ArrowLeft" && o === "ltr" || _ === "ArrowRight" && o === "rtl", Re = Array.from(
            { length: At(h) },
            (oe, Rt) => Rt + 1
          ), st = p !== h || k === 1 ? K ?? Re : Re, wt = st.indexOf(v);
          let vt = v;
          if (Tt)
            ...
            const oe = st[wt] + Nn, Rt = st.find((Ee) => Ee >= oe);
            Rt !== void 0 && (vt = Rt);
          } else if (_ === "ArrowUp") {
            const oe = st[wt] - Nn, Rt = st.slice().reverse().find((Ee) => Ee <= oe);
            Rt !== void 0 && (vt = Rt);
          }
          if (vt !== v) {
  ...
  return dt(() => {
    ...
    const m = setTimeout(() => {
      ...
      if (x && y.current && b.current) {
        const j = b.current.offsetTop - $a;
        y.current.scrollTo({ top: j, behavior: "instant" }), H.current.focus();
      }
      !x && document.activeElement !== H.current && !((D = H.current) != null && D.contains(document.activeElement)) && document.activeElement !== y.current && !((_ = y.current) != null && _.contains(document.activeElement)) && tt();
    }, 10);
    return () => {
      clearTimeout(m);
    };
  }, [x, tt]), /* @__PURE__ */ l(ue, { modal: !1, open: T, onOpenChange: bt, children: [
    ...
    k > 0 && /* @__PURE__ */ r(
      ne,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Z.map((m, D) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(he, { className: "tw-font-semibold tw-text-foreground/80", children: Xa[m.bookType] }),
            m.books.map((_, U) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Fa,
              {
                bookId: _,
                handleSelectBook: () => It(_, !1),
                shouldExpandChildren: p.toLowerCase() === _.toLowerCase() || k === 1,
                handleHighlightBook: () => C(_),
                handleKeyDown: (j) => Dr(j, U),
                bookType: m.bookType,
                ref: (j) => {
                  p === _ && (b.current = j);
                },
...
), J = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Mn.Root, { ref: n, className: d("pr-twp", Ha(), t), ...e }));
...
const wn = Qt.Root, ln = Qt.Trigger, fe = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = W();
...
dn.displayName = nt.Group.displayName;
...
function $e({
  ...
  const [N, x] = P(!1);
  return /* @__PURE__ */ l(wn, { open: N, onOpenChange: x, ...T, children: [
    /* @__PURE__ */ r(ln, { asChild: !0, children: /* @__PURE__ */ l(
      F,
      {
        variant: f,
        role: "combobox",
        ...
        children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: d("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: s ? i(s) : p })
          ] }),
...
function Zs({
  ...
  const g = Oe(p, "%webView_bookSelector_currentBook%"), v = Oe(p, "%webView_bookSelector_choose%"), f = Oe(p, "%webView_bookSelector_chooseBooks%"), [h, C] = P(
    "current book"
    /* CURRENT_BOOK */
  ), T = (N) => {
    C(N), t(N);
...
const jt = $.Root, to = $.Group, Xt = $.Value, eo = _t(
  ...
  return /* @__PURE__ */ l(
    $.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r($.Icon, { asChild: !0, children: /* @__PURE__ */ r(ce, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
no.displayName = $.Label.displayName;
...
ro.displayName = $.Separator.displayName;
function ao({ table: t }) {
...
function io({
  ...
  var N;
  const [i, c] = P([]), [p, g] = P([]), [v, f] = P({}), [h, C] = P({}), T = zn({
    data: e,
    columns: t,
    getCoreRowModel: In(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Ne, { stickyHeader: s, children: [
      /* @__PURE__ */ r(ke, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ r(kt, { children: x.headers.map((S) => /* @__PURE__ */ r(te, { children: S.isPlaceholder ? void 0 : Jt(S.column.columnDef.header, S.getContext()) }, S.id)) }, x.id)) }),
      /* @__PURE__ */ r(Ce, { children: (N = T.getRowModel().rows) != null && N.length ? T.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        kt,
        {
          onClick: () => w(x, T),
...
function ti({ id: t, label: e, groups: n }) {
  const a = (o) => {
    ...
    return s && w ? /* @__PURE__ */ r(Xe, { children: o.items.map((i) => /* @__PURE__ */ r("div", { children: i.itemType === 0 ? /* @__PURE__ */ r(ie, { checked: i.checked, onClick: i.onClick, children: i.label }) : /* @__PURE__ */ r(Ge, { onClick: i.onClick, value: i.value || i.label, children: i.label }) }, i.label)) }) : s ? /* @__PURE__ */ r(_a, { value: o.radioValue, onValueChange: o.onRadioValueChange, children: o.items.map((i) => /* @__PURE__ */ r(
      Ge,
      {
      ...
      i.label
    )) }) : /* @__PURE__ */ r(Xe, { children: o.items.map((i) => /* @__PURE__ */ r(ie, { checked: i.checked, onClick: i.onClick, children: i.label }, i.label)) });
  };
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(ue, { children: [
    /* @__PURE__ */ r(en, { asChild: !0, children: /* @__PURE__ */ l(F, { variant: "default", children: [
      /* @__PURE__ */ r(Xr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ce, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ne, { children: n.map((o, s) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(he, { children: o.label }),
      a(o),
      s < n.length - 1 && /* @__PURE__ */ r(Ft, {})
    ] }, o.label)) })
  ] }) });
}
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-1 tw-ps-4", children: [
          /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-2", children: a.slice(0, 3).map((i) => /* @__PURE__ */ r("span", { className: "tw-text-xs tw-font-semibold tw-text-foreground", children: i.toUpperCase() }, i)) }),
...
function lo({ id: t, versionHistory: e }) {
  ...
  function s(i) {
    const c = new Date(i), p = new Date(o.getTime() - c.getTime()), g = p.getUTCFullYear() - 1970, v = p.getUTCMonth(), f = p.getUTCDate() - 1;
    let h = "";
  ...
  return /* @__PURE__ */ l("div", { id: t, children: [
    ...
    /* @__PURE__ */ r("ul", { className: "tw-list-disc tw-pl-5 tw-pr-4 tw-text-xs tw-text-foreground", children: (n ? w : w.slice(0, 5)).map((i) => /* @__PURE__ */ l("div", { className: "tw-mt-3 tw-flex tw-justify-between", children: [
      /* @__PURE__ */ r("div", { className: "tw-text-foreground", children: /* @__PURE__ */ r("li", { className: "tw-prose tw-text-xs", children: /* @__PURE__ */ r("span", { children: i[1].description }) }) }),
...
function po({
  ...
  const [v, f] = P(!1), h = Y(
    (N) => {
      var S;
      const x = (S = t.find((V) => V.label === N)) == null ? void 0 : S.value;
      x && a(
        n.includes(x) ? n.filter((V) => V !== x) : [...n, x]
      );
    },
    [t, n, a]
  ), C = () => w || o, T = q(() => {
    if (!c) return t;
    const N = t.filter((S) => S.starred).sort((S, V) => S.label.localeCompare(V.label)), x = t.filter((S) => !S.starred).sort((S, V) => {
      const I = n.includes(S.value), z = n.includes(V.value);
      return I && !z ? -1 : !I && z ? 1 : S.label.localeCompare(V.label);
    });
    return [...N, ...x];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(wn, { open: v, onOpenChange: f, children: [
    /* @__PURE__ */ r(ln, { asChild: !0, children: /* @__PURE__ */ l(
      F,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(fe, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ge, { children: [
      ...
      /* @__PURE__ */ l(ve, { children: [
        ...
        /* @__PURE__ */ r(dn, { children: T.map((N) => {
...
function uo({
  ...
  return /* @__PURE__ */ l(Ne, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Ce, { children: s.length > 0 && s.map((w) => /* @__PURE__ */ l(
      kt,
      {
        onClick: () => {
          e(w.reference);
        ...
        children: [
          /* @__PURE__ */ r(Gt, { children: `${M.bookIdToEnglishName(w.reference.book)} ${w.reference.chapterNum}:${w.reference.verseNum}` }),
          /* @__PURE__ */ r(Gt, { children: w.text })
        ]
      },
...
const cn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pe.Root,
  {
    ref: n,
    className: d(
...
cn.displayName = Pe.Root.displayName;
const Zn = _t(
...
const _e = (t) => t === "asc" ? /* @__PURE__ */ r(qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ai = (t) => ({
  accessorKey: "item",
  ...
  let w = [...n];
  t.forEach((c) => {
    e === "approved" ? w.includes(c) || w.push(c) : w = w.filter((p) => p !== c);
  }), a(w);
  let i = [...o];
  t.forEach((c) => {
    e === "unapproved" ? i.includes(c) || i.push(c) : i = i.filter((p) => p !== c);
  }), s(i);
}, si = (t, e, n, a, o) => ({
  accessorKey: "status",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(tr, { value: w, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        se,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, fo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", di = Object.freeze([
...
function ci({
  ...
  const p = xt(n, "%webView_inventory_all%"), g = xt(n, "%webView_inventory_approved%"), v = xt(n, "%webView_inventory_unapproved%"), f = xt(n, "%webView_inventory_unknown%"), h = xt(n, "%webView_inventory_scope_currentBook%"), C = xt(n, "%webView_inventory_scope_chapter%"), T = xt(n, "%webView_inventory_filter_text%"), N = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, S] = P(!1), [V, I] = P("all"), [z, ft] = P(""), [H, y] = P([]), b = q(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), B = q(() => {
    if (x) return b;
    const k = [];
    return b.forEach((L) => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(jt, { onValueChange: (k) => gt(k), defaultValue: w, children: [
...
const pn = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Pn.Root,
  {
    ref: o,
    decorative: n,
...
pn.displayName = Pn.Root.displayName;
...
const un = ee.Provider, mn = ee.Root, hn = ee.Trigger, Se = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ee.Content,
  {
    ref: a,
    sideOffset: e,
...
const nr = u.forwardRef(
  ({
    ...
    const [p, g] = u.useState(t), v = e ?? p, f = u.useCallback(
      ...
      [n, v]
    ), h = u.useCallback(() => f((V) => !V), [f]), C = v ? "expanded" : "collapsed", x = W() === "ltr" ? w : w === "primary" ? "secondary" : "primary", S = u.useMemo(
      () => ({
        state: C,
        open: v,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(er.Provider, { value: S, children: /* @__PURE__ */ r(un, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Ro = _t(
  ...
  ({
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(hn, { asChild: !0, children: g }),
    ...
    rr,
    {
      ...
      children: /* @__PURE__ */ l(or, { children: [
        /* @__PURE__ */ l(Le, { children: [
          ...
          /* @__PURE__ */ r(Ye, { children: /* @__PURE__ */ r(sr, { children: Object.entries(e).map(([f, h]) => /* @__PURE__ */ r(ir, { children: /* @__PURE__ */ r(
            wr,
            {
              onClick: () => p(f),
              isActive: v(f),
...
const yt = "scrBook", Io = "scrRef", Dt = "source", Ao = "details", Po = "Scripture Reference", Fo = "Scripture Book", dr = "Type", jo = "Details";
function Xo(t, e) {
  const n = e ?? !1;
  return [
    {
...
function ui({
  ...
  dt(() => {
    if (i) {
      ...
      if (b.length === 1) {
        const B = C.find((R) => Tn(R) === b[0]) || void 0;
        B && i(B);
      }
    }
  }, [f, C, i, N]);
  const x = o ?? Fo, S = s ?? dr, V = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [yt] },
    { label: `Group by ${S}`, value: [Dt] },
    {
    ...
    !e && /* @__PURE__ */ l(
      jt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Bt, { position: "item-aligned", children: /* @__PURE__ */ r(to, { children: V.map((y) => /* @__PURE__ */ r(lt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Ne, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(ke, { children: N.getHeaderGroups().map((y) => /* @__PURE__ */ r(kt, { children: y.headers.filter((b) => b.column.columnDef.header).map((b) => (
      ...
      /* @__PURE__ */ r(Ce, { children: N.getRowModel().rows.map((y, b) => {
        const B = W();
        return /* @__PURE__ */ r(
          kt,
          {
            ...
            children: y.getVisibleCells().map((R) => {
              if (!(R.getIsPlaceholder() || R.column.columnDef.enableGrouping && !R.getIsGrouped() && (R.column.columnDef.id !== Dt || !n)))
                return /* @__PURE__ */ r(
                  Gt,
                  {
                    className: d(
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (B === "ltr" ? /* @__PURE__ */ r(qe, {}) : /* @__PURE__ */ r(ea, {})),
                          " ",
...
}), cr = (t, e, n) => fn(t, e).every((a) => n.includes(a));
function Ho({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
  ...
  return /* @__PURE__ */ l(
    ye,
    {
      ...
      onSelect: () => {
        s.current || (n(t, a.current), a.current = !1), w.current && clearTimeout(w.current), w.current = setTimeout(() => {
          s.current = !1;
        }, 100);
      },
      onMouseDown: (p) => {
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: o && ((i = o.get(t)) == null ? void 0 : i.localizedName) || M.bookIdToEnglishName(t)
          }
        ),
...
function Yo({
  ...
  const s = fn(e, t).length === 0, w = o["%scripture_section_ot_short%"], i = o["%scripture_section_nt_short%"], c = o["%scripture_section_dc_short%"], p = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
...
function Uo({
  ...
  const s = a["%webView_book_selector_books_selected%"], w = a["%webView_book_selector_select_books%"], i = a["%webView_book_selector_search_books%"], c = a["%webView_book_selector_select_all%"], p = a["%webView_book_selector_clear_all%"], g = a["%webView_book_selector_no_book_found%"], v = a["%webView_book_selector_more%"], f = a["%scripture_section_ot_long%"], h = a["%scripture_section_nt_long%"], C = a["%scripture_section_dc_long%"], T = a["%scripture_section_extra_long%"], [N, x] = P(!1), S = Q(void 0), V = Q(!1);
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(wn, { open: N, onOpenChange: x, children: [
      /* @__PURE__ */ r(ln, { asChild: !0, children: /* @__PURE__ */ l(
        F,
        {
          variant: "outline",
...
function hi({
  ...
  const c = Et(
    ...
    w,
    "%webView_scope_selector_current_chapter%"
  ), v = Et(w, "%webView_scope_selector_current_book%"), f = Et(w, "%webView_scope_selector_choose_books%"), h = Et(w, "%webView_scope_selector_scope%"), C = Et(w, "%webView_scope_selector_select_books%"), T = [
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        sn,
        {
          ...
          children: N.map(({ value: x, label: S, id: V }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(we, { className: "tw-me-2", value: x, id: V }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Bt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(lt, { value: `${c}`, children: w[A(c)] }, `${c}`))
          }
        )
      ]
    }
...
const ur = (t, e, n, a) => n ? Object.entries(t).filter(
...
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, c) => i.order - c.order).map((i) => /* @__PURE__ */ l(mn, { children: [
  /* @__PURE__ */ r(hn, { asChild: !0, children: "command" in i ? /* @__PURE__ */ l(
    me,
    {
      onClick: () => {
        a(i);
      ...
      children: [
        i.iconPathBefore && /* @__PURE__ */ r(de, { icon: i.iconPathBefore, menuLabel: i.label, leading: !0 }),
        i.label,
        i.iconPathAfter && /* @__PURE__ */ r(de, { icon: i.iconPathAfter, menuLabel: i.label })
      ]
    },
    `dropdown-menu-item-${i.label}-${i.command}`
  ) : /* @__PURE__ */ l(Ca, { children: [
    /* @__PURE__ */ r(Fn, { children: i.label }),
  ...
  i.tooltip && /* @__PURE__ */ r(Se, { children: i.tooltip })
...
function En({
  ...
  return /* @__PURE__ */ l(ue, { variant: s, children: [
    /* @__PURE__ */ r(en, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(na, {}) }) }),
    /* @__PURE__ */ r(ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, c]) => typeof i == "boolean" || typeof c == "boolean" ? 0 : i.order - c.order).map(([i], c, p) => /* @__PURE__ */ l(Dn, { children: [
      /* @__PURE__ */ r(Xe, { children: /* @__PURE__ */ r(un, { children: ur(e.groups, e.items, i, t) }) }),
...
function yi({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(mr, { children: [
      /* @__PURE__ */ r(hr, { children: t.map((w) => /* @__PURE__ */ r(Ko, { value: w.value, children: w.value }, w.key)) }),
      t.map((w) => /* @__PURE__ */ r(fr, { value: w.value, children: w.content }, w.key))
    ] })
  ] });
}
function qo({ ...t }) {
...
const Zo = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(Je, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
const Kt = (t, e) => {
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((p) => p.group === s).sort((p, g) => p.order - g.order).map((p) => /* @__PURE__ */ l(mn, { children: [
      /* @__PURE__ */ r(hn, { asChild: !0, children: "command" in p ? /* @__PURE__ */ l(
        Nr,
        {
          onClick: () => {
            a(p);
    ...
    ] }, `tooltip-${p.label}-${"command" in p ? p.command : p.id}`)), c = [...i];
    return i.length > 0 && w < o.length - 1 && c.push(/* @__PURE__ */ r(kr, {}, `separator-${s}`)), c;
  });
};
function ts({
  menuData: t,
  ...
  const o = Q(void 0), s = Q(void 0), w = Q(void 0), i = Q(void 0), c = Q(void 0), p = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (T = w.current) == null || T.focus(), Kt(w, [f, h]);
        break;
      case "alt+n":
        (N = i.current) == null || N.focus(), Kt(i, [f, h]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ l(qo, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(un, { children: Cr(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
...
function Ci({
  ...
  const c = es(
    ...
    var N, x, S, V, I, z;
    const T = C !== h ? ((x = (N = t[h]) == null ? void 0 : N.uiNames) == null ? void 0 : x[C]) ?? ((V = (S = t[h]) == null ? void 0 : S.uiNames) == null ? void 0 : V.en) : void 0;
...
function _i({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: e, children: n.map((i) => /* @__PURE__ */ l("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ r(
      cn,
      {
...
const rs = Ke(({ className: t, ...e }, n) => /* @__PURE__ */ r(oa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
const Ei = ct.Trigger, bs = ct.Portal, Vi = ct.Close, Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Overlay,
  {
    ref: n,
  ...
  return /* @__PURE__ */ l(bs, { children: [
    ...
    /* @__PURE__ */ l(
      ct.Content,
      {
        ...
        ...n,
        children: [
          (o === "bottom" || o === "right") && /* @__PURE__ */ r("div", { className: w[o] }),
          /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-col", children: e }),
          (o === "top" || o === "left") && /* @__PURE__ */ r("div", { className: w[o] })
        ]
      }
    )
  ] });
...
const Os = (t, e, n = {}) => {
  ...
  return dt(() => {
    ...
    return c(!!t), (async () => {
      ...
      p = !1, o.current.preserveValue || w(() => a.current);
    };
  }, [t]), [s, i];
}, Ie = () => !1, zi = (t, e) => {
  const [n] = Os(
