...
import { formatScrRef as Mt, getChaptersForBook as xr, NumberFormat as yr, formatBytes as Nr, deepEqual as ve, isString as ne, compareScrRefs as we, scrRefToBBBCCCVVV as re, getLocalizeKeyForScrollGroupId as M } from "platform-bible-utils";
...
function qo({
  ...
  const o = F(), [s, l] = A(""), [i, p] = A(t.book), [u, h] = A(t.chapterNum ?? 0), [b, g] = A(t.book), [m, y] = A(!1), [z, k] = A(m), x = K(void 0), N = K(void 0), E = K(void 0), $ = tt(
    ...
    Zr.forEach((C) => {
      const I = C.exec(s);
      if (I) {
        const [O, f = void 0, T = void 0] = I.slice(1), Z = ea(O);
  ...
  return wt(() => {
    ...
    /* @__PURE__ */ r(ye, { asChild: !0, children: /* @__PURE__ */ r(
      Ir,
      {
        ...
        handleKeyDown: P,
        handleOnClick: () => {
          p(t.book), g(t.book), h(t.chapterNum > 0 ? t.chapterNum : 0), y(!0), l(Mt(t, "English")), x.current.focus();
        },
        onFocus: () => {
          lt.current = !0;
        },
...
const Mn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Ae, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Dr, { children: /* @__PURE__ */ r(en, { children: Mn(
      t,
      e,
      In(t, i.id),
      a
...
Co.displayName = It.Root.displayName;
