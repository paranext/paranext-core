...
var Xt = (t, e, r) => ys(t, typeof e != "symbol" ? e + "" : e, r);
import { c as b, g as Ae, a as Vr, C as tr, L as qn, u as en, T as At, b as xt, d as yt, e as kt, A as xa, D as Be, f as Te, h as je, i as cr, j as Ge, B as tt, x as ks, k as _s, l as Ns, I as Cs, m as To, n as Ze, r as De, o as Es, p as Gn, P as lr, q as Dr, s as dr, t as wr, v as Oa, w as Ma, y as So, z as ur, E as Ia, F as Pt, R as Ro, G as ya, H as so, J as co, K as lo, M as wo, N as Wn, O as wa, Q as Do, S as Fr, U as Ur, V as yr, W as Ts, X as ir, Y as Xe, Z as Fe, _ as We, $ as kr, a0 as Oo, a1 as Mo, a2 as ka, a3 as Io, a4 as Yn, a5 as Ss, a6 as Rs, a7 as Ds, a8 as uo, a9 as Xn, aa as za, ab as Os, ac as Zn, ad as Ms, ae as Is, af as zs, ag as rn, ah as Ps, ai as As, aj as $s, ak as Jn, al as Qn, am as zo, an as Vs, ao as ti, ap as Ha, aq as an, ar as qa, as as Ls, at as Bs, au as js, av as Fs, aw as Us, ax as Ks, ay as Gr, az as Po, aA as Hs, aB as qs } from "./resizable-DOlm3N_b.js";
import { aC as yf, aD as kf, aE as _f, aF as Nf, aG as Cf, aH as Ef, aI as Tf, aJ as Sf, aK as Rf, aL as Df, aM as Of, aN as Mf, aO as If, aP as zf, aQ as Pf, aR as Af, aS as $f, aT as Vf, aU as Lf, aV as Bf, aW as jf, aX as Ff, aY as Uf, aZ as Kf, a_ as Hf, a$ as qf, b0 as Gf, b1 as Wf, b2 as Yf, b3 as Xf, b4 as Zf, b5 as Jf, b6 as Qf, b7 as tm, b8 as em, b9 as rm, ba as am } from "./resizable-DOlm3N_b.js";
import { jsx as a, jsxs as u, Fragment as gt } from "react/jsx-runtime";
import { Canon as Ft } from "@sillsdev/scripture";
import { Check as Je, Clock as on, ChevronsLeft as nn, ChevronsRight as sn, ChevronUp as ei, ChevronDown as sr, ArrowLeft as Gs, ArrowRight as Ws, BoldIcon as Ys, ItalicIcon as Xs, X as ri, AtSign as ai, Pencil as Zs, Trash2 as Js, Undo2 as Qs, ArrowUp as oi, MoreHorizontal as tc, MailOpen as ec, Mail as rc, FilterIcon as ac, ArrowLeftIcon as oc, ChevronLeftIcon as nc, ChevronRightIcon as ic, ArrowRightIcon as sc, Copy as ni, Filter as cc, User as lc, Link as dc, CircleHelp as wc, Undo as uc, Redo as pc, SquareX as ii, FunctionSquare as si, SquareSigma as ci, Ban as hc, AlertCircle as po, CircleCheckIcon as gc, CircleXIcon as fc, CircleHelpIcon as mc, ArrowUpIcon as vc, ArrowDownIcon as bc, ScrollText as xc, ChevronRight as yc, ChevronLeft as kc, ChevronsUpDown as _c, MenuIcon as Nc, Menu as Cc, EllipsisVertical as Ec, MoreVertical as Tc } from "lucide-react";
import { Section as zt, compareScrRefs as _a, getChaptersForBook as Sc, formatScrRef as $e, formatReplacementString as Ye, getSectionForBook as ua, formatRelativeDate as Rc, sanitizeHtml as Ao, NumberFormat as li, formatBytes as Dc, getCurrentLocale as Oc, usfmMarkers as pa, isPlatformError as Mc, ABORTED as Ic, getErrorMessage as zc, getFormatCallerFunction as Pc, deepEqual as Ac, isString as cn, scrRefToBBBCCCVVV as Ga, defaultScrRef as Wa, formatScrRefRange as $c, getLocalizeKeyForScrollGroupId as ln, formatReplacementStringToArray as dn, collectUsjMarkers as Vc } from "platform-bible-utils";
import Jt, { useRef as B, useMemo as z, createContext as Wr, useContext as Pa, useState as N, useEffect as Q, useCallback as L, useId as Na, useImperativeHandle as Lc, useLayoutEffect as Qt, Fragment as Yr, Component as Bc, createElement as wn, Suspense as jc, forwardRef as $o, memo as di } from "react";
import { IconSelector as wi, IconCheck as Aa, IconChevronDown as Fc, IconChevronUp as Uc, IconLayoutSidebar as Kc, IconLayoutSidebarRight as Hc, IconChevronRight as ui, IconSearch as qc, IconLoader as Gc, IconAlertOctagon as Wc, IconAlertTriangle as Yc, IconInfoCircle as Xc, IconCircleCheck as Zc } from "@tabler/icons-react";
import { createEditor as pi, $getRoot as Qe, $createParagraphNode as Xr, $getSelection as oe, HISTORY_MERGE_TAG as Vo, ParagraphNode as hi, TextNode as gi, $getPreviousSelection as Jc, $isRangeSelection as Se, $caretFromPoint as Qc, $getSiblingCaret as fi, $getChildCaret as tl, $getAdjacentChildCaret as el, $isChildCaret as rl, $normalizeCaret as al, $setSelectionFromCaretRange as ol, $getCollapsedCaretRange as nl, $getCaretInDirection as un, $splitAtPointCaretNext as il, $isTextPointCaret as sl, $findMatchingParent as mi, $isElementNode as Kr, mergeRegister as Le, getDOMTextNode as cl, isHTMLElement as ll, CLEAR_EDITOR_COMMAND as vi, COMMAND_PRIORITY_EDITOR as Lo, shallowMergeConfig as dl, defineExtension as ge, safeCast as pr, createState as wl, FORMAT_TEXT_COMMAND as bi, $isNodeSelection as xi, COMMAND_PRIORITY_LOW as yi, RootNode as ul, LineBreakNode as pl, TabNode as hl, $isEditorState as gl, createCommand as fl, CLICK_COMMAND as ml, isDOMNode as vl, $getNodeFromDOMNode as bl, $createNodeSelection as xl, $setSelection as yl, $getEditor as kl, DecoratorNode as ho, $getState as _l, toggleTextFormatType as pn, TEXT_TYPE_TO_FORMAT as Nl, $setState as Cl, addClassNamesToElement as ki, $create as El, $getNodeByKey as Tl, removeClassNamesFromElement as Sl, KEY_TAB_COMMAND as Rl, $isBlockElementNode as Dl, $createRangeSelection as Ol, $normalizeSelection__EXPERIMENTAL as Ml, OUTDENT_CONTENT_COMMAND as Il, INDENT_CONTENT_COMMAND as hn, INSERT_TAB_COMMAND as zl, COMMAND_PRIORITY_CRITICAL as Bo, $isDecoratorNode as Pl, $isParagraphNode as Al, $isTextNode as go, SELECTION_CHANGE_COMMAND as _i, $insertNodes as $l } from "lexical";
...
import { Avatar as jo, Select as te, Checkbox as gn, Slot as Zr, Tabs as xe, Menubar as Oe, ContextMenu as Ut, Progress as fn, Slider as na, Switch as mn } from "radix-ui";
import { useReactTable as Ci, getFilteredRowModel as ql, getSortedRowModel as Ei, getPaginationRowModel as Gl, getCoreRowModel as Ti, flexRender as Lr, getGroupedRowModel as Wl, getExpandedRowModel as Yl } from "@tanstack/react-table";
import Xl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as fo, HIDDEN_NOTE_CALLER as mo, getDefaultViewOptions as Zl, isInsertEmbedOpOfType as Ir, getMarkerMenuItems as Jl, defaultStyleInfo as Ql, Editorial as td } from "@eten-tech-foundation/platform-editor";
...
function ld({
  ...
  Q(() => {
    ...
    if (!P) return;
    const _ = (Z) => !!Z && Z.scrollWidth > Z.clientWidth, at = () => {
  ...
  const D = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), O = A ? (
...
function pd({
  ...
  const [h, f] = N(!1), [m, x] = N(!1), g = Na(), S = B(!1), y = w !== void 0, E = y ? w : h, C = n === "" ? "" : ae(n, wd), A = ae(s, ud), F = (O) => {
    O || (S.current = !0, x(!1)), y || f(O), p == null || p(O);
  }, K = (O) => {
    if (O && S.current) {
      S.current = !1;
      return;
  ...
  return /* @__PURE__ */ u(Be, { open: E, onOpenChange: F, modal: !1, children: [
    /* @__PURE__ */ a(At, { children: C ? /* @__PURE__ */ u(xt, { open: m, onOpenChange: K, children: [
      /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: D }) }),
...
function gh(t, e, r = (n, s) => n === s, o = 15) {
  return (n) => {
    const s = t.filter(
      (c) => !r(c, n)
    ), i = [n, ...s.slice(0, o - 1)];
...
function Xa({
  ...
  const F = De(), K = sd(), [I, D] = N(!1), [O, W] = N(""), [Y, P] = N(""), [_, at] = N("books"), [M, H] = N(void 0), [Z, j] = N(
    void 0
    ...
    if (!k) return;
    const v = O.startsWith(`${k.book} `) ? O : "", q = ia(v), it = Ar(v);
    return {
      book: k.book,
  ...
  const V = L(() => {
    ...
    (v) => {
      const q = Z ?? (k == null ? void 0 : k.book), it = rt ?? (k == null ? void 0 : k.chapterNum);
      !q || !it || (St({
        book: q,
        chapterNum: it,
        verseNum: v
    ...
    (v) => {
      D(v), v && (at("books"), H(void 0), j(void 0), wt(void 0), P(""), Lt(!1), _t(!1), vt(R));
    },
    [R]
  );
  Q(() => {
  ...
  const { otLong: _e, ntLong: rr, dcLong: ar, extraLong: Ue } = {
    ...
    () => fd(Y),
    [Y]
  ), Ot = z(() => !w || !k || !k.chapterNum || !dt ? !1 : w(k.book, k.chapterNum) > 0, [w, k, dt]), Ke = _ === "books" && !ct && !Y.trim() && Gt.size > 0, ja = L(
    (v) => p ? xn(v, p) : !1,
    [p]
  ), Pe = L(
    (v) => (q) => p ? md(v, q, p) : !1,
    ...
    (v) => {
      ...
      if (!(!!q && !!((Jo = Mt.current) != null && Jo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const Vt = Mt.current ? _d(Mt.current) : [];
        if (Vt.length === 0) {
      ...
      if (v.shiftKey || _ === "books" && q !== Ct.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const Tt = (() => {
        const Vt = _ === "books" && k && Ot && k.chapterNum ? { bookId: k.book, chapterNum: k.chapterNum } : void 0, pe = _ === "verses" ? { bookId: Z, chapterNum: rt } : Vt;
        if (pe) {
  ...
  Qt(() => {
    ...
    if (_ === "verses" && Z && rt !== void 0) {
      const v = Z === t.book && rt === t.chapterNum, q = v ? t.verseNum : 1;
      W(
        ha(Z, rt, q)
      ), setTimeout(() => {
        if (qt.current)
  ...
  const et = k ? `${k.book} ${k.chapterNum ?? ""} ${k.verseNum ?? ""} ${Ot}` : "", $t = B(""), ue = B(""), me = z(() => {
  ...
  }, [_, k, me, et, O]), /* @__PURE__ */ u(lr, { open: I, onOpenChange: Dt, modal: y, children: [
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        onPointerDownOutside: (v) => {
          const { target: q } = v;
          I && se.current && q instanceof Node && se.current.contains(q) && (ce.current = !0, Dt(!1));
        },
        onCloseAutoFocus: S,
            ...
            children: [
                ...
                /* @__PURE__ */ u(xt, { children: [
                  /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Qr,
                      children: F === "ltr" ? /* @__PURE__ */ a(Gs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ws, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                  /* @__PURE__ */ a(kt, { children: Qr })
                ] }),
                _ === "chapters" && M && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ae(M, s) }),
                _ === "verses" && Z && rt !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ae(Z, s)} ${rt}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !ct && /* @__PURE__ */ u(ur, { ref: qt, children: [
                _ === "books" && /* @__PURE__ */ u(gt, { children: [
                  !k && Object.entries(G).map(([v, q]) => {
                    if (q.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Ze, { heading: ze(v), children: q.map((it) => /* @__PURE__ */ a(
                          Ri,
                          {
                            bookId: it,
                            onSelect: (Bt) => lt(Bt),
                  ...
                  k && $ && /* @__PURE__ */ a(Ze, { children: /* @__PURE__ */ u(
                    tr,
                    {
                      value: dd,
                      onSelect: V,
                  ...
                  k && Ot && k.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  k && !Ot && qe(k.book) > 1 && // No heading here either, for the same reason as the verse preview above:
                ...
                _ === "verses" && Z && rt !== void 0 && w && /* @__PURE__ */ a(
                  kn,
                  {
                    bookId: Z,
                    chapterNum: rt,
...
function _n({
  ...
  const [E, C] = N(!1), A = l ?? d, F = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], K = (I, D) => {
    const O = d(I), W = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, Y = `${D ?? ""}${O}${W ?? ""}`;
    return /* @__PURE__ */ u(
      tr,
      {
        value: O,
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        children: /* @__PURE__ */ u(wr, { children: [
          ...
          /* @__PURE__ */ a(ur, { children: F(e) ? e.map((I) => /* @__PURE__ */ a(Ze, { heading: I.groupHeading, children: I.options.map((D) => K(D, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(Ze, { children: e.map((I) => K(I)) }) })
        ] })
      }
    )
  ] });
...
function vh({
  ...
  const w = Za(l, "%webView_bookSelector_currentBook%"), p = Za(l, "%webView_bookSelector_choose%"), h = Za(l, "%webView_bookSelector_chooseBooks%"), [f, m] = N(
    "current book"
    /* CurrentBook */
  ), x = (g) => {
    m(g), t(g);
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Td = zi ? Qt : Q, ca = { tag: Vo };
function Sd({ initialConfig: t, children: e }) {
  const r = z(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: d } = t, l = Ed(null, o), w = pi({ editable: t.editable, html: d, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Rd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : Q;
...
function zd({ children: t, onError: e }) {
  return a(Md, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Pd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : Q;
function Ad(t) {
...
const Pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ld = Pi && "documentMode" in document ? document.documentMode : null;
!(!Pi || !("InputEvent" in window) || Ld) && "getTargetRanges" in new window.InputEvent("input");
function Ee(t) {
  return `${t}px`;
}
...
function jd(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), f = Vd(t, e);
    var m, x;
  ...
  function l(w) {
    w.read(() => {
      ...
      if ((F || K) && C !== null && A !== null) {
        const I = function(D, O, W, Y, P, _, at) {
          const M = (D._window ? D._window.document : document).createRange();
          return M.setStart(...Nn(O, W, Y)), M.setEnd(...Nn(P, _, at)), M;
        }(t, h, m, C, f, S, A);
        d(), d = jd(t, I, e);
      }
...
function Kd(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? r !== null && (r(), r = null) : r === null && (r = Ud(t, e));
  };
...
function qd(t) {
  const e = oe() || Jc();
  let r;
  if (Se(e)) r = Qc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = fi(c, "next"));
    }
    r = r || tl(Qe(), "previous").getFlipped().insert(Xr());
  }
  const o = Gd(t, r), n = el(o), s = rl(n) ? al(n) : o;
  return ol(nl(s)), t.getLatest();
}
function Gd(t, e, r) {
  let o = un(e, "next");
  for (let n = o; n; n = il(n, r)) o = n;
  return sl(o) && Ca(283), o.insert(t.isInline() ? Xr().append(t) : t), un(fi(t.getLatest(), "next"), e.direction);
}
function Wd(t) {
  const e = oe();
  if (!Se(e)) return !1;
...
let Ea, Ve = 0, Ta = 0, Zd = 0, _o = 0, fa = 0;
function En(t) {
  if (ht === void 0) return;
  let e = t.n;
...
function or(t, e) {
  Zt.call(this, void 0), this.x = t, this.s = void 0, this.g = fa - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Jd(t, e) {
  return new or(t, e);
}
...
Zt.prototype.brand = Yd, Zt.prototype.h = function() {
  return !0;
...
const Qa = wl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ji extends ho {
  $config() {
...
ge({ name: "@lexical/extension/DecoratorText", nodes: () => [ji], register: (t, e, r) => t.registerCommand(bi, (o) => {
  const n = oe();
  if (xi(n) || Se(n)) for (const s of n.getNodes()) ew(s) && s.toggleFormat(o);
  return !1;
}, yi) });
function Fi(t, e) {
  let r;
...
class ow {
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || aw;
  }
  getPeerNameSet() {
...
const iw = ge({ config: pr({ setOptions: Sn, updateOptions: Sn }), init: ({ $initialEditorState: t = nw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: s } = n;
    if (gl(s)) t.setEditorState(s, r);
...
}, name: "@lexical/extension/InitialState", nodes: [ul, gi, pl, hl, hi] }), Rn = Symbol.for("@lexical/extension/LexicalBuilder");
function Dn() {
}
function sw(t) {
  throw t;
...
class Nr {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && ft(298, o.name), !n) {
      n = new ow(this, o), this.extensionNameMap.set(o.name, n);
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of tw(p)) {
    ...
    return e.onError || (e.onError = sw), e;
  }
}
const cw = /* @__PURE__ */ new Set(), On = ge({ build(t, e, r) {
...
class Cr extends ho {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: dw, priority: 0 }) };
  }
  exportDOM() {
...
ge({ dependencies: [No, On], name: "@lexical/extension/HorizontalRule", nodes: () => [Cr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(On).output, n = Hr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Le(t.registerCommand(lw, (i) => {
    const c = oe();
    if (!Se(c)) return !1;
    ...
    return !0;
  }, Lo), t.registerCommand(ml, (i) => {
    if (vl(i.target)) {
      const c = bl(i.target);
      if (ww(c)) return function(d, l = !1) {
        const w = oe(), p = d.isSelected(), h = d.getKey();
        let f;
        l && xi(w) ? f = w : (f = xl(), yl(f)), p ? f.delete(h) : f.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
...
ge({ build: (t, e, r) => Or(e), config: pr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Re(() => {
    if (!o.disabled.value) return Kd(t, o.onReposition.value);
  });
} });
function qi(t) {
  return t.canBeEmpty();
}
function uw(t, e, r = qi) {
  return Le(t.registerCommand(Rl, (o) => {
    const n = oe();
    if (!Se(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => Dl(h) && h.canIndent()).length > 0) return !0;
      const c = i.anchor, d = i.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Hd(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let f = Ol();
        if (f.anchor.set(h, 0, "element"), f.focus.set(h, 0, "element"), f = Ml(f), f.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Il : hn : zl;
...
ge({ build: (t, e, r) => Or(e), config: pr({ $canIndent: qi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Re(() => {
    if (!o.value) return uw(t, n, s);
  });
} });
const pw = ge({ name: "@lexical/react/ReactProvider" });
function hw() {
...
ge({ build: (t, e, r) => Or(e), config: pr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Re(() => r.getOutput().disabled.value ? void 0 : Wi(t)) });
function mw(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
  ...
  return function(r, o) {
    ...
    return Go(() => r.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (h) => r._onError(h), children: a(jc, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
...
function bw({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(pw.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && mw(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(vw, { editor: t, ErrorBoundary: e });
}
function Mn(t) {
  return t.getEditorState().read(Gi(t.isComposing()));
}
function xw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Me();
  return function(n) {
    Go(() => Le(Bl(n), Wi(n)), [n]);
  }(o), u(gt, { children: [t, a(yw, { content: e }), a(bw, { editor: o, ErrorBoundary: r })] });
}
...
function kw({ defaultSelection: t }) {
  const [e] = Me();
  return Q(() => {
    e.focus(() => {
...
function Sw(t, e) {
  ...
  return u(gt, { children: [a(Ew, { editor: n, ...o, ref: e }), r != null && a(Rw, { editor: n, content: r })] });
}
...
function Iw({
  ...
  const [e] = Me(), [r, o] = N(e), [n, s] = N("paragraph"), [i, c] = Mw(), d = () => {
  };
...
function Pw() {
  const { activeEditor: t } = Zi(), [e, r] = N([]), o = L((n) => {
    if (Se(n) || Ul(n)) {
      const s = [];
      zn.forEach(({ format: i }) => {
...
function $w({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:relative", children: [
      ...
      e && /* @__PURE__ */ a(kw, { defaultSelection: "rootEnd" }),
  ...
  return (
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ a(Sd, { initialConfig: l, children: /* @__PURE__ */ u(At, { children: [
          /* @__PURE__ */ a(
            $w,
            {
              placeholder: n,
...
function Lw(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), s = Hl(e, n);
      Qe().clear(), $l(s);
    },
    {
      discrete: !0
...
const Bw = "verseText", bh = Object.freeze([
...
function xh({
  ...
  const [s, i] = N(Fw), [c, d] = N(n), [l, w] = N(!1), p = B(void 0), h = B(null);
  Q(() => {
    let g = !0;
    const S = h.current;
    if (!S) return;
...
function $n({
  ...
  const E = L(
    ...
    [t.user]
  ), I = z(() => Ao(t.contents), [t.contents]), D = z(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), O = !!t.conflictResolutionAction && !D, W = z(() => {
    if (o && c)
      return /* @__PURE__ */ u(gt, { children: [
        /* @__PURE__ */ u(
          Ge,
          {
            onClick: (P) => {
              ...
              g(_ ? Lw(t.contents) : jw), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(qw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Gw, { className: "tw:text-xs tw:font-medium", children: K }) }),
        ...
        W && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(tc, {}) }) }),
...
const Ww = {
  ...
  var gr;
  const [at, M] = N({}), H = P ?? at, Z = H.editorState ?? Ww, j = H.assignedUser, rt = _ !== void 0, wt = B(H);
  wt.current = H;
  const ct = L(
    (T) => {
  ...
  const k = z(
    () => D ?? r.filter((T) => !T.deleted),
    [D, r]
  ), $ = z(() => {
    const { commentEdits: T } = H;
    if (!T) return T;
    const nt = new Set(k.map((Ot) => Ot.id)), dt = Object.fromEntries(
      Object.entries(T).filter(([Ot]) => nt.has(Ot))
    );
  ...
  }, [i, o]), Wt = z(() => k.slice(1), [k]), Dt = z(() => Wt.length ?? 0, [Wt.length]), ke = z(() => Dt > 0, [Dt]), Ie = z(() => {
    if (_t || Dt <= 2)
      return Wt;
  ...
  }, [Wt, Dt, _t, H.commentEdits]), _e = z(() => _t || Dt <= 2 ? 0 : Dt - Ie.length, [Dt, _t, Ie.length]), rr = z(
    () => Dt === 1 ? mt.singleReply : Ye(mt.multipleReplies, { count: Dt }),
    [Dt, mt]
  ), ar = z(
  ...
  const Ue = L(
    ...
    async (T) => {
      const nt = ie(Z) ? Ra(Z) : void 0, dt = T.status ? T.assignedUser : j ?? T.assignedUser, Ot = await h({
        ...T,
        contents: nt,
        assignedUser: dt
      });
      return Ot && (dt !== void 0 && vt(dt), nt && st()), Ot;
    },
    [st, Z, h, j]
  );
  if (k.length === 0) return;
  const Ne = !Ct || !g || g.length === 0 || !g.includes(c), hr = !ie(Z) && (j === void 0 || j === ut), Jr = /* @__PURE__ */ a(
    $n,
    {
      comment: V,
      localizedStrings: o,
      ...
      handleDeleteComment: m,
      onEditingChange: se,
      canEditOrDelete: (!X && we.get(V.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    Kw,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ u(Hw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              tt,
              {
                ...
                children: It ? /* @__PURE__ */ a(ec, {}) : /* @__PURE__ */ a(rc, {})
              }
            ),
            W === void 0 ? (
          ...
          n && /* @__PURE__ */ u(gt, { children: [
            ...
            S !== !1 && (!X || ie(Z)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Yo(T) && (T.preventDefault(), T.stopPropagation(), (ie(Z) || j !== void 0 && j !== ut) && Ue());
                },
                onKeyDown: (T) => {
                ...
                children: /* @__PURE__ */ a(
                  Sa,
                  {
                    ...
                    actions: /* @__PURE__ */ u(gt, { children: [
                      j !== void 0 && (ie(Z) || j !== ut) ? /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ye(
                        he(
                          "%comment_assigning_to%",
                          o,
...
function Zw({
  ...
  let D;
  K ? D = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : s || (D = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const O = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: O }), Y = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : W, P = () => {
    const M = o ?? "accept";
    ...
    const H = m === M.value, Z = `${l}-${M.value}`, j = _(M);
    return (
...
const ru = di(function(e) {
  const {
    ...
    [d]
  ), { conflictOptions: w, isResolving: p, resolve: h, resolvedResolution: f, showResolveCheck: m } = eu({
    threadId: s,
    threadStatus: i,
    isSelected: n,
    activeComments: d,
...
function Rh({
  ...
  const [C, A] = N(/* @__PURE__ */ new Set()), [F, K] = N(), [I, D] = N(), O = L(
    async (j) => {
      const rt = await s(j);
      return rt !== void 0 && j.assignedUser !== void 0 && j.assignedUser !== "" && D(j.assignedUser), rt;
    },
    [s]
  );
  Q(() => {
      ...
      children: W.map((j) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: j.type === "Conflict" ? /* @__PURE__ */ a(ru, { ...rt, conflictResolution: S }) : /* @__PURE__ */ a(is, { ...rt })
          },
          j.id
        );
      })
...
au.displayName = "ContentZoomRoot";
const Dh = "data-platform-content-zoom-root";
function ou({ table: t }) {
...
var uu = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(uu || {});
...
function pu({ id: t, versionHistory: e }) {
...
function Vh({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(pu, { versionHistory: n }),
...
function gu({
  ...
  const d = Do(), l = Ln(n, "%undoButton_tooltip%"), w = Ln(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ma, { children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(xt, { children: [
      /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ a(
        tt,
...
function yu({
  ...
  return /* @__PURE__ */ u(Be, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(xt, { children: [
      /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: xu(t, o, e) }) }) }),
...
function Nu({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(xt, { children: [
      /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: ku(t, r) }) }) }),
      /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ a("p", { children: _u(t, r) }) })
    ] }) }),
...
function jh({
  ...
  const [x, g] = N("generated"), [S, y] = N("generated"), [E, C] = N("*"), [A, F] = N("*"), [K, I] = N("f"), [D, O] = N(!1), [W, Y] = N(!0), [P, _] = N(!1), at = B(!1), M = B(""), [H, Z] = N(!1), j = mu(), [rt, wt] = N(), ct = B(null), J = B(
    void 0
  ...
  const Nt = L(() => {
    var $, X, V;
    const R = ($ = f.current) == null ? void 0 : $.querySelector(".editor-input"), G = R == null ? void 0 : R.querySelector("span.note"), k = (V = (X = f.current) == null ? void 0 : X.ownerDocument.getSelection()) == null ? void 0 : V.anchorNode;
  ...
  Q(() => {
    ...
    if ($ && Ir("note", $)) {
      const ot = (X = $.insert.note) == null ? void 0 : X.caller;
      let lt = "custom";
  ...
  const Lt = L(
    (R = !1) => {
      ...
      G && Ir("note", G) && (r == null || r([G]), R && l && s && ((X = l.current) == null || X.replaceEmbedUpdate(s, [G])));
    },
    [s, r, p, l]
  ), se = L(
    (R, G) => {
      var X, V, ot;
      const k = (V = (X = h.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : V.at(0);
  ...
  const qt = () => {
    ...
    if (G && Ir("note", G)) {
      ...
      const lt = (V = (X = G.insert.note) == null ? void 0 : X.contents) == null ? void 0 : V.ops;
      K !== "x" && R === "x" ? lt == null || lt.forEach((st) => Ou(st)) : K === "x" && R !== "x" && (lt == null || lt.forEach((st) => Mu(st))), (ot = h.current) == null || ot.applyUpdate([G, { delete: 1 }]);
    }
  }, It = (R) => {
    ...
    (R) => {
      ...
      if (G && Ir("note", G)) {
        ...
        const lt = (X = G.insert.note) == null ? void 0 : X.style, st = (ot = (V = G.insert.note) == null ? void 0 : V.contents) == null ? void 0 : ot.ops;
        if (lt || O(!1), O(
    ...
    (R) => {
      ...
      zs(R, G, {
        ...
        commitTyped: ($) => {
          var X;
          return (X = h.current) == null ? void 0 : X.commitTypedMarker($);
        },
        commitTypedAndReopen: ($) => {
          var X;
          (X = h.current) == null || X.commitTypedMarker($, { trailingSpace: !1 }), we();
        },
        commitTypedCloser: ($) => {
          var X;
          return (X = h.current) == null ? void 0 : X.commitTypedCloser($);
        },
        commitItem: ($) => {
          var V;
          const X = G.items.find((ot) => ot.marker === $);
          X && ((V = h.current) == null || V.applyMarkerMenuSelection(X, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Q(() => {
    ...
    const R = (G) => {
      var X, V;
      const k = (X = f.current) == null ? void 0 : X.querySelector(".editor-input");
    ...
    if (((k = pt.view) == null ? void 0 : k.markerMode) === "editable") {
      ...
      return document.addEventListener("keydown", $, { capture: !0 }), document.addEventListener("paste", X, { capture: !0 }), () => {
        document.removeEventListener("keydown", $, { capture: !0 }), document.removeEventListener("paste", X, { capture: !0 });
      };
    }
    const G = ($) => {
      const X = R();
      !H && X && document.activeElement === X && $.key === c ? ($.preventDefault(), ne()) : H && $.key === "Escape" && ($.preventDefault(), Z(!1));
    };
    ...
    const R = () => {
      ...
      k && !k.isCollapsed || Nt() || ((X = h.current) == null || X.selectNote(0), (V = h.current) == null || V.focus());
    };
  ...
  return /* @__PURE__ */ u(gt, { children: [
    ...
    /* @__PURE__ */ u(lr, { open: H, children: [
      /* @__PURE__ */ a(Ps, { virtualRef: j.virtualRef }),
      /* @__PURE__ */ a(
        dr,
        {
...
const Lu = (t) => {
  ...
  return e ? e[1] : "";
}, ju = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Xh = Object.freeze([
...
function Zh({
  ...
  const f = Ce(r, "%webView_inventory_all%"), m = Ce(r, "%webView_inventory_approved%"), x = Ce(r, "%webView_inventory_unapproved%"), g = Ce(r, "%webView_inventory_unknown%"), S = Ce(r, "%webView_inventory_scope_currentBook%"), y = Ce(r, "%webView_inventory_scope_chapter%"), E = Ce(r, "%webView_inventory_scope_verse%"), C = Ce(r, "%webView_inventory_filter_text%"), A = Ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), F = Ce(r, "%webView_inventory_no_results%"), [K, I] = N(!1), [D, O] = N("all"), [W, Y] = N(""), [P, _] = N([]), at = z(() => {
    const J = t ?? [];
  ...
  }, [K, at]), H = z(() => M.length === 0 ? [] : Fu(M, D, W), [M, D, W]), Z = z(() => {
    var vt, pt;
    if (!K) return d;
...
const Ku = "16rem", Hu = "3rem", cs = Jt.createContext(void 0);
function Ba() {
...
function qu({
  ...
  const [d, l] = Jt.useState(t), w = e ?? d, p = Jt.useCallback(
    ...
    [r, w]
  ), h = Jt.useCallback(() => p((E) => !E), [p]), f = w ? "expanded" : "collapsed", g = De() === "ltr" ? i : i === "primary" ? "secondary" : "primary", S = Jt.useMemo(
    () => ({
      state: f,
      open: w,
      setOpen: p,
...
function Jh({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    tt,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Kc, {}) : /* @__PURE__ */ a(Hc, {}),
...
function Qu({
  ...
  const c = t ? Zr.Root : "button", { state: d } = Ba(), l = /* @__PURE__ */ a(
    c,
    {
    ...
    Gu,
    {
      ...
      children: /* @__PURE__ */ u(Yu, { children: [
        /* @__PURE__ */ u(jn, { children: [
          ...
          /* @__PURE__ */ a(Un, { children: /* @__PURE__ */ a(Xu, { children: Object.entries(e).map(([g, S]) => /* @__PURE__ */ a(Zu, { children: /* @__PURE__ */ a(
            Qu,
            {
              onClick: () => p(g),
              isActive: x(g),
...
const He = "scrBook", ep = "scrRef", nr = "source", rp = "details", ap = "Scripture Reference", op = "Scripture Book", ls = "Type", np = "Details";
function ip(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, Kn = (t) => `${sp({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ug({
  sources: t,
  ...
  Q(() => {
    if (c) {
      const D = S.getSelectedRowModel().rowsById, O = Object.keys(D);
      if (O.length === 1) {
        const W = x.find((Y) => Kn(Y) === O[0]) || void 0;
        W && c(W);
      }
    }
  }, [f, x, c, S]);
  const y = n ?? op, E = s ?? ls, C = [
    ...
    !D.getIsGrouped() && !D.getIsSelected() && D.getToggleSelectedHandler()(O);
  }, K = (D, O) => D.getIsGrouped() ? "" : b("banded-row", O % 2 === 0 ? "even" : "odd"), I = (D, O, W) => {
    if (!((D == null ? void 0 : D.length) === 0 || O.depth < W.column.getGroupedIndex())) {
      if (O.getIsGrouped())
        switch (O.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(nu, { children: C.map((D) => /* @__PURE__ */ a(be, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Oo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Mo, { children: S.getHeaderGroups().map((D) => /* @__PURE__ */ a(We, { children: D.headers.filter((O) => O.column.columnDef.header).map((O) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ka, { colSpan: O.colSpan, className: "tw:sticky top-0", children: O.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Io, { children: S.getRowModel().rows.map((D, O) => {
        const W = De();
        return /* @__PURE__ */ a(
          We,
          {
            ...
            className: b(K(D, O)),
            onClick: (Y) => F(D, Y),
            children: D.getVisibleCells().map((Y) => {
                    ...
                    children: Y.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(yc, {}) : /* @__PURE__ */ a(kc, {})),
                          " ",
...
function hg({
  ...
  const F = jt(
    i,
    "%webView_scope_selector_selected_text%"
  ), K = jt(i, "%webView_scope_selector_verse%"), I = jt(i, "%webView_scope_selector_chapter%"), D = jt(i, "%webView_scope_selector_book%"), O = jt(
    i,
    "%webView_scope_selector_current_verse%"
  ), W = jt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), Y = jt(i, "%webView_scope_selector_current_book%"), P = jt(i, "%webView_scope_selector_choose_books%"), _ = jt(i, "%webView_scope_selector_scope%"), at = jt(i, "%webView_scope_selector_select_books%"), M = jt(i, "%webView_scope_selector_range%"), H = jt(i, "%webView_scope_selector_select_range%"), Z = jt(i, "%webView_scope_selector_range_start%"), j = jt(i, "%webView_scope_selector_range_end%"), rt = jt(i, "%webView_scope_selector_ok%"), wt = jt(i, "%webView_scope_selector_cancel%"), ct = jt(i, "%webView_scope_selector_navigate%"), J = (U) => {
    if (!g) return;
    ...
    [r, n, g, s]
  ), R = pt.find((U) => U.value === t), G = () => t === "selectedBooks" && n.length > 0 ? n.map((U) => U.toUpperCase()).join(", ") : t === "range" ? $c(Nt, Lt, {
  ...
  ), $ = pt.find((U) => U.value === "selectedBooks"), X = pt.find((U) => U.value === "range"), [V, ot] = N(!1), [lt, st] = N(void 0), [bt, Et] = N(void 0), [mt, Rt] = N(void 0), [Wt, Dt] = N(void 0), [ke, Ie] = N([]), _e = p === "dropdown" && lt === "selectedBooks", rr = /* @__PURE__ */ a(
    wp,
    {
      availableBookInfo: o,
  ...
  ), ar = ye === "end", Ue = ye === "start", ze = "tw:text-muted-foreground", Ne = p === "dropdown" && lt === "range", hr = Ne ? Rt : ee, gr = Ne ? Dt : x ? Kt : se, T = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { htmlFor: "scope-range-start", className: b(ar && ze), children: Z }),
      /* @__PURE__ */ a(
        Xa,
        {
  ...
  const ea = L(
    (U) => {
      Et(U), Rt(Nt), Dt(Lt), Ie(n), ot(!1), st(U);
    },
    [Nt, Lt, n]
  ), ra = L(() => {
    ...
    var et;
    U.preventDefault(), (et = Ot.current) == null || et.focus();
  ...
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    ...
    p === "dropdown" && X && /* @__PURE__ */ a(so, { open: lt === "range", onOpenChange: vr, children: /* @__PURE__ */ a(
      co,
      {
        ref: ja,
        onCloseAutoFocus: aa,
...
function Eo({
  ...
  const l = Na(), w = hp(e), p = s && w.length > 1;
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    /* @__PURE__ */ a(Te, { "aria-label": r, className: n, asChild: !0, id: d, children: /* @__PURE__ */ a(tt, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(Nc, {}) }) }),
...
const mp = Object.freeze([520, 420, 340]), gs = Jt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = hs(n, mp), l = Oi() ?? d, w = l >= Br.MINIMUM;
...
const vp = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  xe.Trigger,
  {
    ref: r,
    ...e,
...
function Dp({
  ...
  if (ed(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    var m, x, g, S;
    w.preventDefault();
...
function Eg({
  ...
  return /* @__PURE__ */ u(wr, { id: s, className: b("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(Hs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(qs, { children: /* @__PURE__ */ a(qc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(ur, { children: [
...
function Sg({
  ...
  const c = t ? dn(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Ap(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
...
function Xg({
  ...
  const n = De();
  return /* @__PURE__ */ u($p, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Vp, {}),
    /* @__PURE__ */ u(
      er.Content,
      {
...
function sf({
  ...
  return /* @__PURE__ */ a(
    xe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: b("pr-twp", Lp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function hf(t) {
  const e = z(() => Vc(t).slice().sort().join(" "), [t]);
...
export {
  ...
  Sh as AvatarImage,
  fh as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  ...
  yh as COMMENT_EDITOR_STRING_KEYS,
  Uw as COMMENT_LIST_ELEMENT_ID,
  kh as COMMENT_LIST_STRING_KEYS,
  bh as CONFLICT_NOTE_STRING_KEYS,
  Dh as CONTENT_ZOOM_ROOT_ATTRIBUTE,
  ...
  xh as CommentEditor,
  Rh as CommentList,
  Zw as ConflictNoteCard,
  au as ContentZoomRoot,
  Mg as ContextMenu,
  ...
  du as ERROR_DUMP_STRING_KEYS,
  zh as ERROR_POPOVER_STRING_KEYS,
  fu as EditorKeyboardShortcuts,
  Df as Empty,
  Of as EmptyContent,
  ...
  hu as UNDO_REDO_BUTTONS_STRING_KEYS,
  Ng as UiLanguageSelector,
  gu as UndoRedoButtons,
  fs as VerticalTabs,
  ...
  _h as getCommentThreadElementId,
  ...
  vu as measureRange,
  Up as pickTabIconUrl,
  nm as sonner,
  df as useEvent,
  wf as useEventAsync,
  hf as useExtraValidMarkers,
  Ts as useListbox,
  mu as useLivePopoverAnchor,
  jp as usePromise,
