import Ml, { jsxs as j, jsx as m, Fragment as Bt } from "react/jsx-runtime";
import * as T from "react";
import G, { forwardRef as xi, useCallback as Ce, useState as ie, useRef as Pt, useEffect as Fe, useLayoutEffect as pa, useMemo as mr } from "react";
import { getChaptersForBook as Al, compareScrRefs as no, scrRefToBBBCCCVVV as Br, formatScrRef as jr, split as Dl } from "platform-bible-utils";
import * as ge from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as Bl } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as jl, Check as yo, Circle as Ll, History as Vl, ArrowDownWideNarrow as Fl, Clock as zl, Bookmark as Ul, ChevronDown as Ei, ChevronUp as Hl, ArrowLeftIcon as Gl, ChevronLeftIcon as Wl, ChevronRightIcon as Xl, ArrowRightIcon as ql, FilterIcon as Yl, X as Kl, Search as Jl, ChevronsUpDown as Zl, CircleCheckIcon as ua, CircleXIcon as da, CircleHelpIcon as fa, ArrowUpIcon as Ql, ArrowDownIcon as ec, ArrowUpDownIcon as tc, LoaderCircle as wo, Download as nc } from "lucide-react";
...
const _e = class ce {
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new Tt(i)), n ? new ce(n, r.toString(), l, c) : new ce();
  }
  /**
...
const Di = ge.Root, Lc = ge.Trigger, bv = ge.Group, vv = ge.Portal, yv = ge.Sub, wv = ge.RadioGroup, Vc = G.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ j(
  ge.SubTrigger,
  {
    ref: o,
    className: V(
...
const ji = G.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ j(
  ge.CheckboxItem,
  {
    ref: o,
    className: V(
...
const zc = G.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ j(
  ge.RadioItem,
  {
    ref: r,
    className: V(
...
const hr = G.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ m(
  ge.Label,
  {
    ref: r,
...
hr.displayName = ge.Label.displayName;
...
const Hc = xi(
  ({ handleSearch: e, handleKeyDown: t, handleOnClick: n, handleSubmit: r, ...o }, a) => /* @__PURE__ */ j("div", { className: "pr-relative", children: [
    /* @__PURE__ */ m(
      gr,
      {
        ...o,
...
function Xc({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ j(hr, { className: "pr-flex pr-justify-between", children: [
    /* @__PURE__ */ m("p", { className: "pr-inline-block pr-align-middle", children: "Go To" }),
    /* @__PURE__ */ j("div", { className: "pr-flex pr-items-center", children: [
      /* @__PURE__ */ m(
        Fl,
        {
          onClick: e,
...
function xv({ scrRef: e, handleSubmit: t }) {
  const [n, r] = ie(""), [o, a] = ie(
    ...
    me.bookNumberToId(e.bookNum)
  ), [f, v] = ie(!1), [g, p] = ie(f), h = Pt(void 0), d = Pt(void 0), b = Pt(void 0), x = Ce(
    (k) => Jc(k).filter((C) => {
  ...
  }, [g]), /* @__PURE__ */ m("div", { className: "pr-flex", children: /* @__PURE__ */ j(Di, { modal: !1, open: f, onOpenChange: E, children: [
    ...
    /* @__PURE__ */ j(
      No,
      {
        ...
        children: [
          ...
          ba.map(
            (k, C) => x(k).length > 0 && /* @__PURE__ */ j("div", { children: [
              /* @__PURE__ */ m(hr, { className: "pr-font-semibold pr-text-slate-700", children: qc[k] }),
...
const vr = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("thead", { ref: n, className: V("[&_tr]:pr-border-b", e), ...t }));
vr.displayName = "TableHeader";
const yr = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("tbody", { ref: n, className: V("[&_tr:last-child]:pr-border-0", e), ...t }));
...
const or = we.Root, op = we.Group, ar = we.Value, Rn = G.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ j(
  we.Trigger,
  {
    ref: r,
    className: V(
    ...
    children: [
      t,
      /* @__PURE__ */ m(we.Icon, { asChild: !0, children: /* @__PURE__ */ m(Ei, { className: "pr-h-4 pr-w-4 pr-opacity-50" }) })
    ]
  }
));
...
const Pn = G.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ m(we.Portal, { children: /* @__PURE__ */ j(
  we.Content,
  {
    ref: o,
    className: V(
...
ap.displayName = we.Label.displayName;
const Ke = G.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ j(
  we.Item,
  {
    ref: r,
    className: V(
...
function sp({ table: e }) {
  return /* @__PURE__ */ m("div", { className: "pr-flex pr-items-center pr-justify-between pr-px-2 pr-pb-3 pr-pt-3", children: /* @__PURE__ */ j("div", { className: "pr-flex pr-items-center pr-space-x-6 lg:pr-space-x-8", children: [
    /* @__PURE__ */ j("div", { className: "pr-flex-1 pr-text-sm pr-text-muted-foreground", children: [
    ...
    /* @__PURE__ */ j("div", { className: "pr-flex pr-items-center pr-space-x-2", children: [
    ...
    /* @__PURE__ */ j("div", { className: "pr-flex pr-w-[100px] pr-items-center pr-justify-center pr-text-sm pr-font-medium", children: [
      "Page ",
...
function lp({ table: e }) {
  return /* @__PURE__ */ j(Di, { children: [
    /* @__PURE__ */ m(Bl, { asChild: !0, children: /* @__PURE__ */ j(Ee, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ m(Yl, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ j(No, { align: "end", className: "pr-w-[150px]", children: [
      /* @__PURE__ */ m(hr, { children: "Toggle columns" }),
      /* @__PURE__ */ m(Co, {}),
...
function cp({
  ...
  return /* @__PURE__ */ j("div", { children: [
    ...
    /* @__PURE__ */ m("div", { className: "pr-twp pr-font-sans", children: /* @__PURE__ */ j(br, { children: [
      /* @__PURE__ */ m(vr, { children: h.getHeaderGroups().map((b) => /* @__PURE__ */ m(vt, { children: b.headers.map((x) => /* @__PURE__ */ m(Sn, { children: x.isPlaceholder ? void 0 : xn(x.column.columnDef.header, x.getContext()) }, x.id)) }, b.id)) }),
      /* @__PURE__ */ m(yr, { children: (d = h.getRowModel().rows) != null && d.length ? h.getRowModel().rows.map((b) => /* @__PURE__ */ m(
        vt,
        {
          onClick: () => a(b, h),
    ...
    n && /* @__PURE__ */ j("div", { className: "pr-flex pr-items-center pr-justify-end pr-space-x-2 pr-py-4", children: [
      /* @__PURE__ */ m(
        Ee,
        {
          variant: "outline",
...
const fp = G.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ j(dp, { children: [
  /* @__PURE__ */ m(zi, {}),
  /* @__PURE__ */ j(
    Qe.Content,
    {
...
const Hi = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ j("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
...
function va({
  ...
  const [f, v] = ie(!1);
  return /* @__PURE__ */ j(pp, { open: f, onOpenChange: v, children: [
    /* @__PURE__ */ m(up, { asChild: !0, children: /* @__PURE__ */ j(
      Ee,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ m(Fi, { className: "pr-w-[200px] pr-p-0", children: /* @__PURE__ */ j(Ui, { children: [
      /* @__PURE__ */ m(Hi, { placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ m(Wi, { children: c }),
      /* @__PURE__ */ m(Gi, { children: t.map((g) => /* @__PURE__ */ j(
        Xi,
        {
          value: a(g),
          onSelect: () => {
...
function kv({
  ...
  return /* @__PURE__ */ j("fieldset", { id: e, className: t, children: [
...
function kp() {
  return wa || (wa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(B) {
      ...
      B === r || B === u || B === a || B === o || B === v || B === g || typeof B == "object" && B !== null && (B.$$typeof === h || B.$$typeof === p || B.$$typeof === i || B.$$typeof === l || B.$$typeof === f || B.$$typeof === b || B.$$typeof === x || B.$$typeof === P || B.$$typeof === d);
    }
    function E(B) {
    ...
    var y = c, O = u, N = l, M = i, D = t, L = f, k = r, C = h, $ = p, F = n, H = a, _ = o, z = v, te = !1;
    function Q(B) {
...
var Fr, Ta;
function Yi() {
  return Ta || (Ta = 1, Fr = Function.call.bind(Object.prototype.hasOwnProperty)), Fr;
}
var zr, Na;
function Np() {
  if (Na)
...
function Cp() {
  ...
  return Ur = function(l, c) {
    ...
    function N(S) {
      ...
      function I(U, Y, W, X, K) {
        for (var J = U[Y], q = 0; q < S.length; q++)
          if (h(J, S[q]))
            return null;
        var Z = JSON.stringify(S, function(se, B) {
          var ne = z(B);
    ...
    function L() {
      function S(I, U, Y, W, X) {
        return F(I[U]) ? null : new d("Invalid " + W + " `" + X + "` supplied to " + ("`" + Y + "`, expected a ReactNode."));
      }
      return b(S);
    }
    function k(S, I, U, Y, W) {
      return new d(
        (S || "React class") + ": " + I + " type `" + U + "." + Y + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + W + "`."
      );
    }
    function C(S) {
      function I(U, Y, W, X, K) {
...
Valid keys: ` + JSON.stringify(Object.keys(S), null, "  ")
    ...
    function _(S) {
      var I = typeof S;
      return Array.isArray(S) ? "array" : S instanceof RegExp ? "object" : H(I, S) ? "symbol" : I;
    }
    function z(S) {
...
function st(e, t, n = {
  ...
  return St(e) && St(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (St(t[o]) && o in e && St(e[o]) ? r[o] = st(e[o], t[o], n) : n.clone ? r[o] = St(t[o]) ? Ki(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function $p(e) {
  const {
...
const Mp = rn(s.elementType, Ip), Ap = "exact-prop: ​";
function Qi(e) {
...
function Bp() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var O = i, N = a, M = e, D = c, L = n, k = g, C = v, $ = t, F = o, H = r, _ = u, z = f, te = !1, Q = !1;
    function S(A) {
    ...
    fe.ContextConsumer = O, fe.ContextProvider = N, fe.Element = M, fe.ForwardRef = D, fe.Fragment = L, fe.Lazy = k, fe.Memo = C, fe.Portal = $, fe.Profiler = F, fe.StrictMode = H, fe.Suspense = _, fe.SuspenseList = z, fe.isAsyncMode = S, fe.isConcurrentMode = I, fe.isContextConsumer = U, fe.isContextProvider = Y, fe.isElement = W, fe.isForwardRef = X, fe.isFragment = K, fe.isLazy = J, fe.isMemo = q, fe.isPortal = Z, fe.isProfiler = ee, fe.isStrictMode = se, fe.isSuspense = B, fe.isSuspenseList = ne, fe.isValidElementType = E, fe.typeOf = y;
  }()), fe;
}
process.env.NODE_ENV === "production" ? ao.exports = Dp() : ao.exports = Bp();
var ir = ao.exports;
...
function nu(e) {
  e.addEventListener("keydown", eu, !0), e.addEventListener("mousedown", Gr, !0), e.addEventListener("pointerdown", Gr, !0), e.addEventListener("touchstart", Gr, !0), e.addEventListener("visibilitychange", tu, !0);
}
function ru(e) {
  const {
    target: t
...
function os() {
  ...
  function n() {
    return t.current ? (so = !0, Jp.start(100, () => {
      so = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
ss.isRequired = is;
lo.isRequired = lo;
const ls = process.env.NODE_ENV === "production" ? lo : ss;
function cs(e, t) {
  const n = R({}, t);
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const w = Se(h.current), E = (N) => {
      ...
      if (!p.current)
        return;
      let M = [];
      if ((w.activeElement === u.current || w.activeElement === f.current) && (M = a(h.current)), M.length > 0) {
        var D, L;
        const k = !!((D = b.current) != null && D.shiftKey && ((L = b.current) == null ? void 0 : L.key) === "Tab"), C = M[0], $ = M[M.length - 1];
...
class Pu {
  ...
  add(t, n) {
    ...
    const a = Wr(this.containers, (i) => i.container === n);
  ...
  mount(t, n) {
    const r = Wr(this.containers, (a) => a.modals.indexOf(t) !== -1), o = this.containers[r];
  ...
  remove(t, n = !0) {
    ...
    if (r === -1)
      return r;
    const o = Wr(this.containers, (i) => i.modals.indexOf(t) !== -1), a = this.containers[o];
...
function Mu(e) {
  ...
  }), M = T.useCallback(() => o.isTopModal(y()), [o]), D = $n((_) => {
    p.current = _, _ && (f && M() ? O() : h.current && kn(h.current, w));
  }), L = T.useCallback(() => {
    o.remove(y(), w);
  }, [w, o]);
  T.useEffect(() => () => {
  ...
  const k = (_) => (z) => {
    ...
    !M()) && (n || (z.stopPropagation(), u && u(z, "escapeKeyDown")));
  }, C = (_) => (z) => {
    var te;
  ...
  return {
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: io(_, c == null ? void 0 : c.props.onEnter),
...
var Ie = "top", Xe = "bottom", qe = "right", Me = "left", Ro = "auto", jn = [Ie, Xe, qe, Me], Zt = "start", In = "end", Au = "clippingParents", gs = "viewport", dn = "popper", Du = "reference", ja = /* @__PURE__ */ jn.reduce(function(e, t) {
...
var $t = Math.max, cr = Math.min, Qt = Math.round;
function co() {
...
function en(e, t, n) {
  ...
  var i = At(e) ? ze(e) : window, l = i.visualViewport, c = !vs() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, f = (r.top + (c && l ? l.offsetTop : 0)) / a, v = r.width / o, g = r.height / a;
  return {
    width: v,
    height: g,
    top: f,
...
function ed(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Ze(n.placement), c = _o(l), u = [Me, qe].indexOf(l) >= 0, f = u ? "height" : "width";
  if (!(!a || !i)) {
    var v = Qu(o.padding, n), g = $o(a), p = c === "y" ? Ie : Me, h = c === "y" ? Xe : qe, d = n.rects.reference[f] + n.rects.reference[c] - i[c] - n.rects.popper[f], b = i[c] - n.rects.reference[c], x = Ln(a), P = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = d / 2 - b / 2, E = v[p], y = P - g[f] - v[h], O = P / 2 - g[f] / 2 + w, N = Tn(E, O, y), M = c;
    n.modifiersData[r] = (t = {}, t[M] = N, t.centerOffset = N - O, t);
  }
}
function td(e) {
...
function Va(e) {
  ...
  if (u) {
    var O = Ln(n), N = "clientHeight", M = "clientWidth";
    if (O === ze(n) && (O = wt(n), ct(O).position !== "static" && l === "absolute" && (N = "scrollHeight", M = "scrollWidth")), O = O, o === Ie || (o === Me || o === qe) && a === In) {
      E = Xe;
...
function Mo(e) {
  return en(wt(e)).left + Io(e).scrollLeft;
}
function ud(e, t) {
  var n = ze(e), r = wt(e), o = n.visualViewport, a = r.clientWidth, i = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function dd(e) {
  var t, n = wt(e), r = Io(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = $t(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = $t(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Mo(e), c = -r.scrollTop;
  return ct(o || n).direction === "rtl" && (l += $t(n.clientWidth, o ? o.clientWidth : 0) - a), {
    width: a,
    height: i,
    x: l,
    y: c
...
function ks(e) {
  return ["html", "body", "#document"].indexOf(tt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && Ao(e) ? e : ks(xr(e));
}
function Nn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function za(e, t, n) {
  return t === gs ? po(ud(e, n)) : At(t) ? fd(t, n) : po(dd(wt(e)));
}
function md(e) {
  var t = Nn(xr(e)), n = ["absolute", "fixed"].indexOf(ct(e).position) >= 0, r = n && Ge(e) ? Ln(e) : e;
  return At(r) ? t.filter(function(o) {
    return At(o) && ys(o, r) && tt(o) !== "body";
  }) : [];
}
function hd(e, t, n, r) {
  var o = t === "clippingParents" ? md(e) : [].concat(t), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, u) {
    var f = za(e, u, r);
    return c.top = $t(f.top, c.top), c.right = cr(f.right, c.right), c.bottom = cr(f.bottom, c.bottom), c.left = $t(f.left, c.left), c;
  }, za(e, i, r));
...
function Mn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Au : l, u = n.rootBoundary, f = u === void 0 ? gs : u, v = n.elementContext, g = v === void 0 ? dn : v, p = n.altBoundary, h = p === void 0 ? !1 : p, d = n.padding, b = d === void 0 ? 0 : d, x = xs(typeof b != "number" ? b : Es(b, jn)), P = g === dn ? Du : dn, w = e.rects.popper, E = e.elements[h ? P : g], y = hd(At(E) ? E : E.contextElement || wt(e.elements.popper), c, f, i), O = en(e.elements.reference), N = Ts({
    reference: O,
    element: w,
    strategy: "absolute",
    placement: o
  }), M = po(Object.assign({}, w, N)), D = g === dn ? M : O, L = {
  ...
  if (g === dn && k) {
    ...
    Object.keys(L).forEach(function($) {
      var F = [qe, Xe].indexOf($) >= 0 ? 1 : -1, H = [Ie, Xe].indexOf($) >= 0 ? "y" : "x";
      L[$] += C[H] * F;
    });
  }
  return L;
...
function vd(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    ...
    }, []), y = t.rects.reference, O = t.rects.popper, N = /* @__PURE__ */ new Map(), M = !0, D = E[0], L = 0; L < E.length; L++) {
      var k = E[L], C = Ze(k), $ = tn(k) === Zt, F = [Ie, Xe].indexOf(C) >= 0, H = F ? "width" : "height", _ = Mn(t, {
        placement: k,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
...
function wd(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, i = Mn(t, {
...
function Ed(e, t, n) {
  ...
  return i = i || 0, l = (l || 0) * o, [Me, qe].indexOf(r) >= 0 ? {
    x: l,
    y: i
  } : {
    x: i,
...
function Sd(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, u = n.rootBoundary, f = n.altBoundary, v = n.padding, g = n.tether, p = g === void 0 ? !0 : g, h = n.tetherOffset, d = h === void 0 ? 0 : h, b = Mn(t, {
    boundary: c,
    rootBoundary: u,
    padding: v,
    altBoundary: f
  }), x = Ze(t.placement), P = tn(t.placement), w = !P, E = _o(x), y = Od(E), O = t.modifiersData.popperOffsets, N = t.rects.reference, M = t.rects.popper, D = typeof d == "function" ? d(Object.assign({}, t.rects, {
    placement: t.placement
  })) : d, L = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (O) {
    if (a) {
      var $, F = E === "y" ? Ie : Me, H = E === "y" ? Xe : qe, _ = E === "y" ? "height" : "width", z = O[E], te = z + b[F], Q = z - b[H], S = p ? -M[_] / 2 : 0, I = P === Zt ? N[_] : M[_], U = P === Zt ? -M[_] : -N[_], Y = t.elements.arrow, W = p && Y ? $o(Y) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ws(), K = X[F], J = X[H], q = Tn(0, N[_], W[_]), Z = w ? N[_] / 2 - S - q - K - L.mainAxis : I - q - K - L.mainAxis, ee = w ? -N[_] / 2 + S + q + J + L.mainAxis : U + q + J + L.mainAxis, se = t.elements.arrow && Ln(t.elements.arrow), B = se ? E === "y" ? se.clientTop || 0 : se.clientLeft || 0 : 0, ne = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, A = z + Z - ne - B, le = z + ee - ne, Te = Tn(p ? cr(te, A) : te, z, p ? $t(Q, le) : Q);
      O[E] = Te, C[E] = Te - z;
    }
    if (l) {
      var Pe, xe = E === "x" ? Ie : Me, Et = E === "x" ? Xe : qe, $e = O[y], rt = y === "y" ? "height" : "width", Be = $e + b[xe], ot = $e - b[Et], Ne = [Ie, Me].indexOf(x) !== -1, jt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, kt = Ne ? Be : $e - N[rt] - M[rt] - jt + L.altAxis, on = Ne ? $e + N[rt] + M[rt] - jt - L.altAxis : ot, Un = p && Ne ? Zu(kt, $e, on) : Tn(p ? kt : Be, $e, p ? on : ot);
      O[y] = Un, C[y] = Un - $e;
    }
    t.modifiersData[r] = C;
  }
...
function Id(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ge(t), o = Ge(t) && _d(t), a = wt(t), i = en(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Ao(a)) && (l = $d(t)), Ge(t) ? (c = en(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Mo(a))), {
    ...
    var f = {
      ...
      setOptions: function(x) {
        ...
        d(), f.options = Object.assign({}, a, f.options, P), f.scrollParents = {
          reference: At(l) ? Nn(l) : l.contextElement ? Nn(l.contextElement) : [],
          popper: Nn(c)
        };
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (Wa(P, w)) {
            f.rects = {
              reference: Id(P, Ln(w), f.options.strategy === "fixed"),
              popper: $o(w)
            ...
            for (var E = 0; E < f.orderedModifiers.length; E++) {
              ...
              var y = f.orderedModifiers[E], O = y.fn, N = y.options, M = N === void 0 ? {} : N, D = y.name;
...
const Wd = () => ut({
  ...
  const O = Hd(f, i), [N, M] = T.useState(O), [D, L] = T.useState(pr(o));
  T.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && D && Er(D) && D.nodeType === 1) {
...
`));
  ...
  const C = Wd(), $ = (r = h.root) != null ? r : "div", F = Mt({
    elementType: $,
  ...
  if (a)
    ...
    const L = pr(r);
    N = L && Er(L) ? Se(L).body : Se(null).body;
  }
  const M = !f && c && (!d || w) ? "none" : void 0, D = d ? {
    in: f,
    onEnter: y,
    onExited: O
  } : void 0;
...
const Zd = {
  borderRadius: 4
}, Qd = Zd, ef = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, xt = ef;
function Cn(e, t) {
  return t ? st(e, t, {
    clone: !1
...
}), Tr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Nr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], lf = [...Tr, ...Nr];
function Vn(e, t, n, r) {
  var o;
  const a = (o = kr(e, t, !1)) != null ? o : n;
...
ve.propTypes = process.env.NODE_ENV !== "production" ? Tr.reduce((e, t) => (e[t] = xt, e), {}) : {};
ve.filterProps = Tr;
function ye(e) {
  return Ss(e, Nr);
}
...
ye.filterProps = Nr;
process.env.NODE_ENV !== "production" && lf.reduce((e, t) => (e[t] = xt, e), {});
function uf(e = 8) {
  if (e.mui)
    return e;
  const t = Os({
...
const df = Ye("border", He), ff = Ye("borderTop", He), mf = Ye("borderRight", He), hf = Ye("borderBottom", He), gf = Ye("borderLeft", He), bf = Ye("borderColor"), vf = Ye("borderTopColor"), yf = Ye("borderRightColor"), wf = Ye("borderBottomColor"), xf = Ye("borderLeftColor"), Ef = Ye("outline", He), kf = Ye("outlineColor"), Or = (e) => {
...
Cr(df, ff, mf, hf, gf, bf, vf, yf, wf, xf, Or, Ef, kf);
const Sr = (e) => {
...
Cr(Sr, Rr, Pr, Tf, Nf, Cf, Of, Sf, Rf, Pf, $f, _f);
function qt(e, t) {
  return t === "grey" ? t : e;
}
const If = ke({
...
function rm(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const P = Ec(i, R({
      shouldForwardProp: x,
      label: b
    }, p)), w = (y) => typeof y == "function" && y.__emotion_real !== y || St(y) ? (O) => tr(y, R({}, O, {
      theme: Yn({
        theme: O.theme,
        defaultTheme: n,
        themeId: t
...
function sm(e) {
  ...
  return e.type === "hsla" && (l += "a", c.push(t[3])), $r({
    type: l,
    values: c
  });
}
function Ka(e) {
  e = Dt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Dt(sm(e)).values : e.values;
...
function dr(e, t) {
  return e = Dt(e), t = Fo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, $r(e);
}
function lm(e, t) {
  if (e = Dt(e), t = Fo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
function Om(e) {
  ...
  function v(d) {
    const b = Ja(d, Xr.text.primary) >= n ? Xr.text.primary : Za.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const x = Ja(d, b);
...
const $m = 0.2, _m = 0.14, Im = 0.12;
function be(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${$m})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${_m})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Im})`].join(",");
}
const Mm = ["none", be(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), be(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), be(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), be(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), be(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), be(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), be(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), be(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), be(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), be(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), be(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), be(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), be(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), be(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), be(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), be(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), be(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), be(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), be(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), be(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), be(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), be(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), be(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), be(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Am = Mm, Dm = ["duration", "easing", "delay"], Bm = {
...
var Ym = function(t) {
  return t.scrollTop;
}, wn = "unmounted", Nt = "exited", Ct = "entering", Xt = "entered", fo = "exiting", ft = /* @__PURE__ */ function(e) {
  Xm(t, e);
  function t(r, o) {
    var a;
    a = e.call(this, r, o) || this;
    var i = o, l = i && !i.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = Nt, a.appearStatus = Ct) : c = Xt : r.unmountOnExit || r.mountOnEnter ? c = wn : c = Nt, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== Ct && i !== Xt && (a = Ct) : (i === Ct || i === Xt) && (a = fo);
    }
    ...
    return (
      ...
      /* @__PURE__ */ G.createElement(Is.Provider, {
        value: null
...
}, qr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Ho = /* @__PURE__ */ T.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
    ...
    d === "auto" ? (Q = E.transitions.getAutoHeightDuration(H.clientHeight), w.current = Q) : Q = _, H.style.transition = [E.transitions.create("opacity", {
      ...
      duration: qr ? Q : Q * 0.666,
      delay: qr ? z : z || Q * 0.333,
      easing: te
...
const nh = yt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), bt = nh, rh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function oh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const ah = (e) => {
...
const js = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const O = dt({
    ...
    TransitionProps: ne
  } = O, A = he(O, rh), le = /* @__PURE__ */ T.isValidElement(M) ? M : /* @__PURE__ */ m("span", {
    children: M
  }), Te = zn(), Pe = Te.direction === "rtl", [xe, Et] = T.useState(), [$e, rt] = T.useState(null), Be = T.useRef(!1), ot = F || Q, Ne = vn(), jt = vn(), kt = vn(), on = vn(), [Un, Ko] = rs({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const _r = ns(S), an = T.useRef(), Hn = $n(() => {
  ...
  const Jo = (re) => {
    ...
    Be.current && re.type !== "touchstart" || (xe && xe.removeAttribute("title"), jt.clear(), kt.clear(), _ || Kn && z ? jt.start(Kn ? z : _, () => {
      Jo(re);
    }) : Jo(re));
  }, Zo = (re) => {
    jt.clear(), kt.start(I, () => {
    ...
    xe || Et(re.currentTarget), kl(re), Qo.current === !0 && (ea(!0), Ir(re));
  }, ra = (re) => {
    Be.current = !0;
    const je = le.props;
    je.onTouchStart && je.onTouchStart(re);
  }, oa = Ir, aa = Zo, Nl = (re) => {
    ra(re), kt.clear(), Ne.clear(), Hn(), an.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", on.start(te, () => {
      document.body.style.WebkitUserSelect = an.current, Ir(re);
    });
  }, Cl = (re) => {
    le.props.onTouchEnd && le.props.onTouchEnd(re), Hn(), kt.start(U, () => {
      Gn(re);
    });
  };
  T.useEffect(() => {
  ...
  const Ol = We(le.ref, Tl, Et, n);
  !se && se !== 0 && (at = !1);
  const Mr = T.useRef(), Sl = (re) => {
    const je = le.props;
    je.onMouseMove && je.onMouseMove(re), mn = {
      x: re.clientX,
      y: re.clientY
    }, Mr.current && Mr.current.update();
  }, sn = {}, Ar = typeof se == "string";
  k ? (sn.title = !at && Ar && !$ ? se : null, sn["aria-describedby"] = at ? _r : null) : (sn["aria-label"] = Ar ? se : null, sn["aria-labelledby"] = at && !Ar ? _r : null);
...
`));
  const Rl = T.useMemo(() => {
    ...
    touch: Be.current
  }), Dr = ah(cn), ia = (r = (o = ee.popper) != null ? o : D.Popper) != null ? r : ih, sa = (a = (i = (l = ee.transition) != null ? l : D.Transition) != null ? i : B) != null ? a : ho, la = (c = (u = ee.tooltip) != null ? u : D.Tooltip) != null ? c : sh, ca = (f = (v = ee.arrow) != null ? v : D.Arrow) != null ? f : lh, Pl = yn(ia, R({}, q, (g = Z.popper) != null ? g : L.popper, {
    className: Oe(Dr.popper, q == null ? void 0 : q.className, (p = (h = Z.popper) != null ? h : L.popper) == null ? void 0 : p.className)
  }), cn), $l = yn(sa, R({}, ne, (d = Z.transition) != null ? d : L.transition), cn), _l = yn(la, R({}, (b = Z.tooltip) != null ? b : L.tooltip, {
    className: Oe(Dr.tooltip, (x = (P = Z.tooltip) != null ? P : L.tooltip) == null ? void 0 : x.className)
  }), cn), Il = yn(ca, R({}, (w = Z.arrow) != null ? w : L.arrow, {
    className: Oe(Dr.arrow, (E = (y = Z.arrow) != null ? y : L.arrow) == null ? void 0 : E.className)
  }), cn);
  return /* @__PURE__ */ j(T.Fragment, {
    children: [/* @__PURE__ */ T.cloneElement(le, Ue), /* @__PURE__ */ m(ia, R({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ j(la, R({}, _l, {
          children: [se, N ? /* @__PURE__ */ m(ca, R({}, Il, {
            ref: rt
          })) : null]
        }))
      }))
...
var Fs = Go.default = void 0, wh = yh(vh()), xh = Ml;
...
function zs(e) {
  const {
    ...
    dc,
    {
      ...
      onClick: t,
      id: d,
      children: n ? /* @__PURE__ */ j(Bt, { children: [
        li(a, n, !0),
...
const _h = Gs, Ih = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Kr(e, t, n) {
...
const Xs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  } = t, g = he(t, Ih), p = T.useRef(null), h = T.useRef({
    keys: [],
    repeating: !0,
  ...
  const d = (w) => {
    ...
    if (y === "ArrowDown")
      w.preventDefault(), hn(E, O, u, c, Kr);
    else if (y === "ArrowUp")
      w.preventDefault(), hn(E, O, u, c, ci);
    else if (y === "Home")
      w.preventDefault(), hn(E, null, u, c, Kr);
    else if (y === "End")
      w.preventDefault(), hn(E, null, u, c, ci);
    else if (y.length === 1) {
      const N = h.current, M = y.toLowerCase(), D = performance.now();
      N.keys.length > 0 && (D - N.lastTime > 500 ? (N.keys = [], N.repeating = !0, N.previousKeyMatched = !0) : N.repeating && M !== N.keys[0] && (N.repeating = !1)), N.lastTime = D, N.keys.push(M);
      const L = O && !N.repeating && Ws(O, N);
      N.previousKeyMatched && (L || hn(E, O, !1, c, Kr, N)) ? w.preventDefault() : N.previousKeyMatched = !1;
    }
    f && f(w);
  }, b = We(p, n);
  let x = -1;
...
const Mh = Xs, Ah = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Dh = {
  entering: {
    opacity: 1
  },
  entered: {
...
const Hh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Gh = (e) => {
  ...
  const J = (r = (o = F == null ? void 0 : F.root) != null ? o : x.Root) != null ? r : Wh, q = (a = (i = F == null ? void 0 : F.backdrop) != null ? i : x.Backdrop) != null ? a : f, Z = (l = $ == null ? void 0 : $.root) != null ? l : P.root, ee = (c = $ == null ? void 0 : $.backdrop) != null ? c : P.backdrop, se = Mt({
    elementType: J,
    externalSlotProps: Z,
  ...
  return !L && !C && (!Y || U) ? null : /* @__PURE__ */ m(_n, {
    ...
    container: d,
    disablePortal: O,
    children: /* @__PURE__ */ j(J, R({}, se, {
      children: [!D && f ? /* @__PURE__ */ m(q, R({}, B)) : null, /* @__PURE__ */ m(lr, {
        disableEnforceFocus: E,
        disableAutoFocus: w,
        disableRestoreFocus: N,
        isEnabled: I,
...
`));
    ...
    const Te = z();
    let Pe = Te.top - le.vertical, xe = Te.left - le.horizontal;
    const Et = Pe + A.height, $e = xe + A.width, rt = Jt(nr(c)), Be = rt.innerHeight - b, ot = rt.innerWidth - b;
    if (b !== null && Pe < b) {
      const Ne = Pe - b;
...
`)), b !== null && xe < b) {
  ...
  }, [c, v, z, te, b]), [S, I] = T.useState(x), U = T.useCallback(() => {
    const ne = $.current;
    if (!ne)
      return;
    const A = Q(ne);
  ...
  const K = h || (c ? Se(nr(c)).body : void 0), J = (o = w == null ? void 0 : w.root) != null ? o : ag, q = (a = w == null ? void 0 : w.paper) != null ? a : Zs, Z = Mt({
    elementType: q,
...
const lg = ["onEntering"], cg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], pg = {
  ...
  const a = dt({
    ...
    slots: P = {},
    slotProps: w = {}
  } = a, E = he(a.TransitionProps, lg), y = he(a, cg), O = zn(), N = O.direction === "rtl", M = R({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: x
  }), D = dg(M), L = i && !u && g, k = T.useRef(null), C = (Q, S) => {
...
`)), Q.props.disabled || (x === "selectedMenu" && Q.props.selected || F === -1) && (F = S));
  ...
  const H = (r = P.paper) != null ? r : mg, _ = (o = w.paper) != null ? o : p, z = Mt({
    elementType: P.root,
...
function Tv({
  ...
  return (((u = n == null ? void 0 : n.items) == null ? void 0 : u.length) ?? 0) === 0 || !r ? r : /* @__PURE__ */ j(
    "div",
    {
...
function yg({
  ...
  Fe(() => {
    if (c) {
      ...
      if (E) {
        const y = E.getBoundingClientRect(), O = window.scrollY, N = window.scrollX, M = y.top + O + E.clientHeight, D = y.left + N;
        b({ top: M, left: D });
      }
    }
  }, [c, o]);
...
const gt = "scrBook", wg = "scrRef", Ot = "source", xg = "details", Eg = "Scripture Reference", kg = "Scripture Book", tl = "Type", Tg = "Details";
function Ng(e, t) {
  const n = t ?? !1;
  return [
    {
...
function Cv({
  ...
  return /* @__PURE__ */ j("div", { className: "pr-twp pr-w-full", children: [
    !t && /* @__PURE__ */ j(
      or,
      {
    ...
    /* @__PURE__ */ j(br, { className: "pr-p-0", children: [
      t && /* @__PURE__ */ m(vr, { children: w.getHeaderGroups().map((k) => /* @__PURE__ */ m(vt, { children: k.headers.filter((C) => C.column.columnDef.header).map((C) => /* @__PURE__ */ m(Sn, { colSpan: C.colSpan, children: C.isPlaceholder ? void 0 : /* @__PURE__ */ j("div", { children: [
            ...
            if (!($.getIsPlaceholder() || $.column.columnDef.enableGrouping && !$.getIsGrouped() && ($.column.columnDef.id !== Ot || !n)))
              return /* @__PURE__ */ m(
                Yt,
                {
                  ...
                  children: (() => $.getIsGrouped() ? /* @__PURE__ */ j(
                    Ee,
                    {
                      variant: "ghost",
...
function Og({
  ...
  return /* @__PURE__ */ j("div", { className: V("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": r }), children: [
    /* @__PURE__ */ m(
      nl,
      {
        htmlFor: e,
...
function $v({
  ...
  const a = Pt(void 0);
  return /* @__PURE__ */ m("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ m(wc, { position: "static", id: r, children: /* @__PURE__ */ j(xc, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ m(
      yg,
      {
        commandHandler: t,
...
const Iv = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.Trigger,
  {
    ref: n,
    ...t,
...
)), Ig = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.Content,
  {
    ref: n,
    className: V(
...
Ig.displayName = De.Content.displayName;
const Zn = (e) => e === "asc" ? /* @__PURE__ */ m(Ql, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ m(ec, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ m(tc, { className: "pr-ml-2 pr-h-4 pr-w-4" }), Mg = (e, t, n, r, o) => [
  {
    accessorKey: "character",
    header: ({ column: a }) => /* @__PURE__ */ j(Ee, { onClick: () => a.toggleSorting(void 0), children: [
      e,
      Zn(a.getIsSorted())
    ] })
  },
  ...
  },
  {
    ...
    header: ({ column: a, table: i }) => {
      ...
      return l.forEach((u) => {
        ...
        /* @__PURE__ */ m("div", { className: "pr-flex pr-justify-center", children: /* @__PURE__ */ j(Ee, { onClick: () => a.toggleSorting(void 0), children: [
          r,
          Zn(a.getIsSorted())
        ] }) }),
        /* @__PURE__ */ j("div", { className: "pr-flex pr-justify-center", children: [
          /* @__PURE__ */ m(Ee, { children: /* @__PURE__ */ m(
            ua,
            {
...
function Dg({
  ...
  return Fe(
    ...
    /* @__PURE__ */ m(vr, { children: /* @__PURE__ */ j(vt, { children: [
      /* @__PURE__ */ m(Sn, { children: a }),
      /* @__PURE__ */ m(Sn, { children: i })
    ] }) }),
    /* @__PURE__ */ m(yr, { children: l.map((u) => /* @__PURE__ */ j(
      vt,
      {
        onClick: () => {
          r(u.reference);
...
function Mv({
  ...
  }, [d, x, w, N, D]), /* @__PURE__ */ j("div", { className: "pr-twp", children: [
    /* @__PURE__ */ j("div", { className: "pr-flex", children: [
      /* @__PURE__ */ j(
        or,
        {
          onValueChange: (_) => M(_),
      ...
      /* @__PURE__ */ j(or, { onValueChange: (_) => O(_), defaultValue: y, children: [
...
function Av({
  ...
  return /* @__PURE__ */ m(
    Ee,
    {
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ m(wo, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ j(Bt, { children: [
        /* @__PURE__ */ m(nc, { size: 25, className: "pr-h-4 pr-w-4" }),
        n
      ] })
    }
  );
}
function Dv({ isRemoving: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    Ee,
    {
      className: V(
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ j(Bt, { children: [
        /* @__PURE__ */ m(wo, { size: 15, className: "pr-mr-1 pr-animate-spin pr-text-black" }),
        "Removing..."
      ] }) : "Remove"
    }
  );
}
function Bv({ isUpdating: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    Ee,
    {
      className: V(
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ j(Bt, { children: [
        /* @__PURE__ */ m(wo, { size: 15, className: "pr-mr-1 pr-animate-spin pr-text-white" }),
        "Updating..."
      ] }) : "Update"
    }
  );
...
function Ab(e, t, n) {
  n._ = !0;
  const r = vi(e[1], t, n), o = e[2].replace(fb, "").split("|").map(Mb), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(u) {
      return vi(u, l, c);
    });
...
var ae;
function Vb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Ib, t.namedCodesToUnicode = t.namedCodesToUnicode ? Rt({}, hi, t.namedCodesToUnicode) : hi;
  const n = t.createElement || T.createElement;
  function r(p, h, ...d) {
    const b = eo(t.overrides, `${p}.props`, {});
    return n(function(x, P) {
      const w = eo(P, x);
      return w ? typeof w == "function" || typeof w == "object" && "render" in w ? w : eo(P, `${x}.component`, x) : x;
    }(p, t.overrides), Rt({}, h, b, { className: Lb(h == null ? void 0 : h.className, b.className) || void 0 }), ...d);
  }
  function o(p) {
    let h = !1;
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(d, b, x) {
      ...
      if (P !== -1) {
        const w = function(N) {
          return N.indexOf("-") !== -1 && N.match(eb) === null && (N = N.replace(ab, function(M, D) {
            return D.toUpperCase();
          })), N;
        }(b.slice(0, P)).trim(), E = function(N) {
          const M = N[0];
          return (M === '"' || M === "'") && N.length >= 2 && N[N.length - 1] === M ? N.slice(1, -1) : N;
        }(b.slice(P + 1).trim()), y = mi[w] || w, O = d[y] = function(N, M) {
          return N === "style" ? M.split(/;\s?/).reduce(function(D, L) {
            const k = L.slice(0, L.indexOf(":"));
            return D[k.replace(/(-[a-z])/g, (C) => C[1].toUpperCase())] = L.slice(k.length + 1).trim(), D;
          }, {}) : N === "href" ? Gt(M) : (M.match(tb) && (M = M.slice(1, M.length - 1)), M === "true" || M !== "false" && M);
        }(w, E);
        typeof O == "string" && (bo.test(O) || vo.test(O)) && (d[y] = T.cloneElement(o(O.trim()), { key: x }));
      } else
        b !== "style" && (d[mi[b] || b] = !0);
      return d;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: it(rl), i: ae.HIGH, l: (p, h, d) => ({ v: h(p[0].replace(Ug, ""), d) }), h: (p, h, d) => r("blockquote", { key: d.k }, h(p.v, d)) }, breakLine: { t: gn(Hg), i: ae.HIGH, l: Zr, h: (p, h, d) => r("br", { key: d.k }) }, breakThematic: { t: it(Gg), i: ae.HIGH, l: Zr, h: (p, h, d) => r("hr", { key: d.k }) }, codeBlock: { t: it(al), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, d) => r("pre", { key: d.k }, r("code", Rt({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(ol), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: ht(Wg), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, d) => r("code", { key: d.k }, p.v) }, footnote: { t: it(Yg), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: Qr }, footnoteReference: { t: mt(Kg), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, d) => r("a", { key: d.k, href: Gt(p.B) }, r("sup", { key: d.k }, p.v)) }, gfmTask: { t: mt(Zg), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, d) => r("input", { checked: p.R, key: d.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? sl : il), i: ae.HIGH, l: (p, h, d) => ({ v: rr(h, p[2], d), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, d) => r(`h${p.C}`, { id: p.T, key: d.k }, h(p.v, d)) }, headingSetext: { t: it(ll), i: ae.MAX, l: (p, h, d) => ({ v: rr(h, p[1], d), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: gn(cl), i: ae.HIGH, l: () => ({}), h: Qr }, image: { t: ht($b), i: ae.HIGH, l: (p) => ({ D: p[1], B: wi(p[2]), F: p[3] }), h: (p, h, d) => r("img", { key: d.k, alt: p.D || void 0, title: p.F || void 0, src: Gt(p.B) }) }, link: { t: mt(Pb), i: ae.LOW, l: (p, h, d) => ({ v: Bb(h, p[1], d), B: wi(p[2]), F: p[3] }), h: (p, h, d) => r("a", { key: d.k, href: Gt(p.B), title: p.F }, h(p.v, d)) }, linkAngleBraceStyleDetector: { t: mt(ob), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : mt(nb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: mt(rb), i: ae.MAX, l(p) {
    let h = p[1], d = p[1];
    return Fg.test(d) || (d = "mailto:" + d), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: d, type: "link" };
  } }, orderedList: bi(r, 1), unorderedList: bi(r, 2), newlineCoalescer: { t: it(Xg), i: ae.LOW, l: Zr, h: () => `
` }, paragraph: { t: Db, i: ae.LOW, l: Jr, h: (p, h, d) => r("p", { key: d.k }, h(p.v, d)) }, ref: { t: mt(ib), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: Qr }, refImage: { t: ht(sb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, d) => r("img", { key: d.k, alt: p.D, src: Gt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: mt(lb), i: ae.MAX, l: (p, h, d) => ({ v: h(p[1], d), Z: h(p[0].replace(cb, "\\$1"), d), P: p[2] }), h: (p, h, d) => l[p.P] ? r("a", { key: d.k, href: Gt(l[p.P].B), title: l[p.P].F }, h(p.v, d)) : r("span", { key: d.k }, h(p.Z, d)) }, table: { t: it(pl), i: ae.HIGH, l: Ab, h: (p, h, d) => r("table", { key: d.k }, r("thead", null, r("tr", null, p.L.map(function(b, x) {
  ...
  }, h: () => " | " }, text: { t: gn(kb), i: ae.MIN, l: (p) => ({ v: p[0].replace(Qg, (h, d) => t.namedCodesToUnicode[d] ? t.namedCodesToUnicode[d] : h) }), h: (p) => p.v }, textBolded: { t: ht(vb), i: ae.MED, l: (p, h, d) => ({ v: h(p[2], d) }), h: (p, h, d) => r("strong", { key: d.k }, h(p.v, d)) }, textEmphasized: { t: ht(yb), i: ae.LOW, l: (p, h, d) => ({ v: h(p[2], d) }), h: (p, h, d) => r("em", { key: d.k }, h(p.v, d)) }, textEscaped: { t: ht(Eb), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: ht(wb), i: ae.LOW, l: Jr, h: (p, h, d) => r("mark", { key: d.k }, h(p.v, d)) }, textStrikethroughed: { t: ht(xb), i: ae.LOW, l: Jr, h: (p, h, d) => r("del", { key: d.k }, h(p.v, d)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: gn(bo), i: ae.HIGH, l(p, h, d) {
    const [, b] = p[3].match(Nb), x = new RegExp(`^${b}`, "gm"), P = p[3].replace(x, ""), w = (E = P, _b.some((M) => M.test(E)) ? jb : rr);
    var E;
    const y = p[1].toLowerCase(), O = Lg.indexOf(y) !== -1;
    d.N = d.N || y === "a";
    const N = O ? p[3] : w(h, P, d);
    return d.N = !1, { O: a(p[2]), v: N, G: O, H: O ? y : p[1] };
  }, h: (p, h, d) => r(p.H, Rt({ key: d.k }, p.O), p.G ? p.v : h(p.v, d)) }, c.htmlSelfClosing = { t: gn(vo), i: ae.HIGH, l: (p) => ({ O: a(p[2] || ""), H: p[1] }), h: (p, h, d) => r(p.H, Rt({}, p.O, { key: d.k })) });
  const u = function(p) {
    let h = Object.keys(p);
    function d(b, x) {
      let P = [], w = "";
      for (; b; ) {
        ...
        for (; E < h.length; ) {
          ...
          if (N) {
            ...
            const D = O.l(N, d, x);
            D.type == null && (D.type = y), P.push(D), w = M;
            break;
          }
          E++;
        }
...
const Zb = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ j(
  bn.Root,
  {
    ref: n,
    className: V(
...
Qb.displayName = ro.Root.displayName;
function ev(e, t = "top") {
