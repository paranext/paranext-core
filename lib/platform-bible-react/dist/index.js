...
import { ChevronRight as go, Check as Je, Circle as bo, X as vo, Search as fi, ChevronsUpDown as mi, FilterIcon as ul, ChevronDown as lr, ChevronUp as wl, ArrowLeftIcon as fl, ChevronLeftIcon as ml, ChevronRightIcon as hl, ArrowRightIcon as gl, CircleCheckIcon as bl, CircleXIcon as vl, CircleHelpIcon as yl, ArrowUpIcon as xl, ArrowDownIcon as Nl, ArrowUpDownIcon as kl, Star as El, PanelLeft as Sl, PanelRight as Tl, ScrollText as Cl, ChevronLeft as Rl, LoaderCircle as Ol, Download as _l, Filter as Pl, User as Il, Link as $l, CircleHelp as Ml } from "lucide-react";
import { getChaptersForBook as Al, deepEqual as yo, substring as Dl, formatScrRef as jr, compareScrRefs as to, scrRefToBBBCCCVVV as Br, getLocalizeKeyForScrollGroupId as pt, NumberFormat as jl, formatBytes as Bl } from "platform-bible-utils";
...
const hr = (t) => t === "asc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(kl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), oh = (t) => ({
  accessorKey: "item",
    ...
    Ji,
    {
      ...
      children: /* @__PURE__ */ N(Qi, { children: [
        /* @__PURE__ */ N(ao, { children: [
          ...
          /* @__PURE__ */ i(so, { children: /* @__PURE__ */ i(ts, { children: Object.entries(e).map(([w, h]) => /* @__PURE__ */ i(es, { children: /* @__PURE__ */ i(
            ns,
            {
              className: y(
...
function ee(t, e, n = {
  ...
  return ve(t) && ve(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ve(e[o]) && o in t && ve(t[o]) ? r[o] = ee(t[o], e[o], n) : n.clone ? r[o] = ve(e[o]) ? as(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
...
function dp(t) {
  t.addEventListener("keydown", lp, !0), t.addEventListener("mousedown", Kr, !0), t.addEventListener("pointerdown", Kr, !0), t.addEventListener("touchstart", Kr, !0), t.addEventListener("visibilitychange", cp, !0);
}
function pp(t) {
  const {
    target: e
...
function ws() {
  ...
  function n() {
    return e.current ? (co = !0, ap.start(100, () => {
      co = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function hp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = Et(t, fp), a = mp(e), s = Object.keys(a);
  function l(w) {
...
const Rp = Ut("border", zt), Op = Ut("borderTop", zt), _p = Ut("borderRight", zt), Pp = Ut("borderBottom", zt), Ip = Ut("borderLeft", zt), $p = Ut("borderColor"), Mp = Ut("borderTopColor"), Ap = Ut("borderRightColor"), Dp = Ut("borderBottomColor"), jp = Ut("borderLeftColor"), Bp = Ut("outline", zt), Vp = Ut("outlineColor"), Er = (t) => {
...
kr(Rp, Op, _p, Pp, Ip, $p, Mp, Ap, Dp, jp, Er, Bp, Vp);
const Sr = (t) => {
...
kr(Sr, Tr, Cr, zp, Fp, Lp, Gp, Up, Xp, Yp, Hp, qp);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const Wp = yt({
...
function Lo(t = {}, ...e) {
  ...
  return d.applyStyles = su, d = e.reduce((p, f) => ee(p, f), d), d.unstable_sxConfig = _({}, Fo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Rr({
      sx: f,
      theme: this
    });
...
function Mu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Et(t, Cu), a = t.primary || Ru(e), s = t.secondary || Ou(e), l = t.error || _u(e), c = t.info || Pu(e), d = t.success || Iu(e), p = t.warning || $u(e);
  function f(m) {
...
const Zu = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Qu = (t) => {
  ...
  const r = Yo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, h = Et(r, Zu), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Mn(t) {
  for (var e = jt(t), n = ni(t); n && Dw(n) && re(n).position === "static"; )
    n = ni(n);
  return n && (Zt(n) === "html" || Zt(n) === "body" && re(n).position === "static") ? e : n || jw(t) || e;
}
function Ko(t) {
...
function Is(t) {
  return ["html", "body", "#document"].indexOf(Zt(t)) >= 0 ? t.ownerDocument.body : Ft(t) && Qo(t) ? t : Is(_r(t));
}
function yn(t, e) {
  var n;
  e === void 0 && (e = []);
...
function ai(t, e, n) {
  return e === Ss ? uo(Jw(t, n)) : Ce(e) ? Qw(e, n) : uo(Zw(pe(t)));
}
function tf(t) {
  var e = yn(_r(t)), n = ["absolute", "fixed"].indexOf(re(t).position) >= 0, r = n && Ft(t) ? Mn(t) : t;
...
const Mf = () => Bo({
  ...
  } = e, g = Et(e, _f), k = B.useRef(null), T = Se(k, n), C = B.useRef(null), S = Se(C, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
...
`));
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, T = Et(e, Pf), [C, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
...
const Lf = {
  ...
  } = e, k = Et(e, Ff), T = fn(), C = B.useRef(), S = As(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
const Gf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Uf = In(Ms, {
  ...
  const o = ys(), a = Yo({
    ...
    slots: C,
    slotProps: S
  } = a, v = Et(a, Gf), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const js = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = Yo({
    ...
    TransitionProps: kt
  } = P, V = Et(P, Yf), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
...
`));
  ...
  const Ir = ps(x), nn = B.useRef(), Vn = lo(() => {
...
`));
  const rl = B.useMemo(() => {
    ...
    touch: we.current
  }), Dr = qf(an), pa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : Wf, ua = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : ir, wa = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : Kf, fa = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : Jf, ol = mn(pa, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
...
const An = sr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Ol, { size: 35, className: y("tw-animate-spin", t), ...e, ref: n }));
...
function pm({
  ...
  if (Zl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, p) => {
    var h, b, m, g;
    d.preventDefault();
    ...
    return /* @__PURE__ */ i(Ls, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, p]) => typeof d == "boolean" || typeof p == "boolean" ? 0 : d.order - p.order).map(([d, p]) => /* @__PURE__ */ N(am, { children: [
      /* @__PURE__ */ i(Gs, { ref: l(d), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ i(Ys, { children: Ws(t.groups, t.items, d, e) })
    ] }, d)) });
}
function yh({
  menuData: t,
...
Sm.displayName = no.Root.displayName;
...
function kh({
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(An, { size: 15 }) : /* @__PURE__ */ N(oe, { children: [
