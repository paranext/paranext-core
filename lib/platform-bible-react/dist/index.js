...
var Nt = (t, e, r) => li(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Slot as ke, Dialog as Jt, Popover as rr, Label as ui, RadioGroup as ra, Tooltip as Le, ToggleGroup as Io, Separator as pi, Avatar as ya, DropdownMenu as vt, Select as Et, Checkbox as qa, Tabs as Kt, Menubar as ee, ContextMenu as bt, Progress as Ha, Slider as pr, Switch as Wa } from "radix-ui";
import { cva as re } from "class-variance-authority";
import { IconX as gi, IconCheck as Me, IconSearch as hi, IconChevronRight as ka, IconChevronDown as fi, IconChevronUp as mi, IconSelector as vi, IconLayoutSidebar as bi, IconLayoutSidebarRight as xi, IconLoader as yi, IconAlertOctagon as ki, IconAlertTriangle as _i, IconInfoCircle as Ni, IconCircleCheck as Ci } from "@tabler/icons-react";
import { Canon as lt } from "@sillsdev/scripture";
import { includes as gr, Section as Y, getChaptersForBook as Ei, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as zi, formatReplacementString as ie, sanitizeHtml as Ti, NumberFormat as Si, formatBytes as Di, getCurrentLocale as Ri, usfmMarkers as xr, getFormatCallerFunction as $i, deepEqual as Mi, isString as Ya, compareScrRefs as aa, scrRefToBBBCCCVVV as Fr, getLocalizeKeyForScrollGroupId as Z } from "platform-bible-utils";
import { Check as nr, Clock as Xa, ChevronsLeft as Ja, ChevronsRight as Za, ChevronLeft as oa, ChevronRight as na, ArrowLeft as Oi, ArrowRight as Ai, ChevronDown as Mr, BoldIcon as Ii, ItalicIcon as Pi, X as Or, AtSign as Po, Pencil as Li, Trash2 as Vi, ArrowUp as Lo, MoreHorizontal as ji, MailOpen as Fi, Mail as Bi, ChevronUp as Ui, FilterIcon as Ki, ArrowLeftIcon as Gi, ChevronLeftIcon as qi, ChevronRightIcon as Hi, ArrowRightIcon as Wi, Copy as Vo, Filter as Yi, User as Xi, Link as Ji, CircleHelp as Zi, ChevronsUpDown as jo, Star as Qi, Undo as ts, Redo as es, SquareX as Fo, FunctionSquare as Bo, SquareSigma as Uo, Ban as rs, AlertCircle as ia, CircleCheckIcon as as, CircleXIcon as os, CircleHelpIcon as ns, ArrowUpIcon as is, ArrowDownIcon as ss, Search as ls, LoaderCircle as cs, CheckIcon as ds, ScrollText as ws, MenuIcon as us, Menu as ps, EllipsisVertical as gs, MoreVertical as Qa } from "lucide-react";
import et, { forwardRef as ir, useRef as G, useMemo as P, useState as T, useCallback as j, useLayoutEffect as At, createContext as Ar, useContext as _a, useEffect as K, Component as hs, createElement as to, Suspense as fs, Fragment as Ko } from "react";
import { createEditor as Go, $getRoot as ce, $createParagraphNode as We, $getSelection as Tt, HISTORY_MERGE_TAG as Na, ParagraphNode as qo, TextNode as Ho, $isTokenOrSegmented as ms, $getCharacterOffsets as vs, $cloneWithPropertiesEphemeral as bs, $getPreviousSelection as xs, $isRangeSelection as Zt, $caretFromPoint as ys, $getSiblingCaret as Wo, $getChildCaret as ks, $getAdjacentChildCaret as _s, $isChildCaret as Ns, $normalizeCaret as Cs, $setSelectionFromCaretRange as Es, $getCollapsedCaretRange as zs, $getCaretInDirection as eo, $splitAtPointCaretNext as Ts, $isTextPointCaret as Ss, $findMatchingParent as Yo, $isElementNode as se, mergeRegister as de, getDOMTextNode as Ds, isHTMLElement as Xo, CLEAR_EDITOR_COMMAND as Jo, COMMAND_PRIORITY_EDITOR as Ca, shallowMergeConfig as Rs, defineExtension as jt, safeCast as Oe, createState as $s, FORMAT_TEXT_COMMAND as Zo, $isNodeSelection as Qo, COMMAND_PRIORITY_LOW as tn, RootNode as Ms, LineBreakNode as Os, TabNode as As, $isEditorState as Is, createCommand as Ps, CLICK_COMMAND as Ls, isDOMNode as Vs, $getNodeFromDOMNode as js, $createNodeSelection as Fs, $setSelection as Bs, $getEditor as Us, DecoratorNode as sa, $getState as Ks, toggleTextFormatType as ro, TEXT_TYPE_TO_FORMAT as Gs, $setState as qs, addClassNamesToElement as en, $create as Hs, $getNodeByKey as Ws, removeClassNamesFromElement as Ys, KEY_TAB_COMMAND as Xs, $isBlockElementNode as Nr, $createRangeSelection as Js, $normalizeSelection__EXPERIMENTAL as Zs, OUTDENT_CONTENT_COMMAND as Qs, INDENT_CONTENT_COMMAND as ao, INSERT_TAB_COMMAND as tl, COMMAND_PRIORITY_CRITICAL as Ea, $isDecoratorNode as el, $isParagraphNode as rl, $isTextNode as Cr, SELECTION_CHANGE_COMMAND as rn, getRegisteredNode as al, isDocumentFragment as oo, isDOMDocumentNode as ol, ArtificialNode__DO_NOT_USE as an, $createLineBreakNode as on, $isRootOrShadowRoot as nl, isBlockDomNode as no, isInlineDomNode as io, $insertNodes as il } from "lexical";
import { HeadingNode as sl, QuoteNode as ll, registerRichText as cl } from "@lexical/rich-text";
...
import { useReactTable as sn, getFilteredRowModel as pl, getSortedRowModel as ln, getPaginationRowModel as gl, getCoreRowModel as cn, flexRender as tr, getGroupedRowModel as hl, getExpandedRowModel as fl } from "@tanstack/react-table";
import ml from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as la, HIDDEN_NOTE_CALLER as ca, getDefaultViewOptions as vl, isInsertEmbedOpOfType as hr, Editorial as bl } from "@eten-tech-foundation/platform-editor";
...
const Ye = 250, dn = 300, El = 400, zl = 450, Tl = 500, wn = re(
...
re("tw:flex tw:items-center tw:gap-2 tw:text-sm tw:shadow-none", {
  variants: {
    size: {
...
function lr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Ol, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        $e.Input,
        {
      ...
      /* @__PURE__ */ a(Il, { children: /* @__PURE__ */ a(hi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const gn = lt.allBookIds.filter(
  (t) => !lt.isObsolete(lt.bookIdToNumber(t))
), Re = Object.fromEntries(
  gn.map((t) => [t, lt.bookIdToEnglishName(t)])
);
function Ra(t, e, r) {
...
function jl({
  ...
  return /* @__PURE__ */ u(ue, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ a(pe, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(Qt, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      we,
      {
        onSelect: () => h(p),
...
function lo({
  ...
  if (t)
    return /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: Wt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
      we,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function Au({
  ...
  const d = st(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, _] = T("books"), [x, N] = T(void 0), [k, I] = T(!1), O = G(void 0), A = G(void 0), C = G(void 0), z = G(void 0), E = G({}), M = j(
    ($) => {
      e($), l && l($);
    },
    [e, l]
    ...
    ($) => {
      if ($.ctrlKey) return;
      const { isLetter: W, isDigit: Q } = so($.key);
      if (v === "chapters") {
        if ($.key === "Backspace") {
        ...
        if (W || Q) {
          if ($.preventDefault(), $.stopPropagation(), _("books"), N(void 0), Q && x) {
            const ut = Re[x];
            b(`${ut} ${$.key}`);
          } else
            b($.key);
    ...
    const { isLetter: W, isDigit: Q } = so($.key);
    (W || Q) && ($.preventDefault(), b((ut) => ut + $.key), A.current.focus(), I(!1));
  }, []);
  return At(() => {
    const $ = setTimeout(() => {
      if (w && v === "books" && C.current && z.current) {
        const W = C.current, Q = z.current, ut = Q.offsetTop, ot = W.clientHeight, Dt = Q.clientHeight, R = ut - ot / 2 + Dt / 2;
        W.scrollTo({
          top: Math.max(0, R),
          behavior: "smooth"
        }), p(wa(t.book));
      ...
      Ne,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: dt.map(({ onClick: $, disabled: W, title: Q, icon: ut }) => /* @__PURE__ */ a(
              V,
              {
                variant: "ghost",
                size: "sm",
          ...
          !k && /* @__PURE__ */ u(Ce, { ref: C, children: [
            v === "books" && /* @__PURE__ */ u(J, { children: [
              !y && Object.entries(H).map(([$, W]) => {
                if (W.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ a(Qt, { heading: he($), children: W.map((Q) => /* @__PURE__ */ a(
                      hn,
                      {
                        bookId: Q,
                        onSelect: (ut) => ct(ut),
              ...
              y && Wt(y.book) > 1 && /* @__PURE__ */ u(J, { children: [
...
function pa({
  ...
  const [N, k] = T(!1), I = d ?? c, O = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
    const E = c(C), M = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, L = `${z ?? ""}${E}${M ?? ""}`;
    return /* @__PURE__ */ u(
      we,
      {
        value: E,
  ...
  return /* @__PURE__ */ u(ue, { open: N, onOpenChange: k, ...x, children: [
    ...
    /* @__PURE__ */ a(
      pe,
      {
        ...
        children: /* @__PURE__ */ u(Ne, { children: [
          ...
          /* @__PURE__ */ a(Ce, { children: O(e) ? e.map((C) => /* @__PURE__ */ a(Qt, { heading: C.groupHeading, children: C.options.map((z) => A(z, C.groupHeading)) }, C.groupHeading)) : /* @__PURE__ */ a(Qt, { children: e.map((C) => A(C)) }) })
        ] })
      }
    )
  ] });
    ...
    fn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(gt, { className: "tw:flex tw:items-center", children: o.map((v) => lt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            V,
            {
...
const vn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = vn ? At : K, fr = { tag: Na };
function Wl({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: c } = t, d = ql(null, o), w = Go({ editable: t.editable, html: c, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
...
class Zl extends hs {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && Ql(e.resetKeys, n)) {
      var i, s;
...
const ec = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function rc(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function ac() {
  return function(t) {
    const [e] = ae(), r = P(() => t(e), [e, t]), [o, n] = T(() => r.initialValueFn()), i = G(o);
    return ec(() => {
...
function nc(t, e, r = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !ms(e) && o !== null) {
    const [n, i] = o, s = t.isBackward(), l = n.getNode(), c = i.getNode(), d = e.is(l), w = e.is(c);
    if (d || w) {
      const [g, h] = vs(t), p = l.is(c), m = e.is(s ? c : l), b = e.is(s ? l : c);
      let v, _ = 0;
      p ? (_ = g > h ? h : g, v = g > h ? g : h) : m ? (_ = s ? h : g, v = void 0) : b && (_ = 0, v = s ? g : h);
      const x = e.__text.slice(_, v);
      x !== e.__text && (r === "clone" && (e = bs(e)), e.__text = x);
    }
  }
  return e;
}
...
const bn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ic = bn && "documentMode" in document ? document.documentMode : null;
!(!bn || !("InputEvent" in window) || ic) && "getTargetRanges" in new window.InputEvent("input");
function Ht(t) {
  return `${t}px`;
}
const sc = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function lc(t, e, r) {
  let o = null, n = null, i = null, s = [];
  const l = document.createElement("div");
  function c() {
    o === null && Er(182), n === null && Er(183);
    const { left: g, top: h } = n.getBoundingClientRect(), p = oc(t, e);
    var m, b;
    l.isConnected || (b = l, (m = n).insertBefore(b, m.firstChild));
    let v = !1;
    for (let _ = 0; _ < p.length; _++) {
      const x = p[_], N = s[_] || document.createElement("div"), k = N.style;
      ...
      const C = Ht(x.height);
      k.height !== C && (N.style.height = C, v = !0), N.parentNode !== l && (l.append(N), v = !0), s[_] = N;
    }
  ...
  const w = t.registerRootListener(function g() {
    ...
    d(), o = h, n = p, i = new MutationObserver((m) => {
      ...
      if (b !== o || v !== n) return g();
      for (const _ of m) if (!l.contains(_.target)) return c();
    }), i.observe(p, sc), c();
  });
  return () => {
    w(), d();
...
function dc(t, e = cc) {
  ...
  function d(w) {
    w.read(() => {
      const g = Tt();
      if (!Zt(g)) return r = null, n = null, i = null, l = null, c(), void (c = () => {
      });
      const [h, p] = function(C) {
        const z = C.getStartEndPoints();
        return C.isBackward() ? [z[1], z[0]] : z;
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, _ = p.getNode(), x = _.getKey(), N = p.offset, k = t.getElementByKey(b), I = t.getElementByKey(x), O = r === null || k !== o || v !== n || b !== r.getKey(), A = i === null || I !== s || N !== l || x !== i.getKey();
      if ((O || A) && k !== null && I !== null) {
        const C = function(z, E, M, L, q, D, H) {
          const y = (z._window ? z._window.document : document).createRange();
          return y.setStart(...co(E, M, L)), y.setEnd(...co(q, D, H)), y;
        }(t, h, m, k, p, _, I);
        c(), c = lc(t, C, e);
      }
      r = m, o = k, n = v, i = _, s = I, l = N;
    });
  }
...
function wc(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = dc(t, e));
  };
...
function pc(t) {
  const e = Tt() || xs();
  let r;
  if (Zt(e)) r = ys(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (r = Wo(l, "next"));
    }
    r = r || ks(ce(), "previous").getFlipped().insert(We());
  }
  const o = gc(t, r), n = _s(o), i = Ns(n) ? Cs(n) : o;
  return Es(zs(i)), t.getLatest();
}
function gc(t, e, r) {
  let o = eo(e, "next");
  for (let n = o; n; n = Ts(n, r)) o = n;
  return Ss(o) && Er(283), o.insert(t.isInline() ? We().append(t) : t), eo(Wo(t.getLatest(), "next"), e.direction);
}
function hc(t) {
  const e = Tt();
  if (!Zt(e)) return !1;
...
const fc = Symbol.for("preact-signals");
function Pr() {
...
let zr, le = 0, Tr = 0, vc = 0, ha = 0, yr = 0;
function uo(t) {
  if (X === void 0) return;
  let e = t.n;
...
function Te(t, e) {
  Ct.call(this, void 0), this.x = t, this.s = void 0, this.g = yr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function bc(t, e) {
  return new Te(t, e);
}
...
Ct.prototype.brand = fc, Ct.prototype.h = function() {
  return !0;
...
function _n() {
  const t = ce(), e = Tt(), r = We();
  t.clear(), t.append(r), e !== null && r.select(), Zt(e) && (e.format = 0);
}
function Nn(t, e = _n) {
  return t.registerCommand(Jo, (r) => (t.update(e), !0), Ca);
}
jt({ build: (t, e, r) => Xe(e), config: Oe({ $onClear: _n }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return te(() => Nn(t, o.value));
} });
function yc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Gr = $s("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Cn extends sa {
  $config() {
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [Cn], register: (t, e, r) => t.registerCommand(Zo, (o) => {
  const n = Tt();
  if (Qo(n) || Zt(n)) for (const i of n.getNodes()) kc(i) && i.toggleFormat(o);
  return !1;
}, tn) });
function En(t, e) {
  let r;
...
const fa = jt({ build: (t) => En(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const zc = jt({ config: Oe({ setOptions: go, updateOptions: go }), init: ({ $initialEditorState: t = Ec }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Ms, Ho, Os, As, qo] }), ho = Symbol.for("@lexical/extension/LexicalBuilder");
function fo() {
}
function Tc(t) {
  throw t;
...
class je {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && tt(298, o.name), !n) {
      n = new Cc(this, o), this.extensionNameMap.set(o.name, n);
...
const Sc = /* @__PURE__ */ new Set(), mo = jt({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const l = bc(() => (i.value || Sc).has(s)), { watchedNodeKeys: c } = n.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), n.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), Dc = Ps("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
...
jt({ dependencies: [fa, mo], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return de(t.registerCommand(Dc, (s) => {
    ...
    return !0;
  }, Ca), t.registerCommand(Ls, (s) => {
    if (Vs(s.target)) {
      const l = js(s.target);
      if ($c(l)) return function(c, d = !1) {
        const w = Tt(), g = c.isSelected(), h = c.getKey();
        let p;
        d && Qo(w) ? p = w : (p = Fs(), Bs(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
    ...
    const s = [];
    for (const { domNode: l, selectedSignal: c } of n.value.nodeSelections.values()) s.push(te(() => {
      const d = l.value;
      d && (c.value ? en(d, i) : Ys(d, i));
    }));
    return de(...s);
  }));
} });
...
function Mc(t, e, r = Dn) {
  return de(t.registerCommand(Xs, (o) => {
    const n = Tt();
    if (!Zt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Nr(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), g = uc(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Js();
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: Dn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return te(() => {
    if (!o.value) return Mc(t, n, i);
  });
} });
const Oc = jt({ name: "@lexical/react/ReactProvider" });
function Ac() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Zt(m)) {
                const b = m.anchor;
                let v = b.getNode(), _ = 0, x = 0;
                if (Cr(v) && d >= 0 && w >= 0 && (_ = d, x = d + w, m.setTextNodeRange(v, _, v, x)), _ === x && g === "" || (m.insertRawText(g), v = b.getNode()), Cr(v)) {
                  _ = h, x = h + p;
                  const N = v.getTextContentSize();
                  _ = _ > N ? N : _, x = x > N ? N : x, m.setTextNodeRange(v, _, v, x);
                }
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => te(() => r.getOutput().disabled.value ? void 0 : $n(t)) });
function Lc(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Pa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
  ...
  return function(r, o) {
    ...
    return Pa(() => r.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = a(o, { onError: (h) => r._onError(h), children: a(fs, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(wl(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function jc({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Oc.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Lc(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Vc, { editor: t, ErrorBoundary: e });
}
function vo(t) {
  return t.getEditorState().read(Rn(t.isComposing()));
}
function Fc({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = ae();
  return function(n) {
    Pa(() => de(cl(n), $n(n)), [n]);
  }(o), u(J, { children: [t, a(Bc, { content: e }), a(jc, { editor: o, ErrorBoundary: r })] });
}
...
const Kc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function Gc({ onClear: t }) {
  const [e] = ae();
  return Kc(() => Nn(e, t), [e, t]), null;
}
const Mn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function qc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: _ = !0, style: x, tabIndex: N, "data-testid": k, ...I }, O) {
  const [A, C] = T(t.isEditable()), z = j((M) => {
    M && M.ownerDocument && M.ownerDocument.defaultView ? t.setRootElement(M) : t.setRootElement(null);
  }, [t]), E = P(() => /* @__PURE__ */ function(...M) {
    return (L) => {
      for (const q of M) typeof q == "function" ? q(L) : q != null && (q.current = L);
    };
  }(O, z), [z, O]);
  return Mn(() => (C(t.isEditable()), t.registerEditableListener((M) => {
    C(M);
  })), [t]), a("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? r : "none", "aria-controls": A ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": A && v === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": d, "aria-multiline": w, "aria-owns": A ? g : void 0, "aria-readonly": !A || void 0, "aria-required": h, autoCapitalize: p, className: m, contentEditable: A, "data-testid": k, id: b, ref: E, role: v, spellCheck: _, style: x, tabIndex: N, ...I });
}
const Hc = ir(qc);
function bo(t) {
  return t.getEditorState().read(Rn(t.isComposing()));
...
function Yc(t, e) {
  ...
  return u(J, { children: [a(Hc, { editor: n, ...o, ref: e }), r != null && a(Xc, { editor: n, content: r })] });
}
function Xc({ content: t, editor: e }) {
  const r = function(s) {
    const [l, c] = T(() => bo(s));
    return Mn(() => {
      function d() {
...
function Qc() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Dl, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ml, { children: [
...
function td({
  ...
  const [e] = ae(), [r, o] = T(e), [n, i] = T("paragraph"), [s, l] = Qc(), c = () => {
  };
...
function nd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(td, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(ad, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Fc,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Jc, { placeholder: t }) }),
          ErrorBoundary: tc
        }
      ),
      e && /* @__PURE__ */ a(Uc, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ a(
          Wl,
          {
            ...
            children: /* @__PURE__ */ u(It, { children: [
              /* @__PURE__ */ a(nd, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Xl,
                {
...
function sd(t, e) {
  const r = ol(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function Ln(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && Cr(e) && (s = nc(o, e, "clone"));
  const l = se(s) ? s.getChildren() : [], c = al(t, s.getType());
  let d;
...
function jn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  const c = function(m, b) {
    const { nodeName: v } = m, _ = b._htmlConversions.get(v.toLowerCase());
    let x = null;
    if (_ !== void 0) for (const N of _) {
      const k = N(m);
  ...
  let h = [];
  const p = (l == null || !nl(l)) && (l != null && Nr(l) || o);
  for (let m = 0; m < g.length; m++) h.push(...jn(g[m], e, r, p, new Map(n), l));
  return w != null && (h = w(h)), no(t) && (h = cd(t, h, p ? () => {
    const m = new an();
    return r.push(m), m;
...
function dd(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = sd(e, n);
      ce().clear(), il(i);
    },
    {
      discrete: !0
...
function ju({
  ...
  const [i, s] = T(ud), [l, c] = T(n), [d, w] = T(!1), g = G(void 0), h = G(null);
  K(() => {
    let v = !0;
    const _ = h.current;
    if (!_) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : ja(v) && (v.preventDefault(), v.stopPropagation(), Ot(i) && p());
        },
        onKeyDown: (v) => {
...
const Fu = Object.freeze([
...
], pd = ["input", "select", "textarea", "button"], gd = ["button", "textbox"], hd = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
  ...
  const n = G(null), [i, s] = T(void 0), [l, c] = T(void 0), d = j(
    ...
    if (p.isContentEditable || pd.includes(m)) return !0;
    const b = p.getAttribute("role");
    if (b && gd.includes(b)) return !0;
    const v = p.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = j(
    (p) => {
      var A;
      const m = p.target, b = (C) => C ? document.getElementById(C) : void 0, v = b(l), _ = b(i);
...
function Ed({ className: t, children: e, ...r }) {
  const o = st();
  return /* @__PURE__ */ a(
    vt.SubContent,
    {
...
function ko({
  ...
  }, [t.date, r]), v = P(() => t.user, [t.user]), _ = P(
    () => t.user.split(" ").map((k) => k[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), x = P(() => Ti(t.contents), [t.contents]), N = P(() => {
    if (o && l)
      return /* @__PURE__ */ u(J, { children: [
        /* @__PURE__ */ u(
          va,
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(dd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(bd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(xd, { className: "tw:text-xs tw:font-medium", children: _ }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), p()) : ja(k) && (k.preventDefault(), k.stopPropagation(), Ot(w) && m());
              },
              onKeyDown: (k) => {
        ...
        N && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ji, {}) }) }),
...
function zd({
  ...
  const [C, z] = T(_o), [E, M] = T(), [L, q] = T(), D = o, [H, y] = T(!1), [F, ct] = T(!1), [xt, Mt] = T(!1), [dt, St] = T(!1), [U, nt] = T(!1), [at, wt] = T(k), [zt, he] = T(!1), yt = G(void 0), [fe, oe] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
      const ft = x ? await x(c) : !1;
      S && nt(ft);
    })(), () => {
      S = !1;
    };
    ...
    let S = !0;
    if (!o) {
      St(!1), oe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const ft = _ ? await _(c) : !1;
      S && St(ft);
    })(), () => {
      S = !1;
    };
  ...
  const ne = P(() => Ft[0], [Ft]), $ = G(null), W = G(void 0), Q = j(() => {
    var S;
    (S = W.current) == null || S.call(W), z(_o);
  }, []), ut = j(() => {
    const S = !at;
    wt(S), he(!S), m == null || m(c, S);
  }, [at, m, c]);
  K(() => {
    y(!1);
  }, [o]), K(() => {
  ...
  const ot = P(
    ...
    () => pt === 1 ? ot.singleReply : ie(ot.multipleReplies, { count: pt }),
    [pt, ot]
  );
  K(() => {
    !o && F && rt && ct(!1);
  ...
  const mt = j(
    async (S) => {
      ...
      ht && await g({ threadId: c, contents: ht }) && Q();
    },
    [
      Q,
      C,
    ...
    async (S) => {
      const ht = Ot(C) ? Dr(C) : void 0, ft = S.status ? S.assignedUser : E ?? S.assignedUser, Bt = await g({
        ...S,
        contents: ht,
        assignedUser: ft
      });
      return Bt && (ft !== void 0 && q(ft), ht && Q()), Bt;
    },
    [Q, C, g, E]
  );
  if (Ft.length !== 0)
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            ...
            /* @__PURE__ */ a(
              ko,
              {
                ...
                handleDeleteComment: p,
                onEditingChange: ct,
                canEditOrDelete: (!F && fe.get(ne.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(J, { children: [
              ...
              it.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                ko,
                {
                  ...
                  handleDeleteComment: p,
                  onEditingChange: ct,
                  canEditOrDelete: (!F && fe.get(S.id)) ?? !1
                }
              ) }, S.id)),
              v !== !1 && (!F || Ot(C)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (S) => {
                    ja(S) && (S.preventDefault(), S.stopPropagation(), (Ot(C) || E !== void 0 && E !== L) && mt());
                  },
                  onKeyDown: (S) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (Ot(C) || E !== L) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ie(
                      ...
                      /* @__PURE__ */ u(ue, { open: xt, onOpenChange: Mt, children: [
                        /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
                          V,
                          {
                            size: "icon",
...
function Yu({
  ...
  const [_, x] = T(/* @__PURE__ */ new Set()), [N, k] = T(), [I, O] = T(), A = j(
    async (y) => {
      const F = await i(y);
  ...
  const C = r.filter(
    ...
    [_, b]
  ), { listboxRef: L, activeId: q, handleKeyDown: D } = hd({
    options: z,
    onOptionSelect: E
  }), H = j(
    (y) => {
      y.key === "Escape" ? (N && _.has(N) && (x((F) => {
        const ct = new Set(F);
...
function qe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Et.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Et.Icon, { asChild: !0, children: /* @__PURE__ */ a(vi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
  ...
  const l = et.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Id(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Ad(l, b, w.key);
...
function Pd({
  ...
  var O;
  const [w, g] = T([]), [h, p] = T([]), [m, b] = T({}), [v, _] = T({}), x = P(() => e ?? [], [e]), N = sn({
    data: x,
    columns: t,
    getCoreRowModel: cn(),
  ...
  let I;
  return c ? I = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(Yt, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Xt, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((O = N.getRowModel().rows) == null ? void 0 : O.length) > 0 ? I = N.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    Yt,
    {
      onClick: () => s(A, N),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((C) => /* @__PURE__ */ a(Xt, { children: tr(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    A.id
  )) : I = /* @__PURE__ */ a(Yt, { children: /* @__PURE__ */ a(Xt, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(Td, { table: N }),
    /* @__PURE__ */ u(dr, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ba, { stickyHeader: i, children: N.getHeaderGroups().map((A) => /* @__PURE__ */ a(Yt, { children: A.headers.map((C) => /* @__PURE__ */ a(Rr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : tr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(V, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Vo, {}) })
        ] }),
...
var jd = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(jd || {});
    ...
    /* @__PURE__ */ a(ye, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(qn, { children: d.itemType === 0 ? /* @__PURE__ */ a(J, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        kd,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(_d, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(cr, {})
    ] }, d.label)) })
...
function np({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(Fd, { versionHistory: n }),
...
function Hn({
  ...
  const [_, x] = T(!1), N = j(
    (E) => {
      var L;
      const M = (L = t.find((q) => q.label === E)) == null ? void 0 : L.value;
      M && r(
    ...
    if (!h) return t;
    const E = t.filter((L) => L.starred).sort((L, q) => L.label.localeCompare(q.label)), M = t.filter((L) => !L.starred).sort((L, q) => {
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(ue, { open: C, onOpenChange: w ?? x, children: [
    ...
    /* @__PURE__ */ a(pe, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
      ...
      /* @__PURE__ */ u(Ce, { children: [
        ...
        /* @__PURE__ */ a(Qt, { children: I.map((E) => /* @__PURE__ */ u(
          we,
          {
            value: E.label,
            onSelect: N,
...
function Ud({
  ...
  const c = P(() => /Macintosh/i.test(navigator.userAgent), []), d = zo(n, "%undoButton_tooltip%"), w = zo(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Va, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(
        V,
...
const Gd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(J, { children: [
...
function qd({
  ...
  const m = (v) => {
    ...
    var _, x, N, k;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((_ = i.current) == null || _.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((x = s.current) == null || x.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((k = s.current) == null || k.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Gd(t, n, r) }) }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ve,
            {
              ...
              onClick: (v) => {
                var _;
                v.stopPropagation(), l.current = !0, (_ = i.current) == null || _.focus();
              },
...
const Hd = (t, e) => t === "f" ? /* @__PURE__ */ u(J, { children: [
  /* @__PURE__ */ a(Bo, {}),
  " ",
...
function Yd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Hd(t, r) }) }) }),
      /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ a("p", { children: Wd(t, r) }) })
    ] }) }),
...
function Jd({ icon: t, className: e }) {
...
function To({
  ...
  return /* @__PURE__ */ u(
    we,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Jd, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
...
function Zd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = T(""), [i, s] = P(() => {
...
function sp({
  ...
  const [m, b] = T("generated"), [v, _] = T("generated"), [x, N] = T("*"), [k, I] = T("*"), [O, A] = T("f"), [C, z] = T(!1), [E, M] = T(!0), [L, q] = T(!1), D = G(!1), H = G(""), [y, F] = T(!1), [ct, xt] = T(), [Mt, dt] = T(), [St, U] = T(), [nt, at] = T(), wt = G(null), zt = P(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...s.view ?? vl(), noteMode: "expanded" }
    }),
    [s, l]
  ), he = P(
    () => Qd(
  ...
  K(() => {
    ...
    if (B && hr("note", B)) {
      ...
      let _t = "custom";
      pt === la ? _t = "generated" : pt === ca ? _t = "hidden" : pt && (N(pt), I(pt)), b(_t), _(_t), A(((it = B.insert.note) == null ? void 0 : it.style) ?? "f"), R = setTimeout(() => {
        var Rt;
  ...
  At(() => {
    (kt.current.book !== n.book || kt.current.chapterNum !== n.chapterNum) && (kt.current = { book: n.book, chapterNum: n.chapterNum }, oe.current());
  }, [n.book, n.chapterNum]);
  const Ft = () => {
    var B;
    ...
    if (B && hr("note", B)) {
      ...
      O !== "x" && R === "x" ? mt == null || mt.forEach(($t) => tw($t)) : O === "x" && R !== "x" && (mt == null || mt.forEach(($t) => ew($t))), (Rt = w.current) == null || Rt.applyUpdate([B, { delete: 1 }]);
    }
  }, Q = (R) => {
      ...
      if (B && hr("note", B)) {
        ...
        if (mt || z(!1), z(
          mt === "x" ? !!($t != null && $t.every((S) => {
            ...
            const ht = ((Bt = S.attributes) == null ? void 0 : Bt.char).style;
  ...
  return /* @__PURE__ */ u(J, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ a(J, { children: aw(t.marker, l, o, d) })
      }
    )
  ] });
}
function cp({
  ...
  const w = c ?? $i(r, void 0), g = (x, N) => {
    d == null || d(x, N, n);
  }, h = i ? r.findIndex((x) => x === i) : -1, [p, m] = T(h), b = (x, N, k) => {
    if (r.length)
      switch (x.key) {
        case "Enter":
        case " ":
          x.preventDefault(), d == null || d(N, k, n);
          break;
      }
  }, v = (x) => {
    if (r.length)
  ...
  return K(() => {
    var x;
    p >= 0 && p < _.current.length && ((x = _.current[p]) == null || x.focus());
  }, [p]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function sw({
  ...
  return /* @__PURE__ */ u(dr, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ba, { stickyHeader: !0, children: /* @__PURE__ */ u(Yt, { children: [
    ...
    /* @__PURE__ */ a(wr, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      Yt,
      {
        ...
        children: [
          /* @__PURE__ */ a(Xt, { children: De(l.reference, "English") }),
          /* @__PURE__ */ a(Xt, { className: o, children: iw(l.text) })
        ]
      },
...
const lw = (t) => {
...
}, Vr = (t, e, r) => /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
  /* @__PURE__ */ u(
    Lt,
    {
  ...
  return e ? e[1] : "";
}, dw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fp = Object.freeze([
...
function mp({
  ...
  const p = Gt(r, "%webView_inventory_all%"), m = Gt(r, "%webView_inventory_approved%"), b = Gt(r, "%webView_inventory_unapproved%"), v = Gt(r, "%webView_inventory_unknown%"), _ = Gt(r, "%webView_inventory_scope_currentBook%"), x = Gt(r, "%webView_inventory_scope_chapter%"), N = Gt(r, "%webView_inventory_scope_verse%"), k = Gt(r, "%webView_inventory_filter_text%"), I = Gt(
    r,
    "%webView_inventory_show_additional_items%"
  ), O = Gt(r, "%webView_inventory_no_results%"), [A, C] = T(!1), [z, E] = T("all"), [M, L] = T(""), [q, D] = T([]), H = P(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : uw(U, n, i);
  }, [t, n, i]), y = P(() => {
    if (A) return H;
    const U = [];
    return H.forEach((nt) => {
  ...
  }, [A, H]), F = P(() => y.length === 0 ? [] : ww(y, z, M), [y, z, M]), ct = P(() => {
    var at, wt;
    if (!A) return c;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(Ke, { onValueChange: (U) => Mt(U), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(He, { children: [
          /* @__PURE__ */ a(Ut, { value: "book", children: _ }),
...
const Ka = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(cs, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Do({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(J, { children: [
      ...
      /* @__PURE__ */ a(dr, { children: /* @__PURE__ */ a(wr, { children: e.map((n) => /* @__PURE__ */ u(Yt, { className: "tw:cursor-pointer", onClick: () => o(n.id), children: [
        /* @__PURE__ */ a(Xt, { className: "tw:border-0", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
          n.id === r && /* @__PURE__ */ a(ds, { className: "tw:h-4 tw:w-4 tw:shrink-0", "aria-label": "current project" }),
        ...
        n.language && /* @__PURE__ */ a(Xt, { className: "tw:border-0 tw:text-right tw:text-sm tw:text-muted-foreground", children: n.language })
      ] }, n.id)) }) })
    ] });
}
function bp({
...
function Zr({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(J, { children: [
      /* @__PURE__ */ a(gt, { className: "tw:text-xs tw:uppercase tw:tracking-wider tw:text-muted-foreground", children: t }),
      /* @__PURE__ */ a(dr, { children: /* @__PURE__ */ a(wr, { children: e.map((n) => /* @__PURE__ */ u(Yt, { children: [
        /* @__PURE__ */ a(Xt, { className: "tw:border-0", children: /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a("span", { className: "tw:font-medium", children: n.fullName }),
          " (",
        ...
        o && r && /* @__PURE__ */ a(Xt, { className: "tw:border-0 tw:text-right", children: /* @__PURE__ */ a(V, { variant: "outline", onClick: () => o(n), children: r }) })
      ] }, n.dblEntryUid)) }) })
    ] });
}
function gw(t, e) {
...
function yp({
  ...
  const [s, l] = T(""), [c, d] = T([]), w = P(
    () => t.filter((D) => !r || D.type === r).filter((D) => gw(D, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: b, hasMore: v } = pw(p), _ = P(
    () => Array.from(new Set(t.map((D) => D.bestLanguageName))).map((D) => ({
      label: D,
      value: D
    })),
    [t]
  ), x = g.length === 0 && h.length === 0 && p.length === 0, N = qt(n, "%resourcePicker_title%"), k = qt(n, "%resourcePicker_search_placeholder%"), I = qt(n, "%resourcePicker_language_filter_any%"), O = qt(
    n,
    "%resourcePicker_section_already_selected%"
  ), A = qt(n, "%resourcePicker_section_installed%"), C = qt(
    n,
    "%resourcePicker_section_available_to_download%"
  ), z = qt(n, "%resourcePicker_button_use%"), E = qt(n, "%resourcePicker_no_results%"), M = qt(n, "%resourcePicker_showing_count%"), L = P(() => {
    if (c.length === _.length || c.length === 0)
      return I;
    if (c.length === 1) {
      const D = _.find((H) => H.value === c[0]);
      if (D) return D.label;
    }
    return ie(
  ...
  }, [c, _, I, n]), q = s.length > 0 || c.length > 0;
  return /* @__PURE__ */ u(J, { children: [
    ...
    q && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: ie(M, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
...
const hw = "16rem", fw = "3rem", Xn = et.createContext(void 0);
function jr() {
...
function mw({
  ...
  const [c, d] = et.useState(t), w = e ?? c, g = et.useCallback(
    ...
    [r, w]
  ), h = et.useCallback(() => g((N) => !N), [g]), p = w ? "expanded" : "collapsed", v = st() === "ltr" ? s : s === "primary" ? "secondary" : "primary", _ = et.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
  ...
  return /* @__PURE__ */ a(Xn.Provider, { value: _, children: /* @__PURE__ */ a(
    "div",
    {
...
function Nw({
  ...
  const l = t ? ke.Root : "button", { state: c } = jr(), d = /* @__PURE__ */ a(
    l,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(_w({ variant: r, size: o }), i),
      ...s
    }
  );
...
function Cw({
  ...
  return /* @__PURE__ */ a(
    vw,
    {
      ...
      children: /* @__PURE__ */ u(xw, { children: [
        /* @__PURE__ */ u(Ro, { children: [
          /* @__PURE__ */ a($o, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(Mo, { children: /* @__PURE__ */ a(yw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(kw, { children: /* @__PURE__ */ a(
            Nw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const me = "scrBook", Ew = "scrRef", Se = "source", zw = "details", Tw = "Scripture Reference", Sw = "Scripture Book", Jn = "Type", Dw = "Details";
function Rw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? lt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === me ? De(n.start) : void 0;
      },
...
}, Oo = (t) => `${$w({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ip({
  sources: t,
  ...
  const [d, w] = T([]), [g, h] = T([{ id: me, desc: !1 }]), [p, m] = T({}), b = P(
  ...
  K(() => {
    if (l) {
      const z = _.getSelectedRowModel().rowsById, E = Object.keys(z);
      if (E.length === 1) {
        const M = b.find((L) => Oo(L) === E[0]) || void 0;
        M && l(M);
      }
    }
  }, [p, b, l, _]);
  const x = n ?? Sw, N = i ?? Jn, k = [
    ...
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(Sd, { children: k.map((z) => /* @__PURE__ */ a(Ut, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(dr, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ba, { children: _.getHeaderGroups().map((z) => /* @__PURE__ */ a(Yt, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
      ...
      /* @__PURE__ */ a(wr, { children: _.getRowModel().rows.map((z, E) => {
        const M = st();
        return /* @__PURE__ */ a(
          Yt,
          {
...
}), Zn = (t, e, r) => Ga(t, e).every((o) => r.includes(o));
function Mw({
  section: t,
  availableBookIds: e,
  selectedBookIds: r,
...
function Ow({
  ...
  }, [v, _] = T(!1), [x, N] = T(""), k = G(void 0), I = G(!1);
  if (t.length !== lt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const O = P(() => lt.allBookIds.filter(
    ...
    (D) => {
      const H = Ga(O, D).map((y) => y);
      r(
        Zn(O, D, e) ? e.filter((y) => !H.includes(y)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, r, O]
  ), L = () => {
            ...
            Ne,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: L, children: c }),
                  ...
                  Object.values(Y).map((D, H) => {
                    ...
                    if (y.length !== 0)
                      return /* @__PURE__ */ u(Ko, { children: [
                        ...
                        H < Object.values(Y).length - 1 && /* @__PURE__ */ a(un, {})
                      ] }, D);
                  })
                ] })
              ]
...
function Lp({
  ...
  ], _ = e ? v.filter((x) => e.includes(x.value)) : v;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        fn,
        {
          ...
          children: _.map(({ value: x, label: N, id: k }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ua, { className: "tw:me-2", value: x, id: k }),
            /* @__PURE__ */ a(gt, { htmlFor: k, children: N })
          ] }, k))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(gt, { children: b }),
      /* @__PURE__ */ a(
        Ow,
        {
          availableBookInfo: o,
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          He,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((d) => /* @__PURE__ */ a(Ut, { value: `${d}`, children: l[Z(d)] }, `${d}`))
          }
        )
      ]
    }
...
const ti = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ u(Nd, { children: [
    /* @__PURE__ */ a(Cd, { children: l.label }),
    /* @__PURE__ */ a(yd, { children: /* @__PURE__ */ a(Ed, { children: ti(
      t,
      e,
      Qn(t, l.id),
      o
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(us, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(Ko, { children: [
      /* @__PURE__ */ a(qn, { children: /* @__PURE__ */ a(It, { children: ti(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(cr, {})
    ] }, c)) })
  ] });
}
const ei = et.forwardRef(
...
const ri = et.forwardRef(({ className: t, ...e }, r) => {
  const o = st();
  return /* @__PURE__ */ a(
    Kt.Root,
    {
...
ri.displayName = Kt.List.displayName;
const ai = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Kt.List,
  {
    ref: r,
    className: f(
...
ai.displayName = Kt.List.displayName;
const Aw = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Kt.Trigger,
  {
    ref: r,
    ...e,
...
)), oi = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Kt.Content,
  {
    ref: r,
    className: f(
...
oi.displayName = Kt.Content.displayName;
function Gp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ri, { children: [
      /* @__PURE__ */ a(ai, { children: t.map((l) => /* @__PURE__ */ a(Aw, { value: l.value, children: l.value }, l.key)) }),
...
function qw({
  ...
  if (xl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, _;
    w.preventDefault();
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (_ = c.current) == null || _.focus(), Ze(c, [h, p]);
        break;
    }
  }), K(() => {
    ...
    return /* @__PURE__ */ a(Iw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(Pw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(It, { children: ni(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Wp({
  ...
  const d = Hw(
    ...
    var _, x, N, k, I, O;
    const v = b !== m ? ((x = (_ = t[m]) == null ? void 0 : _.uiNames) == null ? void 0 : x[b]) ?? ((k = (N = t[m]) == null ? void 0 : N.uiNames) == null ? void 0 : k.en) : void 0;
  ...
  return /* @__PURE__ */ u("div", { id: c, className: f("pr-twp tw:max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(gt, { className: "tw:font-normal tw:text-muted-foreground", children: ie(d, {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(be, { children: [
              /* @__PURE__ */ a(xe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(V, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Qa, {}) }) }),
...
export {
  ...
  Nw as SidebarMenuButton,
  kw as SidebarMenuItem,
  ...
  Bd as UNDO_REDO_BUTTONS_STRING_KEYS,
  Wp as UiLanguageSelector,
  Ud as UndoRedoButtons,
  ri as VerticalTabs,
