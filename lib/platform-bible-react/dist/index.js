...
var Ht = (t, e, r) => Pi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Me, a as Ba, C as ze, A as pe, P as Pe, b as er, B as Y, d as Ve, e as Le, f as je, h as Te, i as Vi, k as Li, j as ji, E as Fi, l as Ua, r as ye, m as Bi, n as dn, o as ta, p as ea, L as zt, R as Ka, q as Gr, D as Na, s as Ca, t as Ea, u as Ta, T as wn, v as Lr, w as Lt, x as qa, y as jt, z as Ft, F as Bt, G as un, H as Ga, I as Ze, J as Nr, K as Fe, M as Be, N as Ue, S as Cr, O as sr, Q as Ui, U as Sr, V as tr, W as $e, Z as rr, X as Oe, Y as cr, _ as Ha, $ as Ya, a0 as Hr, a1 as Wa, a2 as pn, a3 as Ki, a4 as qi, a5 as Gi, a6 as Sa, a7 as hn, a8 as ra, a9 as gn, aa as Hi, ab as Yi, ac as Wi, ad as Xi, ae as fn, af as Ji, ag as ca, ah as xo, ai as la, aj as Zi, ak as Qi, al as ts, am as es, an as rs, ao as zr, ap as Xa, aq as as, ar as os } from "./resizable-C3AVzTx2.js";
import { as as og, at as ng, au as ig, av as sg, aw as cg, ax as lg, ay as dg, az as wg, aA as ug, aB as pg, aC as hg, aD as gg, aE as fg, aF as mg, aG as vg, aH as bg, aI as xg, aJ as yg, aK as kg, aL as _g, aM as Ng, aN as Cg, aO as Eg, aP as Tg, aQ as Sg } from "./resizable-C3AVzTx2.js";
import { jsx as a, jsxs as u, Fragment as dt } from "react/jsx-runtime";
import { Canon as xt } from "@sillsdev/scripture";
import { Check as Ie, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as za, ChevronRight as Ra, ArrowLeft as ns, ArrowRight as is, ChevronDown as wr, BoldIcon as ss, ItalicIcon as cs, X as Ja, AtSign as mn, Pencil as ls, Trash2 as ds, ArrowUp as vn, MoreHorizontal as ws, MailOpen as us, Mail as ps, ChevronUp as hs, FilterIcon as gs, ArrowLeftIcon as fs, ChevronLeftIcon as ms, ChevronRightIcon as vs, ArrowRightIcon as bs, Copy as bn, Filter as xs, User as ys, Link as ks, CircleHelp as _s, Undo as Ns, Redo as Cs, SquareX as xn, FunctionSquare as yn, SquareSigma as kn, Ban as Es, AlertCircle as Da, CircleCheckIcon as Ts, CircleXIcon as Ss, CircleHelpIcon as zs, ArrowUpIcon as Rs, ArrowDownIcon as Ds, ScrollText as Ms, ChevronsUpDown as Os, MenuIcon as $s, Menu as Is, EllipsisVertical as As, MoreVertical as Ps } from "lucide-react";
import { Section as ut, getChaptersForBook as Vs, formatScrRef as Ce, getSectionForBook as yr, formatRelativeDate as Ls, formatReplacementString as Qe, sanitizeHtml as Za, NumberFormat as _n, formatBytes as js, getCurrentLocale as Fs, usfmMarkers as jr, getFormatCallerFunction as Bs, deepEqual as Us, isString as No, compareScrRefs as Ma, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as Co, formatReplacementStringToArray as Eo, collectUsjMarkers as qs } from "platform-bible-utils";
import Wt, { useRef as B, useMemo as I, useState as N, useCallback as L, useEffect as H, useImperativeHandle as Gs, useLayoutEffect as ae, createContext as Qa, useContext as Nn, Component as Hs, createElement as To, Suspense as Ys, forwardRef as Cn, useId as So, Fragment as aa } from "react";
...
import { createEditor as Sn, $getRoot as Ae, $createParagraphNode as Rr, $getSelection as oe, HISTORY_MERGE_TAG as to, ParagraphNode as zn, TextNode as Rn, $getPreviousSelection as nc, $isRangeSelection as be, $caretFromPoint as ic, $getSiblingCaret as Dn, $getChildCaret as sc, $getAdjacentChildCaret as cc, $isChildCaret as lc, $normalizeCaret as dc, $setSelectionFromCaretRange as wc, $getCollapsedCaretRange as uc, $getCaretInDirection as zo, $splitAtPointCaretNext as pc, $isTextPointCaret as hc, $findMatchingParent as Mn, $isElementNode as Er, mergeRegister as Se, getDOMTextNode as gc, isHTMLElement as fc, CLEAR_EDITOR_COMMAND as On, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as mc, defineExtension as le, safeCast as ar, createState as vc, FORMAT_TEXT_COMMAND as $n, $isNodeSelection as In, COMMAND_PRIORITY_LOW as An, RootNode as bc, LineBreakNode as xc, TabNode as yc, $isEditorState as kc, createCommand as _c, CLICK_COMMAND as Nc, isDOMNode as Cc, $getNodeFromDOMNode as Ec, $createNodeSelection as Tc, $setSelection as Sc, $getEditor as zc, DecoratorNode as Oa, $getState as Rc, toggleTextFormatType as Ro, TEXT_TYPE_TO_FORMAT as Dc, $setState as Mc, addClassNamesToElement as Pn, $create as Oc, $getNodeByKey as $c, removeClassNamesFromElement as Ic, KEY_TAB_COMMAND as Ac, $isBlockElementNode as Pc, $createRangeSelection as Vc, $normalizeSelection__EXPERIMENTAL as Lc, OUTDENT_CONTENT_COMMAND as jc, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as Fc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Bc, $isParagraphNode as Uc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Vn, $insertNodes as Kc } from "lexical";
...
import { Avatar as ao, Select as Xt, Checkbox as Mo, Slot as Dr, Tabs as he, Menubar as ke, ContextMenu as It, Progress as Oo, Slider as Or, Switch as $o } from "radix-ui";
import { useReactTable as jn, getFilteredRowModel as Qc, getSortedRowModel as Fn, getPaginationRowModel as tl, getCoreRowModel as Bn, flexRender as kr, getGroupedRowModel as el, getExpandedRowModel as rl } from "@tanstack/react-table";
import al from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as ol, isInsertEmbedOpOfType as $r, Editorial as nl, getMarkerMenuItems as il, defaultStyleInfo as sl } from "@eten-tech-foundation/platform-editor";
...
function wl({
  ...
  return /* @__PURE__ */ u(Pe, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Ve, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Te, { heading: i, children: t.map((E) => /* @__PURE__ */ u(
      ze,
      {
        onSelect: () => C(E),
...
function pa({
  ...
  const j = ye(), [D, $] = N(!1), [P, S] = N(""), [V, W] = N(""), [k, rt] = N("books"), [F, Z] = N(void 0), [M, O] = N(
    void 0
  ), [J, at] = N(void 0), [At, Mt] = N(!1), Ut = B(null), q = B(!1), nt = B(void 0), pt = B(void 0), ct = B(void 0), ft = B(void 0), Jt = B({}), Nt = B({}), yt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), vt = I(() => o ? o() : Bi, [o]), Zt = I(() => ({
    [ut.OT]: vt.filter((X) => xt.isBookOT(X)),
    [ut.NT]: vt.filter((X) => xt.isBookNT(X)),
    [ut.DC]: vt.filter((X) => xt.isBookDC(X)),
    [ut.Extra]: vt.filter((X) => xt.extraBooks().includes(X))
  }), [vt]), Kt = I(() => Object.values(Zt).flat(), [Zt]), Pt = I(() => {
    if (!V.trim()) return Zt;
    const x = {
      [ut.OT]: [],
      [ut.NT]: [],
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((it) => {
      x[it] = Zt[it].filter((Vt) => Ua(Vt, V, n));
    }), x;
  }, [Zt, V, n]), z = I(
    () => fl(V, Kt, n),
    [V, Kt, n]
  ...
  const Ct = L(() => {
    if (z) {
      const x = z.chapterNum ?? 1, X = z.verseNum ?? 1;
      if (w && ua(z.book, x, X, w))
        return;
      yt({
        book: z.book,
        chapterNum: x,
    ...
    (x) => {
      const X = M ?? (z == null ? void 0 : z.book), it = J ?? (z == null ? void 0 : z.chapterNum);
      !X || !it || (yt({
        book: X,
        chapterNum: it,
        verseNum: x
    ...
    (x) => {
      const X = k === "chapters" ? F : z == null ? void 0 : z.book;
      if (X) {
        if (d && d(X, x) > 1) {
          O(X), at(x), rt("verses"), S("");
          return;
        }
        yt({
          book: X,
    ...
    rt("books"), Z(void 0), O(void 0), at(void 0), setTimeout(() => {
      pt.current && pt.current.focus();
    }, 0);
  }, []), se = L(() => {
    const x = M;
    O(void 0), at(void 0), x ? (Z(x), rt("chapters"), S("")) : Et();
  }, [M, Et]), Ot = L((x) => {
    $(x), x && (rt("books"), Z(void 0), O(void 0), at(void 0), W(""));
  }, []);
  H(() => {
    R && Ot(!1);
  }, [R, Ot]);
  ...
  const { otLong: ie, ntLong: Qt, dcLong: T, extraLong: U } = {
    ...
    () => hl(V),
    [V]
  ), st = I(() => !d || !z || !z.chapterNum || !K ? !1 : d(z.book, z.chapterNum) > 0, [d, z, K]), ht = L(
    (x) => w ? Io(x, w) : !1,
    [w]
  ), gt = L(
    (x) => (X) => w ? gl(x, X, w) : !1,
    ...
    (x, X) => (it) => w ? ua(x, X, it, w) : !1,
    [w]
  ), _t = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", te = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", ge = L(
    (x) => {
    ...
    (x) => {
      var Ne, Re, Ye;
      if (x.ctrlKey) return;
      const { isLetter: X, isDigit: it } = Ao(x.key);
      ...
      if ((k === "chapters" || k === "books" && z) && Vt) {
        const Dt = k === "chapters" ? F : z == null ? void 0 : z.book;
        if (!Dt) return;
        k === "chapters" && ((Ye = nt.current) == null || Ye.focus());
        const Tt = (() => {
          if (!P) return 1;
          const fe = P.match(/(\d+)$/);
    ...
    const { isLetter: X, isDigit: it } = Ao(x.key);
    (X || it) && (x.preventDefault(), W((Ne) => Ne + x.key), pt.current.focus(), Mt(!1));
  }, []);
  return ae(() => {
    const x = setTimeout(() => {
      if (D && k === "books" && ct.current && ft.current) {
        const X = ct.current, it = ft.current, Vt = it.offsetTop, Ne = X.clientHeight, Re = it.clientHeight, Ye = Vt - Ne / 2 + Re / 2;
        X.scrollTo({
          top: Math.max(0, Ye),
          behavior: "smooth"
        }), S(Kn(t.book));
    ...
    if (k === "chapters" && F) {
      const x = F === t.book, X = x ? t.chapterNum : 1;
      S(
        `${F} ${pe[F] || ""} ${X}`
      ), setTimeout(() => {
        if (ct.current)
          if (x) {
            const it = Jt.current[t.chapterNum];
  ...
  }, [k, F, z, t.book, t.chapterNum]), ae(() => {
    if (k === "verses" && M && J !== void 0) {
      const x = M === t.book && J === t.chapterNum, X = x ? t.verseNum : 1;
      S(
        `${M} ${pe[M] || ""} ${J}:${X}`
      ), setTimeout(() => {
        if (ct.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Pe, { open: D, onOpenChange: Ot, modal: C, children: [
    ...
    /* @__PURE__ */ a(
      Ve,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: X } = x;
          D && Ut.current && X instanceof Node && Ut.current.contains(X) && (q.current = !0, Ot(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Le,
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Ge.map(
                  ({ onClick: x, disabled: X, title: it, icon: Vt }) => /* @__PURE__ */ a(
                    Y,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  Y,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: k === "verses" ? se : Et,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: j === "ltr" ? /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                k === "chapters" && F && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Me(F, n) }),
                k === "verses" && M && J !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Me(M, n)} ${J}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: k === "verses" ? te : _t
                  }
                )
              ] }),
              !At && /* @__PURE__ */ u(je, { ref: ct, children: [
                k === "books" && /* @__PURE__ */ u(dt, { children: [
                  !z && Object.entries(Pt).map(([x, X]) => {
                    if (X.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Te, { heading: ot(x), children: X.map((it) => /* @__PURE__ */ a(
                          Un,
                          {
                            bookId: it,
                            onSelect: (Vt) => qe(Vt),
                ...
                k === "verses" && M && J !== void 0 && d && /* @__PURE__ */ a(
                  Vo,
                  {
                    bookId: M,
                    chapterNum: J,
...
function Lo({
  ...
  const [y, R] = N(!1), j = d ?? l, D = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], $ = (P, S) => {
    const V = l(P), W = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, k = `${S ?? ""}${V}${W ?? ""}`;
    return /* @__PURE__ */ u(
      ze,
      {
        value: V,
  ...
  return /* @__PURE__ */ u(Pe, { open: y, onOpenChange: R, ...E, children: [
    /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ u(
      Y,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ve,
      {
        ...
        children: /* @__PURE__ */ u(Le, { children: [
          ...
          /* @__PURE__ */ a(je, { children: D(e) ? e.map((P) => /* @__PURE__ */ a(Te, { heading: P.groupHeading, children: P.options.map((S) => $(S, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(Te, { children: e.map((P) => $(P)) }) })
        ] })
      }
    )
  ] });
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Hn ? ae : H, Ar = { tag: to };
function yl({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = bl(null, o), w = Sn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : H;
...
const Sl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : H;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Rl() {
  return function(t) {
    const [e] = _e(), r = I(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = B(o);
    return Sl(() => {
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = Yn && "documentMode" in document ? document.documentMode : null;
!(!Yn || !("InputEvent" in window) || Ml) && "getTargetRanges" in new window.InputEvent("input");
function ve(t) {
  return `${t}px`;
}
...
function $l(t, e, r) {
  ...
  function l() {
    ...
    for (let C = 0; C < g.length; C++) {
      const E = g[C], y = s[C] || document.createElement("div"), R = y.style;
      R.position !== "absolute" && (R.position = "absolute", m = !0);
      const j = ve(E.left - p);
      R.left !== j && (R.left = j, m = !0);
      const D = ve(E.top - h);
      R.top !== D && (y.style.top = D, m = !0);
      const $ = ve(E.width);
      R.width !== $ && (y.style.width = $, m = !0);
      const P = ve(E.height);
      R.height !== P && (y.style.height = P, m = !0), y.parentNode !== c && (c.append(y), m = !0), s[C] = y;
    }
...
function Al(t, e = Il) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, C = g.getNode(), E = C.getKey(), y = g.offset, R = t.getElementByKey(b), j = t.getElementByKey(E), D = r === null || R !== o || m !== n || b !== r.getKey(), $ = i === null || j !== s || y !== c || E !== i.getKey();
      if ((D || $) && R !== null && j !== null) {
        const P = function(S, V, W, k, rt, F, Z) {
          const M = (S._window ? S._window.document : document).createRange();
          return M.setStart(...jo(V, W, k)), M.setEnd(...jo(rt, F, Z)), M;
        }(t, h, f, R, g, C, j);
        l(), l = $l(t, P, e);
      }
      r = f, o = R, n = m, i = C, s = j, c = y;
    });
  }
...
function Ll(t) {
  const e = oe() || nc();
  let r;
  if (be(e)) r = ic(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Dn(c, "next"));
    }
    r = r || sc(Ae(), "previous").getFlipped().insert(Rr());
  }
...
function jl(t, e, r) {
  ...
  return hc(o) && Yr(283), o.insert(t.isInline() ? Rr().append(t) : t), zo(Dn(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = oe();
  if (!be(e)) return !1;
...
let Wr, Ee = 0, Xr = 0, Kl = 0, Va = 0, Br = 0;
function Bo(t) {
  if (lt === void 0) return;
  let e = t.n;
...
le({ name: "@lexical/extension/DecoratorText", nodes: () => [ti], register: (t, e, r) => t.registerCommand($n, (o) => {
  const n = oe();
  if (In(n) || be(n)) for (const i of n.getNodes()) Yl(i) && i.toggleFormat(o);
  return !1;
}, An) });
function ei(t, e) {
  let r;
...
const co = 0, ja = 1, ai = 2, ma = 3, Pr = 4, or = 5, va = 6, br = 7;
function ba(t) {
  return t.id === co;
}
function oi(t) {
...
function Wl(t) {
  return function(e) {
    return e.id === ja;
  }(t) || wt(305, String(t.id), String(ja)), Object.assign(t, { id: ai });
}
...
const Ql = le({ config: ar({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [bc, Rn, xc, yc, zn] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Go() {
}
function td(t) {
  throw t;
...
class dr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ba(i) || wt(300, s, n || "[unknown]"), ba(c = i) || wt(304, String(c.id), String(co)), i = Object.assign(c, { id: ja }), o.state = i;
...
const ed = /* @__PURE__ */ new Set(), Ho = le({ build(t, e, r) {
...
}, dependencies: [La], name: "@lexical/extension/NodeSelection" }), rd = _c("INSERT_HORIZONTAL_RULE_COMMAND");
class ur extends Oa {
  static getType() {
...
le({ dependencies: [La, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  ...
  return Se(t.registerCommand(rd, (s) => {
    const c = oe();
    if (!be(c)) return !1;
...
function nd(t, e, r = ni) {
  return Se(t.registerCommand(Ac, (o) => {
    const n = oe();
    if (!be(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
const id = le({ name: "@lexical/react/ReactProvider" });
function sd() {
            ...
            t.update(() => {
              ...
              if (be(f)) {
                ...
                if ($a(m) && d >= 0 && w >= 0 && (C = d, E = d + w, f.setTextNodeRange(m, C, m, E)), C === E && p === "" || (f.insertRawText(p), m = b.getNode()), $a(m)) {
                  C = h, E = h + g;
                  const y = m.getTextContentSize();
                  C = C > y ? y : C, E = E > y ? y : E, f.setTextNodeRange(m, C, m, E);
                }
...
const wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : H;
...
const fd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : H;
function md({ onClear: t }) {
  const [e] = _e();
  return fd(() => Qn(e, t), [e, t]), null;
}
const ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ae : H;
function vd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: C = !0, style: E, tabIndex: y, "data-testid": R, ...j }, D) {
...
function Ed({
  ...
  const [e] = _e(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Cd(), l = () => {
  };
...
function hi({
  ...
  return /* @__PURE__ */ u(qa, { children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
...
const Od = "verseText", ap = Object.freeze([
...
function op({
  ...
  const [i, s] = N($d), [c, l] = N(n), [d, w] = N(!1), p = B(void 0), h = B(null);
  H(() => {
    let m = !0;
    const C = h.current;
    if (!C) return;
...
function Zo({
  ...
  const g = L(
    ...
    [t.user]
  ), E = I(() => Za(t.contents), [t.contents]), y = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), R = !!t.conflictResolutionAction && !y, j = I(() => {
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          Ze,
          {
            onClick: (D) => {
              D.stopPropagation(), d(!0), p(Md(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Vd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ld, { className: "tw:text-xs tw:font-medium", children: C }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (D) => {
                D.key === "Escape" ? (D.preventDefault(), D.stopPropagation(), g()) : po(D) && (D.preventDefault(), D.stopPropagation(), ce(w) && f());
              },
              onKeyDown: (D) => {
        ...
        j && /* @__PURE__ */ u(Fe, { children: [
          /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(Y, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ws, {}) }) }),
          /* @__PURE__ */ a(Ue, { align: "end", children: j })
        ] })
      ]
    }
  );
...
function bi({
  ...
  const [k, rt] = N(Qo), [F, Z] = N(), [M, O] = N(), J = o, [at, At] = N(!1), [Mt, Ut] = N(!1), [q, nt] = N(!1), [pt, ct] = N(!1), [ft, Jt] = N(!1), [Nt, yt] = N(R), [vt, Zt] = N(!1), Kt = B(void 0), [Pt, z] = N(/* @__PURE__ */ new Map());
  H(() => {
    let _ = !0;
    return (async () => {
  ...
  H(() => {
    if (!o) {
      bt.current !== "idle" && (Z(void 0), O(void 0), bt.current = "idle");
      return;
    }
    bt.current === "idle" && (bt.current = "pending"), pt ? bt.current === "pending" && $ !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    $ !== i && (Z($), bt.current = "auto-populated") : bt.current === "auto-populated" && (Z(void 0), bt.current = "pending");
  }, [o, $, pt, i]);
  const Ct = I(
    () => P ?? e.filter((_) => !_.deleted),
    [P, e]
  );
  H(() => {
    let _ = !0;
  ...
  const qt = I(() => Ct[0], [Ct]), qe = B(null), de = B(void 0), we = L(() => {
    var _;
    (_ = de.current) == null || _.call(de), rt(Qo);
  }, []), Ge = L(() => {
    const _ = !Nt;
    yt(_), Zt(!_), f == null || f(l, _);
  }, [Nt, f, l]);
  H(() => {
    At(!1);
  }, [o]), H(() => {
    if (o && !Nt && !vt) {
      ...
      return Kt.current = _, () => clearTimeout(_);
    }
  ...
  }, [i, r]), Ot = I(() => Ct.slice(1), [Ct]), Rt = I(() => Ot.length ?? 0, [Ot.length]), ne = I(() => Rt > 0, [Rt]), ie = I(() => at || Rt <= 2 ? Ot : Ot.slice(-2), [Ot, Rt, at]), Qt = I(() => at || Rt <= 2 ? 0 : Rt - 2, [Rt, at]), T = I(
    () => Rt === 1 ? Et.singleReply : Qe(Et.multipleReplies, { count: Rt }),
    [Rt, Et]
  ), U = I(
    () => Qt === 1 ? Et.singleReply : Qe(Et.multipleReplies, { count: Qt }),
    [Qt, Et]
  );
  H(() => {
    !o && Mt && ne && Ut(!1);
  ...
  const ot = L(
    ...
    async (_) => {
      const G = ce(k) ? Zr(k) : void 0, K = _.status ? _.assignedUser : F ?? _.assignedUser, st = await p({
        ..._,
        contents: G,
        assignedUser: K
      });
      return st && (K !== void 0 && O(K), G && we()), st;
    },
    [we, k, p, F]
  );
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            ...
            Qt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                onClick: (_) => {
                  _.stopPropagation(), At(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (_) => {
                  (_.key === "Enter" || _.key === " ") && (_.preventDefault(), _.stopPropagation(), At(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Cr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: U }),
                    at ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            ie.map((_) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Zo,
              {
                comment: _,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Ut,
                canEditOrDelete: (!Mt && Pt.get(_.id)) ?? !1
              }
            ) }, _.id)),
            m !== !1 && (!Mt || ce(k)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (_) => {
                  po(_) && (_.preventDefault(), _.stopPropagation(), (ce(k) || F !== void 0 && F !== M) && ot());
                },
                onKeyDown: (_) => {
                  uo(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Jr,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    F !== void 0 && (ce(k) || F !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Qe(
                    ...
                    /* @__PURE__ */ u(Pe, { open: q, onOpenChange: nt, children: [
                      ...
                      /* @__PURE__ */ a(
                        Ve,
                        {
                          ...
                          align: "end",
                          onKeyDown: (_) => {
                            _.key === "Escape" && (_.stopPropagation(), nt(!1));
                          },
                          children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(je, { children: b == null ? void 0 : b.map((_) => /* @__PURE__ */ a(
                            ze,
                            {
                              onSelect: () => {
                                Z(_ !== i ? _ : void 0), bt.current = "user-selected", O(void 0), nt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Ur(_, r) })
                            },
                            _ || "unassigned"
                          )) }) })
                        }
...
function Bd({
  ...
  }, R = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", j = g ? [
    {
      value: "merge",
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), k = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : W, rt = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: C }) : W : k(M === "reject" ? t.rejectedResultText : t.resultText);
  }, F = (M) => p && M.value === "reject", Z = (M) => {
    const O = f === M.value, J = `${d}-${M.value}`, at = F(M);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          Ka,
          {
            ...
            children: D.map((M) => F(M) ? /* @__PURE__ */ a(Lt, { delayDuration: 0, children: /* @__PURE__ */ u(jt, { children: [
              /* @__PURE__ */ a(Ft, { asChild: !0, children: Z(M) }),
              /* @__PURE__ */ a(Bt, { children: R })
            ] }) }, M.value) : Z(M))
          }
        ),
        /* @__PURE__ */ a(Lt, { delayDuration: 0, children: /* @__PURE__ */ u(jt, { children: [
    ...
    if (e === "Resolved") {
      for (let E = o.length - 1; E >= 0; E -= 1)
        if (o[E].status === "Resolved")
          return mi(o[E].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function Hd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = Gd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function pp({
  ...
  const [E, y] = N(/* @__PURE__ */ new Set()), [R, j] = N(), [D, $] = N(), P = L(
    async (O) => {
      const J = await i(O);
  ...
  H(() => {
    f && (y((O) => new Set(O).add(f)), j(f));
  }, [f]);
  const S = r.filter(
    (O) => O.comments.some((J) => !J.deleted)
  ), V = S.map((O) => ({ id: O.id })), W = L(
    (O) => {
      y((J) => new Set(J).add(O.id)), j(O.id), b == null || b(O.id);
    },
    [b]
  ), k = L(
    (O) => {
      ...
      }), j(O), b == null || b(J ? void 0 : O);
    },
    [E, b]
  ), { listboxRef: rt, activeId: F, handleKeyDown: Z } = Ui({
    options: V,
    onOptionSelect: W
  }), M = L(
    (O) => {
      O.key === "Escape" ? (R && E.has(R) && (y((J) => {
        const at = new Set(J);
        return at.delete(R), at;
      }), j(void 0), b == null || b(void 0)), O.preventDefault(), O.stopPropagation()) : Z(O);
    },
    [R, E, Z, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: S.map((O) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: O.type === "Conflict" ? /* @__PURE__ */ a(Hd, { ...J, conflictResolution: C }) : /* @__PURE__ */ a(bi, { ...J })
          },
          O.id
        );
      })
...
function Yd({ table: t }) {
  return /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(Y, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function gr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Xt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Xt.Icon, { asChild: !0, children: /* @__PURE__ */ a(En, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Qd({
  ...
  var D;
  const [w, p] = N([]), [h, g] = N([]), [f, b] = N({}), [m, C] = N({}), E = I(() => e ?? [], [e]), y = jn({
    data: E,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  }), R = y.getVisibleFlatColumns();
  let j;
  return l ? j = Array.from({ length: 10 }).map((S, V) => `skeleton-row-${V}`).map((S) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: R.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((D = y.getRowModel().rows) == null ? void 0 : D.length) > 0 ? j = y.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    Oe,
    {
      onClick: () => s($, y),
    ...
    $.id
  )) : j = /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Yd, { table: y }),
    /* @__PURE__ */ u(Ha, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ya, { stickyHeader: i, children: y.getHeaderGroups().map(($) => /* @__PURE__ */ a(Oe, { children: $.headers.map((P) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : kr(P.column.columnDef.header, P.getContext()) }, P.id)) }, $.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(Y, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(bn, {}) })
        ] }),
...
function bp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(Y, { variant: "default", children: [
...
function nw(t, e, r) {
  var o;
  return xi(t) || t.key === "Shift" || t.key === "Control" || t.key === "Alt" || t.key === "Meta" ? "passed" : t.ctrlKey || t.metaKey || t.altKey ? (r.dismiss(), "ended") : t.key === "ArrowDown" || t.key === "ArrowUp" ? (nr(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue") : t.key === "Enter" ? (nr(t), r.commit(), "ended") : t.key === "Escape" ? (nr(t), r.dismiss(), "ended") : e.kind === "backslash" && (t.key === " " || t.key === "*") ? t.key === " " && ((o = e.shouldSpaceCommit) != null && o.call(e, e.filter)) ? (nr(t), r.commit(), "ended") : (r.dismiss(), "ended") : e.kind === "backslash" && t.key === "Backspace" && e.filter === "" ? (r.dismiss(), "ended") : t.key === "Backspace" || ow[e.kind].test(t.key) ? (e.kind !== "backslash" && nr(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && nr(t), r.dismiss(), "ended");
}
function en(t, e) {
  var r;
...
function sw({
  ...
  return /* @__PURE__ */ u(qa, { children: [
    ...
    e && /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(
        Y,
        {
          "aria-label": w,
...
function dw({
  ...
  const i = B(null), s = B(null), c = B(!1), [l, d] = N(t), [w, p] = N(r), [h, g] = N(!1);
  H(() => {
    d(t);
  }, [t]), H(() => {
    w !== r && p(r);
  ...
  const f = (m) => {
    ...
    var C, E, y, R;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((E = s.current) == null || E.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((y = i.current) == null ? void 0 : y.selectionStart) === 0 && ((R = s.current) == null || R.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Fe, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(Y, { variant: "outline", className: "tw:h-6", children: lw(t, n, r) }) }) }),
...
function pw({
  ...
  return /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(Y, { variant: "outline", className: "tw:h-6", children: ww(t, r) }) }) }),
...
function _p({
  ...
  var ie, Qt;
  const p = B(null), h = B(null), g = B(null), f = B(null);
  ae(() => {
    if (!f.current) return;
    const { width: T } = f.current.getBoundingClientRect();
    T > 0 && (f.current.style.width = `${T}px`);
  }, []);
  const [b, m] = N("generated"), [C, E] = N("generated"), [y, R] = N("*"), [j, D] = N("*"), [$, P] = N("f"), [S, V] = N(!1), [W, k] = N(!0), [rt, F] = N(!1), Z = B(!1), M = B(""), [O, J] = N(!1), [at, At] = N(), [Mt, Ut] = N(), [q, nt] = N(), [pt, ct] = N(), ft = B(null), Jt = B(void 0), Nt = B(0), yt = B(void 0), vt = I(
    () => ({
      ...s,
    ...
    [s, c]
  ), Zt = B((ie = vt.view) == null ? void 0 : ie.markerMode);
  ae(() => {
    var T;
    Zt.current = (T = vt.view) == null ? void 0 : T.markerMode;
  });
  const Kt = I(
    () => vw(
      p,
  ...
  const Pt = L(() => {
    var Q, tt, _;
    const T = (Q = h.current) == null ? void 0 : Q.querySelector(".editor-input"), U = T == null ? void 0 : T.querySelector("span.note"), ot = (_ = (tt = h.current) == null ? void 0 : tt.ownerDocument.getSelection()) == null ? void 0 : _.anchorNode;
    return !!U && !!ot && U.contains(ot);
  }, []);
  H(() => {
    var tt, _;
    let T, U, ot;
    Z.current = !1, yt.current = void 0, k(!0);
    const Q = e == null ? void 0 : e.at(0);
    if (Q && $r("note", Q)) {
      const G = (tt = Q.insert.note) == null ? void 0 : tt.caller;
      let K = "custom";
      G === Ia ? K = "generated" : G === Aa ? K = "hidden" : G && (R(G), D(G)), m(K), E(K), P(((_ = Q.insert.note) == null ? void 0 : _.style) ?? "f"), T = setTimeout(() => {
        var ht, gt, kt;
        const st = Zt.current === "editable" ? [{ retain: _w }, Q] : [Q];
        (ht = p.current) == null || ht.applyUpdate(st), (gt = p.current) == null || gt.selectNote(0), (kt = p.current) == null || kt.focus(), U = requestAnimationFrame(() => {
          ot = setTimeout(() => {
            var _t, te;
            Pt() || ((_t = p.current) == null || _t.selectNote(0), (te = p.current) == null || te.focus());
          }, 0);
        });
      }, 0);
    }
  ...
  const z = L(
    (T, U, ot = !1) => {
      var tt, _, G;
      const Q = (_ = (tt = p.current) == null ? void 0 : tt.getNoteOps(0)) == null ? void 0 : _.at(0);
      if (Q && $r("note", Q)) {
        if (Q.insert.note) {
          let K;
    ...
    var T;
    Jt.current || (T = p.current) == null || T.commitPendingMarkerEdits(), z(b, y, !0), o();
  }, [b, y, o, z]), Ct = B(bt);
  ae(() => {
    Ct.current = bt;
  });
  ...
  const qe = () => {
    ...
    if (U && $r("note", U)) {
      ...
      const K = (_ = (tt = U.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : _.ops;
      $ !== "x" && T === "x" ? K == null || K.forEach((st) => xw(st)) : $ === "x" && T !== "x" && (K == null || K.forEach((st) => yw(st))), (G = p.current) == null || G.applyUpdate([U, { delete: 1 }]);
    }
  }, Et = (T) => {
    ...
    (T) => {
      ...
      if (U && $r("note", U)) {
        ...
        const K = (tt = U.insert.note) == null ? void 0 : tt.style, st = (G = (_ = U.insert.note) == null ? void 0 : _.contents) == null ? void 0 : G.ops;
        if (K || V(!1), V(
          ...
          Z.current = !0, M.current = JSON.stringify(U), k(!0);
          return;
        }
        k(JSON.stringify(U) === M.current), z(b, y);
      } else
        V(!1), k(!0);
    },
    [b, y, z]
    ...
    (T, U, ot) => {
      ...
      if (!w || !Q) return;
      const { passive: tt, literalPrefixLanded: _ } = ot;
      Nt.current += 1;
      const G = Nt.current;
      Jt.current = {
        kind: tt ? "backslash" : "selection",
        token: G,
        literalPrefixLanded: _,
        filter: "",
        items: U
      }, w.show(U.map(bw), Q, tt).then((K) => {
        var st, ht, gt, kt, _t, te;
        if (en(Jt, G), K !== void 0) {
          if (!((st = p.current) != null && st.getSelection())) {
            const ee = yt.current;
            ee ? (ht = p.current) == null || ht.setSelection(ee) : (gt = p.current) == null || gt.selectNote(0);
          }
          (kt = p.current) == null || kt.focus();
          const ge = U.find((ee) => ee.marker === K);
          ge && ((_t = p.current) == null || _t.applyMarkerMenuSelection(ge, {
            trigger: "backslash",
            literalPrefixLanded: _
          }));
        } else tt || (te = p.current) == null || te.focus();
      }).catch(() => {
        var K;
        en(Jt, G), tt || (K = p.current) == null || K.focus();
      });
    },
    [w]
  );
  H(() => {
    const T = (U) => {
      ...
      const Q = (_ = p.current) == null ? void 0 : _.getSelection();
      Q && (yt.current = Q);
    };
    ...
    if (((Q = vt.view) == null ? void 0 : Q.markerMode) === "editable") {
      const tt = (G) => {
        ...
        const K = Jt.current;
        if (K && w) {
          nw(G, K, w) === "ended" && (Jt.current = void 0);
          return;
        }
        if (G.key === "Enter" && !Pt()) {
        ...
        if (!w || G.key !== c) return;
        if (!Pt()) {
          G.preventDefault(), G.stopPropagation(), (te = p.current) == null || te.selectNote(0), (ge = p.current) == null || ge.focus();
          return;
        }
        const st = (ee = p.current) == null ? void 0 : ee.getMarkerMenuContext();
        if (!st) return;
        const ht = il(vt.styleInfo ?? sl, st);
      ...
      return document.addEventListener("keydown", tt, { capture: !0 }), document.addEventListener("paste", _, { capture: !0 }), () => {
        document.removeEventListener("keydown", tt, { capture: !0 }), document.removeEventListener("paste", _, { capture: !0 });
      };
    }
    const U = (tt) => {
      !O && T && document.activeElement === T && tt.key === c ? (tt.preventDefault(), Ot()) : O && tt.key === "Escape" && (tt.preventDefault(), J(!1));
    };
    ...
    Ot,
    c,
    (Qt = vt.view) == null ? void 0 : Qt.markerMode,
    vt.styleInfo,
    w,
    Rt,
    Pt
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
              /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(
                Y,
                {
                  "aria-label": ne,
  ...
  return /* @__PURE__ */ u(dt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(dt, { children: Nw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Cp({
  ...
  const w = l ?? Bs(r, void 0), p = (y, R) => {
    d == null || d(y, R, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = N(h), b = (y, R, j) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), d == null || d(R, j, n);
          break;
      }
  }, m = (y) => {
    if (r.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), f((R) => Math.min(R + 1, r.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), f((R) => Math.max(R - 1, 0));
          break;
      }
  }, C = B([]);
  H(() => {
  ...
  const E = i ? r.findIndex((y) => y === i) : -1;
  return H(() => {
    var y;
    E < 0 || E >= C.current.length || (y = C.current[E]) == null || y.scrollIntoView({ block: "nearest" });
  }, [E]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Ew,
                      {
                        footnote: y,
                        layout: o,
                        formatCaller: () => w(y.caller, R),
                        showMarkers: s
                      }
                    )
                  }
                ),
                R < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Cr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, D)
            );
          })
        }
    ...
    /* @__PURE__ */ a(Wa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { className: o, children: Tw(c.text) })
        ]
      },
...
const zw = (t) => {
...
}, ia = (t, e, r) => /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
  /* @__PURE__ */ u(
    Ft,
    {
  ...
  return e ? e[1] : "";
}, Dw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Mp = Object.freeze([
...
function Op({
  ...
  const g = me(r, "%webView_inventory_all%"), f = me(r, "%webView_inventory_approved%"), b = me(r, "%webView_inventory_unapproved%"), m = me(r, "%webView_inventory_unknown%"), C = me(r, "%webView_inventory_scope_currentBook%"), E = me(r, "%webView_inventory_scope_chapter%"), y = me(r, "%webView_inventory_scope_verse%"), R = me(r, "%webView_inventory_filter_text%"), j = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), D = me(r, "%webView_inventory_no_results%"), [$, P] = N(!1), [S, V] = N("all"), [W, k] = N(""), [rt, F] = N([]), Z = I(() => {
    const q = t ?? [];
    return q.length === 0 ? [] : Ow(q, n, i);
  }, [t, n, i]), M = I(() => {
    if ($) return Z;
    const q = [];
    return Z.forEach((nt) => {
  ...
  }, [$, Z]), O = I(() => M.length === 0 ? [] : Mw(M, S, W), [M, S, W]), J = I(() => {
    var pt, ct;
    if (!$) return l;
  ...
  H(() => {
    O.length === 0 ? F([]) : O.length === 1 && F(O[0].items);
  }, [O]);
  const at = (q, nt) => {
    nt.setRowSelection(() => {
      const ct = {};
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(pr, { onValueChange: (q) => At(q), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(fr, { children: [
          ...
          /* @__PURE__ */ a(ue, { value: "verse", children: y })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ra,
      ...
      o && /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
        /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(zt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? j })
        ] }) }),
        /* @__PURE__ */ a(Bt, { children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] }) })
    ] }),
...
const $w = "16rem", Iw = "3rem", ki = Wt.createContext(void 0);
function sa() {
...
function Aw({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    (y) => {
      const R = typeof y == "function" ? y(w) : y;
      r ? r(R) : d(R);
    },
    [r, w]
  ), h = Wt.useCallback(() => p((y) => !y), [p]), g = w ? "expanded" : "collapsed", m = ye() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Wt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(ki.Provider, { value: C, children: /* @__PURE__ */ a(
    "div",
    {
    ...
    Pw,
    {
      ...
      children: /* @__PURE__ */ u(Lw, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(jw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Fw, { children: /* @__PURE__ */ a(
            Uw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const De = "scrBook", qw = "scrRef", Je = "source", Gw = "details", Hw = "Scripture Reference", Yw = "Scripture Book", _i = "Type", Ww = "Details";
function Xw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Yp({
  ...
  const [d, w] = N([]), [p, h] = N([{ id: De, desc: !1 }]), [g, f] = N({}), b = I(
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const W = b.find((k) => cn(k) === V[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, b, c, C]);
  const E = n ?? Yw, y = i ?? _i, R = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${E}`, value: [De] },
    { label: `Group by ${y}`, value: [Je] },
    {
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: R.map((S) => /* @__PURE__ */ a(ue, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: C.getHeaderGroups().map((S) => /* @__PURE__ */ a(Oe, { children: S.headers.filter((V) => V.column.columnDef.header).map((V) => (
        ...
        return /* @__PURE__ */ a(
          Oe,
          {
            ...
            children: S.getVisibleCells().map((k) => {
              if (!(k.getIsPlaceholder() || k.column.columnDef.enableGrouping && !k.getIsGrouped() && (k.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  cr,
                  {
                    className: v(
                    ...
                    children: k.getIsGrouped() ? /* @__PURE__ */ u(
                      Y,
                      {
                        ...
                        children: [
                          ...
                          !S.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(Ra, {}) : /* @__PURE__ */ a(za, {})),
                          " ",
                          kr(k.column.columnDef.cell, k.getContext()),
                          " (",
                          S.subRows.length,
                          ")"
                        ]
...
function Zw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [b, m] = N(!1), [C, E] = N(""), y = B(void 0), R = B(!1), j = I(
    () => Ni(t),
    [t]
  ), D = I(() => {
    if (!C.trim()) {
    ...
    (k, rt = !1) => {
      if (!rt || !y.current) {
        r(
          e.includes(k) ? e.filter((at) => at !== k) : [...e, k]
        ), y.current = k;
        return;
      }
      const F = j.findIndex((at) => at === y.current), Z = j.findIndex((at) => at === k);
      if (F === -1 || Z === -1) return;
      const [M, O] = [
        Math.min(F, Z),
        Math.max(F, Z)
      ], J = j.slice(M, O + 1).map((at) => at);
      r(
        e.includes(k) ? e.filter((at) => !J.includes(at)) : [.../* @__PURE__ */ new Set([...e, ...J])]
      );
    },
    [e, r, j]
  ), P = (k) => {
    $(k, R.current), R.current = !1;
  }, S = (k, rt) => {
    k.preventDefault(), $(rt, k.shiftKey);
  }, V = () => {
    r(j.map((k) => k));
  }, W = () => {
    r([]);
      ...
      children: [
        ...
        /* @__PURE__ */ a(Ve, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Le,
          {
            shouldFilter: !1,
            onKeyDown: (k) => {
              k.key === "Enter" && (R.current = k.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                ta,
...
function Xp({
  ...
  const R = $t(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = $t(s, "%webView_scope_selector_verse%"), D = $t(s, "%webView_scope_selector_chapter%"), $ = $t(s, "%webView_scope_selector_book%"), P = $t(
    s,
    "%webView_scope_selector_current_verse%"
  ), S = $t(
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = $t(s, "%webView_scope_selector_current_book%"), W = $t(s, "%webView_scope_selector_choose_books%"), k = $t(s, "%webView_scope_selector_scope%"), rt = $t(s, "%webView_scope_selector_select_books%"), F = $t(s, "%webView_scope_selector_range%"), Z = $t(s, "%webView_scope_selector_select_range%"), M = $t(s, "%webView_scope_selector_range_start%"), O = $t(s, "%webView_scope_selector_range_end%"), J = $t(s, "%webView_scope_selector_ok%"), at = $t(s, "%webView_scope_selector_cancel%"), At = $t(s, "%webView_scope_selector_navigate%"), Mt = (A) => {
    if (!f) return;
  ...
  ], q = (A, et, re = !1) => /* @__PURE__ */ u(dt, { children: [
    A,
    et && !re && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      et
    ] })
  ] }), nt = e ? Ut.filter((A) => e.includes(A.value)) : Ut, pt = f ?? wa, ct = w ?? pt, ft = p ?? pt, Jt = () => {
  }, Nt = B(null), yt = B(null), vt = B(!1), Zt = B(null), Kt = B(!1), [Pt, z] = N(void 0), bt = B(!1), Ct = B(!1), qt = B(null), qe = L((A) => {
    if (A) {
    ...
    z((et) => et === "start" ? void 0 : et), bt.current && (bt.current = !1, requestAnimationFrame(() => {
      var re;
      const et = (re = Nt.current) == null ? void 0 : re.querySelector("button");
      et == null || et.click();
    }));
  }, []), de = L((A) => {
    if (A) {
    ...
    (A) => {
      h == null || h(A), g == null || g(A), bt.current = !0;
    },
    [h, g]
  ), Ge = L(
    (A) => {
      g == null || g(A), Ct.current = !0;
    },
    [g]
  ), Et = L(
    (A) => {
    ...
    [r, n, f, i]
  ), se = nt.find((A) => A.value === t), Ot = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Ks(ct, ft, {
  ...
  ), ne = nt.find((A) => A.value === "selectedBooks"), ie = nt.find((A) => A.value === "range"), [Qt, T] = N(!1), [U, ot] = N(void 0), [Q, tt] = N(void 0), [_, G] = N(void 0), [K, st] = N(void 0), [ht, gt] = N([]), kt = d === "dropdown" && U === "selectedBooks", _t = /* @__PURE__ */ a(
    tu,
    {
      availableBookInfo: o,
  ...
  ), te = Pt === "end", ge = Pt === "start", ee = "tw:text-muted-foreground", He = d === "dropdown" && U === "range", x = He ? G : we, it = He ? st : g ? Ge : Jt, Vt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-start", className: v(te && ee), children: M }),
      /* @__PURE__ */ a(
        pa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Nt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-end", className: v(ge && ee), children: O }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: m,
          getEndVerse: C,
          disableReferencesUpTo: He ? _ ?? ct : ct,
          onOpenChange: de,
          onCloseAutoFocus: (A) => {
            var et;
            Ct.current && (Ct.current = !1, A.preventDefault(), (et = qt.current) == null || et.focus());
          },
          className: v(ge && ee),
          modal: !0,
          align: "start"
  ...
  const [Dt, Tt] = N(null), [St, mt] = N(null), [Gt, fe] = N(null), We = 200, [Oi, $i] = N(!1);
  H(() => {
    if (!Gt || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([et]) => {
      $i(et.contentRect.width < We);
    });
    return A.observe(Gt), () => A.disconnect();
  }, [Gt]);
  const fo = L(
    (A) => {
      tt(A), G(ct), st(ft), gt(n), T(!1), ot(A);
    },
    [ct, ft, n]
  ), mo = L(() => {
    Q !== void 0 && (Q === "range" ? (_ && (h == null || h(_)), K && (g == null || g(K))) : Q === "selectedBooks" && i(ht), Et(Q), ot(void 0), tt(void 0));
  }, [
    Q,
    _,
    K,
    ...
    A || (ot(void 0), tt(void 0));
  }, []), vo = L((A) => {
    var et;
    A.preventDefault(), (et = Ye.current) == null || et.focus();
  }, []), bo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ie, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(zt, { children: k }),
      d === "dropdown" ? /* @__PURE__ */ u(Fe, { open: Qt, onOpenChange: T, children: [
        ...
        /* @__PURE__ */ a(
          Ue,
          {
            ...
            children: /* @__PURE__ */ u(ca, { container: Gt, children: [
              Rt.map(({ value: A, label: et, dropdownLabel: re, scrRefSuffix: vr, id: Ii }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: Re(A),
              ...
              b && /* @__PURE__ */ u(dt, { children: [
                ...
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ...
                    onSelect: (A) => {
                      var et, re;
                      if (A.preventDefault(), vt.current) {
                        vt.current = !1;
                        return;
                      }
                      Kt.current || (re = (et = yt.current) == null ? void 0 : et.querySelector("button")) == null || re.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          pa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var et;
                              A.preventDefault(), (et = Zt.current) == null || et.focus();
                            },
                            modal: !0,
        ...
        Ka,
        {
          ...
          children: nt.map(({ value: A, label: et, scrRefSuffix: re, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: vr }),
            /* @__PURE__ */ a(zt, { htmlFor: vr, children: q(et, re) })
          ] }, vr))
        }
      )
    ] }),
    ...
    d === "dropdown" && ne && /* @__PURE__ */ a(Na, { open: U === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ca,
      {
        ...
        children: /* @__PURE__ */ u(ca, { container: St, children: [
          /* @__PURE__ */ a(Ea, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ta, { children: W }) }),
          _t,
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(Y, { variant: "outline", onClick: () => Mr(!1), children: at }),
            /* @__PURE__ */ a(Y, { onClick: mo, children: J })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && ie && /* @__PURE__ */ a(Na, { open: U === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ca,
      {
        ...
        children: /* @__PURE__ */ u(ca, { container: Dt, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(Y, { variant: "outline", onClick: () => Mr(!1), children: at }),
            /* @__PURE__ */ a(Y, { ref: qt, onClick: mo, children: J })
          ] })
        ] })
      }
    ) })
...
function Fa({
  ...
  return /* @__PURE__ */ u(Fe, { variant: i, children: [
    /* @__PURE__ */ a(Be, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(Y, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a($s, {}) }) }),
    /* @__PURE__ */ a(Ue, { align: "start", style: { zIndex: rr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(pn, { children: /* @__PURE__ */ a(Lt, { children: Ti(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(tr, {})
    ] }, l)) })
  ] });
}
const Si = Wt.forwardRef(
...
zi.displayName = he.List.displayName;
...
const au = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
...
Di.displayName = he.Content.displayName;
function ah({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(zi, { children: [
      /* @__PURE__ */ a(Ri, { children: t.map((c) => /* @__PURE__ */ a(au, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(ou, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(nu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: rr },
          children: /* @__PURE__ */ a(Lt, { children: Mi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ih({
  ...
  const d = gu(
    ...
    var C, E, y, R, j, D;
    const m = b !== f ? ((E = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : E[b]) ?? ((R = (y = t[f]) == null ? void 0 : y.uiNames) == null ? void 0 : R.en) : void 0;
...
function wh({
  ...
  return /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
    /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(
      xu,
      {
        className: o,
...
function Ph({
  ...
  const n = ye();
  return /* @__PURE__ */ u(ku, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(_u, {}),
    /* @__PURE__ */ u(
      Ke.Content,
      {
...
function Hh({
  ...
  return /* @__PURE__ */ a(
    he.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Nu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
