import { jsxs as ae, jsx as v, Fragment as Yr } from "react/jsx-runtime";
import * as ie from "react";
import { forwardRef as Kr, useState as Ee, useCallback as Ne, useMemo as _n, useRef as Sn, useEffect as tn } from "react";
import { getChaptersForBook as kr, offsetBook as Ln, FIRST_SCR_BOOK_NUM as Jr, offsetChapter as Fn, FIRST_SCR_CHAPTER_NUM as Zr, offsetVerse as Un, FIRST_SCR_VERSE_NUM as Qr } from "platform-bible-utils";
import * as Y from "@radix-ui/react-dropdown-menu";
import { ChevronRight as et, Check as nt, Circle as rt, History as tt, Tally1 as Gn, ChevronUp as ot } from "lucide-react";
import at, { clsx as it } from "clsx";
import { twMerge as st } from "tailwind-merge";
import { Button as ct, Autocomplete as lt, TextField as Sr, FormControlLabel as Hn, FormLabel as ut, Checkbox as dt, MenuItem as ft, Grid as Er, IconButton as Cr, Paper as pt, Slider as ht, Snackbar as mt, Switch as gt, AppBar as bt, Toolbar as yt, Drawer as vt } from "@mui/material";
...
var Rr = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(Rr || {});
const R = class {
  constructor(e, n, r, t) {
  ...
  allVerses(e = !1, n = R.verseRangeSeparators, r = R.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const t = [], o = qn(this._verse, r);
    for (const a of o.map((i) => qn(i, n))) {
      const i = this.clone();
      i.verse = a[0];
      const l = i.verseNum;
...
*/
A(ye, "ValidStatusType", Rr);
class Ue extends Error {
}
function we(...e) {
  return st(it(e));
}
const zt = Y.Root, Dt = Y.Trigger, jt = ie.forwardRef(({ className: e, inset: n, children: r, ...t }, o) => /* @__PURE__ */ ae(
  Y.SubTrigger,
  {
    ref: o,
    className: we(
    ...
    children: [
      r,
      /* @__PURE__ */ v(et, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
jt.displayName = Y.SubTrigger.displayName;
const Vt = ie.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ v(
  Y.SubContent,
  {
    ref: r,
    className: we(
...
const Ar = ie.forwardRef(({ className: e, sideOffset: n = 4, ...r }, t) => /* @__PURE__ */ v(Y.Portal, { children: /* @__PURE__ */ v(
  Y.Content,
  {
    ref: t,
    sideOffset: n,
...
Ar.displayName = Y.Content.displayName;
const Pr = ie.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ v(
  Y.Item,
  {
    ref: t,
    className: we(
...
const Lt = ie.forwardRef(({ className: e, children: n, checked: r, ...t }, o) => /* @__PURE__ */ ae(
  Y.CheckboxItem,
  {
    ref: o,
    className: we(
    ...
    ...t,
    children: [
      /* @__PURE__ */ v("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ v(Y.ItemIndicator, { children: /* @__PURE__ */ v(nt, { className: "pr-h-4 pr-w-4" }) }) }),
      n
    ]
  }
));
Lt.displayName = Y.CheckboxItem.displayName;
const Ft = ie.forwardRef(({ className: e, children: n, ...r }, t) => /* @__PURE__ */ ae(
  Y.RadioItem,
  {
    ref: t,
    className: we(
    ...
    ...r,
    children: [
      /* @__PURE__ */ v("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ v(Y.ItemIndicator, { children: /* @__PURE__ */ v(rt, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      n
    ]
  }
));
Ft.displayName = Y.RadioItem.displayName;
const Ir = ie.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ v(
  Y.Label,
  {
    ref: t,
...
const Mr = ie.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ v(
  Y.Separator,
  {
    ref: r,
...
const Br = ie.forwardRef(
  ({ className: e, type: n, ...r }, t) => /* @__PURE__ */ v(
    "input",
    {
      type: n,
      className: we(
...
const Ut = Kr(
  ({ handleSearch: e, ...n }, r) => /* @__PURE__ */ ae("div", { children: [
    /* @__PURE__ */ v(
      Br,
      {
        ...n,
...
function Gt({ endChapter: e, activeChapter: n, handleSelectChapter: r }) {
  ...
  return /* @__PURE__ */ v("div", { className: "chapter-select", children: t.map((o) => (
    ...
    /* @__PURE__ */ ae(
      Pr,
      {
        ...
        children: [
          ...
          r && /* @__PURE__ */ v(ot, { name: "chevron-up" })
        ]
      },
      e
    ),
...
function Ui({ scrRef: e, handleSubmit: n }) {
  const { allBookIds: r } = Z, [t, o] = Ee(""), [a, i] = Ee(""), l = Ne(
    (m) => ({
      OT: r.filter((p) => Z.isBookOT(p)),
      NT: r.filter((p) => Z.isBookNT(p)),
      DC: r.filter((p) => Z.isBookDC(p))
    })[m],
    [r]
  ), c = Ne(
    (m) => l(m).filter(
      (y) => Z.bookIdToEnglishName(y).toLowerCase().includes(t.toLowerCase()) || y.toLowerCase().includes(t.toLowerCase())
    ),
    [l, t]
  ), s = (m) => {
    o(m);
  }, u = Ne((m) => kr(Z.bookIdToNumber(m)), []), h = (m) => {
    i(a !== m ? m : ""), u(m) === -1 && n({
  ...
  return /* @__PURE__ */ v("div", { children: /* @__PURE__ */ ae(zt, { children: [
    /* @__PURE__ */ v(Dt, { asChild: !0, children: /* @__PURE__ */ v(
      Ut,
      {
        value: t,
        handleSearch: s,
    ...
    /* @__PURE__ */ v(Ar, { style: { width: "300px", height: "500px", overflowY: "auto" }, children: qt.map((m) => /* @__PURE__ */ ae("div", { children: [
      /* @__PURE__ */ v(Ir, { children: Wt[m] }),
      c(m).map((y) => /* @__PURE__ */ v("div", { children: /* @__PURE__ */ v(
        Ht,
        {
          bookId: y,
          handleSelectBook: () => h(y),
          isSelected: a === y,
          bookType: m,
          children: /* @__PURE__ */ v(
            Gt,
            {
              ...
              endChapter: u(y),
              activeChapter: e.bookNum === Z.bookIdToNumber(y) ? e.chapterNum : 0
            }
          )
        }
      ) }, y)),
      m === "OT" || m === "NT" ? /* @__PURE__ */ v(Mr, {}) : void 0
    ] }, m)) })
  ] }) });
}
function Ae({
...
function Gi({
  ...
  return /* @__PURE__ */ ae(Yr, { children: [
    /* @__PURE__ */ v(
      Hn,
      {
...
function Xt({
  ...
  let h;
  if (r) {
    const d = t === De.Before || t === De.Above, m = /* @__PURE__ */ v("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: r }), y = t === De.Before || t === De.After, p = y ? m : /* @__PURE__ */ v("div", { children: m }), f = y ? u : /* @__PURE__ */ v("div", { children: u });
    h = /* @__PURE__ */ ae(
      ut,
      {
...
function Kt({ commandHandler: e, name: n, className: r, items: t, id: o }) {
  return /* @__PURE__ */ ae(Er, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
    /* @__PURE__ */ v("h3", { className: `papi-menu ${r ?? ""}`, children: n }),
    t.map((a, i) => /* @__PURE__ */ v(
      Yt,
      {
...
let pn;
const hn = () => (pn || (pn = Z.allBookIds.map((e) => ({
  bookId: e,
...
function Wi({ scrRef: e, handleSubmit: n, id: r }) {
  ...
  return /* @__PURE__ */ ae("span", { id: r, children: [
    /* @__PURE__ */ v(
      En,
      {
        title: "Book",
    ...
    /* @__PURE__ */ v(
      ...
      {
        onClick: () => n(Fn(e, 1)),
        isDisabled: e.chapterNum >= kr(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ v(
    ...
    /* @__PURE__ */ v(Ae, { onClick: () => n(Un(e, 1)), children: ">" })
  ] });
}
function qi({ onSearch: e, placeholder: n, isFullWidth: r }) {
  ...
  return /* @__PURE__ */ v(pt, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ v(
    Qe,
    {
      isFullWidth: r,
...
function Xn({ onRowChange: e, row: n, column: r }) {
  const t = (o) => {
    e({ ...n, [r.key]: o.target.value });
  };
  return /* @__PURE__ */ v(Qe, { defaultValue: n[r.key], onChange: t });
}
const Zt = ({ onChange: e, disabled: n, checked: r, ...t }) => /* @__PURE__ */ v(
  Xt,
  {
    ...t,
    isChecked: r,
...
function Ji({
  ...
  const Q = _n(() => {
    const oe = e.map((U) => typeof U.editable == "function" ? {
      ...U,
      editable: (ne) => !!U.editable(ne),
      renderEditCell: U.renderEditCell || Xn
    } : U.editable && !U.renderEditCell ? { ...U, renderEditCell: Xn } : U.renderEditCell && !U.editable ? { ...U, editable: !1 } : U);
    return u ? [{ ...xt, minWidth: h }, ...oe] : oe;
  }, [e, u, h]);
  return /* @__PURE__ */ v(
    wt,
    {
...
function eo() {
  ...
  return j.AsyncMode = c, j.ConcurrentMode = s, j.ContextConsumer = l, j.ContextProvider = i, j.Element = n, j.ForwardRef = u, j.Fragment = t, j.Lazy = y, j.Memo = m, j.Portal = r, j.Profiler = a, j.StrictMode = o, j.Suspense = h, j.isAsyncMode = function(g) {
    return C(g) || z(g) === c;
    ...
    return typeof g == "string" || typeof g == "function" || g === t || g === s || g === a || g === o || g === h || g === d || typeof g == "object" && g !== null && (g.$$typeof === y || g.$$typeof === m || g.$$typeof === i || g.$$typeof === l || g.$$typeof === u || g.$$typeof === f || g.$$typeof === S || g.$$typeof === J || g.$$typeof === p);
  }, j.typeOf = z, j;
}
var V = {};
/** @license React v16.13.1
...
function no() {
  return Kn || (Kn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function z(w) {
      ...
      w === t || w === s || w === a || w === o || w === h || w === d || typeof w == "object" && w !== null && (w.$$typeof === y || w.$$typeof === m || w.$$typeof === i || w.$$typeof === l || w.$$typeof === u || w.$$typeof === f || w.$$typeof === S || w.$$typeof === J || w.$$typeof === p);
    }
    function C(w) {
    ...
    var g = c, ee = s, te = l, me = i, fe = n, T = u, W = t, Q = y, oe = m, U = r, pe = a, ne = o, be = h, Te = !1;
    function $e(w) {
    ...
    V.AsyncMode = g, V.ConcurrentMode = ee, V.ContextConsumer = te, V.ContextProvider = me, V.Element = fe, V.ForwardRef = T, V.Fragment = W, V.Lazy = Q, V.Memo = oe, V.Portal = U, V.Profiler = pe, V.StrictMode = ne, V.Suspense = be, V.isAsyncMode = $e, V.isConcurrentMode = b, V.isContextConsumer = x, V.isContextProvider = $, V.isElement = N, V.isForwardRef = E, V.isFragment = P, V.isLazy = _, V.isMemo = O, V.isPortal = I, V.isProfiler = D, V.isStrictMode = M, V.isSuspense = re, V.isValidElementType = z, V.typeOf = C;
  }()), V;
}
var Jn;
function Dr() {
  return Jn || (Jn = 1, process.env.NODE_ENV === "production" ? Ke.exports = eo() : Ke.exports = no()), Ke.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var bn, er;
function jr() {
  return er || (er = 1, bn = Function.call.bind(Object.prototype.hasOwnProperty)), bn;
}
var yn, nr;
function to() {
  if (nr)
...
function oo() {
  if (rr)
    return vn;
  rr = 1;
  var e = Dr(), n = ro(), r = Rn(), t = jr(), o = to(), a = function() {
  };
...
function lo() {
  ...
  return L.ContextConsumer = i, L.ContextProvider = a, L.Element = e, L.ForwardRef = c, L.Fragment = r, L.Lazy = d, L.Memo = h, L.Portal = n, L.Profiler = o, L.StrictMode = t, L.Suspense = s, L.SuspenseList = u, L.isAsyncMode = function() {
    return !1;
    ...
    return typeof f == "string" || typeof f == "function" || f === r || f === o || f === t || f === s || f === u || f === m || typeof f == "object" && f !== null && (f.$$typeof === d || f.$$typeof === h || f.$$typeof === a || f.$$typeof === i || f.$$typeof === c || f.$$typeof === y || f.getModuleId !== void 0);
  }, L.typeOf = p, L;
}
var F = {};
/**
...
function uo() {
  return ar || (ar = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), n = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), s = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), m = Symbol.for("react.offscreen"), y = !1, p = !1, f = !1, S = !1, J = !1, z;
    z = Symbol.for("react.module.reference");
    function C(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === r || k === o || J || k === t || k === s || k === u || S || k === m || y || p || f || typeof k == "object" && k !== null && (k.$$typeof === d || k.$$typeof === h || k.$$typeof === a || k.$$typeof === i || k.$$typeof === c || // This needs to include all possible module reference object
    ...
    var ee = i, te = a, me = e, fe = c, T = r, W = d, Q = h, oe = n, U = o, pe = t, ne = s, be = u, Te = !1, $e = !1;
    function b(k) {
    ...
    F.ContextConsumer = ee, F.ContextProvider = te, F.Element = me, F.ForwardRef = fe, F.Fragment = T, F.Lazy = W, F.Memo = Q, F.Portal = oe, F.Profiler = U, F.StrictMode = pe, F.Suspense = ne, F.SuspenseList = be, F.isAsyncMode = b, F.isConcurrentMode = x, F.isContextConsumer = $, F.isContextProvider = N, F.isElement = E, F.isForwardRef = P, F.isFragment = _, F.isLazy = O, F.isMemo = I, F.isPortal = D, F.isProfiler = M, F.isStrictMode = re, F.isSuspense = w, F.isSuspenseList = ce, F.isValidElementType = C, F.typeOf = g;
  }()), F;
}
...
function Eo(e) {
  ...
  function s(d, m) {
    const y = i.indexOf(m);
    return `@media (min-width:${typeof n[d] == "number" ? n[d] : d}${r}) and (max-width:${(y !== -1 && typeof n[i[y]] == "number" ? n[i[y]] : m) - t / 100}${r})`;
  }
  function u(d) {
  ...
  function h(d) {
    const m = i.indexOf(d);
    return m === 0 ? l(i[1]) : m === i.length - 1 ? c(i[m]) : s(d, i[i.indexOf(d) + 1]).replace("@media", "@media not all and");
  }
  return B({
    keys: i,
    values: a,
...
function K(e) {
  const {
    ...
    return ve(i, l, (h) => {
      let d = en(s, o, h);
      return h === d && typeof h == "string" && (d = en(s, o, `${n}${h === "default" ? "" : ge(h)}`, h)), r === !1 ? d : {
        [r]: d
      };
    });
  };
...
q.propTypes = process.env.NODE_ENV !== "production" ? an.reduce((e, n) => (e[n] = Ce, e), {}) : {};
q.filterProps = an;
function X(e) {
  return Ur(e, sn);
}
X.propTypes = process.env.NODE_ENV !== "production" ? sn.reduce((e, n) => (e[n] = Ce, e), {}) : {};
X.filterProps = sn;
...
const Do = de("border", ue), jo = de("borderTop", ue), Vo = de("borderRight", ue), Lo = de("borderBottom", ue), Fo = de("borderLeft", ue), Uo = de("borderColor"), Go = de("borderTopColor"), Ho = de("borderRightColor"), Wo = de("borderBottomColor"), qo = de("borderLeftColor"), Xo = de("outline", ue), Yo = de("outlineColor"), ln = (e) => {
...
cn(Do, jo, Vo, Lo, Fo, Uo, Go, Ho, Wo, qo, ln, Xo, Yo);
const un = (e) => {
...
cn(un, dn, fn, Ko, Jo, Zo, Qo, ea, na, ra, ta, oa);
function je(e, n) {
  return n === "grey" ? n : e;
}
const aa = K({
...
function ba() {
  function e(r, t, o, a) {
    ...
    const d = on(o, s) || {};
    return h ? h(i) : ve(i, t, (y) => {
      let p = en(d, u, y);
      return y === p && typeof y == "string" && (p = en(d, u, `${r}${y === "default" ? "" : ge(y)}`, y)), c === !1 ? p : {
        [c]: p
      };
    });
  }
...
const Gr = ba();
Gr.filterProps = ["sx"];
const Bn = Gr, ya = ["breakpoints", "palette", "spacing", "shape"];
function zn(e = {}, ...n) {
  const {
    breakpoints: r = {},
    palette: t = {},
  ...
  return s = n.reduce((u, h) => he(u, h), s), s.unstable_sxConfig = B({}, Mn, i == null ? void 0 : i.unstable_sxConfig), s.unstable_sx = function(h) {
    return Bn({
      sx: h,
      theme: this
    });
...
function Hr(e) {
  ...
  return Object.keys(r).sort().forEach((o) => {
    o === "color" ? t += dr(t) ? e[o] : ge(e[o]) : t += `${dr(t) ? o : ge(o)}${ge(e[o].toString())}`;
  }), t;
}
...
const _a = (e, n) => n.components && n.components[e] && n.components[e].styleOverrides ? n.components[e].styleOverrides : null, nn = (e) => {
  let n = 0;
  const r = {};
...
const $a = zn(), fr = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Ze({
  defaultTheme: e,
  theme: n,
  themeId: r
...
function Aa(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const {
      ...
      overridesResolver: d = Ra(fr(s))
    } = l, m = xe(l, Ea), y = u !== void 0 ? u : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      s && s !== "Root" && s !== "root" || !1
    ), p = h || !1;
    let f;
    process.env.NODE_ENV !== "production" && c && (f = `${c}-${fr(s || "Root")}`);
    let S = Je;
    ...
    const J = kt(i, B({
      ...
      const ee = g ? g.map((T) => {
        ...
        if (Se(T)) {
          let W = T, Q;
          return T && T.variants && (Q = T.variants, delete W.variants, W = (oe) => {
            let U = T;
            return rn(oe, nn(Q), Q).forEach((ne) => {
              U = he(U, ne);
            }), U;
          }), W;
        }
      ...
      if (Se(C)) {
        let T;
        C && C.variants && (T = C.variants, delete te.variants, te = (W) => {
          let Q = C;
          return rn(W, nn(T), T).forEach((U) => {
            Q = he(Q, U);
          }), Q;
        });
      } else
      ...
      c && d && ee.push((T) => {
        ...
        if (Q) {
          ...
          return Object.entries(Q).forEach(([U, pe]) => {
            oe[U] = typeof pe == "function" ? pe(B({}, T, {
              theme: W
            })) : pe;
          }), d(T, oe);
        }
...
function Pa(e) {
  ...
  return !n || !n.components || !n.components[r] || !n.components[r].defaultProps ? t : Lr(n.components[r].defaultProps, t);
}
function Ia({
  props: e,
  name: n,
...
function hr(e) {
  e = Le(e);
  let n = e.type === "hsl" || e.type === "hsla" ? Le(Ba(e)).values : e.values;
...
function za(e, n) {
  if (e = Le(e), n = Wr(n), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - n;
...
const Va = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, ze = Xa, Ya = ["mode", "contrastThreshold", "tonalOffset"], gr = {
...
function ri(e) {
  ...
  function h(p) {
    const f = mr(p, xn.text.primary) >= r ? xn.text.primary : gr.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const S = mr(p, f);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return br(p, "light", J, t), br(p, "dark", z, t), p.contrastText || (p.contrastText = h(p.main)), p;
  }, m = {
    dark: xn,
    light: gr
  };
  return process.env.NODE_ENV !== "production" && (m[n] || console.error(`MUI: The palette mode \`${n}\` is not supported.`)), he(B({
...
function ai(e, n) {
  ...
  const m = o / 14, y = h || ((S) => `${S / s * m}rem`), p = (S, J, z, C, g) => B({
    fontFamily: t,
    fontWeight: S,
    fontSize: y(J),
    ...
    button: p(l, 14, 1.75, 0.4, yr),
    caption: p(i, 12, 1.66, 0.4),
    overline: p(i, 12, 2.66, 1, yr),
...
`)), Object.keys(s).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(s).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((u) => `${u} ${typeof i == "string" ? i : wr(i)} ${l} ${typeof c == "string" ? c : wr(c)}`).join(",");
    }
  }, e, {
    easing: n,
    duration: r
...
function vi(e = {}, ...n) {
  ...
  if (s = he(s, i), s = n.reduce((u, h) => he(u, h), s), process.env.NODE_ENV !== "production") {
    const u = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], h = (d, m) => {
      let y;
      for (y in d) {
        const p = d[y];
        if (u.indexOf(y) !== -1 && Object.keys(p).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const f = An("", y);
            console.error([`MUI: The \`${m}\` component increases the CSS specificity of the \`${y}\` internal state.`, "You can not override it like this: ", JSON.stringify(d, null, 2), "", `Instead, you need to use the '&.${f}' syntax:`, JSON.stringify({
              root: {
                [`&.${f}`]: p
              }
...
`));
    ...
    Object.keys(s.components).forEach((d) => {
      const m = s.components[d].styleOverrides;
      m && d.indexOf("Mui") === 0 && h(m, d);
    });
  }
  return s.unstable_sxConfig = B({}, Mn, i == null ? void 0 : i.unstable_sxConfig), s.unstable_sx = function(h) {
    return Bn({
      sx: h,
      theme: this
    });
...
const Ti = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], _i = (e) => {
...
}), jn = /* @__PURE__ */ ie.forwardRef(function(n, r) {
  const t = xi({
    props: n,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: h,
    viewBox: d = "0 0 24 24"
  } = t, m = xe(t, Ti), y = /* @__PURE__ */ ie.isValidElement(o) && o.type === "svg", p = B({}, t, {
    color: i,
    component: l,
    fontSize: c,
  ...
  return /* @__PURE__ */ ae(Ni, B({
    ...
    ownerState: p,
    children: [y ? o.props.children : o, h ? /* @__PURE__ */ v("title", {
      children: h
    }) : null]
  }));
});
...
function Oi(e, n) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${n}Icon`), r.muiName = xr.muiName, /* @__PURE__ */ ie.memo(/* @__PURE__ */ ie.forwardRef(r));
}
const $i = Oi(/* @__PURE__ */ v("path", {
...
function Zi({
  ...
  let f = e;
  return !f && n && (f = n(c)), /* @__PURE__ */ v("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ v(bt, { position: "static", id: o, children: /* @__PURE__ */ ae(yt, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ v(
      Cr,
      {
        edge: "start",
    ...
    a ? /* @__PURE__ */ v("div", { className: "papi-menu-children", children: a }) : void 0,
    f ? /* @__PURE__ */ v(
      vt,
      {
        ...
        children: /* @__PURE__ */ v(Jt, { commandHandler: p, columns: f.columns })
      }
    ) : void 0
  ] }) }) });
}
