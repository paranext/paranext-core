...
var Kt = (t, e, r) => Vi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Se, a as Fa, C as Ce, A as ie, P as $e, b as We, B as U, d as Ae, e as Ie, f as Ve, h as xe, i as Pi, k as ji, j as Li, E as Bi, l as Ua, r as pe, m as Fi, n as dn, o as Qr, p as ta, L as Nt, R as Ka, q as qr, D as Na, s as Ca, t as Ea, u as Ta, T as wn, v as Pr, w as Vt, x as qa, y as Pt, z as jt, F as Lt, G as un, H as Ga, I as Ge, J as kr, K as ye, M as ke, N as _e, S as _r, O as er, Q as Ui, U as Er, V as Ye, W as De, Z as Xe, X as Re, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as pn, a3 as Ki, a4 as qi, a5 as Gi, a6 as za, a7 as hn, a8 as ea, a9 as gn, aa as Hi, ab as Yi, ac as Wi, ad as Xi, ae as fn, af as Ji, ag as sa, ah as xo, ai as ca, aj as Zi, ak as Qi, al as ts, am as es, an as rs, ao as Tr, ap as Xa, aq as as, ar as os } from "./resizable-C2eEiE_z.js";
import { as as Jh, at as Zh, au as Qh, av as tg, aw as eg, ax as rg, ay as ag, az as og, aA as ng, aB as ig, aC as sg, aD as cg, aE as lg, aF as dg, aG as wg, aH as ug, aI as pg, aJ as hg, aK as gg, aL as fg, aM as mg, aN as vg, aO as bg, aP as xg, aQ as yg } from "./resizable-C2eEiE_z.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Oe, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Sa, ChevronRight as Ra, ArrowLeft as ns, ArrowRight as is, ChevronDown as nr, BoldIcon as ss, ItalicIcon as cs, X as Ja, AtSign as mn, Pencil as ls, Trash2 as ds, ArrowUp as vn, MoreHorizontal as ws, MailOpen as us, Mail as ps, ChevronUp as hs, FilterIcon as gs, ArrowLeftIcon as fs, ChevronLeftIcon as ms, ChevronRightIcon as vs, ArrowRightIcon as bs, Copy as bn, Filter as xs, User as ys, Link as ks, CircleHelp as _s, Undo as Ns, Redo as Cs, SquareX as xn, FunctionSquare as yn, SquareSigma as kn, Ban as Es, AlertCircle as Da, CircleCheckIcon as Ts, CircleXIcon as zs, CircleHelpIcon as Ss, ArrowUpIcon as Rs, ArrowDownIcon as Ds, ScrollText as Os, ChevronsUpDown as Ms, MenuIcon as $s, Menu as As, EllipsisVertical as Is, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Vs, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ps, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as _n, formatBytes as js, getCurrentLocale as Ls, usfmMarkers as jr, getFormatCallerFunction as Bs, deepEqual as Fs, isString as Co, compareScrRefs as Oa, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as Eo, formatReplacementStringToArray as To, collectUsjMarkers as Ks } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as qs, useLayoutEffect as Qt, createContext as Qa, useContext as Nn, Component as Gs, createElement as zo, Suspense as Hs, forwardRef as Cn, useId as So, Fragment as ra } from "react";
...
import { createEditor as zn, $getRoot as Me, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as Sn, TextNode as Rn, $getPreviousSelection as oc, $isRangeSelection as we, $caretFromPoint as nc, $getSiblingCaret as Dn, $getChildCaret as ic, $getAdjacentChildCaret as sc, $isChildCaret as cc, $normalizeCaret as lc, $setSelectionFromCaretRange as dc, $getCollapsedCaretRange as wc, $getCaretInDirection as Ro, $splitAtPointCaretNext as uc, $isTextPointCaret as pc, $findMatchingParent as On, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as hc, isHTMLElement as gc, CLEAR_EDITOR_COMMAND as Mn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as fc, defineExtension as re, safeCast as Je, createState as mc, FORMAT_TEXT_COMMAND as $n, $isNodeSelection as An, COMMAND_PRIORITY_LOW as In, RootNode as vc, LineBreakNode as bc, TabNode as xc, $isEditorState as yc, createCommand as kc, CLICK_COMMAND as _c, isDOMNode as Nc, $getNodeFromDOMNode as Cc, $createNodeSelection as Ec, $setSelection as Tc, $getEditor as zc, DecoratorNode as Ma, $getState as Sc, toggleTextFormatType as Do, TEXT_TYPE_TO_FORMAT as Rc, $setState as Dc, addClassNamesToElement as Vn, $create as Oc, $getNodeByKey as Mc, removeClassNamesFromElement as $c, KEY_TAB_COMMAND as Ac, $isBlockElementNode as Ic, $createRangeSelection as Vc, $normalizeSelection__EXPERIMENTAL as Pc, OUTDENT_CONTENT_COMMAND as jc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Lc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Bc, $isParagraphNode as Fc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Pn, $insertNodes as Uc } from "lexical";
...
import { Avatar as ao, Select as Gt, Checkbox as Mo, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as $o, Slider as Or, Switch as Ao } from "radix-ui";
import { useReactTable as Ln, getFilteredRowModel as Zc, getSortedRowModel as Bn, getPaginationRowModel as Qc, getCoreRowModel as Fn, flexRender as xr, getGroupedRowModel as tl, getExpandedRowModel as el } from "@tanstack/react-table";
...
function cl({
  ...
  return /* @__PURE__ */ u($e, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Ce,
      {
        onSelect: () => g(h),
...
function ua({
  ...
  const B = pe(), [z, A] = _(!1), [I, C] = _(""), [V, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
  ), [W, Z] = _(void 0), [Dt, Tt] = _(!1), Bt = F(null), q = F(!1), tt = F(void 0), wt = F(void 0), at = F(void 0), mt = F(void 0), ae = F({}), ut = F({}), bt = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = Ft[rt].filter((It) => Ua(It, V, n));
    }), b;
  }, [Ft, V, n]), R = D(
    () => pl(V, Jt, n),
    [V, Jt, n]
  ...
  const Ct = L(() => {
    ...
    const b = T;
    $(void 0), Z(void 0), b ? (Y(b), J("chapters"), C("")) : et();
  }, [T, et]), it = L((b) => {
    A(b), b && (J("books"), Y(void 0), $(void 0), Z(void 0), K(""));
  }, []);
  H(() => {
    O && it(!1);
  }, [O, it]);
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    (b) => {
      var me, Te, Fe;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: rt } = Vo(b.key);
      ...
      if (y === "verses" && It) {
        ...
        Ut !== ft && (b.preventDefault(), b.stopPropagation(), C(
          `${Et} ${ie[Et] || ""} ${kt}:${Ut}`
        ), setTimeout(() => {
  ...
  return Qt(() => {
    const b = setTimeout(() => {
      if (z && y === "books" && at.current && mt.current) {
        const G = at.current, rt = mt.current, It = rt.offsetTop, me = G.clientHeight, Te = rt.clientHeight, Fe = It - me / 2 + Te / 2;
        G.scrollTo({
          top: Math.max(0, Fe),
          behavior: "smooth"
        }), C(Kn(t.book));
    ...
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      U,
      {
        ...
        children: [
          g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: je }),
          f && /* @__PURE__ */ a(
            En,
            {
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: G } = b;
          z && Bt.current && G instanceof Node && Bt.current.contains(G) && (q.current = !0, it(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Ie,
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Q.map(
                  ({ onClick: b, disabled: G, title: rt, icon: It }) => /* @__PURE__ */ a(
                    U,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  U,
                  {
                    ...
                    tabIndex: -1,
                    children: B === "ltr" ? /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" })
                  }
                ),
              ...
              !Dt && /* @__PURE__ */ u(Ve, { ref: at, children: [
                ...
                y === "verses" && T && W !== void 0 && d && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: T,
                    chapterNum: W,
...
function Lo({
  ...
  const [N, O] = _(!1), B = d ?? l, z = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], A = (I, C) => {
    const V = l(I), K = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, y = `${C ?? ""}${V}${K ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: V,
  ...
  return /* @__PURE__ */ u($e, { open: N, onOpenChange: O, ...k, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      U,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ie, { children: [
          ...
          /* @__PURE__ */ a(Ve, { children: z(e) ? e.map((I) => /* @__PURE__ */ a(xe, { heading: I.groupHeading, children: I.options.map((C) => A(C, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((I) => A(I)) }) })
        ] })
      }
    )
  ] });
...
function Xu({
  ...
  const w = pa(d, "%webView_bookSelector_currentBook%"), p = pa(d, "%webView_bookSelector_choose%"), g = pa(d, "%webView_bookSelector_chooseBooks%"), [h, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = Hn ? Qt : H, Ar = { tag: to };
      ...
      if (g !== null) {
        if (g === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            const f = zr();
            h.append(f);
            const x = Hn ? document.activeElement : null;
...
function Dl(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < h.length; E++) {
      const k = h[E], N = s[E] || document.createElement("div"), O = N.style;
      O.position !== "absolute" && (O.position = "absolute", v = !0);
      const B = de(k.left - p);
      O.left !== B && (O.left = B, v = !0);
      const z = de(k.top - g);
      O.top !== z && (N.style.top = z, v = !0);
      const A = de(k.width);
      O.width !== A && (N.style.width = A, v = !0);
      const I = de(k.height);
      O.height !== I && (N.style.height = I, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[E] = N;
    }
...
function Ml(t, e = Ol) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, E = h.getNode(), k = E.getKey(), N = h.offset, O = t.getElementByKey(x), B = t.getElementByKey(k), z = r === null || O !== o || v !== n || x !== r.getKey(), A = i === null || B !== s || N !== c || k !== i.getKey();
      if ((z || A) && O !== null && B !== null) {
        const I = function(C, V, K, y, J, j, Y) {
          const T = (C._window ? C._window.document : document).createRange();
          return T.setStart(...Bo(V, K, y)), T.setEnd(...Bo(J, j, Y)), T;
        }(t, g, f, O, h, E, B);
        l(), l = Dl(t, I, e);
      }
      r = f, o = O, n = v, i = E, s = B, c = N;
    });
  }
...
function Al(t) {
  const e = On(t, (r) => Nr(r) && !r.isInline());
...
function Il(t) {
  ...
  if (we(e)) r = nc(e.focus, "next");
    ...
    r = r || ic(Me(), "previous").getFlipped().insert(zr());
  }
...
function Vl(t, e, r) {
  ...
  return pc(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), Ro(Dn(t.getLatest(), "next"), e.direction);
}
function Pl(t) {
  const e = Xt();
  if (!we(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = On(i, (d) => Nr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Yr, be = 0, Wr = 0, Bl = 0, Pa = 0, Br = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ul(t) {
  ...
  Xn(this), nt = t, this.f &= -2, 8 & this.f && so(this), oa();
}
function tr(t, e) {
...
qt.prototype.brand = jl, qt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Wr === 0 && e.l !== Pa && (e.l = Pa, Yr = { S: e, v: e.v, i: e.i, o: Yr });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Jn(this), Ko(this), be++;
  const t = nt;
...
const co = 0, La = 1, ai = 2, fa = 3, Ir = 4, Qe = 5, ma = 6, mr = 7;
function va(t) {
  return t.id === co;
}
function oi(t) {
...
class Yl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && lt(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const Xl = re({ config: Je({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [vc, Rn, bc, xc, Sn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function Jl(t) {
  throw t;
...
const Zl = /* @__PURE__ */ new Set(), Yo = re({ build(t, e, r) {
  const o = r.getDependency(ja).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ei(() => {
  }, () => ue(() => {
...
re({ dependencies: [ja, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Yo).output, n = Cr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ne(t.registerCommand(Ql, (s) => {
    ...
    if (Nc(s.target)) {
      ...
      if (ed(c)) return function(l, d = !1) {
        const w = Xt(), p = l.isSelected(), g = l.getKey();
        let h;
...
function rd(t, e, r = ni) {
  return Ne(t.registerCommand(Ac, (o) => {
    const n = Xt();
    if (!we(n)) return !1;
    o.preventDefault();
    const i = function(s) {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (we(f)) {
                ...
                if ($a(v) && d >= 0 && w >= 0 && (E = d, k = d + w, f.setTextNodeRange(v, E, v, k)), E === k && p === "" || (f.insertRawText(p), v = x.getNode()), $a(v)) {
                  E = g, k = g + h;
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u($e, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ae,
        {
          ...
          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ve, { children: t.map((v) => /* @__PURE__ */ a(
            Ce,
            {
              onSelect: () => {
                l(v || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: xa(v, o) })
            },
            v || "unassigned"
          )) }) })
        }
...
function Qo({
  ...
  const h = L(
    ...
    [t.user]
  ), k = D(() => Za(t.contents), [t.contents]), N = D(
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Ad, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Id, { className: "tw:text-xs tw:font-medium", children: E }) }),
        ...
        B && /* @__PURE__ */ u(ye, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ws, {}) }) }),
...
function bi({
  ...
  const [y, J] = _(tn), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Bt] = _(!1), [q, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(O), [Ot, Ft] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
      const xt = k ? await k(l) : !1;
      S && ae(xt);
    })(), () => {
      S = !1;
    };
  ...
  H(() => {
    ...
    yt.current === "idle" && (yt.current = "pending"), wt ? yt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    A !== i && (Y(A), yt.current = "auto-populated") : yt.current === "auto-populated" && (Y(void 0), yt.current = "pending");
  }, [o, A, wt, i]);
  const Ct = D(
  ...
  const Zt = D(() => Ct[0], [Ct]), Ee = F(null), te = F(void 0), P = L(() => {
    var S;
    (S = te.current) == null || S.call(te), J(tn);
  }, []), Q = L(() => {
    const S = !ut;
  ...
  const Ht = L(
    async (S) => {
      ...
      At && await p({ threadId: l, contents: At }) && P();
    },
    [
      P,
      y,
    ...
    async (S) => {
      const At = ee(y) ? Jr(y) : void 0, xt = S.status ? S.assignedUser : j ?? S.assignedUser, oe = await p({
        ...S,
        contents: At,
        assignedUser: xt
      });
      return oe && (xt !== void 0 && $(xt), At && P()), oe;
    },
    [P, y, p, j]
  );
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              U,
              {
                ...
                children: ut ? /* @__PURE__ */ a(us, {}) : /* @__PURE__ */ a(ps, {})
              }
            ),
            V === void 0 ? (
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    j !== void 0 && (ee(y) || j !== T) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: He(
                    ...
                    /* @__PURE__ */ u($e, { open: q, onOpenChange: tt, children: [
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ve, { children: x == null ? void 0 : x.map((S) => /* @__PURE__ */ a(
                            Ce,
                            {
                              onSelect: () => {
...
function jd({
  ...
  const [s, c] = _("accept"), l = So(), d = So(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = D(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = D(
    () => Ur(t.acceptedText ?? ""),
    ...
    () => Ur(t.mergedText ?? ""),
    [t.mergedText]
  ), k = D(() => Za(t.contents), [t.contents]);
  if (!fi(t))
    return /* @__PURE__ */ a(Kr, { html: k });
  const N = (T) => {
    c(T === "reject" || T === "merge" ? T : "accept");
  }, O = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", B = h ? [
    {
      value: "merge",
    ...
    if (e === "Resolved") {
      for (let k = o.length - 1; k >= 0; k -= 1)
        if (o[k].status === "Resolved")
          return mi(o[k].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function sp({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [O, B] = _(), [z, A] = _(), I = L(
    async ($) => {
      const W = await i($);
  ...
  const C = r.filter(
    ...
    ($) => {
      N((W) => new Set(W).add($.id)), B($.id), x == null || x($.id);
    },
    [x]
  ), y = L(
    ($) => {
    ...
    [k, x]
  ), { listboxRef: J, activeId: j, handleKeyDown: Y } = Ui({
    options: V,
    onOptionSelect: K
  }), T = L(
    ($) => {
      $.key === "Escape" ? (O && k.has(O) && (N((W) => {
        const Z = new Set(W);
        return Z.delete(O), Z;
      }), B(void 0), x == null || x(void 0)), $.preventDefault(), $.stopPropagation()) : Y($);
    },
    [O, k, Y, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Kd, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(bi, { ...W })
          },
          $.id
        );
      })
...
function Xd({
  ...
  var z;
  const [w, p] = _([]), [g, h] = _([]), [f, x] = _({}), [v, E] = _({}), k = D(() => e ?? [], [e]), N = Ln({
    data: k,
    columns: t,
    getCoreRowModel: Fn(),
  ...
  return l ? B = Array.from({ length: 10 }).map((C, V) => `skeleton-row-${V}`).map((C) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = N.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Ha, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ya, { stickyHeader: i, children: N.getHeaderGroups().map((A) => /* @__PURE__ */ a(Re, { children: A.headers.map((I) => /* @__PURE__ */ a(Gr, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : xr(I.column.columnDef.header, I.getContext()) }, I.id)) }, A.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(U, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(bn, {}) })
        ] }),
...
function pp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ye, { children: [
    ...
    /* @__PURE__ */ a(_e, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(pn, { children: d.itemType === 0 ? /* @__PURE__ */ a(ct, { children: d.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        De,
        {
          checked: o[w][g],
...
function nw({
  ...
  const f = (v) => {
    ...
    var E, k, N, O;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((O = s.current) == null || O.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: ow(t, n, r) }) }) }),
...
function cw({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: iw(t, r) }) }) }),
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { children: sw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(_e, { style: { zIndex: hn }, children: [
...
function mp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [O, B] = _("*"), [z, A] = _("f"), [I, C] = _(!1), [V, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, q] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Aa ? st = "generated" : it === Ia ? st = "hidden" : it && (N(it), B(it)), x(st), E(st), A(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var ht;
  ...
  const ut = L(
    (P, Q, et = !1) => {
      ...
      if (ot && Mr("note", ot)) {
        if (ot.insert.note) {
          let pt;
          P === "custom" ? pt = Q : P === "generated" ? pt = Aa : pt = Ia, ot.insert.note.caller = pt;
        }
  ...
  const Jt = () => {
    ...
    if (g.current && ae.length && P && P.rangeCount > 0) {
      ...
      Z(Q.left - et.left), Tt(Q.top - et.top), q(Q.height), $(!0);
    }
  }, [ae, g]);
  H(() => {
    const P = () => {
    ...
    const P = ((et = p.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, Q = (ot) => {
      !T && P && document.activeElement === P && ot.key === c ? (ot.preventDefault(), Ee()) : T && ot.key === "Escape" && (ot.preventDefault(), $(!1));
    };
...
function bp({
  ...
  const w = l ?? Bs(r, void 0), p = (k, N) => {
    d == null || d(k, N, n);
  }, g = i ? r.findIndex((k) => k === i) : -1, [h, f] = _(g), x = (k, N, O) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), d == null || d(N, O, n);
          break;
      }
  }, v = (k) => {
    if (r.length)
...
function yw({
  ...
  return /* @__PURE__ */ u(Ha, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ya, { stickyHeader: !0, children: /* @__PURE__ */ u(Re, { children: [
...
}, na = (t, e, r) => /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
  /* @__PURE__ */ u(
    jt,
    {
...
function Tp({
  ...
  const h = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), x = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), k = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), O = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = le(r, "%webView_inventory_no_results%"), [A, I] = _(!1), [C, V] = _("all"), [K, y] = _(""), [J, j] = _([]), Y = D(() => {
    const q = t ?? [];
  ...
  }, [A, Y]), $ = D(() => T.length === 0 ? [] : Cw(T, C, K), [T, C, K]), W = D(() => {
    var wt, at;
    if (!A) return l;
...
const Tw = "16rem", zw = "3rem", ki = Wt.createContext(void 0);
function ia() {
    ...
    Rw,
    {
      ...
      children: /* @__PURE__ */ u(Ow, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(Mw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a($w, { children: /* @__PURE__ */ a(
            Iw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const ze = "scrBook", Pw = "scrRef", qe = "source", jw = "details", Lw = "Scripture Reference", Bw = "Scripture Book", _i = "Type", Fw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, cn = (t) => `${Kw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Fp({
  sources: t,
  ...
  const [d, w] = _([]), [p, g] = _([{ id: ze, desc: !1 }]), [h, f] = _({}), x = D(
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const K = x.find((y) => cn(y) === V[0]) || void 0;
        K && c(K);
      }
    }
  }, [h, x, c, E]);
  const k = n ?? Bw, N = i ?? _i, O = [
  ...
  }, A = (C, V) => C.getIsGrouped() ? "" : m("banded-row", V % 2 === 0 ? "even" : "odd"), I = (C, V, K) => {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Re, { children: C.headers.filter((V) => V.column.columnDef.header).map((V) => (
                    ...
                    children: y.getIsGrouped() ? /* @__PURE__ */ u(
                      U,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ a(Ra, {}) : /* @__PURE__ */ a(Sa, {})),
                          " ",
...
const Ci = (t, e, r) => go(t, e).every((o) => r.includes(o));
function qw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [x, v] = _(!1), [E, k] = _(""), N = F(void 0), O = F(!1), B = D(
    () => Ni(t),
    [t]
  ), z = D(() => {
    if (!E.trim()) {
    ...
    y.preventDefault(), A(J, y.shiftKey);
  }, V = () => {
    r(B.map((y) => y));
  }, K = () => {
    r([]);
          ...
          Ie,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: V, children: l }),
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: K, children: d })
              ] }),
              /* @__PURE__ */ u(Ve, { children: [
                ...
                Object.values(dt).map((y, J) => {
                  ...
                  if (j.length !== 0)
                    return /* @__PURE__ */ u(ra, { children: [
                      ...
                      J < Object.values(dt).length - 1 && /* @__PURE__ */ a(gn, {})
                    ] }, y);
                })
              ] })
            ]
...
function Hw({
  ...
  const i = o["%webView_book_selector_more%"], s = D(
    ...
    (l) => {
      ...
      r(
        Ci(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ka ? ka : ln
      ).map((l) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Se(l, n) }, l)),
...
function Kp({
  ...
  const O = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = St(s, "%webView_scope_selector_verse%"), z = St(s, "%webView_scope_selector_chapter%"), A = St(s, "%webView_scope_selector_book%"), I = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), C = St(
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = St(s, "%webView_scope_selector_current_book%"), K = St(s, "%webView_scope_selector_choose_books%"), y = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), $ = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Dt = St(s, "%webView_scope_selector_navigate%"), Tt = (M) => {
    if (!f) return;
  ...
  ], q = (M, X, Yt = !1) => /* @__PURE__ */ u(ct, { children: [
    M,
  ...
  }, ut = F(null), bt = F(null), Ot = F(!1), Ft = F(null), Jt = F(!1), [fe, R] = _(void 0), yt = F(!1), Ct = F(!1), Zt = F(null), Ee = L((M) => {
    if (M) {
    ...
    (M) => {
      g == null || g(M), h == null || h(M), yt.current = !0;
    },
    [g, h]
  ), Q = L(
    (M) => {
  ...
  ), ht = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [gt, Mt] = _(!1), [zt, Ht] = _(void 0), [$t, je] = _(void 0), [S, At] = _(void 0), [xt, oe] = _(void 0), [Le, ur] = _([]), pr = d === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Hw,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", Be = d === "dropdown" && zt === "range", b = Be ? At : P, rt = Be ? oe : h ? Q : ae, It = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Ut, ce] = _(null), Ue = 200, [Mi, $i] = _(!1);
  H(() => {
    if (!Ut || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([X]) => {
      $i(X.contentRect.width < Ue);
    });
    return M.observe(Ut), () => M.disconnect();
  }, [Ut]);
  const fo = L(
    (M) => {
      je(M), At(at), oe(mt), ur(n), Mt(!1), Ht(M);
    },
    [at, mt, n]
  ), mo = L(() => {
    $t !== void 0 && ($t === "range" ? (S && (g == null || g(S)), xt && (h == null || h(xt))) : $t === "selectedBooks" && i(Le), et($t), Ht(void 0), je(void 0));
  }, [
    $t,
    S,
    xt,
  ...
  }, []), bo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Oe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Nt, { children: y }),
      d === "dropdown" ? /* @__PURE__ */ u(ye, { open: gt, onOpenChange: Mt, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            children: /* @__PURE__ */ u(sa, { container: Ut, children: [
              st.map(({ value: M, label: X, dropdownLabel: Yt, scrRefSuffix: fr, id: Ai }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: Te(M),
                  ...
                  children: [
                    t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Oe, { className: "tw:h-4 tw:w-4" }) }),
                    q(Yt ?? X, fr, Mi)
                  ]
                },
                Ai
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: Xe },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: l[Eo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ti = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(jt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(ts, { children: /* @__PURE__ */ a(es, { children: Ti(
      t,
      e,
      Ei(t, c.id),
      o
...
function Ba({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a($s, {}) }) }),
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ra, { children: [
      /* @__PURE__ */ a(pn, { children: /* @__PURE__ */ a(Vt, { children: Ti(e.groups, e.items, l, t) }) }),
...
const Si = Wt.forwardRef(({ className: t, ...e }, r) => {
  const o = pe();
  return /* @__PURE__ */ a(
    se.Root,
    {
...
const Ri = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.List,
  {
    ref: r,
    className: m(
...
Ri.displayName = se.List.displayName;
...
)), Di = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Content,
  {
    ref: r,
    className: m(
...
function Jp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Si, { children: [
      /* @__PURE__ */ a(Ri, { children: t.map((c) => /* @__PURE__ */ a(Xw, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (E = l.current) == null || E.focus(), vr(l, [g, h]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ a(Jw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Zw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(Vt, { children: Oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function th({
  ...
  const d = cu(
    ...
    var E, k, N, O, B, z;
    const v = x !== f ? ((k = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : k[x]) ?? ((O = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : O.en) : void 0;
...
function rh({
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(as, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(os, { children: /* @__PURE__ */ a(Zs, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ve, { children: [
