...
import { c as b, g as Re, a as zr, C as qe, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as Ie, f as ke, h as ze, i as tr, j as Be, B as J, x as vs, k as bs, l as xs, I as ys, m as _o, n as Ke, r as Ce, o as ks, p as Kn, P as er, q as _r, s as rr, t as ar, v as Ca, w as Ea, y as No, z as or, E as Ta, F as Mt, R as Co, G as ga, H as ao, J as oo, K as no, M as io, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as hr, W as _s, X as Ze, Y as Ue, Z as Pe, _ as je, $ as gr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as Gn, a5 as Ns, a6 as Cs, a7 as Es, a8 as so, a9 as qn, aa as Sa, ab as Ts, ac as Wn, ad as Ss, ae as Rs, af as Ds, ag as Qo, ah as Ms, ai as Os, aj as Is, ak as Yn, al as Xn, am as Do, an as zs, ao as Jn, ap as ja, aq as tn, ar as Fa, as as Ps, at as $s, au as As, av as Vs, aw as Ls, ax as Bs, ay as Fr, az as Mo, aA as js, aB as Fs } from "./resizable-B4e5BhTX.js";
import { aC as lf, aD as df, aE as wf, aF as uf, aG as pf, aH as hf, aI as gf, aJ as ff, aK as mf, aL as vf, aM as bf, aN as xf, aO as yf, aP as kf, aQ as _f, aR as Nf, aS as Cf, aT as Ef, aU as Tf, aV as Sf, aW as Rf, aX as Df, aY as Mf, aZ as Of, a_ as If, a$ as zf, b0 as Pf, b1 as $f, b2 as Af, b3 as Vf, b4 as Lf, b5 as Bf, b6 as jf, b7 as Ff, b8 as Uf, b9 as Kf, ba as Hf } from "./resizable-B4e5BhTX.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Zn, ChevronDown as Qe, ArrowLeft as Us, ArrowRight as Ks, BoldIcon as Hs, ItalicIcon as Gs, X as Oo, AtSign as Qn, Pencil as qs, Trash2 as Ws, ArrowUp as ti, MoreHorizontal as Ys, MailOpen as Xs, Mail as Js, FilterIcon as Zs, ArrowLeftIcon as Qs, ChevronLeftIcon as tc, ChevronRightIcon as ec, ArrowRightIcon as rc, Copy as ei, Filter as ac, User as oc, Link as nc, CircleHelp as ic, Undo as sc, Redo as cc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as lc, AlertCircle as co, CircleCheckIcon as dc, CircleXIcon as wc, CircleHelpIcon as uc, ArrowUpIcon as pc, ArrowDownIcon as hc, ScrollText as gc, ChevronRight as fc, ChevronLeft as mc, ChevronsUpDown as vc, MenuIcon as bc, Menu as xc, EllipsisVertical as yc, MoreVertical as kc } from "lucide-react";
...
import { GENERATOR_NOTE_CALLER as uo, HIDDEN_NOTE_CALLER as po, getDefaultViewOptions as Gl, isInsertEmbedOpOfType as Dr, getMarkerMenuItems as ql, defaultStyleInfo as Wl, Editorial as Yl } from "@eten-tech-foundation/platform-editor";
...
function Ga({
  ...
  const T = Ce(), B = rd(), [z, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [G, it] = _(
    void 0
...
function jd(t) {
  ...
  if (_e(e)) r = Wc(e.focus, "next");
    ...
    r = r || Yc(Ge(), "previous").getFlipped().insert(Hr());
  }
...
let xa, Me = 0, ya = 0, Gd = 0, bo = 0, da = 0;
function _n(t) {
  if (st === void 0) return;
  let e = t.n;
...
const aw = /* @__PURE__ */ new Set(), Sn = ue({ build(t, e, r) {
  ...
  return { watchNodeKey: function(i) {
    const c = qd(() => (s.value || aw).has(i)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(i);
    const w = d !== void 0;
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Yw, { ...G, conflictResolution: S }) : /* @__PURE__ */ a(rs, { ...G })
          },
          I.id
        );
      })
...
function Lh({
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Mu(O, D, W), [O, D, W]), G = V(() => {
    var vt, pt;
    if (!B) return l;
...
const Ve = "scrBook", Ku = "scrRef", Je = "source", Hu = "details", Gu = "Scripture Reference", qu = "Scripture Book", ns = "Type", Wu = "Details";
function Yu(t, e) {
  const r = e ?? !1;
  return [
    {
