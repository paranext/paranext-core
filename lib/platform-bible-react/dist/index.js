...
import { ChevronRight as be, Check as St, Circle as ve, X as xe, Search as Je, ChevronsUpDown as Ke, FilterIcon as Qn, ChevronDown as qt, ChevronUp as tr, ArrowLeftIcon as er, ChevronLeftIcon as nr, ChevronRightIcon as rr, ArrowRightIcon as ar, LoaderCircle as or, Download as sr, Filter as ir, User as wr, Link as lr, CircleHelp as dr, Star as cr, CircleCheckIcon as pr, CircleXIcon as ur, CircleHelpIcon as mr, ArrowUpIcon as hr, ArrowDownIcon as gr, ArrowUpDownIcon as fr, PanelLeft as br, PanelRight as vr, ScrollText as xr, ChevronLeft as yr, MenuIcon as Nr } from "lucide-react";
...
import { useReactTable as Ze, getFilteredRowModel as Tr, getSortedRowModel as Qe, getPaginationRowModel as _r, getCoreRowModel as tn, flexRender as Pt, getGroupedRowModel as zr, getExpandedRowModel as Er } from "@tanstack/react-table";
...
const ke = I.Trigger, rn = I.Group, Pr = I.Portal, Ar = I.Sub, Qo = I.RadioGroup;
...
function Le(t) {
  return `${D.bookIdToEnglishName(t.book)} ${t.chapterNum}:${t.verseNum}`;
}
function es({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = $(), [i, w] = B(""), [s, p] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, v] = B(!1), [x, y] = B(h), N = Z(void 0), k = Z(void 0), O = Z(void 0), j = tt(
    (C) => {
      const z = a ? a() : ze;
      return {
        OT: z.filter((P) => D.isBookOT(P)),
        NT: z.filter((P) => D.isBookNT(P)),
        DC: z.filter((P) => D.isBookDC(P))
      }[C].filter((P) => {
        const G = D.bookIdToEnglishName(P).toLowerCase(), F = i.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    na.forEach((C) => {
      const z = RegExp(C).exec(i);
      if (z) {
        const [P, G = void 0, F = void 0] = z.slice(1), It = oa(P);
        (D.isBookIdValid(P) || It) && b(
          It ?? P,
          !0,
          G ? parseInt(G, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    (C) => {
      h ? (C.key === "ArrowDown" || C.key === "ArrowUp") && (O != null && O.current ? O.current.focus() : k.current && k.current.focus(), C.preventDefault()) : v(!0);
    },
    [h]
  ), Mt = (C) => {
    const { key: z } = C;
  ...
  return ct(() => {
    ...
    const C = setTimeout(() => {
      if (x && k.current && O.current && !i) {
        const P = O.current.offsetTop - ea;
        k.current.scrollTo({ top: P, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(C);
    };
  }, [x, i]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ d(Kt, { modal: !1, open: h, onOpenChange: Et, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Br,
      {
        ...
        handleKeyDown: A,
        handleOnClick: () => {
          p(t.book), g(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), v(!0), w(Le(t)), N.current.focus();
        },
        onFocus: () => {
          at.current = !0;
        },
...
const sa = vt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, i) => /* @__PURE__ */ r(a ? Rt : "button", { className: l(sa({ variant: e, size: n, className: t })), ref: i, ...o })
);
M.displayName = "Button";
const ia = vt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(We.Root, { ref: n, className: l("pr-twp", ia(), t), ...e }));
...
mn.displayName = At.Root.displayName;
...
const hn = Xt.Root, gn = Xt.Trigger, Ee = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const i = $();
...
const wa = rt.Portal, fn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Overlay,
  {
    ref: n,
    className: l(
...
fn.displayName = rt.Overlay.displayName;
...
function me({
  ...
  const [y, N] = B(!1);
  return /* @__PURE__ */ d(hn, { open: y, onOpenChange: N, ...x, children: [
...
const Zt = c.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const te = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function ka({
  ...
  var y;
  const [s, p] = B([]), [u, m] = B([]), [f, g] = B({}), [h, v] = B({}), x = Ze({
    data: e,
    columns: t,
    getCoreRowModel: tn(),
...
const Yt = Ut(({ className: t, ...e }, n) => /* @__PURE__ */ r(or, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function _a({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ r("div", { className: l("pr-twp", Ta({ variant: e }), t), ...n });
}
function za({
  entries: t,
  ...
  const [m, f] = B(!1), g = tt(
    ...
    const x = t.filter((N) => N.starred).sort((N, k) => N.label.localeCompare(k.label)), y = t.filter((N) => !N.starred).sort((N, k) => {
      const O = n.includes(N.value), j = n.includes(k.value);
      return O && !j ? -1 : !O && j ? 1 : N.label.localeCompare(k.label);
    });
    return [...x, ...y];
  }, [t, n, s]);
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ d(hn, { open: m, onOpenChange: f, children: [
    /* @__PURE__ */ r(gn, { asChild: !0, children: /* @__PURE__ */ d(
      M,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Me, { children: [
      ...
      /* @__PURE__ */ d(Ve, { children: [
        ...
        /* @__PURE__ */ r(bn, { children: v.map((x) => {
...
function Ea({
  ...
  return /* @__PURE__ */ d(Zt, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(te, { children: i.length > 0 && i.map((w) => /* @__PURE__ */ d(
      dt,
      {
        onClick: () => {
          e(w.reference);
        ...
        children: [
          /* @__PURE__ */ r(kt, { children: `${D.bookIdToEnglishName(w.reference.book)} ${w.reference.chapterNum}:${w.reference.verseNum}` }),
...
), Ma = c.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  en.Root,
  {
    ref: o,
...
Ma.displayName = en.Root.displayName;
...
const ee = (t) => t === "asc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ms = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ d(kn, { value: w, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Lt,
        {
          onClick: () => ie(
  ...
  return e ? e[1] : "";
}, Ba = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fs = Object.freeze([
  ...
  return Va(t).forEach((m) => {
    m.startsWith("\\id") && (w = Da(m), s = 0, p = 0), m.startsWith("\\c") && (s = He(m), p = 0), m.startsWith("\\v") && (p = He(m), s === 0 && (s = e.chapterNum));
...
function bs({
  ...
  const f = ot(n, "%webView_inventory_all%"), g = ot(n, "%webView_inventory_approved%"), h = ot(n, "%webView_inventory_unapproved%"), v = ot(n, "%webView_inventory_unknown%"), x = ot(n, "%webView_inventory_scope_currentBook%"), y = ot(n, "%webView_inventory_scope_chapter%"), N = ot(n, "%webView_inventory_scope_verse%"), k = ot(n, "%webView_inventory_filter_text%"), O = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, it] = B(!1), [at, Et] = B("all"), [b, _] = B(""), [K, A] = B([]), Mt = Q(() => s ? a instanceof RegExp ? Pa(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((L) => {
  ...
  }, [j, Mt]), C = Q(() => Oa(pt, at, b), [pt, at, b]), z = Q(() => {
    var wt, ut;
    if (!j) return m;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(Y, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? O })
      ] })
    ] }),
...
const Aa = "16rem", Xa = "3rem", Cn = c.createContext(void 0);
function re() {
...
const Sn = c.forwardRef(
  ({
    ...
    const [u, m] = c.useState(t), f = e ?? u, g = c.useCallback(
      ...
      [n, f]
    ), h = c.useCallback(() => g((O) => !O), [g]), v = f ? "expanded" : "collapsed", N = $() === "ltr" ? w : w === "primary" ? "secondary" : "primary", k = c.useMemo(
      () => ({
        state: v,
        open: f,
        setOpen: g,
...
La.displayName = "SidebarSeparator";
  ...
  ({
    ...
    const p = t ? Rt : "button", { state: u } = re(), m = /* @__PURE__ */ r(
      p,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: l(Ua({ variant: n, size: a }), i),
        ...w
      }
    );
...
const lt = "scrBook", eo = "scrRef", ht = "source", no = "details", ro = "Scripture Reference", ao = "Scripture Book", Vn = "Type", oo = "Details";
function so(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, qe = (t) => `${io({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function xs({
  sources: t,
  ...
  ct(() => {
    if (s) {
      ...
      if (_.length === 1) {
        const K = v.find((A) => qe(A) === _[0]) || void 0;
        K && s(K);
      }
    }
  }, [g, v, s, y]);
  const N = o ?? ao, k = i ?? Vn, O = [
  ...
  }, at = (b, _) => b.getIsGrouped() ? "" : l("banded-row", _ % 2 === 0 ? "even" : "odd"), Et = (b, _, K) => {
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(fa, { children: O.map((b) => /* @__PURE__ */ r(W, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
...
const Bn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in s ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Pr, { children: /* @__PURE__ */ r(on, { children: Bn(
      t,
      e,
      Dn(t, s.id),
      a
...
function Ss({
  ...
  return /* @__PURE__ */ d(Kt, { variant: i, children: [
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ d(Jn, { children: [
      /* @__PURE__ */ r(rn, { children: /* @__PURE__ */ r(Ae, { children: Bn(e.groups, e.items, s, t) }) }),
...
function Rs({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(On, { children: [
      /* @__PURE__ */ r(Pn, { children: t.map((w) => /* @__PURE__ */ r(wo, { value: w.value, children: w.value }, w.key)) }),
...
function ho({
  ...
  if (Ir(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    ...
    return /* @__PURE__ */ r(Xn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(lo, { children: [
...
function zs({
  ...
  const p = go(
    ...
    var y, N, k, O, j, it;
    const x = v !== h ? ((N = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : N[v]) ?? ((O = (k = t[h]) == null ? void 0 : k.uiNames) == null ? void 0 : O.en) : void 0;
...
No.displayName = Tt.Root.displayName;
...
ko.displayName = Tt.Image.displayName;
...
Co.displayName = Tt.Fallback.displayName;
...
Mo.displayName = Ot.Root.displayName;
const Io = c.forwardRef(({ className: t, ...e }, n) => {
  const a = $();
  return /* @__PURE__ */ r(
    pe.Root,
    {
...
const Vs = q.Root, Vo = c.forwardRef(({ className: t, ...e }, n) => {
  const a = $();
  return /* @__PURE__ */ r(
    q.List,
    {
...
Vo.displayName = q.List.displayName;
...
Do.displayName = q.Trigger.displayName;
...
Bo.displayName = q.Content.displayName;
const Ds = (t, e) => {
  ct(() => {
    if (!t) return () => {
    };
...
export {
  ...
  l as cn,
  Da as getBookIdFromUSFM,
  Va as getLinesFromUSFM,
