...
import b, { forwardRef as tn, useRef as Q, useMemo as $, useState as D, useCallback as j, useLayoutEffect as $t, createContext as xn, useContext as fr, useEffect as U, Component as ds, createElement as Lr, Suspense as ps, createRef as us, Fragment as ho } from "react";
...
const Zo = q.allBookIds.filter(
  (e) => !q.isObsolete(q.bookIdToNumber(e))
), ce = Object.fromEntries(
  Zo.map((e) => [e, q.bookIdToEnglishName(e)])
);
function _r(e, t, n) {
...
function mp({
  ...
  const w = lt(), [p, f] = D(!1), [m, u] = D(""), [g, k] = D(""), [x, C] = D("books"), [_, y] = D(void 0), [R, A] = D(!1), E = Q(void 0), T = Q(void 0), M = Q(void 0), N = Q(void 0), S = Q({}), V = j(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
  ), B = $(() => r ? r() : Zo, [r]), F = $(() => ({
    [H.OT]: B.filter((z) => q.isBookOT(z)),
    [H.NT]: B.filter((z) => q.isBookNT(z)),
    [H.DC]: B.filter((z) => q.isBookDC(z)),
    [H.Extra]: B.filter((z) => q.extraBooks().includes(z))
    ...
    const { isLetter: z, isDigit: Z } = qr(v.key);
    (z || Z) && (v.preventDefault(), k((ct) => ct + v.key), T.current.focus(), A(!1));
  }, []);
  return $t(() => {
    const v = setTimeout(() => {
      if (p && x === "books" && M.current && N.current) {
        const z = M.current, Z = N.current, ct = Z.offsetTop, mt = z.clientHeight, re = Z.clientHeight, It = ct - mt / 2 + re / 2;
        z.scrollTo({
          top: Math.max(0, It),
          behavior: "smooth"
        }), u(or(e.book));
  ...
  }, [x, _, O, e.book, e.chapterNum]), /* @__PURE__ */ d(ge, { open: p, onOpenChange: dt, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
...
), it = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(_o.Root, { ref: n, className: h("pr-twp", kl(), e), ...t }));
...
function ar({
  ...
  const [_, y] = D(!1), R = c ?? l, A = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], E = (T, M) => {
    const N = l(T), S = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, V = `${M ?? ""}${N}${S ?? ""}`;
    return /* @__PURE__ */ d(
      zt,
      {
        value: N,
  ...
  return /* @__PURE__ */ d(ge, { open: _, onOpenChange: y, ...C, children: [
    ...
    Cr,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ o(it, { className: "tw-flex tw-items-center", children: r.map((x) => q.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ o(
            L,
            {
...
const bp = [
  ...
  const a = Q(null), [s, i] = D(void 0), [l, c] = D(void 0), w = j(
    ...
    (u) => {
      var T;
      const g = u.target, k = (M) => M ? document.getElementById(M) : void 0, x = k(l), C = k(s);
      if (!!(x && g && x.contains(g) && g !== x) && f(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const M = e.find((N) => N.id === l);
            M && w(M.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const N = M.findIndex((V) => V === g);
          if (N === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(N + 1, M.length - 1) : S = Math.max(N - 1, 0), S !== N && (u.preventDefault(), u.stopPropagation(), (T = M[S]) == null || T.focus());
          return;
        }
        return;
      }
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = ea ? $t : U, cn = { tag: gr };
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : U;
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : U;
function jl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = Ot(), n = $(() => e(t), [t, e]), [r, a] = D(() => n.initialValueFn()), s = Q(r);
    return Bl(() => {
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (Je(g)) {
                ...
                if (fn(x) && w >= 0 && p >= 0 && (C = w, _ = w + p, g.setTextNodeRange(x, C, x, _)), C === _ && f === "" || (g.insertRawText(f), x = k.getNode()), fn(x)) {
                  C = m, _ = m + u;
...
const Dr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : U;
...
const bw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : U;
function vw({ onClear: e }) {
  const [t] = Ot();
  return bw(() => wa(t, e), [t, e]), null;
}
const ga = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : U;
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: m, autoCapitalize: u, className: g, id: k, role: x = "textbox", spellCheck: C = !0, style: _, tabIndex: y, "data-testid": R, ...A }, E) {
  const [T, M] = D(e.isEditable()), N = j((V) => {
...
function Na(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], k = Na(e, g, m, r);
    !a && we(t) && k && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ii(p) || Hr(p)) && p.append(m), n.append(p), f) {
      const u = f.call(i, p);
...
function _a(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  for (let g = 0; g < f.length; g++) m.push(..._a(f[g], t, n, u, new Map(a), l));
  return p != null && (m = p(m)), Xr(e) && (m = $w(e, m, u ? () => {
    const g = new Mo();
    return n.push(g), g;
  } : Nn)), l == null ? m.length > 0 ? i = i.concat(m) : Xr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Kr(g.nextSibling) && Kr(g.previousSibling);
  }(e) && (i = i.concat(Oo())) : we(l) && l.append(...m), i;
}
function $w(e, t, n) {
...
function lo({
  ...
  const [f, m] = D(!1), [u, g] = D(), [k, x] = D(!1), C = Q(null);
  U(() => {
    let N = !0;
    if (!r) {
      x(!1);
    ...
    if (r && k)
      return /* @__PURE__ */ d(st, { children: [
        !Qs(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              m(!0), g(Bw(Fr(e.contents))), c == null || c(!0);
            },
            children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: C,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), _()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), Ht(u) && y());
              },
              onKeyDown: (N) => {
...
function Jw({
  ...
  const [C, _] = D(wo), [y, R] = D(!1), [A, E] = D(!1), [T, M] = D(!1), [N, S] = D(!1), [V, B] = D(!1), [F, I] = D(void 0), [W, O] = D(!1), [ot, yt] = D(!1);
  U(() => {
    let v = !0;
    if (!n) {
      O(!1), yt(!1);
...
function vp({
  ...
  const [m, u] = D(), g = t.filter(
    ...
    u(E);
  }, []), { listboxRef: _, activeId: y, handleKeyDown: R } = Rl({
    options: k,
    onOptionSelect: x
  }), A = j(
    (E) => {
...
function wc({
  ...
  var E;
  const [p, f] = D([]), [m, u] = D([]), [g, k] = D({}), [x, C] = D({}), _ = $(() => t ?? [], [t]), y = Po({
    data: _,
    columns: e,
    getCoreRowModel: Lo(),
  ...
  let A;
  return c ? A = Array.from({ length: 10 }).map((N, S) => `skeleton-row-${S}`).map((N) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(pe, { colSpan: R.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, N)) : ((E = y.getRowModel().rows) == null ? void 0 : E.length) > 0 ? A = y.getRowModel().rows.map((T) => /* @__PURE__ */ o(
    At,
    {
      onClick: () => i(T, y),
    ...
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: y.getHeaderGroups().map((T) => /* @__PURE__ */ o(At, { children: T.headers.map((M) => /* @__PURE__ */ o(Qe, { children: M.isPlaceholder ? void 0 : Xe(M.column.columnDef.header, M.getContext()) }, M.id)) }, T.id)) }),
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(ve, { children: [
    ...
    /* @__PURE__ */ o(ne, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Da, { children: w.itemType === 0 ? /* @__PURE__ */ o(st, { children: w.items.map((f, m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Yt,
        {
          checked: r[p][m],
...
function mc({
  ...
  return /* @__PURE__ */ o("div", { id: x, className: g, children: /* @__PURE__ */ d(ge, { open: M, onOpenChange: p ?? _, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: k,
...
function fc({
  ...
  const g = (x) => {
    ...
    var C, _, y, R;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((C = s.current) == null || C.focus(), l.current = !0) : document.activeElement === s.current && x.key === "ArrowUp" ? ((_ = i.current) == null || _.focus(), l.current = !1) : document.activeElement === s.current && x.key === "ArrowLeft" && ((y = s.current) == null ? void 0 : y.selectionStart) === 0 && ((R = i.current) == null || R.focus(), l.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
...
function Sp({
  ...
  U(() => {
    ...
    if (R && $n("note", R)) {
      ...
      let M = "custom";
      T === Qn ? M = "generated" : T === tr ? M = "hidden" : T && m(T), p(M), g(((E = R.insert.note) == null ? void 0 : E.style) ?? "f"), R.insert.note && (R.insert.note.caller = ""), y = setTimeout(() => {
        var N;
        (N = l.current) == null || N.applyUpdate([{ delete: 1 }, R]);
      }, 0);
    }
    return () => {
      y && clearTimeout(y);
  ...
  const x = j(() => {
    var R, A;
    const y = (A = (R = l.current) == null ? void 0 : R.getNoteOps(0)) == null ? void 0 : A.at(0);
    y && $n("note", y) && (y.insert.note && (w === "custom" ? y.insert.note.caller = f : y.insert.note.caller = w === "generated" ? Qn : tr), t([y]));
  }, [w, f, t]), C = () => {
    var R;
    const y = (R = c.current) == null ? void 0 : R.getElementsByClassName("editor-input")[0];
        ...
        /* @__PURE__ */ o(
          vc,
          {
            ...
            handleNoteTypeChange: (y) => {
              ...
              R && $n("note", R) && (R.insert.note && (R.insert.note.style = y), (T = l.current) == null || T.applyUpdate([{ delete: 1 }, R]));
            },
            localizedStrings: i
          }
        ),
...
function Nc({
  ...
  /* @__PURE__ */ d("span", { className: h("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    Ir(e.marker, [i], r, !1),
    " "
  ] }), m = t === "horizontal" ? "horizontal" : "vertical", u = r ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", k = h(m, u);
  return /* @__PURE__ */ d(st, { children: [
    /* @__PURE__ */ d("div", { className: h("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", k), children: [
      c,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: h("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", k), children: f }),
    /* @__PURE__ */ o(
      "div",
      {
        className: h(
...
function Rp({
  ...
  const p = c ?? ri(n, void 0), f = (_, y) => {
    w == null || w(_, y, a);
  }, m = s ? n.findIndex((_) => _ === s) : -1, [u, g] = D(m), k = (_, y, R) => {
    if (n.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), w == null || w(y, R, a);
          break;
      }
  }, x = (_) => {
    if (n.length)
        ...
        "ul",
        {
          ...
          children: n.map((_, y) => {
            ...
            return /* @__PURE__ */ d(st, { children: [
              ...
              y < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(Re, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
  ...
  return /* @__PURE__ */ d(En, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ o(Tn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      At,
      {
        ...
        children: [
          /* @__PURE__ */ o(pe, { children: `${q.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
function $p({
  ...
  const f = Tt(n, "%webView_inventory_all%"), m = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), k = Tt(n, "%webView_inventory_scope_currentBook%"), x = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), y = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), R = Tt(n, "%webView_inventory_no_results%"), [A, E] = D(!1), [T, M] = D("all"), [N, S] = D(""), [V, B] = D([]), F = $(() => {
    const P = e ?? [];
  ...
  }, [A, F]), W = $(() => I.length === 0 ? [] : Sc(I, T, N), [I, T, N]), O = $(() => {
    var dt, wt;
    if (!A) return c;
...
const La = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), f = t ?? w, m = b.useCallback(
      (y) => {
        const R = typeof y == "function" ? y(f) : y;
        n ? n(R) : p(R);
      },
      [n, f]
  ...
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? q.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Xt ? ke(a.start) : void 0;
      },
...
function zp({
  ...
  U(() => {
    if (l) {
      const N = C.getSelectedRowModel().rowsById, S = Object.keys(N);
      if (S.length === 1) {
        const V = k.find((B) => uo(B) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, k, l, C]);
  const _ = a ?? qc, y = s ?? Xa, R = [
  ...
  }, T = (N, S) => N.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), M = (N, S, V) => {
    if (!((N == null ? void 0 : N.length) === 0 || S.depth < V.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ d(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(fe, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: R.map((N) => /* @__PURE__ */ o(kt, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ o(At, { children: N.headers.filter((S) => S.column.columnDef.header).map((S) => (
      ...
      /* @__PURE__ */ o(Tn, { children: C.getRowModel().rows.map((N, S) => {
        const V = lt();
        return /* @__PURE__ */ o(
          At,
          {
...
function td({
  ...
  }, [x, C] = D(!1), [_, y] = D(""), R = Q(void 0), A = Q(!1);
  if (e.length !== q.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const E = $(() => q.allBookIds.filter(
    (I, W) => e[W] === "1" && !q.isObsolete(q.bookIdToNumber(I))
  ), [e]), T = $(() => {
    if (!_.trim()) {
      const O = {
        [H.OT]: [],
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: C.map(({ value: _, label: y, id: R }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(gn, { className: "tw-me-2", value: _, id: R }),
            /* @__PURE__ */ o(it, { htmlFor: R, children: y })
          ] }, R))
        }
      )
    ] }),
...
function Qp({
  ...
  const w = ld(
    ...
    var C, _, y, R, A, E;
    const x = k !== g ? ((_ = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : _[k]) ?? ((R = (y = e[g]) == null ? void 0 : y.uiNames) == null ? void 0 : R.en) : void 0;
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ o(Pe, { className: h(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(bo, {}) }) }),
...
const cd = tn(({ className: e, ...t }, n) => /* @__PURE__ */ o(Ks, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
