...
import b, { forwardRef as tn, useRef as Q, useMemo as $, useState as D, useCallback as j, useLayoutEffect as $t, createContext as xn, useContext as fr, useEffect as U, Component as ds, createElement as Br, Suspense as ps, createRef as us, Fragment as fo } from "react";
...
const Qo = q.allBookIds.filter(
  (e) => !q.isObsolete(q.bookIdToNumber(e))
), ce = Object.fromEntries(
  Qo.map((e) => [e, q.bookIdToEnglishName(e)])
);
function _r(e, t, n) {
...
function hp({
  ...
  const w = lt(), [p, f] = D(!1), [m, u] = D(""), [g, k] = D(""), [x, C] = D("books"), [_, y] = D(void 0), [E, I] = D(!1), R = Q(void 0), S = Q(void 0), O = Q(void 0), N = Q(void 0), T = Q({}), V = j(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
    ...
    (v) => {
      const z = x === "chapters" ? _ : M == null ? void 0 : M.book;
      z && (V({
        book: z,
        chapterNum: v,
        verseNum: 1
    ...
    (v) => {
      ...
      if ((x === "chapters" || x === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ct = x === "chapters" ? _ : M == null ? void 0 : M.book;
        if (!ct) return;
        const mt = (() => {
          if (!m) return 1;
          const Be = m.match(/(\d+)$/);
  ...
  }, [x, _, M, e.book, e.chapterNum]), /* @__PURE__ */ d(ge, { open: p, onOpenChange: dt, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
...
function ar({
  ...
  const [_, y] = D(!1), E = c ?? l, I = (S) => S.length > 0 && typeof S[0] == "object" && "options" in S[0], R = (S, O) => {
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = na ? $t : U, cn = { tag: gr };
...
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : U;
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: m, autoCapitalize: u, className: g, id: k, role: x = "textbox", spellCheck: C = !0, style: _, tabIndex: y, "data-testid": E, ...I }, R) {
...
function Jw({
  ...
  const [C, _] = D(co), [y, E] = D(!1), [I, R] = D(!1), [S, O] = D(!1), [N, T] = D(!1), [V, B] = D(!1), [F, A] = D(void 0), [W, M] = D(!1), [ot, yt] = D(!1);
  U(() => {
    let v = !0;
    if (!n) {
      M(!1), yt(!1);
  ...
  const _t = $(() => e.filter((v) => !v.deleted), [e]), bt = $(() => _t[0], [_t]), P = Q(null), tt = Q(void 0), dt = j(() => {
    var v;
    (v = tt.current) == null || v.call(tt), _(co);
  }, []);
  U(() => {
    const v = P.current;
    if (!v) return;
...
function wc({
  ...
  var R;
  const [p, f] = D([]), [m, u] = D([]), [g, k] = D({}), [x, C] = D({}), _ = $(() => t ?? [], [t]), y = $o({
    data: _,
    columns: e,
    getCoreRowModel: Bo(),
...
function mc({
  ...
  return /* @__PURE__ */ o("div", { id: x, className: g, children: /* @__PURE__ */ d(ge, { open: O, onOpenChange: p ?? _, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: k,
...
function fc({
  ...
  const g = (x) => {
    u(x), x || (c !== "custom" || p ? (t(c), r(p)) : (w(e), f(n)));
  }, k = (x) => {
    var C, _, y, E;
    (x.key === "ArrowDown" || x.key === "ArrowRight") && document.activeElement === i.current ? (C = s.current) == null || C.focus() : x.key === "ArrowUp" && document.activeElement === s.current ? (_ = i.current) == null || _.focus() : x.key === "ArrowLeft" && document.activeElement === s.current && ((y = s.current) == null ? void 0 : y.selectionStart) === 0 && ((E = i.current) == null || E.focus()), c === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
...
function ed({
  ...
  }, [x, C] = D(!1), [_, y] = D(""), E = Q(void 0), I = Q(!1);
  if (e.length !== q.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const R = $(() => q.allBookIds.filter(
    (A, W) => e[W] === "1" && !q.isObsolete(q.bookIdToNumber(A))
  ), [e]), S = $(() => {
    if (!_.trim()) {
      const M = {
        [H.OT]: [],
