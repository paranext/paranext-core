...
import { c as v, g as Re, a as zr, C as Ge, L as Kn, u as Qo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as Ie, f as ke, h as ze, i as kr, j as Be, B as Z, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ke, r as Ce, o as xs, p as Hn, P as tr, q as _r, s as er, t as rr, v as Na, w as Ca, y as No, z as ar, E as Ea, F as Mt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as qn, O as na, Q as Eo, S as Vr, U as Lr, V as pr, W as ys, X as Je, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as Gn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Yn, aa as Ta, ab as Cs, ac as Wn, ad as Es, ae as Ts, af as Ss, ag as tn, ah as Rs, ai as Ds, aj as Ms, ak as Xn, al as Zn, am as Do, an as Os, ao as Jn, ap as Ba, aq as en, ar as ja, as as Is, at as zs, au as Ps, av as As, aw as $s, ax as Fr, ay as Mo, az as Vs, aA as Ls } from "./resizable-CX9O3zuw.js";
import { aB as of, aC as nf, aD as sf, aE as cf, aF as lf, aG as df, aH as wf, aI as uf, aJ as pf, aK as hf, aL as gf, aM as ff, aN as mf, aO as vf, aP as bf, aQ as xf, aR as yf, aS as kf, aT as _f, aU as Nf, aV as Cf, aW as Ef, aX as Tf, aY as Sf, aZ as Rf, a_ as Df, a$ as Mf, b0 as Of, b1 as If, b2 as zf, b3 as Pf, b4 as Af, b5 as $f, b6 as Vf, b7 as Lf, b8 as Bf, b9 as jf, ba as Ff } from "./resizable-CX9O3zuw.js";
...
import { Section as Dt, compareScrRefs as ma, getChaptersForBook as xc, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as ia, formatRelativeDate as yc, sanitizeHtml as Io, NumberFormat as ii, formatBytes as kc, getCurrentLocale as _c, usfmMarkers as sa, isPlatformError as Nc, ABORTED as Cc, getErrorMessage as Ec, getFormatCallerFunction as Tc, deepEqual as Sc, isString as nn, scrRefToBBBCCCVVV as Fa, defaultScrRef as Ua, formatScrRefRange as Rc, getLocalizeKeyForScrollGroupId as sn, formatReplacementStringToArray as cn, collectUsjMarkers as Dc } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Sa, useState as _, useEffect as W, useCallback as j, useId as co, useImperativeHandle as Mc, useLayoutEffect as Zt, Fragment as Kr, Component as Oc, createElement as ln, Suspense as Ic, forwardRef as zo } from "react";
...
function Ha({
  ...
  const T = Ce(), B = Ql(), [z, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    ...
    if (!A) return;
    const m = M.startsWith(`${A.book} `) ? M : "", H = ta(m), at = Ir(m);
    return {
      book: A.book,
...
function Hd(t) {
  ...
  Ii(this), st = t, this.f &= -2, 8 & this.f && jo(this), Ma();
}
function ur(t, e) {
...
Wt.prototype.brand = jd, Wt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, zi(this), Cn(this), Me++;
  const t = st;
...
const Ow = "verseText", ih = Object.freeze([
...
function rs({
  ...
  const [U, tt] = _(Pn), [N, rt] = _(), [O, I] = _(), q = o, [it, ot] = _(!1), [dt, St] = _(!1), [J, lt] = _(!1), [vt, pt] = _(!1), [It, Ht] = _(!1), [wt, me] = _(E), [oe, bt] = _(!1), gt = F(void 0), [xt, qt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let y = !0;
    return (async () => {
      const $ = k ? await k(l) : !1;
...
const Gw = "data-platform-content-zoom-root", Yw = zo(
  function({ area: e, ...r }, o) {
    return /* @__PURE__ */ a(
      "div",
      {
...
Yw.displayName = "ContentZoomRoot";
function Ww({ table: t }) {
...
function lu({
  ...
  return /* @__PURE__ */ u(Ie, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: cu(t, o, e) }) }) }),
...
function uu({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: du(t, r) }) }) }),
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: wu(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(ze, { style: { zIndex: Yn }, children: [
...
function Eh({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, J] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
...
const Ve = "scrBook", Uu = "scrRef", Ze = "source", Ku = "details", Hu = "Scripture Reference", qu = "Scripture Book", ns = "Type", Gu = "Details";
function Yu(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, Fn = (t) => `${Wu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Zh({
  sources: t,
...
function Qh({
  ...
  ] }), pt = e ? lt.filter((L) => e.includes(L.value)) : lt, It = b ?? Ua, Ht = h ?? It, wt = g ?? It, me = () => {
...
Mp(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Gw as CONTENT_ZOOM_ROOT_ATTRIBUTE,
