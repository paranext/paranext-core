import { jsx as C, jsxs as Oe, Fragment as Sr } from "react/jsx-runtime";
...
function aa({
  ...
  let f;
  if (n) {
    const d = r === wt.Before || r === wt.Above, b = /* @__PURE__ */ C("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === wt.Before || r === wt.After, m = v ? b : /* @__PURE__ */ C("div", { children: b }), h = v ? p : /* @__PURE__ */ C("div", { children: p });
    f = /* @__PURE__ */ Oe(
      Bs,
      {
...
function Oa() {
  return Po || (Po = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(S) {
      return !!(typeof S == "string" || typeof S == "function" || S === n || S === o || $ || S === r || S === u || S === p || x || S === b || v || m || h || typeof S == "object" && S !== null && (S.$$typeof === d || S.$$typeof === f || S.$$typeof === i || S.$$typeof === a || S.$$typeof === c || // This needs to include all possible module reference object
  ...
  if (k) {
    if (i) {
      var G, L = E === "y" ? Te : we, I = E === "y" ? Ae : _e, R = E === "y" ? "height" : "width", j = k[E], Q = j + h[L], Z = j - h[I], O = b ? -D[R] / 2 : 0, M = $ === $t ? P[R] : D[R], F = $ === $t ? -D[R] : -P[R], K = t.elements.arrow, V = b && K ? Mr(K) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Fi(), W = U[L], q = U[I], H = Jt(0, P[R], V[R]), X = y ? P[R] / 2 - O - H - W - A.mainAxis : M - H - W - A.mainAxis, Y = y ? -P[R] / 2 + O + H + q + A.mainAxis : F + H + q + A.mainAxis, ne = t.elements.arrow && un(t.elements.arrow), N = ne ? E === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[E]) != null ? G : 0, S = j + X - J - N, re = j + Y - J, me = Jt(b ? Nn(Q, S) : Q, j, b ? ut(Z, re) : Z);
      k[E] = me, z[E] = me - j;
    }
    if (l) {
...
const is = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const k = Je({
    ...
    TransitionProps: J
  } = k, S = ce(k, Hp), re = /* @__PURE__ */ T.isValidElement(D) ? D : /* @__PURE__ */ C("span", {
    children: D
...
`));
  ...
  const $e = w({}, Lt, S, re.props, {
    className: Re(S.className, re.props.className),
    onTouchStart: oo,
    ref: Rs
  }, Z ? {
    onMouseMove: Ns
...
`));
  ...
  return /* @__PURE__ */ Oe(T.Fragment, {
    children: [/* @__PURE__ */ T.cloneElement(re, $e), /* @__PURE__ */ C(ao, w({
      as: q ?? os,
      placement: W,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ Oe(co, w({}, As, {
          children: [ne, P ? /* @__PURE__ */ C(uo, w({}, _s, {
            ref: ze
          })) : null]
        }))
      }))
...
const Yp = is;
function ii(e, t, n) {
  return e ? /* @__PURE__ */ C(Fs, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ C("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function Jp(e) {
  const {
    onClick: t,
    ...
    mi,
    {
      ...
      children: n ? /* @__PURE__ */ Oe(Sr, { children: [
        ii(i, n, !0),
        /* @__PURE__ */ C(Vs, { primary: n, inset: !i && o }),
        ii(a, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ C(Yp, { title: r, placement: "right", children: /* @__PURE__ */ C("div", { children: h }) }) : h;
}
function ss(e) {
...
function Zp(e) {
  ...
  return /* @__PURE__ */ Oe(Sr, { children: [
    /* @__PURE__ */ C(mi, { onClick: i, children: r.label }),
    /* @__PURE__ */ C(
      zs,
      {
        anchorEl: t,
...
function qr(e, t) {
  const { menuDefinition: n, onClick: r, commandHandler: o } = e, i = ((t == null ? void 0 : t.length) ?? 0) > 0 ? t : (
    // We're apparently laying out a single-column menu (presumably a context menu). In this
    // case, all groups should be included except ones that belong to a submenu.
    ss(n).filter((d) => !("menuItem" in d.group))
  ), a = Object.values(i).sort(
    (d, b) => (d.group.order || 0) - (b.group.order || 0)
  ), l = [];
  a.forEach((d) => {
    Qp(d.id, n.items).forEach(
  ...
  return /* @__PURE__ */ C("div", { role: "menu", "aria-label": f, children: (() => {
    const d = [];
    return l.forEach((b, v) => {
      ...
      if ("command" in m) {
        ...
        d.push(/* @__PURE__ */ C(Zp, { parentMenuItem: m, ...e }, f + m.id));
    }), d;
  })() }, f);
}
function ed(e) {
  ...
  return /* @__PURE__ */ Oe(
    gi,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ C(Us, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ C(
          ed,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Ad = (e) => {
  ...
  const a = Je({
    ...
    const J = Pn(c), S = J && J.nodeType === 1 ? J : xe(G.current).body, re = S.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
      const me = S.getBoundingClientRect();
...
`));
    ...
    const ot = ve + S.height, ye = fe + S.width, ze = en(Pn(c)), ke = ze.innerHeight - h, Ue = ze.innerWidth - h;
    if (h !== null && ve < h) {
      const ge = ve - h;
    ...
    if (process.env.NODE_ENV !== "production" && S.height > ke && S.height && ke && console.error(["MUI: The popover component is too tall.", `Some part of it can not be seen on the screen (${S.height - ke}px).`, "Please consider adding a `max-height` to improve the user-experience."].join(`
`)), h !== null && fe < h) {
      const ge = fe - h;
    ...
    if (!J)
      return;
    const S = Z(J);
    S.top !== null && (J.style.top = S.top), S.left !== null && (J.style.left = S.left), J.style.transformOrigin = S.transformOrigin, M(!0);
  }, [Z]);
  ...
  T.useEffect(() => {
    ...
    return S.addEventListener("resize", J), () => {
      J.clear(), S.removeEventListener("resize", J);
    };
  }, [c, x, F]);
  let U = P;
  ...
  return /* @__PURE__ */ C(q, w({}, N, !Mi(q) && {
    slotProps: ne,
    disableScrollLock: _
  }, {
    children: /* @__PURE__ */ C(k, w({
      appear: !0,
      in: x,
      onEntering: K,
      onExited: V,
...
function Sf({ scrRef: e, handleSubmit: t, id: n }) {
  ...
  return /* @__PURE__ */ Oe("span", { id: n, children: [
    ...
    /* @__PURE__ */ C(gt, { onClick: () => t(mo(e, 1)), children: ">" })
  ] });
}
function Cf({ onSearch: e, placeholder: t, isFullWidth: n }) {
  ...
  return /* @__PURE__ */ C(Hs, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ C(
    _n,
    {
      isFullWidth: n,
...
function di({ onRowChange: e, row: t, column: n }) {
  ...
  return /* @__PURE__ */ C(_n, { defaultValue: t[n.key], onChange: r });
}
const sf = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ C(
  aa,
  {
    ...r,
    isChecked: n,
...
function If({
  ...
  return /* @__PURE__ */ C("div", { ref: f, style: { position: "relative" }, children: /* @__PURE__ */ C(Ks, { position: "static", id: r, children: /* @__PURE__ */ Oe(Xs, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    m ? /* @__PURE__ */ C(
      bi,
      {
        edge: "start",
