import Il, { jsx as m, jsxs as V, Fragment as ut } from "react/jsx-runtime";
import * as T from "react";
import H, { forwardRef as Eo, useCallback as Ne, useState as fe, useRef as _t, useEffect as Ye, useLayoutEffect as ma, useMemo as Bn } from "react";
import { History as Al, ChevronRight as Dl, Check as ko, Circle as Bl, ArrowDownWideNarrow as jl, Clock as Ll, Bookmark as Vl, FilterIcon as Fl, ChevronDown as To, ChevronUp as zl, ArrowLeftIcon as Ul, ChevronLeftIcon as Hl, ChevronRightIcon as Gl, ArrowRightIcon as Wl, ArrowUpIcon as Xl, ArrowDownIcon as ql, ArrowUpDownIcon as Yl, X as Kl, Search as Jl, ChevronsUpDown as Zl, LoaderCircle as gr, Download as Ql, Filter as ec } from "lucide-react";
...
import { useReactTable as ki, getCoreRowModel as Ti, getPaginationRowModel as ac, getSortedRowModel as Ni, getFilteredRowModel as ic, flexRender as En, getExpandedRowModel as sc, getGroupedRowModel as lc } from "@tanstack/react-table";
...
import { FormControlLabel as ha, FormLabel as pc, Checkbox as uc, MenuItem as dc, ListItemText as fc, ListItemIcon as Oi, Menu as mc, Grid as Ci, List as hc, IconButton as Si, Drawer as gc, Slider as bc, Snackbar as vc, Switch as yc, AppBar as wc, Toolbar as xc } from "@mui/material";
...
var Sc = Object.defineProperty, Rc = (e, t, n) => t in e ? Sc(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, oe = (e, t, n) => Rc(e, typeof t != "symbol" ? t + "" : t, n);
const It = [
  "GEN",
  "EXO",
  "LEV",
...
const Ro = ge.Root, Di = ge.Trigger, Vc = ge.Group, bv = ge.Portal, vv = ge.Sub, yv = ge.RadioGroup, Fc = H.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ V(
  ge.SubTrigger,
  {
    ref: o,
    className: L(
...
const zc = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  ge.SubContent,
  {
    ref: n,
    className: L(
...
const vr = H.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ m(ge.Portal, { children: /* @__PURE__ */ m(
  ge.Content,
  {
    ref: r,
    sideOffset: t,
...
const Bi = H.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ m(
  ge.Item,
  {
    ref: r,
    className: L(
...
const Po = H.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ V(
  ge.CheckboxItem,
  {
    ref: o,
    className: L(
...
const ji = H.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ V(
  ge.RadioItem,
  {
    ref: r,
    className: L(
...
const jn = H.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ m(
  ge.Label,
  {
    ref: r,
...
const yr = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  ge.Separator,
  {
    ref: n,
...
function Wc({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ V(jn, { className: "pr-flex pr-justify-between", children: [
...
function wv({ scrRef: e, handleSubmit: t }) {
  const [n, r] = fe(""), [o, a] = fe(
    ...
    (k) => Kc(k).filter((R) => {
      const $ = me.bookIdToEnglishName(R).toLowerCase(), F = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    Yc.forEach((k) => {
      const R = n.match(k);
      if (R) {
        const [$, F = void 0, U = void 0] = R.slice(1), _ = Qc($);
  ...
  }, [g]), /* @__PURE__ */ m("div", { className: "pr-flex", children: /* @__PURE__ */ V(Ro, { modal: !1, open: f, onOpenChange: E, children: [
    ...
    /* @__PURE__ */ V(
      vr,
      {
        ...
        children: [
          ...
          va.map(
            (k, R) => x(k).length > 0 && /* @__PURE__ */ V("div", { children: [
              ...
              va.length - 1 !== R ? /* @__PURE__ */ m(yr, {}) : void 0
            ] }, k)
          )
        ]
      }
...
const ep = No(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ m(r ? cc : "button", { className: L(ep({ variant: t, size: n, className: e })), ref: a, ...o })
);
Oe.displayName = "Button";
function tp({ table: e }) {
  return /* @__PURE__ */ V(Ro, { children: [
    /* @__PURE__ */ m(rc, { asChild: !0, children: /* @__PURE__ */ V(Oe, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ m(Fl, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ V(vr, { align: "end", className: "pr-w-[150px]", children: [
...
const ir = we.Root, np = we.Group, sr = we.Value, Rn = H.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ V(
  we.Trigger,
  {
    ref: r,
    className: L(
...
const Li = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  we.ScrollUpButton,
  {
    ref: n,
...
const Vi = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  we.ScrollDownButton,
  {
    ref: n,
    className: L("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
...
const Pn = H.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ m(we.Portal, { children: /* @__PURE__ */ V(
  we.Content,
  {
    ref: o,
    className: L(
...
const rp = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  we.Label,
  {
    ref: n,
...
const Ke = H.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ V(
  we.Item,
  {
    ref: r,
    className: L(
    ...
    /* @__PURE__ */ V("div", { className: "pr-flex pr-items-center pr-space-x-2", children: [
      ...
      /* @__PURE__ */ V(
        ir,
        {
          ...
          children: [
            /* @__PURE__ */ m(Rn, { className: "pr-h-8 pr-w-[70px]", children: /* @__PURE__ */ m(sr, { placeholder: e.getState().pagination.pageSize }) }),
...
const wr = H.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => /* @__PURE__ */ m("div", { className: L("pr-relative pr-w-full", { "pr-overflow-auto": !t }), children: /* @__PURE__ */ m(
  "table",
  {
    ref: r,
...
const xr = H.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => /* @__PURE__ */ m(
  "thead",
  {
    ref: r,
    className: L(
...
const Er = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("tbody", { ref: n, className: L("[&_tr:last-child]:pr-border-0", e), ...t }));
...
const sp = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  "caption",
  {
    ref: n,
...
function lp({
  ...
  return /* @__PURE__ */ V("div", { className: "pr-twp pr-font-sans", children: [
    ...
    /* @__PURE__ */ V(wr, { stickyHeader: a, children: [
      /* @__PURE__ */ m(xr, { stickyHeader: a, children: u.getHeaderGroups().map((x) => /* @__PURE__ */ m(wt, { children: x.headers.map((S) => /* @__PURE__ */ m($n, { children: S.isPlaceholder ? void 0 : En(S.column.columnDef.header, S.getContext()) }, S.id)) }, x.id)) }),
      /* @__PURE__ */ m(Er, { children: (b = u.getRowModel().rows) != null && b.length ? u.getRowModel().rows.map((x) => /* @__PURE__ */ m(
        wt,
        {
          ...
          children: x.getVisibleCells().map((S) => /* @__PURE__ */ m(Kt, { children: En(S.column.columnDef.cell, S.getContext()) }, S.id))
        },
        x.id
      )) : /* @__PURE__ */ m(wt, { children: /* @__PURE__ */ m(Kt, { colSpan: e.length, className: "pr-h-24 pr-text-center", children: "No results." }) }) })
    ] }),
...
function cp({
  ...
  return Ye(
    () => d(wa(t, e, n, r)),
    [t, e, r, n]
  ), /* @__PURE__ */ V(wr, { stickyHeader: !0, children: [
    /* @__PURE__ */ m(xr, { stickyHeader: !0, children: /* @__PURE__ */ V(wt, { children: [
      /* @__PURE__ */ m($n, { children: i }),
      /* @__PURE__ */ m($n, { children: l })
    ] }) }),
    /* @__PURE__ */ m(Er, { children: c.map((f) => /* @__PURE__ */ V(
      wt,
      {
        onClick: () => {
          o(f.reference);
...
function kv({
  ...
  const F = Bn(() => pp(E, N, M), [E, N, M]), U = (_, z) => {
  ...
  return /* @__PURE__ */ V("div", { className: "pr-flex pr-h-full pr-flex-col", children: [
    /* @__PURE__ */ V("div", { className: "pr-flex", children: [
      /* @__PURE__ */ V(ir, { onValueChange: (_) => C(_), defaultValue: N, children: [
        /* @__PURE__ */ m(Rn, { className: "pr-m-1", children: /* @__PURE__ */ m(sr, { placeholder: "Select filter" }) }),
        /* @__PURE__ */ V(Pn, { className: "pr-font-sans", children: [
      ...
      /* @__PURE__ */ V(ir, { onValueChange: (_) => f(_), defaultValue: d, children: [
        /* @__PURE__ */ m(Rn, { className: "pr-m-1", children: /* @__PURE__ */ m(sr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ V(Pn, { className: "pr-font-sans", children: [
          /* @__PURE__ */ m(Ke, { value: "book", children: b }),
          /* @__PURE__ */ m(Ke, { value: "chapter", children: x }),
          /* @__PURE__ */ m(Ke, { value: "verse", children: S })
        ] })
      ] }),
      /* @__PURE__ */ m(
        br,
...
const dp = Sn.Root, fp = Sn.Trigger, Fi = H.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ m(Sn.Portal, { children: /* @__PURE__ */ m(
  Sn.Content,
  {
    ref: o,
    align: t,
...
Fi.displayName = Sn.Content.displayName;
const mp = Qe.Portal, zi = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  Qe.Overlay,
  {
    ref: n,
    className: L(
...
const hp = H.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ V(mp, { children: [
  /* @__PURE__ */ m(zi, {}),
  /* @__PURE__ */ V(
    Qe.Content,
    {
...
const Hi = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ V("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
...
const Wi = H.forwardRef((e, t) => /* @__PURE__ */ m(Ae.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
...
const yp = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  Ae.Separator,
  {
    ref: n,
...
const Xi = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  Ae.Item,
  {
    ref: n,
    className: L(
...
function xa({
  ...
  const [f, v] = fe(!1);
  return /* @__PURE__ */ V(dp, { open: f, onOpenChange: v, children: [
    /* @__PURE__ */ m(fp, { asChild: !0, children: /* @__PURE__ */ V(
      Oe,
      {
        variant: d,
        role: "combobox",
    ...
    /* @__PURE__ */ m(Fi, { className: "pr-w-[200px] pr-p-0", children: /* @__PURE__ */ V(Ui, { children: [
      /* @__PURE__ */ m(Hi, { placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ m(Wi, { children: c }),
      /* @__PURE__ */ m(Gi, { children: t.map((g) => /* @__PURE__ */ V(
        Xi,
        {
          value: a(g),
          onSelect: () => {
...
function Np() {
  ...
  return ce.AsyncMode = c, ce.ConcurrentMode = d, ce.ContextConsumer = l, ce.ContextProvider = i, ce.Element = t, ce.ForwardRef = f, ce.Fragment = r, ce.Lazy = h, ce.Memo = p, ce.Portal = n, ce.Profiler = a, ce.StrictMode = o, ce.Suspense = v, ce.isAsyncMode = function(y) {
    ...
    return typeof y == "string" || typeof y == "function" || y === r || y === d || y === a || y === o || y === v || y === g || typeof y == "object" && y !== null && (y.$$typeof === h || y.$$typeof === p || y.$$typeof === i || y.$$typeof === l || y.$$typeof === f || y.$$typeof === b || y.$$typeof === x || y.$$typeof === S || y.$$typeof === u);
  }, ce.typeOf = w, ce;
}
var pe = {};
/** @license React v16.13.1
...
function Op() {
  return ka || (ka = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(B) {
      ...
      B === r || B === d || B === a || B === o || B === v || B === g || typeof B == "object" && B !== null && (B.$$typeof === h || B.$$typeof === p || B.$$typeof === i || B.$$typeof === l || B.$$typeof === f || B.$$typeof === b || B.$$typeof === x || B.$$typeof === S || B.$$typeof === u);
    }
    function E(B) {
    ...
    var y = c, N = d, C = l, M = i, D = t, j = f, k = r, R = h, $ = p, F = n, U = a, _ = o, z = v, Q = !1;
    function Z(B) {
    ...
    pe.AsyncMode = y, pe.ConcurrentMode = N, pe.ContextConsumer = C, pe.ContextProvider = M, pe.Element = D, pe.ForwardRef = j, pe.Fragment = k, pe.Lazy = R, pe.Memo = $, pe.Portal = F, pe.Profiler = U, pe.StrictMode = _, pe.Suspense = z, pe.isAsyncMode = Z, pe.isConcurrentMode = O, pe.isContextConsumer = A, pe.isContextProvider = G, pe.isElement = X, pe.isForwardRef = W, pe.isFragment = q, pe.isLazy = K, pe.isMemo = J, pe.isPortal = Y, pe.isProfiler = ee, pe.isStrictMode = te, pe.isSuspense = ie, pe.isValidElementType = w, pe.typeOf = E;
  }()), pe;
}
var Ta;
function Ki() {
...
var Gr, Ca;
function Ji() {
  return Ca || (Ca = 1, Gr = Function.call.bind(Object.prototype.hasOwnProperty)), Gr;
}
var Wr, Sa;
function Sp() {
  if (Sa)
...
function Rp() {
  if (Ra)
    return Xr;
  Ra = 1;
  var e = Ki(), t = Cp(), n = _o(), r = Ji(), o = Sp(), a = function() {
  };
...
const Bp = on(s.elementType, Dp), jp = "exact-prop: ​";
function es(e) {
...
function Vp() {
  return _a || (_a = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), v = Symbol.for("react.memo"), g = Symbol.for("react.lazy"), p = Symbol.for("react.offscreen"), h = !1, u = !1, b = !1, x = !1, S = !1, w;
    w = Symbol.for("react.module.reference");
    function E(I) {
      return !!(typeof I == "string" || typeof I == "function" || I === n || I === o || S || I === r || I === d || I === f || x || I === p || h || u || b || typeof I == "object" && I !== null && (I.$$typeof === g || I.$$typeof === v || I.$$typeof === a || I.$$typeof === i || I.$$typeof === c || // This needs to include all possible module reference object
    ...
    var N = i, C = a, M = e, D = c, j = n, k = g, R = v, $ = t, F = o, U = r, _ = d, z = f, Q = !1, Z = !1;
    function O(I) {
    ...
    de.ContextConsumer = N, de.ContextProvider = C, de.Element = M, de.ForwardRef = D, de.Fragment = j, de.Lazy = k, de.Memo = R, de.Portal = $, de.Profiler = F, de.StrictMode = U, de.Suspense = _, de.SuspenseList = z, de.isAsyncMode = O, de.isConcurrentMode = A, de.isContextConsumer = G, de.isContextProvider = X, de.isElement = W, de.isForwardRef = q, de.isFragment = K, de.isLazy = J, de.isMemo = Y, de.isPortal = ee, de.isProfiler = te, de.isStrictMode = ie, de.isSuspense = B, de.isSuspenseList = ne, de.isValidElementType = E, de.typeOf = y;
  }()), de;
}
...
const Ru = qe("border", Ue), Pu = qe("borderTop", Ue), $u = qe("borderRight", Ue), _u = qe("borderBottom", Ue), Mu = qe("borderLeft", Ue), Iu = qe("borderColor"), Au = qe("borderTopColor"), Du = qe("borderRightColor"), Bu = qe("borderBottomColor"), ju = qe("borderLeftColor"), Lu = qe("outline", Ue), Vu = qe("outlineColor"), Sr = (e) => {
...
Cr(Ru, Pu, $u, _u, Mu, Iu, Au, Du, Bu, ju, Sr, Lu, Vu);
const Rr = (e) => {
...
Cr(Rr, Pr, $r, Fu, zu, Uu, Hu, Gu, Wu, Xu, qu, Yu);
function Yt(e, t) {
  return t === "grey" ? t : e;
}
const Ku = Ee({
...
function wd(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const S = Ec(i, P({
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${et(d || "")}`), k === void 0 && (k = `Styled(${Up(i)})`), j.displayName = k;
      }
...
const Sd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ht = Dd, Bd = ["mode", "contrastThreshold", "tonalOffset"], Ua = {
...
function Hd(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = he(e, Bd), a = e.primary || jd(t), i = e.secondary || Ld(t), l = e.error || Vd(t), c = e.info || Fd(t), d = e.success || zd(t), f = e.warning || Ud(t);
  function v(u) {
    const b = za(u, Kr.text.primary) >= n ? Kr.text.primary : Ua.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const x = za(u, b);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ha(u, "light", S, r), Ha(u, "dark", w, r), u.contrastText || (u.contrastText = v(u.main)), u;
  }, p = {
    dark: Kr,
    light: Ua
  };
...
function Xd(e, t) {
  ...
  const p = o / 14, h = v || ((x) => `${x / d * p}rem`), u = (x, S, w, E, y) => P({
    fontFamily: r,
    fontWeight: x,
    fontSize: h(S),
...
class zf {
  ...
  remove(t, n = !0) {
    ...
    if (a.modals.splice(a.modals.indexOf(t), 1), this.modals.splice(r, 1), a.modals.length === 0)
      a.restore && a.restore(), t.modalRef && Nn(t.modalRef, n), Za(a.container, t.mount, t.modalRef, a.hiddenSiblings, !1), this.containers.splice(o, 1);
    else {
...
function Wf(e) {
  const {
    ...
    open: f,
    rootRef: v
  } = e, g = T.useRef({}), p = T.useRef(null), h = T.useRef(null), u = Ge(h, v), [b, x] = T.useState(!f), S = Hf(c);
  let w = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (w = !1);
  const E = () => Se(p.current), y = () => (g.current.modalRef = h.current, g.current.mount = p.current, g.current), N = () => {
    o.mount(y(), {
      disableScrollLock: r
...
var Me = "top", We = "bottom", Xe = "right", Ie = "left", Uo = "auto", Un = [Me, We, Xe, Ie], Qt = "start", An = "end", Xf = "clippingParents", Ns = "viewport", mn = "popper", qf = "reference", Qa = /* @__PURE__ */ Un.reduce(function(e, t) {
  return e.concat([t + "-" + Qt, t + "-" + An]);
}, []), Os = /* @__PURE__ */ [].concat(Un, [Uo]).reduce(function(e, t) {
...
var Mt = Math.max, fr = Math.min, en = Math.round;
function fo() {
...
function tn(e, t, n) {
  ...
  var i = jt(e) ? Fe(e) : window, l = i.visualViewport, c = !Cs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, f = (r.top + (c && l ? l.offsetTop : 0)) / a, v = r.width / o, g = r.height / a;
  return {
    width: v,
    height: g,
    top: f,
...
function cm(e) {
  ...
  var o = Mr(e);
  for (Ho(o) && (o = o.host); He(o) && ["html", "body"].indexOf(tt(o)) < 0; ) {
    var a = pt(o);
...
function Hn(e) {
  for (var t = Fe(e), n = ei(e); n && lm(n) && pt(n).position === "static"; )
    n = ei(n);
...
var um = function(t, n) {
  ...
  })) : t, Ps(typeof t != "number" ? t : $s(t, Un));
};
function dm(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Ze(n.placement), c = Wo(l), d = [Ie, Xe].indexOf(l) >= 0, f = d ? "height" : "width";
  if (!(!a || !i)) {
    var v = um(o.padding, n), g = Go(a), p = c === "y" ? Me : Ie, h = c === "y" ? We : Xe, u = n.rects.reference[f] + n.rects.reference[c] - i[c] - n.rects.popper[f], b = i[c] - n.rects.reference[c], x = Hn(a), S = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, E = v[p], y = S - g[f] - v[h], N = S / 2 - g[f] / 2 + w, C = On(E, N, y), M = c;
    n.modifiersData[r] = (t = {}, t[M] = C, t.centerOffset = C - N, t);
  }
}
function fm(e) {
...
function ti(e) {
  ...
  if (d) {
    var N = Hn(n), C = "clientHeight", M = "clientWidth";
    if (N === Fe(n) && (N = kt(n), pt(N).position !== "static" && l === "absolute" && (C = "scrollHeight", M = "scrollWidth")), N = N, o === Me || (o === Ie || o === Xe) && a === An) {
      E = We;
  ...
  if (p = R.x, u = R.y, c) {
    var $;
    return Object.assign({}, k, ($ = {}, $[E] = S ? "0" : "", $[w] = x ? "0" : "", $.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + u + "px)" : "translate3d(" + p + "px, " + u + "px, 0)", $));
  }
  return Object.assign({}, k, (t = {}, t[E] = S ? u + "px" : "", t[w] = x ? p + "px" : "", t.transform = "", t));
}
function bm(e) {
...
function qo(e) {
  return tn(kt(e)).left + Xo(e).scrollLeft;
}
function km(e, t) {
...
function _s(e) {
  return ["html", "body", "#document"].indexOf(tt(e)) >= 0 ? e.ownerDocument.body : He(e) && Yo(e) ? e : _s(Mr(e));
}
function Cn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = _s(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), a = Fe(r), i = o ? [a].concat(a.visualViewport || [], Yo(r) ? r : []) : r, l = t.concat(i);
  return o ? l : (
...
function Om(e) {
  var t = Cn(Mr(e)), n = ["absolute", "fixed"].indexOf(pt(e).position) >= 0, r = n && He(e) ? Hn(e) : e;
  return jt(r) ? t.filter(function(o) {
    return jt(o) && Ss(o, r) && tt(o) !== "body";
  }) : [];
}
function Cm(e, t, n, r) {
...
function Dn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Xf : l, d = n.rootBoundary, f = d === void 0 ? Ns : d, v = n.elementContext, g = v === void 0 ? mn : v, p = n.altBoundary, h = p === void 0 ? !1 : p, u = n.padding, b = u === void 0 ? 0 : u, x = Ps(typeof b != "number" ? b : $s(b, Un)), S = g === mn ? qf : mn, w = e.rects.popper, E = e.elements[h ? S : g], y = Cm(jt(E) ? E : E.contextElement || kt(e.elements.popper), c, f, i), N = tn(e.elements.reference), C = Ms({
    reference: N,
    element: w,
    strategy: "absolute",
    placement: o
  }), M = mo(Object.assign({}, w, C)), D = g === mn ? M : N, j = {
  ...
  if (g === mn && k) {
    ...
    Object.keys(j).forEach(function($) {
      var F = [Xe, We].indexOf($) >= 0 ? 1 : -1, U = [Me, We].indexOf($) >= 0 ? "y" : "x";
      j[$] += R[U] * F;
    });
  }
  return j;
...
function Sm(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Os : c, f = nn(r), v = f ? l ? Qa : Qa.filter(function(h) {
    return nn(h) === f;
...
function Pm(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, f = n.boundary, v = n.rootBoundary, g = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, u = n.allowedAutoPlacements, b = t.options.placement, x = Ze(b), S = x === b, w = c || (S || !h ? [rr(b)] : Rm(b)), E = [b].concat(w).reduce(function(W, q) {
      return W.concat(Ze(q) === Uo ? Sm(t, {
        placement: q,
        boundary: f,
        rootBoundary: v,
        padding: d,
    ...
    }, []), y = t.rects.reference, N = t.rects.popper, C = /* @__PURE__ */ new Map(), M = !0, D = E[0], j = 0; j < E.length; j++) {
      var k = E[j], R = Ze(k), $ = nn(k) === Qt, F = [Me, We].indexOf(R) >= 0, U = F ? "width" : "height", _ = Dn(t, {
        placement: k,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
...
function Vm(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, f = n.altBoundary, v = n.padding, g = n.tether, p = g === void 0 ? !0 : g, h = n.tetherOffset, u = h === void 0 ? 0 : h, b = Dn(t, {
    ...
    padding: v,
    altBoundary: f
  }), x = Ze(t.placement), S = nn(t.placement), w = !S, E = Wo(x), y = Lm(E), N = t.modifiersData.popperOffsets, C = t.rects.reference, M = t.rects.popper, D = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, j = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (N) {
    if (a) {
      var $, F = E === "y" ? Me : Ie, U = E === "y" ? We : Xe, _ = E === "y" ? "height" : "width", z = N[E], Q = z + b[F], Z = z - b[U], O = p ? -M[_] / 2 : 0, A = S === Qt ? C[_] : M[_], G = S === Qt ? -M[_] : -C[_], X = t.elements.arrow, W = p && X ? Go(X) : {
        width: 0,
        height: 0
      }, q = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Rs(), K = q[F], J = q[U], Y = On(0, C[_], W[_]), ee = w ? C[_] / 2 - O - Y - K - j.mainAxis : A - Y - K - j.mainAxis, te = w ? -C[_] / 2 + O + Y + J + j.mainAxis : G + Y + J + j.mainAxis, ie = t.elements.arrow && Hn(t.elements.arrow), B = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, ne = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, I = z + ee - ne - B, se = z + te - ne, ke = On(p ? fr(Q, I) : Q, z, p ? Mt(Z, se) : Z);
      N[E] = ke, R[E] = ke - z;
    }
    if (l) {
      var Pe, xe = E === "x" ? Me : Ie, Tt = E === "x" ? We : Xe, $e = N[y], rt = y === "y" ? "height" : "width", Be = $e + b[xe], ot = $e - b[Tt], Te = [Me, Ie].indexOf(x) !== -1, Lt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, Nt = Te ? Be : $e - C[rt] - M[rt] - Lt + j.altAxis, an = Te ? $e + C[rt] + M[rt] - Lt - j.altAxis : ot, Wn = p && Te ? pm(Nt, $e, an) : On(p ? Nt : Be, $e, p ? an : ot);
      N[y] = Wn, R[y] = Wn - $e;
    }
    t.modifiersData[r] = R;
  }
...
function Gm(e, t, n) {
  n === void 0 && (n = !1);
  var r = He(t), o = He(t) && Hm(t), a = kt(t), i = tn(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Yo(a)) && (l = Um(t)), He(t) ? (c = tn(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = qo(a))), {
    ...
    var f = {
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (si(S, w)) {
            f.rects = {
              reference: Gm(S, Hn(w), f.options.strategy === "fixed"),
              popper: Go(w)
            ...
            for (var E = 0; E < f.orderedModifiers.length; E++) {
              ...
              var y = f.orderedModifiers[E], N = y.fn, C = y.options, M = C === void 0 ? {} : C, D = y.name;
...
const oh = () => dt({
  ...
  } = t, b = he(t, eh), x = T.useRef(null), S = Ge(x, n), w = T.useRef(null), E = Ge(w, g), y = T.useRef(E);
  At(() => {
    y.current = E;
  }, [E]), T.useImperativeHandle(g, () => w.current, []);
  const N = nh(f, i), [C, M] = T.useState(N), [D, j] = T.useState(mr(o));
  T.useEffect(() => {
...
`));
  ...
  const R = oh(), $ = (r = h.root) != null ? r : "div", F = Bt({
    elementType: $,
  ...
  const {
    ...
    slotProps: b = {},
    slots: x = {}
  } = t, S = he(t, th), [w, E] = T.useState(!0), y = () => {
    E(!1);
  }, N = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const j = mr(r);
    C = j && Ir(j) ? Se(j).body : Se(null).body;
  }
...
const Ds = H.createContext(null);
var ch = function(t) {
  return t.scrollTop;
}, xn = "unmounted", Ct = "exited", St = "entering", qt = "entered", go = "exiting", mt = /* @__PURE__ */ function(e) {
  sh(t, e);
  function t(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== St && i !== qt && (a = St) : (i === St || i === qt) && (a = go);
    }
    ...
    return (
      ...
      /* @__PURE__ */ H.createElement(Ds.Provider, {
        value: null
...
const uh = {
  ...
  const {
  ...
  } = t, x = he(t, ph), S = yn(), w = T.useRef(), E = Gn(), y = T.useRef(null), N = Ge(y, a.ref, n), C = (U) => (_) => {
    if (U) {
      const z = y.current;
      _ === void 0 ? U(z) : U(z, _);
    }
    ...
    u === "auto" ? (Z = E.transitions.getAutoHeightDuration(U.clientHeight), w.current = Z) : Z = _, U.style.transition = [E.transitions.create("opacity", {
      ...
      duration: Zr ? Z : Z * 0.666,
      delay: Zr ? z : z || Z * 0.333,
      easing: Q
  ...
  return /* @__PURE__ */ m(b, P({
    ...
    onExiting: k,
    addEndListener: (U) => {
      u === "auto" && S.start(w.current || 0, U), r && r(y.current, U);
    },
...
const vo = Ko, dh = (e) => {
...
}, ci = dh, fh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], mh = Re(As, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = gs(), a = ft({
    ...
    slots: w,
    slotProps: E
  } = a, y = he(a, fh), N = (r = w == null ? void 0 : w.root) != null ? r : c == null ? void 0 : c.Root, C = P({
    anchorEl: i,
    container: f,
    disablePortal: v,
    keepMounted: g,
...
const Fs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  var r, o, a, i, l, c, d, f, v, g, p, h, u, b, x, S, w, E, y;
  const N = ft({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: ne
  } = N, I = he(N, bh), se = /* @__PURE__ */ T.isValidElement(M) ? M : /* @__PURE__ */ m("span", {
    children: M
  }), ke = Gn(), Pe = ke.direction === "rtl", [xe, Tt] = T.useState(), [$e, rt] = T.useState(null), Be = T.useRef(!1), ot = F || Z, Te = yn(), Lt = yn(), Nt = yn(), an = yn(), [Wn, ea] = os({
    controlled: q,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const ta = (re) => {
    ...
    (re) => {
      pi.start(800 + A, () => {
        Qn = !1;
      }), ea(!1), X && at && X(re), Te.start(ke.transitions.duration.shortest, () => {
        Be.current = !1;
      });
    }
  ), Dr = (re) => {
    Be.current && re.type !== "touchstart" || (xe && xe.removeAttribute("title"), Lt.clear(), Nt.clear(), _ || Qn && z ? Lt.start(Qn ? z : _, () => {
      ta(re);
    }) : ta(re));
  }, na = (re) => {
    Lt.clear(), Nt.start(A, () => {
    ...
    sa(re), Nt.clear(), Te.clear(), Xn(), sn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", an.start(Q, () => {
      document.body.style.WebkitUserSelect = sn.current, Dr(re);
    });
  }, Ol = (re) => {
    se.props.onTouchEnd && se.props.onTouchEnd(re), Xn(), Nt.start(G, () => {
      qn(re);
    });
  };
  T.useEffect(() => {
    if (!at)
      return;
    function re(je) {
      (je.key === "Escape" || je.key === "Esc") && qn(je);
    }
    return document.addEventListener("keydown", re), () => {
      document.removeEventListener("keydown", re);
    };
  }, [qn, at]);
  const Cl = Ge(se.ref, Tl, Tt, n);
  !ie && ie !== 0 && (at = !1);
  const Br = T.useRef(), Sl = (re) => {
    const je = se.props;
...
`));
  ...
  const cn = {};
  U || (ze.onTouchStart = Nl, ze.onTouchEnd = Ol), $ || (ze.onMouseOver = er(la, ze.onMouseOver), ze.onMouseLeave = er(ca, ze.onMouseLeave), ot || (cn.onMouseOver = la, cn.onMouseLeave = ca)), R || (ze.onFocus = er(ia, ze.onFocus), ze.onBlur = er(aa, ze.onBlur), ot || (cn.onFocus = ia, cn.onBlur = aa)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Rl = T.useMemo(() => {
    var re;
    let je = [{
    ...
    touch: Be.current
  }), Lr = yh(pn), pa = (r = (o = te.popper) != null ? o : D.Popper) != null ? r : wh, ua = (a = (i = (l = te.transition) != null ? l : D.Transition) != null ? i : B) != null ? a : vo, da = (c = (d = te.tooltip) != null ? d : D.Tooltip) != null ? c : xh, fa = (f = (v = te.arrow) != null ? v : D.Arrow) != null ? f : Eh, Pl = wn(pa, P({}, Y, (g = ee.popper) != null ? g : j.popper, {
    className: Ce(Lr.popper, Y == null ? void 0 : Y.className, (p = (h = ee.popper) != null ? h : j.popper) == null ? void 0 : p.className)
  }), pn), $l = wn(ua, P({}, ne, (u = ee.transition) != null ? u : j.transition), pn), _l = wn(da, P({}, (b = ee.tooltip) != null ? b : j.tooltip, {
    className: Ce(Lr.tooltip, (x = (S = ee.tooltip) != null ? S : j.tooltip) == null ? void 0 : x.className)
  }), pn), Ml = wn(fa, P({}, (w = ee.arrow) != null ? w : j.arrow, {
    className: Ce(Lr.arrow, (E = (y = ee.arrow) != null ? y : j.arrow) == null ? void 0 : E.className)
  }), pn);
  return /* @__PURE__ */ V(T.Fragment, {
    children: [/* @__PURE__ */ T.cloneElement(se, ze), /* @__PURE__ */ m(pa, P({
      as: J ?? Vs,
      placement: K,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ V(da, P({}, _l, {
          children: [ie, C ? /* @__PURE__ */ m(fa, P({}, Ml, {
            ref: rt
          })) : null]
        }))
      }))
...
function zs(e) {
  const {
    ...
    dc,
    {
      ...
      onClick: t,
      id: u,
      children: n ? /* @__PURE__ */ V(ut, { children: [
        ui(a, n, !0),
...
function Th(e) {
  const [t, n] = fe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = e, i = (d) => {
    ...
    let d = Us(a).filter((f) => "menuItem" in f.group);
    if (!(r != null && r.id))
...
const Xs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const u = (w) => {
    const E = p.current, y = w.key, N = Se(E).activeElement;
    if (y === "ArrowDown")
      w.preventDefault(), gn(E, N, d, c, Qr);
    else if (y === "ArrowUp")
      w.preventDefault(), gn(E, N, d, c, di);
    else if (y === "Home")
      w.preventDefault(), gn(E, null, d, c, Qr);
    else if (y === "End")
      w.preventDefault(), gn(E, null, d, c, di);
    else if (y.length === 1) {
      const C = h.current, M = y.toLowerCase(), D = performance.now();
      C.keys.length > 0 && (D - C.lastTime > 500 ? (C.keys = [], C.repeating = !0, C.previousKeyMatched = !0) : C.repeating && M !== C.keys[0] && (C.repeating = !1)), C.lastTime = D, C.keys.push(M);
      const j = N && !C.repeating && Ws(N, C);
      C.previousKeyMatched && (j || gn(E, N, !1, c, Qr, C)) ? w.preventDefault() : C.previousKeyMatched = !1;
    }
    f && f(w);
  }, b = Ge(p, n);
  let x = -1;
...
const Dh = Xs, Bh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], jh = {
  ...
  const r = Gn(), o = {
    ...
    timeout: x = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: S = Bs
  } = t, w = he(t, Bh), E = T.useRef(null), y = Ge(E, l.ref, n), N = (F) => (U) => {
    if (F) {
      const _ = E.current;
      U === void 0 ? F(_) : F(_, U);
    }
    ...
    F.style.webkitTransition = r.transitions.create("opacity", _), F.style.transition = r.transitions.create("opacity", _), f && f(F, U);
  }), D = N(v), j = N(u), k = N((F) => {
    const U = hr({
      style: b,
      timeout: x,
    ...
    F.style.webkitTransition = r.transitions.create("opacity", U), F.style.transition = r.transitions.create("opacity", U), p && p(F);
  }), R = N(h);
  return /* @__PURE__ */ m(S, P({
    ...
    children: (F, U) => /* @__PURE__ */ T.cloneElement(l, P({
      style: P({
        opacity: 0,
        visibility: F === "exited" && !d ? "hidden" : void 0
      }, jh[F], b, l.props.style),
      ref: y
    }, U))
  }));
});
...
const Wh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Xh = (e) => {
  ...
  const J = (r = (o = F == null ? void 0 : F.root) != null ? o : x.Root) != null ? r : qh, Y = (a = (i = F == null ? void 0 : F.backdrop) != null ? i : x.Backdrop) != null ? a : f, ee = (l = $ == null ? void 0 : $.root) != null ? l : S.root, te = (c = $ == null ? void 0 : $.backdrop) != null ? c : S.backdrop, ie = Bt({
    elementType: J,
    ...
    ownerState: W,
    className: Ce(g, ee == null ? void 0 : ee.className, q == null ? void 0 : q.root, !W.open && W.exited && (q == null ? void 0 : q.hidden))
  }), B = Bt({
    elementType: Y,
    ...
    className: Ce(te == null ? void 0 : te.className, v == null ? void 0 : v.className, q == null ? void 0 : q.backdrop),
    ownerState: W
  });
  return !j && !R && (!X || G) ? null : /* @__PURE__ */ m(In, {
    ...
    children: /* @__PURE__ */ V(J, P({}, ie, {
      children: [!D && f ? /* @__PURE__ */ m(Y, P({}, B)) : null, /* @__PURE__ */ m(dr, {
        disableEnforceFocus: E,
        disableAutoFocus: w,
        disableRestoreFocus: C,
        isEnabled: A,
...
const ig = (e) => {
  ...
  const i = ft({
  ...
  } = i, j = he(i.TransitionProps, rg), k = he(i, og), R = (r = E == null ? void 0 : E.paper) != null ? r : S, $ = T.useRef(), F = Ge($, R.ref), U = P({}, i, {
    anchorOrigin: d,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
    ...
    const ne = or(c), I = ne && ne.nodeType === 1 ? ne : Se($.current).body, se = I.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const Tt = Pe + I.height, $e = xe + I.width, rt = Zt(or(c)), Be = rt.innerHeight - b, ot = rt.innerWidth - b;
    if (b !== null && Pe < b) {
      const Te = Pe - b;
...
`)), b !== null && xe < b) {
  ...
  let q = C;
  C === "auto" && !N.muiSupportAuto && (q = void 0);
  const K = h || (c ? Se(or(c)).body : void 0), J = (o = w == null ? void 0 : w.root) != null ? o : sg, Y = (a = w == null ? void 0 : w.paper) != null ? a : Zs, ee = Bt({
    elementType: Y,
    ...
    ownerState: U,
    className: Ce(_.paper, R == null ? void 0 : R.className)
  }), te = Bt({
    elementType: J,
...
const pg = ["onEntering"], ug = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], dg = {
  ...
  const a = ft({
    ...
    slots: S = {},
    slotProps: w = {}
  } = a, E = he(a.TransitionProps, pg), y = he(a, ug), N = Gn(), C = N.direction === "rtl", M = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: x
  }), D = mg(M), j = i && !d && g, k = T.useRef(null), R = (Z, O) => {
  ...
  T.Children.map(l, (Z, O) => {
    /* @__PURE__ */ T.isValidElement(Z) && (process.env.NODE_ENV !== "production" && lr.isFragment(Z) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), Z.props.disabled || (x === "selectedMenu" && Z.props.selected || F === -1) && (F = O));
  });
  const U = (r = S.paper) != null ? r : gg, _ = (o = w.paper) != null ? o : p, z = Bt({
    elementType: S.root,
...
function xg({
  ...
  Ye(() => {
    if (c) {
      ...
      if (E) {
        const y = E.getBoundingClientRect(), N = window.scrollY, C = window.scrollX, M = y.top + N + E.clientHeight, D = y.left + C;
        b({ top: M, left: D });
      }
    }
  }, [c, o]);
...
function Sv({
  ...
  return /* @__PURE__ */ V("div", { className: "pr-twp pr-flex pr-h-full pr-w-full pr-flex-col", children: [
    !t && /* @__PURE__ */ V(
      ir,
      {
        ...
        children: [
          /* @__PURE__ */ m(Rn, { className: "pr-mb-1 pr-mt-2", children: /* @__PURE__ */ m(sr, {}) }),
          /* @__PURE__ */ m(Pn, { position: "item-aligned", children: /* @__PURE__ */ m(np, { children: N.map((k) => /* @__PURE__ */ m(Ke, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ V(wr, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ m(xr, { children: w.getHeaderGroups().map((k) => /* @__PURE__ */ m(wt, { children: k.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ m($n, { colSpan: R.colSpan, className: "top-0 pr-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ V("div", { children: [
      ...
      /* @__PURE__ */ m(Er, { children: w.getRowModel().rows.map((k, R) => /* @__PURE__ */ m(
        wt,
        {
...
), nl = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(Ri.Root, { ref: n, className: L(Sg(), e), ...t }));
...
function Mv({
  ...
  const a = _t(void 0);
  return /* @__PURE__ */ m("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ m(wc, { position: "static", id: r, children: /* @__PURE__ */ V(xc, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ m(
      xg,
      {
        commandHandler: t,
...
const Iv = De.Root, Pg = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.List,
  {
    ref: n,
    className: L(
...
const Mg = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.Root,
  {
...
const Ig = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.List,
  {
    ref: n,
    className: L(
...
const Av = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.Trigger,
  {
    ref: n,
    ...t,
...
)), Ag = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.Content,
  {
    ref: n,
    className: L(
...
function Dv({
  ...
  return /* @__PURE__ */ m(
    Oe,
    {
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ m(gr, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ V(ut, { children: [
        /* @__PURE__ */ m(Ql, { size: 25, className: L("pr-h-4 pr-w-4", { "pr-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Bv({ isEnabling: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    Oe,
    {
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ V(ut, { children: [
...
function yi(e, t) {
  const n = t === 1, r = n ? yl : wl, o = n ? gl : bl, a = n ? Ob : Cb;
  return { t(i, l, c) {
    const d = Nb.exec(c);
...
`).match(o);
    ...
    return { p: f.map(function(g, p) {
      const h = a.exec(g)[0].length, u = new RegExp("^ {1," + h + "}", "gm"), b = g.replace(u, "").replace(a, ""), x = p === f.length - 1, S = b.indexOf(`

`) !== -1 || x && v;
      v = S;
      const w = c._, E = c.o;
      let y;
      c.o = !0, S ? (c._ = !1, y = b.replace(vi, `
...
const Sb = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Rb = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, xl = [rl, ol, al, il, ll, sl, cl, pl, gl, yl, bl, wl], Pb = [...xl, /^[^\n]+(?:  \n|\n{2,})/, wo, xo];
function $b(e) {
...
function jb(e, t = {}) {
  ...
  function r(p, h, ...u) {
    ...
    return n(function(x, S) {
      const w = ro(S, x);
      return w ? typeof w == "function" || typeof w == "object" && "render" in w ? w : ro(S, `${x}.component`, x) : x;
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, x) {
      ...
      if (S !== -1) {
        const w = function(C) {
          return C.indexOf("-") !== -1 && C.match(Zg) === null && (C = C.replace(rb, function(M, D) {
            return D.toUpperCase();
          })), C;
        }(b.slice(0, S)).trim(), E = function(C) {
          const M = C[0];
          return (M === '"' || M === "'") && C.length >= 2 && C[C.length - 1] === M ? C.slice(1, -1) : C;
        }(b.slice(S + 1).trim()), y = gi[w] || w, N = u[y] = function(C, M) {
          return C === "style" ? M.split(/;\s?/).reduce(function(D, j) {
            const k = j.slice(0, j.indexOf(":"));
            return D[k.replace(/(-[a-z])/g, (R) => R[1].toUpperCase())] = j.slice(k.length + 1).trim(), D;
          }, {}) : C === "href" ? Wt(M) : (M.match(Qg) && (M = M.slice(1, M.length - 1)), M === "true" || M !== "false" && M);
        }(w, E);
  ...
  const i = [], l = {}, c = { blockQuote: { t: it(rl), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(Fg, ""), u) }), h: (p, h, u) => r("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: bn(zg), i: ae.HIGH, l: to, h: (p, h, u) => r("br", { key: u.k }) }, breakThematic: { t: it(Ug), i: ae.HIGH, l: to, h: (p, h, u) => r("hr", { key: u.k }) }, codeBlock: { t: it(al), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => r("pre", { key: u.k }, r("code", $t({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(ol), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: bt(Hg), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => r("code", { key: u.k }, p.v) }, footnote: { t: it(Xg), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: no }, footnoteReference: { t: gt(qg), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => r("a", { key: u.k, href: Wt(p.B) }, r("sup", { key: u.k }, p.v)) }, gfmTask: { t: gt(Kg), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => r("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? sl : il), i: ae.HIGH, l: (p, h, u) => ({ v: ar(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => r(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: it(ll), i: ae.MAX, l: (p, h, u) => ({ v: ar(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: bn(cl), i: ae.HIGH, l: () => ({}), h: no }, image: { t: bt(Rb), i: ae.HIGH, l: (p) => ({ D: p[1], B: Ei(p[2]), F: p[3] }), h: (p, h, u) => r("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Wt(p.B) }) }, link: { t: gt(Sb), i: ae.LOW, l: (p, h, u) => ({ v: Ab(h, p[1], u), B: Ei(p[2]), F: p[3] }), h: (p, h, u) => r("a", { key: u.k, href: Wt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: gt(nb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : gt(eb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: gt(tb), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
      ...
      for (; b; ) {
        ...
        for (; E < h.length; ) {
          ...
          if (C) {
            ...
            const D = N.l(C, u, x);
            D.type == null && (D.type = y), S.push(D), w = M;
            break;
          }
          E++;
        }
...
function Fv({ groups: e }) {
  return /* @__PURE__ */ V(Ro, { children: [
    ...
    /* @__PURE__ */ m(vr, { children: e.map((t) => /* @__PURE__ */ V(ut, { children: [
...
const Gb = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("p", { ref: n, className: L("pr-text-sm pr-text-muted-foreground", e), ...t }));
...
), Yb = H.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ m("div", { ref: r, role: "alert", className: L(qb({ variant: t }), e), ...n }));
...
const Jb = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("div", { ref: n, className: L("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
Jb.displayName = "AlertDescription";
const Zb = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ V(
  vn.Root,
  {
    ref: n,
    className: L(
...
Zb.displayName = vn.Root.displayName;
const Qb = H.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  io.Root,
  {
    className: L(
