...
import { c as v, g as Ae, a as Ur, C as tr, L as Hn, t as Ts, u as rn, T as zt, b as Nt, d as Ct, e as Et, f as qn, A as ka, r as re, D as Be, h as Te, i as Fe, j as cr, k as Ge, B as et, x as Ss, l as Rs, m as Ds, I as Os, n as To, o as Xe, p as De, q as Ms, s as Gn, P as lr, v as Rr, w as dr, y as wr, z as za, E as Pa, F as So, G as ur, H as Aa, J as It, R as Ro, K as _a, M as co, N as lo, O as wo, Q as uo, S as Wn, U as ha, V as Do, W as Gr, X as Wr, Y as xr, Z as Is, _ as ir, $ as Ze, a0 as je, a1 as We, a2 as yr, a3 as Oo, a4 as Mo, a5 as Na, a6 as Io, a7 as Yn, a8 as zs, a9 as Ps, aa as As, ab as Ca, ac as Zn, ad as $a, ae as $s, af as Xn, ag as Vs, ah as Ls, ai as Bs, aj as an, ak as Fs, al as js, am as Us, an as Jn, ao as Qn, ap as zo, aq as Ks, ar as ti, as as qa, at as on, au as Ga, av as Hs, aw as qs, ax as Gs, ay as Ws, az as Ys, aA as Zs, aB as Xs, aC as Js, aD as Qs, aE as Po, aF as Ao, aG as tc, aH as ec, aI as rc } from "./resizable-DodcNFuZ.js";
import { aJ as Df, aK as Of, aL as Mf, aM as If, aN as zf, aO as Pf, aP as Af, aQ as $f, aR as Vf, aS as Lf, aT as Bf, aU as Ff, aV as jf, aW as Uf, aX as Kf, aY as Hf, aZ as qf, a_ as Gf, a$ as Wf, b0 as Yf, b1 as Zf, b2 as Xf, b3 as Jf, b4 as Qf, b5 as tm, b6 as em, b7 as rm, b8 as am, b9 as om, ba as nm, bb as im, bc as sm, bd as cm, be as lm, bf as dm, bg as wm, bh as um, bi as pm, bj as hm, bk as gm, bl as fm } from "./resizable-DodcNFuZ.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as Je, Clock as nn, ChevronsLeft as sn, ChevronsRight as cn, ChevronUp as ei, ChevronDown as sr, ArrowLeft as ac, ArrowRight as oc, BoldIcon as nc, ItalicIcon as ic, X as ri, AtSign as ai, Pencil as sc, Trash2 as cc, Undo2 as lc, ArrowUp as oi, MoreHorizontal as dc, MailOpen as wc, Mail as uc, FilterIcon as pc, ArrowLeftIcon as hc, ChevronLeftIcon as gc, ChevronRightIcon as fc, ArrowRightIcon as mc, Copy as ni, Filter as vc, User as bc, Link as xc, CircleHelp as yc, Undo as kc, Redo as _c, SquareX as ii, FunctionSquare as si, SquareSigma as ci, Ban as Nc, AlertCircle as po, CircleCheckIcon as Cc, CircleXIcon as Ec, CircleHelpIcon as Tc, ArrowUpIcon as Sc, ArrowDownIcon as Rc, ScrollText as Dc, ChevronRight as Oc, ChevronLeft as Mc, ChevronsUpDown as Ic, MenuIcon as zc, Menu as Pc, EllipsisVertical as Ac, MoreVertical as $c } from "lucide-react";
import { Section as Mt, compareScrRefs as Ea, getChaptersForBook as Vc, formatScrRef as $e, formatReplacementString as Ye, getSectionForBook as ga, formatRelativeDate as Lc, sanitizeHtml as $o, NumberFormat as li, formatBytes as Bc, getCurrentLocale as Fc, usfmMarkers as Br, isPlatformError as jc, ABORTED as Uc, getErrorMessage as Kc, getFormatCallerFunction as Hc, deepEqual as qc, isString as ln, scrRefToBBBCCCVVV as Wa, defaultScrRef as Ya, formatScrRefRange as Gc, getLocalizeKeyForScrollGroupId as dn, formatReplacementStringToArray as wn, collectUsjMarkers as Wc } from "platform-bible-utils";
import Jt, { useRef as P, useMemo as A, createContext as Dr, useContext as Jr, useEffect as tt, useState as N, useCallback as V, useId as Ta, useImperativeHandle as Yc, useLayoutEffect as Ut, Fragment as Qr, Component as Zc, createElement as ho, Suspense as Xc, forwardRef as Vo, memo as di } from "react";
import { IconSelector as wi, IconCheck as Va, IconChevronDown as Jc, IconChevronUp as Qc, IconLayoutSidebar as tl, IconLayoutSidebarRight as el, IconChevronRight as ui, IconSearch as rl, IconLoader as al, IconAlertOctagon as ol, IconAlertTriangle as nl, IconInfoCircle as il, IconCircleCheck as sl } from "@tabler/icons-react";
import { createEditor as pi, $getRoot as Qe, $createParagraphNode as ta, $getSelection as ae, HISTORY_MERGE_TAG as Lo, ParagraphNode as hi, TextNode as gi, $getPreviousSelection as cl, $isRangeSelection as Se, $caretFromPoint as ll, $getSiblingCaret as fi, $getChildCaret as dl, $getAdjacentChildCaret as wl, $isChildCaret as ul, $normalizeCaret as pl, $setSelectionFromCaretRange as hl, $getCollapsedCaretRange as gl, $getCaretInDirection as un, $splitAtPointCaretNext as fl, $isTextPointCaret as ml, $findMatchingParent as mi, $isElementNode as Yr, mergeRegister as Le, getDOMTextNode as vl, isHTMLElement as bl, CLEAR_EDITOR_COMMAND as vi, COMMAND_PRIORITY_EDITOR as Bo, shallowMergeConfig as xl, defineExtension as he, safeCast as pr, createState as yl, FORMAT_TEXT_COMMAND as bi, $isNodeSelection as xi, COMMAND_PRIORITY_LOW as yi, RootNode as kl, LineBreakNode as _l, TabNode as Nl, $isEditorState as Cl, createCommand as El, CLICK_COMMAND as Tl, isDOMNode as Sl, $getNodeFromDOMNode as Rl, $createNodeSelection as Dl, $setSelection as Ol, $getEditor as Ml, DecoratorNode as go, $getState as Il, toggleTextFormatType as pn, TEXT_TYPE_TO_FORMAT as zl, $setState as Pl, addClassNamesToElement as ki, $create as Al, $getNodeByKey as $l, removeClassNamesFromElement as Vl, KEY_TAB_COMMAND as Ll, $isBlockElementNode as Bl, $createRangeSelection as Fl, $normalizeSelection__EXPERIMENTAL as jl, OUTDENT_CONTENT_COMMAND as Ul, INDENT_CONTENT_COMMAND as hn, INSERT_TAB_COMMAND as Kl, COMMAND_PRIORITY_CRITICAL as Fo, $isDecoratorNode as Hl, $isParagraphNode as ql, $isTextNode as fo, SELECTION_CHANGE_COMMAND as _i, $insertNodes as Gl } from "lexical";
import { HeadingNode as Wl, QuoteNode as Yl, registerRichText as Zl } from "@lexical/rich-text";
import { flushSync as Xl, createPortal as Jl } from "react-dom";
import { $isTableSelection as Ql } from "@lexical/table";
import { createHeadlessEditor as Ni } from "@lexical/headless";
import { $generateHtmlFromNodes as td, $generateNodesFromDOM as ed } from "@lexical/html";
...
import { useReactTable as Ci, getFilteredRowModel as rd, getSortedRowModel as Ei, getPaginationRowModel as ad, getCoreRowModel as Ti, flexRender as Kr, getGroupedRowModel as od, getExpandedRowModel as nd } from "@tanstack/react-table";
import id from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as mo, HIDDEN_NOTE_CALLER as vo, getDefaultViewOptions as sd, isInsertEmbedOpOfType as $r, getMarkerMenuItems as cd, defaultStyleInfo as ld, Editorial as dd } from "@eten-tech-foundation/platform-editor";
import { cva as Si } from "class-variance-authority";
import { useHotkeys as wd } from "react-hotkeys-hook";
import { Drawer as er } from "vaul";
import { useTheme as ud } from "next-themes";
import { Toaster as pd } from "sonner";
...
const hd = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"];
function gd(t) {
  return hd.some((e) => e === t);
}
function vn(t) {
...
const vd = "top-match", bd = "Show recent searches", xd = "Recent";
function yd({
  recentSearches: t,
  ...
  const [h, f] = N(!1), [y, b] = N(!1), g = Ta(), C = P(!1), E = w !== void 0, T = E ? w : h, k = n === "" ? "" : re(n, bd), z = re(s, xd), S = (D) => {
...
const Dd = "a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]";
function Od(t) {
  return Array.from(t.querySelectorAll(Dd)).filter(
    (e) => e.tabIndex >= 0
  );
}
function Xa({
  ...
  const S = De(), M = fd(), [I, O] = N(!1), [D, Y] = N(""), [Z, ot] = N(""), [x, rt] = N("books"), [X, L] = N(void 0), [J, j] = N(
    void 0
  ...
  const { otLong: ke, ntLong: _e, dcLong: rr, extraLong: ar } = {
    ...
    (m) => {
      ...
      if (!(!!q && !!((Qo = At.current) != null && Qo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
        const Lt = At.current ? Od(At.current) : [];
        if (Lt.length === 0) {
      ...
      if ((x === "chapters" || x === "verses") && (m.key === " " || m.key === "Enter")) {
        ...
        const ue = (() => {
          if (x === "verses") {
            const Ar = J, en = W, Ha = la(D);
            return !Ar || !en || Ha === void 0 ? void 0 : {
              isDisabled: gr(Ar, en)(Ha),
              activate: () => $(Ha)
            };
          }
          const Yt = X, me = Fr(D);
                ...
                /* @__PURE__ */ u(Nt, { children: [
                  /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
                    et,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": ra,
                      children: S === "ltr" ? /* @__PURE__ */ a(ac, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(oc, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
...
const Pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pd = Pi ? Ut : tt, wa = { tag: Lo };
function Ad({ initialConfig: t, children: e }) {
  const r = A(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: d } = t, l = zd(null, o), w = pi({ editable: t.editable, html: d, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const $d = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ut : tt;
function Vd({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Me();
  return $d(() => {
...
class Bd extends Zc {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && Fd(e.resetKeys, n)) {
      var s, i;
...
function jd({ children: t, onError: e }) {
  return a(Bd, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Ud = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ut : tt;
function Kd(t) {
...
const Ai = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gd = Ai && "documentMode" in document ? document.documentMode : null;
!(!Ai || !("InputEvent" in window) || Gd) && "getTargetRanges" in new window.InputEvent("input");
function Ee(t) {
  return `${t}px`;
}
...
function Qd(t) {
  ...
  return Yr(e) || Sa(4, t.__key), e;
}
function tw(t) {
  const e = ae() || cl();
  let r;
  if (Se(e)) r = ll(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = fi(c, "next"));
    }
    r = r || dl(Qe(), "previous").getFlipped().insert(ta());
  }
  const o = ew(t, r), n = wl(o), s = ul(n) ? pl(n) : o;
  return hl(gl(s)), t.getLatest();
}
function ew(t, e, r) {
  let o = un(e, "next");
  for (let n = o; n; n = fl(n, r)) o = n;
  return ml(o) && Sa(283), o.insert(t.isInline() ? ta().append(t) : t), un(fi(t.getLatest(), "next"), e.direction);
}
function rw(t) {
  const e = ae();
  if (!Se(e)) return !1;
...
const aw = Symbol.for("preact-signals");
function Ba() {
...
let Ra, Ve = 0, Da = 0, nw = 0, _o = 0, va = 0;
function Cn(t) {
  if (wt === void 0) return;
  let e = t.n;
...
function sw(t) {
  ...
  Vi(this), wt = t, this.f &= -2, 8 & this.f && Ho(this), Ba();
}
function br(t, e) {
...
Xt.prototype.brand = aw, Xt.prototype.h = function() {
  return !0;
...
const to = yl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ji extends go {
  $config() {
...
he({ name: "@lexical/extension/DecoratorText", nodes: () => [ji], register: (t, e, r) => t.registerCommand(bi, (o) => {
  const n = ae();
  if (xi(n) || Se(n)) for (const s of n.getNodes()) lw(s) && s.toggleFormat(o);
  return !1;
}, yi) });
function Ui(t, e) {
  let r;
...
const qo = 0, Co = 1, Hi = 2, eo = 3, ua = 4, vr = 5, ro = 6, Vr = 7;
function ao(t) {
  return t.id === qo;
}
function qi(t) {
...
class uw {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : xl;
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || ww;
  }
  getPeerNameSet() {
...
const hw = he({ config: pr({ setOptions: Tn, updateOptions: Tn }), init: ({ $initialEditorState: t = pw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [kl, gi, _l, Nl, hi] }), Sn = Symbol.for("@lexical/extension/LexicalBuilder");
function Rn() {
}
function gw(t) {
  throw t;
...
class _r {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && ft(298, o.name), !n) {
      n = new uw(this, o), this.extensionNameMap.set(o.name, n);
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of cw(p)) {
    ...
    return e.onError || (e.onError = gw), e;
  }
}
const fw = /* @__PURE__ */ new Set(), Dn = he({ build(t, e, r) {
...
class Nr extends go {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: vw, priority: 0 }) };
  }
  exportDOM() {
...
he({ dependencies: [No, Dn], name: "@lexical/extension/HorizontalRule", nodes: () => [Nr], register(t, e, r) {
  ...
  return Le(t.registerCommand(mw, (i) => {
    const c = ae();
    if (!Se(c)) return !1;
    ...
    return !0;
  }, Bo), t.registerCommand(Tl, (i) => {
    if (Sl(i.target)) {
      const c = Rl(i.target);
      if (bw(c)) return function(d, l = !1) {
        const w = ae(), p = d.isSelected(), h = d.getKey();
        let f;
        l && xi(w) ? f = w : (f = Dl(), Ol(f)), p ? f.delete(h) : f.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
...
he({ build: (t, e, r) => Or(e), config: pr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Re(() => {
    if (!o.disabled.value) return Jd(t, o.onReposition.value);
  });
} });
function Gi(t) {
  return t.canBeEmpty();
}
function xw(t, e, r = Gi) {
  return Le(t.registerCommand(Ll, (o) => {
    const n = ae();
    if (!Se(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => Bl(h) && h.canIndent()).length > 0) return !0;
      const c = i.anchor, d = i.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Qd(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let f = Fl();
        if (f.anchor.set(h, 0, "element"), f.focus.set(h, 0, "element"), f = jl(f), f.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Ul : hn : Kl;
...
he({ build: (t, e, r) => Or(e), config: pr({ $canIndent: Gi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Re(() => {
    if (!o.value) return xw(t, n, s);
  });
} });
const yw = he({ name: "@lexical/react/ReactProvider" });
function kw() {
...
function Tw({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(yw.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Cw(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Ew, { editor: t, ErrorBoundary: e });
}
function On(t) {
  return t.getEditorState().read(Wi(t.isComposing()));
}
function Sw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Me();
  return function(n) {
    Wo(() => Le(Zl(n), Yi(n)), [n]);
  }(o), u(ht, { children: [t, a(Rw, { content: e }), a(Tw, { editor: o, ErrorBoundary: r })] });
}
...
function Aw(t, e) {
  ...
  return u(ht, { children: [a(zw, { editor: n, ...o, ref: e }), r != null && a($w, { editor: n, content: r })] });
}
function $w({ content: t, editor: e }) {
  const r = function(i) {
    const [c, d] = N(() => Mn(i));
    return Zi(() => {
      function l() {
...
function Fw({
  ...
  const [e] = Me(), [r, o] = N(e), [n, s] = N("paragraph"), [i, c] = Bw(), d = () => {
  };
...
const Qi = "data-platform-content-zoom-root", Sh = "data-platform-content-zoom-scope", ts = "data-platform-content-zoom-label", es = Dr(void 0);
function Rh({ area: t, label: e, children: r }) {
  const o = A(
    () => ({
      [Qi]: t ?? "",
...
function Hw({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:relative", children: [
          ...
          contentEditable: (
            ...
            /* @__PURE__ */ a(
              "div",
              {
                ...
                ...n,
                children: /* @__PURE__ */ a(Vw, { placeholder: t })
              }
            )
          ),
          ErrorBoundary: jd
      ...
      e && /* @__PURE__ */ a(Dw, { defaultSelection: "rootEnd" }),
  ...
  return (
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ a(Ad, { initialConfig: l, children: /* @__PURE__ */ u(zt, { children: [
          /* @__PURE__ */ a(
            Hw,
            {
              placeholder: n,
          ...
          /* @__PURE__ */ a(Vd, { ignoreSelectionChange: !0, onChange: w })
        ] }) })
      }
    )
  );
...
function Gw(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), s = ed(e, n);
      Qe().clear(), Gl(s);
    },
    {
      discrete: !0
...
const Ww = "verseText", Dh = Object.freeze([
...
function Oh({
  ...
  const [s, i] = N(Zw), [c, d] = N(n), [l, w] = N(!1), p = P(void 0), h = P(null);
  tt(() => {
    let g = !0;
    const C = h.current;
    if (!C) return;
...
function An({
        ...
        /* @__PURE__ */ u(
          Ge,
          {
            onClick: (x) => {
              ...
              C(rt ? Gw(t.contents) : Yw), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(tu, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(eu, { className: "tw:text-xs tw:font-medium", children: I }) }),
        ...
        Z && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(dc, {}) }) }),
...
const ru = {
  ...
  var Ke;
  const rt = Mr(), [X, L] = N({}), J = ot ?? X, j = J.editorState ?? ru, W = J.assignedUser, ut = x !== void 0, mt = P(J);
  mt.current = J;
  const H = V(
    (R) => {
...
), ou = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), xa = (t) => ou($o(t));
function ya({ html: t }) {
  const e = Mr();
  return /* @__PURE__ */ a(
    "div",
...
function nu({
  ...
  const [i, c] = N("accept"), d = Ta(), l = Ta(), w = Mr(), p = r === "loading", h = r === "accept", f = r === "none", y = r === "acceptRejectOrMerge", b = h ? "accept" : i, g = A(
    () => xa(t.rejectedText ?? ""),
    [t.rejectedText]
  ), C = A(
    () => xa(t.acceptedText ?? ""),
...
const du = di(function(e) {
  const {
    ...
    [d]
  ), { conflictOptions: w, isResolving: p, resolve: h, resolvedResolution: f, showResolveCheck: y } = lu({
    threadId: s,
    threadStatus: i,
    isSelected: n,
    activeComments: d,
      ...
      children: Y.map((j) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: j.type === "Conflict" ? /* @__PURE__ */ a(du, { ...W, conflictResolution: C }) : /* @__PURE__ */ a(ds, { ...W })
          },
          j.id
        );
      })
...
wu.displayName = "ContentZoomRoot";
function uu({ table: t }) {
...
function mu({
  ...
  const [w, p] = N([]), [h, f] = N([]), [y, b] = N({}), [g, C] = N({}), E = A(() => e ?? [], [e]), T = Ci({
    ...
    columns: t,
    getCoreRowModel: Ti(),
    ...r && { getPaginationRowModel: ad() },
    onSortingChange: p,
    getSortedRowModel: Ei(),
    onColumnFiltersChange: f,
    getFilteredRowModel: rd(),
...
function Uh({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(id, { options: s, children: e })
    }
  );
}
...
var xu = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(xu || {});
...
function yu({ id: t, versionHistory: e }) {
...
function Wh({
  ...
  const i = A(() => Bc(r), [r]), d = ((l) => {
    const w = new Intl.DisplayNames(Fc(), { type: "language" });
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(yu, { versionHistory: n }),
...
function Ru({
  ...
  return /* @__PURE__ */ u(Be, { open: f, onOpenChange: E, children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Su(t, o, e) }) }) }),
...
function Mu({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Du(t, r) }) }) }),
      /* @__PURE__ */ a(Et, { children: /* @__PURE__ */ a("p", { children: Ou(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(
      Fe,
      {
...
function zu({ icon: t, className: e }) {
  ...
  return /* @__PURE__ */ u(
    tr,
    {
      ...
      children: [
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(zu, { icon: t.icon }) }) }),
...
function Zh({
  ...
  const [b, g] = N("generated"), [C, E] = N("generated"), [T, k] = N("*"), [z, S] = N("*"), [M, I] = N("f"), [O, D] = N(!1), [Y, Z] = N(!0), [ot, x] = N(!1), rt = P(!1), X = P(""), [L, J] = N(!1), j = Cu(), [W, ut] = N(), mt = P(null), H = P(
    void 0
  ...
  const se = () => {
    ...
    if (U && $r("note", U)) {
      ...
      M !== "x" && _ === "x" ? nt == null || nt.forEach((yt) => Lu(yt)) : M === "x" && _ !== "x" && (nt == null || nt.forEach((yt) => Bu(yt))), At(U);
    }
  }, xe = (_) => {
    ...
    (_, U, G) => {
      ...
      Ls({
        ...
        onShowError: (K) => {
          (!jc(K) || K.code !== Uc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Kc(K)}`
          );
        }
      });
    },
  ...
  return /* @__PURE__ */ u(ht, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ht, { children: ju(t.marker, c, o, l) })
      }
    )
  ] });
}
...
const Gu = (t) => {
  ...
  return e ? e[1] : "";
}, Yu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ng = Object.freeze([
...
function ig({
  ...
  }, [M, rt]), L = A(() => X.length === 0 ? [] : Zu(X, O, Y), [X, O, Y]), J = A(() => {
    var vt, lt;
    if (!M) return d;
...
const Ju = "16rem", Qu = "3rem", us = Jt.createContext(void 0);
function ja() {
...
function sg({ className: t, onClick: e, ...r }) {
...
function sp({
  ...
  const c = t ? ea.Root : "button", { state: d } = ja(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(ip({ variant: r, size: o }), s),
      ...i
    }
  );
...
function cp({
  ...
  return /* @__PURE__ */ a(
    ep,
    {
      ...
      children: /* @__PURE__ */ u(ap, { children: [
        /* @__PURE__ */ u(Bn, { children: [
          /* @__PURE__ */ a(Fn, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(jn, { children: /* @__PURE__ */ a(op, { children: Object.entries(e).map(([g, C]) => /* @__PURE__ */ a(np, { children: /* @__PURE__ */ a(
            sp,
            {
              onClick: () => p(g),
              isActive: b(g),
    ...
    /* @__PURE__ */ u(
      tp,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(rp, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
}
const He = "scrBook", lp = "scrRef", nr = "source", dp = "details", wp = "Scripture Reference", up = "Scripture Book", ps = "Type", pp = "Details";
function hp(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: He,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? wp,
      cell: (o) => {
...
}, Un = (t) => `${gp({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function yg({
  sources: t,
  ...
  const C = Ci({
    ...
    getExpandedRowModel: nd(),
    getGroupedRowModel: od(),
    getCoreRowModel: Ti(),
    getSortedRowModel: Ei(),
    getRowId: Un,
    autoResetExpanded: !1,
    ...
    !e && /* @__PURE__ */ u(
      Cr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Sr, { position: "item-aligned", children: /* @__PURE__ */ a(pu, { children: k.map((O) => /* @__PURE__ */ a(ve, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
                    ...
                    children: Z.getIsGrouped() ? /* @__PURE__ */ u(
                      et,
                      {
                        ...
                        children: [
                          ...
                          !O.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Oc, {}) : /* @__PURE__ */ a(Mc, {})),
                          " ",
        ...
        /* @__PURE__ */ a(Rr, { asChild: !0, children: /* @__PURE__ */ u(
          et,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a(Ic, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
...
function _g({
  ...
  const S = Ft(
    ...
    [r, n, g, s]
  ), de = lt.find((F) => F.value === t), ge = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? Gc(Tt, Pt, {
  ...
  const [qt, Pr] = N(null), [Pe, gr] = N(null), [fr, Ua] = N(null), ra = 200, [Ka, aa] = N(!1);
  tt(() => {
  ...
  /* @__PURE__ */ a(Ct, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    Ge,
    {
      ...
      children: [
        ...
        c.shortcut && /* @__PURE__ */ a(Gs, { className: "tw:tracking-normal", children: /* @__PURE__ */ a(Ca, { hint: c.shortcut }) })
      ]
    },
...
function Eo({
  ...
  const l = Ta(), w = kp(e), p = s && w.length > 1;
  Mi();
...
const Cp = Object.freeze([520, 420, 340]), bs = Jt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = vs(n, Cp), l = Oi() ?? d, w = l >= Hr.MINIMUM;
...
const Ep = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  be.Trigger,
  {
    ref: r,
    ...e,
...
function Dg({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(xs, { children: [
      /* @__PURE__ */ a(ys, { children: t.map((c) => /* @__PURE__ */ a(Ep, { value: c.value, children: c.value }, c.key)) }),
...
function Op({
  ...
  return /* @__PURE__ */ a(Rp, { children: /* @__PURE__ */ a(
    Oe.Content,
    {
...
const Lr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
      ...
      /* @__PURE__ */ a(Ct, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        Mp,
        {
          ...
          children: [
            ...
            l.shortcut && /* @__PURE__ */ a(zp, { className: "tw:tracking-normal", children: /* @__PURE__ */ a(Ca, { hint: l.shortcut }) })
          ]
        },
        `menubar-item-${l.label}-${l.command}`
      ) : /* @__PURE__ */ u(Pp, { children: [
        /* @__PURE__ */ a(Ap, { children: l.label }),
        /* @__PURE__ */ a($p, { children: _s(
          t,
          e,
          hs(t, l.id),
          o
    ...
    return c.length > 0 && i < n.length - 1 && d.push(/* @__PURE__ */ a(Ip, {}, `separator-${s}`)), d;
  });
};
function Vp({
  menuData: t,
  ...
  if (wd(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    var y, b, g, C;
    w.preventDefault();
    ...
    return /* @__PURE__ */ a(Tp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: gs(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(Sp, { children: [
      /* @__PURE__ */ a(Dp, { ref: l(w), children: p.label }),
      /* @__PURE__ */ a(
        Op,
        {
          style: { zIndex: je },
...
const Lp = Object.freeze([950, 800, 700]);
function Og(t) {
  switch (t) {
    case void 0:
      return;
    ...
    wr,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(tc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
          ...
          /* @__PURE__ */ a(ec, { children: /* @__PURE__ */ a(rl, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
        ] }) }),
...
function $g({
  ...
  const c = t ? wn(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Hp(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
...
function uf({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    pd,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(sl, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(il, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(nl, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(ol, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(al, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function ff({
  ...
  return /* @__PURE__ */ a(
    be.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Wp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Ef({ value: t, children: e }) {
  return /* @__PURE__ */ a(Di.Provider, { value: t, children: /* @__PURE__ */ a(La.Provider, { value: t, children: e }) });
}
const Tf = 300;
function Qp(t, e = "top") {
...
export {
  ...
  Lh as AvatarImage,
  Ch as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  ...
  Sh as CONTENT_ZOOM_SCOPE_ATTRIBUTE,
  ...
  Oh as CommentEditor,
  Bh as CommentList,
  nu as ConflictNoteCard,
  wu as ContentZoomRoot,
  Rh as ContentZoomTextProvider,
  Fg as ContextMenu,
  Xg as ContextMenuCheckboxItem,
  Gg as ContextMenuContent,
  ...
  tf as ContextMenuSeparator,
  ef as ContextMenuShortcut,
  Hg as ContextMenuSub,
  Zg as ContextMenuSubContent,
  Yg as ContextMenuSubTrigger,
  jg as ContextMenuTrigger,
  mu as DataTable,
  $g as DestructiveKeyConfirmation,
  co as Dialog,
  zf as DialogClose,
  lo as DialogContent,
  ...
  bu as ErrorDump,
  Hh as ErrorPopover,
  Xh as FOOTNOTE_EDITOR_STRING_KEYS,
  Yh as Filter,
  ...
  Ku as FootnoteItem,
  Jh as FootnoteList,
  zg as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  ...
  Cr as Select,
  bp as SelectBooks,
  fp as SelectBooksPicker,
  Sr as SelectContent,
  pu as SelectGroup,
  ve as SelectItem,
  Fh as SelectLabel,
  gu as SelectScrollDownButton,
  ...
  ep as Sidebar,
  ap as SidebarContent,
  wg as SidebarFooter,
  Bn as SidebarGroup,
  pg as SidebarGroupAction,
  ...
  gg as SidebarMenuBadge,
  sp as SidebarMenuButton,
  np as SidebarMenuItem,
  fg as SidebarMenuSkeleton,
  mg as SidebarMenuSub,
  bg as SidebarMenuSubButton,
  vg as SidebarMenuSubItem,
  tp as SidebarProvider,
  cg as SidebarRail,
  ug as SidebarSeparator,
  sg as SidebarTrigger,
  xr as Skeleton,
  pf as Slider,
  uf as Sonner,
  tm as Spinner,
  ...
  zh as getCommentThreadElementId,
  Fa as getInventoryHeader,
  rg as getLinesFromUSFM,
  ag as getNumberFromUSFM,
  hm as getShortcutKeycaps,
  Yu as getStatusForItem,
  Og as getToolbarOSReservedSpaceClassName,
  tg as inventoryCountColumn,
  Qh as inventoryItemColumn,
  eg as inventoryStatusColumn,
  ...
  bf as useEvent,
  xf as useEventAsync,
  _f as useExtraValidMarkers,
  fm as useHasContentBelow,
  Is as useListbox,
  Cu as useLivePopoverAnchor,
  Zp as usePromise,
  Nh as useRecentSearches,
  yf as useRetryablePromise,
  Nf as useRunWhenVisible,
  vs as useShrinkStep,
  Oi as useShrinkStepOverride,
  fd as useShrinkStepValue,
  ja as useSidebar,
  kf as useStylesheet,
  Cf as useTabIconSelection,
  rn as useTruncationTooltip,
  Xp as useViewVisibility
};
