...
import m, { useState as A, useCallback as j, useMemo as H, useRef as q, useLayoutEffect as pn, createContext as Vr, useContext as Mr, useEffect as Vt, forwardRef as Sn, Fragment as Tn } from "react";
import { Slot as Gt } from "@radix-ui/react-slot";
import { cva as _t } from "class-variance-authority";
import { clsx as Dr } from "clsx";
import { extendTailwindMerge as zr } from "tailwind-merge";
import { Command as nt } from "cmdk";
import { X as He, Search as Rn, Clock as mn, ChevronsLeft as un, ChevronsRight as hn, ChevronLeft as Ie, ChevronRight as jt, ArrowLeft as Or, ArrowRight as Ir, Circle as he, ChevronsUpDown as Ue, Check as St, FilterIcon as Ar, ChevronDown as fe, ChevronUp as Pr, ArrowLeftIcon as Br, ChevronLeftIcon as jr, ChevronRightIcon as $r, ArrowRightIcon as Fr, Copy as Lr, Filter as Gr, User as Xr, Link as Hr, CircleHelp as Ur, Star as Yr, CircleCheckIcon as qr, CircleXIcon as Kr, CircleHelpIcon as Jr, ArrowUpIcon as Wr, ArrowDownIcon as Zr, ArrowUpDownIcon as Qr, PanelLeft as to, PanelRight as eo, ScrollText as no, MenuIcon as ro, Menu as oo, EllipsisVertical as ao, LoaderCircle as so } from "lucide-react";
import * as mt from "@radix-ui/react-dialog";
import * as re from "@radix-ui/react-popover";
import { getChaptersForBook as io, formatScrRef as Bt, NumberFormat as wo, formatBytes as lo, getCurrentLocale as co, deepEqual as Ye, isString as Te, compareScrRefs as Ae, scrRefToBBBCCCVVV as Re, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
import * as En from "@radix-ui/react-label";
import * as oe from "@radix-ui/react-radio-group";
import { useReactTable as Vn, getFilteredRowModel as po, getSortedRowModel as Mn, getPaginationRowModel as mo, getCoreRowModel as Dn, flexRender as ee, getGroupedRowModel as uo, getExpandedRowModel as ho } from "@tanstack/react-table";
import * as $ from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as fo } from "@radix-ui/react-dropdown-menu";
import * as G from "@radix-ui/react-select";
import go from "markdown-to-jsx";
...
const yo = _t(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Gt : "button", { className: c(yo({ variant: e, size: n, className: t })), ref: i, ...a })
);
M.displayName = "Button";
const No = "layoutDirection";
function K() {
  const t = localStorage.getItem(No);
  return t === "rtl" ? t : "ltr";
}
const ko = mt.Portal, In = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
    className: c(
...
In.displayName = mt.Overlay.displayName;
const Co = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = K();
...
Co.displayName = mt.Content.displayName;
...
_o.displayName = mt.Title.displayName;
...
So.displayName = mt.Description.displayName;
...
we.displayName = nt.Input.displayName;
const Ut = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.List,
  {
    ref: n,
...
Ut.displayName = nt.List.displayName;
const be = m.forwardRef((t, e) => /* @__PURE__ */ r(nt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
be.displayName = nt.Empty.displayName;
const Mt = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Group,
  {
    ref: n,
    className: c(
...
Mt.displayName = nt.Group.displayName;
const An = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Separator,
  {
    ref: n,
...
An.displayName = nt.Separator.displayName;
const Ct = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Item,
  {
    ref: n,
    className: c(
...
Ct.displayName = nt.Item.displayName;
const Yt = re.Root, qt = re.Trigger, It = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = K();
...
It.displayName = re.Content.displayName;
var To = Object.defineProperty, Ro = (t, e, n) => e in t ? To(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => Ro(t, typeof e != "symbol" ? e + "" : e, n);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
function Eo(t) {
  const e = typeof t == "string" ? Kt(t) : t;
  return e >= 40 && e <= 66;
}
function Vo(t) {
  return (typeof t == "string" ? Kt(t) : t) <= 39;
}
function Bn(t) {
  return t <= 66;
}
...
function Po(t) {
  return Pn[t - 1].includes("*obsolete*");
}
function Bo() {
  const t = {};
...
const O = {
  ...
  extraBooks: Oo,
  bookNumberToId: Je,
  bookNumberToEnglishName: $n,
  bookIdToEnglishName: Io,
  isCanonical: Fn,
  isExtraMaterial: Ao,
  isObsolete: Po
};
...
E(ot, "Original", new ot(ct.Original)), E(ot, "Septuagint", new ot(ct.Septuagint)), E(ot, "Vulgate", new ot(ct.Vulgate)), E(ot, "English", new ot(ct.English)), E(ot, "RussianProtestant", new ot(ct.RussianProtestant)), E(ot, "RussianOrthodox", new ot(ct.RussianOrthodox));
let Rt = ot;
function gn(t, e) {
  const n = e[0];
...
const et = class V {
  constructor(e, n, o, a) {
    if (E(this, "firstChapter"), E(this, "lastChapter"), E(this, "lastVerse"), E(this, "hasSegmentsDefined"), E(this, "text"), E(this, "BBBCCCVVVS"), E(this, "longHashCode"), E(this, "versification"), E(this, "rtlMark", "‏"), E(this, "_bookNum", 0), E(this, "_chapterNum", 0), E(this, "_verseNum", 0), E(this, "_verse"), o == null && a == null)
      if (e != null && typeof e == "string") {
        const i = e, s = n != null && n instanceof Rt ? n : void 0;
        ...
        if (e != null && e instanceof V) {
          ...
          if (e == null) return;
          const i = e instanceof Rt ? e : V.defaultVersification;
          this.setEmpty(i);
        }
      else
      ...
      if (typeof e == "string" && typeof n == "string" && typeof o == "string")
        ...
        this._bookNum = e, this._chapterNum = n, this._verseNum = o, this.versification = a ?? V.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
  ...
  static getBBBCCCVVV(e, n, o) {
    return e % V.bcvMaxValue * V.bookDigitShifter + (n >= 0 ? n % V.bcvMaxValue * V.chapterDigitShifter : 0) + (o >= 0 ? o % V.bcvMaxValue : 0);
  }
  /**
  ...
  static fromJSON(e) {
    ...
    let p;
    return s && (p = new Rt(s)), n ? new V(n, o.toString(), w, p) : new V();
  }
  /**
  ...
  set verse(e) {
    const { success: n, vNum: o } = V.tryGetVerseNum(e);
    this._verse = n ? void 0 : e.replace(this.rtlMark, ""), this._verseNum = o, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = V.tryGetVerseNum(this._verse));
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = i[0], i.length > 1)
        try {
          const s = +i[1].trim();
          this.versification = new Rt(ct[s]);
        } catch {
    ...
    if (o.length !== 2 || O.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !V.isVerseParseable(o[1]))
      throw new Zt("Invalid reference : " + e);
   ...
   */
  allVerses(e = !1, n = V.verseRangeSeparators, o = V.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], i = gn(this._verse, o);
    for (const s of i.map((w) => gn(w, n))) {
      const w = this.clone();
      w.verse = s[0];
      const p = w.verseNum;
  ...
  updateInternal(e, n, o) {
    this.bookNum = O.bookIdToNumber(e), this.chapter = n, this.verse = o;
  }
};
E(et, "defaultVersification", Rt.English), E(et, "verseRangeSeparator", "-"), E(et, "verseSequenceIndicator", ","), E(et, "verseRangeSeparators", [et.verseRangeSeparator]), E(et, "verseSequenceIndicators", [et.verseSequenceIndicator]), E(et, "chapterDigitShifter", 1e3), E(et, "bookDigitShifter", et.chapterDigitShifter * et.chapterDigitShifter), E(et, "bcvMaxValue", et.chapterDigitShifter - 1), /**
...
function jo({
  ...
  renderItem: n = (s) => String(s),
  getItemKey: o = (s) => String(s),
  ...
  return /* @__PURE__ */ d(Yt, { open: s, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(It, { className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ht, { children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(Mt, { heading: i, children: t.map((l) => /* @__PURE__ */ d(
      Ct,
      {
        onSelect: () => p(l),
...
function li(t, e, n = (a, i) => a === i, o = 15) {
  return (a) => {
    const i = t.filter(
      (w) => !n(w, a)
    ), s = [a, ...i.slice(0, o - 1)];
...
const Gn = O.allBookIds.filter(
  (t) => !O.isObsolete(O.bookIdToNumber(t))
), at = Object.fromEntries(
  Gn.map((t) => [t, O.bookIdToEnglishName(t)])
), $o = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon",
  ...
  const n = Fo.reduce(
    (o, a) => {
      ...
      if (i) {
        ...
        if (g.length === 1 && ([l] = g), !l && w && O.isBookIdValid(s)) {
...
function Go(t, e, n, o) {
  const a = j(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const l = e[p - 1], u = Math.max(pt(l), 1);
        o({
          book: l,
          chapterNum: u,
          verseNum: 1
...
function xn({
  ...
  if (t)
    return /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: pt(t) }, (s, w) => w + 1).map((s) => /* @__PURE__ */ r(
      Ct,
      {
        value: `${t} ${at[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function di({
  ...
  const s = K(), [w, p] = A(!1), [l, u] = A(""), [g, h] = A(""), [f, b] = A("books"), [y, N] = A(void 0), [_, k] = A(!1), D = q(void 0), z = q(void 0), J = q(void 0), it = q(void 0), ut = q({}), C = j(
    (x) => {
      e(x), i && i(x);
    },
    [e, i]
  ), v = H(() => o ? o() : Gn, [o]), B = H(() => ({
    OT: v.filter((I) => O.isBookOT(I)),
    NT: v.filter((I) => O.isBookNT(I)),
    DC: v.filter((I) => O.isBookDC(I)),
    Extra: v.filter((I) => O.extraBooks().includes(I))
  }), [v]), S = H(() => Object.values(B).flat(), [B]), Z = H(() => {
    if (!g.trim()) return B;
    const x = g.toLowerCase().trim(), I = { OT: [], NT: [], DC: [], Extra: [] };
    return ["OT", "NT", "DC", "Extra"].forEach((tt) => {
      I[tt] = B[tt].filter((W) => at[W].toLowerCase().includes(x) || W.toLowerCase().includes(x));
    }), I;
  }, [B, g]), T = H(
    () => Lo(g, S),
    [g, S]
    ...
    (x) => {
      const I = f === "chapters" ? y : T == null ? void 0 : T.book;
      I && (C({
        book: I,
        chapterNum: x,
        verseNum: 1
      }), p(!1), b("books"), N(void 0), h(""));
    },
    [C, f, y, T]
  ), de = j(
    (x) => {
    ...
    (x) => {
      ...
      p(x), x && (b("books"), N(void 0), h(""));
    },
    [f, X]
  ), ht = j(
    (x) => T ? !!T.chapterNum && !x.toString().includes(T.chapterNum.toString()) : !1,
    [T]
  ), vt = H(() => Bt(t, "English"), [t]), dn = j((x) => (I) => {
    ut.current[x] = I;
  }, []), Tr = j((x) => {
    ...
    (x) => {
      if (x.ctrlKey) return;
      const { isLetter: I, isDigit: Y } = bn(x.key);
      if (f === "chapters") {
        if (x.key === "Backspace") {
        ...
        if (I || Y) {
          if (x.preventDefault(), x.stopPropagation(), b("books"), N(void 0), Y && y) {
            const tt = at[y];
            h(`${tt} ${x.key}`);
          } else
            h(x.key);
      ...
      if ((f === "chapters" || f === "books" && T) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        const tt = f === "chapters" ? y : T == null ? void 0 : T.book;
        if (!tt) return;
        const W = (() => {
          if (!l) return 1;
          const Wt = l.match(/(\d+)$/);
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            ft = W === 0 ? xt : Math.max(1, W - cn);
            break;
          case "ArrowDown":
            ft = W === 0 ? 1 : Math.min(xt, W + cn);
            break;
          default:
            return;
        }
        ft !== W && (x.preventDefault(), x.stopPropagation(), u(vn(tt, ft)), setTimeout(() => {
          const Wt = ut.current[ft];
    ...
    const { isLetter: I, isDigit: Y } = bn(x.key);
    (I || Y) && (x.preventDefault(), h((tt) => tt + x.key), z.current.focus(), k(!1));
  }, []);
  return pn(() => {
    const x = setTimeout(() => {
      if (w && f === "books" && J.current && it.current) {
        const I = J.current, Y = it.current, tt = Y.offsetTop, W = I.clientHeight, xt = Y.clientHeight, ft = tt - W / 2 + xt / 2;
        I.scrollTo({
          top: Math.max(0, ft),
          behavior: "smooth"
        }), u(vn(t.book));
    ...
    if (f === "chapters" && y) {
      ...
      setTimeout(() => {
        if (J.current)
          if (x) {
            const I = ut.current[t.chapterNum];
  ...
  }, [f, y, T, t.book, t.chapterNum]), /* @__PURE__ */ d(Yt, { open: w, onOpenChange: dt, children: [
    /* @__PURE__ */ r(qt, { asChild: !0, children: /* @__PURE__ */ r(
      M,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: vt })
      }
    ) }),
    /* @__PURE__ */ r(It, { forceMount: !0, className: "tw-z-[250] tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      Ht,
      {
        ref: D,
        onKeyDown: Rr,
        ...
        shouldFilter: !1,
        children: [
          f === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: R.map(({ onClick: x, disabled: I, title: Y, icon: tt }) => /* @__PURE__ */ r(
              M,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              M,
              {
                ...
                tabIndex: -1,
                children: s === "ltr" ? /* @__PURE__ */ r(Or, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ir, { className: "tw-h-4 tw-w-4" })
              }
            ),
            /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: at[y || ""] || "" })
          ] }),
          !_ && /* @__PURE__ */ d(Ut, { ref: J, children: [
            f === "books" && /* @__PURE__ */ d(ne, { children: [
              !T && Object.entries(Z).map(([x, I]) => {
                if (I.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses BookType as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Mt, { heading: $o[x], children: I.map((Y) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: c(
              ...
              T && /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ r(
                Ct,
                {
              ...
              T && pt(T.book) > 1 && /* @__PURE__ */ d(ne, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: at[T.book] }),
                /* @__PURE__ */ r(
                  xn,
                  {
                    bookId: T.book,
...
), U = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(En.Root, { ref: n, className: c("pr-twp", Xo(), t), ...e }));
...
const pe = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  oe.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(oe.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(he, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
pe.displayName = oe.Item.displayName;
function Ho(t) {
...
function $e({
  ...
  const [N, _] = A(!1);
  return /* @__PURE__ */ d(Yt, { open: N, onOpenChange: _, ...y, children: [
    /* @__PURE__ */ r(qt, { asChild: !0, children: /* @__PURE__ */ d(
      M,
      {
        variant: h,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      It,
      {
        ...
        children: /* @__PURE__ */ d(Ht, { children: [
          /* @__PURE__ */ r(we, { placeholder: u, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(be, { children: g }),
          /* @__PURE__ */ r(Ut, { children: e.map((k) => /* @__PURE__ */ d(
            Ct,
            {
              value: w(k),
              onSelect: () => {
...
var Yo = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(Yo || {});
...
function pi({
  ...
  const u = Ve(l, "%webView_bookSelector_currentBook%"), g = Ve(l, "%webView_bookSelector_choose%"), h = Ve(l, "%webView_bookSelector_chooseBooks%"), [f, b] = A(
    "current book"
    /* CURRENT_BOOK */
  ), y = (N) => {
    b(N), t(N);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(U, { className: "tw-ms-1", children: u })
          ] }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(U, { className: "tw-ms-1", children: h })
          ] }),
          /* @__PURE__ */ r(U, { className: "tw-flex tw-items-center", children: o.map((N) => O.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ r(
            M,
            {
...
}), Xn = $.Trigger, Hn = $.Group, qo = $.Portal, Ko = $.Sub, Jo = $.RadioGroup;
function Qe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ze.Provider, { value: n, children: /* @__PURE__ */ r($.Root, { ...e }) });
}
const Un = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = lt();
  return /* @__PURE__ */ d(
    $.SubTrigger,
    {
...
Un.displayName = $.SubTrigger.displayName;
...
Yn.displayName = $.SubContent.displayName;
...
ve.displayName = $.Content.displayName;
const qn = m.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = K(), i = lt();
  return /* @__PURE__ */ r(
    $.Item,
    {
...
qn.displayName = $.Item.displayName;
const tn = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    $.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
tn.displayName = $.CheckboxItem.displayName;
const Kn = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = lt();
  return /* @__PURE__ */ d(
    $.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(he, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Kn.displayName = $.RadioItem.displayName;
...
en.displayName = $.Label.displayName;
...
xe.displayName = $.Separator.displayName;
...
function Zo({ table: t }) {
  return /* @__PURE__ */ d(Qe, { children: [
    /* @__PURE__ */ r(fo, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Ar, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const $t = G.Root, Qo = G.Group, Ft = G.Value, ta = _t(
  ...
  return /* @__PURE__ */ d(
    G.Trigger,
    {
      className: c(ta({ size: n, className: t })),
      ref: a,
      ...o,
      dir: i,
      children: [
...
zt.displayName = G.Trigger.displayName;
const Jn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  G.ScrollUpButton,
  {
    ref: n,
...
Jn.displayName = G.ScrollUpButton.displayName;
const Wn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  G.ScrollDownButton,
  {
    ref: n,
    className: c("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
...
Wn.displayName = G.ScrollDownButton.displayName;
const Ot = m.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const i = K();
...
const ea = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: n,
...
const st = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  G.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
...
na.displayName = G.Separator.displayName;
function ra({ table: t }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        $t,
        {
          ...
          children: [
            /* @__PURE__ */ r(zt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ft, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(Ot, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(st, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function ae(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && oa(o)
  );
}
  ...
  m.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        ae(s, '[tabindex]:not([tabindex="-1"])').forEach((u) => {
...
const aa = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? ae(t.current) : [], i = a.indexOf(document.activeElement), s = o.key === "ArrowRight" ? i + 1 : i - 1;
  ...
  const w = m.useMemo(
    ...
    (u) => {
      ...
      if (u.key === "ArrowDown" || u.key === "ArrowUp")
        u.preventDefault(), wa(f, b, u.key);
      else if (u.key === "ArrowLeft" || u.key === "ArrowRight")
        u.preventDefault(), ia(w, y, u.key);
...
function da({
  ...
  var N;
  const [w, p] = A([]), [l, u] = A([]), [g, h] = A({}), [f, b] = A({}), y = Vn({
    data: e,
    columns: t,
    getCoreRowModel: Dn(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    a && /* @__PURE__ */ r(Zo, { table: y }),
    /* @__PURE__ */ d(ye, { stickyHeader: i, children: [
      /* @__PURE__ */ r(Ne, { stickyHeader: i, children: y.getHeaderGroups().map((_) => /* @__PURE__ */ r(kt, { children: _.headers.map((k) => /* @__PURE__ */ r(se, { children: k.isPlaceholder ? void 0 : ee(k.column.columnDef.header, k.getContext()) }, k.id)) }, _.id)) }),
      /* @__PURE__ */ r(ke, { children: (N = y.getRowModel().rows) != null && N.length ? y.getRowModel().rows.map((_) => /* @__PURE__ */ r(
        kt,
        {
          onClick: () => s(_, y),
          "data-state": _.getIsSelected() && "selected",
          children: _.getVisibleCells().map((k) => /* @__PURE__ */ r(Lt, { children: ee(k.column.columnDef.cell, k.getContext()) }, k.id))
        },
        _.id
      )) : /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r(Lt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && o && /* @__PURE__ */ r(ra, { table: y })
  ] });
}
function mi({ id: t, markdown: e, className: n, anchorTarget: o }) {
  const a = H(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: c("pr-twp tw-prose", n), children: /* @__PURE__ */ r(go, { options: a, children: e }) });
}
const ca = Object.freeze([
  "%webView_error_dump_header%",
  "%webView_error_dump_info_message%"
]), Nn = (t, e) => t[e] ?? e;
function pa({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const o = Nn(n, "%webView_error_dump_header%"), a = Nn(n, "%webView_error_dump_info_message%");
  function i() {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(M, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Lr, {}) })
    ] }),
...
function hi({
  ...
  return /* @__PURE__ */ d(Yt, { onOpenChange: (l) => {
    l || s(!1);
  }, children: [
    /* @__PURE__ */ r(qt, { asChild: !0, children: o }),
    /* @__PURE__ */ d(It, { className: c("tw-min-w-80 tw-max-w-96", a), children: [
      i && n["%webView_error_dump_copied_message%"] && /* @__PURE__ */ r(U, { children: n["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ r(
        pa,
        {
          errorDetails: t,
...
function fi({ id: t, label: e, groups: n }) {
  const [o, a] = A(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Qe, { children: [
    /* @__PURE__ */ r(Xn, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ve, { children: n.map((l, u) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Hn, { children: l.itemType === 0 ? /* @__PURE__ */ r(ne, { children: l.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        tn,
        {
          checked: o[u][h],
        ...
        Jo,
        {
          ...
          children: l.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Kn, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(xe, {})
    ] }, l.label)) })
...
function ua({ id: t, versionHistory: e }) {
...
function bi({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(ua, { versionHistory: a }),
...
const ha = _t(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: c("pr-twp", ha({ variant: e }), t), ...n })
);
...
function fa({
  ...
  const [g, h] = A(!1), f = j(
    ...
    const N = t.filter((k) => k.starred).sort((k, D) => k.label.localeCompare(D.label)), _ = t.filter((k) => !k.starred).sort((k, D) => {
      const z = n.includes(k.value), J = n.includes(D.value);
      return z && !J ? -1 : !z && J ? 1 : k.label.localeCompare(D.label);
    });
    return [...N, ..._];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ d(Yt, { open: g, onOpenChange: h, children: [
    /* @__PURE__ */ r(qt, { asChild: !0, children: /* @__PURE__ */ d(
      M,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(It, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Ht, { children: [
      /* @__PURE__ */ r(we, { placeholder: `Search ${a.toLowerCase()}...` }),
      /* @__PURE__ */ d(Ut, { children: [
        /* @__PURE__ */ r(be, { children: i }),
        /* @__PURE__ */ r(Mt, { children: y.map((N) => {
...
function ga({
  ...
  const o = n["%webView_inventory_occurrences_table_header_reference%"], a = n["%webView_inventory_occurrences_table_header_occurrence%"], i = H(() => {
    const s = [];
    return t.forEach((w) => {
  ...
  return /* @__PURE__ */ d(ye, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(ke, { children: i.length > 0 && i.map((s) => /* @__PURE__ */ d(
      kt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Lt, { children: `${O.bookIdToEnglishName(s.reference.book)} ${s.reference.chapterNum}:${s.reference.verseNum}` }),
          /* @__PURE__ */ r(Lt, { children: s.text })
        ]
      },
...
nn.displayName = Pe.Root.displayName;
...
), ba = m.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  zn.Root,
  {
    ref: a,
    className: c(Zn({ variant: e, size: n, className: t })),
    ...o
  }
));
ba.displayName = zn.Root.displayName;
const Qn = m.createContext({
  size: "default",
  variant: "default"
}), tr = m.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, i) => {
  const s = K();
  return /* @__PURE__ */ r(
    ge.Root,
    {
...
const Ce = (t) => t === "asc" ? /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), xi = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ d(tr, { value: s, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        ce,
        {
          onClick: (p) => {
  ...
  return e ? e[1] : "";
}, xa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Si = Object.freeze([
...
function Ti({
  ...
  const l = gt(n, "%webView_inventory_all%"), u = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), y = gt(n, "%webView_inventory_scope_verse%"), N = gt(n, "%webView_inventory_filter_text%"), _ = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [k, D] = A(!1), [z, J] = A("all"), [it, ut] = A(""), [C, v] = A([]), B = H(() => t.length === 0 ? [] : Na(t, a, i), [t, a, i]), S = H(() => {
    if (k) return B;
    const R = [];
    return B.forEach((X) => {
      const dt = X.items[0], ht = R.find(
        (vt) => vt.items[0] === dt
      );
      ht ? (ht.count += X.count, ht.occurrences = ht.occurrences.concat(X.occurrences)) : R.push({
        items: [dt],
        count: X.count,
  ...
  }, [k, B]), Z = H(() => ya(S, z, it), [S, z, it]), T = H(() => {
    var dt, ht;
    if (!k) return p;
    const R = (dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt.length;
    if (!R) return p;
    const X = [];
  ...
  Vt(() => {
    Z.length === 0 ? v([]) : Z.length === 1 && v(Z[0].items);
  }, [Z]);
  const Jt = (R, X) => {
    X.setRowSelection(() => {
      const dt = {};
      return dt[R.index] = !0, dt;
    }), v(R.original.items);
  }, At = (R) => {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        $t,
        {
          ...
          defaultValue: z,
          children: [
            /* @__PURE__ */ r(zt, { className: "tw-m-1", children: /* @__PURE__ */ r(Ft, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d($t, { onValueChange: (R) => At(R), defaultValue: s, children: [
        /* @__PURE__ */ r(zt, { className: "tw-m-1", children: /* @__PURE__ */ r(Ft, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Ot, { children: [
          /* @__PURE__ */ r(st, { value: "book", children: f }),
          /* @__PURE__ */ r(st, { value: "chapter", children: b }),
          /* @__PURE__ */ r(st, { value: "verse", children: y })
        ] })
      ] }),
      /* @__PURE__ */ r(
        le,
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(U, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? _ })
      ] })
    ] }),
...
rn.displayName = On.Root.displayName;
...
const on = ie.Provider, an = ie.Root, sn = ie.Trigger, _e = m.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  ie.Content,
  {
    ref: o,
    sideOffset: e,
...
_e.displayName = ie.Content.displayName;
const ka = "16rem", Ca = "3rem", er = m.createContext(void 0);
function Se() {
  const t = m.useContext(er);
  if (!t)
...
const nr = m.forwardRef(
  ({
    ...
    const [l, u] = m.useState(t), g = e ?? l, h = m.useCallback(
      (D) => {
        const z = typeof D == "function" ? D(g) : D;
        n ? n(z) : u(z);
      },
      [n, g]
    ), f = m.useCallback(() => h((D) => !D), [h]), b = g ? "expanded" : "collapsed", _ = K() === "ltr" ? s : s === "primary" ? "secondary" : "primary", k = m.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(er.Provider, { value: k, children: /* @__PURE__ */ r(on, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const rr = m.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, i) => {
  const s = Se();
...
const _a = m.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Se();
  return /* @__PURE__ */ d(
    M,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(to, {}) : /* @__PURE__ */ r(eo, {}),
...
const Ta = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  le,
  {
    ref: n,
    "data-sidebar": "input",
...
const Le = m.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Gt : "div",
  {
    ref: o,
...
const Ma = m.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Gt : "button",
  {
    ref: o,
...
Ma.displayName = "SidebarGroupAction";
...
const Da = _t(
  ...
  ({
    ...
    const p = t ? Gt : "button", { state: l } = Se(), u = /* @__PURE__ */ r(
      p,
      {
        ref: w,
        ...
        "data-size": o,
        "data-active": e,
        className: c(Da({ variant: n, size: o }), i),
        ...s
      }
    );
...
const za = m.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Gt : "button",
  {
    ref: a,
...
za.displayName = "SidebarMenuAction";
...
Oa.displayName = "SidebarMenuBadge";
const Ia = m.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(kn, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          kn,
          {
...
Ia.displayName = "SidebarMenuSkeleton";
const Aa = m.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "ul",
    {
      ref: n,
...
Aa.displayName = "SidebarMenuSub";
const Pa = m.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Pa.displayName = "SidebarMenuSubItem";
const Ba = m.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Gt : "a",
  {
    ref: i,
...
Ba.displayName = "SidebarMenuSubButton";
function ja({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  return /* @__PURE__ */ r(
    rr,
    {
      ...
      children: /* @__PURE__ */ d(ar, { children: [
        /* @__PURE__ */ d(Fe, { children: [
          /* @__PURE__ */ r(Le, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ r(Ge, { children: /* @__PURE__ */ r(sr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(ir, { children: /* @__PURE__ */ r(
            wr,
            {
              onClick: () => l(h),
              isActive: g(h),
    ...
    /* @__PURE__ */ d(
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(or, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const yt = "scrBook", $a = "scrRef", Et = "source", Fa = "details", La = "Scripture Reference", Ga = "Scripture Book", lr = "Type", Xa = "Details";
function Ha(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: yt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? La,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? O.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === yt ? Bt(a.start) : void 0;
      },
      getGroupingValue: (o) => O.bookIdToNumber(o.start.book),
    ...
    },
    {
      ...
      id: Et,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? lr : void 0,
    ...
    },
    {
      ...
      id: Fa,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Xa,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, Cn = (t) => `${Ua({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ei({
  sources: t,
  ...
  const [p, l] = A([]), [u, g] = A([{ id: yt, desc: !1 }]), [h, f] = A({}), b = H(
  ...
  const N = Vn({
    ...
    getExpandedRowModel: ho(),
    getGroupedRowModel: uo(),
    getCoreRowModel: Dn(),
    getSortedRowModel: Mn(),
    getRowId: Cn,
    autoResetExpanded: !1,
  ...
  Vt(() => {
    if (w) {
      const C = N.getSelectedRowModel().rowsById, v = Object.keys(C);
      if (v.length === 1) {
        const B = b.find((S) => Cn(S) === v[0]) || void 0;
        B && w(B);
      }
    }
  }, [h, b, w, N]);
  const _ = a ?? Ga, k = i ?? lr, D = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${_}`, value: [yt] },
    { label: `Group by ${k}`, value: [Et] },
    {
  ...
  }, it = (C, v) => C.getIsGrouped() ? "" : c("banded-row", v % 2 === 0 ? "even" : "odd"), ut = (C, v, B) => {
    if (!((C == null ? void 0 : C.length) === 0 || v.depth < B.column.getGroupedIndex())) {
      if (v.getIsGrouped())
        switch (v.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      $t,
      {
        ...
        children: [
          /* @__PURE__ */ r(zt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ft, {}) }),
          /* @__PURE__ */ r(Ot, { position: "item-aligned", children: /* @__PURE__ */ r(Qo, { children: D.map((C) => /* @__PURE__ */ r(st, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ne, { children: N.getHeaderGroups().map((C) => /* @__PURE__ */ r(kt, { children: C.headers.filter((v) => v.column.columnDef.header).map((v) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(se, { colSpan: v.colSpan, className: "top-0 tw-sticky", children: v.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          ee(v.column.columnDef.header, v.getContext())
        ] }) }, v.id)
      )) }, C.id)) }),
      /* @__PURE__ */ r(ke, { children: N.getRowModel().rows.map((C, v) => {
        const B = K();
        return /* @__PURE__ */ r(
          kt,
          {
            ...
            children: C.getVisibleCells().map((S) => {
              if (!(S.getIsPlaceholder() || S.column.columnDef.enableGrouping && !S.getIsGrouped() && (S.column.columnDef.id !== Et || !n)))
                return /* @__PURE__ */ r(
                  Lt,
                  {
                    className: c(
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (B === "ltr" ? /* @__PURE__ */ r(jt, {}) : /* @__PURE__ */ r(Ie, {})),
                          " ",
...
}), dr = (t, e, n) => ln(t, e).every((o) => n.includes(o));
function Ka({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: a && ((w = a.get(t)) == null ? void 0 : w.localizedName) || O.bookIdToEnglishName(t)
          }
        ),
...
function Ja({
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      onClick: () => o(t),
      className: c(
        dr(e, t, n) && !i && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: i,
      children: qa(
        t,
...
function Wa({
  ...
  const z = H(() => O.allBookIds.filter(
    ...
    (v, B = !1) => {
      ...
      const S = z.findIndex((Q) => Q === k.current), Z = z.findIndex((Q) => Q === v);
      if (S === -1 || Z === -1) return;
      const [T, Jt] = [
        Math.min(S, Z),
        Math.max(S, Z)
      ], At = z.slice(T, Jt + 1).map((Q) => Q);
      n(
        e.includes(v) ? e.filter((Q) => !At.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...At])]
      );
    },
    [e, n, z]
  ), it = j(
    (v) => {
      const B = ln(z, v).map((S) => S);
      n(
        dr(z, v, e) ? e.filter((S) => !B.includes(S)) : [.../* @__PURE__ */ new Set([...e, ...B])]
      );
    },
    [e, n, z]
  ), ut = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ d(Yt, { open: N, onOpenChange: _, children: [
      /* @__PURE__ */ r(qt, { asChild: !0, children: /* @__PURE__ */ d(
        M,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(It, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
        Ht,
        {
          onKeyDown: (v) => {
            v.key === "Enter" && (D.current = v.shiftKey);
          },
          children: [
            /* @__PURE__ */ r(we, { placeholder: w }),
            /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(M, { variant: "ghost", size: "sm", onClick: ut, children: p }),
              /* @__PURE__ */ r(M, { variant: "ghost", size: "sm", onClick: C, children: l })
            ] }),
            /* @__PURE__ */ d(Ut, { children: [
              /* @__PURE__ */ r(be, { children: u }),
              Object.values(Nt).map((v, B) => {
                const S = z.filter(
                  (Z) => Pt(Z) === v
                );
                if (S.length !== 0)
                  return /* @__PURE__ */ d(Tn, { children: [
                    /* @__PURE__ */ r(
                      Mt,
                      {
                        heading: Ya(
                    ...
                    B < Object.values(Nt).length - 1 && /* @__PURE__ */ r(An, {})
                  ] }, v);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var B;
        return /* @__PURE__ */ r(me, { className: "hover:tw-bg-secondary", variant: "secondary", children: a && ((B = a.get(v)) == null ? void 0 : B.localizedName) || O.bookIdToEnglishName(v) || v }, v);
      }),
...
function Mi({
  ...
  const p = Tt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), g = Tt(s, "%webView_scope_selector_current_book%"), h = Tt(s, "%webView_scope_selector_choose_books%"), f = Tt(s, "%webView_scope_selector_scope%"), b = Tt(s, "%webView_scope_selector_select_books%"), y = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        We,
        {
          ...
          children: N.map(({ value: _, label: k, id: D }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(pe, { className: "tw-me-2", value: _, id: D }),
            /* @__PURE__ */ r(U, { htmlFor: D, children: k })
          ] }, D))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(U, { children: b }),
      /* @__PURE__ */ r(
        Wa,
        {
          availableBookInfo: o,
...
function Di({
  ...
  return /* @__PURE__ */ d(
    $t,
    {
      ...
      children: [
        /* @__PURE__ */ r(zt, { size: a, className: c("pr-twp tw-w-auto", i), children: /* @__PURE__ */ r(
          Ft,
          {
            placeholder: s[P(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          Ot,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((p) => /* @__PURE__ */ r(st, { value: `${p}`, children: s[P(p)] }, `${p}`))
          }
        )
      ]
    }
...
const pr = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(sn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(qo, { children: /* @__PURE__ */ r(Yn, { children: pr(
      t,
      e,
      cr(t, w.id),
      o
...
function Xe({
  ...
  return /* @__PURE__ */ d(Qe, { variant: i, children: [
    /* @__PURE__ */ r(Xn, { "aria-label": n, className: a, asChild: !0, id: w, children: /* @__PURE__ */ r(M, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(ro, {}) }) }),
    /* @__PURE__ */ r(ve, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, l]) => typeof p == "boolean" || typeof l == "boolean" ? 0 : p.order - l.order).map(([p], l, u) => /* @__PURE__ */ d(Tn, { children: [
      /* @__PURE__ */ r(Hn, { children: /* @__PURE__ */ r(on, { children: pr(e.groups, e.items, p, t) }) }),
...
function Ai({
  ...
  return /* @__PURE__ */ d(mr, { className: `tw-w-full tw-border tw-bg-background ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      Xe,
      {
        onSelectMenuItem: t,
...
function Pi({
  ...
  return /* @__PURE__ */ r(mr, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    Xe,
    {
      onSelectMenuItem: t,
      menuData: e,
...
)), fr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Content,
  {
    ref: n,
    className: c(
...
function Bi({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(ur, { children: [
      /* @__PURE__ */ r(hr, { children: t.map((s) => /* @__PURE__ */ r(Za, { value: s.value, children: s.value }, s.key)) }),
      t.map((s) => /* @__PURE__ */ r(fr, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
function Qa({ ...t }) {
...
const gr = m.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = m.useMemo(
    () => ({
      variant: e
    }),
...
gr.displayName = F.Root.displayName;
...
const xr = m.forwardRef(({ className: t, ...e }, n) => {
  const o = lt();
  return /* @__PURE__ */ r(
    F.SubContent,
    {
...
xr.displayName = F.SubContent.displayName;
const yr = m.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, i) => {
  const s = lt();
...
yr.displayName = F.Content.displayName;
const Nr = m.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = lt();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
const ns = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = lt();
  return /* @__PURE__ */ d(
    F.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(he, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
ns.displayName = F.RadioItem.displayName;
const rs = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: o,
    className: c("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
rs.displayName = F.Label.displayName;
const kr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  F.Separator,
  {
    ref: n,
    className: c("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
kr.displayName = F.Separator.displayName;
const Qt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([i], s) => {
    ...
    return w.length > 0 && s < a.length - 1 && p.push(/* @__PURE__ */ r(kr, {}, `separator-${i}`)), p;
  });
};
function os({
  menuData: t,
  ...
  const a = q(void 0), i = q(void 0), s = q(void 0), w = q(void 0), p = q(void 0), l = (u) => {
    switch (u) {
      case "platform.app":
        return i;
  ...
  if (bo(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, g) => {
    var b, y, N, _;
    u.preventDefault();
    ...
    switch (g.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), Qt(s, [h, f]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), Qt(w, [h, f]);
        break;
      case "alt+h":
        (_ = p.current) == null || _.focus(), Qt(p, [h, f]);
        break;
    }
  }), Vt(() => {
    ...
    return /* @__PURE__ */ r(gr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, g]) => typeof u == "boolean" || typeof g == "boolean" ? 0 : u.order - g.order).map(([u, g]) => /* @__PURE__ */ d(Qa, { children: [
      /* @__PURE__ */ r(br, { ref: l(u), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        yr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(on, { children: Cr(t.groups, t.items, u, e) })
        }
      )
    ] }, u)) });
}
...
function Fi({
  ...
  const p = as(
    ...
    var N, _, k, D, z, J;
    const y = b !== f ? ((_ = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : _[b]) ?? ((D = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : D.en) : void 0;
    return y ? `${(z = t[f]) == null ? void 0 : z.autonym} (${y})` : (J = t[f]) == null ? void 0 : J.autonym;
  };
  return /* @__PURE__ */ d("div", { className: c("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ d(
      $t,
      {
        ...
        onOpenChange: (f) => u(f),
        children: [
          /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(Ft, {}) }),
          /* @__PURE__ */ r(
            Ot,
            {
              className: "tw-z-[250]",
    ...
    e !== "en" && /* @__PURE__ */ d(ne, { children: [
      /* @__PURE__ */ r(U, { className: "tw-ms-3", children: p }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ d(U, { children: [
        "Currently:",
        " ",
...
function ss({ item: t, createLabel: e, createComplexLabel: n }) {
...
const is = Sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(so, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
), ls = m.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, role: "alert", className: c(ws({ variant: e }), t), ...n }));
...
const cs = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: c("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
cs.displayName = "AlertDescription";
...
ps.displayName = Xt.Root.displayName;
...
ms.displayName = Xt.Image.displayName;
...
us.displayName = Xt.Fallback.displayName;
...
gs.displayName = "CardTitle";
const bs = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Xi = L.Root, Hi = L.Trigger, Ui = L.Group, Yi = L.Portal, qi = L.Sub, Ki = L.RadioGroup, ys = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  L.SubTrigger,
  {
    ref: a,
    className: c(
...
ys.displayName = L.SubTrigger.displayName;
...
Ns.displayName = L.SubContent.displayName;
const ks = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(L.Portal, { children: /* @__PURE__ */ r(
  L.Content,
  {
    ref: n,
    className: c(
...
ks.displayName = L.Content.displayName;
const Cs = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  L.Item,
  {
    ref: o,
    className: c(
...
Cs.displayName = L.Item.displayName;
const _s = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  L.CheckboxItem,
  {
    ref: a,
    className: c(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
_s.displayName = L.CheckboxItem.displayName;
const Ss = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  L.RadioItem,
  {
    ref: o,
    className: c(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(he, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
Ss.displayName = L.RadioItem.displayName;
const Ts = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  L.Label,
  {
    ref: o,
    className: c(
...
Ts.displayName = L.Label.displayName;
...
Rs.displayName = L.Separator.displayName;
...
Es.displayName = "ContextMenuShortcut";
const _r = m.createContext({
  direction: "bottom"
});
function Vs({
  ...
  return /* @__PURE__ */ r(_r.Provider, { value: o, children: /* @__PURE__ */ r(
    wt.Root,
    {
...
const Ji = wt.Trigger, Ms = wt.Portal, Wi = wt.Close, Sr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
...
Sr.displayName = wt.Overlay.displayName;
const Ds = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: i = "bottom" } = m.useContext(_r), s = {
...
Is.displayName = wt.Title.displayName;
...
As.displayName = wt.Description.displayName;
const Ps = m.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Be.Root,
  {
    ref: o,
    className: c(
...
Ps.displayName = Be.Root.displayName;
function Zi({ ...t }) {
  return /* @__PURE__ */ r(
    vo,
    {
...
Bs.displayName = te.Root.displayName;
...
const Qi = rt.Root, $s = m.forwardRef(({ className: t, ...e }, n) => {
  const o = K();
  return /* @__PURE__ */ r(
    rt.List,
    {
...
$s.displayName = rt.List.displayName;
...
Fs.displayName = rt.Trigger.displayName;
...
const Hs = (t, e, n = {}) => {
  ...
  o.current = e;
  const a = q(n);
  a.current = Xs(a.current);
  const [i, s] = A(() => o.current), [w, p] = A(!0);
  return Vt(() => {
    let l = !0;
    return p(!!t), (async () => {
      if (t) {
  ...
  const a = q(null), [i, s] = A(void 0), [w, p] = A(void 0), l = j(
    (h) => {
      s(h);
...
export {
  ls as Alert,
  cs as AlertDescription,
  ds as AlertTitle,
  ps as Avatar,
  us as AvatarFallback,
  ms as AvatarImage,
  ci as BOOK_SELECTOR_STRING_KEYS,
  me as Badge,
  ...
  Ut as CommandList,
  Xi as ContextMenu,
  _s as ContextMenuCheckboxItem,
  ks as ContextMenuContent,
  Ui as ContextMenuGroup,
  Cs as ContextMenuItem,
  Ts as ContextMenuLabel,
  Yi as ContextMenuPortal,
  Ki as ContextMenuRadioGroup,
  Ss as ContextMenuRadioItem,
  Rs as ContextMenuSeparator,
  Es as ContextMenuShortcut,
  qi as ContextMenuSub,
  Ns as ContextMenuSubContent,
  ys as ContextMenuSubTrigger,
  Hi as ContextMenuTrigger,
  da as DataTable,
  Vs as Drawer,
  Wi as DrawerClose,
  Ds as DrawerContent,
  ...
  ui as ERROR_POPOVER_STRING_KEYS,
  pa as ErrorDump,
  hi as ErrorPopover,
  vi as Filter,
  fi as FilterDropdown,
  bi as Footer,
  Si as INVENTORY_STRING_KEYS,
  le as Input,
  Ti as Inventory,
  U as Label,
  mi as MarkdownRenderer,
  gi as MoreInfo,
  ...
  jo as RecentSearches,
  Vi as SCOPE_SELECTOR_STRING_KEYS,
  Mi as ScopeSelector,
  Ei as ScriptureResultsViewer,
  Di as ScrollGroupSelector,
  wn as SearchBar,
  $t as Select,
  Ot as SelectContent,
  Qo as SelectGroup,
  ...
  rn as Separator,
  zi as SettingsList,
  Ii as SettingsListHeader,
  Oi as SettingsListItem,
