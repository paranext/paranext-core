...
import { ChevronRight as is, Check as as, Circle as ss, History as ls, ArrowDownWideNarrow as cs, Clock as us, Bookmark as ps } from "lucide-react";
import we, { clsx as ds } from "clsx";
...
function ym({ scrRef: e, handleSubmit: t }) {
  ...
  return /* @__PURE__ */ T("div", { children: /* @__PURE__ */ ue(Gs, { modal: !1, open: l, onOpenChange: m, children: [
...
function dl() {
  if (Mo)
    return cr;
  Mo = 1;
  var e = Ai(), t = ul(), n = jr(), r = Di(), o = pl(), i = function() {
  };
...
const $l = typeof window < "u" ? x.useLayoutEffect : x.useEffect, ht = $l;
let jo = 0;
function Ml(e) {
...
function zl(e) {
  e.addEventListener("keydown", Fl, !0), e.addEventListener("mousedown", pr, !0), e.addEventListener("pointerdown", pr, !0), e.addEventListener("touchstart", pr, !0), e.addEventListener("visibilitychange", Vl, !0);
}
function Ul(e) {
  const {
    target: t
...
function wc(e) {
  const {
    ...
    open: p,
    rootRef: f
  } = e, d = x.useRef({}), b = x.useRef(null), v = x.useRef(null), g = Be(v, f), [m, E] = x.useState(!p), S = vc(c);
  let y = !0;
...
var Se = "top", Le = "bottom", Fe = "right", Ce = "left", Lr = "auto", dn = [Se, Le, Fe, Ce], _t = "start", sn = "end", xc = "clippingParents", ra = "viewport", Gt = "popper", Ec = "reference", Ho = /* @__PURE__ */ dn.reduce(function(e, t) {
...
function Fc(e) {
  ...
  if (!(!i || !s)) {
    var f = Lc(o.padding, n), d = Vr(i), b = c === "y" ? Se : Ce, v = c === "y" ? Le : Fe, g = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], m = s[c] - n.rects.reference[c], E = fn(i), S = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - m / 2, w = f[b], h = S - d[p] - f[v], C = S / 2 - d[p] / 2 + y, P = tn(w, C, h), A = c;
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? xc : l, u = n.rootBoundary, p = u === void 0 ? ra : u, f = n.elementContext, d = f === void 0 ? Gt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, E = la(typeof m != "number" ? m : ca(m, dn)), S = d === Gt ? Ec : Gt, y = e.rects.popper, w = e.elements[v ? S : d], h = tu(bt(w) ? w : w.contextElement || at(e.elements.popper), c, p, s), C = Dt(e.elements.reference), P = pa({
    reference: C,
    element: y,
    strategy: "absolute",
    placement: o
...
function ou(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, p = n.boundary, f = n.rootBoundary, d = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Ue(m), S = E === m, y = c || (S || !v ? [Sn(m)] : ru(m)), w = [m].concat(y).reduce(function(F, U) {
...
function mu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, p = n.altBoundary, f = n.padding, d = n.tether, b = d === void 0 ? !0 : d, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = ln(t, {
    ...
    padding: f,
    altBoundary: p
  }), E = Ue(t.placement), S = jt(t.placement), y = !S, w = zr(E), h = fu(w), C = t.modifiersData.popperOffsets, P = t.rects.reference, A = t.rects.popper, _ = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, D = typeof _ == "number" ? {
    mainAxis: _,
    altAxis: _
  ...
  if (C) {
    ...
    if (l) {
      var Te, me = w === "x" ? Se : Ce, lt = w === "x" ? Le : Fe, ke = C[h], Ge = h === "y" ? "height" : "width", Pe = ke + m[me], Xe = ke - m[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[h]) != null ? Te : 0, ct = ye ? Pe : ke - P[Ge] - A[Ge] - yt + D.altAxis, Vt = ye ? ke + P[Ge] + A[Ge] - yt - D.altAxis : Xe, bn = b && ye ? Bc(ct, ke, Vt) : tn(b ? ct : Pe, ke, b ? Vt : Xe);
      C[h] = bn, z[h] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
  ...
  return function(l, c, u) {
    ...
    var p = {
      ...
      setOptions: function(E) {
        ...
        var y = xu(Tu([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!d) {
          ...
          if (Zo(S, y)) {
            p.rects = {
              reference: yu(S, fn(y), p.options.strategy === "fixed"),
              popper: Vr(y)
...
var Ou = [Xc, du, qc, Ac, uu, iu, hu, zc, su], Su = /* @__PURE__ */ ku({
  defaultModifiers: Ou
});
const da = "Popper";
function Cu(e) {
...
const Mu = () => et({
  ...
  } = t, m = ce(t, Pu), E = x.useRef(null), S = Be(E, n), y = x.useRef(null), w = Be(y, d), h = x.useRef(w);
  ht(() => {
    h.current = w;
  }, [w]), x.useImperativeHandle(d, () => y.current, []);
  const C = Nu(p, s), [P, A] = x.useState(C), [_, D] = x.useState(An(o));
  x.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: m = {},
    slots: E = {}
  } = t, S = ce(t, Ru), [y, w] = x.useState(!0), h = () => {
    w(!1);
  }, C = () => {
    w(!0);
  };
...
const Ju = Ve("border", Ae), Zu = Ve("borderTop", Ae), Qu = Ve("borderRight", Ae), ep = Ve("borderBottom", Ae), tp = Ve("borderLeft", Ae), np = Ve("borderColor"), rp = Ve("borderTopColor"), op = Ve("borderRightColor"), ip = Ve("borderBottomColor"), ap = Ve("borderLeftColor"), sp = Ve("outline", Ae), lp = Ve("outlineColor"), Kn = (e) => {
...
Xn(Ju, Zu, Qu, ep, tp, np, rp, op, ip, ap, Kn, sp, lp);
const Yn = (e) => {
...
Xn(Yn, Jn, Zn, cp, up, pp, dp, fp, mp, hp, gp, bp);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const vp = be({
...
function Np() {
  ...
  function t(n) {
    ...
    function l(c) {
      ...
      if (!u)
        return null;
      const p = Vu(i.breakpoints), f = Object.keys(p);
      let d = p;
...
const Mp = ["breakpoints", "palette", "spacing", "shape"];
function Yr(e = {}, ...t) {
  const {
    breakpoints: n = {},
    palette: r = {},
  ...
  return u.applyStyles = $p, u = t.reduce((p, f) => Ye(p, f), u), u.unstable_sxConfig = k({}, Xr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Kr({
      sx: f,
      theme: this
    });
...
const Ap = ["ownerState"], Dp = ["variants"], jp = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Bp(e) {
  return Object.keys(e).length === 0;
}
function Lp(e) {
...
const Fp = Yr(), ti = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Tn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function zp(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: d = Vp(ti(u))
    } = l, b = ce(l, jp), v = p !== void 0 ? p : (
...
function ni(e) {
  e = vt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? vt(qp(e)).values : e.values;
...
const Yp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ot = od, id = ["mode", "contrastThreshold", "tonalOffset"], oi = {
...
function ii(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Xp(e.main, o) : t === "dark" && (e.dark = Gp(e.main, i)));
}
function ad(e = "light") {
  return e === "dark" ? {
    main: Tt[200],
...
function dd(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ce(e, id), i = e.primary || ad(t), s = e.secondary || sd(t), l = e.error || ld(t), c = e.info || cd(t), u = e.success || ud(t), p = e.warning || pd(t);
  function f(g) {
...
const gd = 0.2, bd = 0.14, vd = 0.12;
function pe(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${gd})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${bd})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${vd})`].join(",");
}
const yd = ["none", pe(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), pe(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), pe(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), pe(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), pe(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), pe(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), pe(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), pe(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), pe(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), pe(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), pe(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), pe(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), pe(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), pe(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), pe(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), pe(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), pe(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), pe(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), pe(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), pe(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), pe(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), pe(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), pe(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), pe(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], wd = yd, xd = ["duration", "easing", "delay"], Ed = {
...
function Od(e) {
  const t = k({}, Ed, e.easing), n = k({}, Td, e.duration);
  return k({
...
const Sd = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Cd = Sd, Pd = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Rd(e = {}, ...t) {
  const {
    mixins: n = {},
    palette: r = {},
...
const Nd = Rd(), Zr = Nd, Qr = "$$material", ya = (e) => Cn(e) && e !== "classes", $d = zp({
  themeId: Qr,
  defaultTheme: Zr,
...
var Id = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.shape({
  enter: a.number,
  exit: a.number,
  appear: a.number
}).isRequired]) : null;
...
const Ad = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function Nr(e) {
  return `scale(${e}, ${e ** 2})`;
}
const Dd = {
  ...
  } = t, E = ce(t, Ad), S = Jt(), y = x.useRef(), w = gn(), h = x.useRef(null), C = Be(h, i.ref, n), P = (I) => (N) => {
    if (I) {
      const j = h.current;
      N === void 0 ? I(j) : I(j, N);
    }
...
const $r = eo, jd = (e) => {
...
}, ui = jd, Bd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Ld = Ee(fa, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ba(), i = tt({
    ...
    slots: y,
    slotProps: w
  } = i, h = ce(i, Bd), C = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, P = k({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: d,
...
const Vd = it("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ot = Vd, zd = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Ud(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Hd = (e) => {
...
const Oa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const C = tt({
    ...
    TransitionProps: J
  } = C, R = ce(C, zd), re = /* @__PURE__ */ x.isValidElement(A) ? A : /* @__PURE__ */ T("span", {
    children: A
...
`));
  const Ka = x.useMemo(() => {
    ...
    touch: Pe.current
  }), or = Hd(Wt), ho = (r = (o = Y.popper) != null ? o : _.Popper) != null ? r : Wd, go = (i = (s = (l = Y.transition) != null ? l : _.Transition) != null ? s : $) != null ? i : $r, bo = (c = (u = Y.tooltip) != null ? u : _.Tooltip) != null ? c : qd, vo = (p = (f = Y.arrow) != null ? f : _.Arrow) != null ? p : Gd, Ya = Zt(ho, k({}, H, (d = K.popper) != null ? d : D.popper, {
...
const Jd = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Zd = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  const r = tt({
    ...
    titleAccess: f,
    viewBox: d = "0 0 24 24"
  } = r, b = ce(r, Jd), v = /* @__PURE__ */ x.isValidElement(o) && o.type === "svg", g = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Ra(e) {
  ...
  return r ? /* @__PURE__ */ T(Xd, { title: r, placement: "right", children: /* @__PURE__ */ T("div", { children: E }) }) : E;
}
function Na(e) {
...
const hf = ["children", "className", "component", "dense", "disablePadding", "subheader"], gf = (e) => {
  const {
    classes: t,
    disablePadding: n,
    dense: r,
...
const _a = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  } = t, d = ce(t, yf), b = x.useRef(null), v = x.useRef({
    keys: [],
    repeating: !0,
...
const wf = _a, xf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Ef = {
  ...
  } = t, y = ce(t, xf), w = x.useRef(null), h = Be(w, l.ref, n), C = (L) => (I) => {
    if (L) {
      const N = w.current;
      I === void 0 ? L(N) : L(N, I);
    }
...
const Nf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], $f = (e) => {
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : Mf, H = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : E.Backdrop) != null ? i : p, K = (l = G == null ? void 0 : G.root) != null ? l : S.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : S.backdrop, ne = gt({
    elementType: q,
    externalSlotProps: K,
...
const Xf = ["onEntering"], Kf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Yf = {
  ...
  const i = tt({
    ...
    slots: S = {},
    slotProps: y = {}
  } = i, w = ce(i.TransitionProps, Xf), h = ce(i, Kf), C = gn(), P = C.direction === "rtl", A = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: w,
    variant: E
  }), _ = Zf(A), D = s && !u && d, B = x.useRef(null), z = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const I = (r = S.paper) != null ? r : em, N = (o = y.paper) != null ? o : b, j = gt({
    elementType: S.root,
...
function Tm({ scrRef: e, handleSubmit: t, id: n }) {
  const r = (c) => {
    t(c);
  }, o = (c, u) => {
...
function km({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = ze(""), i = (s) => {
    o(s), e(s);
  };
...
const am = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ T(
  il,
  {
    ...r,
    isChecked: n,
...
`, "top");
export {
  ym as BookChapterControl,
  wt as Button,
  wm as ChapterRangeSelector,
  il as Checkbox,
  wr as ComboBox,
  xm as ContextMenu,
  df as GridMenu,
