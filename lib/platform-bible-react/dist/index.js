...
var xt = (t, e, n) => ds(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as d, Fragment as ct } from "react/jsx-runtime";
import b, { forwardRef as an, useRef as H, useMemo as z, useState as S, useCallback as K, useLayoutEffect as Kt, createContext as Cn, useContext as fr, useEffect as q, Component as ps, createElement as $r, Suspense as us, Fragment as po } from "react";
import { Command as Nt } from "cmdk";
import { X as je, Search as uo, Check as Gt, Clock as Lr, ChevronsLeft as Vr, ChevronsRight as jr, ChevronLeft as Wn, ChevronRight as Oe, ArrowLeft as ms, ArrowRight as fs, Circle as En, ChevronDown as ze, BoldIcon as hs, ItalicIcon as gs, AtSign as mo, Pencil as bs, Trash2 as vs, ArrowUp as fo, MoreHorizontal as ho, MailOpen as xs, Mail as ys, ChevronUp as go, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as bo, Filter as Ts, User as Rs, Link as Ss, CircleHelp as Ds, ChevronsUpDown as vo, Star as Ms, Undo as Os, Redo as Is, SquareX as xo, FunctionSquare as yo, SquareSigma as No, Ban as As, AlertCircle as Jn, CircleCheckIcon as Ps, CircleXIcon as $s, CircleHelpIcon as Ls, ArrowUpIcon as Vs, ArrowDownIcon as js, PanelLeft as zs, PanelRight as Fs, ScrollText as Bs, MenuIcon as Ks, Menu as Gs, EllipsisVertical as Us, LoaderCircle as qs, GripVertical as Hs } from "lucide-react";
...
import { includes as cn, Section as Y, getChaptersForBook as Ws, formatScrRef as ve, getSectionForBook as We, formatRelativeDate as Js, formatReplacementString as be, sanitizeHtml as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, usfmMarkers as fn, getFormatCallerFunction as ni, deepEqual as ri, isString as zr, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as _o, $getRoot as le, $createParagraphNode as Tn, $getSelection as $t, HISTORY_MERGE_TAG as hr, ParagraphNode as Co, TextNode as Eo, $isTokenOrSegmented as oi, $getCharacterOffsets as ai, $cloneWithPropertiesEphemeral as si, $findMatchingParent as To, $isElementNode as se, $isRangeSelection as Ne, CLEAR_EDITOR_COMMAND as Ro, COMMAND_PRIORITY_EDITOR as So, mergeRegister as we, shallowMergeConfig as ii, defineExtension as Ut, safeCast as sn, createState as li, FORMAT_TEXT_COMMAND as Do, $isNodeSelection as Mo, COMMAND_PRIORITY_LOW as Oo, RootNode as wi, LineBreakNode as ci, TabNode as di, $isEditorState as pi, createCommand as ui, CLICK_COMMAND as mi, isDOMNode as fi, $getNodeFromDOMNode as hi, $createNodeSelection as gi, $setSelection as bi, DecoratorNode as Qn, $getState as vi, toggleTextFormatType as Fr, TEXT_TYPE_TO_FORMAT as xi, $setState as yi, addClassNamesToElement as Io, $create as Ni, $getNodeByKey as ki, removeClassNamesFromElement as _i, KEY_TAB_COMMAND as Ci, $isBlockElementNode as bn, $createRangeSelection as Ei, $normalizeSelection__EXPERIMENTAL as Ti, OUTDENT_CONTENT_COMMAND as Ri, INDENT_CONTENT_COMMAND as Br, INSERT_TAB_COMMAND as Si, COMMAND_PRIORITY_CRITICAL as gr, $isDecoratorNode as Di, $isParagraphNode as Mi, $isTextNode as vn, SELECTION_CHANGE_COMMAND as Ao, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as Kr, isDOMDocumentNode as Ai, ArtificialNode__DO_NOT_USE as Po, $createLineBreakNode as $o, $isRootOrShadowRoot as Pi, isBlockDomNode as Gr, isInlineDomNode as Ur, $insertNodes as $i } from "lexical";
import * as ke from "@radix-ui/react-tooltip";
import { TooltipTrigger as Li } from "@radix-ui/react-tooltip";
import { HeadingNode as Vi, QuoteNode as ji, registerRichText as zi } from "@lexical/rich-text";
import { flushSync as Fi, createPortal as Bi } from "react-dom";
import { $isTableSelection as Ki } from "@lexical/table";
...
import { useReactTable as zo, getFilteredRowModel as Ui, getSortedRowModel as Fo, getPaginationRowModel as qi, getCoreRowModel as Bo, flexRender as Je, getGroupedRowModel as Hi, getExpandedRowModel as Yi } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import Xi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as tr, HIDDEN_NOTE_CALLER as er, getDefaultViewOptions as Wi, isInsertEmbedOpOfType as dn, Editorial as Ji } from "@eten-tech-foundation/platform-editor";
...
const nl = Pt.Root, rl = Pt.Portal, Ko = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pt.Overlay,
  {
    ref: n,
    className: f(
...
Ko.displayName = Pt.Overlay.displayName;
...
Go.displayName = Pt.Content.displayName;
...
qo.displayName = Pt.Title.displayName;
const ol = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pt.Description,
  {
    ref: n,
...
ol.displayName = Pt.Description.displayName;
...
const Ke = b.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(uo, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      Nt.Input,
      {
        ref: n,
...
Ke.displayName = Nt.Input.displayName;
...
ee.displayName = Nt.List.displayName;
...
Ho.displayName = Nt.Separator.displayName;
const qt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Nt.Item,
  {
    ref: n,
...
qt.displayName = Nt.Item.displayName;
...
const Wo = ut.allBookIds.filter(
  (t) => !ut.isObsolete(ut.bookIdToNumber(t))
), xe = Object.fromEntries(
  Wo.map((t) => [t, ut.bookIdToEnglishName(t)])
);
function xr(t, e, n) {
...
const Jo = an(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Fe : "button", { className: f(Zo({ variant: e, size: n, className: t })), ref: i, ...a })
);
F.displayName = "Button";
const ne = Ie.Root, pe = Ie.Trigger, sl = Ie.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ft();
...
Ht.displayName = Ie.Content.displayName;
function ar(t, e, n) {
  return `${t} ${xe[t]}${e ? ` ${vr(t, e)} ${Me(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function il({
  recentSearches: t,
  ...
  return /* @__PURE__ */ d(ne, { open: w, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ r(Ht, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(Qt, { heading: i, children: t.map((u) => /* @__PURE__ */ d(
      qt,
      {
        onSelect: () => p(u),
      ...
      if (s) {
        ...
        if (!p && w) {
          const m = ((g) => Object.keys(xe).find(
            (y) => xe[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function cl(t, e, n, o) {
  const a = K(() => {
    if (t.chapterNum > 1)
      ...
      if (w > 0) {
        const c = e[w - 1], p = Math.max(Bt(c), 1);
        o({
          book: c,
          chapterNum: p,
          verseNum: 1
...
function Hr({
  ...
  if (t)
    return /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Bt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      qt,
      {
        value: `${t} ${xe[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function pp({
  ...
  const c = ft(), [p, u] = S(!1), [h, m] = S(""), [g, y] = S(""), [v, N] = S("books"), [k, _] = S(void 0), [C, j] = S(!1), V = H(void 0), T = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), L = K(
    (x) => {
      e(x), l && l(x);
    },
    [e, l]
  ), P = z(() => o ? o() : Wo, [o]), O = z(() => ({
    [Y.OT]: P.filter((I) => ut.isBookOT(I)),
    [Y.NT]: P.filter((I) => ut.isBookNT(I)),
    [Y.DC]: P.filter((I) => ut.isBookDC(I)),
    [Y.Extra]: P.filter((I) => ut.extraBooks().includes(I))
    ...
    return [Y.OT, Y.NT, Y.DC, Y.Extra].forEach((U) => {
      x[U] = O[U].filter((B) => xr(B, g, a));
    }), x;
  }, [O, g, a]), M = z(
    () => wl(g, A, a),
    [g, A, a]
    ...
    (x) => {
      const I = v === "chapters" ? k : M == null ? void 0 : M.book;
      I && (L({
        book: I,
        chapterNum: x,
        verseNum: 1
      }), u(!1), N("books"), _(void 0), y(""));
    },
    [L, v, k, M]
  ), Tt = K(
    (x) => {
    ...
    (x) => {
      ...
      u(x), x && (N("books"), _(void 0), y(""));
    },
    [v, pt]
  ), { otLong: at, ntLong: st, dcLong: lt, extraLong: bt } = {
    ...
    (x) => {
      if (x.ctrlKey) return;
      const { isLetter: I, isDigit: U } = qr(x.key);
      if (v === "chapters") {
        if (x.key === "Backspace") {
          x.preventDefault(), x.stopPropagation(), pt();
          return;
        }
        if (I || U) {
          if (x.preventDefault(), x.stopPropagation(), N("books"), _(void 0), U && k) {
            const B = xe[k];
            y(`${B} ${x.key}`);
          } else
            y(x.key);
      ...
      if ((v === "chapters" || v === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        const B = v === "chapters" ? k : M == null ? void 0 : M.book;
        if (!B) return;
        const W = (() => {
          if (!h) return 1;
          const it = h.match(/(\d+)$/);
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            et = W === 0 ? wt : Math.max(1, W - gt);
            break;
          case "ArrowDown":
            et = W === 0 ? 1 : Math.min(wt, W + gt);
            break;
          default:
            return;
        }
        et !== W && (x.preventDefault(), x.stopPropagation(), m(ar(B, a, et)), setTimeout(() => {
          const it = D.current[et];
    ...
    const { isLetter: I, isDigit: U } = qr(x.key);
    (I || U) && (x.preventDefault(), y((B) => B + x.key), T.current.focus(), j(!1));
  }, []);
  return Kt(() => {
    const x = setTimeout(() => {
      if (p && v === "books" && $.current && E.current) {
        const I = $.current, U = E.current, B = U.offsetTop, W = I.clientHeight, wt = U.clientHeight, et = B - W / 2 + wt / 2;
        I.scrollTo({
          top: Math.max(0, et),
          behavior: "smooth"
        }), m(ar(t.book));
    ...
    if (v === "chapters" && k) {
      ...
      setTimeout(() => {
        if ($.current)
          if (x) {
            const I = D.current[t.chapterNum];
  ...
  }, [v, k, M, t.book, t.chapterNum]), /* @__PURE__ */ d(ne, { open: p, onOpenChange: G, children: [
    /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
      ...
      te,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ht.map(({ onClick: x, disabled: I, title: U, icon: B }) => /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              F,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ r(ms, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fs, { className: "tw-h-4 tw-w-4" })
              }
            ),
            k && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Me(k, a) })
          ] }),
          !C && /* @__PURE__ */ d(ee, { ref: $, children: [
            v === "books" && /* @__PURE__ */ d(ct, { children: [
              !M && Object.entries(X).map(([x, I]) => {
                if (I.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Qt, { heading: me(x), children: I.map((U) => /* @__PURE__ */ r(
                      Jo,
                      {
                        bookId: U,
                        onSelect: (B) => _t(B),
...
), mt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ko.Root, { ref: n, className: f("pr-twp", dl(), t), ...e }));
...
yr.displayName = en.Root.displayName;
...
function sr({
  ...
  const [k, _] = S(!1), C = w ?? l, j = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], V = (T, $) => {
    const E = l(T), D = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, L = `${$ ?? ""}${E}${D ?? ""}`;
    return /* @__PURE__ */ d(
      qt,
      {
        value: E,
  ...
  return /* @__PURE__ */ d(ne, { open: k, onOpenChange: _, ...N, children: [
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          ...
          /* @__PURE__ */ r(ee, { children: j(e) ? e.map((T) => /* @__PURE__ */ r(Qt, { heading: T.groupHeading, children: T.options.map(($) => V($, T.groupHeading)) }, T.groupHeading)) : e.map((T) => V(T)) })
        ] })
      }
    )
  ] });
...
var ml = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(ml || {});
...
function fp({
  ...
  const p = Vn(c, "%webView_bookSelector_currentBook%"), u = Vn(c, "%webView_bookSelector_choose%"), h = Vn(c, "%webView_bookSelector_chooseBooks%"), [m, g] = S(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    g(v), t(v);
    ...
    yr,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(mt, { className: "tw-flex tw-items-center", children: o.map((v) => ut.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            F,
            {
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, hl = ta ? Kt : q, pn = { tag: hr };
function gl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: w } = t, c = fl(null, o), p = _o({ editable: t.editable, html: w, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
        if (h === void 0) u.update(() => {
          ...
          if (m.isEmpty()) {
            const g = Tn();
            m.append(g);
            const y = ta ? document.activeElement : null;
            ($t() !== null || y !== null && y === u.getRootElement()) && g.select();
          }
        }, pn);
...
const bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : q;
function vl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return bl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: w }) => {
      e && i.size === 0 && s.size === 0 || t && w.has(hr) || l.isEmpty() || n(a, o, w);
    });
  }, [o, t, e, n]), null;
}
const Nr = {
  ...
  {
    ref: o,
    className: e ? f(Zo({ variant: e }), t) : t,
    ...n
  }
));
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : q;
function Cl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function El() {
  return function(t) {
    const [e] = Yt(), n = z(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), i = H(o);
    return _l(() => {
...
function Tl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !oi(e) && o !== null) {
    const [a, i] = o, s = t.isBackward(), l = a.getNode(), w = i.getNode(), c = e.is(l), p = e.is(w);
    if (c || p) {
      const [u, h] = ai(t), m = l.is(w), g = e.is(s ? w : l), y = e.is(s ? l : w);
      let v, N = 0;
      m ? (N = u > h ? h : u, v = u > h ? u : h) : g ? (N = s ? h : u, v = void 0) : y && (N = 0, v = s ? u : h);
      const k = e.__text.slice(N, v);
      k !== e.__text && (n === "clone" && (e = si(e)), e.__text = k);
    }
  }
  return e;
}
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Sl = ea && "documentMode" in document ? document.documentMode : null;
!(!ea || !("InputEvent" in window) || Sl) && "getTargetRanges" in new window.InputEvent("input");
function Dl(t) {
  const e = To(t, (n) => se(n) && !n.isInline());
  return se(e) || Rl(4, t.__key), e;
}
function Ml(t) {
  const e = $t();
  if (!Ne(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = To(i, (c) => se(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function Sn() {
  ...
  for (; Ze !== void 0; ) {
    let n = Ze;
    for (Ze = void 0, ir++; n !== void 0; ) {
      const o = n.o;
      if (n.o = void 0, n.f &= -3, !(8 & n.f) && na(n)) try {
        n.c();
      } catch (a) {
        e || (t = a, e = !0);
      }
...
function he(t, e) {
  yt.call(this, void 0), this.x = t, this.s = void 0, this.g = hn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Al(t, e) {
  return new he(t, e);
}
...
function _r(t) {
  ...
  t.x = void 0, t.s = void 0, oa(t);
}
function Pl(t) {
  if (Z !== this) throw new Error("Out-of-order effect");
  ra(this), Z = t, this.f &= -2, 8 & this.f && _r(this), Sn();
}
function De(t, e) {
...
yt.prototype.brand = Ol, yt.prototype.h = function() {
  return !0;
...
} }), he.prototype = new yt(), he.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === hn)) return !0;
  if (this.g = hn, this.f |= 1, this.i > 0 && !na(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    Wr(this), Z = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, oa(this), Wr(this), ie++;
  const t = Z;
...
function sa(t, e = aa) {
  return t.registerCommand(Ro, (n) => (t.update(e), !0), So);
}
Ut({ build: (t, e, n) => Dn(e), config: sn({ $onClear: aa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const zn = li("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ia extends Qn {
  $config() {
...
Ut({ name: "@lexical/extension/DecoratorText", nodes: () => [ia], register: (t, e, n) => t.registerCommand(Do, (o) => {
  const a = $t();
  if (Mo(a) || Ne(a)) for (const i of a.getNodes()) Ll(i) && i.toggleFormat(o);
  return !1;
}, Oo) });
function la(t, e) {
  let n;
...
const lr = Ut({ build: (t) => la(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function wa(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const n = t, o = e;
    for (const a in o) n[a] = wa(n[a], o[a]);
    return t;
  }
  return e;
}
const Cr = 0, wr = 1, ca = 2, Fn = 3, un = 4, Se = 5, Bn = 6, He = 7;
function Kn(t) {
  return t.id === Cr;
}
function da(t) {
...
function Vl(t) {
  return function(e) {
    return e.id === wr;
  }(t) || tt(305, String(t.id), String(wr)), Object.assign(t, { id: ca });
}
...
class zl {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== un && tt(307, String(n.id), String(Se)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Bn && tt(310, String(n.id), String(Bn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= un;
    }(e) || tt(313, String(e.id), String(un)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Fn;
    }(e) || tt(314, String(e.id), String(Fn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= He;
    }(e) || tt(316, String(e.id), String(He)), e;
  }
...
const Bl = Ut({ config: sn({ setOptions: Jr, updateOptions: Jr }), init: ({ $initialEditorState: t = Fl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: i } = a;
    if (pi(i)) t.setEditorState(i, n);
...
}, name: "@lexical/extension/InitialState", nodes: [wi, Eo, ci, di, Co] }), Zr = Symbol.for("@lexical/extension/LexicalBuilder");
function Qr() {
}
function Kl(t) {
  throw t;
...
class Qe {
  ...
  static maybeFromEditor(e) {
    const n = e[Zr];
    return n && (n.PACKAGE_VERSION !== Gn && tt(292, n.PACKAGE_VERSION, Gn), n instanceof Qe || tt(293)), n;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Kn(i) || tt(300, s, a || "[unknown]"), Kn(l = i) || tt(304, String(l.id), String(Cr)), i = Object.assign(l, { id: wr }), o.state = i;
    ...
    for (const p of l) {
      ...
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const h of $l(u)) {
        if (typeof h != "function") {
          ...
          m && tt(302, u.name, h.replace.name, m.extension.name), o.set(h.replace, p);
        }
        n.add(h);
      }
      if (u.html) {
...
const Gl = /* @__PURE__ */ new Set(), to = Ut({ build(t, e, n) {
  const o = n.getDependency(lr).output, a = nn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = la(() => {
  }, () => ce(() => {
    ...
    o.value.read(() => {
      if ($t()) for (const [p, u] of l.entries()) {
        ...
        const h = ki(p), m = h && h.isSelected() || !1;
...
Ut({ dependencies: [lr, to], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(to).output, a = nn({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return we(t.registerCommand(mi, (s) => {
    if (fi(s.target)) {
      const l = hi(s.target);
      if (ql(l)) return function(w, c = !1) {
        const p = $t(), u = w.isSelected(), h = w.getKey();
        let m;
        c && Mo(p) ? m = p : (m = gi(), bi(m)), u ? m.delete(h) : m.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Oo), t.registerMutationListener(Ae, (s, l) => {
    Il(() => {
      let w = !1;
...
function Hl(t, e, n = ua) {
  return we(t.registerCommand(Ci, (o) => {
    const a = $t();
    if (!Ne(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      if (u.canIndent()) {
        const h = u.getKey();
        let m = Ei();
        if (m.anchor.set(h, 0, "element"), m.focus.set(h, 0, "element"), m = Ti(m), m.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Ri : Br : Si;
    return t.dispatchCommand(i, void 0);
  }, So), t.registerCommand(Br, () => {
...
Ut({ build: (t, e, n) => Dn(e), config: sn({ $canIndent: ua, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (Ne(g)) {
                ...
                if (vn(v) && c >= 0 && p >= 0 && (N = c, k = c + p, g.setTextNodeRange(v, N, v, k)), N === k && u === "" || (g.insertRawText(u), v = y.getNode()), vn(v)) {
                  N = h, k = h + m;
                  const _ = v.getTextContentSize();
                  N = N > _ ? _ : N, k = k > _ ? _ : k, g.setTextNodeRange(v, N, v, k);
                }
...
Ut({ build: (t, e, n) => Dn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ce(() => n.getOutput().disabled.value ? void 0 : fa(t)) });
function Zl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Er = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : q;
  ...
  return function(n, o) {
    ...
    return Er(() => n.registerDecoratorListener((s) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], p = r(o, { onError: (h) => n._onError(h), children: r(us, { fallback: null, children: a[c] }) }), u = n.getElementByKey(c);
        u !== null && s.push(Bi(p, u, c));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function ew({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Er(() => we(zi(a), fa(a)), [a]);
  }(o), d(ct, { children: [t, r(nw, { content: e }), r(tw, { editor: o, ErrorBoundary: n })] });
}
...
const ow = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : q;
function aw({ onClear: t }) {
  const [e] = Yt();
  return ow(() => sa(e, t), [e, t]), null;
}
const ha = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : q;
function sw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: u, ariaRequired: h, autoCapitalize: m, className: g, id: y, role: v = "textbox", spellCheck: N = !0, style: k, tabIndex: _, "data-testid": C, ...j }, V) {
  const [T, $] = S(t.isEditable()), E = K((L) => {
    L && L.ownerDocument && L.ownerDocument.defaultView ? t.setRootElement(L) : t.setRootElement(null);
  }, [t]), D = z(() => /* @__PURE__ */ function(...L) {
    return (P) => {
      for (const O of L) typeof O == "function" ? O(P) : O != null && (O.current = P);
    };
  }(V, E), [E, V]);
  return ha(() => ($(t.isEditable()), t.registerEditableListener((L) => {
    $(L);
  })), [t]), r("div", { "aria-activedescendant": T ? e : void 0, "aria-autocomplete": T ? n : "none", "aria-controls": T ? o : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": T && v === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": p, "aria-owns": T ? u : void 0, "aria-readonly": !T || void 0, "aria-required": h, autoCapitalize: m, className: g, contentEditable: T, "data-testid": C, id: y, ref: D, role: v, spellCheck: N, style: k, tabIndex: _, ...j });
}
const iw = an(sw);
function no(t) {
  return t.getEditorState().read(ma(t.isComposing()));
...
function ww(t, e) {
  ...
  return d(ct, { children: [r(iw, { editor: a, ...o, ref: e }), n != null && r(cw, { editor: a, content: n })] });
}
...
function pw({
  ...
  return /* @__PURE__ */ r(ga.Provider, { value: s, children: i });
}
function ba() {
  const t = fr(ga);
  if (!t)
...
function uw() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(nl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Go, { children: [
      /* @__PURE__ */ r(Uo, { children: /* @__PURE__ */ r(qo, { children: i }) }),
      s
    ] }) });
  }, [t, n]), a = K(
    (i, s, l = !1) => {
...
function mw({
  ...
  const [e] = Yt(), [n, o] = S(e), [a, i] = S("paragraph"), [s, l] = uw(), w = () => {
  };
...
const va = de(
  ...
  {
    ref: a,
    className: f(va({ variant: e, size: n, className: t })),
    ...o
  }
));
hw.displayName = Lo.Root.displayName;
...
function gw() {
  const { activeEditor: t } = ba(), [e, n] = S([]), o = K((a) => {
    if (Ne(a) || Ki(a)) {
      const i = [];
      ro.forEach(({ format: s }) => {
...
function yw(t, e) {
  const n = Ai(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  for (const i of n) if (!Na.has(i.nodeName)) {
    const s = ka(i, t, a, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Po && s.insertAfter($o());
    for (const s of i) {
...
function ya(t, e, n, o = null) {
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], y = ya(t, g, h, o);
    !a && se(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Ii(p) || Kr(p)) && p.append(h), n.append(p), u) {
      const m = u.call(s, p);
...
function ka(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (Na.has(t.nodeName)) return s;
  let l = null;
  const w = function(g, y) {
    ...
    if (N !== void 0) for (const _ of N) {
      const C = _(g);
      C !== null && (k === null || (k.priority || 0) <= (C.priority || 0)) && (k = C);
    }
  ...
  if (c !== null) {
    ...
    if (l = Array.isArray(g) ? g[g.length - 1] : g, l !== null) {
      for (const [, y] of a) if (l = y(l, i), !l) break;
  ...
  let h = [];
  const m = (l == null || !Pi(l)) && (l != null && bn(l) || o);
  for (let g = 0; g < u.length; g++) h.push(...ka(u[g], e, n, m, new Map(a), l));
  return p != null && (h = p(h)), Gr(t) && (h = kw(t, h, m ? () => {
    const g = new Po();
    return n.push(g), g;
  } : Tn)), l == null ? h.length > 0 ? s = s.concat(h) : Gr(t) && function(g) {
...
function Ca(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : Ca(e.children)
  ) : !1;
}
function At(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? Ca(t.root.children) : !1;
}
function _w(t) {
  if (!t || t.trim() === "")
...
function hp({
  ...
  const [a, i] = S(Cw), [s, l] = S(void 0), [w, c] = S(!1), p = H(void 0), u = H(null);
  q(() => {
    let N = !0;
    const k = u.current;
    if (!k) return;
  ...
  const h = K(() => {
    ...
    const N = Nn(a);
    e(N, s);
  }, [a, e, s]), m = o["%commentEditor_placeholder%"] ?? "Type your comment here...", g = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", y = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", v = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
          /* @__PURE__ */ r(Mt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ d(ne, { open: w, onOpenChange: c, children: [
      /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ d(
        F,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(
        Ht,
        {
          ...
          children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: t.map((N) => /* @__PURE__ */ r(
            qt,
            {
              onSelect: () => {
                l(N === "" ? void 0 : N), c(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Sr(N) && (N.preventDefault(), N.stopPropagation(), At(a) && h());
        },
        onKeyDown: (N) => {
          Rr(N), (N.key === "Enter" || N.key === " ") && N.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          yn,
          {
            editorSerializedState: a,
            onSerializedChange: (N) => i(N),
            placeholder: m,
            onClear: (N) => {
              p.current = N;
            }
...
const gp = Object.freeze([
  ...
  const a = H(null), [i, s] = S(void 0), [l, w] = S(void 0), c = K(
    ...
    if (y && Tw.includes(y)) return !0;
    const v = m.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = K(
    (m) => {
      var T;
      const g = m.target, y = ($) => $ ? document.getElementById($) : void 0, v = y(l), N = y(i);
      if (!!(v && g && v.contains(g) && g !== v) && u(g)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          if ($.length === 0) return;
          const E = $.findIndex((L) => L === g);
          if (E === -1) return;
          let D;
          m.key === "ArrowDown" ? D = Math.min(E + 1, $.length - 1) : D = Math.max(E - 1, 0), D !== E && (m.preventDefault(), m.stopPropagation(), (T = $[D]) == null || T.focus());
          return;
        }
        return;
      }
      const C = t.findIndex(($) => $.id === i);
      let j = C;
      switch (m.key) {
        case "ArrowDown":
...
$e.displayName = jo.Root.displayName;
...
Ra.displayName = Be.Root.displayName;
...
Aw.displayName = Be.Image.displayName;
...
Sa.displayName = Be.Fallback.displayName;
const Dr = Cn(void 0);
function Vt() {
  const t = fr(Dr);
  if (!t)
...
}), Ge = nt.Trigger, Da = nt.Group, Pw = nt.Portal, $w = nt.Sub, Lw = nt.RadioGroup;
function Ee({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Dr.Provider, { value: n, children: /* @__PURE__ */ r(nt.Root, { ...e }) });
}
const Ma = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = Vt();
  return /* @__PURE__ */ d(
    nt.SubTrigger,
    {
...
Ma.displayName = nt.SubTrigger.displayName;
...
Oa.displayName = nt.SubContent.displayName;
...
ue.displayName = nt.Content.displayName;
...
const Ia = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Vt();
  return /* @__PURE__ */ d(
    nt.RadioItem,
    {
...
Ia.displayName = nt.RadioItem.displayName;
...
function oo({
  ...
  }, [t.date, n]), v = z(() => t.user, [t.user]), N = z(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = z(() => Zs(t.contents), [t.contents]), _ = z(() => {
    if (o && l)
      return /* @__PURE__ */ d(ct, { children: [
        /* @__PURE__ */ d(
          kn,
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ra, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Sa, { className: "tw-text-xs tw-font-medium", children: N }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ d(Pe, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              gn(t.assignedUser, n)
            ] })
          ] }),
          w && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), m()) : Sr(C) && (C.preventDefault(), C.stopPropagation(), At(p) && g());
              },
              onKeyDown: (C) => {
                Rr(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
        ...
        _ && /* @__PURE__ */ d(Ee, { children: [
          /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ho, {}) }) }),
          /* @__PURE__ */ r(ue, { align: "end", children: _ })
        ] })
      ]
    }
  );
...
function jw({
  ...
  const [T, $] = S(ao), [E, D] = S(
    void 0
  ), L = o, [P, O] = S(!1), [A, X] = S(!1), [M, J] = S(!1), [_t, Ot] = S(!1), [Tt, ht] = S(!1), [pt, G] = S(C), [at, st] = S(!1), lt = H(void 0), [bt, me] = S(/* @__PURE__ */ new Map());
  q(() => {
    let R = !0;
    return (async () => {
      const Rt = k ? await k(w) : !1;
      R && ht(Rt);
    })(), () => {
      R = !1;
    };
    ...
    let R = !0;
    if (!o) {
      Ot(!1), me(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Rt = N ? await N(w) : !1;
      R && Ot(Rt);
    })(), () => {
      R = !1;
    };
  }, [o, w, N]);
  const jt = z(() => e.filter((R) => !R.deleted), [e]);
  q(() => {
    let R = !0;
    if (!o || !_) {
      me(/* @__PURE__ */ new Map());
  ...
  const Xt = z(() => jt[0], [jt]), Te = H(null), oe = H(void 0), Wt = K(() => {
    var R;
    (R = oe.current) == null || R.call(oe), $(ao);
  }, []), Re = K(() => {
    const R = !pt;
    G(R), st(!R), g == null || g(w, R);
  }, [pt, g, w]);
  q(() => {
    O(!1);
  }, [o]), q(() => {
    if (o && !pt && !at) {
      ...
      return lt.current = R, () => clearTimeout(R);
    }
  ...
  }, [i, n]), U = z(() => jt.slice(1), [jt]), B = z(() => U.length ?? 0, [U.length]), W = z(() => B > 0, [B]), wt = z(() => P || B <= 2 ? U : U.slice(-2), [U, B, P]), et = z(() => P || B <= 2 ? 0 : B - 2, [B, P]), gt = z(
    () => B === 1 ? x.singleReply : be(x.multipleReplies, { count: B }),
    [B, x]
  ), it = z(
    () => et === 1 ? x.singleReply : be(x.multipleReplies, { count: et }),
    [et, x]
  );
  q(() => {
    !o && A && W && X(!1);
  ...
  const It = K(
    async (R) => {
      ...
      vt && await u({ threadId: w, contents: vt }) && Wt();
    },
    [
      Wt,
      T,
    ...
    async (R) => {
      const vt = At(T) ? Nn(T) : void 0, Rt = await u({
        ...R,
        contents: vt,
        assignedUser: E ?? R.assignedUser
      });
      return Rt && vt && Wt(), Rt && E !== void 0 && D(void 0), Rt;
    },
    [Wt, T, u, E]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ d(Ta, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            I && /* @__PURE__ */ r(Pe, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: I }),
            /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
                ...
                children: pt ? /* @__PURE__ */ r(xs, {}) : /* @__PURE__ */ r(ys, {})
              }
            ),
            Tt && p !== "Resolved" && /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
                size: "icon",
          ...
          /* @__PURE__ */ r(
            oo,
            {
              ...
              handleDeleteComment: m,
              onEditingChange: X,
              canEditOrDelete: (!A && bt.get(Xt.id)) ?? !1,
              canUserResolveThread: Tt
            }
          )
        ] }),
        /* @__PURE__ */ d(ct, { children: [
          W && !o && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    P ? /* @__PURE__ */ r(go, {}) : /* @__PURE__ */ r(ze, {})
                  ] })
                ]
              }
            ),
            wt.map((R) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              oo,
              {
                comment: R,
                localizedStrings: n,
                ...
                handleDeleteComment: m,
                onEditingChange: X,
                canEditOrDelete: (!A && bt.get(R.id)) ?? !1
              }
            ) }, R.id)),
            v !== !1 && (!A || At(T)) && /* @__PURE__ */ d(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (R) => {
                  Sr(R) && (R.preventDefault(), R.stopPropagation(), (At(T) || E !== void 0) && It());
                },
                onKeyDown: (R) => {
                  Rr(R), (R.key === "Enter" || R.key === " ") && R.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    yn,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ d(ne, { open: M, onOpenChange: J, children: [
                      /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ r(
                        F,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !_t || !y || y.length === 0 || !y.includes(s),
                      ...
                      /* @__PURE__ */ r(
                        Ht,
                        {
                          ...
                          children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: y == null ? void 0 : y.map((R) => /* @__PURE__ */ r(
                            qt,
                            {
                              onSelect: () => {
                                D(R !== i ? R : void 0), J(!1);
...
function vp({
  ...
  const [N, k] = S(/* @__PURE__ */ new Set()), [_, C] = S();
  q(() => {
    g && (k((O) => new Set(O).add(g)), C(g));
  }, [g]);
  const j = n.filter(
    ...
    (O) => {
      k((A) => new Set(A).add(O.id)), C(O.id), y == null || y(O.id);
    },
    [y]
  ), $ = K(
    (O) => {
      ...
      }), C(O), y == null || y(A ? void 0 : O);
    },
    [N, y]
  ), { listboxRef: E, activeId: D, handleKeyDown: L } = Rw({
    options: V,
    onOptionSelect: T
  }), P = K(
    (O) => {
      O.key === "Escape" ? (_ && N.has(_) && (k((A) => {
        const X = new Set(A);
        return X.delete(_), X;
      }), C(void 0), y == null || y(void 0)), O.preventDefault(), O.stopPropagation()) : L(O);
    },
    [_, N, L, y]
  );
  return /* @__PURE__ */ r(
...
function zw({ table: t }) {
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(Gi, { asChild: !0, children: /* @__PURE__ */ d(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Ns, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Le = dt.Root, Fw = dt.Group, Ve = dt.Value, Bw = de(
...
const Aa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(go, { className: "tw-h-4 tw-w-4" })
  }
));
Aa.displayName = dt.ScrollUpButton.displayName;
...
Pa.displayName = dt.ScrollDownButton.displayName;
const Ce = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const i = ft();
  return /* @__PURE__ */ r(dt.Portal, { children: /* @__PURE__ */ d(
    dt.Content,
    {
      ref: a,
      className: f(
...
Kw.displayName = dt.Label.displayName;
const St = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  dt.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(dt.ItemIndicator, { children: /* @__PURE__ */ r(Gt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(dt.ItemText, { children: e })
    ]
  }
));
St.displayName = dt.Item.displayName;
...
Gw.displayName = dt.Separator.displayName;
function Uw({ table: t }) {
...
function Zw({
  ...
  var V;
  const [p, u] = S([]), [h, m] = S([]), [g, y] = S({}), [v, N] = S({}), k = z(() => e ?? [], [e]), _ = zo({
    data: k,
    columns: t,
    getCoreRowModel: Bo(),
  ...
  let j;
  return w ? j = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ r(Jt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(ye, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(cr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? j = _.getRowModel().rows.map((T) => /* @__PURE__ */ r(
    Jt,
    {
      onClick: () => s(T, _),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map(($) => /* @__PURE__ */ r(ye, { children: Je($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    T.id
  )) : j = /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(ye, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(zw, { table: _ }),
    /* @__PURE__ */ d(Mn, { stickyHeader: i, children: [
      /* @__PURE__ */ r(On, { stickyHeader: i, children: _.getHeaderGroups().map((T) => /* @__PURE__ */ r(Jt, { children: T.headers.map(($) => /* @__PURE__ */ r(on, { className: "tw-p-0", children: $.isPlaceholder ? void 0 : Je($.column.columnDef.header, $.getContext()) }, $.id)) }, T.id)) }),
      /* @__PURE__ */ r(In, { children: j })
    ] }),
...
function xp({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Xi, { options: i, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(bo, {}) })
        ] }),
...
function kp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ d(F, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ue, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Da, { children: c.itemType === 0 ? /* @__PURE__ */ r(ct, { children: c.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Zt,
        {
          checked: o[p][h],
        ...
        Lw,
        {
          ...
          children: c.items.map((u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Ia, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, c.label)) })
...
function rc({
  ...
  const [N, k] = S(!1), _ = K(
    (D) => {
      var P;
      const L = (P = t.find((O) => O.label === D)) == null ? void 0 : P.value;
      L && n(
    ...
    if (!h) return t;
    const D = t.filter((P) => P.starred).sort((P, O) => P.label.localeCompare(O.label)), L = t.filter((P) => !P.starred).sort((P, O) => {
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(ne, { open: $, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ d(
      F,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: V, children: i }),
        /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: T, children: s })
      ] }),
      /* @__PURE__ */ d(ee, { children: [
        /* @__PURE__ */ r(ln, { children: l }),
        /* @__PURE__ */ r(Qt, { children: j.map((D) => /* @__PURE__ */ d(
          qt,
          {
            value: D.label,
            onSelect: _,
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ r(Ms, { className: "tw-h-4 tw-w-4" }),
...
function Ep({
  ...
  return /* @__PURE__ */ d("div", { id: u, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: e.map((h) => {
      var m;
      return /* @__PURE__ */ d(Pe, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          F,
          {
            variant: "ghost",
...
function lc({
  ...
  const i = H(null), s = H(null), l = H(!1), [w, c] = S(t), [p, u] = S(n), [h, m] = S(!1);
  q(() => {
    c(t);
  }, [t]), q(() => {
    p !== n && u(n);
  ...
  const g = (v) => {
    ...
    var N, k, _, C;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = i.current) == null || N.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((C = s.current) == null || C.focus(), l.current = !1), w === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ee, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
      /* @__PURE__ */ r(Mt, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: ic(t, a, n) }) }) }),
...
function dc({
  ...
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
      /* @__PURE__ */ r(Li, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: wc(t, n) }) }) }),
      /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: cc(t, n) }) })
    ] }) }),
...
function uc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? As, { className: e, size: 16 });
}
        ...
        return /* @__PURE__ */ d(
          qt,
          {
            ...
            children: [
              ...
              (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ r(Yo, { className: "tw-font-sans", children: s.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
            ]
          },
...
function Tp({
  ...
  const u = H(null), h = H(null), m = H(null), [g, y] = S("generated"), [v, N] = S("*"), [k, _] = S("f"), [C, j] = S(!1), [V, T] = S(!0), [$, E] = S(!1), D = H(!1), L = H(""), [P, O] = S(!1), [A, X] = S(), [M, J] = S(), [_t, Ot] = S(), [Tt, ht] = S(), pt = H(null), G = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  q(() => {
    ...
    if (I && dn("note", I)) {
      const W = (U = I.insert.note) == null ? void 0 : U.caller;
      let wt = "custom";
      W === tr ? wt = "generated" : W === er ? wt = "hidden" : W && N(W), y(wt), _(((B = I.insert.note) == null ? void 0 : B.style) ?? "f"), x = setTimeout(() => {
        var et;
        (et = u.current) == null || et.applyUpdate([I]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const st = K(
    (x, I, U = !1) => {
      var W, wt, et;
      const B = (wt = (W = u.current) == null ? void 0 : W.getNoteOps(0)) == null ? void 0 : wt.at(0);
      if (B && dn("note", B)) {
        if (B.insert.note) {
          let it;
          x === "custom" ? it = I : x === "generated" ? it = tr : it = er, B.insert.note.caller = it;
        }
        n == null || n([B]);
        const gt = (p == null ? void 0 : p.current) ?? i;
        U && c && gt && ((et = c.current) == null || et.replaceEmbedUpdate(gt, [B]));
      }
    },
    [i, p, n, c]
  ), lt = K(() => {
    st(g, v, !0), o();
  }, [g, v, o, st]), bt = H({ book: a.book, chapterNum: a.chapterNum });
  Kt(() => {
    (bt.current.book !== a.book || bt.current.chapterNum !== a.chapterNum) && (bt.current = { book: a.book, chapterNum: a.chapterNum }, lt());
  }, [lt, a.book, a.chapterNum]);
  const me = () => {
    var I;
    const x = (I = h.current) == null ? void 0 : I.getElementsByClassName("editor-input")[0];
    ...
    var U, B, W, wt, et;
    _(x);
    const I = (B = (U = u.current) == null ? void 0 : U.getNoteOps(0)) == null ? void 0 : B.at(0);
    if (I && dn("note", I)) {
      I.insert.note && (I.insert.note.style = x);
      const gt = (wt = (W = I.insert.note) == null ? void 0 : W.contents) == null ? void 0 : wt.ops;
      k !== "x" && x === "x" ? gt == null || gt.forEach((it) => hc(it)) : k === "x" && x !== "x" && (gt == null || gt.forEach((it) => gc(it))), (et = u.current) == null || et.applyUpdate([I, { delete: 1 }]);
    }
  }, oe = (x) => {
    ht(x.contextMarker), E(x.canRedo);
  }, Wt = (x) => {
    var U, B, W, wt, et;
    const I = (B = (U = u.current) == null ? void 0 : U.getNoteOps(0)) == null ? void 0 : B.at(0);
    if (I && dn("note", I)) {
      x.content.length > 1 && setTimeout(() => {
        var It;
        (It = u.current) == null || It.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
      const gt = (W = I.insert.note) == null ? void 0 : W.style, it = (et = (wt = I.insert.note) == null ? void 0 : wt.contents) == null ? void 0 : et.ops;
      if (gt || j(!1), j(
        gt === "x" ? !!(it != null && it.every((It) => {
          var R, vt;
          if (!((R = It.attributes) != null && R.char)) return !0;
          const zt = ((vt = It.attributes) == null ? void 0 : vt.char).style;
        ...
        D.current = !0, L.current = JSON.stringify(I), T(!0);
        return;
      }
      T(JSON.stringify(I) === L.current), st(g, v);
    } else
      j(!1), T(!0);
  }, Re = K(() => {
    const x = window.getSelection();
    if (m.current && at.length && x && x.rangeCount > 0) {
      const I = x.getRangeAt(0).getBoundingClientRect(), U = m.current.getBoundingClientRect();
      X(I.left - U.left), J(I.top - U.top), Ot(I.height), O(!0);
    }
  }, [at, m]);
  return q(() => {
    const x = () => {
    ...
    var x;
    P && ((x = pt.current) == null || x.focus());
  }, [P]), q(() => {
    var U;
    const x = ((U = h.current) == null ? void 0 : U.querySelector(".editor-input")) ?? void 0, I = (B) => {
      !P && x && document.activeElement === x && B.key === l ? (B.preventDefault(), Re()) : P && B.key === "Escape" && (B.preventDefault(), O(!1));
    };
    return document.addEventListener("keydown", I), () => {
      document.removeEventListener("keydown", I);
    };
  }, [P, Re, l]), /* @__PURE__ */ d(ct, { children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          /* @__PURE__ */ r(
            ac,
            {
              onUndoClick: () => {
                var x;
                return (x = u.current) == null ? void 0 : x.undo();
              },
              onRedoClick: () => {
                var x;
                return (x = u.current) == null ? void 0 : x.redo();
              },
              canUndo: !V,
              canRedo: $,
              localizedStrings: w
...
function yc({
  ...
  /* @__PURE__ */ d("span", { className: f("note-caller tw-inline-block", { formatted: i }), children: [
    ...
    Mr(t.marker, [s], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", m = o ? "marker-visible" : "", g = e === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", y = f(h, m);
  return /* @__PURE__ */ d(ct, { children: [
    /* @__PURE__ */ d("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: [
      w,
      p
    ] }),
    /* @__PURE__ */ r("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: u }),
    /* @__PURE__ */ r(
      "div",
      {
        className: f(
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: vc(t.marker, l, o, c) })
      }
    )
  ] });
}
function Sp({
  ...
  const p = w ?? ni(n, void 0), u = (k, _) => {
    c == null || c(k, _, a);
  }, h = i ? n.findIndex((k) => k === i) : -1, [m, g] = S(h), y = (k, _, C) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), c == null || c(_, C, a);
          break;
      }
  }, v = (k) => {
    if (n.length)
      switch (k.key) {
        case "ArrowDown":
          k.preventDefault(), g((_) => Math.min(_ + 1, n.length - 1));
          break;
        case "ArrowUp":
          k.preventDefault(), g((_) => Math.max(_ - 1, 0));
          break;
      }
  }, N = H([]);
  return q(() => {
    var k;
    m >= 0 && m < N.current.length && ((k = N.current[m]) == null || k.focus());
  }, [m]), /* @__PURE__ */ r(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((k, _) => {
            ...
            return /* @__PURE__ */ d(ct, { children: [
              ...
              _ < n.length - 1 && o === "vertical" && /* @__PURE__ */ r($e, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
Or.displayName = nr.Root.displayName;
const _c = (t) => {
  if (t === "asc")
...
function Lp({
  ...
  const m = Ft(n, "%webView_inventory_all%"), g = Ft(n, "%webView_inventory_approved%"), y = Ft(n, "%webView_inventory_unapproved%"), v = Ft(n, "%webView_inventory_unknown%"), N = Ft(n, "%webView_inventory_scope_currentBook%"), k = Ft(n, "%webView_inventory_scope_chapter%"), _ = Ft(n, "%webView_inventory_scope_verse%"), C = Ft(n, "%webView_inventory_filter_text%"), j = Ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = Ft(n, "%webView_inventory_no_results%"), [T, $] = S(!1), [E, D] = S("all"), [L, P] = S(""), [O, A] = S([]), X = z(() => {
    const G = t ?? [];
  ...
  }, [T, X]), J = z(() => M.length === 0 ? [] : Tc(M, E, L), [M, E, L]), _t = z(() => {
    var st, lt;
    if (!T) return w;
    ...
    for (let bt = 0; bt < G; bt++)
      at.push(
        Cc(
          ((lt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : lt[bt]) || "Additional Item",
          bt + 1
        )
      );
    return [...at, ...w];
  }, [o == null ? void 0 : o.tableHeaders, w, T]);
  q(() => {
  ...
  const Ot = (G, at) => {
    ...
    const G = M.filter((at) => ri(
      T ? at.items : [at.items[0]],
      O
    ));
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(Ce, { children: [
              ...
              /* @__PURE__ */ r(St, { value: "unapproved", children: y }),
              /* @__PURE__ */ r(St, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Le, { onValueChange: (G) => Tt(G), defaultValue: s, children: [
        /* @__PURE__ */ r(_e, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Ce, { children: [
          /* @__PURE__ */ r(St, { value: "book", children: N }),
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(mt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] })
    ] }),
...
const Sc = "16rem", Dc = "3rem", La = b.createContext(void 0);
function Pn() {
...
const Va = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(t), u = e ?? c, h = b.useCallback(
      (_) => {
        const C = typeof _ == "function" ? _(u) : _;
        n ? n(C) : p(C);
      },
      [n, u]
    ), m = b.useCallback(() => h((_) => !_), [h]), g = u ? "expanded" : "collapsed", N = ft() === "ltr" ? s : s === "primary" ? "secondary" : "primary", k = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(La.Provider, { value: k, children: /* @__PURE__ */ r(Ct, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
Va.displayName = "SidebarProvider";
const ja = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, i) => {
  const s = Pn();
...
const Mc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    F,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(zs, {}) : /* @__PURE__ */ r(Fs, {}),
...
const Vc = de(
  ...
  ({
    ...
    const w = t ? Fe : "button", { state: c } = Pn(), p = /* @__PURE__ */ r(
      w,
      {
        ref: l,
    ...
    ja,
    {
      ...
      children: /* @__PURE__ */ d(Fa, { children: [
        /* @__PURE__ */ d(dr, { children: [
          ...
          /* @__PURE__ */ r(ur, { children: /* @__PURE__ */ r(Ba, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Ka, { children: /* @__PURE__ */ r(
            Ga,
            {
              onClick: () => c(h),
              isActive: u(h),
...
const ae = "scrBook", qc = "scrRef", ge = "source", Hc = "details", Yc = "Scripture Reference", Xc = "Scripture Book", Ua = "Type", Wc = "Details";
function Jc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ut.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === ae ? ve(a.start) : void 0;
      },
    ...
    },
    {
      ...
      id: ge,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Ua : void 0,
...
}, wo = (t) => `${Zc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function jp({
  sources: t,
  ...
  const [c, p] = S([]), [u, h] = S([{ id: ae, desc: !1 }]), [m, g] = S({}), y = z(
  ...
  q(() => {
    if (l) {
      ...
      if (D.length === 1) {
        const L = y.find((P) => wo(P) === D[0]) || void 0;
        L && l(L);
      }
    }
  }, [m, y, l, N]);
  const k = a ?? Xc, _ = i ?? Ua, C = [
  ...
  }, T = (E, D) => E.getIsGrouped() ? "" : f("banded-row", D % 2 === 0 ? "even" : "odd"), $ = (E, D, L) => {
    if (!((E == null ? void 0 : E.length) === 0 || D.depth < L.column.getGroupedIndex())) {
      if (D.getIsGrouped())
        switch (D.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ce, { position: "item-aligned", children: /* @__PURE__ */ r(Fw, { children: C.map((E) => /* @__PURE__ */ r(St, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Mn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: N.getHeaderGroups().map((E) => /* @__PURE__ */ r(Jt, { children: E.headers.filter((D) => D.column.columnDef.header).map((D) => (
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(Oe, {}) : /* @__PURE__ */ r(Wn, {})),
                          " ",
...
}), qa = (t, e, n) => Ar(t, e).every((o) => n.includes(o));
function Qc({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = Ar(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], w = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
...
function td({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], u = o["%webView_book_selector_more%"], { otLong: h, ntLong: m, dcLong: g, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, N] = S(!1), [k, _] = S(""), C = H(void 0), j = H(!1);
  if (t.length !== ut.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const V = z(() => ut.allBookIds.filter(
    (A, X) => t[X] === "1" && !ut.isObsolete(ut.bookIdToNumber(A))
  ), [t]), T = z(() => {
    if (!k.trim()) {
      const M = {
        [Y.OT]: [],
    ...
    (A, X = !1) => {
      ...
      const M = V.findIndex((ht) => ht === C.current), J = V.findIndex((ht) => ht === A);
      if (M === -1 || J === -1) return;
      const [_t, Ot] = [
        Math.min(M, J),
        Math.max(M, J)
      ], Tt = V.slice(_t, Ot + 1).map((ht) => ht);
      n(
        e.includes(A) ? e.filter((ht) => !Tt.includes(ht)) : [.../* @__PURE__ */ new Set([...e, ...Tt])]
      );
    },
    [e, n, V]
  ), E = (A) => {
    $(A, j.current), j.current = !1;
  }, D = (A, X) => {
    A.preventDefault(), $(X, A.shiftKey);
  }, L = K(
    (A) => {
      const X = Ar(V, A).map((M) => M);
      n(
        qa(V, A, e) ? e.filter((M) => !X.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...X])]
      );
    },
    [e, n, V]
  ), P = () => {
              ...
              children: [
                ...
                /* @__PURE__ */ d(ee, { children: [
                  ...
                  Object.values(Y).map((A, X) => {
                    const M = T[A];
                    if (M.length !== 0)
                      return /* @__PURE__ */ d(po, { children: [
                        /* @__PURE__ */ r(
                          Qt,
                          {
                            heading: Xo(A, h, m, g, y),
                            children: M.map((J) => /* @__PURE__ */ r(
                              Jo,
                              {
                                bookId: J,
                                isSelected: e.includes(J),
                                onSelect: () => E(J),
                                onMouseDown: (_t) => D(_t, J),
                                section: We(J),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: ar(J, a),
                        ...
                        X < Object.values(Y).length - 1 && /* @__PURE__ */ r(Ho, {})
                      ] }, A);
                  })
                ] })
              ]
...
function Fp({
  ...
  const c = fe(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), h = fe(s, "%webView_scope_selector_current_book%"), m = fe(s, "%webView_scope_selector_choose_books%"), g = fe(s, "%webView_scope_selector_scope%"), y = fe(s, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        yr,
        {
          ...
          children: N.map(({ value: k, label: _, id: C }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(xn, { className: "tw-me-2", value: k, id: C }),
            /* @__PURE__ */ r(mt, { htmlFor: C, children: _ })
          ] }, C))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(mt, { children: y }),
      /* @__PURE__ */ r(
        td,
        {
          availableBookInfo: o,
...
const Ya = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Mt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Pw, { children: /* @__PURE__ */ r(Oa, { children: Ya(
      t,
      e,
      Ha(t, l.id),
      o
...
function mr({
  ...
  return /* @__PURE__ */ d(Ee, { variant: i, children: [
    /* @__PURE__ */ r(Ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Ks, {}) }) }),
    /* @__PURE__ */ r(ue, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(po, { children: [
      /* @__PURE__ */ r(Da, { children: /* @__PURE__ */ r(Ct, { children: Ya(e.groups, e.items, w, t) }) }),
      c < p.length - 1 && /* @__PURE__ */ r(Ue, {})
    ] }, w)) })
  ] });
}
...
function qp({
  ...
  return /* @__PURE__ */ d(Xa, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      mr,
      {
        onSelectMenuItem: t,
...
function Hp({
  ...
  return /* @__PURE__ */ r(Xa, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    mr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Wa = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ft();
  return /* @__PURE__ */ r(
    kt.Root,
    {
...
Wa.displayName = kt.List.displayName;
...
Ja.displayName = kt.List.displayName;
...
Za.displayName = kt.Content.displayName;
function Yp({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Wa, { children: [
      /* @__PURE__ */ r(Ja, { children: t.map((l) => /* @__PURE__ */ r(ed, { value: l.value, children: l.value }, l.key)) }),
...
const Qa = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
Qa.displayName = rt.Root.displayName;
...
const es = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = Vt();
  return /* @__PURE__ */ d(
    rt.SubTrigger,
    {
...
es.displayName = rt.SubTrigger.displayName;
...
ns.displayName = rt.SubContent.displayName;
const rs = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, i) => {
  const s = Vt();
...
const os = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Vt();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
os.displayName = rt.Item.displayName;
...
od.displayName = rt.CheckboxItem.displayName;
...
ad.displayName = rt.RadioItem.displayName;
...
sd.displayName = rt.Label.displayName;
...
as.displayName = rt.Separator.displayName;
const Ye = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((c) => c.group === i).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ d(Dt, { children: [
      /* @__PURE__ */ r(Mt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        ...
        /* @__PURE__ */ r(es, { children: c.label }),
    ...
    return l.length > 0 && s < a.length - 1 && w.push(/* @__PURE__ */ r(as, {}, `separator-${i}`)), w;
  });
};
function id({
  menuData: t,
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    var g, y, v, N;
    p.preventDefault();
    ...
    switch (u.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), Ye(s, [h, m]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Ye(l, [h, m]);
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), Ye(w, [h, m]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ r(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(nd, { children: [
      /* @__PURE__ */ r(ts, { ref: c(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        rs,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Ct, { children: ss(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function Jp({
  ...
  const c = ld(
    ...
    a && a(g), o && o([g, ...n.filter((y) => y !== g)]), i && n.find((y) => y === g) && i([...n.filter((y) => y !== g)]), u(!1);
  }, m = (g, y) => {
    var N, k, _, C, j, V;
    const v = y !== g ? ((k = (N = t[g]) == null ? void 0 : N.uiNames) == null ? void 0 : k[y]) ?? ((C = (_ = t[g]) == null ? void 0 : _.uiNames) == null ? void 0 : C.en) : void 0;
    return v ? `${(j = t[g]) == null ? void 0 : j.autonym} (${v})` : (V = t[g]) == null ? void 0 : V.autonym;
  };
  return /* @__PURE__ */ d("div", { id: w, className: f("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(mt, { className: "tw-font-normal tw-text-muted-foreground", children: be(c, {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(Ee, { children: [
              /* @__PURE__ */ r(Ge, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ho, {}) }) }),
...
const cd = an(({ className: t, ...e }, n) => /* @__PURE__ */ r(qs, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
const eu = ot.Root, nu = ot.Trigger, ru = ot.Group, ou = ot.Portal, au = ot.Sub, su = ot.RadioGroup, fd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
fd.displayName = ot.SubTrigger.displayName;
...
hd.displayName = ot.SubContent.displayName;
const gd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: f(
...
gd.displayName = ot.Content.displayName;
...
bd.displayName = ot.Item.displayName;
...
Nd.displayName = ot.Separator.displayName;
...
function _d({
  ...
  return /* @__PURE__ */ r(is.Provider, { value: o, children: /* @__PURE__ */ r(
    Lt.Root,
    {
...
const iu = Lt.Trigger, Cd = Lt.Portal, lu = Lt.Close, ls = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Lt.Overlay,
  {
    ref: n,
...
ls.displayName = Lt.Overlay.displayName;
...
Sd.displayName = Lt.Title.displayName;
...
Dd.displayName = Lt.Description.displayName;
...
function du({
  ...
  return /* @__PURE__ */ r(
    br.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Hs, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function pu({ ...t }) {
...
const uu = kt.Root, Ad = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ft();
  return /* @__PURE__ */ r(
    kt.List,
    {
...
Ad.displayName = kt.List.displayName;
...
Pd.displayName = kt.Trigger.displayName;
...
$d.displayName = kt.Content.displayName;
