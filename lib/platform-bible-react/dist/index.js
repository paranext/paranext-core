...
function up({
  ...
  const c = ht(), [d, m] = S(!1), [f, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, F] = S(!1), j = H(void 0), R = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), V = K(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
...
function hp({
  ...
  const d = Vn(c, "%webView_bookSelector_currentBook%"), m = Vn(c, "%webView_bookSelector_choose%"), f = Vn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
function bl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: w } = t, c = hl(null, o), d = Co({ editable: t.editable, html: w, namespace: a, nodes: i, onError: (m) => s(m, d), theme: o });
    return function(m, f) {
      if (f !== null) {
...
function Rl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !si(e) && o !== null) {
    ...
    if (c || d) {
      const [m, f] = ii(t), u = l.is(w), g = e.is(s ? w : l), x = e.is(s ? l : w);
      let v, y = 0;
...
function Ol(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = Ro(i, (c) => le(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
const Ul = /* @__PURE__ */ new Set(), no = Ut({ build(t, e, n) {
  ...
  return { watchNodeKey: function(s) {
    const l = Pl(() => (i.value || Ul).has(s)), { watchedNodeKeys: w } = a.peek();
    let c = w.get(s);
    const d = c !== void 0;
  ...
  return de(t.registerCommand(hi, (s) => {
    if (gi(s.target)) {
      ...
      if (Hl(l)) return function(w, c = !1) {
        ...
        let u;
        c && Oo(d) ? u = d : (u = vi(), xi(u)), m ? u.delete(f) : u.add(f);
      }(l, s.shiftKey), !0;
    }
    return !1;
    ...
    Al(() => {
      ...
      for (const [d, m] of s.entries()) if (m === "destroyed") c.delete(d), w = !0;
        ...
        f ? f.domNode.value = u : (w = !0, c.set(d, { domNode: nn(u), selectedSignal: o(d) }));
      }
...
function Yl(t, e, n = ma) {
  return de(t.registerCommand(Ti, (o) => {
    ...
    const i = function(s) {
      ...
      const l = s.anchor, w = s.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), m = Ml(d);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Ri();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Si(u), u.anchor.is(c)) return !0;
      }
      return !1;
  ...
  return function(n, o) {
    ...
    return Tr(() => n.registerDecoratorListener((s) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (f) => n._onError(f), children: r(ms, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && s.push(Gi(d, m, c));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function fw({
  ...
  const [e] = Yt(), [n, o] = S(e), [a, i] = S("paragraph"), [s, l] = mw(), w = () => {
  };
...
function Na(t, e, n, o = null) {
  ...
  const l = le(s) ? s.getChildren() : [], w = Ai(t, s.getType());
  let c;
...
function gp({
  ...
  const [a, i] = S(Ew), [s, l] = S(void 0), [w, c] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
    ...
    if (o && l)
      return /* @__PURE__ */ p(ct, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), m(Cw(t.contents)), s == null || s(!0);
            },
            children: [
...
function _p({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Ma, { children: c.itemType === 0 ? /* @__PURE__ */ r(ct, { children: c.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Qt,
        {
          checked: o[d][f],
        ...
        Vw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Aa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ge, {})
    ] }, c.label)) })
...
function wc({
  ...
  const i = H(null), s = H(null), l = H(!1), [w, c] = S(t), [d, m] = S(n), [f, u] = S(!1);
  Y(() => {
    c(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  return /* @__PURE__ */ p(ct, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: xc(t.marker, l, o, c) })
      }
    )
  ] });
}
...
function zp({
  ...
  const [c, d] = S([]), [m, f] = S([{ id: ie, desc: !1 }]), [u, g] = S({}), x = B(
...
function ed({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: f, ntLong: u, dcLong: g, extraLong: x } = {
...
function fr({
  ...
  return /* @__PURE__ */ p(ue, { variant: i, children: [
    ...
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(mo, { children: [
      /* @__PURE__ */ r(Ma, { children: /* @__PURE__ */ r(kt, { children: Xa(e.groups, e.items, w, t) }) }),
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (y = w.current) == null || y.focus(), Ye(w, [f, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(rd, { children: [
      /* @__PURE__ */ r(es, { ref: c(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        os,
        {
          className: "tw-z-[250]",
