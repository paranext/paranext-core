import ll, { jsx as i, jsxs as y, Fragment as ie } from "react/jsx-runtime";
import * as j from "react";
import T, { forwardRef as wr, useCallback as Tt, useState as it, useRef as ye, useEffect as Jt, useLayoutEffect as pa, useMemo as Nt } from "react";
import { History as cl, ChevronRight as ui, Check as _n, Circle as pi, ArrowDownWideNarrow as dl, Clock as ul, Bookmark as pl, X as wi, Search as go, ChevronsUpDown as rr, FilterIcon as wl, ChevronDown as Ue, ChevronUp as Zr, ArrowLeftIcon as fl, ChevronLeftIcon as ml, ChevronRightIcon as hl, ArrowRightIcon as gl, CircleCheckIcon as bl, CircleXIcon as vl, CircleHelpIcon as yl, ArrowUpIcon as xl, ArrowDownIcon as Nl, ArrowUpDownIcon as kl, Star as El, PanelLeft as Tl, PanelRight as Sl, ChevronLeft as Cl, LoaderCircle as Ol, Download as Rl, Filter as _l, User as Pl, Link as $l, CircleHelp as Il, BookOpen as wa, Loader as Al, Ellipsis as Ml } from "lucide-react";
import xe, { clsx as Dl } from "clsx";
...
import { getChaptersForBook as Vl, deepEqual as bo, substring as zl, formatScrRef as Dr, compareScrRefs as Qr, scrRefToBBBCCCVVV as Br, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Ll, formatBytes as Fl, getErrorMessage as Ul } from "platform-bible-utils";
...
import { useReactTable as mi, getCoreRowModel as hi, getPaginationRowModel as Gl, getSortedRowModel as gi, getFilteredRowModel as Xl, flexRender as bn, getExpandedRowModel as Hl, getGroupedRowModel as Yl } from "@tanstack/react-table";
...
import ql, { ThemeContext as Wl, internal_processStyles as Kl } from "@mui/styled-engine";
...
import * as en from "@radix-ui/react-avatar";
...
), Tn = mt.Root, or = mt.Trigger, dc = mt.Group, gh = mt.Portal, bh = mt.Sub, vh = mt.RadioGroup, uc = T.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ y(
  mt.SubTrigger,
  {
    ref: o,
    className: N(
...
uc.displayName = mt.SubTrigger.displayName;
const pc = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  mt.SubContent,
  {
    ref: n,
    className: N(
...
pc.displayName = mt.SubContent.displayName;
...
const ar = T.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = kt();
  return /* @__PURE__ */ i(
    mt.Item,
    {
...
ar.displayName = mt.Item.displayName;
const mr = T.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ y(
  mt.CheckboxItem,
  {
    ref: o,
    className: N(
    ...
    ...r,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ i(mt.ItemIndicator, { children: /* @__PURE__ */ i(_n, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
mr.displayName = mt.CheckboxItem.displayName;
const ki = T.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  mt.RadioItem,
  {
    ref: r,
    className: N(
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ i(mt.ItemIndicator, { children: /* @__PURE__ */ i(pi, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
ki.displayName = mt.RadioItem.displayName;
const $n = T.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ i(
  mt.Label,
  {
    ref: r,
...
$n.displayName = mt.Label.displayName;
const In = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  mt.Separator,
  {
    ref: n,
...
In.displayName = mt.Separator.displayName;
...
function Ec(t) {
  return Ei[t - 1].includes("*obsolete*");
}
function Tc() {
  const t = {};
...
var Ri = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(Ri || {});
const Ot = class at {
  constructor(e, n, r, o) {
...
function Oc({ handleSort: t, handleLocationHistory: e, handleBookmarks: n }) {
  return /* @__PURE__ */ y($n, { className: "tw-flex tw-justify-between", children: [
...
const vn = st.allBookIds, Rc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ha = ["OT", "NT", "DC"], _c = 32 + 32 + 32, Pc = [
  /^(\w+)$/i,
  ...
  OT: vn.filter((n) => st.isBookOT(n)),
  NT: vn.filter((n) => st.isBookNT(n)),
  DC: vn.filter((n) => st.isBookDC(n))
})[t], dn = (t) => Vl(st.bookIdToNumber(t));
function Ic() {
  return vn.map((e) => st.bookIdToEnglishName(e));
}
function Ac(t) {
...
function Mc(t) {
  ...
  if (Ac(e))
    return vn.find((r) => st.bookIdToEnglishName(r) === e);
}
function xh({ scrRef: t, handleSubmit: e }) {
  const n = kt(), [r, o] = it(""), [a, s] = it(
    ...
    Pc.forEach((M) => {
      const D = r.match(M);
      if (D) {
        const [K, H = void 0, z = void 0] = D.slice(1), tt = Mc(K);
    ...
    if (d === a) {
      ...
      l + z <= 0 || l + z > dn(d) ? c(0) : z !== 0 && (c(l + z), M.preventDefault());
    }
  };
  return Jt(() => {
    a === d ? a === st.bookNumberToId(t.bookNum) ? c(t.chapterNum) : c(1) : c(0);
  }, [d, t.bookNum, t.chapterNum, a]), pa(() => {
    b(f);
  }, [f]), pa(() => {
    const M = setTimeout(() => {
      if (g && h.current && k.current) {
        const K = k.current.offsetTop - _c;
  ...
  }, [g]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ y(Tn, { modal: !1, open: f, onOpenChange: v, children: [
    /* @__PURE__ */ i(or, { asChild: !0, children: /* @__PURE__ */ i(
      cc,
      {
        ref: m,
        value: r,
        ...
        children: /* @__PURE__ */ y("div", { className: "rtl:tw-ps-2", children: [
          ...
          ha.map(
            (M, D) => P(M).length > 0 && /* @__PURE__ */ y("div", { children: [
              /* @__PURE__ */ i($n, { className: "tw-font-semibold tw-text-foreground/80", children: Rc[M] }),
              ...
              ha.length - 1 !== D ? /* @__PURE__ */ i(In, {}) : void 0
            ] }, M)
          )
        ] })
      }
...
const Dc = tn(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? Qe : "button", { className: N(Dc({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const Bc = tn(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), St = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(fi.Root, { ref: n, className: N("pr-twp", Bc(), t), ...e }));
St.displayName = fi.Root.displayName;
const _i = T.forwardRef(({ className: t, ...e }, n) => {
  const r = kt();
  return /* @__PURE__ */ i(
    kn.Root,
    {
...
_i.displayName = kn.Root.displayName;
const no = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  kn.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ i(kn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ i(pi, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
no.displayName = kn.Item.displayName;
const Pi = En.Root, $i = En.Trigger, No = T.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => {
  const a = kt();
...
No.displayName = En.Content.displayName;
const jc = Zt.Portal, Ii = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Zt.Overlay,
  {
    ref: n,
    className: N(
...
Ii.displayName = Zt.Overlay.displayName;
const Vc = T.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = kt();
  return /* @__PURE__ */ y(jc, { children: [
    /* @__PURE__ */ i(Ii, {}),
    /* @__PURE__ */ y(
      Zt.Content,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ y(
            Zt.Close,
            {
              ...
              children: [
                /* @__PURE__ */ i(wi, { className: "tw-h-4 tw-w-4" }),
...
Vc.displayName = Zt.Content.displayName;
...
zc.displayName = Zt.Title.displayName;
...
Lc.displayName = Zt.Description.displayName;
...
const Eo = T.forwardRef(({ className: t, ...e }, n) => {
  const r = kt();
  return /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ i(go, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ i(
      Pt.Input,
      {
        ref: n,
...
Eo.displayName = Pt.Input.displayName;
...
To.displayName = Pt.List.displayName;
const So = T.forwardRef((t, e) => /* @__PURE__ */ i(Pt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
So.displayName = Pt.Empty.displayName;
...
Ai.displayName = Pt.Group.displayName;
...
Fc.displayName = Pt.Separator.displayName;
...
Co.displayName = Pt.Item.displayName;
function Uc(t) {
...
function ir({
  ...
  const [h, k] = it(!1);
  return /* @__PURE__ */ y(Pi, { open: h, onOpenChange: k, ...m, children: [
    /* @__PURE__ */ i($i, { asChild: !0, children: /* @__PURE__ */ y(
      wt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(rr, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(
      No,
      {
        ...
        children: /* @__PURE__ */ y(ko, { children: [
          /* @__PURE__ */ i(Eo, { placeholder: u, className: "tw-text-inherit" }),
          /* @__PURE__ */ i(So, { children: f }),
          /* @__PURE__ */ i(To, { children: e.map((P) => /* @__PURE__ */ y(
            Co,
            {
              value: l(P),
              onSelect: () => {
...
function kh({
  ...
  const u = jr(d, "%webView_bookSelector_currentBook%"), f = jr(d, "%webView_bookSelector_choose%"), w = jr(d, "%webView_bookSelector_chooseBooks%"), [g, b] = it(
    "current book"
    /* CURRENT_BOOK */
  ), m = (h) => {
    b(h), t(h);
...
function Hc({ table: t }) {
  return /* @__PURE__ */ y(Tn, { children: [
    /* @__PURE__ */ i(jl, { asChild: !0, children: /* @__PURE__ */ y(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ i(wl, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ y(Ge, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ i($n, { children: "Toggle columns" }),
      /* @__PURE__ */ i(In, {}),
...
const Xe = vt.Root, Yc = vt.Group, He = vt.Value, Ee = T.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = kt();
  return /* @__PURE__ */ y(
    vt.Trigger,
    {
...
const Mi = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  vt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ i(Zr, { className: "tw-h-4 tw-w-4" })
  }
));
Mi.displayName = vt.ScrollUpButton.displayName;
...
Di.displayName = vt.ScrollDownButton.displayName;
...
qc.displayName = vt.Label.displayName;
const Vt = T.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  vt.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(vt.ItemIndicator, { children: /* @__PURE__ */ i(_n, { className: "tw-h-4 tw-w-4" }) }) }),
...
const An = T.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ i("div", { className: N("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ i(
  "table",
  {
    ref: r,
...
const Mn = T.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ i(
  "thead",
  {
    ref: r,
    className: N(
...
const Dn = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("tbody", { ref: n, className: N("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Qc({
  ...
  var h;
  const [l, c] = it([]), [d, u] = it([]), [f, w] = it({}), [g, b] = it({}), m = mi({
    data: e,
    columns: t,
    getCoreRowModel: hi(),
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ y(An, { stickyHeader: a, children: [
      /* @__PURE__ */ i(Mn, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ i(Wt, { children: k.headers.map((P) => /* @__PURE__ */ i(zt, { children: P.isPlaceholder ? void 0 : bn(P.column.columnDef.header, P.getContext()) }, P.id)) }, k.id)) }),
      /* @__PURE__ */ i(Dn, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        Wt,
        {
          onClick: () => s(k, m),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((P) => /* @__PURE__ */ i(Mt, { children: bn(P.column.columnDef.cell, P.getContext()) }, P.id))
        },
        k.id
      )) : /* @__PURE__ */ i(Wt, { children: /* @__PURE__ */ i(Mt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function td({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], a = Nt(() => {
    const s = [];
    return t.forEach((l) => {
      s.some((c) => bo(c, l)) || s.push(l);
    }), s;
  }, [t]);
  return /* @__PURE__ */ y(An, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(Mn, { stickyHeader: !0, children: /* @__PURE__ */ y(Wt, { children: [
      /* @__PURE__ */ i(zt, { children: r }),
      /* @__PURE__ */ i(zt, { children: o })
    ] }) }),
    /* @__PURE__ */ i(Dn, { children: a.length > 0 && a.map((s) => /* @__PURE__ */ y(
      Wt,
      {
        onClick: () => {
          e(s.reference);
...
const Oo = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  to.Root,
  {
    ref: n,
    className: N(
    ...
    children: /* @__PURE__ */ i(
      to.Indicator,
      {
        ...
        children: /* @__PURE__ */ i(_n, { className: "tw-h-4 tw-w-4" })
      }
    )
  }
));
Oo.displayName = to.Root.displayName;
...
}, rd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Bi = tn(
...
), od = T.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ i(
  bi.Root,
  {
    ref: o,
...
od.displayName = bi.Root.displayName;
const ji = T.createContext({
  size: "default",
  variant: "default"
}), Vi = T.forwardRef(({ className: t, variant: e, size: n, children: r, ...o }, a) => {
  const s = kt();
  return /* @__PURE__ */ i(
    fr.Root,
    {
...
Vi.displayName = fr.Root.displayName;
const Qn = T.forwardRef(({ className: t, children: e, variant: n, size: r, ...o }, a) => {
  const s = T.useContext(ji);
  return /* @__PURE__ */ i(
    fr.Item,
    {
      ref: a,
...
Qn.displayName = fr.Item.displayName;
const hr = (t) => t === "asc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(kl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Eh = (t) => ({
  accessorKey: "item",
  ...
  return ed(t).forEach((u) => {
    u.startsWith("\\id") && (s = nd(u), l = 0, c = 0), u.startsWith("\\c") && (l = ga(u), c = 0), u.startsWith("\\v") && (c = ga(u), l === 0 && (l = e.chapterNum));
    let f = o.exec(u) ?? void 0;
    for (; f; ) {
      const w = [];
      f.forEach((h) => w.push(h));
      const g = f.index, b = a.find((h) => bo(h.items, w)), m = {
        reference: {
...
function Oh({
  ...
  const f = ne(n, "%webView_inventory_all%"), w = ne(n, "%webView_inventory_approved%"), g = ne(n, "%webView_inventory_unapproved%"), b = ne(n, "%webView_inventory_unknown%"), m = ne(n, "%webView_inventory_scope_currentBook%"), h = ne(n, "%webView_inventory_scope_chapter%"), k = ne(n, "%webView_inventory_scope_verse%"), P = ne(n, "%webView_inventory_filter_text%"), C = ne(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, v] = it(!1), [$, X] = it("all"), [_, I] = it(""), [U, B] = it([]), M = Nt(() => l ? r instanceof RegExp ? sd(
    l,
    t,
    a,
    s,
  ...
  }, [E, M]), K = Nt(() => id(D, $, _), [D, $, _]), H = Nt(() => {
    var q, Y;
    if (!E)
      return u;
    const x = (q = o == null ? void 0 : o.tableHeaders) == null ? void 0 : q.length;
    if (!x)
      return u;
    const R = [];
    for (let G = 0; G < x; G++)
...
function Rh({
  ...
  return /* @__PURE__ */ y(Pi, { open: d, onOpenChange: u, children: [
    /* @__PURE__ */ i($i, { asChild: !0, children: /* @__PURE__ */ y(
      wt,
      {
        variant: "outline",
        ...
        children: [
          ...
          /* @__PURE__ */ i(rr, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(No, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ y(ko, { children: [
      ...
      /* @__PURE__ */ y(To, { children: [
        ...
        /* @__PURE__ */ i(Ai, { children: g.map((b) => {
          ...
          return /* @__PURE__ */ y(
            Co,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: b.starred && /* @__PURE__ */ i(El, { className: "tw-h-4 tw-w-4" }) }),
...
Fi.displayName = $t.List.displayName;
const ld = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  $t.Trigger,
  {
    ref: n,
    ...e,
...
Ui.displayName = $t.Content.displayName;
function _h({
  tabList: t,
  onSearch: e,
  searchPlaceholder: n,
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ y(Li, { children: [
      /* @__PURE__ */ i(Fi, { children: t.map((a) => /* @__PURE__ */ i(ld, { value: a.value, children: a.value }, a.key)) }),
      t.map((a) => /* @__PURE__ */ i(Ui, { value: a.value, children: a.content }, a.key))
    ] })
  ] });
}
const Ro = T.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ i(
  vi.Root,
  {
    ref: o,
    decorative: n,
...
Ro.displayName = vi.Root.displayName;
...
const cd = Pn.Provider, dd = Pn.Root, ud = Pn.Trigger, Gi = T.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ i(
  Pn.Content,
  {
    ref: r,
    sideOffset: e,
...
Gi.displayName = Pn.Content.displayName;
const pd = "16rem", wd = "3rem", Xi = T.createContext(void 0);
function gr() {
...
const Hi = T.forwardRef(
  ({
    ...
    return /* @__PURE__ */ i(Xi.Provider, { value: P, children: /* @__PURE__ */ i(cd, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const fd = T.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = gr();
  return /* @__PURE__ */ y(
    wt,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ i(Tl, {}) : /* @__PURE__ */ i(Sl, {}),
...
const hd = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Re,
  {
    ref: n,
    "data-sidebar": "input",
...
const oo = T.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? Qe : "div",
  {
    ref: r,
...
const yd = T.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? Qe : "button",
  {
    ref: r,
...
const xd = tn(
  ...
  ({
    ...
    const c = t ? Qe : "button", { state: d } = gr(), u = /* @__PURE__ */ i(
      c,
      {
        ref: l,
...
const Nd = T.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ i(
  e ? Qe : "button",
  {
    ref: o,
...
const Ed = T.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
...
const Cd = T.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ i(
  t ? Qe : "a",
  {
    ref: a,
    ...
    Yi,
    {
      ...
      children: /* @__PURE__ */ y(Wi, { children: [
        /* @__PURE__ */ y(ro, { children: [
          /* @__PURE__ */ i(oo, { className: "tw-text-sm tw-text-gray-400", children: a }),
          /* @__PURE__ */ i(ao, { children: /* @__PURE__ */ i(Ki, { children: e.map((f) => /* @__PURE__ */ i(Ji, { children: /* @__PURE__ */ i(
            Zi,
            {
              className: N(
        ...
        /* @__PURE__ */ y(ro, { children: [
          /* @__PURE__ */ i(oo, { className: "tw-text-sm tw-text-gray-400", children: s }),
          /* @__PURE__ */ i(ao, { className: "tw-pl-3", children: /* @__PURE__ */ i(
            ir,
            {
...
function Ph({
  ...
  return /* @__PURE__ */ y("div", { className: "tw-box-border tw-flex tw-h-full tw-flex-col tw-p-3", children: [
    ...
    /* @__PURE__ */ y(Hi, { id: t, className: "tw-h-full tw-flex-1 tw-gap-4 tw-overflow-auto", children: [
      ...
      /* @__PURE__ */ i(qi, { className: "tw-overflow-y-auto", children: r })
    ] })
  ] });
}
const le = "scrBook", Rd = "scrRef", he = "source", _d = "details", Pd = "Scripture Reference", $d = "Scripture Book", Qi = "Type", Id = "Details";
function Ad(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? st.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === le ? Dr(o.start) : void 0;
      },
    ...
    {
      accessorFn: (r) => Dr(r.start),
      id: Rd,
      header: void 0,
      cell: (r) => {
        const o = r.row.original;
        return r.row.getIsGrouped() ? void 0 : Dr(o.start);
      },
      sortingFn: (r, o) => Qr(r.original.start, o.original.start),
      enableGrouping: !1
    },
...
}, va = (t) => `${Md({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function $h({
  sources: t,
  ...
  Jt(() => {
    if (l) {
      ...
      if (I.length === 1) {
        const U = b.find((B) => va(B) === I[0]) || void 0;
        U && l(U);
      }
    }
  }, [w, b, l, h]);
  const k = o ?? $d, P = a ?? Qi, C = [
    ...
    !e && /* @__PURE__ */ y(
      Xe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Te, { position: "item-aligned", children: /* @__PURE__ */ i(Yc, { children: C.map((_) => /* @__PURE__ */ i(Vt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ y(An, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(Mn, { children: h.getHeaderGroups().map((_) => /* @__PURE__ */ i(Wt, { children: _.headers.filter((I) => I.column.columnDef.header).map((I) => (
      ...
      /* @__PURE__ */ i(Dn, { children: h.getRowModel().rows.map((_, I) => {
        const U = kt();
        return /* @__PURE__ */ i(
          Wt,
          {
                    ...
                    children: (() => B.getIsGrouped() ? /* @__PURE__ */ y(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ i(ui, {}) : /* @__PURE__ */ i(Cl, {})),
                          " ",
                          bn(B.column.columnDef.cell, B.getContext()),
                          " (",
                          _.subRows.length,
                          ")"
                        ]
...
function re(t, e, n = {
  ...
  return ve(t) && ve(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ve(e[o]) && o in t && ve(t[o]) ? r[o] = re(t[o], e[o], n) : n.clone ? r[o] = ve(e[o]) ? es(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
var io = { exports: {} }, qn = { exports: {} }, lt = {};
...
function zd() {
  return xa || (xa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    ct.AsyncMode = v, ct.ConcurrentMode = $, ct.ContextConsumer = X, ct.ContextProvider = _, ct.Element = I, ct.ForwardRef = U, ct.Fragment = B, ct.Lazy = M, ct.Memo = D, ct.Portal = K, ct.Profiler = H, ct.StrictMode = z, ct.Suspense = tt, ct.isAsyncMode = ot, ct.isConcurrentMode = x, ct.isContextConsumer = R, ct.isContextProvider = q, ct.isElement = Y, ct.isForwardRef = G, ct.isFragment = J, ct.isLazy = L, ct.isMemo = Z, ct.isPortal = W, ct.isProfiler = Q, ct.isStrictMode = O, ct.isSuspense = F, ct.isValidElementType = C, ct.typeOf = E;
  }()), ct;
}
var Na;
function ns() {
  return Na || (Na = 1, process.env.NODE_ENV === "production" ? qn.exports = Vd() : qn.exports = zd()), qn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ld() {
  ...
  return Fr = o() ? Object.assign : function(a, s) {
...
function Ud() {
  if (Ca)
    return Hr;
  Ca = 1;
  var t = ns(), e = Ld(), n = $o(), r = rs(), o = Fd(), a = function() {
  };
  ...
  return Hr = function(l, c) {
    ...
    function h(x) {
      ...
      function Y(J, L, Z, W, Q, O, F) {
        ...
        return L[Z] == null ? J ? L[Z] === null ? new m("The " + Q + " `" + O + "` is marked as required " + ("in `" + W + "`, but its value is `null`.")) : new m("The " + Q + " `" + O + "` is marked as required in " + ("`" + W + "`, but its value is `undefined`.")) : null : x(L, Z, W, Q, O);
      }
      var G = Y.bind(null, !1);
      return G.isRequired = Y.bind(null, !0), G;
    }
    function k(x) {
      function R(q, Y, G, J, L, Z) {
        var W = q[Y], Q = z(W);
        if (Q !== x) {
          var O = tt(W);
          return new m(
    ...
    function $(x) {
      function R(q, Y, G, J, L) {
        if (!(q[Y] instanceof x)) {
          var Z = x.name || w, W = ot(q[Y]);
          return new m("Invalid " + J + " `" + L + "` of type " + ("`" + W + "` supplied to `" + G + "`, expected ") + ("instance of `" + Z + "`."));
        }
        return null;
      }
      return h(R);
    ...
    function X(x) {
      ...
      function R(q, Y, G, J, L) {
        for (var Z = q[Y], W = 0; W < x.length; W++)
          if (b(Z, x[W]))
            return null;
    ...
    function _(x) {
      function R(q, Y, G, J, L) {
        ...
        var Z = q[Y], W = z(Z);
        if (W !== "object")
          return new m("Invalid " + J + " `" + L + "` of type " + ("`" + W + "` supplied to `" + G + "`, expected an object."));
        for (var Q in Z)
          if (r(Z, Q)) {
            var O = x(Z, Q, G, J, L + "." + Q, n);
            if (O instanceof Error)
    ...
    function I(x) {
      ...
      for (var R = 0; R < x.length; R++) {
        ...
        if (typeof q != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + rt(q) + " at index " + R + "."
          ), s;
      }
      function Y(G, J, L, Z, W) {
        for (var Q = [], O = 0; O < x.length; O++) {
          var F = x[O], S = F(G, J, L, Z, W, n);
          if (S == null)
            return null;
          S.data && r(S.data, "expectedType") && Q.push(S.data.expectedType);
        }
        var ft = Q.length > 0 ? ", expected one of type [" + Q.join(", ") + "]" : "";
        return new m("Invalid " + Z + " `" + W + "` supplied to " + ("`" + L + "`" + ft + "."));
      }
      return h(Y);
    }
    function U() {
      function x(R, q, Y, G, J) {
        return K(R[q]) ? null : new m("Invalid " + G + " `" + J + "` supplied to " + ("`" + Y + "`, expected a ReactNode."));
      }
      return h(x);
    }
    function B(x, R, q, Y, G) {
      return new m(
        (x || "React class") + ": " + R + " type `" + q + "." + Y + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + G + "`."
      );
    }
    function M(x) {
      function R(q, Y, G, J, L) {
        var Z = q[Y], W = z(Z);
        if (W !== "object")
          return new m("Invalid " + J + " `" + L + "` of type `" + W + "` " + ("supplied to `" + G + "`, expected `object`."));
        for (var Q in x) {
          var O = x[Q];
...
const as = Po(p.element, os);
as.isRequired = Po(p.element.isRequired, os);
const is = as, Wd = "exact-prop: ​";
function Kd(t) {
...
function Zd() {
  return _a || (_a = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    ut.ContextConsumer = $, ut.ContextProvider = X, ut.Element = _, ut.ForwardRef = I, ut.Fragment = U, ut.Lazy = B, ut.Memo = M, ut.Portal = D, ut.Profiler = K, ut.StrictMode = H, ut.Suspense = z, ut.SuspenseList = tt, ut.isAsyncMode = x, ut.isConcurrentMode = R, ut.isContextConsumer = q, ut.isContextProvider = Y, ut.isElement = G, ut.isForwardRef = J, ut.isFragment = L, ut.isLazy = Z, ut.isMemo = W, ut.isPortal = Q, ut.isProfiler = O, ut.isStrictMode = F, ut.isSuspense = S, ut.isSuspenseList = ft, ut.isValidElementType = E, ut.typeOf = v;
  }()), ut;
}
process.env.NODE_ENV === "production" ? so.exports = Jd() : so.exports = Zd();
var Pa = so.exports;
...
const nu = p.oneOfType([p.func, p.object]), ls = nu;
function Qt(t) {
  if (typeof t != "string")
...
function su(t) {
  return sr(t).defaultView || window;
}
function lu(t, e) {
  if (process.env.NODE_ENV === "production")
    return () => null;
...
const cu = typeof window < "u" ? j.useLayoutEffect : j.useEffect, qe = cu;
let Ia = 0;
function du(t) {
...
function yu(t) {
  t.addEventListener("keydown", bu, !0), t.addEventListener("mousedown", qr, !0), t.addEventListener("pointerdown", qr, !0), t.addEventListener("touchstart", qr, !0), t.addEventListener("visibilitychange", vu, !0);
}
function xu(t) {
  const {
    target: e
...
function us() {
  ...
  function n() {
    return e.current ? (co = !0, mu.start(100, () => {
      co = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function Cu(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = Et(t, Tu), a = Su(e), s = Object.keys(a);
  function l(w) {
...
const Ou = {
  borderRadius: 4
}, Ru = Ou, _u = process.env.NODE_ENV !== "production" ? p.oneOfType([p.number, p.string, p.object, p.array]) : {}, de = _u;
function yn(t, e) {
  return e ? re(t, e, {
    clone: !1
...
function yt(t) {
  const {
    ...
    return oe(s, l, (f) => {
      let w = cr(d, o, f);
      return f === w && typeof f == "string" && (w = cr(d, o, `${e}${f === "default" ? "" : Qt(f)}`, f)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
function ju(t, e) {
  return (n) => t.reduce((r, o) => (r[o] = Vn(e, n), r), {});
}
function Vu(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
...
function gs(t, e) {
  const n = hs(t.theme);
  return Object.keys(t).map((r) => Vu(t, e, r, n)).reduce(yn, {});
}
function gt(t) {
  return gs(t, xr);
}
...
bt.filterProps = Nr;
process.env.NODE_ENV !== "production" && Bu.reduce((t, e) => (t[e] = de, t), {});
function zu(t = 8) {
  if (t.mui)
    return t;
  const e = hs({
...
const Lu = Xt("border", Lt), Fu = Xt("borderTop", Lt), Uu = Xt("borderRight", Lt), Gu = Xt("borderBottom", Lt), Xu = Xt("borderLeft", Lt), Hu = Xt("borderColor"), Yu = Xt("borderTopColor"), qu = Xt("borderRightColor"), Wu = Xt("borderBottomColor"), Ku = Xt("borderLeftColor"), Ju = Xt("outline", Lt), Zu = Xt("outlineColor"), Er = (t) => {
...
kr(Lu, Fu, Uu, Gu, Xu, Hu, Yu, qu, Wu, Ku, Er, Ju, Zu);
const Tr = (t) => {
...
kr(Tr, Sr, Cr, Qu, tp, ep, np, rp, op, ap, ip, sp);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const lp = yt({
...
function yp() {
  function t(n, r, o, a) {
    ...
    return f ? f(s) : oe(s, r, (b) => {
      let m = cr(w, u, b);
      return b === m && typeof b == "string" && (m = cr(w, u, `${n}${b === "default" ? "" : Qt(b)}`, b)), c === !1 ? m : {
        [c]: m
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const u = Pu(a.breakpoints), f = Object.keys(u);
      let w = u;
...
function jo(t = {}, ...e) {
  ...
  return d.applyStyles = xp, d = e.reduce((u, f) => re(u, f), d), d.unstable_sxConfig = A({}, Do, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Bo({
      sx: f,
      theme: this
    });
...
const _p = jo(), Va = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Wn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function $p(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: w = Pp(Va(d))
    } = l, g = Et(l, Cp), b = u !== void 0 ? u : (
    ...
    const P = ql(s, A({
      shouldForwardProp: k,
      label: h
    }, g)), C = (v) => typeof v == "function" && v.__emotion_real !== v || ve(v) ? ($) => er(v, A({}, $, {
      theme: Wn({
        theme: $.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let B;
        c && (B = `${c}${Qt(d || "")}`), B === void 0 && (B = `Styled(${eu(s)})`), U.displayName = B;
      }
...
function za(t) {
  t = Ce(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Ce(Dp(t)).values : t.values;
...
function xs(t, e) {
  return t = Ce(t), e = Vo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, Or(t);
}
function Bp(t, e) {
  if (t = Ce(t), e = Vo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
const zp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ve = qp, Wp = ["mode", "contrastThreshold", "tonalOffset"], Fa = {
...
function nw(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Et(t, Wp), a = t.primary || Kp(e), s = t.secondary || Jp(e), l = t.error || Zp(e), c = t.info || Qp(e), d = t.success || tw(e), u = t.warning || ew(e);
  function f(m) {
    const h = La(m, Wr.text.primary) >= n ? Wr.text.primary : Fa.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = La(m, h);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ua(m, "light", P, r), Ua(m, "dark", C, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, g = {
    dark: Wr,
    light: Fa
  };
...
function aw(t, e) {
  ...
  const g = o / 14, b = f || ((k) => `${k / d * g}rem`), m = (k, P, C, E, v) => A({
    ...
    button: m(l, 14, 1.75, 0.4, Ga),
    caption: m(s, 12, 1.66, 0.4),
    overline: m(s, 12, 2.66, 1, Ga),
...
const cw = ["none", ht(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ht(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ht(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ht(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ht(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ht(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ht(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ht(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ht(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ht(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ht(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ht(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ht(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ht(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ht(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ht(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ht(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ht(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ht(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ht(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ht(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ht(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ht(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ht(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], dw = cw, uw = ["duration", "easing", "delay"], pw = {
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((u) => `${u} ${typeof s == "string" ? s : Ha(s)} ${l} ${typeof c == "string" ? c : Ha(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
`));
  ...
  return d.unstable_sxConfig = A({}, Do, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Bo({
      sx: f,
      theme: this
    });
...
const xw = (t) => tr(t) && t !== "classes", Nw = $p({
  themeId: Lo,
  defaultTheme: zo,
...
const Ew = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Tw = (t) => {
  ...
  const r = Fo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = Et(r, Ew), b = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", m = A({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
var ks = _o.default = void 0, $w = Pw(_w()), Iw = ll;
ks = _o.default = (0, $w.default)(/* @__PURE__ */ (0, Iw.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Aw(t) {
...
}, Dw = /* @__PURE__ */ j.createContext(Mw);
function Bw(t) {
  const {
...
function zw(t) {
  ...
  const s = jw(A({}, o, r)), l = Wa(r), c = Wa(o), d = e(s), u = xe(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = A({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = A({}, d, n, c, l);
...
const dr = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    children: r,
    container: o,
    disablePortal: a = !1
...
process.env.NODE_ENV !== "production" && (dr.propTypes = {
   ...
   */
  container: p.oneOfType([Sn, p.func]),
  /**
...
process.env.NODE_ENV !== "production" && (dr["propTypes"] = Kd(dr.propTypes));
var Rt = "top", Ut = "bottom", Gt = "right", _t = "left", Go = "auto", Ln = [Rt, Ut, Gt, _t], We = "start", On = "end", Yw = "clippingParents", Ss = "viewport", pn = "popper", qw = "reference", Ka = /* @__PURE__ */ Ln.reduce(function(t, e) {
  return t.concat([e + "-" + We, e + "-" + On]);
}, []), Cs = /* @__PURE__ */ [].concat(Ln, [Go]).reduce(function(t, e) {
  return t.concat([e, e + "-" + We, e + "-" + On]);
}, []), Ww = "beforeRead", Kw = "read", Jw = "afterRead", Zw = "beforeMain", Qw = "main", tf = "afterMain", ef = "beforeWrite", nf = "write", rf = "afterWrite", of = [Ww, Kw, Jw, Zw, Qw, tf, ef, nf, rf];
function te(t) {
...
var Ne = Math.max, ur = Math.min, Ke = Math.round;
function uo() {
...
function Je(t, e, n) {
  ...
  var s = Oe(t) ? Bt(t) : window, l = s.visualViewport, c = !Os() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: u,
...
function Rr(t) {
  return te(t) === "html" ? t : (
    ...
    (Xo(t) ? t.host : null) || // ShadowRoot detected
...
function df(t) {
  ...
  var o = Rr(t);
  for (Xo(o) && (o = o.host); Ft(o) && ["html", "body"].indexOf(te(o)) < 0; ) {
    var a = ae(o);
...
function Fn(t) {
  for (var e = Bt(t), n = Ja(t); n && cf(n) && ae(n).position === "static"; )
    n = Ja(n);
  return n && (te(n) === "html" || te(n) === "body" && ae(n).position === "static") ? e : n || df(t) || e;
}
function Yo(t) {
...
var pf = function(e, n) {
  ...
  })) : e, Ps(typeof e != "number" ? e : $s(e, Ln));
};
function wf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Kt(n.placement), c = Yo(l), d = [_t, Gt].indexOf(l) >= 0, u = d ? "height" : "width";
  if (!(!a || !s)) {
    var f = pf(o.padding, n), w = Ho(a), g = c === "y" ? Rt : _t, b = c === "y" ? Ut : Gt, m = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], k = Fn(a), P = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, E = f[g], v = P - w[u] - f[b], $ = P / 2 - w[u] / 2 + C, X = xn(E, $, v), _ = c;
...
function Za(t) {
  ...
  if (d) {
    var $ = Fn(n), X = "clientHeight", _ = "clientWidth";
    if ($ === Bt(n) && ($ = ue(n), ae($).position !== "static" && l === "absolute" && (X = "scrollHeight", _ = "scrollWidth")), $ = $, o === Rt || (o === _t || o === Gt) && a === On) {
      E = Ut;
...
function Wo(t) {
  return Je(ue(t)).left + qo(t).scrollLeft;
}
function Ef(t, e) {
...
function Tf(t) {
  var e, n = ue(t), r = qo(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = Ne(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = Ne(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Wo(t), c = -r.scrollTop;
...
function Is(t) {
  return ["html", "body", "#document"].indexOf(te(t)) >= 0 ? t.ownerDocument.body : Ft(t) && Ko(t) ? t : Is(Rr(t));
}
function Nn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Is(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = Bt(r), s = o ? [a].concat(a.visualViewport || [], Ko(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function ti(t, e, n) {
  return e === Ss ? po(Ef(t, n)) : Oe(e) ? Sf(e, n) : po(Tf(ue(t)));
}
function Cf(t) {
  var e = Nn(Rr(t)), n = ["absolute", "fixed"].indexOf(ae(t).position) >= 0, r = n && Ft(t) ? Fn(t) : t;
  return Oe(r) ? e.filter(function(o) {
    return Oe(o) && Rs(o, r) && te(o) !== "body";
  }) : [];
}
function Of(t, e, n, r) {
  var o = e === "clippingParents" ? Cf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var u = ti(t, d, r);
    return c.top = Ne(u.top, c.top), c.right = ur(u.right, c.right), c.bottom = ur(u.bottom, c.bottom), c.left = Ne(u.left, c.left), c;
  }, ti(t, s, r));
...
function Rn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Yw : l, d = n.rootBoundary, u = d === void 0 ? Ss : d, f = n.elementContext, w = f === void 0 ? pn : f, g = n.altBoundary, b = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Ps(typeof h != "number" ? h : $s(h, Ln)), P = w === pn ? qw : pn, C = t.rects.popper, E = t.elements[b ? P : w], v = Of(Oe(E) ? E : E.contextElement || ue(t.elements.popper), c, u, s), $ = Je(t.elements.reference), X = As({
    reference: $,
    element: C,
    strategy: "absolute",
    placement: o
  }), _ = po(Object.assign({}, C, X)), I = w === pn ? _ : $, U = {
...
function Rf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Cs : c, u = Ze(r), f = u ? l ? Ka : Ka.filter(function(b) {
    return Ze(b) === u;
  }) : Ln, w = f.filter(function(b) {
...
function Pf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, b = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Kt(h), P = k === h, C = c || (P || !b ? [nr(h)] : _f(h)), E = [h].concat(C).reduce(function(G, J) {
      return G.concat(Kt(J) === Go ? Rf(e, {
        placement: J,
        boundary: u,
        rootBoundary: f,
        padding: d,
      ...
      var B = E[U], M = Kt(B), D = Ze(B) === We, K = [Rt, Ut].indexOf(M) >= 0, H = K ? "width" : "height", z = Rn(e, {
        placement: B,
        boundary: u,
        rootBoundary: f,
        altBoundary: w,
...
function If(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, s = Rn(e, {
    ...
    altBoundary: !0
  }), c = ei(s, r), d = ei(l, o, a), u = ni(c), f = ni(d);
  e.modifiersData[n] = {
...
function Lf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, b = n.tetherOffset, m = b === void 0 ? 0 : b, h = Rn(e, {
    boundary: c,
    rootBoundary: d,
    padding: f,
    altBoundary: u
  }), k = Kt(e.placement), P = Ze(e.placement), C = !P, E = Yo(k), v = zf(E), $ = e.modifiersData.popperOffsets, X = e.rects.reference, _ = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, U = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if ($) {
    if (a) {
      var D, K = E === "y" ? Rt : _t, H = E === "y" ? Ut : Gt, z = E === "y" ? "height" : "width", tt = $[E], rt = tt + h[K], ot = tt - h[H], x = g ? -_[z] / 2 : 0, R = P === We ? X[z] : _[z], q = P === We ? -_[z] : -X[z], Y = e.elements.arrow, G = g && Y ? Ho(Y) : {
        width: 0,
        height: 0
      }, J = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : _s(), L = J[K], Z = J[H], W = xn(0, X[z], G[z]), Q = C ? X[z] / 2 - x - W - L - U.mainAxis : R - W - L - U.mainAxis, O = C ? -X[z] / 2 + x + W + Z + U.mainAxis : q + W + Z + U.mainAxis, F = e.elements.arrow && Fn(e.elements.arrow), S = F ? E === "y" ? F.clientTop || 0 : F.clientLeft || 0 : 0, ft = (D = B == null ? void 0 : B[E]) != null ? D : 0, V = tt + Q - ft - S, xt = tt + O - ft, Ht = xn(g ? ur(rt, V) : rt, tt, g ? Ne(ot, xt) : ot);
      $[E] = Ht, M[E] = Ht - tt;
    }
    if (l) {
      var pe, Ct = E === "x" ? Rt : _t, Un = E === "x" ? Ut : Gt, Yt = $[v], Pe = v === "y" ? "height" : "width", we = Yt + h[Ct], $e = Yt - h[Un], Ie = [Rt, _t].indexOf(k) !== -1, Ae = (pe = B == null ? void 0 : B[v]) != null ? pe : 0, fe = Ie ? we : Yt - X[Pe] - _[Pe] - Ae + U.altAxis, rn = Ie ? Yt + X[Pe] + _[Pe] - Ae - U.altAxis : $e, Gn = g && Ie ? uf(fe, Yt, rn) : xn(g ? fe : we, Yt, g ? rn : $e);
      $[v] = Gn, M[v] = Gn - Yt;
    }
    e.modifiersData[r] = M;
  }
...
function Hf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && Xf(e), a = ue(e), s = Je(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Ko(a)) && (l = Gf(e)), Ft(e) ? (c = Je(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Wo(a))), {
    ...
    var u = {
      ...
      setOptions: function(k) {
        ...
        m(), u.options = Object.assign({}, a, u.options, P), u.scrollParents = {
          reference: Oe(l) ? Nn(l) : l.contextElement ? Nn(l.contextElement) : [],
          popper: Nn(c)
        };
        var C = qf(Kf([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (oi(P, C)) {
            u.rects = {
              reference: Hf(P, Fn(C), u.options.strategy === "fixed"),
              popper: Ho(C)
...
const am = () => Io({
  root: ["root"]
}, Bw(tm)), im = {}, sm = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, h = Et(e, em), k = j.useRef(null), P = Se(k, n), C = j.useRef(null), E = Se(C, w), v = j.useRef(E);
  qe(() => {
    v.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const $ = rm(u, s), [X, _] = j.useState($), [I, U] = j.useState(pr(o));
  j.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && I && _r(I) && I.nodeType === 1) {
...
`));
  ...
  const M = am(), D = (r = b.root) != null ? r : "div", K = Fw({
    elementType: D,
...
}), Ds = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    anchorEl: r,
    children: o,
    container: a,
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, P = Et(e, nm), [C, E] = j.useState(!0), v = () => {
    E(!1);
  }, $ = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const U = pr(r);
    X = U && _r(U) ? sr(U).body : sr(null).body;
  }
...
process.env.NODE_ENV !== "production" && (Ds.propTypes = {
   ...
   */
  anchorEl: Po(p.oneOfType([Sn, p.object, p.func]), (t) => {
    if (t.open) {
      const e = pr(t.anchorEl);
      if (e && _r(e) && e.nodeType === 1) {
...
var dm = function(e) {
  return e.scrollTop;
}, gn = "unmounted", ge = "exited", be = "entering", Le = "entered", fo = "exiting", se = /* @__PURE__ */ function(t) {
  lm(e, t);
  function e(r, o) {
    var a;
    a = t.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = ge, a.appearStatus = be) : c = Le : r.unmountOnExit || r.mountOnEnter ? c = gn : c = ge, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== be && s !== Le && (a = be) : (s === be || s === Le) && (a = fo);
    }
    ...
    var a = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Yn.findDOMNode(this), l], d = c[0], u = c[1], f = this.getTimeouts(), w = l ? f.appear : f.enter;
    if (!o && !s || ai.disabled) {
      this.safeSetState({
        status: Le
      }, function() {
...
const fm = {
...
}, Kr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Jo = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = Et(e, wm), P = mn(), C = j.useRef(), E = Bs(), v = j.useRef(null), $ = Se(v, a.ref, n), X = (H) => (z) => {
    if (H) {
      const tt = v.current;
    ...
    m === "auto" ? (ot = E.transitions.getAutoHeightDuration(H.clientHeight), C.current = ot) : ot = z, H.style.transition = [E.transitions.create("opacity", {
      ...
      duration: Kr ? ot : ot * 0.666,
      delay: Kr ? tt : tt || ot * 0.333,
      easing: rt
    })].join(","), H.style.opacity = 0, H.style.transform = mo(0.75), f && f(H);
  }), D = X(w);
...
Jo.muiSupportAuto = !0;
const si = Jo, mm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], hm = zn(Ds, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (t, e) => e.root
})({}), Vs = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r;
  const o = vs(), a = Fo({
    props: e,
    name: "MuiPopper"
    ...
    slots: C,
    slotProps: E
  } = a, v = Et(a, mm), $ = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, X = A({
    anchorEl: s,
    container: u,
    disablePortal: f,
    keepMounted: w,
...
process.env.NODE_ENV !== "production" && (Vs.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: p.oneOfType([Sn, p.object, p.func]),
  /**
   * Popper render function or node.
   */
  children: p.oneOfType([p.node, p.func]),
...
const bm = ms("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ce = bm, vm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function ym(t) {
  return Math.round(t * 1e5) / 1e5;
}
const xm = (t) => {
...
const Ls = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const $ = Fo({
    ...
    TransitionProps: ft
  } = $, V = Et($, vm), xt = /* @__PURE__ */ j.isValidElement(_) ? _ : /* @__PURE__ */ i("span", {
    children: _
  }), Ht = Bs(), pe = Ht.direction === "rtl", [Ct, Un] = j.useState(), [Yt, Pe] = j.useState(null), we = j.useRef(!1), $e = K || ot, Ie = mn(), Ae = mn(), fe = mn(), rn = mn(), [Gn, Zo] = ds({
    controlled: J,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Qo = (et) => {
    ...
    (et) => {
      li.start(800 + R, () => {
        Jn = !1;
      }), Zo(!1), Y && ee && Y(et), Ie.start(Ht.transitions.duration.shortest, () => {
        we.current = !1;
      });
    }
  ), $r = (et) => {
    we.current && et.type !== "touchstart" || (Ct && Ct.removeAttribute("title"), Ae.clear(), fe.clear(), z || Jn && tt ? Ae.start(Jn ? tt : z, () => {
      Qo(et);
    }) : Qo(et));
  }, ta = (et) => {
    Ae.clear(), fe.start(R, () => {
    ...
    onFocus: Js,
    ref: Zs
  } = us(), [, na] = j.useState(!1), ra = (et) => {
    Ks(et), ea.current === !1 && (na(!1), ta(et));
  }, oa = (et) => {
    Ct || Un(et.currentTarget), Js(et), ea.current === !0 && (na(!0), $r(et));
  }, aa = (et) => {
    we.current = !0;
    const It = xt.props;
    It.onTouchStart && It.onTouchStart(et);
  }, ia = $r, sa = ta, Qs = (et) => {
    aa(et), fe.clear(), Ie.clear(), Xn(), on.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", rn.start(rt, () => {
      document.body.style.WebkitUserSelect = on.current, $r(et);
    });
  }, tl = (et) => {
    xt.props.onTouchEnd && xt.props.onTouchEnd(et), Xn(), fe.start(q, () => {
      Hn(et);
    });
  };
  j.useEffect(() => {
    if (!ee)
      return;
    function et(It) {
      (It.key === "Escape" || It.key === "Esc") && Hn(It);
    }
    return document.addEventListener("keydown", et), () => {
      document.removeEventListener("keydown", et);
    };
  }, [Hn, ee]);
  const el = Se(xt.ref, Zs, Un, n);
  !F && F !== 0 && (ee = !1);
  const Ir = j.useRef(), nl = (et) => {
    const It = xt.props;
    It.onMouseMove && It.onMouseMove(et), wn = {
      x: et.clientX,
      y: et.clientY
    }, Ir.current && Ir.current.update();
  }, an = {}, Ar = typeof F == "string";
  B ? (an.title = !ee && Ar && !D ? F : null, an["aria-describedby"] = ee ? Pr : null) : (an["aria-label"] = Ar ? F : null, an["aria-labelledby"] = ee && !Ar ? Pr : null);
  const jt = A({}, an, V, xt.props, {
...
`));
  ...
  const sn = {};
  H || (jt.onTouchStart = Qs, jt.onTouchEnd = tl), D || (jt.onMouseOver = Zn(ia, jt.onMouseOver), jt.onMouseLeave = Zn(sa, jt.onMouseLeave), $e || (sn.onMouseOver = ia, sn.onMouseLeave = sa)), M || (jt.onFocus = Zn(oa, jt.onFocus), jt.onBlur = Zn(ra, jt.onBlur), $e || (sn.onFocus = oa, sn.onBlur = ra)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const rl = j.useMemo(() => {
    var et;
    let It = [{
    ...
    return (et = W.popperOptions) != null && et.modifiers && (It = It.concat(W.popperOptions.modifiers)), A({}, W.popperOptions, {
      modifiers: It
    });
  }, [Yt, W]), ln = A({}, $, {
    isRtl: pe,
    ...
    touch: we.current
  }), Mr = xm(ln), la = (r = (o = O.popper) != null ? o : I.Popper) != null ? r : Nm, ca = (a = (s = (l = O.transition) != null ? l : I.Transition) != null ? s : S) != null ? a : si, da = (c = (d = O.tooltip) != null ? d : I.Tooltip) != null ? c : km, ua = (u = (f = O.arrow) != null ? f : I.Arrow) != null ? u : Em, ol = hn(la, A({}, W, (w = Q.popper) != null ? w : U.popper, {
    className: xe(Mr.popper, W == null ? void 0 : W.className, (g = (b = Q.popper) != null ? b : U.popper) == null ? void 0 : g.className)
  }), ln), al = hn(ca, A({}, ft, (m = Q.transition) != null ? m : U.transition), ln), il = hn(da, A({}, (h = Q.tooltip) != null ? h : U.tooltip, {
    className: xe(Mr.tooltip, (k = (P = Q.tooltip) != null ? P : U.tooltip) == null ? void 0 : k.className)
  }), ln), sl = hn(ua, A({}, (C = Q.arrow) != null ? C : U.arrow, {
    className: xe(Mr.arrow, (E = (v = Q.arrow) != null ? v : U.arrow) == null ? void 0 : E.className)
  }), ln);
  return /* @__PURE__ */ y(j.Fragment, {
    children: [/* @__PURE__ */ j.cloneElement(xt, jt), /* @__PURE__ */ i(la, A({
      as: Z ?? zs,
      placement: L,
      anchorEl: ot ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ y(da, A({}, il, {
          children: [F, X ? /* @__PURE__ */ i(ua, A({}, sl, {
            ref: Pe
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Jl,
    {
      ...
      children: n ? /* @__PURE__ */ y(ie, { children: [
        ...
        f ? /* @__PURE__ */ i(yi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(ks, {}) }) : ci(s, n, !1)
      ] }) : h
    }
  );
...
function Gs(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: s } = Nt(() => {
    const u = o && o.length > 0 ? o : (
      ...
      Us(e).filter((b) => !("menuItem" in b.group))
...
const _e = wr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Ol, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
), Mm = T.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: N(Am({ variant: e }), t), ...n }));
...
const Bm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("div", { ref: n, className: N("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Bm.displayName = "AlertDescription";
const jm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  en.Root,
  {
    ref: n,
    className: N(
...
jm.displayName = en.Root.displayName;
const Vm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  en.Image,
  {
    ref: n,
    className: N("tw-aspect-square tw-h-full tw-w-full", t),
    ...e
  }
));
Vm.displayName = en.Image.displayName;
const zm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  en.Fallback,
  {
    ref: n,
    className: N(
...
zm.displayName = en.Fallback.displayName;
const Lm = tn(
...
function Lh({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ i("div", { className: N("pr-twp", Lm({ variant: e }), t), ...n });
}
...
const qs = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: N("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
Um.displayName = fn.Root.displayName;
...
Gm.displayName = eo.Root.displayName;
const Uh = $t.Root, Xm = T.forwardRef(({ className: t, ...e }, n) => {
  const r = kt();
  return /* @__PURE__ */ i(
    $t.List,
    {
...
Xm.displayName = $t.List.displayName;
...
Hm.displayName = $t.Trigger.displayName;
...
Ym.displayName = $t.Content.displayName;
function Gh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      children: t ? /* @__PURE__ */ i(_e, { size: 15 }) : /* @__PURE__ */ y(ie, { children: [
        /* @__PURE__ */ i(Rl, { size: 25, className: N("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Wh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ y(Tn, { children: [
    /* @__PURE__ */ i(or, { asChild: !0, children: /* @__PURE__ */ i(qm, {}) }),
    /* @__PURE__ */ i(Ge, { children: e.map((n) => /* @__PURE__ */ y("div", { children: [
      /* @__PURE__ */ i($n, { children: n.label }),
      /* @__PURE__ */ i(dc, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(mr, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(ki, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(In, {})
    ] }, n.label)) })
  ] }) });
}
...
}, di = (t, e, n) => /* @__PURE__ */ i(wt, { variant: "outline", onClick: () => n(t.dblEntryUid, "install"), children: e }), Zm = (t, e, n, r, o, a) => e.includes(t.dblEntryUid) ? /* @__PURE__ */ i(wt, { variant: "outline", children: /* @__PURE__ */ i(_e, { className: "tw-h-5 tw-py-[1px]" }) }) : t.installed ? t.updateAvailable ? di(t, r, a) : /* @__PURE__ */ i(St, { className: "tw-my-2 tw-flex tw-h-6 tw-items-center", children: o }) : di(t, n, a);
function tg({
  localizedStrings: t,
  dblResources: e,
  ...
  return /* @__PURE__ */ y(Xs, { className: "tw-rounded-none tw-border-0", children: [
    /* @__PURE__ */ i(Hs, { children: /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
      /* @__PURE__ */ i(wa, { size: 36, className: "tw-mr-2" }),
      /* @__PURE__ */ y("div", { children: [
        /* @__PURE__ */ i(Ys, { children: w }),
        /* @__PURE__ */ i(qs, { className: "tw-mt-1", children: f })
      ] })
    ] }) }),
    /* @__PURE__ */ i(Ws, { children: n || !e ? /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-2", children: [
      ...
      /* @__PURE__ */ y("div", { className: "tw-mb-1 tw-flex tw-gap-1", children: [
        /* @__PURE__ */ y("div", { className: "tw-relative", children: [
          ...
          /* @__PURE__ */ i(go, { className: "tw-absolute tw-right-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-text-muted-foreground" })
        ] }),
        /* @__PURE__ */ y(Tn, { children: [
          /* @__PURE__ */ i(or, { asChild: !0, children: /* @__PURE__ */ y(wt, { variant: "outline", children: [
            /* @__PURE__ */ i(Al, { className: "tw-mr-2 tw-w-4" }),
            _
          ] }) }),
      ...
      W.length === 0 ? /* @__PURE__ */ i("div", { className: "tw-m-4 tw-flex tw-w-full tw-justify-center", children: /* @__PURE__ */ i(St, { children: E }) }) : /* @__PURE__ */ y(An, { stickyHeader: !0, children: [
        /* @__PURE__ */ i(Mn, { className: "tw-bg-none", stickyHeader: !0, children: /* @__PURE__ */ y(Wt, { children: [
          /* @__PURE__ */ i(zt, {}),
          /* @__PURE__ */ i(zt, {}),
          /* @__PURE__ */ i(zt, { onClick: () => Q("fullName"), children: /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            b,
            L.key !== "fullName" && /* @__PURE__ */ i(rr, { className: "tw-pl-1", size: 16 }),
            L.key === "fullName" && (L.direction === "ascending" ? /* @__PURE__ */ i(Zr, { className: "tw-pl-1", size: 16 }) : /* @__PURE__ */ i(Ue, { className: "tw-pl-1", size: 16 }))
          ] }) }),
          /* @__PURE__ */ i(zt, { onClick: () => Q("bestLanguageName"), children: /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            k,
            L.key !== "bestLanguageName" && /* @__PURE__ */ i(rr, { className: "tw-pl-1", size: 16 }),
            L.key === "bestLanguageName" && (L.direction === "ascending" ? /* @__PURE__ */ i(Zr, { className: "tw-pl-1", size: 16 }) : /* @__PURE__ */ i(Ue, { className: "tw-pl-1", size: 16 }))
          ] }) }),
          /* @__PURE__ */ i(zt, { children: _ }),
          /* @__PURE__ */ i(zt, { children: X }),
          /* @__PURE__ */ i(zt, { children: u })
        ] }) }),
        /* @__PURE__ */ i(Dn, { children: W.map((O) => {
          var F;
          return /* @__PURE__ */ y(Wt, { children: [
            /* @__PURE__ */ i(Mt, { children: /* @__PURE__ */ i(wa, { className: "tw-pr-0", size: 18 }) }),
            ...
            /* @__PURE__ */ i(Mt, { children: /* @__PURE__ */ y("div", { className: "tw-flex tw-justify-between", children: [
              ...
              O.installed && /* @__PURE__ */ y(Tn, { children: [
                /* @__PURE__ */ i(or, { asChild: !0, children: /* @__PURE__ */ i(wt, { variant: "ghost", children: /* @__PURE__ */ i(Ml, { className: "tw-w-4" }) }) }),
                /* @__PURE__ */ y(Ge, { align: "start", children: [
                  /* @__PURE__ */ i(ar, { onClick: () => l(O.projectId), children: /* @__PURE__ */ i("span", { children: v }) }),
                  /* @__PURE__ */ i(In, {}),
                  /* @__PURE__ */ i(
                    ar,
                    {
...
export {
  ...
  cd as TooltipProvider,
  ud as TooltipTrigger,
