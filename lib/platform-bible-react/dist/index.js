...
import { c as m, g as $e, a as La, C as Pe, A as ue, P as Ve, b as We, B as G, d as je, e as Xe, f as Je, h as Ce, i as Bi, k as Li, j as Fi, E as Ui, l as Fa, r as se, m as Ki, n as dn, o as Qr, p as Ua, L as Et, D as _a, q as Na, s as Ca, t as Ea, T as Wt, u as Ka, v as Xt, w as Jt, x as Zt, y as wn, z as qa, F as Ge, G as kr, H as Ee, I as Te, J as ze, S as _r, K as rr, M as qi, N as Er, O as Ye, Q as Ae, R as Oe, U as ar, V as Ga, W as Ha, X as qr, Y as Ya, Z as un, _ as Gi, $ as Hi, a0 as Yi, a1 as bo, a2 as pn, a3 as ta, a4 as hn, a5 as Wi, a6 as Xi, a7 as Ji, a8 as Zi, a9 as gn, aa as Qi, ab as ia, ac as xo, ad as sa, ae as pr, af as ts, ag as es, ah as rs, ai as as, aj as os, ak as Tr, al as Wa } from "./resizable-C-htIGp4.js";
            ...
            children: [
              ...
              !rt && /* @__PURE__ */ u(Je, { ref: gt, children: [
                O === "books" && /* @__PURE__ */ u(dt, { children: [
                  ...
                  D && !q && or(D.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
ce({ build: (t, e, r) => hr(e), config: Ze({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
ce({ build: (t, e, r) => hr(e), config: Ze({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const so = 0, ja = 1, ri = 2, ga = 3, Ir = 4, tr = 5, fa = 6, fr = 7;
function ma(t) {
  return t.id === so;
}
function ai(t) {
...
class nr {
  ...
  static maybeFromEditor(e) {
    const r = e[qo];
    return r && (r.PACKAGE_VERSION !== va && pt(292, r.PACKAGE_VERSION, va), r instanceof nr || pt(293)), r;
  }
  static fromEditor(e) {
...
ce({ dependencies: [Va, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [cr], register(t, e, r) {
  ...
  return Se(t.registerCommand(rd, (s) => {
    ...
    return !1;
  }, On), t.registerMutationListener(cr, (s, c) => {
    Ul(() => {
      let d = !1;
...
ce({ build: (t, e) => hr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ze({ $getParentEditor: function() {
  const t = bc();
...
ce({ build: (t, e, r) => hr(e), config: Ze({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return be(() => {
...
ce({ build: (t, e, r) => hr(e), config: Ze({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ce({ build: (t, e, r) => hr(e), config: Ze({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => be(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    rt ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(sr, {})
                  ] })
                ]
              }
            ),
      ...
      /* @__PURE__ */ u(
        lr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(ur, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(we, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Qd({
  ...
  let j;
  return d ? j = Array.from({ length: 10 }).map((E, B) => `skeleton-row-${B}`).map((E) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ar, { colSpan: M.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(rr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((z = k.getRowModel().rows) == null ? void 0 : z.length) > 0 ? j = k.getRowModel().rows.map((P) => /* @__PURE__ */ a(
    Oe,
    {
      onClick: () => s(P, k),
      "data-state": P.getIsSelected() && "selected",
      children: P.getVisibleCells().map(($) => /* @__PURE__ */ a(ar, { children: xr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    P.id
  )) : j = /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a(ar, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function nw(t, e, r) {
  return t.key === "Shift" || t.key === "Control" || t.key === "Alt" || t.key === "Meta" ? "passed" : t.ctrlKey || t.metaKey || t.altKey ? (r.dismiss(), "ended") : t.key === "ArrowDown" || t.key === "ArrowUp" ? (mr(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue") : t.key === "Enter" ? (mr(t), r.commit(), "ended") : t.key === "Escape" ? (mr(t), r.dismiss(), "ended") : e.kind === "backslash" && (t.key === " " || t.key === "*") ? (r.dismiss(), "ended") : t.key === "Backspace" || ow[e.kind].test(t.key) ? (e.kind !== "backslash" && mr(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && mr(t), r.dismiss(), "ended");
}
  ...
  const De = () => {
    ...
    (S, X, it) => {
      ...
      st.current = {
        ...
        var q;
        an(st, et), at || (q = h.current) == null || q.focus();
      });
    },
    [p]
  );
  ...
  return /* @__PURE__ */ u(Ga, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Ya, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        ...
        children: [
          /* @__PURE__ */ a(ar, { children: _e(c.reference, "English") }),
          /* @__PURE__ */ a(ar, { className: o, children: Ew(c.text) })
        ]
      },
...
function Tp({
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(lr, { onValueChange: (K) => Tt(K), defaultValue: s, children: [
    ...
    !e && /* @__PURE__ */ u(
      lr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ur, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: M.map((E) => /* @__PURE__ */ a(we, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
function Kp({
  ...
  }, []), vo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-4 tw:w-4" }) }) : void 0;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(Ee, { open: Gt, onOpenChange: S, children: [
        ...
        /* @__PURE__ */ a(
          ze,
          {
            ...
            children: /* @__PURE__ */ u(ia, { container: ae, children: [
              Rt.map(({ value: A, label: Q, dropdownLabel: Ht, scrRefSuffix: gr, id: Pi }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: Re(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-4 tw:w-4" }) }),
                    K(Ht ?? Q, gr, Ai)
                  ]
                },
                Pi
        ...
        ao,
        {
          ...
          children: ot.map(({ value: A, label: Q, scrRefSuffix: Ht, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: gr }),
            /* @__PURE__ */ a(Et, { htmlFor: gr, children: K(Q, Ht) })
          ] }, gr))
        }
      )
    ] }),
...
function Ba({
  ...
  return /* @__PURE__ */ u(Ee, { variant: i, children: [
    ...
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: pr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Nn, { children: [
