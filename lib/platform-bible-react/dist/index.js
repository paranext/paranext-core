...
import { c as m, g as Se, a as La, C as Ce, A as ie, P as Me, b as Ye, B as U, d as $e, e as Ie, f as Ae, h as xe, i as Vi, k as Pi, j as ji, E as Li, l as Ba, r as pe, m as Bi, n as ln, o as Qr, p as ta, L as Nt, R as Fa, q as qr, D as _a, s as Na, t as Ca, u as Ea, T as dn, v as Pr, w as Gt, x as Ua, y as Ht, z as Yt, F as Wt, G as wn, H as Ka, I as qe, J as kr, K as ye, M as ke, N as _e, S as _r, O as tr, Q as Fi, U as Er, V as He, W as De, Z as We, X as Re, Y as er, _ as qa, $ as Ga, a0 as Gr, a1 as Ha, a2 as un, a3 as Ui, a4 as Ki, a5 as qi, a6 as bo, a7 as pn, a8 as ea, a9 as hn, aa as Gi, ab as Hi, ac as Yi, ad as Wi, ae as gn, af as Xi, ag as ia, ah as xo, ai as sa, aj as Ji, ak as Zi, al as Qi, am as ts, an as es, ao as Tr, ap as Ya, aq as rs, ar as as } from "./resizable-U5tJboHn.js";
import { as as qh, at as Gh, au as Hh, av as Yh, aw as Wh, ax as Xh, ay as Jh, az as Zh, aA as Qh, aB as tg, aC as eg, aD as rg, aE as ag, aF as og, aG as ng, aH as ig, aI as sg, aJ as cg, aK as lg, aL as dg, aM as wg, aN as ug, aO as pg, aP as hg, aQ as gg } from "./resizable-U5tJboHn.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as or, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as os, ArrowRight as ns, ChevronDown as nr, BoldIcon as is, ItalicIcon as ss, X as Wa, AtSign as fn, Pencil as cs, Trash2 as ls, ArrowUp as mn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as vn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Cs, AlertCircle as Sa, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Rs, ScrollText as Ds, ChevronsUpDown as Os, MenuIcon as Ms, Menu as $s, EllipsisVertical as Is, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as As, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Vs, formatReplacementString as Ge, sanitizeHtml as Xa, NumberFormat as kn, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as jr, getFormatCallerFunction as Ls, deepEqual as Bs, isString as Co, compareScrRefs as Ra, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Eo, collectUsjMarkers as Us } from "platform-bible-utils";
import qt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Ks, useLayoutEffect as Qt, createContext as Ja, useContext as _n, Component as qs, createElement as To, Suspense as Gs, forwardRef as Nn, useId as zo, Fragment as Za } from "react";
import { IconSelector as Cn, IconCheck as ra, IconChevronDown as Hs, IconChevronUp as Ys, IconLayoutSidebar as Ws, IconLayoutSidebarRight as Xs, IconChevronRight as En, IconSearch as Js, IconLoader as Zs, IconAlertOctagon as Qs, IconAlertTriangle as tc, IconInfoCircle as ec, IconCircleCheck as rc } from "@tabler/icons-react";
import { createEditor as Tn, $getRoot as Oe, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as Qa, ParagraphNode as zn, TextNode as Sn, $getPreviousSelection as ac, $isRangeSelection as we, $caretFromPoint as oc, $getSiblingCaret as Rn, $getChildCaret as nc, $getAdjacentChildCaret as ic, $isChildCaret as sc, $normalizeCaret as cc, $setSelectionFromCaretRange as lc, $getCollapsedCaretRange as dc, $getCaretInDirection as So, $splitAtPointCaretNext as wc, $isTextPointCaret as uc, $findMatchingParent as Dn, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as pc, isHTMLElement as hc, CLEAR_EDITOR_COMMAND as On, COMMAND_PRIORITY_EDITOR as to, shallowMergeConfig as gc, defineExtension as re, safeCast as Xe, createState as fc, FORMAT_TEXT_COMMAND as Mn, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as In, RootNode as mc, LineBreakNode as vc, TabNode as bc, $isEditorState as xc, createCommand as yc, CLICK_COMMAND as kc, isDOMNode as _c, $getNodeFromDOMNode as Nc, $createNodeSelection as Cc, $setSelection as Ec, $getEditor as Tc, DecoratorNode as Da, $getState as zc, toggleTextFormatType as Ro, TEXT_TYPE_TO_FORMAT as Sc, $setState as Rc, addClassNamesToElement as An, $create as Dc, $getNodeByKey as Oc, removeClassNamesFromElement as Mc, KEY_TAB_COMMAND as $c, $isBlockElementNode as Ic, $createRangeSelection as Ac, $normalizeSelection__EXPERIMENTAL as Vc, OUTDENT_CONTENT_COMMAND as Pc, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as jc, COMMAND_PRIORITY_CRITICAL as eo, $isDecoratorNode as Lc, $isParagraphNode as Bc, $isTextNode as Oa, SELECTION_CHANGE_COMMAND as Vn, $insertNodes as Fc } from "lexical";
...
import { Avatar as ro, Select as Ft, Checkbox as Oo, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Mo, Slider as Or, Switch as $o } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as Ma, HIDDEN_NOTE_CALLER as $a, getDefaultViewOptions as rl, isInsertEmbedOpOfType as Mr, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
function Uu(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function wa({
  ...
  const B = pe(), [z, I] = _(!1), [A, C] = _(""), [V, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = Pt[rt].filter((At) => Ba(At, V, n));
    }), b;
  }, [Pt, V, n]), R = D(
    () => ul(V, Jt, n),
    [V, Jt, n]
                  ...
                  !R && Object.entries(fe).map(([b, G]) => {
                    if (G.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(xe, { heading: Ut(b), children: G.map((rt) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: rt,
                            onSelect: (At) => Ee(At),
...
function jo({
  ...
  const [N, O] = _(!1), B = d ?? l, z = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
    const V = l(A), K = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, y = `${C ?? ""}${V}${K ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: V,
...
function Gu({
  ...
  const w = ua(d, "%webView_bookSelector_currentBook%"), p = ua(d, "%webView_bookSelector_choose%"), g = ua(d, "%webView_bookSelector_chooseBooks%"), [h, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Gn ? Qt : H, Ir = { tag: Qa };
...
function Ol(t, e = Dl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, E = h.getNode(), k = E.getKey(), N = h.offset, O = t.getElementByKey(x), B = t.getElementByKey(k), z = r === null || O !== o || v !== n || x !== r.getKey(), I = i === null || B !== s || N !== c || k !== i.getKey();
...
function Il(t) {
  ...
  if (we(e)) r = oc(e.focus, "next");
    ...
    r = r || nc(Oe(), "previous").getFlipped().insert(zr());
  }
...
let Yr, be = 0, Wr = 0, Ll = 0, Aa = 0, Br = 0;
function Fo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
Bt.prototype.brand = Pl, Bt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Wr === 0 && e.l !== Aa && (e.l = Aa, Yr = { S: e, v: e.v, i: e.i, o: Yr });
...
function Zn(t, e = Jn) {
  return t.registerCommand(On, (r) => (t.update(e), !0), to);
}
...
class Qn extends Da {
  $config() {
    return this.config("decorator-text", { extends: Da, stateConfigs: [{ flat: !0, stateConfig: ha }] });
  }
  getFormat() {
    return zc(this, ha);
  }
...
const Va = re({ build: (t) => ti(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, Pa = 1, ri = 2, ga = 3, Ar = 4, Ze = 5, fa = 6, mr = 7;
function ma(t) {
  return t.id === so;
}
function ai(t) {
...
function ql(t) {
  return function(e) {
    return e.id === Pa;
  }(t) || lt(305, String(t.id), String(Pa)), Object.assign(t, { id: ri });
}
...
class Hl {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, l, d) {
      return Object.assign(c, { config: l, id: ga, registerState: d });
...
const Wl = re({ config: Xe({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class ar {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ma(i) || lt(300, s, n || "[unknown]"), ma(c = i) || lt(304, String(c.id), String(so)), i = Object.assign(c, { id: Pa }), o.state = i;
...
const Jl = /* @__PURE__ */ new Set(), Ho = re({ build(t, e, r) {
  const o = r.getDependency(Va).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ti(() => {
  }, () => ue(() => {
...
re({ dependencies: [Va, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ne(t.registerCommand(Zl, (s) => {
    ...
    if (_c(s.target)) {
      ...
      if (td(c)) return function(l, d = !1) {
        ...
        let h;
        d && $n(w) ? h = w : (h = Cc(), Ec(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function ed(t, e, r = oi) {
  return Ne(t.registerCommand($c, (o) => {
    const n = Xt();
    if (!we(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Pc : Do : jc;
    return t.dispatchCommand(i, void 0);
  }, to), t.registerCommand(Do, () => {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (we(f)) {
                ...
                if (Oa(v) && d >= 0 && w >= 0 && (E = d, k = d + w, f.setTextNodeRange(v, E, v, k)), E === k && p === "" || (f.insertRawText(p), v = x.getNode()), Oa(v)) {
                  E = g, k = g + h;
  ...
  return function(r, o) {
    ...
    return lo(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (g) => r._onError(g), children: a(Gs, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
...
const Sd = "verseText", Hu = Object.freeze([
...
function Yu({
  ...
  const [i, s] = _(Rd), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), g = F(null);
  H(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
...
function Zo({
  ...
  const h = L(
    ...
    [t.user]
  ), k = D(() => Xa(t.contents), [t.contents]), N = D(
...
function vi({
  ...
  const [y, J] = _(Qo), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Vt] = _(!1), [q, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(O), [Ot, Pt] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            v !== !1 && (!Tt || ee(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  uo(S) && (S.preventDefault(), S.stopPropagation(), (ee(y) || j !== void 0 && j !== T) && Ut());
                },
                onKeyDown: (S) => {
...
), Vd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => Vd(Xa(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Pd({
  ...
  const [s, c] = _("accept"), l = zo(), d = zo(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = D(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = D(
    () => Ur(t.acceptedText ?? ""),
...
function Ud(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Fd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function ap({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [O, B] = _(), [z, I] = _(), A = L(
    async ($) => {
      const W = await i($);
...
function Wd({
  ...
  var z;
  const [w, p] = _([]), [g, h] = _([]), [f, x] = _({}), [v, E] = _({}), k = D(() => e ?? [], [e]), N = jn({
    data: k,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  return l ? B = Array.from({ length: 10 }).map((C, V) => `skeleton-row-${V}`).map((C) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    I.id
  )) : B = /* @__PURE__ */ a(Re, { children: /* @__PURE__ */ a(er, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Kd, { table: N }),
    /* @__PURE__ */ u(qa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ga, { stickyHeader: i, children: N.getHeaderGroups().map((I) => /* @__PURE__ */ a(Re, { children: I.headers.map((A) => /* @__PURE__ */ a(Gr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : xr(A.column.columnDef.header, A.getContext()) }, A.id)) }, I.id)) }),
...
function lp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ye, { children: [
    ...
    /* @__PURE__ */ a(_e, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(un, { children: d.itemType === 0 ? /* @__PURE__ */ a(ct, { children: d.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        De,
        {
          checked: o[w][g],
...
function ew({
  ...
  const l = Ka(), d = en(n, "%undoButton_tooltip%"), w = en(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ua, { children: [
    /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(
        U,
      ...
      /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(ct, { children: [
          " ",
          /* @__PURE__ */ a(bo, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
      ...
      /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(ct, { children: [
          " ",
          /* @__PURE__ */ a(bo, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function rw({
  ...
  return H(() => {
    var l;
    const i = Ka(), s = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, g, h, f;
...
function ow({
  ...
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: aw(t, n, r) }) }) }),
...
function sw({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: nw(t, r) }) }) }),
      /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ a("p", { children: iw(t, r) }) })
    ] }) }),
...
function pp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [O, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Vt, q] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Ma ? st = "generated" : it === $a ? st = "hidden" : it && (N(it), B(it)), x(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var ht;
  ...
  const ut = L(
    (P, Q, et = !1) => {
      ...
      if (ot && Mr("note", ot)) {
        if (ot.insert.note) {
          let pt;
          P === "custom" ? pt = Q : P === "generated" ? pt = Ma : pt = $a, ot.insert.note.caller = pt;
        }
  ...
  const Jt = () => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      z !== "x" && P === "x" ? pt == null || pt.forEach((gt) => uw(gt)) : z === "x" && P !== "x" && (pt == null || pt.forEach((gt) => pw(gt))), (ht = w.current) == null || ht.applyUpdate([Q, { delete: 1 }]);
    }
  }, Ct = (P) => {
  ...
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: gw(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Ha, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Re,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(er, { className: o, children: vw(c.text) })
        ]
      },
...
const xw = (t) => {
  ...
  return e ? e[1] : "";
}, kw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", kp = Object.freeze([
...
function _p({
  ...
  const h = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), x = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), k = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), O = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = le(r, "%webView_inventory_no_results%"), [I, A] = _(!1), [C, V] = _("all"), [K, y] = _(""), [J, j] = _([]), Y = D(() => {
    const q = t ?? [];
    return q.length === 0 ? [] : Nw(q, n, i);
  }, [t, n, i]), T = D(() => {
    if (I) return Y;
    const q = [];
    return Y.forEach((tt) => {
  ...
  }, [I, Y]), $ = D(() => T.length === 0 ? [] : _w(T, C, K), [T, C, K]), W = D(() => {
    var wt, at;
    if (!I) return l;
...
const Cw = "16rem", Ew = "3rem", yi = qt.createContext(void 0);
function na() {
  const t = qt.useContext(yi);
  if (!t)
...
function Tw({
  ...
  const [l, d] = qt.useState(t), w = e ?? l, p = qt.useCallback(
    ...
    [r, w]
  ), g = qt.useCallback(() => p((N) => !N), [p]), h = w ? "expanded" : "collapsed", v = pe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = qt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Np({ className: t, onClick: e, ...r }) {
...
function $w({
  ...
  const c = t ? Sr.Root : "button", { state: l } = na(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    zw,
    {
      ...
      children: /* @__PURE__ */ u(Rw, { children: [
        /* @__PURE__ */ u(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(Dw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Ow, { children: /* @__PURE__ */ a(
            $w,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const ze = "scrBook", Aw = "scrRef", Ke = "source", Vw = "details", Pw = "Scripture Reference", jw = "Scripture Book", ki = "Type", Lw = "Details";
function Bw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Pp({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(qa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ga, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Re, { children: C.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(Ha, { children: E.getRowModel().rows.map((C, V) => {
        const K = pe();
        return /* @__PURE__ */ a(
          Re,
          {
...
function Lp({
  ...
  const O = St(
  ...
  ], q = (M, X, Kt = !1) => /* @__PURE__ */ u(ct, { children: [
    M,
    ...
    R((X) => X === "start" ? void 0 : X), yt.current && (yt.current = !1, requestAnimationFrame(() => {
      var Kt;
      const X = (Kt = ut.current) == null ? void 0 : Kt.querySelector("button");
      X == null || X.click();
    }));
  }, []), te = L((M) => {
    if (M) {
  ...
  ), ht = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [gt, Mt] = _(!1), [zt, Ut] = _(void 0), [$t, Pe] = _(void 0), [S, It] = _(void 0), [xt, oe] = _(void 0), [je, ur] = _([]), pr = d === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    qw,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Je = "tw:text-muted-foreground", Le = d === "dropdown" && zt === "range", b = Le ? It : P, rt = Le ? oe : h ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const go = L(
    (M) => {
      Pe(M), It(at), oe(mt), ur(n), Mt(!1), Ut(M);
    },
    [at, mt, n]
  ), fo = L(() => {
    $t !== void 0 && ($t === "range" ? (S && (g == null || g(S)), xt && (h == null || h(xt))) : $t === "selectedBooks" && i(je), et($t), Ut(void 0), Pe(void 0));
  }, [
    $t,
    S,
    xt,
    ...
    M || (Ut(void 0), Pe(void 0));
  }, []), mo = L((M) => {
    var X;
    M.preventDefault(), (X = Be.current) == null || X.focus();
  }, []), vo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }) : void 0;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      d === "dropdown" ? /* @__PURE__ */ u(ye, { open: gt, onOpenChange: Mt, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            children: /* @__PURE__ */ u(ia, { container: jt, children: [
              st.map(({ value: M, label: X, dropdownLabel: Kt, scrRefSuffix: fr, id: $i }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Te(M),
                ...
                /* @__PURE__ */ a(
                  qe,
                  {
                    ...
                    onSelect: (M) => {
                      ...
                      Jt.current || (Kt = (X = bt.current) == null ? void 0 : X.querySelector("button")) == null || Kt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
        ...
        Fa,
        {
          ...
          children: tt.map(({ value: M, label: X, scrRefSuffix: Kt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(qr, { className: "tw:me-2", value: M, id: fr }),
            /* @__PURE__ */ a(Nt, { htmlFor: fr, children: q(X, Kt) })
          ] }, fr))
        }
      )
    ] }),
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Ht, { children: [
...
function ja({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Za, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Gt, { children: Ei(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(He, {})
    ] }, l)) })
  ] });
}
const Ti = qt.forwardRef(
...
const zi = qt.forwardRef(({ className: t, ...e }, r) => {
  const o = pe();
  return /* @__PURE__ */ a(
    se.Root,
    {
...
const Si = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.List,
  {
    ref: r,
    className: m(
...
const Yw = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Trigger,
  {
    ref: r,
    ...e,
...
)), Ri = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Content,
  {
    ref: r,
    className: m(
...
const vr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        tu,
        {
          onClick: () => {
            o(d);
      ...
      d.tooltip && /* @__PURE__ */ a(Wt, { children: d.tooltip })
    ] }, `tooltip-${d.label}-${"command" in d ? d.command : d.id}`)), l = [...c];
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(eu, {}, `separator-${i}`)), l;
  });
};
function nu({
  menuData: t,
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Ww, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Xw, { children: [
      /* @__PURE__ */ a(Zw, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        Qw,
        {
          style: { zIndex: We },
          children: /* @__PURE__ */ a(Gt, { children: Di(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Zp({
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(rs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(as, { children: /* @__PURE__ */ a(Js, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { children: [
...
function eh({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function ah({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: s.map((c) => {
    let l = "upcoming";
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(Za, { children: [
...
export {
  ...
  Xu as COMMENT_LIST_STRING_KEYS,
  Hu as CONFLICT_NOTE_STRING_KEYS,
  pi as CancelAcceptButtons,
  Od as Card,
  Md as CardContent,
  tp as CardDescription,
  ep as CardFooter,
  Zu as CardHeader,
  Qu as CardTitle,
  ...
  mw as FootnoteItem,
  gp as FootnoteList,
  Jp as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  kp as INVENTORY_STRING_KEYS,
  ea as Input,
  Zp as InterfaceLanguagePicker,
  _p as Inventory,
  bo as Kbd,
  Zh as KbdGroup,
  Nt as Label,
  ...
  Ju as getCommentThreadElementId,
  ...
  Ph as useEvent,
  jh as useEventAsync,
  Bh as useExtraValidMarkers,
  Fi as useListbox,
  gu as usePromise,
  Uu as useRecentSearches,
  na as useSidebar,
  Lh as useStylesheet,
  Fh as useTabIconSelection,
  gg as useTruncationTooltip,
