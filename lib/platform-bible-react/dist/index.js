...
import c, { forwardRef as Jt, createContext as Jn, useContext as qn, useCallback as et, useState as B, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as Kn } from "react";
...
import { useReactTable as Ze, getFilteredRowModel as Er, getSortedRowModel as Qe, getPaginationRowModel as Mr, getCoreRowModel as tn, flexRender as At, getGroupedRowModel as Ir, getExpandedRowModel as Vr } from "@tanstack/react-table";
...
const ke = V.Trigger, rn = V.Group, jr = V.Portal, Fr = V.Sub, es = V.RadioGroup;
...
const Lt = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  V.Separator,
  {
    ref: n,
...
C(q, "Original", new q(rt.Original)), C(q, "Septuagint", new q(rt.Septuagint)), C(q, "Vulgate", new q(rt.Vulgate)), C(q, "English", new q(rt.English)), C(q, "RussianProtestant", new q(rt.RussianProtestant)), C(q, "RussianOrthodox", new q(rt.RussianOrthodox));
let mt = q;
function $e(t, e) {
  const n = e[0];
...
const ze = O.allBookIds.filter((t) => !O.isObsolete(O.bookIdToNumber(t))), ra = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function rs({
  ...
  const o = $(), [i, w] = B(""), [s, p] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, b] = B(!1), [S, x] = B(h), k = Z(void 0), y = Z(void 0), E = Z(void 0), j = et(
    (N) => {
      const z = a ? a() : ze;
      return {
        OT: z.filter((P) => O.isBookOT(P)),
        NT: z.filter((P) => O.isBookNT(P)),
        DC: z.filter((P) => O.isBookDC(P))
      }[N].filter((P) => {
        const G = O.bookIdToEnglishName(P).toLowerCase(), F = i.replace(/[^a-zA-Z]/g, "").toLowerCase();
  ...
  return ct(() => {
  ...
  }, [S, i]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Wt, { modal: !1, open: h, onOpenChange: Et, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Ar,
      {
        ...
        handleKeyDown: A,
        handleOnClick: () => {
          p(t.book), g(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), b(!0), w(Ot(t, "English")), k.current.focus();
        },
        onFocus: () => {
          ot.current = !0;
        },
...
const la = vt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, i) => /* @__PURE__ */ r(a ? Rt : "button", { className: l(la({ variant: e, size: n, className: t })), ref: i, ...o })
);
I.displayName = "Button";
const da = vt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), L = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(We.Root, { ref: n, className: l("pr-twp", da(), t), ...e }));
...
const hn = jt.Root, gn = jt.Trigger, Ee = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const i = $();
...
const ca = at.Portal, fn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
    className: l(
    ...
    mn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(L, { className: "tw-flex tw-items-center", children: a.map((x) => O.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
const yt = X.Root, xa = X.Group, Nt = X.Value, ft = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = $();
  return /* @__PURE__ */ d(
    X.Trigger,
    {
...
ya.displayName = X.Label.displayName;
...
Na.displayName = X.Separator.displayName;
function ka({ table: t }) {
...
function Ra({
  ...
  var x;
  const [s, p] = B([]), [u, m] = B([]), [f, g] = B({}), [h, b] = B({}), S = Ze({
    data: e,
    columns: t,
    getCoreRowModel: tn(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Qt, { stickyHeader: i, children: [
      /* @__PURE__ */ r(te, { stickyHeader: i, children: S.getHeaderGroups().map((k) => /* @__PURE__ */ r(dt, { children: k.headers.map((y) => /* @__PURE__ */ r(Ft, { children: y.isPlaceholder ? void 0 : At(y.column.columnDef.header, y.getContext()) }, y.id)) }, k.id)) }),
      /* @__PURE__ */ r(ee, { children: (x = S.getRowModel().rows) != null && x.length ? S.getRowModel().rows.map((k) => /* @__PURE__ */ r(
        dt,
        {
          onClick: () => w(k, S),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((y) => /* @__PURE__ */ r(kt, { children: At(y.column.columnDef.cell, y.getContext()) }, y.id))
        },
        k.id
    ...
    n && a && /* @__PURE__ */ r(ka, { table: S })
  ] });
}
const Yt = Jt(({ className: t, ...e }, n) => /* @__PURE__ */ r(sr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function cs({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Wt, { children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(Ta, {}) }),
...
const ne = (t) => t === "asc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(br, { className: "tw-ms-2 tw-h-4 tw-w-4" }), gs = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Oa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", vs = Object.freeze([
  ...
  return Ba(t).forEach((m) => {
    m.startsWith("\\id") && (w = Pa(m), s = 0, p = 0), m.startsWith("\\c") && (s = Ye(m), p = 0), m.startsWith("\\v") && (p = Ye(m), s === 0 && (s = e.chapterNum));
    let f = o.exec(m) ?? void 0;
    for (; f; ) {
      const g = [];
      f.forEach((x) => g.push(x));
      const h = f.index, b = i.find((x) => ye(x.items, g)), S = {
        reference: {
          book: w !== void 0 ? w : "",
...
function xs({
  ...
  const f = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), h = st(n, "%webView_inventory_unapproved%"), b = st(n, "%webView_inventory_unknown%"), S = st(n, "%webView_inventory_scope_currentBook%"), x = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_scope_verse%"), y = st(n, "%webView_inventory_filter_text%"), E = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, tt] = B(!1), [ot, Et] = B("all"), [v, _] = B(""), [K, A] = B([]), Mt = Q(() => s ? a instanceof RegExp ? Xa(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((Y) => {
  ...
  }, [j, Mt]), N = Q(() => Aa(pt, ot, v), [pt, ot, v]), z = Q(() => {
    var wt, ut;
    if (!j) return m;
  ...
  ct(() => {
    N.length === 0 ? A([]) : N.length === 1 && A(N[0].items);
  }, [N]);
  const P = (R, Y) => {
    Y.setRowSelection(() => {
      const wt = {};
...
const Oe = c.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  nn.Root,
  {
    ref: o,
    decorative: n,
...
const ja = "16rem", Fa = "3rem", Sn = c.createContext(void 0);
function ae() {
...
const Rn = c.forwardRef(
  ({
    ...
    const [u, m] = c.useState(t), f = e ?? u, g = c.useCallback(
      ...
      [n, f]
    ), h = c.useCallback(() => g((E) => !E), [g]), b = f ? "expanded" : "collapsed", k = $() === "ltr" ? w : w === "primary" ? "secondary" : "primary", y = c.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(Sn.Provider, { value: y, children: /* @__PURE__ */ r(Ae, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Ga = c.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = ae();
  return /* @__PURE__ */ d(
    I,
    {
  ...
  ({
    ...
    const p = t ? Rt : "button", { state: u } = ae(), m = /* @__PURE__ */ r(
      p,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: l(qa({ variant: n, size: a }), i),
        ...w
      }
    );
...
const Ka = c.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Rt : "button",
  {
    ref: o,
...
const Za = c.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
const eo = c.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, i) => /* @__PURE__ */ r(
  t ? Rt : "a",
  {
    ref: i,
...
const lt = "scrBook", ro = "scrRef", ht = "source", ao = "details", oo = "Scripture Reference", so = "Scripture Book", Dn = "Type", io = "Details";
function wo(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, Ue = (t) => `${lo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ns({
  sources: t,
  ...
  const [p, u] = B([]), [m, f] = B([{ id: lt, desc: !1 }]), [g, h] = B({}), b = Q(
  ...
  ct(() => {
    if (s) {
      ...
      if (_.length === 1) {
        const K = b.find((A) => Ue(A) === _[0]) || void 0;
        K && s(K);
      }
    }
  }, [g, b, s, x]);
  const k = o ?? so, y = i ?? Dn, E = [
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(xa, { children: E.map((v) => /* @__PURE__ */ r(W, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Qt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(te, { children: x.getHeaderGroups().map((v) => /* @__PURE__ */ r(dt, { children: v.headers.filter((_) => _.column.columnDef.header).map((_) => (
        ...
        /* @__PURE__ */ r(Ft, { colSpan: _.colSpan, className: "top-0 tw-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          At(_.column.columnDef.header, _.getContext())
        ] }) }, _.id)
      )) }, v.id)) }),
      /* @__PURE__ */ r(ee, { children: x.getRowModel().rows.map((v, _) => {
        ...
        return /* @__PURE__ */ r(
          dt,
          {
            ...
            className: l(ot(v, _)),
            onClick: (A) => tt(v, A),
            children: v.getVisibleCells().map((A) => {
...
function Je({
  ...
  return /* @__PURE__ */ d(Wt, { variant: i, children: [
    ...
    /* @__PURE__ */ r($t, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ d(Kn, { children: [
      /* @__PURE__ */ r(rn, { children: /* @__PURE__ */ r(Ae, { children: Pn(e.groups, e.items, s, t) }) }),
      p < u.length - 1 && /* @__PURE__ */ r(Lt, {})
    ] }, s)) })
  ] });
}
function Ts({
  ...
  return /* @__PURE__ */ d("div", { className: l("tw-border tw-px-4 tw-text-foreground", i), id: o, children: [
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-flex-nowrap tw-justify-between", children: [
      /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-flex-shrink tw-flex-row tw-justify-evenly", children: w }),
      /* @__PURE__ */ r("span", { className: "tw-flex-2 tw-flex-shrink tw-flex-row tw-justify-evenly", children: s }),
      /* @__PURE__ */ r("span", { className: "tw-flex-3 tw-flex-shrink tw-flex-row tw-justify-evenly", children: p })
    ] }),
    /* @__PURE__ */ r("div", { children: a && /* @__PURE__ */ r(
      Je,
      {
        commandHandler: e,
        menuData: a,
...
An.displayName = J.List.displayName;
...
function _s({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(On, { children: [
      /* @__PURE__ */ r(An, { children: t.map((w) => /* @__PURE__ */ r(co, { value: w.value, children: w.value }, w.key)) }),
...
const mo = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const i = nt();
  return /* @__PURE__ */ d(
    D.CheckboxItem,
    {
...
mo.displayName = D.CheckboxItem.displayName;
const ho = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = nt();
  return /* @__PURE__ */ d(
    D.RadioItem,
    {
...
ho.displayName = D.RadioItem.displayName;
const go = c.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  D.Label,
  {
    ref: a,
    className: l("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
go.displayName = D.Label.displayName;
  ...
  if (Br(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (k = p.current) == null || k.focus(), Bt(p, [g, h]);
        break;
    }
  }), ct(() => {
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(po, { children: [
      /* @__PURE__ */ r(Fn, { ref: u(m), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Ln,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Ae, { children: Un(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
), yo = c.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(xo({ variant: e }), t), ...n }));
...
const ko = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Co.displayName = Tt.Root.displayName;
...
So.displayName = Tt.Image.displayName;
...
Ro.displayName = Tt.Fallback.displayName;
const To = c.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
...
const Eo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
Vo.displayName = Pt.Root.displayName;
...
Do.displayName = pe.Root.displayName;
const Bs = J.Root, Bo = c.forwardRef(({ className: t, ...e }, n) => {
  const a = $();
  return /* @__PURE__ */ r(
    J.List,
    {
...
Bo.displayName = J.List.displayName;
...
Po.displayName = J.Trigger.displayName;
...
Oo.displayName = J.Content.displayName;
const Ps = (t, e) => {
  ct(() => {
    if (!t) return () => {
    };
...
export {
  ...
  Ns as ScriptureResultsViewer,
  ks as ScrollGroupSelector,
  Vn as SearchBar,
  yt as Select,
  bt as SelectContent,
  xa as SelectGroup,
  ...
  Oe as Separator,
  Cs as SettingsList,
  Rs as SettingsListHeader,
  Ss as SettingsListItem,
  no as SettingsSidebar,
  ys as SettingsSidebarContentSearch,
  Vo as Slider,
  Ds as Sonner,
  Yt as Spinner,
  Do as Switch,
  ...
  l as cn,
  Pa as getBookIdFromUSFM,
  Ba as getLinesFromUSFM,
