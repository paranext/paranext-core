import ps, { jsxs as de, jsx as x, Fragment as Hn } from "react/jsx-runtime";
...
import { Autocomplete as Ts, TextField as Os, FormControlLabel as Co, FormLabel as Ss, Checkbox as Cs, MenuItem as Ns, ListItemText as Ps, ListItemIcon as Pi, Menu as Rs, Grid as Ri, List as $s, IconButton as $i, Drawer as Ms, Slider as Is, Snackbar as _s, Switch as As, AppBar as Ds, Toolbar as js } from "@mui/material";
import Bs, { ThemeContext as Ls, internal_processStyles as Fs } from "@mui/styled-engine";
import * as Vs from "react-dom";
import On from "react-dom";
import * as Mi from "@radix-ui/react-label";
import zs, { SelectColumn as Us } from "react-data-grid";
import * as Me from "@radix-ui/react-tabs";
var Hs = Object.defineProperty, Ws = (e, t, n) => t in e ? Hs(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => (Ws(e, typeof t != "symbol" ? t + "" : t, n), n);
const bt = [
  "GEN",
  "EXO",
  "LEV",
...
const nl = fe.Root, rl = fe.Trigger, Uh = fe.Group, Hh = fe.Portal, Wh = fe.Sub, qh = fe.RadioGroup, ol = me.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ de(
  fe.SubTrigger,
  {
    ref: o,
    className: pe(
    ...
    children: [
      n,
      /* @__PURE__ */ x(hs, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
ol.displayName = fe.SubTrigger.displayName;
const il = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  fe.SubContent,
  {
    ref: n,
    className: pe(
...
il.displayName = fe.SubContent.displayName;
...
const al = me.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ de(
  fe.CheckboxItem,
  {
    ref: o,
    className: pe(
    ...
    ...r,
    children: [
      /* @__PURE__ */ x("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ x(fe.ItemIndicator, { children: /* @__PURE__ */ x(ms, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
al.displayName = fe.CheckboxItem.displayName;
const sl = me.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ de(
  fe.RadioItem,
  {
    ref: r,
    className: pe(
    ...
    ...n,
    children: [
      /* @__PURE__ */ x("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ x(fe.ItemIndicator, { children: /* @__PURE__ */ x(gs, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
sl.displayName = fe.RadioItem.displayName;
...
function ll({ className: e, ...t }) {
  return /* @__PURE__ */ x(
    "span",
    {
      className: pe("pr-ml-auto pr-text-xs pr-tracking-widest pr-opacity-60", e),
      ...t
    }
  );
}
ll.displayName = "DropdownMenuShortcut";
...
function pl({
  ...
  return /* @__PURE__ */ x("div", { className: pe("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: i.map((l) => /* @__PURE__ */ x(
    "div",
    {
      className: pe(
...
function dl({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
...
const rn = ce.allBookIds, fl = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ro = ["OT", "NT", "DC"], hl = 32 + 32 + 32, ml = [
  /^(\w+)$/i,
...
function Xh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ee(""), [o, i] = Ee(
    ...
    ce.bookNumberToId(e.bookNum)
  ), [u, f] = Ee(!1), [d, g] = Ee(u), v = mt(void 0), b = mt(void 0), h = mt(void 0), E = Pe(
    (C) => gl(C).filter((R) => {
    ...
    ml.forEach((C) => {
      const R = n.match(C);
      if (R) {
        const [$, j = void 0, D = void 0] = R.slice(1), M = yl($);
  ...
  }, [d]), /* @__PURE__ */ x("div", { children: /* @__PURE__ */ de(nl, { modal: !1, open: u, onOpenChange: w, children: [
        ...
        children: [
          ...
          Ro.map(
            (C, R) => E(C).length > 0 && /* @__PURE__ */ de("div", { children: [
              /* @__PURE__ */ x(Lr, { className: "pr-font-semibold pr-text-slate-700", children: fl[C] }),
...
const wl = Ni(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, i) => /* @__PURE__ */ x(r ? ks : "button", { className: pe(wl({ variant: t, size: n, className: e })), ref: i, ...o })
);
...
var Io;
function Hi() {
  return Io || (Io = 1, process.env.NODE_ENV === "production" ? Sn.exports = kl() : Sn.exports = Tl()), Sn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Cl() {
  if (Bo)
    return dr;
  Bo = 1;
  var e = Hi(), t = Ol(), n = Vr(), r = Wi(), o = Sl(), i = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var Pl = Hi(), Rl = !0;
  Tr.exports = Cl()(Pl.isElement, Rl);
} else
  Tr.exports = Nl()();
var $l = Tr.exports;
const a = /* @__PURE__ */ xl($l);
function zt(e, t) {
...
function _l(e, t, n, r, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof i == "function" && !Il(i) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Al = zt(a.elementType, _l), Dl = "exact-prop: ​";
function Yi(e) {
...
process.env.NODE_ENV === "production" ? Or.exports = jl() : Or.exports = Bl();
var An = Or.exports;
const Ll = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function Fl(e) {
  const t = `${e}`.match(Ll);
  return t && t[1] || "";
}
...
const zl = a.oneOfType([a.func, a.object]), zr = zl;
function qe(e) {
  if (typeof e != "string")
...
const ql = typeof window < "u" ? k.useLayoutEffect : k.useEffect, vt = ql;
let Uo = 0;
function Xl(e) {
...
function ec(e) {
  ...
  return !!(n === "INPUT" && Ql[t] && !e.readOnly || n === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function tc(e) {
...
function rc(e) {
  e.addEventListener("keydown", tc, !0), e.addEventListener("mousedown", hr, !0), e.addEventListener("pointerdown", hr, !0), e.addEventListener("touchstart", hr, !0), e.addEventListener("visibilitychange", nc, !0);
}
function oc(e) {
  const {
    target: t
...
function ea() {
  const e = k.useCallback((o) => {
    o != null && rc(o.ownerDocument);
  }, []), t = k.useRef(!1);
  function n() {
    return t.current ? (Cr = !0, Zl.start(100, () => {
      Cr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
}, dc = /* @__PURE__ */ k.createContext(uc);
function fc(e) {
  const {
...
const wc = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function xc(e) {
...
function kc(e) {
  return !(e.disabled || e.tagName === "INPUT" && e.type === "hidden" || Ec(e));
}
function Tc(e) {
  const t = [], n = [];
  return Array.from(e.querySelectorAll(wc)).forEach((r, o) => {
    const i = xc(r);
...
const pn = /* @__PURE__ */ k.forwardRef(function(t, n) {
  ...
  return /* @__PURE__ */ x(k.Fragment, {
    children: s && /* @__PURE__ */ Vs.createPortal(r, s)
  });
});
...
function Ac(e) {
  const {
    ...
    open: u,
    rootRef: f
  } = e, d = k.useRef({}), g = k.useRef(null), v = k.useRef(null), b = Ve(v, f), [h, E] = k.useState(!u), I = Ic(c);
  let y = !0;
...
var Re = "top", ze = "bottom", Ue = "right", $e = "left", Ur = "auto", bn = [Re, ze, Ue, $e], Dt = "start", un = "end", Dc = "clippingParents", da = "viewport", Kt = "popper", jc = "reference", Ko = /* @__PURE__ */ bn.reduce(function(e, t) {
  return e.concat([t + "-" + Dt, t + "-" + un]);
}, []), fa = /* @__PURE__ */ [].concat(bn, [Ur]).reduce(function(e, t) {
  return e.concat([t, t + "-" + Dt, t + "-" + un]);
}, []), Bc = "beforeRead", Lc = "read", Fc = "afterRead", Vc = "beforeMain", zc = "main", Uc = "afterMain", Hc = "beforeWrite", Wc = "write", qc = "afterWrite", Xc = [Bc, Lc, Fc, Vc, zc, Uc, Hc, Wc, qc];
function Xe(e) {
...
function vn(e) {
  for (var t = je(e), n = Jo(e); n && Jc(n) && et(n).position === "static"; )
    n = Jo(n);
  return n && (Xe(n) === "html" || Xe(n) === "body" && et(n).position === "static") ? t : n || Zc(e) || t;
}
function qr(e) {
...
function tp(e) {
  ...
  if (!(!i || !s)) {
    var f = ep(o.padding, n), d = Wr(i), g = c === "y" ? Re : $e, v = c === "y" ? ze : Ue, b = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], E = vn(i), I = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = b / 2 - h / 2, w = f[g], m = I - d[u] - f[v], S = I / 2 - d[u] / 2 + y, N = an(w, S, m), L = c;
...
function ei(e, t, n) {
  return t === da ? Rr(dp(e, n)) : wt(t) ? hp(t, n) : Rr(fp(lt(e)));
}
function mp(e) {
...
function gp(e, t, n, r) {
  var o = t === "clippingParents" ? mp(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], l = i.reduce(function(c, p) {
    var u = ei(e, p, r);
...
function dn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Dc : l, p = n.rootBoundary, u = p === void 0 ? da : p, f = n.elementContext, d = f === void 0 ? Kt : f, g = n.altBoundary, v = g === void 0 ? !1 : g, b = n.padding, h = b === void 0 ? 0 : b, E = ba(typeof h != "number" ? h : va(h, bn)), I = d === Kt ? jc : Kt, y = e.rects.popper, w = e.elements[v ? I : d], m = gp(wt(w) ? w : w.contextElement || lt(e.elements.popper), c, u, s), S = Bt(e.elements.reference), N = wa({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
...
function yp(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, p = n.padding, u = n.boundary, f = n.rootBoundary, d = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, b = n.allowedAutoPlacements, h = t.options.placement, E = We(h), I = E === h, y = c || (I || !v ? [$n(h)] : vp(h)), w = [h].concat(y).reduce(function(z, H) {
      return z.concat(We(H) === Ur ? bp(t, {
        placement: H,
        boundary: u,
        rootBoundary: f,
        padding: p,
...
function Pp(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, p = n.rootBoundary, u = n.altBoundary, f = n.padding, d = n.tether, g = d === void 0 ? !0 : d, v = n.tetherOffset, b = v === void 0 ? 0 : v, h = dn(t, {
    ...
    padding: f,
    altBoundary: u
  }), E = We(t.placement), I = Lt(t.placement), y = !I, w = qr(E), m = Np(w), S = t.modifiersData.popperOffsets, N = t.rects.reference, L = t.rects.popper, B = typeof b == "function" ? b(Object.assign({}, t.rects, {
    placement: t.placement
  })) : b, F = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (S) {
    if (i) {
      var $, j = w === "y" ? Re : $e, D = w === "y" ? ze : Ue, M = w === "y" ? "height" : "width", V = S[w], Q = V + h[j], Z = V - h[D], O = g ? -L[M] / 2 : 0, A = I === Dt ? N[M] : L[M], U = I === Dt ? -L[M] : -N[M], G = t.elements.arrow, z = g && G ? Wr(G) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ga(), q = H[j], X = H[D], W = an(0, N[M], z[M]), Y = y ? N[M] / 2 - O - W - q - F.mainAxis : A - W - q - F.mainAxis, K = y ? -N[M] / 2 + O + W + X + F.mainAxis : U + W + X + F.mainAxis, ne = t.elements.arrow && vn(t.elements.arrow), _ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = ($ = C == null ? void 0 : C[w]) != null ? $ : 0, P = V + Y - J - _, re = V + K - J, we = an(g ? Bn(Q, P) : Q, V, g ? gt(Z, re) : Z);
      S[w] = we, R[w] = we - V;
    }
    if (l) {
      var Se, ve = w === "x" ? Re : $e, pt = w === "x" ? ze : Ue, Ce = S[m], Ye = m === "y" ? "height" : "width", Ie = Ce + h[ve], Ke = Ce - h[pt], xe = [Re, $e].indexOf(E) !== -1, Et = (Se = C == null ? void 0 : C[m]) != null ? Se : 0, ut = xe ? Ie : Ce - N[Ye] - L[Ye] - Et + F.altAxis, Ut = xe ? Ce + N[Ye] + L[Ye] - Et - F.altAxis : Ke, En = g && xe ? Qc(ut, Ce, Ut) : an(g ? ut : Ie, Ce, g ? Ut : Ke);
      S[m] = En, R[m] = En - Ce;
    }
    t.modifiersData[r] = R;
  }
...
function _p(e, t, n) {
  n === void 0 && (n = !1);
  var r = Fe(t), o = Fe(t) && Ip(t), i = lt(t), s = Bt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Yr(i)) && (l = Mp(t)), Fe(t) ? (c = Bt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Gr(i))), {
  ...
  return function(l, c, p) {
    ...
    var u = {
      ...
      setOptions: function(E) {
        ...
        var y = Dp(Bp([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!d) {
          ...
          if (oi(I, y)) {
            u.rects = {
              reference: _p(I, vn(y), u.options.strategy === "fixed"),
              popper: Wr(y)
...
var Fp = [cp, Cp, sp, Kc, Op, wp, Rp, rp, Ep], Vp = /* @__PURE__ */ Lp({
  defaultModifiers: Fp
});
const xa = "Popper";
function zp(e) {
...
yc(xa, ["root"]);
const Up = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Hp = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Wp(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const Xp = () => nt({
  root: ["root"]
}, fc(zp)), Gp = {}, Yp = /* @__PURE__ */ k.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, h = ue(t, Up), E = k.useRef(null), I = Ve(E, n), y = k.useRef(null), w = Ve(y, d), m = k.useRef(w);
  vt(() => {
    m.current = w;
  }, [w]), k.useImperativeHandle(d, () => y.current, []);
  const S = Wp(u, s), [N, L] = k.useState(S), [B, F] = k.useState(Ln(o));
  k.useEffect(() => {
...
`));
  ...
  const R = Xp(), $ = (r = v.root) != null ? r : "div", j = yt({
    elementType: $,
  ...
  const {
    ...
    slotProps: h = {},
    slots: E = {}
  } = t, I = ue(t, Hp), [y, w] = k.useState(!0), m = () => {
    w(!1);
  }, S = () => {
    w(!0);
  };
...
const Kp = ["values", "unit", "step"], Jp = (e) => {
...
function Zp(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = ue(e, Kp), i = Jp(t), s = Object.keys(i);
  function l(d) {
...
const Qp = {
  borderRadius: 4
}, eu = Qp, tu = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.string, a.object, a.array]) : {}, ct = tu;
function ln(e, t) {
  return t ? Ze(e, t, {
    clone: !1
...
const iu = {
  ...
  if (e.length > 2)
    if (ai[e])
      ...
      return [e];
  const [t, n] = e.split(""), r = iu[t], o = au[n] || "";
  return Array.isArray(o) ? o.map((i) => r + i) : [r + o];
}), Yn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Kn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], lu = [...Yn, ...Kn];
function yn(e, t, n, r) {
  var o;
...
function Ta(e, t) {
  const n = ka(e.theme);
  return Object.keys(e).map((r) => pu(e, t, r, n)).reduce(ln, {});
}
function ge(e) {
  return Ta(e, Yn);
}
...
be.filterProps = Kn;
process.env.NODE_ENV !== "production" && lu.reduce((e, t) => (e[t] = ct, e), {});
function uu(e = 8) {
  if (e.mui)
    return e;
  const t = ka({
...
const du = He("border", Le), fu = He("borderTop", Le), hu = He("borderRight", Le), mu = He("borderBottom", Le), gu = He("borderLeft", Le), bu = He("borderColor"), vu = He("borderTopColor"), yu = He("borderRightColor"), wu = He("borderBottomColor"), xu = He("borderLeftColor"), Eu = He("outline", Le), ku = He("outlineColor"), Zn = (e) => {
...
Jn(du, fu, hu, mu, gu, bu, vu, yu, wu, xu, Zn, Eu, ku);
const Qn = (e) => {
...
Jn(Qn, er, tr, Tu, Ou, Su, Cu, Nu, Pu, Ru, $u, Mu);
function It(e, t) {
  return t === "grey" ? t : e;
}
const Iu = ye({
...
function Wu() {
  ...
  function t(n) {
    ...
    function l(c) {
      ...
      if (!p)
        return null;
      const u = nu(i.breakpoints), f = Object.keys(u);
      let d = u;
...
function eo(e = {}, ...t) {
  ...
  return p.applyStyles = qu, p = t.reduce((u, f) => Ze(u, f), p), p.unstable_sxConfig = T({}, Zr, s == null ? void 0 : s.unstable_sxConfig), p.unstable_sx = function(f) {
    return Qr({
      sx: f,
      theme: this
    });
...
const Ku = ["ownerState"], Ju = ["variants"], Zu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Qu(e) {
  return Object.keys(e).length === 0;
}
function ed(e) {
...
const td = eo(), si = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Nn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function rd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    Fs(s, (m) => m.filter((S) => !(S != null && S.__mui_systemSx)));
    const {
      name: c,
      slot: p,
      ...
      overridesResolver: d = nd(si(p))
    } = l, g = ue(l, Zu), v = u !== void 0 ? u : (
    ...
    let E = Mn;
    p === "Root" || p === "root" ? E = r : p ? E = o : ed(s) && (E = void 0);
    const I = Bs(s, T({
      shouldForwardProp: E,
      label: h
    }, g)), y = (m) => typeof m == "function" && m.__emotion_real !== m || ht(m) ? (S) => In(m, T({}, S, {
      theme: Nn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let C;
        c && (C = `${c}${qe(p || "")}`), C === void 0 && (C = `Styled(${Vl(s)})`), F.displayName = C;
      }
...
const ud = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Nt = yd, wd = ["mode", "contrastThreshold", "tonalOffset"], pi = {
...
function ui(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = cd(e.main, o) : t === "dark" && (e.dark = ld(e.main, i)));
}
function xd(e = "light") {
  return e === "dark" ? {
    main: St[200],
...
function Cd(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ue(e, wd), i = e.primary || xd(t), s = e.secondary || Ed(t), l = e.error || kd(t), c = e.info || Td(t), p = e.success || Od(t), u = e.warning || Sd(t);
  function f(b) {
...
const Nd = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function Pd(e) {
...
const $d = 0.2, Md = 0.14, Id = 0.12;
function he(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${$d})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Md})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Id})`].join(",");
}
const _d = ["none", he(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), he(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), he(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), he(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), he(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), he(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), he(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), he(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), he(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), he(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), he(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), he(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), he(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), he(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), he(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), he(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), he(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), he(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), he(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), he(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), he(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), he(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), he(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), he(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Ad = _d, Dd = ["duration", "easing", "delay"], jd = {
...
function Fd(e) {
  const t = T({}, jd, e.easing), n = T({}, Bd, e.duration);
  return T({
...
const Vd = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, zd = Vd, Ud = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Hd(e = {}, ...t) {
  const {
    mixins: n = {},
    palette: r = {},
...
const Wd = Hd(), no = Wd, ro = "$$material", Na = (e) => Mn(e) && e !== "classes", qd = rd({
  themeId: ro,
  defaultTheme: no,
...
const Jd = {
  ...
  } = t, E = ue(t, Kd), I = en(), y = k.useRef(), w = xn(), m = k.useRef(null), S = Ve(m, i.ref, n), N = (D) => (M) => {
    if (D) {
      const V = m.current;
      M === void 0 ? D(V) : D(V, M);
    }
...
const _r = oo, Zd = (e) => {
...
}, gi = Zd, Qd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], ef = Oe(Ea, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = Sa(), i = rt({
    ...
    slots: y,
    slotProps: w
  } = i, m = ue(i, Qd), S = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, N = T({
    anchorEl: s,
    container: u,
    disablePortal: f,
    keepMounted: d,
...
const nf = st("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), at = nf, rf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function of(e) {
  return Math.round(e * 1e5) / 1e5;
}
const af = (e) => {
...
const _a = /* @__PURE__ */ k.forwardRef(function(t, n) {
  ...
  const S = rt({
    ...
    TransitionProps: J
  } = S, P = ue(S, rf), re = /* @__PURE__ */ k.isValidElement(L) ? L : /* @__PURE__ */ x("span", {
    children: L
...
`));
  const is = k.useMemo(() => {
    ...
    touch: Ie.current
  }), sr = af(Xt), yo = (r = (o = K.popper) != null ? o : B.Popper) != null ? r : sf, wo = (i = (s = (l = K.transition) != null ? l : B.Transition) != null ? s : _) != null ? i : _r, xo = (c = (p = K.tooltip) != null ? p : B.Tooltip) != null ? c : lf, Eo = (u = (f = K.arrow) != null ? f : B.Arrow) != null ? u : cf, as = tn(yo, T({}, W, (d = Y.popper) != null ? d : F.popper, {
    className: ke(sr.popper, W == null ? void 0 : W.className, (g = (v = Y.popper) != null ? v : F.popper) == null ? void 0 : g.className)
  }), Xt), ss = tn(wo, T({}, J, (b = Y.transition) != null ? b : F.transition), Xt), ls = tn(xo, T({}, (h = Y.tooltip) != null ? h : F.tooltip, {
  ...
  return /* @__PURE__ */ de(k.Fragment, {
    children: [/* @__PURE__ */ k.cloneElement(re, Be), /* @__PURE__ */ x(yo, T({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ de(xo, T({}, ls, {
          children: [ne, N ? /* @__PURE__ */ x(Eo, T({}, cs, {
            ref: Ye
          })) : null]
        }))
      }))
...
const ff = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], hf = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  const r = rt({
    ...
    titleAccess: f,
    viewBox: d = "0 0 24 24"
  } = r, g = ue(r, ff), v = /* @__PURE__ */ k.isValidElement(o) && o.type === "svg", b = T({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
`)), aa.configure(e);
  ...
  createSvgIcon: Da,
  debounce: Ji,
  deprecatedPropType: Ul,
  isMuiElement: Hl,
  ownerDocument: Te,
  ownerWindow: At,
  requirePropFactory: Wl,
  setRef: Dn,
...
}, Symbol.toStringTag, { value: "Module" })), vf = /* @__PURE__ */ El(bf);
var yi;
function yf() {
...
var ja = io.default = void 0, xf = wf(yf()), Ef = ps;
ja = io.default = (0, xf.default)(/* @__PURE__ */ (0, Ef.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function wi(e, t, n) {
  ...
  const {
    ...
    Ns,
    {
      ...
      children: n ? /* @__PURE__ */ de(Hn, { children: [
        wi(i, n, !0),
        /* @__PURE__ */ x(Ps, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ x(Pi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ x(ja, {}) }) : wi(s, n, !1)
      ] }) : h
    }
  );
  return r ? /* @__PURE__ */ x(pf, { title: r, placement: "right", children: /* @__PURE__ */ x("div", { children: E }) }) : E;
}
function La(e) {
...
function kf(e) {
  ...
  return /* @__PURE__ */ de(Hn, { children: [
    /* @__PURE__ */ x(Ba, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ x(
      Rs,
      {
        anchorEl: t,
  ...
  return /* @__PURE__ */ de(
    Ri,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ x($s, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ x(
          Of,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Rf = ["children", "className", "component", "dense", "disablePadding", "subheader"], $f = (e) => {
  const {
    classes: t,
    disablePadding: n,
    dense: r,
  ...
  return /* @__PURE__ */ x(Nf.Provider, {
    value: f,
    children: /* @__PURE__ */ de(Mf, T({
      as: s,
...
const If = Va, _f = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function yr(e, t, n) {
...
const Ua = /* @__PURE__ */ k.forwardRef(function(t, n) {
  ...
  } = t, d = ue(t, _f), g = k.useRef(null), v = k.useRef({
    keys: [],
    repeating: !0,
...
const Af = Ua, Df = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], jf = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  } = t, y = ue(t, Df), w = k.useRef(null), m = Ve(w, l.ref, n), S = (j) => (D) => {
    if (j) {
      const M = w.current;
      D === void 0 ? j(M) : j(M, D);
    }
...
const Ff = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Vf = (e) => {
  const {
    classes: t,
    invisible: n
  } = e;
  ...
  const s = rt({
    ...
    slotProps: v = {},
    slots: b = {},
    TransitionComponent: h = Bf,
    transitionDuration: E
  } = s, I = ue(s, Ff), y = T({}, s, {
    component: p,
    invisible: d
  }), w = Vf(y), m = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ x(h, T({
    in: g,
    timeout: E
  }, I, {
    children: /* @__PURE__ */ x(zf, T({
      "aria-hidden": !0
    }, m, {
...
const Wf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], qf = (e) => {
  const {
    open: t,
    exited: n,
    classes: r
  ...
  const X = (r = (o = j == null ? void 0 : j.root) != null ? o : E.Root) != null ? r : Xf, W = (i = (s = j == null ? void 0 : j.backdrop) != null ? s : E.Backdrop) != null ? i : u, Y = (l = $ == null ? void 0 : $.root) != null ? l : I.root, K = (c = $ == null ? void 0 : $.backdrop) != null ? c : I.backdrop, ne = yt({
    elementType: X,
    externalSlotProps: Y,
...
const Jf = ["className", "component", "elevation", "square", "variant"], Zf = (e) => {
  const {
    square: t,
    elevation: n,
    variant: r,
...
const nh = ["onEntering"], rh = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], oh = ["slotProps"];
function Ei(e, t) {
  let n = 0;
...
const ih = (e) => {
  ...
  } = s, F = ue(s.TransitionProps, nh), C = ue(s, rh), R = (r = w == null ? void 0 : w.paper) != null ? r : I, $ = k.useRef(), j = Ve($, R.ref), D = T({}, s, {
    anchorOrigin: p,
    anchorReference: f,
    elevation: b,
    marginThreshold: h,
...
`)), h !== null && ve < h) {
  ...
  const q = v || (c ? Te(_n(c)).body : void 0), X = (o = y == null ? void 0 : y.root) != null ? o : ah, W = (i = y == null ? void 0 : y.paper) != null ? i : Ga, Y = yt({
    elementType: W,
...
const ch = ["onEntering"], ph = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], uh = {
  vertical: "top",
  horizontal: "right"
}, dh = {
  vertical: "top",
  ...
  const i = rt({
    ...
    slots: I = {},
    slotProps: y = {}
  } = i, w = ue(i.TransitionProps, ch), m = ue(i, ph), S = xn(), N = S.direction === "rtl", L = T({}, i, {
    autoFocus: s,
    ...
    TransitionProps: w,
    variant: E
  }), B = fh(L), F = s && !p && d, C = k.useRef(null), R = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || j === -1) && (j = O));
  ...
  const D = (r = I.paper) != null ? r : mh, M = (o = y.paper) != null ? o : g, V = yt({
    elementType: I.root,
  ...
  return /* @__PURE__ */ x(hh, T({
    onClose: f,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: N ? "right" : "left"
    },
    transformOrigin: N ? uh : dh,
    slots: {
      paper: D,
      root: I.root
    },
...
), Ja = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(Mi.Root, { ref: n, className: pe(xh(), e), ...t }));
...
function Un({
  ...
  return /* @__PURE__ */ de("div", { className: pe("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": r }), children: [
    /* @__PURE__ */ x(
      Ja,
      {
        htmlFor: e,
    ...
    /* @__PURE__ */ x(
      Fr,
      {
        ...
        placeholder: s,
        required: l,
        className: pe(c, { "pr-border-red-600": n }),
        defaultValue: p,
        value: u,
        onChange: f,
        onFocus: d,
    ...
    /* @__PURE__ */ x("p", { className: pe({ "pr-hidden": !o }), children: o })
  ] });
}
let wr;
...
function Zh({ scrRef: e, handleSubmit: t, id: n }) {
  const r = (c) => {
    t(c);
  }, o = (c, p) => {
  ...
  return /* @__PURE__ */ de("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    ...
    /* @__PURE__ */ x(kt, { onClick: () => t(So(e, 1)), children: ">" })
  ] });
}
...
const Eh = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ x(
  Ui,
  {
    ...r,
    isChecked: n,
...
function om({
  ...
  const i = mt(void 0);
  return /* @__PURE__ */ x("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ x(Ds, { position: "static", id: r, children: /* @__PURE__ */ de(js, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ x(
      wh,
      {
        commandHandler: t,
...
}, sm = Me.Root, kh = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.List,
  {
    ref: n,
    className: pe(
...
kh.displayName = Me.List.displayName;
...
Th.displayName = Me.Trigger.displayName;
...
Oh.displayName = Me.Content.displayName;
const Sh = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Root,
  {
    orientation: "vertical",
    ref: n,
    className: pe("pr-flex pr-gap-1 pr-rounded-md pr-text-muted-foreground", e),
    ...t
  }
));
Sh.displayName = Me.List.displayName;
const Ch = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.List,
  {
    ref: n,
    className: pe(
...
const lm = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Trigger,
  {
    ref: n,
    ...t,
...
)), Nh = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Content,
  {
    ref: n,
    className: pe(
...
export {
  ...
  kt as Button,
  Gh as ChapterRangeSelector,
  Ui as Checkbox,
  Yh as Checklist,
  kr as ComboBox,
  Kh as ContextMenu,
  nl as DropdownMenu,
  al as DropdownMenuCheckboxItem,
  ...
  om as Toolbar,
  Sh as VerticalTabs,
  Nh as VerticalTabsContent,
  Ch as VerticalTabsList,
  lm as VerticalTabsTrigger,
  im as useEvent,
  am as useEventAsync,
  Ar as usePromise
};
