...
var fs = (t, e, n) => e in t ? ms(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var yt = (t, e, n) => fs(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as sn, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as Y, Component as hs, createElement as jr, Suspense as gs, Fragment as go } from "react";
import { Command as Ct } from "cmdk";
import { X as je, Search as bo, Check as jt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Jn, ChevronRight as Ie, ArrowLeft as bs, ArrowRight as vs, Circle as Tn, ChevronDown as ze, BoldIcon as xs, ItalicIcon as ys, AtSign as vo, Pencil as Ns, Trash2 as ks, ArrowUp as xo, MoreHorizontal as _s, MailOpen as Cs, Mail as Es, ChevronUp as yo, FilterIcon as Ts, ArrowLeftIcon as Rs, ChevronLeftIcon as Ss, ChevronRightIcon as Ds, ArrowRightIcon as Ms, Copy as No, Filter as Is, User as Os, Link as As, CircleHelp as Ps, ChevronsUpDown as ko, Star as $s, Undo as Ls, Redo as Vs, SquareX as _o, FunctionSquare as Co, SquareSigma as Eo, Ban as js, AlertCircle as Zn, CircleCheckIcon as zs, CircleXIcon as Fs, CircleHelpIcon as Bs, ArrowUpIcon as Ks, ArrowDownIcon as Gs, PanelLeft as Us, PanelRight as qs, ScrollText as Hs, MenuIcon as Ys, Menu as Xs, EllipsisVertical as Ws, MoreVertical as Kr, LoaderCircle as Js, GripVertical as Zs } from "lucide-react";
...
import { includes as dn, Section as X, getChaptersForBook as ei, formatScrRef as xe, getSectionForBook as Je, formatRelativeDate as ni, formatReplacementString as ve, sanitizeHtml as ri, NumberFormat as oi, formatBytes as ai, getCurrentLocale as si, usfmMarkers as hn, getFormatCallerFunction as ii, deepEqual as li, isString as Gr, compareScrRefs as Qn, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as Ro, $getRoot as ce, $createParagraphNode as Rn, $getSelection as Vt, HISTORY_MERGE_TAG as br, ParagraphNode as So, TextNode as Do, $isTokenOrSegmented as wi, $getCharacterOffsets as ci, $cloneWithPropertiesEphemeral as di, $findMatchingParent as Mo, $isElementNode as le, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as Io, COMMAND_PRIORITY_EDITOR as Oo, mergeRegister as de, shallowMergeConfig as pi, defineExtension as qt, safeCast as ln, createState as ui, FORMAT_TEXT_COMMAND as Ao, $isNodeSelection as Po, COMMAND_PRIORITY_LOW as $o, RootNode as mi, LineBreakNode as fi, TabNode as hi, $isEditorState as gi, createCommand as bi, CLICK_COMMAND as vi, isDOMNode as xi, $getNodeFromDOMNode as yi, $createNodeSelection as Ni, $setSelection as ki, DecoratorNode as tr, $getState as _i, toggleTextFormatType as Ur, TEXT_TYPE_TO_FORMAT as Ci, $setState as Ei, addClassNamesToElement as Lo, $create as Ti, $getNodeByKey as Ri, removeClassNamesFromElement as Si, KEY_TAB_COMMAND as Di, $isBlockElementNode as vn, $createRangeSelection as Mi, $normalizeSelection__EXPERIMENTAL as Ii, OUTDENT_CONTENT_COMMAND as Oi, INDENT_CONTENT_COMMAND as qr, INSERT_TAB_COMMAND as Ai, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Pi, $isParagraphNode as $i, $isTextNode as xn, SELECTION_CHANGE_COMMAND as Vo, getRegisteredNode as Li, isHTMLElement as Vi, isDocumentFragment as Hr, isDOMDocumentNode as ji, ArtificialNode__DO_NOT_USE as jo, $createLineBreakNode as zo, $isRootOrShadowRoot as zi, isBlockDomNode as Yr, isInlineDomNode as Xr, $insertNodes as Fi } from "lexical";
...
import { useReactTable as Go, getFilteredRowModel as Wi, getSortedRowModel as Uo, getPaginationRowModel as Ji, getCoreRowModel as qo, flexRender as Ze, getGroupedRowModel as Zi, getExpandedRowModel as Qi } from "@tanstack/react-table";
...
const il = Mt.Root, gp = Mt.Trigger, ll = Mt.Portal, bp = Mt.Close, Ho = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
    className: f(
...
cl.displayName = Mt.Description.displayName;
...
Ke.displayName = Ct.Input.displayName;
...
re.displayName = Ct.List.displayName;
const wn = b.forwardRef((t, e) => /* @__PURE__ */ r(Ct.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
wn.displayName = Ct.Empty.displayName;
...
yr.displayName = Ct.Separator.displayName;
...
const ta = sn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Fe : "button", { className: f(ea({ variant: e, size: n, className: t })), ref: s, ...a })
);
z.displayName = "Button";
const Ge = 250, na = 300, pl = 400, vp = 450, xp = 500, oe = Oe.Root, fe = Oe.Trigger, ul = Oe.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = mt();
...
function ml({
  ...
  return /* @__PURE__ */ p(oe, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(Ut, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      Ht,
      {
        onSelect: () => h(u),
...
function Np({
  ...
  const c = mt(), [d, m] = S(!1), [h, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, F] = S(!1), j = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
    ...
    const { isLetter: _, isDigit: L } = Wr(D.key);
    (_ || L) && (D.preventDefault(), x((U) => U + D.key), A.current.focus(), F(!1));
  }, []);
  return At(() => {
    const D = setTimeout(() => {
      if (d && v === "books" && M.current && E.current) {
  ...
  }, [v, N, I, t.book, t.chapterNum]), /* @__PURE__ */ p(oe, { open: d, onOpenChange: G, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      z,
      {
          ...
          v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ r(bs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(vs, { className: "tw-h-4 tw-w-4" })
              }
            ),
...
function ir({
  ...
  const [k, C] = S(!1), F = c ?? w, j = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], A = (M, E) => {
    const R = w(M), V = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, $ = `${E ?? ""}${R}${V ?? ""}`;
    return /* @__PURE__ */ p(
      Ht,
      {
        value: R,
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          ...
          /* @__PURE__ */ r(re, { children: j(e) ? e.map((M) => /* @__PURE__ */ r(Ut, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
function Cp({
  ...
  const d = jn(c, "%webView_bookSelector_currentBook%"), m = jn(c, "%webView_bookSelector_choose%"), h = jn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
function kl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = yl(null, o), d = Ro({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, h) {
      if (h !== null) {
...
const Cr = {
  ...
  mark: "",
  markOverlap: ""
}, kt = _e.Provider, St = _e.Root, Dt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  _e.Trigger,
  {
    ref: o,
...
Dt.displayName = _e.Trigger.displayName;
...
function Ol(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !wi(e) && o !== null) {
    ...
    if (c || d) {
      const [m, h] = ci(t), u = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let v, y = 0;
      u ? (y = m > h ? h : m, v = m > h ? m : h) : g ? (y = i ? h : m, v = void 0) : x && (y = 0, v = i ? m : h);
      const N = e.__text.slice(y, v);
      N !== e.__text && (n === "clone" && (e = di(e)), e.__text = N);
    }
  }
  return e;
}
...
function Ll(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Mo(s, (c) => le(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function Fl(t) {
  ...
  ia(this), Z = t, this.f &= -2, 8 & this.f && Tr(this), Dn();
}
function De(t, e) {
...
Nt.prototype.brand = Vl, Nt.prototype.h = function() {
  ...
  if (this.g = gn, this.f |= 1, this.i > 0 && !sa(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    to(this), Z = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, la(this), to(this), we++;
  const t = Z;
...
function wa() {
  const t = ce(), e = Vt(), n = Rn();
  t.clear(), t.append(n), e !== null && n.select(), ke(e) && (e.format = 0);
}
function ca(t, e = wa) {
  return t.registerCommand(Io, (n) => (t.update(e), !0), Oo);
}
qt({ build: (t, e, n) => Mn(e), config: ln({ $onClear: wa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return pe(() => ca(t, o.value));
} });
function Bl(t) {
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [da], register: (t, e, n) => t.registerCommand(Ao, (o) => {
  const a = Vt();
  if (Po(a) || ke(a)) for (const s of a.getNodes()) Kl(s) && s.toggleFormat(o);
  return !1;
}, $o) });
function pa(t, e) {
  let n;
...
const cr = qt({ build: (t) => pa(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Rr = 0, dr = 1, ma = 2, Bn = 3, mn = 4, Se = 5, Kn = 6, Ye = 7;
function Gn(t) {
  return t.id === Rr;
}
function fa(t) {
...
function Gl(t) {
  return function(e) {
    return e.id === dr;
  }(t) || et(305, String(t.id), String(dr)), Object.assign(t, { id: ma });
}
...
}, name: "@lexical/extension/InitialState", nodes: [mi, Do, fi, hi, So] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function Xl(t) {
  throw t;
...
class tn {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Ro({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [no]: this });
...
const Wl = /* @__PURE__ */ new Set(), oo = qt({ build(t, e, n) {
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = pa(() => {
  }, () => pe(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let w, c = !1;
    o.value.read(() => {
      if (Vt()) for (const [d, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(d);
          continue;
        }
        const h = Ri(d), u = h && h.isSelected() || !1;
        c = c || u !== (!!i && i.has(d)), u && (w = w || /* @__PURE__ */ new Set(), w.add(d));
      }
    }), !c && w && i && w.size === i.size || (s.value = w);
  }));
  return { watchNodeKey: function(i) {
    const l = zl(() => (s.value || Wl).has(i)), { watchedNodeKeys: w } = a.peek();
    let c = w.get(i);
    const d = c !== void 0;
...
qt({ dependencies: [cr, oo], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(oo).output, a = rn({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return de(t.registerCommand(vi, (i) => {
    if (xi(i.target)) {
      const l = yi(i.target);
      if (Zl(l)) return function(w, c = !1) {
        const d = Vt(), m = w.isSelected(), h = w.getKey();
        let u;
        c && Po(d) ? u = d : (u = Ni(), ki(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, $o), t.registerMutationListener(Ae, (i, l) => {
    jl(() => {
      let w = !1;
      ...
      for (const [d, m] of i.entries()) if (m === "destroyed") c.delete(d), w = !0;
        ...
        h ? h.domNode.value = u : (w = !0, c.set(d, { domNode: rn(u), selectedSignal: o(d) }));
      }
...
function Ql(t, e, n = ga) {
  return de(t.registerCommand(Di, (o) => {
    const a = Vt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => vn(h) && h.canIndent()).length > 0) return !0;
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), m = $l(d);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Mi();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Ii(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Oi : qr : Ai;
...
qt({ build: (t, e, n) => Mn(e), config: ln({ $canIndent: ga, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  ...
  return pe(() => {
    if (!o.value) return Ql(t, a, s);
  });
} });
const tw = qt({ name: "@lexical/react/ReactProvider" });
function ew() {
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (xn(v) && c >= 0 && d >= 0 && (y = c, N = c + d, g.setTextNodeRange(v, y, v, N)), y === N && m === "" || (g.insertRawText(m), v = x.getNode()), xn(v)) {
                  y = h, N = h + u;
  ...
  return function(n, o) {
    ...
    return Sr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (h) => n._onError(h), children: r(gs, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(Hi(d, m, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function sw({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(tw.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && ow(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(aw, { editor: t, ErrorBoundary: e });
}
function ao(t) {
  return t.getEditorState().read(ba(t.isComposing()));
}
function iw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Xt();
  return function(a) {
    Sr(() => de(Ui(a), va(a)), [a]);
  }(o), p(lt, { children: [t, r(lw, { content: e }), r(sw, { editor: o, ErrorBoundary: n })] });
}
...
const cw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function dw({ onClear: t }) {
  const [e] = Xt();
  return cw(() => ca(e, t), [e, t]), null;
}
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function pw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: d, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: k, "data-testid": C, ...F }, j) {
...
function fw(t, e) {
  ...
  return p(lt, { children: [r(uw, { editor: a, ...o, ref: e }), n != null && r(hw, { editor: a, content: n })] });
}
...
function vw() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(il, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Yo, { children: [
...
function xw({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = vw(), w = () => {
  };
...
Nw.displayName = Fo.Root.displayName;
const _a = b.createContext({
  size: "default",
  variant: "default"
}), Dr = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = mt();
  return /* @__PURE__ */ r(
    Sn.Root,
    {
...
const en = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
...
function kw() {
  ...
  return yw(o), /* @__PURE__ */ r(
    Dr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: io.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        en,
        {
          value: a,
          "aria-label": i,
...
function Cw({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(xw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(kw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        iw,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(gw, { placeholder: t }) }),
          ErrorBoundary: Sl
        }
      ),
      e && /* @__PURE__ */ r(ww, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(_w, { onClear: n }),
      /* @__PURE__ */ r(dw, {})
    ] })
  ] });
}
...
function Ca(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && xn(e) && (i = Ol(o, e, "clone"));
  const l = le(i) ? i.getChildren() : [], w = Li(t, i.getType());
  let c;
  ...
  if (a && !s) {
    if ((Vi(d) || Hr(d)) && d.append(h), n.append(d), m) {
      const u = m.call(i, d);
      u && (Hr(d) ? d.replaceChildren(u) : d.replaceWith(u));
    }
  } else n.append(h);
  return a;
}
const Ea = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Ta(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (Ea.has(t.nodeName)) return i;
  let l = null;
  ...
  return d != null && (h = d(h)), Yr(t) && (h = Sw(t, h, u ? () => {
    const g = new jo();
    return n.push(g), g;
  } : Rn)), l == null ? h.length > 0 ? i = i.concat(h) : Yr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Xr(g.nextSibling) && Xr(g.previousSibling);
  }(t) && (i = i.concat(zo())) : le(l) && l.append(...h), i;
}
function Sw(t, e, n) {
...
function Dw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = Tw(e, a);
      ce().clear(), Fi(s);
    },
    {
      discrete: !0
...
function Ep({
  ...
  const [a, s] = S(Mw), [i, l] = S(void 0), [w, c] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
          /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(z, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
...
const Tp = Object.freeze([
...
], Iw = ["input", "select", "textarea", "button"], Ow = ["button", "textbox"], Aw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
  ...
  const a = H(null), [s, i] = S(void 0), [l, w] = S(void 0), c = K(
    ...
    if (u.isContentEditable || Iw.includes(g)) return !0;
    const x = u.getAttribute("role");
    if (x && Ow.includes(x)) return !0;
    const v = u.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = K(
    (u) => {
      var A;
      const g = u.target, x = (M) => M ? document.getElementById(M) : void 0, v = x(l), y = x(s);
      ...
      switch (u.key) {
        case "ArrowDown":
          F = Math.min(C + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          F = Math.max(C - 1, 0), u.preventDefault();
          break;
        case "Home":
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", Pw({ variant: e }), t), ...n })
);
...
const Vw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
zw.displayName = Be.Image.displayName;
...
}), Ce = nt.Trigger, Aa = nt.Group, Fw = nt.Portal, Bw = nt.Sub, Kw = nt.RadioGroup;
...
Gw.displayName = "DropdownMenuShortcut";
function lo({
  comment: t,
  isReply: e = !1,
  localizedStrings: n,
  ...
  const u = K(
    ...
    [t.user]
  ), N = B(() => ri(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          _n,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), m(Dw(t.contents)), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(_s, {}) }) }),
...
function Uw({
  ...
  const [A, M] = S(wo), [E, R] = S(
    void 0
  ), V = o, [$, O] = S(!1), [P, W] = S(!1), [I, J] = S(!1), [Tt, Pt] = S(!1), [It, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Jt = B(() => Bt[0], [Bt]), Re = H(null), se = H(void 0), Zt = K(() => {
    var T;
    (T = se.current) == null || T.call(se), M(wo);
  }, []), He = K(() => {
    const T = !pt;
  ...
  }, [s, n]), L = B(() => Bt.slice(1), [Bt]), U = B(() => L.length ?? 0, [L.length]), q = B(() => U > 0, [U]), it = B(() => $ || U <= 2 ? L : L.slice(-2), [L, U, $]), tt = B(() => $ || U <= 2 ? 0 : U - 2, [U, $]), bt = B(
  ...
  const Rt = K(
    async (T) => {
      ...
      vt && await m({ threadId: w, contents: vt }) && Zt();
    },
    [
      Zt,
      A,
          ...
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                children: pt ? /* @__PURE__ */ r(Cs, {}) : /* @__PURE__ */ r(Es, {})
              }
            ),
          ...
          o && /* @__PURE__ */ p(lt, { children: [
            ...
            v !== !1 && (!P || Lt(A)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Ir(T) && (T.preventDefault(), T.stopPropagation(), (Lt(A) || E !== void 0) && Rt());
                },
                onKeyDown: (T) => {
                    ...
                    /* @__PURE__ */ p(oe, { open: I, onOpenChange: J, children: [
                      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
                        z,
                        {
                          ...
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !Tt || !x || x.length === 0 || !x.includes(i),
...
function Sp({
  ...
  const F = n.filter(
    ...
    [y, x]
  ), { listboxRef: E, activeId: R, handleKeyDown: V } = Aw({
    options: j,
    onOptionSelect: A
  }), $ = K(
    (O) => {
...
function qw({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Xi, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Ts, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Le = dt.Root, Hw = dt.Group, Ve = dt.Value, Yw = me(
  ...
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      className: f(Yw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
Va.displayName = dt.ScrollUpButton.displayName;
...
Xw.displayName = dt.Label.displayName;
...
Ww.displayName = dt.Separator.displayName;
function Jw({ table: t }) {
...
function on(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Zw(o)
  );
}
  ...
  const l = b.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), nc(u, g, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), ec(l, x, d.key);
...
function oc({
  ...
  var j;
  const [d, m] = S([]), [h, u] = S([]), [g, x] = S({}), [v, y] = S({}), N = B(() => e ?? [], [e]), k = Go({
    data: N,
    columns: t,
    getCoreRowModel: qo(),
  ...
  let F;
  return w ? F = Array.from({ length: 10 }).map((E, R) => `skeleton-row-${R}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? F = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    Qt,
    {
      onClick: () => i(A, k),
    ...
    A.id
  )) : F = /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(qw, { table: k }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(No, {}) })
        ] }),
...
function Ip({
  ...
  return /* @__PURE__ */ p(oe, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(Yt, { id: s, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
var ic = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(ic || {});
function Op({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "default", children: [
      /* @__PURE__ */ r(Is, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Aa, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][h],
        ...
        Kw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(La, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, c.label)) })
...
function lc({ id: t, versionHistory: e }) {
...
function Pp({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(lc, { versionHistory: a }),
...
function wc({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ p(oe, { open: M, onOpenChange: d ?? N, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
      z,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ne, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: j, children: s }),
        /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: A, children: i })
      ] }),
      /* @__PURE__ */ p(re, { children: [
        /* @__PURE__ */ r(wn, { children: l }),
        /* @__PURE__ */ r(Ut, { children: F.map((R) => /* @__PURE__ */ p(
          Ht,
          {
            value: R.label,
            onSelect: k,
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ r($s, { className: "tw-h-4 tw-w-4" }),
...
function dc({
  ...
  return /* @__PURE__ */ p(lt, { children: [
    ...
    e && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
        z,
        {
          "aria-label": "Redo",
...
const uc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(lt, { children: [
...
function mc({
  ...
  const s = H(null), i = H(null), l = H(!1), [w, c] = S(t), [d, m] = S(n), [h, u] = S(!1);
  Y(() => {
    c(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  const g = (v) => {
    l.current = !1, u(v), v || (w !== "custom" || d ? (e(w), o(d)) : (c(t), m(n)));
  }, x = (v) => {
    var y, N, k, C;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((k = s.current) == null ? void 0 : k.selectionStart) === 0 && ((C = i.current) == null || C.focus(), l.current = !1), w === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ p(ue, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: uc(t, a, n) }) }) }),
...
const fc = (t, e) => t === "f" ? /* @__PURE__ */ p(lt, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function gc({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Bi, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: fc(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: hc(t, n) }) })
    ] }) }),
...
function mo({
  ...
  return /* @__PURE__ */ p(
    Ht,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(vc, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
...
function Lp({
  ...
  const d = H(null), m = H(null), h = H(null), u = H(null);
  At(() => {
    if (!u.current) return;
    const { width: _ } = u.current.getBoundingClientRect();
    _ > 0 && (u.current.style.width = `${_}px`);
  }, []);
  const [g, x] = S("generated"), [v, y] = S("*"), [N, k] = S("f"), [C, F] = S(!1), [j, A] = S(!0), [M, E] = S(!1), R = H(!1), V = H(""), [$, O] = S(!1), [P, W] = S(), [I, J] = S(), [Tt, Pt] = S(), [It, gt] = S(), pt = H(null), G = B(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (L && pn("note", L)) {
      ...
      let tt = "custom";
      it === er ? tt = "generated" : it === nr ? tt = "hidden" : it && y(it), x(tt), k(((q = L.insert.note) == null ? void 0 : q.style) ?? "f"), _ = setTimeout(() => {
        var bt;
  ...
  const Bt = () => {
    ...
    if (L && pn("note", L)) {
      ...
      N !== "x" && _ === "x" ? ct == null || ct.forEach((Rt) => Nc(Rt)) : N === "x" && _ !== "x" && (ct == null || ct.forEach((Rt) => kc(Rt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
    ...
    (_) => {
      ...
      if (L && pn("note", L)) {
        ...
        const ct = (it = L.insert.note) == null ? void 0 : it.style, Rt = (bt = (tt = L.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (ct || F(!1), F(
          ct === "x" ? !!(Rt != null && Rt.every(($t) => {
            var vt, ft;
        ...
        A(JSON.stringify(L) === V.current), st(g, v);
      } else
        F(!1), A(!0);
    },
    [g, v, st]
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
            /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(z, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(je, {}) }) }),
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
              /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
                z,
                {
                  onClick: Bt,
  ...
  return /* @__PURE__ */ p(lt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: Cc(t.marker, l, o, c) })
      }
    )
  ] });
}
function jp({
  ...
  const d = w ?? ii(n, void 0), m = (N, k) => {
    c == null || c(N, k, a);
  }, h = s ? n.findIndex((N) => N === s) : -1, [u, g] = S(h), x = (N, k, C) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
const Dc = (t) => {
...
}, Pn = (t, e, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
  /* @__PURE__ */ p(
    Dt,
    {
  ...
  return e ? e[1] : "";
}, Ic = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", qp = Object.freeze([
...
function Hp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), F = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Kt(n, "%webView_inventory_no_results%"), [A, M] = S(!1), [E, R] = S("all"), [V, $] = S(""), [O, P] = S([]), W = B(() => {
    const G = t ?? [];
    return G.length === 0 ? [] : Ac(G, a, s);
  }, [t, a, s]), I = B(() => {
    if (A) return W;
    const G = [];
    return W.forEach((at) => {
  ...
  }, [A, W]), J = B(() => I.length === 0 ? [] : Oc(I, E, V), [I, E, V]), Tt = B(() => {
    var st, wt;
    if (!A) return w;
  ...
  return /* @__PURE__ */ p("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ p(
        Le,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(Ee, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ p(Le, { onValueChange: (G) => It(G), defaultValue: i, children: [
        /* @__PURE__ */ r(Ee, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Te, { children: [
      ...
      o && /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        /* @__PURE__ */ r(
          Pr,
          {
            className: "tw-m-1",
...
const Pc = "16rem", $c = "3rem", Fa = b.createContext(void 0);
function $n() {
...
const Ba = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), m = e ?? c, h = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => h((k) => !k), [h]), g = m ? "expanded" : "collapsed", y = mt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
...
const Ka = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = $n();
...
const Lc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = $n();
  return /* @__PURE__ */ p(
    z,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Us, {}) : /* @__PURE__ */ r(qs, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
Lc.displayName = "SidebarTrigger";
...
const Kc = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: o,
...
const Gc = me(
  ...
  ({
    ...
    const w = t ? Fe : "button", { state: c } = $n(), d = /* @__PURE__ */ r(
      w,
      {
        ref: l,
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Dt, { asChild: !0, children: d }),
      /* @__PURE__ */ r(_t, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : d;
  }
);
Ya.displayName = "SidebarMenuButton";
const Uc = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: a,
...
const Hc = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Hc.displayName = "SidebarMenuSkeleton";
...
const Wc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Fe : "a",
  {
    ref: s,
...
Wc.displayName = "SidebarMenuSubButton";
function Jc({
  id: t,
  extensionLabels: e,
  projectInfo: n,
...
const ie = "scrBook", Zc = "scrRef", be = "source", Qc = "details", td = "Scripture Reference", ed = "Scripture Book", Xa = "Type", nd = "Details";
function rd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, fo = (t) => `${od({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Xp({
  sources: t,
  ...
  const [c, d] = S([]), [m, h] = S([{ id: ie, desc: !1 }]), [u, g] = S({}), x = B(
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(Hw, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
function ad({
  ...
  return /* @__PURE__ */ r(
    z,
    {
      ...
      onClick: () => o(t),
      className: f(
        Wa(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: dl(
        t,
...
function sd({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, y] = S(!1), [N, k] = S(""), C = H(void 0), F = H(!1);
  ...
  const j = B(() => ut.allBookIds.filter(
    ...
    (P, W = !1) => {
      ...
      const I = j.findIndex((gt) => gt === C.current), J = j.findIndex((gt) => gt === P);
      if (I === -1 || J === -1) return;
      const [Tt, Pt] = [
        Math.min(I, J),
        Math.max(I, J)
      ], It = j.slice(Tt, Pt + 1).map((gt) => gt);
      n(
    ...
    (P) => {
      const W = Lr(j, P).map((I) => I);
      n(
        Wa(j, P, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), $ = () => {
            ...
            ne,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: $, children: w }),
                  /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: O, children: c })
                ] }),
                /* @__PURE__ */ p(re, { children: [
...
function Jp({
  ...
  const c = he(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = he(i, "%webView_scope_selector_current_book%"), u = he(i, "%webView_scope_selector_choose_books%"), g = he(i, "%webView_scope_selector_scope%"), x = he(i, "%webView_scope_selector_select_books%"), v = [
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ p(St, { children: [
  /* @__PURE__ */ r(Dt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    _n,
    {
      onClick: () => {
        o(l);
    ...
    /* @__PURE__ */ r(Fw, { children: /* @__PURE__ */ r($a, { children: Za(
      t,
      e,
      Ja(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(ue, { variant: s, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ys, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", style: { zIndex: Ge }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(go, { children: [
      /* @__PURE__ */ r(Aa, { children: /* @__PURE__ */ r(kt, { children: Za(e.groups, e.items, w, t) }) }),
...
function nu({
  ...
  return /* @__PURE__ */ p(Qa, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      hr,
      {
        onSelectMenuItem: t,
...
const ts = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Et.Root,
    {
...
ts.displayName = Et.List.displayName;
const es = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.List,
  {
    ref: n,
    className: f(
...
es.displayName = Et.List.displayName;
...
)), ns = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.Content,
  {
    ref: n,
    className: f(
...
function ou({
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(ts, { children: [
      /* @__PURE__ */ r(es, { children: t.map((l) => /* @__PURE__ */ r(id, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(ns, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function ld({ ...t }) {
...
const rs = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
rs.displayName = rt.Root.displayName;
...
os.displayName = rt.Trigger.displayName;
const as = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    rt.SubTrigger,
    {
...
as.displayName = rt.SubTrigger.displayName;
...
ss.displayName = rt.SubContent.displayName;
const is = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Ft();
...
const ls = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
ls.displayName = rt.Item.displayName;
const cd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    rt.CheckboxItem,
    {
...
cd.displayName = rt.CheckboxItem.displayName;
const dd = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ p(
    rt.RadioItem,
    {
...
dd.displayName = rt.RadioItem.displayName;
const pd = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  rt.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
pd.displayName = rt.Label.displayName;
const ws = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Separator,
  {
    ref: n,
    className: f("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
ws.displayName = rt.Separator.displayName;
const Xe = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
        ls,
        {
          onClick: () => {
            o(c);
        ...
        /* @__PURE__ */ r(as, { children: c.label }),
    ...
    return l.length > 0 && i < a.length - 1 && w.push(/* @__PURE__ */ r(ws, {}, `separator-${s}`)), w;
  });
};
function ud({
  menuData: t,
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Xe(i, [h, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Xe(l, [h, u]);
        break;
      case "alt+h":
        (y = w.current) == null || y.focus(), Xe(w, [h, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(rs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(ld, { children: [
      /* @__PURE__ */ r(os, { ref: c(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        is,
        {
          style: { zIndex: Ge },
          children: /* @__PURE__ */ r(kt, { children: cs(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
...
function iu({
  ...
  const c = md(
    ...
    return v ? `${(F = t[g]) == null ? void 0 : F.autonym} (${v})` : (j = t[g]) == null ? void 0 : j.autonym;
  };
  return /* @__PURE__ */ p("div", { id: w, className: f("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(ht, { className: "tw-font-normal tw-text-muted-foreground", children: ve(c, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function fd({ item: t, createLabel: e, createComplexLabel: n }) {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
...
const hd = sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Js, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
), bd = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const xd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
xd.displayName = "AlertDescription";
const du = ot.Root, pu = ot.Trigger, uu = ot.Group, mu = ot.Portal, fu = ot.Sub, hu = ot.RadioGroup, yd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
yd.displayName = ot.SubTrigger.displayName;
...
Nd.displayName = ot.SubContent.displayName;
const kd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: f(
...
kd.displayName = ot.Content.displayName;
const _d = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ot.Item,
  {
    ref: o,
    className: f(
...
_d.displayName = ot.Item.displayName;
const Cd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ot.CheckboxItem,
  {
    ref: a,
    className: f(
...
const Ed = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ot.RadioItem,
  {
    ref: o,
    className: f(
...
Ed.displayName = ot.RadioItem.displayName;
...
Td.displayName = ot.Label.displayName;
...
Rd.displayName = ot.Separator.displayName;
...
Dd.displayName = "Drawer";
const gu = zt.Trigger, Md = zt.Portal, bu = zt.Close, ps = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
ps.displayName = zt.Overlay.displayName;
...
Pd.displayName = zt.Title.displayName;
...
$d.displayName = zt.Description.displayName;
const Ld = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  or.Root,
  {
    ref: o,
    className: f(
...
Ld.displayName = or.Root.displayName;
function vu({
  className: t,
  ...e
}) {
...
const Vd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ p(
    We.Root,
    {
...
Vd.displayName = We.Root.displayName;
const jd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    ar.Root,
    {
...
jd.displayName = ar.Root.displayName;
const ku = Et.Root, zd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Et.List,
    {
...
zd.displayName = Et.List.displayName;
...
Fd.displayName = Et.Trigger.displayName;
...
Bd.displayName = Et.Content.displayName;
...
export {
  ...
  kd as ContextMenuContent,
  uu as ContextMenuGroup,
  _d as ContextMenuItem,
  ...
  Nd as ContextMenuSubContent,
  yd as ContextMenuSubTrigger,
  ...
  cc as UNDO_REDO_BUTTONS_STRING_KEYS,
  iu as UiLanguageSelector,
  dc as UndoRedoButtons,
  ts as VerticalTabs,
