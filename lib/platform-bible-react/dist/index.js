...
const aa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = aa ? Gt : U, dn = { tag: br };
function Ml({ initialConfig: e, children: t }) {
  const n = L(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Rl(null, o), p = Ro({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (h) => i(h, p), theme: o });
    return function(h, m) {
      if (m !== null) {
...
class Vl extends ms {
  ...
  componentDidUpdate(t, n) {
    ...
    if (o && n.error !== null && Pl(t.resetKeys, a)) {
      var s, i;
...
function $l({ children: e, onError: t }) {
  return r(Vl, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
...
const ew = Xt({ config: on({ setOptions: oo, updateOptions: oo }), init: ({ $initialEditorState: e = tw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, o) {
...
const rw = /* @__PURE__ */ new Set(), io = Xt({ build(e, t, n) {
...
function sw(e, t) {
  return ee(e.registerCommand(Ei, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Kl(i, (m) => fn(m) && m.canIndent() ? m : null).length > 0) return !0;
...
function mw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Mr(() => ee(Fi(a), xa(a)), [a]);
  }(o), d(it, { children: [e, r(hw, { content: t }), r(uw, { editor: o, ErrorBoundary: n })] });
}
...
function Nw(e, t) {
  ...
  return d(it, { children: [r(xw, { editor: a, ...o, ref: t }), n != null && r(kw, { editor: a, content: n })] });
}
...
Rw.displayName = $o.Root.displayName;
...
function Ta(e, t, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (m = p(m)), Yr(e) && (m = Pw(e, m, u ? () => {
    const g = new Vo();
    return n.push(g), g;
...
const Kw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
Uw.displayName = Ve.Image.displayName;
    ...
    "div",
    {
      ...
      children: [
        ...
        P && /* @__PURE__ */ d(xe, { children: [
          /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(No, {}) }) }),
...
function _p({
  ...
  const x = t.filter(
    ...
    [u]
  ), { listboxRef: A, activeId: P, handleKeyDown: _ } = zw({
    options: E,
    onOptionSelect: y
  }), M = z(
    (k) => {
...
const Me = lt.Root, tc = lt.Group, Oe = lt.Value, ec = re(
...
nc.displayName = lt.Label.displayName;
...
rc.displayName = lt.Separator.displayName;
function oc({ table: e }) {
...
const gc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(it, { children: [
...
const vc = (e, t) => e === "f" ? /* @__PURE__ */ d(it, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function _c({
  ...
  return /* @__PURE__ */ d(it, { children: [
    ...
    /* @__PURE__ */ r("div", { className: f("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ r(it, { children: Nc(e.marker, l, o, w) }) })
  ] });
}
const Ap = ["%webView_footnoteList_header%"], Cc = (e, t) => e[t] ?? t;
function Vp({
  className: e,
  classNameForItems: t,
  footnotes: n,
  ...
  const h = p ? Cc(p, "%webView_footnoteList_header%") : "Footnotes", m = c ?? ai(n, void 0), u = (y, S) => {
    w == null || w(y, S, a);
...
const Wa = (e, t, n, o) => n ? Object.entries(e).filter(
  ...
  /* @__PURE__ */ r(Ft, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Yw, { children: /* @__PURE__ */ r(Va, { children: Wa(
      e,
      t,
      Ja(e, l.id),
      o
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(xe, { children: [
              /* @__PURE__ */ r(Le, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r($, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(No, {}) }) }),
