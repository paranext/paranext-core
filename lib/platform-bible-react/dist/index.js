import { jsx as r, jsxs as d, Fragment as ot } from "react/jsx-runtime";
import * as Qe from "react";
import b, { forwardRef as Ve, useRef as et, useMemo as L, useState as M, useCallback as B, useLayoutEffect as It, createContext as Dn, useContext as In, useEffect as q, Suspense as ia, createRef as la, Fragment as yr } from "react";
import { Command as dt } from "cmdk";
import { X as Me, Search as Nr, Check as _t, Clock as tr, ChevronsLeft as er, ChevronsRight as nr, ChevronLeft as dn, ChevronRight as ae, ArrowLeft as wa, ArrowRight as da, Circle as Xe, ChevronDown as Yt, BoldIcon as ca, ItalicIcon as pa, UnderlineIcon as ua, StrikethroughIcon as ma, Pencil as ha, Trash2 as fa, ArrowUp as kr, MoreHorizontal as _r, ChevronUp as cn, AtSign as ga, FilterIcon as ba, ArrowLeftIcon as va, ChevronLeftIcon as xa, ChevronRightIcon as ya, ArrowRightIcon as Na, Copy as Cr, Filter as ka, User as _a, Link as Ca, CircleHelp as Ea, ChevronsUpDown as Er, Star as Ta, FunctionSquare as Tr, SquareSigma as Rr, SquareX as Ra, AlertCircle as pn, CircleCheckIcon as Sa, CircleXIcon as Da, CircleHelpIcon as Ia, ArrowUpIcon as Oa, ArrowDownIcon as Va, ArrowUpDownIcon as Ma, PanelLeft as Aa, PanelRight as Pa, ScrollText as $a, MenuIcon as La, Menu as za, EllipsisVertical as Ba, LoaderCircle as ja, GripVertical as Fa } from "lucide-react";
import { clsx as Ga } from "clsx";
import { extendTailwindMerge as Ha } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { includes as Le, Section as F, getChaptersForBook as Xa, formatScrRef as ne, getSectionForBook as _e, formatRelativeDate as Ua, formatReplacementString as re, sanitizeHtml as Ka, parseParatextHtml as rr, hasCustomParatextTags as Ya, NumberFormat as qa, formatBytes as Ja, getCurrentLocale as Wa, getFormatCallerFunction as Za, deepEqual as Sr, isString as tn, compareScrRefs as un, scrRefToBBBCCCVVV as en, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
import * as Dr from "@radix-ui/react-label";
import * as Re from "@radix-ui/react-radio-group";
import { createEditor as Qa, $getRoot as qt, $createParagraphNode as On, $getSelection as Se, HISTORY_MERGE_TAG as Ir, ParagraphNode as ts, TextNode as es, $isDecoratorNode as ns, $isElementNode as Ce, $isParagraphNode as rs, $isTextNode as je, $isTokenOrSegmented as os, $getCharacterOffsets as as, $isRangeSelection as Vn, CLEAR_EDITOR_COMMAND as Or, COMMAND_PRIORITY_EDITOR as ss, SELECTION_CHANGE_COMMAND as Vr, COMMAND_PRIORITY_CRITICAL as Mr, FORMAT_TEXT_COMMAND as is, $cloneWithProperties as ls, getRegisteredNode as ws, isHTMLElement as ds, isDocumentFragment as or, ArtificialNode__DO_NOT_USE as Ar, $createLineBreakNode as Pr, $isRootOrShadowRoot as cs, $isBlockElementNode as mn, isBlockDomNode as ar, isInlineDomNode as sr, $insertNodes as ps } from "lexical";
...
import { createHeadlessEditor as Lr } from "@lexical/headless";
...
import { useReactTable as Br, getFilteredRowModel as ys, getSortedRowModel as jr, getPaginationRowModel as Ns, getCoreRowModel as Fr, flexRender as Ee, getGroupedRowModel as ks, getExpandedRowModel as _s } from "@tanstack/react-table";
...
const Os = ft.Root, Vs = ft.Portal, Gr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: u(
...
Gr.displayName = ft.Overlay.displayName;
const Hr = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = st();
...
const Ur = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Title,
  {
    ref: n,
...
Ur.displayName = ft.Title.displayName;
...
const Pe = b.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(Nr, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      dt.Input,
      {
        ref: n,
...
const Ke = b.forwardRef((t, e) => /* @__PURE__ */ r(dt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
Kr.displayName = dt.Separator.displayName;
...
function me(t, e = !0) {
  return e && (t = t.toUpperCase()), t in ir ? ir[t] : 0;
}
function Pn(t) {
  return me(t) > 0;
}
...
function Xs(t) {
  return Yr[t - 1].includes("*obsolete*");
}
function Us() {
  const t = {};
...
var Qr = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(Qr || {});
const wt = class H {
  constructor(e, n, o, a) {
  ...
  allVerses(e = !1, n = H.verseRangeSeparators, o = H.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], s = lr(this._verse, o);
    for (const i of s.map((l) => lr(l, n))) {
      const l = this.clone();
      l.verse = i[0];
      const p = l.verseNum;
...
const eo = K.allBookIds.filter(
  (t) => !K.isObsolete(K.bookIdToNumber(t))
), Xt = Object.fromEntries(
  eo.map((t) => [t, K.bookIdToEnglishName(t)])
);
function zn(t, e, n) {
...
$.displayName = "Button";
const he = se.Root, fe = se.Trigger, vd = se.Anchor, te = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = st();
  ...
  const o = Js.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!c && p) {
          const m = ((g) => Object.keys(Xt).find(
            (v) => Xt[v].toLowerCase() === g.toLowerCase()
          ))(l);
          if (m && e.includes(m) && (c = m), !c && n) {
            const g = Array.from(n.entries()).find(
              ([, v]) => v.localizedName.toLowerCase() === l.toLowerCase()
            );
            g && e.includes(g[0]) && ([c] = g);
          }
        }
        if (c) {
...
function yd({
  ...
  const w = st(), [c, f] = M(!1), [h, m] = M(""), [g, v] = M(""), [y, O] = M("books"), [N, x] = M(void 0), [_, A] = M(!1), C = et(void 0), E = et(void 0), S = et(void 0), T = et(void 0), R = et({}), P = B(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
    ...
    return [F.OT, F.NT, F.DC, F.Extra].forEach((rt) => {
      D[rt] = G[rt].filter((it) => zn(it, g, a));
    }), D;
  }, [G, g, a]), V = L(
    () => Ws(g, I, a),
    [g, I, a]
    ...
    [y, Y]
  ), { otLong: xt, ntLong: Et, dcLong: Jn, extraLong: Wn } = {
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: X, isDigit: rt } = wr(D.key);
      if (y === "chapters") {
        if (D.key === "Backspace") {
        ...
        if (X || rt) {
          if (D.preventDefault(), D.stopPropagation(), O("books"), x(void 0), rt && N) {
            const it = Xt[N];
            v(`${it} ${D.key}`);
          } else
            v(D.key);
      ...
      if ((y === "chapters" || y === "books" && V) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        ...
        switch (D.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Tt = lt === 0 ? Bt : Math.max(1, lt - Qn);
            break;
          case "ArrowDown":
            Tt = lt === 0 ? 1 : Math.min(Bt, lt + Qn);
            break;
          default:
            return;
        }
    ...
    const { isLetter: X, isDigit: rt } = wr(D.key);
    (X || rt) && (D.preventDefault(), v((it) => it + D.key), E.current.focus(), A(!1));
  }, []);
  return It(() => {
    const D = setTimeout(() => {
      if (c && y === "books" && S.current && T.current) {
        const X = S.current, rt = T.current, it = rt.offsetTop, lt = X.clientHeight, Bt = rt.clientHeight, Tt = it - lt / 2 + Bt / 2;
        X.scrollTo({
          top: Math.max(0, Tt),
          behavior: "smooth"
        }), m(xn(t.book));
      ...
      pe,
      {
        ...
        children: [
          y === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: k.map(({ onClick: D, disabled: X, title: rt, icon: it }) => /* @__PURE__ */ r(
              $,
              {
                variant: "ghost",
                size: "sm",
          ...
          !_ && /* @__PURE__ */ d(ue, { ref: S, children: [
            y === "books" && /* @__PURE__ */ d(ot, { children: [
              !V && Object.entries(J).map(([D, X]) => {
                if (X.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r($t, { heading: ea(D), children: X.map((rt) => /* @__PURE__ */ r(
                      no,
                      {
                        bookId: rt,
                        onSelect: (it) => ht(it),
                        section: _e(rt),
                        commandValue: `${rt} ${Xt[rt]}`,
                        ref: rt === t.book ? T : void 0,
                        localizedBookNames: a
                      },
                      rt
                    )) }, D)
              ...
              V && kt(V.book) > 1 && /* @__PURE__ */ d(ot, { children: [
...
), at = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Dr.Root, { ref: n, className: u("pr-twp", Qs(), t), ...e }));
at.displayName = Dr.Root.displayName;
const Bn = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    Re.Root,
    {
...
function _d({
  ...
  const c = on(w, "%webView_bookSelector_currentBook%"), f = on(w, "%webView_bookSelector_choose%"), h = on(w, "%webView_bookSelector_chooseBooks%"), [m, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), v = (y) => {
    g(y), t(y);
...
const Cd = [
  ...
  const a = et(null), [s, i] = M(void 0), [l, p] = M(void 0), w = B(
    ...
    (m) => {
      var E;
      const g = m.target, v = (S) => S ? document.getElementById(S) : void 0, y = v(l), O = v(s);
...
const oo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ii = oo ? It : q, ze = { tag: Ir };
function li({ initialConfig: t, children: e }) {
      ...
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (m.isEmpty()) {
            const g = On();
            m.append(g);
            const v = oo ? document.activeElement : null;
            (Se() !== null || v !== null && v === f.getRootElement()) && g.select();
          }
        }, ze);
  ...
  }, []), r(ro.Provider, { value: n, children: e });
}
...
function di({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return wi(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: p }) => {
      e && s.size === 0 && i.size === 0 || t && p.has(Ir) || l.isEmpty() || n(a, o, p);
    });
  }, [o, t, e, n]), null;
}
const jn = {
  ...
  mark: "",
  markOverlap: ""
}, St = Ae.Provider, At = Ae.Root, Ut = Ae.Trigger, Dt = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  Ae.Content,
  {
    ref: o,
    sideOffset: e,
...
var cr = { error: null }, ci = function(t) {
  var e, n;
  function o() {
    for (var s, i = arguments.length, l = new Array(i), p = 0; p < i; p++) l[p] = arguments[p];
    return (s = t.call.apply(t, [this].concat(l)) || this).state = cr, s.resetErrorBoundary = function() {
  ...
  return a.reset = function() {
    ...
    f !== null && i.error !== null && ((w = s.resetKeys) === void 0 && (w = []), (c = h) === void 0 && (c = []), w.length !== c.length || w.some(function(m, g) {
      return !Object.is(m, c[g]);
...
function vi(t, e) {
  ...
  if (e.isSelected(t) && !os(e) && n !== null) {
    ...
    if (p || w) {
      const [c, f] = as(t), h = i.is(l), m = e.is(s ? l : i), g = e.is(s ? i : l);
      let v, y = 0;
      h ? (y = c > f ? f : c, v = c > f ? c : f) : m ? (y = s ? f : c, v = void 0) : g && (y = 0, v = s ? c : f), e.__text = e.__text.slice(y, v);
    }
  }
  return e;
}
const so = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xi = so && "documentMode" in document ? document.documentMode : null;
!(!so || !("InputEvent" in window) || xi) && "getTargetRanges" in new window.InputEvent("input");
function Gn(...t) {
  return () => {
...
function pr(t) {
  return t.getEditorState().read(ao(t.isComposing()));
}
function Ni({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Ct(), a = function(s, i) {
    ...
    return kn(() => s.registerDecoratorListener((w) => {
      ...
      for (let f = 0; f < c.length; f++) {
        const h = c[f], m = r(i, { onError: (v) => s._onError(v), children: r(ia, { fallback: null, children: l[h] }) }), g = s.getElementByKey(h);
  ...
  return function(s) {
    kn(() => Gn(fs(s), yi(s)), [s]);
  }(o), d(ot, { children: [t, r(ki, { content: e }), a] });
}
...
function Ei({ onClear: t }) {
  const [e] = Ct();
  return Ci(() => e.registerCommand(Or, (n) => (e.update(() => {
    if (t == null) {
...
function Di(t, e) {
  ...
  return d(ot, { children: [r(Ri, { editor: a, ...o, ref: e }), n != null && r(Ii, { editor: a, content: n })] });
}
...
function Vi({
  ...
  return /* @__PURE__ */ r(lo.Provider, { value: i, children: s });
}
function wo() {
  const t = In(lo);
  if (!t)
...
function Mi() {
  const [t, e] = M(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Os, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Hr, { children: [
      /* @__PURE__ */ r(Xr, { children: /* @__PURE__ */ r(Ur, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = B(
    (s, i, l = !1) => {
...
const co = Lt(
  ...
  {
    ref: a,
    className: u(co({ variant: e, size: n, className: t })),
    ...o
  }
));
...
const po = b.createContext({
  size: "default",
  variant: "default"
}), Hn = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = st();
  return /* @__PURE__ */ r(
    Ue.Root,
    {
...
const Te = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = b.useContext(po);
  return /* @__PURE__ */ r(
    Ue.Item,
    {
      ref: s,
...
function Li() {
  const { activeEditor: t } = wo(), [e, n] = M([]), o = B((a) => {
    if (Vn(a) || vs(a)) {
      const s = [];
      mr.forEach(({ format: i }) => {
  ...
  return Pi(o), /* @__PURE__ */ r(
    Hn,
    {
      ...
      variant: "outline",
      size: "sm",
      children: mr.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        Te,
        {
          value: a,
          "aria-label": i,
...
function Fi(t, e) {
  ...
  for (let s = 0; s < n.length; s++) {
    const i = n[s];
    if (!mo.has(i.nodeName)) {
      const l = ho(i, t, a, !1);
      l !== null && (o = o.concat(l));
    }
  }
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Ar && i.insertAfter(Pr());
    for (const i of s) {
...
function uo(t, e, n, o = null) {
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], v = uo(t, g, h, o);
    !a && Ce(e) && v && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((ds(c) || or(c)) && c.append(h), n.append(c), f) {
      const m = f.call(i, c);
      m && (or(c) ? c.replaceChildren(m) : c.replaceWith(m));
    }
  } else n.append(h);
  return a;
}
const mo = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function ho(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (mo.has(t.nodeName)) return i;
  let l = null;
  const p = function(g, v) {
    const { nodeName: y } = g, O = v._htmlConversions.get(y.toLowerCase());
    let N = null;
  ...
  for (let g = 0; g < f.length; g++) h.push(...ho(f[g], e, n, m, new Map(a), l));
  return c != null && (h = c(h)), ar(t) && (h = Hi(t, h, m ? () => {
    const g = new Ar();
    return n.push(g), g;
  } : On)), l == null ? h.length > 0 ? i = i.concat(h) : ar(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : sr(g.nextSibling) && sr(g.previousSibling);
  }(t) && (i = i.concat(Pr())) : Ce(l) && l.append(...h), i;
}
function Hi(t, e, n) {
...
function Ui(t) {
  ...
  const e = t.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Lr({
...
ie.displayName = zr.Root.displayName;
...
function ee({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Xn.Provider, { value: n, children: /* @__PURE__ */ r(Z.Root, { ...e }) });
}
const ko = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = bt();
  return /* @__PURE__ */ d(
    Z.SubTrigger,
    {
...
const _o = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Z.SubContent,
  {
    ref: n,
    className: u(
...
const zt = b.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = st();
...
const Ge = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = st(), s = bt();
  return /* @__PURE__ */ r(
    Z.Item,
    {
...
const Pt = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = bt();
  return /* @__PURE__ */ d(
    Z.CheckboxItem,
    {
...
const Co = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = bt();
  return /* @__PURE__ */ d(
    Z.RadioItem,
    {
...
const $e = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Z.Label,
  {
    ref: o,
    ...
    if (a && n)
      return /* @__PURE__ */ d(ot, { children: [
        !Ya(t.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              f(!0), m(Ui(rr(t.contents))), w == null || w(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        A && /* @__PURE__ */ d(ee, { children: [
          /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(_r, {}) }) }),
...
function rl({
  ...
  const [m, g] = M(fr), [v, y] = M(!1), [O, N] = M(!1), [x, _] = M(!1), [A, C] = M(!1), E = L(() => t.filter((k) => !k.deleted), [t]), S = L(() => E[0], [E]), T = et(null), R = et(void 0);
  q(() => {
    const k = T.current;
    if (!k) return;
    const Y = () => {
  ...
  const P = L(
    ...
    var Y;
    await c(l, fo(m)) && ((Y = R.current) == null || Y.call(R), g(fr));
  }, [m, c, l]);
  return /* @__PURE__ */ r(
    bo,
    {
          ...
          n && /* @__PURE__ */ d(ot, { children: [
            ...
            (!A || Ht(m)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDown: (k) => {
                  go(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    _n,
...
function Ed({
  ...
  const [p, w] = M(), c = e.filter(
    ...
    w(N);
  }, []), { listboxRef: g, activeId: v, handleKeyDown: y } = ai({
    options: f,
    onOptionSelect: h
  }), O = B(
    (N) => {
...
), Wt = b.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = st();
  return /* @__PURE__ */ d(
    nt.Trigger,
    {
...
const Zt = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = st();
...
const Ye = b.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
...
const qe = b.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: u(
...
const Je = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: u("[&_tr:last-child]:tw-border-0", t), ...e }));
Je.displayName = "TableBody";
const cl = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
...
const Rt = b.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const l = b.useMemo(
    ...
    (c) => {
      ...
      ) : [], g = m.indexOf(f), v = l.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (c.key === "ArrowDown" || c.key === "ArrowUp")
        c.preventDefault(), ml(m, g, c.key);
...
function fl({
  ...
  var C;
  const [c, f] = M([]), [h, m] = M([]), [g, v] = M({}), [y, O] = M({}), N = L(() => e ?? [], [e]), x = Br({
    data: N,
    columns: t,
    getCoreRowModel: Fr(),
    ...n && { getPaginationRowModel: Ns() },
    onSortingChange: f,
    getSortedRowModel: jr(),
...
function bl({
  ...
  const a = br(n, "%webView_error_dump_header%"), s = br(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r($, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Cr, {}) })
        ] }),
...
function Dd({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ee, { children: [
    ...
    /* @__PURE__ */ r(zt, { children: n.map((w, c) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(No, { children: w.itemType === 0 ? /* @__PURE__ */ r(ot, { children: w.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Pt,
        {
          checked: o[c][h],
...
function yl({
  ...
  return /* @__PURE__ */ r("div", { id: y, className: g, children: /* @__PURE__ */ d(he, { open: S, onOpenChange: c ?? N, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ d(
      $,
      {
        variant: v,
        ...
        children: [
          ...
          /* @__PURE__ */ r(Er, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
...
const Nl = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(ot, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ d(ot, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
function kl({
  ...
  return q(() => {
    ...
    l !== n && p(n);
  }, [n]), /* @__PURE__ */ d(ee, { onOpenChange: (c) => {
...
const _l = (t, e) => t === "f" ? /* @__PURE__ */ d(ot, { children: [
  /* @__PURE__ */ r(Tr, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ d(ot, { children: [
  /* @__PURE__ */ r(Rr, {}),
  " ",
...
function Md({
  ...
  const l = et(null), p = la(), [w, c] = M("generated"), [f, h] = M("*"), [m, g] = M("f"), v = L(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (_ && nn("note", _)) {
      ...
      let S = "custom";
      E === hn ? S = "generated" : E === fn ? S = "hidden" : E && h(E), c(S), g(((C = _.insert.note) == null ? void 0 : C.style) ?? "f"), _.insert.note && (_.insert.note.caller = ""), x = setTimeout(() => {
        var T;
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
            /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: O, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cr, {}) }) }),
...
function Sl({
  ...
  const p = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, w = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, c = a && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
  // specific class name in case styling is needed.
  // TODO(mattg): Look at the width in relation to grid sizing
  /* @__PURE__ */ d("span", { className: u("note-caller tw-inline-block", { formatted: s }), children: [
    a,
    " "
  ] }), f = i && /* @__PURE__ */ d(ot, { children: [
    Un(t.marker, [i], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", m = o ? "marker-visible" : "", g = e === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", v = u(h, m);
  return /* @__PURE__ */ d(ot, { children: [
    /* @__PURE__ */ d("div", { className: u("textual-note-header tw-col-span-1 tw-text-nowrap tw-w-fit tw-pr-2", v), children: [
      p,
      c
    ] }),
    /* @__PURE__ */ r("div", { className: u("textual-note-header tw-col-span-1 tw-text-nowrap tw-w-fit tw-pr-2", v), children: f }),
    /* @__PURE__ */ r("div", { className: u("textual-note-body tw-pr-0.5", g, v), children: l && l.length > 0 && /* @__PURE__ */ r(ot, { children: Tl(t.marker, l, o, w) }) })
  ] });
}
...
function $d({
  ...
  const f = c ? Dl(c, "%webView_footnoteList_header%") : "Footnotes", h = p ?? Za(n, void 0), m = (x, _) => {
    w == null || w(x, _, a);
  }, g = s ? n.findIndex((x) => x === s) : 0, [v, y] = M(g), O = (x) => {
    if (n.length)
      switch (x.key) {
        case "ArrowDown":
  ...
  return q(() => {
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        tabIndex: 0,
        className: u("tw-h-full tw-overflow-y-auto @container", t),
        onKeyDown: O,
        children: /* @__PURE__ */ r(
          "ul",
          {
            className: u(
              "tw-p-0.5 tw-pt-1",
              "tw-grid",
              o === "horizontal" ? "tw-grid-cols-3 tw-grid-cols-[min-content_min-content_1fr]" : "tw-grid-cols-2 tw-grid-cols-[min-content_1fr]",
              !l && "formatted-font"
            ),
            children: n.map((x, _) => {
              const A = x === s, C = `${a}-${_}`;
              return console.log(e), /* @__PURE__ */ d(ot, { children: [
                /* @__PURE__ */ r(
                  "li",
                  {
                    ref: (E) => {
                    ...
                    className: u(
                      ...
                      */
                      ...
                      "tw-grid tw-grid-cols-subgrid tw-grid-flow-col",
                ...
                _ < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(
                  ie,
                  {
...
Kn.displayName = gn.Root.displayName;
...
function Xd({
  ...
  const f = yt(n, "%webView_inventory_all%"), h = yt(n, "%webView_inventory_approved%"), m = yt(n, "%webView_inventory_unapproved%"), g = yt(n, "%webView_inventory_unknown%"), v = yt(n, "%webView_inventory_scope_currentBook%"), y = yt(n, "%webView_inventory_scope_chapter%"), O = yt(n, "%webView_inventory_scope_verse%"), N = yt(n, "%webView_inventory_filter_text%"), x = yt(
    n,
    "%webView_inventory_show_additional_items%"
...
const $l = "16rem", Ll = "3rem", So = b.createContext(void 0);
function Ze() {
  const t = b.useContext(So);
  if (!t)
...
const Do = b.forwardRef(
  ({
    ...
    const [w, c] = b.useState(t), f = e ?? w, h = b.useCallback(
      (x) => {
        const _ = typeof x == "function" ? x(f) : x;
        n ? n(_) : c(_);
      },
      [n, f]
    ), m = b.useCallback(() => h((x) => !x), [h]), g = f ? "expanded" : "collapsed", O = st() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
...
const Io = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Ze();
...
const zl = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Ze();
  return /* @__PURE__ */ d(
    $,
    {
...
const Tn = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? de : "div",
  {
    ref: o,
...
const Kl = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? de : "button",
  {
    ref: a,
...
}, vr = (t) => `${sw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Kd({
  sources: t,
  ...
  const [w, c] = M([]), [f, h] = M([{ id: Mt, desc: !1 }]), [m, g] = M({}), v = L(
  ...
  q(() => {
    if (l) {
      ...
      if (R.length === 1) {
        const P = v.find((z) => vr(z) === R[0]) || void 0;
        P && l(P);
      }
    }
  }, [m, v, l, O]);
...
const qn = (t, e) => t.filter((n) => {
  try {
    return _e(n) === e;
  } catch {
    return !1;
  }
}), Lo = (t, e, n) => qn(t, e).every((o) => n.includes(o));
function iw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = qn(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], p = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    $,
    {
      variant: "outline",
...
function lw({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], p = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], c = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: h, ntLong: m, dcLong: g, extraLong: v } = {
                  ...
                  Object.values(F).map((I, J) => {
                    ...
                    if (V.length !== 0)
                      return /* @__PURE__ */ d(yr, { children: [
                        ...
                        J < Object.values(F).length - 1 && /* @__PURE__ */ r(Kr, {})
                      ] }, I);
                  })
                ] })
              ]
...
function qd({
  ...
  const w = jt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = jt(i, "%webView_scope_selector_current_book%"), m = jt(i, "%webView_scope_selector_choose_books%"), g = jt(i, "%webView_scope_selector_scope%"), v = jt(i, "%webView_scope_selector_select_books%"), y = [
...
function Sn({
  ...
  return /* @__PURE__ */ d(ee, { variant: s, children: [
    ...
    /* @__PURE__ */ r(zt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, w]) => typeof p == "boolean" || typeof w == "boolean" ? 0 : p.order - w.order).map(([p], w, c) => /* @__PURE__ */ d(yr, { children: [
...
const Fo = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ct.Root,
    {
...
)), Ho = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Content,
  {
    ref: n,
    className: u(
...
const Xo = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(Xn.Provider, { value: a, children: /* @__PURE__ */ r(
    Q.Root,
    {
      ref: o,
      className: u(
...
const Uo = b.forwardRef(({ className: t, ...e }, n) => {
  const o = bt();
  return /* @__PURE__ */ r(
    Q.Trigger,
    {
...
const qo = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = bt();
...
const Jo = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = bt();
  return /* @__PURE__ */ r(
    Q.Item,
    {
  ...
  if (Rs(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (c, f) => {
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Ne(s, [h, m]);
        break;
      case "alt+l":
...
function ac({
  ...
  const w = fw(
    ...
    a && a(g), o && o([g, ...n.filter((v) => v !== g)]), s && n.find((v) => v === g) && s([...n.filter((v) => v !== g)]), f(!1);
  }, m = (g, v) => {
    var O, N, x, _, A, C;
    const y = v !== g ? ((N = (O = t[g]) == null ? void 0 : O.uiNames) == null ? void 0 : N[v]) ?? ((_ = (x = t[g]) == null ? void 0 : x.uiNames) == null ? void 0 : _.en) : void 0;
    return y ? `${(A = t[g]) == null ? void 0 : A.autonym} (${y})` : (C = t[g]) == null ? void 0 : C.autonym;
  };
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ee, { children: [
              /* @__PURE__ */ r(ge, { className: u(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r($, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(_r, {}) }) }),
...
const wc = tt.Root, dc = tt.Trigger, cc = tt.Group, pc = tt.Portal, uc = tt.Sub, mc = tt.RadioGroup, kw = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  tt.SubTrigger,
  {
    ref: a,
    className: u(
...
const Cw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(tt.Portal, { children: /* @__PURE__ */ r(
  tt.Content,
  {
    ref: n,
    className: u(
...
const Tw = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  tt.CheckboxItem,
  {
    ref: a,
    className: u(
...
const Rw = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  tt.RadioItem,
  {
    ref: o,
    className: u(
...
const hc = gt.Trigger, Vw = gt.Portal, fc = gt.Close, ta = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  gt.Overlay,
  {
    ref: n,
...
const Mw = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(Qo), i = {
...
const zw = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  bn.Root,
  {
    ref: o,
    className: u(
...
const Bw = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ d(
    ke.Root,
    {
...
const yc = ct.Root, Fw = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ct.List,
    {
