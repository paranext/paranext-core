...
import E, { forwardRef as lr, useCallback as St, useState as pt, useRef as Ft, useEffect as ne, useLayoutEffect as ha, useMemo as Rt } from "react";
...
import { ChevronRight as bo, Check as Je, Circle as vo, X as yo, Search as mi, ChevronsUpDown as hi, FilterIcon as wl, ChevronDown as cr, ChevronUp as fl, ArrowLeftIcon as ml, ChevronLeftIcon as hl, ChevronRightIcon as gl, ArrowRightIcon as bl, LoaderCircle as vl, Download as yl, Filter as xl, User as Nl, Link as kl, CircleHelp as El, Star as Sl, CircleCheckIcon as Cl, CircleXIcon as Tl, CircleHelpIcon as Rl, ArrowUpIcon as Ol, ArrowDownIcon as _l, ArrowUpDownIcon as Pl, PanelLeft as $l, PanelRight as Il, ScrollText as Ml, ChevronLeft as Al } from "lucide-react";
import { getChaptersForBook as Dl, NumberFormat as jl, formatBytes as Bl, deepEqual as xo, substring as Vl, formatScrRef as Br, compareScrRefs as eo, scrRefToBBBCCCVVV as Vr, getLocalizeKeyForScrollGroupId as dt } from "platform-bible-utils";
...
const No = wt.Root, Ci = wt.Trigger, ac = wt.Group, Zm = wt.Portal, Qm = wt.Sub, th = wt.RadioGroup, ic = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  wt.SubTrigger,
  {
    ref: o,
    className: y(
...
ic.displayName = wt.SubTrigger.displayName;
...
sc.displayName = wt.SubContent.displayName;
...
pr.displayName = wt.Content.displayName;
...
Ti.displayName = wt.Item.displayName;
...
ko.displayName = wt.CheckboxItem.displayName;
const Ri = E.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  wt.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ i(wt.ItemIndicator, { children: /* @__PURE__ */ i(vo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
Ri.displayName = wt.RadioItem.displayName;
...
ur.displayName = wt.Label.displayName;
...
wr.displayName = wt.Separator.displayName;
...
const To = ht.allBookIds.filter((t) => !ht.isObsolete(ht.bookIdToNumber(t))), kc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
], ln = (t) => Dl(ht.bookIdToNumber(t));
function Cc() {
  return To.map((e) => ht.bookIdToEnglishName(e));
}
function Tc(t) {
...
function Rc(t) {
  ...
  if (Tc(e))
    return To.find((r) => ht.bookIdToEnglishName(r) === e);
}
function nh({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = Nt(), [a, s] = pt(""), [l, c] = pt(t.book), [d, p] = pt(t.chapterNum ?? 0), [f, w] = pt(t.book), [m, b] = pt(!1), [h, g] = pt(m), k = Ft(void 0), C = Ft(void 0), T = Ft(void 0), S = St(
    ...
    (j, M, A, G) => {
      if (p(t.book !== j ? 1 : t.chapterNum), M || ln(j) === -1) {
        e({
          book: j,
          chapterNum: A || 1,
          verseNum: G || 1
  ...
  }, [f, t.book, t.chapterNum, l]), ha(() => {
    g(m);
  }, [m]), ha(() => {
    const j = setTimeout(() => {
      if (h && C.current && T.current) {
        const A = T.current.offsetTop - Ec;
    ...
    /* @__PURE__ */ i(
      Ro,
      {
        ...
        children: /* @__PURE__ */ N(Oo, { children: [
          ...
          /* @__PURE__ */ i(Po, { children: e.map((C) => /* @__PURE__ */ N(
            Io,
            {
              value: l(C),
              onSelect: () => {
...
function oh({
  ...
  const p = zr(d, "%webView_bookSelector_currentBook%"), f = zr(d, "%webView_bookSelector_choose%"), w = zr(d, "%webView_bookSelector_chooseBooks%"), [m, b] = pt(
    "current book"
    /* CURRENT_BOOK */
  ), h = (g) => {
    b(g), t(g);
...
function Vc({ table: t }) {
  return /* @__PURE__ */ N(No, { children: [
    /* @__PURE__ */ i(ul, { asChild: !0, children: /* @__PURE__ */ N(ut, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function Yc({
  ...
  var g;
  const [l, c] = pt([]), [d, p] = pt([]), [f, w] = pt({}), [m, b] = pt({}), h = bi({
    data: e,
    columns: t,
    getCoreRowModel: yi(),
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(fr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(mr, { stickyHeader: a, children: h.getHeaderGroups().map((k) => /* @__PURE__ */ i(ce, { children: k.headers.map((C) => /* @__PURE__ */ i(En, { children: C.isPlaceholder ? void 0 : bn(C.column.columnDef.header, C.getContext()) }, C.id)) }, k.id)) }),
      /* @__PURE__ */ i(hr, { children: (g = h.getRowModel().rows) != null && g.length ? h.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        ce,
        {
          onClick: () => s(k, h),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((C) => /* @__PURE__ */ i(Ue, { children: bn(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        k.id
...
function dh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ N(No, { children: [
    /* @__PURE__ */ i(Ci, { asChild: !0, children: /* @__PURE__ */ i(Hc, {}) }),
...
), td = E.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ i(
  xi.Root,
  {
    ref: o,
...
td.displayName = xi.Root.displayName;
...
const gr = (t) => t === "asc" ? /* @__PURE__ */ i(Ol, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(_l, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Pl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), mh = (t) => ({
  ...
  return e ? e[1] : "";
}, od = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", bh = Object.freeze([
  ...
  return nd(t).forEach((p) => {
    p.startsWith("\\id") && (s = rd(p), l = 0, c = 0), p.startsWith("\\c") && (l = ya(p), c = 0), p.startsWith("\\v") && (c = ya(p), l === 0 && (l = e.chapterNum));
...
function vh({
  ...
  const f = te(n, "%webView_inventory_all%"), w = te(n, "%webView_inventory_approved%"), m = te(n, "%webView_inventory_unapproved%"), b = te(n, "%webView_inventory_unknown%"), h = te(n, "%webView_inventory_scope_currentBook%"), g = te(n, "%webView_inventory_scope_chapter%"), k = te(n, "%webView_inventory_scope_verse%"), C = te(n, "%webView_inventory_filter_text%"), T = te(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = pt(!1), [P, F] = pt("all"), [R, $] = pt(""), [L, D] = pt([]), tt = Rt(() => l ? r instanceof RegExp ? id(l, t, a, s, r) : r(l, t, a, s) : [], [l, r, t, a, s]), J = Rt(() => {
    if (S) return tt;
    const x = [];
    return tt.forEach((O) => {
...
const Hi = E.forwardRef(
  ({
    ...
    return /* @__PURE__ */ i(Yi.Provider, { value: C, children: /* @__PURE__ */ i(sd, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const ud = E.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    ut,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ i($l, {}) : /* @__PURE__ */ i(Il, {}),
...
const se = "scrBook", Td = "scrRef", he = "source", Rd = "details", Od = "Scripture Reference", _d = "Scripture Book", es = "Type", Pd = "Details";
function $d(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ht.bookIdToEnglishName(o.start.book) : r.row.groupingColumnId === se ? Br(o.start) : void 0;
      },
...
}, Na = (t) => `${Id({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function xh({
  sources: t,
  ...
  ne(() => {
    if (l) {
      const R = g.getSelectedRowModel().rowsById, $ = Object.keys(R);
      if ($.length === 1) {
        const L = b.find((D) => Na(D) === $[0]) || void 0;
        L && l(L);
      }
    }
  }, [w, b, l, g]);
  const k = o ?? _d, C = a ?? es, T = [
  ...
  }, P = (R, $) => R.getIsGrouped() ? "" : y("banded-row", $ % 2 === 0 ? "even" : "odd"), F = (R, $, L) => {
    ...
    !e && /* @__PURE__ */ N(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ee, { position: "item-aligned", children: /* @__PURE__ */ i(zc, { children: T.map((R) => /* @__PURE__ */ i(Vt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ N(fr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(mr, { children: g.getHeaderGroups().map((R) => /* @__PURE__ */ i(ce, { children: R.headers.filter(($) => $.column.columnDef.header).map(($) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ i(En, { colSpan: $.colSpan, className: "top-0 tw-sticky", children: $.isPlaceholder ? void 0 : /* @__PURE__ */ N("div", { children: [
          ...
          " ",
          bn($.column.columnDef.header, $.getContext())
        ] }) }, $.id)
      )) }, R.id)) }),
      /* @__PURE__ */ i(hr, { children: g.getRowModel().rows.map((R, $) => {
        const L = Nt();
        return /* @__PURE__ */ i(
          ce,
          {
...
is.displayName = ft.Root.displayName;
...
ss.displayName = ft.Trigger.displayName;
...
ls.displayName = ft.SubTrigger.displayName;
...
cs.displayName = ft.SubContent.displayName;
...
ds.displayName = ft.Content.displayName;
...
ps.displayName = ft.Item.displayName;
...
jd.displayName = ft.CheckboxItem.displayName;
const Bd = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    ft.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(ft.ItemIndicator, { children: /* @__PURE__ */ i(vo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Bd.displayName = ft.RadioItem.displayName;
...
Vd.displayName = ft.Label.displayName;
...
us.displayName = ft.Separator.displayName;
const cn = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var r;
  ...
  if (Xl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    return /* @__PURE__ */ i(is, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ N(Ad, { children: [
      ...
      /* @__PURE__ */ i(
        ...
        {
          className: "tw-z-[250]",
          children: ws(t.groups, t.items, p, e)
        }
      )
    ] }, p)) });
}
...
function Yd() {
  return Sa || (Sa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function T(I) {
      ...
      I === r || I === d || I === a || I === o || I === f || I === w || typeof I == "object" && I !== null && (I.$$typeof === b || I.$$typeof === m || I.$$typeof === s || I.$$typeof === l || I.$$typeof === p || I.$$typeof === g || I.$$typeof === k || I.$$typeof === C || I.$$typeof === h);
    }
    function S(I) {
    ...
    var v = c, P = d, F = l, R = s, $ = e, L = p, D = r, tt = b, J = m, j = n, M = a, A = o, G = f, H = !1;
    function rt(I) {
      return H || (H = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), x(I) || S(I) === c;
    }
    function x(I) {
      return S(I) === d;
    }
    ...
    it.AsyncMode = v, it.ConcurrentMode = P, it.ContextConsumer = F, it.ContextProvider = R, it.Element = $, it.ForwardRef = L, it.Fragment = D, it.Lazy = tt, it.Memo = J, it.Portal = j, it.Profiler = M, it.StrictMode = A, it.Suspense = G, it.isAsyncMode = rt, it.isConcurrentMode = x, it.isContextConsumer = O, it.isContextProvider = U, it.isElement = X, it.isForwardRef = z, it.isFragment = K, it.isLazy = q, it.isMemo = W, it.isPortal = Y, it.isProfiler = Z, it.isStrictMode = Q, it.isSuspense = ct, it.isValidElementType = T, it.typeOf = S;
  }()), it;
}
var Ca;
function hs() {
  return Ca || (Ca = 1, process.env.NODE_ENV === "production" ? Un.exports = Xd() : Un.exports = Yd()), Un.exports;
}
/*
object-assign
(c) Sindre Sorhus
    ...
    function F(x) {
      ...
      function O(U, X, z, K, q) {
        for (var W = U[X], Y = 0; Y < x.length; Y++)
          if (b(W, x[Y]))
            return null;
        var Z = JSON.stringify(x, function(ct, I) {
          var kt = G(I);
          return kt === "symbol" ? String(I) : I;
        });
...
function rp() {
  return Aa || (Aa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var P = s, F = a, R = t, $ = c, L = n, D = w, tt = f, J = e, j = o, M = r, A = d, G = p, H = !1, rt = !1;
    function x(V) {
    ...
    lt.ContextConsumer = P, lt.ContextProvider = F, lt.Element = R, lt.ForwardRef = $, lt.Fragment = L, lt.Lazy = D, lt.Memo = tt, lt.Portal = J, lt.Profiler = j, lt.StrictMode = M, lt.Suspense = A, lt.SuspenseList = G, lt.isAsyncMode = x, lt.isConcurrentMode = O, lt.isContextConsumer = U, lt.isContextProvider = X, lt.isElement = z, lt.isForwardRef = K, lt.isFragment = q, lt.isLazy = W, lt.isMemo = Y, lt.isPortal = Z, lt.isProfiler = Q, lt.isStrictMode = ct, lt.isSuspense = I, lt.isSuspenseList = kt, lt.isValidElementType = S, lt.typeOf = v;
  }()), lt;
}
var Da;
function op() {
...
Er(Cr, Tr, Rr, tu, eu, nu, ru, ou, au, iu, su, lu);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const cu = yt({
...
const Su = ["ownerState"], Cu = ["variants"], Tu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Ru(t) {
  return Object.keys(t).length === 0;
}
function Ou(t) {
...
function $u(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const C = Yl(s, _({
      shouldForwardProp: k,
      label: g
    }, m)), T = (v) => typeof v == "function" && v.__emotion_real !== v || ve(v) ? (P) => Zn(v, _({}, P, {
      theme: Yn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
...
function Ya(t) {
  t = Ce(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Ce(Du(t)).values : t.values;
...
function $s(t, e) {
  return t = Ce(t), e = Uo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, _r(t);
}
function ju(t, e) {
  if (t = Ce(t), e = Uo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Wa(h, "light", C, r), Wa(h, "dark", T, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, m = {
    dark: Zr,
    light: qa
  };
...
const ew = ["none", mt(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), mt(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), mt(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), mt(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), mt(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), mt(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), mt(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), mt(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), mt(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), mt(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), mt(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), mt(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), mt(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), mt(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), mt(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), mt(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), mt(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), mt(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), mt(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), mt(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), mt(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), mt(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), mt(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), mt(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], nw = ["duration", "easing", "delay"], rw = {
...
const dw = (t) => Jn(t) && t !== "classes", An = $u({
  themeId: Yo,
  defaultTheme: Xo,
...
function Rw(t) {
  ...
  const s = Cw(_({}, o, r)), l = ei(r), c = ei(o), d = e(s), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
var Ot = "top", Gt = "bottom", Ut = "right", _t = "left", qo = "auto", Dn = [Ot, Gt, Ut, _t], He = "start", Tn = "end", Aw = "clippingParents", As = "viewport", un = "popper", Dw = "reference", ni = /* @__PURE__ */ Dn.reduce(function(t, e) {
...
function We(t, e, n) {
  ...
  var s = Te(t) ? jt(t) : window, l = s.visualViewport, c = !js() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function tf(t) {
  ...
  if (!(!a || !s)) {
    var f = Qw(o.padding, n), w = Ko(a), m = c === "y" ? Ot : _t, b = c === "y" ? Gt : Ut, h = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = jn(a), C = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, T = h / 2 - g / 2, S = f[m], v = C - w[p] - f[b], P = C / 2 - w[p] / 2 + T, F = yn(S, P, v), R = c;
...
function oi(t) {
  ...
  if (d) {
    ...
    if (P === jt(n) && (P = pe(n), oe(P).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), P = P, o === Ot || (o === _t || o === Ut) && a === Tn) {
      S = Gt;
      var $ = f && P === v && v.visualViewport ? v.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        P[F]
      );
      h -= $ - r.height, h *= c ? 1 : -1;
    }
    if (o === _t || (o === Ot || o === Gt) && a === Tn) {
      T = Ut;
...
function Rn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Aw : l, d = n.rootBoundary, p = d === void 0 ? As : d, f = n.elementContext, w = f === void 0 ? un : f, m = n.altBoundary, b = m === void 0 ? !1 : m, h = n.padding, g = h === void 0 ? 0 : h, k = zs(typeof g != "number" ? g : Fs(g, Dn)), C = w === un ? Dw : un, T = t.rects.popper, S = t.elements[b ? C : w], v = hf(Te(S) ? S : S.contextElement || pe(t.elements.popper), c, p, s), P = We(t.elements.reference), F = Gs({
    reference: P,
    element: T,
    placement: o
  }), R = wo(Object.assign({}, T, F)), $ = w === un ? R : P, L = {
    top: v.top - $.top + k.top,
...
function vf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, m = n.flipVariations, b = m === void 0 ? !0 : m, h = n.allowedAutoPlacements, g = e.options.placement, k = Wt(g), C = k === g, T = c || (C || !b ? [Qn(g)] : bf(g)), S = [g].concat(T).reduce(function(z, K) {
    ...
    }, []), v = e.rects.reference, P = e.rects.popper, F = /* @__PURE__ */ new Map(), R = !0, $ = S[0], L = 0; L < S.length; L++) {
...
function Of(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, m = w === void 0 ? !0 : w, b = n.tetherOffset, h = b === void 0 ? 0 : b, g = Rn(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Wt(e.placement), C = Ke(e.placement), T = !C, S = Jo(k), v = Rf(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, $ = typeof h == "function" ? h(Object.assign({}, e.rects, {
    placement: e.placement
  })) : h, L = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
  ...
  if (P) {
    if (a) {
      var J, j = S === "y" ? Ot : _t, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = P[S], H = G + g[j], rt = G - g[M], x = m ? -R[A] / 2 : 0, O = C === He ? F[A] : R[A], U = C === He ? -R[A] : -F[A], X = e.elements.arrow, z = m && X ? Ko(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Vs(), q = K[j], W = K[M], Y = yn(0, F[A], z[A]), Z = T ? F[A] / 2 - x - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = T ? -F[A] / 2 + x + Y + W + L.mainAxis : U + Y + W + L.mainAxis, ct = e.elements.arrow && jn(e.elements.arrow), I = ct ? S === "y" ? ct.clientTop || 0 : ct.clientLeft || 0 : 0, kt = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - kt - I, xt = G + Q - kt, Yt = yn(m ? ar(H, V) : H, G, m ? xe(rt, xt) : rt);
      P[S] = Yt, tt[S] = Yt - G;
    }
    if (l) {
      var ue, Ct = S === "x" ? Ot : _t, Bn = S === "x" ? Gt : Ut, Ht = P[v], _e = v === "y" ? "height" : "width", we = Ht + g[Ct], Pe = Ht - g[Bn], $e = [Ot, _t].indexOf(k) !== -1, Ie = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = $e ? we : Ht - F[_e] - R[_e] - Ie + L.altAxis, en = $e ? Ht + F[_e] + R[_e] - Ie - L.altAxis : Pe, Vn = m && $e ? Zw(fe, Ht, en) : yn(m ? fe : we, Ht, m ? en : Pe);
      P[v] = Vn, tt[v] = Vn - Ht;
    }
...
function Mf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Lt(e), o = Lt(e) && If(e), a = pe(e), s = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  ta(a)) && (l = $f(e)), Lt(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Qo(a))), {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        h(), p.options = Object.assign({}, a, p.options, C), p.scrollParents = {
          reference: Te(l) ? xn(l) : l.contextElement ? xn(l.contextElement) : [],
          popper: xn(c)
        };
        var T = Df(Bf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (di(C, T)) {
            p.rects = {
              reference: Mf(C, jn(T), p.options.strategy === "fixed"),
              popper: Ko(T)
            ...
            for (var S = 0; S < p.orderedModifiers.length; S++) {
              ...
              var v = p.orderedModifiers[S], P = v.fn, F = v.options, R = F === void 0 ? {} : F, $ = v.name;
...
var zf = [cf, Tf, sf, Ww, Sf, yf, _f, nf, Nf], Ff = /* @__PURE__ */ Vf({
  defaultModifiers: zf
});
const Lf = "Popper";
function Gf(t) {
...
const qf = () => Vo({
  ...
  } = e, g = Et(e, Uf), k = B.useRef(null), C = Se(k, n), T = B.useRef(null), S = Se(T, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
  }, [S]), B.useImperativeHandle(w, () => T.current, []);
  const P = Yf(p, s), [F, R] = B.useState(P), [$, L] = B.useState(ir(o));
  B.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, C = Et(e, Xf), [T, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
...
const nm = {
  ...
  } = e, k = Et(e, em), C = mn(), T = B.useRef(), S = Xs(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
const rm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], om = An(Us, {
  ...
  const o = _s(), a = Ho({
    ...
    slots: T,
    slotProps: S
  } = a, v = Et(a, rm), P = (r = T == null ? void 0 : T.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const le = Ts("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), im = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function sm(t) {
  return Math.round(t * 1e5) / 1e5;
}
const lm = (t) => {
...
const Hs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = Ho({
    ...
    slots: Q = {},
    title: ct,
    TransitionComponent: I = sr,
    TransitionProps: kt
  } = P, V = Et(P, im), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
  }), Yt = Xs(), ue = Yt.direction === "rtl", [Ct, Bn] = B.useState(), [Ht, _e] = B.useState(null), we = B.useRef(!1), Pe = j || rt, $e = mn(), Ie = mn(), fe = mn(), en = mn(), [Vn, na] = Ns({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Ir = xs(x), nn = B.useRef(), zn = co(() => {
  ...
  const ra = (et) => {
    ...
    (et) => {
      wi.start(800 + O, () => {
        qn = !1;
      }), na(!1), X && Qt && X(et), $e.start(Yt.transitions.duration.shortest, () => {
        we.current = !1;
      });
    }
  ), Mr = (et) => {
    we.current && et.type !== "touchstart" || (Ct && Ct.removeAttribute("title"), Ie.clear(), fe.clear(), A || qn && G ? Ie.start(qn ? G : A, () => {
      ra(et);
    }) : ra(et));
  }, oa = (et) => {
    Ie.clear(), fe.start(O, () => {
    ...
    Ct || Bn(et.currentTarget), Zs(et), aa.current === !0 && (ia(!0), Mr(et));
  }, ca = (et) => {
    we.current = !0;
    const It = xt.props;
    It.onTouchStart && It.onTouchStart(et);
  }, da = Mr, pa = oa, tl = (et) => {
    ca(et), fe.clear(), $e.clear(), zn(), nn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", en.start(H, () => {
  ...
  }, rn = {}, Dr = typeof ct == "string";
  D ? (rn.title = !Qt && Dr && !J ? ct : null, rn["aria-describedby"] = Qt ? Ir : null) : (rn["aria-label"] = Dr ? ct : null, rn["aria-labelledby"] = Qt && !Dr ? Ir : null);
...
`));
  const ol = B.useMemo(() => {
    ...
    return (et = Y.popperOptions) != null && et.modifiers && (It = It.concat(Y.popperOptions.modifiers)), _({}, Y.popperOptions, {
      modifiers: It
    });
  }, [Ht, Y]), an = _({}, P, {
    isRtl: ue,
    ...
    touch: we.current
  }), jr = lm(an), ua = (r = (o = Q.popper) != null ? o : $.Popper) != null ? r : cm, wa = (a = (s = (l = Q.transition) != null ? l : $.Transition) != null ? s : I) != null ? a : sr, fa = (c = (d = Q.tooltip) != null ? d : $.Tooltip) != null ? c : dm, ma = (p = (f = Q.arrow) != null ? f : $.Arrow) != null ? p : pm, al = hn(ua, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    ...
    className: ye(jr.tooltip, (k = (C = Z.tooltip) != null ? C : L.tooltip) == null ? void 0 : k.className)
  }), an), ll = hn(ma, _({}, (T = Z.arrow) != null ? T : L.arrow, {
    ...
    children: [/* @__PURE__ */ B.cloneElement(xt, Bt), /* @__PURE__ */ i(ua, _({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(fa, _({}, sl, {
          children: [ct, F ? /* @__PURE__ */ i(ma, _({}, ll, {
            ref: _e
          })) : null]
        }))
      }))
...
function Ph({
  ...
  ne(() => {
    if (c) {
      ...
      if (S) {
        const v = S.getBoundingClientRect(), P = window.scrollY, F = window.scrollX, R = v.top + P + S.clientHeight, $ = v.left + F;
        g({ top: R, left: $ });
      }
    }
  }, [c, o]);
...
const Cm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Ah = $t.Root, Pm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    $t.List,
    {
...
Pm.displayName = $t.List.displayName;
...
$m.displayName = $t.Trigger.displayName;
...
Im.displayName = $t.Content.displayName;
const Dh = (t, e) => {
  ne(() => {
    if (!t) return () => {
    };
...
export {
  ...
  y as cn,
  rd as getBookIdFromUSFM,
  nd as getLinesFromUSFM,
