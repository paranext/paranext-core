import ts, { jsxs as ue, jsx as T, Fragment as Fn } from "react/jsx-runtime";
import * as w from "react";
import Nt, { forwardRef as ns, useState as Xe, useRef as Nn, useCallback as Fe, useMemo as Bt, useEffect as Vn } from "react";
import { getChaptersForBook as wi, offsetBook as yo, FIRST_SCR_BOOK_NUM as rs, offsetChapter as xo, FIRST_SCR_CHAPTER_NUM as os, offsetVerse as wo, FIRST_SCR_VERSE_NUM as is } from "platform-bible-utils";
import * as ge from "@radix-ui/react-dropdown-menu";
import { ChevronRight as as, Check as ss, Circle as ls, History as cs, Tally1 as Eo, ChevronUp as us } from "lucide-react";
import xe, { clsx as ds } from "clsx";
import { twMerge as ps } from "tailwind-merge";
import { Button as fs, Autocomplete as hs, TextField as Ei, FormControlLabel as To, FormLabel as ms, Checkbox as gs, MenuItem as bs, ListItemText as vs, ListItemIcon as Ti, Menu as ys, Grid as ki, List as xs, IconButton as Oi, Drawer as ws, Paper as Es, Slider as Ts, Snackbar as ks, Switch as Os, AppBar as Ss, Toolbar as Cs } from "@mui/material";
import Ps, { ThemeContext as Rs, internal_processStyles as Ns } from "@mui/styled-engine";
import * as $s from "react-dom";
import xn from "react-dom";
import Ms, { SelectColumn as _s } from "react-data-grid";
var Is = Object.defineProperty, As = (e, t, n) => t in e ? Is(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => (As(e, typeof t != "symbol" ? t + "" : t, n), n);
const ht = [
  "GEN",
  "EXO",
  "LEV",
...
function Lt(e, t = !0) {
  return t && (e = e.toUpperCase()), e in ko ? ko[e] : 0;
}
function Ir(e) {
  return Lt(e) > 0;
}
...
const Oe = class oe {
  ...
  allVerses(t = !1, n = oe.verseRangeSeparators, r = oe.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], i = Oo(this._verse, r);
    for (const s of i.map((l) => Oo(l, n))) {
      const l = this.clone();
      l.verse = s[0];
      const c = l.verseNum;
...
const qs = ge.Root, Gs = ge.Trigger, Xs = w.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ ue(
  ge.SubTrigger,
  {
    ref: o,
    className: Qe(
...
const Ks = w.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ T(
  ge.SubContent,
  {
    ref: n,
    className: Qe(
...
const Mi = w.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ T(ge.Portal, { children: /* @__PURE__ */ T(
  ge.Content,
  {
    ref: r,
    sideOffset: t,
...
const Dr = w.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ T(
  ge.Item,
  {
    ref: r,
    className: Qe(
...
const Ys = w.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ ue(
  ge.CheckboxItem,
  {
    ref: o,
    className: Qe(
...
Ys.displayName = ge.CheckboxItem.displayName;
const Js = w.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ue(
  ge.RadioItem,
  {
    ref: r,
    className: Qe(
...
Js.displayName = ge.RadioItem.displayName;
const _i = w.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ T(
  ge.Label,
  {
    ref: r,
...
_i.displayName = ge.Label.displayName;
const Ii = w.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ T(
  ge.Separator,
  {
    ref: n,
...
const Zs = ns(
  ({ handleSearch: e, ...t }, n) => /* @__PURE__ */ ue("div", { children: [
    /* @__PURE__ */ T(
      Ai,
      {
        ...t,
...
function Qs({ endChapter: e, activeChapter: t, handleSelectChapter: n }) {
    ...
    /* @__PURE__ */ ue(
      Dr,
      {
        ...
        children: [
          ...
          n && /* @__PURE__ */ T(us, { name: "chevron-up" })
        ]
      },
      e
    ),
...
function bh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = me, [r, o] = Xe(""), [i, s] = Xe(""), l = Nn(void 0), c = Fe(
    (b) => ({
      OT: n.filter((m) => me.isBookOT(m)),
      NT: n.filter((m) => me.isBookNT(m)),
      DC: n.filter((m) => me.isBookDC(m))
    })[b],
    [n]
  ), u = Fe(
    (b) => c(b).filter(
      (h) => me.bookIdToEnglishName(h).toLowerCase().includes(r.toLowerCase()) || h.toLowerCase().includes(r.toLowerCase())
    ),
    [c, r]
  ), d = (b) => {
    o(b);
  }, f = Fe((b) => wi(me.bookIdToNumber(b)), []), p = (b) => {
    s(i !== b ? b : ""), f(b) === -1 && t({
      bookNum: me.bookIdToNumber(b),
      chapterNum: 1,
      verseNum: 1
    });
  }, v = (b) => {
  ...
  return /* @__PURE__ */ ue("div", { children: [
    /* @__PURE__ */ ue(qs, { children: [
      ...
      /* @__PURE__ */ ue(Mi, { style: { width: "300px", height: "500px", overflowY: "auto" }, children: [
        /* @__PURE__ */ T(
          Dr,
          {
            onSelect: (b) => {
              b.preventDefault(), l.current.focus(), console.log("Attempt to give focus to input");
            },
            children: "Give focus to input"
          }
        ),
        nl.map((b) => /* @__PURE__ */ ue("div", { children: [
          /* @__PURE__ */ T(_i, { children: tl[b] }),
          u(b).map((h) => /* @__PURE__ */ T("div", { children: /* @__PURE__ */ T(
            el,
            {
              bookId: h,
              handleSelectBook: () => p(h),
              isSelected: i === h,
              bookType: b,
              children: /* @__PURE__ */ T(
                Qs,
                {
                  ...
                  endChapter: f(h),
                  activeChapter: e.bookNum === me.bookIdToNumber(h) ? e.chapterNum : 0
                }
              )
            }
          ) }, h)),
          b === "OT" || b === "NT" ? /* @__PURE__ */ T(Ii, {}) : void 0
        ] }, b))
      ] })
    ] }),
    /* @__PURE__ */ T(
...
function rl({
  ...
  let f;
  if (n) {
    const p = r === Pt.Before || r === Pt.Above, v = /* @__PURE__ */ T("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), b = r === Pt.Before || r === Pt.After, h = b ? v : /* @__PURE__ */ T("div", { children: v }), m = b ? d : /* @__PURE__ */ T("div", { children: d });
    f = /* @__PURE__ */ ue(
      ms,
      {
...
function al() {
  if (So)
    return ie;
  So = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, u = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, f = e ? Symbol.for("react.suspense") : 60113, p = e ? Symbol.for("react.suspense_list") : 60120, v = e ? Symbol.for("react.memo") : 60115, b = e ? Symbol.for("react.lazy") : 60116, h = e ? Symbol.for("react.block") : 60121, m = e ? Symbol.for("react.fundamental") : 60117, E = e ? Symbol.for("react.responder") : 60118, $ = e ? Symbol.for("react.scope") : 60119;
  function y(g) {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = b, ie.Memo = v, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(g) {
    return x(g) || y(g) === c;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === u || g === i || g === o || g === f || g === p || typeof g == "object" && g !== null && (g.$$typeof === b || g.$$typeof === v || g.$$typeof === s || g.$$typeof === l || g.$$typeof === d || g.$$typeof === m || g.$$typeof === E || g.$$typeof === $ || g.$$typeof === h);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function sl() {
  return Co || (Co = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(N) {
      ...
      N === r || N === u || N === i || N === o || N === f || N === p || typeof N == "object" && N !== null && (N.$$typeof === b || N.$$typeof === v || N.$$typeof === s || N.$$typeof === l || N.$$typeof === d || N.$$typeof === m || N.$$typeof === E || N.$$typeof === $ || N.$$typeof === h);
    }
    function x(N) {
    ...
    var g = c, S = u, C = l, A = s, I = t, D = d, B = r, z = b, G = v, L = n, _ = i, R = o, j = f, Q = !1;
    function Z(N) {
...
var sr, $o;
function ji() {
  return $o || ($o = 1, sr = Function.call.bind(Object.prototype.hasOwnProperty)), sr;
}
var lr, Mo;
function cl() {
  if (Mo)
...
function ul() {
  if (_o)
    return cr;
  _o = 1;
  var e = Di(), t = ll(), n = jr(), r = ji(), o = cl(), i = function() {
  };
  ...
  return cr = function(l, c) {
    ...
    function m(O) {
      ...
      function X(U, W, q, H, K, Y, ne) {
        ...
        return W[q] == null ? U ? W[q] === null ? new h("The " + K + " `" + Y + "` is marked as required " + ("in `" + H + "`, but its value is `null`.")) : new h("The " + K + " `" + Y + "` is marked as required in " + ("`" + H + "`, but its value is `undefined`.")) : null : O(W, q, H, K, Y);
      }
      var F = X.bind(null, !1);
    ...
    function y(O) {
      function M(V, X, F, U, W) {
        ...
        if (!Array.isArray(q)) {
          var H = R(q);
          return new h("Invalid " + U + " `" + W + "` of type " + ("`" + H + "` supplied to `" + F + "`, expected an array."));
        }
    ...
    function x() {
      function O(M, V, X, F, U) {
        ...
        if (!l(W)) {
          var q = R(W);
          return new h("Invalid " + F + " `" + U + "` of type " + ("`" + q + "` supplied to `" + X + "`, expected a single ReactElement."));
        }
        return null;
      }
      return m(O);
    ...
    function g() {
      function O(M, V, X, F, U) {
        ...
        if (!e.isValidElementType(W)) {
          var q = R(W);
          return new h("Invalid " + F + " `" + U + "` of type " + ("`" + q + "` supplied to `" + X + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return m(O);
    ...
    function S(O) {
      function M(V, X, F, U, W) {
        if (!(V[X] instanceof O)) {
          ...
          return new h("Invalid " + U + " `" + W + "` of type " + ("`" + H + "` supplied to `" + F + "`, expected ") + ("instance of `" + q + "`."));
        }
        return null;
      }
      return m(M);
    ...
    function C(O) {
      ...
      function M(V, X, F, U, W) {
        ...
        return new h("Invalid " + U + " `" + W + "` of value `" + String(q) + "` " + ("supplied to `" + F + "`, expected one of " + K + "."));
      }
      return m(M);
    }
    function A(O) {
      function M(V, X, F, U, W) {
        ...
        var q = V[X], H = R(q);
        if (H !== "object")
          return new h("Invalid " + U + " `" + W + "` of type " + ("`" + H + "` supplied to `" + F + "`, expected an object."));
        for (var K in q)
          if (r(q, K)) {
            var Y = O(q, K, F, U, W + "." + K, n);
            if (Y instanceof Error)
    ...
    function I(O) {
      ...
      function X(F, U, W, q, H) {
        ...
        return new h("Invalid " + q + " `" + H + "` supplied to " + ("`" + W + "`" + J + "."));
      }
      return m(X);
    }
    function D() {
      function O(M, V, X, F, U) {
        return L(M[V]) ? null : new h("Invalid " + F + " `" + U + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return m(O);
    }
    ...
    function z(O) {
      function M(V, X, F, U, W) {
        var q = V[X], H = R(q);
        if (H !== "object")
          return new h("Invalid " + U + " `" + W + "` of type `" + H + "` " + ("supplied to `" + F + "`, expected `object`."));
        for (var K in O) {
          var Y = O[K];
...
if (process.env.NODE_ENV !== "production") {
  var pl = Di(), fl = !0;
  wr.exports = ul()(pl.isElement, fl);
} else
  wr.exports = dl()();
var hl = wr.exports;
const a = /* @__PURE__ */ ol(hl);
function Ft(e, t) {
...
function Ke(e, t, n = {
  ...
  return pt(e) && pt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (pt(t[o]) && o in e && pt(e[o]) ? r[o] = Ke(e[o], t[o], n) : n.clone ? r[o] = pt(t[o]) ? Bi(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function ml(e) {
  const {
...
function Li(e, t, n, r, o) {
  ...
  let l;
  const c = i.type;
  return typeof c == "function" && !ml(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Fi = Ft(a.element, Li);
Fi.isRequired = Ft(a.element.isRequired, Li);
const un = Fi;
function gl(e) {
  const {
    prototype: t = {}
...
function bl(e, t, n, r, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof i == "function" && !gl(i) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const vl = Ft(a.elementType, bl), yl = "exact-prop: ​";
function Vi(e) {
...
function xl() {
  ...
  return se.ContextConsumer = s, se.ContextProvider = i, se.Element = e, se.ForwardRef = c, se.Fragment = n, se.Lazy = p, se.Memo = f, se.Portal = t, se.Profiler = o, se.StrictMode = r, se.Suspense = u, se.SuspenseList = d, se.isAsyncMode = function() {
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === u || m === d || m === v || typeof m == "object" && m !== null && (m.$$typeof === p || m.$$typeof === f || m.$$typeof === i || m.$$typeof === s || m.$$typeof === c || m.$$typeof === b || m.getModuleId !== void 0);
  }, se.typeOf = h, se;
}
var le = {};
/**
...
function wl() {
  return Do || (Do = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), v = Symbol.for("react.offscreen"), b = !1, h = !1, m = !1, E = !1, $ = !1, y;
    y = Symbol.for("react.module.reference");
    function x(P) {
      return !!(typeof P == "string" || typeof P == "function" || P === n || P === o || $ || P === r || P === u || P === d || E || P === v || b || h || m || typeof P == "object" && P !== null && (P.$$typeof === p || P.$$typeof === f || P.$$typeof === i || P.$$typeof === s || P.$$typeof === c || // This needs to include all possible module reference object
    ...
    var S = s, C = i, A = e, I = c, D = n, B = p, z = f, G = t, L = o, _ = r, R = u, j = d, Q = !1, Z = !1;
    function O(P) {
    ...
    le.ContextConsumer = S, le.ContextProvider = C, le.Element = A, le.ForwardRef = I, le.Fragment = D, le.Lazy = B, le.Memo = z, le.Portal = G, le.Profiler = L, le.StrictMode = _, le.Suspense = R, le.SuspenseList = j, le.isAsyncMode = O, le.isConcurrentMode = M, le.isContextConsumer = V, le.isContextProvider = X, le.isElement = F, le.isForwardRef = U, le.isFragment = W, le.isLazy = q, le.isMemo = H, le.isPortal = K, le.isProfiler = Y, le.isStrictMode = ne, le.isSuspense = N, le.isSuspenseList = J, le.isValidElementType = x, le.typeOf = g;
  }()), le;
}
process.env.NODE_ENV === "production" ? Er.exports = xl() : Er.exports = wl();
var $n = Er.exports;
...
const Ol = a.oneOfType([a.func, a.object]), Br = Ol;
function ze(e) {
  if (typeof e != "string")
...
const Rl = typeof window < "u" ? w.useLayoutEffect : w.useEffect, mt = Rl;
let Bo = 0;
function Nl(e) {
...
function Ml(e, t) {
  const n = w.useRef(Fo);
  return n.current === Fo && (n.current = e(t)), n;
}
const _l = [];
function Il(e) {
  w.useEffect(e, _l);
...
function jl(e) {
  ...
  return !!(n === "INPUT" && Dl[t] && !e.readOnly || n === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function Bl(e) {
...
function Fl(e) {
  e.addEventListener("keydown", Bl, !0), e.addEventListener("mousedown", dr, !0), e.addEventListener("pointerdown", dr, !0), e.addEventListener("touchstart", dr, !0), e.addEventListener("visibilitychange", Ll, !0);
}
function Vl(e) {
  const {
    target: t
...
function qi() {
  ...
  function n() {
    return t.current ? (kr = !0, Al.start(100, () => {
      kr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
    return Vl(o) ? (t.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: t,
    onFocus: r,
...
function Ki(e, t, ...n) {
  return e[t] === void 0 ? null : Xi(e, t, ...n);
}
function Or() {
  return null;
}
Ki.isRequired = Xi;
Or.isRequired = Or;
const Yi = process.env.NODE_ENV === "production" ? Or : Ki;
function Ji(e, t) {
  const n = k({}, t);
...
}, Kl = /* @__PURE__ */ w.createContext(Xl);
function Yl(e) {
  const {
...
function Zl(e) {
  ...
  if (!t) {
    const v = xe(n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), b = k({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), h = k({}, n, o, r);
    return v.length > 0 && (h.className = v), Object.keys(b).length > 0 && (h.style = b), {
      props: h,
      internalRef: void 0
    };
  }
  const s = ta(k({}, o, r)), l = zo(r), c = zo(o), u = t(s), d = xe(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), p = k({}, u, n, c, l);
...
function _n(e) {
  const {
    ...
    isEnabled: s = lc,
    open: l
  } = e, c = w.useRef(!1), u = w.useRef(null), d = w.useRef(null), f = w.useRef(null), p = w.useRef(null), v = w.useRef(!1), b = w.useRef(null), h = De(t.ref, b), m = w.useRef(null);
  w.useEffect(() => {
    !l || !b.current || (v.current = !n);
  }, [n, l]), w.useEffect(() => {
    if (!l || !b.current)
      return;
    const y = we(b.current);
    return b.current.contains(y.activeElement) || (b.current.hasAttribute("tabIndex") || (process.env.NODE_ENV !== "production" && console.error(["MUI: The modal content node does not accept focus.", 'For the benefit of assistive technologies, the tabIndex of the node is being set to "-1".'].join(`
`)), b.current.setAttribute("tabIndex", "-1")), v.current && b.current.focus()), () => {
    ...
    if (!l || !b.current)
      return;
    const y = we(b.current), x = (C) => {
      m.current = C, !(r || !s() || C.key !== "Tab") && y.activeElement === b.current && C.shiftKey && (c.current = !0, d.current && d.current.focus());
    }, g = () => {
      const C = b.current;
      if (C === null)
        return;
      ...
      if (!v.current)
        return;
      let A = [];
      if ((y.activeElement === u.current || y.activeElement === d.current) && (A = i(b.current)), A.length > 0) {
        var I, D;
    ...
    return () => {
      clearInterval(S), y.removeEventListener("focusin", g), y.removeEventListener("keydown", x, !0);
    };
  }, [n, r, o, s, l, i]);
  const E = (y) => {
...
const an = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    ...
    container: o,
    disablePortal: i = !1
  } = t, [s, l] = w.useState(null), c = De(/* @__PURE__ */ w.isValidElement(r) ? r.ref : null, n);
  if (mt(() => {
    ...
    return /* @__PURE__ */ T(w.Fragment, {
      children: r
    });
  }
  return /* @__PURE__ */ T(w.Fragment, {
    children: s && /* @__PURE__ */ $s.createPortal(r, s)
  });
});
...
process.env.NODE_ENV !== "production" && (an["propTypes"] = Vi(an.propTypes));
function uc(e) {
  const t = we(e);
  ...
  if (!t.disableScrollLock) {
    if (uc(r)) {
      ...
      n.push({
        ...
        el: r
      }), r.style.paddingRight = `${Uo(r) + s}px`;
      ...
      [].forEach.call(l, (c) => {
        n.push({
          ...
          property: "padding-right",
          el: c
        }), c.style.paddingRight = `${Uo(c) + s}px`;
      });
    }
    let i;
...
class hc {
  ...
  remove(t, n = !0) {
    ...
    if (i.modals.splice(i.modals.indexOf(t), 1), this.modals.splice(r, 1), i.modals.length === 0)
      i.restore && i.restore(), t.modalRef && en(t.modalRef, n), Ho(i.container, t.mount, t.modalRef, i.hiddenSiblings, !1), this.containers.splice(o, 1);
    else {
...
function vc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), v = w.useRef(null), b = w.useRef(null), h = De(b, f), [m, E] = w.useState(!d), $ = gc(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const x = () => we(v.current), g = () => (p.current.modalRef = b.current, p.current.mount = v.current, p.current), S = () => {
    o.mount(g(), {
      disableScrollLock: r
    }), b.current && (b.current.scrollTop = 0);
  }, C = on(() => {
    const R = mc(t) || x().body;
    o.add(g(), R), b.current && S();
  }), A = w.useCallback(() => o.isTopModal(g()), [o]), I = on((R) => {
    v.current = R, R && (d && A() ? S() : b.current && en(b.current, y));
  }), D = w.useCallback(() => {
    o.remove(g(), y);
  }, [y, o]);
  w.useEffect(() => () => {
...
var Se = "top", je = "bottom", Be = "right", Ce = "left", Lr = "auto", pn = [Se, je, Be, Ce], It = "start", sn = "end", yc = "clippingParents", oa = "viewport", Gt = "popper", xc = "reference", Wo = /* @__PURE__ */ pn.reduce(function(e, t) {
  return e.concat([t + "-" + It, t + "-" + sn]);
}, []), ia = /* @__PURE__ */ [].concat(pn, [Lr]).reduce(function(e, t) {
  return e.concat([t, t + "-" + It, t + "-" + sn]);
}, []), wc = "beforeRead", Ec = "read", Tc = "afterRead", kc = "beforeMain", Oc = "main", Sc = "afterMain", Cc = "beforeWrite", Pc = "write", Rc = "afterWrite", Nc = [wc, Ec, Tc, kc, Oc, Sc, Cc, Pc, Rc];
function Ue(e) {
...
function $c(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !Ae(i) || !Ue(i) || (Object.assign(i.style, r), Object.keys(o).forEach(function(s) {
      var l = o[s];
...
function Mc(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !Ae(o) || !Ue(o) || (Object.assign(o.style, l), Object.keys(i).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
function Dt(e, t, n) {
  ...
  var s = bt(e) ? Me(e) : window, l = s.visualViewport, c = !aa() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, d = (r.top + (c && l ? l.offsetTop : 0)) / i, f = r.width / o, p = r.height / i;
  return {
    width: f,
    height: p,
    top: d,
...
function Ac(e) {
  ...
  var o = Un(e);
  for (Fr(o) && (o = o.host); Ae(o) && ["html", "body"].indexOf(Ue(o)) < 0; ) {
    var i = Je(o);
...
function fn(e) {
  for (var t = Me(e), n = qo(e); n && Ic(n) && Je(n).position === "static"; )
    n = qo(n);
  return n && (Ue(n) === "html" || Ue(n) === "body" && Je(n).position === "static") ? t : n || Ac(e) || t;
}
function zr(e) {
...
var jc = function(t, n) {
  ...
  })) : t, ca(typeof t != "number" ? t : ua(t, pn));
};
function Bc(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Ve(n.placement), c = zr(l), u = [Ce, Be].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = jc(o.padding, n), p = Vr(i), v = c === "y" ? Se : Ce, b = c === "y" ? je : Be, h = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], E = fn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = h / 2 - m / 2, x = f[v], g = $ - p[d] - f[b], S = $ / 2 - p[d] / 2 + y, C = tn(x, S, g), A = c;
    n.modifiersData[r] = (t = {}, t[A] = C, t.centerOffset = C - S, t);
  }
}
function Lc(e) {
...
function Go(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, i = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, f = e.isFixed, p = s.x, v = p === void 0 ? 0 : p, b = s.y, h = b === void 0 ? 0 : b, m = typeof d == "function" ? d({
    x: v,
    y: h
  }) : {
    x: v,
  ...
  v = m.x, h = m.y;
  var E = s.hasOwnProperty("x"), $ = s.hasOwnProperty("y"), y = Ce, x = Se, g = window;
  if (u) {
    var S = fn(n), C = "clientHeight", A = "clientWidth";
    if (S === Me(n) && (S = at(n), Je(S).position !== "static" && l === "absolute" && (C = "scrollHeight", A = "scrollWidth")), S = S, o === Se || (o === Ce || o === Be) && i === sn) {
      x = je;
      var I = f && S === g && g.visualViewport ? g.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        S[C]
      );
      h -= I - r.height, h *= c ? 1 : -1;
    }
    if (o === Ce || (o === Se || o === je) && i === sn) {
      y = Be;
      var D = f && S === g && g.visualViewport ? g.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        S[A]
      );
      v -= D - r.width, v *= c ? 1 : -1;
  ...
  if (v = z.x, h = z.y, c) {
    var G;
    return Object.assign({}, B, (G = {}, G[x] = $ ? "0" : "", G[y] = E ? "0" : "", G.transform = (g.devicePixelRatio || 1) <= 1 ? "translate(" + v + "px, " + h + "px)" : "translate3d(" + v + "px, " + h + "px, 0)", G));
  }
  return Object.assign({}, B, (t = {}, t[x] = $ ? h + "px" : "", t[y] = E ? v + "px" : "", t.transform = "", t));
}
function Uc(e) {
  ...
  t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, Go(Object.assign({}, u, {
    offsets: t.modifiersData.popperOffsets,
    position: t.options.strategy,
    adaptive: s,
    roundOffsets: c
  })))), t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, Go(Object.assign({}, u, {
...
function da(e) {
  return ["html", "body", "#document"].indexOf(Ue(e)) >= 0 ? e.ownerDocument.body : Ae(e) && Wr(e) ? e : da(Un(e));
}
function nn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = da(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Me(r), s = o ? [i].concat(i.visualViewport || [], Wr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function Ko(e, t, n) {
  return t === oa ? Cr(Kc(e, n)) : bt(t) ? Jc(t, n) : Cr(Yc(at(e)));
}
function Zc(e) {
  var t = nn(Un(e)), n = ["absolute", "fixed"].indexOf(Je(e).position) >= 0, r = n && Ae(e) ? fn(e) : e;
  return bt(r) ? t.filter(function(o) {
    return bt(o) && sa(o, r) && Ue(o) !== "body";
  }) : [];
}
function Qc(e, t, n, r) {
  var o = t === "clippingParents" ? Zc(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], l = i.reduce(function(c, u) {
    var d = Ko(e, u, r);
...
function pa(e) {
  var t = e.reference, n = e.element, r = e.placement, o = r ? Ve(r) : null, i = r ? jt(r) : null, s = t.x + t.width / 2 - n.width / 2, l = t.y + t.height / 2 - n.height / 2, c;
  switch (o) {
    case Se:
      c = {
        x: s,
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? yc : l, u = n.rootBoundary, d = u === void 0 ? oa : u, f = n.elementContext, p = f === void 0 ? Gt : f, v = n.altBoundary, b = v === void 0 ? !1 : v, h = n.padding, m = h === void 0 ? 0 : h, E = ca(typeof m != "number" ? m : ua(m, pn)), $ = p === Gt ? xc : Gt, y = e.rects.popper, x = e.elements[b ? $ : p], g = Qc(bt(x) ? x : x.contextElement || at(e.elements.popper), c, d, s), S = Dt(e.elements.reference), C = pa({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
  }), A = Cr(Object.assign({}, y, C)), I = p === Gt ? A : S, D = {
  ...
  if (p === Gt && B) {
    ...
    Object.keys(D).forEach(function(G) {
      var L = [Be, je].indexOf(G) >= 0 ? 1 : -1, _ = [Se, je].indexOf(G) >= 0 ? "y" : "x";
      D[G] += z[_] * L;
    });
  }
  return D;
...
function eu(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? ia : c, d = jt(r), f = d ? l ? Wo : Wo.filter(function(b) {
    return jt(b) === d;
  }) : pn, p = f.filter(function(b) {
...
function nu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, v = n.flipVariations, b = v === void 0 ? !0 : v, h = n.allowedAutoPlacements, m = t.options.placement, E = Ve(m), $ = E === m, y = c || ($ || !b ? [Sn(m)] : tu(m)), x = [m].concat(y).reduce(function(F, U) {
      return F.concat(Ve(U) === Lr ? eu(t, {
        placement: U,
        boundary: d,
        rootBoundary: f,
        padding: u,
    ...
    }, []), g = t.rects.reference, S = t.rects.popper, C = /* @__PURE__ */ new Map(), A = !0, I = x[0], D = 0; D < x.length; D++) {
      var B = x[D], z = Ve(B), G = jt(B) === It, L = [Se, je].indexOf(z) >= 0, _ = L ? "width" : "height", R = ln(t, {
        placement: B,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function Jo(e) {
  return [Se, Be, je, Ce].some(function(t) {
    return e[t] >= 0;
  });
}
function ou(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, s = ln(t, {
    ...
    altBoundary: !0
  }), c = Yo(s, r), u = Yo(l, o, i), d = Jo(c), f = Jo(u);
  t.modifiersData[n] = {
...
function au(e, t, n) {
  var r = Ve(e), o = [Ce, Se].indexOf(r) >= 0 ? -1 : 1, i = typeof n == "function" ? n(Object.assign({}, t, {
    placement: e
  })) : n, s = i[0], l = i[1];
  return s = s || 0, l = (l || 0) * o, [Ce, Be].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function pu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, v = p === void 0 ? !0 : p, b = n.tetherOffset, h = b === void 0 ? 0 : b, m = ln(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), E = Ve(t.placement), $ = jt(t.placement), y = !$, x = zr(E), g = du(x), S = t.modifiersData.popperOffsets, C = t.rects.reference, A = t.rects.popper, I = typeof h == "function" ? h(Object.assign({}, t.rects, {
    placement: t.placement
  })) : h, D = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (S) {
    if (i) {
      var G, L = x === "y" ? Se : Ce, _ = x === "y" ? je : Be, R = x === "y" ? "height" : "width", j = S[x], Q = j + m[L], Z = j - m[_], O = v ? -A[R] / 2 : 0, M = $ === It ? C[R] : A[R], V = $ === It ? -A[R] : -C[R], X = t.elements.arrow, F = v && X ? Vr(X) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : la(), W = U[L], q = U[_], H = tn(0, C[R], F[R]), K = y ? C[R] / 2 - O - H - W - D.mainAxis : M - H - W - D.mainAxis, Y = y ? -C[R] / 2 + O + H + q + D.mainAxis : V + H + q + D.mainAxis, ne = t.elements.arrow && fn(t.elements.arrow), N = ne ? x === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[x]) != null ? G : 0, P = j + K - J - N, re = j + Y - J, ve = tn(v ? In(Q, P) : Q, j, v ? ft(Z, re) : Z);
      S[x] = ve, z[x] = ve - j;
    }
    if (l) {
      var Te, he = x === "x" ? Se : Ce, lt = x === "x" ? je : Be, ke = S[g], We = g === "y" ? "height" : "width", Pe = ke + m[he], qe = ke - m[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[g]) != null ? Te : 0, ct = ye ? Pe : ke - C[We] - A[We] - yt + D.altAxis, Vt = ye ? ke + C[We] + A[We] - yt - D.altAxis : qe, bn = v && ye ? Dc(ct, ke, Vt) : tn(v ? ct : Pe, ke, v ? Vt : qe);
      S[g] = bn, z[g] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
function bu(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ae(t), o = Ae(t) && gu(t), i = at(t), s = Dt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Wr(i)) && (l = mu(t)), Ae(t) ? (c = Dt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Hr(i))), {
...
function Eu(e) {
  e === void 0 && (e = {});
  var t = e, n = t.defaultModifiers, r = n === void 0 ? [] : n, o = t.defaultOptions, i = o === void 0 ? Zo : o;
  return function(l, c, u) {
    ...
    var d = {
      ...
      setOptions: function(E) {
        ...
        h(), d.options = Object.assign({}, i, d.options, $), d.scrollParents = {
          reference: bt(l) ? nn(l) : l.contextElement ? nn(l.contextElement) : [],
          popper: nn(c)
        };
        var y = yu(wu([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!p) {
          ...
          if (Qo($, y)) {
            d.rects = {
              reference: bu($, fn(y), d.options.strategy === "fixed"),
              popper: Vr(y)
            ...
            for (var x = 0; x < d.orderedModifiers.length; x++) {
              ...
              var g = d.orderedModifiers[x], S = g.fn, C = g.options, A = C === void 0 ? {} : C, I = g.name;
...
var Tu = [qc, uu, Hc, _c, lu, ru, fu, Fc, iu], ku = /* @__PURE__ */ Eu({
  defaultModifiers: Tu
});
const fa = "Popper";
function Ou(e) {
...
nc(fa, ["root"]);
const Su = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Cu = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Pu(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const Nu = () => et({
  root: ["root"]
}, Yl(Ou)), $u = {}, Mu = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, m = ce(t, Su), E = w.useRef(null), $ = De(E, n), y = w.useRef(null), x = De(y, p), g = w.useRef(x);
  mt(() => {
    g.current = x;
  }, [x]), w.useImperativeHandle(p, () => y.current, []);
  const S = Pu(d, s), [C, A] = w.useState(S), [I, D] = w.useState(An(o));
  w.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && I && Hn(I) && I.nodeType === 1) {
...
`));
  ...
  const z = Nu(), G = (r = b.root) != null ? r : "div", L = gt({
    elementType: G,
...
}), ha = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    anchorEl: r,
    children: o,
    container: i,
  ...
  if (i)
    ...
    const D = An(r);
    C = D && Hn(D) ? we(D).body : we(null).body;
  }
  const A = !d && c && (!h || y) ? "none" : void 0, I = h ? {
    in: d,
    onEnter: g,
    onExited: S
  } : void 0;
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || Ru(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
const _u = ["values", "unit", "step"], Iu = (e) => {
...
function Au(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = ce(e, _u), i = Iu(t), s = Object.keys(i);
  function l(p) {
  ...
  function u(p, v) {
    const b = s.indexOf(v);
    return `@media (min-width:${typeof t[p] == "number" ? t[p] : p}${n}) and (max-width:${(b !== -1 && typeof t[s[b]] == "number" ? t[s[b]] : v) - r / 100}${n})`;
  }
  function d(p) {
...
const Du = {
  borderRadius: 4
}, ju = Du, Bu = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.string, a.object, a.array]) : {}, st = Bu;
function rn(e, t) {
  return t ? Ke(e, t, {
    clone: !1
...
function be(e) {
  const {
    ...
    return Ze(s, l, (f) => {
      let p = Dn(u, o, f);
      return f === p && typeof f == "string" && (p = Dn(u, o, `${t}${f === "default" ? "" : ze(f)}`, f)), n === !1 ? p : {
        [n]: p
      };
    });
  };
...
const zu = {
  ...
  if (e.length > 2)
    if (ti[e])
      ...
      return [e];
  const [t, n] = e.split(""), r = zu[t], o = Uu[n] || "";
  return Array.isArray(o) ? o.map((i) => r + i) : [r + o];
}), qn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Gn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Wu = [...qn, ...Gn];
function hn(e, t, n, r) {
  var o;
...
function Gu(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = Hu(n), i = qu(o, r), s = e[n];
  return Ze(e, s, i);
}
function ga(e, t) {
  const n = ma(e.theme);
  return Object.keys(e).map((r) => Gu(e, t, r, n)).reduce(rn, {});
}
function pe(e) {
  return ga(e, qn);
}
...
fe.filterProps = Gn;
process.env.NODE_ENV !== "production" && Wu.reduce((e, t) => (e[t] = st, e), {});
function Xu(e = 8) {
  if (e.mui)
    return e;
  const t = ma({
...
const Ku = Le("border", Ie), Yu = Le("borderTop", Ie), Ju = Le("borderRight", Ie), Zu = Le("borderBottom", Ie), Qu = Le("borderLeft", Ie), ed = Le("borderColor"), td = Le("borderTopColor"), nd = Le("borderRightColor"), rd = Le("borderBottomColor"), od = Le("borderLeftColor"), id = Le("outline", Ie), ad = Le("outlineColor"), Kn = (e) => {
...
Xn(Ku, Yu, Ju, Zu, Qu, ed, td, nd, rd, od, Kn, id, ad);
const Yn = (e) => {
...
Xn(Yn, Jn, Zn, sd, ld, cd, ud, dd, pd, fd, hd, md);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const gd = be({
...
function Pd() {
  function e(n, r, o, i) {
    ...
    const p = Wn(o, u) || {};
    return f ? f(s) : Ze(s, r, (b) => {
      let h = Dn(p, d, b);
      return b === h && typeof b == "string" && (h = Dn(p, d, `${n}${b === "default" ? "" : ze(b)}`, b)), c === !1 ? h : {
        [c]: h
      };
    });
  }
  function t(n) {
    ...
    function l(c) {
      ...
      if (!u)
        return null;
      const d = Lu(i.breakpoints), f = Object.keys(d);
      let p = d;
...
const Nd = ["breakpoints", "palette", "spacing", "shape"];
function Yr(e = {}, ...t) {
  const {
    breakpoints: n = {},
    palette: r = {},
  ...
  return u.applyStyles = Rd, u = t.reduce((d, f) => Ke(d, f), u), u.unstable_sxConfig = k({}, Xr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Kr({
      sx: f,
      theme: this
    });
...
const _d = ["ownerState"], Id = ["variants"], Ad = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Dd(e) {
  return Object.keys(e).length === 0;
}
function jd(e) {
...
const Bd = Yr(), ni = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Tn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Fd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    Ns(s, (g) => g.filter((S) => !(S != null && S.__mui_systemSx)));
    const {
      name: c,
      slot: u,
      ...
      overridesResolver: p = Ld(ni(u))
    } = l, v = ce(l, Ad), b = d !== void 0 ? d : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      u && u !== "Root" && u !== "root" || !1
    ), h = f || !1;
    let m;
    process.env.NODE_ENV !== "production" && c && (m = `${c}-${ni(u || "Root")}`);
    let E = Cn;
    u === "Root" || u === "root" ? E = r : u ? E = o : jd(s) && (E = void 0);
    const $ = Ps(s, k({
      shouldForwardProp: E,
      label: m
    }, v)), y = (g) => typeof g == "function" && g.__emotion_real !== g || pt(g) ? (S) => Pn(g, k({}, S, {
      theme: Tn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let B;
        c && (B = `${c}${ze(u || "")}`), B === void 0 && (B = `Styled(${kl(s)})`), D.displayName = B;
      }
...
function Jr(e, t = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > n) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${n}].`), Gl(e, t, n);
}
function Ud(e) {
  e = e.slice(1);
...
function ri(e) {
  e = vt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? vt(Hd(e)).values : e.values;
...
const Xd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ot = np, rp = ["mode", "contrastThreshold", "tonalOffset"], ii = {
...
function ai(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = qd(e.main, o) : t === "dark" && (e.dark = Wd(e.main, i)));
}
function op(e = "light") {
  return e === "dark" ? {
    main: Tt[200],
...
function up(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ce(e, rp), i = e.primary || op(t), s = e.secondary || ip(t), l = e.error || ap(t), c = e.info || sp(t), u = e.success || lp(t), d = e.warning || cp(t);
  function f(h) {
    const m = oi(h, fr.text.primary) >= n ? fr.text.primary : ii.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = oi(h, m);
...
`));
  ...
  const p = ({
    ...
    if (h = k({}, h), !h.main && h[E] && (h.main = h[E]), !h.hasOwnProperty("main"))
...
} });` : Mt(12, m ? ` (${m})` : "", JSON.stringify(h.main)));
    return ai(h, "light", $, r), ai(h, "dark", y, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, v = {
    dark: fr,
    light: ii
  };
  return process.env.NODE_ENV !== "production" && (v[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), Ke(k({
...
function fp(e, t) {
  ...
  const v = o / 14, b = f || ((E) => `${E / u * v}rem`), h = (E, $, y, x, g) => k({
    fontFamily: r,
    fontWeight: E,
    fontSize: b($),
    ...
    button: h(l, 14, 1.75, 0.4, si),
    caption: h(s, 12, 1.66, 0.4),
    overline: h(s, 12, 2.66, 1, si),
...
const hp = 0.2, mp = 0.14, gp = 0.12;
function de(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${hp})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${mp})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${gp})`].join(",");
}
const bp = ["none", de(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), de(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), de(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), de(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), de(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), de(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), de(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), de(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), de(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), de(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), de(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), de(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), de(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), de(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), de(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), de(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), de(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), de(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), de(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), de(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), de(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), de(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), de(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), de(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], vp = bp, yp = ["duration", "easing", "delay"], xp = {
...
function Tp(e) {
  const t = k({}, xp, e.easing), n = k({}, wp, e.duration);
  return k({
...
const kp = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Op = kp, Sp = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Cp(e = {}, ...t) {
  const {
    mixins: n = {},
    palette: r = {},
  ...
  if (u = Ke(u, s), u = t.reduce((d, f) => Ke(d, f), u), process.env.NODE_ENV !== "production") {
    const d = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], f = (p, v) => {
      ...
      for (b in p) {
        ...
        if (d.indexOf(b) !== -1 && Object.keys(h).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const m = He("", b);
            console.error([`MUI: The \`${v}\` component increases the CSS specificity of the \`${b}\` internal state.`, "You can not override it like this: ", JSON.stringify(p, null, 2), "", `Instead, you need to use the '&.${m}' syntax:`, JSON.stringify({
              root: {
                [`&.${m}`]: h
              }
...
const Pp = Cp(), Zr = Pp, Qr = "$$material", xa = (e) => Cn(e) && e !== "classes", Rp = Fd({
  themeId: Qr,
  defaultTheme: Zr,
...
function gn() {
  const e = ya(Zr);
  return process.env.NODE_ENV !== "production" && w.useDebugValue(e), e[Qr] || e;
}
function tt({
  props: e,
  name: t
...
var $p = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.shape({
  enter: a.number,
  exit: a.number,
  appear: a.number
}).isRequired]) : null;
...
const Ip = {
...
}, hr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), eo = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = t, E = ce(t, _p), $ = Jt(), y = w.useRef(), x = gn(), g = w.useRef(null), S = De(g, i.ref, n), C = (_) => (R) => {
    if (_) {
      const j = g.current;
      R === void 0 ? _(j) : _(j, R);
    }
    ...
    let O;
    h === "auto" ? (O = x.transitions.getAutoHeightDuration(_.clientHeight), y.current = O) : O = j, _.style.transition = [x.transitions.create("opacity", {
      duration: O,
      delay: Q
    ...
    let Z;
    h === "auto" ? (Z = x.transitions.getAutoHeightDuration(_.clientHeight), y.current = Z) : Z = R, _.style.transition = [x.transitions.create("opacity", {
      duration: Z,
      delay: j
    }), x.transitions.create("transform", {
      ...
      easing: Q
    })].join(","), _.style.opacity = 0, _.style.transform = Nr(0.75), f && f(_);
  }), G = C(p);
  return /* @__PURE__ */ T(m, k({
    ...
    onExiting: B,
    addEndListener: (_) => {
      h === "auto" && $.start(y.current || 0, _), r && r(g.current, _);
    },
    timeout: h === "auto" ? null : h
  }, E, {
    children: (_, R) => /* @__PURE__ */ w.cloneElement(i, k({
      style: k({
        opacity: 0,
        transform: Nr(0.75),
        visibility: _ === "exited" && !l ? "hidden" : void 0
      }, Ip[_], b, i.props.style),
      ref: S
    }, R))
  }));
});
...
}, di = Ap, Dp = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], jp = Ee(ha, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), ka = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const o = va(), i = tt({
    props: t,
    name: "MuiPopper"
    ...
    slots: y,
    slotProps: x
  } = i, g = ce(i, Dp), S = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, C = k({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Lp = it("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ot = Lp, Fp = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Vp(e) {
  return Math.round(e * 1e5) / 1e5;
}
const zp = (e) => {
...
const Sa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, v, b, h, m, E, $, y, x, g;
  const S = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: J
  } = S, P = ce(S, Fp), re = /* @__PURE__ */ w.isValidElement(A) ? A : /* @__PURE__ */ T("span", {
    children: A
  }), ve = gn(), Te = ve.direction === "rtl", [he, lt] = w.useState(), [ke, We] = w.useState(null), Pe = w.useRef(!1), qe = L || Z, ye = Jt(), yt = Jt(), ct = Jt(), Vt = Jt(), [bn, oo] = Wi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const io = (ee) => {
    ...
    (ee) => {
      pi.start(800 + M, () => {
        kn = !1;
      }), oo(!1), X && Ge && X(ee), ye.start(ve.transitions.duration.shortest, () => {
        Pe.current = !1;
      });
    }
  ), tr = (ee) => {
    Pe.current && ee.type !== "touchstart" || (he && he.removeAttribute("title"), yt.clear(), ct.clear(), R || kn && j ? yt.start(kn ? j : R, () => {
      io(ee);
    }) : io(ee));
  }, ao = (ee) => {
    yt.clear(), ct.start(M, () => {
    ...
    onFocus: Ha,
    ref: Wa
  } = qi(), [, lo] = w.useState(!1), co = (ee) => {
    Ua(ee), so.current === !1 && (lo(!1), ao(ee));
  }, uo = (ee) => {
    he || lt(ee.currentTarget), Ha(ee), so.current === !0 && (lo(!0), tr(ee));
  }, po = (ee) => {
    Pe.current = !0;
    const Re = re.props;
  ...
  const Xa = De(re.ref, Wa, lt, n);
  !ne && ne !== 0 && (Ge = !1);
  const nr = w.useRef(), Ka = (ee) => {
    const Re = re.props;
  ...
  B ? (Ut.title = !Ge && rr && !G ? ne : null, Ut["aria-describedby"] = Ge ? er : null) : (Ut["aria-label"] = rr ? ne : null, Ut["aria-labelledby"] = Ge && !rr ? er : null);
  const _e = k({}, Ut, P, re.props, {
  ...
  process.env.NODE_ENV !== "production" && (_e["data-mui-internal-clone-element"] = !0, w.useEffect(() => {
...
`));
  ...
  const Ht = {};
  _ || (_e.onTouchStart = qa, _e.onTouchEnd = Ga), G || (_e.onMouseOver = On(fo, _e.onMouseOver), _e.onMouseLeave = On(ho, _e.onMouseLeave), qe || (Ht.onMouseOver = fo, Ht.onMouseLeave = ho)), z || (_e.onFocus = On(uo, _e.onFocus), _e.onBlur = On(co, _e.onBlur), qe || (Ht.onFocus = uo, Ht.onBlur = co)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Ya = w.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Pe.current
  }), or = zp(Wt), mo = (r = (o = Y.popper) != null ? o : I.Popper) != null ? r : Up, go = (i = (s = (l = Y.transition) != null ? l : I.Transition) != null ? s : N) != null ? i : $r, bo = (c = (u = Y.tooltip) != null ? u : I.Tooltip) != null ? c : Hp, vo = (d = (f = Y.arrow) != null ? f : I.Arrow) != null ? d : Wp, Ja = Zt(mo, k({}, H, (p = K.popper) != null ? p : D.popper, {
    className: xe(or.popper, H == null ? void 0 : H.className, (v = (b = K.popper) != null ? b : D.popper) == null ? void 0 : v.className)
  }), Wt), Za = Zt(go, k({}, J, (h = K.transition) != null ? h : D.transition), Wt), Qa = Zt(bo, k({}, (m = K.tooltip) != null ? m : D.tooltip, {
    className: xe(or.tooltip, (E = ($ = K.tooltip) != null ? $ : D.tooltip) == null ? void 0 : E.className)
  }), Wt), es = Zt(vo, k({}, (y = K.arrow) != null ? y : D.arrow, {
    className: xe(or.arrow, (x = (g = K.arrow) != null ? g : D.arrow) == null ? void 0 : x.className)
  }), Wt);
  return /* @__PURE__ */ ue(w.Fragment, {
    children: [/* @__PURE__ */ w.cloneElement(re, _e), /* @__PURE__ */ T(mo, k({
      as: q ?? Oa,
      placement: W,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ ue(bo, k({}, Qa, {
          children: [ne, C ? /* @__PURE__ */ T(vo, k({}, es, {
            ref: We
          })) : null]
        }))
      }))
...
const Kp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Yp = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
...
}), no = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = tt({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, v = ce(r, Kp), b = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", h = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
  ...
  return /* @__PURE__ */ ue(Jp, k({
    ...
    ownerState: h,
    children: [b ? o.props.children : o, f ? /* @__PURE__ */ T("title", {
      children: f
    }) : null]
  }));
});
...
function Pa(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${t}Icon`), n.muiName = fi.muiName, /* @__PURE__ */ w.memo(/* @__PURE__ */ w.forwardRef(n));
}
const Zp = {
  configure: (e) => {
...
}, Symbol.toStringTag, { value: "Module" })), ef = /* @__PURE__ */ il(Qp);
var hi;
function tf() {
...
var Ra = to.default = void 0, rf = nf(tf()), of = ts;
Ra = to.default = (0, rf.default)(/* @__PURE__ */ (0, of.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function mi(e, t, n) {
  ...
  const {
    ...
    bs,
    {
      ...
      children: n ? /* @__PURE__ */ ue(Fn, { children: [
        mi(i, n, !0),
        /* @__PURE__ */ T(vs, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ T(Ti, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ T(Ra, {}) }) : mi(s, n, !1)
      ] }) : m
    }
  );
...
function af(e) {
  ...
  return /* @__PURE__ */ ue(Fn, { children: [
    /* @__PURE__ */ T(Na, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ T(
      ys,
      {
        anchorEl: t,
...
const sf = (e, t) => t.filter((o) => o.group === e).sort((o, i) => (o.order || 0) - (i.order || 0));
function ro(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: i, allowForLeadingIcons: s } = Bt(() => {
    const d = o && o.length > 0 ? o : (
      ...
      $a(t).filter((b) => !("menuItem" in b.group))
    ), f = Object.values(d).sort(
      (b, h) => (b.group.order || 0) - (h.group.order || 0)
    ), p = [];
    f.forEach((b) => {
      sf(b.id, t.items).forEach(
        (h) => p.push({ item: h, isLastItemInGroup: !1 })
...
const Ma = /* @__PURE__ */ w.createContext({});
...
const ff = ["children", "className", "component", "dense", "disablePadding", "subheader"], hf = (e) => {
  const {
    classes: t,
    disablePadding: n,
    dense: r,
  ...
  paddingTop: 0
})), _a = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = tt({
    props: t,
    name: "MuiList"
  }), {
  ...
  return /* @__PURE__ */ T(df.Provider, {
    value: f,
    children: /* @__PURE__ */ ue(mf, k({
      as: s,
...
const gf = _a, bf = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function gr(e, t, n) {
...
const Aa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
  ...
  } = t, p = ce(t, bf), v = w.useRef(null), b = w.useRef({
    keys: [],
    repeating: !0,
  ...
  mt(() => {
    ...
    adjustStyleForScrollbar: (y, x) => {
      ...
      if (y.clientHeight < v.current.clientHeight && g) {
        const S = `${Gi(we(y))}px`;
        v.current.style[x.direction === "rtl" ? "paddingLeft" : "paddingRight"] = S, v.current.style.width = `calc(100% + ${S})`;
      }
      return v.current;
    }
  }), []);
  const h = (y) => {
    const x = v.current, g = y.key, S = we(x).activeElement;
    if (g === "ArrowDown")
      y.preventDefault(), Yt(x, S, u, c, gr);
    else if (g === "ArrowUp")
      y.preventDefault(), Yt(x, S, u, c, gi);
    else if (g === "Home")
      y.preventDefault(), Yt(x, null, u, c, gr);
    else if (g === "End")
      y.preventDefault(), Yt(x, null, u, c, gi);
    else if (g.length === 1) {
      const C = b.current, A = g.toLowerCase(), I = performance.now();
      C.keys.length > 0 && (I - C.lastTime > 500 ? (C.keys = [], C.repeating = !0, C.previousKeyMatched = !0) : C.repeating && A !== C.keys[0] && (C.repeating = !1)), C.lastTime = I, C.keys.push(A);
      const D = S && !C.repeating && Ia(S, C);
      C.previousKeyMatched && (D || Yt(x, S, !1, c, gr, C)) ? y.preventDefault() : C.previousKeyMatched = !1;
    }
    d && d(y);
  }, m = De(v, n);
  let E = -1;
...
`)), y.props.disabled || (f === "selectedMenu" && y.props.selected || E === -1) && (E = x), E === x && (y.props.disabled || y.props.muiSkipListHighlight || y.type.muiSkipListHighlight) && (E += 1, E >= s.length && (E = -1));
  ...
  const $ = w.Children.map(s, (y, x) => {
    if (x === E) {
      const g = {};
      return i && (g.autoFocus = !0), y.props.tabIndex === void 0 && f === "selectedMenu" && (g.tabIndex = 0), /* @__PURE__ */ w.cloneElement(y, g);
    }
    return y;
  });
  return /* @__PURE__ */ T(gf, k({
    role: "menu",
    ref: m,
    className: l,
    onKeyDown: h,
...
const vf = Aa, yf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], xf = {
  entering: {
    opacity: 1
  },
  entered: {
...
}, Da = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = gn(), o = {
  ...
  } = t, y = ce(t, yf), x = w.useRef(null), g = De(x, l.ref, n), S = (L) => (_) => {
    if (L) {
      const R = x.current;
      _ === void 0 ? L(R) : L(R, _);
    }
    ...
    L.style.webkitTransition = r.transitions.create("opacity", _), L.style.transition = r.transitions.create("opacity", _), v && v(L);
  }), z = S(b);
  return /* @__PURE__ */ T($, k({
    appear: s,
    in: u,
    ...
    children: (L, _) => /* @__PURE__ */ w.cloneElement(l, k({
      style: k({
        opacity: 0,
...
const Tf = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], kf = (e) => {
  const {
    classes: t,
    invisible: n
  } = e;
...
})), ja = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o, i;
  const s = tt({
    props: t,
    name: "MuiBackdrop"
    ...
    slotProps: b = {},
    slots: h = {},
    TransitionComponent: m = wf,
    transitionDuration: E
  } = s, $ = ce(s, Tf), y = k({}, s, {
    component: u,
    invisible: p
  }), x = kf(y), g = (r = b.root) != null ? r : f.root;
  return /* @__PURE__ */ T(m, k({
    in: v,
    timeout: E
  }, $, {
    children: /* @__PURE__ */ T(Of, k({
      "aria-hidden": !0
    }, g, {
      as: (o = (i = h.root) != null ? i : d.Root) != null ? o : u,
      className: xe(x.root, c, g == null ? void 0 : g.className),
      ownerState: k({}, y, g == null ? void 0 : g.ownerState),
      classes: x,
      ref: n,
      children: l
    }))
...
const Pf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Rf = (e) => {
  const {
    open: t,
    exited: n,
    classes: r
  ...
  zIndex: -1
}), Ba = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o, i, s, l, c;
  const u = tt({
    name: "MuiModal",
    props: t
  }), {
    BackdropComponent: d = $f,
    BackdropProps: f,
    className: p,
  ...
  if (b.props.tabIndex === void 0 && (W.tabIndex = "-1"), X) {
    const {
      onEnter: J,
      onExited: P
    } = Z();
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : Nf, H = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : E.Backdrop) != null ? i : d, K = (l = G == null ? void 0 : G.root) != null ? l : $.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : $.backdrop, ne = gt({
    elementType: q,
    externalSlotProps: K,
    ...
    ownerState: F,
    className: xe(p, K == null ? void 0 : K.className, U == null ? void 0 : U.root, !F.open && F.exited && (U == null ? void 0 : U.hidden))
  }), N = gt({
    elementType: H,
    externalSlotProps: Y,
    additionalProps: f,
  ...
  return !D && !z && (!X || V) ? null : /* @__PURE__ */ T(an, {
    ...
    children: /* @__PURE__ */ ue(q, k({}, ne, {
      children: [!I && d ? /* @__PURE__ */ T(H, k({}, N)) : null, /* @__PURE__ */ T(_n, {
        disableEnforceFocus: x,
        disableAutoFocus: y,
        disableRestoreFocus: C,
        isEnabled: M,
        open: z,
        children: /* @__PURE__ */ w.cloneElement(b, W)
      })]
    }))
  });
});
...
const If = ["className", "component", "elevation", "square", "variant"], Af = (e) => {
  const {
    square: t,
    elevation: n,
    variant: r,
  ...
  return k({
    ...
    backgroundImage: `linear-gradient(${jn("#fff", di(t.elevation))}, ${jn("#fff", di(t.elevation))})`
  }, e.vars && {
    backgroundImage: (n = e.vars.overlays) == null ? void 0 : n[t.elevation]
  }));
}), La = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = tt({
    props: t,
    name: "MuiPaper"
  }), {
...
const Lf = ["onEntering"], Ff = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], Vf = ["slotProps"];
function bi(e, t) {
  let n = 0;
...
const zf = (e) => {
  ...
  outline: 0
}), Va = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o, i;
  const s = tt({
    props: t,
    name: "MuiPopover"
  ...
  } = s, D = ce(s.TransitionProps, Lf), B = ce(s, Ff), z = (r = x == null ? void 0 : x.paper) != null ? r : $, G = w.useRef(), L = De(G, z.ref), _ = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: h,
    marginThreshold: m,
    ...
    TransitionProps: D
  }), R = zf(_), j = w.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = Rn(c), P = J && J.nodeType === 1 ? J : we(G.current).body, re = P.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    return {
      top: re.top + bi(re, u.vertical),
      left: re.left + vi(re, u.horizontal)
    };
  }, [c, u.horizontal, u.vertical, d, f]), Q = w.useCallback((J) => ({
    vertical: bi(J, g.vertical),
    horizontal: vi(J, g.horizontal)
  }), [g.horizontal, g.vertical]), Z = w.useCallback((J) => {
    const P = {
      width: J.offsetWidth,
    ...
    if (f === "none")
      return {
        top: null,
        left: null,
        transformOrigin: yi(re)
      };
    const ve = j();
    let Te = ve.top - re.vertical, he = ve.left - re.horizontal;
    const lt = Te + P.height, ke = he + P.width, We = _t(Rn(c)), Pe = We.innerHeight - m, qe = We.innerWidth - m;
    if (m !== null && Te < m) {
      const ye = Te - m;
    ...
    if (process.env.NODE_ENV !== "production" && P.height > Pe && P.height && Pe && console.error(["MUI: The popover component is too tall.", `Some part of it can not be seen on the screen (${P.height - Pe}px).`, "Please consider adding a `max-height` to improve the user-experience."].join(`
`)), m !== null && he < m) {
      const ye = he - m;
    ...
    if (!J)
      return;
    const P = Z(J);
    P.top !== null && (J.style.top = P.top), P.left !== null && (J.style.left = P.left), J.style.transformOrigin = P.transformOrigin, M(!0);
  }, [Z]);
  ...
  let U = C;
  C === "auto" && !S.muiSupportAuto && (U = void 0);
  const W = b || (c ? we(Rn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : Uf, H = (i = y == null ? void 0 : y.paper) != null ? i : Fa, K = gt({
    elementType: H,
    ...
    ownerState: _,
    className: xe(R.root, v)
  }), {
    slotProps: ne
  } = Y, N = ce(Y, Vf);
  return /* @__PURE__ */ T(q, k({}, N, !ea(q) && {
    slotProps: ne,
    disableScrollLock: I
  }, {
...
const qf = ["onEntering"], Gf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Xf = {
  vertical: "top",
  horizontal: "right"
}, Kf = {
  vertical: "top",
  ...
  shouldForwardProp: (e) => xa(e) || e === "classes",
  name: "MuiMenu",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), Zf = Ee(Fa, {
  ...
  // We disable the focus ring for mouse, touch and keyboard users.
  outline: 0
}), za = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o;
  const i = tt({
    props: t,
    name: "MuiMenu"
    ...
    slots: $ = {},
    slotProps: y = {}
  } = i, x = ce(i.TransitionProps, qf), g = ce(i, Gf), S = gn(), C = S.direction === "rtl", A = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: x,
    variant: E
  }), I = Yf(A), D = s && !u && p, B = w.useRef(null), z = (Z, O) => {
  ...
  w.Children.map(l, (Z, O) => {
    /* @__PURE__ */ w.isValidElement(Z) && (process.env.NODE_ENV !== "production" && $n.isFragment(Z) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  });
  const _ = (r = $.paper) != null ? r : Zf, R = (o = y.paper) != null ? o : v, j = gt({
    elementType: $.root,
  ...
  return /* @__PURE__ */ T(Jf, k({
    onClose: f,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: C ? "right" : "left"
    },
    transformOrigin: C ? Xf : Kf,
    slots: {
      paper: _,
      root: $.root
    },
    ...
    children: /* @__PURE__ */ T(Qf, k({
      ...
      className: xe(I.list, d.className),
      children: l
    }))
  }));
});
...
function yh({
  ...
  var u;
  const [o, i] = Nt.useState(void 0), s = Fe(
    (d) => {
      d.preventDefault(), i(
        o === void 0 ? {
          mouseX: d.clientX + 2,
...
function rh({
  ...
  const [c, u] = Xe(!1), [d, f] = Xe(!1), p = Fe(() => {
    c && u(!1), f(!1);
  }, [c]), v = Fe((x) => {
    x.stopPropagation(), u((g) => {
      const S = !g;
  ...
  Vn(() => {
    if (c) {
      ...
      if (x) {
        const g = x.getBoundingClientRect(), S = window.scrollY, C = window.scrollX, A = g.top + S + x.clientHeight, I = g.left + C;
        m({ top: A, left: I });
      }
    }
  }, [c, o]);
  const [E] = Mr(
    Fe(async () => (e == null ? void 0 : e(!1)) ?? t, [e, t, c]),
    t
  ), [$] = Mr(
    Fe(async () => (e == null ? void 0 : e(!0)) ?? n ?? E, [e, n, E, c]),
    n ?? E
  ), y = d && $ ? $ : E;
  return /* @__PURE__ */ ue(Fn, { children: [
    /* @__PURE__ */ T(
...
let br;
const vr = () => (br || (br = me.allBookIds.map((e) => ({
  bookId: e,
  label: me.bookIdToEnglishName(e)
}))), br);
function wh({ scrRef: e, handleSubmit: t, id: n }) {
  const r = (c) => {
    t(c);
  }, o = (c, u) => {
  ...
  return /* @__PURE__ */ ue("span", { id: n, children: [
    ...
    /* @__PURE__ */ T(xt, { onClick: () => t(wo(e, 1)), children: ">" })
  ] });
}
function Eh({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = Xe(""), i = (s) => {
    o(s), e(s);
  };
  return /* @__PURE__ */ T(Es, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ T(
    Ln,
    {
      isFullWidth: n,
...
const oh = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ T(
  rl,
  {
    ...r,
    isChecked: n,
...
function Sh({
  ...
  const G = Bt(() => {
    const L = e.map((_) => typeof _.editable == "function" ? {
      ...
      renderEditCell: _.renderEditCell || xi
    } : _.editable && !_.renderEditCell ? { ..._, renderEditCell: xi } : _.renderEditCell && !_.editable ? { ..._, editable: !1 } : _);
...
function Ch({
  ...
  const i = Nn(void 0);
  return /* @__PURE__ */ T("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ T(Ss, { position: "static", id: r, children: /* @__PURE__ */ ue(Cs, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ T(
      rh,
      {
        commandHandler: t,
...
export {
  ...
  xt as Button,
  vh as ChapterRangeSelector,
  rl as Checkbox,
  xr as ComboBox,
  yh as ContextMenu,
  uf as GridMenu,
  rh as HamburgerMenuButton,
  xh as IconButton,
  Pt as LabelPosition,
  Na as MenuItem,
  wh as RefSelector,
