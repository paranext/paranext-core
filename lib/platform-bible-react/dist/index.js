import ts, { jsxs as de, jsx as T, Fragment as Ln } from "react/jsx-runtime";
import * as w from "react";
import Nt, { forwardRef as ns, useState as Xe, useCallback as Fe, useMemo as Bt, useRef as yr, useEffect as Fn } from "react";
import { getChaptersForBook as xi, offsetBook as vo, FIRST_SCR_BOOK_NUM as rs, offsetChapter as yo, FIRST_SCR_CHAPTER_NUM as os, offsetVerse as xo, FIRST_SCR_VERSE_NUM as is } from "platform-bible-utils";
import * as ge from "@radix-ui/react-dropdown-menu";
import { ChevronRight as as, Check as ss, Circle as ls, History as cs, Tally1 as wo, ChevronUp as us } from "lucide-react";
import xe, { clsx as ds } from "clsx";
import { twMerge as ps } from "tailwind-merge";
import { Button as fs, Autocomplete as hs, TextField as wi, FormControlLabel as Eo, FormLabel as ms, Checkbox as gs, MenuItem as bs, ListItemText as vs, ListItemIcon as Ei, Menu as ys, Grid as Ti, List as xs, IconButton as ki, Drawer as ws, Paper as Es, Slider as Ts, Snackbar as ks, Switch as Os, AppBar as Ss, Toolbar as Cs } from "@mui/material";
...
const qs = ge.Root, Gs = ge.Trigger, Xs = w.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ de(
  ge.SubTrigger,
  {
    ref: o,
    className: Qe(
...
const $i = w.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ T(ge.Portal, { children: /* @__PURE__ */ T(
  ge.Content,
  {
    ref: r,
    sideOffset: t,
...
const Mi = w.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ T(
  ge.Item,
  {
    ref: r,
    className: Qe(
...
Mi.displayName = ge.Item.displayName;
const Ys = w.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ de(
  ge.CheckboxItem,
  {
    ref: o,
    className: Qe(
...
const Js = w.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ de(
  ge.RadioItem,
  {
    ref: r,
    className: Qe(
...
const Zs = ns(
  ({ handleSearch: e, ...t }, n) => /* @__PURE__ */ de("div", { children: [
    /* @__PURE__ */ T(
      Ai,
      {
        ...t,
...
function bh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = me, [r, o] = Xe(""), [i, s] = Xe(""), l = Fe(
    (h) => ({
    ...
    o(h);
  }, d = Fe((h) => xi(me.bookIdToNumber(h)), []), f = (h) => {
    s(i !== h ? h : ""), d(h) === -1 && t({
  ...
  return /* @__PURE__ */ T("div", { children: /* @__PURE__ */ de(qs, { children: [
    ...
    /* @__PURE__ */ T($i, { style: { width: "300px", height: "500px", overflowY: "auto" }, children: nl.map((h) => /* @__PURE__ */ de("div", { children: [
      /* @__PURE__ */ T(_i, { children: tl[h] }),
      ...
      h === "OT" || h === "NT" ? /* @__PURE__ */ T(Ii, {}) : void 0
    ] }, h)) })
  ] }) });
}
function xt({
...
function vh({
  ...
  return /* @__PURE__ */ de(Ln, { children: [
    /* @__PURE__ */ T(
      Eo,
      {
...
function rl({
  ...
  let f;
  if (n) {
    const p = r === Pt.Before || r === Pt.Above, h = /* @__PURE__ */ T("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === Pt.Before || r === Pt.After, m = v ? h : /* @__PURE__ */ T("div", { children: h }), b = v ? d : /* @__PURE__ */ T("div", { children: d });
    f = /* @__PURE__ */ de(
      ms,
      {
...
function al() {
  if (Oo)
    return ie;
  Oo = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, u = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, f = e ? Symbol.for("react.suspense") : 60113, p = e ? Symbol.for("react.suspense_list") : 60120, h = e ? Symbol.for("react.memo") : 60115, v = e ? Symbol.for("react.lazy") : 60116, m = e ? Symbol.for("react.block") : 60121, b = e ? Symbol.for("react.fundamental") : 60117, E = e ? Symbol.for("react.responder") : 60118, $ = e ? Symbol.for("react.scope") : 60119;
  function y(g) {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = v, ie.Memo = h, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(g) {
    return x(g) || y(g) === c;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === u || g === i || g === o || g === f || g === p || typeof g == "object" && g !== null && (g.$$typeof === v || g.$$typeof === h || g.$$typeof === s || g.$$typeof === l || g.$$typeof === d || g.$$typeof === b || g.$$typeof === E || g.$$typeof === $ || g.$$typeof === m);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function sl() {
  return So || (So = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(N) {
      ...
      N === r || N === u || N === i || N === o || N === f || N === p || typeof N == "object" && N !== null && (N.$$typeof === v || N.$$typeof === h || N.$$typeof === s || N.$$typeof === l || N.$$typeof === d || N.$$typeof === b || N.$$typeof === E || N.$$typeof === $ || N.$$typeof === m);
    }
    function x(N) {
    ...
    var g = c, S = u, C = l, A = s, I = t, D = d, B = r, z = v, G = h, L = n, _ = i, R = o, j = f, Q = !1;
    function Z(N) {
...
var Co;
function Di() {
  return Co || (Co = 1, process.env.NODE_ENV === "production" ? wn.exports = al() : wn.exports = sl()), wn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var ar, No;
function ji() {
  return No || (No = 1, ar = Function.call.bind(Object.prototype.hasOwnProperty)), ar;
}
var sr, $o;
function cl() {
  if ($o)
...
function ul() {
  if (Mo)
    return lr;
  Mo = 1;
  var e = Di(), t = ll(), n = Dr(), r = ji(), o = cl(), i = function() {
  };
  ...
  return lr = function(l, c) {
    ...
    function b(O) {
      ...
      function X(U, W, q, H, K, Y, ne) {
        ...
        return W[q] == null ? U ? W[q] === null ? new m("The " + K + " `" + Y + "` is marked as required " + ("in `" + H + "`, but its value is `null`.")) : new m("The " + K + " `" + Y + "` is marked as required in " + ("`" + H + "`, but its value is `undefined`.")) : null : O(W, q, H, K, Y);
      }
      var F = X.bind(null, !1);
    ...
    function x() {
      function O(M, V, X, F, U) {
        ...
        if (!l(W)) {
          var q = R(W);
          return new m("Invalid " + F + " `" + U + "` of type " + ("`" + q + "` supplied to `" + X + "`, expected a single ReactElement."));
        }
        return null;
      }
      return b(O);
    ...
    function g() {
      function O(M, V, X, F, U) {
        ...
        if (!e.isValidElementType(W)) {
          var q = R(W);
          return new m("Invalid " + F + " `" + U + "` of type " + ("`" + q + "` supplied to `" + X + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return b(O);
    ...
    function C(O) {
      ...
      function M(V, X, F, U, W) {
        ...
        return new m("Invalid " + U + " `" + W + "` of value `" + String(q) + "` " + ("supplied to `" + F + "`, expected one of " + K + "."));
      }
      return b(M);
    }
    function A(O) {
    ...
    function D() {
      function O(M, V, X, F, U) {
        return L(M[V]) ? null : new m("Invalid " + F + " `" + U + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return b(O);
    }
...
function xl() {
  ...
  return se.ContextConsumer = s, se.ContextProvider = i, se.Element = e, se.ForwardRef = c, se.Fragment = n, se.Lazy = p, se.Memo = f, se.Portal = t, se.Profiler = o, se.StrictMode = r, se.Suspense = u, se.SuspenseList = d, se.isAsyncMode = function() {
    ...
    return !1;
  }, se.isContextConsumer = function(b) {
    return m(b) === s;
    ...
    return typeof b == "string" || typeof b == "function" || b === n || b === o || b === r || b === u || b === d || b === h || typeof b == "object" && b !== null && (b.$$typeof === p || b.$$typeof === f || b.$$typeof === i || b.$$typeof === s || b.$$typeof === c || b.$$typeof === v || b.getModuleId !== void 0);
  }, se.typeOf = m, se;
}
var le = {};
/**
...
function wl() {
  return Ao || (Ao = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), h = Symbol.for("react.offscreen"), v = !1, m = !1, b = !1, E = !1, $ = !1, y;
    y = Symbol.for("react.module.reference");
    function x(P) {
      return !!(typeof P == "string" || typeof P == "function" || P === n || P === o || $ || P === r || P === u || P === d || E || P === h || v || m || b || typeof P == "object" && P !== null && (P.$$typeof === p || P.$$typeof === f || P.$$typeof === i || P.$$typeof === s || P.$$typeof === c || // This needs to include all possible module reference object
...
const Ol = a.oneOfType([a.func, a.object]), jr = Ol;
function ze(e) {
  if (typeof e != "string")
...
function Fl(e) {
  e.addEventListener("keydown", Bl, !0), e.addEventListener("mousedown", ur, !0), e.addEventListener("pointerdown", ur, !0), e.addEventListener("touchstart", ur, !0), e.addEventListener("visibilitychange", Ll, !0);
}
function Vl(e) {
  const {
    target: t
...
function Zl(e) {
  ...
  if (!t) {
    const h = xe(n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = k({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), m = k({}, n, o, r);
    return h.length > 0 && (m.className = h), Object.keys(v).length > 0 && (m.style = v), {
      props: m,
      internalRef: void 0
    };
  }
  const s = ta(k({}, o, r)), l = Vo(r), c = Vo(o), u = t(s), d = xe(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), p = k({}, u, n, c, l);
...
function Mn(e) {
  const {
    ...
    isEnabled: s = lc,
    open: l
  } = e, c = w.useRef(!1), u = w.useRef(null), d = w.useRef(null), f = w.useRef(null), p = w.useRef(null), h = w.useRef(!1), v = w.useRef(null), m = De(t.ref, v), b = w.useRef(null);
  w.useEffect(() => {
...
`)), v.current.setAttribute("tabIndex", "-1")), h.current && v.current.focus()), () => {
    ...
    if (!l || !v.current)
      return;
    const y = we(v.current), x = (C) => {
      b.current = C, !(r || !s() || C.key !== "Tab") && y.activeElement === v.current && C.shiftKey && (c.current = !0, d.current && d.current.focus());
    }, g = () => {
      const C = v.current;
      if (C === null)
        return;
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (A = i(v.current)), A.length > 0) {
        var I, D;
        const B = !!((I = b.current) != null && I.shiftKey && ((D = b.current) == null ? void 0 : D.key) === "Tab"), z = A[0], G = A[A.length - 1];
...
process.env.NODE_ENV !== "production" && (Mn["propTypes"] = Vi(Mn.propTypes));
function cc(e) {
...
function vc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), h = w.useRef(null), v = w.useRef(null), m = De(v, f), [b, E] = w.useState(!d), $ = gc(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const x = () => we(h.current), g = () => (p.current.modalRef = v.current, p.current.mount = h.current, p.current), S = () => {
    o.mount(g(), {
      disableScrollLock: r
    }), v.current && (v.current.scrollTop = 0);
  }, C = on(() => {
    const R = mc(t) || x().body;
    o.add(g(), R), v.current && S();
  }), A = w.useCallback(() => o.isTopModal(g()), [o]), I = on((R) => {
    h.current = R, R && (d && A() ? S() : v.current && en(v.current, y));
  }), D = w.useCallback(() => {
    o.remove(g(), y);
  }, [y, o]);
  w.useEffect(() => () => {
...
var Se = "top", je = "bottom", Be = "right", Ce = "left", Br = "auto", pn = [Se, je, Be, Ce], It = "start", sn = "end", yc = "clippingParents", oa = "viewport", Gt = "popper", xc = "reference", Ho = /* @__PURE__ */ pn.reduce(function(e, t) {
  return e.concat([t + "-" + It, t + "-" + sn]);
}, []), ia = /* @__PURE__ */ [].concat(pn, [Br]).reduce(function(e, t) {
...
function zn(e) {
  return Ue(e) === "html" ? e : (
    ...
    (Lr(e) ? e.host : null) || // ShadowRoot detected
...
function Ac(e) {
  ...
  var o = zn(e);
  for (Lr(o) && (o = o.host); Ae(o) && ["html", "body"].indexOf(Ue(o)) < 0; ) {
    var i = Je(o);
...
function fn(e) {
  for (var t = Me(e), n = Wo(e); n && Ic(n) && Je(n).position === "static"; )
    n = Wo(n);
...
function Bc(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Ve(n.placement), c = Vr(l), u = [Ce, Be].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = jc(o.padding, n), p = Fr(i), h = c === "y" ? Se : Ce, v = c === "y" ? je : Be, m = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], b = s[c] - n.rects.reference[c], E = fn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = m / 2 - b / 2, x = f[h], g = $ - p[d] - f[v], S = $ / 2 - p[d] / 2 + y, C = tn(x, S, g), A = c;
...
function qo(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, i = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, f = e.isFixed, p = s.x, h = p === void 0 ? 0 : p, v = s.y, m = v === void 0 ? 0 : v, b = typeof d == "function" ? d({
    x: h,
    y: m
  }) : {
    x: h,
  ...
  if (h = z.x, m = z.y, c) {
    var G;
    return Object.assign({}, B, (G = {}, G[x] = $ ? "0" : "", G[y] = E ? "0" : "", G.transform = (g.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + m + "px)" : "translate3d(" + h + "px, " + m + "px, 0)", G));
  }
  return Object.assign({}, B, (t = {}, t[x] = $ ? m + "px" : "", t[y] = E ? h + "px" : "", t.transform = "", t));
}
function Uc(e) {
...
function Ur(e) {
  return Dt(at(e)).left + zr(e).scrollLeft;
}
function Kc(e, t) {
...
function Yc(e) {
  var t, n = at(e), r = zr(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = ft(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = ft(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Ur(e), c = -r.scrollTop;
...
function da(e) {
  return ["html", "body", "#document"].indexOf(Ue(e)) >= 0 ? e.ownerDocument.body : Ae(e) && Hr(e) ? e : da(zn(e));
}
function nn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = da(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Me(r), s = o ? [i].concat(i.visualViewport || [], Hr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function Zc(e) {
  var t = nn(zn(e)), n = ["absolute", "fixed"].indexOf(Je(e).position) >= 0, r = n && Ae(e) ? fn(e) : e;
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? yc : l, u = n.rootBoundary, d = u === void 0 ? oa : u, f = n.elementContext, p = f === void 0 ? Gt : f, h = n.altBoundary, v = h === void 0 ? !1 : h, m = n.padding, b = m === void 0 ? 0 : m, E = ca(typeof b != "number" ? b : ua(b, pn)), $ = p === Gt ? xc : Gt, y = e.rects.popper, x = e.elements[v ? $ : p], g = Qc(bt(x) ? x : x.contextElement || at(e.elements.popper), c, d, s), S = Dt(e.elements.reference), C = pa({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
...
function eu(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? ia : c, d = jt(r), f = d ? l ? Ho : Ho.filter(function(v) {
    return jt(v) === d;
...
function nu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, h = n.flipVariations, v = h === void 0 ? !0 : h, m = n.allowedAutoPlacements, b = t.options.placement, E = Ve(b), $ = E === b, y = c || ($ || !v ? [Sn(b)] : tu(b)), x = [b].concat(y).reduce(function(F, U) {
      return F.concat(Ve(U) === Br ? eu(t, {
        placement: U,
        boundary: d,
        rootBoundary: f,
        padding: u,
...
function ou(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, s = ln(t, {
    ...
    altBoundary: !0
  }), c = Ko(s, r), u = Ko(l, o, i), d = Yo(c), f = Yo(u);
  t.modifiersData[n] = {
...
function pu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, h = p === void 0 ? !0 : p, v = n.tetherOffset, m = v === void 0 ? 0 : v, b = ln(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), E = Ve(t.placement), $ = jt(t.placement), y = !$, x = Vr(E), g = du(x), S = t.modifiersData.popperOffsets, C = t.rects.reference, A = t.rects.popper, I = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, D = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (S) {
    if (i) {
      var G, L = x === "y" ? Se : Ce, _ = x === "y" ? je : Be, R = x === "y" ? "height" : "width", j = S[x], Q = j + b[L], Z = j - b[_], O = h ? -A[R] / 2 : 0, M = $ === It ? C[R] : A[R], V = $ === It ? -A[R] : -C[R], X = t.elements.arrow, F = h && X ? Fr(X) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : la(), W = U[L], q = U[_], H = tn(0, C[R], F[R]), K = y ? C[R] / 2 - O - H - W - D.mainAxis : M - H - W - D.mainAxis, Y = y ? -C[R] / 2 + O + H + q + D.mainAxis : V + H + q + D.mainAxis, ne = t.elements.arrow && fn(t.elements.arrow), N = ne ? x === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[x]) != null ? G : 0, P = j + K - J - N, re = j + Y - J, ve = tn(h ? _n(Q, P) : Q, j, h ? ft(Z, re) : Z);
      S[x] = ve, z[x] = ve - j;
    }
    if (l) {
      var Te, he = x === "x" ? Se : Ce, lt = x === "x" ? je : Be, ke = S[g], We = g === "y" ? "height" : "width", Pe = ke + b[he], qe = ke - b[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[g]) != null ? Te : 0, ct = ye ? Pe : ke - C[We] - A[We] - yt + D.altAxis, Vt = ye ? ke + C[We] + A[We] - yt - D.altAxis : qe, bn = h && ye ? Dc(ct, ke, Vt) : tn(h ? ct : Pe, ke, h ? Vt : qe);
      S[g] = bn, z[g] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
function bu(e, t, n) {
  ...
  Hr(i)) && (l = mu(t)), Ae(t) ? (c = Dt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Ur(i))), {
  ...
  return function(l, c, u) {
    ...
    function v() {
      d.orderedModifiers.forEach(function(b) {
        var E = b.name, $ = b.options, y = $ === void 0 ? {} : $, x = b.effect;
...
const Nu = () => et({
  ...
  } = t, b = ce(t, Su), E = w.useRef(null), $ = De(E, n), y = w.useRef(null), x = De(y, p), g = w.useRef(x);
  mt(() => {
    g.current = x;
  }, [x]), w.useImperativeHandle(p, () => y.current, []);
  const S = Pu(d, s), [C, A] = w.useState(S), [I, D] = w.useState(In(o));
  w.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && I && Un(I) && I.nodeType === 1) {
...
`));
  ...
  const z = Nu(), G = (r = v.root) != null ? r : "div", L = gt({
    elementType: G,
  ...
  if (i)
    ...
    const D = In(r);
    C = D && Un(D) ? we(D).body : we(null).body;
  }
  const A = !d && c && (!m || y) ? "none" : void 0, I = m ? {
    in: d,
    onEnter: g,
    onExited: S
  } : void 0;
...
function Ze(e, t, n) {
  ...
  if (typeof t == "object") {
    ...
    return Object.keys(t).reduce((s, l) => {
      if (Object.keys(i.values || Wr).indexOf(l) !== -1) {
        const c = i.up(l);
        s[c] = n(t[l], l);
      } else {
        const c = l;
...
function be(e) {
  const {
    ...
    return Ze(s, l, (f) => {
      let p = An(u, o, f);
      return f === p && typeof f == "string" && (p = An(u, o, `${t}${f === "default" ? "" : ze(f)}`, f)), n === !1 ? p : {
        [n]: p
      };
    });
  };
...
const Ku = Le("border", Ie), Yu = Le("borderTop", Ie), Ju = Le("borderRight", Ie), Zu = Le("borderBottom", Ie), Qu = Le("borderLeft", Ie), ed = Le("borderColor"), td = Le("borderTopColor"), nd = Le("borderRightColor"), rd = Le("borderBottomColor"), od = Le("borderLeftColor"), id = Le("outline", Ie), ad = Le("outlineColor"), Xn = (e) => {
...
Gn(Ku, Yu, Ju, Zu, Qu, ed, td, nd, rd, od, Xn, id, ad);
const Kn = (e) => {
...
Gn(Kn, Yn, Jn, sd, ld, cd, ud, dd, pd, fd, hd, md);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const gd = be({
...
const yd = be({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const t = (n) => {
      var r, o;
      const i = ((r = e.theme) == null || (r = r.breakpoints) == null || (r = r.values) == null ? void 0 : r[n]) || Wr[n];
...
function Pd() {
  function e(n, r, o, i) {
    ...
    return f ? f(s) : Ze(s, r, (v) => {
      let m = An(p, d, v);
      return v === m && typeof v == "string" && (m = An(p, d, `${n}${v === "default" ? "" : ze(v)}`, v)), c === !1 ? m : {
        [c]: m
      };
    });
  }
...
function Kr(e = {}, ...t) {
  ...
  return u.applyStyles = Rd, u = t.reduce((d, f) => Ke(d, f), u), u.unstable_sxConfig = k({}, Gr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Xr({
      sx: f,
      theme: this
    });
...
const Bd = Kr(), ti = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Tn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Fd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: p = Ld(ti(u))
    } = l, h = ce(l, Ad), v = d !== void 0 ? d : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      u && u !== "Root" && u !== "root" || !1
    ), m = f || !1;
    let b;
    process.env.NODE_ENV !== "production" && c && (b = `${c}-${ti(u || "Root")}`);
    let E = Cn;
    u === "Root" || u === "root" ? E = r : u ? E = o : jd(s) && (E = void 0);
    const $ = Ps(s, k({
      shouldForwardProp: E,
      label: b
    }, h)), y = (g) => typeof g == "function" && g.__emotion_real !== g || pt(g) ? (S) => Pn(g, k({}, S, {
      theme: Tn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
...
function Dn(e, t) {
  return e = vt(e), t = Yr(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Zn(e);
}
function Wd(e, t) {
  if (e = vt(e), t = Yr(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Xd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ot = np, rp = ["mode", "contrastThreshold", "tonalOffset"], oi = {
...
function up(e) {
  ...
  function f(m) {
    const b = ri(m, pr.text.primary) >= n ? pr.text.primary : oi.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = ri(m, b);
      E < 3 && console.error([`MUI: The contrast ratio of ${E}:1 for ${b} on ${m}`, "falls below the WCAG recommended absolute minimum contrast ratio of 3:1.", "https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
`));
    }
    return b;
  }
...
The color object needs to have a \`main\` property or a \`${E}\` property.` : Mt(11, b ? ` (${b})` : "", E));
...
} });` : Mt(12, b ? ` (${b})` : "", JSON.stringify(m.main)));
    return ii(m, "light", $, r), ii(m, "dark", y, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, h = {
    dark: pr,
    light: oi
  };
  return process.env.NODE_ENV !== "production" && (h[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), Ke(k({
...
function fp(e, t) {
  ...
  const h = o / 14, v = f || ((E) => `${E / u * h}rem`), m = (E, $, y, x, g) => k({
    fontFamily: r,
    fontWeight: E,
    fontSize: v($),
...
const bp = ["none", ue(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ue(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ue(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ue(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ue(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ue(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ue(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ue(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ue(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ue(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ue(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ue(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ue(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ue(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ue(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ue(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ue(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ue(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ue(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ue(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ue(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ue(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ue(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ue(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], vp = bp, yp = ["duration", "easing", "delay"], xp = {
...
`));
  ...
  return u.unstable_sxConfig = k({}, Gr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Xr({
      sx: f,
      theme: this
    });
...
const Pp = Cp(), Jr = Pp, Zr = "$$material", xa = (e) => Cn(e) && e !== "classes", Rp = Fd({
  themeId: Zr,
  defaultTheme: Jr,
...
function gn() {
  const e = ya(Jr);
  return process.env.NODE_ENV !== "production" && w.useDebugValue(e), e[Zr] || e;
}
function tt({
  props: e,
  name: t
...
}, fr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Qr = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
    ...
    let O;
    m === "auto" ? (O = x.transitions.getAutoHeightDuration(_.clientHeight), y.current = O) : O = j, _.style.transition = [x.transitions.create("opacity", {
      duration: O,
      delay: Q
    ...
    let Z;
    m === "auto" ? (Z = x.transitions.getAutoHeightDuration(_.clientHeight), y.current = Z) : Z = R, _.style.transition = [x.transitions.create("opacity", {
      duration: Z,
      delay: j
    }), x.transitions.create("transform", {
...
}, ui = Ap, Dp = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], jp = Ee(ha, {
  name: "MuiPopper",
  slot: "Root",
...
const Sa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, h, v, m, b, E, $, y, x, g;
  const S = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: A
  }), ve = gn(), Te = ve.direction === "rtl", [he, lt] = w.useState(), [ke, We] = w.useState(null), Pe = w.useRef(!1), qe = L || Z, ye = Jt(), yt = Jt(), ct = Jt(), Vt = Jt(), [bn, ro] = Wi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const oo = (ee) => {
    ...
    (ee) => {
      di.start(800 + M, () => {
        kn = !1;
      }), ro(!1), X && Ge && X(ee), ye.start(ve.transitions.duration.shortest, () => {
        Pe.current = !1;
      });
    }
  ), er = (ee) => {
    ...
    onFocus: Ha,
    ref: Wa
  } = qi(), [, so] = w.useState(!1), lo = (ee) => {
    Ua(ee), ao.current === !1 && (so(!1), io(ee));
  }, co = (ee) => {
    he || lt(ee.currentTarget), Ha(ee), ao.current === !0 && (so(!0), er(ee));
  }, uo = (ee) => {
    Pe.current = !0;
    const Re = re.props;
    Re.onTouchStart && Re.onTouchStart(ee);
  }, po = er, fo = io, qa = (ee) => {
    uo(ee), ct.clear(), ye.clear(), vn(), zt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Vt.start(Q, () => {
  ...
  B ? (Ut.title = !Ge && nr && !G ? ne : null, Ut["aria-describedby"] = Ge ? Qn : null) : (Ut["aria-label"] = nr ? ne : null, Ut["aria-labelledby"] = Ge && !nr ? Qn : null);
...
`));
  ...
  const Ht = {};
  _ || (_e.onTouchStart = qa, _e.onTouchEnd = Ga), G || (_e.onMouseOver = On(po, _e.onMouseOver), _e.onMouseLeave = On(fo, _e.onMouseLeave), qe || (Ht.onMouseOver = po, Ht.onMouseLeave = fo)), z || (_e.onFocus = On(co, _e.onFocus), _e.onBlur = On(lo, _e.onBlur), qe || (Ht.onFocus = co, Ht.onBlur = lo)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Ya = w.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Pe.current
  }), rr = zp(Wt), ho = (r = (o = Y.popper) != null ? o : I.Popper) != null ? r : Up, mo = (i = (s = (l = Y.transition) != null ? l : I.Transition) != null ? s : N) != null ? i : $r, go = (c = (u = Y.tooltip) != null ? u : I.Tooltip) != null ? c : Hp, bo = (d = (f = Y.arrow) != null ? f : I.Arrow) != null ? d : Wp, Ja = Zt(ho, k({}, H, (p = K.popper) != null ? p : D.popper, {
    className: xe(rr.popper, H == null ? void 0 : H.className, (h = (v = K.popper) != null ? v : D.popper) == null ? void 0 : h.className)
  }), Wt), Za = Zt(mo, k({}, J, (m = K.transition) != null ? m : D.transition), Wt), Qa = Zt(go, k({}, (b = K.tooltip) != null ? b : D.tooltip, {
    className: xe(rr.tooltip, (E = ($ = K.tooltip) != null ? $ : D.tooltip) == null ? void 0 : E.className)
  }), Wt), es = Zt(bo, k({}, (y = K.arrow) != null ? y : D.arrow, {
    className: xe(rr.arrow, (x = (g = K.arrow) != null ? g : D.arrow) == null ? void 0 : x.className)
  }), Wt);
  return /* @__PURE__ */ de(w.Fragment, {
    children: [/* @__PURE__ */ w.cloneElement(re, _e), /* @__PURE__ */ T(ho, k({
      as: q ?? Oa,
      placement: W,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ de(go, k({}, Qa, {
          children: [ne, C ? /* @__PURE__ */ T(bo, k({}, es, {
            ref: We
          })) : null]
        }))
      }))
...
const Kp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Yp = (e) => {
  ...
  const r = tt({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, h = ce(r, Kp), v = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", m = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Pa(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${t}Icon`), n.muiName = pi.muiName, /* @__PURE__ */ w.memo(/* @__PURE__ */ w.forwardRef(n));
}
const Zp = {
  configure: (e) => {
...
var Ra = eo.default = void 0, rf = nf(tf()), of = ts;
Ra = eo.default = (0, rf.default)(/* @__PURE__ */ (0, of.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function hi(e, t, n) {
...
function Na(e) {
  const {
    ...
    bs,
    {
      ...
      onClick: t,
      id: m,
      children: n ? /* @__PURE__ */ de(Ln, { children: [
        hi(i, n, !0),
        /* @__PURE__ */ T(vs, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ T(Ei, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ T(Ra, {}) }) : hi(s, n, !1)
      ] }) : b
    }
  );
...
function af(e) {
  const [t, n] = Xe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (u) => {
    ...
    ), /* @__PURE__ */ T(no, { ...e, includedGroups: u });
  };
  return /* @__PURE__ */ de(Ln, { children: [
...
function lf(e) {
  ...
  )), /* @__PURE__ */ T(no, { ...e, includedGroups: i });
}
function cf({
  commandHandler: e,
  menuDefinition: t,
...
const Aa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  } = t, p = ce(t, bf), h = w.useRef(null), v = w.useRef({
    keys: [],
    repeating: !0,
  ...
  mt(() => {
    ...
    adjustStyleForScrollbar: (y, x) => {
      ...
      if (y.clientHeight < h.current.clientHeight && g) {
        const S = `${Gi(we(y))}px`;
        h.current.style[x.direction === "rtl" ? "paddingLeft" : "paddingRight"] = S, h.current.style.width = `calc(100% + ${S})`;
      }
      return h.current;
    }
  }), []);
  const m = (y) => {
    const x = h.current, g = y.key, S = we(x).activeElement;
    if (g === "ArrowDown")
      y.preventDefault(), Yt(x, S, u, c, mr);
    else if (g === "ArrowUp")
      y.preventDefault(), Yt(x, S, u, c, mi);
    else if (g === "Home")
      y.preventDefault(), Yt(x, null, u, c, mr);
    else if (g === "End")
      y.preventDefault(), Yt(x, null, u, c, mi);
    else if (g.length === 1) {
      const C = v.current, A = g.toLowerCase(), I = performance.now();
      ...
      C.previousKeyMatched && (D || Yt(x, S, !1, c, mr, C)) ? y.preventDefault() : C.previousKeyMatched = !1;
    }
    d && d(y);
  }, b = De(h, n);
  let E = -1;
...
const vf = Aa, yf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], xf = {
  ...
  const r = gn(), o = {
    ...
    L.style.webkitTransition = r.transitions.create("opacity", _), L.style.transition = r.transitions.create("opacity", _), h && h(L);
  }), z = S(v);
  return /* @__PURE__ */ T($, k({
    appear: s,
    in: u,
...
const Tf = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], kf = (e) => {
  ...
  const s = tt({
    ...
    slotProps: v = {},
    slots: m = {},
    TransitionComponent: b = wf,
    transitionDuration: E
  } = s, $ = ce(s, Tf), y = k({}, s, {
    component: u,
    invisible: p
  }), x = kf(y), g = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ T(b, k({
    in: h,
    timeout: E
  }, $, {
...
const Pf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Rf = (e) => {
  ...
  return !D && !z && (!X || V) ? null : /* @__PURE__ */ T(an, {
    ...
    children: /* @__PURE__ */ de(q, k({}, ne, {
      children: [!I && d ? /* @__PURE__ */ T(H, k({}, N)) : null, /* @__PURE__ */ T(Mn, {
        disableEnforceFocus: x,
        disableAutoFocus: y,
        disableRestoreFocus: C,
        isEnabled: M,
...
const If = ["className", "component", "elevation", "square", "variant"], Af = (e) => {
  ...
  return k({
    ...
    backgroundImage: `linear-gradient(${Dn("#fff", ui(t.elevation))}, ${Dn("#fff", ui(t.elevation))})`
  }, e.vars && {
...
`));
    ...
    vertical: gi(J, g.vertical),
    horizontal: bi(J, g.horizontal)
    ...
    const lt = Te + P.height, ke = he + P.width, We = _t(Rn(c)), Pe = We.innerHeight - b, qe = We.innerWidth - b;
    if (b !== null && Te < b) {
      const ye = Te - b;
      Te -= ye, re.vertical += ye;
    } else if (b !== null && lt > Pe) {
      const ye = lt - Pe;
      Te -= ye, re.vertical += ye;
    }
...
`)), b !== null && he < b) {
  ...
  }, [c, f, j, Q, b]), [O, M] = w.useState(E), V = w.useCallback(() => {
    const J = G.current;
    if (!J)
      return;
    const P = Z(J);
  ...
  const W = v || (c ? we(Rn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : Uf, H = (i = y == null ? void 0 : y.paper) != null ? i : Fa, K = gt({
    elementType: H,
...
const qf = ["onEntering"], Gf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Xf = {
  ...
  const i = tt({
    ...
    B.current && B.current.adjustStyleForScrollbar(Z, S), b && b(Z, O);
  }, G = (Z) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const _ = (r = $.paper) != null ? r : Zf, R = (o = y.paper) != null ? o : h, j = gt({
    elementType: $.root,
...
let gr;
const br = () => (gr || (gr = me.allBookIds.map((e) => ({
  bookId: e,
...
function wh({ scrRef: e, handleSubmit: t, id: n }) {
  ...
  return /* @__PURE__ */ de("span", { id: n, children: [
    ...
    /* @__PURE__ */ T(xt, { onClick: () => t(xo(e, 1)), children: ">" })
  ] });
}
...
function Ch({
  ...
  const i = yr(void 0);
  return /* @__PURE__ */ T("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ T(Ss, { position: "static", id: r, children: /* @__PURE__ */ de(Cs, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ T(
      rh,
      {
        commandHandler: t,
