...
import { Slot as be, Dialog as Wt, Popover as tr, Label as ai, RadioGroup as Jr, Tooltip as Ae, ToggleGroup as So, Separator as oi, Avatar as fa, DropdownMenu as vt, Select as Et, Checkbox as Fa, Tabs as Kt, Menubar as Jt, ContextMenu as bt, Progress as Ba, Slider as lr, Switch as Ua } from "radix-ui";
import { cva as Zt } from "class-variance-authority";
import { IconX as ni, IconCheck as De, IconSearch as ii, IconChevronRight as ma, IconChevronDown as si, IconChevronUp as ci, IconSelector as li, IconLayoutSidebar as di, IconLayoutSidebarRight as wi, IconLoader as ui, IconAlertOctagon as pi, IconAlertTriangle as gi, IconInfoCircle as hi, IconCircleCheck as fi } from "@tabler/icons-react";
import { Canon as ct } from "@sillsdev/scripture";
import { includes as dr, Section as Y, getChaptersForBook as mi, formatScrRef as Te, getSectionForBook as Je, formatRelativeDate as vi, formatReplacementString as ze, sanitizeHtml as bi, NumberFormat as xi, formatBytes as yi, getCurrentLocale as ki, usfmMarkers as fr, getFormatCallerFunction as _i, deepEqual as Ni, isString as Ka, compareScrRefs as Zr, scrRefToBBBCCCVVV as Pr, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
import { Check as or, Clock as qa, ChevronsLeft as Ga, ChevronsRight as Ha, ChevronLeft as Qr, ChevronRight as ta, ArrowLeft as Ci, ArrowRight as Ei, ChevronDown as Sr, BoldIcon as zi, ItalicIcon as Ti, X as Rr, AtSign as Ro, Pencil as Si, Trash2 as Ri, ArrowUp as Do, MoreHorizontal as Di, MailOpen as $i, Mail as Mi, ChevronUp as Oi, FilterIcon as Ii, ArrowLeftIcon as Ai, ChevronLeftIcon as Pi, ChevronRightIcon as Li, ArrowRightIcon as Vi, Copy as $o, Filter as ji, User as Fi, Link as Bi, CircleHelp as Ui, ChevronsUpDown as Mo, Star as Ki, Undo as qi, Redo as Gi, SquareX as Oo, FunctionSquare as Io, SquareSigma as Ao, Ban as Hi, AlertCircle as ea, CircleCheckIcon as Wi, CircleXIcon as Yi, CircleHelpIcon as Xi, ArrowUpIcon as Ji, ArrowDownIcon as Zi, ScrollText as Qi, Search as ts, MenuIcon as es, Menu as rs, EllipsisVertical as as, MoreVertical as Wa, LoaderCircle as os } from "lucide-react";
import tt, { forwardRef as nr, useRef as K, useMemo as L, useState as S, useCallback as j, useLayoutEffect as It, createContext as Dr, useContext as va, useEffect as q, Component as ns, createElement as Ya, Suspense as is, Fragment as Po } from "react";
import { createEditor as Lo, $getRoot as oe, $createParagraphNode as Ge, $getSelection as Tt, HISTORY_MERGE_TAG as ba, ParagraphNode as Vo, TextNode as jo, $isTokenOrSegmented as ss, $getCharacterOffsets as cs, $cloneWithPropertiesEphemeral as ls, $getPreviousSelection as ds, $isRangeSelection as Yt, $caretFromPoint as ws, $getSiblingCaret as Fo, $getChildCaret as us, $getAdjacentChildCaret as ps, $isChildCaret as gs, $normalizeCaret as hs, $setSelectionFromCaretRange as fs, $getCollapsedCaretRange as ms, $getCaretInDirection as Xa, $splitAtPointCaretNext as vs, $isTextPointCaret as bs, $findMatchingParent as Bo, $isElementNode as re, mergeRegister as ne, getDOMTextNode as xs, isHTMLElement as Uo, CLEAR_EDITOR_COMMAND as Ko, COMMAND_PRIORITY_EDITOR as xa, shallowMergeConfig as ys, defineExtension as jt, safeCast as $e, createState as ks, FORMAT_TEXT_COMMAND as qo, $isNodeSelection as Go, COMMAND_PRIORITY_LOW as Ho, RootNode as _s, LineBreakNode as Ns, TabNode as Cs, $isEditorState as Es, createCommand as zs, CLICK_COMMAND as Ts, isDOMNode as Ss, $getNodeFromDOMNode as Rs, $createNodeSelection as Ds, $setSelection as $s, $getEditor as Ms, DecoratorNode as ra, $getState as Os, toggleTextFormatType as Ja, TEXT_TYPE_TO_FORMAT as Is, $setState as As, addClassNamesToElement as Wo, $create as Ps, $getNodeByKey as Ls, removeClassNamesFromElement as Vs, KEY_TAB_COMMAND as js, $isBlockElementNode as xr, $createRangeSelection as Fs, $normalizeSelection__EXPERIMENTAL as Bs, OUTDENT_CONTENT_COMMAND as Us, INDENT_CONTENT_COMMAND as Za, INSERT_TAB_COMMAND as Ks, COMMAND_PRIORITY_CRITICAL as ya, $isDecoratorNode as qs, $isParagraphNode as Gs, $isTextNode as yr, SELECTION_CHANGE_COMMAND as Yo, getRegisteredNode as Hs, isDocumentFragment as Qa, isDOMDocumentNode as Ws, ArtificialNode__DO_NOT_USE as Xo, $createLineBreakNode as Jo, $isRootOrShadowRoot as Ys, isBlockDomNode as to, isInlineDomNode as eo, $insertNodes as Xs } from "lexical";
import { HeadingNode as Js, QuoteNode as Zs, registerRichText as Qs } from "@lexical/rich-text";
import { flushSync as tc, createPortal as ec } from "react-dom";
import { $isTableSelection as rc } from "@lexical/table";
import { createHeadlessEditor as Zo } from "@lexical/headless";
import { useReactTable as Qo, getFilteredRowModel as ac, getSortedRowModel as tn, getPaginationRowModel as oc, getCoreRowModel as en, flexRender as Ze, getGroupedRowModel as nc, getExpandedRowModel as ic } from "@tanstack/react-table";
import sc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as aa, HIDDEN_NOTE_CALLER as oa, getDefaultViewOptions as cc, isInsertEmbedOpOfType as wr, Editorial as lc } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as dc } from "react-hotkeys-hook";
import { Drawer as xe } from "vaul";
import * as ka from "react-resizable-panels";
import { useTheme as wc } from "next-themes";
import { Toaster as uc } from "sonner";
...
function f(...t) {
  ...
  }), ri(n.join(" ")).split(" ").filter(Boolean).map((d) => {
    const l = o.get(d);
    return l ? gc(d, l) : d;
  }).join(" ");
}
const He = 250, rn = 300, hc = 400, fc = 450, mc = 500, an = Zt(
...
const vc = "layoutDirection";
function st() {
  const t = localStorage.getItem(vc);
  return t === "rtl" ? t : "ltr";
}
function bc({ ...t }) {
...
function kc({
  ...
  const s = st();
  return /* @__PURE__ */ u(xc, { children: [
    /* @__PURE__ */ a(yc, { className: o }),
    /* @__PURE__ */ u(
      Wt.Content,
      {
...
function sr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Cc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        Re.Input,
        {
      ...
      /* @__PURE__ */ a(zc, { children: /* @__PURE__ */ a(ii, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Cu(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
          ...
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a(
              V,
              {
                ...
                tabIndex: -1,
                children: l === "ltr" ? /* @__PURE__ */ a(Ci, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ei, { className: "tw:h-4 tw:w-4" })
              }
            ),
...
const wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Lc = wn ? It : q, ur = { tag: ba };
function Vc({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = Pc(null, o), w = Lo({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const jc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Fc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Qt();
  return jc(() => {
...
class Uc extends ns {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && Kc(e.resetKeys, n)) {
      var i, s;
...
function qc({ children: t, onError: e }) {
  return a(Uc, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Gc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Hc(t) {
...
const un = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Jc = un && "documentMode" in document ? document.documentMode : null;
!(!un || !("InputEvent" in window) || Jc) && "getTargetRanges" in new window.InputEvent("input");
function Gt(t) {
  return `${t}px`;
}
...
function Qc(t, e, r) {
  ...
  function d() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = Yc(t, e);
    var m, b;
...
function ol(t) {
  const e = Tt() || ds();
  let r;
  if (Yt(e)) r = ws(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Fo(c, "next"));
    }
    r = r || us(oe(), "previous").getFlipped().insert(Ge());
  }
  const o = nl(t, r), n = ps(o), i = gs(n) ? hs(n) : o;
  return fs(ms(i)), t.getLatest();
}
function nl(t, e, r) {
  let o = Xa(e, "next");
  for (let n = o; n; n = vs(n, r)) o = n;
  return bs(o) && kr(283), o.insert(t.isInline() ? Ge().append(t) : t), Xa(Fo(t.getLatest(), "next"), e.direction);
}
function il(t) {
  const e = Tt();
  if (!Yt(e)) return !1;
...
const sl = Symbol.for("preact-signals");
function Mr() {
...
let _r, ae = 0, Nr = 0, ll = 0, da = 0, mr = 0;
function io(t) {
  if (X === void 0) return;
  let e = t.n;
...
Ct.prototype.brand = sl, Ct.prototype.h = function() {
  return !0;
...
const Fr = ks("format", { parse: (t) => typeof t == "number" ? t : 0 });
class vn extends ra {
  $config() {
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [vn], register: (t, e, r) => t.registerCommand(qo, (o) => {
  const n = Tt();
  if (Go(n) || Yt(n)) for (const i of n.getNodes()) pl(i) && i.toggleFormat(o);
  return !1;
}, Ho) });
function bn(t, e) {
  let r;
...
class fl {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : ys;
...
const vl = jt({ config: $e({ setOptions: co, updateOptions: co }), init: ({ $initialEditorState: t = ml }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (Es(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [_s, jo, Ns, Cs, Vo] }), lo = Symbol.for("@lexical/extension/LexicalBuilder");
function wo() {
}
function bl(t) {
  throw t;
...
class Le {
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = bl), e;
  }
}
const xl = /* @__PURE__ */ new Set(), uo = jt({ build(t, e, r) {
...
jt({ dependencies: [wa, uo], name: "@lexical/extension/HorizontalRule", nodes: () => [je], register(t, e, r) {
  ...
  return ne(t.registerCommand(yl, (s) => {
    const c = Tt();
    if (!Yt(c)) return !1;
    ...
    return !0;
  }, xa), t.registerCommand(Ts, (s) => {
    if (Ss(s.target)) {
      const c = Rs(s.target);
      if (_l(c)) return function(d, l = !1) {
        const w = Tt(), g = d.isSelected(), h = d.getKey();
        let p;
        l && Go(w) ? p = w : (p = Ds(), $s(p)), g ? p.delete(h) : p.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
jt({ build: (t, e, r) => We(e), config: $e({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Xt(() => {
    if (!o.disabled.value) return rl(t, o.onReposition.value);
  });
} });
function _n(t) {
  return t.canBeEmpty();
}
function Nl(t, e, r = _n) {
  return ne(t.registerCommand(js, (o) => {
    const n = Tt();
    if (!Yt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => xr(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), g = al(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Fs();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = Bs(p), p.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Us : Za : Ks;
...
jt({ build: (t, e, r) => We(e), config: $e({ $canIndent: _n, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Xt(() => {
    if (!o.value) return Nl(t, n, i);
  });
} });
const Cl = jt({ name: "@lexical/react/ReactProvider" });
function El() {
...
function Rl({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    ...
    return Ra(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (h) => r._onError(h), children: a(is, { fallback: null, children: n[l] }) }), g = r.getElementByKey(l);
        g !== null && s.push(ec(w, g, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
}
function Dl({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    const o = Le.maybeFromEditor(r);
    if (o && o.hasExtensionByName(Cl.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Sl(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Rl, { editor: t, ErrorBoundary: e });
}
function po(t) {
  return t.getEditorState().read(Nn(t.isComposing()));
}
function $l({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Qt();
  return function(n) {
    Ra(() => ne(Qs(n), Cn(n)), [n]);
  }(o), u(ot, { children: [t, a(Ml, { content: e }), a(Dl, { editor: o, ErrorBoundary: r })] });
}
function Ml({ content: t }) {
...
function Ol({ defaultSelection: t }) {
  const [e] = Qt();
  return q(() => {
    e.focus(() => {
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Al({ onClear: t }) {
  const [e] = Qt();
  return Il(() => mn(e, t), [e, t]), null;
}
const En = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Pl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: N = !0, style: y, tabIndex: _, "data-testid": k, ...A }, M) {
...
function jl(t, e) {
  ...
  return u(ot, { children: [a(Ll, { editor: n, ...o, ref: e }), r != null && a(Fl, { editor: n, content: r })] });
}
function Fl({ content: t, editor: e }) {
  const r = function(s) {
    const [c, d] = S(() => go(s));
    return En(() => {
      function l() {
...
function Kl() {
  const [t, e] = S(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(bc, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(kc, { children: [
      /* @__PURE__ */ a(_c, { children: /* @__PURE__ */ a(Nc, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = j(
    (i, s, c = !1) => {
...
function ql({
  ...
  const [e] = Qt(), [r, o] = S(e), [n, i] = S("paragraph"), [s, c] = Kl(), d = () => {
  };
...
function Xl({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(ql, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Wl, {}) }) }),
      ...
      /* @__PURE__ */ a(
        $l,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Bl, { placeholder: t }) }),
          ErrorBoundary: qc
        }
      ),
      e && /* @__PURE__ */ a(Ol, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(Yl, { onClear: r }),
      /* @__PURE__ */ a(Al, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ a(
          Vc,
          {
            ...
            children: /* @__PURE__ */ u(At, { children: [
              /* @__PURE__ */ a(Xl, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Fc,
                {
...
function Zl(t, e) {
  const r = Ws(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function Dn(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && yr(e) && (s = Xc(o, e, "clone"));
  const c = re(s) ? s.getChildren() : [], d = Hs(t, s.getType());
  let l;
...
function Mn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (c == null || !Ys(c)) && (c != null && xr(c) || o);
  for (let m = 0; m < g.length; m++) h.push(...Mn(g[m], e, r, p, new Map(n), c));
  return w != null && (h = w(h)), to(t) && (h = td(t, h, p ? () => {
    const m = new Xo();
    return r.push(m), m;
...
function ed(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Zl(e, n);
      oe().clear(), Xs(i);
    },
    {
      discrete: !0
...
function Du({
  ...
  const [i, s] = S(ad), [c, d] = S(n), [l, w] = S(!1), g = K(void 0), h = K(null);
  q(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
...
const $u = Object.freeze([
...
], od = ["input", "select", "textarea", "button"], nd = ["button", "textbox"], id = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
  ...
  const n = K(null), [i, s] = S(void 0), [c, d] = S(void 0), l = j(
    ...
    if (p.isContentEditable || od.includes(m)) return !0;
    const b = p.getAttribute("role");
    if (b && nd.includes(b)) return !0;
...
function mo({
  ...
  const p = j(
    ...
    [t.user]
  ), y = L(() => bi(t.contents), [t.contents]), _ = L(() => {
    if (o && c)
      return /* @__PURE__ */ u(ot, { children: [
        /* @__PURE__ */ u(
          pa,
          {
            onClick: (k) => {
              k.stopPropagation(), l(!0), g(ed(t.contents)), s == null || s(!0);
            },
            children: [
              /* @__PURE__ */ a(Si, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(dd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(wd, { className: "tw:text-xs tw:font-medium", children: N }) }),
        ...
        _ && /* @__PURE__ */ u(fe, { children: [
          /* @__PURE__ */ a(me, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Di, {}) }) }),
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                V,
                {
                  ...
                  children: rt ? /* @__PURE__ */ a($i, {}) : /* @__PURE__ */ a(Mi, {})
                }
              ),
...
function ju({
  ...
  const C = r.filter(
    ...
    [N, b]
  ), { listboxRef: P, activeId: G, handleKeyDown: O } = id({
    options: z,
    onOptionSelect: E
  }), W = j(
    (x) => {
...
function bd({ table: t }) {
  return /* @__PURE__ */ u(fe, { children: [
    /* @__PURE__ */ a(me, { asChild: !0, children: /* @__PURE__ */ u(V, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Ii, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function Ke({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Et.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Et.Icon, { asChild: !0, children: /* @__PURE__ */ a(li, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ar(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Nd(o)
  );
}
function Ia({
  className: t,
  ...
  const c = tt.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), zd(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Ed(c, b, w.key);
...
function qu({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(sc, { options: i, children: e })
    }
  );
}
...
var Dd = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Dd || {});
function Wu({ id: t, label: e, groups: r }) {
  const [o, n] = S(
    Object.fromEntries(
      r.map(
    ...
    /* @__PURE__ */ a(ve, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Vn, { children: l.itemType === 0 ? /* @__PURE__ */ a(ot, { children: l.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        pd,
        {
          ...
          children: l.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(gd, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(cr, {})
    ] }, l.label)) })
...
function $d({ id: t, versionHistory: e }) {
...
function Xu({
  ...
  const s = L(() => yi(r), [r]), d = ((l) => {
    const w = new Intl.DisplayNames(ki(), { type: "language" });
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a($d, { versionHistory: n }),
        ...
        /* @__PURE__ */ a(ie, { children: A.map((E) => /* @__PURE__ */ u(
          se,
          {
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ a(Ki, { className: "tw:h-4 tw:w-4" }),
...
const Pd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ot, { children: [
...
function Ld({
  ...
  return /* @__PURE__ */ u(fe, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(me, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Pd(t, n, r) }) }) }),
...
const Vd = (t, e) => t === "f" ? /* @__PURE__ */ u(ot, { children: [
  /* @__PURE__ */ a(Io, {}),
  " ",
...
function Fd({
  ...
  return /* @__PURE__ */ u(fe, { children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(me, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Vd(t, r) }) }) }),
      /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ a("p", { children: jd(t, r) }) })
    ] }) }),
...
function Ud({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Hi, { className: e, size: 16 });
}
function _o({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ u(
    se,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Ud, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Tc, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function Kd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = S(""), [i, s] = L(() => {
...
function Zu({
  ...
  const [m, b] = S("generated"), [v, N] = S("generated"), [y, _] = S("*"), [k, A] = S("*"), [M, I] = S("f"), [C, z] = S(!1), [E, $] = S(!0), [P, G] = S(!1), O = K(!1), W = K(""), [x, F] = S(!1), [lt, xt] = S(), [Mt, dt] = S(), [St, U] = S(), [nt, rt] = S(), wt = K(null), zt = L(
    () => ({
      ...
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? cc(), noteMode: "expanded" }
    }),
    [s, c]
  ), we = L(
    () => qd(
  ...
  const Ft = () => {
    ...
    if (B && wr("note", B)) {
      ...
      M !== "x" && R === "x" ? ft == null || ft.forEach(($t) => Gd($t)) : M === "x" && R !== "x" && (ft == null || ft.forEach(($t) => Hd($t))), (Dt = w.current) == null || Dt.applyUpdate([B, { delete: 1 }]);
    }
  }, Z = (R) => {
  ...
  return /* @__PURE__ */ u(ot, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ot, { children: Yd(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Pa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ge,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ve, { className: o, children: Zd(c.text) })
        ]
      },
...
const tw = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ a(Ji, { className: "tw:h-4 tw:w-4" });
  if (t === "desc")
  ...
  return e ? e[1] : "";
}, rw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", sp = Object.freeze([
...
function cp({
  ...
  }, [I, W]), F = L(() => x.length === 0 ? [] : aw(x, z, $), [x, z, $]), lt = L(() => {
    var rt, wt;
    if (!I) return d;
...
const nw = "16rem", iw = "3rem", Bn = tt.createContext(void 0);
function Ar() {
...
function lp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    V,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(di, {}) : /* @__PURE__ */ a(wi, {}),
    ...
    cw,
    {
      ...
      children: /* @__PURE__ */ u(dw, { children: [
        /* @__PURE__ */ u(No, { children: [
          ...
          /* @__PURE__ */ a(Eo, { children: /* @__PURE__ */ a(ww, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(uw, { children: /* @__PURE__ */ a(
            gw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const pe = "scrBook", fw = "scrRef", Ee = "source", mw = "details", vw = "Scripture Reference", bw = "Scripture Book", Un = "Type", xw = "Details";
function yw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: pe,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? vw,
      cell: (o) => {
...
}, zo = (t) => `${kw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function _p({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      Be,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(qe, { position: "item-aligned", children: /* @__PURE__ */ a(xd, { children: k.map((z) => /* @__PURE__ */ a(Ut, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
...
const Gn = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ u(hd, { children: [
    /* @__PURE__ */ a(fd, { children: c.label }),
    /* @__PURE__ */ a(ud, { children: /* @__PURE__ */ a(md, { children: Gn(
      t,
      e,
      qn(t, c.id),
      o
...
function ha({
  ...
  return /* @__PURE__ */ u(fe, { variant: i, children: [
    /* @__PURE__ */ a(me, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(es, {}) }) }),
...
const Cw = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Kt.Trigger,
  {
    ref: r,
    ...e,
...
function $p({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Wn, { children: [
      /* @__PURE__ */ a(Yn, { children: t.map((c) => /* @__PURE__ */ a(Cw, { value: c.value, children: c.value }, c.key)) }),
...
function Rw({
  ...
  const i = de();
  return /* @__PURE__ */ a(Tw, { children: /* @__PURE__ */ a(
    Jt.Content,
    {
...
const Xe = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Pt, { children: [
      ...
      ) : /* @__PURE__ */ u(Mw, { children: [
        /* @__PURE__ */ a(Ow, { children: l.label }),
        /* @__PURE__ */ a(Iw, { children: Jn(
          t,
          e,
          qn(t, l.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a($w, {}, `separator-${i}`)), d;
  });
};
function Aw({
  menuData: t,
  ...
  if (dc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, N;
    w.preventDefault();
    ...
    return /* @__PURE__ */ a(Ew, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(zw, { children: [
      /* @__PURE__ */ a(Sw, { ref: l(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        Rw,
        {
          style: { zIndex: He },
...
function Lw({ item: t, createLabel: e, createComplexLabel: r }) {
...
const Vw = nr(({ className: t, ...e }, r) => /* @__PURE__ */ a(os, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
Vw.displayName = "Spinner";
function Lp({
  id: t,
  isDisabled: e = !1,
  hasError: r = !1,
...
function ig({
  ...
  const n = st();
  return /* @__PURE__ */ u(Fw, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Bw, {}),
    /* @__PURE__ */ u(
      xe.Content,
      {
...
function hg({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    uc,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(fi, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(hi, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(gi, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(pi, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(ui, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function bg({
  ...
  return /* @__PURE__ */ a(
    Kt.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Uw({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
Gw(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Dd as DropdownMenuItemType,
  Or as DropdownMenuLabel,
  ud as DropdownMenuPortal,
  pd as DropdownMenuRadioGroup,
  gd as DropdownMenuRadioItem,
  ...
  Ad as EditorKeyboardShortcuts,
  Rd as ErrorDump,
  Hu as ErrorPopover,
  Qu as FOOTNOTE_EDITOR_STRING_KEYS,
  Ju as Filter,
  Wu as FilterDropdown,
  Xu as Footer,
  Zu as FootnoteEditor,
  Jd as FootnoteItem,
  tp as FootnoteList,
  ...
  Kd as MarkerMenu,
  Yu as MoreInfo,
  Md as MultiSelectComboBox,
  $p as NavigationContentSearch,
  ce as Popover,
  Rc as PopoverAnchor,
  le as PopoverContent,
  Nu as PopoverDescription,
  ku as PopoverHeader,
  _u as PopoverTitle,
  ...
  Dc as RecentSearches,
  gg as ResizableHandle,
  pg as ResizablePanel,
  ug as ResizablePanelGroup,
  Pp as ResultsCard,
  Np as SCOPE_SELECTOR_STRING_KEYS,
  Cp as ScopeSelector,
  _p as ScriptureResultsViewer,
  ...
  Od as UNDO_REDO_BUTTONS_STRING_KEYS,
  Ip as UiLanguageSelector,
  Id as UndoRedoButtons,
  Wn as VerticalTabs,
  Xn as VerticalTabsContent,
  Yn as VerticalTabsList,
  Cw as VerticalTabsTrigger,
  He as Z_INDEX_ABOVE_DOCK,
  rn as Z_INDEX_FOOTNOTE_EDITOR,
  mc as Z_INDEX_MODAL,
  fc as Z_INDEX_MODAL_BACKDROP,
  hc as Z_INDEX_OVERLAY,
  sd as badgeVariants,
