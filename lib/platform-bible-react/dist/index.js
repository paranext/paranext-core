...
import D, { forwardRef as nn, useCallback as Se, useState as fe, useRef as kr, useEffect as We, useLayoutEffect as oa, useMemo as lr } from "react";
...
const Fl = bt.Root, zl = bt.Trigger, Ri = D.forwardRef(({ className: e, align: r = "center", sideOffset: t = 4, ...n }, o) => /* @__PURE__ */ p(bt.Portal, { children: /* @__PURE__ */ p(
  bt.Content,
  {
    ref: o,
    align: r,
...
Ri.displayName = bt.Content.displayName;
const Gl = Ye.Portal, Pi = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ p(
  Ye.Overlay,
  {
    ref: t,
    className: R(
...
Pi.displayName = Ye.Overlay.displayName;
const Ul = D.forwardRef(({ className: e, children: r, ...t }, n) => /* @__PURE__ */ T(Gl, { children: [
  /* @__PURE__ */ p(Pi, {}),
  /* @__PURE__ */ T(
    Ye.Content,
    {
...
Ul.displayName = Ye.Content.displayName;
const Hl = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ p(
  Ye.Title,
  {
    ref: t,
...
Hl.displayName = Ye.Title.displayName;
...
Xl.displayName = Ye.Description.displayName;
const _i = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ p(
  Re,
  {
    ref: t,
    className: R(
...
_i.displayName = Re.displayName;
const $i = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ T("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
...
$i.displayName = Re.Input.displayName;
const Ii = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ p(
  Re.List,
  {
    ref: t,
...
Ii.displayName = Re.List.displayName;
const Ai = D.forwardRef((e, r) => /* @__PURE__ */ p(Re.Empty, { ref: r, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
Ai.displayName = Re.Empty.displayName;
...
Wl.displayName = Re.Group.displayName;
...
Yl.displayName = Re.Separator.displayName;
const Mi = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ p(
  Re.Item,
  {
    ref: t,
    className: R(
...
Mi.displayName = Re.Item.displayName;
function ql(e) {
...
function pa({
  ...
  const [c, h] = fe(!1);
  return /* @__PURE__ */ T(Fl, { open: c, onOpenChange: h, ...v, children: [
    /* @__PURE__ */ p(zl, { asChild: !0, children: /* @__PURE__ */ T(
      ye,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ p(Ri, { className: "pr-w-[200px] pr-p-0", dir: f, children: /* @__PURE__ */ T(_i, { children: [
      /* @__PURE__ */ p($i, { dir: f, placeholder: s, className: "pr-text-inherit" }),
      /* @__PURE__ */ p(Ai, { children: l }),
      /* @__PURE__ */ p(Ii, { children: r.map((d) => /* @__PURE__ */ T(
        Mi,
        {
          value: a(d),
          onSelect: () => {
...
), He = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ p(di.Root, { ref: t, className: R("pr-twp", Kl(), e), ...r }));
...
Di.displayName = wt.Root.displayName;
const eo = D.forwardRef(({ className: e, ...r }, t) => /* @__PURE__ */ p(
  wt.Item,
  {
    ...
    ...r,
    children: /* @__PURE__ */ p(wt.Indicator, { className: "pr-flex pr-items-center pr-justify-center", children: /* @__PURE__ */ p(ci, { className: "pr-h-2.5 pr-w-2.5 pr-fill-current pr-text-current" }) })
  }
));
eo.displayName = wt.Item.displayName;
...
function uv({
  ...
  const v = nr(t, "%webView_inventory_all%"), c = nr(t, "%webView_inventory_approved%"), h = nr(t, "%webView_inventory_unapproved%"), d = nr(t, "%webView_inventory_unknown%"), g = nr(t, "%webView_platformScripture_currentBook%"), y = nr(t, "%webView_inventory_scope_chapter%"), C = nr(t, "%webView_inventory_scope_verse%"), k = nr(t, "%webView_inventory_filter_text%"), [x, w] = fe([]), [O, _] = fe("all"), [B, S] = fe(""), [P, N] = fe(""), j = Se(
    (F, E) => {
      w((G) => {
        let z = [];
        return F.forEach((Y) => {
...
function kv({
  ...
  return /* @__PURE__ */ T("fieldset", { id: e, className: r, children: [
    t && /* @__PURE__ */ p("legend", { children: /* @__PURE__ */ p(He, { children: t }) }),
    n.map((s) => /* @__PURE__ */ T("div", { className: "pr-twp pr-m-2 pr-flex pr-items-center", children: [
      /* @__PURE__ */ p(
        Wi,
        {
...
function vu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, s = {}) => {
    ...
    const C = el(i, $({
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        l && (N = `${l}${qe(u || "")}`), N === void 0 && (N = `Styled(${Lc(i)})`), P.displayName = N;
      }
...
function gm(e) {
  ...
  if (!r.modifiersData[n]._skip) {
    for (var o = t.mainAxis, a = o === void 0 ? !0 : o, i = t.altAxis, s = i === void 0 ? !0 : i, l = t.fallbackPlacements, u = t.padding, f = t.boundary, b = t.rootBoundary, v = t.altBoundary, c = t.flipVariations, h = c === void 0 ? !0 : c, d = t.allowedAutoPlacements, g = r.options.placement, y = Xe(g), C = y === g, k = l || (C || !h ? [qt(g)] : hm(g)), x = [g].concat(k).reduce(function(z, Y) {
      ...
      var N = x[P], j = Xe(N), V = Kr(N) === Wr, Z = [Ce, je].indexOf(j) >= 0, K = Z ? "width" : "height", H = St(r, {
        placement: N,
        boundary: f,
        rootBoundary: b,
        altBoundary: v,
...
function Sm(e) {
  var r = e.state, t = e.options, n = e.name, o = t.mainAxis, a = o === void 0 ? !0 : o, i = t.altAxis, s = i === void 0 ? !1 : i, l = t.boundary, u = t.rootBoundary, f = t.altBoundary, b = t.padding, v = t.tether, c = v === void 0 ? !0 : v, h = t.tetherOffset, d = h === void 0 ? 0 : h, g = St(r, {
    ...
    padding: b,
    altBoundary: f
  }), y = Xe(r.placement), C = Kr(r.placement), k = !C, x = Bo(y), w = Tm(x), O = r.modifiersData.popperOffsets, _ = r.rects.reference, B = r.rects.popper, S = typeof d == "function" ? d(Object.assign({}, r.rects, {
    placement: r.placement
  })) : d, P = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
...
`));
  ...
  N ? (et.title = !Je && Pn && !V ? de : null, et["aria-describedby"] = Je ? Cn : null) : (et["aria-label"] = Pn ? de : null, et["aria-labelledby"] = Je && !Pn ? Cn : null);
