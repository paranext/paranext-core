...
var qt = (t, e, n) => wi(t, typeof e != "symbol" ? e + "" : e, n);
...
import { toast as tf } from "sonner";
...
function _r({
  ...
  const R = Ct(), [I, S] = D(!1), [V, _] = D(""), [T, C] = D(""), [v, E] = D("books"), [$, L] = D(void 0), [A, j] = D(
    void 0
  ), [U, X] = D(void 0), [et, Tt] = D(!1), Bt = H(null), Rt = H(!1), rt = H(void 0), vt = H(void 0), q = H(void 0), it = H(void 0), ct = H({}), pt = H({}), ut = G(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
  ...
  }), [It]), Gt = z(() => Object.values(Ot).flat(), [Ot]), Pe = z(() => {
    if (!T.trim()) return Ot;
    const k = {
      [Q.OT]: [],
      [Q.NT]: [],
    ...
    return [Q.OT, Q.NT, Q.DC, Q.Extra].forEach((tt) => {
      k[tt] = Ot[tt].filter((Kt) => ho(Kt, T, a));
    }), k;
  }, [Ot, T, a]), P = z(
    () => kc(T, Gt, a),
    [T, Gt, a]
      ...
      if (v === "verses" && Kt) {
        ...
        switch (k.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            $t = Z === 0 ? K : Math.max(1, Z - we);
            break;
          case "ArrowDown":
            $t = Z === 0 ? 1 : Math.min(K, Z + we);
            break;
          default:
            return;
        }
        $t !== Z && (k.preventDefault(), k.stopPropagation(), _(
          `${Pt} ${ae[Pt] || ""} ${O}:${$t}`
        ), setTimeout(() => {
          const He = pt.current[$t];
          He && He.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((v === "chapters" || v === "books" && P) && Kt) {
        const Pt = v === "chapters" ? $ : P == null ? void 0 : P.book;
        if (!Pt) return;
        ...
        switch (k.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Z = O === 0 ? K : Math.max(1, O - $t);
            break;
          case "ArrowDown":
            Z = O === 0 ? 1 : Math.min(K, O + $t);
            break;
          default:
            return;
        }
  ...
  return Wt(() => {
    const k = setTimeout(() => {
      if (I && v === "books" && q.current && it.current) {
        const Y = q.current, tt = it.current, Kt = tt.offsetTop, $e = Y.clientHeight, Ke = tt.clientHeight, qe = Kt - $e / 2 + Ke / 2;
        Y.scrollTo({
          top: Math.max(0, qe),
          behavior: "smooth"
        }), _(ts(t.book));
    ...
    /* @__PURE__ */ r(
      ce,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: Y } = k;
          Bt.current && Y instanceof Node && Bt.current.contains(Y) && (Rt.current = !0, Dt(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ p(
          ve,
          {
            ...
            children: [
              v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: lt.map(({ onClick: k, disabled: Y, title: tt, icon: Kt }) => /* @__PURE__ */ r(
                  F,
                  {
                    variant: "ghost",
                    size: "sm",
...
const bo = {
  ...
  mark: "",
  markOverlap: ""
}, Mt = Ze.Provider, Lt = Ze.Root, Vt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Ze.Trigger,
  {
    ref: o,
...
Vt.displayName = Ze.Trigger.displayName;
const At = b.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(Ze.Portal, { children: /* @__PURE__ */ r(
  Ze.Content,
  {
    ref: a,
    sideOffset: e,
...
At.displayName = Ze.Content.displayName;
const vo = [
  Xl,
  Ta,
  Sa,
...
function Ue(t, e) {
  Ht.call(this, void 0), this.x = t, this.s = void 0, this.g = Yn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function ed(t, e) {
  return new Ue(t, e);
}
...
Ht.prototype.brand = Zc, Ht.prototype.h = function() {
  return !0;
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
          /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(hn, {}) }) }),
          /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("p", { children: y }) })
        ] }) }),
        /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
          ...
          /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("p", { children: g }) })
        ] }) })
      ] })
    ] }),
...
function iw({
  ...
  const [T, C] = D(sa), [v, E] = D(
    void 0
  ), $ = o, [L, A] = D(!1), [j, U] = D(!1), [X, et] = D(!1), [Tt, Bt] = D(!1), [Rt, rt] = D(!1), [vt, q] = D(S), [it, ct] = D(!1), pt = H(void 0), [ut, It] = D(/* @__PURE__ */ new Map());
  J(() => {
    let M = !0;
    return (async () => {
  ...
  const Gt = z(() => Ot[0], [Ot]), Pe = H(null), P = H(void 0), Ft = G(() => {
    var M;
  ...
  const zt = z(
    ...
    () => nt === 1 ? zt.singleReply : Xe(zt.multipleReplies, { count: nt }),
    [nt, zt]
  ), Nt = z(
    () => ft === 1 ? zt.singleReply : Xe(zt.multipleReplies, { count: ft }),
    [ft, zt]
  );
  J(() => {
    !o && j && lt && U(!1);
  ...
  const kt = G(
    async (M) => {
      ...
      _t && await m({ threadId: d, contents: _t }) && Ft();
    },
    [
      Ft,
      T,
    ...
    async (M) => {
      ...
      return xt && _t && Ft(), xt && v !== void 0 && E(void 0), xt;
    },
    [Ft, T, m, v]
  );
  if (Gt)
          ...
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            ...
            /* @__PURE__ */ r(
              aa,
              {
                ...
                handleDeleteComment: u,
                onEditingChange: U,
                canEditOrDelete: (!j && ut.get(Gt.id)) ?? !1,
...
function Tw({
  ...
  return /* @__PURE__ */ p(st, { children: [
    /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
      ...
      /* @__PURE__ */ r(At, { children: /* @__PURE__ */ p("p", { children: [
...
function Iw({
  ...
  return /* @__PURE__ */ p(be, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Rw(t, a, n) }) }) }),
      /* @__PURE__ */ r(At, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ p(
      ie,
      {
...
function Mw({
  ...
  return /* @__PURE__ */ p(be, { children: [
    /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
      ...
      /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("p", { children: Ow(t, n) }) })
    ] }) }),
...
function sm({
  ...
  const [g, y] = D("generated"), [x, N] = D("*"), [R, I] = D("f"), [S, V] = D(!1), [_, T] = D(!0), [C, v] = D(!1), E = H(!1), $ = H(""), [L, A] = D(!1), [j, U] = D(), [X, et] = D(), [Tt, Bt] = D(), [Rt, rt] = D(), vt = H(null), q = z(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const Ot = () => {
    ...
    if (f.current && it.length && B && B.rangeCount > 0) {
      ...
      U(W.left - nt.left), et(W.top - nt.top), Bt(W.height), A(!0);
    }
  }, [it, f]);
  return J(() => {
    const B = () => {
    ...
    const B = ((nt = m.current) == null ? void 0 : nt.querySelector(".editor-input")) ?? void 0, W = (lt) => {
      !L && B && document.activeElement === B && lt.key === l ? (lt.preventDefault(), zt()) : L && lt.key === "Escape" && (lt.preventDefault(), A(!1));
    };
    return document.addEventListener("keydown", W), () => {
      document.removeEventListener("keydown", W);
    };
  }, [L, zt, l]), /* @__PURE__ */ p(st, { children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
            ...
            /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("p", { children: d["%footnoteEditor_saveButton_tooltip%"] }) })
          ] }) }),
          /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
            /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(hn, {}) }) }),
            /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("p", { children: d["%footnoteEditor_cancelButton_tooltip%"] }) })
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
              ...
              /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("p", { children: d["%footnoteEditor_copyButton_tooltip%"] }) })
            ] }) }) })
          ]
        }
      )
...
const Hw = (t) => {
...
}, hr = (t, e, n) => /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
  /* @__PURE__ */ p(
    Vt,
    {
  ...
  /* @__PURE__ */ r(At, { side: "bottom", children: e })
] }) }), cm = (t) => ({
  accessorKey: "item",
  ...
  return /* @__PURE__ */ r("div", { id: c, className: "pr-twp tw-h-full tw-overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-h-full tw-w-full tw-min-w-min tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
        ...
        /* @__PURE__ */ r(At, { children: (o == null ? void 0 : o.checkboxText) ?? V })
      ] }) })
    ] }),
...
function rp({ row: t, mode: e, strings: n, onClick: o, onOpen: a }) {
  ...
  return /* @__PURE__ */ p(Lt, { delayDuration: 200, children: [
  ...
  return /* @__PURE__ */ p(ye, { open: e, onOpenChange: n, children: [
    ...
    /* @__PURE__ */ r(
      ce,
      {
        ...
        children: /* @__PURE__ */ r(Mt, { delayDuration: 200, children: /* @__PURE__ */ p(ve, { shouldFilter: !1, children: [
...
const Vs = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Ls.Provider, { value: R, children: /* @__PURE__ */ r(Mt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const fp = Be(
  ...
  ({
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Vt, { asChild: !0, children: w }),
      /* @__PURE__ */ r(At, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : w;
  }
);
...
function ym({
  ...
  const R = jt(
    i,
    "%webView_scope_selector_selected_text%"
  ), I = jt(i, "%webView_scope_selector_verse%"), S = jt(i, "%webView_scope_selector_chapter%"), V = jt(i, "%webView_scope_selector_book%"), _ = jt(
    i,
    "%webView_scope_selector_current_verse%"
  ), T = jt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), C = jt(i, "%webView_scope_selector_current_book%"), v = jt(i, "%webView_scope_selector_choose_books%"), E = jt(i, "%webView_scope_selector_scope%"), $ = jt(i, "%webView_scope_selector_select_books%"), L = jt(i, "%webView_scope_selector_range%"), A = jt(i, "%webView_scope_selector_select_range%"), j = jt(i, "%webView_scope_selector_range_start%"), U = jt(i, "%webView_scope_selector_range_end%"), X = jt(i, "%webView_scope_selector_ok%"), et = jt(i, "%webView_scope_selector_navigate%"), Tt = (O) => {
    if (!g) return;
  ...
  ] }), rt = e ? Bt.filter((O) => e.includes(O.value)) : Bt, vt = g ?? yr, q = w ?? vt, it = m ?? vt, ct = () => {
  }, pt = H(null), ut = H(null), It = H(!1), Ot = H(null), Gt = H(!1), [Pe, P] = D(void 0), Ft = H(!1), Qt = H(!1), zt = H(null), B = G((O) => {
    if (O) {
      P("start"), Ft.current = !1;
      return;
    }
    P((K) => K === "start" ? void 0 : K), Ft.current && (Ft.current = !1, requestAnimationFrame(() => {
      var Z;
    ...
    (O) => {
      f == null || f(O), u == null || u(O), Ft.current = !0;
    },
    [f, u]
  ), lt = G(
    (O) => {
    ...
    /* @__PURE__ */ p("div", { ref: pt, className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        _r,
        {
          ...
          onCloseAutoFocus: (O) => {
            var K;
            Qt.current && (Qt.current = !1, O.preventDefault(), (K = zt.current) == null || K.focus());
          },
          className: h(xt && ke),
          modal: !0,
          align: "start"
  ...
  const [ze, br] = D(null), [an, vr] = D(null), [k, Y] = D(null), tt = 200, [Kt, $e] = D(!1);
  J(() => {
  ...
  }, []), Pt = (O) => t === O ? /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Zt, { className: "tw-h-4 tw-w-4" }) }) : void 0;
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      c === "dropdown" ? /* @__PURE__ */ p(be, { open: rn, onOpenChange: _n, children: [
        ...
        /* @__PURE__ */ r(
          ie,
          {
            ...
            children: /* @__PURE__ */ p(Nr, { container: k, children: [
              Nt.map(({ value: O, label: K, dropdownLabel: Z, scrRefSuffix: $t, id: we }) => /* @__PURE__ */ r(
                ee,
                {
                  ref: on(O),
                  checked: t === O,
                ...
                /* @__PURE__ */ r(
                  We,
                  {
                    ...
                    onSelect: (O) => {
                      ...
                      Gt.current || (Z = (K = ut.current) == null ? void 0 : K.querySelector("button")) == null || Z.click();
                    },
                    children: /* @__PURE__ */ r(
                      "div",
                      {
        ...
        go,
        {
          ...
          children: rt.map(({ value: O, label: K, scrRefSuffix: Z, id: $t }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(er, { className: "tw-me-2", value: O, id: $t }),
            /* @__PURE__ */ r(Et, { htmlFor: $t, children: Rt(K, Z) })
          ] }, $t))
        }
      )
    ] }),
        ...
        children: /* @__PURE__ */ r(
          Zn,
          {
            ...
            children: /* @__PURE__ */ p(Nr, { container: ze, children: [
              ...
              Ge,
              /* @__PURE__ */ r(Xr, { children: /* @__PURE__ */ r(F, { ref: zt, onClick: () => Fe(void 0), children: X }) })
            ] })
          }
        )
      }
...
const Xs = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ p(Lt, { children: [
  ...
  l.tooltip && /* @__PURE__ */ r(At, { children: l.tooltip })
...
function ao({
  ...
  return /* @__PURE__ */ p(be, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ie, { align: "start", style: { zIndex: xn }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, c]) => typeof d == "boolean" || typeof c == "boolean" ? 0 : d.order - c.order).map(([d], c, w) => /* @__PURE__ */ p(io, { children: [
      /* @__PURE__ */ r(Ds, { children: /* @__PURE__ */ r(Mt, { children: Xs(e.groups, e.items, d, t) }) }),
...
const Rn = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((c) => c.group === s).sort((c, w) => c.order - w.order).map((c) => /* @__PURE__ */ p(Lt, { children: [
      ...
      c.tooltip && /* @__PURE__ */ r(At, { children: c.tooltip })
  ...
  if (cc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, m) => {
    ...
    return /* @__PURE__ */ r(ti, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, m]) => typeof w == "boolean" || typeof m == "boolean" ? 0 : w.order - m.order).map(([w, m]) => /* @__PURE__ */ p(Ap, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          style: { zIndex: xn },
          children: /* @__PURE__ */ r(Mt, { children: ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Mm({
  ...
  return n ? /* @__PURE__ */ r(Mt, { delayDuration: 0, children: /* @__PURE__ */ p(Lt, { children: [
...
const $m = bt.Root, jm = bt.Trigger, Lm = bt.Group, Vm = bt.Portal, Bm = bt.Sub, Gm = bt.RadioGroup, Up = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  bt.SubTrigger,
  {
    ref: a,
    className: h(
...
const Fm = le.Trigger, ru = le.Portal, zm = le.Close, ci = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  le.Overlay,
  {
    ref: n,
...
const Ym = Xt.Root, pu = b.forwardRef(({ className: t, ...e }, n) => {
  const o = Ct();
  return /* @__PURE__ */ r(
    Xt.List,
    {
