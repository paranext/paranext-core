...
var At = (t, e, r) => Gi(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Gt, Z as Hi, B as j, c as m, a as Yi, C as Pe, D as pe, T as Vt, b as Lt, d as Ft, e as he, f as Bt, g as ge, h as dn, i as lr, j as Me, k as Te, P as Ie, l as He, m as Ve, n as Ye, o as Nr, p as We, q as ea, S as rr, s as ar, u as Wi, t as Ke, v as Re, w as Da, x as wn, y as Xi, z as Ji, A as un, E as pn, F as Zi, G as Qi, H as ts, I as ua, J as pa, K as ra, L as es, M as rs, N as as, O as os, Q as ns, R as Cr, U as qa } from "./resizable-1QLYYY9K.js";
import { V as rg, W as ag, X as og, Y as ng, _ as ig, $ as sg, a0 as cg, a1 as lg, a2 as dg } from "./resizable-1QLYYY9K.js";
import { jsx as a, jsxs as u, Fragment as tt } from "react/jsx-runtime";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as Mr, Section as Z, getChaptersForBook as is, formatScrRef as Ne, getSectionForBook as br, formatRelativeDate as ss, formatReplacementString as ke, sanitizeHtml as cs, NumberFormat as ls, formatBytes as ds, getCurrentLocale as ws, usfmMarkers as Lr, getFormatCallerFunction as us, deepEqual as ps, isString as mo, compareScrRefs as Oa, scrRefToBBBCCCVVV as ha, defaultScrRef as ga, formatScrRefRange as hs, getLocalizeKeyForScrollGroupId as vo } from "platform-bible-utils";
import { Check as qe, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronUp as hn, ChevronDown as Ge, ArrowLeft as gs, ArrowRight as fs, BoldIcon as ms, ItalicIcon as vs, X as aa, AtSign as gn, Pencil as bs, Trash2 as xs, ArrowUp as fn, MoreHorizontal as ys, MailOpen as ks, Mail as _s, FilterIcon as Ns, ArrowLeftIcon as Cs, ChevronLeftIcon as Es, ChevronRightIcon as Ts, ArrowRightIcon as zs, Copy as mn, Filter as Ss, User as Ds, Link as Os, CircleHelp as $s, ChevronsUpDown as vn, Star as Ms, Undo as Rs, Redo as As, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Ps, AlertCircle as $a, CircleCheckIcon as Is, CircleXIcon as Vs, CircleHelpIcon as Ls, ArrowUpIcon as Fs, ArrowDownIcon as Bs, Search as js, LoaderCircle as Us, ScrollText as Ks, ChevronRight as qs, ChevronLeft as Gs, MenuIcon as Hs, Menu as Ys, EllipsisVertical as Ws, MoreVertical as ko } from "lucide-react";
import ut, { useRef as H, useMemo as F, useState as E, useCallback as L, useEffect as W, useLayoutEffect as Qt, Fragment as Ga, createContext as Ha, useContext as kn, Component as Xs, createElement as _o, Suspense as Js, forwardRef as oa } from "react";
import { Dialog as fe, Label as Zs, RadioGroup as Ma, ToggleGroup as _n, Slot as dr, Avatar as Ya, Select as It, Checkbox as No, Tabs as ie, Menubar as be, ContextMenu as St, Progress as Co, Slider as Rr, Switch as Eo } from "radix-ui";
import { createEditor as Nn, $getRoot as ze, $createParagraphNode as wr, $getSelection as qt, HISTORY_MERGE_TAG as Wa, ParagraphNode as Cn, TextNode as En, $isTokenOrSegmented as Qs, $getCharacterOffsets as tc, $cloneWithPropertiesEphemeral as ec, $getPreviousSelection as rc, $isRangeSelection as me, $caretFromPoint as ac, $getSiblingCaret as Tn, $getChildCaret as oc, $getAdjacentChildCaret as nc, $isChildCaret as ic, $normalizeCaret as sc, $setSelectionFromCaretRange as cc, $getCollapsedCaretRange as lc, $getCaretInDirection as To, $splitAtPointCaretNext as dc, $isTextPointCaret as wc, $findMatchingParent as zn, $isElementNode as Ce, mergeRegister as Se, getDOMTextNode as uc, isHTMLElement as Sn, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as Xa, shallowMergeConfig as pc, defineExtension as ee, safeCast as Xe, createState as hc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as Mn, RootNode as gc, LineBreakNode as fc, TabNode as mc, $isEditorState as vc, createCommand as bc, CLICK_COMMAND as xc, isDOMNode as yc, $getNodeFromDOMNode as kc, $createNodeSelection as _c, $setSelection as Nc, $getEditor as Cc, DecoratorNode as Ra, $getState as Ec, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as Tc, $setState as zc, addClassNamesToElement as Rn, $create as Sc, $getNodeByKey as Dc, removeClassNamesFromElement as Oc, KEY_TAB_COMMAND as $c, $isBlockElementNode as Kr, $createRangeSelection as Mc, $normalizeSelection__EXPERIMENTAL as Rc, OUTDENT_CONTENT_COMMAND as Ac, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as Pc, COMMAND_PRIORITY_CRITICAL as Ja, $isDecoratorNode as Ic, $isParagraphNode as Vc, $isTextNode as qr, SELECTION_CHANGE_COMMAND as An, getRegisteredNode as Lc, isDocumentFragment as Do, isDOMDocumentNode as Fc, ArtificialNode__DO_NOT_USE as Pn, $createLineBreakNode as In, $isRootOrShadowRoot as Bc, isBlockDomNode as Oo, isInlineDomNode as $o, $insertNodes as jc } from "lexical";
...
import { useReactTable as Fn, getFilteredRowModel as il, getSortedRowModel as Bn, getPaginationRowModel as sl, getCoreRowModel as jn, flexRender as xr, getGroupedRowModel as cl, getExpandedRowModel as ll } from "@tanstack/react-table";
import dl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Aa, HIDDEN_NOTE_CALLER as Pa, getDefaultViewOptions as wl, isInsertEmbedOpOfType as Ar, Editorial as ul } from "@eten-tech-foundation/platform-editor";
...
function bl({
  ...
  return /* @__PURE__ */ u(pe, { open: w, onOpenChange: p, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ a(
        j,
        {
          variant: l,
          size: "icon",
    ...
    /* @__PURE__ */ u(ge, { id: s, align: "start", style: { zIndex: dn }, children: [
      /* @__PURE__ */ a(lr, { children: i }),
      t.map((h) => /* @__PURE__ */ u(
        Me,
        {
          className: c,
  ...
  const o = xl.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && d) {
          const h = ((f) => Object.keys(oe).find(
            (x) => oe[x].toLowerCase() === f.toLowerCase()
          ))(c);
...
function Nl(t, e, r, o, n) {
  const i = L(() => {
    if (t.chapterNum > 1)
      ...
      if (l > 0) {
        const w = e[l - 1], p = Math.max(ne(w), 1);
        o({
          book: w,
          chapterNum: p,
          verseNum: 1
  ...
  return F(() => [
    ...
    {
      onClick: s,
      disabled: e.length === 0 || (t.chapterNum === ne(t.book) || ne(t.book) <= 0) && e.indexOf(t.book) === e.length - 1,
      title: "Next chapter",
      icon: r === "ltr" ? yo : xo
    },
    {
...
function Hn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Te, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", d), children: Array.from({ length: t }, (l, w) => w + 1).map((l) => {
      ...
      return /* @__PURE__ */ a(
        Pe,
        {
          ...
          className: m(
            ...
            c && "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset",
            {
              "tw:bg-muted/50 tw:text-muted-foreground/50": ((i == null ? void 0 : i(l)) ?? !1) && !w && !((s == null ? void 0 : s(l)) ?? !1)
            },
            {
              ...
              "tw:bg-primary/70 tw:text-primary-foreground tw:data-selected:bg-primary/70 tw:data-selected:text-primary-foreground tw:hover:bg-primary": (s == null ? void 0 : s(l)) ?? !1
            },
...
function ma({
  ...
  const k = Gt(), [_, N] = E(!1), [P, U] = E(""), [I, O] = E(""), [y, S] = E("books"), [R, D] = E(void 0), [B, V] = E(
    void 0
  ), [K, $] = E(void 0), [Q, mt] = E(!1), ct = H(null), Ht = H(!1), bt = H(void 0), Dt = H(void 0), q = H(void 0), rt = H(void 0), ot = H({}), nt = H({}), it = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), jt = F(() => o ? o() : Kn, [o]), vt = F(() => ({
    [Z.OT]: jt.filter((G) => dt.isBookOT(G)),
    [Z.NT]: jt.filter((G) => dt.isBookNT(G)),
    [Z.DC]: jt.filter((G) => dt.isBookDC(G)),
    [Z.Extra]: jt.filter((G) => dt.extraBooks().includes(G))
  }), [jt]), Yt = F(() => Object.values(vt).flat(), [vt]), Wt = F(() => {
    if (!I.trim()) return vt;
    const b = {
      [Z.OT]: [],
      [Z.NT]: [],
    ...
    return [Z.OT, Z.NT, Z.DC, Z.Extra].forEach((X) => {
      b[X] = vt[X].filter((Et) => Qa(Et, I, n));
    }), b;
  }, [vt, I, n]), T = F(
    () => _l(I, Yt, n),
    [I, Yt, n]
  ...
  const Ut = L(() => {
    if (T) {
      const b = T.chapterNum ?? 1, G = T.verseNum ?? 1;
      if (w && fa(T.book, b, G, w))
        return;
      it({
        book: T.book,
        chapterNum: b,
    ...
    (b) => {
      const G = B ?? (T == null ? void 0 : T.book), X = K ?? (T == null ? void 0 : T.chapterNum);
      !G || !X || (it({
        book: G,
        chapterNum: X,
        verseNum: b
    ...
    (b) => {
      const G = y === "chapters" ? R : T == null ? void 0 : T.book;
      if (G) {
        if (l && l(G, b) > 1) {
          V(G), $(b), S("verses"), U("");
          return;
    ...
    S("books"), D(void 0), V(void 0), $(void 0), setTimeout(() => {
      Dt.current && Dt.current.focus();
    }, 0);
  }, []), A = L(() => {
    const b = B;
    V(void 0), $(void 0), b ? (D(b), S("chapters"), U("")) : Zt();
  }, [B, Zt]), Y = L((b) => {
    N(b), b && (S("books"), D(void 0), V(void 0), $(void 0), O(""));
    ...
    const b = P.match(/(\d+)$/);
    if (b) {
      const G = parseInt(b[1], 10), X = ne(T.book);
      if (G >= 1 && (X <= 0 || G <= X)) return G;
    }
    return T.chapterNum ?? 1;
  }, [P, T]), z = F(
    () => Ne(
      t,
    ...
    () => yl(I),
    [I]
  ), Oe = F(() => !l || !T || !T.chapterNum || !_t ? !1 : l(T.book, T.chapterNum) > 0, [l, T, _t]), Fe = L(
    (b) => w ? Ro(b, w) : !1,
    [w]
  ), pr = L(
    (b) => (G) => w ? kl(b, G, w) : !1,
    ...
    (b, G) => (X) => w ? fa(b, G, X, w) : !1,
    [w]
  ), hr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Je = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", zr = L(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && T && T.chapterNum !== void 0 && T.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), Ut());
    },
    [p, T, Ut]
  ), Sr = L(
    (b) => {
      var se, gr, Ze;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: X } = Ao(b.key);
      if ((y === "chapters" || y === "verses") && (b.key === " " || b.key === "Enter")) {
        const Ot = b.target instanceof HTMLElement ? b.target : void 0;
        ...
        const Tt = (se = bt.current) == null ? void 0 : se.querySelector(
      ...
      if ((y === "chapters" || y === "verses") && (G || X)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (y === "chapters" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), Zt();
        return;
      }
      ...
      if (y === "verses" && Et) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            ft !== 0 && (Rt = ft > 1 ? ft - 1 : Tt);
            break;
          case "ArrowRight":
            ft !== 0 && (Rt = ft < Tt ? ft + 1 : 1);
            break;
          case "ArrowUp":
            Rt = ft === 0 ? Tt : Math.max(1, ft - ce);
            break;
          case "ArrowDown":
            Rt = ft === 0 ? 1 : Math.min(Tt, ft + ce);
            break;
          default:
            return;
        }
        Rt !== ft && (b.preventDefault(), b.stopPropagation(), U(
          `${Ot} ${oe[Ot] || ""} ${Nt}:${Rt}`
        ), setTimeout(() => {
          const le = nt.current[Rt];
          le && le.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((y === "chapters" || y === "books" && T) && Et) {
        const Ot = y === "chapters" ? R : T == null ? void 0 : T.book;
        if (!Ot) return;
        y === "chapters" && ((Ze = bt.current) == null || Ze.focus());
        const Nt = (() => {
          if (!P) return 1;
          const ce = P.match(/(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            Nt !== 0 && (ft = Nt > 1 ? Nt - 1 : Tt);
            break;
          case "ArrowRight":
            Nt !== 0 && (ft = Nt < Tt ? Nt + 1 : 1);
            break;
          case "ArrowUp":
            ft = Nt === 0 ? Tt : Math.max(1, Nt - Rt);
            break;
          case "ArrowDown":
            ft = Nt === 0 ? 1 : Math.min(Tt, Nt + Rt);
            break;
          default:
            return;
        }
        ft !== Nt && (b.preventDefault(), b.stopPropagation(), U(
          `${Ot} ${oe[Ot] || ""} ${ft}`
        ), setTimeout(() => {
          const ce = ot.current[ft];
    ...
    const { isLetter: G, isDigit: X } = Ao(b.key);
    (G || X) && (b.preventDefault(), O((se) => se + b.key), Dt.current.focus(), mt(!1));
  }, []);
  return Qt(() => {
    const b = setTimeout(() => {
      if (_ && y === "books" && q.current && rt.current) {
        const G = q.current, X = rt.current, Et = X.offsetTop, se = G.clientHeight, gr = X.clientHeight, Ze = Et - se / 2 + gr / 2;
        G.scrollTo({
          top: Math.max(0, Ze),
          behavior: "smooth"
        }), U(Gn(t.book));
    ...
    if (y === "chapters" && R) {
      const b = R === t.book, G = b ? t.chapterNum : 1;
      U(
        `${R} ${oe[R] || ""} ${G}`
      ), setTimeout(() => {
        if (q.current)
          if (b) {
            const X = ot.current[t.chapterNum];
  ...
  }, [y, R, T, t.book, t.chapterNum]), Qt(() => {
    if (y === "verses" && B && K !== void 0) {
      const b = B === t.book && K === t.chapterNum, G = b ? t.verseNum : 1;
      U(
        `${B} ${oe[B] || ""} ${K}:${G}`
      ), setTimeout(() => {
        if (q.current)
          if (b) {
            const X = nt.current[t.verseNum];
            X && X.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            q.current.scrollTo({ top: 0 });
        bt.current && bt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ie, { open: _, onOpenChange: Y, modal: v, children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(
      j,
      {
        ...
        onClick: (b) => {
          Ht.current && (Ht.current = !1, b.preventDefault());
        },
        children: g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: z })
      }
    ) }),
    /* @__PURE__ */ a(
      Ve,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: G } = b;
          _ && ct.current && G instanceof Node && ct.current.contains(G) && (Ht.current = !0, Y(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          Ye,
          {
            ...
            shouldFilter: !1,
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: m("tw:flex tw:items-end", Q && "tw:pb-1"), children: [
                /* @__PURE__ */ u("div", { className: "tw:relative tw:flex-1", children: [
                  /* @__PURE__ */ a(
                    Nr,
                    {
                      ...
                      onKeyDown: zr,
                      onFocus: () => mt(!1),
                      className: s && s.length > 0 ? "tw:pr-8!" : ""
                    }
                  ),
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:translate-y-px tw:items-center tw:pe-2", children: /* @__PURE__ */ a(Vt, { children: Jt.map(({ onClick: b, disabled: G, title: X, icon: Et }, se) => /* @__PURE__ */ u(Ga, { children: [
                  se === 2 && /* @__PURE__ */ a("div", { className: "tw:mx-1 tw:h-5 tw:w-px tw:bg-border", "aria-hidden": "true" }),
                ...
                /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
                  ...
                  /* @__PURE__ */ a(Bt, { children: "Back" })
                ] }) }),
                y === "chapters" && R && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ye(R, n) }),
                y === "verses" && B && K !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ye(B, n)} ${K}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? Je : hr
                  }
                )
              ] }),
              !Q && /* @__PURE__ */ u(We, { ref: q, children: [
                y === "books" && /* @__PURE__ */ u(tt, { children: [
                  !T && Object.entries(Wt).map(([b, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Te, { heading: yt(b), children: G.map((X) => /* @__PURE__ */ a(
                          qn,
                          {
                            bookId: X,
                            onSelect: (Et) => Xt(Et),
                  ...
                  T && /* @__PURE__ */ a(Te, { children: /* @__PURE__ */ u(
                    Pe,
                    {
                      value: `${T.book} ${oe[T.book]} ${T.chapterNum || ""}:${T.verseNum || ""})}`,
                      onSelect: Ut,
                      disabled: !!w && fa(
                        T.book,
                        T.chapterNum ?? 1,
                      ...
                      children: [
                        /* @__PURE__ */ a("span", { className: "tw:flex-1", children: Ne(
                          {
                            book: T.book,
                            chapterNum: kt ?? 1,
                            verseNum: kt === T.chapterNum ? T.verseNum ?? 1 : 1
                          },
                          ye(T.book, n)
                        ) }),
                        /* @__PURE__ */ a("span", { className: "tw:font-normal tw:text-muted-foreground", children: Za(T.book, n) })
                      ]
                    },
                    "top-match"
                  ) }),
                  T && Oe && T.chapterNum && l && /* @__PURE__ */ u(tt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${ye(T.book, n)} ${T.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Io,
                      {
                        ...
                        onVerseSelect: re,
                        setVerseRef: pt,
                        isVerseDisabled: Be(T.book, T.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  T && !Oe && ne(T.book) > 1 && /* @__PURE__ */ u(tt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: ye(T.book, n) }),
                ...
                y === "chapters" && R && /* @__PURE__ */ a(
                  Po,
                  {
                    ...
                    onChapterSelect: Mt,
                    setChapterRef: wt,
                    isChapterDisabled: pr(R),
                    className: "tw:p-4"
                  }
                ),
                y === "verses" && B && K !== void 0 && l && /* @__PURE__ */ a(
                  Io,
                  {
                    bookId: B,
                    chapterNum: K,
...
function Vo({
  ...
  const [_, N] = E(!1), P = l ?? d, U = (O) => O.length > 0 && typeof O[0] == "object" && "options" in O[0], I = (O, y) => {
    const S = d(O), R = typeof O == "object" && "secondaryLabel" in O ? O.secondaryLabel : void 0, D = `${y ?? ""}${S}${R ?? ""}`;
    return /* @__PURE__ */ u(
      Pe,
      {
        value: S,
  ...
  return /* @__PURE__ */ u(Ie, { open: _, onOpenChange: N, ...k, children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
      j,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ge, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(
      Ve,
      {
        ...
        children: /* @__PURE__ */ u(Ye, { children: [
          ...
          /* @__PURE__ */ a(We, { children: U(e) ? e.map((O) => /* @__PURE__ */ a(Te, { heading: O.groupHeading, children: O.options.map((y) => I(y, O.groupHeading)) }, O.groupHeading)) : /* @__PURE__ */ a(Te, { children: e.map((O) => I(O)) }) })
        ] })
      }
    )
  ] });
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zl = Xn ? Qt : W, Pr = { tag: Wa };
...
const Dl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : W;
...
const Pl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : W;
function Il(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Vl() {
  return function(t) {
    const [e] = xe(), r = F(() => t(e), [e, t]), [o, n] = E(() => r.initialValueFn()), i = H(o);
    return Pl(() => {
...
const Jn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Bl = Jn && "documentMode" in document ? document.documentMode : null;
!(!Jn || !("InputEvent" in window) || Bl) && "getTargetRanges" in new window.InputEvent("input");
function ue(t) {
  return `${t}px`;
}
const jl = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function Ul(t, e, r) {
  ...
  function l(w) {
    w.read(() => {
      ...
      if ((U || I) && N !== null && P !== null) {
        const O = function(y, S, R, D, B, V, K) {
          const $ = (y._window ? y._window.document : document).createRange();
          return $.setStart(...Lo(S, R, D)), $.setEnd(...Lo(B, V, K)), $;
        }(t, g, f, N, h, C, P);
        d(), d = Ul(t, O, e);
      }
...
function Hl(t) {
  const e = zn(t, (r) => Ce(r) && !r.isInline());
  return Ce(e) || Yr(4, t.__key), e;
}
function Yl(t) {
  const e = qt() || rc();
  let r;
  if (me(e)) r = ac(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Tn(c, "next"));
    }
    r = r || oc(ze(), "previous").getFlipped().insert(wr());
  }
...
function Wl(t, e, r) {
  ...
  return wc(o) && Yr(283), o.insert(t.isInline() ? wr().append(t) : t), To(Tn(t.getLatest(), "next"), e.direction);
}
function Xl(t) {
  const e = qt();
  if (!me(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = zn(i, (l) => Ce(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Wr, Ee = 0, Xr = 0, Ql = 0, Ba = 0, Br = 0;
function Bo(t) {
  if (et === void 0) return;
  let e = t.n;
...
function ed(t) {
  ...
  Qn(this), et = t, this.f &= -2, 8 & this.f && ro(this), ia();
}
function tr(t, e) {
...
Pt.prototype.brand = Jl, Pt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ee !== 0 && Xr === 0 && e.l !== Ba && (e.l = Ba, Wr = { S: e, v: e.v, i: e.i, o: Wr });
  ...
  if (this.g = Br, this.f |= 1, this.i > 0 && !Zn(this)) return this.f &= -2, !0;
  const t = et;
  try {
    jo(this), et = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ti(this), jo(this), Ee++;
  const t = et;
...
ee({ build: (t, e, r) => ur(e), config: Xe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ei() {
  const t = ze(), e = qt(), r = wr();
  t.clear(), t.append(r), e !== null && r.select(), me(e) && (e.format = 0);
}
function ri(t, e = ei) {
  return t.registerCommand(Dn, (r) => (t.update(e), !0), Xa);
}
ee({ build: (t, e, r) => ur(e), config: Xe({ $onClear: ei }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
class ai extends Ra {
  $config() {
    return this.config("decorator-text", { extends: Ra, stateConfigs: [{ flat: !0, stateConfig: xa }] });
  }
  getFormat() {
    return Ec(this, xa);
  }
...
ee({ name: "@lexical/extension/DecoratorText", nodes: () => [ai], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = qt();
  if ($n(n) || me(n)) for (const i of n.getNodes()) ad(i) && i.toggleFormat(o);
  return !1;
}, Mn) });
function oi(t, e) {
  let r;
...
const ja = ee({ build: (t) => oi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const ao = 0, Ua = 1, ii = 2, ya = 3, Ir = 4, Qe = 5, ka = 6, mr = 7;
function _a(t) {
  return t.id === ao;
}
function si(t) {
...
function od(t) {
  return function(e) {
    return e.id === Ua;
  }(t) || lt(305, String(t.id), String(Ua)), Object.assign(t, { id: ii });
}
...
function sd() {
  const t = ze();
  t.isEmpty() && t.append(wr());
}
const cd = ee({ config: Xe({ setOptions: Uo, updateOptions: Uo }), init: ({ $initialEditorState: t = sd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [gc, En, fc, mc, Cn] }), Ko = Symbol.for("@lexical/extension/LexicalBuilder");
function qo() {
}
function ld(t) {
  throw t;
...
class er {
  ...
  static maybeFromEditor(e) {
    const r = e[Ko];
    return r && (r.PACKAGE_VERSION !== Na && lt(292, r.PACKAGE_VERSION, Na), r instanceof er || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      _a(i) || lt(300, s, n || "[unknown]"), _a(c = i) || lt(304, String(c.id), String(ao)), i = Object.assign(c, { id: Ua }), o.state = i;
...
const dd = /* @__PURE__ */ new Set(), Go = ee({ build(t, e, r) {
  const o = r.getDependency(ja).output, n = kr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = oi(() => {
  }, () => ve(() => {
...
}, dependencies: [ja], name: "@lexical/extension/NodeSelection" }), wd = bc("INSERT_HORIZONTAL_RULE_COMMAND");
class or extends Ra {
  static getType() {
...
ee({ dependencies: [ja, Go], name: "@lexical/extension/HorizontalRule", nodes: () => [or], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Go).output, n = kr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Se(t.registerCommand(wd, (s) => {
    const c = qt();
    if (!me(c)) return !1;
...
ee({ build: (t, e) => ur({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Xe({ $getParentEditor: function() {
  const t = Cc();
...
ee({ build: (t, e, r) => ur(e), config: Xe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ve(() => {
...
function hd(t, e, r = ci) {
  return Se(t.registerCommand($c, (o) => {
    const n = qt();
    if (!me(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
ee({ build: (t, e, r) => ur(e), config: Xe({ $canIndent: ci, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ve(() => {
    if (!o.value) return hd(t, n, i);
  });
} });
const gd = ee({ name: "@lexical/react/ReactProvider" });
function fd() {
...
ee({ build: (t, e, r) => ur(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ve(() => r.getOutput().disabled.value ? void 0 : di(t)) });
function bd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const no = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : W;
...
const Cd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : W;
...
function Rd() {
  const [t, e] = E(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Ia, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Va, { children: [
...
function Ad({
  ...
  const [e] = xe(), [r, o] = E(e), [n, i] = E("paragraph"), [s, c] = Rd(), d = () => {
  };
...
function Ud(t, e) {
  ...
  const r = document.createElement("div"), o = ze().getChildren();
  for (let n = 0; n < o.length; n++)
    fi(t, o[n], r, e);
  return r.innerHTML;
}
function fi(t, e, r, o = null) {
  ...
  const c = Ce(s) ? s.getChildren() : [], d = Lc(t, s.getType());
  let l;
  ...
  for (let h = 0; h < c.length; h++) {
    ...
    !n && Ce(e) && x && e.extractWithChild(f, o, "html") && (n = !0);
  }
  if (n && !i) {
    if ((Sn(w) || Do(w)) && w.append(g), r.append(w), p) {
      const h = p.call(s, w);
      h && (Do(w) ? w.replaceChildren(h) : w.replaceWith(h));
    }
  } else r.append(g);
  return n;
}
...
function vi(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let g = [];
  const h = (c == null || !Bc(c)) && (c != null && Kr(c) || o);
  for (let f = 0; f < p.length; f++) g.push(...vi(p[f], e, r, h, new Map(n), c));
  return w != null && (g = w(g)), Oo(t) && (g = Kd(t, g, h ? () => {
    const f = new Pn();
    return r.push(f), f;
  } : wr)), c == null ? g.length > 0 ? s = s.concat(g) : Oo(t) && function(f) {
    return f.nextSibling == null || f.previousSibling == null ? !1 : $o(f.nextSibling) && $o(f.previousSibling);
  }(t) && (s = s.concat(In())) : Ce(c) && c.append(...g), s;
}
function Kd(t, e, r) {
...
function qd(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = jd(e, n);
      ze().clear(), jc(i);
    },
    {
      discrete: !0
...
function cp({
  ...
  const [i, s] = E(Hd), [c, d] = E(n), [l, w] = E(!1), p = H(void 0), g = H(null);
  W(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ie, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
        j,
        {
          variant: "outline",
...
function Jo({
  ...
  const h = L(
    ...
    [t.user]
  ), k = F(() => cs(t.contents), [t.contents]), _ = F(() => {
    if (o && c)
      return /* @__PURE__ */ u(tt, { children: [
        /* @__PURE__ */ u(
          Me,
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ u(ar, { variant: "secondary", className: "tw:text-xs tw:font-normal", children: [
              "→ ",
              Ur(t.assignedUser, r)
            ] })
          ] }),
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), h()) : co(N) && (N.preventDefault(), N.stopPropagation(), te(w) && f());
              },
              onKeyDown: (N) => {
        ...
        _ && /* @__PURE__ */ u(pe, { children: [
          /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ys, {}) }) }),
...
function Zd({
  ...
  const [O, y] = E(Zo), [S, R] = E(), [D, B] = E(), V = o, [K, $] = E(!1), [Q, mt] = E(!1), [ct, Ht] = E(!1), [bt, Dt] = E(!1), [q, rt] = E(!1), [ot, nt] = E(N), [it, jt] = E(!1), vt = H(void 0), [Yt, Wt] = E(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  W(() => {
    if (!o) {
      T.current !== "idle" && (R(void 0), B(void 0), T.current = "idle");
      return;
    }
    T.current === "idle" && (T.current = "pending"), bt ? T.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (R(I), T.current = "auto-populated") : T.current === "auto-populated" && (R(void 0), T.current = "pending");
  }, [o, I, bt, i]);
  const $t = F(() => e.filter((z) => !z.deleted), [e]);
  W(() => {
    let z = !0;
    if (!o || !_) {
      Wt(/* @__PURE__ */ new Map());
  ...
  const Ut = F(() => $t[0], [$t]), re = H(null), Xt = H(void 0), Mt = L(() => {
    var z;
    (z = Xt.current) == null || z.call(Xt), y(Zo);
  }, []), De = L(() => {
    const z = !ot;
    nt(z), jt(!z), f == null || f(d, z);
  }, [ot, f, d]);
  W(() => {
    $(!1);
  }, [o]), W(() => {
  ...
  }, [i, r]), A = F(() => $t.slice(1), [$t]), Y = F(() => A.length ?? 0, [A.length]), st = F(() => Y > 0, [Y]), at = F(() => K || Y <= 2 ? A : A.slice(-2), [A, Y, K]), ht = F(() => K || Y <= 2 ? 0 : Y - 2, [Y, K]), xt = F(
    () => Y === 1 ? Jt.singleReply : ke(Jt.multipleReplies, { count: Y }),
    [Y, Jt]
  ), yt = F(
    () => ht === 1 ? Jt.singleReply : ke(Jt.multipleReplies, { count: ht }),
    [ht, Jt]
  );
  W(() => {
    !o && Q && st && mt(!1);
  ...
  const gt = L(
    async (z) => {
      ...
      wt && await p({ threadId: d, contents: wt }) && Mt();
    },
    [
      Mt,
      O,
    ...
    async (z) => {
      const wt = te(O) ? Zr(O) : void 0, pt = z.status ? z.assignedUser : S ?? z.assignedUser, _t = await p({
        ...z,
        contents: wt,
        assignedUser: pt
      });
      return _t && (pt !== void 0 && B(pt), wt && Mt()), _t;
    },
    [Mt, O, p, S]
  );
  if ($t.length !== 0)
        ...
        children: /* @__PURE__ */ u(Wd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              Zt && /* @__PURE__ */ a(ar, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Zt }),
              /* @__PURE__ */ a(
                j,
                {
                  variant: "ghost",
                  ...
                  children: ot ? /* @__PURE__ */ a(ks, {}) : /* @__PURE__ */ a(_s, {})
                }
              ),
            ...
            /* @__PURE__ */ a(
              Jo,
              {
                ...
                handleDeleteComment: h,
                onEditingChange: mt,
                canEditOrDelete: (!Q && Yt.get(Ut.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(tt, { children: [
              ht > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (z) => {
                    (z.key === "Enter" || z.key === " ") && (z.preventDefault(), z.stopPropagation(), $(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(rr, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: yt }),
                      K ? /* @__PURE__ */ a(hn, {}) : /* @__PURE__ */ a(Ge, {})
                    ] })
                  ]
                }
              ),
              at.map((z) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Jo,
                {
                  comment: z,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: h,
                  onEditingChange: mt,
                  canEditOrDelete: (!Q && Yt.get(z.id)) ?? !1
                }
              ) }, z.id)),
              v !== !1 && (!Q || te(O)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (z) => {
                    co(z) && (z.preventDefault(), z.stopPropagation(), (te(O) || S !== void 0 && S !== D) && gt());
                  },
                  onKeyDown: (z) => {
                    io(z), (z.key === "Enter" || z.key === " ") && z.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Jr,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      S !== void 0 && (te(O) || S !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ke(
                      ...
                      /* @__PURE__ */ u(Ie, { open: ct, onOpenChange: Ht, children: [
                        /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(
                          j,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ a(
                          Ve,
                          {
                            ...
                            align: "end",
                            onKeyDown: (z) => {
                              z.key === "Escape" && (z.stopPropagation(), Ht(!1));
                            },
                            children: /* @__PURE__ */ a(Ye, { children: /* @__PURE__ */ a(We, { children: x == null ? void 0 : x.map((z) => /* @__PURE__ */ a(
                              Pe,
                              {
                                onSelect: () => {
                                  R(z !== i ? z : void 0), T.current = "user-selected", B(void 0), Ht(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function fp({
  ...
  const O = r.filter(
    ...
    [C, x]
  ), { listboxRef: D, activeId: B, handleKeyDown: V } = Wi({
    options: y,
    onOptionSelect: S
  }), K = L(
    ($) => {
...
function Qd({ table: t }) {
  return /* @__PURE__ */ u(pe, { children: [
    /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ u(j, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      ...
      /* @__PURE__ */ u(
        nr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(cr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ae, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function cw({
  ...
  let P;
  return d ? P = Array.from({ length: 10 }).map((y, S) => `skeleton-row-${S}`).map((y) => /* @__PURE__ */ a(_e, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Ae, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Da, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((U = _.getRowModel().rows) == null ? void 0 : U.length) > 0 ? P = _.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    _e,
    {
      onClick: () => s(I, _),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((O) => /* @__PURE__ */ a(Ae, { children: xr(O.column.columnDef.cell, O.getContext()) }, O.id))
    },
    I.id
  )) : P = /* @__PURE__ */ a(_e, { children: /* @__PURE__ */ a(Ae, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Qd, { table: _ }),
    /* @__PURE__ */ u(sa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(lo, { stickyHeader: i, children: _.getHeaderGroups().map((I) => /* @__PURE__ */ a(_e, { children: I.headers.map((O) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: O.isPlaceholder ? void 0 : xr(O.column.columnDef.header, O.getContext()) }, O.id)) }, I.id)) }),
...
function Np({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(pe, { children: [
    /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ u(j, { variant: "default", children: [
      /* @__PURE__ */ a(Ss, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(Ge, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(ge, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(lr, { children: l.label }),
...
function Ni({
  ...
  const [C, k] = E(!1), _ = L(
    (S) => {
      var D;
      const R = (D = t.find((B) => B.label === S)) == null ? void 0 : D.value;
      R && r(
        e.includes(R) ? e.filter((B) => B !== R) : [...e, R]
      );
    },
    [t, e, r]
  ), N = () => d || o, P = F(() => {
    if (!g) return t;
    const S = t.filter((D) => D.starred).sort((D, B) => D.label.localeCompare(B.label)), R = t.filter((D) => !D.starred).sort((D, B) => {
      const V = e.includes(D.value), K = e.includes(B.value);
      return V && !K ? -1 : !V && K ? 1 : D.label.localeCompare(B.label);
    });
    return [...S, ...R];
  }, [t, e, g]), U = () => {
    r(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: f, children: /* @__PURE__ */ u(Ie, { open: O, onOpenChange: w ?? k, children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
      j,
      {
        variant: x,
    ...
    /* @__PURE__ */ a(Ve, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ye, { children: [
        ...
        /* @__PURE__ */ a(Te, { children: P.map((S) => /* @__PURE__ */ u(
          Pe,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ a(Ms, { className: "tw:h-4 tw:w-4" }),
...
function Tp({
  ...
  return /* @__PURE__ */ u("div", { id: p, className: "tw:flex tw:items-center tw:gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:items-center tw:gap-2", children: e.map((g) => {
      var h;
      return /* @__PURE__ */ u(ar, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          j,
          {
            variant: "ghost",
...
function hw({
  ...
  const d = F(() => /Macintosh/i.test(navigator.userAgent), []), l = rn(n, "%undoButton_tooltip%"), w = rn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(
        j,
...
function mw({
  ...
  const i = H(null), s = H(null), c = H(!1), [d, l] = E(t), [w, p] = E(r), [g, h] = E(!1);
  W(() => {
    l(t);
  }, [t]), W(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(pe, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: fw(t, n, r) }) }) }),
...
function xw({
  ...
  return /* @__PURE__ */ u(pe, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: vw(t, r) }) }) }),
      /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ a("p", { children: bw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(ge, { style: { zIndex: un }, children: [
...
function _w({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  ...
  return /* @__PURE__ */ u(Ye, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(We, { children: [
      ...
      /* @__PURE__ */ a(Te, { children: i.map((c) => {
        var d;
        return /* @__PURE__ */ a(
          an,
          {
      ...
      s.length > 0 && /* @__PURE__ */ u(tt, { children: [
        ...
        /* @__PURE__ */ a(Te, { children: s.map((c) => {
          var d;
          return /* @__PURE__ */ a(
            an,
            {
...
function zp({
  ...
  const [f, x] = E("generated"), [v, C] = E("generated"), [k, _] = E("*"), [N, P] = E("*"), [U, I] = E("f"), [O, y] = E(!1), [S, R] = E(!0), [D, B] = E(!1), V = H(!1), K = H(""), [$, Q] = E(!1), [mt, ct] = E(), [Ht, bt] = E(), [Dt, q] = E(), [rt, ot] = E(), nt = H(null), it = F(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (Y && Ar("note", Y)) {
      ...
      let xt = "custom";
      ht === Aa ? xt = "generated" : ht === Pa ? xt = "hidden" : ht && (_(ht), P(ht)), x(xt), C(xt), I(((at = Y.insert.note) == null ? void 0 : at.style) ?? "f"), A = setTimeout(() => {
        var yt;
  ...
  const vt = L(
    (A, Y, st = !1) => {
      ...
      if (at && Ar("note", at)) {
        if (at.insert.note) {
          let gt;
          A === "custom" ? gt = Y : A === "generated" ? gt = Aa : gt = Pa, at.insert.note.caller = gt;
        }
  ...
  const T = H({ book: n.book, chapterNum: n.chapterNum });
  Qt(() => {
    (T.current.book !== n.book || T.current.chapterNum !== n.chapterNum) && (T.current = { book: n.book, chapterNum: n.chapterNum }, Wt.current());
  }, [n.book, n.chapterNum]);
  const $t = () => {
    var Y;
    ...
    if (Y && Ar("note", Y)) {
      ...
      U !== "x" && A === "x" ? gt == null || gt.forEach((kt) => Cw(kt)) : U === "x" && A !== "x" && (gt == null || gt.forEach((kt) => Ew(kt))), (yt = w.current) == null || yt.applyUpdate([Y, { delete: 1 }]);
    }
  }, Mt = (A) => {
    ot(A.contextMarker), B(A.canRedo);
  }, De = L(
    (A) => {
      var st, at, ht, xt, yt;
      const Y = (at = (st = w.current) == null ? void 0 : st.getNoteOps(0)) == null ? void 0 : at.at(0);
      if (Y && Ar("note", Y)) {
        ...
        const gt = (ht = Y.insert.note) == null ? void 0 : ht.style, kt = (yt = (xt = Y.insert.note) == null ? void 0 : xt.contents) == null ? void 0 : yt.ops;
        if (gt || y(!1), y(
          gt === "x" ? !!(kt != null && kt.every((z) => {
            var pt, _t;
            if (!((pt = z.attributes) != null && pt.char)) return !0;
            const wt = ((_t = z.attributes) == null ? void 0 : _t.char).style;
    ...
    if (g.current && jt.length && A && A.rangeCount > 0) {
  ...
  W(() => {
    ...
    const A = ((st = p.current) == null ? void 0 : st.querySelector(".editor-input")) ?? void 0, Y = (at) => {
      !$ && A && document.activeElement === A && at.key === c ? (at.preventDefault(), Jt()) : $ && at.key === "Escape" && (at.preventDefault(), Q(!1));
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
              ...
              /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ a("p", { children: Zt }) })
            ] }) }) })
          ]
        }
      )
...
function $w({
  ...
  return /* @__PURE__ */ u(sa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(lo, { stickyHeader: !0, children: /* @__PURE__ */ u(_e, { children: [
    ...
    /* @__PURE__ */ a(ca, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      _e,
      {
        ...
        children: [
          /* @__PURE__ */ a(Ae, { children: Ne(c.reference, "English") }),
          /* @__PURE__ */ a(Ae, { className: o, children: Ow(c.text) })
        ]
      },
...
function Vp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), C = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), _ = de(r, "%webView_inventory_scope_verse%"), N = de(r, "%webView_inventory_filter_text%"), P = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), U = de(r, "%webView_inventory_no_results%"), [I, O] = E(!1), [y, S] = E("all"), [R, D] = E(""), [B, V] = E([]), K = F(() => {
    const q = t ?? [];
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        nr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(cr, { children: [
              /* @__PURE__ */ a(ae, { value: "all", children: h }),
              /* @__PURE__ */ a(ae, { value: "approved", children: f }),
              /* @__PURE__ */ a(ae, { value: "unapproved", children: x }),
              /* @__PURE__ */ a(ae, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(nr, { onValueChange: (q) => Ht(q), defaultValue: s, children: [
        /* @__PURE__ */ a(sr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(ir, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(cr, { children: [
          /* @__PURE__ */ a(ae, { value: "book", children: C }),
          /* @__PURE__ */ a(ae, { value: "chapter", children: k }),
          /* @__PURE__ */ a(ae, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Tr,
      ...
      o && /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
        /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Ct, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? P })
        ] }) }),
        /* @__PURE__ */ a(Bt, { children: (o == null ? void 0 : o.checkboxText) ?? P })
      ] }) })
    ] }),
...
const Ti = oa(({ className: t, ...e }, r) => /* @__PURE__ */ a(Us, { size: 35, className: m("tw:animate-spin", t), ...e, ref: r }));
Ti.displayName = "Spinner";
function Vw(t, e = 50) {
  const [r, o] = E(e), n = H(null);
  return W(() => {
    o(e);
  }, [t, e]), W(() => {
...
function Ta({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(tt, { children: [
      ...
      /* @__PURE__ */ a(sa, { children: /* @__PURE__ */ a(ca, { children: e.map((n) => /* @__PURE__ */ u(_e, { children: [
        /* @__PURE__ */ a(Ae, { className: "tw:border-0", children: /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a("span", { className: "tw:font-medium", children: n.fullName }),
          " (",
          /* @__PURE__ */ a("span", { children: n.displayName }),
          ")",
          /* @__PURE__ */ a(ar, { variant: "secondary", className: "tw:ml-2", children: n.bestLanguageName })
        ] }) }),
        o && r && /* @__PURE__ */ a(Ae, { className: "tw:border-0 tw:text-right", children: /* @__PURE__ */ a(j, { variant: "outline", onClick: () => o(n), children: r }) })
      ] }, n.dblEntryUid)) }) })
    ] });
}
function Lw(t, e) {
...
function Fp({
  ...
  const [s, c] = E(""), [d, l] = E([]), w = F(
    ...
    [t]
  ), k = p.length === 0 && g.length === 0 && h.length === 0, _ = we(n, "%resourcePicker_title%"), N = we(n, "%resourcePicker_search_placeholder%"), P = we(n, "%resourcePicker_language_filter_any%"), U = we(
    n,
    "%resourcePicker_section_already_selected%"
  ), I = we(n, "%resourcePicker_section_installed%"), O = we(
    n,
    "%resourcePicker_section_available_to_download%"
  ), y = we(n, "%resourcePicker_button_use%"), S = we(n, "%resourcePicker_no_results%"), R = we(n, "%resourcePicker_showing_count%"), D = F(() => {
  ...
  }, [d, C, P, n]), B = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(tt, { children: [
    ...
    B && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: ke(R, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      k && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: S }),
...
const Fw = "16rem", Bw = "3rem", zi = ut.createContext(void 0);
function wa() {
...
function jw({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), g = ut.useCallback(() => p((_) => !_), [p]), h = w ? "expanded" : "collapsed", v = Gt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Ww({
  ...
  const c = t ? dr.Root : "button", { state: d } = wa(), l = /* @__PURE__ */ a(
    c,
    {
  ...
  return n ? /* @__PURE__ */ u(Lt, { children: [
    /* @__PURE__ */ a(Ft, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      Bt,
      {
        side: "right",
    ...
    Uw,
    {
      ...
      children: /* @__PURE__ */ u(qw, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(Gw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Hw, { children: /* @__PURE__ */ a(
            Ww,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const $e = "scrBook", Jw = "scrRef", Ue = "source", Zw = "details", Qw = "Scripture Reference", tu = "Scripture Book", Si = "Type", eu = "Details";
function ru(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === $e ? Ne(n.start) : void 0;
      },
...
}, cn = (t) => `${au({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function eh({
  sources: t,
  ...
  const [l, w] = E([]), [p, g] = E([{ id: $e, desc: !1 }]), [h, f] = E({}), x = F(
    () => t.flatMap((y) => y.data.map((S) => ({
      ...S,
      source: y.source
    }))),
    [t]
  ...
  W(() => {
    if (c) {
      const y = C.getSelectedRowModel().rowsById, S = Object.keys(y);
      if (S.length === 1) {
        const R = x.find((D) => cn(D) === S[0]) || void 0;
        R && c(R);
      }
    }
  }, [h, x, c, C]);
  ...
  }, I = (y, S) => y.getIsGrouped() ? "" : m("banded-row", S % 2 === 0 ? "even" : "odd"), O = (y, S, R) => {
    if (!((y == null ? void 0 : y.length) === 0 || S.depth < R.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { position: "item-aligned", children: /* @__PURE__ */ a(tw, { children: N.map((y) => /* @__PURE__ */ a(ae, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(sa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(lo, { children: C.getHeaderGroups().map((y) => /* @__PURE__ */ a(_e, { children: y.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Qr, { colSpan: S.colSpan, className: "tw:sticky top-0", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(ca, { children: C.getRowModel().rows.map((y, S) => {
        const R = Gt();
        return /* @__PURE__ */ a(
          _e,
          {
            ...
            children: y.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== Ue || !r)))
                return /* @__PURE__ */ a(
                  Ae,
                  {
                    className: m(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      j,
                      {
                        ...
                        type: "button",
                        children: [
                          y.getIsExpanded() && /* @__PURE__ */ a(Ge, {}),
                          !y.getIsExpanded() && (R === "ltr" ? /* @__PURE__ */ a(qs, {}) : /* @__PURE__ */ a(Gs, {})),
                          " ",
                          xr(D.column.columnDef.cell, D.getContext()),
                          " (",
                          y.subRows.length,
                          ")"
                        ]
...
const Oi = (t, e, r) => uo(t, e).every((o) => r.includes(o));
function ou({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [x, v] = E(!1), [C, k] = E(""), _ = H(void 0), N = H(!1), P = F(
    () => Di(t),
    [t]
  ), U = F(() => {
    if (!C.trim()) {
    ...
    D.preventDefault(), I(B, D.shiftKey);
  }, S = () => {
    r(P.map((D) => D));
  }, R = () => {
    r([]);
          ...
          Ye,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: S, children: d }),
                /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: R, children: l })
              ] }),
              /* @__PURE__ */ u(We, { children: [
                /* @__PURE__ */ a(ea, { children: w }),
                Object.values(Z).map((D, B) => {
                  const V = U[D];
                  if (V.length !== 0)
                    return /* @__PURE__ */ u(Ga, { children: [
                      ...
                      B < Object.values(Z).length - 1 && /* @__PURE__ */ a(pn, {})
                    ] }, D);
                })
              ] })
            ]
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === za ? za : ln
      ).map((d) => /* @__PURE__ */ a(ar, { className: "tw:hover:bg-secondary", variant: "secondary", children: ye(d, n) }, d)),
...
function ah({
  ...
  const N = zt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), S = zt(s, "%webView_scope_selector_current_book%"), R = zt(s, "%webView_scope_selector_choose_books%"), D = zt(s, "%webView_scope_selector_scope%"), B = zt(s, "%webView_scope_selector_select_books%"), V = zt(s, "%webView_scope_selector_range%"), K = zt(s, "%webView_scope_selector_select_range%"), $ = zt(s, "%webView_scope_selector_range_start%"), Q = zt(s, "%webView_scope_selector_range_end%"), mt = zt(s, "%webView_scope_selector_ok%"), ct = zt(s, "%webView_scope_selector_cancel%"), Ht = zt(s, "%webView_scope_selector_navigate%"), bt = (M) => {
    if (!f) return;
  ...
  ], q = (M, J, Kt = !1) => /* @__PURE__ */ u(tt, { children: [
    M,
    J && !Kt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), rt = e ? Dt.filter((M) => e.includes(M.value)) : Dt, ot = f ?? ga, nt = w ?? ot, it = p ?? ot, jt = () => {
  }, vt = H(null), Yt = H(null), Wt = H(!1), T = H(null), $t = H(!1), [Ut, re] = E(void 0), Xt = H(!1), Mt = H(!1), De = H(null), Jt = L((M) => {
    if (M) {
      re("start"), Xt.current = !1;
      return;
    }
    re((J) => J === "start" ? void 0 : J), Xt.current && (Xt.current = !1, requestAnimationFrame(() => {
      var Kt;
      const J = (Kt = vt.current) == null ? void 0 : Kt.querySelector("button");
      J == null || J.click();
    }));
  }, []), Zt = L((M) => {
    if (M) {
    ...
    [r, n, f, i]
  ), at = rt.find((M) => M.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? hs(nt, it, {
  ...
  ), yt = rt.find((M) => M.value === "selectedBooks"), gt = rt.find((M) => M.value === "range"), [kt, z] = E(!1), [wt, pt] = E(void 0), [_t, Oe] = E(void 0), [Fe, pr] = E(void 0), [Be, hr] = E(void 0), [Je, zr] = E([]), Sr = l === "dropdown" && wt === "selectedBooks", Dr = /* @__PURE__ */ a(
    iu,
    {
      availableBookInfo: o,
      selectedBookIds: Sr ? Je : n,
      onChangeSelectedBookIds: Sr ? zr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), b = Ut === "end", G = Ut === "start", X = "tw:text-muted-foreground", Et = l === "dropdown" && wt === "range", se = Et ? pr : A, Ze = Et ? hr : h ? Y : jt, Ot = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-start", className: m(b && X), children: $ }),
      /* @__PURE__ */ a(
        ma,
        {
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-end", className: m(G && X), children: Q }),
      /* @__PURE__ */ a(
        ma,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: C,
          disableReferencesUpTo: Et ? Fe ?? nt : nt,
          onOpenChange: Zt,
          onCloseAutoFocus: (M) => {
            var J;
            Mt.current && (Mt.current = !1, M.preventDefault(), (J = De.current) == null || J.focus());
          },
          className: m(G && X),
          modal: !0,
          align: "start"
  ...
  const [Rt, ce] = E(null), [le, Li] = E(null), [Or, Fi] = E(null), Bi = 200, [ji, Ui] = E(!1);
  W(() => {
    if (!Or || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([J]) => {
      Ui(J.contentRect.width < Bi);
    });
    return M.observe(Or), () => M.disconnect();
  }, [Or]);
  const po = L(
    (M) => {
      Oe(M), pr(nt), hr(it), zr(n), z(!1), pt(M);
    },
    [nt, it, n]
  ), ho = L(() => {
    _t !== void 0 && (_t === "range" ? (Fe && (g == null || g(Fe)), Be && (h == null || h(Be))) : _t === "selectedBooks" && i(Je), st(_t), pt(void 0), Oe(void 0));
  }, [
    _t,
    Fe,
    Be,
    ...
    M || (pt(void 0), Oe(void 0));
  }, []), go = L((M) => {
    var J;
    M.preventDefault(), (J = ft.current) == null || J.focus();
  }, []), fo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(qe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Ct, { children: D }),
      l === "dropdown" ? /* @__PURE__ */ u(pe, { open: kt, onOpenChange: z, children: [
        /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ u(
          j,
          {
            ref: ft,
        ...
        /* @__PURE__ */ a(
          ge,
          {
            ...
            children: /* @__PURE__ */ u(ua, { container: Or, children: [
              xt.map(({ value: M, label: J, dropdownLabel: Kt, scrRefSuffix: fr, id: Ki }) => /* @__PURE__ */ u(
                Me,
                {
                  ref: Tt(M),
                  ...
                  children: [
                    t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(qe, { className: "tw:h-4 tw:w-4" }) }),
                    q(Kt ?? J, fr, ji)
                  ]
                },
                Ki
              ...
              x && /* @__PURE__ */ u(tt, { children: [
                /* @__PURE__ */ a(Ke, {}),
                /* @__PURE__ */ a(lr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Ht }),
                /* @__PURE__ */ a(
                  Me,
                  {
                    ref: T,
                    ...
                    onSelect: (M) => {
                      var J, Kt;
                      if (M.preventDefault(), Wt.current) {
                        Wt.current = !1;
                        return;
                      }
                      $t.current || (Kt = (J = Yt.current) == null ? void 0 : J.querySelector("button")) == null || Kt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (M) => {
                          ...
                          J != null && J.closest("button") && (Wt.current = !0, requestAnimationFrame(() => {
                            Wt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ma,
                          {
                            ...
                            onCloseAutoFocus: (M) => {
                              var J;
                              M.preventDefault(), (J = T.current) == null || J.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(tt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ne(f ?? ga, "id") }),
                              /* @__PURE__ */ a(Ge, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Yn,
        {
          ...
          children: rt.map(({ value: M, label: J, scrRefSuffix: Kt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(La, { className: "tw:me-2", value: M, id: fr }),
            /* @__PURE__ */ a(Ct, { htmlFor: fr, children: q(J, Kt) })
          ] }, fr))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { children: B }),
      Dr
    ] }),
    l === "radio" && t === "range" && Ot,
    l === "dropdown" && yt && /* @__PURE__ */ a(Ia, { open: wt === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      Va,
      {
        ref: Li,
        onCloseAutoFocus: go,
        onEscapeKeyDown: (M) => {
          le != null && le.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(ua, { container: le, children: [
          /* @__PURE__ */ a(Gr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Hr, { children: R }) }),
          Dr,
          /* @__PURE__ */ u(Mo, { children: [
            /* @__PURE__ */ a(j, { variant: "outline", onClick: () => $r(!1), children: ct }),
            /* @__PURE__ */ a(j, { onClick: ho, children: mt })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(Ia, { open: wt === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      Va,
      {
        ref: ce,
        onCloseAutoFocus: go,
        onEscapeKeyDown: (M) => {
          Rt != null && Rt.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(ua, { container: Rt, children: [
          ...
          /* @__PURE__ */ u(Mo, { children: [
            /* @__PURE__ */ a(j, { variant: "outline", onClick: () => $r(!1), children: ct }),
            /* @__PURE__ */ a(j, { ref: De, onClick: ho, children: mt })
          ] })
        ] })
      }
    ) })
...
function oh({
  ...
  return /* @__PURE__ */ u(
    nr,
    {
      ...
      children: [
        /* @__PURE__ */ a(sr, { size: n, className: m("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          ir,
          {
        ...
        /* @__PURE__ */ a(
          cr,
          {
            ...
            style: { zIndex: ra },
            children: t.map((l) => /* @__PURE__ */ a(ae, { value: `${l}`, children: c[vo(l)] }, `${l}`))
          }
        )
      ]
    }
...
const Mi = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(Lt, { children: [
  /* @__PURE__ */ a(Ft, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(as, { children: /* @__PURE__ */ a(os, { children: Mi(
      t,
      e,
      $i(t, c.id),
      o
...
function Ka({
  ...
  return /* @__PURE__ */ u(pe, { variant: i, children: [
    /* @__PURE__ */ a(he, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(j, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Hs, {}) }) }),
    /* @__PURE__ */ a(ge, { align: "start", style: { zIndex: ra }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Ga, { children: [
      /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(Vt, { children: Mi(e.groups, e.items, d, t) }) }),
...
Ai.displayName = ie.List.displayName;
...
Pi.displayName = ie.List.displayName;
...
Ii.displayName = ie.Content.displayName;
function dh({
  tabList: t,
  searchValue: e,
  onSearch: r,
...
const vr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        gu,
        {
          onClick: () => {
            o(l);
      ...
      l.tooltip && /* @__PURE__ */ a(Bt, { children: l.tooltip })
  ...
  if (pl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(du, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(wu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ra },
          children: /* @__PURE__ */ a(Vt, { children: Vi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
      ...
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: ra },
              children: Object.keys(t).map((f) => /* @__PURE__ */ a(ae, { value: f, children: h(f, e) }, f))
            }
          )
        ]
      }
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(pe, { children: [
              /* @__PURE__ */ a(he, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
              /* @__PURE__ */ a(ge, { align: "end", children: l })
            ] }) }),
            e && l && /* @__PURE__ */ u(pe, { children: [
              /* @__PURE__ */ a(he, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
              /* @__PURE__ */ a(ge, { align: "end", children: l })
            ] })
          ] }),
