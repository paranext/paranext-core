...
import { c as v, g as Ae, a as Ur, C as tr, L as Hn, t as Ts, u as rn, T as zt, b as _t, d as Nt, e as Ct, f as Gn, A as ka, r as re, D as Be, h as Te, i as Fe, j as cr, k as qe, B as et, x as Ss, l as Rs, m as Ds, I as Os, n as To, o as Xe, p as De, q as Ms, s as qn, P as lr, v as Rr, w as dr, y as wr, z as Ia, E as za, F as So, G as ur, H as Pa, J as It, R as Ro, K as _a, M as so, N as co, O as lo, Q as wo, S as Wn, U as ha, V as Do, W as qr, X as Wr, Y as xr, Z as Is, _ as ir, $ as Ze, a0 as je, a1 as We, a2 as yr, a3 as Oo, a4 as Mo, a5 as Na, a6 as Io, a7 as Yn, a8 as zs, a9 as Ps, aa as As, ab as uo, ac as Zn, ad as Aa, ae as $s, af as Xn, ag as Vs, ah as Ls, ai as Bs, aj as an, ak as Fs, al as js, am as Us, an as Jn, ao as Qn, ap as zo, aq as Ks, ar as ti, as as Ha, at as on, au as Ga, av as Hs, aw as Gs, ax as qs, ay as Ws, az as Ys, aA as Zs, aB as Xs, aC as Js, aD as Qs, aE as Po, aF as Ao, aG as tc, aH as ec } from "./resizable-BFpDZJ3Z.js";
import { aI as Rf, aJ as Df, aK as Of, aL as Mf, aM as If, aN as zf, aO as Pf, aP as Af, aQ as $f, aR as Vf, aS as Lf, aT as Bf, aU as Ff, aV as jf, aW as Uf, aX as Kf, aY as Hf, aZ as Gf, a_ as qf, a$ as Wf, b0 as Yf, b1 as Zf, b2 as Xf, b3 as Jf, b4 as Qf, b5 as tm, b6 as em, b7 as rm, b8 as am, b9 as om, ba as nm, bb as im, bc as sm, bd as cm, be as lm, bf as dm, bg as wm, bh as um, bi as pm, bj as hm } from "./resizable-BFpDZJ3Z.js";
...
import { HeadingNode as ql, QuoteNode as Wl, registerRichText as Yl } from "@lexical/rich-text";
...
function xd({
  ...
  return /* @__PURE__ */ u(Be, { open: T, onOpenChange: S, modal: !1, children: [
    /* @__PURE__ */ a(zt, { children: k ? /* @__PURE__ */ u(_t, { open: y, onOpenChange: M, children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: O }) }),
...
function Za({
  ...
  const { otLong: ke, ntLong: _e, dcLong: rr, extraLong: ar } = {
    ...
    () => _d(Z),
    [Z]
  ), ct = A(() => !w || !B || !B.chapterNum || !it ? !1 : w(B.book, B.chapterNum) > 0, [w, B, it]), Gt = x === "books" && !mt && !Z.trim() && Et.size > 0, Pr = V(
    (m) => p ? bn(m, p) : !1,
    [p]
  ), Pe = V(
    (m) => (G) => p ? Nd(m, G, p) : !1,
    ...
    (m) => {
      ...
      if (!(!!G && !!((Qo = At.current) != null && Qo.contains(G))) && (G != null && G.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
      ...
      const { isLetter: Bt, isDigit: qt } = vn(m.key);
      ...
      if (x === "books" && !Tt && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
        const Lt = G === St.current ? St.current : void 0, ue = (Lt == null ? void 0 : Lt.selectionStart) ?? 0, Yt = (Lt == null ? void 0 : Lt.selectionEnd) ?? 0, me = S === "rtl" ? m.key === "ArrowRight" : m.key === "ArrowLeft";
    ...
    const { isLetter: G, isDigit: st } = vn(m.key);
    (G || st) && (m.preventDefault(), ot((Dt) => Dt + m.key), (qt = St.current) == null || qt.focus(), H(!1));
  }, []);
  Ut(() => {
    const m = setTimeout(() => {
      if (I && x === "books" && $t.current && ie.current) {
        const G = $t.current, st = ie.current, Bt = st.offsetTop, qt = G.clientHeight, Dt = st.clientHeight, ee = Bt - qt / 2 + Dt / 2;
        G.scrollTo({
          top: Math.max(0, ee),
          behavior: "smooth"
        }), Y(bo(t.book));
  ...
  return Ut(() => {
    ...
    const { max: m, initial: G, parse: st, buildValue: Bt } = fe, qt = (Dt) => {
      const ee = st(Dt);
      return ee !== void 0 && ee >= 1 && ee <= m && Dt === Bt(ee) ? ee : void 0;
    };
    if (Vt.current !== at) {
      Vt.current = at;
      const Dt = Bt(Math.min(Math.max(G, 1), m));
      we.current = Dt, Y(Dt);
      return;
    }
    if (qt(D) !== void 0) {
    ...
    Y(
      qt(we.current) !== void 0 ? we.current : Bt(Math.min(Math.max(G, 1), m))
    );
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        onPointerDownOutside: (m) => {
          const { target: G } = m;
          I && Ht.current && G instanceof Node && Ht.current.contains(G) && (Wt.current = !0, pt(!1));
        },
        onCloseAutoFocus: C,
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(za, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: yt.map(
                      ({ onClick: m, disabled: G, title: st, icon: Bt, group: qt }, Dt) => {
                        const ee = /* @__PURE__ */ a(
                          et,
                          {
                            variant: "ghost",
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(Qr, { children: [
                            Dt > 0 && qt !== yt[Dt - 1].group && /* @__PURE__ */ a(So, {}),
                            G ? (
...
const qw = "verseText", Rh = Object.freeze([
        ...
        /* @__PURE__ */ u(
          qe,
          {
            onClick: (x) => {
              ...
              C(rt ? Gw(t.contents) : Ww), i == null || i(!0);
            },
            children: [
...
function Su({
  ...
  return /* @__PURE__ */ u(Be, { open: f, onOpenChange: E, children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Tu(t, o, e) }) }) }),
...
function Ou({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Ru(t, r) }) }) }),
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: Du(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(
      Fe,
      {
...
function Yh({
  ...
  tt(() => {
    ...
    const _ = () => {
      ...
      q && !q.isCollapsed || Ht() || ((Q = h.current) == null || Q.selectNote(0), (K = h.current) == null || K.focus());
    };
...
const Ju = "16rem", Qu = "3rem", gs = Jt.createContext(void 0);
function Fa() {
  const t = Jt.useContext(gs);
  if (!t)
...
function tp({
  ...
  return /* @__PURE__ */ a(gs.Provider, { value: C, children: /* @__PURE__ */ a(
    "div",
    {
...
const He = "scrBook", lp = "scrRef", nr = "source", dp = "details", wp = "Scripture Reference", up = "Scripture Book", fs = "Type", pp = "Details";
function hp(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: nr,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? fs : void 0,
...
function kg({
  ...
  ), _ = lt.find((F) => F.value === "selectedBooks"), U = lt.find((F) => F.value === "range"), [q, $] = N(!1), [Q, K] = N(void 0), [nt, yt] = N(void 0), [Rt, dt] = N(void 0), [kt, pt] = N(void 0), [xt, Ue] = N([]), ke = p === "dropdown" && Q === "selectedBooks", _e = /* @__PURE__ */ a(
    bp,
    {
      availableBookInfo: o,
...
const ms = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => hs(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => {
  if ("command" in c)
  ...
  const d = /* @__PURE__ */ a(Ws, { children: c.label });
...
function Eo({
  ...
  const l = Ea(), w = Xu(e), p = s && w.length > 1;
  Mi();
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        style: { zIndex: je },
        onCloseAutoFocus: () => {
          Gn() === "pointer" && Js(h.current ?? void 0);
        },
...
function $p({
  ...
  if (dd(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Ep, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ps(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(Tp, { children: [
...
export {
  ...
  hs as isGroupUnderColumnOrSubMenu,
  Do as isMacOs,
  pm as isWindows,
  Eu as leftEdgeRect,
