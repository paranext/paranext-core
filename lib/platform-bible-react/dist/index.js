...
import { includes as gr, Section as W, getChaptersForBook as zi, formatScrRef as Re, getSectionForBook as Qe, formatRelativeDate as Ti, formatReplacementString as ie, sanitizeHtml as Si, NumberFormat as Ri, formatBytes as Di, getCurrentLocale as $i, usfmMarkers as xr, getFormatCallerFunction as Mi, deepEqual as Oi, isString as Ya, compareScrRefs as aa, scrRefToBBBCCCVVV as Fr, getLocalizeKeyForScrollGroupId as Z } from "platform-bible-utils";
...
function wa(t, e, r) {
  return `${t} ${De[t]}${e ? ` ${Ra(t, e)} ${Ve(t, e)}` : ""}${r ? ` ${r}` : ""}`;
}
function Fl({
  recentSearches: t,
  ...
  const o = Bl.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && c) {
          const p = ((m) => Object.keys(De).find(
            (b) => De[b].toLowerCase() === m.toLowerCase()
          ))(l);
...
function Lu({
  ...
  const d = lt(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, k] = T("books"), [x, N] = T(void 0), [_, M] = T(!1), V = q(void 0), A = q(void 0), C = q(void 0), z = q(void 0), E = q({}), O = j(
    ...
    [W.OT]: R.filter((H) => ct.isBookOT(H)),
    [W.NT]: R.filter((H) => ct.isBookNT(H)),
    [W.DC]: R.filter((H) => ct.isBookDC(H)),
    [W.Extra]: R.filter((H) => ct.extraBooks().includes(H))
  }), [R]), P = I(() => Object.values(F).flat(), [F]), G = I(() => {
    if (!m.trim()) return F;
    const $ = {
      [W.OT]: [],
      [W.NT]: [],
      ...
      if ((v === "chapters" || v === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes($.key)) {
        ...
        switch ($.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            D = ot === 0 ? St : Math.max(1, ot - B);
            break;
          case "ArrowDown":
            D = ot === 0 ? 1 : Math.min(St, ot + B);
            break;
          default:
            return;
        }
        D !== ot && ($.preventDefault(), $.stopPropagation(), p(wa(wt, n, D)), setTimeout(() => {
  ...
  return Mt(() => {
    const $ = setTimeout(() => {
      if (w && v === "books" && C.current && z.current) {
        const H = C.current, Q = z.current, wt = Q.offsetTop, ot = H.clientHeight, St = Q.clientHeight, D = wt - ot / 2 + St / 2;
        H.scrollTo({
          top: Math.max(0, D),
          behavior: "smooth"
        }), p(wa(t.book));
...
function pa({
  ...
  const [N, _] = T(!1), M = d ?? c, V = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
    const E = c(C), O = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, R = `${z ?? ""}${E}${O ?? ""}`;
    return /* @__PURE__ */ u(
      we,
      {
        value: E,
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((V || A) && _ !== null && M !== null) {
        const C = function(z, E, O, R, F, P, G) {
          const y = (z._window ? z._window.document : document).createRange();
          return y.setStart(...co(E, O, R)), y.setEnd(...co(F, P, G)), y;
        }(t, h, m, _, p, k, M);
        c(), c = cc(t, C, e);
      }
...
function hc(t, e, r) {
  ...
  return Rs(o) && Er(283), o.insert(t.isInline() ? We().append(t) : t), eo(Wo(t.getLatest(), "next"), e.direction);
}
function fc(t) {
  const e = zt();
  if (!Xt(e)) return !1;
...
const Rc = /* @__PURE__ */ new Set(), mo = Lt({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const l = xc(() => (i.value || Rc).has(s)), { watchedNodeKeys: c } = n.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), n.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), Dc = Ls("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
...
Lt({ dependencies: [fa, mo], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return de(t.registerCommand(Dc, (s) => {
    const l = zt();
    if (!Xt(l)) return !1;
...
function vo(t) {
  return t.getEditorState().read(Dn(t.isComposing()));
}
...
function Hc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: k = !0, style: x, tabIndex: N, "data-testid": _, ...M }, V) {
  const [A, C] = T(t.isEditable()), z = j((O) => {
    ...
    return (R) => {
      for (const F of O) typeof F == "function" ? F(R) : F != null && (F.current = R);
    };
  }(V, z), [z, V]);
...
function td() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Dl, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ol, { children: [
...
function Td({
  ...
  const [C, z] = T(_o), [E, O] = T(), [R, F] = T(), P = o, [G, y] = T(!1), [Y, ft] = T(!1), [nt, re] = T(!1), [ae, Tt] = T(!1), [U, it] = T(!1), [at, dt] = T(_), [Et, he] = T(!1), xt = q(void 0), [fe, oe] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
  ...
  }, [i, r]), D = I(() => Vt.slice(1), [Vt]), B = I(() => D.length ?? 0, [D.length]), rt = I(() => B > 0, [B]), st = I(() => G || B <= 2 ? D : D.slice(-2), [D, B, G]), ut = I(() => G || B <= 2 ? 0 : B - 2, [B, G]), kt = I(
  ...
  const mt = j(
    ...
    async (S) => {
      const gt = $t(C) ? Rr(C) : void 0, ht = S.status ? S.assignedUser : E ?? S.assignedUser, jt = await g({
        ...S,
        contents: gt,
        assignedUser: ht
      });
            ...
            o && /* @__PURE__ */ u(J, { children: [
              ...
              v !== !1 && (!Y || $t(C)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (S) => {
                    ja(S) && (S.preventDefault(), S.stopPropagation(), ($t(C) || E !== void 0 && E !== R) && mt());
                  },
                  onKeyDown: (S) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && ($t(C) || E !== R) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ie(
...
function Zu({
  ...
  const C = r.filter(
    ...
    [k, b]
  ), { listboxRef: R, activeId: F, handleKeyDown: P } = fd({
    options: z,
    onOptionSelect: E
  }), G = j(
    (y) => {
...
function Ld({
  ...
  return c ? M = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(Ht, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Wt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((V = N.getRowModel().rows) == null ? void 0 : V.length) > 0 ? M = N.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(dr, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ba, { stickyHeader: i, children: N.getHeaderGroups().map((A) => /* @__PURE__ */ a(Ht, { children: A.headers.map((C) => /* @__PURE__ */ a(Dr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : tr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
...
function Hn({
  ...
  const [k, x] = T(!1), N = j(
    (E) => {
      var R;
      const O = (R = t.find((F) => F.label === E)) == null ? void 0 : R.value;
      O && r(
    ...
    if (!h) return t;
    const E = t.filter((R) => R.starred).sort((R, F) => R.label.localeCompare(F.label)), O = t.filter((R) => !R.starred).sort((R, F) => {
      const P = e.includes(R.value), G = e.includes(F.value);
      return P && !G ? -1 : !P && G ? 1 : R.label.localeCompare(F.label);
    });
    return [...E, ...O];
  }, [t, e, h]), V = () => {
    r(t.map((E) => E.value));
...
function dp({
  ...
  const [m, b] = T("generated"), [v, k] = T("generated"), [x, N] = T("*"), [_, M] = T("*"), [V, A] = T("f"), [C, z] = T(!1), [E, O] = T(!0), [R, F] = T(!1), P = q(!1), G = q(""), [y, Y] = T(!1), [ft, nt] = T(), [re, ae] = T(), [Tt, U] = T(), [it, at] = T(), dt = q(null), Et = I(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  K(() => {
    ...
    if (B && hr("note", B)) {
      ...
      let kt = "custom";
      ut === la ? kt = "generated" : ut === ca ? kt = "hidden" : ut && (N(ut), M(ut)), b(kt), k(kt), A(((st = B.insert.note) == null ? void 0 : st.style) ?? "f"), D = setTimeout(() => {
        var Rt;
  ...
  const xt = j(
    (D, B, rt = !1) => {
      ...
      if (st && hr("note", st)) {
        if (st.insert.note) {
          let mt;
          D === "custom" ? mt = B : D === "generated" ? mt = la : mt = ca, st.insert.note.caller = mt;
        }
        r == null || r([st]), rt && d && i && ((Rt = d.current) == null || Rt.replaceEmbedUpdate(i, [st]));
      }
    },
    [i, r, d]
  ), fe = j(() => {
  ...
  const Vt = () => {
    var B;
    const D = (B = g.current) == null ? void 0 : B.getElementsByClassName("editor-input")[0];
    ...
    if (B && hr("note", B)) {
      ...
      V !== "x" && D === "x" ? mt == null || mt.forEach((Dt) => ew(Dt)) : V === "x" && D !== "x" && (mt == null || mt.forEach((Dt) => rw(Dt))), (Rt = w.current) == null || Rt.applyUpdate([B, { delete: 1 }]);
    }
  }, Q = (D) => {
    at(D.contextMarker), F(D.canRedo);
  }, wt = j(
    (D) => {
      var rt, st, ut, kt, Rt;
      const B = (st = (rt = w.current) == null ? void 0 : rt.getNoteOps(0)) == null ? void 0 : st.at(0);
      if (B && hr("note", B)) {
        ...
        const mt = (ut = B.insert.note) == null ? void 0 : ut.style, Dt = (Rt = (kt = B.insert.note) == null ? void 0 : kt.contents) == null ? void 0 : Rt.ops;
        if (mt || z(!1), z(
          mt === "x" ? !!(Dt != null && Dt.every((S) => {
            var ht, jt;
    ...
    if (h.current && he.length && D && D.rangeCount > 0) {
      const B = D.getRangeAt(0).getBoundingClientRect(), rt = h.current.getBoundingClientRect();
  ...
  K(() => {
    ...
    var D;
    y && ((D = dt.current) == null || D.focus());
  }, [y]), K(() => {
    var rt;
    const D = ((rt = g.current) == null ? void 0 : rt.querySelector(".editor-input")) ?? void 0, B = (st) => {
      !y && D && document.activeElement === D && st.key === l ? (st.preventDefault(), ot()) : y && st.key === "Escape" && (st.preventDefault(), Y(!1));
    };
  ...
  return /* @__PURE__ */ u(dr, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(wr, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      Ht,
      {
        ...
        children: [
          /* @__PURE__ */ a(Wt, { children: Re(l.reference, "English") }),
...
function xp({
  ...
  const p = Ut(r, "%webView_inventory_all%"), m = Ut(r, "%webView_inventory_approved%"), b = Ut(r, "%webView_inventory_unapproved%"), v = Ut(r, "%webView_inventory_unknown%"), k = Ut(r, "%webView_inventory_scope_currentBook%"), x = Ut(r, "%webView_inventory_scope_chapter%"), N = Ut(r, "%webView_inventory_scope_verse%"), _ = Ut(r, "%webView_inventory_filter_text%"), M = Ut(
    r,
    "%webView_inventory_show_additional_items%"
  ), V = Ut(r, "%webView_inventory_no_results%"), [A, C] = T(!1), [z, E] = T("all"), [O, R] = T(""), [F, P] = T([]), G = I(() => {
    const U = t ?? [];
...
function Np({
  ...
  const [s, l] = T(""), [c, d] = T([]), w = I(
    ...
    n,
    "%resourcePicker_section_available_to_download%"
  ), z = Kt(n, "%resourcePicker_button_use%"), E = Kt(n, "%resourcePicker_no_results%"), O = Kt(n, "%resourcePicker_showing_count%"), R = I(() => {
...
const me = "scrBook", zw = "scrRef", Se = "source", Tw = "details", Sw = "Scripture Reference", Rw = "Scripture Book", Jn = "Type", Dw = "Details";
function $w(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ct.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === me ? Re(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Tw,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Dw,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
function Vp({
  ...
  K(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const O = b.find((R) => Oo(R) === E[0]) || void 0;
        O && l(O);
      }
    }
  }, [p, b, l, k]);
  const x = n ?? Rw, N = i ?? Jn, _ = [
  ...
  return /* @__PURE__ */ u("div", { id: c, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(Rd, { children: _.map((z) => /* @__PURE__ */ a(Ft, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(dr, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ba, { children: k.getHeaderGroups().map((z) => /* @__PURE__ */ a(Ht, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
        ...
        /* @__PURE__ */ a(Dr, { colSpan: E.colSpan, className: "tw:sticky top-0", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
        ...
        return /* @__PURE__ */ a(
          Ht,
          {
            ...
            children: z.getVisibleCells().map((R) => {
              if (!(R.getIsPlaceholder() || R.column.columnDef.enableGrouping && !R.getIsGrouped() && (R.column.columnDef.id !== Se || !r)))
                return /* @__PURE__ */ a(
                  Wt,
                  {
                    className: f(
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ u(
                      L,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          tr(R.column.columnDef.cell, R.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function Ow({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: g, ntLong: h, dcLong: p, extraLong: m } = {
    ...
    (R, F = !1) => {
      if (!F || !N.current) {
        r(
          e.includes(R) ? e.filter((nt) => nt !== R) : [...e, R]
        ), N.current = R;
        return;
      }
      const P = M.findIndex((nt) => nt === N.current), G = M.findIndex((nt) => nt === R);
      if (P === -1 || G === -1) return;
      const [y, Y] = [
        Math.min(P, G),
        Math.max(P, G)
      ...
      r(
        e.includes(R) ? e.filter((nt) => !ft.includes(nt)) : [.../* @__PURE__ */ new Set([...e, ...ft])]
      );
    },
    [e, r, M]
  ), C = (R) => {
    A(R, _.current), _.current = !1;
  }, z = (R, F) => {
    R.preventDefault(), A(F, R.shiftKey);
  }, E = () => {
    r(M.map((R) => R));
  }, O = () => {
    r([]);
      ...
      children: [
        ...
        /* @__PURE__ */ a(pe, { className: "tw:w-full tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Ne,
          {
            shouldFilter: !1,
            onKeyDown: (R) => {
              R.key === "Enter" && (_.current = R.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                lr,
...
export {
  ...
  yp as PROJECT_PICKER_STRING_KEYS,
  ue as Popover,
  jl as PopoverAnchor,
