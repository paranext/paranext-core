...
D(dt, "Original", new dt(gt.Original)), D(dt, "Septuagint", new dt(gt.Septuagint)), D(dt, "Vulgate", new dt(gt.Vulgate)), D(dt, "English", new dt(gt.English)), D(dt, "RussianProtestant", new dt(gt.RussianProtestant)), D(dt, "RussianOrthodox", new dt(gt.RussianOrthodox));
let It = dt;
function In(t, e) {
  const n = e[0];
...
const it = class O {
    ...
    if (D(this, "firstChapter"), D(this, "lastChapter"), D(this, "lastVerse"), D(this, "hasSegmentsDefined"), D(this, "text"), D(this, "BBBCCCVVVS"), D(this, "longHashCode"), D(this, "versification"), D(this, "rtlMark", "‏"), D(this, "_bookNum", 0), D(this, "_chapterNum", 0), D(this, "_verseNum", 0), D(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof O) {
          ...
          if (e == null) return;
          const s = e instanceof It ? e : O.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new It(i)), n ? new O(n, a.toString(), w, u) : new O();
  }
  /**
  ...
  parse(e) {
    ...
    if (a.length !== 2 || j.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !O.isVerseParseable(a[1]))
      throw new re("Invalid reference : " + e);
...
const ar = tn(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? qt : "button", { className: c(io({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
function An({
  ...
  if (t)
    return /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: bt(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Bt,
      {
        value: `${t} ${At[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Ii({
  ...
  const d = at(), [p, f] = A(!1), [h, g] = A(""), [b, y] = A(""), [N, V] = A("books"), [x, _] = A(void 0), [X, z] = A(!1), P = nt(void 0), F = nt(void 0), H = nt(void 0), R = nt(void 0), C = nt({}), B = G(
    (v) => {
      e(v), w && w(v);
    },
    [e, w]
  ), E = J(() => a ? a() : rr, [a]), Z = J(() => ({
    [I.OT]: E.filter(($) => j.isBookOT($)),
    [I.NT]: E.filter(($) => j.isBookNT($)),
    [I.DC]: E.filter(($) => j.isBookDC($)),
    [I.Extra]: E.filter(($) => j.extraBooks().includes($))
  }), [E]), S = J(() => Object.values(Z).flat(), [Z]), q = J(() => {
    if (!b.trim()) return Z;
    const v = {
      [I.OT]: [],
      [I.NT]: [],
    ...
    (v) => {
      ...
      if ((N === "chapters" || N === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ot = N === "chapters" ? x : k == null ? void 0 : k.book;
        if (!ot) return;
        const st = (() => {
          if (!h) return 1;
          const ne = h.match(/(\d+)$/);
    ...
    const { isLetter: $, isDigit: et } = On(v.key);
    ($ || et) && (v.preventDefault(), y((ot) => ot + v.key), F.current.focus(), z(!1));
  }, []);
  return Tn(() => {
    const v = setTimeout(() => {
      if (p && N === "books" && H.current && R.current) {
        const $ = H.current, et = R.current, ot = et.offsetTop, st = $.clientHeight, Dt = et.clientHeight, Nt = ot - st / 2 + Dt / 2;
        $.scrollTo({
          top: Math.max(0, Nt),
          behavior: "smooth"
        }), g(Ue(t.book));
  ...
  }, [N, x, k, t.book, t.chapterNum]), /* @__PURE__ */ l(te, { open: p, onOpenChange: mt, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ r(
      M,
      {
      ...
      Wt,
      {
        ...
        children: [
          N === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: T.map(({ onClick: v, disabled: $, title: et, icon: ot }) => /* @__PURE__ */ r(
              M,
              {
                variant: "ghost",
                size: "sm",
            ...
            x && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ht(x, o) })
          ] }),
          !X && /* @__PURE__ */ l(Zt, { ref: H, children: [
            N === "books" && /* @__PURE__ */ l(kt, { children: [
              ...
              k && bt(k.book) > 1 && /* @__PURE__ */ l(kt, { children: [
...
), rt = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Gn.Root, { ref: n, className: c("pr-twp", uo(), t), ...e }));
...
function Ke({
  ...
  const [N, V] = A(!1);
  return /* @__PURE__ */ l(te, { open: N, onOpenChange: V, ...y, children: [
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ l(Wt, { children: [
          ...
          /* @__PURE__ */ r(Zt, { children: e.map((x) => /* @__PURE__ */ l(
            Bt,
            {
              value: w(x),
              onSelect: () => {
...
function Pi({
  ...
  const p = Pe(d, "%webView_bookSelector_currentBook%"), f = Pe(d, "%webView_bookSelector_choose%"), h = Pe(d, "%webView_bookSelector_chooseBooks%"), [g, b] = A(
    "current book"
    /* CURRENT_BOOK */
  ), y = (N) => {
    b(N), t(N);
    ...
    cn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(rt, { className: "tw-flex tw-items-center", children: a.map((N) => j.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ r(
            M,
            {
...
const Ut = W.Root, No = W.Group, Kt = W.Value, ko = Et(
  ...
  return /* @__PURE__ */ l(
    W.Trigger,
    {
      className: c(ko({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
dr.displayName = W.ScrollUpButton.displayName;
...
const Ee = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: c("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? de(t.current) : [], s = o.indexOf(document.activeElement), i = a.key === "ArrowRight" ? s + 1 : s - 1;
...
function Io({
  ...
  var P;
  const [p, f] = A([]), [h, g] = A([]), [b, y] = A({}), [N, V] = A({}), x = J(() => e ?? [], [e]), _ = Xn({
    data: x,
    columns: t,
    getCoreRowModel: Hn(),
  ...
  }), X = _.getVisibleFlatColumns();
  let z;
  return u ? z = Array.from({ length: 10 }).map((R, C) => `skeleton-row-${C}`).map((R) => /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(Pt, { colSpan: X.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(qe, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, R)) : ((P = _.getRowModel().rows) == null ? void 0 : P.length) > 0 ? z = _.getRowModel().rows.map((F) => /* @__PURE__ */ r(
    Ct,
    {
      onClick: () => i(F, _),
      "data-state": F.getIsSelected() && "selected",
      children: F.getVisibleCells().map((H) => /* @__PURE__ */ r(Pt, { children: ie(H.column.columnDef.cell, H.getContext()) }, H.id))
    },
    F.id
    ...
    o && /* @__PURE__ */ r(yo, { table: _ }),
    /* @__PURE__ */ l(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Te, { stickyHeader: s, children: _.getHeaderGroups().map((F) => /* @__PURE__ */ r(Ct, { children: F.headers.map((H) => /* @__PURE__ */ r(ce, { children: H.isPlaceholder ? void 0 : ie(H.column.columnDef.header, H.getContext()) }, H.id)) }, F.id)) }),
...
function zi({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: c("pr-twp tw-prose", n), children: /* @__PURE__ */ r(La, { options: o, children: e }) });
}
...
function ji({ id: t, label: e, groups: n }) {
  const [a, o] = A(
    ...
    i((h) => (h[d] = p, { ...h }));
    const f = n[d].items.find((h) => h.id === p);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(_e, { children: [
    ...
    /* @__PURE__ */ r(me, { children: n.map((d, p) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(hn, { children: d.label }),
      /* @__PURE__ */ r(or, { children: d.itemType === 0 ? /* @__PURE__ */ r(kt, { children: d.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        mn,
        {
          checked: a[p][h],
        ...
        vo,
        {
          ...
          children: d.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(lr, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(Re, {})
    ] }, d.label)) })
...
function Bi({
  ...
  }).format(Object.values(n).reduce((p, f) => p + f, 0)), d = () => {
...
function zo({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const u = new Date(w), d = new Date(o.getTime() - u.getTime()), p = d.getUTCFullYear() - 1970, f = d.getUTCMonth(), h = d.getUTCDate() - 1;
    let g = "";
...
const $o = Et(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: c("pr-twp", $o({ variant: e }), t), ...n })
);
...
function Lo({
  ...
  const [V, x] = A(!1), _ = G(
    (C) => {
      var E;
      const B = (E = t.find((Z) => Z.label === C)) == null ? void 0 : E.value;
      B && n(
    ...
    if (!h) return t;
    const C = t.filter((E) => E.starred).sort((E, Z) => E.label.localeCompare(Z.label)), B = t.filter((E) => !E.starred).sort((E, Z) => {
      const S = e.includes(E.value), q = e.includes(Z.value);
      return S && !q ? -1 : !S && q ? 1 : E.label.localeCompare(Z.label);
    });
    return [...C, ...B];
  }, [t, e, h]), P = () => {
    n(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ r("div", { id: N, className: b, children: /* @__PURE__ */ l(te, { open: H, onOpenChange: p ?? x, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ l(
      M,
      {
        variant: y,
        ...
        children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-font-normal", children: X() })
          ] }),
        ...
        /* @__PURE__ */ r(zt, { children: z.map((C) => /* @__PURE__ */ l(
          Bt,
          {
            ...
            children: [
              ...
              C.starred && /* @__PURE__ */ r(da, { className: "tw-h-4 tw-w-4" }),
...
function Go({
  ...
  const u = a ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, d = a ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(kt, { children: [
  ...
  ] }), g = c(e === "horizontal" ? "horizontal tw-table-cell" : "vertical", a ? "marker-visible" : "");
  return /* @__PURE__ */ l(kt, { children: [
    /* @__PURE__ */ l("div", { className: c("textual-note-header tw-text-nowrap tw-pr-2", g), children: [
      u,
      p
    ] }),
    /* @__PURE__ */ r("div", { className: c("textual-note-body", g), children: w && w.length > 0 && /* @__PURE__ */ r(kt, { children: jo(t.marker, w, a, d) }) })
  ] });
}
...
const Ho = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function Fi({
  ...
  const p = d ? Ko(d, "%webView_footnoteList_header%") : "Footnotes", f = w ?? Ma(e, void 0), h = (x, _) => {
    u == null || u(x, _, a);
  }, g = o ? e.findIndex((x) => x === o) : 0, [b, y] = A(g), N = (x) => {
    if (e.length)
      switch (x.key) {
        case "ArrowDown":
        ...
        case "Enter":
        case " ":
          x.preventDefault(), u == null || u(e[b], b, a);
          break;
      }
  }, V = nt([]);
  return St(() => {
...
function Zi({
  ...
  const f = ft(n, "%webView_inventory_all%"), h = ft(n, "%webView_inventory_approved%"), g = ft(n, "%webView_inventory_unapproved%"), b = ft(n, "%webView_inventory_unknown%"), y = ft(n, "%webView_inventory_scope_currentBook%"), N = ft(n, "%webView_inventory_scope_chapter%"), V = ft(n, "%webView_inventory_scope_verse%"), x = ft(n, "%webView_inventory_filter_text%"), _ = ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), X = ft(n, "%webView_inventory_no_results%"), [z, P] = A(!1), [F, H] = A("all"), [R, C] = A(""), [B, E] = A([]), Z = J(() => {
    const T = t ?? [];
  ...
  }, [z, Z]), q = J(() => S.length === 0 ? [] : Qo(S, F, R), [S, F, R]), k = J(() => {
    var mt, ht;
    if (!z) return u;
  ...
  return /* @__PURE__ */ l("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(rt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? _ })
      ] })
    ] }),
...
const br = m.forwardRef(
  ({
    ...
    const [d, p] = m.useState(t), f = e ?? d, h = m.useCallback(
      (_) => {
        const X = typeof _ == "function" ? _(f) : _;
        n ? n(X) : p(X);
      },
      [n, f]
    ...
    return /* @__PURE__ */ r(gr.Provider, { value: x, children: /* @__PURE__ */ r(vn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const ds = Et(
  ...
  ({
    ...
    const u = t ? qt : "button", { state: d } = Me(), p = /* @__PURE__ */ r(
      u,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: c(ds({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(De, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
  ...
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? j.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === Rt ? Ft(o.start) : void 0;
      },
...
function tw({
  ...
  const [d, p] = A([]), [f, h] = A([{ id: Rt, desc: !1 }]), [g, b] = A({}), y = J(
  ...
  St(() => {
    if (w) {
      ...
      if (C.length === 1) {
        const B = y.find((E) => $n(E) === C[0]) || void 0;
        B && w(B);
      }
    }
  }, [g, y, w, V]);
  const x = o ?? ys, _ = s ?? _r, X = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [Rt] },
    { label: `Group by ${_}`, value: [Ot] },
    {
  ...
  }, F = (R, C) => R.getIsGrouped() ? "" : c("banded-row", C % 2 === 0 ? "even" : "odd"), H = (R, C, B) => {
    ...
    !e && /* @__PURE__ */ l(
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(No, { children: X.map((R) => /* @__PURE__ */ r(ct, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Se, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Te, { children: V.getHeaderGroups().map((R) => /* @__PURE__ */ r(Ct, { children: R.headers.filter((C) => C.column.columnDef.header).map((C) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(ce, { colSpan: C.colSpan, className: "top-0 tw-sticky", children: C.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
                  ...
                  Pt,
                  {
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ l(
                      M,
                      {
                        ...
                        type: "button",
                        children: [
                          R.getIsExpanded() && /* @__PURE__ */ r(Ne, {}),
                          !R.getIsExpanded() && (B === "ltr" ? /* @__PURE__ */ r(Yt, {}) : /* @__PURE__ */ r(Be, {})),
                          " ",
...
function _s({
  ...
  const s = kn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], d = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    M,
    {
      variant: "outline",
...
function Rs({
  ...
  }, [N, V] = A(!1), [x, _] = A(""), X = nt(void 0), z = nt(!1);
  ...
  const P = J(() => j.allBookIds.filter(
    ...
    (S, q = !1) => {
      ...
      const k = P.findIndex((T) => T === X.current), Q = P.findIndex((T) => T === S);
      if (k === -1 || Q === -1) return;
      const [xt, Xt] = [
        Math.min(k, Q),
        Math.max(k, Q)
      ], Vt = P.slice(xt, Xt + 1).map((T) => T);
      n(
        e.includes(S) ? e.filter((T) => !Vt.includes(T)) : [.../* @__PURE__ */ new Set([...e, ...Vt])]
      );
    },
    [e, n, P]
  ), R = (S) => {
    H(S, z.current), z.current = !1;
  }, C = (S, q) => {
    S.preventDefault(), H(q, S.shiftKey);
  }, B = G(
    (S) => {
      const q = kn(P, S).map((k) => k);
      n(
        Rr(P, S, e) ? e.filter((k) => !q.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, P]
  ), E = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(I).map((S) => /* @__PURE__ */ r(
      _s,
      {
        section: S,
        availableBookIds: P,
            ...
            Wt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(M, { variant: "ghost", size: "sm", onClick: E, children: u }),
                  /* @__PURE__ */ r(M, { variant: "ghost", size: "sm", onClick: Z, children: d })
                ] }),
                /* @__PURE__ */ l(Zt, { children: [
                  /* @__PURE__ */ r(Ce, { children: p }),
                  Object.values(I).map((S, q) => {
                    const k = F[S];
                    if (k.length !== 0)
...
function nw({
  ...
  const d = Mt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Mt(i, "%webView_scope_selector_current_book%"), g = Mt(i, "%webView_scope_selector_choose_books%"), b = Mt(i, "%webView_scope_selector_scope%"), y = Mt(i, "%webView_scope_selector_select_books%"), N = [
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        cn,
        {
          ...
          children: V.map(({ value: x, label: _, id: X }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(be, { className: "tw-me-2", value: x, id: X }),
            /* @__PURE__ */ r(rt, { htmlFor: X, children: _ })
          ] }, X))
        }
      )
    ] }),
...
function rw({
  ...
  return /* @__PURE__ */ l(
    Ut,
    {
      ...
      children: [
        /* @__PURE__ */ r(Lt, { size: o, className: c("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Kt,
          {
            placeholder: w[L(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((d) => /* @__PURE__ */ r(ct, { value: `${d}`, children: w[L(d)] }, `${d}`))
          }
        )
      ]
    }
...
function Qe({
  ...
  return /* @__PURE__ */ l(_e, { variant: s, children: [
    ...
    /* @__PURE__ */ r(me, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, d]) => typeof u == "boolean" || typeof d == "boolean" ? 0 : u.order - d.order).map(([u], d, p) => /* @__PURE__ */ l(jn, { children: [
...
$r.displayName = U.Item.displayName;
...
Lr.displayName = U.Separator.displayName;
const ae = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((d) => d.group === s).sort((d, p) => d.order - p.order).map((d) => /* @__PURE__ */ l(xn, { children: [
      /* @__PURE__ */ r(yn, { asChild: !0, children: "command" in d ? /* @__PURE__ */ l(
        $r,
        {
          onClick: () => {
            a(d);
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ r(xe, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ r(xe, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
      ...
      d.tooltip && /* @__PURE__ */ r(De, { children: d.tooltip })
...
function Is({
  ...
  const o = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), u = nt(void 0), d = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (ja(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), ae(i, [h, g]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), ae(w, [h, g]);
        break;
      case "alt+h":
        (V = u.current) == null || V.focus(), ae(u, [h, g]);
        break;
    }
  }), St(() => {
    ...
    return /* @__PURE__ */ r(Ir, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ l(Ts, { children: [
      /* @__PURE__ */ r(Or, { ref: d(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        zr,
        {
          className: "tw-z-[250]",
...
function pw({
  ...
  const d = Os(
    ...
    o && o(b), a && a([b, ...n.filter((y) => y !== b)]), s && n.find((y) => y === b) && s([...n.filter((y) => y !== b)]), f(!1);
  }, g = (b, y) => {
    var V, x, _, X, z, P;
    const N = y !== b ? ((x = (V = t[b]) == null ? void 0 : V.uiNames) == null ? void 0 : x[y]) ?? ((X = (_ = t[b]) == null ? void 0 : _.uiNames) == null ? void 0 : X.en) : void 0;
    return N ? `${(z = t[b]) == null ? void 0 : z.autonym} (${N})` : (P = t[b]) == null ? void 0 : P.autonym;
  };
      ...
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((b) => /* @__PURE__ */ r(ct, { value: b, children: g(b, e) }, b))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(rt, { className: "tw-font-normal tw-text-muted-foreground", children: Ia(d, {
        ...
        /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && w && /* @__PURE__ */ l(_e, { children: [
              /* @__PURE__ */ r(un, { className: c(d && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(M, { className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ka, {}) }) }),
...
const Ps = tn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ca, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
const js = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: c("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
di.displayName = lt.Trigger.displayName;
...
ci.displayName = lt.Content.displayName;
...
const mi = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = A(void 0), [w, u] = A(void 0), d = G(
    (h) => {
      i(h);
