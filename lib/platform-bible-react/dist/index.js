...
function Sv({ scrRef: e, handleSubmit: t }) {
  const [n, r] = fe(""), [o, a] = fe(
    ...
    me.bookNumberToId(e.bookNum)
  ), [f, v] = fe(!1), [g, p] = fe(f), h = $t(void 0), d = $t(void 0), b = $t(void 0), w = Ce(
    (k) => Qc(k).filter((S) => {
...
const Er = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("thead", { ref: n, className: F("[&_tr]:pr-border-b", e), ...t }));
...
function up({
  ...
  return /* @__PURE__ */ A("div", { children: [
    ...
    /* @__PURE__ */ m("div", { className: "pr-twp pr-font-sans", children: /* @__PURE__ */ A(xr, { children: [
      /* @__PURE__ */ m(Er, { children: h.getHeaderGroups().map((b) => /* @__PURE__ */ m(vt, { children: b.headers.map((w) => /* @__PURE__ */ m(Rn, { children: w.isPlaceholder ? void 0 : En(w.column.columnDef.header, w.getContext()) }, w.id)) }, b.id)) }),
...
function tn(e, t, n) {
  ...
  var i = Bt(e) ? Fe(e) : window, l = i.visualViewport, c = !ys() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, f = (r.top + (c && l ? l.offsetTop : 0)) / a, v = r.width / o, g = r.height / a;
  return {
    width: v,
    height: g,
    top: f,
...
function An(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Bu : l, u = n.rootBoundary, f = u === void 0 ? bs : u, v = n.elementContext, g = v === void 0 ? fn : v, p = n.altBoundary, h = p === void 0 ? !1 : p, d = n.padding, b = d === void 0 ? 0 : d, w = Es(typeof b != "number" ? b : ks(b, Vn)), P = g === fn ? ju : fn, x = e.rects.popper, E = e.elements[h ? P : g], y = bd(Bt(E) ? E : E.contextElement || xt(e.elements.popper), c, f, i), N = tn(e.elements.reference), C = Ns({
    reference: N,
    element: x,
    strategy: "absolute",
    placement: o
  }), _ = ho(Object.assign({}, x, C)), D = g === fn ? _ : N, j = {
  ...
  if (N) {
    if (a) {
      var $, z = E === "y" ? Ie : Me, B = E === "y" ? We : Xe, M = E === "y" ? "height" : "width", U = N[E], Q = U + b[z], Y = U - b[B], O = p ? -_[M] / 2 : 0, L = P === Qt ? C[M] : _[M], H = P === Qt ? -_[M] : -C[M], Z = t.elements.arrow, W = p && Z ? Mo(Z) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : xs(), K = X[z], J = X[B], q = Nn(0, C[M], W[M]), ee = x ? C[M] / 2 - O - q - K - j.mainAxis : L - q - K - j.mainAxis, te = x ? -C[M] / 2 + O + q + J + j.mainAxis : H + q + J + j.mainAxis, ie = t.elements.arrow && Fn(t.elements.arrow), V = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, ne = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, I = U + ee - ne - V, se = U + te - ne, Te = Nn(p ? fr(Q, I) : Q, U, p ? It(Y, se) : Y);
      N[E] = Te, S[E] = Te - U;
    }
    if (l) {
      var Pe, Ee = E === "x" ? Ie : Me, kt = E === "x" ? We : Xe, $e = N[y], rt = y === "y" ? "height" : "width", Be = $e + b[Ee], ot = $e - b[kt], Ne = [Ie, Me].indexOf(w) !== -1, Lt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, Tt = Ne ? Be : $e - C[rt] - _[rt] - Lt + j.altAxis, an = Ne ? $e + C[rt] + _[rt] - Lt - j.altAxis : ot, Gn = p && Ne ? ed(Tt, $e, an) : Nn(p ? Tt : Be, $e, p ? an : ot);
      N[y] = Gn, S[y] = Gn - $e;
    }
    t.modifiersData[r] = S;
  }
...
const qd = () => ut({
  ...
  } = t, b = ge(t, Hd), w = T.useRef(null), P = Ge(w, n), x = T.useRef(null), E = Ge(x, g), y = T.useRef(E);
  At(() => {
    y.current = E;
...
`));
  ...
  const {
    ...
    slotProps: b = {},
    slots: w = {}
  } = t, P = ge(t, Gd), [x, E] = T.useState(!0), y = () => {
    E(!1);
  }, N = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const j = mr(r);
    C = j && Cr(j) ? Oe(j).body : Oe(null).body;
  }
...
function ke(e) {
  const {
    ...
    if (i[t] == null)
      return null;
    const l = i[t], c = i.theme, u = Sr(c, r) || {};
    return pt(i, l, (v) => {
      let g = hr(u, o, v);
...
function am(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const P = Tc(i, R({
      shouldForwardProp: w,
      label: b
    }, p)), x = (y) => typeof y == "function" && y.__emotion_real !== y || Rt(y) ? (N) => nr(y, R({}, N, {
      theme: Jn({
        theme: N.theme,
        defaultTheme: n,
        themeId: t
...
function Rm(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ge(e, Em), a = e.primary || km(t), i = e.secondary || Tm(t), l = e.error || Nm(t), c = e.info || Cm(t), u = e.success || Sm(t), f = e.warning || Om(t);
  function v(d) {
    const b = Ja(d, Jr.text.primary) >= n ? Jr.text.primary : Za.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const w = Ja(d, b);
...
const Qm = {
  ...
  } = t, w = ge(t, Zm), P = yn(), x = T.useRef(), E = Hn(), y = T.useRef(null), N = Ge(y, a.ref, n), C = (B) => (M) => {
    if (B) {
      const U = y.current;
      M === void 0 ? B(U) : B(U, M);
    }
...
const yo = Xo, eh = (e) => {
  ...
  const o = $s(), a = dt({
    ...
    slots: x,
    slotProps: E
  } = a, y = ge(a, th), N = (r = x == null ? void 0 : x.root) != null ? r : c == null ? void 0 : c.Root, C = R({
    anchorEl: i,
    container: f,
    disablePortal: v,
    keepMounted: g,
...
`));
  const $l = T.useMemo(() => {
    ...
    touch: Be.current
  }), Vr = sh(pn), ca = (r = (o = te.popper) != null ? o : D.Popper) != null ? r : lh, pa = (a = (i = (l = te.transition) != null ? l : D.Transition) != null ? i : V) != null ? a : yo, ua = (c = (u = te.tooltip) != null ? u : D.Tooltip) != null ? c : ch, da = (f = (v = te.arrow) != null ? v : D.Arrow) != null ? f : ph, _l = wn(ca, R({}, q, (g = ee.popper) != null ? g : j.popper, {
    className: Se(Vr.popper, q == null ? void 0 : q.className, (p = (h = ee.popper) != null ? h : j.popper) == null ? void 0 : p.className)
  }), pn), Il = wn(pa, R({}, ne, (d = ee.transition) != null ? d : j.transition), pn), Ml = wn(ua, R({}, (b = ee.tooltip) != null ? b : j.tooltip, {
    className: Se(Vr.tooltip, (w = (P = ee.tooltip) != null ? P : j.tooltip) == null ? void 0 : w.className)
  }), pn), Al = wn(da, R({}, (x = ee.arrow) != null ? x : j.arrow, {
    className: Se(Vr.arrow, (E = (y = ee.arrow) != null ? y : j.arrow) == null ? void 0 : E.className)
  }), pn);
  return /* @__PURE__ */ A(T.Fragment, {
...
const mh = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], hh = (e) => {
  ...
  const r = dt({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = r, p = ge(r, mh), h = /* @__PURE__ */ T.isValidElement(o) && o.type === "svg", d = R({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
const qs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const d = (x) => {
    ...
    if (y === "ArrowDown")
      x.preventDefault(), gn(E, N, u, c, eo);
    else if (y === "ArrowUp")
      x.preventDefault(), gn(E, N, u, c, ci);
    else if (y === "Home")
      x.preventDefault(), gn(E, null, u, c, eo);
    else if (y === "End")
      ...
      C.previousKeyMatched && (j || gn(E, N, !1, c, eo, C)) ? x.preventDefault() : C.previousKeyMatched = !1;
    }
    f && f(x);
  }, b = Ge(p, n);
  let w = -1;
...
const Dh = qs, Bh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], jh = {
  ...
  } = t, x = ge(t, Bh), E = T.useRef(null), y = Ge(E, l.ref, n), N = (z) => (B) => {
    if (z) {
      const M = E.current;
      B === void 0 ? z(M) : z(M, B);
    }
...
const Wh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Xh = (e) => {
  ...
  const J = (r = (o = z == null ? void 0 : z.root) != null ? o : w.Root) != null ? r : qh, q = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : w.Backdrop) != null ? a : f, ee = (l = $ == null ? void 0 : $.root) != null ? l : P.root, te = (c = $ == null ? void 0 : $.backdrop) != null ? c : P.backdrop, ie = Dt({
    elementType: J,
...
const ig = (e) => {
  ...
  } = i, j = ge(i.TransitionProps, rg), k = ge(i, og), S = (r = E == null ? void 0 : E.paper) != null ? r : P, $ = T.useRef(), z = Ge($, S.ref), B = R({}, i, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: d,
    marginThreshold: b,
...
`)), b !== null && Ee < b) {
  ...
  const K = h || (c ? Oe(rr(c)).body : void 0), J = (o = x == null ? void 0 : x.root) != null ? o : sg, q = (a = x == null ? void 0 : x.paper) != null ? a : Qs, ee = Dt({
    elementType: q,
...
const pg = ["onEntering"], ug = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], dg = {
  ...
  const a = dt({
    ...
    slots: P = {},
    slotProps: x = {}
  } = a, E = ge(a.TransitionProps, pg), y = ge(a, ug), N = Hn(), C = N.direction === "rtl", _ = R({}, a, {
    autoFocus: i,
...
`)), Y.props.disabled || (w === "selectedMenu" && Y.props.selected || z === -1) && (z = O));
  ...
  const B = (r = P.paper) != null ? r : gg, M = (o = x.paper) != null ? o : p, U = Dt({
    elementType: P.root,
...
function _v({
  ...
  return /* @__PURE__ */ A("div", { className: "pr-twp pr-w-full", children: [
    ...
    /* @__PURE__ */ A(xr, { className: "pr-p-0", children: [
      t && /* @__PURE__ */ m(Er, { children: x.getHeaderGroups().map((k) => /* @__PURE__ */ m(vt, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => /* @__PURE__ */ m(Rn, { colSpan: S.colSpan, children: S.isPlaceholder ? void 0 : /* @__PURE__ */ A("div", { children: [
      ...
      /* @__PURE__ */ m(kr, { children: x.getRowModel().rows.map((k, S) => /* @__PURE__ */ m(
        vt,
        {
...
function Bg({
  ...
  return Ye(
    ...
    /* @__PURE__ */ m(Er, { children: /* @__PURE__ */ A(vt, { children: [
...
function Wb(e, t = {}) {
  ...
  function r(p, h, ...d) {
    ...
    return n(function(w, P) {
      const x = oo(P, w);
      return x ? typeof x == "function" || typeof x == "object" && "render" in x ? x : oo(P, `${w}.component`, w) : w;
    }(p, t.overrides), Pt({}, h, b, { className: Gb(h == null ? void 0 : h.className, b.className) || void 0 }), ...d);
  }
  function o(p) {
    let h = !1;
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(d, b, w) {
      ...
      if (P !== -1) {
        ...
        typeof N == "string" && (xo.test(N) || Eo.test(N)) && (d[y] = T.cloneElement(o(N.trim()), { key: w }));
      } else
        b !== "style" && (d[hi[b] || b] = !0);
      return d;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: it(al), i: ae.HIGH, l: (p, h, d) => ({ v: h(p[0].replace(Yg, ""), d) }), h: (p, h, d) => r("blockquote", { key: d.k }, h(p.v, d)) }, breakLine: { t: bn(Kg), i: ae.HIGH, l: no, h: (p, h, d) => r("br", { key: d.k }) }, breakThematic: { t: it(Jg), i: ae.HIGH, l: no, h: (p, h, d) => r("hr", { key: d.k }) }, codeBlock: { t: it(sl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, d) => r("pre", { key: d.k }, r("code", Pt({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(il), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: ht(Zg), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, d) => r("code", { key: d.k }, p.v) }, footnote: { t: it(tb), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: ro }, footnoteReference: { t: mt(nb), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, d) => r("a", { key: d.k, href: Wt(p.B) }, r("sup", { key: d.k }, p.v)) }, gfmTask: { t: mt(ob), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, d) => r("input", { checked: p.R, key: d.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? cl : ll), i: ae.HIGH, l: (p, h, d) => ({ v: or(h, p[2], d), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, d) => r(`h${p.C}`, { id: p.T, key: d.k }, h(p.v, d)) }, headingSetext: { t: it(pl), i: ae.MAX, l: (p, h, d) => ({ v: or(h, p[1], d), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: bn(ul), i: ae.HIGH, l: () => ({}), h: ro }, image: { t: ht(Bb), i: ae.HIGH, l: (p) => ({ D: p[1], B: xi(p[2]), F: p[3] }), h: (p, h, d) => r("img", { key: d.k, alt: p.D || void 0, title: p.F || void 0, src: Wt(p.B) }) }, link: { t: mt(Db), i: ae.LOW, l: (p, h, d) => ({ v: Ub(h, p[1], d), B: xi(p[2]), F: p[3] }), h: (p, h, d) => r("a", { key: d.k, href: Wt(p.B), title: p.F }, h(p.v, d)) }, linkAngleBraceStyleDetector: { t: mt(pb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : mt(lb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: mt(cb), i: ae.MAX, l(p) {
    let h = p[1], d = p[1];
...
` }, paragraph: { t: zb, i: ae.LOW, l: to, h: (p, h, d) => r("p", { key: d.k }, h(p.v, d)) }, ref: { t: mt(db), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: ro }, refImage: { t: ht(fb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, d) => r("img", { key: d.k, alt: p.D, src: Wt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: mt(mb), i: ae.MAX, l: (p, h, d) => ({ v: h(p[1], d), Z: h(p[0].replace(hb, "\\$1"), d), P: p[2] }), h: (p, h, d) => l[p.P] ? r("a", { key: d.k, href: Wt(l[p.P].B), title: l[p.P].F }, h(p.v, d)) : r("span", { key: d.k }, h(p.Z, d)) }, table: { t: it(dl), i: ae.HIGH, l: Fb, h: (p, h, d) => r("table", { key: d.k }, r("thead", null, r("tr", null, p.L.map(function(b, w) {
  ...
  }, h: (p, h, d) => r(p.H, Pt({ key: d.k }, p.O), p.G ? p.v : h(p.v, d)) }, c.htmlSelfClosing = { t: bn(Eo), i: ae.HIGH, l: (p) => ({ O: a(p[2] || ""), H: p[1] }), h: (p, h, d) => r(p.H, Pt({}, p.O, { key: d.k })) });
  const u = function(p) {
    let h = Object.keys(p);
    function d(b, w) {
      let P = [], x = "";
