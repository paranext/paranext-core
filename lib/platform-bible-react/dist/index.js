import Dl, { jsxs as A, jsx as m, Fragment as jt } from "react/jsx-runtime";
import * as T from "react";
import G, { forwardRef as Ei, useCallback as Ce, useState as fe, useRef as Pt, useEffect as Ye, useLayoutEffect as fa, useMemo as Bn } from "react";
import { getChaptersForBook as Bl, compareScrRefs as ao, scrRefToBBBCCCVVV as Vr, formatScrRef as Fr, split as jl } from "platform-bible-utils";
import * as be from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as Ll } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as Vl, Check as Eo, Circle as Fl, History as zl, ArrowDownWideNarrow as Ul, Clock as Hl, Bookmark as Gl, ChevronDown as ki, ChevronUp as Wl, ArrowLeftIcon as Xl, ChevronLeftIcon as ql, ChevronRightIcon as Yl, ArrowRightIcon as Kl, FilterIcon as Jl, X as Zl, Search as Ql, ChevronsUpDown as ec, ArrowUpIcon as tc, ArrowDownIcon as nc, ArrowUpDownIcon as rc, CircleCheckIcon as ar, CircleXIcon as ir, CircleHelpIcon as sr, LoaderCircle as ko, Download as oc } from "lucide-react";
...
const _e = class le {
  constructor(t, n, r, o) {
    if (oe(this, "firstChapter"), oe(this, "lastChapter"), oe(this, "lastVerse"), oe(this, "hasSegmentsDefined"), oe(this, "text"), oe(this, "BBBCCCVVVS"), oe(this, "longHashCode"), oe(this, "versification"), oe(this, "rtlMark", "‏"), oe(this, "_bookNum", 0), oe(this, "_chapterNum", 0), oe(this, "_verseNum", 0), oe(this, "_verse"), r == null && o == null)
      if (t != null && typeof t == "string") {
        const a = t, i = n != null && n instanceof Tt ? n : void 0;
        this.setEmpty(i), this.parse(a);
      } else if (t != null && typeof t == "number") {
        const a = n != null && n instanceof Tt ? n : void 0;
        ...
        if (t != null && t instanceof le) {
          ...
          if (t == null)
            return;
          const a = t instanceof Tt ? t : le.defaultVersification;
          this.setEmpty(a);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new Tt(i)), n ? new le(n, r.toString(), l, c) : new le();
  }
  /**
...
const Li = G.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ A(
  be.CheckboxItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ m("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ m(be.ItemIndicator, { children: /* @__PURE__ */ m(Eo, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
...
const vr = G.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ m(
  be.Label,
  {
    ref: r,
...
function Yc({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ A(vr, { className: "pr-flex pr-justify-between", children: [
...
function Sv({ scrRef: e, handleSubmit: t }) {
  ...
  ), [i, l] = fe(e.chapterNum ?? 0), [c, u] = fe(
    me.bookNumberToId(e.bookNum)
  ), [f, v] = fe(!1), [g, p] = fe(f), h = Pt(void 0), d = Pt(void 0), b = Pt(void 0), w = Ce(
    (k) => Qc(k).filter((S) => {
    ...
    /* @__PURE__ */ A(
      Oo,
      {
        ...
        children: [
          ...
          ba.map(
            (k, S) => w(k).length > 0 && /* @__PURE__ */ A("div", { children: [
              /* @__PURE__ */ m(vr, { className: "pr-font-semibold pr-text-slate-700", children: Kc[k] }),
              w(k).map(($) => /* @__PURE__ */ m("div", { children: /* @__PURE__ */ m(
                qc,
                {
                  bookId: $,
...
const Ke = G.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ A(
  xe.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ m("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ m(xe.ItemIndicator, { children: /* @__PURE__ */ m(Eo, { className: "pr-h-4 pr-w-4" }) }) }),
...
function pp({ table: e }) {
  return /* @__PURE__ */ A(Bi, { children: [
    /* @__PURE__ */ m(Ll, { asChild: !0, children: /* @__PURE__ */ A(ge, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ m(Jl, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ A(Oo, { align: "end", className: "pr-w-[150px]", children: [
      /* @__PURE__ */ m(vr, { children: "Toggle columns" }),
      /* @__PURE__ */ m(Ro, {}),
...
function up({
  ...
  var d;
  const [i, l] = fe([]), [c, u] = fe([]), [f, v] = fe({}), [g, p] = fe({}), h = Ti({
    data: t,
    columns: e,
    getCoreRowModel: Ni(),
  ...
  return /* @__PURE__ */ A("div", { children: [
    o && /* @__PURE__ */ m(pp, { table: h }),
    /* @__PURE__ */ m("div", { className: "pr-twp pr-font-sans", children: /* @__PURE__ */ A(wr, { children: [
      /* @__PURE__ */ m(xr, { children: h.getHeaderGroups().map((b) => /* @__PURE__ */ m(vt, { children: b.headers.map((w) => /* @__PURE__ */ m(Rn, { children: w.isPlaceholder ? void 0 : En(w.column.columnDef.header, w.getContext()) }, w.id)) }, b.id)) }),
      /* @__PURE__ */ m(Er, { children: (d = h.getRowModel().rows) != null && d.length ? h.getRowModel().rows.map((b) => /* @__PURE__ */ m(
        vt,
        {
          onClick: () => a(b, h),
          "data-state": b.getIsSelected() && "selected",
          children: b.getVisibleCells().map((w) => /* @__PURE__ */ m(Kt, { children: En(w.column.columnDef.cell, w.getContext()) }, w.id))
        },
        b.id
...
function Tp() {
  if (ya)
    return ce;
  ya = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, a = e ? Symbol.for("react.profiler") : 60114, i = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, u = e ? Symbol.for("react.concurrent_mode") : 60111, f = e ? Symbol.for("react.forward_ref") : 60112, v = e ? Symbol.for("react.suspense") : 60113, g = e ? Symbol.for("react.suspense_list") : 60120, p = e ? Symbol.for("react.memo") : 60115, h = e ? Symbol.for("react.lazy") : 60116, d = e ? Symbol.for("react.block") : 60121, b = e ? Symbol.for("react.fundamental") : 60117, w = e ? Symbol.for("react.responder") : 60118, P = e ? Symbol.for("react.scope") : 60119;
  function x(y) {
  ...
  return ce.AsyncMode = c, ce.ConcurrentMode = u, ce.ContextConsumer = l, ce.ContextProvider = i, ce.Element = t, ce.ForwardRef = f, ce.Fragment = r, ce.Lazy = h, ce.Memo = p, ce.Portal = n, ce.Profiler = a, ce.StrictMode = o, ce.Suspense = v, ce.isAsyncMode = function(y) {
    return E(y) || x(y) === c;
    ...
    return typeof y == "string" || typeof y == "function" || y === r || y === u || y === a || y === o || y === v || y === g || typeof y == "object" && y !== null && (y.$$typeof === h || y.$$typeof === p || y.$$typeof === i || y.$$typeof === l || y.$$typeof === f || y.$$typeof === b || y.$$typeof === w || y.$$typeof === P || y.$$typeof === d);
  }, ce.typeOf = x, ce;
}
var pe = {};
/** @license React v16.13.1
...
function Np() {
  return wa || (wa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function x(V) {
      ...
      V === r || V === u || V === a || V === o || V === v || V === g || typeof V == "object" && V !== null && (V.$$typeof === h || V.$$typeof === p || V.$$typeof === i || V.$$typeof === l || V.$$typeof === f || V.$$typeof === b || V.$$typeof === w || V.$$typeof === P || V.$$typeof === d);
    }
    function E(V) {
    ...
    var y = c, N = u, C = l, _ = i, D = t, j = f, k = r, S = h, $ = p, z = n, B = a, M = o, U = v, Q = !1;
    function Y(V) {
      return Q || (Q = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), O(V) || E(V) === c;
    }
    function O(V) {
      return E(V) === u;
    }
    ...
    pe.AsyncMode = y, pe.ConcurrentMode = N, pe.ContextConsumer = C, pe.ContextProvider = _, pe.Element = D, pe.ForwardRef = j, pe.Fragment = k, pe.Lazy = S, pe.Memo = $, pe.Portal = z, pe.Profiler = B, pe.StrictMode = M, pe.Suspense = U, pe.isAsyncMode = Y, pe.isConcurrentMode = O, pe.isContextConsumer = L, pe.isContextProvider = H, pe.isElement = Z, pe.isForwardRef = W, pe.isFragment = X, pe.isLazy = K, pe.isMemo = J, pe.isPortal = q, pe.isProfiler = ee, pe.isStrictMode = te, pe.isSuspense = ie, pe.isValidElementType = x, pe.typeOf = E;
  }()), pe;
}
var xa;
function Yi() {
...
var Hr, Ta;
function Ki() {
  return Ta || (Ta = 1, Hr = Function.call.bind(Object.prototype.hasOwnProperty)), Hr;
}
var Gr, Na;
function Sp() {
  if (Na)
  ...
  return Wr = function(l, c) {
    ...
    function b(O) {
      ...
      function Z(X, K, J, q, ee, te, ie) {
        ...
        return K[J] == null ? X ? K[J] === null ? new d("The " + ee + " `" + te + "` is marked as required " + ("in `" + q + "`, but its value is `null`.")) : new d("The " + ee + " `" + te + "` is marked as required in " + ("`" + q + "`, but its value is `undefined`.")) : null : O(K, J, q, ee, te);
      }
      var W = Z.bind(null, !1);
      return W.isRequired = Z.bind(null, !0), W;
    }
    function w(O) {
      function L(H, Z, W, X, K, J) {
        var q = H[Z], ee = M(q);
        if (ee !== O) {
          var te = U(q);
          return new d(
    ...
    function E() {
      function O(L, H, Z, W, X) {
        var K = L[H];
        if (!l(K)) {
          var J = M(K);
          return new d("Invalid " + W + " `" + X + "` of type " + ("`" + J + "` supplied to `" + Z + "`, expected a single ReactElement."));
        }
        return null;
      }
      return b(O);
    ...
    function y() {
      function O(L, H, Z, W, X) {
        ...
        if (!e.isValidElementType(K)) {
          var J = M(K);
          return new d("Invalid " + W + " `" + X + "` of type " + ("`" + J + "` supplied to `" + Z + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return b(O);
    ...
    function C(O) {
      ...
      function L(H, Z, W, X, K) {
        for (var J = H[Z], q = 0; q < O.length; q++)
          if (h(J, O[q]))
            return null;
        var ee = JSON.stringify(O, function(ie, V) {
          var ne = U(V);
          return ne === "symbol" ? String(V) : V;
        });
        return new d("Invalid " + X + " `" + K + "` of value `" + String(J) + "` " + ("supplied to `" + W + "`, expected one of " + ee + "."));
      }
      return b(L);
    }
    function _(O) {
    ...
    function D(O) {
      ...
      function Z(W, X, K, J, q) {
        for (var ee = [], te = 0; te < O.length; te++) {
          var ie = O[te], V = ie(W, X, K, J, q, n);
          if (V == null)
            return null;
          V.data && r(V.data, "expectedType") && ee.push(V.data.expectedType);
        }
    ...
    function j() {
      function O(L, H, Z, W, X) {
        return z(L[H]) ? null : new d("Invalid " + W + " `" + X + "` supplied to " + ("`" + Z + "`, expected a ReactNode."));
      }
      return b(O);
    }
    function k(O, L, H, Z, W) {
      return new d(
        (O || "React class") + ": " + L + " type `" + H + "." + Z + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + W + "`."
      );
    }
    function S(O) {
      function L(H, Z, W, X, K) {
...
Valid keys: ` + JSON.stringify(Object.keys(O), null, "  ")
    ...
    function M(O) {
      var L = typeof O;
      return Array.isArray(O) ? "array" : O instanceof RegExp ? "object" : B(L, O) ? "symbol" : L;
    }
    function U(O) {
...
function st(e, t, n = {
  ...
  return Ot(e) && Ot(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (Ot(t[o]) && o in e && Ot(e[o]) ? r[o] = st(e[o], t[o], n) : n.clone ? r[o] = Ot(t[o]) ? Ji(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function Ip(e) {
  const {
...
function jp() {
  ...
  return ue.ContextConsumer = i, ue.ContextProvider = a, ue.Element = e, ue.ForwardRef = c, ue.Fragment = n, ue.Lazy = g, ue.Memo = v, ue.Portal = t, ue.Profiler = o, ue.StrictMode = r, ue.Suspense = u, ue.SuspenseList = f, ue.isAsyncMode = function() {
    return !1;
...
function Lp() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), v = Symbol.for("react.memo"), g = Symbol.for("react.lazy"), p = Symbol.for("react.offscreen"), h = !1, d = !1, b = !1, w = !1, P = !1, x;
    x = Symbol.for("react.module.reference");
    function E(I) {
      return !!(typeof I == "string" || typeof I == "function" || I === n || I === o || P || I === r || I === u || I === f || w || I === p || h || d || b || typeof I == "object" && I !== null && (I.$$typeof === g || I.$$typeof === v || I.$$typeof === a || I.$$typeof === i || I.$$typeof === c || // This needs to include all possible module reference object
    ...
    var N = i, C = a, _ = e, D = c, j = n, k = g, S = v, $ = t, z = o, B = r, M = u, U = f, Q = !1, Y = !1;
    function O(I) {
    ...
    de.ContextConsumer = N, de.ContextProvider = C, de.Element = _, de.ForwardRef = D, de.Fragment = j, de.Lazy = k, de.Memo = S, de.Portal = $, de.Profiler = z, de.StrictMode = B, de.Suspense = M, de.SuspenseList = U, de.isAsyncMode = O, de.isConcurrentMode = L, de.isContextConsumer = H, de.isContextProvider = Z, de.isElement = W, de.isForwardRef = X, de.isFragment = K, de.isLazy = J, de.isMemo = q, de.isPortal = ee, de.isProfiler = te, de.isStrictMode = ie, de.isSuspense = V, de.isSuspenseList = ne, de.isValidElementType = E, de.typeOf = y;
  }()), de;
}
process.env.NODE_ENV === "production" ? lo.exports = jp() : lo.exports = Lp();
var pr = lo.exports;
...
const Xp = typeof window < "u" ? T.useLayoutEffect : T.useEffect, Mt = Xp;
let $a = 0;
function qp(e) {
...
function ou(e) {
  e.addEventListener("keydown", nu, !0), e.addEventListener("mousedown", qr, !0), e.addEventListener("pointerdown", qr, !0), e.addEventListener("touchstart", qr, !0), e.addEventListener("visibilitychange", ru, !0);
}
function au(e) {
  const {
    target: t
...
function as() {
  ...
  function n() {
    return t.current ? (po = !0, Qp.start(100, () => {
      po = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
function gu(e) {
  ...
  if (!t) {
    const p = Se(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = R({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), d = R({}, n, o, r);
    return p.length > 0 && (d.className = p), Object.keys(h).length > 0 && (d.style = h), {
      props: d,
      internalRef: void 0
    };
  }
  const i = ms(R({}, o, r)), l = Aa(r), c = Aa(o), u = t(i), f = Se(u == null ? void 0 : u.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = R({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), g = R({}, u, n, c, l);
...
function dr(e) {
  const {
    ...
    isEnabled: i = Cu,
    open: l
  } = e, c = T.useRef(!1), u = T.useRef(null), f = T.useRef(null), v = T.useRef(null), g = T.useRef(null), p = T.useRef(!1), h = T.useRef(null), d = Ge(t.ref, h), b = T.useRef(null);
  T.useEffect(() => {
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    if (!l || !h.current)
      return;
    const x = Oe(h.current), E = (C) => {
      b.current = C, !(r || !i() || C.key !== "Tab") && x.activeElement === h.current && C.shiftKey && (c.current = !0, f.current && f.current.focus());
    }, y = () => {
      const C = h.current;
      if (C === null)
        return;
      ...
      if (C.contains(x.activeElement) || r && x.activeElement !== u.current && x.activeElement !== f.current)
        return;
      ...
      if (!p.current)
        return;
      let _ = [];
      if ((x.activeElement === u.current || x.activeElement === f.current) && (_ = a(h.current)), _.length > 0) {
        var D, j;
        const k = !!((D = b.current) != null && D.shiftKey && ((j = b.current) == null ? void 0 : j.key) === "Tab"), S = _[0], $ = _[_.length - 1];
...
function Du(e) {
  const {
    ...
    open: f,
    rootRef: v
  } = e, g = T.useRef({}), p = T.useRef(null), h = T.useRef(null), d = Ge(h, v), [b, w] = T.useState(!f), P = Mu(c);
  let x = !0;
  ...
  const E = () => Oe(p.current), y = () => (g.current.modalRef = h.current, g.current.mount = p.current, g.current), N = () => {
    ...
    p.current = M, M && (f && _() ? N() : h.current && Tn(h.current, x));
  }), j = T.useCallback(() => {
    o.remove(y(), x);
  }, [x, o]);
  T.useEffect(() => () => {
  ...
  const k = (M) => (U) => {
    ...
    !_()) && (n || (U.stopPropagation(), u && u(U, "escapeKeyDown")));
  }, S = (M) => (U) => {
    var Q;
    (Q = M.onClick) == null || Q.call(M, U), U.target === U.currentTarget && u && u(U, "backdropClick");
  };
  return {
    getRootProps: (M = {}) => {
      const U = ms(e);
    ...
    getTransitionProps: () => {
      ...
      return {
        ...
        onExited: co(U, c == null ? void 0 : c.props.onExited)
      };
    },
    rootRef: d,
    portalRef: D,
...
var _t = Math.max, fr = Math.min, en = Math.round;
function fo() {
...
function tn(e, t, n) {
  ...
  var i = Dt(e) ? Fe(e) : window, l = i.visualViewport, c = !ys() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, f = (r.top + (c && l ? l.offsetTop : 0)) / a, v = r.width / o, g = r.height / a;
  return {
    width: v,
    height: g,
    top: f,
...
function nd(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Ze(n.placement), c = Ao(l), u = [Me, Xe].indexOf(l) >= 0, f = u ? "height" : "width";
  if (!(!a || !i)) {
    var v = td(o.padding, n), g = Mo(a), p = c === "y" ? Ie : Me, h = c === "y" ? We : Xe, d = n.rects.reference[f] + n.rects.reference[c] - i[c] - n.rects.popper[f], b = i[c] - n.rects.reference[c], w = Fn(a), P = w ? c === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = d / 2 - b / 2, E = v[p], y = P - g[f] - v[h], N = P / 2 - g[f] / 2 + x, C = Nn(E, N, y), _ = c;
...
function Va(e) {
  ...
  p = b.x, d = b.y;
  var w = i.hasOwnProperty("x"), P = i.hasOwnProperty("y"), x = Me, E = Ie, y = window;
  if (u) {
    var N = Fn(n), C = "clientHeight", _ = "clientWidth";
    if (N === Fe(n) && (N = wt(n), ct(N).position !== "static" && l === "absolute" && (C = "scrollHeight", _ = "scrollWidth")), N = N, o === Ie || (o === Me || o === Xe) && a === Mn) {
      E = We;
  ...
  if (p = S.x, d = S.y, c) {
    var $;
    return Object.assign({}, k, ($ = {}, $[E] = P ? "0" : "", $[x] = w ? "0" : "", $.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + d + "px)" : "translate3d(" + p + "px, " + d + "px, 0)", $));
  }
  return Object.assign({}, k, (t = {}, t[E] = P ? d + "px" : "", t[x] = w ? p + "px" : "", t.transform = "", t));
}
function sd(e) {
...
function Bo(e) {
  return tn(wt(e)).left + Do(e).scrollLeft;
}
function fd(e, t) {
  var n = Fe(e), r = wt(e), o = n.visualViewport, a = r.clientWidth, i = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function md(e) {
  var t, n = wt(e), r = Do(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = _t(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = _t(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Bo(e), c = -r.scrollTop;
...
function Ts(e) {
  return ["html", "body", "#document"].indexOf(tt(e)) >= 0 ? e.ownerDocument.body : He(e) && jo(e) ? e : Ts(Tr(e));
}
function Cn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function za(e, t, n) {
  return t === bs ? mo(fd(e, n)) : Dt(t) ? hd(t, n) : mo(md(wt(e)));
}
function gd(e) {
  var t = Cn(Tr(e)), n = ["absolute", "fixed"].indexOf(ct(e).position) >= 0, r = n && He(e) ? Fn(e) : e;
  return Dt(r) ? t.filter(function(o) {
    return Dt(o) && ws(o, r) && tt(o) !== "body";
  }) : [];
}
function bd(e, t, n, r) {
  var o = t === "clippingParents" ? gd(e) : [].concat(t), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, u) {
    var f = za(e, u, r);
    return c.top = _t(f.top, c.top), c.right = fr(f.right, c.right), c.bottom = fr(f.bottom, c.bottom), c.left = _t(f.left, c.left), c;
  }, za(e, i, r));
...
function An(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Bu : l, u = n.rootBoundary, f = u === void 0 ? bs : u, v = n.elementContext, g = v === void 0 ? fn : v, p = n.altBoundary, h = p === void 0 ? !1 : p, d = n.padding, b = d === void 0 ? 0 : d, w = Es(typeof b != "number" ? b : ks(b, Vn)), P = g === fn ? ju : fn, x = e.rects.popper, E = e.elements[h ? P : g], y = bd(Dt(E) ? E : E.contextElement || wt(e.elements.popper), c, f, i), N = tn(e.elements.reference), C = Ns({
    reference: N,
    element: x,
    strategy: "absolute",
    placement: o
  }), _ = mo(Object.assign({}, x, C)), D = g === fn ? _ : N, j = {
...
function vd(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? vs : c, f = nn(r), v = f ? l ? ja : ja.filter(function(h) {
    return nn(h) === f;
...
function wd(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, u = n.padding, f = n.boundary, v = n.rootBoundary, g = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, d = n.allowedAutoPlacements, b = t.options.placement, w = Ze(b), P = w === b, x = c || (P || !h ? [er(b)] : yd(b)), E = [b].concat(x).reduce(function(W, X) {
    ...
    }, []), y = t.rects.reference, N = t.rects.popper, C = /* @__PURE__ */ new Map(), _ = !0, D = E[0], j = 0; j < E.length; j++) {
      var k = E[j], S = Ze(k), $ = nn(k) === Qt, z = [Ie, We].indexOf(S) >= 0, B = z ? "width" : "height", M = An(t, {
        placement: k,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
...
function Pd(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, u = n.rootBoundary, f = n.altBoundary, v = n.padding, g = n.tether, p = g === void 0 ? !0 : g, h = n.tetherOffset, d = h === void 0 ? 0 : h, b = An(t, {
    boundary: c,
    rootBoundary: u,
    padding: v,
    altBoundary: f
  }), w = Ze(t.placement), P = nn(t.placement), x = !P, E = Ao(w), y = Rd(E), N = t.modifiersData.popperOffsets, C = t.rects.reference, _ = t.rects.popper, D = typeof d == "function" ? d(Object.assign({}, t.rects, {
    placement: t.placement
  })) : d, j = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (N) {
    if (a) {
      var $, z = E === "y" ? Ie : Me, B = E === "y" ? We : Xe, M = E === "y" ? "height" : "width", U = N[E], Q = U + b[z], Y = U - b[B], O = p ? -_[M] / 2 : 0, L = P === Qt ? C[M] : _[M], H = P === Qt ? -_[M] : -C[M], Z = t.elements.arrow, W = p && Z ? Mo(Z) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : xs(), K = X[z], J = X[B], q = Nn(0, C[M], W[M]), ee = x ? C[M] / 2 - O - q - K - j.mainAxis : L - q - K - j.mainAxis, te = x ? -C[M] / 2 + O + q + J + j.mainAxis : H + q + J + j.mainAxis, ie = t.elements.arrow && Fn(t.elements.arrow), V = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, ne = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, I = U + ee - ne - V, se = U + te - ne, Te = Nn(p ? fr(Q, I) : Q, U, p ? _t(Y, se) : Y);
      N[E] = Te, S[E] = Te - U;
    }
    if (l) {
      var Pe, Ee = E === "x" ? Ie : Me, Et = E === "x" ? We : Xe, $e = N[y], rt = y === "y" ? "height" : "width", Be = $e + b[Ee], ot = $e - b[Et], Ne = [Ie, Me].indexOf(w) !== -1, Lt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, kt = Ne ? Be : $e - C[rt] - _[rt] - Lt + j.altAxis, an = Ne ? $e + C[rt] + _[rt] - Lt - j.altAxis : ot, Gn = p && Ne ? ed(kt, $e, an) : Nn(p ? kt : Be, $e, p ? an : ot);
      N[y] = Gn, S[y] = Gn - $e;
    }
    t.modifiersData[r] = S;
  }
...
function Ad(e, t, n) {
  n === void 0 && (n = !1);
  var r = He(t), o = He(t) && Md(t), a = wt(t), i = tn(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
    ...
    var f = {
      ...
      setOptions: function(w) {
        ...
        d(), f.options = Object.assign({}, a, f.options, P), f.scrollParents = {
          reference: Dt(l) ? Cn(l) : l.contextElement ? Cn(l.contextElement) : [],
          popper: Cn(c)
        };
        var x = Bd(Ld([].concat(r, f.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (Wa(P, x)) {
            f.rects = {
              reference: Ad(P, Fn(x), f.options.strategy === "fixed"),
              popper: Mo(x)
...
const qd = () => ut({
  ...
  } = t, b = he(t, Hd), w = T.useRef(null), P = Ge(w, n), x = T.useRef(null), E = Ge(x, g), y = T.useRef(E);
  Mt(() => {
    y.current = E;
  }, [E]), T.useImperativeHandle(g, () => x.current, []);
  const N = Wd(f, i), [C, _] = T.useState(N), [D, j] = T.useState(mr(o));
  T.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && D && Nr(D) && D.nodeType === 1) {
...
`));
  ...
  const S = qd(), $ = (r = h.root) != null ? r : "div", z = At({
    elementType: $,
  ...
  const {
    ...
    slotProps: b = {},
    slots: w = {}
  } = t, P = he(t, Gd), [x, E] = T.useState(!0), y = () => {
    E(!1);
  }, N = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const j = mr(r);
    C = j && Nr(j) ? Oe(j).body : Oe(null).body;
  }
...
function Qd(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = he(e, Jd), a = Zd(t), i = Object.keys(a);
  function l(g) {
...
const ef = {
  borderRadius: 4
}, tf = ef, nf = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, xt = nf;
function Sn(e, t) {
  return t ? st(e, t, {
    clone: !1
...
function ke(e) {
  const {
    ...
    if (i[t] == null)
      return null;
    const l = i[t], c = i.theme, u = Cr(c, r) || {};
    return pt(i, l, (v) => {
      let g = hr(u, o, v);
      return v === g && typeof v == "string" && (g = hr(u, o, `${t}${v === "default" ? "" : et(v)}`, v)), n === !1 ? g : {
        [n]: g
      };
    });
  };
...
ye.propTypes = process.env.NODE_ENV !== "production" ? Sr.reduce((e, t) => (e[t] = xt, e), {}) : {};
ye.filterProps = Sr;
function we(e) {
  return Rs(e, Or);
}
we.propTypes = process.env.NODE_ENV !== "production" ? Or.reduce((e, t) => (e[t] = xt, e), {}) : {};
we.filterProps = Or;
process.env.NODE_ENV !== "production" && pf.reduce((e, t) => (e[t] = xt, e), {});
function ff(e = 8) {
  if (e.mui)
    return e;
  const t = Os({
...
const mf = qe("border", Ue), hf = qe("borderTop", Ue), gf = qe("borderRight", Ue), bf = qe("borderBottom", Ue), vf = qe("borderLeft", Ue), yf = qe("borderColor"), wf = qe("borderTopColor"), xf = qe("borderRightColor"), Ef = qe("borderBottomColor"), kf = qe("borderLeftColor"), Tf = qe("outline", Ue), Nf = qe("outlineColor"), Pr = (e) => {
...
Rr(mf, hf, gf, bf, vf, yf, wf, xf, Ef, kf, Pr, Tf, Nf);
const $r = (e) => {
...
Rr($r, _r, Ir, Cf, Sf, Of, Rf, Pf, $f, _f, If, Mf);
function Yt(e, t) {
  return t === "grey" ? t : e;
}
const Af = ke({
...
function Xf() {
  function e(n, r, o, a) {
    ...
    return v ? v(i) : pt(i, r, (h) => {
      let d = hr(g, f, h);
      return h === d && typeof h == "string" && (d = hr(g, f, `${n}${h === "default" ? "" : et(h)}`, h)), c === !1 ? d : {
        [c]: d
      };
    });
  }
...
function Uo(e = {}, ...t) {
  ...
  return u.applyStyles = qf, u = t.reduce((f, v) => st(f, v), u), u.unstable_sxConfig = R({}, Fo, i == null ? void 0 : i.unstable_sxConfig), u.unstable_sx = function(v) {
    return zo({
      sx: v,
      theme: this
    });
...
function am(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const {
      ...
      overridesResolver: g = om(Ya(u))
    } = l, p = he(l, em), h = f !== void 0 ? f : (
    ...
    let w = tr;
    u === "Root" || u === "root" ? w = r : u ? w = o : nm(i) && (w = void 0);
    const P = Tc(i, R({
      shouldForwardProp: w,
      label: b
    }, p)), x = (y) => typeof y == "function" && y.__emotion_real !== y || Ot(y) ? (N) => nr(y, R({}, N, {
      theme: Jn({
        theme: N.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${et(u || "")}`), k === void 0 && (k = `Styled(${zp(i)})`), j.displayName = k;
      }
...
function Ka(e) {
  e = Bt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Bt(cm(e)).values : e.values;
...
function gr(e, t) {
  return e = Bt(e), t = Ho(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Mr(e);
}
function pm(e, t) {
...
function Rm(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = he(e, Em), a = e.primary || km(t), i = e.secondary || Tm(t), l = e.error || Nm(t), c = e.info || Cm(t), u = e.success || Sm(t), f = e.warning || Om(t);
  function v(d) {
    const b = Ja(d, Kr.text.primary) >= n ? Kr.text.primary : Za.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const w = Ja(d, b);
...
`));
  ...
  const g = ({
    ...
    if (d = R({}, d), !d.main && d[w] && (d.main = d[w]), !d.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${b ? ` (${b})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${w}\` property.` : Jt(11, b ? ` (${b})` : "", w));
...
} });` : Jt(12, b ? ` (${b})` : "", JSON.stringify(d.main)));
    return Qa(d, "light", P, r), Qa(d, "dark", x, r), d.contrastText || (d.contrastText = v(d.main)), d;
  }, p = {
    dark: Kr,
    light: Za
  };
...
function _m(e, t) {
  ...
  const p = o / 14, h = v || ((w) => `${w / u * p}rem`), d = (w, P, x, E, y) => R({
    fontFamily: r,
    fontWeight: w,
    fontSize: h(P),
...
function zm(e) {
  const t = R({}, Lm, e.easing), n = R({}, Vm, e.duration);
  return R({
...
`));
  ...
  return u.unstable_sxConfig = R({}, Fo, i == null ? void 0 : i.unstable_sxConfig), u.unstable_sx = function(v) {
    return zo({
      sx: v,
      theme: this
    });
...
var Jm = function(t) {
  return t.scrollTop;
}, xn = "unmounted", Nt = "exited", Ct = "entering", qt = "entered", go = "exiting", ft = /* @__PURE__ */ function(e) {
  Ym(t, e);
  function t(r, o) {
    var a;
    a = e.call(this, r, o) || this;
    var i = o, l = i && !i.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = Nt, a.appearStatus = Ct) : c = qt : r.unmountOnExit || r.mountOnEnter ? c = xn : c = Nt, a.state = {
      status: c
...
const Qm = {
...
}, Jr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Xo = /* @__PURE__ */ T.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = t, w = he(t, Zm), P = yn(), x = T.useRef(), E = Hn(), y = T.useRef(null), N = Ge(y, a.ref, n), C = (B) => (M) => {
    if (B) {
      const U = y.current;
      M === void 0 ? B(U) : B(U, M);
    }
    ...
    let O;
    d === "auto" ? (O = E.transitions.getAutoHeightDuration(B.clientHeight), x.current = O) : O = U, B.style.transition = [E.transitions.create("opacity", {
      duration: O,
      delay: Q
    ...
    let Y;
    d === "auto" ? (Y = E.transitions.getAutoHeightDuration(B.clientHeight), x.current = Y) : Y = M, B.style.transition = [E.transitions.create("opacity", {
      duration: Y,
      delay: U
    }), E.transitions.create("transform", {
      duration: Jr ? Y : Y * 0.666,
      delay: Jr ? U : U || Y * 0.333,
      easing: Q
    })].join(","), B.style.opacity = 0, B.style.transform = bo(0.75), v && v(B);
  }), $ = C(g);
  return /* @__PURE__ */ m(b, R({
    ...
    onExiting: k,
    addEndListener: (B) => {
      d === "auto" && P.start(x.current || 0, B), r && r(y.current, B);
    },
    timeout: d === "auto" ? null : d
  }, w, {
    children: (B, M) => /* @__PURE__ */ T.cloneElement(a, R({
      style: R({
        opacity: 0,
        transform: bo(0.75),
...
const vo = Xo, eh = (e) => {
  ...
  const o = $s(), a = dt({
    ...
    slots: x,
    slotProps: E
  } = a, y = he(a, th), N = (r = x == null ? void 0 : x.root) != null ? r : c == null ? void 0 : c.Root, C = R({
    anchorEl: i,
    container: f,
    disablePortal: v,
    keepMounted: g,
...
const oh = yt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), bt = oh, ah = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function ih(e) {
  return Math.round(e * 1e5) / 1e5;
}
const sh = (e) => {
...
const Ls = /* @__PURE__ */ T.forwardRef(function(t, n) {
  var r, o, a, i, l, c, u, f, v, g, p, h, d, b, w, P, x, E, y;
  const N = dt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    slots: te = {},
    title: ie,
    TransitionComponent: V = vo,
    TransitionProps: ne
  } = N, I = he(N, ah), se = /* @__PURE__ */ T.isValidElement(_) ? _ : /* @__PURE__ */ m("span", {
    children: _
  }), Te = Hn(), Pe = Te.direction === "rtl", [Ee, Et] = T.useState(), [$e, rt] = T.useState(null), Be = T.useRef(!1), ot = z || Y, Ne = yn(), Lt = yn(), kt = yn(), an = yn(), [Gn, Qo] = os({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Ar = rs(O), sn = T.useRef(), Wn = _n(() => {
  ...
  const ea = (re) => {
    ...
    Be.current && re.type !== "touchstart" || (Ee && Ee.removeAttribute("title"), Lt.clear(), kt.clear(), M || Zn && U ? Lt.start(Zn ? U : M, () => {
      ea(re);
    }) : ea(re));
  }, ta = (re) => {
    Lt.clear(), kt.start(L, () => {
    ...
    Ee || Et(re.currentTarget), Nl(re), na.current === !0 && (ra(!0), Dr(re));
  }, ia = (re) => {
    Be.current = !0;
    const je = se.props;
    je.onTouchStart && je.onTouchStart(re);
  }, sa = Dr, la = ta, Sl = (re) => {
    ia(re), kt.clear(), Ne.clear(), Wn(), sn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", an.start(Q, () => {
      document.body.style.WebkitUserSelect = sn.current, Dr(re);
    });
  }, Ol = (re) => {
    se.props.onTouchEnd && se.props.onTouchEnd(re), Wn(), kt.start(H, () => {
      Xn(re);
    });
  };
  T.useEffect(() => {
  ...
  }, ln = {}, jr = typeof ie == "string";
  k ? (ln.title = !at && jr && !$ ? ie : null, ln["aria-describedby"] = at ? Ar : null) : (ln["aria-label"] = jr ? ie : null, ln["aria-labelledby"] = at && !jr ? Ar : null);
  const ze = R({}, ln, I, se.props, {
...
`));
  const $l = T.useMemo(() => {
    ...
    touch: Be.current
  }), Lr = sh(pn), ca = (r = (o = te.popper) != null ? o : D.Popper) != null ? r : lh, pa = (a = (i = (l = te.transition) != null ? l : D.Transition) != null ? i : V) != null ? a : vo, ua = (c = (u = te.tooltip) != null ? u : D.Tooltip) != null ? c : ch, da = (f = (v = te.arrow) != null ? v : D.Arrow) != null ? f : ph, _l = wn(ca, R({}, q, (g = ee.popper) != null ? g : j.popper, {
    className: Se(Lr.popper, q == null ? void 0 : q.className, (p = (h = ee.popper) != null ? h : j.popper) == null ? void 0 : p.className)
  }), pn), Il = wn(pa, R({}, ne, (d = ee.transition) != null ? d : j.transition), pn), Ml = wn(ua, R({}, (b = ee.tooltip) != null ? b : j.tooltip, {
    className: Se(Lr.tooltip, (w = (P = ee.tooltip) != null ? P : j.tooltip) == null ? void 0 : w.className)
  }), pn), Al = wn(da, R({}, (x = ee.arrow) != null ? x : j.arrow, {
    className: Se(Lr.arrow, (E = (y = ee.arrow) != null ? y : j.arrow) == null ? void 0 : E.className)
  }), pn);
  return /* @__PURE__ */ A(T.Fragment, {
    children: [/* @__PURE__ */ T.cloneElement(se, ze), /* @__PURE__ */ m(ca, R({
      as: J ?? js,
      placement: K,
      anchorEl: Y ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ A(ua, R({}, Ml, {
          children: [ie, C ? /* @__PURE__ */ m(da, R({}, Al, {
            ref: rt
          })) : null]
        }))
      }))
...
const mh = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], hh = (e) => {
  ...
  const r = dt({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = r, p = he(r, mh), h = /* @__PURE__ */ T.isValidElement(o) && o.type === "svg", d = R({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
function Us(e) {
  const {
    ...
    mc,
    {
      ...
      onClick: t,
      id: d,
      children: n ? /* @__PURE__ */ A(jt, { children: [
        li(a, n, !0),
  ...
  return r ? /* @__PURE__ */ m(uh, { title: r, placement: "right", children: /* @__PURE__ */ m("div", { children: w }) }) : w;
}
function Hs(e) {
...
function Th(e) {
  const [t, n] = fe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = e, i = (u) => {
    ...
    let u = Hs(a).filter((f) => "menuItem" in f.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return u = u.filter(
      (f) => "menuItem" in f.group && f.group.menuItem === r.id
    ), /* @__PURE__ */ m(Ko, { ...e, includedGroups: u });
  };
...
yt("MuiList", ["root", "padding", "dense", "subheader"]);
...
const qs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const d = (x) => {
    const E = p.current, y = x.key, N = Oe(E).activeElement;
    if (y === "ArrowDown")
      x.preventDefault(), gn(E, N, u, c, Qr);
    else if (y === "ArrowUp")
      x.preventDefault(), gn(E, N, u, c, ci);
    else if (y === "Home")
      x.preventDefault(), gn(E, null, u, c, Qr);
    else if (y === "End")
      x.preventDefault(), gn(E, null, u, c, ci);
    else if (y.length === 1) {
      ...
      const j = N && !C.repeating && Xs(N, C);
      C.previousKeyMatched && (j || gn(E, N, !1, c, Qr, C)) ? x.preventDefault() : C.previousKeyMatched = !1;
    }
    f && f(x);
  }, b = Ge(p, n);
  let w = -1;
  T.Children.forEach(i, (x, E) => {
    ...
    process.env.NODE_ENV !== "production" && pr.isFragment(x) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
...
const Dh = qs, Bh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], jh = {
  ...
  const r = Hn(), o = {
    ...
    timeout: w = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: P = As
  } = t, x = he(t, Bh), E = T.useRef(null), y = Ge(E, l.ref, n), N = (z) => (B) => {
    if (z) {
      const M = E.current;
      B === void 0 ? z(M) : z(M, B);
    }
  ...
  return /* @__PURE__ */ m(P, R({
    ...
    children: (z, B) => /* @__PURE__ */ T.cloneElement(l, R({
      style: R({
        opacity: 0,
...
const Fh = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], zh = (e) => {
  ...
  const i = dt({
    ...
    component: u,
    invisible: g
  }), E = zh(x), y = (r = h.root) != null ? r : v.root;
  return /* @__PURE__ */ m(b, R({
    in: p,
    timeout: w
  }, P, {
    children: /* @__PURE__ */ m(Uh, R({
      ...
      ownerState: R({}, x, y == null ? void 0 : y.ownerState),
      classes: E,
      ref: n,
      children: l
    }))
...
const Wh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Xh = (e) => {
  ...
  const J = (r = (o = z == null ? void 0 : z.root) != null ? o : w.Root) != null ? r : qh, q = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : w.Backdrop) != null ? a : f, ee = (l = $ == null ? void 0 : $.root) != null ? l : P.root, te = (c = $ == null ? void 0 : $.backdrop) != null ? c : P.backdrop, ie = At({
    elementType: J,
  ...
  return !j && !S && (!Z || H) ? null : /* @__PURE__ */ m(In, {
    ref: O,
    container: d,
    disablePortal: N,
    children: /* @__PURE__ */ A(J, R({}, ie, {
      children: [!D && f ? /* @__PURE__ */ m(q, R({}, V)) : null, /* @__PURE__ */ m(dr, {
        disableEnforceFocus: E,
        disableAutoFocus: x,
        disableRestoreFocus: C,
        isEnabled: L,
...
const ig = (e) => {
  ...
  } = i, j = he(i.TransitionProps, rg), k = he(i, og), S = (r = E == null ? void 0 : E.paper) != null ? r : P, $ = T.useRef(), z = Ge($, S.ref), B = R({}, i, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: d,
    marginThreshold: b,
...
`));
    ...
    return {
      top: se.top + pi(se, u.vertical),
      left: se.left + ui(se, u.horizontal)
    };
  }, [c, u.horizontal, u.vertical, f, v]), Q = T.useCallback((ne) => ({
    ...
    const Et = Pe + I.height, $e = Ee + I.width, rt = Zt(rr(c)), Be = rt.innerHeight - b, ot = rt.innerWidth - b;
    if (b !== null && Pe < b) {
      const Ne = Pe - b;
      Pe -= Ne, se.vertical += Ne;
    } else if (b !== null && Et > Be) {
      const Ne = Et - Be;
      Pe -= Ne, se.vertical += Ne;
    }
...
`)), b !== null && Ee < b) {
  ...
  }, [c, v, U, Q, b]), [O, L] = T.useState(w), H = T.useCallback(() => {
    const ne = $.current;
    if (!ne)
      return;
    const I = Y(ne);
    I.top !== null && (ne.style.top = I.top), I.left !== null && (ne.style.left = I.left), ne.style.transformOrigin = I.transformOrigin, L(!0);
  }, [Y]);
  ...
  const K = h || (c ? Oe(rr(c)).body : void 0), J = (o = x == null ? void 0 : x.root) != null ? o : sg, q = (a = x == null ? void 0 : x.paper) != null ? a : Qs, ee = At({
    elementType: q,
  ...
  return /* @__PURE__ */ m(J, R({}, V, !fs(J) && {
    slotProps: ie,
    disableScrollLock: D
  }, {
    children: /* @__PURE__ */ m(N, R({
      appear: !0,
      in: w,
      onEntering: Z,
      onExited: W,
...
const pg = ["onEntering"], ug = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], dg = {
  ...
  const a = dt({
    ...
    slots: P = {},
    slotProps: x = {}
  } = a, E = he(a.TransitionProps, pg), y = he(a, ug), N = Hn(), C = N.direction === "rtl", _ = R({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: w
  }), D = mg(_), j = i && !u && g, k = T.useRef(null), S = (Y, O) => {
...
`)), Y.props.disabled || (w === "selectedMenu" && Y.props.selected || z === -1) && (z = O));
  });
  const B = (r = P.paper) != null ? r : gg, M = (o = x.paper) != null ? o : p, U = At({
    elementType: P.root,
...
function Pv({
  ...
  return (((u = n == null ? void 0 : n.items) == null ? void 0 : u.length) ?? 0) === 0 || !r ? r : /* @__PURE__ */ A(
    "div",
    {
...
function xg({
  ...
  const [w] = yo(
    ...
    Ce(async () => (e == null ? void 0 : e(!0)) ?? n ?? w, [e, n, w, c]),
    n ?? w
  ), x = f && P ? P : w;
  return /* @__PURE__ */ A(jt, { children: [
    /* @__PURE__ */ m(
...
const gt = "scrBook", Eg = "scrRef", St = "source", kg = "details", Tg = "Scripture Reference", Ng = "Scripture Book", nl = "Type", Cg = "Details";
function Sg(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? me.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === gt ? Fr(o.start) : void 0;
      },
...
function _v({
  ...
  const [c, u] = fe([]), [f, v] = fe([{ id: gt, desc: !1 }]), [g, p] = fe(() => e.flatMap((k) => {
    const S = k.source;
    return k.data.map(($) => ({
      ...$,
      source: S
  ...
  }, D = (k, S) => k.getIsGrouped() ? "" : F("banded-row", S % 2 === 0 ? "even" : "odd"), j = (k, S, $) => {
  ...
  return /* @__PURE__ */ A("div", { className: "pr-twp pr-w-full", children: [
    ...
    /* @__PURE__ */ A(wr, { className: "pr-p-0", children: [
      t && /* @__PURE__ */ m(xr, { children: x.getHeaderGroups().map((k) => /* @__PURE__ */ m(vt, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => /* @__PURE__ */ m(Rn, { colSpan: S.colSpan, children: S.isPlaceholder ? void 0 : /* @__PURE__ */ A("div", { children: [
      ...
      /* @__PURE__ */ m(Er, { children: x.getRowModel().rows.map((k, S) => /* @__PURE__ */ m(
        vt,
        {
...
function Dg({ columns: e, tableData: t, onSelectItem: n }) {
  return /* @__PURE__ */ m("div", { className: "pr-overflow-y-auto", children: /* @__PURE__ */ m(up, { columns: e, data: t, onRowClickHandler: (o, a) => {
...
`);
  ...
  return a.forEach((u) => {
    u.startsWith("\\id") && (i = 0, l = 0), u.startsWith("\\c") && (i = fi(u), l = 0), u.startsWith("\\v") && (l = fi(u), i === 0 && (i = r.chapterNum));
    const f = n(u, t);
...
function Bg({
  ...
  const i = a["%webView_inventory_occurrences_table_header_reference%"], l = a["%webView_inventory_occurrences_table_header_occurrence%"], [c, u] = fe(
    mi(t, e, n, r)
  );
  return Ye(
    () => u(mi(t, e, n, r)),
    ...
    /* @__PURE__ */ m(xr, { children: /* @__PURE__ */ A(vt, { children: [
      /* @__PURE__ */ m(Rn, { children: i }),
      /* @__PURE__ */ m(Rn, { children: l })
    ] }) }),
    /* @__PURE__ */ m(Er, { children: c.map((f) => /* @__PURE__ */ A(
      vt,
      {
        onClick: () => {
          o(f.reference);
...
function ol({
  ...
  const g = n["%webView_inventory_all%"], p = n["%webView_inventory_approved%"], h = n["%webView_inventory_unapproved%"], d = n["%webView_inventory_unknown%"], b = n["%webView_inventory_scope_book%"], w = n["%webView_inventory_scope_chapter%"], P = n["%webView_inventory_scope_verse%"], x = n["%webView_inventory_filter_text%"], [E, y] = fe([]), [N, C] = fe("all"), [_, D] = fe(""), [j, k] = fe(""), S = (B, M) => {
    y((Y) => {
      let O = [];
      return B.forEach((L) => {
        O = Y.map((H) => H.item === L && H.status !== M ? { ...H, status: M } : H);
      }), O;
    });
    let U = [...o];
    B.forEach((Y) => {
  ...
  Ye(() => {
    c && (console.log("Updating itemData"), y(Lg(c, r, $)));
  }, [r, e, c, $]);
  ...
  return /* @__PURE__ */ A("div", { className: "pr-twp pr-font-sans", children: [
    /* @__PURE__ */ A("div", { className: "pr-flex", children: [
      /* @__PURE__ */ A(lr, { onValueChange: (B) => C(B), defaultValue: N, children: [
        ...
        /* @__PURE__ */ A($n, { className: "pr-font-sans", children: [
          ...
          /* @__PURE__ */ m(Ke, { value: "unknown", children: d })
        ] })
      ] }),
      /* @__PURE__ */ A(lr, { onValueChange: (B) => f(B), defaultValue: u, children: [
        /* @__PURE__ */ m(Pn, { children: /* @__PURE__ */ m(cr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ A($n, { className: "pr-font-sans", children: [
          /* @__PURE__ */ m(Ke, { value: "book", children: b }),
          /* @__PURE__ */ m(Ke, { value: "chapter", children: w }),
    ...
    /* @__PURE__ */ m(
      "div",
      {
        className: `pr-overflow-y-auto pr-rounded-md pr-border ${j !== "" && "pr-max-h-96"}`,
        children: /* @__PURE__ */ m(
          Dg,
          {
            columns: v(S),
    ...
    j !== "" && /* @__PURE__ */ m("div", { className: "pr-mt-4 pr-rounded-md pr-border", children: /* @__PURE__ */ m(
      Bg,
      {
        selectedItem: j,
        text: c,
...
const $t = (e) => e === "asc" ? /* @__PURE__ */ m(tc, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ m(nc, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ m(rc, { className: "pr-ml-2 pr-h-4 pr-w-4" }), Vg = (e, t, n, r, o) => [
  {
    accessorKey: "item",
    header: ({ column: a }) => /* @__PURE__ */ A(ge, { onClick: () => a.toggleSorting(void 0), children: [
      e,
      $t(a.getIsSorted())
    ] })
  },
  ...
  },
  {
    ...
    header: ({ column: a, table: i }) => {
      ...
      return l.forEach((u) => {
        ...
        /* @__PURE__ */ m("div", { className: "pr-flex pr-justify-center", children: /* @__PURE__ */ A(ge, { onClick: () => a.toggleSorting(void 0), children: [
          r,
          $t(a.getIsSorted())
        ] }) }),
        /* @__PURE__ */ A("div", { className: "pr-flex pr-justify-center", children: [
          /* @__PURE__ */ m(ge, { children: /* @__PURE__ */ m(
            ar,
            {
...
function Vv({
  ...
  return /* @__PURE__ */ m("div", { className: "pr-twp", children: /* @__PURE__ */ m(
    ol,
    {
      scriptureReference: e,
      setScriptureReference: t,
...
const zg = (e, t, n, r) => [
  {
    accessorKey: "item",
    header: ({ column: o }) => /* @__PURE__ */ A(ge, { onClick: () => o.toggleSorting(void 0), children: [
      e,
      $t(o.getIsSorted())
    ] })
  },
  ...
  },
  {
    ...
    header: ({ column: o, table: a }) => {
      ...
      return i.forEach((c) => {
        ...
        /* @__PURE__ */ m("div", { className: "pr-flex pr-justify-center", children: /* @__PURE__ */ A(ge, { onClick: () => o.toggleSorting(void 0), children: [
          n,
          $t(o.getIsSorted())
        ] }) }),
        /* @__PURE__ */ A("div", { className: "pr-flex pr-justify-center", children: [
...
function Fv({
  ...
  return /* @__PURE__ */ m("div", { className: "pr-twp pr-font-sans", children: /* @__PURE__ */ m(
    ol,
    {
      scriptureReference: e,
      setScriptureReference: t,
...
function zv({
  ...
  return /* @__PURE__ */ m(
    ge,
    {
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ m(ko, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ A(jt, { children: [
        /* @__PURE__ */ m(oc, { size: 25, className: "pr-h-4 pr-w-4" }),
        n
      ] })
    }
  );
}
function Uv({ isRemoving: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    ge,
    {
      className: F(
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ A(jt, { children: [
        /* @__PURE__ */ m(ko, { size: 15, className: "pr-mr-1 pr-animate-spin pr-text-black" }),
        "Removing..."
      ] }) : "Remove"
    }
  );
...
function Hv({ isUpdating: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    ge,
    {
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ A(jt, { children: [
        /* @__PURE__ */ m(ko, { size: 15, className: "pr-mr-1 pr-animate-spin pr-text-white" }),
        "Updating..."
      ] }) : "Update"
    }
  );
...
function vi(e, t) {
  ...
  return { t(i, l, c) {
    ...
    const u = n ? +i[2] : void 0, f = i[0].replace(qg, `
`).match(o);
    let v = !1;
    return { p: f.map(function(g, p) {
      const h = a.exec(g)[0].length, d = new RegExp("^ {1," + h + "}", "gm"), b = g.replace(d, "").replace(a, ""), w = p === f.length - 1, P = b.indexOf(`

`) !== -1 || w && v;
      v = P;
      const x = c._, E = c.o;
      let y;
      c.o = !0, P ? (c._ = !1, y = b.replace(bi, `
...
var ae;
function Wb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Lb, t.namedCodesToUnicode = t.namedCodesToUnicode ? Rt({}, gi, t.namedCodesToUnicode) : gi;
  const n = t.createElement || T.createElement;
  function r(p, h, ...d) {
    const b = ro(t.overrides, `${p}.props`, {});
    return n(function(w, P) {
      const x = ro(P, w);
      return x ? typeof x == "function" || typeof x == "object" && "render" in x ? x : ro(P, `${w}.component`, w) : w;
    }(p, t.overrides), Rt({}, h, b, { className: Gb(h == null ? void 0 : h.className, b.className) || void 0 }), ...d);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = gb.test(p) === !1);
    const d = f(u(h ? p : `${p.trimEnd().replace(Pb, "")}
...
`, { _: h }));
  ...
  function a(p) {
    const h = p.match(Wg);
    return h ? h.reduce(function(d, b, w) {
      const P = b.indexOf("=");
      if (P !== -1) {
        const x = function(C) {
        ...
        }(b.slice(P + 1).trim()), y = hi[x] || x, N = d[y] = function(C, _) {
          return C === "style" ? _.split(/;\s?/).reduce(function(D, j) {
            const k = j.slice(0, j.indexOf(":"));
            return D[k.replace(/(-[a-z])/g, (S) => S[1].toUpperCase())] = j.slice(k.length + 1).trim(), D;
          }, {}) : C === "href" ? Wt(_) : (_.match(sb) && (_ = _.slice(1, _.length - 1)), _ === "true" || _ !== "false" && _);
        }(x, E);
        typeof N == "string" && (wo.test(N) || xo.test(N)) && (d[y] = T.cloneElement(o(N.trim()), { key: w }));
      } else
        b !== "style" && (d[hi[b] || b] = !0);
      return d;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: it(al), i: ae.HIGH, l: (p, h, d) => ({ v: h(p[0].replace(Yg, ""), d) }), h: (p, h, d) => r("blockquote", { key: d.k }, h(p.v, d)) }, breakLine: { t: bn(Kg), i: ae.HIGH, l: to, h: (p, h, d) => r("br", { key: d.k }) }, breakThematic: { t: it(Jg), i: ae.HIGH, l: to, h: (p, h, d) => r("hr", { key: d.k }) }, codeBlock: { t: it(sl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, d) => r("pre", { key: d.k }, r("code", Rt({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(il), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: ht(Zg), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, d) => r("code", { key: d.k }, p.v) }, footnote: { t: it(tb), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: no }, footnoteReference: { t: mt(nb), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, d) => r("a", { key: d.k, href: Wt(p.B) }, r("sup", { key: d.k }, p.v)) }, gfmTask: { t: mt(ob), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, d) => r("input", { checked: p.R, key: d.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? cl : ll), i: ae.HIGH, l: (p, h, d) => ({ v: or(h, p[2], d), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, d) => r(`h${p.C}`, { id: p.T, key: d.k }, h(p.v, d)) }, headingSetext: { t: it(pl), i: ae.MAX, l: (p, h, d) => ({ v: or(h, p[1], d), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: bn(ul), i: ae.HIGH, l: () => ({}), h: no }, image: { t: ht(Bb), i: ae.HIGH, l: (p) => ({ D: p[1], B: xi(p[2]), F: p[3] }), h: (p, h, d) => r("img", { key: d.k, alt: p.D || void 0, title: p.F || void 0, src: Wt(p.B) }) }, link: { t: mt(Db), i: ae.LOW, l: (p, h, d) => ({ v: Ub(h, p[1], d), B: xi(p[2]), F: p[3] }), h: (p, h, d) => r("a", { key: d.k, href: Wt(p.B), title: p.F }, h(p.v, d)) }, linkAngleBraceStyleDetector: { t: mt(pb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : mt(lb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: mt(cb), i: ae.MAX, l(p) {
    let h = p[1], d = p[1];
    return Xg.test(d) || (d = "mailto:" + d), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: d, type: "link" };
  } }, orderedList: vi(r, 1), unorderedList: vi(r, 2), newlineCoalescer: { t: it(Qg), i: ae.LOW, l: to, h: () => `
` }, paragraph: { t: zb, i: ae.LOW, l: eo, h: (p, h, d) => r("p", { key: d.k }, h(p.v, d)) }, ref: { t: mt(db), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: no }, refImage: { t: ht(fb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, d) => r("img", { key: d.k, alt: p.D, src: Wt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: mt(mb), i: ae.MAX, l: (p, h, d) => ({ v: h(p[1], d), Z: h(p[0].replace(hb, "\\$1"), d), P: p[2] }), h: (p, h, d) => l[p.P] ? r("a", { key: d.k, href: Wt(l[p.P].B), title: l[p.P].F }, h(p.v, d)) : r("span", { key: d.k }, h(p.Z, d)) }, table: { t: it(dl), i: ae.HIGH, l: Fb, h: (p, h, d) => r("table", { key: d.k }, r("thead", null, r("tr", null, p.L.map(function(b, w) {
    return r("th", { key: w, style: wi(p, w) }, h(b, d));
  }))), r("tbody", null, p.A.map(function(b, w) {
    return r("tr", { key: w }, b.map(function(P, x) {
      return r("td", { key: x, style: wi(p, x) }, h(P, d));
    }));
  }))) }, tableSeparator: { t: function(p, h) {
    return h.$ ? (h._ = !0, vb.exec(p)) : null;
  }, i: ae.HIGH, l: function() {
    return { type: "tableSeparator" };
  }, h: () => " | " }, text: { t: bn(Rb), i: ae.MIN, l: (p) => ({ v: p[0].replace(ab, (h, d) => t.namedCodesToUnicode[d] ? t.namedCodesToUnicode[d] : h) }), h: (p) => p.v }, textBolded: { t: ht(Tb), i: ae.MED, l: (p, h, d) => ({ v: h(p[2], d) }), h: (p, h, d) => r("strong", { key: d.k }, h(p.v, d)) }, textEmphasized: { t: ht(Nb), i: ae.LOW, l: (p, h, d) => ({ v: h(p[2], d) }), h: (p, h, d) => r("em", { key: d.k }, h(p.v, d)) }, textEscaped: { t: ht(Ob), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: ht(Cb), i: ae.LOW, l: eo, h: (p, h, d) => r("mark", { key: d.k }, h(p.v, d)) }, textStrikethroughed: { t: ht(Sb), i: ae.LOW, l: eo, h: (p, h, d) => r("del", { key: d.k }, h(p.v, d)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: bn(wo), i: ae.HIGH, l(p, h, d) {
    const [, b] = p[3].match($b), w = new RegExp(`^${b}`, "gm"), P = p[3].replace(w, ""), x = (E = P, jb.some((_) => _.test(E)) ? Hb : or);
    var E;
    const y = p[1].toLowerCase(), N = Gg.indexOf(y) !== -1;
    d.N = d.N || y === "a";
    const C = N ? p[3] : x(h, P, d);
    return d.N = !1, { O: a(p[2]), v: C, G: N, H: N ? y : p[1] };
  }, h: (p, h, d) => r(p.H, Rt({ key: d.k }, p.O), p.G ? p.v : h(p.v, d)) }, c.htmlSelfClosing = { t: bn(xo), i: ae.HIGH, l: (p) => ({ O: a(p[2] || ""), H: p[1] }), h: (p, h, d) => r(p.H, Rt({}, p.O, { key: d.k })) });
  const u = function(p) {
    let h = Object.keys(p);
    function d(b, w) {
      let P = [], x = "";
      for (; b; ) {
        let E = 0;
        for (; E < h.length; ) {
          const y = h[E], N = p[y], C = N.t(b, w, x);
          if (C) {
            const _ = C[0];
            b = b.substring(_.length);
            const D = N.l(C, d, w);
            D.type == null && (D.type = y), P.push(D), x = _;
            break;
          }
          E++;
        }
...
av.displayName = io.Root.displayName;
function iv(e, t = "top") {
