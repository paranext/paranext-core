import il, { jsx as i, jsxs as y, Fragment as le } from "react/jsx-runtime";
...
import { useReactTable as wi, getCoreRowModel as fi, getPaginationRowModel as Ll, getSortedRowModel as mi, getFilteredRowModel as Fl, flexRender as fn, getExpandedRowModel as Ul, getGroupedRowModel as Gl } from "@tanstack/react-table";
...
const St = class at {
  ...
  parse(e) {
    ...
    if (r.length !== 2 || it.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !at.isVerseParseable(r[1]))
      throw new on("Invalid reference : " + e);
...
const xn = mt.Root, nr = mt.Trigger, bc = mt.Group, dh = mt.Portal, uh = mt.Sub, ph = mt.RadioGroup, vc = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ y(
  mt.SubTrigger,
  {
    ref: o,
    className: N(
...
function wh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = st(""), [o, a] = st(
    ...
    it.bookNumberToId(t.bookNum)
  ), [u, f] = st(!1), [w, g] = st(u), b = ve(void 0), m = ve(void 0), h = ve(void 0), k = Et(
    (E) => Oc(E).filter((B) => {
      const D = it.bookIdToEnglishName(B).toLowerCase(), Q = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (E, B, D, Q) => {
      if (l(
        it.bookNumberToId(t.bookNum) !== E ? 1 : t.chapterNum
      ), B || an(E) === -1) {
        e({
          bookNum: it.bookIdToNumber(E),
          chapterNum: D || 1,
          verseNum: Q || 1
        }), f(!1), r("");
        return;
    ...
    (E) => {
      ...
      // eslint-disable-next-line no-null/no-null
      m.current !== null && m.current.focus(), E.preventDefault()) : f(!0);
    },
    [u]
  ), _ = (E) => {
    const { key: B } = E;
    ...
    if (c === o) {
      ...
      s + D <= 0 || s + D > an(c) ? l(0) : D !== 0 && (l(s + D), E.preventDefault());
    }
  };
  return Kt(() => {
    o === c ? o === it.bookNumberToId(t.bookNum) ? l(t.chapterNum) : l(1) : l(0);
    ...
    const E = setTimeout(() => {
      if (w && m.current && h.current) {
        ...
        m.current.scrollTo({ top: D, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(E);
    };
  }, [w]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ y(xn, { modal: !1, open: u, onOpenChange: T, children: [
    /* @__PURE__ */ i(nr, { asChild: !0, children: /* @__PURE__ */ i(
      ac,
      {
        ...
        handleKeyDown: W,
        handleOnClick: () => {
          a(it.bookNumberToId(t.bookNum)), d(it.bookNumberToId(t.bookNum)), l(t.chapterNum > 0 ? t.chapterNum : 0), f(!0), b.current.focus();
        },
        onFocus: () => {
          O.current = !0;
        },
              ...
              k(E).map((D) => /* @__PURE__ */ i("div", { children: /* @__PURE__ */ i(
                Nc,
                {
                  ...
                  children: /* @__PURE__ */ i(
                    kc,
                    {
                      handleSelectChapter: A,
                      endChapter: an(D),
                      activeChapter: t.bookNum === it.bookIdToNumber(D) ? t.chapterNum : 0,
...
const $c = Je(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? Ke : "button", { className: N($c({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const Ic = Je(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Mt = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(pi.Root, { ref: n, className: N("pr-twp", Ic(), t), ...e }));
...
jc.displayName = Rt.Separator.displayName;
const To = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Rt.Item,
  {
    ref: n,
...
function or({
  ...
  const [k, M] = st(!1);
  return /* @__PURE__ */ y(Ri, { open: k, onOpenChange: M, ...h, children: [
    ...
    /* @__PURE__ */ i(
      yo,
      {
        ...
        children: /* @__PURE__ */ y(xo, { children: [
          ...
          /* @__PURE__ */ i(ko, { children: e.map((O) => /* @__PURE__ */ y(
            To,
            {
              value: l(O),
              onSelect: () => {
...
function mh({
  ...
  const u = Dr(d, "%webView_bookSelector_currentBook%"), f = Dr(d, "%webView_bookSelector_choose%"), w = Dr(d, "%webView_bookSelector_chooseBooks%"), [g, b] = st(
    "current book"
    /* CURRENT_BOOK */
  ), m = (h) => {
    b(h), t(h);
      ...
      children: /* @__PURE__ */ y("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ y("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Mt, { className: "tw-ml-1", children: u })
          ] }),
        ...
        /* @__PURE__ */ y("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Mt, { className: "tw-ml-1", children: w })
          ] }),
          /* @__PURE__ */ i(Mt, { className: "tw-flex tw-items-center", children: r.map((h) => it.bookIdToEnglishName(h)).join(", ") }),
          /* @__PURE__ */ i(
            wt,
            {
...
function Fc({ table: t }) {
  return /* @__PURE__ */ y(xn, { children: [
    ...
    /* @__PURE__ */ y(Le, { align: "end", className: "tw-w-[150px]", children: [
...
const Nn = vt.Root, Uc = vt.Group, kn = vt.Value, Fe = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  vt.Trigger,
  {
    ref: r,
    className: N(
...
const Ue = S.forwardRef(({ className: t, children: e, position: n = "popper", ...r }, o) => /* @__PURE__ */ i(vt.Portal, { children: /* @__PURE__ */ y(
  vt.Content,
  {
    ref: o,
    className: N(
...
const Xt = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  vt.Item,
  {
    ref: r,
    className: N(
...
Xt.displayName = vt.Item.displayName;
      ...
      /* @__PURE__ */ y(
        Nn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ i(Ue, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ i(Xt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function qc({
  ...
  var h;
  const [l, c] = st([]), [d, u] = st([]), [f, w] = st({}), [g, b] = st({}), m = wi({
    data: e,
    columns: t,
    getCoreRowModel: fi(),
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ i(Fc, { table: m }),
    /* @__PURE__ */ y($n, { stickyHeader: a, children: [
      /* @__PURE__ */ i(In, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ i(Wt, { children: k.headers.map((M) => /* @__PURE__ */ i(jt, { children: M.isPlaceholder ? void 0 : fn(M.column.columnDef.header, M.getContext()) }, M.id)) }, k.id)) }),
      /* @__PURE__ */ i(An, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        Wt,
        {
          onClick: () => s(k, m),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((M) => /* @__PURE__ */ i(It, { children: fn(M.column.columnDef.cell, M.getContext()) }, M.id))
        },
        k.id
...
}, Qc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Mi = Je(
...
const fr = (t) => t === "asc" ? /* @__PURE__ */ i(vl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(yl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), hh = (t) => ({
  accessorKey: "item",
  ...
  return Jc(t).forEach((u) => {
    ...
    for (; f; ) {
      ...
      const g = f.index, b = a.find((h) => ho(h.items, w)), m = {
        reference: {
...
function yh({
  ...
  const f = ee(n, "%webView_inventory_all%"), w = ee(n, "%webView_inventory_approved%"), g = ee(n, "%webView_inventory_unapproved%"), b = ee(n, "%webView_inventory_unknown%"), m = ee(n, "%webView_inventory_scope_currentBook%"), h = ee(n, "%webView_inventory_scope_chapter%"), k = ee(n, "%webView_inventory_scope_verse%"), M = ee(n, "%webView_inventory_filter_text%"), O = ee(
    n,
    "%webView_inventory_show_additional_items%"
  ), [T, v] = st(!1), [A, U] = st("all"), [W, _] = st(""), [$, E] = st([]), B = Nt(() => l ? r instanceof RegExp ? rd(
    l,
    t,
    a,
    s,
    ...
    for (let F = 0; F < x; F++)
      P.push(
        ed(
          ((G = o == null ? void 0 : o.tableHeaders) == null ? void 0 : G[F]) || "Additional Item",
          F + 1
        )
      );
    return [...P, ...u];
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ y("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Nn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ y(Ue, { children: [
              /* @__PURE__ */ i(Xt, { value: "all", children: f }),
              /* @__PURE__ */ i(Xt, { value: "approved", children: w }),
              /* @__PURE__ */ i(Xt, { value: "unapproved", children: g }),
              /* @__PURE__ */ i(Xt, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ y(Nn, { onValueChange: (x) => tt(x), defaultValue: c, children: [
        /* @__PURE__ */ i(Fe, { className: "tw-m-1", children: /* @__PURE__ */ i(kn, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ y(Ue, { children: [
          /* @__PURE__ */ i(Xt, { value: "book", children: m }),
          /* @__PURE__ */ i(Xt, { value: "chapter", children: h }),
          /* @__PURE__ */ i(Xt, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ i(
        Se,
      ...
      o && /* @__PURE__ */ y("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ i(Mt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? O })
      ] })
    ] }),
...
function xh({
  ...
  const [d, u] = st(!1), f = Et(
    ...
    const b = t.filter((h) => h.starred).sort((h, k) => h.label.localeCompare(k.label)), m = t.filter((h) => !h.starred).sort((h, k) => {
      const M = n.includes(h.value), O = n.includes(k.value);
      return M && !O ? -1 : !M && O ? 1 : h.label.localeCompare(k.label);
    });
    return [...b, ...m];
  }, [t, n, l]);
        ...
        children: [
          /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ i(
              ...
              {
                className: N(
                  (n.length === 0 || n.length === t.length) && "tw-text-muted"
                ),
                children: w()
              }
            )
          ...
          return /* @__PURE__ */ y(
            To,
            {
              ...
              children: [
                ...
                e && /* @__PURE__ */ i("div", { className: "tw-w-10 tw-text-right tw-text-muted-foreground", children: m })
              ]
            },
            b.value
          );
...
const Gi = S.forwardRef(
  ({
    ...
    const [c, d] = S.useState(t), u = e ?? c, f = S.useCallback(
      (m) => {
        const h = typeof m == "function" ? m(u) : m;
        n ? n(h) : d(h);
      },
      [n, u]
    ), w = S.useCallback(() => f((m) => !m), [f]), g = u ? "expanded" : "collapsed", b = S.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: f,
...
const ie = "scrBook", Td = "scrRef", me = "source", Sd = "details", Cd = "Scripture Reference", Od = "Scripture Book", Ji = "Type", Rd = "Details";
function _d(t, e) {
  const n = e ?? !1;
  return [
    {
...
function Eh({
  ...
  const [d, u] = st([]), [f, w] = st([{ id: ie, desc: !1 }]), [g, b] = st({}), m = Nt(
  ...
  Kt(() => {
    if (l) {
      ...
      if ($.length === 1) {
        const E = m.find((B) => ga(B) === $[0]) || void 0;
        E && l(E);
      }
    }
  }, [g, m, l, k]);
  const M = o ?? Od, O = a ?? Ji, T = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${M}`, value: [ie] },
    { label: `Group by ${O}`, value: [me] },
    {
      label: `Group by ${M} and ${O}`,
      value: [ie, me]
    },
    {
      label: `Group by ${O} and ${M}`,
      value: [me, ie]
    }
  ], v = (_) => {
    u(JSON.parse(_));
  ...
  }, U = (_, $) => _.getIsGrouped() ? "" : N("banded-row", $ % 2 === 0 ? "even" : "odd"), W = (_, $, E) => {
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ y(
      Nn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ue, { position: "item-aligned", children: /* @__PURE__ */ i(Uc, { children: T.map((_) => /* @__PURE__ */ i(Xt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ y($n, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(In, { children: k.getHeaderGroups().map((_) => /* @__PURE__ */ i(Wt, { children: _.headers.filter(($) => $.column.columnDef.header).map(($) => (
        ...
        /* @__PURE__ */ i(jt, { colSpan: $.colSpan, className: "top-0 tw-sticky", children: $.isPlaceholder ? void 0 : /* @__PURE__ */ y("div", { children: [
                ...
                It,
                {
                  ...
                  children: (() => E.getIsGrouped() ? /* @__PURE__ */ y(
                    wt,
                    {
                      ...
                      type: "button",
                      children: [
                        _.getIsExpanded() && /* @__PURE__ */ i(ze, {}),
                        !_.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ i(ci, {}) : /* @__PURE__ */ i(El, {})),
                        " ",
                        fn(E.column.columnDef.cell, E.getContext()),
                        " (",
                        _.subRows.length,
                        ")"
                      ]
    ...
    Nn,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ i(
          ...
          {
            style: { zIndex: 250 },
            children: t.map((a) => /* @__PURE__ */ i(Xt, { value: `${a}`, children: o[pt(a)] }, `${a}`))
          }
        )
      ]
    }
...
function Md() {
  ...
  return lt.AsyncMode = c, lt.ConcurrentMode = d, lt.ContextConsumer = l, lt.ContextProvider = s, lt.Element = e, lt.ForwardRef = u, lt.Fragment = r, lt.Lazy = b, lt.Memo = g, lt.Portal = n, lt.Profiler = a, lt.StrictMode = o, lt.Suspense = f, lt.isAsyncMode = function(v) {
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === a || v === o || v === f || v === w || typeof v == "object" && v !== null && (v.$$typeof === b || v.$$typeof === g || v.$$typeof === s || v.$$typeof === l || v.$$typeof === u || v.$$typeof === h || v.$$typeof === k || v.$$typeof === M || v.$$typeof === m);
  }, lt.typeOf = O, lt;
}
var ct = {};
/** @license React v16.13.1
...
function Dd() {
  return va || (va = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function O(C) {
      ...
      C === r || C === d || C === a || C === o || C === f || C === w || typeof C == "object" && C !== null && (C.$$typeof === b || C.$$typeof === g || C.$$typeof === s || C.$$typeof === l || C.$$typeof === u || C.$$typeof === h || C.$$typeof === k || C.$$typeof === M || C.$$typeof === m);
    }
    function T(C) {
    ...
    var v = c, A = d, U = l, W = s, _ = e, $ = u, E = r, B = b, D = g, Q = n, J = a, X = o, tt = f, rt = !1;
    function ot(C) {
      return rt || (rt = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), x(C) || T(C) === c;
    }
    function x(C) {
      return T(C) === d;
    }
    ...
    ct.AsyncMode = v, ct.ConcurrentMode = A, ct.ContextConsumer = U, ct.ContextProvider = W, ct.Element = _, ct.ForwardRef = $, ct.Fragment = E, ct.Lazy = B, ct.Memo = D, ct.Portal = Q, ct.Profiler = J, ct.StrictMode = X, ct.Suspense = tt, ct.isAsyncMode = ot, ct.isConcurrentMode = x, ct.isContextConsumer = P, ct.isContextProvider = H, ct.isElement = G, ct.isForwardRef = F, ct.isFragment = q, ct.isLazy = z, ct.isMemo = K, ct.isPortal = Y, ct.isProfiler = Z, ct.isStrictMode = R, ct.isSuspense = L, ct.isValidElementType = O, ct.typeOf = T;
  }()), ct;
}
var ya;
function ts() {
  ...
  return Gr = function(l, c) {
    ...
    function h(x) {
      ...
      function G(q, z, K, Y, Z, R, L) {
        ...
        return z[K] == null ? q ? z[K] === null ? new m("The " + Z + " `" + R + "` is marked as required " + ("in `" + Y + "`, but its value is `null`.")) : new m("The " + Z + " `" + R + "` is marked as required in " + ("`" + Y + "`, but its value is `undefined`.")) : null : x(z, K, Y, Z, R);
      }
      var F = G.bind(null, !1);
      return F.isRequired = G.bind(null, !0), F;
    }
    function k(x) {
      function P(H, G, F, q, z, K) {
        var Y = H[G], Z = X(Y);
        if (Z !== x) {
          var R = tt(Y);
          return new m(
            "Invalid " + q + " `" + z + "` of type " + ("`" + R + "` supplied to `" + F + "`, expected ") + ("`" + x + "`."),
            { expectedType: x }
          );
        }
        return null;
    ...
    function O(x) {
      function P(H, G, F, q, z) {
        if (typeof x != "function")
          return new m("Property `" + z + "` of component `" + F + "` has invalid PropType notation inside arrayOf.");
        var K = H[G];
        if (!Array.isArray(K)) {
          var Y = X(K);
          return new m("Invalid " + q + " `" + z + "` of type " + ("`" + Y + "` supplied to `" + F + "`, expected an array."));
        }
        for (var Z = 0; Z < K.length; Z++) {
          var R = x(K, Z, F, q, z + "[" + Z + "]", n);
    ...
    function T() {
      function x(P, H, G, F, q) {
        var z = P[H];
        if (!l(z)) {
          var K = X(z);
          return new m("Invalid " + F + " `" + q + "` of type " + ("`" + K + "` supplied to `" + G + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(x);
    ...
    function v() {
      function x(P, H, G, F, q) {
        ...
        if (!t.isValidElementType(z)) {
          var K = X(z);
          return new m("Invalid " + F + " `" + q + "` of type " + ("`" + K + "` supplied to `" + G + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(x);
    ...
    function A(x) {
      function P(H, G, F, q, z) {
        if (!(H[G] instanceof x)) {
          var K = x.name || w, Y = ot(H[G]);
          return new m("Invalid " + q + " `" + z + "` of type " + ("`" + Y + "` supplied to `" + F + "`, expected ") + ("instance of `" + K + "`."));
        }
        return null;
      }
      return h(P);
    ...
    function U(x) {
      ...
      function P(H, G, F, q, z) {
        for (var K = H[G], Y = 0; Y < x.length; Y++)
          if (b(K, x[Y]))
            return null;
        var Z = JSON.stringify(x, function(L, C) {
          var ft = tt(C);
          return ft === "symbol" ? String(C) : C;
        });
        return new m("Invalid " + q + " `" + z + "` of value `" + String(K) + "` " + ("supplied to `" + F + "`, expected one of " + Z + "."));
      }
      return h(P);
    }
    function W(x) {
      function P(H, G, F, q, z) {
        ...
        var K = H[G], Y = X(K);
        if (Y !== "object")
          return new m("Invalid " + q + " `" + z + "` of type " + ("`" + Y + "` supplied to `" + F + "`, expected an object."));
        for (var Z in K)
          if (r(K, Z)) {
            var R = x(K, Z, F, q, z + "." + Z, n);
            if (R instanceof Error)
    ...
    function _(x) {
      ...
      function G(F, q, z, K, Y) {
        for (var Z = [], R = 0; R < x.length; R++) {
          var L = x[R], C = L(F, q, z, K, Y, n);
          if (C == null)
            return null;
          C.data && r(C.data, "expectedType") && Z.push(C.data.expectedType);
        }
        var ft = Z.length > 0 ? ", expected one of type [" + Z.join(", ") + "]" : "";
        return new m("Invalid " + K + " `" + Y + "` supplied to " + ("`" + z + "`" + ft + "."));
      }
      return h(G);
    }
    function $() {
      function x(P, H, G, F, q) {
        return Q(P[H]) ? null : new m("Invalid " + F + " `" + q + "` supplied to " + ("`" + G + "`, expected a ReactNode."));
      }
      return h(x);
    }
    function E(x, P, H, G, F) {
      return new m(
        (x || "React class") + ": " + P + " type `" + H + "." + G + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + F + "`."
      );
    }
    function B(x) {
      function P(H, G, F, q, z) {
        var K = H[G], Y = X(K);
        if (Y !== "object")
          return new m("Invalid " + q + " `" + z + "` of type `" + Y + "` " + ("supplied to `" + F + "`, expected `object`."));
        for (var Z in x) {
          var R = x[Z];
          if (typeof R != "function")
            return E(F, q, z, Z, tt(R));
          var L = R(K, Z, F, q, z + "." + Z, n);
          if (L)
            return L;
        }
        return null;
    ...
    function D(x) {
      function P(H, G, F, q, z) {
        ...
        for (var R in Z) {
          var L = x[R];
          if (r(x, R) && typeof L != "function")
            return E(F, q, z, R, tt(L));
          if (!L)
            return new m(
              "Invalid " + q + " `" + z + "` key `" + R + "` supplied to `" + F + "`.\nBad object: " + JSON.stringify(H[G], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(x), null, "  ")
            );
          var C = L(K, R, F, q, z + "." + R, n);
          if (C)
            return C;
        }
        return null;
...
function Wd() {
  return Oa || (Oa = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), b = !1, m = !1, h = !1, k = !1, M = !1, O;
    O = Symbol.for("react.module.reference");
    function T(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || M || V === r || V === d || V === u || k || V === g || b || m || h || typeof V == "object" && V !== null && (V.$$typeof === w || V.$$typeof === f || V.$$typeof === a || V.$$typeof === s || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    var A = s, U = a, W = t, _ = c, $ = n, E = w, B = f, D = e, Q = o, J = r, X = d, tt = u, rt = !1, ot = !1;
    function x(V) {
    ...
    ut.ContextConsumer = A, ut.ContextProvider = U, ut.Element = W, ut.ForwardRef = _, ut.Fragment = $, ut.Lazy = E, ut.Memo = B, ut.Portal = D, ut.Profiler = Q, ut.StrictMode = J, ut.Suspense = X, ut.SuspenseList = tt, ut.isAsyncMode = x, ut.isConcurrentMode = P, ut.isContextConsumer = H, ut.isContextProvider = G, ut.isElement = F, ut.isForwardRef = q, ut.isFragment = z, ut.isLazy = K, ut.isMemo = Y, ut.isPortal = Z, ut.isProfiler = R, ut.isStrictMode = L, ut.isSuspense = C, ut.isSuspenseList = ft, ut.isValidElementType = T, ut.typeOf = v;
  }()), ut;
}
...
const au = typeof window < "u" ? j.useLayoutEffect : j.useEffect, He = au;
let Pa = 0;
function iu(t) {
...
function ms(t, e) {
  const n = fs(t.theme);
  return Object.keys(t).map((r) => Mu(t, e, r, n)).reduce(hn, {});
}
function gt(t) {
  return ms(t, vr);
}
...
const Bu = Ut("border", Vt), ju = Ut("borderTop", Vt), Vu = Ut("borderRight", Vt), zu = Ut("borderBottom", Vt), Lu = Ut("borderLeft", Vt), Fu = Ut("borderColor"), Uu = Ut("borderTopColor"), Gu = Ut("borderRightColor"), Hu = Ut("borderBottomColor"), Xu = Ut("borderLeftColor"), Yu = Ut("outline", Vt), Wu = Ut("outlineColor"), Nr = (t) => {
...
function hp() {
  function t(n, r, o, a) {
    ...
    return f ? f(s) : re(s, r, (b) => {
      let m = sr(w, u, b);
      return b === m && typeof b == "string" && (m = sr(w, u, `${n}${b === "default" ? "" : Zt(b)}`, b)), c === !1 ? m : {
        [c]: m
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const u = Cu(a.breakpoints), f = Object.keys(u);
      let w = u;
...
function Do(t = {}, ...e) {
  ...
  return d.applyStyles = gp, d = e.reduce((u, f) => ne(u, f), d), d.unstable_sxConfig = I({}, Ao, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Mo({
      sx: f,
      theme: this
    });
...
function Op(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    Yl(s, (v) => v.filter((A) => !(A != null && A.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const M = Hl(s, I({
      shouldForwardProp: k,
      label: h
    }, g)), O = (v) => typeof v == "function" && v.__emotion_real !== v || be(v) ? (A) => Qn(v, I({}, A, {
      theme: Yn({
        theme: A.theme,
        defaultTheme: n,
        themeId: e
...
function ja(t) {
  t = Ee(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Ee($p(t)).values : t.values;
...
const Dp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, De = Gp, Hp = ["mode", "contrastThreshold", "tonalOffset"], za = {
...
`));
  ...
  const w = ({
    ...
    if (m = I({}, m), !m.main && m[k] && (m.main = m[k]), !m.hasOwnProperty("main"))
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return La(m, "light", M, r), La(m, "dark", O, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, g = {
    dark: Yr,
    light: za
  };
...
function ew(t, e) {
  ...
  const g = o / 14, b = f || ((k) => `${k / d * g}rem`), m = (k, M, O, T, v) => I({
    fontFamily: r,
    fontWeight: k,
    fontSize: b(M),
...
function uw(t) {
  const e = I({}, lw, t.easing), n = I({}, cw, t.duration);
  return I({
...
`));
  ...
  return d.unstable_sxConfig = I({}, Ao, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Mo({
      sx: f,
      theme: this
    });
...
const yw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], xw = (t) => {
  ...
  const r = zo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, yw), b = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", m = I({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Dw(t) {
  ...
  if (!e) {
    const g = ye(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), b = I({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), m = I({}, n, o, r);
    return g.length > 0 && (m.className = g), Object.keys(b).length > 0 && (m.style = b), {
      props: m,
      internalRef: void 0
    };
  }
  const s = Aw(I({}, o, r)), l = Ya(r), c = Ya(o), d = e(s), u = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = I({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = I({}, d, n, c, l);
...
var Ct = "top", Lt = "bottom", Ft = "right", Ot = "left", Fo = "auto", Vn = [Ct, Lt, Ft, Ot], Xe = "start", Sn = "end", Uw = "clippingParents", Es = "viewport", ln = "popper", Gw = "reference", Wa = /* @__PURE__ */ Vn.reduce(function(t, e) {
  return t.concat([e + "-" + Xe, e + "-" + Sn]);
}, []), Ts = /* @__PURE__ */ [].concat(Vn, [Fo]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Xe, e + "-" + Sn]);
...
function cf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = qt(n.placement), c = Ho(l), d = [Ot, Ft].indexOf(l) >= 0, u = d ? "height" : "width";
  if (!(!a || !s)) {
    var f = lf(o.padding, n), w = Go(a), g = c === "y" ? Ct : Ot, b = c === "y" ? Lt : Ft, m = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], k = zn(a), M = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, O = m / 2 - h / 2, T = f[g], v = M - w[u] - f[b], A = M / 2 - w[u] / 2 + O, U = gn(T, A, v), W = c;
    n.modifiersData[r] = (e = {}, e[W] = U, e.centerOffset = U - A, e);
  }
}
function df(t) {
...
function Ka(t) {
  ...
  g = h.x, m = h.y;
  var k = s.hasOwnProperty("x"), M = s.hasOwnProperty("y"), O = Ot, T = Ct, v = window;
  if (d) {
    var A = zn(n), U = "clientHeight", W = "clientWidth";
    if (A === Dt(n) && (A = de(n), oe(A).position !== "static" && l === "absolute" && (U = "scrollHeight", W = "scrollWidth")), A = A, o === Ct || (o === Ot || o === Ft) && a === Sn) {
      T = Lt;
      var _ = f && A === v && v.visualViewport ? v.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        A[U]
      );
    ...
    if (o === Ot || (o === Ct || o === Lt) && a === Sn) {
      O = Ft;
      var $ = f && A === v && v.visualViewport ? v.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        A[W]
      );
      g -= $ - r.width, g *= c ? 1 : -1;
  ...
  if (g = B.x, m = B.y, c) {
    var D;
    return Object.assign({}, E, (D = {}, D[T] = M ? "0" : "", D[O] = k ? "0" : "", D.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", D));
  }
  return Object.assign({}, E, (e = {}, e[T] = M ? m + "px" : "", e[O] = k ? g + "px" : "", e.transform = "", e));
}
function ff(t) {
...
function Yo(t) {
  return We(de(t)).left + Xo(t).scrollLeft;
}
function yf(t, e) {
...
function Za(t, e, n) {
  return e === Es ? co(yf(t, n)) : Te(e) ? Nf(e, n) : co(xf(de(t)));
}
function kf(t) {
...
function Cn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Uw : l, d = n.rootBoundary, u = d === void 0 ? Es : d, f = n.elementContext, w = f === void 0 ? ln : f, g = n.altBoundary, b = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Rs(typeof h != "number" ? h : _s(h, Vn)), M = w === ln ? Gw : ln, O = t.rects.popper, T = t.elements[b ? M : w], v = Ef(Te(T) ? T : T.contextElement || de(t.elements.popper), c, u, s), A = We(t.elements.reference), U = $s({
    reference: A,
    element: O,
    strategy: "absolute",
    placement: o
  }), W = co(Object.assign({}, O, U)), _ = w === ln ? W : A, $ = {
  ...
  if (w === ln && E) {
    ...
    Object.keys($).forEach(function(D) {
      var Q = [Ft, Lt].indexOf(D) >= 0 ? 1 : -1, J = [Ct, Lt].indexOf(D) >= 0 ? "y" : "x";
      $[D] += B[J] * Q;
    });
  }
  return $;
...
function Tf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ts : c, u = qe(r), f = u ? l ? Wa : Wa.filter(function(b) {
    return qe(b) === u;
  }) : Vn, w = f.filter(function(b) {
...
function Cf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, b = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = qt(h), M = k === h, O = c || (M || !b ? [tr(h)] : Sf(h)), T = [h].concat(O).reduce(function(F, q) {
      return F.concat(qt(q) === Fo ? Tf(e, {
        placement: q,
        boundary: u,
        rootBoundary: f,
        padding: d,
    ...
    }, []), v = e.rects.reference, A = e.rects.popper, U = /* @__PURE__ */ new Map(), W = !0, _ = T[0], $ = 0; $ < T.length; $++) {
      var E = T[$], B = qt(E), D = qe(E) === Xe, Q = [Ct, Lt].indexOf(B) >= 0, J = Q ? "width" : "height", X = Cn(e, {
        placement: E,
        boundary: u,
        rootBoundary: f,
        altBoundary: w,
        padding: d
      }), tt = Q ? D ? Ft : Ot : D ? Lt : Ct;
      v[J] > A[J] && (tt = tr(tt));
      var rt = tr(tt), ot = [];
      if (a && ot.push(X[B] <= 0), l && ot.push(X[tt] <= 0, X[rt] <= 0), ot.every(function(F) {
        return F;
      })) {
        _ = E, W = !1;
        break;
...
function Bf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, b = n.tetherOffset, m = b === void 0 ? 0 : b, h = Cn(e, {
    boundary: c,
    rootBoundary: d,
    padding: f,
    altBoundary: u
  }), k = qt(e.placement), M = qe(e.placement), O = !M, T = Ho(k), v = Df(T), A = e.modifiersData.popperOffsets, U = e.rects.reference, W = e.rects.popper, _ = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, $ = typeof _ == "number" ? {
    mainAxis: _,
    altAxis: _
  ...
  if (A) {
    if (a) {
      var D, Q = T === "y" ? Ct : Ot, J = T === "y" ? Lt : Ft, X = T === "y" ? "height" : "width", tt = A[T], rt = tt + h[Q], ot = tt - h[J], x = g ? -W[X] / 2 : 0, P = M === Xe ? U[X] : W[X], H = M === Xe ? -W[X] : -U[X], G = e.elements.arrow, F = g && G ? Go(G) : {
        width: 0,
        height: 0
      }, q = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Os(), z = q[Q], K = q[J], Y = gn(0, U[X], F[X]), Z = O ? U[X] / 2 - x - Y - z - $.mainAxis : P - Y - z - $.mainAxis, R = O ? -U[X] / 2 + x + Y + K + $.mainAxis : H + Y + K + $.mainAxis, L = e.elements.arrow && zn(e.elements.arrow), C = L ? T === "y" ? L.clientTop || 0 : L.clientLeft || 0 : 0, ft = (D = E == null ? void 0 : E[T]) != null ? D : 0, V = tt + Z - ft - C, xt = tt + R - ft, Gt = gn(g ? cr(rt, V) : rt, tt, g ? xe(ot, xt) : ot);
      A[T] = Gt, B[T] = Gt - tt;
    }
    if (l) {
      var ue, Tt = T === "x" ? Ct : Ot, Ln = T === "x" ? Lt : Ft, Ht = A[v], Oe = v === "y" ? "height" : "width", pe = Ht + h[Tt], Re = Ht - h[Ln], _e = [Ct, Ot].indexOf(k) !== -1, Pe = (ue = E == null ? void 0 : E[v]) != null ? ue : 0, we = _e ? pe : Ht - U[Oe] - W[Oe] - Pe + $.altAxis, Qe = _e ? Ht + U[Oe] + W[Oe] - Pe - $.altAxis : Re, Fn = g && _e ? sf(we, Ht, Qe) : gn(g ? we : pe, Ht, g ? Qe : Re);
      A[v] = Fn, B[v] = Fn - Ht;
    }
    e.modifiersData[r] = B;
  }
...
function Ff(t, e, n) {
  n === void 0 && (n = !1);
  var r = zt(e), o = zt(e) && Lf(e), a = de(e), s = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Wo(a)) && (l = zf(e)), zt(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Yo(a))), {
  ...
  return function(l, c, d) {
    ...
    var u = {
      ...
      setOptions: function(k) {
        var M = typeof k == "function" ? k(u.options) : k;
        m(), u.options = Object.assign({}, a, u.options, M), u.scrollParents = {
          reference: Te(l) ? bn(l) : l.contextElement ? bn(l.contextElement) : [],
          popper: bn(c)
        };
        var O = Gf(Xf([].concat(r, u.options.modifiers)));
        return u.orderedModifiers = O.filter(function(T) {
          return T.enabled;
        }), b(), g.update();
      },
      ...
      forceUpdate: function() {
        if (!w) {
          var k = u.elements, M = k.reference, O = k.popper;
          if (ni(M, O)) {
            u.rects = {
              reference: Ff(M, zn(O), u.options.strategy === "fixed"),
              popper: Go(O)
            ...
            for (var T = 0; T < u.orderedModifiers.length; T++) {
              ...
              var v = u.orderedModifiers[T], A = v.fn, U = v.options, W = U === void 0 ? {} : U, _ = v.name;
    ...
    function b() {
      u.orderedModifiers.forEach(function(h) {
        var k = h.name, M = h.options, O = M === void 0 ? {} : M, T = h.effect;
        if (typeof T == "function") {
          var v = T({
            state: u,
            name: k,
...
const em = () => Po({
  ...
  } = e, h = kt(e, Jf), k = j.useRef(null), M = ke(k, n), O = j.useRef(null), T = ke(O, w), v = j.useRef(T);
  He(() => {
    v.current = T;
  }, [T]), j.useImperativeHandle(w, () => O.current, []);
  const A = Qf(u, s), [U, W] = j.useState(A), [_, $] = j.useState(dr(o));
  j.useEffect(() => {
...
`));
    ...
    c != null && (X = X.concat(c)), f && f.modifiers != null && (X = X.concat(f.modifiers));
    const tt = qf(_, k.current, I({
      placement: A
    }, f, {
      modifiers: X
    }));
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, M = kt(e, Zf), [O, T] = j.useState(!0), v = () => {
    T(!1);
  }, A = () => {
    T(!0);
  };
  ...
  if (a)
    ...
    const $ = dr(r);
    U = $ && Or($) ? ar($).body : ar(null).body;
  }
  const W = !u && c && (!m || O) ? "none" : void 0, _ = m ? {
    in: u,
    onEnter: v,
    onExited: A
  } : void 0;
...
const dm = {
  ...
  const {
  ...
  } = e, k = kt(e, cm), M = un(), O = j.useRef(), T = Ms(), v = j.useRef(null), A = ke(v, a.ref, n), U = (J) => (X) => {
    if (J) {
      const tt = v.current;
    ...
    let x;
    m === "auto" ? (x = T.transitions.getAutoHeightDuration(J.clientHeight), O.current = x) : x = tt, J.style.transition = [T.transitions.create("opacity", {
      duration: x,
      delay: rt
    ...
    let ot;
    m === "auto" ? (ot = T.transitions.getAutoHeightDuration(J.clientHeight), O.current = ot) : ot = X, J.style.transition = [T.transitions.create("opacity", {
      duration: ot,
      delay: tt
    }), T.transitions.create("transform", {
      ...
      easing: rt
    })].join(","), J.style.opacity = 0, J.style.transform = wo(0.75), f && f(J);
  }), D = U(w);
  return /* @__PURE__ */ i(h, I({
    ...
    onExiting: E,
    addEndListener: (J) => {
      m === "auto" && M.start(O.current || 0, J), r && r(v.current, J);
    },
    timeout: m === "auto" ? null : m
  }, k, {
    children: (J, X) => /* @__PURE__ */ j.cloneElement(a, I({
      style: I({
        opacity: 0,
        transform: wo(0.75),
...
const ai = qo, um = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], pm = jn(As, {
  ...
  const o = gs(), a = zo({
    ...
    slots: O,
    slotProps: T
  } = a, v = kt(a, um), A = (r = O == null ? void 0 : O.root) != null ? r : c == null ? void 0 : c.Root, U = I({
    anchorEl: s,
    container: u,
    disablePortal: f,
    keepMounted: w,
...
const fm = ws("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), se = fm, mm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function hm(t) {
  return Math.round(t * 1e5) / 1e5;
}
const gm = (t) => {
  ...
  [`&[data-popper-placement*="right"] .${se.arrow}`]: I({}, e.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${se.arrow}`]: I({}, e.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  [`.${se.popper}[data-popper-placement*="left"] &`]: I({
  ...
  [`.${se.popper}[data-popper-placement*="right"] &`]: I({
  ...
  [`.${se.popper}[data-popper-placement*="top"] &`]: I({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, e.touch && {
    marginBottom: "24px"
  }),
  [`.${se.popper}[data-popper-placement*="bottom"] &`]: I({
...
const Vs = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r, o, a, s, l, c, d, u, f, w, g, b, m, h, k, M, O, T, v;
  const A = zo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: ft
  } = A, V = kt(A, mm), xt = /* @__PURE__ */ j.isValidElement(W) ? W : /* @__PURE__ */ i("span", {
    children: W
  }), Gt = Ms(), ue = Gt.direction === "rtl", [Tt, Ln] = j.useState(), [Ht, Oe] = j.useState(null), pe = j.useRef(!1), Re = Q || ot, _e = un(), Pe = un(), we = un(), Qe = un(), [Fn, Ko] = ls({
    controlled: q,
    default: !1,
    name: "Tooltip",
    state: "open"
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    j.useEffect(() => {
      Tt && Tt.disabled && !et && L !== "" && Tt.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [L, Tt, et]);
  }
  const Rr = ss(x), tn = j.useRef(), Un = io(() => {
    tn.current !== void 0 && (document.body.style.WebkitUserSelect = tn.current, tn.current = void 0), Qe.clear();
  });
  j.useEffect(() => Un, [Un]);
  const Jo = (et) => {
    ii.clear(), qn = !0, Ko(!0), F && !te && F(et);
  }, Gn = io(
    /**
    ...
    (et) => {
      ii.start(800 + P, () => {
        qn = !1;
      }), Ko(!1), G && te && G(et), _e.start(Gt.transitions.duration.shortest, () => {
        pe.current = !1;
      });
    }
  ), _r = (et) => {
    pe.current && et.type !== "touchstart" || (Tt && Tt.removeAttribute("title"), Pe.clear(), we.clear(), X || qn && tt ? Pe.start(qn ? tt : X, () => {
      Jo(et);
    }) : Jo(et));
  }, Zo = (et) => {
    Pe.clear(), we.start(P, () => {
  ...
  }, en = {}, $r = typeof L == "string";
  E ? (en.title = !te && $r && !D ? L : null, en["aria-describedby"] = te ? Rr : null) : (en["aria-label"] = $r ? L : null, en["aria-labelledby"] = te && !$r ? Rr : null);
  const Bt = I({}, en, V, xt.props, {
...
`));
  ...
  const nn = {};
  J || (Bt.onTouchStart = Js, Bt.onTouchEnd = Zs), D || (Bt.onMouseOver = Kn(oa, Bt.onMouseOver), Bt.onMouseLeave = Kn(aa, Bt.onMouseLeave), Re || (nn.onMouseOver = oa, nn.onMouseLeave = aa)), B || (Bt.onFocus = Kn(na, Bt.onFocus), Bt.onBlur = Kn(ea, Bt.onBlur), Re || (nn.onFocus = na, nn.onBlur = ea)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const el = j.useMemo(() => {
    var et;
    let Pt = [{
    ...
    return (et = Y.popperOptions) != null && et.modifiers && (Pt = Pt.concat(Y.popperOptions.modifiers)), I({}, Y.popperOptions, {
      modifiers: Pt
    });
  }, [Ht, Y]), rn = I({}, A, {
    isRtl: ue,
    ...
    touch: pe.current
  }), Ir = gm(rn), ia = (r = (o = R.popper) != null ? o : _.Popper) != null ? r : bm, sa = (a = (s = (l = R.transition) != null ? l : _.Transition) != null ? s : C) != null ? a : ai, la = (c = (d = R.tooltip) != null ? d : _.Tooltip) != null ? c : vm, ca = (u = (f = R.arrow) != null ? f : _.Arrow) != null ? u : ym, nl = pn(ia, I({}, Y, (w = Z.popper) != null ? w : $.popper, {
    className: ye(Ir.popper, Y == null ? void 0 : Y.className, (g = (b = Z.popper) != null ? b : $.popper) == null ? void 0 : g.className)
  }), rn), rl = pn(sa, I({}, ft, (m = Z.transition) != null ? m : $.transition), rn), ol = pn(la, I({}, (h = Z.tooltip) != null ? h : $.tooltip, {
    className: ye(Ir.tooltip, (k = (M = Z.tooltip) != null ? M : $.tooltip) == null ? void 0 : k.className)
  }), rn), al = pn(ca, I({}, (O = Z.arrow) != null ? O : $.arrow, {
    className: ye(Ir.arrow, (T = (v = Z.arrow) != null ? v : $.arrow) == null ? void 0 : T.className)
  }), rn);
  return /* @__PURE__ */ y(j.Fragment, {
    children: [/* @__PURE__ */ j.cloneElement(xt, Bt), /* @__PURE__ */ i(ia, I({
      as: K ?? js,
      placement: z,
      anchorEl: ot ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ y(la, I({}, ol, {
          children: [L, U ? /* @__PURE__ */ i(ca, I({}, al, {
            ref: Oe
          })) : null]
        }))
      }))
...
function zs(t) {
  const {
    ...
    Wl,
    {
      ...
      onClick: e,
      id: m,
      children: n ? /* @__PURE__ */ y(le, { children: [
        si(a, n, !0),
...
function Rm({
  ...
  const [c, d] = st(!1), [u, f] = st(!1), w = Et(() => {
    ...
    T.stopPropagation(), d((v) => {
      const A = !v;
      return A && T.shiftKey ? f(!0) : A || f(!1), A;
    });
  }, []), b = Et(
    (T) => (w(), r(T)),
    [r, w]
  ...
  Kt(() => {
    if (c) {
      ...
      if (T) {
        const v = T.getBoundingClientRect(), A = window.scrollY, U = window.scrollX, W = v.top + A + T.clientHeight, _ = v.left + U;
        h({ top: W, left: _ });
      }
    }
  }, [c, o]);
...
const Ce = ur(({ className: t, ...e }, n) => /* @__PURE__ */ i(Tl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
function Ih({ className: t, variant: e, ...n }) {
...
Dm.displayName = dn.Root.displayName;
...
const Mh = _t.Root, jm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  _t.List,
  {
    ref: n,
    className: N(
...
jm.displayName = _t.List.displayName;
...
Vm.displayName = _t.Trigger.displayName;
...
zm.displayName = _t.Content.displayName;
function Dh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(Ce, { size: 15 }) : /* @__PURE__ */ y(le, { children: [
...
function Bh({
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      onClick: e,
      ...r,
      children: t ? /* @__PURE__ */ y(le, { children: [
...
function Lh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ y(xn, { children: [
    /* @__PURE__ */ i(nr, { asChild: !0, children: /* @__PURE__ */ i(Lm, {}) }),
    /* @__PURE__ */ i(Le, { children: e.map((n) => /* @__PURE__ */ y("div", { children: [
...
function Xh({
  ...
  const u = t["%resources_action%"], f = t["%resources_dialog_subtitle%"], w = t["%resources_dialog_title%"], g = t["%resources_filterInput%"], b = t["%resources_fullName%"], m = t["%resources_get%"], h = t["%resources_installed%"], k = t["%resources_language%"], M = t["%resources_languageFilter%"], O = t["%resources_loadingResources%"], T = t["%resources_noResults%"], v = t["%resources_open%"], A = t["%resources_remove%"], U = t["%resources_size%"], W = t["%resources_type%"], _ = t["%resources_type_DBL%"], $ = t["%resources_type_ER%"], E = t["%resources_type_SLR%"], B = t["%resources_type_XR%"], D = t["%resources_type_unknown%"], Q = t["%resources_update%"], [J, X] = st([]), tt = (R, L) => {
    if (!c || !d)
      return;
    const C = {
      dblEntryUid: R,
      action: L === "install" ? "installing" : "removing"
    };
    X((V) => [...V, C]), (L === "install" ? c : d)(R).catch((V) => {
      console.debug(zl(V));
    });
  };
  Kt(() => {
    X(
      (R) => R.filter((L) => {
        const C = e.find((ft) => ft.dblEntryUid === L.dblEntryUid);
        return C ? !(L.action === "installing" && C.installed || L.action === "removing" && !C.installed) : !0;
      })
    );
  }, [e]);
  const [rt, ot] = st(""), x = Nt(() => e.filter((R) => {
    const L = rt.toLowerCase();
    return R.displayName.toLowerCase().includes(L) || R.fullName.toLowerCase().includes(L) || R.bestLanguageName.toLowerCase().includes(L);
  }), [e, rt]), P = Nt(() => [
    ...
    const L = [...r];
    let C = [];
    !L || L.length === 0 ? C = [R] : C = L.includes(R) ? L.filter((ft) => ft !== R) : [...L, R], o(C);
  ...
  const F = (R) => {
    const L = [...a];
    let C = [];
    !L || L.length === 0 ? C = [R] : C = L.includes(R) ? L.filter((ft) => ft !== R) : [...L, R], s(C);
  }, q = Nt(() => G.filter((R) => a.includes(R.bestLanguageName)), [a, G]), [z, K] = st({
    key: "bestLanguageName",
    direction: "ascending"
  }), Y = Nt(() => [...q].sort((R, L) => {
    const C = R[z.key], ft = L[z.key];
    return C < ft ? z.direction === "ascending" ? -1 : 1 : C > ft ? z.direction === "ascending" ? 1 : -1 : 0;
  }), [z.direction, z.key, q]), Z = (R) => {
    const L = { key: R, direction: "ascending" };
    z.key === R && z.direction === "ascending" && (L.direction = "descending"), K(L);
  };
    ...
    /* @__PURE__ */ i(Ys, { children: n || !e ? /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-2", children: [
      ...
      /* @__PURE__ */ y("div", { className: "tw-mb-1 tw-flex tw-gap-1", children: [
        ...
        /* @__PURE__ */ y(xn, { children: [
          ...
          /* @__PURE__ */ i(Le, { align: "start", children: P.map((R) => /* @__PURE__ */ i(
            wr,
            {
              checked: r.includes(R.type),
              onClick: (L) => {
                L.preventDefault(), H(R.type);
              },
      ...
      Y.length === 0 ? /* @__PURE__ */ i("div", { className: "tw-m-4 tw-flex tw-w-full tw-justify-center", children: /* @__PURE__ */ i(Mt, { children: T }) }) : /* @__PURE__ */ y($n, { stickyHeader: !0, children: [
        /* @__PURE__ */ i(In, { className: "tw-bg-none", stickyHeader: !0, children: /* @__PURE__ */ y(Wt, { children: [
          /* @__PURE__ */ i(jt, {}),
          /* @__PURE__ */ i(jt, {}),
          /* @__PURE__ */ i(jt, { onClick: () => Z("fullName"), children: /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            b,
            z.key !== "fullName" && /* @__PURE__ */ i(er, { className: "tw-pl-1", size: 16 }),
            z.key === "fullName" && (z.direction === "ascending" ? /* @__PURE__ */ i(Kr, { className: "tw-pl-1", size: 16 }) : /* @__PURE__ */ i(ze, { className: "tw-pl-1", size: 16 }))
          ] }) }),
          /* @__PURE__ */ i(jt, { onClick: () => Z("bestLanguageName"), children: /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            k,
            z.key !== "bestLanguageName" && /* @__PURE__ */ i(er, { className: "tw-pl-1", size: 16 }),
            z.key === "bestLanguageName" && (z.direction === "ascending" ? /* @__PURE__ */ i(Kr, { className: "tw-pl-1", size: 16 }) : /* @__PURE__ */ i(ze, { className: "tw-pl-1", size: 16 }))
          ] }) }),
          /* @__PURE__ */ i(jt, { children: W }),
        ...
        /* @__PURE__ */ i(An, { children: Y.map((R) => {
          ...
          return /* @__PURE__ */ y(Wt, { children: [
            ...
            /* @__PURE__ */ i(It, { children: ((L = P.find((C) => C.type === R.type)) == null ? void 0 : L.localizedValue) ?? D }),
            /* @__PURE__ */ i(It, { children: R.size }),
            /* @__PURE__ */ i(It, { children: /* @__PURE__ */ y("div", { className: "tw-flex tw-justify-between", children: [
              Hm(
                R,
                J.map((C) => C.dblEntryUid),
                m,
                Q,
                h,
                tt
              ),
              R.installed && /* @__PURE__ */ y(xn, { children: [
                /* @__PURE__ */ i(nr, { asChild: !0, children: /* @__PURE__ */ i(wt, { variant: "ghost", children: /* @__PURE__ */ i($l, { className: "tw-w-4" }) }) }),
                /* @__PURE__ */ y(Le, { align: "start", children: [
                  ...
                  /* @__PURE__ */ i(
                    rr,
                    {
                      ...
                      children: /* @__PURE__ */ i("span", { children: A })
                    }
                  )
                ] })
              ] })
