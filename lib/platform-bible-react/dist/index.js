...
var _t = (t, e, r) => ci(t, typeof e != "symbol" ? e + "" : e, r);
import { jsx as a, jsxs as u, Fragment as J } from "react/jsx-runtime";
...
import { Slot as ke, Dialog as Yt, Popover as rr, Label as pi, RadioGroup as ra, Tooltip as Le, ToggleGroup as Io, Separator as gi, Avatar as ya, DropdownMenu as vt, Select as Ct, Checkbox as qa, Tabs as Bt, Menubar as Qt, ContextMenu as bt, Progress as Ha, Slider as pr, Switch as Wa } from "radix-ui";
import { cva as te } from "class-variance-authority";
import { IconX as hi, IconCheck as Me, IconSearch as fi, IconChevronRight as ka, IconChevronDown as mi, IconChevronUp as vi, IconSelector as bi, IconLayoutSidebar as xi, IconLayoutSidebarRight as yi, IconLoader as ki, IconAlertOctagon as _i, IconAlertTriangle as Ni, IconInfoCircle as Ci, IconCircleCheck as Ei } from "@tabler/icons-react";
import { Canon as ct } from "@sillsdev/scripture";
import { includes as gr, Section as W, getChaptersForBook as zi, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as Ti, formatReplacementString as ie, sanitizeHtml as Si, NumberFormat as Di, formatBytes as Ri, getCurrentLocale as $i, usfmMarkers as xr, getFormatCallerFunction as Mi, deepEqual as Oi, isString as Ya, compareScrRefs as aa, scrRefToBBBCCCVVV as Fr, getLocalizeKeyForScrollGroupId as Z } from "platform-bible-utils";
import { Check as nr, Clock as Xa, ChevronsLeft as Ja, ChevronsRight as Za, ChevronLeft as oa, ChevronRight as na, ArrowLeft as Ai, ArrowRight as Ii, ChevronDown as Mr, BoldIcon as Pi, ItalicIcon as Li, X as Or, AtSign as Po, Pencil as Vi, Trash2 as ji, ArrowUp as Lo, MoreHorizontal as Fi, MailOpen as Bi, Mail as Ui, ChevronUp as Ki, FilterIcon as Gi, ArrowLeftIcon as qi, ChevronLeftIcon as Hi, ChevronRightIcon as Wi, ArrowRightIcon as Yi, Copy as Vo, Filter as Xi, User as Ji, Link as Zi, CircleHelp as Qi, ChevronsUpDown as jo, Star as ts, Undo as es, Redo as rs, SquareX as Fo, FunctionSquare as Bo, SquareSigma as Uo, Ban as as, AlertCircle as ia, CircleCheckIcon as os, CircleXIcon as ns, CircleHelpIcon as is, ArrowUpIcon as ss, ArrowDownIcon as ls, Search as cs, LoaderCircle as ds, CheckIcon as ws, ScrollText as us, MenuIcon as ps, Menu as gs, EllipsisVertical as hs, MoreVertical as Qa } from "lucide-react";
import et, { forwardRef as ir, useRef as q, useMemo as I, useState as T, useCallback as j, useLayoutEffect as Mt, createContext as Ar, useContext as _a, useEffect as K, Component as fs, createElement as to, Suspense as ms, Fragment as Ko } from "react";
import { createEditor as Go, $getRoot as ce, $createParagraphNode as We, $getSelection as zt, HISTORY_MERGE_TAG as Na, ParagraphNode as qo, TextNode as Ho, $isTokenOrSegmented as vs, $getCharacterOffsets as bs, $cloneWithPropertiesEphemeral as xs, $getPreviousSelection as ys, $isRangeSelection as Xt, $caretFromPoint as ks, $getSiblingCaret as Wo, $getChildCaret as _s, $getAdjacentChildCaret as Ns, $isChildCaret as Cs, $normalizeCaret as Es, $setSelectionFromCaretRange as zs, $getCollapsedCaretRange as Ts, $getCaretInDirection as eo, $splitAtPointCaretNext as Ss, $isTextPointCaret as Ds, $findMatchingParent as Yo, $isElementNode as se, mergeRegister as de, getDOMTextNode as Rs, isHTMLElement as Xo, CLEAR_EDITOR_COMMAND as Jo, COMMAND_PRIORITY_EDITOR as Ca, shallowMergeConfig as $s, defineExtension as Lt, safeCast as Oe, createState as Ms, FORMAT_TEXT_COMMAND as Zo, $isNodeSelection as Qo, COMMAND_PRIORITY_LOW as tn, RootNode as Os, LineBreakNode as As, TabNode as Is, $isEditorState as Ps, createCommand as Ls, CLICK_COMMAND as Vs, isDOMNode as js, $getNodeFromDOMNode as Fs, $createNodeSelection as Bs, $setSelection as Us, $getEditor as Ks, DecoratorNode as sa, $getState as Gs, toggleTextFormatType as ro, TEXT_TYPE_TO_FORMAT as qs, $setState as Hs, addClassNamesToElement as en, $create as Ws, $getNodeByKey as Ys, removeClassNamesFromElement as Xs, KEY_TAB_COMMAND as Js, $isBlockElementNode as Nr, $createRangeSelection as Zs, $normalizeSelection__EXPERIMENTAL as Qs, OUTDENT_CONTENT_COMMAND as tl, INDENT_CONTENT_COMMAND as ao, INSERT_TAB_COMMAND as el, COMMAND_PRIORITY_CRITICAL as Ea, $isDecoratorNode as rl, $isParagraphNode as al, $isTextNode as Cr, SELECTION_CHANGE_COMMAND as rn, getRegisteredNode as ol, isDocumentFragment as oo, isDOMDocumentNode as nl, ArtificialNode__DO_NOT_USE as an, $createLineBreakNode as on, $isRootOrShadowRoot as il, isBlockDomNode as no, isInlineDomNode as io, $insertNodes as sl } from "lexical";
...
import { useReactTable as sn, getFilteredRowModel as gl, getSortedRowModel as ln, getPaginationRowModel as hl, getCoreRowModel as cn, flexRender as tr, getGroupedRowModel as fl, getExpandedRowModel as ml } from "@tanstack/react-table";
import vl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as la, HIDDEN_NOTE_CALLER as ca, getDefaultViewOptions as bl, isInsertEmbedOpOfType as hr, Editorial as xl } from "@eten-tech-foundation/platform-editor";
...
const Ye = 250, dn = 300, zl = 400, Tl = 450, Sl = 500, wn = te(
  ...
  return /* @__PURE__ */ u($l, { children: [
    ...
    /* @__PURE__ */ u(
      Yt.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(Yt.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(L, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(hi, {}),
...
function Ru({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(Yt.Close, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function lr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Al, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(Pl, { children: /* @__PURE__ */ a(fi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const gn = ct.allBookIds.filter(
  (t) => !ct.isObsolete(ct.bookIdToNumber(t))
), Re = Object.fromEntries(
  gn.map((t) => [t, ct.bookIdToEnglishName(t)])
);
function Ra(t, e, r) {
...
function Fl({
  ...
  return /* @__PURE__ */ u(ue, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ a(pe, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(Jt, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      we,
      {
        onSelect: () => h(p),
...
function lo({
  ...
  if (t)
    return /* @__PURE__ */ a(Jt, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: qt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
      we,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function Lu({
  ...
  }, [v, x, y, t.book, t.chapterNum]), /* @__PURE__ */ u(ue, { open: w, onOpenChange: U, children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
      L,
      {
        ...
        children: /* @__PURE__ */ a("span", { className: "tw:truncate", children: fe })
      }
    ) }),
    /* @__PURE__ */ a(pe, { id: c, forceMount: !0, className: "tw:w-[280px] tw:p-0", align: "center", children: /* @__PURE__ */ u(
      Ne,
      {
        ref: V,
        onKeyDown: Vt,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ae.map(({ onClick: $, disabled: H, title: Q, icon: wt }) => /* @__PURE__ */ a(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ a(
              L,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a(Ai, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ii, { className: "tw:h-4 tw:w-4" })
              }
            ),
            x && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ve(x, n) })
          ] }),
          !_ && /* @__PURE__ */ u(Ce, { ref: C, children: [
            v === "books" && /* @__PURE__ */ u(J, { children: [
              !y && Object.entries(G).map(([$, H]) => {
                if (H.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ a(Jt, { heading: he($), children: H.map((Q) => /* @__PURE__ */ a(
                      hn,
                      {
                        bookId: Q,
                        onSelect: (wt) => ft(wt),
              ...
              y && /* @__PURE__ */ a(Jt, { children: /* @__PURE__ */ a(
                we,
                {
              ...
              y && qt(y.book) > 1 && /* @__PURE__ */ u(J, { children: [
...
function pa({
  ...
  return /* @__PURE__ */ u(ue, { open: N, onOpenChange: _, ...x, children: [
    ...
    /* @__PURE__ */ a(
      pe,
      {
        ...
        children: /* @__PURE__ */ u(Ne, { children: [
          ...
          /* @__PURE__ */ a(Ce, { children: V(e) ? e.map((C) => /* @__PURE__ */ a(Jt, { heading: C.groupHeading, children: C.options.map((z) => A(z, C.groupHeading)) }, C.groupHeading)) : /* @__PURE__ */ a(Jt, { children: e.map((C) => A(C)) }) })
        ] })
      }
    )
  ] });
...
const vn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Wl = vn ? Mt : K, fr = { tag: Na };
      ...
      if (h !== null) {
        if (h === void 0) g.update(() => {
          ...
          if (p.isEmpty()) {
            const m = We();
            p.append(m);
            const b = vn ? document.activeElement : null;
...
const Xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
...
const rc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
function ac(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function oc() {
  return function(t) {
    const [e] = ee(), r = I(() => t(e), [e, t]), [o, n] = T(() => r.initialValueFn()), i = q(o);
    return rc(() => {
...
function ic(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !vs(e) && o !== null) {
    ...
    if (d || w) {
      const [g, h] = bs(t), p = l.is(c), m = e.is(s ? c : l), b = e.is(s ? l : c);
      let v, k = 0;
      p ? (k = g > h ? h : g, v = g > h ? g : h) : m ? (k = s ? h : g, v = void 0) : b && (k = 0, v = s ? g : h);
      const x = e.__text.slice(k, v);
      x !== e.__text && (r === "clone" && (e = xs(e)), e.__text = x);
    }
  }
  return e;
}
...
const bn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, sc = bn && "documentMode" in document ? document.documentMode : null;
!(!bn || !("InputEvent" in window) || sc) && "getTargetRanges" in new window.InputEvent("input");
function Gt(t) {
  return `${t}px`;
}
...
function pc(t) {
  const e = Yo(t, (r) => se(r) && !r.isInline());
  return se(e) || Er(4, t.__key), e;
}
function gc(t) {
  const e = zt() || ys();
  let r;
  if (Xt(e)) r = ks(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (r = Wo(l, "next"));
    }
    r = r || _s(ce(), "previous").getFlipped().insert(We());
  }
  const o = hc(t, r), n = Ns(o), i = Cs(n) ? Es(n) : o;
  return zs(Ts(i)), t.getLatest();
}
function hc(t, e, r) {
  let o = eo(e, "next");
  for (let n = o; n; n = Ss(n, r)) o = n;
  return Ds(o) && Er(283), o.insert(t.isInline() ? We().append(t) : t), eo(Wo(t.getLatest(), "next"), e.direction);
}
function fc(t) {
  const e = zt();
  if (!Xt(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const l = Yo(i, (d) => se(d) && !d.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
let zr, le = 0, Tr = 0, bc = 0, ha = 0, yr = 0;
function uo(t) {
  if (X === void 0) return;
  let e = t.n;
...
function Te(t, e) {
  Nt.call(this, void 0), this.x = t, this.s = void 0, this.g = yr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function xc(t, e) {
  return new Te(t, e);
}
...
function yc(t) {
  ...
  yn(this), X = t, this.f &= -2, 8 & this.f && Oa(this), Pr();
}
function Pe(t, e) {
...
Nt.prototype.brand = mc, Nt.prototype.h = function() {
  ...
  if (t !== this.v) {
    if (Tr > 100) throw new Error("Cycle detected");
    (function(e) {
      le !== 0 && Tr === 0 && e.l !== ha && (e.l = ha, zr = { S: e, v: e.v, i: e.i, o: zr });
    })(this), this.v = t, this.i++, yr++, le++;
    try {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, kn(this), po(this), le++;
  const t = X;
...
function _n() {
  const t = ce(), e = zt(), r = We();
  t.clear(), t.append(r), e !== null && r.select(), Xt(e) && (e.format = 0);
}
function Nn(t, e = _n) {
  return t.registerCommand(Jo, (r) => (t.update(e), !0), Ca);
}
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $onClear: _n }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Zt(() => Nn(t, o.value));
} });
function kc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Gr = Ms("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Cn extends sa {
  $config() {
...
Lt({ name: "@lexical/extension/DecoratorText", nodes: () => [Cn], register: (t, e, r) => t.registerCommand(Zo, (o) => {
  const n = zt();
  if (Qo(n) || Xt(n)) for (const i of n.getNodes()) _c(i) && i.toggleFormat(o);
  return !1;
}, tn) });
function En(t, e) {
  let r;
...
const fa = Lt({ build: (t) => En(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Aa = 0, ma = 1, Tn = 2, qr = 3, mr = 4, Ie = 5, Hr = 6, Je = 7;
function Wr(t) {
  return t.id === Aa;
}
function Sn(t) {
...
function Nc(t) {
  return function(e) {
    return e.id === ma;
  }(t) || tt(305, String(t.id), String(ma)), Object.assign(t, { id: Tn });
}
...
class Ec {
  ...
  init(e) {
    ...
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(l, c, d) {
      return Object.assign(l, { id: mr, initResult: c, registerState: d });
    }(i, s, n);
  }
  build(e) {
    const r = this.state;
    let o;
    r.id !== mr && tt(307, String(r.id), String(Ie)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= mr;
    }(e) || tt(313, String(e.id), String(mr)), e.initResult;
  }
  getInitPeer(e) {
...
}, name: "@lexical/extension/InitialState", nodes: [Os, Ho, As, Is, qo] }), ho = Symbol.for("@lexical/extension/LexicalBuilder");
function fo() {
}
function Sc(t) {
  throw t;
...
const Dc = /* @__PURE__ */ new Set(), mo = Lt({ build(t, e, r) {
  const o = r.getDependency(fa).output, n = ar({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = En(() => {
  }, () => Zt(() => {
...
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), Rc = Ls("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
...
Lt({ dependencies: [fa, mo], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return de(t.registerCommand(Rc, (s) => {
    const l = zt();
    if (!Xt(l)) return !1;
    ...
    if (js(s.target)) {
      ...
      if (Mc(l)) return function(c, d = !1) {
        ...
        let p;
        d && Qo(w) ? p = w : (p = Bs(), Us(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
    ...
    const s = [];
    for (const { domNode: l, selectedSignal: c } of n.value.nodeSelections.values()) s.push(Zt(() => {
      const d = l.value;
      d && (c.value ? en(d, i) : Xs(d, i));
    }));
    return de(...s);
  }));
} });
...
function Oc(t, e, r = Dn) {
  return de(t.registerCommand(Js, (o) => {
    const n = zt();
    if (!Xt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Nr(h) && h.canIndent()).length > 0) return !0;
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: Dn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
function Lc(t) {
  if (!Pc(t, !1)) return !1;
  const e = ce().getChildren(), r = e.length;
  if (r > 1) return !1;
  for (let o = 0; o < r; o++) {
    const n = e[o];
    if (rl(n)) return !1;
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Xt(m)) {
                ...
                if (Cr(v) && d >= 0 && w >= 0 && (k = d, x = d + w, m.setTextNodeRange(v, k, v, x)), k === x && g === "" || (m.insertRawText(g), v = b.getNode()), Cr(v)) {
                  k = h, x = h + p;
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Zt(() => r.getOutput().disabled.value ? void 0 : $n(t)) });
function Vc(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Pa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
...
function Bc({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Pa(() => de(dl(n), $n(n)), [n]);
  }(o), u(J, { children: [t, a(Uc, { content: e }), a(Fc, { editor: o, ErrorBoundary: r })] });
}
function Uc({ content: t }) {
  const [e] = ee(), r = function(n) {
    ...
    return Pa(() => {
      ...
      return l(), de(n.registerUpdateListener(() => {
        l();
...
const Gc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
function qc({ onClear: t }) {
  const [e] = ee();
  return Gc(() => Nn(e, t), [e, t]), null;
}
const Mn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
function Hc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: k = !0, style: x, tabIndex: N, "data-testid": _, ...M }, V) {
  ...
  return Mn(() => (C(t.isEditable()), t.registerEditableListener((O) => {
    C(O);
...
function Xc(t, e) {
  ...
  return u(J, { children: [a(Wc, { editor: n, ...o, ref: e }), r != null && a(Jc, { editor: n, content: r })] });
}
...
function Qc({
  ...
  return /* @__PURE__ */ a(On.Provider, { value: s, children: i });
}
function An() {
  const t = _a(On);
  if (!t)
...
function ed({
  ...
  const [e] = ee(), [r, o] = T(e), [n, i] = T("paragraph"), [s, l] = td(), c = () => {
  };
...
function od() {
  const { activeEditor: t } = An(), [e, r] = T([]), o = j((n) => {
    if (Xt(n) || pl(n)) {
      const i = [];
      xo.forEach(({ format: s }) => {
...
function cd(t, e) {
  ...
  const r = document.createElement("div"), o = ce().getChildren();
  for (let n = 0; n < o.length; n++)
    Ln(t, o[n], r, e);
  return r.innerHTML;
}
function Ln(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && Cr(e) && (s = ic(o, e, "clone"));
  const l = se(s) ? s.getChildren() : [], c = ol(t, s.getType());
  let d;
  ...
  for (let p = 0; p < l.length; p++) {
    const m = l[p], b = Ln(t, m, h, o);
    !n && se(e) && b && e.extractWithChild(m, o, "html") && (n = !0);
  }
  if (n && !i) {
...
function jn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (l == null || !il(l)) && (l != null && Nr(l) || o);
  for (let m = 0; m < g.length; m++) h.push(...jn(g[m], e, r, p, new Map(n), l));
  ...
  }(t) && (s = s.concat(on())) : se(l) && l.append(...h), s;
}
function dd(t, e, r) {
  ...
  for (let s = 0; s < e.length; s++) {
    const l = e[s];
    if (Nr(l)) o && !l.getFormat() && l.setFormat(o), n.push(l);
    else if (i.push(l), s === e.length - 1 || s < e.length - 1 && Nr(e[s + 1])) {
      const c = r();
...
function Gn({
  ...
  return /* @__PURE__ */ u(Va, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
    ...
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      ...
      /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ a("p", { children: l }) })
    ] }) })
  ] });
}
function _r(t, e) {
...
function Uu({
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(ue, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(
        L,
        {
          variant: "outline",
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : ja(v) && (v.preventDefault(), v.stopPropagation(), $t(i) && p());
        },
        onKeyDown: (v) => {
...
function ko({
  ...
  const p = j(
    ...
    [t.user]
  ), x = I(() => Si(t.contents), [t.contents]), N = I(() => {
    if (o && l)
      return /* @__PURE__ */ u(J, { children: [
        /* @__PURE__ */ u(
          va,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), p()) : ja(_) && (_.preventDefault(), _.stopPropagation(), $t(w) && m());
              },
              onKeyDown: (_) => {
        ...
        N && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Fi, {}) }) }),
...
function Td({
  ...
  const [C, z] = T(_o), [E, O] = T(), [D, F] = T(), P = o, [G, y] = T(!1), [Y, ft] = T(!1), [nt, re] = T(!1), [ae, Tt] = T(!1), [U, it] = T(!1), [at, dt] = T(_), [Et, he] = T(!1), xt = q(void 0), [fe, oe] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
  ...
  K(() => {
    ...
    yt.current === "idle" && (yt.current = "pending"), ae ? yt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
  ...
  const ne = I(() => Vt[0], [Vt]), $ = q(null), H = q(void 0), Q = j(() => {
    var S;
    (S = H.current) == null || S.call(H), z(_o);
  }, []), wt = j(() => {
    const S = !at;
    dt(S), he(!S), m == null || m(c, S);
  }, [at, m, c]);
  K(() => {
    y(!1);
  }, [o]), K(() => {
  ...
  const ot = I(
    ...
    () => ut === 1 ? ot.singleReply : ie(ot.multipleReplies, { count: ut }),
    [ut, ot]
  );
  K(() => {
    !o && Y && rt && ft(!1);
  ...
  const mt = j(
    ...
    async (S) => {
      const gt = $t(C) ? Dr(C) : void 0, ht = S.status ? S.assignedUser : E ?? S.assignedUser, jt = await g({
        ...S,
        contents: gt,
        assignedUser: ht
      });
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                L,
                {
                  ...
                  children: at ? /* @__PURE__ */ a(Bi, {}) : /* @__PURE__ */ a(Ui, {})
                }
              ),
            ...
            /* @__PURE__ */ a(
              ko,
              {
                ...
                handleDeleteComment: p,
                onEditingChange: ft,
                canEditOrDelete: (!Y && fe.get(ne.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(J, { children: [
              ...
              st.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                ko,
                {
                  ...
                  handleDeleteComment: p,
                  onEditingChange: ft,
                  canEditOrDelete: (!Y && fe.get(S.id)) ?? !1
                }
              ) }, S.id)),
              v !== !1 && (!Y || $t(C)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (S) => {
                    ja(S) && (S.preventDefault(), S.stopPropagation(), ($t(C) || E !== void 0 && E !== D) && mt());
                  },
                  onKeyDown: (S) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && ($t(C) || E !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ie(
                      ...
                      /* @__PURE__ */ u(ue, { open: nt, onOpenChange: re, children: [
                        /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
                          L,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !ae || !b || b.length === 0 || !b.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          pe,
                          {
                            ...
                            align: "end",
                            onKeyDown: (S) => {
                              S.key === "Escape" && (S.stopPropagation(), re(!1));
                            },
                            children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: b == null ? void 0 : b.map((S) => /* @__PURE__ */ a(
                              we,
                              {
                                onSelect: () => {
                                  O(S !== i ? S : void 0), yt.current = "user-selected", F(void 0), re(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: _r(S, r) })
                              },
                              S || "unassigned"
                            )) }) })
                          }
...
function Sd({ table: t }) {
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(L, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Gi, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function qe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ct.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ct.Icon, { asChild: !0, children: /* @__PURE__ */ a(bi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Ld({
  ...
  let M;
  return c ? M = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(Ht, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Wt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((V = N.getRowModel().rows) == null ? void 0 : V.length) > 0 ? M = N.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    Ht,
    {
      onClick: () => s(A, N),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((C) => /* @__PURE__ */ a(Wt, { children: tr(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    A.id
  )) : M = /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a(Wt, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(Sd, { table: N }),
    /* @__PURE__ */ u(dr, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ba, { stickyHeader: i, children: N.getHeaderGroups().map((A) => /* @__PURE__ */ a(Ht, { children: A.headers.map((C) => /* @__PURE__ */ a(Rr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : tr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
      /* @__PURE__ */ a(wr, { children: M })
    ] }),
...
function np({
  ...
  return /* @__PURE__ */ u(ue, { onOpenChange: (w) => {
    w || l(!1);
  }, children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: o }),
    /* @__PURE__ */ u(pe, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
...
function ip({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(L, { variant: "default", children: [
      /* @__PURE__ */ a(Xi, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
    ...
    /* @__PURE__ */ a(ye, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(qn, { children: d.itemType === 0 ? /* @__PURE__ */ a(J, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ve,
        {
          checked: o[w][h],
...
function Hn({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(ue, { open: C, onOpenChange: w ?? x, children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(
      L,
      {
        variant: b,
    ...
    /* @__PURE__ */ a(pe, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
      ...
      /* @__PURE__ */ u(Ce, { children: [
        /* @__PURE__ */ a(Ir, { children: l }),
        /* @__PURE__ */ a(Jt, { children: M.map((E) => /* @__PURE__ */ u(
          we,
          {
            value: E.label,
            onSelect: N,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ a(ts, { className: "tw:h-4 tw:w-4" }),
...
function Kd({
  ...
  return /* @__PURE__ */ u(Va, { children: [
    ...
    e && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
        L,
        {
          "aria-label": w,
...
const qd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(J, { children: [
  /* @__PURE__ */ a("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ u(J, { children: [
  /* @__PURE__ */ a("p", { children: "-" }),
  " ",
...
function Hd({
  ...
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: qd(t, n, r) }) }) }),
...
const Wd = (t, e) => t === "f" ? /* @__PURE__ */ u(J, { children: [
  /* @__PURE__ */ a(Bo, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ u(J, { children: [
  /* @__PURE__ */ a(Uo, {}),
  " ",
...
function Xd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: Wd(t, r) }) }) }),
      /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ a("p", { children: Yd(t, r) }) })
    ] }) }),
...
function Qd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  ...
  return /* @__PURE__ */ u(Ne, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ce, { children: [
      ...
      /* @__PURE__ */ a(Jt, { children: i.map((l) => {
        var c;
        return /* @__PURE__ */ a(
          To,
          {
      ...
      s.length > 0 && /* @__PURE__ */ u(J, { children: [
        i.length > 0 && /* @__PURE__ */ a(un, { alwaysRender: !0 }),
        /* @__PURE__ */ a(Jt, { children: s.map((l) => {
          var c;
          return /* @__PURE__ */ a(
            To,
            {
...
function dp({
  ...
  const [m, b] = T("generated"), [v, k] = T("generated"), [x, N] = T("*"), [_, M] = T("*"), [V, A] = T("f"), [C, z] = T(!1), [E, O] = T(!0), [D, F] = T(!1), P = q(!1), G = q(""), [y, Y] = T(!1), [ft, nt] = T(), [re, ae] = T(), [Tt, U] = T(), [it, at] = T(), dt = q(null), Et = I(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Mt(() => {
    (yt.current.book !== n.book || yt.current.chapterNum !== n.chapterNum) && (yt.current = { book: n.book, chapterNum: n.chapterNum }, oe.current());
  }, [n.book, n.chapterNum]);
  const Vt = () => {
    var B;
    ...
    if (h.current && he.length && R && R.rangeCount > 0) {
      const B = R.getRangeAt(0).getBoundingClientRect(), rt = h.current.getBoundingClientRect();
      nt(B.left - rt.left), ae(B.top - rt.top), U(B.height), Y(!0);
    }
  }, [he, h]);
  K(() => {
    const R = () => {
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
              /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
                L,
                {
                  "aria-label": St,
              ...
              /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ a("p", { children: St }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(J, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ a(J, { children: ow(t.marker, l, o, d) })
      }
    )
  ] });
}
...
function lw({
  ...
  return /* @__PURE__ */ u(dr, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ba, { stickyHeader: !0, children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Rr, { children: n }),
      /* @__PURE__ */ a(Rr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(wr, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      Ht,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          /* @__PURE__ */ a(Wt, { children: De(l.reference, "English") }),
          /* @__PURE__ */ a(Wt, { className: o, children: sw(l.text) })
        ]
      },
...
}, Vr = (t, e, r) => /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
  /* @__PURE__ */ u(
    It,
    {
...
function xp({
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(Ke, { onValueChange: (U) => re(U), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
        ...
        /* @__PURE__ */ a(Pt, { children: (o == null ? void 0 : o.checkboxText) ?? M })
      ] }) })
    ] }),
...
const Ka = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(ds, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Do({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(J, { children: [
      ...
      /* @__PURE__ */ a(dr, { children: /* @__PURE__ */ a(wr, { children: e.map((n) => /* @__PURE__ */ u(Ht, { className: "tw:cursor-pointer", onClick: () => o(n.id), children: [
        /* @__PURE__ */ a(Wt, { className: "tw:border-0", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
          n.id === r && /* @__PURE__ */ a(ws, { className: "tw:h-4 tw:w-4 tw:shrink-0", "aria-label": "current project" }),
          /* @__PURE__ */ u("span", { children: [
            /* @__PURE__ */ a("span", { className: "tw:font-medium", children: n.fullName }),
            " (",
            /* @__PURE__ */ a("span", { children: n.shortName }),
            ")"
          ] })
        ] }) }),
        n.language && /* @__PURE__ */ a(Wt, { className: "tw:border-0 tw:text-right tw:text-sm tw:text-muted-foreground", children: n.language })
      ] }, n.id)) }) })
    ] });
}
function kp({
  ...
  const [s, l] = T(""), c = I(
    ...
    () => r.filter((k) => So(k, s)),
    [r, s]
  ), w = I(() => !t || !c.some((x) => x.id === t.id) ? c : [t, ...c.filter((x) => x.id !== t.id)], [c, t]), g = w.length === 0 && d.length === 0, h = i["%projectPicker_title%"] ?? "%projectPicker_title%", p = i["%projectPicker_section_recent%"] ?? "Recent", m = i["%projectPicker_section_all%"] ?? "All projects", b = i["%projectPicker_search_placeholder%"] ?? "Search projects...", v = i["%projectPicker_no_results%"] ?? "No projects found";
  return /* @__PURE__ */ u(J, { children: [
...
function Zr({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(J, { children: [
      /* @__PURE__ */ a(pt, { className: "tw:text-xs tw:uppercase tw:tracking-wider tw:text-muted-foreground", children: t }),
      /* @__PURE__ */ a(dr, { children: /* @__PURE__ */ a(wr, { children: e.map((n) => /* @__PURE__ */ u(Ht, { children: [
        /* @__PURE__ */ a(Wt, { className: "tw:border-0", children: /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a("span", { className: "tw:font-medium", children: n.fullName }),
          " (",
        ...
        o && r && /* @__PURE__ */ a(Wt, { className: "tw:border-0 tw:text-right", children: /* @__PURE__ */ a(L, { variant: "outline", onClick: () => o(n), children: r }) })
      ] }, n.dblEntryUid)) }) })
    ] });
}
function hw(t, e) {
...
function Np({
  ...
  return /* @__PURE__ */ u(J, { children: [
    ...
    F && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: ie(O, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
...
const fw = "16rem", mw = "3rem", Xn = et.createContext(void 0);
function jr() {
  const t = et.useContext(Xn);
  if (!t)
...
function vw({
  ...
  return /* @__PURE__ */ a(Xn.Provider, { value: k, children: /* @__PURE__ */ a(
    "div",
    {
...
function Cw({
  ...
  return n ? /* @__PURE__ */ u(At, { children: [
...
const me = "scrBook", zw = "scrRef", Se = "source", Tw = "details", Sw = "Scripture Reference", Dw = "Scripture Book", Jn = "Type", Rw = "Details";
function $w(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ct.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === me ? De(n.start) : void 0;
      },
...
function Vp({
  ...
  const [d, w] = T([]), [g, h] = T([{ id: me, desc: !1 }]), [p, m] = T({}), b = I(
  ...
  return /* @__PURE__ */ u("div", { id: c, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(dr, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ba, { children: k.getHeaderGroups().map((z) => /* @__PURE__ */ a(Ht, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Rr, { colSpan: E.colSpan, className: "tw:sticky top-0", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(wr, { children: k.getRowModel().rows.map((z, E) => {
        const O = lt();
        return /* @__PURE__ */ a(
          Ht,
          {
...
const Qn = (t, e, r) => Ga(t, e).every((o) => r.includes(o));
function Ow({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  return /* @__PURE__ */ u(
    ue,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(pe, { className: "tw:w-full tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Ne,
          {
            shouldFilter: !1,
            onKeyDown: (D) => {
                ...
                Object.values(W).map((D, F) => {
                  ...
                  if (P.length !== 0)
                    return /* @__PURE__ */ u(Ko, { children: [
                      ...
                      F < Object.values(W).length - 1 && /* @__PURE__ */ a(un, {})
                    ] }, D);
                })
              ] })
            ]
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          He,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((d) => /* @__PURE__ */ a(Ft, { value: `${d}`, children: l[Z(d)] }, `${d}`))
          }
        )
      ]
    }
...
const ei = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((l) => l.group === i).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ u(At, { children: [
  /* @__PURE__ */ a(It, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
    va,
    {
      onClick: () => {
        o(l);
    ...
    /* @__PURE__ */ a(kd, { children: /* @__PURE__ */ a(zd, { children: ei(
      t,
      e,
      ti(t, l.id),
      o
  ...
  l.tooltip && /* @__PURE__ */ a(Pt, { children: l.tooltip })
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(L, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ps, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(Ko, { children: [
      /* @__PURE__ */ a(qn, { children: /* @__PURE__ */ a(Ot, { children: ei(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(cr, {})
    ] }, c)) })
  ] });
}
const ri = et.forwardRef(
...
const ai = et.forwardRef(({ className: t, ...e }, r) => {
  const o = lt();
  return /* @__PURE__ */ a(
    Bt.Root,
    {
...
ai.displayName = Bt.List.displayName;
const oi = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.List,
  {
    ref: r,
    className: f(
...
)), ni = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.Content,
  {
    ref: r,
    className: f(
...
ni.displayName = Bt.Content.displayName;
function Wp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ai, { children: [
      /* @__PURE__ */ a(oi, { children: t.map((l) => /* @__PURE__ */ a(Lw, { value: l.value, children: l.value }, l.key)) }),
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const l = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(At, { children: [
  ...
  if (yl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    return /* @__PURE__ */ a(Vw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(jw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Ot, { children: ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Jp({
  ...
  return /* @__PURE__ */ u("div", { id: c, className: f("pr-twp tw:max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(pt, { className: "tw:font-normal tw:text-muted-foreground", children: ie(d, {
...
export {
  ...
  Sl as Z_INDEX_MODAL,
  Tl as Z_INDEX_MODAL_BACKDROP,
  zl as Z_INDEX_OVERLAY,
  md as badgeVariants,
