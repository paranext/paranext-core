...
import b, { forwardRef as Pe, useRef as et, useMemo as B, useState as D, useCallback as z, useLayoutEffect as Mt, createContext as zn, useContext as jn, useEffect as Y, Suspense as la, createRef as Sr, Fragment as Dr } from "react";
import { Command as pt } from "cmdk";
import { X as $e, Search as Ir, Check as Tt, Clock as lr, ChevronsLeft as wr, ChevronsRight as cr, ChevronLeft as vn, ChevronRight as pe, ArrowLeft as wa, ArrowRight as ca, Circle as Je, ChevronDown as Qt, BoldIcon as da, ItalicIcon as pa, UnderlineIcon as ua, StrikethroughIcon as ma, Pencil as ha, Trash2 as fa, ArrowUp as Or, MoreHorizontal as Mr, ChevronUp as xn, AtSign as ga, FilterIcon as ba, ArrowLeftIcon as va, ChevronLeftIcon as xa, ChevronRightIcon as ya, ArrowRightIcon as Na, Copy as Vr, Filter as ka, User as _a, Link as Ca, CircleHelp as Ea, ChevronsUpDown as Ar, Star as Ta, FunctionSquare as Pr, SquareSigma as $r, SquareX as Ra, AlertCircle as yn, CircleCheckIcon as Sa, CircleXIcon as Da, CircleHelpIcon as Ia, ArrowUpIcon as Oa, ArrowDownIcon as Ma, ArrowUpDownIcon as Va, PanelLeft as Aa, PanelRight as Pa, ScrollText as $a, MenuIcon as La, Menu as Ba, EllipsisVertical as za, LoaderCircle as ja, GripVertical as Fa } from "lucide-react";
import { clsx as Ga } from "clsx";
import { extendTailwindMerge as Ha } from "tailwind-merge";
import * as yt from "@radix-ui/react-dialog";
import { includes as Ge, Section as H, getChaptersForBook as Xa, formatScrRef as ce, getSectionForBook as Re, formatRelativeDate as Ka, formatReplacementString as qt, sanitizeHtml as Ua, parseParatextHtml as dr, hasCustomParatextTags as Ya, NumberFormat as qa, formatBytes as Ja, getCurrentLocale as Wa, getFormatCallerFunction as Za, deepEqual as Lr, isString as cn, compareScrRefs as Nn, scrRefToBBBCCCVVV as dn, getLocalizeKeyForScrollGroupId as K } from "platform-bible-utils";
...
import * as Br from "@radix-ui/react-label";
import * as Oe from "@radix-ui/react-radio-group";
import { createEditor as Qa, $getRoot as te, $createParagraphNode as Fn, $getSelection as Me, HISTORY_MERGE_TAG as zr, ParagraphNode as ts, TextNode as es, $isDecoratorNode as ns, $isElementNode as Se, $isParagraphNode as rs, $isTextNode as Ke, $isTokenOrSegmented as os, $getCharacterOffsets as as, $isRangeSelection as Gn, CLEAR_EDITOR_COMMAND as jr, COMMAND_PRIORITY_EDITOR as ss, SELECTION_CHANGE_COMMAND as Fr, COMMAND_PRIORITY_CRITICAL as Gr, FORMAT_TEXT_COMMAND as is, $cloneWithProperties as ls, getRegisteredNode as ws, isHTMLElement as cs, isDocumentFragment as pr, ArtificialNode__DO_NOT_USE as Hr, $createLineBreakNode as Xr, $isRootOrShadowRoot as ds, $isBlockElementNode as kn, isBlockDomNode as ur, isInlineDomNode as mr, $insertNodes as ps } from "lexical";
...
import * as Kr from "@radix-ui/react-toggle";
import { createHeadlessEditor as Ur } from "@lexical/headless";
import * as Yr from "@radix-ui/react-separator";
...
import { useReactTable as qr, getFilteredRowModel as ys, getSortedRowModel as Jr, getPaginationRowModel as Ns, getCoreRowModel as Wr, flexRender as De, getGroupedRowModel as ks, getExpandedRowModel as _s } from "@tanstack/react-table";
...
const Os = yt.Root, Ms = yt.Portal, Zr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  yt.Overlay,
  {
    ref: n,
    className: u(
...
Zr.displayName = yt.Overlay.displayName;
const Qr = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = st();
...
Qr.displayName = yt.Content.displayName;
...
eo.displayName = yt.Title.displayName;
...
const Be = b.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(Ir, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      pt.Input,
      {
        ref: n,
...
no.displayName = pt.Separator.displayName;
      ...
      if (i) {
        ...
        if (!p && d) {
          const m = ((g) => Object.keys(Jt).find(
            (y) => Jt[y].toLowerCase() === g.toLowerCase()
          ))(l);
  ...
  return Mt(() => {
    const v = setTimeout(() => {
      if (p && k === "books" && I.current && N.current) {
        const j = I.current, J = N.current, lt = J.offsetTop, ct = j.clientHeight, Xt = J.clientHeight, St = lt - ct / 2 + Xt / 2;
        j.scrollTo({
          top: Math.max(0, St),
          behavior: "smooth"
        }), m(Sn(t.book));
...
), at = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Br.Root, { ref: n, className: u("pr-twp", Qs(), t), ...e }));
at.displayName = Br.Root.displayName;
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ c(oe, { children: [
          ...
          /* @__PURE__ */ r(ae, { children: M(e) ? e.map((C) => /* @__PURE__ */ r(zt, { heading: C.groupHeading, children: C.options.map((I) => R(I, C.groupHeading)) }, C.groupHeading)) : e.map((C) => R(C)) })
        ] })
      }
    )
  ] });
...
const mo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ii = mo ? Mt : Y, He = { tag: zr };
      ...
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (m.isEmpty()) {
            ...
            (Me() !== null || y !== null && y === f.getRootElement()) && g.select();
          }
        }, He);
...
function ci({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return wi(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      e && s.size === 0 && i.size === 0 || t && d.has(zr) || l.isEmpty() || n(a, o, d);
    });
  }, [o, t, e, n]), null;
}
const Wn = {
...
const fo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xi = fo && "documentMode" in document ? document.documentMode : null;
!(!fo || !("InputEvent" in window) || xi) && "getTargetRanges" in new window.InputEvent("input");
function Qn(...t) {
  return () => {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (Gn(y)) {
                ...
                if (Ke(S) && w >= 0 && p >= 0 && (T = w, x = w + p, y.setTextNodeRange(S, T, S, x)), T === x && f === "" || (y.insertRawText(f), S = k.getNode()), Ke(S)) {
                  T = h, x = h + m;
...
function Ei({ onClear: t }) {
  const [e] = Rt();
  return Ci(() => e.registerCommand(jr, (n) => (e.update(() => {
    if (t == null) {
...
function Vi() {
  const [t, e] = D(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ r(Os, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Qr, { children: [
      /* @__PURE__ */ r(to, { children: /* @__PURE__ */ r(eo, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = z(
    (s, i, l = !1) => {
...
$i.displayName = Kr.Root.displayName;
...
function Fi(t, e) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Hr && i.insertAfter(Xr());
    for (const i of s) {
...
function _o(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  }(t) && (i = i.concat(Xr())) : Se(l) && l.append(...h), i;
}
function Hi(t, e, n) {
...
function Ki(t) {
  ...
  const e = t.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Ur({
...
he.displayName = Yr.Root.displayName;
...
}), ye = Z.Trigger, So = Z.Group, Qi = Z.Portal, tl = Z.Sub, el = Z.RadioGroup;
...
Ht.displayName = Z.Content.displayName;
...
Ye.displayName = Z.Item.displayName;
...
Bt.displayName = Z.CheckboxItem.displayName;
const Oo = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ c(
    Z.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Z.ItemIndicator, { children: /* @__PURE__ */ r(Je, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
ze.displayName = Z.Label.displayName;
...
Ne.displayName = Z.Separator.displayName;
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: S,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), T()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), Pt(m) && x());
              },
              onKeyDown: (N) => {
        ...
        I && /* @__PURE__ */ c(le, { children: [
          /* @__PURE__ */ r(ye, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Mr, {}) }) }),
...
function rl({
  ...
  const it = B(
  ...
  }, [a, e]), At = B(() => xt.slice(1), [xt]), ht = B(() => At.length ?? 0, [At.length]), on = B(() => ht > 0, [ht]), an = B(() => C || ht <= 2 ? At : At.slice(-2), [At, ht, C]), we = B(() => C || ht <= 2 ? 0 : ht - 2, [ht, C]), je = B(
    ...
    async (v) => {
      const j = Pt(S) ? Vn(S) : void 0, J = await w({
        ...v,
        contents: j,
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            M && /* @__PURE__ */ r(
              $,
              {
                ...
                children: x ? /* @__PURE__ */ r(xn, {}) : /* @__PURE__ */ r(Qt, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
          ...
          n && /* @__PURE__ */ c(rt, { children: [
            ...
            m !== !1 && (!N || Pt(S)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (v) => {
                  v.key === "Enter" && v.shiftKey && (v.preventDefault(), v.stopPropagation(), (Pt(S) || F !== void 0) && Fe());
                },
                onKeyDown: (v) => {
...
function Ec({
  ...
  const [h, m] = D(), g = e.filter(
    ...
    m(R);
  }, []), { listboxRef: T, activeId: x, handleKeyDown: _ } = ai({
    options: y,
    onOptionSelect: k
  }), M = z(
    (R) => {
...
function fl({
  ...
  var R;
  const [p, f] = D([]), [h, m] = D([]), [g, y] = D({}), [k, S] = D({}), T = B(() => e ?? [], [e]), x = qr({
    data: T,
    columns: t,
    getCoreRowModel: Wr(),
  ...
  return d ? M = Array.from({ length: 10 }).map((N, E) => `skeleton-row-${E}`).map((N) => /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(Zt, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(An, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, N)) : ((R = x.getRowModel().rows) == null ? void 0 : R.length) > 0 ? M = x.getRowModel().rows.map((C) => /* @__PURE__ */ r(
    ...
    /* @__PURE__ */ c(Qe, { stickyHeader: s, children: [
      /* @__PURE__ */ r(tn, { stickyHeader: s, children: x.getHeaderGroups().map((C) => /* @__PURE__ */ r(Dt, { children: C.headers.map((I) => /* @__PURE__ */ r(Ae, { children: I.isPlaceholder ? void 0 : De(I.column.columnDef.header, I.getContext()) }, I.id)) }, C.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r($, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Vr, {}) })
        ] }),
  ...
  return /* @__PURE__ */ r("div", { id: k, className: g, children: /* @__PURE__ */ c(se, { open: I, onOpenChange: p ?? T, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ c(
      $,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ar, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(oe, { children: [
      ...
      /* @__PURE__ */ c(ae, { children: [
        ...
        /* @__PURE__ */ r(zt, { children: M.map((E) => /* @__PURE__ */ c(
          Ft,
          {
            value: E.label,
            onSelect: x,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ r(Ta, { className: "tw-h-4 tw-w-4" }),
...
function kl({
  ...
  const s = Sr(), [i, l] = D(t), [d, w] = D(n);
  return Y(() => {
    l(t);
  }, [t]), Y(() => {
    d !== n && w(n);
  }, [n]), /* @__PURE__ */ c(le, { onOpenChange: (f) => {
    f || (i !== "custom" || d ? (e(i), o(d)) : (l(t), w(n)));
  }, children: [
    ...
    /* @__PURE__ */ c(Ht, { className: "tw-z-[300]", children: [
...
function Vc({
  ...
  const l = et(null), d = Sr(), [w, p] = D("generated"), [f, h] = D("*"), [m, g] = D("f"), y = B(
    () => ({
      ...s,
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ r(Ts, { options: y, onScrRefChange: () => {
          }, scrRef: o, ref: l }),
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(It, { children: /* @__PURE__ */ c(Lt, { children: [
            /* @__PURE__ */ r(Wt, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: S, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Vr, {}) }) }),
...
function $c({
  ...
  const f = p ? Dl(p, "%webView_footnoteList_header%") : "Footnotes", h = d ?? Za(n, void 0), m = (x, _) => {
    w == null || w(x, _, a);
...
function Xc({
  ...
  }, [M, F]), q = B(() => V.length === 0 ? [] : Al(V, C, N), [V, C, N]), O = B(() => {
    var wt, it;
    if (!M) return d;
...
const $l = "16rem", Ll = "3rem", Po = b.createContext(void 0);
function rn() {
...
const $t = "scrBook", tw = "scrRef", Yt = "source", ew = "details", nw = "Scripture Reference", rw = "Scripture Book", Ho = "Type", ow = "Details";
function aw(t, e) {
  const n = e ?? !1;
  return [
    {
...
function Uc({
  ...
  const [w, p] = D([]), [f, h] = D([{ id: $t, desc: !1 }]), [m, g] = D({}), y = B(
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ c(
      fe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(re, { position: "item-aligned", children: /* @__PURE__ */ r(al, { children: _.map((N) => /* @__PURE__ */ r(vt, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Qe, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(tn, { children: S.getHeaderGroups().map((N) => /* @__PURE__ */ r(Dt, { children: N.headers.filter((E) => E.column.columnDef.header).map((E) => (
        ...
        /* @__PURE__ */ r(Ae, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
          ...
          " ",
          De(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, N.id)) }),
                  ...
                  Object.values(H).map((V, q) => {
                    ...
                    if (O.length !== 0)
                      return /* @__PURE__ */ c(Dr, { children: [
                        ...
                        q < Object.values(H).length - 1 && /* @__PURE__ */ r(no, {})
                      ] }, V);
                  })
                ] })
              ]
...
function qc({
  ...
  const w = Kt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Kt(i, "%webView_scope_selector_current_book%"), m = Kt(i, "%webView_scope_selector_choose_books%"), g = Kt(i, "%webView_scope_selector_scope%"), y = Kt(i, "%webView_scope_selector_select_books%"), k = [
      ...
      /* @__PURE__ */ r(
        Jn,
        {
          ...
          children: S.map(({ value: T, label: x, id: _ }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Ue, { className: "tw-me-2", value: T, id: _ }),
...
const Uo = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Wt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    ...
    /* @__PURE__ */ r(Qi, { children: /* @__PURE__ */ r(Io, { children: Uo(
      t,
      e,
      Ko(t, l.id),
      o
...
function Bn({
  ...
  return /* @__PURE__ */ c(le, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(Dr, { children: [
...
function nd({
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(qo, { children: [
      /* @__PURE__ */ r(Jo, { children: t.map((l) => /* @__PURE__ */ r(ww, { value: l.value, children: l.value }, l.key)) }),
...
const uw = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ c(
    Q.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(Je, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
  ...
  if (Rs(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Ee(i, [h, m]);
        break;
      case "alt+n":
        (k = l.current) == null || k.focus(), Ee(l, [h, m]);
        break;
      case "alt+h":
        (S = d.current) == null || S.focus(), Ee(d, [h, m]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(Zo, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(cw, { children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ c(le, { children: [
              /* @__PURE__ */ r(ye, { className: u(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r($, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Mr, {}) }) }),
...
const wd = tt.Root, cd = tt.Trigger, dd = tt.Group, pd = tt.Portal, ud = tt.Sub, md = tt.RadioGroup, kw = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  tt.SubTrigger,
  {
    ref: a,
    className: u(
...
const hd = Nt.Trigger, Mw = Nt.Portal, fd = Nt.Close, ia = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Nt.Overlay,
  {
    ref: n,
