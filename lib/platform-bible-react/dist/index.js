...
import m, { forwardRef as Ze, useRef as nt, useMemo as H, useState as I, useCallback as B, useLayoutEffect as Rn, createContext as Wr, useContext as Zr, useEffect as Rt, Fragment as Gn } from "react";
import { Command as it } from "cmdk";
import { X as Qe, Search as Fn, Check as Tt, Clock as Tn, ChevronsLeft as En, ChevronsRight as Vn, ChevronLeft as $e, ChevronRight as Ft, ArrowLeft as Qr, ArrowRight as ta, Circle as be, ChevronsUpDown as tn, FilterIcon as ea, ChevronDown as ve, ChevronUp as na, ArrowLeftIcon as ra, ChevronLeftIcon as aa, ChevronRightIcon as oa, ArrowRightIcon as sa, Copy as ia, Filter as wa, User as la, Link as ca, CircleHelp as da, Star as pa, AlertCircle as je, CircleCheckIcon as ua, CircleXIcon as ma, CircleHelpIcon as ha, ArrowUpIcon as fa, ArrowDownIcon as ga, ArrowUpDownIcon as ba, PanelLeft as va, PanelRight as xa, ScrollText as ya, MenuIcon as Na, Menu as ka, EllipsisVertical as Ca, LoaderCircle as _a, GripVertical as Sa } from "lucide-react";
import { clsx as Ra } from "clsx";
import { extendTailwindMerge as Ta } from "tailwind-merge";
import * as xt from "@radix-ui/react-dialog";
import { includes as ue, Section as M, getChaptersForBook as Ea, formatScrRef as Lt, getSectionForBook as ae, NumberFormat as Va, formatBytes as Ma, getCurrentLocale as Da, getFormatCallerFunction as Ia, deepEqual as en, isString as Ve, compareScrRefs as Be, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
import { useReactTable as Hn, getFilteredRowModel as Oa, getSortedRowModel as Yn, getPaginationRowModel as Pa, getCoreRowModel as Un, flexRender as oe, getGroupedRowModel as Aa, getExpandedRowModel as za } from "@tanstack/react-table";
...
import * as Kn from "@radix-ui/react-toggle";
import * as qn from "@radix-ui/react-separator";
...
const Xa = xt.Portal, Jn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  xt.Overlay,
  {
    ref: n,
    className: d(
...
Jn.displayName = xt.Overlay.displayName;
...
Ha.displayName = xt.Content.displayName;
...
Ya.displayName = xt.Title.displayName;
...
Ua.displayName = xt.Description.displayName;
...
Pt.displayName = it.Group.displayName;
...
Wn.displayName = it.Separator.displayName;
const jt = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  it.Item,
  {
    ref: n,
...
var rr = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(rr || {});
const st = class D {
  constructor(e, n, a, o) {
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Dt(i)), n ? new D(n, a.toString(), w, u) : new D();
  }
  /**
...
const or = $.allBookIds.filter(
  (t) => !$.isObsolete($.bookIdToNumber(t))
), Ot = Object.fromEntries(
  or.map((t) => [t, $.bookIdToEnglishName(t)])
);
function wn(t, e, n) {
...
const sr = Ze(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Ut : "button", { className: d(io({ variant: e, size: n, className: t })), ref: s, ...o })
);
O.displayName = "Button";
const Zt = se.Root, Qt = se.Trigger, Bt = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = tt();
...
function wo({
  ...
  return /* @__PURE__ */ l(Zt, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(Bt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(Pt, { heading: s, children: t.map((p) => /* @__PURE__ */ l(
      jt,
      {
        onSelect: () => c(p),
...
function On({
  ...
  if (t)
    return /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r("div", { className: d("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: vt(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      jt,
      {
        value: `${t} ${Ot[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Oi({
  ...
  const c = tt(), [p, g] = I(!1), [h, f] = I(""), [b, y] = I(""), [v, S] = I("books"), [N, C] = I(void 0), [j, W] = I(!1), L = nt(void 0), at = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), U = B(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
  ), P = H(() => a ? a() : or, [a]), lt = H(() => ({
    [M.OT]: P.filter((A) => $.isBookOT(A)),
    [M.NT]: P.filter((A) => $.isBookNT(A)),
    [M.DC]: P.filter((A) => $.isBookDC(A)),
    [M.Extra]: P.filter((A) => $.extraBooks().includes(A))
    ...
    (x) => {
      const A = v === "chapters" ? N : k == null ? void 0 : k.book;
      A && (U({
        book: A,
        chapterNum: x,
        verseNum: 1
    ...
    (x) => {
      if (x.ctrlKey) return;
      const { isLetter: A, isDigit: J } = In(x.key);
      if (v === "chapters") {
        if (x.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            yt = ot === 0 ? Vt : Math.max(1, ot - Sn);
            break;
          case "ArrowDown":
            yt = ot === 0 ? 1 : Math.min(Vt, ot + Sn);
            break;
          default:
            return;
        }
    ...
    const { isLetter: A, isDigit: J } = In(x.key);
    (A || J) && (x.preventDefault(), y((rt) => rt + x.key), at.current.focus(), W(!1));
  }, []);
  return Rn(() => {
    const x = setTimeout(() => {
      if (p && v === "books" && pt.current && _.current) {
        const A = pt.current, J = _.current, rt = J.offsetTop, ot = A.clientHeight, Vt = J.clientHeight, yt = rt - ot / 2 + Vt / 2;
        A.scrollTo({
          top: Math.max(0, yt),
          behavior: "smooth"
        }), f(Xe(t.book));
    ...
    /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ r(
      O,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: Ur })
      }
    ) }),
      ...
      qt,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: q.map(({ onClick: x, disabled: A, title: J, icon: rt }) => /* @__PURE__ */ r(
              O,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              O,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ r(Qr, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ta, { className: "tw-h-4 tw-w-4" })
              }
            ),
          ...
          !j && /* @__PURE__ */ l(Jt, { ref: pt, children: [
            v === "books" && /* @__PURE__ */ l(bt, { children: [
              !k && Object.entries(et).map(([x, A]) => {
                if (A.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Pt, { heading: Hr(x), children: A.map((J) => /* @__PURE__ */ r(
                      sr,
                      {
                        bookId: J,
                        onSelect: (rt) => ft(rt),
              ...
              k && /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r(
                jt,
                {
                  value: `${k.book} ${Ot[k.book]} ${k.chapterNum || ""}:${k.verseNum || ""})}`,
                  onSelect: K,
...
), Q = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Xn.Root, { ref: n, className: d("pr-twp", uo(), t), ...e }));
Q.displayName = Xn.Root.displayName;
...
function zi({
  ...
  const p = Ie(c, "%webView_bookSelector_currentBook%"), g = Ie(c, "%webView_bookSelector_choose%"), h = Ie(c, "%webView_bookSelector_chooseBooks%"), [f, b] = I(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    b(v), t(v);
...
}), ir = G.Trigger, wr = G.Group, go = G.Portal, bo = G.Sub, vo = G.RadioGroup;
function dn({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(cn.Provider, { value: n, children: /* @__PURE__ */ r(G.Root, { ...e }) });
}
const lr = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ht();
  return /* @__PURE__ */ l(
    G.SubTrigger,
    {
...
lr.displayName = G.SubTrigger.displayName;
...
cr.displayName = G.SubContent.displayName;
...
const dr = m.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = tt(), s = ht();
  return /* @__PURE__ */ r(
    G.Item,
    {
...
const pn = m.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ht();
  return /* @__PURE__ */ l(
    G.CheckboxItem,
    {
...
const pr = m.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ht();
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
...
pr.displayName = G.RadioItem.displayName;
const un = m.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: a,
...
function yo({ table: t }) {
  return /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r($a, { asChild: !0, children: /* @__PURE__ */ l(O, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ea, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Xt = Y.Root, No = Y.Group, Ht = Y.Value, ko = Et(
...
const ur = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Y.ScrollUpButton,
  {
    ref: n,
    className: d("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ r(na, { className: "tw-h-4 tw-w-4" })
  }
));
ur.displayName = Y.ScrollUpButton.displayName;
...
mr.displayName = Y.ScrollDownButton.displayName;
...
_o.displayName = Y.Separator.displayName;
function So({ table: t }) {
      ...
      /* @__PURE__ */ l(
        O,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(oa, { className: "tw-h-4 tw-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ l(
...
function Io({
  ...
  var S;
  const [u, c] = I([]), [p, g] = I([]), [h, f] = I({}), [b, y] = I({}), v = Hn({
    data: e,
    columns: t,
    getCoreRowModel: Un(),
    ...n && { getPaginationRowModel: Pa() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", id: w, children: [
    ...
    n && a && /* @__PURE__ */ r(So, { table: v })
  ] });
}
function $i({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = H(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(ja, { options: o, children: e }) });
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(O, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(ia, {}) })
        ] }),
...
function Bi({
  ...
  return /* @__PURE__ */ l(Zt, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ l(Bt, { id: s, className: d("tw-min-w-80 tw-max-w-96", o), children: [
...
function Li({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r(ir, { asChild: !0, children: /* @__PURE__ */ l(O, { variant: "default", children: [
      /* @__PURE__ */ r(wa, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ve, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(Ne, { children: n.map((c, p) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(un, { children: c.label }),
      /* @__PURE__ */ r(wr, { children: c.itemType === 0 ? /* @__PURE__ */ r(bt, { children: c.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        pn,
        {
          checked: a[p][h],
        ...
        vo,
        {
          ...
          children: c.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(pr, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(ke, {})
    ] }, c.label)) })
  ...
  return /* @__PURE__ */ r("div", { id: g, className: p, children: /* @__PURE__ */ l(Zt, { open: h, onOpenChange: f, children: [
    ...
    /* @__PURE__ */ r(Bt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(qt, { children: [
      ...
      /* @__PURE__ */ l(Jt, { children: [
        ...
        /* @__PURE__ */ r(Pt, { children: v.map((S) => {
          ...
          return /* @__PURE__ */ l(
            jt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: S.starred && /* @__PURE__ */ r(pa, { className: "tw-h-4 tw-w-4" }) }),
...
const Ye = d("marker", "marker-visible'}");
function Ue(t, e, n = !0, a = !0, o = []) {
  if (!(!e || e.length === 0))
    return e.map((s) => {
      ...
      return i += `-${s.marker ?? "unknown"}`, Bo(s, i, n, [
        ...o,
        t ?? "unknown"
      ]);
    });
...
function Lo({
  ...
  const u = a ? /* @__PURE__ */ r("span", { className: Ye, children: `\\${t.marker} ` }) : void 0, c = a ? /* @__PURE__ */ r("span", { className: Ye, children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(bt, { children: [
...
function Hi({
  ...
  const p = c ? Uo(c, "%webView_footnoteList_header%") : "Footnotes", g = w ?? Ia(e, void 0), h = (f) => {
    u && u(f);
  };
  return /* @__PURE__ */ l(bt, { children: [
...
const fr = Et(
  ...
  {
    ref: o,
    className: d(fr({ variant: e, size: n, className: t })),
    ...a
  }
));
qo.displayName = Kn.Root.displayName;
const gr = m.createContext({
  size: "default",
  variant: "default"
}), br = m.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = tt();
  return /* @__PURE__ */ r(
    xe.Root,
    {
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(fa, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ga, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ba, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Yi = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(br, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        me,
        {
          onClick: (u) => {
  ...
  return e ? e[1] : "";
}, Wo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Zi = Object.freeze([
...
function Qi({
  ...
  const p = Nt(n, "%webView_inventory_all%"), g = Nt(n, "%webView_inventory_approved%"), h = Nt(n, "%webView_inventory_unapproved%"), f = Nt(n, "%webView_inventory_unknown%"), b = Nt(n, "%webView_inventory_scope_currentBook%"), y = Nt(n, "%webView_inventory_scope_chapter%"), v = Nt(n, "%webView_inventory_scope_verse%"), S = Nt(n, "%webView_inventory_filter_text%"), N = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, j] = I(!1), [W, L] = I("all"), [at, pt] = I(""), [_, E] = I([]), U = H(() => t.length === 0 ? [] : Qo(t, o, s), [t, o, s]), P = H(() => {
    if (C) return U;
    const T = [];
    return U.forEach((Z) => {
...
hn.displayName = qn.Root.displayName;
...
const fn = ce.Provider, gn = ce.Root, bn = ce.Trigger, Te = m.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ce.Content,
  {
    ref: a,
    sideOffset: e,
...
const ts = "16rem", es = "3rem", vr = m.createContext(void 0);
function Ee() {
  const t = m.useContext(vr);
  if (!t)
...
const xr = m.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(vr.Provider, { value: N, children: /* @__PURE__ */ r(fn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
xr.displayName = "SidebarProvider";
const yr = m.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Ee();
...
const ns = m.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    O,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(va, {}) : /* @__PURE__ */ r(xa, {}),
...
_r.displayName = "SidebarMenuItem";
const ls = Et(
...
function fs({
  ...
  return /* @__PURE__ */ r(
    yr,
    {
      ...
      children: /* @__PURE__ */ l(kr, { children: [
        /* @__PURE__ */ l(Ke, { children: [
          /* @__PURE__ */ r(qe, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Je, { children: /* @__PURE__ */ r(Cr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(_r, { children: /* @__PURE__ */ r(
            Sr,
            {
              onClick: () => c(h),
              isActive: g(h),
...
const _t = "scrBook", gs = "scrRef", It = "source", bs = "details", vs = "Scripture Reference", xs = "Scripture Book", Rr = "Type", ys = "Details";
function Ns(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? $.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === _t ? Lt(o.start) : void 0;
      },
...
function ew({
  ...
  const [c, p] = I([]), [g, h] = I([{ id: _t, desc: !1 }]), [f, b] = I({}), y = H(
  ...
  Rt(() => {
    if (w) {
      ...
      if (E.length === 1) {
        const U = y.find((P) => $n(P) === E[0]) || void 0;
        U && w(U);
      }
    }
  }, [f, y, w, S]);
  const N = o ?? xs, C = s ?? Rr, j = [
    ...
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r($t, { position: "item-aligned", children: /* @__PURE__ */ r(No, { children: j.map((_) => /* @__PURE__ */ r(ut, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ l(
                      O,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ r(Ft, {}) : /* @__PURE__ */ r($e, {})),
                          " ",
...
}), Tr = (t, e, n) => xn(t, e).every((a) => n.includes(a));
function Cs({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    O,
    {
      ...
      onClick: () => a(t),
      className: d(
        Tr(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: so(
        t,
...
function _s({
  ...
  }, [v, S] = I(!1), [N, C] = I(""), j = nt(void 0), W = nt(!1);
  ...
  const L = H(() => $.allBookIds.filter(
    ...
    (R) => {
      ...
      n(
        Tr(L, R, e) ? e.filter((k) => !et.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...et])]
      );
    },
    [e, n, L]
  ), P = () => {
                  ...
                  Object.values(M).map((R, et) => {
                    ...
                    if (k.length !== 0)
                      return /* @__PURE__ */ l(Gn, { children: [
                        ...
                        et < Object.values(M).length - 1 && /* @__PURE__ */ r(Wn, {})
                      ] }, R);
                  })
                ] })
              ]
...
function rw({
  ...
  const c = Mt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Mt(i, "%webView_scope_selector_current_book%"), f = Mt(i, "%webView_scope_selector_choose_books%"), b = Mt(i, "%webView_scope_selector_scope%"), y = Mt(i, "%webView_scope_selector_select_books%"), v = [
...
const Vr = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(bn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(lr, { children: w.label }),
    /* @__PURE__ */ r(go, { children: /* @__PURE__ */ r(cr, { children: Vr(
      t,
      e,
      Er(t, w.id),
      a
...
function We({
  ...
  return /* @__PURE__ */ l(dn, { variant: s, children: [
    /* @__PURE__ */ r(ir, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(O, { variant: i, size: "icon", children: a ?? /* @__PURE__ */ r(Na, {}) }) }),
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, c]) => typeof u == "boolean" || typeof c == "boolean" ? 0 : u.order - c.order).map(([u], c, p) => /* @__PURE__ */ l(Gn, { children: [
      /* @__PURE__ */ r(wr, { children: /* @__PURE__ */ r(fn, { children: Vr(e.groups, e.items, u, t) }) }),
...
function ww({
  ...
  return /* @__PURE__ */ l(Mr, { className: `tw-w-full tw-border ${s}`, id: o, children: [
    n && /* @__PURE__ */ r(
      We,
      {
        onSelectMenuItem: t,
...
Ir.displayName = wt.List.displayName;
...
)), Or = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Content,
  {
    ref: n,
    className: d(
...
Or.displayName = wt.Content.displayName;
function cw({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Dr, { children: [
      /* @__PURE__ */ r(Ir, { children: t.map((w) => /* @__PURE__ */ r(Ss, { value: w.value, children: w.value }, w.key)) }),
      t.map((w) => /* @__PURE__ */ r(Or, { value: w.value, children: w.content }, w.key))
    ] })
  ] });
}
function Rs({ ...t }) {
...
const Pr = m.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  ...
  return /* @__PURE__ */ r(cn.Provider, { value: o, children: /* @__PURE__ */ r(
    F.Root,
    {
      ref: a,
      className: d(
...
Pr.displayName = F.Root.displayName;
...
Ar.displayName = F.Trigger.displayName;
const zr = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ht();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
zr.displayName = F.SubTrigger.displayName;
...
$r.displayName = F.SubContent.displayName;
const jr = m.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ht();
...
jr.displayName = F.Content.displayName;
const Br = m.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = ht();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
Br.displayName = F.Item.displayName;
...
function Ds({
  ...
  const o = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), u = nt(void 0), c = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (Ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, g) => {
    var b, y, v, S;
    p.preventDefault();
    ...
    return /* @__PURE__ */ r(Pr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, g]) => typeof p == "boolean" || typeof g == "boolean" ? 0 : p.order - g.order).map(([p, g]) => /* @__PURE__ */ l(Rs, { children: [
      /* @__PURE__ */ r(Ar, { ref: c(p), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        jr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(fn, { children: Gr(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
const Ps = Ze(({ className: t, ...e }, n) => /* @__PURE__ */ r(_a, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
Bs.displayName = Kt.Root.displayName;
...
const fw = X.Root, gw = X.Trigger, bw = X.Group, vw = X.Portal, xw = X.Sub, yw = X.RadioGroup, Fs = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: o,
    className: d(
...
const Nw = mt.Trigger, Qs = mt.Portal, kw = mt.Close, Xr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
...
Xr.displayName = mt.Overlay.displayName;
const ti = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = m.useContext(Fr), i = {
...
function si({
  ...
  return /* @__PURE__ */ r(
    nn.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Sa, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
const Ln = 50;
function Cw({
  ...
  const [w, u] = I(() => {
    const c = localStorage.getItem(t), p = c ? Number(c) : NaN;
    return !Number.isNaN(p) && p >= 0 && p <= 100 ? p : a <= 0 || a > 100 ? (console.warn(
      `PersistedResizableGroup: invalid defaultSize "${a}" - Expected number (as percentage) in range 0-100. Falling back to 50%.`
    ), Ln) : a;
  });
  return Rt(() => {
    localStorage.setItem(t, String(w));
  }, [w, t]), /* @__PURE__ */ r("div", { className: d("w-full h-full", e), children: /* @__PURE__ */ l(oi, { direction: o, children: [
    /* @__PURE__ */ r(Bn, { defaultSize: w, onResize: u, children: i[0] }),
    /* @__PURE__ */ r(si, { withHandle: s, className: n }),
    /* @__PURE__ */ r(Bn, { children: i[1] })
  ] }) });
}
const ii = m.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Ge.Root,
  {
    ref: a,
    className: d(
...
ii.displayName = Ge.Root.displayName;
function _w({ ...t }) {
  return /* @__PURE__ */ r(
    La,
    {
...
wi.displayName = re.Root.displayName;
const li = m.forwardRef(({ className: t, ...e }, n) => {
  const a = tt();
  return /* @__PURE__ */ r(
    Fe.Root,
    {
...
li.displayName = Fe.Root.displayName;
const Sw = wt.Root, ci = m.forwardRef(({ className: t, ...e }, n) => {
  const a = tt();
  return /* @__PURE__ */ r(
    wt.List,
    {
...
di.displayName = wt.Trigger.displayName;
...
const hi = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = I(void 0), [w, u] = I(void 0), c = B(
    (h) => {
      i(h);
...
export {
  ...
  ji as ERROR_POPOVER_STRING_KEYS,
  Po as ErrorDump,
  Bi as ErrorPopover,
  Xi as Filter,
  ...
  Gi as MoreInfo,
  jo as MultiSelectComboBox,
  cw as NavigationContentSearch,
  Cw as PersistedSplitPanels,
  Zt as Popover,
  ...
  si as ResizableHandle,
  Bn as ResizablePanel,
