...
import S, { forwardRef as Qn, useCallback as kt, useState as ut, useRef as ge, useEffect as ae, useLayoutEffect as Qo, useMemo as $t } from "react";
...
import { MenuItem as Al, ListItemText as Ml, ListItemIcon as oi, Menu as Dl, Grid as ai, List as Bl, IconButton as ii, Drawer as jl, AppBar as Vl, Toolbar as zl } from "@mui/material";
...
const wo = wt.Root, wi = wt.Trigger, oc = wt.Group, nh = wt.Portal, rh = wt.Sub, oh = wt.RadioGroup, ac = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  wt.SubTrigger,
  {
    ref: o,
    className: N(
...
const rr = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(wt.Portal, { children: /* @__PURE__ */ s(
  wt.Content,
  {
    ref: r,
    sideOffset: e,
...
const fi = S.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ s(
  wt.Item,
  {
    ref: r,
    className: N(
...
const fo = S.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ x(
  wt.CheckboxItem,
  {
    ref: o,
    className: N(
...
const mi = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(
  wt.RadioItem,
  {
    ref: r,
    className: N(
...
const Sn = S.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ s(
  wt.Label,
  {
    ref: r,
...
function ah({ scrRef: t, handleSubmit: e }) {
  const [n, r] = ut(""), [o, a] = ut(
    ot.bookNumberToId(t.bookNum)
  ), [i, l] = ut(t.chapterNum ?? 0), [c, d] = ut(
    ot.bookNumberToId(t.bookNum)
  ), [p, f] = ut(!1), [w, g] = ut(p), v = ge(void 0), m = ge(void 0), h = ge(void 0), T = kt(
    (k) => fc(k).filter((B) => {
      const M = ot.bookIdToEnglishName(B).toLowerCase(), J = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    wc.forEach((k) => {
      const B = n.match(k);
      if (B) {
        const [M, J = void 0, q = void 0] = B.slice(1), U = gc(M);
    ...
    /* @__PURE__ */ x(
      rr,
      {
        ...
        children: [
          ...
          na.map(
            (k, B) => T(k).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ s(Sn, { className: "tw-font-semibold tw-text-foreground/80", children: pc[k] }),
              T(k).map((M) => /* @__PURE__ */ s("div", { children: /* @__PURE__ */ s(
                lc,
                {
                  bookId: M,
              ...
              na.length - 1 !== B ? /* @__PURE__ */ s(or, {}) : void 0
            ] }, k)
          )
        ]
      }
...
), Ht = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(Za.Root, { ref: n, className: N("pr-twp", vc(), t), ...e }));
Ht.displayName = Za.Root.displayName;
const hi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  fn.Root,
  {
...
const Yr = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  fn.Item,
  {
    ref: n,
    className: N(
...
const yc = mn.Root, xc = mn.Trigger, gi = S.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(mn.Portal, { children: /* @__PURE__ */ s(
  mn.Content,
  {
    ref: o,
    align: e,
...
const Nc = Yt.Portal, bi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Yt.Overlay,
  {
    ref: n,
    className: N(
...
const kc = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(Nc, { children: [
  /* @__PURE__ */ s(bi, {}),
  /* @__PURE__ */ x(
    Yt.Content,
    {
...
const vi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Ot,
  {
    ref: n,
    className: N(
...
const yi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
...
const xi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Ot.List,
  {
    ref: n,
...
const Ni = S.forwardRef((t, e) => /* @__PURE__ */ s(Ot.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
const ki = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Ot.Item,
  {
    ref: n,
    className: N(
...
const hn = bt.Root, $c = bt.Group, gn = bt.Value, De = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(
  bt.Trigger,
  {
    ref: r,
    className: N(
...
const Ei = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  bt.ScrollUpButton,
  {
    ref: n,
...
const Si = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  bt.ScrollDownButton,
  {
    ref: n,
    className: N("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
...
const Be = S.forwardRef(({ className: t, children: e, position: n = "popper", ...r }, o) => /* @__PURE__ */ s(bt.Portal, { children: /* @__PURE__ */ x(
  bt.Content,
  {
    ref: o,
    className: N(
...
const Ut = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(
  bt.Item,
  {
    ref: r,
    className: N(
      ...
      /* @__PURE__ */ x(
        hn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s(Be, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ s(Ut, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const bn = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "th",
  {
    ref: n,
    className: N(
...
const je = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "td",
  {
    ref: n,
...
function jc({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(ar, { stickyHeader: a, children: [
      /* @__PURE__ */ s(ir, { stickyHeader: a, children: m.getHeaderGroups().map((T) => /* @__PURE__ */ s(oe, { children: T.headers.map((A) => /* @__PURE__ */ s(bn, { children: A.isPlaceholder ? void 0 : cn(A.column.columnDef.header, A.getContext()) }, A.id)) }, T.id)) }),
      /* @__PURE__ */ s(sr, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((T) => /* @__PURE__ */ s(
        oe,
        {
          onClick: () => i(T, m),
          "data-state": T.getIsSelected() && "selected",
          children: T.getVisibleCells().map((A) => /* @__PURE__ */ s(je, { children: cn(A.column.columnDef.cell, A.getContext()) }, A.id))
        },
        T.id
...
const mo = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Hr.Root,
  {
    ref: n,
    className: N(
...
), Uc = S.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  ni.Root,
  {
    ref: o,
...
const Ci = S.createContext({
  size: "default",
  variant: "default"
}), Oi = S.forwardRef(({ className: t, variant: e, size: n, children: r, ...o }, a) => /* @__PURE__ */ s(
  nr.Root,
  {
    ref: a,
...
const lr = (t) => t === "asc" ? /* @__PURE__ */ s(cl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(dl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(pl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), lh = (t) => ({
  accessorKey: "item",
...
function uh({
  ...
  const f = Jt(n, "%webView_inventory_all%"), w = Jt(n, "%webView_inventory_approved%"), g = Jt(n, "%webView_inventory_unapproved%"), v = Jt(n, "%webView_inventory_unknown%"), m = Jt(n, "%webView_inventory_scope_currentBook%"), h = Jt(n, "%webView_inventory_scope_chapter%"), T = Jt(n, "%webView_inventory_scope_verse%"), A = Jt(n, "%webView_inventory_filter_text%"), R = Jt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [$, z] = ut("all"), [H, C] = ut(""), [P, k] = ut([]), B = $t(() => l ? r instanceof RegExp ? Xc(
    l,
    t,
    a,
    i,
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ x(hn, { onValueChange: (y) => tt(y), defaultValue: c, children: [
        ...
        /* @__PURE__ */ x(Be, { children: [
          ...
          /* @__PURE__ */ s(Ut, { value: "verse", children: T })
        ] })
      ] }),
      /* @__PURE__ */ s(
        Xe,
...
)), $i = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Rt.Content,
  {
    ref: n,
    className: N(
...
const ho = S.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ s(
  ri.Root,
  {
    ref: o,
    decorative: n,
...
const Wc = En.Provider, qc = En.Root, Kc = En.Trigger, Ii = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  En.Content,
  {
    ref: r,
    sideOffset: e,
...
const Jc = "16rem", Zc = "3rem", Qc = "b", Ai = S.createContext(void 0);
function cr() {
  const t = S.useContext(Ai);
  if (!t)
...
const Mi = S.forwardRef(
  ({
    ...
    const [c, d] = S.useState(t), p = e ?? c, f = S.useCallback(
      (m) => {
        const h = typeof m == "function" ? m(p) : m;
        n ? n(h) : d(h);
      },
      [n, p]
    ), w = S.useCallback(() => f((m) => !m), [f]);
    S.useEffect(() => {
      const m = (h) => {
        h.key === Qc && (h.metaKey || h.ctrlKey) && (h.preventDefault(), w());
      };
      return window.addEventListener("keydown", m), () => window.removeEventListener("keydown", m);
    }, [w]);
    const g = p ? "expanded" : "collapsed", v = S.useMemo(
      () => ({
        state: g,
        open: p,
        setOpen: f,
...
const td = S.forwardRef(({ className: t, onClick: e, ...n }, r) => {
...
const ad = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ho,
  {
    ref: n,
...
const id = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? He : "button",
  {
    ref: r,
...
const ld = S.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ s(
  e ? He : "button",
  {
    ref: o,
...
const dd = S.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
...
const wd = S.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ s(
  t ? He : "a",
  {
    ref: a,
...
function fd({
  ...
  return /* @__PURE__ */ s(
    Di,
    {
      ...
      children: /* @__PURE__ */ x(ji, { children: [
...
function fh({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-box-border tw-flex tw-h-full tw-flex-col tw-p-3", children: [
    ...
    /* @__PURE__ */ x(Mi, { id: t, className: "tw-h-full tw-flex-1 tw-gap-4 tw-overflow-auto", children: [
      ...
      /* @__PURE__ */ s(Bi, { className: "tw-overflow-y-auto", children: r })
    ] })
  ] });
}
const ne = "scrBook", md = "scrRef", we = "source", hd = "details", gd = "Scripture Reference", bd = "Scripture Book", Fi = "Type", vd = "Details";
function yd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, aa = (t) => `${xd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function mh({
  sources: t,
  ...
  ae(() => {
    if (l) {
      const C = T.getSelectedRowModel().rowsById, P = Object.keys(C);
      if (P.length === 1) {
        const k = m.find((B) => aa(B) === P[0]) || void 0;
        k && l(k);
      }
    }
  }, [g, m, l, T]);
  const A = o ?? bd, R = a ?? Fi, E = [
    ...
    !e && /* @__PURE__ */ x(
      hn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(Be, { position: "item-aligned", children: /* @__PURE__ */ s($c, { children: E.map((C) => /* @__PURE__ */ s(Ut, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(ar, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(ir, { children: T.getHeaderGroups().map((C) => /* @__PURE__ */ s(oe, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
      ...
      /* @__PURE__ */ s(sr, { children: T.getRowModel().rows.map((C, P) => /* @__PURE__ */ s(
        oe,
        {
...
function Sd() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = i, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = v, it.Memo = g, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = f, it.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === f || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === i || b.$$typeof === l || b.$$typeof === p || b.$$typeof === h || b.$$typeof === T || b.$$typeof === A || b.$$typeof === m);
  }, it.typeOf = R, it;
}
var st = {};
/** @license React v16.13.1
...
function Td() {
  return sa || (sa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function R(I) {
      ...
      I === r || I === d || I === a || I === o || I === f || I === w || typeof I == "object" && I !== null && (I.$$typeof === v || I.$$typeof === g || I.$$typeof === i || I.$$typeof === l || I.$$typeof === p || I.$$typeof === h || I.$$typeof === T || I.$$typeof === A || I.$$typeof === m);
    }
    function E(I) {
    ...
    var b = c, $ = d, z = l, H = i, C = e, P = p, k = r, B = v, M = g, J = n, q = a, U = o, tt = f, at = !1;
    function rt(I) {
    ...
    st.AsyncMode = b, st.ConcurrentMode = $, st.ContextConsumer = z, st.ContextProvider = H, st.Element = C, st.ForwardRef = P, st.Fragment = k, st.Lazy = B, st.Memo = M, st.Portal = J, st.Profiler = q, st.StrictMode = U, st.Suspense = tt, st.isAsyncMode = rt, st.isConcurrentMode = y, st.isContextConsumer = O, st.isContextProvider = L, st.isElement = F, st.isForwardRef = V, st.isFragment = W, st.isLazy = X, st.isMemo = Y, st.isPortal = G, st.isProfiler = K, st.isStrictMode = Z, st.isSuspense = dt, st.isValidElementType = R, st.typeOf = E;
  }()), st;
}
var la;
function Hi() {
  return la || (la = 1, process.env.NODE_ENV === "production" ? jn.exports = Sd() : jn.exports = Td()), jn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Rd() {
  if (wa)
    return jr;
  wa = 1;
  var t = Hi(), e = Cd(), n = vo(), r = Xi(), o = Od(), a = function() {
  };
...
function jd() {
  return ha || (ha = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, m = !1, h = !1, T = !1, A = !1, R;
    R = Symbol.for("react.module.reference");
    function E(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || A || j === r || j === d || j === p || T || j === g || v || m || h || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === f || j.$$typeof === a || j.$$typeof === i || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var $ = i, z = a, H = t, C = c, P = n, k = w, B = f, M = e, J = o, q = r, U = d, tt = p, at = !1, rt = !1;
    function y(j) {
...
const Fd = u.oneOfType([u.func, u.object]), Ji = Fd;
function Wt(t) {
  if (typeof t != "string")
...
function is(t, e) {
  const n = as(t.theme);
  return Object.keys(t).map((r) => Sp(t, e, r, n)).reduce(pn, {});
}
function mt(t) {
  return is(t, wr);
}
...
const Cp = zt("border", Dt), Op = zt("borderTop", Dt), Rp = zt("borderRight", Dt), _p = zt("borderBottom", Dt), Pp = zt("borderLeft", Dt), $p = zt("borderColor"), Ip = zt("borderTopColor"), Ap = zt("borderRightColor"), Mp = zt("borderBottomColor"), Dp = zt("borderLeftColor"), Bp = zt("outline", Dt), jp = zt("outlineColor"), hr = (t) => {
...
mr(Cp, Op, Rp, _p, Pp, $p, Ip, Ap, Mp, Dp, hr, Bp, jp);
const gr = (t) => {
...
function So(t = {}, ...e) {
  ...
  return d.applyStyles = su, d = e.reduce((p, f) => Zt(p, f), d), d.unstable_sxConfig = _({}, ko, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return Eo({
      sx: f,
      theme: this
    });
...
const hu = So(), Sa = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Vn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function bu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const {
      ...
      overridesResolver: w = gu(Sa(d))
    } = l, g = Nt(l, wu), v = p !== void 0 ? p : (
    ...
    let T = Gn;
    d === "Root" || d === "root" ? T = r : d ? T = o : mu(i) && (T = void 0);
    const A = Pl(i, _({
      shouldForwardProp: T,
      label: h
      ...
      c && w && H.push((k) => {
        ...
        if (!B.components || !B.components[c] || !B.components[c].styleOverrides)
          return null;
        const M = B.components[c].styleOverrides, J = {};
        ...
        const M = Vn(_({}, k, {
          defaultTheme: n,
          themeId: e
        })), J = M == null || (B = M.components) == null || (B = B[c]) == null ? void 0 : B.variants;
        return Hn({
          variants: J
        }, _({}, k, {
          theme: M
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${Wt(d || "")}`), k === void 0 && (k = `Styled(${Ld(i)})`), P.displayName = k;
      }
...
const Tu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, $e = Au, Mu = ["mode", "contrastThreshold", "tonalOffset"], Oa = {
...
function Fu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Nt(t, Mu), a = t.primary || Du(e), i = t.secondary || Bu(e), l = t.error || ju(e), c = t.info || Vu(e), d = t.success || zu(e), p = t.warning || Lu(e);
  function f(m) {
...
`));
  ...
  const w = ({
    ...
    if (m = _({}, m), !m.main && m[T] && (m.main = m[T]), !m.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${h ? ` (${h})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${T}\` property.` : Ve(11, h ? ` (${h})` : "", T));
...
function Hu(t, e) {
  ...
  const g = o / 14, v = f || ((T) => `${T / d * g}rem`), m = (T, A, R, E, b) => _({
    fontFamily: r,
    fontWeight: T,
    fontSize: v(A),
...
const sw = (t) => Gn(t) && t !== "classes", lw = bu({
  themeId: Oo,
  defaultTheme: Co,
...
const dw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], pw = (t) => {
  ...
  const r = Ro({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = Nt(r, dw), v = /* @__PURE__ */ D.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
var us = go.default = void 0, bw = gw(hw()), vw = Xs;
us = go.default = (0, bw.default)(/* @__PURE__ */ (0, vw.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function yw(t) {
...
function Tw(t) {
  ...
  const i = Ew(_({}, o, r)), l = Ma(r), c = Ma(o), d = e(i), p = be(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
process.env.NODE_ENV !== "production" && (Kn["propTypes"] = Dd(Kn.propTypes));
var Tt = "top", jt = "bottom", Vt = "right", Ct = "left", Po = "auto", _n = [Tt, jt, Vt, Ct], Le = "start", xn = "end", Iw = "clippingParents", ms = "viewport", nn = "popper", Aw = "reference", Da = /* @__PURE__ */ _n.reduce(function(t, e) {
  return t.concat([e + "-" + Le, e + "-" + xn]);
}, []), hs = /* @__PURE__ */ [].concat(_n, [Po]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Le, e + "-" + xn]);
}, []), Mw = "beforeRead", Dw = "read", Bw = "afterRead", jw = "beforeMain", Vw = "main", zw = "afterMain", Lw = "beforeWrite", Fw = "write", Uw = "afterWrite", Gw = [Mw, Dw, Bw, jw, Vw, zw, Lw, Fw, Uw];
function qt(t) {
...
function Hw(t) {
  ...
  Object.keys(e.elements).forEach(function(n) {
    ...
    !Bt(a) || !qt(a) || (Object.assign(a.style, r), Object.keys(o).forEach(function(i) {
      var l = o[i];
...
function Xw(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Bt(o) || !qt(o) || (Object.assign(o.style, l), Object.keys(a).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
function Ue(t, e, n) {
  ...
  e && Bt(t) && (o = t.offsetWidth > 0 && Fe(r.width) / t.offsetWidth || 1, a = t.offsetHeight > 0 && Fe(r.height) / t.offsetHeight || 1);
...
function qw(t) {
  ...
  var o = xr(t);
  for ($o(o) && (o = o.host); Bt(o) && ["html", "body"].indexOf(qt(o)) < 0; ) {
    var a = te(o);
...
function Pn(t) {
  for (var e = At(t), n = Ba(t); n && Ww(n) && te(n).position === "static"; )
    n = Ba(n);
...
function Zw(t) {
  ...
  if (!(!a || !i)) {
    var f = Jw(o.padding, n), w = Io(a), g = c === "y" ? Tt : Ct, v = c === "y" ? jt : Vt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], T = Pn(a), A = T ? c === "y" ? T.clientHeight || 0 : T.clientWidth || 0 : 0, R = m / 2 - h / 2, E = f[g], b = A - w[p] - f[v], $ = A / 2 - w[p] / 2 + R, z = un(E, $, b), H = c;
...
function ja(t) {
  ...
  g = h.x, m = h.y;
  var T = i.hasOwnProperty("x"), A = i.hasOwnProperty("y"), R = Ct, E = Tt, b = window;
  if (d) {
  ...
  if (g = B.x, m = B.y, c) {
    var M;
    return Object.assign({}, k, (M = {}, M[E] = A ? "0" : "", M[R] = T ? "0" : "", M.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", M));
  }
  return Object.assign({}, k, (e = {}, e[E] = A ? m + "px" : "", e[R] = T ? g + "px" : "", e.transform = "", e));
}
function rf(t) {
...
function Ns(t) {
  return ["html", "body", "#document"].indexOf(qt(t)) >= 0 ? t.ownerDocument.body : Bt(t) && Bo(t) ? t : Ns(xr(t));
}
function wn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Ns(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = At(r), i = o ? [a].concat(a.visualViewport || [], Bo(r) ? r : []) : r, l = e.concat(i);
  return o ? l : (
...
function za(t, e, n) {
  return e === ms ? ro(df(t, n)) : ke(e) ? uf(e, n) : ro(pf(le(t)));
}
function wf(t) {
  var e = wn(xr(t)), n = ["absolute", "fixed"].indexOf(te(t).position) >= 0, r = n && Bt(t) ? Pn(t) : t;
...
function Nn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Iw : l, d = n.rootBoundary, p = d === void 0 ? ms : d, f = n.elementContext, w = f === void 0 ? nn : f, g = n.altBoundary, v = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, T = ys(typeof h != "number" ? h : xs(h, _n)), A = w === nn ? Aw : nn, R = t.rects.popper, E = t.elements[v ? A : w], b = ff(ke(E) ? E : E.contextElement || le(t.elements.popper), c, p, i), $ = Ue(t.elements.reference), z = ks({
    reference: $,
    element: R,
    strategy: "absolute",
    placement: o
  }), H = ro(Object.assign({}, R, z)), C = w === nn ? H : $, P = {
    top: b.top - C.top + T.top,
    bottom: C.bottom - b.bottom + T.bottom,
    left: b.left - C.left + T.left,
    right: C.right - b.right + T.right
  }, k = t.modifiersData.offset;
  if (w === nn && k) {
    var B = k[o];
    Object.keys(P).forEach(function(M) {
      var J = [Vt, jt].indexOf(M) >= 0 ? 1 : -1, q = [Tt, jt].indexOf(M) >= 0 ? "y" : "x";
      P[M] += B[q] * J;
    });
  }
  return P;
...
function gf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, T = Xt(h), A = T === h, R = c || (A || !v ? [Xn(h)] : hf(h)), E = [h].concat(R).reduce(function(V, W) {
      return V.concat(Xt(W) === Po ? mf(e, {
        placement: W,
        boundary: p,
        rootBoundary: f,
        padding: d,
      ...
      var k = E[P], B = Xt(k), M = Ge(k) === Le, J = [Tt, jt].indexOf(B) >= 0, q = J ? "width" : "height", U = Nn(e, {
        placement: k,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
        padding: d
      }), tt = J ? M ? Vt : Ct : M ? jt : Tt;
      b[q] > $[q] && (tt = Xn(tt));
      var at = Xn(tt), rt = [];
...
function Fa(t) {
  return [Tt, Vt, jt, Ct].some(function(e) {
    return t[e] >= 0;
  });
}
function vf(t) {
...
function Cf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = Nn(e, {
    ...
    padding: f,
    altBoundary: p
  }), T = Xt(e.placement), A = Ge(e.placement), R = !A, E = Ao(T), b = Tf(E), $ = e.modifiersData.popperOffsets, z = e.rects.reference, H = e.rects.popper, C = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, P = typeof C == "number" ? {
    mainAxis: C,
    altAxis: C
    ...
    mainAxis: 0,
    altAxis: 0
  }, C), k = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, B = {
    x: 0,
    y: 0
  };
  if ($) {
    if (a) {
      var M, J = E === "y" ? Tt : Ct, q = E === "y" ? jt : Vt, U = E === "y" ? "height" : "width", tt = $[E], at = tt + h[J], rt = tt - h[q], y = g ? -H[U] / 2 : 0, O = A === Le ? z[U] : H[U], L = A === Le ? -H[U] : -z[U], F = e.elements.arrow, V = g && F ? Io(F) : {
        width: 0,
        height: 0
      }, W = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : vs(), X = W[J], Y = W[q], G = un(0, z[U], V[U]), K = R ? z[U] / 2 - y - G - X - P.mainAxis : O - G - X - P.mainAxis, Z = R ? -z[U] / 2 + y + G + Y + P.mainAxis : L + G + Y + P.mainAxis, dt = e.elements.arrow && Pn(e.elements.arrow), I = dt ? E === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, xt = (M = k == null ? void 0 : k[E]) != null ? M : 0, j = tt + K - xt - I, yt = tt + Z - xt, Lt = un(g ? Jn(at, j) : at, tt, g ? ve(rt, yt) : rt);
      $[E] = Lt, B[E] = Lt - tt;
    }
    if (l) {
      var ce, Et = E === "x" ? Tt : Ct, In = E === "x" ? jt : Vt, Ft = $[b], Ee = b === "y" ? "height" : "width", de = Ft + h[Et], Se = Ft - h[In], Te = [Tt, Ct].indexOf(T) !== -1, Ce = (ce = k == null ? void 0 : k[b]) != null ? ce : 0, pe = Te ? de : Ft - z[Ee] - H[Ee] - Ce + P.altAxis, We = Te ? Ft + z[Ee] + H[Ee] - Ce - P.altAxis : Se, An = g && Te ? Kw(pe, Ft, We) : un(g ? pe : de, Ft, g ? We : Se);
      $[b] = An, B[b] = An - Ft;
    }
    e.modifiersData[r] = B;
  }
...
function $f(t, e, n) {
  n === void 0 && (n = !1);
  var r = Bt(e), o = Bt(e) && Pf(e), a = le(e), i = Ue(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Bo(a)) && (l = _f(e)), Bt(e) ? (c = Ue(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Do(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      forceUpdate: function() {
        if (!w) {
          var T = p.elements, A = T.reference, R = T.popper;
          if (Ga(A, R)) {
            p.rects = {
              reference: $f(A, Pn(R), p.options.strategy === "fixed"),
              popper: Io(R)
    ...
    function v() {
      p.orderedModifiers.forEach(function(h) {
        var T = h.name, A = h.options, R = A === void 0 ? {} : A, E = h.effect;
        if (typeof E == "function") {
          var b = E({
            state: p,
            name: T,
...
var jf = [sf, Sf, of, Yw, kf, bf, Of, tf, yf], Vf = /* @__PURE__ */ Bf({
  defaultModifiers: jf
});
const Es = "Popper";
function zf(t) {
...
const Hf = () => yo({
  ...
  } = e, h = Nt(e, Lf), T = D.useRef(null), A = xe(T, n), R = D.useRef(null), E = xe(R, w), b = D.useRef(E);
  ze(() => {
    b.current = E;
  }, [E]), D.useImperativeHandle(w, () => R.current, []);
  const $ = Uf(p, i), [z, H] = D.useState($), [C, P] = D.useState(Zn(o));
  D.useEffect(() => {
...
`));
  ...
  const B = Hf(), M = (r = v.root) != null ? r : "div", J = Ow({
    elementType: M,
  ...
  const {
    ...
    slotProps: h = {},
    slots: T = {}
  } = e, A = Nt(e, Ff), [R, E] = D.useState(!0), b = () => {
    E(!1);
  }, $ = () => {
    E(!0);
  };
...
var Kf = function(e) {
  ...
  return n.componentDidMount = function() {
    ...
    return (
      ...
      /* @__PURE__ */ S.createElement(Cs.Provider, {
        value: null
...
const tm = {
...
}, Fr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), jo = /* @__PURE__ */ D.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, T = Nt(e, Qf), A = an(), R = D.useRef(), E = Ts(), b = D.useRef(null), $ = xe(b, a.ref, n), z = (q) => (U) => {
    if (q) {
      const tt = b.current;
...
jo.muiSupportAuto = !0;
const Ya = jo, em = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], nm = Rn(Ss, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ls(), a = Ro({
    ...
    slots: R,
    slotProps: E
  } = a, b = Nt(a, em), $ = (r = R == null ? void 0 : R.root) != null ? r : c == null ? void 0 : c.Root, z = _({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const om = os("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), re = om, am = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function im(t) {
  return Math.round(t * 1e5) / 1e5;
}
const sm = (t) => {
...
const _s = /* @__PURE__ */ D.forwardRef(function(e, n) {
  var r, o, a, i, l, c, d, p, f, w, g, v, m, h, T, A, R, E, b;
  const $ = Ro({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: xt
  } = $, j = Nt($, am), yt = /* @__PURE__ */ D.isValidElement(H) ? H : /* @__PURE__ */ s("span", {
    children: H
...
`));
  ...
  const Mt = _({}, Ke, j, yt.props, {
    className: be(j.className, yt.props.className),
    onTouchStart: Xo,
    ref: Vs
  }, rt ? {
    onMouseMove: zs
...
`));
  ...
  const Je = {};
  q || (Mt.onTouchStart = Bs, Mt.onTouchEnd = js), M || (Mt.onMouseOver = Fn(Yo, Mt.onMouseOver), Mt.onMouseLeave = Fn(Wo, Mt.onMouseLeave), Se || (Je.onMouseOver = Yo, Je.onMouseLeave = Wo)), B || (Mt.onFocus = Fn(Ho, Mt.onFocus), Mt.onBlur = Fn(Go, Mt.onBlur), Se || (Je.onFocus = Ho, Je.onBlur = Go)), process.env.NODE_ENV !== "production" && yt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${yt.props.title}\` or the Tooltip component.`].join(`
`));
  const Ls = D.useMemo(() => {
    var Q;
    let _t = [{
    ...
    touch: de.current
  }), Cr = sm(Ze), qo = (r = (o = Z.popper) != null ? o : C.Popper) != null ? r : lm, Ko = (a = (i = (l = Z.transition) != null ? l : C.Transition) != null ? i : I) != null ? a : Ya, Jo = (c = (d = Z.tooltip) != null ? d : C.Tooltip) != null ? c : cm, Zo = (p = (f = Z.arrow) != null ? f : C.Arrow) != null ? p : dm, Fs = sn(qo, _({}, G, (w = K.popper) != null ? w : P.popper, {
    ...
    className: be(Cr.tooltip, (T = (A = K.tooltip) != null ? A : P.tooltip) == null ? void 0 : T.className)
...
function Ps(t) {
  ...
  return r ? /* @__PURE__ */ s(pm, { title: r, placement: "right", children: /* @__PURE__ */ s("div", { children: T }) }) : T;
}
function $s(t) {
...
function vm({
  ...
  const [T] = so(
    ...
    kt(async () => (t == null ? void 0 : t(!0)) ?? n ?? T, [t, n, T, c]),
    n ?? T
  ), R = p && A ? A : T;
  return /* @__PURE__ */ x(ie, { children: [
    /* @__PURE__ */ s(
...
), xm = S.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: N(ym({ variant: e }), t), ...n }));
...
const km = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: N("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const _m = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ x(
  on.Root,
  {
    ref: n,
    className: N(
...
_m.displayName = on.Root.displayName;
...
Pm.displayName = Xr.Root.displayName;
const Sh = Rt.Root, $m = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Rt.List,
  {
    ref: n,
    className: N(
...
$m.displayName = Rt.List.displayName;
...
Im.displayName = Rt.Trigger.displayName;
...
Am.displayName = Rt.Content.displayName;
function Th({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
...
function Ph({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ x(wo, { children: [
    /* @__PURE__ */ s(wi, { asChild: !0, children: /* @__PURE__ */ s(Mm, {}) }),
...
export {
  ...
  $h as NoExtensionsFound,
  hi as RadioGroup,
  Yr as RadioGroupItem,
  mh as ScriptureResultsViewer,
  hh as ScrollGroupSelector,
  Ri as SearchBar,
  hn as Select,
  Be as SelectContent,
  $c as SelectGroup,
