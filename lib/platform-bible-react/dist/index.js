...
const ta = sn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Fe : "button", { className: h(ea({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
function Np({
  ...
  const c = mt(), [d, u] = S(!1), [f, m] = S(""), [g, x] = S(""), [v, N] = S("books"), [y, k] = S(void 0), [C, j] = S(!1), z = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
  ...
  }, [v, y, I, t.book, t.chapterNum]), /* @__PURE__ */ p(oe, { open: d, onOpenChange: G, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
...
), ht = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(To.Root, { ref: n, className: h("pr-twp", bl(), t), ...e }));
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          /* @__PURE__ */ r(Ke, { placeholder: f, className: "tw-text-inherit" }),
...
function Cp({
  ...
  const d = jn(c, "%webView_bookSelector_currentBook%"), u = jn(c, "%webView_bookSelector_choose%"), f = jn(c, "%webView_bookSelector_chooseBooks%"), [m, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
function kl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = yl(null, o), d = Ro({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (u) => i(u, d), theme: o });
    return function(u, f) {
      if (f !== null) {
...
function Ol(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !wi(e) && o !== null) {
    ...
    if (c || d) {
      const [u, f] = ci(t), m = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let v, N = 0;
...
class tn {
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: u } = d;
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const f of Bl(u)) {
  ...
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = pa(() => {
    ...
    o.value.read(() => {
      if (Vt()) for (const [d, u] of l.entries()) {
        ...
        const f = Ri(d), m = f && f.isSelected() || !1;
  ...
  return de(t.registerCommand(vi, (i) => {
    if (xi(i.target)) {
      ...
      if (Zl(l)) return function(w, c = !1) {
        ...
        let m;
        c && Po(d) ? m = d : (m = Ni(), ki(m)), u ? m.delete(f) : m.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    jl(() => {
      ...
      for (const [d, u] of i.entries()) if (u === "destroyed") c.delete(d), w = !0;
        ...
        f ? f.domNode.value = m : (w = !0, c.set(d, { domNode: rn(m), selectedSignal: o(d) }));
      }
...
function Ql(t, e, n = ga) {
  return de(t.registerCommand(Di, (o) => {
    ...
    const s = function(i) {
      ...
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), u = $l(d);
      if (u.canIndent()) {
        const f = u.getKey();
        let m = Mi();
        if (m.anchor.set(f, 0, "element"), m.focus.set(f, 0, "element"), m = Ii(m), m.anchor.is(c)) return !0;
      }
      return !1;
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (xn(v) && c >= 0 && d >= 0 && (N = c, y = c + d, g.setTextNodeRange(v, N, v, y)), N === y && u === "" || (g.insertRawText(u), v = x.getNode()), xn(v)) {
                  N = f, y = f + m;
  ...
  return function(n, o) {
    ...
    return Sr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (f) => n._onError(f), children: r(gs, { fallback: null, children: a[c] }) }), u = n.getElementByKey(c);
        u !== null && i.push(Hi(d, u, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
const ka = me(
  ...
  {
    ref: a,
    className: h(ka({ variant: e, size: n, className: t })),
    ...o
  }
));
...
function Ca(t, e, n, o = null) {
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], x = Ca(t, g, f, o);
    !a && le(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Vi(d) || Hr(d)) && d.append(f), n.append(d), u) {
      const m = u.call(i, d);
      m && (Hr(d) ? d.replaceChildren(m) : d.replaceWith(m));
    }
  } else n.append(f);
  return a;
}
...
function Ta(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  for (let g = 0; g < u.length; g++) f.push(...Ta(u[g], e, n, m, new Map(a), l));
  return d != null && (f = d(f)), Yr(t) && (f = Sw(t, f, m ? () => {
    const g = new jo();
    return n.push(g), g;
  } : Rn)), l == null ? f.length > 0 ? i = i.concat(f) : Yr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Xr(g.nextSibling) && Xr(g.previousSibling);
  }(t) && (i = i.concat(zo())) : le(l) && l.append(...f), i;
}
function Sw(t, e, n) {
...
function Ep({
  ...
  const [a, s] = S(Mw), [i, l] = S(void 0), [w, c] = S(!1), d = H(void 0), u = H(null);
  Y(() => {
    let N = !0;
    const y = u.current;
    if (!y) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Ir(N) && (N.preventDefault(), N.stopPropagation(), Lt(a) && f());
        },
        onKeyDown: (N) => {
...
function lo({
  ...
  const m = K(
    ...
    [t.user]
  ), y = B(() => ri(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          _n,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), u(Dw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ia, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Oa, { className: "tw-text-xs tw-font-medium", children: N }) }),
...
function Uw({
  ...
  const Dt = K(
    async (T) => {
      ...
      vt && await u({ threadId: w, contents: vt }) && Zt();
    },
    [
      Zt,
      A,
    ...
    async (T) => {
      const vt = Lt(A) ? kn(A) : void 0, ft = await u({
        ...T,
        contents: vt,
...
function oc({
  ...
  var z;
  const [d, u] = S([]), [f, m] = S([]), [g, x] = S({}), [v, N] = S({}), y = B(() => e ?? [], [e]), k = Go({
    data: y,
    columns: t,
    getCoreRowModel: qo(),
...
function Op({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Aa, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((u, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][f],
        ...
        Kw,
        {
          ...
          children: c.items.map((u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(La, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, c.label)) })
...
function Lp({
  ...
  const [g, x] = S("generated"), [v, N] = S("*"), [y, k] = S("f"), [C, j] = S(!1), [z, A] = S(!0), [M, E] = S(!1), R = H(!1), V = H(""), [$, O] = S(!1), [P, W] = S(), [I, J] = S(), [St, Pt] = S(), [It, gt] = S(), pt = H(null), G = B(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
...
const Ba = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), u = e ?? c, f = b.useCallback(
      ...
      [n, u]
    ), m = b.useCallback(() => f((k) => !k), [f]), g = u ? "expanded" : "collapsed", N = mt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(Fa.Provider, { value: y, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
    ...
    Ka,
    {
      ...
      children: /* @__PURE__ */ p(Ua, { children: [
        /* @__PURE__ */ p(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(qa, { children: Object.entries(e).map(([f, m]) => /* @__PURE__ */ r(Ha, { children: /* @__PURE__ */ r(
            Ya,
            {
              onClick: () => c(f),
              isActive: u(f),
...
function ud({
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, u) => {
    var g, x, v, N;
    d.preventDefault();
    ...
    switch (u.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Xe(s, [f, m]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Xe(i, [f, m]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Xe(l, [f, m]);
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), Xe(w, [f, m]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(rs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, u]) => typeof d == "boolean" || typeof u == "boolean" ? 0 : d.order - u.order).map(([d, u]) => /* @__PURE__ */ p(ld, { children: [
      /* @__PURE__ */ r(os, { ref: c(d), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        is,
        {
          style: { zIndex: Ge },
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: h(u && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
