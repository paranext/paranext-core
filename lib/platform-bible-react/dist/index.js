...
import { GENERATOR_NOTE_CALLER as uo, HIDDEN_NOTE_CALLER as po, getDefaultViewOptions as Hl, isInsertEmbedOpOfType as Dr, getMarkerMenuItems as ql, defaultStyleInfo as Gl, Editorial as Wl } from "@eten-tech-foundation/platform-editor";
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (m) => {
      ...
      if (N === "books" && !Ht && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
        const At = H === gt.current ? gt.current : void 0, de = (At == null ? void 0 : At.selectionStart) ?? 0, Gt = (At == null ? void 0 : At.selectionEnd) ?? 0, he = T === "rtl" ? m.key === "ArrowRight" : m.key === "ArrowLeft";
...
function Bd(t) {
  const e = ae() || qc();
  let r;
  if (_e(e)) r = Gc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = ui(c, "next"));
    }
    r = r || Wc(qe(), "previous").getFlipped().insert(Hr());
  }
...
function Sh({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, W] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
  ...
  const xt = j(() => {
    var y, G, A;
    const S = (y = g.current) == null ? void 0 : y.querySelector(".editor-input"), K = S == null ? void 0 : S.querySelector("span.note"), X = (A = (G = g.current) == null ? void 0 : G.ownerDocument.getSelection()) == null ? void 0 : A.anchorNode;
...
function eg({
  ...
  const T = Bt(
  ...
  ), mt = pt.find((L) => L.value === "selectedBooks"), ce = pt.find((L) => L.value === "range"), [Qt, S] = _(!1), [K, X] = _(void 0), [y, G] = _(void 0), [A, et] = _(void 0), [nt, ct] = _(void 0), [_t, Pt] = _([]), Vt = p === "dropdown" && K === "selectedBooks", te = /* @__PURE__ */ a(
    tp,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-start", className: v(Cr && ir), children: q }),
      /* @__PURE__ */ a(
        qa,
        {
  ...
  const Yr = j(
    ...
    y !== void 0 && (y === "range" ? (A && (f == null || f(A)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), zt(y), X(void 0), G(void 0));
  }, [
    y,
    A,
    nt,
