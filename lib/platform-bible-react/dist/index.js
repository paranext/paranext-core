...
import u, { forwardRef as Ke, useRef as nt, useMemo as H, useState as I, useCallback as B, useLayoutEffect as Nn, createContext as Fr, useContext as Xr, useEffect as Dt, Fragment as Pn } from "react";
import { Command as st } from "cmdk";
import { X as qe, Search as An, Check as Ct, Clock as kn, ChevronsLeft as Cn, ChevronsRight as _n, ChevronLeft as je, ChevronRight as $t, ArrowLeft as Hr, ArrowRight as Ur, Circle as ge, ChevronsUpDown as Je, FilterIcon as Yr, ChevronDown as be, ChevronUp as Kr, ArrowLeftIcon as qr, ChevronLeftIcon as Jr, ChevronRightIcon as Wr, ArrowRightIcon as Zr, Copy as Qr, Filter as to, User as eo, Link as no, CircleHelp as ro, Star as oo, CircleCheckIcon as ao, CircleXIcon as so, CircleHelpIcon as io, ArrowUpIcon as wo, ArrowDownIcon as lo, ArrowUpDownIcon as co, PanelLeft as po, PanelRight as uo, ScrollText as mo, MenuIcon as ho, Menu as fo, EllipsisVertical as go, LoaderCircle as bo } from "lucide-react";
...
const Po = gt.Portal, Fn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  gt.Overlay,
  {
    ref: n,
    className: d(
...
Fn.displayName = gt.Overlay.displayName;
const Ao = u.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = tt();
...
Ao.displayName = gt.Content.displayName;
...
jo.displayName = gt.Title.displayName;
...
zo.displayName = gt.Description.displayName;
...
const xe = u.forwardRef((t, e) => /* @__PURE__ */ r(st.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
E(dt, "Original", new dt(ht.Original)), E(dt, "Septuagint", new dt(ht.Septuagint)), E(dt, "Vulgate", new dt(ht.Vulgate)), E(dt, "English", new dt(ht.English)), E(dt, "RussianProtestant", new dt(ht.RussianProtestant)), E(dt, "RussianOrthodox", new dt(ht.RussianOrthodox));
let Et = dt;
function Rn(t, e) {
  const n = e[0];
...
const Jt = ae.Root, Wt = ae.Trigger, zt = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = tt();
...
function na(t, e, n, o) {
  const a = B(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const c = e[p - 1], m = Math.max(ft(c), 1);
        o({
          book: c,
          chapterNum: m,
          verseNum: 1
  ...
  return H(() => [
    ...
    {
      onClick: s,
      disabled: e.length === 0 || (t.chapterNum === ft(t.book) || ft(t.book) === -1) && e.indexOf(t.book) === e.length - 1,
      title: "Next chapter",
      icon: n === "ltr" ? _n : Cn
    }
  ], [
...
function En({
  ...
  if (t)
    return /* @__PURE__ */ r(It, { children: /* @__PURE__ */ r("div", { className: d("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ft(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      jt,
      {
        value: `${t} ${Mt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function xi({
  ...
  const p = tt(), [c, m] = I(!1), [g, h] = I(""), [f, b] = I(""), [v, N] = I("books"), [k, y] = I(void 0), [O, U] = I(!1), et = nt(void 0), L = nt(void 0), pt = nt(void 0), _ = nt(void 0), T = nt({}), q = B(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
  ...
  }, [v, k, C, t.book, t.chapterNum]), /* @__PURE__ */ l(Jt, { open: c, onOpenChange: yt, children: [
    /* @__PURE__ */ r(Wt, { asChild: !0, children: /* @__PURE__ */ r(
      D,
      {
        ...
        children: [
          ...
          !O && /* @__PURE__ */ l(Kt, { ref: pt, children: [
            v === "books" && /* @__PURE__ */ l(oe, { children: [
              ...
              C && ft(C.book) > 1 && /* @__PURE__ */ l(oe, { children: [
...
), Z = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(jn.Root, { ref: n, className: d("pr-twp", ra(), t), ...e }));
...
me.displayName = se.Item.displayName;
function oa(t) {
    ...
    /* @__PURE__ */ r(
      zt,
      {
        ...
        children: /* @__PURE__ */ l(Yt, { children: [
          /* @__PURE__ */ r(de, { placeholder: m, className: "tw-text-inherit" }),
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(Z, { className: "tw-ms-1", children: m })
          ] }),
...
const nr = u.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    $.SubTrigger,
    {
...
const rr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $.SubContent,
  {
    ref: n,
    className: d(
...
const or = u.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = tt(), s = mt();
  return /* @__PURE__ */ r(
    $.Item,
    {
...
const ar = u.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ l(
    $.RadioItem,
    {
...
const Gt = K.Root, pa = K.Group, Ft = K.Value, ua = _t(
...
), Pt = u.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = tt();
  return /* @__PURE__ */ l(
    K.Trigger,
    {
...
const At = u.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = tt();
...
ma.displayName = K.Label.displayName;
  ...
  u.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        ie(i, '[tabindex]:not([tabindex="-1"])').forEach((m) => {
...
const kt = u.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const w = u.useMemo(
    ...
    (m) => {
      ...
      if (m.key === "ArrowDown" || m.key === "ArrowUp")
        m.preventDefault(), ya(f, b, m.key);
      else if (m.key === "ArrowLeft" || m.key === "ArrowRight")
        m.preventDefault(), xa(w, v, m.key);
...
function ka({
  ...
  var N;
  const [w, p] = I([]), [c, m] = I([]), [g, h] = I({}), [f, b] = I({}), v = zn({
    data: e,
    columns: t,
    getCoreRowModel: Ln(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(ke, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ce, { stickyHeader: s, children: v.getHeaderGroups().map((k) => /* @__PURE__ */ r(kt, { children: k.headers.map((y) => /* @__PURE__ */ r(we, { children: y.isPlaceholder ? void 0 : re(y.column.columnDef.header, y.getContext()) }, y.id)) }, k.id)) }),
      /* @__PURE__ */ r(_e, { children: (N = v.getRowModel().rows) != null && N.length ? v.getRowModel().rows.map((k) => /* @__PURE__ */ r(
        ...
        k.id
      )) : /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ r(Xt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Ei({
  ...
  const i = H(() => ko(n), [n]), p = ((c) => {
    const m = new Intl.DisplayNames(Co(), { type: "language" });
...
function Ea({
  ...
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(Jt, { open: g, onOpenChange: h, children: [
    /* @__PURE__ */ r(Wt, { asChild: !0, children: /* @__PURE__ */ l(
      D,
      {
        variant: "ghost",
...
), Ma = u.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  $n.Root,
  {
    ref: a,
...
const lr = u.createContext({
  size: "default",
  variant: "default"
}), dr = u.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = tt();
  return /* @__PURE__ */ r(
    ve.Root,
    {
...
function zi({
  ...
  const c = vt(n, "%webView_inventory_all%"), m = vt(n, "%webView_inventory_approved%"), g = vt(n, "%webView_inventory_unapproved%"), h = vt(n, "%webView_inventory_unknown%"), f = vt(n, "%webView_inventory_scope_currentBook%"), b = vt(n, "%webView_inventory_scope_chapter%"), v = vt(n, "%webView_inventory_scope_verse%"), N = vt(n, "%webView_inventory_filter_text%"), k = vt(
    n,
    "%webView_inventory_show_additional_items%"
    ...
    for (let yt = 0; yt < S; yt++)
      Q.push(
        Da(
          ((X = o == null ? void 0 : o.tableHeaders) == null ? void 0 : X[yt]) || "Additional Item",
          yt + 1
        )
      );
    return [...Q, ...p];
...
const cn = le.Provider, pn = le.Root, un = le.Trigger, Re = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  le.Content,
  {
    ref: o,
    sideOffset: e,
...
const Aa = "16rem", ja = "3rem", cr = u.createContext(void 0);
function Te() {
  const t = u.useContext(cr);
  if (!t)
...
const pr = u.forwardRef(
  ({
    ...
    const [c, m] = u.useState(t), g = e ?? c, h = u.useCallback(
      ...
      [n, g]
    ), f = u.useCallback(() => h((O) => !O), [h]), b = g ? "expanded" : "collapsed", k = tt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = u.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
...
const ur = u.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Te();
...
const za = u.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Te();
  return /* @__PURE__ */ l(
    D,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(po, {}) : /* @__PURE__ */ r(uo, {}),
...
const Xa = u.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ht : "button",
  {
    ref: o,
...
const Ha = _t(
  ...
  ({
    ...
    const p = t ? Ht : "button", { state: c } = Te(), m = /* @__PURE__ */ r(
      p,
      {
        ref: w,
...
const Ua = u.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ht : "button",
  {
    ref: a,
...
const Ka = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Wa = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ht : "a",
  {
    ref: s,
    ...
    /* @__PURE__ */ l(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(mr, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Nt = "scrBook", Qa = "scrRef", Vt = "source", ts = "details", es = "Scripture Reference", ns = "Scripture Book", vr = "Type", rs = "Details";
function os(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? z.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Nt ? Bt(a.start) : void 0;
      },
...
function Li({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ l(ke, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ce, { children: N.getHeaderGroups().map((_) => /* @__PURE__ */ r(kt, { children: _.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ r(
        rn,
        {
          ...
          children: N.map(({ value: k, label: y, id: O }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(me, { className: "tw-me-2", value: k, id: O }),
...
function Ye({
  ...
  return /* @__PURE__ */ l(an, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ye, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, c]) => typeof p == "boolean" || typeof c == "boolean" ? 0 : p.order - c.order).map(([p], c, m) => /* @__PURE__ */ l(Pn, { children: [
...
const Cr = u.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ r(
    it.Root,
    {
...
)), Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  it.Content,
  {
    ref: n,
    className: d(
...
const Rr = u.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = u.useMemo(
    () => ({
      variant: e
    }),
...
const Tr = u.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    G.Trigger,
    {
...
const Er = u.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    G.SubTrigger,
    {
...
const Mr = u.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = mt();
...
const Dr = u.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ r(
    G.Item,
    {
...
const cs = u.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    G.CheckboxItem,
    {
...
const ps = u.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
...
us.displayName = G.Label.displayName;
const Ir = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  G.Separator,
  {
    ref: n,
...
function ms({
  ...
  if (Mo(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    var b, v, N, k;
    m.preventDefault();
    ...
    return /* @__PURE__ */ r(Rr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ l(ls, { children: [
      /* @__PURE__ */ r(Tr, { ref: c(m), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        Mr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(cn, { children: Or(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
), vs = u.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, role: "alert", className: d(bs({ variant: e }), t), ...n }));
...
const ys = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const Ts = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const ew = F.Root, nw = F.Trigger, rw = F.Group, ow = F.Portal, aw = F.Sub, sw = F.RadioGroup, Ms = u.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  F.SubTrigger,
  {
    ref: a,
    className: d(
...
const Is = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(F.Portal, { children: /* @__PURE__ */ r(
  F.Content,
  {
    ref: n,
    className: d(
...
const Os = u.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  F.Item,
  {
    ref: o,
    className: d(
...
const Ps = u.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ l(
  F.CheckboxItem,
  {
    ref: a,
    className: d(
...
const As = u.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  F.RadioItem,
  {
    ref: o,
    className: d(
...
const js = u.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: o,
    className: d(
...
const iw = ut.Trigger, $s = ut.Portal, ww = ut.Close, Ar = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
...
Ar.displayName = ut.Overlay.displayName;
const Gs = u.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = u.useContext(Pr), i = {
...
Hs.displayName = ut.Title.displayName;
...
Us.displayName = ut.Description.displayName;
const Ys = u.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Le.Root,
  {
    ref: o,
    className: d(
...
const Ks = u.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ l(
    ee.Root,
    {
...
const qs = u.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ r(
    $e.Root,
    {
...
const dw = it.Root, Js = u.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ r(
    it.List,
    {
