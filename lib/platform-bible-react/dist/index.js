import Zl, { jsx as d, jsxs as $, Fragment as Et } from "react/jsx-runtime";
import * as k from "react";
import U, { forwardRef as wn, useCallback as Se, useState as fe, useRef as Mt, useEffect as Je, useLayoutEffect as xa, useMemo as xt } from "react";
import { History as Ql, ChevronRight as $i, Check as xn, Circle as ec, ArrowDownWideNarrow as tc, Clock as rc, Bookmark as nc, FilterIcon as oc, ChevronDown as En, ChevronUp as ac, ArrowLeftIcon as ic, ChevronLeftIcon as sc, ChevronRightIcon as lc, ArrowRightIcon as cc, ArrowUpIcon as pc, ArrowDownIcon as dc, ArrowUpDownIcon as uc, CircleCheckIcon as fc, CircleXIcon as mc, CircleHelpIcon as hc, X as gc, Search as bc, ChevronsUpDown as vc, ChevronLeft as yc, LoaderCircle as wc, Download as xc, Filter as Ec, User as kc, Link as Nc, CircleHelp as Tc } from "lucide-react";
import Oe, { clsx as Cc } from "clsx";
...
import { getChaptersForBook as Rc, getLocalizeKeyForScrollGroupId as me, formatScrRef as Xn, compareScrRefs as mo, scrRefToBBBCCCVVV as Yn, NumberFormat as Pc, formatBytes as $c } from "platform-bible-utils";
import { useReactTable as _i, getCoreRowModel as Ii, getPaginationRowModel as _c, getSortedRowModel as Mi, getFilteredRowModel as Ic, flexRender as Tr, getExpandedRowModel as Mc, getGroupedRowModel as Ac } from "@tanstack/react-table";
import { Slot as Dc } from "@radix-ui/react-slot";
...
import { FormControlLabel as Ea, FormLabel as jc, Checkbox as Bc, MenuItem as Lc, ListItemText as Fc, ListItemIcon as Di, Menu as Vc, Grid as ji, List as zc, IconButton as Bi, Drawer as Uc, Slider as Hc, Snackbar as Gc, Switch as Wc, AppBar as Xc, Toolbar as Yc } from "@mui/material";
...
import qc, { ThemeContext as Kc, internal_processStyles as Jc } from "@mui/styled-engine";
...
var rp = Object.defineProperty, np = (e, t, r) => t in e ? rp(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => np(e, typeof t != "symbol" ? t + "" : t, r);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
const Mo = be.Root, Xi = be.Trigger, mp = be.Group, Xv = be.Portal, Yv = be.Sub, qv = be.RadioGroup, hp = U.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ $(
  be.SubTrigger,
  {
    ref: o,
    className: D(
...
hp.displayName = be.SubTrigger.displayName;
...
gp.displayName = be.SubContent.displayName;
...
const Ao = U.forwardRef(({ className: e, children: t, checked: r, ...n }, o) => /* @__PURE__ */ $(
  be.CheckboxItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(be.ItemIndicator, { children: /* @__PURE__ */ d(xn, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
...
const qi = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  be.RadioItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(be.ItemIndicator, { children: /* @__PURE__ */ d(ec, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
...
bp.displayName = "DropdownMenuShortcut";
const vp = wn(
  ({
    bookId: e,
    handleSelectBook: t,
...
function wp({ handleSort: e, handleLocationHistory: t, handleBookmarks: r }) {
...
const Cr = he.allBookIds, xp = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ta = ["OT", "NT", "DC"], Ep = 32 + 32 + 32, kp = [
  /^(\w+)$/i,
...
function Kv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = fe(""), [o, a] = fe(
    ...
    (N, M, j, z) => {
      if (l(
        he.bookNumberToId(e.bookNum) !== N ? 1 : e.chapterNum
      ), M || hr(N) === -1) {
        t({
          bookNum: he.bookIdToNumber(N),
          chapterNum: j || 1,
          verseNum: z || 1
        }), v(!1), n("");
        return;
    ...
    kp.forEach((N) => {
      const M = r.match(N);
      if (M) {
        const [j, z = void 0, G = void 0] = M.slice(1), B = Sp(j);
    ...
    (N) => {
      m ? (N.key === "ArrowDown" || N.key === "ArrowUp") && (typeof b < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      b.current !== null ? b.current.focus() : typeof u < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      u.current !== null && u.current.focus(), N.preventDefault()) : v(!0);
    },
    [m]
  ), R = (N) => {
    const { key: M } = N;
  ...
  return Je(() => {
    ...
    const N = setTimeout(() => {
      if (g && u.current && b.current) {
        const j = b.current.offsetTop - Ep;
  ...
  }, [g]), /* @__PURE__ */ d("div", { className: "pr-twp pr-flex", children: /* @__PURE__ */ $(Mo, { modal: !1, open: m, onOpenChange: E, children: [
        ...
        children: [
          ...
          Ta.map(
            (N, M) => w(N).length > 0 && /* @__PURE__ */ $("div", { children: [
              /* @__PURE__ */ d(Vr, { className: "pr-font-semibold pr-text-foreground/80", children: xp[N] }),
              w(N).map((j) => /* @__PURE__ */ d("div", { children: /* @__PURE__ */ d(
                vp,
                {
                  bookId: j,
              ...
              Ta.length - 1 !== M ? /* @__PURE__ */ d(Cn, {}) : void 0
            ] }, N)
          )
        ]
      }
...
const Op = kn(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? Dc : "button", { className: D(Op({ variant: t, size: r, className: e })), ref: a, ...o })
);
Te.displayName = "Button";
function Rp({ table: e }) {
  return /* @__PURE__ */ $(Mo, { children: [
    /* @__PURE__ */ d(Oc, { asChild: !0, children: /* @__PURE__ */ $(Te, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ d(oc, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
...
const _r = xe.Root, Pp = xe.Group, Ir = xe.Value, Zt = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  xe.Trigger,
  {
    ref: n,
    className: D(
...
const Ki = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ d(ac, { className: "pr-h-4 pr-w-4" })
  }
));
Ki.displayName = xe.ScrollUpButton.displayName;
...
Ji.displayName = xe.ScrollDownButton.displayName;
...
$p.displayName = xe.Label.displayName;
const Ke = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  xe.Item,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(xe.ItemIndicator, { children: /* @__PURE__ */ d(xn, { className: "pr-h-4 pr-w-4" }) }) }),
...
_p.displayName = xe.Separator.displayName;
function Ip({ table: e }) {
      ...
      /* @__PURE__ */ $(
        Te,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(cc, { className: "pr-h-4 pr-w-4" })
          ]
        }
      )
    ] })
...
const Mp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "tfoot",
  {
    ref: r,
...
const Ap = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "caption",
  {
    ref: r,
...
function Dp({
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp pr-font-sans", children: [
    o && /* @__PURE__ */ d(Rp, { table: u }),
    /* @__PURE__ */ $(Sn, { stickyHeader: a, children: [
      /* @__PURE__ */ d(On, { stickyHeader: a, children: u.getHeaderGroups().map((w) => /* @__PURE__ */ d(wt, { children: w.headers.map((O) => /* @__PURE__ */ d(Mr, { children: O.isPlaceholder ? void 0 : Tr(O.column.columnDef.header, O.getContext()) }, O.id)) }, w.id)) }),
      /* @__PURE__ */ d(Rn, { children: (b = u.getRowModel().rows) != null && b.length ? u.getRowModel().rows.map((w) => /* @__PURE__ */ d(
        wt,
        {
          onClick: () => i(w, u),
    ...
    r && n && /* @__PURE__ */ d(Ip, { table: u })
  ] });
}
const jp = (e) => e.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), Ca = (e) => {
...
function Bp({
  ...
  return Je(
    ...
    /* @__PURE__ */ d(On, { stickyHeader: !0, children: /* @__PURE__ */ $(wt, { children: [
...
]), Do = (e) => e === "asc" ? /* @__PURE__ */ d(pc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(dc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(uc, { className: "pr-ms-2 pr-h-4 pr-w-4" }), Lp = (e, t, r) => {
  let n = e;
...
), Vp = U.forwardRef(({ className: e, variant: t, size: r, ...n }, o) => /* @__PURE__ */ d(
  Ai.Root,
  {
    ref: o,
    className: D(Zi({ variant: t, size: r, className: e })),
    ...n
  }
));
Vp.displayName = Ai.Root.displayName;
const Qi = U.createContext({
  size: "default",
  variant: "default"
}), es = U.forwardRef(({ className: e, variant: t, size: r, children: n, ...o }, a) => /* @__PURE__ */ d(
  Nn.Root,
  {
    ref: a,
    className: D(
...
const Qv = (e) => ({
  ...
  cell: ({ row: r }) => {
    ...
    return /* @__PURE__ */ $(es, { value: n, variant: "outline", type: "single", children: [
      /* @__PURE__ */ d(an, { onClick: () => t([o], "approved"), value: "approved", children: /* @__PURE__ */ d(fc, {}) }),
      /* @__PURE__ */ d(
        an,
        {
      ...
      /* @__PURE__ */ d(an, { onClick: () => t([o], "unknown"), value: "unknown", children: /* @__PURE__ */ d(hc, {}) })
    ] });
  }
}), qn = {
  [me("undefined")]: "Ø",
...
const zp = $r.Root, Up = $r.Trigger, ts = U.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d($r.Portal, { children: /* @__PURE__ */ d(
  $r.Content,
  {
    ref: o,
    align: t,
...
ts.displayName = $r.Content.displayName;
const Hp = et.Portal, rs = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  et.Overlay,
  {
    ref: r,
    className: D(
...
const Gp = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(Hp, { children: [
  /* @__PURE__ */ d(rs, {}),
  /* @__PURE__ */ $(
    et.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ $(et.Close, { className: "pr-absolute pr-right-4 pr-top-4 pr-rounded-sm pr-opacity-70 pr-ring-offset-background pr-transition-opacity hover:pr-opacity-100 focus:pr-outline-none focus:pr-ring-2 focus:pr-ring-ring focus:pr-ring-offset-2 disabled:pr-pointer-events-none data-[state=open]:pr-bg-accent data-[state=open]:pr-text-muted-foreground", children: [
          /* @__PURE__ */ d(gc, { className: "pr-h-4 pr-w-4" }),
...
Gp.displayName = et.Content.displayName;
...
Wp.displayName = et.Title.displayName;
const Xp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  et.Description,
  {
    ref: r,
...
Xp.displayName = et.Description.displayName;
...
ns.displayName = De.displayName;
const os = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
  /* @__PURE__ */ d(bc, { className: "pr-me-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" }),
  /* @__PURE__ */ d(
    De.Input,
    {
      ref: r,
...
os.displayName = De.Input.displayName;
...
as.displayName = De.List.displayName;
const is = U.forwardRef((e, t) => /* @__PURE__ */ d(De.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
is.displayName = De.Empty.displayName;
const Yp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Group,
  {
    ref: r,
    className: D(
...
Yp.displayName = De.Group.displayName;
const qp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Separator,
  {
    ref: r,
...
qp.displayName = De.Separator.displayName;
const ss = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Item,
  {
    ref: r,
    className: D(
...
ss.displayName = De.Item.displayName;
function Kp(e) {
...
function Oa({
  ...
  const [p, h] = fe(!1);
  return /* @__PURE__ */ $(zp, { open: p, onOpenChange: h, ...g, children: [
    /* @__PURE__ */ d(Up, { asChild: !0, children: /* @__PURE__ */ $(
      Te,
      {
        variant: f,
        role: "combobox",
        ...
        children: [
          n ? a(n) : i,
          /* @__PURE__ */ d(vc, { className: "pr-ms-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ d(ts, { className: "pr-w-[200px] pr-p-0", dir: m, children: /* @__PURE__ */ $(ns, { children: [
      /* @__PURE__ */ d(os, { dir: m, placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ d(is, { children: c }),
      /* @__PURE__ */ d(as, { children: t.map((u) => /* @__PURE__ */ $(
        ss,
        {
          value: a(u),
          onSelect: () => {
...
const ls = k.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ho.Root,
  {
    ref: r,
    className: D(
      "pr-peer pr-h-4 pr-w-4 pr-shrink-0 pr-rounded-sm pr-border pr-border-primary pr-ring-offset-background focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2 disabled:pr-cursor-not-allowed disabled:pr-opacity-50 data-[state=checked]:pr-bg-primary data-[state=checked]:pr-text-primary-foreground",
      e
    ),
    ...t,
    children: /* @__PURE__ */ d(
...
ls.displayName = ho.Root.displayName;
const Jp = kn(
  "pr-text-sm pr-font-medium pr-leading-none peer-disabled:pr-cursor-not-allowed peer-disabled:pr-opacity-70"
), jo = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Li.Root,
  {
    ref: r,
    className: D("pr-twp pr-font-sans", Jp(), e),
    ...t
  }
));
jo.displayName = Li.Root.displayName;
function a0({
  id: e,
  className: t,
  legend: r,
  ...
  return /* @__PURE__ */ $("fieldset", { id: e, className: t, children: [
    r && /* @__PURE__ */ d("legend", { className: "pr-font-sans", children: r }),
    n.map((l) => /* @__PURE__ */ $("div", { className: "pr-m-2 pr-flex pr-items-center", children: [
      ...
      /* @__PURE__ */ d(jo, { children: i ? i(l) : l })
    ] }))
  ] });
}
function Zp(e) {
...
function lt(e, t, r = {
  ...
  return _t(e) && _t(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (_t(t[o]) && o in e && _t(e[o]) ? n[o] = lt(e[o], t[o], r) : r.clone ? n[o] = _t(t[o]) ? ps(t[o]) : t[o] : n[o] = t[o]);
  }), n;
}
var bo = { exports: {} }, en = { exports: {} }, ce = {};
...
function rd() {
  return Pa || (Pa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = f, C = l, I = i, R = t, _ = m, N = n, M = h, j = p, z = r, G = a, B = o, W = v, te = !1;
    function V(F) {
...
var $a;
function ds() {
  return $a || ($a = 1, process.env.NODE_ENV === "production" ? en.exports = td() : en.exports = rd()), en.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var Qn, Ma;
function us() {
  return Ma || (Ma = 1, Qn = Function.call.bind(Object.prototype.hasOwnProperty)), Qn;
}
var eo, Aa;
function od() {
  if (Aa)
...
function ad() {
  if (Da)
    return to;
  Da = 1;
  var e = ds(), t = nd(), r = Lo(), n = us(), o = od(), a = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var sd = ds(), ld = !0;
  bo.exports = ad()(sd.isElement, ld);
} else
  bo.exports = id()();
var cd = bo.exports;
const s = /* @__PURE__ */ Zp(cd);
function pd(e) {
  const {
    prototype: t = {}
  } = e;
...
function fs(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !pd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ms = lr(s.element, fs);
ms.isRequired = lr(s.element.isRequired, fs);
const zr = ms;
function dd(e) {
  const {
    prototype: t = {}
...
function gd() {
  return La || (La = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var T = i, C = a, I = e, R = c, _ = r, N = g, M = v, j = t, z = o, G = n, B = f, W = m, te = !1, V = !1;
    function S(A) {
...
process.env.NODE_ENV === "production" ? vo.exports = hd() : vo.exports = gd();
var un = vo.exports;
...
const wd = s.oneOfType([s.func, s.object]), Fo = wd;
function tt(e) {
  if (typeof e != "string")
...
function Md() {
  this.visibilityState === "hidden" && wo && (Pn = !0);
}
function Ad(e) {
  e.addEventListener("keydown", Id, !0), e.addEventListener("mousedown", no, !0), e.addEventListener("pointerdown", no, !0), e.addEventListener("touchstart", no, !0), e.addEventListener("visibilitychange", Md, !0);
}
function Dd(e) {
  const {
    target: t
...
function ws() {
  ...
  function r() {
    return t.current ? (wo = !0, Pd.start(100, () => {
      wo = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
...
ks.isRequired = Es;
xo.isRequired = xo;
const Ns = process.env.NODE_ENV === "production" ? xo : ks;
function Ts(e, t) {
  const r = P({}, t);
...
function Gd(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = ge(e, Ud), a = Hd(t), i = Object.keys(a);
  function l(g) {
...
function ke(e) {
  const {
    ...
    if (i[t] == null)
      return null;
    const l = i[t], c = i.theme, f = $n(c, n) || {};
    return pt(i, l, (v) => {
      let g = mn(f, o, v);
      return v === g && typeof v == "string" && (g = mn(f, o, `${t}${v === "default" ? "" : tt(v)}`, v)), r === !1 ? g : {
        [r]: g
      };
    });
  };
...
const au = qe("border", He), iu = qe("borderTop", He), su = qe("borderRight", He), lu = qe("borderBottom", He), cu = qe("borderLeft", He), pu = qe("borderColor"), du = qe("borderTopColor"), uu = qe("borderRightColor"), fu = qe("borderBottomColor"), mu = qe("borderLeftColor"), hu = qe("outline", He), gu = qe("outlineColor"), An = (e) => {
...
Mn(au, iu, su, lu, cu, pu, du, uu, fu, mu, An, hu, gu);
const Dn = (e) => {
...
Mn(Dn, jn, Bn, bu, vu, yu, wu, xu, Eu, ku, Nu, Tu);
function Jt(e, t) {
  return t === "grey" ? t : e;
}
const Cu = ke({
...
function Bu() {
  function e(r, n, o, a) {
    ...
    return v ? v(i) : pt(i, n, (h) => {
      let u = mn(g, m, h);
      return h === u && typeof h == "string" && (u = mn(g, m, `${r}${h === "default" ? "" : tt(h)}`, h)), c === !1 ? u : {
        [c]: u
      };
    });
  }
...
function Go(e = {}, ...t) {
  ...
  return f.applyStyles = Lu, f = t.reduce((m, v) => lt(m, v), f), f.unstable_sxConfig = P({}, Uo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return Ho({
      sx: v,
      theme: this
    });
...
const Yu = Go(), Xa = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function tn({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Ku(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Jc(i, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: f,
      ...
      overridesResolver: g = qu(Xa(f))
    } = l, p = ge(l, Gu), h = m !== void 0 ? m : (
    ...
    let w = sn;
    f === "Root" || f === "root" ? w = n : f ? w = o : Xu(i) && (w = void 0);
    const O = qc(i, P({
      shouldForwardProp: w,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${tt(f || "")}`), N === void 0 && (N = `Styled(${yd(i)})`), _.displayName = N;
      }
...
function hn(e, t) {
  return e = Bt(e), t = Wo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Ln(e);
}
function tf(e, t) {
...
function xf(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = ge(e, mf), a = e.primary || hf(t), i = e.secondary || gf(t), l = e.error || bf(t), c = e.info || vf(t), f = e.success || yf(t), m = e.warning || wf(t);
  function v(u) {
    const b = qa(u, oo.text.primary) >= r ? oo.text.primary : Ka.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const w = qa(u, b);
...
`));
  ...
  return f.unstable_sxConfig = P({}, Uo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return Ho({
      sx: v,
      theme: this
    });
...
const Is = (e) => sn(e) && e !== "classes", Ff = Ku({
  themeId: Yo,
  defaultTheme: Xo,
...
const zf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Uf = (e) => {
  ...
  const n = ft({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = n, p = ge(n, zf), h = /* @__PURE__ */ k.isValidElement(o) && o.type === "svg", u = P({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), Xf = /* @__PURE__ */ Qp(Wf);
var ri;
function Yf() {
...
var As = Bo.default = void 0, Kf = qf(Yf()), Jf = Zl;
As = Bo.default = (0, Kf.default)(/* @__PURE__ */ (0, Jf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Ds(e) {
...
function rm(e) {
  ...
  const i = js(P({}, o, n)), l = ni(n), c = ni(o), f = t(i), m = Oe(f == null ? void 0 : f.className, r == null ? void 0 : r.className, a, o == null ? void 0 : o.className, n == null ? void 0 : n.className), v = P({}, f == null ? void 0 : f.style, r == null ? void 0 : r.style, o == null ? void 0 : o.style, n == null ? void 0 : n.style), g = P({}, f, r, c, l);
...
function gn(e) {
  const {
    ...
    isEnabled: i = um,
    open: l
  } = e, c = k.useRef(!1), f = k.useRef(null), m = k.useRef(null), v = k.useRef(null), g = k.useRef(null), p = k.useRef(!1), h = k.useRef(null), u = We(t.ref, h), b = k.useRef(null);
  k.useEffect(() => {
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const x = Re(h.current), E = (C) => {
      ...
      if ((x.activeElement === f.current || x.activeElement === m.current) && (I = a(h.current)), I.length > 0) {
        var R, _;
        const N = !!((R = b.current) != null && R.shiftKey && ((_ = b.current) == null ? void 0 : _.key) === "Tab"), M = I[0], j = I[I.length - 1];
...
process.env.NODE_ENV !== "production" && (gn["propTypes"] = hs(gn.propTypes));
function fm(e) {
  return typeof e == "function" ? e() : e;
}
const jr = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    children: n,
    container: o,
    disablePortal: a = !1
  ...
  if (jt(() => {
    ...
    if (/* @__PURE__ */ k.isValidElement(n)) {
      ...
      return /* @__PURE__ */ k.cloneElement(n, f);
    }
    return /* @__PURE__ */ d(k.Fragment, {
      children: n
    });
  }
  return /* @__PURE__ */ d(k.Fragment, {
...
process.env.NODE_ENV !== "production" && (jr["propTypes"] = hs(jr.propTypes));
function mm(e) {
  const t = Re(e);
...
function Em(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = k.useRef({}), p = k.useRef(null), h = k.useRef(null), u = We(h, v), [b, w] = k.useState(!m), O = wm(c);
  let x = !0;
  ...
  }), I = k.useCallback(() => o.isTopModal(y()), [o]), R = Ar((B) => {
  ...
  return {
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: yo(B, c == null ? void 0 : c.props.onEnter),
        onExited: yo(W, c == null ? void 0 : c.props.onExited)
      };
    },
    rootRef: u,
    portalRef: R,
...
var Me = "top", Xe = "bottom", Ye = "right", Ae = "left", Ko = "auto", Wr = [Me, Xe, Ye, Ae], nr = "start", Br = "end", km = "clippingParents", Fs = "viewport", br = "popper", Nm = "reference", ii = /* @__PURE__ */ Wr.reduce(function(e, t) {
  return e.concat([t + "-" + nr, t + "-" + Br]);
}, []), Vs = /* @__PURE__ */ [].concat(Wr, [Ko]).reduce(function(e, t) {
...
function ar(e, t, r) {
  ...
  var i = Ft(e) ? ze(e) : window, l = i.visualViewport, c = !zs() && r, f = (n.left + (c && l ? l.offsetLeft : 0)) / o, m = (n.top + (c && l ? l.offsetTop : 0)) / a, v = n.width / o, g = n.height / a;
  return {
    width: v,
    height: g,
    top: m,
...
function Lm(e) {
  var t = /firefox/i.test(Eo()), r = /Trident/i.test(Eo());
  if (r && Ge(e)) {
    var n = dt(e);
    if (n.position === "fixed")
      return null;
...
function Xr(e) {
  for (var t = ze(e), r = si(e); r && Bm(r) && dt(r).position === "static"; )
    r = si(r);
  return r && (rt(r) === "html" || rt(r) === "body" && dt(r).position === "static") ? t : r || Lm(e) || t;
}
function Qo(e) {
...
var Vm = function(t, r) {
  ...
  })) : t, Gs(typeof t != "number" ? t : Ws(t, Wr));
};
function zm(e) {
  ...
  if (!(!a || !i)) {
    var v = Vm(o.padding, r), g = Zo(a), p = c === "y" ? Me : Ae, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], w = Xr(a), O = w ? c === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = u / 2 - b / 2, E = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + x, C = Rr(E, T, y), I = c;
...
function li(e) {
  ...
  if (p = M.x, u = M.y, c) {
    var j;
    return Object.assign({}, N, (j = {}, j[E] = O ? "0" : "", j[x] = w ? "0" : "", j.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + u + "px)" : "translate3d(" + p + "px, " + u + "px, 0)", j));
  }
  return Object.assign({}, N, (t = {}, t[E] = O ? u + "px" : "", t[x] = w ? p + "px" : "", t.transform = "", t));
}
function Xm(e) {
...
function Xs(e) {
  return ["html", "body", "#document"].indexOf(rt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && ra(e) ? e : Xs(Fn(e));
}
function Pr(e, t) {
  var r;
  t === void 0 && (t = []);
  var n = Xs(e), o = n === ((r = e.ownerDocument) == null ? void 0 : r.body), a = ze(n), i = o ? [a].concat(a.visualViewport || [], ra(n) ? n : []) : n, l = t.concat(i);
  return o ? l : (
...
function pi(e, t, r) {
  return t === Fs ? ko(Qm(e, r)) : Ft(t) ? th(t, r) : ko(eh(Tt(e)));
}
function rh(e) {
  var t = Pr(Fn(e)), r = ["absolute", "fixed"].indexOf(dt(e).position) >= 0, n = r && Ge(e) ? Xr(e) : e;
  return Ft(n) ? t.filter(function(o) {
    return Ft(o) && Us(o, n) && rt(o) !== "body";
  }) : [];
}
function nh(e, t, r, n) {
  var o = t === "clippingParents" ? rh(e) : [].concat(t), a = [].concat(o, [r]), i = a[0], l = a.reduce(function(c, f) {
    var m = pi(e, f, n);
...
function Lr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? km : l, f = r.rootBoundary, m = f === void 0 ? Fs : f, v = r.elementContext, g = v === void 0 ? br : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, w = Gs(typeof b != "number" ? b : Ws(b, Wr)), O = g === br ? Nm : br, x = e.rects.popper, E = e.elements[h ? O : g], y = nh(Ft(E) ? E : E.contextElement || Tt(e.elements.popper), c, m, i), T = ar(e.elements.reference), C = Ys({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
  }), I = ko(Object.assign({}, x, C)), R = g === br ? I : T, _ = {
...
function oh(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, a = r.rootBoundary, i = r.padding, l = r.flipVariations, c = r.allowedAutoPlacements, f = c === void 0 ? Vs : c, m = ir(n), v = m ? l ? ii : ii.filter(function(h) {
    return ir(h) === m;
...
function ih(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, w = Qe(b), O = w === b, x = c || (O || !h ? [cn(b)] : ah(b)), E = [b].concat(x).reduce(function(H, K) {
      return H.concat(Qe(K) === Ko ? oh(t, {
        placement: K,
        boundary: m,
        rootBoundary: v,
        padding: f,
      ...
      var N = E[_], M = Qe(N), j = ir(N) === nr, z = [Me, Xe].indexOf(M) >= 0, G = z ? "width" : "height", B = Lr(t, {
        placement: N,
        boundary: m,
        rootBoundary: v,
        altBoundary: g,
...
function dh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.offset, a = o === void 0 ? [0, 0] : o, i = Vs.reduce(function(m, v) {
    return m[v] = ph(v, t.rects, a), m;
...
function gh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Lr(t, {
    ...
    padding: v,
    altBoundary: m
  }), w = Qe(t.placement), O = ir(t.placement), x = !O, E = Qo(w), y = hh(E), T = t.modifiersData.popperOffsets, C = t.rects.reference, I = t.rects.popper, R = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, _ = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
  ...
  if (T) {
    if (a) {
      var j, z = E === "y" ? Me : Ae, G = E === "y" ? Xe : Ye, B = E === "y" ? "height" : "width", W = T[E], te = W + b[z], V = W - b[G], S = p ? -I[B] / 2 : 0, L = O === nr ? C[B] : I[B], X = O === nr ? -I[B] : -C[B], Y = t.elements.arrow, H = p && Y ? Zo(Y) : {
        width: 0,
        height: 0
      }, K = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Hs(), q = K[z], Z = K[G], J = Rr(0, C[B], H[B]), Q = x ? C[B] / 2 - S - J - q - _.mainAxis : L - J - q - _.mainAxis, ee = x ? -C[B] / 2 + S + J + Z + _.mainAxis : X + J + Z + _.mainAxis, ie = t.elements.arrow && Xr(t.elements.arrow), F = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = (j = N == null ? void 0 : N[E]) != null ? j : 0, A = W + Q - re - F, se = W + ee - re, Ne = Rr(p ? bn(te, A) : te, W, p ? At(V, se) : V);
      T[E] = Ne, M[E] = Ne - W;
    }
    if (l) {
      var $e, Ee = E === "x" ? Me : Ae, Ct = E === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + b[Ee], at = _e - b[Ct], Ce = [Me, Ae].indexOf(w) !== -1, Vt = ($e = N == null ? void 0 : N[y]) != null ? $e : 0, St = Ce ? Be : _e - C[ot] - I[ot] - Vt + _.altAxis, cr = Ce ? _e + C[ot] + I[ot] - Vt - _.altAxis : at, Kr = p && Ce ? Fm(St, _e, cr) : Rr(p ? St : Be, _e, p ? cr : at);
      T[y] = Kr, M[y] = Kr - _e;
    }
    t.modifiersData[n] = M;
  }
...
function xh(e, t, r) {
  ...
  ra(a)) && (l = yh(t)), Ge(t) ? (c = ar(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = ta(a))), {
    ...
    var m = {
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (mi(O, x)) {
            m.rects = {
              reference: xh(O, Xr(x), m.options.strategy === "fixed"),
              popper: Zo(x)
...
var Sh = [Km, mh, Ym, jm, uh, sh, bh, Hm, ch], Oh = /* @__PURE__ */ Ch({
  defaultModifiers: Sh
});
const qs = "Popper";
function Rh(e) {
...
const Mh = () => ut({
  ...
  } = t, b = ge(t, Ph), w = k.useRef(null), O = We(w, r), x = k.useRef(null), E = We(x, g), y = k.useRef(E);
  jt(() => {
    y.current = E;
  }, [E]), k.useImperativeHandle(g, () => x.current, []);
  const T = _h(m, i), [C, I] = k.useState(T), [R, _] = k.useState(vn(o));
  k.useEffect(() => {
...
`));
  ...
  u !== null && (N.TransitionProps = u);
  const M = Mh(), j = (n = h.root) != null ? n : "div", z = Lt({
    elementType: j,
...
}), Ks = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    anchorEl: n,
    children: o,
    container: a,
...
const Js = U.createContext(null);
var Lh = function(t) {
  return t.scrollTop;
}, Nr = "unmounted", Rt = "exited", Pt = "entering", Kt = "entered", To = "exiting", mt = /* @__PURE__ */ function(e) {
  jh(t, e);
  function t(n, o) {
    var a;
  ...
  return r.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== Pt && i !== Kt && (a = Pt) : (i === Pt || i === Kt) && (a = To);
    }
    ...
    return (
      ...
      /* @__PURE__ */ U.createElement(Js.Provider, {
        value: null
...
const Vh = {
...
}, io = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), na = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    addEndListener: n,
    appear: o = !0,
    children: a,
  ...
  } = t, w = ge(t, Fh), O = Er(), x = k.useRef(), E = Yr(), y = k.useRef(null), T = We(y, a.ref, r), C = (G) => (B) => {
    if (G) {
      const W = y.current;
      B === void 0 ? G(W) : G(W, B);
    }
    ...
    u === "auto" ? (V = E.transitions.getAutoHeightDuration(G.clientHeight), x.current = V) : V = B, G.style.transition = [E.transitions.create("opacity", {
      ...
      easing: te
    })].join(","), G.style.opacity = 0, G.style.transform = Co(0.75), v && v(G);
  }), j = C(g);
...
}, gi = zh, Uh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Hh = Pe(Ks, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), el = /* @__PURE__ */ k.forwardRef(function(t, r) {
  var n;
  const o = $s(), a = ft({
    props: t,
    name: "MuiPopper"
    ...
    slots: x,
    slotProps: E
  } = a, y = ge(a, Uh), T = (n = x == null ? void 0 : x.root) != null ? n : c == null ? void 0 : c.Root, C = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const Wh = kt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), yt = Wh, Xh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Yh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const qh = (e) => {
...
const rl = /* @__PURE__ */ k.forwardRef(function(t, r) {
  ...
  const T = ft({
    ...
    slots: ee = {},
    title: ie,
    TransitionComponent: F = So,
    TransitionProps: re
  } = T, A = ge(T, Xh), se = /* @__PURE__ */ k.isValidElement(I) ? I : /* @__PURE__ */ d("span", {
    children: I
  }), Ne = Yr(), $e = Ne.direction === "rtl", [Ee, Ct] = k.useState(), [_e, ot] = k.useState(null), Be = k.useRef(!1), at = z || V, Ce = Er(), Vt = Er(), St = Er(), cr = Er(), [Kr, sa] = ys({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const la = (ne) => {
    ...
    onFocus: Vl,
    ref: zl
  } = ws(), [, da] = k.useState(!1), ua = (ne) => {
    Fl(ne), pa.current === !1 && (da(!1), ca(ne));
  }, fa = (ne) => {
    Ee || Ct(ne.currentTarget), Vl(ne), pa.current === !0 && (da(!0), Un(ne));
  }, ma = (ne) => {
    Be.current = !0;
    const Le = se.props;
    Le.onTouchStart && Le.onTouchStart(ne);
  }, ha = Un, ga = ca, Ul = (ne) => {
    ma(ne), St.clear(), Ce.clear(), Jr(), pr.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", cr.start(te, () => {
  ...
  const Gl = We(se.ref, zl, Ct, r);
  !ie && ie !== 0 && (it = !1);
  const Hn = k.useRef(), Wl = (ne) => {
    const Le = se.props;
  ...
  N ? (dr.title = !it && Gn && !j ? ie : null, dr["aria-describedby"] = it ? zn : null) : (dr["aria-label"] = Gn ? ie : null, dr["aria-labelledby"] = it && !Gn ? zn : null);
...
`));
  ...
  const ur = {};
  G || (Ue.onTouchStart = Ul, Ue.onTouchEnd = Hl), j || (Ue.onMouseOver = on(ha, Ue.onMouseOver), Ue.onMouseLeave = on(ga, Ue.onMouseLeave), at || (ur.onMouseOver = ha, ur.onMouseLeave = ga)), M || (Ue.onFocus = on(fa, Ue.onFocus), Ue.onBlur = on(ua, Ue.onBlur), at || (ur.onFocus = fa, ur.onBlur = ua)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Xl = k.useMemo(() => {
    var ne;
    let Le = [{
    ...
    touch: Be.current
  }), Wn = qh(fr), ba = (n = (o = ee.popper) != null ? o : R.Popper) != null ? n : Kh, va = (a = (i = (l = ee.transition) != null ? l : R.Transition) != null ? i : F) != null ? a : So, ya = (c = (f = ee.tooltip) != null ? f : R.Tooltip) != null ? c : Jh, wa = (m = (v = ee.arrow) != null ? v : R.Arrow) != null ? m : Zh, Yl = kr(ba, P({}, J, (g = Q.popper) != null ? g : _.popper, {
    className: Oe(Wn.popper, J == null ? void 0 : J.className, (p = (h = Q.popper) != null ? h : _.popper) == null ? void 0 : p.className)
  }), fr), ql = kr(va, P({}, re, (u = Q.transition) != null ? u : _.transition), fr), Kl = kr(ya, P({}, (b = Q.tooltip) != null ? b : _.tooltip, {
    className: Oe(Wn.tooltip, (w = (O = Q.tooltip) != null ? O : _.tooltip) == null ? void 0 : w.className)
  }), fr), Jl = kr(wa, P({}, (x = Q.arrow) != null ? x : _.arrow, {
    className: Oe(Wn.arrow, (E = (y = Q.arrow) != null ? y : _.arrow) == null ? void 0 : E.className)
  }), fr);
  return /* @__PURE__ */ $(k.Fragment, {
    children: [/* @__PURE__ */ k.cloneElement(se, Ue), /* @__PURE__ */ d(ba, P({
      as: Z ?? tl,
      placement: q,
      anchorEl: V ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ $(ya, P({}, Kl, {
          children: [ie, C ? /* @__PURE__ */ d(wa, P({}, Jl, {
            ref: ot
          })) : null]
        }))
      }))
...
const Qh = rl;
function vi(e, t, r) {
  return e ? /* @__PURE__ */ d(Di, { className: `papi-menu-icon-${r ? "leading" : "trailing"}`, children: /* @__PURE__ */ d("img", { src: e, alt: `${r ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function nl(e) {
  const {
    onClick: t,
    ...
    Lc,
    {
      ...
      children: r ? /* @__PURE__ */ $(Et, { children: [
        vi(a, r, !0),
        /* @__PURE__ */ d(Fc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ d(Di, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ d(As, {}) }) : vi(i, r, !1)
      ] }) : b
    }
  );
  return n ? /* @__PURE__ */ d(Qh, { title: n, placement: "right", children: /* @__PURE__ */ d("div", { children: w }) }) : w;
}
function ol(e) {
...
function eg(e) {
  const [t, r] = fe(void 0), { parentMenuItem: n, parentItemProps: o, menuDefinition: a } = e, i = (f) => {
    ...
    let f = ol(a).filter((m) => "menuItem" in m.group);
    if (!(n != null && n.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return f = f.filter(
      (m) => "menuItem" in m.group && m.group.menuItem === n.id
    ), /* @__PURE__ */ d(oa, { ...e, includedGroups: f });
  };
  return /* @__PURE__ */ $(Et, { children: [
    /* @__PURE__ */ d(nl, { onClick: i, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ d(
      Vc,
      {
        anchorEl: t,
...
function oa(e) {
  const { menuDefinition: t, onClick: r, commandHandler: n, includedGroups: o } = e, { items: a, allowForLeadingIcons: i } = xt(() => {
    const m = o && o.length > 0 ? o : (
      ...
      ol(t).filter((h) => !("menuItem" in h.group))
...
function rg(e) {
  ...
  )), /* @__PURE__ */ d(oa, { ...e, includedGroups: a });
}
function ng({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ $(
    ji,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d(zc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ d(
          rg,
          {
            commandHandler: e,
            menuDefinition: t,
...
const al = /* @__PURE__ */ k.createContext({});
process.env.NODE_ENV !== "production" && (al.displayName = "ListContext");
const ag = al;
function ig(e) {
  return nt("MuiList", e);
}
...
const sg = ["children", "className", "component", "dense", "disablePadding", "subheader"], lg = (e) => {
  ...
  paddingTop: 0
})), il = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const n = ft({
    props: t,
    name: "MuiList"
  }), {
  ...
  return /* @__PURE__ */ d(ag.Provider, {
    value: v,
    children: /* @__PURE__ */ $(cg, P({
      as: i,
...
const pg = il, dg = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function so(e, t, r) {
...
const ll = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: n,
  ...
  } = t, g = ge(t, dg), p = k.useRef(null), h = k.useRef({
    keys: [],
    repeating: !0,
  ...
  const u = (x) => {
    ...
    if (y === "ArrowDown")
      x.preventDefault(), yr(E, T, f, c, so);
    else if (y === "ArrowUp")
      x.preventDefault(), yr(E, T, f, c, yi);
    else if (y === "Home")
      x.preventDefault(), yr(E, null, f, c, so);
    else if (y === "End")
...
const ug = ll, fg = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], mg = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  } = t, x = ge(t, fg), E = k.useRef(null), y = We(E, l.ref, r), T = (z) => (G) => {
    if (z) {
      const B = E.current;
      G === void 0 ? z(B) : z(B, G);
    }
...
const Eg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], kg = (e) => {
  ...
  const Z = (n = (o = z == null ? void 0 : z.root) != null ? o : w.Root) != null ? n : Ng, J = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : w.Backdrop) != null ? a : m, Q = (l = j == null ? void 0 : j.root) != null ? l : O.root, ee = (c = j == null ? void 0 : j.backdrop) != null ? c : O.backdrop, ie = Lt({
    elementType: Z,
    externalSlotProps: Q,
...
const Og = ["className", "component", "elevation", "square", "variant"], Rg = (e) => {
  ...
  return P({
    ...
    backgroundImage: `linear-gradient(${hn("#fff", gi(t.elevation))}, ${hn("#fff", gi(t.elevation))})`
  }, e.vars && {
...
const Dg = (e) => {
  ...
  } = i, _ = ge(i.TransitionProps, Ig), N = ge(i, Mg), M = (n = E == null ? void 0 : E.paper) != null ? n : O, j = k.useRef(), z = We(j, M.ref), G = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
`));
  ...
  }, [c, f.horizontal, f.vertical, m, v]), te = k.useCallback((re) => ({
    ...
    const Ct = $e + A.height, _e = Ee + A.width, ot = rr(pn(c)), Be = ot.innerHeight - b, at = ot.innerWidth - b;
    if (b !== null && $e < b) {
      const Ce = $e - b;
      $e -= Ce, se.vertical += Ce;
...
`)), b !== null && Ee < b) {
  ...
  }, [c, v, W, te, b]), [S, L] = k.useState(w), X = k.useCallback(() => {
    const re = j.current;
    if (!re)
      return;
    const A = V(re);
  ...
  const q = h || (c ? Re(pn(c)).body : void 0), Z = (o = x == null ? void 0 : x.root) != null ? o : jg, J = (a = x == null ? void 0 : x.paper) != null ? a : fl, Q = Lt({
    elementType: J,
...
const Fg = ["onEntering"], Vg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], zg = {
  ...
  const a = ft({
    ...
    slots: O = {},
    slotProps: x = {}
  } = a, E = ge(a.TransitionProps, Fg), y = ge(a, Vg), T = Yr(), C = T.direction === "rtl", I = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: w
  }), R = Hg(I), _ = i && !f && g, N = k.useRef(null), M = (V, S) => {
    N.current && N.current.adjustStyleForScrollbar(V, T), b && b(V, S);
  }, j = (V) => {
    V.key === "Tab" && (V.preventDefault(), v && v(V, "tabKeyDown"));
  };
  let z = -1;
  k.Children.map(l, (V, S) => {
    /* @__PURE__ */ k.isValidElement(V) && (process.env.NODE_ENV !== "production" && un.isFragment(V) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), V.props.disabled || (w === "selectedMenu" && V.props.selected || z === -1) && (z = S));
  });
  const G = (n = O.paper) != null ? n : Wg, B = (o = x.paper) != null ? o : p, W = Lt({
    elementType: O.root,
...
const vt = "scrBook", Zg = "scrRef", $t = "source", Qg = "details", eb = "Scripture Reference", tb = "Scripture Book", gl = "Type", rb = "Details";
function nb(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      cell: (n) => {
        ...
        return n.row.getIsGrouped() ? he.bookNumberToEnglishName(o.start.bookNum) : n.row.groupingColumnId === vt ? Xn(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: $t,
      header: r ? (e == null ? void 0 : e.typeColumnName) ?? gl : void 0,
...
function l0({
  ...
  Je(() => {
    if (l) {
      ...
      if (_.length === 1) {
        const N = u.find((M) => ki(M) === _[0]) || void 0;
        N && l(N);
      }
    }
  }, [p, u, l, w]);
  const O = o ?? tb, x = a ?? gl, E = [
    ...
    !t && /* @__PURE__ */ $(
      _r,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Qt, { position: "item-aligned", children: /* @__PURE__ */ d(Pp, { children: E.map((R) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ $(Sn, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ d(On, { children: w.getHeaderGroups().map((R) => /* @__PURE__ */ d(wt, { children: R.headers.filter((_) => _.column.columnDef.header).map((_) => (
                  ...
                  children: (() => N.getIsGrouped() ? /* @__PURE__ */ $(
                    Te,
                    {
                      ...
                      children: [
                        ...
                        !R.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ d($i, {}) : /* @__PURE__ */ d(yc, {})),
                        " ",
...
const bl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Root,
  {
...
const vl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.List,
  {
    ref: r,
    className: D(
...
const ib = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Trigger,
  {
    ref: r,
    ...t,
...
)), yl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Content,
  {
    ref: r,
    className: D(
...
yl.displayName = je.Content.displayName;
function d0({
  tabList: e,
  onSearch: t,
  searchPlaceholder: r,
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ $(bl, { dir: a, children: [
      /* @__PURE__ */ d(vl, { children: e.map((i) => /* @__PURE__ */ d(ib, { value: i.value, children: i.value }, i.key)) }),
      e.map((i) => /* @__PURE__ */ d(yl, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
const wl = U.forwardRef(({ className: e, orientation: t = "horizontal", decorative: r = !0, ...n }, o) => /* @__PURE__ */ d(
  Fi.Root,
  {
    ref: o,
    decorative: r,
...
wl.displayName = Fi.Root.displayName;
...
const qr = wn(({ className: e, ...t }, r) => /* @__PURE__ */ d(wc, { size: 35, className: D("pr-animate-spin", e), ...t, ref: r }));
...
function b0({
  ...
  const a = Mt(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Xc, { position: "static", id: n, children: /* @__PURE__ */ $(
    Yc,
    {
...
), lb = U.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: D(sb({ variant: t }), e), ...r }));
...
cb.displayName = "AlertTitle";
const pb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: D("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
pb.displayName = "AlertDescription";
...
const mb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: D("pr-text-sm pr-text-muted-foreground", e), ...t }));
...
const bb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $(
  xr.Root,
  {
    ref: r,
    className: D(
...
bb.displayName = xr.Root.displayName;
...
vb.displayName = go.Root.displayName;
const y0 = je.Root, yb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.List,
  {
    ref: r,
    className: D(
...
yb.displayName = je.List.displayName;
const wb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Trigger,
  {
    ref: r,
    className: D(
...
wb.displayName = je.Trigger.displayName;
const xb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Content,
  {
    ref: r,
    className: D(
...
xb.displayName = je.Content.displayName;
function w0({
  isInstalling: e,
  handleClick: t,
  buttonText: r,
  ...
  return /* @__PURE__ */ d(
    Te,
    {
      ...
      children: e ? /* @__PURE__ */ d(qr, { size: 15 }) : /* @__PURE__ */ $(Et, { children: [
        /* @__PURE__ */ d(xc, { size: 25, className: D("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
...
const Eb = ["children", "options"], Ni = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), Ti = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, kb = ["style", "script"], Nb = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, Tb = /mailto:/i, Cb = /\n{2,}$/, xl = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, Sb = /^ *> ?/gm, Ob = /^ {2,}\n/, Rb = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, El = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, kl = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, Pb = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, $b = /^(?:\n *)*\n/, _b = /\r\n?/g, Ib = /^\[\^([^\]]+)](:.*)\n/, Mb = /^\[\^([^\]]+)]/, Ab = /\f/g, Db = /^\s*?\[(x|\s)\]/, Nl = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, Tl = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, Cl = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, Ro = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, jb = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, Sl = /^<!--[\s\S]*?(?:-->)/, Bb = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, Po = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, Lb = /^\{.*\}$/, Fb = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, Vb = /^<([^ >]+@[^ >]+)>/, zb = /^<([^ >]+:\/[^ >]+)>/, Ub = /-([a-z])?/gi, Ol = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, Hb = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, Gb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, Wb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, Xb = /(\[|\])/g, Yb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, qb = /\t/g, Kb = /^ *\| */, Jb = /(^ *\||\| *$)/g, Zb = / *$/, Qb = /^ *:-+: *$/, ev = /^ *:-+ *$/, tv = /^ *-+: *$/, rv = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, nv = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, ov = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, av = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, iv = /^\\([^0-9A-Za-z\s])/, sv = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, lv = /^\n+/, cv = /^([ \t]*)/, pv = /\\([^\\])/g, Ci = / *\n+$/, dv = /(?:^|\n)( *)$/, aa = "(?:\\d+\\.)", ia = "(?:[*+-])";
function Rl(e) {
  return "( *)(" + (e === 1 ? aa : ia) + ") +";
}
const Pl = Rl(1), $l = Rl(2);
function _l(e) {
  return new RegExp("^" + (e === 1 ? Pl : $l));
}
const uv = _l(1), fv = _l(2);
function Il(e) {
  return new RegExp("^" + (e === 1 ? Pl : $l) + "[^\\n]*(?:\\n(?!\\1" + (e === 1 ? aa : ia) + " )[^\\n]*)*(\\n|$)", "gm");
}
...
function Si(e, t) {
  const r = t === 1, n = r ? jl : Bl, o = r ? Ml : Al, a = r ? uv : fv;
  return { t(i, l, c) {
    const f = dv.exec(c);
    return f && (l.o || !l._ && !l.u) ? n.exec(i = f[1] + i) : null;
  }, i: ae.HIGH, l(i, l, c) {
    const f = r ? +i[2] : void 0, m = i[0].replace(Cb, `
`).match(o);
    let v = !1;
...
const mv = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, hv = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Ll = [xl, El, kl, Nl, Cl, Tl, Sl, Ol, Ml, jl, Al, Bl], gv = [...Ll, /^[^\n]+(?:  \n|\n{2,})/, Ro, Po];
function bv(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function vv(e) {
  return tv.test(e) ? "right" : Qb.test(e) ? "center" : ev.test(e) ? "left" : null;
}
function Oi(e, t, r) {
  const n = r.$;
  r.$ = !0;
...
function yv(e, t, r) {
  r._ = !0;
  const n = Oi(e[1], t, r), o = e[2].replace(Jb, "").split("|").map(vv), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(f) {
      return Oi(f, l, c);
    });
...
`))
  ...
  let n = "";
  e.split(`
`).every((a) => !Ll.some((i) => i.test(a)) && (n += a + `
`, a.trim()));
  const o = n.trimEnd();
  return o == "" ? null : [n, o];
}
...
var ae;
function Nv(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || bv, t.namedCodesToUnicode = t.namedCodesToUnicode ? It({}, Ti, t.namedCodesToUnicode) : Ti;
  ...
  function n(p, h, ...u) {
    ...
    }(p, t.overrides), It({}, h, b, { className: kv(h == null ? void 0 : h.className, b.className) || void 0 }), ...u);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = Yb.test(p) === !1);
    const u = m(f(h ? p : `${p.trimEnd().replace(lv, "")}
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, w) {
      ...
      if (O !== -1) {
        const x = function(C) {
          return C.indexOf("-") !== -1 && C.match(Bb) === null && (C = C.replace(Ub, function(I, R) {
          ...
          }, {}) : C === "href" ? Yt(I) : (I.match(Lb) && (I = I.slice(1, I.length - 1)), I === "true" || I !== "false" && I);
        }(x, E);
        typeof T == "string" && (Ro.test(T) || Po.test(T)) && (u[y] = k.cloneElement(o(T.trim()), { key: w }));
      } else
        b !== "style" && (u[Ni[b] || b] = !0);
      return u;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: st(xl), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(Sb, ""), u) }), h: (p, h, u) => n("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: wr(Ob), i: ae.HIGH, l: co, h: (p, h, u) => n("br", { key: u.k }) }, breakThematic: { t: st(Rb), i: ae.HIGH, l: co, h: (p, h, u) => n("hr", { key: u.k }) }, codeBlock: { t: st(kl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => n("pre", { key: u.k }, n("code", It({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: st(El), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: bt(Pb), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => n("code", { key: u.k }, p.v) }, footnote: { t: st(Ib), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: po }, footnoteReference: { t: gt(Mb), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B) }, n("sup", { key: u.k }, p.v)) }, gfmTask: { t: gt(Db), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => n("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: st(t.enforceAtxHeadings ? Tl : Nl), i: ae.HIGH, l: (p, h, u) => ({ v: dn(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => n(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: st(Cl), i: ae.MAX, l: (p, h, u) => ({ v: dn(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: wr(Sl), i: ae.HIGH, l: () => ({}), h: po }, image: { t: bt(hv), i: ae.HIGH, l: (p) => ({ D: p[1], B: Pi(p[2]), F: p[3] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Yt(p.B) }) }, link: { t: gt(mv), i: ae.LOW, l: (p, h, u) => ({ v: xv(h, p[1], u), B: Pi(p[2]), F: p[3] }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: gt(zb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : gt(Fb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: gt(Vb), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
    return Tb.test(u) || (u = "mailto:" + u), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: u, type: "link" };
  } }, orderedList: Si(n, 1), unorderedList: Si(n, 2), newlineCoalescer: { t: st($b), i: ae.LOW, l: co, h: () => `
` }, paragraph: { t: wv, i: ae.LOW, l: lo, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: gt(Hb), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: po }, refImage: { t: bt(Gb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Yt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: gt(Wb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(Xb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Yt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: st(Ol), i: ae.HIGH, l: yv, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, w) {
  ...
  }, h: () => " | " }, text: { t: wr(sv), i: ae.MIN, l: (p) => ({ v: p[0].replace(jb, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: bt(rv), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: bt(nv), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: bt(iv), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: bt(ov), i: ae.LOW, l: lo, h: (p, h, u) => n("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: bt(av), i: ae.LOW, l: lo, h: (p, h, u) => n("del", { key: u.k }, h(p.v, u)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: wr(Ro), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(cv), w = new RegExp(`^${b}`, "gm"), O = p[3].replace(w, ""), x = (E = O, gv.some((I) => I.test(E)) ? Ev : dn);
    var E;
    const y = p[1].toLowerCase(), T = kb.indexOf(y) !== -1;
    u.N = u.N || y === "a";
    const C = T ? p[3] : x(h, O, u);
    return u.N = !1, { O: a(p[2]), v: C, G: T, H: T ? y : p[1] };
  }, h: (p, h, u) => n(p.H, It({ key: u.k }, p.O), p.G ? p.v : h(p.v, u)) }, c.htmlSelfClosing = { t: wr(Po), i: ae.HIGH, l: (p) => ({ O: a(p[2] || ""), H: p[1] }), h: (p, h, u) => n(p.H, It({}, p.O, { key: u.k })) });
  const f = function(p) {
    let h = Object.keys(p);
    function u(b, w) {
      let O = [], x = "";
...
const Tv = (e) => {
  ...
  return k.cloneElement(Nv(t, r), n);
};
function N0({ id: e, markdown: t }) {
  return /* @__PURE__ */ d("div", { id: e, className: "pr-prose", children: /* @__PURE__ */ d(Tv, { children: t }) });
}
const Cv = wn((e, t) => /* @__PURE__ */ $(
  Te,
  {
    ref: t,
    ...
    ...e,
    children: [
      /* @__PURE__ */ d(Ec, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ d(
        En,
        {
...
var Sv = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(Sv || {});
function T0({ id: e, groups: t }) {
  return /* @__PURE__ */ d("div", { id: e, children: /* @__PURE__ */ $(Mo, { children: [
    /* @__PURE__ */ d(Xi, { asChild: !0, children: /* @__PURE__ */ d(Cv, {}) }),
    /* @__PURE__ */ d(Tn, { children: t.map((r) => /* @__PURE__ */ $("div", { children: [
      /* @__PURE__ */ d(Vr, { children: r.label }),
      /* @__PURE__ */ d(mp, { children: r.items.map((n) => /* @__PURE__ */ d("div", { children: n.itemType === 0 ? /* @__PURE__ */ d(Ao, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ d(qi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ d(Cn, {})
    ] }, r.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ $("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            /* @__PURE__ */ d(kc, { className: "pr-mr-1 pr-h-4 pr-w-4" }),
        ...
        /* @__PURE__ */ $("div", { className: "pr-ml-auto pr-flex pr-flex-col pr-space-y-2", children: [
          /* @__PURE__ */ $(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ d(Nc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ $(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ d(Tc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          )
        ] })
...
export {
  lb as Alert,
  pb as AlertDescription,
  cb as AlertTitle,
  Kv as BookChapterControl,
  Te as Button,
  db as Card,
  hb as CardContent,
  ...
  jo as Label,
  qt as LabelPosition,
  N0 as MarkdownRenderer,
  nl as MenuItem,
  S0 as MoreInfo,
  d0 as NavigationContentSearch,
  C0 as NoExtensionsFound,
  l0 as ScriptureResultsViewer,
  r0 as ScrollGroupSelector,
  ab as SearchBar,
  _r as Select,
  Qt as SelectContent,
  Pp as SelectGroup,
  ...
  bl as VerticalTabs,
  yl as VerticalTabsContent,
  vl as VerticalTabsList,
  ib as VerticalTabsTrigger,
  Op as buttonVariants,
  Do as getSortingIcon,
  e0 as inventoryCountColumn,
  Qv as inventoryItemColumn,
  t0 as inventoryStatusColumn,
  I0 as sonner,
  R0 as useEvent,
  P0 as useEventAsync,
  Oo as usePromise
