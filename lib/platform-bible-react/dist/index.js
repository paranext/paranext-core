...
import { c as v, g as Ee, a as Ba, C as ke, A as ie, P as De, b as We, B as q, d as Oe, e as Me, f as $e, h as xe, i as Pi, k as Vi, j as ji, E as Li, l as Ua, r as pe, m as Fi, n as ln, o as Qr, p as ta, L as Nt, R as Ka, q as qr, D as Na, s as Ca, t as Ea, u as Ta, T as dn, v as Vr, w as Pt, x as qa, y as Vt, z as jt, F as Lt, G as wn, H as Ga, I as Ge, J as kr, K as Ie, M as Ae, N as Pe, S as _r, O as er, Q as Bi, U as Er, V as Ye, W as ze, Z as Xe, X as Te, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as un, a3 as Ui, a4 as Ki, a5 as qi, a6 as za, a7 as pn, a8 as ea, a9 as hn, aa as Gi, ab as Hi, ac as Yi, ad as Wi, ae as gn, af as Xi, ag as sa, ah as xo, ai as ca, aj as Ji, ak as Zi, al as Qi, am as ts, an as es, ao as Tr, ap as Xa, aq as rs, ar as as } from "./resizable-C3AVzTx2.js";
...
import { Section as dt, getChaptersForBook as Ps, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Vs, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as kn, formatBytes as js, getCurrentLocale as Ls, usfmMarkers as jr, getFormatCallerFunction as Fs, deepEqual as Bs, isString as No, compareScrRefs as Oa, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as Co, formatReplacementStringToArray as Eo, collectUsjMarkers as Ks } from "platform-bible-utils";
import Wt, { useRef as B, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as qs, useLayoutEffect as Qt, createContext as Qa, useContext as _n, Component as Gs, createElement as To, Suspense as Hs, forwardRef as Nn, useId as zo, Fragment as ra } from "react";
...
import { useReactTable as jn, getFilteredRowModel as Zc, getSortedRowModel as Ln, getPaginationRowModel as Qc, getCoreRowModel as Fn, flexRender as xr, getGroupedRowModel as tl, getExpandedRowModel as el } from "@tanstack/react-table";
...
function ua({
  ...
  const F = pe(), [z, I] = _(!1), [A, C] = _(""), [P, U] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
  ), [W, Z] = _(void 0), [Dt, Tt] = _(!1), Ft = B(null), K = B(!1), tt = B(void 0), wt = B(void 0), at = B(void 0), mt = B(void 0), ae = B({}), ut = B({}), bt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ...
  }), [Ot]), Jt = D(() => Object.values(Bt).flat(), [Bt]), fe = D(() => {
    if (!P.trim()) return Bt;
    const x = {
      [dt.OT]: [],
      [dt.NT]: [],
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      x[rt] = Bt[rt].filter((At) => Ua(At, P, n));
    }), x;
  }, [Bt, P, n]), R = D(
    () => pl(P, Jt, n),
    [P, Jt, n]
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    (x) => {
      ...
      if ((k === "chapters" || k === "books" && R) && At) {
        ...
        if (!Et) return;
        k === "chapters" && ((Be = tt.current) == null || Be.focus());
        const kt = (() => {
          if (!A) return 1;
          const ce = A.match(/(\d+)$/);
  ...
  return Qt(() => {
    const x = setTimeout(() => {
      if (z && k === "books" && at.current && mt.current) {
        const G = at.current, rt = mt.current, At = rt.offsetTop, me = G.clientHeight, Ne = rt.clientHeight, Be = At - me / 2 + Ne / 2;
        G.scrollTo({
          top: Math.max(0, Be),
          behavior: "smooth"
        }), C(Un(t.book));
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: G } = x;
          z && Ft.current && G instanceof Node && Ft.current.contains(G) && (K.current = !0, it(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Me,
              ...
              k === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  q,
                  {
                    ...
                    tabIndex: -1,
                    children: F === "ltr" ? /* @__PURE__ */ a(os, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" })
                  }
                ),
...
function jo({
  ...
  const [N, O] = _(!1), F = d ?? l, z = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
...
function Tl() {
  return function(t) {
    const [e] = ge(), r = D(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = B(o);
    return Cl(() => {
...
function Ml(t, e = Ol) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, E = g.getNode(), y = E.getKey(), N = g.offset, O = t.getElementByKey(b), F = t.getElementByKey(y), z = r === null || O !== o || m !== n || b !== r.getKey(), I = i === null || F !== s || N !== c || y !== i.getKey();
      if ((z || I) && O !== null && F !== null) {
...
let Yr, be = 0, Wr = 0, Fl = 0, Va = 0, Fr = 0;
function Bo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
qt.prototype.brand = jl, qt.prototype.h = function() {
  ...
  if (this.g = Fr, this.f |= 1, this.i > 0 && !Yn(this)) return this.f &= -2, !0;
  const t = nt;
  try {
    Uo(this), nt = this;
    const e = this.x();
...
function Zu({
  ...
  const [i, s] = _(Dd), [c, l] = _(n), [d, w] = _(!1), p = B(void 0), h = B(null);
  H(() => {
    let m = !0;
    const E = h.current;
    if (!E) return;
...
function Zo({
  ...
  const g = L(
    ...
    [t.contents]
  ), O = !!t.conflictResolutionAction && !N, F = D(() => {
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          Ge,
...
function vi({
  ...
  const [k, J] = _(Qo), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Ft] = _(!1), [K, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(O), [Ot, Bt] = _(!1), Jt = B(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
  ...
  const Zt = D(() => Ct[0], [Ct]), _e = B(null), te = B(void 0), V = L(() => {
    var S;
    (S = te.current) == null || S.call(te), J(Qo);
  }, []), Q = L(() => {
    const S = !ut;
    bt(S), Bt(!S), f == null || f(l, S);
  }, [ut, f, l]);
  H(() => {
    Dt(!1);
  }, [o]), H(() => {
                        ...
                        Oe,
                        {
                          ...
                          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: b == null ? void 0 : b.map((S) => /* @__PURE__ */ a(
                            ke,
                            {
                              ...
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Br(S, r) })
                            },
                            S || "unassigned"
                          )) }) })
                        }
...
function sp({
  ...
  const [y, N] = _(/* @__PURE__ */ new Set()), [O, F] = _(), [z, I] = _(), A = L(
    async ($) => {
      const W = await i($);
  ...
  H(() => {
    f && (N(($) => new Set($).add(f)), F(f));
  }, [f]);
  const C = r.filter(
    ($) => $.comments.some((W) => !W.deleted)
  ), P = C.map(($) => ({ id: $.id })), U = L(
    ($) => {
      N((W) => new Set(W).add($.id)), F($.id), b == null || b($.id);
    },
    [b]
  ), k = L(
    ($) => {
    ...
    [y, b]
  ), { listboxRef: J, activeId: j, handleKeyDown: Y } = Bi({
    options: P,
    onOptionSelect: U
  }), T = L(
    ($) => {
      $.key === "Escape" ? (O && y.has(O) && (N((W) => {
        const Z = new Set(W);
        return Z.delete(O), Z;
      }), F(void 0), b == null || b(void 0)), $.preventDefault(), $.stopPropagation()) : Y($);
    },
    [O, y, Y, b]
  );
  return /* @__PURE__ */ a(
...
function Xd({
  ...
  return l ? F = Array.from({ length: 10 }).map((C, P) => `skeleton-row-${P}`).map((C) => /* @__PURE__ */ a(Te, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? F = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    I.id
  )) : F = /* @__PURE__ */ a(Te, { children: /* @__PURE__ */ a(rr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function nw({
  ...
  const i = B(null), s = B(null), c = B(!1), [l, d] = _(t), [w, p] = _(r), [h, g] = _(!1);
  H(() => {
    d(t);
  }, [t]), H(() => {
    w !== r && p(r);
...
function mp({
  ...
  const [f, b] = _("generated"), [m, E] = _("generated"), [y, N] = _("*"), [O, F] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [P, U] = _(!0), [k, J] = _(!1), j = B(!1), Y = B(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Ft, K] = _(), [tt, wt] = _(), at = B(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Ia ? st = "generated" : it === Aa ? st = "hidden" : it && (N(it), F(it)), b(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), V = setTimeout(() => {
        var ht;
  ...
  const Bt = B({ book: n.book, chapterNum: n.chapterNum });
  Qt(() => {
    (Bt.current.book !== n.book || Bt.current.chapterNum !== n.chapterNum) && (Bt.current = { book: n.book, chapterNum: n.chapterNum }, Ot.current());
  }, [n.book, n.chapterNum]);
  const Jt = () => {
    var Q;
...
function Tp({
  ...
  const g = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), m = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), O = le(r, "%webView_inventory_filter_text%"), F = le(
    r,
    "%webView_inventory_show_additional_items%"
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
        /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Nt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? F })
        ] }) }),
        /* @__PURE__ */ a(Lt, { children: (o == null ? void 0 : o.checkboxText) ?? F })
      ] }) })
    ] }),
...
function Pw({
  ...
  const d = L(
    ...
    () => r.map((g) => ({
      ...
      fullName: g.projectFullName ?? g.projectName
    })),
    [r]
  ), h = L(
...
const Ce = "scrBook", Vw = "scrRef", qe = "source", jw = "details", Lw = "Scripture Reference", Fw = "Scripture Book", ki = "Type", Bw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function qw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [b, m] = _(!1), [E, y] = _(""), N = B(void 0), O = B(!1), F = D(
    () => _i(t),
    [t]
  ), z = D(() => {
    if (!E.trim()) {
    ...
    (k, J = !1) => {
      ...
      const j = F.findIndex((Z) => Z === N.current), Y = F.findIndex((Z) => Z === k);
      if (j === -1 || Y === -1) return;
      const [T, $] = [
        Math.min(j, Y),
        Math.max(j, Y)
      ], W = F.slice(T, $ + 1).map((Z) => Z);
      r(
...
function Kp({
  ...
  const O = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), F = St(s, "%webView_scope_selector_verse%"), z = St(s, "%webView_scope_selector_chapter%"), I = St(s, "%webView_scope_selector_book%"), A = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), C = St(
    s,
  ...
  ] }), tt = e ? Ft.filter((M) => e.includes(M.value)) : Ft, wt = f ?? da, at = w ?? wt, mt = p ?? wt, ae = () => {
  }, ut = B(null), bt = B(null), Ot = B(!1), Bt = B(null), Jt = B(!1), [fe, R] = _(void 0), yt = B(!1), Ct = B(!1), Zt = B(null), _e = L((M) => {
    if (M) {
  ...
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", Fe = d === "dropdown" && zt === "range", x = Fe ? It : V, rt = Fe ? oe : g ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: ut, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ua,
        {
          ...
          localizedStrings: m,
          getEndVerse: E,
          disableReferencesUpTo: Fe ? S ?? at : at,
          onOpenChange: te,
          onCloseAutoFocus: (M) => {
            var X;
  ...
  const fo = L(
    ...
    var X;
    M.preventDefault(), (X = Be.current) == null || X.focus();
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ua,
                          {
                            ...
                            onCloseAutoFocus: (M) => {
                              var X;
                              M.preventDefault(), (X = Bt.current) == null || X.focus();
                            },
                            modal: !0,
...
function th({
  ...
  const d = cu(
    ...
    return m ? `${(F = t[f]) == null ? void 0 : F.autonym} (${m})` : (z = t[f]) == null ? void 0 : z.autonym;
  };
