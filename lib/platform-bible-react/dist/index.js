...
import { includes as Rr, Section as Z, getChaptersForBook as Ji, formatScrRef as ye, getSectionForBook as fr, formatRelativeDate as Zi, formatReplacementString as xe, sanitizeHtml as Qi, NumberFormat as ts, formatBytes as es, getCurrentLocale as rs, usfmMarkers as Fr, getFormatCallerFunction as as, deepEqual as os, isString as mo, compareScrRefs as Da, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as ns, getLocalizeKeyForScrollGroupId as vo } from "platform-bible-utils";
import { Check as Ae, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronLeft as Sa, ChevronRight as Oa, ArrowLeft as is, ArrowRight as ss, ChevronDown as tr, BoldIcon as cs, ItalicIcon as ls, X as ea, AtSign as dn, Pencil as ds, Trash2 as ws, ArrowUp as wn, MoreHorizontal as us, MailOpen as ps, Mail as hs, ChevronUp as gs, FilterIcon as fs, ArrowLeftIcon as ms, ChevronLeftIcon as vs, ChevronRightIcon as bs, ArrowRightIcon as xs, Copy as un, Filter as ys, User as ks, Link as _s, CircleHelp as Ns, ChevronsUpDown as pn, Star as Cs, Undo as Es, Redo as Ts, SquareX as hn, FunctionSquare as gn, SquareSigma as fn, Ban as zs, AlertCircle as $a, CircleCheckIcon as Ds, CircleXIcon as Ss, CircleHelpIcon as Os, ArrowUpIcon as $s, ArrowDownIcon as Ms, Search as Rs, LoaderCircle as As, ScrollText as Ps, MenuIcon as Is, Menu as Vs, EllipsisVertical as Ls, MoreVertical as ko } from "lucide-react";
...
function ga({
  ...
  const C = jt(), [k, _] = N(!1), [I, j] = N(""), [V, $] = N(""), [x, z] = N("books"), [A, S] = N(void 0), [O, W] = N(
    void 0
  ), [K, M] = N(void 0), [Q, mt] = N(!1), ct = q(null), Bt = q(!1), bt = q(void 0), St = q(void 0), U = q(void 0), rt = q(void 0), ot = q({}), nt = q({}), it = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const Vt = L(() => {
    ...
    const b = O;
    W(void 0), M(void 0), b ? (S(b), z("chapters"), j("")) : Ht();
  }, [O, Ht]), H = L((b) => {
    ...
    () => ll(V),
    [V]
  ), kt = F(() => !l || !D || !D.chapterNum || !pt ? !1 : l(D.book, D.chapterNum) > 0, [l, D, pt]), je = L(
    (b) => w ? Oo(b, w) : !1,
    [w]
  ), Oe = L(
    (b) => (G) => w ? dl(b, G, w) : !1,
    ...
    const { isLetter: G, isDigit: J } = $o(b.key);
    (G || J) && (b.preventDefault(), $((Jt) => Jt + b.key), St.current.focus(), mt(!1));
  }, []);
  return Xt(() => {
    const b = setTimeout(() => {
...
function ed(t, e, r = ei) {
  return Ee(t.registerCommand(xc, (o) => {
    ...
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Nc : Do : Cc;
    return t.dispatchCommand(i, void 0);
  }, Xa), t.registerCommand(Do, () => {
...
function Pd({
  ...
  const [$, x] = N(Wo), [z, A] = N(), [S, O] = N(), W = o, [K, M] = N(!1), [Q, mt] = N(!1), [ct, Bt] = N(!1), [bt, St] = N(!1), [U, rt] = N(!1), [ot, nt] = N(_), [it, It] = N(!1), vt = q(void 0), [Ut, Kt] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let E = !0;
    return (async () => {
            ...
            o && /* @__PURE__ */ u(tt, { children: [
              ...
              v !== !1 && (!Q || Zt($)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (E) => {
                    co(E) && (E.preventDefault(), E.stopPropagation(), (Zt($) || z !== void 0 && z !== S) && gt());
                  },
                  onKeyDown: (E) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && (Zt($) || z !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: xe(
...
function sw({
  ...
  const [n, i] = N(""), [s, c] = F(() => {
    ...
    if (!d)
      return [e.filter((p) => !p.isDisallowed), []];
    const l = e.filter((p) => {
      var h;
      const f = (h = p.marker) == null ? void 0 : h.toLowerCase();
      return p.isDisallowed ? f === d : f == null ? void 0 : f.includes(d);
    }), w = e.filter(
...
function hp({
  ...
  const [m, y] = N("generated"), [v, T] = N("generated"), [C, k] = N("*"), [_, I] = N("*"), [j, V] = N("f"), [$, x] = N(!1), [z, A] = N(!0), [S, O] = N(!1), W = q(!1), K = q(""), [M, Q] = N(!1), [mt, ct] = N(), [Bt, bt] = N(), [St, U] = N(), [rt, ot] = N(), nt = q(null), it = F(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
function Np({
  ...
  const h = de(r, "%webView_inventory_all%"), m = de(r, "%webView_inventory_approved%"), y = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), T = de(r, "%webView_inventory_scope_currentBook%"), C = de(r, "%webView_inventory_scope_chapter%"), k = de(r, "%webView_inventory_scope_verse%"), _ = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), j = de(r, "%webView_inventory_no_results%"), [V, $] = N(!1), [x, z] = N("all"), [A, S] = N(""), [O, W] = N([]), K = F(() => {
    const U = t ?? [];
    ...
    Tw,
    {
      ...
      children: /* @__PURE__ */ u(Dw, { children: [
        /* @__PURE__ */ u(en, { children: [
          ...
          /* @__PURE__ */ a(an, { children: /* @__PURE__ */ a(Sw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(Ow, { children: /* @__PURE__ */ a(
            Mw,
            {
              onClick: () => l(h),
              isActive: f(h),
...
const jw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Da(t.start, t.end) === 0 ? `${ua(t.start)}+${e}` : `${ua(t.start)}+${e}-${ua(t.end)}+${r}`;
...
function jp({
  ...
  Y(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const A = y.find((S) => on(S) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [h, y, c, T]);
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !x.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a(Oa, {}) : /* @__PURE__ */ a(Sa, {})),
                          " ",
...
function Up({
  ...
  }, vt = q(null), Ut = q(null), Kt = q(!1), D = q(null), Ot = q(!1), [Vt, ne] = N(void 0), qt = q(!1), $t = q(!1), Se = q(null), Gt = L((R) => {
    if (R) {
  ...
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, E] = N(!1), [wt, pt] = N(void 0), [kt, je] = N(void 0), [Oe, lr] = N(void 0), [Be, dr] = N(void 0), [wr, Dr] = N([]), Sr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    Kw,
    {
      availableBookInfo: o,
  ...
  const [Wt, Ue] = N(null), [Or, Di] = N(null), [$r, Si] = N(null), Oi = 200, [$i, Mi] = N(!1);
  Y(() => {
  ...
  const po = L(
    (R) => {
      je(R), lr(nt), dr(it), Dr(n), E(!1), pt(R);
    },
    [nt, it, n]
  ), ho = L(() => {
    ...
    l === "dropdown" && gt && /* @__PURE__ */ a(Va, { open: wt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      La,
      {
        ...
        children: /* @__PURE__ */ u(da, { container: Wt, children: [
          ...
          /* @__PURE__ */ u(So, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Mr(!1), children: ct }),
            /* @__PURE__ */ a(B, { ref: Se, onClick: ho, children: mt })
          ] })
        ] })
      }
    ) })
