...
import { useReactTable as Ho, getFilteredRowModel as rl, getSortedRowModel as Uo, getPaginationRowModel as ol, getCoreRowModel as Xo, flexRender as tn, getGroupedRowModel as al, getExpandedRowModel as sl } from "@tanstack/react-table";
...
const ml = Rt.Root, hl = Rt.Portal, Yo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Rt.Overlay,
  {
    ref: n,
    className: h(
...
Yo.displayName = Rt.Overlay.displayName;
...
qo.displayName = Rt.Content.displayName;
...
Wo.displayName = Rt.Title.displayName;
...
const un = b.forwardRef((e, t) => /* @__PURE__ */ o(bt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
un.displayName = bt.Empty.displayName;
const Xt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  bt.Group,
  {
    ref: n,
    className: h(
...
Zo.displayName = bt.Separator.displayName;
...
var gl = Object.defineProperty, bl = (e, t, n) => t in e ? gl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, U = (e, t, n) => bl(e, typeof t != "symbol" ? t + "" : t, n);
const Ce = [
  "GEN",
  "EXO",
  "LEV",
...
const gt = class Y {
  constructor(t, n, r, a) {
    if (U(this, "firstChapter"), U(this, "lastChapter"), U(this, "lastVerse"), U(this, "hasSegmentsDefined"), U(this, "text"), U(this, "BBBCCCVVVS"), U(this, "longHashCode"), U(this, "versification"), U(this, "rtlMark", "‏"), U(this, "_bookNum", 0), U(this, "_chapterNum", 0), U(this, "_verseNum", 0), U(this, "_verse"), r == null && a == null)
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new fe(Pt[i]);
        } catch {
...
const le = Ae.Root, ce = Ae.Trigger, Ep = Ae.Anchor, Wt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = pt();
  ...
  return /* @__PURE__ */ d(le, { open: w, onOpenChange: c, children: [
    /* @__PURE__ */ o(ce, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ o(Ur, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ o(Wt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: /* @__PURE__ */ o(Xt, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      Lt,
      {
        onSelect: () => p(m),
        className: h("tw-flex tw-items-center", l),
        children: [
          /* @__PURE__ */ o(Ur, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function ro({
  ...
  if (e)
    return /* @__PURE__ */ o(Xt, { children: /* @__PURE__ */ o("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Vt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Lt,
      {
        value: `${e} ${Ne[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function Sp({
  ...
  const c = pt(), [p, m] = M(!1), [f, u] = M(""), [g, y] = M(""), [v, N] = M("books"), [k, T] = M(void 0), [V, $] = M(!1), P = Z(void 0), x = Z(void 0), E = Z(void 0), _ = Z(void 0), S = Z({}), C = z(
    (O) => {
      t(O), l && l(O);
    },
    [t, l]
  ...
  }), [A]), I = B(() => Object.values(K).flat(), [K]), F = B(() => {
    if (!g.trim()) return K;
    const O = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    [v, j]
  ), { otLong: ft, ntLong: xt, dcLong: Nt, extraLong: de } = {
    ...
    const { isLetter: H, isDigit: st } = no(O.key);
    (H || st) && (O.preventDefault(), y((lt) => lt + O.key), x.current.focus(), $(!1));
  }, []);
  return Ht(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && E.current && _.current) {
        const H = E.current, st = _.current, lt = st.offsetTop, nt = H.clientHeight, zt = st.clientHeight, Ct = lt - nt / 2 + zt / 2;
        H.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(pr(e.book));
        ...
        children: [
          ...
          !V && /* @__PURE__ */ d(Jt, { ref: E, children: [
            v === "books" && /* @__PURE__ */ d(wt, { children: [
              !D && Object.entries(F).map(([O, H]) => {
                if (H.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Xt, { heading: hn(O), children: H.map((st) => /* @__PURE__ */ o(
                      la,
                      {
                        bookId: st,
                        onSelect: (lt) => ct(lt),
              ...
              D && /* @__PURE__ */ o(Xt, { children: /* @__PURE__ */ o(
                Lt,
                {
    ...
    /* @__PURE__ */ o(
      Wt,
      {
        ...
        children: /* @__PURE__ */ d(qt, { children: [
          ...
          /* @__PURE__ */ o(Jt, { children: $(t) ? t.map((x) => /* @__PURE__ */ o(Xt, { heading: x.groupHeading, children: x.options.map((E) => P(E, x.groupHeading)) }, x.groupHeading)) : t.map((x) => P(x)) })
        ] })
      }
    )
  ] });
...
function Mp({
  ...
  const p = Un(c, "%webView_bookSelector_currentBook%"), m = Un(c, "%webView_bookSelector_choose%"), f = Un(c, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    g(v), e(v);
...
const wa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, jl = wa ? Ht : q, xn = { tag: kr };
      ...
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = An();
            u.append(g);
            const y = wa ? document.activeElement : null;
...
const Fl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
...
const Or = {
  ...
  mark: "",
  markOverlap: ""
}, Tt = pn.Provider, $t = pn.Root, Gt = pn.Trigger, St = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  pn.Content,
  {
    ref: r,
    sideOffset: t,
...
class Hl extends ks {
  ...
  componentDidUpdate(t, n) {
    ...
    if (r && n.error !== null && Ul(t.resetKeys, a)) {
      var s, i;
...
const Yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function ql(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function Jl() {
  return function(e) {
    const [t] = Bt(), n = B(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = Z(r);
    return Yl(() => {
...
function Wl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !fi(t) && r !== null) {
    ...
    if (c || p) {
      const [m, f] = gi(e), u = l.is(w), g = t.is(i ? w : l), y = t.is(i ? l : w);
      let v, N = 0;
      u ? (N = m > f ? f : m, v = m > f ? m : f) : g ? (N = i ? f : m, v = void 0) : y && (N = 0, v = i ? m : f);
...
Yt({ build: (e, t, n) => $n(t), config: dn({ $onClear: ga }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
...
const hr = Yt({ build: (e) => va(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const dc = Yt({ config: dn({ setOptions: lo, updateOptions: lo }), init: ({ $initialEditorState: e = wc }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
const uc = /* @__PURE__ */ new Set(), po = Yt({ build(e, t, n) {
...
Yt({ dependencies: [hr, po], name: "@lexical/extension/HorizontalRule", nodes: [Pe], register(e, t, n) {
  ...
  return ae(e.registerCommand(Ei, (i) => {
    if (Ti(i.target)) {
      ...
      if (hc(l)) return function(w, c = !1) {
        const p = Ut(), m = w.isSelected(), f = w.getKey();
        let u;
...
const gc = Yt({ name: "@lexical/react/ReactProvider" });
function bc() {
...
Yt({ build: (e, t, n) => $n(t), config: dn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => se(() => n.getOutput().disabled.value ? void 0 : Ca(e)) });
function yc(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Vr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
...
const Tc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function Sc({ onClear: e }) {
  const [t] = Bt();
  return Tc(() => ba(t, e), [t, e]), null;
}
const Ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function Rc({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: y, role: v = "textbox", spellCheck: N = !0, style: k, tabIndex: T, "data-testid": V, ...$ }, P) {
...
function $c({
  ...
  const [t] = Bt(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Vc(), w = () => {
  };
...
function Kc(e, t) {
  const n = Ui(t) ? t.body.childNodes : t.childNodes;
  let r = [];
  const a = [];
...
function Ma(e, t, n, r = null) {
  ...
  const l = ye(i) ? i.getChildren() : [], w = Ki(e, i.getType());
  let c;
...
function Ia(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (f = p(f)), Zr(e) && (f = Uc(e, f, u ? () => {
    const g = new jo();
    return n.push(g), g;
...
function Xc(e) {
  ...
  if (n.update(
    () => {
      const s = new DOMParser().parseFromString(t, "text/html"), i = Kc(n, s);
      oe().clear(), Yi(i);
    },
    {
      discrete: !0
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(je, {}) }) }),
          /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: y }) })
        ] }) }),
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
...
function lw({
  ...
  const [$, P] = M(go), [x, E] = M(!1), [_, S] = M(!1), [C, A] = M(!1), [K, I] = M(!1), [F, D] = M(!1), [G, ct] = M(void 0), [Qt, jt] = M(!1), [ut, j] = M(!1), [et, ft] = M(T), [xt, Nt] = M(!1), de = Z(void 0), [hn, Ye] = M(/* @__PURE__ */ new Map());
  q(() => {
    let R = !0;
    if (!r) {
      jt(!1), j(!1), Ye(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
  ...
  const _t = B(() => te[0], [te]), fn = Z(null), Re = Z(void 0), pe = z(() => {
    var R;
    (R = Re.current) == null || R.call(Re), P(go);
  }, []), O = z(() => {
    const R = !et;
    ft(R), Nt(!R), u == null || u(w, R);
  }, [et, u, w]);
  q(() => {
    const R = fn.current;
    if (!R)
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
              ...
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("span", { className: e, children: [
                    _t.contextBefore,
                    /* @__PURE__ */ o("span", { className: "tw-font-bold", children: _t.selectedText }),
                    _t.contextAfter
                  ] })
                ]
              }
            ...
            _ && /* @__PURE__ */ o(
              L,
              {
                ...
                children: x ? /* @__PURE__ */ o(or, {}) : /* @__PURE__ */ o(_e, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
            fo,
            {
              ...
              handleDeleteComment: f,
              onEditingChange: I,
              canEditOrDelete: hn.get(_t.id) ?? !1,
              canUserResolveThread: ut
            }
          )
        ] }),
        /* @__PURE__ */ d(wt, { children: [
          zt && !r && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          r && /* @__PURE__ */ d(wt, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    C ? /* @__PURE__ */ o(or, {}) : /* @__PURE__ */ o(_e, {})
                  ] })
                ]
              }
            ),
            Ct.map((R) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              fo,
              {
                comment: R,
                localizedStrings: n,
            ...
            y !== !1 && (!K || Et($)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (R) => {
                  R.key === "Enter" && R.shiftKey && (R.preventDefault(), R.stopPropagation(), (Et($) || G !== void 0) && Kr());
                },
                onKeyDown: (R) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    G !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ve(
                    ...
                    /* @__PURE__ */ d(le, { open: F, onOpenChange: D, children: [
                      ...
                      /* @__PURE__ */ o(
                        Wt,
                        {
                          ...
                          children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: g == null ? void 0 : g.map((R) => /* @__PURE__ */ o(
                            Lt,
                            {
                              onSelect: () => {
                                ct(R !== s ? R : void 0), D(!1);
...
function Pp({
  ...
  const T = n.filter(
    ...
    [y]
  ), { listboxRef: x, activeId: E, handleKeyDown: _ } = Wc({
    options: V,
    onOptionSelect: $
  }), S = z(
    (C) => {
...
Ka.displayName = it.ScrollDownButton.displayName;
      ...
      /* @__PURE__ */ d(
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ o(Te, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(kt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
function yw({
  ...
  var P;
  const [p, m] = M([]), [f, u] = M([]), [g, y] = M({}), [v, N] = M({}), k = B(() => t ?? [], [t]), T = Ho({
    data: k,
    columns: e,
    getCoreRowModel: Xo(),
  ...
  let $;
  return w ? $ = Array.from({ length: 10 }).map((_, S) => `skeleton-row-${S}`).map((_) => /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(ke, { colSpan: V.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(gr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((P = T.getRowModel().rows) == null ? void 0 : P.length) > 0 ? $ = T.getRowModel().rows.map((x) => /* @__PURE__ */ o(
    Ft,
    {
      onClick: () => i(x, T),
    ...
    x.id
  )) : $ = /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(ke, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(cw, { table: T }),
    /* @__PURE__ */ d(Ln, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Bn, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ o(Ft, { children: x.headers.map((E) => /* @__PURE__ */ o(cn, { children: E.isPlaceholder ? void 0 : tn(E.column.columnDef.header, E.getContext()) }, E.id)) }, x.id)) }),
...
function Ew({
  ...
  const [N, k] = M(!1), T = z(
    (S) => {
      var A;
      const C = (A = e.find((K) => K.label === S)) == null ? void 0 : A.value;
      C && n(
        t.includes(C) ? t.filter((K) => K !== C) : [...t, C]
      );
    },
    [e, t, n]
  ), V = () => w || r, $ = B(() => {
    if (!f) return e;
    const S = e.filter((A) => A.starred).sort((A, K) => A.label.localeCompare(K.label)), C = e.filter((A) => !A.starred).sort((A, K) => {
      const I = t.includes(A.value), F = t.includes(K.value);
      return I && !F ? -1 : !I && F ? 1 : A.label.localeCompare(K.label);
    });
    return [...S, ...C];
  }, [e, t, f]), P = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(le, { open: E, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ o(ce, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: y,
    ...
    /* @__PURE__ */ o(Wt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(qt, { children: [
      ...
      /* @__PURE__ */ d(Jt, { children: [
        ...
        /* @__PURE__ */ o(Xt, { children: $.map((S) => /* @__PURE__ */ d(
          Lt,
          {
            value: S.label,
            onSelect: T,
...
function Sw({
  ...
  return /* @__PURE__ */ d(Se, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(He, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: Tw(e, a, n) }) }) }),
...
function Mw({
  ...
  return /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
      ...
      /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: Dw(e, n) }) })
    ] }) }),
...
function Gp({
  ...
  const w = Z(null), c = Cs(), [p, m] = M("generated"), [f, u] = M("*"), [g, y] = M("f"), [v, N] = M(!1), k = B(
    () => ({
      ...i,
  ...
  const T = z(() => {
    ...
    x && vn("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = f : x.insert.note.caller = p === "generated" ? ir : lr), n([x]));
  }, [p, f, n]), V = () => {
    var E;
    ...
    if (E && vn("note", E)) {
      ...
      g !== "x" && x === "x" ? I == null || I.forEach((F) => Ow(F)) : g === "x" && x !== "x" && (I == null || I.forEach((F) => Iw(F))), (K = w.current) == null || K.applyUpdate([{ delete: 1 }, E]);
    }
  }, P = () => {
    var E, _, S, C, A;
    const x = (_ = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    if (x && vn("note", x)) {
      const K = (S = x.insert.note) == null ? void 0 : S.style, I = (A = (C = x.insert.note) == null ? void 0 : C.contents) == null ? void 0 : A.ops;
      K || N(!1), N(
        K === "x" ? !!(I != null && I.every((F) => {
          var G, ct;
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: r, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(je, {}) }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
            /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: V, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(To, {}) }) }),
...
function Vw({
  ...
  /* @__PURE__ */ d("span", { className: h("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    jr(e.marker, [i], r, !1),
    " "
  ] }), f = t === "horizontal" ? "horizontal" : "vertical", u = r ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", y = h(f, u);
  return /* @__PURE__ */ d(wt, { children: [
    /* @__PURE__ */ d("div", { className: h("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: [
      w,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: h("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: m }),
    /* @__PURE__ */ o(
      "div",
      {
        className: h(
...
function Hp({
  ...
  const p = w ?? hi(n, void 0), m = (k, T) => {
    c == null || c(k, T, a);
  }, f = s ? n.findIndex((k) => k === s) : -1, [u, g] = M(f), y = (k, T, V) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
...
function Lw({
  ...
  return /* @__PURE__ */ d(Ln, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Bn, { stickyHeader: !0, children: /* @__PURE__ */ d(Ft, { children: [
...
const zn = (e) => e === "asc" ? /* @__PURE__ */ o(qs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ws, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Up = (e) => ({
  accessorKey: "item",
...
function Qp({
  ...
  const f = At(n, "%webView_inventory_all%"), u = At(n, "%webView_inventory_approved%"), g = At(n, "%webView_inventory_unapproved%"), y = At(n, "%webView_inventory_unknown%"), v = At(n, "%webView_inventory_scope_currentBook%"), N = At(n, "%webView_inventory_scope_chapter%"), k = At(n, "%webView_inventory_scope_verse%"), T = At(n, "%webView_inventory_filter_text%"), V = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), $ = At(n, "%webView_inventory_no_results%"), [P, x] = M(!1), [E, _] = M("all"), [S, C] = M(""), [A, K] = M([]), I = B(() => {
    const j = e ?? [];
  ...
  }, [P, I]), D = B(() => F.length === 0 ? [] : zw(F, E, S), [F, E, S]), G = B(() => {
    var ft, xt;
    if (!P) return w;
  ...
  q(() => {
    D.length === 0 ? K([]) : D.length === 1 && K(D[0].items);
  }, [D]);
  const ct = (j, et) => {
    et.setRowSelection(() => {
      const ft = {};
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(Te, { children: [
              ...
              /* @__PURE__ */ o(kt, { value: "unknown", children: y })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Le, { onValueChange: (j) => Qt(j), defaultValue: i, children: [
        ...
        /* @__PURE__ */ d(Te, { children: [
          ...
          /* @__PURE__ */ o(kt, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Xe,
...
function eu({ localizedStrings: e, markerMenuItems: t }) {
  ...
  return /* @__PURE__ */ d(qt, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ d(Jt, { children: [
      ...
      /* @__PURE__ */ o(Xt, { children: a.map((s) => /* @__PURE__ */ d(
        Lt,
        {
...
const Gw = "16rem", Kw = "3rem", Ua = b.createContext(void 0);
function Fn() {
...
const Xa = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ o(Ua.Provider, { value: k, children: /* @__PURE__ */ o(Tt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Hw = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Fn();
  return /* @__PURE__ */ d(
    L,
    {
  ...
  ({
    ...
    const w = e ? ze : "button", { state: c } = Fn(), p = /* @__PURE__ */ o(
      w,
      {
        ...
        "data-size": r,
        "data-active": t,
        className: h(Zw({ variant: n, size: r }), s),
        ...i
      }
    );
...
const pd = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || sr(e.start, e.end) === 0 ? `${Kn(e.start)}+${t}` : `${Kn(e.start)}+${t}-${Kn(e.end)}+${n}`;
}, xo = (e) => `${pd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function ru({
  sources: e,
  ...
  const [c, p] = M([]), [m, f] = M([{ id: ne, desc: !1 }]), [u, g] = M({}), y = B(
  ...
  q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const C = y.find((A) => xo(A) === S[0]) || void 0;
        C && l(C);
      }
    }
  }, [u, y, l, N]);
  ...
  }, x = (_, S) => _.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), E = (_, S, C) => {
    ...
    !t && /* @__PURE__ */ d(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Te, { position: "item-aligned", children: /* @__PURE__ */ o(ww, { children: V.map((_) => /* @__PURE__ */ o(kt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Ln, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Bn, { children: N.getHeaderGroups().map((_) => /* @__PURE__ */ o(Ft, { children: _.headers.filter((S) => S.column.columnDef.header).map((S) => (
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (C === "ltr" ? /* @__PURE__ */ o(Ie, {}) : /* @__PURE__ */ o(rr, {})),
                          " ",
...
function md({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], w = r["%webView_book_selector_select_all%"], c = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], m = r["%webView_book_selector_more%"], { otLong: f, ntLong: u, dcLong: g, extraLong: y } = {
                    ...
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(No, { children: [
                        /* @__PURE__ */ o(
                          Xt,
                          {
                            heading: sa(I, f, u, g, y),
                            children: D.map((G) => /* @__PURE__ */ o(
                              la,
                              {
                                bookId: G,
                        ...
                        F < Object.values(X).length - 1 && /* @__PURE__ */ o(Zo, {})
                      ] }, I);
                  })
                ] })
              ]
...
function au({
  ...
  const c = he(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), f = he(i, "%webView_scope_selector_current_book%"), u = he(i, "%webView_scope_selector_choose_books%"), g = he(i, "%webView_scope_selector_scope%"), y = he(i, "%webView_scope_selector_select_books%"), v = [
      ...
      children: [
        ...
        /* @__PURE__ */ o(
          Te,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((c) => /* @__PURE__ */ o(kt, { value: `${c}`, children: l[W(c)] }, `${c}`))
          }
        )
      ]
    }
...
function yr({
  ...
  return /* @__PURE__ */ d(Se, { variant: s, children: [
    ...
    /* @__PURE__ */ o(we, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(No, { children: [
      /* @__PURE__ */ o(Ba, { children: /* @__PURE__ */ o(Tt, { children: rs(t.groups, t.items, w, e) }) }),
      c < p.length - 1 && /* @__PURE__ */ o(Ue, {})
    ] }, w)) })
  ] });
}
...
function pu({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(as, { children: [
      /* @__PURE__ */ o(ss, { children: e.map((l) => /* @__PURE__ */ o(hd, { value: l.value, children: l.value }, l.key)) }),
  ...
  if (wl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), We(i, [f, u]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ o(ls, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(fd, { children: [
      /* @__PURE__ */ o(cs, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        ps,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Tt, { children: hs(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
const _d = wn(({ className: e, ...t }, n) => /* @__PURE__ */ o(oi, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
const Sd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Sd.displayName = "AlertDescription";
const vu = at.Root, xu = at.Trigger, yu = at.Group, Nu = at.Portal, ku = at.Sub, _u = at.RadioGroup, Rd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  at.SubTrigger,
  {
    ref: a,
    className: h(
...
const Md = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(at.Portal, { children: /* @__PURE__ */ o(
  at.Content,
  {
    ref: n,
    className: h(
...
const Cu = Mt.Trigger, Bd = Mt.Portal, Eu = Mt.Close, gs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Mt.Overlay,
  {
    ref: n,
...
Gd.displayName = Mt.Title.displayName;
...
Kd.displayName = Mt.Description.displayName;
const Hd = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  wr.Root,
  {
    ref: r,
    className: h(
...
Ud.displayName = Ze.Root.displayName;
...
Xd.displayName = dr.Root.displayName;
const Mu = vt.Root, Yd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = pt();
  return /* @__PURE__ */ o(
    vt.List,
    {
...
Yd.displayName = vt.List.displayName;
const qd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  vt.Trigger,
  {
    ref: n,
    className: h(
...
qd.displayName = vt.Trigger.displayName;
...
Jd.displayName = vt.Content.displayName;
