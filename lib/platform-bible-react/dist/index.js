...
import { Check as or, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Ta, ChevronRight as za, ChevronsUpDown as gn, ArrowLeft as os, ArrowRight as ns, ChevronDown as nr, BoldIcon as is, ItalicIcon as ss, X as Xa, AtSign as fn, Pencil as cs, Trash2 as ls, ArrowUp as mn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as vn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Cs, AlertCircle as Sa, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Ds, ScrollText as Rs, MenuIcon as Os, Menu as $s, EllipsisVertical as Ms, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Is, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as As, formatReplacementString as Ke, sanitizeHtml as Ja, NumberFormat as Vs, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as Pr, getFormatCallerFunction as Bs, deepEqual as Ls, isString as Co, compareScrRefs as Da, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Eo, collectUsjMarkers as Us } from "platform-bible-utils";
import Dt, { useRef as F, useMemo as M, useState as _, useCallback as B, useEffect as H, useImperativeHandle as Ks, useLayoutEffect as Qt, createContext as Za, useContext as kn, Component as qs, createElement as To, Suspense as Gs, forwardRef as _n, useId as zo, Fragment as Nn } from "react";
import { RadioGroup as Ra, ToggleGroup as Cn, Avatar as Qa, Select as Ut, Checkbox as So, Slot as zr, Tabs as ce, Menubar as he, ContextMenu as Rt, Progress as Do, Slider as Or, Switch as Ro } from "radix-ui";
import { createEditor as En, $getRoot as Re, $createParagraphNode as Sr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as Tn, TextNode as zn, $getPreviousSelection as Hs, $isRangeSelection as ue, $caretFromPoint as Ys, $getSiblingCaret as Sn, $getChildCaret as Ws, $getAdjacentChildCaret as Xs, $isChildCaret as Js, $normalizeCaret as Zs, $setSelectionFromCaretRange as Qs, $getCollapsedCaretRange as tc, $getCaretInDirection as Oo, $splitAtPointCaretNext as ec, $isTextPointCaret as rc, $findMatchingParent as Dn, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as ac, isHTMLElement as oc, CLEAR_EDITOR_COMMAND as Rn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as nc, defineExtension as ae, safeCast as Xe, createState as ic, FORMAT_TEXT_COMMAND as On, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as Mn, RootNode as sc, LineBreakNode as cc, TabNode as lc, $isEditorState as dc, createCommand as wc, CLICK_COMMAND as uc, isDOMNode as pc, $getNodeFromDOMNode as hc, $createNodeSelection as gc, $setSelection as fc, $getEditor as mc, DecoratorNode as Oa, $getState as vc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as bc, $setState as xc, addClassNamesToElement as In, $create as yc, $getNodeByKey as kc, removeClassNamesFromElement as _c, KEY_TAB_COMMAND as Nc, $isBlockElementNode as Cc, $createRangeSelection as Ec, $normalizeSelection__EXPERIMENTAL as Tc, OUTDENT_CONTENT_COMMAND as zc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Sc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Dc, $isParagraphNode as Rc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as An, $insertNodes as Oc } from "lexical";
import { HeadingNode as $c, QuoteNode as Mc, registerRichText as Ic } from "@lexical/rich-text";
import { flushSync as Ac, createPortal as Vc } from "react-dom";
...
import { useReactTable as Pn, getFilteredRowModel as Lc, getSortedRowModel as jn, getPaginationRowModel as Fc, getCoreRowModel as Bn, flexRender as xr, getGroupedRowModel as Uc, getExpandedRowModel as Kc } from "@tanstack/react-table";
import { IconCheck as ra, IconChevronDown as qc, IconChevronUp as Gc, IconSelector as Hc, IconLayoutSidebar as Yc, IconLayoutSidebarRight as Wc, IconChevronRight as Ln, IconLoader as Xc, IconAlertOctagon as Jc, IconAlertTriangle as Zc, IconInfoCircle as Qc, IconCircleCheck as tl } from "@tabler/icons-react";
...
function ml({ initialConfig: t, children: e }) {
  const r = M(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = gl(null, o), w = En({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
function Il(t) {
  const e = Xt() || Hs();
  let r;
  if (ue(e)) r = Ys(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Sn(c, "next"));
    }
    r = r || Ws(Re(), "previous").getFlipped().insert(Sr());
  }
  const o = Al(t, r), n = Xs(o), i = Js(n) ? Zs(n) : o;
  return Qs(tc(i)), t.getLatest();
}
function Al(t, e, r) {
  let o = Oo(e, "next");
  for (let n = o; n; n = ec(n, r)) o = n;
  return rc(o) && Hr(283), o.insert(t.isInline() ? Sr().append(t) : t), Oo(Sn(t.getLatest(), "next"), e.direction);
}
function Vl(t) {
  const e = Xt();
  if (!ue(e)) return !1;
...
const ha = ic("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends Oa {
  $config() {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Xt();
  if ($n(n) || ue(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, Mn) });
function ti(t, e) {
  let r;
...
}, name: "@lexical/extension/InitialState", nodes: [sc, zn, cc, lc, Tn] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Go() {
}
function Xl(t) {
  throw t;
...
}, dependencies: [Pa], name: "@lexical/extension/NodeSelection" }), Zl = wc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends Oa {
  static getType() {
  ...
  return Ne(t.registerCommand(Zl, (s) => {
    ...
    if (pc(s.target)) {
      ...
      if (td(c)) return function(d, l = !1) {
        ...
        let h;
        l && $n(w) ? h = w : (h = gc(), fc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function ed(t, e, r = oi) {
  return Ne(t.registerCommand(Nc, (o) => {
    const n = Xt();
    if (!ue(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ut.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ut.Icon, { asChild: !0, children: /* @__PURE__ */ a(Hc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Xd({
  ...
  var z;
  const [w, p] = _([]), [g, h] = _([]), [f, x] = _({}), [v, E] = _({}), k = M(() => e ?? [], [e]), N = Pn({
    data: k,
    columns: t,
    getCoreRowModel: Bn(),
...
function Ba({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Nn, { children: [
...
function Ah(t) {
  const e = M(() => Us(t).slice().sort().join(" "), [t]);
