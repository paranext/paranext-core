...
import { c as m, g as Se, a as La, C as Ce, A as ie, P as Me, b as Ye, B as U, d as $e, e as Ie, f as Ae, h as xe, i as Ai, k as Vi, j as Pi, E as ji, l as Ba, r as pe, m as Li, n as cn, o as Qr, p as ta, L as Nt, R as Fa, q as qr, D as _a, s as Na, t as Ca, u as Ea, T as ln, v as Pr, w as Gt, x as Ua, y as Ht, z as Yt, F as Wt, G as dn, H as Ka, I as qe, J as kr, K as ye, M as ke, N as _e, S as _r, O as tr, Q as Bi, U as Er, V as He, W as De, Z as We, X as Re, Y as er, _ as qa, $ as Ga, a0 as Gr, a1 as Ha, a2 as wn, a3 as Fi, a4 as Ui, a5 as Ki, a6 as vo, a7 as un, a8 as ea, a9 as pn, aa as qi, ab as Gi, ac as Hi, ad as Yi, ae as hn, af as Wi, ag as ia, ah as bo, ai as sa, aj as Xi, ak as Ji, al as Zi, am as Qi, an as ts, ao as Tr, ap as Ya, aq as es, ar as rs } from "./resizable-U5tJboHn.js";
import { as as Kh, at as qh, au as Gh, av as Hh, aw as Yh, ax as Wh, ay as Xh, az as Jh, aA as Zh, aB as Qh, aC as tg, aD as eg, aE as rg, aF as ag, aG as og, aH as ng, aI as ig, aJ as sg, aK as cg, aL as lg, aM as dg, aN as wg, aO as ug, aP as pg, aQ as hg } from "./resizable-U5tJboHn.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as or, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as as, ArrowRight as os, ChevronDown as nr, BoldIcon as ns, ItalicIcon as is, X as Wa, AtSign as gn, Pencil as ss, Trash2 as cs, ArrowUp as fn, MoreHorizontal as ls, MailOpen as ds, Mail as ws, ChevronUp as us, FilterIcon as ps, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as fs, ArrowRightIcon as ms, Copy as mn, Filter as vs, User as bs, Link as xs, CircleHelp as ys, Undo as ks, Redo as _s, SquareX as vn, FunctionSquare as bn, SquareSigma as xn, Ban as Ns, AlertCircle as Sa, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as zs, ArrowDownIcon as Ss, ScrollText as Rs, ChevronsUpDown as Ds, MenuIcon as Os, Menu as Ms, EllipsisVertical as $s, MoreVertical as _o } from "lucide-react";
import { Section as dt, getChaptersForBook as Is, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as As, formatReplacementString as Ge, sanitizeHtml as Xa, NumberFormat as Vs, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as jr, getFormatCallerFunction as Ls, deepEqual as Bs, isString as No, compareScrRefs as Ra, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Co, collectUsjMarkers as Us } from "platform-bible-utils";
import qt, { useRef as F, useMemo as O, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Ks, useLayoutEffect as Qt, createContext as Ja, useContext as yn, Component as qs, createElement as Eo, Suspense as Gs, forwardRef as kn, useId as To, Fragment as _n } from "react";
import { IconSelector as Nn, IconCheck as ra, IconChevronDown as Hs, IconChevronUp as Ys, IconLayoutSidebar as Ws, IconLayoutSidebarRight as Xs, IconChevronRight as Cn, IconSearch as Js, IconLoader as Zs, IconAlertOctagon as Qs, IconAlertTriangle as tc, IconInfoCircle as ec, IconCircleCheck as rc } from "@tabler/icons-react";
import { createEditor as En, $getRoot as Oe, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as Za, ParagraphNode as Tn, TextNode as zn, $getPreviousSelection as ac, $isRangeSelection as we, $caretFromPoint as oc, $getSiblingCaret as Sn, $getChildCaret as nc, $getAdjacentChildCaret as ic, $isChildCaret as sc, $normalizeCaret as cc, $setSelectionFromCaretRange as lc, $getCollapsedCaretRange as dc, $getCaretInDirection as zo, $splitAtPointCaretNext as wc, $isTextPointCaret as uc, $findMatchingParent as Rn, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as pc, isHTMLElement as hc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as Qa, shallowMergeConfig as gc, defineExtension as re, safeCast as Xe, createState as fc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as Mn, COMMAND_PRIORITY_LOW as $n, RootNode as mc, LineBreakNode as vc, TabNode as bc, $isEditorState as xc, createCommand as yc, CLICK_COMMAND as kc, isDOMNode as _c, $getNodeFromDOMNode as Nc, $createNodeSelection as Cc, $setSelection as Ec, $getEditor as Tc, DecoratorNode as Da, $getState as zc, toggleTextFormatType as So, TEXT_TYPE_TO_FORMAT as Sc, $setState as Rc, addClassNamesToElement as In, $create as Dc, $getNodeByKey as Oc, removeClassNamesFromElement as Mc, KEY_TAB_COMMAND as $c, $isBlockElementNode as Ic, $createRangeSelection as Ac, $normalizeSelection__EXPERIMENTAL as Vc, OUTDENT_CONTENT_COMMAND as Pc, INDENT_CONTENT_COMMAND as Ro, INSERT_TAB_COMMAND as jc, COMMAND_PRIORITY_CRITICAL as to, $isDecoratorNode as Lc, $isParagraphNode as Bc, $isTextNode as Oa, SELECTION_CHANGE_COMMAND as An, $insertNodes as Fc } from "lexical";
...
import { Avatar as eo, Select as Ft, Checkbox as Do, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Oo, Slider as Or, Switch as Mo } from "radix-ui";
...
function wa({
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    (b) => {
      var me, Te, Be;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: rt } = Io(b.key);
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = qn ? Qt : H, Ir = { tag: Za };
    ...
    w.read(() => {
      ...
      if ((z || I) && D !== null && B !== null) {
        const A = function(C, V, K, y, J, j, Y) {
          ...
          return T.setStart(...jo(V, K, y)), T.setEnd(...jo(J, j, Y)), T;
        }(t, g, f, D, h, E, B);
        d(), d = Rl(t, A, e);
      }
...
function Fl(t) {
  ...
  Yn(this), nt = t, this.f &= -2, 8 & this.f && no(this), aa();
}
function Qe(t, e) {
...
const io = 0, Pa = 1, ei = 2, ga = 3, Ar = 4, Ze = 5, fa = 6, mr = 7;
function ma(t) {
  return t.id === io;
}
function ri(t) {
...
function ql(t) {
  return function(e) {
    return e.id === Pa;
  }(t) || lt(305, String(t.id), String(Pa)), Object.assign(t, { id: ei });
}
...
const Wl = re({ config: Xe({ setOptions: Uo, updateOptions: Uo }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class ar {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ma(i) || lt(300, s, n || "[unknown]"), ma(c = i) || lt(304, String(c.id), String(io)), i = Object.assign(c, { id: Pa }), o.state = i;
...
const co = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
...
function Jo({
  ...
  const h = L(
    ...
    [t.user]
  ), k = O(() => Xa(t.contents), [t.contents]), N = O(
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (z) => {
                z.key === "Escape" ? (z.preventDefault(), z.stopPropagation(), h()) : wo(z) && (z.preventDefault(), z.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (z) => {
...
function mi({
  ...
  const [y, J] = _(Zo), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Vt] = _(!1), [q, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(D), [Ot, Pt] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            v !== !1 && (!Tt || ee(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  wo(S) && (S.preventDefault(), S.stopPropagation(), (ee(y) || j !== void 0 && j !== T) && Ut());
                },
                onKeyDown: (S) => {
                  lo(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Xr,
...
function Pd({
  ...
  const [s, c] = _("accept"), d = To(), l = To(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = O(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = O(
    () => Ur(t.acceptedText ?? ""),
...
function _p({
  ...
  }, [I, Y]), $ = O(() => T.length === 0 ? [] : _w(T, C, K), [T, C, K]), W = O(() => {
    var wt, at;
    if (!I) return d;
...
const Cw = "16rem", Ew = "3rem", xi = qt.createContext(void 0);
function na() {
  const t = qt.useContext(xi);
  if (!t)
    ...
    zw,
    {
      ...
      children: /* @__PURE__ */ u(Rw, { children: [
        /* @__PURE__ */ u(rn, { children: [
          ...
          /* @__PURE__ */ a(on, { children: /* @__PURE__ */ a(Dw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Ow, { children: /* @__PURE__ */ a(
            $w,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const ze = "scrBook", Aw = "scrRef", Ke = "source", Vw = "details", Pw = "Scripture Reference", jw = "Scripture Book", yi = "Type", Lw = "Details";
function Bw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, nn = (t) => `${Fw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Pp({
  sources: t,
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const K = x.find((y) => nn(y) === V[0]) || void 0;
        K && c(K);
      }
    }
  }, [h, x, c, E]);
  const k = n ?? jw, N = i ?? yi, D = [
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(qd, { children: D.map((C) => /* @__PURE__ */ a(ne, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function Lp({
  ...
  }, []), mo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }) : void 0;
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            children: /* @__PURE__ */ u(ia, { container: jt, children: [
              st.map(({ value: M, label: X, dropdownLabel: Kt, scrRefSuffix: fr, id: Mi }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Te(M),
      ...
      Na,
      {
        ...
        children: /* @__PURE__ */ u(ia, { container: _t, children: [
          ...
          /* @__PURE__ */ u(bo, { children: [
            ...
            /* @__PURE__ */ a(U, { onClick: go, children: W })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && pt && /* @__PURE__ */ a(_a, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Na,
      {
        ...
        children: /* @__PURE__ */ u(ia, { container: Et, children: [
          ...
          /* @__PURE__ */ u(bo, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Dr(!1), children: Z }),
            /* @__PURE__ */ a(U, { ref: Zt, onClick: go, children: W })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: We },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: d[Co(w)] }, `${w}`))
          }
        )
      ]
    }
...
function ja({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(_n, { children: [
      /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(Gt, { children: Ci(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(He, {})
    ] }, d)) })
  ] });
}
const Ei = qt.forwardRef(
...
const Ti = qt.forwardRef(({ className: t, ...e }, r) => {
  const o = pe();
  return /* @__PURE__ */ a(
    se.Root,
    {
...
const zi = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.List,
  {
    ref: r,
    className: m(
...
)), Si = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Content,
  {
    ref: r,
    className: m(
...
function Hp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ti, { children: [
      /* @__PURE__ */ a(zi, { children: t.map((c) => /* @__PURE__ */ a(Yw, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Ww, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Xw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: We },
          children: /* @__PURE__ */ a(Gt, { children: Ri(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(ye, { children: [
              /* @__PURE__ */ a(ke, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(_o, {}) }) }),
...
function Lh(t) {
  const e = O(() => Us(t).slice().sort().join(" "), [t]);
...
export {
  ...
  na as useSidebar,
  jh as useStylesheet,
  Bh as useTabIconSelection,
  hg as useTruncationTooltip,
