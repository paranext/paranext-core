...
import u, { forwardRef as $t, createContext as Hn, useContext as Un, useCallback as tt, useState as A, useRef as K, useEffect as wt, useLayoutEffect as Xe, useMemo as W, Fragment as qn } from "react";
...
import { useReactTable as Je, getFilteredRowModel as Tr, getSortedRowModel as Ke, getPaginationRowModel as _r, getCoreRowModel as We, flexRender as Bt, getGroupedRowModel as zr, getExpandedRowModel as Er } from "@tanstack/react-table";
...
const ye = D.Trigger, tn = D.Group, Or = D.Portal, Ar = D.Sub, Zo = D.RadioGroup;
...
const en = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = et();
  return /* @__PURE__ */ d(
    D.SubTrigger,
    {
...
const At = u.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = F();
...
const Ne = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = F(), s = et();
  return /* @__PURE__ */ r(
    D.Item,
    {
...
const ke = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = et();
  return /* @__PURE__ */ d(
    D.CheckboxItem,
    {
...
const rn = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ d(
    D.RadioItem,
    {
...
const Ut = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  D.Label,
  {
    ref: a,
...
const Te = X.allBookIds.filter((t) => !X.isObsolete(X.bookIdToNumber(t))), ta = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ge = ["OT", "NT", "DC"], ea = 96, na = [
  /^(\w+)$/i,
...
function ts({
  ...
  const o = F(), [s, w] = A(""), [i, c] = A(t.book), [p, m] = A(t.chapterNum ?? 0), [b, g] = A(t.book), [h, y] = A(!1), [z, k] = A(h), x = K(void 0), N = K(void 0), E = K(void 0), $ = tt(
    (C) => {
      const I = a ? a() : Te;
      return {
    ...
    (C, I, O, f) => {
      if (m(t.book !== C ? 1 : t.chapterNum), I || zt(C) === -1) {
        e({
          book: C,
          chapterNum: O ?? 1,
          verseNum: f ?? 1
    ...
    na.forEach((C) => {
      const I = C.exec(s);
      if (I) {
        const [O, f = void 0, T = void 0] = I.slice(1), Z = oa(O);
    ...
    (C) => {
      h ? (C.key === "ArrowDown" || C.key === "ArrowUp") && (E != null && E.current ? E.current.focus() : N.current && N.current.focus(), C.preventDefault()) : y(!0);
    },
    [h]
  ), te = (C) => {
    const { key: I } = C;
    ...
    if (b === i) {
      ...
      p + T <= 0 || p + T > zt(b) ? m(0) : T !== 0 && (m(p + T), C.preventDefault());
    }
  };
  return wt(() => {
    i === b ? i === t.book ? m(t.chapterNum) : m(1) : m(0);
  ...
  }, [z, s]), /* @__PURE__ */ d(Ht, { modal: !1, open: h, onOpenChange: ct, children: [
    /* @__PURE__ */ r(ye, { asChild: !0, children: /* @__PURE__ */ r(
      Vr,
      {
        ...
        handleKeyDown: P,
        handleOnClick: () => {
          c(t.book), g(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), y(!0), w(Mt(t, "English")), x.current.focus();
        },
        onFocus: () => {
          dt.current = !0;
        },
      ...
      At,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ge.map((C, I) => {
          ...
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Ut, { className: "tw-font-semibold tw-text-foreground/80", children: ta[C] }),
...
), G = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(qe.Root, { ref: n, className: l("pr-twp", ia(), t), ...e }));
G.displayName = qe.Root.displayName;
const cn = u.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    Dt.Root,
    {
...
const pn = Vt.Root, un = Vt.Trigger, _e = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = F();
...
const wa = rt.Portal, mn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Overlay,
  {
    ref: n,
    className: l(
...
const la = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = F();
...
const ze = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  H,
  {
    ref: n,
    className: l(
...
const Ee = u.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
...
const Me = u.forwardRef((t, e) => /* @__PURE__ */ r(H.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
      ...
      B,
      {
        ...
        children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: l("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: s ? i(s) : p })
          ] }),
...
function ns({
  ...
  const m = ae(p, "%webView_bookSelector_currentBook%"), b = ae(p, "%webView_bookSelector_choose%"), g = ae(p, "%webView_bookSelector_chooseBooks%"), [h, y] = A(
    "current book"
    /* CURRENT_BOOK */
  ), z = (k) => {
    y(k), t(k);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(G, { className: "tw-ms-1", children: m })
          ] }),
...
function ga({ table: t }) {
  return /* @__PURE__ */ d(Ht, { children: [
    /* @__PURE__ */ r(Wn, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const vt = j.Root, fa = j.Group, xt = j.Value, ba = lt(
...
), gt = u.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = F();
  return /* @__PURE__ */ d(
    j.Trigger,
    {
...
const ft = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = F();
...
va.displayName = j.Label.displayName;
const Q = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  j.Item,
  {
    ref: a,
    className: l(
...
xa.displayName = j.Separator.displayName;
function ya({ table: t }) {
...
const qt = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const Jt = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: l(
...
const Kt = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Ca({
  ...
  var k;
  const [i, c] = A([]), [p, m] = A([]), [b, g] = A({}), [h, y] = A({}), z = Je({
    data: e,
    columns: t,
    getCoreRowModel: We(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(ga, { table: z }),
    /* @__PURE__ */ d(qt, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Jt, { stickyHeader: s, children: z.getHeaderGroups().map((x) => /* @__PURE__ */ r(it, { children: x.headers.map((N) => /* @__PURE__ */ r(Pt, { children: N.isPlaceholder ? void 0 : Bt(N.column.columnDef.header, N.getContext()) }, N.id)) }, x.id)) }),
      /* @__PURE__ */ r(Kt, { children: (k = z.getRowModel().rows) != null && k.length ? z.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        it,
        {
          ...
          children: x.getVisibleCells().map((N) => /* @__PURE__ */ r(yt, { children: Bt(N.column.columnDef.cell, N.getContext()) }, N.id))
        },
        x.id
    ...
    n && a && /* @__PURE__ */ r(ya, { table: z })
  ] });
}
const jt = $t(({ className: t, ...e }, n) => /* @__PURE__ */ r(ar, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function is({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Ir, { options: o, children: e }) });
}
const Sa = $t((t, e) => /* @__PURE__ */ d(
  B,
  {
    ref: e,
...
function ws({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ht, { children: [
    /* @__PURE__ */ r(ye, { asChild: !0, children: /* @__PURE__ */ r(Sa, {}) }),
...
function Ta({ id: t, versionHistory: e }) {
  ...
  function s(i) {
    const c = new Date(i), p = new Date(o.getTime() - c.getTime()), m = p.getUTCFullYear() - 1970, b = p.getUTCMonth(), g = p.getUTCDate() - 1;
    let h = "";
    return m > 0 ? h = `${m.toString()} year${m === 1 ? "" : "s"} ago` : b > 0 ? h = `${b.toString()} month${b === 1 ? "" : "s"} ago` : g === 0 ? h = "today" : h = `${g.toString()} day${g === 1 ? "" : "s"} ago`, h;
  }
...
function za({
  ...
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ d(pn, { open: b, onOpenChange: g, children: [
    /* @__PURE__ */ r(un, { asChild: !0, children: /* @__PURE__ */ d(
      B,
      {
        variant: "ghost",
          ...
          return /* @__PURE__ */ d(
            Be,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: k.starred && /* @__PURE__ */ r(dr, { className: "tw-h-4 tw-w-4" }) }),
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((g) => {
      ...
      return /* @__PURE__ */ d(bn, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        ...
        (h = t.find((y) => y.value === g)) == null ? void 0 : h.label
      ] }, g);
...
), Ia = u.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Ze.Root,
  {
    ref: o,
...
const xn = u.createContext({
  size: "default",
  variant: "default"
}), yn = u.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const w = F();
  return /* @__PURE__ */ r(
    Yt.Root,
    {
...
const Ft = u.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const w = u.useContext(xn);
  return /* @__PURE__ */ r(
    Yt.Item,
    {
      ref: s,
...
const Wt = (t) => t === "asc" ? /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), us = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Ba = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", vs = Object.freeze([
...
function xs({
  ...
  const p = ot(n, "%webView_inventory_all%"), m = ot(n, "%webView_inventory_approved%"), b = ot(n, "%webView_inventory_unapproved%"), g = ot(n, "%webView_inventory_unknown%"), h = ot(n, "%webView_inventory_scope_currentBook%"), y = ot(n, "%webView_inventory_scope_chapter%"), z = ot(n, "%webView_inventory_filter_text%"), k = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, N] = A(!1), [E, $] = A("all"), [q, dt] = A(""), [ct, v] = A([]), R = W(() => t.length === 0 ? [] : Va(t, o, s), [t, o, s]), L = W(() => {
    if (x) return R;
    const f = [];
    return R.forEach((T) => {
        ...
        vt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(ft, { children: [
              /* @__PURE__ */ r(Q, { value: "all", children: p }),
...
const Ve = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Qe.Root,
  {
    ref: o,
    decorative: n,
...
const Pe = Ot.Provider, Oe = Ot.Root, Ae = Ot.Trigger, Zt = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Ot.Content,
  {
    ref: a,
    sideOffset: e,
...
const Pa = "16rem", Oa = "3rem", Nn = u.createContext(void 0);
function Qt() {
  const t = u.useContext(Nn);
  if (!t)
    throw new Error("useSidebar must be used within a SidebarProvider.");
  return t;
}
const kn = u.forwardRef(
  ({
    defaultOpen: t = !0,
    open: e,
    onOpenChange: n,
    ...
    const [p, m] = u.useState(t), b = e ?? p, g = u.useCallback(
      (E) => {
        const $ = typeof E == "function" ? E(b) : E;
        n ? n($) : m($);
      },
      [n, b]
    ), h = u.useCallback(() => g((E) => !E), [g]), y = b ? "expanded" : "collapsed", x = F() === "ltr" ? w : w === "primary" ? "secondary" : "primary", N = u.useMemo(
      () => ({
        state: y,
        open: b,
        setOpen: g,
...
const Cn = u.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const w = Qt();
...
const Aa = u.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Qt();
  return /* @__PURE__ */ d(
    B,
    {
...
const me = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Ct : "div",
  {
    ref: a,
...
const La = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Ct : "button",
  {
    ref: a,
...
const Ya = lt(
  ...
  ({
    ...
    const c = t ? Ct : "button", { state: p } = Qt(), m = /* @__PURE__ */ r(
      c,
      {
        ref: i,
        ...
        "data-size": a,
        "data-active": e,
        className: l(Ya({ variant: n, size: a }), s),
        ...w
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Ae, { asChild: !0, children: m }),
      /* @__PURE__ */ r(Zt, { side: "right", align: "center", hidden: p !== "collapsed", ...o })
    ] })) : m;
  }
);
zn.displayName = "SidebarMenuButton";
const Ha = u.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Ct : "button",
  {
    ref: o,
...
const qa = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
const Wa = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Ct : "a",
  {
    ref: s,
...
function Za({
  ...
  const p = tt(
    ...
    (g) => {
      const h = n.find((y) => y.projectId === g);
...
const st = "scrBook", Qa = "scrRef", mt = "source", to = "details", eo = "Scripture Reference", no = "Scripture Book", In = "Type", ro = "Details";
function ao(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, Le = (t) => `${oo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ns({
  sources: t,
  ...
  const [c, p] = A([]), [m, b] = A([{ id: st, desc: !1 }]), [g, h] = A({}), y = W(
    ...
    !e && /* @__PURE__ */ d(
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ft, { position: "item-aligned", children: /* @__PURE__ */ r(fa, { children: E.map((v) => /* @__PURE__ */ r(Q, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !v.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(ge, {}) : /* @__PURE__ */ r(xr, {})),
                          " ",
...
function Dn({
  ...
  return /* @__PURE__ */ d(Ht, { variant: s, children: [
    /* @__PURE__ */ r(ye, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(B, { variant: w, size: "icon", children: a ?? /* @__PURE__ */ r(yr, {}) }) }),
    /* @__PURE__ */ r(At, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, p]) => typeof c == "boolean" || typeof p == "boolean" ? 0 : c.order - p.order).map(([c], p, m) => /* @__PURE__ */ d(qn, { children: [
      /* @__PURE__ */ r(tn, { children: /* @__PURE__ */ r(Pe, { children: Bn(e.groups, e.items, c, t) }) }),
      p < m.length - 1 && /* @__PURE__ */ r(Xt, {})
    ] }, c)) })
  ] });
}
function Ye(t, e, n) {
  if (t !== "menuButton")
    return /* @__PURE__ */ r("div", { className: e, children: n });
}
function so(t, e, n, a) {
  if (t !== "menuButton")
    return /* @__PURE__ */ d("div", { className: "tw-flex tw-h-full tw-shrink tw-grow-[2] tw-flex-row-reverse tw-flex-wrap tw-items-start tw-gap-2 tw-overflow-clip tw-@container/tab-toolbar-end", children: [
      n && /* @__PURE__ */ r(
        Dn,
        {
          commandHandler: a,
...
function Ts({
  ...
  return /* @__PURE__ */ d(
    ...
    {
      className: l(
        `tw-sticky tw-top-0 tw-box-border tw-flex tw-h-14 tw-flex-row tw-items-center tw-justify-between tw-gap-2 tw-overflow-clip tw-px-4 tw-py-2 tw-text-foreground tw-@container/toolbar ${p === "menuButton" ? "tw-pointer-events-none" : "tw-w-full tw-border tw-bg-background"}`,
        s
      ),
      id: o,
      children: [
        n && /* @__PURE__ */ r(
          Dn,
          {
            ...
            menuData: n,
            tabLabel: "Project",
            icon: m ?? /* @__PURE__ */ r(Nr, {}),
            className: p === "menuButton" ? "tw-pointer-events-auto tw-shadow-lg" : "",
            buttonVariant: p === "menuButton" ? "outline" : "ghost"
          }
        ),
        Ye(
          p,
...
const Vn = u.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.Root,
    {
...
)), On = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Content,
  {
    ref: n,
    className: l(
...
function _s({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Vn, { children: [
      /* @__PURE__ */ r(Pn, { children: t.map((w) => /* @__PURE__ */ r(io, { value: w.value, children: w.value }, w.key)) }),
...
const An = u.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = u.useMemo(
    () => ({
      variant: e
    }),
...
const Xn = u.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    V.Trigger,
    {
...
const Fn = u.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    V.SubContent,
    {
...
const Gn = u.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const w = et();
...
const $n = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ r(
    V.Item,
    {
...
const po = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ d(
    V.RadioItem,
    {
...
const Et = (t, e) => {
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((p) => p.group === s).sort((p, m) => p.order - m.order).map((p) => /* @__PURE__ */ d(Oe, { children: [
      /* @__PURE__ */ r(Ae, { asChild: !0, children: "command" in p ? /* @__PURE__ */ d(
        $n,
        {
          onClick: () => {
            a(p);
          ...
          children: [
            p.iconPathBefore && /* @__PURE__ */ r(Gt, { icon: p.iconPathBefore, menuLabel: p.label, leading: !0 }),
            p.label,
            p.iconPathAfter && /* @__PURE__ */ r(Gt, { icon: p.iconPathAfter, menuLabel: p.label })
          ]
        },
        `menubar-item-${p.label}-${p.command}`
      ) : /* @__PURE__ */ d(lo, { children: [
        /* @__PURE__ */ r(jn, { children: p.label }),
      ...
      p.tooltip && /* @__PURE__ */ r(Zt, { children: p.tooltip })
    ] }, `tooltip-${p.label}-${"command" in p ? p.command : p.id}`)), c = [...i];
    return i.length > 0 && w < o.length - 1 && c.push(/* @__PURE__ */ r(Ln, {}, `separator-${s}`)), c;
  });
};
function mo({
  menuData: t,
  ...
  const o = K(void 0), s = K(void 0), w = K(void 0), i = K(void 0), c = K(void 0), p = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (Mr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, b) => {
    var y, z, k, x;
    m.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (y = s.current) == null || y.focus(), Et(s, [g, h]);
        break;
      case "alt+l":
        (z = w.current) == null || z.focus(), Et(w, [g, h]);
        break;
      case "alt+n":
        (k = i.current) == null || k.focus(), Et(i, [g, h]);
        break;
      case "alt+h":
        (x = c.current) == null || x.focus(), Et(c, [g, h]);
        break;
    }
  }), wt(() => {
    ...
    return /* @__PURE__ */ r(An, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, b]) => typeof m == "boolean" || typeof b == "boolean" ? 0 : m.order - b.order).map(([m, b]) => /* @__PURE__ */ d(wo, { children: [
      /* @__PURE__ */ r(Xn, { ref: p(m), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        Gn,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Pe, { children: Yn(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function Is({
  ...
  const c = ho(
    ...
    o && o(h), a && a([h, ...n.filter((y) => y !== h)]), s && n.find((y) => y === h) && s([...n.filter((y) => y !== h)]), m(!1);
  }, g = (h, y) => {
    var k, x, N, E, $, q;
    const z = y !== h ? ((x = (k = t[h]) == null ? void 0 : k.uiNames) == null ? void 0 : x[y]) ?? ((E = (N = t[h]) == null ? void 0 : N.uiNames) == null ? void 0 : E.en) : void 0;
    return z ? `${($ = t[h]) == null ? void 0 : $.autonym} (${z})` : (q = t[h]) == null ? void 0 : q.autonym;
  };
...
), bo = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(fo({ variant: e }), t), ...n }));
...
const xo = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
yo.displayName = St.Root.displayName;
...
No.displayName = St.Image.displayName;
...
ko.displayName = St.Fallback.displayName;
...
const To = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Eo = u.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ d(
    It.Root,
    {
...
Eo.displayName = It.Root.displayName;
const Io = u.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    de.Root,
    {
...
Io.displayName = de.Root.displayName;
const Vs = U.Root, Mo = u.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.List,
    {
...
Mo.displayName = U.List.displayName;
...
export {
  ...
  l as cn,
  bs as getBookIdFromUSFM,
  gs as getLinesFromUSFM,
  fs as getNumberFromUSFM,
  Ba as getStatusForItem,
