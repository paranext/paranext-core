...
import b, { forwardRef as wn, useRef as Z, useMemo as B, useState as M, useCallback as z, useLayoutEffect as Ht, createContext as On, useContext as Nr, useEffect as q, Component as ks, createElement as Kr, Suspense as _s, createRef as Cs, Fragment as No } from "react";
import { Command as vt } from "cmdk";
import { X as je, Search as ko, Check as Mt, Clock as Hr, ChevronsLeft as Xr, ChevronsRight as Yr, ChevronLeft as rr, ChevronRight as Ie, ArrowLeft as Es, ArrowRight as Ts, Circle as In, ChevronDown as _e, BoldIcon as Ss, ItalicIcon as Rs, UnderlineIcon as Ds, StrikethroughIcon as Ms, AtSign as _o, Pencil as Os, Trash2 as Is, ArrowUp as Co, MoreHorizontal as Eo, MailOpen as As, Mail as Ps, ChevronUp as or, FilterIcon as Vs, ArrowLeftIcon as $s, ChevronLeftIcon as Ls, ChevronRightIcon as Bs, ArrowRightIcon as js, Copy as To, Filter as zs, User as Fs, Link as Gs, CircleHelp as Us, ChevronsUpDown as So, Star as Ks, SquareX as Ro, FunctionSquare as Do, SquareSigma as Mo, AlertCircle as ar, CircleCheckIcon as Hs, CircleXIcon as Xs, CircleHelpIcon as Ys, ArrowUpIcon as qs, ArrowDownIcon as Js, ArrowUpDownIcon as Ws, PanelLeft as Zs, PanelRight as Qs, ScrollText as ti, MenuIcon as ei, Menu as ni, EllipsisVertical as ri, LoaderCircle as oi, GripVertical as ai } from "lucide-react";
...
import { useReactTable as Ko, getFilteredRowModel as rl, getSortedRowModel as Ho, getPaginationRowModel as ol, getCoreRowModel as Xo, flexRender as tn, getGroupedRowModel as al, getExpandedRowModel as sl } from "@tanstack/react-table";
...
var gl = Object.defineProperty, bl = (e, t, n) => t in e ? gl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, H = (e, t, n) => bl(e, typeof t != "symbol" ? t + "" : t, n);
const Ce = [
  "GEN",
  "EXO",
  "LEV",
...
H(Nt, "Original", new Nt(Vt.Original)), H(Nt, "Septuagint", new Nt(Vt.Septuagint)), H(Nt, "Vulgate", new Nt(Vt.Vulgate)), H(Nt, "English", new Nt(Vt.English)), H(Nt, "RussianProtestant", new Nt(Vt.RussianProtestant)), H(Nt, "RussianOrthodox", new Nt(Vt.RussianOrthodox));
let fe = Nt;
function eo(e, t) {
  const n = t[0];
...
const le = Ae.Root, ce = Ae.Trigger, Ep = Ae.Anchor, Zt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = pt();
  ...
  return /* @__PURE__ */ d(le, { open: w, onOpenChange: c, children: [
    /* @__PURE__ */ o(ce, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ o(Hr, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ o(Zt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(Jt, { children: /* @__PURE__ */ o(Wt, { children: /* @__PURE__ */ o(Yt, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      Bt,
      {
        ...
        children: [
          /* @__PURE__ */ o(Hr, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function Sp({
  ...
  const c = pt(), [p, m] = M(!1), [f, u] = M(""), [g, x] = M(""), [v, N] = M("books"), [k, T] = M(void 0), [V, $] = M(!1), P = Z(void 0), y = Z(void 0), C = Z(void 0), _ = Z(void 0), S = Z({}), E = z(
    ...
    (O) => {
      if (O.ctrlKey) return;
      const { isLetter: K, isDigit: st } = no(O.key);
      if (v === "chapters") {
        if (O.key === "Backspace") {
    ...
    const { isLetter: K, isDigit: st } = no(O.key);
    (K || st) && (O.preventDefault(), x((lt) => lt + O.key), y.current.focus(), $(!1));
  }, []);
  return Ht(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && C.current && _.current) {
        const K = C.current, st = _.current, lt = st.offsetTop, nt = K.clientHeight, Ft = st.clientHeight, Et = lt - nt / 2 + Ft / 2;
        K.scrollTo({
          top: Math.max(0, Et),
          behavior: "smooth"
        }), u(pr(e.book));
      ...
      Jt,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ut.map(({ onClick: O, disabled: K, title: st, icon: lt }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
          ...
          !V && /* @__PURE__ */ d(Wt, { ref: C, children: [
            v === "books" && /* @__PURE__ */ d(wt, { children: [
              !D && Object.entries(G).map(([O, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Yt, { heading: hn(O), children: K.map((st) => /* @__PURE__ */ o(
                      la,
                      {
                        bookId: st,
                        onSelect: (lt) => ct(lt),
...
function Mp({
  ...
  const p = Hn(c, "%webView_bookSelector_currentBook%"), m = Hn(c, "%webView_bookSelector_choose%"), f = Hn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), e(v);
...
function Xl({ children: e, onError: t }) {
  return o(Kl, { fallback: o("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
...
function Uc(e, t) {
  const n = Hi(t) ? t.body.childNodes : t.childNodes;
  let r = [];
  const a = [];
...
function Ma(e, t, n, r = null) {
  ...
  if (a && !s) {
    if ((Ki(p) || Wr(p)) && p.append(f), n.append(p), m) {
      const u = m.call(i, p);
...
function Ia(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (f = p(f)), Zr(e) && (f = Hc(e, f, u ? () => {
    const g = new jo();
    return n.push(g), g;
...
}), Ke = rt.Trigger, Ba = rt.Group, ow = rt.Portal, aw = rt.Sub, sw = rt.RadioGroup;
    ...
    "div",
    {
      ...
      children: [
        ...
        P && /* @__PURE__ */ d(Se, { children: [
          /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(Eo, {}) }) }),
...
function yw({
  ...
  var P;
  const [p, m] = M([]), [f, u] = M([]), [g, x] = M({}), [v, N] = M({}), k = B(() => t ?? [], [t]), T = Ko({
    data: k,
    columns: e,
    getCoreRowModel: Xo(),
        ...
        /* @__PURE__ */ o(Yt, { children: $.map((S) => /* @__PURE__ */ d(
          Bt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Ks, { className: "tw-h-4 tw-w-4" }),
...
function Sw({
  ...
  return /* @__PURE__ */ d(Se, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o(St, { children: /* @__PURE__ */ d(Lt, { children: [
      /* @__PURE__ */ o(Ut, { asChild: !0, children: /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: Tw(e, a, n) }) }) }),
...
function Mw({
  ...
  return /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ o(St, { children: /* @__PURE__ */ d(Lt, { children: [
      /* @__PURE__ */ o(qi, { asChild: !0, children: /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: Rw(e, n) }) }) }),
...
function Gp({
  ...
  q(() => {
    ...
    if (C && vn("note", C)) {
      const A = (_ = C.insert.note) == null ? void 0 : _.caller;
      let U = "custom";
      A === ir ? U = "generated" : A === lr ? U = "hidden" : A && u(A), m(U), x(((S = C.insert.note) == null ? void 0 : S.style) ?? "f"), (E = w.current) == null || E.setUsj({
        type: "USJ",
        version: "3.1",
        content: [
          {
        ...
        var I;
        (I = w.current) == null || I.applyUpdate([C]);
      }, 0);
    }
    return () => {
      y && clearTimeout(y);
...
const zn = (e) => e === "asc" ? /* @__PURE__ */ o(qs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ws, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Hp = (e) => ({
  accessorKey: "item",
...
const Gw = "16rem", Uw = "3rem", Ha = b.createContext(void 0);
function Fn() {
...
const Xa = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ o(Ha.Provider, { value: k, children: /* @__PURE__ */ o(St, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
function yr({
  ...
  return /* @__PURE__ */ d(Se, { variant: s, children: [
    /* @__PURE__ */ o(Ke, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(L, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(ei, {}) }) }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(Se, { children: [
              /* @__PURE__ */ o(Ke, { className: h(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(Eo, {}) }) }),
...
const Cu = Ot.Trigger, Bd = Ot.Portal, Eu = Ot.Close, gs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ot.Overlay,
  {
    ref: n,
...
Hd.displayName = Ze.Root.displayName;
...
const Mu = xt.Root, Yd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = pt();
  return /* @__PURE__ */ o(
    xt.List,
    {
...
Yd.displayName = xt.List.displayName;
...
qd.displayName = xt.Trigger.displayName;
