...
var kt = (t, e, n) => ps(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as d, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as sn, useRef as U, useMemo as z, useState as R, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as q, Component as us, createElement as Lr, Suspense as ms, Fragment as uo } from "react";
import { Command as Tt } from "cmdk";
import { X as je, Search as mo, Check as zt, Clock as Vr, ChevronsLeft as jr, ChevronsRight as zr, ChevronLeft as Jn, ChevronRight as Oe, ArrowLeft as fs, ArrowRight as hs, Circle as Tn, ChevronDown as ze, BoldIcon as gs, ItalicIcon as bs, AtSign as fo, Pencil as vs, Trash2 as xs, ArrowUp as ho, MoreHorizontal as go, MailOpen as ys, Mail as Ns, ChevronUp as bo, FilterIcon as ks, ArrowLeftIcon as _s, ChevronLeftIcon as Cs, ChevronRightIcon as Es, ArrowRightIcon as Ts, Copy as vo, Filter as Rs, User as Ss, Link as Ds, CircleHelp as Ms, ChevronsUpDown as xo, Star as Os, Undo as Is, Redo as As, SquareX as yo, FunctionSquare as No, SquareSigma as ko, Ban as Ps, AlertCircle as Zn, CircleCheckIcon as $s, CircleXIcon as Ls, CircleHelpIcon as Vs, ArrowUpIcon as js, ArrowDownIcon as zs, PanelLeft as Fs, PanelRight as Bs, ScrollText as Ks, MenuIcon as Gs, Menu as Us, EllipsisVertical as qs, LoaderCircle as Hs, GripVertical as Ys } from "lucide-react";
...
import { includes as dn, Section as X, getChaptersForBook as Js, formatScrRef as xe, getSectionForBook as Je, formatRelativeDate as Zs, formatReplacementString as ve, sanitizeHtml as Qs, NumberFormat as ti, formatBytes as ei, getCurrentLocale as ni, usfmMarkers as hn, getFormatCallerFunction as ri, deepEqual as oi, isString as Fr, compareScrRefs as Qn, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import { createEditor as Co, $getRoot as ce, $createParagraphNode as Rn, $getSelection as jt, HISTORY_MERGE_TAG as br, ParagraphNode as Eo, TextNode as To, $isTokenOrSegmented as ai, $getCharacterOffsets as si, $cloneWithPropertiesEphemeral as ii, $findMatchingParent as Ro, $isElementNode as le, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as So, COMMAND_PRIORITY_EDITOR as Do, mergeRegister as de, shallowMergeConfig as li, defineExtension as Ut, safeCast as ln, createState as wi, FORMAT_TEXT_COMMAND as Mo, $isNodeSelection as Oo, COMMAND_PRIORITY_LOW as Io, RootNode as ci, LineBreakNode as di, TabNode as pi, $isEditorState as ui, createCommand as mi, CLICK_COMMAND as fi, isDOMNode as hi, $getNodeFromDOMNode as gi, $createNodeSelection as bi, $setSelection as vi, DecoratorNode as tr, $getState as xi, toggleTextFormatType as Br, TEXT_TYPE_TO_FORMAT as yi, $setState as Ni, addClassNamesToElement as Ao, $create as ki, $getNodeByKey as _i, removeClassNamesFromElement as Ci, KEY_TAB_COMMAND as Ei, $isBlockElementNode as vn, $createRangeSelection as Ti, $normalizeSelection__EXPERIMENTAL as Ri, OUTDENT_CONTENT_COMMAND as Si, INDENT_CONTENT_COMMAND as Kr, INSERT_TAB_COMMAND as Di, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Mi, $isParagraphNode as Oi, $isTextNode as xn, SELECTION_CHANGE_COMMAND as Po, getRegisteredNode as Ii, isHTMLElement as Ai, isDocumentFragment as Gr, isDOMDocumentNode as Pi, ArtificialNode__DO_NOT_USE as $o, $createLineBreakNode as Lo, $isRootOrShadowRoot as $i, isBlockDomNode as Ur, isInlineDomNode as qr, $insertNodes as Li } from "lexical";
...
import { useReactTable as Fo, getFilteredRowModel as qi, getSortedRowModel as Bo, getPaginationRowModel as Hi, getCoreRowModel as Ko, flexRender as Ze, getGroupedRowModel as Yi, getExpandedRowModel as Xi } from "@tanstack/react-table";
import * as wt from "@radix-ui/react-select";
import Wi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as er, HIDDEN_NOTE_CALLER as nr, getDefaultViewOptions as Ji, isInsertEmbedOpOfType as pn, Editorial as Zi } from "@eten-tech-foundation/platform-editor";
...
const rl = Vt.Root, ol = Vt.Portal, Go = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vt.Overlay,
  {
    ref: n,
    className: f(
...
Go.displayName = Vt.Overlay.displayName;
...
Uo.displayName = Vt.Content.displayName;
...
Ho.displayName = Vt.Title.displayName;
...
al.displayName = Vt.Description.displayName;
...
ee.displayName = Tt.List.displayName;
...
Yo.displayName = Tt.Separator.displayName;
const qt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Tt.Item,
  {
    ref: n,
...
const Zo = sn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Fe : "button", { className: f(Qo({ variant: e, size: n, className: t })), ref: i, ...a })
);
F.displayName = "Button";
const ne = Ie.Root, me = Ie.Trigger, il = Ie.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = vt();
...
function Yr({
  ...
  if (t)
    return /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Gt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      qt,
      {
        value: `${t} ${ye[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function pp({
  ...
  const c = vt(), [p, u] = R(!1), [h, m] = R(""), [g, x] = R(""), [v, y] = R("books"), [N, k] = R(void 0), [_, B] = R(!1), L = U(void 0), S = U(void 0), P = U(void 0), E = U(void 0), M = U({}), V = K(
    (O) => {
      e(O), l && l(O);
    },
    [e, l]
  ), j = z(() => o ? o() : Jo, [o]), D = z(() => ({
    [X.OT]: j.filter((H) => ct.isBookOT(H)),
    [X.NT]: j.filter((H) => ct.isBookNT(H)),
    [X.DC]: j.filter((H) => ct.isBookDC(H)),
    [X.Extra]: j.filter((H) => ct.extraBooks().includes(H))
    ...
    return [X.OT, X.NT, X.DC, X.Extra].forEach((C) => {
      O[C] = D[C].filter(($) => Nr($, g, a));
    }), O;
  }, [D, g, a]), I = z(
    () => cl(g, A, a),
    [g, A, a]
    ...
    (O) => {
      const H = v === "chapters" ? N : I == null ? void 0 : I.book;
      H && (V({
        book: H,
        chapterNum: O,
        verseNum: 1
    ...
    (O) => {
      ...
      u(O), O && (y("books"), k(void 0), x(""));
    },
    [v, dt]
  ), { otLong: it, ntLong: pt, dcLong: nt, extraLong: yt } = {
    ...
    (O) => {
      if (O.ctrlKey) return;
      const { isLetter: H, isDigit: C } = Hr(O.key);
      if (v === "chapters") {
        if (O.key === "Backspace") {
          O.preventDefault(), O.stopPropagation(), dt();
          return;
        }
        if (H || C) {
          if (O.preventDefault(), O.stopPropagation(), y("books"), k(void 0), C && N) {
            const $ = ye[N];
            x(`${$} ${O.key}`);
          } else
            x(O.key);
      ...
      if ((v === "chapters" || v === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        const $ = v === "chapters" ? N : I == null ? void 0 : I.book;
        if (!$) return;
        const Y = (() => {
          if (!h) return 1;
          const ut = h.match(/(\d+)$/);
        ...
        switch (O.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            et = Y === 0 ? Z : Math.max(1, Y - xt);
            break;
          case "ArrowDown":
            et = Y === 0 ? 1 : Math.min(Z, Y + xt);
            break;
          default:
            return;
        }
        et !== Y && (O.preventDefault(), O.stopPropagation(), m(sr($, a, et)), setTimeout(() => {
          const ut = M.current[et];
    ...
    const { isLetter: H, isDigit: C } = Hr(O.key);
    (H || C) && (O.preventDefault(), x(($) => $ + O.key), S.current.focus(), B(!1));
  }, []);
  return At(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && P.current && E.current) {
        const H = P.current, C = E.current, $ = C.offsetTop, Y = H.clientHeight, Z = C.clientHeight, et = $ - Y / 2 + Z / 2;
        H.scrollTo({
          top: Math.max(0, et),
          behavior: "smooth"
        }), m(sr(t.book));
    ...
    if (v === "chapters" && N) {
      ...
      setTimeout(() => {
        if (P.current)
          if (O) {
            const H = M.current[t.chapterNum];
  ...
  }, [v, N, I, t.book, t.chapterNum]), /* @__PURE__ */ d(ne, { open: p, onOpenChange: G, children: [
    /* @__PURE__ */ r(me, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
      ...
      te,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: mt.map(({ onClick: O, disabled: H, title: C, icon: $ }) => /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
                size: "sm",
          ...
          !_ && /* @__PURE__ */ d(ee, { ref: P, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !I && Object.entries(W).map(([O, H]) => {
                if (H.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Qt, { heading: oe(O), children: H.map((C) => /* @__PURE__ */ r(
                      Zo,
                      {
                        bookId: C,
                        onSelect: ($) => St($),
...
), bt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(_o.Root, { ref: n, className: f("pr-twp", pl(), t), ...e }));
bt.displayName = _o.Root.displayName;
...
function ir({
  ...
  const [N, k] = R(!1), _ = w ?? l, B = (S) => S.length > 0 && typeof S[0] == "object" && "options" in S[0], L = (S, P) => {
    const E = l(S), M = typeof S == "object" && "secondaryLabel" in S ? S.secondaryLabel : void 0, V = `${P ?? ""}${E}${M ?? ""}`;
    return /* @__PURE__ */ d(
      qt,
      {
        value: E,
        ...
        children: [
          ...
          /* @__PURE__ */ d("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: [
            E,
            M && /* @__PURE__ */ d("span", { className: "tw-text-muted-foreground", children: [
              " · ",
              M
            ] })
          ] })
  ...
  return /* @__PURE__ */ d(ne, { open: N, onOpenChange: k, ...y, children: [
    /* @__PURE__ */ r(me, { asChild: !0, children: /* @__PURE__ */ d(
      F,
      {
        variant: m,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          ...
          /* @__PURE__ */ r(wn, { children: h }),
          /* @__PURE__ */ r(ee, { children: B(e) ? e.map((S) => /* @__PURE__ */ r(Qt, { heading: S.groupHeading, children: S.options.map((P) => L(P, S.groupHeading)) }, S.groupHeading)) : e.map((S) => L(S)) })
        ] })
      }
    )
  ] });
...
function fp({
  ...
  const p = jn(c, "%webView_bookSelector_currentBook%"), u = jn(c, "%webView_bookSelector_choose%"), h = jn(c, "%webView_bookSelector_chooseBooks%"), [m, g] = R(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(bt, { className: "tw-ms-1", children: p })
          ] }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(bt, { className: "tw-ms-1", children: h })
          ] }),
          /* @__PURE__ */ r(bt, { className: "tw-flex tw-items-center", children: o.map((v) => ct.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            F,
            {
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, hl = ea ? At : q, un = { tag: br };
...
const bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : q;
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : q;
function Cl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function El() {
  return function(t) {
    const [e] = Yt(), n = z(() => t(e), [e, t]), [o, a] = R(() => n.initialValueFn()), i = U(o);
    return _l(() => {
...
function Pl(t) {
  ...
  oa(this), Q = t, this.f &= -2, 8 & this.f && Er(this), Dn();
}
function De(t, e) {
...
_t.prototype.brand = Ol, _t.prototype.h = function() {
  return !0;
  ...
  if (this.g = gn, this.f |= 1, this.i > 0 && !ra(this)) return this.f &= -2, !0;
  const t = Q;
  try {
    Jr(this), Q = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, aa(this), Jr(this), we++;
  const t = Q;
...
function sa() {
  const t = ce(), e = jt(), n = Rn();
  t.clear(), t.append(n), e !== null && n.select(), ke(e) && (e.format = 0);
}
function ia(t, e = sa) {
  return t.registerCommand(So, (n) => (t.update(e), !0), Do);
}
Ut({ build: (t, e, n) => Mn(e), config: ln({ $onClear: sa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const Fn = wi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class la extends tr {
  $config() {
...
Ut({ name: "@lexical/extension/DecoratorText", nodes: () => [la], register: (t, e, n) => t.registerCommand(Mo, (o) => {
  const a = jt();
  if (Oo(a) || ke(a)) for (const i of a.getNodes()) Ll(i) && i.toggleFormat(o);
  return !1;
}, Io) });
function wa(t, e) {
  let n;
...
const cr = Ut({ build: (t) => wa(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Tr = 0, dr = 1, da = 2, Bn = 3, mn = 4, Se = 5, Kn = 6, Ye = 7;
function Gn(t) {
  return t.id === Tr;
}
function pa(t) {
...
function Vl(t) {
  return function(e) {
    return e.id === dr;
  }(t) || rt(305, String(t.id), String(dr)), Object.assign(t, { id: da });
}
...
class zl {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== mn && rt(307, String(n.id), String(Se)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  register(e, n) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== Ye && rt(309, String(o.id), String(Ye)), this.state = function(s) {
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Kn && rt(310, String(n.id), String(Kn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= mn;
    }(e) || rt(313, String(e.id), String(mn)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Bn;
    }(e) || rt(314, String(e.id), String(Bn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
...
const Bl = Ut({ config: ln({ setOptions: Zr, updateOptions: Zr }), init: ({ $initialEditorState: t = Fl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class tn {
  ...
  static maybeFromEditor(e) {
    const n = e[Qr];
    return n && (n.PACKAGE_VERSION !== Un && rt(292, n.PACKAGE_VERSION, Un), n instanceof tn || rt(293)), n;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Gn(i) || rt(300, s, a || "[unknown]"), Gn(l = i) || rt(304, String(l.id), String(Tr)), i = Object.assign(l, { id: dr }), o.state = i;
    ...
    for (const p of l) {
      ...
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const h of $l(u)) {
        if (typeof h != "function") {
          ...
          m && rt(302, u.name, h.replace.name, m.extension.name), o.set(h.replace, p);
        }
        n.add(h);
      }
      if (u.html) {
...
const Gl = /* @__PURE__ */ new Set(), eo = Ut({ build(t, e, n) {
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = wa(() => {
  }, () => pe(() => {
...
Ut({ dependencies: [cr, eo], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(eo).output, a = rn({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return de(t.registerCommand(fi, (s) => {
    if (hi(s.target)) {
      const l = gi(s.target);
      if (ql(l)) return function(w, c = !1) {
        const p = jt(), u = w.isSelected(), h = w.getKey();
        let m;
    ...
    Il(() => {
      ...
      for (const [p, u] of s.entries()) if (u === "destroyed") c.delete(p), w = !0;
        ...
        h ? h.domNode.value = m : (w = !0, c.set(p, { domNode: rn(m), selectedSignal: o(p) }));
      }
...
function Hl(t, e, n = ma) {
  return de(t.registerCommand(Ei, (o) => {
    const a = jt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const i = function(s) {
...
Ut({ build: (t, e, n) => Mn(e), config: ln({ $canIndent: ma, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (xn(v) && c >= 0 && p >= 0 && (y = c, N = c + p, g.setTextNodeRange(v, y, v, N)), y === N && u === "" || (g.insertRawText(u), v = x.getNode()), xn(v)) {
                  y = h, N = h + m;
...
Ut({ build: (t, e, n) => Mn(e), config: ln({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : ha(t)) });
function Zl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Rr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : q;
...
function Na(t, e, n, o = null) {
  ...
  let s = e;
  o !== null && xn(e) && (s = Tl(o, e, "clone"));
  const l = le(s) ? s.getChildren() : [], w = Ii(t, s.getType());
  let c;
...
function hp({
  ...
  const [a, i] = R(Cw), [s, l] = R(void 0), [w, c] = R(!1), p = U(void 0), u = U(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
...
const gp = Object.freeze([
  ...
  const a = U(null), [i, s] = R(void 0), [l, w] = R(void 0), c = K(
    (m) => {
      s(m);
    ...
    (m) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && u(g)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          if (E === -1) return;
          let M;
          m.key === "ArrowDown" ? M = Math.min(E + 1, P.length - 1) : M = Math.max(E - 1, 0), M !== E && (m.preventDefault(), m.stopPropagation(), (S = P[M]) == null || S.focus());
          return;
        }
        return;
      }
      ...
      switch (m.key) {
        case "ArrowDown":
          B = Math.min(_ + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          B = Math.max(_ - 1, 0), m.preventDefault();
          break;
        case "Home":
...
}), Ge = ot.Trigger, Ma = ot.Group, Pw = ot.Portal, $w = ot.Sub, Lw = ot.RadioGroup;
function Te({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Or.Provider, { value: n, children: /* @__PURE__ */ r(ot.Root, { ...e }) });
}
...
Ia.displayName = ot.SubContent.displayName;
const fe = b.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const i = vt();
...
fe.displayName = ot.Content.displayName;
...
_n.displayName = ot.Item.displayName;
...
const Aa = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    ot.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(Tn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Aa.displayName = ot.RadioItem.displayName;
...
cn.displayName = ot.Label.displayName;
    ...
    if (o && l)
      return /* @__PURE__ */ d(lt, { children: [
        /* @__PURE__ */ d(
          ...
          {
            onClick: (_) => {
              _.stopPropagation(), c(!0), u(_w(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), m()) : Mr(_) && (_.preventDefault(), _.stopPropagation(), Lt(p) && g());
              },
              onKeyDown: (_) => {
                Dr(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
        ...
        k && /* @__PURE__ */ d(Te, { children: [
          /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(go, {}) }) }),
          /* @__PURE__ */ r(fe, { align: "end", children: k })
        ] })
      ]
    }
  );
...
function jw({
  ...
  const [S, P] = R(so), [E, M] = R(
    void 0
  ), V = o, [j, D] = R(!1), [A, W] = R(!1), [I, J] = R(!1), [St, Pt] = R(!1), [$t, mt] = R(!1), [dt, G] = R(_), [it, pt] = R(!1), nt = U(void 0), [yt, oe] = R(/* @__PURE__ */ new Map());
  q(() => {
    let T = !0;
    return (async () => {
      const gt = N ? await N(w) : !1;
      T && mt(gt);
    })(), () => {
      T = !1;
    };
    ...
    let T = !0;
    if (!o) {
      Pt(!1), oe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const gt = y ? await y(w) : !1;
      T && Pt(gt);
    })(), () => {
      T = !1;
    };
  }, [o, w, y]);
  const Ot = z(() => e.filter((T) => !T.deleted), [e]);
  q(() => {
    let T = !0;
    if (!o || !k) {
      oe(/* @__PURE__ */ new Map());
  ...
  const Xt = z(() => Ot[0], [Ot]), Re = U(null), ae = U(void 0), Wt = K(() => {
    var T;
    (T = ae.current) == null || T.call(ae), P(so);
  }, []), He = K(() => {
    const T = !dt;
    G(T), pt(!T), g == null || g(w, T);
  }, [dt, g, w]);
  q(() => {
    D(!1);
  }, [o]), q(() => {
    if (o && !dt && !it) {
      ...
      return nt.current = T, () => clearTimeout(T);
    }
  ...
  }, [i, n]), C = z(() => Ot.slice(1), [Ot]), $ = z(() => C.length ?? 0, [C.length]), Y = z(() => $ > 0, [$]), Z = z(() => j || $ <= 2 ? C : C.slice(-2), [C, $, j]), et = z(() => j || $ <= 2 ? 0 : $ - 2, [$, j]), xt = z(
    () => $ === 1 ? O.singleReply : ve(O.multipleReplies, { count: $ }),
    [$, O]
  ), ut = z(
    () => et === 1 ? O.singleReply : ve(O.multipleReplies, { count: et }),
    [et, O]
  );
  q(() => {
    !o && A && Y && W(!1);
  ...
  const Nt = K(
    async (T) => {
      ...
      ht && await u({ threadId: w, contents: ht }) && Wt();
    },
    [
      Wt,
      S,
    ...
    async (T) => {
      const ht = Lt(S) ? kn(S) : void 0, gt = await u({
        ...T,
        contents: ht,
        assignedUser: E ?? T.assignedUser
      });
      return gt && ht && Wt(), gt && E !== void 0 && M(void 0), gt;
    },
    [Wt, S, u, E]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ d(Ra, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            H && /* @__PURE__ */ r(Pe, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: H }),
            /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
          ...
          /* @__PURE__ */ r(
            ao,
            {
              ...
              handleDeleteComment: m,
              onEditingChange: W,
              canEditOrDelete: (!A && yt.get(Xt.id)) ?? !1,
              canUserResolveThread: $t
            }
          )
        ] }),
        /* @__PURE__ */ d(lt, { children: [
          Y && !o && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
            ...
            et > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r($e, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: ut }),
                    j ? /* @__PURE__ */ r(bo, {}) : /* @__PURE__ */ r(ze, {})
                  ] })
                ]
              }
            ),
            Z.map((T) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              ao,
              {
                comment: T,
                localizedStrings: n,
                ...
                handleDeleteComment: m,
                onEditingChange: W,
                canEditOrDelete: (!A && yt.get(T.id)) ?? !1
              }
            ) }, T.id)),
            v !== !1 && (!A || Lt(S)) && /* @__PURE__ */ d(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (T) => {
                  Mr(T) && (T.preventDefault(), T.stopPropagation(), (Lt(S) || E !== void 0) && Nt());
                },
                onKeyDown: (T) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ d(ne, { open: I, onOpenChange: J, children: [
                      /* @__PURE__ */ r(me, { asChild: !0, children: /* @__PURE__ */ r(
                        F,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ r(
                        Ht,
                        {
                          ...
                          children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: x == null ? void 0 : x.map((T) => /* @__PURE__ */ r(
                            qt,
                            {
                              onSelect: () => {
                                M(T !== i ? T : void 0), J(!1);
...
function vp({
  ...
  const [y, N] = R(/* @__PURE__ */ new Set()), [k, _] = R();
  q(() => {
    g && (N((D) => new Set(D).add(g)), _(g));
  }, [g]);
  const B = n.filter(
    ...
    (D) => {
      N((A) => new Set(A).add(D.id)), _(D.id), x == null || x(D.id);
    },
    [x]
  ), P = K(
    (D) => {
      ...
      }), _(D), x == null || x(A ? void 0 : D);
    },
    [y, x]
  ), { listboxRef: E, activeId: M, handleKeyDown: V } = Rw({
    options: L,
    onOptionSelect: S
  }), j = K(
    (D) => {
      D.key === "Escape" ? (k && y.has(k) && (N((A) => {
        const W = new Set(A);
        return W.delete(k), W;
      }), _(void 0), x == null || x(void 0)), D.preventDefault(), D.stopPropagation()) : V(D);
    },
    [k, y, V, x]
  );
  return /* @__PURE__ */ r(
...
const Le = wt.Root, Fw = wt.Group, Ve = wt.Value, Bw = ue(
...
const It = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  wt.Item,
  {
    ref: o,
    className: f(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(wt.ItemIndicator, { children: /* @__PURE__ */ r(zt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(wt.ItemText, { children: e })
    ]
  }
));
It.displayName = wt.Item.displayName;
      ...
      /* @__PURE__ */ d(
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Ee, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(It, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        on(s, '[tabindex]:not([tabindex="-1"])').forEach((p) => {
...
function Zw({
  ...
  let B;
  return w ? B = Array.from({ length: 10 }).map((E, M) => `skeleton-row-${M}`).map((E) => /* @__PURE__ */ r(Jt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((L = k.getRowModel().rows) == null ? void 0 : L.length) > 0 ? B = k.getRowModel().rows.map((S) => /* @__PURE__ */ r(
    Jt,
    {
      onClick: () => s(S, k),
      "data-state": S.getIsSelected() && "selected",
      children: S.getVisibleCells().map((P) => /* @__PURE__ */ r(Ne, { children: Ze(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    S.id
    ...
    /* @__PURE__ */ d(On, { stickyHeader: i, children: [
      /* @__PURE__ */ r(In, { stickyHeader: i, children: k.getHeaderGroups().map((S) => /* @__PURE__ */ r(Jt, { children: S.headers.map((P) => /* @__PURE__ */ r(an, { className: "tw-p-0", children: P.isPlaceholder ? void 0 : Ze(P.column.columnDef.header, P.getContext()) }, P.id)) }, S.id)) }),
...
function kp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Te, { children: [
    ...
    /* @__PURE__ */ r(fe, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
...
function rc({
  ...
  const [y, N] = R(!1), k = K(
    (M) => {
      var j;
      const V = (j = t.find((D) => D.label === M)) == null ? void 0 : j.value;
      V && n(
    ...
    if (!h) return t;
    const M = t.filter((j) => j.starred).sort((j, D) => j.label.localeCompare(D.label)), V = t.filter((j) => !j.starred).sort((j, D) => {
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(ne, { open: P, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(me, { asChild: !0, children: /* @__PURE__ */ d(
      F,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
      ...
      /* @__PURE__ */ d(ee, { children: [
        ...
        /* @__PURE__ */ r(Qt, { children: B.map((M) => /* @__PURE__ */ d(
          qt,
          {
            value: M.label,
            onSelect: k,
            ...
            children: [
              ...
              M.starred && /* @__PURE__ */ r(Os, { className: "tw-h-4 tw-w-4" }),
...
function lc({
  ...
  const i = U(null), s = U(null), l = U(!1), [w, c] = R(t), [p, u] = R(n), [h, m] = R(!1);
  q(() => {
    c(t);
  }, [t]), q(() => {
    p !== n && u(n);
  ...
  const g = (v) => {
    ...
    var y, N, k, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = i.current) == null || y.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), l.current = !1), w === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
...
function dc({
  ...
  return /* @__PURE__ */ d(Te, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
      /* @__PURE__ */ r(Vi, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: wc(t, n) }) }) }),
      /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: cc(t, n) }) })
    ] }) }),
    /* @__PURE__ */ d(fe, { className: "tw-z-[300]", children: [
...
function Tp({
  ...
  const u = U(null), h = U(null), m = U(null), g = U(null);
  At(() => {
    if (!g.current) return;
    const { width: C } = g.current.getBoundingClientRect();
    C > 0 && (g.current.style.width = `${C}px`);
  }, []);
  const [x, v] = R("generated"), [y, N] = R("*"), [k, _] = R("f"), [B, L] = R(!1), [S, P] = R(!0), [E, M] = R(!1), V = U(!1), j = U(""), [D, A] = R(!1), [W, I] = R(), [J, St] = R(), [Pt, $t] = R(), [mt, dt] = R(), G = U(null), it = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  q(() => {
    ...
    if ($ && pn("note", $)) {
      const et = (Y = $.insert.note) == null ? void 0 : Y.caller;
      let xt = "custom";
      et === er ? xt = "generated" : et === nr ? xt = "hidden" : et && N(et), v(xt), _(((Z = $.insert.note) == null ? void 0 : Z.style) ?? "f"), C = setTimeout(() => {
        var ut;
        (ut = u.current) == null || ut.applyUpdate([$]);
      }, 0);
    }
    return () => {
      C && clearTimeout(C);
  ...
  const nt = K(
    (C, $, Y = !1) => {
      var et, xt, ut;
      const Z = (xt = (et = u.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : xt.at(0);
      if (Z && pn("note", Z)) {
        if (Z.insert.note) {
          let ft;
          C === "custom" ? ft = $ : C === "generated" ? ft = er : ft = nr, Z.insert.note.caller = ft;
        }
        n == null || n([Z]);
        const Nt = (p == null ? void 0 : p.current) ?? i;
        Y && c && Nt && ((ut = c.current) == null || ut.replaceEmbedUpdate(Nt, [Z]));
      }
    },
    [i, p, n, c]
  ), yt = K(() => {
  ...
  const Ot = U({ book: a.book, chapterNum: a.chapterNum });
  At(() => {
    (Ot.current.book !== a.book || Ot.current.chapterNum !== a.chapterNum) && (Ot.current = { book: a.book, chapterNum: a.chapterNum }, oe.current());
  }, [a.book, a.chapterNum]);
  const Xt = () => {
    var $;
    const C = ($ = h.current) == null ? void 0 : $.getElementsByClassName("editor-input")[0];
    ...
    var Y, Z, et, xt, ut;
    _(C);
    const $ = (Z = (Y = u.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : Z.at(0);
    if ($ && pn("note", $)) {
      $.insert.note && ($.insert.note.style = C);
      const Nt = (xt = (et = $.insert.note) == null ? void 0 : et.contents) == null ? void 0 : xt.ops;
      k !== "x" && C === "x" ? Nt == null || Nt.forEach((ft) => hc(ft)) : k === "x" && C !== "x" && (Nt == null || Nt.forEach((ft) => gc(ft))), (ut = u.current) == null || ut.applyUpdate([$, { delete: 1 }]);
    }
  }, He = (C) => {
    dt(C.contextMarker), M(C.canRedo);
  }, O = K(
    (C) => {
      var Y, Z, et, xt, ut;
      const $ = (Z = (Y = u.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : Z.at(0);
      if ($ && pn("note", $)) {
        C.content.length > 1 && setTimeout(() => {
          var T;
          (T = u.current) == null || T.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const Nt = (et = $.insert.note) == null ? void 0 : et.style, ft = (ut = (xt = $.insert.note) == null ? void 0 : xt.contents) == null ? void 0 : ut.ops;
        if (Nt || L(!1), L(
          Nt === "x" ? !!(ft != null && ft.every((T) => {
            var gt, se;
            if (!((gt = T.attributes) != null && gt.char)) return !0;
            const ht = ((se = T.attributes) == null ? void 0 : se.char).style;
        ...
        P(JSON.stringify($) === j.current), nt(x, y);
      } else
        L(!1), P(!0);
    },
    [x, y, nt]
    ...
    if (m.current && pt.length && C && C.rangeCount > 0) {
      const $ = C.getRangeAt(0).getBoundingClientRect(), Y = m.current.getBoundingClientRect();
      I($.left - Y.left), St($.top - Y.top), $t($.height), A(!0);
    }
  }, [pt, m]);
  return q(() => {
    const C = () => {
    ...
    var C;
    D && ((C = G.current) == null || C.focus());
  }, [D]), q(() => {
    var Y;
    const C = ((Y = h.current) == null ? void 0 : Y.querySelector(".editor-input")) ?? void 0, $ = (Z) => {
      !D && C && document.activeElement === C && Z.key === l ? (Z.preventDefault(), H()) : D && Z.key === "Escape" && (Z.preventDefault(), A(!1));
    };
    return document.addEventListener("keydown", $), () => {
      document.removeEventListener("keydown", $);
    };
  }, [D, H, l]), /* @__PURE__ */ d(lt, { children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          /* @__PURE__ */ r(
            ac,
            {
              onUndoClick: () => {
                var C;
                return (C = u.current) == null ? void 0 : C.undo();
              },
              onRedoClick: () => {
                var C;
                return (C = u.current) == null ? void 0 : C.redo();
              },
              canUndo: !S,
              canRedo: E,
              localizedStrings: w
          ...
          /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
            ...
            /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: w["%footnoteEditor_saveButton_tooltip%"] }) })
          ] }) }),
          /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
            /* @__PURE__ */ r(Mt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(je, {}) }) }),
            /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: w["%footnoteEditor_cancelButton_tooltip%"] }) })
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ d(
...
function Sp({
  ...
  const p = w ?? ri(n, void 0), u = (N, k) => {
    c == null || c(N, k, a);
  }, h = i ? n.findIndex((N) => N === i) : -1, [m, g] = R(h), x = (N, k, _) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), c == null || c(k, _, a);
          break;
      }
  }, v = (N) => {
    if (n.length)
...
function kc({
  ...
  return /* @__PURE__ */ d(On, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(In, { stickyHeader: !0, children: /* @__PURE__ */ d(Jt, { children: [
      /* @__PURE__ */ r(an, { children: a }),
      /* @__PURE__ */ r(an, { children: i })
    ] }) }),
    /* @__PURE__ */ r(An, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ d(
      Jt,
      {
        onClick: () => {
          e(l.reference);
...
const _c = (t) => {
...
}, Pn = (t, e, n) => /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
  /* @__PURE__ */ d(
    Mt,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ d(Sr, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        en,
        {
          onClick: (w) => {
...
function Lp({
  ...
  const m = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), _ = Kt(n, "%webView_inventory_filter_text%"), B = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = Kt(n, "%webView_inventory_no_results%"), [S, P] = R(!1), [E, M] = R("all"), [V, j] = R(""), [D, A] = R([]), W = z(() => {
    const G = t ?? [];
    ...
    const G = [];
    return W.forEach((it) => {
      const pt = it.items[0], nt = G.find(
        (yt) => yt.items[0] === pt
      );
      nt ? (nt.count += it.count, nt.occurrences = nt.occurrences.concat(it.occurrences)) : G.push({
        items: [pt],
        count: it.count,
  ...
  }, [S, W]), J = z(() => I.length === 0 ? [] : Tc(I, E, V), [I, E, V]), St = z(() => {
    var pt, nt;
    if (!S) return w;
    const G = (pt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : pt.length;
    if (!G) return w;
    const it = [];
    for (let yt = 0; yt < G; yt++)
      it.push(
        Cc(
          ((nt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : nt[yt]) || "Additional Item",
          yt + 1
        )
      );
    return [...it, ...w];
  ...
  const Pt = (G, it) => {
    it.setRowSelection(() => {
      const nt = {};
      return nt[G.index] = !0, nt;
    });
    const pt = G.original.items;
    A(pt), h && pt.length > 0 && h(pt[0]);
  }, $t = (G) => {
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(Ee, { children: [
              /* @__PURE__ */ r(It, { value: "all", children: m }),
      ...
      /* @__PURE__ */ d(Le, { onValueChange: (G) => $t(G), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(bt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] })
    ] }),
...
const ja = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(t), u = e ?? c, h = b.useCallback(
      ...
      [n, u]
    ), m = b.useCallback(() => h((k) => !k), [h]), g = u ? "expanded" : "collapsed", y = vt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Va.Provider, { value: N, children: /* @__PURE__ */ r(Ct, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Vc = ue(
  ...
  ({
    ...
    const w = t ? Fe : "button", { state: c } = $n(), p = /* @__PURE__ */ r(
      w,
      {
        ref: l,
    ...
    za,
    {
      ...
      children: /* @__PURE__ */ d(Ba, { children: [
        /* @__PURE__ */ d(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(Ka, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Ga, { children: /* @__PURE__ */ r(
            Ua,
            {
              onClick: () => c(h),
              isActive: u(h),
...
const ie = "scrBook", qc = "scrRef", be = "source", Hc = "details", Yc = "Scripture Reference", Xc = "Scripture Book", qa = "Type", Wc = "Details";
function Jc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ct.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === ie ? xe(a.start) : void 0;
      },
...
function jp({
  ...
  const [c, p] = R([]), [u, h] = R([{ id: ie, desc: !1 }]), [m, g] = R({}), x = z(
    () => t.flatMap((E) => E.data.map((M) => ({
      ...M,
      source: E.source
    }))),
    [t]
  ...
  q(() => {
    if (l) {
      const E = y.getSelectedRowModel().rowsById, M = Object.keys(E);
      if (M.length === 1) {
        const V = x.find((j) => co(j) === M[0]) || void 0;
        V && l(V);
      }
    }
  }, [m, x, l, y]);
  const N = a ?? Xc, k = i ?? qa, _ = [
    ...
    !E.getIsGrouped() && !E.getIsSelected() && E.getToggleSelectedHandler()(M);
  }, S = (E, M) => E.getIsGrouped() ? "" : f("banded-row", M % 2 === 0 ? "even" : "odd"), P = (E, M, V) => {
    if (!((E == null ? void 0 : E.length) === 0 || M.depth < V.column.getGroupedIndex())) {
      if (M.getIsGrouped())
        switch (M.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ee, { position: "item-aligned", children: /* @__PURE__ */ r(Fw, { children: _.map((E) => /* @__PURE__ */ r(It, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(On, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(In, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Jt, { children: E.headers.filter((M) => M.column.columnDef.header).map((M) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(an, { colSpan: M.colSpan, className: "top-0 tw-sticky", children: M.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Ze(M.column.columnDef.header, M.getContext())
        ] }) }, M.id)
      )) }, E.id)) }),
      /* @__PURE__ */ r(An, { children: y.getRowModel().rows.map((E, M) => {
        const V = vt();
        return /* @__PURE__ */ r(
          Jt,
          {
            ...
            children: E.getVisibleCells().map((j) => {
              if (!(j.getIsPlaceholder() || j.column.columnDef.enableGrouping && !j.getIsGrouped() && (j.column.columnDef.id !== be || !n)))
                return /* @__PURE__ */ r(
                  Ne,
                  {
                    className: f(
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ d(
                      F,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          Ze(j.column.columnDef.cell, j.getContext()),
                          " (",
                          E.subRows.length,
                          ")"
                        ]
...
}), Ha = (t, e, n) => $r(t, e).every((o) => n.includes(o));
function Qc({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
...
function td({
  ...
  }, [v, y] = R(!1), [N, k] = R(""), _ = U(void 0), B = U(!1);
  ...
  const L = z(() => ct.allBookIds.filter(
    ...
    (A, W = !1) => {
      ...
      const I = L.findIndex((mt) => mt === _.current), J = L.findIndex((mt) => mt === A);
      if (I === -1 || J === -1) return;
      const [St, Pt] = [
        Math.min(I, J),
        Math.max(I, J)
      ], $t = L.slice(St, Pt + 1).map((mt) => mt);
      n(
...
function Fp({
  ...
  const c = he(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), h = he(s, "%webView_scope_selector_current_book%"), m = he(s, "%webView_scope_selector_choose_books%"), g = he(s, "%webView_scope_selector_scope%"), x = he(s, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        kr,
        {
          ...
          children: y.map(({ value: N, label: k, id: _ }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(yn, { className: "tw-me-2", value: N, id: _ }),
            /* @__PURE__ */ r(bt, { htmlFor: _, children: k })
          ] }, _))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(bt, { children: x }),
      /* @__PURE__ */ r(
        td,
        {
          availableBookInfo: o,
...
function hr({
  ...
  return /* @__PURE__ */ d(Te, { variant: i, children: [
    /* @__PURE__ */ r(Ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Gs, {}) }) }),
    /* @__PURE__ */ r(fe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(uo, { children: [
      /* @__PURE__ */ r(Ma, { children: /* @__PURE__ */ r(Ct, { children: Xa(e.groups, e.items, w, t) }) }),
...
Ja.displayName = Rt.List.displayName;
...
Qa.displayName = Rt.Content.displayName;
function Yp({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
ts.displayName = at.Root.displayName;
...
ns.displayName = at.SubTrigger.displayName;
...
rs.displayName = at.SubContent.displayName;
...
os.displayName = at.Content.displayName;
...
as.displayName = at.Item.displayName;
...
ss.displayName = at.Separator.displayName;
const Xe = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
...
function id({
  ...
  const a = U(void 0), i = U(void 0), s = U(void 0), l = U(void 0), w = U(void 0), c = (p) => {
    switch (p) {
      case "platform.app":
        return i;
  ...
  if (Qi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    switch (u.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = i.current) == null || g.focus(), Xe(i, [h, m]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), Xe(s, [h, m]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Xe(l, [h, m]);
        break;
      case "alt+h":
        (y = w.current) == null || y.focus(), Xe(w, [h, m]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ r(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(nd, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Ct, { children: is(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function Jp({
  ...
  const c = ld(
    ...
    var y, N, k, _, B, L;
    const v = x !== g ? ((N = (y = t[g]) == null ? void 0 : y.uiNames) == null ? void 0 : N[x]) ?? ((_ = (k = t[g]) == null ? void 0 : k.uiNames) == null ? void 0 : _.en) : void 0;
      ...
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(It, { value: g, children: m(g, e) }, g))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(bt, { className: "tw-font-normal tw-text-muted-foreground", children: ve(c, {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(Te, { children: [
              /* @__PURE__ */ r(Ge, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(go, {}) }) }),
              /* @__PURE__ */ r(fe, { align: "end", children: l })
            ] })
          ] }),
...
const cd = sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Hs, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
const iu = Ft.Trigger, Cd = Ft.Portal, lu = Ft.Close, ws = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Ft.Overlay,
  {
    ref: n,
...
ws.displayName = Ft.Overlay.displayName;
...
Sd.displayName = Ft.Title.displayName;
...
Dd.displayName = Ft.Description.displayName;
...
Md.displayName = or.Root.displayName;
function wu({
  className: t,
  ...e
}) {
...
Od.displayName = We.Root.displayName;
...
const uu = Rt.Root, Ad = b.forwardRef(({ className: t, ...e }, n) => {
  const o = vt();
  return /* @__PURE__ */ r(
    Rt.List,
    {
...
Ad.displayName = Rt.List.displayName;
...
Pd.displayName = Rt.Trigger.displayName;
...
$d.displayName = Rt.Content.displayName;
