...
import c, { forwardRef as re, createContext as wr, useContext as lr, useCallback as it, useState as A, useRef as ot, useEffect as xt, useLayoutEffect as We, useMemo as J, Fragment as dr } from "react";
...
import { ChevronRight as Ce, Check as Vt, Circle as Se, X as Re, Search as on, ChevronsUpDown as Te, FilterIcon as mr, ChevronDown as qt, ChevronUp as sn, ArrowLeftIcon as hr, ChevronLeftIcon as gr, ChevronRightIcon as fr, ArrowRightIcon as br, LoaderCircle as vr, Download as xr, Filter as yr, User as Nr, Link as kr, CircleHelp as Cr, Star as Sr, CircleCheckIcon as Rr, CircleXIcon as Tr, CircleHelpIcon as _r, ArrowUpIcon as zr, ArrowDownIcon as Er, ArrowUpDownIcon as Mr, PanelLeft as Dr, PanelRight as Ir, ScrollText as wn, ChevronLeft as Vr, MenuIcon as Br, ImageIcon as Ar, BookA as Or, BookOpen as Pr, Home as Fr, Ellipsis as Xr } from "lucide-react";
import { formatScrRef as Yt, getChaptersForBook as Gr, NumberFormat as $r, formatBytes as Lr, deepEqual as _e, substring as Yr, compareScrRefs as he, scrRefToBBBCCCVVV as de, getLocalizeKeyForScrollGroupId as B, formatTimeSpan as jr } from "platform-bible-utils";
...
import { useReactTable as dn, getFilteredRowModel as Hr, getSortedRowModel as cn, getPaginationRowModel as Ur, getCoreRowModel as pn, flexRender as jt, getGroupedRowModel as qr, getExpandedRowModel as Jr } from "@tanstack/react-table";
...
const oe = F.Trigger, hn = F.Group, na = F.Portal, ra = F.Sub, us = F.RadioGroup;
...
const gn = c.forwardRef(({ className: t, inset: e, children: r, ...a }, o) => {
  const i = wt();
  return /* @__PURE__ */ w(
    F.SubTrigger,
    {
...
gn.displayName = F.SubTrigger.displayName;
const fn = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  F.SubContent,
  {
    ref: r,
    className: d(
...
fn.displayName = F.SubContent.displayName;
...
const bn = c.forwardRef(({ className: t, children: e, ...r }, a) => {
  const o = wt();
  return /* @__PURE__ */ w(
    F.RadioItem,
    {
...
bn.displayName = F.RadioItem.displayName;
...
var oa = Object.defineProperty, sa = (t, e, r) => e in t ? oa(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, _ = (t, e, r) => sa(t, typeof e != "symbol" ? e + "" : e, r);
const Tt = [
  "GEN",
  "EXO",
  "LEV",
...
function Ft(t, e = !0) {
  return e && (t = t.toUpperCase()), t in Ze ? Ze[t] : 0;
}
function De(t) {
  return Ft(t) > 0;
}
...
const W = class I {
  ...
  allVerses(e = !1, r = I.verseRangeSeparators, a = I.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], i = Qe(this._verse, a);
    for (const l of i.map((s) => Qe(s, r))) {
      const s = this.clone();
      s.verse = l[0];
      const p = s.verseNum;
...
const Ve = $.allBookIds.filter((t) => !$.isObsolete($.bookIdToNumber(t))), va = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, tn = ["OT", "NT", "DC"], xa = 96, ya = [
  /^(\w+)$/i,
...
function hs({
  ...
  const o = q(), [i, l] = A(""), [s, p] = A(t.book), [u, m] = A(t.chapterNum ?? 0), [f, h] = A(t.book), [g, v] = A(!1), [R, y] = A(g), C = ot(void 0), k = ot(void 0), V = ot(void 0), G = it(
    ...
    ya.forEach((N) => {
      const T = N.exec(i);
      if (T) {
        const [O, D = void 0, L = void 0] = T.slice(1), mt = Ca(O);
  ...
  return xt(() => {
    ...
    const N = setTimeout(() => {
      if (R && k.current && V.current && !i) {
        const O = V.current.offsetTop - xa;
    ...
    /* @__PURE__ */ n(
      Pt,
      {
        ...
        ref: k,
        children: /* @__PURE__ */ n("div", { className: "rtl:tw-ps-2", children: tn.map((N, T) => {
          const O = G(N);
          return O.length > 0 && /* @__PURE__ */ w("div", { children: [
            /* @__PURE__ */ n(se, { className: "tw-font-semibold tw-text-foreground/80", children: va[N] }),
            ...
            tn.length - 1 !== T ? /* @__PURE__ */ n(Wt, {}) : void 0
          ] }, N);
        }) })
      }
    )
...
const Sa = Mt(
  ...
  ({ className: t, variant: e, size: r, asChild: a = !1, ...o }, i) => /* @__PURE__ */ n(a ? Bt : "button", { className: d(Sa({ variant: e, size: r, className: t })), ref: i, ...o })
);
E.displayName = "Button";
const Ra = Mt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), U = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(ln.Root, { ref: r, className: d("pr-twp", Ra(), t), ...e }));
U.displayName = ln.Root.displayName;
const Sn = c.forwardRef(({ className: t, ...e }, r) => {
  const a = q();
  return /* @__PURE__ */ n(
    Ht.Root,
    {
...
Sn.displayName = Ht.Root.displayName;
const be = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  Ht.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ n(Ht.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ n(Se, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
be.displayName = Ht.Item.displayName;
const Rn = Ut.Root, Tn = Ut.Trigger, Be = c.forwardRef(({ className: t, align: e = "center", sideOffset: r = 4, ...a }, o) => {
  const i = q();
...
const Ta = pt.Portal, _n = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  pt.Overlay,
  {
    ref: r,
    className: d(
...
_n.displayName = pt.Overlay.displayName;
const _a = c.forwardRef(({ className: t, children: e, ...r }, a) => {
  const o = q();
...
_a.displayName = pt.Content.displayName;
const za = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  pt.Title,
  {
    ref: r,
...
za.displayName = pt.Title.displayName;
const Ea = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  pt.Description,
  {
    ref: r,
...
Ea.displayName = pt.Description.displayName;
...
zn.displayName = Q.Group.displayName;
const Ma = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  Q.Separator,
  {
    ref: r,
...
Ma.displayName = Q.Separator.displayName;
...
function ve({
  ...
  const [y, C] = A(!1);
  return /* @__PURE__ */ w(Rn, { open: y, onOpenChange: C, ...R, children: [
    /* @__PURE__ */ n(Tn, { asChild: !0, children: /* @__PURE__ */ w(
      E,
      {
        variant: h,
        role: "combobox",
...
function Ba({ table: t }) {
  return /* @__PURE__ */ w(Kt, { children: [
    /* @__PURE__ */ n(ur, { asChild: !0, children: /* @__PURE__ */ w(E, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ n(mr, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const _t = Y.Root, Aa = Y.Group, zt = Y.Value, yt = c.forwardRef(({ className: t, children: e, ...r }, a) => {
  const o = q();
  return /* @__PURE__ */ w(
    Y.Trigger,
    {
...
En.displayName = Y.ScrollUpButton.displayName;
const Mn = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  Y.ScrollDownButton,
  {
    ref: r,
    className: d("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
...
Mn.displayName = Y.ScrollDownButton.displayName;
...
Oa.displayName = Y.Label.displayName;
...
Pa.displayName = Y.Separator.displayName;
function Fa({ table: t }) {
...
const Xa = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  "tfoot",
  {
    ref: r,
...
const Ga = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  "caption",
  {
    ref: r,
...
function $a({
  ...
  var y;
  const [s, p] = A([]), [u, m] = A([]), [f, h] = A({}), [g, v] = A({}), R = dn({
    data: e,
    columns: t,
    getCoreRowModel: pn(),
    ...r && { getPaginationRowModel: Ur() },
    onSortingChange: p,
    getSortedRowModel: cn(),
    onColumnFiltersChange: m,
    getFilteredRowModel: Hr(),
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ n(Ba, { table: R }),
    /* @__PURE__ */ w(Zt, { stickyHeader: i, children: [
      /* @__PURE__ */ n(Qt, { stickyHeader: i, children: R.getHeaderGroups().map((C) => /* @__PURE__ */ n(ct, { children: C.headers.map((k) => /* @__PURE__ */ n(vt, { children: k.isPlaceholder ? void 0 : jt(k.column.columnDef.header, k.getContext()) }, k.id)) }, C.id)) }),
      /* @__PURE__ */ n(te, { children: (y = R.getRowModel().rows) != null && y.length ? R.getRowModel().rows.map((C) => /* @__PURE__ */ n(
        ct,
        {
          onClick: () => l(C, R),
          "data-state": C.getIsSelected() && "selected",
          children: C.getVisibleCells().map((k) => /* @__PURE__ */ n(at, { children: jt(k.column.columnDef.cell, k.getContext()) }, k.id))
        },
        C.id
    ...
    r && a && /* @__PURE__ */ n(Fa, { table: R })
  ] });
}
const Et = re(({ className: t, ...e }, r) => /* @__PURE__ */ n(vr, { size: 35, className: d("tw-animate-spin", t), ...e, ref: r }));
  ...
  return /* @__PURE__ */ n(
    E,
    {
      ...
      children: t ? /* @__PURE__ */ n(Et, { size: 15 }) : /* @__PURE__ */ w(It, { children: [
        /* @__PURE__ */ n(xr, { size: 25, className: d("tw-h-4 tw-w-4", { "tw-mr-1": r }) }),
        r
      ] })
    }
  );
}
function vs({ isEnabling: t, handleClick: e, className: r, ...a }) {
  return /* @__PURE__ */ n(
    E,
    {
      className: d(
...
function ys({ isUpdating: t, handleClick: e, className: r, ...a }) {
  return /* @__PURE__ */ n(
    E,
    {
      className: d(
...
function Ns({ id: t, markdown: e, className: r, anchorTarget: a }) {
  const o = J(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ n("div", { id: t, className: d("pr-twp tw-prose", r), children: /* @__PURE__ */ n(Kr, { options: o, children: e }) });
}
const La = re((t, e) => /* @__PURE__ */ w(
  E,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ n(yr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ n(
        qt,
        {
...
function ks({ id: t, groups: e }) {
  return /* @__PURE__ */ n("div", { id: t, children: /* @__PURE__ */ w(Kt, { children: [
    /* @__PURE__ */ n(oe, { asChild: !0, children: /* @__PURE__ */ n(La, {}) }),
    /* @__PURE__ */ n(Pt, { children: e.map((r) => /* @__PURE__ */ w("div", { children: [
      /* @__PURE__ */ n(se, { children: r.label }),
      /* @__PURE__ */ n(hn, { children: r.items.map((a) => /* @__PURE__ */ n("div", { children: a.itemType === 0 ? /* @__PURE__ */ n(Ee, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ n(bn, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ n(Wt, {})
    ] }, r.label)) })
  ] }) });
}
...
function Ss({ id: t, category: e, downloads: r, languages: a, moreInfoUrl: o }) {
  const i = new $r("en", {
    notation: "compact",
      ...
      children: [
        ...
        /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ n(Nr, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ w("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          ...
          /* @__PURE__ */ w(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ n(Cr, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function Rs({
  ...
  return /* @__PURE__ */ n("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ w("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ n(ja, { versionHistory: o }),
...
const Ha = Mt(
  ...
  ({ className: t, variant: e, ...r }, a) => /* @__PURE__ */ n("div", { ref: a, className: d("pr-twp", Ha({ variant: e }), t), ...r })
);
...
function Ua({
  ...
  return /* @__PURE__ */ n("div", { className: m, children: /* @__PURE__ */ w(Rn, { open: f, onOpenChange: h, children: [
    /* @__PURE__ */ n(Tn, { asChild: !0, children: /* @__PURE__ */ w(
      E,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ n(Be, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ w(Ae, { children: [
      ...
      /* @__PURE__ */ w(Pe, { children: [
        ...
        /* @__PURE__ */ n(zn, { children: R.map((y) => {
          ...
          return /* @__PURE__ */ w(
            Xe,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ n("div", { className: "tw-w-4", children: y.starred && /* @__PURE__ */ n(Sr, { className: "tw-h-4 tw-w-4" }) }),
...
function Ts({
  ...
  return /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    r.length > 0 ? /* @__PURE__ */ n("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: r.map((h) => {
      var g;
      return /* @__PURE__ */ w(Dn, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ n(
          E,
          {
            variant: "ghost",
...
const In = Mt(
  ...
  {
    ref: o,
    className: d(In({ variant: e, size: r, className: t })),
    ...a
  }
));
Ja.displayName = un.Root.displayName;
const Vn = c.createContext({
  size: "default",
  variant: "default"
}), Bn = c.forwardRef(({ className: t, variant: e, size: r, children: a, ...o }, i) => {
  const l = q();
  return /* @__PURE__ */ n(
    ae.Root,
    {
...
Bn.displayName = ae.Root.displayName;
...
const ie = (t) => t === "asc" ? /* @__PURE__ */ n(zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ n(Er, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ n(Mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), _s = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ w(Bn, { value: l, variant: "outline", type: "single", children: [
      /* @__PURE__ */ n(
        ee,
        {
          onClick: (p) => {
  ...
  return e ? e[1] : "";
}, Qa = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ms = Object.freeze([
  ...
  return Wa(t).forEach((m) => {
    m.startsWith("\\id") && (l = Za(m), s = 0, p = 0), m.startsWith("\\c") && (s = en(m), p = 0), m.startsWith("\\v") && (p = en(m), s === 0 && (s = e.chapterNum));
    ...
    for (; f; ) {
      ...
      const g = f.index, v = i.find((y) => _e(y.items, h)), R = {
        ...
        text: Yr(m, Math.max(0, g - 25), Math.min(g + 25, m.length))
      };
      if (v)
...
function Ds({
  ...
  const f = ht(r, "%webView_inventory_all%"), h = ht(r, "%webView_inventory_approved%"), g = ht(r, "%webView_inventory_unapproved%"), v = ht(r, "%webView_inventory_unknown%"), R = ht(r, "%webView_inventory_scope_currentBook%"), y = ht(r, "%webView_inventory_scope_chapter%"), C = ht(r, "%webView_inventory_scope_verse%"), k = ht(r, "%webView_inventory_filter_text%"), V = ht(
    r,
    "%webView_inventory_show_additional_items%"
  ), [G, et] = A(!1), [st, kt] = A("all"), [x, M] = A(""), [K, P] = A([]), Ct = J(() => s ? a instanceof RegExp ? eo(s, t, i, l, a) : a(s, t, i, l) : [], [s, a, t, i, l]), ut = J(() => {
    if (G) return Ct;
    const S = [];
    return Ct.forEach((j) => {
      const lt = j.items[0], rt = S.find(
        (ft) => ft.items[0] === lt
      );
      rt ? (rt.count += j.count, rt.occurrences = rt.occurrences.concat(j.occurrences)) : S.push({
        items: [lt],
        count: j.count,
  ...
  }, [G, Ct]), N = J(() => to(ut, st, x), [ut, st, x]), T = J(() => {
    var lt, rt;
    if (!G) return m;
...
$e.displayName = mn.Root.displayName;
...
const Le = Jt.Provider, Ye = Jt.Root, je = Jt.Trigger, we = c.forwardRef(({ className: t, sideOffset: e = 4, ...r }, a) => /* @__PURE__ */ n(
  Jt.Content,
  {
    ref: a,
    sideOffset: e,
...
const no = "16rem", ro = "3rem", An = c.createContext(void 0);
function le() {
...
const On = c.forwardRef(
  ({
    ...
    return /* @__PURE__ */ n(An.Provider, { value: k, children: /* @__PURE__ */ n(Le, { delayDuration: 0, children: /* @__PURE__ */ n(
      "div",
      {
        style: (
...
const Pn = c.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: r, children: a, ...o }, i) => {
  const l = le();
...
const ao = c.forwardRef(({ className: t, onClick: e, ...r }, a) => {
  const o = le();
  return /* @__PURE__ */ w(
    E,
    {
      ...
      ...r,
      children: [
        o.side === "primary" ? /* @__PURE__ */ n(Dr, {}) : /* @__PURE__ */ n(Ir, {}),
        /* @__PURE__ */ n("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
ao.displayName = "SidebarTrigger";
...
wo.displayName = "SidebarFooter";
const lo = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  $e,
  {
    ref: r,
...
lo.displayName = "SidebarSeparator";
...
const co = c.forwardRef(({ className: t, asChild: e = !1, ...r }, a) => /* @__PURE__ */ n(
  e ? Bt : "button",
  {
    ref: a,
  ...
  ({
    ...
    const p = t ? Bt : "button", { state: u } = le(), m = /* @__PURE__ */ n(
      p,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: d(po({ variant: r, size: a }), i),
        ...l
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ n(je, { asChild: !0, children: m }),
      /* @__PURE__ */ n(we, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : m;
  }
);
Ln.displayName = "SidebarMenuButton";
const uo = c.forwardRef(({ className: t, asChild: e = !1, showOnHover: r = !1, ...a }, o) => /* @__PURE__ */ n(
  e ? Bt : "button",
  {
    ref: o,
...
uo.displayName = "SidebarMenuAction";
...
mo.displayName = "SidebarMenuBadge";
const ho = c.forwardRef(({ className: t, showIcon: e = !1, ...r }, a) => {
...
ho.displayName = "SidebarMenuSkeleton";
...
go.displayName = "SidebarMenuSub";
const fo = c.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ n("li", { ref: e, ...t })
);
fo.displayName = "SidebarMenuSubItem";
const bo = c.forwardRef(({ asChild: t = !1, size: e = "md", isActive: r, className: a, ...o }, i) => /* @__PURE__ */ n(
  t ? Bt : "a",
  {
    ref: i,
...
function vo({
  ...
  return /* @__PURE__ */ n(
    Pn,
    {
      ...
      children: /* @__PURE__ */ w(Xn, { children: [
        /* @__PURE__ */ w(xe, { children: [
          /* @__PURE__ */ n(ye, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ n(Ne, { children: /* @__PURE__ */ n(Gn, { children: Object.entries(e).map(([h, g]) => /* @__PURE__ */ n($n, { children: /* @__PURE__ */ n(
            Ln,
            {
              onClick: () => u(h),
              isActive: f(h),
    ...
    /* @__PURE__ */ w(
      On,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ n(Fn, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const bt = "scrBook", xo = "scrRef", Rt = "source", yo = "details", No = "Scripture Reference", ko = "Scripture Book", Yn = "Type", Co = "Details";
function So(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: yo,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Co,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
}, rn = (t) => `${Ro({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Vs({
  sources: t,
  ...
  xt(() => {
    if (s) {
      ...
      if (M.length === 1) {
        const K = v.find((P) => rn(P) === M[0]) || void 0;
        K && s(K);
      }
    }
  }, [h, v, s, y]);
  const C = o ?? ko, k = i ?? Yn, V = [
    ...
    !e && /* @__PURE__ */ w(
      _t,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ n(Nt, { position: "item-aligned", children: /* @__PURE__ */ n(Aa, { children: V.map((x) => /* @__PURE__ */ n(Z, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ w(Zt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ n(Qt, { children: y.getHeaderGroups().map((x) => /* @__PURE__ */ n(ct, { children: x.headers.filter((M) => M.column.columnDef.header).map((M) => (
        ...
        /* @__PURE__ */ n(vt, { colSpan: M.colSpan, className: "top-0 tw-sticky", children: M.isPlaceholder ? void 0 : /* @__PURE__ */ w("div", { children: [
          ...
          " ",
          jt(M.column.columnDef.header, M.getContext())
        ] }) }, M.id)
      )) }, x.id)) }),
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ w(
                      E,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          jt(P.column.columnDef.cell, P.getContext()),
                          " (",
                          x.subRows.length,
                          ")"
                        ]
...
const Hn = (t, e, r, a) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ n(je, { asChild: !0, children: "command" in s ? /* @__PURE__ */ w(
    Dt,
    {
      onClick: () => {
        a(s);
    ...
    /* @__PURE__ */ n(gn, { children: s.label }),
    /* @__PURE__ */ n(na, { children: /* @__PURE__ */ n(fn, { children: Hn(
      t,
      e,
      jn(t, s.id),
      a
...
function Fs({
  ...
  return /* @__PURE__ */ w(Kt, { variant: i, children: [
    ...
    /* @__PURE__ */ n(Pt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ w(dr, { children: [
      /* @__PURE__ */ n(hn, { children: /* @__PURE__ */ n(Le, { children: Hn(e.groups, e.items, s, t) }) }),
      p < u.length - 1 && /* @__PURE__ */ n(Wt, {})
    ] }, s)) })
  ] });
}
const Un = c.forwardRef(({ className: t, ...e }, r) => {
  const a = q();
  return /* @__PURE__ */ n(
    tt.Root,
    {
...
const qn = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  tt.List,
  {
    ref: r,
    className: d(
...
qn.displayName = tt.List.displayName;
const To = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  tt.Trigger,
  {
    ref: r,
    ...e,
...
)), Jn = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  tt.Content,
  {
    ref: r,
    className: d(
...
Jn.displayName = tt.Content.displayName;
function Xs({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ w(Un, { children: [
      /* @__PURE__ */ n(qn, { children: t.map((l) => /* @__PURE__ */ n(To, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ n(Jn, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function _o({ ...t }) {
...
const Kn = c.forwardRef(({ className: t, variant: e = "default", ...r }, a) => {
  const o = c.useMemo(
    () => ({
      variant: e
    }),
...
const Wn = c.forwardRef(({ className: t, ...e }, r) => {
  const a = wt();
  return /* @__PURE__ */ n(
    X.Trigger,
    {
...
const Zn = c.forwardRef(({ className: t, inset: e, children: r, ...a }, o) => {
  const i = wt();
  return /* @__PURE__ */ w(
    X.SubTrigger,
    {
...
const Qn = c.forwardRef(({ className: t, ...e }, r) => {
  const a = wt();
  return /* @__PURE__ */ n(
    X.SubContent,
    {
...
const tr = c.forwardRef(({ className: t, align: e = "start", alignOffset: r = -4, sideOffset: a = 8, ...o }, i) => {
  const l = wt();
...
const er = c.forwardRef(({ className: t, inset: e, ...r }, a) => {
  const o = wt();
  return /* @__PURE__ */ n(
    X.Item,
    {
...
const Eo = c.forwardRef(({ className: t, children: e, checked: r, ...a }, o) => {
  const i = wt();
  return /* @__PURE__ */ w(
    X.CheckboxItem,
    {
...
const Mo = c.forwardRef(({ className: t, children: e, ...r }, a) => {
  const o = wt();
  return /* @__PURE__ */ w(
    X.RadioItem,
    {
...
const Do = c.forwardRef(({ className: t, inset: e, ...r }, a) => /* @__PURE__ */ n(
  X.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Do.displayName = X.Label.displayName;
const nr = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  X.Separator,
  {
    ref: r,
    className: d("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
const $t = (t, e) => {
  ...
  return o.flatMap(([i], l) => {
    const s = e.filter((u) => u.group === i).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ w(Ye, { children: [
      /* @__PURE__ */ n(je, { asChild: !0, children: "command" in u ? /* @__PURE__ */ w(
        er,
        {
          onClick: () => {
            a(u);
        ...
        /* @__PURE__ */ n(Zn, { children: u.label }),
        /* @__PURE__ */ n(Qn, { children: rr(
          t,
          e,
          jn(t, u.id),
          a
    ...
    return s.length > 0 && l < o.length - 1 && p.push(/* @__PURE__ */ n(nr, {}, `separator-${i}`)), p;
  });
};
function Io({
  menuData: t,
  ...
  if (Wr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    var v, R, y, C;
    m.preventDefault();
    ...
    return /* @__PURE__ */ n(Kn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ w(_o, { children: [
      /* @__PURE__ */ n(Wn, { ref: u(m), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ n(
        tr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ n(Le, { children: rr(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function Bo({ item: t, createLabel: e, createComplexLabel: r }) {
...
), Oo = c.forwardRef(({ className: t, variant: e, ...r }, a) => /* @__PURE__ */ n("div", { ref: a, role: "alert", className: d(Ao({ variant: e }), t), ...r }));
...
const Fo = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n("div", { ref: r, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Fo.displayName = "AlertDescription";
const Xo = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  At.Root,
  {
    ref: r,
    className: d(
...
Xo.displayName = At.Root.displayName;
const Go = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  At.Image,
  {
    ref: r,
...
Go.displayName = At.Image.displayName;
const $o = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  At.Fallback,
  {
    ref: r,
    className: d(
...
$o.displayName = At.Fallback.displayName;
...
const Lo = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n("p", { ref: r, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Yo = c.forwardRef(({ className: t, ...e }, r) => {
  const a = q();
  return /* @__PURE__ */ w(
    Lt.Root,
    {
...
Yo.displayName = Lt.Root.displayName;
const jo = c.forwardRef(({ className: t, ...e }, r) => {
  const a = q();
  return /* @__PURE__ */ n(
    fe.Root,
    {
...
const Us = tt.Root, Ho = c.forwardRef(({ className: t, ...e }, r) => {
  const a = q();
  return /* @__PURE__ */ n(
    tt.List,
    {
...
Ho.displayName = tt.List.displayName;
const Uo = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  tt.Trigger,
  {
    ref: r,
    className: d(
...
Uo.displayName = tt.Trigger.displayName;
const qo = c.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ n(
  tt.Content,
  {
    ref: r,
    className: d(
...
qo.displayName = tt.Content.displayName;
function Jo({
  defaultValue: t,
  onChange: e,
  variant: r,
...
function qs({
  ...
  const h = (b) => t[b] ?? b, g = h("%resources_action%"), v = h("%resources_activity%"), R = h("%resources_clearSearch%"), y = h("%home_dialog_title%"), C = h("%resources_filterInput%"), k = h("%resources_fullName%"), V = h("%resources_get%"), G = h("%resources_getResources%"), et = h("%resources_items%"), st = h("%resources_language%"), kt = h("%resources_loading%"), x = h("%resources_noProjects%"), M = h("%resources_noProjectsInstruction%"), K = h("%resources_noSearchResults%"), P = h("%resources_open%"), Ct = h("%resources_searchedFor%"), ut = h("%resources_sync%"), N = J(() => {
    const b = [];
    return m && Object.entries(m).forEach(([z, H]) => {
      b.push({
        id: z,
        name: H.name,
        fullName: H.fullName,
        ...
        editedStatus: H.editedStatus,
        lastSendReceiveDate: H.lastSendReceiveDate,
        type: "project"
      });
    }), u == null || u.forEach((z) => {
      b.some((H) => H.id === z.id) || b.push({
        id: z.id,
        name: z.name,
        fullName: z.fullName,
        language: z.language,
    ...
    const b = N.filter((z) => {
      ...
      return (mt === "all" || mt === z.type) && (z.fullName.toLowerCase().includes(H) || z.name.toLowerCase().includes(H) || z.language.toLowerCase().includes(H));
    });
    return b.length === 0 && T === "" && setTimeout(() => {
      ...
      switch (D.key) {
        case "fullName":
          return z.fullName < H.fullName ? D.direction === "ascending" ? -1 : 1 : z.fullName > H.fullName ? D.direction === "ascending" ? 1 : -1 : 0;
        case "language":
          return z.language < H.language ? D.direction === "ascending" ? -1 : 1 : z.language > H.language ? D.direction === "ascending" ? 1 : -1 : 0;
        case "activity":
          return !z.lastSendReceiveDate || !H.lastSendReceiveDate ? 0 : z.lastSendReceiveDate < H.lastSendReceiveDate ? D.direction === "ascending" ? -1 : 1 : z.lastSendReceiveDate > H.lastSendReceiveDate ? D.direction === "ascending" ? 1 : -1 : 0;
        case "action":
          return 0;
        default:
          return 0;
  ...
  return /* @__PURE__ */ n("div", { children: /* @__PURE__ */ w(ar, { className: "tw-flex tw-h-screen tw-flex-col tw-rounded-none tw-border-0", children: [
    /* @__PURE__ */ n(or, { className: "tw-flex-shrink-0", children: /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-gap-4", children: [
      /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-4 md:tw-flex-row", children: [
        /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center tw-gap-4", children: [
          /* @__PURE__ */ n(Fr, { size: 36 }),
          /* @__PURE__ */ n(sr, { children: y })
        ] }),
        /* @__PURE__ */ n(
          He,
          {
    ...
    s || p ? /* @__PURE__ */ w(ke, { className: "tw-flex tw-flex-grow tw-flex-col tw-items-center tw-justify-center tw-gap-2", children: [
      ...
      /* @__PURE__ */ n(Et, {})
    ] }) : /* @__PURE__ */ n(ke, { className: "tw-flex-grow tw-overflow-auto", children: u ? /* @__PURE__ */ n("div", { className: "tw-h-full tw-flex-grow", children: j.length === 0 ? /* @__PURE__ */ w("div", { className: "tw-flex tw-h-full tw-flex-grow tw-flex-col tw-items-center tw-justify-center tw-gap-1 tw-rounded-lg tw-border tw-border-gray-200 tw-p-6 tw-text-center", children: [
      ...
      /* @__PURE__ */ n(te, { children: j.map((b) => {
        const z = an[b.type].icon;
        return /* @__PURE__ */ w(
          ct,
          {
            className: "[&>td]:tw-p-2",
            ...
            children: [
              ...
              j.some(
                (H) => H.isSendReceivable
              ) && /* @__PURE__ */ n(at, { children: b.lastSendReceiveDate && jr(
                ft,
              ...
              /* @__PURE__ */ n(at, { children: b.isSendReceivable && b.isLocallyAvailable && /* @__PURE__ */ w(Kt, { children: [
                /* @__PURE__ */ n(oe, { asChild: !0, children: /* @__PURE__ */ n(E, { variant: "ghost", children: /* @__PURE__ */ n(Xr, { className: "tw-w-4" }) }) }),
    ...
    /* @__PURE__ */ n(ir, { className: "tw-flex-shrink-0 tw-justify-center tw-border-t tw-p-4", children: j.length > 0 && /* @__PURE__ */ n(U, { className: "tw-font-normal", children: `${j.length} ${et}` }) })
  ] }) });
}
const Js = (t, e) => {
  xt(() => {
...
export {
  ...
  $o as AvatarFallback,
  Go as AvatarImage,
  gs as BOOK_SELECTOR_STRING_KEYS,
  Dn as Badge,
  hs as BookChapterControl,
  ...
  Ds as Inventory,
  U as Label,
  Ns as MarkdownRenderer,
  Ss as MoreInfo,
  Ua as MultiSelectComboBox,
  ...
  Ls as UiLanguageSelector,
  ys as UpdateButton,
  ja as VersionHistory,
  Un as VerticalTabs,
  Jn as VerticalTabsContent,
  qn as VerticalTabsList,
  To as VerticalTabsTrigger,
  Ha as badgeVariants,
  Sa as buttonVariants,
  d as cn,
  Za as getBookIdFromUSFM,
  Wa as getLinesFromUSFM,
  en as getNumberFromUSFM,
  Qa as getStatusForItem,
  Gs as getToolbarOSReservedSpaceClassName,
  zs as inventoryCountColumn,
  _s as inventoryItemColumn,
  Es as inventoryStatusColumn,
  Qs as sonner,
  Js as useEvent,
  Ks as useEventAsync,
  Wo as usePromise
