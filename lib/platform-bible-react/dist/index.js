...
const xr = G.forwardRef(
  ({ className: e, ...t }, n) => (
    // Added pr-h-full
    /* @__PURE__ */ m("div", { className: "pr-relative pr-h-full pr-w-full pr-overflow-auto", children: /* @__PURE__ */ m(
      "table",
      {
        ref: n,
...
function up({
  ...
  return /* @__PURE__ */ A("div", { className: "pr-h-full", children: [
    o && /* @__PURE__ */ m(pp, { table: h }),
    /* @__PURE__ */ m("div", { className: "pr-twp pr-h-full pr-font-sans", children: /* @__PURE__ */ A(xr, { children: [
...
function Np() {
  return wa || (wa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function x(L) {
      ...
      L === r || L === u || L === a || L === o || L === v || L === g || typeof L == "object" && L !== null && (L.$$typeof === h || L.$$typeof === p || L.$$typeof === i || L.$$typeof === l || L.$$typeof === f || L.$$typeof === b || L.$$typeof === w || L.$$typeof === P || L.$$typeof === d);
    }
    function E(L) {
    ...
    var y = c, N = u, C = l, _ = i, D = t, V = f, k = r, S = h, $ = p, z = n, B = a, M = o, U = v, Q = !1;
    function Y(L) {
...
function Op() {
  ...
  return Xr = function(l, c) {
    ...
    function V() {
      function O(j, H, Z, W, X) {
        return z(j[H]) ? null : new d("Invalid " + W + " `" + X + "` supplied to " + ("`" + Z + "`, expected a ReactNode."));
      }
      return b(O);
    }
...
function Lp() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var N = i, C = a, _ = e, D = c, V = n, k = g, S = v, $ = t, z = o, B = r, M = u, U = f, Q = !1, Y = !1;
    function O(I) {
...
function An(e, t) {
  ...
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Bu : l, u = n.rootBoundary, f = u === void 0 ? bs : u, v = n.elementContext, g = v === void 0 ? fn : v, p = n.altBoundary, h = p === void 0 ? !1 : p, d = n.padding, b = d === void 0 ? 0 : d, w = Es(typeof b != "number" ? b : ks(b, Vn)), P = g === fn ? ju : fn, x = e.rects.popper, E = e.elements[h ? P : g], y = bd(Bt(E) ? E : E.contextElement || xt(e.elements.popper), c, f, i), N = tn(e.elements.reference), C = Ns({
    ...
    strategy: "absolute",
    placement: o
  }), _ = ho(Object.assign({}, x, C)), D = g === fn ? _ : N, V = {
...
function Pd(e) {
  ...
  if (N) {
    if (a) {
      var $, z = E === "y" ? Ie : Me, B = E === "y" ? We : Xe, M = E === "y" ? "height" : "width", U = N[E], Q = U + b[z], Y = U - b[B], O = p ? -_[M] / 2 : 0, j = P === Qt ? C[M] : _[M], H = P === Qt ? -_[M] : -C[M], Z = t.elements.arrow, W = p && Z ? Mo(Z) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : xs(), K = X[z], J = X[B], q = Nn(0, C[M], W[M]), ee = x ? C[M] / 2 - O - q - K - V.mainAxis : j - q - K - V.mainAxis, te = x ? -C[M] / 2 + O + q + J + V.mainAxis : H + q + J + V.mainAxis, ie = t.elements.arrow && Fn(t.elements.arrow), L = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, ne = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, I = U + ee - ne - L, se = U + te - ne, Te = Nn(p ? fr(Q, I) : Q, U, p ? It(Y, se) : Y);
      N[E] = Te, S[E] = Te - U;
    }
    if (l) {
      var Pe, Ee = E === "x" ? Ie : Me, kt = E === "x" ? We : Xe, $e = N[y], rt = y === "y" ? "height" : "width", Be = $e + b[Ee], ot = $e - b[kt], Ne = [Ie, Me].indexOf(w) !== -1, Lt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, Tt = Ne ? Be : $e - C[rt] - _[rt] - Lt + V.altAxis, an = Ne ? $e + C[rt] + _[rt] - Lt - V.altAxis : ot, Gn = p && Ne ? ed(Tt, $e, an) : Nn(p ? Tt : Be, $e, p ? an : ot);
      N[y] = Gn, S[y] = Gn - $e;
    }
    t.modifiersData[r] = S;
  }
...
function am(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const P = Tc(i, R({
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${et(u || "")}`), k === void 0 && (k = `Styled(${zp(i)})`), V.displayName = k;
      }
...
`));
  const $l = T.useMemo(() => {
    ...
    touch: Be.current
  }), Vr = sh(pn), ca = (r = (o = te.popper) != null ? o : D.Popper) != null ? r : lh, pa = (a = (i = (l = te.transition) != null ? l : D.Transition) != null ? i : L) != null ? a : yo, ua = (c = (u = te.tooltip) != null ? u : D.Tooltip) != null ? c : ch, da = (f = (v = te.arrow) != null ? v : D.Arrow) != null ? f : ph, _l = wn(ca, R({}, q, (g = ee.popper) != null ? g : V.popper, {
    className: Se(Vr.popper, q == null ? void 0 : q.className, (p = (h = ee.popper) != null ? h : V.popper) == null ? void 0 : p.className)
  }), pn), Il = wn(pa, R({}, ne, (d = ee.transition) != null ? d : V.transition), pn), Ml = wn(ua, R({}, (b = ee.tooltip) != null ? b : V.tooltip, {
    className: Se(Vr.tooltip, (w = (P = ee.tooltip) != null ? P : V.tooltip) == null ? void 0 : w.className)
  }), pn), Al = wn(da, R({}, (x = ee.arrow) != null ? x : V.arrow, {
...
const qs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const d = (x) => {
    ...
    if (y === "ArrowDown")
      ...
      C.previousKeyMatched && (V || gn(E, N, !1, c, eo, C)) ? x.preventDefault() : C.previousKeyMatched = !1;
    }
    f && f(x);
  }, b = Ge(p, n);
  let w = -1;
...
const Wh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Xh = (e) => {
  ...
  return !V && !S && (!Z || H) ? null : /* @__PURE__ */ m(In, {
    ...
    children: /* @__PURE__ */ A(J, R({}, ie, {
      children: [!D && f ? /* @__PURE__ */ m(q, R({}, L)) : null, /* @__PURE__ */ m(dr, {
        disableEnforceFocus: E,
        disableAutoFocus: x,
        disableRestoreFocus: C,
        isEnabled: j,
...
const ig = (e) => {
  ...
  } = i, V = ge(i.TransitionProps, rg), k = ge(i, og), S = (r = E == null ? void 0 : E.paper) != null ? r : P, $ = T.useRef(), z = Ge($, S.ref), B = R({}, i, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: d,
    marginThreshold: b,
...
`)), b !== null && Ee < b) {
  ...
  }, [c, v, U, Q, b]), [O, j] = T.useState(w), H = T.useCallback(() => {
    const ne = $.current;
    if (!ne)
      return;
    const I = Y(ne);
...
const pg = ["onEntering"], ug = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], dg = {
  ...
  const a = dt({
    ...
    TransitionProps: E,
    variant: w
  }), D = mg(_), V = i && !u && g, k = T.useRef(null), S = (Y, O) => {
...
function Dg({ columns: e, tableData: t, onSelectItem: n }) {
  return /* @__PURE__ */ m("div", { className: "pr-h-full", children: /* @__PURE__ */ m(up, { columns: e, data: t, onRowClickHandler: (o, a) => {
...
function ol({
  ...
  const g = n["%webView_inventory_all%"], p = n["%webView_inventory_approved%"], h = n["%webView_inventory_unapproved%"], d = n["%webView_inventory_unknown%"], b = n["%webView_inventory_scope_book%"], w = n["%webView_inventory_scope_chapter%"], P = n["%webView_inventory_scope_verse%"], x = n["%webView_inventory_filter_text%"], [E, y] = fe([]), [N, C] = fe("all"), [_, D] = fe(""), [V, k] = fe(""), S = (B, M) => {
    y((Y) => {
      let O = [];
      return B.forEach((j) => {
