    ...
    return /* @__PURE__ */ l("div", { className: "tw-relative tw-max-w-48", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          ...
          onKeyDown: (h) => {
            h.key === "Enter" ? (a(), h.preventDefault()) : e(h);
          },
          onClick: n,
          onFocus: (h) => {
            var f;
            b(!0), (f = p.onFocus) == null || f.call(p, h);
          },
          onBlur: (h) => {
            var f;
            b(!1), (f = p.onBlur) == null || f.call(p, h);
          },
          ref: c
        }
      ),
...
function Ws({
  ...
  const o = W(), [s, i] = B(
    () => Mt(t, "English")
  ), [w, p] = B(""), [c, g] = B(t.book), [b, h] = B(t.chapterNum ?? 0), [f, k] = B(t.book), [S, N] = B(!1), [_, x] = B(S), [M, z] = B(!1), [A, mt] = B(), U = Z(void 0), y = Z(void 0), v = Z(void 0), I = Z(void 0), R = H(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (V, C) => {
    ...
    if (!(!A || !A.chapterNum))
      return A.verseNum ? [A.chapterNum] : Array.from({ length: Pt(f) }, (m, V) => V + 1).filter(
        (m) => {
          var V;
          return (A == null ? void 0 : A.chapterNum) && m.toString().includes((V = A == null ? void 0 : A.chapterNum) == null ? void 0 : V.toString());
        }
      );
  }, [f, A]), lt = q(() => {
    const m = R(s.trim());
    ...
    i(Mt(t, "English")), p(""), g(t.book), k(t.book);
  }, [t]), gt = H((m) => {
    if (K.current) {
      K.current = !1;
      return;
    ...
    (m, V, C, Y) => {
      if (h(t.book !== m ? 1 : t.chapterNum), V || Pt(m) === -1) {
        e({
          book: m,
          chapterNum: C ?? 1,
          verseNum: Y ?? 1
    ...
    (m) => {
      if (!S)
        ...
        return;
      } else m.key === "ArrowDown" ? (I != null && I.current ? I.current.focus() : v != null && v.current ? v.current.focus() : y.current && y.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === U.current && (N(!1), m.preventDefault(), m.stopPropagation());
  ...
  return ct(() => {
    tt === 1 ? h(1) : c === f ? c === t.book ? h(t.chapterNum) : h(1) : h(0);
    ...
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          g(t.book), k(t.book), h(t.chapterNum > 0 ? t.chapterNum : 0), U.current.focus();
        },
        onFocus: () => {
      ...
      ne,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((m, V) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(fe, { className: "tw-font-semibold tw-text-foreground/80", children: Xa[m.bookType] }),
...
function Qs({
  ...
  const g = ze(c, "%webView_bookSelector_currentBook%"), b = ze(c, "%webView_bookSelector_choose%"), h = ze(c, "%webView_bookSelector_chooseBooks%"), [f, k] = B(
    "current book"
    /* CURRENT_BOOK */
  ), S = (N) => {
    k(N), t(N);
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(J, { className: "tw-ms-1", children: h })
          ] }),
...
function io({
  ...
  var N;
  const [w, p] = B([]), [c, g] = B([]), [b, h] = B({}), [f, k] = B({}), S = On({
    data: e,
    columns: t,
    getCoreRowModel: zn(),
...
function ri({ id: t, label: e, groups: n }) {
  const [a, o] = B(
    ...
    i((h) => (h[c] = g, { ...h }));
    const b = n[c].items.find((h) => h.id === g);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(me, { children: [
    ...
    /* @__PURE__ */ r(ne, { children: n.map((c, g) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(Pn, { children: c.itemType === 0 ? /* @__PURE__ */ r(ce, { children: c.items.map((b, h) => /* @__PURE__ */ l("div", { children: [
        console.log("item", h, a[g][h]) ?? "",
        /* @__PURE__ */ r(
          en,
          {
            checked: a[g][h],
            onCheckedChange: () => w(g, h),
            children: b.label
          }
        )
      ] }, b.id)) }) : /* @__PURE__ */ r(
...
function co({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const p = new Date(w), c = new Date(o.getTime() - p.getTime()), g = c.getUTCFullYear() - 1970, b = c.getUTCMonth(), h = c.getUTCDate() - 1;
    let f = "";
    return g > 0 ? f = `${g.toString()} year${g === 1 ? "" : "s"} ago` : b > 0 ? f = `${b.toString()} month${b === 1 ? "" : "s"} ago` : h === 0 ? f = "today" : f = `${h.toString()} day${h === 1 ? "" : "s"} ago`, f;
  }
...
function uo({
  ...
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(ge, { open: b, onOpenChange: h, children: [
    /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ l(
      F,
      {
        variant: "ghost",
      ...
      return /* @__PURE__ */ l(le, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          F,
          {
            ...
            onClick: () => a(n.filter((k) => k !== h)),
            children: /* @__PURE__ */ r(Je, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (f = t.find((k) => k.value === h)) == null ? void 0 : f.label
      ] }, h);
...
function mi({
  ...
  const c = bt(n, "%webView_inventory_all%"), g = bt(n, "%webView_inventory_approved%"), b = bt(n, "%webView_inventory_unapproved%"), h = bt(n, "%webView_inventory_unknown%"), f = bt(n, "%webView_inventory_scope_currentBook%"), k = bt(n, "%webView_inventory_scope_chapter%"), S = bt(n, "%webView_inventory_scope_verse%"), N = bt(n, "%webView_inventory_filter_text%"), _ = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, M] = B(!1), [z, A] = B("all"), [mt, U] = B(""), [y, v] = B([]), I = q(() => t.length === 0 ? [] : vo(t, o, s), [t, o, s]), R = q(() => {
    if (x) return I;
    const T = [];
    return I.forEach((K) => {
        ...
        jt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l(At, { children: [
              ...
              /* @__PURE__ */ r(wt, { value: "unknown", children: h })
            ] })
          ]
        }
      ),
...
const nr = u.forwardRef(
  ({
    ...
    const [c, g] = u.useState(t), b = e ?? c, h = u.useCallback(
      (M) => {
        const z = typeof M == "function" ? M(b) : M;
        n ? n(z) : g(z);
      },
      [n, b]
    ), f = u.useCallback(() => h((M) => !M), [h]), k = b ? "expanded" : "collapsed", _ = W() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = u.useMemo(
      () => ({
        state: k,
        open: b,
        setOpen: h,
...
const Eo = St(
  ...
  ({
    ...
    const p = t ? $t : "button", { state: c } = Ee(), g = /* @__PURE__ */ r(
      p,
      {
        ref: w,
...
function Ao({
  ...
  const c = H(
    ...
    (h) => {
      const f = n.find((k) => k.projectId === h);
...
function fi({
  ...
  const [p, c] = B([]), [g, b] = B([{ id: Nt, desc: !1 }]), [h, f] = B({}), k = q(
  ...
  ct(() => {
    if (w) {
      ...
      if (v.length === 1) {
        const I = k.find((R) => Sn(R) === v[0]) || void 0;
        I && w(I);
      }
    }
  }, [h, k, w, N]);
  ...
  }, mt = (y, v) => y.getIsGrouped() ? "" : d("banded-row", v % 2 === 0 ? "even" : "odd"), U = (y, v, I) => {
    if (!((y == null ? void 0 : y.length) === 0 || v.depth < I.column.getGroupedIndex())) {
      if (v.getIsGrouped())
        switch (v.depth) {
          case 1:
            return "tw-ps-4";
...
function Ko({
  ...
  const z = q(() => O.allBookIds.filter(
    ...
    (v) => {
      const I = mn(z, v).map((R) => R);
      n(
        cr(z, v, e) ? e.filter((R) => !I.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...I])]
      );
    },
    [e, n, z]
  ), U = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
        ...
        ve,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              ...
              /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: y, children: c })
            ] }),
            /* @__PURE__ */ l(ye, { children: [
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var I;
        return /* @__PURE__ */ r(le, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((I = o.get(v)) == null ? void 0 : I.localizedName) || O.bookIdToEnglishName(v) || v }, v);
      }),
...
function bi({
  ...
  const p = Vt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), b = Vt(i, "%webView_scope_selector_current_book%"), h = Vt(i, "%webView_scope_selector_choose_books%"), f = Vt(i, "%webView_scope_selector_scope%"), k = Vt(i, "%webView_scope_selector_select_books%"), S = [
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (k = s.current) == null || k.focus(), Kt(s, [h, f]);
        break;
      case "alt+l":
        (S = i.current) == null || S.focus(), Kt(i, [h, f]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), Kt(w, [h, f]);
        break;
      case "alt+h":
        (_ = p.current) == null || _.focus(), Kt(p, [h, f]);
        break;
    }
  }), ct(() => {
...
function Ti({
  ...
  const p = ns(
    ...
    o && o(f), a && a([f, ...n.filter((k) => k !== f)]), s && n.find((k) => k === f) && s([...n.filter((k) => k !== f)]), g(!1);
  }, h = (f, k) => {
    var N, _, x, M, z, A;
      ...
      jt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((f) => /* @__PURE__ */ r(wt, { value: f, children: h(f, e) }, f))
            }
          )
        ]
      }
