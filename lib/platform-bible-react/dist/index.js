...
import { c as b, g as Re, a as zr, C as Ge, L as Un, u as Jo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as Ie, f as ke, h as ze, i as kr, j as Be, B as Z, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ke, r as Ce, o as xs, p as Kn, P as tr, q as _r, s as er, t as rr, v as Na, w as Ca, y as No, z as ar, E as Ea, F as Mt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as pr, W as ys, X as Je, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as qn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Gn, aa as Ta, ab as Cs, ac as Yn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as Wn, al as Xn, am as Do, an as Os, ao as Zn, ap as Ba, aq as tn, ar as ja, as as Is, at as zs, au as Ps, av as As, aw as $s, ax as Fr, ay as Mo, az as Vs, aA as Ls } from "./resizable-BUC6I0Lc.js";
import { aB as af, aC as of, aD as nf, aE as sf, aF as cf, aG as lf, aH as df, aI as wf, aJ as uf, aK as pf, aL as hf, aM as gf, aN as ff, aO as mf, aP as vf, aQ as bf, aR as xf, aS as yf, aT as kf, aU as _f, aV as Nf, aW as Cf, aX as Ef, aY as Tf, aZ as Sf, a_ as Rf, a$ as Df, b0 as Mf, b1 as Of, b2 as If, b3 as zf, b4 as Pf, b5 as Af, b6 as $f, b7 as Vf, b8 as Lf, b9 as Bf, ba as jf, bb as Ff, bc as Uf } from "./resizable-BUC6I0Lc.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Jn, ChevronDown as Qe, ArrowLeft as Bs, ArrowRight as js, BoldIcon as Fs, ItalicIcon as Us, X as Oo, AtSign as Qn, Pencil as Ks, Trash2 as Hs, ArrowUp as ti, MoreHorizontal as qs, MailOpen as Gs, Mail as Ys, FilterIcon as Ws, ArrowLeftIcon as Xs, ChevronLeftIcon as Zs, ChevronRightIcon as Js, ArrowRightIcon as Qs, Copy as ei, Filter as tc, User as ec, Link as rc, CircleHelp as ac, Undo as oc, Redo as nc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as ic, AlertCircle as so, CircleCheckIcon as sc, CircleXIcon as cc, CircleHelpIcon as lc, ArrowUpIcon as dc, ArrowDownIcon as wc, ScrollText as uc, ChevronRight as pc, ChevronLeft as hc, ChevronsUpDown as gc, MenuIcon as fc, Menu as mc, EllipsisVertical as vc, MoreVertical as bc } from "lucide-react";
...
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Sa, useState as _, useEffect as W, useCallback as j, useId as co, useImperativeHandle as Mc, useLayoutEffect as Zt, Fragment as Kr, Component as Oc, createElement as cn, Suspense as Ic, forwardRef as ii } from "react";
...
import { Avatar as $o, Select as Jt, Checkbox as un, Slot as qr, Tabs as fe, Menubar as Ee, ContextMenu as Ft, Progress as pn, Slider as Qr, Switch as hn } from "radix-ui";
...
function Ha({
  ...
  const T = Ce(), B = Ql(), [z, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    void 0
  ), [ot, dt] = _(void 0), [St, J] = _(!1), [lt, vt] = _(!1), [pt, It] = _(!1), [Ht, wt] = _(!1), me = F(null), oe = F(!1), bt = F(void 0), gt = F(void 0), xt = F(void 0), qt = F(void 0), Rt = F({}), Nt = F({}), ft = j(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (v) => {
      ...
      if ((N === "chapters" || N === "verses") && (v.key === " " || v.key === "Enter")) {
        ...
        const de = (() => {
          if (N === "verses") {
            const Rr = q, Zo = ot, La = ta(M);
            return !Rr || !Zo || La === void 0 ? void 0 : {
              isDisabled: cr(Rr, Zo)(La),
              activate: () => R(La)
            };
          }
          const Gt = O, he = Ir(M);
    ...
    (H || at) && (v.preventDefault(), tt((yt) => yt + v.key), (Kt = gt.current) == null || Kt.focus(), J(!1));
  }, []);
  Zt(() => {
    const v = setTimeout(() => {
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bd = Di ? Zt : W, ra = { tag: zo };
...
const yd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
...
const Td = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
function Sd(t) {
...
function Vd(t) {
  ...
  return Xc(Zc(s)), t.getLatest();
}
function Ld(t, e, r) {
  let o = ln(e, "next");
  for (let n = o; n; n = Jc(n, r)) o = n;
...
const Jd = ue({ config: or({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = Zd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const Uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
...
const gw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
function fw({ onClear: t }) {
  const [e] = Te();
  return gw(() => Ai(e, t), [e, t]), null;
}
const Hi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
    ...
    "div",
    {
      ...
      children: [
        ...
        P && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(qs, {}) }) }),
...
function rs({
  ...
  const [U, tt] = _(zn), [N, rt] = _(), [O, I] = _(), q = o, [it, ot] = _(!1), [dt, St] = _(!1), [J, lt] = _(!1), [vt, pt] = _(!1), [It, Ht] = _(!1), [wt, me] = _(E), [oe, bt] = _(!1), gt = F(void 0), [xt, qt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let y = !0;
    return (async () => {
      const $ = k ? await k(l) : !1;
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    ...
                    /* @__PURE__ */ u(tr, { open: J, onOpenChange: lt, children: [
...
function ge({
  ...
  return /* @__PURE__ */ u(
    Jt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Jt.ItemIndicator, { children: /* @__PURE__ */ a(Ra, { className: "tw:pointer-events-none" }) }) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(Z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ a(ei, {}) })
        ] }),
...
function su({
  ...
  return /* @__PURE__ */ u(Ie, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: iu(t, o, e) }) }) }),
...
function du({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: cu(t, r) }) }) }),
...
function Nh({
  ...
  const [g, S] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, J] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
  ...
  const ie = () => {
    ...
    if (m.current && gt.length && R && R.rangeCount > 0) {
      ...
      dt(K.left - X.left), J(K.top - X.top), vt(K.height), it(!0);
    }
  }, [gt, m]), kt = F(() => {
  }), ve = j(
    (R, K, X) => {
...
function zh({
  ...
  const f = xe(r, "%webView_inventory_all%"), m = xe(r, "%webView_inventory_approved%"), x = xe(r, "%webView_inventory_unapproved%"), g = xe(r, "%webView_inventory_unknown%"), S = xe(r, "%webView_inventory_scope_currentBook%"), k = xe(r, "%webView_inventory_scope_chapter%"), C = xe(r, "%webView_inventory_scope_verse%"), E = xe(r, "%webView_inventory_filter_text%"), P = xe(
    ...
    const J = t ?? [];
    return J.length === 0 ? [] : Ru(J, n, s);
  }, [t, n, s]), O = V(() => {
    if (B) return rt;
    const J = [];
    return rt.forEach((lt) => {
      const vt = lt.items[0], pt = J.find(
        (It) => It.items[0] === vt
      );
      pt ? (pt.count += lt.count, pt.occurrences = pt.occurrences.concat(lt.occurrences)) : J.push({
        items: [vt],
        count: lt.count,
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(vr, { onValueChange: (J) => ot(J), defaultValue: i, children: [
...
const Ve = "scrBook", ju = "scrRef", Ze = "source", Fu = "details", Uu = "Scripture Reference", Ku = "Scripture Book", ns = "Type", Hu = "Details";
function qu(t, e) {
  const r = e ?? !1;
  return [
    {
        ...
        return /* @__PURE__ */ a(
          je,
          {
            ...
            children: D.getVisibleCells().map((U) => {
              if (!(U.getIsPlaceholder() || U.column.columnDef.enableGrouping && !U.getIsGrouped() && (U.column.columnDef.id !== Ze || !r)))
                return /* @__PURE__ */ a(
                  hr,
                  {
                    className: b(
              ...
              rr,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(Z, { variant: "ghost", size: "sm", onClick: U, children: w })
                  ] }),
      ...
      ao,
      {
        ...
        children: /* @__PURE__ */ u(Ba, { container: Se, children: [
          ...
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(Z, { variant: "outline", onClick: () => dr(!1), children: dt }),
            /* @__PURE__ */ a(Z, { onClick: Xr, children: ot })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && ce && /* @__PURE__ */ a(ro, { open: K === "range", onOpenChange: dr, children: /* @__PURE__ */ a(
      ao,
      {
        ...
        children: /* @__PURE__ */ u(Ba, { container: sr, children: [
          ...
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(Z, { variant: "outline", onClick: () => dr(!1), children: dt }),
            /* @__PURE__ */ a(Z, { ref: ie, onClick: Xr, children: ot })
          ] })
        ] })
      }
    ) })
...
function ko({
  ...
  return /* @__PURE__ */ u(Ie, { variant: s, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(Z, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(fc, {}) }) }),
...
export {
  ...
  $f as Z_INDEX_NESTED_MODAL_BACKDROP,
