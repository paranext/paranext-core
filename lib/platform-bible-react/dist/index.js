...
var Rt = (t, e, n) => Oi(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as at } from "react/jsx-runtime";
import N, { forwardRef as pn, useRef as G, useMemo as z, useState as I, useCallback as K, useLayoutEffect as Lt, createContext as An, useContext as kr, useEffect as q, Component as Ai, createElement as Wr, Suspense as Pi, Fragment as Do } from "react";
import { Command as It } from "cmdk";
import { X as Be, Search as Io, Check as Bt, Clock as Jr, ChevronsLeft as Zr, ChevronsRight as Qr, ChevronLeft as or, ChevronRight as Ft, ArrowLeft as Li, ArrowRight as $i, Circle as Pn, ChevronDown as Ke, BoldIcon as Vi, ItalicIcon as ji, AtSign as Mo, Pencil as Fi, Trash2 as zi, ArrowUp as _r, MoreHorizontal as Oo, MailOpen as Bi, Mail as Ki, ChevronUp as Ao, FilterIcon as Ui, ArrowLeftIcon as Gi, ChevronLeftIcon as qi, ChevronRightIcon as Hi, ArrowRightIcon as Yi, Copy as Po, Filter as Xi, User as Wi, Link as Ji, CircleHelp as Zi, ChevronsUpDown as Lo, Star as Qi, Undo as ts, Redo as es, SquareX as $o, FunctionSquare as Vo, SquareSigma as jo, Ban as ns, AlertCircle as ar, CircleCheckIcon as rs, CircleXIcon as os, CircleHelpIcon as as, ArrowUpIcon as is, ArrowDownIcon as ss, PanelLeft as ls, PanelRight as cs, ScrollText as ws, MenuIcon as ds, Menu as ps, EllipsisVertical as us, GripVertical as ms, MoreVertical as to, LoaderCircle as fs } from "lucide-react";
...
import { includes as fn, Section as Q, getChaptersForBook as bs, formatScrRef as Ce, getSectionForBook as nn, formatRelativeDate as vs, formatReplacementString as _e, sanitizeHtml as xs, NumberFormat as ys, formatBytes as Ns, getCurrentLocale as ks, usfmMarkers as xn, getFormatCallerFunction as _s, deepEqual as Cs, isString as eo, compareScrRefs as ir, scrRefToBBBCCCVVV as Kn, getLocalizeKeyForScrollGroupId as nt } from "platform-bible-utils";
...
import { createEditor as zo, $getRoot as ce, $createParagraphNode as Ge, $getSelection as Dt, HISTORY_MERGE_TAG as Cr, ParagraphNode as Bo, TextNode as Ko, $isTokenOrSegmented as Es, $getCharacterOffsets as Ts, $cloneWithPropertiesEphemeral as Rs, $getPreviousSelection as Ss, $isRangeSelection as Wt, $caretFromPoint as Ds, $getSiblingCaret as Uo, $getChildCaret as Is, $getAdjacentChildCaret as Ms, $isChildCaret as Os, $normalizeCaret as As, $setSelectionFromCaretRange as Ps, $getCollapsedCaretRange as Ls, $getCaretInDirection as no, $splitAtPointCaretNext as $s, $isTextPointCaret as Vs, $findMatchingParent as Go, $isElementNode as ie, mergeRegister as we, getDOMTextNode as js, isHTMLElement as qo, CLEAR_EDITOR_COMMAND as Ho, COMMAND_PRIORITY_EDITOR as Er, shallowMergeConfig as Fs, defineExtension as $t, safeCast as Me, createState as zs, FORMAT_TEXT_COMMAND as Yo, $isNodeSelection as Xo, COMMAND_PRIORITY_LOW as Wo, RootNode as Bs, LineBreakNode as Ks, TabNode as Us, $isEditorState as Gs, createCommand as qs, CLICK_COMMAND as Hs, isDOMNode as Ys, $getNodeFromDOMNode as Xs, $createNodeSelection as Ws, $setSelection as Js, $getEditor as Zs, DecoratorNode as sr, $getState as Qs, toggleTextFormatType as ro, TEXT_TYPE_TO_FORMAT as tl, $setState as el, addClassNamesToElement as Jo, $create as nl, $getNodeByKey as rl, removeClassNamesFromElement as ol, KEY_TAB_COMMAND as al, $isBlockElementNode as kn, $createRangeSelection as il, $normalizeSelection__EXPERIMENTAL as sl, OUTDENT_CONTENT_COMMAND as ll, INDENT_CONTENT_COMMAND as oo, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as Tr, $isDecoratorNode as wl, $isParagraphNode as dl, $isTextNode as _n, SELECTION_CHANGE_COMMAND as Zo, getRegisteredNode as pl, isDocumentFragment as ao, isDOMDocumentNode as ul, ArtificialNode__DO_NOT_USE as Qo, $createLineBreakNode as ta, $isRootOrShadowRoot as ml, isBlockDomNode as io, isInlineDomNode as so, $insertNodes as fl } from "lexical";
...
import { useReactTable as oa, getFilteredRowModel as _l, getSortedRowModel as aa, getPaginationRowModel as Cl, getCoreRowModel as ia, flexRender as rn, getGroupedRowModel as El, getExpandedRowModel as Tl } from "@tanstack/react-table";
...
const Ol = gs({ prefix: "tw-" });
function g(...t) {
  return Ol(hs(t));
}
const He = 250, sa = 300, Al = 400, Pl = 450, la = 500, Ll = "layoutDirection";
function gt() {
  const t = localStorage.getItem(Ll);
  return t === "rtl" ? t : "ltr";
}
const $l = At.Root, lu = At.Trigger, Vl = At.Portal, cu = At.Close, ca = N.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  At.Overlay,
  {
    ref: o,
    className: g(
...
const wa = N.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, s) => {
  const i = gt();
...
const pa = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  At.Title,
  {
    ref: n,
...
const Fl = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  At.Description,
  {
    ref: n,
...
const pe = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  It,
  {
    ref: n,
    className: g(
...
const Ye = N.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
...
const ue = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  It.List,
  {
    ref: n,
...
const un = N.forwardRef((t, e) => /* @__PURE__ */ r(It.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
un.displayName = It.Empty.displayName;
const Jt = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  It.Group,
  {
    ref: n,
    className: g(
...
const Sr = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  It.Separator,
  {
    ref: n,
...
const te = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  It.Item,
  {
    ref: n,
    className: g(
...
function Ir(t, e, n) {
  ...
  if (!o) return !1;
  const a = ht.bookIdToEnglishName(t), s = n == null ? void 0 : n.get(t);
...
const ha = pn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ue : "button", { className: g(ga({ variant: e, size: n, className: t })), ref: s, ...a })
);
U.displayName = "Button";
const me = Ve.Root, xe = Ve.Trigger, Bl = Ve.Anchor, ee = N.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = gt();
...
function Kl({
  ...
  return /* @__PURE__ */ p(me, { open: d, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(ee, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: /* @__PURE__ */ r(Jt, { heading: s, children: t.map((f) => /* @__PURE__ */ p(
      te,
      {
        onSelect: () => m(f),
...
function wu(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
      ...
      if (i) {
        ...
        if (!d && c) {
          const f = ((h) => Object.keys(Ee).find(
            (y) => Ee[y].toLowerCase() === h.toLowerCase()
          ))(l);
...
function co({
  ...
  if (t)
    return /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r("div", { className: g("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Xt(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      te,
      {
        value: `${t} ${Ee[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function du({
  ...
  const w = gt(), [d, u] = I(!1), [m, f] = I(""), [h, y] = I(""), [x, b] = I("books"), [v, k] = I(void 0), [_, $] = I(!1), j = G(void 0), O = G(void 0), R = G(void 0), E = G(void 0), T = G({}), V = K(
    (L) => {
      e(L), l && l(L);
    },
    [e, l]
    ...
    (L) => {
      const S = x === "chapters" ? v : P == null ? void 0 : P.book;
      S && (V({
        book: S,
        chapterNum: L,
        verseNum: 1
      }), u(!1), b("books"), k(void 0), y(""));
    },
    [V, x, v, P]
  ), it = K(
    (L) => {
    ...
    (L) => {
      ...
      if (x === "chapters") {
        ...
        if (S || F) {
          if (L.preventDefault(), L.stopPropagation(), b("books"), k(void 0), F && v) {
            const Y = Ee[v];
            y(`${Y} ${L.key}`);
          } else
            y(L.key);
      ...
      if ((x === "chapters" || x === "books" && P) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(L.key)) {
        const Y = x === "chapters" ? v : P == null ? void 0 : P.book;
        if (!Y) return;
        const X = (() => {
          if (!m) return 1;
          const mt = m.match(/(\d+)$/);
    ...
    const { isLetter: S, isDigit: F } = lo(L.key);
    (S || F) && (L.preventDefault(), y((Y) => Y + L.key), O.current.focus(), $(!1));
  }, []);
  return Lt(() => {
    const L = setTimeout(() => {
      if (d && x === "books" && R.current && E.current) {
  ...
  }, [x, v, P, t.book, t.chapterNum]), /* @__PURE__ */ p(me, { open: d, onOpenChange: H, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
      U,
      {
          ...
          x === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              U,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(Li, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r($i, { className: "tw-h-4 tw-w-4" })
              }
            ),
            v && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Le(v, a) })
          ] }),
          !_ && /* @__PURE__ */ p(ue, { ref: R, children: [
...
), yt = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Fo.Root, { ref: n, className: g("pr-twp", Hl(), t), ...e }));
yt.displayName = Fo.Root.displayName;
const Mr = N.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
  return /* @__PURE__ */ r(
    sn.Root,
    {
...
const Cn = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  sn.Item,
  {
    ref: n,
    className: g(
...
function mr({
  ...
  const [k, _] = I(!1), $ = w ?? c, j = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], O = (R, E) => {
    const T = c(R), V = typeof R == "object" && "secondaryLabel" in R ? R.secondaryLabel : void 0, C = `${E ?? ""}${T}${V ?? ""}`;
    return /* @__PURE__ */ p(
      te,
      {
        value: T,
  ...
  return /* @__PURE__ */ p(me, { open: k, onOpenChange: _, ...v, children: [
    ...
    Mr,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(yt, { className: "tw-flex tw-items-center", children: o.map((x) => ht.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            U,
            {
...
function Zl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = Wl(null, o), d = zo({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (u) => i(u, d), theme: o });
    return function(u, m) {
      if (m !== null) {
        if (m === void 0) u.update(() => {
          ...
          if (f.isEmpty()) {
            const h = Ge();
            f.append(h);
            const y = va ? document.activeElement : null;
            (Dt() !== null || y !== null && y === u.getRootElement()) && h.select();
          }
        }, gn);
...
function tc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return Ql(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: c }) => {
      e && s.size === 0 && i.size === 0 || t && c.has(Cr) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const Or = {
  ...
  mark: "",
  markOverlap: ""
}, bt = Re.Provider, Nt = Re.Root, kt = N.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Re.Trigger,
  {
    ref: o,
...
const vt = N.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(Re.Portal, { children: /* @__PURE__ */ r(
  Re.Content,
  {
    ref: a,
    sideOffset: e,
...
function sc() {
  return function(t) {
    const [e] = ne(), n = z(() => t(e), [e, t]), [o, a] = I(() => n.initialValueFn()), s = G(o);
    return ac(() => {
...
function lc(t, e) {
  ...
  for (let w = 0; w < c; w++) {
    const d = i[w], u = l && l.top <= d.top && l.top + l.height > d.top && l.left + l.width > d.left, m = d.width + s === o.width;
    u || m ? (i.splice(w--, 1), c--) : l = d;
  }
  return i;
}
function cc(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Es(e) && o !== null) {
    ...
    if (w || d) {
      const [u, m] = Ts(t), f = l.is(c), h = e.is(i ? c : l), y = e.is(i ? l : c);
      let x, b = 0;
      f ? (b = u > m ? m : u, x = u > m ? u : m) : h ? (b = i ? m : u, x = void 0) : y && (b = 0, x = i ? u : m);
      const v = e.__text.slice(b, x);
      v !== e.__text && (n === "clone" && (e = Rs(e)), e.__text = v);
    }
  }
  return e;
}
...
function pc(t, e, n) {
  ...
  function c() {
    ...
    var h, y;
    l.isConnected || (y = l, (h = a).insertBefore(y, h.firstChild));
    let x = !1;
    for (let b = 0; b < f.length; b++) {
      const v = f[b], k = i[b] || document.createElement("div"), _ = k.style;
      _.position !== "absolute" && (_.position = "absolute", x = !0);
      const $ = Yt(v.left - u);
      _.left !== $ && (_.left = $, x = !0);
      const j = Yt(v.top - m);
      _.top !== j && (k.style.top = j, x = !0);
      const O = Yt(v.width);
      _.width !== O && (k.style.width = O, x = !0);
      const R = Yt(v.height);
      _.height !== R && (k.style.height = R, x = !0), k.parentNode !== l && (l.append(k), x = !0), i[b] = k;
    }
  ...
  const d = t.registerRootListener(function u() {
    ...
    if (!qo(f)) return w();
    w(), o = m, a = f, s = new MutationObserver((h) => {
      const y = t.getRootElement(), x = y && y.parentElement;
      if (y !== o || x !== a) return u();
      for (const b of h) if (!l.contains(b.target)) return c();
    }), s.observe(f, dc), c();
  });
  return () => {
    d(), w();
...
function mc(t, e = uc) {
  ...
  function w(d) {
    d.read(() => {
      const u = Dt();
      if (!Wt(u)) return n = null, a = null, s = null, l = null, c(), void (c = () => {
      });
      const [m, f] = function(R) {
        const E = R.getStartEndPoints();
        return R.isBackward() ? [E[1], E[0]] : E;
      }(u), h = m.getNode(), y = h.getKey(), x = m.offset, b = f.getNode(), v = b.getKey(), k = f.offset, _ = t.getElementByKey(y), $ = t.getElementByKey(v), j = n === null || _ !== o || x !== a || y !== n.getKey(), O = s === null || $ !== i || k !== l || v !== s.getKey();
      if ((j || O) && _ !== null && $ !== null) {
        const R = function(E, T, V, C, D, A, W) {
          const P = (E._window ? E._window.document : document).createRange();
          return P.setStart(...wo(T, V, C)), P.setEnd(...wo(D, A, W)), P;
        }(t, m, h, _, f, b, $);
        c(), c = pc(t, R, e);
      }
      n = h, o = _, a = x, s = b, i = $, l = k;
    });
  }
...
function fc(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? n !== null && (n(), n = null) : n === null && (n = mc(t, e));
  };
...
function hc(t) {
  const e = Go(t, (n) => ie(n) && !n.isInline());
  return ie(e) || En(4, t.__key), e;
}
function gc(t) {
  const e = Dt() || Ss();
  let n;
  if (Wt(e)) n = Ds(e.focus, "next");
    ...
    n = n || Is(ce(), "previous").getFlipped().insert(Ge());
  }
  const o = bc(t, n), a = Ms(o), s = Os(a) ? As(a) : o;
  return Ps(Ls(s)), t.getLatest();
}
function bc(t, e, n) {
  let o = no(e, "next");
  for (let a = o; a; a = $s(a, n)) o = a;
  return Vs(o) && En(283), o.insert(t.isInline() ? Ge().append(t) : t), no(Uo(t.getLatest(), "next"), e.direction);
}
function vc(t) {
  const e = Dt();
  if (!Wt(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Go(s, (w) => ie(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
let Tn, se = 0, Rn = 0, Nc = 0, hr = 0, yn = 0;
function uo(t) {
  if (et === void 0) return;
  let e = t.n;
...
St.prototype.brand = xc, St.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      se !== 0 && Rn === 0 && e.l !== hr && (e.l = hr, Tn = { S: e, v: e.v, i: e.i, o: Tn });
    })(this), this.v = t, this.i++, yn++, se++;
    try {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ka(this), mo(this), se++;
  const t = et;
...
const Hn = zs("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ea extends sr {
  $config() {
    return this.config("decorator-text", { extends: sr, stateConfigs: [{ flat: !0, stateConfig: Hn }] });
  }
  getFormat() {
    return Qs(this, Hn);
  }
...
$t({ name: "@lexical/extension/DecoratorText", nodes: () => [Ea], register: (t, e, n) => t.registerCommand(Yo, (o) => {
  const a = Dt();
  if (Xo(a) || Wt(a)) for (const s of a.getNodes()) Ec(s) && s.toggleFormat(o);
  return !1;
}, Wo) });
function Ta(t, e) {
  let n;
...
class Sc {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Fs;
  ...
  register(e, n) {
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== Qe && ot(309, String(o.id), String(Qe)), this.state = function(i) {
...
}, name: "@lexical/extension/InitialState", nodes: [Bs, Ko, Ks, Us, Bo] }), ho = Symbol.for("@lexical/extension/LexicalBuilder");
function go() {
}
function Mc(t) {
  throw t;
...
class $e {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && ot(298, o.name), !a) {
      ...
      typeof s == "string" && ot(299, o.name, s);
      for (const i of o.conflictsWith || []) this.extensionNameMap.has(i) && ot(299, o.name, i), this.conflicts.set(i, o.name);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Wn(s) || ot(300, i, a || "[unknown]"), Wn(l = s) || ot(304, String(l.id), String(Lr)), s = Object.assign(l, { id: br }), o.state = s;
...
const Oc = /* @__PURE__ */ new Set(), bo = $t({ build(t, e, n) {
  const o = n.getDependency(gr).output, a = ln({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Ta(() => {
  }, () => Zt(() => {
    ...
    o.value.read(() => {
      if (Dt()) for (const [d, u] of l.entries()) {
        ...
        w = w || f !== (!!i && i.has(d)), f && (c = c || /* @__PURE__ */ new Set(), c.add(d));
      }
    }), !w && c && i && c.size === i.size || (s.value = c);
  }));
  return { watchNodeKey: function(i) {
    const l = kc(() => (s.value || Oc).has(i)), { watchedNodeKeys: c } = a.peek();
    let w = c.get(i);
    const d = w !== void 0;
    return w = w || /* @__PURE__ */ new Set(), w.add(l), d || (c.set(i, w), a.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [gr], name: "@lexical/extension/NodeSelection" }), Ac = qs("INSERT_HORIZONTAL_RULE_COMMAND");
class je extends sr {
  static getType() {
...
$t({ dependencies: [gr, bo], name: "@lexical/extension/HorizontalRule", nodes: () => [je], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(bo).output, a = ln({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return we(t.registerCommand(Ac, (i) => {
    const l = Dt();
    if (!Wt(l)) return !1;
    ...
    return !0;
  }, Er), t.registerCommand(Hs, (i) => {
    if (Ys(i.target)) {
      const l = Xs(i.target);
      if (Lc(l)) return function(c, w = !1) {
        const d = Dt(), u = c.isSelected(), m = c.getKey();
        let f;
        w && Xo(d) ? f = d : (f = Ws(), Js(f)), u ? f.delete(m) : f.add(m);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Wo), t.registerMutationListener(je, (i, l) => {
    yc(() => {
      let c = !1;
      const { nodeSelections: w } = a.peek();
      for (const [d, u] of i.entries()) if (u === "destroyed") w.delete(d), c = !0;
      else {
...
function $c(t, e, n = Ia) {
  return we(t.registerCommand(al, (o) => {
    ...
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((m) => kn(m) && m.canIndent()).length > 0) return !0;
      const l = i.anchor, c = i.focus, w = c.isBefore(l) ? c : l, d = w.getNode(), u = hc(d);
      if (u.canIndent()) {
        const m = u.getKey();
        let f = il();
        if (f.anchor.set(m, 0, "element"), f.focus.set(m, 0, "element"), f = sl(f), f.anchor.is(w)) return !0;
      }
      return !1;
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Wt(h)) {
                const y = h.anchor;
                let x = y.getNode(), b = 0, v = 0;
                if (_n(x) && w >= 0 && d >= 0 && (b = w, v = w + d, h.setTextNodeRange(x, b, x, v)), b === v && u === "" || (h.insertRawText(u), x = y.getNode()), _n(x)) {
                  b = m, v = m + f;
                  const k = x.getTextContentSize();
                  b = b > k ? k : b, v = v > k ? k : v, h.setTextNodeRange(x, b, x, v);
                }
  ...
  return function(n, o) {
    ...
    return Vr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], d = r(o, { onError: (m) => n._onError(m), children: r(Pi, { fallback: null, children: a[w] }) }), u = n.getElementByKey(w);
        u !== null && i.push(yl(d, u, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function Wc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: u, ariaRequired: m, autoCapitalize: f, className: h, id: y, role: x = "textbox", spellCheck: b = !0, style: v, tabIndex: k, "data-testid": _, ...$ }, j) {
  const [O, R] = I(t.isEditable()), E = K((V) => {
    V && V.ownerDocument && V.ownerDocument.defaultView ? t.setRootElement(V) : t.setRootElement(null);
  }, [t]), T = z(() => /* @__PURE__ */ function(...V) {
    return (C) => {
      for (const D of V) typeof D == "function" ? D(C) : D != null && (D.current = C);
    };
  }(j, E), [E, j]);
  return Aa(() => (R(t.isEditable()), t.registerEditableListener((V) => {
    R(V);
  })), [t]), r("div", { "aria-activedescendant": O ? e : void 0, "aria-autocomplete": O ? n : "none", "aria-controls": O ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": O && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": d, "aria-owns": O ? u : void 0, "aria-readonly": !O || void 0, "aria-required": m, autoCapitalize: f, className: h, contentEditable: O, "data-testid": _, id: y, ref: T, role: x, spellCheck: b, style: v, tabIndex: k, ...$ });
}
const Jc = pn(Wc);
function xo(t) {
  return t.getEditorState().read(Ma(t.isComposing()));
...
function nw({
  ...
  return /* @__PURE__ */ r(Pa.Provider, { value: i, children: s });
}
function La() {
  const t = kr(Pa);
  if (!t)
...
function rw() {
  const [t, e] = I(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r($l, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(wa, { children: [
      /* @__PURE__ */ r(da, { children: /* @__PURE__ */ r(pa, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = K(
    (s, i, l = !1) => {
...
function ow({
  ...
  const [e] = ne(), [n, o] = I(e), [a, s] = I("paragraph"), [i, l] = rw(), c = () => {
  };
...
), iw = N.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  ea.Root,
  {
    ref: a,
...
iw.displayName = ea.Root.displayName;
const Va = N.createContext({
  size: "default",
  variant: "default"
}), jr = N.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = gt();
  return /* @__PURE__ */ r(
    Ln.Root,
    {
...
const an = N.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = N.useContext(Va);
  return /* @__PURE__ */ r(
    Ln.Item,
    {
      ref: s,
...
const yo = [
  ...
  { format: "italic", icon: ji, label: "Italic" }
...
function cw({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(ow, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(sw, {}) }) }),
...
function ja(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && _n(e) && (i = cc(o, e, "clone"));
  const l = ie(i) ? i.getChildren() : [], c = pl(t, i.getType());
  let w;
  ...
  for (let f = 0; f < l.length; f++) {
    const h = l[f], y = ja(t, h, m, o);
    !a && ie(e) && y && e.extractWithChild(h, o, "html") && (a = !0);
  }
  if (a && !s) {
...
function za(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (Fa.has(t.nodeName)) return i;
  let l = null;
  const c = function(h, y) {
    const { nodeName: x } = h, b = y._htmlConversions.get(x.toLowerCase());
    let v = null;
    if (b !== void 0) for (const k of b) {
      const _ = k(h);
  ...
  return d != null && (m = d(m)), io(t) && (m = uw(t, m, f ? () => {
    const h = new Qo();
    return n.push(h), h;
  } : Ge)), l == null ? m.length > 0 ? i = i.concat(m) : io(t) && function(h) {
    return h.nextSibling == null || h.previousSibling == null ? !1 : so(h.nextSibling) && so(h.previousSibling);
  }(t) && (i = i.concat(ta())) : ie(l) && l.append(...m), i;
}
function uw(t, e, n) {
...
function fu({
  ...
  const [a, s] = I(fw), [i, l] = I(void 0), [c, w] = I(!1), d = G(void 0), u = G(null);
  q(() => {
    let b = !0;
    const v = u.current;
    if (!v) return;
  ...
  const m = K(() => {
    ...
    const b = Dn(a);
    e(b, i);
  }, [a, e, i]), f = o["%commentEditor_placeholder%"] ?? "Type your comment here...", h = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", y = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", x = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
          ...
          /* @__PURE__ */ r(vt, { children: /* @__PURE__ */ r("p", { children: y }) })
        ] }) }),
        /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(me, { open: c, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ r(
        ee,
        {
          ...
          children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: t.map((b) => /* @__PURE__ */ r(
            te,
            {
              onSelect: () => {
                l(b === "" ? void 0 : b), w(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), n()) : zr(b) && (b.preventDefault(), b.stopPropagation(), jt(a) && m());
        },
        onKeyDown: (b) => {
          Fr(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          Sn,
          {
...
const hu = Object.freeze([
  ...
  const a = G(null), [s, i] = I(void 0), [l, c] = I(void 0), w = K(
    (f) => {
      i(f);
      const h = t.find((x) => x.id === f);
      h && (e == null || e(h));
      const y = document.getElementById(f);
      y && (y.scrollIntoView({ block: "center" }), y.focus()), a.current && a.current.setAttribute("aria-activedescendant", f);
    },
    [e, t]
  ), d = K(
    (f) => {
      const h = t.find((y) => y.id === f);
      h && (c((y) => y === f ? void 0 : f), n == null || n(h));
    },
    [n, t]
  ), u = (f) => {
    if (!f) return !1;
    ...
    const y = f.getAttribute("role");
    if (y && gw.includes(y)) return !0;
    const x = f.getAttribute("tabindex");
    return x !== void 0 && x !== "-1";
  }, m = K(
    (f) => {
      var O;
      const h = f.target, y = (R) => R ? document.getElementById(R) : void 0, x = y(l), b = y(s);
      if (!!(x && h && x.contains(h) && h !== x) && u(h)) {
      ...
      const _ = t.findIndex((R) => R.id === s);
      let $ = _;
      switch (f.key) {
        case "ArrowDown":
          $ = Math.min(_ + 1, t.length - 1), f.preventDefault();
          break;
        case "ArrowUp":
          $ = Math.max(_ - 1, 0), f.preventDefault();
          break;
        case "Home":
          $ = 0, f.preventDefault();
          break;
        ...
        case " ":
        case "Enter":
          s && d(s), f.preventDefault(), f.stopPropagation();
          return;
        case "ArrowRight": {
          const R = b;
          if (R) {
...
const yw = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: g("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const zt = N.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  ra.Root,
  {
    ref: a,
    decorative: n,
...
const qa = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  qe.Root,
  {
    ref: n,
    className: g(
...
const kw = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  qe.Image,
  {
    ref: n,
...
const Ha = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  qe.Fallback,
  {
    ref: n,
    className: g(
...
}), be = st.Trigger, Ya = st.Group, _w = st.Portal, Cw = st.Sub, Ew = st.RadioGroup;
function de({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Kr.Provider, { value: n, children: /* @__PURE__ */ r(st.Root, { ...e }) });
}
const Xa = N.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ut();
  return /* @__PURE__ */ p(
    st.SubTrigger,
    {
...
Xa.displayName = st.SubTrigger.displayName;
const Wa = N.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = gt();
  return /* @__PURE__ */ r(
    st.SubContent,
    {
...
Wa.displayName = st.SubContent.displayName;
const Qt = N.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = gt();
...
Qt.displayName = st.Content.displayName;
const In = N.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = gt(), s = Ut();
  return /* @__PURE__ */ r(
    st.Item,
    {
...
In.displayName = st.Item.displayName;
const le = N.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = gt(), i = Ut();
  return /* @__PURE__ */ p(
    st.CheckboxItem,
    {
      ...
      dir: s,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(st.ItemIndicator, { children: /* @__PURE__ */ r(Bt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
le.displayName = st.CheckboxItem.displayName;
const Ja = N.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = gt(), s = Ut();
  return /* @__PURE__ */ p(
    st.RadioItem,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(st.ItemIndicator, { children: /* @__PURE__ */ r(Pn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Ja.displayName = st.RadioItem.displayName;
const mn = N.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  st.Label,
  {
    ref: o,
...
mn.displayName = st.Label.displayName;
const We = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  st.Separator,
  {
    ref: n,
...
We.displayName = st.Separator.displayName;
...
function No({
  ...
  const f = K(
    (_) => {
      _ && _.stopPropagation(), w(!1), u(void 0), i == null || i(!1);
    },
    [i]
  ), h = K(
    async (_) => {
      ...
      await a(
        t.id,
        Dn(d)
      ) && (w(!1), u(void 0), i == null || i(!1));
    },
    [d, a, t.id, i]
  ), y = z(() => {
    const _ = new Date(t.date), $ = vs(
      _,
  ...
  }, [t.date, n]), x = z(() => t.user, [t.user]), b = z(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), v = z(() => xs(t.contents), [t.contents]), k = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(at, { children: [
        /* @__PURE__ */ p(
          In,
          {
            onClick: (_) => {
              _.stopPropagation(), w(!0), u(mw(t.contents)), i == null || i(!0);
            },
            children: [
              /* @__PURE__ */ r(Fi, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(qa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Ha, { className: "tw-text-xs tw-font-medium", children: b }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: m,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), f()) : zr(_) && (_.preventDefault(), _.stopPropagation(), jt(d) && h());
              },
              onKeyDown: (_) => {
                Fr(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
...
function Rw({
  ...
  const [O, R] = I(ko), [E, T] = I(
    void 0
  ), V = o, [C, D] = I(!1), [A, W] = I(!1), [P, tt] = I(!1), [Et, B] = I(!1), [it, J] = I(!1), [Z, H] = I(_), [wt, dt] = I(!1), ut = G(void 0), [Tt, re] = I(/* @__PURE__ */ new Map());
  q(() => {
    let M = !0;
    return (async () => {
      const xt = v ? await v(c) : !1;
      M && J(xt);
    })(), () => {
      M = !1;
    };
  ...
  }, [s, n]), F = z(() => Gt.slice(1), [Gt]), Y = z(() => F.length ?? 0, [F.length]), X = z(() => Y > 0, [Y]), pt = z(() => C || Y <= 2 ? F : F.slice(-2), [F, Y, C]), rt = z(() => C || Y <= 2 ? 0 : Y - 2, [Y, C]), _t = z(
            ...
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              ...
              /* @__PURE__ */ r(
                U,
                {
                  ...
                  children: Z ? /* @__PURE__ */ r(Bi, {}) : /* @__PURE__ */ r(Ki, {})
                }
              ),
                      ...
                      /* @__PURE__ */ p(me, { open: P, onOpenChange: tt, children: [
                        /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
                          U,
                          {
                            ...
                            variant: "outline",
                            className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                            disabled: !Et || !y || y.length === 0 || !y.includes(i),
                        ...
                        /* @__PURE__ */ r(
                          ee,
                          {
                            ...
                            children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: y == null ? void 0 : y.map((M) => /* @__PURE__ */ r(
                              te,
                              {
                                onSelect: () => {
                                  T(M !== s ? M : void 0), tt(!1);
...
function bu({
  ...
  const [b, v] = I(/* @__PURE__ */ new Set()), [k, _] = I();
  q(() => {
    h && (v((D) => new Set(D).add(h)), _(h));
  }, [h]);
  const $ = n.filter(
    (D) => D.comments.some((A) => !A.deleted)
  ), j = $.map((D) => ({ id: D.id })), O = K(
    (D) => {
      v((A) => new Set(A).add(D.id)), _(D.id), y == null || y(D.id);
    },
    [y]
  ), R = K(
    (D) => {
      ...
      }), _(D), y == null || y(A ? void 0 : D);
    },
    [b, y]
  ), { listboxRef: E, activeId: T, handleKeyDown: V } = Br({
    options: j,
    onOptionSelect: O
  }), C = K(
    (D) => {
      D.key === "Escape" ? (k && b.has(k) && (v((A) => {
        const W = new Set(A);
        return W.delete(k), W;
      }), _(void 0), y == null || y(void 0)), D.preventDefault(), D.stopPropagation()) : V(D);
    },
    [k, b, V, y]
  );
  return /* @__PURE__ */ r(
...
function Sw({ table: t }) {
  return /* @__PURE__ */ p(de, { children: [
    /* @__PURE__ */ r(kl, { asChild: !0, children: /* @__PURE__ */ p(U, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Ui, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
), De = N.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = gt();
  return /* @__PURE__ */ p(
    ft.Trigger,
    {
...
const Za = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.ScrollUpButton,
  {
    ref: n,
...
const Ie = N.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = gt();
...
const Mw = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Label,
  {
    ref: n,
...
const Pt = N.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ft.Item,
  {
    ref: o,
    className: g(
...
const Ow = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Separator,
  {
    ref: n,
    className: g("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
const Vn = N.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
  ...
  N.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        cn(i, '[tabindex]:not([tabindex="-1"])').forEach((d) => {
...
const jn = N.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: g(
...
const Fn = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: g("[&_tr:last-child]:tw-border-0", t), ...e }));
Fn.displayName = "TableBody";
const Lw = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? cn(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
const ae = N.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  const i = N.useRef(null);
  N.useEffect(() => {
    typeof s == "function" ? s(i.current) : s && "current" in s && (s.current = i.current);
  }, [s]), $w(i);
  const l = N.useMemo(
    () => i.current ? cn(i.current) : [],
    [i]
  ), c = N.useCallback(
    (d) => {
      const { current: u } = i;
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        ...
        d.preventDefault(), Vw(l, y, d.key);
      else if (d.key === "Escape") {
        d.preventDefault();
        const x = u.closest("table");
        x && x.focus();
      }
      e == null || e(d);
    },
...
const wn = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "th",
  {
    ref: n,
    className: g(
...
const Fw = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function zw({
  ...
  var j;
  const [d, u] = I([]), [m, f] = I([]), [h, y] = I({}), [x, b] = I({}), v = z(() => e ?? [], [e]), k = oa({
    data: v,
    columns: t,
    getCoreRowModel: ia(),
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((E, T) => `skeleton-row-${T}`).map((E) => /* @__PURE__ */ r(ae, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Te, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dn, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? $ = k.getRowModel().rows.map((O) => /* @__PURE__ */ r(
    ae,
    {
      onClick: () => i(O, k),
    ...
    O.id
  )) : $ = /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ r(Te, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Sw, { table: k }),
    /* @__PURE__ */ p(Vn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(jn, { stickyHeader: s, children: k.getHeaderGroups().map((O) => /* @__PURE__ */ r(ae, { children: O.headers.map((R) => /* @__PURE__ */ r(wn, { className: "tw-p-0", children: R.isPlaceholder ? void 0 : rn(R.column.columnDef.header, R.getContext()) }, R.id)) }, O.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(U, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Po, {}) })
        ] }),
...
function yu({
  ...
  return /* @__PURE__ */ p(me, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(ee, { id: s, className: g("tw-min-w-80 tw-max-w-96", a), children: [
      i && n["%webView_error_dump_copied_message%"] && /* @__PURE__ */ r(yt, { children: n["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ r(
        Kw,
        {
          errorDetails: t,
...
function qw({
  ...
  const [b, v] = I(!1), k = K(
    (T) => {
      var C;
      const V = (C = t.find((D) => D.label === T)) == null ? void 0 : C.value;
      V && n(
    ...
    if (!m) return t;
    const T = t.filter((C) => C.starred).sort((C, D) => C.label.localeCompare(D.label)), V = t.filter((C) => !C.starred).sort((C, D) => {
  ...
  return /* @__PURE__ */ r("div", { id: x, className: h, children: /* @__PURE__ */ p(me, { open: R, onOpenChange: d ?? v, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ p(
      U,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(pe, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: j, children: s }),
        /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: O, children: i })
      ] }),
      /* @__PURE__ */ p(ue, { children: [
        /* @__PURE__ */ r(un, { children: l }),
        /* @__PURE__ */ r(Jt, { children: $.map((T) => /* @__PURE__ */ p(
          te,
          {
            value: T.label,
            onSelect: k,
            ...
            children: [
              ...
              T.starred && /* @__PURE__ */ r(Qi, { className: "tw-h-4 tw-w-4" }),
...
function Jw({
  ...
  const s = G(null), i = G(null), l = G(!1), [c, w] = I(t), [d, u] = I(n), [m, f] = I(!1);
  q(() => {
    w(t);
  }, [t]), q(() => {
    d !== n && u(n);
  ...
  const h = (x) => {
    l.current = !1, f(x), x || (c !== "custom" || d ? (e(c), o(d)) : (w(t), u(n)));
  }, y = (x) => {
    var b, v, k, _;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((b = s.current) == null || b.focus(), l.current = !0) : document.activeElement === s.current && x.key === "ArrowUp" ? ((v = i.current) == null || v.focus(), l.current = !1) : document.activeElement === s.current && x.key === "ArrowLeft" && ((k = s.current) == null ? void 0 : k.selectionStart) === 0 && ((_ = i.current) == null || _.focus(), l.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && h(!1);
  };
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            le,
            {
              ...
              onClick: (x) => {
                var b;
                x.stopPropagation(), l.current = !0, (b = s.current) == null || b.focus();
              },
...
function td({
  ...
  return /* @__PURE__ */ p(de, { children: [
    ...
    /* @__PURE__ */ p(Qt, { style: { zIndex: sa }, children: [
  ...
  return /* @__PURE__ */ p(pe, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(ue, { children: [
      ...
      i.length > 0 && /* @__PURE__ */ p(at, { children: [
        s.length > 0 && /* @__PURE__ */ r(Sr, { alwaysRender: !0 }),
...
function Eu({
  ...
  const [h, y] = I("generated"), [x, b] = I("*"), [v, k] = I("f"), [_, $] = I(!1), [j, O] = I(!0), [R, E] = I(!1), T = G(!1), V = G(""), [C, D] = I(!1), [A, W] = I(), [P, tt] = I(), [Et, B] = I(), [it, J] = I(), Z = G(null), H = z(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...i.view ?? Sl(), noteMode: "expanded" }
    }),
    [i, l]
  ), wt = z(
    () => od(
  ...
  q(() => {
    ...
    if (F && hn("note", F)) {
      ...
      let rt = "custom";
      pt === lr ? rt = "generated" : pt === cr ? rt = "hidden" : pt && b(pt), y(rt), k(((X = F.insert.note) == null ? void 0 : X.style) ?? "f"), S = setTimeout(() => {
        var _t;
  ...
  const dt = K(
    (S, F, Y = !1) => {
      ...
      if (X && hn("note", X)) {
        ...
        n == null || n([X]), Y && w && s && ((_t = w.current) == null || _t.replaceEmbedUpdate(s, [X]));
      }
    },
    [s, n, w]
  ), ut = K(() => {
  ...
  const Gt = () => {
    ...
    if (F && hn("note", F)) {
      ...
      v !== "x" && S === "x" ? mt == null || mt.forEach((Ot) => ad(Ot)) : v === "x" && S !== "x" && (mt == null || mt.forEach((Ot) => id(Ot))), (_t = d.current) == null || _t.applyUpdate([F, { delete: 1 }]);
    }
  }, oe = (S) => {
    ...
    (S) => {
      ...
      if (F && hn("note", F)) {
        ...
        if (mt || $(!1), $(
          ...
          T.current = !0, V.current = JSON.stringify(F), O(!0);
          return;
        }
        O(JSON.stringify(F) === V.current), dt(h, x);
      } else
        $(!1), O(!0);
    },
    [h, x, dt]
...
function wd({
  ...
  /* @__PURE__ */ p("span", { className: g("note-caller tw-inline-block", { formatted: s }), children: [
    a,
    " "
  ] }), u = i && /* @__PURE__ */ p(at, { children: [
    Ur(t.marker, [i], o, !1),
    " "
  ] }), m = e === "horizontal" ? "horizontal" : "vertical", f = o ? "marker-visible" : "", h = e === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", y = g(m, f);
  return /* @__PURE__ */ p(at, { children: [
    /* @__PURE__ */ p("div", { className: g("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: [
      c,
      d
    ] }),
    /* @__PURE__ */ r("div", { className: g("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: u }),
    /* @__PURE__ */ r(
      "div",
      {
        className: g(
...
function Ru({
  ...
  const d = c ?? _s(n, void 0), u = (v, k) => {
    w == null || w(v, k, a);
  }, m = s ? n.findIndex((v) => v === s) : -1, [f, h] = I(m), y = (v, k, _) => {
    if (n.length)
      switch (v.key) {
        case "Enter":
        case " ":
          v.preventDefault(), w == null || w(k, _, a);
          break;
      }
  }, x = (v) => {
    if (n.length)
      switch (v.key) {
        case "ArrowDown":
          v.preventDefault(), h((k) => Math.min(k + 1, n.length - 1));
          break;
        case "ArrowUp":
          v.preventDefault(), h((k) => Math.max(k - 1, 0));
          break;
      }
  }, b = G([]);
  return q(() => {
    var v;
    f >= 0 && f < b.current.length && ((v = b.current[f]) == null || v.focus());
  }, [f]), /* @__PURE__ */ r(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((v, k) => {
            ...
            return /* @__PURE__ */ p(at, { children: [
              ...
              k < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(zt, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function pd({
  ...
  return /* @__PURE__ */ p(Vn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(jn, { stickyHeader: !0, children: /* @__PURE__ */ p(ae, { children: [
      ...
      /* @__PURE__ */ r(wn, { children: s })
    ] }) }),
    /* @__PURE__ */ r(Fn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      ae,
      {
        onClick: () => {
          e(l.reference);
...
const Gr = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wr.Root,
  {
    ref: n,
    className: g(
...
const ud = (t) => {
  ...
  accessorKey: "status",
  header: ({ column: s }) => zn(s, t, "tw-justify-center"),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ p(jr, { value: i, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        an,
        {
          onClick: (c) => {
...
function Lu({
  ...
  const f = Ht(n, "%webView_inventory_all%"), h = Ht(n, "%webView_inventory_approved%"), y = Ht(n, "%webView_inventory_unapproved%"), x = Ht(n, "%webView_inventory_unknown%"), b = Ht(n, "%webView_inventory_scope_currentBook%"), v = Ht(n, "%webView_inventory_scope_chapter%"), k = Ht(n, "%webView_inventory_scope_verse%"), _ = Ht(n, "%webView_inventory_filter_text%"), $ = Ht(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Ht(n, "%webView_inventory_no_results%"), [O, R] = I(!1), [E, T] = I("all"), [V, C] = I(""), [D, A] = I([]), W = z(() => {
    const H = t ?? [];
    return H.length === 0 ? [] : gd(H, a, s);
  }, [t, a, s]), P = z(() => {
    if (O) return W;
    const H = [];
    return W.forEach((wt) => {
  ...
  }, [O, W]), tt = z(() => P.length === 0 ? [] : hd(P, E, V), [P, E, V]), Et = z(() => {
    var dt, ut;
    if (!O) return c;
        ...
        Fe,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ p(Ie, { children: [
              ...
              /* @__PURE__ */ r(Pt, { value: "unapproved", children: y }),
              /* @__PURE__ */ r(Pt, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(Fe, { onValueChange: (H) => it(H), defaultValue: i, children: [
        /* @__PURE__ */ r(De, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(ze, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Ie, { children: [
          /* @__PURE__ */ r(Pt, { value: "book", children: b }),
          /* @__PURE__ */ r(Pt, { value: "chapter", children: v }),
...
const bd = "16rem", vd = "3rem", ei = N.createContext(void 0);
function Bn() {
  const t = N.useContext(ei);
  if (!t)
...
const ni = N.forwardRef(
  ({
    ...
    const [w, d] = N.useState(t), u = e ?? w, m = N.useCallback(
      (k) => {
        const _ = typeof k == "function" ? k(u) : k;
        n ? n(_) : d(_);
      },
      [n, u]
    ), f = N.useCallback(() => m((k) => !k), [m]), h = u ? "expanded" : "collapsed", b = gt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", v = N.useMemo(
      () => ({
        state: h,
        open: u,
        setOpen: m,
    ...
    return /* @__PURE__ */ r(ei.Provider, { value: v, children: /* @__PURE__ */ r(bt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
ni.displayName = "SidebarProvider";
const ri = N.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Bn();
...
ri.displayName = "Sidebar";
const xd = N.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Bn();
  return /* @__PURE__ */ p(
    U,
    {
...
oi.displayName = "SidebarInset";
const Nd = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Je,
  {
    ref: n,
    "data-sidebar": "input",
...
const Cd = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt,
  {
    ref: n,
...
const xr = N.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ue : "div",
  {
    ref: o,
...
const Ed = N.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ue : "button",
  {
    ref: o,
...
ii.displayName = "SidebarMenu";
const si = N.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "li",
    {
      ref: n,
  ...
  ({
    ...
    const c = t ? Ue : "button", { state: w } = Bn(), d = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: g(Td({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Rd = N.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ue : "button",
  {
    ref: a,
...
const Dd = N.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
  const a = N.useMemo(() => `${Math.floor(Math.random() * 40) + 50}%`, []);
  return /* @__PURE__ */ p(
    "div",
    {
      ref: o,
...
const Md = N.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Md.displayName = "SidebarMenuSubItem";
const Od = N.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ue : "a",
  {
    ref: s,
...
function Ad({
  ...
  return /* @__PURE__ */ r(
    ri,
    {
      ...
      children: /* @__PURE__ */ p(ai, { children: [
        /* @__PURE__ */ p(vr, { children: [
          /* @__PURE__ */ r(xr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(yr, { children: /* @__PURE__ */ r(ii, { children: Object.entries(e).map(([m, f]) => /* @__PURE__ */ r(si, { children: /* @__PURE__ */ r(
            li,
            {
              onClick: () => w(m),
              isActive: u(m),
...
const qr = pn(
  ({ value: t, onSearch: e, placeholder: n, isFullWidth: o, className: a, isDisabled: s = !1, id: i }, l) => {
    const c = gt();
    return /* @__PURE__ */ p("div", { id: i, className: g("tw-relative", { "tw-w-full": o }, a), children: [
      /* @__PURE__ */ r(
        Io,
        {
          className: g(
    ...
    /* @__PURE__ */ p(
      ni,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(oi, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const ge = "scrBook", Pd = "scrRef", ke = "source", Ld = "details", $d = "Scripture Reference", Vd = "Scripture Book", ci = "Type", jd = "Details";
function Fd(t, e) {
  const n = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: ke,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? ci : void 0,
...
const zd = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || ir(t.start, t.end) === 0 ? `${Kn(t.start)}+${e}` : `${Kn(t.start)}+${e}-${Kn(t.end)}+${n}`;
...
function Vu({
  ...
  const [w, d] = I([]), [u, m] = I([{ id: ge, desc: !1 }]), [f, h] = I({}), y = z(
  ...
  q(() => {
    if (l) {
      const E = b.getSelectedRowModel().rowsById, T = Object.keys(E);
      if (T.length === 1) {
        const V = y.find((C) => Ro(C) === T[0]) || void 0;
        V && l(V);
      }
    }
  }, [f, y, l, b]);
  const v = a ?? Vd, k = s ?? ci, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${v}`, value: [ge] },
  ...
  }, O = (E, T) => E.getIsGrouped() ? "" : g("banded-row", T % 2 === 0 ? "even" : "odd"), R = (E, T, V) => {
    if (!((E == null ? void 0 : E.length) === 0 || T.depth < V.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ p(
      Fe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ie, { position: "item-aligned", children: /* @__PURE__ */ r(Dw, { children: _.map((E) => /* @__PURE__ */ r(Pt, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Vn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(jn, { children: b.getHeaderGroups().map((E) => /* @__PURE__ */ r(ae, { children: E.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ r(Fn, { children: b.getRowModel().rows.map((E, T) => {
        const V = gt();
        return /* @__PURE__ */ r(
          ae,
          {
                    ...
                    children: C.getIsGrouped() ? /* @__PURE__ */ p(
                      U,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ r(Ft, {}) : /* @__PURE__ */ r(or, {})),
                          " ",
...
}), wi = (t, e, n) => Hr(t, e).every((o) => n.includes(o));
function Bd({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    U,
    {
      ...
      onClick: () => o(t),
      className: g(
        wi(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: zl(
        t,
...
function Kd({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], u = o["%webView_book_selector_more%"], { otLong: m, ntLong: f, dcLong: h, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, b] = I(!1), [v, k] = I(""), _ = G(void 0), $ = G(!1);
  ...
  const j = z(() => ht.allBookIds.filter(
    ...
    (A, W = !1) => {
      ...
      const P = j.findIndex((J) => J === _.current), tt = j.findIndex((J) => J === A);
      if (P === -1 || tt === -1) return;
      const [Et, B] = [
        Math.min(P, tt),
        Math.max(P, tt)
      ], it = j.slice(Et, B + 1).map((J) => J);
      n(
        e.includes(A) ? e.filter((J) => !it.includes(J)) : [.../* @__PURE__ */ new Set([...e, ...it])]
      );
    },
    [e, n, j]
  ), E = (A) => {
    R(A, $.current), $.current = !1;
  }, T = (A, W) => {
    ...
    (A) => {
      ...
      n(
        wi(j, A, e) ? e.filter((P) => !W.includes(P)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), C = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ee, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ p(
            pe,
            {
              shouldFilter: !1,
              onKeyDown: (A) => {
                A.key === "Enter" && ($.current = A.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Ye,
...
function Fu({
  ...
  const w = ye(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), m = ye(i, "%webView_scope_selector_current_book%"), f = ye(i, "%webView_scope_selector_choose_books%"), h = ye(i, "%webView_scope_selector_scope%"), y = ye(i, "%webView_scope_selector_select_books%"), x = [
  ...
  ], b = e ? x.filter((v) => e.includes(v.value)) : x;
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Mr,
        {
          ...
          children: b.map(({ value: v, label: k, id: _ }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Cn, { className: "tw-me-2", value: v, id: _ }),
            /* @__PURE__ */ r(yt, { htmlFor: _, children: k })
          ] }, _))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(yt, { children: y }),
      /* @__PURE__ */ r(
        Kd,
        {
          availableBookInfo: o,
...
function zu({
  ...
  return /* @__PURE__ */ p(
    Fe,
    {
      ...
      children: [
        /* @__PURE__ */ r(De, { size: a, className: g("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          ze,
          {
...
const pi = (t, e, n, o) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ p(Nt, { children: [
  /* @__PURE__ */ r(kt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r(_w, { children: /* @__PURE__ */ r(Wa, { children: pi(
      t,
      e,
      di(t, l.id),
      o
...
function Nr({
  ...
  return /* @__PURE__ */ p(de, { variant: s, children: [
    /* @__PURE__ */ r(be, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(U, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(ds, {}) }) }),
    /* @__PURE__ */ r(Qt, { align: "start", style: { zIndex: He }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(Do, { children: [
      /* @__PURE__ */ r(Ya, { children: /* @__PURE__ */ r(bt, { children: pi(e.groups, e.items, c, t) }) }),
...
function Gu({
  ...
  return /* @__PURE__ */ p(ui, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      Nr,
      {
        onSelectMenuItem: t,
    ...
    i && /* @__PURE__ */ r("div", { className: "tw-flex tw-h-full tw-shrink tw-grow-[1] tw-flex-row tw-flex-wrap tw-items-start tw-gap-x-1 tw-gap-y-2 tw-overflow-clip", children: i }),
...
function qu({
  ...
  return /* @__PURE__ */ r(ui, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    Nr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const mi = N.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
  return /* @__PURE__ */ r(
    Mt.Root,
    {
...
mi.displayName = Mt.List.displayName;
const fi = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.List,
  {
    ref: n,
    className: g(
...
fi.displayName = Mt.List.displayName;
const Ud = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Trigger,
  {
    ref: n,
    ...e,
...
)), hi = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Content,
  {
    ref: n,
    className: g(
...
function Hu({
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(mi, { children: [
      /* @__PURE__ */ r(fi, { children: t.map((l) => /* @__PURE__ */ r(Ud, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(hi, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Gd({ ...t }) {
...
const gi = N.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = N.useMemo(
    () => ({
      variant: e
    }),
...
gi.displayName = lt.Root.displayName;
const bi = N.forwardRef(({ className: t, ...e }, n) => {
  const o = Ut();
  return /* @__PURE__ */ r(
    lt.Trigger,
    {
...
bi.displayName = lt.Trigger.displayName;
const vi = N.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ut();
  return /* @__PURE__ */ p(
    lt.SubTrigger,
    {
      ...
      className: g(
        ...
        e && "tw-pl-8",
        fe({ variant: s.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...o,
...
vi.displayName = lt.SubTrigger.displayName;
const xi = N.forwardRef(({ className: t, ...e }, n) => {
  const o = Ut();
  return /* @__PURE__ */ r(
    lt.SubContent,
    {
...
xi.displayName = lt.SubContent.displayName;
const yi = N.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Ut();
...
yi.displayName = lt.Content.displayName;
const Ni = N.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Ut();
  return /* @__PURE__ */ r(
    lt.Item,
    {
...
Ni.displayName = lt.Item.displayName;
const Hd = N.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Ut();
  return /* @__PURE__ */ p(
    lt.CheckboxItem,
    {
...
const Yd = N.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ut();
  return /* @__PURE__ */ p(
    lt.RadioItem,
    {
...
const Xd = N.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  lt.Label,
  {
    ref: o,
    className: g("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
const ki = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  lt.Separator,
  {
    ref: n,
    className: g("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
ki.displayName = lt.Separator.displayName;
const tn = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, d) => w.order - d.order).map((w) => /* @__PURE__ */ p(Nt, { children: [
      /* @__PURE__ */ r(kt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ p(
        ...
        /* @__PURE__ */ r(vi, { children: w.label }),
        /* @__PURE__ */ r(xi, { children: _i(
          t,
          e,
          di(t, w.id),
          o
    ...
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ r(ki, {}, `separator-${s}`)), c;
  });
};
function Wd({
  menuData: t,
  ...
  const a = G(void 0), s = G(void 0), i = G(void 0), l = G(void 0), c = G(void 0), w = (d) => {
    switch (d) {
      case "platform.app":
        return s;
  ...
  if (Il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, u) => {
    ...
    switch (u.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (h = s.current) == null || h.focus(), tn(s, [m, f]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), tn(i, [m, f]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), tn(l, [m, f]);
        break;
      case "alt+h":
        (b = c.current) == null || b.focus(), tn(c, [m, f]);
        break;
    }
  }), q(() => {
    ...
    const d = new MutationObserver((f) => {
      f.forEach((h) => {
        if (h.attributeName === "data-state" && h.target instanceof HTMLElement) {
          const y = h.target.getAttribute("data-state");
          n(y === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(gi, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, u]) => typeof d == "boolean" || typeof u == "boolean" ? 0 : d.order - u.order).map(([d, u]) => /* @__PURE__ */ p(Gd, { children: [
      /* @__PURE__ */ r(bi, { ref: w(d), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        yi,
        {
          style: { zIndex: He },
          children: /* @__PURE__ */ r(bt, { children: _i(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
...
function Wu({
  ...
  const w = Jd(
    ...
    a && a(h), o && o([h, ...n.filter((y) => y !== h)]), s && n.find((y) => y === h) && s([...n.filter((y) => y !== h)]), u(!1);
  }, f = (h, y) => {
    var b, v, k, _, $, j;
    const x = y !== h ? ((v = (b = t[h]) == null ? void 0 : b.uiNames) == null ? void 0 : v[y]) ?? ((_ = (k = t[h]) == null ? void 0 : k.uiNames) == null ? void 0 : _.en) : void 0;
    return x ? `${($ = t[h]) == null ? void 0 : $.autonym} (${x})` : (j = t[h]) == null ? void 0 : j.autonym;
  };
...
function Ei({
  ...
  return /* @__PURE__ */ r(
    Rr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(ms, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Yr({
  ...
  onItemClick: o,
  selectedItemId: a,
  emptyStateMessage: s = "No items found",
  isLoading: i = !1,
  variant: l = "text",
  ...
  const [m, f] = I(), h = G(null), y = a ?? m, x = z(
    () => m ? t.find((C) => C.id === m) : void 0,
    [m, t]
  ), b = z(() => t.map((C) => ({ id: C.id })), [t]), v = (C) => {
    o == null || o(C), n && f(C.id === m ? void 0 : C.id);
  }, k = (C) => {
    const D = t.find((A) => A.id === C.id);
    D && v(D);
  }, { listboxRef: _, activeId: $, handleKeyDown: j, focusOption: O } = Br({
    options: b,
    onOptionSelect: k,
    onCharacterPress: d
  }), R = () => {
      ...
      children: t.map((C) => {
        ...
        return /* @__PURE__ */ r(
          "li",
          {
            ...
            onClick: () => v(C),
            onKeyDown: (A) => {
              (A.key === "Enter" || A.key === " ") && (A.preventDefault(), v(C));
            },
            className: g(
  ...
  return /* @__PURE__ */ r("div", { ref: h, className: g("tw-relative tw-flex tw-h-full tw-overflow-hidden", u), children: V ? (
    ...
    /* @__PURE__ */ p(Ci, { direction: "horizontal", className: "tw-h-full tw-w-full", children: [
    ...
    Yr,
    {
      ...
      renderItem: (i) => /* @__PURE__ */ r(
        Qd,
        {
          ...
          showSourceLanguage: o,
          showTransliteration: a,
          description: t == null ? void 0 : t(i),
          badges: e == null ? void 0 : e(i),
          occurrenceCount: n == null ? void 0 : n(i)
        }
      )
    }
  );
...
function Qd({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-0.5", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-baseline tw-gap-2", children: [
      ...
      s !== void 0 && /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
        /* @__PURE__ */ r(kt, { asChild: !0, children: /* @__PURE__ */ r("span", { className: "tw-ml-1 tw-cursor-help tw-rounded tw-bg-accent tw-px-1.5 tw-py-0.5 tw-text-xs", children: s }) }),
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2 tw-overflow-hidden", children: [
      ...
      a == null ? void 0 : a.map((i) => /* @__PURE__ */ r(
        "span",
        {
...
function Qu({
  ...
  const [m, f] = I(a), [h, y] = I(-1), x = G(null), b = G(null), [v, k] = I(!1), [_, $] = I(0);
  q(() => {
    const B = x.current;
    if (!B) return;
    ...
    return it.observe(B), () => it.disconnect();
  }, []);
  const j = _ > 0 ? tp / _ * 100 : 20, O = _ > 0 ? ep / _ * 100 : 30;
  q(() => {
    var B;
  ...
  const R = K(
    ...
    [w]
  ), E = t.find((B) => B.id === m), T = E && !v, V = E && v, C = K(
    (B) => {
    ...
    (B) => {
      ...
      const it = m ? t.findIndex((Z) => Z.id === m) : -1, J = h >= 0 ? h : it;
      if (B.key === "ArrowDown") {
        B.preventDefault();
        ...
        if (Z === h) return;
        y(Z), v || C(t[Z]);
      } else (B.key === "Enter" || B.key === " ") && v && h >= 0 && (B.preventDefault(), C(t[h]));
    },
    [t, h, v, C, m]
  ), A = K(() => {
    const B = m;
    if (f(void 0), B) {
      const it = t.findIndex((J) => J.id === B);
      it >= 0 && y(it), requestAnimationFrame(() => {
        var J;
        (J = b.current) == null || J.focus();
      });
    }
  }, [t, m]);
  q(() => {
    if (h < 0 || !b.current) return;
    const B = b.current.children[h];
  ...
  q(() => {
    var it;
    if (!v || !m) return;
    const B = (it = W.current) == null ? void 0 : it.querySelector("[data-back-to-list]");
    B == null || B.focus();
  }, [v, m]);
  const P = !!T;
  q(() => {
    var B;
    P && ((B = b.current) == null || B.focus());
  }, [P]);
  const Et = i ? /* @__PURE__ */ r("div", { className: "tw-p-4 tw-text-sm tw-text-muted-foreground", children: "Loading..." }) : t.length === 0 ? /* @__PURE__ */ r("div", { className: "tw-p-4 tw-text-sm tw-text-muted-foreground", children: s ?? "No items found" }) : /* @__PURE__ */ r(
    "ul",
    {
      ref: b,
      role: "listbox",
  ...
  return /* @__PURE__ */ p("div", { className: g("tw-flex tw-h-full tw-flex-col tw-overflow-hidden", u), children: [
    ...
    /* @__PURE__ */ r("div", { ref: x, className: "tw-relative tw-flex tw-flex-1 tw-overflow-hidden", children: np({
      showSideBySide: !!T,
      showFullDetail: !!V,
      listElement: Et,
...
function np({
  ...
  return t && o !== void 0 ? /* @__PURE__ */ p(Ci, { direction: "horizontal", children: [
    /* @__PURE__ */ r(On, { defaultSize: 33.3333, minSize: a, children: /* @__PURE__ */ r("div", { className: "tw-h-full tw-overflow-y-auto", children: n }) }),
    /* @__PURE__ */ r(Ei, {}),
    /* @__PURE__ */ r(On, { defaultSize: 66.6667, minSize: s, children: /* @__PURE__ */ r("div", { className: "tw-h-full tw-overflow-y-auto tw-bg-background tw-p-4", children: o }) })
...
function rp({
  ...
  var f, h, y;
  const o = G(null), a = G(null), [s, i] = I(0);
  q(() => {
    const x = o.current, b = a.current;
    if (!x || !b) return;
    const v = () => {
      const _ = x.clientWidth, $ = Array.from(b.children).filter(
        (T) => T instanceof HTMLElement
      );
      if ($.length === 0) return;
      if ($.reduce((T, V) => T + V.offsetWidth, 0) <= _ - 4) {
        i(0);
        return;
      }
      const O = $.map((T) => T.offsetWidth), R = t.length, E = 44;
      for (let T = 1; T < R; T += 1) {
        let V = E;
        if (T < R - 1) {
          V += O[0] ?? 0;
          for (let C = T + 1; C < R; C += 1) V += O[C] ?? 0;
        } else
          V += O[R - 1] ?? 0;
        if (V <= _ - 4) {
          i(T);
    ...
    return k.observe(x), v(), () => k.disconnect();
  }, [t]);
  const l = s > 0, c = s >= t.length - 1, d = l ? c ? t.slice(0, -1) : t.slice(1, s + 1) : [], u = d.map((x) => x.label).join(" > "), m = ((f = d[0]) == null ? void 0 : f.id) ?? ((h = t[0]) == null ? void 0 : h.id);
  return /* @__PURE__ */ p("div", { ref: o, className: "tw-overflow-hidden", children: [
    /* @__PURE__ */ r(
      "div",
      {
        ...
        "aria-hidden": !0,
        children: t.map((x, b) => /* @__PURE__ */ p("span", { className: "tw-flex tw-shrink-0 tw-items-center tw-gap-0.5", children: [
          b > 0 && /* @__PURE__ */ r(Ft, { className: "tw-h-3 tw-w-3" }),
          /* @__PURE__ */ r("span", { className: "tw-px-1.5 tw-py-1 tw-text-sm", children: x.label })
        ] }, x.id))
      }
    ),
        ...
        /* @__PURE__ */ r(bt, { delayDuration: 0, children: /* @__PURE__ */ p(Nt, { children: [
          /* @__PURE__ */ r(kt, { asChild: !0, children: /* @__PURE__ */ r("span", { children: /* @__PURE__ */ r(
            nr,
            {
              ...
              allDomains: e,
              currentPath: t,
              expandToId: m ?? ((y = t[0]) == null ? void 0 : y.id) ?? "",
              onDomainSelect: n,
              isEllipsis: !0
            }
          ) }) }),
    ...
    /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ r(
      "button",
      {
        ...
        className: g(
          ...
          i ? "tw-flex tw-items-center tw-px-1 tw-py-1" : "tw-px-1.5 tw-py-1",
          e && !i && "tw-font-bold"
        ),
        children: t
      }
...
function op({
  ...
  q(() => {
    const b = requestAnimationFrame(() => {
      var v;
      (v = i.current) == null || v.scrollIntoView({ block: "center" });
    });
    return () => cancelAnimationFrame(b);
  }, [n]);
  const l = () => s.current ? Array.from(s.current.querySelectorAll("button")) : [], c = (b) => {
    const v = l();
    if (v.length === 0) return;
    const k = document.activeElement;
    let $ = (k instanceof HTMLButtonElement ? v.indexOf(k) : -1) + b;
    $ < 0 && ($ = v.length - 1), $ >= v.length && ($ = 0), v[$].focus();
  }, w = (b) => {
    const v = l();
    v.length !== 0 && v[b === "first" ? 0 : v.length - 1].focus();
  }, d = (b) => {
    let v = b;
    for (; v && v !== s.current; ) {
      if (v instanceof HTMLLIElement && v.getAttribute("role") === "treeitem") return v;
      v = v.parentElement;
    }
  }, u = (b) => {
    if (!b) return;
    const v = b.querySelector(":scope > div > button");
    v == null || v.focus();
  }, m = (b) => {
    const v = b.querySelector(':scope > ul[role="group"]');
    return v ? Array.from(v.children).filter(
      (k) => k instanceof HTMLLIElement && k.getAttribute("role") === "treeitem"
    ) : [];
  }, f = (b) => {
    const v = b.parentElement;
    if (!(v instanceof HTMLUListElement) || v.getAttribute("role") !== "group") return;
    const k = v.parentElement;
    return k instanceof HTMLLIElement && k.getAttribute("role") === "treeitem" ? k : void 0;
  }, h = (b) => {
    const v = b.getAttribute("aria-expanded");
    if (v === "false") {
      const k = b.querySelector(":scope > div > button");
      k == null || k.click();
    } else if (v === "true") {
      const [k] = m(b);
      u(k);
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { ref: s, onKeyDown: (b) => {
      switch (b.key) {
        case "ArrowDown":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), c(1);
          break;
        case "ArrowUp":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), c(-1);
          break;
        case "ArrowRight": {
          const v = d(document.activeElement);
          if (!v) break;
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), h(v);
          break;
        }
        case "ArrowLeft": {
          const v = d(document.activeElement);
          if (!v) break;
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), y(v);
          break;
        }
        case "Home":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), w("first");
          break;
        case "End":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), w("last");
          break;
        case "Tab":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), c(b.shiftKey ? -1 : 1);
          break;
        case "Escape":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), a();
          break;
      }
    }, children: /* @__PURE__ */ r(
      Ri,
...
function Ti(t, e) {
  var n;
  return t.id === e ? !0 : ((n = t.children) == null ? void 0 : n.some((o) => Ti(o, e))) ?? !1;
}
function Ri({
  domains: t,
  currentPath: e,
  ...
  return /* @__PURE__ */ r(
    ...
    {
      role: i ? "tree" : "group",
      "aria-label": i ? "Semantic domain tree" : void 0,
      className: g("tw-space-y-0.5", { "tw-ml-3": a.length > 0 }),
      children: t.map((c) => {
        const w = [...a, c], d = c.id === n, u = c.children && c.children.length > 0, f = Ti(c, n) && c.id !== n, h = c.id === n;
        return /* @__PURE__ */ r(
          ap,
          {
            domain: c,
...
function ap({
  ...
  return /* @__PURE__ */ p(
    "li",
    {
      ...
      "aria-expanded": h,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-0.5", children: f ? (
...
function nm({
  ...
  return a ? /* @__PURE__ */ r("div", { className: g("tw-flex tw-flex-col tw-gap-2 tw-p-2", i), children: Array.from({ length: 6 }, (h, y) => /* @__PURE__ */ r(
    dn,
    {
  ...
  ) : /* @__PURE__ */ r("div", { className: g("tw-overflow-y-auto tw-px-2 tw-py-2", i), children: /* @__PURE__ */ r(
    "ul",
    {
      role: "listbox",
      tabIndex: 0,
            ...
            "li",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-mt-0.5 tw-flex tw-items-center tw-gap-2 tw-overflow-hidden", children: [
                  ...
                  h.strongsCodes.map((x) => /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
                    /* @__PURE__ */ r(kt, { asChild: !0, children: /* @__PURE__ */ r("span", { className: "tw-ml-1 tw-shrink-0 tw-cursor-help tw-rounded tw-bg-accent tw-px-1.5 tw-py-0.5 tw-text-xs", children: x }) }),
...
function ip({ item: t, createLabel: e, createComplexLabel: n }) {
...
const sp = pn(({ className: t, ...e }, n) => /* @__PURE__ */ r(fs, { size: 35, className: g("tw-animate-spin", t), ...e, ref: n }));
sp.displayName = "Spinner";
function am({
  id: t,
  isDisabled: e = !1,
  hasError: n = !1,
...
), cp = N.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const dp = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: g("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
dp.displayName = "AlertDescription";
const im = ct.Root, sm = ct.Trigger, lm = ct.Group, cm = ct.Portal, wm = ct.Sub, dm = ct.RadioGroup, pp = N.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ct.SubTrigger,
  {
    ref: a,
    className: g(
...
const up = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.SubContent,
  {
    ref: n,
    className: g(
...
const mp = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ct.Portal, { children: /* @__PURE__ */ r(
  ct.Content,
  {
    ref: n,
    className: g(
...
const fp = N.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ct.Item,
  {
    ref: o,
    className: g(
...
const hp = N.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ct.CheckboxItem,
  {
    ref: a,
    className: g(
...
const gp = N.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ct.RadioItem,
  {
    ref: o,
    className: g(
...
const bp = N.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ct.Label,
  {
    ref: o,
    className: g(
...
const vp = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Separator,
  {
    ref: n,
...
function yp({
  ...
  const o = N.useMemo(() => ({ direction: e }), [e]);
...
const pm = Kt.Trigger, Np = Kt.Portal, um = Kt.Close, Di = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Kt.Overlay,
  {
    ref: n,
...
const kp = N.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, container: o, ...a }, s) => {
  const { direction: i = "bottom" } = N.useContext(Si), l = o ? "tw-absolute" : "tw-fixed", c = {
...
const Ep = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Kt.Title,
  {
    ref: n,
    className: g("tw-text-lg tw-font-semibold tw-leading-none tw-tracking-tight", t),
...
const Tp = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Kt.Description,
  {
    ref: n,
    className: g("tw-text-sm tw-text-muted-foreground", t),
...
const Rp = N.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  dr.Root,
  {
    ref: o,
    className: g(
...
const Sp = N.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
  return /* @__PURE__ */ p(
    en.Root,
    {
...
const Dp = N.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
  return /* @__PURE__ */ r(
    pr.Root,
    {
...
const fm = Mt.Root, Ip = N.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
  return /* @__PURE__ */ r(
    Mt.List,
    {
...
const Mp = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Trigger,
  {
    ref: n,
    className: g(
...
const Op = N.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Content,
  {
    ref: n,
    className: g(
