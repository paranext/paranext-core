...
var Is = (t, e, n) => e in t ? Ds(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var Rt = (t, e, n) => Is(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as st } from "react/jsx-runtime";
import x, { forwardRef as pn, useRef as G, useMemo as z, useState as I, useCallback as K, useLayoutEffect as Lt, createContext as On, useContext as Nr, useEffect as q, Component as Ms, createElement as Xr, Suspense as Os, Fragment as Do } from "react";
import { Command as It } from "cmdk";
import { X as Be, Search as Io, Check as zt, Clock as Wr, ChevronsLeft as Jr, ChevronsRight as Zr, ChevronLeft as rr, ChevronRight as Xt, ArrowLeft as As, ArrowRight as Ps, Circle as An, ChevronDown as Ke, BoldIcon as Ls, ItalicIcon as $s, AtSign as Mo, Pencil as Vs, Trash2 as js, ArrowUp as kr, MoreHorizontal as Oo, MailOpen as Fs, Mail as zs, ChevronUp as Ao, FilterIcon as Bs, ArrowLeftIcon as Ks, ChevronLeftIcon as Us, ChevronRightIcon as Gs, ArrowRightIcon as qs, Copy as Po, Filter as Hs, User as Ys, Link as Xs, CircleHelp as Ws, ChevronsUpDown as Lo, Star as Js, Undo as Zs, Redo as Qs, SquareX as $o, FunctionSquare as Vo, SquareSigma as jo, Ban as ti, AlertCircle as or, CircleCheckIcon as ei, CircleXIcon as ni, CircleHelpIcon as ri, ArrowUpIcon as oi, ArrowDownIcon as ai, PanelLeft as si, PanelRight as ii, ScrollText as li, MenuIcon as ci, Menu as wi, EllipsisVertical as di, GripVertical as pi, MoreVertical as Qr, LoaderCircle as ui } from "lucide-react";
import { clsx as mi } from "clsx";
import { extendTailwindMerge as fi } from "tailwind-merge";
import * as At from "@radix-ui/react-dialog";
import { Canon as ht } from "@sillsdev/scripture";
import { includes as fn, Section as Q, getChaptersForBook as hi, formatScrRef as Ce, getSectionForBook as nn, formatRelativeDate as gi, formatReplacementString as _e, sanitizeHtml as bi, NumberFormat as vi, formatBytes as xi, getCurrentLocale as yi, usfmMarkers as xn, getFormatCallerFunction as Ni, deepEqual as ki, isString as to, compareScrRefs as ar, scrRefToBBBCCCVVV as Bn, getLocalizeKeyForScrollGroupId as nt } from "platform-bible-utils";
...
import { createEditor as zo, $getRoot as ce, $createParagraphNode as Ge, $getSelection as Dt, HISTORY_MERGE_TAG as _r, ParagraphNode as Bo, TextNode as Ko, $isTokenOrSegmented as _i, $getCharacterOffsets as Ci, $cloneWithPropertiesEphemeral as Ei, $getPreviousSelection as Ti, $isRangeSelection as Wt, $caretFromPoint as Ri, $getSiblingCaret as Uo, $getChildCaret as Si, $getAdjacentChildCaret as Di, $isChildCaret as Ii, $normalizeCaret as Mi, $setSelectionFromCaretRange as Oi, $getCollapsedCaretRange as Ai, $getCaretInDirection as eo, $splitAtPointCaretNext as Pi, $isTextPointCaret as Li, $findMatchingParent as Go, $isElementNode as se, mergeRegister as we, getDOMTextNode as $i, isHTMLElement as qo, CLEAR_EDITOR_COMMAND as Ho, COMMAND_PRIORITY_EDITOR as Cr, shallowMergeConfig as Vi, defineExtension as $t, safeCast as Me, createState as ji, FORMAT_TEXT_COMMAND as Yo, $isNodeSelection as Xo, COMMAND_PRIORITY_LOW as Wo, RootNode as Fi, LineBreakNode as zi, TabNode as Bi, $isEditorState as Ki, createCommand as Ui, CLICK_COMMAND as Gi, isDOMNode as qi, $getNodeFromDOMNode as Hi, $createNodeSelection as Yi, $setSelection as Xi, $getEditor as Wi, DecoratorNode as sr, $getState as Ji, toggleTextFormatType as no, TEXT_TYPE_TO_FORMAT as Zi, $setState as Qi, addClassNamesToElement as Jo, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as nl, KEY_TAB_COMMAND as rl, $isBlockElementNode as kn, $createRangeSelection as ol, $normalizeSelection__EXPERIMENTAL as al, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as ro, INSERT_TAB_COMMAND as il, COMMAND_PRIORITY_CRITICAL as Er, $isDecoratorNode as ll, $isParagraphNode as cl, $isTextNode as _n, SELECTION_CHANGE_COMMAND as Zo, getRegisteredNode as wl, isDocumentFragment as oo, isDOMDocumentNode as dl, ArtificialNode__DO_NOT_USE as Qo, $createLineBreakNode as ta, $isRootOrShadowRoot as pl, isBlockDomNode as ao, isInlineDomNode as so, $insertNodes as ul } from "lexical";
import * as Re from "@radix-ui/react-tooltip";
import { TooltipTrigger as ml } from "@radix-ui/react-tooltip";
import { HeadingNode as fl, QuoteNode as hl, registerRichText as gl } from "@lexical/rich-text";
import { flushSync as bl, createPortal as vl } from "react-dom";
...
import { useReactTable as oa, getFilteredRowModel as Nl, getSortedRowModel as aa, getPaginationRowModel as kl, getCoreRowModel as sa, flexRender as rn, getGroupedRowModel as _l, getExpandedRowModel as Cl } from "@tanstack/react-table";
import * as ft from "@radix-ui/react-select";
import El from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ir, HIDDEN_NOTE_CALLER as lr, getDefaultViewOptions as Tl, isInsertEmbedOpOfType as hn, Editorial as Rl } from "@eten-tech-foundation/platform-editor";
...
import * as Tr from "react-resizable-panels";
...
const Il = fi({ prefix: "tw-" });
function g(...t) {
  return Il(mi(t));
}
const He = 250, ia = 300, Ml = 400, Ol = 450, la = 500, Al = "layoutDirection";
function gt() {
  const t = localStorage.getItem(Al);
  return t === "rtl" ? t : "ltr";
}
const Pl = At.Root, lu = At.Trigger, Ll = At.Portal, cu = At.Close, ca = x.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  At.Overlay,
  {
    ref: o,
    className: g(
...
const Vl = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  At.Description,
  {
    ref: n,
...
Vl.displayName = At.Description.displayName;
...
const Rr = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  It.Separator,
  {
    ref: n,
...
Rr.displayName = It.Separator.displayName;
...
const me = Ve.Root, xe = Ve.Trigger, Fl = Ve.Anchor, ee = x.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, i) => {
  const s = gt();
...
function pr(t, e, n) {
  return `${t} ${Ee[t]}${e ? ` ${Sr(t, e)} ${Le(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function zl({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(me, { open: w, onOpenChange: u, children: [
  ...
  const o = Bl.reduce(
    (a, i) => {
      ...
      if (s) {
        ...
        let w;
        const u = e.filter((m) => Dr(m, l, n));
        if (u.length === 1 && ([w] = u), !w && c) {
...
function Ul(t, e, n, o) {
  const a = K(() => {
    if (t.chapterNum > 1)
      ...
      if (c > 0) {
        const d = e[c - 1], w = Math.max(Yt(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function lo({
  ...
  if (t)
    return /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r("div", { className: g("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Yt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      te,
      {
        value: `${t} ${Ee[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function du({
  ...
  const d = gt(), [w, u] = I(!1), [m, f] = I(""), [h, v] = I(""), [b, y] = I("books"), [N, _] = I(void 0), [k, $] = I(!1), j = G(void 0), A = G(void 0), R = G(void 0), C = G(void 0), E = G({}), T = K(
    (L) => {
      e(L), l && l(L);
    },
    [e, l]
  ), S = z(() => o ? o() : fa, [o]), M = z(() => ({
    [Q.OT]: S.filter((D) => ht.isBookOT(D)),
    [Q.NT]: S.filter((D) => ht.isBookNT(D)),
    [Q.DC]: S.filter((D) => ht.isBookDC(D)),
    [Q.Extra]: S.filter((D) => ht.extraBooks().includes(D))
  }), [S]), V = z(() => Object.values(M).flat(), [M]), W = z(() => {
    if (!h.trim()) return M;
    const L = {
      [Q.OT]: [],
      [Q.NT]: [],
    ...
    (L) => {
      const D = b === "chapters" ? N : P == null ? void 0 : P.book;
      D && (T({
        book: D,
        chapterNum: L,
        verseNum: 1
    ...
    (L) => {
      if (L.ctrlKey) return;
      const { isLetter: D, isDigit: F } = io(L.key);
      if (b === "chapters") {
        if (L.key === "Backspace") {
      ...
      if ((b === "chapters" || b === "books" && P) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(L.key)) {
        ...
        rt !== X && (L.preventDefault(), L.stopPropagation(), f(pr(Y, a, rt)), setTimeout(() => {
          const mt = E.current[rt];
    ...
    const { isLetter: D, isDigit: F } = io(L.key);
    (D || F) && (L.preventDefault(), v((Y) => Y + L.key), A.current.focus(), $(!1));
  }, []);
  return Lt(() => {
    const L = setTimeout(() => {
      if (w && b === "books" && R.current && C.current) {
        const D = R.current, F = C.current, Y = F.offsetTop, X = D.clientHeight, pt = F.clientHeight, rt = Y - X / 2 + pt / 2;
        D.scrollTo({
          top: Math.max(0, rt),
          behavior: "smooth"
        }), f(pr(t.book));
    ...
    if (b === "chapters" && N) {
      ...
      setTimeout(() => {
        if (R.current)
          if (L) {
            const D = E.current[t.chapterNum];
            D && D.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            R.current.scrollTo({ top: 0 });
        j.current && j.current.focus();
      }, 0);
    }
  }, [b, N, P, t.book, t.chapterNum]), /* @__PURE__ */ p(me, { open: w, onOpenChange: H, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
      U,
      {
      ...
      pe,
      {
        ...
        children: [
          b === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: J.map(({ onClick: L, disabled: D, title: F, icon: Y }) => /* @__PURE__ */ r(
              U,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              U,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ r(As, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ps, { className: "tw-h-4 tw-w-4" })
              }
            ),
          ...
          !k && /* @__PURE__ */ p(ue, { ref: R, children: [
            b === "books" && /* @__PURE__ */ p(st, { children: [
              !P && Object.entries(W).map(([L, D]) => {
                if (D.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Jt, { heading: re(L), children: D.map((F) => /* @__PURE__ */ r(
                      ha,
                      {
                        bookId: F,
                        onSelect: (Y) => Et(Y),
              ...
              P && /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(
                te,
                {
                  ...
                  children: Ce(
                    ...
                    a ? Sr(P.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              P && Yt(P.book) > 1 && /* @__PURE__ */ p(st, { children: [
...
), yt = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Fo.Root, { ref: n, className: g("pr-twp", Gl(), t), ...e }));
yt.displayName = Fo.Root.displayName;
const Ir = x.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
  return /* @__PURE__ */ r(
    sn.Root,
    {
...
Ir.displayName = sn.Root.displayName;
const Cn = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  sn.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(sn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(An, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
...
function ur({
  ...
  const [_, k] = I(!1), $ = d ?? c, j = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], A = (R, C) => {
    const E = c(R), T = typeof R == "object" && "secondaryLabel" in R ? R.secondaryLabel : void 0, S = `${C ?? ""}${E}${T ?? ""}`;
    return /* @__PURE__ */ p(
      te,
      {
        value: E,
    ...
    /* @__PURE__ */ r(
      ee,
      {
        ...
        children: /* @__PURE__ */ p(pe, { children: [
          ...
          /* @__PURE__ */ r(ue, { children: j(e) ? e.map((R) => /* @__PURE__ */ r(Jt, { heading: R.groupHeading, children: R.options.map((C) => A(C, R.groupHeading)) }, R.groupHeading)) : e.map((R) => A(R)) })
        ] })
      }
    )
  ] });
...
function mu({
  ...
  const w = Un(d, "%webView_bookSelector_currentBook%"), u = Un(d, "%webView_bookSelector_choose%"), m = Un(d, "%webView_bookSelector_chooseBooks%"), [f, h] = I(
    "current book"
    /* CurrentBook */
  ), v = (b) => {
    h(b), t(b);
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(yt, { className: "tw-ms-1", children: w })
          ] }),
...
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Xl = va ? Lt : q, gn = { tag: _r };
function Wl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, d = Yl(null, o), w = zo({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, w), theme: o });
    return function(u, m) {
      if (m !== null) {
...
const Jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : q;
function Zl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return Jl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(_r) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const Mr = {
...
const rc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : q;
function oc(t) {
...
function sc(t, e) {
  ...
  s.sort((d, w) => {
    const u = d.top - w.top;
    return Math.abs(u) <= 3 ? d.left - w.left : u;
  });
  for (let d = 0; d < c; d++) {
    const w = s[d], u = l && l.top <= w.top && l.top + l.height > w.top && l.left + l.width > w.left, m = w.width + i === o.width;
    u || m ? (s.splice(d--, 1), c--) : l = w;
  }
  return s;
}
function ic(t, e, n = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !_i(e) && o !== null) {
    const [a, i] = o, s = t.isBackward(), l = a.getNode(), c = i.getNode(), d = e.is(l), w = e.is(c);
    if (d || w) {
      const [u, m] = Ci(t), f = l.is(c), h = e.is(s ? c : l), v = e.is(s ? l : c);
      let b, y = 0;
      f ? (y = u > m ? m : u, b = u > m ? u : m) : h ? (y = s ? m : u, b = void 0) : v && (y = 0, b = s ? u : m);
      const N = e.__text.slice(y, b);
      N !== e.__text && (n === "clone" && (e = Ei(e)), e.__text = N);
    }
  }
  return e;
}
...
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, lc = xa && "documentMode" in document ? document.documentMode : null;
!(!xa || !("InputEvent" in window) || lc) && "getTargetRanges" in new window.InputEvent("input");
function Ht(t) {
  return `${t}px`;
}
...
function wc(t, e, n) {
  ...
  function c() {
    ...
    const { left: u, top: m } = a.getBoundingClientRect(), f = sc(t, e);
    var h, v;
  ...
  const w = t.registerRootListener(function u() {
    ...
    if (!qo(f)) return d();
    d(), o = m, a = f, i = new MutationObserver((h) => {
...
function dc(t) {
  for (const e of t) {
    const n = e.style;
    n.background !== "Highlight" && (n.background = "Highlight"), n.color !== "HighlightText" && (n.color = "HighlightText"), n.marginTop !== Ht(-1.5) && (n.marginTop = Ht(-1.5)), n.paddingTop !== Ht(4) && (n.paddingTop = Ht(4)), n.paddingBottom !== Ht(0) && (n.paddingBottom = Ht(0));
  }
}
function pc(t, e = dc) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(u), h = m.getNode(), v = h.getKey(), b = m.offset, y = f.getNode(), N = y.getKey(), _ = f.offset, k = t.getElementByKey(v), $ = t.getElementByKey(N), j = n === null || k !== o || b !== a || v !== n.getKey(), A = i === null || $ !== s || _ !== l || N !== i.getKey();
      if ((j || A) && k !== null && $ !== null) {
        const R = function(C, E, T, S, M, V, W) {
          const P = (C._window ? C._window.document : document).createRange();
          return P.setStart(...co(E, T, S)), P.setEnd(...co(M, V, W)), P;
        }(t, m, h, k, f, y, $);
        c(), c = wc(t, R, e);
      }
      n = h, o = k, a = b, i = y, s = $, l = _;
    });
  }
  return d(t.getEditorState()), we(t.registerUpdateListener(({ editorState: w }) => d(w)), () => {
    c();
  });
}
function uc(t, e) {
...
function fc(t) {
  const e = Dt() || Ti();
  let n;
  if (Wt(e)) n = Ri(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (n = Uo(l, "next"));
    }
    n = n || Si(ce(), "previous").getFlipped().insert(Ge());
  }
  const o = hc(t, n), a = Di(o), i = Ii(a) ? Mi(a) : o;
  return Oi(Ai(i)), t.getLatest();
}
function hc(t, e, n) {
  let o = eo(e, "next");
  for (let a = o; a; a = Pi(a, n)) o = a;
  return Li(o) && En(283), o.insert(t.isInline() ? Ge().append(t) : t), eo(Uo(t.getLatest(), "next"), e.direction);
}
function gc(t) {
  const e = Dt();
  if (!Wt(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = Go(i, (d) => se(d) && !d.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
let Tn, ie = 0, Rn = 0, xc = 0, fr = 0, yn = 0;
function po(t) {
  if (et === void 0) return;
  let e = t.n;
...
function Nc(t) {
  ...
  Na(this), et = t, this.f &= -2, 8 & this.f && Ar(this), Ln();
}
function Pe(t, e) {
...
St.prototype.brand = bc, St.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ie !== 0 && Rn === 0 && e.l !== fr && (e.l = fr, Tn = { S: e, v: e.v, i: e.i, o: Tn });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ka(this), uo(this), ie++;
  const t = et;
  return et = this, Nc.bind(this, t);
...
function Ca(t, e = _a) {
  return t.registerCommand(Ho, (n) => (t.update(e), !0), Cr);
}
...
const qn = ji("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ea extends sr {
  $config() {
    return this.config("decorator-text", { extends: sr, stateConfigs: [{ flat: !0, stateConfig: qn }] });
  }
  getFormat() {
    return Ji(this, qn);
  }
...
$t({ name: "@lexical/extension/DecoratorText", nodes: () => [Ea], register: (t, e, n) => t.registerCommand(Yo, (o) => {
  const a = Dt();
  if (Xo(a) || Wt(a)) for (const i of a.getNodes()) _c(i) && i.toggleFormat(o);
  return !1;
}, Wo) });
function Ta(t, e) {
  let n;
...
const hr = $t({ build: (t) => Ta(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Pr = 0, gr = 1, Sa = 2, Hn = 3, bn = 4, Ae = 5, Yn = 6, Qe = 7;
function Xn(t) {
  return t.id === Pr;
}
function Da(t) {
...
function Cc(t) {
  return function(e) {
    return e.id === gr;
  }(t) || ot(305, String(t.id), String(gr)), Object.assign(t, { id: Sa });
}
...
class Tc {
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Yn && ot(310, String(n.id), String(Yn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Hn;
    }(e) || ot(314, String(e.id), String(Hn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
...
const Sc = $t({ config: Me({ setOptions: mo, updateOptions: mo }), init: ({ $initialEditorState: t = Rc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: i } = a;
    if (Ki(i)) t.setEditorState(i, n);
...
}, name: "@lexical/extension/InitialState", nodes: [Fi, Ko, zi, Bi, Bo] }), fo = Symbol.for("@lexical/extension/LexicalBuilder");
function ho() {
}
function Dc(t) {
  throw t;
...
class $e {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Wn, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const n = e[fo];
    return n && (n.PACKAGE_VERSION !== Wn && ot(292, n.PACKAGE_VERSION, Wn), n instanceof $e || ot(293)), n;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Xn(i) || ot(300, s, a || "[unknown]"), Xn(l = i) || ot(304, String(l.id), String(Pr)), i = Object.assign(l, { id: gr }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of l) {
      const { extension: u } = w;
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const m of kc(u)) {
        if (typeof m != "function") {
          const f = o.get(m.replace);
          f && ot(302, u.name, m.replace.name, f.extension.name), o.set(m.replace, w);
        }
        n.add(m);
      }
      if (u.html) {
...
const Ic = /* @__PURE__ */ new Set(), go = $t({ build(t, e, n) {
  const o = n.getDependency(hr).output, a = ln({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Ta(() => {
  }, () => Zt(() => {
    const s = i.peek(), { watchedNodeKeys: l } = a.value;
    let c, d = !1;
    o.value.read(() => {
      if (Dt()) for (const [w, u] of l.entries()) {
        if (u.size === 0) {
          l.delete(w);
          continue;
        }
        const m = el(w), f = m && m.isSelected() || !1;
        d = d || f !== (!!s && s.has(w)), f && (c = c || /* @__PURE__ */ new Set(), c.add(w));
      }
    }), !d && c && s && c.size === s.size || (i.value = c);
  }));
  return { watchNodeKey: function(s) {
    const l = yc(() => (i.value || Ic).has(s)), { watchedNodeKeys: c } = a.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), a.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [hr], name: "@lexical/extension/NodeSelection" }), Mc = Ui("INSERT_HORIZONTAL_RULE_COMMAND");
class je extends sr {
  static getType() {
...
$t({ dependencies: [hr, go], name: "@lexical/extension/HorizontalRule", nodes: () => [je], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(go).output, a = ln({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return we(t.registerCommand(Mc, (s) => {
    const l = Dt();
    if (!Wt(l)) return !1;
    ...
    return !0;
  }, Cr), t.registerCommand(Gi, (s) => {
    if (qi(s.target)) {
      const l = Hi(s.target);
      if (Ac(l)) return function(c, d = !1) {
        const w = Dt(), u = c.isSelected(), m = c.getKey();
        let f;
        d && Xo(w) ? f = w : (f = Yi(), Xi(f)), u ? f.delete(m) : f.add(m);
      }(l, s.shiftKey), !0;
    }
    return !1;
    ...
    vc(() => {
      ...
      for (const [w, u] of s.entries()) if (u === "destroyed") d.delete(w), c = !0;
      else {
        const m = d.get(w), f = t.getElementByKey(w);
        m ? m.domNode.value = f : (c = !0, d.set(w, { domNode: ln(f), selectedSignal: o(w) }));
      }
...
function Pc(t, e, n = Ia) {
  return we(t.registerCommand(rl, (o) => {
    const a = Dt();
    if (!Wt(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((m) => kn(m) && m.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), u = mc(w);
      if (u.canIndent()) {
        const m = u.getKey();
        let f = ol();
        if (f.anchor.set(m, 0, "element"), f.focus.set(m, 0, "element"), f = al(f), f.anchor.is(d)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? sl : ro : il;
    return t.dispatchCommand(i, void 0);
  }, Cr), t.registerCommand(ro, () => {
...
const Lc = $t({ name: "@lexical/react/ReactProvider" });
function $c() {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Wt(h)) {
                ...
                if (_n(b) && d >= 0 && w >= 0 && (y = d, N = d + w, h.setTextNodeRange(b, y, b, N)), y === N && u === "" || (h.insertRawText(u), b = v.getNode()), _n(b)) {
                  y = m, N = m + f;
...
const $r = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : q;
function zc({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, i] = I(() => n.getDecorators());
    return $r(() => n.registerDecoratorListener((s) => {
      bl(() => {
        i(s);
      });
    }), [n]), q(() => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = r(o, { onError: (m) => n._onError(m), children: r(Os, { fallback: null, children: a[d] }) }), u = n.getElementByKey(d);
        u !== null && s.push(vl(w, u, d));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function Bc({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(Lc.name)) {
...
function Kc({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    $r(() => we(gl(a), Oa(a)), [a]);
  }(o), p(st, { children: [t, r(Uc, { content: e }), r(Bc, { editor: o, ErrorBoundary: n })] });
}
...
const qc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : q;
function Hc({ onClear: t }) {
  const [e] = ne();
  return qc(() => Ca(e, t), [e, t]), null;
}
const Aa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : q;
function Yc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: u, ariaRequired: m, autoCapitalize: f, className: h, id: v, role: b = "textbox", spellCheck: y = !0, style: N, tabIndex: _, "data-testid": k, ...$ }, j) {
  const [A, R] = I(t.isEditable()), C = K((T) => {
    T && T.ownerDocument && T.ownerDocument.defaultView ? t.setRootElement(T) : t.setRootElement(null);
  }, [t]), E = z(() => /* @__PURE__ */ function(...T) {
    return (S) => {
      for (const M of T) typeof M == "function" ? M(S) : M != null && (M.current = S);
    };
  }(j, C), [C, j]);
  return Aa(() => (R(t.isEditable()), t.registerEditableListener((T) => {
    R(T);
  })), [t]), r("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? n : "none", "aria-controls": A ? o : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": A && b === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": d, "aria-multiline": w, "aria-owns": A ? u : void 0, "aria-readonly": !A || void 0, "aria-required": m, autoCapitalize: f, className: h, contentEditable: A, "data-testid": k, id: v, ref: E, role: b, spellCheck: y, style: N, tabIndex: _, ...$ });
}
const Xc = pn(Yc);
function vo(t) {
  return t.getEditorState().read(Ma(t.isComposing()));
...
function Jc(t, e) {
  ...
  return p(st, { children: [r(Xc, { editor: a, ...o, ref: e }), n != null && r(Zc, { editor: a, content: n })] });
}
...
function ew() {
  const [t, e] = I(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(Pl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(wa, { children: [
...
function nw({
  ...
  const [e] = ne(), [n, o] = I(e), [a, i] = I("paragraph"), [s, l] = ew(), c = () => {
  };
...
), ow = x.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  ea.Root,
  {
    ref: a,
...
const Va = x.createContext({
  size: "default",
  variant: "default"
}), Vr = x.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, i) => {
  const s = gt();
  return /* @__PURE__ */ r(
    Pn.Root,
    {
...
an.displayName = Pn.Item.displayName;
const xo = [
  { format: "bold", icon: Ls, label: "Bold" },
  { format: "italic", icon: $s, label: "Italic" }
...
function cw(t, e) {
  const n = dl(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
...
function ja(t, e, n, o = null) {
  ...
  let s = e;
  o !== null && _n(e) && (s = ic(o, e, "clone"));
  const l = se(s) ? s.getChildren() : [], c = wl(t, s.getType());
  let d;
  d = c && c.exportDOM !== void 0 ? c.exportDOM(t, s) : s.exportDOM(t);
  const { element: w, after: u } = d;
  if (!w) return !1;
  ...
  if (a && !i) {
    if ((qo(w) || oo(w)) && w.append(m), n.append(w), u) {
      const f = u.call(s, w);
      f && (oo(w) ? w.replaceChildren(f) : w.replaceWith(f));
    }
  } else n.append(m);
  return a;
}
...
function za(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  let m = [];
  const f = (l == null || !pl(l)) && (l != null && kn(l) || o);
  for (let h = 0; h < u.length; h++) m.push(...za(u[h], e, n, f, new Map(a), l));
  return w != null && (m = w(m)), ao(t) && (m = dw(t, m, f ? () => {
    const h = new Qo();
    return n.push(h), h;
  } : Ge)), l == null ? m.length > 0 ? s = s.concat(m) : ao(t) && function(h) {
    return h.nextSibling == null || h.previousSibling == null ? !1 : so(h.nextSibling) && so(h.previousSibling);
...
function fu({
  ...
  const [a, i] = I(uw), [s, l] = I(void 0), [c, d] = I(!1), w = G(void 0), u = G(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(me, { open: c, onOpenChange: d, children: [
      /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ p(
        U,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ r("span", { children: Jn(s !== void 0 ? s : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ r(
        ee,
        {
          ...
          children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: t.map((y) => /* @__PURE__ */ r(
            te,
            {
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ r("span", { children: Jn(y, o) })
            },
            y || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Fr(y) && (y.preventDefault(), y.stopPropagation(), jt(a) && m());
        },
        onKeyDown: (y) => {
          jr(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          Sn,
          {
...
const hu = Object.freeze([
...
], mw = ["input", "select", "textarea", "button"], fw = ["button", "textbox"], zr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = G(null), [i, s] = I(void 0), [l, c] = I(void 0), d = K(
    (f) => {
      s(f);
    ...
    if (f.isContentEditable || mw.includes(h)) return !0;
    const v = f.getAttribute("role");
    if (v && fw.includes(v)) return !0;
    ...
    (f) => {
      ...
      if (!!(b && h && b.contains(h) && h !== b) && u(h)) {
        ...
        if (f.key === "ArrowDown" || f.key === "ArrowUp") {
          ...
          const C = R.findIndex((T) => T === h);
          if (C === -1) return;
          let E;
          f.key === "ArrowDown" ? E = Math.min(C + 1, R.length - 1) : E = Math.max(C - 1, 0), E !== C && (f.preventDefault(), f.stopPropagation(), (A = R[E]) == null || A.focus());
          return;
        }
        return;
      }
      ...
      switch (f.key) {
        case "ArrowDown":
          $ = Math.min(k + 1, t.length - 1), f.preventDefault();
          break;
        case "ArrowUp":
          $ = Math.max(k - 1, 0), f.preventDefault();
          break;
        case "Home":
          $ = 0, f.preventDefault();
          break;
        case "End":
          $ = t.length - 1, f.preventDefault();
          break;
        case " ":
        case "Enter":
          i && w(i), f.preventDefault(), f.stopPropagation();
          return;
        case "ArrowRight": {
          const R = y;
          if (R) {
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: g("pr-twp", hw({ variant: e }), t), ...n })
);
...
const vw = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: g("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Ft = x.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  ra.Root,
  {
    ref: a,
    decorative: n,
...
Ft.displayName = ra.Root.displayName;
...
const yw = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  qe.Image,
  {
    ref: n,
...
yw.displayName = qe.Image.displayName;
...
}), be = it.Trigger, Ya = it.Group, Nw = it.Portal, kw = it.Sub, _w = it.RadioGroup;
function de({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Br.Provider, { value: n, children: /* @__PURE__ */ r(it.Root, { ...e }) });
}
...
const le = x.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ p(
    it.CheckboxItem,
    {
      ...
      dir: i,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(it.ItemIndicator, { children: /* @__PURE__ */ r(zt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const Ja = x.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    it.RadioItem,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(it.ItemIndicator, { children: /* @__PURE__ */ r(An, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
function yo({
  ...
  const f = K(
    (k) => {
      k && k.stopPropagation(), d(!1), u(void 0), s == null || s(!1);
    },
    [s]
  ), h = K(
    async (k) => {
      if (k && k.stopPropagation(), !w || !a) return;
      await a(
        t.id,
        Dn(w)
      ) && (d(!1), u(void 0), s == null || s(!1));
    },
    [w, a, t.id, s]
  ), v = z(() => {
    const k = new Date(t.date), $ = gi(
      k,
    ...
    [t.user]
  ), N = z(() => bi(t.contents), [t.contents]), _ = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(st, { children: [
        /* @__PURE__ */ p(
          In,
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), u(pw(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p(
          In,
          {
            ...
            children: [
              /* @__PURE__ */ r(js, { className: "tw-me-2 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: m,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), f()) : Fr(k) && (k.preventDefault(), k.stopPropagation(), jt(w) && h());
              },
              onKeyDown: (k) => {
                jr(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
...
function Ew({
  ...
  const [A, R] = I(No), [C, E] = I(
    void 0
  ), T = o, [S, M] = I(!1), [V, W] = I(!1), [P, tt] = I(!1), [Et, B] = I(!1), [at, J] = I(!1), [Z, H] = I(k), [wt, dt] = I(!1), ut = G(void 0), [Tt, re] = I(/* @__PURE__ */ new Map());
  q(() => {
    let O = !0;
    return (async () => {
  ...
  const Ut = z(() => e.filter((O) => !O.deleted), [e]);
  q(() => {
    let O = !0;
    if (!o || !_) {
      re(/* @__PURE__ */ new Map());
  ...
  const Gt = z(() => Ut[0], [Ut]), Oe = G(null), he = G(void 0), oe = K(() => {
    var O;
    (O = he.current) == null || O.call(he), R(No);
  }, []), Ze = K(() => {
    const O = !Z;
    H(O), dt(!O), h == null || h(c, O);
  }, [Z, h, c]);
  q(() => {
    M(!1);
  }, [o]), q(() => {
    if (o && !Z && !wt) {
      ...
      return ut.current = O, () => clearTimeout(O);
    }
  ...
  }, [i, n]), F = z(() => Ut.slice(1), [Ut]), Y = z(() => F.length ?? 0, [F.length]), X = z(() => Y > 0, [Y]), pt = z(() => S || Y <= 2 ? F : F.slice(-2), [F, Y, S]), rt = z(() => S || Y <= 2 ? 0 : Y - 2, [Y, S]), _t = z(
  ...
  const Ot = K(
    ...
    async (O) => {
      const Ct = jt(A) ? Dn(A) : void 0, xt = await u({
        ...O,
        contents: Ct,
        assignedUser: C ?? O.assignedUser
      });
      return xt && Ct && oe(), xt && C !== void 0 && E(void 0), xt;
    },
    [oe, A, u, C]
  );
  if (Gt)
    return /* @__PURE__ */ r(
      Ua,
      {
        ...
        className: g(
          ...
          {
            "tw-bg-primary-foreground": !o && w !== "Resolved" && Z,
            "tw-bg-background": o && w !== "Resolved" && Z,
            "tw-bg-muted": w === "Resolved",
            "tw-bg-accent": !Z && !o && w !== "Resolved"
          }
        ),
        onClick: () => {
          l(c);
        ...
        children: /* @__PURE__ */ p(Ga, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              D && /* @__PURE__ */ r(Se, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: D }),
              /* @__PURE__ */ r(
                U,
                {
                  variant: "ghost",
                  ...
                  children: Z ? /* @__PURE__ */ r(Fs, {}) : /* @__PURE__ */ r(zs, {})
                }
              ),
              at && w !== "Resolved" && /* @__PURE__ */ r(
                U,
                {
                  variant: "ghost",
                  size: "icon",
            ...
            /* @__PURE__ */ r(
              yo,
              {
                ...
                handleDeleteComment: f,
                onEditingChange: W,
                canEditOrDelete: (!V && Tt.get(Gt.id)) ?? !1,
          ...
          /* @__PURE__ */ p(st, { children: [
            X && !o && /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Ft, {}) }),
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                      ...
                      S ? /* @__PURE__ */ r(Ao, {}) : /* @__PURE__ */ r(Ke, {})
                    ] })
                  ]
                }
              ),
              pt.map((O) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
                yo,
                {
                  comment: O,
                  localizedStrings: n,
                  ...
                  handleDeleteComment: f,
                  onEditingChange: W,
                  canEditOrDelete: (!V && Tt.get(O.id)) ?? !1
                }
              ) }, O.id)),
              b !== !1 && (!V || jt(A)) && /* @__PURE__ */ p(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (O) => {
                    Fr(O) && (O.preventDefault(), O.stopPropagation(), (jt(A) || C !== void 0) && Ot());
                  },
                  onKeyDown: (O) => {
                    jr(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ r(
                      Sn,
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      C !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: _e(
                      ...
                      /* @__PURE__ */ p(me, { open: P, onOpenChange: tt, children: [
                        ...
                        /* @__PURE__ */ r(
                          ee,
                          {
                            ...
                            children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: v == null ? void 0 : v.map((O) => /* @__PURE__ */ r(
                              te,
                              {
                                onSelect: () => {
                                  E(O !== i ? O : void 0), tt(!1);
                                ...
                                className: "tw-flex tw-items-center",
                                children: /* @__PURE__ */ r("span", { children: Nn(O, n) })
                              },
                              O || "unassigned"
                            )) }) })
                          }
...
function bu({
  ...
  q(() => {
    h && (N((M) => new Set(M).add(h)), k(h));
  }, [h]);
  const $ = n.filter(
    (M) => M.comments.some((V) => !V.deleted)
  ), j = $.map((M) => ({ id: M.id })), A = K(
    (M) => {
      N((V) => new Set(V).add(M.id)), k(M.id), v == null || v(M.id);
    },
    [v]
  ), R = K(
    (M) => {
      ...
      }), k(M), v == null || v(V ? void 0 : M);
    },
    [y, v]
  ), { listboxRef: C, activeId: E, handleKeyDown: T } = zr({
    options: j,
    onOptionSelect: A
  }), S = K(
    (M) => {
      M.key === "Escape" ? (_ && y.has(_) && (N((V) => {
        const W = new Set(V);
        return W.delete(_), W;
      }), k(void 0), v == null || v(void 0)), M.preventDefault(), M.stopPropagation()) : T(M);
    },
    [_, y, T, v]
  );
  return /* @__PURE__ */ r(
...
function Tw({ table: t }) {
  return /* @__PURE__ */ p(de, { children: [
    /* @__PURE__ */ r(yl, { asChild: !0, children: /* @__PURE__ */ p(U, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Bs, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Fe = ft.Root, Rw = ft.Group, ze = ft.Value, Sw = ve(
  ...
  return /* @__PURE__ */ p(
    ft.Trigger,
    {
      className: g(Sw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: i,
      children: [
...
const Dw = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Label,
  {
    ref: n,
...
Dw.displayName = ft.Label.displayName;
const Pt = x.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ft.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ft.ItemIndicator, { children: /* @__PURE__ */ r(zt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(ft.ItemText, { children: e })
    ]
  }
));
Pt.displayName = ft.Item.displayName;
const Iw = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Separator,
  {
    ref: n,
    className: g("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
Iw.displayName = ft.Separator.displayName;
function Mw({ table: t }) {
...
const $n = x.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
  ...
  x.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        cn(s, '[tabindex]:not([tabindex="-1"])').forEach((w) => {
...
$n.displayName = "Table";
const Vn = x.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: g(
...
const jn = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: g("[&_tr:last-child]:tw-border-0", t), ...e }));
jn.displayName = "TableBody";
const Aw = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
  ...
  const l = x.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), $w(f, h, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Lw(l, v, w.key);
...
const Vw = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function jw({
  ...
  var j;
  const [w, u] = I([]), [m, f] = I([]), [h, v] = I({}), [b, y] = I({}), N = z(() => e ?? [], [e]), _ = oa({
    data: N,
    columns: t,
    getCoreRowModel: sa(),
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((C, E) => `skeleton-row-${E}`).map((C) => /* @__PURE__ */ r(ae, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Te, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dn, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : ((j = _.getRowModel().rows) == null ? void 0 : j.length) > 0 ? $ = _.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    ae,
    {
      onClick: () => s(A, _),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((R) => /* @__PURE__ */ r(Te, { children: rn(R.column.columnDef.cell, R.getContext()) }, R.id))
    },
    A.id
  )) : $ = /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ r(Te, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: d }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Tw, { table: _ }),
    /* @__PURE__ */ p($n, { stickyHeader: i, children: [
      /* @__PURE__ */ r(Vn, { stickyHeader: i, children: _.getHeaderGroups().map((A) => /* @__PURE__ */ r(ae, { children: A.headers.map((R) => /* @__PURE__ */ r(wn, { className: "tw-p-0", children: R.isPlaceholder ? void 0 : rn(R.column.columnDef.header, R.getContext()) }, R.id)) }, A.id)) }),
...
function vu({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(El, { options: i, children: e })
    }
  );
}
...
function yu({
  ...
  return /* @__PURE__ */ p(me, { onOpenChange: (w) => {
    w || l(!1);
  }, children: [
...
function Nu({ id: t, label: e, groups: n }) {
  const [o, a] = I(
    ...
    s((m) => (m[d] = w, { ...m }));
    const u = n[d].items.find((m) => m.id === w);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(de, { children: [
    ...
    /* @__PURE__ */ r(Qt, { children: n.map((d, w) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(mn, { children: d.label }),
      /* @__PURE__ */ r(Ya, { children: d.itemType === 0 ? /* @__PURE__ */ r(st, { children: d.items.map((u, m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        le,
        {
          checked: o[w][m],
        ...
        {
          value: i[w],
          onValueChange: (u) => c(w, u),
          children: d.items.map((u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Ja, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ r(We, {})
    ] }, d.label)) })
...
function ku({
  ...
  }).format(Object.values(n).reduce((w, u) => w + u, 0)), d = () => {
...
function Kw({ id: t, versionHistory: e }) {
  ...
  function i(l) {
    const c = new Date(l), d = new Date(a.getTime() - c.getTime()), w = d.getUTCFullYear() - 1970, u = d.getUTCMonth(), m = d.getUTCDate() - 1;
    let f = "";
    return w > 0 ? f = `${w.toString()} year${w === 1 ? "" : "s"} ago` : u > 0 ? f = `${u.toString()} month${u === 1 ? "" : "s"} ago` : m === 0 ? f = "today" : f = `${m.toString()} day${m === 1 ? "" : "s"} ago`, f;
  }
...
function _u({
  ...
  const s = z(() => xi(n), [n]), c = ((d) => {
    const w = new Intl.DisplayNames(yi(), { type: "language" });
    return d.map((u) => w.of(u));
  })(o);
...
function Uw({
  ...
  const [y, N] = I(!1), _ = K(
    (E) => {
      var S;
      const T = (S = t.find((M) => M.label === E)) == null ? void 0 : S.value;
      T && n(
        e.includes(T) ? e.filter((M) => M !== T) : [...e, T]
      );
    },
    [t, e, n]
  ), k = () => c || o, $ = z(() => {
    if (!m) return t;
    const E = t.filter((S) => S.starred).sort((S, M) => S.label.localeCompare(M.label)), T = t.filter((S) => !S.starred).sort((S, M) => {
      const V = e.includes(S.value), W = e.includes(M.value);
      return V && !W ? -1 : !V && W ? 1 : S.label.localeCompare(M.label);
    });
    return [...E, ...T];
  }, [t, e, m]), j = () => {
    n(t.map((E) => E.value));
  ...
  return /* @__PURE__ */ r("div", { id: b, className: h, children: /* @__PURE__ */ p(me, { open: R, onOpenChange: w ?? N, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ p(
      U,
      {
        variant: v,
    ...
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(pe, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: A, children: s })
      ] }),
      /* @__PURE__ */ p(ue, { children: [
        /* @__PURE__ */ r(un, { children: l }),
        /* @__PURE__ */ r(Jt, { children: $.map((E) => /* @__PURE__ */ p(
          te,
          {
            value: E.label,
            onSelect: _,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ r(Js, { className: "tw-h-4 tw-w-4" }),
...
const Yw = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(st, { children: [
...
function Xw({
  ...
  const i = G(null), s = G(null), l = G(!1), [c, d] = I(t), [w, u] = I(n), [m, f] = I(!1);
  q(() => {
    d(t);
  }, [t]), q(() => {
    w !== n && u(n);
  ...
  const h = (b) => {
    l.current = !1, f(b), b || (c !== "custom" || w ? (e(c), o(w)) : (d(t), u(n)));
  }, v = (b) => {
    var y, N, _, k;
  ...
  return /* @__PURE__ */ p(de, { open: m, onOpenChange: h, children: [
    /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
      /* @__PURE__ */ r(kt, { asChild: !0, children: /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ r(U, { variant: "outline", className: "tw-h-6", children: Yw(t, a, n) }) }) }),
...
const Ww = (t, e) => t === "f" ? /* @__PURE__ */ p(st, { children: [
  /* @__PURE__ */ r(Vo, {}),
  " ",
...
function Zw({
  ...
  return /* @__PURE__ */ p(de, { children: [
    /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
      /* @__PURE__ */ r(ml, { asChild: !0, children: /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ r(U, { variant: "outline", className: "tw-h-6", children: Ww(t, n) }) }) }),
      /* @__PURE__ */ r(vt, { children: /* @__PURE__ */ r("p", { children: Jw(t, n) }) })
    ] }) }),
...
function td({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? ti, { className: e, size: 16 });
}
function Eo({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ p(
    te,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(td, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
...
function ed({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = I(""), [i, s] = z(() => {
    ...
    const c = e.filter(
      (w) => {
        var u;
        return (u = w.marker) == null ? void 0 : u.toLowerCase().includes(l);
      }
    ), d = e.filter(
  ...
  return /* @__PURE__ */ p(pe, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(ue, { children: [
      ...
      s.length > 0 && /* @__PURE__ */ p(st, { children: [
        i.length > 0 && /* @__PURE__ */ r(Rr, { alwaysRender: !0 }),
...
function Eu({
  ...
  const w = G(null), u = G(null), m = G(null), f = G(null);
  Lt(() => {
    if (!f.current) return;
    const { width: D } = f.current.getBoundingClientRect();
    D > 0 && (f.current.style.width = `${D}px`);
  }, []);
  const [h, v] = I("generated"), [b, y] = I("*"), [N, _] = I("f"), [k, $] = I(!1), [j, A] = I(!0), [R, C] = I(!1), E = G(!1), T = G(""), [S, M] = I(!1), [V, W] = I(), [P, tt] = I(), [Et, B] = I(), [at, J] = I(), Z = G(null), H = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  q(() => {
    ...
    if (F && hn("note", F)) {
      ...
      let rt = "custom";
      pt === ir ? rt = "generated" : pt === lr ? rt = "hidden" : pt && y(pt), v(rt), _(((X = F.insert.note) == null ? void 0 : X.style) ?? "f"), D = setTimeout(() => {
        var _t;
        (_t = w.current) == null || _t.applyUpdate([F]);
      }, 0);
    }
    return () => {
      D && clearTimeout(D);
  ...
  const dt = K(
    (D, F, Y = !1) => {
      var pt, rt, _t;
      const X = (rt = (pt = w.current) == null ? void 0 : pt.getNoteOps(0)) == null ? void 0 : rt.at(0);
      if (X && hn("note", X)) {
        if (X.insert.note) {
          let mt;
          D === "custom" ? mt = F : D === "generated" ? mt = ir : mt = lr, X.insert.note.caller = mt;
        }
        n == null || n([X]), Y && d && i && ((_t = d.current) == null || _t.replaceEmbedUpdate(i, [X]));
      }
    },
    [i, n, d]
  ), ut = K(() => {
  ...
  const Ut = () => {
    var F;
    const D = (F = u.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    ...
    var Y, X, pt, rt, _t;
    _(D);
    const F = (X = (Y = w.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : X.at(0);
    if (F && hn("note", F)) {
      F.insert.note && (F.insert.note.style = D);
      const mt = (rt = (pt = F.insert.note) == null ? void 0 : pt.contents) == null ? void 0 : rt.ops;
      N !== "x" && D === "x" ? mt == null || mt.forEach((Ot) => rd(Ot)) : N === "x" && D !== "x" && (mt == null || mt.forEach((Ot) => od(Ot))), (_t = w.current) == null || _t.applyUpdate([F, { delete: 1 }]);
    }
  }, oe = (D) => {
    J(D.contextMarker), C(D.canRedo);
  }, Ze = K(
    (D) => {
      var Y, X, pt, rt, _t;
      const F = (X = (Y = w.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : X.at(0);
      if (F && hn("note", F)) {
        ...
        if (mt || $(!1), $(
          mt === "x" ? !!(Ot != null && Ot.every((Vt) => {
            ...
            const O = ((xt = Vt.attributes) == null ? void 0 : xt.char).style;
          ...
          E.current = !0, T.current = JSON.stringify(F), A(!0);
          return;
        }
        A(JSON.stringify(F) === T.current), dt(h, b);
      } else
        $(!1), A(!0);
    },
    [h, b, dt]
    ...
    if (m.current && wt.length && D && D.rangeCount > 0) {
      const F = D.getRangeAt(0).getBoundingClientRect(), Y = m.current.getBoundingClientRect();
      W(F.left - Y.left), tt(F.top - Y.top), B(F.height), M(!0);
    }
  }, [wt, m]);
  return q(() => {
    const D = () => {
    ...
    var D;
    S && ((D = Z.current) == null || D.focus());
  }, [S]), q(() => {
    var Y;
    const D = ((Y = u.current) == null ? void 0 : Y.querySelector(".editor-input")) ?? void 0, F = (X) => {
      !S && D && document.activeElement === D && X.key === l ? (X.preventDefault(), L()) : S && X.key === "Escape" && (X.preventDefault(), M(!1));
    };
    return document.addEventListener("keydown", F), () => {
      document.removeEventListener("keydown", F);
    };
  }, [S, L, l]), /* @__PURE__ */ p(st, { children: [
  ...
  return /* @__PURE__ */ p(st, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(st, { children: sd(t.marker, l, o, d) })
      }
    )
  ] });
}
        ...
        "ul",
        {
          ...
          children: n.map((N, _) => {
            ...
            return /* @__PURE__ */ p(st, { children: [
              ...
              _ < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(Ft, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function wd({
  ...
  return /* @__PURE__ */ p($n, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Vn, { stickyHeader: !0, children: /* @__PURE__ */ p(ae, { children: [
      /* @__PURE__ */ r(wn, { children: a }),
      /* @__PURE__ */ r(wn, { children: i })
    ] }) }),
    /* @__PURE__ */ r(jn, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ p(
      ae,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { className: o, children: cd(l.text) })
        ]
      },
...
const Ur = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  cr.Root,
  {
    ref: n,
    className: g(
...
Ur.displayName = cr.Root.displayName;
const dd = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(oi, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(ai, { className: "tw-h-4 tw-w-4" });
}, Fn = (t, e, n) => /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
  /* @__PURE__ */ p(
    kt,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ p(Vr, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        an,
        {
          onClick: (c) => {
            c.stopPropagation(), Zn(
              [l],
              "approved",
              e,
              n,
  ...
  return e ? e[1] : "";
}, ud = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Pu = Object.freeze([
...
function Lu({
  ...
  const f = qt(n, "%webView_inventory_all%"), h = qt(n, "%webView_inventory_approved%"), v = qt(n, "%webView_inventory_unapproved%"), b = qt(n, "%webView_inventory_unknown%"), y = qt(n, "%webView_inventory_scope_currentBook%"), N = qt(n, "%webView_inventory_scope_chapter%"), _ = qt(n, "%webView_inventory_scope_verse%"), k = qt(n, "%webView_inventory_filter_text%"), $ = qt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = qt(n, "%webView_inventory_no_results%"), [A, R] = I(!1), [C, E] = I("all"), [T, S] = I(""), [M, V] = I([]), W = z(() => {
    const H = t ?? [];
    return H.length === 0 ? [] : fd(H, a, i);
  }, [t, a, i]), P = z(() => {
    if (A) return W;
    const H = [];
    return W.forEach((wt) => {
  ...
  }, [A, W]), tt = z(() => P.length === 0 ? [] : md(P, C, T), [P, C, T]), Et = z(() => {
    var dt, ut;
    if (!A) return c;
  ...
  q(() => {
    tt.length === 0 ? V([]) : tt.length === 1 && V(tt[0].items);
  }, [tt]);
  const B = (H, wt) => {
    wt.setRowSelection(() => {
      const ut = {};
  ...
  return /* @__PURE__ */ r("div", { id: d, className: "pr-twp tw-h-full tw-overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-h-full tw-w-full tw-min-w-min tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ p(Fe, { onValueChange: (H) => at(H), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ p(Nt, { children: [
        /* @__PURE__ */ r(kt, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-w-fit tw-min-w-[26px] tw-items-center tw-rounded-md tw-border", children: [
          ...
          /* @__PURE__ */ r(yt, { className: "tw-m-1 tw-truncate", children: (o == null ? void 0 : o.checkboxText) ?? $ })
        ] }) }),
        /* @__PURE__ */ r(vt, { children: (o == null ? void 0 : o.checkboxText) ?? $ })
      ] }) })
    ] }),
...
const hd = "16rem", gd = "3rem", es = x.createContext(void 0);
function zn() {
...
const ns = x.forwardRef(
  ({
    ...
    const [d, w] = x.useState(t), u = e ?? d, m = x.useCallback(
      (_) => {
...
const bd = x.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = zn();
  return /* @__PURE__ */ p(
    U,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(si, {}) : /* @__PURE__ */ r(ii, {}),
...
const xd = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Je,
  {
    ref: n,
    "data-sidebar": "input",
...
const kd = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Ft,
  {
    ref: n,
...
const vr = x.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ue : "div",
  {
    ref: o,
...
const _d = x.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ue : "button",
  {
    ref: o,
...
_d.displayName = "SidebarGroupAction";
...
const Cd = ve(
  ...
  ({
    ...
    const c = t ? Ue : "button", { state: d } = zn(), w = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: g(Cd({ variant: n, size: o }), i),
        ...s
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(kt, { asChild: !0, children: w }),
      /* @__PURE__ */ r(vt, { side: "right", align: "center", hidden: d !== "collapsed", ...a })
    ] })) : w;
  }
);
ls.displayName = "SidebarMenuButton";
const Ed = x.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ue : "button",
  {
    ref: a,
...
Ed.displayName = "SidebarMenuAction";
...
const Rd = x.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Id = x.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Ue : "a",
  {
    ref: i,
    ...
    rs,
    {
      ...
      children: /* @__PURE__ */ p(as, { children: [
        /* @__PURE__ */ p(br, { children: [
          ...
          /* @__PURE__ */ r(xr, { children: /* @__PURE__ */ r(ss, { children: Object.entries(e).map(([m, f]) => /* @__PURE__ */ r(is, { children: /* @__PURE__ */ r(
            ls,
            {
              onClick: () => d(m),
              isActive: u(m),
...
const ge = "scrBook", Od = "scrRef", ke = "source", Ad = "details", Pd = "Scripture Reference", Ld = "Scripture Book", cs = "Type", $d = "Details";
function Vd(t, e) {
  const n = e ?? !1;
  return [
    {
...
const jd = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || ar(t.start, t.end) === 0 ? `${Bn(t.start)}+${e}` : `${Bn(t.start)}+${e}-${Bn(t.end)}+${n}`;
}, To = (t) => `${jd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Vu({
  sources: t,
  ...
  const [d, w] = I([]), [u, m] = I([{ id: ge, desc: !1 }]), [f, h] = I({}), v = z(
  ...
  q(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const T = v.find((S) => To(S) === E[0]) || void 0;
        T && l(T);
      }
    }
  }, [f, v, l, y]);
  const N = a ?? Ld, _ = i ?? cs, k = [
  ...
  }, A = (C, E) => C.getIsGrouped() ? "" : g("banded-row", E % 2 === 0 ? "even" : "odd"), R = (C, E, T) => {
    if (!((C == null ? void 0 : C.length) === 0 || E.depth < T.column.getGroupedIndex())) {
      if (E.getIsGrouped())
        switch (E.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ p(
      Fe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ie, { position: "item-aligned", children: /* @__PURE__ */ r(Rw, { children: k.map((C) => /* @__PURE__ */ r(Pt, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p($n, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Vn, { children: y.getHeaderGroups().map((C) => /* @__PURE__ */ r(ae, { children: C.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(wn, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          rn(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, C.id)) }),
      /* @__PURE__ */ r(jn, { children: y.getRowModel().rows.map((C, E) => {
        const T = gt();
        return /* @__PURE__ */ r(
          ae,
          {
            ...
            className: g(A(C, E)),
            onClick: (S) => j(C, S),
            children: C.getVisibleCells().map((S) => {
              if (!(S.getIsPlaceholder() || S.column.columnDef.enableGrouping && !S.getIsGrouped() && (S.column.columnDef.id !== ke || !n)))
                return /* @__PURE__ */ r(
                  Te,
                  {
                    className: g(
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ p(
                      U,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (T === "ltr" ? /* @__PURE__ */ r(Xt, {}) : /* @__PURE__ */ r(rr, {})),
                          " ",
                          rn(S.column.columnDef.cell, S.getContext()),
                          " (",
                          C.subRows.length,
                          ")"
                        ]
...
}), ws = (t, e, n) => qr(t, e).every((o) => n.includes(o));
function Fd({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = qr(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], d = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    U,
    {
      variant: "outline",
...
function zd({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], u = o["%webView_book_selector_more%"], { otLong: m, ntLong: f, dcLong: h, extraLong: v } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [b, y] = I(!1), [N, _] = I(""), k = G(void 0), $ = G(!1);
  if (t.length !== ht.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const j = z(() => ht.allBookIds.filter(
    (V, W) => t[W] === "1" && !ht.isObsolete(ht.bookIdToNumber(V))
  ), [t]), A = z(() => {
    if (!N.trim()) {
      const P = {
        [Q.OT]: [],
    ...
    (V, W = !1) => {
      if (!W || !k.current) {
        n(
          e.includes(V) ? e.filter((J) => J !== V) : [...e, V]
        ), k.current = V;
        return;
      }
      const P = j.findIndex((J) => J === k.current), tt = j.findIndex((J) => J === V);
      if (P === -1 || tt === -1) return;
      const [Et, B] = [
        Math.min(P, tt),
        Math.max(P, tt)
      ], at = j.slice(Et, B + 1).map((J) => J);
      n(
        e.includes(V) ? e.filter((J) => !at.includes(J)) : [.../* @__PURE__ */ new Set([...e, ...at])]
      );
    },
    [e, n, j]
  ), C = (V) => {
    R(V, $.current), $.current = !1;
  }, E = (V, W) => {
    V.preventDefault(), R(W, V.shiftKey);
  }, T = K(
    (V) => {
      const W = qr(j, V).map((P) => P);
      n(
        ws(j, V, e) ? e.filter((P) => !W.includes(P)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), S = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(Q).map((V) => /* @__PURE__ */ r(
      Fd,
      {
        section: V,
        availableBookIds: j,
            ...
            pe,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: S, children: c }),
                  /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: M, children: d })
                ] }),
                /* @__PURE__ */ p(ue, { children: [
                  /* @__PURE__ */ r(un, { children: w }),
                  Object.values(Q).map((V, W) => {
                    const P = A[V];
                    if (P.length !== 0)
                      return /* @__PURE__ */ p(Do, { children: [
                          ...
                          Jt,
                          {
                            ...
                            children: P.map((tt) => /* @__PURE__ */ r(
                              ha,
                              {
                                ...
                                onSelect: () => C(tt),
                                onMouseDown: (Et) => E(Et, tt),
                                section: nn(tt),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: pr(tt, a),
                                className: "tw-flex tw-items-center"
                              },
                              tt
                            ))
                        ...
                        W < Object.values(Q).length - 1 && /* @__PURE__ */ r(Rr, {})
                      ] }, V);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Qn ? Qn : Ro
      ).map((V) => /* @__PURE__ */ r(Se, { className: "hover:tw-bg-secondary", variant: "secondary", children: Le(V, a) }, V)),
      e.length > Qn && /* @__PURE__ */ r(
        Se,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - Ro} ${u}`
        }
      )
    ] })
  ] });
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Ie,
          {
            ...
            style: { zIndex: He },
            children: t.map((d) => /* @__PURE__ */ r(Pt, { value: `${d}`, children: l[nt(d)] }, `${d}`))
          }
        )
      ]
    }
...
const ps = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(kt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r(Nw, { children: /* @__PURE__ */ r(Wa, { children: ps(
      t,
      e,
      ds(t, l.id),
      o
...
function yr({
  ...
  return /* @__PURE__ */ p(de, { variant: i, children: [
    /* @__PURE__ */ r(be, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(ci, {}) }) }),
    /* @__PURE__ */ r(Qt, { align: "start", style: { zIndex: He }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ p(Do, { children: [
      /* @__PURE__ */ r(Ya, { children: /* @__PURE__ */ r(bt, { children: ps(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ r(We, {})
    ] }, c)) })
  ] });
}
...
const Bd = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Trigger,
  {
    ref: n,
    ...e,
...
function Hu({
  ...
  return /* @__PURE__ */ p("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(ms, { children: [
      /* @__PURE__ */ r(fs, { children: t.map((l) => /* @__PURE__ */ r(Bd, { value: l.value, children: l.value }, l.key)) }),
...
const Gd = x.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = Kt();
  return /* @__PURE__ */ p(
    lt.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(lt.ItemIndicator, { children: /* @__PURE__ */ r(zt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Gd.displayName = lt.CheckboxItem.displayName;
const qd = x.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Kt();
  return /* @__PURE__ */ p(
    lt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(lt.ItemIndicator, { children: /* @__PURE__ */ r(An, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
qd.displayName = lt.RadioItem.displayName;
const Hd = x.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  lt.Label,
  {
    ref: o,
    className: g("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Hd.displayName = lt.Label.displayName;
...
const tn = (t, e) => {
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ p(Nt, { children: [
      /* @__PURE__ */ r(kt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ p(
        Ns,
        {
          onClick: () => {
            o(d);
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ r(Mn, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ r(Mn, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ p(Ud, { children: [
        /* @__PURE__ */ r(vs, { children: d.label }),
      ...
      d.tooltip && /* @__PURE__ */ r(vt, { children: d.tooltip })
...
function Yd({
  ...
  const a = G(void 0), i = G(void 0), s = G(void 0), l = G(void 0), c = G(void 0), d = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (Sl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, u) => {
    var h, v, b, y;
    w.preventDefault();
    ...
    return /* @__PURE__ */ r(gs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w, u]) => /* @__PURE__ */ p(Kd, { children: [
      /* @__PURE__ */ r(bs, { ref: d(w), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        ys,
        {
          style: { zIndex: He },
          children: /* @__PURE__ */ r(bt, { children: _s(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Wu({
  ...
  const d = Xd(
    ...
    return b ? `${($ = t[h]) == null ? void 0 : $.autonym} (${b})` : (j = t[h]) == null ? void 0 : j.autonym;
  };
  return /* @__PURE__ */ p("div", { id: c, className: g("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(yt, { className: "tw-font-normal tw-text-muted-foreground", children: _e(d, {
...
function Hr({
  ...
  showTransliteration: d = !1,
  onCharacterPress: w,
  className: u
}) {
  const [m, f] = I(), h = G(null), v = a ?? m, b = z(
    () => m ? t.find((T) => T.id === m) : void 0,
    [m, t]
  ), y = z(() => t.map((T) => ({ id: T.id })), [t]), N = (T) => {
    o == null || o(T), n && f(T.id === m ? void 0 : T.id);
  }, _ = (T) => {
    const S = t.find((M) => M.id === T.id);
    S && N(S);
  }, { listboxRef: k, activeId: $, handleKeyDown: j, focusOption: A } = zr({
    options: y,
    onOptionSelect: _,
    onCharacterPress: w
  }), R = () => {
    const T = m;
    f(void 0), T && requestAnimationFrame(() => {
      var S;
      A(T), (S = k.current) == null || S.focus();
    });
  }, C = G(null);
  if (q(() => {
    if (!b) return;
    ...
    if (!T) return;
    const S = (M) => {
      M.key === "Escape" && (M.preventDefault(), R());
    };
    return T.addEventListener("keydown", S), () => T.removeEventListener("keydown", S);
  }, [b]), s)
    return /* @__PURE__ */ r("div", { className: g("tw-flex tw-flex-col tw-gap-2 tw-p-2", u), children: Array.from({ length: 6 }, (T, S) => /* @__PURE__ */ r(
      dn,
      {
      ...
      children: t.map((T) => {
        ...
        return /* @__PURE__ */ r(
          "li",
          {
            ...
            onClick: () => N(T),
            onKeyDown: (M) => {
              (M.key === "Enter" || M.key === " ") && (M.preventDefault(), N(T));
            },
            className: g(
            ...
            children: e ? e(T) : /* @__PURE__ */ r(
              Wd,
              {
                item: T,
                variant: l,
                showSourceLanguage: c,
                showTransliteration: d
              }
            )
          },
          T.id
  ...
  return /* @__PURE__ */ p("div", { ref: h, className: g("tw-relative tw-h-full tw-overflow-hidden", u), children: [
    /* @__PURE__ */ r("div", { className: "tw-h-full tw-overflow-y-auto", children: E }),
    n && b && /* @__PURE__ */ r(
      "div",
      {
        ref: C,
        ...
        children: /* @__PURE__ */ r("div", { className: "tw-h-full tw-overflow-y-auto tw-p-4", children: n(b, R) })
      }
    )
  ] });
}
function Wd({
  ...
  return /* @__PURE__ */ p(st, { children: [
    ...
    /* @__PURE__ */ r(Ft, { className: "tw-absolute tw-bottom-0 tw-left-0 tw-right-0" })
  ] });
}
const Ju = [
...
function Jd({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-0.5", children: [
    ...
    /* @__PURE__ */ r(Ft, { className: "tw-mt-1" })
  ] });
}
function Zd({
  className: t,
...
function Qu({
  ...
  const [m, f] = I(a), [h, v] = I(-1), b = G(null), y = G(null), [N, _] = I(!1), [k, $] = I(0);
  q(() => {
    const B = b.current;
    if (!B) return;
    const at = new ResizeObserver(([J]) => {
      const Z = (J == null ? void 0 : J.contentRect.width) ?? 0;
      $(Z), _(Z < 350);
    });
    return at.observe(B), () => at.disconnect();
  }, []);
  const j = k > 0 ? tp / k * 100 : 20, A = k > 0 ? ep / k * 100 : 30;
  q(() => {
    var B;
  ...
  const R = K(
    ...
    [d]
  ), C = t.find((B) => B.id === m), E = C && !N, T = C && N, S = K(
    (B) => {
    ...
    (B) => {
      ...
      const at = m ? t.findIndex((Z) => Z.id === m) : -1, J = h >= 0 ? h : at;
      if (B.key === "ArrowDown") {
        B.preventDefault();
        ...
        if (Z === h) return;
        v(Z), N || S(t[Z]);
      } else (B.key === "Enter" || B.key === " ") && N && h >= 0 && (B.preventDefault(), S(t[h]));
    },
    [t, h, N, S, m]
  ), V = K(() => {
    const B = m;
    if (f(void 0), B) {
      const at = t.findIndex((J) => J.id === B);
      at >= 0 && v(at), requestAnimationFrame(() => {
        var J;
  ...
  q(() => {
    var at;
    if (!N || !m) return;
    const B = (at = W.current) == null ? void 0 : at.querySelector("[data-back-to-list]");
    B == null || B.focus();
  }, [N, m]);
  const P = !!E;
  q(() => {
          ...
          /* @__PURE__ */ r(
            "li",
            {
              ...
              className: g("tw-cursor-pointer tw-border-b tw-p-2", {
                "tw-bg-muted": J,
                "hover:tw-bg-muted": !J,
                "tw-ring-1 tw-ring-inset tw-ring-ring": h === at && !J
              }),
  ...
  return /* @__PURE__ */ p("div", { className: g("tw-flex tw-h-full tw-flex-col tw-overflow-hidden", u), children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-px-2 tw-py-1.5", children: [
      ...
      w && /* @__PURE__ */ p(U, { variant: "ghost", size: "sm", className: "tw-shrink-0 tw-gap-1", onClick: w, children: [
    ...
    /* @__PURE__ */ r("div", { ref: b, className: "tw-relative tw-flex tw-flex-1 tw-overflow-hidden", children: np({
      ...
      showFullDetail: !!T,
      listElement: Et,
      detailElement: C && n ? n(C, V) : void 0,
      listMinPct: j,
      detailMinPct: A,
      detailPanelRef: W
    }) })
...
function np({
  ...
  return t && o !== void 0 ? /* @__PURE__ */ p(Zd, { direction: "horizontal", children: [
    /* @__PURE__ */ r(So, { defaultSize: 33.3333, minSize: a, children: /* @__PURE__ */ r("div", { className: "tw-h-full tw-overflow-y-auto", children: n }) }),
    /* @__PURE__ */ r(Qd, {}),
    /* @__PURE__ */ r(So, { defaultSize: 66.6667, minSize: i, children: /* @__PURE__ */ r("div", { className: "tw-h-full tw-overflow-y-auto tw-bg-background tw-p-4", children: o }) })
...
function rp({
  ...
  q(() => {
    ...
    if (!b || !y) return;
    const N = () => {
      const k = b.clientWidth, $ = Array.from(y.children).filter(
        (E) => E instanceof HTMLElement
      );
      if ($.length === 0) return;
      if ($.reduce((E, T) => E + T.offsetWidth, 0) <= k - 4) {
        s(0);
        return;
      }
      const A = $.map((E) => E.offsetWidth), R = t.length, C = 44;
      for (let E = 1; E < R; E += 1) {
        let T = C;
        if (E < R - 1) {
          T += A[0] ?? 0;
          for (let S = E + 1; S < R; S += 1) T += A[S] ?? 0;
        } else
          T += A[R - 1] ?? 0;
        if (T <= k - 4) {
          s(E);
  ...
  const l = i > 0, c = i >= t.length - 1, w = l ? c ? t.slice(0, -1) : t.slice(1, i + 1) : [], u = w.map((b) => b.label).join(" > "), m = ((f = w[0]) == null ? void 0 : f.id) ?? ((h = t[0]) == null ? void 0 : h.id);
  return /* @__PURE__ */ p("div", { ref: o, className: "tw-overflow-hidden", children: [
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: t.map((b, y) => /* @__PURE__ */ p("span", { className: "tw-flex tw-shrink-0 tw-items-center tw-gap-0.5", children: [
          y > 0 && /* @__PURE__ */ r(Xt, { className: "tw-h-3 tw-w-3" }),
    ...
    /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-center tw-gap-0.5", children: [
      ...
      l && /* @__PURE__ */ p(st, { children: [
        !c && /* @__PURE__ */ r(Xt, { className: "tw-h-3 tw-w-3 tw-shrink-0 tw-text-muted-foreground" }),
      ...
      t.map((b, y) => {
        ...
        if (!(y <= i && !N))
          return /* @__PURE__ */ p("span", { className: "tw-flex tw-shrink-0 tw-items-center tw-gap-0.5", children: [
            /* @__PURE__ */ r(Xt, { className: "tw-h-3 tw-w-3 tw-shrink-0 tw-text-muted-foreground" }),
            /* @__PURE__ */ r(
              er,
              {
                label: b.label,
  ...
  return /* @__PURE__ */ p(de, { open: l, onOpenChange: c, modal: !0, children: [
    ...
    /* @__PURE__ */ r(
      Qt,
      {
        ...
        style: { zIndex: la + 10 },
        onEscapeKeyDown: (w) => {
          w.stopPropagation(), w.preventDefault(), c(!1);
        },
        onKeyDown: (w) => {
...
function op({
  ...
  const l = () => i.current ? Array.from(i.current.querySelectorAll("button")) : [], c = (w) => {
    const u = l();
    if (u.length === 0) return;
    const m = document.activeElement;
    let h = (m instanceof HTMLButtonElement ? u.indexOf(m) : -1) + w;
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { ref: i, onKeyDown: (w) => {
      switch (w.key) {
        case "ArrowDown":
          w.preventDefault(), w.stopPropagation(), w.nativeEvent.stopImmediatePropagation(), c(1);
          break;
        case "ArrowUp":
          w.preventDefault(), w.stopPropagation(), w.nativeEvent.stopImmediatePropagation(), c(-1);
          break;
        case "Tab":
          w.preventDefault(), w.stopPropagation(), w.nativeEvent.stopImmediatePropagation(), c(w.shiftKey ? -1 : 1);
          break;
        case "Escape":
          w.preventDefault(), w.stopPropagation(), w.nativeEvent.stopImmediatePropagation(), a();
          break;
      }
    }, children: /* @__PURE__ */ r(
      Es,
...
function Cs(t, e) {
  var n;
  return t.id === e ? !0 : ((n = t.children) == null ? void 0 : n.some((o) => Cs(o, e))) ?? !1;
}
function Es({
  domains: t,
  currentPath: e,
  ...
  return /* @__PURE__ */ r("ul", { className: g("tw-space-y-0.5", { "tw-ml-3": a.length > 0 }), children: t.map((s) => {
    const l = [...a, s], c = s.id === n, d = s.children && s.children.length > 0, u = Cs(s, n) && s.id !== n, m = s.id === n;
    return /* @__PURE__ */ r(
      ap,
      {
        domain: s,
...
function ap({
  ...
  return q(() => {
    a && u(!0);
  }, [a]), /* @__PURE__ */ p("li", { children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-0.5", children: [
      o ? /* @__PURE__ */ r(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ r(
        "button",
        {
          ...
          className: g(
            ...
            n ? "tw-bg-accent tw-font-medium" : "hover:tw-bg-muted"
          ),
          onClick: () => l(e),
          children: t.label
        }
    ...
    w && t.children && t.children.length > 0 && /* @__PURE__ */ r(
      Es,
      {
        domains: t.children,
        currentPath: i,
...
function nm({
  ...
  const d = z(() => t.map((h) => ({ id: h.id })), [t]), w = (h) => {
    const v = t.find((b) => b.id === h.id);
    v && (e == null || e(v));
  }, { listboxRef: u, activeId: m, handleKeyDown: f } = zr({
    options: d,
    onOptionSelect: w,
    onCharacterPress: i
  });
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && m && d && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(de, { children: [
              /* @__PURE__ */ r(be, { className: g(u && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(U, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Qr, {}) }) }),
              /* @__PURE__ */ r(Qt, { align: "end", children: d })
            ] }) }),
            e && d && /* @__PURE__ */ p(de, { children: [
              /* @__PURE__ */ r(be, { className: g(u && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(U, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Qr, {}) }) }),
              /* @__PURE__ */ r(Qt, { align: "end", children: d })
            ] })
          ] }),
...
const ip = pn(({ className: t, ...e }, n) => /* @__PURE__ */ r(ui, { size: 35, className: g("tw-animate-spin", t), ...e, ref: n }));
...
const hp = x.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ct.CheckboxItem,
  {
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ct.ItemIndicator, { children: /* @__PURE__ */ r(zt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
...
const gp = x.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ct.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ct.ItemIndicator, { children: /* @__PURE__ */ r(An, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
...
function yp({
  ...
  return /* @__PURE__ */ r(Ts.Provider, { value: o, children: /* @__PURE__ */ r(
    Bt.Root,
    {
...
const pm = Bt.Trigger, Np = Bt.Portal, um = Bt.Close, Rs = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Overlay,
  {
    ref: n,
...
Rs.displayName = Bt.Overlay.displayName;
const kp = x.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, container: o, ...a }, i) => {
  const { direction: s = "bottom" } = x.useContext(Ts), l = o ? "tw-absolute" : "tw-fixed", c = {
  ...
  return /* @__PURE__ */ p(Np, { container: o, children: [
    ...
    /* @__PURE__ */ p(
      Bt.Content,
      {
        ...
        ...a,
        children: [
          !n && (s === "bottom" || s === "right") && /* @__PURE__ */ r("div", { className: d[s] }),
          /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-col", children: e }),
          !n && (s === "top" || s === "left") && /* @__PURE__ */ r("div", { className: d[s] })
        ]
      }
    )
  ] });
...
Ep.displayName = Bt.Title.displayName;
...
Tp.displayName = Bt.Description.displayName;
...
Rp.displayName = wr.Root.displayName;
function mm({ ...t }) {
  return /* @__PURE__ */ r(
    Dl,
    {
...
Dp.displayName = dr.Root.displayName;
...
export {
  ...
  Qd as ResizableHandle,
  So as ResizablePanel,
  Zd as ResizablePanelGroup,
  om as ResultsCard,
  ...
  os as SidebarInset,
  ss as SidebarMenu,
  Ed as SidebarMenuAction,
  Td as SidebarMenuBadge,
  ls as SidebarMenuButton,
  is as SidebarMenuItem,
  Rd as SidebarMenuSkeleton,
  Sd as SidebarMenuSub,
  Id as SidebarMenuSubButton,
  Dd as SidebarMenuSubItem,
  ns as SidebarProvider,
  vd as SidebarRail,
  kd as SidebarSeparator,
  bd as SidebarTrigger,
  dn as Skeleton,
  Sp as Slider,
  mm as Sonner,
  Hr as SourceLanguageIndexedList,
  ip as Spinner,
  Dp as Switch,
  ...
  Gw as UNDO_REDO_BUTTONS_STRING_KEYS,
