import cl, { jsx as i, jsxs as N, Fragment as oe } from "react/jsx-runtime";
import * as B from "react";
import E, { forwardRef as lr, useCallback as St, useState as ut, useRef as Ht, useEffect as ce, useLayoutEffect as ha, useMemo as Rt } from "react";
...
const No = ft.Root, Ti = ft.Trigger, ac = ft.Group, eh = ft.Portal, nh = ft.Sub, rh = ft.RadioGroup, ic = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  ft.SubTrigger,
  {
    ref: o,
    className: y(
...
function Yc({
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(fr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(mr, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ i(le, { children: k.headers.map((T) => /* @__PURE__ */ i(En, { children: T.isPlaceholder ? void 0 : bn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
...
function lh({
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(_n, { size: 15 }) : /* @__PURE__ */ N(oe, { children: [
...
const gr = (t) => t === "asc" ? /* @__PURE__ */ i(Ol, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(_l, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Pl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), bh = (t) => ({
  accessorKey: "item",
  ...
  return td(t).forEach((p) => {
    ...
    for (; f; ) {
      ...
      const h = f.index, b = a.find((g) => xo(g.items, w)), m = {
        ...
        text: Vl(p, Math.max(0, h - 25), Math.min(h + 25, p.length))
      };
      if (b)
    ...
    qi,
    {
      ...
      children: /* @__PURE__ */ N(Ki, { children: [
        /* @__PURE__ */ N(io, { children: [
          ...
          /* @__PURE__ */ i(lo, { children: /* @__PURE__ */ i(Ji, { children: Object.entries(e).map(([w, h]) => /* @__PURE__ */ i(Zi, { children: /* @__PURE__ */ i(
            Qi,
            {
              className: y(
...
const ie = "scrBook", Cd = "scrRef", he = "source", Rd = "details", Od = "Scripture Reference", _d = "Scripture Book", es = "Type", Pd = "Details";
function Id(t, e) {
  const n = e ?? !1;
  return [
    {
...
function Fd({
  ...
  if (Xl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, p) => {
    var h, b, m, g;
    d.preventDefault();
    ...
    return /* @__PURE__ */ i(is, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, p]) => typeof d == "boolean" || typeof p == "boolean" ? 0 : d.order - p.order).map(([d, p]) => /* @__PURE__ */ N(Ad, { children: [
      /* @__PURE__ */ i(ss, { ref: l(d), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ i(ds, { children: ws(t.groups, t.items, d, e) })
    ] }, d)) });
}
function _h(t) {
  switch (t) {
...
const Lp = Ut("border", zt), Gp = Ut("borderTop", zt), Up = Ut("borderRight", zt), Xp = Ut("borderBottom", zt), Yp = Ut("borderLeft", zt), Hp = Ut("borderColor"), qp = Ut("borderTopColor"), Wp = Ut("borderRightColor"), Kp = Ut("borderBottomColor"), Jp = Ut("borderLeftColor"), Zp = Ut("outline", zt), Qp = Ut("outlineColor"), Sr = (t) => {
...
function qu(t) {
  ...
  function f(m) {
    const g = Ha(m, Zr.text.primary) >= n ? Zr.text.primary : qa.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Ha(m, g);
...
const uw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], ww = (t) => {
  ...
  const r = Ho({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, h = Et(r, uw), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
var Ot = "top", Lt = "bottom", Gt = "right", _t = "left", qo = "auto", Dn = [Ot, Lt, Gt, _t], He = "start", Cn = "end", Aw = "clippingParents", As = "viewport", un = "popper", Dw = "reference", ni = /* @__PURE__ */ Dn.reduce(function(t, e) {
...
function jn(t) {
  for (var e = jt(t), n = ri(t); n && Kw(n) && re(n).position === "static"; )
    n = ri(n);
...
function tf(t) {
  ...
  if (!(!a || !s)) {
    var f = Qw(o.padding, n), w = Ko(a), h = c === "y" ? Ot : _t, b = c === "y" ? Lt : Gt, m = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = jn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - g / 2, S = f[h], v = T - w[p] - f[b], P = T / 2 - w[p] / 2 + C, F = yn(S, P, v), R = c;
...
function oi(t) {
  ...
  if (d) {
    ...
    if (P === jt(n) && (P = pe(n), re(P).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), P = P, o === Ot || (o === _t || o === Gt) && a === Cn) {
      S = Lt;
...
function Ls(t) {
  return ["html", "body", "#document"].indexOf(Zt(t)) >= 0 ? t.ownerDocument.body : Ft(t) && ta(t) ? t : Ls(Pr(t));
}
function xn(t, e) {
  var n;
  e === void 0 && (e = []);
...
function mf(t) {
  var e = xn(Pr(t)), n = ["absolute", "fixed"].indexOf(re(t).position) >= 0, r = n && Ft(t) ? jn(t) : t;
...
function Rn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Aw : l, d = n.rootBoundary, p = d === void 0 ? As : d, f = n.elementContext, w = f === void 0 ? un : f, h = n.altBoundary, b = h === void 0 ? !1 : h, m = n.padding, g = m === void 0 ? 0 : m, k = zs(typeof g != "number" ? g : Fs(g, Dn)), T = w === un ? Dw : un, C = t.rects.popper, S = t.elements[b ? T : w], v = hf(Ce(S) ? S : S.contextElement || pe(t.elements.popper), c, p, s), P = We(t.elements.reference), F = Gs({
    reference: P,
    element: C,
    placement: o
...
function vf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, h = n.flipVariations, b = h === void 0 ? !0 : h, m = n.allowedAutoPlacements, g = e.options.placement, k = Wt(g), T = k === g, C = c || (T || !b ? [Qn(g)] : bf(g)), S = [g].concat(C).reduce(function(z, K) {
...
function Of(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, h = w === void 0 ? !0 : w, b = n.tetherOffset, m = b === void 0 ? 0 : b, g = Rn(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Wt(e.placement), T = Ke(e.placement), C = !T, S = Jo(k), v = Rf(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    ...
    if (l) {
      var ue, Tt = S === "x" ? Ot : _t, Bn = S === "x" ? Lt : Gt, Yt = P[v], _e = v === "y" ? "height" : "width", we = Yt + g[Tt], Pe = Yt - g[Bn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = Ie ? we : Yt - F[_e] - R[_e] - $e + L.altAxis, nn = Ie ? Yt + F[_e] + R[_e] - $e - L.altAxis : Pe, Vn = h && Ie ? Zw(fe, Yt, nn) : yn(h ? fe : we, Yt, h ? nn : Pe);
      P[v] = Vn, tt[v] = Vn - Yt;
    }
...
function Mf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && $f(e), a = pe(e), s = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  ta(a)) && (l = If(e)), Ft(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Qo(a))), {
...
var Qf = function(e) {
  return e.scrollTop;
}, gn = "unmounted", ge = "exited", be = "entering", ze = "entered", mo = "exiting", ae = /* @__PURE__ */ function(t) {
  Jf(e, t);
  function e(r, o) {
    var a;
...
const se = Cs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), im = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function sm(t) {
  return Math.round(t * 1e5) / 1e5;
}
const lm = (t) => {
...
const Hs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = Ho({
    ...
    children: R
  }), Xt = Xs(), ue = Xt.direction === "rtl", [Tt, Bn] = B.useState(), [Yt, _e] = B.useState(null), we = B.useRef(!1), Pe = j || rt, Ie = mn(), $e = mn(), fe = mn(), nn = mn(), [Vn, na] = Ns({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const $r = xs(x), rn = B.useRef(), zn = co(() => {
  ...
  const ra = (et) => {
    ...
    (et) => {
      wi.start(800 + O, () => {
        qn = !1;
      }), na(!1), X && Qt && X(et), Ie.start(Xt.transitions.duration.shortest, () => {
        we.current = !1;
      });
    }
  ), Mr = (et) => {
    ...
    ca(et), fe.clear(), Ie.clear(), zn(), rn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", nn.start(H, () => {
      document.body.style.WebkitUserSelect = rn.current, Mr(et);
    });
  }, el = (et) => {
  ...
  }, on = {}, Dr = typeof dt == "string";
  D ? (on.title = !Qt && Dr && !J ? dt : null, on["aria-describedby"] = Qt ? $r : null) : (on["aria-label"] = Dr ? dt : null, on["aria-labelledby"] = Qt && !Dr ? $r : null);
...
`));
  ...
  const an = {};
  M || (Bt.onTouchStart = tl, Bt.onTouchEnd = el), J || (Bt.onMouseOver = Wn(da, Bt.onMouseOver), Bt.onMouseLeave = Wn(pa, Bt.onMouseLeave), Pe || (an.onMouseOver = da, an.onMouseLeave = pa)), tt || (Bt.onFocus = Wn(la, Bt.onFocus), Bt.onBlur = Wn(sa, Bt.onBlur), Pe || (an.onFocus = la, an.onBlur = sa)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const ol = B.useMemo(() => {
    var et;
    let $t = [{
    ...
    touch: we.current
  }), jr = lm(sn), ua = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : cm, wa = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : sr, fa = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : dm, ma = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : pm, al = hn(ua, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ye(jr.popper, Y == null ? void 0 : Y.className, (h = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : h.className)
  }), sn), il = hn(wa, _({}, kt, (m = Z.transition) != null ? m : L.transition), sn), sl = hn(fa, _({}, (g = Z.tooltip) != null ? g : L.tooltip, {
    className: ye(jr.tooltip, (k = (T = Z.tooltip) != null ? T : L.tooltip) == null ? void 0 : k.className)
  }), sn), ll = hn(ma, _({}, (C = Z.arrow) != null ? C : L.arrow, {
...
km.displayName = Qe.Root.displayName;
...
Em.displayName = Qe.Image.displayName;
...
Sm.displayName = Qe.Fallback.displayName;
...
const Om = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Im = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ N(
    fn.Root,
    {
...
Im.displayName = fn.Root.displayName;
...
$m.displayName = ro.Root.displayName;
const Bh = It.Root, Mm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    It.List,
    {
...
Mm.displayName = It.List.displayName;
const Am = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Trigger,
  {
    ref: n,
    className: y(
...
Am.displayName = It.Trigger.displayName;
...
Dm.displayName = It.Content.displayName;
const Vh = (t, e) => {
  ce(() => {
    if (!t) return () => {
    };
