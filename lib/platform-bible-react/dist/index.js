import Il, { jsxs as j, jsx as m, Fragment as Bt } from "react/jsx-runtime";
...
function xv({ scrRef: e, handleSubmit: t }) {
  const [n, r] = ie(""), [o, a] = ie(
    ...
    (k) => Jc(k).filter((O) => {
      const $ = me.bookIdToEnglishName(O).toLowerCase(), F = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    /* @__PURE__ */ j(
      No,
      {
        ...
        children: [
          ...
          ba.map(
            (k, O) => x(k).length > 0 && /* @__PURE__ */ j("div", { children: [
...
function kp() {
  return wa || (wa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, C = u, N = l, I = i, D = t, L = f, k = r, O = h, $ = p, F = n, H = a, _ = o, z = v, te = !1;
    function Q(B) {
...
function Bp() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var C = i, N = a, I = e, D = c, L = n, k = g, O = v, $ = t, F = o, H = r, _ = u, z = f, te = !1, Q = !1;
    function S(A) {
...
const Gp = typeof window < "u" ? T.useLayoutEffect : T.useEffect, Mt = Gp;
let $a = 0;
function Wp(e) {
...
function Iu(e) {
  ...
  const E = () => Se(p.current), y = () => (g.current.modalRef = h.current, g.current.mount = p.current, g.current), C = () => {
    ...
    p.current = _, _ && (f && I() ? C() : h.current && kn(h.current, w));
  }), L = T.useCallback(() => {
    o.remove(y(), w);
  }, [w, o]);
  T.useEffect(() => () => {
...
function ed(e) {
  ...
  if (!(!a || !i)) {
    var v = Qu(o.padding, n), g = $o(a), p = c === "y" ? Me : Ie, h = c === "y" ? Xe : qe, d = n.rects.reference[f] + n.rects.reference[c] - i[c] - n.rects.popper[f], b = i[c] - n.rects.reference[c], x = Ln(a), P = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = d / 2 - b / 2, E = v[p], y = P - g[f] - v[h], C = P / 2 - g[f] / 2 + w, N = Tn(E, C, y), I = c;
...
function Va(e) {
  ...
  if (u) {
    var C = Ln(n), N = "clientHeight", I = "clientWidth";
    if (C === ze(n) && (C = wt(n), ct(C).position !== "static" && l === "absolute" && (N = "scrollHeight", I = "scrollWidth")), C = C, o === Me || (o === Ie || o === qe) && a === Mn) {
      E = Xe;
...
function Io(e) {
  return en(wt(e)).left + Mo(e).scrollLeft;
}
function ud(e, t) {
...
function dd(e) {
  var t, n = wt(e), r = Mo(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = $t(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = $t(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Io(e), c = -r.scrollTop;
...
function In(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Au : l, u = n.rootBoundary, f = u === void 0 ? gs : u, v = n.elementContext, g = v === void 0 ? dn : v, p = n.altBoundary, h = p === void 0 ? !1 : p, d = n.padding, b = d === void 0 ? 0 : d, x = xs(typeof b != "number" ? b : Es(b, jn)), P = g === dn ? Du : dn, w = e.rects.popper, E = e.elements[h ? P : g], y = hd(At(E) ? E : E.contextElement || wt(e.elements.popper), c, f, i), C = en(e.elements.reference), N = Ts({
    reference: C,
    element: w,
    strategy: "absolute",
    placement: o
  }), I = po(Object.assign({}, w, N)), D = g === dn ? I : C, L = {
...
function vd(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, u = n.padding, f = n.boundary, v = n.rootBoundary, g = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, d = n.allowedAutoPlacements, b = t.options.placement, x = Ze(b), P = x === b, w = c || (P || !h ? [Qn(b)] : bd(b)), E = [b].concat(w).reduce(function(W, X) {
      ...
      var k = E[L], O = Ze(k), $ = tn(k) === Zt, F = [Me, Xe].indexOf(O) >= 0, H = F ? "width" : "height", _ = In(t, {
        placement: k,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
...
function Sd(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, u = n.rootBoundary, f = n.altBoundary, v = n.padding, g = n.tether, p = g === void 0 ? !0 : g, h = n.tetherOffset, d = h === void 0 ? 0 : h, b = In(t, {
    ...
    padding: v,
    altBoundary: f
  }), x = Ze(t.placement), P = tn(t.placement), w = !P, E = _o(x), y = Od(E), C = t.modifiersData.popperOffsets, N = t.rects.reference, I = t.rects.popper, D = typeof d == "function" ? d(Object.assign({}, t.rects, {
    placement: t.placement
  })) : d, L = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (C) {
    if (a) {
      var $, F = E === "y" ? Me : Ie, H = E === "y" ? Xe : qe, _ = E === "y" ? "height" : "width", z = C[E], te = z + b[F], Q = z - b[H], S = p ? -I[_] / 2 : 0, M = P === Zt ? N[_] : I[_], U = P === Zt ? -I[_] : -N[_], Y = t.elements.arrow, W = p && Y ? $o(Y) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ws(), K = X[F], J = X[H], q = Tn(0, N[_], W[_]), Z = w ? N[_] / 2 - S - q - K - L.mainAxis : M - q - K - L.mainAxis, ee = w ? -N[_] / 2 + S + q + J + L.mainAxis : U + q + J + L.mainAxis, se = t.elements.arrow && Ln(t.elements.arrow), B = se ? E === "y" ? se.clientTop || 0 : se.clientLeft || 0 : 0, ne = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, A = z + Z - ne - B, le = z + ee - ne, Te = Tn(p ? cr(te, A) : te, z, p ? $t(Q, le) : Q);
      C[E] = Te, O[E] = Te - z;
    }
    if (l) {
      var Pe, xe = E === "x" ? Me : Ie, Et = E === "x" ? Xe : qe, $e = C[y], rt = y === "y" ? "height" : "width", Be = $e + b[xe], ot = $e - b[Et], Ne = [Me, Ie].indexOf(x) !== -1, jt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, kt = Ne ? Be : $e - N[rt] - I[rt] - jt + L.altAxis, on = Ne ? $e + N[rt] + I[rt] - jt - L.altAxis : ot, Un = p && Ne ? Zu(kt, $e, on) : Tn(p ? kt : Be, $e, p ? on : ot);
      C[y] = Un, O[y] = Un - $e;
    }
    t.modifiersData[r] = O;
  }
...
const Wd = () => ut({
  ...
  const C = Hd(f, i), [N, I] = T.useState(C), [D, L] = T.useState(pr(o));
  T.useEffect(() => {
...
`));
  ...
  const O = Wd(), $ = (r = h.root) != null ? r : "div", F = It({
    elementType: $,
...
function rm(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const P = Ec(i, R({
      shouldForwardProp: x,
      label: b
    }, p)), w = (y) => typeof y == "function" && y.__emotion_real !== y || St(y) ? (C) => tr(y, R({}, C, {
      theme: Yn({
        theme: C.theme,
        defaultTheme: n,
        themeId: t
...
const Jm = {
  ...
  } = t, x = he(t, Km), P = vn(), w = T.useRef(), E = zn(), y = T.useRef(null), C = We(y, a.ref, n), N = (H) => (_) => {
    if (H) {
      const z = y.current;
      _ === void 0 ? H(z) : H(z, _);
    }
...
const ho = Ho, Zm = (e) => {
  ...
  const o = Ps(), a = dt({
    ...
    slots: w,
    slotProps: E
  } = a, y = he(a, Qm), C = (r = w == null ? void 0 : w.root) != null ? r : c == null ? void 0 : c.Root, N = R({
    anchorEl: i,
    container: f,
    disablePortal: v,
    keepMounted: g,
...
const js = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const C = dt({
    ...
    TransitionProps: ne
  } = C, A = he(C, rh), le = /* @__PURE__ */ T.isValidElement(I) ? I : /* @__PURE__ */ m("span", {
    children: I
...
`));
  ...
  const Jo = (re) => {
    ...
    xe || Et(re.currentTarget), kl(re), Qo.current === !0 && (ea(!0), Mr(re));
  }, ra = (re) => {
    Be.current = !0;
    const je = le.props;
    ...
    ra(re), kt.clear(), Ne.clear(), Hn(), an.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", on.start(te, () => {
      document.body.style.WebkitUserSelect = an.current, Mr(re);
    });
  }, Cl = (re) => {
...
const Xs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const d = (w) => {
    ...
    if (y === "ArrowDown")
      w.preventDefault(), hn(E, C, u, c, Kr);
    else if (y === "ArrowUp")
      w.preventDefault(), hn(E, C, u, c, ci);
    else if (y === "Home")
      ...
      N.previousKeyMatched && (L || hn(E, C, !1, c, Kr, N)) ? w.preventDefault() : N.previousKeyMatched = !1;
    }
    f && f(w);
  }, b = We(p, n);
  let x = -1;
...
const Ih = Xs, Ah = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Dh = {
  ...
  } = t, w = he(t, Ah), E = T.useRef(null), y = We(E, l.ref, n), C = (F) => (H) => {
    if (F) {
      const _ = E.current;
      H === void 0 ? F(_) : F(_, H);
    }
...
const Hh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Gh = (e) => {
  ...
  const J = (r = (o = F == null ? void 0 : F.root) != null ? o : x.Root) != null ? r : Wh, q = (a = (i = F == null ? void 0 : F.backdrop) != null ? i : x.Backdrop) != null ? a : f, Z = (l = $ == null ? void 0 : $.root) != null ? l : P.root, ee = (c = $ == null ? void 0 : $.backdrop) != null ? c : P.backdrop, se = It({
    elementType: J,
    externalSlotProps: Z,
  ...
  return !L && !O && (!Y || U) ? null : /* @__PURE__ */ m(_n, {
    ref: S,
    container: d,
    disablePortal: C,
...
const og = (e) => {
  ...
  const i = dt({
    ...
    TransitionComponent: C = ho,
    transitionDuration: N = "auto",
    TransitionProps: {
      onEntering: I
    } = {},
    disableScrollLock: D = !1
  } = i, L = he(i.TransitionProps, tg), k = he(i, ng), O = (r = E == null ? void 0 : E.paper) != null ? r : P, $ = T.useRef(), F = We($, O.ref), H = R({}, i, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: d,
    marginThreshold: b,
...
`)), b !== null && xe < b) {
  ...
  const K = h || (c ? Se(nr(c)).body : void 0), J = (o = w == null ? void 0 : w.root) != null ? o : ag, q = (a = w == null ? void 0 : w.paper) != null ? a : Zs, Z = It({
    elementType: q,
...
const lg = ["onEntering"], cg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], pg = {
  ...
  const a = dt({
    ...
    slots: P = {},
    slotProps: w = {}
  } = a, E = he(a.TransitionProps, lg), y = he(a, cg), C = zn(), N = C.direction === "rtl", I = R({}, a, {
    autoFocus: i,
...
`)), Q.props.disabled || (x === "selectedMenu" && Q.props.selected || F === -1) && (F = S));
  ...
  const H = (r = P.paper) != null ? r : mg, _ = (o = w.paper) != null ? o : p, z = It({
    elementType: P.root,
...
function Cv({
  ...
  return /* @__PURE__ */ j("div", { className: "pr-twp pr-flex pr-h-full pr-w-full pr-flex-col", children: [
    !t && /* @__PURE__ */ j(
      or,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(Pn, { position: "item-aligned", children: /* @__PURE__ */ m(op, { children: C.map((k) => /* @__PURE__ */ m(Ke, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ j(br, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ m(vr, { children: w.getHeaderGroups().map((k) => /* @__PURE__ */ m(vt, { children: k.headers.filter((O) => O.column.columnDef.header).map((O) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ m(Sn, { colSpan: O.colSpan, className: "top-0 pr-sticky", children: O.isPlaceholder ? void 0 : /* @__PURE__ */ j("div", { children: [
      ...
      /* @__PURE__ */ m(yr, { children: w.getRowModel().rows.map((k, O) => /* @__PURE__ */ m(
        vt,
        {
...
function Iv({
  ...
  return Fe(() => {
    ...
    /* @__PURE__ */ j("div", { className: "pr-flex", children: [
      ...
      /* @__PURE__ */ j(or, { onValueChange: (_) => C(_), defaultValue: y, children: [
...
var ae;
function Vb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Mb, t.namedCodesToUnicode = t.namedCodesToUnicode ? Rt({}, hi, t.namedCodesToUnicode) : hi;
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(d, b, x) {
      ...
      if (P !== -1) {
        ...
        typeof C == "string" && (bo.test(C) || vo.test(C)) && (d[y] = T.cloneElement(o(C.trim()), { key: x }));
      } else
        b !== "style" && (d[mi[b] || b] = !0);
      return d;
    }, {}) : null;
