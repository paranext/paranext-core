...
var wi = (t, e, r) => e in t ? di(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Nt = (t, e, r) => wi(t, typeof e != "symbol" ? e + "" : e, r);
import { jsx as a, jsxs as u, Fragment as et } from "react/jsx-runtime";
import { Command as $e } from "cmdk";
import { clsx as ui } from "clsx";
import { extendTailwindMerge as pi, twMerge as gi } from "tailwind-merge";
import { Slot as ke, Dialog as Yt, Popover as rr, Label as hi, RadioGroup as aa, Tooltip as Le, ToggleGroup as $o, Separator as fi, Avatar as Na, DropdownMenu as vt, Select as Et, Checkbox as qa, Tabs as Kt, Menubar as Qt, ContextMenu as bt, Progress as Ha, Slider as dr, Switch as Wa } from "radix-ui";
import { cva as te } from "class-variance-authority";
import { IconX as mi, IconCheck as Me, IconSearch as vi, IconChevronRight as Ca, IconChevronDown as bi, IconChevronUp as xi, IconSelector as yi, IconLayoutSidebar as ki, IconLayoutSidebarRight as _i, IconLoader as Ni, IconAlertOctagon as Ci, IconAlertTriangle as Ei, IconInfoCircle as zi, IconCircleCheck as Ti } from "@tabler/icons-react";
import { Canon as lt } from "@sillsdev/scripture";
import { includes as wr, Section as Y, getChaptersForBook as Si, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as Di, formatReplacementString as oe, sanitizeHtml as Ri, NumberFormat as $i, formatBytes as Mi, getCurrentLocale as Oi, usfmMarkers as mr, getFormatCallerFunction as Ai, deepEqual as Ii, isString as Ya, compareScrRefs as oa, scrRefToBBBCCCVVV as Br, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
import { Check as nr, Clock as Xa, ChevronsLeft as Ja, ChevronsRight as Za, ChevronLeft as na, ChevronRight as ia, ArrowLeft as Pi, ArrowRight as Li, ChevronDown as Rr, BoldIcon as Vi, ItalicIcon as ji, X as $r, AtSign as Mo, Pencil as Fi, Trash2 as Bi, ArrowUp as Oo, MoreHorizontal as Ui, MailOpen as Ki, Mail as Gi, ChevronUp as qi, FilterIcon as Hi, ArrowLeftIcon as Wi, ChevronLeftIcon as Yi, ChevronRightIcon as Xi, ArrowRightIcon as Ji, Copy as Ao, Filter as Zi, User as Qi, Link as ts, CircleHelp as es, ChevronsUpDown as Io, Star as rs, Undo as as, Redo as os, SquareX as Po, FunctionSquare as Lo, SquareSigma as Vo, Ban as ns, AlertCircle as sa, CircleCheckIcon as is, CircleXIcon as ss, CircleHelpIcon as ls, ArrowUpIcon as cs, ArrowDownIcon as ds, Search as ws, LoaderCircle as us, ScrollText as ps, MenuIcon as gs, Menu as hs, EllipsisVertical as fs, MoreVertical as Qa } from "lucide-react";
import tt, { forwardRef as ir, useRef as G, useMemo as P, useState as T, useCallback as j, useLayoutEffect as At, createContext as Mr, useContext as Ea, useEffect as K, Component as ms, createElement as to, Suspense as vs, Fragment as jo } from "react";
import { createEditor as Fo, $getRoot as le, $createParagraphNode as We, $getSelection as Tt, HISTORY_MERGE_TAG as za, ParagraphNode as Bo, TextNode as Uo, $isTokenOrSegmented as bs, $getCharacterOffsets as xs, $cloneWithPropertiesEphemeral as ys, $getPreviousSelection as ks, $isRangeSelection as Xt, $caretFromPoint as _s, $getSiblingCaret as Ko, $getChildCaret as Ns, $getAdjacentChildCaret as Cs, $isChildCaret as Es, $normalizeCaret as zs, $setSelectionFromCaretRange as Ts, $getCollapsedCaretRange as Ss, $getCaretInDirection as eo, $splitAtPointCaretNext as Ds, $isTextPointCaret as Rs, $findMatchingParent as Go, $isElementNode as ie, mergeRegister as ce, getDOMTextNode as $s, isHTMLElement as qo, CLEAR_EDITOR_COMMAND as Ho, COMMAND_PRIORITY_EDITOR as Ta, shallowMergeConfig as Ms, defineExtension as jt, safeCast as Oe, createState as Os, FORMAT_TEXT_COMMAND as Wo, $isNodeSelection as Yo, COMMAND_PRIORITY_LOW as Xo, RootNode as As, LineBreakNode as Is, TabNode as Ps, $isEditorState as Ls, createCommand as Vs, CLICK_COMMAND as js, isDOMNode as Fs, $getNodeFromDOMNode as Bs, $createNodeSelection as Us, $setSelection as Ks, $getEditor as Gs, DecoratorNode as la, $getState as qs, toggleTextFormatType as ro, TEXT_TYPE_TO_FORMAT as Hs, $setState as Ws, addClassNamesToElement as Jo, $create as Ys, $getNodeByKey as Xs, removeClassNamesFromElement as Js, KEY_TAB_COMMAND as Zs, $isBlockElementNode as yr, $createRangeSelection as Qs, $normalizeSelection__EXPERIMENTAL as tl, OUTDENT_CONTENT_COMMAND as el, INDENT_CONTENT_COMMAND as ao, INSERT_TAB_COMMAND as rl, COMMAND_PRIORITY_CRITICAL as Sa, $isDecoratorNode as al, $isParagraphNode as ol, $isTextNode as kr, SELECTION_CHANGE_COMMAND as Zo, getRegisteredNode as nl, isDocumentFragment as oo, isDOMDocumentNode as il, ArtificialNode__DO_NOT_USE as Qo, $createLineBreakNode as tn, $isRootOrShadowRoot as sl, isBlockDomNode as no, isInlineDomNode as io, $insertNodes as ll } from "lexical";
...
import { useReactTable as rn, getFilteredRowModel as hl, getSortedRowModel as an, getPaginationRowModel as fl, getCoreRowModel as on, flexRender as tr, getGroupedRowModel as ml, getExpandedRowModel as vl } from "@tanstack/react-table";
import bl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ca, HIDDEN_NOTE_CALLER as da, getDefaultViewOptions as xl, isInsertEmbedOpOfType as ur, Editorial as yl } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as kl } from "react-hotkeys-hook";
import { Drawer as _e } from "vaul";
import * as Da from "react-resizable-panels";
import { useTheme as _l } from "next-themes";
import { Toaster as Nl } from "sonner";
import { toast as jg } from "sonner";
const Cl = pi({ prefix: "tw" });
function wa(t) {
  const e = [];
  let r = "", o = 0;
...
function f(...t) {
  ...
  }), gi(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const d = o.get(c);
    return d ? zl(c, d) : c;
  }).join(" ");
}
const Ye = 250, nn = 300, Tl = 400, Sl = 450, Dl = 500, sn = te(
...
function Al({
  ...
  const s = st();
  return /* @__PURE__ */ u(Ml, { children: [
    /* @__PURE__ */ a(Ol, { className: o }),
    /* @__PURE__ */ u(
      Yt.Content,
      {
...
function lr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Il, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        $e.Input,
        {
      ...
      /* @__PURE__ */ a(Ll, { children: /* @__PURE__ */ a(vi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function ua(t, e, r) {
  return `${t} ${Re[t]}${e ? ` ${Ra(t, e)} ${Ve(t, e)}` : ""}${r ? ` ${r}` : ""}`;
}
function Bl({
  recentSearches: t,
...
function Iu({
  ...
  const d = st(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, N] = T("books"), [x, _] = T(void 0), [k, I] = T(!1), O = G(void 0), A = G(void 0), C = G(void 0), z = G(void 0), E = G({}), M = j(
    ...
    ($) => {
      if ($.ctrlKey) return;
      const { isLetter: W, isDigit: Z } = so($.key);
      if (v === "chapters") {
        if ($.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes($.key)) {
        ...
        R !== ot && ($.preventDefault(), $.stopPropagation(), p(ua(ut, n, R)), setTimeout(() => {
          ...
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a(
              V,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a(Pi, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Li, { className: "tw:h-4 tw:w-4" })
              }
            ),
              ...
              !y && Object.entries(H).map(([$, W]) => {
                if (W.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ a(Jt, { heading: ge($), children: W.map((Z) => /* @__PURE__ */ a(
                      pn,
                      {
                        bookId: Z,
                        onSelect: (ut) => ct(ut),
...
const fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Yl = fn ? At : K, pr = { tag: za };
function Xl({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: c } = t, d = Wl(null, o), w = Fo({ editable: t.editable, html: c, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function Zl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return Jl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(za) || l.isEmpty() || r(n, o, c);
    });
  }, [o, t, e, r]), null;
}
const Ma = {
...
class tc extends ms {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && ec(e.resetKeys, n)) {
      var i, s;
...
function rc({ children: t, onError: e }) {
  return a(tc, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const ac = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function oc(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function nc() {
  return function(t) {
    const [e] = ee(), r = P(() => t(e), [e, t]), [o, n] = T(() => r.initialValueFn()), i = G(o);
    return ac(() => {
...
const mn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, lc = mn && "documentMode" in document ? document.documentMode : null;
!(!mn || !("InputEvent" in window) || lc) && "getTargetRanges" in new window.InputEvent("input");
function Ht(t) {
  return `${t}px`;
}
...
function dc(t, e, r) {
  ...
  function c() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = ic(t, e);
    var m, b;
...
function pc(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = uc(t, e));
  };
...
function hc(t) {
  ...
  const o = fc(t, r), n = Cs(o), i = Es(n) ? zs(n) : o;
  return Ts(Ss(i)), t.getLatest();
}
function fc(t, e, r) {
  let o = eo(e, "next");
  for (let n = o; n; n = Ds(n, r)) o = n;
  return Rs(o) && _r(283), o.insert(t.isInline() ? We().append(t) : t), eo(Ko(t.getLatest(), "next"), e.direction);
}
function mc(t) {
  const e = Tt();
  if (!Xt(e)) return !1;
...
const vc = Symbol.for("preact-signals");
function Ar() {
...
let Nr, se = 0, Cr = 0, xc = 0, fa = 0, vr = 0;
function uo(t) {
  if (X === void 0) return;
  let e = t.n;
...
function kc(t) {
  ...
  bn(this), X = t, this.f &= -2, 8 & this.f && Aa(this), Ar();
}
function Pe(t, e) {
...
Ct.prototype.brand = vc, Ct.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      se !== 0 && Cr === 0 && e.l !== fa && (e.l = fa, Nr = { S: e, v: e.v, i: e.i, o: Nr });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, xn(this), po(this), se++;
  const t = X;
  return X = this, kc.bind(this, t);
...
function kn(t, e = yn) {
  return t.registerCommand(Ho, (r) => (t.update(e), !0), Ta);
}
...
const qr = Os("format", { parse: (t) => typeof t == "number" ? t : 0 });
class _n extends la {
  $config() {
    return this.config("decorator-text", { extends: la, stateConfigs: [{ flat: !0, stateConfig: qr }] });
  }
  getFormat() {
    return qs(this, qr);
  }
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [_n], register: (t, e, r) => t.registerCommand(Wo, (o) => {
  const n = Tt();
  if (Yo(n) || Xt(n)) for (const i of n.getNodes()) Nc(i) && i.toggleFormat(o);
  return !1;
}, Xo) });
function Nn(t, e) {
  let r;
...
const Ia = 0, va = 1, En = 2, Hr = 3, gr = 4, Ie = 5, Wr = 6, Je = 7;
function Yr(t) {
  return t.id === Ia;
}
function zn(t) {
...
const Sc = jt({ config: Oe({ setOptions: go, updateOptions: go }), init: ({ $initialEditorState: t = Tc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [As, Uo, Is, Ps, Bo] }), ho = Symbol.for("@lexical/extension/LexicalBuilder");
function fo() {
}
function Dc(t) {
  throw t;
...
class je {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && Q(298, o.name), !n) {
      n = new zc(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var l;
      Yr(i) || Q(300, s, n || "[unknown]"), Yr(l = i) || Q(304, String(l.id), String(Ia)), i = Object.assign(l, { id: va }), o.state = i;
...
const Rc = /* @__PURE__ */ new Set(), mo = jt({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const l = yc(() => (i.value || Rc).has(s)), { watchedNodeKeys: c } = n.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), n.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [ma], name: "@lexical/extension/NodeSelection" }), $c = Vs("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends la {
  static getType() {
...
jt({ dependencies: [ma, mo], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ce(t.registerCommand($c, (s) => {
    const l = Tt();
    if (!Xt(l)) return !1;
    ...
    return !0;
  }, Ta), t.registerCommand(js, (s) => {
    if (Fs(s.target)) {
      const l = Bs(s.target);
      if (Oc(l)) return function(c, d = !1) {
        const w = Tt(), g = c.isSelected(), h = c.getKey();
        let p;
        d && Yo(w) ? p = w : (p = Us(), Ks(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Zt(() => {
    if (!o.disabled.value) return pc(t, o.onReposition.value);
  });
} });
function Tn(t) {
  return t.canBeEmpty();
}
function Ac(t, e, r = Tn) {
  return ce(t.registerCommand(Zs, (o) => {
    ...
    const i = function(s) {
      ...
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), g = gc(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Qs();
...
const La = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function Fc({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, i] = T(() => r.getDecorators());
    return La(() => r.registerDecoratorListener((s) => {
      ul(() => {
        i(s);
      });
    }), [r]), K(() => {
...
function Bc({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Ic.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && jc(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Fc, { editor: t, ErrorBoundary: e });
}
function vo(t) {
  return t.getEditorState().read(Sn(t.isComposing()));
}
function Uc({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = ee();
  return function(n) {
    La(() => ce(wl(n), Dn(n)), [n]);
  }(o), u(et, { children: [t, a(Kc, { content: e }), a(Bc, { editor: o, ErrorBoundary: r })] });
}
function Kc({ content: t }) {
...
function Wc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: N = !0, style: x, tabIndex: _, "data-testid": k, ...I }, O) {
  ...
  return Rn(() => (C(t.isEditable()), t.registerEditableListener((M) => {
    C(M);
...
function Jc(t, e) {
  ...
  return u(et, { children: [a(Yc, { editor: n, ...o, ref: e }), r != null && a(Zc, { editor: n, content: r })] });
}
...
function td({
  ...
  return /* @__PURE__ */ a($n.Provider, { value: s, children: i });
}
function Mn() {
  const t = Ea($n);
  if (!t)
...
function ed() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a($l, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Al, { children: [
...
function rd({
  ...
  const [e] = ee(), [r, o] = T(e), [n, i] = T("paragraph"), [s, l] = ed(), c = () => {
  };
...
function sd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(rd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(nd, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Uc,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Qc, { placeholder: t }) }),
          ErrorBoundary: rc
        }
      ),
      e && /* @__PURE__ */ a(Gc, { defaultSelection: "rootEnd" }),
...
function Ln(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (l == null || !sl(l)) && (l != null && yr(l) || o);
  for (let m = 0; m < g.length; m++) h.push(...Ln(g[m], e, r, p, new Map(n), l));
  return w != null && (h = w(h)), no(t) && (h = wd(t, h, p ? () => {
    const m = new Qo();
    return r.push(m), m;
...
function ud(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = cd(e, n);
      le().clear(), ll(i);
    },
    {
      discrete: !0
...
function Fu({
  ...
  const [i, s] = T(gd), [l, c] = T(n), [d, w] = T(!1), g = G(void 0), h = G(null);
  K(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : Fa(v) && (v.preventDefault(), v.stopPropagation(), Ot(i) && p());
        },
        onKeyDown: (v) => {
          Va(v), (v.key === "Enter" || v.key === " ") && v.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Er,
          {
...
const Bu = Object.freeze([
...
], hd = ["input", "select", "textarea", "button"], fd = ["button", "textbox"], md = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
  ...
  const n = G(null), [i, s] = T(void 0), [l, c] = T(void 0), d = j(
    ...
    if (p.isContentEditable || hd.includes(m)) return !0;
    const b = p.getAttribute("role");
    if (b && fd.includes(b)) return !0;
...
function be({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ a(Ba.Provider, { value: o, children: /* @__PURE__ */ a(vt.Root, { "data-slot": "dropdown-menu", dir: r, ...e }) });
}
function _d({
  ...t
}) {
...
function zd({
  ...
  return /* @__PURE__ */ u(
    vt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ca, { className: "tw:ms-auto" })
      ]
    }
  );
}
function Td({ className: t, children: e, ...r }) {
  const o = st();
  return /* @__PURE__ */ a(
    vt.SubContent,
    {
...
function ko({
  ...
  const p = j(
    ...
    [t.user]
  ), x = P(() => Ri(t.contents), [t.contents]), _ = P(() => {
    if (o && l)
      return /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ u(
          ba,
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(ud(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(yd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(kd, { className: "tw:text-xs tw:font-medium", children: N }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), p()) : Fa(k) && (k.preventDefault(), k.stopPropagation(), Ot(w) && m());
              },
              onKeyDown: (k) => {
        ...
        _ && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ui, {}) }) }),
...
function Sd({
  ...
  const [C, z] = T(_o), [E, M] = T(), [L, q] = T(), D = o, [H, y] = T(!1), [F, ct] = T(!1), [xt, Mt] = T(!1), [dt, St] = T(!1), [U, nt] = T(!1), [at, wt] = T(k), [zt, ge] = T(!1), yt = G(void 0), [he, re] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
  ...
  const ae = P(() => Ft[0], [Ft]), $ = G(null), W = G(void 0), Z = j(() => {
    var S;
  ...
  if (Ft.length !== 0)
    return /* @__PURE__ */ a(
      bd,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ u(xd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                V,
                {
                  ...
                  children: at ? /* @__PURE__ */ a(Ki, {}) : /* @__PURE__ */ a(Gi, {})
                }
              ),
            ...
            o && /* @__PURE__ */ u(et, { children: [
              ...
              v !== !1 && (!F || Ot(C)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (S) => {
                    Fa(S) && (S.preventDefault(), S.stopPropagation(), (Ot(C) || E !== void 0 && E !== L) && mt());
                  },
                  onKeyDown: (S) => {
                    Va(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Er,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (Ot(C) || E !== L) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: oe(
...
function Xu({
  ...
  const C = r.filter(
    ...
    [N, b]
  ), { listboxRef: L, activeId: q, handleKeyDown: D } = md({
    options: z,
    onOptionSelect: E
  }), H = j(
    (y) => {
...
function Dd({ table: t }) {
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(V, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Hi, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function qe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Et.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Et.Icon, { asChild: !0, children: /* @__PURE__ */ a(yi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
  ...
  const l = tt.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Ld(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Pd(l, b, w.key);
...
function Vd({
  ...
  return c ? I = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(xa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((O = _.getRowModel().rows) == null ? void 0 : O.length) > 0 ? I = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Pr, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ua, { stickyHeader: i, children: _.getHeaderGroups().map((A) => /* @__PURE__ */ a(ne, { children: A.headers.map((C) => /* @__PURE__ */ a(Tr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : tr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
...
function op({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(V, { variant: "default", children: [
      /* @__PURE__ */ a(Zi, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
    ...
    /* @__PURE__ */ a(ye, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Kn, { children: d.itemType === 0 ? /* @__PURE__ */ a(et, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        Nd,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Cd, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(cr, {})
    ] }, d.label)) })
        ...
        /* @__PURE__ */ a(Jt, { children: I.map((E) => /* @__PURE__ */ u(
          de,
          {
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ a(rs, { className: "tw:h-4 tw:w-4" }),
...
const Hd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(et, { children: [
...
function Wd({
  ...
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Hd(t, n, r) }) }) }),
...
const Yd = (t, e) => t === "f" ? /* @__PURE__ */ u(et, { children: [
  /* @__PURE__ */ a(Lo, {}),
  " ",
...
function Jd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Yd(t, r) }) }) }),
      /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ a("p", { children: Xd(t, r) }) })
    ] }) }),
...
function lp({
  ...
  const [m, b] = T("generated"), [v, N] = T("generated"), [x, _] = T("*"), [k, I] = T("*"), [O, A] = T("f"), [C, z] = T(!1), [E, M] = T(!0), [L, q] = T(!1), D = G(!1), H = G(""), [y, F] = T(!1), [ct, xt] = T(), [Mt, dt] = T(), [St, U] = T(), [nt, at] = T(), wt = G(null), zt = P(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  K(() => {
    ...
    if (B && ur("note", B)) {
      ...
      let _t = "custom";
      pt === ca ? _t = "generated" : pt === da ? _t = "hidden" : pt && (_(pt), I(pt)), b(_t), N(_t), A(((it = B.insert.note) == null ? void 0 : it.style) ?? "f"), R = setTimeout(() => {
        var Rt;
  ...
  const yt = j(
    (R, B, rt = !1) => {
      ...
      if (it && ur("note", it)) {
        if (it.insert.note) {
          let mt;
          R === "custom" ? mt = B : R === "generated" ? mt = ca : mt = da, it.insert.note.caller = mt;
        }
  ...
  const Ft = () => {
    ...
    if (B && ur("note", B)) {
      ...
      O !== "x" && R === "x" ? mt == null || mt.forEach(($t) => rw($t)) : O === "x" && R !== "x" && (mt == null || mt.forEach(($t) => aw($t))), (Rt = w.current) == null || Rt.applyUpdate([B, { delete: 1 }]);
    }
  }, Z = (R) => {
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ a(et, { children: nw(t.marker, l, o, d) })
      }
    )
  ] });
}
...
function cw({
  ...
  return /* @__PURE__ */ u(Pr, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ua, { stickyHeader: !0, children: /* @__PURE__ */ u(ne, { children: [
    ...
    /* @__PURE__ */ a(Lr, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ve, { className: o, children: lw(l.text) })
        ]
      },
...
const dw = (t) => {
  ...
  return e ? e[1] : "";
}, uw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", mp = Object.freeze([
...
function vp({
  ...
  }, [A, H]), F = P(() => y.length === 0 ? [] : pw(y, z, M), [y, z, M]), ct = P(() => {
    var at, wt;
    if (!A) return c;
...
const Wn = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(us, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function xp({
  ...
  const [s, l] = T(""), [c, d] = T([]), w = P(
    () => t.filter((D) => !r || D.type === r).filter((D) => fw(D, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: b, hasMore: v } = hw(p), N = P(
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    q && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: oe(M, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !x && !e && /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ a(Qr, { label: O, resources: g }),
        /* @__PURE__ */ a(
          Qr,
          {
            label: A,
...
const mw = "16rem", vw = "3rem", Yn = tt.createContext(void 0);
function Fr() {
...
function yp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    V,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(ki, {}) : /* @__PURE__ */ a(_i, {}),
    ...
    Xn,
    {
      ...
      children: /* @__PURE__ */ a(
        "div",
        {
          ...
          children: r.map((s) => /* @__PURE__ */ u(ya, { children: [
            /* @__PURE__ */ a(ka, { className: "tw:text-sm", children: s.label }),
            s.header && /* @__PURE__ */ a(Sr, { className: "tw:pb-1", children: s.header }),
            /* @__PURE__ */ a(Sr, { children: /* @__PURE__ */ a(Jn, { children: s.items.map((l) => /* @__PURE__ */ a(Zn, { children: /* @__PURE__ */ a(
              Qn,
              {
    ...
    Xn,
    {
      ...
      children: /* @__PURE__ */ u(yw, { children: [
        /* @__PURE__ */ u(ya, { children: [
          /* @__PURE__ */ a(ka, { className: "tw:text-sm", children: s }),
        ...
        /* @__PURE__ */ u(ya, { children: [
          /* @__PURE__ */ a(ka, { className: "tw:text-sm", children: l }),
...
const Cw = "Search app settings, extension settings, and project settings";
function Ew(t, e) {
...
function Op({
  ...
  projectInfo: i,
  children: s,
  handleSelectSidebarItem: l,
  selectedSidebarItem: c,
  searchValue: d,
  onSearch: w,
  searchPlaceholder: g = Cw,
  extensionsSidebarGroupLabel: h,
  ...
  const b = P(() => {
    if (e)
      return e.map((v) => ({
        ...v,
        items: v.items.filter((N) => Ew(N.label, d))
      }));
  }, [e, d]);
    ...
    /* @__PURE__ */ u(
      bw,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(xw, { className: "tw:min-w-[215px]", children: s })
        ]
      }
    )
  ] });
}
function Ap({ title: t, body: e, className: r }) {
  return /* @__PURE__ */ u(
    "div",
    {
      className: f(
...
const fe = "scrBook", zw = "scrRef", Se = "source", Tw = "details", Sw = "Scripture Reference", Dw = "Scripture Book", ti = "Type", Rw = "Details";
function $w(t, e) {
  const r = e ?? !1;
  return [
    {
...
const Mw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || oa(t.start, t.end) === 0 ? `${Br(t.start)}+${e}` : `${Br(t.start)}+${e}-${Br(t.end)}+${r}`;
}, Do = (t) => `${Mw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ip({
  sources: t,
  ...
  K(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const M = b.find((L) => Do(L) === E[0]) || void 0;
        M && l(M);
      }
    }
  }, [p, b, l, N]);
  const x = n ?? Dw, _ = i ?? ti, k = [
    ...
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(Rd, { children: k.map((z) => /* @__PURE__ */ a(Ut, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Pr, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ua, { children: N.getHeaderGroups().map((z) => /* @__PURE__ */ a(ne, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      V,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (M === "ltr" ? /* @__PURE__ */ a(ia, {}) : /* @__PURE__ */ a(na, {})),
                          " ",
...
}), ei = (t, e, r) => Ga(t, e).every((o) => r.includes(o));
function Ow({
  section: t,
  availableBookIds: e,
  selectedBookIds: r,
...
function Aw({
  ...
  const O = P(() => lt.allBookIds.filter(
    ...
    (D) => {
      ...
      r(
        ei(O, D, e) ? e.filter((y) => !H.includes(y)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, r, O]
  ), L = () => {
      ...
      /* @__PURE__ */ a(
        gn,
        {
          ...
          children: N.map(({ value: x, label: _, id: k }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(pa, { className: "tw:me-2", value: x, id: k }),
...
const ai = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ u(Ed, { children: [
    /* @__PURE__ */ a(zd, { children: l.label }),
    /* @__PURE__ */ a(_d, { children: /* @__PURE__ */ a(Td, { children: ai(
      t,
      e,
      ri(t, l.id),
      o
...
function _a({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(gs, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(jo, { children: [
      /* @__PURE__ */ a(Kn, { children: /* @__PURE__ */ a(It, { children: ai(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(cr, {})
    ] }, c)) })
  ] });
}
const oi = tt.forwardRef(
...
function Up({
  ...
  return /* @__PURE__ */ u(oi, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      _a,
      {
        onSelectMenuItem: t,
...
const ni = tt.forwardRef(({ className: t, ...e }, r) => {
  const o = st();
  return /* @__PURE__ */ a(
    Kt.Root,
    {
...
ni.displayName = Kt.List.displayName;
const ii = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Kt.List,
  {
    ref: r,
    className: f(
...
)), si = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Kt.Content,
  {
    ref: r,
    className: f(
...
si.displayName = Kt.Content.displayName;
function Gp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ni, { children: [
      /* @__PURE__ */ a(ii, { children: t.map((l) => /* @__PURE__ */ a(Iw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ a(si, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Pw({
  ...
  return /* @__PURE__ */ a(Ba.Provider, { value: o, children: /* @__PURE__ */ a(
    Qt.Root,
    {
      "data-slot": "menubar",
      className: f(
...
function Gw({
  ...
  return /* @__PURE__ */ u(
    Qt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ca, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
  ...
  if (kl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    return /* @__PURE__ */ a(Pw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(Lw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(It, { children: li(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Tg({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    Nl,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(Ti, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(zi, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(Ei, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(Ci, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(Ni, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
