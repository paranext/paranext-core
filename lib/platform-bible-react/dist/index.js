...
import { c as v, g as Ae, a as Vr, C as tr, L as Kn, t as _s, u as tn, T as At, b as xt, d as yt, e as kt, f as Hn, A as ba, r as ae, D as Be, h as Te, i as Fe, j as cr, k as Ge, B as tt, x as Ns, l as Cs, m as Es, I as Ts, n as Co, o as Xe, p as Oe, q as Ss, s as qn, P as lr, v as Or, w as dr, y as wr, z as Oa, E as Da, F as Eo, G as ur, H as Ma, J as Pt, R as To, K as xa, M as io, N as so, O as co, Q as lo, S as Gn, U as da, V as So, W as jr, X as Ur, Y as yr, Z as Rs, _ as Os, $ as ir, a0 as Ze, a1 as je, a2 as We, a3 as kr, a4 as Ro, a5 as Oo, a6 as ya, a7 as Do, a8 as Wn, a9 as Ds, aa as Ms, ab as Is, ac as wo, ad as Yn, ae as Ia, af as zs, ag as Zn, ah as Ps, ai as As, aj as $s, ak as en, al as Vs, am as Ls, an as Bs, ao as Xn, ap as Jn, aq as Mo, ar as Fs, as as Qn, at as Ka, au as rn, av as Ha, aw as js, ax as Us, ay as Ks, az as Hs, aA as qs, aB as Gs, aC as Ws, aD as Ys, aE as Zs, aF as Io, aG as zo, aH as Xs, aI as Js } from "./resizable-BQFRPfJp.js";
import { aJ as Cf, aK as Ef, aL as Tf, aM as Sf, aN as Rf, aO as Of, aP as Df, aQ as Mf, aR as If, aS as zf, aT as Pf, aU as Af, aV as $f, aW as Vf, aX as Lf, aY as Bf, aZ as Ff, a_ as jf, a$ as Uf, b0 as Kf, b1 as Hf, b2 as qf, b3 as Gf, b4 as Wf, b5 as Yf, b6 as Zf, b7 as Xf, b8 as Jf, b9 as Qf, ba as tm, bb as em, bc as rm, bd as am, be as om, bf as nm, bg as im, bh as sm, bi as cm, bj as lm, bk as dm, bl as wm, bm as um, bn as pm, bo as hm, bp as gm } from "./resizable-BQFRPfJp.js";
...
import Qt, { useRef as $, useMemo as A, createContext as Gr, useContext as za, useEffect as X, useState as N, useCallback as j, useId as _a, useImperativeHandle as Hc, useLayoutEffect as Ut, Fragment as Wr, Component as qc, createElement as dn, Suspense as Gc, forwardRef as Ao, memo as li } from "react";
...
function Si({
  ...
  const b = $(!1), x = () => {
    ...
    () => Vr(e, d),
    [e, d]
  ), E = !!h && !p, C = `${T} (${y})`, V = E ? f || `${C}, ${h}` : C, O = /* @__PURE__ */ u(
    tr,
    {
      ref: t,
...
function pd({
  ...
  Di(), X(() => {
    var H;
    const L = (H = C.current) == null ? void 0 : H.closest('button, [role="combobox"], [tabindex]');
    if (!L) return;
    const _ = (J) => !!J && J.scrollWidth > J.clientWidth, at = () => {
      Hn() !== "pointer" && (O || _(h.current) || _(d.current)) && E(!0);
    }, P = () => E(!1);
...
function md({
  ...
  const [h, f] = N(!1), [b, x] = N(!1), g = _a(), T = $(!1), y = w !== void 0, E = y ? w : h, C = n === "" ? "" : ae(n, gd), V = ae(s, fd), O = (M) => {
  ...
  return /* @__PURE__ */ u(Be, { open: E, onOpenChange: O, modal: !1, children: [
    /* @__PURE__ */ a(At, { children: C ? /* @__PURE__ */ u(xt, { open: b, onOpenChange: z, children: [
...
function Ya({
  ...
  const O = Oe(), z = ud(), [I, R] = N(!1), [M, W] = N(""), [Y, L] = N(""), [_, at] = N("books"), [P, H] = N(void 0), [J, U] = N(
    void 0
  ), [rt, wt] = N(void 0), [ct, Q] = N(!1), [ut, vt] = N(!1), [pt, _t] = N(!1), [Nt, Lt] = N(!1), se = $(null), ce = $(!1), Mt = $(void 0), Ct = $(void 0), Gt = $(void 0), fe = $(void 0), ye = $({}), It = $({}), St = j(
    (m) => {
      e(m), d && d(m);
    },
    [e, d]
    ...
    if (!k) return;
    const m = M.startsWith(`${k.book} `) ? M : "", q = na(m), it = Ar(m);
    return {
      book: k.book,
  ...
  const F = j(() => {
    ...
    (m) => {
      const q = _ === "chapters" ? P : k == null ? void 0 : k.book;
      if (q) {
        if (w && w(q, m) > 1) {
          U(q), wt(m), at("verses"), W("");
          return;
        }
        St({
          book: q,
  ...
  const { otLong: _e, ntLong: rr, dcLong: ar, extraLong: Ue } = {
    ...
    [t.book, s, z]
  ), gr = `${t.chapterNum}:${t.verseNum}`, S = j((m) => (q) => {
    ye.current[m] = q;
  }, []), nt = j((m) => (q) => {
    It.current[m] = q;
  }, []), dt = A(
    ...
    (m) => {
      ...
      const { isLetter: Bt, isDigit: qt } = mn(m.key);
      ...
      if (_ === "books" && k && !ct && m.key === "Enter" && !(q !== Ct.current && !!(q != null && q.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (_ === "books" && !Nt && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
        const Vt = q === Ct.current ? Ct.current : void 0, pe = (Vt == null ? void 0 : Vt.selectionStart) ?? 0, Zt = (Vt == null ? void 0 : Vt.selectionEnd) ?? 0, ve = O === "rtl" ? m.key === "ArrowRight" : m.key === "ArrowLeft";
        if (!!Vt && (pe !== Zt || (ve ? pe > 0 : Zt < Vt.value.length))) return;
      }
      if (m.shiftKey || _ === "books" && q !== Ct.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const Tt = (() => {
    ...
    const { isLetter: q, isDigit: it } = mn(m.key);
    (q || it) && (m.preventDefault(), L((Tt) => Tt + m.key), (qt = Ct.current) == null || qt.focus(), Q(!1));
  }, []);
  Ut(() => {
    const m = setTimeout(() => {
      if (I && _ === "books" && Gt.current && fe.current) {
        const q = Gt.current, it = fe.current, Bt = it.offsetTop, qt = q.clientHeight, Tt = it.clientHeight, re = Bt - qt / 2 + Tt / 2;
        q.scrollTo({
          top: Math.max(0, re),
          behavior: "smooth"
        }), W(mo(t.book));
    ...
    if (_ === "verses" && J && rt !== void 0) {
      const m = J === t.book && rt === t.chapterNum, q = m ? t.verseNum : 1;
      W(
        pa(J, rt, q)
      ), setTimeout(() => {
        if (Gt.current)
  ...
  const et = k ? `${k.book} ${k.chapterNum ?? ""} ${k.verseNum ?? ""} ${Dt}` : "", $t = $(""), ue = $(""), me = A(() => {
    ...
    const { book: m, chapterNum: q, verseNum: it } = k;
    if (Dt && q && w)
      return {
        max: w(m, q),
        initial: it ?? (m === t.book && q === t.chapterNum ? t.verseNum : 1),
        parse: na,
        buildValue: (qt) => pa(m, q, qt)
      };
    const Bt = qe(m);
    if (!(Bt <= 1))
      return {
  ...
  return Ut(() => {
    ...
    const { max: m, initial: q, parse: it, buildValue: Bt } = me, qt = (Tt) => {
      const re = it(Tt);
      return re !== void 0 && re >= 1 && re <= m && Tt === Bt(re) ? re : void 0;
    };
    if ($t.current !== et) {
      $t.current = et;
      const Tt = Bt(Math.min(Math.max(q, 1), m));
      ue.current = Tt, W(Tt);
      return;
    }
    if (qt(M) !== void 0) {
    ...
    W(
      qt(ue.current) !== void 0 ? ue.current : Bt(Math.min(Math.max(q, 1), m))
    );
        ...
        children: /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(
          wr,
          {
            ...
            children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Da, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: Et.map(
                      ({ onClick: m, disabled: q, title: it, icon: Bt, group: qt }, Tt) => {
                        const re = /* @__PURE__ */ a(
                          tt,
                          {
                            variant: "ghost",
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(Wr, { children: [
                            Tt > 0 && qt !== Et[Tt - 1].group && /* @__PURE__ */ a(Eo, {}),
                            q ? (
              ...
              !ct && /* @__PURE__ */ u(ur, { ref: Gt, children: [
                _ === "books" && /* @__PURE__ */ u(gt, { children: [
                  !k && Object.entries(G).map(([m, q]) => {
                    if (q.length !== 0)
                      return (
...
function yn({
  ...
  const [E, C] = N(!1), V = l ?? d, O = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], z = (I, R) => {
...
function Hd(t, e, r) {
  ...
  function d() {
    ...
    for (let T = 0; T < f.length; T++) {
      ...
      const V = Ee(y.left - p);
      C.left !== V && (C.left = V, g = !0);
      const O = Ee(y.top - h);
      C.top !== O && (E.style.top = O, g = !0);
      const z = Ee(y.width);
      C.width !== z && (E.style.width = z, g = !0);
      const I = Ee(y.height);
...
function Gd(t, e = qd) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), b = h.getNode(), x = b.getKey(), g = h.offset, T = f.getNode(), y = T.getKey(), E = f.offset, C = t.getElementByKey(x), V = t.getElementByKey(y), O = r === null || C !== o || g !== n || x !== r.getKey(), z = s === null || V !== i || E !== c || y !== s.getKey();
      if ((O || z) && C !== null && V !== null) {
            ...
            t.update(() => {
              ...
              if (Se(b)) {
                ...
                if (ho(g) && l >= 0 && w >= 0 && (T = l, y = l + w, b.setTextNodeRange(g, T, g, y)), T === y && p === "" || (b.insertRawText(p), g = x.getNode()), ho(g)) {
                  ...
                  T = T > E ? E : T, y = y > E ? E : y, b.setTextNodeRange(g, T, g, y);
                }
...
const qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ut : X;
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          b && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: T,
              onKeyDownCapture: (L) => {
                L.key === "Escape" ? (L.preventDefault(), L.stopPropagation(), E()) : Wo(L) && (L.preventDefault(), L.stopPropagation(), ie(h) && C());
              },
              onKeyDown: (L) => {
                Go(L), (L.key === "Enter" || L.key === " ") && L.stopPropagation();
              },
              onClick: (L) => {
                L.stopPropagation();
              },
...
const Jw = {
  ...
  const ct = j(
    ...
    [H.commentEdits, ct]
  ), [ut, vt] = N(), pt = n, [_t, Nt] = N(!1), [Lt, se] = N(!1), [ce, Mt] = N(!1), [Ct, Gt] = N(!1), [fe, ye] = N(!1), [It, St] = N(V), [ne, le] = N(!1), de = $(void 0), [we, ee] = N(/* @__PURE__ */ new Map());
  X(() => {
    let S = !0;
    return (async () => {
  ...
  G.current = l, X(() => () => {
    var nt;
    const { current: S } = wt;
    S.assignedUser !== void 0 && S.assignedUser === Wt.current && S.editorState === void 0 && !$r(S.commentEdits) && ((nt = D.current) == null || nt.call(D, G.current, void 0));
  }, []);
  const k = A(
...
function eu({
  ...
  }, C = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", V = f ? [
    {
      value: "merge",
...
function zh({
  ...
  const [C, V] = N(/* @__PURE__ */ new Set()), [O, z] = N(), [I, R] = N(), M = j(
    async (U) => {
      const rt = await s(U);
...
function pu({
  ...
  var O;
  const [w, p] = N([]), [h, f] = N([]), [b, x] = N({}), [g, T] = N({}), y = A(() => e ?? [], [e]), E = Ni({
    data: y,
    columns: t,
    getCoreRowModel: Ei(),
  ...
  let V;
  return d ? V = Array.from({ length: 10 }).map((R, M) => `skeleton-row-${M}`).map((R) => /* @__PURE__ */ a(We, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(kr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(yr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, R)) : ((O = E.getRowModel().rows) == null ? void 0 : O.length) > 0 ? V = E.getRowModel().rows.map((z) => /* @__PURE__ */ a(
    We,
    {
      onClick: () => i(z, E),
    ...
    /* @__PURE__ */ u(Ro, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Oo, { stickyHeader: s, children: E.getHeaderGroups().map((z) => /* @__PURE__ */ a(We, { children: z.headers.map((I) => /* @__PURE__ */ a(ya, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : Lr(I.column.columnDef.header, I.getContext()) }, I.id)) }, z.id)) }),
...
function Cu({
  ...
  const g = (y) => {
    if (i.current = !1, h(y), !y) {
      const E = b.current, C = x.current;
      E !== "custom" || C ? (E !== t || C !== e) && r(E, C) : (d(t), w(e));
    }
  }, T = (y) => {
    var E, C, V, O;
    y.stopPropagation(), document.activeElement === s.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((E = n.current) == null || E.focus(), i.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), i.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && ((V = n.current) == null ? void 0 : V.selectionStart) === 0 && ((O = s.current) == null || O.focus(), i.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && g(!1);
  };
...
function Hh({
  ...
  const [x, g] = N("generated"), [T, y] = N("generated"), [E, C] = N("*"), [V, O] = N("*"), [z, I] = N("f"), [R, M] = N(!1), [W, Y] = N(!0), [L, _] = N(!1), at = $(!1), P = $(""), [H, J] = N(!1), U = yu(), [rt, wt] = N(), ct = $(null), Q = $(
    void 0
  ), ut = $(0), vt = $(void 0), pt = A(
    () => ({
      ...i,
  ...
  const Nt = j(() => {
    var B, Z, F;
    const D = (B = f.current) == null ? void 0 : B.querySelector(".editor-input"), G = D == null ? void 0 : D.querySelector("span.note"), k = (F = (Z = f.current) == null ? void 0 : Z.ownerDocument.getSelection()) == null ? void 0 : F.anchorNode;
  ...
  X(() => {
    ...
    if (B && Ir("note", B)) {
      ...
      let lt = "custom";
      ot === go ? lt = "generated" : ot === fo ? lt = "hidden" : ot && (C(ot), O(ot)), g(lt), y(lt), I(((F = B.insert.note) == null ? void 0 : F.style) ?? "f"), D = setTimeout(() => {
        var st, bt, Et;
        (st = h.current) == null || st.applyUpdate([B]), (bt = h.current) == null || bt.selectNote(0), (Et = h.current) == null || Et.focus(), G = requestAnimationFrame(() => {
          k = setTimeout(() => {
            var mt, Rt;
    ...
    return () => {
      D && clearTimeout(D), G !== void 0 && cancelAnimationFrame(G), k !== void 0 && clearTimeout(k);
    };
  }, [e, s, Nt]);
  const Lt = j(
    (D = !1) => {
      var k, B, Z;
      p == null || p();
      const G = (B = (k = h.current) == null ? void 0 : k.getNoteOps(0)) == null ? void 0 : B.at(0);
      G && Ir("note", G) && (r == null || r([G]), D && l && s && ((Z = l.current) == null || Z.replaceEmbedUpdate(s, [G])));
    },
    [s, r, p, l]
  ), se = j(
    (D, G) => {
      ...
      let B;
      D === "custom" ? B = G : D === "generated" ? B = go : B = fo, k.insert.note.caller !== B && (k.insert.note.caller = B, (ot = h.current) == null || ot.applyUpdate([k, { delete: 1 }]));
    },
    []
  ), ce = j(() => {
    var D;
  ...
  const Gt = () => {
    var G;
    const D = (G = f.current) == null ? void 0 : G.getElementsByClassName("editor-input")[0];
    D != null && D.textContent && navigator.clipboard.writeText(D.textContent);
  }, fe = j(
    (D, G) => {
      p == null || p(), g(D), C(G), se(D, G);
    },
    [se, p]
  ), ye = (D) => {
    var k, B, Z, F, ot;
    ...
    const G = (B = (k = h.current) == null ? void 0 : k.getNoteOps(0)) == null ? void 0 : B.at(0);
    if (G && Ir("note", G)) {
      G.insert.note && (G.insert.note.style = D);
      const lt = (F = (Z = G.insert.note) == null ? void 0 : Z.contents) == null ? void 0 : F.ops;
      z !== "x" && D === "x" ? lt == null || lt.forEach((st) => Pu(st)) : z === "x" && D !== "x" && (lt == null || lt.forEach((st) => Au(st))), (ot = h.current) == null || ot.applyUpdate([G, { delete: 1 }]);
    }
  }, It = (D) => {
    ...
    (D) => {
      ...
      if (G && Ir("note", G)) {
        ...
        const lt = (Z = G.insert.note) == null ? void 0 : Z.style, st = (ot = (F = G.insert.note) == null ? void 0 : F.contents) == null ? void 0 : ot.ops;
        if (lt || M(!1), M(
          ...
          at.current = !0, P.current = JSON.stringify(G), Y(!0);
          return;
        }
        Y(JSON.stringify(G) === P.current), Lt();
      } else
        M(!1), Y(!0);
    },
    [Lt]
    ...
    if (!D) return !1;
    const G = od(pt.styleInfo ?? nd, D);
    return G.length === 0 ? !1 : (de(D, G, { passive: !D.hasTextSelection }), !0);
    ...
    (D) => {
      ...
      $s(D, G, {
        ...
        commitItem: (B) => {
          var F;
          const Z = G.items.find((ot) => ot.marker === B);
  ...
  X(() => {
    ...
    const D = () => {
      var B, Z, F;
      const G = ((B = f.current) == null ? void 0 : B.querySelector(".editor-input")) ?? void 0;
...
function Bu({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Yo(t.marker, [i], o, !1),
    " "
  ] }), f = !!d, b = !!w, x = !!p, g = e === "horizontal" ? "horizontal" : "vertical", T = o ? "marker-visible" : "", y = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", E = v(g, T);
  return /* @__PURE__ */ u(gt, { children: [
...
function Gh({
  ...
  const p = l ?? Fc(r, void 0), h = (C, V) => {
    w == null || w(C, V, n);
  }, f = s ? r.findIndex((C) => C === s) : -1, [b, x] = N(f), g = (C, V, O) => {
    if (r.length)
      switch (C.key) {
        case "Enter":
        case " ":
          C.preventDefault(), w == null || w(V, O, n);
          break;
      }
  }, T = (C) => {
    if (r.length)
      switch (C.key) {
        case "ArrowDown":
          C.preventDefault(), x((V) => Math.min(V + 1, r.length - 1));
          break;
        case "ArrowUp":
          C.preventDefault(), x((V) => Math.max(V - 1, 0));
          break;
      }
  }, y = $([]);
  X(() => {
...
function eg({
  ...
  const f = Ce(r, "%webView_inventory_all%"), b = Ce(r, "%webView_inventory_approved%"), x = Ce(r, "%webView_inventory_unapproved%"), g = Ce(r, "%webView_inventory_unknown%"), T = Ce(r, "%webView_inventory_scope_currentBook%"), y = Ce(r, "%webView_inventory_scope_chapter%"), E = Ce(r, "%webView_inventory_scope_verse%"), C = Ce(r, "%webView_inventory_filter_text%"), V = Ce(
    r,
    "%webView_inventory_show_additional_items%"
  ...
  }, [z, at]), H = A(() => P.length === 0 ? [] : qu(P, R, W), [P, R, W]), J = A(() => {
    var vt, pt;
    if (!z) return d;
...
function Zu({
  ...
  const [d, l] = Qt.useState(t), w = e ?? d, p = Qt.useCallback(
    ...
    [r, w]
  ), h = Qt.useCallback(() => p((E) => !E), [p]), f = w ? "expanded" : "collapsed", g = Oe() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = Qt.useMemo(
    () => ({
      state: f,
      open: w,
      setOpen: p,
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(lu, { children: C.map((R) => /* @__PURE__ */ a(be, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
...
function up({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: b, extraLong: x } = {
  ...
  }, [g, T] = N(!1), [y, E] = N(""), C = $(void 0), V = $(!1), O = A(
    () => Jn(t),
    [t]
  ), z = A(() => {
    if (!y.trim()) {
    ...
    (_, at = !1) => {
      ...
      const P = O.findIndex((wt) => wt === C.current), H = O.findIndex((wt) => wt === _);
      if (P === -1 || H === -1) return;
      const [J, U] = [
        Math.min(P, H),
        Math.max(P, H)
...
function vg({
  ...
  const O = Ft(
  ...
  ] }), pt = e ? ut.filter((K) => e.includes(K.value)) : ut, _t = g ?? Ga, Nt = h ?? _t, Lt = f ?? _t, se = () => {
  }, ce = $(null), Mt = $(null), Ct = $(!1), Gt = $(null), fe = $(!1), [ye, It] = N(void 0), St = $(!1), ne = $(!1), le = $(null), de = j((K) => {
    if (K) {
    ...
    [r, n, g, s]
  ), D = pt.find((K) => K.value === t), G = () => t === "selectedBooks" && n.length > 0 ? n.map((K) => K.toUpperCase()).join(", ") : t === "range" ? Uc(Nt, Lt, {
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          Ya,
                          {
                            ...
                            onCloseAutoFocus: (K) => {
                              var et;
                              K.preventDefault(), (et = Gt.current) == null || et.focus();
                            },
                            modal: !0,
...
function Sg({
  ...
  const l = Ap(
    ...
    var T, y, E, C, V, O;
    const g = x !== b ? ((y = (T = t[b]) == null ? void 0 : T.uiNames) == null ? void 0 : y[x]) ?? ((C = (E = t[b]) == null ? void 0 : E.uiNames) == null ? void 0 : C.en) : void 0;
...
function Og({
  ...
  const E = o["%firstRun_language_search_placeholder%"] ?? "", C = o["%firstRun_language_noResults%"] ?? "", V = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(
    wr,
    {
      id: s,
