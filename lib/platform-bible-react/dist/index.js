...
var es = (e, t, n) => t in e ? ts(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var ht = (e, t, n) => es(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as r, jsxs as c, Fragment as st } from "react/jsx-runtime";
import b, { forwardRef as tn, useRef as X, useMemo as j, useState as I, useCallback as G, useLayoutEffect as Bt, createContext as yn, useContext as dr, useEffect as q, Component as ns, createElement as Or, Suspense as rs, createRef as os, Fragment as io } from "react";
import { Command as vt } from "cmdk";
import { X as Me, Search as lo, Check as St, Clock as Ir, ChevronsLeft as Ar, ChevronsRight as Pr, ChevronLeft as qn, ChevronRight as _e, ArrowLeft as as, ArrowRight as ss, Circle as Nn, ChevronDown as Oe, BoldIcon as is, ItalicIcon as ls, UnderlineIcon as ws, StrikethroughIcon as ds, AtSign as wo, Pencil as cs, Trash2 as ps, ArrowUp as co, MoreHorizontal as po, MailOpen as us, Mail as ms, ChevronUp as uo, FilterIcon as fs, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as bs, ArrowRightIcon as vs, Copy as mo, Filter as xs, User as ys, Link as Ns, CircleHelp as ks, ChevronsUpDown as fo, Star as _s, SquareX as ho, FunctionSquare as go, SquareSigma as bo, AlertCircle as Hn, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as Rs, ArrowDownIcon as Ss, Ban as Ds, PanelLeft as Ms, PanelRight as Os, ScrollText as Is, MenuIcon as As, Menu as Ps, EllipsisVertical as $s, LoaderCircle as Ls, GripVertical as Vs } from "lucide-react";
...
import { includes as sn, Section as U, getChaptersForBook as Bs, formatScrRef as Jt, getSectionForBook as Ke, formatRelativeDate as Fs, formatReplacementString as ue, sanitizeHtml as Gs, NumberFormat as Ks, formatBytes as Us, getCurrentLocale as qs, getFormatCallerFunction as Hs, deepEqual as Ys, isString as $r, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as W, formatScrRefRange as Xs } from "platform-bible-utils";
...
import { createEditor as xo, $getRoot as Qt, $createParagraphNode as kn, $getSelection as Ft, HISTORY_MERGE_TAG as cr, ParagraphNode as yo, TextNode as No, $isTokenOrSegmented as Ws, $getCharacterOffsets as Js, $cloneWithPropertiesEphemeral as Zs, $findMatchingParent as Qs, $isElementNode as me, CLEAR_EDITOR_COMMAND as ko, COMMAND_PRIORITY_EDITOR as _o, $isRangeSelection as We, mergeRegister as te, shallowMergeConfig as ti, defineExtension as Kt, safeCast as en, RootNode as ei, LineBreakNode as ni, TabNode as ri, $isEditorState as oi, createCommand as ai, CLICK_COMMAND as si, isDOMNode as ii, $getNodeFromDOMNode as li, $isNodeSelection as wi, $createNodeSelection as di, $setSelection as ci, COMMAND_PRIORITY_LOW as pi, DecoratorNode as ui, addClassNamesToElement as Co, $create as mi, $getNodeByKey as fi, removeClassNamesFromElement as hi, KEY_TAB_COMMAND as gi, $isBlockElementNode as mn, $createRangeSelection as bi, $normalizeSelection__EXPERIMENTAL as vi, OUTDENT_CONTENT_COMMAND as xi, INDENT_CONTENT_COMMAND as Lr, INSERT_TAB_COMMAND as yi, COMMAND_PRIORITY_CRITICAL as pr, $isDecoratorNode as Ni, $isParagraphNode as ki, $isTextNode as fn, SELECTION_CHANGE_COMMAND as Eo, FORMAT_TEXT_COMMAND as _i, getRegisteredNode as Ci, isHTMLElement as Ei, isDocumentFragment as Vr, isDOMDocumentNode as Ti, ArtificialNode__DO_NOT_USE as To, $createLineBreakNode as Ro, $isRootOrShadowRoot as Ri, isBlockDomNode as jr, isInlineDomNode as zr, $insertNodes as Si } from "lexical";
...
import { useReactTable as Oo, getFilteredRowModel as Vi, getSortedRowModel as Io, getPaginationRowModel as ji, getCoreRowModel as Ao, flexRender as Ue, getGroupedRowModel as zi, getExpandedRowModel as Bi } from "@tanstack/react-table";
import * as rt from "@radix-ui/react-select";
import Fi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Xn, HIDDEN_NOTE_CALLER as Wn, getDefaultViewOptions as Gi, isInsertEmbedOpOfType as ln, Editorial as Ki } from "@eten-tech-foundation/platform-editor";
...
const Xi = Rt.Root, Wi = Rt.Portal, Po = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Rt.Overlay,
  {
    ref: n,
    className: m(
...
Po.displayName = Rt.Overlay.displayName;
const $o = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = dt();
  return /* @__PURE__ */ c(Wi, { children: [
    /* @__PURE__ */ r(Po, {}),
    /* @__PURE__ */ c(
      Rt.Content,
      {
...
$o.displayName = Rt.Content.displayName;
...
const Vo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Rt.Title,
  {
    ref: n,
...
Vo.displayName = Rt.Title.displayName;
...
Ji.displayName = Rt.Description.displayName;
...
const jo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  vt.Separator,
  {
    ref: n,
...
const Fo = ot.allBookIds.filter(
  ...
  Fo.map((e) => [e, ot.bookIdToEnglishName(e)])
);
function fr(e, t, n) {
  const o = t.trim().toLowerCase();
  if (!o) return !1;
  const a = ot.bookIdToEnglishName(e), s = n == null ? void 0 : n.get(e);
  return !!(sn(a.toLowerCase(), o) || sn(e.toLowerCase(), o) || (s ? sn(s.localizedName.toLowerCase(), o) || sn(s.localizedId.toLowerCase(), o) : !1));
}
const Go = tn(
  ({
    bookId: e,
  ...
  ({ className: e, variant: t, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: m(Ko({ variant: t, size: n, className: e })), ref: s, ...a })
);
V.displayName = "Button";
const re = Ce.Root, oe = Ce.Trigger, Xc = Ce.Anchor, Ht = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...o }, a) => {
  const s = dt();
...
function Qi({
  ...
  return /* @__PURE__ */ c(re, { open: d, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Ht, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Gt, { heading: s, children: e.map((u) => /* @__PURE__ */ c(
      Pt,
      {
        onSelect: () => p(u),
...
function Wc(e, t, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function nl(e, t, n, o) {
  const a = G(() => {
    if (e.chapterNum > 1)
      ...
      if (d > 0) {
        const w = t[d - 1], p = Math.max(At(w), 1);
        o({
          book: w,
          chapterNum: p,
          verseNum: 1
  ...
  return j(() => [
    ...
    {
      onClick: s,
      disabled: t.length === 0 || (e.chapterNum === At(e.book) || At(e.book) <= 0) && t.indexOf(e.book) === t.length - 1,
      title: "Next chapter",
      icon: n === "ltr" ? Pr : Ar
    }
  ], [
...
function Fr({
  ...
  if (e)
    return /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: At(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Pt,
      {
        value: `${e} ${fe[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function Jc({
  ...
  const w = dt(), [p, u] = I(!1), [h, f] = I(""), [g, v] = I(""), [x, y] = I("books"), [N, _] = I(void 0), [S, z] = I(!1), L = X(void 0), k = X(void 0), R = X(void 0), E = X(void 0), T = X({}), P = G(
    (O) => {
      t(O), l && l(O);
    },
    [t, l]
  ...
  }), [$]), A = j(() => Object.values(M).flat(), [M]), B = j(() => {
    if (!g.trim()) return M;
    const O = {
      [U.OT]: [],
      [U.NT]: [],
    ...
    (O) => {
      const H = x === "chapters" ? N : C == null ? void 0 : C.book;
      H && (P({
        book: H,
        chapterNum: O,
        verseNum: 1
    ...
    (O) => {
      ...
      if ((x === "chapters" || x === "books" && C) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        const Q = x === "chapters" ? N : C == null ? void 0 : C.book;
        if (!Q) return;
        const pt = (() => {
          if (!h) return 1;
          const le = h.match(/(\d+)$/);
    ...
    const { isLetter: H, isDigit: Z } = Br(O.key);
    (H || Z) && (O.preventDefault(), v((Q) => Q + O.key), k.current.focus(), z(!1));
  }, []);
  return Bt(() => {
    const O = setTimeout(() => {
      if (p && x === "books" && R.current && E.current) {
    ...
    if (x === "chapters" && N) {
      ...
      setTimeout(() => {
        if (R.current)
          if (O) {
            const H = T.current[e.chapterNum];
  ...
  }, [x, N, C, e.book, e.chapterNum]), /* @__PURE__ */ c(re, { open: p, onOpenChange: F, children: [
    /* @__PURE__ */ r(oe, { asChild: !0, children: /* @__PURE__ */ r(
      V,
      {
      ...
      Ut,
      {
        ...
        children: [
          ...
          !S && /* @__PURE__ */ c(qt, { ref: R, children: [
            x === "books" && /* @__PURE__ */ c(st, { children: [
              !C && Object.entries(B).map(([O, H]) => {
                if (H.length !== 0)
                  return (
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(vo.Root, { ref: n, className: m("pr-twp", rl(), e), ...t }));
wt.displayName = vo.Root.displayName;
...
const hn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Xe.Item,
  {
    ref: n,
    className: m(
...
function er({
  ...
  return /* @__PURE__ */ c(re, { open: N, onOpenChange: _, ...y, children: [
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ c(Ut, { children: [
          ...
          /* @__PURE__ */ r(qt, { children: z(t) ? t.map((k) => /* @__PURE__ */ r(Gt, { heading: k.groupHeading, children: k.options.map((R) => L(R, k.groupHeading)) }, k.groupHeading)) : t.map((k) => L(k)) })
        ] })
      }
    )
  ] });
    ...
    hr,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(wt, { className: "tw-flex tw-items-center", children: o.map((x) => ot.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            V,
            {
...
const qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ll = qo ? Bt : q, wn = { tag: cr };
function wl({ initialConfig: e, children: t }) {
  const n = j(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = e, w = il(null, o), p = xo({ editable: e.editable, html: d, namespace: a, nodes: s, onError: (u) => i(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
        if (h === void 0) u.update(() => {
          ...
          if (f.isEmpty()) {
            ...
            (Ft() !== null || v !== null && v === u.getRootElement()) && g.select();
          }
        }, wn);
...
const dl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
function cl({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return dl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      t && s.size === 0 && i.size === 0 || e && d.has(cr) || l.isEmpty() || n(a, o, d);
    });
  }, [o, e, t, n]), null;
}
const gr = {
  ...
  mark: "",
  markOverlap: ""
}, kt = Ae.Provider, Et = Ae.Root, Tt = b.forwardRef(({ className: e, variant: t, ...n }, o) => /* @__PURE__ */ r(
  Ae.Trigger,
  {
    ref: o,
    className: t ? m(Ko({ variant: t }), e) : e,
    ...n
  }
));
Tt.displayName = Ae.Trigger.displayName;
const _t = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, o) => /* @__PURE__ */ r(
  Ae.Content,
  {
    ref: o,
    sideOffset: t,
...
class ul extends ns {
  ...
  componentDidUpdate(t, n) {
    ...
    if (o && n.error !== null && ml(t.resetKeys, a)) {
      var s, i;
...
function fl({ children: e, onError: t }) {
  return r(ul, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
const hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
function gl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function bl() {
  return function(e) {
    const [t] = $t(), n = j(() => e(t), [t, e]), [o, a] = I(() => n.initialValueFn()), s = X(o);
    return hl(() => {
...
function vl(e, t, n = "self") {
  const o = e.getStartEndPoints();
  if (t.isSelected(e) && !Ws(t) && o !== null) {
    const [a, s] = o, i = e.isBackward(), l = a.getNode(), d = s.getNode(), w = t.is(l), p = t.is(d);
    if (w || p) {
      const [u, h] = Js(e), f = l.is(d), g = t.is(i ? d : l), v = t.is(i ? l : d);
      let x, y = 0;
      f ? (y = u > h ? h : u, x = u > h ? u : h) : g ? (y = i ? h : u, x = void 0) : v && (y = 0, x = i ? u : h);
      const N = t.__text.slice(y, x);
      N !== t.__text && (n === "clone" && (t = Zs(t)), t.__text = N);
    }
  }
  return t;
}
...
const Ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yl = Ho && "documentMode" in document ? document.documentMode : null;
!(!Ho || !("InputEvent" in window) || yl) && "getTargetRanges" in new window.InputEvent("input");
function Gr(e) {
  const t = Qs(e, (n) => me(n) && !n.isInline());
  return me(t) || xl(4, e.__key), t;
}
...
function ce(e, t) {
  gt.call(this, void 0), this.x = e, this.s = void 0, this.g = pn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function _l(e, t) {
  return new ce(e, t);
}
...
function Cl(e) {
  ...
  Xo(this), Y = e, this.f &= -2, 8 & this.f && vr(this), Cn();
}
function Ne(e, t) {
...
function En(e, t = {}) {
  const n = {};
  for (const o in e) {
    const a = t[o], s = Je(a === void 0 ? e[o] : a);
    n[o] = s;
  }
  return n;
}
gt.prototype.brand = Nl, gt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Wo(this), qr(this), Zt++;
  const e = Y;
  return Y = this, Cl.bind(this, e);
...
Kt({ build: (e, t, n) => En(t), config: en({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const o = n.getOutput();
  return ee(() => o.disabled.value ? void 0 : e.registerRootListener((a) => {
    e.focus(() => {
...
function Jo() {
  const e = Qt(), t = Ft(), n = kn();
  e.clear(), e.append(n), t !== null && n.select(), We(t) && (t.format = 0);
}
function Zo(e, t = Jo) {
  return e.registerCommand(ko, (n) => (e.update(t), !0), _o);
}
Kt({ build: (e, t, n) => En(t), config: en({ $onClear: Jo }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: o } = n.getOutput();
  return ee(() => Zo(e, o.value));
} });
function El(e) {
...
const rr = Kt({ build: (e) => Qo(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const xr = 0, or = 1, ea = 2, Ln = 3, dn = 4, ye = 5, Vn = 6, Be = 7;
function jn(e) {
  return e.id === xr;
}
function na(e) {
...
function Tl(e) {
  return function(t) {
    return t.id === or;
  }(e) || J(305, String(e.id), String(or)), Object.assign(e, { id: ea });
}
...
class Sl {
  ...
  init(t) {
    ...
    let i;
    this.state = s, this.extension.init && (i = this.extension.init(t, s.config, o)), this.state = function(l, d, w) {
  ...
  build(t) {
    const n = this.state;
    let o;
    n.id !== dn && J(307, String(n.id), String(ye)), this.extension.build && (o = this.extension.build(t, n.config, n.registerState));
  ...
  register(t, n) {
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== Be && J(309, String(o.id), String(Be)), this.state = function(i) {
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= Be;
    }(t) || J(316, String(t.id), String(Be)), t;
  }
...
const Ml = Kt({ config: en({ setOptions: Hr, updateOptions: Hr }), init: ({ $initialEditorState: e = Dl }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (oi(s)) e.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ei, No, ni, ri, yo] }), Yr = Symbol.for("@lexical/extension/LexicalBuilder");
function Xr() {
}
function Ol(e) {
  throw e;
...
class He {
  ...
  static fromEditor(t) {
    const n = He.maybeFromEditor(t);
    return n === void 0 && J(294), n;
  }
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(xo({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [Yr]: this });
  ...
  buildEditor() {
    ...
    return t = te(this.registerEditor(o), () => o.setRootElement(null)), o;
  }
  ...
  buildCreateEditorArgs() {
    ...
    return t.onError || (t.onError = Ol), t;
  }
}
const Il = /* @__PURE__ */ new Set(), Wr = Kt({ build(e, t, n) {
  const o = n.getDependency(rr).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Qo(() => {
  }, () => ee(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let d, w = !1;
    o.value.read(() => {
      if (Ft()) for (const [p, u] of l.entries()) {
        if (u.size === 0) {
          l.delete(p);
          continue;
        }
        const h = fi(p), f = h && h.isSelected() || !1;
        w = w || f !== (!!i && i.has(p)), f && (d = d || /* @__PURE__ */ new Set(), d.add(p));
      }
    }), !w && d && i && d.size === i.size || (s.value = d);
  }));
  return { watchNodeKey: function(i) {
    const l = _l(() => (s.value || Il).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
Kt({ dependencies: [rr, Wr], name: "@lexical/extension/HorizontalRule", nodes: () => [Ee], register(e, t, n) {
  const { watchNodeKey: o } = n.getDependency(Wr).output, a = Je({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return te(e.registerCommand(si, (i) => {
    if (ii(i.target)) {
      const l = li(i.target);
      if (Pl(l)) return function(d, w = !1) {
        const p = Ft(), u = d.isSelected(), h = d.getKey();
        let f;
        w && wi(p) ? f = p : (f = di(), ci(f)), u ? f.delete(h) : f.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, pi), e.registerMutationListener(Ee, (i, l) => {
    kl(() => {
      let d = !1;
      const { nodeSelections: w } = a.peek();
      for (const [p, u] of i.entries()) if (u === "destroyed") w.delete(p), d = !0;
      else {
        const h = w.get(p), f = e.getElementByKey(p);
    ...
    const i = [];
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(ee(() => {
      const w = l.value;
      w && (d.value ? Co(w, s) : hi(w, s));
    }));
    return te(...i);
  }));
} });
function $l(e, t) {
  return te(e.registerCommand(gi, (n) => {
    const o = Ft();
    if (!We(o)) return !1;
    n.preventDefault();
    const a = function(s) {
      if (s.getNodes().filter((u) => mn(u) && u.canIndent()).length > 0) return !0;
      const i = s.anchor, l = s.focus, d = l.isBefore(i) ? l : i, w = d.getNode(), p = Gr(w);
      if (p.canIndent()) {
        const u = p.getKey();
        let h = bi();
        if (h.anchor.set(u, 0, "element"), h.focus.set(u, 0, "element"), h = vi(h), h.anchor.is(d)) return !0;
      }
      return !1;
    }(o) ? n.shiftKey ? xi : Lr : yi;
    return e.dispatchCommand(a, void 0);
  }, _o), e.registerCommand(Lr, () => {
...
Kt({ build: (e, t, n) => En(t), config: en({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: o, maxIndent: a } = n.getOutput();
  return ee(() => {
    if (!o.value) return $l(e, a);
  });
} });
const Ll = Kt({ name: "@lexical/react/ReactProvider" });
function Vl() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            e.update(() => {
              ...
              if (We(g)) {
                const v = g.anchor;
                let x = v.getNode(), y = 0, N = 0;
                if (fn(x) && w >= 0 && p >= 0 && (y = w, N = w + p, g.setTextNodeRange(x, y, x, N)), y === N && u === "" || (g.insertRawText(u), x = v.getNode()), fn(x)) {
                  y = h, N = h + f;
                  const _ = x.getTextContentSize();
                  y = y > _ ? _ : y, N = N > _ ? _ : N, g.setTextNodeRange(x, y, x, N);
                }
...
Kt({ build: (e, t, n) => En(t), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => ee(() => n.getOutput().disabled.value ? void 0 : aa(e)) });
function Bl(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", e);
  for (const a of t) o.append("v", a);
...
const yr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
function Fl({ editor: e, ErrorBoundary: t }) {
  return function(n, o) {
...
function Gl({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    ...
    return !1;
  }(e) ? null : r(Fl, { editor: e, ErrorBoundary: t });
}
function Jr(e) {
  return e.getEditorState().read(oa(e.isComposing()));
}
function Kl({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [o] = $t();
  return function(a) {
    yr(() => te(Ii(a), aa(a)), [a]);
  }(o), c(st, { children: [e, r(Ul, { content: t }), r(Gl, { editor: o, ErrorBoundary: n })] });
}
...
function ql({ defaultSelection: e }) {
  const [t] = $t();
  return q(() => {
    t.focus(() => {
...
const Hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
function Yl({ onClear: e }) {
  const [t] = $t();
  return Hl(() => Zo(t, e), [t, e]), null;
}
const sa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
function Xl({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: u, ariaRequired: h, autoCapitalize: f, className: g, id: v, role: x = "textbox", spellCheck: y = !0, style: N, tabIndex: _, "data-testid": S, ...z }, L) {
  const [k, R] = I(e.isEditable()), E = G((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? e.setRootElement(P) : e.setRootElement(null);
  }, [e]), T = j(() => /* @__PURE__ */ function(...P) {
    return ($) => {
      for (const M of P) typeof M == "function" ? M($) : M != null && (M.current = $);
    };
  }(L, E), [E, L]);
  return sa(() => (R(e.isEditable()), e.registerEditableListener((P) => {
    R(P);
  })), [e]), r("div", { "aria-activedescendant": k ? t : void 0, "aria-autocomplete": k ? n : "none", "aria-controls": k ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": k && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": k ? u : void 0, "aria-readonly": !k || void 0, "aria-required": h, autoCapitalize: f, className: g, contentEditable: k, "data-testid": S, id: v, ref: T, role: x, spellCheck: y, style: N, tabIndex: _, ...z });
}
const Wl = tn(Xl);
function Zr(e) {
  return e.getEditorState().read(oa(e.isComposing()));
...
function Zl(e, t) {
  ...
  return c(st, { children: [r(Wl, { editor: a, ...o, ref: t }), n != null && r(Ql, { editor: a, content: n })] });
}
function Ql({ content: e, editor: t }) {
  const n = function(i) {
    const [l, d] = I(() => Zr(i));
    return sa(() => {
      function w() {
...
function nw() {
  const [e, t] = I(void 0), n = G(() => {
    t(void 0);
  }, []), o = j(() => {
    if (e === void 0)
      return;
    const { title: s, content: i } = e;
    return /* @__PURE__ */ r(Xi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c($o, { children: [
      /* @__PURE__ */ r(Lo, { children: /* @__PURE__ */ r(Vo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = G(
    (s, i, l = !1) => {
...
function rw({
  ...
  const [t] = $t(), [n, o] = I(t), [a, s] = I("paragraph"), [i, l] = nw(), d = () => {
  };
...
), aw = b.forwardRef(({ className: e, variant: t, size: n, ...o }, a) => /* @__PURE__ */ r(
  So.Root,
  {
    ref: a,
    className: m(wa({ variant: t, size: n, className: e })),
    ...o
  }
));
aw.displayName = So.Root.displayName;
...
function sw() {
  const { activeEditor: e } = la(), [t, n] = I([]), o = G((a) => {
    if (We(a) || $i(a)) {
      const s = [];
      Qr.forEach(({ format: i }) => {
      ...
      /* @__PURE__ */ r(
        Kl,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(tw, { placeholder: e }) }),
          ErrorBoundary: fl
        }
      ),
      t && /* @__PURE__ */ r(ql, { defaultSelection: "rootEnd" }),
...
function ca(e, t, n, o = null) {
  ...
  let i = t;
  o !== null && fn(t) && (i = vl(o, t, "clone"));
  const l = me(i) ? i.getChildren() : [], d = Ci(e, i.getType());
  let w;
  ...
  for (let f = 0; f < l.length; f++) {
    const g = l[f], v = ca(e, g, h, o);
    !a && me(t) && v && t.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ei(p) || Vr(p)) && p.append(h), n.append(p), u) {
      const f = u.call(i, p);
...
function ua(e, t, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (pa.has(e.nodeName)) return i;
  let l = null;
  const d = function(g, v) {
    const { nodeName: x } = g, y = v._htmlConversions.get(x.toLowerCase());
    let N = null;
  ...
  for (let g = 0; g < u.length; g++) h.push(...ua(u[g], t, n, f, new Map(a), l));
  return p != null && (h = p(h)), jr(e) && (h = pw(e, h, f ? () => {
    const g = new To();
    return n.push(g), g;
  } : kn)), l == null ? h.length > 0 ? i = i.concat(h) : jr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : zr(g.nextSibling) && zr(g.previousSibling);
  }(e) && (i = i.concat(Ro())) : me(l) && l.append(...h), i;
}
function pw(e, t, n) {
...
function fa(e) {
  return e ? e.some(
    (t) => t && "text" in t && t.text.trim().length > 0 ? !0 : !t || !("children" in t) ? !1 : fa(t.children)
  ) : !1;
}
function Ct(e) {
  var t;
  return (t = e == null ? void 0 : e.root) != null && t.children ? fa(e.root.children) : !1;
}
function uw(e) {
  if (!e || e.trim() === "")
...
function ep({
  ...
  const [a, s] = I(mw), [i, l] = I(void 0), [d, w] = I(!1), p = X(void 0), u = X(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
  ...
  const h = G(() => {
    ...
    const y = bn(a);
    t(y, i);
  }, [a, t, i]), f = o["%commentEditor_placeholder%"] ?? "Type your comment here...", g = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", v = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", x = o["%commentEditor_assignTo_label%"] ?? "Assign to";
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
          /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Me, {}) }) }),
...
const np = Object.freeze([
  ...
  const a = X(null), [s, i] = I(void 0), [l, d] = I(void 0), w = G(
    (f) => {
      i(f);
      const g = e.find((x) => x.id === f);
      g && (t == null || t(g));
    ...
    if (v && hw.includes(v)) return !0;
    const x = f.getAttribute("tabindex");
    return x !== void 0 && x !== "-1";
  }, h = G(
    (f) => {
      var k;
      const g = f.target, v = (R) => R ? document.getElementById(R) : void 0, x = v(l), y = v(s);
      if (!!(x && g && x.contains(g) && g !== x) && u(g)) {
        if (f.key === "Escape" || f.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            f.preventDefault(), f.stopPropagation();
            const R = e.find((E) => E.id === l);
            R && w(R.id);
          }
          return;
        }
      ...
      switch (f.key) {
        case "ArrowDown":
          z = Math.min(S + 1, e.length - 1), f.preventDefault();
          break;
        case "ArrowUp":
  ...
  ({ className: e, variant: t, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: m("pr-twp", bw({ variant: t }), e), ...n })
);
...
const yw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
const kw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Pe.Image,
  {
    ref: n,
...
kw.displayName = Pe.Image.displayName;
...
}), Le = tt.Trigger, xa = tt.Group, _w = tt.Portal, Cw = tt.Sub, Ew = tt.RadioGroup;
function ve({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ r(_r.Provider, { value: n, children: /* @__PURE__ */ r(tt.Root, { ...t }) });
}
const ya = b.forwardRef(({ className: e, inset: t, children: n, ...o }, a) => {
  const s = Mt();
  return /* @__PURE__ */ c(
    tt.SubTrigger,
    {
...
const ka = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = Mt();
  return /* @__PURE__ */ c(
    tt.RadioItem,
    {
...
const Ve = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  tt.Separator,
  {
    ref: n,
...
function to({
  ...
  }, [e.date, n]), x = j(() => e.user, [e.user]), y = j(
    () => e.user.split(" ").map((S) => S[0]).join("").toUpperCase().slice(0, 2),
    [e.user]
  ), N = j(() => Gs(e.contents), [e.contents]), _ = j(() => {
    if (o && l)
      return /* @__PURE__ */ c(st, { children: [
        /* @__PURE__ */ c(
          vn,
          {
            onClick: () => {
              w(!0), u(uw(e.contents)), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        _ && /* @__PURE__ */ c(ve, { children: [
          /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(po, {}) }) }),
          /* @__PURE__ */ r(ae, { align: "end", children: _ })
        ] })
      ]
    }
  );
...
function Rw({
  ...
  const [k, R] = I(eo), E = o, [T, P] = I(!1), [$, M] = I(!1), [A, B] = I(!1), [C, K] = I(void 0), [ct, ut] = I(!1), [Lt, mt] = I(!1), [it, F] = I(S), [at, ft] = I(!1), lt = X(void 0), [yt, ze] = I(/* @__PURE__ */ new Map());
  q(() => {
    let D = !0;
    return (async () => {
  ...
  const Xt = j(() => t.filter((D) => !D.deleted), [t]);
  q(() => {
    let D = !0;
    if (!o || !_) {
      ze(/* @__PURE__ */ new Map());
  ...
  const se = j(() => Xt[0], [Xt]), on = X(null), xe = X(void 0), ie = G(() => {
    var D;
    (D = xe.current) == null || D.call(xe), R(eo);
  }, []), On = G(() => {
    const D = !it;
    F(D), ft(!D), g == null || g(d, D);
  }, [it, g, d]);
  q(() => {
    P(!1);
  }, [o]), q(() => {
  ...
  const O = j(
  ...
  }, [s, n]), Z = j(() => Xt.slice(1), [Xt]), Q = j(() => Z.length ?? 0, [Z.length]), pt = j(() => Q > 0, [Q]), Vt = j(() => T || Q <= 2 ? Z : Z.slice(-2), [Z, Q, T]), bt = j(() => T || Q <= 2 ? 0 : Q - 2, [Q, T]), an = j(
    () => Q === 1 ? O.singleReply : ue(O.multipleReplies, { count: Q }),
    [Q, O]
  ), le = j(
    () => bt === 1 ? O.singleReply : ue(O.multipleReplies, { count: bt }),
    [bt, O]
  ), Sr = G(async () => {
    ...
    D && await u({ threadId: d, contents: D }) && ie();
  }, [ie, k, u, C, d]), Dr = G(
    async (D) => {
      const we = Ct(k) ? bn(k) : void 0, Ot = await u({
        ...D,
        contents: we,
        assignedUser: C ?? D.assignedUser
      });
      return Ot && we && ie(), Ot && C !== void 0 && K(void 0), Ot;
    },
    [ie, k, u, C]
  );
  return /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              V,
              {
                ...
                children: it ? /* @__PURE__ */ r(us, {}) : /* @__PURE__ */ r(ms, {})
              }
            ),
          ...
          /* @__PURE__ */ r("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: /* @__PURE__ */ c(
            "p",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ c("span", { className: e, children: [
                  se.contextBefore,
          ...
          /* @__PURE__ */ r(
            to,
            {
              ...
              handleDeleteComment: f,
              onEditingChange: M,
              canEditOrDelete: yt.get(se.id) ?? !1,
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ c(re, { open: A, onOpenChange: B, children: [
                      /* @__PURE__ */ r(oe, { asChild: !0, children: /* @__PURE__ */ r(
                        V,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ r(
                        Ht,
                        {
                          ...
                          align: "end",
                          onKeyDown: (D) => {
                            D.key === "Escape" && (D.stopPropagation(), B(!1));
                          },
                          children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(qt, { children: v == null ? void 0 : v.map((D) => /* @__PURE__ */ r(
                            Pt,
                            {
                              onSelect: () => {
                                K(D !== s ? D : void 0), B(!1);
...
function op({
  ...
  const z = n.filter(
    ...
    (M) => {
      N((A) => new Set(A).add(M.id)), S(M.id), v == null || v(M.id);
    },
    [v]
  ), R = G(
    (M) => {
      ...
      }), S(M), v == null || v(A ? void 0 : M);
    },
    [y, v]
  ), { listboxRef: E, activeId: T, handleKeyDown: P } = gw({
    options: L,
    onOptionSelect: k
  }), $ = G(
    (M) => {
      M.key === "Escape" ? (_ && y.has(_) && (N((A) => {
        const B = new Set(A);
        return B.delete(_), B;
      }), S(void 0), v == null || v(void 0)), M.preventDefault(), M.stopPropagation()) : P(M);
    },
    [_, y, P, v]
  );
  return /* @__PURE__ */ r(
...
function Sw({ table: e }) {
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(Li, { asChild: !0, children: /* @__PURE__ */ c(V, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Se = rt.Root, Dw = rt.Group, De = rt.Value, Mw = ne(
  ...
  return /* @__PURE__ */ c(
    rt.Trigger,
    {
      className: m(Mw({ size: n, className: e })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
const Ca = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  rt.ScrollDownButton,
  {
    ref: n,
    className: m("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
...
const Ow = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  rt.Label,
  {
    ref: n,
...
const Nt = b.forwardRef(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ c(
  rt.Item,
  {
    ref: o,
    className: m(
      ...
      /* @__PURE__ */ c(
        Se,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(be, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ r(Nt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const Sn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: m("[&_tr:last-child]:tw-border-0", e), ...t }));
Sn.displayName = "TableBody";
const $w = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
...
const zw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function Bw({
  ...
  var L;
  const [p, u] = I([]), [h, f] = I([]), [g, v] = I({}), [x, y] = I({}), N = j(() => t ?? [], [t]), _ = Oo({
    data: N,
    columns: e,
    getCoreRowModel: Ao(),
  ...
  return d ? z = Array.from({ length: 10 }).map((E, T) => `skeleton-row-${T}`).map((E) => /* @__PURE__ */ r(jt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(he, { colSpan: S.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ar, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((L = _.getRowModel().rows) == null ? void 0 : L.length) > 0 ? z = _.getRowModel().rows.map((k) => /* @__PURE__ */ r(
    ...
    k.id
  )) : z = /* @__PURE__ */ r(jt, { children: /* @__PURE__ */ r(he, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Sw, { table: _ }),
    /* @__PURE__ */ c(Tn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Rn, { stickyHeader: s, children: _.getHeaderGroups().map((k) => /* @__PURE__ */ r(jt, { children: k.headers.map((R) => /* @__PURE__ */ r(Qe, { className: "tw-p-0", children: R.isPlaceholder ? void 0 : Ue(R.column.columnDef.header, R.getContext()) }, R.id)) }, k.id)) }),
...
function ap({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Fi, { options: s, children: t })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(V, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(mo, {}) })
        ] }),
...
function ip({
  ...
  return /* @__PURE__ */ c(re, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ c(Ht, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
function lp({ id: e, label: t, groups: n }) {
  const [o, a] = I(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: e, children: /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ c(V, { variant: "default", children: [
...
function Uw({ id: e, versionHistory: t }) {
...
function dp({
  ...
  const i = j(() => Us(n), [n]), d = ((w) => {
    const p = new Intl.DisplayNames(qs(), { type: "language" });
    return w.map((u) => p.of(u));
  })(o);
  return /* @__PURE__ */ r("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
...
function qw({
  ...
  const [y, N] = I(!1), _ = G(
    (T) => {
      var $;
      const P = ($ = e.find((M) => M.label === T)) == null ? void 0 : $.value;
      P && n(
        t.includes(P) ? t.filter((M) => M !== P) : [...t, P]
      );
    },
    [e, t, n]
  ), S = () => d || o, z = j(() => {
    if (!h) return e;
    const T = e.filter(($) => $.starred).sort(($, M) => $.label.localeCompare(M.label)), P = e.filter(($) => !$.starred).sort(($, M) => {
      const A = t.includes($.value), B = t.includes(M.value);
      return A && !B ? -1 : !A && B ? 1 : $.label.localeCompare(M.label);
    });
    return [...T, ...P];
  }, [e, t, h]), L = () => {
    n(e.map((T) => T.value));
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ c(re, { open: R, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(oe, { asChild: !0, children: /* @__PURE__ */ c(
      V,
      {
        variant: v,
        ...
        /* @__PURE__ */ r(Gt, { children: z.map((T) => /* @__PURE__ */ c(
          Pt,
          {
            ...
            children: [
              ...
              T.starred && /* @__PURE__ */ r(_s, { className: "tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ c("div", { id: u, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    t.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: t.map((h) => {
      ...
      return /* @__PURE__ */ c(Te, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        ...
        (f = e.find((g) => g.value === h)) == null ? void 0 : f.label
      ] }, h);
...
const Hw = (e, t, n) => e === "generated" ? /* @__PURE__ */ c(st, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  t["%footnoteEditor_callerDropdown_item_generated%"]
] }) : e === "hidden" ? /* @__PURE__ */ c(st, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
function Yw({
  ...
  const s = X(null), i = X(null), l = X(!1), [d, w] = I(e), [p, u] = I(n), [h, f] = I(!1);
  q(() => {
    w(e);
  }, [e]), q(() => {
    p !== n && u(n);
  ...
  const g = (x) => {
    l.current = !1, f(x), x || (d !== "custom" || p ? (t(d), o(p)) : (w(e), u(n)));
  }, v = (x) => {
    var y, N, _, S;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && x.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && x.key === "ArrowLeft" && ((_ = s.current) == null ? void 0 : _.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), d === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ c(ve, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
      /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Hw(e, a, n) }) }) }),
...
const Xw = (e, t) => e === "f" ? /* @__PURE__ */ c(st, { children: [
  /* @__PURE__ */ r(go, {}),
  " ",
  t["%footnoteEditor_noteType_footnote_label%"]
] }) : e === "fe" ? /* @__PURE__ */ c(st, { children: [
  /* @__PURE__ */ r(bo, {}),
  " ",
...
function Jw({
  ...
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
      /* @__PURE__ */ r(Di, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Xw(e, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: Ww(e, n) }) })
    ] }) }),
...
function pp({
  ...
  const d = X(null), w = os(), [p, u] = I("generated"), [h, f] = I("*"), [g, v] = I("f"), [x, y] = I(!1), N = j(
    () => ({
      ...i,
      markerMenuTrigger: i.markerMenuTrigger ?? "\\",
      hasExternalUI: !0,
      view: { ...i.view ?? Gi(), noteMode: "expanded" }
    }),
    [i]
  );
  q(() => {
    ...
    var E, T;
    let k;
    const R = t == null ? void 0 : t.at(0);
    if (R && ln("note", R)) {
      const P = (E = R.insert.note) == null ? void 0 : E.caller;
      let $ = "custom";
      P === Xn ? $ = "generated" : P === Wn ? $ = "hidden" : P && f(P), u($), v(((T = R.insert.note) == null ? void 0 : T.style) ?? "f"), k = setTimeout(() => {
        var M;
  ...
  const _ = G(() => {
    ...
    if (R && ln("note", R)) {
      ...
      g !== "x" && k === "x" ? A == null || A.forEach((B) => Zw(B)) : g === "x" && k !== "x" && (A == null || A.forEach((B) => Qw(B))), (M = d.current) == null || M.applyUpdate([R, { delete: 1 }]);
    }
  }, L = (k) => {
    var E, T, P, $, M;
    const R = (T = (E = d.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : T.at(0);
    if (R && ln("note", R)) {
      ...
      const A = (P = R.insert.note) == null ? void 0 : P.style, B = (M = ($ = R.insert.note) == null ? void 0 : $.contents) == null ? void 0 : M.ops;
      A || y(!1), y(
        A === "x" ? !!(B != null && B.every((C) => {
          var ct, ut;
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
          /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Me, {}) }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
            /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: S, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(mo, {}) }) }),
...
function rd({
  ...
  const d = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${e.marker} ` }) : void 0, w = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${e.marker}*` }) : void 0, p = a && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
  // specific class name in case styling is needed.
  /* @__PURE__ */ c("span", { className: m("note-caller tw-inline-block", { formatted: s }), children: [
    a,
    " "
  ] }), u = i && /* @__PURE__ */ c(st, { children: [
    Cr(e.marker, [i], o, !1),
    " "
  ] }), h = t === "horizontal" ? "horizontal" : "vertical", f = o ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", v = m(h, f);
  return /* @__PURE__ */ c(st, { children: [
    /* @__PURE__ */ c("div", { className: m("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", v), children: [
      d,
      p
    ] }),
    /* @__PURE__ */ r("div", { className: m("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", v), children: u }),
    /* @__PURE__ */ r(
      "div",
      {
        className: m(
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(st, { children: ed(e.marker, l, o, w) })
      }
    )
  ] });
}
function mp({
  ...
  const p = d ?? Hs(n, void 0), u = (N, _) => {
    w == null || w(N, _, a);
  }, h = s ? n.findIndex((N) => N === s) : -1, [f, g] = I(h), v = (N, _, S) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
function ad({
  ...
  return /* @__PURE__ */ c(Tn, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Sn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ c(
      jt,
      {
        onClick: () => {
          t(l.reference);
        ...
        children: [
          /* @__PURE__ */ r(he, { children: Jt(l.reference, "English") }),
          /* @__PURE__ */ r(he, { className: o, children: od(l.text) })
        ]
      },
...
const sd = (e) => {
...
}, Dn = (e, t, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
  /* @__PURE__ */ c(
    Tt,
    {
  ...
  /* @__PURE__ */ r(_t, { side: "bottom", children: t })
] }) }), fp = (e) => ({
  accessorKey: "item",
  accessorFn: (t) => t.items[0],
  header: ({ column: t }) => Dn(t, e)
}), id = (e, t) => ({
  accessorKey: `item${t}`,
  accessorFn: (n) => n.items[t],
  header: ({ column: n }) => Dn(n, e)
}), hp = (e) => ({
  accessorKey: "count",
  header: ({ column: t }) => Dn(t, e, "tw-justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: s }) => Dn(s, e, "tw-justify-center"),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ c(Nr, { value: i, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        Ye,
        {
          onClick: (d) => {
            d.stopPropagation(), Fn(
              [l],
              "approved",
              t,
              n,
  ...
  return t ? t[1] : "";
}, ld = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", yp = Object.freeze([
...
function Np({
  ...
  const f = It(n, "%webView_inventory_all%"), g = It(n, "%webView_inventory_approved%"), v = It(n, "%webView_inventory_unapproved%"), x = It(n, "%webView_inventory_unknown%"), y = It(n, "%webView_inventory_scope_currentBook%"), N = It(n, "%webView_inventory_scope_chapter%"), _ = It(n, "%webView_inventory_scope_verse%"), S = It(n, "%webView_inventory_filter_text%"), z = It(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = It(n, "%webView_inventory_no_results%"), [k, R] = I(!1), [E, T] = I("all"), [P, $] = I(""), [M, A] = I([]), B = j(() => {
    const F = e ?? [];
    return F.length === 0 ? [] : dd(F, a, s);
  }, [e, a, s]), C = j(() => {
    if (k) return B;
    const F = [];
    return B.forEach((at) => {
      const ft = at.items[0], lt = F.find(
        (yt) => yt.items[0] === ft
      );
      lt ? (lt.count += at.count, lt.occurrences = lt.occurrences.concat(at.occurrences)) : F.push({
        items: [ft],
        count: at.count,
  ...
  }, [k, B]), K = j(() => C.length === 0 ? [] : wd(C, E, P), [C, E, P]), ct = j(() => {
    var ft, lt;
    if (!k) return d;
    const F = (ft = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ft.length;
    if (!F) return d;
    const at = [];
  ...
  const ut = (F, at) => {
    at.setRowSelection(() => {
      const lt = {};
      return lt[F.index] = !0, lt;
    });
    const ft = F.original.items;
        ...
        Se,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ c(be, { children: [
              ...
              /* @__PURE__ */ r(Nt, { value: "unapproved", children: v }),
              /* @__PURE__ */ r(Nt, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ c(Se, { onValueChange: (F) => Lt(F), defaultValue: i, children: [
...
function cd({ icon: e, className: t }) {
  return /* @__PURE__ */ r(e ?? Ds, { className: t, size: 16 });
}
function _p({ localizedStrings: e, markerMenuItems: t }) {
  const [n, o] = I(""), a = j(() => {
      ...
      /* @__PURE__ */ r(Gt, { children: a.map((s) => {
        ...
        return /* @__PURE__ */ c(
          Pt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-6", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(cd, { icon: s.icon }) }) }),
              /* @__PURE__ */ c("div", { children: [
          ...
          `item-${s.marker ?? ((i = s.icon) == null ? void 0 : i.displayName)}-${s.title.replaceAll(" ", "")}`
        );
      }) })
    ] })
  ] });
}
const pd = "16rem", ud = "3rem", Ta = b.createContext(void 0);
function Mn() {
  const e = b.useContext(Ta);
  if (!e)
...
const Ra = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), u = t ?? w, h = b.useCallback(
      (_) => {
        const S = typeof _ == "function" ? _(u) : _;
        n ? n(S) : p(S);
      },
      [n, u]
    ), f = b.useCallback(() => h((_) => !_), [h]), g = u ? "expanded" : "collapsed", y = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ta.Provider, { value: N, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Sa = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Mn();
...
const md = b.forwardRef(({ className: e, onClick: t, ...n }, o) => {
  const a = Mn();
  return /* @__PURE__ */ c(
    V,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Ms, {}) : /* @__PURE__ */ r(Os, {}),
...
const hd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  je,
  {
    ref: n,
    "data-sidebar": "input",
...
const xd = b.forwardRef(({ className: e, asChild: t = !1, ...n }, o) => /* @__PURE__ */ r(
  t ? Ie : "button",
  {
    ref: o,
...
const yd = ne(
  ...
  ({
    ...
    const d = e ? Ie : "button", { state: w } = Mn(), p = /* @__PURE__ */ r(
      d,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": t,
        className: m(yd({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Nd = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  t ? Ie : "button",
  {
    ref: a,
...
const _d = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, o) => {
...
_d.displayName = "SidebarMenuSkeleton";
...
const Td = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  e ? Ie : "a",
  {
    ref: s,
    ...
    Sa,
    {
      ...
      children: /* @__PURE__ */ c(Ma, { children: [
        /* @__PURE__ */ c(sr, { children: [
          ...
          /* @__PURE__ */ r(lr, { children: /* @__PURE__ */ r(Oa, { children: Object.entries(t).map(([h, f]) => /* @__PURE__ */ r(Ia, { children: /* @__PURE__ */ r(
            Aa,
            {
              onClick: () => w(h),
              isActive: u(h),
...
const Tr = tn(
  ({ value: e, onSearch: t, placeholder: n, isFullWidth: o, className: a, isDisabled: s = !1, id: i }, l) => {
    const d = dt();
    return /* @__PURE__ */ c("div", { id: i, className: m("tw-relative", { "tw-w-full": o }, a), children: [
      /* @__PURE__ */ r(
        lo,
        {
          className: m(
...
const Wt = "scrBook", Sd = "scrRef", pe = "source", Dd = "details", Md = "Scripture Reference", Od = "Scripture Book", Pa = "Type", Id = "Details";
function Ad(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: Wt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Md,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? ot.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Wt ? Jt(a.start) : void 0;
      },
...
}, oo = (e) => `${Pd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Ep({
  sources: e,
  ...
  const [w, p] = I([]), [u, h] = I([{ id: Wt, desc: !1 }]), [f, g] = I({}), v = j(
    () => e.flatMap((E) => E.data.map((T) => ({
      ...T,
      source: E.source
    }))),
    [e]
  ...
  q(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const P = v.find(($) => oo($) === T[0]) || void 0;
        P && l(P);
      }
    }
  }, [f, v, l, y]);
  const N = a ?? Od, _ = s ?? Pa, S = [
    ...
    !t && /* @__PURE__ */ c(
      Se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(be, { position: "item-aligned", children: /* @__PURE__ */ r(Dw, { children: S.map((E) => /* @__PURE__ */ r(Nt, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Tn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ r(Rn, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(jt, { children: E.headers.filter((T) => T.column.columnDef.header).map((T) => (
        ...
        return /* @__PURE__ */ r(
          jt,
          {
            ...
            children: E.getVisibleCells().map(($) => {
              if (!($.getIsPlaceholder() || $.column.columnDef.enableGrouping && !$.getIsGrouped() && ($.column.columnDef.id !== pe || !n)))
                return /* @__PURE__ */ r(
                  he,
                  {
                    className: m(
...
}), $a = (e, t, n) => Rr(e, t).every((o) => n.includes(o));
function $d({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = Rr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    V,
    {
      variant: "outline",
      ...
      onClick: () => o(e),
      className: m(
        $a(t, e, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Zi(
        e,
...
function Ld({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], u = o["%webView_book_selector_more%"], { otLong: h, ntLong: f, dcLong: g, extraLong: v } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, y] = I(!1), [N, _] = I(""), S = X(void 0), z = X(!1);
  if (e.length !== ot.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const L = j(() => ot.allBookIds.filter(
    (A, B) => e[B] === "1" && !ot.isObsolete(ot.bookIdToNumber(A))
  ), [e]), k = j(() => {
    if (!N.trim()) {
      const C = {
        [U.OT]: [],
    ...
    (A, B = !1) => {
      if (!B || !S.current) {
        n(
          t.includes(A) ? t.filter((mt) => mt !== A) : [...t, A]
        ), S.current = A;
        return;
      }
      ...
      n(
        t.includes(A) ? t.filter((mt) => !Lt.includes(mt)) : [.../* @__PURE__ */ new Set([...t, ...Lt])]
      );
    },
    [t, n, L]
  ), E = (A) => {
    ...
    A.preventDefault(), R(B, A.shiftKey);
  }, P = G(
    (A) => {
      const B = Rr(L, A).map((C) => C);
      n(
        $a(L, A, t) ? t.filter((C) => !B.includes(C)) : [.../* @__PURE__ */ new Set([...t, ...B])]
      );
    },
    [t, n, L]
  ), $ = () => {
                  ...
                  Object.values(U).map((A, B) => {
                    ...
                    if (C.length !== 0)
                      return /* @__PURE__ */ c(io, { children: [
                        ...
                        B < Object.values(U).length - 1 && /* @__PURE__ */ r(jo, {})
                      ] }, A);
                  })
                ] })
              ]
...
function Rp({
  ...
  const w = de(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = de(i, "%webView_scope_selector_current_book%"), f = de(i, "%webView_scope_selector_choose_books%"), g = de(i, "%webView_scope_selector_scope%"), v = de(i, "%webView_scope_selector_select_books%"), x = [
  ...
  ], y = t ? x.filter((N) => t.includes(N.value)) : x;
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          be,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ r(Nt, { value: `${w}`, children: l[W(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Va = (e, t, n, o) => n ? Object.entries(e).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Et, { children: [
  ...
  ) : /* @__PURE__ */ c(Cw, { children: [
    /* @__PURE__ */ r(ya, { children: l.label }),
    /* @__PURE__ */ r(_w, { children: /* @__PURE__ */ r(Na, { children: Va(
      e,
      t,
      La(e, l.id),
      o
...
function wr({
  ...
  return /* @__PURE__ */ c(ve, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(V, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(As, {}) }) }),
    /* @__PURE__ */ r(ae, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(io, { children: [
      /* @__PURE__ */ r(xa, { children: /* @__PURE__ */ r(kt, { children: Va(t.groups, t.items, d, e) }) }),
...
function Ip({
  ...
  return /* @__PURE__ */ c(ja, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      wr,
      {
        onSelectMenuItem: e,
...
const za = b.forwardRef(({ className: e, ...t }, n) => {
  const o = dt();
  return /* @__PURE__ */ r(
    xt.Root,
    {
...
Ba.displayName = xt.List.displayName;
const Vd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  xt.Trigger,
  {
    ref: n,
...
)), Fa = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  xt.Content,
  {
    ref: n,
    className: m(
...
function Pp({
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(za, { children: [
      /* @__PURE__ */ r(Ba, { children: e.map((l) => /* @__PURE__ */ r(Vd, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ r(Fa, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function jd({ ...e }) {
...
const Ga = b.forwardRef(({ className: e, variant: t = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: t
    }),
...
const Ha = b.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Mt();
...
const Ya = b.forwardRef(({ className: e, inset: t, ...n }, o) => {
  const a = Mt();
  return /* @__PURE__ */ r(
    et.Item,
    {
...
const Bd = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => {
  const s = Mt();
  return /* @__PURE__ */ c(
    et.CheckboxItem,
    {
...
Bd.displayName = et.CheckboxItem.displayName;
const Fd = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = Mt();
  return /* @__PURE__ */ c(
    et.RadioItem,
    {
...
Fd.displayName = et.RadioItem.displayName;
const Gd = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  et.Label,
  {
    ref: o,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
Gd.displayName = et.Label.displayName;
...
const Fe = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Et, { children: [
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(Xa, {}, `separator-${s}`)), d;
  });
};
function Kd({
  menuData: e,
  ...
  const a = X(void 0), s = X(void 0), i = X(void 0), l = X(void 0), d = X(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (Ui(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    switch (u.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Fe(s, [h, f]);
        break;
      case "alt+l":
        (v = i.current) == null || v.focus(), Fe(i, [h, f]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), Fe(l, [h, f]);
        break;
      case "alt+h":
        (y = d.current) == null || y.focus(), Fe(d, [h, f]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ r(Ga, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ c(jd, { children: [
      /* @__PURE__ */ r(Ka, { ref: w(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        Ha,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(kt, { children: Wa(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function Vp({
  ...
  const w = Ud(
    ...
    var y, N, _, S, z, L;
    const x = v !== g ? ((N = (y = e[g]) == null ? void 0 : y.uiNames) == null ? void 0 : N[v]) ?? ((S = (_ = e[g]) == null ? void 0 : _.uiNames) == null ? void 0 : S.en) : void 0;
    return x ? `${(z = e[g]) == null ? void 0 : z.autonym} (${x})` : (L = e[g]) == null ? void 0 : L.autonym;
  };
      ...
      Se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(e).map((g) => /* @__PURE__ */ r(Nt, { value: g, children: f(g, t) }, g))
            }
          )
        ]
      }
    ),
    t !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(wt, { className: "tw-font-normal tw-text-muted-foreground", children: ue(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => f(g, t)).join(", ") : e.en.autonym
    }) }) })
  ] });
}
function qd({ item: e, createLabel: t, createComplexLabel: n }) {
...
function jp({
  ...
  return /* @__PURE__ */ r("div", { id: e, className: t, children: n.map((l) => /* @__PURE__ */ c("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ r(
      Er,
      {
  ...
  return /* @__PURE__ */ c("div", { className: m("tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none"), children: [
    /* @__PURE__ */ c(
      V,
      {
        ...
        children: [
          /* @__PURE__ */ r("span", { className: m({ "tw-me-2": i === "allText" }), children: t ? Xs(e, t, s) : Jt(
            e,
...
function Bp({
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      onDoubleClick: p,
      onKeyDown: (v) => {
        document.activeElement === (f == null ? void 0 : f.current) && (v.key === "Enter" || v.key === " ") && (v.preventDefault(), n == null || n());
      },
      ref: f,
      role: "button",
      tabIndex: 0,
      ...
      children: [
        /* @__PURE__ */ c("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": t }), children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ r(
                    Hd,
                    {
                      startRef: u == null ? void 0 : u.startRef,
                      endRef: u == null ? void 0 : u.endRef,
                      scriptureTextPart: u.scriptureTextPart,
                      scrRefFormattingOptions: u.scrRefFormattingOptions,
                      onClick: (v) => {
                        v == null || v.stopPropagation(), n(), p == null || p();
                      },
            ...
            t && l && /* @__PURE__ */ r("div", { className: "tw-p-1", children: /* @__PURE__ */ c(ve, { children: [
              /* @__PURE__ */ r(Le, { className: w, asChild: !0, children: /* @__PURE__ */ r(V, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(po, {}) }) }),
              /* @__PURE__ */ r(ae, { align: "end", children: l })
            ] }) })
          ] }),
          t && d && /* @__PURE__ */ r("div", { className: "tw-ms-1 tw-w-fit tw-min-w-0 tw-max-w-full tw-overflow-hidden tw-break-words", children: d })
        ] }),
        w && /* @__PURE__ */ r(
          "div",
          {
...
const Yd = tn(({ className: e, ...t }, n) => /* @__PURE__ */ r(Ls, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
), Wd = b.forwardRef(({ className: e, variant: t, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Jd.displayName = "AlertTitle";
const Zd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Zd.displayName = "AlertDescription";
const Gp = nt.Root, Kp = nt.Trigger, Up = nt.Group, qp = nt.Portal, Hp = nt.Sub, Yp = nt.RadioGroup, Qd = b.forwardRef(({ className: e, inset: t, children: n, ...o }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
Qd.displayName = nt.SubTrigger.displayName;
...
tc.displayName = nt.SubContent.displayName;
const ec = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(nt.Portal, { children: /* @__PURE__ */ r(
  nt.Content,
  {
    ref: n,
    className: m(
...
ec.displayName = nt.Content.displayName;
const nc = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  nt.Item,
  {
    ref: o,
    className: m(
...
nc.displayName = nt.Item.displayName;
const rc = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
rc.displayName = nt.CheckboxItem.displayName;
const oc = b.forwardRef(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: o,
    className: m(
...
oc.displayName = nt.RadioItem.displayName;
const ac = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  nt.Label,
  {
    ref: o,
    className: m(
...
ac.displayName = nt.Label.displayName;
...
ic.displayName = "ContextMenuShortcut";
...
lc.displayName = "Drawer";
const Xp = Dt.Trigger, wc = Dt.Portal, Wp = Dt.Close, Za = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Dt.Overlay,
  {
    ref: n,
...
Za.displayName = Dt.Overlay.displayName;
const dc = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(Ja), i = {
...
uc.displayName = Dt.Title.displayName;
const mc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Dt.Description,
  {
    ref: n,
    className: m("tw-text-sm tw-text-muted-foreground", e),
...
mc.displayName = Dt.Description.displayName;
const fc = b.forwardRef(({ className: e, value: t, ...n }, o) => /* @__PURE__ */ r(
  Zn.Root,
  {
    ref: o,
    className: m(
...
fc.displayName = Zn.Root.displayName;
function Jp({
  className: e,
  ...t
}) {
...
function Qp({
  ...
  return /* @__PURE__ */ r(
    ur.PanelResizeHandle,
    {
      ...
      ...n,
      children: e && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Vs, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function tu({ ...e }) {
...
const hc = b.forwardRef(({ className: e, ...t }, n) => {
  const o = dt();
  return /* @__PURE__ */ c(
    Ge.Root,
    {
...
hc.displayName = Ge.Root.displayName;
const gc = b.forwardRef(({ className: e, ...t }, n) => {
  const o = dt();
  return /* @__PURE__ */ r(
    Qn.Root,
    {
...
gc.displayName = Qn.Root.displayName;
const eu = xt.Root, bc = b.forwardRef(({ className: e, ...t }, n) => {
  const o = dt();
  return /* @__PURE__ */ r(
    xt.List,
    {
...
bc.displayName = xt.List.displayName;
...
vc.displayName = xt.Trigger.displayName;
const xc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  xt.Content,
  {
    ref: n,
    className: m(
...
xc.displayName = xt.Content.displayName;
...
const kc = (e, t, n = {}) => {
  ...
  o.current = t;
  const a = X(n);
  a.current = Nc(a.current);
  const [s, i] = I(() => o.current), [l, d] = I(!0);
  return q(() => {
    let w = !0;
    return d(!!e), (async () => {
      if (e) {
...
export {
  ...
  kw as AvatarImage,
  Zc as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  Qc as BOOK_SELECTOR_STRING_KEYS,
  Te as Badge,
  Jc as BookChapterControl,
  ...
  op as CommentList,
  Gp as ContextMenu,
  rc as ContextMenuCheckboxItem,
  ec as ContextMenuContent,
  Up as ContextMenuGroup,
  nc as ContextMenuItem,
  ac as ContextMenuLabel,
  qp as ContextMenuPortal,
  Yp as ContextMenuRadioGroup,
  oc as ContextMenuRadioItem,
  sc as ContextMenuSeparator,
  ic as ContextMenuShortcut,
  Hp as ContextMenuSub,
  tc as ContextMenuSubContent,
  Qd as ContextMenuSubTrigger,
  Kp as ContextMenuTrigger,
  Bw as DataTable,
  lc as Drawer,
  Wp as DrawerClose,
  dc as DrawerContent,
  mc as DrawerDescription,
  pc as DrawerFooter,
  cc as DrawerHeader,
  Za as DrawerOverlay,
  wc as DrawerPortal,
  ...
  Bp as ResultsCard,
  Tp as SCOPE_SELECTOR_STRING_KEYS,
  Rp as ScopeSelector,
  Ep as ScriptureResultsViewer,
  Sp as ScrollGroupSelector,
  Tr as SearchBar,
  Se as Select,
  be as SelectContent,
  Dw as SelectGroup,
  ...
  Re as Separator,
  Dp as SettingsList,
  Op as SettingsListHeader,
  Mp as SettingsListItem,
  Rd as SettingsSidebar,
  Cp as SettingsSidebarContentSearch,
  Sa as Sidebar,
  Ma as SidebarContent,
  bd as SidebarFooter,
  sr as SidebarGroup,
  xd as SidebarGroupAction,
  ...
  Vp as UiLanguageSelector,
  za as VerticalTabs,
  Fa as VerticalTabsContent,
  Ba as VerticalTabsList,
  Vd as VerticalTabsTrigger,
  bw as badgeVariants,
  ...
  zp as getLocalizedBookName,
  vp as getNumberFromUSFM,
  ld as getStatusForItem,
  $p as getToolbarOSReservedSpaceClassName,
