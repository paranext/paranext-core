...
var yt = (t, e, n) => Si(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as w, Fragment as Q } from "react/jsx-runtime";
import b, { forwardRef as cn, useRef as H, useMemo as B, useState as R, useCallback as V, useLayoutEffect as It, createContext as Sn, useContext as xr, useEffect as q, Component as Di, createElement as Wr, Suspense as Mi, Fragment as Ro } from "react";
import { Command as Ct } from "cmdk";
import { X as Be, Search as So, Check as Ft, Clock as Jr, ChevronsLeft as Zr, ChevronsRight as Qr, ChevronLeft as tr, ChevronRight as Pe, ArrowLeft as Oi, ArrowRight as Ii, Circle as Dn, ChevronDown as Ke, BoldIcon as Ai, ItalicIcon as Pi, AtSign as Do, Pencil as Li, Trash2 as $i, ArrowUp as Mo, MoreHorizontal as Vi, MailOpen as ji, Mail as zi, ChevronUp as Oo, FilterIcon as Fi, ArrowLeftIcon as Bi, ChevronLeftIcon as Ki, ChevronRightIcon as Ui, ArrowRightIcon as Gi, Copy as Io, Filter as Hi, User as qi, Link as Yi, CircleHelp as Xi, ChevronsUpDown as Ao, Star as Wi, Undo as Ji, Redo as Zi, SquareX as Po, FunctionSquare as Lo, SquareSigma as $o, Ban as Qi, AlertCircle as er, CircleCheckIcon as ts, CircleXIcon as es, CircleHelpIcon as ns, ArrowUpIcon as rs, ArrowDownIcon as os, PanelLeft as as, PanelRight as is, ScrollText as ss, MenuIcon as ls, Menu as cs, EllipsisVertical as ds, MoreVertical as to, LoaderCircle as ws, GripVertical as ps } from "lucide-react";
...
import { includes as mn, Section as X, getChaptersForBook as fs, formatScrRef as Ne, getSectionForBook as Ze, formatRelativeDate as hs, formatReplacementString as ye, sanitizeHtml as gs, NumberFormat as bs, formatBytes as vs, getCurrentLocale as xs, usfmMarkers as vn, getFormatCallerFunction as ys, deepEqual as Ns, isString as eo, compareScrRefs as nr, scrRefToBBBCCCVVV as zn, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import { createEditor as jo, $getRoot as pe, $createParagraphNode as Mn, $getSelection as jt, HISTORY_MERGE_TAG as yr, ParagraphNode as zo, TextNode as Fo, $isTokenOrSegmented as ks, $getCharacterOffsets as _s, $cloneWithPropertiesEphemeral as Cs, $findMatchingParent as Bo, $isElementNode as ce, $isRangeSelection as Ce, CLEAR_EDITOR_COMMAND as Ko, COMMAND_PRIORITY_EDITOR as Uo, mergeRegister as ue, shallowMergeConfig as Es, defineExtension as Jt, safeCast as dn, createState as Ts, FORMAT_TEXT_COMMAND as Go, $isNodeSelection as Ho, COMMAND_PRIORITY_LOW as qo, RootNode as Rs, LineBreakNode as Ss, TabNode as Ds, $isEditorState as Ms, createCommand as Os, CLICK_COMMAND as Is, isDOMNode as As, $getNodeFromDOMNode as Ps, $createNodeSelection as Ls, $setSelection as $s, DecoratorNode as rr, $getState as Vs, toggleTextFormatType as no, TEXT_TYPE_TO_FORMAT as js, $setState as zs, addClassNamesToElement as Yo, $create as Fs, $getNodeByKey as Bs, removeClassNamesFromElement as Ks, KEY_TAB_COMMAND as Us, $isBlockElementNode as kn, $createRangeSelection as Gs, $normalizeSelection__EXPERIMENTAL as Hs, OUTDENT_CONTENT_COMMAND as qs, INDENT_CONTENT_COMMAND as ro, INSERT_TAB_COMMAND as Ys, COMMAND_PRIORITY_CRITICAL as Nr, $isDecoratorNode as Xs, $isParagraphNode as Ws, $isTextNode as _n, SELECTION_CHANGE_COMMAND as Xo, getRegisteredNode as Js, isHTMLElement as Zs, isDocumentFragment as oo, isDOMDocumentNode as Qs, ArtificialNode__DO_NOT_USE as Wo, $createLineBreakNode as Jo, $isRootOrShadowRoot as tl, isBlockDomNode as ao, isInlineDomNode as io, $insertNodes as el } from "lexical";
import * as Ee from "@radix-ui/react-tooltip";
import { TooltipTrigger as nl } from "@radix-ui/react-tooltip";
import { HeadingNode as rl, QuoteNode as ol, registerRichText as al } from "@lexical/rich-text";
...
import * as ta from "@radix-ui/react-separator";
...
import { useReactTable as ea, getFilteredRowModel as dl, getSortedRowModel as na, getPaginationRowModel as wl, getCoreRowModel as ra, flexRender as Qe, getGroupedRowModel as pl, getExpandedRowModel as ul } from "@tanstack/react-table";
import * as wt from "@radix-ui/react-select";
import ml from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as or, HIDDEN_NOTE_CALLER as ar, getDefaultViewOptions as fl, isInsertEmbedOpOfType as fn, Editorial as hl } from "@eten-tech-foundation/platform-editor";
...
import { toast as am } from "sonner";
import * as Je from "@radix-ui/react-slider";
import * as lr from "@radix-ui/react-switch";
const vl = ms({ prefix: "tw-" });
function h(...t) {
  return vl(us(t));
}
const xl = "layoutDirection";
function mt() {
  const t = localStorage.getItem(xl);
  return t === "rtl" ? t : "ltr";
}
const oa = At.Root, aa = At.Portal, _r = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  At.Overlay,
  {
    ref: n,
    className: h(
...
ia.displayName = At.Content.displayName;
...
Se.displayName = Ct.Input.displayName;
...
Qt.displayName = Ct.List.displayName;
const He = b.forwardRef((t, e) => /* @__PURE__ */ r(Ct.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
He.displayName = Ct.Empty.displayName;
const zt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Ct.Group,
  {
    ref: n,
...
zt.displayName = Ct.Group.displayName;
...
sa.displayName = Ct.Separator.displayName;
...
Kt.displayName = Ct.Item.displayName;
...
la.displayName = "CommandShortcut";
const ca = (t, e, n, o, a) => {
  switch (t) {
    case X.OT:
...
const da = ut.allBookIds.filter(
  (t) => !ut.isObsolete(ut.bookIdToNumber(t))
), ke = Object.fromEntries(
  da.map((t) => [t, ut.bookIdToEnglishName(t)])
);
function Dr(t, e, n) {
...
const wa = cn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Ue : "button", { className: h(pa({ variant: e, size: n, className: t })), ref: i, ...a })
);
z.displayName = "Button";
const wn = 250, ua = 300, Le = 400, Nl = 450, kl = 500, Ut = we.Root, ge = we.Trigger, Mr = we.Anchor, Pt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, i) => {
  const s = mt();
...
function cr(t, e, n) {
  return `${t} ${ke[t]}${e ? ` ${Sr(t, e)} ${Ae(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function _l({
  recentSearches: t,
  ...
  return /* @__PURE__ */ w(Ut, { open: p, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(Pt, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(zt, { heading: i, children: t.map((m) => /* @__PURE__ */ w(
      Kt,
      {
        onSelect: () => f(m),
...
function qp(t, e, n = (a, i) => a === i, o = 15) {
  return (a) => {
    const i = t.filter(
      (l) => !n(l, a)
    ), s = [a, ...i.slice(0, o - 1)];
...
function lo({
  ...
  if (t)
    return /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Yt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      Kt,
      {
        value: `${t} ${ke[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function Yp({
  ...
  const c = mt(), [p, u] = R(!1), [f, m] = R(""), [g, x] = R(""), [v, y] = R("books"), [N, k] = R(void 0), [C, K] = R(!1), F = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), S = H({}), j = V(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
  ...
  }), [L]), P = B(() => Object.values(I).flat(), [I]), W = B(() => {
    if (!g.trim()) return I;
    const D = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: _, isDigit: $ } = so(D.key);
      if (v === "chapters") {
        if (D.key === "Backspace") {
    ...
    const { isLetter: _, isDigit: $ } = so(D.key);
    (_ || $) && (D.preventDefault(), x((G) => G + D.key), A.current.focus(), K(!1));
  }, []);
  return It(() => {
    const D = setTimeout(() => {
    ...
    /* @__PURE__ */ r(Pt, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ w(
      Zt,
      {
        ref: F,
        onKeyDown: re,
        ...
        children: [
          ...
          !C && /* @__PURE__ */ w(Qt, { ref: M, children: [
            v === "books" && /* @__PURE__ */ w(Q, { children: [
              !O && Object.entries(W).map(([D, _]) => {
                if (_.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(zt, { heading: ee(D), children: _.map(($) => /* @__PURE__ */ r(
                      wa,
                      {
                        bookId: $,
                        onSelect: (G) => Tt(G),
              ...
              O && /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(
                Kt,
                {
                  ...
                  children: Ne(
                    ...
                    a ? Sr(O.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              O && Yt(O.book) > 1 && /* @__PURE__ */ w(Q, { children: [
...
), ht = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Vo.Root, { ref: n, className: h("pr-twp", Rl(), t), ...e }));
ht.displayName = Vo.Root.displayName;
const Or = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    rn.Root,
    {
...
function dr({
  ...
  const [k, C] = R(!1), K = c ?? d, F = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], A = (M, E) => {
    ...
    /* @__PURE__ */ r(
      Pt,
      {
        ...
        children: /* @__PURE__ */ w(Zt, { children: [
          ...
          /* @__PURE__ */ r(Qt, { children: F(e) ? e.map((M) => /* @__PURE__ */ r(zt, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
const fa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = fa ? It : q, hn = { tag: yr };
function Il({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: d } = t, c = Ml(null, o), p = jo({ editable: t.editable, html: d, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, f) {
      if (f !== null) {
        if (f === void 0) u.update(() => {
          ...
          if (m.isEmpty()) {
            const g = Mn();
            m.append(g);
            const x = fa ? document.activeElement : null;
  ...
  }, []), r(ma.Provider, { value: n, children: e });
}
const Al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
...
const Ir = {
  ...
  mark: "",
  markOverlap: ""
}, kt = Ee.Provider, St = Ee.Root, Dt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Ee.Trigger,
  {
    ref: o,
    className: e ? h(pa({ variant: e }), t) : t,
    ...n
  }
));
Dt.displayName = Ee.Trigger.displayName;
...
function jl({ children: t, onError: e }) {
  return r($l, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Fl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Bl() {
  return function(t) {
    const [e] = te(), n = B(() => t(e), [e, t]), [o, a] = R(() => n.initialValueFn()), i = H(o);
    return zl(() => {
...
const ha = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gl = ha && "documentMode" in document ? document.documentMode : null;
!(!ha || !("InputEvent" in window) || Gl) && "getTargetRanges" in new window.InputEvent("input");
function Hl(t) {
  const e = Bo(t, (n) => ce(n) && !n.isInline());
  return ce(e) || Ul(4, t.__key), e;
}
function ql(t) {
  const e = jt();
  if (!Ce(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = Bo(i, (c) => ce(c) && !c.isInline());
    if (l === null) continue;
    const d = l.getKey();
...
function In() {
  ...
  for (; tn !== void 0; ) {
    ...
    for (tn = void 0, pr++; n !== void 0; ) {
      const o = n.o;
      if (n.o = void 0, n.f &= -3, !(8 & n.f) && ga(n)) try {
        n.c();
      } catch (a) {
        e || (t = a, e = !0);
      }
...
function Pr(t) {
  ...
  t.x = void 0, t.s = void 0, va(t);
}
function Jl(t) {
  if (Z !== this) throw new Error("Out-of-order effect");
  ba(this), Z = t, this.f &= -2, 8 & this.f && Pr(this), In();
}
function Ie(t, e) {
...
Nt.prototype.brand = Yl, Nt.prototype.h = function() {
  return !0;
}, Nt.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : co(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const e = t.e, n = t.x;
    e !== void 0 && (e.x = n, t.e = void 0), n !== void 0 && (n.e = e, t.x = void 0), t === this.t && (this.t = n, n === void 0 && co(() => {
      var o;
  ...
  if (this.g = xn, this.f |= 1, this.i > 0 && !ga(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    po(this), Z = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, va(this), po(this), de++;
  const t = Z;
  return Z = this, Jl.bind(this, t);
...
function xa() {
  const t = pe(), e = jt(), n = Mn();
  t.clear(), t.append(n), e !== null && n.select(), Ce(e) && (e.format = 0);
}
function ya(t, e = xa) {
  return t.registerCommand(Ko, (n) => (t.update(e), !0), Uo);
}
Jt({ build: (t, e, n) => An(e), config: dn({ $onClear: xa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return me(() => ya(t, o.value));
} });
function Zl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Un = Ts("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Na extends rr {
  $config() {
...
Jt({ name: "@lexical/extension/DecoratorText", nodes: () => [Na], register: (t, e, n) => t.registerCommand(Go, (o) => {
  const a = jt();
  if (Ho(a) || Ce(a)) for (const i of a.getNodes()) Ql(i) && i.toggleFormat(o);
  return !1;
}, qo) });
function ka(t, e) {
  let n;
...
const ur = Jt({ build: (t) => ka(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function _a(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const n = t, o = e;
    for (const a in o) n[a] = _a(n[a], o[a]);
    return t;
  }
  return e;
}
const Lr = 0, mr = 1, Ca = 2, Gn = 3, gn = 4, Oe = 5, Hn = 6, Xe = 7;
function qn(t) {
  return t.id === Lr;
}
function Ea(t) {
...
function tc(t) {
  return function(e) {
    return e.id === mr;
  }(t) || nt(305, String(t.id), String(mr)), Object.assign(t, { id: Ca });
}
...
class nc {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Es;
    for (const o of this.configs) e = n(e, o);
    return e;
  }
  init(e) {
    const n = this.state;
    Ea(n) || nt(306, String(n.id));
...
const oc = Jt({ config: dn({ setOptions: uo, updateOptions: uo }), init: ({ $initialEditorState: t = rc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: i } = a;
    if (Ms(i)) t.setEditorState(i, n);
...
}, name: "@lexical/extension/InitialState", nodes: [Rs, Fo, Ss, Ds, zo] }), mo = Symbol.for("@lexical/extension/LexicalBuilder");
function fo() {
}
function ac(t) {
  throw t;
...
class en {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && nt(298, o.name), !a) {
      a = new nc(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      qn(i) || nt(300, s, a || "[unknown]"), qn(l = i) || nt(304, String(l.id), String(Lr)), i = Object.assign(l, { id: mr }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const p of l) {
      const { extension: u } = p;
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const f of Zl(u)) {
...
const ic = /* @__PURE__ */ new Set(), ho = Jt({ build(t, e, n) {
  const o = n.getDependency(ur).output, a = on({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ka(() => {
  }, () => me(() => {
...
Os("INSERT_HORIZONTAL_RULE_COMMAND");
class $e extends rr {
  static getType() {
...
Jt({ dependencies: [ur, ho], name: "@lexical/extension/HorizontalRule", nodes: () => [$e], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(ho).output, a = on({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ue(t.registerCommand(Is, (s) => {
    if (As(s.target)) {
      const l = Ps(s.target);
      if (lc(l)) return function(d, c = !1) {
        const p = jt(), u = d.isSelected(), f = d.getKey();
        let m;
        c && Ho(p) ? m = p : (m = Ls(), $s(m)), u ? m.delete(f) : m.add(f);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, qo), t.registerMutationListener($e, (s, l) => {
    Xl(() => {
      let d = !1;
...
function cc(t, e, n = Ra) {
  return ue(t.registerCommand(Us, (o) => {
    const a = jt();
    if (!Ce(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((f) => kn(f) && f.canIndent()).length > 0) return !0;
      const l = s.anchor, d = s.focus, c = d.isBefore(l) ? d : l, p = c.getNode(), u = Hl(p);
      if (u.canIndent()) {
        const f = u.getKey();
        let m = Gs();
        if (m.anchor.set(f, 0, "element"), m.focus.set(f, 0, "element"), m = Hs(m), m.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? qs : ro : Ys;
    return t.dispatchCommand(i, void 0);
  }, Uo), t.registerCommand(ro, () => {
...
Jt({ build: (t, e, n) => An(e), config: dn({ $canIndent: Ra, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: i } = n.getOutput();
  return me(() => {
    if (!o.value) return cc(t, a, i);
  });
} });
...
Jt({ build: (t, e, n) => An(e), config: dn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => me(() => n.getOutput().disabled.value ? void 0 : Da(t)) });
function mc(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const $r = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
  ...
  return function(n, o) {
    ...
    return $r(() => n.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const c = l[d], p = r(o, { onError: (f) => n._onError(f), children: r(Mi, { fallback: null, children: a[c] }) }), u = n.getElementByKey(c);
        u !== null && s.push(sl(p, u, c));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function hc({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(dc.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && mc(320, a);
      return !0;
    }
    return !1;
...
function gc({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    $r(() => ue(al(a), Da(a)), [a]);
  }(o), w(Q, { children: [t, r(bc, { content: e }), r(hc, { editor: o, ErrorBoundary: n })] });
}
...
const xc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function yc({ onClear: t }) {
  const [e] = te();
  return xc(() => ya(e, t), [e, t]), null;
}
const Ma = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Nc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: u, ariaRequired: f, autoCapitalize: m, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: k, "data-testid": C, ...K }, F) {
  ...
  return Ma(() => (M(t.isEditable()), t.registerEditableListener((j) => {
    M(j);
...
function Cc(t, e) {
  ...
  return w(Q, { children: [r(kc, { editor: a, ...o, ref: e }), n != null && r(Ec, { editor: a, content: n })] });
}
function Ec({ content: t, editor: e }) {
  const n = function(s) {
    const [l, d] = R(() => bo(s));
    return Ma(() => {
      function c() {
...
function Sc() {
  const [t, e] = R(void 0), n = V(() => {
    ...
    return /* @__PURE__ */ r(oa, { open: !0, onOpenChange: n, children: /* @__PURE__ */ w(ia, { children: [
...
function Dc({
  ...
  const [e] = te(), [n, o] = R(e), [a, i] = R("paragraph"), [s, l] = Sc(), d = () => {
  };
...
), Oc = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Zo.Root,
  {
    ref: a,
...
Oc.displayName = Zo.Root.displayName;
const Pa = b.createContext({
  size: "default",
  variant: "default"
}), Vr = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, i) => {
  const s = mt();
  return /* @__PURE__ */ r(
    On.Root,
    {
...
Vr.displayName = On.Root.displayName;
...
function Ic() {
  const { activeEditor: t } = Ia(), [e, n] = R([]), o = V((a) => {
    if (Ce(a) || ll(a)) {
      const i = [];
      vo.forEach(({ format: s }) => {
  ...
  return Mc(o), /* @__PURE__ */ r(
    Vr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: vo.map(({ format: a, icon: i, label: s }) => /* @__PURE__ */ r(
        nn,
        {
          value: a,
          "aria-label": s,
...
function Pc({
  ...
  return /* @__PURE__ */ w("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Dc, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Ic, {}) }) }),
      ...
      /* @__PURE__ */ r(
        gc,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ r(Tc, { placeholder: t }) }),
          ErrorBoundary: jl
        }
      ),
      e && /* @__PURE__ */ r(vc, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(Ac, { onClear: n }),
      /* @__PURE__ */ r(yc, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ r(
          Il,
          {
            ...
            children: /* @__PURE__ */ w(kt, { children: [
              /* @__PURE__ */ r(Pc, { placeholder: a, autoFocus: i, onClear: s }),
              /* @__PURE__ */ r(
                Pl,
                {
...
function $c(t, e) {
  const n = Qs(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  for (const i of n) if (!$a.has(i.nodeName)) {
    const s = Va(i, t, a, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Wo && s.insertAfter(Jo());
    for (const s of i) {
...
function La(t, e, n, o = null) {
  ...
  let s = e;
  o !== null && _n(e) && (s = Kl(o, e, "clone"));
  const l = ce(s) ? s.getChildren() : [], d = Js(t, s.getType());
  let c;
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], x = La(t, g, f, o);
    !a && ce(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Zs(p) || oo(p)) && p.append(f), n.append(p), u) {
      const m = u.call(s, p);
      m && (oo(p) ? p.replaceChildren(m) : p.replaceWith(m));
    }
  } else n.append(f);
  return a;
}
...
function Va(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  let f = [];
  const m = (l == null || !tl(l)) && (l != null && kn(l) || o);
  for (let g = 0; g < u.length; g++) f.push(...Va(u[g], e, n, m, new Map(a), l));
  return p != null && (f = p(f)), ao(t) && (f = jc(t, f, m ? () => {
    const g = new Wo();
    return n.push(g), g;
  } : Mn)), l == null ? f.length > 0 ? s = s.concat(f) : ao(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : io(g.nextSibling) && io(g.previousSibling);
  }(t) && (s = s.concat(Jo())) : ce(l) && l.append(...f), s;
}
function jc(t, e, n) {
...
function zc(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), i = $c(e, a);
      pe().clear(), el(i);
    },
    {
      discrete: !0
...
function Zp({
  ...
  const [a, i] = R(Fc), [s, l] = R(void 0), [d, c] = R(!1), p = H(void 0), u = H(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ w("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
          /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(z, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Be, {}) }) }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : zr(y) && (y.preventDefault(), y.stopPropagation(), Vt(a) && f());
        },
        onKeyDown: (y) => {
...
const Qp = Object.freeze([
...
], Bc = ["input", "select", "textarea", "button"], Kc = ["button", "textbox"], Uc = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
  ...
  const a = H(null), [i, s] = R(void 0), [l, d] = R(void 0), c = V(
    ...
    if (m.isContentEditable || Bc.includes(g)) return !0;
    const x = m.getAttribute("role");
    if (x && Kc.includes(x)) return !0;
    ...
    (m) => {
      ...
      switch (m.key) {
        case "ArrowDown":
          K = Math.min(C + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          K = Math.max(C - 1, 0), m.preventDefault();
          break;
        case "Home":
          K = 0, m.preventDefault();
          break;
        case "End":
          K = t.length - 1, m.preventDefault();
          break;
        case " ":
        case "Enter":
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: h("pr-twp", Gc({ variant: e }), t), ...n })
);
...
const Yc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
Yc.displayName = "CardDescription";
...
je.displayName = ta.Root.displayName;
...
Ka.displayName = Ge.Root.displayName;
...
Wc.displayName = Ge.Image.displayName;
...
Ua.displayName = Ge.Fallback.displayName;
const Fr = Sn(void 0);
function Gt() {
  const t = xr(Fr);
  if (!t)
...
}), fe = rt.Trigger, Ga = rt.Group, Ha = rt.Portal, qa = rt.Sub, Ya = rt.RadioGroup;
function ae({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Fr.Provider, { value: n, children: /* @__PURE__ */ r(rt.Root, { ...e }) });
}
const Br = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = Gt();
  return /* @__PURE__ */ w(
    rt.SubTrigger,
    {
...
Br.displayName = rt.SubTrigger.displayName;
const Kr = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ r(
    rt.SubContent,
    {
...
Kr.displayName = rt.SubContent.displayName;
...
Ur.displayName = rt.RadioItem.displayName;
...
Xa.displayName = "DropdownMenuShortcut";
function xo({
  comment: t,
  isReply: e = !1,
  localizedStrings: n,
  ...
  const m = V(
    ...
    [t.user]
  ), N = B(() => gs(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ w(Q, { children: [
        /* @__PURE__ */ w(
          an,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), u(zc(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ka, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Ua, { className: "tw-text-xs tw-font-medium", children: y }) }),
        /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          d && /* @__PURE__ */ w(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), m()) : zr(C) && (C.preventDefault(), C.stopPropagation(), Vt(p) && g());
              },
              onKeyDown: (C) => {
                jr(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
        ...
        k && /* @__PURE__ */ w(ae, { children: [
          /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Vi, {}) }) }),
...
function Jc({
  ...
  const [A, M] = R(yo), [E, S] = R(
    void 0
  ), j = o, [L, I] = R(!1), [P, W] = R(!1), [O, J] = R(!1), [Tt, Lt] = R(!1), [Mt, gt] = R(!1), [pt, U] = R(C), [it, st] = R(!1), ct = H(void 0), [xt, ee] = R(/* @__PURE__ */ new Map());
  q(() => {
    let T = !0;
    return (async () => {
  ...
  const Ht = B(() => e.filter((T) => !T.deleted), [e]);
  q(() => {
    let T = !0;
    if (!o || !k) {
      ee(/* @__PURE__ */ new Map());
  ...
  const ne = B(() => Ht[0], [Ht]), Me = H(null), se = H(void 0), re = V(() => {
    var T;
    (T = se.current) == null || T.call(se), M(yo);
  }, []), Ye = V(() => {
    const T = !pt;
  ...
  }, [i, n]), $ = B(() => Ht.slice(1), [Ht]), G = B(() => $.length ?? 0, [$.length]), Y = B(() => G > 0, [G]), lt = B(() => L || G <= 2 ? $ : $.slice(-2), [$, G, L]), et = B(() => L || G <= 2 ? 0 : G - 2, [G, L]), bt = B(
  ...
  const Rt = V(
    ...
    async (T) => {
      const vt = Vt(A) ? Tn(A) : void 0, ft = await u({
        ...T,
        contents: vt,
  ...
  return /* @__PURE__ */ r(
    Fa,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ w(Ba, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                children: pt ? /* @__PURE__ */ r(ji, {}) : /* @__PURE__ */ r(zi, {})
              }
            ),
          ...
          o && /* @__PURE__ */ w(Q, { children: [
            ...
            v !== !1 && (!P || Vt(A)) && /* @__PURE__ */ w(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  zr(T) && (T.preventDefault(), T.stopPropagation(), (Vt(A) || E !== void 0) && Rt());
                },
                onKeyDown: (T) => {
                  jr(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    En,
                  ...
                  /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ w(Ut, { open: O, onOpenChange: J, children: [
                      /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r(
                        z,
                        {
                          size: "icon",
...
function eu({
  ...
  const K = n.filter(
    ...
    [y, x]
  ), { listboxRef: E, activeId: S, handleKeyDown: j } = Uc({
    options: F,
    onOptionSelect: A
  }), L = V(
    (I) => {
...
function Zc({ table: t }) {
  return /* @__PURE__ */ w(ae, { children: [
    /* @__PURE__ */ r(cl, { asChild: !0, children: /* @__PURE__ */ w(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const ze = wt.Root, Qc = wt.Group, Fe = wt.Value, td = he(
  ...
  return /* @__PURE__ */ w(
    wt.Trigger,
    {
      className: h(td({ size: n, className: t })),
      ref: a,
      ...o,
      dir: i,
      children: [
...
Wa.displayName = wt.ScrollUpButton.displayName;
...
ed.displayName = wt.Label.displayName;
...
nd.displayName = wt.Separator.displayName;
function rd({ table: t }) {
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), ld(m, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), sd(l, x, p.key);
...
function dd({
  ...
  var F;
  const [p, u] = R([]), [f, m] = R([]), [g, x] = R({}), [v, y] = R({}), N = B(() => e ?? [], [e]), k = ea({
    data: N,
    columns: t,
    getCoreRowModel: ra(),
  ...
  let K;
  return d ? K = Array.from({ length: 10 }).map((E, S) => `skeleton-row-${S}`).map((E) => /* @__PURE__ */ r(oe, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(_e, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(fr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((F = k.getRowModel().rows) == null ? void 0 : F.length) > 0 ? K = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    oe,
    {
      onClick: () => s(A, k),
    ...
    A.id
  )) : K = /* @__PURE__ */ r(oe, { children: /* @__PURE__ */ r(_e, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ w("div", { className: "pr-twp", id: l, children: [
...
function nu({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(ml, { options: i, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ w("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Io, {}) })
        ] }),
...
function ou({
  ...
  return /* @__PURE__ */ w(Ut, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ w(Pt, { id: i, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
function au({ id: t, label: e, groups: n }) {
  const [o, a] = R(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ w(ae, { children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ w(z, { variant: "default", children: [
      /* @__PURE__ */ r(Hi, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
    ...
    /* @__PURE__ */ r(Wt, { children: n.map((c, p) => /* @__PURE__ */ w("div", { children: [
      ...
      /* @__PURE__ */ r(Ga, { children: c.itemType === 0 ? /* @__PURE__ */ r(Q, { children: c.items.map((u, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Xt,
        {
          checked: o[p][f],
        ...
        Ya,
        {
          ...
          children: c.items.map((u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Ur, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ r(De, {})
    ] }, c.label)) })
...
function md({ id: t, versionHistory: e }) {
...
function su({
  ...
  const s = B(() => vs(n), [n]), d = ((c) => {
    const p = new Intl.DisplayNames(xs(), { type: "language" });
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(md, { versionHistory: a }),
...
function fd({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ w(Ut, { open: M, onOpenChange: p ?? N, children: [
    ...
    /* @__PURE__ */ r(Pt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ w(Zt, { children: [
      ...
      /* @__PURE__ */ w(Qt, { children: [
        ...
        /* @__PURE__ */ r(zt, { children: K.map((S) => /* @__PURE__ */ w(
          Kt,
          {
            value: S.label,
            onSelect: k,
...
function gd({
  ...
  const d = B(() => /Macintosh/i.test(navigator.userAgent), []);
  return /* @__PURE__ */ w(Q, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
        z,
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ w("p", { children: [
        _o(a, "%undoButton_tooltip%"),
        i && ` (${d ? "⌘Z" : "Ctrl+Z"})`
      ] }) })
    ] }) }),
    e && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
        z,
        {
          "aria-label": "Redo",
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ w("p", { children: [
        _o(a, "%redoButton_tooltip%"),
        i && ` (${d ? "⌘⇧Z" : "Ctrl+Y"})`
      ] }) })
    ] }) })
  ] });
}
function bd({ children: t, editorRef: e }) {
  const n = H(null);
  return q(() => {
    var s;
...
const vd = (t, e, n) => t === "generated" ? /* @__PURE__ */ w(Q, { children: [
...
function xd({
  ...
  return /* @__PURE__ */ w(ae, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: vd(t, a, n) }) }) }),
...
const yd = (t, e) => t === "f" ? /* @__PURE__ */ w(Q, { children: [
  /* @__PURE__ */ r(Lo, {}),
  " ",
...
function kd({
  ...
  return /* @__PURE__ */ w(ae, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
      /* @__PURE__ */ r(nl, { asChild: !0, children: /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: yd(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: Nd(t, n) }) })
    ] }) }),
    /* @__PURE__ */ w(Wt, { style: { zIndex: ua }, children: [
...
function Cd({ icon: t, className: e }) {
...
function Ed({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = R(""), i = B(() => {
    ...
    const l = e.filter(
      (d) => {
        var c;
        return (c = d.marker) == null ? void 0 : c.toLowerCase().includes(s);
      }
    );
    return l.push(
      ...e.filter(
        (d) => d.title.toLowerCase().includes(s) && !l.includes(d)
      )
    ), l;
  }, [o, e]);
      ...
      /* @__PURE__ */ r(zt, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ w(
          Kt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Cd, { icon: s.icon }) }) }),
              /* @__PURE__ */ w("div", { children: [
              ...
              (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ r(la, { className: "tw-font-sans", children: s.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
            ]
          },
...
function cu({
  ...
  const [g, x] = R("generated"), [v, y] = R("*"), [N, k] = R("f"), [C, K] = R(!1), [F, A] = R(!0), [M, E] = R(!1), S = H(!1), j = H(""), [L, I] = R(!1), [P, W] = R(), [O, J] = R(), [Tt, Lt] = R(), [Mt, gt] = R(), pt = H(null), U = B(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const Ht = () => {
    ...
    if ($ && fn("note", $)) {
      ...
      N !== "x" && _ === "x" ? dt == null || dt.forEach((Rt) => Rd(Rt)) : N === "x" && _ !== "x" && (dt == null || dt.forEach((Rt) => Sd(Rt))), (bt = p.current) == null || bt.applyUpdate([$, { delete: 1 }]);
    }
  }, re = (_) => {
    ...
    (_) => {
      ...
      if ($ && fn("note", $)) {
        ...
        const dt = (lt = $.insert.note) == null ? void 0 : lt.style, Rt = (bt = (et = $.insert.note) == null ? void 0 : et.contents) == null ? void 0 : bt.ops;
        if (dt || K(!1), K(
          dt === "x" ? !!(Rt != null && Rt.every(($t) => {
            var vt, ft;
    ...
    if (f.current && it.length && _ && _.rangeCount > 0) {
      ...
      W($.left - G.left), J($.top - G.top), Lt($.height), I(!0);
    }
  }, [it, f]);
  return q(() => {
    const _ = () => {
    ...
    /* @__PURE__ */ w("div", { ref: m, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ w("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ w("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
            /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(z, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(Be, {}) }) }),
      ...
      /* @__PURE__ */ w(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(bd, { editorRef: p, children: /* @__PURE__ */ r(
              hl,
              {
                options: U,
                onStateChange: re,
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
              /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
                z,
                {
                  onClick: Ht,
  ...
  return /* @__PURE__ */ w(Q, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(Q, { children: Md(t.marker, l, o, c) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ r($n, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ w(
      oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(_e, { className: o, children: Ad(l.text) })
        ]
      },
...
const Hr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ir.Root,
  {
    ref: n,
    className: h(
...
Hr.displayName = ir.Root.displayName;
const Ld = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(rs, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(os, { className: "tw-h-4 tw-w-4" });
}, Vn = (t, e, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
  /* @__PURE__ */ w(
    Dt,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ w(Vr, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        nn,
        {
          onClick: (d) => {
  ...
  return e ? e[1] : "";
}, Vd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", bu = Object.freeze([
...
function vu({
  ...
  const m = qt(n, "%webView_inventory_all%"), g = qt(n, "%webView_inventory_approved%"), x = qt(n, "%webView_inventory_unapproved%"), v = qt(n, "%webView_inventory_unknown%"), y = qt(n, "%webView_inventory_scope_currentBook%"), N = qt(n, "%webView_inventory_scope_chapter%"), k = qt(n, "%webView_inventory_scope_verse%"), C = qt(n, "%webView_inventory_filter_text%"), K = qt(
    n,
    "%webView_inventory_show_additional_items%"
  ), F = qt(n, "%webView_inventory_no_results%"), [A, M] = R(!1), [E, S] = R("all"), [j, L] = R(""), [I, P] = R([]), W = B(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : zd(U, a, i);
  }, [t, a, i]), O = B(() => {
    if (A) return W;
    const U = [];
    return W.forEach((it) => {
  ...
  }, [A, W]), J = B(() => O.length === 0 ? [] : jd(O, E, j), [O, E, j]), Tt = B(() => {
    var st, ct;
    if (!A) return d;
    ...
    /* @__PURE__ */ w("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ w(
        ze,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(Te, { className: "tw-m-1", children: /* @__PURE__ */ r(Fe, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ w(ze, { onValueChange: (U) => Mt(U), defaultValue: s, children: [
        /* @__PURE__ */ r(Te, { className: "tw-m-1", children: /* @__PURE__ */ r(Fe, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ w(Re, { children: [
      ...
      o && /* @__PURE__ */ w("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(ht, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? K })
      ] })
    ] }),
...
const Nn = "hover:tw-bg-accent hover:tw-text-accent-foreground [transition-duration:0ms]", Fd = 150, Bd = 100;
function Kd({
  label: t,
  items: e,
  onSelect: n
  ...
  const [o, a] = R(!1), i = H(), s = H(), l = V(() => {
    clearTimeout(s.current), i.current = setTimeout(() => a(!0), Fd);
  }, []), d = V(() => {
    clearTimeout(i.current), s.current = setTimeout(() => a(!1), Bd);
  }, []), c = V(() => {
    clearTimeout(s.current);
  }, []);
  return q(() => () => {
    clearTimeout(i.current), clearTimeout(s.current);
  }, []), /* @__PURE__ */ w(qa, { open: o, onOpenChange: a, children: [
    /* @__PURE__ */ r(
      Br,
      {
        className: Nn,
    ...
    /* @__PURE__ */ r(Ha, { children: /* @__PURE__ */ r(
      Kr,
      {
      ...
      n.push(
        /* @__PURE__ */ w(
          an,
          {
            ...
            children: [
              i.label,
              i.shortcut && /* @__PURE__ */ r(Xa, { children: i.shortcut })
            ]
          },
          i.id
        )
...
const ti = "OK", Ud = "Cancel", Gd = "Alert", Hd = "Confirm", qd = "Dialog";
function Yd({
  options: t,
  onOk: e
}) {
  return /* @__PURE__ */ w(Q, { children: [
    ...
    /* @__PURE__ */ r(Er, { children: /* @__PURE__ */ r(z, { onClick: e, children: t.okLabel ?? ti }) })
  ] });
}
function Xd({
  options: t,
  ...
  return /* @__PURE__ */ w(Q, { children: [
    ...
    /* @__PURE__ */ w(Er, { children: [
      /* @__PURE__ */ r(z, { variant: "outline", onClick: n, children: t.cancelLabel ?? Ud }),
      /* @__PURE__ */ r(z, { variant: t.destructive ? "destructive" : "default", onClick: e, children: t.okLabel ?? ti })
    ] })
  ] });
}
function Wd(t) {
...
function yu({
  ...
  const a = H(!1), i = V(
    ...
    [o]
  ), d = Wd(t), c = ("title" in e && typeof e.title == "string" ? e.title : void 0) || Jd(t);
  return /* @__PURE__ */ r(oa, { open: !0, onOpenChange: l, children: /* @__PURE__ */ w(aa, { children: [
    /* @__PURE__ */ r(
      _r,
      {
...
function sw({
  ...
  switch (t.type) {
    case "text":
      return /* @__PURE__ */ r(ew, { content: t });
    case "list":
      return /* @__PURE__ */ r(nw, { content: t });
    case "description":
      return /* @__PURE__ */ r(rw, { content: t });
    case "richText":
      return /* @__PURE__ */ r(aw, { content: t });
    case "card":
      return /* @__PURE__ */ r(iw, { content: t, onAction: e });
    default:
      return;
  }
}
function Nu({
  ...
  return /* @__PURE__ */ w(Ut, { open: !0, onOpenChange: d, children: [
    /* @__PURE__ */ r(Mr, { asChild: !0, children: /* @__PURE__ */ r(
      "div",
      {
    ...
    /* @__PURE__ */ w(
      Pt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(sw, { content: t, onAction: p })
        ]
      }
    )
  ] });
...
function dw({
  ...
  return n.size > 1 || n.size === 1 && !n.has("") ? /* @__PURE__ */ r(Q, { children: Array.from(n.entries()).map(([a, i]) => /* @__PURE__ */ r(zt, { heading: a || void 0, children: i.map((s) => /* @__PURE__ */ r(Co, { item: s, onSelect: e }, s.id)) }, a)) }) : /* @__PURE__ */ r(zt, { children: t.map((a) => /* @__PURE__ */ r(Co, { item: a, onSelect: e }, a.id)) });
}
function ku({
  items: t,
  position: e,
    ...
    Zt,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ w(Qt, { style: { maxHeight: l - 44 }, children: [
          ...
          /* @__PURE__ */ r(dw, { items: t, onSelect: d })
        ] })
      ]
    }
  );
...
const ww = "16rem", pw = "3rem", ei = b.createContext(void 0);
function jn() {
  const t = b.useContext(ei);
  if (!t)
...
const ni = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(ei.Provider, { value: N, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const ri = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, i) => {
  const s = jn();
...
const uw = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = jn();
  return /* @__PURE__ */ w(
    z,
    {
...
mw.displayName = "SidebarRail";
const oi = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "main",
    {
      ref: n,
...
const vw = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ue : "button",
  {
    ref: o,
...
vw.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const d = t ? Ue : "button", { state: c } = jn(), p = /* @__PURE__ */ r(
      d,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: h(xw({ variant: n, size: o }), i),
        ...s
      }
    );
...
const yw = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ue : "button",
  {
    ref: a,
...
yw.displayName = "SidebarMenuAction";
...
Nw.displayName = "SidebarMenuBadge";
const kw = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
kw.displayName = "SidebarMenuSkeleton";
const _w = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "ul",
    {
      ref: n,
...
_w.displayName = "SidebarMenuSub";
const Cw = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Cw.displayName = "SidebarMenuSubItem";
const Ew = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Ue : "a",
  {
    ref: i,
...
Ew.displayName = "SidebarMenuSubButton";
function Tw({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  return /* @__PURE__ */ r(
    ri,
    {
      ...
      children: /* @__PURE__ */ w(ai, { children: [
        /* @__PURE__ */ w(hr, { children: [
          /* @__PURE__ */ r(gr, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ r(br, { children: /* @__PURE__ */ r(ii, { children: Object.entries(e).map(([f, m]) => /* @__PURE__ */ r(si, { children: /* @__PURE__ */ r(
            li,
            {
              onClick: () => c(f),
              isActive: u(f),
...
const le = "scrBook", Rw = "scrRef", xe = "source", Sw = "details", Dw = "Scripture Reference", Mw = "Scripture Book", ci = "Type", Ow = "Details";
function Iw(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, Eo = (t) => `${Aw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Cu({
  sources: t,
  ...
  const [c, p] = R([]), [u, f] = R([{ id: le, desc: !1 }]), [m, g] = R({}), x = B(
  ...
  q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const j = x.find((L) => Eo(L) === S[0]) || void 0;
        j && l(j);
      }
    }
  }, [m, x, l, y]);
  const N = a ?? Mw, k = i ?? ci, C = [
    ...
    !e && /* @__PURE__ */ w(
      ze,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Re, { position: "item-aligned", children: /* @__PURE__ */ r(Qc, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
const Yr = (t, e) => t.filter((n) => {
  try {
    return Ze(n) === e;
  } catch {
    return !1;
  }
}), di = (t, e, n) => Yr(t, e).every((o) => n.includes(o));
function Pw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = Yr(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function Lw({
  ...
  }, [v, y] = R(!1), [N, k] = R(""), C = H(void 0), K = H(!1);
  ...
  const F = B(() => ut.allBookIds.filter(
    ...
    M(P, K.current), K.current = !1;
  }, S = (P, W) => {
    P.preventDefault(), M(W, P.shiftKey);
  }, j = V(
    (P) => {
      const W = Yr(F, P).map((O) => O);
      n(
        di(F, P, e) ? e.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, F]
  ), L = () => {
    ...
    /* @__PURE__ */ w(
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Pt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ w(
            Zt,
            {
              shouldFilter: !1,
              onKeyDown: (P) => {
                P.key === "Enter" && (K.current = P.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Se,
                  ...
                  Object.values(X).map((P, W) => {
                    ...
                    if (O.length !== 0)
                      return /* @__PURE__ */ w(Ro, { children: [
                        ...
                        W < Object.values(X).length - 1 && /* @__PURE__ */ r(sa, {})
                      ] }, P);
                  })
                ] })
              ]
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((l) => l.group === i).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ w(St, { children: [
  /* @__PURE__ */ r(Dt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ w(
    an,
    {
      onClick: () => {
        o(l);
    ...
    /* @__PURE__ */ r(Br, { children: l.label }),
    /* @__PURE__ */ r(Ha, { children: /* @__PURE__ */ r(Kr, { children: pi(
      t,
      e,
      wi(t, l.id),
      o
...
function vr({
  ...
  return /* @__PURE__ */ w(ae, { variant: i, children: [
    /* @__PURE__ */ r(fe, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(ls, {}) }) }),
    /* @__PURE__ */ r(Wt, { align: "start", style: { zIndex: wn }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, c]) => typeof d == "boolean" || typeof c == "boolean" ? 0 : d.order - c.order).map(([d], c, p) => /* @__PURE__ */ w(Ro, { children: [
      /* @__PURE__ */ r(Ga, { children: /* @__PURE__ */ r(kt, { children: pi(e.groups, e.items, d, t) }) }),
...
function Ou({
  ...
  return /* @__PURE__ */ w(ui, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      vr,
      {
        onSelectMenuItem: t,
...
const mi = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Et.Root,
    {
...
mi.displayName = Et.List.displayName;
...
fi.displayName = Et.List.displayName;
...
)), hi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.Content,
  {
    ref: n,
    className: h(
...
hi.displayName = Et.Content.displayName;
function Au({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ w("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ w(mi, { children: [
      /* @__PURE__ */ r(fi, { children: t.map((l) => /* @__PURE__ */ r($w, { value: l.value, children: l.value }, l.key)) }),
...
const gi = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(Fr.Provider, { value: a, children: /* @__PURE__ */ r(
    ot.Root,
    {
      ref: o,
      className: h(
...
gi.displayName = ot.Root.displayName;
const bi = b.forwardRef(({ className: t, ...e }, n) => {
  const o = Gt();
  return /* @__PURE__ */ r(
    ot.Trigger,
    {
...
bi.displayName = ot.Trigger.displayName;
const vi = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = Gt();
  return /* @__PURE__ */ w(
    ot.SubTrigger,
    {
...
vi.displayName = ot.SubTrigger.displayName;
const xi = b.forwardRef(({ className: t, ...e }, n) => {
  const o = Gt();
  return /* @__PURE__ */ r(
    ot.SubContent,
    {
...
xi.displayName = ot.SubContent.displayName;
const yi = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, i) => {
  const s = Gt();
...
yi.displayName = ot.Content.displayName;
const Ni = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Gt();
  return /* @__PURE__ */ r(
    ot.Item,
    {
...
const zw = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = Gt();
  return /* @__PURE__ */ w(
    ot.CheckboxItem,
    {
...
zw.displayName = ot.CheckboxItem.displayName;
const Fw = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Gt();
  return /* @__PURE__ */ w(
    ot.RadioItem,
    {
...
Fw.displayName = ot.RadioItem.displayName;
const Bw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ot.Label,
  {
    ref: o,
    className: h("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Bw.displayName = ot.Label.displayName;
const ki = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ot.Separator,
  {
    ref: n,
    className: h("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
ki.displayName = ot.Separator.displayName;
const We = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((c) => c.group === i).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ w(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ w(
        Ni,
        {
          onClick: () => {
            o(c);
      ...
      ) : /* @__PURE__ */ w(jw, { children: [
        /* @__PURE__ */ r(vi, { children: c.label }),
    ...
    return l.length > 0 && s < a.length - 1 && d.push(/* @__PURE__ */ r(ki, {}, `separator-${i}`)), d;
  });
};
function Kw({
  menuData: t,
  ...
  if (gl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    var g, x, v, y;
    p.preventDefault();
    ...
    return /* @__PURE__ */ r(gi, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ w(Vw, { children: [
      /* @__PURE__ */ r(bi, { ref: c(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        yi,
        {
          style: { zIndex: wn },
          children: /* @__PURE__ */ r(kt, { children: _i(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function $u({
  ...
  const c = Uw(
    ...
    return v ? `${(K = t[g]) == null ? void 0 : K.autonym} (${v})` : (F = t[g]) == null ? void 0 : F.autonym;
  };
        ...
        /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ w(ae, { children: [
              /* @__PURE__ */ r(fe, { className: h(u && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(to, {}) }) }),
...
const Hw = cn(({ className: t, ...e }, n) => /* @__PURE__ */ r(ws, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
...
const Ww = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Ww.displayName = "AlertDescription";
const Fu = at.Root, Bu = at.Trigger, Ku = at.Group, Uu = at.Portal, Gu = at.Sub, Hu = at.RadioGroup, Jw = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ w(
  at.SubTrigger,
  {
    ref: a,
    className: h(
...
Jw.displayName = at.SubTrigger.displayName;
...
Zw.displayName = at.SubContent.displayName;
const Qw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(at.Portal, { children: /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: h(
...
Qw.displayName = at.Content.displayName;
const tp = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  at.Item,
  {
    ref: o,
    className: h(
...
tp.displayName = at.Item.displayName;
const ep = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ w(
  at.CheckboxItem,
  {
    ref: a,
    className: h(
...
ep.displayName = at.CheckboxItem.displayName;
const np = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ w(
  at.RadioItem,
  {
    ref: o,
    className: h(
...
np.displayName = at.RadioItem.displayName;
const rp = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  at.Label,
  {
    ref: o,
    className: h(
...
rp.displayName = at.Label.displayName;
...
op.displayName = at.Separator.displayName;
...
function ip({
  ...
  return /* @__PURE__ */ r(Ci.Provider, { value: o, children: /* @__PURE__ */ r(
    Bt.Root,
    {
...
const qu = Bt.Trigger, sp = Bt.Portal, Yu = Bt.Close, Ei = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Overlay,
  {
    ref: n,
...
Ei.displayName = Bt.Overlay.displayName;
const lp = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: i = "bottom" } = b.useContext(Ci), s = {
...
wp.displayName = Bt.Title.displayName;
...
pp.displayName = Bt.Description.displayName;
const up = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  sr.Root,
  {
    ref: o,
    className: h(
...
up.displayName = sr.Root.displayName;
function Xu({
  className: t,
  ...e
}) {
...
const mp = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ w(
    Je.Root,
    {
...
mp.displayName = Je.Root.displayName;
...
fp.displayName = lr.Root.displayName;
const Qu = Et.Root, hp = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Et.List,
    {
...
hp.displayName = Et.List.displayName;
const gp = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.Trigger,
  {
    ref: n,
    className: h(
...
gp.displayName = Et.Trigger.displayName;
...
bp.displayName = Et.Content.displayName;
...
export {
  Yw as Alert,
  Ww as AlertDescription,
  Xw as AlertTitle,
  Ka as Avatar,
  Ua as AvatarFallback,
  Wc as AvatarImage,
  ...
  tu as COMMENT_LIST_STRING_KEYS,
  Fa as Card,
  Ba as CardContent,
  Yc as CardDescription,
  Xc as CardFooter,
  Hc as CardHeader,
  qc as CardTitle,
  ...
  Zw as ContextMenuSubContent,
  Jw as ContextMenuSubTrigger,
  ...
  ru as ERROR_POPOVER_STRING_KEYS,
  bd as EditorKeyboardShortcuts,
  pd as ErrorDump,
  ou as ErrorPopover,
  du as FOOTNOTE_EDITOR_STRING_KEYS,
  lu as Filter,
  au as FilterDropdown,
  su as Footer,
  cu as FootnoteEditor,
  Id as FootnoteItem,
  wu as FootnoteList,
  bu as INVENTORY_STRING_KEYS,
  qe as Input,
  vu as Inventory,
  ht as Label,
  _d as MARKER_MENU_STRING_KEYS,
  nu as MarkdownRenderer,
  Ed as MarkerMenu,
  iu as MoreInfo,
  fd as MultiSelectComboBox,
  Au as NavigationContentSearch,
  ku as OverlayCommandPalette,
  xu as OverlayContextMenu,
  yu as OverlayModalDialog,
  Nu as OverlayPopover,
  Ut as Popover,
  Mr as PopoverAnchor,
  ...
  je as Separator,
  Su as SettingsList,
  Mu as SettingsListHeader,
  Du as SettingsListItem,
  Tw as SettingsSidebar,
  _u as SettingsSidebarContentSearch,
  ri as Sidebar,
  ai as SidebarContent,
  gw as SidebarFooter,
  hr as SidebarGroup,
  vw as SidebarGroupAction,
  ...
  hd as UNDO_REDO_BUTTONS_STRING_KEYS,
  $u as UiLanguageSelector,
  ...
  fu as getLinesFromUSFM,
  hu as getNumberFromUSFM,
  Vd as getStatusForItem,
  Pu as getToolbarOSReservedSpaceClassName,
  uu as inventoryCountColumn,
  pu as inventoryItemColumn,
