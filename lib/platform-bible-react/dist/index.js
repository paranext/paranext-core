...
var ht = (e, t, n) => ys(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as wt } from "react/jsx-runtime";
import b, { forwardRef as wn, useRef as Z, useMemo as j, useState as M, useCallback as F, useLayoutEffect as Ht, createContext as On, useContext as yr, useEffect as Y, Component as Ns, createElement as Ur, Suspense as ks, createRef as _s, Fragment as yo } from "react";
import { Command as yt } from "cmdk";
import { X as je, Search as No, Check as Ot, Clock as Kr, ChevronsLeft as qr, ChevronsRight as Hr, ChevronLeft as nr, ChevronRight as Ie, ArrowLeft as Cs, ArrowRight as Es, Circle as In, ChevronDown as _e, BoldIcon as Ts, ItalicIcon as Ss, UnderlineIcon as Rs, StrikethroughIcon as Ds, AtSign as ko, Pencil as Ms, Trash2 as Os, ArrowUp as _o, MoreHorizontal as Co, MailOpen as Is, Mail as As, ChevronUp as rr, FilterIcon as Ps, ArrowLeftIcon as Vs, ChevronLeftIcon as $s, ChevronRightIcon as Ls, ArrowRightIcon as Bs, Copy as Eo, Filter as js, User as zs, Link as Fs, CircleHelp as Gs, ChevronsUpDown as To, Star as Us, SquareX as So, FunctionSquare as Ro, SquareSigma as Do, AlertCircle as or, CircleCheckIcon as Ks, CircleXIcon as qs, CircleHelpIcon as Hs, ArrowUpIcon as Xs, ArrowDownIcon as Ys, ArrowUpDownIcon as Js, PanelLeft as Ws, PanelRight as Zs, ScrollText as Qs, MenuIcon as ti, Menu as ei, EllipsisVertical as ni, LoaderCircle as ri, GripVertical as oi } from "lucide-react";
import { clsx as ai } from "clsx";
import { extendTailwindMerge as si } from "tailwind-merge";
import * as Mt from "@radix-ui/react-dialog";
import { includes as bn, Section as H, getChaptersForBook as ii, formatScrRef as xe, getSectionForBook as Qe, formatRelativeDate as li, formatReplacementString as ve, sanitizeHtml as ci, NumberFormat as wi, formatBytes as di, getCurrentLocale as pi, getFormatCallerFunction as ui, deepEqual as mi, isString as Xr, compareScrRefs as ar, scrRefToBBBCCCVVV as Gn, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { createEditor as Oo, $getRoot as ae, $createParagraphNode as An, $getSelection as Xt, HISTORY_MERGE_TAG as Nr, ParagraphNode as Io, TextNode as Ao, $isTokenOrSegmented as fi, $getCharacterOffsets as hi, $cloneWithPropertiesEphemeral as gi, $findMatchingParent as bi, $isElementNode as ye, CLEAR_EDITOR_COMMAND as Po, COMMAND_PRIORITY_EDITOR as Vo, $isRangeSelection as an, shallowMergeConfig as vi, defineExtension as Jt, safeCast as dn, RootNode as xi, LineBreakNode as yi, TabNode as Ni, $isEditorState as ki, createCommand as _i, CLICK_COMMAND as Ci, isDOMNode as Ei, $getNodeFromDOMNode as Ti, $isNodeSelection as Si, $createNodeSelection as Ri, $setSelection as Di, COMMAND_PRIORITY_LOW as Mi, DecoratorNode as Oi, $create as Ii, $getNodeByKey as Ai, INDENT_CONTENT_COMMAND as Yr, COMMAND_PRIORITY_CRITICAL as kr, KEY_TAB_COMMAND as Pi, $createRangeSelection as Vi, $normalizeSelection__EXPERIMENTAL as $i, OUTDENT_CONTENT_COMMAND as Li, INSERT_TAB_COMMAND as Bi, $isBlockElementNode as Cn, $isDecoratorNode as ji, $isParagraphNode as zi, $isTextNode as En, SELECTION_CHANGE_COMMAND as $o, FORMAT_TEXT_COMMAND as Fi, getRegisteredNode as Gi, isHTMLElement as Ui, isDocumentFragment as Jr, isDOMDocumentNode as Ki, ArtificialNode__DO_NOT_USE as Lo, $createLineBreakNode as Bo, $isRootOrShadowRoot as qi, isBlockDomNode as Wr, isInlineDomNode as Zr, $insertNodes as Hi } from "lexical";
...
import * as Fo from "@radix-ui/react-separator";
...
import { useReactTable as Go, getFilteredRowModel as nl, getSortedRowModel as Uo, getPaginationRowModel as rl, getCoreRowModel as Ko, flexRender as tn, getGroupedRowModel as ol, getExpandedRowModel as al } from "@tanstack/react-table";
import * as st from "@radix-ui/react-select";
import sl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as sr, HIDDEN_NOTE_CALLER as ir, getDefaultViewOptions as il, isInsertEmbedOpOfType as vn, Editorial as ll } from "@eten-tech-foundation/platform-editor";
...
import * as cr from "@radix-ui/react-progress";
...
const ul = Mt.Root, ml = Mt.Portal, qo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Mt.Overlay,
  {
    ref: n,
    className: f(
...
qo.displayName = Mt.Overlay.displayName;
...
Ho.displayName = Mt.Content.displayName;
...
const Yo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Mt.Title,
  {
    ref: n,
...
Yo.displayName = Mt.Title.displayName;
...
fl.displayName = Mt.Description.displayName;
...
const Ge = b.forwardRef(({ className: e, ...t }, n) => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ o(No, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ o(
      yt.Input,
      {
        ref: n,
...
Ge.displayName = yt.Input.displayName;
...
Zt.displayName = yt.List.displayName;
const un = b.forwardRef((e, t) => /* @__PURE__ */ o(yt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
un.displayName = yt.Empty.displayName;
...
Yt.displayName = yt.Group.displayName;
...
Jo.displayName = yt.Separator.displayName;
...
jt.displayName = yt.Item.displayName;
...
var hl = Object.defineProperty, gl = (e, t, n) => t in e ? hl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, K = (e, t, n) => gl(e, typeof t != "symbol" ? t + "" : t, n);
const Ce = [
  "GEN",
  "EXO",
  "LEV",
...
function ea(e) {
  return e <= 0 || e > ta ? "******" : Zo[e - 1];
}
function _l(e) {
  return ea(Ue(e));
}
function na(e) {
  const t = typeof e == "number" ? Tr(e) : e;
  return Er(t) && !Cr.includes(t);
}
function Cl(e) {
  const t = typeof e == "number" ? Tr(e) : e;
  return Er(t) && Cr.includes(t);
...
var $t = /* @__PURE__ */ ((e) => (e[e.Unknown = 0] = "Unknown", e[e.Original = 1] = "Original", e[e.Septuagint = 2] = "Septuagint", e[e.Vulgate = 3] = "Vulgate", e[e.English = 4] = "English", e[e.RussianProtestant = 5] = "RussianProtestant", e[e.RussianOrthodox = 6] = "RussianOrthodox", e))($t || {});
const kt = class {
  ...
  constructor(t) {
    ...
    typeof t == "string" ? (this.name = t, this._type = $t[t]) : (this._type = t, this.name = $t[t]);
  }
  get type() {
    return this._type;
  }
...
K(kt, "Original", new kt($t.Original)), K(kt, "Septuagint", new kt($t.Septuagint)), K(kt, "Vulgate", new kt($t.Vulgate)), K(kt, "English", new kt($t.English)), K(kt, "RussianProtestant", new kt($t.RussianProtestant)), K(kt, "RussianOrthodox", new kt($t.RussianOrthodox));
let he = kt;
function to(e, t) {
  const n = t[0];
...
const xt = class X {
    ...
    if (K(this, "firstChapter"), K(this, "lastChapter"), K(this, "lastVerse"), K(this, "hasSegmentsDefined"), K(this, "text"), K(this, "BBBCCCVVVS"), K(this, "longHashCode"), K(this, "versification"), K(this, "rtlMark", "‏"), K(this, "_bookNum", 0), K(this, "_chapterNum", 0), K(this, "_verseNum", 0), K(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        ...
        if (t != null && t instanceof X) {
          ...
          if (t == null) return;
          const s = t instanceof he ? t : X.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let w;
    return i && (w = new he(i)), n ? new X(n, r.toString(), l, w) : new X();
  }
  /**
...
K(xt, "defaultVersification", he.English), K(xt, "verseRangeSeparator", "-"), K(xt, "verseSequenceIndicator", ","), K(xt, "verseRangeSeparators", [xt.verseRangeSeparator]), K(xt, "verseSequenceIndicators", [xt.verseSequenceIndicator]), K(xt, "chapterDigitShifter", 1e3), K(xt, "bookDigitShifter", xt.chapterDigitShifter * xt.chapterDigitShifter), K(xt, "bcvMaxValue", xt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
K(xt, "ValidStatusType", ra);
...
const aa = Q.allBookIds.filter(
  (e) => !Q.isObsolete(Q.bookIdToNumber(e))
), Ne = Object.fromEntries(
  aa.map((e) => [e, Q.bookIdToEnglishName(e)])
);
function Rr(e, t, n) {
...
const sa = wn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? ze : "button", { className: f(Rl({ variant: t, size: n, className: e })), ref: s, ...a })
);
L.displayName = "Button";
const ce = Ae.Root, we = Ae.Trigger, Ep = Ae.Anchor, Qt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = pt();
...
Qt.displayName = Ae.Content.displayName;
function dr(e, t, n) {
  return `${e} ${Ne[e]}${t ? ` ${Sr(e, t)} ${Oe(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function Dl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ d(ce, { open: w, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ o(Qt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(Wt, { children: /* @__PURE__ */ o(Zt, { children: /* @__PURE__ */ o(Yt, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      jt,
      {
        onSelect: () => p(m),
...
function Tp(e, t, n = (a, s) => a === s, r = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, r - 1)];
      ...
      if (i) {
        ...
        if (!p && w) {
          const u = ((g) => Object.keys(Ne).find(
            (y) => Ne[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function Il(e, t, n, r) {
  const a = F(() => {
    if (e.chapterNum > 1)
      ...
      if (w > 0) {
        const c = t[w - 1], p = Math.max(Lt(c), 1);
        r({
          book: c,
          chapterNum: p,
          verseNum: 1
  ...
  return j(() => [
    ...
    {
      onClick: s,
      disabled: t.length === 0 || (e.chapterNum === Lt(e.book) || Lt(e.book) === -1) && t.indexOf(e.book) === t.length - 1,
      title: "Next chapter",
      icon: n === "ltr" ? Hr : qr
    }
  ], [
...
function no({
  ...
  if (e)
    return /* @__PURE__ */ o(Yt, { children: /* @__PURE__ */ o("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Lt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      jt,
      {
        value: `${e} ${Ne[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function Sp({
  ...
  const c = pt(), [p, m] = M(!1), [h, u] = M(""), [g, y] = M(""), [v, N] = M("books"), [k, T] = M(void 0), [P, V] = M(!1), $ = Z(void 0), x = Z(void 0), E = Z(void 0), _ = Z(void 0), S = Z({}), C = F(
    (O) => {
      t(O), l && l(O);
    },
    [t, l]
  ), A = j(() => r ? r() : aa, [r]), G = j(() => ({
    [H.OT]: A.filter((U) => Q.isBookOT(U)),
    [H.NT]: A.filter((U) => Q.isBookNT(U)),
    [H.DC]: A.filter((U) => Q.isBookDC(U)),
    [H.Extra]: A.filter((U) => Q.extraBooks().includes(U))
  }), [A]), I = j(() => Object.values(G).flat(), [G]), q = j(() => {
    if (!g.trim()) return G;
    const O = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    return [H.OT, H.NT, H.DC, H.Extra].forEach((at) => {
      O[at] = G[at].filter((it) => Rr(it, g, a));
    }), O;
  }, [G, g, a]), D = j(
    () => Ol(g, I, a),
    [g, I, a]
    ...
    (O) => {
      const U = v === "chapters" ? k : D == null ? void 0 : D.book;
      U && (C({
        book: U,
        chapterNum: O,
        verseNum: 1
      }), m(!1), N("books"), T(void 0), y(""));
    },
    [C, v, k, D]
  ), Ft = F(
    (O) => {
    ...
    (O) => {
      ...
      m(O), O && (N("books"), T(void 0), y(""));
    },
    [v, Ct]
  ), { otLong: ct, ntLong: ft, dcLong: ut, extraLong: vt } = {
    ...
    (O) => {
      if (O.ctrlKey) return;
      const { isLetter: U, isDigit: at } = eo(O.key);
      if (v === "chapters") {
        if (O.key === "Backspace") {
          O.preventDefault(), O.stopPropagation(), Ct();
          return;
        }
        if (U || at) {
          if (O.preventDefault(), O.stopPropagation(), N("books"), T(void 0), at && k) {
            const it = Ne[k];
            y(`${it} ${O.key}`);
          } else
            y(O.key);
      ...
      if ((v === "chapters" || v === "books" && D) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        const it = v === "chapters" ? k : D == null ? void 0 : D.book;
        if (!it) return;
        const et = (() => {
          if (!h) return 1;
          const me = h.match(/(\d+)$/);
        ...
        switch (O.key) {
          case "ArrowLeft":
            et !== 0 && (Tt = et > 1 ? et - 1 : Gt);
            break;
          case "ArrowRight":
            et !== 0 && (Tt = et < Gt ? et + 1 : 1);
            break;
          case "ArrowUp":
            Tt = et === 0 ? Gt : Math.max(1, et - ue);
            break;
          case "ArrowDown":
            Tt = et === 0 ? 1 : Math.min(Gt, et + ue);
            break;
          default:
            return;
        }
        Tt !== et && (O.preventDefault(), O.stopPropagation(), u(dr(it, a, Tt)), setTimeout(() => {
          const me = S.current[Tt];
    ...
    const { isLetter: U, isDigit: at } = eo(O.key);
    (U || at) && (O.preventDefault(), y((it) => it + O.key), x.current.focus(), V(!1));
  }, []);
  return Ht(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && E.current && _.current) {
        const U = E.current, at = _.current, it = at.offsetTop, et = U.clientHeight, Gt = at.clientHeight, Tt = it - et / 2 + Gt / 2;
        U.scrollTo({
          top: Math.max(0, Tt),
          behavior: "smooth"
        }), u(dr(e.book));
  ...
  }, [v, k, D, e.book, e.chapterNum]), /* @__PURE__ */ d(ce, { open: p, onOpenChange: B, children: [
    /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        children: /* @__PURE__ */ o("span", { className: "tw-truncate", children: ee })
      }
    ) }),
    /* @__PURE__ */ o(Qt, { id: w, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      Wt,
      {
        ref: $,
        onKeyDown: Re,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: mt.map(({ onClick: O, disabled: U, title: at, icon: it }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ o(
              L,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ o(Cs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Es, { className: "tw-h-4 tw-w-4" })
              }
            ),
            k && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Oe(k, a) })
          ] }),
          !P && /* @__PURE__ */ d(Zt, { ref: E, children: [
            v === "books" && /* @__PURE__ */ d(wt, { children: [
              !D && Object.entries(q).map(([O, U]) => {
                if (U.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Yt, { heading: fn(O), children: U.map((at) => /* @__PURE__ */ o(
                      sa,
                      {
                        bookId: at,
                        onSelect: (it) => lt(it),
                        section: Qe(at),
                        commandValue: `${at} ${Ne[at]}`,
                        ref: at === e.book ? _ : void 0,
                        localizedBookNames: a
                      },
                      at
                    )) }, O)
              ...
              D && /* @__PURE__ */ o(Yt, { children: /* @__PURE__ */ o(
                jt,
                {
                  ...
                  children: xe(
                    ...
                    a ? Sr(D.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              D && Lt(D.book) > 1 && /* @__PURE__ */ d(wt, { children: [
...
), dt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Mo.Root, { ref: n, className: f("pr-twp", Al(), e), ...t }));
dt.displayName = Mo.Root.displayName;
const Dr = b.forwardRef(({ className: e, ...t }, n) => {
  const r = pt();
  return /* @__PURE__ */ o(
    on.Root,
    {
...
Dr.displayName = on.Root.displayName;
...
function pr({
  ...
  const [k, T] = M(!1), P = w ?? l, V = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], $ = (x, E) => {
    const _ = l(x), S = typeof x == "object" && "secondaryLabel" in x ? x.secondaryLabel : void 0, C = `${E ?? ""}${_}${S ?? ""}`;
    return /* @__PURE__ */ d(
      jt,
      {
        value: _,
  ...
  return /* @__PURE__ */ d(ce, { open: k, onOpenChange: T, ...N, children: [
    ...
    /* @__PURE__ */ o(
      Qt,
      {
        ...
        children: /* @__PURE__ */ d(Wt, { children: [
          /* @__PURE__ */ o(Ge, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ o(un, { children: h }),
          /* @__PURE__ */ o(Zt, { children: V(t) ? t.map((x) => /* @__PURE__ */ o(Yt, { heading: x.groupHeading, children: x.options.map((E) => $(E, x.groupHeading)) }, x.groupHeading)) : t.map((x) => $(x)) })
        ] })
      }
    )
  ] });
...
var $l = /* @__PURE__ */ ((e) => (e.CURRENT_BOOK = "current book", e.CHOOSE_BOOKS = "choose books", e))($l || {});
...
function Mp({
  ...
  const p = Kn(c, "%webView_bookSelector_currentBook%"), m = Kn(c, "%webView_bookSelector_choose%"), h = Kn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    g(v), e(v);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(dt, { className: "tw-ms-1", children: h })
          ] }),
...
const la = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Bl = la ? Ht : Y, xn = { tag: Nr };
function jl({ initialConfig: e, children: t }) {
  const n = j(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: w } = e, c = Ll(null, r), p = Oo({ editable: e.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, h) {
      if (h !== null) {
  ...
  }, []), o(ia.Provider, { value: n, children: t });
}
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function Fl({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  const [r] = zt();
  return zl(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: w }) => {
      t && s.size === 0 && i.size === 0 || e && w.has(Nr) || l.isEmpty() || n(a, r, w);
    });
  }, [r, e, t, n]), null;
}
const Mr = {
  ...
  mark: "",
  markOverlap: ""
}, Rt = pn.Provider, Bt = pn.Root, Kt = pn.Trigger, Dt = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  pn.Content,
  {
    ref: r,
    sideOffset: t,
...
Dt.displayName = pn.Content.displayName;
const Or = [
  Yi,
  Io,
  Ao,
...
function ql({ children: e, onError: t }) {
  return o(Ul, { fallback: o("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
...
function Yl() {
  return function(e) {
    const [t] = zt(), n = j(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = Z(r);
    return Hl(() => {
...
function Jl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !fi(t) && r !== null) {
    ...
    if (c || p) {
      const [m, h] = hi(e), u = l.is(w), g = t.is(i ? w : l), y = t.is(i ? l : w);
      let v, N = 0;
      u ? (N = m > h ? h : m, v = m > h ? m : h) : g ? (N = i ? h : m, v = void 0) : y && (N = 0, v = i ? m : h);
...
const ca = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Zl = ca && "documentMode" in document ? document.documentMode : null;
!(!ca || !("InputEvent" in window) || Zl) && "getTargetRanges" in new window.InputEvent("input");
function wa(...e) {
  const t = [];
...
function Vn() {
  ...
  for (; en !== void 0; ) {
    ...
    for (en = void 0, ur++; n !== void 0; ) {
      const r = n.o;
      if (n.o = void 0, n.f &= -3, !(8 & n.f) && pa(n)) try {
        n.c();
      } catch (a) {
        t || (e = a, t = !0);
      }
...
function ge(e, t) {
  gt.call(this, void 0), this.x = e, this.s = void 0, this.g = kn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function rc(e, t) {
  return new ge(e, t);
}
...
function Ir(e) {
  ...
  e.x = void 0, e.s = void 0, ma(e);
}
function oc(e) {
  if (J !== this) throw new Error("Out-of-order effect");
  ua(this), J = e, this.f &= -2, 8 & this.f && Ir(this), Vn();
}
function Me(e, t) {
...
gt.prototype.brand = ec, gt.prototype.h = function() {
  return !0;
...
} }), ge.prototype = new gt(), ge.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === kn)) return !0;
  if (this.g = kn, this.f |= 1, this.i > 0 && !pa(this)) return this.f &= -2, !0;
  const e = J;
  try {
    so(this), J = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ma(this), so(this), oe++;
  const e = J;
...
Jt({ build: (e, t, n) => $n(t), config: dn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
...
function fa() {
  const e = ae(), t = Xt(), n = An();
  e.clear(), e.append(n), t !== null && n.select(), an(t) && (t.format = 0);
}
function ha(e, t = fa) {
  return e.registerCommand(Po, (n) => (e.update(t), !0), Vo);
}
Jt({ build: (e, t, n) => $n(t), config: dn({ $onClear: fa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return ie(() => ha(e, r.value));
} });
function ac(e) {
...
const mr = Jt({ build: (e) => ga(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function ba(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = ba(n[a], r[a]);
    return e;
  }
  return t;
}
const Ar = 0, fr = 1, va = 2, Hn = 3, yn = 4, De = 5, Xn = 6, Je = 7;
function Yn(e) {
  return e.id === Ar;
}
function xa(e) {
...
function sc(e) {
  return function(t) {
    return t.id === fr;
  }(e) || tt(305, String(e.id), String(fr)), Object.assign(e, { id: va });
}
...
class lc {
  constructor(t, n) {
    ...
    ht(this, "state");
    ht(this, "_signal");
    this.builder = t, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Ar };
  }
  mergeConfigs() {
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Xn && tt(310, String(n.id), String(Xn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
...
const wc = Jt({ config: dn({ setOptions: io, updateOptions: io }), init: ({ $initialEditorState: e = cc }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [xi, Ao, yi, Ni, Io] }), lo = Symbol.for("@lexical/extension/LexicalBuilder");
function co() {
}
function dc(e) {
  throw e;
...
class nn {
  ...
  static maybeFromEditor(t) {
    const n = t[lo];
    return n && (n.PACKAGE_VERSION !== Jn && tt(292, n.PACKAGE_VERSION, Jn), n instanceof nn || tt(293)), n;
  }
  static fromEditor(t) {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(Oo({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [lo]: this });
  ...
  addExtension(t) {
    ...
    if (a !== void 0 && a.extension !== r && tt(298, r.name), !a) {
      a = new lc(this, r), this.extensionNameMap.set(r.name, a);
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Yn(s) || tt(300, i, a || "[unknown]"), Yn(l = s) || tt(304, String(l.id), String(Ar)), s = Object.assign(l, { id: fr }), r.state = s;
      const w = this.outgoingConfigEdges.get(i);
      if (w) for (const c of w.keys()) {
        const p = this.extensionNameMap.get(c);
        p && n(p, i);
      }
      s = sc(s), r.state = s, t.push(r);
    };
    for (const r of this.extensionNameMap.values()) Yn(r.state) && n(r);
    ...
    for (const p of l) {
      ...
      if (m.onError !== void 0 && (t.onError = m.onError), m.disableEvents !== void 0 && (t.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (t.parentEditor = m.parentEditor), m.editable !== void 0 && (t.editable = m.editable), m.namespace !== void 0 && (t.namespace = m.namespace), m.$initialEditorState !== void 0 && (t.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of ac(m)) {
        if (typeof h != "function") {
          ...
          u && tt(302, m.name, h.replace.name, u.extension.name), r.set(h.replace, p);
        }
        n.add(h);
      }
      if (m.html) {
...
const pc = /* @__PURE__ */ new Set(), wo = Jt({ build(e, t, n) {
  const r = n.getDependency(mr).output, a = sn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ga(() => {
  }, () => ie(() => {
...
Jt({ dependencies: [mr, wo], name: "@lexical/extension/HorizontalRule", nodes: [Pe], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(wo).output, a = sn({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return se(e.registerCommand(Ci, (i) => {
    if (Ei(i.target)) {
      const l = Ti(i.target);
      if (mc(l)) return function(w, c = !1) {
        const p = Xt(), m = w.isSelected(), h = w.getKey();
        let u;
    ...
    nc(() => {
      ...
      for (const [p, m] of i.entries()) if (m === "destroyed") c.delete(p), w = !0;
        ...
        h ? h.domNode.value = u : (w = !0, c.set(p, { domNode: sn(u), selectedSignal: r(p) }));
      }
    ...
    for (const { domNode: l, selectedSignal: w } of a.value.nodeSelections.values()) i.push(ie(() => {
      const c = l.value;
      c && (w.value ? da(c, s) : Ql(c, s));
    }));
    return se(...i);
  }));
} });
function fc(e, t) {
  return se(e.registerCommand(Pi, (n) => {
    const r = Xt();
    if (!an(r)) return !1;
    n.preventDefault();
    const a = function(s) {
      ...
      return !1;
    }(r) ? n.shiftKey ? Li : Yr : Bi;
    return e.dispatchCommand(a, void 0);
  }, Vo), e.registerCommand(Yr, () => {
    const n = typeof t == "number" ? t : t ? t.peek() : null;
    if (n == null) return !1;
    const r = Xt();
    if (!an(r)) return !1;
    const a = r.getNodes().map((s) => ro(s).getIndent());
    return Math.max(...a) + 1 >= n;
  }, kr));
}
Jt({ build: (e, t, n) => $n(t), config: dn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: r, maxIndent: a } = n.getOutput();
  return ie(() => {
    if (!r.value) return fc(e, a);
  });
} });
const hc = Jt({ name: "@lexical/react/ReactProvider" });
function gc() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (w) {
            ...
            e.update(() => {
              ...
              if (an(g)) {
                const y = g.anchor;
                let v = y.getNode(), N = 0, k = 0;
                if (En(v) && c >= 0 && p >= 0 && (N = c, k = c + p, g.setTextNodeRange(v, N, v, k)), N === k && m === "" || (g.insertRawText(m), v = y.getNode()), En(v)) {
                  N = h, k = h + u;
...
Jt({ build: (e, t, n) => $n(t), config: dn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => ie(() => n.getOutput().disabled.value ? void 0 : ka(e)) });
function xc(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Pr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function yc({ editor: e, ErrorBoundary: t }) {
  return function(n, r) {
    ...
    return Pr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], p = o(r, { onError: (h) => n._onError(h), children: o(ks, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
...
function Nc({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    ...
    if (r && r.hasExtensionByName(hc.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) r.hasExtensionByName(a) && xc(320, a);
      return !0;
    }
    return !1;
  }(e) ? null : o(yc, { editor: e, ErrorBoundary: t });
}
function po(e) {
  return e.getEditorState().read(Na(e.isComposing()));
}
function kc({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [r] = zt();
  return function(a) {
    Pr(() => se(Wi(a), ka(a)), [a]);
  }(r), d(wt, { children: [e, o(_c, { content: t }), o(Nc, { editor: r, ErrorBoundary: n })] });
}
function _c({ content: e }) {
  const [t] = zt(), n = function(a) {
    const [s, i] = M(() => po(a));
    return Pr(() => {
      function l() {
        const w = po(a);
...
function Cc({ defaultSelection: e }) {
  const [t] = zt();
  return Y(() => {
    t.focus(() => {
...
const Ec = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function Tc({ onClear: e }) {
  const [t] = zt();
  return Ec(() => ha(t, e), [t, e]), null;
}
const _a = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function Sc({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: v = "textbox", spellCheck: N = !0, style: k, tabIndex: T, "data-testid": P, ...V }, $) {
  const [x, E] = M(e.isEditable()), _ = F((C) => {
    C && C.ownerDocument && C.ownerDocument.defaultView ? e.setRootElement(C) : e.setRootElement(null);
  }, [e]), S = j(() => /* @__PURE__ */ function(...C) {
    return (A) => {
      for (const G of C) typeof G == "function" ? G(A) : G != null && (G.current = A);
    };
  }($, _), [_, $]);
  return _a(() => (E(e.isEditable()), e.registerEditableListener((C) => {
    E(C);
  })), [e]), o("div", { "aria-activedescendant": x ? t : void 0, "aria-autocomplete": x ? n : "none", "aria-controls": x ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": x && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": p, "aria-owns": x ? m : void 0, "aria-readonly": !x || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: x, "data-testid": P, id: y, ref: S, role: v, spellCheck: N, style: k, tabIndex: T, ...V });
}
const Rc = wn(Sc);
function uo(e) {
  return e.getEditorState().read(Na(e.isComposing()));
...
const Dc = wn(Mc);
function Mc(e, t) {
  const { placeholder: n, ...r } = e, [a] = zt();
  return d(wt, { children: [o(Rc, { editor: a, ...r, ref: t }), n != null && o(Oc, { editor: a, content: n })] });
}
...
function Pc() {
  const [e, t] = M(void 0), n = F(() => {
    t(void 0);
  }, []), r = j(() => {
    if (e === void 0)
      return;
    const { title: s, content: i } = e;
    return /* @__PURE__ */ o(ul, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ho, { children: [
      /* @__PURE__ */ o(Xo, { children: /* @__PURE__ */ o(Yo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = F(
    (s, i, l = !1) => {
...
function Vc({
  ...
  const [t] = zt(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Pc(), w = () => {
  };
...
), Lc = b.forwardRef(({ className: e, variant: t, size: n, ...r }, a) => /* @__PURE__ */ o(
  jo.Root,
  {
    ref: a,
    className: f(Ta({ variant: t, size: n, className: e })),
    ...r
  }
));
Lc.displayName = jo.Root.displayName;
...
Vr.displayName = Pn.Root.displayName;
...
const mo = [
  ...
  { format: "underline", icon: Rs, label: "Underline" },
  { format: "strikethrough", icon: Ds, label: "Strikethrough" }
];
function Bc() {
  const { activeEditor: e } = Ea(), [t, n] = M([]), r = F((a) => {
    if (an(a) || tl(a)) {
      const s = [];
      mo.forEach(({ format: i }) => {
  ...
  return $c(r), /* @__PURE__ */ o(
    Vr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: mo.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ o(
        rn,
        {
          value: a,
          "aria-label": i,
...
function jc({ onClear: e }) {
  const [t] = zt();
  Y(() => {
    e && e(() => {
      t.dispatchCommand(Po, void 0);
    });
  }, [t, e]);
}
function zc({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ o(Vc, { children: () => /* @__PURE__ */ o("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ o(Bc, {}) }) }),
      ...
      /* @__PURE__ */ o(
        kc,
        {
          contentEditable: /* @__PURE__ */ o("div", { ref: (s) => {
            s !== void 0 && r(s);
          }, children: /* @__PURE__ */ o(Ic, { placeholder: e }) }),
          ErrorBoundary: ql
        }
      ),
      t && /* @__PURE__ */ o(Cc, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ o(jc, { onClear: n }),
      /* @__PURE__ */ o(Tc, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ o(
          jl,
          {
            ...
            children: /* @__PURE__ */ d(Rt, { children: [
              /* @__PURE__ */ o(zc, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ o(
                Fl,
                {
                  ignoreSelectionChange: !0,
                  onChange: (w) => {
                    n == null || n(w), r == null || r(w.toJSON());
                  }
                }
              )
            ] })
...
function Gc(e, t) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Lo && i.insertAfter(Bo());
    for (const i of s) {
...
function Ra(e, t, n, r = null) {
  ...
  let i = t;
  r !== null && En(t) && (i = Jl(r, t, "clone"));
  const l = ye(i) ? i.getChildren() : [], w = Gi(e, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = Ra(e, g, h, r);
    !a && ye(t) && y && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ui(p) || Jr(p)) && p.append(h), n.append(p), m) {
      const u = m.call(i, p);
...
function Ma(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (Da.has(e.nodeName)) return i;
  let l = null;
  const w = function(g, y) {
    const { nodeName: v } = g, N = y._htmlConversions.get(v.toLowerCase());
    let k = null;
  ...
  let h = [];
  const u = (l == null || !qi(l)) && (l != null && Cn(l) || r);
  for (let g = 0; g < m.length; g++) h.push(...Ma(m[g], t, n, u, new Map(a), l));
  return p != null && (h = p(h)), Wr(e) && (h = Kc(e, h, u ? () => {
    const g = new Lo();
    return n.push(g), g;
  ...
  }(e) && (i = i.concat(Bo())) : ye(l) && l.append(...h), i;
}
function Kc(e, t, n) {
...
function Ia(e) {
  return e ? e.some(
    (t) => t && "text" in t && t.text.trim().length > 0 ? !0 : !t || !("children" in t) ? !1 : Ia(t.children)
  ) : !1;
}
function St(e) {
  var t;
  return (t = e == null ? void 0 : e.root) != null && t.children ? Ia(e.root.children) : !1;
}
function qc(e) {
  if (!e || e.trim() === "")
  ...
  if (t.update(
    () => {
      const a = new DOMParser().parseFromString(e, "text/html"), s = Gc(t, a);
      ae().clear(), Hi(s);
    },
    {
      discrete: !0
...
function Rn(e) {
  ...
  return t.getEditorState().read(() => {
    r = Uc(t);
  }), r = r.replace(/\s+style="[^"]*"/g, "").replace(/\s+class="[^"]*"/g, "").replace(/<span>(.*?)<\/span>/g, "$1").replace(/<b><strong[^>]*>(.*?)<\/strong><\/b>/g, "<b>$1</b>").replace(/<strong><b[^>]*>(.*?)<\/b><\/strong>/g, "<b>$1</b>").replace(/<i><em[^>]*>(.*?)<\/em><\/i>/g, "<i>$1</i>").replace(/<em><i[^>]*>(.*?)<\/i><\/em>/g, "<i>$1</i>").replace(/<u><span[^>]*>(.*?)<\/span><\/u>/g, "<u>$1</u>").replace(/<s><span[^>]*>(.*?)<\/span><\/s>/g, "<s>$1</s>").replace(/<br\s*\/?>/gi, "<br/>"), r;
}
function $r(e) {
...
function Op({
  ...
  const [a, s] = M(Hc), [i, l] = M(void 0), [w, c] = M(!1), p = Z(void 0), m = Z(null);
  Y(() => {
    let N = !0;
    const k = m.current;
    if (!k) return;
  ...
  const h = F(() => {
    ...
    const N = Rn(a);
    t(N, i);
  }, [a, t, i]), u = r["%commentEditor_placeholder%"] ?? "Type your comment here...", g = r["%commentEditor_saveButton_tooltip%"] ?? "Save comment", y = r["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", v = r["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ d(Bt, { children: [
          /* @__PURE__ */ o(Kt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(je, {}) }) }),
          /* @__PURE__ */ o(Dt, { children: /* @__PURE__ */ o("p", { children: y }) })
        ] }) }),
        /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ d(Bt, { children: [
          /* @__PURE__ */ o(Kt, { asChild: !0, children: /* @__PURE__ */ o(
            L,
            {
              onClick: h,
          ...
          /* @__PURE__ */ o(Dt, { children: /* @__PURE__ */ o("p", { children: g }) })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ d(ce, { open: w, onOpenChange: c, children: [
      /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ d(
        L,
        {
          ...
          disabled: e.length === 0,
          children: [
            /* @__PURE__ */ o(ko, { className: "tw-h-4 tw-w-4" }),
      ...
      /* @__PURE__ */ o(
        Qt,
        {
          ...
          children: /* @__PURE__ */ o(Wt, { children: /* @__PURE__ */ o(Zt, { children: e.map((N) => /* @__PURE__ */ o(
            jt,
            {
              onSelect: () => {
                l(N === "" ? void 0 : N), c(!1);
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ o("span", { children: Wn(N, r) })
            },
            N || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), St(a) && h());
        },
        onKeyDown: (N) => {
...
const Ip = Object.freeze([
  ...
  "%no_comments%"
], Xc = ["input", "select", "textarea", "button"], Yc = ["button", "textbox"], Jc = ({
  options: e,
  onFocusChange: t,
  onOptionSelect: n,
  onCharacterPress: r
}) => {
  const a = Z(null), [s, i] = M(void 0), [l, w] = M(void 0), c = F(
    (u) => {
      i(u);
    ...
    if (y && Yc.includes(y)) return !0;
    const v = u.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = F(
    (u) => {
      var x;
      const g = u.target, y = (E) => E ? document.getElementById(E) : void 0, v = y(l), N = y(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const _ = E.findIndex((C) => C === g);
          if (_ === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(_ + 1, E.length - 1) : S = Math.max(_ - 1, 0), S !== _ && (u.preventDefault(), u.stopPropagation(), (x = E[S]) == null || x.focus());
          return;
        }
        return;
      }
      const P = e.findIndex((E) => E.id === s);
      let V = P;
      switch (u.key) {
        case "ArrowDown":
          V = Math.min(P + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          V = Math.max(P - 1, 0), u.preventDefault();
          break;
        case "Home":
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: f("pr-twp", Wc({ variant: t }), e), ...n })
);
...
const tw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
tw.displayName = "CardDescription";
const Pa = b.forwardRef(
  ({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: f("pr-twp tw-p-6 tw-pt-0", e), ...t })
);
...
$e.displayName = Fo.Root.displayName;
...
Va.displayName = Fe.Root.displayName;
...
$a.displayName = Fe.Fallback.displayName;
const Lr = On(void 0);
function At() {
  const e = yr(Lr);
  if (!e)
...
}), Ke = nt.Trigger, La = nt.Group, rw = nt.Portal, ow = nt.Sub, aw = nt.RadioGroup;
function Se({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Lr.Provider, { value: n, children: /* @__PURE__ */ o(nt.Root, { ...t }) });
}
...
Ba.displayName = nt.SubTrigger.displayName;
...
ja.displayName = nt.SubContent.displayName;
...
de.displayName = nt.Content.displayName;
...
const qt = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = At();
  return /* @__PURE__ */ d(
    nt.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(Ot, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
  ...
  return /* @__PURE__ */ d(
    nt.RadioItem,
    {
      ...
      className: f(
        "tw-relative tw-flex tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-py-1.5 tw-pe-2 tw-ps-8 tw-text-sm tw-outline-none tw-transition-colors focus:tw-bg-accent focus:tw-text-accent-foreground data-[disabled]:tw-pointer-events-none data-[disabled]:tw-opacity-50",
        e,
        te({ variant: a.variant })
        // CUSTOM use context to add variants
      ),
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(In, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
});
za.displayName = nt.RadioItem.displayName;
...
mn.displayName = nt.Label.displayName;
...
function fo({
  ...
  const v = F(() => {
    ...
    const x = new Date(e.date), E = li(
      x,
      n["%comment_date_today%"],
      n["%comment_date_yesterday%"]
    ), _ = x.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [e.date, n]), T = j(() => e.user, [e.user]), P = j(
    () => e.user.split(" ").map((x) => x[0]).join("").toUpperCase().slice(0, 2),
    [e.user]
  ), V = j(() => ci(e.contents), [e.contents]), $ = j(() => {
    if (r && c)
      return /* @__PURE__ */ d(wt, { children: [
        /* @__PURE__ */ d(
          Dn,
          {
            onClick: () => {
              h(!0), g(qc(e.contents)), w == null || w(!0);
            },
            children: [
              /* @__PURE__ */ o(Ms, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Va, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o($a, { className: "tw-text-xs tw-font-medium", children: P }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: y,
              onKeyDownCapture: (x) => {
                x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), v()) : x.key === "Enter" && x.shiftKey && (x.preventDefault(), x.stopPropagation(), St(u) && N());
              },
              onKeyDown: (x) => {
                $r(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  Sn,
        ...
        $ && /* @__PURE__ */ d(Se, { children: [
          /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(Co, {}) }) }),
          /* @__PURE__ */ o(de, { align: "end", children: $ })
        ] })
      ]
    }
  );
...
function iw({
  ...
  const [V, $] = M(ho), [x, E] = M(!1), [_, S] = M(!1), [C, A] = M(!1), [G, I] = M(!1), [q, D] = M(!1), [z, lt] = M(void 0), [bt, Ft] = M(!1), [mt, Ct] = M(!1), [B, ct] = M(T), [ft, ut] = M(!1), vt = Z(void 0), [fn, Xe] = M(/* @__PURE__ */ new Map());
  Y(() => {
    let R = !0;
    if (!r) {
      Ft(!1), Ct(!1), Xe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const ne = v ? await v(w) : !1;
      if (!R) return;
  ...
  const ee = j(() => t.filter((R) => !R.deleted), [t]);
  Y(() => {
    let R = !0;
    if (!r || !k) {
      Xe(/* @__PURE__ */ new Map());
  ...
  const Et = j(() => ee[0], [ee]), hn = Z(null), Re = Z(void 0), pe = F(() => {
    var R;
    (R = Re.current) == null || R.call(Re), $(ho);
  }, []), O = F(() => {
    const R = !B;
    ct(R), ut(!R), u == null || u(w, R);
  }, [B, u, w]);
  Y(() => {
    const R = hn.current;
    if (!R)
    ...
    return Pt(), window.addEventListener("resize", Pt), () => window.removeEventListener("resize", Pt);
  ...
  const U = j(
  ...
  }, [s, n]), it = j(() => ee.slice(1), [ee]), et = j(() => it.length ?? 0, [it.length]), Gt = j(() => et > 0, [et]), Tt = j(() => C || et <= 2 ? it : it.slice(-2), [it, et, C]), ue = j(() => C || et <= 2 ? 0 : et - 2, [et, C]), me = j(
    () => et === 1 ? U.singleReply : ve(U.multipleReplies, { count: et }),
    [et, U]
  ), gs = j(
    () => ue === 1 ? U.singleReply : ve(U.multipleReplies, { count: ue }),
    [ue, U]
  ), Gr = F(async () => {
    const R = St(V) ? Rn(V) : void 0;
    if (z !== void 0) {
      await p({
        threadId: w,
        contents: R,
    ...
    async (R) => {
      const Pt = St(V) ? Rn(V) : void 0, ne = await p({
        ...R,
        contents: Pt,
        assignedUser: z ?? R.assignedUser
      });
      return ne && Pt && pe(), ne && z !== void 0 && lt(void 0), ne;
    },
    [pe, V, p, z]
  );
  return /* @__PURE__ */ o(
    Aa,
    {
      ...
      className: f(
        ...
        {
          "tw-bg-primary-foreground": !r && c !== "Resolved" && B,
          "tw-bg-background": r && c !== "Resolved" && B,
          "tw-bg-muted": c === "Resolved",
          "tw-bg-blue-50": !B && !r && c !== "Resolved"
        }
      ),
      onClick: () => {
        l(w);
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ o(
              L,
              {
                ...
                "aria-label": B ? "Mark as unread" : "Mark as read",
                children: B ? /* @__PURE__ */ o(Is, {}) : /* @__PURE__ */ o(As, {})
              }
            ),
            at && /* @__PURE__ */ o(Ve, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: at })
          ] }),
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            _ && /* @__PURE__ */ o(
              L,
              {
                ...
                size: "icon",
                onClick: (R) => {
                  R.stopPropagation(), E(!x);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": x ? "Collapse text" : "Expand text",
                children: x ? /* @__PURE__ */ o(rr, {}) : /* @__PURE__ */ o(_e, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
            fo,
            {
              ...
              isThreadExpanded: r,
              threadStatus: c,
              handleAddCommentToThread: bs,
              handleUpdateComment: m,
              handleDeleteComment: h,
              onEditingChange: I,
              canEditOrDelete: fn.get(Et.id) ?? !1,
              canUserResolveThread: mt
            }
          )
        ] }),
        /* @__PURE__ */ d(wt, { children: [
          Gt && !r && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          r && /* @__PURE__ */ d(wt, { children: [
            ue > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o($e, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ o("p", { className: "tw-text-sm tw-text-muted-foreground", children: gs }),
                    C ? /* @__PURE__ */ o(rr, {}) : /* @__PURE__ */ o(_e, {})
                  ] })
                ]
              }
            ),
            Tt.map((R) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              fo,
              {
                comment: R,
                localizedStrings: n,
            ...
            y !== !1 && (!G || St(V)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (R) => {
                  R.key === "Enter" && R.shiftKey && (R.preventDefault(), R.stopPropagation(), (St(V) || z !== void 0) && Gr());
                },
                onKeyDown: (R) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    z !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ve(
                    ...
                    /* @__PURE__ */ d(ce, { open: q, onOpenChange: D, children: [
                      /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !bt || !g || g.length === 0 || !g.includes(i),
                      ...
                      /* @__PURE__ */ o(
                        Qt,
                        {
                          ...
                          children: /* @__PURE__ */ o(Wt, { children: /* @__PURE__ */ o(Zt, { children: g == null ? void 0 : g.map((R) => /* @__PURE__ */ o(
                            jt,
                            {
                              onSelect: () => {
                                lt(R !== s ? R : void 0), D(!1);
...
function Pp({
  ...
  const T = n.filter(
    (C) => C.comments.some((A) => !A.deleted)
  ), P = T.map((C) => ({
    id: C.id
  })), V = F(
    (C) => {
      N(C.id), y == null || y(C.id);
    },
    [y]
  ), $ = F(
    (C) => {
    ...
    [y]
  ), { listboxRef: x, activeId: E, handleKeyDown: _ } = Jc({
    options: P,
    onOptionSelect: V
  }), S = F(
    (C) => {
      C.key === "Escape" ? (N(void 0), y == null || y(void 0), C.preventDefault(), C.stopPropagation()) : _(C);
    },
    [_, y]
  );
  return /* @__PURE__ */ o(
...
function lw({ table: e }) {
  return /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ o(el, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(Ps, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Le = st.Root, cw = st.Group, Be = st.Value, ww = le(
  ...
  return /* @__PURE__ */ d(
    st.Trigger,
    {
      ...
      children: [
        t,
        /* @__PURE__ */ o(st.Icon, { asChild: !0, children: /* @__PURE__ */ o(_e, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Ee.displayName = st.Trigger.displayName;
const Fa = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  st.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ o(rr, { className: "tw-h-4 tw-w-4" })
  }
));
Fa.displayName = st.ScrollUpButton.displayName;
...
Ga.displayName = st.ScrollDownButton.displayName;
...
Te.displayName = st.Content.displayName;
const dw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  st.Label,
  {
    ref: n,
...
dw.displayName = st.Label.displayName;
...
pw.displayName = st.Separator.displayName;
function uw({ table: e }) {
...
function ln(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && mw(r)
  );
}
const Ln = b.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ o("div", { className: f("pr-twp tw-relative tw-w-full", { "tw-p-1": t }), children: /* @__PURE__ */ o(
    "table",
    {
      tabIndex: 0,
      onKeyDown: s,
...
const jn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", e), ...t }));
...
const Ut = b.forwardRef(({ className: e, onKeyDown: t, onSelect: n, setFocusAlsoRunsSelect: r = !1, ...a }, s) => {
...
const vw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "caption",
  {
    ref: n,
...
function xw({
  ...
  var $;
  const [p, m] = M([]), [h, u] = M([]), [g, y] = M({}), [v, N] = M({}), k = j(() => t ?? [], [t]), T = Go({
    data: k,
    columns: e,
    getCoreRowModel: Ko(),
  ...
  }), P = T.getVisibleFlatColumns();
  let V;
  return w ? V = Array.from({ length: 10 }).map((_, S) => `skeleton-row-${S}`).map((_) => /* @__PURE__ */ o(Ut, { children: /* @__PURE__ */ o(ke, { colSpan: P.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(hr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : (($ = T.getRowModel().rows) == null ? void 0 : $.length) > 0 ? V = T.getRowModel().rows.map((x) => /* @__PURE__ */ o(
    Ut,
    {
      onClick: () => i(x, T),
      "data-state": x.getIsSelected() && "selected",
      children: x.getVisibleCells().map((E) => /* @__PURE__ */ o(ke, { children: tn(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    x.id
  )) : V = /* @__PURE__ */ o(Ut, { children: /* @__PURE__ */ o(ke, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(lw, { table: T }),
    /* @__PURE__ */ d(Ln, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Bn, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ o(Ut, { children: x.headers.map((E) => /* @__PURE__ */ o(cn, { children: E.isPlaceholder ? void 0 : tn(E.column.columnDef.header, E.getContext()) }, E.id)) }, x.id)) }),
      /* @__PURE__ */ o(jn, { children: V })
    ] }),
...
function Vp({
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: /* @__PURE__ */ o(sl, { options: s, children: t })
    }
  );
}
...
var kw = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(kw || {});
function Bp({ id: e, label: t, groups: n }) {
  const [r, a] = M(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "default", children: [
      /* @__PURE__ */ o(js, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
    ...
    /* @__PURE__ */ o(de, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(La, { children: c.itemType === 0 ? /* @__PURE__ */ o(wt, { children: c.items.map((m, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        qt,
        {
          checked: r[p][h],
...
function zp({
  ...
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ o(_w, { versionHistory: a }),
...
function Cw({
  ...
  const [N, k] = M(!1), T = F(
    (S) => {
      var A;
      const C = (A = e.find((G) => G.label === S)) == null ? void 0 : A.value;
      C && n(
        t.includes(C) ? t.filter((G) => G !== C) : [...t, C]
      );
    },
    [e, t, n]
  ), P = () => w || r, V = j(() => {
    if (!h) return e;
    const S = e.filter((A) => A.starred).sort((A, G) => A.label.localeCompare(G.label)), C = e.filter((A) => !A.starred).sort((A, G) => {
      const I = t.includes(A.value), q = t.includes(G.value);
      return I && !q ? -1 : !I && q ? 1 : A.label.localeCompare(G.label);
    });
    return [...S, ...C];
  }, [e, t, h]), $ = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(ce, { open: E, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: y,
    ...
    /* @__PURE__ */ o(Qt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Wt, { children: [
        ...
        /* @__PURE__ */ o(Yt, { children: V.map((S) => /* @__PURE__ */ d(
          jt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Us, { className: "tw-h-4 tw-w-4" }),
...
function Tw({
  ...
  const g = (v) => {
    ...
    var N, k, T, P;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = s.current) == null || N.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((k = i.current) == null || k.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((T = s.current) == null ? void 0 : T.selectionStart) === 0 && ((P = i.current) == null || P.focus(), l.current = !1), w === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(Se, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ d(Bt, { children: [
      /* @__PURE__ */ o(Kt, { asChild: !0, children: /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: Ew(e, a, n) }) }) }),
      /* @__PURE__ */ o(Dt, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ d(
      de,
      {
...
function Dw({
  ...
  return /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ d(Bt, { children: [
      /* @__PURE__ */ o(Xi, { asChild: !0, children: /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: Sw(e, n) }) }) }),
      /* @__PURE__ */ o(Dt, { children: /* @__PURE__ */ o("p", { children: Rw(e, n) }) })
    ] }) }),
...
function Gp({
  ...
  const w = Z(null), c = _s(), [p, m] = M("generated"), [h, u] = M("*"), [g, y] = M("f"), [v, N] = M(!1), k = j(
    () => ({
      ...i,
  ...
  Y(() => {
    ...
    if (E && vn("note", E)) {
      const C = (_ = E.insert.note) == null ? void 0 : _.caller;
      let A = "custom";
      C === sr ? A = "generated" : C === ir ? A = "hidden" : C && u(C), m(A), y(((S = E.insert.note) == null ? void 0 : S.style) ?? "f"), x = setTimeout(() => {
        var G;
        (G = w.current) == null || G.applyUpdate([E]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const T = F(() => {
    var E, _;
    const x = (_ = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    x && vn("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = h : x.insert.note.caller = p === "generated" ? sr : ir), n([x]));
  }, [p, h, n]), P = () => {
    var E;
    ...
    if (E && vn("note", E)) {
      E.insert.note && (E.insert.note.style = x);
      const I = (A = (C = E.insert.note) == null ? void 0 : C.contents) == null ? void 0 : A.ops;
      g !== "x" && x === "x" ? I == null || I.forEach((q) => Mw(q)) : g === "x" && x !== "x" && (I == null || I.forEach((q) => Ow(q))), (G = w.current) == null || G.applyUpdate([E, { delete: 1 }]);
    }
  }, $ = (x) => {
    var _, S, C, A, G;
    const E = (S = (_ = w.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : S.at(0);
    if (E && vn("note", E)) {
      x.content.length > 1 && setTimeout(() => {
        var D;
        (D = w.current) == null || D.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
      const I = (C = E.insert.note) == null ? void 0 : C.style, q = (G = (A = E.insert.note) == null ? void 0 : A.contents) == null ? void 0 : G.ops;
      I || N(!1), N(
        I === "x" ? !!(q != null && q.every((D) => {
          var lt, bt;
          if (!((lt = D.attributes) != null && lt.char)) return !0;
          const z = ((bt = D.attributes) == null ? void 0 : bt.char).style;
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ d(Bt, { children: [
          /* @__PURE__ */ o(Kt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: r, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(je, {}) }) }),
          /* @__PURE__ */ o(Dt, { children: /* @__PURE__ */ o("p", { children: l["%footnoteEditor_cancelButton_tooltip%"] }) })
        ] }) }),
        /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ d(Bt, { children: [
          /* @__PURE__ */ o(Kt, { asChild: !0, children: /* @__PURE__ */ o(
            L,
          ...
          /* @__PURE__ */ o(Dt, { children: l["%footnoteEditor_saveButton_tooltip%"] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ d(Bt, { children: [
            /* @__PURE__ */ o(Kt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: P, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(Eo, {}) }) }),
            /* @__PURE__ */ o(Dt, { children: /* @__PURE__ */ o("p", { children: l["%footnoteEditor_copyButton_tooltip%"] }) })
          ] }) }) })
        ]
      }
    )
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ d(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ o(or, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
...
function Vw({
  ...
  /* @__PURE__ */ d("span", { className: f("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    Br(e.marker, [i], r, !1),
    " "
  ] }), h = t === "horizontal" ? "horizontal" : "vertical", u = r ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", y = f(h, u);
  return /* @__PURE__ */ d(wt, { children: [
    /* @__PURE__ */ d("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: [
      w,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: m }),
    /* @__PURE__ */ o(
      "div",
      {
        className: f(
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(wt, { children: Aw(e.marker, l, r, c) })
      }
    )
  ] });
}
function Kp({
  ...
  const p = w ?? ui(n, void 0), m = (k, T) => {
    c == null || c(k, T, a);
  }, h = s ? n.findIndex((k) => k === s) : -1, [u, g] = M(h), y = (k, T, P) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), c == null || c(T, P, a);
          break;
      }
  }, v = (k) => {
    if (n.length)
...
function Lw({
  ...
  return /* @__PURE__ */ d(Ln, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Bn, { stickyHeader: !0, children: /* @__PURE__ */ d(Ut, { children: [
    ...
    /* @__PURE__ */ o(jn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ke, { className: r, children: $w(l.text) })
        ]
      },
...
const jr = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  lr.Root,
  {
    ref: n,
    className: f(
...
jr.displayName = lr.Root.displayName;
const zn = (e) => e === "asc" ? /* @__PURE__ */ o(Xs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Ys, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }), qp = (e) => ({
  accessorKey: "item",
  ...
  return t ? t[1] : "";
}, jw = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Zp = Object.freeze([
  ...
  const a = Xr(r.key) ? r.key : r.key[0];
  return {
    items: Xr(r.key) ? [r.key] : r.key,
    count: r.count,
    status: r.status || jw(a, t, n),
...
function Qp({
  ...
  const u = Vt(n, "%webView_inventory_all%"), g = Vt(n, "%webView_inventory_approved%"), y = Vt(n, "%webView_inventory_unapproved%"), v = Vt(n, "%webView_inventory_unknown%"), N = Vt(n, "%webView_inventory_scope_currentBook%"), k = Vt(n, "%webView_inventory_scope_chapter%"), T = Vt(n, "%webView_inventory_scope_verse%"), P = Vt(n, "%webView_inventory_filter_text%"), V = Vt(
    n,
    "%webView_inventory_show_additional_items%"
  ), $ = Vt(n, "%webView_inventory_no_results%"), [x, E] = M(!1), [_, S] = M("all"), [C, A] = M(""), [G, I] = M([]), q = j(() => {
    const B = e ?? [];
    return B.length === 0 ? [] : Fw(B, a, s);
  }, [e, a, s]), D = j(() => {
    if (x) return q;
    const B = [];
    return q.forEach((ct) => {
      const ft = ct.items[0], ut = B.find(
        (vt) => vt.items[0] === ft
      );
      ut ? (ut.count += ct.count, ut.occurrences = ut.occurrences.concat(ct.occurrences)) : B.push({
        items: [ft],
        count: ct.count,
  ...
  }, [x, q]), z = j(() => D.length === 0 ? [] : zw(D, _, C), [D, _, C]), lt = j(() => {
    var ft, ut;
    if (!x) return w;
    const B = (ft = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ft.length;
    if (!B) return w;
    const ct = [];
    for (let vt = 0; vt < B; vt++)
      ct.push(
        Bw(
          ((ut = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ut[vt]) || "Additional Item",
          vt + 1
        )
      );
    return [...ct, ...w];
  }, [r == null ? void 0 : r.tableHeaders, w, x]);
  Y(() => {
  ...
  const bt = (B, ct) => {
    ...
    const B = D.filter((ct) => mi(
      x ? ct.items : [ct.items[0]],
      G
    ));
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(Te, { children: [
              /* @__PURE__ */ o(_t, { value: "all", children: u }),
              /* @__PURE__ */ o(_t, { value: "approved", children: g }),
              /* @__PURE__ */ o(_t, { value: "unapproved", children: y }),
              /* @__PURE__ */ o(_t, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Le, { onValueChange: (B) => Ft(B), defaultValue: i, children: [
        /* @__PURE__ */ o(Ee, { className: "tw-m-1", children: /* @__PURE__ */ o(Be, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Te, { children: [
          /* @__PURE__ */ o(_t, { value: "book", children: N }),
          /* @__PURE__ */ o(_t, { value: "chapter", children: k }),
          /* @__PURE__ */ o(_t, { value: "verse", children: T })
        ] })
      ] }),
      /* @__PURE__ */ o(
        He,
...
function eu({ localizedStrings: e, markerMenuItems: t }) {
  const [n, r] = M(""), a = j(() => {
  ...
  return /* @__PURE__ */ d(Wt, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ o(
      Ge,
      {
        value: n,
      ...
      /* @__PURE__ */ o(Yt, { children: a.map((s) => /* @__PURE__ */ d(
        jt,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ o(Wo, { className: "tw-font-sans", children: s.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const Gw = "16rem", Uw = "3rem", Ka = b.createContext(void 0);
function Fn() {
...
const qa = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(e), m = t ?? c, h = b.useCallback(
      (T) => {
        const P = typeof T == "function" ? T(m) : T;
        n ? n(P) : p(P);
      },
      [n, m]
    ...
    return /* @__PURE__ */ o(Ka.Provider, { value: k, children: /* @__PURE__ */ o(Rt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ha = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Fn();
...
const Kw = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    L,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ o(Ws, {}) : /* @__PURE__ */ o(Zs, {}),
...
const br = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? ze : "div",
  {
    ref: r,
...
const Ww = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? ze : "button",
  {
    ref: r,
...
Ww.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const w = e ? ze : "button", { state: c } = Fn(), p = /* @__PURE__ */ o(
      w,
      {
        ...
        "data-size": r,
        "data-active": t,
        className: f(Zw({ variant: n, size: r }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o(Kt, { asChild: !0, children: p }),
      /* @__PURE__ */ o(Dt, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : p;
  }
);
Za.displayName = "SidebarMenuButton";
const Qw = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? ze : "button",
  {
    ref: a,
...
Qw.displayName = "SidebarMenuAction";
...
const ed = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
const od = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? ze : "a",
  {
    ref: s,
...
function ad({
  ...
  return /* @__PURE__ */ o(
    Ha,
    {
      ...
      children: /* @__PURE__ */ d(Ya, { children: [
        /* @__PURE__ */ d(gr, { children: [
          /* @__PURE__ */ o(br, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(vr, { children: /* @__PURE__ */ o(Ja, { children: Object.entries(t).map(([h, u]) => /* @__PURE__ */ o(Wa, { children: /* @__PURE__ */ o(
            Za,
            {
              onClick: () => c(h),
              isActive: m(h),
        ...
        /* @__PURE__ */ d(gr, { children: [
          /* @__PURE__ */ o(br, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ o(vr, { className: "tw-pl-3", children: /* @__PURE__ */ o(
            pr,
            {
              buttonVariant: "ghost",
...
const zr = wn(
  ({ value: e, onSearch: t, placeholder: n, isFullWidth: r, className: a, isDisabled: s = !1, id: i }, l) => {
    const w = pt();
    return /* @__PURE__ */ d("div", { id: i, className: f("tw-relative", { "tw-w-full": r }, a), children: [
      /* @__PURE__ */ o(
        No,
        {
          className: f(
    ...
    /* @__PURE__ */ d(
      qa,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Xa, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const re = "scrBook", sd = "scrRef", be = "source", id = "details", ld = "Scripture Reference", cd = "Scripture Book", Qa = "Type", wd = "Details";
function dd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: re,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? ld,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? Q.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === re ? xe(a.start) : void 0;
      },
      getGroupingValue: (r) => Q.bookIdToNumber(r.start.book),
      sortingFn: (r, a) => ar(r.original.start, a.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id,
      header: (e == null ? void 0 : e.detailsColumnName) ?? wd,
      cell: (r) => r.getValue(),
      enableGrouping: !1
    }
  ];
...
const pd = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || ar(e.start, e.end) === 0 ? `${Gn(e.start)}+${t}` : `${Gn(e.start)}+${t}-${Gn(e.end)}+${n}`;
}, vo = (e) => `${pd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function ru({
  sources: e,
  ...
  const [c, p] = M([]), [m, h] = M([{ id: re, desc: !1 }]), [u, g] = M({}), y = j(
  ...
  Y(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const C = y.find((A) => vo(A) === S[0]) || void 0;
        C && l(C);
      }
    }
  }, [u, y, l, N]);
  const k = a ?? cd, T = s ?? Qa, P = [
  ...
  }, x = (_, S) => _.getIsGrouped() ? "" : f("banded-row", S % 2 === 0 ? "even" : "odd"), E = (_, S, C) => {
    if (!((_ == null ? void 0 : _.length) === 0 || S.depth < C.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ d(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Te, { position: "item-aligned", children: /* @__PURE__ */ o(cw, { children: P.map((_) => /* @__PURE__ */ o(_t, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Ln, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Bn, { children: N.getHeaderGroups().map((_) => /* @__PURE__ */ o(Ut, { children: _.headers.filter((S) => S.column.columnDef.header).map((S) => (
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (C === "ltr" ? /* @__PURE__ */ o(Ie, {}) : /* @__PURE__ */ o(nr, {})),
                          " ",
...
const Fr = (e, t) => e.filter((n) => {
  try {
    return Qe(n) === t;
  } catch {
    return !1;
  }
}), ts = (e, t, n) => Fr(e, t).every((r) => n.includes(r));
function ud({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = Fr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], w = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    L,
    {
      variant: "outline",
...
function md({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], w = r["%webView_book_selector_select_all%"], c = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], m = r["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: y } = {
  ...
  }, [v, N] = M(!1), [k, T] = M(""), P = Z(void 0), V = Z(!1);
  if (e.length !== Q.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const $ = j(() => Q.allBookIds.filter(
    (I, q) => e[q] === "1" && !Q.isObsolete(Q.bookIdToNumber(I))
  ), [e]), x = j(() => {
    if (!k.trim()) {
      const D = {
        [H.OT]: [],
    ...
    (I, q = !1) => {
      if (!q || !P.current) {
        n(
          t.includes(I) ? t.filter((mt) => mt !== I) : [...t, I]
        ), P.current = I;
        return;
      }
      const D = $.findIndex((mt) => mt === P.current), z = $.findIndex((mt) => mt === I);
      if (D === -1 || z === -1) return;
      const [lt, bt] = [
        Math.min(D, z),
        Math.max(D, z)
      ], Ft = $.slice(lt, bt + 1).map((mt) => mt);
      n(
        t.includes(I) ? t.filter((mt) => !Ft.includes(mt)) : [.../* @__PURE__ */ new Set([...t, ...Ft])]
      );
    },
    [t, n, $]
  ), _ = (I) => {
    E(I, V.current), V.current = !1;
  }, S = (I, q) => {
    I.preventDefault(), E(q, I.shiftKey);
  }, C = F(
    (I) => {
      const q = Fr($, I).map((D) => D);
      n(
        ts($, I, t) ? t.filter((D) => !q.includes(D)) : [.../* @__PURE__ */ new Set([...t, ...q])]
      );
    },
    [t, n, $]
  ), A = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(H).map((I) => /* @__PURE__ */ o(
      ud,
      {
        section: I,
        availableBookIds: $,
            ...
            Wt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: G, children: c })
                ] }),
                /* @__PURE__ */ d(Zt, { children: [
                  /* @__PURE__ */ o(un, { children: p }),
                  Object.values(H).map((I, q) => {
                    const D = x[I];
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(yo, { children: [
                        /* @__PURE__ */ o(
                          Yt,
                          {
                            heading: oa(I, h, u, g, y),
                            children: D.map((z) => /* @__PURE__ */ o(
                              sa,
                              {
                                bookId: z,
                                isSelected: t.includes(z),
                                onSelect: () => _(z),
                                onMouseDown: (lt) => S(lt, z),
                                section: Qe(z),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: dr(z, a),
                        ...
                        q < Object.values(H).length - 1 && /* @__PURE__ */ o(Jo, {})
                      ] }, I);
                  })
                ] })
              ]
...
function au({
  ...
  const c = fe(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = fe(i, "%webView_scope_selector_current_book%"), u = fe(i, "%webView_scope_selector_choose_books%"), g = fe(i, "%webView_scope_selector_scope%"), y = fe(i, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Dr,
        {
          ...
          children: N.map(({ value: k, label: T, id: P }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(Tn, { className: "tw-me-2", value: k, id: P }),
            /* @__PURE__ */ o(dt, { htmlFor: P, children: T })
          ] }, P))
        }
      )
    ] }),
    e === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ o(dt, { children: y }),
      /* @__PURE__ */ o(
        md,
        {
          availableBookInfo: r,
...
function su({
  ...
  return /* @__PURE__ */ d(
    Le,
    {
      ...
      children: [
        /* @__PURE__ */ o(Ee, { size: a, className: f("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          Be,
          {
            placeholder: l[W(t)] ?? t
          }
...
const ns = (e, t, n, r) => n ? Object.entries(e).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ d(Bt, { children: [
  /* @__PURE__ */ o(Kt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    Dn,
    {
      onClick: () => {
        r(l);
    ...
    /* @__PURE__ */ o(rw, { children: /* @__PURE__ */ o(ja, { children: ns(
      e,
      t,
      es(e, l.id),
      r
  ...
  l.tooltip && /* @__PURE__ */ o(Dt, { children: l.tooltip })
...
function xr({
  ...
  return /* @__PURE__ */ d(Se, { variant: s, children: [
    /* @__PURE__ */ o(Ke, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(L, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(ti, {}) }) }),
    /* @__PURE__ */ o(de, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(yo, { children: [
      /* @__PURE__ */ o(La, { children: /* @__PURE__ */ o(Rt, { children: ns(t.groups, t.items, w, e) }) }),
      c < p.length - 1 && /* @__PURE__ */ o(qe, {})
    ] }, w)) })
  ] });
}
...
os.displayName = Nt.List.displayName;
...
as.displayName = Nt.List.displayName;
...
ss.displayName = Nt.Content.displayName;
function pu({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(os, { children: [
      /* @__PURE__ */ o(as, { children: e.map((l) => /* @__PURE__ */ o(fd, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ o(ss, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function hd({ ...e }) {
  return /* @__PURE__ */ o(rt.Menu, { ...e });
}
function gd({ ...e }) {
  return /* @__PURE__ */ o(rt.Sub, { "data-slot": "menubar-sub", ...e });
}
const is = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  ...
  return /* @__PURE__ */ o(Lr.Provider, { value: a, children: /* @__PURE__ */ o(
    rt.Root,
    {
      ref: r,
      className: f(
...
is.displayName = rt.Root.displayName;
  ...
  return /* @__PURE__ */ o(
    rt.Trigger,
    {
      ...
      className: f(
        ...
        // CUSTOM
        "pr-twp",
        te({ variant: r.variant, className: e })
        // CUSTOM use context to add variants
      ),
      ...t
    }
...
ls.displayName = rt.Trigger.displayName;
  ...
  return /* @__PURE__ */ d(
    rt.SubTrigger,
    {
      ...
      className: f(
        ...
        t && "tw-pl-8",
        te({ variant: s.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...r,
...
cs.displayName = rt.SubTrigger.displayName;
...
ws.displayName = rt.SubContent.displayName;
...
ds.displayName = rt.Content.displayName;
  ...
  return /* @__PURE__ */ o(
    rt.Item,
    {
      ...
      className: f(
        ...
        t && "tw-pl-8",
        te({ variant: a.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...n
...
ps.displayName = rt.Item.displayName;
const bd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = At();
  return /* @__PURE__ */ d(
    rt.CheckboxItem,
    {
...
bd.displayName = rt.CheckboxItem.displayName;
const vd = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = At();
  return /* @__PURE__ */ d(
    rt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(In, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
});
vd.displayName = rt.RadioItem.displayName;
...
xd.displayName = rt.Label.displayName;
...
us.displayName = rt.Separator.displayName;
const We = (e, t) => {
  setTimeout(() => {
    t.forEach((n) => {
      var r;
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((c) => c.group === s).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ d(Bt, { children: [
      /* @__PURE__ */ o(Kt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        ps,
        {
          onClick: () => {
            r(c);
      ...
      c.tooltip && /* @__PURE__ */ o(Dt, { children: c.tooltip })
...
function yd({
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    var g, y, v, N;
    p.preventDefault();
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), We(i, [h, u]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ o(is, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(hd, { children: [
      /* @__PURE__ */ o(ls, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        ds,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Rt, { children: ms(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function mu({
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      className: f("tw-border tw-px-4 tw-text-foreground", r),
      ref: p,
...
function fu({
  ...
  const c = Nd(
    ...
    a && a(g), r && r([g, ...n.filter((y) => y !== g)]), s && n.find((y) => y === g) && s([...n.filter((y) => y !== g)]), m(!1);
  }, u = (g, y) => {
    var N, k, T, P, V, $;
    const v = y !== g ? ((k = (N = e[g]) == null ? void 0 : N.uiNames) == null ? void 0 : k[y]) ?? ((P = (T = e[g]) == null ? void 0 : T.uiNames) == null ? void 0 : P.en) : void 0;
    return v ? `${(V = e[g]) == null ? void 0 : V.autonym} (${v})` : ($ = e[g]) == null ? void 0 : $.autonym;
  };
...
function kd({ item: e, createLabel: t, createComplexLabel: n }) {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(Se, { children: [
              /* @__PURE__ */ o(Ke, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(Co, {}) }) }),
...
const _d = wn(({ className: e, ...t }, n) => /* @__PURE__ */ o(ri, { size: 35, className: f("tw-animate-spin", e), ...t, ref: n }));
_d.displayName = "Spinner";
function bu({
  id: e,
  isDisabled: t = !1,
  hasError: n = !1,
  ...
  return /* @__PURE__ */ d("div", { className: f("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": r }), children: [
    /* @__PURE__ */ o(
      dt,
      {
        htmlFor: e,
...
), Ed = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const Sd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Sd.displayName = "AlertDescription";
const vu = ot.Root, xu = ot.Trigger, yu = ot.Group, Nu = ot.Portal, ku = ot.Sub, _u = ot.RadioGroup, Rd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
Rd.displayName = ot.SubTrigger.displayName;
...
Dd.displayName = ot.SubContent.displayName;
const Md = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(ot.Portal, { children: /* @__PURE__ */ o(
  ot.Content,
  {
    ref: n,
    className: f(
...
Md.displayName = ot.Content.displayName;
...
Od.displayName = ot.Item.displayName;
const Id = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  ot.CheckboxItem,
  {
    ref: a,
    className: f(
...
Id.displayName = ot.CheckboxItem.displayName;
const Ad = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  ot.RadioItem,
  {
    ref: r,
    className: f(
...
const Pd = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  ot.Label,
  {
    ref: r,
    className: f(
...
Vd.displayName = ot.Separator.displayName;
...
$d.displayName = "ContextMenuShortcut";
...
const Cu = It.Trigger, Bd = It.Portal, Eu = It.Close, hs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  It.Overlay,
  {
    ref: n,
...
hs.displayName = It.Overlay.displayName;
const jd = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
zd.displayName = "DrawerHeader";
function Fd({ className: e, ...t }) {
  return /* @__PURE__ */ o("div", { className: f("tw-mt-auto tw-flex tw-flex-col tw-gap-2 tw-p-4", e), ...t });
}
Fd.displayName = "DrawerFooter";
...
Gd.displayName = It.Title.displayName;
...
Ud.displayName = It.Description.displayName;
...
function Ru({
  ...
  return /* @__PURE__ */ o(
    _r.PanelResizeHandle,
    {
      ...
      ...n,
      children: e && /* @__PURE__ */ o("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ o(oi, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Du({ ...e }) {
...
const qd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = pt();
  return /* @__PURE__ */ d(
    Ze.Root,
    {
...
qd.displayName = Ze.Root.displayName;
...
Hd.displayName = wr.Root.displayName;
const Mu = Nt.Root, Xd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = pt();
  return /* @__PURE__ */ o(
    Nt.List,
    {
...
Xd.displayName = Nt.List.displayName;
...
Yd.displayName = Nt.Trigger.displayName;
...
export {
  ...
  Ve as Badge,
  Sp as BookChapterControl,
  $l as BookSelectionMode,
  Mp as BookSelector,
  L as Button,
  ...
  Pp as CommentList,
  vu as ContextMenu,
  Id as ContextMenuCheckboxItem,
  Md as ContextMenuContent,
  yu as ContextMenuGroup,
  Od as ContextMenuItem,
  Pd as ContextMenuLabel,
  Nu as ContextMenuPortal,
  _u as ContextMenuRadioGroup,
  Ad as ContextMenuRadioItem,
  Vd as ContextMenuSeparator,
  $d as ContextMenuShortcut,
  ku as ContextMenuSub,
  Dd as ContextMenuSubContent,
  Rd as ContextMenuSubTrigger,
  ...
  Nw as ErrorDump,
  Lp as ErrorPopover,
  Up as FOOTNOTE_EDITOR_STRING_KEYS,
  Fp as Filter,
  ...
  gu as ResultsCard,
  ou as SCOPE_SELECTOR_STRING_KEYS,
  au as ScopeSelector,
  ...
  ed as SidebarMenuSkeleton,
  nd as SidebarMenuSub,
  od as SidebarMenuSubButton,
  rd as SidebarMenuSubItem,
