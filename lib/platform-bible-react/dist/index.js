...
import { c as x, g as je, a as jr, C as ir, L as Un, u as Jo, T as At, b as Rt, d as Dt, e as Ot, A as xa, D as He, f as ze, h as qe, i as gr, j as Qe, B as tt, x as ks, k as _s, l as Ns, I as Cs, m as Co, n as ar, r as $e, o as Es, p as Kn, P as fr, q as zr, s as mr, t as vr, v as Oa, w as Ma, y as Eo, z as br, E as Ia, F as Pt, R as To, G as ya, H as io, J as so, K as co, M as lo, N as Hn, O as wa, Q as So, S as Hr, U as qr, V as Cr, W as Ts, X as ur, Y as rr, Z as Ge, _ as tr, $ as Er, a0 as Ro, a1 as Do, a2 as ka, a3 as Oo, a4 as qn, a5 as Ss, a6 as Rs, a7 as Ds, a8 as wo, a9 as Gn, aa as za, ab as Os, ac as Wn, ad as Ms, ae as Is, af as zs, ag as Qo, ah as Ps, ai as As, aj as $s, ak as Yn, al as Xn, am as Mo, an as Vs, ao as Zn, ap as Ua, aq as tn, ar as Ka, as as Ls, at as Bs, au as js, av as Fs, aw as Us, ax as Ks, ay as Yr, az as Io, aA as Hs, aB as qs } from "./resizable-B4e5BhTX.js";
import { aC as yf, aD as kf, aE as _f, aF as Nf, aG as Cf, aH as Ef, aI as Tf, aJ as Sf, aK as Rf, aL as Df, aM as Of, aN as Mf, aO as If, aP as zf, aQ as Pf, aR as Af, aS as $f, aT as Vf, aU as Lf, aV as Bf, aW as jf, aX as Ff, aY as Uf, aZ as Kf, a_ as Hf, a$ as qf, b0 as Gf, b1 as Wf, b2 as Yf, b3 as Xf, b4 as Zf, b5 as Jf, b6 as Qf, b7 as tm, b8 as em, b9 as rm, ba as am } from "./resizable-B4e5BhTX.js";
import { jsx as a, jsxs as u, Fragment as vt } from "react/jsx-runtime";
import { Canon as qt } from "@sillsdev/scripture";
import { Check as or, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Jn, ChevronDown as pr, ArrowLeft as Gs, ArrowRight as Ws, BoldIcon as Ys, ItalicIcon as Xs, X as zo, AtSign as Qn, Pencil as Zs, Trash2 as Js, ArrowUp as ti, MoreHorizontal as Qs, MailOpen as tc, Mail as ec, FilterIcon as rc, ArrowLeftIcon as ac, ChevronLeftIcon as oc, ChevronRightIcon as nc, ArrowRightIcon as ic, Copy as ei, Filter as sc, User as cc, Link as lc, CircleHelp as dc, Undo as wc, Redo as uc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as pc, AlertCircle as hc, CircleCheckIcon as gc, CircleXIcon as fc, CircleHelpIcon as mc, ArrowUpIcon as vc, ArrowDownIcon as bc, ScrollText as xc, ChevronRight as yc, ChevronLeft as kc, ChevronsUpDown as _c, MenuIcon as Nc, Menu as Cc, EllipsisVertical as Ec, MoreVertical as Tc } from "lucide-react";
import { Section as zt, compareScrRefs as _a, getChaptersForBook as Sc, formatScrRef as Fe, formatReplacementString as er, getSectionForBook as ua, formatRelativeDate as Rc, sanitizeHtml as Po, NumberFormat as ni, formatBytes as Dc, getCurrentLocale as Oc, usfmMarkers as pa, deepEqual as ii, isPlatformError as Mc, ABORTED as Ic, getErrorMessage as zc, getFormatCallerFunction as Pc, isString as on, scrRefToBBBCCCVVV as Ha, defaultScrRef as qa, formatScrRefRange as Ac, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as $c } from "platform-bible-utils";
import we, { useRef as L, useMemo as V, createContext as Xr, useContext as Pa, useState as _, useEffect as G, useCallback as B, useId as Na, useImperativeHandle as si, useLayoutEffect as Zt, Fragment as hr, Component as Vc, createElement as cn, Suspense as Lc, forwardRef as ci } from "react";
import { IconSelector as li, IconCheck as Aa, IconChevronDown as Bc, IconChevronUp as jc, IconLayoutSidebar as Fc, IconLayoutSidebarRight as Uc, IconChevronRight as di, IconSearch as Kc, IconLoader as Hc, IconAlertOctagon as qc, IconAlertTriangle as Gc, IconInfoCircle as Wc, IconCircleCheck as Yc } from "@tabler/icons-react";
import { createEditor as wi, $getRoot as nr, $createParagraphNode as Zr, $getSelection as ue, HISTORY_MERGE_TAG as Ao, ParagraphNode as ui, TextNode as pi, $getPreviousSelection as Xc, $isRangeSelection as Pe, $caretFromPoint as Zc, $getSiblingCaret as hi, $getChildCaret as Jc, $getAdjacentChildCaret as Qc, $isChildCaret as tl, $normalizeCaret as el, $setSelectionFromCaretRange as rl, $getCollapsedCaretRange as al, $getCaretInDirection as ln, $splitAtPointCaretNext as ol, $isTextPointCaret as nl, $findMatchingParent as gi, $isElementNode as Gr, mergeRegister as Ke, getDOMTextNode as il, isHTMLElement as sl, CLEAR_EDITOR_COMMAND as fi, COMMAND_PRIORITY_EDITOR as $o, shallowMergeConfig as cl, defineExtension as ye, safeCast as xr, createState as ll, FORMAT_TEXT_COMMAND as mi, $isNodeSelection as vi, COMMAND_PRIORITY_LOW as bi, RootNode as dl, LineBreakNode as wl, TabNode as ul, $isEditorState as pl, createCommand as hl, CLICK_COMMAND as gl, isDOMNode as fl, $getNodeFromDOMNode as ml, $createNodeSelection as vl, $setSelection as bl, $getEditor as xl, DecoratorNode as uo, $getState as yl, toggleTextFormatType as dn, TEXT_TYPE_TO_FORMAT as kl, $setState as _l, addClassNamesToElement as xi, $create as Nl, $getNodeByKey as Cl, removeClassNamesFromElement as El, KEY_TAB_COMMAND as Tl, $isBlockElementNode as Sl, $createRangeSelection as Rl, $normalizeSelection__EXPERIMENTAL as Dl, OUTDENT_CONTENT_COMMAND as Ol, INDENT_CONTENT_COMMAND as wn, INSERT_TAB_COMMAND as Ml, COMMAND_PRIORITY_CRITICAL as Vo, $isDecoratorNode as Il, $isParagraphNode as zl, $isTextNode as po, SELECTION_CHANGE_COMMAND as yi, $insertNodes as Pl } from "lexical";
...
import { Avatar as Lo, Select as ee, Checkbox as un, Slot as Jr, Tabs as Te, Menubar as Ve, ContextMenu as Gt, Progress as pn, Slider as oa, Switch as hn } from "radix-ui";
import { useReactTable as _i, getFilteredRowModel as Kl, getSortedRowModel as Ni, getPaginationRowModel as Hl, getCoreRowModel as Ci, flexRender as Fr, getGroupedRowModel as ql, getExpandedRowModel as Gl } from "@tanstack/react-table";
import Wl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ho, HIDDEN_NOTE_CALLER as go, getDefaultViewOptions as Yl, isInsertEmbedOpOfType as $r, getMarkerMenuItems as Xl, defaultStyleInfo as Zl, Editorial as Jl } from "@eten-tech-foundation/platform-editor";
import { cva as Ei } from "class-variance-authority";
import { useHotkeys as Ql } from "react-hotkeys-hook";
import { Drawer as sr } from "vaul";
import { useTheme as td } from "next-themes";
import { Toaster as ed } from "sonner";
import { toast as nm } from "sonner";
...
function Ti({
  ...
  const v = L(!1), f = () => {
    ...
    () => jr(e, l),
    [e, l]
  ), T = !!h && !p, z = `${C} (${y})`, U = T ? m || `${z}, ${h}` : z, E = /* @__PURE__ */ u(
    ir,
    {
      ref: t,
      value: d || `${e} ${qt.bookIdToEnglishName(e)}`,
      onSelect: f,
      onMouseDown: g,
      role: "option",
      "aria-selected": r,
...
function sd({
  ...
  const {
    ...
    onPointerEnter: v,
    onPointerLeave: f
  } = Jo(), [g, C] = _(!1), [y, T] = _(!1), z = L(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), U = n && e !== void 0, E = s ?? (e !== void 0 && !n);
  G(() => {
    var R;
    id();
    ...
    const k = (Y) => !!Y && Y.scrollWidth > Y.clientWidth, et = () => {
      fo !== "pointer" && (E || k(h.current) || k(l.current)) && T(!0);
    }, I = () => T(!1);
        ...
        children: [
          /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                S,
                S && M && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                M
              ]
            }
          ) }),
...
function wd({
  ...
  const [h, m] = _(!1), [v, f] = _(!1), g = Na(), C = L(!1), y = w !== void 0, T = y ? w : h, z = n === "" ? "" : de(n, ld), U = de(s, dd), E = (D) => {
    D || (C.current = !0, f(!1)), y || m(D), p == null || p(D);
  }, j = (D) => {
    if (D && C.current) {
      C.current = !1;
      return;
  ...
  return /* @__PURE__ */ u(He, { open: T, onOpenChange: E, modal: !1, children: [
    /* @__PURE__ */ a(At, { children: z ? /* @__PURE__ */ u(Rt, { open: v, onOpenChange: j, children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: O }) }),
      /* @__PURE__ */ a(Ot, { children: z })
...
function mn(t, e) {
  return qt.bookIdToNumber(t) < qt.bookIdToNumber(e.book);
}
function gd(t, e, r) {
  const o = qt.bookIdToNumber(t) - qt.bookIdToNumber(r.book);
  return o < 0 ? !0 : o > 0 ? !1 : e < r.chapterNum;
}
function Ga(t, e, r, o) {
  const n = qt.bookIdToNumber(t) - qt.bookIdToNumber(o.book);
  return n < 0 ? !0 : n > 0 ? !1 : e < o.chapterNum ? !0 : e > o.chapterNum ? !1 : r < o.verseNum;
}
function Je(t) {
  return Sc(qt.bookIdToNumber(t));
}
function fd(t, e, r) {
  ...
  const o = pd.reduce(
    (n, s) => {
      ...
      if (i) {
        ...
        if (!w && l) {
          const m = ((v) => Object.keys(xa).find(
            (f) => xa[f].toLowerCase() === v.toLowerCase()
          ))(c);
...
function vo(t) {
  return {
    [zt.OT]: t.filter((e) => qt.isBookOT(e)),
    [zt.NT]: t.filter((e) => qt.isBookNT(e)),
    [zt.DC]: t.filter((e) => qt.isBookDC(e)),
    [zt.Extra]: t.filter((e) => qt.extraBooks().includes(e))
  };
}
function md(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : qt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
...
function Wa({
  ...
  const E = $e(), j = nd(), [$, O] = _(!1), [D, S] = _(""), [M, X] = _(""), [k, et] = _("books"), [I, R] = _(void 0), [Y, dt] = _(
    void 0
  ), [nt, ht] = _(void 0), [Et, Q] = _(!1), [wt, ft] = _(!1), [it, Tt] = _(!1), [re, kt] = _(!1), Se = L(null), ke = L(!1), Ft = L(void 0), _t = L(void 0), Wt = L(void 0), pe = L(void 0), Mt = L({}), pt = L({}), bt = B(
    (b) => {
      e(b), l && l(b);
    },
    [e, l]
    ...
    projectBooksBySection: Ut,
    reachableBooksBySection: Re,
    reachableBooks: xt,
    projectBooks: oe,
    ...
    () => md(he, ae),
    [he, ae]
  ), mt = $t.has(t.book), _e = V(() => M.trim() ? vo(
    xt.filter((b) => Co(b, M, s))
  ) : wt ? Re : Ut, [
    Ut,
    Re,
    xt,
    ...
    if (!A) return;
    const b = D.startsWith(`${A.book} `) ? D : "", H = na(b), ot = Br(b);
    return {
      book: A.book,
      chapterNum: ot ?? A.chapterNum ?? 1,
      verseNum: H ?? A.verseNum ?? 1
    };
  }, [A, D]), ge = L(!1);
  G(() => {
    if (!ge.current) {
  ...
  const ne = B(() => {
    ...
    (b) => {
      const H = Y ?? (A == null ? void 0 : A.book), ot = nt ?? (A == null ? void 0 : A.chapterNum);
      !H || !ot || (bt({
        book: H,
        chapterNum: ot,
        verseNum: b
    ...
    (b) => {
      const H = k === "chapters" ? I : A == null ? void 0 : A.book;
      if (H) {
        if (w && w(H, b) > 1) {
          dt(H), ht(b), et("verses"), S("");
          return;
        }
        bt({
          book: H,
    ...
    et("books"), R(void 0), dt(void 0), ht(void 0), kt(!1), setTimeout(() => {
      var b;
      (b = _t.current) == null || b.focus();
    }, 0);
  }, []), fe = B(() => {
    const b = Y;
    dt(void 0), ht(void 0), b ? (R(b), et("chapters"), S("")) : Yt();
  }, [Y, Yt]), me = B(
    (b) => {
      O(b), b && (et("books"), R(void 0), dt(void 0), ht(void 0), X(""), kt(!1), Tt(!1), ft(mt));
    },
    [mt]
  );
  G(() => {
  ...
  G(() => {
    var b;
    De !== 0 && ((b = _t.current) == null || b.focus());
  }, [De]), si(
    z,
    () => ({
      open: () => {
  ...
  const { otLong: Oe, ntLong: We, dcLong: Ye, extraLong: Xe } = {
    ...
    () => j >= Ur.TIGHT ? jr(t.book, s) : je(t.book, s),
    [t.book, s, j]
  ), J = `${t.chapterNum}:${t.verseNum}`, q = B((b) => (H) => {
    Mt.current[b] = H;
  }, []), W = B((b) => (H) => {
    pt.current[b] = H;
  }, []), rt = V(
    () => hd(M),
    [M]
  ), st = V(() => !w || !A || !A.chapterNum || !rt ? !1 : w(A.book, A.chapterNum) > 0, [w, A, rt]), lt = k === "books" && !Et && !M.trim() && $t.size > 0, St = B(
    (b) => p ? mn(b, p) : !1,
    [p]
  ), yt = B(
    (b) => (H) => p ? gd(b, H, p) : !1,
    ...
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), h && h.includes(b.key) && A && A.chapterNum !== void 0 && A.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), ne());
    },
    [h, A, ne]
  ), aa = B(
    (b) => {
      ...
      if (!(!!H && !!((Yo = Ft.current) != null && Yo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (b.key === "Tab") {
        const jt = Ft.current ? yd(Ft.current) : [];
        if (jt.length === 0) {
          b.preventDefault(), b.stopPropagation();
          return;
        }
        const be = jt[jt.length - 1], Jt = b.shiftKey ? jt[0] : be;
        document.activeElement === Jt && (b.preventDefault(), b.stopPropagation(), (b.shiftKey ? be : jt[0]).focus());
        return;
      }
      const { isLetter: Kt, isDigit: Xt } = gn(b.key);
      if ((k === "chapters" || k === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const be = (() => {
          if (k === "verses") {
            const Ar = Y, Zo = nt, Fa = na(D);
            return !Ar || !Zo || Fa === void 0 ? void 0 : {
              isDisabled: Vt(Ar, Zo)(Fa),
              activate: () => ie(Fa)
            };
          }
          const Jt = I, Ce = Br(D);
        ...
        if (be) {
          b.preventDefault(), b.stopPropagation(), be.isDisabled || be.activate();
          return;
        }
      }
      if (k === "books" && A && !Et && b.key === "Enter" && !(H !== _t.current && !!(H != null && H.closest('button, a, input, select, textarea, [role="button"]')))) {
        b.preventDefault(), b.stopPropagation(), ne();
        return;
      }
      if ((k === "chapters" || k === "verses") && (Kt || Xt)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (b.key === "Backspace" && (k === "chapters" || k === "verses")) {
        b.preventDefault(), b.stopPropagation(), k === "verses" ? fe() : Yt();
        return;
      }
      if (!ad(b.key) || Et) return;
      if (k === "books" && !re && (b.key === "ArrowLeft" || b.key === "ArrowRight")) {
        const jt = H === _t.current ? _t.current : void 0, be = (jt == null ? void 0 : jt.selectionStart) ?? 0, Jt = (jt == null ? void 0 : jt.selectionEnd) ?? 0, Ce = E === "rtl" ? b.key === "ArrowRight" : b.key === "ArrowLeft";
        if (!!jt && (be !== Jt || (Ce ? be > 0 : Jt < jt.value.length))) return;
      }
      if (b.shiftKey || k === "books" && H !== _t.current && (H != null && H.closest('button, a, [role="button"]')))
        return;
      const Ct = (() => {
        const jt = k === "books" && A && st && A.chapterNum ? { bookId: A.book, chapterNum: A.chapterNum } : void 0, be = k === "verses" ? { bookId: Y, chapterNum: nt } : jt;
        if (be) {
          const { bookId: Jt, chapterNum: Ce } = be;
          return !Jt || !Ce || !w ? void 0 : {
            max: w(Jt, Ce),
            current: na(D) ?? 0,
            buildValue: (Ar) => ha(Jt, Ce, Ar),
            refs: pt,
        ...
        if (k === "chapters" || k === "books" && A && Je(A.book) > 1) {
          const Jt = k === "chapters" ? I : A == null ? void 0 : A.book;
          return Jt ? {
            max: Je(Jt),
            current: Br(D) ?? 0,
            buildValue: (Ce) => Tr(Jt, Ce),
            refs: Mt,
            takeFocus: k === "chapters"
          } : void 0;
        }
      })();
      if (!Ct || Ct.max <= 0) return;
      k === "books" && kt(!0), Ct.takeFocus && ((Xo = Ft.current) == null || Xo.focus());
      const le = bd({
        current: Ct.current,
        key: b.key,
        max: Ct.max,
      ...
      if (b.preventDefault(), b.stopPropagation(), le === Ct.current) return;
      S(Ct.buildValue(le));
      const Wo = Ct.refs.current[le];
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (Kt = _t.current) == null || Kt.focus();
      return;
    }
    const { isLetter: H, isDigit: ot } = gn(b.key);
    (H || ot) && (b.preventDefault(), X((Ct) => Ct + b.key), (Xt = _t.current) == null || Xt.focus(), Q(!1));
  }, []);
  Zt(() => {
    const b = setTimeout(() => {
      if ($ && k === "books" && Wt.current && pe.current) {
        const H = Wt.current, ot = pe.current, Kt = ot.offsetTop, Xt = H.clientHeight, Ct = ot.clientHeight, le = Kt - Xt / 2 + Ct / 2;
        H.scrollTo({
          top: Math.max(0, le),
          behavior: "smooth"
        }), S(mo(t.book));
    ...
    if (k === "chapters" && I) {
      const b = I === t.book, H = b ? t.chapterNum : 1;
      S(Tr(I, H)), setTimeout(() => {
        if (Wt.current)
          if (b) {
  ...
  }, [k, I, A, t.book, t.chapterNum]), Zt(() => {
    if (k === "verses" && Y && nt !== void 0) {
      const b = Y === t.book && nt === t.chapterNum, H = b ? t.verseNum : 1;
      S(
        ha(Y, nt, H)
      ), setTimeout(() => {
        if (Wt.current)
          if (b) {
            const ot = pt.current[t.verseNum];
            ot && ot.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            Wt.current.scrollTo({ top: 0 });
        Ft.current && Ft.current.focus();
  ...
  const at = A ? `${A.book} ${A.chapterNum ?? ""} ${A.verseNum ?? ""} ${st}` : "", Bt = L(""), ve = L(""), Ne = V(() => {
    if (k !== "books" || !A || Et) return;
    const { book: b, chapterNum: H, verseNum: ot } = A;
    if (st && H && w)
      return {
        max: w(b, H),
        initial: ot ?? (b === t.book && H === t.chapterNum ? t.verseNum : 1),
        parse: na,
        buildValue: (Xt) => ha(b, H, Xt)
      };
    const Kt = Je(b);
    if (!(Kt <= 1))
      return {
  ...
  return Zt(() => {
    if (k !== "books" || !A || !Ne || Ne.max <= 0) {
      Bt.current = "";
      return;
    }
    const { max: b, initial: H, parse: ot, buildValue: Kt } = Ne, Xt = (Ct) => {
      const le = ot(Ct);
      return le !== void 0 && le >= 1 && le <= b && Ct === Kt(le) ? le : void 0;
    };
    if (Bt.current !== at) {
      Bt.current = at;
      const Ct = Kt(Math.min(Math.max(H, 1), b));
      ve.current = Ct, S(Ct);
      return;
    }
    if (Xt(D) !== void 0) {
    ...
    S(
      Xt(ve.current) !== void 0 ? ve.current : Kt(Math.min(Math.max(H, 1), b))
    );
  }, [k, A, Ne, at, D]), /* @__PURE__ */ u(fr, { open: $, onOpenChange: me, modal: y, children: [
    /* @__PURE__ */ a(zr, { asChild: !0, children: /* @__PURE__ */ u(
      tt,
      {
        ref: Se,
        ...
        onClick: (b) => {
          ke.current && (ke.current = !1, b.preventDefault());
        },
        children: [
          m ?? /* @__PURE__ */ a(
            sd,
            {
              primary: Z,
              secondary: J,
              showSecondary: j < Ur.MINIMUM,
              isPartial: j >= Ur.TIGHT,
              fullText: K
            }
          ),
          f && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      mr,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: H } = b;
          $ && Se.current && H instanceof Node && Se.current.contains(H) && (ke.current = !0, me(!1));
        },
        onCloseAutoFocus: C,
          ...
          vr,
          {
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  className: x("tw:flex tw:items-end", Et && "tw:pb-1"),
                  onFocus: (b) => {
                    Tt(b.target !== _t.current);
                  },
                  onBlur: (b) => {
                    b.currentTarget.contains(b.relatedTarget) || Tt(!1);
                  },
                  children: [
                    ...
                    /* @__PURE__ */ a(Ma, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: It.map(
                      ({ onClick: b, disabled: H, title: ot, icon: Kt, group: Xt }, Ct) => {
                        const le = /* @__PURE__ */ a(
                          tt,
                          {
                            variant: "ghost",
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(hr, { children: [
                            Ct > 0 && Xt !== It[Ct - 1].group && /* @__PURE__ */ a(Eo, {}),
                            H ? (
                              ...
                              /* @__PURE__ */ a("span", { title: ot, className: "tw:inline-flex", children: le })
                            ) : /* @__PURE__ */ u(Rt, { children: [
                              /* @__PURE__ */ a(Dt, { asChild: !0, children: le }),
                              /* @__PURE__ */ a(Ot, { children: ot })
                            ] })
                          ] }, `${Xt}-${Ct}`)
                        );
                      }
                ...
                /* @__PURE__ */ u(Rt, { children: [
                  /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      variant: "ghost",
                      size: "sm",
                      onClick: k === "verses" ? fe : Yt,
                      className: "tw:me-2 tw:h-6 tw:w-6 tw:p-0",
                      tabIndex: -1,
                      "aria-label": lr,
                      children: E === "ltr" ? /* @__PURE__ */ a(Gs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ws, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                  /* @__PURE__ */ a(Ot, { children: lr })
                ] }),
                k === "chapters" && I && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: je(I, s) }),
                k === "verses" && Y && nt !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${je(Y, s)} ${nt}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: k === "verses" ? yr : Lt
                  }
                )
              ] }),
              !Et && /* @__PURE__ */ u(br, { ref: Wt, children: [
                k === "books" && /* @__PURE__ */ u(vt, { children: [
                  !A && Object.entries(_e).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ar, { heading: Be(b), children: H.map((ot) => /* @__PURE__ */ a(
                          Ti,
                          {
                            bookId: ot,
                            onSelect: (Kt) => se(Kt),
                            section: ua(ot),
                            commandValue: mo(ot),
                            suppressKeyboardHighlight: it,
                            ref: ot === t.book ? pe : void 0,
                            localizedBookNames: s,
                            disabled: St(ot),
                            dimmedReason: $t.has(ot) ? ja : void 0,
                            dimmedDescription: $t.has(ot) ? ta(ot) : void 0
                          },
                          ot
                        )) }, b)
                      );
                  }),
                  A && ct && /* @__PURE__ */ a(ar, { children: /* @__PURE__ */ u(
                    ir,
                    {
                      value: cd,
                      onSelect: ne,
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: jr(A.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  A && st && A.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  /* @__PURE__ */ a(
                    bn,
                    {
                      ...
                      onVerseSelect: ie,
                      setVerseRef: W,
                      isVerseDisabled: Vt(A.book, A.chapterNum),
                      suppressKeyboardHighlight: it,
                      className: "tw:px-4 tw:pb-4"
                    }
                  ),
                  A && !st && Je(A.book) > 1 && // No heading here either, for the same reason as the verse preview above:
                ...
                k === "chapters" && I && /* @__PURE__ */ a(
                  vn,
                  {
                    ...
                    onChapterSelect: ce,
                    setChapterRef: q,
                    isChapterDisabled: yt(I),
                    className: "tw:p-4"
                  }
                ),
                k === "verses" && Y && nt !== void 0 && w && /* @__PURE__ */ a(
                  bn,
                  {
                    bookId: Y,
                    chapterNum: nt,
              ...
              lt && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                tt,
                {
                  variant: "ghost",
                  size: "sm",
...
function xn({
  ...
  const [T, z] = _(!1), U = d ?? l, E = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], j = ($, O) => {
    const D = l($), S = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, M = `${O ?? ""}${D}${S ?? ""}`;
    return /* @__PURE__ */ u(
      ir,
      {
        value: D,
  ...
  return /* @__PURE__ */ u(fr, { open: T, onOpenChange: z, ...y, children: [
    /* @__PURE__ */ a(zr, { asChild: !0, children: /* @__PURE__ */ u(
      tt,
      {
        variant: v,
    ...
    /* @__PURE__ */ a(
      mr,
      {
        ...
        style: s,
        children: /* @__PURE__ */ u(vr, { children: [
          /* @__PURE__ */ a(
            Oa,
            {
              placeholder: h,
          ...
          /* @__PURE__ */ a(Ia, { children: m }),
          /* @__PURE__ */ a(br, { children: E(e) ? e.map(($) => /* @__PURE__ */ a(ar, { heading: $.groupHeading, children: $.options.map((O) => j(O, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(ar, { children: e.map(($) => j($)) }) })
        ] })
      }
    )
  ] });
...
function xh({
  ...
  const w = Ya(d, "%webView_bookSelector_currentBook%"), p = Ya(d, "%webView_bookSelector_choose%"), h = Ya(d, "%webView_bookSelector_chooseBooks%"), [m, v] = _(
    "current book"
    /* CurrentBook */
  ), f = (g) => {
    v(g), t(g);
    ...
    To,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Pt, { className: "tw:flex tw:items-center", children: o.map((g) => qt.bookIdToEnglishName(g)).join(", ") }),
          /* @__PURE__ */ a(
            tt,
            {
...
const Mi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cd = Mi ? Zt : G, sa = { tag: Ao };
function Ed({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: l } = t, d = Nd(null, o), w = wi({ editable: t.editable, html: l, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (m.isEmpty()) {
            ...
            (ue() !== null || f !== null && f === p.getRootElement()) && v.select();
          }
        }, sa);
...
const Td = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
...
function Md({ children: t, onError: e }) {
...
const Id = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
function zd(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Pd() {
  return function(t) {
    const [e] = Le(), r = V(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), s = L(o);
    return Id(() => {
...
const Ii = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $d = Ii && "documentMode" in document ? document.documentMode : null;
!(!Ii || !("InputEvent" in window) || $d) && "getTargetRanges" in new window.InputEvent("input");
function Ie(t) {
  return `${t}px`;
}
...
function Ld(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), m = Ad(t, e);
    var v, f;
    c.isConnected || (f = c, (v = n).insertBefore(f, v.firstChild));
    let g = !1;
    for (let C = 0; C < m.length; C++) {
      const y = m[C], T = i[C] || document.createElement("div"), z = T.style;
      z.position !== "absolute" && (z.position = "absolute", g = !0);
      const U = Ie(y.left - p);
      z.left !== U && (z.left = U, g = !0);
      const E = Ie(y.top - h);
      z.top !== E && (T.style.top = E, g = !0);
      const j = Ie(y.width);
      z.width !== j && (T.style.width = j, g = !0);
      const $ = Ie(y.height);
      z.height !== $ && (T.style.height = $, g = !0), T.parentNode !== c && (c.append(T), g = !0), i[C] = T;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    if (!sl(m)) return d();
    d(), o = h, n = m, s = new MutationObserver((v) => {
      const f = t.getRootElement(), g = f && f.parentElement;
      if (f !== o || g !== n) return p();
      for (const C of v) if (!c.contains(C.target)) return l();
    }), s.observe(m, Vd), l();
  });
  return () => {
    w(), d();
...
function Bd(t) {
  for (const e of t) {
    const r = e.style;
    r.background !== "Highlight" && (r.background = "Highlight"), r.color !== "HighlightText" && (r.color = "HighlightText"), r.marginTop !== Ie(-1.5) && (r.marginTop = Ie(-1.5)), r.paddingTop !== Ie(4) && (r.paddingTop = Ie(4)), r.paddingBottom !== Ie(0) && (r.paddingBottom = Ie(0));
  }
}
function jd(t, e = Bd) {
  ...
  function d(w) {
    w.read(() => {
      const p = ue();
      if (!Pe(p)) return r = null, n = null, s = null, c = null, l(), void (l = () => {
      });
      const [h, m] = function($) {
        const O = $.getStartEndPoints();
        return $.isBackward() ? [O[1], O[0]] : O;
      }(p), v = h.getNode(), f = v.getKey(), g = h.offset, C = m.getNode(), y = C.getKey(), T = m.offset, z = t.getElementByKey(f), U = t.getElementByKey(y), E = r === null || z !== o || g !== n || f !== r.getKey(), j = s === null || U !== i || T !== c || y !== s.getKey();
      if ((E || j) && z !== null && U !== null) {
        const $ = function(O, D, S, M, X, k, et) {
          const I = (O._window ? O._window.document : document).createRange();
          return I.setStart(...yn(D, S, M)), I.setEnd(...yn(X, k, et)), I;
        }(t, h, v, z, m, C, U);
        l(), l = Ld(t, $, e);
      }
      r = v, o = z, n = g, s = C, i = U, c = T;
    });
  }
...
function Ud(t) {
  const e = gi(t, (r) => Gr(r) && !r.isInline());
  return Gr(e) || Ca(4, t.__key), e;
}
function Kd(t) {
  const e = ue() || Xc();
  let r;
  if (Pe(e)) r = Zc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = hi(c, "next"));
    }
    r = r || Jc(nr(), "previous").getFlipped().insert(Zr());
  }
...
function Hd(t, e, r) {
  ...
  return nl(o) && Ca(283), o.insert(t.isInline() ? Zr().append(t) : t), ln(hi(t.getLatest(), "next"), e.direction);
}
function qd(t) {
  const e = ue();
  if (!Pe(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(i)) continue;
    const c = gi(s, (d) => Gr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Ea, Ue = 0, Ta = 0, Yd = 0, yo = 0, fa = 0;
function _n(t) {
  if (ut === void 0) return;
  let e = t.n;
...
function Zd(t) {
  ...
  Pi(this), ut = t, this.f &= -2, 8 & this.f && Fo(this), Va();
}
function Nr(t, e) {
...
te.prototype.brand = Gd, te.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ue !== 0 && Ta === 0 && e.l !== yo && (e.l = yo, Ea = { S: e, v: e.v, i: e.i, o: Ea });
...
} }), dr.prototype = new te(), dr.prototype.h = function() {
  ...
  return ut = t, Pi(this), this.f &= -2, !0;
}, dr.prototype.S = function(t) {
  if (this.t === void 0) {
    this.f |= 36;
    for (let e = this.s; e !== void 0; e = e.n) e.S.S(e);
  }
  te.prototype.S.call(this, t);
}, dr.prototype.U = function(t) {
...
}, Object.defineProperty(dr.prototype, "value", { get() {
...
ye({ build: (t, e, r) => Pr(e), config: xr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
  return Ae(() => o.disabled.value ? void 0 : t.registerRootListener((n) => {
    t.focus(() => {
...
function $i() {
  const t = nr(), e = ue(), r = Zr();
  t.clear(), t.append(r), e !== null && r.select(), Pe(e) && (e.format = 0);
}
function Vi(t, e = $i) {
  return t.registerCommand(fi, (r) => (t.update(e), !0), $o);
}
ye({ build: (t, e, r) => Pr(e), config: xr({ $onClear: $i }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Ae(() => Vi(t, o.value));
} });
function Jd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Za = ll("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Li extends uo {
  $config() {
    return this.config("decorator-text", { extends: uo, stateConfigs: [{ flat: !0, stateConfig: Za }] });
  }
  getFormat() {
    return yl(this, Za);
  }
...
ye({ name: "@lexical/extension/DecoratorText", nodes: () => [Li], register: (t, e, r) => t.registerCommand(mi, (o) => {
  const n = ue();
  if (vi(n) || Pe(n)) for (const s of n.getNodes()) Qd(s) && s.toggleFormat(o);
  return !1;
}, bi) });
function Bi(t, e) {
  let r;
...
const ko = ye({ build: (t) => Bi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Uo = 0, _o = 1, Fi = 2, Ja = 3, ca = 4, _r = 5, Qa = 6, Vr = 7;
function to(t) {
  return t.id === Uo;
}
function Ui(t) {
...
function tw(t) {
  return function(e) {
    return e.id === _o;
  }(t) || gt(305, String(t.id), String(_o)), Object.assign(t, { id: Fi });
}
...
class rw {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(c, l, d) {
      return Object.assign(c, { config: l, id: Ja, registerState: d });
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== ca && gt(307, String(r.id), String(_r)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== _r && gt(308, String(o.id), String(_r));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(s) {
      return Object.assign(s, { id: Qa });
    }(o), () => {
      const s = this.state;
      s.id !== Vr && gt(309, String(o.id), String(Vr)), this.state = function(i) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Qa && gt(310, String(r.id), String(Qa)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= ca;
    }(e) || gt(313, String(e.id), String(ca)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Ja;
    }(e) || gt(314, String(e.id), String(Ja)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Vr;
    }(e) || gt(316, String(e.id), String(Vr)), e;
  }
...
const ow = ye({ config: xr({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = aw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [dl, pi, wl, ul, ui] }), En = Symbol.for("@lexical/extension/LexicalBuilder");
function Tn() {
}
function nw(t) {
  throw t;
...
class Sr {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = eo, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[En];
    return r && (r.PACKAGE_VERSION !== eo && gt(292, r.PACKAGE_VERSION, eo), r instanceof Sr || gt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      to(s) || gt(300, i, n || "[unknown]"), to(c = s) || gt(304, String(c.id), String(Uo)), s = Object.assign(c, { id: _o }), o.state = s;
    ...
    for (const o of this.extensionNameMap.values()) to(o.state) && r(o);
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of Jd(p)) {
        if (typeof h != "function") {
          const m = o.get(h.replace);
          m && gt(302, p.name, h.replace.name, m.extension.name), o.set(h.replace, w);
        }
        r.add(h);
      }
      if (p.html) {
...
const iw = /* @__PURE__ */ new Set(), Sn = ye({ build(t, e, r) {
  const o = r.getDependency(ko).output, n = Wr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Bi(() => {
  }, () => Ae(() => {
    ...
    o.value.read(() => {
      if (ue()) for (const [w, p] of c.entries()) {
        ...
        const h = Cl(w), m = h && h.isSelected() || !1;
        d = d || m !== (!!i && i.has(w)), m && (l = l || /* @__PURE__ */ new Set(), l.add(w));
      }
    }), !d && l && i && l.size === i.size || (s.value = l);
  }));
  return { watchNodeKey: function(i) {
    const c = Xd(() => (s.value || iw).has(i)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(i);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(i, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [ko], name: "@lexical/extension/NodeSelection" }), sw = hl("INSERT_HORIZONTAL_RULE_COMMAND");
class Rr extends uo {
  static getType() {
...
ye({ dependencies: [ko, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [Rr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Sn).output, n = Wr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Ke(t.registerCommand(sw, (i) => {
    const c = ue();
    if (!Pe(c)) return !1;
    ...
    return !0;
  }, $o), t.registerCommand(gl, (i) => {
    if (fl(i.target)) {
      const c = ml(i.target);
      if (lw(c)) return function(l, d = !1) {
        const w = ue(), p = l.isSelected(), h = l.getKey();
        let m;
        d && vi(w) ? m = w : (m = vl(), bl(m)), p ? m.delete(h) : m.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  }, bi), t.registerMutationListener(Rr, (i, c) => {
    Wd(() => {
      let l = !1;
      const { nodeSelections: d } = n.peek();
      for (const [w, p] of i.entries()) if (p === "destroyed") d.delete(w), l = !0;
      else {
        const h = d.get(w), m = t.getElementByKey(w);
        h ? h.domNode.value = m : (l = !0, d.set(w, { domNode: Wr(m), selectedSignal: o(w) }));
      }
      l && (n.value = { nodeSelections: d });
    });
  }), Ae(() => {
    const i = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) i.push(Ae(() => {
      const d = c.value;
      d && (l.value ? xi(d, s) : El(d, s));
    }));
    return Ke(...i);
  }));
} });
ye({ build: (t, e) => Pr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: xr({ $getParentEditor: function() {
  const t = xl();
  return Sr.fromEditor(t), t;
}, inheritEditableFromParent: !1 }), init: (t, e, r) => {
  const o = e.$getParentEditor();
  t.parentEditor = o, t.theme = t.theme || o._config.theme;
}, name: "@lexical/extension/NestedEditor", register: (t, e, r) => Ae(() => {
...
ye({ build: (t, e, r) => Pr(e), config: xr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ae(() => {
...
function dw(t, e, r = Ki) {
  return Ke(t.registerCommand(Tl, (o) => {
    const n = ue();
    if (!Pe(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => Sl(h) && h.canIndent()).length > 0) return !0;
      const c = i.anchor, l = i.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Ud(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let m = Rl();
        if (m.anchor.set(h, 0, "element"), m.focus.set(h, 0, "element"), m = Dl(m), m.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Ol : wn : Ml;
...
ye({ build: (t, e, r) => Pr(e), config: xr({ $canIndent: Ki, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: s } = r.getOutput();
  return Ae(() => {
    if (!o.value) return dw(t, n, s);
  });
} });
const ww = ye({ name: "@lexical/react/ReactProvider" });
function uw() {
  return nr().getTextContent();
}
function pw(t, e = !0) {
  if (t) return !1;
  let r = uw();
...
function hw(t) {
  if (!pw(t, !1)) return !1;
  const e = nr().getChildren(), r = e.length;
  if (r > 1) return !1;
  for (let o = 0; o < r; o++) {
    const n = e[o];
    if (Il(n)) return !1;
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (Pe(v)) {
                const f = v.anchor;
                let g = f.getNode(), C = 0, y = 0;
                if (po(g) && d >= 0 && w >= 0 && (C = d, y = d + w, v.setTextNodeRange(g, C, g, y)), C === y && p === "" || (v.insertRawText(p), g = f.getNode()), po(g)) {
                  C = h, y = h + m;
                  const T = g.getTextContentSize();
                  C = C > T ? T : C, y = y > T ? T : y, v.setTextNodeRange(g, C, g, y);
                }
...
ye({ build: (t, e, r) => Pr(e), config: xr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ae(() => r.getOutput().disabled.value ? void 0 : qi(t)) });
function gw(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
  ...
  return function(r, o) {
    ...
    return Ho(() => r.registerDecoratorListener((i) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(Lc, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && i.push(Bl(w, p, d));
      }
      return i;
    }, [o, n, r]);
  }(t, e);
...
function vw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Ho(() => Ke(Vl(n), qi(n)), [n]);
  }(o), u(vt, { children: [t, a(bw, { content: e }), a(mw, { editor: o, ErrorBoundary: r })] });
}
function bw({ content: t }) {
  const [e] = Le(), r = function(n) {
    const [s, i] = _(() => Rn(n));
    return Ho(() => {
      function c() {
        const l = Rn(n);
...
const yw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
function kw({ onClear: t }) {
  const [e] = Le();
  return yw(() => Vi(e, t), [e, t]), null;
}
const Gi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
function _w({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: m, className: v, id: f, role: g = "textbox", spellCheck: C = !0, style: y, tabIndex: T, "data-testid": z, ...U }, E) {
  const [j, $] = _(t.isEditable()), O = B((S) => {
    S && S.ownerDocument && S.ownerDocument.defaultView ? t.setRootElement(S) : t.setRootElement(null);
  }, [t]), D = V(() => /* @__PURE__ */ function(...S) {
    return (M) => {
      for (const X of S) typeof X == "function" ? X(M) : X != null && (X.current = M);
    };
  }(E, O), [O, E]);
  return Gi(() => ($(t.isEditable()), t.registerEditableListener((S) => {
    $(S);
  })), [t]), a("div", { "aria-activedescendant": j ? e : void 0, "aria-autocomplete": j ? r : "none", "aria-controls": j ? o : void 0, "aria-describedby": n, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": j && g === "combobox" ? !!i : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": j ? p : void 0, "aria-readonly": !j || void 0, "aria-required": h, autoCapitalize: m, className: v, contentEditable: j, "data-testid": z, id: f, ref: D, role: g, spellCheck: C, style: y, tabIndex: T, ...U });
}
const Nw = ci(_w);
function Dn(t) {
  return t.getEditorState().read(Hi(t.isComposing()));
...
const Cw = ci(Ew);
function Ew(t, e) {
  const { placeholder: r, ...o } = t, [n] = Le();
  return u(vt, { children: [a(Nw, { editor: n, ...o, ref: e }), r != null && a(Tw, { editor: n, content: r })] });
}
...
function Ow({
  ...
  const [e] = Le(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Dw(), l = () => {
  };
...
function Iw() {
  const { activeEditor: t } = Yi(), [e, r] = _([]), o = B((n) => {
    if (Pe(n) || jl(n)) {
      const s = [];
      On.forEach(({ format: i }) => {
        ...
        children: /* @__PURE__ */ a(
          Ed,
          {
            ...
            children: /* @__PURE__ */ u(At, { children: [
              /* @__PURE__ */ a(Pw, { placeholder: n, autoFocus: s, onClear: i }),
              /* @__PURE__ */ a(
                Sd,
                {
...
function Qi({
  ...
  return /* @__PURE__ */ u(Ma, { children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(
        tt,
        {
          "aria-label": i,
      ...
      /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ a("p", { children: i }) })
    ] }) }),
    /* @__PURE__ */ a(Eo, {}),
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(
...
const Vw = "verseText", yh = Object.freeze([
...
function kh({
  ...
  const [s, i] = _(Lw), [c, l] = _(n), [d, w] = _(!1), p = L(void 0), h = L(null);
  G(() => {
    let g = !0;
    const C = h.current;
    if (!C) return;
  ...
  const m = B(() => {
    ...
    const g = Ra(s);
    e(g, c);
  }, [s, e, c]), v = o["%commentEditor_placeholder%"] ?? "Type your comment here...", f = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(fr, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(zr, { asChild: !0, children: /* @__PURE__ */ u(
        tt,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: ro(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        mr,
        {
          ...
          children: /* @__PURE__ */ a(vr, { children: /* @__PURE__ */ a(br, { children: t.map((g) => /* @__PURE__ */ a(
            ir,
            {
              onSelect: () => {
                l(g || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: ro(g, o) })
            },
            g || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (g) => {
          g.key === "Escape" ? (g.preventDefault(), g.stopPropagation(), r()) : Go(g) && (g.preventDefault(), g.stopPropagation(), xe(s) && m());
        },
        onKeyDown: (g) => {
...
function In({
  ...
  const m = B(
    (E) => {
      E && E.stopPropagation(), d(!1), p(void 0), i == null || i(!1);
    },
    [i]
  ), v = B(
    async (E) => {
    ...
    return er(r["%comment_dateAtTime%"], {
      date: j,
      time: $
    });
  }, [t.date, r]), g = V(() => t.user, [t.user]), C = V(
    () => t.user.split(" ").map((E) => E[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = V(() => Po(t.contents), [t.contents]), T = V(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), z = !!t.conflictResolutionAction && !T, U = V(() => {
    if (o && c)
      return /* @__PURE__ */ u(vt, { children: [
        /* @__PURE__ */ u(
          Qe,
          {
            onClick: (E) => {
              E.stopPropagation(), d(!0), p($w(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Uw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Kw, { className: "tw:text-xs tw:font-medium", children: C }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            /* @__PURE__ */ a("p", { className: "tw:text-sm tw:font-medium", children: g }),
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (E) => {
                E.key === "Escape" ? (E.preventDefault(), E.stopPropagation(), m()) : Go(E) && (E.preventDefault(), E.stopPropagation(), xe(w) && v());
              },
              onKeyDown: (E) => {
        ...
        U && /* @__PURE__ */ u(He, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Qs, {}) }) }),
          /* @__PURE__ */ a(qe, { align: "end", children: U })
        ] })
      ]
    }
  );
...
function os({
  ...
  rootContentSlot: O,
  resolveActionSlot: D,
  spaceRootContentFromReplies: S = !1
}) {
  const [M, X] = _(zn), [k, et] = _(), [I, R] = _(), Y = o, [dt, nt] = _(!1), [ht, Et] = _(!1), [Q, wt] = _(!1), [ft, it] = _(!1), [Tt, re] = _(!1), [kt, Se] = _(z), [ke, Ft] = _(!1), _t = L(void 0), [Wt, pe] = _(/* @__PURE__ */ new Map());
  G(() => {
    let P = !0;
    return (async () => {
    ...
    let P = !0;
    if (!o) {
      it(!1), pe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Nt = C ? await C(l) : !1;
      P && it(Nt);
    })(), () => {
      P = !1;
    };
  ...
  G(() => {
    ...
    Mt.current === "idle" && (Mt.current = "pending"), ft ? Mt.current === "pending" && j !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    j !== s && (et(j), Mt.current = "auto-populated") : Mt.current === "auto-populated" && (et(void 0), Mt.current = "pending");
  }, [o, j, ft, s]);
  const pt = V(
    () => $ ?? e.filter((P) => !P.deleted),
    [$, e]
  );
  G(() => {
    let P = !0;
  ...
  const bt = V(() => pt[0], [pt]), he = L(null), ae = L(void 0), Ut = B(() => {
    var P;
    (P = ae.current) == null || P.call(ae), X(zn);
  }, []), Re = B(() => {
    const P = !kt;
    Se(P), Ft(!P), v == null || v(l, P);
  }, [kt, v, l]);
  G(() => {
    nt(!1);
  }, [o]), G(() => {
    if (o && !kt && !ke) {
      ...
      return _t.current = P, () => clearTimeout(P);
    }
    _t.current && (clearTimeout(_t.current), _t.current = void 0);
  }, [o, kt, ke, U, l, v]);
  const xt = V(
    () => ({
    ...
    const P = ma(s, r);
    return er(r["%comment_assigned_to%"], {
      assignedUser: P
    });
  }, [s, r]), $t = V(() => pt.slice(1), [pt]), mt = V(() => $t.length ?? 0, [$t.length]), _e = V(() => mt > 0, [mt]), A = V(() => dt || mt <= 2 ? $t : $t.slice(-2), [$t, mt, dt]), ct = V(() => dt || mt <= 2 ? 0 : mt - 2, [mt, dt]), ge = V(
    () => mt === 1 ? xt.singleReply : er(xt.multipleReplies, { count: mt }),
    [mt, xt]
  ), ne = V(
    () => ct === 1 ? xt.singleReply : er(xt.multipleReplies, { count: ct }),
    [ct, xt]
  );
  G(() => {
    !o && ht && _e && Et(!1);
  ...
  const ie = B(
    async (P) => {
      ...
      It && await p({ threadId: l, contents: It }) && Ut();
    },
    [
      Ut,
      M,
    ...
    async (P) => {
      const It = xe(M) ? Ra(M) : void 0, Nt = P.status ? P.assignedUser : k ?? P.assignedUser, Yt = await p({
        ...P,
        contents: It,
        assignedUser: Nt
      });
      return Yt && (Nt !== void 0 && R(Nt), It && Ut()), Yt;
    },
    [Ut, M, p, k]
  );
  ...
  const ce = /* @__PURE__ */ a(
    In,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: se,
      handleUpdateComment: h,
      handleDeleteComment: m,
      onEditingChange: Et,
      canEditOrDelete: (!ht && Wt.get(bt.id)) ?? !1,
      canUserResolveThread: Tt
    }
  );
  return /* @__PURE__ */ a(
    jw,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ u(Fw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            oe && /* @__PURE__ */ a(Hr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: oe }),
            /* @__PURE__ */ a(
              tt,
              {
                variant: "ghost",
            ...
            D === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: Tt && w !== "Resolved",
                  onClick: () => se({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(vt, { children: [
          _e && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          o && /* @__PURE__ */ u(vt, { children: [
            S && A.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ct > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (P) => {
                  P.stopPropagation(), nt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (P) => {
                  (P.key === "Enter" || P.key === " ") && (P.preventDefault(), P.stopPropagation(), nt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(qr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: ne }),
                    dt ? /* @__PURE__ */ a(Jn, {}) : /* @__PURE__ */ a(pr, {})
                  ] })
                ]
              }
            ),
            A.map((P) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              In,
              {
                comment: P,
                localizedStrings: r,
                ...
                handleDeleteComment: m,
                onEditingChange: Et,
                canEditOrDelete: (!ht && Wt.get(P.id)) ?? !1
              }
            ) }, P.id)),
            g !== !1 && (!ht || xe(M)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (P) => {
                  Go(P) && (P.preventDefault(), P.stopPropagation(), (xe(M) || k !== void 0 && k !== I) && ie());
                },
                onKeyDown: (P) => {
                  qo(P), (P.key === "Enter" || P.key === " ") && P.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Sa,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    k !== void 0 && (xe(M) || k !== I) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: er(
                    ...
                    /* @__PURE__ */ u(fr, { open: Q, onOpenChange: wt, children: [
                      /* @__PURE__ */ a(zr, { asChild: !0, children: /* @__PURE__ */ a(
                        tt,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !ft || !f || f.length === 0 || !f.includes(i),
                      ...
                      /* @__PURE__ */ a(
                        mr,
                        {
                          ...
                          align: "end",
                          onKeyDown: (P) => {
                            P.key === "Escape" && (P.stopPropagation(), wt(!1));
                          },
                          children: /* @__PURE__ */ a(vr, { children: /* @__PURE__ */ a(br, { children: f == null ? void 0 : f.map((P) => /* @__PURE__ */ a(
                            ir,
                            {
                              onSelect: () => {
                                et(P !== s ? P : void 0), Mt.current = "user-selected", R(void 0), wt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: ma(P, r) })
                            },
                            P || "unassigned"
                          )) }) })
                        }
...
), qw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), va = (t) => qw(Po(t));
function ba({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Gw({
  ...
  const [i, c] = _("accept"), l = Na(), d = Na(), w = r === "loading", p = r === "accept", h = r === "none", m = r === "acceptRejectOrMerge", v = p ? "accept" : i, f = V(
    () => va(t.rejectedText ?? ""),
    [t.rejectedText]
  ), g = V(
    () => va(t.acceptedText ?? ""),
  ...
  }, z = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", U = m ? [
    {
      value: "merge",
  ...
  const D = e["%conflict_note_no_result%"] ?? "No result preview available.", S = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: D }), M = (I) => I ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: I }) : S, X = () => {
    const I = o ?? "accept";
    return I === "merged" ? t.mergedText ? /* @__PURE__ */ a(ba, { html: C }) : S : M(I === "reject" ? t.rejectedResultText : t.resultText);
  }, k = (I) => p && I.value === "reject", et = (I) => {
    const R = v === I.value, Y = `${d}-${I.value}`, dt = k(I);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          className: x(
            ...
            dt ? "tw:cursor-not-allowed tw:opacity-60" : "tw:cursor-pointer"
          ),
          children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              /* @__PURE__ */ a(
                ya,
                {
                  ...
                  "aria-label": I.label,
                  disabled: dt,
                  "aria-describedby": dt ? l : void 0
                }
              ),
              /* @__PURE__ */ a("span", { "aria-hidden": !0, className: "tw:font-medium", children: I.label })
            ] }),
            dt && // aria-describedby links the option to this visually-hidden notice so assistive tech
      ...
      !w && !h && /* @__PURE__ */ u(vt, { children: [
        ...
        /* @__PURE__ */ a(
          To,
          {
            ...
            children: E.map((I) => k(I) ? /* @__PURE__ */ a(At, { delayDuration: 0, children: /* @__PURE__ */ u(Rt, { children: [
              /* @__PURE__ */ a(Dt, { asChild: !0, children: et(I) }),
              /* @__PURE__ */ a(Ot, { children: z })
            ] }) }, I.value) : et(I))
          }
        ),
        /* @__PURE__ */ a(At, { delayDuration: 0, children: /* @__PURE__ */ u(Rt, { children: [
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return rs(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function Jw(t) {
  ...
  } = t, c = V(() => e.filter((C) => !C.deleted), [e]), l = V(
    () => c.find((C) => C.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: m } = Zw({
    threadId: n,
    threadStatus: s,
    isSelected: o,
    activeComments: c,
...
function Oh({
  ...
  const [y, T] = _(/* @__PURE__ */ new Set()), [z, U] = _(), [E, j] = _(), $ = B(
    async (R) => {
      const Y = await s(R);
  ...
  G(() => {
    v && (T((R) => new Set(R).add(v)), U(v));
  }, [v]);
  const O = r.filter(
    (R) => R.comments.some((Y) => !Y.deleted)
  ), D = O.map((R) => ({ id: R.id })), S = B(
    (R) => {
      T((Y) => new Set(Y).add(R.id)), U(R.id), f == null || f(R.id);
    },
    [f]
  ), M = B(
    (R) => {
    ...
    [y, f]
  ), { listboxRef: X, activeId: k, handleKeyDown: et } = Ts({
    options: D,
    onOptionSelect: S
  }), I = B(
    (R) => {
      R.key === "Escape" ? (z && y.has(z) && (T((Y) => {
        const dt = new Set(Y);
        return dt.delete(z), dt;
      ...
      children: O.map((R) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: R.type === "Conflict" ? /* @__PURE__ */ a(Jw, { ...Y, conflictResolution: C }) : /* @__PURE__ */ a(os, { ...Y })
          },
          R.id
        );
      })
...
function Qw({ table: t }) {
  return /* @__PURE__ */ u(He, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(tt, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(rc, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(qe, { align: "end", className: "tw:w-[150px]", children: [
      /* @__PURE__ */ a(gr, { children: "Toggle columns" }),
      /* @__PURE__ */ a(ur, {}),
...
function Mr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    ee.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(ee.Icon, { asChild: !0, children: /* @__PURE__ */ a(li, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Ee({
  ...
  return /* @__PURE__ */ u(
    ee.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(ee.ItemIndicator, { children: /* @__PURE__ */ a(Aa, { className: "tw:pointer-events-none" }) }) }),
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ u(
        Dr,
        {
          ...
          children: [
            /* @__PURE__ */ a(Mr, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(Or, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(Ir, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(Ee, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function ou({
  ...
  var E;
  const [w, p] = _([]), [h, m] = _([]), [v, f] = _({}), [g, C] = _({}), y = V(() => e ?? [], [e]), T = _i({
    data: y,
    columns: t,
    getCoreRowModel: Ci(),
  ...
  }), z = T.getVisibleFlatColumns();
  let U;
  return l ? U = Array.from({ length: 10 }).map((O, D) => `skeleton-row-${D}`).map((O) => /* @__PURE__ */ a(tr, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Er, { colSpan: z.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Cr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, O)) : ((E = T.getRowModel().rows) == null ? void 0 : E.length) > 0 ? U = T.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    tr,
    {
      onClick: () => i(j, T),
      "data-state": j.getIsSelected() && "selected",
      children: j.getVisibleCells().map(($) => /* @__PURE__ */ a(Er, { children: Fr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    j.id
  )) : U = /* @__PURE__ */ a(tr, { children: /* @__PURE__ */ a(Er, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Qw, { table: T }),
    /* @__PURE__ */ u(Ro, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Do, { stickyHeader: s, children: T.getHeaderGroups().map((j) => /* @__PURE__ */ a(tr, { children: j.headers.map(($) => /* @__PURE__ */ a(ka, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : Fr($.column.columnDef.header, $.getContext()) }, $.id)) }, j.id)) }),
      /* @__PURE__ */ a(Oo, { children: U })
    ] }),
...
function Ah({
  ...
  return /* @__PURE__ */ u(fr, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(zr, { asChild: !0, children: o }),
    /* @__PURE__ */ u(mr, { id: s, className: x("tw:min-w-80 tw:max-w-96", n), children: [
...
function $h({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(He, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(tt, { variant: "default", children: [
      /* @__PURE__ */ a(sc, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(pr, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(qe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(gr, { children: d.label }),
      /* @__PURE__ */ a(qn, { children: d.itemType === 0 ? /* @__PURE__ */ a(vt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        rr,
        {
          checked: o[w][h],
        ...
        Ss,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Rs, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(ur, {})
    ] }, d.label)) })
...
function Lh({
  ...
  const i = V(() => Dc(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(Oc(), { type: "language" });
...
const lu = ["marker", "note-category", "note-placeholder"];
function du(t, e) {
  let r = t.parentElement;
  for (; r && r !== e; ) {
    const { classList: o } = r;
    if (lu.some((n) => o.contains(n))) return !0;
    r = r.parentElement;
  }
  return !1;
}
...
function uu(t, e, r) {
  ...
  if (n.nodeType === Node.ELEMENT_NODE) {
    const d = n.childNodes[s], w = d ? wu(d) : void 0;
    if (!w) return "end";
    n = w, s = 0;
  }
    ...
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
      ...
      /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(vt, { children: [
          " ",
          /* @__PURE__ */ a(wo, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(Eo, {}),
    e && /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(
        tt,
        {
          "aria-label": w,
      ...
      /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(vt, { children: [
          " ",
          /* @__PURE__ */ a(wo, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
  ...
  return G(() => {
    ...
    const s = So(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      ...
      if (s) {
        ...
        if (!d.ctrlKey) return;
        !d.shiftKey && w === "z" ? (d.preventDefault(), r && ((m = e.current) == null || m.undo())) : (w === "y" || d.shiftKey && w === "z") && (d.preventDefault(), o && ((v = e.current) == null || v.redo()));
      }
    };
    return document.addEventListener("keydown", c), () => document.removeEventListener("keydown", c);
  }, [o, r, e]), /* @__PURE__ */ a("div", { ref: n, children: t });
}
const fu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(vt, { children: [
...
function mu({
  ...
  const n = L(null), s = L(null), i = L(!1), [c, l] = _(t), [d, w] = _(e), [p, h] = _(!1), m = L(!1), v = L(c);
  v.current = c;
  const f = L(d);
  f.current = d, G(() => {
    l(t);
  ...
  const g = (y) => {
    if (i.current = !1, h(y), !y) {
      const T = v.current, z = f.current;
      T !== "custom" || z ? (T !== t || z !== e) && r(T, z) : (l(t), w(e));
    }
  }, C = (y) => {
    var T, z, U, E;
    y.stopPropagation(), document.activeElement === s.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((T = n.current) == null || T.focus(), i.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((z = s.current) == null || z.focus(), i.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && ((U = n.current) == null ? void 0 : U.selectionStart) === 0 && ((E = s.current) == null || E.focus(), i.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && g(!1);
  };
  return /* @__PURE__ */ u(He, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: fu(t, o, e) }) }) }),
      /* @__PURE__ */ a(Ot, { children: o["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      qe,
      {
        ...
        children: [
          /* @__PURE__ */ a(gr, { children: o["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(ur, {}),
          /* @__PURE__ */ a(
            rr,
            {
          ...
          /* @__PURE__ */ a(
            rr,
            {
              ...
              onClick: (y) => {
                var T;
                if (y.stopPropagation(), m.current && y.target !== n.current) {
                  g(!1);
                  return;
                }
                i.current = !0, (T = n.current) == null || T.focus();
              },
...
const vu = (t, e) => t === "f" ? /* @__PURE__ */ u(vt, { children: [
  /* @__PURE__ */ a(ai, {}),
  " ",
  ...
  return t === "f" && (r = e["%footnoteEditor_noteType_footnote_label%"]), er(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: r
  });
};
function xu({
  ...
  return /* @__PURE__ */ u(He, { children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: vu(t, r) }) }) }),
      /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ a("p", { children: bu(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(qe, { style: { zIndex: Gn }, children: [
      /* @__PURE__ */ a(gr, { children: r["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ a(ur, {}),
      /* @__PURE__ */ u(
        rr,
        {
...
function ku({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? pc, { className: e, size: 16 });
}
function _u({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: t !== "none" && /* @__PURE__ */ a(or, { size: 16 })
    }
  );
}
function $n({
  ...
  return /* @__PURE__ */ u(
    ir,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(_u, { state: t.selectionState }),
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(ku, { icon: t.icon }) }) }),
...
function Nu({
  ...
  return /* @__PURE__ */ u(vr, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      Oa,
      {
    ...
    /* @__PURE__ */ u(br, { children: [
      ...
      /* @__PURE__ */ a(ar, { children: i.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          $n,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(vt, { children: [
        ...
        /* @__PURE__ */ a(ar, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            $n,
            {
...
const Ru = 300, Du = ".typeahead-popover", ao = "*", Ou = {
  type: "USJ",
  version: "3.1",
  content: [
    {
...
function jh({
  ...
  var Be;
  const f = L(null), g = L(null), C = L(null), y = L(null), T = L(s);
  G(() => {
    T.current = s;
  }, [s]);
  const z = L(h);
  ...
  const U = B(() => {
    var K, Z;
    const N = z.current;
    N !== void 0 && N !== "end" ? (K = f.current) == null || K.selectNoteTextOffset(0, N.utf16Offset) : (Z = f.current) == null || Z.selectNote(0);
  }, []);
  Zt(() => {
    if (w || !y.current) return;
    const { width: N } = y.current.getBoundingClientRect();
    N > 0 && (y.current.style.width = `${N}px`);
  }, [w]);
  const [E, j] = _("generated"), [$, O] = _("generated"), [D, S] = _(ao), [M, X] = _(ao), [k, et] = _("f"), [I, R] = _(!1), [Y, dt] = _(!0), [nt, ht] = _(!1), Et = L(!1), Q = L(""), wt = L(!1), ft = L(void 0), [it, Tt] = _(!1), [re, kt] = _(), [Se, ke] = _(), [Ft, _t] = _(), [Wt, pe] = _(), Mt = L(null), pt = L(
    void 0
  ), bt = L(0), he = L(m);
  G(() => {
    he.current = m;
    ...
    () => () => {
      var N;
      pt.current && (pt.current = void 0, (N = he.current) == null || N.dismiss());
    },
    []
  );
  const ae = L(void 0), Ut = V(
    () => ({
      ...i,
  ...
  G(() => {
    var N;
    it || (N = f.current) == null || N.focus();
  }, [k, it]);
  const xt = B(() => {
    var J, q, W;
    const N = (J = g.current) == null ? void 0 : J.querySelector(".editor-input"), K = N == null ? void 0 : N.querySelector("span.note"), Z = (W = (q = g.current) == null ? void 0 : q.ownerDocument.getSelection()) == null ? void 0 : W.anchorNode;
    return !!K && !!Z && K.contains(Z);
  }, []), oe = B(
    (N = !1) => {
      var Z, J, q;
      v == null || v();
      const K = (J = (Z = f.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : J.at(0);
      if (K && $r("note", K) && (r == null || r([K]), N && d && T.current)) {
        if (w && ii(K, ft.current)) return;
        ft.current = K, (q = d.current) == null || q.replaceEmbedUpdate(T.current, [K]);
      }
    },
    [w, r, v, d]
  ), $t = B(
    (N, K) => {
      var q, W, rt, st;
      pt.current || (q = f.current) == null || q.commitPendingMarkerEdits();
      const Z = (rt = (W = f.current) == null ? void 0 : W.getNoteOps(0)) == null ? void 0 : rt.at(0);
      if (!Z || !$r("note", Z) || !Z.insert.note) return;
      let J;
      N === "custom" ? J = K : N === "generated" ? J = ho : J = go, Z.insert.note.caller !== J && (Z.insert.note.caller = J, (st = f.current) == null || st.applyUpdate([Z, { delete: 1 }]));
    },
    []
  ), mt = L(void 0), _e = L(oe);
  G(() => {
  ...
  const A = B(() => {
    mt.current !== void 0 && (clearTimeout(mt.current), mt.current = void 0);
  }, []), ct = B(() => {
    mt.current !== void 0 && (A(), _e.current(!0));
  }, [A]), ge = B(() => {
    A(), mt.current = setTimeout(() => {
      mt.current = void 0, _e.current(!0);
    }, Ru);
  }, [A]);
  G(() => {
    var q, W;
    let N, K, Z;
    Et.current = !1, wt.current = !1, ae.current = void 0, dt(!0);
    const J = e == null ? void 0 : e.at(0);
    if (ft.current = J, J && $r("note", J)) {
      const rt = (q = J.insert.note) == null ? void 0 : q.caller;
      let st = "custom";
      rt === ho ? st = "generated" : rt === go && (st = "hidden");
      const lt = st === "custom" && rt ? rt : ao;
      S(lt), X(lt), j(st), O(st), et(((W = J.insert.note) == null ? void 0 : W.style) ?? "f"), N = setTimeout(() => {
        var yt, Vt, Lt, yr;
        const St = (Vt = (yt = f.current) == null ? void 0 : yt.getNoteOps(0)) == null ? void 0 : Vt.at(0);
        (Lt = f.current) == null || Lt.applyUpdate(St ? [J, { delete: 1 }] : [J]), U(), (yr = f.current) == null || yr.focus(), K = requestAnimationFrame(() => {
          Z = setTimeout(() => {
            var lr;
            xt() || (U(), (lr = f.current) == null || lr.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      ct(), z.current = void 0, N && clearTimeout(N), K !== void 0 && cancelAnimationFrame(K), Z !== void 0 && clearTimeout(Z);
    };
  }, [e, ct, xt, U]), Zt(() => () => ct(), [ct]);
  const ne = B(() => {
    var N;
    wt.current && (pt.current || (N = f.current) == null || N.commitPendingMarkerEdits(), ct());
  }, [ct]);
  si(
    p,
    () => ({
      flushPendingEdits: ne,
      focus: () => {
        var N;
  ...
  const ie = B(() => {
    var N, K;
    if (!pt.current) {
      const Z = (N = g.current) == null ? void 0 : N.querySelector(".editor-input");
      Z != null && Z.contains(Z.ownerDocument.activeElement) && Z.blur(), (K = f.current) == null || K.commitPendingMarkerEdits();
    }
    w ? ct() : (A(), oe(!0)), o();
  }, [A, ct, w, o, oe]), se = L(ie);
  Zt(() => {
  ...
  const ce = L({ book: n.book, chapterNum: n.chapterNum });
  Zt(() => {
    (ce.current.book !== n.book || ce.current.chapterNum !== n.chapterNum) && (ce.current = { book: n.book, chapterNum: n.chapterNum }, se.current());
  }, [n.book, n.chapterNum]);
  const P = () => {
    var K;
    const N = (K = g.current) == null ? void 0 : K.getElementsByClassName("editor-input")[0];
    N != null && N.textContent && navigator.clipboard.writeText(N.textContent);
  }, It = B(
    (N, K) => {
      v == null || v(), j(N), S(K), $t(N, K), w && ct();
    },
    [$t, ct, w, v]
  ), Nt = (N) => {
    var Z, J, q, W, rt, st;
    et(N), pt.current || (Z = f.current) == null || Z.commitPendingMarkerEdits();
    const K = (q = (J = f.current) == null ? void 0 : J.getNoteOps(0)) == null ? void 0 : q.at(0);
    if (K && $r("note", K)) {
      K.insert.note && (K.insert.note.style = N);
      const lt = (rt = (W = K.insert.note) == null ? void 0 : W.contents) == null ? void 0 : rt.ops;
      k !== "x" && N === "x" ? lt == null || lt.forEach((St) => Tu(St)) : k === "x" && N !== "x" && (lt == null || lt.forEach((St) => Su(St))), (st = f.current) == null || st.applyUpdate([K, { delete: 1 }]), w && ct();
    }
  }, Yt = (N) => {
    pe(N.contextMarker), ht(N.canRedo);
  }, fe = B(
    (N) => {
      var Z, J, q, W, rt;
      const K = (J = (Z = f.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : J.at(0);
      if (K && $r("note", K)) {
        ...
        const st = (q = K.insert.note) == null ? void 0 : q.style, lt = (rt = (W = K.insert.note) == null ? void 0 : W.contents) == null ? void 0 : rt.ops;
        if (st || R(!1), R(
          st === "x" ? !!(lt != null && lt.every((St) => {
            var Vt, Lt;
            if (!((Vt = St.attributes) != null && Vt.char)) return !0;
            const yt = ((Lt = St.attributes) == null ? void 0 : Lt.char).style;
          ...
          Et.current = !0, Q.current = JSON.stringify(K), dt(!0);
          return;
        }
        wt.current = !0, dt(JSON.stringify(K) === Q.current), oe(), w && ge();
      } else
        R(!1), dt(!0);
    },
    [w, oe, ge]
    ...
    if (C.current && Re.length && N && N.rangeCount > 0) {
      const K = N.getRangeAt(0).getBoundingClientRect(), Z = C.current.getBoundingClientRect();
      kt(K.left - Z.left), ke(K.top - Z.top), _t(K.height), Tt(!0);
    }
  }, [Re, C]), De = L(() => {
  }), cr = B(
    (N, K, Z) => {
      const { anchorRect: J } = N;
      if (!m || !J) return;
      const { passive: q } = Z;
      Is({
        items: K,
        ...
        sessionCounterRef: bt,
        setSession: (W) => {
          pt.current = W;
        },
        clearSessionIfCurrent: (W) => Qo(pt, W),
        ...
        restoreSelectionIfLost: () => {
          var W, rt, st;
          if (!((W = f.current) != null && W.getSelection())) {
            const lt = ae.current;
            lt ? (rt = f.current) == null || rt.setSelection(lt) : (st = f.current) == null || st.selectNote(0);
          }
        },
        focusEditor: () => {
          var W;
        ...
        applyItem: (W) => {
          var rt;
          return (rt = f.current) == null ? void 0 : rt.applyMarkerMenuSelection(W, {
            trigger: "backslash",
        ...
        onShowError: (W) => {
          (!Mc(W) || W.code !== Ic) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${zc(W)}`
          );
        }
      });
    },
    ...
    var Z;
    const N = (Z = f.current) == null ? void 0 : Z.getMarkerMenuContext();
    if (!N) return !1;
    const K = Xl(Ut.styleInfo ?? Zl, N);
    return K.length === 0 ? !1 : (cr(N, K, { passive: !N.hasTextSelection }), !0);
  }, [cr, Ut.styleInfo]), We = B(
    (N) => {
      const K = pt.current;
      if (!K || !m) return;
      zs(N, K, {
        ...
        commitTyped: (J) => {
          var q;
          return (q = f.current) == null ? void 0 : q.commitTypedMarker(J);
        },
        commitTypedAndReopen: (J) => {
          var q;
          (q = f.current) == null || q.commitTypedMarker(J, { trailingSpace: !1 }), Oe();
        },
        commitTypedCloser: (J) => {
          var q;
          return (q = f.current) == null ? void 0 : q.commitTypedCloser(J);
        },
        commitItem: (J) => {
          var W;
          const q = K.items.find((rt) => rt.marker === J);
          q && ((W = f.current) == null || W.applyMarkerMenuSelection(q, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  G(() => {
    ...
    const N = (K) => {
      var q, W;
      const Z = (q = g.current) == null ? void 0 : q.querySelector(".editor-input");
    ...
    var N;
    it && ((N = Mt.current) == null || N.focus());
  }, [it]), G(() => {
    var J;
    const N = () => {
      var q;
      return ((q = g.current) == null ? void 0 : q.querySelector(".editor-input")) ?? void 0;
    }, K = (q) => {
      var W;
      return w && q.key === "Escape" && !!((W = y.current) != null && W.contains(document.activeElement)) && !document.querySelector(Du);
    };
    if (((J = Ut.view) == null ? void 0 : J.markerMode) === "editable") {
      const q = (rt) => {
        var St, yt, Vt, Lt;
        if (As(rt)) return;
        const st = pt.current;
        if (!st && K(rt)) {
          rt.preventDefault(), rt.stopPropagation(), se.current();
          return;
        }
        const lt = N();
        if (!(!lt || document.activeElement !== lt)) {
          if (st && m) {
            De.current(rt);
            return;
          }
          if (rt.key === "Enter" && !xt()) {
            rt.preventDefault(), rt.stopPropagation(), (St = f.current) == null || St.selectNote(0), (yt = f.current) == null || yt.focus();
            return;
          }
          if (m && rt.key === c) {
            if (!xt()) {
              rt.preventDefault(), rt.stopPropagation(), (Vt = f.current) == null || Vt.selectNote(0), (Lt = f.current) == null || Lt.focus();
              return;
            }
            Oe() && (rt.preventDefault(), rt.stopPropagation());
          }
        }
      }, W = () => {
        var st, lt;
        const rt = N();
        !rt || document.activeElement !== rt || xt() || ((st = f.current) == null || st.selectNote(0), (lt = f.current) == null || lt.focus());
      };
      return document.addEventListener("keydown", q, { capture: !0 }), document.addEventListener("paste", W, { capture: !0 }), () => {
        document.removeEventListener("keydown", q, { capture: !0 }), document.removeEventListener("paste", W, { capture: !0 });
      };
    }
    const Z = (q) => {
      const W = N();
      !it && W && document.activeElement === W && q.key === c ? (q.preventDefault(), me()) : it && q.key === "Escape" ? (q.preventDefault(), Tt(!1)) : K(q) && (q.preventDefault(), se.current());
    };
    ...
    me,
    c,
    (Be = Ut.view) == null ? void 0 : Be.markerMode,
    Ut.styleInfo,
    m,
    Oe,
    xt
    ...
    const N = () => {
      var J, q, W;
      const K = ((J = g.current) == null ? void 0 : J.querySelector(".editor-input")) ?? void 0;
      if (!K || document.activeElement !== K) return;
      const Z = document.getSelection();
      Z && !Z.isCollapsed || xt() || ((q = f.current) == null || q.selectNote(0), (W = f.current) == null || W.focus());
    };
  ...
  return /* @__PURE__ */ u(vt, { children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ u("div", { className: "tw:flex", children: [
            ...
            !w && /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(Ma, { children: [
              Xe,
              /* @__PURE__ */ a(
                Qi,
                {
          ...
          /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:end-0", children: /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
                  /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      "aria-label": Ye,
                  ...
                  /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ a("p", { children: Ye }) })
                ] }) }) })
              ]
            }
          )
    ...
    /* @__PURE__ */ u(fr, { open: it, children: [
      /* @__PURE__ */ a(
        Ps,
        {
          className: "tw:absolute",
...
function zu(t, e, r = !0, o = void 0, n = void 0) {
  const s = [];
  let i = [];
  (e ?? []).forEach((l) => {
  ...
  return c || s.push([]), s.map((l, d) => {
    ...
    return (
      ...
      /* @__PURE__ */ u("p", { className: "notetext", children: [
        w && !c && /* @__PURE__ */ a("span", { className: "note-placeholder", children: Mu }),
        w && n,
        is(t, l, r),
        p && o
      ] }, `${t ?? "note"}-p${d}`)
...
function is(t, e, r = !0, o = !1) {
  if (!(!e || e.length === 0))
    return e.map((n, s) => {
      const i = `${t ?? "note"}-${s}`;
      return typeof n == "string" ? /* @__PURE__ */ a("span", { className: x(`usfm_${t}`), children: n }, i) : Pu(n, i, r, o);
    });
}
function Pu(t, e, r, o = !1) {
  ...
  return /* @__PURE__ */ u("span", { children: [
    ...
    n && r && Iu(t) && /* @__PURE__ */ a("span", { className: "marker", children: `\\${s}*` })
  ] }, e);
}
function Au({
  footnote: t,
  ...
  /* @__PURE__ */ a("span", { className: x("note-caller tw:inline-block", { formatted: s }), children: n }), w = e === "horizontal" ? "horizontal" : "vertical", p = o ? "marker-visible" : "", h = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", m = x(w, p);
  return /* @__PURE__ */ u(vt, { children: [
...
function Uh({
  ...
  renderEditingFootnote: v
}) {
  const f = w ?? Pc(o, void 0), g = v ? m : void 0, C = L([]), y = (S, M, X) => {
    if (h) {
      const k = C.current[M], et = k ? uu(X.clientX, X.clientY, k) : "end";
      h(S, M, s, et);
      return;
    }
    p == null || p(S, M, s);
  }, T = i ? o.findIndex((S) => S === i) : -1, [z, U] = _(T), E = (S) => {
    var M;
    U(S), S >= 0 && S < C.current.length && ((M = C.current[S]) == null || M.focus());
  }, j = (S, M, X) => {
    if (o.length)
      switch (S.key) {
        case "Enter":
          S.preventDefault(), h ? h(M, X, s, "end") : p == null || p(M, X, s);
          break;
        case " ":
          S.preventDefault(), p == null || p(M, X, s);
          break;
      }
  }, $ = o.length - 1, O = (S) => {
    if (o.length && !(S.target !== S.currentTarget && !(S.target instanceof HTMLElement && S.target.closest('li[role="option"]'))))
      switch (S.key) {
        case "ArrowDown":
          S.preventDefault(), E(da(z, 1, $, g));
          break;
        case "ArrowUp":
          S.preventDefault(), E(da(z, -1, $, g));
          break;
  ...
  const D = i ? o.findIndex((S) => S === i) : -1;
  return G(() => {
    var S;
    D < 0 || D >= C.current.length || (S = C.current[D]) == null || S.scrollIntoView({ block: "nearest" });
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ a(
        "ul",
        {
          ...
          children: o.map((S, M) => {
            const X = S === i, k = M === m && !!v, et = k ? $u : `${s}-${M}`, I = M < o.length - 1 && n === "vertical" && /* @__PURE__ */ a(qr, { tabIndex: -1, className: "tw:col-span-2" });
            return k ? /* @__PURE__ */ u(hr, { children: [
              /* @__PURE__ */ a(
                "li",
                {
                  "data-state": "editing",
...
function Lu({
  ...
  return /* @__PURE__ */ u(Ro, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Do, { stickyHeader: !0, children: /* @__PURE__ */ u(tr, { children: [
    ...
    /* @__PURE__ */ a(Oo, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      tr,
      {
        ...
        children: [
          /* @__PURE__ */ a(Er, { children: Fe(c.reference, "English") }),
          /* @__PURE__ */ a(Er, { className: o, children: Vu(c.text) })
        ]
      },
...
}, La = (t, e, r) => /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
  /* @__PURE__ */ u(
    Dt,
    {
...
function Zh({
  ...
  const m = Me(r, "%webView_inventory_all%"), v = Me(r, "%webView_inventory_approved%"), f = Me(r, "%webView_inventory_unapproved%"), g = Me(r, "%webView_inventory_unknown%"), C = Me(r, "%webView_inventory_scope_currentBook%"), y = Me(r, "%webView_inventory_scope_chapter%"), T = Me(r, "%webView_inventory_scope_verse%"), z = Me(r, "%webView_inventory_filter_text%"), U = Me(
    r,
    "%webView_inventory_show_additional_items%"
  ), E = Me(r, "%webView_inventory_no_results%"), [j, $] = _(!1), [O, D] = _("all"), [S, M] = _(""), [X, k] = _([]), et = V(() => {
    const Q = t ?? [];
    return Q.length === 0 ? [] : Ku(Q, n, s);
  }, [t, n, s]), I = V(() => {
    if (j) return et;
    const Q = [];
    return et.forEach((wt) => {
      const ft = wt.items[0], it = Q.find(
        (Tt) => Tt.items[0] === ft
      );
      it ? (it.count += wt.count, it.occurrences = it.occurrences.concat(wt.occurrences)) : Q.push({
        items: [ft],
        count: wt.count,
  ...
  }, [j, et]), R = V(() => I.length === 0 ? [] : Uu(I, O, S), [I, O, S]), Y = V(() => {
    var ft, it;
    if (!j) return l;
    ...
    for (let Tt = 0; Tt < Q; Tt++)
      wt.push(
        ju(
          ((it = o == null ? void 0 : o.tableHeaders) == null ? void 0 : it[Tt]) || "Additional Item",
          Tt + 1
        )
      );
    return [...wt, ...l];
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        Dr,
        {
          onValueChange: (Q) => ht(Q),
          defaultValue: O,
          children: [
            /* @__PURE__ */ a(Mr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(Or, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(Ir, { children: [
              /* @__PURE__ */ a(Ee, { value: "all", children: m }),
              /* @__PURE__ */ a(Ee, { value: "approved", children: v }),
              /* @__PURE__ */ a(Ee, { value: "unapproved", children: f }),
              /* @__PURE__ */ a(Ee, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(Dr, { onValueChange: (Q) => nt(Q), defaultValue: i, children: [
        /* @__PURE__ */ a(Mr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(Or, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(Ir, { children: [
          /* @__PURE__ */ a(Ee, { value: "book", children: C }),
          /* @__PURE__ */ a(Ee, { value: "chapter", children: y }),
          /* @__PURE__ */ a(Ee, { value: "verse", children: T })
        ] })
      ] }),
      /* @__PURE__ */ a(
        za,
      ...
      o && /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
        ...
        /* @__PURE__ */ a(Ot, { children: (o == null ? void 0 : o.checkboxText) ?? U })
      ] }) })
    ] }),
    ...
    Et.length > 0 && /* @__PURE__ */ a("div", { className: "tw:m-1 tw:flex-1 tw:overflow-auto tw:rounded-md tw:border", children: /* @__PURE__ */ a(
      Lu,
      {
        classNameForText: p,
        occurrenceData: Et,
...
const Hu = "16rem", qu = "3rem", cs = we.createContext(void 0);
function Ba() {
  const t = we.useContext(cs);
  if (!t)
...
function Gu({
  ...
  const [l, d] = we.useState(t), w = e ?? l, p = we.useCallback(
    (T) => {
      const z = typeof T == "function" ? T(w) : T;
      r ? r(z) : d(z);
    },
    [r, w]
  ), h = we.useCallback(() => p((T) => !T), [p]), m = w ? "expanded" : "collapsed", g = $e() === "ltr" ? i : i === "primary" ? "secondary" : "primary", C = we.useMemo(
    () => ({
      state: m,
      open: w,
      setOpen: p,
...
function tp({
  ...
  const c = t ? Jr.Root : "button", { state: l } = Ba(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: x(Qu({ variant: r, size: o }), s),
      ...i
    }
  );
...
function ep({
  ...
  const p = B(
    ...
    (g) => {
      const C = r.find((y) => y.projectId === g);
    ...
    return l && (g.searchPlaceholder = l), d && (g.commandEmptyMessage = d), g;
  }, [c, i, l, d]), f = B(
  ...
  return /* @__PURE__ */ a(
    Wu,
    {
      ...
      children: /* @__PURE__ */ u(Xu, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          /* @__PURE__ */ a(Ln, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Zu, { children: Object.entries(e).map(([g, C]) => /* @__PURE__ */ a(Ju, { children: /* @__PURE__ */ a(
            tp,
            {
              onClick: () => p(g),
              isActive: f(g),
    ...
    /* @__PURE__ */ u(
      Gu,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Yu, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
}
const Ze = "scrBook", rp = "scrRef", wr = "source", ap = "details", op = "Scripture Reference", np = "Scripture Book", ls = "Type", ip = "Details";
function sp(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Ze,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? op,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? qt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ze ? Fe(n.start) : void 0;
      },
      getGroupingValue: (o) => qt.bookIdToNumber(o.start.book),
    ...
    },
    {
      ...
      id: ap,
      header: (t == null ? void 0 : t.detailsColumnName) ?? ip,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
const cp = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || _a(t.start, t.end) === 0 ? `${Ha(t.start)}+${e}` : `${Ha(t.start)}+${e}-${Ha(t.end)}+${r}`;
}, jn = (t) => `${cp({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ug({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Ze, desc: !1 }]), [m, v] = _({}), f = V(
  ...
  G(() => {
    if (c) {
      ...
      if (D.length === 1) {
        const S = f.find((M) => jn(M) === D[0]) || void 0;
        S && c(S);
      }
    }
  }, [m, f, c, C]);
  const y = n ?? np, T = s ?? ls, z = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Ze] },
    { label: `Group by ${T}`, value: [wr] },
    {
  ...
  }, j = (O, D) => O.getIsGrouped() ? "" : x("banded-row", D % 2 === 0 ? "even" : "odd"), $ = (O, D, S) => {
    if (!((O == null ? void 0 : O.length) === 0 || D.depth < S.column.getGroupedIndex())) {
      if (D.getIsGrouped())
        switch (D.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      Dr,
      {
        ...
        children: [
          /* @__PURE__ */ a(Mr, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(Or, {}) }),
          /* @__PURE__ */ a(Ir, { position: "item-aligned", children: /* @__PURE__ */ a(tu, { children: z.map((O) => /* @__PURE__ */ a(Ee, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ro, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Do, { children: C.getHeaderGroups().map((O) => /* @__PURE__ */ a(tr, { children: O.headers.filter((D) => D.column.columnDef.header).map((D) => (
        ...
        /* @__PURE__ */ a(ka, { colSpan: D.colSpan, className: "tw:sticky top-0", children: D.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Fr(D.column.columnDef.header, D.getContext())
        ] }) }, D.id)
      )) }, O.id)) }),
      /* @__PURE__ */ a(Oo, { children: C.getRowModel().rows.map((O, D) => {
        const S = $e();
        return /* @__PURE__ */ a(
          tr,
          {
            ...
            children: O.getVisibleCells().map((M) => {
              if (!(M.getIsPlaceholder() || M.column.columnDef.enableGrouping && !M.getIsGrouped() && (M.column.columnDef.id !== wr || !r)))
                return /* @__PURE__ */ a(
                  Er,
                  {
                    className: x(
                    ...
                    children: M.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        type: "button",
                        children: [
                          O.getIsExpanded() && /* @__PURE__ */ a(pr, {}),
                          !O.getIsExpanded() && (S === "ltr" ? /* @__PURE__ */ a(yc, {}) : /* @__PURE__ */ a(kc, {})),
                          " ",
                          Fr(M.column.columnDef.cell, M.getContext()),
                          " (",
                          O.subRows.length,
                          ")"
                        ]
...
function lp({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: m, dcLong: v, extraLong: f } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [g, C] = _(!1), [y, T] = _(""), z = L(void 0), U = L(!1), E = V(
    () => Xn(t),
    [t]
  ), j = V(() => {
    if (!y.trim()) {
    ...
    (k, et = !1) => {
      if (!et || !z.current) {
        r(
          e.includes(k) ? e.filter((ht) => ht !== k) : [...e, k]
        ), z.current = k;
        return;
      }
      const I = E.findIndex((ht) => ht === z.current), R = E.findIndex((ht) => ht === k);
      if (I === -1 || R === -1) return;
      const [Y, dt] = [
        Math.min(I, R),
        Math.max(I, R)
      ], nt = E.slice(Y, dt + 1).map((ht) => ht);
      r(
        e.includes(k) ? e.filter((ht) => !nt.includes(ht)) : [.../* @__PURE__ */ new Set([...e, ...nt])]
      );
    },
    [e, r, E]
  ), O = (k) => {
    $(k, U.current), U.current = !1;
  }, D = (k, et) => {
    k.preventDefault(), $(et, k.shiftKey);
  }, S = () => {
    r(E.map((k) => k));
  }, M = () => {
    r([]);
    ...
    () => Object.values(zt).filter(
      (k) => (s == null ? void 0 : s[k]) !== void 0 && Mo(E, k).length === 0
          ...
          mr,
          {
            ...
            children: /* @__PURE__ */ u(
              vr,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (k) => {
                  k.key === "Enter" && (U.current = k.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    Oa,
                  ...
                  /* @__PURE__ */ u(br, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(Ia, { children: p }),
                    Object.values(zt).filter((k) => j[k].length > 0).map((k, et) => {
                      const I = j[k];
                      return /* @__PURE__ */ u(hr, { children: [
                        et > 0 && /* @__PURE__ */ a(Wn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          ar,
                          {
                            heading: Kn(k, h, m, v, f),
                  ...
                  X.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: X.map(({ section: k, explanation: et }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: et }, k)) })
                ]
              }
            )
          }
...
function wp({
  ...
  return /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(Rt, { children: [
    /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ a(
      dp,
      {
        className: o,
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === no ? no : Fn
      ).map((d) => /* @__PURE__ */ a(Hr, { className: "tw:hover:bg-secondary", variant: "secondary", children: je(d, n) }, d)),
...
function hg({
  ...
  const E = Ht(
    i,
    "%webView_scope_selector_selected_text%"
  ), j = Ht(i, "%webView_scope_selector_verse%"), $ = Ht(i, "%webView_scope_selector_chapter%"), O = Ht(i, "%webView_scope_selector_book%"), D = Ht(
    i,
    "%webView_scope_selector_current_verse%"
  ), S = Ht(
    i,
    "%webView_scope_selector_current_chapter%"
  ), M = Ht(i, "%webView_scope_selector_current_book%"), X = Ht(i, "%webView_scope_selector_choose_books%"), k = Ht(i, "%webView_scope_selector_scope%"), et = Ht(i, "%webView_scope_selector_select_books%"), I = Ht(i, "%webView_scope_selector_range%"), R = Ht(i, "%webView_scope_selector_select_range%"), Y = Ht(i, "%webView_scope_selector_range_start%"), dt = Ht(i, "%webView_scope_selector_range_end%"), nt = Ht(i, "%webView_scope_selector_ok%"), ht = Ht(i, "%webView_scope_selector_cancel%"), Et = Ht(i, "%webView_scope_selector_navigate%"), Q = (F) => {
    if (!g) return;
  ...
  ], ft = (F, at, Bt = !1) => /* @__PURE__ */ u(vt, { children: [
    F,
    at && !Bt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      at
    ] })
  ] }), it = e ? wt.filter((F) => e.includes(F.value)) : wt, Tt = g ?? qa, re = h ?? Tt, kt = m ?? Tt, Se = () => {
  }, ke = L(null), Ft = L(null), _t = L(!1), Wt = L(null), pe = L(!1), [Mt, pt] = _(void 0), bt = L(!1), he = L(!1), ae = L(null), Ut = B((F) => {
    if (F) {
      pt("start"), bt.current = !1;
      return;
    }
    pt((at) => at === "start" ? void 0 : at), bt.current && (bt.current = !1, requestAnimationFrame(() => {
      var Bt;
      const at = (Bt = ke.current) == null ? void 0 : Bt.querySelector("button");
      at == null || at.click();
    }));
  }, []), Re = B((F) => {
    if (F) {
    ...
    pt((at) => at === "end" ? void 0 : at);
  }, []), xt = B(
    (F) => {
      v == null || v(F), f == null || f(F), bt.current = !0;
    },
    [v, f]
  ), oe = B(
    (F) => {
      f == null || f(F), he.current = !0;
    },
    [f]
  ), $t = B(
    (F) => {
    ...
    [r, n, g, s]
  ), mt = it.find((F) => F.value === t), _e = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? Ac(re, kt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : mt ? ft(mt.label, mt.scrRefSuffix) : t, A = it.filter(
    (F) => F.value !== "selectedBooks" && F.value !== "range"
  ), ct = it.find((F) => F.value === "selectedBooks"), ge = it.find((F) => F.value === "range"), [ne, ie] = _(!1), [se, ce] = _(void 0), [P, It] = _(void 0), [Nt, Yt] = _(void 0), [fe, me] = _(void 0), [De, cr] = _([]), Oe = p === "dropdown" && se === "selectedBooks", We = /* @__PURE__ */ a(
    pp,
    {
      availableBookInfo: o,
      selectedBookIds: Oe ? De : n,
      onChangeSelectedBookIds: Oe ? cr : s,
      localizedStrings: i,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Ye = Mt === "end", Xe = Mt === "start", Be = "tw:text-muted-foreground", N = p === "dropdown" && se === "range", K = N ? Yt : xt, J = N ? me : f ? oe : Se, q = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { htmlFor: "scope-range-start", className: x(Ye && Be), children: Y }),
      /* @__PURE__ */ a(
        Wa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ke, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { htmlFor: "scope-range-end", className: x(Xe && Be), children: dt }),
      /* @__PURE__ */ a(
        Wa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: y,
          getEndVerse: T,
          disableReferencesUpTo: N ? Nt ?? re : re,
          onOpenChange: Re,
          onCloseAutoFocus: (F) => {
            var at;
            he.current && (he.current = !1, F.preventDefault(), (at = ae.current) == null || at.focus());
          },
          className: x(Xe && Be),
          modal: !0,
          align: "start"
  ...
  const [lt, St] = _(null), [yt, Vt] = _(null), [Lt, yr] = _(null), lr = 200, [ja, Qr] = _(!1);
  G(() => {
    if (!Lt || typeof ResizeObserver > "u") return;
    const F = new ResizeObserver(([at]) => {
      Qr(at.contentRect.width < lr);
    });
    return F.observe(Lt), () => F.disconnect();
  }, [Lt]);
  const ta = B(
    (F) => {
      It(F), Yt(re), me(kt), cr(n), ie(!1), ce(F);
    },
    [re, kt, n]
  ), ea = B(() => {
    P !== void 0 && (P === "range" ? (Nt && (v == null || v(Nt)), fe && (f == null || f(fe))) : P === "selectedBooks" && s(De), $t(P), ce(void 0), It(void 0));
  }, [
    P,
    Nt,
    fe,
    ...
    F || (ce(void 0), It(void 0));
  }, []), ra = B((F) => {
    var at;
    F.preventDefault(), (at = st.current) == null || at.focus();
  }, []), aa = (F) => t === F ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !z && /* @__PURE__ */ a(Pt, { children: k }),
      p === "dropdown" ? /* @__PURE__ */ u(He, { open: ne, onOpenChange: ie, children: [
        /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(
          tt,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: _e() }),
              /* @__PURE__ */ a(pr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          qe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Ua, { container: Lt, children: [
              A.map(({ value: F, label: at, dropdownLabel: Bt, scrRefSuffix: ve, id: Ne }) => {
                ...
                return /* @__PURE__ */ u(
                  Qe,
                  {
                    ...
                    children: [
                      t === F && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }),
                      /* @__PURE__ */ u("span", { className: "tw:flex tw:min-w-0 tw:flex-col tw:gap-0.5", children: [
                        /* @__PURE__ */ a("span", { className: "tw:flex tw:items-center tw:gap-1.5", children: ft(Bt ?? at, ve, ja) }),
              ...
              C && /* @__PURE__ */ u(vt, { children: [
                /* @__PURE__ */ a(ur, {}),
                /* @__PURE__ */ a(gr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Et }),
                /* @__PURE__ */ a(
                  Qe,
                  {
                    ref: Wt,
                    ...
                    onSelect: (F) => {
                      var at, Bt;
                      if (F.preventDefault(), _t.current) {
                        _t.current = !1;
                        return;
                      }
                      pe.current || (Bt = (at = Ft.current) == null ? void 0 : at.querySelector("button")) == null || Bt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          Wa,
                          {
                            ...
                            onCloseAutoFocus: (F) => {
                              var at;
                              F.preventDefault(), (at = Wt.current) == null || at.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(vt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Fe(g ?? qa, "id") }),
                              /* @__PURE__ */ a(pr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        To,
        {
          ...
          children: it.map(({ value: F, label: at, scrRefSuffix: Bt, id: ve }) => {
            const Ne = d == null ? void 0 : d[F];
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
                /* @__PURE__ */ a(
                  ya,
                  {
                    ...
                    id: ve,
                    disabled: !!Ne,
                    "aria-describedby": Ne ? `${ve}-explanation` : void 0
                  }
                ),
                /* @__PURE__ */ a(Pt, { htmlFor: ve, children: ft(at, Bt) })
              ] }),
    ...
    p === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { children: et }),
      We
    ] }),
    p === "radio" && t === "range" && q,
    p === "dropdown" && ct && /* @__PURE__ */ a(io, { open: se === "selectedBooks", onOpenChange: kr, children: /* @__PURE__ */ a(
      so,
      {
        ref: Vt,
        onCloseAutoFocus: ra,
        onEscapeKeyDown: (F) => {
          yt != null && yt.querySelector('[data-state="open"]') && F.preventDefault();
        },
        children: /* @__PURE__ */ u(Ua, { container: yt, children: [
          /* @__PURE__ */ a(co, { className: "tw:pe-8", children: /* @__PURE__ */ a(lo, { children: X }) }),
          We,
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => kr(!1), children: ht }),
            /* @__PURE__ */ a(tt, { onClick: ea, children: nt })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && ge && /* @__PURE__ */ a(io, { open: se === "range", onOpenChange: kr, children: /* @__PURE__ */ a(
      so,
      {
        ref: St,
        onCloseAutoFocus: ra,
        ...
        children: /* @__PURE__ */ u(Ua, { container: lt, children: [
          /* @__PURE__ */ a(co, { className: "tw:pe-8", children: /* @__PURE__ */ a(lo, { children: R }) }),
          q,
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => kr(!1), children: ht }),
            /* @__PURE__ */ a(tt, { ref: ae, onClick: ea, children: nt })
          ] })
        ] })
      }
    ) })
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Rt, { children: [
...
function No({
  ...
  const d = Na(), w = fp(e), p = s && w.length > 1;
  return /* @__PURE__ */ u(He, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(tt, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(Nc, {}) }) }),
    /* @__PURE__ */ a(qe, { align: "start", style: { zIndex: Ge }, children: w.map(({ columnKey: h, label: m }, v) => {
      const f = `${d}-${h}`;
      return /* @__PURE__ */ u(hr, { children: [
        /* @__PURE__ */ u(qn, { "aria-labelledby": p ? f : void 0, children: [
          p && /* @__PURE__ */ a(gr, { id: f, children: m }),
          /* @__PURE__ */ a(At, { children: ps(e.groups, e.items, h, t) })
        ] }),
        v < w.length - 1 && /* @__PURE__ */ a(ur, {})
      ] }, h);
    }) })
  ] });
}
...
const bp = Object.freeze([520, 420, 340]), gs = we.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = hs(n, bp), d = Ri() ?? l, w = d >= Ur.MINIMUM;
    return /* @__PURE__ */ a($a.Provider, { value: d, children: /* @__PURE__ */ a(
      "div",
      {
        ref: c,
        className: x(
...
const fs = we.forwardRef(({ className: t, ...e }, r) => {
  const o = $e();
  return /* @__PURE__ */ a(
    Te.Root,
    {
...
fs.displayName = Te.List.displayName;
...
ms.displayName = Te.List.displayName;
const xp = we.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.Trigger,
  {
    ref: r,
    ...e,
...
)), vs = we.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.Content,
  {
    ref: r,
    className: x(
...
vs.displayName = Te.Content.displayName;
function yg({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(fs, { children: [
      /* @__PURE__ */ a(ms, { children: t.map((c) => /* @__PURE__ */ a(xp, { value: c.value, children: c.value }, c.key)) }),
...
function Cp({
  ...
  const i = Yr();
  return /* @__PURE__ */ a(_p, { children: /* @__PURE__ */ a(
    Ve.Content,
    {
...
const Lr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    const c = e.filter((d) => d.group === s).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Rt, { children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        Ep,
        {
          ...
          children: [
            ...
            d.shortcut && /* @__PURE__ */ a(Sp, { children: d.shortcut })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(Rp, { children: [
        /* @__PURE__ */ a(Dp, { children: d.label }),
        /* @__PURE__ */ a(Op, { children: bs(
          t,
          e,
          ds(t, d.id),
          o
    ...
    return c.length > 0 && i < n.length - 1 && l.push(/* @__PURE__ */ a(Tp, {}, `separator-${s}`)), l;
  });
};
function Mp({
  menuData: t,
  ...
  const n = L(void 0), s = L(void 0), i = L(void 0), c = L(void 0), l = L(void 0), d = (w) => {
    switch (w) {
      case "platform.app":
        return s;
  ...
  if (Ql(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (v = s.current) == null || v.focus(), Lr(s, [h, m]);
        break;
      case "alt+l":
        (f = i.current) == null || f.focus(), Lr(i, [h, m]);
        break;
      case "alt+n":
        (g = c.current) == null || g.focus(), Lr(c, [h, m]);
        break;
      case "alt+h":
        (C = l.current) == null || C.focus(), Lr(l, [h, m]);
        break;
    }
  }), G(() => {
    ...
    const w = new MutationObserver((m) => {
      m.forEach((v) => {
        if (v.attributeName === "data-state" && v.target instanceof HTMLElement) {
          const f = v.target.getAttribute("data-state");
          r(f === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ a(yp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ws(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(kp, { children: [
      /* @__PURE__ */ a(Np, { ref: d(w), children: p.label }),
      /* @__PURE__ */ a(
        Cp,
        {
          style: { zIndex: Ge },
...
const Ip = Object.freeze([950, 800, 700]);
function kg(t) {
  switch (t) {
    case void 0:
      return;
...
function _g({
  ...
  const [w, p] = _(void 0), h = B(
    (f) => p(f ?? void 0),
    []
  ), m = hs(w, Ip), v = Ri() ?? m;
  return /* @__PURE__ */ a($a.Provider, { value: v, children: /* @__PURE__ */ a(
    "div",
    {
...
function Ng({
  ...
  const d = zp(
    ...
    n && n(v), o && o([v, ...r.filter((f) => f !== v)]), s && r.find((f) => f === v) && s([...r.filter((f) => f !== v)]), p(!1);
  }, m = (v, f) => {
    var C, y, T, z, U, E;
    const g = f !== v ? ((y = (C = t[v]) == null ? void 0 : C.uiNames) == null ? void 0 : y[f]) ?? ((z = (T = t[v]) == null ? void 0 : T.uiNames) == null ? void 0 : z.en) : void 0;
    return g ? `${(U = t[v]) == null ? void 0 : U.autonym} (${g})` : (E = t[v]) == null ? void 0 : E.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: x("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ u(
      Dr,
      {
        ...
        onOpenChange: (v) => p(v),
        children: [
          /* @__PURE__ */ a(Mr, { children: /* @__PURE__ */ a(Or, {}) }),
          /* @__PURE__ */ a(
            Ir,
            {
              style: { zIndex: Ge },
              children: Object.keys(t).map((v) => /* @__PURE__ */ a(Ee, { value: v, children: m(v, e) }, v))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Pt, { className: "tw:font-normal tw:text-muted-foreground", children: er(d, {
...
function Eg({
  ...
  const [i, c] = _(""), l = V(
    ...
    return l.filter(({ keywords: f }) => f.some((g) => g.toLowerCase().includes(v)));
  }, [l, i]), w = l.length > 1, p = o["%firstRun_language_search_placeholder%"] ?? "", h = o["%firstRun_language_noResults%"] ?? "", m = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(vr, { id: s, className: x("pr-twp", n), shouldFilter: !1, children: [
...
function Sg({
  ...
  const c = t ? sn(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Vp(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
      ...
      /* @__PURE__ */ a(
        Ot,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: sn(d, {
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(hr, { children: h }, `key-${m}`)
          )) })
        }
      )
    ] })
            ...
            d && (e || h && v) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(He, { children: [
                  /* @__PURE__ */ a(ze, { className: x(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
...
function Og({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = V(() => {
    const c = new ni(o);
    return (l) => c.format(l);
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: i.map((c) => {
    let l = "upcoming";
    return c === s ? l = "active" : c < s && (l = "complete"), /* @__PURE__ */ u(hr, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function Mg({ ...t }) {
  return /* @__PURE__ */ a(Gt.Root, { "data-slot": "context-menu", ...t });
}
function Ig({
  className: t,
  ...e
...
function zg({ ...t }) {
  return /* @__PURE__ */ a(Gt.Group, { "data-slot": "context-menu-group", ...t });
}
function Pg({ ...t }) {
  return /* @__PURE__ */ a(Gt.Portal, { "data-slot": "context-menu-portal", ...t });
}
function Ag({ ...t }) {
  return /* @__PURE__ */ a(Gt.Sub, { "data-slot": "context-menu-sub", ...t });
}
function $g({
  ...t
}) {
  return /* @__PURE__ */ a(Gt.RadioGroup, { "data-slot": "context-menu-radio-group", ...t });
}
function Vg({
  className: t,
...
function Fg({
  ...
  return /* @__PURE__ */ u(
    Gt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Gt.ItemIndicator, { children: /* @__PURE__ */ a(Aa, {}) }) }),
        e
      ]
    }
  );
...
function Gg({ ...t }) {
  return /* @__PURE__ */ a(sr.Root, { "data-slot": "drawer", ...t });
}
function Wg({ ...t }) {
  return /* @__PURE__ */ a(sr.Trigger, { "data-slot": "drawer-trigger", ...t });
}
function Lp({ ...t }) {
  return /* @__PURE__ */ a(sr.Portal, { "data-slot": "drawer-portal", ...t });
}
function Yg({ ...t }) {
  return /* @__PURE__ */ a(sr.Close, { "data-slot": "drawer-close", ...t });
}
function Bp({
  className: t,
  ...e
...
function sf({
  ...
  return /* @__PURE__ */ a(
    Te.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: x("pr-twp", jp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
const Up = (t, e, r = {}) => {
  ...
  const [e, r] = _(!1), [o, n] = _(!1), [s, i] = _(0), c = L(void 0), l = V(() => {
    if (!t) return;
    const h = async () => {
      try {
        const m = await t();
...
function hf(t) {
  const e = V(() => $c(t).slice().sort().join(" "), [t]);
...
function mf({ value: t, children: e }) {
  return /* @__PURE__ */ a(Si.Provider, { value: t, children: /* @__PURE__ */ a($a.Provider, { value: t, children: e }) });
}
const vf = 300;
function qp(t, e = "top") {
...
qp(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Dh as AvatarImage,
  vh as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  ...
  _h as COMMENT_EDITOR_STRING_KEYS,
  Bw as COMMENT_LIST_ELEMENT_ID,
  Nh as COMMENT_LIST_STRING_KEYS,
  yh as CONFLICT_NOTE_STRING_KEYS,
  ...
  lo as DialogTitle,
  Rf as DialogTrigger,
  wp as DisabledActionTooltip,
  dp as DisabledTooltipWrapper,
  Gg as Drawer,
  Yg as DrawerClose,
  Xg as DrawerContent,
  ...
  gu as EditorKeyboardShortcuts,
  Df as Empty,
  Of as EmptyContent,
  Mf as EmptyDescription,
  If as EmptyHeader,
  zf as EmptyMedia,
  Pf as EmptyState,
  Af as EmptyTitle,
  iu as ErrorDump,
  Ah as ErrorPopover,
  Fh as FOOTNOTE_EDITOR_STRING_KEYS,
  Bh as Filter,
  $h as FilterDropdown,
  Lh as Footer,
  jh as FootnoteEditor,
  Au as FootnoteItem,
  Uh as FootnoteList,
  Ru as INLINE_APPLY_DEBOUNCE_MS,
  ...
  pu as UNDO_REDO_BUTTONS_STRING_KEYS,
  Ng as UiLanguageSelector,
  hu as UndoRedoButtons,
  fs as VerticalTabs,
  vs as VerticalTabsContent,
  ms as VerticalTabsList,
  xp as VerticalTabsTrigger,
  Og as WizardStepper,
  ...
  tm as badgeVariants,
  em as buttonGroupVariants,
  rm as buttonVariants,
  x as cn,
  Yh as getBookIdFromUSFM,
  uu as getCaretPositionFromClick,
  ...
  So as isMacOs,
  am as isWindows,
  Eu as markerMenuItemToPaletteItem,
  Hp as pickTabIconUrl,
  nm as sonner,
  df as useEvent,
  wf as useEventAsync,
