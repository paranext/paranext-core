...
function mp({
  ...
  const c = ht(), [d, m] = S(!1), [f, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, z] = S(!1), j = H(void 0), R = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), V = K(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
...
function Fw({
  ...
  const [R, $] = S(lo), [E, D] = S(
    void 0
  ), V = o, [P, I] = S(!1), [A, W] = S(!1), [O, J] = S(!1), [St, At] = S(!1), [Mt, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
...
function Cp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Oa, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][f],
...
function Sp({
  ...
  const [g, x] = S("generated"), [v, y] = S("*"), [N, k] = S("f"), [C, z] = S(!1), [j, R] = S(!0), [$, E] = S(!1), D = H(!1), V = H(""), [P, I] = S(!1), [A, W] = S(), [O, J] = S(), [St, At] = S(), [Mt, gt] = S(), pt = H(null), G = B(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      N !== "x" && _ === "x" ? ct == null || ct.forEach((Dt) => bc(Dt)) : N === "x" && _ !== "x" && (ct == null || ct.forEach((Dt) => vc(Dt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
...
function jp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), z = Kt(
    n,
    "%webView_inventory_show_additional_items%"
...
function Fp({
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ p(Mn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Qt, { children: E.headers.filter((D) => D.column.columnDef.header).map((D) => (
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Br, {}) }) }),
