...
var fs = (t, e, r) => e in t ? gs(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Wt = (t, e, r) => fs(t, typeof e != "symbol" ? e + "" : e, r);
import { c as b, g as Re, a as zr, C as qe, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as Ie, f as ke, h as ze, i as tr, j as Be, B as J, x as ms, k as vs, l as bs, I as xs, m as _o, n as Ke, r as Ce, o as ys, p as Kn, P as er, q as _r, s as rr, t as ar, v as Ca, w as Ea, y as No, z as or, E as Ta, F as Mt, R as Co, G as ga, H as ao, J as oo, K as no, M as io, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as hr, W as ks, X as Ze, Y as Ue, Z as Pe, _ as je, $ as gr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as Gn, a5 as _s, a6 as Ns, a7 as Cs, a8 as so, a9 as qn, aa as Sa, ab as Es, ac as Wn, ad as Ts, ae as Ss, af as Rs, ag as Qo, ah as Ds, ai as Ms, aj as Os, ak as Yn, al as Xn, am as Do, an as Is, ao as Jn, ap as ja, aq as tn, ar as Fa, as as zs, at as Ps, au as $s, av as As, aw as Vs, ax as Ls, ay as Fr, az as Mo, aA as Bs, aB as js } from "./resizable-B4e5BhTX.js";
import { aC as cf, aD as lf, aE as df, aF as wf, aG as uf, aH as pf, aI as hf, aJ as gf, aK as ff, aL as mf, aM as vf, aN as bf, aO as xf, aP as yf, aQ as kf, aR as _f, aS as Nf, aT as Cf, aU as Ef, aV as Tf, aW as Sf, aX as Rf, aY as Df, aZ as Mf, a_ as Of, a$ as If, b0 as zf, b1 as Pf, b2 as $f, b3 as Af, b4 as Vf, b5 as Lf, b6 as Bf, b7 as jf, b8 as Ff, b9 as Uf, ba as Kf } from "./resizable-B4e5BhTX.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Zn, ChevronDown as Qe, ArrowLeft as Fs, ArrowRight as Us, BoldIcon as Ks, ItalicIcon as Hs, X as Oo, AtSign as Qn, Pencil as Gs, Trash2 as qs, ArrowUp as ti, MoreHorizontal as Ws, MailOpen as Ys, Mail as Xs, FilterIcon as Js, ArrowLeftIcon as Zs, ChevronLeftIcon as Qs, ChevronRightIcon as tc, ArrowRightIcon as ec, Copy as ei, Filter as rc, User as ac, Link as oc, CircleHelp as nc, Undo as ic, Redo as sc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as cc, AlertCircle as co, CircleCheckIcon as lc, CircleXIcon as dc, CircleHelpIcon as wc, ArrowUpIcon as uc, ArrowDownIcon as pc, ScrollText as hc, ChevronRight as gc, ChevronLeft as fc, ChevronsUpDown as mc, MenuIcon as vc, Menu as bc, EllipsisVertical as xc, MoreVertical as yc } from "lucide-react";
import { Section as Dt, compareScrRefs as ma, getChaptersForBook as kc, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as ia, formatRelativeDate as _c, sanitizeHtml as Io, NumberFormat as ni, formatBytes as Nc, getCurrentLocale as Cc, usfmMarkers as sa, isPlatformError as Ec, ABORTED as Tc, getErrorMessage as Sc, getFormatCallerFunction as Rc, deepEqual as Dc, isString as on, scrRefToBBBCCCVVV as Ua, defaultScrRef as Ka, formatScrRefRange as Mc, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as Oc } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Ra, useState as _, useEffect as Y, useCallback as j, useId as va, useImperativeHandle as Ic, useLayoutEffect as Jt, Fragment as Kr, Component as zc, createElement as cn, Suspense as Pc, forwardRef as ii } from "react";
import { IconSelector as si, IconCheck as Da, IconChevronDown as $c, IconChevronUp as Ac, IconLayoutSidebar as Vc, IconLayoutSidebarRight as Lc, IconChevronRight as ci, IconSearch as Bc, IconLoader as jc, IconAlertOctagon as Fc, IconAlertTriangle as Uc, IconInfoCircle as Kc, IconCircleCheck as Hc } from "@tabler/icons-react";
import { createEditor as li, $getRoot as Ge, $createParagraphNode as Hr, $getSelection as ae, HISTORY_MERGE_TAG as zo, ParagraphNode as di, TextNode as wi, $getPreviousSelection as Gc, $isRangeSelection as _e, $caretFromPoint as qc, $getSiblingCaret as ui, $getChildCaret as Wc, $getAdjacentChildCaret as Yc, $isChildCaret as Xc, $normalizeCaret as Jc, $setSelectionFromCaretRange as Zc, $getCollapsedCaretRange as Qc, $getCaretInDirection as ln, $splitAtPointCaretNext as tl, $isTextPointCaret as el, $findMatchingParent as pi, $isElementNode as Br, mergeRegister as Oe, getDOMTextNode as rl, isHTMLElement as al, CLEAR_EDITOR_COMMAND as hi, COMMAND_PRIORITY_EDITOR as Po, shallowMergeConfig as ol, defineExtension as ue, safeCast as nr, createState as nl, FORMAT_TEXT_COMMAND as gi, $isNodeSelection as fi, COMMAND_PRIORITY_LOW as mi, RootNode as il, LineBreakNode as sl, TabNode as cl, $isEditorState as ll, createCommand as dl, CLICK_COMMAND as wl, isDOMNode as ul, $getNodeFromDOMNode as pl, $createNodeSelection as hl, $setSelection as gl, $getEditor as fl, DecoratorNode as lo, $getState as ml, toggleTextFormatType as dn, TEXT_TYPE_TO_FORMAT as vl, $setState as bl, addClassNamesToElement as vi, $create as xl, $getNodeByKey as yl, removeClassNamesFromElement as kl, KEY_TAB_COMMAND as _l, $isBlockElementNode as Nl, $createRangeSelection as Cl, $normalizeSelection__EXPERIMENTAL as El, OUTDENT_CONTENT_COMMAND as Tl, INDENT_CONTENT_COMMAND as wn, INSERT_TAB_COMMAND as Sl, COMMAND_PRIORITY_CRITICAL as $o, $isDecoratorNode as Rl, $isParagraphNode as Dl, $isTextNode as wo, SELECTION_CHANGE_COMMAND as bi, $insertNodes as Ml } from "lexical";
import { HeadingNode as Ol, QuoteNode as Il, registerRichText as zl } from "@lexical/rich-text";
import { flushSync as Pl, createPortal as $l } from "react-dom";
...
import { Avatar as Ao, Select as Zt, Checkbox as un, Slot as Gr, Tabs as fe, Menubar as Ee, ContextMenu as Ft, Progress as pn, Slider as Qr, Switch as hn } from "radix-ui";
import { useReactTable as yi, getFilteredRowModel as Bl, getSortedRowModel as ki, getPaginationRowModel as jl, getCoreRowModel as _i, flexRender as Pr, getGroupedRowModel as Fl, getExpandedRowModel as Ul } from "@tanstack/react-table";
import Kl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as uo, HIDDEN_NOTE_CALLER as po, getDefaultViewOptions as Hl, isInsertEmbedOpOfType as Dr, getMarkerMenuItems as Gl, defaultStyleInfo as ql, Editorial as Wl } from "@eten-tech-foundation/platform-editor";
...
import { toast as Gf } from "sonner";
...
function Ci({
  ...
  const m = F(!1), x = () => {
    ...
    () => zr(e, l),
    [e, l]
  ), C = !!h && !p, E = `${S} (${k})`, P = C ? f || `${E}, ${h}` : E, T = /* @__PURE__ */ u(
    qe,
    {
      ref: t,
      ...
      children: [
        ...
        /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1", children: S }),
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      className: b(
        ...
        {
          "tw:border-s-red-200": s === Dt.OT,
          "tw:border-s-purple-200": s === Dt.NT,
          "tw:border-s-indigo-200": s === Dt.DC,
          "tw:border-s-amber-200": s === Dt.Extra
        }
      ),
      children: T
    }
...
const Zl = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"];
function Ql(t) {
  return Zl.some((e) => e === t);
}
function gn(t) {
...
function ad({
  ...
  Y(() => {
    ...
    if (!tt) return;
    const N = (G) => !!G && G.scrollWidth > G.clientWidth, rt = () => {
  ...
  const D = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), M = P ? (
        ...
        children: [
          /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                W,
                W && U && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                U
              ]
            }
          ) }),
...
function sd({
  ...
  const [h, f] = _(!1), [m, x] = _(!1), g = va(), S = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, nd), P = re(s, id), T = (M) => {
    M || (S.current = !0, x(!1)), k || f(M), p == null || p(M);
  }, B = (M) => {
    if (M && S.current) {
      S.current = !1;
      return;
  ...
  return /* @__PURE__ */ u(Ie, { open: C, onOpenChange: T, modal: !1, children: [
    /* @__PURE__ */ a(Ot, { children: E ? /* @__PURE__ */ u(Ct, { open: m, onOpenChange: B, children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: D }) }),
      /* @__PURE__ */ a(Tt, { children: E })
    ] }) : /* @__PURE__ */ a(ke, { asChild: !0, children: D }) }),
    /* @__PURE__ */ u(
      ze,
      {
        id: i,
...
function oh(t, e, r = (n, s) => n === s, o = 15) {
  return (n) => {
    const s = t.filter(
      (c) => !r(c, n)
    ), i = [n, ...s.slice(0, o - 1)];
  ...
  const o = ld.reduce(
    (n, s) => {
      ...
      if (i) {
        ...
        if (!w && l) {
          const f = ((m) => Object.keys(ha).find(
            (x) => ha[x].toLowerCase() === m.toLowerCase()
          ))(c);
...
function fo(t) {
  return {
    [Dt.OT]: t.filter((e) => jt.isBookOT(e)),
    [Dt.NT]: t.filter((e) => jt.isBookNT(e)),
    [Dt.DC]: t.filter((e) => jt.isBookDC(e)),
    [Dt.Extra]: t.filter((e) => jt.extraBooks().includes(e))
  };
}
function pd(t, e) {
...
function Si({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(
      "div",
      {
...
function Ga({
  ...
  const T = Ce(), B = ed(), [z, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [G, it] = _(
    void 0
  ), [ot, dt] = _(void 0), [St, Z] = _(!1), [lt, vt] = _(!1), [pt, It] = _(!1), [Ht, wt] = _(!1), me = F(null), oe = F(!1), bt = F(void 0), gt = F(void 0), xt = F(void 0), Gt = F(void 0), Rt = F({}), Nt = F({}), ft = j(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
    ...
    () => pd(ne, ie),
    [ne, ie]
  ), kt = zt.has(t.book), ve = V(() => U.trim() ? fo(
    Ut.filter((v) => _o(v, U, s))
  ) : lt ? $e : se, [
    se,
    $e,
    Ut,
    ...
    if (!$) return;
    const v = M.startsWith(`${$.book} `) ? M : "", H = ta(v), at = Ir(v);
    return {
      book: $.book,
  ...
  const Qt = j(() => {
    ...
    (v) => {
      const H = G ?? ($ == null ? void 0 : $.book), at = ot ?? ($ == null ? void 0 : $.chapterNum);
      !H || !at || (ft({
        book: H,
        chapterNum: at,
        verseNum: v
    ...
    (v) => {
      const H = N === "chapters" ? O : $ == null ? void 0 : $.book;
      if (H) {
        if (w && w(H, v) > 1) {
          it(H), dt(v), rt("verses"), W("");
          return;
        }
        ft({
          book: H,
    ...
    rt("books"), I(void 0), it(void 0), dt(void 0), wt(!1), setTimeout(() => {
      var v;
      (v = gt.current) == null || v.focus();
    }, 0);
  }, []), nt = j(() => {
    const v = G;
    it(void 0), dt(void 0), v ? (I(v), rt("chapters"), W("")) : et();
  }, [G, et]), ct = j(
    (v) => {
      D(v), v && (rt("books"), I(void 0), it(void 0), dt(void 0), tt(""), wt(!1), It(!1), vt(kt));
    },
    [kt]
  );
  Y(() => {
  ...
  Y(() => {
    var v;
    _t !== 0 && ((v = gt.current) == null || v.focus());
  }, [_t]), Ic(
    E,
    () => ({
      open: () => {
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (v) => $ ? !!$.chapterNum && !v.toString().includes($.chapterNum.toString()) : !1,
    [$]
  ), Pa = V(
    () => De(
      t,
    ...
    () => B >= $r.TIGHT ? zr(t.book, s) : Re(t.book, s),
    [t.book, s, B]
  ), $a = `${t.chapterNum}:${t.verseNum}`, Tr = j((v) => (H) => {
    Rt.current[v] = H;
  }, []), Sr = j((v) => (H) => {
    Nt.current[v] = H;
  }, []), sr = V(
    () => dd(U),
    [U]
  ), be = V(() => !w || !$ || !$.chapterNum || !sr ? !1 : w($.book, $.chapterNum) > 0, [w, $, sr]), cr = N === "books" && !St && !U.trim() && zt.size > 0, Aa = j(
    (v) => p ? mn(v, p) : !1,
    [p]
  ), Se = j(
    (v) => (H) => p ? wd(v, H, p) : !1,
    ...
    (v) => {
      (v.key === "Home" || v.key === "End") && v.stopPropagation(), h && h.includes(v.key) && $ && $.chapterNum !== void 0 && $.verseNum !== void 0 && (v.preventDefault(), v.stopPropagation(), Qt());
    },
    [h, $, Qt]
  ), Zr = j(
    (v) => {
      ...
      if (!(!!H && !!((Yo = bt.current) != null && Yo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const At = bt.current ? md(bt.current) : [];
        if (At.length === 0) {
          v.preventDefault(), v.stopPropagation();
          return;
        }
        const de = At[At.length - 1], qt = v.shiftKey ? At[0] : de;
        document.activeElement === qt && (v.preventDefault(), v.stopPropagation(), (v.shiftKey ? de : At[0]).focus());
        return;
      }
      const { isLetter: Lt, isDigit: Kt } = gn(v.key);
      if ((N === "chapters" || N === "verses") && (v.key === " " || v.key === "Enter")) {
        if (!!(H != null && H.closest(
        ...
        const de = (() => {
          if (N === "verses") {
            const Rr = G, Jo = ot, Ba = ta(M);
            return !Rr || !Jo || Ba === void 0 ? void 0 : {
              isDisabled: lr(Rr, Jo)(Ba),
              activate: () => R(Ba)
            };
          }
          const qt = O, he = Ir(M);
        ...
        if (de) {
          v.preventDefault(), v.stopPropagation(), de.isDisabled || de.activate();
          return;
        }
      }
      if (N === "books" && $ && !St && v.key === "Enter" && !(H !== gt.current && !!(H != null && H.closest('button, a, input, select, textarea, [role="button"]')))) {
        v.preventDefault(), v.stopPropagation(), Qt();
        return;
      }
      ...
      if (v.key === "Backspace" && (N === "chapters" || N === "verses")) {
        v.preventDefault(), v.stopPropagation(), N === "verses" ? nt() : et();
        return;
      }
      if (!Ql(v.key) || St) return;
      if (N === "books" && !Ht && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const At = H === gt.current ? gt.current : void 0, de = (At == null ? void 0 : At.selectionStart) ?? 0, qt = (At == null ? void 0 : At.selectionEnd) ?? 0, he = T === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
        if (!!At && (de !== qt || (he ? de > 0 : qt < At.value.length))) return;
      }
      if (v.shiftKey || N === "books" && H !== gt.current && (H != null && H.closest('button, a, [role="button"]')))
        return;
      const yt = (() => {
        const At = N === "books" && $ && be && $.chapterNum ? { bookId: $.book, chapterNum: $.chapterNum } : void 0, de = N === "verses" ? { bookId: G, chapterNum: ot } : At;
        if (de) {
          const { bookId: qt, chapterNum: he } = de;
          return !qt || !he || !w ? void 0 : {
            max: w(qt, he),
            current: ta(M) ?? 0,
            buildValue: (Rr) => ca(qt, he, Rr),
            refs: Nt,
        ...
        if (N === "chapters" || N === "books" && $ && Le($.book) > 1) {
          const qt = N === "chapters" ? O : $ == null ? void 0 : $.book;
          return qt ? {
            max: Le(qt),
            current: Ir(M) ?? 0,
            buildValue: (he) => fr(qt, he),
            refs: Rt,
      ...
      N === "books" && wt(!0), yt.takeFocus && ((Xo = bt.current) == null || Xo.focus());
      const ee = gd({
        current: yt.current,
        key: v.key,
        max: yt.max,
      ...
      if (v.preventDefault(), v.stopPropagation(), ee === yt.current) return;
      W(yt.buildValue(ee));
      const Wo = yt.refs.current[ee];
    ...
    if (v.key === "ArrowUp" || v.key === "ArrowDown") {
      (Lt = gt.current) == null || Lt.focus();
      return;
    }
    const { isLetter: H, isDigit: at } = gn(v.key);
    (H || at) && (v.preventDefault(), tt((yt) => yt + v.key), (Kt = gt.current) == null || Kt.focus(), Z(!1));
  }, []);
  Jt(() => {
    const v = setTimeout(() => {
      if (z && N === "books" && xt.current && Gt.current) {
        const H = xt.current, at = Gt.current, Lt = at.offsetTop, Kt = H.clientHeight, yt = at.clientHeight, ee = Lt - Kt / 2 + yt / 2;
        H.scrollTo({
          top: Math.max(0, ee),
          behavior: "smooth"
        }), W(go(t.book));
    ...
    if (N === "chapters" && O) {
      const v = O === t.book, H = v ? t.chapterNum : 1;
      W(fr(O, H)), setTimeout(() => {
        if (xt.current)
          if (v) {
            const at = Rt.current[t.chapterNum];
  ...
  }, [N, O, $, t.book, t.chapterNum]), Jt(() => {
    if (N === "verses" && G && ot !== void 0) {
      const v = G === t.book && ot === t.chapterNum, H = v ? t.verseNum : 1;
      W(
        ca(G, ot, H)
      ), setTimeout(() => {
        if (xt.current)
          if (v) {
            const at = Nt.current[t.verseNum];
            at && at.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            xt.current.scrollTo({ top: 0 });
        bt.current && bt.current.focus();
  ...
  const Q = $ ? `${$.book} ${$.chapterNum ?? ""} ${$.verseNum ?? ""} ${be}` : "", $t = F(""), le = F(""), pe = V(() => {
    if (N !== "books" || !$ || St) return;
    const { book: v, chapterNum: H, verseNum: at } = $;
    if (be && H && w)
      return {
        max: w(v, H),
        initial: at ?? (v === t.book && H === t.chapterNum ? t.verseNum : 1),
        parse: ta,
        buildValue: (Kt) => ca(v, H, Kt)
      };
    const Lt = Le(v);
    if (!(Lt <= 1))
      return {
  ...
  return Jt(() => {
    if (N !== "books" || !$ || !pe || pe.max <= 0) {
      $t.current = "";
      return;
    }
    const { max: v, initial: H, parse: at, buildValue: Lt } = pe, Kt = (yt) => {
      const ee = at(yt);
      return ee !== void 0 && ee >= 1 && ee <= v && yt === Lt(ee) ? ee : void 0;
    };
    if ($t.current !== Q) {
      $t.current = Q;
      const yt = Lt(Math.min(Math.max(H, 1), v));
      le.current = yt, W(yt);
      return;
    }
    if (Kt(M) !== void 0) {
    ...
    W(
      Kt(le.current) !== void 0 ? le.current : Lt(Math.min(Math.max(H, 1), v))
    );
  }, [N, $, pe, Q, M]), /* @__PURE__ */ u(er, { open: z, onOpenChange: ct, modal: k, children: [
    /* @__PURE__ */ a(_r, { asChild: !0, children: /* @__PURE__ */ u(
      J,
      {
        ref: me,
        ...
        onClick: (v) => {
          oe.current && (oe.current = !1, v.preventDefault());
        },
        children: [
          f ?? /* @__PURE__ */ a(
            ad,
    ...
    /* @__PURE__ */ a(
      rr,
      {
        ...
        onPointerDownOutside: (v) => {
          const { target: H } = v;
          z && me.current && H instanceof Node && me.current.contains(H) && (oe.current = !0, ct(!1));
        },
        onCloseAutoFocus: S,
          ...
          ar,
          {
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  className: b("tw:flex tw:items-end", St && "tw:pb-1"),
                  onFocus: (v) => {
                    It(v.target !== gt.current);
                  },
                  onBlur: (v) => {
                    v.currentTarget.contains(v.relatedTarget) || It(!1);
                  },
                  children: [
                    ...
                    /* @__PURE__ */ a(Ea, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: q.map(
                      ({ onClick: v, disabled: H, title: at, icon: Lt, group: Kt }, yt) => {
                        const ee = /* @__PURE__ */ a(
                          J,
                          {
                            variant: "ghost",
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(Kr, { children: [
                            yt > 0 && Kt !== q[yt - 1].group && /* @__PURE__ */ a(No, {}),
                            H ? (
                              ...
                              /* @__PURE__ */ a("span", { title: at, className: "tw:inline-flex", children: ee })
                            ) : /* @__PURE__ */ u(Ct, { children: [
                              /* @__PURE__ */ a(Et, { asChild: !0, children: ee }),
                ...
                /* @__PURE__ */ u(Ct, { children: [
                  /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
                    J,
                    {
                      variant: "ghost",
                      size: "sm",
                      onClick: N === "verses" ? nt : et,
                      className: "tw:me-2 tw:h-6 tw:w-6 tw:p-0",
                      tabIndex: -1,
                      "aria-label": qr,
                      children: T === "ltr" ? /* @__PURE__ */ a(Fs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Us, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                  /* @__PURE__ */ a(Tt, { children: qr })
                ] }),
                N === "chapters" && O && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Re(O, s) }),
                N === "verses" && G && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Re(G, s)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: N === "verses" ? Va : dr
                  }
                )
              ] }),
              !St && /* @__PURE__ */ u(or, { ref: xt, children: [
                N === "books" && /* @__PURE__ */ u(ht, { children: [
                  !$ && Object.entries(ve).map(([v, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ke, { heading: ir(v), children: H.map((at) => /* @__PURE__ */ a(
                          Ci,
                          {
                            bookId: at,
                            onSelect: (Lt) => K(Lt),
                            ...
                            ref: at === t.book ? Gt : void 0,
                            localizedBookNames: s,
                            disabled: Aa(at),
                            dimmedReason: zt.has(at) ? La : void 0,
                            dimmedDescription: zt.has(at) ? Yr(at) : void 0
                          },
                          at
                        )) }, v)
                      );
                  }),
                  $ && mt && /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ u(
                    qe,
                    {
                      value: od,
                      onSelect: Qt,
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: zr($.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  $ && be && $.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  $ && !be && Le($.book) > 1 && // No heading here either, for the same reason as the verse preview above:
                ...
                N === "chapters" && O && /* @__PURE__ */ a(
                  vn,
                  {
                    ...
                    onChapterSelect: X,
                    setChapterRef: Tr,
                    isChapterDisabled: Se(O),
                    className: "tw:p-4"
                  }
                ),
                N === "verses" && G && ot !== void 0 && w && /* @__PURE__ */ a(
                  bn,
                  {
                    bookId: G,
                    chapterNum: ot,
...
function xn({
  ...
  const [C, E] = _(!1), P = d ?? l, T = (z) => z.length > 0 && typeof z[0] == "object" && "options" in z[0], B = (z, D) => {
    const M = l(z), W = typeof z == "object" && "secondaryLabel" in z ? z.secondaryLabel : void 0, U = `${D ?? ""}${M}${W ?? ""}`;
    return /* @__PURE__ */ u(
      qe,
      {
        value: M,
  ...
  return /* @__PURE__ */ u(er, { open: C, onOpenChange: E, ...k, children: [
    /* @__PURE__ */ a(_r, { asChild: !0, children: /* @__PURE__ */ u(
      J,
      {
        variant: m,
    ...
    /* @__PURE__ */ a(
      rr,
      {
        ...
        style: s,
        children: /* @__PURE__ */ u(ar, { children: [
          /* @__PURE__ */ a(
            Ca,
            {
              placeholder: h,
          ...
          /* @__PURE__ */ a(Ta, { children: f }),
          /* @__PURE__ */ a(or, { children: T(e) ? e.map((z) => /* @__PURE__ */ a(Ke, { heading: z.groupHeading, children: z.options.map((D) => B(D, z.groupHeading)) }, z.groupHeading)) : /* @__PURE__ */ a(Ke, { children: e.map((z) => B(z)) }) })
        ] })
      }
    )
  ] });
...
function sh({
  ...
  const w = qa(d, "%webView_bookSelector_currentBook%"), p = qa(d, "%webView_bookSelector_choose%"), h = qa(d, "%webView_bookSelector_chooseBooks%"), [f, m] = _(
    "current book"
    /* CurrentBook */
  ), x = (g) => {
    m(g), t(g);
    ...
    Co,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Mt, { className: "tw:flex tw:items-center", children: o.map((g) => jt.bookIdToEnglishName(g)).join(", ") }),
          /* @__PURE__ */ a(
            J,
            {
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yd = Di ? Jt : Y, ra = { tag: zo };
function kd({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: l } = t, d = xd(null, o), w = li({ editable: t.editable, html: l, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (f.isEmpty()) {
            ...
            (ae() !== null || x !== null && x === p.getRootElement()) && m.select();
          }
        }, ra);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const f = p.parseEditorState(h);
            p.setEditorState(f, ra);
            break;
          }
          case "object":
...
const _d = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
class Ed extends zc {
  constructor(e) {
    super(e), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = Wa;
  }
...
const Rd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Dd(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Md() {
  return function(t) {
    const [e] = Te(), r = V(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), s = F(o);
    return Rd(() => {
...
function Pd(t, e, r) {
  ...
  function l() {
    o === null && ba(182), n === null && ba(183);
    const { left: p, top: h } = n.getBoundingClientRect(), f = Od(t, e);
    var m, x;
    c.isConnected || (x = c, (m = n).insertBefore(x, m.firstChild));
    let g = !1;
    for (let S = 0; S < f.length; S++) {
      const k = f[S], C = i[S] || document.createElement("div"), E = C.style;
      E.position !== "absolute" && (E.position = "absolute", g = !0);
      const P = ye(k.left - p);
      E.left !== P && (E.left = P, g = !0);
      const T = ye(k.top - h);
      E.top !== T && (C.style.top = T, g = !0);
      const B = ye(k.width);
      E.width !== B && (C.style.width = B, g = !0);
      const z = ye(k.height);
      E.height !== z && (C.style.height = z, g = !0), C.parentNode !== c && (c.append(C), g = !0), i[S] = C;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    if (!al(f)) return d();
    d(), o = h, n = f, s = new MutationObserver((m) => {
      const x = t.getRootElement(), g = x && x.parentElement;
      if (x !== o || g !== n) return p();
      for (const S of m) if (!c.contains(S.target)) return l();
    }), s.observe(f, zd), l();
  });
  return () => {
    w(), d();
...
function Ad(t, e = $d) {
  ...
  function d(w) {
    w.read(() => {
      const p = ae();
      if (!_e(p)) return r = null, n = null, s = null, c = null, l(), void (l = () => {
      });
      const [h, f] = function(z) {
        const D = z.getStartEndPoints();
        return z.isBackward() ? [D[1], D[0]] : D;
      }(p), m = h.getNode(), x = m.getKey(), g = h.offset, S = f.getNode(), k = S.getKey(), C = f.offset, E = t.getElementByKey(x), P = t.getElementByKey(k), T = r === null || E !== o || g !== n || x !== r.getKey(), B = s === null || P !== i || C !== c || k !== s.getKey();
      if ((T || B) && E !== null && P !== null) {
        const z = function(D, M, W, U, tt, N, rt) {
          const O = (D._window ? D._window.document : document).createRange();
          return O.setStart(...yn(M, W, U)), O.setEnd(...yn(tt, N, rt)), O;
        }(t, h, m, E, f, S, P);
        l(), l = Pd(t, z, e);
      }
      r = m, o = E, n = g, s = S, i = P, c = C;
    });
  }
...
function Ld(t) {
  const e = pi(t, (r) => Br(r) && !r.isInline());
  return Br(e) || ba(4, t.__key), e;
}
function Bd(t) {
  const e = ae() || Gc();
  let r;
  if (_e(e)) r = qc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = ui(c, "next"));
    }
    r = r || Wc(Ge(), "previous").getFlipped().insert(Hr());
  }
  const o = jd(t, r), n = Yc(o), s = Xc(n) ? Jc(n) : o;
  return Zc(Qc(s)), t.getLatest();
}
function jd(t, e, r) {
  let o = ln(e, "next");
  for (let n = o; n; n = tl(n, r)) o = n;
  return el(o) && ba(283), o.insert(t.isInline() ? Hr().append(t) : t), ln(ui(t.getLatest(), "next"), e.direction);
}
function Fd(t) {
  const e = ae();
  if (!_e(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(i)) continue;
    const c = pi(s, (d) => Br(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let xa, Me = 0, ya = 0, Hd = 0, bo = 0, da = 0;
function _n(t) {
  if (st === void 0) return;
  let e = t.n;
...
function Xe(t, e) {
  Yt.call(this, void 0), this.x = t, this.s = void 0, this.g = da - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Gd(t, e) {
  return new Xe(t, e);
}
...
function qd(t) {
  ...
  Ii(this), st = t, this.f &= -2, 8 & this.f && Bo(this), Oa();
}
function pr(t, e) {
...
Yt.prototype.brand = Ud, Yt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Me !== 0 && ya === 0 && e.l !== bo && (e.l = bo, xa = { S: e, v: e.v, i: e.i, o: xa });
    })(this), this.v = t, this.i++, da++, Me++;
    try {
  ...
  if (this.g = da, this.f |= 1, this.i > 0 && !Oi(this)) return this.f &= -2, !0;
  const t = st;
  try {
    Nn(this), st = this;
    const e = this.x();
  ...
  return st = t, Ii(this), this.f &= -2, !0;
...
ue({ build: (t, e, r) => Nr(e), config: nr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
  return Ne(() => o.disabled.value ? void 0 : t.registerRootListener((n) => {
    t.focus(() => {
...
function Pi() {
  const t = Ge(), e = ae(), r = Hr();
  t.clear(), t.append(r), e !== null && r.select(), _e(e) && (e.format = 0);
}
function $i(t, e = Pi) {
  return t.registerCommand(hi, (r) => (t.update(e), !0), Po);
}
ue({ build: (t, e, r) => Nr(e), config: nr({ $onClear: Pi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Ne(() => $i(t, o.value));
} });
function Wd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Ya = nl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ai extends lo {
  $config() {
...
ue({ name: "@lexical/extension/DecoratorText", nodes: () => [Ai], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = ae();
  if (fi(n) || _e(n)) for (const s of n.getNodes()) Yd(s) && s.toggleFormat(o);
  return !1;
}, mi) });
function Vi(t, e) {
  let r;
...
const xo = ue({ build: (t) => Vi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const jo = 0, yo = 1, Bi = 2, Xa = 3, aa = 4, ur = 5, Ja = 6, Mr = 7;
function Za(t) {
  return t.id === jo;
}
function ji(t) {
...
function Xd(t) {
  return function(e) {
    return e.id === yo;
  }(t) || ut(305, String(t.id), String(yo)), Object.assign(t, { id: Bi });
}
...
class Zd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== aa && ut(307, String(r.id), String(ur)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
    const n = { ...r.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(s, i, c) {
      return Object.assign(s, { id: ur, output: i, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== ur && ut(308, String(o.id), String(ur));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(s) {
      return Object.assign(s, { id: Ja });
    }(o), () => {
      const s = this.state;
      s.id !== Mr && ut(309, String(o.id), String(Mr)), this.state = function(i) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ja && ut(310, String(r.id), String(Ja)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= aa;
    }(e) || ut(313, String(e.id), String(aa)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Mr;
    }(e) || ut(316, String(e.id), String(Mr)), e;
  }
...
function Qd() {
  const t = Ge();
  t.isEmpty() && t.append(Hr());
}
const tw = ue({ config: nr({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = Qd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [il, wi, sl, cl, di] }), En = Symbol.for("@lexical/extension/LexicalBuilder");
function Tn() {
}
function ew(t) {
  throw t;
...
class mr {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Qa, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[En];
    return r && (r.PACKAGE_VERSION !== Qa && ut(292, r.PACKAGE_VERSION, Qa), r instanceof mr || ut(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Za(s) || ut(300, i, n || "[unknown]"), Za(c = s) || ut(304, String(c.id), String(jo)), s = Object.assign(c, { id: yo }), o.state = s;
...
const rw = /* @__PURE__ */ new Set(), Sn = ue({ build(t, e, r) {
  const o = r.getDependency(xo).output, n = jr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Vi(() => {
  }, () => Ne(() => {
    ...
    o.value.read(() => {
      if (ae()) for (const [w, p] of c.entries()) {
        ...
        const h = yl(w), f = h && h.isSelected() || !1;
        d = d || f !== (!!i && i.has(w)), f && (l = l || /* @__PURE__ */ new Set(), l.add(w));
      }
    }), !d && l && i && l.size === i.size || (s.value = l);
  }));
  return { watchNodeKey: function(i) {
    const c = Gd(() => (s.value || rw).has(i)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(i);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(i, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [xo], name: "@lexical/extension/NodeSelection" }), aw = dl("INSERT_HORIZONTAL_RULE_COMMAND");
class vr extends lo {
  static getType() {
...
ue({ dependencies: [xo, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [vr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Sn).output, n = jr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Oe(t.registerCommand(aw, (i) => {
    const c = ae();
    if (!_e(c)) return !1;
    ...
    return !0;
  }, Po), t.registerCommand(wl, (i) => {
    if (ul(i.target)) {
      const c = pl(i.target);
      if (nw(c)) return function(l, d = !1) {
        const w = ae(), p = l.isSelected(), h = l.getKey();
        let f;
        d && fi(w) ? f = w : (f = hl(), gl(f)), p ? f.delete(h) : f.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  }, mi), t.registerMutationListener(vr, (i, c) => {
    Kd(() => {
      let l = !1;
      ...
      for (const [w, p] of i.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = f : (l = !0, d.set(w, { domNode: jr(f), selectedSignal: o(w) }));
      }
      l && (n.value = { nodeSelections: d });
    });
  }), Ne(() => {
    const i = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) i.push(Ne(() => {
      const d = c.value;
      d && (l.value ? vi(d, s) : kl(d, s));
    }));
    return Oe(...i);
  }));
} });
ue({ build: (t, e) => Nr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: nr({ $getParentEditor: function() {
  const t = fl();
  return mr.fromEditor(t), t;
}, inheritEditableFromParent: !1 }), init: (t, e, r) => {
  const o = e.$getParentEditor();
  t.parentEditor = o, t.theme = t.theme || o._config.theme;
}, name: "@lexical/extension/NestedEditor", register: (t, e, r) => Ne(() => {
...
ue({ build: (t, e, r) => Nr(e), config: nr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ne(() => {
...
function iw(t, e, r = Fi) {
  return Oe(t.registerCommand(_l, (o) => {
    const n = ae();
    if (!_e(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      ...
      if (p.canIndent()) {
        const h = p.getKey();
        let f = Cl();
        if (f.anchor.set(h, 0, "element"), f.focus.set(h, 0, "element"), f = El(f), f.anchor.is(d)) return !0;
      }
      return !1;
...
ue({ build: (t, e, r) => Nr(e), config: nr({ $canIndent: Fi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: s } = r.getOutput();
  return Ne(() => {
    if (!o.value) return iw(t, n, s);
  });
} });
const sw = ue({ name: "@lexical/react/ReactProvider" });
function cw() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (_e(m)) {
                const x = m.anchor;
                let g = x.getNode(), S = 0, k = 0;
                if (wo(g) && d >= 0 && w >= 0 && (S = d, k = d + w, m.setTextNodeRange(g, S, g, k)), S === k && p === "" || (m.insertRawText(p), g = x.getNode()), wo(g)) {
                  S = h, k = h + f;
                  const C = g.getTextContentSize();
                  S = S > C ? C : S, k = k > C ? C : k, m.setTextNodeRange(g, S, g, k);
                }
...
ue({ build: (t, e, r) => Nr(e), config: nr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ne(() => r.getOutput().disabled.value ? void 0 : Ki(t)) });
function ww(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function hw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Uo(() => Oe(zl(n), Ki(n)), [n]);
  }(o), u(ht, { children: [t, a(gw, { content: e }), a(pw, { editor: o, ErrorBoundary: r })] });
}
...
const mw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function vw({ onClear: t }) {
  const [e] = Te();
  return mw(() => $i(e, t), [e, t]), null;
}
const Hi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function bw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: f, className: m, id: x, role: g = "textbox", spellCheck: S = !0, style: k, tabIndex: C, "data-testid": E, ...P }, T) {
  const [B, z] = _(t.isEditable()), D = j((W) => {
    W && W.ownerDocument && W.ownerDocument.defaultView ? t.setRootElement(W) : t.setRootElement(null);
  }, [t]), M = V(() => /* @__PURE__ */ function(...W) {
    return (U) => {
      for (const tt of W) typeof tt == "function" ? tt(U) : tt != null && (tt.current = U);
    };
  }(T, D), [D, T]);
  return Hi(() => (z(t.isEditable()), t.registerEditableListener((W) => {
    z(W);
  })), [t]), a("div", { "aria-activedescendant": B ? e : void 0, "aria-autocomplete": B ? r : "none", "aria-controls": B ? o : void 0, "aria-describedby": n, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": B && g === "combobox" ? !!i : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": B ? p : void 0, "aria-readonly": !B || void 0, "aria-required": h, autoCapitalize: f, className: m, contentEditable: B, "data-testid": E, id: x, ref: M, role: g, spellCheck: S, style: k, tabIndex: C, ...P });
}
const xw = ii(bw);
function Dn(t) {
  return t.getEditorState().read(Ui(t.isComposing()));
...
function kw(t, e) {
  ...
  return u(ht, { children: [a(xw, { editor: n, ...o, ref: e }), r != null && a(_w, { editor: n, content: r })] });
}
...
function Ew() {
  const [t, e] = _(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(ao, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(oo, { children: [
      /* @__PURE__ */ a(no, { children: /* @__PURE__ */ a(io, { children: s }) }),
      i
    ] }) });
  }, [t, r]), n = j(
    (s, i, c = !1) => {
...
function Tw({
  ...
  const [e] = Te(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Ew(), l = () => {
  };
...
const zw = "verseText", ch = Object.freeze([
...
function lh({
  ...
  const [s, i] = _(Pw), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  Y(() => {
    let g = !0;
    const S = h.current;
    if (!S) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(er, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(_r, { asChild: !0, children: /* @__PURE__ */ u(
        J,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: to(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        rr,
        {
          ...
          children: /* @__PURE__ */ a(ar, { children: /* @__PURE__ */ a(or, { children: t.map((g) => /* @__PURE__ */ a(
            qe,
            {
              onSelect: () => {
                l(g || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: to(g, o) })
            },
            g || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (g) => {
          g.key === "Escape" ? (g.preventDefault(), g.stopPropagation(), r()) : Ho(g) && (g.preventDefault(), g.stopPropagation(), we(s) && f());
        },
        onKeyDown: (g) => {
          Ko(g), (g.key === "Enter" || g.key === " ") && g.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          ka,
          {
...
function In({
  ...
  const f = j(
    ...
    const T = new Date(t.date), B = _c(
      T,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), z = T.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), g = V(() => t.user, [t.user]), S = V(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = V(() => Io(t.contents), [t.contents]), C = V(
    ...
    if (o && c)
      return /* @__PURE__ */ u(ht, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(Iw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Lw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Bw, { className: "tw:text-xs tw:font-medium", children: S }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), f()) : Ho(T) && (T.preventDefault(), T.stopPropagation(), we(w) && m());
              },
              onKeyDown: (T) => {
        ...
        P && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ws, {}) }) }),
...
function rs({
  ...
  const [U, tt] = _(zn), [N, rt] = _(), [O, I] = _(), G = o, [it, ot] = _(!1), [dt, St] = _(!1), [Z, lt] = _(!1), [vt, pt] = _(!1), [It, Ht] = _(!1), [wt, me] = _(E), [oe, bt] = _(!1), gt = F(void 0), [xt, Gt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let y = !0;
    return (async () => {
    ...
    let y = !0;
    if (!o) {
      pt(!1), Gt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const A = S ? await S(l) : !1;
      y && pt(A);
    })(), () => {
      y = !1;
    };
  ...
  Y(() => {
    if (!o) {
      Rt.current !== "idle" && (rt(void 0), I(void 0), Rt.current = "idle");
      return;
    }
    Rt.current === "idle" && (Rt.current = "pending"), vt ? Rt.current === "pending" && B !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    B !== s && (rt(B), Rt.current = "auto-populated") : Rt.current === "auto-populated" && (rt(void 0), Rt.current = "pending");
  }, [o, B, vt, s]);
  const Nt = V(
  ...
  const ft = V(() => Nt[0], [Nt]), ne = F(null), ie = F(void 0), se = j(() => {
    var y;
    (y = ie.current) == null || y.call(ie), tt(zn);
  }, []), $e = j(() => {
    const y = !wt;
    me(y), bt(!y), m == null || m(l, y);
  }, [wt, m, l]);
  Y(() => {
    ot(!1);
  }, [o]), Y(() => {
  ...
  const Ut = V(
    ...
    const y = wa(s, r);
    return Fe(r["%comment_assigned_to%"], {
      assignedUser: y
    });
  }, [s, r]), zt = V(() => Nt.slice(1), [Nt]), kt = V(() => zt.length ?? 0, [zt.length]), ve = V(() => kt > 0, [kt]), $ = V(() => it || kt <= 2 ? zt : zt.slice(-2), [zt, kt, it]), mt = V(() => it || kt <= 2 ? 0 : kt - 2, [kt, it]), ce = V(
    () => kt === 1 ? Ut.singleReply : Fe(Ut.multipleReplies, { count: kt }),
    [kt, Ut]
  ), Qt = V(
    () => mt === 1 ? Ut.singleReply : Fe(Ut.multipleReplies, { count: mt }),
    [mt, Ut]
  );
  Y(() => {
    !o && dt && ve && St(!1);
  ...
  const R = j(
    async (y) => {
      ...
      q && await p({ threadId: l, contents: q }) && se();
    },
    [
      se,
      U,
    ...
    async (y) => {
      const q = we(U) ? _a(U) : void 0, A = y.status ? y.assignedUser : N ?? y.assignedUser, et = await p({
        ...y,
        contents: q,
        assignedUser: A
      });
      return et && (A !== void 0 && I(A), q && se()), et;
    },
    [se, U, p, N]
  );
  ...
  const X = /* @__PURE__ */ a(
    In,
    {
      ...
      handleDeleteComment: f,
      onEditingChange: St,
      canEditOrDelete: (!dt && xt.get(ft.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    Aw,
    {
      ...
      className: b(
        ...
        {
          "tw:bg-primary-foreground": !o && w !== "Resolved" && wt,
          "tw:bg-background": o && w !== "Resolved" && wt,
          "tw:bg-muted": w === "Resolved",
          "tw:bg-accent": !wt && !o && w !== "Resolved"
        }
      ),
      onClick: () => {
        c(l);
      ...
      children: /* @__PURE__ */ u(Vw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            Ae && /* @__PURE__ */ a(Vr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Ae }),
            /* @__PURE__ */ a(
              J,
              {
                variant: "ghost",
                ...
                "aria-label": wt ? r["%comment_aria_mark_as_unread%"] ?? "Mark as unread" : r["%comment_aria_mark_as_read%"] ?? "Mark as read",
                children: wt ? /* @__PURE__ */ a(Ys, {}) : /* @__PURE__ */ a(Xs, {})
              }
            ),
            M === void 0 ? (
            ...
            "p",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("span", { className: t, children: [
                  ft.contextBefore,
                  /* @__PURE__ */ a("span", { className: "tw:font-bold", children: ft.selectedText }),
                  ft.contextAfter
                ] })
              ]
            }
        ...
        /* @__PURE__ */ u(ht, { children: [
          ve && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Lr, {}) }),
            ...
            mt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Lr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Qt }),
                    it ? /* @__PURE__ */ a(Zn, {}) : /* @__PURE__ */ a(Qe, {})
                  ] })
                ]
              }
            ),
            $.map((y) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              In,
              {
                comment: y,
                localizedStrings: r,
                ...
                handleDeleteComment: f,
                onEditingChange: St,
                canEditOrDelete: (!dt && xt.get(y.id)) ?? !1
              }
            ) }, y.id)),
            g !== !1 && (!dt || we(U)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (y) => {
                  Ho(y) && (y.preventDefault(), y.stopPropagation(), (we(U) || N !== void 0 && N !== O) && R());
                },
                onKeyDown: (y) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    N !== void 0 && (we(U) || N !== O) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Fe(
                    ...
                    /* @__PURE__ */ u(er, { open: Z, onOpenChange: lt, children: [
                      /* @__PURE__ */ a(_r, { asChild: !0, children: /* @__PURE__ */ a(
                        J,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !vt || !x || x.length === 0 || !x.includes(i),
                      ...
                      /* @__PURE__ */ a(
                        rr,
                        {
                          ...
                          children: /* @__PURE__ */ a(ar, { children: /* @__PURE__ */ a(or, { children: x == null ? void 0 : x.map((y) => /* @__PURE__ */ a(
                            qe,
                            {
                              onSelect: () => {
                                rt(y !== s ? y : void 0), Rt.current = "user-selected", I(void 0), lt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: wa(y, r) })
                            },
                            y || "unassigned"
                          )) }) })
                        }
...
), Fw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ua = (t) => Fw(Io(t));
function pa({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Uw({
  ...
  const [i, c] = _("accept"), l = va(), d = va(), w = r === "loading", p = r === "accept", h = r === "none", f = r === "acceptRejectOrMerge", m = p ? "accept" : i, x = V(
    () => ua(t.rejectedText ?? ""),
    [t.rejectedText]
  ), g = V(
    () => ua(t.acceptedText ?? ""),
    ...
    () => ua(t.mergedText ?? ""),
    [t.mergedText]
  ), k = V(() => Io(t.contents), [t.contents]);
  if (!Qi(t))
    return /* @__PURE__ */ a(pa, { html: k });
  const C = (O) => {
    c(O === "reject" || O === "merge" ? O : "accept");
  }, E = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", P = f ? [
    {
      value: "merge",
  ...
  let D;
  B ? D = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : s || (D = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), U = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : W, tt = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(pa, { html: S }) : W : U(O === "reject" ? t.rejectedResultText : t.resultText);
  }, N = (O) => p && O.value === "reject", rt = (O) => {
    const I = m === O.value, G = `${d}-${O.value}`, it = N(O);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(
          Co,
          {
            ...
            children: T.map((O) => N(O) ? /* @__PURE__ */ a(Ot, { delayDuration: 0, children: /* @__PURE__ */ u(Ct, { children: [
              /* @__PURE__ */ a(Et, { asChild: !0, children: rt(O) }),
              /* @__PURE__ */ a(Tt, { children: E })
            ] }) }, O.value) : rt(O))
          }
        ),
...
function Ww(t) {
  ...
  } = t, c = V(() => e.filter((S) => !S.deleted), [e]), l = V(
    () => c.find((S) => S.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: f } = qw({
    threadId: n,
    threadStatus: s,
    isSelected: o,
    activeComments: c,
...
function vh({
  ...
  const [k, C] = _(/* @__PURE__ */ new Set()), [E, P] = _(), [T, B] = _(), z = j(
    async (I) => {
      const G = await s(I);
      return G !== void 0 && I.assignedUser !== void 0 && I.assignedUser !== "" && B(I.assignedUser), G;
    },
    [s]
  );
  Y(() => {
    m && (C((I) => new Set(I).add(m)), P(m));
  }, [m]);
  const D = r.filter(
    (I) => I.comments.some((G) => !G.deleted)
  ), M = D.map((I) => ({ id: I.id })), W = j(
    (I) => {
      C((G) => new Set(G).add(I.id)), P(I.id), x == null || x(I.id);
    },
    [x]
  ), U = j(
    (I) => {
      ...
      }), P(I), x == null || x(G ? void 0 : I);
    },
    [k, x]
  ), { listboxRef: tt, activeId: N, handleKeyDown: rt } = ks({
    options: M,
    onOptionSelect: W
  }), O = j(
    (I) => {
      I.key === "Escape" ? (E && k.has(E) && (C((G) => {
        const it = new Set(G);
        return it.delete(E), it;
      }), P(void 0), x == null || x(void 0)), I.preventDefault(), I.stopPropagation()) : rt(I);
    },
    [E, k, rt, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Ww, { ...G, conflictResolution: S }) : /* @__PURE__ */ a(rs, { ...G })
          },
          I.id
        );
      })
...
function Yw({ table: t }) {
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ u(J, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function yr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Zt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Zt.Icon, { asChild: !0, children: /* @__PURE__ */ a(si, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ge({
  ...
  return /* @__PURE__ */ u(
    Zt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Zt.ItemIndicator, { children: /* @__PURE__ */ a(Da, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        br,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(kr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ge, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function tu({
  ...
  var T;
  const [w, p] = _([]), [h, f] = _([]), [m, x] = _({}), [g, S] = _({}), k = V(() => e ?? [], [e]), C = yi({
    data: k,
    columns: t,
    getCoreRowModel: _i(),
  ...
  let P;
  return l ? P = Array.from({ length: 10 }).map((D, M) => `skeleton-row-${M}`).map((D) => /* @__PURE__ */ a(je, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(gr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(hr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? P = C.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    je,
    {
      onClick: () => i(B, C),
      "data-state": B.getIsSelected() && "selected",
      children: B.getVisibleCells().map((z) => /* @__PURE__ */ a(gr, { children: Pr(z.column.columnDef.cell, z.getContext()) }, z.id))
    },
    B.id
  )) : P = /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(gr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Yw, { table: C }),
    /* @__PURE__ */ u(To, { stickyHeader: s, children: [
      /* @__PURE__ */ a(So, { stickyHeader: s, children: C.getHeaderGroups().map((B) => /* @__PURE__ */ a(je, { children: B.headers.map((z) => /* @__PURE__ */ a(fa, { className: "tw:p-0", children: z.isPlaceholder ? void 0 : Pr(z.column.columnDef.header, z.getContext()) }, z.id)) }, B.id)) }),
...
function _h({
  ...
  return /* @__PURE__ */ u(er, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(_r, { asChild: !0, children: o }),
    /* @__PURE__ */ u(rr, { id: s, className: b("tw:min-w-80 tw:max-w-96", n), children: [
      i && r["%webView_error_dump_copied_message%"] && /* @__PURE__ */ a(Mt, { children: r["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ a(
        ru,
        {
          errorDetails: t,
...
function Nh({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ u(J, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(ze, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(tr, { children: d.label }),
...
function Eh({
  ...
  const i = V(() => Nc(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(Cc(), { type: "language" });
  ...
  return /* @__PURE__ */ u(Ea, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      ...
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(ht, { children: [
          " ",
          /* @__PURE__ */ a(so, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      ...
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(ht, { children: [
          " ",
          /* @__PURE__ */ a(so, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
  ...
  return Y(() => {
    ...
    const s = Eo(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      ...
      if (s) {
        ...
        if (!d.ctrlKey) return;
        !d.shiftKey && w === "z" ? (d.preventDefault(), r && ((f = e.current) == null || f.undo())) : (w === "y" || d.shiftKey && w === "z") && (d.preventDefault(), o && ((m = e.current) == null || m.redo()));
      }
    };
...
function lu({
  ...
  const n = F(null), s = F(null), i = F(!1), [c, l] = _(t), [d, w] = _(e), [p, h] = _(!1), f = F(!1), m = F(c);
  m.current = c;
  const x = F(d);
  x.current = d, Y(() => {
    l(t);
  ...
  const g = (k) => {
    if (i.current = !1, h(k), !k) {
      const C = m.current, E = x.current;
      C !== "custom" || E ? (C !== t || E !== e) && r(C, E) : (l(t), w(e));
    }
  }, S = (k) => {
    var C, E, P, T;
    k.stopPropagation(), document.activeElement === s.current && k.key === "ArrowDown" || k.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), i.current = !0) : document.activeElement === n.current && k.key === "ArrowUp" ? ((E = s.current) == null || E.focus(), i.current = !1) : document.activeElement === n.current && k.key === "ArrowLeft" && ((P = n.current) == null ? void 0 : P.selectionStart) === 0 && ((T = s.current) == null || T.focus(), i.current = !1), c === "custom" && k.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && g(!1);
  };
  return /* @__PURE__ */ u(Ie, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: cu(t, o, e) }) }) }),
    ...
    /* @__PURE__ */ u(
      ze,
      {
        ...
        children: [
          /* @__PURE__ */ a(tr, { children: o["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(Ze, {}),
          /* @__PURE__ */ a(
            Ue,
            {
...
const du = (t, e) => t === "f" ? /* @__PURE__ */ u(ht, { children: [
  ...
  return t === "f" && (r = e["%footnoteEditor_noteType_footnote_label%"]), Fe(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: r
  });
};
function uu({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: du(t, r) }) }) }),
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: wu(t, r) }) })
    ] }) }),
...
function hu({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? cc, { className: e, size: 16 });
}
function gu({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
...
function fu({
  ...
  return /* @__PURE__ */ u(ar, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      Ca,
      {
    ...
    /* @__PURE__ */ u(or, { children: [
      ...
      /* @__PURE__ */ a(Ke, { children: i.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          An,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(Ke, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            An,
            {
...
function Sh({
  ...
  var Qt;
  const h = F(null), f = F(null), m = F(null), x = F(null);
  Jt(() => {
    if (!x.current) return;
    const { width: R } = x.current.getBoundingClientRect();
    R > 0 && (x.current.style.width = `${R}px`);
  }, []);
  const [g, S] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, W] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [G, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
  ), me = F(0), oe = F(void 0), bt = V(
    () => ({
      ...i,
  ...
  const xt = j(() => {
    var y, q, A;
    const R = (y = f.current) == null ? void 0 : y.querySelector(".editor-input"), K = R == null ? void 0 : R.querySelector("span.note"), X = (A = (q = f.current) == null ? void 0 : q.ownerDocument.getSelection()) == null ? void 0 : A.anchorNode;
    return !!K && !!X && K.contains(X);
  }, []);
  Y(() => {
    var q, A;
    let R, K, X;
    O.current = !1, oe.current = void 0, tt(!0);
    const y = e == null ? void 0 : e.at(0);
    if (y && Dr("note", y)) {
      const et = (q = y.insert.note) == null ? void 0 : q.caller;
      let nt = "custom";
      et === uo ? nt = "generated" : et === po ? nt = "hidden" : et && (P(et), B(et)), S(nt), C(nt), D(((A = y.insert.note) == null ? void 0 : A.style) ?? "f"), R = setTimeout(() => {
        var ct, _t, Pt;
        (ct = h.current) == null || ct.applyUpdate([y]), (_t = h.current) == null || _t.selectNote(0), (Pt = h.current) == null || Pt.focus(), K = requestAnimationFrame(() => {
          X = setTimeout(() => {
            var Vt, te;
            xt() || ((Vt = h.current) == null || Vt.selectNote(0), (te = h.current) == null || te.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      R && clearTimeout(R), K !== void 0 && cancelAnimationFrame(K), X !== void 0 && clearTimeout(X);
    };
  }, [e, s, xt]);
  const Gt = j(
    (R = !1) => {
      ...
      K && Dr("note", K) && (r == null || r([K]), R && d && s && ((q = d.current) == null || q.replaceEmbedUpdate(s, [K])));
    },
    [s, r, p, d]
  ), Rt = j(
    (R, K) => {
      var q, A, et;
      const X = (A = (q = h.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : A.at(0);
      if (!X || !Dr("note", X) || !X.insert.note) return;
      let y;
      R === "custom" ? y = K : R === "generated" ? y = uo : y = po, X.insert.note.caller !== y && (X.insert.note.caller = y, (et = h.current) == null || et.applyUpdate([X, { delete: 1 }]));
    },
    []
  ), Nt = j(() => {
    var R;
    wt.current || (R = h.current) == null || R.commitPendingMarkerEdits(), Gt(!0), o();
  }, [o, Gt]), ft = F(Nt);
  Jt(() => {
    ft.current = Nt;
  });
  const ne = F({ book: n.book, chapterNum: n.chapterNum });
  Jt(() => {
    (ne.current.book !== n.book || ne.current.chapterNum !== n.chapterNum) && (ne.current = { book: n.book, chapterNum: n.chapterNum }, ft.current());
  }, [n.book, n.chapterNum]);
  const ie = () => {
    var K;
    ...
    if (K && Dr("note", K)) {
      ...
      const nt = (A = (q = K.insert.note) == null ? void 0 : q.contents) == null ? void 0 : A.ops;
      z !== "x" && R === "x" ? nt == null || nt.forEach((ct) => bu(ct)) : z === "x" && R !== "x" && (nt == null || nt.forEach((ct) => xu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (R) => {
    It(R.contextMarker), rt(R.canRedo);
  }, Ae = j(
    (R) => {
      var X, y, q, A, et;
      const K = (y = (X = h.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : y.at(0);
      if (K && Dr("note", K)) {
        ...
        const nt = (q = K.insert.note) == null ? void 0 : q.style, ct = (et = (A = K.insert.note) == null ? void 0 : A.contents) == null ? void 0 : et.ops;
        if (nt || W(!1), W(
          nt === "x" ? !!(ct != null && ct.every((_t) => {
            var Vt, te;
            if (!((Vt = _t.attributes) != null && Vt.char)) return !0;
            const Pt = ((te = _t.attributes) == null ? void 0 : te.char).style;
        ...
        tt(JSON.stringify(K) === I.current), Gt();
      } else
        W(!1), tt(!0);
    },
    [Gt]
    ...
    if (m.current && gt.length && R && R.rangeCount > 0) {
      const K = R.getRangeAt(0).getBoundingClientRect(), X = m.current.getBoundingClientRect();
      dt(K.left - X.left), Z(K.top - X.top), vt(K.height), it(!0);
    }
  }, [gt, m]), kt = F(() => {
  }), ve = j(
    (R, K, X) => {
      ...
      Ss({
        ...
        clearSessionIfCurrent: (A) => Qo(wt, A),
        ...
        restoreSelectionIfLost: () => {
          ...
          if (!((A = h.current) != null && A.getSelection())) {
            const ct = oe.current;
            ct ? (et = h.current) == null || et.setSelection(ct) : (nt = h.current) == null || nt.selectNote(0);
          }
        },
        focusEditor: () => {
          var A;
        ...
        applyItem: (A) => {
          var et;
          return (et = h.current) == null ? void 0 : et.applyMarkerMenuSelection(A, {
            trigger: "backslash",
        ...
        onShowError: (A) => {
          (!Ec(A) || A.code !== Tc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Sc(A)}`
          );
        }
      });
    },
    ...
    var X;
    const R = (X = h.current) == null ? void 0 : X.getMarkerMenuContext();
    if (!R) return !1;
    const K = Gl(bt.styleInfo ?? ql, R);
    return K.length === 0 ? !1 : (ve(R, K, { passive: !R.hasTextSelection }), !0);
  }, [ve, bt.styleInfo]), mt = j(
    (R) => {
      const K = wt.current;
      if (!K || !w) return;
      Rs(R, K, {
        ...
        commitTyped: (y) => {
          var q;
          return (q = h.current) == null ? void 0 : q.commitTypedMarker(y);
        },
        commitTypedAndReopen: (y) => {
          var q;
          (q = h.current) == null || q.commitTypedMarker(y, { trailingSpace: !1 }), $();
        },
        commitTypedCloser: (y) => {
          var q;
          return (q = h.current) == null ? void 0 : q.commitTypedCloser(y);
        },
        commitItem: (y) => {
          var A;
          const q = K.items.find((et) => et.marker === y);
          q && ((A = h.current) == null || A.applyMarkerMenuSelection(q, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    const R = (K) => {
      var q, A;
      const X = (q = f.current) == null ? void 0 : q.querySelector(".editor-input");
      if (!X || K.target !== X) return;
      const y = (A = h.current) == null ? void 0 : A.getSelection();
      y && (oe.current = y);
    };
    ...
    var R;
    G && ((R = Ht.current) == null || R.focus());
  }, [G]), Y(() => {
    var X;
    const R = () => {
      var y;
      return ((y = f.current) == null ? void 0 : y.querySelector(".editor-input")) ?? void 0;
    };
    if (((X = bt.view) == null ? void 0 : X.markerMode) === "editable") {
      const y = (A) => {
        ...
        if (A.key === "Enter" && !xt()) {
          A.preventDefault(), A.stopPropagation(), (ct = h.current) == null || ct.selectNote(0), (_t = h.current) == null || _t.focus();
          return;
        }
        if (w && A.key === c) {
          if (!xt()) {
            A.preventDefault(), A.stopPropagation(), (Pt = h.current) == null || Pt.selectNote(0), (Vt = h.current) == null || Vt.focus();
            return;
          }
        ...
        var et, nt;
        const A = R();
        !A || document.activeElement !== A || xt() || ((et = h.current) == null || et.selectNote(0), (nt = h.current) == null || nt.focus());
      };
    ...
    const K = (y) => {
      const q = R();
      !G && q && document.activeElement === q && y.key === c ? (y.preventDefault(), zt()) : G && y.key === "Escape" && (y.preventDefault(), it(!1));
    };
    ...
    zt,
    c,
    (Qt = bt.view) == null ? void 0 : Qt.markerMode,
    bt.styleInfo,
    w,
    $,
    xt
    ...
    const R = () => {
      var y, q, A;
      const K = ((y = f.current) == null ? void 0 : y.querySelector(".editor-input")) ?? void 0;
      if (!K || document.activeElement !== K) return;
      const X = document.getSelection();
      X && !X.isCollapsed || xt() || ((q = h.current) == null || q.selectNote(0), (A = h.current) == null || A.focus());
    };
  ...
  const ce = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(ht, { children: [
    /* @__PURE__ */ u("div", { ref: x, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      /* @__PURE__ */ u("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(Ea, { children: [
          /* @__PURE__ */ a(
            iu,
            {
              onUndoClick: () => {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
              ...
              /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: ce }) })
            ] }) }) })
          ]
        }
      )
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(co, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
...
function Nu({
  ...
  /* @__PURE__ */ a("span", { className: b("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Go(t.marker, [i], o, !1),
    " "
  ] }), f = !!l, m = !!w, x = !!p, g = e === "horizontal" ? "horizontal" : "vertical", S = o ? "marker-visible" : "", k = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = b(g, S);
  return /* @__PURE__ */ u(ht, { children: [
...
function Dh({
  ...
  const p = d ?? Rc(r, void 0), h = (E, P) => {
    w == null || w(E, P, n);
  }, f = s ? r.findIndex((E) => E === s) : -1, [m, x] = _(f), g = (E, P, T) => {
    if (r.length)
      switch (E.key) {
        case "Enter":
        case " ":
  ...
  Y(() => {
    var E;
    m >= 0 && m < k.current.length && ((E = k.current[m]) == null || E.focus());
  }, [m]);
          ...
          children: r.map((E, P) => {
            ...
            return (
              ...
              /* @__PURE__ */ u(Xt.Fragment, { children: [
                ...
                P < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Lr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, B)
            );
          })
        }
...
function Eu({
  ...
  return /* @__PURE__ */ u(To, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(So, { stickyHeader: !0, children: /* @__PURE__ */ u(je, { children: [
    ...
    /* @__PURE__ */ a(Ro, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      je,
      {
        ...
        children: [
          /* @__PURE__ */ a(gr, { children: De(c.reference, "English") }),
          /* @__PURE__ */ a(gr, { className: o, children: Cu(c.text) })
        ]
      },
...
const Tu = (t) => {
...
}, Ia = (t, e, r) => /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
  /* @__PURE__ */ u(
    Et,
    {
  ...
  accessorKey: "status",
  header: ({ column: s }) => Ia(s, t, "tw:justify-center"),
  cell: ({ row: s }) => {
  ...
  return e ? e[1] : "";
}, Ru = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ah = Object.freeze([
...
function Vh({
  ...
  const f = xe(r, "%webView_inventory_all%"), m = xe(r, "%webView_inventory_approved%"), x = xe(r, "%webView_inventory_unapproved%"), g = xe(r, "%webView_inventory_unknown%"), S = xe(r, "%webView_inventory_scope_currentBook%"), k = xe(r, "%webView_inventory_scope_chapter%"), C = xe(r, "%webView_inventory_scope_verse%"), E = xe(r, "%webView_inventory_filter_text%"), P = xe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = xe(r, "%webView_inventory_no_results%"), [B, z] = _(!1), [D, M] = _("all"), [W, U] = _(""), [tt, N] = _([]), rt = V(() => {
    const Z = t ?? [];
    return Z.length === 0 ? [] : Mu(Z, n, s);
  }, [t, n, s]), O = V(() => {
    if (B) return rt;
    const Z = [];
    return rt.forEach((lt) => {
      const vt = lt.items[0], pt = Z.find(
        (It) => It.items[0] === vt
      );
      pt ? (pt.count += lt.count, pt.occurrences = pt.occurrences.concat(lt.occurrences)) : Z.push({
        items: [vt],
        count: lt.count,
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Du(O, D, W), [O, D, W]), G = V(() => {
    var vt, pt;
    if (!B) return l;
    ...
    for (let It = 0; It < Z; It++)
      lt.push(
        Su(
          ((pt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : pt[It]) || "Additional Item",
          It + 1
        )
      );
    return [...lt, ...l];
  ...
  const it = (Z, lt) => {
    lt.setRowSelection(() => {
      const pt = {};
      return pt[Z.index] = !0, pt;
    });
    const vt = Z.original.items;
    N(vt), h && vt.length > 0 && h(vt[0]);
  }, ot = (Z) => {
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        br,
        {
          onValueChange: (Z) => dt(Z),
          defaultValue: D,
          children: [
            /* @__PURE__ */ a(yr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(xr, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(kr, { children: [
              /* @__PURE__ */ a(ge, { value: "all", children: f }),
              /* @__PURE__ */ a(ge, { value: "approved", children: m }),
              /* @__PURE__ */ a(ge, { value: "unapproved", children: x }),
              /* @__PURE__ */ a(ge, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(br, { onValueChange: (Z) => ot(Z), defaultValue: i, children: [
        /* @__PURE__ */ a(yr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(xr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(kr, { children: [
          /* @__PURE__ */ a(ge, { value: "book", children: S }),
          /* @__PURE__ */ a(ge, { value: "chapter", children: k }),
          /* @__PURE__ */ a(ge, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Sa,
      ...
      o && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
        /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Mt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? P })
        ] }) }),
...
const Ou = "16rem", Iu = "3rem", os = Xt.createContext(void 0);
function za() {
  const t = Xt.useContext(os);
  if (!t)
...
function zu({
  ...
  const [l, d] = Xt.useState(t), w = e ?? l, p = Xt.useCallback(
    ...
    [r, w]
  ), h = Xt.useCallback(() => p((C) => !C), [p]), f = w ? "expanded" : "collapsed", g = Ce() === "ltr" ? i : i === "primary" ? "secondary" : "primary", S = Xt.useMemo(
    () => ({
      state: f,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(os.Provider, { value: S, children: /* @__PURE__ */ a(
    "div",
    {
...
function ju({
  ...
  const c = t ? Gr.Root : "button", { state: l } = za(), d = /* @__PURE__ */ a(
    c,
    {
...
function Fu({
  ...
  const p = j(
    ...
    (g) => {
      const S = r.find((k) => k.projectId === g);
      return S ? S.projectName : g;
    },
    [r]
  ), f = V(
    () => r.map((g) => ({
  ...
  return /* @__PURE__ */ a(
    Pu,
    {
      ...
      children: /* @__PURE__ */ u(Au, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          /* @__PURE__ */ a(Ln, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Vu, { children: Object.entries(e).map(([g, S]) => /* @__PURE__ */ a(Lu, { children: /* @__PURE__ */ a(
            ju,
            {
              onClick: () => p(g),
              isActive: x(g),
              children: /* @__PURE__ */ a("span", { className: "tw:pl-3", children: S })
            }
          ) }, g)) }) })
        ] }),
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(hc, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  Os,
                  {
                    mode: "project",
    ...
    /* @__PURE__ */ u(
      zu,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a($u, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
}
const Ve = "scrBook", Uu = "scrRef", Je = "source", Ku = "details", Hu = "Scripture Reference", Gu = "Scripture Book", ns = "Type", qu = "Details";
function Wu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? jt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ve ? De(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Ku,
      header: (t == null ? void 0 : t.detailsColumnName) ?? qu,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
const Yu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || ma(t.start, t.end) === 0 ? `${Ua(t.start)}+${e}` : `${Ua(t.start)}+${e}-${Ua(t.end)}+${r}`;
}, jn = (t) => `${Yu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Qh({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Ve, desc: !1 }]), [f, m] = _({}), x = V(
  ...
  Y(() => {
    if (c) {
      const D = S.getSelectedRowModel().rowsById, M = Object.keys(D);
      if (M.length === 1) {
        const W = x.find((U) => jn(U) === M[0]) || void 0;
        W && c(W);
      }
    }
  }, [f, x, c, S]);
  const k = n ?? Gu, C = s ?? ns, E = [
  ...
  }, B = (D, M) => D.getIsGrouped() ? "" : b("banded-row", M % 2 === 0 ? "even" : "odd"), z = (D, M, W) => {
    if (!((D == null ? void 0 : D.length) === 0 || M.depth < W.column.getGroupedIndex())) {
      if (M.getIsGrouped())
        switch (M.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      br,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(kr, { position: "item-aligned", children: /* @__PURE__ */ a(Xw, { children: E.map((D) => /* @__PURE__ */ a(ge, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(To, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(So, { children: S.getHeaderGroups().map((D) => /* @__PURE__ */ a(je, { children: D.headers.filter((M) => M.column.columnDef.header).map((M) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(fa, { colSpan: M.colSpan, className: "tw:sticky top-0", children: M.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Pr(M.column.columnDef.header, M.getContext())
        ] }) }, M.id)
      )) }, D.id)) }),
      /* @__PURE__ */ a(Ro, { children: S.getRowModel().rows.map((D, M) => {
        const W = Ce();
        return /* @__PURE__ */ a(
          je,
          {
                    ...
                    children: U.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(gc, {}) : /* @__PURE__ */ a(fc, {})),
                          " ",
                          Pr(U.column.columnDef.cell, U.getContext()),
                          " (",
                          D.subRows.length,
                          ")"
                        ]
...
function Xu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: m, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [g, S] = _(!1), [k, C] = _(""), E = F(void 0), P = F(!1), T = V(
    () => Xn(t),
    [t]
  ), B = V(() => {
    if (!k.trim()) {
    ...
    (N, rt = !1) => {
      ...
      const O = T.findIndex((dt) => dt === E.current), I = T.findIndex((dt) => dt === N);
      if (O === -1 || I === -1) return;
      const [G, it] = [
        Math.min(O, I),
        Math.max(O, I)
      ], ot = T.slice(G, it + 1).map((dt) => dt);
      r(
    ...
    z(N, P.current), P.current = !1;
  }, M = (N, rt) => {
    N.preventDefault(), z(rt, N.shiftKey);
  }, W = () => {
    r(T.map((N) => N));
  }, U = () => {
    r([]);
  }, tt = V(
    () => Object.values(Dt).filter(
          ...
          rr,
          {
            ...
            children: /* @__PURE__ */ u(
              ar,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (N) => {
                  N.key === "Enter" && (P.current = N.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    Ca,
                  ...
                  /* @__PURE__ */ u(or, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(Ta, { children: p }),
                    Object.values(Dt).filter((N) => B[N].length > 0).map((N, rt) => {
                      const O = B[N];
                      return /* @__PURE__ */ u(Kr, { children: [
                        rt > 0 && /* @__PURE__ */ a(Wn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Ke,
                          {
                            heading: Kn(N, h, f, m, x),
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ro ? ro : Fn
      ).map((d) => /* @__PURE__ */ a(Vr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Re(d, n) }, d)),
      e.length > ro && /* @__PURE__ */ a(
        Vr,
        {
...
function eg({
  ...
  const T = Bt(
    i,
    "%webView_scope_selector_selected_text%"
  ), B = Bt(i, "%webView_scope_selector_verse%"), z = Bt(i, "%webView_scope_selector_chapter%"), D = Bt(i, "%webView_scope_selector_book%"), M = Bt(
    i,
    "%webView_scope_selector_current_verse%"
  ), W = Bt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), U = Bt(i, "%webView_scope_selector_current_book%"), tt = Bt(i, "%webView_scope_selector_choose_books%"), N = Bt(i, "%webView_scope_selector_scope%"), rt = Bt(i, "%webView_scope_selector_select_books%"), O = Bt(i, "%webView_scope_selector_range%"), I = Bt(i, "%webView_scope_selector_select_range%"), G = Bt(i, "%webView_scope_selector_range_start%"), it = Bt(i, "%webView_scope_selector_range_end%"), ot = Bt(i, "%webView_scope_selector_ok%"), dt = Bt(i, "%webView_scope_selector_cancel%"), St = Bt(i, "%webView_scope_selector_navigate%"), Z = (L) => {
    if (!g) return;
    const Q = g.book.toUpperCase();
    switch (L) {
      case "verse":
        return De(g, "id");
      case "chapter":
        return `${Q} ${g.chapterNum}`;
      case "book":
        return Q;
      default:
        return;
  ...
  ], vt = (L, Q, $t = !1) => /* @__PURE__ */ u(ht, { children: [
    L,
    Q && !$t && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Q
    ] })
  ] }), pt = e ? lt.filter((L) => e.includes(L.value)) : lt, It = g ?? Ka, Ht = h ?? It, wt = f ?? It, me = () => {
  }, oe = F(null), bt = F(null), gt = F(!1), xt = F(null), Gt = F(!1), [Rt, Nt] = _(void 0), ft = F(!1), ne = F(!1), ie = F(null), se = j((L) => {
    if (L) {
      Nt("start"), ft.current = !1;
      return;
    }
    Nt((Q) => Q === "start" ? void 0 : Q), ft.current && (ft.current = !1, requestAnimationFrame(() => {
      var $t;
      const Q = ($t = oe.current) == null ? void 0 : $t.querySelector("button");
      Q == null || Q.click();
    }));
  }, []), $e = j((L) => {
    if (L) {
    ...
    (L) => {
      m == null || m(L), x == null || x(L), ft.current = !0;
    },
    [m, x]
  ), Ae = j(
    (L) => {
      x == null || x(L), ne.current = !0;
    },
    [x]
  ), zt = j(
    (L) => {
      r(L), L === "selectedBooks" && n.length === 0 && (g != null && g.book) && s([g.book]);
    },
    [r, n, g, s]
  ), kt = pt.find((L) => L.value === t), ve = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? Mc(Ht, wt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : kt ? vt(kt.label, kt.scrRefSuffix) : t, $ = pt.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), mt = pt.find((L) => L.value === "selectedBooks"), ce = pt.find((L) => L.value === "range"), [Qt, R] = _(!1), [K, X] = _(void 0), [y, q] = _(void 0), [A, et] = _(void 0), [nt, ct] = _(void 0), [_t, Pt] = _([]), Vt = p === "dropdown" && K === "selectedBooks", te = /* @__PURE__ */ a(
    tp,
    {
      availableBookInfo: o,
      selectedBookIds: Vt ? _t : n,
      onChangeSelectedBookIds: Vt ? Pt : s,
      localizedStrings: i,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Cr = Rt === "end", Er = Rt === "start", ir = "tw:text-muted-foreground", Ye = p === "dropdown" && K === "range", Pa = Ye ? et : Ut, $a = Ye ? ct : x ? Ae : me, Tr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-start", className: b(Cr && ir), children: G }),
      /* @__PURE__ */ a(
        Ga,
        {
    ...
    /* @__PURE__ */ u("div", { ref: oe, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-end", className: b(Er && ir), children: it }),
      /* @__PURE__ */ a(
        Ga,
        {
          id: "scope-range-end",
          ...
          localizedStrings: k,
          getEndVerse: C,
          disableReferencesUpTo: Ye ? A ?? Ht : Ht,
          onOpenChange: $e,
          onCloseAutoFocus: (L) => {
            var Q;
            ne.current && (ne.current = !1, L.preventDefault(), (Q = ie.current) == null || Q.focus());
          },
          className: b(Er && ir),
          modal: !0,
          align: "start"
  ...
  const [cr, Aa] = _(null), [Se, lr] = _(null), [dr, Va] = _(null), qr = 200, [La, Wr] = _(!1);
  Y(() => {
    if (!dr || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([Q]) => {
      Wr(Q.contentRect.width < qr);
    });
    return L.observe(dr), () => L.disconnect();
  }, [dr]);
  const Yr = j(
    (L) => {
      q(L), et(Ht), ct(wt), Pt(n), R(!1), X(L);
    },
    [Ht, wt, n]
  ), Xr = j(() => {
    y !== void 0 && (y === "range" ? (A && (m == null || m(A)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), zt(y), X(void 0), q(void 0));
  }, [
    y,
    A,
    nt,
    ...
    var Q;
    L.preventDefault(), (Q = be.current) == null || Q.focus();
  }, []), Zr = (L) => t === L ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(He, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(Mt, { children: N }),
      p === "dropdown" ? /* @__PURE__ */ u(Ie, { open: Qt, onOpenChange: R, children: [
        /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ u(
          J,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ve() }),
              /* @__PURE__ */ a(Qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          ze,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ja, { container: dr, children: [
              $.map(({ value: L, label: Q, dropdownLabel: $t, scrRefSuffix: le, id: pe }) => {
                ...
                return /* @__PURE__ */ u(
                  Be,
                  {
                    ...
                    children: [
                      t === L && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(He, { className: "tw:h-4 tw:w-4" }) }),
                      /* @__PURE__ */ u("span", { className: "tw:flex tw:min-w-0 tw:flex-col tw:gap-0.5", children: [
                        /* @__PURE__ */ a("span", { className: "tw:flex tw:items-center tw:gap-1.5", children: vt($t ?? Q, le, La) }),
              ...
              S && /* @__PURE__ */ u(ht, { children: [
                /* @__PURE__ */ a(Ze, {}),
                /* @__PURE__ */ a(tr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: St }),
                /* @__PURE__ */ a(
                  Be,
                  {
                    ref: xt,
                    ...
                    onSelect: (L) => {
                      var Q, $t;
                      if (L.preventDefault(), gt.current) {
                        gt.current = !1;
                        return;
                      }
                      Gt.current || ($t = (Q = bt.current) == null ? void 0 : Q.querySelector("button")) == null || $t.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (L) => {
                          ...
                          Q != null && Q.closest("button") && (gt.current = !0, requestAnimationFrame(() => {
                            gt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          Ga,
                          {
                            ...
                            onCloseAutoFocus: (L) => {
                              var Q;
                              L.preventDefault(), (Q = xt.current) == null || Q.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(ht, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: De(g ?? Ka, "id") }),
                              /* @__PURE__ */ a(Qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Co,
        {
          ...
          children: pt.map(({ value: L, label: Q, scrRefSuffix: $t, id: le }) => {
            const pe = d == null ? void 0 : d[L];
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
                /* @__PURE__ */ a(
                  ga,
                  {
                    ...
                    id: le,
                    disabled: !!pe,
                    "aria-describedby": pe ? `${le}-explanation` : void 0
                  }
                ),
                /* @__PURE__ */ a(Mt, { htmlFor: le, children: vt(Q, $t) })
              ] }),
    ...
    p === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { children: rt }),
      te
    ] }),
    p === "radio" && t === "range" && Tr,
    p === "dropdown" && mt && /* @__PURE__ */ a(ao, { open: K === "selectedBooks", onOpenChange: wr, children: /* @__PURE__ */ a(
      oo,
      {
        ref: lr,
        onCloseAutoFocus: Jr,
        onEscapeKeyDown: (L) => {
          Se != null && Se.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(ja, { container: Se, children: [
          /* @__PURE__ */ a(no, { className: "tw:pe-8", children: /* @__PURE__ */ a(io, { children: tt }) }),
          te,
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => wr(!1), children: dt }),
            /* @__PURE__ */ a(J, { onClick: Xr, children: ot })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && ce && /* @__PURE__ */ a(ao, { open: K === "range", onOpenChange: wr, children: /* @__PURE__ */ a(
      oo,
      {
        ref: Aa,
        onCloseAutoFocus: Jr,
        onEscapeKeyDown: (L) => {
          cr != null && cr.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(ja, { container: cr, children: [
          /* @__PURE__ */ a(no, { className: "tw:pe-8", children: /* @__PURE__ */ a(io, { children: I }) }),
          Tr,
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => wr(!1), children: dt }),
            /* @__PURE__ */ a(J, { ref: ie, onClick: Xr, children: ot })
          ] })
        ] })
      }
    ) })
...
function rg({
  ...
  return /* @__PURE__ */ u(
    br,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(yr, { size: n, className: b("pr-twp tw:w-auto", s), children: /* @__PURE__ */ a(
          xr,
          {
        ...
        /* @__PURE__ */ a(
          kr,
          {
            ...
            style: { zIndex: Pe },
            children: t.map((w) => /* @__PURE__ */ a(ge, { value: `${w}`, children: l[nn(w)] }, `${w}`))
          }
        )
      ]
    }
...
function ap(t) {
  const e = new Set(t.items.map((o) => o.group)), r = new Set(
    Object.entries(t.groups).flatMap(
      ([o, n]) => (
        // A group with no `column` belongs to a submenu, so it contributes to no column of this menu
        "column" in n && e.has(o) ? [n.column] : []
      )
    )
  );
  return ss(t.columns).filter(({ columnKey: o }) => r.has(o)).map(({ columnKey: o, column: n }) => ({ columnKey: o, label: n.label }));
}
...
const cs = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Et, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    Be,
    {
      ...
      children: [
        ...
        c.shortcut && /* @__PURE__ */ a(zs, { children: c.shortcut })
      ]
    },
    `dropdown-menu-item-${c.label}-${c.command}`
  ) : /* @__PURE__ */ u(Ps, { children: [
    /* @__PURE__ */ a($s, { children: c.label }),
    /* @__PURE__ */ a(As, { children: /* @__PURE__ */ a(Vs, { children: cs(
      t,
      e,
      is(t, c.id),
      o
...
function ko({
  ...
  const d = va(), w = ap(e), p = s && w.length > 1;
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(J, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(vc, {}) }) }),
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: Pe }, children: w.map(({ columnKey: h, label: f }, m) => {
      const x = `${d}-${h}`;
      return /* @__PURE__ */ u(Kr, { children: [
        /* @__PURE__ */ u(Gn, { "aria-labelledby": p ? x : void 0, children: [
          p && /* @__PURE__ */ a(tr, { id: x, children: f }),
          /* @__PURE__ */ a(Ot, { children: cs(e.groups, e.items, h, t) })
        ] }),
        m < w.length - 1 && /* @__PURE__ */ a(Ze, {})
      ] }, h);
    }) })
  ] });
}
...
const ip = Object.freeze([520, 420, 340]), ds = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = ls(n, ip), d = Ti() ?? l, w = d >= $r.MINIMUM;
...
function ig({
  ...
  return /* @__PURE__ */ u(ds, { className: `tw:w-full tw:border-b ${s}`, id: n, children: [
    r && /* @__PURE__ */ a(
      ko,
      {
        onSelectMenuItem: t,
...
function sg({
  ...
  return /* @__PURE__ */ a(ds, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    ko,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const ws = Xt.forwardRef(({ className: t, ...e }, r) => {
  const o = Ce();
  return /* @__PURE__ */ a(
    fe.Root,
    {
...
ws.displayName = fe.List.displayName;
const us = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.List,
  {
    ref: r,
    className: b(
...
const sp = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Trigger,
  {
    ref: r,
    ...e,
...
)), ps = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Content,
  {
    ref: r,
    className: b(
...
function cg({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ws, { children: [
      /* @__PURE__ */ a(us, { children: t.map((c) => /* @__PURE__ */ a(sp, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(ps, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function cp({
  ...
  return /* @__PURE__ */ a(Ls.Provider, { value: o, children: /* @__PURE__ */ a(
    Ee.Root,
    {
      "data-slot": "menubar",
      className: b(
...
function lp({ ...t }) {
  return /* @__PURE__ */ a(Ee.Menu, { "data-slot": "menubar-menu", ...t });
}
function dp({ ...t }) {
  return /* @__PURE__ */ a(Ee.Portal, { "data-slot": "menubar-portal", ...t });
}
function wp({
  className: t,
  ...e
...
function up({
  ...
  const i = Fr();
  return /* @__PURE__ */ a(dp, { children: /* @__PURE__ */ a(
    Ee.Content,
    {
...
function fp({ ...t }) {
  return /* @__PURE__ */ a(Ee.Sub, { "data-slot": "menubar-sub", ...t });
}
function mp({
  className: t,
  inset: e,
...
const Or = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
      ...
      /* @__PURE__ */ a(Et, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        pp,
        {
          ...
          children: [
            ...
            d.shortcut && /* @__PURE__ */ a(gp, { children: d.shortcut })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(fp, { children: [
        /* @__PURE__ */ a(mp, { children: d.label }),
        /* @__PURE__ */ a(vp, { children: hs(
          t,
          e,
          is(t, d.id),
          o
    ...
    return c.length > 0 && i < n.length - 1 && l.push(/* @__PURE__ */ a(hp, {}, `separator-${s}`)), l;
  });
};
function bp({
  menuData: t,
  ...
  if (Yl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = s.current) == null || m.focus(), Or(s, [h, f]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Or(i, [h, f]);
        break;
      case "alt+n":
        (g = c.current) == null || g.focus(), Or(c, [h, f]);
        break;
      case "alt+h":
        (S = l.current) == null || S.focus(), Or(l, [h, f]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(cp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ss(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(lp, { children: [
      /* @__PURE__ */ a(wp, { ref: d(w), children: p.label }),
      /* @__PURE__ */ a(
        up,
        {
          style: { zIndex: Pe },
          children: /* @__PURE__ */ a(Ot, { children: hs(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const xp = Object.freeze([950, 800, 700]);
function lg(t) {
  switch (t) {
    case void 0:
      return;
...
function wg({
  ...
  const d = yp(
    ...
    var S, k, C, E, P, T;
    const g = x !== m ? ((k = (S = t[m]) == null ? void 0 : S.uiNames) == null ? void 0 : k[x]) ?? ((E = (C = t[m]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
    return g ? `${(P = t[m]) == null ? void 0 : P.autonym} (${g})` : (T = t[m]) == null ? void 0 : T.autonym;
  };
      ...
      br,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: Pe },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(ge, { value: m, children: f(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Mt, { className: "tw:font-normal tw:text-muted-foreground", children: Fe(d, {
...
function pg({
  ...
  const [i, c] = _(""), l = V(
    ...
    return l.filter(({ keywords: x }) => x.some((g) => g.toLowerCase().includes(m)));
  }, [l, i]), w = l.length > 1, p = o["%firstRun_language_search_placeholder%"] ?? "", h = o["%firstRun_language_noResults%"] ?? "", f = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(ar, { id: s, className: b("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(Bs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(js, { children: /* @__PURE__ */ a(Bc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(or, { children: [
...
function _p({ item: t, createLabel: e, createComplexLabel: r }) {
      ...
      /* @__PURE__ */ a(
        Tt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: sn(d, {
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(Kr, { children: h }, `key-${f}`)
          )) })
        }
      )
    ] })
            ...
            d && (e || h && m) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ie, { children: [
                  /* @__PURE__ */ a(ke, { className: b(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    J,
                    {
...
function vg({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = V(() => {
    const c = new ni(o);
    return (l) => c.format(l);
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: i.map((c) => {
    let l = "upcoming";
    return c === s ? l = "active" : c < s && (l = "complete"), /* @__PURE__ */ u(Kr, { children: [
...
function Rg({
  ...
  return /* @__PURE__ */ u(
    Ft.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Ft.ItemIndicator, { children: /* @__PURE__ */ a(Da, {}) }) }),
        e
      ]
    }
  );
...
function qg({
  ...
  return /* @__PURE__ */ a(
    fe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: b("pr-twp", Sp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
const Dp = (t, e, r = {}) => {
  ...
  const [e, r] = _(!1), [o, n] = _(!1), [s, i] = _(0), c = F(void 0), l = V(() => {
    if (!t) return;
    const h = async () => {
      try {
        const f = await t();
...
function tf(t) {
  const e = V(() => Oc(t).slice().sort().join(" "), [t]);
...
function af({ value: t, children: e }) {
  return /* @__PURE__ */ a(Ei.Provider, { value: t, children: /* @__PURE__ */ a(Ma.Provider, { value: t, children: e }) });
}
const of = 300;
function Ip(t, e = "top") {
...
export {
  ...
  dh as COMMENT_EDITOR_STRING_KEYS,
  $w as COMMENT_LIST_ELEMENT_ID,
  wh as COMMENT_LIST_STRING_KEYS,
  ch as CONFLICT_NOTE_STRING_KEYS,
  ...
  Cg as ContextMenuContent,
  yg as ContextMenuGroup,
  Eg as ContextMenuItem,
  Mg as ContextMenuLabel,
  kg as ContextMenuPortal,
  Ng as ContextMenuRadioGroup,
  Dg as ContextMenuRadioItem,
  Og as ContextMenuSeparator,
  Ig as ContextMenuShortcut,
  _g as ContextMenuSub,
  Sg as ContextMenuSubContent,
  Tg as ContextMenuSubTrigger,
  xg as ContextMenuTrigger,
  tu as DataTable,
  ...
  Ju as DisabledTooltipWrapper,
  zg as Drawer,
  $g as DrawerClose,
  Ag as DrawerContent,
  jg as DrawerDescription,
  Lg as DrawerFooter,
  Vg as DrawerHeader,
  Tp as DrawerOverlay,
  Ep as DrawerPortal,
  ...
  kh as ERROR_POPOVER_STRING_KEYS,
  ...
  Eh as Footer,
  Sh as FootnoteEditor,
  Nu as FootnoteItem,
  Dh as FootnoteList,
  ug as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Ah as INVENTORY_STRING_KEYS,
  Sa as Input,
  pg as InterfaceLanguagePicker,
  Vh as Inventory,
  so as Kbd,
  Nf as KbdGroup,
  Mt as Label,
  ...
  Cf as PopoverDescription,
  Ef as PopoverHeader,
  ja as PopoverPortalContainerProvider,
  Tf as PopoverTitle,
  ...
  Sf as ResizableHandle,
  Rf as ResizablePanel,
  Df as ResizablePanelGroup,
  fg as ResultsCard,
  Mf as RetryableErrorView,
  tg as SCOPE_SELECTOR_STRING_KEYS,
  ep as SELECT_BOOKS_STRING_KEYS,
  $r as SHRINK_STEP,
  eg as ScopeSelector,
  Qh as ScriptureResultsViewer,
  rg as ScrollGroupSelector,
  Yn as SearchBar,
  br as Select,
  tp as SelectBooks,
  ...
  Xg as useEvent,
  Jg as useEventAsync,
  tf as useExtraValidMarkers,
  ks as useListbox,
  Dp as usePromise,
  oh as useRecentSearches,
  Zg as useRetryablePromise,
  ef as useRunWhenVisible,
  ls as useShrinkStep,
  Ti as useShrinkStepOverride,
  ed as useShrinkStepValue,
  za as useSidebar,
  Qg as useStylesheet,
  rf as useTabIconSelection,
  Zo as useTruncationTooltip,
  Mp as useViewVisibility
};
