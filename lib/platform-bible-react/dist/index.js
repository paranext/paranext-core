...
import b, { forwardRef as cn, useRef as H, useMemo as B, useState as R, useCallback as V, useLayoutEffect as It, createContext as Sn, useContext as xr, useEffect as q, Component as Mi, createElement as Jr, Suspense as Oi, Fragment as Do } from "react";
...
Pt.displayName = Ct.Group.displayName;
...
Sr.displayName = Ct.Separator.displayName;
    ...
    /* @__PURE__ */ r(
      Lt,
      {
        ...
        children: /* @__PURE__ */ w(Zt, { children: [
          ...
          /* @__PURE__ */ r(Qt, { children: F(e) ? e.map((M) => /* @__PURE__ */ r(Pt, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
function yo({
  ...
  const m = V(
    ...
    [t.user]
  ), N = B(() => bs(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ w(J, { children: [
        /* @__PURE__ */ w(
          an,
...
function Zc({
  ...
  const [A, M] = R(No), [E, S] = R(
    void 0
  ), j = o, [L, I] = R(!1), [P, W] = R(!1), [O, Z] = R(!1), [Tt, $t] = R(!1), [Mt, gt] = R(!1), [pt, U] = R(C), [it, st] = R(!1), ct = H(void 0), [xt, ee] = R(/* @__PURE__ */ new Map());
  q(() => {
    let T = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ w(J, { children: [
            ...
            v !== !1 && (!P || jt(A)) && /* @__PURE__ */ w(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Fr(T) && (T.preventDefault(), T.stopPropagation(), (jt(A) || E !== void 0) && Rt());
                },
                onKeyDown: (T) => {
...
function wd({
  ...
  var F;
  const [p, u] = R([]), [f, m] = R([]), [g, x] = R({}), [v, y] = R({}), N = B(() => e ?? [], [e]), k = ra({
    data: N,
    columns: t,
    getCoreRowModel: aa(),
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ w(Ut, { open: M, onOpenChange: p ?? N, children: [
    ...
    /* @__PURE__ */ r(Lt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ w(Zt, { children: [
      ...
      /* @__PURE__ */ w(Qt, { children: [
        ...
        /* @__PURE__ */ r(Pt, { children: K.map((S) => /* @__PURE__ */ w(
          Kt,
          {
            value: S.label,
            onSelect: k,
...
function yd({
  ...
  return /* @__PURE__ */ w(ae, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ w(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: xd(t, a, n) }) }) }),
...
function du({
  ...
  const [g, x] = R("generated"), [v, y] = R("*"), [N, k] = R("f"), [C, K] = R(!1), [F, A] = R(!0), [M, E] = R(!1), S = H(!1), j = H(""), [L, I] = R(!1), [P, W] = R(), [O, Z] = R(), [Tt, $t] = R(), [Mt, gt] = R(), pt = H(null), U = B(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const Ht = () => {
    ...
    if ($ && fn("note", $)) {
      ...
      N !== "x" && _ === "x" ? dt == null || dt.forEach((Rt) => Sd(Rt)) : N === "x" && _ !== "x" && (dt == null || dt.forEach((Rt) => Dd(Rt))), (bt = p.current) == null || bt.applyUpdate([$, { delete: 1 }]);
    }
  }, re = (_) => {
...
function xu({
  ...
  }, [A, W]), Z = B(() => O.length === 0 ? [] : zd(O, E, j), [O, E, j]), Tt = B(() => {
    var st, ct;
    if (!A) return d;
...
function $w({
  ...
  const F = B(() => ut.allBookIds.filter(
    ...
    (P, W = !1) => {
      ...
      const O = F.findIndex((gt) => gt === C.current), Z = F.findIndex((gt) => gt === P);
      if (O === -1 || Z === -1) return;
      const [Tt, $t] = [
        Math.min(O, Z),
        Math.max(O, Z)
      ], Mt = F.slice(Tt, $t + 1).map((gt) => gt);
      n(
    ...
    (P) => {
      const W = Xr(F, P).map((O) => O);
      n(
        wi(F, P, e) ? e.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, F]
  ), L = () => {
...
hi.displayName = Et.List.displayName;
const Vw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.Trigger,
  {
    ref: n,
...
gi.displayName = Et.Content.displayName;
function Pu({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
const tm = Et.Root, gp = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Et.List,
    {
...
gp.displayName = Et.List.displayName;
...
bp.displayName = Et.Trigger.displayName;
...
vp.displayName = Et.Content.displayName;
