...
import { useReactTable as Po, getFilteredRowModel as Xi, getSortedRowModel as $o, getPaginationRowModel as Ki, getCoreRowModel as Lo, flexRender as Xe, getGroupedRowModel as Ui, getExpandedRowModel as Yi } from "@tanstack/react-table";
...
Go.displayName = ft.Separator.displayName;
...
const Qo = tn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Oe : "button", { className: m(bl({ variant: t, size: n, className: e })), ref: s, ...a })
);
L.displayName = "Button";
const ge = Ee.Root, be = Ee.Trigger, pp = Ee.Anchor, ee = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = lt();
      ...
      if (i) {
        ...
        if (!p && c) {
          const u = ((g) => Object.keys(ce).find(
            (N) => ce[N].toLowerCase() === g.toLowerCase()
          ))(l);
...
function mp({
  ...
  const w = lt(), [p, f] = D(!1), [h, u] = D(""), [g, N] = D(""), [k, C] = D("books"), [_, x] = D(void 0), [R, A] = D(!1), E = rt(void 0), T = rt(void 0), M = rt(void 0), y = rt(void 0), S = rt({}), V = j(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
    ...
    (v) => {
      const z = k === "chapters" ? _ : O == null ? void 0 : O.book;
      z && (V({
        book: z,
        chapterNum: v,
        verseNum: 1
    ...
    (v) => {
      if (v.ctrlKey) return;
      const { isLetter: z, isDigit: Z } = qr(v.key);
      if (k === "chapters") {
        if (v.key === "Backspace") {
      ...
      if ((k === "chapters" || k === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ct = k === "chapters" ? _ : O == null ? void 0 : O.book;
        if (!ct) return;
        const mt = (() => {
          if (!h) return 1;
          const Be = h.match(/(\d+)$/);
        ...
        switch (v.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            It = mt === 0 ? re : Math.max(1, mt - $r);
            break;
          case "ArrowDown":
            It = mt === 0 ? 1 : Math.min(re, mt + $r);
            break;
          default:
            return;
        }
    ...
    const { isLetter: z, isDigit: Z } = qr(v.key);
    (z || Z) && (v.preventDefault(), N((ct) => ct + v.key), T.current.focus(), A(!1));
  }, []);
  return $t(() => {
    const v = setTimeout(() => {
      if (p && k === "books" && M.current && y.current) {
        const z = M.current, Z = y.current, ct = Z.offsetTop, mt = z.clientHeight, re = Z.clientHeight, It = ct - mt / 2 + re / 2;
        z.scrollTo({
          top: Math.max(0, It),
          behavior: "smooth"
        }), u(or(e.book));
  ...
  }, [k, _, O, e.book, e.chapterNum]), /* @__PURE__ */ d(ge, { open: p, onOpenChange: dt, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
      ...
      Qt,
      {
        ...
        children: [
          ...
          !R && /* @__PURE__ */ d(te, { ref: M, children: [
            k === "books" && /* @__PURE__ */ d(st, { children: [
              !O && Object.entries(W).map(([v, z]) => {
                if (z.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Bt, { heading: Mn(v), children: z.map((Z) => /* @__PURE__ */ o(
                      Qo,
                      {
                        bookId: Z,
                        onSelect: (ct) => yt(ct),
...
), it = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(_o.Root, { ref: n, className: m("pr-twp", kl(), e), ...t }));
it.displayName = _o.Root.displayName;
...
function ar({
  ...
  const [_, x] = D(!1), R = c ?? l, A = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], E = (T, M) => {
    const y = l(T), S = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, V = `${M ?? ""}${y}${S ?? ""}`;
    return /* @__PURE__ */ d(
      zt,
      {
        value: y,
...
const bp = [
  ...
  const a = rt(null), [s, i] = D(void 0), [l, c] = D(void 0), w = j(
    ...
    (u) => {
      var T;
      const g = u.target, N = (M) => M ? document.getElementById(M) : void 0, k = N(l), C = N(s);
      if (!!(k && g && k.contains(g) && g !== k) && f(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const y = M.findIndex((V) => V === g);
          if (y === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(y + 1, M.length - 1) : S = Math.max(y - 1, 0), S !== y && (u.preventDefault(), u.stopPropagation(), (T = M[S]) == null || T.focus());
          return;
        }
        return;
      }
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = ea ? $t : q, cn = { tag: gr };
function Ol({ initialConfig: e, children: t }) {
  const n = $(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Dl(null, r), p = Co({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, h) {
      if (h !== null) {
...
function zl() {
  return function(e) {
    const [t] = Ot(), n = $(() => e(t), [t, e]), [r, a] = D(() => n.initialValueFn()), s = rt(r);
    return Bl(() => {
...
function Fl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !oi(t) && r !== null) {
    ...
    if (w || p) {
      const [f, h] = ai(e), u = l.is(c), g = t.is(i ? c : l), N = t.is(i ? l : c);
      let k, C = 0;
...
ut.prototype.brand = Ul, ut.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ia(this), to(this), Ut++;
  const e = K;
...
jt({ build: (e, t, n) => Cn(t), config: nn({ $onClear: la }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Wt(() => wa(e, r.value));
} });
function Wl(e) {
...
const ir = jt({ build: (e) => ca(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Rr = 0, lr = 1, pa = 2, zn = 3, dn = 4, ye = 5, Fn = 6, ze = 7;
function Gn(e) {
  return e.id === Rr;
}
function ua(e) {
...
const nw = jt({ config: nn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: e = ew }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
const ow = /* @__PURE__ */ new Set(), oo = jt({ build(e, t, n) {
  const r = n.getDependency(ir).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ca(() => {
  }, () => Wt(() => {
  ...
  return Jt(e.registerCommand(mi, (i) => {
    if (hi(i.target)) {
      ...
      if (sw(l)) return function(c, w = !1) {
        ...
        let u;
        w && gi(p) ? u = p : (u = bi(), vi(u)), f ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
...
function iw(e, t) {
  return Jt(e.registerCommand(_i, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Kl(i, (h) => hn(h) && h.canIndent() ? h : null).length > 0) return !0;
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (Je(g)) {
                ...
                if (fn(k) && w >= 0 && p >= 0 && (C = w, _ = w + p, g.setTextNodeRange(k, C, k, _)), C === _ && f === "" || (g.insertRawText(f), k = N.getNode()), fn(k)) {
                  C = h, _ = h + u;
...
jt({ build: (e, t, n) => Cn(t), config: nn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Wt(() => n.getOutput().disabled.value ? void 0 : fa(e)) });
function pw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
  ...
  return function(n, r) {
    ...
    return Dr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = o(r, { onError: (h) => n._onError(h), children: o(ps, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
...
function hw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Dr(() => Jt(ji(a), fa(a)), [a]);
  }(r), d(st, { children: [e, o(fw, { content: t }), o(mw, { editor: r, ErrorBoundary: n })] });
}
...
function kw(e, t) {
  ...
  return d(st, { children: [o(yw, { editor: a, ...r, ref: t }), n != null && o(_w, { editor: a, content: n })] });
}
...
function Tw({
  ...
  const [t] = Ot(), [n, r] = D(t), [a, s] = D("paragraph"), [i, l] = Sw(), c = () => {
  };
...
function Mw() {
  const { activeEditor: e } = va(), [t, n] = D([]), r = j((a) => {
    if (Je(a) || Gi(a)) {
      const s = [];
      io.forEach(({ format: i }) => {
...
function Na(e, t, n, r = null) {
  ...
  const l = we(i) ? i.getChildren() : [], c = Oi(e, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    ...
    !a && we(t) && N && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ii(p) || Hr(p)) && p.append(h), n.append(p), f) {
      const u = f.call(i, p);
...
function _a(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (h = p(h)), Xr(e) && (h = $w(e, h, u ? () => {
    const g = new Mo();
    return n.push(g), g;
  ...
  }(e) && (i = i.concat(Oo())) : we(l) && l.append(...h), i;
}
function $w(e, t, n) {
...
Re.displayName = Vo.Root.displayName;
...
}), Pe = tt.Trigger, Da = tt.Group, Kw = tt.Portal, Uw = tt.Sub, Yw = tt.RadioGroup;
...
ne.displayName = tt.Content.displayName;
...
Yt.displayName = tt.CheckboxItem.displayName;
...
function lo({
    ...
    if (r && N)
      return /* @__PURE__ */ d(st, { children: [
        !Qs(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              h(!0), g(Bw(Fr(e.contents))), c == null || c(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ta, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Ra, { className: "tw-text-xs tw-font-medium", children: E }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: C,
              onKeyDownCapture: (y) => {
                y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), _()) : y.key === "Enter" && y.shiftKey && (y.preventDefault(), y.stopPropagation(), Ht(u) && x());
              },
              onKeyDown: (y) => {
        ...
        M && /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(Pe, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(bo, {}) }) }),
...
function Jw({
  ...
  const [C, _] = D(wo), [x, R] = D(!1), [A, E] = D(!1), [T, M] = D(!1), [y, S] = D(!1), [V, B] = D(!1), [F, I] = D(void 0), [W, O] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      O(!1), yt(!1);
  ...
  const _t = $(() => e.filter((v) => !v.deleted), [e]), bt = $(() => _t[0], [_t]), P = rt(null), Q = rt(void 0), dt = j(() => {
    var v;
    (v = Q.current) == null || v.call(Q), _(wo);
  }, []);
  q(() => {
    const v = P.current;
    if (!v) return;
  ...
  const wt = $(
  ...
  }, [a, t]), Gt = $(() => _t.slice(1), [_t]), vt = $(() => Gt.length ?? 0, [Gt.length]), Mn = $(() => vt > 0, [vt]), On = $(() => T || vt <= 2 ? Gt : Gt.slice(-2), [Gt, vt, T]), xe = $(() => T || vt <= 2 ? 0 : vt - 2, [vt, T]), sn = $(
    ...
    async (v) => {
      const z = Ht(C) ? cr(C) : void 0, Z = await w({
        ...v,
        contents: z,
        assignedUser: F ?? v.assignedUser
      });
      return Z && z && dt(), Z && F !== void 0 && I(void 0), Z;
    },
    [dt, C, w, F]
  );
  return /* @__PURE__ */ o(
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            A && /* @__PURE__ */ o(
              L,
              {
                ...
                children: x ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(ue, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
...
function vp({
  ...
  const [h, u] = D(), g = t.filter(
    ...
    u(E);
  }, []), { listboxRef: _, activeId: x, handleKeyDown: R } = Rl({
    options: N,
    onOptionSelect: k
  }), A = j(
    (E) => {
...
const De = at.Root, Zw = at.Group, Me = at.Value, Qw = Zt(
  ...
  return /* @__PURE__ */ d(
    at.Trigger,
    {
      ...
      children: [
        t,
        /* @__PURE__ */ o(at.Icon, { asChild: !0, children: /* @__PURE__ */ o(ue, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
he.displayName = at.Trigger.displayName;
...
fe.displayName = at.Content.displayName;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        De,
        {
          ...
          children: [
            /* @__PURE__ */ o(he, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ o(Me, { placeholder: e.getState().pagination.pageSize }) }),
...
function wc({
  ...
  var E;
  const [p, f] = D([]), [h, u] = D([]), [g, N] = D({}), [k, C] = D({}), _ = $(() => t ?? [], [t]), x = Po({
    data: _,
    columns: e,
    getCoreRowModel: Lo(),
  ...
  }), R = x.getVisibleFlatColumns();
  let A;
  return c ? A = Array.from({ length: 10 }).map((y, S) => `skeleton-row-${S}`).map((y) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(pe, { colSpan: R.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, y)) : ((E = x.getRowModel().rows) == null ? void 0 : E.length) > 0 ? A = x.getRowModel().rows.map((T) => /* @__PURE__ */ o(
    At,
    {
      onClick: () => i(T, x),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map((M) => /* @__PURE__ */ o(pe, { children: Xe(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    T.id
  )) : A = /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(pe, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Ww, { table: x }),
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: x.getHeaderGroups().map((T) => /* @__PURE__ */ o(At, { children: T.headers.map((M) => /* @__PURE__ */ o(Qe, { children: M.isPlaceholder ? void 0 : Xe(M.column.columnDef.header, M.getContext()) }, M.id)) }, T.id)) }),
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(ve, { children: [
    ...
    /* @__PURE__ */ o(ne, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Da, { children: w.itemType === 0 ? /* @__PURE__ */ o(st, { children: w.items.map((f, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Yt,
        {
          checked: r[p][h],
...
function mc({
  ...
  const [C, _] = D(!1), x = j(
    ...
    const S = e.filter((B) => B.starred).sort((B, F) => B.label.localeCompare(F.label)), V = e.filter((B) => !B.starred).sort((B, F) => {
      const I = t.includes(B.value), W = t.includes(F.value);
      return I && !W ? -1 : !I && W ? 1 : B.label.localeCompare(F.label);
    });
    return [...S, ...V];
  }, [e, t, h]), E = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: k, className: g, children: /* @__PURE__ */ d(ge, { open: M, onOpenChange: p ?? _, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: N,
    ...
    /* @__PURE__ */ o(ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Qt, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: E, children: s }),
        /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: T, children: i })
      ] }),
...
const hc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(st, { children: [
...
function fc({
  ...
  return q(() => {
    ...
    /* @__PURE__ */ d(ne, { className: "tw-z-[300]", children: [
...
const gc = (e, t) => e === "f" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ o(yo, {}),
  " ",
...
function Sp({
  ...
  const l = rt(null), c = us(), [w, p] = D("generated"), [f, h] = D("*"), [u, g] = D("f"), N = $(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (R && $n("note", R)) {
      ...
      let M = "custom";
      T === Qn ? M = "generated" : T === tr ? M = "hidden" : T && h(T), p(M), g(((E = R.insert.note) == null ? void 0 : E.style) ?? "f"), R.insert.note && (R.insert.note.caller = ""), x = setTimeout(() => {
        var y;
        (y = l.current) == null || y.applyUpdate([{ delete: 1 }, R]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const k = j(() => {
    var R, A;
    const x = (A = (R = l.current) == null ? void 0 : R.getNoteOps(0)) == null ? void 0 : A.at(0);
    x && $n("note", x) && (x.insert.note && (w === "custom" ? x.insert.note.caller = f : x.insert.note.caller = w === "generated" ? Qn : tr), t([x]));
  }, [w, f, t]), C = () => {
    var R;
    const x = (R = c.current) == null ? void 0 : R.getElementsByClassName("editor-input")[0];
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
        ...
        /* @__PURE__ */ o(
          vc,
          {
            ...
            handleNoteTypeChange: (x) => {
              ...
              R && $n("note", R) && (R.insert.note && (R.insert.note.style = x), (T = l.current) == null || T.applyUpdate([{ delete: 1 }, R]));
            },
            localizedStrings: i
          }
        ),
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ o(Wi, { options: N, onScrRefChange: () => {
          }, scrRef: r, ref: l }),
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Kt, { children: [
            /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: C, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
...
function Nc({
  ...
  /* @__PURE__ */ d("span", { className: m("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    Ir(e.marker, [i], r, !1),
    " "
  ] }), h = t === "horizontal" ? "horizontal" : "vertical", u = r ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", N = m(h, u);
  return /* @__PURE__ */ d(st, { children: [
    /* @__PURE__ */ d("div", { className: m("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", N), children: [
      c,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: m("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", N), children: f }),
    /* @__PURE__ */ o(
      "div",
      {
        className: m(
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(st, { children: xc(e.marker, l, r, w) })
      }
    )
  ] });
}
function Rp({
  ...
  const p = c ?? ri(n, void 0), f = (_, x) => {
    w == null || w(_, x, a);
  }, h = s ? n.findIndex((_) => _ === s) : -1, [u, g] = D(h), N = (_, x, R) => {
    if (n.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), w == null || w(x, R, a);
          break;
      }
  }, k = (_) => {
    if (n.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), g((x) => Math.min(x + 1, n.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), g((x) => Math.max(x - 1, 0));
          break;
      }
  }, C = rt([]);
  return q(() => {
        ...
        "ul",
        {
          ...
          children: n.map((_, x) => {
            ...
            return /* @__PURE__ */ d(st, { children: [
              ...
              x < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(Re, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
    ...
    /* @__PURE__ */ o(Tn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      At,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(pe, { children: kc(i.text) })
        ]
      },
...
function $p({
  ...
  const f = Tt(n, "%webView_inventory_all%"), h = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), N = Tt(n, "%webView_inventory_scope_currentBook%"), k = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), x = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), R = Tt(n, "%webView_inventory_no_results%"), [A, E] = D(!1), [T, M] = D("all"), [y, S] = D(""), [V, B] = D([]), F = $(() => {
    const P = e ?? [];
  ...
  }, [A, F]), W = $(() => I.length === 0 ? [] : Sc(I, T, y), [I, T, y]), O = $(() => {
    var dt, wt;
    if (!A) return c;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        De,
        {
          ...
          defaultValue: T,
          children: [
            /* @__PURE__ */ o(he, { className: "tw-m-1", children: /* @__PURE__ */ o(Me, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(De, { onValueChange: (P) => yt(P), defaultValue: i, children: [
        /* @__PURE__ */ o(he, { className: "tw-m-1", children: /* @__PURE__ */ o(Me, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(fe, { children: [
...
const La = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), f = t ?? w, h = b.useCallback(
      (x) => {
        const R = typeof x == "function" ? x(f) : x;
        n ? n(R) : p(R);
      },
      [n, f]
    ...
    return /* @__PURE__ */ o($a.Provider, { value: _, children: /* @__PURE__ */ o(Vt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
    ...
    Ba,
    {
      ...
      children: /* @__PURE__ */ d(za, { children: [
        /* @__PURE__ */ d(pr, { children: [
          ...
          /* @__PURE__ */ o(mr, { children: /* @__PURE__ */ o(Fa, { children: Object.entries(t).map(([h, u]) => /* @__PURE__ */ o(Ga, { children: /* @__PURE__ */ o(
            Ha,
            {
              onClick: () => w(h),
              isActive: f(h),
...
const Xt = "scrBook", Kc = "scrRef", ie = "source", Uc = "details", Yc = "Scripture Reference", qc = "Scripture Book", Xa = "Type", Jc = "Details";
function Wc(e, t) {
  const n = t ?? !1;
  return [
    {
...
function zp({
  ...
  const [w, p] = D([]), [f, h] = D([{ id: Xt, desc: !1 }]), [u, g] = D({}), N = $(
  ...
  q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const V = N.find((B) => uo(B) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, N, l, C]);
  const _ = a ?? qc, x = s ?? Xa, R = [
  ...
  }, T = (y, S) => y.getIsGrouped() ? "" : m("banded-row", S % 2 === 0 ? "even" : "odd"), M = (y, S, V) => {
    if (!((y == null ? void 0 : y.length) === 0 || S.depth < V.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ d(
      De,
      {
        ...
        children: [
          /* @__PURE__ */ o(he, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ o(Me, {}) }),
          /* @__PURE__ */ o(fe, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: R.map((y) => /* @__PURE__ */ o(kt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: C.getHeaderGroups().map((y) => /* @__PURE__ */ o(At, { children: y.headers.filter((S) => S.column.columnDef.header).map((S) => (
      ...
      /* @__PURE__ */ o(Tn, { children: C.getRowModel().rows.map((y, S) => {
        const V = lt();
        return /* @__PURE__ */ o(
          At,
          {
...
function td({
  ...
  }, [k, C] = D(!1), [_, x] = D(""), R = rt(void 0), A = rt(!1);
  if (e.length !== Y.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const E = $(() => Y.allBookIds.filter(
    (I, W) => e[W] === "1" && !Y.isObsolete(Y.bookIdToNumber(I))
  ), [e]), T = $(() => {
    if (!_.trim()) {
      const O = {
        [H.OT]: [],
    ...
    (I, W = !1) => {
      ...
      const O = E.findIndex((P) => P === R.current), ot = E.findIndex((P) => P === I);
      if (O === -1 || ot === -1) return;
      const [yt, _t] = [
        Math.min(O, ot),
        Math.max(O, ot)
      ], bt = E.slice(yt, _t + 1).map((P) => P);
      n(
        t.includes(I) ? t.filter((P) => !bt.includes(P)) : [.../* @__PURE__ */ new Set([...t, ...bt])]
      );
    },
    [t, n, E]
  ), y = (I) => {
    ...
    I.preventDefault(), M(W, I.shiftKey);
  }, V = j(
    (I) => {
      const W = Pr(E, I).map((O) => O);
      n(
        Ka(E, I, t) ? t.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...t, ...W])]
      );
    },
    [t, n, E]
  ), B = () => {
                  ...
                  Object.values(H).map((I, W) => {
                    ...
                    if (O.length !== 0)
                      return /* @__PURE__ */ d(ho, { children: [
                        ...
                        W < Object.values(H).length - 1 && /* @__PURE__ */ o(Go, {})
                      ] }, I);
                  })
                ] })
              ]
...
function Gp({
  ...
  const w = oe(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = oe(i, "%webView_scope_selector_current_book%"), u = oe(i, "%webView_scope_selector_choose_books%"), g = oe(i, "%webView_scope_selector_scope%"), N = oe(i, "%webView_scope_selector_select_books%"), k = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: C.map(({ value: _, label: x, id: R }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(gn, { className: "tw-me-2", value: _, id: R }),
            /* @__PURE__ */ o(it, { htmlFor: R, children: x })
          ] }, R))
        }
      )
    ] }),
...
function Hp({
  ...
  return /* @__PURE__ */ d(
    De,
    {
      ...
      children: [
        /* @__PURE__ */ o(he, { size: a, className: m("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          Me,
          {
            placeholder: l[U(t)] ?? t
          }
...
function hr({
  ...
  return /* @__PURE__ */ d(ve, { variant: s, children: [
    ...
    /* @__PURE__ */ o(ne, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(ho, { children: [
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (N = i.current) == null || N.focus(), Fe(i, [h, u]);
        break;
      case "alt+n":
        (k = l.current) == null || k.focus(), Fe(l, [h, u]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ o(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ d(nd, { children: [
...
function Qp({
  ...
  const w = ld(
    ...
    var C, _, x, R, A, E;
    const k = N !== g ? ((_ = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : _[N]) ?? ((R = (x = e[g]) == null ? void 0 : x.uiNames) == null ? void 0 : R.en) : void 0;
    return k ? `${(A = e[g]) == null ? void 0 : A.autonym} (${k})` : (E = e[g]) == null ? void 0 : E.autonym;
  };
  return /* @__PURE__ */ d("div", { id: c, className: m("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      De,
      {
        ...
        onOpenChange: (g) => f(g),
        children: [
          /* @__PURE__ */ o(he, { children: /* @__PURE__ */ o(Me, {}) }),
          /* @__PURE__ */ o(
            fe,
            {
              className: "tw-z-[250]",
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ o(Pe, { className: m(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(bo, {}) }) }),
...
const cd = tn(({ className: e, ...t }, n) => /* @__PURE__ */ o(Ks, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
Od.displayName = Ge.Root.displayName;
...
const hu = gt.Root, Ad = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ o(
    gt.List,
    {
