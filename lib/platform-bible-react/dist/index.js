...
import { c as v, g as Re, a as Ir, C as Ge, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as ze, f as ke, h as Ie, i as kr, j as Be, B as J, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ke, r as Ce, o as xs, p as Kn, P as tr, q as _r, s as er, t as rr, v as Na, w as Ca, y as No, z as ar, E as Ea, F as Mt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as pr, W as ys, X as Ze, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as qn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Gn, aa as Ta, ab as Cs, ac as Wn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as Yn, al as Xn, am as Do, an as Os, ao as Jn, ap as Ba, aq as tn, ar as ja, as as zs, at as Is, au as Ps, av as $s, aw as As, ax as Fr, ay as Mo, az as Vs, aA as Ls } from "./resizable-Cbwu4ANg.js";
import { aB as ef, aC as rf, aD as af, aE as of, aF as nf, aG as sf, aH as cf, aI as lf, aJ as df, aK as wf, aL as uf, aM as pf, aN as hf, aO as gf, aP as ff, aQ as mf, aR as vf, aS as bf, aT as xf, aU as yf, aV as kf, aW as _f, aX as Nf, aY as Cf, aZ as Ef, a_ as Tf, a$ as Sf, b0 as Rf, b1 as Df, b2 as Mf, b3 as Of, b4 as zf, b5 as If, b6 as Pf, b7 as $f, b8 as Af, b9 as Vf, ba as Lf } from "./resizable-Cbwu4ANg.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Zn, ChevronDown as Qe, ArrowLeft as Bs, ArrowRight as js, BoldIcon as Fs, ItalicIcon as Us, X as Oo, AtSign as Qn, Pencil as Ks, Trash2 as Hs, ArrowUp as ti, MoreHorizontal as qs, MailOpen as Gs, Mail as Ws, FilterIcon as Ys, ArrowLeftIcon as Xs, ChevronLeftIcon as Js, ChevronRightIcon as Zs, ArrowRightIcon as Qs, Copy as ei, Filter as tc, User as ec, Link as rc, CircleHelp as ac, Undo as oc, Redo as nc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as ic, AlertCircle as so, CircleCheckIcon as sc, CircleXIcon as cc, CircleHelpIcon as lc, ArrowUpIcon as dc, ArrowDownIcon as wc, ScrollText as uc, ChevronRight as pc, ChevronLeft as hc, ChevronsUpDown as gc, MenuIcon as fc, Menu as mc, EllipsisVertical as vc, MoreVertical as bc } from "lucide-react";
import { Section as Dt, resolveLocalizedString as re, compareScrRefs as ma, getChaptersForBook as xc, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as ia, formatRelativeDate as yc, sanitizeHtml as zo, NumberFormat as ni, formatBytes as kc, getCurrentLocale as _c, usfmMarkers as sa, isPlatformError as Nc, ABORTED as Cc, getErrorMessage as Ec, getFormatCallerFunction as Tc, deepEqual as Sc, isString as on, scrRefToBBBCCCVVV as Fa, defaultScrRef as Ua, formatScrRefRange as Rc, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as Dc } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Sa, useState as _, useEffect as Y, useCallback as j, useId as co, useImperativeHandle as Mc, useLayoutEffect as Jt, Fragment as Kr, Component as Oc, createElement as cn, Suspense as zc, forwardRef as ii } from "react";
...
function od({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = co(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, rd), P = re(s, ad), T = (M) => {
...
function Ha({
  ...
  const T = Ce(), B = Zl(), [I, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, z] = _(void 0), [q, it] = _(
    void 0
    ...
    if (!$) return;
    const m = M.startsWith(`${$.book} `) ? M : "", H = ta(m), at = zr(m);
    return {
      book: $.book,
  ...
  const Qt = j(() => {
    ...
    const m = q;
    it(void 0), dt(void 0), m ? (z(m), rt("chapters"), W("")) : et();
  }, [q, et]), ct = j(
    (m) => {
      D(m), m && (rt("books"), z(void 0), it(void 0), dt(void 0), tt(""), wt(!1), zt(!1), vt(kt));
    },
    [kt]
  );
  Y(() => {
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    [t.book, s, B]
  ), Pa = `${t.chapterNum}:${t.verseNum}`, Tr = j((m) => (H) => {
    Rt.current[m] = H;
  }, []), Sr = j((m) => (H) => {
    Nt.current[m] = H;
  }, []), ir = V(
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onFocus: (m) => {
                    zt(m.target !== gt.current);
                  },
                  onBlur: (m) => {
                    m.currentTarget.contains(m.relatedTarget) || zt(!1);
                  },
                  children: [
...
function xn({
  ...
  const [C, E] = _(!1), P = d ?? l, T = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], B = (I, D) => {
    const M = l(I), W = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, U = `${D ?? ""}${M}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Ge,
      {
        value: M,
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vd = Di ? Jt : Y, ra = { tag: Io };
...
const xd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
const Ed = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Td(t) {
...
function Od(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      ...
      const I = ye(k.height);
      E.height !== I && (C.style.height = I, b = !0), C.parentNode !== c && (c.append(C), b = !0), i[R] = C;
    }
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((T || B) && E !== null && P !== null) {
        const I = function(D, M, W, U, tt, N, rt) {
...
function Ad(t) {
  ...
  const o = Vd(t, r), n = Gc(o), s = Wc(n) ? Yc(n) : o;
...
Yt.prototype.brand = Bd, Yt.prototype.h = function() {
  return !0;
...
const Wa = al("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ai extends lo {
  $config() {
...
const jo = 0, yo = 1, Bi = 2, Ya = 3, aa = 4, wr = 5, Xa = 6, Mr = 7;
function Ja(t) {
  return t.id === jo;
}
function ji(t) {
...
const hw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function fw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: x, role: b = "textbox", spellCheck: R = !0, style: k, tabIndex: C, "data-testid": E, ...P }, T) {
  const [B, I] = _(t.isEditable()), D = j((W) => {
  ...
  return Hi(() => (I(t.isEditable()), t.registerEditableListener((W) => {
    I(W);
...
function zn({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a($w, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Aw, { className: "tw:text-xs tw:font-medium", children: R }) }),
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              J,
              {
                ...
                children: wt ? /* @__PURE__ */ a(Gs, {}) : /* @__PURE__ */ a(Ws, {})
              }
            ),
            M === void 0 ? (
...
function Bw({
  ...
  const [i, c] = _("accept"), l = co(), d = co(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : i, x = V(
    () => ua(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = V(
    () => ua(t.acceptedText ?? ""),
...
function Hw(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = Kw({
    threadId: n,
    threadStatus: s,
    isSelected: o,
    activeComments: c,
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(Hw, { ...q, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...q })
          },
          z.id
        );
      })
...
function _h({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [I, D] = _("f"), [M, W] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), z = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, zt] = _(), Ht = F(null), wt = F(
    void 0
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      I !== "x" && S === "x" ? nt == null || nt.forEach((ct) => fu(ct)) : I === "x" && S !== "x" && (nt == null || nt.forEach((ct) => mu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (S) => {
    zt(S.contextMarker), rt(S.canRedo);
  }, Ae = j(
    (S) => {
      var X, y, G, A, et;
      const K = (y = (X = h.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : y.at(0);
...
function zh({
  ...
  const g = xe(r, "%webView_inventory_all%"), f = xe(r, "%webView_inventory_approved%"), x = xe(r, "%webView_inventory_unapproved%"), b = xe(r, "%webView_inventory_unknown%"), R = xe(r, "%webView_inventory_scope_currentBook%"), k = xe(r, "%webView_inventory_scope_chapter%"), C = xe(r, "%webView_inventory_scope_verse%"), E = xe(r, "%webView_inventory_filter_text%"), P = xe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = xe(r, "%webView_inventory_no_results%"), [B, I] = _(!1), [D, M] = _("all"), [W, U] = _(""), [tt, N] = _([]), rt = V(() => {
    const Z = t ?? [];
  ...
  }, [B, rt]), z = V(() => O.length === 0 ? [] : Tu(O, D, W), [O, D, W]), q = V(() => {
    var vt, pt;
    if (!B) return l;
...
function Vu({
  ...
  const c = t ? qr.Root : "button", { state: l } = za(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Au({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Ou,
    {
      ...
      children: /* @__PURE__ */ u(Iu, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Pu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a($u, { children: /* @__PURE__ */ a(
            Vu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
function Wh({
  ...
  }, B = (D, M) => D.getIsGrouped() ? "" : v("banded-row", M % 2 === 0 ? "even" : "odd"), I = (D, M, W) => {
                    ...
                    children: U.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(pc, {}) : /* @__PURE__ */ a(hc, {})),
                          " ",
...
function Xh({
  ...
  ] }), pt = e ? lt.filter((L) => e.includes(L.value)) : lt, zt = b ?? Ua, Ht = h ?? zt, wt = g ?? zt, me = () => {
  ...
  ), Cr = Rt === "end", Er = Rt === "start", nr = "tw:text-muted-foreground", Ye = p === "dropdown" && K === "range", Ia = Ye ? et : Ut, Pa = Ye ? ct : x ? Ae : me, Tr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [sr, $a] = _(null), [Se, cr] = _(null), [lr, Aa] = _(null), Gr = 200, [Va, Wr] = _(!1);
  Y(() => {
  ...
  const Yr = j(
    ...
    y !== void 0 && (y === "range" ? (A && (f == null || f(A)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), It(y), X(void 0), G(void 0));
  }, [
    y,
    A,
    nt,
  ...
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      p === "dropdown" ? /* @__PURE__ */ u(ze, { open: Qt, onOpenChange: S, children: [
                        ...
                        children: /* @__PURE__ */ a(
                          Ha,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(ht, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: De(b ?? Ua, "id") }),
                              /* @__PURE__ */ a(Qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
...
function Fg({
  ...
  return /* @__PURE__ */ a(
    fe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", _p({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  _f as ResizableHandle,
  Nf as ResizablePanel,
  Cf as ResizablePanelGroup,
  wg as ResultsCard,
  Ef as RetryableErrorView,
  ...
  Mf as Z_INDEX_FIRST_RUN,
  Of as Z_INDEX_MODAL,
  zf as Z_INDEX_MODAL_BACKDROP,
  If as Z_INDEX_ONBOARDING_TOUR,
  Pf as Z_INDEX_OVERLAY,
  $f as badgeVariants,
