...
import { c as m, g as me, a as _r, C as Se, u as Oo, T as Dt, b as Mt, d as Ot, e as It, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Zi, l as Qi, m as ts, I as es, n as io, r as ye, o as rs, p as En, q as la, s as da, L as Et, R as so, t as ea, D as ja, v as Ba, w as Fa, y as Ua, z as Tn, E as Gr, F as co, G as Sn, H as lo, J as Je, K as Er, M as je, N as Be, O as Fe, S as Tr, Q as nr, U as as, V as zr, W as Ze, X as Oe, Z as tr, Y as De, _ as ir, $ as wo, a0 as uo, a1 as ra, a2 as po, a3 as Rn, a4 as os, a5 as ns, a6 as is, a7 as Ka, a8 as zn, a9 as wa, aa as ss, ab as Dn, ac as cs, ad as ls, ae as ds, af as Io, ag as ws, ah as us, ai as ps, aj as hs, ak as Mn, al as On, am as ho, an as gs, ao as In, ap as Na, aq as $o, ar as Ca, as as fs, at as ms, au as vs, av as bs, aw as xs, ax as Dr, ay as go, az as ys, aA as ks } from "./resizable-CPdgp7Xh.js";
import { aB as Tg, aC as Sg, aD as Rg, aE as zg, aF as Dg, aG as Mg, aH as Og, aI as Ig, aJ as $g, aK as Pg, aL as Ag, aM as Vg, aN as Lg, aO as jg, aP as Bg, aQ as Fg, aR as Ug, aS as Kg, aT as Hg, aU as Gg, aV as qg, aW as Wg, aX as Yg, aY as Xg, aZ as Jg, a_ as Zg, a$ as Qg, b0 as tf, b1 as ef, b2 as rf, b3 as af, b4 as of, b5 as nf, b6 as sf, b7 as cf } from "./resizable-CPdgp7Xh.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as zt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Po, ChevronsLeft as Ao, ChevronsRight as Vo, ChevronLeft as Ha, ChevronRight as Ga, ArrowLeft as _s, ArrowRight as Ns, ChevronDown as lr, BoldIcon as Cs, ItalicIcon as Es, X as fo, AtSign as $n, Pencil as Ts, Trash2 as Ss, ArrowUp as Pn, MoreHorizontal as Rs, MailOpen as zs, Mail as Ds, ChevronUp as Ms, FilterIcon as Os, ArrowLeftIcon as Is, ChevronLeftIcon as $s, ChevronRightIcon as Ps, ArrowRightIcon as As, Copy as An, Filter as Vs, User as Ls, Link as js, CircleHelp as Bs, Undo as Fs, Redo as Us, SquareX as Vn, FunctionSquare as Ln, SquareSigma as jn, Ban as Ks, AlertCircle as qa, CircleCheckIcon as Hs, CircleXIcon as Gs, CircleHelpIcon as qs, ArrowUpIcon as Ws, ArrowDownIcon as Ys, ScrollText as Xs, ChevronsUpDown as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as tc, MoreVertical as ec } from "lucide-react";
import { Section as Ct, getChaptersForBook as rc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as qr, formatRelativeDate as ac, sanitizeHtml as mo, NumberFormat as Bn, formatBytes as oc, getCurrentLocale as nc, usfmMarkers as Wr, isPlatformError as ic, ABORTED as sc, getErrorMessage as cc, getFormatCallerFunction as lc, deepEqual as dc, isString as Lo, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as wc, getLocalizeKeyForScrollGroupId as jo, formatReplacementStringToArray as Bo, collectUsjMarkers as uc } from "platform-bible-utils";
import Yt, { useRef as F, useMemo as A, createContext as ua, useContext as vo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as pc, useLayoutEffect as te, Component as hc, createElement as Fo, Suspense as gc, forwardRef as Fn, useId as Uo, Fragment as pa } from "react";
import { IconSelector as Un, IconCheck as ha, IconChevronDown as fc, IconChevronUp as mc, IconLayoutSidebar as vc, IconLayoutSidebarRight as bc, IconChevronRight as Kn, IconSearch as xc, IconLoader as yc, IconAlertOctagon as kc, IconAlertTriangle as _c, IconInfoCircle as Nc, IconCircleCheck as Cc } from "@tabler/icons-react";
import { createEditor as Hn, $getRoot as $e, $createParagraphNode as Mr, $getSelection as ee, HISTORY_MERGE_TAG as bo, ParagraphNode as Gn, TextNode as qn, $getPreviousSelection as Ec, $isRangeSelection as be, $caretFromPoint as Tc, $getSiblingCaret as Wn, $getChildCaret as Sc, $getAdjacentChildCaret as Rc, $isChildCaret as zc, $normalizeCaret as Dc, $setSelectionFromCaretRange as Mc, $getCollapsedCaretRange as Oc, $getCaretInDirection as Ko, $splitAtPointCaretNext as Ic, $isTextPointCaret as $c, $findMatchingParent as Yn, $isElementNode as Sr, mergeRegister as Te, getDOMTextNode as Pc, isHTMLElement as Ac, CLEAR_EDITOR_COMMAND as Xn, COMMAND_PRIORITY_EDITOR as xo, shallowMergeConfig as Vc, defineExtension as ne, safeCast as er, createState as Lc, FORMAT_TEXT_COMMAND as Jn, $isNodeSelection as Zn, COMMAND_PRIORITY_LOW as Qn, RootNode as jc, LineBreakNode as Bc, TabNode as Fc, $isEditorState as Uc, createCommand as Kc, CLICK_COMMAND as Hc, isDOMNode as Gc, $getNodeFromDOMNode as qc, $createNodeSelection as Wc, $setSelection as Yc, $getEditor as Xc, DecoratorNode as Ya, $getState as Jc, toggleTextFormatType as Ho, TEXT_TYPE_TO_FORMAT as Zc, $setState as Qc, addClassNamesToElement as ti, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as rl, KEY_TAB_COMMAND as al, $isBlockElementNode as ol, $createRangeSelection as nl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as Go, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as yo, $isDecoratorNode as ll, $isParagraphNode as dl, $isTextNode as Xa, SELECTION_CHANGE_COMMAND as ei, $insertNodes as wl } from "lexical";
...
function Il({
  ...
  W(() => {
    ...
    const I = (G) => !!G && G.scrollWidth > G.clientWidth, tt = () => {
      Qa !== "pointer" && (S || I(h.current) || I(l.current)) && C(!0);
    }, N = () => C(!1);
...
function Ra({
  ...
  const U = ye(), V = Ml(), D = S ?? V, [K, Y] = _(!1), [H, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [G, nt] = _(void 0), [at, pt] = _(
    void 0
  ...
  return te(() => {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Pe, { open: K, onOpenChange: L, modal: b, children: [
...
function en({
  ...
  const [C, T] = _(!1), $ = d ?? l, S = (V) => V.length > 0 && typeof V[0] == "object" && "options" in V[0], U = (V, D) => {
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Le, { children: S(e) ? e.map((V) => /* @__PURE__ */ a(Ee, { heading: V.groupHeading, children: V.options.map((D) => U(D, V.groupHeading)) }, V.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map((V) => U(V)) }) })
        ] })
      }
    )
  ] });
...
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = wi ? te : W, Ur = { tag: bo };
function Gl({ initialConfig: t, children: e }) {
  const r = A(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Kl(null, o), w = Hn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
function nd(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < g.length; E++) {
      ...
      const U = ve(b.width);
      T.width !== U && (C.style.width = U, v = !0);
      const V = ve(b.height);
      T.height !== V && (C.style.height = V, v = !0), C.parentNode !== c && (c.append(C), v = !0), s[E] = C;
    }
...
function sd(t, e = id) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), y = f.getKey(), v = h.offset, E = g.getNode(), b = E.getKey(), C = g.offset, T = t.getElementByKey(y), $ = t.getElementByKey(b), S = r === null || T !== o || v !== n || y !== r.getKey(), U = i === null || $ !== s || C !== c || b !== i.getKey();
      if ((S || U) && T !== null && $ !== null) {
...
function wd(t, e, r) {
  ...
  return $c(o) && aa(283), o.insert(t.isInline() ? Mr().append(t) : t), Ko(Wn(t.getLatest(), "next"), e.direction);
}
function ud(t) {
  const e = ee();
  if (!be(e)) return !1;
...
let oa, Ce = 0, na = 0, gd = 0, ro = 0, Jr = 0;
function on(t) {
  if (it === void 0) return;
  let e = t.n;
...
function md(t) {
  ...
  hi(this), it = t, this.f &= -2, 8 & this.f && Eo(this), ga();
}
function or(t, e) {
...
Wt.prototype.brand = pd, Wt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, gi(this), nn(this), Ce++;
  const t = it;
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [vi], register: (t, e, r) => t.registerCommand(Jn, (o) => {
  const n = ee();
  if (Zn(n) || be(n)) for (const i of n.getNodes()) bd(i) && i.toggleFormat(o);
  return !1;
}, Qn) });
function bi(t, e) {
  let r;
...
const ao = ne({ build: (t) => bi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const To = 0, oo = 1, yi = 2, Oa = 3, Kr = 4, ar = 5, Ia = 6, yr = 7;
function $a(t) {
  return t.id === To;
}
function ki(t) {
...
function xd(t) {
  return function(e) {
    return e.id === oo;
  }(t) || ut(305, String(t.id), String(oo)), Object.assign(t, { id: yi });
}
...
const Nd = ne({ config: er({ setOptions: sn, updateOptions: sn }), init: ({ $initialEditorState: t = _d }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [jc, qn, Bc, Fc, Gn] }), cn = Symbol.for("@lexical/extension/LexicalBuilder");
function ln() {
}
function Cd(t) {
  throw t;
...
const Ed = /* @__PURE__ */ new Set(), dn = ne({ build(t, e, r) {
  const o = r.getDependency(ao).output, n = Rr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = bi(() => {
  }, () => xe(() => {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (be(f)) {
                ...
                if (Xa(v) && d >= 0 && w >= 0 && (E = d, b = d + w, f.setTextNodeRange(v, E, v, b)), E === b && p === "" || (f.insertRawText(p), v = y.getNode()), Xa(v)) {
                  E = h, b = h + g;
...
function Gd(t, e) {
  ...
  return u(lt, { children: [a(Kd, { editor: n, ...o, ref: e }), r != null && a(qd, { editor: n, content: r })] });
}
...
function Dp({
  ...
  const [i, s] = _(nw), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  W(() => {
    let v = !0;
    const E = h.current;
    if (!E) return;
...
function gn({
  ...
  }, [t.date, r]), v = A(() => t.user, [t.user]), E = A(
    () => t.user.split(" ").map((S) => S[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), b = A(() => mo(t.contents), [t.contents]), C = A(
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), g()) : Do(S) && (S.preventDefault(), S.stopPropagation(), oe(w) && f());
              },
              onKeyDown: (S) => {
...
function Ai({
  ...
  const [H, Q] = _(fn), [I, tt] = _(), [N, z] = _(), G = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(T), [At, bt] = _(!1), Bt = F(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let x = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            ...
            v !== !1 && (!pt || oe(H)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  Do(x) && (x.preventDefault(), x.stopPropagation(), (oe(H) || I !== void 0 && I !== N) && R());
                },
                onKeyDown: (x) => {
...
), uw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Qr = (t) => uw(mo(t));
function ta({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function pw({
  ...
  const [s, c] = _("accept"), l = Uo(), d = Uo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, y = A(
    () => Qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Qr(t.acceptedText ?? ""),
...
function vw(t) {
  ...
  } = t, c = A(() => e.filter((E) => !E.deleted), [e]), l = A(
...
function jp({
  ...
  const [b, C] = _(/* @__PURE__ */ new Set()), [T, $] = _(), [S, U] = _(), V = j(
    async (z) => {
      const G = await i(z);
  ...
  const D = r.filter(
    ...
    (z) => {
      C((G) => new Set(G).add(z.id)), $(z.id), y == null || y(z.id);
    },
    [y]
  ), H = j(
    (z) => {
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(vw, { ...G, conflictResolution: E }) : /* @__PURE__ */ a(Ai, { ...G })
          },
          z.id
        );
      })
...
function Nw({
  ...
  var S;
  const [w, p] = _([]), [h, g] = _([]), [f, y] = _({}), [v, E] = _({}), b = A(() => e ?? [], [e]), C = ai({
    data: b,
    columns: t,
    getCoreRowModel: ni(),
...
function Xp({
  ...
  const [v, E] = _("generated"), [b, C] = _("generated"), [T, $] = _("*"), [S, U] = _("*"), [V, D] = _("f"), [K, Y] = _(!1), [H, Q] = _(!0), [I, tt] = _(!1), N = F(!1), z = F(""), [G, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = F(null), vt = F(
    void 0
  ...
  const Tt = j(() => {
    var x, L, P;
    const R = (x = g.current) == null ? void 0 : x.querySelector(".editor-input"), B = R == null ? void 0 : R.querySelector("span.note"), q = (P = (L = g.current) == null ? void 0 : L.ownerDocument.getSelection()) == null ? void 0 : P.anchorNode;
  ...
  W(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let st = "custom";
      et === Ja ? st = "generated" : et === Za ? st = "hidden" : et && ($(et), U(et)), E(st), C(st), D(((P = x.insert.note) == null ? void 0 : P.style) ?? "f"), R = setTimeout(() => {
        var ht, xt, _t;
    ...
    return () => {
      R && clearTimeout(R), B !== void 0 && cancelAnimationFrame(B), q !== void 0 && clearTimeout(q);
    };
  }, [e, i, Tt]);
  const Ft = j(
    (R = !1) => {
    ...
    (R, B) => {
      ...
      let x;
      R === "custom" ? x = B : R === "generated" ? x = Ja : x = Za, q.insert.note.caller !== x && (q.insert.note.caller = x, (et = h.current) == null || et.applyUpdate([q, { delete: 1 }]));
    },
    []
  ), kt = j(() => {
    var R;
  ...
  const se = () => {
    ...
    if (B && xr("note", B)) {
      ...
      V !== "x" && R === "x" ? st == null || st.forEach((ht) => Uw(ht)) : V === "x" && R !== "x" && (st == null || st.forEach((ht) => Kw(ht))), (et = h.current) == null || et.applyUpdate([B, { delete: 1 }]);
    }
  }, Kt = (R) => {
    ...
    if (f.current && Bt.length && R && R.rangeCount > 0) {
      const B = R.getRangeAt(0).getBoundingClientRect(), q = f.current.getBoundingClientRect();
    ...
    var q;
    const R = (q = h.current) == null ? void 0 : q.getMarkerMenuContext();
    if (!R) return !1;
...
function ih({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), y = fe(r, "%webView_inventory_unapproved%"), v = fe(r, "%webView_inventory_unknown%"), E = fe(r, "%webView_inventory_scope_currentBook%"), b = fe(r, "%webView_inventory_scope_chapter%"), C = fe(r, "%webView_inventory_scope_verse%"), T = fe(r, "%webView_inventory_filter_text%"), $ = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), S = fe(r, "%webView_inventory_no_results%"), [U, V] = _(!1), [D, K] = _("all"), [Y, H] = _(""), [Q, I] = _([]), tt = A(() => {
    const J = t ?? [];
  ...
  }, [U, tt]), z = A(() => N.length === 0 ? [] : tu(N, D, Y), [N, D, Y]), G = A(() => {
    var gt, ft;
    if (!U) return l;
    ...
    nu,
    {
      ...
      children: /* @__PURE__ */ u(su, { children: [
        /* @__PURE__ */ u(xn, { children: [
          ...
          /* @__PURE__ */ a(kn, { children: /* @__PURE__ */ a(cu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(lu, { children: /* @__PURE__ */ a(
            wu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
}, _n = (t) => `${bu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function yh({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: ze, desc: !1 }]), [g, f] = _({}), y = A(
  ...
  W(() => {
    if (c) {
      const D = E.getSelectedRowModel().rowsById, K = Object.keys(D);
      if (K.length === 1) {
        const Y = y.find((H) => _n(H) === K[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, y, c, E]);
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(wo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(uo, { children: E.getHeaderGroups().map((D) => /* @__PURE__ */ a(De, { children: D.headers.filter((K) => K.column.columnDef.header).map((K) => (
      ...
      /* @__PURE__ */ a(po, { children: E.getRowModel().rows.map((D, K) => {
        const Y = ye();
        return /* @__PURE__ */ a(
          De,
          {
...
function xu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: y } = {
  ...
  }, [v, E] = _(!1), [b, C] = _(""), T = F(void 0), $ = F(!1), S = A(
    () => On(t),
    [t]
  ), U = A(() => {
    if (!b.trim()) {
    ...
    () => Object.values(Ct).filter(
      (I) => (i == null ? void 0 : i[I]) !== void 0 && ho(S, I).length === 0
...
function _h({
  ...
  const $ = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), S = Rt(s, "%webView_scope_selector_verse%"), U = Rt(s, "%webView_scope_selector_chapter%"), V = Rt(s, "%webView_scope_selector_book%"), D = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), K = Rt(
    s,
  ...
  ] }), gt = e ? J.filter((O) => e.includes(O.value)) : J, ft = y ?? Ta, mt = p ?? ft, Jt = h ?? ft, vt = () => {
  ...
  ), Lt = gt.find((O) => O.value === "selectedBooks"), Ht = gt.find((O) => O.value === "range"), [ue, pe] = _(!1), [R, B] = _(void 0), [q, x] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && R === "selectedBooks", jt = /* @__PURE__ */ a(
    Nu,
    {
      availableBookInfo: o,
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    ...
    w === "radio" && t === "range" && fr,
    w === "dropdown" && Lt && /* @__PURE__ */ a(ja, { open: R === "selectedBooks", onOpenChange: k, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: ba,
        onCloseAutoFocus: rt,
    ...
    w === "dropdown" && Ht && /* @__PURE__ */ a(ja, { open: R === "range", onOpenChange: k, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: Vr,
        onCloseAutoFocus: rt,
...
function no({
  ...
  return /* @__PURE__ */ u(je, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Fe, { align: "start", style: { zIndex: tr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(pa, { children: [
      /* @__PURE__ */ a(Rn, { children: /* @__PURE__ */ a(Dt, { children: Fi(e.groups, e.items, l, t) }) }),
...
const Gi = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.List,
  {
    ref: r,
    className: m(
...
function Mh({
  ...
  return /* @__PURE__ */ a(_o.Provider, { value: y, children: /* @__PURE__ */ a(
    "div",
    {
...
function $h({
  ...
  const [s, c] = _(""), [l, d] = _(e), w = A(
    ...
    [t]
  ), p = A(() => Cn(w, s), [w, s]), h = w.length > 1, g = o["%firstRun_language_search_placeholder%"] ?? "", f = o["%firstRun_language_noResults%"] ?? "", y = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(
    Ve,
    {
      id: i,
          ...
          /* @__PURE__ */ a(
            "input",
            {
              ...
              onChange: (v) => {
                ...
                c(E), d(((b = Cn(w, E)[0]) == null ? void 0 : b.tag) ?? "");
              },
