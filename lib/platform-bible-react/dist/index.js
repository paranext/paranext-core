import Ks, { jsx as S, jsxs as be, Fragment as jn } from "react/jsx-runtime";
...
function Uf({
  ...
  return /* @__PURE__ */ be(jn, { children: [
    /* @__PURE__ */ S(
      mo,
      {
...
function wa() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = a, ie.Element = t, ie.ForwardRef = p, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === r || m === u || m === i || m === o || m === f || m === d || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === b || m.$$typeof === a || m.$$typeof === l || m.$$typeof === p || m.$$typeof === h || m.$$typeof === x || m.$$typeof === $ || m.$$typeof === g);
  }, ie.typeOf = y, ie;
}
var se = {};
/** @license React v16.13.1
...
function Oa() {
  return Eo || (Eo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(N) {
      ...
      N === r || N === u || N === i || N === o || N === f || N === d || typeof N == "object" && N !== null && (N.$$typeof === v || N.$$typeof === b || N.$$typeof === a || N.$$typeof === l || N.$$typeof === p || N.$$typeof === h || N.$$typeof === x || N.$$typeof === $ || N.$$typeof === g);
    }
    function E(N) {
...
function Ba() {
  return Ro || (Ro = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), a = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, g = !1, h = !1, x = !1, $ = !1, y;
    y = Symbol.for("react.module.reference");
    function E(C) {
      return !!(typeof C == "string" || typeof C == "function" || C === n || C === o || $ || C === r || C === u || C === p || x || C === b || v || g || h || typeof C == "object" && C !== null && (C.$$typeof === d || C.$$typeof === f || C.$$typeof === i || C.$$typeof === a || C.$$typeof === c || // This needs to include all possible module reference object
...
function Al(e) {
  const {
    ...
    open: p,
    rootRef: f
  } = e, d = T.useRef({}), b = T.useRef(null), v = T.useRef(null), g = Ie(v, f), [h, x] = T.useState(!p), $ = _l(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const E = () => ve(b.current), m = () => (d.current.modalRef = v.current, d.current.mount = b.current, d.current), P = () => {
    o.mount(m(), {
      disableScrollLock: r
...
function tc(e) {
  ...
  if (!(!i || !a)) {
    var f = ec(o.padding, n), d = Ir(i), b = c === "y" ? we : Oe, v = c === "y" ? Ae : De, g = n.rects.reference[p] + n.rects.reference[c] - a[c] - n.rects.popper[p], h = a[c] - n.rects.reference[c], x = pn(i), $ = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, y = g / 2 - h / 2, E = f[b], m = $ - d[p] - f[v], P = $ / 2 - d[p] / 2 + y, k = Qt(E, P, m), D = c;
...
function Vo(e) {
  ...
  b = h.x, g = h.y;
  var x = a.hasOwnProperty("x"), $ = a.hasOwnProperty("y"), y = Oe, E = we, m = window;
  if (u) {
  ...
  if (b = z.x, g = z.y, c) {
    var G;
    return Object.assign({}, B, (G = {}, G[E] = $ ? "0" : "", G[y] = x ? "0" : "", G.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", G));
  }
...
function yc(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !0 : a, c = n.fallbackPlacements, u = n.padding, p = n.boundary, f = n.rootBoundary, d = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, h = t.options.placement, x = Le(h), $ = x === h, y = c || ($ || !v ? [On(h)] : vc(h)), E = [h].concat(y).reduce(function(F, U) {
...
function Rc(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !1 : a, c = n.boundary, u = n.rootBoundary, p = n.altBoundary, f = n.padding, d = n.tether, b = d === void 0 ? !0 : d, v = n.tetherOffset, g = v === void 0 ? 0 : v, h = sn(t, {
    ...
    padding: f,
    altBoundary: p
  }), x = Le(t.placement), $ = At(t.placement), y = !$, E = Ar(x), m = Cc(E), P = t.modifiersData.popperOffsets, k = t.rects.reference, D = t.rects.popper, A = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, I = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  return function(l, c, u) {
    ...
    var p = {
      ...
      setOptions: function(x) {
        ...
        g(), p.options = Object.assign({}, i, p.options, $), p.scrollParents = {
...
const Gc = () => Ye({
  ...
  } = t, h = ce(t, Uc), x = T.useRef(null), $ = Ie(x, n), y = T.useRef(null), E = Ie(y, d), m = T.useRef(E);
  pt(() => {
    m.current = E;
...
`));
  ...
  if (i)
    ...
    const I = Mn(r);
    k = I && Vn(I) ? ve(I).body : ve(null).body;
  }
...
function Np(e, t) {
  ...
  const b = o / 14, v = f || ((x) => `${x / u * b}rem`), g = (x, $, y, E, m) => w({
    fontFamily: r,
    fontWeight: x,
    fontSize: v($),
...
const Jp = {
  ...
  } = t, x = ce(t, Yp), $ = Xt(), y = T.useRef(), E = hn(), m = T.useRef(null), P = Ie(m, i.ref, n), k = (_) => (R) => {
    if (_) {
      const j = m.current;
      R === void 0 ? _(j) : _(j, R);
    }
  ...
  return /* @__PURE__ */ S(h, w({
    ...
    onExiting: B,
    addEndListener: (_) => {
      g === "auto" && $.start(y.current || 0, _), r && r(m.current, _);
    },
...
const fs = /* @__PURE__ */ T.forwardRef(function(t, n) {
  var r, o, i, a, l, c, u, p, f, d, b, v, g, h, x, $, y, E, m;
  const P = Je({
    props: t,
    name: "MuiTooltip"
  }), {
...
`));
  const Us = T.useMemo(() => {
    ...
    className: Re(tr.tooltip, (x = ($ = X.tooltip) != null ? $ : I.tooltip) == null ? void 0 : x.className)
...
function bs(e) {
  const {
    ...
    Qs,
    {
      ...
      onClick: t,
      id: g,
      children: n ? /* @__PURE__ */ be(jn, { children: [
        ci(i, n, !0),
...
const Ts = /* @__PURE__ */ T.forwardRef(function(t, n) {
  ...
  const g = (y) => {
    const E = b.current, m = y.key, P = ve(E).activeElement;
    if (m === "ArrowDown")
...
`)), h !== null && fe < h) {
  ...
  const W = v || (c ? ve(Sn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : sf, H = (i = y == null ? void 0 : y.paper) != null ? i : Ss, X = dt({
    elementType: H,
...
function yf({
  ...
  const [a, l] = ct(!1), [c, u] = ct(!1), p = Ct(() => {
    a && l(!1), u(!1);
  }, [a]), f = Ct(
    (h) => {
      h.stopPropagation(), l((x) => {
        const $ = !x;
        return $ && t && h.shiftKey ? u(!0) : $ || u(!1), $;
      });
    },
    [t]
  ), d = Ct(
  ...
  return Bn(() => {
    a && r.current && g(r.current.clientHeight);
  }, [a, r]), /* @__PURE__ */ be(jn, { children: [
    /* @__PURE__ */ be(
      Ei,
      {
        edge: "start",
...
function Qf({
  ...
  const i = br(void 0);
  return /* @__PURE__ */ S("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ S(la, { position: "static", id: r, children: /* @__PURE__ */ be(ca, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ S(
      yf,
      {
        commandHandler: t,
