...
function oi({
  ...
  const g = U(!1), f = () => {
    ...
    () => _r(e, l),
    [e, l]
  ), y = !!p && !w, N = `${v} (${R})`, T = y ? h || `${N}, ${p}` : N, I = /* @__PURE__ */ u(
    Se,
    {
      ref: t,
...
function Ml({
  ...
  Y(() => {
    ...
    if (!Q) return;
    const C = (q) => !!q && q.scrollWidth > q.clientWidth, et = () => {
      Qa !== "pointer" && (E || C(h.current) || C(l.current)) && N(!0);
    }, D = () => N(!1);
  ...
  return /* @__PURE__ */ u(Ve, { open: b, onOpenChange: v, children: [
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        align: "start",
        onOpenAutoFocus: (y) => {
          const N = y.currentTarget instanceof HTMLElement ? y.currentTarget.querySelector("[cmdk-root]") : void 0;
          N instanceof HTMLElement && (y.preventDefault(), N.focus());
        },
        children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ee, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
          Se,
          {
            onSelect: () => R(y),
...
function Ra({
  ...
  const E = be(), F = zl(), [O, z] = _(!1), [K, W] = _(""), [j, Q] = _(""), [C, et] = _("books"), [D, M] = _(void 0), [q, nt] = _(
    void 0
  ...
  const yt = L(() => {
    ...
    (k) => {
      const rt = C === "chapters" ? D : P == null ? void 0 : P.book;
      if (rt) {
        if (w && w(rt, k) > 1) {
  ...
  const { otLong: $, ntLong: tt, dcLong: ct, extraLong: pt } = {
    ...
    () => Pl(j),
    [j]
  ), fa = A(() => !w || !P || !P.chapterNum || !Ar ? !1 : w(P.book, P.chapterNum) > 0, [w, P, Ar]), ma = C === "books" && !jt && !j.trim() && Jt.size > 0, Vr = L(
    (k) => p ? Yo(k, p) : !1,
    [p]
  ), mr = L(
    (k) => (rt) => p ? Al(k, rt, p) : !1,
    ...
    (k) => {
      var _e, V, Z;
      if (k.target instanceof Node && !k.currentTarget.contains(k.target) || k.ctrlKey) return;
      ...
      if ((C === "chapters" || C === "books" && P) && Qt) {
        const lt = C === "chapters" ? D : P == null ? void 0 : P.book;
        if (!lt) return;
        C === "chapters" && ((Z = _t.current) == null || Z.focus());
        const bt = (() => {
          if (!K) return 1;
          const De = K.match(/(\d+)$/);
  ...
  return te(() => {
    const k = setTimeout(() => {
      if (O && C === "books" && Bt.current && re.current) {
  ...
  }, [C, D, P, t.book, t.chapterNum]), te(() => {
    if (C === "verses" && q && ot !== void 0) {
          ...
          je,
          {
            ...
            children: [
              C === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                C === "verses" && q && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ge(q, i)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: C === "verses" ? Ge : vr
                  }
                )
              ] }),
              !jt && /* @__PURE__ */ u(Be, { ref: Bt, children: [
                C === "books" && /* @__PURE__ */ u(dt, { children: [
                ...
                C === "verses" && q && ot !== void 0 && w && /* @__PURE__ */ a(
                  Zo,
                  {
                    bookId: q,
                    chapterNum: ot,
...
function Qo({
  ...
  const [N, T] = _(!1), I = d ?? l, E = (O) => O.length > 0 && typeof O[0] == "object" && "options" in O[0], F = (O, z) => {
  ...
  return /* @__PURE__ */ u(Ve, { open: N, onOpenChange: T, ...y, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: f,
...
function ad(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      ...
      const E = fe(y.top - h);
      T.top !== E && (N.style.top = E, v = !0);
      const F = fe(y.width);
      T.width !== F && (N.style.width = F, v = !0);
      const O = fe(y.height);
      T.height !== O && (N.style.height = O, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[R] = N;
    }
...
function nd(t, e = od) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, R = g.getNode(), y = R.getKey(), N = g.offset, T = t.getElementByKey(b), I = t.getElementByKey(y), E = r === null || T !== o || v !== n || b !== r.getKey(), F = i === null || I !== s || N !== c || y !== i.getKey();
      if ((E || F) && T !== null && I !== null) {
        const O = function(z, K, W, j, Q, C, et) {
          const D = (z._window ? z._window.document : document).createRange();
          return D.setStart(...tn(K, W, j)), D.setEnd(...tn(Q, C, et)), D;
        }(t, h, f, T, g, R, I);
        l(), l = ad(t, O, e);
      }
      r = f, o = T, n = v, i = R, s = I, c = N;
    });
  }
            ...
            t.update(() => {
              ...
              if (me(f)) {
                ...
                if (Xa(v) && d >= 0 && w >= 0 && (R = d, y = d + w, f.setTextNodeRange(v, R, v, y)), R === y && p === "" || (f.insertRawText(p), v = b.getNode()), Xa(v)) {
                  ...
                  R = R > N ? N : R, y = y > N ? N : y, f.setTextNodeRange(v, R, v, y);
                }
...
function pn({
  ...
  const g = L(
    ...
    [t.user]
  ), y = A(() => mo(t.contents), [t.contents]), N = A(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), T = !!t.conflictResolutionAction && !N, I = A(() => {
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          Je,
...
function Pi({
  ...
  const [j, Q] = _(hn), [C, et] = _(), [D, M] = _(), q = o, [nt, ot] = _(!1), [ut, jt] = _(!1), [J, st] = _(!1), [ft, mt] = _(!1), [vt, _t] = _(!1), [ht, Bt] = _(T), [re, St] = _(!1), Ft = U(void 0), [gt, Yt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
      const $ = y ? await y(l) : !1;
  ...
  const S = L(
    ...
    async (x) => {
      const H = ne(j) ? oa(j) : void 0, $ = x.status ? x.assignedUser : C ?? x.assignedUser, tt = await p({
        ...x,
        contents: H,
        assignedUser: $
      });
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            ...
            v !== !1 && (!ut || ne(j)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  Ro(x) && (x.preventDefault(), x.stopPropagation(), (ne(j) || C !== void 0 && C !== D) && S());
                },
                onKeyDown: (x) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    C !== void 0 && (ne(j) || C !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ie(
...
function ww({
  ...
  }, C = (D) => p && D.value === "reject", et = (D) => {
    const M = f === D.value, q = `${d}-${D.value}`, nt = C(D);
    return (
...
function Vp({
  ...
  const [y, N] = _(/* @__PURE__ */ new Set()), [T, I] = _(), [E, F] = _(), O = L(
    async (M) => {
      const q = await i(M);
  ...
  Y(() => {
    f && (N((M) => new Set(M).add(f)), I(f));
  }, [f]);
  const z = r.filter(
    (M) => M.comments.some((q) => !q.deleted)
  ), K = z.map((M) => ({ id: M.id })), W = L(
    (M) => {
      N((q) => new Set(q).add(M.id)), I(M.id), b == null || b(M.id);
    },
    [b]
  ), j = L(
    (M) => {
    ...
    [y, b]
  ), { listboxRef: Q, activeId: C, handleKeyDown: et } = es({
    options: K,
    onOptionSelect: W
  }), D = L(
    (M) => {
      M.key === "Escape" ? (T && y.has(T) && (N((q) => {
        const nt = new Set(q);
...
function kw({
  ...
  var E;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, R] = _({}), y = A(() => e ?? [], [e]), N = ti({
    data: y,
    columns: t,
    getCoreRowModel: ri(),
  ...
  return l ? I = Array.from({ length: 10 }).map((z, K) => `skeleton-row-${K}`).map((z) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(sr, { colSpan: T.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((E = N.getRowModel().rows) == null ? void 0 : E.length) > 0 ? I = N.getRowModel().rows.map((F) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(wo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: N.getHeaderGroups().map((F) => /* @__PURE__ */ a(Oe, { children: F.headers.map((O) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: O.isPlaceholder ? void 0 : Nr(O.column.columnDef.header, O.getContext()) }, O.id)) }, F.id)) }),
...
function Dw({
  ...
  const v = (y) => {
    if (s.current = !1, h(y), !y) {
      const N = f.current, T = b.current;
      N !== "custom" || T ? (N !== t || T !== e) && r(N, T) : (l(t), w(e));
    }
  }, R = (y) => {
    var N, T, I, E;
    y.stopPropagation(), document.activeElement === i.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((N = n.current) == null || N.focus(), s.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((T = i.current) == null || T.focus(), s.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && ((I = n.current) == null ? void 0 : I.selectionStart) === 0 && ((E = i.current) == null || E.focus(), s.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === i.current || document.activeElement === n.current) && v(!1);
  };
...
function Wp({
  ...
  const [v, R] = _("generated"), [y, N] = _("generated"), [T, I] = _("*"), [E, F] = _("*"), [O, z] = _("f"), [K, W] = _(!1), [j, Q] = _(!0), [C, et] = _(!1), D = U(!1), M = U(""), [q, nt] = _(!1), [ot, ut] = _(), [jt, J] = _(), [st, ft] = _(), [mt, vt] = _(), _t = U(null), ht = U(
    void 0
  ...
  Y(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let ct = "custom";
      tt === Ja ? ct = "generated" : tt === Za ? ct = "hidden" : tt && (I(tt), F(tt)), R(ct), N(ct), z((($ = x.insert.note) == null ? void 0 : $.style) ?? "f"), S = setTimeout(() => {
        var pt, Ct, Rt;
...
function qw({
  ...
  /* @__PURE__ */ a("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    zo(t.marker, [s], o, !1),
    " "
  ] }), g = !!l, f = !!w, b = !!p, v = e === "horizontal" ? "horizontal" : "vertical", R = o ? "marker-visible" : "", y = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", N = m(v, R);
  return /* @__PURE__ */ u(dt, { children: [
...
function oh({
  ...
  const g = he(r, "%webView_inventory_all%"), f = he(r, "%webView_inventory_approved%"), b = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), R = he(r, "%webView_inventory_scope_currentBook%"), y = he(r, "%webView_inventory_scope_chapter%"), N = he(r, "%webView_inventory_scope_verse%"), T = he(r, "%webView_inventory_filter_text%"), I = he(
    r,
    "%webView_inventory_show_additional_items%"
  ), E = he(r, "%webView_inventory_no_results%"), [F, O] = _(!1), [z, K] = _("all"), [W, j] = _(""), [Q, C] = _([]), et = A(() => {
    const J = t ?? [];
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(ur, { onValueChange: (J) => ot(J), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(gr, { children: [
          ...
          /* @__PURE__ */ a(ce, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ca,
...
function ru({
  ...
  const [l, d] = Gt.useState(t), w = e ?? l, p = Gt.useCallback(
    ...
    [r, w]
  ), h = Gt.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", v = be() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = Gt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function vu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [v, R] = _(!1), [y, N] = _(""), T = U(void 0), I = U(!1), E = A(
    () => zn(t),
    [t]
  ), F = A(() => {
    if (!y.trim()) {
    ...
    O(C, I.current), I.current = !1;
  }, K = (C, et) => {
    C.preventDefault(), O(et, C.shiftKey);
  }, W = () => {
    r(E.map((C) => C));
  }, j = () => {
    r([]);
    ...
    () => Object.values(Et).filter(
      (C) => (i == null ? void 0 : i[C]) !== void 0 && ho(E, C).length === 0
          ...
          Le,
          {
            ...
            children: /* @__PURE__ */ u(
              je,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (C) => {
                  C.key === "Enter" && (I.current = C.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    ia,
                  ...
                  /* @__PURE__ */ u(Be, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(Et).filter((C) => F[C].length > 0).map((C, et) => {
                      const D = F[C];
                  ...
                  Q.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Q.map(({ section: C, explanation: et }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: et }, C)) })
                ]
              }
            )
          }
...
function yh({
  ...
  const I = zt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = zt(s, "%webView_scope_selector_current_book%"), j = zt(s, "%webView_scope_selector_choose_books%"), Q = zt(s, "%webView_scope_selector_scope%"), C = zt(s, "%webView_scope_selector_select_books%"), et = zt(s, "%webView_scope_selector_range%"), D = zt(s, "%webView_scope_selector_select_range%"), M = zt(s, "%webView_scope_selector_range_start%"), q = zt(s, "%webView_scope_selector_range_end%"), nt = zt(s, "%webView_scope_selector_ok%"), ot = zt(s, "%webView_scope_selector_cancel%"), ut = zt(s, "%webView_scope_selector_navigate%"), jt = (V) => {
    if (!b) return;
...
function Dh({
  ...
  const d = Bu(
    ...
    var R, y, N, T, I, E;
    const v = b !== f ? ((y = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : y[b]) ?? ((T = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : T.en) : void 0;
...
export {
  ...
  tf as Z_INDEX_CONNECTION_LOST,
  ef as Z_INDEX_FIRST_RUN,
  rf as Z_INDEX_MODAL,
  af as Z_INDEX_MODAL_BACKDROP,
  of as Z_INDEX_ONBOARDING_TOUR,
