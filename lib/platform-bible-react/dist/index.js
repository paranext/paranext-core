import el, { jsx as s, jsxs as x, Fragment as ie } from "react/jsx-runtime";
...
import { History as nl, ChevronRight as Ja, Check as tr, Circle as Za, ArrowDownWideNarrow as rl, Clock as ol, Bookmark as al, X as Qa, Search as il, ChevronsUpDown as sl, FilterIcon as ll, ChevronDown as er, ChevronUp as cl, ArrowLeftIcon as dl, ChevronLeftIcon as pl, ChevronRightIcon as ul, ArrowRightIcon as wl, CircleCheckIcon as fl, CircleXIcon as ml, CircleHelpIcon as hl, ArrowUpIcon as gl, ArrowDownIcon as bl, ArrowUpDownIcon as vl, PanelLeft as yl, ChevronLeft as xl, LoaderCircle as Nl, Download as kl, Filter as El, User as Sl, Link as Tl, CircleHelp as Cl } from "lucide-react";
import be, { clsx as Ol } from "clsx";
...
import { getChaptersForBook as Pl, deepEqual as co, substring as $l, formatScrRef as Or, compareScrRefs as Hr, scrRefToBBBCCCVVV as Rr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Il, formatBytes as Al } from "platform-bible-utils";
...
import { useReactTable as ei, getCoreRowModel as ni, getPaginationRowModel as Ml, getSortedRowModel as ri, getFilteredRowModel as Dl, flexRender as dn, getExpandedRowModel as Bl, getGroupedRowModel as jl } from "@tanstack/react-table";
...
import Vl, { ThemeContext as zl, internal_processStyles as Ll } from "@mui/styled-engine";
import { MenuItem as Fl, ListItemText as Ul, ListItemIcon as ii, Menu as Gl, Grid as si, List as Hl, IconButton as li, Drawer as Xl, AppBar as Yl, Toolbar as Wl } from "@mui/material";
...
import Jl from "markdown-to-jsx";
const Zl = Rl({ prefix: "tw-" });
function N(...t) {
  return Zl(Ol(t));
}
...
var tc = Object.defineProperty, ec = (t, e, n) => e in t ? tc(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, et = (t, e, n) => ec(t, typeof e != "symbol" ? e + "" : e, n);
const ye = [
  "GEN",
  "EXO",
  "LEV",
...
const fo = wt.Root, mi = wt.Trigger, uc = wt.Group, fh = wt.Portal, mh = wt.Sub, hh = wt.RadioGroup, wc = T.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  wt.SubTrigger,
  {
    ref: o,
    className: N(
...
wc.displayName = wt.SubTrigger.displayName;
const fc = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  wt.SubContent,
  {
    ref: n,
    className: N(
...
fc.displayName = wt.SubContent.displayName;
...
const mo = T.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ x(
  wt.CheckboxItem,
  {
    ref: o,
    className: N(
...
const gi = T.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(
  wt.RadioItem,
  {
    ref: r,
    className: N(
...
function bc({ handleSort: t, handleLocationHistory: e, handleBookmarks: n }) {
...
const pn = ot.allBookIds, vc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ra = ["OT", "NT", "DC"], yc = 32 + 32 + 32, xc = [
  /^(\w+)$/i,
...
function gh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = ut(""), [o, a] = ut(
    ...
    ot.bookNumberToId(t.bookNum)
  ), [p, h] = ut(!1), [w, g] = ut(p), v = ge(void 0), f = ge(void 0), m = ge(void 0), E = Et(
    (k) => Nc(k).filter((B) => {
    ...
    xc.forEach((k) => {
      const B = n.match(k);
      if (B) {
        const [D, J = void 0, q = void 0] = B.slice(1), U = Sc(D);
  ...
  return ae(() => {
    ...
    const k = setTimeout(() => {
      if (w && f.current && m.current) {
        const D = m.current.offsetTop - yc;
  ...
  }, [w]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(fo, { modal: !1, open: p, onOpenChange: S, children: [
    /* @__PURE__ */ s(mi, { asChild: !0, children: /* @__PURE__ */ s(
      Ql,
      {
        ...
        handleKeyDown: H,
        handleOnClick: () => {
          a(ot.bookNumberToId(t.bookNum)), d(ot.bookNumberToId(t.bookNum)), l(t.chapterNum > 0 ? t.chapterNum : 0), h(!0), v.current.focus();
        },
        onFocus: () => {
          C.current = !0;
        },
        ...
        children: [
          ...
          ra.map(
            (k, B) => E(k).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ s(Sn, { className: "tw-font-semibold tw-text-foreground/80", children: vc[k] }),
...
const Tc = Xe(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? He : "button", { className: N(Tc({ variant: e, size: n, className: t })), ref: a, ...o })
);
gt.displayName = "Button";
const Cc = Xe(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Xt = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(ti.Root, { ref: n, className: N("pr-twp", Cc(), t), ...e }));
...
const Oc = hn.Root, Rc = hn.Trigger, vi = T.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(hn.Portal, { children: /* @__PURE__ */ s(
  hn.Content,
  {
    ref: o,
    align: e,
...
const _c = vt.Portal, yi = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.Overlay,
  {
    ref: n,
    className: N(
...
const Pc = T.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(_c, { children: [
  /* @__PURE__ */ s(yi, {}),
  /* @__PURE__ */ x(
    vt.Content,
    {
...
Pc.displayName = vt.Content.displayName;
...
$c.displayName = vt.Title.displayName;
...
Ic.displayName = vt.Description.displayName;
...
const Ni = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
  /* @__PURE__ */ s(il, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
  /* @__PURE__ */ s(
    Rt.Input,
    {
      ref: n,
...
Ac.displayName = Rt.Group.displayName;
...
Mc.displayName = Rt.Separator.displayName;
...
function qr({
  ...
  const [v, f] = ut(!1);
  return /* @__PURE__ */ x(Oc, { open: v, onOpenChange: f, ...g, children: [
    /* @__PURE__ */ s(Rc, { asChild: !0, children: /* @__PURE__ */ x(
      gt,
      {
        variant: p,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ s(sl, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(vi, { className: N("tw-w-[200px] tw-p-0", r), dir: h, children: /* @__PURE__ */ x(xi, { children: [
      /* @__PURE__ */ s(Ni, { dir: h, placeholder: c, className: "tw-text-inherit" }),
      /* @__PURE__ */ s(Ei, { children: d }),
      /* @__PURE__ */ s(ki, { children: e.map((m) => /* @__PURE__ */ x(
        Si,
        {
          value: i(m),
          onSelect: () => {
...
function vh({
  ...
  const p = _r(d, "%webView_bookSelector_currentBook%"), h = _r(d, "%webView_bookSelector_choose%"), w = _r(d, "%webView_bookSelector_chooseBooks%"), [g, v] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), f = (m) => {
    v(m), t(m);
    ...
    bi,
    {
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ s(Xt, { className: "tw-flex tw-items-center", children: r.map((m) => ot.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ s(
            gt,
            {
...
function Vc({ table: t }) {
  return /* @__PURE__ */ x(fo, { children: [
    /* @__PURE__ */ s(_l, { asChild: !0, children: /* @__PURE__ */ x(gt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ s(ll, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const gn = bt.Root, zc = bt.Group, bn = bt.Value, De = T.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(
  bt.Trigger,
  {
    ref: r,
    className: N(
...
const Ti = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  bt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ s(cl, { className: "tw-h-4 tw-w-4" })
  }
));
...
Lc.displayName = bt.Label.displayName;
...
Fc.displayName = bt.Separator.displayName;
function Uc({ table: t }) {
...
const Hc = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "caption",
  {
    ref: n,
...
function Xc({
  ...
  var m;
  const [l, c] = ut([]), [d, p] = ut([]), [h, w] = ut({}), [g, v] = ut({}), f = ei({
    data: e,
    columns: t,
    getCoreRowModel: ni(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(ar, { stickyHeader: a, children: [
      ...
      /* @__PURE__ */ s(sr, { children: (m = f.getRowModel().rows) != null && m.length ? f.getRowModel().rows.map((E) => /* @__PURE__ */ s(
        oe,
        {
          onClick: () => i(E, f),
...
}, Kc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Oi = Xe(
...
), Jc = T.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  oi.Root,
  {
    ref: o,
    className: N(Oi({ variant: e, size: n, className: t })),
    ...r
  }
));
Jc.displayName = oi.Root.displayName;
...
const lr = (t) => t === "asc" ? /* @__PURE__ */ s(gl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(bl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(vl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), yh = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: a }) => {
    ...
    return /* @__PURE__ */ x(_i, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ s(
        Un,
        {
          onClick: () => Pr(
  ...
  return Wc(t).forEach((p) => {
    p.startsWith("\\id") && (i = qc(p), l = 0, c = 0), p.startsWith("\\c") && (l = oa(p), c = 0), p.startsWith("\\v") && (c = oa(p), l === 0 && (l = e.chapterNum));
    let h = o.exec(p) ?? void 0;
    for (; h; ) {
      const w = [];
      h.forEach((m) => w.push(m));
      const g = h.index, v = a.find((m) => co(m.items, w)), f = {
        reference: {
          bookNum: i !== void 0 ? i : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: $l(p, Math.max(0, g - 25), Math.min(g + 25, p.length))
      };
      if (v)
...
function Eh({
  ...
  const h = Jt(n, "%webView_inventory_all%"), w = Jt(n, "%webView_inventory_approved%"), g = Jt(n, "%webView_inventory_unapproved%"), v = Jt(n, "%webView_inventory_unknown%"), f = Jt(n, "%webView_inventory_scope_currentBook%"), m = Jt(n, "%webView_inventory_scope_chapter%"), E = Jt(n, "%webView_inventory_scope_verse%"), _ = Jt(n, "%webView_inventory_filter_text%"), C = Jt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, b] = ut(!1), [I, z] = ut("all"), [H, O] = ut(""), [$, k] = ut([]), B = It(() => l ? r instanceof RegExp ? td(
    l,
    t,
    a,
    i,
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        gn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(Be, { children: [
              /* @__PURE__ */ s(Gt, { value: "all", children: h }),
      ...
      /* @__PURE__ */ x(gn, { onValueChange: (y) => tt(y), defaultValue: c, children: [
        ...
        /* @__PURE__ */ x(Be, { children: [
          ...
          /* @__PURE__ */ s(Gt, { value: "chapter", children: m }),
...
function Sh({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x($i, { dir: a, children: [
      /* @__PURE__ */ s(Ii, { children: t.map((i) => /* @__PURE__ */ s(ed, { value: i.value, children: i.value }, i.key)) }),
...
const nd = vt.Root, rd = vt.Portal, Mi = M.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.Overlay,
  {
    className: N(
      "tw-fixed tw-inset-0 tw-z-50 tw-bg-black/80 data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0",
...
), Di = M.forwardRef(({ side: t = "right", className: e, children: n, ...r }, o) => /* @__PURE__ */ x(rd, { children: [
  /* @__PURE__ */ s(Mi, {}),
...
const sd = En.Provider, ld = En.Root, cd = En.Trigger, Bi = T.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  En.Content,
  {
    ref: r,
    sideOffset: e,
...
const pd = "sidebar:state", ud = 60 * 60 * 24 * 7, wd = "16rem", fd = "18rem", md = "3rem", hd = "b", ji = T.createContext(void 0);
function cr() {
...
const Vi = T.forwardRef(
  ({
    ...
    const c = dd(), [d, p] = T.useState(!1), [h, w] = T.useState(t), g = e ?? h, v = T.useCallback(
      (_) => {
    ...
    const m = g ? "expanded" : "collapsed", E = T.useMemo(
      () => ({
        state: m,
        open: g,
        setOpen: v,
    ...
    return /* @__PURE__ */ s(ji.Provider, { value: E, children: /* @__PURE__ */ s(sd, { delayDuration: 0, children: /* @__PURE__ */ s(
      "div",
      {
        style: (
...
const Ed = Xe(
  ...
  ({
    ...
    const c = t ? He : "button", { isMobile: d, state: p } = cr(), h = /* @__PURE__ */ s(
      c,
      {
        ref: l,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ s(cd, { asChild: !0, children: h }),
      /* @__PURE__ */ s(
        Bi,
        {
          side: "right",
...
function Pd({
  ...
  const a = Et(
    ...
    (c) => {
      const d = n.find((p) => p.projectId === c);
      return d ? d.projectName : c;
    },
    [n]
  ), l = Et(
    (c) => !o.projectId && c === o.label,
    [o]
  );
  return /* @__PURE__ */ s(
    zi,
    {
      ...
      children: /* @__PURE__ */ x(Fi, { children: [
        /* @__PURE__ */ x(Kr, { children: [
          /* @__PURE__ */ s(Jr, { className: "tw-text-sm tw-text-gray-400", children: "Extensions" }),
          /* @__PURE__ */ s(Zr, { children: /* @__PURE__ */ s(Ui, { children: e.map((c) => /* @__PURE__ */ s(Gi, { children: /* @__PURE__ */ s(
            Hi,
            {
              className: N(
                ...
                { "tw-bg-white tw-text-gray-900 tw-shadow-sm": l(c) }
              ),
              onClick: () => a(c, void 0),
              isActive: l(c),
              children: /* @__PURE__ */ s("span", { className: "tw-pl-3", children: c })
            }
          ) }, c)) }) })
        ] }),
        /* @__PURE__ */ x(Kr, { children: [
          /* @__PURE__ */ s(Jr, { className: "tw-text-sm tw-text-gray-400", children: "Projects" }),
          /* @__PURE__ */ s(Zr, { className: "tw-pl-3", children: /* @__PURE__ */ s(
            qr,
            {
              popoverContentClassName: "tw-z-[1000]",
              options: n.flatMap((c) => c.projectId),
              getOptionLabel: (c) => i(c),
...
function Th({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-h-full tw-p-3", children: [
    ...
    /* @__PURE__ */ x(Vi, { dir: e, id: t, className: "tw-gap-4", children: [
      /* @__PURE__ */ s(
        Pd,
        {
          extensionLabels: n,
...
const ne = "scrBook", $d = "scrRef", we = "source", Id = "details", Ad = "Scripture Reference", Md = "Scripture Book", Xi = "Type", Dd = "Details";
function Bd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, ia = (t) => `${jd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ch({
  sources: t,
  ...
  const [d, p] = ut([]), [h, w] = ut([{ id: ne, desc: !1 }]), [g, v] = ut({}), f = It(
    ...
    !e && /* @__PURE__ */ x(
      gn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(Be, { position: "item-aligned", children: /* @__PURE__ */ s(zc, { children: S.map((O) => /* @__PURE__ */ s(Gt, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ x(
                    gt,
                    {
                      ...
                      children: [
                        ...
                        !O.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ s(Ja, {}) : /* @__PURE__ */ s(xl, {})),
                        " ",
...
const Ki = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("p", { ref: n, className: N("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function $h({
  id: t,
  settingsGroupLabel: e,
  settingsGroupDescription: n,
  children: r
}) {
  return /* @__PURE__ */ x(Yi, { id: t, children: [
    /* @__PURE__ */ x(Wi, { children: [
      /* @__PURE__ */ s(qi, { children: e }),
      n && /* @__PURE__ */ s(Ki, { children: n })
    ] }),
    /* @__PURE__ */ s(Ji, { children: r })
  ] });
}
function Ih({
  id: t,
...
function Zt(t, e, n = {
  ...
  return he(t) && he(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (he(e[o]) && o in t && he(t[o]) ? r[o] = Zt(t[o], e[o], n) : n.clone ? r[o] = he(e[o]) ? Qi(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
...
function Ud() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = i, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = v, it.Memo = g, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = h, it.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === h || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === i || b.$$typeof === l || b.$$typeof === p || b.$$typeof === m || b.$$typeof === E || b.$$typeof === _ || b.$$typeof === f);
  }, it.typeOf = C, it;
}
var st = {};
/** @license React v16.13.1
...
function Gd() {
  return la || (la = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(A) {
      ...
      A === r || A === d || A === a || A === o || A === h || A === w || typeof A == "object" && A !== null && (A.$$typeof === v || A.$$typeof === g || A.$$typeof === i || A.$$typeof === l || A.$$typeof === p || A.$$typeof === m || A.$$typeof === E || A.$$typeof === _ || A.$$typeof === f);
    }
    function S(A) {
    ...
    var b = c, I = d, z = l, H = i, O = e, $ = p, k = r, B = v, D = g, J = n, q = a, U = o, tt = h, at = !1;
    function rt(A) {
...
var ca;
function ts() {
  return ca || (ca = 1, process.env.NODE_ENV === "production" ? jn.exports = Ud() : jn.exports = Gd()), jn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Yd() {
  if (fa)
    return Vr;
  fa = 1;
  var t = ts(), e = Hd(), n = yo(), r = es(), o = Xd(), a = function() {
  };
...
function ns(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Zd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${i}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const rs = vo(u.element, ns);
rs.isRequired = vo(u.element.isRequired, ns);
const os = rs, Qd = "exact-prop: ​";
function tp(t) {
...
function np() {
  return ga || (ga = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, f = !1, m = !1, E = !1, _ = !1, C;
    C = Symbol.for("react.module.reference");
    function S(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || _ || j === r || j === d || j === p || E || j === g || v || f || m || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === h || j.$$typeof === a || j.$$typeof === i || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var I = i, z = a, H = t, O = c, $ = n, k = w, B = h, D = e, J = o, q = r, U = d, tt = p, at = !1, rt = !1;
    function y(j) {
...
process.env.NODE_ENV === "production" ? to.exports = ep() : to.exports = np();
var ba = to.exports;
...
const ip = u.oneOfType([u.func, u.object]), is = ip;
function Wt(t) {
  if (typeof t != "string")
...
const wp = typeof window < "u" ? M.useLayoutEffect : M.useEffect, ze = wp;
let ya = 0;
function fp(t) {
...
function Ep(t) {
  t.addEventListener("keydown", Np, !0), t.addEventListener("mousedown", Lr, !0), t.addEventListener("pointerdown", Lr, !0), t.addEventListener("touchstart", Lr, !0), t.addEventListener("visibilitychange", kp, !0);
}
function Sp(t) {
  const {
    target: e
...
function cs() {
  ...
  function n() {
    return e.current ? (no = !0, vp.start(100, () => {
      no = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
const Rp = ["values", "unit", "step"], _p = (t) => {
...
function Pp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = kt(t, Rp), a = _p(e), i = Object.keys(a);
  function l(w) {
...
const $p = {
  borderRadius: 4
}, Ip = $p, Ap = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.string, u.object, u.array]) : {}, se = Ap;
function un(t, e) {
  return e ? Zt(t, e, {
    clone: !1
...
const jp = {
  ...
  if (t.length > 2)
    if (Sa[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = jp[e], o = Vp[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), wr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], fr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Lp = [...wr, ...fr];
function Cn(t, e, n, r) {
  var o;
...
function Up(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = zp(n), a = Fp(o, r), i = t[n];
  return Qt(t, i, a);
}
function ms(t, e) {
  const n = fs(t.theme);
  return Object.keys(t).map((r) => Up(t, e, r, n)).reduce(un, {});
}
function mt(t) {
  return ms(t, wr);
}
...
ht.filterProps = fr;
process.env.NODE_ENV !== "production" && Lp.reduce((t, e) => (t[e] = se, t), {});
function Gp(t = 8) {
  if (t.mui)
    return t;
  const e = fs({
...
const Hp = Lt("border", Bt), Xp = Lt("borderTop", Bt), Yp = Lt("borderRight", Bt), Wp = Lt("borderBottom", Bt), qp = Lt("borderLeft", Bt), Kp = Lt("borderColor"), Jp = Lt("borderTopColor"), Zp = Lt("borderRightColor"), Qp = Lt("borderBottomColor"), tu = Lt("borderLeftColor"), eu = Lt("outline", Bt), nu = Lt("outlineColor"), hr = (t) => {
...
mr(Hp, Xp, Yp, Wp, qp, Kp, Jp, Zp, Qp, tu, hr, eu, nu);
const gr = (t) => {
...
mr(gr, br, vr, ru, ou, au, iu, su, lu, cu, du, pu);
function Me(t, e) {
  return e === "grey" ? e : t;
}
const uu = yt({
...
function Eu() {
  ...
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = Mp(a.breakpoints), h = Object.keys(p);
      let w = p;
...
function To(t = {}, ...e) {
  ...
  return d.applyStyles = Su, d = e.reduce((p, h) => Zt(p, h), d), d.unstable_sxConfig = P({}, Eo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return So({
      sx: h,
      theme: this
    });
...
const Ru = ["ownerState"], _u = ["variants"], Pu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function $u(t) {
  return Object.keys(t).length === 0;
}
function Iu(t) {
...
const Au = To(), Ta = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Vn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function Du(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Ll(i, (b) => b.filter((I) => !(I != null && I.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = Mu(Ta(d))
    } = l, g = kt(l, Pu), v = p !== void 0 ? p : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), f = h || !1;
    let m;
    process.env.NODE_ENV !== "production" && c && (m = `${c}-${Ta(d || "Root")}`);
    let E = Gn;
    d === "Root" || d === "root" ? E = r : d ? E = o : Iu(i) && (E = void 0);
    const _ = Vl(i, P({
      shouldForwardProp: E,
      label: m
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${Wt(d || "")}`), k === void 0 && (k = `Styled(${ap(i)})`), $.displayName = k;
      }
...
function Ca(t) {
  t = Ne(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Ne(zu(t)).values : t.values;
...
const Gu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, $e = Zu, Qu = ["mode", "contrastThreshold", "tonalOffset"], Ra = {
...
function _a(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = Fu(t.main, o) : e === "dark" && (t.dark = Lu(t.main, a)));
}
function tw(t = "light") {
  return t === "dark" ? {
    main: _e[200],
...
function iw(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = kt(t, Qu), a = t.primary || tw(e), i = t.secondary || ew(e), l = t.error || nw(e), c = t.info || rw(e), d = t.success || ow(e), p = t.warning || aw(e);
  function h(f) {
    const m = Oa(f, Fr.text.primary) >= n ? Fr.text.primary : Ra.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = Oa(f, m);
...
The color object needs to have a \`main\` property or a \`${E}\` property.` : Ve(11, m ? ` (${m})` : "", E));
...
} });` : Ve(12, m ? ` (${m})` : "", JSON.stringify(f.main)));
    return _a(f, "light", _, r), _a(f, "dark", C, r), f.contrastText || (f.contrastText = h(f.main)), f;
  }, g = {
    dark: Fr,
    light: Ra
  };
...
function cw(t, e) {
  ...
  const g = o / 14, v = h || ((E) => `${E / d * g}rem`), f = (E, _, C, S, b) => P({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(_),
...
const ww = ["none", ft(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ft(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ft(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ft(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ft(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ft(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ft(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ft(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ft(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ft(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ft(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ft(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ft(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ft(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ft(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ft(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ft(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ft(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ft(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ft(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ft(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ft(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ft(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ft(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], fw = ww, mw = ["duration", "easing", "delay"], hw = {
...
function vw(t) {
  const e = P({}, hw, t.easing), n = P({}, gw, t.duration);
  return P({
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((p) => `${p} ${typeof i == "string" ? i : Ia(i)} ${l} ${typeof c == "string" ? c : Ia(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
function kw(t = {}, ...e) {
  ...
  if (d = Zt(d, i), d = e.reduce((p, h) => Zt(p, h), d), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return d.unstable_sxConfig = P({}, Eo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return So({
      sx: h,
      theme: this
    });
...
const Sw = (t) => Gn(t) && t !== "classes", Tw = Du({
  themeId: Ro,
  defaultTheme: Oo,
...
const Ow = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Rw = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
  ...
  const r = _o({
    ...
    titleAccess: h,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, Ow), v = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", f = P({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), Iw = /* @__PURE__ */ Ld($w);
var Ma;
function Aw() {
...
var xs = bo.default = void 0, Dw = Mw(Aw()), Bw = el;
xs = bo.default = (0, Dw.default)(/* @__PURE__ */ (0, Bw.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function jw(t) {
...
function ln(t, e, n) {
  return t === void 0 || jw(t) ? e : P({}, e, {
    ownerState: P({}, e.ownerState, n)
  });
}
const Vw = {
  disableDefaultClasses: !1
}, zw = /* @__PURE__ */ M.createContext(Vw);
function Lw(t) {
  const {
...
function Gw(t) {
  ...
  const i = Fw(P({}, o, r)), l = Da(r), c = Da(o), d = e(i), p = be(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = P({}, d, n, c, l);
...
process.env.NODE_ENV !== "production" && (Kn["propTypes"] = tp(Kn.propTypes));
var Ct = "top", Vt = "bottom", zt = "right", Ot = "left", $o = "auto", _n = [Ct, Vt, zt, Ot], Le = "start", Nn = "end", Jw = "clippingParents", Es = "viewport", rn = "popper", Zw = "reference", Ba = /* @__PURE__ */ _n.reduce(function(t, e) {
  return t.concat([e + "-" + Le, e + "-" + Nn]);
}, []), Ss = /* @__PURE__ */ [].concat(_n, [$o]).reduce(function(t, e) {
...
function Ue(t, e, n) {
  ...
  var i = ke(t) ? Mt(t) : window, l = i.visualViewport, c = !Ts() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, h = r.width / o, w = r.height / a;
  return {
    width: h,
    height: w,
    top: p,
...
function Pn(t) {
  for (var e = Mt(t), n = ja(t); n && wf(n) && te(n).position === "static"; )
    n = ja(n);
  return n && (qt(n) === "html" || qt(n) === "body" && te(n).position === "static") ? e : n || ff(t) || e;
}
function Mo(t) {
...
var hf = function(e, n) {
  ...
  })) : e, Rs(typeof e != "number" ? e : _s(e, _n));
};
function gf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Yt(n.placement), c = Mo(l), d = [Ot, zt].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var h = hf(o.padding, n), w = Ao(a), g = c === "y" ? Ct : Ot, v = c === "y" ? Vt : zt, f = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], m = i[c] - n.rects.reference[c], E = Pn(a), _ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, C = f / 2 - m / 2, S = h[g], b = _ - w[p] - h[v], I = _ / 2 - w[p] / 2 + C, z = wn(S, I, b), H = c;
...
function Va(t) {
  ...
  if (d) {
    ...
    if (I === Mt(n) && (I = le(n), te(I).position !== "static" && l === "absolute" && (z = "scrollHeight", H = "scrollWidth")), I = I, o === Ct || (o === Ot || o === zt) && a === Nn) {
      S = Vt;
      var O = h && I === b && b.visualViewport ? b.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        I[z]
      );
    ...
    if (o === Ot || (o === Ct || o === Vt) && a === Nn) {
      C = zt;
      var $ = h && I === b && b.visualViewport ? b.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        I[H]
      );
      g -= $ - r.width, g *= c ? 1 : -1;
...
function Nf(t) {
  ...
  e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, Va(Object.assign({}, d, {
    offsets: e.modifiersData.popperOffsets,
    position: e.options.strategy,
    adaptive: i,
    roundOffsets: c
  })))), e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, Va(Object.assign({}, d, {
...
function Ef(t) {
  var e = t.state, n = t.instance, r = t.options, o = r.scroll, a = o === void 0 ? !0 : o, i = r.resize, l = i === void 0 ? !0 : i, c = Mt(e.elements.popper), d = [].concat(e.scrollParents.reference, e.scrollParents.popper);
...
function Ps(t) {
  return ["html", "body", "#document"].indexOf(qt(t)) >= 0 ? t.ownerDocument.body : jt(t) && jo(t) ? t : Ps(xr(t));
}
function fn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Ps(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = Mt(r), i = o ? [a].concat(a.visualViewport || [], jo(r) ? r : []) : r, l = e.concat(i);
  return o ? l : (
...
function kn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Jw : l, d = n.rootBoundary, p = d === void 0 ? Es : d, h = n.elementContext, w = h === void 0 ? rn : h, g = n.altBoundary, v = g === void 0 ? !1 : g, f = n.padding, m = f === void 0 ? 0 : f, E = Rs(typeof m != "number" ? m : _s(m, _n)), _ = w === rn ? Zw : rn, C = t.rects.popper, S = t.elements[v ? _ : w], b = $f(ke(S) ? S : S.contextElement || le(t.elements.popper), c, p, i), I = Ue(t.elements.reference), z = $s({
    reference: I,
    element: C,
    strategy: "absolute",
    placement: o
...
function If(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ss : c, p = Ge(r), h = p ? l ? Ba : Ba.filter(function(v) {
    return Ge(v) === p;
  }) : _n, w = h.filter(function(v) {
...
function Mf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, m = e.options.placement, E = Yt(m), _ = E === m, C = c || (_ || !v ? [Xn(m)] : Af(m)), S = [m].concat(C).reduce(function(V, W) {
      return V.concat(Yt(W) === $o ? If(e, {
        placement: W,
        boundary: p,
        rootBoundary: h,
        padding: d,
...
function Bf(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, i = kn(e, {
    ...
    altBoundary: !0
  }), c = Fa(i, r), d = Fa(l, o, a), p = Ua(c), h = Ua(d);
  e.modifiersData[n] = {
...
function zf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, i = Ss.reduce(function(p, h) {
    return p[h] = Vf(h, e.rects, a), p;
...
function Hf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = kn(e, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: p
  }), E = Yt(e.placement), _ = Ge(e.placement), C = !_, S = Mo(E), b = Gf(S), I = e.modifiersData.popperOffsets, z = e.rects.reference, H = e.rects.popper, O = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, $ = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if (I) {
    if (a) {
      var D, J = S === "y" ? Ct : Ot, q = S === "y" ? Vt : zt, U = S === "y" ? "height" : "width", tt = I[S], at = tt + m[J], rt = tt - m[q], y = g ? -H[U] / 2 : 0, R = _ === Le ? z[U] : H[U], L = _ === Le ? -H[U] : -z[U], F = e.elements.arrow, V = g && F ? Ao(F) : {
        width: 0,
        height: 0
      }, W = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Os(), X = W[J], Y = W[q], G = wn(0, z[U], V[U]), K = C ? z[U] / 2 - y - G - X - $.mainAxis : R - G - X - $.mainAxis, Z = C ? -z[U] / 2 + y + G + Y + $.mainAxis : L + G + Y + $.mainAxis, dt = e.elements.arrow && Pn(e.elements.arrow), A = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Nt = (D = k == null ? void 0 : k[S]) != null ? D : 0, j = tt + K - Nt - A, xt = tt + Z - Nt, Ft = wn(g ? Jn(at, j) : at, tt, g ? ve(rt, xt) : rt);
      I[S] = Ft, B[S] = Ft - tt;
    }
    if (l) {
      var ce, St = S === "x" ? Ct : Ot, In = S === "x" ? Vt : zt, Ut = I[b], Ee = b === "y" ? "height" : "width", de = Ut + m[St], Se = Ut - m[In], Te = [Ct, Ot].indexOf(E) !== -1, Ce = (ce = k == null ? void 0 : k[b]) != null ? ce : 0, pe = Te ? de : Ut - z[Ee] - H[Ee] - Ce + $.altAxis, qe = Te ? Ut + z[Ee] + H[Ee] - Ce - $.altAxis : Se, An = g && Te ? mf(pe, Ut, qe) : wn(g ? pe : de, Ut, g ? qe : Se);
      I[b] = An, B[b] = An - Ut;
    }
    e.modifiersData[r] = B;
  }
...
function Kf(t, e, n) {
  n === void 0 && (n = !1);
  var r = jt(e), o = jt(e) && qf(e), a = le(e), i = Ue(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  jo(a)) && (l = Wf(e)), jt(e) ? (c = Ue(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Bo(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (Ha(_, C)) {
            p.rects = {
              reference: Kf(_, Pn(C), p.options.strategy === "fixed"),
              popper: Ao(C)
    ...
    function v() {
      p.orderedModifiers.forEach(function(m) {
        var E = m.name, _ = m.options, C = _ === void 0 ? {} : _, S = m.effect;
...
var nm = [Sf, Uf, kf, uf, Lf, Df, Xf, vf, jf], rm = /* @__PURE__ */ em({
  defaultModifiers: nm
});
const Is = "Popper";
function om(t) {
...
const cm = () => xo({
  root: ["root"]
}, Lw(om)), dm = {}, pm = /* @__PURE__ */ M.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, m = kt(e, am), E = M.useRef(null), _ = xe(E, n), C = M.useRef(null), S = xe(C, w), b = M.useRef(S);
  ze(() => {
    b.current = S;
  }, [S]), M.useImperativeHandle(w, () => C.current, []);
  const I = sm(p, i), [z, H] = M.useState(I), [O, $] = M.useState(Zn(o));
  M.useEffect(() => {
...
`));
  ...
  const B = cm(), D = (r = v.root) != null ? r : "div", J = Xw({
    elementType: D,
...
}), As = /* @__PURE__ */ M.forwardRef(function(e, n) {
  const {
    anchorEl: r,
    children: o,
    container: a,
    ...
    slotProps: m = {},
    slots: E = {}
  } = e, _ = kt(e, im), [C, S] = M.useState(!0), b = () => {
    S(!1);
  }, I = () => {
    S(!0);
  };
...
var fm = function(e) {
  ...
  return n.componentDidMount = function() {
    ...
    return (
      ...
      /* @__PURE__ */ T.createElement(Ds.Provider, {
        value: null
...
const bm = {
  ...
  const {
    ...
    TransitionComponent: m = mm
  } = e, E = kt(e, gm), _ = sn(), C = M.useRef(), S = Ms(), b = M.useRef(null), I = xe(b, a.ref, n), z = (q) => (U) => {
    if (q) {
      const tt = b.current;
    ...
    f === "auto" ? (rt = S.transitions.getAutoHeightDuration(q.clientHeight), C.current = rt) : rt = U, q.style.transition = [S.transitions.create("opacity", {
      ...
      easing: at
    })].join(","), q.style.opacity = 0, q.style.transform = so(0.75), h && h(q);
  }), D = z(w);
  return /* @__PURE__ */ s(m, P({
    appear: o,
    in: l,
    nodeRef: b,
    onEnter: O,
...
Vo.muiSupportAuto = !0;
const Wa = Vo, vm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], ym = Rn(As, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (t, e) => e.root
})({}), Bs = /* @__PURE__ */ M.forwardRef(function(e, n) {
  var r;
  const o = gs(), a = _o({
    props: e,
    name: "MuiPopper"
    ...
    slots: C,
    slotProps: S
  } = a, b = kt(a, vm), I = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, z = P({
    anchorEl: i,
    container: p,
    disablePortal: h,
    keepMounted: w,
...
const Nm = ws("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), re = Nm, km = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Em(t) {
  return Math.round(t * 1e5) / 1e5;
}
const Sm = (t) => {
...
const Vs = /* @__PURE__ */ M.forwardRef(function(e, n) {
  var r, o, a, i, l, c, d, p, h, w, g, v, f, m, E, _, C, S, b;
  const I = _o({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: Nt
  } = I, j = kt(I, km), xt = /* @__PURE__ */ M.isValidElement(H) ? H : /* @__PURE__ */ s("span", {
    children: H
  }), Ft = Ms(), ce = Ft.direction === "rtl", [St, In] = M.useState(), [Ut, Ee] = M.useState(null), de = M.useRef(!1), Se = J || rt, Te = sn(), Ce = sn(), pe = sn(), qe = sn(), [An, zo] = ls({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const kr = ss(y), Ke = M.useRef(), Mn = eo(() => {
  ...
  const Lo = (Q) => {
    ...
    onFocus: Gs,
    ref: Hs
  } = cs(), [, Go] = M.useState(!1), Ho = (Q) => {
    Us(Q), Uo.current === !1 && (Go(!1), Fo(Q));
  }, Xo = (Q) => {
    St || In(Q.currentTarget), Gs(Q), Uo.current === !0 && (Go(!0), Er(Q));
  }, Yo = (Q) => {
    de.current = !0;
    const Pt = xt.props;
  ...
  const Ws = xe(xt.ref, Hs, In, n);
  !dt && dt !== 0 && (Kt = !1);
  const Sr = M.useRef(), qs = (Q) => {
    const Pt = xt.props;
...
`));
  const Ks = M.useMemo(() => {
    ...
    touch: de.current
  }), Cr = Sm(Qe), Ko = (r = (o = Z.popper) != null ? o : O.Popper) != null ? r : Tm, Jo = (a = (i = (l = Z.transition) != null ? l : O.Transition) != null ? i : A) != null ? a : Wa, Zo = (c = (d = Z.tooltip) != null ? d : O.Tooltip) != null ? c : Cm, Qo = (p = (h = Z.arrow) != null ? h : O.Arrow) != null ? p : Om, Js = ln(Ko, P({}, G, (w = K.popper) != null ? w : $.popper, {
    className: be(Cr.popper, G == null ? void 0 : G.className, (g = (v = K.popper) != null ? v : $.popper) == null ? void 0 : g.className)
  }), Qe), Zs = ln(Jo, P({}, Nt, (f = K.transition) != null ? f : $.transition), Qe), Qs = ln(Zo, P({}, (m = K.tooltip) != null ? m : $.tooltip, {
    className: be(Cr.tooltip, (E = (_ = K.tooltip) != null ? _ : $.tooltip) == null ? void 0 : E.className)
  }), Qe), tl = ln(Qo, P({}, (C = K.arrow) != null ? C : $.arrow, {
  ...
  return /* @__PURE__ */ x(M.Fragment, {
    children: [/* @__PURE__ */ M.cloneElement(xt, Dt), /* @__PURE__ */ s(Ko, P({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(Zo, P({}, Qs, {
          children: [dt, z ? /* @__PURE__ */ s(Qo, P({}, tl, {
            ref: Ee
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Fl,
    {
      ...
      children: n ? /* @__PURE__ */ x(ie, { children: [
        ...
        h ? /* @__PURE__ */ s(ii, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(xs, {}) }) : Ka(i, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ s(Rm, { title: r, placement: "right", children: /* @__PURE__ */ s("div", { children: E }) }) : E;
}
function Ls(t) {
...
function _m(t) {
  const [e, n] = ut(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = t, i = (d) => {
    ...
    let d = Ls(a).filter((p) => "menuItem" in p.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return d = d.filter(
      (p) => "menuItem" in p.group && p.group.menuItem === r.id
    ), /* @__PURE__ */ s(Fs, { ...t, includedGroups: d });
  };
  return /* @__PURE__ */ x(ie, { children: [
    /* @__PURE__ */ s(zs, { onClick: i, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ s(
      Gl,
      {
        anchorEl: e,
...
function $m(t) {
  ...
  )), /* @__PURE__ */ s(Fs, { ...t, includedGroups: a });
}
function Im({
  commandHandler: t,
  menuDefinition: e,
  ...
  return /* @__PURE__ */ x(
    si,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ s(Hl, { id: n, dense: !0, className: a ?? "", children: /* @__PURE__ */ s(
          $m,
          {
            commandHandler: t,
            menuDefinition: e,
...
function Bm({
  ...
  const [c, d] = ut(!1), [p, h] = ut(!1), w = Et(() => {
    ...
    S.stopPropagation(), d((b) => {
      const I = !b;
      return I && S.shiftKey ? h(!0) : I || h(!1), I;
    });
  }, []), v = Et(
    (S) => (w(), r(S)),
    [r, w]
...
const $n = Qn(({ className: t, ...e }, n) => /* @__PURE__ */ s(Nl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
function Dh({
  ...
  const a = ge(void 0);
  return /* @__PURE__ */ s("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ s(Yl, { position: "static", id: r, children: /* @__PURE__ */ x(
    Wl,
    {
...
), Vm = T.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: N(jm({ variant: e }), t), ...n }));
...
const Lm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: N("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Lm.displayName = "AlertDescription";
function Bh({ ...t }) {
  return /* @__PURE__ */ s(
    Kl,
    {
...
const Fm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ x(
  an.Root,
  {
    ref: n,
    className: N(
...
const jh = _t.Root, Gm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  _t.List,
  {
    ref: n,
    className: N(
  ...
  return /* @__PURE__ */ s(
    gt,
    {
      ...
      children: t ? /* @__PURE__ */ s($n, { size: 15 }) : /* @__PURE__ */ x(ie, { children: [
        /* @__PURE__ */ s(kl, { size: 25, className: N("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Uh({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: N("pr-twp tw-prose", n), children: /* @__PURE__ */ s(Jl, { options: o, children: e }) });
}
const Ym = Qn((t, e) => /* @__PURE__ */ x(
  gt,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ s(El, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ s(
        er,
        {
...
function Gh({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ x(fo, { children: [
    ...
    /* @__PURE__ */ s(rr, { children: e.map((n) => /* @__PURE__ */ x("div", { children: [
      ...
      /* @__PURE__ */ s(uc, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(mo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(gi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(or, {})
    ] }, n.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ x("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ s(Sl, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ x("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          ...
          /* @__PURE__ */ x(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ s(Cl, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
