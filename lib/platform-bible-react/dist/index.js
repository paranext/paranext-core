...
import { c as m, g as Ee, a as Fa, C as ke, A as ie, P as De, b as We, B as q, d as Oe, e as Me, f as $e, h as xe, i as Ai, k as Pi, j as Vi, E as ji, l as Ua, r as pe, m as Li, n as cn, o as Qr, p as ta, L as Nt, R as Ka, q as qr, D as Na, s as Ca, t as Ea, u as Ta, T as ln, v as Vr, w as Pt, x as qa, y as Vt, z as jt, F as Lt, G as dn, H as Ga, I as Ge, J as kr, K as Ie, M as Ae, N as Pe, S as _r, O as er, Q as Bi, U as Er, V as Ye, W as ze, Z as Xe, X as Te, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as wn, a3 as Fi, a4 as Ui, a5 as Ki, a6 as za, a7 as un, a8 as ea, a9 as pn, aa as qi, ab as Gi, ac as Hi, ad as Yi, ae as hn, af as Wi, ag as ca, ah as bo, ai as la, aj as Xi, ak as Ji, al as Zi, am as Qi, an as ts, ao as Tr, ap as Xa, aq as es, ar as rs } from "./resizable-BwezOpOQ.js";
...
import { Avatar as ao, Select as Gt, Checkbox as Do, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Oo, Slider as Or, Switch as Mo } from "radix-ui";
...
function Rl(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < g.length; E++) {
      ...
      const I = de(y.width);
      O.width !== I && (N.style.width = I, v = !0);
      const A = de(y.height);
      O.height !== A && (N.style.height = A, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[E] = N;
    }
...
function Ol(t, e = Dl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, E = g.getNode(), y = E.getKey(), N = g.offset, O = t.getElementByKey(b), B = t.getElementByKey(y), z = r === null || O !== o || v !== n || b !== r.getKey(), I = i === null || B !== s || N !== c || y !== i.getKey();
...
class Zn extends Ma {
  $config() {
    return this.config("decorator-text", { extends: Ma, stateConfigs: [{ flat: !0, stateConfig: fa }] });
  }
  getFormat() {
    return zc(this, fa);
  }
...
function fp({
  ...
  const [f, b] = _("generated"), [v, E] = _("generated"), [y, N] = _("*"), [O, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [P, U] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, K] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
function Ep({
  ...
  const g = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), O = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
...
function Up({
  ...
  ] }), tt = e ? Bt.filter((M) => e.includes(M.value)) : Bt, wt = f ?? wa, at = w ?? wt, mt = p ?? wt, ae = () => {
