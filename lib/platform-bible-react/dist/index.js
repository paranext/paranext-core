...
import { c as v, g as Re, a as Ir, C as Ge, L as Kn, u as Qo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as ze, f as ke, h as Ie, i as kr, j as Be, B as Z, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ke, r as Ce, o as xs, p as Hn, P as tr, q as _r, s as er, t as rr, v as Na, w as Ca, y as No, z as ar, E as Ea, F as Mt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as qn, O as na, Q as Eo, S as Vr, U as Lr, V as pr, W as ys, X as Je, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as Gn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Yn, aa as Ta, ab as Cs, ac as Wn, ad as Es, ae as Ts, af as Ss, ag as tn, ah as Rs, ai as Ds, aj as Ms, ak as Xn, al as Zn, am as Do, an as Os, ao as Jn, ap as Ba, aq as en, ar as ja, as as zs, at as Is, au as Ps, av as As, aw as $s, ax as Fr, ay as Mo, az as Vs, aA as Ls } from "./resizable-DWUA1ZY3.js";
import { aB as of, aC as nf, aD as sf, aE as cf, aF as lf, aG as df, aH as wf, aI as uf, aJ as pf, aK as hf, aL as gf, aM as ff, aN as mf, aO as vf, aP as bf, aQ as xf, aR as yf, aS as kf, aT as _f, aU as Nf, aV as Cf, aW as Ef, aX as Tf, aY as Sf, aZ as Rf, a_ as Df, a$ as Mf, b0 as Of, b1 as zf, b2 as If, b3 as Pf, b4 as Af, b5 as $f, b6 as Vf, b7 as Lf, b8 as Bf, b9 as jf, ba as Ff } from "./resizable-DWUA1ZY3.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as rn, ChevronsLeft as an, ChevronsRight as on, ChevronUp as Qn, ChevronDown as Qe, ArrowLeft as Bs, ArrowRight as js, BoldIcon as Fs, ItalicIcon as Us, X as Oo, AtSign as ti, Pencil as Ks, Trash2 as Hs, ArrowUp as ei, MoreHorizontal as qs, MailOpen as Gs, Mail as Ys, FilterIcon as Ws, ArrowLeftIcon as Xs, ChevronLeftIcon as Zs, ChevronRightIcon as Js, ArrowRightIcon as Qs, Copy as ri, Filter as tc, User as ec, Link as rc, CircleHelp as ac, Undo as oc, Redo as nc, SquareX as ai, FunctionSquare as oi, SquareSigma as ni, Ban as ic, AlertCircle as so, CircleCheckIcon as sc, CircleXIcon as cc, CircleHelpIcon as lc, ArrowUpIcon as dc, ArrowDownIcon as wc, ScrollText as uc, ChevronRight as pc, ChevronLeft as hc, ChevronsUpDown as gc, MenuIcon as fc, Menu as mc, EllipsisVertical as vc, MoreVertical as bc } from "lucide-react";
import { Section as Dt, compareScrRefs as ma, getChaptersForBook as xc, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as ia, formatRelativeDate as yc, sanitizeHtml as zo, NumberFormat as ii, formatBytes as kc, getCurrentLocale as _c, usfmMarkers as sa, isPlatformError as Nc, ABORTED as Cc, getErrorMessage as Ec, getFormatCallerFunction as Tc, deepEqual as Sc, isString as nn, scrRefToBBBCCCVVV as Fa, defaultScrRef as Ua, formatScrRefRange as Rc, getLocalizeKeyForScrollGroupId as sn, formatReplacementStringToArray as cn, collectUsjMarkers as Dc } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Sa, useState as _, useEffect as W, useCallback as j, useId as co, useImperativeHandle as Mc, useLayoutEffect as Zt, Fragment as Kr, Component as Oc, createElement as ln, Suspense as zc, forwardRef as Io } from "react";
...
import { createEditor as li, $getRoot as qe, $createParagraphNode as Hr, $getSelection as ae, HISTORY_MERGE_TAG as Po, ParagraphNode as di, TextNode as wi, $getPreviousSelection as Kc, $isRangeSelection as _e, $caretFromPoint as Hc, $getSiblingCaret as ui, $getChildCaret as qc, $getAdjacentChildCaret as Gc, $isChildCaret as Yc, $normalizeCaret as Wc, $setSelectionFromCaretRange as Xc, $getCollapsedCaretRange as Zc, $getCaretInDirection as dn, $splitAtPointCaretNext as Jc, $isTextPointCaret as Qc, $findMatchingParent as pi, $isElementNode as Br, mergeRegister as Oe, getDOMTextNode as tl, isHTMLElement as el, CLEAR_EDITOR_COMMAND as hi, COMMAND_PRIORITY_EDITOR as Ao, shallowMergeConfig as rl, defineExtension as ue, safeCast as or, createState as al, FORMAT_TEXT_COMMAND as gi, $isNodeSelection as fi, COMMAND_PRIORITY_LOW as mi, RootNode as ol, LineBreakNode as nl, TabNode as il, $isEditorState as sl, createCommand as cl, CLICK_COMMAND as ll, isDOMNode as dl, $getNodeFromDOMNode as wl, $createNodeSelection as ul, $setSelection as pl, $getEditor as hl, DecoratorNode as lo, $getState as gl, toggleTextFormatType as wn, TEXT_TYPE_TO_FORMAT as fl, $setState as ml, addClassNamesToElement as vi, $create as vl, $getNodeByKey as bl, removeClassNamesFromElement as xl, KEY_TAB_COMMAND as yl, $isBlockElementNode as kl, $createRangeSelection as _l, $normalizeSelection__EXPERIMENTAL as Nl, OUTDENT_CONTENT_COMMAND as Cl, INDENT_CONTENT_COMMAND as un, INSERT_TAB_COMMAND as El, COMMAND_PRIORITY_CRITICAL as $o, $isDecoratorNode as Tl, $isParagraphNode as Sl, $isTextNode as wo, SELECTION_CHANGE_COMMAND as bi, $insertNodes as Rl } from "lexical";
...
import { Avatar as Vo, Select as Jt, Checkbox as pn, Slot as qr, Tabs as fe, Menubar as Ee, ContextMenu as Ft, Progress as hn, Slider as Qr, Switch as gn } from "radix-ui";
...
function nd({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = co(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, ad), P = re(s, od), T = (M) => {
...
function Ha({
  ...
  const T = Ce(), B = Ql(), [I, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, z] = _(void 0), [q, it] = _(
    void 0
  ), [ot, dt] = _(void 0), [St, J] = _(!1), [lt, vt] = _(!1), [pt, zt] = _(!1), [Ht, wt] = _(!1), me = F(null), oe = F(!1), bt = F(void 0), gt = F(void 0), xt = F(void 0), qt = F(void 0), Rt = F({}), Nt = F({}), ft = j(
    (m) => {
      e(m), l && l(m);
    },
    [e, l]
    ...
    if (!A) return;
    const m = M.startsWith(`${A.book} `) ? M : "", H = ta(m), at = zr(m);
    return {
      book: A.book,
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (m) => {
      ...
      if (!(!!H && !!((Xo = bt.current) != null && Xo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
      ...
      const { isLetter: Lt, isDigit: Kt } = fn(m.key);
      ...
      N === "books" && wt(!0), yt.takeFocus && ((Zo = bt.current) == null || Zo.focus());
      const ee = pd({
        current: yt.current,
        key: m.key,
        max: yt.max,
    ...
    const { isLetter: H, isDigit: at } = fn(m.key);
    (H || at) && (m.preventDefault(), tt((yt) => yt + m.key), (Kt = gt.current) == null || Kt.focus(), J(!1));
  }, []);
  Zt(() => {
    const m = setTimeout(() => {
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bd = Di ? Zt : W, ra = { tag: Po };
    ...
    w.read(() => {
      ...
      if ((T || B) && E !== null && P !== null) {
        const I = function(D, M, Y, U, tt, N, rt) {
          ...
          return O.setStart(...kn(M, Y, U)), O.setEnd(...kn(tt, N, rt)), O;
        }(t, h, f, E, g, R, P);
        l(), l = zd(t, I, e);
      }
...
function Ld(t, e, r) {
  ...
  return Qc(o) && va(283), o.insert(t.isInline() ? Hr().append(t) : t), dn(ui(t.getLatest(), "next"), e.direction);
}
function Bd(t) {
  const e = ae();
  if (!_e(e)) return !1;
...
function Hd(t) {
  ...
  zi(this), st = t, this.f &= -2, 8 & this.f && jo(this), Ma();
}
function ur(t, e) {
...
Wt.prototype.brand = jd, Wt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ii(this), Cn(this), Me++;
  const t = st;
...
const Fo = 0, yo = 1, Bi = 2, Wa = 3, aa = 4, wr = 5, Xa = 6, Mr = 7;
function Za(t) {
  return t.id === Fo;
}
function ji(t) {
...
const Jd = ue({ config: or({ setOptions: En, updateOptions: En }), init: ({ $initialEditorState: t = Zd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ol, wi, nl, il, di] }), Tn = Symbol.for("@lexical/extension/LexicalBuilder");
function Sn() {
}
function Qd(t) {
  throw t;
...
class fr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Za(s) || ut(300, i, n || "[unknown]"), Za(c = s) || ut(304, String(c.id), String(Fo)), s = Object.assign(c, { id: yo }), o.state = s;
...
const tw = /* @__PURE__ */ new Set(), Rn = ue({ build(t, e, r) {
...
ue({ dependencies: [xo, Rn], name: "@lexical/extension/HorizontalRule", nodes: () => [mr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Rn).output, n = jr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
...
const Ko = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
...
const Ow = "verseText", nh = Object.freeze([
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : qo(b) && (b.preventDefault(), b.stopPropagation(), we(s) && g());
        },
        onKeyDown: (b) => {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : qo(T) && (T.preventDefault(), T.stopPropagation(), we(w) && f());
              },
              onKeyDown: (T) => {
...
function rs({
  ...
  const [U, tt] = _(Pn), [N, rt] = _(), [O, z] = _(), q = o, [it, ot] = _(!1), [dt, St] = _(!1), [J, lt] = _(!1), [vt, pt] = _(!1), [zt, Ht] = _(!1), [wt, me] = _(E), [oe, bt] = _(!1), gt = F(void 0), [xt, qt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let y = !0;
    return (async () => {
      const $ = k ? await k(l) : !1;
  ...
  const ft = V(() => Nt[0], [Nt]), ne = F(null), ie = F(void 0), se = j(() => {
    var y;
    (y = ie.current) == null || y.call(ie), tt(Pn);
  }, []), Ae = j(() => {
    const y = !wt;
          ...
          o && /* @__PURE__ */ u(ht, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    it ? /* @__PURE__ */ a(Qn, {}) : /* @__PURE__ */ a(Qe, {})
                  ] })
                ]
              }
            ),
            ...
            b !== !1 && (!dt || we(U)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (y) => {
                  qo(y) && (y.preventDefault(), y.stopPropagation(), (we(U) || N !== void 0 && N !== O) && S());
                },
                onKeyDown: (y) => {
                  Ho(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ya,
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(qw, { ...q, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...q })
          },
          z.id
        );
      })
...
const fh = "data-platform-content-zoom-root", Gw = Io(
  function({ area: e, ...r }, o) {
    return /* @__PURE__ */ a(
      "div",
      {
...
Gw.displayName = "ContentZoomRoot";
function Yw({ table: t }) {
...
function cu({
  ...
  return /* @__PURE__ */ u(ze, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: su(t, o, e) }) }) }),
...
function wu({
  ...
  return /* @__PURE__ */ u(ze, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: lu(t, r) }) }) }),
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: du(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ie, { style: { zIndex: Yn }, children: [
...
function Eh({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [I, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), z = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, J] = _(), [lt, vt] = _(), [pt, zt] = _(), Ht = F(null), wt = F(
    void 0
  ...
  W(() => {
    ...
    if (y && Dr("note", y)) {
      ...
      let nt = "custom";
      et === uo ? nt = "generated" : et === po ? nt = "hidden" : et && (P(et), B(et)), R(nt), C(nt), D((($ = y.insert.note) == null ? void 0 : $.style) ?? "f"), S = setTimeout(() => {
        var ct, _t, Pt;
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      I !== "x" && S === "x" ? nt == null || nt.forEach((ct) => vu(ct)) : I === "x" && S !== "x" && (nt == null || nt.forEach((ct) => bu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (S) => {
...
function Bu({
  ...
  const c = t ? qr.Root : "button", { state: l } = za(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Lu({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Iu,
    {
      ...
      children: /* @__PURE__ */ u(Au, { children: [
        /* @__PURE__ */ u(Ln, { children: [
          ...
          /* @__PURE__ */ a(jn, { children: /* @__PURE__ */ a($u, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Vu, { children: /* @__PURE__ */ a(
            Bu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Ve = "scrBook", Fu = "scrRef", Ze = "source", Uu = "details", Ku = "Scripture Reference", Hu = "Scripture Book", ns = "Type", qu = "Details";
function Gu(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Zh({
  ...
  W(() => {
    if (c) {
      ...
      if (M.length === 1) {
        const Y = x.find((U) => Fn(U) === M[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, x, c, R]);
...
function Qh({
  ...
  const Wr = j(
    ...
    y !== void 0 && (y === "range" ? ($ && (f == null || f($)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), It(y), X(void 0), G(void 0));
  }, [
    y,
    $,
    nt,
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          yr,
          {
            ...
            style: { zIndex: Pe },
            children: t.map((w) => /* @__PURE__ */ a(ge, { value: `${w}`, children: l[sn(w)] }, `${w}`))
          }
        )
      ]
    }
...
export {
  ...
  fh as CONTENT_ZOOM_ROOT_ATTRIBUTE,
