...
import A, { forwardRef as Kn, useCallback as Me, useState as ue, useRef as gt, useEffect as at, useLayoutEffect as Ho, useMemo as _e } from "react";
...
const ao = we.Root, as = we.Trigger, zl = we.Group, ym = we.Portal, xm = we.Sub, Nm = we.RadioGroup, Fl = A.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ x(
  we.SubTrigger,
  {
    ref: o,
    className: T(
...
const Ul = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  we.SubContent,
  {
    ref: n,
    className: T(
...
const ss = A.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ i(
  we.Item,
  {
    ref: r,
    className: T(
...
const is = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  we.RadioItem,
  {
    ref: r,
    className: T(
...
const Nn = A.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ i(
  we.Label,
  {
    ref: r,
...
function km({ scrRef: e, handleSubmit: t }) {
  const [n, r] = ue(""), [o, a] = ue(
    ...
    oe.bookNumberToId(e.bookNum)
  ), [p, h] = ue(!1), [w, b] = ue(p), v = gt(void 0), f = gt(void 0), m = gt(void 0), E = Me(
    (N) => Jl(N).filter((B) => {
    ...
    (N) => {
      p ? (N.key === "ArrowDown" || N.key === "ArrowUp") && (typeof m < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      m.current !== null ? m.current.focus() : typeof f < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      f.current !== null && f.current.focus(), N.preventDefault()) : h(!0);
    },
    [p]
  ), C = (N) => {
    const { key: B } = N;
...
), He = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(Ga.Root, { ref: n, className: T("pr-twp", nc(), e), ...t }));
He.displayName = Ga.Root.displayName;
const ls = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  un.Root,
  {
...
const rc = wn.Root, oc = wn.Trigger, cs = A.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ i(wn.Portal, { children: /* @__PURE__ */ i(
  wn.Content,
  {
    ref: o,
    align: t,
...
const ac = Ye.Portal, ds = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ye.Overlay,
  {
    ref: n,
    className: T(
...
const sc = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(ac, { children: [
  /* @__PURE__ */ i(ds, {}),
  /* @__PURE__ */ x(
    Ye.Content,
    {
...
const ic = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ye.Title,
  {
    ref: n,
...
const lc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ye.Description,
  {
    ref: n,
...
const ps = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Se,
  {
    ref: n,
    className: T(
...
const us = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
...
const ws = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Se.List,
  {
    ref: n,
...
const fs = A.forwardRef((e, t) => /* @__PURE__ */ i(Se.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
...
const ms = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Se.Item,
  {
    ref: n,
    className: T(
...
function qo({
  ...
  const [v, f] = ue(!1);
  return /* @__PURE__ */ x(rc, { open: v, onOpenChange: f, ...b, children: [
    /* @__PURE__ */ i(oc, { asChild: !0, children: /* @__PURE__ */ x(
      be,
      {
        ...
        disabled: w,
        children: [
          /* @__PURE__ */ i("span", { className: "tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: uc(r, s, a) }),
          /* @__PURE__ */ i(Mi, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(cs, { className: "tw-w-[200px] tw-p-0", dir: h, children: /* @__PURE__ */ x(ps, { children: [
      /* @__PURE__ */ i(us, { dir: h, placeholder: l, className: "tw-text-inherit" }),
      /* @__PURE__ */ i(fs, { children: c }),
      /* @__PURE__ */ i(ws, { children: t.map((m) => /* @__PURE__ */ x(
        ms,
        {
          value: a(m),
          onSelect: () => {
            ...
            /* @__PURE__ */ i(
              Jn,
              {
                className: T("tw-me-2 tw-h-4 tw-w-4", {
                  "tw-opacity-0": Array.isArray(r) ? !r.includes(m) : !r || a(r) !== a(m)
                })
              }
            ),
            a(m)
...
const fn = ge.Root, hc = ge.Group, mn = ge.Value, Mt = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Trigger,
  {
    ref: r,
    className: T(
...
const hs = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  ge.ScrollUpButton,
  {
    ref: n,
...
const Bt = A.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ i(ge.Portal, { children: /* @__PURE__ */ x(
  ge.Content,
  {
    ref: o,
    className: T(
...
function Nc({
  ...
  var m;
  const [l, c] = ue([]), [d, p] = ue([]), [h, w] = ue({}), [b, v] = ue({}), f = Ha({
    data: t,
    columns: e,
    getCoreRowModel: Xa(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(rr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(or, { stickyHeader: a, children: f.getHeaderGroups().map((E) => /* @__PURE__ */ i(ot, { children: E.headers.map((I) => /* @__PURE__ */ i(hn, { children: I.isPlaceholder ? void 0 : sn(I.column.columnDef.header, I.getContext()) }, I.id)) }, E.id)) }),
      /* @__PURE__ */ i(ar, { children: (m = f.getRowModel().rows) != null && m.length ? f.getRowModel().rows.map((E) => /* @__PURE__ */ i(
        ot,
        {
          onClick: () => s(E, f),
          "data-state": E.getIsSelected() && "selected",
          children: E.getVisibleCells().map((I) => /* @__PURE__ */ i(jt, { children: sn(I.column.columnDef.cell, I.getContext()) }, I.id))
        },
        E.id
...
const io = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Fr.Root,
  {
    ref: n,
    className: T(
...
const vs = A.createContext({
  size: "default",
  variant: "default"
}), ys = A.forwardRef(({ className: e, variant: t, size: n, children: r, ...o }, a) => /* @__PURE__ */ i(
  er.Root,
  {
    ref: a,
...
function Pm({
  ...
  const h = Je(n, "%webView_inventory_all%"), w = Je(n, "%webView_inventory_approved%"), b = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), f = Je(n, "%webView_inventory_scope_currentBook%"), m = Je(n, "%webView_inventory_scope_chapter%"), E = Je(n, "%webView_inventory_scope_verse%"), I = Je(n, "%webView_inventory_filter_text%"), O = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [k, g] = ue(!1), [_, L] = ue("all"), [H, C] = ue(""), [P, N] = ue([]), B = _e(() => l ? r instanceof RegExp ? Pc(
    l,
    e,
    a,
    s,
...
)), ks = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.Content,
  {
    ref: n,
    className: T(
...
function $m({
  ...
  const [d, p] = ue([]), [h, w] = ue([{ id: nt, desc: !1 }]), [b, v] = ue({}), f = _e(
    ...
    !t && /* @__PURE__ */ x(
      fn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Bt, { position: "item-aligned", children: /* @__PURE__ */ i(hc, { children: k.map((C) => /* @__PURE__ */ i(Ue, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
const Ts = A.forwardRef(({ className: e, orientation: t = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ i(
  qa.Root,
  {
    ref: o,
    decorative: n,
...
function Uc() {
  if (Zo)
    return se;
  Zo = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, a = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, d = e ? Symbol.for("react.concurrent_mode") : 60111, p = e ? Symbol.for("react.forward_ref") : 60112, h = e ? Symbol.for("react.suspense") : 60113, w = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, v = e ? Symbol.for("react.lazy") : 60116, f = e ? Symbol.for("react.block") : 60121, m = e ? Symbol.for("react.fundamental") : 60117, E = e ? Symbol.for("react.responder") : 60118, I = e ? Symbol.for("react.scope") : 60119;
  function O(g) {
  ...
  return se.AsyncMode = c, se.ConcurrentMode = d, se.ContextConsumer = l, se.ContextProvider = s, se.Element = t, se.ForwardRef = p, se.Fragment = r, se.Lazy = v, se.Memo = b, se.Portal = n, se.Profiler = a, se.StrictMode = o, se.Suspense = h, se.isAsyncMode = function(g) {
    return k(g) || O(g) === c;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === d || g === a || g === o || g === h || g === w || typeof g == "object" && g !== null && (g.$$typeof === v || g.$$typeof === b || g.$$typeof === s || g.$$typeof === l || g.$$typeof === p || g.$$typeof === m || g.$$typeof === E || g.$$typeof === I || g.$$typeof === f);
  }, se.typeOf = O, se;
}
var ie = {};
/** @license React v16.13.1
...
function Gc() {
  return Qo || (Qo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function O($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === h || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === b || $.$$typeof === s || $.$$typeof === l || $.$$typeof === p || $.$$typeof === m || $.$$typeof === E || $.$$typeof === I || $.$$typeof === f);
    }
    function k($) {
    ...
    var g = c, _ = d, L = l, H = s, C = t, P = p, N = r, B = v, D = b, J = n, q = a, U = o, ee = h, ae = !1;
    function re($) {
...
function td() {
  ...
  return le.ContextConsumer = s, le.ContextProvider = a, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = w, le.Memo = h, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = d, le.SuspenseList = p, le.isAsyncMode = function() {
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === d || m === p || m === b || typeof m == "object" && m !== null && (m.$$typeof === w || m.$$typeof === h || m.$$typeof === a || m.$$typeof === s || m.$$typeof === c || m.$$typeof === v || m.getModuleId !== void 0);
  }, le.typeOf = f, le;
}
var ce = {};
/**
...
function nd() {
  return la || (la = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, f = !1, m = !1, E = !1, I = !1, O;
    O = Symbol.for("react.module.reference");
    function k(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || I || j === r || j === d || j === p || E || j === b || v || f || m || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === h || j.$$typeof === a || j.$$typeof === s || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var _ = s, L = a, H = e, C = c, P = n, N = w, B = h, D = t, J = o, q = r, U = d, ee = p, ae = !1, re = !1;
    function y(j) {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return xa(f, "light", I, r), xa(f, "dark", O, r), f.contrastText || (f.contrastText = h(f.main)), f;
  }, b = {
    dark: jr,
    light: ya
  };
...
function cu(e, t) {
  ...
  const b = o / 14, v = h || ((E) => `${E / d * b}rem`), f = (E, I, O, k, g) => R({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(I),
...
function hw(e) {
  ...
  if (!(!a || !s)) {
    var h = mw(o.padding, n), w = To(a), b = c === "y" ? Te : Ce, v = c === "y" ? je : Ve, f = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], m = s[c] - n.rects.reference[c], E = On(a), I = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, O = f / 2 - m / 2, k = h[b], g = I - w[p] - h[v], _ = I / 2 - w[p] / 2 + O, L = dn(k, _, g), H = c;
...
function Pa(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, p = e.roundOffsets, h = e.isFixed, w = s.x, b = w === void 0 ? 0 : w, v = s.y, f = v === void 0 ? 0 : v, m = typeof p == "function" ? p({
    x: b,
    y: f
  }) : {
    x: b,
  ...
  b = m.x, f = m.y;
  var E = s.hasOwnProperty("x"), I = s.hasOwnProperty("y"), O = Ce, k = Te, g = window;
  if (d) {
  ...
  if (b = B.x, f = B.y, c) {
    var D;
    return Object.assign({}, N, (D = {}, D[k] = I ? "0" : "", D[O] = E ? "0" : "", D.transform = (g.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + f + "px)" : "translate3d(" + b + "px, " + f + "px, 0)", D));
  }
  return Object.assign({}, N, (t = {}, t[k] = I ? f + "px" : "", t[O] = E ? b + "px" : "", t.transform = "", t));
}
function xw(e) {
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, s = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Ju : l, d = n.rootBoundary, p = d === void 0 ? Zs : d, h = n.elementContext, w = h === void 0 ? en : h, b = n.altBoundary, v = b === void 0 ? !1 : b, f = n.padding, m = f === void 0 ? 0 : f, E = ri(typeof m != "number" ? m : oi(m, Sn)), I = w === en ? Zu : en, O = e.rects.popper, k = e.elements[v ? I : w], g = _w(kt(k) ? k : k.contextElement || lt(e.elements.popper), c, p, s), _ = Ut(e.elements.reference), L = si({
    reference: _,
    element: O,
    strategy: "absolute",
    placement: o
...
function $w(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Qs : c, p = Gt(r), h = p ? l ? Oa : Oa.filter(function(v) {
    return Gt(v) === p;
  }) : Sn, w = h.filter(function(v) {
...
function Iw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, w = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, f = n.allowedAutoPlacements, m = t.options.placement, E = Xe(m), I = E === m, O = c || (I || !v ? [Un(m)] : Aw(m)), k = [m].concat(O).reduce(function(V, W) {
...
function Gw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, w = n.tether, b = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: p
  }), E = Xe(t.placement), I = Gt(t.placement), O = !I, k = Co(E), g = Uw(k), _ = t.modifiersData.popperOffsets, L = t.rects.reference, H = t.rects.popper, C = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, P = typeof C == "number" ? {
    mainAxis: C,
    altAxis: C
  ...
  if (_) {
    if (a) {
      var D, J = k === "y" ? Te : Ce, q = k === "y" ? je : Ve, U = k === "y" ? "height" : "width", ee = _[k], ae = ee + m[J], re = ee - m[q], y = b ? -H[U] / 2 : 0, S = I === zt ? L[U] : H[U], z = I === zt ? -H[U] : -L[U], F = t.elements.arrow, V = b && F ? To(F) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var ct, ke = k === "x" ? Te : Ce, Pn = k === "x" ? je : Ve, Fe = _[g], Et = g === "y" ? "height" : "width", dt = Fe + m[ke], Tt = Fe - m[Pn], Ct = [Te, Ce].indexOf(E) !== -1, St = (ct = N == null ? void 0 : N[g]) != null ? ct : 0, pt = Ct ? dt : Fe - L[Et] - H[Et] - St + P.altAxis, Xt = Ct ? Fe + L[Et] + H[Et] - St - P.altAxis : Tt, _n = b && Ct ? fw(pt, Fe, Xt) : dn(b ? pt : dt, Fe, b ? Xt : Tt);
      _[g] = _n, B[g] = _n - Fe;
    }
    t.modifiersData[r] = B;
  }
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      forceUpdate: function() {
        if (!w) {
          var E = p.elements, I = E.reference, O = E.popper;
          if (Ma(I, O)) {
            p.rects = {
              reference: qw(I, On(O), p.options.strategy === "fixed"),
              popper: To(O)
    ...
    function v() {
      p.orderedModifiers.forEach(function(m) {
        var E = m.name, I = m.options, O = I === void 0 ? {} : I, k = m.effect;
...
const cf = () => uo({
  ...
  } = t, m = Ne(t, of), E = M.useRef(null), I = xt(E, n), O = M.useRef(null), k = xt(O, w), g = M.useRef(k);
  Lt(() => {
    g.current = k;
...
`));
  ...
  const {
    ...
    slotProps: m = {},
    slots: E = {}
  } = t, I = Ne(t, af), [O, k] = M.useState(!0), g = () => {
    k(!1);
  }, _ = () => {
    k(!0);
  };
...
const bf = {
  ...
  } = t, E = Ne(t, gf), I = rn(), O = M.useRef(), k = ci(), g = M.useRef(null), _ = xt(g, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = g.current;
...
const wi = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, s, l, c, d, p, h, w, b, v, f, m, E, I, O, k, g;
  const _ = xo({
    props: t,
    name: "MuiTooltip"
  }), {
...
`));
  const Ei = M.useMemo(() => {
    ...
    className: bt(Er.tooltip, (E = (I = K.tooltip) != null ? I : P.tooltip) == null ? void 0 : E.className)
...
function Bf({
  ...
  const [c, d] = ue(!1), [p, h] = ue(!1), w = Me(() => {
    ...
    k.stopPropagation(), d((g) => {
      const _ = !g;
      return _ && k.shiftKey ? h(!0) : _ || h(!1), _;
    });
  }, []), v = Me(
    (k) => (w(), r(k)),
    [r, w]
...
const Hf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i("p", { ref: n, className: T("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
const Wf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  nn.Root,
  {
    ref: n,
    className: T(
...
const Fm = Oe.Root, Kf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.List,
  {
    ref: n,
    className: T(
...
const Jf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.Trigger,
  {
    ref: n,
    className: T(
