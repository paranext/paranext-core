...
import { Check as Oe, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Sa, ChevronRight as Ra, ArrowLeft as ns, ArrowRight as is, ChevronDown as nr, BoldIcon as ss, ItalicIcon as cs, X as Ja, AtSign as mn, Pencil as ls, Trash2 as ds, ArrowUp as vn, MoreHorizontal as ws, MailOpen as us, Mail as ps, ChevronUp as hs, FilterIcon as gs, ArrowLeftIcon as fs, ChevronLeftIcon as ms, ChevronRightIcon as vs, ArrowRightIcon as bs, Copy as bn, Filter as xs, User as ys, Link as ks, CircleHelp as _s, Undo as Ns, Redo as Cs, SquareX as xn, FunctionSquare as yn, SquareSigma as kn, Minus as Es, Ban as Ts, AlertCircle as Da, CircleCheckIcon as zs, CircleXIcon as Ss, CircleHelpIcon as Rs, ArrowUpIcon as Ds, ArrowDownIcon as Os, ScrollText as Ms, ChevronsUpDown as $s, MenuIcon as As, Menu as Is, EllipsisVertical as Vs, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Ps, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as js, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as _n, formatBytes as Ls, getCurrentLocale as Bs, usfmMarkers as jr, getFormatCallerFunction as Fs, deepEqual as Us, isString as Co, compareScrRefs as Oa, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as Eo, formatReplacementStringToArray as To, collectUsjMarkers as qs } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Gs, useLayoutEffect as Qt, createContext as Qa, useContext as Nn, Component as Hs, createElement as zo, Suspense as Ys, forwardRef as Cn, useId as So, Fragment as ra } from "react";
import { IconSelector as En, IconCheck as aa, IconChevronDown as Ws, IconChevronUp as Xs, IconLayoutSidebar as Js, IconLayoutSidebarRight as Zs, IconChevronRight as Tn, IconSearch as Qs, IconLoader as tc, IconAlertOctagon as ec, IconAlertTriangle as rc, IconInfoCircle as ac, IconCircleCheck as oc } from "@tabler/icons-react";
import { createEditor as zn, $getRoot as Me, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as Sn, TextNode as Rn, $getPreviousSelection as nc, $isRangeSelection as we, $caretFromPoint as ic, $getSiblingCaret as Dn, $getChildCaret as sc, $getAdjacentChildCaret as cc, $isChildCaret as lc, $normalizeCaret as dc, $setSelectionFromCaretRange as wc, $getCollapsedCaretRange as uc, $getCaretInDirection as Ro, $splitAtPointCaretNext as pc, $isTextPointCaret as hc, $findMatchingParent as On, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as gc, isHTMLElement as fc, CLEAR_EDITOR_COMMAND as Mn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as mc, defineExtension as re, safeCast as Je, createState as vc, FORMAT_TEXT_COMMAND as $n, $isNodeSelection as An, COMMAND_PRIORITY_LOW as In, RootNode as bc, LineBreakNode as xc, TabNode as yc, $isEditorState as kc, createCommand as _c, CLICK_COMMAND as Nc, isDOMNode as Cc, $getNodeFromDOMNode as Ec, $createNodeSelection as Tc, $setSelection as zc, $getEditor as Sc, DecoratorNode as Ma, $getState as Rc, toggleTextFormatType as Do, TEXT_TYPE_TO_FORMAT as Dc, $setState as Oc, addClassNamesToElement as Vn, $create as Mc, $getNodeByKey as $c, removeClassNamesFromElement as Ac, KEY_TAB_COMMAND as Ic, $isBlockElementNode as Vc, $createRangeSelection as Pc, $normalizeSelection__EXPERIMENTAL as jc, OUTDENT_CONTENT_COMMAND as Lc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Bc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Fc, $isParagraphNode as Uc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Pn, $insertNodes as Kc } from "lexical";
...
import { useReactTable as Ln, getFilteredRowModel as Qc, getSortedRowModel as Bn, getPaginationRowModel as tl, getCoreRowModel as Fn, flexRender as xr, getGroupedRowModel as el, getExpandedRowModel as rl } from "@tanstack/react-table";
import al from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Aa, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as ol, isInsertEmbedOpOfType as Mr, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vl = Hn ? Qt : H, Ar = { tag: to };
...
const xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function Tl(t) {
...
function Ol(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: g } = n.getBoundingClientRect(), h = Sl(t, e);
    var f, x;
...
function Vl(t) {
  ...
  if (we(e)) r = ic(e.focus, "next");
    ...
    r = r || sc(Me(), "previous").getFlipped().insert(zr());
  }
...
function Pl(t, e, r) {
  ...
  return hc(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), Ro(Dn(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = Xt();
  if (!we(e)) return !1;
...
let Yr, be = 0, Wr = 0, Fl = 0, Pa = 0, Br = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
} }), Ke.prototype = new Bt(), Ke.prototype.h = function() {
...
const ga = vc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ti extends Ma {
  $config() {
...
const Jl = re({ config: Je({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Xl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class or {
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const g of ql(p)) {
...
const Ql = /* @__PURE__ */ new Set(), Yo = re({ build(t, e, r) {
...
re({ dependencies: [ja, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ne(t.registerCommand(td, (s) => {
    const c = Xt();
    if (!we(c)) return !1;
    ...
    return !0;
  }, eo), t.registerCommand(Nc, (s) => {
    if (Cc(s.target)) {
      const c = Ec(s.target);
      if (rd(c)) return function(l, d = !1) {
        const w = Xt(), p = l.isSelected(), g = l.getKey();
        let h;
        d && An(w) ? h = w : (h = Tc(), zc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  ...
  return Ne(t.registerCommand(Ic, (o) => {
    ...
    const i = function(s) {
      ...
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Pc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = jc(h), h.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Lc : Oo : Bc;
...
const od = re({ name: "@lexical/react/ReactProvider" });
function nd() {
  ...
  return function(r, o) {
    ...
    return wo(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (g) => r._onError(g), children: a(Ys, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
...
function wd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    wo(() => Ne(Hc(n), si(n)), [n]);
  }(o), u(ct, { children: [t, a(ud, { content: e }), a(dd, { editor: o, ErrorBoundary: r })] });
}
...
const hd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
...
function bd(t, e) {
  ...
  return u(ct, { children: [a(md, { editor: n, ...o, ref: e }), r != null && a(xd, { editor: n, content: r })] });
}
...
const Dd = "verseText", Ju = Object.freeze([
...
function Zu({
  ...
  const [i, s] = _(Od), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), g = F(null);
  H(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
...
), jd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => jd(Za(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function qd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Kd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(qd, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(bi, { ...W })
          },
          $.id
        );
      })
...
const nw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ct, { children: [
...
function iw({
  ...
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: nw(t, n, r) }) }) }),
...
const sw = (t, e) => t === "f" ? /* @__PURE__ */ u(ct, { children: [
  /* @__PURE__ */ a(yn, {}),
  " ",
...
function lw({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: sw(t, r) }) }) }),
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: cw(t, r) }) })
    ] }) }),
...
function uw({ state: t }) {
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        t === "all" && /* @__PURE__ */ a(Oe, { size: 16 }),
        t === "partial" && /* @__PURE__ */ a(Es, { size: 16 }),
        t === "none" && /* @__PURE__ */ a("span", { className: "tw:size-3 tw:rounded-[3px] tw:border tw:border-input" })
      ]
    }
  );
}
...
function mp({
  ...
  const Jt = () => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      z !== "x" && P === "x" ? pt == null || pt.forEach((gt) => gw(gt)) : z === "x" && P !== "x" && (pt == null || pt.forEach((gt) => fw(gt))), (ht = w.current) == null || ht.applyUpdate([Q, { delete: 1 }]);
    }
  }, Ct = (P) => {
  ...
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: vw(t.marker, c, o, d) })
      }
    )
  ] });
}
...
const _w = (t) => {
  ...
  return e ? e[1] : "";
}, Cw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ep = Object.freeze([
...
function Tp({
  ...
  }, [A, Y]), $ = D(() => T.length === 0 ? [] : Ew(T, C, K), [T, C, K]), W = D(() => {
    var wt, at;
    if (!A) return l;
...
const zw = "16rem", Sw = "3rem", ki = Wt.createContext(void 0);
function ia() {
    ...
    Dw,
    {
      ...
      children: /* @__PURE__ */ u(Mw, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a($w, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Aw, { children: /* @__PURE__ */ a(
            Vw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const ze = "scrBook", jw = "scrRef", qe = "source", Lw = "details", Bw = "Scripture Reference", Fw = "Scripture Book", _i = "Type", Uw = "Details";
function Kw(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: O.map((C) => /* @__PURE__ */ a(ne, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function Kp({
  ...
  const O = St(
    ...
    [r, n, f, i]
  ), ot = tt.find((M) => M.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Ks(at, mt, {
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [jt, ce] = _(null), Ue = 200, [Mi, $i] = _(!1);
  H(() => {
...
function Ba({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(As, {}) }) }),
...
const Jw = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Trigger,
  {
    ref: r,
    ...e,
...
function Jp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Si, { children: [
      /* @__PURE__ */ a(Ri, { children: t.map((c) => /* @__PURE__ */ a(Jw, { value: c.value, children: c.value }, c.key)) }),
...
const vr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(ou, {}, `separator-${i}`)), l;
  });
};
function cu({
  menuData: t,
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Zw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Qw, { children: [
      /* @__PURE__ */ a(eu, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        ru,
        {
          style: { zIndex: Xe },
...
function oh({
  ...
  const c = t ? To(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = pu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
