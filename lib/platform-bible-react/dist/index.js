...
import p, { useState as A, useRef as K, useMemo as H, useCallback as $, useLayoutEffect as mn, createContext as Tr, useContext as Rr, useEffect as Dt, forwardRef as _n, Fragment as Sn } from "react";
import { formatScrRef as Wt, getChaptersForBook as Er, NumberFormat as Vr, formatBytes as Dr, deepEqual as Ye, isString as Ee, compareScrRefs as Pe, scrRefToBBBCCCVVV as Ve, getLocalizeKeyForScrollGroupId as B } from "platform-bible-utils";
import { X as Ue, Search as Tn, ChevronLeft as Ie, ChevronRight as te, ChevronsLeft as hn, ChevronsRight as fn, ArrowLeft as Mr, Circle as qe, ChevronsUpDown as Je, Check as Bt, FilterIcon as zr, ChevronDown as ge, ChevronUp as Or, ArrowLeftIcon as Br, ChevronLeftIcon as Ar, ChevronRightIcon as Pr, ArrowRightIcon as Ir, Copy as jr, Filter as $r, User as Xr, Link as Fr, CircleHelp as Gr, Star as Lr, CircleCheckIcon as Hr, CircleXIcon as Yr, CircleHelpIcon as Ur, ArrowUpIcon as qr, ArrowDownIcon as Jr, ArrowUpDownIcon as Kr, PanelLeft as Wr, PanelRight as Zr, ScrollText as Qr, MenuIcon as ta, Menu as ea, EllipsisVertical as na, LoaderCircle as ra } from "lucide-react";
...
import * as Rn from "@radix-ui/react-label";
import * as ne from "@radix-ui/react-radio-group";
import { useReactTable as En, getFilteredRowModel as sa, getSortedRowModel as Vn, getPaginationRowModel as ia, getCoreRowModel as Dn, flexRender as Zt, getGroupedRowModel as wa, getExpandedRowModel as la } from "@tanstack/react-table";
import * as X from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as da } from "@radix-ui/react-dropdown-menu";
import * as L from "@radix-ui/react-select";
import ca from "markdown-to-jsx";
...
import { useHotkeys as pa } from "react-hotkeys-hook";
...
function Ht(t, e = !0) {
  return e && (t = t.toUpperCase()), t in gn ? gn[t] : 0;
}
function We(t) {
  return Ht(t) > 0;
}
...
function Pn(t) {
  return t <= 0 || t > An ? "******" : On[t - 1];
}
function Na(t) {
  return Pn(Ht(t));
}
function In(t) {
  const e = typeof t == "number" ? Ze(t) : t;
  return We(e) && !Ke.includes(e);
}
function ka(t) {
  const e = typeof t == "number" ? Ze(t) : t;
  return We(e) && Ke.includes(e);
...
function Ca(t) {
  return On[t - 1].includes("*obsolete*");
}
function _a() {
  const t = {};
...
E(at, "Original", new at(mt.Original)), E(at, "Septuagint", new at(mt.Septuagint)), E(at, "Vulgate", new at(mt.Vulgate)), E(at, "English", new at(mt.English)), E(at, "RussianProtestant", new at(mt.RussianProtestant)), E(at, "RussianOrthodox", new at(mt.RussianOrthodox));
let Rt = at;
function bn(t, e) {
  const n = e[0];
...
const et = class D {
  constructor(e, n, a, o) {
    if (E(this, "firstChapter"), E(this, "lastChapter"), E(this, "lastVerse"), E(this, "hasSegmentsDefined"), E(this, "text"), E(this, "BBBCCCVVVS"), E(this, "longHashCode"), E(this, "versification"), E(this, "rtlMark", "‏"), E(this, "_bookNum", 0), E(this, "_chapterNum", 0), E(this, "_verseNum", 0), E(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, i = n != null && n instanceof Rt ? n : void 0;
        this.setEmpty(i), this.parse(s);
      } else if (e != null && typeof e == "number") {
        const s = n != null && n instanceof Rt ? n : void 0;
        ...
        if (e != null && e instanceof D) {
          ...
          if (e == null) return;
          const s = e instanceof Rt ? e : D.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Rt(i)), n ? new D(n, a.toString(), w, u) : new D();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Rt(mt[i]);
        } catch {
  ...
  allVerses(e = !1, n = D.verseRangeSeparators, a = D.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], s = bn(this._verse, a);
    for (const i of s.map((w) => bn(w, n))) {
      const w = this.clone();
      w.verse = i[0];
      const u = w.verseNum;
...
*/
E(et, "ValidStatusType", jn);
class qt extends Error {
}
const Sa = oa({ prefix: "tw-" });
function d(...t) {
  return Sa(aa(t));
}
const Ta = _t(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Gt : "button", { className: d(Ta({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
const Ea = ht.Portal, $n = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ht.Overlay,
  {
    ref: n,
    className: d(
...
const Va = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = J();
  return /* @__PURE__ */ l(Ea, { children: [
    /* @__PURE__ */ r($n, {}),
    /* @__PURE__ */ l(
      ht.Content,
      {
...
Va.displayName = ht.Content.displayName;
...
Da.displayName = ht.Title.displayName;
...
Ma.displayName = ht.Description.displayName;
...
const ie = p.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(Tn, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      nt.Input,
      {
        ref: n,
...
ie.displayName = nt.Input.displayName;
...
we.displayName = nt.List.displayName;
const ve = p.forwardRef((t, e) => /* @__PURE__ */ r(nt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
Vt.displayName = nt.Group.displayName;
...
Xn.displayName = nt.Separator.displayName;
...
Nt.displayName = nt.Item.displayName;
const le = ee.Root, de = ee.Trigger, Yt = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = J();
...
function Us({
  ...
  const o = J(), [s, i] = A(!1), [w, u] = A(""), [c, m] = A(""), [g, h] = A("books"), [f, x] = A(void 0), C = K(void 0), N = K(void 0), S = K(void 0), k = K({}), V = H(() => a ? a() : Fn, [a]), O = H(() => ({
    OT: V.filter((_) => M.isBookOT(_)),
    NT: V.filter((_) => M.isBookNT(_)),
    DC: V.filter((_) => M.isBookDC(_)),
    Extra: V.filter((_) => M.extraBooks().includes(_))
  }), [V]), P = H(() => Object.values(O).flat(), [O]), ft = H(() => {
    if (!c.trim()) return O;
    const b = c.toLowerCase(), _ = { OT: [], NT: [], DC: [], Extra: [] };
    return ["OT", "NT", "DC", "Extra"].forEach((Z) => {
      _[Z] = O[Z].filter((U) => wt[U].toLowerCase().includes(b) || U.toLowerCase().includes(b));
    }), _;
  }, [O, c]), xt = $(
    (b) => {
      if (!b.trim()) return;
      const _ = Oa.reduce(
        (I, Z) => {
          if (I) return I;
          const U = Z.exec(b.trim());
          if (U) {
            const [ct, st = void 0, Ut = void 0] = U.slice(1);
            let Q;
            const Re = ((it) => Object.keys(wt).find(
              (It) => wt[It].toLowerCase() === it.toLowerCase()
            ))(ct);
            if (Re && P.includes(Re) && (Q = Re), !Q && M.isBookIdValid(ct)) {
              const it = ct.toUpperCase();
              P.includes(it) && (Q = it);
            }
            if (!Q) {
              const it = ct.toLowerCase(), It = P.filter((un) => wt[un].toLowerCase().includes(it) || un.toLowerCase().includes(it));
              It.length === 1 && ([Q] = It);
            }
            if (Q) {
              let it = st ? parseInt(st, 10) : void 0;
              it && it > gt(Q) && (it = Math.max(gt(Q), 1));
              const It = Ut ? parseInt(Ut, 10) : void 0;
              return {
                book: Q,
                chapterNum: it,
                verseNum: It
    ...
    (b) => {
      const _ = g === "chapters" ? f : v == null ? void 0 : v.book;
      _ && (e({
        book: _,
        chapterNum: b,
        verseNum: 1
    ...
    if (t.chapterNum > 1)
      ...
      const b = P.indexOf(t.book);
      if (b > 0) {
        const _ = P[b - 1], I = Math.max(gt(_), 1);
        e({
          book: _,
          chapterNum: I,
          verseNum: 1
    ...
    {
      onClick: At,
      disabled: t.chapterNum === 1 && P.indexOf(t.book) === 0,
    ...
    {
      onClick: Pt,
      disabled: (t.chapterNum === gt(t.book) || gt(t.book) === -1) && P.indexOf(t.book) === P.length - 1,
      title: "Next chapter",
      icon: o === "ltr" ? te : Ie
    }
  ], [
    ...
    (b) => {
      ...
      i(b), b && (h("books"), x(void 0), m(""));
    },
    [g, Y]
  ), W = $(
    (b) => v ? !!v.chapterNum && !b.toString().includes(v.chapterNum.toString()) : !1,
    [v]
  ), dt = H(() => Wt(t, "English"), [t]), j = H(() => {
    const b = f ?? (v == null ? void 0 : v.book);
    if (!b) return;
    const _ = gt(b), I = wt[b];
    return {
      endChapter: _,
      bookName: I,
      selectedChapter: t.book === b ? t.chapterNum : 0
    };
  }, [f, v == null ? void 0 : v.book, t.book, t.chapterNum]), ot = $((b, _) => `${b} ${wt[b]}${_ ? ` ${_}` : ""}`, []), pn = $((b) => (_) => {
    k.current[b] = _;
  }, []), _r = $((b) => {
    (b.key === "Home" || b.key === "End") && b.stopPropagation();
  }, []), Sr = $(
    (b) => {
      if (b.ctrlKey) return;
      const _ = /^[a-zA-Z]$/.test(b.key), I = /^[0-9]$/.test(b.key);
      if (g === "chapters") {
        if (b.key === "Backspace") {
        ...
        if (_ || I) {
          if (b.preventDefault(), b.stopPropagation(), h("books"), x(void 0), I && f) {
            const Z = wt[f];
            m(`${Z} ${b.key}`);
          } else
            m(b.key);
      ...
      if (g === "books" && (_ || I)) {
        b.preventDefault(), b.stopPropagation(), m((Z) => Z + b.key), setTimeout(() => {
          C.current && C.current.focus();
        }, 0);
        return;
      }
      if ((g === "chapters" || g === "books" && v) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(b.key)) {
        const Z = g === "chapters" ? f : v == null ? void 0 : v.book;
        if (!Z) return;
        const U = (() => {
          if (!w) return 1;
          const Q = w.match(/(\d+)$/);
          return Q ? parseInt(Q[1], 10) : 0;
        })(), ct = j == null ? void 0 : j.endChapter;
        if (!ct) return;
        let st = U;
        const Ut = 6;
        switch (b.key) {
          case "ArrowLeft":
            U !== 0 && (st = Math.max(1, U - 1));
            break;
          case "ArrowRight":
            U !== 0 && (st = Math.min(ct, U + 1));
            break;
          case "ArrowUp":
            st = U === 0 ? gt(Z) : Math.max(1, U - Ut);
            break;
          case "ArrowDown":
            st = U === 0 ? 1 : Math.min(ct, U + Ut);
            break;
          default:
            return;
        }
        st !== U && (b.preventDefault(), b.stopPropagation(), u(ot(Z, st)), setTimeout(() => {
          const Q = k.current[st];
  ...
  return mn(() => {
    const b = setTimeout(() => {
      if (s && g === "books" && N.current && S.current) {
        const _ = N.current, I = S.current, Z = I.offsetTop, U = _.clientHeight, ct = I.clientHeight, st = Z - U / 2 + ct / 2;
        _.scrollTo({
          top: Math.max(0, st),
          behavior: "smooth"
        }), u(ot(t.book));
  ...
  }, [s, g, c, v, t.book, ot]), mn(() => {
    if (g === "chapters" && f) {
      const b = f === t.book;
      setTimeout(() => {
        if (N.current)
          if (b) {
            const _ = k.current[t.chapterNum];
    ...
    t.book,
    t.chapterNum
  ]), /* @__PURE__ */ l(le, { open: s, onOpenChange: R, children: [
      ...
      se,
      {
        ...
        children: [
          g === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: pe.map(({ onClick: b, disabled: _, title: I, icon: Z }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r("span", { className: "tw-text-sm tw-font-medium", children: j == null ? void 0 : j.bookName })
          ] }),
          /* @__PURE__ */ l(we, { ref: N, children: [
            g === "books" && /* @__PURE__ */ l(Qt, { children: [
              !v && Object.entries(ft).map(([b, _]) => {
                if (_.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses BookType as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Vt, { heading: za[b], children: _.map((I) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: d(
                          "tw-mx-1 tw-my-1 tw-border-b-0 tw-border-e-0 tw-border-s-2 tw-border-t-0 tw-border-solid",
                          {
                            "tw-border-s-red-200": b.toLowerCase() === "ot",
                            "tw-border-s-purple-200": b.toLowerCase() === "nt",
                            "tw-border-s-indigo-200": b.toLowerCase() === "dc",
                            "tw-border-s-amber-200": b.toLowerCase() === "extra"
                          }
                        ),
                        children: /* @__PURE__ */ r(
                          Nt,
              ...
              v && /* @__PURE__ */ r(Vt, { children: /* @__PURE__ */ r(
                Nt,
                {
                  value: `${v.book} ${wt[v.book]} ${v.chapterNum || ""}:${v.verseNum || ""})}`,
                  onSelect: y,
              ...
              v && j && j.endChapter > 1 && /* @__PURE__ */ l(Qt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: j.bookName }),
                /* @__PURE__ */ r(Vt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-px-4 tw-pb-4", children: Array.from({ length: j.endChapter }, (b, _) => _ + 1).map(
                  (b) => /* @__PURE__ */ r(
                    Nt,
                    {
                      value: `${v.book} ${wt[v.book]} ${b}`,
                      onSelect: () => T(b),
                      ref: pn(b),
                      className: d(
                        "tw-h-8 tw-w-8 tw-cursor-pointer tw-justify-center tw-rounded-md tw-text-center tw-text-sm",
                        {
                          "tw-bg-primary tw-text-primary-foreground": b === j.selectedChapter
                        },
                        {
                          "tw-bg-muted/50 tw-text-muted-foreground/50": W(b)
                        }
                      ),
                      children: b
                    },
            ...
            g === "chapters" && /* @__PURE__ */ r(Vt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-p-4", children: j && Array.from({ length: j.endChapter }, (b, _) => _ + 1).map(
              (b) => /* @__PURE__ */ r(
                Nt,
                {
                  value: `${f || ""} ${wt[f || ""] || ""} ${b}`,
...
), q = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Rn.Root, { ref: n, className: d("pr-twp", Ba(), t), ...e }));
q.displayName = Rn.Root.displayName;
const Qe = p.forwardRef(({ className: t, ...e }, n) => {
  const a = J();
  return /* @__PURE__ */ r(
    ne.Root,
    {
...
Qe.displayName = ne.Root.displayName;
const me = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ne.Item,
  {
    ref: n,
    className: d(
    ...
    ...e,
    children: /* @__PURE__ */ r(ne.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(qe, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
...
function Fe({
  ...
  const [N, S] = A(!1);
  return /* @__PURE__ */ l(le, { open: N, onOpenChange: S, ...C, children: [
...
function Js({
  ...
  const m = Me(c, "%webView_bookSelector_currentBook%"), g = Me(c, "%webView_bookSelector_choose%"), h = Me(c, "%webView_bookSelector_chooseBooks%"), [f, x] = A(
    "current book"
    /* CURRENT_BOOK */
  ), C = (N) => {
    x(N), t(N);
    ...
    Qe,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(q, { className: "tw-flex tw-items-center", children: a.map((N) => M.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
}), Gn = X.Trigger, Ln = X.Group, ja = X.Portal, $a = X.Sub, Xa = X.RadioGroup;
function en({ variant: t = "default", ...e }) {
  const n = p.useMemo(
    () => ({
      variant: t
    }),
...
const Hn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    X.SubTrigger,
    {
...
Hn.displayName = X.SubTrigger.displayName;
...
const xe = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = J();
...
const Un = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = J(), s = ut();
  return /* @__PURE__ */ r(
    X.Item,
    {
...
Un.displayName = X.Item.displayName;
const nn = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    X.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(Bt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const qn = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ l(
    X.RadioItem,
    {
...
const rn = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
...
function Ga({ table: t }) {
  return /* @__PURE__ */ l(en, { children: [
    /* @__PURE__ */ r(da, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const $t = L.Root, La = L.Group, Xt = L.Value, Ha = _t(
...
), zt = p.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = J();
  return /* @__PURE__ */ l(
    L.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(L.Icon, { asChild: !0, children: /* @__PURE__ */ r(ge, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
Kn.displayName = L.ScrollDownButton.displayName;
const Ot = p.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = J();
...
Ot.displayName = L.Content.displayName;
...
Ya.displayName = L.Label.displayName;
const lt = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  L.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(Bt, { className: "tw-h-4 tw-w-4" }) }) }),
      ...
      /* @__PURE__ */ l(
        $t,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Ot, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(lt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function re(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (a) => !a.hasAttribute("disabled") && !a.getAttribute("aria-hidden") && Ja(a)
  );
}
const Ne = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
...
const ke = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: d(
...
const Ce = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? re(t.current) : [], s = o.indexOf(document.activeElement), i = a.key === "ArrowRight" ? s + 1 : s - 1;
...
function eo({
  ...
  var N;
  const [w, u] = A([]), [c, m] = A([]), [g, h] = A({}), [f, x] = A({}), C = En({
    data: e,
    columns: t,
    getCoreRowModel: Dn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(Ga, { table: C }),
    /* @__PURE__ */ l(Ne, { stickyHeader: s, children: [
      /* @__PURE__ */ r(ke, { stickyHeader: s, children: C.getHeaderGroups().map((S) => /* @__PURE__ */ r(Ct, { children: S.headers.map((k) => /* @__PURE__ */ r(ae, { children: k.isPlaceholder ? void 0 : Zt(k.column.columnDef.header, k.getContext()) }, k.id)) }, S.id)) }),
      /* @__PURE__ */ r(Ce, { children: (N = C.getRowModel().rows) != null && N.length ? C.getRowModel().rows.map((S) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(S, C),
          "data-state": S.getIsSelected() && "selected",
          children: S.getVisibleCells().map((k) => /* @__PURE__ */ r(Ft, { children: Zt(k.column.columnDef.cell, k.getContext()) }, k.id))
        },
        S.id
...
function Ks({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(ca, { options: o, children: e }) });
}
const Ws = Object.freeze([
  "%webView_error_dump_header%",
  "%webView_error_dump_info_message%"
]), xn = (t, e) => t[e] ?? e;
function no({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const a = xn(n, "%webView_error_dump_header%"), o = xn(n, "%webView_error_dump_info_message%");
  function s() {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(jr, {}) })
    ] }),
...
var ro = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(ro || {});
function Qs({ id: t, label: e, groups: n }) {
  const [a, o] = A(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(en, { children: [
    /* @__PURE__ */ r(Gn, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "default", children: [
      /* @__PURE__ */ r($r, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ge, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(xe, { children: n.map((c, m) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(rn, { children: c.label }),
      /* @__PURE__ */ r(Ln, { children: c.itemType === 0 ? /* @__PURE__ */ r(Qt, { children: c.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        nn,
        {
          checked: a[m][h],
...
function ei({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    /* @__PURE__ */ r(ao, { versionHistory: o }),
...
const oo = _t(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", oo({ variant: e }), t), ...n })
);
...
function so({
  ...
  const [g, h] = A(!1), f = $(
    (N) => {
      var k;
      const S = (k = t.find((V) => V.label === N)) == null ? void 0 : k.value;
      S && a(
    ...
    if (!u) return t;
    const N = t.filter((k) => k.starred).sort((k, V) => k.label.localeCompare(V.label)), S = t.filter((k) => !k.starred).sort((k, V) => {
      const O = n.includes(k.value), P = n.includes(V.value);
      return O && !P ? -1 : !O && P ? 1 : k.label.localeCompare(V.label);
    });
    return [...N, ...S];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(le, { open: g, onOpenChange: h, children: [
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(se, { children: [
      /* @__PURE__ */ r(ie, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ l(we, { children: [
        /* @__PURE__ */ r(ve, { children: s }),
        /* @__PURE__ */ r(Vt, { children: C.map((N) => {
          ...
          return /* @__PURE__ */ l(
            Nt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: N.starred && /* @__PURE__ */ r(Lr, { className: "tw-h-4 tw-w-4" }) }),
...
an.displayName = je.Root.displayName;
...
), wo = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Mn.Root,
  {
    ref: o,
    className: d(Wn({ variant: e, size: n, className: t })),
    ...a
  }
));
wo.displayName = Mn.Root.displayName;
...
Qn.displayName = be.Root.displayName;
const ue = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const _e = (t) => t === "asc" ? /* @__PURE__ */ r(qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Kr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ri = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(Qn, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        ue,
        {
          onClick: (u) => {
  ...
  return e ? e[1] : "";
}, co = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", li = Object.freeze([
  ...
  return t.forEach((o) => {
    const s = a.find(
      (i) => Ye(
        i.items,
        Ee(o.inventoryText) ? [o.inventoryText] : o.inventoryText
      )
    );
    if (s)
      ...
      const i = {
        items: Ee(o.inventoryText) ? [o.inventoryText] : o.inventoryText,
        count: 1,
        status: co(
...
function di({
  ...
  const c = bt(n, "%webView_inventory_all%"), m = bt(n, "%webView_inventory_approved%"), g = bt(n, "%webView_inventory_unapproved%"), h = bt(n, "%webView_inventory_unknown%"), f = bt(n, "%webView_inventory_scope_currentBook%"), x = bt(n, "%webView_inventory_scope_chapter%"), C = bt(n, "%webView_inventory_scope_verse%"), N = bt(n, "%webView_inventory_filter_text%"), S = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [k, V] = A(!1), [O, P] = A("all"), [ft, xt] = A(""), [v, y] = A([]), G = H(() => t.length === 0 ? [] : uo(t, o, s), [t, o, s]), T = H(() => {
    if (k) return G;
    const R = [];
    return G.forEach((W) => {
      const dt = W.items[0], j = R.find(
        (ot) => ot.items[0] === dt
      );
      j ? (j.count += W.count, j.occurrences = j.occurrences.concat(W.occurrences)) : R.push({
        items: [dt],
        count: W.count,
  ...
  }, [k, G]), Y = H(() => po(T, O, ft), [T, O, ft]), At = H(() => {
    var dt, j;
    if (!k) return u;
    const R = (dt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : dt.length;
    if (!R) return u;
    const W = [];
    for (let ot = 0; ot < R; ot++)
      W.push(
        lo(
          ((j = a == null ? void 0 : a.tableHeaders) == null ? void 0 : j[ot]) || "Additional Item",
          ot + 1
        )
      );
    return [...W, ...u];
  ...
  Dt(() => {
    Y.length === 0 ? y([]) : Y.length === 1 && y(Y[0].items);
  }, [Y]);
  const Pt = (R, W) => {
    W.setRowSelection(() => {
      const dt = {};
    ...
    if (T.length === 0 || v.length === 0) return [];
    const R = T.filter((W) => Ye(
      k ? W.items : [W.items[0]],
      v
    ));
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        $t,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l(Ot, { children: [
              ...
              /* @__PURE__ */ r(lt, { value: "unapproved", children: g }),
              /* @__PURE__ */ r(lt, { value: "unknown", children: h })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ l($t, { onValueChange: (R) => St(R), defaultValue: i, children: [
        ...
        /* @__PURE__ */ l(Ot, { children: [
          ...
          /* @__PURE__ */ r(lt, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ r(
        ce,
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(q, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? S })
      ] })
    ] }),
    ...
    pe.length > 0 && /* @__PURE__ */ r("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ r(
      io,
      {
        occurrenceData: pe,
        setScriptureReference: e,
...
const on = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  zn.Root,
  {
    ref: o,
    decorative: n,
...
on.displayName = zn.Root.displayName;
...
const sn = oe.Provider, wn = oe.Root, ln = oe.Trigger, Se = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  oe.Content,
  {
    ref: a,
    sideOffset: e,
...
const mo = "16rem", ho = "3rem", tr = p.createContext(void 0);
function Te() {
...
const er = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), g = e ?? c, h = p.useCallback(
      (V) => {
        const O = typeof V == "function" ? V(g) : V;
        n ? n(O) : m(O);
      },
      [n, g]
    ), f = p.useCallback(() => h((V) => !V), [h]), x = g ? "expanded" : "collapsed", S = J() === "ltr" ? i : i === "primary" ? "secondary" : "primary", k = p.useMemo(
      () => ({
        state: x,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(tr.Provider, { value: k, children: /* @__PURE__ */ r(sn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
er.displayName = "SidebarProvider";
const nr = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Te();
...
const fo = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Te();
  return /* @__PURE__ */ l(
    z,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(Wr, {}) : /* @__PURE__ */ r(Zr, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
fo.displayName = "SidebarTrigger";
...
yo.displayName = "SidebarSeparator";
...
const Le = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Gt : "div",
  {
    ref: a,
...
const ko = _t(
  ...
  ({
    ...
    const u = t ? Gt : "button", { state: c } = Te(), m = /* @__PURE__ */ r(
      u,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(ko({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ l(wn, { children: [
      /* @__PURE__ */ r(ln, { asChild: !0, children: m }),
      /* @__PURE__ */ r(Se, { side: "right", align: "center", hidden: c !== "collapsed", ...o })
    ] })) : m;
  }
);
ir.displayName = "SidebarMenuButton";
const Co = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Gt : "button",
  {
    ref: o,
...
Co.displayName = "SidebarMenuAction";
...
_o.displayName = "SidebarMenuBadge";
...
const Eo = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Gt : "a",
  {
    ref: s,
...
function Vo({
  ...
  return /* @__PURE__ */ r(
    nr,
    {
      ...
      children: /* @__PURE__ */ l(ar, { children: [
        /* @__PURE__ */ l(Ge, { children: [
          /* @__PURE__ */ r(Le, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(He, { children: /* @__PURE__ */ r(or, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(sr, { children: /* @__PURE__ */ r(
            ir,
            {
              onClick: () => c(h),
              isActive: g(h),
...
const yt = "scrBook", Do = "scrRef", Et = "source", Mo = "details", zo = "Scripture Reference", Oo = "Scripture Book", wr = "Type", Bo = "Details";
function Ao(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? M.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === yt ? Wt(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Mo,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Bo,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
const Po = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Pe(t.start, t.end) === 0 ? `${Ve(t.start)}+${e}` : `${Ve(t.start)}+${e}-${Ve(t.end)}+${n}`;
}, Nn = (t) => `${Po({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function pi({
  sources: t,
  ...
  const [u, c] = A([]), [m, g] = A([{ id: yt, desc: !1 }]), [h, f] = A({}), x = H(
  ...
  const N = En({
    ...
    getExpandedRowModel: la(),
    getGroupedRowModel: wa(),
    getCoreRowModel: Dn(),
    getSortedRowModel: Vn(),
    getRowId: Nn,
    autoResetExpanded: !1,
  ...
  Dt(() => {
    if (w) {
      ...
      if (y.length === 1) {
        const G = x.find((T) => Nn(T) === y[0]) || void 0;
        G && w(G);
      }
    }
  }, [h, x, w, N]);
  const S = o ?? Oo, k = s ?? wr, V = [
  ...
  }, ft = (v, y) => v.getIsGrouped() ? "" : d("banded-row", y % 2 === 0 ? "even" : "odd"), xt = (v, y, G) => {
    if (!((v == null ? void 0 : v.length) === 0 || y.depth < G.column.getGroupedIndex())) {
      if (y.getIsGrouped())
        switch (y.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ l(
      $t,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ot, { position: "item-aligned", children: /* @__PURE__ */ r(La, { children: V.map((v) => /* @__PURE__ */ r(lt, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Ne, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(ke, { children: N.getHeaderGroups().map((v) => /* @__PURE__ */ r(Ct, { children: v.headers.filter((y) => y.column.columnDef.header).map((y) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(ae, { colSpan: y.colSpan, className: "top-0 tw-sticky", children: y.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          ...
          " ",
          Zt(y.column.columnDef.header, y.getContext())
        ] }) }, y.id)
      )) }, v.id)) }),
      /* @__PURE__ */ r(Ce, { children: N.getRowModel().rows.map((v, y) => {
        const G = J();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            className: d(ft(v, y)),
            onClick: (T) => P(v, T),
            children: v.getVisibleCells().map((T) => {
              if (!(T.getIsPlaceholder() || T.column.columnDef.enableGrouping && !T.getIsGrouped() && (T.column.columnDef.id !== Et || !n)))
                return /* @__PURE__ */ r(
                  Ft,
                  {
                    className: d(
                    ...
                    children: T.getIsGrouped() ? /* @__PURE__ */ l(
                      z,
                      {
                        ...
                        type: "button",
                        children: [
                          v.getIsExpanded() && /* @__PURE__ */ r(ge, {}),
                          !v.getIsExpanded() && (G === "ltr" ? /* @__PURE__ */ r(te, {}) : /* @__PURE__ */ r(Ie, {})),
                          " ",
                          Zt(T.column.columnDef.cell, T.getContext()),
                          " (",
                          v.subRows.length,
                          ")"
                        ]
...
}), lr = (t, e, n) => cn(t, e).every((a) => n.includes(a));
function $o({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
...
function Xo({
  ...
  const s = cn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function Fo({
  ...
  const s = a["%webView_book_selector_books_selected%"], i = a["%webView_book_selector_select_books%"], w = a["%webView_book_selector_search_books%"], u = a["%webView_book_selector_select_all%"], c = a["%webView_book_selector_clear_all%"], m = a["%webView_book_selector_no_book_found%"], g = a["%webView_book_selector_more%"], h = a["%scripture_section_ot_long%"], f = a["%scripture_section_nt_long%"], x = a["%scripture_section_dc_long%"], C = a["%scripture_section_extra_long%"], [N, S] = A(!1), k = K(void 0), V = K(!1);
  if (t.length !== M.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const O = H(() => M.allBookIds.filter(
    (y, G) => t[G] === "1" && !M.isObsolete(M.bookIdToNumber(y))
  ), [t]), P = $(
    (y, G = !1) => {
      if (!G || !k.current) {
        n(
          e.includes(y) ? e.filter((tt) => tt !== y) : [...e, y]
        ), k.current = y;
        return;
      }
      const T = O.findIndex((tt) => tt === k.current), Y = O.findIndex((tt) => tt === y);
      if (T === -1 || Y === -1) return;
      const [At, Pt] = [
        Math.min(T, Y),
        Math.max(T, Y)
      ], St = O.slice(At, Pt + 1).map((tt) => tt);
      n(
        e.includes(y) ? e.filter((tt) => !St.includes(tt)) : [.../* @__PURE__ */ new Set([...e, ...St])]
      );
    },
    [e, n, O]
  ), ft = $(
    (y) => {
      const G = cn(O, y).map((T) => T);
      n(
        lr(O, y, e) ? e.filter((T) => !G.includes(T)) : [.../* @__PURE__ */ new Set([...e, ...G])]
      );
    },
    [e, n, O]
  ), xt = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(kt).map((y) => /* @__PURE__ */ r(
      Xo,
      {
        section: y,
        availableBookIds: O,
    ...
    /* @__PURE__ */ l(le, { open: N, onOpenChange: S, children: [
      /* @__PURE__ */ r(de, { asChild: !0, children: /* @__PURE__ */ l(
        z,
        {
          variant: "outline",
              ...
              Object.values(kt).map((y, G) => {
                ...
                if (T.length !== 0)
                  return /* @__PURE__ */ l(Sn, { children: [
                    ...
                    G < Object.values(kt).length - 1 && /* @__PURE__ */ r(Xn, {})
                  ] }, y);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var G;
        return /* @__PURE__ */ r(he, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((G = o.get(y)) == null ? void 0 : G.localizedName) || M.bookIdToEnglishName(y) || y }, y);
      }),
...
function mi({
  ...
  const u = Tt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), g = Tt(i, "%webView_scope_selector_current_book%"), h = Tt(i, "%webView_scope_selector_choose_books%"), f = Tt(i, "%webView_scope_selector_scope%"), x = Tt(i, "%webView_scope_selector_select_books%"), C = [
  ...
  ], N = e ? C.filter((S) => e.includes(S.value)) : C;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Qe,
        {
          ...
          children: N.map(({ value: S, label: k, id: V }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(me, { className: "tw-me-2", value: S, id: V }),
            /* @__PURE__ */ r(q, { htmlFor: V, children: k })
          ] }, V))
        }
      )
    ] }),
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ l(wn, { children: [
  /* @__PURE__ */ r(ln, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    Un,
    {
      onClick: () => {
        a(w);
    ...
    /* @__PURE__ */ r(Hn, { children: w.label }),
    /* @__PURE__ */ r(ja, { children: /* @__PURE__ */ r(Yn, { children: cr(
      t,
      e,
      dr(t, w.id),
      a
...
function Cn({
  ...
  return /* @__PURE__ */ l(en, { variant: s, children: [
    /* @__PURE__ */ r(Gn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(ta, {}) }) }),
    /* @__PURE__ */ r(xe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w], u, c) => /* @__PURE__ */ l(Sn, { children: [
      /* @__PURE__ */ r(Ln, { children: /* @__PURE__ */ r(sn, { children: cr(e.groups, e.items, w, t) }) }),
      u < c.length - 1 && /* @__PURE__ */ r(ye, {})
    ] }, w)) })
  ] });
}
function vi({
...
const pr = p.forwardRef(({ className: t, ...e }, n) => {
  const a = J();
  return /* @__PURE__ */ r(
    rt.Root,
    {
...
const ur = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.List,
  {
    ref: n,
    className: d(
...
function xi({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(pr, { children: [
      /* @__PURE__ */ r(ur, { children: t.map((i) => /* @__PURE__ */ r(Go, { value: i.value, children: i.value }, i.key)) }),
...
const hr = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
...
hr.displayName = F.Root.displayName;
const fr = p.forwardRef(({ className: t, ...e }, n) => {
  const a = ut();
  return /* @__PURE__ */ r(
    F.Trigger,
    {
...
fr.displayName = F.Trigger.displayName;
const gr = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
gr.displayName = F.SubTrigger.displayName;
...
br.displayName = F.SubContent.displayName;
const vr = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ut();
...
vr.displayName = F.Content.displayName;
const xr = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
xr.displayName = F.Item.displayName;
const Yo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(Bt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Yo.displayName = F.CheckboxItem.displayName;
const Uo = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(qe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Uo.displayName = F.RadioItem.displayName;
const qo = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
qo.displayName = F.Label.displayName;
const yr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  F.Separator,
  {
    ref: n,
    className: d("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
yr.displayName = F.Separator.displayName;
const Jt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, m) => c.order - m.order).map((c) => /* @__PURE__ */ l(wn, { children: [
      /* @__PURE__ */ r(ln, { asChild: !0, children: "command" in c ? /* @__PURE__ */ l(
        xr,
        {
          onClick: () => {
            a(c);
      ...
      ) : /* @__PURE__ */ l(Ho, { children: [
        /* @__PURE__ */ r(gr, { children: c.label }),
    ...
    return w.length > 0 && i < o.length - 1 && u.push(/* @__PURE__ */ r(yr, {}, `separator-${s}`)), u;
  });
};
function Jo({
  menuData: t,
  ...
  if (pa(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    var x, C, N, S;
    m.preventDefault();
    ...
    switch (g.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (x = s.current) == null || x.focus(), Jt(s, [h, f]);
        break;
      case "alt+l":
        (C = i.current) == null || C.focus(), Jt(i, [h, f]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), Jt(w, [h, f]);
        break;
      case "alt+h":
        (S = u.current) == null || S.focus(), Jt(u, [h, f]);
        break;
    }
  }), Dt(() => {
    ...
    return /* @__PURE__ */ r(hr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ l(Lo, { children: [
      /* @__PURE__ */ r(fr, { ref: c(m), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        vr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(sn, { children: Nr(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function ki({
  ...
  const u = Ko(
    ...
    var N, S, k, V, O, P;
    const C = x !== f ? ((S = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : S[x]) ?? ((V = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : V.en) : void 0;
    return C ? `${(O = t[f]) == null ? void 0 : O.autonym} (${C})` : (P = t[f]) == null ? void 0 : P.autonym;
  };
...
function Wo({ item: t, createLabel: e, createComplexLabel: n }) {
...
const Zo = _n(({ className: t, ...e }, n) => /* @__PURE__ */ r(ra, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), ts = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(Qo({ variant: e }), t), ...n }));
...
es.displayName = "AlertTitle";
const ns = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
rs.displayName = Lt.Root.displayName;
...
as.displayName = Lt.Image.displayName;
...
os.displayName = Lt.Fallback.displayName;
...
const ls = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Si = pt.Trigger, us = pt.Portal, Ti = pt.Close, Cr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
Cr.displayName = pt.Overlay.displayName;
const ms = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = p.useContext(kr), i = {
...
fs.displayName = "DrawerFooter";
const gs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Title,
  {
    ref: n,
    className: d("tw-text-lg tw-font-semibold tw-leading-none tw-tracking-tight", t),
...
gs.displayName = pt.Title.displayName;
...
const vs = p.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  $e.Root,
  {
    ref: a,
    className: d(
...
vs.displayName = $e.Root.displayName;
function Ri({ ...t }) {
  return /* @__PURE__ */ r(
    ua,
    {
...
const xs = p.forwardRef(({ className: t, ...e }, n) => {
  const a = J();
  return /* @__PURE__ */ l(
    Kt.Root,
    {
...
xs.displayName = Kt.Root.displayName;
...
ys.displayName = Xe.Root.displayName;
const Ei = rt.Root, Ns = p.forwardRef(({ className: t, ...e }, n) => {
  const a = J();
  return /* @__PURE__ */ r(
    rt.List,
    {
...
const ks = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Trigger,
  {
    ref: n,
    className: d(
...
ks.displayName = rt.Trigger.displayName;
...
const Ts = (t, e, n = {}) => {
  ...
  const o = K(null), [s, i] = A(void 0), [w, u] = A(void 0), c = $(
    (h) => {
      i(h);
...
export {
  ...
  as as AvatarImage,
  qs as BOOK_SELECTOR_STRING_KEYS,
  he as Badge,
  ...
  Ws as ERROR_DUMP_STRING_KEYS,
  no as ErrorDump,
  Zs as ErrorPopover,
  ni as Filter,
  Qs as FilterDropdown,
  ei as Footer,
  li as INVENTORY_STRING_KEYS,
  ce as Input,
  di as Inventory,
  q as Label,
  Ks as MarkdownRenderer,
  ti as MoreInfo,
  so as MultiSelectComboBox,
  xi as NavigationContentSearch,
  le as Popover,
  ...
  ui as SCOPE_SELECTOR_STRING_KEYS,
  mi as ScopeSelector,
  pi as ScriptureResultsViewer,
  hi as ScrollGroupSelector,
  dn as SearchBar,
  $t as Select,
  Ot as SelectContent,
  La as SelectGroup,
  ...
  gi as SettingsListItem,
  Vo as SettingsSidebar,
  ci as SettingsSidebarContentSearch,
  nr as Sidebar,
  ar as SidebarContent,
  xo as SidebarFooter,
  Ge as SidebarGroup,
  No as SidebarGroupAction,
  ...
  rr as SidebarInset,
  or as SidebarMenu,
  Co as SidebarMenuAction,
  _o as SidebarMenuBadge,
  ir as SidebarMenuButton,
  sr as SidebarMenuItem,
  So as SidebarMenuSkeleton,
  To as SidebarMenuSub,
  Eo as SidebarMenuSubButton,
  Ro as SidebarMenuSubItem,
  er as SidebarProvider,
  go as SidebarRail,
  ...
  ki as UiLanguageSelector,
  pr as VerticalTabs,
  mr as VerticalTabsContent,
  ur as VerticalTabsList,
  Go as VerticalTabsTrigger,
  oo as badgeVariants,
  Ta as buttonVariants,
  d as cn,
  wi as getBookIdFromUSFM,
  si as getLinesFromUSFM,
  ii as getNumberFromUSFM,
  co as getStatusForItem,
  yi as getToolbarOSReservedSpaceClassName,
  ai as inventoryCountColumn,
  ri as inventoryItemColumn,
