...
import p, { forwardRef as qt, createContext as tr, useContext as er, useCallback as Q, useState as P, useRef as q, useEffect as ct, useLayoutEffect as Ke, useMemo as tt, Fragment as an } from "react";
...
import { DropdownMenuTrigger as ar } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as Re, Check as xt, Circle as Te, X as Ee, Search as on, ChevronsUpDown as Ve, FilterIcon as or, ChevronDown as Jt, ChevronUp as sr, ArrowLeftIcon as ir, ChevronLeftIcon as wr, ChevronRightIcon as lr, ArrowRightIcon as dr, LoaderCircle as cr, Download as pr, Filter as ur, User as mr, Link as hr, CircleHelp as gr, Star as fr, CircleCheckIcon as br, CircleXIcon as vr, CircleHelpIcon as xr, ArrowUpIcon as yr, ArrowDownIcon as Nr, ArrowUpDownIcon as kr, PanelLeft as Cr, PanelRight as Sr, ScrollText as _r, ChevronLeft as Rr, MenuIcon as Tr, Menu as Er, EllipsisVertical as Vr } from "lucide-react";
import { formatScrRef as Ot, getChaptersForBook as zr, NumberFormat as Mr, formatBytes as Dr, deepEqual as ze, isString as ue, compareScrRefs as xe, scrRefToBBBCCCVVV as me, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
import { Slot as Rt } from "@radix-ui/react-slot";
import * as sn from "@radix-ui/react-label";
...
import { useReactTable as wn, getFilteredRowModel as Br, getSortedRowModel as ln, getPaginationRowModel as Or, getCoreRowModel as dn, flexRender as It, getGroupedRowModel as Ir, getExpandedRowModel as Pr } from "@tanstack/react-table";
import * as G from "@radix-ui/react-select";
import Ar from "markdown-to-jsx";
import * as ye from "@radix-ui/react-checkbox";
import * as Kt from "@radix-ui/react-toggle-group";
import * as cn from "@radix-ui/react-toggle";
...
const De = A.Trigger, un = A.Group, Lr = A.Portal, Yr = A.Sub, is = A.RadioGroup;
function Wt({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Me.Provider, { value: n, children: /* @__PURE__ */ r(A.Root, { ...e }) });
}
const mn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = rt();
  return /* @__PURE__ */ l(
    A.SubTrigger,
    {
...
mn.displayName = A.SubTrigger.displayName;
...
hn.displayName = A.SubContent.displayName;
const Ft = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = Y();
...
Ft.displayName = A.Content.displayName;
...
Be.displayName = A.Item.displayName;
const Oe = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = rt();
  return /* @__PURE__ */ l(
    A.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(A.ItemIndicator, { children: /* @__PURE__ */ r(xt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Oe.displayName = A.CheckboxItem.displayName;
const gn = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    A.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(A.ItemIndicator, { children: /* @__PURE__ */ r(Te, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
gn.displayName = A.RadioItem.displayName;
...
Zt.displayName = A.Label.displayName;
const Gt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  A.Separator,
  {
    ref: n,
...
Gt.displayName = A.Separator.displayName;
...
var Ur = Object.defineProperty, qr = (t, e, n) => e in t ? Ur(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => qr(t, typeof e != "symbol" ? e + "" : e, n);
const ft = [
  "GEN",
  "EXO",
  "LEV",
...
function Kr(t) {
  return (typeof t == "string" ? Vt(t) : t) <= 39;
}
function bn(t) {
  return t <= 66;
}
...
R(Z, "Original", new Z(at.Original)), R(Z, "Septuagint", new Z(at.Septuagint)), R(Z, "Vulgate", new Z(at.Vulgate)), R(Z, "English", new Z(at.English)), R(Z, "RussianProtestant", new Z(at.RussianProtestant)), R(Z, "RussianOrthodox", new Z(at.RussianOrthodox));
let ht = Z;
function Ze(t, e) {
  const n = e[0];
...
var Nn = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(Nn || {});
const J = class D {
  constructor(e, n, a, o) {
    if (R(this, "firstChapter"), R(this, "lastChapter"), R(this, "lastVerse"), R(this, "hasSegmentsDefined"), R(this, "text"), R(this, "BBBCCCVVVS"), R(this, "longHashCode"), R(this, "versification"), R(this, "rtlMark", "‏"), R(this, "_bookNum", 0), R(this, "_chapterNum", 0), R(this, "_verseNum", 0), R(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, i = n != null && n instanceof ht ? n : void 0;
        this.setEmpty(i), this.parse(s);
      } else if (e != null && typeof e == "number") {
        const s = n != null && n instanceof ht ? n : void 0;
        ...
        if (e != null && e instanceof D) {
          ...
          if (e == null) return;
          const s = e instanceof ht ? e : D.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new ht(i)), n ? new D(n, a.toString(), w, c) : new D();
  }
  /**
   ...
   */
  get book() {
    return V.bookNumberToId(this.bookNum, "");
  }
  set book(e) {
    this.bookNum = V.bookIdToNumber(e);
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new ht(at[i]);
        } catch {
    ...
    if (a.length !== 2 || V.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !D.isVerseParseable(a[1]))
      throw new zt("Invalid reference : " + e);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > V.lastBook ? 2 : (V.isCanonical(this._bookNum), 0);
  }
  setEmpty(e = D.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = e;
  }
  updateInternal(e, n, a) {
    this.bookNum = V.bookIdToNumber(e), this.chapter = n, this.verse = a;
  }
};
R(J, "defaultVersification", ht.English), R(J, "verseRangeSeparator", "-"), R(J, "verseSequenceIndicator", ","), R(J, "verseRangeSeparators", [J.verseRangeSeparator]), R(J, "verseSequenceIndicators", [J.verseSequenceIndicator]), R(J, "chapterDigitShifter", 1e3), R(J, "bookDigitShifter", J.chapterDigitShifter * J.chapterDigitShifter), R(J, "bcvMaxValue", J.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
R(J, "ValidStatusType", Nn);
      ...
      children: [
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: V.bookIdToEnglishName(t)
          }
        ),
...
const je = V.allBookIds.filter((t) => !V.isObsolete(V.bookIdToNumber(t))), ia = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Qe = ["OT", "NT", "DC"], wa = 96, la = [
  /^(\w+)$/i,
...
], Mt = (t) => zr(V.bookIdToNumber(t));
function da() {
  return je.map((e) => V.bookIdToEnglishName(e));
}
function ca(t) {
...
function pa(t) {
  ...
  if (ca(e))
    return je.find((a) => V.bookIdToEnglishName(a) === e);
}
function ls({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = Y(), [s, i] = P(""), [w, c] = P(t.book), [u, h] = P(t.chapterNum ?? 0), [f, g] = P(t.book), [m, v] = P(!1), [k, C] = P(m), x = q(void 0), y = q(void 0), z = q(void 0), S = Q(
    (_) => {
      const B = a ? a() : je;
      return {
        OT: B.filter((X) => V.isBookOT(X)),
        NT: B.filter((X) => V.isBookNT(X)),
        DC: B.filter((X) => V.isBookDC(X))
      }[_].filter((X) => {
        const b = V.bookIdToEnglishName(X).toLowerCase(), M = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
        return b.includes(M) || // Match book name
    ...
    (_, B, X, b) => {
      if (h(t.book !== _ ? 1 : t.chapterNum), B || Mt(_) === -1) {
        e({
          book: _,
          chapterNum: X ?? 1,
          verseNum: b ?? 1
    ...
    la.forEach((_) => {
      const B = _.exec(s);
      if (B) {
        const [X, b = void 0, M = void 0] = B.slice(1), et = pa(X);
        (V.isBookIdValid(X) || et) && N(
          et ?? X,
          !0,
          b ? parseInt(b, 10) : 1,
          M ? parseInt(M, 10) : 1
    ...
    (_) => {
      m ? (_.key === "ArrowDown" || _.key === "ArrowUp") && (z != null && z.current ? z.current.focus() : y.current && y.current.focus(), _.preventDefault()) : v(!0);
    },
    [m]
  ), ce = (_) => {
    const { key: B } = _;
    B === "ArrowRight" || B === "ArrowLeft" || B === "ArrowDown" || B === "ArrowUp" || B === "Enter" || x.current.dispatchEvent(new KeyboardEvent("keydown", { key: B }));
  }, pe = (_) => {
    const { key: B } = _;
    if (f === w) {
      if (B === "Enter") {
        _.preventDefault(), N(w, !0, u);
        return;
      }
      const X = B === "ArrowRight" && !o || B === "ArrowRight" && o === "ltr" || B === "ArrowLeft" && o === "rtl", b = B === "ArrowLeft" && !o || B === "ArrowLeft" && o === "ltr" || B === "ArrowRight" && o === "rtl";
      let M = 0;
      if (X)
        if (u < Mt(f))
          M = 1;
      ...
      else B === "ArrowDown" ? M = 6 : B === "ArrowUp" && (M = -6);
      u + M <= 0 || u + M > Mt(f) ? h(0) : M !== 0 && (h(u + M), _.preventDefault());
    }
  };
  return ct(() => {
    w === f ? w === t.book ? h(t.chapterNum) : h(1) : h(0);
  }, [f, t.book, t.chapterNum, w]), Ke(() => {
    C(m);
  }, [m]), Ke(() => {
    const _ = setTimeout(() => {
      if (k && y.current && z.current && !s) {
        const X = z.current.offsetTop - wa;
        y.current.scrollTo({ top: X, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(_);
    };
  }, [k, s]), /* @__PURE__ */ l(Wt, { modal: !1, open: m, onOpenChange: U, children: [
    /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(
      Gr,
      {
        ...
        handleKeyDown: E,
        handleOnClick: () => {
          c(t.book), g(t.book), h(t.chapterNum > 0 ? t.chapterNum : 0), v(!0), i(Ot(t, "English")), x.current.focus();
        },
        onFocus: () => {
          $.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      Ft,
      {
        ...
        ref: y,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Qe.map((_, B) => {
          const X = S(_);
          return X.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(Zt, { className: "tw-font-semibold tw-text-foreground/80", children: ia[_] }),
            X.map((b) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              oa,
              {
                bookId: b,
                handleSelectBook: () => N(b, !1),
                isSelected: w === b,
                handleHighlightBook: () => g(b),
                handleKeyDown: pe,
                bookType: _,
                ref: (M) => {
                  w === b && (z.current = M);
                ...
                children: /* @__PURE__ */ r(
                  sa,
                  {
                    handleSelectChapter: T,
                    endChapter: Mt(b),
                    activeChapter: t.book === b ? t.chapterNum : 0,
            ...
            Qe.length - 1 !== B ? /* @__PURE__ */ r(Gt, {}) : void 0
          ] }, _);
        }) })
      }
    )
...
const ua = pt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Rt : "button", { className: d(ua({ variant: e, size: n, className: t })), ref: s, ...o })
);
O.displayName = "Button";
const ma = pt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), L = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(sn.Root, { ref: n, className: d("pr-twp", ma(), t), ...e }));
L.displayName = sn.Root.displayName;
const Xe = p.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    Pt.Root,
    {
...
Xe.displayName = Pt.Root.displayName;
const Yt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Pt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Te, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Yt.displayName = Pt.Item.displayName;
const Fe = At.Root, Ge = At.Trigger, Qt = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = Y();
...
Qt.displayName = At.Content.displayName;
const ha = ot.Portal, kn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ot.Overlay,
  {
    ref: n,
    className: d(
...
kn.displayName = ot.Overlay.displayName;
const ga = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = Y();
...
ga.displayName = ot.Content.displayName;
...
fa.displayName = ot.Title.displayName;
...
ba.displayName = ot.Description.displayName;
...
ee.displayName = K.Input.displayName;
...
ne.displayName = K.List.displayName;
const re = p.forwardRef((t, e) => /* @__PURE__ */ r(K.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
re.displayName = K.Empty.displayName;
const $e = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  K.Group,
  {
    ref: n,
    className: d(
...
$e.displayName = K.Group.displayName;
const Cn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  K.Separator,
  {
    ref: n,
...
ae.displayName = K.Item.displayName;
function va(t) {
...
function ke({
  ...
  const [C, x] = P(!1);
  return /* @__PURE__ */ l(Fe, { open: C, onOpenChange: x, ...k, children: [
    ...
    /* @__PURE__ */ r(
      Qt,
      {
        ...
        children: /* @__PURE__ */ l(te, { children: [
          ...
          /* @__PURE__ */ r(re, { children: f }),
          /* @__PURE__ */ r(ne, { children: e.map((y) => /* @__PURE__ */ l(
            ae,
            {
              value: w(y),
              onSelect: () => {
...
var ya = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(ya || {});
...
function cs({
  ...
  const h = he(u, "%webView_bookSelector_currentBook%"), f = he(u, "%webView_bookSelector_choose%"), g = he(u, "%webView_bookSelector_chooseBooks%"), [m, v] = P(
    "current book"
    /* CURRENT_BOOK */
  ), k = (C) => {
    v(C), t(C);
    ...
    Xe,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(L, { className: "tw-flex tw-items-center", children: a.map((C) => V.bookIdToEnglishName(C)).join(", ") }),
          /* @__PURE__ */ r(
            O,
            {
...
function Na({ table: t }) {
  return /* @__PURE__ */ l(Wt, { children: [
    /* @__PURE__ */ r(ar, { asChild: !0, children: /* @__PURE__ */ l(O, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const kt = G.Root, ka = G.Group, Ct = G.Value, Ca = pt(
...
), bt = p.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = Y();
  return /* @__PURE__ */ l(
    G.Trigger,
    {
      className: d(Ca({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(G.Icon, { asChild: !0, children: /* @__PURE__ */ r(Jt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
bt.displayName = G.Trigger.displayName;
const Sn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  G.ScrollUpButton,
  {
    ref: n,
...
Sn.displayName = G.ScrollUpButton.displayName;
...
_n.displayName = G.ScrollDownButton.displayName;
...
Sa.displayName = G.Label.displayName;
const nt = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  G.Item,
  {
    ref: a,
    className: d(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(xt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(G.ItemText, { children: e })
    ]
  }
));
nt.displayName = G.Item.displayName;
...
_a.displayName = G.Separator.displayName;
function Ra({ table: t }) {
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        kt,
        {
          ...
          children: [
            /* @__PURE__ */ r(bt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ct, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(vt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(nt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const oe = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: d("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const se = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: d(
...
const ie = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
...
Ta.displayName = "TableFooter";
const dt = p.forwardRef(
...
const St = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function Va({
  ...
  var C;
  const [w, c] = P([]), [u, h] = P([]), [f, g] = P({}), [m, v] = P({}), k = wn({
    data: e,
    columns: t,
    getCoreRowModel: dn(),
    ...n && { getPaginationRowModel: Or() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(Na, { table: k }),
    /* @__PURE__ */ l(oe, { stickyHeader: s, children: [
      /* @__PURE__ */ r(se, { stickyHeader: s, children: k.getHeaderGroups().map((x) => /* @__PURE__ */ r(dt, { children: x.headers.map((y) => /* @__PURE__ */ r(jt, { children: y.isPlaceholder ? void 0 : It(y.column.columnDef.header, y.getContext()) }, y.id)) }, x.id)) }),
      /* @__PURE__ */ r(ie, { children: (C = k.getRowModel().rows) != null && C.length ? k.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        dt,
        {
          onClick: () => i(x, k),
          "data-state": x.getIsSelected() && "selected",
          children: x.getVisibleCells().map((y) => /* @__PURE__ */ r(St, { children: It(y.column.columnDef.cell, y.getContext()) }, y.id))
        },
        x.id
      )) : /* @__PURE__ */ r(dt, { children: /* @__PURE__ */ r(St, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && a && /* @__PURE__ */ r(Ra, { table: k })
  ] });
}
const $t = qt(({ className: t, ...e }, n) => /* @__PURE__ */ r(cr, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function ps({
  ...
  return /* @__PURE__ */ r(
    O,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r($t, { size: 15 }) : /* @__PURE__ */ l(_t, { children: [
        /* @__PURE__ */ r(pr, { size: 25, className: d("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
}
function us({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    O,
    {
      className: d(
      ...
      onClick: e,
      ...a,
      children: t ? /* @__PURE__ */ l(_t, { children: [
...
function hs({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    O,
    {
      className: d(
...
function gs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Ar, { options: o, children: e }) });
}
const za = qt((t, e) => /* @__PURE__ */ l(
  O,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ r(ur, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ r(
        Jt,
        {
...
function fs({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(Wt, { children: [
    /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(za, {}) }),
    /* @__PURE__ */ r(Ft, { children: e.map((n) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(Zt, { children: n.label }),
      /* @__PURE__ */ r(un, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Oe, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(gn, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Gt, {})
    ] }, n.label)) })
  ] }) });
}
function bs({ id: t, message: e }) {
      ...
      children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ r(mr, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ l("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ l(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ r(hr, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ l(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ r(gr, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function Da({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const c = new Date(w), u = new Date(o.getTime() - c.getTime()), h = u.getUTCFullYear() - 1970, f = u.getUTCMonth(), g = u.getUTCDate() - 1;
    let m = "";
  ...
  return /* @__PURE__ */ l("div", { id: t, children: [
    ...
    /* @__PURE__ */ r("ul", { className: "tw-list-disc tw-pl-5 tw-pr-4 tw-text-xs tw-text-gray-600", children: (n ? i : i.slice(0, 5)).map((w) => /* @__PURE__ */ l("div", { className: "tw-mt-3 tw-flex tw-justify-between", children: [
...
function xs({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ l("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ r(Da, { versionHistory: o }),
...
const Ba = pt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", Ba({ variant: e }), t), ...n })
);
...
function Oa({
  ...
  const [f, g] = P(!1), m = Q(
    (C) => {
      var y;
      const x = (y = t.find((z) => z.label === C)) == null ? void 0 : y.value;
      x && a(
        n.includes(x) ? n.filter((z) => z !== x) : [...n, x]
      );
    },
    [t, n, a]
  ), v = () => i || o, k = tt(() => {
    if (!c) return t;
    const C = t.filter((y) => y.starred).sort((y, z) => y.label.localeCompare(z.label)), x = t.filter((y) => !y.starred).sort((y, z) => {
      const S = n.includes(y.value), F = n.includes(z.value);
      return S && !F ? -1 : !S && F ? 1 : y.label.localeCompare(z.label);
    });
    return [...C, ...x];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: h, children: /* @__PURE__ */ l(Fe, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ l(
      O,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Qt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(te, { children: [
      /* @__PURE__ */ r(ee, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ l(ne, { children: [
        /* @__PURE__ */ r(re, { children: s }),
        /* @__PURE__ */ r($e, { children: k.map((C) => {
          const x = e ? e(C) : void 0;
          return /* @__PURE__ */ l(
            ae,
            {
              value: C.label,
              ...
              children: [
                /* @__PURE__ */ r("div", { className: "w-4", children: /* @__PURE__ */ r(
                  xt,
                  {
                    className: d(
                      "tw-h-4 tw-w-4",
                      n.includes(C.value) ? "tw-opacity-100" : "tw-opacity-0"
                    )
                  }
                ) }),
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: C.starred && /* @__PURE__ */ r(fr, { className: "tw-h-4 tw-w-4" }) }),
...
function ys({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((g) => {
      var m;
      return /* @__PURE__ */ l(Ht, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          O,
          {
            variant: "ghost",
...
function Ia({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = tt(() => {
    const i = [];
    return t.forEach((w) => {
      i.some((c) => ze(c, w)) || i.push(w);
    }), i;
  }, [t]);
  return /* @__PURE__ */ l(oe, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(se, { stickyHeader: !0, children: /* @__PURE__ */ l(dt, { children: [
    ...
    /* @__PURE__ */ r(ie, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      dt,
      {
        ...
        children: [
          /* @__PURE__ */ r(St, { children: `${V.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(St, { children: i.text })
        ]
      },
...
Le.displayName = ye.Root.displayName;
const Rn = pt(
...
), Pa = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  cn.Root,
  {
    ref: o,
    className: d(Rn({ variant: e, size: n, className: t })),
    ...a
  }
));
Pa.displayName = cn.Root.displayName;
const Tn = p.createContext({
  size: "default",
  variant: "default"
}), En = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = Y();
  return /* @__PURE__ */ r(
    Kt.Root,
    {
...
En.displayName = Kt.Root.displayName;
const Lt = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = p.useContext(Tn);
  return /* @__PURE__ */ r(
    Kt.Item,
    {
      ref: s,
...
Lt.displayName = Kt.Item.displayName;
const we = (t) => t === "asc" ? /* @__PURE__ */ r(yr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Nr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(kr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ns = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(En, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Lt,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, ja = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ts = Object.freeze([
...
function Es({
  ...
  const u = it(n, "%webView_inventory_all%"), h = it(n, "%webView_inventory_approved%"), f = it(n, "%webView_inventory_unapproved%"), g = it(n, "%webView_inventory_unknown%"), m = it(n, "%webView_inventory_scope_currentBook%"), v = it(n, "%webView_inventory_scope_chapter%"), k = it(n, "%webView_inventory_filter_text%"), C = it(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, y] = P(!1), [z, S] = P("all"), [F, $] = P(""), [U, N] = P([]), T = tt(() => t.length === 0 ? [] : Fa(t, o, s), [t, o, s]), H = tt(() => {
    if (x) return T;
    const b = [];
    return T.forEach((M) => {
      const et = M.items[0], ut = b.find(
        (yt) => yt.items[0] === et
      );
      ut ? (ut.count += M.count, ut.occurrences = ut.occurrences.concat(M.occurrences)) : b.push({
        items: [et],
        count: M.count,
  ...
  }, [x, T]), E = tt(() => Xa(H, z, F), [H, z, F]), ce = tt(() => {
    var et, ut;
    if (!x) return c;
    const b = (et = a == null ? void 0 : a.tableHeaders) == null ? void 0 : et.length;
    if (!b) return c;
    const M = [];
    for (let yt = 0; yt < b; yt++)
      M.push(
        Aa(
          ((ut = a == null ? void 0 : a.tableHeaders) == null ? void 0 : ut[yt]) || "Additional Item",
          yt + 1
        )
      );
    return [...M, ...c];
  ...
  ct(() => {
    E.length === 0 ? N([]) : E.length === 1 && N(E[0].items);
  }, [E]);
  const pe = (b, M) => {
    M.setRowSelection(() => {
      const et = {};
      return et[b.index] = !0, et;
    }), N(b.original.items);
  }, _ = (b) => {
    if (b === "book" || b === "chapter")
      w(b);
    ...
    if (H.length === 0 || U.length === 0) return [];
    const b = H.filter((M) => ze(
      x ? M.items : [M.items[0]],
      U
    ));
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        kt,
        {
          ...
          defaultValue: z,
          children: [
            /* @__PURE__ */ r(bt, { className: "tw-m-1", children: /* @__PURE__ */ r(Ct, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ l(vt, { children: [
              /* @__PURE__ */ r(nt, { value: "all", children: u }),
              /* @__PURE__ */ r(nt, { value: "approved", children: h }),
              /* @__PURE__ */ r(nt, { value: "unapproved", children: f }),
              /* @__PURE__ */ r(nt, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ l(kt, { onValueChange: (b) => _(b), defaultValue: i, children: [
        /* @__PURE__ */ r(bt, { className: "tw-m-1", children: /* @__PURE__ */ r(Ct, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(vt, { children: [
          /* @__PURE__ */ r(nt, { value: "book", children: m }),
          /* @__PURE__ */ r(nt, { value: "chapter", children: v })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Et,
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(L, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? C })
      ] })
    ] }),
    /* @__PURE__ */ r("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ r(
      Va,
      {
        columns: ce,
        data: E,
        onRowClickHandler: pe,
        stickyHeader: !0
      }
    ) }),
    X.length > 0 && /* @__PURE__ */ r("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ r(
      Ia,
      {
        occurrenceData: X,
        setScriptureReference: e,
...
const Ye = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  pn.Root,
  {
    ref: o,
    decorative: n,
...
Ye.displayName = pn.Root.displayName;
...
const He = Xt.Provider, Ue = Xt.Root, qe = Xt.Trigger, le = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Xt.Content,
  {
    ref: a,
    sideOffset: e,
...
le.displayName = Xt.Content.displayName;
const Ga = "16rem", $a = "3rem", Vn = p.createContext(void 0);
function de() {
  const t = p.useContext(Vn);
  if (!t)
...
const zn = p.forwardRef(
  ({
    ...
    const [u, h] = p.useState(t), f = e ?? u, g = p.useCallback(
      (z) => {
        const S = typeof z == "function" ? z(f) : z;
        n ? n(S) : h(S);
      },
      [n, f]
    ), m = p.useCallback(() => g((z) => !z), [g]), v = f ? "expanded" : "collapsed", x = Y() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = p.useMemo(
      () => ({
        state: v,
        open: f,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(Vn.Provider, { value: y, children: /* @__PURE__ */ r(He, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Mn = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = de();
...
Mn.displayName = "Sidebar";
const La = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = de();
  return /* @__PURE__ */ l(
    O,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(Cr, {}) : /* @__PURE__ */ r(Sr, {}),
...
const Ka = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Rt : "button",
  {
    ref: a,
...
Ka.displayName = "SidebarGroupAction";
...
const Wa = pt(
  ...
  ({
    ...
    const c = t ? Rt : "button", { state: u } = de(), h = /* @__PURE__ */ r(
      c,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(Wa({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(qe, { asChild: !0, children: h }),
      /* @__PURE__ */ r(le, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : h;
  }
);
Pn.displayName = "SidebarMenuButton";
const Za = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Rt : "button",
  {
    ref: o,
...
const ro = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Rt : "a",
  {
    ref: s,
...
ro.displayName = "SidebarMenuSubButton";
function ao({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  const u = Q(
    ...
    (g) => {
      const m = n.find((v) => v.projectId === g);
  ...
  return /* @__PURE__ */ r(
    Mn,
    {
      ...
      children: /* @__PURE__ */ l(Bn, { children: [
        /* @__PURE__ */ l(Ce, { children: [
          /* @__PURE__ */ r(Se, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(_e, { children: /* @__PURE__ */ r(On, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(In, { children: /* @__PURE__ */ r(
            Pn,
            {
              onClick: () => u(g),
              isActive: f(g),
    ...
    /* @__PURE__ */ l(
      zn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Dn, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const wt = "scrBook", oo = "scrRef", gt = "source", so = "details", io = "Scripture Reference", wo = "Scripture Book", jn = "Type", lo = "Details";
function co(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? V.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === wt ? Ot(o.start) : void 0;
      },
      getGroupingValue: (a) => V.bookIdToNumber(a.start.book),
    ...
    },
    {
      ...
      id: gt,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? jn : void 0,
    ...
    },
    {
      ...
      id: so,
      header: (t == null ? void 0 : t.detailsColumnName) ?? lo,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
}, en = (t) => `${po({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function zs({
  sources: t,
  ...
  const [c, u] = P([]), [h, f] = P([{ id: wt, desc: !1 }]), [g, m] = P({}), v = tt(
  ...
  const C = wn({
    ...
    getExpandedRowModel: Pr(),
    getGroupedRowModel: Ir(),
    getCoreRowModel: dn(),
    getSortedRowModel: ln(),
    getRowId: en,
    autoResetExpanded: !1,
  ...
  ct(() => {
    if (w) {
      ...
      if (T.length === 1) {
        const H = v.find((E) => en(E) === T[0]) || void 0;
        H && w(H);
      }
    }
  }, [g, v, w, C]);
  const x = o ?? wo, y = s ?? jn, z = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [wt] },
  ...
  }, $ = (N, T) => N.getIsGrouped() ? "" : d("banded-row", T % 2 === 0 ? "even" : "odd"), U = (N, T, H) => {
    if (!((N == null ? void 0 : N.length) === 0 || T.depth < H.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      kt,
      {
        ...
        children: [
          /* @__PURE__ */ r(bt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ct, {}) }),
          /* @__PURE__ */ r(vt, { position: "item-aligned", children: /* @__PURE__ */ r(ka, { children: z.map((N) => /* @__PURE__ */ r(nt, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(oe, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(se, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ r(dt, { children: N.headers.filter((T) => T.column.columnDef.header).map((T) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(jt, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          ...
          " ",
          It(T.column.columnDef.header, T.getContext())
        ] }) }, T.id)
      )) }, N.id)) }),
      /* @__PURE__ */ r(ie, { children: C.getRowModel().rows.map((N, T) => {
        const H = Y();
        return /* @__PURE__ */ r(
          dt,
          {
            ...
            children: N.getVisibleCells().map((E) => {
              if (!(E.getIsPlaceholder() || E.column.columnDef.enableGrouping && !E.getIsGrouped() && (E.column.columnDef.id !== gt || !n)))
                return /* @__PURE__ */ r(
                  St,
                  {
                    className: d(
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ l(
                      O,
                      {
                        ...
                        type: "button",
                        children: [
                          N.getIsExpanded() && /* @__PURE__ */ r(Jt, {}),
                          !N.getIsExpanded() && (H === "ltr" ? /* @__PURE__ */ r(Re, {}) : /* @__PURE__ */ r(Rr, {})),
                          " ",
                          It(E.column.columnDef.cell, E.getContext()),
                          " (",
                          N.subRows.length,
                          ")"
                        ]
...
var lt = /* @__PURE__ */ ((t) => (t.OT = "OT", t.NT = "NT", t.DC = "DC", t.Extra = "Extra", t))(lt || {});
const uo = (t) => {
  switch (t) {
    case "OT":
  ...
  if (V.isBookOT(t)) return "OT";
  if (V.isBookNT(t)) return "NT";
  if (V.isBookDC(t)) return "DC";
  if (V.isExtraMaterial(t)) return "Extra";
...
}), Xn = (t, e, n) => Je(t, e).every((a) => n.includes(a));
function mo({ bookId: t, selectedBookIds: e, toggleBook: n, lastKeyEventShiftKey: a }) {
  const o = q(!1), s = q();
  return /* @__PURE__ */ l(
    ae,
    {
      ...
      onSelect: () => {
        o.current || (n(t, a.current), a.current = !1), s.current && clearTimeout(s.current), s.current = setTimeout(() => {
          o.current = !1;
        }, 100);
      },
      onMouseDown: (i) => {
        i.preventDefault(), o.current = !0, n(t, i.shiftKey);
      },
      role: "option",
      "aria-selected": e.includes(t),
      "aria-label": `${V.bookIdToEnglishName(t)} (${t.toLocaleUpperCase()})`,
      children: [
        /* @__PURE__ */ r(
          xt,
          {
        ...
        /* @__PURE__ */ r(
          "span",
          {
            className: d(
              ...
              {
                "tw-border-s-red-200": Nt(t) === lt.OT,
                "tw-border-s-purple-200": Nt(t) === lt.NT,
                "tw-border-s-indigo-200": Nt(t) === lt.DC,
                "tw-border-s-yellow-200": Nt(t) === lt.Extra
              }
            ),
            children: V.bookIdToEnglishName(t)
          }
        ),
        /* @__PURE__ */ r("span", { className: "tw-ml-2 tw-text-xs tw-text-muted-foreground", children: t.toLocaleUpperCase() })
      ]
    },
    t
  );
...
function ho({
  ...
  return /* @__PURE__ */ r(
    O,
    {
      ...
      onClick: () => a(t),
      className: d(
        Xn(e, t, n) && !o && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/90"
      ),
      disabled: o,
      children: t
    }
...
function go({
  ...
  const o = a["%webView_book_selector_books_selected%"], s = a["%webView_book_selector_select_books%"], i = a["%webView_book_selector_search_books%"], w = a["%webView_book_selector_select_all%"], c = a["%webView_book_selector_clear_all%"], u = a["%webView_book_selector_no_book_found%"], h = a["%webView_book_selector_more%"], [f, g] = P(!1), m = q(void 0), v = q(!1);
  if (t.length !== V.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const k = tt(() => V.allBookIds.filter(
    (S, F) => t[F] === "1" && !V.isObsolete(V.bookIdToNumber(S))
  ), [t]), C = Q(
    (S, F = !1) => {
      if (!F || !m.current) {
        n(
      ...
      const $ = k.findIndex((E) => E === m.current), U = k.findIndex((E) => E === S);
      if ($ === -1 || U === -1) return;
      const [N, T] = [
        Math.min($, U),
        Math.max($, U)
      ], H = k.slice(N, T + 1).map((E) => E);
      n(
        e.includes(S) ? e.filter((E) => !H.includes(E)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, n, k]
  ), x = Q(
    (S) => {
      const F = Je(k, S).map(($) => $);
      n(
        Xn(k, S, e) ? e.filter(($) => !F.includes($)) : [.../* @__PURE__ */ new Set([...e, ...F])]
      );
    },
    [e, n, k]
  ), y = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(lt).map((S) => /* @__PURE__ */ r(
      ho,
      {
        section: S,
        availableBookIds: k,
    ...
    /* @__PURE__ */ l(Fe, { open: f, onOpenChange: g, children: [
      /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ l(
        O,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(Qt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
        te,
        {
          onKeyDown: (S) => {
            S.key === "Enter" && (v.current = S.shiftKey);
          },
          children: [
            /* @__PURE__ */ r(ee, { placeholder: i }),
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(O, { variant: "ghost", size: "sm", onClick: y, children: w }),
              /* @__PURE__ */ r(O, { variant: "ghost", size: "sm", onClick: z, children: c })
            ] }),
            /* @__PURE__ */ l(ne, { children: [
              /* @__PURE__ */ r(re, { children: u }),
              Object.values(lt).map((S, F) => {
                const $ = k.filter(
                  (U) => Nt(U) === S
                );
                if ($.length !== 0)
                  return /* @__PURE__ */ l(an, { children: [
                    /* @__PURE__ */ r($e, { heading: uo(S), children: $.map((U) => /* @__PURE__ */ r(
                      mo,
                      {
                        bookId: U,
                        selectedBookIds: e,
                    ...
                    F < Object.values(lt).length - 1 && /* @__PURE__ */ r(Cn, {})
                  ] }, S);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === fe ? fe : nn
      ).map((S) => /* @__PURE__ */ r(Ht, { variant: "secondary", children: V.bookIdToEnglishName(S) || S }, S)),
      e.length > fe && /* @__PURE__ */ r(Ht, { variant: "secondary", children: `+${e.length - nn} ${h}` })
    ] })
  ] });
}
...
function Ds({
  ...
  const w = mt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = mt(i, "%webView_scope_selector_current_book%"), f = mt(i, "%webView_scope_selector_choose_books%"), g = mt(i, "%webView_scope_selector_scope%"), m = mt(i, "%webView_scope_selector_select_books%"), v = [
  ...
  ], k = e ? v.filter((C) => e.includes(C.value)) : v;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Xe,
        {
          ...
          children: k.map(({ value: C, label: x, id: y }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Yt, { className: "tw-me-2", value: C, id: y }),
            /* @__PURE__ */ r(L, { htmlFor: y, children: x })
          ] }, y))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(L, { children: m }),
      /* @__PURE__ */ r(
        go,
        {
          availableBookInfo: a,
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          vt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(nt, { value: `${c}`, children: i[I(c)] }, `${c}`))
          }
        )
      ]
    }
...
const Gn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(qe, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    Be,
    {
      ...
      children: [
        w.iconPathBefore && /* @__PURE__ */ r(Ut, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
        w.label,
        w.iconPathAfter && /* @__PURE__ */ r(Ut, { icon: w.iconPathAfter, menuLabel: w.label })
      ]
    },
    `dropdown-menu-item-${w.label}-${w.command}`
  ) : /* @__PURE__ */ l(Yr, { children: [
    /* @__PURE__ */ r(mn, { children: w.label }),
    /* @__PURE__ */ r(Lr, { children: /* @__PURE__ */ r(hn, { children: Gn(
      t,
      e,
      Fn(t, w.id),
      a
  ...
  w.tooltip && /* @__PURE__ */ r(le, { children: w.tooltip })
...
function rn({
  ...
  return /* @__PURE__ */ l(Wt, { variant: s, children: [
    /* @__PURE__ */ r(De, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(O, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Tr, {}) }) }),
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ l(an, { children: [
      /* @__PURE__ */ r(un, { children: /* @__PURE__ */ r(He, { children: Gn(e.groups, e.items, w, t) }) }),
      c < u.length - 1 && /* @__PURE__ */ r(Gt, {})
    ] }, w)) })
  ] });
}
function As({
...
$n.displayName = W.List.displayName;
...
Ln.displayName = W.List.displayName;
...
)), Yn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  W.Content,
  {
    ref: n,
    className: d(
...
Yn.displayName = W.Content.displayName;
function js({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l($n, { children: [
      /* @__PURE__ */ r(Ln, { children: t.map((i) => /* @__PURE__ */ r(fo, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(Yn, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function bo({ ...t }) {
...
const Hn = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(Me.Provider, { value: o, children: /* @__PURE__ */ r(
    j.Root,
    {
      ref: a,
      className: d(
...
Hn.displayName = j.Root.displayName;
...
Un.displayName = j.Trigger.displayName;
  ...
  return /* @__PURE__ */ l(
    j.SubTrigger,
    {
      ...
      className: d(
        ...
        e && "tw-pl-8",
        st({ variant: s.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...a,
...
qn.displayName = j.SubTrigger.displayName;
...
Jn.displayName = j.SubContent.displayName;
const Kn = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = rt();
...
Kn.displayName = j.Content.displayName;
const Wn = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = rt();
  return /* @__PURE__ */ r(
    j.Item,
    {
...
Wn.displayName = j.Item.displayName;
const xo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    j.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(xt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
xo.displayName = j.CheckboxItem.displayName;
const yo = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = rt();
  return /* @__PURE__ */ l(
    j.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(Te, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
yo.displayName = j.RadioItem.displayName;
const No = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
No.displayName = j.Label.displayName;
...
Zn.displayName = j.Separator.displayName;
const Dt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((u) => u.group === s).sort((u, h) => u.order - h.order).map((u) => /* @__PURE__ */ l(Ue, { children: [
      ...
      u.tooltip && /* @__PURE__ */ r(le, { children: u.tooltip })
    ] }, `tooltip-${u.label}-${"command" in u ? u.command : u.id}`)), c = [...w];
    return w.length > 0 && i < o.length - 1 && c.push(/* @__PURE__ */ r(Zn, {}, `separator-${s}`)), c;
  });
};
function ko({
  menuData: t,
  ...
  const o = q(void 0), s = q(void 0), i = q(void 0), w = q(void 0), c = q(void 0), u = (h) => {
    switch (h) {
      case "platform.app":
        return s;
  ...
  if (jr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (h, f) => {
    var v, k, C, x;
    h.preventDefault();
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (v = s.current) == null || v.focus(), Dt(s, [g, m]);
        break;
      case "alt+l":
        (k = i.current) == null || k.focus(), Dt(i, [g, m]);
        break;
      case "alt+n":
        (C = w.current) == null || C.focus(), Dt(w, [g, m]);
        break;
      case "alt+h":
        (x = c.current) == null || x.focus(), Dt(c, [g, m]);
        break;
    }
  }), ct(() => {
    ...
    const h = new MutationObserver((m) => {
      m.forEach((v) => {
        if (v.attributeName === "data-state" && v.target instanceof HTMLElement) {
          const k = v.target.getAttribute("data-state");
          n(k === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(Hn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, h]) => typeof h == "object").sort(([, h], [, f]) => typeof h == "boolean" || typeof f == "boolean" ? 0 : h.order - f.order).map(([h, f]) => /* @__PURE__ */ l(bo, { children: [
      /* @__PURE__ */ r(Un, { ref: u(h), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Kn,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(He, { children: Qn(t.groups, t.items, h, e) })
        }
      )
    ] }, h)) });
}
...
function Gs({
  ...
  const c = Co(
    ...
    o && o(m), a && a([m, ...n.filter((v) => v !== m)]), s && n.find((v) => v === m) && s([...n.filter((v) => v !== m)]), h(!1);
  }, g = (m, v) => {
    var C, x, y, z, S, F;
    const k = v !== m ? ((x = (C = t[m]) == null ? void 0 : C.uiNames) == null ? void 0 : x[v]) ?? ((z = (y = t[m]) == null ? void 0 : y.uiNames) == null ? void 0 : z.en) : void 0;
    return k ? `${(S = t[m]) == null ? void 0 : S.autonym} (${k})` : (F = t[m]) == null ? void 0 : F.autonym;
  };
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      kt,
      {
        ...
        onOpenChange: (m) => h(m),
        children: [
          /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ r(Ct, {}) }),
          /* @__PURE__ */ r(
            vt,
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((m) => /* @__PURE__ */ r(nt, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ l(_t, { children: [
      /* @__PURE__ */ r(L, { className: "tw-ms-3", children: c }),
...
function So({ item: t, createLabel: e, createComplexLabel: n }) {
...
), Ro = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(_o({ variant: e }), t), ...n }));
Ro.displayName = "Alert";
...
To.displayName = "AlertTitle";
const Eo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Eo.displayName = "AlertDescription";
...
Vo.displayName = Tt.Root.displayName;
...
zo.displayName = Tt.Image.displayName;
...
Mo.displayName = Tt.Fallback.displayName;
...
const Io = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const jo = p.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ l(
    Bt.Root,
    {
...
jo.displayName = Bt.Root.displayName;
const Xo = p.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    Ne.Root,
    {
...
Xo.displayName = Ne.Root.displayName;
const Hs = W.Root, Fo = p.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    W.List,
    {
...
Fo.displayName = W.List.displayName;
...
Go.displayName = W.Trigger.displayName;
...
$o.displayName = W.Content.displayName;
const Us = (t, e) => {
  ct(() => {
    if (!t) return () => {
    };
...
export {
  ...
  zo as AvatarImage,
  ds as BOOK_SELECTOR_STRING_KEYS,
  Ht as Badge,
  ls as BookChapterControl,
  ...
  ys as Filter,
  za as FilterButton,
  fs as FilterDropdown,
  xs as Footer,
  Ts as INVENTORY_STRING_KEYS,
  Et as Input,
  ps as InstallButton,
  Es as Inventory,
  L as Label,
  ...
  hs as UpdateButton,
  Da as VersionHistory,
  $n as VerticalTabs,
  Yn as VerticalTabsContent,
  Ln as VerticalTabsList,
  fo as VerticalTabsTrigger,
  Ba as badgeVariants,
  ua as buttonVariants,
  d as cn,
  Rs as getBookIdFromUSFM,
  Ss as getLinesFromUSFM,
  _s as getNumberFromUSFM,
