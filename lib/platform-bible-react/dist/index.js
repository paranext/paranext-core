...
import v, { forwardRef as on, useRef as H, useMemo as F, useState as S, useCallback as K, useLayoutEffect as Mt, createContext as Cn, useContext as gr, useEffect as Y, Component as xs, createElement as jr, Suspense as ys, Fragment as bo } from "react";
import { Command as kt } from "cmdk";
import { X as an, Search as vo, Check as Ut, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Wn, ChevronRight as Ie, ArrowLeft as Ns, ArrowRight as ks, Circle as En, ChevronDown as je, BoldIcon as _s, ItalicIcon as Cs, AtSign as xo, Pencil as Es, Trash2 as Ts, ArrowUp as yo, MoreHorizontal as Rs, MailOpen as Ss, Mail as Ds, ChevronUp as No, FilterIcon as Ms, ArrowLeftIcon as Os, ChevronLeftIcon as Is, ChevronRightIcon as As, ArrowRightIcon as Ps, Copy as ko, Filter as $s, User as Ls, Link as Vs, CircleHelp as js, ChevronsUpDown as _o, Star as zs, Undo as Fs, Redo as Bs, SquareX as Co, FunctionSquare as Eo, SquareSigma as To, Ban as Ks, AlertCircle as Jn, CircleCheckIcon as Gs, CircleXIcon as Us, CircleHelpIcon as qs, ArrowUpIcon as Hs, ArrowDownIcon as Ys, PanelLeft as Xs, PanelRight as Ws, ScrollText as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as ti, MoreVertical as Kr, LoaderCircle as ei, GripVertical as ni } from "lucide-react";
...
const dl = Lt.Root, pl = Lt.Portal, Yo = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Lt.Overlay,
  {
    ref: n,
    className: f(
...
Yo.displayName = Lt.Overlay.displayName;
...
Xo.displayName = Lt.Content.displayName;
...
Jo.displayName = Lt.Title.displayName;
...
ul.displayName = Lt.Description.displayName;
...
function ar(t, e, n) {
  return `${t} ${ye[t]}${e ? ` ${Nr(t, e)} ${Oe(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function hl({
  recentSearches: t,
...
function yp({
  ...
  const w = ht(), [d, m] = S(!1), [h, u] = S(""), [g, b] = S(""), [x, E] = S("books"), [y, k] = S(void 0), [_, z] = S(!1), V = H(void 0), R = H(void 0), $ = H(void 0), C = H(void 0), D = H({}), j = K(
  ...
  }), [P]), A = F(() => Object.values(I).flat(), [I]), W = F(() => {
    if (!g.trim()) return I;
    const M = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (M) => {
      const N = x === "chapters" ? y : O == null ? void 0 : O.book;
      N && (j({
        book: N,
        chapterNum: M,
        verseNum: 1
    ...
    (M) => {
      ...
      if ((x === "chapters" || x === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        const U = x === "chapters" ? y : O == null ? void 0 : O.book;
        if (!U) return;
        const q = (() => {
          if (!h) return 1;
          const ct = h.match(/(\d+)$/);
  ...
  }, [x, y, O, t.book, t.chapterNum]), /* @__PURE__ */ p(ae, { open: d, onOpenChange: G, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      B,
      {
        ...
        children: [
          ...
          !_ && /* @__PURE__ */ p(oe, { ref: $, children: [
            x === "books" && /* @__PURE__ */ p(it, { children: [
              ...
              O && Kt(O.book) > 1 && /* @__PURE__ */ p(it, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Oe(O.book, a) }),
                /* @__PURE__ */ r(
                  Jr,
                  {
                    bookId: O.book,
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, _l = oa ? Mt : Y, pn = { tag: br };
      ...
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (Vt() !== null || b !== null && b === m.getRootElement()) && g.select();
          }
        }, pn);
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
...
const Cr = {
  ...
  mark: "",
  markOverlap: ""
}, Tt = _e.Provider, Ot = _e.Root, It = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  _e.Trigger,
  {
    ref: o,
...
It.displayName = _e.Trigger.displayName;
const Rt = v.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(_e.Portal, { children: /* @__PURE__ */ r(
  _e.Content,
  {
    ref: o,
    sideOffset: e,
...
Rt.displayName = _e.Content.displayName;
const Er = [
  Hi,
  Do,
  Mo,
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
function Il(t) {
...
function jl(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Oo(s, (w) => we(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
const Sr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
...
const pw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
function uw({ onClear: t }) {
  const [e] = Xt();
  return pw(() => ca(e, t), [e, t]), null;
}
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
function mw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: b, role: x = "textbox", spellCheck: E = !0, style: y, tabIndex: k, "data-testid": _, ...z }, V) {
  const [R, $] = S(t.isEditable()), C = K((j) => {
    ...
    return (P) => {
      for (const I of j) typeof I == "function" ? I(P) : I != null && (I.current = P);
    };
  }(V, C), [C, V]);
...
function Ia({
  ...
  return /* @__PURE__ */ p(Da, { children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
      ...
      /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: l }) })
    ] }) }),
    ...
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
      ...
      /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: c }) })
    ] }) })
  ] });
}
function gn(t, e) {
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), n()) : Or(b) && (b.preventDefault(), b.stopPropagation(), $t(a) && h());
        },
        onKeyDown: (b) => {
    ...
    if (o && l)
      return /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (_) => {
              _.stopPropagation(), w(!0), m(Ow(t.contents)), i == null || i(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), u()) : Or(_) && (_.preventDefault(), _.stopPropagation(), $t(d) && g());
              },
              onKeyDown: (_) => {
...
function Yw({
  ...
  const [R, $] = S(co), [C, D] = S(
    void 0
  ), j = o, [P, I] = S(!1), [A, W] = S(!1), [O, J] = S(!1), [Ct, At] = S(!1), [St, gt] = S(!1), [pt, G] = S(_), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ p(it, { children: [
            ...
            x !== !1 && (!A || $t(R)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Or(T) && (T.preventDefault(), T.stopPropagation(), ($t(R) || C !== void 0) && Et());
                },
                onKeyDown: (T) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ p(ae, { open: O, onOpenChange: J, children: [
                      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
                        B,
                        {
                          size: "icon",
...
function Rp({
  ...
  const z = n.filter(
    ...
    (I) => {
      y((A) => new Set(A).add(I.id)), _(I.id), b == null || b(I.id);
    },
    [b]
  ), $ = K(
    (I) => {
    ...
    (I) => {
      I.key === "Escape" ? (k && E.has(k) && (y((A) => {
        const W = new Set(A);
        return W.delete(k), W;
      }), _(void 0), b == null || b(void 0)), I.preventDefault(), I.stopPropagation()) : j(I);
    },
    [k, E, j, b]
  );
  return /* @__PURE__ */ r(
...
Dt.displayName = dt.Item.displayName;
      ...
      /* @__PURE__ */ p(
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Re, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(Dt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const In = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function ic({
  ...
  return c ? z = Array.from({ length: 10 }).map((C, D) => `skeleton-row-${D}`).map((C) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : ((V = k.getRowModel().rows) == null ? void 0 : V.length) > 0 ? z = k.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    ...
    /* @__PURE__ */ p(Mn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(On, { stickyHeader: s, children: k.getHeaderGroups().map((R) => /* @__PURE__ */ r(Qt, { children: R.headers.map(($) => /* @__PURE__ */ r(rn, { className: "tw-p-0", children: $.isPlaceholder ? void 0 : We($.column.columnDef.header, $.getContext()) }, $.id)) }, R.id)) }),
...
function pc({
  ...
  const [E, y] = S(!1), k = K(
    (D) => {
      var P;
      const j = (P = t.find((I) => I.label === D)) == null ? void 0 : P.value;
      j && n(
    ...
    if (!h) return t;
    const D = t.filter((P) => P.starred).sort((P, I) => P.label.localeCompare(I.label)), j = t.filter((P) => !P.starred).sort((P, I) => {
...
function mc({
  ...
  return /* @__PURE__ */ p(Da, { children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
      ...
      /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ p("p", { children: [
        w,
    ...
    e && /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
      /* @__PURE__ */ r(It, { asChild: !0, children: /* @__PURE__ */ r(
        B,
        {
          "aria-label": d,
...
function gc({
  ...
  return /* @__PURE__ */ p(me, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
      /* @__PURE__ */ r(It, { asChild: !0, children: /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: hc(t, a, n) }) }) }),
      /* @__PURE__ */ r(Rt, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ p(
      ee,
      {
...
function xc({
  ...
  return /* @__PURE__ */ p(me, { children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
      ...
      /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: vc(t, n) }) })
    ] }) }),
...
function $p({
  ...
  const [g, b] = S("generated"), [x, E] = S("*"), [y, k] = S("f"), [_, z] = S(!1), [V, R] = S(!0), [$, C] = S(!1), D = H(!1), j = H(""), [P, I] = S(!1), [A, W] = S(), [O, J] = S(), [Ct, At] = S(), [St, gt] = S(), pt = H(null), G = F(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  return Y(() => {
    ...
    const N = ((U = m.current) == null ? void 0 : U.querySelector(".editor-input")) ?? void 0, L = (q) => {
      !P && N && document.activeElement === N && q.key === l ? (q.preventDefault(), M()) : P && q.key === "Escape" && (q.preventDefault(), I(!1));
    };
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
              /* @__PURE__ */ r(It, { asChild: !0, children: /* @__PURE__ */ r(
                B,
                {
                  onClick: Ft,
              ...
              /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: c["%footnoteEditor_copyButton_tooltip%"] }) })
            ] }) }) })
          ]
        }
      )
...
const Ic = (t) => {
...
}, An = (t, e, n) => /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
  /* @__PURE__ */ p(
    It,
    {
  ...
  /* @__PURE__ */ r(Rt, { side: "bottom", children: e })
] }) }), jp = (t) => ({
  accessorKey: "item",
...
function qp({
  ...
  const u = Bt(n, "%webView_inventory_all%"), g = Bt(n, "%webView_inventory_approved%"), b = Bt(n, "%webView_inventory_unapproved%"), x = Bt(n, "%webView_inventory_unknown%"), E = Bt(n, "%webView_inventory_scope_currentBook%"), y = Bt(n, "%webView_inventory_scope_chapter%"), k = Bt(n, "%webView_inventory_scope_verse%"), _ = Bt(n, "%webView_inventory_filter_text%"), z = Bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = Bt(n, "%webView_inventory_no_results%"), [R, $] = S(!1), [C, D] = S("all"), [j, P] = S(""), [I, A] = S([]), W = F(() => {
    const G = t ?? [];
  ...
  }, [R, W]), J = F(() => O.length === 0 ? [] : $c(O, C, j), [O, C, j]), Ct = F(() => {
    var st, wt;
    if (!R) return c;
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        Le,
        {
          ...
          defaultValue: C,
          children: [
            /* @__PURE__ */ r(Te, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ p(Le, { onValueChange: (G) => St(G), defaultValue: i, children: [
        /* @__PURE__ */ r(Te, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Re, { children: [
          /* @__PURE__ */ r(Dt, { value: "book", children: E }),
      ...
      o && /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ p(Ot, { children: [
        /* @__PURE__ */ r(It, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-w-fit tw-min-w-[26px] tw-items-center tw-rounded-md tw-border", children: [
          ...
          /* @__PURE__ */ r(ft, { className: "tw-m-1 tw-truncate", children: (o == null ? void 0 : o.checkboxText) ?? z })
        ] }) }),
        /* @__PURE__ */ r(Rt, { children: (o == null ? void 0 : o.checkboxText) ?? z })
      ] }) })
    ] }),
...
const qa = v.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Ua.Provider, { value: y, children: /* @__PURE__ */ r(Tt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Hc = ne(
  ...
  ({
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Rt, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : d;
  }
);
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Re, { position: "item-aligned", children: /* @__PURE__ */ r(Ww, { children: _.map((C) => /* @__PURE__ */ r(Dt, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Mn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ r(Qt, { children: C.headers.filter((D) => D.column.columnDef.header).map((D) => (
      ...
      /* @__PURE__ */ r(In, { children: E.getRowModel().rows.map((C, D) => {
        const j = ht();
        return /* @__PURE__ */ r(
          Qt,
          {
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ p(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (j === "ltr" ? /* @__PURE__ */ r(Ie, {}) : /* @__PURE__ */ r(Wn, {})),
                          " ",
...
function wd({
  ...
  const V = F(() => ut.allBookIds.filter(
    ...
    (A, W = !1) => {
      ...
      const O = V.findIndex((gt) => gt === _.current), J = V.findIndex((gt) => gt === A);
      if (O === -1 || J === -1) return;
      const [Ct, At] = [
        Math.min(O, J),
        Math.max(O, J)
      ], St = V.slice(Ct, At + 1).map((gt) => gt);
      n(
        e.includes(A) ? e.filter((gt) => !St.includes(gt)) : [.../* @__PURE__ */ new Set([...e, ...St])]
      );
    },
    [e, n, V]
  ), C = (A) => {
    ...
    (A) => {
      const W = Lr(V, A).map((O) => O);
      n(
        ts(V, A, e) ? e.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, V]
  ), P = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Hn ? Hn : go
      ).map((A) => /* @__PURE__ */ r($e, { className: "hover:tw-bg-secondary", variant: "secondary", children: Oe(A, a) }, A)),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Re,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(Dt, { value: `${w}`, children: l[Q(w)] }, `${w}`))
          }
        )
      ]
    }
...
const ns = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  l.tooltip && /* @__PURE__ */ r(Rt, { children: l.tooltip })
...
function hr({
  ...
  return /* @__PURE__ */ p(me, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(bo, { children: [
      /* @__PURE__ */ r(Va, { children: /* @__PURE__ */ r(Tt, { children: ns(e.groups, e.items, c, t) }) }),
...
const He = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, d) => w.order - d.order).map((w) => /* @__PURE__ */ p(Ot, { children: [
      ...
      w.tooltip && /* @__PURE__ */ r(Rt, { children: w.tooltip })
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    return /* @__PURE__ */ r(is, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(dd, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Tt, { children: ms(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
