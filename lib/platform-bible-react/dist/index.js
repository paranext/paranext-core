...
import { c as m, g as Oe, a as La, C as Ve, A as ue, P as je, b as Xe, B as H, d as Be, e as Je, f as Ze, h as Ee, i as Bi, k as Li, j as Fi, E as Ui, l as Fa, r as se, m as Ki, n as dn, o as Qr, p as Ua, L as Et, D as _a, q as Na, s as Ca, t as Ea, T as Wt, u as Ka, v as Xt, w as Jt, x as Zt, y as wn, z as qa, F as He, G as _r, H as Te, I as ze, J as Se, S as Nr, K as or, M as qi, N as Tr, O as We, Q as Ie, R as Ae, U as nr, V as Ga, W as Ha, X as qr, Y as Ya, Z as un, _ as Gi, $ as Hi, a0 as Yi, a1 as bo, a2 as pn, a3 as ta, a4 as hn, a5 as Wi, a6 as Xi, a7 as Ji, a8 as Zi, a9 as gn, aa as Qi, ab as ia, ac as xo, ad as sa, ae as gr, af as ts, ag as es, ah as rs, ai as as, aj as os, ak as zr, al as Wa } from "./resizable-C-htIGp4.js";
...
import { Check as cr, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as ns, ArrowRight as is, ChevronDown as lr, BoldIcon as ss, ItalicIcon as cs, X as Xa, AtSign as fn, Pencil as ls, Trash2 as ds, ArrowUp as mn, MoreHorizontal as ws, MailOpen as us, Mail as ps, ChevronUp as hs, FilterIcon as gs, ArrowLeftIcon as fs, ChevronLeftIcon as ms, ChevronRightIcon as vs, ArrowRightIcon as bs, Copy as vn, Filter as xs, User as ys, Link as ks, CircleHelp as _s, Undo as Ns, Redo as Cs, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Es, AlertCircle as Sa, CircleCheckIcon as Ts, CircleXIcon as zs, CircleHelpIcon as Ss, ArrowUpIcon as Ds, ArrowDownIcon as Rs, ScrollText as Ms, ChevronsUpDown as $s, MenuIcon as Os, Menu as As, EllipsisVertical as Is, MoreVertical as No } from "lucide-react";
import { Section as ht, getChaptersForBook as Ps, formatScrRef as Ne, getSectionForBook as xr, formatRelativeDate as Vs, formatReplacementString as Ye, sanitizeHtml as Ja, NumberFormat as js, formatBytes as Bs, getCurrentLocale as Ls, usfmMarkers as Vr, getFormatCallerFunction as Fs, deepEqual as Us, isString as Co, compareScrRefs as Da, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as Eo, collectUsjMarkers as qs } from "platform-bible-utils";
import $t, { useRef as U, useMemo as I, useState as _, useCallback as L, useEffect as J, useImperativeHandle as Gs, useLayoutEffect as Yt, createContext as Za, useContext as kn, Component as Hs, createElement as To, Suspense as Ys, forwardRef as _n, useId as zo, Fragment as Nn } from "react";
import { RadioGroup as Ra, ToggleGroup as Cn, Avatar as Qa, Select as Ft, Checkbox as So, Slot as Sr, Tabs as pe, Menubar as ye, ContextMenu as Ot, Progress as Do, Slider as Mr, Switch as Ro } from "radix-ui";
import { createEditor as En, $getRoot as Pe, $createParagraphNode as Dr, $getSelection as Qt, HISTORY_MERGE_TAG as to, ParagraphNode as Tn, TextNode as zn, $getPreviousSelection as Ws, $isRangeSelection as be, $caretFromPoint as Xs, $getSiblingCaret as Sn, $getChildCaret as Js, $getAdjacentChildCaret as Zs, $isChildCaret as Qs, $normalizeCaret as tc, $setSelectionFromCaretRange as ec, $getCollapsedCaretRange as rc, $getCaretInDirection as Mo, $splitAtPointCaretNext as ac, $isTextPointCaret as oc, $findMatchingParent as Dn, $isElementNode as Cr, mergeRegister as De, getDOMTextNode as nc, isHTMLElement as ic, CLEAR_EDITOR_COMMAND as Rn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as sc, defineExtension as ce, safeCast as Qe, createState as cc, FORMAT_TEXT_COMMAND as Mn, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as On, RootNode as lc, LineBreakNode as dc, TabNode as wc, $isEditorState as uc, createCommand as pc, CLICK_COMMAND as hc, isDOMNode as gc, $getNodeFromDOMNode as fc, $createNodeSelection as mc, $setSelection as vc, $getEditor as bc, DecoratorNode as Ma, $getState as xc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as yc, $setState as kc, addClassNamesToElement as An, $create as _c, $getNodeByKey as Nc, removeClassNamesFromElement as Cc, KEY_TAB_COMMAND as Ec, $isBlockElementNode as Tc, $createRangeSelection as zc, $normalizeSelection__EXPERIMENTAL as Sc, OUTDENT_CONTENT_COMMAND as Dc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Rc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Mc, $isParagraphNode as $c, $isTextNode as $a, SELECTION_CHANGE_COMMAND as In, $insertNodes as Oc } from "lexical";
...
import { useReactTable as Vn, getFilteredRowModel as Uc, getSortedRowModel as jn, getPaginationRowModel as Kc, getCoreRowModel as Bn, flexRender as yr, getGroupedRowModel as qc, getExpandedRowModel as Gc } from "@tanstack/react-table";
...
function wl({
  ...
  return /* @__PURE__ */ u(je, { open: w, onOpenChange: p, children: [
    /* @__PURE__ */ a(Xe, { asChild: !0, children: /* @__PURE__ */ a(
      H,
      {
        variant: l,
        size: "icon",
    ...
    /* @__PURE__ */ a(Be, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Je, { children: /* @__PURE__ */ a(Ze, { children: /* @__PURE__ */ a(Ee, { heading: i, children: t.map((g) => /* @__PURE__ */ u(
      Ve,
      {
        onSelect: () => h(g),
      ...
      if (s) {
        ...
        if (!w && d) {
          const g = ((f) => Object.keys(ue).find(
            (y) => ue[y].toLowerCase() === f.toLowerCase()
          ))(c);
...
function Kn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Ee, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function wa({
  ...
  const M = se(), [j, D] = _(!1), [P, $] = _(""), [E, B] = _(""), [O, T] = _("books"), [Y, W] = _(void 0), [F, V] = _(
    void 0
  ), [R, Z] = _(void 0), [at, Tt] = _(!1), St = U(null), Pt = U(!1), K = U(void 0), nt = U(void 0), gt = U(void 0), wt = U(void 0), xt = U({}), he = U({}), st = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Ut = I(() => o ? o() : Ki, [o]), yt = I(() => ({
    [ht.OT]: Ut.filter((X) => kt.isBookOT(X)),
    [ht.NT]: Ut.filter((X) => kt.isBookNT(X)),
    [ht.DC]: Ut.filter((X) => kt.isBookDC(X)),
    [ht.Extra]: Ut.filter((X) => kt.extraBooks().includes(X))
  }), [Ut]), oe = I(() => Object.values(yt).flat(), [yt]), te = I(() => {
    if (!E.trim()) return yt;
    const b = {
      [ht.OT]: [],
      [ht.NT]: [],
    ...
    return [ht.OT, ht.NT, ht.DC, ht.Extra].forEach((it) => {
      b[it] = yt[it].filter((jt) => Fa(jt, E, n));
    }), b;
  }, [yt, E, n]), S = I(
    () => fl(E, oe, n),
    [E, oe, n]
  ...
  const mt = L(() => {
    if (S) {
      const b = S.chapterNum ?? 1, X = S.verseNum ?? 1;
      if (w && da(S.book, b, X, w))
        return;
      st({
        book: S.book,
        chapterNum: b,
    ...
    (b) => {
      const X = F ?? (S == null ? void 0 : S.book), it = R ?? (S == null ? void 0 : S.chapterNum);
      !X || !it || (st({
        book: X,
        chapterNum: it,
        verseNum: b
    ...
    (b) => {
      const X = O === "chapters" ? Y : S == null ? void 0 : S.book;
      if (X) {
        if (l && l(X, b) > 1) {
          V(X), Z(b), T("verses"), $("");
          return;
    ...
    T("books"), W(void 0), V(void 0), Z(void 0), setTimeout(() => {
      nt.current && nt.current.focus();
    }, 0);
  }, []), Dt = L(() => {
    const b = F;
    V(void 0), Z(void 0), b ? (W(b), T("chapters"), $("")) : de();
  }, [F, de]), Vt = L((b) => {
    D(b), b && (T("books"), W(void 0), V(void 0), Z(void 0), B(""));
  }, []);
  J(() => {
    k && Vt(!1);
  }, [k, Vt]);
  ...
  J(() => {
    var b;
    ee !== 0 && ((b = nt.current) == null || b.focus());
  }, [ee]), Gs(
    N,
    () => ({
      open: () => {
  ...
  const { otLong: qt, ntLong: re, dcLong: Gt, extraLong: z } = {
    ...
    () => hl(E),
    [E]
  ), q = I(() => !l || !S || !S.chapterNum || !rt ? !1 : l(S.book, S.chapterNum) > 0, [l, S, rt]), lt = L(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), ut = L(
    (b) => (X) => w ? gl(b, X, w) : !1,
    ...
    (b, X) => (it) => w ? da(b, X, it, w) : !1,
    [w]
  ), Nt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ct = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", fe = L(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && S && S.chapterNum !== void 0 && S.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), mt());
    },
    [p, S, mt]
  ), Fe = L(
    (b) => {
      var _e, Ue, Me;
      if (b.ctrlKey) return;
      const { isLetter: X, isDigit: it } = Io(b.key);
      if ((O === "chapters" || O === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const It = (_e = K.current) == null ? void 0 : _e.querySelector(
      ...
      if ((O === "chapters" || O === "verses") && (X || it)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (O === "chapters" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), de();
        return;
      }
      ...
      if (O === "verses" && jt) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            ft !== 0 && (ne = ft > 1 ? ft - 1 : It);
            break;
          case "ArrowRight":
            ft !== 0 && (ne = ft < It ? ft + 1 : 1);
            break;
          case "ArrowUp":
            ne = ft === 0 ? It : Math.max(1, ft - ae);
            break;
          case "ArrowDown":
            ne = ft === 0 ? 1 : Math.min(It, ft + ae);
            break;
          default:
            return;
        }
        ne !== ft && (b.preventDefault(), b.stopPropagation(), $(
          `${At} ${ue[At] || ""} ${bt}:${ne}`
        ), setTimeout(() => {
          const Ke = he.current[ne];
          Ke && Ke.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((O === "chapters" || O === "books" && S) && jt) {
        const At = O === "chapters" ? Y : S == null ? void 0 : S.book;
        if (!At) return;
        O === "chapters" && ((Me = K.current) == null || Me.focus());
        const bt = (() => {
          if (!P) return 1;
          const ae = P.match(/(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            bt !== 0 && (ft = bt > 1 ? bt - 1 : It);
            break;
          case "ArrowRight":
            bt !== 0 && (ft = bt < It ? bt + 1 : 1);
            break;
          case "ArrowUp":
            ft = bt === 0 ? It : Math.max(1, bt - ne);
            break;
          case "ArrowDown":
            ft = bt === 0 ? 1 : Math.min(It, bt + ne);
            break;
          default:
            return;
        }
        ft !== bt && (b.preventDefault(), b.stopPropagation(), $(
          `${At} ${ue[At] || ""} ${ft}`
        ), setTimeout(() => {
          const ae = xt.current[ft];
    ...
    const { isLetter: X, isDigit: it } = Io(b.key);
    (X || it) && (b.preventDefault(), B((_e) => _e + b.key), nt.current.focus(), Tt(!1));
  }, []);
  return Yt(() => {
    const b = setTimeout(() => {
      if (j && O === "books" && gt.current && wt.current) {
        const X = gt.current, it = wt.current, jt = it.offsetTop, _e = X.clientHeight, Ue = it.clientHeight, Me = jt - _e / 2 + Ue / 2;
        X.scrollTo({
          top: Math.max(0, Me),
          behavior: "smooth"
        }), $(Un(t.book));
    ...
    if (O === "chapters" && Y) {
      const b = Y === t.book, X = b ? t.chapterNum : 1;
      $(
        `${Y} ${ue[Y] || ""} ${X}`
      ), setTimeout(() => {
        if (gt.current)
  ...
  }, [O, Y, S, t.book, t.chapterNum]), Yt(() => {
    if (O === "verses" && F && R !== void 0) {
      const b = F === t.book && R === t.chapterNum, X = b ? t.verseNum : 1;
      $(
        `${F} ${ue[F] || ""} ${R}:${X}`
      ), setTimeout(() => {
        if (gt.current)
          if (b) {
            const it = he.current[t.verseNum];
            it && it.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            gt.current.scrollTo({ top: 0 });
        K.current && K.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(je, { open: j, onOpenChange: Vt, modal: v, children: [
    /* @__PURE__ */ a(Xe, { asChild: !0, children: /* @__PURE__ */ a(
      H,
      {
        ref: St,
        ...
        children: h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Q })
      }
    ) }),
    /* @__PURE__ */ a(
      Be,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: X } = b;
          j && St.current && X instanceof Node && St.current.contains(X) && (Pt.current = !0, Vt(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          Je,
          {
            ...
            children: [
              O === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: le.map(
                  ({ onClick: b, disabled: X, title: it, icon: jt }) => /* @__PURE__ */ a(
                    H,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  H,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: O === "verses" ? Dt : de,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: M === "ltr" ? /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                O === "chapters" && Y && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Oe(Y, n) }),
                O === "verses" && F && R !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Oe(F, n)} ${R}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: O === "verses" ? Ct : Nt
                  }
                )
              ] }),
              !at && /* @__PURE__ */ u(Ze, { ref: gt, children: [
                O === "books" && /* @__PURE__ */ u(dt, { children: [
                  !S && Object.entries(te).map(([b, X]) => {
                    if (X.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ee, { heading: G(b), children: X.map((it) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: it,
                            onSelect: (jt) => Kt(jt),
                  ...
                  S && /* @__PURE__ */ a(Ee, { children: /* @__PURE__ */ a(
                    Ve,
                    {
                      value: `${S.book} ${ue[S.book]} ${S.chapterNum || ""}:${S.verseNum || ""})}`,
                      onSelect: mt,
                      disabled: !!w && da(
                        S.book,
                        S.chapterNum ?? 1,
                      ...
                      children: Ne(
                        ...
                        n ? La(S.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  S && q && S.chapterNum && l && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Oe(S.book, n)} ${S.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Vo,
                      {
                        ...
                        onVerseSelect: zt,
                        setVerseRef: x,
                        isVerseDisabled: vt(S.book, S.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  S && !q && ir(S.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Oe(S.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Po,
                      {
                        ...
                        setChapterRef: et,
                        isChapterDimmed: ot,
                        isChapterDisabled: ut(S.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                O === "chapters" && Y && /* @__PURE__ */ a(
                  Po,
                  {
                    bookId: Y,
                    scrRef: t,
...
function jo({
  ...
  const [k, M] = _(!1), j = l ?? d, D = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], P = ($, E) => {
  ...
  return /* @__PURE__ */ u(je, { open: k, onOpenChange: M, ...N, children: [
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        children: /* @__PURE__ */ u(Je, { children: [
          ...
          /* @__PURE__ */ a(Ze, { children: D(e) ? e.map(($) => /* @__PURE__ */ a(Ee, { heading: $.groupHeading, children: $.options.map((E) => P(E, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map(($) => P($)) }) })
        ] })
      }
    )
  ] });
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Gn ? Yt : J, Ar = { tag: to };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            ...
            (Qt() !== null || y !== null && y === p.getRootElement()) && f.select();
          }
        }, Ar);
...
const kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : J;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : J;
function Sl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Dl() {
  return function(t) {
    const [e] = ke(), r = I(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = U(o);
    return zl(() => {
...
function Il(t, e = Al) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), y = f.getKey(), v = h.offset, C = g.getNode(), N = C.getKey(), k = g.offset, M = t.getElementByKey(y), j = t.getElementByKey(N), D = r === null || M !== o || v !== n || y !== r.getKey(), P = i === null || j !== s || k !== c || N !== i.getKey();
      if ((D || P) && M !== null && j !== null) {
        const $ = function(E, B, O, T, Y, W, F) {
          const V = (E._window ? E._window.document : document).createRange();
          return V.setStart(...Bo(B, O, T)), V.setEnd(...Bo(Y, W, F)), V;
        }(t, h, f, M, g, C, j);
        d(), d = Ol(t, $, e);
      }
...
function jl(t) {
  const e = Qt() || Ws();
  let r;
  if (be(e)) r = Xs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Sn(c, "next"));
    }
    r = r || Js(Pe(), "previous").getFlipped().insert(Dr());
  }
...
function Bl(t, e, r) {
  ...
  return oc(o) && Hr(283), o.insert(t.isInline() ? Dr().append(t) : t), Mo(Sn(t.getLatest(), "next"), e.direction);
}
function Ll(t) {
  const e = Qt();
  if (!be(e)) return !1;
...
let Yr, Ce = 0, Wr = 0, Kl = 0, Pa = 0, Br = 0;
function Fo(t) {
  if (ct === void 0) return;
  let e = t.n;
...
function qe(t, e) {
  Lt.call(this, void 0), this.x = t, this.s = void 0, this.g = Br - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function ql(t, e) {
  return new qe(t, e);
}
...
Lt.prototype.brand = Fl, Lt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ce !== 0 && Wr === 0 && e.l !== Pa && (e.l = Pa, Yr = { S: e, v: e.v, i: e.i, o: Yr });
    })(this), this.v = t, this.i++, Br++, Ce++;
    try {
...
} }), qe.prototype = new Lt(), qe.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Xn(this), Uo(this), Ce++;
  const t = ct;
  return ct = this, Gl.bind(this, t);
...
ce({ build: (t, e, r) => fr(e), config: Qe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Jn() {
  const t = Pe(), e = Qt(), r = Dr();
  t.clear(), t.append(r), e !== null && r.select(), be(e) && (e.format = 0);
}
function Zn(t, e = Jn) {
  return t.registerCommand(Rn, (r) => (t.update(e), !0), eo);
}
ce({ build: (t, e, r) => fr(e), config: Qe({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
ce({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Mn, (o) => {
  const n = Qt();
  if ($n(n) || be(n)) for (const i of n.getNodes()) Yl(i) && i.toggleFormat(o);
  return !1;
}, On) });
function ti(t, e) {
  let r;
...
const Va = ce({ build: (t) => ti(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, ja = 1, ri = 2, ga = 3, Ir = 4, er = 5, fa = 6, vr = 7;
function ma(t) {
  return t.id === so;
}
function ai(t) {
...
class Jl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && pt(307, String(r.id), String(er)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const Ql = ce({ config: Qe({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class sr {
  ...
  static maybeFromEditor(e) {
    const r = e[qo];
    return r && (r.PACKAGE_VERSION !== va && pt(292, r.PACKAGE_VERSION, va), r instanceof sr || pt(293)), r;
  }
  static fromEditor(e) {
...
const ed = /* @__PURE__ */ new Set(), Ho = ce({ build(t, e, r) {
...
ce({ dependencies: [Va, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [dr], register(t, e, r) {
  ...
  return De(t.registerCommand(rd, (s) => {
    const c = Qt();
    if (!be(c)) return !1;
    ...
    if (gc(s.target)) {
      ...
      if (od(c)) return function(d, l = !1) {
        const w = Qt(), p = d.isSelected(), h = d.getKey();
        let g;
    ...
    Ul(() => {
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        h ? h.domNode.value = g : (d = !0, l.set(w, { domNode: Er(g), selectedSignal: o(w) }));
      }
...
ce({ build: (t, e) => fr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Qe({ $getParentEditor: function() {
  const t = bc();
...
ce({ build: (t, e, r) => fr(e), config: Qe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return xe(() => {
...
function nd(t, e, r = oi) {
  return De(t.registerCommand(Ec, (o) => {
    const n = Qt();
    if (!be(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
ce({ build: (t, e, r) => fr(e), config: Qe({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return xe(() => {
    if (!o.value) return nd(t, n, i);
  });
} });
const id = ce({ name: "@lexical/react/ReactProvider" });
function sd() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (be(f)) {
                const y = f.anchor;
                let v = y.getNode(), C = 0, N = 0;
                if ($a(v) && l >= 0 && w >= 0 && (C = l, N = l + w, f.setTextNodeRange(v, C, v, N)), C === N && p === "" || (f.insertRawText(p), v = y.getNode()), $a(v)) {
                  C = h, N = h + g;
...
ce({ build: (t, e, r) => fr(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => xe(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : J;
...
const fd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : J;
function md({ onClear: t }) {
  const [e] = ke();
  return fd(() => Zn(e, t), [e, t]), null;
}
const si = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : J;
function vd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: y, role: v = "textbox", spellCheck: C = !0, style: N, tabIndex: k, "data-testid": M, ...j }, D) {
...
function Ed({
  ...
  const [e] = ke(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Cd(), d = () => {
  };
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ a(
          yl,
          {
            ...
            children: /* @__PURE__ */ u(Wt, { children: [
...
function gi({
  ...
  return /* @__PURE__ */ u(Ka, { children: [
    /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
...
function Qu({
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(je, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(Xe, { asChild: !0, children: /* @__PURE__ */ u(
        H,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ a(
        Be,
        {
          ...
          children: /* @__PURE__ */ a(Je, { children: /* @__PURE__ */ a(Ze, { children: t.map((v) => /* @__PURE__ */ a(
            Ve,
            {
              onSelect: () => {
                d(v || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : uo(v) && (v.preventDefault(), v.stopPropagation(), ie(i) && g());
        },
        onKeyDown: (v) => {
...
function Zo({
  ...
  const g = L(
    (D) => {
      D && D.stopPropagation(), l(!1), p(void 0), s == null || s(!1);
    },
    [s]
  ), f = L(
    async (D) => {
    ...
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (D) => {
              D.stopPropagation(), l(!0), p($d(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (D) => {
                D.key === "Escape" ? (D.preventDefault(), D.stopPropagation(), g()) : uo(D) && (D.preventDefault(), D.stopPropagation(), ie(w) && f());
              },
              onKeyDown: (D) => {
        ...
        j && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ws, {}) }) }),
...
function xi({
  ...
  const [T, Y] = _(Qo), [W, F] = _(), [V, R] = _(), Z = o, [at, Tt] = _(!1), [St, Pt] = _(!1), [K, nt] = _(!1), [gt, wt] = _(!1), [xt, he] = _(!1), [st, Ut] = _(M), [yt, oe] = _(!1), te = U(void 0), [S, _t] = _(/* @__PURE__ */ new Map());
  J(() => {
    let x = !0;
    return (async () => {
      const q = N ? await N(d) : !1;
      x && he(q);
    })(), () => {
      x = !1;
    };
  ...
  J(() => {
    if (!o) {
      mt.current !== "idle" && (F(void 0), R(void 0), mt.current = "idle");
      return;
    }
    mt.current === "idle" && (mt.current = "pending"), gt ? mt.current === "pending" && P !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    P !== i && (F(P), mt.current = "auto-populated") : mt.current === "auto-populated" && (F(void 0), mt.current = "pending");
  }, [o, P, gt, i]);
  const zt = I(
  ...
  const Kt = I(() => zt[0], [zt]), Re = U(null), ge = U(void 0), le = L(() => {
    var x;
    (x = ge.current) == null || x.call(ge), Y(Qo);
  }, []), de = L(() => {
    const x = !st;
    Ut(x), oe(!x), f == null || f(d, x);
  }, [st, f, d]);
  J(() => {
    Tt(!1);
  }, [o]), J(() => {
    if (o && !st && !yt) {
      ...
      return te.current = x, () => clearTimeout(x);
    }
  ...
  const Dt = I(
    ...
    const x = Fr(i, r);
    return Ye(r["%comment_assigned_to%"], {
      assignedUser: x
    });
  }, [i, r]), ee = I(() => zt.slice(1), [zt]), Rt = I(() => ee.length ?? 0, [ee.length]), qt = I(() => Rt > 0, [Rt]), re = I(() => at || Rt <= 2 ? ee : ee.slice(-2), [ee, Rt, at]), Gt = I(() => at || Rt <= 2 ? 0 : Rt - 2, [Rt, at]), z = I(
    () => Rt === 1 ? Dt.singleReply : Ye(Dt.multipleReplies, { count: Rt }),
    [Rt, Dt]
  ), G = I(
    () => Gt === 1 ? Dt.singleReply : Ye(Dt.multipleReplies, { count: Gt }),
    [Gt, Dt]
  );
  J(() => {
    !o && St && qt && Pt(!1);
  ...
  const ot = L(
    async (x) => {
      ...
      rt && await p({ threadId: d, contents: rt }) && le();
    },
    [
      le,
      T,
    ...
    async (x) => {
      const rt = ie(T) ? Jr(T) : void 0, q = x.status ? x.assignedUser : W ?? x.assignedUser, lt = await p({
        ...x,
        contents: rt,
        assignedUser: q
      });
      return lt && (q !== void 0 && R(q), rt && le()), lt;
    },
    [le, T, p, W]
  );
  ...
  const et = /* @__PURE__ */ a(
    Zo,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Pt,
      canEditOrDelete: (!St && S.get(Kt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Pd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            Vt && /* @__PURE__ */ a(_r, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Vt }),
            /* @__PURE__ */ a(
              H,
              {
                variant: "ghost",
        ...
        /* @__PURE__ */ u(dt, { children: [
          qt && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          !o && ie(T) && /* @__PURE__ */ a(
            Xr,
            {
              ...
              onSerializedChange: (x) => Y(x),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(dt, { children: [
            O && re.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Gt > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (x) => {
                  x.stopPropagation(), Tt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (x) => {
                  (x.key === "Enter" || x.key === " ") && (x.preventDefault(), x.stopPropagation(), Tt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Nr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: G }),
                    at ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(lr, {})
                  ] })
                ]
              }
            ),
            re.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Zo,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: Pt,
                canEditOrDelete: (!St && S.get(x.id)) ?? !1
              }
            ) }, x.id)),
            v !== !1 && (!St || ie(T)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (x) => {
                  uo(x) && (x.preventDefault(), x.stopPropagation(), (ie(T) || W !== void 0 && W !== V) && ot());
                },
                onKeyDown: (x) => {
                  wo(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Xr,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    W !== void 0 && (ie(T) || W !== V) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ye(
                    ...
                    /* @__PURE__ */ u(je, { open: K, onOpenChange: nt, children: [
                      /* @__PURE__ */ a(Xe, { asChild: !0, children: /* @__PURE__ */ a(
                        H,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Be,
                        {
                          ...
                          children: /* @__PURE__ */ a(Je, { children: /* @__PURE__ */ a(Ze, { children: y == null ? void 0 : y.map((x) => /* @__PURE__ */ a(
                            Ve,
                            {
                              onSelect: () => {
                                F(x !== i ? x : void 0), mt.current = "user-selected", R(void 0), nt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Fr(x, r) })
                            },
                            x || "unassigned"
                          )) }) })
                        }
...
function Fd({
  ...
  const [s, c] = _("accept"), d = zo(), l = zo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, y = I(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = I(
    () => Ur(t.acceptedText ?? ""),
  ...
  const B = e["%conflict_note_no_result%"] ?? "No result preview available.", O = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: B }), T = (V) => V ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: V }) : O, Y = () => {
    const V = o ?? "accept";
    return V === "merged" ? t.mergedText ? /* @__PURE__ */ a(Kr, { html: C }) : O : T(V === "reject" ? t.rejectedResultText : t.resultText);
  }, W = (V) => p && V.value === "reject", F = (V) => {
    const R = f === V.value, Z = `${l}-${V.value}`, at = W(V);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: D.map((V) => W(V) ? /* @__PURE__ */ a(Wt, { delayDuration: 0, children: /* @__PURE__ */ u(Xt, { children: [
              /* @__PURE__ */ a(Jt, { asChild: !0, children: F(V) }),
              /* @__PURE__ */ a(Zt, { children: M })
            ] }) }, V.value) : F(V))
          }
        ),
        /* @__PURE__ */ a(Wt, { delayDuration: 0, children: /* @__PURE__ */ u(Xt, { children: [
...
function sp({
  ...
  const [N, k] = _(/* @__PURE__ */ new Set()), [M, j] = _(), [D, P] = _(), $ = L(
    async (R) => {
      const Z = await i(R);
  ...
  const E = r.filter(
    ...
    (R) => {
      k((Z) => new Set(Z).add(R.id)), j(R.id), y == null || y(R.id);
    },
    [y]
  ), T = L(
    (R) => {
      ...
      k((at) => {
        const Tt = new Set(at);
        return Tt.has(R) ? Tt.delete(R) : Tt.add(R), Tt;
      }), j(R), y == null || y(Z ? void 0 : R);
    },
    [N, y]
  ), { listboxRef: Y, activeId: W, handleKeyDown: F } = qi({
    options: B,
    onOptionSelect: O
  }), V = L(
    (R) => {
      R.key === "Escape" ? (M && N.has(M) && (k((Z) => {
        const at = new Set(Z);
        return at.delete(M), at;
      }), j(void 0), y == null || y(void 0)), R.preventDefault(), R.stopPropagation()) : F(R);
    },
    [M, N, F, y]
  );
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      tabIndex: 0,
      ref: Y,
      "aria-activedescendant": W ?? void 0,
      "aria-label": "Comments",
      className: m(
...
function Yd({ table: t }) {
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function pr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ft.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ft.Icon, { asChild: !0, children: /* @__PURE__ */ a(Wc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
      ...
      /* @__PURE__ */ u(
        wr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(hr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(we, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Qd({
  ...
  var D;
  const [w, p] = _([]), [h, g] = _([]), [f, y] = _({}), [v, C] = _({}), N = I(() => e ?? [], [e]), k = Vn({
    data: N,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  let j;
  return d ? j = Array.from({ length: 10 }).map((E, B) => `skeleton-row-${B}`).map((E) => /* @__PURE__ */ a(Ae, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(nr, { colSpan: M.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(or, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((D = k.getRowModel().rows) == null ? void 0 : D.length) > 0 ? j = k.getRowModel().rows.map((P) => /* @__PURE__ */ a(
    Ae,
    {
      onClick: () => s(P, k),
      "data-state": P.getIsSelected() && "selected",
      children: P.getVisibleCells().map(($) => /* @__PURE__ */ a(nr, { children: yr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    P.id
  )) : j = /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(nr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Yd, { table: k }),
    /* @__PURE__ */ u(Ga, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ha, { stickyHeader: i, children: k.getHeaderGroups().map((P) => /* @__PURE__ */ a(Ae, { children: P.headers.map(($) => /* @__PURE__ */ a(qr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : yr($.column.columnDef.header, $.getContext()) }, $.id)) }, P.id)) }),
...
function up({
  ...
  return /* @__PURE__ */ u(je, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ a(Xe, { asChild: !0, children: o }),
...
function pp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "default", children: [
...
function nw(t, e, r) {
  var o;
  return t.key === "Shift" || t.key === "Control" || t.key === "Alt" || t.key === "Meta" ? "passed" : t.ctrlKey || t.metaKey || t.altKey ? (r.dismiss(), "ended") : t.key === "ArrowDown" || t.key === "ArrowUp" ? (rr(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue") : t.key === "Enter" ? (rr(t), r.commit(), "ended") : t.key === "Escape" ? (rr(t), r.dismiss(), "ended") : e.kind === "backslash" && (t.key === " " || t.key === "*") ? t.key === " " && ((o = e.shouldSpaceCommit) != null && o.call(e, e.filter)) ? (rr(t), r.commit(), "ended") : (r.dismiss(), "ended") : e.kind === "backslash" && t.key === "Backspace" && e.filter === "" ? (r.dismiss(), "ended") : t.key === "Backspace" || ow[e.kind].test(t.key) ? (e.kind !== "backslash" && rr(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && rr(t), r.dismiss(), "ended");
}
function en(t, e) {
  var r;
...
function sw({
  ...
  return /* @__PURE__ */ u(Ka, { children: [
    ...
    e && /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(
        H,
        {
          "aria-label": w,
...
function dw({
  ...
  return /* @__PURE__ */ u(Te, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: lw(t, n, r) }) }) }),
...
function pw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: ww(t, r) }) }) }),
...
function fw({
  ...
  return /* @__PURE__ */ u(Je, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ze, { children: [
      ...
      /* @__PURE__ */ a(Ee, { children: s.map((d) => {
        var l;
        return /* @__PURE__ */ a(
          an,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(Ee, { children: c.map((d) => {
          var l;
          return /* @__PURE__ */ a(
            an,
            {
...
function mp({
  ...
  Yt(() => {
    if (!y.current) return;
    const { width: z } = y.current.getBoundingClientRect();
    z > 0 && (y.current.style.width = `${z}px`);
  }, []);
  const [v, C] = _("generated"), [N, k] = _("generated"), [M, j] = _("*"), [D, P] = _("*"), [$, E] = _("f"), [B, O] = _(!1), [T, Y] = _(!0), [W, F] = _(!1), V = U(!1), R = U(""), [Z, at] = _(!1), [Tt, St] = _(), [Pt, K] = _(), [nt, gt] = _(), [wt, xt] = _(), he = U(null), st = U(void 0), Ut = U(0), yt = I(
    () => ({
      ...c,
    ...
    [c, d]
  ), oe = U((re = yt.view) == null ? void 0 : re.markerMode);
  Yt(() => {
    var z;
    oe.current = (z = yt.view) == null ? void 0 : z.markerMode;
  });
  const te = I(
    () => mw(
      h,
  ...
  J(() => {
    var z;
    Z || (z = h.current) == null || z.focus();
  }, [$, Z]);
  const S = L(() => {
    var Q, et, x;
    const z = (Q = g.current) == null ? void 0 : Q.querySelector(".editor-input"), G = z == null ? void 0 : z.querySelector("span.note"), ot = (x = (et = g.current) == null ? void 0 : et.ownerDocument.getSelection()) == null ? void 0 : x.anchorNode;
    return !!G && !!ot && G.contains(ot);
  }, []);
  J(() => {
    var et, x;
    let z, G, ot;
    ...
    if (Q && $r("note", Q)) {
      const rt = (et = Q.insert.note) == null ? void 0 : et.caller;
      let q = "custom";
      rt === Oa ? q = "generated" : rt === Aa ? q = "hidden" : rt && (j(rt), P(rt)), C(q), k(q), E(((x = Q.insert.note) == null ? void 0 : x.style) ?? "f"), z = setTimeout(() => {
        var ut, vt, Nt;
        const lt = oe.current === "editable" ? [{ retain: kw }, Q] : [Q];
        (ut = h.current) == null || ut.applyUpdate(lt), (vt = h.current) == null || vt.selectNote(0), (Nt = h.current) == null || Nt.focus(), G = requestAnimationFrame(() => {
          ot = setTimeout(() => {
            var Ct, fe;
            S() || ((Ct = h.current) == null || Ct.selectNote(0), (fe = h.current) == null || fe.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      z && clearTimeout(z), G !== void 0 && cancelAnimationFrame(G), ot !== void 0 && clearTimeout(ot);
    };
  }, [e, i, s, S]);
  const _t = L(
    (z, G, ot = !1) => {
      var et, x, rt;
      const Q = (x = (et = h.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : x.at(0);
      if (Q && $r("note", Q)) {
        if (Q.insert.note) {
          let q;
          z === "custom" ? q = G : z === "generated" ? q = Oa : q = Aa, Q.insert.note.caller = q;
        }
        r == null || r([Q]), ot && w && i && ((rt = w.current) == null || rt.replaceEmbedUpdate(i, [Q]));
      }
    },
    [i, r, w]
  ), mt = L(() => {
    var z;
    st.current || (z = h.current) == null || z.commitPendingMarkerEdits(), _t(v, M, !0), o();
  }, [v, M, o, _t]), zt = U(mt);
  Yt(() => {
    zt.current = mt;
  });
  const Kt = U({ book: n.book, chapterNum: n.chapterNum });
  Yt(() => {
    (Kt.current.book !== n.book || Kt.current.chapterNum !== n.chapterNum) && (Kt.current = { book: n.book, chapterNum: n.chapterNum }, zt.current());
  }, [n.book, n.chapterNum]);
  const Re = () => {
    var G;
    const z = (G = g.current) == null ? void 0 : G.getElementsByClassName("editor-input")[0];
    ...
    var ot, Q, et, x, rt;
    E(z);
    const G = (Q = (ot = h.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : Q.at(0);
    if (G && $r("note", G)) {
      G.insert.note && (G.insert.note.style = z);
      const q = (x = (et = G.insert.note) == null ? void 0 : et.contents) == null ? void 0 : x.ops;
      $ !== "x" && z === "x" ? q == null || q.forEach((lt) => bw(lt)) : $ === "x" && z !== "x" && (q == null || q.forEach((lt) => xw(lt))), (rt = h.current) == null || rt.applyUpdate([G, { delete: 1 }]);
    }
  }, Dt = (z) => {
    xt(z.contextMarker), F(z.canRedo);
  }, Vt = L(
    (z) => {
      var ot, Q, et, x, rt;
      const G = (Q = (ot = h.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : Q.at(0);
      if (G && $r("note", G)) {
        z.content.length > 1 && setTimeout(() => {
          var ut;
          (ut = h.current) == null || ut.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const q = (et = G.insert.note) == null ? void 0 : et.style, lt = (rt = (x = G.insert.note) == null ? void 0 : x.contents) == null ? void 0 : rt.ops;
        if (q || O(!1), O(
          q === "x" ? !!(lt != null && lt.every((ut) => {
            var Nt, Ct;
            if (!((Nt = ut.attributes) != null && Nt.char)) return !0;
            const vt = ((Ct = ut.attributes) == null ? void 0 : Ct.char).style;
          ...
          V.current = !0, R.current = JSON.stringify(G), Y(!0);
          return;
        }
        Y(JSON.stringify(G) === R.current), _t(v, M);
      } else
        O(!1), Y(!0);
    },
    [v, M, _t]
    ...
    if (f.current && te.length && z && z.rangeCount > 0) {
      const G = z.getRangeAt(0).getBoundingClientRect(), ot = f.current.getBoundingClientRect();
      St(G.left - ot.left), K(G.top - ot.top), gt(G.height), at(!0);
    }
  }, [te, f]), Rt = L(
    (z, G, ot) => {
      const { anchorRect: Q } = z;
      if (!p || !Q) return;
      const { passive: et, literalPrefixLanded: x } = ot;
      Ut.current += 1;
      const rt = Ut.current;
      st.current = {
        kind: et ? "backslash" : "selection",
        token: rt,
        literalPrefixLanded: x,
        filter: "",
        items: G
      }, p.show(G.map(vw), Q, et).then((q) => {
        var lt, ut, vt;
        if (en(st, rt), q !== void 0) {
          const Nt = G.find((Ct) => Ct.marker === q);
          Nt && ((lt = h.current) == null || lt.applyMarkerMenuSelection(Nt, {
            trigger: "backslash",
            literalPrefixLanded: x
          })), (ut = h.current) == null || ut.focus();
        } else et || (vt = h.current) == null || vt.focus();
      }).catch(() => {
        var q;
        en(st, rt), et || (q = h.current) == null || q.focus();
      });
    },
    [p]
  );
  J(() => {
    ...
    var z;
    Z && ((z = he.current) == null || z.focus());
  }, [Z]), J(() => {
    var ot, Q;
    const z = ((ot = g.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0;
    if (((Q = yt.view) == null ? void 0 : Q.markerMode) === "editable") {
      const et = (x) => {
        ...
        const rt = st.current;
        if (rt && p) {
          nw(x, rt, p) === "ended" && (st.current = void 0);
          return;
        }
        if (x.key === "Enter" && !S()) {
          x.preventDefault(), x.stopPropagation(), (vt = h.current) == null || vt.selectNote(0), (Nt = h.current) == null || Nt.focus();
          return;
        }
        if (!p || x.key !== d) return;
        if (!S()) {
          x.preventDefault(), x.stopPropagation(), (Ct = h.current) == null || Ct.selectNote(0), (fe = h.current) == null || fe.focus();
          return;
        }
        const q = (Fe = h.current) == null ? void 0 : Fe.getMarkerMenuContext();
        if (!q) return;
        const lt = il(yt.styleInfo ?? sl, q);
        if (lt.length === 0) return;
        const ut = !q.hasTextSelection;
        ut || (x.preventDefault(), x.stopPropagation()), Rt(q, lt, { passive: ut, literalPrefixLanded: ut });
      };
    ...
    const G = (et) => {
      !Z && z && document.activeElement === z && et.key === d ? (et.preventDefault(), ee()) : Z && et.key === "Escape" && (et.preventDefault(), at(!1));
    };
    ...
    ee,
    d,
    (Gt = yt.view) == null ? void 0 : Gt.markerMode,
    yt.styleInfo,
    p,
    Rt,
    S
    ...
    var ot;
    const z = ((ot = g.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0, G = () => {
      var Q, et;
      !z || document.activeElement !== z || S() || ((Q = h.current) == null || Q.selectNote(0), (et = h.current) == null || et.focus());
    };
    return document.addEventListener("pointerup", G), document.addEventListener("selectionchange", G), () => {
      document.removeEventListener("pointerup", G), document.removeEventListener("selectionchange", G);
    };
  }, [S]);
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(Ka, { children: [
          /* @__PURE__ */ a(
            sw,
            {
              onUndoClick: () => {
                var z;
                return (z = h.current) == null ? void 0 : z.undo();
              },
              onRedoClick: () => {
                var z;
                return (z = h.current) == null ? void 0 : z.redo();
              },
              canUndo: !T,
              canRedo: W,
              localizedStrings: l
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
              /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(
                H,
                {
                  "aria-label": qt,
              ...
              /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ a("p", { children: qt }) })
            ] }) }) })
          ]
        }
      )
...
function Cw({
  ...
  /* @__PURE__ */ u("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    po(t.marker, [s], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", f = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", y = m(h, g);
  return /* @__PURE__ */ u(dt, { children: [
...
function bp({
  ...
  const w = d ?? Fs(r, void 0), p = (N, k) => {
    l == null || l(N, k, n);
  }, h = i ? r.findIndex((N) => N === i) : -1, [g, f] = _(h), y = (N, k, M) => {
    if (r.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
function Tw({
  ...
  return /* @__PURE__ */ u(Ga, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ha, { stickyHeader: !0, children: /* @__PURE__ */ u(Ae, { children: [
    ...
    /* @__PURE__ */ a(Ya, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ae,
      {
        ...
        children: [
          /* @__PURE__ */ a(nr, { children: Ne(c.reference, "English") }),
          /* @__PURE__ */ a(nr, { className: o, children: Ew(c.text) })
        ]
      },
...
const zw = (t) => {
...
}, oa = (t, e, r) => /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
  /* @__PURE__ */ u(
    Jt,
    {
  ...
  return e ? e[1] : "";
}, Dw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ep = Object.freeze([
...
function Tp({
  ...
  const g = me(r, "%webView_inventory_all%"), f = me(r, "%webView_inventory_approved%"), y = me(r, "%webView_inventory_unapproved%"), v = me(r, "%webView_inventory_unknown%"), C = me(r, "%webView_inventory_scope_currentBook%"), N = me(r, "%webView_inventory_scope_chapter%"), k = me(r, "%webView_inventory_scope_verse%"), M = me(r, "%webView_inventory_filter_text%"), j = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), D = me(r, "%webView_inventory_no_results%"), [P, $] = _(!1), [E, B] = _("all"), [O, T] = _(""), [Y, W] = _([]), F = I(() => {
    const K = t ?? [];
  ...
  }, [P, F]), R = I(() => V.length === 0 ? [] : Rw(V, E, O), [V, E, O]), Z = I(() => {
    var gt, wt;
    if (!P) return d;
  ...
  J(() => {
    R.length === 0 ? W([]) : R.length === 1 && W(R[0].items);
  }, [R]);
  const at = (K, nt) => {
    nt.setRowSelection(() => {
      const wt = {};
    ...
    if (V.length === 0 || Y.length === 0) return [];
    const K = V.filter((nt) => Us(
      P ? nt.items : [nt.items[0]],
      Y
    ));
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
...
const $w = "16rem", Ow = "3rem", _i = $t.createContext(void 0);
function na() {
  const t = $t.useContext(_i);
  if (!t)
...
function Aw({
  ...
  const [d, l] = $t.useState(t), w = e ?? d, p = $t.useCallback(
    (k) => {
      const M = typeof k == "function" ? k(w) : k;
      r ? r(M) : l(M);
    },
    [r, w]
  ), h = $t.useCallback(() => p((k) => !k), [p]), g = w ? "expanded" : "collapsed", v = se() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = $t.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Fw({
  ...
  return n ? /* @__PURE__ */ u(Xt, { children: [
    /* @__PURE__ */ a(Jt, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      Zt,
      {
        side: "right",
...
function Pp({
  ...
  const [o] = $t.useState(() => `${Math.floor(Math.random() * 40) + 50}%`), n = { "--skeleton-width": o };
  return /* @__PURE__ */ u(
    "div",
    {
...
const $e = "scrBook", Kw = "scrRef", Ge = "source", qw = "details", Gw = "Scripture Reference", Hw = "Scripture Book", Ni = "Type", Yw = "Details";
function Ww(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? kt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === $e ? Ne(n.start) : void 0;
      },
...
function Fp({
  ...
  const [l, w] = _([]), [p, h] = _([{ id: $e, desc: !1 }]), [g, f] = _({}), y = I(
  ...
  J(() => {
    if (c) {
      ...
      if (B.length === 1) {
        const O = y.find((T) => cn(T) === B[0]) || void 0;
        O && c(O);
      }
    }
  }, [g, y, c, C]);
    ...
    !e && /* @__PURE__ */ u(
      wr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: M.map((E) => /* @__PURE__ */ a(we, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ga, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ha, { children: C.getHeaderGroups().map((E) => /* @__PURE__ */ a(Ae, { children: E.headers.filter((B) => B.column.columnDef.header).map((B) => (
        ...
        /* @__PURE__ */ a(qr, { colSpan: B.colSpan, className: "tw:sticky top-0", children: B.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          yr(B.column.columnDef.header, B.getContext())
        ] }) }, B.id)
      )) }, E.id)) }),
...
function Jw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [y, v] = _(!1), [C, N] = _(""), k = U(void 0), M = U(!1), j = I(
    () => Ci(t),
    [t]
  ), D = I(() => {
    if (!C.trim()) {
    ...
    (T, Y = !1) => {
      if (!Y || !k.current) {
        r(
          e.includes(T) ? e.filter((at) => at !== T) : [...e, T]
        ), k.current = T;
        return;
      }
      const W = j.findIndex((at) => at === k.current), F = j.findIndex((at) => at === T);
      if (W === -1 || F === -1) return;
      const [V, R] = [
        Math.min(W, F),
        Math.max(W, F)
      ], Z = j.slice(V, R + 1).map((at) => at);
      r(
        e.includes(T) ? e.filter((at) => !Z.includes(at)) : [.../* @__PURE__ */ new Set([...e, ...Z])]
      );
    },
    [e, r, j]
  ), $ = (T) => {
    ...
    T.preventDefault(), P(Y, T.shiftKey);
  }, B = () => {
    r(j.map((T) => T));
  }, O = () => {
    r([]);
  ...
  return /* @__PURE__ */ u(
    je,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(Be, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Je,
          {
            shouldFilter: !1,
            onKeyDown: (T) => {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(H, { variant: "ghost", size: "sm", onClick: B, children: d }),
                /* @__PURE__ */ a(H, { variant: "ghost", size: "sm", onClick: O, children: l })
              ] }),
              /* @__PURE__ */ u(Ze, { children: [
                /* @__PURE__ */ a(Ua, { children: w }),
                Object.values(ht).map((T, Y) => {
                  const W = D[T];
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(Nn, { children: [
                      ...
                      Y < Object.values(ht).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, T);
                })
              ] })
            ]
...
function Kp({
  ...
  const M = Mt(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = Mt(s, "%webView_scope_selector_verse%"), D = Mt(s, "%webView_scope_selector_chapter%"), P = Mt(s, "%webView_scope_selector_book%"), $ = Mt(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = Mt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), B = Mt(s, "%webView_scope_selector_current_book%"), O = Mt(s, "%webView_scope_selector_choose_books%"), T = Mt(s, "%webView_scope_selector_scope%"), Y = Mt(s, "%webView_scope_selector_select_books%"), W = Mt(s, "%webView_scope_selector_range%"), F = Mt(s, "%webView_scope_selector_select_range%"), V = Mt(s, "%webView_scope_selector_range_start%"), R = Mt(s, "%webView_scope_selector_range_end%"), Z = Mt(s, "%webView_scope_selector_ok%"), at = Mt(s, "%webView_scope_selector_cancel%"), Tt = Mt(s, "%webView_scope_selector_navigate%"), St = (A) => {
    if (!f) return;
  ...
  ], K = (A, tt, Ht = !1) => /* @__PURE__ */ u(dt, { children: [
    A,
    tt && !Ht && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), nt = e ? Pt.filter((A) => e.includes(A.value)) : Pt, gt = f ?? la, wt = w ?? gt, xt = p ?? gt, he = () => {
  }, st = U(null), Ut = U(null), yt = U(!1), oe = U(null), te = U(!1), [S, _t] = _(void 0), mt = U(!1), zt = U(!1), Kt = U(null), Re = L((A) => {
    if (A) {
      _t("start"), mt.current = !1;
      return;
    }
    _t((tt) => tt === "start" ? void 0 : tt), mt.current && (mt.current = !1, requestAnimationFrame(() => {
      var Ht;
      const tt = (Ht = st.current) == null ? void 0 : Ht.querySelector("button");
      tt == null || tt.click();
    }));
  }, []), ge = L((A) => {
    if (A) {
    ...
    (A) => {
      h == null || h(A), g == null || g(A), mt.current = !0;
    },
    [h, g]
  ), de = L(
    (A) => {
    ...
    [r, n, f, i]
  ), Vt = nt.find((A) => A.value === t), ee = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Ks(wt, xt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Vt ? K(Vt.label, Vt.scrRefSuffix) : t, Rt = nt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), qt = nt.find((A) => A.value === "selectedBooks"), re = nt.find((A) => A.value === "range"), [Gt, z] = _(!1), [G, ot] = _(void 0), [Q, et] = _(void 0), [x, rt] = _(void 0), [q, lt] = _(void 0), [ut, vt] = _([]), Nt = l === "dropdown" && G === "selectedBooks", Ct = /* @__PURE__ */ a(
    Qw,
    {
      availableBookInfo: o,
      selectedBookIds: Nt ? ut : n,
      onChangeSelectedBookIds: Nt ? vt : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), fe = S === "end", Fe = S === "start", tr = "tw:text-muted-foreground", b = l === "dropdown" && G === "range", X = b ? rt : le, jt = b ? lt : g ? de : he, _e = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: m(fe && tr), children: V }),
      /* @__PURE__ */ a(
        wa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: st, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Fe && tr), children: R }),
      /* @__PURE__ */ a(
        wa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: C,
          disableReferencesUpTo: b ? x ?? wt : wt,
          onOpenChange: ge,
          onCloseAutoFocus: (A) => {
            var tt;
            zt.current && (zt.current = !1, A.preventDefault(), (tt = Kt.current) == null || tt.focus());
          },
          className: m(Fe && tr),
          modal: !0,
          align: "start"
  ...
  const [bt, It] = _(null), [ft, ne] = _(null), [ae, Ke] = _(null), Oi = 200, [Ai, Ii] = _(!1);
  J(() => {
    if (!ae || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([tt]) => {
      Ii(tt.contentRect.width < Oi);
    });
    return A.observe(ae), () => A.disconnect();
  }, [ae]);
  const go = L(
    (A) => {
      et(A), rt(wt), lt(xt), vt(n), z(!1), ot(A);
    },
    [wt, xt, n]
  ), fo = L(() => {
    Q !== void 0 && (Q === "range" ? (x && (h == null || h(x)), q && (g == null || g(q))) : Q === "selectedBooks" && i(ut), Dt(Q), ot(void 0), et(void 0));
  }, [
    Q,
    x,
    q,
    ...
    A || (ot(void 0), et(void 0));
  }, []), mo = L((A) => {
    var tt;
    A.preventDefault(), (tt = At.current) == null || tt.focus();
  }, []), vo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(cr, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !N && /* @__PURE__ */ a(Et, { children: T }),
      l === "dropdown" ? /* @__PURE__ */ u(Te, { open: Gt, onOpenChange: z, children: [
        ...
        /* @__PURE__ */ a(
          Se,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ia, { container: ae, children: [
              Rt.map(({ value: A, label: tt, dropdownLabel: Ht, scrRefSuffix: mr, id: Pi }) => /* @__PURE__ */ u(
                He,
                {
                  ref: Me(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(cr, { className: "tw:h-4 tw:w-4" }) }),
                    K(Ht ?? tt, mr, Ai)
                  ]
                },
                Pi
                ...
                /* @__PURE__ */ a(
                  He,
                  {
                    ...
                    onSelect: (A) => {
                      ...
                      te.current || (Ht = (tt = Ut.current) == null ? void 0 : tt.querySelector("button")) == null || Ht.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          tt != null && tt.closest("button") && (yt.current = !0, requestAnimationFrame(() => {
                            yt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          wa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var tt;
                              A.preventDefault(), (tt = oe.current) == null || tt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(dt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ne(f ?? la, "id") }),
                              /* @__PURE__ */ a(lr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        ao,
        {
          ...
          children: nt.map(({ value: A, label: tt, scrRefSuffix: Ht, id: mr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: mr }),
            /* @__PURE__ */ a(Et, { htmlFor: mr, children: K(tt, Ht) })
          ] }, mr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && _e,
    l === "dropdown" && qt && /* @__PURE__ */ a(_a, { open: G === "selectedBooks", onOpenChange: Rr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: ne,
        onCloseAutoFocus: mo,
        ...
        children: /* @__PURE__ */ u(ia, { container: ft, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Rr(!1), children: at }),
            /* @__PURE__ */ a(H, { onClick: fo, children: Z })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && re && /* @__PURE__ */ a(_a, { open: G === "range", onOpenChange: Rr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: It,
        onCloseAutoFocus: mo,
        onEscapeKeyDown: (A) => {
          bt != null && bt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(ia, { container: bt, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Rr(!1), children: at }),
            /* @__PURE__ */ a(H, { ref: Kt, onClick: fo, children: Z })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          hr,
          {
            ...
            style: { zIndex: gr },
            children: t.map((w) => /* @__PURE__ */ a(we, { value: `${w}`, children: d[Eo(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(Xt, { children: [
...
function Ba({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(H, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Os, {}) }) }),
    /* @__PURE__ */ a(Se, { align: "start", style: { zIndex: gr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Nn, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Wt, { children: zi(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(We, {})
    ] }, d)) })
  ] });
}
const Si = $t.forwardRef(
...
const Di = $t.forwardRef(({ className: t, ...e }, r) => {
  const o = se();
  return /* @__PURE__ */ a(
    pe.Root,
    {
...
const Ri = $t.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.List,
  {
    ref: r,
    className: m(
...
const ru = $t.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Trigger,
  {
    ref: r,
    ...e,
...
)), Mi = $t.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Content,
  {
    ref: r,
    className: m(
...
function Jp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Di, { children: [
      /* @__PURE__ */ a(Ri, { children: t.map((c) => /* @__PURE__ */ a(ru, { value: c.value, children: c.value }, c.key)) }),
...
const br = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        cu,
        {
          onClick: () => {
            o(l);
      ...
      l.tooltip && /* @__PURE__ */ a(Zt, { children: l.tooltip })
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), br(s, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), br(c, [h, g]);
        break;
      case "alt+h":
        (C = d.current) == null || C.focus(), br(d, [h, g]);
        break;
    }
  }), J(() => {
    ...
    return /* @__PURE__ */ a(au, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(ou, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: gr },
          children: /* @__PURE__ */ a(Wt, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function th({
  ...
  const l = hu(
    ...
    var C, N, k, M, j, D;
    const v = y !== f ? ((N = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : N[y]) ?? ((M = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : M.en) : void 0;
    return v ? `${(j = t[f]) == null ? void 0 : j.autonym} (${v})` : (D = t[f]) == null ? void 0 : D.autonym;
  };
  return /* @__PURE__ */ u("div", { id: d, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: Ye(l, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(ze, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(H, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
...
function vh({
  ...
  return /* @__PURE__ */ u(
    Ot.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Ot.ItemIndicator, { children: /* @__PURE__ */ a(ra, {}) }) }),
        e
      ]
    }
  );
