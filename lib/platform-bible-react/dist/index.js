...
import W, { forwardRef as Eo, useCallback as Se, useState as ce, useRef as _t, useEffect as He, useLayoutEffect as ha, useMemo as Mt } from "react";
import { History as Fl, ChevronRight as Ci, Check as No, Circle as Vl, ArrowDownWideNarrow as zl, Clock as Ul, Bookmark as Hl, FilterIcon as Gl, ChevronDown as gn, ChevronUp as Wl, ArrowLeftIcon as Xl, ChevronLeftIcon as Yl, ChevronRightIcon as ql, ArrowRightIcon as Kl, ArrowUpIcon as Jl, ArrowDownIcon as Zl, ArrowUpDownIcon as Ql, CircleCheckIcon as ga, CircleXIcon as ba, CircleHelpIcon as va, X as ec, Search as tc, ChevronsUpDown as rc, ChevronLeft as nc, LoaderCircle as bn, Download as oc, Filter as ac, User as ic, Link as sc, CircleHelp as lc } from "lucide-react";
import Ce, { clsx as cc } from "clsx";
import { extendTailwindMerge as pc } from "tailwind-merge";
import * as ge from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as dc } from "@radix-ui/react-dropdown-menu";
import { getChaptersForBook as uc, compareScrRefs as io, scrRefToBBBCCCVVV as Vn, formatScrRef as zn, NumberFormat as fc, formatBytes as mc } from "platform-bible-utils";
import { useReactTable as Oi, getCoreRowModel as Ri, getPaginationRowModel as hc, getSortedRowModel as Pi, getFilteredRowModel as gc, flexRender as kr, getExpandedRowModel as bc, getGroupedRowModel as vc } from "@tanstack/react-table";
import { Slot as yc } from "@radix-ui/react-slot";
import { cva as To } from "class-variance-authority";
import * as xe from "@radix-ui/react-select";
import { FormControlLabel as ya, FormLabel as wc, Checkbox as xc, MenuItem as kc, ListItemText as Ec, ListItemIcon as $i, Menu as Nc, Grid as _i, List as Tc, IconButton as Ii, Drawer as Sc, Slider as Cc, Snackbar as Oc, Switch as Rc, AppBar as Pc, Toolbar as $c } from "@mui/material";
import * as Or from "@radix-ui/react-popover";
import { Command as Ae } from "cmdk";
import * as Qe from "@radix-ui/react-dialog";
import _c, { ThemeContext as Ic, internal_processStyles as Mc } from "@mui/styled-engine";
...
var Bc = Object.defineProperty, Lc = (e, t, r) => t in e ? Bc(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => Lc(e, typeof t != "symbol" ? t + "" : t, r);
const At = [
  "GEN",
  "EXO",
  "LEV",
...
const Ro = ge.Root, Vi = ge.Trigger, Kc = ge.Group, Rv = ge.Portal, Pv = ge.Sub, $v = ge.RadioGroup, Jc = W.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ _(
  ge.SubTrigger,
  {
    ref: o,
    className: z(
...
const Zc = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ge.SubContent,
  {
    ref: r,
    className: z(
...
const yn = W.forwardRef(({ className: e, sideOffset: t = 4, ...r }, n) => /* @__PURE__ */ d(ge.Portal, { children: /* @__PURE__ */ d(
  ge.Content,
  {
    ref: n,
    sideOffset: t,
...
const jr = W.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ d(
  ...
  {
    ref: n,
    className: z("pr-px-2 pr-py-1.5 pr-text-sm pr-font-semibold", t && "pr-pl-8", e),
    ...r
  }
));
jr.displayName = ge.Label.displayName;
const wn = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ge.Separator,
  {
    ref: r,
    className: z("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
    ...t
  }
));
...
function Qc({ className: e, ...t }) {
  return /* @__PURE__ */ d(
    "span",
    {
      className: z("pr-ml-auto pr-text-xs pr-tracking-widest pr-opacity-60", e),
      ...t
    }
  );
}
...
const ep = Eo(
  ({
    ...
    zi,
    {
      ref: l,
      textValue: e,
      className: z("pr-font-normal pr-text-slate-700", {
...
function tp({
  ...
  return /* @__PURE__ */ d("div", { className: z("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: a.map((l) => /* @__PURE__ */ d(
    "div",
    {
      className: z(
...
function rp({ handleSort: e, handleLocationHistory: t, handleBookmarks: r }) {
...
const Er = me.allBookIds, np = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ka = ["OT", "NT", "DC"], op = 32 + 32 + 32, ap = [
  /^(\w+)$/i,
...
function _v({ scrRef: e, handleSubmit: t }) {
  const [r, n] = ce(""), [o, a] = ce(
    ...
    ap.forEach(($) => {
      const E = r.match($);
      if (E) {
        const [R, I = void 0, U = void 0] = E.slice(1), B = cp(R);
  ...
  return He(() => {
    ...
    const $ = setTimeout(() => {
      if (g && u.current && b.current) {
        const R = b.current.offsetTop - op;
        ...
        children: [
          ...
          ka.map(
            ($, E) => x($).length > 0 && /* @__PURE__ */ _("div", { children: [
              /* @__PURE__ */ d(jr, { className: "pr-font-semibold pr-text-slate-700", children: np[$] }),
              ...
              ka.length - 1 !== E ? /* @__PURE__ */ d(wn, {}) : void 0
            ] }, $)
          )
        ]
      }
...
const pp = To(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? yc : "button", { className: z(pp({ variant: t, size: r, className: e })), ref: a, ...o })
);
we.displayName = "Button";
function dp({ table: e }) {
  return /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ d(dc, { asChild: !0, children: /* @__PURE__ */ _(we, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
...
const an = xe.Root, up = xe.Group, sn = xe.Value, Rr = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  xe.Trigger,
  {
    ref: n,
    className: z(
...
const Hi = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ...
  {
    ref: r,
    className: z("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
    ...t,
...
const fp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ...
  {
    ref: r,
    className: z("pr-py-1.5 pr-pl-8 pr-pr-2 pr-text-sm pr-font-semibold", e),
    ...t
  }
));
fp.displayName = xe.Label.displayName;
...
mp.displayName = xe.Separator.displayName;
function hp({ table: e }) {
...
const xn = W.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d("div", { className: z("pr-relative pr-w-full", { "pr-overflow-auto": !t }), children: /* @__PURE__ */ d(
  "table",
  {
    ref: n,
    className: z("pr-w-full pr-caption-bottom pr-text-sm", e),
    ...r
  }
) }));
xn.displayName = "Table";
const kn = W.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d(
  "thead",
  {
    ref: n,
    className: z(
...
const En = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("tbody", { ref: r, className: z("[&_tr:last-child]:pr-border-0", e), ...t }));
En.displayName = "TableBody";
const gp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "tfoot",
  {
    ref: r,
    className: z("pr-border-t pr-bg-muted/50 pr-font-medium [&>tr]:last:pr-border-b-0", e),
    ...t
  }
));
gp.displayName = "TableFooter";
...
const Jt = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ...
  {
    ref: r,
    className: z("pr-p-4 pr-align-middle [&:has([role=checkbox])]:pr-pe-0", e),
    ...t
  }
));
...
const bp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ...
  {
    ref: r,
    className: z("pr-mt-4 pr-text-sm pr-text-muted-foreground", e),
    ...t
  }
));
bp.displayName = "TableCaption";
function vp({
  columns: e,
  data: t,
  ...
  const [l, c] = ce([]), [f, m] = ce([]), [v, g] = ce({}), [p, h] = ce({}), u = Oi({
    ...
    columns: e,
    getCoreRowModel: Ri(),
    ...r && { getPaginationRowModel: hc() },
    onSortingChange: c,
    getSortedRowModel: Pi(),
    onColumnFiltersChange: m,
    getFilteredRowModel: gc(),
  ...
  return /* @__PURE__ */ _("div", { className: "pr-twp pr-font-sans", children: [
    o && /* @__PURE__ */ d(dp, { table: u }),
    /* @__PURE__ */ _(xn, { stickyHeader: a, children: [
      /* @__PURE__ */ d(kn, { stickyHeader: a, children: u.getHeaderGroups().map((x) => /* @__PURE__ */ d(yt, { children: x.headers.map((O) => /* @__PURE__ */ d($r, { children: O.isPlaceholder ? void 0 : kr(O.column.columnDef.header, O.getContext()) }, O.id)) }, x.id)) }),
      /* @__PURE__ */ d(En, { children: (b = u.getRowModel().rows) != null && b.length ? u.getRowModel().rows.map((x) => /* @__PURE__ */ d(
        yt,
        {
          onClick: () => i(x, u),
...
function wp({
  ...
  return He(
    () => f(Na(t, e, r, n)),
    [t, e, n, r]
  ), /* @__PURE__ */ _(xn, { stickyHeader: !0, children: [
    /* @__PURE__ */ d(kn, { stickyHeader: !0, children: /* @__PURE__ */ _(yt, { children: [
      /* @__PURE__ */ d($r, { children: i }),
      /* @__PURE__ */ d($r, { children: l })
    ] }) }),
    /* @__PURE__ */ d(En, { children: c.map((m) => /* @__PURE__ */ _(
      yt,
      {
        onClick: () => {
          o(m.reference);
...
]), $o = (e) => e === "asc" ? /* @__PURE__ */ d(Jl, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(Zl, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(Ql, { className: "pr-ms-2 pr-h-4 pr-w-4" }), xp = (e, t, r) => {
  let n = e;
...
function Mv({
  ...
  return /* @__PURE__ */ _("div", { className: "pr-twp pr-flex pr-h-full pr-flex-col", children: [
    /* @__PURE__ */ _("div", { className: "pr-flex", children: [
      /* @__PURE__ */ _(an, { onValueChange: (L) => S(L), defaultValue: T, children: [
      ...
      /* @__PURE__ */ _(an, { onValueChange: (L) => m(L), defaultValue: f, children: [
...
}), Ep = Or.Root, Np = Or.Trigger, Wi = W.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d(Or.Portal, { children: /* @__PURE__ */ d(
  Or.Content,
  {
    ref: o,
    align: t,
...
const Tp = Qe.Portal, Xi = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Overlay,
  {
    ref: r,
    className: z(
...
const Sp = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(Tp, { children: [
  /* @__PURE__ */ d(Xi, {}),
  /* @__PURE__ */ _(
    Qe.Content,
    {
...
Sp.displayName = Qe.Content.displayName;
const Cp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Title,
  {
    ref: r,
    className: z("pr-text-lg pr-font-semibold pr-leading-none pr-tracking-tight", e),
    ...t
  }
));
Cp.displayName = Qe.Title.displayName;
const Op = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Description,
  {
    ref: r,
    className: z("pr-text-sm pr-text-muted-foreground", e),
    ...t
  }
));
Op.displayName = Qe.Description.displayName;
...
const Ki = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ...
  {
    ref: r,
    className: z("pr-max-h-[300px] pr-overflow-y-auto pr-overflow-x-hidden", e),
    ...t
  }
));
...
Rp.displayName = Ae.Group.displayName;
const Pp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ae.Separator,
  {
    ref: r,
    className: z("pr--mx-1 pr-h-px pr-bg-border", e),
    ...t
  }
));
Pp.displayName = Ae.Separator.displayName;
...
function Ta({
  ...
  const [g, p] = ce(!1);
  return /* @__PURE__ */ _(Ep, { open: g, onOpenChange: p, ...v, children: [
    /* @__PURE__ */ d(Np, { asChild: !0, children: /* @__PURE__ */ _(
      we,
      {
        variant: f,
        role: "combobox",
        "aria-expanded": g,
        id: e,
        className: z("pr-w-[200px] pr-justify-between", r),
        children: [
          n ? a(n) : i,
        ...
        Zi,
        {
          ...
          children: [
            /* @__PURE__ */ d(
              No,
              {
                className: z("pr-me-2 pr-h-4 pr-w-4", {
...
function jp() {
  return Ca || (Ca = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = f, S = l, M = i, j = t, V = m, $ = n, E = h, R = p, I = r, U = a, B = o, L = v, Z = !1;
    function Q(F) {
...
var Wn, $a;
function rs() {
  return $a || ($a = 1, Wn = Function.call.bind(Object.prototype.hasOwnProperty)), Wn;
}
var Xn, _a;
function Lp() {
  if (_a)
...
function Fp() {
  if (Ia)
    return Yn;
  Ia = 1;
  var e = ts(), t = Bp(), r = Io(), n = rs(), o = Lp(), a = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var zp = ts(), Up = !0;
  lo.exports = Fp()(zp.isElement, Up);
} else
  lo.exports = Vp()();
var Hp = lo.exports;
const s = /* @__PURE__ */ Ip(Hp);
function Gp(e) {
  const {
    prototype: t = {}
  } = e;
...
function ns(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Gp(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function Xp(e, t, r, n, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof a == "function" && !Wp(a) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Yp = ar(s.elementType, Xp), qp = "exact-prop: ​";
function as(e) {
...
function Jp() {
  return Da || (Da = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var T = i, S = a, M = e, j = c, V = r, $ = g, E = v, R = t, I = o, U = n, B = f, L = m, Z = !1, Q = !1;
    function C(D) {
...
const td = s.oneOfType([s.func, s.object]), Mo = td;
function et(e) {
  if (typeof e != "string")
...
const ad = typeof window < "u" ? N.useLayoutEffect : N.useEffect, Dt = ad;
let Ba = 0;
function id(e) {
...
function yr() {
  const e = ld(Lr.create).current;
  return pd(e.disposeEffect), e;
}
let Nn = !0, uo = !1;
const dd = new Lr(), ud = {
  text: !0,
...
function fd(e) {
  ...
  return !!(r === "INPUT" && ud[t] && !e.readOnly || r === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function md(e) {
...
function gd(e) {
  e.addEventListener("keydown", md, !0), e.addEventListener("mousedown", Kn, !0), e.addEventListener("pointerdown", Kn, !0), e.addEventListener("touchstart", Kn, !0), e.addEventListener("visibilitychange", hd, !0);
}
function bd(e) {
  const {
    target: t
...
function ps() {
  const e = N.useCallback((o) => {
    o != null && gd(o.ownerDocument);
  }, []), t = N.useRef(!1);
  function r() {
    return t.current ? (uo = !0, dd.start(100, () => {
      uo = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
    return bd(o) ? (t.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: t,
    onFocus: n,
...
fs.isRequired = us;
fo.isRequired = fo;
const ms = process.env.NODE_ENV === "production" ? fo : fs;
function hs(e, t) {
  const r = P({}, t);
...
const Nd = ["values", "unit", "step"], Td = (e) => {
...
function Sd(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = he(e, Nd), a = Td(t), i = Object.keys(a);
  function l(g) {
...
const Cd = {
  borderRadius: 4
}, Od = Cd, Rd = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, kt = Rd;
function Nr(e, t) {
  return t ? st(e, t, {
    clone: !1
...
function Ee(e) {
  const {
    ...
    if (i[t] == null)
      return null;
    const l = i[t], c = i.theme, f = Tn(c, n) || {};
    return ct(i, l, (v) => {
      let g = pn(f, o, v);
...
const Id = {
  ...
  if (e.length > 2)
    if (Ua[e])
      ...
      return [e];
  const [t, r] = e.split(""), n = Id[t], o = Md[r] || "";
  return Array.isArray(o) ? o.map((a) => n + a) : [n + o];
}), Sn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Cn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Dd = [...Sn, ...Cn];
function Fr(e, t, r, n) {
  var o;
...
function Bd(e, t, r, n) {
  if (t.indexOf(r) === -1)
    return null;
  const o = Ad(r), a = jd(o, n), i = e[r];
  return ct(e, i, a);
}
function ys(e, t) {
  const r = vs(e.theme);
  return Object.keys(e).map((n) => Bd(e, t, n, r)).reduce(Nr, {});
}
function ve(e) {
  return ys(e, Sn);
}
ve.propTypes = process.env.NODE_ENV !== "production" ? Sn.reduce((e, t) => (e[t] = kt, e), {}) : {};
ve.filterProps = Sn;
function ye(e) {
  return ys(e, Cn);
}
ye.propTypes = process.env.NODE_ENV !== "production" ? Cn.reduce((e, t) => (e[t] = kt, e), {}) : {};
ye.filterProps = Cn;
process.env.NODE_ENV !== "production" && Dd.reduce((e, t) => (e[t] = kt, e), {});
function Ld(e = 8) {
  if (e.mui)
    return e;
  const t = vs({
...
const Fd = qe("border", Ue), Vd = qe("borderTop", Ue), zd = qe("borderRight", Ue), Ud = qe("borderBottom", Ue), Hd = qe("borderLeft", Ue), Gd = qe("borderColor"), Wd = qe("borderTopColor"), Xd = qe("borderRightColor"), Yd = qe("borderBottomColor"), qd = qe("borderLeftColor"), Kd = qe("outline", Ue), Jd = qe("outlineColor"), Rn = (e) => {
...
On(Fd, Vd, zd, Ud, Hd, Gd, Wd, Xd, Yd, qd, Rn, Kd, Jd);
const Pn = (e) => {
...
On(Pn, $n, _n, Zd, Qd, eu, tu, ru, nu, ou, au, iu);
function Kt(e, t) {
  return t === "grey" ? t : e;
}
const su = Ee({
...
function yu() {
  ...
  function t(r) {
    ...
    function l(c) {
      ...
      if (!f)
        return null;
      const m = Pd(a.breakpoints), v = Object.keys(m);
      let g = m;
...
function Lo(e = {}, ...t) {
  ...
  return f.applyStyles = wu, f = t.reduce((m, v) => st(m, v), f), f.unstable_sxConfig = P({}, jo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return Bo({
      sx: v,
      theme: this
    });
...
const Nu = ["ownerState"], Tu = ["variants"], Su = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Cu(e) {
  return Object.keys(e).length === 0;
}
function Ou(e) {
...
const Ru = Lo(), Ha = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Kr({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function $u(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Mc(i, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: f,
      ...
      overridesResolver: g = Pu(Ha(f))
    } = l, p = he(l, Su), h = m !== void 0 ? m : (
    ...
    let x = en;
    f === "Root" || f === "root" ? x = n : f ? x = o : Ou(i) && (x = void 0);
    const O = _c(i, P({
      shouldForwardProp: x,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let $;
        c && ($ = `${c}${et(f || "")}`), $ === void 0 && ($ = `Styled(${ed(i)})`), V.displayName = $;
      }
...
function Fo(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), Ed(e, t, r);
}
function Mu(e) {
  e = e.slice(1);
...
function Ga(e) {
  e = jt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? jt(Au(e)).values : e.values;
...
function dn(e, t) {
  return e = jt(e), t = Fo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, In(e);
}
function Du(e, t) {
...
const Lu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Gt = Xu, Yu = ["mode", "contrastThreshold", "tonalOffset"], Xa = {
...
function Ya(e, t, r, n) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = ju(e.main, o) : t === "dark" && (e.dark = Du(e.main, a)));
}
function qu(e = "light") {
  return e === "dark" ? {
    main: Ut[200],
...
function tf(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = he(e, Yu), a = e.primary || qu(t), i = e.secondary || Ku(t), l = e.error || Ju(t), c = e.info || Zu(t), f = e.success || Qu(t), m = e.warning || ef(t);
  function v(u) {
    const b = Wa(u, Jn.text.primary) >= r ? Jn.text.primary : Xa.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const x = Wa(u, b);
...
const af = 0.2, sf = 0.14, lf = 0.12;
function be(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${af})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${sf})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${lf})`].join(",");
}
const cf = ["none", be(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), be(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), be(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), be(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), be(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), be(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), be(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), be(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), be(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), be(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), be(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), be(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), be(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), be(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), be(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), be(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), be(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), be(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), be(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), be(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), be(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), be(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), be(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), be(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], pf = cf, df = ["duration", "easing", "delay"], uf = {
...
function hf(e) {
  const t = P({}, uf, e.easing), r = P({}, ff, e.duration);
  return P({
...
const gf = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, bf = gf, vf = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function yf(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: n = {},
...
const Es = (e) => en(e) && e !== "classes", xf = $u({
  themeId: zo,
  defaultTheme: Vo,
...
const Ef = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Nf = (e) => {
  const {
    color: t,
    fontSize: r,
    classes: n
  ...
  const n = ut({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = n, p = he(n, Ef), h = /* @__PURE__ */ N.isValidElement(o) && o.type === "svg", u = P({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
`)), gs.configure(e);
  ...
  createSvgIcon: Ns,
  debounce: ss,
  deprecatedPropType: rd,
  isMuiElement: nd,
  ownerDocument: Oe,
  ownerWindow: Qt,
  requirePropFactory: od,
  setRef: cn,
  unstable_ClassNameGenerator: Sf,
...
}, Symbol.toStringTag, { value: "Module" })), Of = /* @__PURE__ */ Mp(Cf);
var Qa;
function Rf() {
...
var Ts = _o.default = void 0, $f = Pf(Rf()), _f = Ll;
Ts = _o.default = (0, $f.default)(/* @__PURE__ */ (0, _f.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Ss(e) {
...
}, Mf = /* @__PURE__ */ N.createContext(If);
function Af(e) {
  const {
...
const Bf = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function Bt(e) {
  var t;
  const {
    elementType: r,
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const w = Oe(h.current), k = (S) => {
      ...
      if ((w.activeElement === f.current || w.activeElement === m.current) && (M = a(h.current)), M.length > 0) {
        var j, V;
        const $ = !!((j = b.current) != null && j.shiftKey && ((V = b.current) == null ? void 0 : V.key) === "Tab"), E = M[0], R = M[M.length - 1];
...
process.env.NODE_ENV !== "production" && (un["propTypes"] = as(un.propTypes));
function Yf(e) {
...
const Mr = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  return /* @__PURE__ */ d(N.Fragment, {
    children: i && /* @__PURE__ */ Ac.createPortal(n, i)
  });
});
...
function nm(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = N.useRef({}), p = N.useRef(null), h = N.useRef(null), u = We(h, v), [b, x] = N.useState(!m), O = tm(c);
  let w = !0;
  ...
  return {
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: po(B, c == null ? void 0 : c.props.onEnter),
        onExited: po(L, c == null ? void 0 : c.props.onExited)
      };
    },
    rootRef: u,
    portalRef: j,
...
var Ie = "top", Xe = "bottom", Ye = "right", Me = "left", Ho = "auto", zr = [Ie, Xe, Ye, Me], er = "start", Ar = "end", om = "clippingParents", Ps = "viewport", mr = "popper", am = "reference", ni = /* @__PURE__ */ zr.reduce(function(e, t) {
  return e.concat([t + "-" + er, t + "-" + Ar]);
}, []), $s = /* @__PURE__ */ [].concat(zr, [Ho]).reduce(function(e, t) {
  return e.concat([t, t + "-" + er, t + "-" + Ar]);
}, []), im = "beforeRead", sm = "read", lm = "afterRead", cm = "beforeMain", pm = "main", dm = "afterMain", um = "beforeWrite", fm = "write", mm = "afterWrite", hm = [im, sm, lm, cm, pm, dm, um, fm, mm];
function tt(e) {
...
function Ur(e) {
  for (var t = Ve(e), r = oi(e); r && ym(r) && pt(r).position === "static"; )
    r = oi(r);
  return r && (tt(r) === "html" || tt(r) === "body" && pt(r).position === "static") ? t : r || wm(e) || t;
}
function Xo(e) {
...
function Em(e) {
  ...
  if (!(!a || !i)) {
    var v = km(o.padding, r), g = Wo(a), p = c === "y" ? Ie : Me, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], x = Ur(a), O = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, k = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + w, S = Sr(k, T, y), M = c;
...
function js(e) {
  return ["html", "body", "#document"].indexOf(tt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && Ko(e) ? e : js(Mn(e));
}
function Cr(e, t) {
  var r;
  t === void 0 && (t = []);
...
function si(e, t, r) {
  return t === Ps ? ho(Mm(e, r)) : Lt(t) ? Dm(t, r) : ho(Am(Et(e)));
}
function jm(e) {
  var t = Cr(Mn(e)), r = ["absolute", "fixed"].indexOf(pt(e).position) >= 0, n = r && Ge(e) ? Ur(e) : e;
...
function Dr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? om : l, f = r.rootBoundary, m = f === void 0 ? Ps : f, v = r.elementContext, g = v === void 0 ? mr : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, x = As(typeof b != "number" ? b : Ds(b, zr)), O = g === mr ? am : mr, w = e.rects.popper, k = e.elements[h ? O : g], y = Bm(Lt(k) ? k : k.contextElement || Et(e.elements.popper), c, m, i), T = rr(e.elements.reference), S = Bs({
    reference: T,
    element: w,
    strategy: "absolute",
    placement: o
  }), M = ho(Object.assign({}, w, S)), j = g === mr ? M : T, V = {
...
function Vm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, x = Ze(b), O = x === b, w = c || (O || !h ? [rn(b)] : Fm(b)), k = [b].concat(w).reduce(function(G, X) {
      return G.concat(Ze(X) === Ho ? Lm(t, {
        placement: X,
        boundary: m,
        rootBoundary: v,
        padding: f,
    ...
    }, []), y = t.rects.reference, T = t.rects.popper, S = /* @__PURE__ */ new Map(), M = !0, j = k[0], V = 0; V < k.length; V++) {
      var $ = k[V], E = Ze($), R = nr($) === er, I = [Ie, Xe].indexOf(E) >= 0, U = I ? "width" : "height", B = Dr(t, {
        placement: $,
        boundary: m,
        rootBoundary: v,
        altBoundary: g,
...
function Jm(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Dr(t, {
    ...
    padding: v,
    altBoundary: m
  }), x = Ze(t.placement), O = nr(t.placement), w = !O, k = Xo(x), y = Km(k), T = t.modifiersData.popperOffsets, S = t.rects.reference, M = t.rects.popper, j = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, V = typeof j == "number" ? {
    mainAxis: j,
    altAxis: j
  ...
  if (T) {
    if (a) {
      var R, I = k === "y" ? Ie : Me, U = k === "y" ? Xe : Ye, B = k === "y" ? "height" : "width", L = T[k], Z = L + b[I], Q = L - b[U], C = p ? -M[B] / 2 : 0, A = O === er ? S[B] : M[B], H = O === er ? -M[B] : -S[B], J = t.elements.arrow, G = p && J ? Wo(J) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Ms(), q = X[I], K = X[U], Y = Sr(0, S[B], G[B]), ee = w ? S[B] / 2 - C - Y - q - V.mainAxis : A - Y - q - V.mainAxis, te = w ? -S[B] / 2 + C + Y + K + V.mainAxis : H + Y + K + V.mainAxis, ie = t.elements.arrow && Ur(t.elements.arrow), F = ie ? k === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = (R = $ == null ? void 0 : $[k]) != null ? R : 0, D = L + ee - re - F, se = L + te - re, Ne = Sr(p ? fn(Z, D) : Z, L, p ? It(Q, se) : Q);
      T[k] = Ne, E[k] = Ne - L;
    }
    if (l) {
      var Pe, ke = k === "x" ? Ie : Me, Nt = k === "x" ? Xe : Ye, $e = T[y], nt = y === "y" ? "height" : "width", je = $e + b[ke], ot = $e - b[Nt], Te = [Ie, Me].indexOf(x) !== -1, Ft = (Pe = $ == null ? void 0 : $[y]) != null ? Pe : 0, Tt = Te ? je : $e - S[nt] - M[nt] - Ft + V.altAxis, ir = Te ? $e + S[nt] + M[nt] - Ft - V.altAxis : ot, Gr = p && Te ? xm(Tt, $e, ir) : Sr(p ? Tt : je, $e, p ? ir : ot);
      T[y] = Gr, E[y] = Gr - $e;
    }
    t.modifiersData[n] = E;
  }
...
function rh(e, t, r) {
  r === void 0 && (r = !1);
  var n = Ge(t), o = Ge(t) && th(t), a = Et(t), i = rr(e, o, r), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Ko(a)) && (l = eh(t)), Ge(t) ? (c = rr(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = qo(a))), {
  ...
  return function(l, c, f) {
    ...
    var m = {
      ...
      setOptions: function(x) {
        ...
        var w = oh(ih([].concat(n, m.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (di(O, w)) {
            m.rects = {
              reference: rh(O, Ur(w), m.options.strategy === "fixed"),
              popper: Wo(w)
...
var lh = [$m, qm, Rm, vm, Xm, zm, Zm, Tm, Hm], ch = /* @__PURE__ */ sh({
  defaultModifiers: lh
});
const Ls = "Popper";
function ph(e) {
...
Vf(Ls, ["root"]);
const dh = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], uh = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function fh(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const hh = () => dt({
  root: ["root"]
}, Af(ph)), gh = {}, bh = /* @__PURE__ */ N.forwardRef(function(t, r) {
  var n;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, b = he(t, dh), x = N.useRef(null), O = We(x, r), w = N.useRef(null), k = We(w, g), y = N.useRef(k);
  Dt(() => {
    y.current = k;
  }, [k]), N.useImperativeHandle(g, () => w.current, []);
  const T = fh(m, i), [S, M] = N.useState(T), [j, V] = N.useState(mn(o));
  N.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && j && An(j) && j.nodeType === 1) {
...
`));
  ...
  const E = hh(), R = (n = h.root) != null ? n : "div", I = Bt({
    elementType: R,
  ...
  const {
    ...
    slotProps: b = {},
    slots: x = {}
  } = t, O = he(t, uh), [w, k] = N.useState(!0), y = () => {
    k(!1);
  }, T = () => {
    k(!0);
  };
  ...
  if (a)
    ...
    const V = mn(n);
    S = V && An(V) ? Oe(V).body : Oe(null).body;
  }
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || mh(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
var wh = function(t) {
  return t.scrollTop;
}, xr = "unmounted", Ct = "exited", Ot = "entering", qt = "entered", bo = "exiting", ft = /* @__PURE__ */ function(e) {
  vh(t, e);
  function t(n, o) {
    var a;
  ...
  return r.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== Ot && i !== qt && (a = Ot) : (i === Ot || i === qt) && (a = bo);
    }
...
const kh = {
...
}, Qn = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Jo = /* @__PURE__ */ N.forwardRef(function(t, r) {
  const {
    addEndListener: n,
    appear: o = !0,
    children: a,
  ...
  } = t, x = he(t, xh), O = yr(), w = N.useRef(), k = Hr(), y = N.useRef(null), T = We(y, a.ref, r), S = (U) => (B) => {
    if (U) {
      const L = y.current;
      B === void 0 ? U(L) : U(L, B);
    }
...
const yo = Jo, Eh = (e) => {
...
}, fi = Eh, Nh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Th = Re(Fs, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = xs(), a = ut({
    ...
    slots: w,
    slotProps: k
  } = a, y = he(a, Nh), T = (n = w == null ? void 0 : w.root) != null ? n : c == null ? void 0 : c.Root, S = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const Ch = xt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), vt = Ch, Oh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Rh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Ph = (e) => {
...
const Ws = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const T = ut({
    ...
    TransitionProps: re
  } = T, D = he(T, Oh), se = /* @__PURE__ */ N.isValidElement(M) ? M : /* @__PURE__ */ d("span", {
    children: M
  }), Ne = Hr(), Pe = Ne.direction === "rtl", [ke, Nt] = N.useState(), [$e, nt] = N.useState(null), je = N.useRef(!1), ot = I || Q, Te = yr(), Ft = yr(), Tt = yr(), ir = yr(), [Gr, ta] = cs({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Dn = ls(C), sr = N.useRef(), Wr = _r(() => {
  ...
  const ra = (ne) => {
    ...
    je.current && ne.type !== "touchstart" || (ke && ke.removeAttribute("title"), Ft.clear(), Tt.clear(), B || Zr && L ? Ft.start(Zr ? L : B, () => {
      ra(ne);
    }) : ra(ne));
  }, na = (ne) => {
    Ft.clear(), Tt.start(A, () => {
    ...
    ke || Nt(ne.currentTarget), Ol(ne), oa.current === !0 && (aa(!0), jn(ne));
  }, la = (ne) => {
    je.current = !0;
    const Be = se.props;
    ...
    la(ne), Tt.clear(), Te.clear(), Wr(), sr.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", ir.start(Z, () => {
      document.body.style.WebkitUserSelect = sr.current, jn(ne);
    });
  }, $l = (ne) => {
  ...
  !ie && ie !== 0 && (at = !1);
  const Bn = N.useRef(), Il = (ne) => {
    const Be = se.props;
    Be.onMouseMove && Be.onMouseMove(ne), hr = {
      x: ne.clientX,
      y: ne.clientY
    }, Bn.current && Bn.current.update();
  }, lr = {}, Ln = typeof ie == "string";
  $ ? (lr.title = !at && Ln && !R ? ie : null, lr["aria-describedby"] = at ? Dn : null) : (lr["aria-label"] = Ln ? ie : null, lr["aria-labelledby"] = at && !Ln ? Dn : null);
...
`));
  ...
  const cr = {};
  U || (ze.onTouchStart = Pl, ze.onTouchEnd = $l), R || (ze.onMouseOver = Qr(ca, ze.onMouseOver), ze.onMouseLeave = Qr(pa, ze.onMouseLeave), ot || (cr.onMouseOver = ca, cr.onMouseLeave = pa)), E || (ze.onFocus = Qr(sa, ze.onFocus), ze.onBlur = Qr(ia, ze.onBlur), ot || (cr.onFocus = sa, cr.onBlur = ia)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Ml = N.useMemo(() => {
    var ne;
    let Be = [{
    ...
    touch: je.current
  }), Fn = Ph(pr), da = (n = (o = te.popper) != null ? o : j.Popper) != null ? n : $h, ua = (a = (i = (l = te.transition) != null ? l : j.Transition) != null ? i : F) != null ? a : yo, fa = (c = (f = te.tooltip) != null ? f : j.Tooltip) != null ? c : _h, ma = (m = (v = te.arrow) != null ? v : j.Arrow) != null ? m : Ih, Al = wr(da, P({}, Y, (g = ee.popper) != null ? g : V.popper, {
    className: Ce(Fn.popper, Y == null ? void 0 : Y.className, (p = (h = ee.popper) != null ? h : V.popper) == null ? void 0 : p.className)
  }), pr), Dl = wr(ua, P({}, re, (u = ee.transition) != null ? u : V.transition), pr), jl = wr(fa, P({}, (b = ee.tooltip) != null ? b : V.tooltip, {
    className: Ce(Fn.tooltip, (x = (O = ee.tooltip) != null ? O : V.tooltip) == null ? void 0 : x.className)
  }), pr), Bl = wr(ma, P({}, (w = ee.arrow) != null ? w : V.arrow, {
    className: Ce(Fn.arrow, (k = (y = ee.arrow) != null ? y : V.arrow) == null ? void 0 : k.className)
  }), pr);
  return /* @__PURE__ */ _(N.Fragment, {
...
function Xs(e) {
  ...
  return n ? /* @__PURE__ */ d(Mh, { title: n, placement: "right", children: /* @__PURE__ */ d("div", { children: x }) }) : x;
}
function Ys(e) {
...
const Dh = (e, t) => t.filter((o) => o.group === e).sort((o, a) => (o.order || 0) - (a.order || 0));
function Zo(e) {
  ...
  return /* @__PURE__ */ _(
    _i,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d(Tc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ d(
          jh,
          {
            commandHandler: e,
            menuDefinition: t,
...
const zh = ["children", "className", "component", "dense", "disablePadding", "subheader"], Uh = (e) => {
  const {
    classes: t,
    disablePadding: r,
    dense: n,
  ...
  return /* @__PURE__ */ d(Fh.Provider, {
    value: v,
    children: /* @__PURE__ */ _(Hh, P({
      as: i,
...
const Gh = Ks, Wh = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function eo(e, t, r) {
...
const Zs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  } = t, g = he(t, Wh), p = N.useRef(null), h = N.useRef({
    keys: [],
    repeating: !0,
  ...
  const u = (w) => {
    ...
    if (y === "ArrowDown")
      w.preventDefault(), gr(k, T, f, c, eo);
    else if (y === "ArrowUp")
      w.preventDefault(), gr(k, T, f, c, gi);
    else if (y === "Home")
      w.preventDefault(), gr(k, null, f, c, eo);
    else if (y === "End")
      ...
      const V = T && !S.repeating && Js(T, S);
      S.previousKeyMatched && (V || gr(k, T, !1, c, eo, S)) ? w.preventDefault() : S.previousKeyMatched = !1;
    }
    m && m(w);
  }, b = We(p, r);
  let x = -1;
...
const Xh = Zs, Yh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], qh = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  } = t, w = he(t, Yh), k = N.useRef(null), y = We(k, l.ref, r), T = (I) => (U) => {
    if (I) {
      const B = k.current;
      U === void 0 ? I(B) : I(B, U);
    }
...
const Zh = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Qh = (e) => {
  const {
    classes: t,
    invisible: r
  } = e;
  ...
  const i = ut({
    ...
    slotProps: h = {},
    slots: u = {},
    TransitionComponent: b = Kh,
    transitionDuration: x
  } = i, O = he(i, Zh), w = P({}, i, {
    component: f,
    invisible: g
  }), k = Qh(w), y = (n = h.root) != null ? n : v.root;
  return /* @__PURE__ */ d(b, P({
    in: p,
    timeout: x
  }, O, {
    children: /* @__PURE__ */ d(eg, P({
      "aria-hidden": !0
    }, y, {
...
const ng = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], og = (e) => {
  const {
    open: t,
    exited: r,
    classes: n
  ...
  const K = (n = (o = I == null ? void 0 : I.root) != null ? o : x.Root) != null ? n : ag, Y = (a = (i = I == null ? void 0 : I.backdrop) != null ? i : x.Backdrop) != null ? a : m, ee = (l = R == null ? void 0 : R.root) != null ? l : O.root, te = (c = R == null ? void 0 : R.backdrop) != null ? c : O.backdrop, ie = Bt({
    elementType: K,
  ...
  return !V && !E && (!J || H) ? null : /* @__PURE__ */ d(Mr, {
    ref: C,
    container: u,
    disablePortal: T,
    children: /* @__PURE__ */ _(K, P({}, ie, {
      children: [!j && m ? /* @__PURE__ */ d(Y, P({}, F)) : null, /* @__PURE__ */ d(un, {
        disableEnforceFocus: k,
        disableAutoFocus: w,
        disableRestoreFocus: S,
        isEnabled: A,
...
const cg = ["className", "component", "elevation", "square", "variant"], pg = (e) => {
  const {
    square: t,
    elevation: r,
    variant: n,
...
const mg = ["onEntering"], hg = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], gg = ["slotProps"];
function bi(e, t) {
  let r = 0;
...
const bg = (e) => {
  ...
  const i = ut({
  ...
  } = i, V = he(i.TransitionProps, mg), $ = he(i, hg), E = (n = k == null ? void 0 : k.paper) != null ? n : O, R = N.useRef(), I = We(R, E.ref), U = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
    ...
    const re = nn(c), D = re && re.nodeType === 1 ? re : Oe(R.current).body, se = D.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const Nt = Pe + D.height, $e = ke + D.width, nt = Qt(nn(c)), je = nt.innerHeight - b, ot = nt.innerWidth - b;
    if (b !== null && Pe < b) {
      const Te = Pe - b;
...
`)), b !== null && ke < b) {
  ...
  const q = h || (c ? Oe(nn(c)).body : void 0), K = (o = w == null ? void 0 : w.root) != null ? o : vg, Y = (a = w == null ? void 0 : w.paper) != null ? a : nl, ee = Bt({
    elementType: Y,
...
const xg = ["onEntering"], kg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Eg = {
  vertical: "top",
  horizontal: "right"
}, Ng = {
  vertical: "top",
  ...
  const a = ut({
    ...
    slots: O = {},
    slotProps: w = {}
  } = a, k = he(a.TransitionProps, xg), y = he(a, kg), T = Hr(), S = T.direction === "rtl", M = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: k,
    variant: x
  }), j = Tg(M), V = i && !f && g, $ = N.useRef(null), E = (Q, C) => {
...
`)), Q.props.disabled || (x === "selectedMenu" && Q.props.selected || I === -1) && (I = C));
  ...
  const U = (n = O.paper) != null ? n : Cg, B = (o = w.paper) != null ? o : p, L = Bt({
    elementType: O.root,
  ...
  return /* @__PURE__ */ d(Sg, P({
    onClose: v,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: S ? "right" : "left"
    },
    transformOrigin: S ? Eg : Ng,
    slots: {
      paper: U,
      root: O.root
    },
...
const bt = "scrBook", Ig = "scrRef", Rt = "source", Mg = "details", Ag = "Scripture Reference", Dg = "Scripture Book", il = "Type", jg = "Details";
function Bg(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      id: bt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Ag,
      cell: (n) => {
        const o = n.row.original;
        return n.row.getIsGrouped() ? me.bookNumberToEnglishName(o.start.bookNum) : n.row.groupingColumnId === bt ? zn(o.start) : void 0;
      },
...
function zv({
  ...
  }, V = (E, R) => E.getIsGrouped() ? "" : z("banded-row", R % 2 === 0 ? "even" : "odd"), $ = (E, R, I) => {
    ...
    !t && /* @__PURE__ */ _(
      an,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Pr, { position: "item-aligned", children: /* @__PURE__ */ d(up, { children: S.map((E) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ _(xn, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ d(kn, { children: k.getHeaderGroups().map((E) => /* @__PURE__ */ d(yt, { children: E.headers.filter((R) => R.column.columnDef.header).map((R) => (
      ...
      /* @__PURE__ */ d(En, { children: k.getRowModel().rows.map((E, R) => /* @__PURE__ */ d(
        yt,
        {
...
), sl = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(Mi.Root, { ref: r, className: z(Lg(), e), ...t }));
...
function Fg({
  ...
  return /* @__PURE__ */ _("div", { className: z("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": n }), children: [
    /* @__PURE__ */ d(
      sl,
      {
        htmlFor: e,
    ...
    /* @__PURE__ */ d(
      vn,
      {
        ...
        placeholder: i,
        required: l,
        className: z(c, { "pr-border-red-600": r }),
        defaultValue: f,
        value: m,
        onChange: v,
        onFocus: g,
    ...
    /* @__PURE__ */ d("p", { className: z({ "pr-hidden": !o }), children: o })
  ] });
}
function Uv({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [n, o] = ce(""), a = (i) => {
    o(i), e(i);
  };
  return /* @__PURE__ */ d(
...
function Xv({
  ...
  const a = _t(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Pc, { position: "static", id: n, children: /* @__PURE__ */ _($c, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ d(
      _g,
      {
        commandHandler: t,
...
const Yv = De.Root, Vg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.List,
  {
    ref: r,
    className: z(
...
Vg.displayName = De.List.displayName;
...
zg.displayName = De.Trigger.displayName;
...
Ug.displayName = De.Content.displayName;
const Hg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Root,
  {
    orientation: "vertical",
    ref: r,
    className: z("pr-flex pr-gap-1 pr-rounded-md pr-text-muted-foreground", e),
    ...t
  }
));
...
const qv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    ...t,
...
)), Wg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Content,
  {
    ref: r,
    className: z(
...
Wg.displayName = De.Content.displayName;
function Kv({
  isInstalling: e,
  handleClick: t,
  buttonText: r,
  ...
  return /* @__PURE__ */ d(
    we,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ d(bn, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ _(wt, { children: [
        /* @__PURE__ */ d(oc, { size: 25, className: z("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
...
const Xg = ["children", "options"], wi = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), xi = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, Yg = ["style", "script"], qg = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, Kg = /mailto:/i, Jg = /\n{2,}$/, ll = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, Zg = /^ *> ?/gm, Qg = /^ {2,}\n/, eb = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, cl = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, pl = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, tb = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, rb = /^(?:\n *)*\n/, nb = /\r\n?/g, ob = /^\[\^([^\]]+)](:.*)\n/, ab = /^\[\^([^\]]+)]/, ib = /\f/g, sb = /^\s*?\[(x|\s)\]/, dl = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, ul = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, fl = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, xo = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, lb = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, ml = /^<!--[\s\S]*?(?:-->)/, cb = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, ko = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, pb = /^\{.*\}$/, db = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, ub = /^<([^ >]+@[^ >]+)>/, fb = /^<([^ >]+:\/[^ >]+)>/, mb = /-([a-z])?/gi, hl = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, hb = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, gb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, bb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, vb = /(\[|\])/g, yb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, wb = /\t/g, xb = /^ *\| */, kb = /(^ *\||\| *$)/g, Eb = / *$/, Nb = /^ *:-+: *$/, Tb = /^ *:-+ *$/, Sb = /^ *-+: *$/, Cb = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, Ob = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, Rb = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, Pb = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, $b = /^\\([^0-9A-Za-z\s])/, _b = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, Ib = /^\n+/, Mb = /^([ \t]*)/, Ab = /\\([^\\])/g, ki = / *\n+$/, Db = /(?:^|\n)( *)$/, Qo = "(?:\\d+\\.)", ea = "(?:[*+-])";
function gl(e) {
  return "( *)(" + (e === 1 ? Qo : ea) + ") +";
}
...
function Ei(e, t) {
  const r = t === 1, n = r ? Nl : Tl, o = r ? xl : kl, a = r ? jb : Bb;
  return { t(i, l, c) {
    const f = Db.exec(c);
    return f && (l.o || !l._ && !l.u) ? n.exec(i = f[1] + i) : null;
  }, i: ae.HIGH, l(i, l, c) {
    const f = r ? +i[2] : void 0, m = i[0].replace(Jg, `
`).match(o);
    let v = !1;
...
const Lb = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Fb = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Sl = [ll, cl, pl, dl, fl, ul, ml, hl, xl, Nl, kl, Tl], Vb = [...Sl, /^[^\n]+(?:  \n|\n{2,})/, xo, ko];
function zb(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function Ub(e) {
  return Sb.test(e) ? "right" : Nb.test(e) ? "center" : Tb.test(e) ? "left" : null;
}
function Ni(e, t, r) {
  const n = r.$;
  r.$ = !0;
...
function Hb(e, t, r) {
  r._ = !0;
  const n = Ni(e[1], t, r), o = e[2].replace(kb, "").split("|").map(Ub), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(f) {
      return Ni(f, l, c);
    });
...
var ae;
function qb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || zb, t.namedCodesToUnicode = t.namedCodesToUnicode ? $t({}, xi, t.namedCodesToUnicode) : xi;
  const r = t.createElement || N.createElement;
  function n(p, h, ...u) {
    const b = oo(t.overrides, `${p}.props`, {});
    return r(function(x, O) {
      const w = oo(O, x);
      return w ? typeof w == "function" || typeof w == "object" && "render" in w ? w : oo(O, `${x}.component`, x) : x;
    }(p, t.overrides), $t({}, h, b, { className: Yb(h == null ? void 0 : h.className, b.className) || void 0 }), ...u);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = yb.test(p) === !1);
    const u = m(f(h ? p : `${p.trimEnd().replace(Ib, "")}
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, x) {
      ...
      if (O !== -1) {
        const w = function(S) {
          return S.indexOf("-") !== -1 && S.match(cb) === null && (S = S.replace(mb, function(M, j) {
          ...
          return S === "style" ? M.split(/;\s?/).reduce(function(j, V) {
            const $ = V.slice(0, V.indexOf(":"));
            return j[$.replace(/(-[a-z])/g, (E) => E[1].toUpperCase())] = V.slice($.length + 1).trim(), j;
          }, {}) : S === "href" ? Xt(M) : (M.match(pb) && (M = M.slice(1, M.length - 1)), M === "true" || M !== "false" && M);
        }(w, k);
        typeof T == "string" && (xo.test(T) || ko.test(T)) && (u[y] = N.cloneElement(o(T.trim()), { key: x }));
      } else
        b !== "style" && (u[wi[b] || b] = !0);
      return u;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: it(ll), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(Zg, ""), u) }), h: (p, h, u) => n("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: br(Qg), i: ae.HIGH, l: ro, h: (p, h, u) => n("br", { key: u.k }) }, breakThematic: { t: it(eb), i: ae.HIGH, l: ro, h: (p, h, u) => n("hr", { key: u.k }) }, codeBlock: { t: it(pl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => n("pre", { key: u.k }, n("code", $t({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(cl), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: gt(tb), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => n("code", { key: u.k }, p.v) }, footnote: { t: it(ob), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: no }, footnoteReference: { t: ht(ab), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => n("a", { key: u.k, href: Xt(p.B) }, n("sup", { key: u.k }, p.v)) }, gfmTask: { t: ht(sb), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => n("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? ul : dl), i: ae.HIGH, l: (p, h, u) => ({ v: on(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => n(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: it(fl), i: ae.MAX, l: (p, h, u) => ({ v: on(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: br(ml), i: ae.HIGH, l: () => ({}), h: no }, image: { t: gt(Fb), i: ae.HIGH, l: (p) => ({ D: p[1], B: Si(p[2]), F: p[3] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Xt(p.B) }) }, link: { t: ht(Lb), i: ae.LOW, l: (p, h, u) => ({ v: Wb(h, p[1], u), B: Si(p[2]), F: p[3] }), h: (p, h, u) => n("a", { key: u.k, href: Xt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: ht(fb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : ht(db)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: ht(ub), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
    return Kg.test(u) || (u = "mailto:" + u), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: u, type: "link" };
  } }, orderedList: Ei(n, 1), unorderedList: Ei(n, 2), newlineCoalescer: { t: it(rb), i: ae.LOW, l: ro, h: () => `
` }, paragraph: { t: Gb, i: ae.LOW, l: to, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: ht(hb), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: no }, refImage: { t: gt(gb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Xt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: ht(bb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(vb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Xt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: it(hl), i: ae.HIGH, l: Hb, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, x) {
    ...
    return h.$ ? (h._ = !0, xb.exec(p)) : null;
  }, i: ae.HIGH, l: function() {
    return { type: "tableSeparator" };
  }, h: () => " | " }, text: { t: br(_b), i: ae.MIN, l: (p) => ({ v: p[0].replace(lb, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: gt(Cb), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: gt(Ob), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: gt($b), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: gt(Rb), i: ae.LOW, l: to, h: (p, h, u) => n("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: gt(Pb), i: ae.LOW, l: to, h: (p, h, u) => n("del", { key: u.k }, h(p.v, u)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: br(xo), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(Mb), x = new RegExp(`^${b}`, "gm"), O = p[3].replace(x, ""), w = (k = O, Vb.some((M) => M.test(k)) ? Xb : on);
    var k;
    const y = p[1].toLowerCase(), T = Yg.indexOf(y) !== -1;
    u.N = u.N || y === "a";
    const S = T ? p[3] : w(h, O, u);
    return u.N = !1, { O: a(p[2]), v: S, G: T, H: T ? y : p[1] };
  }, h: (p, h, u) => n(p.H, $t({ key: u.k }, p.O), p.G ? p.v : h(p.v, u)) }, c.htmlSelfClosing = { t: br(ko), i: ae.HIGH, l: (p) => ({ O: a(p[2] || ""), H: p[1] }), h: (p, h, u) => n(p.H, $t({}, p.O, { key: u.k })) });
  const f = function(p) {
    let h = Object.keys(p);
    function u(b, x) {
      let O = [], w = "";
...
function e0({ id: e, markdown: t }) {
  return /* @__PURE__ */ d("div", { id: e, className: "pr-prose", children: /* @__PURE__ */ d(Kb, { children: t }) });
}
const Jb = Eo((e, t) => /* @__PURE__ */ _(
  we,
  {
    ref: t,
    ...
    ...e,
    children: [
      /* @__PURE__ */ d(ac, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ d(
        gn,
        {
...
var Zb = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(Zb || {});
function t0({ id: e, groups: t }) {
  return /* @__PURE__ */ d("div", { id: e, children: /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ d(Vi, { asChild: !0, children: /* @__PURE__ */ d(Jb, {}) }),
    /* @__PURE__ */ d(yn, { children: t.map((r) => /* @__PURE__ */ _("div", { children: [
      /* @__PURE__ */ d(jr, { children: r.label }),
      /* @__PURE__ */ d(Kc, { children: r.items.map((n) => /* @__PURE__ */ d("div", { children: n.itemType === 0 ? /* @__PURE__ */ d(Po, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ d(Ui, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ d(wn, {})
    ] }, r.label)) })
  ] }) });
}
function r0({ id: e, message: t }) {
      ...
      children: [
        ...
        /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            /* @__PURE__ */ d(ic, { className: "pr-mr-1 pr-h-4 pr-w-4" }),
...
function Qb({ id: e, versionHistory: t }) {
...
function o0({
  ...
  return /* @__PURE__ */ d("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ _("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ d(Qb, { versionHistory: o }),
...
const tv = W.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d(
    ...
    {
      ref: r,
      className: z("pr-flex pr-flex-col pr-space-y-1.5 pr-p-6", e),
      ...t
    }
  )
);
tv.displayName = "CardHeader";
const rv = W.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d(
    "h3",
    {
      ref: r,
      className: z("pr-text-2xl pr-font-semibold pr-leading-none pr-tracking-tight", e),
      ...t,
      children: t.children
    }
  )
...
const nv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: z("pr-text-sm pr-text-muted-foreground", e), ...t }));
nv.displayName = "CardDescription";
const ov = W.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: z("pr-p-6 pr-pt-0", e), ...t })
);
ov.displayName = "CardContent";
const av = W.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: z("pr-flex pr-items-center pr-p-6 pr-pt-0", e), ...t })
);
av.displayName = "CardFooter";
const iv = To(
...
), sv = W.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: z(iv({ variant: t }), e), ...r }));
sv.displayName = "Alert";
const lv = W.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ _(
    "h5",
    {
      ref: r,
      className: z("pr-mb-1 pr-font-medium pr-leading-none pr-tracking-tight", e),
      ...t,
      children: [
        t.children,
        " "
...
lv.displayName = "AlertTitle";
const cv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: z("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
cv.displayName = "AlertDescription";
const pv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ _(
  vr.Root,
  {
    ref: r,
    className: z(
...
pv.displayName = vr.Root.displayName;
const dv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  so.Root,
  {
    className: z(
...
dv.displayName = so.Root.displayName;
function uv(e, t = "top") {
...
export {
  ...
  o0 as Footer,
  Lh as GridMenu,
  _g as HamburgerMenuButton,
  Iv as INVENTORY_STRING_KEYS,
  Vv as IconButton,
  vn as Input,
  Kv as InstallButton,
  Mv as Inventory,
  ...
  Xv as Toolbar,
  Qv as UpdateButton,
  Qb as VersionHistory,
  Hg as VerticalTabs,
  Wg as VerticalTabsContent,
  Gg as VerticalTabsList,
  qv as VerticalTabsTrigger,
  pp as buttonVariants,
  $o as getSortingIcon,
  Dv as inventoryCountColumn,
  Av as inventoryItemColumn,
  jv as inventoryStatusColumn,
  a0 as useEvent,
  i0 as useEventAsync,
  wo as usePromise
};
