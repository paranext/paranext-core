...
const nt = class D {
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new Dt(i)), n ? new D(n, a.toString(), w, c) : new D();
  }
  /**
...
function Fa({
  ...
  const i = Array.from({ length: e }, (c, p) => p + 1), w = H(
    (c) => {
      o(c);
    },
    [o]
...
function Ws({
  ...
  const o = W(), [s, i] = P(
    () => Mt(t, "English")
  ), [w, c] = P(""), [p, g] = P(t.book), [v, f] = P(t.chapterNum ?? 0), [h, k] = P(t.book), [S, N] = P(!1), [_, x] = P(S), [M, z] = P(!1), [B, mt] = P(), U = Z(void 0), y = Z(void 0), b = Z(void 0), I = Z(void 0), R = H(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (V, C) => {
    ...
    i(Mt(t, "English")), c(""), g(t.book), k(t.book);
  }, [t]), gt = H((m) => {
    if (K.current) {
      K.current = !1;
      return;
    ...
    (m, V, C, Y) => {
      if (f(t.book !== m ? 1 : t.chapterNum), V || Pt(m) === -1) {
        e({
          book: m,
          chapterNum: C ?? 1,
          verseNum: Y ?? 1
    ...
    (m) => {
      if (!S)
        ...
        return;
      } else m.key === "ArrowDown" ? (I != null && I.current ? I.current.focus() : b != null && b.current ? b.current.focus() : y.current && y.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === U.current && (N(!1), m.preventDefault(), m.stopPropagation());
      if (document.activeElement === U.current) {
        if (/^[a-zA-Z]$/.test(m.key) && (T(lt ? w + m.key : m.key), z(!0), m.preventDefault()), /^\d$/.test(m.key)) {
          const V = s;
          if (M)
            T(w + m.key);
          else {
  ...
  return ct(() => {
    tt === 1 ? f(1) : p === h ? p === t.book ? f(t.chapterNum) : f(1) : f(0);
  ...
  }, [_, et]), /* @__PURE__ */ l(ue, { modal: !1, open: S, onOpenChange: gt, children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          g(t.book), k(t.book), f(t.chapterNum > 0 ? t.chapterNum : 0), U.current.focus();
        },
        onFocus: () => {
    ...
    tt > 0 && /* @__PURE__ */ r(
      ne,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((m, V) => /* @__PURE__ */ l("div", { children: [
...
function Ge({
  ...
  const [N, _] = P(!1);
  return /* @__PURE__ */ l(fe, { open: N, onOpenChange: _, ...S, children: [
    ...
    /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ l(be, { children: [
          ...
          /* @__PURE__ */ r(xe, { children: e.map((x) => /* @__PURE__ */ l(
            Ne,
            {
              value: w(x),
              onSelect: () => {
...
function Qs({
  ...
  const g = Me(p, "%webView_bookSelector_currentBook%"), v = Me(p, "%webView_bookSelector_choose%"), f = Me(p, "%webView_bookSelector_chooseBooks%"), [h, k] = P(
    "current book"
    /* CURRENT_BOOK */
  ), S = (N) => {
    k(N), t(N);
...
function so({
  ...
  var N;
  const [w, c] = P([]), [p, g] = P([]), [v, f] = P({}), [h, k] = P({}), S = On({
    data: e,
    columns: t,
    getCoreRowModel: zn(),
...
function io({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Xr, {}) })
    ] }),
...
function ri({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(ue, { children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ l(F, { variant: "default", children: [
...
function mi({
  ...
  const p = bt(n, "%webView_inventory_all%"), g = bt(n, "%webView_inventory_approved%"), v = bt(n, "%webView_inventory_unapproved%"), f = bt(n, "%webView_inventory_unknown%"), h = bt(n, "%webView_inventory_scope_currentBook%"), k = bt(n, "%webView_inventory_scope_chapter%"), S = bt(n, "%webView_inventory_scope_verse%"), N = bt(n, "%webView_inventory_filter_text%"), _ = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, M] = P(!1), [z, B] = P("all"), [mt, U] = P(""), [y, b] = P([]), I = q(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), R = q(() => {
    if (x) return I;
    const T = [];
    return I.forEach((K) => {
...
const nr = u.forwardRef(
  ({
    ...
    const [p, g] = u.useState(t), v = e ?? p, f = u.useCallback(
      ...
      [n, v]
    ), h = u.useCallback(() => f((M) => !M), [f]), k = v ? "expanded" : "collapsed", _ = W() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = u.useMemo(
      () => ({
        state: k,
        open: v,
        setOpen: f,
...
function fi({
  ...
  const [c, p] = P([]), [g, v] = P([{ id: Nt, desc: !1 }]), [f, h] = P({}), k = q(
  ...
  ct(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const I = k.find((R) => Sn(R) === b[0]) || void 0;
        I && w(I);
      }
    }
  }, [f, k, w, N]);
  ...
  }, mt = (y, b) => y.getIsGrouped() ? "" : d("banded-row", b % 2 === 0 ? "even" : "odd"), U = (y, b, I) => {
    if (!((y == null ? void 0 : y.length) === 0 || b.depth < I.column.getGroupedIndex())) {
      if (b.getIsGrouped())
        switch (b.depth) {
          case 1:
            return "tw-ps-4";
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ r(Ke, {}) : /* @__PURE__ */ r(na, {})),
                          " ",
...
function Uo({
  ...
  const z = q(() => O.allBookIds.filter(
    ...
    (b) => {
      const I = mn(z, b).map((R) => R);
      n(
        cr(z, b, e) ? e.filter((R) => !I.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...I])]
      );
    },
    [e, n, z]
  ), U = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(fe, { open: N, onOpenChange: _, children: [
      /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ l(
        F,
        {
          variant: "outline",
        ...
        be,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: U, children: c }),
              /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: y, children: p })
            ] }),
            /* @__PURE__ */ l(xe, { children: [
              /* @__PURE__ */ r(ye, { children: g }),
              Object.values(kt).map((b, I) => {
                const R = z.filter(
                  ($) => It($) === b
                );
                if (R.length !== 0)
                  return /* @__PURE__ */ l(En, { children: [
                    ...
                    I < Object.values(kt).length - 1 && /* @__PURE__ */ r(qn, {})
                  ] }, b);
              })
            ] })
          ]
...
function bi({
  ...
  const c = Vt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), v = Vt(i, "%webView_scope_selector_current_book%"), f = Vt(i, "%webView_scope_selector_choose_books%"), h = Vt(i, "%webView_scope_selector_scope%"), k = Vt(i, "%webView_scope_selector_select_books%"), S = [
...
function Rn({
  ...
  return /* @__PURE__ */ l(ue, { variant: s, children: [
    /* @__PURE__ */ r(tn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(ra, {}) }) }),
...
function ts({
  ...
  const o = Z(void 0), s = Z(void 0), i = Z(void 0), w = Z(void 0), c = Z(void 0), p = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (k = s.current) == null || k.focus(), Kt(s, [f, h]);
        break;
      case "alt+l":
        (S = i.current) == null || S.focus(), Kt(i, [f, h]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), Kt(w, [f, h]);
        break;
      case "alt+h":
        (_ = c.current) == null || _.focus(), Kt(c, [f, h]);
        break;
    }
  }), ct(() => {
