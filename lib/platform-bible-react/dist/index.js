...
var yt = (t, e, n) => vs(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as it } from "react/jsx-runtime";
import v, { forwardRef as on, useRef as H, useMemo as F, useState as S, useCallback as K, useLayoutEffect as St, createContext as Cn, useContext as gr, useEffect as Y, Component as xs, createElement as jr, Suspense as ys, Fragment as bo } from "react";
import { Command as kt } from "cmdk";
import { X as an, Search as vo, Check as Ut, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Wn, ChevronRight as Oe, ArrowLeft as Ns, ArrowRight as ks, Circle as En, ChevronDown as je, BoldIcon as _s, ItalicIcon as Cs, AtSign as xo, Pencil as Es, Trash2 as Ts, ArrowUp as yo, MoreHorizontal as Rs, MailOpen as Ss, Mail as Ds, ChevronUp as No, FilterIcon as Ms, ArrowLeftIcon as Is, ChevronLeftIcon as Os, ChevronRightIcon as As, ArrowRightIcon as Ps, Copy as ko, Filter as $s, User as Ls, Link as Vs, CircleHelp as js, ChevronsUpDown as _o, Star as zs, Undo as Fs, Redo as Bs, SquareX as Co, FunctionSquare as Eo, SquareSigma as To, Ban as Ks, AlertCircle as Jn, CircleCheckIcon as Gs, CircleXIcon as Us, CircleHelpIcon as qs, ArrowUpIcon as Hs, ArrowDownIcon as Ys, PanelLeft as Xs, PanelRight as Ws, ScrollText as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as ti, MoreVertical as Kr, LoaderCircle as ei, GripVertical as ni } from "lucide-react";
...
import { includes as cn, Section as X, getChaptersForBook as ai, formatScrRef as xe, getSectionForBook as Xe, formatRelativeDate as si, formatReplacementString as ve, sanitizeHtml as ii, NumberFormat as li, formatBytes as wi, getCurrentLocale as ci, usfmMarkers as fn, getFormatCallerFunction as di, deepEqual as pi, isString as Gr, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as So, $getRoot as de, $createParagraphNode as Tn, $getSelection as $t, HISTORY_MERGE_TAG as br, ParagraphNode as Do, TextNode as Mo, $isTokenOrSegmented as ui, $getCharacterOffsets as mi, $cloneWithPropertiesEphemeral as fi, $findMatchingParent as Io, $isElementNode as we, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as Oo, COMMAND_PRIORITY_EDITOR as Ao, mergeRegister as pe, shallowMergeConfig as hi, defineExtension as qt, safeCast as sn, createState as gi, FORMAT_TEXT_COMMAND as Po, $isNodeSelection as $o, COMMAND_PRIORITY_LOW as Lo, RootNode as bi, LineBreakNode as vi, TabNode as xi, $isEditorState as yi, createCommand as Ni, CLICK_COMMAND as ki, isDOMNode as _i, $getNodeFromDOMNode as Ci, $createNodeSelection as Ei, $setSelection as Ti, DecoratorNode as Qn, $getState as Ri, toggleTextFormatType as Ur, TEXT_TYPE_TO_FORMAT as Si, $setState as Di, addClassNamesToElement as Vo, $create as Mi, $getNodeByKey as Ii, removeClassNamesFromElement as Oi, KEY_TAB_COMMAND as Ai, $isBlockElementNode as bn, $createRangeSelection as Pi, $normalizeSelection__EXPERIMENTAL as $i, OUTDENT_CONTENT_COMMAND as Li, INDENT_CONTENT_COMMAND as qr, INSERT_TAB_COMMAND as Vi, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as ji, $isParagraphNode as zi, $isTextNode as vn, SELECTION_CHANGE_COMMAND as jo, getRegisteredNode as Fi, isHTMLElement as Bi, isDocumentFragment as Hr, isDOMDocumentNode as Ki, ArtificialNode__DO_NOT_USE as zo, $createLineBreakNode as Fo, $isRootOrShadowRoot as Gi, isBlockDomNode as Yr, isInlineDomNode as Xr, $insertNodes as Ui } from "lexical";
...
import { useReactTable as Uo, getFilteredRowModel as tl, getSortedRowModel as qo, getPaginationRowModel as el, getCoreRowModel as Ho, flexRender as We, getGroupedRowModel as nl, getExpandedRowModel as rl } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import ol from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as tr, HIDDEN_NOTE_CALLER as er, getDefaultViewOptions as al, isInsertEmbedOpOfType as dn, Editorial as sl } from "@eten-tech-foundation/platform-editor";
...
const dl = Pt.Root, pl = Pt.Portal, Yo = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pt.Overlay,
  {
    ref: n,
    className: f(
...
Yo.displayName = Pt.Overlay.displayName;
const Xo = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ht();
        ...
        children: [
          ...
          /* @__PURE__ */ p(
            Pt.Close,
            {
              ...
              children: [
                /* @__PURE__ */ r(an, { className: "tw-h-4 tw-w-4" }),
...
Xo.displayName = Pt.Content.displayName;
...
const Jo = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pt.Title,
  {
    ref: n,
...
Jo.displayName = Pt.Title.displayName;
...
ul.displayName = Pt.Description.displayName;
...
const Be = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
...
oe.displayName = kt.List.displayName;
const ln = v.forwardRef((t, e) => /* @__PURE__ */ r(kt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
ln.displayName = kt.Empty.displayName;
const Gt = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  kt.Group,
  {
    ref: n,
    className: f(
...
Gt.displayName = kt.Group.displayName;
...
yr.displayName = kt.Separator.displayName;
...
const ea = on(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? ze : "button", { className: f(na({ variant: e, size: n, className: t })), ref: s, ...a })
);
B.displayName = "Button";
const ae = Ae.Root, fe = Ae.Trigger, fl = Ae.Anchor, Yt = v.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ht();
...
function hl({
  ...
  return /* @__PURE__ */ p(ae, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(oe, { children: /* @__PURE__ */ r(Gt, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      Ht,
      {
        onSelect: () => h(u),
      ...
      if (i) {
        ...
        if (!d && c) {
          const u = ((g) => Object.keys(ye).find(
            (b) => ye[b].toLowerCase() === g.toLowerCase()
          ))(l);
...
function vl(t, e, n, o) {
  const a = K(() => {
    if (t.chapterNum > 1)
      ...
      if (c > 0) {
        const w = e[c - 1], d = Math.max(Kt(w), 1);
        o({
          book: w,
          chapterNum: d,
          verseNum: 1
...
function Jr({
  ...
  if (t)
    return /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Kt(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Ht,
      {
        value: `${t} ${ye[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function yp({
  ...
  const w = ht(), [d, m] = S(!1), [h, u] = S(""), [g, b] = S(""), [x, E] = S("books"), [y, k] = S(void 0), [_, z] = S(!1), V = H(void 0), R = H(void 0), $ = H(void 0), C = H(void 0), D = H({}), j = K(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
  ), P = F(() => o ? o() : ta, [o]), O = F(() => ({
    [X.OT]: P.filter((N) => ut.isBookOT(N)),
    [X.NT]: P.filter((N) => ut.isBookNT(N)),
    [X.DC]: P.filter((N) => ut.isBookDC(N)),
    [X.Extra]: P.filter((N) => ut.extraBooks().includes(N))
  }), [P]), A = F(() => Object.values(O).flat(), [O]), W = F(() => {
    if (!g.trim()) return O;
    const M = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (M) => {
      const N = x === "chapters" ? y : I == null ? void 0 : I.book;
      N && (j({
        book: N,
        chapterNum: M,
        verseNum: 1
      }), m(!1), E("books"), k(void 0), b(""));
    },
    [j, x, y, I]
  ), Tt = K(
    (M) => {
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: N, isDigit: L } = Wr(M.key);
      if (x === "chapters") {
        if (M.key === "Backspace") {
        ...
        if (N || L) {
          if (M.preventDefault(), M.stopPropagation(), E("books"), k(void 0), L && y) {
            const U = ye[y];
            b(`${U} ${M.key}`);
          } else
            b(M.key);
      ...
      if ((x === "chapters" || x === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        const U = x === "chapters" ? y : I == null ? void 0 : I.book;
        if (!U) return;
        const q = (() => {
          if (!h) return 1;
          const ct = h.match(/(\d+)$/);
    ...
    const { isLetter: N, isDigit: L } = Wr(M.key);
    (N || L) && (M.preventDefault(), b((U) => U + M.key), R.current.focus(), z(!1));
  }, []);
  return St(() => {
    const M = setTimeout(() => {
      if (d && x === "books" && $.current && C.current) {
        const N = $.current, L = C.current, U = L.offsetTop, q = N.clientHeight, lt = L.clientHeight, tt = U - q / 2 + lt / 2;
        N.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), u(ar(t.book));
    ...
    if (x === "chapters" && y) {
      ...
      setTimeout(() => {
        if ($.current)
          if (M) {
            const N = D.current[t.chapterNum];
      ...
      re,
      {
        ...
        children: [
          x === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: gt.map(({ onClick: M, disabled: N, title: L, icon: U }) => /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
                size: "sm",
            ...
            y && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ie(y, a) })
          ] }),
          !_ && /* @__PURE__ */ p(oe, { ref: $, children: [
            x === "books" && /* @__PURE__ */ p(it, { children: [
              !I && Object.entries(W).map(([M, N]) => {
                if (N.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Gt, { heading: Wt(M), children: N.map((L) => /* @__PURE__ */ r(
                      ea,
                      {
                        bookId: L,
                        onSelect: (U) => Ct(U),
              ...
              I && /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r(
                Ht,
                {
              ...
              I && Kt(I.book) > 1 && /* @__PURE__ */ p(it, { children: [
...
), ft = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ro.Root, { ref: n, className: f("pr-twp", xl(), t), ...e }));
ft.displayName = Ro.Root.displayName;
...
const xn = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tn.Item,
  {
    ref: n,
    className: f(
...
function sr({
  ...
  const [y, k] = S(!1), _ = c ?? l, z = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], V = (R, $) => {
    const C = l(R), D = typeof R == "object" && "secondaryLabel" in R ? R.secondaryLabel : void 0, j = `${$ ?? ""}${C}${D ?? ""}`;
    return /* @__PURE__ */ p(
      Ht,
      {
        value: C,
  ...
  return /* @__PURE__ */ p(ae, { open: y, onOpenChange: k, ...E, children: [
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(re, { children: [
          /* @__PURE__ */ r(Be, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(ln, { children: h }),
          /* @__PURE__ */ r(oe, { children: z(e) ? e.map((R) => /* @__PURE__ */ r(Gt, { heading: R.groupHeading, children: R.options.map(($) => V($, R.groupHeading)) }, R.groupHeading)) : e.map((R) => V(R)) })
        ] })
      }
    )
  ] });
...
function _p({
  ...
  const d = Vn(w, "%webView_bookSelector_currentBook%"), m = Vn(w, "%webView_bookSelector_choose%"), h = Vn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), b = (x) => {
    g(x), t(x);
    ...
    _r,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(ft, { className: "tw-flex tw-items-center", children: o.map((x) => ut.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            B,
            {
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, _l = oa ? St : Y, pn = { tag: br };
function Cl({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = kl(null, o), d = So({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Tn();
            u.append(g);
            const b = oa ? document.activeElement : null;
            ($t() !== null || b !== null && b === m.getRootElement()) && g.select();
          }
        }, pn);
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : Y;
...
const Cr = {
  ...
  mark: "",
  markOverlap: ""
}, Dt = _e.Provider, Lt = _e.Root, Vt = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  _e.Trigger,
  {
    ref: o,
...
Vt.displayName = _e.Trigger.displayName;
const Mt = v.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(_e.Portal, { children: /* @__PURE__ */ r(
  _e.Content,
  {
    ref: o,
    sideOffset: e,
...
Mt.displayName = _e.Content.displayName;
const Er = [
  Hi,
  Do,
  Mo,
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : Y;
function Ol(t) {
...
function Pl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !ui(e) && o !== null) {
    ...
    if (w || d) {
      ...
      let x, E = 0;
      u ? (E = m > h ? h : m, x = m > h ? m : h) : g ? (E = i ? h : m, x = void 0) : b && (E = 0, x = i ? m : h);
      const y = e.__text.slice(E, x);
...
function Vl(t) {
  const e = Io(t, (n) => we(n) && !n.isInline());
  return we(e) || $l(4, t.__key), e;
}
function jl(t) {
  const e = $t();
  if (!ke(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Io(s, (w) => we(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
function Kl(t) {
  ...
  ia(this), Z = t, this.f &= -2, 8 & this.f && Tr(this), Sn();
}
function Me(t, e) {
...
Nt.prototype.brand = zl, Nt.prototype.h = function() {
  ...
  if (this.g = hn, this.f |= 1, this.i > 0 && !sa(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    to(this), Z = this;
    const e = this.x();
...
function ca(t, e = wa) {
  return t.registerCommand(Oo, (n) => (t.update(e), !0), Ao);
}
qt({ build: (t, e, n) => Dn(e), config: sn({ $onClear: wa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return ue(() => ca(t, o.value));
} });
function Gl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const zn = gi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class da extends Qn {
  $config() {
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [da], register: (t, e, n) => t.registerCommand(Po, (o) => {
  const a = $t();
  if ($o(a) || ke(a)) for (const s of a.getNodes()) Ul(s) && s.toggleFormat(o);
  return !1;
}, Lo) });
function pa(t, e) {
  let n;
...
const Rr = 0, cr = 1, ma = 2, Fn = 3, un = 4, De = 5, Bn = 6, qe = 7;
function Kn(t) {
  return t.id === Rr;
}
function fa(t) {
...
function ql(t) {
  return function(e) {
    return e.id === cr;
  }(t) || et(305, String(t.id), String(cr)), Object.assign(t, { id: ma });
}
...
class Yl {
  ...
  register(e, n) {
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== qe && et(309, String(o.id), String(qe)), this.state = function(i) {
...
const Wl = qt({ config: sn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: t = Xl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [bi, Mo, vi, xi, Do] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function Jl(t) {
  throw t;
...
class Ze {
  ...
  static maybeFromEditor(e) {
    const n = e[no];
    return n && (n.PACKAGE_VERSION !== Gn && et(292, n.PACKAGE_VERSION, Gn), n instanceof Ze || et(293)), n;
  }
  static fromEditor(e) {
...
const Zl = /* @__PURE__ */ new Set(), oo = qt({ build(t, e, n) {
  const o = n.getDependency(wr).output, a = en({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = pa(() => {
  }, () => ue(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let c, w = !1;
    o.value.read(() => {
      if ($t()) for (const [d, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(d);
          continue;
        }
...
qt({ dependencies: [wr, oo], name: "@lexical/extension/HorizontalRule", nodes: () => [Pe], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(oo).output, a = en({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return pe(t.registerCommand(ki, (i) => {
    if (_i(i.target)) {
      const l = Ci(i.target);
      if (tw(l)) return function(c, w = !1) {
        const d = $t(), m = c.isSelected(), h = c.getKey();
        let u;
        w && $o(d) ? u = d : (u = Ei(), Ti(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Lo), t.registerMutationListener(Pe, (i, l) => {
    Fl(() => {
      let c = !1;
      ...
      for (const [d, m] of i.entries()) if (m === "destroyed") w.delete(d), c = !0;
        ...
        h ? h.domNode.value = u : (c = !0, w.set(d, { domNode: en(u), selectedSignal: o(d) }));
      }
      c && (a.value = { nodeSelections: w });
    });
  }), ue(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) i.push(ue(() => {
      const w = l.value;
      w && (c.value ? Vo(w, s) : Oi(w, s));
    }));
    return pe(...i);
  }));
} });
...
function ew(t, e, n = ga) {
  return pe(t.registerCommand(Ai, (o) => {
    const a = $t();
    if (!ke(a)) return !1;
    o.preventDefault();
    const s = function(i) {
...
qt({ build: (t, e, n) => Dn(e), config: sn({ $canIndent: ga, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                const b = g.anchor;
                let x = b.getNode(), E = 0, y = 0;
                if (vn(x) && w >= 0 && d >= 0 && (E = w, y = w + d, g.setTextNodeRange(x, E, x, y)), E === y && m === "" || (g.insertRawText(m), x = b.getNode()), vn(x)) {
                  E = h, y = h + u;
                  const k = x.getTextContentSize();
                  E = E > k ? k : E, y = y > k ? k : y, g.setTextNodeRange(x, E, x, y);
                }
...
qt({ build: (t, e, n) => Dn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ue(() => n.getOutput().disabled.value ? void 0 : va(t)) });
function sw(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Sr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : Y;
...
function ww({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Sr(() => pe(Xi(a), va(a)), [a]);
  }(o), p(it, { children: [t, r(cw, { content: e }), r(lw, { editor: o, ErrorBoundary: n })] });
}
...
const pw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : Y;
function uw({ onClear: t }) {
  const [e] = Xt();
  return pw(() => ca(e, t), [e, t]), null;
}
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : Y;
function mw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: b, role: x = "textbox", spellCheck: E = !0, style: y, tabIndex: k, "data-testid": _, ...z }, V) {
  const [R, $] = S(t.isEditable()), C = K((j) => {
    j && j.ownerDocument && j.ownerDocument.defaultView ? t.setRootElement(j) : t.setRootElement(null);
  }, [t]), D = F(() => /* @__PURE__ */ function(...j) {
    return (P) => {
      for (const O of j) typeof O == "function" ? O(P) : O != null && (O.current = P);
    };
  }(V, C), [C, V]);
  return xa(() => ($(t.isEditable()), t.registerEditableListener((j) => {
    $(j);
  })), [t]), r("div", { "aria-activedescendant": R ? e : void 0, "aria-autocomplete": R ? n : "none", "aria-controls": R ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": R && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": d, "aria-owns": R ? m : void 0, "aria-readonly": !R || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: R, "data-testid": _, id: b, ref: D, role: x, spellCheck: E, style: y, tabIndex: k, ...z });
}
const fw = on(mw);
function so(t) {
  return t.getEditorState().read(ba(t.isComposing()));
...
function gw(t, e) {
  ...
  return p(it, { children: [r(fw, { editor: a, ...o, ref: e }), n != null && r(bw, { editor: a, content: n })] });
}
function bw({ content: t, editor: e }) {
  const n = function(i) {
    ...
    return xa(() => {
      ...
      return w(), pe(i.registerUpdateListener(() => {
        w();
  ...
  if (St(() => (a(e.isEditable()), e.registerEditableListener((i) => {
    a(i);
  })), [e]), !n) return null;
  let s = null;
...
function yw() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(dl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Xo, { children: [
...
function Nw({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = yw(), c = () => {
  };
...
_w.displayName = Bo.Root.displayName;
const _a = v.createContext({
  size: "default",
  variant: "default"
...
const Qe = v.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = v.useContext(_a);
  return /* @__PURE__ */ r(
    Rn.Item,
    {
      ref: s,
...
Qe.displayName = Rn.Item.displayName;
const io = [
...
function Ca(t, e, n, o = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], b = Ca(t, g, h, o);
    !a && we(e) && b && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Bi(d) || Hr(d)) && d.append(h), n.append(d), m) {
      const u = m.call(i, d);
...
function Ta(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  const c = function(g, b) {
    const { nodeName: x } = g, E = b._htmlConversions.get(x.toLowerCase());
    let y = null;
  ...
  let h = [];
  const u = (l == null || !Gi(l)) && (l != null && bn(l) || o);
  ...
  }(t) && (i = i.concat(Fo())) : we(l) && l.append(...h), i;
}
function Mw(t, e, n) {
...
const Ce = v.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Go.Root,
  {
    ref: a,
    decorative: n,
...
Ce.displayName = Go.Root.displayName;
const Ow = ne(
...
function Da({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      "data-orientation": e,
      className: f("pr-twp", Ow({ orientation: e }), t),
      ...n
    }
  );
}
...
function Oa({
  ...
  const l = lo(a, "%cancelButton_tooltip%"), c = lo(a, "%acceptButton_tooltip%");
  return /* @__PURE__ */ p(Da, { children: [
    /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
      ...
      /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ r("p", { children: l }) })
    ] }) }),
    (i === "secondary" || i === "default") && /* @__PURE__ */ r(Ma, {}),
    /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(
        B,
        {
      ...
      /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ r("p", { children: c }) })
    ] }) })
  ] });
}
function gn(t, e) {
...
function Cp({
  ...
  const [a, s] = S(Aw), [i, l] = S(void 0), [c, w] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let b = !0;
    const x = m.current;
    if (!x) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
        ...
        Yt,
        {
          ...
          children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(oe, { children: t.map((b) => /* @__PURE__ */ r(
            Ht,
            {
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ r("span", { children: Un(b, o) })
            },
            b || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), n()) : Ir(b) && (b.preventDefault(), b.stopPropagation(), At(a) && h());
        },
        onKeyDown: (b) => {
          Mr(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          yn,
          {
...
const Ep = Object.freeze([
  ...
  const a = H(null), [s, i] = S(void 0), [l, c] = S(void 0), w = K(
    ...
    (u) => {
      var R;
      const g = u.target, b = ($) => $ ? document.getElementById($) : void 0, x = b(l), E = b(s);
      if (!!(x && g && x.contains(g) && g !== x) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if ($.length === 0) return;
          const C = $.findIndex((j) => j === g);
          if (C === -1) return;
          let D;
          u.key === "ArrowDown" ? D = Math.min(C + 1, $.length - 1) : D = Math.max(C - 1, 0), D !== C && (u.preventDefault(), u.stopPropagation(), (R = $[D]) == null || R.focus());
          return;
        }
        return;
      }
      const _ = t.findIndex(($) => $.id === s);
      let z = _;
      switch (u.key) {
        case "ArrowDown":
          z = Math.min(_ + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          z = Math.max(_ - 1, 0), u.preventDefault();
          break;
        case "Home":
...
const $a = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Fe.Root,
  {
    ref: n,
    className: f(
...
Kw.displayName = Fe.Image.displayName;
...
}), Ee = nt.Trigger, Va = nt.Group, Gw = nt.Portal, Uw = nt.Sub, qw = nt.RadioGroup;
...
const ja = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = zt();
  return /* @__PURE__ */ p(
    nt.SubTrigger,
    {
...
const kn = v.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = ht(), s = zt();
  return /* @__PURE__ */ r(
    nt.Item,
    {
...
const te = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ p(
    nt.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(nt.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const Fa = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ p(
    nt.RadioItem,
    {
...
Fa.displayName = nt.RadioItem.displayName;
const wn = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  nt.Label,
  {
    ref: o,
...
Ke.displayName = nt.Separator.displayName;
...
function wo({
  ...
  }, [t.date, n]), x = F(() => t.user, [t.user]), E = F(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = F(() => ii(t.contents), [t.contents]), k = F(() => {
    if (o && l)
      return /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ p(
          kn,
          {
            onClick: (_) => {
              _.stopPropagation(), w(!0), m(Iw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r($a, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(La, { className: "tw-text-xs tw-font-medium", children: E }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), u()) : Ir(_) && (_.preventDefault(), _.stopPropagation(), At(d) && g());
              },
              onKeyDown: (_) => {
                Mr(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
        ...
        k && /* @__PURE__ */ p(me, { children: [
          /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Rs, {}) }) }),
...
function Yw({
  ...
  const [R, $] = S(co), [C, D] = S(
    void 0
  ), j = o, [P, O] = S(!1), [A, W] = S(!1), [I, J] = S(!1), [Ct, It] = S(!1), [Tt, gt] = S(!1), [pt, G] = S(_), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
    ...
    let T = !0;
    if (!o) {
      It(!1), Wt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const mt = E ? await E(c) : !1;
      T && It(mt);
    })(), () => {
      T = !1;
    };
  }, [o, c, E]);
  const Ft = F(() => e.filter((T) => !T.deleted), [e]);
  Y(() => {
    let T = !0;
    if (!o || !k) {
      Wt(/* @__PURE__ */ new Map());
  ...
  const Jt = F(() => Ft[0], [Ft]), Se = H(null), ie = H(void 0), Zt = K(() => {
    var T;
    (T = ie.current) == null || T.call(ie), $(co);
  }, []), Ue = K(() => {
    const T = !pt;
  ...
  }, [s, n]), L = F(() => Ft.slice(1), [Ft]), U = F(() => L.length ?? 0, [L.length]), q = F(() => U > 0, [U]), lt = F(() => P || U <= 2 ? L : L.slice(-2), [L, U, P]), tt = F(() => P || U <= 2 ? 0 : U - 2, [U, P]), bt = F(
  ...
  const Et = K(
    ...
    async (T) => {
      const vt = At(R) ? Nn(R) : void 0, mt = await m({
        ...T,
        contents: vt,
        assignedUser: C ?? T.assignedUser
      });
      return mt && vt && Zt(), mt && C !== void 0 && D(void 0), mt;
    },
    [Zt, R, m, C]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ p(Pa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            N && /* @__PURE__ */ r($e, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: N }),
            /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
                ...
                children: pt ? /* @__PURE__ */ r(Ss, {}) : /* @__PURE__ */ r(Ds, {})
              }
            ),
            Tt && d !== "Resolved" && /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
                size: "icon",
          ...
          o && /* @__PURE__ */ p(it, { children: [
            ...
            x !== !1 && (!A || At(R)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Ir(T) && (T.preventDefault(), T.stopPropagation(), (At(R) || C !== void 0) && Et());
                },
                onKeyDown: (T) => {
                    ...
                    /* @__PURE__ */ p(ae, { open: I, onOpenChange: J, children: [
                      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
                        B,
                        {
                          ...
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !Ct || !b || b.length === 0 || !b.includes(i),
                      ...
                      /* @__PURE__ */ r(
                        Yt,
                        {
                          ...
                          children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(oe, { children: b == null ? void 0 : b.map((T) => /* @__PURE__ */ r(
                            Ht,
                            {
                              onSelect: () => {
                                D(T !== s ? T : void 0), J(!1);
...
function Rp({
  ...
  const [E, y] = S(/* @__PURE__ */ new Set()), [k, _] = S();
  Y(() => {
  ...
  const z = n.filter(
    ...
    (O) => {
      y((A) => new Set(A).add(O.id)), _(O.id), b == null || b(O.id);
    },
    [b]
  ), $ = K(
    (O) => {
      ...
      }), _(O), b == null || b(A ? void 0 : O);
    },
    [E, b]
  ), { listboxRef: C, activeId: D, handleKeyDown: j } = Lw({
    options: V,
    onOptionSelect: R
  }), P = K(
    (O) => {
      O.key === "Escape" ? (k && E.has(k) && (y((A) => {
        const W = new Set(A);
        return W.delete(k), W;
      }), _(void 0), b == null || b(void 0)), O.preventDefault(), O.stopPropagation()) : j(O);
    },
    [k, E, j, b]
  );
  return /* @__PURE__ */ r(
...
const Le = dt.Root, Ww = dt.Group, Ve = dt.Value, Jw = ne(
...
), Te = v.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = ht();
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
...
const Ba = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.ScrollUpButton,
  {
    ref: n,
...
const Re = v.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = ht();
...
const Rt = v.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  dt.Item,
  {
    ref: o,
    className: f(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(dt.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(dt.ItemText, { children: e })
    ]
  }
));
Rt.displayName = dt.Item.displayName;
      ...
      /* @__PURE__ */ p(
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Re, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(Rt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const Mn = v.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
  ...
  v.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        nn(i, '[tabindex]:not([tabindex="-1"])').forEach((d) => {
...
const In = v.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: f(
...
const On = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? nn(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
const rn = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "th",
  {
    ref: n,
    className: f(
...
function ic({
  ...
  var V;
  const [d, m] = S([]), [h, u] = S([]), [g, b] = S({}), [x, E] = S({}), y = F(() => e ?? [], [e]), k = Uo({
    data: y,
    columns: t,
    getCoreRowModel: Ho(),
  ...
  let z;
  return c ? z = Array.from({ length: 10 }).map((C, D) => `skeleton-row-${D}`).map((C) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : ((V = k.getRowModel().rows) == null ? void 0 : V.length) > 0 ? z = k.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    Qt,
    {
      onClick: () => i(R, k),
      "data-state": R.getIsSelected() && "selected",
      children: R.getVisibleCells().map(($) => /* @__PURE__ */ r(Ne, { children: We($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    R.id
  )) : z = /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Xw, { table: k }),
    /* @__PURE__ */ p(Mn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(In, { stickyHeader: s, children: k.getHeaderGroups().map((R) => /* @__PURE__ */ r(Qt, { children: R.headers.map(($) => /* @__PURE__ */ r(rn, { className: "tw-p-0", children: $.isPlaceholder ? void 0 : We($.column.columnDef.header, $.getContext()) }, $.id)) }, R.id)) }),
      /* @__PURE__ */ r(On, { children: z })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(ko, {}) })
        ] }),
...
function Ip({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(me, { children: [
    /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ p(B, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((w, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Va, { children: w.itemType === 0 ? /* @__PURE__ */ r(it, { children: w.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][h],
        ...
        qw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Fa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ke, {})
    ] }, w.label)) })
...
function pc({
  ...
  const [E, y] = S(!1), k = K(
    (D) => {
      var P;
      const j = (P = t.find((O) => O.label === D)) == null ? void 0 : P.value;
      j && n(
        e.includes(j) ? e.filter((O) => O !== j) : [...e, j]
      );
    },
    [t, e, n]
  ), _ = () => c || o, z = F(() => {
    if (!h) return t;
    const D = t.filter((P) => P.starred).sort((P, O) => P.label.localeCompare(O.label)), j = t.filter((P) => !P.starred).sort((P, O) => {
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ p(ae, { open: $, onOpenChange: d ?? y, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
      B,
      {
        variant: b,
      ...
      return /* @__PURE__ */ p($e, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          B,
          {
            ...
            children: /* @__PURE__ */ r(an, { className: "tw-h-3 tw-w-3" })
          }
        ),
...
function mc({
  ...
  const c = F(() => /Macintosh/i.test(navigator.userAgent), []), w = mo(a, "%undoButton_tooltip%"), d = mo(a, "%redoButton_tooltip%");
  return /* @__PURE__ */ p(Da, { children: [
    /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(
        B,
      ...
      /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p("p", { children: [
        ...
        s && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ r(pr, { children: c ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (l === "secondary" || l === "default") && /* @__PURE__ */ r(Ma, {}),
    e && /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(
        B,
        {
          "aria-label": d,
      ...
      /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p("p", { children: [
        ...
        s && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ r(pr, { children: c ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const hc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(it, { children: [
...
function gc({
  ...
  const g = (x) => {
    ...
    var E, y, k, _;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((E = s.current) == null || E.focus(), l.current = !0) : document.activeElement === s.current && x.key === "ArrowUp" ? ((y = i.current) == null || y.focus(), l.current = !1) : document.activeElement === s.current && x.key === "ArrowLeft" && ((k = s.current) == null ? void 0 : k.selectionStart) === 0 && ((_ = i.current) == null || _.focus(), l.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ p(me, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: hc(t, a, n) }) }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            te,
            {
              ...
              onClick: (x) => {
                var E;
                x.stopPropagation(), l.current = !0, (E = s.current) == null || E.focus();
              },
...
const bc = (t, e) => t === "f" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ r(Eo, {}),
  " ",
...
function xc({
  ...
  return /* @__PURE__ */ p(me, { children: [
    /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(qi, { asChild: !0, children: /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: bc(t, n) }) }) }),
      /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ r("p", { children: vc(t, n) }) })
    ] }) }),
...
function kc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  ...
  return /* @__PURE__ */ p(re, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(oe, { children: [
      ...
      /* @__PURE__ */ r(Gt, { children: s.map((l) => {
        var c;
        return /* @__PURE__ */ r(
          fo,
          {
      ...
      i.length > 0 && /* @__PURE__ */ p(it, { children: [
        ...
        /* @__PURE__ */ r(Gt, { children: i.map((l) => {
          var c;
          return /* @__PURE__ */ r(
            fo,
            {
...
function $p({
  ...
  const [g, b] = S("generated"), [x, E] = S("*"), [y, k] = S("f"), [_, z] = S(!1), [V, R] = S(!0), [$, C] = S(!1), D = H(!1), j = H(""), [P, O] = S(!1), [A, W] = S(), [I, J] = S(), [Ct, It] = S(), [Tt, gt] = S(), pt = H(null), G = F(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (L && dn("note", L)) {
      ...
      let tt = "custom";
      lt === tr ? tt = "generated" : lt === er ? tt = "hidden" : lt && E(lt), b(tt), k(((q = L.insert.note) == null ? void 0 : q.style) ?? "f"), N = setTimeout(() => {
        var bt;
  ...
  const st = K(
    (N, L, U = !1) => {
      ...
      if (q && dn("note", q)) {
        if (q.insert.note) {
          let ct;
          N === "custom" ? ct = L : N === "generated" ? ct = tr : ct = er, q.insert.note.caller = ct;
        }
  ...
  const Ft = () => {
    var L;
    const N = (L = m.current) == null ? void 0 : L.getElementsByClassName("editor-input")[0];
    ...
    if (L && dn("note", L)) {
      L.insert.note && (L.insert.note.style = N);
      const ct = (tt = (lt = L.insert.note) == null ? void 0 : lt.contents) == null ? void 0 : tt.ops;
      y !== "x" && N === "x" ? ct == null || ct.forEach((Et) => Cc(Et)) : y === "x" && N !== "x" && (ct == null || ct.forEach((Et) => Ec(Et))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (N) => {
    gt(N.contextMarker), C(N.canRedo);
  }, Ue = K(
    (N) => {
      var U, q, lt, tt, bt;
      const L = (q = (U = d.current) == null ? void 0 : U.getNoteOps(0)) == null ? void 0 : q.at(0);
      if (L && dn("note", L)) {
        ...
        const ct = (lt = L.insert.note) == null ? void 0 : lt.style, Et = (bt = (tt = L.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (ct || z(!1), z(
          ct === "x" ? !!(Et != null && Et.every((Ot) => {
            var vt, mt;
            if (!((vt = Ot.attributes) != null && vt.char)) return !0;
            const T = ((mt = Ot.attributes) == null ? void 0 : mt.char).style;
          ...
          D.current = !0, j.current = JSON.stringify(L), R(!0);
          return;
        }
        R(JSON.stringify(L) === j.current), st(g, x);
      } else
        z(!1), R(!0);
    },
    [g, x, st]
    ...
    if (h.current && at.length && N && N.rangeCount > 0) {
      const L = N.getRangeAt(0).getBoundingClientRect(), U = h.current.getBoundingClientRect();
      W(L.left - U.left), J(L.top - U.top), It(L.height), O(!0);
    }
  }, [at, h]);
  return Y(() => {
    const N = () => {
    ...
    var N;
    P && ((N = pt.current) == null || N.focus());
  }, [P]), Y(() => {
    var U;
    const N = ((U = m.current) == null ? void 0 : U.querySelector(".editor-input")) ?? void 0, L = (q) => {
      !P && N && document.activeElement === N && q.key === l ? (q.preventDefault(), M()) : P && q.key === "Escape" && (q.preventDefault(), O(!1));
    };
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
              /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(
                B,
                {
                  onClick: Ft,
              ...
              /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ r("p", { children: c["%footnoteEditor_copyButton_tooltip%"] }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ p(it, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(it, { children: Rc(t.marker, l, o, w) })
      }
    )
  ] });
}
function Vp({
  ...
  const d = c ?? di(n, void 0), m = (y, k) => {
    w == null || w(y, k, a);
  }, h = s ? n.findIndex((y) => y === s) : -1, [u, g] = S(h), b = (y, k, _) => {
    if (n.length)
      switch (y.key) {
        case "Enter":
        case " ":
  ...
  return Y(() => {
    var y;
    u >= 0 && u < E.current.length && ((y = E.current[u]) == null || y.focus());
  }, [u]), /* @__PURE__ */ r(
    "div",
    {
      role: "listbox",
...
function Ic({
  ...
  return /* @__PURE__ */ p(Mn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(In, { stickyHeader: !0, children: /* @__PURE__ */ p(Qt, { children: [
      /* @__PURE__ */ r(rn, { children: a }),
      /* @__PURE__ */ r(rn, { children: s })
    ] }) }),
...
}, An = (t, e, n) => /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ p(Lt, { children: [
  /* @__PURE__ */ p(
    Vt,
    {
...
function qp({
  ...
  const u = Bt(n, "%webView_inventory_all%"), g = Bt(n, "%webView_inventory_approved%"), b = Bt(n, "%webView_inventory_unapproved%"), x = Bt(n, "%webView_inventory_unknown%"), E = Bt(n, "%webView_inventory_scope_currentBook%"), y = Bt(n, "%webView_inventory_scope_chapter%"), k = Bt(n, "%webView_inventory_scope_verse%"), _ = Bt(n, "%webView_inventory_filter_text%"), z = Bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = Bt(n, "%webView_inventory_no_results%"), [R, $] = S(!1), [C, D] = S("all"), [j, P] = S(""), [O, A] = S([]), W = F(() => {
    const G = t ?? [];
  ...
  }, [R, W]), J = F(() => I.length === 0 ? [] : $c(I, C, j), [I, C, j]), Ct = F(() => {
    var st, wt;
    if (!R) return c;
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ p(Re, { children: [
              ...
              /* @__PURE__ */ r(Rt, { value: "unapproved", children: b }),
              /* @__PURE__ */ r(Rt, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(Le, { onValueChange: (G) => Tt(G), defaultValue: i, children: [
        /* @__PURE__ */ r(Te, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Re, { children: [
          /* @__PURE__ */ r(Rt, { value: "book", children: E }),
          /* @__PURE__ */ r(Rt, { value: "chapter", children: y }),
          /* @__PURE__ */ r(Rt, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Ge,
...
const Vc = "16rem", jc = "3rem", Ua = v.createContext(void 0);
function Pn() {
  const t = v.useContext(Ua);
  if (!t)
...
const qa = v.forwardRef(
  ({
    ...
    const [w, d] = v.useState(t), m = e ?? w, h = v.useCallback(
      ...
      [n, m]
    ), u = v.useCallback(() => h((k) => !k), [h]), g = m ? "expanded" : "collapsed", E = ht() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = v.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ua.Provider, { value: y, children: /* @__PURE__ */ r(Dt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ha = v.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Pn();
...
const Hc = ne(
  ...
  ({
    ...
    const c = t ? ze : "button", { state: w } = Pn(), d = /* @__PURE__ */ r(
      c,
      {
        ref: l,
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Mt, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : d;
  }
);
    ...
    Ha,
    {
      ...
      children: /* @__PURE__ */ p(Xa, { children: [
        /* @__PURE__ */ p(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(Wa, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Ja, { children: /* @__PURE__ */ r(
            Za,
            {
              onClick: () => w(h),
              isActive: m(h),
...
const le = "scrBook", ed = "scrRef", be = "source", nd = "details", rd = "Scripture Reference", od = "Scripture Book", Qa = "Type", ad = "Details";
function sd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, ho = (t) => `${id({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Yp({
  sources: t,
  ...
  const [w, d] = S([]), [m, h] = S([{ id: le, desc: !1 }]), [u, g] = S({}), b = F(
    () => t.flatMap((C) => C.data.map((D) => ({
      ...D,
      source: C.source
    }))),
    [t]
  ...
  Y(() => {
    if (l) {
      const C = E.getSelectedRowModel().rowsById, D = Object.keys(C);
      if (D.length === 1) {
        const j = b.find((P) => ho(P) === D[0]) || void 0;
        j && l(j);
      }
    }
  }, [u, b, l, E]);
  const y = a ?? od, k = s ?? Qa, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [le] },
    ...
    !C.getIsGrouped() && !C.getIsSelected() && C.getToggleSelectedHandler()(D);
  }, R = (C, D) => C.getIsGrouped() ? "" : f("banded-row", D % 2 === 0 ? "even" : "odd"), $ = (C, D, j) => {
    if (!((C == null ? void 0 : C.length) === 0 || D.depth < j.column.getGroupedIndex())) {
      if (D.getIsGrouped())
        switch (D.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Re, { position: "item-aligned", children: /* @__PURE__ */ r(Ww, { children: _.map((C) => /* @__PURE__ */ r(Rt, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Mn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(In, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ r(Qt, { children: C.headers.filter((D) => D.column.columnDef.header).map((D) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(rn, { colSpan: D.colSpan, className: "top-0 tw-sticky", children: D.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(On, { children: E.getRowModel().rows.map((C, D) => {
        const j = ht();
        return /* @__PURE__ */ r(
          Qt,
          {
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ p(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (j === "ltr" ? /* @__PURE__ */ r(Oe, {}) : /* @__PURE__ */ r(Wn, {})),
                          " ",
                          We(P.column.columnDef.cell, P.getContext()),
                          " (",
                          C.subRows.length,
                          ")"
                        ]
...
}), ts = (t, e, n) => Lr(t, e).every((o) => n.includes(o));
function ld({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
...
function wd({
  ...
  }, [x, E] = S(!1), [y, k] = S(""), _ = H(void 0), z = H(!1);
  ...
  const V = F(() => ut.allBookIds.filter(
    ...
    (A, W = !1) => {
      ...
      const I = V.findIndex((gt) => gt === _.current), J = V.findIndex((gt) => gt === A);
      if (I === -1 || J === -1) return;
      const [Ct, It] = [
        Math.min(I, J),
        Math.max(I, J)
      ], Tt = V.slice(Ct, It + 1).map((gt) => gt);
      n(
        e.includes(A) ? e.filter((gt) => !Tt.includes(gt)) : [.../* @__PURE__ */ new Set([...e, ...Tt])]
      );
    },
    [e, n, V]
  ), C = (A) => {
    ...
    (A) => {
      const W = Lr(V, A).map((I) => I);
      n(
        ts(V, A, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, V]
  ), P = () => {
...
function Wp({
  ...
  const w = he(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = he(i, "%webView_scope_selector_current_book%"), u = he(i, "%webView_scope_selector_choose_books%"), g = he(i, "%webView_scope_selector_scope%"), b = he(i, "%webView_scope_selector_select_books%"), x = [
  ...
  ], E = e ? x.filter((y) => e.includes(y.value)) : x;
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        _r,
        {
          ...
          children: E.map(({ value: y, label: k, id: _ }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(xn, { className: "tw-me-2", value: y, id: _ }),
            /* @__PURE__ */ r(ft, { htmlFor: _, children: k })
          ] }, _))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(ft, { children: b }),
      /* @__PURE__ */ r(
        wd,
        {
          availableBookInfo: o,
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Re,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(Rt, { value: `${w}`, children: l[Q(w)] }, `${w}`))
          }
        )
      ]
    }
...
const ns = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ p(Lt, { children: [
  /* @__PURE__ */ r(Vt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r(Gw, { children: /* @__PURE__ */ r(za, { children: ns(
      t,
      e,
      es(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(me, { variant: s, children: [
    /* @__PURE__ */ r(Ee, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Zs, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(bo, { children: [
      /* @__PURE__ */ r(Va, { children: /* @__PURE__ */ r(Dt, { children: ns(e.groups, e.items, c, t) }) }),
      w < d.length - 1 && /* @__PURE__ */ r(Ke, {})
    ] }, c)) })
  ] });
}
...
const os = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    _t.Root,
    {
...
os.displayName = _t.List.displayName;
const as = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  _t.List,
  {
    ref: n,
    className: f(
...
as.displayName = _t.List.displayName;
...
)), ss = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  _t.Content,
  {
    ref: n,
    className: f(
...
ss.displayName = _t.Content.displayName;
function ru({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(os, { children: [
      /* @__PURE__ */ r(as, { children: t.map((l) => /* @__PURE__ */ r(cd, { value: l.value, children: l.value }, l.key)) }),
...
const is = v.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = v.useMemo(
    () => ({
      variant: e
    }),
...
const ls = v.forwardRef(({ className: t, ...e }, n) => {
  const o = zt();
  return /* @__PURE__ */ r(
    rt.Trigger,
    {
...
const ws = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = zt();
  return /* @__PURE__ */ p(
    rt.SubTrigger,
    {
...
const cs = v.forwardRef(({ className: t, ...e }, n) => {
  const o = zt();
  return /* @__PURE__ */ r(
    rt.SubContent,
    {
...
cs.displayName = rt.SubContent.displayName;
const ds = v.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = zt();
...
const ps = v.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
const ud = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ p(
    rt.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(rt.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const He = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, d) => w.order - d.order).map((w) => /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ p(
        ps,
        {
          onClick: () => {
            o(w);
          ...
          children: [
            w.iconPathBefore && /* @__PURE__ */ r(_n, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
            w.label,
            w.iconPathAfter && /* @__PURE__ */ r(_n, { icon: w.iconPathAfter, menuLabel: w.label })
          ]
        },
      ...
      w.tooltip && /* @__PURE__ */ r(Mt, { children: w.tooltip })
    ] }, `tooltip-${w.label}-${"command" in w ? w.command : w.id}`)), c = [...l];
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ r(us, {}, `separator-${s}`)), c;
  });
};
function hd({
  menuData: t,
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), He(s, [h, u]);
        break;
      case "alt+l":
        (b = i.current) == null || b.focus(), He(i, [h, u]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), He(l, [h, u]);
        break;
      case "alt+h":
        (E = c.current) == null || E.focus(), He(c, [h, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(is, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(dd, { children: [
      /* @__PURE__ */ r(ls, { ref: w(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        ds,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Dt, { children: ms(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
...
function su({
  ...
  const w = gd(
    ...
    var E, y, k, _, z, V;
    const x = b !== g ? ((y = (E = t[g]) == null ? void 0 : E.uiNames) == null ? void 0 : y[b]) ?? ((_ = (k = t[g]) == null ? void 0 : k.uiNames) == null ? void 0 : _.en) : void 0;
  ...
  return /* @__PURE__ */ p("div", { id: c, className: f("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(ft, { className: "tw-font-normal tw-text-muted-foreground", children: ve(w, {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && w && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(me, { children: [
              /* @__PURE__ */ r(Ee, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: w })
            ] }) }),
            e && w && /* @__PURE__ */ p(me, { children: [
              /* @__PURE__ */ r(Ee, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: w })
            ] })
          ] }),
...
const vd = on(({ className: t, ...e }, n) => /* @__PURE__ */ r(ei, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
const cu = ot.Root, du = ot.Trigger, pu = ot.Group, uu = ot.Portal, mu = ot.Sub, fu = ot.RadioGroup, _d = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
_d.displayName = ot.SubTrigger.displayName;
const Cd = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ot.SubContent,
  {
    ref: n,
...
Cd.displayName = ot.SubContent.displayName;
const Ed = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: f(
...
Ed.displayName = ot.Content.displayName;
...
Td.displayName = ot.Item.displayName;
const Rd = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ot.CheckboxItem,
  {
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
Rd.displayName = ot.CheckboxItem.displayName;
...
Sd.displayName = ot.RadioItem.displayName;
...
Dd.displayName = ot.Label.displayName;
...
Md.displayName = ot.Separator.displayName;
...
Od.displayName = "Drawer";
const hu = jt.Trigger, Ad = jt.Portal, gu = jt.Close, hs = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  jt.Overlay,
  {
    ref: n,
...
hs.displayName = jt.Overlay.displayName;
const Pd = v.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = v.useContext(fs), i = {
...
Vd.displayName = jt.Title.displayName;
...
jd.displayName = jt.Description.displayName;
...
zd.displayName = rr.Root.displayName;
function bu({
  className: t,
  ...e
}) {
...
Fd.displayName = Ye.Root.displayName;
...
Bd.displayName = or.Root.displayName;
const Nu = _t.Root, Kd = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    _t.List,
    {
...
Kd.displayName = _t.List.displayName;
...
Gd.displayName = _t.Trigger.displayName;
...
Ud.displayName = _t.Content.displayName;
