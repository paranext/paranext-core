...
var Ki = (t, e, r) => e in t ? Ui(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Ft = (t, e, r) => Ki(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Xt, Z as qi, B as K, c as f, a as Gi, C as Oe, P as Re, b as je, d as $e, e as Fe, f as Be, g as me, h as Nr, i as oa, T as qt, S as rr, j as Gt, k as Ht, l as Yt, D as Ye, m as xr, n as Te, o as ze, p as Se, q as tr, u as Hi, s as Cr, t as We, v as Ie, w as un, x as Yi, y as Wi, z as pn, A as hn, E as Xi, F as Ji, G as Zi, H as Qi, I as ha, J as ga, K as lr, L as ts, M as es, N as rs, O as as, Q as os, R as Er, U as Ya } from "./resizable-CX1Q8cJa.js";
import { V as og, W as ng, X as ig, Y as sg, _ as cg, $ as lg, a0 as dg, a1 as wg, a2 as ug } from "./resizable-CX1Q8cJa.js";
import { jsx as a, jsxs as u, Fragment as rt } from "react/jsx-runtime";
import { Canon as wt } from "@sillsdev/scripture";
import { includes as Ar, Section as Q, getChaptersForBook as ns, formatScrRef as Ce, getSectionForBook as mr, formatRelativeDate as is, formatReplacementString as Ne, sanitizeHtml as Wa, NumberFormat as ss, formatBytes as cs, getCurrentLocale as ls, usfmMarkers as Fr, getFormatCallerFunction as ds, deepEqual as ws, isString as yo, compareScrRefs as Ra, scrRefToBBBCCCVVV as fa, defaultScrRef as ma, formatScrRefRange as us, getLocalizeKeyForScrollGroupId as ko } from "platform-bible-utils";
import { Check as Ve, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as $a, ChevronRight as Ma, ArrowLeft as ps, ArrowRight as hs, ChevronDown as ar, BoldIcon as gs, ItalicIcon as fs, X as na, AtSign as gn, Pencil as ms, Trash2 as vs, ArrowUp as fn, MoreHorizontal as bs, MailOpen as xs, Mail as ys, ChevronUp as ks, FilterIcon as _s, ArrowLeftIcon as Ns, ChevronLeftIcon as Cs, ChevronRightIcon as Es, ArrowRightIcon as Ts, Copy as mn, Filter as zs, User as Ss, Link as Ds, CircleHelp as Os, ChevronsUpDown as vn, Star as Rs, Undo as $s, Redo as Ms, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as As, AlertCircle as Aa, CircleCheckIcon as Ps, CircleXIcon as Is, CircleHelpIcon as Vs, ArrowUpIcon as Ls, ArrowDownIcon as js, Search as Fs, LoaderCircle as Bs, ScrollText as Us, MenuIcon as Ks, Menu as qs, EllipsisVertical as Gs, MoreVertical as Eo } from "lucide-react";
import pt, { useRef as G, useMemo as P, useState as C, useCallback as F, useEffect as Y, useLayoutEffect as ee, createContext as Xa, useContext as kn, Component as Hs, createElement as To, Suspense as Ys, forwardRef as ia, useId as zo, Fragment as _n } from "react";
import { Dialog as ve, Label as Ws, RadioGroup as Pa, ToggleGroup as Nn, Slot as dr, Avatar as Ja, Select as Ut, Checkbox as So, Tabs as ue, Menubar as ye, ContextMenu as Rt, Progress as Do, Slider as Pr, Switch as Oo } from "radix-ui";
import { createEditor as Cn, $getRoot as Le, $createParagraphNode as Tr, $getSelection as Wt, HISTORY_MERGE_TAG as Za, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Xs, $isRangeSelection as be, $caretFromPoint as Js, $getSiblingCaret as zn, $getChildCaret as Zs, $getAdjacentChildCaret as Qs, $isChildCaret as tc, $normalizeCaret as ec, $setSelectionFromCaretRange as rc, $getCollapsedCaretRange as ac, $getCaretInDirection as Ro, $splitAtPointCaretNext as oc, $isTextPointCaret as nc, $findMatchingParent as Sn, $isElementNode as yr, mergeRegister as De, getDOMTextNode as ic, isHTMLElement as sc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as Qa, shallowMergeConfig as cc, defineExtension as se, safeCast as Xe, createState as lc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as Rn, COMMAND_PRIORITY_LOW as $n, RootNode as dc, LineBreakNode as wc, TabNode as uc, $isEditorState as pc, createCommand as hc, CLICK_COMMAND as gc, isDOMNode as fc, $getNodeFromDOMNode as mc, $createNodeSelection as vc, $setSelection as bc, $getEditor as xc, DecoratorNode as Ia, $getState as yc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as kc, $setState as _c, addClassNamesToElement as Mn, $create as Nc, $getNodeByKey as Cc, removeClassNamesFromElement as Ec, KEY_TAB_COMMAND as Tc, $isBlockElementNode as zc, $createRangeSelection as Sc, $normalizeSelection__EXPERIMENTAL as Dc, OUTDENT_CONTENT_COMMAND as Oc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Rc, COMMAND_PRIORITY_CRITICAL as to, $isDecoratorNode as $c, $isParagraphNode as Mc, $isTextNode as Va, SELECTION_CHANGE_COMMAND as An, $insertNodes as Ac } from "lexical";
import { HeadingNode as Pc, QuoteNode as Ic, registerRichText as Vc } from "@lexical/rich-text";
import { flushSync as Lc, createPortal as jc } from "react-dom";
import { IconX as Fc, IconCheck as sa, IconChevronDown as Bc, IconChevronUp as Uc, IconSelector as Kc, IconLayoutSidebar as qc, IconLayoutSidebarRight as Gc, IconChevronRight as Pn, IconLoader as Hc, IconAlertOctagon as Yc, IconAlertTriangle as Wc, IconInfoCircle as Xc, IconCircleCheck as Jc } from "@tabler/icons-react";
...
import { useReactTable as Vn, getFilteredRowModel as el, getSortedRowModel as Ln, getPaginationRowModel as rl, getCoreRowModel as jn, flexRender as vr, getGroupedRowModel as al, getExpandedRowModel as ol } from "@tanstack/react-table";
import nl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as La, HIDDEN_NOTE_CALLER as ja, getDefaultViewOptions as il, isInsertEmbedOpOfType as Ir, Editorial as sl } from "@eten-tech-foundation/platform-editor";
...
function Ba({
  ...
  const s = Xt();
  return /* @__PURE__ */ u(wl, { children: [
    /* @__PURE__ */ a(ul, { className: o }),
    /* @__PURE__ */ u(
      ve.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ve.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(K, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Fc, {}),
...
function Ao({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ve.Close, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
const Bn = wt.allBookIds.filter(
  (t) => !wt.isObsolete(wt.bookIdToNumber(t))
), de = Object.fromEntries(
  Bn.map((t) => [t, wt.bookIdToEnglishName(t)])
);
function ro(t, e, r) {
...
function hl({
  ...
  return /* @__PURE__ */ u(Re, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a($e, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(me, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Oe,
      {
        onSelect: () => g(h),
  ...
  const o = gl.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && d) {
          const h = ((m) => Object.keys(de).find(
            (y) => de[y].toLowerCase() === m.toLowerCase()
          ))(c);
...
function ba({
  ...
  const _ = Xt(), [k, N] = C(!1), [M, B] = C(""), [I, V] = C(""), [x, R] = C("books"), [S, z] = C(void 0), [T, $] = C(
    void 0
  ), [U, W] = C(void 0), [L, et] = C(!1), it = G(null), bt = G(!1), xt = G(void 0), It = G(void 0), q = G(void 0), at = G(void 0), ft = G({}), st = G({}), ct = F(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), mt = P(() => o ? o() : Bn, [o]), yt = P(() => ({
    [Q.OT]: mt.filter((H) => wt.isBookOT(H)),
    [Q.NT]: mt.filter((H) => wt.isBookNT(H)),
    [Q.DC]: mt.filter((H) => wt.isBookDC(H)),
    [Q.Extra]: mt.filter((H) => wt.extraBooks().includes(H))
  }), [mt]), Jt = P(() => Object.values(yt).flat(), [yt]), re = P(() => {
    if (!I.trim()) return yt;
    const b = {
      [Q.OT]: [],
      [Q.NT]: [],
  ...
  const ae = F(() => {
    ...
    (b) => {
      const H = T ?? (D == null ? void 0 : D.book), Z = U ?? (D == null ? void 0 : D.chapterNum);
      !H || !Z || (ct({
        book: H,
        chapterNum: Z,
        verseNum: b
    ...
    (b) => {
      const H = x === "chapters" ? S : D == null ? void 0 : D.book;
      if (H) {
        if (l && l(H, b) > 1) {
          $(H), W(b), R("verses"), B("");
          return;
    ...
    R("books"), z(void 0), $(void 0), W(void 0), setTimeout(() => {
      It.current && It.current.focus();
    }, 0);
  }, []), j = F(() => {
    const b = T;
    $(void 0), W(void 0), b ? (z(b), R("chapters"), B("")) : Mt();
  }, [T, Mt]), X = F((b) => {
    N(b), b && (R("books"), z(void 0), $(void 0), W(void 0), V(""));
  }, []), { otLong: lt, ntLong: tt, dcLong: ot, extraLong: gt } = {
    ...
    () => fl(I),
    [I]
  ), Pt = P(() => !l || !D || !D.chapterNum || !Lt ? !1 : l(D.book, D.chapterNum) > 0, [l, D, Lt]), O = F(
    (b) => w ? Po(b, w) : !1,
    [w]
  ), Ct = F(
    (b) => (H) => w ? ml(b, H, w) : !1,
    ...
    (b, H) => (Z) => w ? va(b, H, Z, w) : !1,
    [w]
  ), Zt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ke = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", ur = F(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), ae());
    },
    [p, D, ae]
  ), Dr = F(
    (b) => {
      var oe, Je, pr;
      if (b.ctrlKey) return;
      const { isLetter: H, isDigit: Z } = Io(b.key);
      if ((x === "chapters" || x === "verses") && (b.key === " " || b.key === "Enter")) {
        const jt = b.target instanceof HTMLElement ? b.target : void 0;
        ...
        const Dt = (oe = xt.current) == null ? void 0 : oe.querySelector(
      ...
      if ((x === "chapters" || x === "verses") && (H || Z)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (x === "chapters" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), Mt();
        return;
      }
      ...
      const St = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(b.key);
      if (x === "verses" && St) {
        const jt = T, kt = U;
        if (!jt || !kt || !l) return;
        const Dt = l(jt, kt);
        if (!Dt) return;
        (Je = xt.current) == null || Je.focus();
        const ht = (() => {
          if (!M) return 1;
          const qe = M.match(/:(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            ht !== 0 && (Qt = ht > 1 ? ht - 1 : Dt);
            break;
          case "ArrowRight":
            ht !== 0 && (Qt = ht < Dt ? ht + 1 : 1);
            break;
          case "ArrowUp":
            Qt = ht === 0 ? Dt : Math.max(1, ht - te);
            break;
          case "ArrowDown":
            Qt = ht === 0 ? 1 : Math.min(Dt, ht + te);
            break;
          default:
            return;
        }
        Qt !== ht && (b.preventDefault(), b.stopPropagation(), B(
          `${jt} ${de[jt] || ""} ${kt}:${Qt}`
        ), setTimeout(() => {
          const qe = st.current[Qt];
          qe && qe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((x === "chapters" || x === "books" && D) && St) {
        const jt = x === "chapters" ? S : D == null ? void 0 : D.book;
        if (!jt) return;
        x === "chapters" && ((pr = xt.current) == null || pr.focus());
        const kt = (() => {
          if (!M) return 1;
          const te = M.match(/(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            kt !== 0 && (ht = kt > 1 ? kt - 1 : Dt);
            break;
          case "ArrowRight":
            kt !== 0 && (ht = kt < Dt ? kt + 1 : 1);
            break;
          case "ArrowUp":
            ht = kt === 0 ? Dt : Math.max(1, kt - Qt);
            break;
          case "ArrowDown":
            ht = kt === 0 ? 1 : Math.min(Dt, kt + Qt);
            break;
          default:
            return;
        }
        ht !== kt && (b.preventDefault(), b.stopPropagation(), B(
          `${jt} ${de[jt] || ""} ${ht}`
        ), setTimeout(() => {
          const te = ft.current[ht];
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (St = It.current) == null || St.focus();
      return;
    }
    const { isLetter: H, isDigit: Z } = Io(b.key);
    (H || Z) && (b.preventDefault(), V((oe) => oe + b.key), It.current.focus(), et(!1));
  }, []);
  return ee(() => {
    const b = setTimeout(() => {
      if (k && x === "books" && q.current && at.current) {
        const H = q.current, Z = at.current, St = Z.offsetTop, oe = H.clientHeight, Je = Z.clientHeight, pr = St - oe / 2 + Je / 2;
        H.scrollTo({
          top: Math.max(0, pr),
          behavior: "smooth"
        }), B(Kn(t.book));
    ...
    if (x === "chapters" && S) {
      const b = S === t.book, H = b ? t.chapterNum : 1;
      B(
        `${S} ${de[S] || ""} ${H}`
      ), setTimeout(() => {
        if (q.current)
          if (b) {
            const Z = ft.current[t.chapterNum];
  ...
  }, [x, S, D, t.book, t.chapterNum]), ee(() => {
    if (x === "verses" && T && U !== void 0) {
      const b = T === t.book && U === t.chapterNum, H = b ? t.verseNum : 1;
      B(
        `${T} ${de[T] || ""} ${U}:${H}`
      ), setTimeout(() => {
        if (q.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Re, { open: k, onOpenChange: X, modal: v, children: [
    /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ a(
      K,
      {
        ref: it,
        ...
        children: g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Et })
      }
    ) }),
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: H } = b;
          k && it.current && H instanceof Node && it.current.contains(H) && (bt.current = !0, X(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          Fe,
          {
            ...
            children: [
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ce.map(({ onClick: b, disabled: H, title: Z, icon: St }) => /* @__PURE__ */ a(
                  K,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  K,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: x === "verses" ? j : Mt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: _ === "ltr" ? /* @__PURE__ */ a(ps, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(hs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                x === "chapters" && S && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Pe(S, n) }),
                x === "verses" && T && U !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Pe(T, n)} ${U}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: x === "verses" ? Ke : Zt
                  }
                )
              ] }),
              !L && /* @__PURE__ */ u(Be, { ref: q, children: [
                x === "books" && /* @__PURE__ */ u(rt, { children: [
                  !D && Object.entries(re).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(me, { heading: vt(b), children: H.map((Z) => /* @__PURE__ */ a(
                          Un,
                          {
                            bookId: Z,
                            onSelect: (St) => $t(St),
                  ...
                  D && /* @__PURE__ */ a(me, { children: /* @__PURE__ */ a(
                    Oe,
                    {
                      ...
                      children: Ce(
                        ...
                        n ? eo(D.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  D && Pt && D.chapterNum && l && /* @__PURE__ */ u(rt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Pe(D.book, n)} ${D.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Lo,
                      {
                        ...
                        onVerseSelect: Nt,
                        setVerseRef: Tt,
                        isVerseDisabled: zt(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !Pt && fe(D.book) > 1 && /* @__PURE__ */ u(rt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Pe(D.book, n) }),
                      /* @__PURE__ */ a("span", { children: Zt })
                    ] }),
                    /* @__PURE__ */ a(
                      Vo,
                      {
                ...
                x === "chapters" && S && /* @__PURE__ */ a(
                  Vo,
                  {
                    ...
                    onChapterSelect: Vt,
                    setChapterRef: At,
                    isChapterDisabled: Ct(S),
                    className: "tw:p-4"
                  }
                ),
                x === "verses" && T && U !== void 0 && l && /* @__PURE__ */ a(
                  Lo,
                  {
                    bookId: T,
                    chapterNum: U,
...
function jo({
  ...
  const [k, N] = C(!1), M = l ?? d, B = (V) => V.length > 0 && typeof V[0] == "object" && "options" in V[0], I = (V, x) => {
    const R = d(V), S = typeof V == "object" && "secondaryLabel" in V ? V.secondaryLabel : void 0, z = `${x ?? ""}${R}${S ?? ""}`;
    return /* @__PURE__ */ u(
      Oe,
      {
        value: R,
  ...
  return /* @__PURE__ */ u(Re, { open: k, onOpenChange: N, ..._, children: [
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          /* @__PURE__ */ a(Nr, { placeholder: g, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(oa, { children: h }),
          /* @__PURE__ */ a(Be, { children: B(e) ? e.map((V) => /* @__PURE__ */ a(me, { heading: V.groupHeading, children: V.options.map((x) => I(x, V.groupHeading)) }, V.groupHeading)) : /* @__PURE__ */ a(me, { children: e.map((V) => I(V)) }) })
        ] })
      }
    )
  ] });
...
function ip({
  ...
  const w = xa(l, "%webView_bookSelector_currentBook%"), p = xa(l, "%webView_bookSelector_choose%"), g = xa(l, "%webView_bookSelector_chooseBooks%"), [h, m] = C(
    "current book"
    /* CurrentBook */
  ), y = (v) => {
    m(v), t(v);
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, _l = Hn ? ee : Y, Vr = { tag: Za };
function Nl({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = kl(null, o), w = Cn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
        if (g === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            ...
            (Wt() !== null || y !== null && y === p.getRootElement()) && m.select();
          }
        }, Vr);
...
const Cl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : Y;
...
function Dl({ children: t, onError: e }) {
  return a(zl, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : Y;
function Rl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function $l() {
  return function(t) {
    const [e] = ke(), r = P(() => t(e), [e, t]), [o, n] = C(() => r.initialValueFn()), i = G(o);
    return Ol(() => {
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Al = Yn && "documentMode" in document ? document.documentMode : null;
!(!Yn || !("InputEvent" in window) || Al) && "getTargetRanges" in new window.InputEvent("input");
function ge(t) {
  return `${t}px`;
}
...
function Il(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < h.length; E++) {
      const _ = h[E], k = s[E] || document.createElement("div"), N = k.style;
      N.position !== "absolute" && (N.position = "absolute", v = !0);
      const M = ge(_.left - p);
      N.left !== M && (N.left = M, v = !0);
      const B = ge(_.top - g);
      N.top !== B && (k.style.top = B, v = !0);
      const I = ge(_.width);
      N.width !== I && (k.style.width = I, v = !0);
      const V = ge(_.height);
      N.height !== V && (k.style.height = V, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[E] = k;
    }
...
function Ll(t, e = Vl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      const [g, h] = function(V) {
        const x = V.getStartEndPoints();
        return V.isBackward() ? [x[1], x[0]] : x;
      }(p), m = g.getNode(), y = m.getKey(), v = g.offset, E = h.getNode(), _ = E.getKey(), k = h.offset, N = t.getElementByKey(y), M = t.getElementByKey(_), B = r === null || N !== o || v !== n || y !== r.getKey(), I = i === null || M !== s || k !== c || _ !== i.getKey();
      if ((B || I) && N !== null && M !== null) {
        const V = function(x, R, S, z, T, $, U) {
          const W = (x._window ? x._window.document : document).createRange();
          return W.setStart(...Fo(R, S, z)), W.setEnd(...Fo(T, $, U)), W;
        }(t, g, m, N, h, E, M);
        d(), d = Il(t, V, e);
      }
      r = m, o = N, n = v, i = E, s = M, c = k;
    });
  }
  return l(t.getEditorState()), De(t.registerUpdateListener(({ editorState: w }) => l(w)), () => {
    d();
  });
}
function jl(t, e) {
...
function Fl(t) {
  const e = Sn(t, (r) => yr(r) && !r.isInline());
  return yr(e) || Jr(4, t.__key), e;
}
function Bl(t) {
  const e = Wt() || Xs();
  let r;
  if (be(e)) r = Js(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = zn(c, "next"));
    }
    r = r || Zs(Le(), "previous").getFlipped().insert(Tr());
  }
  const o = Ul(t, r), n = Qs(o), i = tc(n) ? ec(n) : o;
  return rc(ac(i)), t.getLatest();
}
function Ul(t, e, r) {
  let o = Ro(e, "next");
  for (let n = o; n; n = oc(n, r)) o = n;
  return nc(o) && Jr(283), o.insert(t.isInline() ? Tr().append(t) : t), Ro(zn(t.getLatest(), "next"), e.direction);
}
function Kl(t) {
  const e = Wt();
  if (!be(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Sn(i, (l) => yr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Zr, Ee = 0, Qr = 0, Hl = 0, Ka = 0, Ur = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Wl(t) {
  ...
  Xn(this), nt = t, this.f &= -2, 8 & this.f && io(this), ca();
}
function Qe(t, e) {
...
Bt.prototype.brand = ql, Bt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ee !== 0 && Qr === 0 && e.l !== Ka && (e.l = Ka, Zr = { S: e, v: e.v, i: e.i, o: Zr });
    })(this), this.v = t, this.i++, Ur++, Ee++;
    try {
...
} }), Ge.prototype = new Bt(), Ge.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Jn(this), Ko(this), Ee++;
  const t = nt;
  return nt = this, Wl.bind(this, t);
...
se({ build: (t, e, r) => wr(e), config: Xe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Zn() {
  const t = Le(), e = Wt(), r = Tr();
  t.clear(), t.append(r), e !== null && r.select(), be(e) && (e.format = 0);
}
function Qn(t, e = Zn) {
  return t.registerCommand(Dn, (r) => (t.update(e), !0), Qa);
}
se({ build: (t, e, r) => wr(e), config: Xe({ $onClear: Zn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const ka = lc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ti extends Ia {
  $config() {
    return this.config("decorator-text", { extends: Ia, stateConfigs: [{ flat: !0, stateConfig: ka }] });
  }
  getFormat() {
    return yc(this, ka);
  }
...
se({ name: "@lexical/extension/DecoratorText", nodes: () => [ti], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Wt();
  if (Rn(n) || be(n)) for (const i of n.getNodes()) Jl(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function ei(t, e) {
  let r;
...
const qa = se({ build: (t) => ei(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, Ga = 1, ai = 2, _a = 3, Lr = 4, Ze = 5, Na = 6, gr = 7;
function Ca(t) {
  return t.id === so;
}
function oi(t) {
...
function Zl(t) {
  return function(e) {
    return e.id === Ga;
  }(t) || dt(305, String(t.id), String(Ga)), Object.assign(t, { id: ai });
}
...
class td {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Lr && dt(307, String(r.id), String(Ze)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== gr && dt(309, String(o.id), String(gr)), this.state = function(s) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Lr;
    }(e) || dt(313, String(e.id), String(Lr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= gr;
    }(e) || dt(316, String(e.id), String(gr)), e;
  }
...
const rd = se({ config: Xe({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = ed }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [dc, Tn, wc, uc, En] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function ad(t) {
  throw t;
...
class er {
  ...
  static maybeFromEditor(e) {
    const r = e[Go];
    return r && (r.PACKAGE_VERSION !== Ea && dt(292, r.PACKAGE_VERSION, Ea), r instanceof er || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ca(i) || dt(300, s, n || "[unknown]"), Ca(c = i) || dt(304, String(c.id), String(so)), i = Object.assign(c, { id: Ga }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const g of Xl(p)) {
...
const od = /* @__PURE__ */ new Set(), Yo = se({ build(t, e, r) {
  const o = r.getDependency(qa).output, n = kr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ei(() => {
  }, () => xe(() => {
  ...
  return { watchNodeKey: function(s) {
    const c = Yl(() => (i.value || od).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const w = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), w || (d.set(s, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [qa], name: "@lexical/extension/NodeSelection" }), nd = hc("INSERT_HORIZONTAL_RULE_COMMAND");
class or extends Ia {
  static getType() {
...
se({ dependencies: [qa, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [or], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Yo).output, n = kr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return De(t.registerCommand(nd, (s) => {
    ...
    return !0;
  }, Qa), t.registerCommand(gc, (s) => {
    if (fc(s.target)) {
      const c = mc(s.target);
      if (sd(c)) return function(d, l = !1) {
        const w = Wt(), p = d.isSelected(), g = d.getKey();
        let h;
        l && Rn(w) ? h = w : (h = vc(), bc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, $n), t.registerMutationListener(or, (s, c) => {
    Gl(() => {
      let d = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        g ? g.domNode.value = h : (d = !0, l.set(w, { domNode: kr(h), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(xe(() => {
      const l = c.value;
      l && (d.value ? Mn(l, i) : Ec(l, i));
    }));
    return De(...s);
  }));
} });
se({ build: (t, e) => wr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Xe({ $getParentEditor: function() {
  const t = xc();
...
se({ build: (t, e, r) => wr(e), config: Xe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return xe(() => {
...
function cd(t, e, r = ni) {
  return De(t.registerCommand(Tc, (o) => {
    const n = Wt();
    if (!be(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => zc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Fl(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Sc();
...
se({ build: (t, e, r) => wr(e), config: Xe({ $canIndent: ni, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (be(m)) {
                const y = m.anchor;
                let v = y.getNode(), E = 0, _ = 0;
                if (Va(v) && l >= 0 && w >= 0 && (E = l, _ = l + w, m.setTextNodeRange(v, E, v, _)), E === _ && p === "" || (m.insertRawText(p), v = y.getNode()), Va(v)) {
                  E = g, _ = g + h;
                  const k = v.getTextContentSize();
                  E = E > k ? k : E, _ = _ > k ? k : _, m.setTextNodeRange(v, E, v, _);
                }
...
se({ build: (t, e, r) => wr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => xe(() => r.getOutput().disabled.value ? void 0 : si(t)) });
function pd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : Y;
  ...
  return function(r, o) {
    ...
    return lo(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (g) => r._onError(g), children: a(Ys, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
...
function fd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    lo(() => De(Vc(n), si(n)), [n]);
  }(o), u(rt, { children: [t, a(md, { content: e }), a(gd, { editor: o, ErrorBoundary: r })] });
}
...
function Nd(t, e) {
  ...
  return u(rt, { children: [a(kd, { editor: n, ...o, ref: e }), r != null && a(Cd, { editor: n, content: r })] });
}
function Cd({ content: t, editor: e }) {
  const r = function(s) {
    ...
    return ci(() => {
      ...
      return l(), De(s.registerUpdateListener(() => {
        l();
...
function zd() {
  const [t, e] = C(void 0), r = F(() => {
    e(void 0);
  }, []), o = P(() => {
    if (t === void 0)
      return;
    const { title: i, content: s } = t;
    return /* @__PURE__ */ a(Fa, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ba, { children: [
      /* @__PURE__ */ a(Yr, { children: /* @__PURE__ */ a(Wr, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = F(
    (i, s, c = !1) => {
...
function Sd({
  ...
  const [e] = ke(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = zd(), d = () => {
  };
...
function Rd() {
  const { activeEditor: t } = di(), [e, r] = C([]), o = F((n) => {
    if (be(n) || Zc(n)) {
      const i = [];
      Jo.forEach(({ format: s }) => {
...
function mi({
  ...
  return /* @__PURE__ */ u(uo, { children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
      /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ a(
        K,
        {
          "aria-label": s,
          className: n,
...
const Vd = "verseText", cp = Object.freeze([
...
function lp({
  ...
  const [i, s] = C(Ld), [c, d] = C(n), [l, w] = C(!1), p = G(void 0), g = G(null);
  Y(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
      ...
      /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ u(
        K,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: Ta(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : po(v) && (v.preventDefault(), v.stopPropagation(), ne(i) && h());
        },
        onKeyDown: (v) => {
...
function Qo({
  ...
  const h = F(
    ...
    const N = new Date(t.date), M = is(
      N,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), B = N.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    [t.user]
  ), _ = P(() => Wa(t.contents), [t.contents]), k = P(() => {
    if (o && c)
      return /* @__PURE__ */ u(rt, { children: [
        /* @__PURE__ */ u(
          Ye,
          {
            onClick: (N) => {
              N.stopPropagation(), l(!0), p(Pd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Bd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ud, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), h()) : po(N) && (N.preventDefault(), N.stopPropagation(), ne(w) && m());
              },
              onKeyDown: (N) => {
                wo(N), (N.key === "Enter" || N.key === " ") && N.stopPropagation();
              },
              onClick: (N) => {
                N.stopPropagation();
              },
        ...
        k && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(bs, {}) }) }),
          /* @__PURE__ */ a(Se, { align: "end", children: k })
        ] })
      ]
    }
  );
...
function yi({
  ...
  const [S, z] = C(tn), [T, $] = C(), [U, W] = C(), L = o, [et, it] = C(!1), [bt, xt] = C(!1), [It, q] = C(!1), [at, ft] = C(!1), [st, ct] = C(!1), [mt, yt] = C(N), [Jt, re] = C(!1), D = G(void 0), [pe, ae] = C(/* @__PURE__ */ new Map());
  Y(() => {
    let O = !0;
    return (async () => {
      const zt = _ ? await _(d) : !1;
      O && ct(zt);
    })(), () => {
      O = !1;
    };
    ...
    let O = !0;
    if (!o) {
      ft(!1), ae(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const zt = E ? await E(d) : !1;
      O && ft(zt);
    })(), () => {
      O = !1;
    };
  ...
  Y(() => {
    if (!o) {
      Nt.current !== "idle" && ($(void 0), W(void 0), Nt.current = "idle");
      return;
    }
    Nt.current === "idle" && (Nt.current = "pending"), at ? Nt.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && ($(I), Nt.current = "auto-populated") : Nt.current === "auto-populated" && ($(void 0), Nt.current = "pending");
  }, [o, I, at, i]);
  const $t = P(() => e.filter((O) => !O.deleted), [e]);
  Y(() => {
    let O = !0;
    if (!o || !k) {
      ae(/* @__PURE__ */ new Map());
  ...
  const Vt = P(() => $t[0], [$t]), Me = G(null), ce = G(void 0), Mt = F(() => {
    var O;
    (O = ce.current) == null || O.call(ce), z(tn);
  }, []), j = F(() => {
    const O = !mt;
    yt(O), re(!O), m == null || m(d, O);
  }, [mt, m, d]);
  Y(() => {
    it(!1);
  }, [o]), Y(() => {
    if (o && !mt && !Jt) {
      ...
      return D.current = O, () => clearTimeout(O);
    }
  ...
  }, [i, r]), tt = P(() => $t.slice(1), [$t]), ot = P(() => tt.length ?? 0, [tt.length]), gt = P(() => ot > 0, [ot]), vt = P(() => et || ot <= 2 ? tt : tt.slice(-2), [tt, ot, et]), ut = P(() => et || ot <= 2 ? 0 : ot - 2, [ot, et]), Et = P(
    () => ot === 1 ? X.singleReply : Ne(X.multipleReplies, { count: ot }),
    [ot, X]
  ), At = P(
    () => ut === 1 ? X.singleReply : Ne(X.multipleReplies, { count: ut }),
    [ut, X]
  );
  Y(() => {
    !o && bt && gt && xt(!1);
  ...
  const Tt = F(
    async (O) => {
      ...
      Ct && await p({ threadId: d, contents: Ct }) && Mt();
    },
    [
      Mt,
      S,
    ...
    async (O) => {
      const Ct = ne(S) ? ea(S) : void 0, zt = O.status ? O.assignedUser : T ?? O.assignedUser, Zt = await p({
        ...O,
        contents: Ct,
        assignedUser: zt
      });
      return Zt && (zt !== void 0 && W(zt), Ct && Mt()), Zt;
    },
    [Mt, S, p, T]
  );
  ...
  const Pt = /* @__PURE__ */ a(
    Qo,
    {
      ...
      handleDeleteComment: h,
      onEditingChange: xt,
      canEditOrDelete: (!bt && pe.get(Vt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Fd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            lt && /* @__PURE__ */ a(xr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: lt }),
            /* @__PURE__ */ a(
              K,
              {
                variant: "ghost",
                ...
                children: mt ? /* @__PURE__ */ a(xs, {}) : /* @__PURE__ */ a(ys, {})
              }
            ),
            x === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: st && w !== "Resolved",
                  onClick: () => Lt({ threadId: d, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(rt, { children: [
          ...
          !o && ne(S) && /* @__PURE__ */ a(
            ta,
            {
              ...
              onSerializedChange: (O) => z(O),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(rt, { children: [
            R && vt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ut > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (O) => {
                  O.stopPropagation(), it(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (O) => {
                  (O.key === "Enter" || O.key === " ") && (O.preventDefault(), O.stopPropagation(), it(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(rr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: At }),
                    et ? /* @__PURE__ */ a(ks, {}) : /* @__PURE__ */ a(ar, {})
                  ] })
                ]
              }
            ),
            vt.map((O) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Qo,
              {
                comment: O,
                localizedStrings: r,
                ...
                handleDeleteComment: h,
                onEditingChange: xt,
                canEditOrDelete: (!bt && pe.get(O.id)) ?? !1
              }
            ) }, O.id)),
            v !== !1 && (!bt || ne(S)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (O) => {
                  po(O) && (O.preventDefault(), O.stopPropagation(), (ne(S) || T !== void 0 && T !== U) && Tt());
                },
                onKeyDown: (O) => {
                  wo(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ta,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    T !== void 0 && (ne(S) || T !== U) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ne(
                    ...
                    /* @__PURE__ */ u(Re, { open: It, onOpenChange: q, children: [
                      /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ a(
                        K,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !at || !y || y.length === 0 || !y.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          align: "end",
                          onKeyDown: (O) => {
                            O.key === "Escape" && (O.stopPropagation(), q(!1));
                          },
                          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: y == null ? void 0 : y.map((O) => /* @__PURE__ */ a(
                            Oe,
                            {
                              onSelect: () => {
                                $(O !== i ? O : void 0), Nt.current = "user-selected", W(void 0), q(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: qr(O, r) })
                            },
                            O || "unassigned"
                          )) }) })
                        }
...
), qd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Gr = (t) => qd(Wa(t));
function Hr({ html: t, className: e }) {
  return /* @__PURE__ */ a(
    "div",
    {
      className: f(Kd, e),
...
function Gd({
  ...
  const [s, c] = C("accept"), d = zo(), l = zo(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", m = p ? "accept" : s, y = P(
    () => Gr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = P(
    () => Gr(t.acceptedText ?? ""),
    ...
    () => Gr(t.mergedText ?? ""),
    [t.mergedText]
  ), _ = P(() => Wa(t.contents), [t.contents]);
  if (!bi(t))
    return /* @__PURE__ */ a(Hr, { html: _ });
  const k = ($) => {
    c($ === "reject" || $ === "merge" ? $ : "accept");
  }, N = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", M = h ? [
    {
      value: "merge",
  ...
  let x;
  I ? x = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (x = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const R = e["%conflict_note_no_result%"] ?? "No result preview available.", S = ($) => $ ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: $ }) : /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: R }), z = () => {
    const $ = o ?? "accept";
    return $ === "merged" ? t.mergedText ? /* @__PURE__ */ a(Hr, { html: E }) : S(void 0) : S($ === "reject" ? t.rejectedResultText : t.resultText);
  }, T = ($) => {
    const U = m === $.value, W = `${l}-${$.value}`, L = p && $.value === "reject";
    return (
      ...
      !w && !g && /* @__PURE__ */ u(rt, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: B.map(($) => p && $.value === "reject" ? /* @__PURE__ */ a(qt, { delayDuration: 0, children: /* @__PURE__ */ u(Gt, { children: [
              /* @__PURE__ */ a(Ht, { asChild: !0, children: T($) }),
              /* @__PURE__ */ a(Yt, { side: "right", children: N })
            ] }) }, $.value) : T($))
          }
        ),
        /* @__PURE__ */ a(qt, { delayDuration: 0, children: /* @__PURE__ */ u(Gt, { children: [
          /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:inline-flex tw:self-start", children: /* @__PURE__ */ a(
            K,
            {
              size: "sm",
              disabled: V,
...
function Xd({
  ...
  const [i, s] = C("loading"), [c, d] = C(!1), [l, w] = C(), p = n == null ? void 0 : n.getOptions, g = n == null ? void 0 : n.resolve;
  Y(() => {
    let E = !0;
    if (!r) {
      s("loading");
  ...
  const h = F(
    ...
    if (e === "Resolved") {
      for (let E = o.length - 1; E >= 0; E -= 1) {
        const _ = o[E].conflictResolutionAction;
        if (_ === "replaced") return "reject";
        if (_ === "merged") return "merged";
      }
      return "accept";
    }
  }, [e, o]) ?? l;
  return { conflictOptions: i, isResolving: c, resolve: h, resolvedResolution: y, showResolveCheck: i !== "loading" && i !== "none" };
}
function Jd(t) {
  const {
    comments: e,
  ...
  } = t, c = P(() => e.filter((E) => !E.deleted), [e]), d = c[0], { conflictOptions: l, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Xd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function mp({
  ...
  const [_, k] = C(/* @__PURE__ */ new Set()), [N, M] = C(), [B, I] = C(), V = F(
    async (L) => {
      const et = await i(L);
      return et !== void 0 && L.assignedUser !== void 0 && L.assignedUser !== "" && I(L.assignedUser), et;
    },
    [i]
  );
  Y(() => {
    m && (k((L) => new Set(L).add(m)), M(m));
  }, [m]);
  const x = r.filter(
    (L) => L.comments.some((et) => !et.deleted)
  ), R = x.map((L) => ({ id: L.id })), S = F(
    (L) => {
      k((et) => new Set(et).add(L.id)), M(L.id), y == null || y(L.id);
    },
    [y]
  ), z = F(
    (L) => {
      ...
      k((it) => {
        const bt = new Set(it);
        return bt.has(L) ? bt.delete(L) : bt.add(L), bt;
      }), M(L), y == null || y(et ? void 0 : L);
    },
    [_, y]
  ), { listboxRef: T, activeId: $, handleKeyDown: U } = Hi({
    options: R,
    onOptionSelect: S
  }), W = F(
    (L) => {
      L.key === "Escape" ? (N && _.has(N) && (k((et) => {
        const it = new Set(et);
        return it.delete(N), it;
      }), M(void 0), y == null || y(void 0)), L.preventDefault(), L.stopPropagation()) : U(L);
    },
    [N, _, U, y]
  );
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      onKeyDown: W,
      children: x.map((L) => {
        const et = L.type === "Conflict" ? Jd : yi;
        return /* @__PURE__ */ a(
          "div",
          {
            className: f({
...
function Zd({ table: t }) {
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(K, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(_s, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function sr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ut.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ut.Icon, { asChild: !0, children: /* @__PURE__ */ a(Kc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function le({
  ...
  return /* @__PURE__ */ u(
    Ut.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ut.ItemIndicator, { children: /* @__PURE__ */ a(sa, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        nr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(cr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(le, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  const c = pt.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), iw(h, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), nw(c, y, w.key);
...
function sw({
  ...
  var B;
  const [w, p] = C([]), [g, h] = C([]), [m, y] = C({}), [v, E] = C({}), _ = P(() => e ?? [], [e]), k = Vn({
    data: _,
    columns: t,
    getCoreRowModel: jn(),
  ...
  let M;
  return d ? M = Array.from({ length: 10 }).map((x, R) => `skeleton-row-${R}`).map((x) => /* @__PURE__ */ a(we, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ie, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((B = k.getRowModel().rows) == null ? void 0 : B.length) > 0 ? M = k.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    we,
    {
      onClick: () => s(I, k),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((V) => /* @__PURE__ */ a(ie, { children: vr(V.column.columnDef.cell, V.getContext()) }, V.id))
    },
    I.id
  )) : M = /* @__PURE__ */ a(we, { children: /* @__PURE__ */ a(ie, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Zd, { table: k }),
    /* @__PURE__ */ u(la, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ho, { stickyHeader: i, children: k.getHeaderGroups().map((I) => /* @__PURE__ */ a(we, { children: I.headers.map((V) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: V.isPlaceholder ? void 0 : vr(V.column.columnDef.header, V.getContext()) }, V.id)) }, I.id)) }),
...
function Cp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    ...
    /* @__PURE__ */ a(Se, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Cr, { children: l.label }),
      /* @__PURE__ */ a(un, { children: l.itemType === 0 ? /* @__PURE__ */ a(rt, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ie,
        {
          checked: o[w][g],
        ...
        Yi,
        {
          ...
          children: l.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Wi, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(We, {})
    ] }, l.label)) })
...
function ww({ id: t, versionHistory: e }) {
...
function Tp({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(ww, { versionHistory: n }),
...
function ki({
  ...
  const [E, _] = C(!1), k = F(
    (R) => {
      var z;
      const S = (z = t.find((T) => T.label === R)) == null ? void 0 : z.value;
      S && r(
    ...
    if (!g) return t;
    const R = t.filter((z) => z.starred).sort((z, T) => z.label.localeCompare(T.label)), S = t.filter((z) => !z.starred).sort((z, T) => {
      const $ = e.includes(z.value), U = e.includes(T.value);
      return $ && !U ? -1 : !$ && U ? 1 : z.label.localeCompare(T.label);
    });
    return [...R, ...S];
  }, [t, e, g]), B = () => {
    r(t.map((R) => R.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Re, { open: V, onOpenChange: w ?? _, children: [
    /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ u(
      K,
      {
        variant: y,
    ...
    /* @__PURE__ */ a($e, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Fe, { children: [
      ...
      /* @__PURE__ */ u(Be, { children: [
        /* @__PURE__ */ a(oa, { children: c }),
        /* @__PURE__ */ a(me, { children: M.map((R) => /* @__PURE__ */ u(
          Oe,
          {
            value: R.label,
            onSelect: k,
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ a(Rs, { className: "tw:h-4 tw:w-4" }),
              /* @__PURE__ */ a("div", { className: "tw:flex-grow", children: R.label }),
              R.secondaryLabel && /* @__PURE__ */ a("div", { className: "tw:text-end tw:text-muted-foreground", children: R.secondaryLabel })
            ]
          },
          R.label
        )) })
      ...
      return /* @__PURE__ */ u(xr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          K,
          {
            ...
            children: /* @__PURE__ */ a(na, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function pw({
  ...
  const d = P(() => /Macintosh/i.test(navigator.userAgent), []), l = on(n, "%undoButton_tooltip%"), w = on(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(uo, { children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
      /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ a(
        K,
    ...
    e && /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
      /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ a(
        K,
        {
          "aria-label": w,
...
const gw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(rt, { children: [
...
function fw({
  ...
  const i = G(null), s = G(null), c = G(!1), [d, l] = C(t), [w, p] = C(r), [g, h] = C(!1);
  Y(() => {
    l(t);
  }, [t]), Y(() => {
    w !== r && p(r);
  ...
  const m = (v) => {
    ...
    var E, _, k, N;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((_ = s.current) == null || _.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((N = s.current) == null || N.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Te, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
      /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: gw(t, n, r) }) }) }),
      /* @__PURE__ */ a(Yt, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      Se,
      {
...
const mw = (t, e) => t === "f" ? /* @__PURE__ */ u(rt, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function bw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
      /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: mw(t, r) }) }) }),
      /* @__PURE__ */ a(Yt, { children: /* @__PURE__ */ a("p", { children: vw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Se, { style: { zIndex: pn }, children: [
...
function yw({ icon: t, className: e }) {
...
function nn({
  ...
  return /* @__PURE__ */ u(
    Oe,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(yw, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
...
function Dp({
  ...
  const [m, y] = C("generated"), [v, E] = C("generated"), [_, k] = C("*"), [N, M] = C("*"), [B, I] = C("f"), [V, x] = C(!1), [R, S] = C(!0), [z, T] = C(!1), $ = G(!1), U = G(""), [W, L] = C(!1), [et, it] = C(), [bt, xt] = C(), [It, q] = C(), [at, ft] = C(), st = G(null), ct = P(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (X && Ir("note", X)) {
      const ot = (lt = X.insert.note) == null ? void 0 : lt.caller;
      let gt = "custom";
      ot === La ? gt = "generated" : ot === ja ? gt = "hidden" : ot && (k(ot), M(ot)), y(gt), E(gt), I(((tt = X.insert.note) == null ? void 0 : tt.style) ?? "f"), j = setTimeout(() => {
        var vt;
        (vt = w.current) == null || vt.applyUpdate([X]);
      }, 0);
    }
    return () => {
      j && clearTimeout(j);
  ...
  const yt = F(
    (j, X, lt = !1) => {
      var ot, gt, vt;
      const tt = (gt = (ot = w.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : gt.at(0);
      if (tt && Ir("note", tt)) {
        if (tt.insert.note) {
          let ut;
          j === "custom" ? ut = X : j === "generated" ? ut = La : ut = ja, tt.insert.note.caller = ut;
        }
        r == null || r([tt]), lt && l && i && ((vt = l.current) == null || vt.replaceEmbedUpdate(i, [tt]));
      }
    },
    [i, r, l]
  ), Jt = F(() => {
  ...
  const D = G({ book: n.book, chapterNum: n.chapterNum });
  ee(() => {
    (D.current.book !== n.book || D.current.chapterNum !== n.chapterNum) && (D.current = { book: n.book, chapterNum: n.chapterNum }, re.current());
  }, [n.book, n.chapterNum]);
  const pe = () => {
    var X;
    const j = (X = p.current) == null ? void 0 : X.getElementsByClassName("editor-input")[0];
    ...
    var lt, tt, ot, gt, vt;
    I(j);
    const X = (tt = (lt = w.current) == null ? void 0 : lt.getNoteOps(0)) == null ? void 0 : tt.at(0);
    if (X && Ir("note", X)) {
      X.insert.note && (X.insert.note.style = j);
      const ut = (gt = (ot = X.insert.note) == null ? void 0 : ot.contents) == null ? void 0 : gt.ops;
      B !== "x" && j === "x" ? ut == null || ut.forEach((Et) => Nw(Et)) : B === "x" && j !== "x" && (ut == null || ut.forEach((Et) => Cw(Et))), (vt = w.current) == null || vt.applyUpdate([X, { delete: 1 }]);
    }
  }, Vt = (j) => {
    ft(j.contextMarker), T(j.canRedo);
  }, Me = F(
    (j) => {
      var lt, tt, ot, gt, vt;
      const X = (tt = (lt = w.current) == null ? void 0 : lt.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (X && Ir("note", X)) {
        j.content.length > 1 && setTimeout(() => {
          var At;
          (At = w.current) == null || At.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const ut = (ot = X.insert.note) == null ? void 0 : ot.style, Et = (vt = (gt = X.insert.note) == null ? void 0 : gt.contents) == null ? void 0 : vt.ops;
        if (ut || x(!1), x(
          ut === "x" ? !!(Et != null && Et.every((At) => {
            var Lt, Pt;
            if (!((Lt = At.attributes) != null && Lt.char)) return !0;
            const Tt = ((Pt = At.attributes) == null ? void 0 : Pt.char).style;
          ...
          $.current = !0, U.current = JSON.stringify(X), S(!0);
          return;
        }
        S(JSON.stringify(X) === U.current), yt(m, _);
      } else
        x(!1), S(!0);
    },
    [m, _, yt]
    ...
    if (g.current && mt.length && j && j.rangeCount > 0) {
      const X = j.getRangeAt(0).getBoundingClientRect(), lt = g.current.getBoundingClientRect();
      it(X.left - lt.left), xt(X.top - lt.top), q(X.height), L(!0);
    }
  }, [mt, g]);
  Y(() => {
    const j = () => {
    ...
    var j;
    W && ((j = st.current) == null || j.focus());
  }, [W]), Y(() => {
    var lt;
    const j = ((lt = p.current) == null ? void 0 : lt.querySelector(".editor-input")) ?? void 0, X = (tt) => {
      !W && j && document.activeElement === j && tt.key === c ? (tt.preventDefault(), ce()) : W && tt.key === "Escape" && (tt.preventDefault(), L(!1));
    };
    return document.addEventListener("keydown", X), () => {
      document.removeEventListener("keydown", X);
    };
  }, [W, ce, c]);
  const Mt = d["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(rt, { children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
              /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ a(
                K,
                {
                  "aria-label": Mt,
              ...
              /* @__PURE__ */ a(Yt, { children: /* @__PURE__ */ a("p", { children: Mt }) })
            ] }) }) })
          ]
        }
      )
      ...
      if (typeof i == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(Aa, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
  ...
  return /* @__PURE__ */ u(rt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(rt, { children: Tw(t.marker, c, o, l) })
      }
    )
  ] });
}
function Rp({
  ...
  const w = d ?? ds(r, void 0), p = (_, k) => {
    l == null || l(_, k, n);
  }, g = i ? r.findIndex((_) => _ === i) : -1, [h, m] = C(g), y = (_, k, N) => {
    if (r.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), l == null || l(k, N, n);
          break;
      }
  }, v = (_) => {
    if (r.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), m((k) => Math.min(k + 1, r.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), m((k) => Math.max(k - 1, 0));
          break;
      }
  }, E = G([]);
  return Y(() => {
    var _;
    h >= 0 && h < E.current.length && ((_ = E.current[h]) == null || _.focus());
  }, [h]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((_, k) => {
            ...
            return /* @__PURE__ */ u(rt, { children: [
              ...
              k < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(rr, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function Ow({
  ...
  return /* @__PURE__ */ u(la, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(ho, { stickyHeader: !0, children: /* @__PURE__ */ u(we, { children: [
      /* @__PURE__ */ a(ra, { children: n }),
      /* @__PURE__ */ a(ra, { children: i })
    ] }) }),
    /* @__PURE__ */ a(da, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      we,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(ie, { children: Ce(c.reference, "English") }),
          /* @__PURE__ */ a(ie, { className: o, children: Dw(c.text) })
        ]
      },
...
const Rw = (t) => {
...
}, wa = (t, e, r) => /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
  /* @__PURE__ */ u(
    Ht,
    {
  ...
  return e ? e[1] : "";
}, Mw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Lp = Object.freeze([
...
function jp({
  ...
  const h = he(r, "%webView_inventory_all%"), m = he(r, "%webView_inventory_approved%"), y = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), E = he(r, "%webView_inventory_scope_currentBook%"), _ = he(r, "%webView_inventory_scope_chapter%"), k = he(r, "%webView_inventory_scope_verse%"), N = he(r, "%webView_inventory_filter_text%"), M = he(
    r,
    "%webView_inventory_show_additional_items%"
  ), B = he(r, "%webView_inventory_no_results%"), [I, V] = C(!1), [x, R] = C("all"), [S, z] = C(""), [T, $] = C([]), U = P(() => {
    const q = t ?? [];
    return q.length === 0 ? [] : Pw(q, n, i);
  }, [t, n, i]), W = P(() => {
    if (I) return U;
    const q = [];
    return U.forEach((at) => {
      const ft = at.items[0], st = q.find(
        (ct) => ct.items[0] === ft
      );
      st ? (st.count += at.count, st.occurrences = st.occurrences.concat(at.occurrences)) : q.push({
        items: [ft],
        count: at.count,
  ...
  }, [I, U]), L = P(() => W.length === 0 ? [] : Aw(W, x, S), [W, x, S]), et = P(() => {
    var ft, st;
    if (!I) return d;
  ...
  Y(() => {
    L.length === 0 ? $([]) : L.length === 1 && $(L[0].items);
  }, [L]);
  const it = (q, at) => {
    at.setRowSelection(() => {
      const st = {};
    ...
    if (W.length === 0 || T.length === 0) return [];
    const q = W.filter((at) => ws(
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        nr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(cr, { children: [
              /* @__PURE__ */ a(le, { value: "all", children: h }),
              /* @__PURE__ */ a(le, { value: "approved", children: m }),
      ...
      /* @__PURE__ */ u(nr, { onValueChange: (q) => bt(q), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(cr, { children: [
          ...
          /* @__PURE__ */ a(le, { value: "chapter", children: _ }),
          /* @__PURE__ */ a(le, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Sr,
      ...
      o && /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Gt, { children: [
        /* @__PURE__ */ a(Ht, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            Ni,
            {
        ...
        /* @__PURE__ */ a(Yt, { children: (o == null ? void 0 : o.checkboxText) ?? M })
      ] }) })
    ] }),
        ...
        children: [
          ...
          t && /* @__PURE__ */ u(
            K,
            {
              ...
              children: [
                /* @__PURE__ */ a(na, { className: "tw:h-4 tw:w-4" }),
...
const Ci = ia(({ className: t, ...e }, r) => /* @__PURE__ */ a(Bs, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
Ci.displayName = "Spinner";
function Iw(t, e = 50) {
  const [r, o] = C(e), n = G(null);
  return Y(() => {
    o(e);
  }, [t, e]), Y(() => {
...
function Sa({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(rt, { children: [
      /* @__PURE__ */ a(we, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(ie, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        we,
        {
          ...
          children: [
            /* @__PURE__ */ a(ie, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(rt, { children: [
              /* @__PURE__ */ a(Ve, { className: "tw:h-3.5 tw:w-3.5", "aria-hidden": !0 }),
              /* @__PURE__ */ a("span", { className: "tw:sr-only", children: t })
            ] }) }),
            /* @__PURE__ */ a(ie, { className: "tw:border-0 tw:py-1 tw:pr-2 tw:font-normal tw:whitespace-nowrap", children: o.displayName }),
            /* @__PURE__ */ a(ie, { className: "tw:border-0 tw:py-1 tw:pl-2", children: o.fullName }),
            /* @__PURE__ */ a(ie, { className: "tw:border-0 tw:py-1 tw:pl-4 tw:text-right tw:text-muted-foreground", children: o.bestLanguageName })
          ]
        },
        o.dblEntryUid
      ))
...
function Bp({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = P(
    () => t.filter((T) => !r || T.type === r).filter((T) => Vw(T, s)).filter(
      (T) => d.length === 0 || d.includes(T.bestLanguageName)
    ),
    [t, r, s, d]
  ), p = P(
    () => w.filter((T) => o == null ? void 0 : o.includes(T.dblEntryUid)),
    [w, o]
  ), g = P(
    () => w.filter((T) => T.installed && !(o != null && o.includes(T.dblEntryUid))),
    [w, o]
  ), h = P(
    () => w.filter(
      (T) => !T.installed && !(o != null && o.includes(T.dblEntryUid))
    ),
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = Iw(h), E = P(
    () => Array.from(new Set(t.map((T) => T.bestLanguageName))).map((T) => ({
      label: T,
      value: T
    })),
    [t]
  ), _ = p.length === 0 && g.length === 0 && h.length === 0, k = _e(n, "%resourcePicker_title%"), N = _e(n, "%resourcePicker_search_placeholder%"), M = _e(n, "%resourcePicker_language_filter_any%"), B = _e(
    n,
    "%resourcePicker_section_already_selected%"
  ), I = _e(n, "%resourcePicker_section_installed%"), V = _e(
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = _e(n, "%resourcePicker_no_results%"), R = _e(n, "%resourcePicker_showing_count%"), S = P(() => {
    if (d.length === E.length || d.length === 0)
      return M;
    if (d.length === 1) {
      const T = E.find(($) => $.value === d[0]);
      if (T) return T.label;
    }
    return Ne(
  ...
  }, [d, E, M, n]), z = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(rt, { children: [
    /* @__PURE__ */ a(Yr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Wr, { children: k }) }),
    ...
    z && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: Ne(R, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(Ci, {}) }),
      _ && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: x }),
      !_ && !e && /* @__PURE__ */ a(la, { children: /* @__PURE__ */ u(da, { children: [
        /* @__PURE__ */ a(Sa, { label: B, resources: p }),
        /* @__PURE__ */ a(Sa, { label: I, resources: g, onSelect: i }),
        /* @__PURE__ */ a(
          Sa,
          {
            label: V,
        ...
        v && /* @__PURE__ */ a(we, { className: "tw:border-0", children: /* @__PURE__ */ a(ie, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: y, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const Lw = "16rem", jw = "3rem", Ei = pt.createContext(void 0);
function pa() {
  const t = pt.useContext(Ei);
  if (!t)
...
function Fw({
  ...
  const [d, l] = pt.useState(t), w = e ?? d, p = pt.useCallback(
    (k) => {
      const N = typeof k == "function" ? k(w) : k;
      r ? r(N) : l(N);
    },
    [r, w]
  ), g = pt.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = Xt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = pt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Ei.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
...
function Up({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    K,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(qc, {}) : /* @__PURE__ */ a(Gc, {}),
...
function Yw({
  ...
  const c = t ? dr.Root : "button", { state: d } = pa(), l = /* @__PURE__ */ a(
    c,
    {
  ...
  return n ? /* @__PURE__ */ u(Gt, { children: [
    /* @__PURE__ */ a(Ht, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      Yt,
      {
        side: "right",
    ...
    Bw,
    {
      ...
      children: /* @__PURE__ */ u(Kw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(qw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(Gw, { children: /* @__PURE__ */ a(
            Yw,
            {
              onClick: () => l(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(Us, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  Zi,
                  {
                    mode: "project",
...
const Ae = "scrBook", Xw = "scrRef", He = "source", Jw = "details", Zw = "Scripture Reference", Qw = "Scripture Book", Ti = "Type", tu = "Details";
function eu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? wt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ae ? Ce(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Jw,
      header: (t == null ? void 0 : t.detailsColumnName) ?? tu,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
const ru = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ra(t.start, t.end) === 0 ? `${fa(t.start)}+${e}` : `${fa(t.start)}+${e}-${fa(t.end)}+${r}`;
}, dn = (t) => `${ru({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ah({
  sources: t,
  ...
  const [l, w] = C([]), [p, g] = C([{ id: Ae, desc: !1 }]), [h, m] = C({}), y = P(
    () => t.flatMap((x) => x.data.map((R) => ({
      ...R,
      source: x.source
    }))),
    [t]
  ...
  Y(() => {
    if (c) {
      const x = E.getSelectedRowModel().rowsById, R = Object.keys(x);
      if (R.length === 1) {
        const S = y.find((z) => dn(z) === R[0]) || void 0;
        S && c(S);
      }
    }
  }, [h, y, c, E]);
  const _ = n ?? Qw, k = i ?? Ti, N = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${_}`, value: [Ae] },
    ...
    !x.getIsGrouped() && !x.getIsSelected() && x.getToggleSelectedHandler()(R);
  }, I = (x, R) => x.getIsGrouped() ? "" : f("banded-row", R % 2 === 0 ? "even" : "odd"), V = (x, R, S) => {
    if (!((x == null ? void 0 : x.length) === 0 || R.depth < S.column.getGroupedIndex())) {
      if (R.getIsGrouped())
        switch (R.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { position: "item-aligned", children: /* @__PURE__ */ a(Qd, { children: N.map((x) => /* @__PURE__ */ a(le, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(la, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(ho, { children: E.getHeaderGroups().map((x) => /* @__PURE__ */ a(we, { children: x.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ra, { colSpan: R.colSpan, className: "tw:sticky top-0", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          vr(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, x.id)) }),
      /* @__PURE__ */ a(da, { children: E.getRowModel().rows.map((x, R) => {
        const S = Xt();
        return /* @__PURE__ */ a(
          we,
          {
            ...
            className: f(I(x, R)),
            onClick: (z) => B(x, z),
            children: x.getVisibleCells().map((z) => {
                  ...
                  ie,
                  {
                    ...
                    children: z.getIsGrouped() ? /* @__PURE__ */ u(
                      K,
                      {
                        ...
                        type: "button",
                        children: [
                          x.getIsExpanded() && /* @__PURE__ */ a(ar, {}),
                          !x.getIsExpanded() && (S === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a($a, {})),
                          " ",
                          vr(z.column.columnDef.cell, z.getContext()),
                          " (",
                          x.subRows.length,
                          ")"
                        ]
...
const Si = (t, e, r) => fo(t, e).every((o) => r.includes(o));
function au({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: m } = {
  ...
  }, [y, v] = C(!1), [E, _] = C(""), k = G(void 0), N = G(!1), M = P(
    () => zi(t),
    [t]
  ), B = P(() => {
    if (!E.trim()) {
    ...
    (z, T = !1) => {
      if (!T || !k.current) {
        r(
          e.includes(z) ? e.filter((it) => it !== z) : [...e, z]
        ), k.current = z;
        return;
      }
      const $ = M.findIndex((it) => it === k.current), U = M.findIndex((it) => it === z);
      if ($ === -1 || U === -1) return;
      const [W, L] = [
        Math.min($, U),
        Math.max($, U)
      ], et = M.slice(W, L + 1).map((it) => it);
      r(
        e.includes(z) ? e.filter((it) => !et.includes(it)) : [.../* @__PURE__ */ new Set([...e, ...et])]
      );
    },
    [e, r, M]
  ), V = (z) => {
    I(z, N.current), N.current = !1;
  }, x = (z, T) => {
    z.preventDefault(), I(T, z.shiftKey);
  }, R = () => {
    r(M.map((z) => z));
  }, S = () => {
    r([]);
          ...
          Fe,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: R, children: d }),
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: S, children: l })
              ] }),
              /* @__PURE__ */ u(Be, { children: [
                /* @__PURE__ */ a(oa, { children: w }),
                Object.values(Q).map((z, T) => {
                  const $ = B[z];
                  if ($.length !== 0)
                    return /* @__PURE__ */ u(_n, { children: [
                      /* @__PURE__ */ a(
                        me,
                        {
                          heading: Fn(z, p, g, h, m),
                          children: $.map((U) => /* @__PURE__ */ a(
                            Un,
                            {
                              bookId: U,
                      ...
                      T < Object.values(Q).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, z);
                })
              ] })
            ]
...
function nu({
  ...
  const i = o["%webView_book_selector_more%"], s = P(
    ...
    (d) => {
      ...
      r(
        Si(s, d, e) ? e.filter((w) => !l.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...l])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Da ? Da : wn
      ).map((d) => /* @__PURE__ */ a(xr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Pe(d, n) }, d)),
...
function nh({
  ...
  const N = Ot(
    s,
    "%webView_scope_selector_selected_text%"
  ), M = Ot(s, "%webView_scope_selector_verse%"), B = Ot(s, "%webView_scope_selector_chapter%"), I = Ot(s, "%webView_scope_selector_book%"), V = Ot(
    s,
    "%webView_scope_selector_current_verse%"
  ), x = Ot(
    s,
    "%webView_scope_selector_current_chapter%"
  ), R = Ot(s, "%webView_scope_selector_current_book%"), S = Ot(s, "%webView_scope_selector_choose_books%"), z = Ot(s, "%webView_scope_selector_scope%"), T = Ot(s, "%webView_scope_selector_select_books%"), $ = Ot(s, "%webView_scope_selector_range%"), U = Ot(s, "%webView_scope_selector_select_range%"), W = Ot(s, "%webView_scope_selector_range_start%"), L = Ot(s, "%webView_scope_selector_range_end%"), et = Ot(s, "%webView_scope_selector_ok%"), it = Ot(s, "%webView_scope_selector_cancel%"), bt = Ot(s, "%webView_scope_selector_navigate%"), xt = (A) => {
    if (!m) return;
  ...
  ], q = (A, J, Kt = !1) => /* @__PURE__ */ u(rt, { children: [
    A,
    J && !Kt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), at = e ? It.filter((A) => e.includes(A.value)) : It, ft = m ?? ma, st = w ?? ft, ct = p ?? ft, mt = () => {
  }, yt = G(null), Jt = G(null), re = G(!1), D = G(null), pe = G(!1), [ae, Nt] = C(void 0), $t = G(!1), Vt = G(!1), Me = G(null), ce = F((A) => {
    if (A) {
      Nt("start"), $t.current = !1;
      return;
    }
    Nt((J) => J === "start" ? void 0 : J), $t.current && ($t.current = !1, requestAnimationFrame(() => {
      var Kt;
      const J = (Kt = yt.current) == null ? void 0 : Kt.querySelector("button");
      J == null || J.click();
    }));
  }, []), Mt = F((A) => {
    if (A) {
    ...
    (A) => {
      g == null || g(A), h == null || h(A), $t.current = !0;
    },
    [g, h]
  ), X = F(
    (A) => {
      h == null || h(A), Vt.current = !0;
    },
    [h]
  ), lt = F(
    (A) => {
    ...
    [r, n, m, i]
  ), tt = at.find((A) => A.value === t), ot = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? us(st, ct, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : tt ? q(tt.label, tt.scrRefSuffix) : t, gt = at.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), vt = at.find((A) => A.value === "selectedBooks"), ut = at.find((A) => A.value === "range"), [Et, At] = C(!1), [Tt, Lt] = C(void 0), [Pt, O] = C(void 0), [Ct, zt] = C(void 0), [Zt, Ke] = C(void 0), [ur, Dr] = C([]), Or = l === "dropdown" && Tt === "selectedBooks", b = /* @__PURE__ */ a(
    nu,
    {
      availableBookInfo: o,
      selectedBookIds: Or ? ur : n,
      onChangeSelectedBookIds: Or ? Dr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), H = ae === "end", Z = ae === "start", St = "tw:text-muted-foreground", oe = l === "dropdown" && Tt === "range", Je = oe ? zt : j, jt = oe ? Ke : h ? X : mt, kt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: f(H && St), children: W }),
      /* @__PURE__ */ a(
        ba,
        {
    ...
    /* @__PURE__ */ u("div", { ref: yt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: f(Z && St), children: L }),
      /* @__PURE__ */ a(
        ba,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: oe ? Ct ?? st : st,
          onOpenChange: Mt,
          onCloseAutoFocus: (A) => {
            var J;
            Vt.current && (Vt.current = !1, A.preventDefault(), (J = Me.current) == null || J.focus());
          },
          className: f(Z && St),
          modal: !0,
          align: "start"
  ...
  const [te, qe] = C(null), [Rr, Ii] = C(null), [$r, Vi] = C(null), Li = 200, [ji, Fi] = C(!1);
  Y(() => {
    if (!$r || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([J]) => {
      Fi(J.contentRect.width < Li);
    });
    return A.observe($r), () => A.disconnect();
  }, [$r]);
  const mo = F(
    (A) => {
      O(A), zt(st), Ke(ct), Dr(n), At(!1), Lt(A);
    },
    [st, ct, n]
  ), vo = F(() => {
    Pt !== void 0 && (Pt === "range" ? (Ct && (g == null || g(Ct)), Zt && (h == null || h(Zt))) : Pt === "selectedBooks" && i(ur), lt(Pt), Lt(void 0), O(void 0));
  }, [
    Pt,
    Ct,
    Zt,
    ...
    A || (Lt(void 0), O(void 0));
  }, []), bo = F((A) => {
    var J;
    A.preventDefault(), (J = Qt.current) == null || J.focus();
  }, []), xo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !_ && /* @__PURE__ */ a(_t, { children: z }),
      l === "dropdown" ? /* @__PURE__ */ u(Te, { open: Et, onOpenChange: At, children: [
        ...
        /* @__PURE__ */ a(
          Se,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ha, { container: $r, children: [
              gt.map(({ value: A, label: J, dropdownLabel: Kt, scrRefSuffix: hr, id: Bi }) => /* @__PURE__ */ u(
                Ye,
                {
                  ref: ht(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }),
                    q(Kt ?? J, hr, ji)
                  ]
                },
                Bi
              ...
              y && /* @__PURE__ */ u(rt, { children: [
                /* @__PURE__ */ a(We, {}),
                /* @__PURE__ */ a(Cr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: bt }),
                /* @__PURE__ */ a(
                  Ye,
                  {
                    ref: D,
                    ...
                    onSelect: (A) => {
                      var J, Kt;
                      if (A.preventDefault(), re.current) {
                        re.current = !1;
                        return;
                      }
                      pe.current || (Kt = (J = Jt.current) == null ? void 0 : J.querySelector("button")) == null || Kt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          J != null && J.closest("button") && (re.current = !0, requestAnimationFrame(() => {
                            re.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ba,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var J;
                              A.preventDefault(), (J = D.current) == null || J.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(rt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ce(m ?? ma, "id") }),
                              /* @__PURE__ */ a(ar, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        ao,
        {
          ...
          children: at.map(({ value: A, label: J, scrRefSuffix: Kt, id: hr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Xr, { className: "tw:me-2", value: A, id: hr }),
            /* @__PURE__ */ a(_t, { htmlFor: hr, children: q(J, Kt) })
          ] }, hr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && kt,
    l === "dropdown" && vt && /* @__PURE__ */ a(Fa, { open: Tt === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: Ii,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (A) => {
          Rr != null && Rr.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(ha, { container: Rr, children: [
          /* @__PURE__ */ a(Yr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Wr, { children: S }) }),
          b,
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Mr(!1), children: it }),
            /* @__PURE__ */ a(K, { onClick: vo, children: et })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ut && /* @__PURE__ */ a(Fa, { open: Tt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: qe,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(ha, { container: te, children: [
          /* @__PURE__ */ a(Yr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Wr, { children: U }) }),
          kt,
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Mr(!1), children: it }),
            /* @__PURE__ */ a(K, { ref: Me, onClick: vo, children: et })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          cr,
          {
            ...
            style: { zIndex: lr },
            children: t.map((l) => /* @__PURE__ */ a(le, { value: `${l}`, children: c[ko(l)] }, `${l}`))
          }
        )
      ]
    }
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(Gt, { children: [
  /* @__PURE__ */ a(Ht, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    Ye,
    {
      onClick: () => {
        o(c);
    ...
    /* @__PURE__ */ a(rs, { children: /* @__PURE__ */ a(as, { children: Oi(
      t,
      e,
      Di(t, c.id),
      o
...
function Ha({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(K, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ks, {}) }) }),
    /* @__PURE__ */ a(Se, { align: "start", style: { zIndex: lr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(_n, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(qt, { children: Oi(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(We, {})
    ] }, d)) })
  ] });
}
const Ri = pt.forwardRef(
...
const $i = pt.forwardRef(({ className: t, ...e }, r) => {
  const o = Xt();
  return /* @__PURE__ */ a(
    ue.Root,
    {
...
$i.displayName = ue.List.displayName;
const Mi = pt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.List,
  {
    ref: r,
    className: f(
...
Mi.displayName = ue.List.displayName;
const cu = pt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.Trigger,
  {
    ref: r,
    ...e,
...
)), Ai = pt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.Content,
  {
    ref: r,
    className: f(
...
Ai.displayName = ue.Content.displayName;
function uh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u($i, { children: [
      /* @__PURE__ */ a(Mi, { children: t.map((c) => /* @__PURE__ */ a(cu, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(Ai, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function lu({
...
const fr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Gt, { children: [
      /* @__PURE__ */ a(Ht, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        hu,
        {
          onClick: () => {
            o(l);
      ...
      ) : /* @__PURE__ */ u(fu, { children: [
        /* @__PURE__ */ a(mu, { children: l.label }),
        /* @__PURE__ */ a(vu, { children: Pi(
          t,
          e,
          Di(t, l.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(gu, {}, `separator-${i}`)), d;
  });
};
function bu({
  menuData: t,
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), fr(i, [g, h]);
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), fr(s, [g, h]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), fr(c, [g, h]);
        break;
      case "alt+h":
        (E = d.current) == null || E.focus(), fr(d, [g, h]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(lu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(du, { children: [
      /* @__PURE__ */ a(uu, { ref: l(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        pu,
        {
          style: { zIndex: lr },
          children: /* @__PURE__ */ a(qt, { children: Pi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function gh({
  ...
  const l = xu(
    ...
    var E, _, k, N, M, B;
    const v = y !== m ? ((_ = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : _[y]) ?? ((N = (k = t[m]) == null ? void 0 : k.uiNames) == null ? void 0 : N.en) : void 0;
      ...
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: lr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(le, { value: m, children: h(m, e) }, m))
            }
          )
        ]
      }
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(ze, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(K, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Eo, {}) }) }),
              /* @__PURE__ */ a(Se, { align: "end", children: l })
            ] }) }),
...
function Rh({
  ...
  return /* @__PURE__ */ u(
    Rt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Rt.ItemIndicator, { children: /* @__PURE__ */ a(sa, {}) }) }),
        e
      ]
    }
  );
...
function Xh({
  ...
  return /* @__PURE__ */ a(
    ue.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Eu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  qh as Progress,
  Fp as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  ao as RadioGroup,
  ...
  Bp as ResourcePickerDialog,
  mh as ResultsCard,
  oh as SCOPE_SELECTOR_STRING_KEYS,
  iu as SELECT_BOOKS_STRING_KEYS,
  nh as ScopeSelector,
  ...
  nr as Select,
  nu as SelectBooks,
  au as SelectBooksPicker,
  cr as SelectContent,
  Qd as SelectGroup,
  le as SelectItem,
  vp as SelectLabel,
  ew as SelectScrollDownButton,
  tw as SelectScrollUpButton,
