...
import { c as v, g as Ae, a as Ur, C as tr, L as qn, t as Rs, u as an, T as zt, b as Nt, d as Ct, e as Et, f as Gn, A as ka, r as re, D as Be, h as Se, i as Fe, j as cr, k as Ge, B as et, x as Ds, l as Os, m as Ms, I as Is, n as To, o as Xe, p as be, q as zs, s as Wn, P as lr, v as Rr, w as dr, y as wr, z as Ia, E as za, F as So, G as ur, H as Pa, J as It, R as Ro, K as _a, M as so, N as co, O as lo, Q as wo, S as Do, U as Gr, V as Wr, W as xr, X as Ps, Y as ir, Z as Ze, _ as je, $ as We, a0 as yr, a1 as Oo, a2 as Mo, a3 as Na, a4 as Io, a5 as Yn, a6 as As, a7 as $s, a8 as Vs, a9 as uo, aa as Zn, ab as Aa, ac as Ls, ad as Xn, ae as Bs, af as Fs, ag as js, ah as on, ai as Us, aj as Ks, ak as Hs, al as Jn, am as Qn, an as zo, ao as qs, ap as ti, aq as Ha, ar as nn, as as qa, at as Gs, au as Ws, av as Ys, aw as Zs, ax as Xs, ay as Js, az as Qs, aA as tc, aB as ec, aC as Po, aD as Ao, aE as rc, aF as ac } from "./resizable-C_A_0ssf.js";
import { aG as Mf, aH as If, aI as zf, aJ as Pf, aK as Af, aL as $f, aM as Vf, aN as Lf, aO as Bf, aP as Ff, aQ as jf, aR as Uf, aS as Kf, aT as Hf, aU as qf, aV as Gf, aW as Wf, aX as Yf, aY as Zf, aZ as Xf, a_ as Jf, a$ as Qf, b0 as tm, b1 as em, b2 as rm, b3 as am, b4 as om, b5 as nm, b6 as im, b7 as sm, b8 as cm, b9 as lm, ba as dm, bb as wm, bc as um, bd as pm, be as hm, bf as gm, bg as fm, bh as mm, bi as vm } from "./resizable-C_A_0ssf.js";
...
function vd({
  ...
  Mi(), tt(() => {
    ...
    const x = (J) => !!J && J.scrollWidth > J.clientWidth, rt = () => {
      Gn() !== "pointer" && (S || x(h.current) || x(d.current)) && T(!0);
    }, X = () => T(!1);
...
function Za({
  ...
  const S = be(), M = md(), [I, O] = N(!1), [D, Y] = N(""), [Z, ot] = N(""), [x, rt] = N("books"), [X, L] = N(void 0), [J, j] = N(
    void 0
  ), [W, ut] = N(void 0), [mt, H] = N(!1), [gt, vt] = N(!1), [lt, Ot] = N(!1), [Tt, Pt] = N(!1), qt = P(null), Yt = P(!1), At = P(void 0), St = P(void 0), $t = P(void 0), ie = P(void 0), oe = P({}), se = P({}), bt = V(
    (m) => {
      e(m), d && d(m);
    },
    [e, d]
  ...
  const { otLong: _e, ntLong: Ne, dcLong: rr, extraLong: ar } = {
    ...
    () => Cd(Z),
    [Z]
  ), ct = A(() => !w || !B || !B.chapterNum || !it ? !1 : w(B.book, B.chapterNum) > 0, [w, B, it]), Gt = x === "books" && !mt && !Z.trim() && _t.size > 0, Pr = V(
    (m) => p ? xn(m, p) : !1,
    [p]
  ), Pe = V(
    (m) => (q) => p ? Ed(m, q, p) : !1,
    ...
    (m) => {
      ...
      if (!(!!q && !!((tn = At.current) != null && tn.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
      ...
      if (x === "books" && !Tt && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
        const Lt = q === St.current ? St.current : void 0, ue = (Lt == null ? void 0 : Lt.selectionStart) ?? 0, Zt = (Lt == null ? void 0 : Lt.selectionEnd) ?? 0, me = S === "rtl" ? m.key === "ArrowRight" : m.key === "ArrowLeft";
    ...
    const { isLetter: q, isDigit: st } = bn(m.key);
    (q || st) && (m.preventDefault(), ot((Dt) => Dt + m.key), (Wt = St.current) == null || Wt.focus(), H(!1));
  }, []);
  Kt(() => {
    const m = setTimeout(() => {
      if (I && x === "books" && $t.current && ie.current) {
        const q = $t.current, st = ie.current, Ft = st.offsetTop, Wt = q.clientHeight, Dt = st.clientHeight, ee = Ft - Wt / 2 + Dt / 2;
        q.scrollTo({
          top: Math.max(0, ee),
          behavior: "smooth"
        }), Y(bo(t.book));
  ...
  return Kt(() => {
    ...
    const { max: m, initial: q, parse: st, buildValue: Ft } = fe, Wt = (Dt) => {
      const ee = st(Dt);
      return ee !== void 0 && ee >= 1 && ee <= m && Dt === Ft(ee) ? ee : void 0;
    };
    if (Vt.current !== at) {
      Vt.current = at;
      const Dt = Ft(Math.min(Math.max(q, 1), m));
      we.current = Dt, Y(Dt);
      return;
    }
    if (Wt(D) !== void 0) {
    ...
    Y(
      Wt(we.current) !== void 0 ? we.current : Ft(Math.min(Math.max(q, 1), m))
    );
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        onPointerDownOutside: (m) => {
          const { target: q } = m;
          I && qt.current && q instanceof Node && qt.current.contains(q) && (Yt.current = !0, pt(!1));
        },
        onCloseAutoFocus: C,
        children: /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(
          wr,
          {
            ...
            children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(za, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: yt.map(
                      ({ onClick: m, disabled: q, title: st, icon: Ft, group: Wt }, Dt) => {
                        const ee = /* @__PURE__ */ a(
                          et,
                          {
                            variant: "ghost",
              ...
              Gt && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                et,
                {
                  variant: "ghost",
                  size: "sm",
...
function Zd(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), f = Gd(t, e);
    var y, b;
...
const Go = 0, Co = 1, Hi = 2, to = 3, ua = 4, vr = 5, eo = 6, Vr = 7;
function ro(t) {
  return t.id === Go;
}
function qi(t) {
...
class _r {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ro(s) || ft(300, i, n || "[unknown]"), ro(c = s) || ft(304, String(c.id), String(Go)), s = Object.assign(c, { id: Co }), o.state = s;
...
const ou = {
  ...
  const H = V(
    ...
    [J.commentEdits, H]
  ), [vt, lt] = N(), Ot = n, [Tt, Pt] = N(!1), [qt, Yt] = N(!1), [At, St] = N(!1), [$t, ie] = N(!1), [oe, se] = N(!1), [bt, ce] = N(z), [ye, Ie] = N(!1), le = P(void 0), [te, ke] = N(/* @__PURE__ */ new Map());
  tt(() => {
    let R = !0;
    return (async () => {
  ...
  const _ = A(
    ...
    if (!R) return R;
    const it = new Set(_.map((Gt) => Gt.id)), ct = Object.fromEntries(
      Object.entries(R).filter(([Gt]) => it.has(Gt))
    );
  ...
  const ze = V(
    ...
    async (R) => {
      const it = ne(j) ? Oa(j) : void 0, ct = R.status ? R.assignedUser : W ?? R.assignedUser, Gt = await h({
        ...R,
        contents: it,
        assignedUser: ct
      });
      return Gt && (ct !== void 0 && lt(ct), it && nt()), Gt;
    },
    [nt, j, h, W]
  );
    ...
    if ($ && $r("note", $)) {
      ...
      nt === mo ? yt = "generated" : nt === vo ? yt = "hidden" : nt && (k(nt), S(nt)), g(yt), E(yt), I(((K = $.insert.note) == null ? void 0 : K.style) ?? "f"), _ = setTimeout(() => {
        ...
        (Rt = h.current) == null || Rt.applyUpdate([$]), (dt = h.current) == null || dt.selectNote(0), (kt = h.current) == null || kt.focus(), U = requestAnimationFrame(() => {
          G = setTimeout(() => {
            var pt, xt;
            qt() || ((pt = h.current) == null || pt.selectNote(0), (xt = h.current) == null || xt.focus());
          }, 0);
        });
      }, 0);
    }
  ...
  tt(() => {
    ...
    if (((G = Tt.view) == null ? void 0 : G.markerMode) === "editable") {
      const $ = (K) => {
        ...
        var nt, yt;
        const K = _();
        !K || document.activeElement !== K || qt() || ((nt = h.current) == null || nt.selectNote(0), (yt = h.current) == null || yt.focus());
      };
    ...
    const _ = () => {
      ...
      G && !G.isCollapsed || qt() || ((Q = h.current) == null || Q.selectNote(0), (K = h.current) == null || K.focus());
    };
...
function Cg({
  ...
  ] }), lt = e ? gt.filter((F) => e.includes(F.value)) : gt, Ot = g ?? Wa, Tt = h ?? Ot, Pt = f ?? Ot, qt = () => {
  ...
  ), _ = lt.find((F) => F.value === "selectedBooks"), U = lt.find((F) => F.value === "range"), [G, $] = N(!1), [Q, K] = N(void 0), [nt, yt] = N(void 0), [Rt, dt] = N(void 0), [kt, pt] = N(void 0), [xt, Ue] = N([]), _e = p === "dropdown" && Q === "selectedBooks", Ne = /* @__PURE__ */ a(
    yp,
    {
      availableBookInfo: o,
  ...
  ), rr = oe === "end", ar = oe === "start", ze = "tw:text-muted-foreground", Ce = p === "dropdown" && Q === "range", hr = Ce ? dt : te, zr = Ce ? pt : b ? ke : qt, Ke = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Gt, Pr] = N(null), [Pe, gr] = N(null), [fr, ja] = N(null), ra = 200, [Ua, aa] = N(!1);
  tt(() => {
  ...
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    ...
    p === "dropdown" && U && /* @__PURE__ */ a(so, { open: Q === "range", onOpenChange: mr, children: /* @__PURE__ */ a(
      co,
      {
        ...
        onCloseAutoFocus: ia,
        onEscapeKeyDown: (F) => {
          Gt != null && Gt.querySelector('[data-state="open"]') && F.preventDefault();
        },
        children: /* @__PURE__ */ u(Ha, { container: Gt, children: [
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        style: { zIndex: je },
        onCloseAutoFocus: () => {
          Gn() === "pointer" && tc(h.current ?? void 0);
        },
...
export {
  ...
  qh as ERROR_POPOVER_STRING_KEYS,
