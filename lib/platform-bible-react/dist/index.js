...
var si = (t, e, r) => e in t ? ii(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var _t = (t, e, r) => si(t, typeof e != "symbol" ? e + "" : e, r);
import { jsx as a, jsxs as u, Fragment as et } from "react/jsx-runtime";
import { Command as Me } from "cmdk";
import { clsx as li } from "clsx";
import { extendTailwindMerge as ci, twMerge as di } from "tailwind-merge";
import { Slot as ke, Dialog as Ht, Popover as rr, Label as wi, RadioGroup as ra, Tooltip as Le, ToggleGroup as Ro, Separator as ui, Avatar as ya, DropdownMenu as vt, Select as Ct, Checkbox as Ua, Tabs as Bt, Menubar as Jt, ContextMenu as bt, Progress as Ka, Slider as dr, Switch as Ga } from "radix-ui";
import { cva as Zt } from "class-variance-authority";
import { IconX as pi, IconCheck as $e, IconSearch as gi, IconChevronRight as ka, IconChevronDown as hi, IconChevronUp as fi, IconSelector as mi, IconLayoutSidebar as vi, IconLayoutSidebarRight as bi, IconLoader as xi, IconAlertOctagon as yi, IconAlertTriangle as ki, IconInfoCircle as _i, IconCircleCheck as Ni } from "@tabler/icons-react";
import { Canon as ct } from "@sillsdev/scripture";
import { includes as wr, Section as W, getChaptersForBook as Ci, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as Ei, formatReplacementString as oe, sanitizeHtml as zi, NumberFormat as Ti, formatBytes as Si, getCurrentLocale as Di, usfmMarkers as mr, getFormatCallerFunction as Ri, deepEqual as Mi, isString as qa, compareScrRefs as aa, scrRefToBBBCCCVVV as Fr, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
import { Check as nr, Clock as Ha, ChevronsLeft as Wa, ChevronsRight as Ya, ChevronLeft as oa, ChevronRight as na, ArrowLeft as $i, ArrowRight as Oi, ChevronDown as Dr, BoldIcon as Ai, ItalicIcon as Ii, X as Rr, AtSign as Mo, Pencil as Pi, Trash2 as Li, ArrowUp as $o, MoreHorizontal as Vi, MailOpen as ji, Mail as Fi, ChevronUp as Bi, FilterIcon as Ui, ArrowLeftIcon as Ki, ChevronLeftIcon as Gi, ChevronRightIcon as qi, ArrowRightIcon as Hi, Copy as Oo, Filter as Wi, User as Yi, Link as Xi, CircleHelp as Ji, ChevronsUpDown as Ao, Star as Zi, Undo as Qi, Redo as ts, SquareX as Io, FunctionSquare as Po, SquareSigma as Lo, Ban as es, AlertCircle as ia, CircleCheckIcon as rs, CircleXIcon as as, CircleHelpIcon as os, ArrowUpIcon as ns, ArrowDownIcon as is, Search as ss, LoaderCircle as ls, ScrollText as cs, MenuIcon as ds, Menu as ws, EllipsisVertical as us, MoreVertical as Xa } from "lucide-react";
import tt, { forwardRef as ir, useRef as q, useMemo as P, useState as T, useCallback as j, useLayoutEffect as $t, createContext as Mr, useContext as _a, useEffect as K, Component as ps, createElement as Ja, Suspense as gs, Fragment as Vo } from "react";
import { createEditor as jo, $getRoot as le, $createParagraphNode as We, $getSelection as zt, HISTORY_MERGE_TAG as Na, ParagraphNode as Fo, TextNode as Bo, $isTokenOrSegmented as hs, $getCharacterOffsets as fs, $cloneWithPropertiesEphemeral as ms, $getPreviousSelection as vs, $isRangeSelection as Wt, $caretFromPoint as bs, $getSiblingCaret as Uo, $getChildCaret as xs, $getAdjacentChildCaret as ys, $isChildCaret as ks, $normalizeCaret as _s, $setSelectionFromCaretRange as Ns, $getCollapsedCaretRange as Cs, $getCaretInDirection as Za, $splitAtPointCaretNext as Es, $isTextPointCaret as zs, $findMatchingParent as Ko, $isElementNode as ie, mergeRegister as ce, getDOMTextNode as Ts, isHTMLElement as Go, CLEAR_EDITOR_COMMAND as qo, COMMAND_PRIORITY_EDITOR as Ca, shallowMergeConfig as Ss, defineExtension as Lt, safeCast as Oe, createState as Ds, FORMAT_TEXT_COMMAND as Ho, $isNodeSelection as Wo, COMMAND_PRIORITY_LOW as Yo, RootNode as Rs, LineBreakNode as Ms, TabNode as $s, $isEditorState as Os, createCommand as As, CLICK_COMMAND as Is, isDOMNode as Ps, $getNodeFromDOMNode as Ls, $createNodeSelection as Vs, $setSelection as js, $getEditor as Fs, DecoratorNode as sa, $getState as Bs, toggleTextFormatType as Qa, TEXT_TYPE_TO_FORMAT as Us, $setState as Ks, addClassNamesToElement as Xo, $create as Gs, $getNodeByKey as qs, removeClassNamesFromElement as Hs, KEY_TAB_COMMAND as Ws, $isBlockElementNode as yr, $createRangeSelection as Ys, $normalizeSelection__EXPERIMENTAL as Xs, OUTDENT_CONTENT_COMMAND as Js, INDENT_CONTENT_COMMAND as to, INSERT_TAB_COMMAND as Zs, COMMAND_PRIORITY_CRITICAL as Ea, $isDecoratorNode as Qs, $isParagraphNode as tl, $isTextNode as kr, SELECTION_CHANGE_COMMAND as Jo, getRegisteredNode as el, isDocumentFragment as eo, isDOMDocumentNode as rl, ArtificialNode__DO_NOT_USE as Zo, $createLineBreakNode as Qo, $isRootOrShadowRoot as al, isBlockDomNode as ro, isInlineDomNode as ao, $insertNodes as ol } from "lexical";
import { HeadingNode as nl, QuoteNode as il, registerRichText as sl } from "@lexical/rich-text";
import { flushSync as ll, createPortal as cl } from "react-dom";
import { $isTableSelection as dl } from "@lexical/table";
import { createHeadlessEditor as tn } from "@lexical/headless";
import { useReactTable as en, getFilteredRowModel as wl, getSortedRowModel as rn, getPaginationRowModel as ul, getCoreRowModel as an, flexRender as tr, getGroupedRowModel as pl, getExpandedRowModel as gl } from "@tanstack/react-table";
import hl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as la, HIDDEN_NOTE_CALLER as ca, getDefaultViewOptions as fl, isInsertEmbedOpOfType as ur, Editorial as ml } from "@eten-tech-foundation/platform-editor";
...
function f(...t) {
  const e = li(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return yl(e);
  const r = e.split(" ").filter(Boolean), o = /* @__PURE__ */ new Map(), n = [];
  return r.forEach((c) => {
    const d = kl(c);
    o.set(d.normalized, d.original), n.push(d.normalized);
  }), di(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const d = o.get(c);
    return d ? _l(c, d) : c;
  }).join(" ");
}
const Ye = 250, on = 300, Nl = 400, Cl = 450, El = 500, nn = Zt(
...
function lr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Ml, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        Me.Input,
        {
      ...
      /* @__PURE__ */ a(Ol, { children: /* @__PURE__ */ a(gi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Ou(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (l) => !r(l, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function Au({
  ...
  const d = lt(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, N] = T("books"), [x, _] = T(void 0), [k, $] = T(!1), V = q(void 0), A = q(void 0), C = q(void 0), z = q(void 0), E = q({}), O = j(
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: H, isDigit: Z } = oo(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        ...
        R !== ot && (M.preventDefault(), M.stopPropagation(), p(wa(wt, n, R)), setTimeout(() => {
          ...
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a(
              L,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a($i, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Oi, { className: "tw:h-4 tw:w-4" })
              }
            ),
...
const hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gl = hn ? $t : K, pr = { tag: Na };
function ql({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: c } = t, d = Kl(null, o), w = jo({ editable: t.editable, html: c, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
...
const Ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function tc(t) {
...
const fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, oc = fn && "documentMode" in document ? document.documentMode : null;
!(!fn || !("InputEvent" in window) || oc) && "getTargetRanges" in new window.InputEvent("input");
function Gt(t) {
  return `${t}px`;
}
const nc = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function ic(t, e, r) {
  let o = null, n = null, i = null, s = [];
  const l = document.createElement("div");
  function c() {
    o === null && _r(182), n === null && _r(183);
    const { left: g, top: h } = n.getBoundingClientRect(), p = rc(t, e);
    var m, b;
    ...
    w.read(() => {
      ...
      if ((V || A) && k !== null && $ !== null) {
        const C = function(z, E, O, D, F, I, G) {
          ...
          return y.setStart(...io(E, O, D)), y.setEnd(...io(F, I, G)), y;
        }(t, h, m, k, p, N, $);
        c(), c = ic(t, C, e);
      }
...
function cc(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = lc(t, e));
  };
...
function dc(t) {
  const e = Ko(t, (r) => ie(r) && !r.isInline());
  return ie(e) || _r(4, t.__key), e;
}
function wc(t) {
  const e = zt() || vs();
  let r;
  if (Wt(e)) r = bs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (r = Uo(l, "next"));
    }
    r = r || xs(le(), "previous").getFlipped().insert(We());
  }
  const o = uc(t, r), n = ys(o), i = ks(n) ? _s(n) : o;
  return Ns(Cs(i)), t.getLatest();
}
function uc(t, e, r) {
  let o = Za(e, "next");
  for (let n = o; n; n = Es(n, r)) o = n;
  return zs(o) && _r(283), o.insert(t.isInline() ? We().append(t) : t), Za(Uo(t.getLatest(), "next"), e.direction);
}
function pc(t) {
  const e = zt();
  if (!Wt(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const l = Ko(i, (d) => ie(d) && !d.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
const gc = Symbol.for("preact-signals");
function Or() {
...
let Nr, se = 0, Cr = 0, fc = 0, ha = 0, vr = 0;
function lo(t) {
  if (X === void 0) return;
  let e = t.n;
...
Nt.prototype.brand = gc, Nt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      se !== 0 && Cr === 0 && e.l !== ha && (e.l = ha, Nr = { S: e, v: e.v, i: e.i, o: Nr });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, bn(this), co(this), se++;
  const t = X;
  return X = this, vc.bind(this, t);
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $onClear: xn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const Gr = Ds("format", { parse: (t) => typeof t == "number" ? t : 0 });
class kn extends sa {
  $config() {
...
Lt({ name: "@lexical/extension/DecoratorText", nodes: () => [kn], register: (t, e, r) => t.registerCommand(Ho, (o) => {
  const n = zt();
  if (Wo(n) || Wt(n)) for (const i of n.getNodes()) xc(i) && i.toggleFormat(o);
  return !1;
}, Yo) });
function _n(t, e) {
  let r;
...
const fa = Lt({ build: (t) => _n(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const $a = 0, ma = 1, Cn = 2, qr = 3, gr = 4, Ie = 5, Hr = 6, Je = 7;
function Wr(t) {
  return t.id === $a;
}
function En(t) {
...
class _c {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Ss;
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || kc;
  }
  getPeerNameSet() {
...
const Cc = Lt({ config: Oe({ setOptions: wo, updateOptions: wo }), init: ({ $initialEditorState: t = Nc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (Os(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [Rs, Bo, Ms, $s, Fo] }), uo = Symbol.for("@lexical/extension/LexicalBuilder");
function po() {
}
function Ec(t) {
  throw t;
...
class je {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && Q(298, o.name), !n) {
      n = new _c(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var l;
      Wr(i) || Q(300, s, n || "[unknown]"), Wr(l = i) || Q(304, String(l.id), String($a)), i = Object.assign(l, { id: ma }), o.state = i;
      const c = this.outgoingConfigEdges.get(s);
      if (c) for (const d of c.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = yc(i), o.state = i, e.push(o);
    };
...
const zc = /* @__PURE__ */ new Set(), go = Lt({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const l = mc(() => (i.value || zc).has(s)), { watchedNodeKeys: c } = n.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), n.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), Tc = As("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: Sc, priority: 0 }) };
  }
  exportDOM() {
...
Lt({ dependencies: [fa, go], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ce(t.registerCommand(Tc, (s) => {
    const l = zt();
    if (!Wt(l)) return !1;
    ...
    return !0;
  }, Ca), t.registerCommand(Is, (s) => {
    if (Ps(s.target)) {
      const l = Ls(s.target);
      if (Dc(l)) return function(c, d = !1) {
        const w = zt(), g = c.isSelected(), h = c.getKey();
        let p;
        d && Wo(w) ? p = w : (p = Vs(), js(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Xt(() => {
    if (!o.disabled.value) return cc(t, o.onReposition.value);
  });
} });
function zn(t) {
  return t.canBeEmpty();
}
function Rc(t, e, r = zn) {
  return ce(t.registerCommand(Ws, (o) => {
    const n = zt();
    if (!Wt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => yr(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), g = dc(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Ys();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = Xs(p), p.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Js : to : Zs;
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: zn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Xt(() => {
    if (!o.value) return Rc(t, n, i);
  });
} });
const Mc = Lt({ name: "@lexical/react/ReactProvider" });
function $c() {
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Xt(() => r.getOutput().disabled.value ? void 0 : Sn(t)) });
function Ic(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Aa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
  ...
  return function(r, o) {
    ...
    return Aa(() => r.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = a(o, { onError: (h) => r._onError(h), children: a(gs, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(cl(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Lc({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Mc.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Ic(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Pc, { editor: t, ErrorBoundary: e });
}
function ho(t) {
  return t.getEditorState().read(Tn(t.isComposing()));
}
function Vc({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Qt();
  return function(n) {
    Aa(() => ce(sl(n), Sn(n)), [n]);
  }(o), u(et, { children: [t, a(jc, { content: e }), a(Lc, { editor: o, ErrorBoundary: r })] });
}
...
const Bc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Uc({ onClear: t }) {
  const [e] = Qt();
  return Bc(() => yn(e, t), [e, t]), null;
}
const Dn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Kc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: N = !0, style: x, tabIndex: _, "data-testid": k, ...$ }, V) {
  ...
  return Dn(() => (C(t.isEditable()), t.registerEditableListener((O) => {
    C(O);
...
function Hc(t, e) {
  ...
  return u(et, { children: [a(Gc, { editor: n, ...o, ref: e }), r != null && a(Wc, { editor: n, content: r })] });
}
...
function Jc() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Tl, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Rl, { children: [
...
function Zc({
  ...
  const [e] = Qt(), [r, o] = T(e), [n, i] = T("paragraph"), [s, l] = Jc(), c = () => {
  };
...
function ed() {
  const { activeEditor: t } = Mn(), [e, r] = T([]), o = j((n) => {
    if (Wt(n) || dl(n)) {
      const i = [];
      mo.forEach(({ format: s }) => {
...
function ad({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Zc, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(ed, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Vc,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Yc, { placeholder: t }) }),
          ErrorBoundary: Zl
        }
      ),
...
function nd(t, e) {
  const r = rl(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function An(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && kr(e) && (s = ac(o, e, "clone"));
  const l = ie(s) ? s.getChildren() : [], c = el(t, s.getType());
  let d;
...
function Pn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (l == null || !al(l)) && (l != null && yr(l) || o);
  for (let m = 0; m < g.length; m++) h.push(...Pn(g[m], e, r, p, new Map(n), l));
  return w != null && (h = w(h)), ro(t) && (h = sd(t, h, p ? () => {
    const m = new Zo();
    return r.push(m), m;
  ...
  }(t) && (s = s.concat(Qo())) : ie(l) && l.append(...h), s;
}
function sd(t, e, r) {
...
function ld(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = nd(e, n);
      le().clear(), ol(i);
    },
    {
      discrete: !0
...
function ju({
  ...
  const [i, s] = T(dd), [l, c] = T(n), [d, w] = T(!1), g = q(void 0), h = q(null);
  K(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : La(v) && (v.preventDefault(), v.stopPropagation(), Mt(i) && p());
        },
        onKeyDown: (v) => {
...
const Fu = Object.freeze([
...
], wd = ["input", "select", "textarea", "button"], ud = ["button", "textbox"], pd = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
  ...
  const n = q(null), [i, s] = T(void 0), [l, c] = T(void 0), d = j(
    ...
    if (p.isContentEditable || wd.includes(m)) return !0;
    const b = p.getAttribute("role");
    if (b && ud.includes(b)) return !0;
...
function Nd({ className: t, children: e, ...r }) {
  const o = lt();
  return /* @__PURE__ */ a(
    vt.SubContent,
    {
...
function bo({
  ...
  const p = j(
    ...
    [t.user]
  ), x = P(() => zi(t.contents), [t.contents]), _ = P(() => {
    if (o && l)
      return /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ u(
          va,
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(ld(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(md, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(vd, { className: "tw:text-xs tw:font-medium", children: N }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), p()) : La(k) && (k.preventDefault(), k.stopPropagation(), Mt(w) && m());
              },
              onKeyDown: (k) => {
        ...
        _ && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Vi, {}) }) }),
...
function Cd({
  ...
  const [C, z] = T(xo), [E, O] = T(), [D, F] = T(), I = o, [G, y] = T(!1), [Y, ft] = T(!1), [nt, te] = T(!1), [ee, Tt] = T(!1), [U, it] = T(!1), [at, dt] = T(k), [Et, ge] = T(!1), xt = q(void 0), [he, re] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
  ...
  const mt = j(
    ...
    async (S) => {
      const pt = Mt(C) ? zr(C) : void 0, gt = S.status ? S.assignedUser : E ?? S.assignedUser, jt = await g({
        ...S,
        contents: pt,
        assignedUser: gt
      });
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                L,
                {
                  ...
                  children: at ? /* @__PURE__ */ a(ji, {}) : /* @__PURE__ */ a(Fi, {})
                }
              ),
            ...
            o && /* @__PURE__ */ u(et, { children: [
              ...
              v !== !1 && (!Y || Mt(C)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (S) => {
                    La(S) && (S.preventDefault(), S.stopPropagation(), (Mt(C) || E !== void 0 && E !== D) && mt());
                  },
                  onKeyDown: (S) => {
...
function Yu({
  ...
  const C = r.filter(
    ...
    [N, b]
  ), { listboxRef: D, activeId: F, handleKeyDown: I } = pd({
    options: z,
    onOptionSelect: E
  }), G = j(
    (y) => {
...
function qe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ct.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ct.Icon, { asChild: !0, children: /* @__PURE__ */ a(mi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function or(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Rd(o)
  );
}
function Ir({
  className: t,
...
function Ad({
  ...
  var V;
  const [w, g] = T([]), [h, p] = T([]), [m, b] = T({}), [v, N] = T({}), x = P(() => e ?? [], [e]), _ = en({
    data: x,
    columns: t,
    getCoreRowModel: an(),
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? $ = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ne,
    {
      onClick: () => s(A, _),
    ...
    n && /* @__PURE__ */ a(Ed, { table: _ }),
    /* @__PURE__ */ u(Ir, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ja, { stickyHeader: i, children: _.getHeaderGroups().map((A) => /* @__PURE__ */ a(ne, { children: A.headers.map((C) => /* @__PURE__ */ a(Tr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : tr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
      /* @__PURE__ */ a(Pr, { children: $ })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Oo, {}) })
        ] }),
    ...
    /* @__PURE__ */ a(ye, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Un, { children: d.itemType === 0 ? /* @__PURE__ */ a(et, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        xd,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(yd, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(cr, {})
    ] }, d.label)) })
...
function Vd({ id: t, versionHistory: e }) {
...
function np({
  ...
  const s = P(() => Si(r), [r]), c = ((d) => {
    const w = new Intl.DisplayNames(Di(), { type: "language" });
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(Vd, { versionHistory: n }),
...
function Fd({
  ...
  const c = P(() => /Macintosh/i.test(navigator.userAgent), []), d = No(n, "%undoButton_tooltip%"), w = No(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Pa, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
        L,
...
const Ud = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(et, { children: [
...
function Kd({
  ...
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: Ud(t, n, r) }) }) }),
...
const Gd = (t, e) => t === "f" ? /* @__PURE__ */ u(et, { children: [
  /* @__PURE__ */ a(Po, {}),
  " ",
...
function Hd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: Gd(t, r) }) }) }),
      /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ a("p", { children: qd(t, r) }) })
    ] }) }),
...
function Xd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = T(""), [i, s] = P(() => {
...
function sp({
  ...
  K(() => {
    ...
    if (B && ur("note", B)) {
      ...
      let kt = "custom";
      ut === la ? kt = "generated" : ut === ca ? kt = "hidden" : ut && (_(ut), $(ut)), b(kt), N(kt), A(((st = B.insert.note) == null ? void 0 : st.style) ?? "f"), R = setTimeout(() => {
        var Dt;
  ...
  const Vt = () => {
    ...
    if (B && ur("note", B)) {
      ...
      V !== "x" && R === "x" ? mt == null || mt.forEach((Rt) => Zd(Rt)) : V === "x" && R !== "x" && (mt == null || mt.forEach((Rt) => Qd(Rt))), (Dt = w.current) == null || Dt.applyUpdate([B, { delete: 1 }]);
    }
  }, Z = (R) => {
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ a(et, { children: ew(t.marker, l, o, d) })
      }
    )
  ] });
}
...
function nw({
  ...
  return /* @__PURE__ */ u(Ir, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(ja, { stickyHeader: !0, children: /* @__PURE__ */ u(ne, { children: [
    ...
    /* @__PURE__ */ a(Pr, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ve, { className: o, children: ow(l.text) })
        ]
      },
...
const iw = (t) => {
...
}, Lr = (t, e, r) => /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(At, { children: [
  /* @__PURE__ */ u(
    It,
    {
  ...
  return e ? e[1] : "";
}, lw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fp = Object.freeze([
...
function mp({
  ...
  }, [A, G]), Y = P(() => y.length === 0 ? [] : cw(y, z, O), [y, z, O]), ft = P(() => {
    var at, dt;
    if (!A) return c;
...
const Hn = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(ls, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Zr({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(et, { children: [
      ...
      /* @__PURE__ */ a(Ir, { children: /* @__PURE__ */ a(Pr, { children: e.map((n) => /* @__PURE__ */ u(ne, { children: [
...
function bp({
  ...
  const [s, l] = T(""), [c, d] = T([]), w = P(
    () => t.filter((I) => !r || I.type === r).filter((I) => uw(I, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: b, hasMore: v } = ww(p), N = P(
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(Hn, {}) }),
...
const pw = "16rem", gw = "3rem", Wn = tt.createContext(void 0);
function jr() {
...
function xp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    L,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(vi, {}) : /* @__PURE__ */ a(bi, {}),
    ...
    fw,
    {
      ...
      children: /* @__PURE__ */ u(vw, { children: [
        /* @__PURE__ */ u(Eo, { children: [
          ...
          /* @__PURE__ */ a(To, { children: /* @__PURE__ */ a(bw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(xw, { children: /* @__PURE__ */ a(
            kw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const fe = "scrBook", Nw = "scrRef", Se = "source", Cw = "details", Ew = "Scripture Reference", zw = "Scripture Book", Yn = "Type", Tw = "Details";
function Sw(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: Cw,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Tw,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, So = (t) => `${Dw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Op({
  sources: t,
  ...
  K(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const O = b.find((D) => So(D) === E[0]) || void 0;
        O && l(O);
      }
    }
  }, [p, b, l, N]);
  const x = n ?? zw, _ = i ?? Yn, k = [
    ...
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(zd, { children: k.map((z) => /* @__PURE__ */ a(Ft, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ir, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(ja, { children: N.getHeaderGroups().map((z) => /* @__PURE__ */ a(ne, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
...
const Jn = (t, e, r) => Ba(t, e).every((o) => r.includes(o));
function Rw({
  availableBookInfo: t,
  selectedBookIds: e,
                ...
                Object.values(W).map((D, F) => {
                  ...
                  if (I.length !== 0)
                    return /* @__PURE__ */ u(Vo, { children: [
                      ...
                      F < Object.values(W).length - 1 && /* @__PURE__ */ a(cn, {})
                    ] }, D);
                })
              ] })
            ]
...
function $w({
  ...
  const i = o["%webView_book_selector_more%"], s = P(
    ...
    (c) => {
      const d = Ba(s, c).map((w) => w);
      r(
        Jn(s, c, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
...
const Qn = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ u(kd, { children: [
    /* @__PURE__ */ a(_d, { children: l.label }),
    /* @__PURE__ */ a(bd, { children: /* @__PURE__ */ a(Nd, { children: Qn(
      t,
      e,
      Zn(t, l.id),
      o
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(L, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ds, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(Vo, { children: [
      /* @__PURE__ */ a(Un, { children: /* @__PURE__ */ a(Ot, { children: Qn(e.groups, e.items, c, t) }) }),
...
const ei = tt.forwardRef(({ className: t, ...e }, r) => {
  const o = lt();
  return /* @__PURE__ */ a(
    Bt.Root,
    {
...
ei.displayName = Bt.List.displayName;
...
const Aw = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.Trigger,
  {
    ref: r,
    ...e,
...
)), ai = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.Content,
  {
    ref: r,
    className: f(
...
ai.displayName = Bt.Content.displayName;
function Up({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ei, { children: [
      /* @__PURE__ */ a(ri, { children: t.map((l) => /* @__PURE__ */ a(Aw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ a(ai, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Iw({
...
function jw({
  ...
  const i = pe();
  return /* @__PURE__ */ a(Lw, { children: /* @__PURE__ */ a(
    Jt.Content,
    {
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const l = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(At, { children: [
      ...
      ) : /* @__PURE__ */ u(Uw, { children: [
        /* @__PURE__ */ a(Kw, { children: d.label }),
        /* @__PURE__ */ a(Gw, { children: oi(
          t,
          e,
          Zn(t, d.id),
          o
    ...
    return l.length > 0 && s < n.length - 1 && c.push(/* @__PURE__ */ a(Bw, {}, `separator-${i}`)), c;
  });
};
function qw({
  menuData: t,
  ...
  if (vl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, N;
    w.preventDefault();
    ...
    return /* @__PURE__ */ a(Iw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(Pw, { children: [
      /* @__PURE__ */ a(Vw, { ref: d(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        jw,
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Ot, { children: oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Ww({ item: t, createLabel: e, createComplexLabel: r }) {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(be, { children: [
              /* @__PURE__ */ a(xe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(L, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Xa, {}) }) }),
...
function mg({
  ...
  const n = lt();
  return /* @__PURE__ */ u(Xw, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Jw, {}),
    /* @__PURE__ */ u(
      _e.Content,
      {
...
function Eg({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    xl,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(Ni, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(_i, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(ki, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(yi, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(xi, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function Dg({
  ...
  return /* @__PURE__ */ a(
    Bt.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Zw({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  Pu as BOOK_SELECTOR_STRING_KEYS,
  Ue as Badge,
  Au as BookChapterControl,
  ga as BookSelectionMode,
  Lu as BookSelector,
  L as Button,
  Pa as ButtonGroup,
  jn as ButtonGroupSeparator,
  Vu as ButtonGroupText,
  Fn as CANCEL_ACCEPT_BUTTONS_STRING_KEYS,
  Fu as COMMENT_EDITOR_STRING_KEYS,
  Bu as COMMENT_LIST_STRING_KEYS,
  ...
  kg as Progress,
  vp as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  pn as RadioGroup,
  ua as RadioGroupItem,
  Ll as RecentSearches,
  Cg as ResizableHandle,
  Ng as ResizablePanel,
  _g as ResizablePanelGroup,
  bp as ResourcePickerDialog,
  Wp as ResultsCard,
  Ap as SCOPE_SELECTOR_STRING_KEYS,
  Ow as SELECT_BOOKS_STRING_KEYS,
  Ip as ScopeSelector,
  Op as ScriptureResultsViewer,
  Pp as ScrollGroupSelector,
  Vr as SearchBar,
  Ke as Select,
  $w as SelectBooks,
  Rw as SelectBooksPicker,
  He as SelectContent,
  zd as SelectGroup,
  Ft as SelectItem,
  Xu as SelectLabel,
  Sd as SelectScrollDownButton,
  ...
  Vp as SettingsListItem,
  _w as SettingsSidebar,
  ...
  Aw as VerticalTabsTrigger,
  Ye as Z_INDEX_ABOVE_DOCK,
  on as Z_INDEX_FOOTNOTE_EDITOR,
  El as Z_INDEX_MODAL,
  Cl as Z_INDEX_MODAL_BACKDROP,
