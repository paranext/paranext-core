...
import { createEditor as No, $getRoot as Kt, $createParagraphNode as xn, $getSelection as Bt, HISTORY_MERGE_TAG as pr, ParagraphNode as ko, TextNode as _o, $isTokenOrSegmented as ri, $getCharacterOffsets as oi, $cloneWithPropertiesEphemeral as ai, $findMatchingParent as si, $isElementNode as le, CLEAR_EDITOR_COMMAND as Co, COMMAND_PRIORITY_EDITOR as Eo, $isRangeSelection as qe, shallowMergeConfig as ii, defineExtension as zt, safeCast as en, RootNode as li, LineBreakNode as wi, TabNode as di, $isEditorState as ci, createCommand as pi, CLICK_COMMAND as ui, isDOMNode as mi, $getNodeFromDOMNode as hi, $isNodeSelection as fi, $createNodeSelection as gi, $setSelection as bi, COMMAND_PRIORITY_LOW as vi, DecoratorNode as xi, $create as yi, $getNodeByKey as Ni, INDENT_CONTENT_COMMAND as zr, COMMAND_PRIORITY_CRITICAL as ur, KEY_TAB_COMMAND as ki, $createRangeSelection as _i, $normalizeSelection__EXPERIMENTAL as Ci, OUTDENT_CONTENT_COMMAND as Ei, INSERT_TAB_COMMAND as Si, $isBlockElementNode as un, $isDecoratorNode as Ti, $isParagraphNode as Ri, $isTextNode as mn, SELECTION_CHANGE_COMMAND as So, FORMAT_TEXT_COMMAND as Di, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as jr, isDOMDocumentNode as Mi, ArtificialNode__DO_NOT_USE as To, $createLineBreakNode as Ro, $isRootOrShadowRoot as Ai, isBlockDomNode as Fr, isInlineDomNode as Gr, $insertNodes as Vi } from "lexical";
...
import { useReactTable as Mo, getFilteredRowModel as Hi, getSortedRowModel as Ao, getPaginationRowModel as Xi, getCoreRowModel as Vo, flexRender as He, getGroupedRowModel as Ui, getExpandedRowModel as Ki } from "@tanstack/react-table";
...
const el = Ct.Root, nl = Ct.Portal, $o = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
    className: h(
...
$o.displayName = Ct.Overlay.displayName;
const Po = g.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = wt();
...
Po.displayName = Ct.Content.displayName;
...
const Bo = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Title,
  {
    ref: n,
...
Bo.displayName = Ct.Title.displayName;
...
const fe = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt,
  {
    ref: n,
    className: h(
...
rn.displayName = gt.Input.displayName;
const ge = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.List,
  {
    ref: n,
...
const Nn = g.forwardRef((e, t) => /* @__PURE__ */ o(gt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
Nn.displayName = gt.Empty.displayName;
const Yt = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Group,
  {
    ref: n,
    className: h(
...
Yt.displayName = gt.Group.displayName;
const zo = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Separator,
  {
    ref: n,
...
const Zt = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Item,
  {
    ref: n,
    className: h(
...
Zt.displayName = gt.Item.displayName;
...
F(vt, "Original", new vt(Rt.Original)), F(vt, "Septuagint", new vt(Rt.Septuagint)), F(vt, "Vulgate", new vt(Rt.Vulgate)), F(vt, "English", new vt(Rt.English)), F(vt, "RussianProtestant", new vt(Rt.RussianProtestant)), F(vt, "RussianOrthodox", new vt(Rt.RussianOrthodox));
let oe = vt;
function Xr(e, t) {
  const n = t[0];
...
const qo = Qe(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Ie : "button", { className: h(gl({ variant: t, size: n, className: e })), ref: s, ...a })
);
B.displayName = "Button";
const be = Ee.Root, ve = Ee.Trigger, pp = Ee.Anchor, Qt = g.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = wt();
...
function Qn(e, t, n) {
  return `${e} ${we[e]}${t ? ` ${br(e, t)} ${_e(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function bl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ c(be, { open: l, onOpenChange: d, children: [
    ...
    /* @__PURE__ */ o(Qt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: /* @__PURE__ */ o(Yt, { heading: s, children: e.map((p) => /* @__PURE__ */ c(
      Zt,
      {
        onSelect: () => w(p),
...
function Kr({
  ...
  if (e)
    return /* @__PURE__ */ o(Yt, { children: /* @__PURE__ */ o("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Dt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Zt,
      {
        value: `${e} ${we[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function mp({
  ...
  const w = wt(), [p, f] = M(!1), [m, u] = M(""), [b, x] = M(""), [y, R] = M("books"), [N, v] = M(void 0), [C, V] = M(!1), _ = ot(void 0), E = ot(void 0), D = ot(void 0), k = ot(void 0), S = ot({}), L = j(
    (T) => {
      t(T), l && l(T);
    },
    [t, l]
  ), $ = z(() => r ? r() : Yo, [r]), J = z(() => ({
    [G.OT]: $.filter((K) => q.isBookOT(K)),
    [G.NT]: $.filter((K) => q.isBookNT(K)),
    [G.DC]: $.filter((K) => q.isBookDC(K)),
    [G.Extra]: $.filter((K) => q.extraBooks().includes(K))
  }), [$]), A = z(() => Object.values(J).flat(), [J]), X = z(() => {
    if (!b.trim()) return J;
    const T = {
      [G.OT]: [],
      [G.NT]: [],
    ...
    (T) => {
      const K = y === "chapters" ? N : O == null ? void 0 : O.book;
      K && (L({
        book: K,
        chapterNum: T,
        verseNum: 1
    ...
    [y, Q]
  ), { otLong: yt, ntLong: Nt, dcLong: an, extraLong: I } = {
    ...
    (T) => O ? !!O.chapterNum && !T.toString().includes(O.chapterNum.toString()) : !1,
    [O]
  ), os = z(
    () => ke(
      e,
    ...
    (T) => {
      if (T.ctrlKey) return;
      const { isLetter: K, isDigit: it } = Ur(T.key);
      if (y === "chapters") {
        if (T.key === "Backspace") {
        ...
        if (K || it) {
          if (T.preventDefault(), T.stopPropagation(), R("books"), v(void 0), it && N) {
            const pt = we[N];
            x(`${pt} ${T.key}`);
          } else
            x(T.key);
      ...
      if ((y === "chapters" || y === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(T.key)) {
        const pt = y === "chapters" ? N : O == null ? void 0 : O.book;
        if (!pt) return;
        const ht = (() => {
          if (!m) return 1;
          const Le = m.match(/(\d+)$/);
    ...
    const { isLetter: K, isDigit: it } = Ur(T.key);
    (K || it) && (T.preventDefault(), x((pt) => pt + T.key), E.current.focus(), V(!1));
  }, []);
  return Lt(() => {
    const T = setTimeout(() => {
      if (p && y === "books" && D.current && k.current) {
        const K = D.current, it = k.current, pt = it.offsetTop, ht = K.clientHeight, ne = it.clientHeight, At = pt - ht / 2 + ne / 2;
        K.scrollTo({
          top: Math.max(0, At),
          behavior: "smooth"
        }), u(Qn(e.book));
  ...
  }, [y, N, O, e.book, e.chapterNum]), /* @__PURE__ */ c(be, { open: p, onOpenChange: xt, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
      B,
      {
    ...
    /* @__PURE__ */ o(Qt, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ c(
      fe,
      {
        ref: _,
        onKeyDown: ss,
        ...
        children: [
          y === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: P.map(({ onClick: T, disabled: K, title: it, icon: pt }) => /* @__PURE__ */ o(
              B,
              {
                variant: "ghost",
                size: "sm",
            ...
            N && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: _e(N, a) })
          ] }),
          !C && /* @__PURE__ */ c(ge, { ref: D, children: [
            y === "books" && /* @__PURE__ */ c(at, { children: [
              !O && Object.entries(X).map(([T, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Yt, { heading: _t(T), children: K.map((it) => /* @__PURE__ */ o(
                      qo,
                      {
                        bookId: it,
                        onSelect: (pt) => dt(pt),
                        section: Ge(it),
                        commandValue: `${it} ${we[it]}`,
                        ref: it === e.book ? k : void 0,
                        localizedBookNames: a
                      },
                      it
                    )) }, T)
              ...
              O && /* @__PURE__ */ o(Yt, { children: /* @__PURE__ */ o(
                Zt,
                {
                  ...
                  children: ke(
                    ...
                    a ? br(O.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              O && Dt(O.book) > 1 && /* @__PURE__ */ c(at, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: _e(O.book, a) }),
                /* @__PURE__ */ o(
                  Kr,
                  {
                    bookId: O.book,
...
), lt = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(yo.Root, { ref: n, className: h("pr-twp", Nl(), e), ...t }));
lt.displayName = yo.Root.displayName;
const xr = g.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    Ye.Root,
    {
...
xr.displayName = Ye.Root.displayName;
const hn = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ye.Item,
  {
    ref: n,
    className: h(
    ...
    ...t,
    children: /* @__PURE__ */ o(Ye.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ o(vn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
    ...
    /* @__PURE__ */ o(
      Qt,
      {
        ...
        children: /* @__PURE__ */ c(fe, { children: [
          ...
          /* @__PURE__ */ o(ge, { children: V(t) ? t.map((E) => /* @__PURE__ */ o(Yt, { heading: E.groupHeading, children: E.options.map((D) => _(D, E.groupHeading)) }, E.groupHeading)) : t.map((E) => _(E)) })
        ] })
      }
    )
  ] });
...
function gp({
  ...
  const p = An(w, "%webView_bookSelector_currentBook%"), f = An(w, "%webView_bookSelector_choose%"), m = An(w, "%webView_bookSelector_chooseBooks%"), [u, b] = M(
    "current book"
    /* CURRENT_BOOK */
  ), x = (y) => {
    b(y), e(y);
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(lt, { className: "tw-ms-1", children: p })
          ] }),
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(lt, { className: "tw-ms-1", children: m })
          ] }),
          /* @__PURE__ */ o(lt, { className: "tw-flex tw-items-center", children: r.map((y) => q.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ o(
            B,
            {
...
const bp = [
  ...
  const a = ot(null), [s, i] = M(void 0), [l, d] = M(void 0), w = j(
    (u) => {
      i(u);
    ...
    (u) => {
      var E;
      const b = u.target, x = (D) => D ? document.getElementById(D) : void 0, y = x(l), R = x(s);
...
const Wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = Wo ? Lt : Z, ln = { tag: pr };
      ...
      if (m !== null) {
        if (m === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (Bt() !== null || x !== null && x === f.getRootElement()) && b.select();
          }
        }, ln);
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Z;
...
const yr = {
  ...
  mark: "",
  markOverlap: ""
}, $t = nn.Provider, Ht = nn.Root, de = nn.Trigger, Pt = g.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  nn.Content,
  {
    ref: r,
    sideOffset: t,
...
const Ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Z;
function Bl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = It(), n = z(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = ot(r);
    return Ll(() => {
...
function jl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ri(t) && r !== null) {
    ...
    if (w || p) {
      const [f, m] = oi(e), u = l.is(d), b = t.is(i ? d : l), x = t.is(i ? l : d);
      let y, R = 0;
      u ? (R = f > m ? m : f, y = f > m ? f : m) : b ? (R = i ? m : f, y = void 0) : x && (R = 0, y = i ? f : m);
...
function ae(e, t) {
  mt.call(this, void 0), this.x = e, this.s = void 0, this.g = cn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function Yl(e, t) {
  return new ae(e, t);
}
...
function ql(e) {
  ...
  na(this), U = e, this.f &= -2, 8 & this.f && kr(this), kn();
}
function Ne(e, t) {
...
mt.prototype.brand = Ul, mt.prototype.h = function() {
  ...
  if (this.g = cn, this.f |= 1, this.i > 0 && !ea(this)) return this.f &= -2, !0;
  const e = U;
  try {
    Wr(this), U = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ra(this), Wr(this), Xt++;
  const e = U;
...
zt({ build: (e, t, n) => _n(t), config: en({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
...
function oa() {
  const e = Kt(), t = Bt(), n = xn();
  e.clear(), e.append(n), t !== null && n.select(), qe(t) && (t.format = 0);
}
function aa(e, t = oa) {
  return e.registerCommand(Co, (n) => (e.update(t), !0), Eo);
}
zt({ build: (e, t, n) => _n(t), config: en({ $onClear: oa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Jt(() => aa(e, r.value));
} });
function Jl(e) {
...
const _r = 0, rr = 1, la = 2, $n = 3, wn = 4, ye = 5, Pn = 6, ze = 7;
function Ln(e) {
  return e.id === _r;
}
function wa(e) {
...
function Wl(e) {
  return function(t) {
    return t.id === rr;
  }(e) || W(305, String(e.id), String(rr)), Object.assign(e, { id: la });
}
...
class Ql {
  ...
  build(t) {
    const n = this.state;
    let r;
    n.id !== wn && W(307, String(n.id), String(ye)), this.extension.build && (r = this.extension.build(t, n.config, n.registerState));
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Pn && W(310, String(n.id), String(Pn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
      return Object.assign(a, { id: ze });
    }(n), r;
  }
  getSignal() {
    return this._signal === void 0 && W(311), this._signal;
  }
  getInitResult() {
    this.extension.init === void 0 && W(312, this.extension.name);
    const t = this.state;
    return function(n) {
      return n.id >= wn;
    }(t) || W(313, String(t.id), String(wn)), t.initResult;
  }
  getInitPeer(t) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= $n;
    }(t) || W(314, String(t.id), String($n)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
  ...
  getInitDependency(t) {
    ...
    return n === void 0 && W(315, this.extension.name, t.name), n.getExtensionInitDependency();
  }
  getDependency(t) {
    const n = this.builder.getExtensionRep(t);
    return n === void 0 && W(315, this.extension.name, t.name), n.getExtensionDependency();
  }
  getState() {
    const t = this.state;
    return function(n) {
      return n.id >= ze;
    }(t) || W(316, String(t.id), String(ze)), t;
  }
  ...
  getExtensionDependency() {
    if (!this._dependency) {
      ...
      (function(n) {
        return n.id >= ye;
      })(t) || W(317, this.extension.name), this._dependency = { config: t.config, init: t.initResult, output: t.output };
    }
...
const ew = zt({ config: en({ setOptions: Zr, updateOptions: Zr }), init: ({ $initialEditorState: e = tw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [li, _o, wi, di, ko] }), Qr = Symbol.for("@lexical/extension/LexicalBuilder");
function to() {
}
function nw(e) {
  throw e;
...
class Ue {
  ...
  static maybeFromEditor(t) {
    const n = t[Qr];
    return n && (n.PACKAGE_VERSION !== Bn && W(292, n.PACKAGE_VERSION, Bn), n instanceof Ue || W(293)), n;
  }
  static fromEditor(t) {
    const n = Ue.maybeFromEditor(t);
    return n === void 0 && W(294), n;
  }
  constructEditor() {
  ...
  getExtensionRep(t) {
    ...
    if (n) return n.extension !== t && W(295, t.name), n;
  }
  addEdge(t, n, r) {
  ...
  addExtension(t) {
    this._sortedExtensionReps !== void 0 && W(296);
    const n = dn(t), [r] = n;
    typeof r.name != "string" && W(297, typeof r.name);
    let a = this.extensionNameMap.get(r.name);
    if (a !== void 0 && a.extension !== r && W(298, r.name), !a) {
      a = new Ql(this, r), this.extensionNameMap.set(r.name, a);
      const s = this.conflicts.get(r.name);
      typeof s == "string" && W(299, r.name, s);
      for (const i of r.conflictsWith || []) this.extensionNameMap.has(i) && W(299, r.name, i), this.conflicts.set(i, r.name);
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Ln(s) || W(300, i, a || "[unknown]"), Ln(l = s) || W(304, String(l.id), String(_r)), s = Object.assign(l, { id: rr }), r.state = s;
    ...
    for (const p of l) {
      ...
      if (f.onError !== void 0 && (t.onError = f.onError), f.disableEvents !== void 0 && (t.disableEvents = f.disableEvents), f.parentEditor !== void 0 && (t.parentEditor = f.parentEditor), f.editable !== void 0 && (t.editable = f.editable), f.namespace !== void 0 && (t.namespace = f.namespace), f.$initialEditorState !== void 0 && (t.$initialEditorState = f.$initialEditorState), f.nodes) for (const m of Jl(f)) {
        if (typeof m != "function") {
          ...
          u && W(302, f.name, m.replace.name, u.extension.name), r.set(m.replace, p);
        }
        n.add(m);
      }
      if (f.html) {
...
const rw = /* @__PURE__ */ new Set(), eo = zt({ build(e, t, n) {
  const r = n.getDependency(nr).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = sa(() => {
  }, () => Jt(() => {
...
zt({ dependencies: [nr, eo], name: "@lexical/extension/HorizontalRule", nodes: [Se], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(eo).output, a = Je({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return qt(e.registerCommand(ui, (i) => {
    ...
    Kl(() => {
      ...
      for (const [p, f] of i.entries()) if (f === "destroyed") w.delete(p), d = !0;
        ...
        m ? m.domNode.value = u : (d = !0, w.set(p, { domNode: Je(u), selectedSignal: r(p) }));
      }
      d && (a.value = { nodeSelections: w });
    });
  }), Jt(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(Jt(() => {
      const w = l.value;
...
zt({ build: (e, t, n) => _n(t), config: en({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
...
function dw(e) {
  if (!ww(e, !1)) return !1;
  const t = Kt().getChildren(), n = t.length;
  if (n > 1) return !1;
  for (let r = 0; r < n; r++) {
    const a = t[r];
    if (Ti(a)) return !1;
          ...
          if (d) {
            ...
            e.update(() => {
              ...
              if (qe(b)) {
                ...
                if (mn(y) && w >= 0 && p >= 0 && (R = w, N = w + p, b.setTextNodeRange(y, R, y, N)), R === N && f === "" || (b.insertRawText(f), y = x.getNode()), mn(y)) {
                  R = m, N = m + u;
                  const v = y.getTextContentSize();
                  R = R > v ? v : R, N = N > v ? v : N, b.setTextNodeRange(y, R, y, N);
                }
...
zt({ build: (e, t, n) => _n(t), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Jt(() => n.getOutput().disabled.value ? void 0 : pa(e)) });
function cw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Cr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Z;
...
const gw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Z;
function bw({ onClear: e }) {
  const [t] = It();
  return gw(() => aa(t, e), [t, e]), null;
}
const ua = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Z;
function vw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: m, autoCapitalize: u, className: b, id: x, role: y = "textbox", spellCheck: R = !0, style: N, tabIndex: v, "data-testid": C, ...V }, _) {
...
const ga = g.createContext({
  size: "default",
  variant: "default"
}), Er = g.forwardRef(({ className: e, variant: t, size: n, children: r, ...a }, s) => {
  const i = wt();
  return /* @__PURE__ */ o(
    yn.Root,
    {
...
const Ke = g.forwardRef(({ className: e, children: t, variant: n, size: r, ...a }, s) => {
  const i = g.useContext(ga);
  return /* @__PURE__ */ o(
    yn.Item,
    {
      ref: s,
...
Ke.displayName = yn.Item.displayName;
const oo = [
...
function Vw(e, t) {
  ...
  const n = document.createElement("div"), r = Kt().getChildren();
...
function ba(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const b = l[u], x = ba(e, b, m, r);
    !a && le(t) && x && t.extractWithChild(b, r, "html") && (a = !0);
  }
  if (a && !s) {
...
function xa(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const d = function(b, x) {
    const { nodeName: y } = b, R = x._htmlConversions.get(y.toLowerCase());
    let N = null;
  ...
  for (let b = 0; b < f.length; b++) m.push(...xa(f[b], t, n, u, new Map(a), l));
  return p != null && (m = p(m)), Fr(e) && (m = $w(e, m, u ? () => {
    const b = new To();
    return n.push(b), b;
  } : xn)), l == null ? m.length > 0 ? i = i.concat(m) : Fr(e) && function(b) {
    return b.nextSibling == null || b.previousSibling == null ? !1 : Gr(b.nextSibling) && Gr(b.previousSibling);
...
const Fw = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
const Re = g.forwardRef(({ className: e, orientation: t = "horizontal", decorative: n = !0, ...r }, a) => /* @__PURE__ */ o(
  Io.Root,
  {
    ref: a,
    decorative: n,
...
Re.displayName = Io.Root.displayName;
const ka = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Me.Root,
  {
    ref: n,
    className: h(
...
ka.displayName = Me.Root.displayName;
...
const _a = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Me.Fallback,
  {
    ref: n,
    className: h(
...
_a.displayName = Me.Fallback.displayName;
const Tr = bn(void 0);
function St() {
  const e = cr(Tr);
  if (!e)
...
}), Ve = tt.Trigger, Ca = tt.Group, Xw = tt.Portal, Uw = tt.Sub, Kw = tt.RadioGroup;
...
const Ea = g.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = St();
  return /* @__PURE__ */ c(
    tt.SubTrigger,
    {
...
const te = g.forwardRef(({ className: e, sideOffset: t = 4, children: n, ...r }, a) => {
  const s = wt();
...
const fn = g.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = wt(), s = St();
  return /* @__PURE__ */ o(
    tt.Item,
    {
...
const Ut = g.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = St();
  return /* @__PURE__ */ c(
    tt.CheckboxItem,
    {
...
const Ta = g.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = St();
  return /* @__PURE__ */ c(
    tt.RadioItem,
    {
...
const on = g.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  tt.Label,
  {
    ref: r,
...
const $e = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  tt.Separator,
  {
    ref: n,
      ...
      children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            t && e.assignedUser !== void 0 && /* @__PURE__ */ c(Te, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              pn(e.assignedUser, r)
            ] })
          ] }),
          p && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: b,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), x()) : _.key === "Enter" && _.shiftKey && (_.preventDefault(), _.stopPropagation(), Ft(m) && y());
              },
              onKeyDown: (_) => {
        ...
        V && /* @__PURE__ */ c(xe, { children: [
          /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(ho, {}) }) }),
          /* @__PURE__ */ o(te, { align: "end", children: V })
        ] })
      ]
    }
  );
...
function qw({
  ...
  const [u, b] = M(so), [x, y] = M(!1), [R, N] = M(!1), [v, C] = M(!1), [V, _] = M(!1), [E, D] = M(!1), [k, S] = M(void 0), L = z(() => e.filter((I) => !I.deleted), [e]), $ = z(() => L[0], [L]), J = ot(null), A = ot(void 0), X = j(() => {
    var I;
    (I = A.current) == null || I.call(A), b(so);
  }, []);
  Z(() => {
    const I = J.current;
    if (!I) return;
    ...
    return _t(), window.addEventListener("resize", _t), () => window.removeEventListener("resize", _t);
  }, [$ == null ? void 0 : $.verse]), Z(() => {
    C(!1);
  }, [n]);
  const O = z(
  ...
  }, [a, t]), dt = z(() => L.slice(1), [L]), ct = z(() => dt.length ?? 0, [dt.length]), Mt = z(() => ct > 0, [ct]), P = z(() => v || ct <= 2 ? dt : dt.slice(-2), [dt, ct, v]), Q = z(() => v || ct <= 2 ? 0 : ct - 2, [ct, v]), xt = z(
    () => ct === 1 ? O.singleReply : ie(O.multipleReplies, { count: ct }),
    [ct, O]
  ), yt = z(
    () => Q === 1 ? O.singleReply : ie(O.multipleReplies, { count: Q }),
    [Q, O]
  ), Nt = j(async () => {
    const I = Ft(u) ? ar(u) : void 0;
    if (k !== void 0) {
      await w({
        threadId: l,
        contents: I,
    ...
    I && await w({ threadId: l, contents: I }) && X();
  }, [X, u, w, k, l]), an = j(
    async (I) => {
      const _t = Ft(u) ? ar(u) : void 0, ee = await w({
        ...I,
        contents: _t,
        assignedUser: k ?? I.assignedUser
      });
      return ee && _t && X(), ee && k !== void 0 && S(void 0), ee;
    },
    [X, u, w, k]
  );
  return /* @__PURE__ */ o(
    Sr,
    {
      ...
      children: /* @__PURE__ */ c(Na, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          rt && /* @__PURE__ */ o(Te, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: rt }),
          ...
          /* @__PURE__ */ o(
            ao,
            {
              ...
              isThreadExpanded: n,
              threadStatus: d,
              isEditable: L.length === 1 && ($ == null ? void 0 : $.user) === s,
        ...
        /* @__PURE__ */ c(at, { children: [
          Mt && !n && /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
            /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(Re, {}) }),
            /* @__PURE__ */ o("p", { className: "tw-text-sm tw-text-muted-foreground", children: xt })
          ] }),
          !n && Ft(u) && /* @__PURE__ */ o(
            or,
            {
          ...
          n && /* @__PURE__ */ c(at, { children: [
            ...
            P.map((I) => {
              const ee = I.id === dt[dt.length - 1].id && I.user === s;
            ...
            (!V || Ft(u)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (I) => {
                  I.key === "Enter" && I.shiftKey && (I.preventDefault(), I.stopPropagation(), (Ft(u) || k !== void 0) && Nt());
                },
                onKeyDown: (I) => {
                    ...
                    /* @__PURE__ */ c(be, { open: E, onOpenChange: D, children: [
                      ...
                      /* @__PURE__ */ o(
                        Qt,
                        {
                          ...
                          children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: m == null ? void 0 : m.map((I) => /* @__PURE__ */ o(
                            Zt,
                            {
                              onSelect: () => {
                                S(I !== a ? I : void 0), D(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ o("span", { children: pn(I, t) })
                            },
                            I || "unassigned"
                          )) }) })
                        }
...
function Jw({ table: e }) {
  return /* @__PURE__ */ c(xe, { children: [
    ...
    /* @__PURE__ */ c(te, { align: "end", className: "tw-w-[150px]", children: [
...
), me = g.forwardRef(({ className: e, children: t, size: n, ...r }, a) => {
  const s = wt();
  return /* @__PURE__ */ c(
    st.Trigger,
    {
...
const Ra = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  st.ScrollUpButton,
  {
    ref: n,
...
const Da = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  st.ScrollDownButton,
  {
    ref: n,
    className: h("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
...
const he = g.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, a) => {
  const s = wt();
...
const kt = g.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  st.Item,
  {
    ref: r,
    className: h(
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ c(
        De,
        {
          ...
          children: [
            /* @__PURE__ */ o(me, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ o(Oe, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ o(he, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(kt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const Cn = g.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => {
...
const En = g.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => /* @__PURE__ */ o(
  "thead",
  {
    ref: r,
    className: h(
...
const Sn = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", e), ...t }));
...
const Vt = g.forwardRef(({ className: e, onKeyDown: t, onSelect: n, setFocusAlsoRunsSelect: r = !1, ...a }, s) => {
...
const Ze = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "th",
  {
    ref: n,
    className: h(
...
const ce = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "td",
  {
    ref: n,
...
function ld({
  ...
  var _;
  const [p, f] = M([]), [m, u] = M([]), [b, x] = M({}), [y, R] = M({}), N = z(() => t ?? [], [t]), v = Mo({
    data: N,
    columns: e,
    getCoreRowModel: Vo(),
  ...
  return d ? V = Array.from({ length: 10 }).map((k, S) => `skeleton-row-${S}`).map((k) => /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(ce, { colSpan: C.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(sr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((_ = v.getRowModel().rows) == null ? void 0 : _.length) > 0 ? V = v.getRowModel().rows.map((E) => /* @__PURE__ */ o(
    Vt,
    {
      ...
      children: E.getVisibleCells().map((D) => /* @__PURE__ */ o(ce, { children: He(D.column.columnDef.cell, D.getContext()) }, D.id))
    },
    E.id
    ...
    /* @__PURE__ */ c(Cn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(En, { stickyHeader: s, children: v.getHeaderGroups().map((E) => /* @__PURE__ */ o(Vt, { children: E.headers.map((D) => /* @__PURE__ */ o(Ze, { children: D.isPlaceholder ? void 0 : He(D.column.columnDef.header, D.getContext()) }, D.id)) }, E.id)) }),
...
function Np({
  ...
  return /* @__PURE__ */ c(be, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ c(Qt, { id: s, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ c(B, { variant: "default", children: [
      /* @__PURE__ */ o(Ss, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(pe, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ o(te, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
...
function ud({
  ...
  const [R, N] = M(!1), v = j(
    (S) => {
      var $;
      const L = ($ = e.find((J) => J.label === S)) == null ? void 0 : $.value;
      L && n(
    ...
    if (!m) return e;
    const S = e.filter(($) => $.starred).sort(($, J) => $.label.localeCompare(J.label)), L = e.filter(($) => !$.starred).sort(($, J) => {
      const A = t.includes($.value), X = t.includes(J.value);
      return A && !X ? -1 : !A && X ? 1 : $.label.localeCompare(J.label);
    });
    return [...S, ...L];
  }, [e, t, m]), _ = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: y, className: b, children: /* @__PURE__ */ c(be, { open: D, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ c(
      B,
      {
        variant: x,
    ...
    /* @__PURE__ */ o(Qt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(fe, { children: [
      ...
      /* @__PURE__ */ c(ge, { children: [
        ...
        /* @__PURE__ */ o(Yt, { children: V.map((S) => /* @__PURE__ */ c(
          Zt,
          {
            value: S.label,
            onSelect: v,
      ...
      return /* @__PURE__ */ c(Te, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ o(
          B,
          {
            ...
            onClick: () => n(t.filter((b) => b !== m)),
            children: /* @__PURE__ */ o(tn, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (u = e.find((b) => b.value === m)) == null ? void 0 : u.label
      ] }, m);
    }) }) : /* @__PURE__ */ o(lt, { children: p })
  ] });
}
...
function hd({
  ...
  return Z(() => {
    ...
    /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Ht, { children: [
      /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "outline", className: "tw-h-6", children: md(e, a, n) }) }) }),
      /* @__PURE__ */ o(Pt, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ c(te, { className: "tw-z-[300]", children: [
...
function bd({
  ...
  return /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Ht, { children: [
      /* @__PURE__ */ o($i, { asChild: !0, children: /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o(
        B,
        {
          variant: "outline",
    ...
    e !== "x" && /* @__PURE__ */ c(te, { className: "tw-z-[300]", children: [
...
function Sp({
  ...
  const l = ot(null), d = ps(), [w, p] = M("generated"), [f, m] = M("*"), [u, b] = M("f"), x = z(
    () => ({
      ...s,
  ...
  Z(() => {
    ...
    if (C && In("note", C)) {
      ...
      let D = "custom";
      E === Yn ? D = "generated" : E === qn ? D = "hidden" : E && m(E), p(D), b(((_ = C.insert.note) == null ? void 0 : _.style) ?? "f"), C.insert.note && (C.insert.note.caller = ""), v = setTimeout(() => {
        var k;
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Ht, { children: [
          /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(B, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(tn, {}) }) }),
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Ht, { children: [
...
function Dp({
  ...
  const f = p ? Nd(p, "%webView_footnoteList_header%") : "Footnotes", m = d ?? ni(n, void 0), u = (v, C) => {
    w == null || w(v, C, a);
  }, b = s ? n.findIndex((v) => v === s) : 0, [x, y] = M(b), R = (v) => {
    if (n.length)
      switch (v.key) {
        case "ArrowDown":
          ...
          "div",
          {
            ...
            children: n.map((v, C) => {
              ...
              return /* @__PURE__ */ c(at, { children: [
                ...
                C < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(Re, {})
              ] });
            })
          }
        )
...
const Dr = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Jn.Root,
  {
    ref: n,
    className: h(
...
function Lp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), m = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), b = Tt(n, "%webView_inventory_unknown%"), x = Tt(n, "%webView_inventory_scope_currentBook%"), y = Tt(n, "%webView_inventory_scope_chapter%"), R = Tt(n, "%webView_inventory_scope_verse%"), N = Tt(n, "%webView_inventory_filter_text%"), v = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), C = Tt(n, "%webView_inventory_no_results%"), [V, _] = M(!1), [E, D] = M("all"), [k, S] = M(""), [L, $] = M([]), J = z(() => {
    const P = e ?? [];
    return P.length === 0 ? [] : Td(P, a, s);
  }, [e, a, s]), A = z(() => {
    if (V) return J;
    const P = [];
    return J.forEach((Q) => {
      const xt = Q.items[0], yt = P.find(
        (Nt) => Nt.items[0] === xt
      );
      yt ? (yt.count += Q.count, yt.occurrences = yt.occurrences.concat(Q.occurrences)) : P.push({
        items: [xt],
        count: Q.count,
  ...
  }, [V, J]), X = z(() => A.length === 0 ? [] : Sd(A, E, k), [A, E, k]), O = z(() => {
    var xt, yt;
    if (!V) return d;
    const P = (xt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : xt.length;
    if (!P) return d;
    const Q = [];
  ...
  Z(() => {
    X.length === 0 ? $([]) : X.length === 1 && $(X[0].items);
  }, [X]);
  const rt = (P, Q) => {
    Q.setRowSelection(() => {
      const xt = {};
      return xt[P.index] = !0, xt;
    }), $(P.original.items);
  }, dt = (P) => {
  ...
  return /* @__PURE__ */ c("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ c(
        De,
        {
          onValueChange: (P) => ct(P),
          defaultValue: E,
          children: [
            /* @__PURE__ */ o(me, { className: "tw-m-1", children: /* @__PURE__ */ o(Oe, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ c(he, { children: [
              ...
              /* @__PURE__ */ o(kt, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ c(De, { onValueChange: (P) => dt(P), defaultValue: i, children: [
        /* @__PURE__ */ o(me, { className: "tw-m-1", children: /* @__PURE__ */ o(Oe, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(he, { children: [
          /* @__PURE__ */ o(kt, { value: "book", children: x }),
          /* @__PURE__ */ o(kt, { value: "chapter", children: y }),
          /* @__PURE__ */ o(kt, { value: "verse", children: R })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Pe,
      ...
      r && /* @__PURE__ */ c("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(lt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? v })
      ] })
    ] }),
...
const Rd = "16rem", Dd = "3rem", Ia = g.createContext(void 0);
function Rn() {
  const e = g.useContext(Ia);
  if (!e)
...
const Ma = g.forwardRef(
  ({
    ...
    const [w, p] = g.useState(e), f = t ?? w, m = g.useCallback(
      (v) => {
        const C = typeof v == "function" ? v(f) : v;
        n ? n(C) : p(C);
      },
      [n, f]
    ), u = g.useCallback(() => m((v) => !v), [m]), b = f ? "expanded" : "collapsed", R = wt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = g.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: m,
...
const Aa = g.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Rn();
...
const lr = g.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Ie : "div",
  {
    ref: r,
...
const Ld = Wt(
  ...
  ({
    ...
    const d = e ? Ie : "button", { state: w } = Rn(), p = /* @__PURE__ */ o(
      d,
      {
        ref: l,
...
const Bd = g.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: a,
...
function Xd({
  ...
  const w = j(
    ...
    (m) => {
      const u = n.find((b) => b.projectId === m);
...
const Gt = "scrBook", Ud = "scrRef", se = "source", Kd = "details", Yd = "Scripture Reference", qd = "Scripture Book", za = "Type", Jd = "Details";
function Wd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? q.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Gt ? ke(a.start) : void 0;
      },
...
function zp({
  ...
  const [w, p] = M([]), [f, m] = M([{ id: Gt, desc: !1 }]), [u, b] = M({}), x = z(
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ c(
      De,
      {
        ...
        children: [
          /* @__PURE__ */ o(me, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ o(Oe, {}) }),
          /* @__PURE__ */ o(he, { position: "item-aligned", children: /* @__PURE__ */ o(Ww, { children: C.map((k) => /* @__PURE__ */ o(kt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Cn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(En, { children: R.getHeaderGroups().map((k) => /* @__PURE__ */ o(Vt, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => (
        ...
        /* @__PURE__ */ o(Ze, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
        ...
        return /* @__PURE__ */ o(
          Vt,
          {
            ...
            children: k.getVisibleCells().map(($) => {
              if (!($.getIsPlaceholder() || $.column.columnDef.enableGrouping && !$.getIsGrouped() && ($.column.columnDef.id !== se || !n)))
                return /* @__PURE__ */ o(
                  ce,
                  {
                    className: h(
                    ...
                    children: $.getIsGrouped() ? /* @__PURE__ */ c(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ o(Ce, {}) : /* @__PURE__ */ o(Hn, {})),
                          " ",
                          He($.column.columnDef.cell, $.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
function tc({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], d = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], f = r["%webView_book_selector_more%"], { otLong: m, ntLong: u, dcLong: b, extraLong: x } = {
  ...
  const _ = z(() => q.allBookIds.filter(
    ...
    (A, X = !1) => {
      ...
      const O = _.findIndex((P) => P === C.current), rt = _.findIndex((P) => P === A);
      if (O === -1 || rt === -1) return;
      const [dt, ct] = [
        Math.min(O, rt),
        Math.max(O, rt)
      ], Mt = _.slice(dt, ct + 1).map((P) => P);
      n(
        t.includes(A) ? t.filter((P) => !Mt.includes(P)) : [.../* @__PURE__ */ new Set([...t, ...Mt])]
      );
    },
    [t, n, _]
  ), k = (A) => {
    D(A, V.current), V.current = !1;
  }, S = (A, X) => {
    A.preventDefault(), D(X, A.shiftKey);
  }, L = j(
    (A) => {
      const X = Ir(_, A).map((O) => O);
      n(
        ja(_, A, t) ? t.filter((O) => !X.includes(O)) : [.../* @__PURE__ */ new Set([...t, ...X])]
      );
    },
    [t, n, _]
  ), $ = () => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(G).map((A) => /* @__PURE__ */ o(
      Qd,
      {
        section: A,
        availableBookIds: _,
    ...
    /* @__PURE__ */ c(
      be,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Qt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            fe,
            {
              shouldFilter: !1,
              onKeyDown: (A) => {
                    ...
                    if (O.length !== 0)
                      return /* @__PURE__ */ c(po, { children: [
                        /* @__PURE__ */ o(
                          Yt,
                          {
                            heading: Ko(A, m, u, b, x),
                            children: O.map((rt) => /* @__PURE__ */ o(
                              qo,
                              {
                                bookId: rt,
                                isSelected: t.includes(rt),
                                onSelect: () => k(rt),
                                onMouseDown: (dt) => S(dt, rt),
                                section: Ge(rt),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: Qn(rt, a),
                                className: "tw-flex tw-items-center"
                              },
                              rt
                            ))
...
function Fp({
  ...
  const w = re(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), m = re(i, "%webView_scope_selector_current_book%"), u = re(i, "%webView_scope_selector_choose_books%"), b = re(i, "%webView_scope_selector_scope%"), x = re(i, "%webView_scope_selector_select_books%"), y = [
      ...
      children: [
        ...
        /* @__PURE__ */ o(
          he,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ o(kt, { value: `${w}`, children: l[Y(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Ht, { children: [
...
function dr({
  ...
  return /* @__PURE__ */ c(xe, { variant: s, children: [
    /* @__PURE__ */ o(Ve, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(B, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Fs, {}) }) }),
    /* @__PURE__ */ o(te, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(po, { children: [
...
const Xa = g.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    bt.Root,
    {
...
const Ua = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  bt.List,
  {
    ref: n,
    className: h(
...
)), Ka = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  bt.Content,
  {
    ref: n,
    className: h(
...
const Ya = g.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  const a = g.useMemo(
    () => ({
      variant: t
    }),
...
const Ja = g.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = St();
  return /* @__PURE__ */ c(
    et.SubTrigger,
    {
...
const Wa = g.forwardRef(({ className: e, ...t }, n) => {
  const r = St();
  return /* @__PURE__ */ o(
    et.SubContent,
    {
...
const Za = g.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: r = 8, ...a }, s) => {
  const i = St();
...
const Qa = g.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = St();
  return /* @__PURE__ */ o(
    et.Item,
    {
...
const ts = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  et.Separator,
  {
    ref: n,
    className: h("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
const je = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Ht, { children: [
...
function ic({
  ...
  const a = ot(void 0), s = ot(void 0), i = ot(void 0), l = ot(void 0), d = ot(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (Wi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), je(s, [m, u]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), je(i, [m, u]);
        break;
      case "alt+n":
        (y = l.current) == null || y.focus(), je(l, [m, u]);
        break;
      case "alt+h":
        (R = d.current) == null || R.focus(), je(d, [m, u]);
        break;
    }
  }), Z(() => {
...
function Zp({
  ...
  const w = lc(
    ...
    var R, N, v, C, V, _;
    const y = x !== b ? ((N = (R = e[b]) == null ? void 0 : R.uiNames) == null ? void 0 : N[x]) ?? ((C = (v = e[b]) == null ? void 0 : v.uiNames) == null ? void 0 : C.en) : void 0;
  ...
  return /* @__PURE__ */ c("div", { id: d, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ c(
      De,
      {
        ...
        onOpenChange: (b) => f(b),
        children: [
          /* @__PURE__ */ o(me, { children: /* @__PURE__ */ o(Oe, {}) }),
          /* @__PURE__ */ o(
            he,
            {
              className: "tw-z-[250]",
              children: Object.keys(e).map((b) => /* @__PURE__ */ o(kt, { value: b, children: u(b, t) }, b))
            }
          )
        ]
      }
    ),
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(lt, { className: "tw-font-normal tw-text-muted-foreground", children: ie(w, {
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ c(xe, { children: [
              /* @__PURE__ */ o(Ve, { className: h(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(ho, {}) }) }),
...
const dc = Qe(({ className: e, ...t }, n) => /* @__PURE__ */ o(Xs, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
const mc = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
mc.displayName = "AlertDescription";
const nu = nt.Root, ru = nt.Trigger, ou = nt.Group, au = nt.Portal, su = nt.Sub, iu = nt.RadioGroup, hc = g.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: h(
...
const vc = g.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: h(
...
const xc = g.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: r,
    className: h(
...
const lu = Et.Trigger, Cc = Et.Portal, wu = Et.Close, rs = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
rs.displayName = Et.Overlay.displayName;
const Ec = g.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
  const { direction: s = "bottom" } = g.useContext(ns), i = {
...
Rc.displayName = Et.Title.displayName;
...
Dc.displayName = Et.Description.displayName;
...
Ic.displayName = Fe.Root.displayName;
...
const mu = bt.Root, Ac = g.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    bt.List,
    {
