...
function km({ scrRef: e, handleSubmit: t }) {
  const [n, r] = ue(""), [o, a] = ue(
    ...
    oe.bookNumberToId(e.bookNum)
  ), [p, h] = ue(!1), [w, b] = ue(p), v = gt(void 0), f = gt(void 0), m = gt(void 0), k = Me(
    (N) => Jl(N).filter((B) => {
  ...
  }, [w]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(ao, { modal: !1, open: p, onOpenChange: E, children: [
    ...
    /* @__PURE__ */ x(
      tr,
      {
        ...
        children: [
          ...
          Wo.map(
            (N, B) => k(N).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ i(Nn, { className: "tw-font-semibold tw-text-foreground/80", children: Wl[N] }),
              k(N).map((D) => /* @__PURE__ */ i("div", { children: /* @__PURE__ */ i(
                Hl,
                {
                  bookId: D,
...
function qo({
  ...
  const [k, A] = ue(!1);
  return /* @__PURE__ */ x(rc, { open: k, onOpenChange: A, ...m, children: [
    ...
    /* @__PURE__ */ i(cs, { className: "tw-w-[200px] tw-p-0", dir: v, children: /* @__PURE__ */ x(ps, { children: [
      /* @__PURE__ */ i(us, { dir: v, placeholder: c, className: "tw-text-inherit" }),
      /* @__PURE__ */ i(fs, { children: h }),
      /* @__PURE__ */ i(ws, { children: t.map((C) => /* @__PURE__ */ x(
        ms,
        {
          value: a(C),
          onSelect: () => {
            ...
            /* @__PURE__ */ i(
              Jn,
              {
                className: T("tw-me-2 tw-h-4 tw-w-4", {
                  "tw-opacity-0": Array.isArray(r) ? !r.includes(C) : !r || a(r) !== a(C)
                })
              }
            ),
            a(C)
...
const fn = ge.Root, hc = ge.Group, mn = ge.Value, Mt = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Trigger,
  {
    ref: r,
    className: T(
...
function Nc({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(rr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(or, { stickyHeader: a, children: f.getHeaderGroups().map((k) => /* @__PURE__ */ i(ot, { children: k.headers.map((A) => /* @__PURE__ */ i(hn, { children: A.isPlaceholder ? void 0 : sn(A.column.columnDef.header, A.getContext()) }, A.id)) }, k.id)) }),
      /* @__PURE__ */ i(ar, { children: (m = f.getRowModel().rows) != null && m.length ? f.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        ot,
        {
          onClick: () => s(k, f),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((A) => /* @__PURE__ */ i(jt, { children: sn(A.column.columnDef.cell, A.getContext()) }, A.id))
        },
        k.id
...
function Pm({
  ...
  const h = Je(n, "%webView_inventory_all%"), w = Je(n, "%webView_inventory_approved%"), b = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), f = Je(n, "%webView_inventory_scope_currentBook%"), m = Je(n, "%webView_inventory_scope_chapter%"), k = Je(n, "%webView_inventory_scope_verse%"), A = Je(n, "%webView_inventory_filter_text%"), C = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, g] = ue(!1), [_, L] = ue("all"), [H, S] = ue(""), [P, N] = ue([]), B = _e(() => l ? r instanceof RegExp ? Pc(
    l,
    e,
    a,
    s,
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ x(fn, { onValueChange: (y) => ee(y), defaultValue: c, children: [
        ...
        /* @__PURE__ */ x(Bt, { children: [
          ...
          /* @__PURE__ */ i(Ue, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ i(
        xn,
      ...
      o && /* @__PURE__ */ x("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ i(He, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? C })
      ] })
    ] }),
...
function $m({
  ...
  at(() => {
    if (l) {
      const S = k.getSelectedRowModel().rowsById, P = Object.keys(S);
      if (P.length === 1) {
  ...
  }, L = (S, P) => S.getIsGrouped() ? "" : T("banded-row", P % 2 === 0 ? "even" : "odd"), H = (S, P, N) => {
    ...
    !t && /* @__PURE__ */ x(
      fn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Bt, { position: "item-aligned", children: /* @__PURE__ */ i(hc, { children: E.map((S) => /* @__PURE__ */ i(Ue, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(rr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ i(or, { children: k.getHeaderGroups().map((S) => /* @__PURE__ */ i(ot, { children: S.headers.filter((P) => P.column.columnDef.header).map((P) => (
      ...
      /* @__PURE__ */ i(ar, { children: k.getRowModel().rows.map((S, P) => /* @__PURE__ */ i(
        ot,
        {
                ...
                jt,
                {
                  ...
                  children: (() => N.getIsGrouped() ? /* @__PURE__ */ x(
                    be,
                    {
                      ...
                      type: "button",
                      children: [
                        S.getIsExpanded() && /* @__PURE__ */ i(Zn, {}),
                        !S.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ i(Fa, {}) : /* @__PURE__ */ i(qi, {})),
                        " ",
...
function Uc() {
  if (Zo)
    return se;
  Zo = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, a = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, d = e ? Symbol.for("react.concurrent_mode") : 60111, p = e ? Symbol.for("react.forward_ref") : 60112, h = e ? Symbol.for("react.suspense") : 60113, w = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, v = e ? Symbol.for("react.lazy") : 60116, f = e ? Symbol.for("react.block") : 60121, m = e ? Symbol.for("react.fundamental") : 60117, k = e ? Symbol.for("react.responder") : 60118, A = e ? Symbol.for("react.scope") : 60119;
  function C(g) {
  ...
  return se.AsyncMode = c, se.ConcurrentMode = d, se.ContextConsumer = l, se.ContextProvider = s, se.Element = t, se.ForwardRef = p, se.Fragment = r, se.Lazy = v, se.Memo = b, se.Portal = n, se.Profiler = a, se.StrictMode = o, se.Suspense = h, se.isAsyncMode = function(g) {
    return E(g) || C(g) === c;
  }, se.isConcurrentMode = E, se.isContextConsumer = function(g) {
    return C(g) === l;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === d || g === a || g === o || g === h || g === w || typeof g == "object" && g !== null && (g.$$typeof === v || g.$$typeof === b || g.$$typeof === s || g.$$typeof === l || g.$$typeof === p || g.$$typeof === m || g.$$typeof === k || g.$$typeof === A || g.$$typeof === f);
  }, se.typeOf = C, se;
}
var ie = {};
/** @license React v16.13.1
...
function Gc() {
  return Qo || (Qo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === h || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === b || $.$$typeof === s || $.$$typeof === l || $.$$typeof === p || $.$$typeof === m || $.$$typeof === k || $.$$typeof === A || $.$$typeof === f);
    }
    function E($) {
    ...
    var g = c, _ = d, L = l, H = s, S = t, P = p, N = r, B = v, D = b, J = n, q = a, U = o, ee = h, ae = !1;
    function re($) {
    ...
    ie.AsyncMode = g, ie.ConcurrentMode = _, ie.ContextConsumer = L, ie.ContextProvider = H, ie.Element = S, ie.ForwardRef = P, ie.Fragment = N, ie.Lazy = B, ie.Memo = D, ie.Portal = J, ie.Profiler = q, ie.StrictMode = U, ie.Suspense = ee, ie.isAsyncMode = re, ie.isConcurrentMode = y, ie.isContextConsumer = O, ie.isContextProvider = z, ie.isElement = F, ie.isForwardRef = V, ie.isFragment = W, ie.isLazy = X, ie.isMemo = Y, ie.isPortal = G, ie.isProfiler = K, ie.isStrictMode = Z, ie.isSuspense = de, ie.isValidElementType = C, ie.typeOf = E;
  }()), ie;
}
var ea;
function Os() {
...
function Yc() {
  ...
  return Dr = function(l, c) {
    ...
    function P() {
      function y(O, z, F, V, W) {
        return J(O[z]) ? null : new f("Invalid " + V + " `" + W + "` supplied to " + ("`" + F + "`, expected a ReactNode."));
      }
      return m(y);
    }
    function N(y, O, z, F, V) {
      return new f(
...
function nd() {
  return la || (la = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, f = !1, m = !1, k = !1, A = !1, C;
    C = Symbol.for("react.module.reference");
    function E(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || A || j === r || j === d || j === p || k || j === b || v || f || m || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === h || j.$$typeof === a || j.$$typeof === s || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var _ = s, L = a, H = e, S = c, P = n, N = w, B = h, D = t, J = o, q = r, U = d, ee = p, ae = !1, re = !1;
    function y(j) {
...
function Mp(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    let k = zn;
    d === "Root" || d === "root" ? k = r : d ? k = o : Ap(s) && (k = void 0);
    const A = fl(s, R({
      shouldForwardProp: k,
      label: m
    }, b)), C = (g) => typeof g == "function" && g.__emotion_real !== g || ht(g) ? (_) => Fn(g, R({}, _, {
      theme: Mn({
        theme: _.theme,
        defaultTheme: n,
        themeId: t
...
`));
  ...
  const w = ({
    ...
    if (f = R({}, f), !f.main && f[k] && (f.main = f[k]), !f.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${m ? ` (${m})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${k}\` property.` : Vt(11, m ? ` (${m})` : "", k));
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return xa(f, "light", A, r), xa(f, "dark", C, r), f.contrastText || (f.contrastText = h(f.main)), f;
  }, b = {
    dark: jr,
    light: ya
  };
...
function cu(e, t) {
  ...
  const b = o / 14, v = h || ((k) => `${k / d * b}rem`), f = (k, A, C, E, g) => R({
    fontFamily: r,
    fontWeight: k,
    fontSize: v(A),
...
function hw(e) {
  ...
  if (!(!a || !s)) {
    var h = mw(o.padding, n), w = To(a), b = c === "y" ? Te : Ce, v = c === "y" ? je : Ve, f = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], m = s[c] - n.rects.reference[c], k = On(a), A = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - m / 2, E = h[b], g = A - w[p] - h[v], _ = A / 2 - w[p] / 2 + C, L = dn(E, _, g), H = c;
...
function Pa(e) {
  ...
  b = m.x, f = m.y;
  var k = s.hasOwnProperty("x"), A = s.hasOwnProperty("y"), C = Ce, E = Te, g = window;
  if (d) {
    ...
    if (_ === Ae(n) && (_ = lt(n), et(_).position !== "static" && l === "absolute" && (L = "scrollHeight", H = "scrollWidth")), _ = _, o === Te || (o === Ce || o === Ve) && a === vn) {
      E = je;
      var S = h && _ === g && g.visualViewport ? g.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        _[L]
      );
      f -= S - r.height, f *= c ? 1 : -1;
    }
  ...
  if (b = B.x, f = B.y, c) {
    var D;
    return Object.assign({}, N, (D = {}, D[E] = A ? "0" : "", D[C] = k ? "0" : "", D.transform = (g.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + f + "px)" : "translate3d(" + b + "px, " + f + "px, 0)", D));
  }
  return Object.assign({}, N, (t = {}, t[E] = A ? f + "px" : "", t[C] = k ? b + "px" : "", t.transform = "", t));
}
function xw(e) {
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, s = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Ju : l, d = n.rootBoundary, p = d === void 0 ? Zs : d, h = n.elementContext, w = h === void 0 ? en : h, b = n.altBoundary, v = b === void 0 ? !1 : b, f = n.padding, m = f === void 0 ? 0 : f, k = ri(typeof m != "number" ? m : oi(m, Sn)), A = w === en ? Zu : en, C = e.rects.popper, E = e.elements[v ? A : w], g = _w(kt(E) ? E : E.contextElement || lt(e.elements.popper), c, p, s), _ = Ut(e.elements.reference), L = si({
    reference: _,
    element: C,
    strategy: "absolute",
    placement: o
  }), H = Kr(Object.assign({}, C, L)), S = w === en ? H : _, P = {
    top: g.top - S.top + k.top,
    bottom: S.bottom - g.bottom + k.bottom,
    left: g.left - S.left + k.left,
    right: S.right - g.right + k.right
...
function Iw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, w = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, f = n.allowedAutoPlacements, m = t.options.placement, k = Xe(m), A = k === m, C = c || (A || !v ? [Un(m)] : Aw(m)), E = [m].concat(C).reduce(function(V, W) {
    ...
    }, []), g = t.rects.reference, _ = t.rects.popper, L = /* @__PURE__ */ new Map(), H = !0, S = E[0], P = 0; P < E.length; P++) {
      var N = E[P], B = Xe(N), D = Gt(N) === zt, J = [Te, je].indexOf(B) >= 0, q = J ? "width" : "height", U = yn(t, {
        placement: N,
        boundary: p,
        rootBoundary: h,
        altBoundary: w,
...
function Gw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, w = n.tether, b = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = yn(t, {
    ...
    padding: h,
    altBoundary: p
  }), k = Xe(t.placement), A = Gt(t.placement), C = !A, E = Co(k), g = Uw(E), _ = t.modifiersData.popperOffsets, L = t.rects.reference, H = t.rects.popper, S = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, P = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
    ...
    mainAxis: 0,
    altAxis: 0
  }, S), N = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, B = {
    x: 0,
    y: 0
  };
  if (_) {
    if (a) {
      var D, J = E === "y" ? Te : Ce, q = E === "y" ? je : Ve, U = E === "y" ? "height" : "width", ee = _[E], ae = ee + m[J], re = ee - m[q], y = b ? -H[U] / 2 : 0, O = A === zt ? L[U] : H[U], z = A === zt ? -H[U] : -L[U], F = t.elements.arrow, V = b && F ? To(F) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ni(), X = W[J], Y = W[q], G = dn(0, L[U], V[U]), K = C ? L[U] / 2 - y - G - X - P.mainAxis : O - G - X - P.mainAxis, Z = C ? -L[U] / 2 + y + G + Y + P.mainAxis : z + G + Y + P.mainAxis, de = t.elements.arrow && On(t.elements.arrow), $ = de ? E === "y" ? de.clientTop || 0 : de.clientLeft || 0 : 0, xe = (D = N == null ? void 0 : N[E]) != null ? D : 0, j = ee + K - xe - $, ye = ee + Z - xe, ze = dn(b ? Wn(ae, j) : ae, ee, b ? vt(re, ye) : re);
      _[E] = ze, B[E] = ze - ee;
    }
    if (l) {
      var ct, ke = E === "x" ? Te : Ce, Pn = E === "x" ? je : Ve, Fe = _[g], Et = g === "y" ? "height" : "width", dt = Fe + m[ke], Tt = Fe - m[Pn], Ct = [Te, Ce].indexOf(k) !== -1, St = (ct = N == null ? void 0 : N[g]) != null ? ct : 0, pt = Ct ? dt : Fe - L[Et] - H[Et] - St + P.altAxis, Xt = Ct ? Fe + L[Et] + H[Et] - St - P.altAxis : Tt, _n = b && Ct ? fw(pt, Fe, Xt) : dn(b ? pt : dt, Fe, b ? Xt : Tt);
      _[g] = _n, B[g] = _n - Fe;
    }
    t.modifiersData[r] = B;
  }
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        var A = typeof k == "function" ? k(p.options) : k;
      ...
      forceUpdate: function() {
        if (!w) {
          var k = p.elements, A = k.reference, C = k.popper;
          if (Ma(A, C)) {
            p.rects = {
              reference: qw(A, On(C), p.options.strategy === "fixed"),
              popper: To(C)
            ...
            for (var E = 0; E < p.orderedModifiers.length; E++) {
              ...
              var g = p.orderedModifiers[E], _ = g.fn, L = g.options, H = L === void 0 ? {} : L, S = g.name;
    ...
    function v() {
      p.orderedModifiers.forEach(function(m) {
        var k = m.name, A = m.options, C = A === void 0 ? {} : A, E = m.effect;
        if (typeof E == "function") {
          var g = E({
            state: p,
            name: k,
...
const cf = () => uo({
  ...
  } = t, m = Ne(t, of), k = M.useRef(null), A = xt(k, n), C = M.useRef(null), E = xt(C, w), g = M.useRef(E);
  Lt(() => {
    g.current = E;
  }, [E]), M.useImperativeHandle(w, () => C.current, []);
  const _ = sf(p, s), [L, H] = M.useState(_), [S, P] = M.useState(qn(o));
  M.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: m = {},
    slots: k = {}
  } = t, A = Ne(t, af), [C, E] = M.useState(!0), g = () => {
    E(!1);
  }, _ = () => {
    E(!0);
  };
  ...
  const H = !p && c && (!f || C) ? "none" : void 0, S = f ? {
    in: p,
    onEnter: g,
    onExited: _
  } : void 0;
...
const bf = {
  ...
  const {
  ...
  } = t, k = Ne(t, gf), A = rn(), C = M.useRef(), E = ci(), g = M.useRef(null), _ = xt(g, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = g.current;
    ...
    let y;
    f === "auto" ? (y = E.transitions.getAutoHeightDuration(q.clientHeight), C.current = y) : y = ee, q.style.transition = [E.transitions.create("opacity", {
      duration: y,
      delay: ae
    ...
    let re;
    f === "auto" ? (re = E.transitions.getAutoHeightDuration(q.clientHeight), C.current = re) : re = U, q.style.transition = [E.transitions.create("opacity", {
      duration: re,
      delay: ee
    }), E.transitions.create("transform", {
  ...
  return /* @__PURE__ */ i(m, R({
    ...
    onExiting: N,
    addEndListener: (q) => {
      f === "auto" && A.start(C.current || 0, q), r && r(g.current, q);
    },
...
const Va = Po, vf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], yf = Cn(li, {
  ...
  const o = Hs(), a = xo({
    ...
    slots: C,
    slotProps: E
  } = a, g = Ne(a, vf), _ = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, L = R({
    anchorEl: s,
    container: p,
    disablePortal: h,
    keepMounted: w,
...
const wi = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, s, l, c, d, p, h, w, b, v, f, m, k, A, C, E, g;
  const _ = xo({
    props: t,
    name: "MuiTooltip"
  }), {
...
`));
  const Ei = M.useMemo(() => {
    ...
    touch: dt.current
  }), Er = Tf(Kt), zo = (r = (o = Z.popper) != null ? o : S.Popper) != null ? r : Cf, Fo = (a = (s = (l = Z.transition) != null ? l : S.Transition) != null ? s : $) != null ? a : Va, Uo = (c = (d = Z.tooltip) != null ? d : S.Tooltip) != null ? c : Sf, Go = (p = (h = Z.arrow) != null ? h : S.Arrow) != null ? p : Of, Ti = on(zo, R({}, G, (w = K.popper) != null ? w : P.popper, {
    ...
    className: bt(Er.tooltip, (k = (A = K.tooltip) != null ? A : P.tooltip) == null ? void 0 : k.className)
  }), Kt), Oi = on(Go, R({}, (C = K.arrow) != null ? C : P.arrow, {
...
function fi(e) {
  ...
  return r ? /* @__PURE__ */ i(Rf, { title: r, placement: "right", children: /* @__PURE__ */ i("div", { children: k }) }) : k;
}
function mi(e) {
...
function Bf({
  ...
  at(() => {
    if (c) {
      ...
      if (E) {
        const g = E.getBoundingClientRect(), _ = window.scrollY, L = window.scrollX, H = g.top + _ + E.clientHeight, S = g.left + L;
        m({ top: H, left: S });
      }
    }
  }, [c, o]);
  const [k] = eo(
    ...
    Me(async () => (e == null ? void 0 : e(!0)) ?? n ?? k, [e, n, k, c]),
    n ?? k
  ), C = p && A ? A : k;
  return /* @__PURE__ */ x(st, { children: [
    /* @__PURE__ */ i(
