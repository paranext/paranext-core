...
var jt = (t, e, r) => Pi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Re, a as La, C as Me, A as ce, P as Ie, b as Ge, B as q, d as Ae, e as He, f as Ye, h as ye, i as ji, k as Bi, j as Li, E as Fi, l as Fa, r as re, m as Ui, n as dn, o as Zr, p as Ua, L as kt, D as _a, q as Na, s as Ca, t as Ea, T as Kt, u as Ka, v as qt, w as Gt, x as Ht, y as wn, z as qa, F as Fe, G as nr, H as ke, I as _e, J as Ne, S as kr, K as tr, M as Ki, N as Er, O as Ke, Q as Oe, Z as We, R as De, U as er, V as Ga, W as Ha, X as qr, Y as Ya, _ as pn, $ as qi, a0 as Gi, a1 as Hi, a2 as xo, a3 as un, a4 as Qr, a5 as hn, a6 as Yi, a7 as Wi, a8 as Xi, a9 as Ji, aa as gn, ab as Zi, ac as ia, ad as yo, ae as sa, af as Qi, ag as ts, ah as es, ai as rs, aj as as, ak as Tr, al as Wa } from "./resizable-Rk1gjPJn.js";
import { am as Gh, an as Hh, ao as Yh, ap as Wh, aq as Xh, ar as Jh, as as Zh, at as Qh, au as tg, av as eg, aw as rg, ax as ag, ay as og, az as ng, aA as ig, aB as sg, aC as cg, aD as lg, aE as dg, aF as wg, aG as pg, aH as ug, aI as hg, aJ as gg, aK as fg } from "./resizable-Rk1gjPJn.js";
import { jsx as a, jsxs as p, Fragment as it } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as ir, Clock as ko, ChevronsLeft as _o, ChevronsRight as No, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as os, ArrowRight as ns, ChevronDown as qe, BoldIcon as is, ItalicIcon as ss, X as Xa, AtSign as fn, Pencil as cs, Trash2 as ls, ArrowUp as mn, MoreHorizontal as ds, MailOpen as ws, Mail as ps, ChevronUp as us, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as vn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Cs, AlertCircle as Sa, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Rs, ScrollText as Ds, ChevronsUpDown as Os, MenuIcon as $s, Menu as Ms, EllipsisVertical as Is, MoreVertical as Co } from "lucide-react";
import { Section as dt, getChaptersForBook as As, formatScrRef as be, getSectionForBook as br, formatRelativeDate as Vs, formatReplacementString as Ue, sanitizeHtml as Ja, NumberFormat as Ps, formatBytes as js, getCurrentLocale as Bs, usfmMarkers as jr, getFormatCallerFunction as Ls, deepEqual as Fs, isString as Eo, compareScrRefs as Ra, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as To, collectUsjMarkers as Ks } from "platform-bible-utils";
import Tt, { useRef as K, useMemo as I, useState as k, useCallback as L, useEffect as W, useImperativeHandle as qs, useLayoutEffect as Zt, createContext as Za, useContext as kn, Component as Gs, createElement as zo, Suspense as Hs, forwardRef as _n, useId as So, Fragment as Nn } from "react";
import { RadioGroup as Da, ToggleGroup as Cn, Avatar as Qa, Select as Lt, Checkbox as Ro, Slot as zr, Tabs as le, Menubar as ge, ContextMenu as zt, Progress as Do, Slider as $r, Switch as Oo } from "radix-ui";
import { createEditor as En, $getRoot as $e, $createParagraphNode as Sr, $getSelection as Yt, HISTORY_MERGE_TAG as to, ParagraphNode as Tn, TextNode as zn, $getPreviousSelection as Ys, $isRangeSelection as ue, $caretFromPoint as Ws, $getSiblingCaret as Sn, $getChildCaret as Xs, $getAdjacentChildCaret as Js, $isChildCaret as Zs, $normalizeCaret as Qs, $setSelectionFromCaretRange as tc, $getCollapsedCaretRange as ec, $getCaretInDirection as $o, $splitAtPointCaretNext as rc, $isTextPointCaret as ac, $findMatchingParent as Rn, $isElementNode as _r, mergeRegister as Ce, getDOMTextNode as oc, isHTMLElement as nc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as ic, defineExtension as ae, safeCast as Xe, createState as sc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as Mn, RootNode as cc, LineBreakNode as lc, TabNode as dc, $isEditorState as wc, createCommand as pc, CLICK_COMMAND as uc, isDOMNode as hc, $getNodeFromDOMNode as gc, $createNodeSelection as fc, $setSelection as mc, $getEditor as vc, DecoratorNode as Oa, $getState as bc, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as xc, $setState as yc, addClassNamesToElement as In, $create as kc, $getNodeByKey as _c, removeClassNamesFromElement as Nc, KEY_TAB_COMMAND as Cc, $isBlockElementNode as Ec, $createRangeSelection as Tc, $normalizeSelection__EXPERIMENTAL as zc, OUTDENT_CONTENT_COMMAND as Sc, INDENT_CONTENT_COMMAND as Io, INSERT_TAB_COMMAND as Rc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Dc, $isParagraphNode as Oc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as An, $insertNodes as $c } from "lexical";
import { HeadingNode as Mc, QuoteNode as Ic, registerRichText as Ac } from "@lexical/rich-text";
import { flushSync as Vc, createPortal as Pc } from "react-dom";
...
import { $generateHtmlFromNodes as Bc, $generateNodesFromDOM as Lc } from "@lexical/html";
import { useReactTable as Pn, getFilteredRowModel as Fc, getSortedRowModel as jn, getPaginationRowModel as Uc, getCoreRowModel as Bn, flexRender as xr, getGroupedRowModel as Kc, getExpandedRowModel as qc } from "@tanstack/react-table";
import { IconCheck as ea, IconChevronDown as Gc, IconChevronUp as Hc, IconSelector as Yc, IconLayoutSidebar as Wc, IconLayoutSidebarRight as Xc, IconChevronRight as Ln, IconLoader as Jc, IconAlertOctagon as Zc, IconAlertTriangle as Qc, IconInfoCircle as tl, IconCircleCheck as el } from "@tabler/icons-react";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ma, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as al, isInsertEmbedOpOfType as Mr, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
function cl({
  ...
  return /* @__PURE__ */ p(Ie, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(Ye, { children: /* @__PURE__ */ a(ye, { heading: i, children: t.map((h) => /* @__PURE__ */ p(
      Me,
      {
        onSelect: () => g(h),
...
function Up(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function wa({
  ...
  const A = re(), [B, T] = k(!1), [V, $] = k(""), [N, j] = k(""), [D, E] = k("books"), [Y, G] = k(void 0), [F, O] = k(
    void 0
  ), [S, Z] = k(void 0), [Q, _t] = k(!1), Nt = K(null), At = K(!1), U = K(void 0), tt = K(void 0), wt = K(void 0), st = K(void 0), vt = K({}), oe = K({}), at = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  }), [Vt]), Wt = I(() => Object.values(St).flat(), [St]), ne = I(() => {
    if (!N.trim()) return St;
    const b = {
      [dt.OT]: [],
      [dt.NT]: [],
  ...
  const xt = L(() => {
    if (R) {
      const b = R.chapterNum ?? 1, H = R.verseNum ?? 1;
      if (w && da(R.book, b, H, w))
        return;
      at({
        book: R.book,
        chapterNum: b,
    ...
    (b) => {
      const H = F ?? (R == null ? void 0 : R.book), rt = S ?? (R == null ? void 0 : R.chapterNum);
      !H || !rt || (at({
        book: H,
        chapterNum: rt,
        verseNum: b
    ...
    (b) => {
      const H = D === "chapters" ? Y : R == null ? void 0 : R.book;
      if (H) {
        if (l && l(H, b) > 1) {
          O(H), Z(b), E("verses"), $("");
          return;
    ...
    E("books"), G(void 0), O(void 0), Z(void 0), setTimeout(() => {
      tt.current && tt.current.focus();
    }, 0);
  }, []), ot = L(() => {
    const b = F;
    O(void 0), Z(void 0), b ? (G(b), E("chapters"), $("")) : X();
  }, [F, X]), et = L((b) => {
    T(b), b && (E("books"), G(void 0), O(void 0), Z(void 0), j(""));
  }, []);
  W(() => {
    _ && et(!1);
  }, [_, et]);
  ...
  const { otLong: gt, ntLong: ut, dcLong: ft, extraLong: Rt } = {
    ...
    () => wl(N),
    [N]
  ), yt = I(() => !l || !R || !R.chapterNum || !$t ? !1 : l(R.book, R.chapterNum) > 0, [l, R, $t]), de = L(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), Te = L(
    (b) => (H) => w ? pl(b, H, w) : !1,
    ...
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), u && u.includes(b.key) && R && R.chapterNum !== void 0 && R.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), xt());
    },
    [u, R, xt]
  ), Dr = L(
    (b) => {
      ...
      if ((D === "chapters" || D === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const It = (ve = U.current) == null ? void 0 : ve.querySelector(
      ...
      if (D === "verses" && Pt) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            ht !== 0 && (te = ht > 1 ? ht - 1 : It);
            break;
          case "ArrowRight":
            ht !== 0 && (te = ht < It ? ht + 1 : 1);
            break;
          case "ArrowUp":
            te = ht === 0 ? It : Math.max(1, ht - Jt);
            break;
          case "ArrowDown":
            te = ht === 0 ? 1 : Math.min(It, ht + Jt);
            break;
          default:
            return;
        }
      ...
      if ((D === "chapters" || D === "books" && R) && Pt) {
        const Mt = D === "chapters" ? Y : R == null ? void 0 : R.book;
        if (!Mt) return;
        D === "chapters" && ((ze = U.current) == null || ze.focus());
        const mt = (() => {
          if (!V) return 1;
          const Jt = V.match(/(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            mt !== 0 && (ht = mt > 1 ? mt - 1 : It);
            break;
          case "ArrowRight":
            mt !== 0 && (ht = mt < It ? mt + 1 : 1);
            break;
          case "ArrowUp":
            ht = mt === 0 ? It : Math.max(1, mt - te);
            break;
          case "ArrowDown":
            ht = mt === 0 ? 1 : Math.min(It, mt + te);
            break;
          default:
            return;
        }
  ...
  return Zt(() => {
    const b = setTimeout(() => {
      if (B && D === "books" && wt.current && st.current) {
  ...
  }, [D, Y, R, t.book, t.chapterNum]), Zt(() => {
    if (D === "verses" && F && S !== void 0) {
      const b = F === t.book && S === t.chapterNum, H = b ? t.verseNum : 1;
      $(
        `${F} ${ce[F] || ""} ${S}:${H}`
      ), setTimeout(() => {
        if (wt.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ p(Ie, { open: B, onOpenChange: et, modal: v, children: [
    /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ a(
      q,
      {
        ref: Nt,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: H } = b;
          B && Nt.current && H instanceof Node && Nt.current.contains(H) && (At.current = !0, et(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ p(
          He,
          {
            ...
            shouldFilter: !1,
            children: [
              D === "books" ? /* @__PURE__ */ p("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  q,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: D === "verses" ? ot : X,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: A === "ltr" ? /* @__PURE__ */ a(os, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                D === "chapters" && Y && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Re(Y, n) }),
                D === "verses" && F && S !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Re(F, n)} ${S}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !Q && /* @__PURE__ */ p(Ye, { ref: wt, children: [
                D === "books" && /* @__PURE__ */ p(it, { children: [
                  !R && Object.entries(ne).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ye, { heading: Dt(b), children: H.map((rt) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: rt,
                            onSelect: (Pt) => Qt(Pt),
                  ...
                  R && /* @__PURE__ */ a(ye, { children: /* @__PURE__ */ a(
                    Me,
                    {
                      ...
                      children: be(
                        ...
                        n ? La(R.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  R && yt && R.chapterNum && l && /* @__PURE__ */ p(it, { children: [
                  ...
                  R && !yt && rr(R.book) > 1 && /* @__PURE__ */ p(it, { children: [
                    /* @__PURE__ */ p("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ a(
                      Po,
                      {
                        ...
                        setChapterRef: Ee,
                        isChapterDimmed: Ft,
                        isChapterDisabled: Te(R.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                D === "chapters" && Y && /* @__PURE__ */ a(
                  Po,
                  {
                    bookId: Y,
                    scrRef: t,
                ...
                D === "verses" && F && S !== void 0 && l && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: F,
                    chapterNum: S,
...
function Bo({
  ...
  const [_, A] = k(!1), B = l ?? d, T = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, N) => {
    const j = d($), D = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, E = `${N ?? ""}${j}${D ?? ""}`;
    return /* @__PURE__ */ p(
      Me,
      {
        value: j,
  ...
  return /* @__PURE__ */ p(Ie, { open: _, onOpenChange: A, ...y, children: [
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ p(He, { children: [
          ...
          /* @__PURE__ */ a(Ye, { children: T(e) ? e.map(($) => /* @__PURE__ */ a(ye, { heading: $.groupHeading, children: $.options.map((N) => V(N, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(ye, { children: e.map(($) => V($)) }) })
        ] })
      }
    )
  ] });
...
function Gp({
  ...
  const w = pa(l, "%webView_bookSelector_currentBook%"), u = pa(l, "%webView_bookSelector_choose%"), g = pa(l, "%webView_bookSelector_chooseBooks%"), [h, f] = k(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = Gn ? Zt : W, Ar = { tag: to };
function vl({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = fl(null, o), w = En({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (u) => s(u, w), theme: o });
    return function(u, g) {
      if (g !== null) {
        if (g === void 0) u.update(() => {
          ...
          if (h.isEmpty()) {
            ...
            (Yt() !== null || x !== null && x === u.getRootElement()) && f.select();
          }
        }, Ar);
        else if (g !== null) switch (typeof g) {
          case "string": {
            const h = u.parseEditorState(g);
            u.setEditorState(h, Ar);
            break;
          }
          case "object":
            u.setEditorState(g, Ar);
            break;
          case "function":
            u.update(() => {
              $e().isEmpty() && g(u);
...
const bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
...
const Cl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
function El(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Tl() {
  return function(t) {
    const [e] = fe(), r = I(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = K(o);
    return Cl(() => {
...
function Dl(t, e, r) {
  ...
  function d() {
    ...
    const { left: u, top: g } = n.getBoundingClientRect(), h = zl(t, e);
    var f, x;
    c.isConnected || (x = c, (f = n).insertBefore(x, f.firstChild));
    let v = !1;
    for (let C = 0; C < h.length; C++) {
      const y = h[C], _ = s[C] || document.createElement("div"), A = _.style;
      A.position !== "absolute" && (A.position = "absolute", v = !0);
      const B = pe(y.left - u);
      A.left !== B && (A.left = B, v = !0);
      const T = pe(y.top - g);
      A.top !== T && (_.style.top = T, v = !0);
      const V = pe(y.width);
      A.width !== V && (_.style.width = V, v = !0);
      const $ = pe(y.height);
      A.height !== $ && (_.style.height = $, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[C] = _;
    }
...
function $l(t, e = Ol) {
  ...
  function l(w) {
    w.read(() => {
      const u = Yt();
      if (!ue(u)) return r = null, n = null, i = null, c = null, d(), void (d = () => {
      });
      const [g, h] = function($) {
        const N = $.getStartEndPoints();
        return $.isBackward() ? [N[1], N[0]] : N;
      }(u), f = g.getNode(), x = f.getKey(), v = g.offset, C = h.getNode(), y = C.getKey(), _ = h.offset, A = t.getElementByKey(x), B = t.getElementByKey(y), T = r === null || A !== o || v !== n || x !== r.getKey(), V = i === null || B !== s || _ !== c || y !== i.getKey();
      if ((T || V) && A !== null && B !== null) {
        const $ = function(N, j, D, E, Y, G, F) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...Lo(j, D, E)), O.setEnd(...Lo(Y, G, F)), O;
        }(t, g, f, A, h, C, B);
        d(), d = Dl(t, $, e);
      }
      r = f, o = A, n = v, i = C, s = B, c = _;
    });
  }
...
function Al(t) {
  ...
  if (ue(e)) r = Ws(e.focus, "next");
    ...
    r = r || Xs($e(), "previous").getFlipped().insert(Sr());
  }
  const o = Vl(t, r), n = Js(o), i = Zs(n) ? Qs(n) : o;
  return tc(ec(i)), t.getLatest();
}
function Vl(t, e, r) {
  let o = $o(e, "next");
  for (let n = o; n; n = rc(n, r)) o = n;
  return ac(o) && Gr(283), o.insert(t.isInline() ? Sr().append(t) : t), $o(Sn(t.getLatest(), "next"), e.direction);
}
function Pl(t) {
  const e = Yt();
  if (!ue(e)) return !1;
...
let Hr, xe = 0, Yr = 0, Ll = 0, Va = 0, Lr = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Be(t, e) {
  Bt.call(this, void 0), this.x = t, this.s = void 0, this.g = Lr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Fl(t, e) {
  return new Be(t, e);
}
...
function Ul(t) {
  ...
  Wn(this), nt = t, this.f &= -2, 8 & this.f && no(this), aa();
}
function Qe(t, e) {
...
Bt.prototype.brand = jl, Bt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      xe !== 0 && Yr === 0 && e.l !== Va && (e.l = Va, Hr = { S: e, v: e.v, i: e.i, o: Hr });
    })(this), this.v = t, this.i++, Lr++, xe++;
    try {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Xn(this), Ko(this), xe++;
  const t = nt;
...
ae({ build: (t, e, r) => pr(e), config: Xe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
ae({ build: (t, e, r) => pr(e), config: Xe({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return he(() => Zn(t, o.value));
} });
function Kl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ha = sc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends Oa {
  $config() {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Yt();
  if ($n(n) || ue(n)) for (const i of n.getNodes()) ql(i) && i.toggleFormat(o);
  return !1;
}, Mn) });
function ti(t, e) {
  let r;
...
const io = 0, ja = 1, ri = 2, ga = 3, Vr = 4, Ze = 5, fa = 6, mr = 7;
function ma(t) {
  return t.id === io;
}
function ai(t) {
...
const Xl = ae({ config: Xe({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [cc, zn, lc, dc, Tn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function Jl(t) {
  throw t;
...
class ar {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ma(i) || lt(300, s, n || "[unknown]"), ma(c = i) || lt(304, String(c.id), String(io)), i = Object.assign(c, { id: ja }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: u } = w;
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const g of Kl(u)) {
...
}, dependencies: [Pa], name: "@lexical/extension/NodeSelection" }), Ql = pc("INSERT_HORIZONTAL_RULE_COMMAND");
class sr extends Oa {
  static getType() {
...
ae({ dependencies: [Pa, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [sr], register(t, e, r) {
  ...
  return Ce(t.registerCommand(Ql, (s) => {
    const c = Yt();
    if (!ue(c)) return !1;
    ...
    return !0;
  }, eo), t.registerCommand(uc, (s) => {
    if (hc(s.target)) {
      const c = gc(s.target);
      if (ed(c)) return function(d, l = !1) {
        const w = Yt(), u = d.isSelected(), g = d.getKey();
        let h;
        l && $n(w) ? h = w : (h = fc(), mc(h)), u ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Mn), t.registerMutationListener(sr, (s, c) => {
    Bl(() => {
      let d = !1;
    ...
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(he(() => {
      const l = c.value;
      l && (d.value ? In(l, i) : Nc(l, i));
    }));
    return Ce(...s);
  }));
} });
ae({ build: (t, e) => pr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Xe({ $getParentEditor: function() {
  const t = vc();
...
ae({ build: (t, e, r) => pr(e), config: Xe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return he(() => {
...
function rd(t, e, r = oi) {
  return Ce(t.registerCommand(Cc, (o) => {
    ...
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => Ec(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), u = Il(w);
      if (u.canIndent()) {
        const g = u.getKey();
        let h = Tc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = zc(h), h.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Sc : Io : Rc;
    return t.dispatchCommand(i, void 0);
  }, eo), t.registerCommand(Io, () => {
...
ae({ build: (t, e, r) => pr(e), config: Xe({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return he(() => {
    if (!o.value) return rd(t, n, i);
  });
} });
const ad = ae({ name: "@lexical/react/ReactProvider" });
function od() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                ...
                if ($a(v) && l >= 0 && w >= 0 && (C = l, y = l + w, f.setTextNodeRange(v, C, v, y)), C === y && u === "" || (f.insertRawText(u), v = x.getNode()), $a(v)) {
                  C = g, y = g + h;
                  const _ = v.getTextContentSize();
                  C = C > _ ? _ : C, y = y > _ ? _ : y, f.setTextNodeRange(v, C, v, y);
                }
...
ae({ build: (t, e, r) => pr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => he(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function sd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
  ...
  return function(r, o) {
    ...
    return co(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (g) => r._onError(g), children: a(Hs, { fallback: null, children: n[l] }) }), u = r.getElementByKey(l);
        u !== null && s.push(Pc(w, u, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function dd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    co(() => Ce(Ac(n), ii(n)), [n]);
  }(o), p(it, { children: [t, a(wd, { content: e }), a(ld, { editor: o, ErrorBoundary: r })] });
}
...
function vd(t, e) {
  ...
  return p(it, { children: [a(fd, { editor: n, ...o, ref: e }), r != null && a(bd, { editor: n, content: r })] });
}
...
function kd() {
  const [t, e] = k(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(_a, { open: !0, onOpenChange: r, children: /* @__PURE__ */ p(Na, { children: [
...
function _d({
  ...
  const [e] = fe(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = kd(), d = () => {
  };
...
function Ed() {
  const { activeEditor: t } = li(), [e, r] = k([]), o = L((n) => {
    if (ue(n) || jc(n)) {
      const i = [];
      Jo.forEach(({ format: s }) => {
...
function zd({
  ...
  return /* @__PURE__ */ p("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(_d, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Ed, {}) }) }),
...
function Rd(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Lc(e, n);
      $e().clear(), $c(i);
    },
    {
      discrete: !0
...
function hi({
  ...
  return /* @__PURE__ */ p(Ka, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
...
const Dd = "verseText", Hp = Object.freeze([
...
function Yp({
  ...
  const [i, s] = k(Od), [c, d] = k(n), [l, w] = k(!1), u = K(void 0), g = K(null);
  W(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ p(Ie, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ p(
        q,
        {
          variant: "outline",
...
function Qo({
  ...
  const h = L(
    (T) => {
      T && T.stopPropagation(), l(!1), u(void 0), s == null || s(!1);
    },
    [s]
  ), f = L(
    async (T) => {
    ...
    [t.user]
  ), y = I(() => Ja(t.contents), [t.contents]), _ = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), A = !!t.conflictResolutionAction && !_, B = I(() => {
    if (o && c)
      return /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ p(
          Fe,
          {
            onClick: (T) => {
              T.stopPropagation(), l(!0), u(Rd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Ad, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Vd, { className: "tw:text-xs tw:font-medium", children: C }) }),
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          /* @__PURE__ */ p("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ p(nr, { variant: "secondary", className: "tw:text-xs tw:font-normal", children: [
              "→ ",
              Fr(t.assignedUser, r)
            ] })
          ] }),
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), h()) : po(T) && (T.preventDefault(), T.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (T) => {
        ...
        B && /* @__PURE__ */ p(ke, { children: [
          /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ds, {}) }) }),
...
function bi({
  ...
  rootContentSlot: N,
  resolveActionSlot: j,
  spaceRootContentFromReplies: D = !1
}) {
  const [E, Y] = k(tn), [G, F] = k(), [O, S] = k(), Z = o, [Q, _t] = k(!1), [Nt, At] = k(!1), [U, tt] = k(!1), [wt, st] = k(!1), [vt, oe] = k(!1), [at, Vt] = k(A), [St, Wt] = k(!1), ne = K(void 0), [R, Xt] = k(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  W(() => {
    if (!o) {
      xt.current !== "idle" && (F(void 0), S(void 0), xt.current = "idle");
      return;
    }
    ...
    V !== i && (F(V), xt.current = "auto-populated") : xt.current === "auto-populated" && (F(void 0), xt.current = "pending");
  }, [o, V, wt, i]);
  const Ct = I(
  ...
  const Qt = I(() => Ct[0], [Ct]), me = K(null), ie = K(void 0), P = L(() => {
    var z;
    (z = ie.current) == null || z.call(ie), Y(tn);
  }, []), X = L(() => {
    const z = !at;
  ...
  }, [i, r]), pt = I(() => Ct.slice(1), [Ct]), ct = I(() => pt.length ?? 0, [pt.length]), gt = I(() => ct > 0, [ct]), ut = I(() => Q || ct <= 2 ? pt : pt.slice(-2), [pt, ct, Q]), ft = I(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), Rt = I(
  ...
  const Ft = L(
    async (z) => {
      ...
      $t && await u({ threadId: d, contents: $t }) && P();
    },
    [
      P,
      E,
    ...
    async (z) => {
      const $t = ee(E) ? Xr(E) : void 0, yt = z.status ? z.assignedUser : G ?? z.assignedUser, de = await u({
        ...z,
        contents: $t,
        assignedUser: yt
      });
  ...
  const Ee = /* @__PURE__ */ a(
    Qo,
    {
      ...
      handleDeleteComment: h,
      onEditingChange: At,
      canEditOrDelete: (!Nt && R.get(Qt.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    Md,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ p(Id, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              q,
              {
                ...
                children: at ? /* @__PURE__ */ a(ws, {}) : /* @__PURE__ */ a(ps, {})
              }
            ),
            j === void 0 ? (
        ...
        /* @__PURE__ */ p(it, { children: [
          gt && !o && /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          o && /* @__PURE__ */ p(it, { children: [
            D && ut.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ft > 0 && /* @__PURE__ */ p(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    Q ? /* @__PURE__ */ a(us, {}) : /* @__PURE__ */ a(qe, {})
                  ] })
                ]
              }
            ),
            ut.map((z) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Qo,
              {
                comment: z,
                localizedStrings: r,
                ...
                handleDeleteComment: h,
                onEditingChange: At,
                canEditOrDelete: (!Nt && R.get(z.id)) ?? !1
              }
            ) }, z.id)),
            v !== !1 && (!Nt || ee(E)) && /* @__PURE__ */ p(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (z) => {
                  po(z) && (z.preventDefault(), z.stopPropagation(), (ee(E) || G !== void 0 && G !== O) && Ft());
                },
                onKeyDown: (z) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    G !== void 0 && (ee(E) || G !== O) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ue(
                    ...
                    /* @__PURE__ */ p(Ie, { open: U, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ a(
                        q,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(Ye, { children: x == null ? void 0 : x.map((z) => /* @__PURE__ */ a(
                            Me,
                            {
                              onSelect: () => {
                                F(z !== i ? z : void 0), xt.current = "user-selected", S(void 0), tt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function Bd({
  ...
  const [s, c] = k("accept"), d = So(), l = So(), w = r === "loading", u = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = u ? "accept" : s, x = I(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = I(
    () => Ur(t.acceptedText ?? ""),
    ...
    () => Ur(t.mergedText ?? ""),
    [t.mergedText]
  ), y = I(() => Ja(t.contents), [t.contents]);
  if (!fi(t))
    return /* @__PURE__ */ a(Kr, { html: y });
  const _ = (O) => {
    c(O === "reject" || O === "merge" ? O : "accept");
  }, A = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", B = h ? [
    {
      value: "merge",
  ...
  const j = e["%conflict_note_no_result%"] ?? "No result preview available.", D = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: j }), E = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : D, Y = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(Kr, { html: C }) : D : E(O === "reject" ? t.rejectedResultText : t.resultText);
  }, G = (O) => u && O.value === "reject", F = (O) => {
    const S = f === O.value, Z = `${l}-${O.value}`, Q = G(O);
    return (
  ...
  return (
    ...
    /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", onClick: (O) => O.stopPropagation(), children: [
      /* @__PURE__ */ a("p", { children: e["%conflict_note_description_verseText%"] ?? "Conflicting changes were made to the verse text." }),
      w && /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-col tw:gap-2", "data-slot": "conflict-loading", children: [
        /* @__PURE__ */ a(tr, { className: "tw:h-8 tw:w-full" }),
        /* @__PURE__ */ a(tr, { className: "tw:h-8 tw:w-full" }),
        /* @__PURE__ */ a(tr, { className: "tw:h-8 tw:w-24" })
      ] }),
      !w && g && Y(),
      !w && !g && /* @__PURE__ */ p(it, { children: [
        ...
        /* @__PURE__ */ a(
          ra,
          {
            ...
            children: T.map((O) => G(O) ? /* @__PURE__ */ a(Kt, { delayDuration: 0, children: /* @__PURE__ */ p(qt, { children: [
              /* @__PURE__ */ a(Gt, { asChild: !0, children: F(O) }),
              /* @__PURE__ */ a(Ht, { children: A })
            ] }) }, O.value) : F(O))
          }
        ),
        /* @__PURE__ */ a(Kt, { delayDuration: 0, children: /* @__PURE__ */ p(qt, { children: [
...
function Kd({
  ...
  const [i, s] = k("loading"), [c, d] = k(!1), [l, w] = k(), u = n == null ? void 0 : n.getOptions, g = n == null ? void 0 : n.resolve;
  W(() => {
    let y = !0;
    if (!r) {
      s("loading");
...
function qd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: u, resolvedResolution: g, showResolveCheck: h } = Kd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function au({
  ...
  const [y, _] = k(/* @__PURE__ */ new Set()), [A, B] = k(), [T, V] = k(), $ = L(
    async (S) => {
      const Z = await i(S);
  ...
  const N = r.filter(
  ...
  ), j = N.map((S) => ({ id: S.id })), D = L(
    (S) => {
      _((Z) => new Set(Z).add(S.id)), B(S.id), x == null || x(S.id);
    },
    [x]
  ), E = L(
    (S) => {
    ...
    [y, x]
  ), { listboxRef: Y, activeId: G, handleKeyDown: F } = Ki({
    options: j,
    onOptionSelect: D
  }), O = L(
    (S) => {
      S.key === "Escape" ? (A && y.has(A) && (_((Z) => {
        const Q = new Set(Z);
        return Q.delete(A), Q;
      }), B(void 0), x == null || x(void 0)), S.preventDefault(), S.stopPropagation()) : F(S);
    },
    [A, y, F, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: N.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(qd, { ...Z, conflictResolution: C }) : /* @__PURE__ */ a(bi, { ...Z })
          },
          S.id
        );
      })
...
function Gd({ table: t }) {
  return /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ p(q, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(hs, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ p(Ne, { align: "end", className: "tw:w-[150px]", children: [
...
function dr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ p(
    Lt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Lt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Yc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
function wr({
  ...
  const s = re();
  return /* @__PURE__ */ a(Lt.Portal, { children: /* @__PURE__ */ p(
    Lt.Content,
    {
...
function se({
  ...
  return /* @__PURE__ */ p(
    Lt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Lt.ItemIndicator, { children: /* @__PURE__ */ a(ea, { className: "tw:pointer-events-none" }) }) }),
...
function Jd({
  ...
  var T;
  const [w, u] = k([]), [g, h] = k([]), [f, x] = k({}), [v, C] = k({}), y = I(() => e ?? [], [e]), _ = Pn({
    data: y,
    columns: t,
    getCoreRowModel: Bn(),
    ...r && { getPaginationRowModel: Uc() },
    onSortingChange: u,
  ...
  }), A = _.getVisibleFlatColumns();
  let B;
  return d ? B = Array.from({ length: 10 }).map((N, j) => `skeleton-row-${j}`).map((N) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: A.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    De,
    {
      onClick: () => s(V, _),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map(($) => /* @__PURE__ */ a(er, { children: xr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    V.id
  )) : B = /* @__PURE__ */ a(De, { children: /* @__PURE__ */ a(er, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Gd, { table: _ }),
    /* @__PURE__ */ p(Ga, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ha, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(De, { children: V.headers.map(($) => /* @__PURE__ */ a(qr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : xr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function cu({
  ...
  return /* @__PURE__ */ p(Ie, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(Ge, { asChild: !0, children: o }),
    /* @__PURE__ */ p(Ae, { id: i, className: m("tw:min-w-80 tw:max-w-96", n), children: [
...
function lu({ id: t, label: e, groups: r }) {
  const [o, n] = k(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ p(q, { variant: "default", children: [
      /* @__PURE__ */ a(bs, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(qe, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Ne, { children: r.map((l, w) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ a(Er, { children: l.label }),
      /* @__PURE__ */ a(pn, { children: l.itemType === 0 ? /* @__PURE__ */ a(it, { children: l.items.map((u, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][g],
        ...
        qi,
        {
          ...
          children: l.items.map((u) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Gi, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ a(Ke, {})
    ] }, l.label)) })
...
function pu({
  ...
  return /* @__PURE__ */ p("div", { id: u, className: "tw:flex tw:items-center tw:gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:items-center tw:gap-2", children: e.map((g) => {
      var h;
      return /* @__PURE__ */ p(nr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          q,
          {
            variant: "ghost",
...
function aw({
  ...
  return /* @__PURE__ */ p(Ka, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      ...
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ p("p", { children: [
        l,
        i && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ a(xo, { children: d ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(wn, {}),
    e && /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(
        q,
        {
          "aria-label": w,
      ...
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ p("p", { children: [
        ...
        i && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ a(xo, { children: d ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const nw = (t, e, r) => t === "generated" ? /* @__PURE__ */ p(it, { children: [
...
function iw({
  ...
  const i = K(null), s = K(null), c = K(!1), [d, l] = k(t), [w, u] = k(r), [g, h] = k(!1);
  W(() => {
    l(t);
  }, [t]), W(() => {
    w !== r && u(r);
  ...
  const f = (v) => {
    ...
    var C, y, _, A;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((A = s.current) == null || A.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ p(ke, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: nw(t, n, r) }) }) }),
...
const sw = (t, e) => t === "f" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function lw({
  ...
  return /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: sw(t, r) }) }) }),
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: cw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ p(Ne, { style: { zIndex: un }, children: [
...
function pw({
  ...
  return /* @__PURE__ */ p(He, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(Ye, { children: [
      ...
      c.length > 0 && /* @__PURE__ */ p(it, { children: [
...
function uu({
  ...
  const w = K(null), u = K(null), g = K(null), h = K(null);
  Zt(() => {
    if (!h.current) return;
    const { width: P } = h.current.getBoundingClientRect();
    P > 0 && (h.current.style.width = `${P}px`);
  }, []);
  const [f, x] = k("generated"), [v, C] = k("generated"), [y, _] = k("*"), [A, B] = k("*"), [T, V] = k("f"), [$, N] = k(!1), [j, D] = k(!0), [E, Y] = k(!1), G = K(!1), F = K(""), [O, S] = k(!1), [Z, Q] = k(), [_t, Nt] = k(), [At, U] = k(), [tt, wt] = k(), st = K(null), vt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && Mr("note", X)) {
      ...
      let ct = "custom";
      pt === Ma ? ct = "generated" : pt === Ia ? ct = "hidden" : pt && (_(pt), B(pt)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const at = L(
    (P, X, ot = !1) => {
      ...
      if (et && Mr("note", et)) {
        if (et.insert.note) {
          let ut;
          P === "custom" ? ut = X : P === "generated" ? ut = Ma : ut = Ia, et.insert.note.caller = ut;
        }
  ...
  const ne = () => {
    var X;
    const P = (X = u.current) == null ? void 0 : X.getElementsByClassName("editor-input")[0];
    ...
    if (X && Mr("note", X)) {
      ...
      const ut = (ct = (pt = X.insert.note) == null ? void 0 : pt.contents) == null ? void 0 : ct.ops;
      T !== "x" && P === "x" ? ut == null || ut.forEach((ft) => hw(ft)) : T === "x" && P !== "x" && (ut == null || ut.forEach((ft) => gw(ft))), (gt = w.current) == null || gt.applyUpdate([X, { delete: 1 }]);
    }
  }, Ct = (P) => {
    ...
    (P) => {
      ...
      if (X && Mr("note", X)) {
        ...
        const ut = (pt = X.insert.note) == null ? void 0 : pt.style, ft = (gt = (ct = X.insert.note) == null ? void 0 : ct.contents) == null ? void 0 : gt.ops;
        if (ut || N(!1), N(
          ut === "x" ? !!(ft != null && ft.every((Rt) => {
            var Ft, Ot;
            if (!((Ft = Rt.attributes) != null && Ft.char)) return !0;
            const Dt = ((Ot = Rt.attributes) == null ? void 0 : Ot.char).style;
          ...
          G.current = !0, F.current = JSON.stringify(X), D(!0);
          return;
        }
        D(JSON.stringify(X) === F.current), at(f, y);
      } else
        N(!1), D(!0);
    },
    [f, y, at]
  ...
  W(() => {
    ...
    var ot;
    const P = ((ot = u.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0, X = (et) => {
  ...
  return /* @__PURE__ */ p(it, { children: [
    /* @__PURE__ */ p("div", { ref: h, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ p(Ka, { children: [
          /* @__PURE__ */ a(
            aw,
            {
              onUndoClick: () => {
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
              /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(
                q,
                {
                  "aria-label": ie,
...
function bw({
  ...
  return /* @__PURE__ */ p(it, { children: [
    ...
    /* @__PURE__ */ a("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", x), children: u }),
    /* @__PURE__ */ a(
      "div",
      {
        className: m(
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(it, { children: mw(t.marker, c, o, l) })
      }
    )
  ] });
}
function gu({
  ...
  const w = d ?? Ls(r, void 0), u = (y, _) => {
    l == null || l(y, _, n);
  }, g = i ? r.findIndex((y) => y === i) : -1, [h, f] = k(g), x = (y, _, A) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), l == null || l(_, A, n);
          break;
      }
  }, v = (y) => {
    if (r.length)
        ...
        "ul",
        {
          ...
          children: r.map((y, _) => {
            ...
            return /* @__PURE__ */ p(it, { children: [
              ...
              _ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(kr, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function yw({
  ...
  return /* @__PURE__ */ p(Ga, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ha, { stickyHeader: !0, children: /* @__PURE__ */ p(De, { children: [
      /* @__PURE__ */ a(qr, { children: n }),
      /* @__PURE__ */ a(qr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(Ya, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ p(
      De,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ a(er, { className: o, children: xw(c.text) })
        ]
      },
...
const kw = (t) => {
...
}, oa = (t, e, r) => /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
  /* @__PURE__ */ p(
    Gt,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ p(lo, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          or,
          {
            onClick: (d) => {
  ...
  return e ? e[1] : "";
}, Nw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ku = Object.freeze([
...
function _u({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), _ = we(r, "%webView_inventory_scope_verse%"), A = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = k(!1), [N, j] = k("all"), [D, E] = k(""), [Y, G] = k([]), F = I(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = I(() => O.length === 0 ? [] : Cw(O, N, D), [O, N, D]), Z = I(() => {
    var wt, st;
    if (!V) return d;
  ...
  W(() => {
    S.length === 0 ? G([]) : S.length === 1 && G(S[0].items);
  }, [S]);
  const Q = (U, tt) => {
    tt.setRowSelection(() => {
      const st = {};
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ p(cr, { onValueChange: (U) => _t(U), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
        /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            yi,
            {
...
const ho = [
  ...
  },
  {
    ...
    descriptionKey: "%paratextRegistration_description_internetUse_option_BlockInSensitiveLocations_details%",
    isEnabled: !1
  },
  {
    value: "ProxyOnly",
...
function Tw(t) {
  return ho.some((e) => e.value !== "BlockInSensitiveLocations" && e.value === t);
}
const Nu = [
  ...ho.flatMap((t) => [t.labelKey, t.descriptionKey]),
...
function Cu({
  ...
  return /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ a(
                ...
                {
                  value: n.value,
                  id: `internet-option-${n.value}`,
                  disabled: o || !n.isEnabled,
                  className: "tw:mt-0.5"
                }
              ),
              /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-1 tw:flex-col", children: [
                /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:justify-between", children: [
                  /* @__PURE__ */ a(
                    "label",
                    {
                      htmlFor: `internet-option-${n.value}`,
                      "aria-disabled": !n.isEnabled || void 0,
                      className: m(
                        "tw:text-sm tw:font-medium",
                        n.isEnabled && !o ? "tw:cursor-pointer" : "tw:cursor-not-allowed tw:text-muted-foreground"
                      ),
                      children: t[n.labelKey]
                    }
                  ),
                  !n.isEnabled && /* @__PURE__ */ a(nr, { variant: "muted", children: t["%paratextRegistration_internetUse_comingSoon%"] })
                ] }),
                /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: t[n.descriptionKey] })
              ] })
            ]
          },
          n.value
    ...
    /* @__PURE__ */ a("p", { className: "tw:px-2 tw:text-xs tw:text-muted-foreground", children: t["%paratextRegistration_internetUse_footer%"] })
  ] });
}
const Eu = [
...
function Tu({
  ...
  const [n, i] = k(!1), s = e === "Development" ? "Development" : "Production";
  return /* @__PURE__ */ p("div", { className: "tw:border-t tw:pt-2", children: [
    /* @__PURE__ */ p(
      q,
      {
        variant: "ghost",
        ...
        onClick: () => i((c) => !c),
        children: [
          /* @__PURE__ */ a("span", { children: t["%paratextRegistration_developer_section_label%"] }),
          /* @__PURE__ */ a(
            qe,
            {
              className: `tw:size-4 tw:transition-transform${n ? " tw:rotate-180" : ""}`
            }
          )
        ]
      }
    ),
    /* @__PURE__ */ a("div", { id: "developer-section-content", className: "tw:mt-2 tw:px-2", hidden: !n, children: /* @__PURE__ */ p(
      lo,
      {
        type: "single",
        value: s,
        onValueChange: (c) => {
          (c === "Production" || c === "Development") && r(c);
        },
        disabled: o,
        children: [
          /* @__PURE__ */ a(
            or,
            {
              ...
              children: t["%paratextRegistration_label_serverType_option_Production%"]
            }
          ),
          /* @__PURE__ */ a(
            or,
            {
              ...
              children: t["%paratextRegistration_label_serverType_option_Development%"]
            }
          )
        ]
      }
...
const zw = "16rem", Sw = "3rem", ki = Tt.createContext(void 0);
function na() {
  const t = Tt.useContext(ki);
  if (!t)
...
function Rw({
  ...
  const [d, l] = Tt.useState(t), w = e ?? d, u = Tt.useCallback(
    (_) => {
      const A = typeof _ == "function" ? _(w) : _;
      r ? r(A) : l(A);
    },
    [r, w]
  ), g = Tt.useCallback(() => u((_) => !_), [u]), h = w ? "expanded" : "collapsed", v = re() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Tt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: u,
...
function zu({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ p(
    q,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Wc, {}) : /* @__PURE__ */ a(Xc, {}),
...
function Vw({
  ...
  return n ? /* @__PURE__ */ p(qt, { children: [
    ...
    Dw,
    {
      ...
      children: /* @__PURE__ */ p($w, { children: [
        /* @__PURE__ */ p(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(Mw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Iw, { children: /* @__PURE__ */ a(
            Vw,
            {
              onClick: () => l(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ p(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { className: "tw:pl-3", children: /* @__PURE__ */ p(
            "div",
            {
              className: m(
...
const Se = "scrBook", jw = "scrRef", Le = "source", Bw = "details", Lw = "Scripture Reference", Fw = "Scripture Book", _i = "Type", Uw = "Details";
function Kw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Fu({
  ...
  const [l, w] = k([]), [u, g] = k([{ id: Se, desc: !1 }]), [h, f] = k({}), x = I(
  ...
  W(() => {
    if (c) {
      ...
      if (j.length === 1) {
        const D = x.find((E) => cn(E) === j[0]) || void 0;
        D && c(D);
      }
    }
  }, [h, x, c, C]);
  const y = n ?? Fw, _ = i ?? _i, A = [
  ...
  }, V = (N, j) => N.getIsGrouped() ? "" : m("banded-row", j % 2 === 0 ? "even" : "odd"), $ = (N, j, D) => {
    if (!((N == null ? void 0 : N.length) === 0 || j.depth < D.column.getGroupedIndex())) {
      if (j.getIsGrouped())
        switch (j.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ p(
      cr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(wr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: A.map((N) => /* @__PURE__ */ a(se, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Ga, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ha, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ a(De, { children: N.headers.filter((j) => j.column.columnDef.header).map((j) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(qr, { colSpan: j.colSpan, className: "tw:sticky top-0", children: j.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          xr(j.column.columnDef.header, j.getContext())
        ] }) }, j.id)
      )) }, N.id)) }),
      /* @__PURE__ */ a(Ya, { children: C.getRowModel().rows.map((N, j) => {
        const D = re();
        return /* @__PURE__ */ a(
          De,
          {
            ...
            children: N.getVisibleCells().map((E) => {
              if (!(E.getIsPlaceholder() || E.column.columnDef.enableGrouping && !E.getIsGrouped() && (E.column.columnDef.id !== Le || !r)))
                return /* @__PURE__ */ a(
                  er,
                  {
                    className: m(
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ p(
                      q,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          N.getIsExpanded() && /* @__PURE__ */ a(qe, {}),
                          !N.getIsExpanded() && (D === "ltr" ? /* @__PURE__ */ a(za, {}) : /* @__PURE__ */ a(Ta, {})),
                          " ",
...
function Gw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: u, ntLong: g, dcLong: h, extraLong: f } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, v] = k(!1), [C, y] = k(""), _ = K(void 0), A = K(!1), B = I(
    () => Ni(t),
    [t]
  ), T = I(() => {
    if (!C.trim()) {
    ...
    (E, Y = !1) => {
      ...
      const G = B.findIndex((Q) => Q === _.current), F = B.findIndex((Q) => Q === E);
      if (G === -1 || F === -1) return;
      const [O, S] = [
        Math.min(G, F),
        Math.max(G, F)
  ...
  return /* @__PURE__ */ p(
    Ie,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(Ae, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ p(
          He,
          {
            shouldFilter: !1,
            onKeyDown: (E) => {
              E.key === "Enter" && (A.current = E.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                Zr,
              ...
              /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: j, children: d }),
                /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: D, children: l })
              ] }),
              /* @__PURE__ */ p(Ye, { children: [
                ...
                Object.values(dt).map((E, Y) => {
                  ...
                  if (G.length !== 0)
                    return /* @__PURE__ */ p(Nn, { children: [
                      ...
                      Y < Object.values(dt).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, E);
                })
              ] })
            ]
  ...
  return /* @__PURE__ */ p("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ya ? ya : ln
      ).map((d) => /* @__PURE__ */ a(nr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Re(d, n) }, d)),
...
function Ku({
  ...
  const A = Et(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), j = Et(s, "%webView_scope_selector_current_book%"), D = Et(s, "%webView_scope_selector_choose_books%"), E = Et(s, "%webView_scope_selector_scope%"), Y = Et(s, "%webView_scope_selector_select_books%"), G = Et(s, "%webView_scope_selector_range%"), F = Et(s, "%webView_scope_selector_select_range%"), O = Et(s, "%webView_scope_selector_range_start%"), S = Et(s, "%webView_scope_selector_range_end%"), Z = Et(s, "%webView_scope_selector_ok%"), Q = Et(s, "%webView_scope_selector_cancel%"), _t = Et(s, "%webView_scope_selector_navigate%"), Nt = (M) => {
    if (!f) return;
  ...
  ], U = (M, J, Ut = !1) => /* @__PURE__ */ p(it, { children: [
    M,
    J && !Ut && /* @__PURE__ */ p("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? At.filter((M) => e.includes(M.value)) : At, wt = f ?? la, st = w ?? wt, vt = u ?? wt, oe = () => {
  }, at = K(null), Vt = K(null), St = K(!1), Wt = K(null), ne = K(!1), [R, Xt] = k(void 0), xt = K(!1), Ct = K(!1), Qt = K(null), me = L((M) => {
    if (M) {
    ...
    [r, n, f, i]
  ), et = tt.find((M) => M.value === t), pt = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Us(st, vt, {
  ...
  ), gt = tt.find((M) => M.value === "selectedBooks"), ut = tt.find((M) => M.value === "range"), [ft, Rt] = k(!1), [Dt, Ft] = k(void 0), [Ot, Ee] = k(void 0), [z, $t] = k(void 0), [yt, de] = k(void 0), [Te, ur] = k([]), hr = l === "dropdown" && Dt === "selectedBooks", gr = /* @__PURE__ */ a(
    Yw,
    {
      availableBookInfo: o,
      selectedBookIds: hr ? Te : n,
      onChangeSelectedBookIds: hr ? ur : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), Rr = R === "end", Dr = R === "start", Je = "tw:text-muted-foreground", b = l === "dropdown" && Dt === "range", H = b ? $t : P, Pt = b ? de : h ? X : oe, ve = /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-start", className: m(Rr && Je), children: O }),
      /* @__PURE__ */ a(
        wa,
        {
    ...
    /* @__PURE__ */ p("div", { ref: at, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-end", className: m(Dr && Je), children: S }),
      /* @__PURE__ */ a(
        wa,
        {
          id: "scope-range-end",
  ...
  const [mt, It] = k(null), [ht, te] = k(null), [Jt, je] = k(null), $i = 200, [Mi, Ii] = k(!1);
  W(() => {
    if (!Jt || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([J]) => {
      Ii(J.contentRect.width < $i);
    });
    return M.observe(Jt), () => M.disconnect();
  }, [Jt]);
  const fo = L(
    (M) => {
      Ee(M), $t(st), de(vt), ur(n), Rt(!1), Ft(M);
    },
    [st, vt, n]
  ), mo = L(() => {
    Ot !== void 0 && (Ot === "range" ? (z && (g == null || g(z)), yt && (h == null || h(yt))) : Ot === "selectedBooks" && i(Te), ot(Ot), Ft(void 0), Ee(void 0));
  }, [
    Ot,
    z,
    yt,
    ...
    M || (Ft(void 0), Ee(void 0));
  }, []), vo = L((M) => {
    var J;
    M.preventDefault(), (J = Mt.current) == null || J.focus();
  }, []), bo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ p("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(kt, { children: E }),
      l === "dropdown" ? /* @__PURE__ */ p(ke, { open: ft, onOpenChange: Rt, children: [
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ p(ia, { container: Jt, children: [
              ct.map(({ value: M, label: J, dropdownLabel: Ut, scrRefSuffix: fr, id: Ai }) => /* @__PURE__ */ p(
                Fe,
                {
                  ref: ze(M),
                  ...
                  children: [
                    t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-4 tw:w-4" }) }),
                    U(Ut ?? J, fr, Mi)
                  ]
                },
                Ai
              ...
              x && /* @__PURE__ */ p(it, { children: [
                /* @__PURE__ */ a(Ke, {}),
                /* @__PURE__ */ a(Er, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: _t }),
                /* @__PURE__ */ a(
                  Fe,
                  {
                    ref: Wt,
                        ...
                        children: /* @__PURE__ */ a(
                          wa,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ p(it, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: be(f ?? la, "id") }),
                              /* @__PURE__ */ a(qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        ra,
        {
          ...
          children: tt.map(({ value: M, label: J, scrRefSuffix: Ut, id: fr }) => /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Nr, { className: "tw:me-2", value: M, id: fr }),
            /* @__PURE__ */ a(kt, { htmlFor: fr, children: U(J, Ut) })
          ] }, fr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && ve,
    l === "dropdown" && gt && /* @__PURE__ */ a(_a, { open: Dt === "selectedBooks", onOpenChange: Or, children: /* @__PURE__ */ a(
      Na,
      {
        ref: te,
        onCloseAutoFocus: vo,
        ...
        children: /* @__PURE__ */ p(ia, { container: ht, children: [
          /* @__PURE__ */ a(Ca, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ea, { children: D }) }),
          gr,
          /* @__PURE__ */ p(yo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Or(!1), children: Q }),
            /* @__PURE__ */ a(q, { onClick: mo, children: Z })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ut && /* @__PURE__ */ a(_a, { open: Dt === "range", onOpenChange: Or, children: /* @__PURE__ */ a(
      Na,
      {
        ref: It,
        onCloseAutoFocus: vo,
        ...
        children: /* @__PURE__ */ p(ia, { container: mt, children: [
          /* @__PURE__ */ a(Ca, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ea, { children: F }) }),
          ve,
          /* @__PURE__ */ p(yo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Or(!1), children: Q }),
            /* @__PURE__ */ a(q, { ref: Qt, onClick: mo, children: Z })
          ] })
        ] })
      }
    ) })
...
function qu({
  ...
  return /* @__PURE__ */ p(
    cr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(dr, { size: n, className: m("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          lr,
          {
            placeholder: d[To(e)] ?? e
          }
        ) }),
        /* @__PURE__ */ a(
          wr,
          {
            ...
            style: { zIndex: We },
            children: t.map((w) => /* @__PURE__ */ a(se, { value: `${w}`, children: d[To(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ p(qt, { children: [
  /* @__PURE__ */ a(Gt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
    Fe,
    {
      onClick: () => {
        o(c);
    ...
    /* @__PURE__ */ a(es, { children: /* @__PURE__ */ a(rs, { children: Ti(
      t,
      e,
      Ei(t, c.id),
      o
...
function Ba({
  ...
  return /* @__PURE__ */ p(ke, { variant: i, children: [
    /* @__PURE__ */ a(_e, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a($s, {}) }) }),
    /* @__PURE__ */ a(Ne, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ p(Nn, { children: [
      /* @__PURE__ */ a(pn, { children: /* @__PURE__ */ a(Kt, { children: Ti(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Ke, {})
    ] }, d)) })
  ] });
}
const zi = Tt.forwardRef(
...
function Wu({
  ...
  return /* @__PURE__ */ p(zi, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Ba,
      {
        onSelectMenuItem: t,
    ...
    /* @__PURE__ */ p("div", { className: "tw:flex tw:shrink tw:grow-[1] tw:flex-row-reverse tw:flex-wrap tw:items-start tw:gap-x-1 tw:gap-y-2 tw:overflow-clip", children: [
      o && /* @__PURE__ */ a(
        Ba,
        {
          onSelectMenuItem: e,
...
const Si = Tt.forwardRef(({ className: t, ...e }, r) => {
  const o = re();
  return /* @__PURE__ */ a(
    le.Root,
    {
...
const Ri = Tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.List,
  {
    ref: r,
    className: m(
...
Ri.displayName = le.List.displayName;
const Jw = Tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Trigger,
  {
    ref: r,
    ...e,
...
const vr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ p(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
        ap,
        {
          onClick: () => {
            o(l);
      ...
      ) : /* @__PURE__ */ p(np, { children: [
        /* @__PURE__ */ a(ip, { children: l.label }),
        /* @__PURE__ */ a(sp, { children: Oi(
          t,
          e,
          Ei(t, l.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(op, {}, `separator-${i}`)), d;
  });
};
function cp({
  menuData: t,
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, u) => {
    var f, x, v, C;
    w.preventDefault();
    ...
    switch (u.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (C = d.current) == null || C.focus(), vr(d, [g, h]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(Zw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w, u]) => /* @__PURE__ */ p(Qw, { children: [
      /* @__PURE__ */ a(ep, { ref: l(w), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ a(
        rp,
        {
          style: { zIndex: We },
          children: /* @__PURE__ */ a(Kt, { children: Oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function th({
  ...
  const l = lp(
    ...
    n && n(f), o && o([f, ...r.filter((x) => x !== f)]), i && r.find((x) => x === f) && i([...r.filter((x) => x !== f)]), u(!1);
  }, h = (f, x) => {
    var C, y, _, A, B, T;
    const v = x !== f ? ((y = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : y[x]) ?? ((A = (_ = t[f]) == null ? void 0 : _.uiNames) == null ? void 0 : A.en) : void 0;
    return v ? `${(B = t[f]) == null ? void 0 : B.autonym} (${v})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
  return /* @__PURE__ */ p("div", { id: d, className: m("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ p(
      cr,
      {
        name: "uiLanguage",
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ p(ke, { children: [
              /* @__PURE__ */ a(_e, { className: m(u && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(q, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Co, {}) }) }),
              /* @__PURE__ */ a(Ne, { align: "end", children: l })
            ] }) }),
            e && l && /* @__PURE__ */ p(ke, { children: [
              /* @__PURE__ */ a(_e, { className: m(u && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(q, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Co, {}) }) }),
              /* @__PURE__ */ a(Ne, { align: "end", children: l })
            ] })
          ] }),
...
function Eh({
  ...
  const n = re();
  return /* @__PURE__ */ p(up, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(hp, {}),
    /* @__PURE__ */ p(
      Ve.Content,
      {
...
function Ah({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", gp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Fh(t) {
  const e = I(() => Ks(t).slice().sort().join(" "), [t]);
...
vp(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Eu as DEVELOPER_SECTION_STRING_KEYS,
  Jd as DataTable,
  Tu as DeveloperSection,
  _a as Dialog,
  Hh as DialogClose,
  Na as DialogContent,
  ...
  su as ERROR_POPOVER_STRING_KEYS,
  ...
  pu as Filter,
  lu as FilterDropdown,
  wu as Footer,
  uu as FootnoteEditor,
  bw as FootnoteItem,
  gu as FootnoteList,
  Nu as INTERNET_ACCESS_OPTION_LIST_STRING_KEYS,
  ku as INVENTORY_STRING_KEYS,
  Qr as Input,
  Cu as InternetAccessOptionList,
  _u as Inventory,
  xo as Kbd,
  Qh as KbdGroup,
  kt as Label,
  dw as MARKER_MENU_STRING_KEYS,
  iu as MarkdownRenderer,
  pw as MarkerMenu,
  du as MoreInfo,
  ...
  rh as ResultsCard,
  Uu as SCOPE_SELECTOR_STRING_KEYS,
  Ww as SELECT_BOOKS_STRING_KEYS,
  Ku as ScopeSelector,
  Fu as ScriptureResultsViewer,
  qu as ScrollGroupSelector,
  gn as SearchBar,
  cr as Select,
  Yw as SelectBooks,
  ...
  kr as Separator,
  Gu as SettingsList,
  Yu as SettingsListHeader,
  Hu as SettingsListItem,
  ...
  Ow as SidebarInset,
  Mw as SidebarMenu,
  Iu as SidebarMenuAction,
  Au as SidebarMenuBadge,
  Vw as SidebarMenuButton,
  Iw as SidebarMenuItem,
  Vu as SidebarMenuSkeleton,
  Pu as SidebarMenuSub,
  Bu as SidebarMenuSubButton,
  ju as SidebarMenuSubItem,
  Rw as SidebarProvider,
  Su as SidebarRail,
  $u as SidebarSeparator,
  zu as SidebarTrigger,
  tr as Skeleton,
  $h as Slider,
  Oh as Sonner,
  ig as Spinner,
