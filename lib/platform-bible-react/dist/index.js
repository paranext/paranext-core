...
function zv({ groups: e }) {
  return /* @__PURE__ */ B(Ro, { children: [
    ...
    /* @__PURE__ */ m(vr, { children: e.map((t) => /* @__PURE__ */ B(dt, { children: [
      ...
      /* @__PURE__ */ m(Uc, { children: t.items.map((n) => /* @__PURE__ */ m("div", { children: n.itemType === 0 ? /* @__PURE__ */ m(Po, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ m(Fi, { onClick: n.onClick, value: n.label, children: n.label }) })) }),
      /* @__PURE__ */ m(yr, {})
    ] })) })
  ] });
}
