import { jsx as r, jsxs as l, Fragment as ln } from "react/jsx-runtime";
import p, { forwardRef as Re, createContext as lr, useContext as dr, useCallback as U, useState as j, useRef as q, useEffect as it, useLayoutEffect as Ze, useMemo as et, Fragment as dn } from "react";
...
import { ChevronRight as Ee, Check as Ct, Circle as De, X as Ve, Search as cn, ChevronsUpDown as Me, FilterIcon as mr, ChevronDown as Wt, ChevronUp as hr, ArrowLeftIcon as fr, ChevronLeftIcon as gr, ChevronRightIcon as br, ArrowRightIcon as vr, Filter as xr, User as yr, Link as Nr, CircleHelp as kr, Star as Cr, CircleCheckIcon as _r, CircleXIcon as Sr, CircleHelpIcon as Tr, ArrowUpIcon as Rr, ArrowDownIcon as Er, ArrowUpDownIcon as Dr, PanelLeft as Vr, PanelRight as Mr, ScrollText as zr, ChevronLeft as Or, MenuIcon as Ir, Menu as Br, EllipsisVertical as Pr, LoaderCircle as Ar, Copy as jr } from "lucide-react";
import { formatScrRef as St, MODIFIER_KEYS as Xr, getChaptersForBook as Fr, NumberFormat as Gr, formatBytes as $r, deepEqual as ze, isString as ue, compareScrRefs as xe, scrRefToBBBCCCVVV as me, getLocalizeKeyForScrollGroupId as B } from "platform-bible-utils";
...
import { useReactTable as un, getFilteredRowModel as Lr, getSortedRowModel as mn, getPaginationRowModel as Yr, getCoreRowModel as hn, flexRender as Xt, getGroupedRowModel as Hr, getExpandedRowModel as Ur } from "@tanstack/react-table";
import * as G from "@radix-ui/react-select";
import qr from "markdown-to-jsx";
...
import { Toaster as Kr } from "sonner";
...
const Ie = X.Trigger, bn = X.Group, ta = X.Portal, ea = X.Sub, Rs = X.RadioGroup;
...
vn.displayName = X.SubTrigger.displayName;
...
Be.displayName = X.Item.displayName;
...
yn.displayName = X.RadioItem.displayName;
...
var Rn = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(Rn || {});
const W = class I {
  constructor(e, n, a, o) {
...
const fa = 6, Fe = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), ga = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, en = ["OT", "NT", "DC"], ba = 96, va = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), xa = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', Pt = (t) => Fr(M.bookIdToNumber(t));
function ya() {
...
function Ds({
  ...
  const o = H(), [s, i] = j(
    () => St(t, "English")
  ), [w, c] = j(""), [u, f] = j(t.book), [v, g] = j(t.chapterNum ?? 0), [m, N] = j(t.book), [T, y] = j(!1), [x, _] = j(T), S = q(void 0), z = q(void 0), $ = q(void 0), gt = U(
    (h) => {
      const V = a ? a() : Fe;
      return {
    ...
    (h, V) => {
      ...
      if (nn.has(C)) {
        if (m === u) {
          ...
          else C === "ArrowDown" ? L = fa : C === "ArrowUp" && (L = -6);
          if (v + L <= 0 || v + L > Pt(m))
            g(0);
          else if (L !== 0) {
  ...
  }, [x, b]), /* @__PURE__ */ l(Qt, { modal: !1, open: T, onOpenChange: A, children: [
      ...
      Yt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: en.map((h, V) => {
          ...
          return C.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(te, { className: "tw-font-semibold tw-text-foreground/80", children: ga[h] }),
...
const Ca = ft(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Dt : "button", { className: d(Ca({ variant: e, size: n, className: t })), ref: s, ...o })
);
P.displayName = "Button";
const _a = ft(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(pn.Root, { ref: n, className: d("pr-twp", _a(), t), ...e }));
...
const Sa = wt.Portal, En = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
    className: d(
...
En.displayName = wt.Overlay.displayName;
    ...
    /* @__PURE__ */ r(
      ee,
      {
        ...
        children: /* @__PURE__ */ l(ne, { children: [
          ...
          /* @__PURE__ */ r(ae, { children: e.map((_) => /* @__PURE__ */ l(
            se,
            {
              value: w(_),
              onSelect: () => {
...
function Ms({
  ...
  const f = he(u, "%webView_bookSelector_currentBook%"), v = he(u, "%webView_bookSelector_choose%"), g = he(u, "%webView_bookSelector_chooseBooks%"), [m, N] = j(
    "current book"
    /* CURRENT_BOOK */
  ), T = (y) => {
    N(y), t(y);
...
function za({ table: t }) {
  return /* @__PURE__ */ l(Qt, { children: [
    /* @__PURE__ */ r(ur, { asChild: !0, children: /* @__PURE__ */ l(P, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Tt = G.Root, Oa = G.Group, Rt = G.Value, Ia = ft(
...
Vn.displayName = G.ScrollUpButton.displayName;
...
function Fa({
  ...
  var y;
  const [w, c] = j([]), [u, f] = j([]), [v, g] = j({}), [m, N] = j({}), T = un({
    data: e,
    columns: t,
    getCoreRowModel: hn(),
    ...n && { getPaginationRowModel: Yr() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(ie, { stickyHeader: s, children: [
      /* @__PURE__ */ r(we, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ r(ht, { children: x.headers.map((_) => /* @__PURE__ */ r($t, { children: _.isPlaceholder ? void 0 : Xt(_.column.columnDef.header, _.getContext()) }, _.id)) }, x.id)) }),
      /* @__PURE__ */ r(le, { children: (y = T.getRowModel().rows) != null && y.length ? T.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        ht,
        {
          ...
          children: x.getVisibleCells().map((_) => /* @__PURE__ */ r(Et, { children: Xt(_.column.columnDef.cell, _.getContext()) }, _.id))
        },
        x.id
...
function zs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp", n), children: /* @__PURE__ */ r(qr, { options: o, children: e }) });
}
var Ga = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Ga || {});
function Os({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(Qt, { children: [
    /* @__PURE__ */ r(Ie, { asChild: !0, children: /* @__PURE__ */ l(P, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(Yt, { children: n.map((a) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(bn, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(Pe, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(yn, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(Ht, {})
    ] }, a.label)) })
  ] }) });
}
...
const La = ft(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", La({ variant: e }), t), ...n })
);
...
function Ya({
  ...
  return /* @__PURE__ */ r("div", { className: f, children: /* @__PURE__ */ l($e, { open: v, onOpenChange: g, children: [
    /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ l(
      P,
      {
        variant: "ghost",
...
function Ha({
  ...
  return /* @__PURE__ */ l(ie, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(we, { stickyHeader: !0, children: /* @__PURE__ */ l(ht, { children: [
...
), Ua = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  fn.Root,
  {
    ref: o,
...
Ua.displayName = fn.Root.displayName;
const On = p.createContext({
  size: "default",
  variant: "default"
}), In = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = H();
  return /* @__PURE__ */ r(
    Zt.Root,
    {
...
const de = (t) => t === "asc" ? /* @__PURE__ */ r(Rr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Er, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), As = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(In, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Ut,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, Ja = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ls = Object.freeze([
...
function Ys({
  ...
  const u = pt(n, "%webView_inventory_all%"), f = pt(n, "%webView_inventory_approved%"), v = pt(n, "%webView_inventory_unapproved%"), g = pt(n, "%webView_inventory_unknown%"), m = pt(n, "%webView_inventory_scope_currentBook%"), N = pt(n, "%webView_inventory_scope_chapter%"), T = pt(n, "%webView_inventory_filter_text%"), y = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, _] = j(!1), [S, z] = j("all"), [$, gt] = j(""), [lt, k] = j([]), b = et(() => t.length === 0 ? [] : Wa(t, o, s), [t, o, s]), A = et(() => {
    if (x) return b;
    const D = [];
    return b.forEach((h) => {
  ...
  const Ot = (D, h) => {
    ...
    if (A.length === 0 || lt.length === 0) return [];
    const D = A.filter((h) => ze(
      x ? h.items : [h.items[0]],
      lt
    ));
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Tt, { onValueChange: (D) => It(D), defaultValue: i, children: [
...
Ue.displayName = gn.Root.displayName;
...
const Za = "16rem", Qa = "3rem", Bn = p.createContext(void 0);
function pe() {
...
const Pn = p.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Bn.Provider, { value: _, children: /* @__PURE__ */ r(qe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Pn.displayName = "SidebarProvider";
...
const to = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = pe();
  return /* @__PURE__ */ l(
    P,
    {
...
const so = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Dt : "button",
  {
    ref: a,
  ...
  ({
    ...
    const c = t ? Dt : "button", { state: u } = pe(), f = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: d(io({ variant: n, size: a }), s),
        ...i
      }
    );
...
const wo = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Dt : "button",
  {
    ref: o,
...
wo.displayName = "SidebarMenuAction";
...
lo.displayName = "SidebarMenuBadge";
const co = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
uo.displayName = "SidebarMenuSubItem";
const mo = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Dt : "a",
  {
    ref: s,
...
function ho({
  ...
  return /* @__PURE__ */ r(
    An,
    {
      ...
      children: /* @__PURE__ */ l(Xn, { children: [
        /* @__PURE__ */ l(_e, { children: [
          /* @__PURE__ */ r(Se, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Te, { children: /* @__PURE__ */ r(Fn, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(Gn, { children: /* @__PURE__ */ r(
            $n,
            {
              onClick: () => u(g),
              isActive: v(g),
    ...
    /* @__PURE__ */ l(
      Pn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jn, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const ut = "scrBook", fo = "scrRef", xt = "source", go = "details", bo = "Scripture Reference", vo = "Scripture Book", Yn = "Type", xo = "Details";
function yo(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, an = (t) => `${No({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Us({
  sources: t,
  ...
  const [c, u] = j([]), [f, v] = j([{ id: ut, desc: !1 }]), [g, m] = j({}), N = et(
  ...
  it(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const A = N.find((R) => an(R) === b[0]) || void 0;
        A && w(A);
      }
    }
  }, [g, N, w, y]);
  const x = o ?? vo, _ = s ?? Yn, S = [
  ...
  }, gt = (k, b) => k.getIsGrouped() ? "" : d("banded-row", b % 2 === 0 ? "even" : "odd"), lt = (k, b, A) => {
    ...
    !e && /* @__PURE__ */ l(
      Tt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(kt, { position: "item-aligned", children: /* @__PURE__ */ r(Oa, { children: S.map((k) => /* @__PURE__ */ r(rt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      P,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ r(Ee, {}) : /* @__PURE__ */ r(Or, {})),
                          " ",
...
}), Hn = (t, e, n) => We(t, e).every((a) => n.includes(a));
function _o({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
...
function So({
  ...
  return /* @__PURE__ */ r(
    P,
    {
      ...
      onClick: () => a(t),
      className: d(
        Hn(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Co(
        t,
...
function To({
  ...
  const z = et(() => M.allBookIds.filter(
    ...
    (b) => {
      const A = We(z, b).map((R) => R);
      n(
        Hn(z, b, e) ? e.filter((R) => !A.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...A])]
      );
    },
    [e, n, z]
  ), lt = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
        ...
        ne,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(P, { variant: "ghost", size: "sm", onClick: lt, children: c }),
              /* @__PURE__ */ r(P, { variant: "ghost", size: "sm", onClick: k, children: u })
            ] }),
            /* @__PURE__ */ l(ae, { children: [
              /* @__PURE__ */ r(oe, { children: f }),
              Object.values(mt).map((b, A) => {
                const R = z.filter(
                  (nt) => _t(nt) === b
                );
                if (R.length !== 0)
                  return /* @__PURE__ */ l(dn, { children: [
                    ...
                    A < Object.values(mt).length - 1 && /* @__PURE__ */ r(Dn, {})
                  ] }, b);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var A;
        return /* @__PURE__ */ r(Jt, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((A = o.get(b)) == null ? void 0 : A.localizedName) || M.bookIdToEnglishName(b) || b }, b);
      }),
...
const qn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Ke, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    Be,
    {
      onClick: () => {
        a(w);
...
function sn({
  ...
  return /* @__PURE__ */ l(Qt, { variant: s, children: [
    /* @__PURE__ */ r(Ie, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(P, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Ir, {}) }) }),
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ l(dn, { children: [
      /* @__PURE__ */ r(bn, { children: /* @__PURE__ */ r(qe, { children: qn(e.groups, e.items, w, t) }) }),
...
Kn.displayName = Q.List.displayName;
...
)), Wn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Q.Content,
  {
    ref: n,
    className: d(
...
Wn.displayName = Q.Content.displayName;
function ei({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Jn, { children: [
      /* @__PURE__ */ r(Kn, { children: t.map((i) => /* @__PURE__ */ r(Ro, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(Wn, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function Eo({ ...t }) {
...
const Zn = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
...
Zn.displayName = F.Root.displayName;
...
Qn.displayName = F.Trigger.displayName;
const tr = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
tr.displayName = F.SubTrigger.displayName;
const er = p.forwardRef(({ className: t, ...e }, n) => {
  const a = ot();
  return /* @__PURE__ */ r(
    F.SubContent,
    {
...
er.displayName = F.SubContent.displayName;
const nr = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ot();
...
nr.displayName = F.Content.displayName;
...
Mo.displayName = F.RadioItem.displayName;
...
zo.displayName = F.Label.displayName;
const ar = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  F.Separator,
  {
    ref: n,
    className: d("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
ar.displayName = F.Separator.displayName;
...
or.displayname = "MenubarShortcut";
const At = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((u) => u.group === s).sort((u, f) => u.order - f.order).map((u) => /* @__PURE__ */ l(Je, { children: [
      /* @__PURE__ */ r(Ke, { asChild: !0, children: "command" in u ? /* @__PURE__ */ l(
        rr,
        {
          onClick: () => {
            a(u);
          ...
          children: [
            ...
            /* @__PURE__ */ r(or, { children: u.shortcut })
          ]
        },
        `menubar-item-${u.label}-${u.command}`
      ) : /* @__PURE__ */ l(Do, { children: [
        /* @__PURE__ */ r(tr, { children: u.label }),
        /* @__PURE__ */ r(er, { children: sr(
          t,
          e,
          Un(t, u.id),
          a
    ...
    return w.length > 0 && i < o.length - 1 && c.push(/* @__PURE__ */ r(ar, {}, `separator-${s}`)), c;
  });
};
function Oo({
  menuData: t,
  ...
  if (Jr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (f, v) => {
    var N, T, y, x;
    f.preventDefault();
    ...
    return /* @__PURE__ */ r(Zn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, f]) => typeof f == "object").sort(([, f], [, v]) => typeof f == "boolean" || typeof v == "boolean" ? 0 : f.order - v.order).map(([f, v]) => /* @__PURE__ */ l(Eo, { children: [
      /* @__PURE__ */ r(Qn, { ref: u(f), children: typeof v == "object" && "label" in v && v.label }),
      /* @__PURE__ */ r(
        nr,
        {
          className: "tw-z-[250]",
...
const Po = Re(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ar, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function wi({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const a = wn(n, "%webView_error_dump_header%"), o = wn(n, "%webView_error_dump_info_message%");
  function s() {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(P, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s, children: /* @__PURE__ */ r(jr, {}) })
    ] }),
...
), jo = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(Ao({ variant: e }), t), ...n }));
...
const Fo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Go.displayName = Vt.Root.displayName;
...
$o.displayName = Vt.Image.displayName;
...
Lo.displayName = Vt.Fallback.displayName;
...
const li = at.Trigger, Zo = at.Portal, di = at.Close, wr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
...
wr.displayName = at.Overlay.displayName;
...
const as = p.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Ne.Root,
  {
    ref: a,
    className: d(
...
as.displayName = Ne.Root.displayName;
function ci({ ...t }) {
  return /* @__PURE__ */ r(
    Kr,
    {
...
os.displayName = jt.Root.displayName;
...
ss.displayName = ke.Root.displayName;
const pi = Q.Root, is = p.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.List,
    {
...
export {
  ...
  Ue as Separator,
  Ws as SettingsList,
  Qs as SettingsListHeader,
  Zs as SettingsListItem,
  ho as SettingsSidebar,
  ...
  ai as UiLanguageSelector,
  Jn as VerticalTabs,
  Wn as VerticalTabsContent,
  Kn as VerticalTabsList,
  Ro as VerticalTabsTrigger,
  La as badgeVariants,
  Ca as buttonVariants,
  d as cn,
  $s as getBookIdFromUSFM,
  Fs as getLinesFromUSFM,
  Gs as getNumberFromUSFM,
  Ja as getStatusForItem,
  ni as getToolbarOSReservedSpaceClassName,
  js as inventoryCountColumn,
