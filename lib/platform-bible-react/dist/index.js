...
var Zt = (t, e, r) => Cs(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Ae, a as Ur, C as tr, L as Hn, t as Es, u as rn, T as zt, b as Nt, d as Ct, e as Et, f as qn, A as ka, r as re, D as Be, h as Te, i as Fe, j as cr, k as Ge, B as et, x as Ts, l as Ss, m as Rs, I as Ds, n as To, o as Xe, p as De, q as Os, s as Gn, P as lr, v as Rr, w as dr, y as wr, z as Ia, E as za, F as So, G as ur, H as Pa, J as It, R as Ro, K as _a, M as so, N as co, O as lo, Q as wo, S as Wn, U as ha, V as Do, W as Gr, X as Wr, Y as xr, Z as Ms, _ as ir, $ as Ze, a0 as je, a1 as We, a2 as yr, a3 as Oo, a4 as Mo, a5 as Na, a6 as Io, a7 as Yn, a8 as Is, a9 as zs, aa as Ps, ab as uo, ac as Zn, ad as Aa, ae as As, af as Xn, ag as $s, ah as Vs, ai as Ls, aj as an, ak as Bs, al as Fs, am as js, an as Jn, ao as Qn, ap as zo, aq as Us, ar as ti, as as Ha, at as on, au as qa, av as Ks, aw as Hs, ax as qs, ay as Gs, az as Ws, aA as Ys, aB as Zs, aC as Xs, aD as Js, aE as Po, aF as Ao, aG as Qs, aH as tc } from "./resizable-ehLO8YVZ.js";
...
import { Section as Mt, compareScrRefs as Ca, getChaptersForBook as Ac, formatScrRef as $e, formatReplacementString as Ye, getSectionForBook as ga, formatRelativeDate as $c, sanitizeHtml as $o, NumberFormat as li, formatBytes as Vc, getCurrentLocale as Lc, usfmMarkers as Br, isPlatformError as Bc, ABORTED as Fc, getErrorMessage as jc, getFormatCallerFunction as Uc, deepEqual as Kc, isString as ln, scrRefToBBBCCCVVV as Ga, defaultScrRef as Wa, formatScrRefRange as Hc, getLocalizeKeyForScrollGroupId as dn, formatReplacementStringToArray as wn, collectUsjMarkers as qc } from "platform-bible-utils";
import Jt, { useRef as P, useMemo as A, createContext as Dr, useContext as Jr, useEffect as tt, useState as N, useCallback as V, useId as Ea, useImperativeHandle as Gc, useLayoutEffect as Ut, Fragment as Qr, Component as Wc, createElement as ho, Suspense as Yc, forwardRef as Vo, memo as di } from "react";
...
import { useReactTable as Ci, getFilteredRowModel as td, getSortedRowModel as Ei, getPaginationRowModel as ed, getCoreRowModel as Ti, flexRender as Kr, getGroupedRowModel as rd, getExpandedRowModel as ad } from "@tanstack/react-table";
...
function gd({
  ...
  Mi(), tt(() => {
    ...
    if (!ot) return;
    const b = (J) => !!J && J.scrollWidth > J.clientWidth, rt = () => {
      qn() !== "pointer" && (S || b(h.current) || b(d.current)) && T(!0);
    }, X = () => T(!1);
...
function bd({
  ...
  const [h, f] = N(!1), [y, x] = N(!1), g = Ea(), C = P(!1), E = w !== void 0, T = E ? w : h, k = n === "" ? "" : re(n, md), z = re(s, vd), S = (D) => {
    D || (C.current = !0, x(!1)), E || f(D), p == null || p(D);
  }, M = (D) => {
    if (D && C.current) {
      C.current = !1;
      return;
      ...
      if (i) {
        ...
        if (!w && d) {
          const f = ((y) => Object.keys(ka).find(
            (x) => ka[x].toLowerCase() === y.toLowerCase()
          ))(c);
...
function Za({
  ...
  const S = De(), M = hd(), [I, O] = N(!1), [D, Y] = N(""), [Z, ot] = N(""), [b, rt] = N("books"), [X, L] = N(void 0), [J, j] = N(
    void 0
  ...
  const G = V(() => {
    ...
    (m) => {
      const q = b === "chapters" ? X : B == null ? void 0 : B.book;
      if (q) {
        if (w && w(q, m) > 1) {
  ...
  const { otLong: ke, ntLong: _e, dcLong: rr, extraLong: ar } = {
    ...
    () => kd(Z),
    [Z]
  ), ct = A(() => !w || !B || !B.chapterNum || !it ? !1 : w(B.book, B.chapterNum) > 0, [w, B, it]), qt = b === "books" && !mt && !Z.trim() && _t.size > 0, Pr = V(
    (m) => p ? bn(m, p) : !1,
    [p]
  ), Pe = V(
    (m) => (q) => p ? _d(m, q, p) : !1,
    ...
    (m) => {
      ...
      if (!(!!q && !!((Qo = At.current) != null && Qo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
        const Lt = At.current ? Rd(At.current) : [];
        if (Lt.length === 0) {
      ...
      if (b === "books" && B && !mt && m.key === "Enter" && !(q !== St.current && !!(q != null && q.closest('button, a, input, select, textarea, [role="button"]')))) {
        m.preventDefault(), m.stopPropagation(), G();
        return;
      }
      if ((b === "chapters" || b === "verses") && (Bt || Gt)) {
        m.preventDefault(), m.stopPropagation();
        return;
      }
      if (m.key === "Backspace" && (b === "chapters" || b === "verses")) {
        m.preventDefault(), m.stopPropagation(), b === "verses" ? kt() : dt();
        return;
      }
      if (!pd(m.key) || mt) return;
      if (b === "books" && !Tt && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
      ...
      if (m.shiftKey || b === "books" && q !== St.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const Dt = (() => {
        const Lt = b === "books" && B && ct && B.chapterNum ? { bookId: B.book, chapterNum: B.chapterNum } : void 0, ue = b === "verses" ? { bookId: J, chapterNum: W } : Lt;
        if (ue) {
        ...
        if (b === "chapters" || b === "books" && B && qe(B.book) > 1) {
          const Yt = b === "chapters" ? X : B == null ? void 0 : B.book;
          return Yt ? {
            max: qe(Yt),
            current: Fr(D) ?? 0,
      ...
      b === "books" && Pt(!0), Dt.takeFocus && ((tn = At.current) == null || tn.focus());
      const ee = Td({
        current: Dt.current,
        key: m.key,
        max: Dt.max,
  ...
  Ut(() => {
    const m = setTimeout(() => {
      if (I && b === "books" && $t.current && ie.current) {
  ...
  }, [b, X, B, t.book, t.chapterNum]), Ut(() => {
    if (b === "verses" && J && W !== void 0) {
  ...
  }, [b, B, fe, at, D]), /* @__PURE__ */ u(lr, { open: I, onOpenChange: pt, modal: E, children: [
          ...
          wr,
          {
            ...
            children: [
                ...
                /* @__PURE__ */ u(Nt, { children: [
                  /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
                    et,
                    {
                      variant: "ghost",
                      size: "sm",
                      onClick: b === "verses" ? kt : dt,
                      className: "tw:me-2 tw:h-6 tw:w-6 tw:p-0",
                      tabIndex: -1,
                      "aria-label": ra,
                      children: S === "ltr" ? /* @__PURE__ */ a(ec, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(rc, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                  /* @__PURE__ */ a(Et, { children: ra })
                ] }),
                b === "chapters" && X && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ae(X, s) }),
                b === "verses" && J && W !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ae(J, s)} ${W}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !mt && /* @__PURE__ */ u(ur, { ref: $t, children: [
                ...
                b === "verses" && J && W !== void 0 && w && /* @__PURE__ */ a(
                  yn,
                  {
                    bookId: J,
                    chapterNum: W,
...
const Pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Id = Pi ? Ut : tt, wa = { tag: Lo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (f.isEmpty()) {
            ...
            (ae() !== null || x !== null && x === p.getRootElement()) && y.select();
          }
        }, wa);
...
const Pd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ut : tt;
...
const Fd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ut : tt;
function jd(t) {
...
function Gd(t, e, r) {
  ...
  function d() {
    ...
    var y, x;
    c.isConnected || (x = c, (y = n).insertBefore(x, y.firstChild));
    let g = !1;
...
function Yd(t, e = Wd) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), y = h.getNode(), x = y.getKey(), g = h.offset, C = f.getNode(), E = C.getKey(), T = f.offset, k = t.getElementByKey(x), z = t.getElementByKey(E), S = r === null || k !== o || g !== n || x !== r.getKey(), M = s === null || z !== i || T !== c || E !== s.getKey();
      if ((S || M) && k !== null && z !== null) {
        const I = function(O, D, Y, Z, ot, b, rt) {
          const X = (O._window ? O._window.document : document).createRange();
          return X.setStart(..._n(D, Y, Z)), X.setEnd(..._n(ot, b, rt)), X;
        }(t, h, y, k, f, C, z);
        d(), d = Gd(t, I, e);
      }
...
function Jd(t) {
  const e = ae() || il();
  let r;
  if (Se(e)) r = sl(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = fi(c, "next"));
    }
    r = r || cl(Qe(), "previous").getFlipped().insert(ta());
  }
...
function Qd(t, e, r) {
  ...
  return gl(o) && Ta(283), o.insert(t.isInline() ? ta().append(t) : t), un(fi(t.getLatest(), "next"), e.direction);
}
function tw(t) {
  const e = ae();
  if (!Se(e)) return !1;
...
Xt.prototype.brand = ew, Xt.prototype.h = function() {
  return !0;
...
he({ name: "@lexical/extension/DecoratorText", nodes: () => [ji], register: (t, e, r) => t.registerCommand(bi, (o) => {
  const n = ae();
  if (xi(n) || Se(n)) for (const s of n.getNodes()) sw(s) && s.toggleFormat(o);
  return !1;
}, yi) });
function Ui(t, e) {
  let r;
...
const uw = he({ config: pr({ setOptions: Tn, updateOptions: Tn }), init: ({ $initialEditorState: t = ww }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const hw = /* @__PURE__ */ new Set(), Dn = he({ build(t, e, r) {
...
const bw = he({ name: "@lexical/react/ReactProvider" });
function xw() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (Se(y)) {
                ...
                if (fo(g) && l >= 0 && w >= 0 && (C = l, E = l + w, y.setTextNodeRange(g, C, g, E)), C === E && p === "" || (y.insertRawText(p), g = x.getNode()), fo(g)) {
                  C = h, E = h + f;
...
const Rw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ut : tt;
...
function Lw({
  ...
  const [e] = Me(), [r, o] = N(e), [n, s] = N("paragraph"), [i, c] = Vw(), d = () => {
  };
...
function Sh({
  ...
  const [s, i] = N(Ww), [c, d] = N(n), [l, w] = N(!1), p = P(void 0), h = P(null);
  tt(() => {
    let g = !0;
    const C = h.current;
    if (!C) return;
  ...
  const f = V(() => {
    ...
    const g = Oa(s);
    e(g, c);
  }, [s, e, c]), y = o["%commentEditor_placeholder%"] ?? "Type your comment here...", x = o["%commentEditor_assignTo_label%"] ?? "Assign to";
...
function An({
  ...
  const w = Mr(), [p, h] = N(), f = d ?? p, x = f !== void 0 && o, g = l !== void 0, C = V(
    (b) => {
      g || h(b), l == null || l(b);
    },
    [g, l]
  ...
  const k = V(
    ...
    const b = new Date(t.date), rt = $c(
      b,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), X = b.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    if (o && c)
      return /* @__PURE__ */ u(ht, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (b) => {
              b.stopPropagation(), T.current = !0;
              const rt = t.contents.trim() !== "";
              C(rt ? Hw(t.contents) : Gw), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          x && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: E,
              onKeyDownCapture: (b) => {
                b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), k()) : Zo(b) && (b.preventDefault(), b.stopPropagation(), ne(f) && z());
              },
              onKeyDown: (b) => {
        ...
        Z && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(cc, {}) }) }),
...
const tu = {
  ...
  var Ke;
  const rt = Mr(), [X, L] = N({}), J = ot ?? X, j = J.editorState ?? tu, W = J.assignedUser, ut = b !== void 0, mt = P(J);
  mt.current = J;
  const H = V(
    (R) => {
      const it = { ...mt.current, ...R };
      mt.current = it, ut || L(it), b == null || b(l, Pn(it) ? void 0 : it);
    },
    [ut, b, l]
  ), gt = V(
    (R, it) => {
...
function au({
  ...
  const [i, c] = N("accept"), d = Ea(), l = Ea(), w = Mr(), p = r === "loading", h = r === "accept", f = r === "none", y = r === "acceptRejectOrMerge", x = h ? "accept" : i, g = A(
    () => xa(t.rejectedText ?? ""),
    [t.rejectedText]
  ), C = A(
    () => xa(t.acceptedText ?? ""),
  ...
  const Y = e["%conflict_note_no_result%"] ?? "No result preview available.", Z = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: Y }), ot = (L) => L ? /* @__PURE__ */ a(
    ...
    const J = x === L.value, j = `${l}-${L.value}`, W = rt(L);
    return (
    ...
    if (e === "Resolved") {
      for (let E = o.length - 1; E >= 0; E -= 1)
        if (o[E].status === "Resolved")
          return ss(o[E].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? l;
...
const cu = di(function(e) {
  const {
    ...
    [d]
  ), { conflictOptions: w, isResolving: p, resolve: h, resolvedResolution: f, showResolveCheck: y } = su({
    threadId: s,
    threadStatus: i,
    isSelected: n,
    activeComments: d,
...
function $h({
  ...
  const Y = r.filter(
    ...
    (j) => {
      z((W) => new Set(W).add(j.id)), M(j.id), x == null || x(j.id);
    },
    [x]
  ), b = V(
    (j) => {
      ...
      }), M(j), x == null || x(W ? void 0 : j);
    },
    [k, x]
  ), { listboxRef: rt, activeId: X, handleKeyDown: L } = Ms({
    options: Z,
    onOptionSelect: ot
  }), J = V(
    (j) => {
      ...
      }), M(void 0), x == null || x(void 0)), j.preventDefault(), j.stopPropagation()) : L(j);
    },
    [S, k, L, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: Y.map((j) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: j.type === "Conflict" ? /* @__PURE__ */ a(cu, { ...W, conflictResolution: C }) : /* @__PURE__ */ a(ls, { ...W })
          },
          j.id
        );
      })
...
function gu({
  ...
  var S;
  const [w, p] = N([]), [h, f] = N([]), [y, x] = N({}), [g, C] = N({}), E = A(() => e ?? [], [e]), T = Ci({
    data: E,
    columns: t,
    getCoreRowModel: Ti(),
      ...
      return /* @__PURE__ */ u(Gr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          et,
          {
            ...
            onClick: () => r(e.filter((y) => y !== h)),
            children: /* @__PURE__ */ a(ri, { className: "tw:h-3 tw:w-3" })
          }
        ),
        (f = t.find((y) => y.value === h)) == null ? void 0 : f.label
      ] }, h);
...
function Tu({
  ...
  const s = P(!1), i = P(null), c = P(null), d = P(!1), [l, w] = N(t), [p, h] = N(e), [f, y] = N(!1), x = P(!1), g = P(l);
  g.current = l;
  const C = P(p);
  C.current = p, tt(() => {
    w(t);
  ...
  return /* @__PURE__ */ u(Be, { open: f, onOpenChange: E, children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Eu(t, o, e) }) }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            Ze,
            {
              ...
              onClick: (k) => {
                var z;
                if (k.stopPropagation(), x.current && k.target !== i.current) {
                  E(!1);
                  return;
                }
...
function Du({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Su(t, r) }) }) }),
      /* @__PURE__ */ a(Et, { children: /* @__PURE__ */ a("p", { children: Ru(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(
      Fe,
      {
...
function Gh({
  ...
  const [x, g] = N("generated"), [C, E] = N("generated"), [T, k] = N("*"), [z, S] = N("*"), [M, I] = N("f"), [O, D] = N(!1), [Y, Z] = N(!0), [ot, b] = N(!1), rt = P(!1), X = P(""), [L, J] = N(!1), j = _u(), [W, ut] = N(), mt = P(null), H = P(
    void 0
  ...
  const se = () => {
    ...
    if (U && $r("note", U)) {
      ...
      M !== "x" && _ === "x" ? nt == null || nt.forEach((yt) => $u(yt)) : M === "x" && _ !== "x" && (nt == null || nt.forEach((yt) => Vu(yt))), At(U);
    }
  }, xe = (_) => {
    ut(_.contextMarker), b(_.canRedo);
  }, Ie = V(
    (_) => {
      var G, $, Q, K, nt;
      const U = ($ = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : $.at(0);
    ...
    (_, U, G) => {
      ...
      Vs({
        ...
        onShowError: (K) => {
          (!Bc(K) || K.code !== Fc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${jc(K)}`
          );
        }
      });
    },
  ...
  return /* @__PURE__ */ u(ht, { children: [
    ...
    /* @__PURE__ */ u(lr, { open: L, children: [
      /* @__PURE__ */ a(Bs, { virtualRef: j.virtualRef }),
      /* @__PURE__ */ a(
        dr,
        {
...
function ju({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Xo(t.marker, [i], o, !1),
    " "
  ] }), f = !!d, y = !!w, x = !!p, g = e === "horizontal" ? "horizontal" : "vertical", C = o ? "marker-visible" : "", E = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", T = v(g, C);
  return /* @__PURE__ */ u(ht, { children: [
...
function Yh({
  ...
  const p = l ?? Uc(r, void 0), h = (k, z) => {
    w == null || w(k, z, n);
  }, f = s ? r.findIndex((k) => k === s) : -1, [y, x] = N(f), g = (k, z, S) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
...
function ag({
  ...
  const f = Ce(r, "%webView_inventory_all%"), y = Ce(r, "%webView_inventory_approved%"), x = Ce(r, "%webView_inventory_unapproved%"), g = Ce(r, "%webView_inventory_unknown%"), C = Ce(r, "%webView_inventory_scope_currentBook%"), E = Ce(r, "%webView_inventory_scope_chapter%"), T = Ce(r, "%webView_inventory_scope_verse%"), k = Ce(r, "%webView_inventory_filter_text%"), z = Ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), S = Ce(r, "%webView_inventory_no_results%"), [M, I] = N(!1), [O, D] = N("all"), [Y, Z] = N(""), [ot, b] = N([]), rt = A(() => {
    const H = t ?? [];
    return H.length === 0 ? [] : Yu(H, n, s);
  }, [t, n, s]), X = A(() => {
    if (M) return rt;
    const H = [];
  ...
  }, [M, rt]), L = A(() => X.length === 0 ? [] : Wu(X, O, Y), [X, O, Y]), J = A(() => {
    var vt, lt;
    if (!M) return d;
...
const Zu = "16rem", Xu = "3rem", ws = Jt.createContext(void 0);
function Fa() {
  const t = Jt.useContext(ws);
  if (!t)
...
function vg({
  ...
  const [l, w] = N([]), [p, h] = N([{ id: He, desc: !1 }]), [f, y] = N({}), x = A(
  ...
  tt(() => {
    if (c) {
      ...
      if (D.length === 1) {
        const Y = x.find((Z) => Un(Z) === D[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [f, x, c, C]);
  const E = n ?? dp, T = s ?? us, k = [
    ...
    !e && /* @__PURE__ */ u(
      Cr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Sr, { position: "item-aligned", children: /* @__PURE__ */ a(wu, { children: k.map((O) => /* @__PURE__ */ a(ve, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
                    ...
                    children: Z.getIsGrouped() ? /* @__PURE__ */ u(
                      et,
                      {
                        ...
                        children: [
                          ...
                          !O.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Rc, {}) : /* @__PURE__ */ a(Dc, {})),
                          " ",
...
function hp({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: y, extraLong: x } = {
    ...
    (b, rt = !1) => {
      ...
      const X = S.findIndex((ut) => ut === k.current), L = S.findIndex((ut) => ut === b);
      if (X === -1 || L === -1) return;
      const [J, j] = [
        Math.min(X, L),
        Math.max(X, L)
      ...
      r(
        e.includes(b) ? e.filter((ut) => !W.includes(ut)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, r, S]
  ), O = (b) => {
    I(b, z.current), z.current = !1;
  }, D = (b, rt) => {
    b.preventDefault(), I(rt, b.shiftKey);
  }, Y = () => {
    r(S.map((b) => b));
  }, Z = () => {
    r([]);
    ...
    () => Object.values(Mt).filter(
      (b) => (s == null ? void 0 : s[b]) !== void 0 && zo(S, b).length === 0
          ...
          dr,
          {
            ...
            children: /* @__PURE__ */ u(
              wr,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (b) => {
                  b.key === "Enter" && (z.current = b.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    Ia,
                  ...
                  /* @__PURE__ */ u(ur, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(Mt).filter((b) => M[b].length > 0).map((b, rt) => {
                      const X = M[b];
                  ...
                  ot.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: ot.map(({ section: b, explanation: rt }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: rt }, b)) })
                ]
              }
            )
          }
...
function xg({
  ...
  const S = Ft(
    ...
    (F) => {
      y == null || y(F), x == null || x(F), bt.current = !0;
    },
    [y, x]
  ), ye = V(
    (F) => {
      x == null || x(F), ce.current = !0;
    },
    [x]
  ), _t = V(
    (F) => {
    ...
    [r, n, g, s]
  ), de = lt.find((F) => F.value === t), ge = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? Hc(Tt, Pt, {
  ...
  ), rr = oe === "end", ar = oe === "start", ze = "tw:text-muted-foreground", Ne = p === "dropdown" && Q === "range", hr = Ne ? dt : te, zr = Ne ? pt : x ? ye : Ht, Ke = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const oa = V(
    ...
    nt !== void 0 && (nt === "range" ? (Rt && (y == null || y(Rt)), kt && (x == null || x(kt))) : nt === "selectedBooks" && s(xt), _t(nt), K(void 0), yt(void 0));
  }, [
    nt,
    Rt,
    kt,
...
const fs = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => gs(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(Nt, { children: [
...
function Eo({
  ...
  Mi();
  const h = P(null), f = () => Hs(h.current ?? void 0);
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        children: w.map(({ columnKey: y, label: x }, g) => {
          const C = `${l}-${y}`;
          return /* @__PURE__ */ u(Qr, { children: [
            /* @__PURE__ */ u(Yn, { "aria-labelledby": p ? C : void 0, children: [
              p && /* @__PURE__ */ a(cr, { id: C, children: x }),
              /* @__PURE__ */ a(zt, { children: fs(e.groups, e.items, y, t) })
            ] }),
...
const _p = Object.freeze([520, 420, 340]), vs = Jt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = ms(n, _p), l = Oi() ?? d, w = l >= Hr.MINIMUM;
...
const Np = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  be.Trigger,
  {
    ref: r,
    ...e,
    ...
    const w = new MutationObserver((f) => {
      f.forEach((y) => {
        if (y.attributeName === "data-state" && y.target instanceof HTMLElement) {
          const x = y.target.getAttribute("data-state");
          r(x === "open");
        }
      });
    });
...
function Dg({
  ...
  const l = Vp(
    ...
    n && n(y), o && o([y, ...r.filter((x) => x !== y)]), s && r.find((x) => x === y) && s([...r.filter((x) => x !== y)]), p(!1);
  }, f = (y, x) => {
    var C, E, T, k, z, S;
    const g = x !== y ? ((E = (C = t[y]) == null ? void 0 : C.uiNames) == null ? void 0 : E[x]) ?? ((k = (T = t[y]) == null ? void 0 : T.uiNames) == null ? void 0 : k.en) : void 0;
...
function Mg({
  ...
  const [i, c] = N(""), [d, l] = N(), w = P(null), p = P(null), h = P(/* @__PURE__ */ new Map()), [f, y] = N(), x = A(
    () => Bp(Object.entries(t)).map(([S, M]) => ({
      tag: S,
      info: M,
      keywords: [
        M.autonym,
...
function xf(t) {
  const e = A(() => qc(t).slice().sort().join(" "), [t]);
