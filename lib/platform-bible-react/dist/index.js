...
var Bt = (t, e, r) => Pi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Se, a as Fa, C as Ce, A as se, P as $e, b as Ye, B as U, d as Me, e as Ie, f as Ae, h as xe, i as ji, k as Li, j as Bi, E as Fi, l as Ua, r as re, m as Ui, n as ln, o as Qr, p as ta, L as Nt, D as Na, q as Ca, s as Ea, t as Ta, T as qt, u as Ka, v as Ht, w as Yt, x as Wt, y as dn, z as Ga, F as Ge, G as kr, H as ye, I as ke, J as _e, S as _r, K as tr, M as Ki, N as Er, O as He, Q as De, Z as We, R as Re, U as er, V as qa, W as Ha, X as Gr, Y as Ya, _ as wn, $ as Gi, a0 as qi, a1 as Hi, a2 as bo, a3 as un, a4 as ea, a5 as pn, a6 as Yi, a7 as Wi, a8 as Xi, a9 as Ji, aa as hn, ab as Zi, ac as sa, ad as xo, ae as ca, af as Qi, ag as ts, ah as es, ai as rs, aj as as, ak as Tr, al as Wa, am as os, an as ns } from "./resizable-Ds9c_6hc.js";
import { ao as Yh, ap as Wh, aq as Xh, ar as Jh, as as Zh, at as Qh, au as tg, av as eg, aw as rg, ax as ag, ay as og, az as ng, aA as ig, aB as sg, aC as cg, aD as lg, aE as dg, aF as wg, aG as ug, aH as pg, aI as hg, aJ as gg, aK as fg, aL as mg, aM as vg } from "./resizable-Ds9c_6hc.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as or, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as za, ChevronRight as Sa, ArrowLeft as is, ArrowRight as ss, ChevronDown as nr, BoldIcon as cs, ItalicIcon as ls, X as Xa, AtSign as gn, Pencil as ds, Trash2 as ws, ArrowUp as fn, MoreHorizontal as us, MailOpen as ps, Mail as hs, ChevronUp as gs, FilterIcon as fs, ArrowLeftIcon as ms, ChevronLeftIcon as vs, ChevronRightIcon as bs, ArrowRightIcon as xs, Copy as mn, Filter as ys, User as ks, Link as _s, CircleHelp as Ns, Undo as Cs, Redo as Es, SquareX as vn, FunctionSquare as bn, SquareSigma as xn, Ban as Ts, AlertCircle as Ra, CircleCheckIcon as zs, CircleXIcon as Ss, CircleHelpIcon as Rs, ArrowUpIcon as Ds, ArrowDownIcon as Os, ScrollText as $s, ChevronsUpDown as Ms, MenuIcon as Is, Menu as As, EllipsisVertical as Vs, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Ps, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as js, formatReplacementString as qe, sanitizeHtml as Ja, NumberFormat as Ls, formatBytes as Bs, getCurrentLocale as Fs, usfmMarkers as Pr, getFormatCallerFunction as Us, deepEqual as Ks, isString as Co, compareScrRefs as Da, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Gs, getLocalizeKeyForScrollGroupId as Eo, collectUsjMarkers as qs } from "platform-bible-utils";
import Rt, { useRef as F, useMemo as O, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Hs, useLayoutEffect as Qt, createContext as Za, useContext as yn, Component as Ys, createElement as To, Suspense as Ws, forwardRef as kn, useId as zo, Fragment as _n } from "react";
import { IconSelector as Nn, IconCheck as ra, IconChevronDown as Xs, IconChevronUp as Js, IconLayoutSidebar as Zs, IconLayoutSidebarRight as Qs, IconChevronRight as Cn, IconSearch as tc, IconLoader as ec, IconAlertOctagon as rc, IconAlertTriangle as ac, IconInfoCircle as oc, IconCircleCheck as nc } from "@tabler/icons-react";
import { RadioGroup as Oa, ToggleGroup as En, Avatar as Qa, Select as Ut, Checkbox as So, Slot as zr, Tabs as ce, Menubar as he, ContextMenu as Dt, Progress as Ro, Slider as Or, Switch as Do } from "radix-ui";
import { createEditor as Tn, $getRoot as Oe, $createParagraphNode as Sr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as zn, TextNode as Sn, $getPreviousSelection as ic, $isRangeSelection as ue, $caretFromPoint as sc, $getSiblingCaret as Rn, $getChildCaret as cc, $getAdjacentChildCaret as lc, $isChildCaret as dc, $normalizeCaret as wc, $setSelectionFromCaretRange as uc, $getCollapsedCaretRange as pc, $getCaretInDirection as Oo, $splitAtPointCaretNext as hc, $isTextPointCaret as gc, $findMatchingParent as Dn, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as fc, isHTMLElement as mc, CLEAR_EDITOR_COMMAND as On, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as vc, defineExtension as ae, safeCast as Xe, createState as bc, FORMAT_TEXT_COMMAND as $n, $isNodeSelection as Mn, COMMAND_PRIORITY_LOW as In, RootNode as xc, LineBreakNode as yc, TabNode as kc, $isEditorState as _c, createCommand as Nc, CLICK_COMMAND as Cc, isDOMNode as Ec, $getNodeFromDOMNode as Tc, $createNodeSelection as zc, $setSelection as Sc, $getEditor as Rc, DecoratorNode as $a, $getState as Dc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as Oc, $setState as $c, addClassNamesToElement as An, $create as Mc, $getNodeByKey as Ic, removeClassNamesFromElement as Ac, KEY_TAB_COMMAND as Vc, $isBlockElementNode as Pc, $createRangeSelection as jc, $normalizeSelection__EXPERIMENTAL as Lc, OUTDENT_CONTENT_COMMAND as Bc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Fc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Uc, $isParagraphNode as Kc, $isTextNode as Ma, SELECTION_CHANGE_COMMAND as Vn, $insertNodes as Gc } from "lexical";
import { HeadingNode as qc, QuoteNode as Hc, registerRichText as Yc } from "@lexical/rich-text";
...
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as nl, isInsertEmbedOpOfType as $r, Editorial as il } from "@eten-tech-foundation/platform-editor";
...
function ua({
  ...
  const B = re(), [z, I] = _(!1), [A, C] = _(""), [V, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, M] = _(
    void 0
  ), [W, Z] = _(void 0), [Ot, Tt] = _(!1), Pt = F(null), G = F(!1), tt = F(void 0), wt = F(void 0), at = F(void 0), mt = F(void 0), oe = F({}), ut = F({}), bt = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), $t = O(() => o ? o() : Ui, [o]), jt = O(() => ({
    [dt.OT]: $t.filter((q) => vt.isBookOT(q)),
    [dt.NT]: $t.filter((q) => vt.isBookNT(q)),
    [dt.DC]: $t.filter((q) => vt.isBookDC(q)),
    [dt.Extra]: $t.filter((q) => vt.extraBooks().includes(q))
  }), [$t]), Jt = O(() => Object.values(jt).flat(), [jt]), fe = O(() => {
    if (!V.trim()) return jt;
    const b = {
      [dt.OT]: [],
      [dt.NT]: [],
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = jt[rt].filter((Vt) => Ua(Vt, V, n));
    }), b;
  }, [jt, V, n]), R = O(
    () => gl(V, Jt, n),
    [V, Jt, n]
  ...
  const Ct = L(() => {
    if (R) {
      const b = R.chapterNum ?? 1, q = R.verseNum ?? 1;
      if (w && wa(R.book, b, q, w))
        return;
      bt({
        book: R.book,
        chapterNum: b,
    ...
    (b) => {
      const q = T ?? (R == null ? void 0 : R.book), rt = W ?? (R == null ? void 0 : R.chapterNum);
      !q || !rt || (bt({
        book: q,
        chapterNum: rt,
        verseNum: b
    ...
    (b) => {
      const q = y === "chapters" ? j : R == null ? void 0 : R.book;
      if (q) {
        if (l && l(q, b) > 1) {
          M(q), Z(b), J("verses"), C("");
          return;
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    () => pl(V),
    [V]
  ), ne = O(() => !l || !R || !R.chapterNum || !xt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, xt]), je = L(
    (b) => w ? Io(b, w) : !1,
    [w]
  ), ur = L(
    (b) => (q) => w ? hl(b, q, w) : !1,
    ...
    (b) => {
      var me, Te, Be;
      if (b.ctrlKey) return;
      const { isLetter: q, isDigit: rt } = Ao(b.key);
      ...
      if (y === "verses" && Vt) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            ft !== 0 && (Lt = ft > 1 ? ft - 1 : _t);
            break;
          case "ArrowRight":
            ft !== 0 && (Lt = ft < _t ? ft + 1 : 1);
            break;
          case "ArrowUp":
            Lt = ft === 0 ? _t : Math.max(1, ft - le);
            break;
          case "ArrowDown":
            Lt = ft === 0 ? 1 : Math.min(_t, ft + le);
            break;
          default:
            return;
        }
        Lt !== ft && (b.preventDefault(), b.stopPropagation(), C(
          `${Et} ${se[Et] || ""} ${kt}:${Lt}`
        ), setTimeout(() => {
      ...
      if ((y === "chapters" || y === "books" && R) && Vt) {
        ...
        switch (b.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            ft = kt === 0 ? _t : Math.max(1, kt - Lt);
            break;
          case "ArrowDown":
            ft = kt === 0 ? 1 : Math.min(_t, kt + Lt);
            break;
          default:
            return;
        }
    ...
    const { isLetter: q, isDigit: rt } = Ao(b.key);
    (q || rt) && (b.preventDefault(), K((me) => me + b.key), wt.current.focus(), Tt(!1));
  }, []);
  return Qt(() => {
    const b = setTimeout(() => {
      if (z && y === "books" && at.current && mt.current) {
        const q = at.current, rt = mt.current, Vt = rt.offsetTop, me = q.clientHeight, Te = rt.clientHeight, Be = Vt - me / 2 + Te / 2;
        q.scrollTo({
          top: Math.max(0, Be),
          behavior: "smooth"
        }), C(Un(t.book));
    ...
    if (y === "chapters" && j) {
      const b = j === t.book, q = b ? t.chapterNum : 1;
      C(
        `${j} ${se[j] || ""} ${q}`
      ), setTimeout(() => {
        if (at.current)
    ...
    if (y === "verses" && T && W !== void 0) {
      const b = T === t.book && W === t.chapterNum, q = b ? t.verseNum : 1;
      C(
        `${T} ${se[T] || ""} ${W}:${q}`
      ), setTimeout(() => {
        if (at.current)
    ...
    /* @__PURE__ */ a(
      Me,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: q } = b;
          z && Pt.current && q instanceof Node && Pt.current.contains(q) && (G.current = !0, it(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Ie,
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Q.map(
                  ({ onClick: b, disabled: q, title: rt, icon: Vt }) => /* @__PURE__ */ a(
                    U,
                    {
                      variant: "ghost",
                      size: "sm",
              ...
              !Ot && /* @__PURE__ */ u(Ae, { ref: at, children: [
                y === "books" && /* @__PURE__ */ u(ct, { children: [
                  !R && Object.entries(fe).map(([b, q]) => {
                    if (q.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: Kt(b), children: q.map((rt) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: rt,
                            onSelect: (Vt) => Ee(Vt),
                  ...
                  R && ne && R.chapterNum && l && /* @__PURE__ */ u(ct, { children: [
                  ...
                  R && !ne && rr(R.book) > 1 && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
function Xu({
  ...
  const w = pa(l, "%webView_bookSelector_currentBook%"), p = pa(l, "%webView_bookSelector_choose%"), g = pa(l, "%webView_bookSelector_chooseBooks%"), [h, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = qn ? Qt : H, Ir = { tag: to };
function xl({ initialConfig: t, children: e }) {
  const r = O(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = vl(null, o), w = Tn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
function $l(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: g } = n.getBoundingClientRect(), h = Rl(t, e);
    var f, x;
...
function Pl(t) {
  ...
  if (ue(e)) r = sc(e.focus, "next");
    ...
    r = r || cc(Oe(), "previous").getFlipped().insert(Sr());
  }
...
function jl(t, e, r) {
  ...
  return gc(o) && Hr(283), o.insert(t.isInline() ? Sr().append(t) : t), Oo(Rn(t.getLatest(), "next"), e.direction);
}
function Ll(t) {
  const e = Xt();
  if (!ue(e)) return !1;
...
let Yr, be = 0, Wr = 0, Ul = 0, Pa = 0, Lr = 0;
function Fo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ue(t, e) {
  Ft.call(this, void 0), this.x = t, this.s = void 0, this.g = Lr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Kl(t, e) {
  return new Ue(t, e);
}
...
function Gl(t) {
  ...
  Wn(this), nt = t, this.f &= -2, 8 & this.f && io(this), oa();
}
function Qe(t, e) {
...
Ft.prototype.brand = Bl, Ft.prototype.h = function() {
  return !0;
...
} }), Ue.prototype = new Ft(), Ue.prototype.h = function() {
...
const ga = bc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends $a {
  $config() {
    return this.config("decorator-text", { extends: $a, stateConfigs: [{ flat: !0, stateConfig: ga }] });
  }
  getFormat() {
    return Dc(this, ga);
  }
...
const ja = ae({ build: (t) => ti(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, La = 1, ri = 2, fa = 3, Ar = 4, Ze = 5, ma = 6, mr = 7;
function va(t) {
  return t.id === so;
}
function ai(t) {
...
class Xl {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, d, l) {
      return Object.assign(c, { config: d, id: fa, registerState: l });
...
const Zl = ae({ config: Xe({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [xc, Sn, yc, kc, zn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function qo() {
}
function Ql(t) {
  throw t;
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[Go];
    return r && (r.PACKAGE_VERSION !== ba && lt(292, r.PACKAGE_VERSION, ba), r instanceof ar || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      va(i) || lt(300, s, n || "[unknown]"), va(c = i) || lt(304, String(c.id), String(so)), i = Object.assign(c, { id: La }), o.state = i;
...
const td = /* @__PURE__ */ new Set(), Ho = ae({ build(t, e, r) {
...
}, dependencies: [ja], name: "@lexical/extension/NodeSelection" }), ed = Nc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends $a {
  static getType() {
...
ae({ dependencies: [ja, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ne(t.registerCommand(ed, (s) => {
    const c = Xt();
    if (!ue(c)) return !1;
    ...
    if (Ec(s.target)) {
      ...
      if (ad(c)) return function(d, l = !1) {
        ...
        let h;
        l && Mn(w) ? h = w : (h = zc(), Sc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function od(t, e, r = oi) {
  return Ne(t.registerCommand(Vc, (o) => {
    ...
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => Pc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Vl(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = jc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Lc(h), h.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Bc : Mo : Fc;
...
function Cd({
  ...
  const [e] = ge(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Nd(), d = () => {
  };
...
function gi({
  ...
  return /* @__PURE__ */ u(Ka, { children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
...
const $d = "verseText", Ju = Object.freeze([
...
function Zu({
  ...
  const [i, s] = _(Md), [c, d] = _(n), [l, w] = _(!1), p = F(void 0), g = F(null);
  H(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
...
function Zo({
    ...
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (z) => {
              z.stopPropagation(), l(!0), p(Od(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Pd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(jd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        ...
        B && /* @__PURE__ */ u(ye, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(us, {}) }) }),
...
function xi({
  ...
  const [y, J] = _(Qo), [j, Y] = _(), [T, M] = _(), W = o, [Z, Ot] = _(!1), [Tt, Pt] = _(!1), [G, tt] = _(!1), [wt, at] = _(!1), [mt, oe] = _(!1), [ut, bt] = _(D), [$t, jt] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
  ...
  const et = O(
    ...
    () => st === 1 ? et.singleReply : qe(et.multipleReplies, { count: st }),
    [st, et]
  ), zt = O(
    () => gt === 1 ? et.singleReply : qe(et.multipleReplies, { count: gt }),
    [gt, et]
  );
  H(() => {
    !o && Tt && ht && Pt(!1);
  ...
  const Kt = L(
    ...
    async (S) => {
      ...
      return ne && (xt !== void 0 && M(xt), At && P()), ne;
    },
    [P, y, p, j]
  );
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    j !== void 0 && (ee(y) || j !== T) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: qe(
                    ...
                    /* @__PURE__ */ u($e, { open: G, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ a(
                        U,
                        {
                          size: "icon",
...
), Bd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => Bd(Ja(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      !w && !g && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: z.map((T) => j(T) ? /* @__PURE__ */ a(qt, { delayDuration: 0, children: /* @__PURE__ */ u(Ht, { children: [
              /* @__PURE__ */ a(Yt, { asChild: !0, children: Y(T) }),
              /* @__PURE__ */ a(Wt, { children: D })
            ] }) }, T.value) : Y(T))
          }
        ),
        /* @__PURE__ */ a(qt, { delayDuration: 0, children: /* @__PURE__ */ u(Ht, { children: [
...
function Hd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = qd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
      ...
      children: C.map((M) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: M.type === "Conflict" ? /* @__PURE__ */ a(Hd, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(xi, { ...W })
          },
          M.id
        );
      })
...
function nw({
  ...
  const d = Ga(), l = en(n, "%undoButton_tooltip%"), w = en(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ka, { children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(
        U,
    ...
    e && /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(
        U,
        {
          "aria-label": w,
...
function iw({
  ...
  return H(() => {
    var d;
    const i = Ga(), s = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, c = (l) => {
      var p, g, h, f;
...
function cw({
  ...
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: sw(t, n, r) }) }) }),
...
function ww({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: lw(t, r) }) }) }),
      /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ a("p", { children: dw(t, r) }) })
    ] }) }),
...
function mp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [D, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, M] = _(!1), [W, Z] = _(), [Ot, Tt] = _(), [Pt, G] = _(), [tt, wt] = _(), at = F(null), mt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && $r("note", Q)) {
      ...
      let st = "custom";
      it === Ia ? st = "generated" : it === Aa ? st = "hidden" : it && (N(it), B(it)), x(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var ht;
  ...
  const Jt = () => {
    ...
    if (Q && $r("note", Q)) {
      ...
      z !== "x" && P === "x" ? pt == null || pt.forEach((gt) => fw(gt)) : z === "x" && P !== "x" && (pt == null || pt.forEach((gt) => mw(gt))), (ht = w.current) == null || ht.applyUpdate([Q, { delete: 1 }]);
    }
  }, Ct = (P) => {
    ...
    if (g.current && oe.length && P && P.rangeCount > 0) {
      ...
      Z(Q.left - et.left), Tt(Q.top - et.top), G(Q.height), M(!0);
    }
  }, [oe, g]);
  H(() => {
    const P = () => {
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
              /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(
                U,
                {
                  "aria-label": te,
...
const Nw = (t) => {
...
}, na = (t, e, r) => /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
  /* @__PURE__ */ u(
    Yt,
    {
  ...
  return e ? e[1] : "";
}, Ew = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ep = Object.freeze([
...
function Tp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), E = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), D = de(r, "%webView_inventory_filter_text%"), B = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = de(r, "%webView_inventory_no_results%"), [I, A] = _(!1), [C, V] = _("all"), [K, y] = _(""), [J, j] = _([]), Y = O(() => {
    const G = t ?? [];
  ...
  }, [I, Y]), M = O(() => T.length === 0 ? [] : Tw(T, C, K), [T, C, K]), W = O(() => {
    var wt, at;
    if (!I) return d;
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(sr, { onValueChange: (G) => Ot(G), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ u(Ht, { children: [
        ...
        /* @__PURE__ */ a(Wt, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const Sw = "16rem", Rw = "3rem", _i = Rt.createContext(void 0);
function ia() {
...
function Dw({
  ...
  const [d, l] = Rt.useState(t), w = e ?? d, p = Rt.useCallback(
    ...
    [r, w]
  ), g = Rt.useCallback(() => p((N) => !N), [p]), h = w ? "expanded" : "collapsed", v = re() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = Rt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Pw({
  ...
  const c = t ? zr.Root : "button", { state: d } = ia(), l = /* @__PURE__ */ a(
    c,
    {
    ...
    Ow,
    {
      ...
      children: /* @__PURE__ */ u(Mw, { children: [
        /* @__PURE__ */ u(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(Iw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Aw, { children: /* @__PURE__ */ a(
            Pw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const ze = "scrBook", Lw = "scrRef", Ke = "source", Bw = "details", Fw = "Scripture Reference", Uw = "Scripture Book", Ni = "Type", Kw = "Details";
function Gw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, sn = (t) => `${qw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Fp({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: D.map((C) => /* @__PURE__ */ a(ie, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function Kp({
  ...
  const D = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = St(s, "%webView_scope_selector_current_book%"), K = St(s, "%webView_scope_selector_choose_books%"), y = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), M = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Ot = St(s, "%webView_scope_selector_navigate%"), Tt = ($) => {
    if (!f) return;
  ...
  ], G = ($, X, Gt = !1) => /* @__PURE__ */ u(ct, { children: [
    $,
    X && !Gt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), tt = e ? Pt.filter(($) => e.includes($.value)) : Pt, wt = f ?? da, at = w ?? wt, mt = p ?? wt, oe = () => {
  }, ut = F(null), bt = F(null), $t = F(!1), jt = F(null), Jt = F(!1), [fe, R] = _(void 0), yt = F(!1), Ct = F(!1), Zt = F(null), Ee = L(($) => {
    if ($) {
    ...
    R((X) => X === "start" ? void 0 : X), yt.current && (yt.current = !1, requestAnimationFrame(() => {
      var Gt;
      const X = (Gt = ut.current) == null ? void 0 : Gt.querySelector("button");
      X == null || X.click();
    }));
  }, []), te = L(($) => {
    if ($) {
    ...
    [r, n, f, i]
  ), ot = tt.find(($) => $.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map(($) => $.toUpperCase()).join(", ") : t === "range" ? Gs(at, mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ot ? G(ot.label, ot.scrRefSuffix) : t, st = tt.filter(
    ($) => $.value !== "selectedBooks" && $.value !== "range"
  ), ht = tt.find(($) => $.value === "selectedBooks"), pt = tt.find(($) => $.value === "range"), [gt, Mt] = _(!1), [zt, Kt] = _(void 0), [It, Pe] = _(void 0), [S, At] = _(void 0), [xt, ne] = _(void 0), [je, ur] = _([]), pr = l === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Je = "tw:text-muted-foreground", Le = l === "dropdown" && zt === "range", b = Le ? At : P, rt = Le ? ne : h ? Q : oe, Vt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Lt, le] = _(null), Fe = 200, [Mi, Ii] = _(!1);
  H(() => {
    if (!Lt || typeof ResizeObserver > "u") return;
    const $ = new ResizeObserver(([X]) => {
      Ii(X.contentRect.width < Fe);
    });
    return $.observe(Lt), () => $.disconnect();
  }, [Lt]);
  const go = L(
    ($) => {
      Pe($), At(at), ne(mt), ur(n), Mt(!1), Kt($);
    },
    [at, mt, n]
  ), fo = L(() => {
    It !== void 0 && (It === "range" ? (S && (g == null || g(S)), xt && (h == null || h(xt))) : It === "selectedBooks" && i(je), et(It), Kt(void 0), Pe(void 0));
  }, [
    It,
    S,
    xt,
  ...
  }, []), vo = ($) => t === $ ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(ye, { open: gt, onOpenChange: Mt, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(sa, { container: Lt, children: [
              st.map(({ value: $, label: X, dropdownLabel: Gt, scrRefSuffix: fr, id: Ai }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: Te($),
              ...
              x && /* @__PURE__ */ u(ct, { children: [
                ...
                /* @__PURE__ */ a(
                  Ge,
                  {
                    ...
                    onSelect: ($) => {
                      var X, Gt;
                      if ($.preventDefault(), $t.current) {
                        $t.current = !1;
                        return;
                      }
                      Jt.current || (Gt = (X = bt.current) == null ? void 0 : X.querySelector("button")) == null || Gt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ua,
                          {
                            ...
                            onCloseAutoFocus: ($) => {
                              var X;
                              $.preventDefault(), (X = jt.current) == null || X.focus();
                            },
                            modal: !0,
        ...
        ao,
        {
          ...
          children: tt.map(({ value: $, label: X, scrRefSuffix: Gt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(qr, { className: "tw:me-2", value: $, id: fr }),
            /* @__PURE__ */ a(Nt, { htmlFor: fr, children: G(X, Gt) })
          ] }, fr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && Vt,
    l === "dropdown" && ht && /* @__PURE__ */ a(Na, { open: zt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ca,
      {
        ref: ft,
        onCloseAutoFocus: mo,
    ...
    l === "dropdown" && pt && /* @__PURE__ */ a(Na, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ca,
      {
        ref: kt,
        onCloseAutoFocus: mo,
...
function Ba({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Is, {}) }) }),
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(_n, { children: [
      /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(qt, { children: zi(e.groups, e.items, d, t) }) }),
...
const Zw = Rt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Trigger,
  {
    ref: r,
    ...e,
  ...
  if (sl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Qw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: We },
          children: /* @__PURE__ */ a(qt, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
