...
import { includes as ue, Section as M, getChaptersForBook as Ra, formatScrRef as Bt, getSectionForBook as ae, NumberFormat as Ta, formatBytes as Ea, getCurrentLocale as Va, getFormatCallerFunction as Ma, deepEqual as Qe, isString as Ve, compareScrRefs as Le, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
import { useReactTable as Gn, getFilteredRowModel as Da, getSortedRowModel as Fn, getPaginationRowModel as Ia, getCoreRowModel as Xn, flexRender as oe, getGroupedRowModel as Oa, getExpandedRowModel as Aa } from "@tanstack/react-table";
...
function Mi({
  ...
  const c = tt(), [p, g] = O(!1), [h, f] = O(""), [b, y] = O(""), [v, S] = O("books"), [N, C] = O(void 0), [j, W] = O(!1), B = nt(void 0), at = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), U = L(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
      ...
      if ((v === "chapters" || v === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            yt = ot === 0 ? Et : Math.max(1, ot - _n);
            break;
          case "ArrowDown":
            yt = ot === 0 ? 1 : Math.min(Et, ot + _n);
            break;
          default:
            return;
        }
...
function Mo({
  ...
  var S;
  const [u, c] = O([]), [p, g] = O([]), [h, f] = O({}), [b, y] = O({}), v = Gn({
    data: e,
    columns: t,
    getCoreRowModel: Xn(),
...
function Ji({
  ...
  const p = Nt(n, "%webView_inventory_all%"), g = Nt(n, "%webView_inventory_approved%"), h = Nt(n, "%webView_inventory_unapproved%"), f = Nt(n, "%webView_inventory_unknown%"), b = Nt(n, "%webView_inventory_scope_currentBook%"), y = Nt(n, "%webView_inventory_scope_chapter%"), v = Nt(n, "%webView_inventory_scope_verse%"), S = Nt(n, "%webView_inventory_filter_text%"), N = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, j] = O(!1), [W, B] = O("all"), [at, pt] = O(""), [_, E] = O([]), U = H(() => t.length === 0 ? [] : Zo(t, o, s), [t, o, s]), A = H(() => {
    if (C) return U;
    const T = [];
    return U.forEach((Z) => {
    ...
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r($t, { position: "item-aligned", children: /* @__PURE__ */ r(xo, { children: j.map((_) => /* @__PURE__ */ r(ut, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
...
Ts.displayName = F.CheckboxItem.displayName;
...
Es.displayName = F.RadioItem.displayName;
...
Vs.displayName = F.Label.displayName;
...
const uw = X.Root, mw = X.Trigger, hw = X.Group, fw = X.Portal, gw = X.Sub, bw = X.RadioGroup, Gs = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: o,
    className: d(
...
Gs.displayName = X.SubTrigger.displayName;
...
Fs.displayName = X.SubContent.displayName;
const Xs = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(X.Portal, { children: /* @__PURE__ */ r(
  X.Content,
  {
    ref: n,
    className: d(
...
Xs.displayName = X.Content.displayName;
...
Hs.displayName = X.Item.displayName;
...
Ys.displayName = X.CheckboxItem.displayName;
...
Ks.displayName = X.Label.displayName;
...
qs.displayName = X.Separator.displayName;
...
si.displayName = Fe.Root.displayName;
...
const pi = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = O(void 0), [w, u] = O(void 0), c = L(
    (h) => {
      i(h);
