...
var bt = (e, t, n) => us(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as rn, useRef as Q, useMemo as B, useState as M, useCallback as z, useLayoutEffect as Ht, createContext as En, useContext as gr, useEffect as q, Component as ms, createElement as Br, Suspense as hs, createRef as fs, Fragment as go } from "react";
import { Command as Nt } from "cmdk";
import { X as Ae, Search as bo, Check as Mt, Clock as jr, ChevronsLeft as zr, ChevronsRight as Fr, ChevronLeft as Zn, ChevronRight as Se, ArrowLeft as gs, ArrowRight as bs, Circle as Sn, ChevronDown as be, BoldIcon as vs, ItalicIcon as xs, UnderlineIcon as ys, StrikethroughIcon as Ns, AtSign as vo, Pencil as ks, Trash2 as _s, ArrowUp as xo, MoreHorizontal as yo, ChevronUp as Qn, FilterIcon as Cs, ArrowLeftIcon as Es, ChevronLeftIcon as Ss, ChevronRightIcon as Ts, ArrowRightIcon as Rs, Copy as No, Filter as Ds, User as Ms, Link as Os, CircleHelp as Is, ChevronsUpDown as ko, Star as As, SquareX as _o, FunctionSquare as Co, SquareSigma as Eo, AlertCircle as tr, CircleCheckIcon as Ps, CircleXIcon as Vs, CircleHelpIcon as $s, ArrowUpIcon as Ls, ArrowDownIcon as Bs, ArrowUpDownIcon as js, PanelLeft as zs, PanelRight as Fs, ScrollText as Gs, MenuIcon as Ks, Menu as Hs, EllipsisVertical as Xs, LoaderCircle as Us, GripVertical as Ys } from "lucide-react";
import { clsx as qs } from "clsx";
import { extendTailwindMerge as Js } from "tailwind-merge";
import * as Dt from "@radix-ui/react-dialog";
import { includes as pn, Section as H, getChaptersForBook as Ws, formatScrRef as me, getSectionForBook as Ue, formatRelativeDate as Zs, formatReplacementString as ue, sanitizeHtml as Qs, parseParatextHtml as Gr, hasCustomParatextTags as ti, NumberFormat as ei, formatBytes as ni, getCurrentLocale as ri, getFormatCallerFunction as oi, deepEqual as ai, isString as Kr, compareScrRefs as er, scrRefToBBBCCCVVV as Bn, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { createEditor as To, $getRoot as ee, $createParagraphNode as Tn, $getSelection as Xt, HISTORY_MERGE_TAG as br, ParagraphNode as Ro, TextNode as Do, $isTokenOrSegmented as si, $getCharacterOffsets as ii, $cloneWithPropertiesEphemeral as li, $findMatchingParent as ci, $isElementNode as he, CLEAR_EDITOR_COMMAND as Mo, COMMAND_PRIORITY_EDITOR as Oo, $isRangeSelection as Qe, shallowMergeConfig as wi, defineExtension as Yt, safeCast as on, RootNode as di, LineBreakNode as pi, TabNode as ui, $isEditorState as mi, createCommand as hi, CLICK_COMMAND as fi, isDOMNode as gi, $getNodeFromDOMNode as bi, $isNodeSelection as vi, $createNodeSelection as xi, $setSelection as yi, COMMAND_PRIORITY_LOW as Ni, DecoratorNode as ki, $create as _i, $getNodeByKey as Ci, INDENT_CONTENT_COMMAND as Hr, COMMAND_PRIORITY_CRITICAL as vr, KEY_TAB_COMMAND as Ei, $createRangeSelection as Si, $normalizeSelection__EXPERIMENTAL as Ti, OUTDENT_CONTENT_COMMAND as Ri, INSERT_TAB_COMMAND as Di, $isBlockElementNode as vn, $isDecoratorNode as Mi, $isParagraphNode as Oi, $isTextNode as xn, SELECTION_CHANGE_COMMAND as Io, FORMAT_TEXT_COMMAND as Ii, getRegisteredNode as Ai, isHTMLElement as Pi, isDocumentFragment as Xr, isDOMDocumentNode as Vi, ArtificialNode__DO_NOT_USE as Ao, $createLineBreakNode as Po, $isRootOrShadowRoot as $i, isBlockDomNode as Ur, isInlineDomNode as Yr, $insertNodes as Li } from "lexical";
...
import { GENERATOR_NOTE_CALLER as nr, HIDDEN_NOTE_CALLER as rr, getDefaultViewOptions as Zi, isInsertEmbedOpOfType as un, Editorial as Qi } from "@eten-tech-foundation/platform-editor";
...
const ol = Dt.Root, al = Dt.Portal, Fo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Dt.Overlay,
  {
    ref: n,
    className: f(
...
Fo.displayName = Dt.Overlay.displayName;
...
Go.displayName = Dt.Content.displayName;
...
Ho.displayName = Dt.Title.displayName;
...
sl.displayName = Dt.Description.displayName;
...
$e.displayName = Nt.Input.displayName;
...
Jt.displayName = Nt.List.displayName;
const sn = b.forwardRef((e, t) => /* @__PURE__ */ o(Nt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
sn.displayName = Nt.Empty.displayName;
...
Ut.displayName = Nt.Group.displayName;
...
Xo.displayName = Nt.Separator.displayName;
...
Lt.displayName = Nt.Item.displayName;
...
K(_t, "Original", new _t(Pt.Original)), K(_t, "Septuagint", new _t(Pt.Septuagint)), K(_t, "Vulgate", new _t(Pt.Vulgate)), K(_t, "English", new _t(Pt.English)), K(_t, "RussianProtestant", new _t(Pt.RussianProtestant)), K(_t, "RussianOrthodox", new _t(Pt.RussianOrthodox));
let we = _t;
function Jr(e, t) {
  const n = t[0];
...
const yt = class U {
    ...
    if (K(this, "firstChapter"), K(this, "lastChapter"), K(this, "lastVerse"), K(this, "hasSegmentsDefined"), K(this, "text"), K(this, "BBBCCCVVVS"), K(this, "longHashCode"), K(this, "versification"), K(this, "rtlMark", "‏"), K(this, "_bookNum", 0), K(this, "_chapterNum", 0), K(this, "_verseNum", 0), K(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        ...
        if (t != null && t instanceof U) {
          ...
          if (t == null) return;
          const s = t instanceof we ? t : U.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let w;
    return i && (w = new we(i)), n ? new U(n, r.toString(), l, w) : new U();
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new we(Pt[i]);
        } catch {
...
K(yt, "defaultVersification", we.English), K(yt, "verseRangeSeparator", "-"), K(yt, "verseSequenceIndicator", ","), K(yt, "verseRangeSeparators", [yt.verseRangeSeparator]), K(yt, "verseSequenceIndicators", [yt.verseSequenceIndicator]), K(yt, "chapterDigitShifter", 1e3), K(yt, "bookDigitShifter", yt.chapterDigitShifter * yt.chapterDigitShifter), K(yt, "bcvMaxValue", yt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
K(yt, "ValidStatusType", Qo);
...
const ea = Z.allBookIds.filter(
  (e) => !Z.isObsolete(Z.bookIdToNumber(e))
), fe = Object.fromEntries(
  ea.map((e) => [e, Z.bookIdToEnglishName(e)])
);
function Cr(e, t, n) {
...
const na = rn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Pe : "button", { className: f(xl({ variant: t, size: n, className: e })), ref: s, ...a })
);
...
function ir(e, t, n) {
  return `${e} ${fe[e]}${t ? ` ${_r(e, t)} ${Ee(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function yl({
  recentSearches: e,
...
function Zr({
  ...
  if (e)
    return /* @__PURE__ */ o(Ut, { children: /* @__PURE__ */ o("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Vt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Lt,
      {
        value: `${e} ${fe[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function bp({
  ...
  const c = dt(), [p, m] = M(!1), [h, u] = M(""), [g, k] = M(""), [v, N] = M("books"), [y, S] = M(void 0), [A, j] = M(!1), $ = Q(void 0), x = Q(void 0), E = Q(void 0), C = Q(void 0), _ = Q({}), I = z(
    (O) => {
      t(O), l && l(O);
    },
    [t, l]
  ), P = B(() => r ? r() : ea, [r]), F = B(() => ({
    [H.OT]: P.filter((Y) => Z.isBookOT(Y)),
    [H.NT]: P.filter((Y) => Z.isBookNT(Y)),
    [H.DC]: P.filter((Y) => Z.isBookDC(Y)),
    [H.Extra]: P.filter((Y) => Z.extraBooks().includes(Y))
  }), [P]), R = B(() => Object.values(F).flat(), [F]), G = B(() => {
    if (!g.trim()) return F;
    const O = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    (O) => {
      const Y = v === "chapters" ? y : D == null ? void 0 : D.book;
      Y && (I({
        book: Y,
        chapterNum: O,
        verseNum: 1
    ...
    [v, gt]
  ), { otLong: it, ntLong: mt, dcLong: ct, extraLong: ht } = {
    ...
    (O) => {
      if (O.ctrlKey) return;
      const { isLetter: Y, isDigit: at } = Wr(O.key);
      if (v === "chapters") {
        if (O.key === "Backspace") {
          O.preventDefault(), O.stopPropagation(), gt();
          return;
        }
        if (Y || at) {
          if (O.preventDefault(), O.stopPropagation(), N("books"), S(void 0), at && y) {
            const T = fe[y];
            k(`${T} ${O.key}`);
          } else
            k(O.key);
      ...
      if ((v === "chapters" || v === "books" && D) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        ...
        switch (O.key) {
          case "ArrowLeft":
            et !== 0 && (xt = et > 1 ? et - 1 : ft);
            break;
          case "ArrowRight":
            et !== 0 && (xt = et < ft ? et + 1 : 1);
            break;
          case "ArrowUp":
            xt = et === 0 ? ft : Math.max(1, et - dn);
            break;
          case "ArrowDown":
            xt = et === 0 ? 1 : Math.min(ft, et + dn);
            break;
          default:
            return;
        }
        xt !== et && (O.preventDefault(), O.stopPropagation(), u(ir(T, a, xt)), setTimeout(() => {
          const Fe = _.current[xt];
    ...
    const { isLetter: Y, isDigit: at } = Wr(O.key);
    (Y || at) && (O.preventDefault(), k((T) => T + O.key), x.current.focus(), j(!1));
  }, []);
  return Ht(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && E.current && C.current) {
        const Y = E.current, at = C.current, T = at.offsetTop, et = Y.clientHeight, ft = at.clientHeight, xt = T - et / 2 + ft / 2;
        Y.scrollTo({
          top: Math.max(0, xt),
          behavior: "smooth"
        }), u(ir(e.book));
    ...
    if (v === "chapters" && y) {
      ...
      setTimeout(() => {
        if (E.current)
          if (O) {
            const Y = _.current[e.chapterNum];
  ...
  }, [v, y, D, e.book, e.chapterNum]), /* @__PURE__ */ d(ae, { open: p, onOpenChange: L, children: [
    /* @__PURE__ */ o(se, { asChild: !0, children: /* @__PURE__ */ o(
      V,
      {
        ...
        children: /* @__PURE__ */ o("span", { className: "tw-truncate", children: Ct })
      }
    ) }),
      ...
      qt,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ut.map(({ onClick: O, disabled: Y, title: at, icon: T }) => /* @__PURE__ */ o(
              V,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ o(
              V,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ o(gs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(bs, { className: "tw-h-4 tw-w-4" })
              }
            ),
            y && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ee(y, a) })
          ] }),
          !A && /* @__PURE__ */ d(Jt, { ref: E, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !D && Object.entries(G).map(([O, Y]) => {
                if (Y.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Ut, { heading: cn(O), children: Y.map((at) => /* @__PURE__ */ o(
                      na,
                      {
                        bookId: at,
                        onSelect: (T) => pt(T),
                        section: Ue(at),
                        commandValue: `${at} ${fe[at]}`,
                        ref: at === e.book ? C : void 0,
                        localizedBookNames: a
                      },
                      at
                    )) }, O)
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(So.Root, { ref: n, className: f("pr-twp", Cl(), e), ...t }));
...
function lr({
  ...
  const [y, S] = M(!1), A = w ?? l, j = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], $ = (x, E) => {
    const C = l(x), _ = typeof x == "object" && "secondaryLabel" in x ? x.secondaryLabel : void 0, I = `${E ?? ""}${C}${_ ?? ""}`;
    return /* @__PURE__ */ d(
      Lt,
      {
        value: C,
    ...
    /* @__PURE__ */ o(
      Wt,
      {
        ...
        children: /* @__PURE__ */ d(qt, { children: [
          ...
          /* @__PURE__ */ o(sn, { children: h }),
          /* @__PURE__ */ o(Jt, { children: j(t) ? t.map((x) => /* @__PURE__ */ o(Ut, { heading: x.groupHeading, children: x.options.map((E) => $(E, x.groupHeading)) }, x.groupHeading)) : t.map((x) => $(x)) })
        ] })
      }
    )
  ] });
...
function yp({
  ...
  const p = zn(c, "%webView_bookSelector_currentBook%"), m = zn(c, "%webView_bookSelector_choose%"), h = zn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), k = (v) => {
    g(v), e(v);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(wt, { className: "tw-ms-1", children: h })
          ] }),
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = oa ? Ht : q, mn = { tag: br };
function Ml({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: w } = e, c = Rl(null, r), p = To({ editable: e.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Tn();
            u.append(g);
            const k = oa ? document.activeElement : null;
  ...
  }, []), o(ra.Provider, { value: n, children: t });
}
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function Il({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return Ol(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: w }) => {
      t && s.size === 0 && i.size === 0 || e && w.has(br) || l.isEmpty() || n(a, r, w);
    });
  }, [r, e, t, n]), null;
}
const Sr = {
  ...
  mark: "",
  markOverlap: ""
}, Tt = an.Provider, $t = an.Root, Gt = an.Trigger, Rt = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  an.Content,
  {
    ref: r,
    sideOffset: t,
...
Rt.displayName = an.Content.displayName;
const Tr = [
  ji,
  Ro,
  Do,
...
const Ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function Bl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function jl() {
  return function(e) {
    const [t] = Bt(), n = B(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = Q(r);
    return Ll(() => {
...
function zl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !si(t) && r !== null) {
    ...
    if (c || p) {
      const [m, h] = ii(e), u = l.is(w), g = t.is(i ? w : l), k = t.is(i ? l : w);
      let v, N = 0;
      u ? (N = m > h ? h : m, v = m > h ? m : h) : g ? (N = i ? h : m, v = void 0) : k && (N = 0, v = i ? m : h);
...
function de(e, t) {
  vt.call(this, void 0), this.x = e, this.s = void 0, this.g = gn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function Yl(e, t) {
  return new de(e, t);
}
...
function ql(e) {
  ...
  ca(this), J = e, this.f &= -2, 8 & this.f && Rr(this), Dn();
}
function Ce(e, t) {
...
vt.prototype.brand = Xl, vt.prototype.h = function() {
  ...
  if (this.g = gn, this.f |= 1, this.i > 0 && !la(this)) return this.f &= -2, !0;
  const e = J;
  try {
    no(this), J = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, wa(this), no(this), te++;
  const e = J;
  return J = this, ql.bind(this, e);
...
Yt({ build: (e, t, n) => Mn(t), config: on({ $onClear: da }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return re(() => pa(e, r.value));
} });
function Jl(e) {
...
const wr = Yt({ build: (e) => ua(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function ma(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = ma(n[a], r[a]);
    return e;
  }
  return t;
}
const Dr = 0, dr = 1, ha = 2, Gn = 3, hn = 4, _e = 5, Kn = 6, Ke = 7;
function Hn(e) {
  return e.id === Dr;
}
function fa(e) {
...
function Wl(e) {
  return function(t) {
    return t.id === dr;
  }(e) || tt(305, String(e.id), String(dr)), Object.assign(e, { id: ha });
}
...
class Ql {
  ...
  init(t) {
    ...
    const r = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...r, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, w, c) {
      return Object.assign(l, { config: w, id: Gn, registerState: c });
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Gn;
    }(t) || tt(314, String(t.id), String(Gn)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
...
class Je {
  ...
  static maybeFromEditor(t) {
    const n = t[oo];
    return n && (n.PACKAGE_VERSION !== Xn && tt(292, n.PACKAGE_VERSION, Xn), n instanceof Je || tt(293)), n;
  }
  static fromEditor(t) {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(To({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [oo]: this });
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Hn(s) || tt(300, i, a || "[unknown]"), Hn(l = s) || tt(304, String(l.id), String(Dr)), s = Object.assign(l, { id: dr }), r.state = s;
    ...
    for (const r of this.extensionNameMap.values()) Hn(r.state) && n(r);
...
const rc = /* @__PURE__ */ new Set(), so = Yt({ build(e, t, n) {
  const r = n.getDependency(wr).output, a = tn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ua(() => {
  }, () => re(() => {
...
Yt({ dependencies: [wr, so], name: "@lexical/extension/HorizontalRule", nodes: [Re], register(e, t, n) {
  ...
  return ne(e.registerCommand(fi, (i) => {
    if (gi(i.target)) {
      ...
      if (ac(l)) return function(w, c = !1) {
        ...
        let u;
        c && vi(p) ? u = p : (u = xi(), yi(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    Ul(() => {
      ...
      for (const [p, m] of i.entries()) if (m === "destroyed") c.delete(p), w = !0;
        ...
        h ? h.domNode.value = u : (w = !0, c.set(p, { domNode: tn(u), selectedSignal: r(p) }));
      }
...
function sc(e, t) {
  return ne(e.registerCommand(Ei, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Hl(i, (h) => vn(h) && h.canIndent() ? h : null).length > 0) return !0;
      const l = s.anchor, w = s.focus, c = w.isBefore(l) ? w : l, p = c.getNode(), m = Qr(p);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Si();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Ti(u), u.anchor.is(c)) return !0;
      }
      return !1;
...
Yt({ build: (e, t, n) => Mn(t), config: on({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => re(() => n.getOutput().disabled.value ? void 0 : va(e)) });
function dc(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Mr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
  ...
  return function(n, r) {
    ...
    return Mr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], p = o(r, { onError: (h) => n._onError(h), children: o(hs, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
...
const gc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function bc({ onClear: e }) {
  const [t] = Bt();
  return gc(() => pa(t, e), [t, e]), null;
}
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function vc({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: k, role: v = "textbox", spellCheck: N = !0, style: y, tabIndex: S, "data-testid": A, ...j }, $) {
  const [x, E] = M(e.isEditable()), C = z((I) => {
    I && I.ownerDocument && I.ownerDocument.defaultView ? e.setRootElement(I) : e.setRootElement(null);
  }, [e]), _ = B(() => /* @__PURE__ */ function(...I) {
    return (P) => {
      for (const F of I) typeof F == "function" ? F(P) : F != null && (F.current = P);
    };
  }($, C), [C, $]);
  return xa(() => (E(e.isEditable()), e.registerEditableListener((I) => {
    E(I);
  })), [e]), o("div", { "aria-activedescendant": x ? t : void 0, "aria-autocomplete": x ? n : "none", "aria-controls": x ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": x && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": p, "aria-owns": x ? m : void 0, "aria-readonly": !x || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: x, "data-testid": A, id: k, ref: _, role: v, spellCheck: N, style: y, tabIndex: S, ...j });
}
const xc = rn(vc);
function lo(e) {
  return e.getEditorState().read(ba(e.isComposing()));
...
function Cc({
  ...
  return /* @__PURE__ */ o(ya.Provider, { value: i, children: s });
}
function Na() {
  const e = gr(ya);
  if (!e)
...
function Ec() {
  const [e, t] = M(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(ol, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Go, { children: [
      /* @__PURE__ */ o(Ko, { children: /* @__PURE__ */ o(Ho, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Sc({
  ...
  const [t] = Bt(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Ec(), w = () => {
  };
...
Or.displayName = Rn.Root.displayName;
...
function Dc() {
  const { activeEditor: e } = Na(), [t, n] = M([]), r = z((a) => {
    if (Qe(a) || Hi(a)) {
      const s = [];
      co.forEach(({ format: i }) => {
...
function Ca(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], k = Ca(e, g, h, r);
    !a && he(t) && k && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Pi(p) || Xr(p)) && p.append(h), n.append(p), m) {
      const u = m.call(i, p);
...
function Sa(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  ...
  const w = function(g, k) {
    ...
    if (N !== void 0) for (const S of N) {
      const A = S(g);
      A !== null && (y === null || (y.priority || 0) <= (A.priority || 0)) && (y = A);
    }
  ...
  for (let g = 0; g < m.length; g++) h.push(...Sa(m[g], t, n, u, new Map(a), l));
  return p != null && (h = p(h)), Ur(e) && (h = Vc(e, h, u ? () => {
    const g = new Ao();
    return n.push(g), g;
  } : Tn)), l == null ? h.length > 0 ? i = i.concat(h) : Ur(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Yr(g.nextSibling) && Yr(g.previousSibling);
  }(e) && (i = i.concat(Po())) : he(l) && l.append(...h), i;
}
function Vc(e, t, n) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(V, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(Ae, {}) }) }),
          /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ o("p", { children: k }) })
        ] }) }),
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
      ...
      /* @__PURE__ */ o(se, { asChild: !0, children: /* @__PURE__ */ d(
        V,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ o("span", { children: Un(i !== void 0 ? i : "", r) })
          ]
        }
      ) }),
      /* @__PURE__ */ o(
        Wt,
        {
          ...
          children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: e.map((N) => /* @__PURE__ */ o(
            Lt,
            {
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ o("span", { children: Un(N, r) })
            },
            N || "unassigned"
          )) }) })
        }
...
const kp = Object.freeze([
  ...
  const a = Q(null), [s, i] = M(void 0), [l, w] = M(void 0), c = z(
    ...
    (u) => {
      var x;
      const g = u.target, k = (E) => E ? document.getElementById(E) : void 0, v = k(l), N = k(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const E = e.find((C) => C.id === l);
            E && c(E.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const C = E.findIndex((I) => I === g);
          if (C === -1) return;
          let _;
          u.key === "ArrowDown" ? _ = Math.min(C + 1, E.length - 1) : _ = Math.max(C - 1, 0), _ !== C && (u.preventDefault(), u.stopPropagation(), (x = E[_]) == null || x.focus());
          return;
        }
        return;
      }
      const A = e.findIndex((E) => E.id === s);
      let j = A;
      switch (u.key) {
        case "ArrowDown":
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: f("pr-twp", Fc({ variant: t }), e), ...n })
);
...
const Hc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
function Ne({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Ar.Provider, { value: n, children: /* @__PURE__ */ o(nt.Root, { ...t }) });
}
const Aa = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = It();
  return /* @__PURE__ */ d(
    nt.SubTrigger,
    {
...
const Kt = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    nt.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
});
Kt.displayName = nt.CheckboxItem.displayName;
const Va = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = It();
  return /* @__PURE__ */ d(
    nt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(Sn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
...
function wo({
  ...
  const v = z(() => {
    ...
    const x = new Date(e.date), E = Zs(
      x,
      n["%comment_date_today%"],
      n["%comment_date_yesterday%"]
    ), C = x.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [e.date, n]), S = B(() => e.user, [e.user]), A = B(
    ...
    if (r && c)
      return /* @__PURE__ */ d(lt, { children: [
        !ti(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              h(!0), g($c(Gr(e.contents))), w == null || w(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ma, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Oa, { className: "tw-text-xs tw-font-medium", children: A }) }),
        ...
        $ && /* @__PURE__ */ d(Ne, { children: [
          /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(yo, {}) }) }),
          /* @__PURE__ */ o(ie, { align: "end", children: $ })
        ] })
      ]
    }
  );
...
function Zc({
  ...
  const [y, S] = M(po), [A, j] = M(!1), [$, x] = M(!1), [E, C] = M(!1), [_, I] = M(!1), [P, F] = M(!1), [R, G] = M(void 0), [D, X] = M(!1), [pt, jt] = M(!1), [zt, ut] = M(/* @__PURE__ */ new Map());
  q(() => {
    let T = !0;
    if (!r) {
      X(!1), jt(!1), ut(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const ft = k ? await k(w) : !1;
      if (!T) return;
      const xt = v ? await v(w) : !1;
      T && (X(ft), jt(xt));
    })(), () => {
      T = !1;
    };
  }, [r, w, k, v]);
  const gt = B(() => t.filter((T) => !T.deleted), [t]);
  q(() => {
    let T = !0;
    if (!r || !N) {
      ut(/* @__PURE__ */ new Map());
  ...
  const L = B(() => gt[0], [gt]), it = Q(null), mt = Q(void 0), ct = z(() => {
    var T;
  ...
  const ht = B(
  ...
  }, [s, n]), le = B(() => gt.slice(1), [gt]), Ct = B(() => le.length ?? 0, [le.length]), wn = B(() => Ct > 0, [Ct]), $n = B(() => E || Ct <= 2 ? le : le.slice(-2), [le, Ct, E]), ke = B(() => E || Ct <= 2 ? 0 : Ct - 2, [Ct, E]), Ln = B(
    () => Ct === 1 ? ht.singleReply : ue(ht.multipleReplies, { count: Ct }),
    [Ct, ht]
  ), O = B(
    () => ke === 1 ? ht.singleReply : ue(ht.multipleReplies, { count: ke }),
    [ke, ht]
  ), Y = z(async () => {
    const T = St(y) ? kn(y) : void 0;
    if (R !== void 0) {
      await p({
        threadId: w,
        contents: T,
    ...
    T && await p({ threadId: w, contents: T }) && ct();
  }, [ct, y, p, R, w]), at = z(
    async (T) => {
      const et = St(y) ? kn(y) : void 0, ft = await p({
        ...T,
        contents: et,
        assignedUser: R ?? T.assignedUser
      });
      return ft && et && ct(), ft && R !== void 0 && G(void 0), ft;
    },
    [ct, y, p, R]
  );
  return /* @__PURE__ */ o(
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
              ...
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("span", { className: e, children: [
                    L.contextBefore,
                    /* @__PURE__ */ o("span", { className: "tw-font-bold", children: L.selectedText }),
                    L.contextAfter
                  ] })
                ]
              }
            ...
            $ && /* @__PURE__ */ o(
              V,
              {
                ...
                size: "icon",
                onClick: (T) => {
                  T.stopPropagation(), j(!A);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": A ? "Collapse text" : "Expand text",
                children: A ? /* @__PURE__ */ o(Qn, {}) : /* @__PURE__ */ o(be, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
          ...
          r && /* @__PURE__ */ d(lt, { children: [
            ke > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (T) => {
                  (T.key === "Enter" || T.key === " ") && (T.preventDefault(), T.stopPropagation(), C(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(Me, {}) }),
            ...
            $n.map((T) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              wo,
              {
                ...
                handleDeleteComment: h,
                onEditingChange: I,
                canEditOrDelete: zt.get(T.id) ?? !1
              }
            ) }, T.id)),
            g !== !1 && (!_ || St(y)) && /* @__PURE__ */ d(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (T) => {
                  T.key === "Enter" && T.shiftKey && (T.preventDefault(), T.stopPropagation(), (St(y) || R !== void 0) && Y());
                },
                onKeyDown: (T) => {
                  Ir(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    Nn,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ d(ae, { open: P, onOpenChange: F, children: [
                      /* @__PURE__ */ o(se, { asChild: !0, children: /* @__PURE__ */ o(
                        V,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ o(
                        Wt,
                        {
                          ...
                          align: "end",
                          onKeyDown: (T) => {
                            T.key === "Escape" && (T.stopPropagation(), F(!1));
                          },
...
function Cp({
  ...
  const y = n.filter(
    ...
    [g]
  ), { listboxRef: $, activeId: x, handleKeyDown: E } = zc({
    options: S,
    onOptionSelect: A
  }), C = z(
    (_) => {
      _.key === "Escape" ? (v(void 0), g == null || g(void 0), _.preventDefault(), _.stopPropagation()) : E(_);
    },
    [E, g]
  );
  return /* @__PURE__ */ o(
...
function Qc({ table: e }) {
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Xi, { asChild: !0, children: /* @__PURE__ */ d(V, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Oe = st.Root, tw = st.Group, Ie = st.Value, ew = oe(
  ...
  return /* @__PURE__ */ d(
    st.Trigger,
    {
      className: f(ew({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
        t,
        /* @__PURE__ */ o(st.Icon, { asChild: !0, children: /* @__PURE__ */ o(be, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
xe.displayName = st.Trigger.displayName;
...
$a.displayName = st.ScrollUpButton.displayName;
...
La.displayName = st.ScrollDownButton.displayName;
...
ye.displayName = st.Content.displayName;
...
nw.displayName = st.Label.displayName;
const Et = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  st.Item,
  {
    ref: r,
    className: f(
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(st.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ o(st.ItemText, { children: t })
    ]
  }
));
Et.displayName = st.Item.displayName;
...
rw.displayName = st.Separator.displayName;
function ow({ table: e }) {
      ...
      /* @__PURE__ */ d(
        Oe,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ o(ye, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(Et, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const An = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", e), ...t }));
...
function dw({
  ...
  var $;
  const [p, m] = M([]), [h, u] = M([]), [g, k] = M({}), [v, N] = M({}), y = B(() => t ?? [], [t]), S = Bo({
    data: y,
    columns: e,
    getCoreRowModel: zo(),
  ...
  let j;
  return w ? j = Array.from({ length: 10 }).map((C, _) => `skeleton-row-${_}`).map((C) => /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(ge, { colSpan: A.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : (($ = S.getRowModel().rows) == null ? void 0 : $.length) > 0 ? j = S.getRowModel().rows.map((x) => /* @__PURE__ */ o(
    Ft,
    {
      onClick: () => i(x, S),
      "data-state": x.getIsSelected() && "selected",
      children: x.getVisibleCells().map((E) => /* @__PURE__ */ o(ge, { children: Ye(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    x.id
    ...
    /* @__PURE__ */ d(On, { stickyHeader: s, children: [
      /* @__PURE__ */ o(In, { stickyHeader: s, children: S.getHeaderGroups().map((x) => /* @__PURE__ */ o(Ft, { children: x.headers.map((E) => /* @__PURE__ */ o(nn, { children: E.isPlaceholder ? void 0 : Ye(E.column.columnDef.header, E.getContext()) }, E.id)) }, x.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(V, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(No, {}) })
        ] }),
...
function Tp({
  ...
  return /* @__PURE__ */ d(ae, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ d(Wt, { id: s, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function Rp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ d(V, { variant: "default", children: [
    ...
    /* @__PURE__ */ o(ie, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Ia, { children: c.itemType === 0 ? /* @__PURE__ */ o(lt, { children: c.items.map((m, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Kt,
        {
          checked: r[p][h],
        ...
        Jc,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Va, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ o(je, {})
    ] }, c.label)) })
...
function fw({
  ...
  const [N, y] = M(!1), S = z(
    (_) => {
      var P;
      const I = (P = e.find((F) => F.label === _)) == null ? void 0 : P.value;
      I && n(
    ...
    if (!h) return e;
    const _ = e.filter((P) => P.starred).sort((P, F) => P.label.localeCompare(F.label)), I = e.filter((P) => !P.starred).sort((P, F) => {
      const R = t.includes(P.value), G = t.includes(F.value);
      return R && !G ? -1 : !R && G ? 1 : P.label.localeCompare(F.label);
    });
    return [..._, ...I];
  }, [e, t, h]), $ = () => {
    n(e.map((_) => _.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(ae, { open: E, onOpenChange: p ?? y, children: [
    /* @__PURE__ */ o(se, { asChild: !0, children: /* @__PURE__ */ d(
      V,
      {
        variant: k,
    ...
    /* @__PURE__ */ o(Wt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(qt, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ o(V, { variant: "ghost", size: "sm", onClick: $, children: s }),
        /* @__PURE__ */ o(V, { variant: "ghost", size: "sm", onClick: x, children: i })
      ] }),
        ...
        /* @__PURE__ */ o(Ut, { children: j.map((_) => /* @__PURE__ */ d(
          Lt,
          {
            ...
            children: [
              ...
              _.starred && /* @__PURE__ */ o(As, { className: "tw-h-4 tw-w-4" }),
...
function bw({
  ...
  const s = Q(null), i = Q(null), l = Q(!1), [w, c] = M(e), [p, m] = M(n), [h, u] = M(!1);
  q(() => {
    c(e);
  }, [e]), q(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var N, y, S, A;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = s.current) == null || N.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((y = i.current) == null || y.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((S = s.current) == null ? void 0 : S.selectionStart) === 0 && ((A = i.current) == null || A.focus(), l.current = !1), w === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ne, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o(V, { variant: "outline", className: "tw-h-6", children: gw(e, a, n) }) }) }),
          ...
          /* @__PURE__ */ o(
            Kt,
            {
              ...
              children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
                ...
                /* @__PURE__ */ o("span", { className: "tw-w-10 tw-text-center", children: nr })
              ] })
            }
          ),
          /* @__PURE__ */ o(
...
function yw({
  ...
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ o(Bi, { asChild: !0, children: /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o(V, { variant: "outline", className: "tw-h-6", children: vw(e, n) }) }) }),
      /* @__PURE__ */ o(Rt, { children: /* @__PURE__ */ o("p", { children: xw(e, n) }) })
    ] }) }),
...
function Ip({
  ...
  const w = Q(null), c = fs(), [p, m] = M("generated"), [h, u] = M("*"), [g, k] = M("f"), [v, N] = M(!1), y = B(
    () => ({
      ...i,
  ...
  q(() => {
    ...
    if (E && un("note", E)) {
      const I = (C = E.insert.note) == null ? void 0 : C.caller;
      let P = "custom";
      I === nr ? P = "generated" : I === rr ? P = "hidden" : I && u(I), m(P), k(((_ = E.insert.note) == null ? void 0 : _.style) ?? "f"), x = setTimeout(() => {
        var F;
        (F = w.current) == null || F.applyUpdate([{ delete: 1 }, E]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const S = z(() => {
    var E, C;
    const x = (C = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : C.at(0);
    x && un("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = h : x.insert.note.caller = p === "generated" ? nr : rr), n([x]));
  }, [p, h, n]), A = () => {
    var E;
    ...
    var C, _, I, P, F;
    k(x);
    const E = (_ = (C = w.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : _.at(0);
    if (E && un("note", E)) {
      E.insert.note && (E.insert.note.style = x);
      const R = (P = (I = E.insert.note) == null ? void 0 : I.contents) == null ? void 0 : P.ops;
      g !== "x" && x === "x" ? R == null || R.forEach((G) => Nw(G)) : g === "x" && x !== "x" && (R == null || R.forEach((G) => kw(G))), (F = w.current) == null || F.applyUpdate([{ delete: 1 }, E]);
    }
  }, $ = () => {
    var E, C, _, I, P;
    const x = (C = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : C.at(0);
    if (x && un("note", x)) {
      const F = (_ = x.insert.note) == null ? void 0 : _.style, R = (P = (I = x.insert.note) == null ? void 0 : I.contents) == null ? void 0 : P.ops;
      F || N(!1), N(
        F === "x" ? !!(R != null && R.every((G) => {
          var X, pt;
          if (!((X = G.attributes) != null && X.char)) return !0;
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(V, { onClick: r, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(Ae, {}) }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
            /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(V, { onClick: A, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(No, {}) }) }),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ d(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ o(tr, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
...
function Ew({
  ...
  /* @__PURE__ */ d("span", { className: f("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    Pr(e.marker, [i], r, !1),
    " "
  ] }), h = t === "horizontal" ? "horizontal" : "vertical", u = r ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", k = f(h, u);
  return /* @__PURE__ */ d(lt, { children: [
    /* @__PURE__ */ d("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", k), children: [
      w,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", k), children: m }),
    /* @__PURE__ */ o(
      "div",
      {
        className: f(
...
function Pp({
  ...
  const p = w ?? oi(n, void 0), m = (y, S) => {
    c == null || c(y, S, a);
  }, h = s ? n.findIndex((y) => y === s) : -1, [u, g] = M(h), k = (y, S, A) => {
    if (n.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), c == null || c(S, A, a);
          break;
      }
  }, v = (y) => {
    if (n.length)
...
const Pn = (e) => e === "asc" ? /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(js, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Vp = (e) => ({
  accessorKey: "item",
  ...
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ d(V, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Pn(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ d(V, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    e,
    Pn(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
  ...
  const a = Kr(r.key) ? r.key : r.key[0];
  return {
    items: Kr(r.key) ? [r.key] : r.key,
    count: r.count,
    status: r.status || Dw(a, t, n),
...
function Gp({
  ...
  const u = At(n, "%webView_inventory_all%"), g = At(n, "%webView_inventory_approved%"), k = At(n, "%webView_inventory_unapproved%"), v = At(n, "%webView_inventory_unknown%"), N = At(n, "%webView_inventory_scope_currentBook%"), y = At(n, "%webView_inventory_scope_chapter%"), S = At(n, "%webView_inventory_scope_verse%"), A = At(n, "%webView_inventory_filter_text%"), j = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), $ = At(n, "%webView_inventory_no_results%"), [x, E] = M(!1), [C, _] = M("all"), [I, P] = M(""), [F, R] = M([]), G = B(() => {
    const L = e ?? [];
    ...
    const L = [];
    return G.forEach((it) => {
      const mt = it.items[0], ct = L.find(
        (ht) => ht.items[0] === mt
      );
      ct ? (ct.count += it.count, ct.occurrences = ct.occurrences.concat(it.occurrences)) : L.push({
        items: [mt],
        count: it.count,
  ...
  }, [x, G]), X = B(() => D.length === 0 ? [] : Mw(D, C, I), [D, C, I]), pt = B(() => {
    var mt, ct;
    if (!x) return w;
    const L = (mt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : mt.length;
    if (!L) return w;
    const it = [];
    for (let ht = 0; ht < L; ht++)
      it.push(
        Rw(
          ((ct = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ct[ht]) || "Additional Item",
          ht + 1
        )
      );
    return [...it, ...w];
  ...
  q(() => {
    X.length === 0 ? R([]) : X.length === 1 && R(X[0].items);
  }, [X]);
  const jt = (L, it) => {
    it.setRowSelection(() => {
      const ct = {};
      return ct[L.index] = !0, ct;
    });
    const mt = L.original.items;
    R(mt), h && mt.length > 0 && h(mt[0]);
  }, zt = (L) => {
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        Oe,
        {
          onValueChange: (L) => ut(L),
          defaultValue: C,
          children: [
            /* @__PURE__ */ o(xe, { className: "tw-m-1", children: /* @__PURE__ */ o(Ie, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ d(ye, { children: [
              /* @__PURE__ */ o(Et, { value: "all", children: u }),
              /* @__PURE__ */ o(Et, { value: "approved", children: g }),
              /* @__PURE__ */ o(Et, { value: "unapproved", children: k }),
              /* @__PURE__ */ o(Et, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Oe, { onValueChange: (L) => zt(L), defaultValue: i, children: [
        /* @__PURE__ */ o(xe, { className: "tw-m-1", children: /* @__PURE__ */ o(Ie, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ye, { children: [
          /* @__PURE__ */ o(Et, { value: "book", children: N }),
          /* @__PURE__ */ o(Et, { value: "chapter", children: y }),
          /* @__PURE__ */ o(Et, { value: "verse", children: S })
        ] })
      ] }),
      /* @__PURE__ */ o(
        ze,
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(wt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? j })
      ] })
    ] }),
    ...
    gt.length > 0 && /* @__PURE__ */ o("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ o(
      Tw,
      {
        classNameForText: m,
        occurrenceData: gt,
      ...
      /* @__PURE__ */ o(Ut, { children: a.map((s) => /* @__PURE__ */ d(
        Lt,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ o(Uo, { className: "tw-font-sans", children: s.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const Iw = "16rem", Aw = "3rem", ja = b.createContext(void 0);
function Vn() {
...
const za = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(e), m = t ?? c, h = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => h((S) => !S), [h]), g = m ? "expanded" : "collapsed", N = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ o(ja.Provider, { value: y, children: /* @__PURE__ */ o(Tt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Fa = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Vn();
...
const mr = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Pe : "div",
  {
    ref: r,
  ...
  ({
    ...
    const w = e ? Pe : "button", { state: c } = Vn(), p = /* @__PURE__ */ o(
      w,
      {
        ...
        "data-size": r,
        "data-active": t,
        className: f(Fw({ variant: n, size: r }), s),
        ...i
      }
    );
...
const Hw = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      ...n,
      children: [
        t && /* @__PURE__ */ o(pr, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ o(
          pr,
          {
    ...
    Fa,
    {
      ...
      children: /* @__PURE__ */ d(Ka, { children: [
        /* @__PURE__ */ d(ur, { children: [
          /* @__PURE__ */ o(mr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(hr, { children: /* @__PURE__ */ o(Ha, { children: Object.entries(t).map(([h, u]) => /* @__PURE__ */ o(Xa, { children: /* @__PURE__ */ o(
            Ua,
            {
              onClick: () => c(h),
              isActive: m(h),
        ...
        /* @__PURE__ */ d(ur, { children: [
          /* @__PURE__ */ o(mr, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ o(hr, { className: "tw-pl-3", children: /* @__PURE__ */ o(
            lr,
            {
              buttonVariant: "ghost",
    ...
    /* @__PURE__ */ d(
      za,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Ga, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const Qt = "scrBook", Jw = "scrRef", pe = "source", Ww = "details", Zw = "Scripture Reference", Qw = "Scripture Book", Ya = "Type", td = "Details";
function ed(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      sortingFn: (r, a) => er(r.original.start, a.original.start),
      enableGrouping: !0
    },
    {
...
const nd = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || er(e.start, e.end) === 0 ? `${Bn(e.start)}+${t}` : `${Bn(e.start)}+${t}-${Bn(e.end)}+${n}`;
...
function Up({
  ...
  const [c, p] = M([]), [m, h] = M([{ id: Qt, desc: !1 }]), [u, g] = M({}), k = B(
    () => e.flatMap((C) => C.data.map((_) => ({
      ..._,
      source: C.source
    }))),
    [e]
  ...
  q(() => {
    if (l) {
      const C = N.getSelectedRowModel().rowsById, _ = Object.keys(C);
      if (_.length === 1) {
        const I = k.find((P) => ho(P) === _[0]) || void 0;
        I && l(I);
      }
    }
  }, [u, k, l, N]);
  const y = a ?? Qw, S = s ?? Ya, A = [
    ...
    !C.getIsGrouped() && !C.getIsSelected() && C.getToggleSelectedHandler()(_);
  }, x = (C, _) => C.getIsGrouped() ? "" : f("banded-row", _ % 2 === 0 ? "even" : "odd"), E = (C, _, I) => {
    if (!((C == null ? void 0 : C.length) === 0 || _.depth < I.column.getGroupedIndex())) {
      if (_.getIsGrouped())
        switch (_.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ d(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ye, { position: "item-aligned", children: /* @__PURE__ */ o(tw, { children: A.map((C) => /* @__PURE__ */ o(Et, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(On, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(In, { children: N.getHeaderGroups().map((C) => /* @__PURE__ */ o(Ft, { children: C.headers.filter((_) => _.column.columnDef.header).map((_) => (
      ...
      /* @__PURE__ */ o(An, { children: N.getRowModel().rows.map((C, _) => {
        const I = dt();
        return /* @__PURE__ */ o(
          Ft,
          {
            ...
            children: C.getVisibleCells().map((P) => {
              if (!(P.getIsPlaceholder() || P.column.columnDef.enableGrouping && !P.getIsGrouped() && (P.column.columnDef.id !== pe || !n)))
                return /* @__PURE__ */ o(
                  ge,
                  {
                    className: f(
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      V,
                      {
                        ...
                        type: "button",
                        children: [
                          C.getIsExpanded() && /* @__PURE__ */ o(be, {}),
                          !C.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ o(Se, {}) : /* @__PURE__ */ o(Zn, {})),
                          " ",
...
}), qa = (e, t, n) => Lr(e, t).every((r) => n.includes(r));
function rd({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = Lr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], w = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    V,
    {
      variant: "outline",
...
function od({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], w = r["%webView_book_selector_select_all%"], c = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], m = r["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: k } = {
  ...
  }, [v, N] = M(!1), [y, S] = M(""), A = Q(void 0), j = Q(!1);
  if (e.length !== Z.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const $ = B(() => Z.allBookIds.filter(
    ...
    (R, G = !1) => {
      if (!G || !A.current) {
        n(
          t.includes(R) ? t.filter((ut) => ut !== R) : [...t, R]
        ), A.current = R;
        return;
      }
      const D = $.findIndex((ut) => ut === A.current), X = $.findIndex((ut) => ut === R);
      if (D === -1 || X === -1) return;
      const [pt, jt] = [
        Math.min(D, X),
        Math.max(D, X)
      ], zt = $.slice(pt, jt + 1).map((ut) => ut);
      n(
        t.includes(R) ? t.filter((ut) => !zt.includes(ut)) : [.../* @__PURE__ */ new Set([...t, ...zt])]
      );
    },
    [t, n, $]
  ), C = (R) => {
    E(R, j.current), j.current = !1;
  }, _ = (R, G) => {
    R.preventDefault(), E(G, R.shiftKey);
  }, I = z(
    (R) => {
      const G = Lr($, R).map((D) => D);
      n(
        qa($, R, t) ? t.filter((D) => !G.includes(D)) : [.../* @__PURE__ */ new Set([...t, ...G])]
      );
    },
    [t, n, $]
  ), P = () => {
            ...
            qt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(V, { variant: "ghost", size: "sm", onClick: P, children: w }),
                  /* @__PURE__ */ o(V, { variant: "ghost", size: "sm", onClick: F, children: c })
                ] }),
                /* @__PURE__ */ d(Jt, { children: [
                  /* @__PURE__ */ o(sn, { children: p }),
                  Object.values(H).map((R, G) => {
                    const D = x[R];
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(go, { children: [
                        /* @__PURE__ */ o(
                          Ut,
                          {
                            heading: ta(R, h, u, g, k),
                            children: D.map((X) => /* @__PURE__ */ o(
                              na,
                              {
                                bookId: X,
                                isSelected: t.includes(X),
                                onSelect: () => C(X),
                                onMouseDown: (pt) => _(pt, X),
                                section: Ue(X),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: ir(X, a),
                        ...
                        G < Object.values(H).length - 1 && /* @__PURE__ */ o(Xo, {})
                      ] }, R);
                  })
                ] })
              ]
...
function qp({
  ...
  const c = ce(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = ce(i, "%webView_scope_selector_current_book%"), u = ce(i, "%webView_scope_selector_choose_books%"), g = ce(i, "%webView_scope_selector_scope%"), k = ce(i, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Er,
        {
          ...
          children: N.map(({ value: y, label: S, id: A }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(yn, { className: "tw-me-2", value: y, id: A }),
...
function Jp({
  ...
  return /* @__PURE__ */ d(
    Oe,
    {
      ...
      children: [
        /* @__PURE__ */ o(xe, { size: a, className: f("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          Ie,
          {
            placeholder: l[W(t)] ?? t
          }
        ...
        /* @__PURE__ */ o(
          ye,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((c) => /* @__PURE__ */ o(Et, { value: `${c}`, children: l[W(c)] }, `${c}`))
          }
        )
      ]
    }
...
const Wa = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  /* @__PURE__ */ o(Gt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ o(Aa, { children: l.label }),
    /* @__PURE__ */ o(Yc, { children: /* @__PURE__ */ o(Pa, { children: Wa(
      e,
      t,
      Ja(e, l.id),
      r
...
function fr({
  ...
  return /* @__PURE__ */ d(Ne, { variant: s, children: [
    /* @__PURE__ */ o(Be, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(V, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Ks, {}) }) }),
    /* @__PURE__ */ o(ie, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(go, { children: [
      /* @__PURE__ */ o(Ia, { children: /* @__PURE__ */ o(Tt, { children: Wa(t.groups, t.items, w, e) }) }),
...
function eu({
  ...
  return /* @__PURE__ */ o(Za, { className: "tw-pointer-events-none", id: n, children: t && /* @__PURE__ */ o(
    fr,
    {
      onSelectMenuItem: e,
      menuData: t,
...
Qa.displayName = kt.List.displayName;
...
ts.displayName = kt.List.displayName;
...
)), es = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  kt.Content,
  {
    ref: n,
    className: f(
...
es.displayName = kt.Content.displayName;
function nu({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Qa, { children: [
      /* @__PURE__ */ o(ts, { children: e.map((l) => /* @__PURE__ */ o(ad, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ o(es, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function sd({ ...e }) {
...
const ns = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  const a = b.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ o(Ar.Provider, { value: a, children: /* @__PURE__ */ o(
    rt.Root,
    {
      ref: r,
      className: f(
...
const os = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = It();
  return /* @__PURE__ */ d(
    rt.SubTrigger,
    {
...
const ss = b.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: r = 8, ...a }, s) => {
  const i = It();
...
const is = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = It();
  return /* @__PURE__ */ o(
    rt.Item,
    {
...
ld.displayName = rt.CheckboxItem.displayName;
const cd = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    rt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(Sn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
...
wd.displayName = rt.Label.displayName;
const ls = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  rt.Separator,
  {
    ref: n,
    className: f("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((c) => c.group === s).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        ...
        /* @__PURE__ */ o(os, { children: c.label }),
        /* @__PURE__ */ o(as, { children: cs(
          e,
          t,
          Ja(e, c.id),
          r
    ...
    return l.length > 0 && i < a.length - 1 && w.push(/* @__PURE__ */ o(ls, {}, `separator-${s}`)), w;
  });
};
function dd({
  menuData: e,
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (k = i.current) == null || k.focus(), He(i, [h, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), He(l, [h, u]);
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), He(w, [h, u]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ o(ns, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(sd, { children: [
      /* @__PURE__ */ o(rs, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        ss,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Tt, { children: cs(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function au({
  ...
  const c = pd(
    ...
    var N, y, S, A, j, $;
    const v = k !== g ? ((y = (N = e[g]) == null ? void 0 : N.uiNames) == null ? void 0 : y[k]) ?? ((A = (S = e[g]) == null ? void 0 : S.uiNames) == null ? void 0 : A.en) : void 0;
    return v ? `${(j = e[g]) == null ? void 0 : j.autonym} (${v})` : ($ = e[g]) == null ? void 0 : $.autonym;
  };
      ...
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(e).map((g) => /* @__PURE__ */ o(Et, { value: g, children: u(g, t) }, g))
            }
          )
        ]
      }
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(Ne, { children: [
              /* @__PURE__ */ o(Be, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(V, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(yo, {}) }) }),
...
const md = rn(({ className: e, ...t }, n) => /* @__PURE__ */ o(Us, { size: 35, className: f("tw-animate-spin", e), ...t, ref: n }));
...
const bd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
bd.displayName = "AlertDescription";
const cu = ot.Root, wu = ot.Trigger, du = ot.Group, pu = ot.Portal, uu = ot.Sub, mu = ot.RadioGroup, vd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
vd.displayName = ot.SubTrigger.displayName;
...
xd.displayName = ot.SubContent.displayName;
const yd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(ot.Portal, { children: /* @__PURE__ */ o(
  ot.Content,
  {
    ref: n,
    className: f(
...
yd.displayName = ot.Content.displayName;
...
Nd.displayName = ot.Item.displayName;
...
kd.displayName = ot.CheckboxItem.displayName;
...
_d.displayName = ot.RadioItem.displayName;
...
Ed.displayName = ot.Separator.displayName;
...
const hu = Ot.Trigger, Rd = Ot.Portal, fu = Ot.Close, ds = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ot.Overlay,
  {
    ref: n,
...
ds.displayName = Ot.Overlay.displayName;
...
Id.displayName = Ot.Title.displayName;
const Ad = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ot.Description,
  {
    ref: n,
...
Ad.displayName = Ot.Description.displayName;
...
Pd.displayName = ar.Root.displayName;
function gu({
  className: e,
  ...t
}) {
...
$d.displayName = sr.Root.displayName;
const yu = kt.Root, Ld = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    kt.List,
    {
...
Ld.displayName = kt.List.displayName;
...
Bd.displayName = kt.Trigger.displayName;
...
jd.displayName = kt.Content.displayName;
