...
import { useReactTable as We, getFilteredRowModel as _r, getSortedRowModel as Ze, getPaginationRowModel as Tr, getCoreRowModel as Qe, flexRender as At, getGroupedRowModel as zr, getExpandedRowModel as Er } from "@tanstack/react-table";
...
const H = class _ {
  ...
  parse(e) {
    ...
    if (a.length !== 2 || O.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !_.isVerseParseable(a[1]))
      throw new Vt("Invalid reference : " + e);
...
function fs({
  ...
  const f = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), h = st(n, "%webView_inventory_unapproved%"), b = st(n, "%webView_inventory_unknown%"), S = st(n, "%webView_inventory_scope_currentBook%"), x = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_scope_verse%"), y = st(n, "%webView_inventory_filter_text%"), E = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, tt] = B(!1), [ot, Et] = B("all"), [v, T] = B(""), [K, A] = B([]), Mt = Q(() => s ? a instanceof RegExp ? Pa(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((L) => {
...
function vs({
  ...
  ct(() => {
    if (s) {
      const v = x.getSelectedRowModel().rowsById, T = Object.keys(v);
      if (T.length === 1) {
        const K = b.find((A) => Ue(A) === T[0]) || void 0;
        K && s(K);
      }
    }
  }, [g, b, s, x]);
  const k = o ?? ro, y = i ?? Vn, E = [
    ...
    !v.getIsGrouped() && !v.getIsSelected() && v.getToggleSelectedHandler()(T);
  }, ot = (v, T) => v.getIsGrouped() ? "" : l("banded-row", T % 2 === 0 ? "even" : "odd"), Et = (v, T, K) => {
    if (!((v == null ? void 0 : v.length) === 0 || T.depth < K.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(Qt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(te, { children: x.getHeaderGroups().map((v) => /* @__PURE__ */ r(dt, { children: v.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ r(ee, { children: x.getRowModel().rows.map((v, T) => {
        const K = $();
        return /* @__PURE__ */ r(
          dt,
          {
