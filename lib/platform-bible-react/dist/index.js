...
import { r as jt, Z as Hi, B, c as m, a as Yi, C as Se, P as De, b as Ve, d as Oe, e as Le, f as Fe, g as pe, h as _r, i as ea, T as te, S as tr, j as ee, k as re, l as ae, D as He, m as xr, n as Ne, o as Ce, p as Ee, u as Wi, q as Nr, s as Ye, t as Pe, v as Da, w as wn, x as Xi, y as Ji, z as un, A as pn, E as Zi, F as Qi, G as ts, H as es, I as ua, J as pa, K as ra, L as rs, M as as, N as os, O as ns, Q as is, R as Cr, U as Ha } from "./resizable-CUvCloPJ.js";
...
import { useReactTable as Fn, getFilteredRowModel as il, getSortedRowModel as jn, getPaginationRowModel as sl, getCoreRowModel as Bn, flexRender as vr, getGroupedRowModel as cl, getExpandedRowModel as ll } from "@tanstack/react-table";
...
function bl({
  ...
  return /* @__PURE__ */ u(De, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Oe, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(pe, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Se,
      {
        onSelect: () => g(h),
...
function Hn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(pe, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function ma({
  ...
  const k = jt(), [_, N] = E(!1), [I, j] = E(""), [V, $] = E(""), [y, z] = E("books"), [A, D] = E(void 0), [O, W] = E(
    void 0
  ), [K, M] = E(void 0), [Q, mt] = E(!1), ct = q(null), Bt = q(!1), bt = q(void 0), Dt = q(void 0), U = q(void 0), rt = q(void 0), ot = q({}), nt = q({}), it = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const Vt = L(() => {
    ...
    () => yl(V),
    [V]
  ), kt = F(() => !l || !S || !S.chapterNum || !pt ? !1 : l(S.book, S.chapterNum) > 0, [l, S, pt]), Be = L(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), Me = L(
    (b) => (G) => w ? kl(b, G, w) : !1,
    ...
    (b, G) => (J) => w ? fa(b, G, J, w) : !1,
    [w]
  ), Ue = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", wr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", ur = L(
    (b) => {
    ...
    (b) => {
      ...
      if ((y === "chapters" || y === "books" && S) && Et) {
        ...
        if (!Mt) return;
        y === "chapters" && ((pr = bt.current) == null || pr.focus());
        const _t = (() => {
          if (!I) return 1;
          const Wt = I.match(/(\d+)$/);
  ...
  return Xt(() => {
    const b = setTimeout(() => {
      if (_ && y === "books" && U.current && rt.current) {
        const G = U.current, J = rt.current, Et = J.offsetTop, Jt = G.clientHeight, Xe = J.clientHeight, pr = Et - Jt / 2 + Xe / 2;
        G.scrollTo({
          top: Math.max(0, pr),
          behavior: "smooth"
        }), j(Gn(t.book));
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(De, { open: _, onOpenChange: H, modal: v, children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(
      B,
      {
        ref: ct,
          ...
          Le,
          {
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                y === "chapters" && A && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ae(A, n) }),
                y === "verses" && O && K !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ae(O, n)} ${K}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? wr : Ue
                  }
                )
              ] }),
              !Q && /* @__PURE__ */ u(Fe, { ref: U, children: [
                y === "books" && /* @__PURE__ */ u(et, { children: [
                  ...
                  S && kt && S.chapterNum && l && /* @__PURE__ */ u(et, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ae(S.book, n)} ${S.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Vo,
                      {
                        ...
                        onVerseSelect: ne,
                        setVerseRef: wt,
                        isVerseDisabled: dr(S.book, S.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  S && !kt && ue(S.book) > 1 && /* @__PURE__ */ u(et, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ae(S.book, n) }),
...
function Lo({
  ...
  const [_, N] = E(!1), I = l ?? d, j = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, y) => {
  ...
  return /* @__PURE__ */ u(De, { open: _, onOpenChange: N, ...k, children: [
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        children: /* @__PURE__ */ u(Le, { children: [
          ...
          /* @__PURE__ */ a(Fe, { children: j(e) ? e.map(($) => /* @__PURE__ */ a(pe, { heading: $.groupHeading, children: $.options.map((y) => V(y, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(pe, { children: e.map(($) => V($)) }) })
        ] })
      }
    )
  ] });
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zl = Xn ? Xt : Y, Pr = { tag: Xa };
...
const Dl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
...
const Pl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function Il(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Vl() {
  return function(t) {
    const [e] = ve(), r = F(() => t(e), [e, t]), [o, n] = E(() => r.initialValueFn()), i = q(o);
    return Pl(() => {
...
function Ul(t, e, r) {
  ...
  function d() {
    ...
    for (let C = 0; C < h.length; C++) {
      ...
      const $ = we(k.height);
      N.height !== $ && (_.style.height = $, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[C] = _;
    }
...
function ql(t, e = Kl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, C = h.getNode(), k = C.getKey(), _ = h.offset, N = t.getElementByKey(x), I = t.getElementByKey(k), j = r === null || N !== o || v !== n || x !== r.getKey(), V = i === null || I !== s || _ !== c || k !== i.getKey();
      if ((j || V) && N !== null && I !== null) {
        const $ = function(y, z, A, D, O, W, K) {
          const M = (y._window ? y._window.document : document).createRange();
          return M.setStart(...Fo(z, A, D)), M.setEnd(...Fo(O, W, K)), M;
        }(t, g, f, N, h, C, I);
        d(), d = Ul(t, $, e);
      }
      r = f, o = N, n = v, i = C, s = I, c = _;
    });
  }
...
function Hl(t) {
  const e = zn(t, (r) => ke(r) && !r.isInline());
  return ke(e) || Yr(4, t.__key), e;
}
function Yl(t) {
  const e = Ft() || rc();
  let r;
  if (ge(e)) r = ac(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Tn(c, "next"));
    }
    r = r || oc(Te(), "previous").getFlipped().insert(cr());
  }
...
function Wl(t, e, r) {
  ...
  return wc(o) && Yr(283), o.insert(t.isInline() ? cr().append(t) : t), zo(Tn(t.getLatest(), "next"), e.direction);
}
function Xl(t) {
  const e = Ft();
  if (!ge(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = zn(i, (l) => ke(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Wr, _e = 0, Xr = 0, Ql = 0, Ua = 0, jr = 0;
function Bo(t) {
  if (tt === void 0) return;
  let e = t.n;
...
function ed(t) {
  ...
  Qn(this), tt = t, this.f &= -2, 8 & this.f && ao(this), ia();
}
function Ze(t, e) {
...
At.prototype.brand = Jl, At.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      _e !== 0 && Xr === 0 && e.l !== Ua && (e.l = Ua, Wr = { S: e, v: e.v, i: e.i, o: Wr });
    })(this), this.v = t, this.i++, jr++, _e++;
    try {
...
} }), qe.prototype = new At(), qe.prototype.h = function() {
  ...
  return tt = t, Qn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ti(this), Uo(this), _e++;
  const t = tt;
  return tt = this, ed.bind(this, t);
...
oe({ build: (t, e, r) => lr(e), config: We({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ei() {
  const t = Te(), e = Ft(), r = cr();
  t.clear(), t.append(r), e !== null && r.select(), ge(e) && (e.format = 0);
}
function ri(t, e = ei) {
  return t.registerCommand(Dn, (r) => (t.update(e), !0), Ja);
}
oe({ build: (t, e, r) => lr(e), config: We({ $onClear: ei }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return fe(() => ri(t, o.value));
} });
function rd(t) {
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [ai], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Ft();
  if ($n(n) || ge(n)) for (const i of n.getNodes()) ad(i) && i.toggleFormat(o);
  return !1;
}, Mn) });
function oi(t, e) {
  let r;
...
const Ka = oe({ build: (t) => oi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const oo = 0, qa = 1, ii = 2, ya = 3, Ir = 4, Je = 5, ka = 6, gr = 7;
function _a(t) {
  return t.id === oo;
}
function si(t) {
...
const cd = oe({ config: We({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = sd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const dd = /* @__PURE__ */ new Set(), Ho = oe({ build(t, e, r) {
...
oe({ dependencies: [Ka, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [rr], register(t, e, r) {
  ...
  return ze(t.registerCommand(wd, (s) => {
    const c = Ft();
    if (!ge(c)) return !1;
    ...
    return !1;
  }, Mn), t.registerMutationListener(rr, (s, c) => {
    Zl(() => {
      let d = !1;
...
oe({ build: (t, e) => lr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: We({ $getParentEditor: function() {
  const t = Cc();
...
oe({ build: (t, e, r) => lr(e), config: We({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return fe(() => {
...
function hd(t, e, r = ci) {
  return ze(t.registerCommand($c, (o) => {
    const n = Ft();
    if (!ge(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
oe({ build: (t, e, r) => lr(e), config: We({ $canIndent: ci, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return fe(() => {
    if (!o.value) return hd(t, n, i);
  });
} });
const gd = oe({ name: "@lexical/react/ReactProvider" });
function fd() {
...
oe({ build: (t, e, r) => lr(e), config: We({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => fe(() => r.getOutput().disabled.value ? void 0 : di(t)) });
function bd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const io = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
...
function kd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    io(() => ze(qc(n), di(n)), [n]);
  }(o), u(et, { children: [t, a(_d, { content: e }), a(yd, { editor: o, ErrorBoundary: r })] });
}
...
function Dd(t, e) {
  ...
  return u(et, { children: [a(zd, { editor: n, ...o, ref: e }), r != null && a(Od, { editor: n, content: r })] });
}
...
function Ad({
  ...
  const [e] = ve(), [r, o] = E(e), [n, i] = E("paragraph"), [s, c] = Rd(), d = () => {
  };
...
function Ud(t, e) {
  ...
  const r = document.createElement("div"), o = Te().getChildren();
  for (let n = 0; n < o.length; n++)
    fi(t, o[n], r, e);
  return r.innerHTML;
}
function fi(t, e, r, o = null) {
  ...
  const i = ke(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && qr(e) && (s = Fl(o, e, "clone"));
  const c = ke(s) ? s.getChildren() : [], d = Lc(t, s.getType());
  let l;
  ...
  for (let h = 0; h < c.length; h++) {
    ...
    !n && ke(e) && x && e.extractWithChild(f, o, "html") && (n = !0);
  }
  if (n && !i) {
...
function cp({
  ...
  const [i, s] = E(Hd), [c, d] = E(n), [l, w] = E(!1), p = q(void 0), g = q(null);
  Y(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        ...
        _ && /* @__PURE__ */ u(Ne, { children: [
          /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ks, {}) }) }),
          /* @__PURE__ */ a(Ee, { align: "end", children: _ })
        ] })
      ]
    }
  );
...
function Zd({
  ...
  const [$, y] = E(Qo), [z, A] = E(), [D, O] = E(), W = o, [K, M] = E(!1), [Q, mt] = E(!1), [ct, Bt] = E(!1), [bt, Dt] = E(!1), [U, rt] = E(!1), [ot, nt] = E(N), [it, It] = E(!1), vt = q(void 0), [Ut, Kt] = E(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const gt = L(
    ...
    async (T) => {
      const wt = Zt($) ? Zr($) : void 0, pt = T.status ? T.assignedUser : z ?? T.assignedUser, kt = await p({
        ...T,
        contents: wt,
        assignedUser: pt
      });
        ...
        children: /* @__PURE__ */ u(Wd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              Ht && /* @__PURE__ */ a(xr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Ht }),
              /* @__PURE__ */ a(
                B,
                {
                  variant: "ghost",
            ...
            o && /* @__PURE__ */ u(et, { children: [
              ...
              v !== !1 && (!Q || Zt($)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (T) => {
                    lo(T) && (T.preventDefault(), T.stopPropagation(), (Zt($) || z !== void 0 && z !== D) && gt());
                  },
                  onKeyDown: (T) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      ...
                      /* @__PURE__ */ u(De, { open: ct, onOpenChange: Bt, children: [
                        /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(
                          B,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ a(
                          Oe,
                          {
                            ...
                            children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Fe, { children: x == null ? void 0 : x.map((T) => /* @__PURE__ */ a(
                              Se,
                              {
                                onSelect: () => {
...
function fp({
  ...
  const [C, k] = E(/* @__PURE__ */ new Set()), [_, N] = E(), [I, j] = E(), V = L(
    async (M) => {
      const Q = await i(M);
  ...
  const $ = r.filter(
    ...
    [C, x]
  ), { listboxRef: D, activeId: O, handleKeyDown: W } = Wi({
    options: y,
    onOptionSelect: z
  }), K = L(
    (M) => {
      M.key === "Escape" ? (_ && C.has(_) && (k((Q) => {
        const mt = new Set(Q);
...
function Qd({ table: t }) {
  return /* @__PURE__ */ u(Ne, { children: [
    /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Es, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(Ee, { align: "end", className: "tw:w-[150px]", children: [
...
function cw({
  ...
  let I;
  return d ? I = Array.from({ length: 10 }).map((y, z) => `skeleton-row-${z}`).map((y) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Da, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((j = _.getRowModel().rows) == null ? void 0 : j.length) > 0 ? I = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ce,
    {
      onClick: () => s(V, _),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map(($) => /* @__PURE__ */ a(Qt, { children: vr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    V.id
    ...
    /* @__PURE__ */ u(sa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(wo, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map(($) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : vr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function Np({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ne, { children: [
    /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "default", children: [
      /* @__PURE__ */ a(Os, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(er, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Ee, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Nr, { children: l.label }),
      /* @__PURE__ */ a(wn, { children: l.itemType === 0 ? /* @__PURE__ */ a(et, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Pe,
        {
          checked: o[w][g],
...
function Ni({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: f, children: /* @__PURE__ */ u(De, { open: $, onOpenChange: w ?? k, children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(
      B,
      {
        variant: x,
...
const fw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(et, { children: [
...
function mw({
  ...
  const i = q(null), s = q(null), c = q(!1), [d, l] = E(t), [w, p] = E(r), [g, h] = E(!1);
  Y(() => {
    l(t);
  }, [t]), Y(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(Ne, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: fw(t, n, r) }) }) }),
...
const vw = (t, e) => t === "f" ? /* @__PURE__ */ u(et, { children: [
  /* @__PURE__ */ a(bn, {}),
  " ",
...
function xw({
  ...
  return /* @__PURE__ */ u(Ne, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: vw(t, r) }) }) }),
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: bw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ee, { style: { zIndex: un }, children: [
...
function _w({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  ...
  return /* @__PURE__ */ u(Le, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Fe, { children: [
      ...
      /* @__PURE__ */ a(pe, { children: i.map((c) => {
        var d;
        return /* @__PURE__ */ a(
          on,
          {
      ...
      s.length > 0 && /* @__PURE__ */ u(et, { children: [
        ...
        /* @__PURE__ */ a(pe, { children: s.map((c) => {
          var d;
          return /* @__PURE__ */ a(
            on,
            {
...
function zp({
  ...
  const [f, x] = E("generated"), [v, C] = E("generated"), [k, _] = E("*"), [N, I] = E("*"), [j, V] = E("f"), [$, y] = E(!1), [z, A] = E(!0), [D, O] = E(!1), W = q(!1), K = q(""), [M, Q] = E(!1), [mt, ct] = E(), [Bt, bt] = E(), [Dt, U] = E(), [rt, ot] = E(), nt = q(null), it = F(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (H && Ar("note", H)) {
      ...
      let xt = "custom";
      ht === Ia ? xt = "generated" : ht === Va ? xt = "hidden" : ht && (_(ht), I(ht)), x(xt), C(xt), V(((at = H.insert.note) == null ? void 0 : at.style) ?? "f"), P = setTimeout(() => {
        var yt;
  ...
  const Ot = () => {
    ...
    if (H && Ar("note", H)) {
      ...
      j !== "x" && P === "x" ? gt == null || gt.forEach((Ct) => Cw(Ct)) : j === "x" && P !== "x" && (gt == null || gt.forEach((Ct) => Ew(Ct))), (yt = w.current) == null || yt.applyUpdate([H, { delete: 1 }]);
    }
  }, $t = (P) => {
    ...
    (P) => {
      ...
      if (H && Ar("note", H)) {
        ...
        A(JSON.stringify(H) === K.current), vt(f, k);
      } else
        y(!1), A(!0);
    },
    [f, k, vt]
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(et, { children: zw(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(ca, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ce,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Qt, { className: o, children: Ow(c.text) })
        ]
      },
...
}, la = (t, e, r) => /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
  /* @__PURE__ */ u(
    re,
    {
...
function Vp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), C = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), _ = de(r, "%webView_inventory_scope_verse%"), N = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), j = de(r, "%webView_inventory_no_results%"), [V, $] = E(!1), [y, z] = E("all"), [A, D] = E(""), [O, W] = E([]), K = F(() => {
    const U = t ?? [];
  ...
  }, [V, K]), Q = F(() => M.length === 0 ? [] : Pw(M, y, A), [M, y, A]), mt = F(() => {
    var ot, nt;
    if (!V) return d;
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(ar, { onValueChange: (U) => Bt(U), defaultValue: s, children: [
...
function Ta({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(et, { children: [
      /* @__PURE__ */ a(ce, { className: "tw:border-0 tw:hover:bg-transparent", "aria-hidden": !0, children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(Nt, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        ce,
        {
          ...
          onKeyDown: r ? (n) => {
            (n.key === "Enter" || n.key === " ") && r(o);
          } : void 0,
          children: [
            /* @__PURE__ */ a(Qt, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ a(Ie, { className: "tw:h-3.5 tw:w-3.5" }) }),
...
function Fp({
  ...
  const [s, c] = E(""), [d, l] = E([]), w = F(
    () => t.filter((O) => !r || O.type === r).filter((O) => Lw(O, s)).filter(
  ...
  }, [d, C, I, n]), D = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !k && !e && /* @__PURE__ */ a(sa, { children: /* @__PURE__ */ u(ca, { children: [
        /* @__PURE__ */ a(Ta, { label: j, resources: p }),
        /* @__PURE__ */ a(Ta, { label: V, resources: g, onSelect: i }),
        /* @__PURE__ */ a(
          Ta,
          {
            label: $,
...
function Ww({
  ...
  const c = t ? sr.Root : "button", { state: d } = wa(), l = /* @__PURE__ */ a(
    c,
    {
...
const Re = "scrBook", Jw = "scrRef", Ge = "source", Zw = "details", Qw = "Scripture Reference", tu = "Scripture Book", Si = "Type", eu = "Details";
function ru(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Re ? ye(n.start) : void 0;
      },
...
function eh({
  ...
  const [l, w] = E([]), [p, g] = E([{ id: Re, desc: !1 }]), [h, f] = E({}), x = F(
  ...
  Y(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const A = x.find((D) => ln(D) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [h, x, c, C]);
  ...
  }, V = (y, z) => y.getIsGrouped() ? "" : m("banded-row", z % 2 === 0 ? "even" : "odd"), $ = (y, z, A) => {
    ...
    !e && /* @__PURE__ */ u(
      ar,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ir, { position: "item-aligned", children: /* @__PURE__ */ a(tw, { children: N.map((y) => /* @__PURE__ */ a(ie, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(sa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(wo, { children: C.getHeaderGroups().map((y) => /* @__PURE__ */ a(ce, { children: y.headers.filter((z) => z.column.columnDef.header).map((z) => (
        ...
        /* @__PURE__ */ a(Qr, { colSpan: z.colSpan, className: "tw:sticky top-0", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          vr(z.column.columnDef.header, z.getContext())
        ] }) }, z.id)
      )) }, y.id)) }),
        ...
        return /* @__PURE__ */ a(
          ce,
          {
            ...
            children: y.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== Ge || !r)))
                return /* @__PURE__ */ a(
                  Qt,
                  {
                    className: m(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        type: "button",
                        children: [
                          y.getIsExpanded() && /* @__PURE__ */ a(er, {}),
                          !y.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a($a, {})),
                          " ",
                          vr(D.column.columnDef.cell, D.getContext()),
                          " (",
                          y.subRows.length,
                          ")"
                        ]
...
function ou({
  ...
  }, [x, v] = E(!1), [C, k] = E(""), _ = q(void 0), N = q(!1), I = F(
    () => Di(t),
    [t]
  ), j = F(() => {
    if (!C.trim()) {
                ...
                Object.values(Z).map((D, O) => {
                  ...
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(kn, { children: [
                      ...
                      O < Object.values(Z).length - 1 && /* @__PURE__ */ a(pn, {})
                    ] }, D);
                })
              ] })
            ]
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === za ? za : dn
      ).map((d) => /* @__PURE__ */ a(xr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ae(d, n) }, d)),
...
function ah({
  ...
  const N = zt(
  ...
  ], U = (R, X, Lt = !1) => /* @__PURE__ */ u(et, { children: [
    R,
    X && !Lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), rt = e ? Dt.filter((R) => e.includes(R.value)) : Dt, ot = f ?? ga, nt = w ?? ot, it = p ?? ot, It = () => {
  }, vt = q(null), Ut = q(null), Kt = q(!1), S = q(null), Ot = q(!1), [Vt, ne] = E(void 0), qt = q(!1), $t = q(!1), $e = q(null), Gt = L((R) => {
    if (R) {
    ...
    [r, n, f, i]
  ), at = rt.find((R) => R.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((R) => R.toUpperCase()).join(", ") : t === "range" ? gs(nt, it, {
  ...
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, T] = E(!1), [wt, pt] = E(void 0), [kt, Be] = E(void 0), [Me, dr] = E(void 0), [Ue, wr] = E(void 0), [ur, zr] = E([]), Sr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    iu,
    {
      availableBookInfo: o,
      selectedBookIds: Sr ? ur : n,
      onChangeSelectedBookIds: Sr ? zr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), G = Vt === "end", J = Vt === "start", Et = "tw:text-muted-foreground", Jt = l === "dropdown" && wt === "range", Xe = Jt ? dr : P, Mt = Jt ? wr : h ? H : It, _t = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: m(G && Et), children: M }),
      /* @__PURE__ */ a(
        ma,
        {
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ma,
        {
          ...
          localizedStrings: v,
          getEndVerse: C,
          disableReferencesUpTo: Jt ? Me ?? nt : nt,
          onOpenChange: Ht,
          onCloseAutoFocus: (R) => {
            var X;
            $t.current && ($t.current = !1, R.preventDefault(), (X = $e.current) == null || X.focus());
          },
          className: m(J && Et),
          modal: !0,
          align: "start"
  ...
  const [Wt, Ke] = E(null), [Dr, Li] = E(null), [Or, Fi] = E(null), ji = 200, [Bi, Ui] = E(!1);
  Y(() => {
  ...
  const ho = L(
    (R) => {
      Be(R), dr(nt), wr(it), zr(n), T(!1), pt(R);
    },
    [nt, it, n]
  ), go = L(() => {
    kt !== void 0 && (kt === "range" ? (Me && (g == null || g(Me)), Ue && (h == null || h(Ue))) : kt === "selectedBooks" && i(ur), st(kt), pt(void 0), Be(void 0));
  }, [
    kt,
    Me,
    Ue,
    ...
    R || (pt(void 0), Be(void 0));
  }, []), fo = L((R) => {
    var X;
    R.preventDefault(), (X = Yt.current) == null || X.focus();
  }, []), mo = (R) => t === R ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ie, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Nt, { children: D }),
      l === "dropdown" ? /* @__PURE__ */ u(Ne, { open: Ct, onOpenChange: T, children: [
        ...
        /* @__PURE__ */ a(
          Ee,
          {
            ...
            children: /* @__PURE__ */ u(ua, { container: Or, children: [
              xt.map(({ value: R, label: X, dropdownLabel: Lt, scrRefSuffix: hr, id: Ki }) => /* @__PURE__ */ u(
                He,
                {
                  ref: ft(R),
                  ...
                  children: [
                    t === R && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ie, { className: "tw:h-4 tw:w-4" }) }),
                    U(Lt ?? X, hr, Bi)
                  ]
                },
                Ki
                        ...
                        children: /* @__PURE__ */ a(
                          ma,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(et, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ye(f ?? ga, "id") }),
                              /* @__PURE__ */ a(er, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Yn,
        {
          ...
          children: rt.map(({ value: R, label: X, scrRefSuffix: Lt, id: hr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ja, { className: "tw:me-2", value: R, id: hr }),
            /* @__PURE__ */ a(Nt, { htmlFor: hr, children: U(X, Lt) })
          ] }, hr))
        }
      )
    ] }),
    ...
    l === "dropdown" && yt && /* @__PURE__ */ a(La, { open: wt === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      Fa,
      {
        ...
        children: /* @__PURE__ */ u(ua, { container: Dr, children: [
          /* @__PURE__ */ a(Gr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Hr, { children: A }) }),
          b,
    ...
    l === "dropdown" && gt && /* @__PURE__ */ a(La, { open: wt === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      Fa,
      {
        ...
        children: /* @__PURE__ */ u(ua, { container: Wt, children: [
          ...
          /* @__PURE__ */ u(Ro, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => $r(!1), children: ct }),
            /* @__PURE__ */ a(B, { ref: $e, onClick: go, children: mt })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          ir,
          {
            ...
            style: { zIndex: ra },
            children: t.map((l) => /* @__PURE__ */ a(ie, { value: `${l}`, children: c[bo(l)] }, `${l}`))
          }
        )
      ]
    }
...
function Ga({
  ...
  return /* @__PURE__ */ u(Ne, { variant: i, children: [
    /* @__PURE__ */ a(Ce, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Hs, {}) }) }),
    /* @__PURE__ */ a(Ee, { align: "start", style: { zIndex: ra }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(kn, { children: [
      /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(te, { children: Mi(e.groups, e.items, d, t) }) }),
  ...
  if (pl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(du, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(wu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ra },
          children: /* @__PURE__ */ a(te, { children: Vi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ph({
  ...
  const l = yu(
    ...
    return v ? `${(I = t[f]) == null ? void 0 : I.autonym} (${v})` : (j = t[f]) == null ? void 0 : j.autonym;
  };
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Ne, { children: [
              /* @__PURE__ */ a(Ce, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(_o, {}) }) }),
              /* @__PURE__ */ a(Ee, { align: "end", children: l })
            ] }) }),
            e && l && /* @__PURE__ */ u(Ne, { children: [
              /* @__PURE__ */ a(Ce, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(_o, {}) }) }),
              /* @__PURE__ */ a(Ee, { align: "end", children: l })
            ] })
          ] }),
