...
import { Button as Fr, Autocomplete as Ur, TextField as vr, FormControlLabel as Vn, FormLabel as Wr, Checkbox as Gr, MenuItem as qr, Grid as kr, IconButton as xr, Paper as Hr, Slider as Xr, Snackbar as Yr, Switch as Kr, AppBar as Jr, Toolbar as Zr, Drawer as Qr } from "@mui/material";
import * as Fe from "react";
import { useMemo as Tn, useState as Pe, useCallback as Xe, useRef as xn, useEffect as nn } from "react";
...
function dt({ commandHandler: e, className: n, items: r, id: t }) {
  return /* @__PURE__ */ S("div", { id: t, className: `papi-menu ${n ?? ""}`, children: r == null ? void 0 : r.map((o, i) => /* @__PURE__ */ S(
    ut,
    {
...
function ft({ commandHandler: e, name: n, className: r, items: t, id: o }) {
  return /* @__PURE__ */ De(kr, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
    /* @__PURE__ */ S("h3", { className: `papi-menu-column-header ${r ?? ""}`, children: n }),
    /* @__PURE__ */ S(dt, { commandHandler: e, items: t })
  ] });
}
...
var ht = Object.defineProperty, mt = (e, n, r) => n in e ? ht(e, n, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[n] = r, A = (e, n, r) => (mt(e, typeof n != "symbol" ? n + "" : n, r), r);
const Ee = [
  "GEN",
  "EXO",
  "LEV",
...
const Ct = ({ onChange: e, disabled: n, checked: r, ...t }) => /* @__PURE__ */ S(
  lt,
  {
    ...t,
    isChecked: r,
...
function $t() {
  return Hn || (Hn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var m = c, Q = s, re = l, fe = a, le = n, C = u, G = t, Z = b, te = v, J = r, q = i, ne = o, ue = p, xe = !1;
    function we(y) {
      return xe || (xe = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), g(y) || T(y) === c;
    }
    function g(y) {
      return T(y) === s;
    }
    ...
    z.AsyncMode = m, z.ConcurrentMode = Q, z.ContextConsumer = re, z.ContextProvider = fe, z.Element = le, z.ForwardRef = C, z.Fragment = G, z.Lazy = Z, z.Memo = te, z.Portal = J, z.Profiler = q, z.StrictMode = ne, z.Suspense = ue, z.isAsyncMode = we, z.isConcurrentMode = g, z.isContextConsumer = k, z.isContextProvider = N, z.isElement = O, z.isForwardRef = w, z.isFragment = P, z.isLazy = _, z.isMemo = $, z.isPortal = I, z.isProfiler = j, z.isStrictMode = M, z.isSuspense = ee, z.isValidElementType = D, z.typeOf = T;
  }()), z;
}
var Xn;
function $r() {
  return Xn || (Xn = 1, process.env.NODE_ENV === "production" ? He.exports = Ot() : He.exports = $t()), He.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function At() {
  if (Qn)
    return bn;
  Qn = 1;
  var e = $r(), n = Nt(), r = $n(), t = Nr(), o = Rt(), i = function() {
  };
  ...
  return bn = function(l, c) {
    ...
    function le(g) {
      ...
      for (var k = 0; k < g.length; k++) {
        ...
        if (typeof N != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + xe(N) + " at index " + k + "."
          ), a;
      }
      function O(w, P, _, $, I) {
    ...
    function C() {
      function g(k, N, O, w, P) {
        return J(k[N]) ? null : new h("Invalid " + w + " `" + P + "` supplied to " + ("`" + O + "`, expected a ReactNode."));
      }
      return f(g);
    }
    function G(g, k, N, O, w) {
      return new h(
        (g || "React class") + ": " + k + " type `" + N + "." + O + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + w + "`."
      );
    }
    function Z(g) {
      function k(N, O, w, P, _) {
...
if (process.env.NODE_ENV !== "production") {
  var It = $r(), Mt = !0;
  En.exports = At()(It.isElement, Mt);
} else
  En.exports = Pt()();
var Bt = En.exports;
const U = /* @__PURE__ */ _t(Bt);
function Me(e) {
...
function jt() {
  return rr || (rr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function T(x) {
      return !!(typeof x == "string" || typeof x == "function" || x === r || x === o || K || x === t || x === s || x === u || E || x === v || b || h || f || typeof x == "object" && x !== null && (x.$$typeof === d || x.$$typeof === p || x.$$typeof === i || x.$$typeof === a || x.$$typeof === c || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      x.$$typeof === D || x.getModuleId !== void 0));
    }
    function m(x) {
    ...
    var Q = a, re = i, fe = e, le = c, C = r, G = d, Z = p, te = n, J = o, q = t, ne = s, ue = u, xe = !1, we = !1;
    function g(x) {
...
function Rr(e, n = "") {
  return e.displayName || e.name || zt(e) || n;
}
function or(e, n, r) {
  const t = Rr(n);
...
const Kt = ["values", "unit", "step"], Jt = (e) => {
...
function Zt(e) {
  const {
    ...
    unit: r = "px",
    step: t = 5
  } = e, o = be(e, Kt), i = Jt(n), a = Object.keys(i);
  function l(d) {
...
const Qt = {
  borderRadius: 4
}, eo = Qt, no = process.env.NODE_ENV !== "production" ? U.oneOfType([U.number, U.string, U.object, U.array]) : {}, ke = no;
function Le(e, n) {
  return n ? de(e, n, {
    clone: !1
...
function uo(e, n, r, t) {
  if (n.indexOf(r) === -1)
    return null;
  const o = so(r), i = lo(o, t), a = e[r];
  return ge(e, a, i);
}
function Mr(e, n) {
  const r = Ir(e.theme);
  return Object.keys(e).map((t) => uo(e, n, t, r)).reduce(Le, {});
}
function H(e) {
  return Mr(e, tn);
}
H.propTypes = process.env.NODE_ENV !== "production" ? tn.reduce((e, n) => (e[n] = ke, e), {}) : {};
H.filterProps = tn;
function X(e) {
  return Mr(e, on);
}
X.propTypes = process.env.NODE_ENV !== "production" ? on.reduce((e, n) => (e[n] = ke, e), {}) : {};
X.filterProps = on;
process.env.NODE_ENV !== "production" && co.reduce((e, n) => (e[n] = ke, e), {});
function fo(e = 8) {
  if (e.mui)
    return e;
  const n = Ir({
...
const po = ce("border", se), ho = ce("borderTop", se), mo = ce("borderRight", se), go = ce("borderBottom", se), bo = ce("borderLeft", se), yo = ce("borderColor"), vo = ce("borderTopColor"), ko = ce("borderRightColor"), xo = ce("borderBottomColor"), So = ce("borderLeftColor"), Eo = ce("outline", se), wo = ce("outlineColor"), sn = (e) => {
...
an(po, ho, mo, go, bo, yo, vo, ko, xo, So, sn, Eo, wo);
const cn = (e) => {
...
an(cn, ln, un, To, Co, _o, Oo, $o, No, Ro, Ao, Po);
function Ie(e, n) {
  return n === "grey" ? n : e;
}
const Io = Y({
...
function qo() {
  ...
  function n(r) {
    ...
    function l(c) {
      ...
      if (!s)
        return null;
      const u = ro(i.breakpoints), p = Object.keys(u);
      let d = u;
...
const Br = qo();
Br.filterProps = ["sx"];
const In = Br, Ho = ["breakpoints", "palette", "spacing", "shape"];
function Mn(e = {}, ...n) {
  const {
    breakpoints: r = {},
    palette: t = {},
...
const ri = (e, n) => n.components && n.components[e] && n.components[e].styleOverrides ? n.components[e].styleOverrides : null, Qe = (e) => {
  let n = 0;
  const r = {};
...
const ii = Mn(), lr = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Ke({
  defaultTheme: e,
  theme: n,
  themeId: r
...
function si(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, l = {}) => {
    ...
    const {
      ...
      overridesResolver: d = ai(lr(s))
    } = l, v = be(l, Qo), b = u !== void 0 ? u : (
    ...
    let E = Ye;
    s === "Root" || s === "root" ? E = t : s ? E = o : ni(a) && (E = void 0);
    const K = at(a, B({
      shouldForwardProp: E,
      label: f
    }, v)), D = (T, ...m) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        let C;
        c && (C = `${c}${pe(s || "")}`), C === void 0 && (C = `Styled(${Lt(a)})`), le.displayName = C;
      }
...
function dr(e) {
  e = Be(e);
  let n = e.type === "hsl" || e.type === "hsla" ? Be(di(e)).values : e.values;
...
const mi = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Re = Ei, wi = ["mode", "contrastThreshold", "tonalOffset"], pr = {
...
function hr(e, n, r, t) {
  ...
  e[n] || (e.hasOwnProperty(r) ? e[n] = e[r] : n === "light" ? e.light = pi(e.main, o) : n === "dark" && (e.dark = fi(e.main, i)));
}
function Ti(e = "light") {
  return e === "dark" ? {
    main: $e[200],
...
function Ri(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = be(e, wi), i = e.primary || Ti(n), a = e.secondary || Ci(n), l = e.error || _i(n), c = e.info || Oi(n), s = e.success || $i(n), u = e.warning || Ni(n);
  function p(h) {
...
const Mi = 0.2, Bi = 0.14, Di = 0.12;
function W(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Mi})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Bi})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Di})`].join(",");
}
const ji = ["none", W(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), W(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), W(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), W(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), W(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), W(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), W(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), W(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), W(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), W(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), W(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), W(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), W(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), W(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), W(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), W(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), W(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), W(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), W(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), W(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), W(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), W(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), W(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), W(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Vi = ji, zi = ["duration", "easing", "delay"], Li = {
...
function Wi(e) {
  const n = B({}, Li, e.easing), r = B({}, Fi, e.duration);
  return B({
...
const Gi = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, qi = Gi, Hi = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Xi(e = {}, ...n) {
  const {
    mixins: r = {},
    palette: t = {},
...
const Ji = (e) => Ye(e) && e !== "classes", Zi = si({
  themeId: zr,
  defaultTheme: Vr,
...
const na = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], ra = (e) => {
  const {
    color: n,
    fontSize: r,
    classes: t
  ...
  const t = Ki({
    ...
    titleAccess: p,
    viewBox: d = "0 0 24 24"
  } = t, v = be(t, na), b = /* @__PURE__ */ Fe.isValidElement(o) && o.type === "svg", h = B({}, t, {
    color: a,
    component: l,
    fontSize: c,
  ...
  u || (f.viewBox = d);
  const E = ra(h);
  return /* @__PURE__ */ De(ta, B({
    as: l,
    className: Yt(E.root, i),
    focusable: "false",
    color: s,
  ...
  return !f && n && (f = n(c)), /* @__PURE__ */ S("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ S(Jr, { position: "static", id: o, children: /* @__PURE__ */ De(Zr, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    ...
    f ? /* @__PURE__ */ S(
      Qr,
      {
        ...
        children: /* @__PURE__ */ S(pt, { commandHandler: h, columns: f.columns })
      }
    ) : void 0
  ] }) }) });
}
