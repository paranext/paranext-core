import Jl, { jsx as d, jsxs as $, Fragment as Et } from "react/jsx-runtime";
import * as N from "react";
import U, { forwardRef as yn, useCallback as Se, useState as fe, useRef as Mt, useEffect as Je, useLayoutEffect as va, useMemo as xt } from "react";
import { History as Zl, ChevronRight as $i, Check as Oo, Circle as Ql, ArrowDownWideNarrow as ec, Clock as tc, Bookmark as rc, FilterIcon as nc, ChevronDown as wn, ChevronUp as oc, ArrowLeftIcon as ac, ChevronLeftIcon as ic, ChevronRightIcon as sc, ArrowRightIcon as lc, ArrowUpIcon as cc, ArrowDownIcon as pc, ArrowUpDownIcon as dc, CircleCheckIcon as ya, CircleXIcon as wa, CircleHelpIcon as xa, X as uc, Search as fc, ChevronsUpDown as mc, ChevronLeft as hc, LoaderCircle as gc, Download as bc, Filter as vc, User as yc, Link as wc, CircleHelp as xc } from "lucide-react";
import Oe, { clsx as Ec } from "clsx";
import { extendTailwindMerge as kc } from "tailwind-merge";
import * as be from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as Nc } from "@radix-ui/react-dropdown-menu";
import { getChaptersForBook as Tc, getLocalizeKeyForScrollGroupId as me, formatScrRef as Gn, compareScrRefs as uo, scrRefToBBBCCCVVV as Wn, NumberFormat as Cc, formatBytes as Sc } from "platform-bible-utils";
import { useReactTable as _i, getCoreRowModel as Ii, getPaginationRowModel as Oc, getSortedRowModel as Mi, getFilteredRowModel as Rc, flexRender as Tr, getExpandedRowModel as Pc, getGroupedRowModel as $c } from "@tanstack/react-table";
import { Slot as _c } from "@radix-ui/react-slot";
import { cva as xn } from "class-variance-authority";
import * as Ee from "@radix-ui/react-select";
import { FormControlLabel as Ea, FormLabel as Ic, Checkbox as Mc, MenuItem as Ac, ListItemText as Dc, ListItemIcon as Ai, Menu as jc, Grid as Di, List as Bc, IconButton as ji, Drawer as Lc, Slider as Fc, Snackbar as Vc, Switch as zc, AppBar as Uc, Toolbar as Hc } from "@mui/material";
import * as $r from "@radix-ui/react-popover";
import { Command as De } from "cmdk";
import * as et from "@radix-ui/react-dialog";
import Gc, { ThemeContext as Wc, internal_processStyles as Xc } from "@mui/styled-engine";
...
import { Toaster as qc } from "sonner";
import { toast as $0 } from "sonner";
import * as xr from "@radix-ui/react-slider";
import * as fo from "@radix-ui/react-switch";
import * as En from "@radix-ui/react-toggle-group";
import * as Fi from "@radix-ui/react-toggle";
const Kc = kc({ prefix: "pr-" });
function D(...e) {
  return Kc(Ec(e));
}
...
var Zc = Object.defineProperty, Qc = (e, t, r) => t in e ? Zc(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => Qc(e, typeof t != "symbol" ? t + "" : t, r);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
const he = {
  ...
  extraBooks: ap,
  bookNumberToId: $o,
  bookNumberToEnglishName: Hi,
  bookIdToEnglishName: ip,
  isCanonical: Gi,
  isExtraMaterial: sp,
  isObsolete: lp
};
...
*/
oe(Ie, "ValidStatusType", Wi);
let mr = class extends Error {
};
const _o = be.Root, Xi = be.Trigger, pp = be.Group, Wv = be.Portal, Xv = be.Sub, Yv = be.RadioGroup, dp = U.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ $(
  be.SubTrigger,
  {
    ref: o,
    className: D(
    ...
    children: [
      r,
      /* @__PURE__ */ d($i, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
dp.displayName = be.SubTrigger.displayName;
...
up.displayName = be.SubContent.displayName;
const kn = U.forwardRef(({ className: e, sideOffset: t = 4, ...r }, n) => /* @__PURE__ */ d(be.Portal, { children: /* @__PURE__ */ d(
  be.Content,
  {
    ref: n,
    sideOffset: t,
...
const Yi = U.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ d(
  be.Item,
  {
    ref: n,
    className: D(
...
Yi.displayName = be.Item.displayName;
const Io = U.forwardRef(({ className: e, children: t, checked: r, ...n }, o) => /* @__PURE__ */ $(
  be.CheckboxItem,
  {
    ref: o,
    className: D(
    ...
    ...n,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(be.ItemIndicator, { children: /* @__PURE__ */ d(Oo, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
Io.displayName = be.CheckboxItem.displayName;
const qi = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  be.RadioItem,
  {
    ref: n,
    className: D(
...
qi.displayName = be.RadioItem.displayName;
...
const Nn = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  be.Separator,
  {
    ref: r,
...
Nn.displayName = be.Separator.displayName;
...
function gp({ handleSort: e, handleLocationHistory: t, handleBookmarks: r }) {
...
const Cr = he.allBookIds, bp = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ta = ["OT", "NT", "DC"], vp = 32 + 32 + 32, yp = [
  /^(\w+)$/i,
...
function qv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = fe(""), [o, a] = fe(
    ...
    (k) => wp(k).filter((M) => {
      const j = he.bookIdToEnglishName(M).toLowerCase(), z = r.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    yp.forEach((k) => {
      const M = r.match(k);
      if (M) {
        const [j, z = void 0, G = void 0] = M.slice(1), B = kp(j);
        (he.isBookIdValid(j) || B) && y(
          B ?? j,
          !0,
          z ? parseInt(z, 10) : 1,
          G ? parseInt(G, 10) : 1
  ...
  return Je(() => {
    ...
    const k = setTimeout(() => {
      if (g && u.current && b.current) {
        const j = b.current.offsetTop - vp;
        u.current.scrollTo({ top: j, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(k);
    };
  }, [g]), /* @__PURE__ */ d("div", { className: "pr-twp pr-flex", children: /* @__PURE__ */ $(_o, { modal: !1, open: m, onOpenChange: E, children: [
    /* @__PURE__ */ d(Xi, { asChild: !0, children: /* @__PURE__ */ d(
      Jc,
      {
        ref: h,
        value: r,
        ...
        children: [
          ...
          Ta.map(
            (k, M) => w(k).length > 0 && /* @__PURE__ */ $("div", { children: [
              /* @__PURE__ */ d(Vr, { className: "pr-font-semibold pr-text-foreground/80", children: bp[k] }),
                ...
                mp,
                {
                  ...
                  children: /* @__PURE__ */ d(
                    hp,
                    {
                      ...
                      endChapter: hr(j),
                      activeChapter: e.bookNum === he.bookIdToNumber(j) ? e.chapterNum : 0,
              ...
              Ta.length - 1 !== M ? /* @__PURE__ */ d(Nn, {}) : void 0
            ] }, k)
          )
        ]
      }
...
const Np = xn(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? _c : "button", { className: D(Np({ variant: t, size: r, className: e })), ref: a, ...o })
);
xe.displayName = "Button";
function Tp({ table: e }) {
  return /* @__PURE__ */ $(_o, { children: [
    /* @__PURE__ */ d(Nc, { asChild: !0, children: /* @__PURE__ */ $(xe, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ d(nc, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ $(kn, { align: "end", className: "pr-w-[150px]", children: [
...
const _r = Ee.Root, Cp = Ee.Group, Ir = Ee.Value, Zt = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  Ee.Trigger,
  {
    ref: n,
    className: D(
...
const Ki = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ee.ScrollUpButton,
  {
    ref: r,
    className: D("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
    ...t,
    children: /* @__PURE__ */ d(oc, { className: "pr-h-4 pr-w-4" })
  }
));
Ki.displayName = Ee.ScrollUpButton.displayName;
const Ji = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ee.ScrollDownButton,
  {
    ref: r,
    className: D("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
...
Ji.displayName = Ee.ScrollDownButton.displayName;
const Qt = U.forwardRef(({ className: e, children: t, position: r = "popper", ...n }, o) => /* @__PURE__ */ d(Ee.Portal, { children: /* @__PURE__ */ $(
  Ee.Content,
  {
    ref: o,
    className: D(
...
const Sp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ee.Label,
  {
    ref: r,
...
Sp.displayName = Ee.Label.displayName;
const Ke = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  Ee.Item,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(Ee.ItemIndicator, { children: /* @__PURE__ */ d(Oo, { className: "pr-h-4 pr-w-4" }) }) }),
...
Op.displayName = Ee.Separator.displayName;
function Rp({ table: e }) {
...
const Tn = U.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d("div", { className: D("pr-twp pr-relative pr-w-full", { "pr-overflow-auto": !t }), children: /* @__PURE__ */ d(
  "table",
  {
    ref: n,
...
const Cn = U.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d(
  "thead",
  {
    ref: n,
    className: D(
...
const Sn = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("tbody", { ref: r, className: D("[&_tr:last-child]:pr-border-0", e), ...t }));
Sn.displayName = "TableBody";
const Pp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "tfoot",
  {
    ref: r,
...
function _p({
  ...
  var b;
  const [l, c] = fe([]), [f, m] = fe([]), [v, g] = fe({}), [p, h] = fe({}), u = _i({
    data: t,
    columns: e,
    getCoreRowModel: Ii(),
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp pr-font-sans", children: [
    o && /* @__PURE__ */ d(Tp, { table: u }),
    /* @__PURE__ */ $(Tn, { stickyHeader: a, children: [
      /* @__PURE__ */ d(Cn, { stickyHeader: a, children: u.getHeaderGroups().map((w) => /* @__PURE__ */ d(wt, { children: w.headers.map((O) => /* @__PURE__ */ d(Mr, { children: O.isPlaceholder ? void 0 : Tr(O.column.columnDef.header, O.getContext()) }, O.id)) }, w.id)) }),
      /* @__PURE__ */ d(Sn, { children: (b = u.getRowModel().rows) != null && b.length ? u.getRowModel().rows.map((w) => /* @__PURE__ */ d(
        wt,
        {
          onClick: () => i(w, u),
    ...
    r && n && /* @__PURE__ */ d(Rp, { table: u })
  ] });
}
const Ip = (e) => e.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), Ca = (e) => {
  ...
  return a.forEach((f) => {
    f.startsWith("\\id") && (i = 0, l = 0), f.startsWith("\\c") && (i = Ca(f), l = 0), f.startsWith("\\v") && (l = Ca(f), i === 0 && (i = n.chapterNum));
    const m = r(f, t);
...
function Mp({
  ...
  return Je(
    () => f(Sa(t, e, r, n)),
    [t, e, n, r]
  ), /* @__PURE__ */ $(Tn, { stickyHeader: !0, children: [
    /* @__PURE__ */ d(Cn, { stickyHeader: !0, children: /* @__PURE__ */ $(wt, { children: [
...
]), Mo = (e) => e === "asc" ? /* @__PURE__ */ d(cc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(pc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(dc, { className: "pr-ms-2 pr-h-4 pr-w-4" }), Ap = (e, t, r) => {
  let n = e;
...
function Jv({
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp pr-flex pr-h-full pr-flex-col", children: [
    /* @__PURE__ */ $("div", { className: "pr-flex", children: [
      ...
      /* @__PURE__ */ $(_r, { onValueChange: (V) => W(V), defaultValue: f, children: [
...
const jp = $r.Root, Bp = $r.Trigger, Zi = U.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d($r.Portal, { children: /* @__PURE__ */ d(
  $r.Content,
  {
    ref: o,
    align: t,
...
Zi.displayName = $r.Content.displayName;
const Lp = et.Portal, Qi = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  et.Overlay,
  {
    ref: r,
    className: D(
...
Qi.displayName = et.Overlay.displayName;
const Fp = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(Lp, { children: [
  /* @__PURE__ */ d(Qi, {}),
  /* @__PURE__ */ $(
    et.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ $(et.Close, { className: "pr-absolute pr-right-4 pr-top-4 pr-rounded-sm pr-opacity-70 pr-ring-offset-background pr-transition-opacity hover:pr-opacity-100 focus:pr-outline-none focus:pr-ring-2 focus:pr-ring-ring focus:pr-ring-offset-2 disabled:pr-pointer-events-none data-[state=open]:pr-bg-accent data-[state=open]:pr-text-muted-foreground", children: [
          /* @__PURE__ */ d(uc, { className: "pr-h-4 pr-w-4" }),
...
Fp.displayName = et.Content.displayName;
const Vp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  et.Title,
  {
    ref: r,
...
Vp.displayName = et.Title.displayName;
const zp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  et.Description,
  {
    ref: r,
...
zp.displayName = et.Description.displayName;
const es = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De,
  {
    ref: r,
    className: D(
...
const ts = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
  /* @__PURE__ */ d(fc, { className: "pr-me-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" }),
  /* @__PURE__ */ d(
    De.Input,
    {
      ref: r,
...
ts.displayName = De.Input.displayName;
const rs = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.List,
  {
    ref: r,
...
rs.displayName = De.List.displayName;
const ns = U.forwardRef((e, t) => /* @__PURE__ */ d(De.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
ns.displayName = De.Empty.displayName;
const Up = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Group,
  {
    ref: r,
...
Up.displayName = De.Group.displayName;
...
Hp.displayName = De.Separator.displayName;
const os = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Item,
  {
    ref: r,
    className: D(
...
os.displayName = De.Item.displayName;
function Gp(e) {
...
function Oa({
  ...
  const [p, h] = fe(!1);
  return /* @__PURE__ */ $(jp, { open: p, onOpenChange: h, ...g, children: [
    /* @__PURE__ */ d(Bp, { asChild: !0, children: /* @__PURE__ */ $(
      xe,
      {
        variant: f,
        role: "combobox",
        ...
        children: [
          n ? a(n) : i,
          /* @__PURE__ */ d(mc, { className: "pr-ms-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ d(Zi, { className: "pr-w-[200px] pr-p-0", dir: m, children: /* @__PURE__ */ $(es, { children: [
      /* @__PURE__ */ d(ts, { dir: m, placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ d(ns, { children: c }),
      /* @__PURE__ */ d(rs, { children: t.map((u) => /* @__PURE__ */ $(
        os,
        {
          value: a(u),
          onSelect: () => {
...
function lt(e, t, r = {
  ...
  return _t(e) && _t(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (_t(t[o]) && o in e && _t(e[o]) ? n[o] = lt(e[o], t[o], r) : r.clone ? n[o] = _t(t[o]) ? is(t[o]) : t[o] : n[o] = t[o]);
  }), n;
}
var mo = { exports: {} }, en = { exports: {} }, ce = {};
...
function Jp() {
  return Pa || (Pa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = f, C = l, I = i, R = t, _ = m, k = n, M = h, j = p, z = r, G = a, B = o, W = v, te = !1;
    function V(F) {
...
var $a;
function ss() {
  return $a || ($a = 1, process.env.NODE_ENV === "production" ? en.exports = Kp() : en.exports = Jp()), en.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var Jn, Ma;
function ls() {
  return Ma || (Ma = 1, Jn = Function.call.bind(Object.prototype.hasOwnProperty)), Jn;
}
var Zn, Aa;
function Qp() {
  if (Aa)
...
function ed() {
  if (Da)
    return Qn;
  Da = 1;
  var e = ss(), t = Zp(), r = Do(), n = ls(), o = Qp(), a = function() {
  };
  ...
  return Qn = function(l, c) {
    ...
    function _() {
      function S(L, X, Y, H, K) {
        return z(L[X]) ? null : new u("Invalid " + H + " `" + K + "` supplied to " + ("`" + Y + "`, expected a ReactNode."));
      }
      return b(S);
    }
...
if (process.env.NODE_ENV !== "production") {
  var rd = ss(), nd = !0;
  mo.exports = ed()(rd.isElement, nd);
} else
  mo.exports = td()();
var od = mo.exports;
const s = /* @__PURE__ */ Xp(od);
function ad(e) {
  const {
    prototype: t = {}
  } = e;
...
function cs(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !ad(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ps = lr(s.element, cs);
ps.isRequired = lr(s.element.isRequired, cs);
const zr = ps;
function id(e) {
  const {
    prototype: t = {}
...
function sd(e, t, r, n, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof a == "function" && !id(a) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ld = lr(s.elementType, sd), cd = "exact-prop: ​";
function ds(e) {
...
function dd() {
  return La || (La = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var T = i, C = a, I = e, R = c, _ = r, k = g, M = v, j = t, z = o, G = n, B = f, W = m, te = !1, V = !1;
    function S(A) {
...
process.env.NODE_ENV === "production" ? ho.exports = pd() : ho.exports = dd();
var dn = ho.exports;
...
const hd = s.oneOfType([s.func, s.object]), jo = hd;
function tt(e) {
  if (typeof e != "string")
...
const yd = typeof window < "u" ? N.useLayoutEffect : N.useEffect, jt = yd;
let Va = 0;
function wd(e) {
...
function Sd(e) {
  ...
  return !!(r === "INPUT" && Cd[t] && !e.readOnly || r === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function Od(e) {
  e.metaKey || e.altKey || e.ctrlKey || (On = !0);
}
function to() {
  On = !1;
}
function Rd() {
  this.visibilityState === "hidden" && bo && (On = !0);
}
function Pd(e) {
  e.addEventListener("keydown", Od, !0), e.addEventListener("mousedown", to, !0), e.addEventListener("pointerdown", to, !0), e.addEventListener("touchstart", to, !0), e.addEventListener("visibilitychange", Rd, !0);
}
function $d(e) {
  const {
    target: t
...
function gs() {
  const e = N.useCallback((o) => {
    o != null && Pd(o.ownerDocument);
  }, []), t = N.useRef(!1);
  function r() {
    return t.current ? (bo = !0, Td.start(100, () => {
      bo = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
    return $d(o) ? (t.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: t,
    onFocus: n,
...
function ys(e, t, ...r) {
  return e[t] === void 0 ? null : vs(e, t, ...r);
}
function vo() {
  return null;
}
ys.isRequired = vs;
vo.isRequired = vo;
const ws = process.env.NODE_ENV === "production" ? vo : ys;
function xs(e, t) {
  const r = P({}, t);
...
function jd(e, t = Number.MIN_SAFE_INTEGER, r = Number.MAX_SAFE_INTEGER) {
...
const Bd = ["values", "unit", "step"], Ld = (e) => {
...
function Fd(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = ge(e, Bd), a = Ld(t), i = Object.keys(a);
  function l(g) {
...
const Vd = {
  borderRadius: 4
}, zd = Vd, Ud = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, Nt = Ud;
function Sr(e, t) {
  return t ? lt(e, t, {
    clone: !1
...
function Ne(e) {
  const {
    ...
    if (i[t] == null)
      return null;
    const l = i[t], c = i.theme, f = Rn(c, n) || {};
    return pt(i, l, (v) => {
      let g = fn(f, o, v);
...
const Xd = {
  ...
  if (e.length > 2)
    if (Wa[e])
      ...
      return [e];
  const [t, r] = e.split(""), n = Xd[t], o = Yd[r] || "";
  return Array.isArray(o) ? o.map((a) => n + a) : [n + o];
}), Pn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], $n = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Kd = [...Pn, ...$n];
function Hr(e, t, r, n) {
  var o;
...
function Zd(e, t, r, n) {
  if (t.indexOf(r) === -1)
    return null;
  const o = qd(r), a = Jd(o, n), i = e[r];
  return pt(e, i, a);
}
function Ts(e, t) {
  const r = Ns(e.theme);
  return Object.keys(e).map((n) => Zd(e, t, n, r)).reduce(Sr, {});
}
function ye(e) {
  return Ts(e, Pn);
}
ye.propTypes = process.env.NODE_ENV !== "production" ? Pn.reduce((e, t) => (e[t] = Nt, e), {}) : {};
ye.filterProps = Pn;
function we(e) {
  return Ts(e, $n);
}
we.propTypes = process.env.NODE_ENV !== "production" ? $n.reduce((e, t) => (e[t] = Nt, e), {}) : {};
we.filterProps = $n;
process.env.NODE_ENV !== "production" && Kd.reduce((e, t) => (e[t] = Nt, e), {});
function Qd(e = 8) {
  if (e.mui)
    return e;
  const t = Ns({
...
const eu = qe("border", He), tu = qe("borderTop", He), ru = qe("borderRight", He), nu = qe("borderBottom", He), ou = qe("borderLeft", He), au = qe("borderColor"), iu = qe("borderTopColor"), su = qe("borderRightColor"), lu = qe("borderBottomColor"), cu = qe("borderLeftColor"), pu = qe("outline", He), du = qe("outlineColor"), In = (e) => {
...
_n(eu, tu, ru, nu, ou, au, iu, su, lu, cu, In, pu, du);
const Mn = (e) => {
...
_n(Mn, An, Dn, uu, fu, mu, hu, gu, bu, vu, yu, wu);
function Jt(e, t) {
  return t === "grey" ? t : e;
}
const xu = Ne({
...
function Iu() {
  ...
  function t(r) {
    ...
    function l(c) {
      ...
      if (!f)
        return null;
      const m = Hd(a.breakpoints), v = Object.keys(m);
      let g = m;
...
function zo(e = {}, ...t) {
  ...
  return f.applyStyles = Mu, f = t.reduce((m, v) => lt(m, v), f), f.unstable_sxConfig = P({}, Fo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return Vo({
      sx: v,
      theme: this
    });
...
const Bu = ["ownerState"], Lu = ["variants"], Fu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Vu(e) {
  return Object.keys(e).length === 0;
}
function zu(e) {
...
const Uu = zo(), Xa = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function tn({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Gu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Xc(i, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: f,
      ...
      overridesResolver: g = Hu(Xa(f))
    } = l, p = ge(l, Fu), h = m !== void 0 ? m : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      f && f !== "Root" && f !== "root" || !1
    ), u = v || !1;
    let b;
    process.env.NODE_ENV !== "production" && c && (b = `${c}-${Xa(f || "Root")}`);
    let w = an;
    f === "Root" || f === "root" ? w = n : f ? w = o : zu(i) && (w = void 0);
    const O = Gc(i, P({
      shouldForwardProp: w,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${tt(f || "")}`), k === void 0 && (k = `Styled(${md(i)})`), _.displayName = k;
      }
...
function Wu(e) {
  ...
  return !t || !t.components || !t.components[r] || !t.components[r].defaultProps ? n : xs(t.components[r].defaultProps, n);
}
function Xu({
  props: e,
  name: t,
...
function Uo(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), jd(e, t, r);
}
function Yu(e) {
  e = e.slice(1);
...
function mn(e, t) {
  return e = Bt(e), t = Uo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, jn(e);
}
function Ku(e, t) {
...
const Qu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Wt = lf, cf = ["mode", "contrastThreshold", "tonalOffset"], Ka = {
...
function Ja(e, t, r, n) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = Ju(e.main, o) : t === "dark" && (e.dark = Ku(e.main, a)));
}
function pf(e = "light") {
  return e === "dark" ? {
    main: Ht[200],
...
function gf(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = ge(e, cf), a = e.primary || pf(t), i = e.secondary || df(t), l = e.error || uf(t), c = e.info || ff(t), f = e.success || mf(t), m = e.warning || hf(t);
  function v(u) {
    const b = qa(u, ro.text.primary) >= r ? ro.text.primary : Ka.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const w = qa(u, b);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ja(u, "light", O, n), Ja(u, "dark", x, n), u.contrastText || (u.contrastText = v(u.main)), u;
  }, p = {
    dark: ro,
    light: Ka
  };
...
const wf = 0.2, xf = 0.14, Ef = 0.12;
function ve(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${wf})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${xf})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Ef})`].join(",");
}
const kf = ["none", ve(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ve(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ve(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ve(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ve(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ve(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ve(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ve(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ve(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ve(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ve(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ve(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ve(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ve(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ve(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ve(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ve(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ve(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ve(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ve(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ve(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ve(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ve(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ve(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Nf = kf, Tf = ["duration", "easing", "delay"], Cf = {
...
function Rf(e) {
  const t = P({}, Cf, e.easing), r = P({}, Sf, e.duration);
  return P({
...
`)), Object.keys(f).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(f).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((m) => `${m} ${typeof i == "string" ? i : ei(i)} ${l} ${typeof c == "string" ? c : ei(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: r
...
const Pf = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, $f = Pf, _f = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function If(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: n = {},
...
`));
  ...
  return f.unstable_sxConfig = P({}, Fo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return Vo({
      sx: v,
      theme: this
    });
...
const Rs = (e) => an(e) && e !== "classes", Af = Gu({
  themeId: Go,
  defaultTheme: Ho,
...
const jf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Bf = (e) => {
  ...
  const n = ft({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = n, p = ge(n, jf), h = /* @__PURE__ */ N.isValidElement(o) && o.type === "svg", u = P({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
function Ps(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${t}Icon`), r.muiName = ti.muiName, /* @__PURE__ */ N.memo(/* @__PURE__ */ N.forwardRef(r));
}
const Ff = {
  configure: (e) => {
...
}, Symbol.toStringTag, { value: "Module" })), zf = /* @__PURE__ */ Yp(Vf);
var ri;
function Uf() {
...
var $s = Ao.default = void 0, Gf = Hf(Uf()), Wf = Jl;
$s = Ao.default = (0, Gf.default)(/* @__PURE__ */ (0, Wf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function _s(e) {
...
function kr(e, t, r) {
  return e === void 0 || _s(e) ? t : P({}, t, {
    ownerState: P({}, t.ownerState, r)
  });
}
const Xf = {
  disableDefaultClasses: !1
}, Yf = /* @__PURE__ */ N.createContext(Xf);
function qf(e) {
  const {
...
function Jf(e) {
  ...
  const i = Is(P({}, o, n)), l = ni(n), c = ni(o), f = t(i), m = Oe(f == null ? void 0 : f.className, r == null ? void 0 : r.className, a, o == null ? void 0 : o.className, n == null ? void 0 : n.className), v = P({}, f == null ? void 0 : f.style, r == null ? void 0 : r.style, o == null ? void 0 : o.style, n == null ? void 0 : n.style), g = P({}, f, r, c, l);
...
function im(e) {
  const t = [], r = [];
  return Array.from(e.querySelectorAll(rm)).forEach((n, o) => {
    const a = nm(n);
    a === -1 || !am(n) || (a === 0 ? t.push(n) : r.push({
      documentOrder: o,
      tabIndex: a,
      node: n
    }));
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const x = Re(h.current), E = (C) => {
      ...
      if ((x.activeElement === f.current || x.activeElement === m.current) && (I = a(h.current)), I.length > 0) {
        var R, _;
        const k = !!((R = b.current) != null && R.shiftKey && ((_ = b.current) == null ? void 0 : _.key) === "Tab"), M = I[0], j = I[I.length - 1];
...
const jr = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  return /* @__PURE__ */ d(N.Fragment, {
    children: i && /* @__PURE__ */ Yc.createPortal(n, i)
  });
});
...
process.env.NODE_ENV !== "production" && (jr["propTypes"] = ds(jr.propTypes));
function cm(e) {
  const t = Re(e);
    ...
    if (cm(n)) {
      ...
      [].forEach.call(l, (c) => {
        r.push({
          ...
          property: "padding-right",
          el: c
        }), c.style.paddingRight = `${oi(c) + i}px`;
      });
    }
    let a;
...
class fm {
  ...
  add(t, r) {
    ...
    const a = no(this.containers, (i) => i.container === r);
  ...
  mount(t, r) {
    const n = no(this.containers, (a) => a.modals.indexOf(t) !== -1), o = this.containers[n];
    o.restore || (o.restore = dm(o, r));
  }
  remove(t, r = !0) {
    const n = this.modals.indexOf(t);
    if (n === -1)
      return n;
    const o = no(this.containers, (i) => i.modals.indexOf(t) !== -1), a = this.containers[o];
...
function bm(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = N.useRef({}), p = N.useRef(null), h = N.useRef(null), u = We(h, v), [b, w] = N.useState(!m), O = hm(c);
  let x = !0;
  ...
  const k = (B) => (W) => {
    ...
    !I()) && (r || (W.stopPropagation(), f && f(W, "escapeKeyDown")));
  }, M = (B) => (W) => {
    var te;
    (te = B.onClick) == null || te.call(B, W), W.target === W.currentTarget && f && f(W, "backdropClick");
  };
  return {
    getRootProps: (B = {}) => {
      const W = Is(e);
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: go(B, c == null ? void 0 : c.props.onEnter),
        onExited: go(W, c == null ? void 0 : c.props.onExited)
      };
    },
    rootRef: u,
    portalRef: R,
...
var Me = "top", Xe = "bottom", Ye = "right", Ae = "left", Xo = "auto", Wr = [Me, Xe, Ye, Ae], nr = "start", Br = "end", vm = "clippingParents", Ds = "viewport", br = "popper", ym = "reference", ii = /* @__PURE__ */ Wr.reduce(function(e, t) {
  return e.concat([t + "-" + nr, t + "-" + Br]);
}, []), js = /* @__PURE__ */ [].concat(Wr, [Xo]).reduce(function(e, t) {
  return e.concat([t, t + "-" + nr, t + "-" + Br]);
}, []), wm = "beforeRead", xm = "read", Em = "afterRead", km = "beforeMain", Nm = "main", Tm = "afterMain", Cm = "beforeWrite", Sm = "write", Om = "afterWrite", Rm = [wm, xm, Em, km, Nm, Tm, Cm, Sm, Om];
function rt(e) {
...
function ar(e, t, r) {
  ...
  var i = Ft(e) ? ze(e) : window, l = i.visualViewport, c = !Bs() && r, f = (n.left + (c && l ? l.offsetLeft : 0)) / o, m = (n.top + (c && l ? l.offsetTop : 0)) / a, v = n.width / o, g = n.height / a;
  return {
    width: v,
    height: g,
    top: m,
...
function Xr(e) {
  for (var t = ze(e), r = si(e); r && Im(r) && dt(r).position === "static"; )
    r = si(r);
  return r && (rt(r) === "html" || rt(r) === "body" && dt(r).position === "static") ? t : r || Mm(e) || t;
}
function Ko(e) {
...
var Dm = function(t, r) {
  ...
  })) : t, Vs(typeof t != "number" ? t : zs(t, Wr));
};
function jm(e) {
  var t, r = e.state, n = e.name, o = e.options, a = r.elements.arrow, i = r.modifiersData.popperOffsets, l = Qe(r.placement), c = Ko(l), f = [Ae, Ye].indexOf(l) >= 0, m = f ? "height" : "width";
  if (!(!a || !i)) {
    var v = Dm(o.padding, r), g = qo(a), p = c === "y" ? Me : Ae, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], w = Xr(a), O = w ? c === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = u / 2 - b / 2, E = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + x, C = Rr(E, T, y), I = c;
...
function li(e) {
  ...
  if (p = M.x, u = M.y, c) {
    var j;
    return Object.assign({}, k, (j = {}, j[E] = O ? "0" : "", j[x] = w ? "0" : "", j.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + u + "px)" : "translate3d(" + p + "px, " + u + "px, 0)", j));
  }
...
function zm(e) {
  ...
  t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, li(Object.assign({}, f, {
    offsets: t.modifiersData.popperOffsets,
    position: t.options.strategy,
    adaptive: i,
    roundOffsets: c
  })))), t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, li(Object.assign({}, f, {
...
function Us(e) {
  return ["html", "body", "#document"].indexOf(rt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && Qo(e) ? e : Us(Bn(e));
}
function Pr(e, t) {
  var r;
  t === void 0 && (t = []);
  var n = Us(e), o = n === ((r = e.ownerDocument) == null ? void 0 : r.body), a = ze(n), i = o ? [a].concat(a.visualViewport || [], Qo(n) ? n : []) : n, l = t.concat(i);
  return o ? l : (
...
function pi(e, t, r) {
  return t === Ds ? wo(Ym(e, r)) : Ft(t) ? Km(t, r) : wo(qm(Tt(e)));
}
function Jm(e) {
  var t = Pr(Bn(e)), r = ["absolute", "fixed"].indexOf(dt(e).position) >= 0, n = r && Ge(e) ? Xr(e) : e;
  return Ft(n) ? t.filter(function(o) {
    return Ft(o) && Ls(o, n) && rt(o) !== "body";
  }) : [];
}
function Zm(e, t, r, n) {
  var o = t === "clippingParents" ? Jm(e) : [].concat(t), a = [].concat(o, [r]), i = a[0], l = a.reduce(function(c, f) {
    var m = pi(e, f, n);
...
function Lr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? vm : l, f = r.rootBoundary, m = f === void 0 ? Ds : f, v = r.elementContext, g = v === void 0 ? br : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, w = Vs(typeof b != "number" ? b : zs(b, Wr)), O = g === br ? ym : br, x = e.rects.popper, E = e.elements[h ? O : g], y = Zm(Ft(E) ? E : E.contextElement || Tt(e.elements.popper), c, m, i), T = ar(e.elements.reference), C = Hs({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
  }), I = wo(Object.assign({}, x, C)), R = g === br ? I : T, _ = {
...
function Qm(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, a = r.rootBoundary, i = r.padding, l = r.flipVariations, c = r.allowedAutoPlacements, f = c === void 0 ? js : c, m = ir(n), v = m ? l ? ii : ii.filter(function(h) {
    return ir(h) === m;
...
function th(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, w = Qe(b), O = w === b, x = c || (O || !h ? [ln(b)] : eh(b)), E = [b].concat(x).reduce(function(H, K) {
      return H.concat(Qe(K) === Xo ? Qm(t, {
        placement: K,
        boundary: m,
        rootBoundary: v,
        padding: f,
      ...
      var k = E[_], M = Qe(k), j = ir(k) === nr, z = [Me, Xe].indexOf(M) >= 0, G = z ? "width" : "height", B = Lr(t, {
        placement: k,
        boundary: m,
        rootBoundary: v,
        altBoundary: g,
...
function nh(e) {
  var t = e.state, r = e.name, n = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, i = Lr(t, {
    ...
    altBoundary: !0
  }), c = di(i, n), f = di(l, o, a), m = ui(c), v = ui(f);
  t.modifiersData[r] = {
...
function ih(e) {
  var t = e.state, r = e.options, n = e.name, o = r.offset, a = o === void 0 ? [0, 0] : o, i = js.reduce(function(m, v) {
    return m[v] = ah(v, t.rects, a), m;
...
function dh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Lr(t, {
    ...
    padding: v,
    altBoundary: m
  }), w = Qe(t.placement), O = ir(t.placement), x = !O, E = Ko(w), y = ph(E), T = t.modifiersData.popperOffsets, C = t.rects.reference, I = t.rects.popper, R = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, _ = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
  ...
  if (T) {
    if (a) {
      var j, z = E === "y" ? Me : Ae, G = E === "y" ? Xe : Ye, B = E === "y" ? "height" : "width", W = T[E], te = W + b[z], V = W - b[G], S = p ? -I[B] / 2 : 0, L = O === nr ? C[B] : I[B], X = O === nr ? -I[B] : -C[B], Y = t.elements.arrow, H = p && Y ? qo(Y) : {
        width: 0,
        height: 0
      }, K = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Fs(), q = K[z], Z = K[G], J = Rr(0, C[B], H[B]), Q = x ? C[B] / 2 - S - J - q - _.mainAxis : L - J - q - _.mainAxis, ee = x ? -C[B] / 2 + S + J + Z + _.mainAxis : X + J + Z + _.mainAxis, ie = t.elements.arrow && Xr(t.elements.arrow), F = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = (j = k == null ? void 0 : k[E]) != null ? j : 0, A = W + Q - re - F, se = W + ee - re, Te = Rr(p ? gn(te, A) : te, W, p ? At(V, se) : V);
      T[E] = Te, M[E] = Te - W;
    }
    if (l) {
      var $e, ke = E === "x" ? Me : Ae, Ct = E === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + b[ke], at = _e - b[Ct], Ce = [Me, Ae].indexOf(w) !== -1, Vt = ($e = k == null ? void 0 : k[y]) != null ? $e : 0, St = Ce ? Be : _e - C[ot] - I[ot] - Vt + _.altAxis, cr = Ce ? _e + C[ot] + I[ot] - Vt - _.altAxis : at, Kr = p && Ce ? Am(St, _e, cr) : Rr(p ? St : Be, _e, p ? cr : at);
      T[y] = Kr, M[y] = Kr - _e;
    }
    t.modifiersData[n] = M;
  }
...
function gh(e, t, r) {
  r === void 0 && (r = !1);
  var n = Ge(t), o = Ge(t) && hh(t), a = Tt(t), i = ar(e, o, r), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Qo(a)) && (l = mh(t)), Ge(t) ? (c = ar(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Zo(a))), {
  ...
  return function(l, c, f) {
    ...
    var m = {
      ...
      setOptions: function(w) {
        ...
        var x = vh(wh([].concat(n, m.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (mi(O, x)) {
            m.rects = {
              reference: gh(O, Xr(x), m.options.strategy === "fixed"),
              popper: qo(x)
...
var Eh = [Gm, ch, Um, _m, sh, rh, uh, Lm, oh], kh = /* @__PURE__ */ xh({
  defaultModifiers: Eh
});
const Gs = "Popper";
function Nh(e) {
...
tm(Gs, ["root"]);
const Th = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Ch = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Sh(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const Rh = () => ut({
  root: ["root"]
}, qf(Nh)), Ph = {}, $h = /* @__PURE__ */ N.forwardRef(function(t, r) {
  var n;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, b = ge(t, Th), w = N.useRef(null), O = We(w, r), x = N.useRef(null), E = We(x, g), y = N.useRef(E);
  jt(() => {
    y.current = E;
  }, [E]), N.useImperativeHandle(g, () => x.current, []);
  const T = Sh(m, i), [C, I] = N.useState(T), [R, _] = N.useState(bn(o));
  N.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && R && Ln(R) && R.nodeType === 1) {
...
`));
  ...
  const M = Rh(), j = (n = h.root) != null ? n : "div", z = Lt({
    elementType: j,
  ...
  const {
    ...
    slotProps: b = {},
    slots: w = {}
  } = t, O = ge(t, Ch), [x, E] = N.useState(!0), y = () => {
    E(!1);
  }, T = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const _ = bn(n);
    C = _ && Ln(_) ? Re(_).body : Re(null).body;
  }
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || Oh(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
const Xs = U.createContext(null);
var Mh = function(t) {
  return t.scrollTop;
}, Nr = "unmounted", Rt = "exited", Pt = "entering", Kt = "entered", Eo = "exiting", mt = /* @__PURE__ */ function(e) {
  _h(t, e);
  function t(n, o) {
    var a;
  ...
  return r.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== Pt && i !== Kt && (a = Pt) : (i === Pt || i === Kt) && (a = Eo);
    }
...
const Ah = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function ko(e) {
  return `scale(${e}, ${e ** 2})`;
}
const Dh = {
...
}, oo = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), ea = /* @__PURE__ */ N.forwardRef(function(t, r) {
  const {
    addEndListener: n,
    appear: o = !0,
    children: a,
    ...
    TransitionComponent: b = Ys
  } = t, w = ge(t, Ah), O = Er(), x = N.useRef(), E = Yr(), y = N.useRef(null), T = We(y, a.ref, r), C = (G) => (B) => {
    if (G) {
      const W = y.current;
      B === void 0 ? G(W) : G(W, B);
    }
    ...
    let S;
    u === "auto" ? (S = E.transitions.getAutoHeightDuration(G.clientHeight), x.current = S) : S = W, G.style.transition = [E.transitions.create("opacity", {
      duration: S,
      delay: te
    }), E.transitions.create("transform", {
      duration: oo ? S : S * 0.666,
      delay: te,
      easing: V
    })].join(","), c && c(G, B);
  }), _ = C(f), k = C(p), M = C((G) => {
    ...
    let V;
    u === "auto" ? (V = E.transitions.getAutoHeightDuration(G.clientHeight), x.current = V) : V = B, G.style.transition = [E.transitions.create("opacity", {
      duration: V,
      delay: W
    }), E.transitions.create("transform", {
      duration: oo ? V : V * 0.666,
      delay: oo ? W : W || V * 0.333,
      easing: te
    })].join(","), G.style.opacity = 0, G.style.transform = ko(0.75), v && v(G);
  }), j = C(g);
  return /* @__PURE__ */ d(b, P({
    ...
    onExiting: k,
    addEndListener: (G) => {
      u === "auto" && O.start(x.current || 0, G), n && n(y.current, G);
    },
...
const No = ea, jh = (e) => {
...
}, gi = jh, Bh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Lh = Pe(Ws, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = Ss(), a = ft({
    ...
    slots: x,
    slotProps: E
  } = a, y = ge(a, Bh), T = (n = x == null ? void 0 : x.root) != null ? n : c == null ? void 0 : c.Root, C = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const Vh = kt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), yt = Vh, zh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Uh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Hh = (e) => {
...
const Zs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const T = ft({
    ...
    TransitionProps: re
  } = T, A = ge(T, zh), se = /* @__PURE__ */ N.isValidElement(I) ? I : /* @__PURE__ */ d("span", {
    children: I
  }), Te = Yr(), $e = Te.direction === "rtl", [ke, Ct] = N.useState(), [_e, ot] = N.useState(null), Be = N.useRef(!1), at = z || V, Ce = Er(), Vt = Er(), St = Er(), cr = Er(), [Kr, oa] = hs({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const aa = (ne) => {
    ...
    (ne) => {
      bi.start(800 + L, () => {
        nn = !1;
      }), oa(!1), Y && it && Y(ne), Ce.start(Te.transitions.duration.shortest, () => {
        Be.current = !1;
      });
    }
  ), Vn = (ne) => {
    Be.current && ne.type !== "touchstart" || (ke && ke.removeAttribute("title"), Vt.clear(), St.clear(), B || nn && W ? Vt.start(nn ? W : B, () => {
      aa(ne);
    }) : aa(ne));
  }, ia = (ne) => {
    Vt.clear(), St.start(L, () => {
    ...
    onFocus: Fl,
    ref: Vl
  } = gs(), [, la] = N.useState(!1), ca = (ne) => {
    Ll(ne), sa.current === !1 && (la(!1), ia(ne));
  }, pa = (ne) => {
    ke || Ct(ne.currentTarget), Fl(ne), sa.current === !0 && (la(!0), Vn(ne));
  }, da = (ne) => {
    Be.current = !0;
    const Le = se.props;
    Le.onTouchStart && Le.onTouchStart(ne);
  }, ua = Vn, fa = ia, zl = (ne) => {
    da(ne), St.clear(), Ce.clear(), Jr(), pr.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", cr.start(te, () => {
      document.body.style.WebkitUserSelect = pr.current, Vn(ne);
    });
  }, Ul = (ne) => {
  ...
  !ie && ie !== 0 && (it = !1);
  const zn = N.useRef(), Gl = (ne) => {
    const Le = se.props;
    Le.onMouseMove && Le.onMouseMove(ne), vr = {
      x: ne.clientX,
      y: ne.clientY
    }, zn.current && zn.current.update();
  }, dr = {}, Un = typeof ie == "string";
  k ? (dr.title = !it && Un && !j ? ie : null, dr["aria-describedby"] = it ? Fn : null) : (dr["aria-label"] = Un ? ie : null, dr["aria-labelledby"] = it && !Un ? Fn : null);
...
`));
  ...
  const ur = {};
  G || (Ue.onTouchStart = zl, Ue.onTouchEnd = Ul), j || (Ue.onMouseOver = on(ua, Ue.onMouseOver), Ue.onMouseLeave = on(fa, Ue.onMouseLeave), at || (ur.onMouseOver = ua, ur.onMouseLeave = fa)), M || (Ue.onFocus = on(pa, Ue.onFocus), Ue.onBlur = on(ca, Ue.onBlur), at || (ur.onFocus = pa, ur.onBlur = ca)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Wl = N.useMemo(() => {
    var ne;
    let Le = [{
    ...
    touch: Be.current
  }), Hn = Hh(fr), ma = (n = (o = ee.popper) != null ? o : R.Popper) != null ? n : Gh, ha = (a = (i = (l = ee.transition) != null ? l : R.Transition) != null ? i : F) != null ? a : No, ga = (c = (f = ee.tooltip) != null ? f : R.Tooltip) != null ? c : Wh, ba = (m = (v = ee.arrow) != null ? v : R.Arrow) != null ? m : Xh, Xl = kr(ma, P({}, J, (g = Q.popper) != null ? g : _.popper, {
    className: Oe(Hn.popper, J == null ? void 0 : J.className, (p = (h = Q.popper) != null ? h : _.popper) == null ? void 0 : p.className)
  }), fr), Yl = kr(ha, P({}, re, (u = Q.transition) != null ? u : _.transition), fr), ql = kr(ga, P({}, (b = Q.tooltip) != null ? b : _.tooltip, {
    className: Oe(Hn.tooltip, (w = (O = Q.tooltip) != null ? O : _.tooltip) == null ? void 0 : w.className)
  }), fr), Kl = kr(ba, P({}, (x = Q.arrow) != null ? x : _.arrow, {
    className: Oe(Hn.arrow, (E = (y = Q.arrow) != null ? y : _.arrow) == null ? void 0 : E.className)
  }), fr);
  return /* @__PURE__ */ $(N.Fragment, {
    children: [/* @__PURE__ */ N.cloneElement(se, Ue), /* @__PURE__ */ d(ma, P({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ $(ga, P({}, ql, {
          children: [ie, C ? /* @__PURE__ */ d(ba, P({}, Kl, {
            ref: ot
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Ac,
    {
      ...
      children: r ? /* @__PURE__ */ $(Et, { children: [
        vi(a, r, !0),
        /* @__PURE__ */ d(Dc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ d(Ai, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ d($s, {}) }) : vi(i, r, !1)
      ] }) : b
    }
  );
  return n ? /* @__PURE__ */ d(Yh, { title: n, placement: "right", children: /* @__PURE__ */ d("div", { children: w }) }) : w;
}
function el(e) {
...
function qh(e) {
  const [t, r] = fe(void 0), { parentMenuItem: n, parentItemProps: o, menuDefinition: a } = e, i = (f) => {
    ...
    let f = el(a).filter((m) => "menuItem" in m.group);
    if (!(n != null && n.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return f = f.filter(
      (m) => "menuItem" in m.group && m.group.menuItem === n.id
    ), /* @__PURE__ */ d(ta, { ...e, includedGroups: f });
  };
  return /* @__PURE__ */ $(Et, { children: [
    /* @__PURE__ */ d(Qs, { onClick: i, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ d(
      jc,
      {
        anchorEl: t,
...
function ta(e) {
  const { menuDefinition: t, onClick: r, commandHandler: n, includedGroups: o } = e, { items: a, allowForLeadingIcons: i } = xt(() => {
    const m = o && o.length > 0 ? o : (
      ...
      el(t).filter((h) => !("menuItem" in h.group))
  ...
  return /* @__PURE__ */ $(
    Di,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d(Bc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ d(
          Jh,
          {
            commandHandler: e,
            menuDefinition: t,
...
const tl = /* @__PURE__ */ N.createContext({});
process.env.NODE_ENV !== "production" && (tl.displayName = "ListContext");
const eg = tl;
function tg(e) {
  return nt("MuiList", e);
}
kt("MuiList", ["root", "padding", "dense", "subheader"]);
const rg = ["children", "className", "component", "dense", "disablePadding", "subheader"], ng = (e) => {
  const {
    classes: t,
    disablePadding: r,
    dense: n,
  ...
  return /* @__PURE__ */ d(eg.Provider, {
    value: v,
    children: /* @__PURE__ */ $(og, P({
      as: i,
...
const ag = rl, ig = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function ao(e, t, r) {
...
const ol = /* @__PURE__ */ N.forwardRef(function(t, r) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: n,
  ...
  } = t, g = ge(t, ig), p = N.useRef(null), h = N.useRef({
    keys: [],
    repeating: !0,
  ...
  const u = (x) => {
    ...
    if (y === "ArrowDown")
      x.preventDefault(), yr(E, T, f, c, ao);
    else if (y === "ArrowUp")
      x.preventDefault(), yr(E, T, f, c, yi);
    else if (y === "Home")
      x.preventDefault(), yr(E, null, f, c, ao);
    else if (y === "End")
      x.preventDefault(), yr(E, null, f, c, yi);
    else if (y.length === 1) {
      ...
      const _ = T && !C.repeating && nl(T, C);
      C.previousKeyMatched && (_ || yr(E, T, !1, c, ao, C)) ? x.preventDefault() : C.previousKeyMatched = !1;
    }
    m && m(x);
  }, b = We(p, r);
  let w = -1;
...
const sg = ol, lg = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], cg = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  const n = Yr(), o = {
    ...
    timeout: w = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: O = Ys
  } = t, x = ge(t, lg), E = N.useRef(null), y = We(E, l.ref, r), T = (z) => (G) => {
    if (z) {
      const B = E.current;
      G === void 0 ? z(B) : z(B, G);
    }
...
const ug = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], fg = (e) => {
  const {
    classes: t,
    invisible: r
  } = e;
  ...
  const i = ft({
    ...
    slotProps: h = {},
    slots: u = {},
    TransitionComponent: b = pg,
    transitionDuration: w
  } = i, O = ge(i, ug), x = P({}, i, {
    component: f,
    invisible: g
  }), E = fg(x), y = (n = h.root) != null ? n : v.root;
  return /* @__PURE__ */ d(b, P({
    in: p,
    timeout: w
  }, O, {
...
const bg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], vg = (e) => {
  const {
    open: t,
    exited: r,
    classes: n
  ...
  const Z = (n = (o = z == null ? void 0 : z.root) != null ? o : w.Root) != null ? n : yg, J = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : w.Backdrop) != null ? a : m, Q = (l = j == null ? void 0 : j.root) != null ? l : O.root, ee = (c = j == null ? void 0 : j.backdrop) != null ? c : O.backdrop, ie = Lt({
    elementType: Z,
    externalSlotProps: Q,
...
const kg = ["className", "component", "elevation", "square", "variant"], Ng = (e) => {
  const {
    square: t,
    elevation: r,
    variant: n,
  ...
  return P({
    ...
    backgroundImage: `linear-gradient(${mn("#fff", gi(t.elevation))}, ${mn("#fff", gi(t.elevation))})`
  }, e.vars && {
...
const Og = ["onEntering"], Rg = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], Pg = ["slotProps"];
function wi(e, t) {
  let r = 0;
...
const $g = (e) => {
  ...
  const i = ft({
    ...
    TransitionComponent: T = No,
    transitionDuration: C = "auto",
    TransitionProps: {
      onEntering: I
    } = {},
    disableScrollLock: R = !1
  } = i, _ = ge(i.TransitionProps, Og), k = ge(i, Rg), M = (n = E == null ? void 0 : E.paper) != null ? n : O, j = N.useRef(), z = We(j, M.ref), G = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
    ...
    const re = cn(c), A = re && re.nodeType === 1 ? re : Re(j.current).body, se = A.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    return {
      top: se.top + wi(se, f.vertical),
      left: se.left + xi(se, f.horizontal)
    };
...
`)), b !== null && ke < b) {
  ...
  }, [c, v, W, te, b]), [S, L] = N.useState(w), X = N.useCallback(() => {
    const re = j.current;
    if (!re)
      return;
    const A = V(re);
  ...
  const q = h || (c ? Re(cn(c)).body : void 0), Z = (o = x == null ? void 0 : x.root) != null ? o : _g, J = (a = x == null ? void 0 : x.paper) != null ? a : cl, Q = Lt({
    elementType: J,
...
const Ag = ["onEntering"], Dg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], jg = {
  vertical: "top",
  horizontal: "right"
}, Bg = {
  vertical: "top",
  ...
  const a = ft({
    ...
    slots: O = {},
    slotProps: x = {}
  } = a, E = ge(a.TransitionProps, Ag), y = ge(a, Dg), T = Yr(), C = T.direction === "rtl", I = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: w
  }), R = Lg(I), _ = i && !f && g, k = N.useRef(null), M = (V, S) => {
...
`)), V.props.disabled || (w === "selectedMenu" && V.props.selected || z === -1) && (z = S));
  ...
  const G = (n = O.paper) != null ? n : Vg, B = (o = x.paper) != null ? o : p, W = Lt({
    elementType: O.root,
  ...
  return /* @__PURE__ */ d(Fg, P({
    onClose: v,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: C ? "right" : "left"
    },
    transformOrigin: C ? jg : Bg,
    slots: {
      paper: G,
      root: O.root
    },
...
const vt = "scrBook", Xg = "scrRef", $t = "source", Yg = "details", qg = "Scripture Reference", Kg = "Scripture Book", ul = "Type", Jg = "Details";
function Zg(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      cell: (n) => {
        ...
        return n.row.getIsGrouped() ? he.bookNumberToEnglishName(o.start.bookNum) : n.row.groupingColumnId === vt ? Gn(o.start) : void 0;
      },
      getGroupingValue: (n) => n.start.bookNum,
      sortingFn: (n, o) => uo(n.original.start, o.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id: $t,
      header: r ? (e == null ? void 0 : e.typeColumnName) ?? ul : void 0,
    ...
    },
    {
      ...
      id: Yg,
      header: (e == null ? void 0 : e.detailsColumnName) ?? Jg,
      cell: (n) => n.getValue(),
      enableGrouping: !1
    }
  ];
...
const Qg = (e) => {
  ...
  let r = 0;
  return e.end && ({ offset: r } = e.end), !e.end || uo(e.start, e.end) === 0 ? `${Wn(e.start)}+${t}` : `${Wn(e.start)}+${t}-${Wn(e.end)}+${r}`;
}, ki = (e) => `${Qg({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function i0({
  sources: e,
  ...
  Je(() => {
    if (l) {
      ...
      if (_.length === 1) {
        const k = u.find((M) => ki(M) === _[0]) || void 0;
        k && l(k);
      }
    }
  }, [p, u, l, w]);
  const O = o ?? Kg, x = a ?? ul, E = [
    ...
    !t && /* @__PURE__ */ $(
      _r,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Qt, { position: "item-aligned", children: /* @__PURE__ */ d(Cp, { children: E.map((R) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ $(Tn, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ d(Cn, { children: w.getHeaderGroups().map((R) => /* @__PURE__ */ d(wt, { children: R.headers.filter((_) => _.column.columnDef.header).map((_) => (
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ $(
                    xe,
                    {
                      ...
                      children: [
                        ...
                        !R.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ d($i, {}) : /* @__PURE__ */ d(hc, {})),
                        " ",
...
const fl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Root,
  {
...
fl.displayName = je.List.displayName;
...
const tb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Trigger,
  {
    ref: r,
    ...t,
...
)), hl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Content,
  {
    ref: r,
    className: D(
...
hl.displayName = je.Content.displayName;
function c0({
  tabList: e,
  onSearch: t,
  searchPlaceholder: r,
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ $(fl, { dir: a, children: [
      /* @__PURE__ */ d(ml, { children: e.map((i) => /* @__PURE__ */ d(tb, { value: i.value, children: i.value }, i.key)) }),
      e.map((i) => /* @__PURE__ */ d(hl, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
const gl = U.forwardRef(({ className: e, orientation: t = "horizontal", decorative: r = !0, ...n }, o) => /* @__PURE__ */ d(
  Bi.Root,
  {
    ref: o,
    decorative: r,
...
gl.displayName = Bi.Root.displayName;
function p0({ children: e }) {
...
const qr = yn(({ className: e, ...t }, r) => /* @__PURE__ */ d(gc, { size: 35, className: D("pr-animate-spin", e), ...t, ref: r }));
...
), bl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Li.Root,
  {
    ref: r,
    className: D("pr-twp pr-font-sans", rb(), e),
    ...t
  }
));
bl.displayName = Li.Root.displayName;
function m0({
  id: e,
  isDisabled: t = !1,
  hasError: r = !1,
...
function h0({
  ...
  const a = Mt(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Uc, { position: "static", id: n, children: /* @__PURE__ */ $(
    Hc,
    {
...
), ob = U.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: D(nb({ variant: t }), e), ...r }));
ob.displayName = "Alert";
...
ab.displayName = "AlertTitle";
const ib = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: D("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
...
const pb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: D("pr-text-sm pr-text-muted-foreground", e), ...t }));
pb.displayName = "CardDescription";
const db = U.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: D("pr-p-6 pr-pt-0", e), ...t })
);
db.displayName = "CardContent";
...
const fb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $(
  xr.Root,
  {
    ref: r,
    className: D(
...
fb.displayName = xr.Root.displayName;
const mb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  fo.Root,
  {
    className: D(
...
mb.displayName = fo.Root.displayName;
const b0 = je.Root, hb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.List,
  {
    ref: r,
    className: D(
...
hb.displayName = je.List.displayName;
...
gb.displayName = je.Trigger.displayName;
const bb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.Content,
  {
    ref: r,
    className: D(
...
bb.displayName = je.Content.displayName;
const vl = xn(
...
), vb = U.forwardRef(({ className: e, variant: t, size: r, ...n }, o) => /* @__PURE__ */ d(
  Fi.Root,
  {
    ref: o,
    className: D(vl({ variant: t, size: r, className: e })),
    ...n
  }
));
vb.displayName = Fi.Root.displayName;
const yl = U.createContext({
  size: "default",
  variant: "default"
}), yb = U.forwardRef(({ className: e, variant: t, size: r, children: n, ...o }, a) => /* @__PURE__ */ d(
  En.Root,
  {
    ref: a,
    className: D(
...
yb.displayName = En.Root.displayName;
const wb = U.forwardRef(({ className: e, children: t, variant: r, size: n, ...o }, a) => {
  const i = U.useContext(yl);
  return /* @__PURE__ */ d(
    En.Item,
    {
      ref: a,
...
wb.displayName = En.Item.displayName;
function v0({
  isInstalling: e,
  handleClick: t,
  buttonText: r,
  ...
  return /* @__PURE__ */ d(
    xe,
    {
      ...
      children: e ? /* @__PURE__ */ d(qr, { size: 15 }) : /* @__PURE__ */ $(Et, { children: [
        /* @__PURE__ */ d(bc, { size: 25, className: D("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
...
`) !== -1 || w && v;
      ...
      const x = c._, E = c.o;
      let y;
      c.o = !0, O ? (c._ = !1, y = b.replace(Ci, `

`)) : (c._ = !0, y = b.replace(Ci, ""));
      const T = l(y, c);
...
function vv(e, t, r) {
  r._ = !0;
  const n = Oi(e[1], t, r), o = e[2].replace(Kb, "").split("|").map(bv), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(f) {
      return Oi(f, l, c);
    });
...
var ae;
function kv(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || gv, t.namedCodesToUnicode = t.namedCodesToUnicode ? It({}, Ti, t.namedCodesToUnicode) : Ti;
  const r = t.createElement || N.createElement;
  function n(p, h, ...u) {
    const b = co(t.overrides, `${p}.props`, {});
    return r(function(w, O) {
      const x = co(O, w);
      return x ? typeof x == "function" || typeof x == "object" && "render" in x ? x : co(O, `${w}.component`, w) : w;
    }(p, t.overrides), It({}, h, b, { className: Ev(h == null ? void 0 : h.className, b.className) || void 0 }), ...u);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = Xb.test(p) === !1);
    const u = m(f(h ? p : `${p.trimEnd().replace(sv, "")}
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, w) {
      ...
      if (O !== -1) {
        ...
        }(b.slice(O + 1).trim()), y = Ni[x] || x, T = u[y] = function(C, I) {
        ...
        typeof T == "string" && (Co.test(T) || So.test(T)) && (u[y] = N.cloneElement(o(T.trim()), { key: w }));
      } else
        b !== "style" && (u[Ni[b] || b] = !0);
      return u;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: st(wl), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(Cb, ""), u) }), h: (p, h, u) => n("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: wr(Sb), i: ae.HIGH, l: so, h: (p, h, u) => n("br", { key: u.k }) }, breakThematic: { t: st(Ob), i: ae.HIGH, l: so, h: (p, h, u) => n("hr", { key: u.k }) }, codeBlock: { t: st(El), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => n("pre", { key: u.k }, n("code", It({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: st(xl), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: bt(Rb), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => n("code", { key: u.k }, p.v) }, footnote: { t: st(_b), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: lo }, footnoteReference: { t: gt(Ib), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B) }, n("sup", { key: u.k }, p.v)) }, gfmTask: { t: gt(Ab), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => n("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: st(t.enforceAtxHeadings ? Nl : kl), i: ae.HIGH, l: (p, h, u) => ({ v: pn(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => n(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: st(Tl), i: ae.MAX, l: (p, h, u) => ({ v: pn(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: wr(Cl), i: ae.HIGH, l: () => ({}), h: lo }, image: { t: bt(mv), i: ae.HIGH, l: (p) => ({ D: p[1], B: Pi(p[2]), F: p[3] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Yt(p.B) }) }, link: { t: gt(fv), i: ae.LOW, l: (p, h, u) => ({ v: wv(h, p[1], u), B: Pi(p[2]), F: p[3] }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: gt(Vb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : gt(Lb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: gt(Fb), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
    return Nb.test(u) || (u = "mailto:" + u), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: u, type: "link" };
  } }, orderedList: Si(n, 1), unorderedList: Si(n, 2), newlineCoalescer: { t: st(Pb), i: ae.LOW, l: so, h: () => `
` }, paragraph: { t: yv, i: ae.LOW, l: io, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: gt(Ub), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: lo }, refImage: { t: bt(Hb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Yt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: gt(Gb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(Wb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Yt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: st(Sl), i: ae.HIGH, l: vv, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, w) {
    return n("th", { key: w, style: Ri(p, w) }, h(b, u));
  }))), n("tbody", null, p.A.map(function(b, w) {
    return n("tr", { key: w }, b.map(function(O, x) {
      return n("td", { key: x, style: Ri(p, x) }, h(O, u));
    }));
  }))) }, tableSeparator: { t: function(p, h) {
    return h.$ ? (h._ = !0, qb.exec(p)) : null;
  }, i: ae.HIGH, l: function() {
    return { type: "tableSeparator" };
  }, h: () => " | " }, text: { t: wr(iv), i: ae.MIN, l: (p) => ({ v: p[0].replace(Db, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: bt(tv), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: bt(rv), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: bt(av), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: bt(nv), i: ae.LOW, l: io, h: (p, h, u) => n("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: bt(ov), i: ae.LOW, l: io, h: (p, h, u) => n("del", { key: u.k }, h(p.v, u)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: wr(Co), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(lv), w = new RegExp(`^${b}`, "gm"), O = p[3].replace(w, ""), x = (E = O, hv.some((I) => I.test(E)) ? xv : pn);
    var E;
    const y = p[1].toLowerCase(), T = Eb.indexOf(y) !== -1;
    u.N = u.N || y === "a";
    const C = T ? p[3] : x(h, O, u);
    return u.N = !1, { O: a(p[2]), v: C, G: T, H: T ? y : p[1] };
  }, h: (p, h, u) => n(p.H, It({ key: u.k }, p.O), p.G ? p.v : h(p.v, u)) }, c.htmlSelfClosing = { t: wr(So), i: ae.HIGH, l: (p) => ({ O: a(p[2] || ""), H: p[1] }), h: (p, h, u) => n(p.H, It({}, p.O, { key: u.k })) });
  const f = function(p) {
    let h = Object.keys(p);
    function u(b, w) {
      let O = [], x = "";
...
const Nv = (e) => {
  ...
  return N.cloneElement(kv(t, r), n);
};
function E0({ id: e, markdown: t }) {
  return /* @__PURE__ */ d("div", { id: e, className: "pr-prose", children: /* @__PURE__ */ d(Nv, { children: t }) });
}
const Tv = yn((e, t) => /* @__PURE__ */ $(
  xe,
  {
    ref: t,
    ...
    ...e,
    children: [
      /* @__PURE__ */ d(vc, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ d(
        wn,
        {
...
function k0({ id: e, groups: t }) {
  return /* @__PURE__ */ d("div", { id: e, children: /* @__PURE__ */ $(_o, { children: [
    /* @__PURE__ */ d(Xi, { asChild: !0, children: /* @__PURE__ */ d(Tv, {}) }),
    /* @__PURE__ */ d(kn, { children: t.map((r) => /* @__PURE__ */ $("div", { children: [
      /* @__PURE__ */ d(Vr, { children: r.label }),
      /* @__PURE__ */ d(pp, { children: r.items.map((n) => /* @__PURE__ */ d("div", { children: n.itemType === 0 ? /* @__PURE__ */ d(Io, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ d(qi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ d(Nn, {})
    ] }, r.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ $("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            /* @__PURE__ */ d(yc, { className: "pr-mr-1 pr-h-4 pr-w-4" }),
        ...
        /* @__PURE__ */ $("div", { className: "pr-ml-auto pr-flex pr-flex-col pr-space-y-2", children: [
          /* @__PURE__ */ $(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ d(wc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ $(
...
function C0({
  ...
  return /* @__PURE__ */ d("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ $("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ d(Sv, { versionHistory: o }),
...
export {
  ...
  fp as DropdownMenuShortcut,
  Xv as DropdownMenuSub,
  up as DropdownMenuSubContent,
  dp as DropdownMenuSubTrigger,
  Xi as DropdownMenuTrigger,
  y0 as EnableButton,
  Tv as FilterButton,
  k0 as FilterDropdown,
  C0 as Footer,
  Qh as GridMenu,
  Wg as HamburgerMenuButton,
  ...
  gl as Separator,
  p0 as SettingsList,
  u0 as SettingsListHeader,
  d0 as SettingsListItem,
  fb as ShadCnSlider,
  mb as ShadCnSwitch,
  s0 as Slider,
  l0 as Snackbar,
  ...
  fl as VerticalTabs,
  hl as VerticalTabsContent,
  ml as VerticalTabsList,
  tb as VerticalTabsTrigger,
