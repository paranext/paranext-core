...
import { Avatar as Bo, Select as ae, Checkbox as hn, Slot as Jr, Tabs as ye, Menubar as De, ContextMenu as Ht, Progress as gn, Slider as na, Switch as fn } from "radix-ui";
...
function Xa({
  ...
  const B = Re(), U = sd(), [O, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [G, $] = _(
    void 0
...
te.prototype.brand = Yd, te.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Vi(this), En(this), Ve++;
  const t = ht;
...
he({ name: "@lexical/extension/DecoratorText", nodes: () => [ji], register: (t, e, r) => t.registerCommand(bi, (o) => {
  const n = ce();
  if (xi(n) || Te(n)) for (const s of n.getNodes()) ew(s) && s.toggleFormat(o);
  return !1;
}, yi) });
function Fi(t, e) {
  let r;
...
const iw = he({ config: pr({ setOptions: Tn, updateOptions: Tn }), init: ({ $initialEditorState: t = nw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const cw = /* @__PURE__ */ new Set(), Dn = he({ build(t, e, r) {
...
he({ dependencies: [No, Dn], name: "@lexical/extension/HorizontalRule", nodes: () => [Cr], register(t, e, r) {
...
const pw = he({ name: "@lexical/react/ReactProvider" });
function hw() {
...
function Iw({
  ...
  const [e] = Me(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Ow(), d = () => {
  };
    ...
    "div",
    {
      ...
      children: [
        ...
        W && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(tc, {}) }) }),
...
function mu({
  ...
  return /* @__PURE__ */ u(Be, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: fu(t, o, e) }) }) }),
...
function xu({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: vu(t, r) }) }) }),
...
const He = "scrBook", Ju = "scrRef", or = "source", Zu = "details", Qu = "Scripture Reference", tp = "Scripture Book", ls = "Type", ep = "Details";
function rp(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(ou, { children: N.map((S) => /* @__PURE__ */ a(xe, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
...
function cg({
  ...
  const B = Ut(
    ...
    [r, n, g, s]
  ), Jt = mt.find((F) => F.value === t), Ie = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? $c(jt, Pt, {
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          Rr,
          {
            ...
            style: { zIndex: Fe },
            children: t.map((w) => /* @__PURE__ */ a(xe, { value: `${w}`, children: d[cn(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Eo({
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    /* @__PURE__ */ a(Ee, { "aria-label": r, className: n, asChild: !0, id: d, children: /* @__PURE__ */ a(et, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(Nc, {}) }) }),
