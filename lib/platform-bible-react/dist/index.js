...
import b, { forwardRef as Pe, useRef as et, useMemo as B, useState as D, useCallback as z, useLayoutEffect as Vt, createContext as zn, useContext as jn, useEffect as Y, Suspense as ia, createRef as la, Fragment as Sr } from "react";
import { Command as pt } from "cmdk";
import { X as $e, Search as Dr, Check as Tt, Clock as lr, ChevronsLeft as wr, ChevronsRight as cr, ChevronLeft as vn, ChevronRight as pe, ArrowLeft as wa, ArrowRight as ca, Circle as Je, ChevronDown as Qt, BoldIcon as da, ItalicIcon as pa, UnderlineIcon as ua, StrikethroughIcon as ma, Pencil as ha, Trash2 as fa, ArrowUp as Ir, MoreHorizontal as Or, ChevronUp as xn, AtSign as ga, FilterIcon as ba, ArrowLeftIcon as va, ChevronLeftIcon as xa, ChevronRightIcon as ya, ArrowRightIcon as Na, Copy as Vr, Filter as ka, User as _a, Link as Ca, CircleHelp as Ea, ChevronsUpDown as Mr, Star as Ta, FunctionSquare as Ar, SquareSigma as Pr, SquareX as Ra, AlertCircle as yn, CircleCheckIcon as Sa, CircleXIcon as Da, CircleHelpIcon as Ia, ArrowUpIcon as Oa, ArrowDownIcon as Va, ArrowUpDownIcon as Ma, PanelLeft as Aa, PanelRight as Pa, ScrollText as $a, MenuIcon as La, Menu as Ba, EllipsisVertical as za, LoaderCircle as ja, GripVertical as Fa } from "lucide-react";
...
const Os = yt.Root, Vs = yt.Portal, Wr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  yt.Overlay,
  {
    ref: n,
    className: u(
...
Ms.displayName = yt.Description.displayName;
...
function yc({
  ...
  const w = st(), [p, f] = D(!1), [h, m] = D(""), [g, y] = D(""), [k, S] = D("books"), [T, x] = D(void 0), [_, V] = D(!1), R = et(void 0), C = et(void 0), I = et(void 0), N = et(void 0), E = et({}), A = z(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
  ...
  }), [L]), M = B(() => Object.values(F).flat(), [F]), q = B(() => {
    if (!g.trim()) return F;
    const v = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    const { isLetter: j, isDigit: J } = gr(v.key);
    (j || J) && (v.preventDefault(), y((lt) => lt + v.key), C.current.focus(), V(!1));
  }, []);
  return Vt(() => {
    const v = setTimeout(() => {
...
function Dn({
  ...
  const [T, x] = D(!1), _ = d ?? l, V = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], R = (C, I) => {
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ c(oe, { children: [
          ...
          /* @__PURE__ */ r(ae, { children: V(e) ? e.map((C) => /* @__PURE__ */ r(zt, { heading: C.groupHeading, children: C.options.map((I) => R(I, C.groupHeading)) }, C.groupHeading)) : e.map((C) => R(C)) })
        ] })
      }
    )
  ] });
...
const Cc = [
  ...
  const a = et(null), [s, i] = D(void 0), [l, d] = D(void 0), w = z(
    ...
    (m) => {
      ...
      switch (m.key) {
        case "ArrowDown":
          V = Math.min(_ + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          V = Math.max(_ - 1, 0), m.preventDefault();
          break;
        case "Home":
          V = 0, m.preventDefault();
          break;
        case "End":
          V = t.length - 1, m.preventDefault();
          break;
        case " ":
        case "Enter":
...
const uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ii = uo ? Vt : Y, He = { tag: Br };
...
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
...
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function mi(t) {
...
const On = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function xr(t) {
  ...
  const [o] = Rt(), a = function(s, i) {
    ...
    return On(() => s.registerDecoratorListener((w) => {
      ...
      for (let f = 0; f < p.length; f++) {
        const h = p[f], m = r(i, { onError: (y) => s._onError(y), children: r(ia, { fallback: null, children: l[h] }) }), g = s.getElementByKey(h);
...
const Ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
function Ei({ onClear: t }) {
  const [e] = Rt();
  return Ci(() => e.registerCommand(zr, (n) => (e.update(() => {
    if (t == null) {
      const o = te(), a = Ve(), s = Fn();
      o.clear(), o.append(s), a !== null && s.select(), Gn(a) && (a.format = 0);
    } else t();
  }), !0), ss), [e, t]), null;
}
const fo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Vt : Y;
...
function Ai({
  ...
  const [e] = Rt(), [n, o] = D(e), [a, s] = D("paragraph"), [i, l] = Mi(), d = () => {
  };
...
}), ye = Z.Trigger, Ro = Z.Group, Qi = Z.Portal, tl = Z.Sub, el = Z.RadioGroup;
...
So.displayName = Z.SubTrigger.displayName;
...
Do.displayName = Z.SubContent.displayName;
...
Io.displayName = Z.RadioItem.displayName;
...
function kr({
  ...
  }, [t.date, n]), V = B(() => t.user, [t.user]), R = B(
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Eo, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(To, { className: "tw-text-xs tw-font-medium", children: R }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ c(
            "div",
            {
              ...
              onKeyDown: (N) => {
                _o(N), (N.key === "Enter" || N.key === " ") && N.stopPropagation();
              },
              children: [
                /* @__PURE__ */ r(
                  Vn,
...
function rl({
  ...
  const [S, T] = D(_r), [x, _] = D(!1), [V, R] = D(!1), [C, I] = D(!1), [N, E] = D(!1), [A, L] = D(!1), [F, M] = D(void 0), [q, O] = D(!1), [nt, gt] = D(!1);
  Y(() => {
    let v = !0;
    if (!n) {
      O(!1), gt(!1);
  ...
  const it = B(
    ...
    async (v) => {
      const j = Pt(S) ? Mn(S) : void 0, J = await w({
        ...v,
        contents: j,
        assignedUser: F ?? v.assignedUser
      });
      return J && j && wt(), J && F !== void 0 && M(void 0), J;
    },
    [wt, S, w, F]
  );
  return /* @__PURE__ */ r(
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        Me(i, '[tabindex]:not([tabindex="-1"])').forEach((p) => {
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? Me(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
function fl({
  ...
  return d ? V = Array.from({ length: 10 }).map((N, E) => `skeleton-row-${E}`).map((N) => /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(Zt, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(An, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, N)) : ((R = x.getRowModel().rows) == null ? void 0 : R.length) > 0 ? V = x.getRowModel().rows.map((C) => /* @__PURE__ */ r(
    ...
    C.id
  )) : V = /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(Zt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
...
function yl({
  ...
  const [S, T] = D(!1), x = z(
    ...
    const E = t.filter((L) => L.starred).sort((L, F) => L.label.localeCompare(F.label)), A = t.filter((L) => !L.starred).sort((L, F) => {
      const M = e.includes(L.value), q = e.includes(F.value);
      return M && !q ? -1 : !M && q ? 1 : L.label.localeCompare(F.label);
    });
    return [...E, ...A];
  }, [t, e, h]), R = () => {
    n(t.map((E) => E.value));
  ...
  return /* @__PURE__ */ r("div", { id: k, className: g, children: /* @__PURE__ */ c(se, { open: I, onOpenChange: p ?? T, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ c(
      $,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Mr, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(oe, { children: [
      ...
      /* @__PURE__ */ c(ae, { children: [
        ...
        /* @__PURE__ */ r(zt, { children: V.map((E) => /* @__PURE__ */ c(
          Ft,
          {
            value: E.label,
            onSelect: x,
...
function Mc({
  ...
  const l = et(null), d = la(), [w, p] = D("generated"), [f, h] = D("*"), [m, g] = D("f"), y = B(
    () => ({
      ...s,
  ...
  Y(() => {
    ...
    if (_ && pn("note", _)) {
      const C = (V = _.insert.note) == null ? void 0 : V.caller;
      let I = "custom";
  ...
  const k = z(() => {
    var _, V;
    const x = (V = (_ = l.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : V.at(0);
        ...
        /* @__PURE__ */ r(
          El,
          {
            ...
            handleNoteTypeChange: (x) => {
              var V, R, C;
              g(x);
              const _ = (R = (V = l.current) == null ? void 0 : V.getNoteOps(0)) == null ? void 0 : R.at(0);
...
const nn = (t) => t === "asc" ? /* @__PURE__ */ r(Oa, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Va, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ma, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Lc = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Ml = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Hc = Object.freeze([
...
function Xc({
  ...
  const f = _t(n, "%webView_inventory_all%"), h = _t(n, "%webView_inventory_approved%"), m = _t(n, "%webView_inventory_unapproved%"), g = _t(n, "%webView_inventory_unknown%"), y = _t(n, "%webView_inventory_scope_currentBook%"), k = _t(n, "%webView_inventory_scope_chapter%"), S = _t(n, "%webView_inventory_scope_verse%"), T = _t(n, "%webView_inventory_filter_text%"), x = _t(
    n,
    "%webView_inventory_show_additional_items%"
  ), _ = _t(n, "%webView_inventory_no_results%"), [V, R] = D(!1), [C, I] = D("all"), [N, E] = D(""), [A, L] = D([]), F = B(() => {
    const P = t ?? [];
  ...
  }, [V, F]), q = B(() => M.length === 0 ? [] : Al(M, C, N), [M, C, N]), O = B(() => {
    var wt, it;
    if (!V) return d;
  ...
  const nt = (P, W) => {
    ...
    if (M.length === 0 || A.length === 0) return [];
    const P = M.filter((W) => $r(
      V ? W.items : [W.items[0]],
      A
    ));
...
const Po = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Ao.Provider, { value: T, children: /* @__PURE__ */ r(It, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
function lw({
  ...
  const R = B(() => U.allBookIds.filter(
    ...
    (M, q = !1) => {
      if (!q || !_.current) {
        n(
          e.includes(M) ? e.filter((P) => P !== M) : [...e, M]
        ), _.current = M;
        return;
      }
      const O = R.findIndex((P) => P === _.current), nt = R.findIndex((P) => P === M);
      if (O === -1 || nt === -1) return;
      const [gt, xt] = [
        Math.min(O, nt),
        Math.max(O, nt)
      ...
      n(
        e.includes(M) ? e.filter((P) => !mt.includes(P)) : [.../* @__PURE__ */ new Set([...e, ...mt])]
      );
    },
    [e, n, R]
  ), N = (M) => {
    I(M, V.current), V.current = !1;
  }, E = (M, q) => {
    M.preventDefault(), I(q, M.shiftKey);
  }, A = z(
    (M) => {
      const q = sr(R, M).map((O) => O);
      n(
        Ho(R, M, e) ? e.filter((O) => !q.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, R]
  ), L = () => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(H).map((M) => /* @__PURE__ */ r(
      iw,
      {
        section: M,
        availableBookIds: R,
        ...
        children: [
          ...
          /* @__PURE__ */ r(Gt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            oe,
            {
              shouldFilter: !1,
              onKeyDown: (M) => {
                M.key === "Enter" && (V.current = M.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Be,
    ...
    e.length > 0 && /* @__PURE__ */ c("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === fn ? fn : Rr
      ).map((M) => /* @__PURE__ */ r(me, { className: "hover:tw-bg-secondary", variant: "secondary", children: de(M, a) }, M)),
...
Wo.displayName = Q.Root.displayName;
...
Zo.displayName = Q.Trigger.displayName;
...
Qo.displayName = Q.SubTrigger.displayName;
...
ta.displayName = Q.SubContent.displayName;
...
ea.displayName = Q.Content.displayName;
...
ra.displayName = Q.Separator.displayName;
const Ee = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
...
function ad({
  ...
  const w = fw(
    ...
    return k ? `${(V = t[g]) == null ? void 0 : V.autonym} (${k})` : (R = t[g]) == null ? void 0 : R.autonym;
  };
...
const hd = Nt.Trigger, Vw = Nt.Portal, fd = Nt.Close, sa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Nt.Overlay,
  {
    ref: n,
