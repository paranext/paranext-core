...
import u, { useCallback as X, useMemo as G, useState as B, useRef as L, useLayoutEffect as on, createContext as vr, useContext as xr, useEffect as Ct, forwardRef as vn, Fragment as xn } from "react";
...
const ia = vt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Bt : "button", { className: c(ia({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
const la = lt.Portal, Rn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  lt.Overlay,
  {
    ref: n,
    className: c(
...
da.displayName = lt.Content.displayName;
...
pa.displayName = lt.Description.displayName;
...
const Bn = M.allBookIds.filter(
  (t) => !M.isObsolete(M.bookIdToNumber(t))
), rt = Object.fromEntries(
  Bn.map((t) => [t, M.bookIdToEnglishName(t)])
), _a = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon",
...
function Ra(t, e, n, a) {
  const o = X(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const d = e[p - 1], m = Math.max(ut(d), 1);
        a({
          book: d,
          chapterNum: m,
          verseNum: 1
  ...
  return G(() => [
    {
      onClick: o,
      disabled: t.chapterNum === 1 && e.indexOf(t.book) === 0,
    ...
    {
      onClick: s,
      disabled: (t.chapterNum === ut(t.book) || ut(t.book) === -1) && e.indexOf(t.book) === e.length - 1,
      title: "Next chapter",
      icon: n === "ltr" ? wn : sn
    }
  ], [
...
function pn({
  ...
  if (t)
    return /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ut(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      _t,
      {
        value: `${t} ${rt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function js({
  ...
  const o = Y(), [s, i] = B(!1), [w, p] = B(""), [d, m] = B(""), [g, h] = B("books"), [f, v] = B(void 0), C = L(void 0), N = L(void 0), _ = L(void 0), k = L(void 0), D = L({}), O = G(() => a ? a() : Bn, [a]), U = G(() => ({
    ...
    (y) => {
      ...
      if (g === "chapters") {
        if (y.key === "Backspace") {
          y.preventDefault(), y.stopPropagation(), dt();
          return;
        }
        if (S || $) {
      ...
      if ((g === "chapters" || g === "books" && b) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key)) {
        ...
        switch (y.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            ct = q === 0 ? ht : Math.max(1, q - an);
            break;
          case "ArrowDown":
            ct = q === 0 ? 1 : Math.min(ht, q + an);
            break;
          default:
            return;
        }
        ct !== q && (y.preventDefault(), y.stopPropagation(), p(cn(W, ct)), setTimeout(() => {
          const Ft = D.current[ct];
  ...
  return on(() => {
    const y = setTimeout(() => {
      if (s && g === "books" && _.current && k.current) {
        const S = _.current, $ = k.current, W = $.offsetTop, q = S.clientHeight, ht = $.clientHeight, ct = W - q / 2 + ht / 2;
        S.scrollTo({
          top: Math.max(0, ct),
          behavior: "smooth"
        }), p(cn(t.book));
...
function Xs({
  ...
  const m = _e(d, "%webView_bookSelector_currentBook%"), g = _e(d, "%webView_bookSelector_choose%"), h = _e(d, "%webView_bookSelector_chooseBooks%"), [f, v] = B(
    "current book"
    /* CURRENT_BOOK */
  ), C = (N) => {
    v(N), t(N);
...
}), Pn = P.Trigger, In = P.Group, za = P.Portal, Oa = P.Sub, Aa = P.RadioGroup;
function qe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ue.Provider, { value: n, children: /* @__PURE__ */ r(P.Root, { ...e }) });
}
...
jn.displayName = P.SubTrigger.displayName;
...
$n.displayName = P.SubContent.displayName;
...
me.displayName = P.Content.displayName;
...
Xn.displayName = P.Item.displayName;
const Je = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    P.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(P.ItemIndicator, { children: /* @__PURE__ */ r(Et, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Je.displayName = P.CheckboxItem.displayName;
const Fn = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    P.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(P.ItemIndicator, { children: /* @__PURE__ */ r($e, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Fn.displayName = P.RadioItem.displayName;
...
Ke.displayName = P.Label.displayName;
...
he.displayName = P.Separator.displayName;
...
function Ja({
  ...
  var N;
  const [w, p] = B([]), [d, m] = B([]), [g, h] = B({}), [f, v] = B({}), C = kn({
    data: e,
    columns: t,
    getCoreRowModel: _n(),
...
function Hs({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(qe, { children: [
    /* @__PURE__ */ r(Pn, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "default", children: [
...
function ni({
  ...
  const d = pt(n, "%webView_inventory_all%"), m = pt(n, "%webView_inventory_approved%"), g = pt(n, "%webView_inventory_unapproved%"), h = pt(n, "%webView_inventory_unknown%"), f = pt(n, "%webView_inventory_scope_currentBook%"), v = pt(n, "%webView_inventory_scope_chapter%"), C = pt(n, "%webView_inventory_scope_verse%"), N = pt(n, "%webView_inventory_filter_text%"), _ = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [k, D] = B(!1), [O, U] = B("all"), [ot, xt] = B(""), [b, x] = B([]), j = G(() => t.length === 0 ? [] : so(t, o, s), [t, o, s]), T = G(() => {
    if (k) return j;
    const R = [];
    return j.forEach((K) => {
...
const Pe = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Bt : "div",
  {
    ref: a,
...
const go = vt(
  ...
  ({
    ...
    const p = t ? Bt : "button", { state: d } = ye(), m = /* @__PURE__ */ r(
      p,
      {
        ref: w,
    ...
    Kn,
    {
      ...
      children: /* @__PURE__ */ l(Zn, { children: [
        /* @__PURE__ */ l(Be, { children: [
          /* @__PURE__ */ r(Pe, { className: "tw-text-sm", children: s }),
        ...
        /* @__PURE__ */ l(Be, { children: [
          /* @__PURE__ */ r(Pe, { className: "tw-text-sm", children: i }),
...
function ai({
  ...
  const [p, d] = B([]), [m, g] = B([{ id: ft, desc: !1 }]), [h, f] = B({}), v = G(
...
function bn({
  ...
  return /* @__PURE__ */ l(qe, { variant: s, children: [
    /* @__PURE__ */ r(Pn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Hr, {}) }) }),
...
function pi({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(sr, { children: [
      /* @__PURE__ */ r(ir, { children: t.map((i) => /* @__PURE__ */ r(Po, { value: i.value, children: i.value }, i.key)) }),
...
Wo.displayName = Pt.Root.displayName;
...
Zo.displayName = Pt.Image.displayName;
...
Qo.displayName = Pt.Fallback.displayName;
...
const ys = (t, e, n = {}) => {
  ...
  const o = L(null), [s, i] = B(void 0), [w, p] = B(void 0), d = X(
    (h) => {
      i(h);
