...
import { c as v, g as ye, a as Yr, C as Ee, u as ji, T as zt, b as Rt, d as Dt, e as Ot, A as ce, P as $e, f as We, B as G, h as Ie, i as Ae, j as Pe, k as Ne, l as Bi, m as Fi, n as Ui, E as Ki, o as Wa, r as fe, p as qi, q as hn, s as aa, t as oa, L as Ct, R as Xa, v as Wr, D as Da, w as Oa, x as Ma, y as $a, z as gn, F as jr, G as Ja, H as fn, I as Za, J as He, K as kr, M as Ve, N as Le, O as je, S as _r, Q as er, U as Hi, V as Er, W as Ye, X as De, Z as Xe, Y as Re, _ as rr, $ as Qa, a0 as to, a1 as Xr, a2 as eo, a3 as mn, a4 as Gi, a5 as Yi, a6 as Wi, a7 as Ia, a8 as vn, a9 as na, aa as bn, ab as Xi, ac as Ji, ad as Zi, ae as Qi, af as xn, ag as ts, ah as ha, ai as Co, aj as ga, ak as es, al as rs, am as as, an as os, ao as ns, ap as Tr, aq as ro, ar as is, as as ss } from "./resizable-B4uTyxTb.js";
...
import { GENERATOR_NOTE_CALLER as Fa, HIDDEN_NOTE_CALLER as Ua, getDefaultViewOptions as sl, isInsertEmbedOpOfType as Ir, Editorial as cl } from "@eten-tech-foundation/platform-editor";
...
function pl({
  ...
  const {
    ...
    onPointerEnter: w,
    onPointerLeave: p
  } = ji(), [g, h] = k(!1), f = n && e !== void 0, b = i ?? (e !== void 0 && !n), m = V(() => {
    b && h(!0), f && w();
  }, [b, f, w]), N = V(() => {
    h(!1), p();
  }, [p]), y = V(() => {
    h(!1), p();
  }, [p]), _ = /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), D = f ? (
  ...
  return (
    ...
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(Rt, { open: d || g, children: [
      /* @__PURE__ */ a(Dt, { asChild: !0, children: /* @__PURE__ */ u(
        "span",
        {
          ...
          children: [
            B,
            B && T && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
            T
          ]
        }
      ) }),
...
function ba({
  ...
  const T = fe(), j = ul(), P = B ?? j, [E, L] = k(!1), [H, C] = k(""), [X, F] = k(""), [$, M] = k("books"), [z, tt] = k(void 0), [K, kt] = k(
    void 0
  ), [lt, $t] = k(void 0), [Y, rt] = k(!1), ft = U(null), dt = U(!1), pt = U(void 0), Ht = U(void 0), nt = U(void 0), Zt = U(void 0), Gt = U({}), Qt = U({}), xt = V(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ...
  const ee = V(() => {
    ...
    L(x), x && (M("books"), tt(void 0), kt(void 0), $t(void 0), F(""));
  }, []);
  W(() => {
    D && st(!1);
  }, [D, st]);
  ...
  const { otLong: Et, ntLong: Lt, dcLong: Tt, extraLong: Te } = {
    ...
    [t.book, n, P]
  ), Fe = `${t.chapterNum}:${t.verseNum}`, ur = V((x) => (q) => {
    Gt.current[x] = q;
  }, []), pr = V((x) => (q) => {
    Qt.current[x] = q;
  }, []), hr = O(
    () => ml(X),
    [X]
  ), gr = O(() => !d || !R || !R.chapterNum || !hr ? !1 : d(R.book, R.chapterNum) > 0, [d, R, hr]), Rr = V(
    (x) => w ? jo(x, w) : !1,
    [w]
  ), Ue = V(
    (x) => (q) => w ? vl(x, q, w) : !1,
    ...
    [w]
  ), Dr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", ua = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", pa = V(
    (x) => {
    ...
    (x) => {
      ...
      if (($ === "chapters" || $ === "books" && R) && Bt) {
        const Ft = $ === "chapters" ? z : R == null ? void 0 : R.book;
        if (!Ft) return;
...
function Ko({
  ...
  const [_, D] = k(!1), B = d ?? l, T = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], j = (P, E) => {
    const L = l(P), H = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, C = `${E ?? ""}${L}${H ?? ""}`;
    return /* @__PURE__ */ u(
      Ee,
      {
        value: L,
    ...
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        children: /* @__PURE__ */ u(Ae, { children: [
          ...
          /* @__PURE__ */ a(Pe, { children: T(e) ? e.map((P) => /* @__PURE__ */ a(Ne, { heading: P.groupHeading, children: P.options.map((E) => j(E, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(Ne, { children: e.map((P) => j(P)) }) })
        ] })
      }
    )
  ] });
...
function ip({
  ...
  const w = xa(d, "%webView_bookSelector_currentBook%"), p = xa(d, "%webView_bookSelector_choose%"), g = xa(d, "%webView_bookSelector_chooseBooks%"), [h, f] = k(
    "current book"
    /* CurrentBook */
  ), b = (m) => {
    f(m), t(m);
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, _l = Xn ? Xt : W, Pr = { tag: io };
...
function Pl(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: g } = n.getBoundingClientRect(), h = $l(t, e);
    var f, b;
    c.isConnected || (b = c, (f = n).insertBefore(b, f.firstChild));
    let m = !1;
    for (let N = 0; N < h.length; N++) {
      const y = h[N], _ = s[N] || document.createElement("div"), D = _.style;
...
function Ll(t, e = Vl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), b = f.getKey(), m = g.offset, N = h.getNode(), y = N.getKey(), _ = h.offset, D = t.getElementByKey(b), B = t.getElementByKey(y), T = r === null || D !== o || m !== n || b !== r.getKey(), j = i === null || B !== s || _ !== c || y !== i.getKey();
      if ((T || j) && D !== null && B !== null) {
        const P = function(E, L, H, C, X, F, $) {
          const M = (E._window ? E._window.document : document).createRange();
          return M.setStart(...qo(L, H, C)), M.setEnd(...qo(X, F, $)), M;
        }(t, g, f, D, h, N, B);
        l(), l = Pl(t, P, e);
      }
...
let Zr, _e = 0, Qr = 0, Gl = 0, qa = 0, Kr = 0;
function Go(t) {
  if (ot === void 0) return;
  let e = t.n;
...
function Wl(t) {
  ...
  Qn(this), ot = t, this.f &= -2, 8 & this.f && go(this), la();
}
function tr(t, e) {
...
const ka = yc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ai extends ja {
  $config() {
...
const fo = 0, Ga = 1, ii = 2, _a = 3, Vr = 4, Qe = 5, Na = 6, mr = 7;
function Ca(t) {
  return t.id === fo;
}
function si(t) {
...
function Zl(t) {
  return function(e) {
    return e.id === Ga;
  }(t) || wt(305, String(t.id), String(Ga)), Object.assign(t, { id: ii });
}
...
}, dependencies: [Ha], name: "@lexical/extension/NodeSelection" }), nd = Ec("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends ja {
  static getType() {
...
oe({ dependencies: [Ha, Zo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ce(t.registerCommand(nd, (s) => {
    ...
    return !0;
  }, so), t.registerCommand(Tc, (s) => {
    if (Sc(s.target)) {
      const c = zc(s.target);
      if (sd(c)) return function(l, d = !1) {
        const w = Jt(), p = l.isSelected(), g = l.getKey();
        let h;
        d && Vn(w) ? h = w : (h = Rc(), Dc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  ...
  return Ce(t.registerCommand(Lc, (o) => {
    ...
    const i = function(s) {
      ...
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Bc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Fc(h), h.anchor.is(d)) return !0;
      }
      return !1;
  ...
  return function(r, o) {
    ...
    return vo(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (g) => r._onError(g), children: a(Js, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
...
function Dd() {
  const { activeEditor: t } = pi(), [e, r] = k([]), o = V((n) => {
    if (he(n) || Qc(n)) {
      const i = [];
      en.forEach(({ format: s }) => {
...
function cp({
  ...
  const [i, s] = k(Pd), [c, l] = k(n), [d, w] = k(!1), p = U(void 0), g = U(null);
  W(() => {
    let m = !0;
    const N = g.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : xo(m) && (m.preventDefault(), m.stopPropagation(), ae(i) && h());
        },
        onKeyDown: (m) => {
    ...
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(Id(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), h()) : xo(T) && (T.preventDefault(), T.stopPropagation(), ae(w) && f());
              },
              onKeyDown: (T) => {
...
function ki({
  ...
  const [C, X] = k(on), [F, $] = k(), [M, z] = k(), tt = o, [K, kt] = k(!1), [lt, $t] = k(!1), [Y, rt] = k(!1), [ft, dt] = k(!1), [pt, Ht] = k(!1), [nt, Zt] = k(D), [Gt, Qt] = k(!1), xt = U(void 0), [te, It] = k(/* @__PURE__ */ new Map());
  W(() => {
    let S = !0;
    return (async () => {
  ...
  const R = O(() => At[0], [At]), be = U(null), ee = U(void 0), A = V(() => {
    var S;
    (S = ee.current) == null || S.call(ee), X(on);
  }, []), Z = V(() => {
    const S = !nt;
  ...
  const Lt = V(
    ...
    async (S) => {
      const jt = ae(C) ? ea(C) : void 0, _t = S.status ? S.assignedUser : F ?? S.assignedUser, de = await p({
        ...S,
        contents: jt,
        assignedUser: _t
      });
      return de && (_t !== void 0 && z(_t), jt && A()), de;
    },
    [A, C, p, F]
  );
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            m !== !1 && (!lt || ae(C)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  xo(S) && (S.preventDefault(), S.stopPropagation(), (ae(C) || F !== void 0 && F !== M) && Lt());
                },
                onKeyDown: (S) => {
                  bo(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ta,
...
), Kd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Hr = (t) => Kd(oo(t));
function Gr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function qd({
  ...
  const [s, c] = k("accept"), l = Mo(), d = Mo(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = O(
    () => Hr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = O(
    () => Hr(t.acceptedText ?? ""),
  ...
  const L = e["%conflict_note_no_result%"] ?? "No result preview available.", H = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: L }), C = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : H, X = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(Gr, { html: N }) : H : C(M === "reject" ? t.rejectedResultText : t.resultText);
  }, F = (M) => p && M.value === "reject", $ = (M) => {
    const z = f === M.value, tt = `${d}-${M.value}`, K = F(M);
    return (
      ...
      !w && !g && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          Xa,
          {
            ...
            children: T.map((M) => F(M) ? /* @__PURE__ */ a(zt, { delayDuration: 0, children: /* @__PURE__ */ u(Rt, { children: [
...
function Xd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Wd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function mp({
  ...
  const [y, _] = k(/* @__PURE__ */ new Set()), [D, B] = k(), [T, j] = k(), P = V(
    async (z) => {
      const tt = await i(z);
      return tt !== void 0 && z.assignedUser !== void 0 && z.assignedUser !== "" && j(z.assignedUser), tt;
    },
    [i]
  );
  W(() => {
  ...
  const E = r.filter(
  ...
  ), L = E.map((z) => ({ id: z.id })), H = V(
    (z) => {
      _((tt) => new Set(tt).add(z.id)), B(z.id), b == null || b(z.id);
    },
    [b]
  ), C = V(
    (z) => {
    ...
    (z) => {
      z.key === "Escape" ? (D && y.has(D) && (_((tt) => {
        const K = new Set(tt);
        return K.delete(D), K;
      }), B(void 0), b == null || b(void 0)), z.preventDefault(), z.stopPropagation()) : $(z);
    },
    [D, y, $, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: E.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(Xd, { ...tt, conflictResolution: N }) : /* @__PURE__ */ a(ki, { ...tt })
          },
          z.id
        );
      })
...
function rw({
  ...
  var T;
  const [w, p] = k([]), [g, h] = k([]), [f, b] = k({}), [m, N] = k({}), y = O(() => e ?? [], [e]), _ = Un({
    data: y,
    columns: t,
    getCoreRowModel: qn(),
  ...
  let B;
  return l ? B = Array.from({ length: 10 }).map((E, L) => `skeleton-row-${L}`).map((E) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: D.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = _.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    Re,
    {
      onClick: () => s(j, _),
    ...
    /* @__PURE__ */ u(Qa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(to, { stickyHeader: i, children: _.getHeaderGroups().map((j) => /* @__PURE__ */ a(Re, { children: j.headers.map((P) => /* @__PURE__ */ a(Xr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : xr(P.column.columnDef.header, P.getContext()) }, P.id)) }, j.id)) }),
...
function ww({
  ...
  const i = U(null), s = U(null), c = U(!1), [l, d] = k(t), [w, p] = k(r), [g, h] = k(!1);
  W(() => {
    d(t);
  }, [t]), W(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(Ve, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u(Rt, { children: [
...
function Tp({
  ...
  const [f, b] = k("generated"), [m, N] = k("generated"), [y, _] = k("*"), [D, B] = k("*"), [T, j] = k("f"), [P, E] = k(!1), [L, H] = k(!0), [C, X] = k(!1), F = U(!1), $ = U(""), [M, z] = k(!1), [tt, K] = k(), [kt, lt] = k(), [$t, Y] = k(), [rt, ft] = k(), dt = U(null), pt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const xt = () => {
    ...
    if (Z && Ir("note", Z)) {
      ...
      T !== "x" && A === "x" ? st == null || st.forEach((mt) => xw(mt)) : T === "x" && A !== "x" && (st == null || st.forEach((mt) => yw(mt))), (gt = w.current) == null || gt.applyUpdate([Z, { delete: 1 }]);
    }
  }, At = (A) => {
    ...
    if (g.current && Ht.length && A && A.rangeCount > 0) {
      const Z = A.getRangeAt(0).getBoundingClientRect(), at = g.current.getBoundingClientRect();
      K(Z.left - at.left), lt(Z.top - at.top), Y(Z.height), z(!0);
    }
  }, [Ht, g]);
  W(() => {
    const A = () => {
    ...
    const A = ((at = p.current) == null ? void 0 : at.querySelector(".editor-input")) ?? void 0, Z = (it) => {
      !M && A && document.activeElement === A && it.key === c ? (it.preventDefault(), be()) : M && it.key === "Escape" && (it.preventDefault(), z(!1));
    };
...
function zp({
  ...
  const w = l ?? qs(r, void 0), p = (y, _) => {
    d == null || d(y, _, n);
  }, g = i ? r.findIndex((y) => y === i) : -1, [h, f] = k(g), b = (y, _, D) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
...
function Pp({
  ...
  const h = ue(r, "%webView_inventory_all%"), f = ue(r, "%webView_inventory_approved%"), b = ue(r, "%webView_inventory_unapproved%"), m = ue(r, "%webView_inventory_unknown%"), N = ue(r, "%webView_inventory_scope_currentBook%"), y = ue(r, "%webView_inventory_scope_chapter%"), _ = ue(r, "%webView_inventory_scope_verse%"), D = ue(r, "%webView_inventory_filter_text%"), B = ue(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = ue(r, "%webView_inventory_no_results%"), [j, P] = k(!1), [E, L] = k("all"), [H, C] = k(""), [X, F] = k([]), $ = O(() => {
    const Y = t ?? [];
  ...
  }, [j, $]), z = O(() => M.length === 0 ? [] : Dw(M, E, H), [M, E, H]), tt = O(() => {
    var ft, dt;
    if (!j) return l;
  ...
  W(() => {
    z.length === 0 ? F([]) : z.length === 1 && F(z[0].items);
  }, [z]);
  const K = (Y, rt) => {
    rt.setRowSelection(() => {
      const dt = {};
...
function Iw({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    ...
    [r, w]
  ), g = Wt.useCallback(() => p((_) => !_), [p]), h = w ? "expanded" : "collapsed", m = fe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = Wt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
    ...
    Aw,
    {
      ...
      children: /* @__PURE__ */ u(Vw, { children: [
        /* @__PURE__ */ u(ln, { children: [
          ...
          /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(Lw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(jw, { children: /* @__PURE__ */ a(
            Fw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
function Zp({
  ...
  const [d, w] = k([]), [p, g] = k([{ id: ze, desc: !1 }]), [h, f] = k({}), b = O(
  ...
  }, j = (E, L) => E.getIsGrouped() ? "" : v("banded-row", L % 2 === 0 ? "even" : "odd"), P = (E, L, H) => {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Qa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(to, { children: N.getHeaderGroups().map((E) => /* @__PURE__ */ a(Re, { children: E.headers.filter((L) => L.column.columnDef.header).map((L) => (
        ...
        /* @__PURE__ */ a(Xr, { colSpan: L.colSpan, className: "tw:sticky top-0", children: L.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
...
function th({
  ...
  const D = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = St(s, "%webView_scope_selector_verse%"), T = St(s, "%webView_scope_selector_chapter%"), j = St(s, "%webView_scope_selector_book%"), P = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = St(
    s,
    "%webView_scope_selector_current_chapter%"
  ), L = St(s, "%webView_scope_selector_current_book%"), H = St(s, "%webView_scope_selector_choose_books%"), C = St(s, "%webView_scope_selector_scope%"), X = St(s, "%webView_scope_selector_select_books%"), F = St(s, "%webView_scope_selector_range%"), $ = St(s, "%webView_scope_selector_select_range%"), M = St(s, "%webView_scope_selector_range_start%"), z = St(s, "%webView_scope_selector_range_end%"), tt = St(s, "%webView_scope_selector_ok%"), K = St(s, "%webView_scope_selector_cancel%"), kt = St(s, "%webView_scope_selector_navigate%"), lt = (I) => {
    if (!f) return;
  ...
  }, nt = U(null), Zt = U(null), Gt = U(!1), Qt = U(null), xt = U(!1), [te, It] = k(void 0), yt = U(!1), At = U(!1), R = U(null), be = V((I) => {
    if (I) {
    ...
    (I) => {
      g == null || g(I), h == null || h(I), yt.current = !0;
    },
    [g, h]
  ), Z = V(
    (I) => {
      h == null || h(I), At.current = !0;
    },
    [h]
  ), at = V(
    (I) => {
  ...
  ), gt = rt.find((I) => I.value === "selectedBooks"), st = rt.find((I) => I.value === "range"), [mt, Vt] = k(!1), [Et, Lt] = k(void 0), [Tt, Te] = k(void 0), [S, jt] = k(void 0), [_t, de] = k(void 0), [Fe, ur] = k([]), pr = d === "dropdown" && Et === "selectedBooks", hr = /* @__PURE__ */ a(
    Qw,
    {
      availableBookInfo: o,
  ...
  ), gr = te === "end", Rr = te === "start", Ue = "tw:text-muted-foreground", Se = d === "dropdown" && Et === "range", Dr = Se ? jt : A, pa = Se ? de : h ? Z : Ht, Or = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const re = V(
    ...
    Tt !== void 0 && (Tt === "range" ? (S && (g == null || g(S)), _t && (h == null || h(_t))) : Tt === "selectedBooks" && i(Fe), at(Tt), Lt(void 0), Te(void 0));
  }, [
    Tt,
    S,
    _t,
  ...
  if (ll(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (b = s.current) == null || b.focus(), vr(s, [g, h]);
        break;
      case "alt+n":
        (m = c.current) == null || m.focus(), vr(c, [g, h]);
        break;
      case "alt+h":
        (N = l.current) == null || N.focus(), vr(l, [g, h]);
        break;
    }
  }), W(() => {
...
function dh({
  ...
  const d = vu(
    ...
    return m ? `${(B = t[f]) == null ? void 0 : B.autonym} (${m})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
      ...
      /* @__PURE__ */ a(
        Ot,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Do(d, {
            ...
            /* @__PURE__ */ a(sa, { children: g }, `key-${h}`)
          )) })
        }
      )
    ] })
