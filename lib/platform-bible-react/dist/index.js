...
function cd({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = va(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, id), P = re(s, sd), T = (M) => {
  ...
  return Oe(t.registerCommand(ow, (i) => {
    ...
    if (pl(i.target)) {
      ...
      if (iw(c)) return function(l, d = !1) {
        ...
        let g;
        d && fi(w) ? g = w : (g = gl(), fl(g)), p ? g.delete(h) : g.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Yw, { ...G, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...G })
          },
          I.id
        );
      })
    ...
    $u,
    {
      ...
      children: /* @__PURE__ */ u(Vu, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Lu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Bu, { children: /* @__PURE__ */ a(
            Fu,
            {
              onClick: () => d(g),
              isActive: h(g),
