...
function Li({ scrRef: e, handleSubmit: n }) {
  const { allBookIds: r } = Z, [t, o] = we(""), [a, i] = we(""), [u, s] = we(!1), c = Qe(void 0), l = ve(
    (C) => ({
  ...
  return /* @__PURE__ */ b("div", { children: /* @__PURE__ */ ae(Bt, { modal: !1, open: u, onOpenChange: f, children: [
    ...
    /* @__PURE__ */ b(Rr, { className: "menu-content", style: { overflowY: "auto" }, onKeyDown: S, children: Ht.map((C) => /* @__PURE__ */ ae("div", { children: [
...
function qt({
  ...
  let p;
  if (r) {
    const d = t === ze.Before || t === ze.Above, v = /* @__PURE__ */ b("span", { className: `papi-checkbox-label ${u ? "error" : ""} ${s ?? ""}`, children: r }), y = t === ze.Before || t === ze.After, h = y ? v : /* @__PURE__ */ b("div", { children: v }), f = y ? l : /* @__PURE__ */ b("div", { children: l });
    p = /* @__PURE__ */ ae(
      lt,
      {
...
function Wi({ scrRef: e, handleSubmit: n, id: r }) {
  const t = (s) => {
    ...
    const p = { bookNum: Z.bookIdToNumber(c.bookId), chapterNum: 1, verseNum: 1 };
    t(p);
  }, a = (s) => {
...
function Qt() {
  ...
  return V.AsyncMode = s, V.ConcurrentMode = c, V.ContextConsumer = u, V.ContextProvider = i, V.Element = n, V.ForwardRef = l, V.Fragment = t, V.Lazy = y, V.Memo = v, V.Portal = r, V.Profiler = a, V.StrictMode = o, V.Suspense = p, V.isAsyncMode = function(m) {
    return E(m) || T(m) === s;
    ...
    return typeof m == "string" || typeof m == "function" || m === t || m === c || m === a || m === o || m === p || m === d || typeof m == "object" && m !== null && (m.$$typeof === y || m.$$typeof === v || m.$$typeof === i || m.$$typeof === u || m.$$typeof === l || m.$$typeof === f || m.$$typeof === S || m.$$typeof === C || m.$$typeof === h);
  }, V.typeOf = T, V;
}
var F = {};
/** @license React v16.13.1
...
function eo() {
  return Yn || (Yn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function T(w) {
      ...
      w === t || w === c || w === a || w === o || w === p || w === d || typeof w == "object" && w !== null && (w.$$typeof === y || w.$$typeof === v || w.$$typeof === i || w.$$typeof === u || w.$$typeof === l || w.$$typeof === f || w.$$typeof === S || w.$$typeof === C || w.$$typeof === h);
    }
    function E(w) {
    ...
    var m = s, ee = c, te = u, me = i, fe = n, N = l, q = t, Q = y, oe = v, G = r, pe = a, ne = o, be = p, _e = !1;
    function $e(w) {
      ...
      for (var l in a)
        if (t(a, l)) {
          ...
          try {
            ...
            p = a[l](i, l, s, u, null, n);
          } catch (y) {
            p = y;
          }
          if (p && !(p instanceof Error) && e(
            (s || "React class") + ": type specification of " + u + " `" + l + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof p + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."
...
function co() {
  ...
  return L.ContextConsumer = i, L.ContextProvider = a, L.Element = e, L.ForwardRef = s, L.Fragment = r, L.Lazy = d, L.Memo = p, L.Portal = n, L.Profiler = o, L.StrictMode = t, L.Suspense = c, L.SuspenseList = l, L.isAsyncMode = function() {
    return !1;
    ...
    return typeof f == "string" || typeof f == "function" || f === r || f === o || f === t || f === c || f === l || f === v || typeof f == "object" && f !== null && (f.$$typeof === d || f.$$typeof === p || f.$$typeof === a || f.$$typeof === i || f.$$typeof === s || f.$$typeof === y || f.getModuleId !== void 0);
  }, L.typeOf = h, L;
}
var U = {};
/**
...
function lo() {
  return or || (or = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === r || k === o || C || k === t || k === c || k === l || S || k === v || y || h || f || typeof k == "object" && k !== null && (k.$$typeof === d || k.$$typeof === p || k.$$typeof === a || k.$$typeof === i || k.$$typeof === s || // This needs to include all possible module reference object
    ...
    var ee = i, te = a, me = e, fe = s, N = r, q = d, Q = p, oe = n, G = o, pe = t, ne = c, be = l, _e = !1, $e = !1;
    function g(k) {
...
function J(e) {
  const {
    ...
    return xe(i, u, (p) => {
      let d = nn(c, o, p);
      return p === d && typeof p == "string" && (d = nn(c, o, `${n}${p === "default" ? "" : ge(p)}`, p)), r === !1 ? d : {
        [r]: d
      };
    });
  };
...
function ga() {
  function e(r, t, o, a) {
    ...
    return p ? p(i) : xe(i, t, (y) => {
      let h = nn(d, l, y);
      return y === h && typeof y == "string" && (h = nn(d, l, `${r}${y === "default" ? "" : ge(y)}`, y)), s === !1 ? h : {
        [s]: h
      };
    });
  }
...
function Dn(e = {}, ...n) {
  ...
  return c = n.reduce((l, p) => he(l, p), c), c.unstable_sxConfig = z({}, Mn, i == null ? void 0 : i.unstable_sxConfig), c.unstable_sx = function(p) {
    return Bn({
      sx: p,
      theme: this
    });
...
function Ra(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, u = {}) => {
    ...
    let f;
    process.env.NODE_ENV !== "production" && s && (f = `${s}-${dr(c || "Root")}`);
    let S = Je;
    ...
    const C = xt(i, z({
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        s && (N = `${s}${ge(c || "")}`), N === void 0 && (N = `Styled(${po(i)})`), fe.displayName = N;
      }
...
function oi(e, n) {
  ...
  const v = o / 14, y = p || ((S) => `${S / c * v}rem`), h = (S, C, T, E, m) => z({
    fontFamily: t,
    fontWeight: S,
    fontSize: y(C),
  ...
  return z({
    ...
    create: (o = ["all"], a = {}) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        ...
        !l(o) && !Array.isArray(o) && console.error('MUI: Argument "props" must be a string or Array.'), !p(i) && !l(i) && console.error(`MUI: Argument "duration" must be a number or a string but found ${i}.`), l(u) || console.error('MUI: Argument "easing" must be a string.'), !p(s) && !l(s) && console.error('MUI: Argument "delay" must be a number or a string.'), typeof a != "object" && console.error(["MUI: Secong argument of transition.create must be an object.", "Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
...
function yi(e = {}, ...n) {
  ...
  if (c = he(c, i), c = n.reduce((l, p) => he(l, p), c), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return c.unstable_sxConfig = z({}, Mn, i == null ? void 0 : i.unstable_sxConfig), c.unstable_sx = function(p) {
    return Bn({
      sx: p,
      theme: this
    });
...
function Ji({
  ...
  let f = e;
  return !f && n && (f = n(s)), /* @__PURE__ */ b("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ b(gt, { position: "static", id: o, children: /* @__PURE__ */ ae(bt, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ b(
      Er,
      {
        edge: "start",
...
const Ri = (e, n, r = {}) => {
  ...
  const [a, i] = we(() => t.current), [u, s] = we(!0);
  return on(() => {
    let c = !0;
    return s(!!e), (async () => {
      if (e) {
