...
import { Button as Eo, Autocomplete as xo, TextField as Cr, FormControlLabel as Mt, FormLabel as To, Checkbox as ko, MenuItem as So, ListItemText as wo, ListItemIcon as Oo, Grid as Pr, IconButton as Rr, Paper as Co, Slider as Po, Snackbar as Ro, Switch as No, AppBar as _o, Toolbar as $o, Drawer as Mo } from "@mui/material";
import * as w from "react";
import Qe, { useMemo as ht, useState as en, useCallback as xn, useRef as it, useEffect as In } from "react";
import Io, { ThemeContext as Ao, internal_processStyles as Do } from "@mui/styled-engine";
import * as Bo from "react-dom";
import vn from "react-dom";
import { offsetBook as It, FIRST_SCR_BOOK_NUM as jo, offsetChapter as At, FIRST_SCR_CHAPTER_NUM as Vo, getChaptersForBook as Lo, offsetVerse as Dt, FIRST_SCR_VERSE_NUM as Fo } from "platform-bible-utils";
import zo, { SelectColumn as Uo } from "react-data-grid";
function He({
  id: e,
  isDisabled: n = !1,
  className: t,
...
function Bt(e, n, t) {
  return e ? /* @__PURE__ */ C(Oo, { children: /* @__PURE__ */ C("img", { src: e, alt: `${t ? "Leading" : "Trailing"} icon for ${n}` }) }) : void 0;
}
function qo(e) {
  const {
    onClick: n,
...
function Nr({
  ...
  const i = (t == null ? void 0 : t.find((a) => a.iconPathBefore !== void 0)) !== void 0;
  return /* @__PURE__ */ C("div", { id: r, className: `papi-menu ${n ?? ""}`, children: t == null ? void 0 : t.map((a, c) => /* @__PURE__ */ C(
    qo,
    {
...
function Wo({ commandHandler: e, name: n, className: t, items: r, id: o }) {
  return /* @__PURE__ */ xe(Pr, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${t ?? ""}`, children: [
    ...
    /* @__PURE__ */ C(Nr, { commandHandler: e, items: r })
  ] });
}
function Go({ commandHandler: e, className: n, columns: t, id: r }) {
  return /* @__PURE__ */ C(
    Pr,
    {
      container: !0,
...
function Yo() {
  return Vt || (Vt = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), n = Symbol.for("react.portal"), t = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), a = Symbol.for("react.context"), c = Symbol.for("react.server_context"), l = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), y = Symbol.for("react.offscreen"), b = !1, g = !1, h = !1, T = !1, V = !1, v;
    v = Symbol.for("react.module.reference");
    function x(S) {
      return !!(typeof S == "string" || typeof S == "function" || S === t || S === o || V || S === r || S === u || S === d || T || S === y || b || g || h || typeof S == "object" && S !== null && (S.$$typeof === f || S.$$typeof === p || S.$$typeof === i || S.$$typeof === a || S.$$typeof === l || // This needs to include all possible module reference object
...
function Jo() {
  ...
  return re.AsyncMode = l, re.ConcurrentMode = u, re.ContextConsumer = c, re.ContextProvider = a, re.Element = n, re.ForwardRef = d, re.Fragment = r, re.Lazy = b, re.Memo = y, re.Portal = t, re.Profiler = i, re.StrictMode = o, re.Suspense = p, re.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === r || m === u || m === i || m === o || m === p || m === f || typeof m == "object" && m !== null && (m.$$typeof === b || m.$$typeof === y || m.$$typeof === a || m.$$typeof === c || m.$$typeof === d || m.$$typeof === h || m.$$typeof === T || m.$$typeof === V || m.$$typeof === g);
  }, re.typeOf = v, re;
}
var oe = {};
/** @license React v16.13.1
...
function Zo() {
  return Ft || (Ft = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function v(O) {
      ...
      O === r || O === u || O === i || O === o || O === p || O === f || typeof O == "object" && O !== null && (O.$$typeof === b || O.$$typeof === y || O.$$typeof === a || O.$$typeof === c || O.$$typeof === d || O.$$typeof === h || O.$$typeof === T || O.$$typeof === V || O.$$typeof === g);
    }
    function x(O) {
...
function ni() {
  if (Gt)
    return Yn;
  Gt = 1;
  var e = _r(), n = Qo(), t = mt(), r = $r(), o = ei(), i = function() {
  };
  ...
  return Yn = function(c, l) {
    ...
    function h(E) {
      ...
      function z(F, j, L, W, X, U, de) {
        ...
        return j[L] == null ? F ? j[L] === null ? new g("The " + X + " `" + U + "` is marked as required " + ("in `" + W + "`, but its value is `null`.")) : new g("The " + X + " `" + U + "` is marked as required in " + ("`" + W + "`, but its value is `undefined`.")) : null : E(j, L, W, X, U);
      }
      var D = z.bind(null, !1);
      return D.isRequired = z.bind(null, !0), D;
    }
    function T(E) {
      function P(A, z, D, F, j, L) {
        var W = A[z], X = $(W);
        if (X !== E) {
          var U = B(W);
          return new g(
            "Invalid " + F + " `" + j + "` of type " + ("`" + U + "` supplied to `" + D + "`, expected ") + ("`" + E + "`."),
            { expectedType: E }
          );
        }
        return null;
    ...
    function v(E) {
      function P(A, z, D, F, j) {
        if (typeof E != "function")
          return new g("Property `" + j + "` of component `" + D + "` has invalid PropType notation inside arrayOf.");
        var L = A[z];
        if (!Array.isArray(L)) {
          var W = $(L);
          return new g("Invalid " + F + " `" + j + "` of type " + ("`" + W + "` supplied to `" + D + "`, expected an array."));
        }
        for (var X = 0; X < L.length; X++) {
          var U = E(L, X, D, F, j + "[" + X + "]", t);
    ...
    function x() {
      function E(P, A, z, D, F) {
        var j = P[A];
        if (!c(j)) {
          var L = $(j);
          return new g("Invalid " + D + " `" + F + "` of type " + ("`" + L + "` supplied to `" + z + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(E);
    ...
    function m() {
      function E(P, A, z, D, F) {
        ...
        if (!e.isValidElementType(j)) {
          var L = $(j);
          return new g("Invalid " + D + " `" + F + "` of type " + ("`" + L + "` supplied to `" + z + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(E);
    ...
    function I(E) {
      function P(A, z, D, F, j) {
        if (!(A[z] instanceof E)) {
          ...
          return new g("Invalid " + F + " `" + j + "` of type " + ("`" + W + "` supplied to `" + D + "`, expected ") + ("instance of `" + L + "`."));
        }
        return null;
      }
      return h(P);
    ...
    function _(E) {
      ...
      function P(A, z, D, F, j) {
        ...
        return new g("Invalid " + F + " `" + j + "` of value `" + String(L) + "` " + ("supplied to `" + D + "`, expected one of " + X + "."));
      }
      return h(P);
    }
    function K(E) {
      function P(A, z, D, F, j) {
        ...
        var L = A[z], W = $(L);
        if (W !== "object")
          return new g("Invalid " + F + " `" + j + "` of type " + ("`" + W + "` supplied to `" + D + "`, expected an object."));
        for (var X in L)
          if (r(L, X)) {
            var U = E(L, X, D, F, j + "." + X, t);
            if (U instanceof Error)
    ...
    function Z(E) {
      ...
      function z(D, F, j, L, W) {
        for (var X = [], U = 0; U < E.length; U++) {
          var de = E[U], O = de(D, F, j, L, W, t);
          if (O == null)
            return null;
    ...
    function R() {
      function E(P, A, z, D, F) {
        return M(P[A]) ? null : new g("Invalid " + D + " `" + F + "` supplied to " + ("`" + z + "`, expected a ReactNode."));
      }
      return h(E);
    }
    ...
    function q(E) {
      function P(A, z, D, F, j) {
        var L = A[z], W = $(L);
        if (W !== "object")
          return new g("Invalid " + F + " `" + j + "` of type `" + W + "` " + ("supplied to `" + D + "`, expected `object`."));
        for (var X in E) {
          var U = E[X];
          if (typeof U != "function")
            return G(D, F, j, X, B(U));
          var de = U(L, X, D, F, j + "." + X, t);
          if (de)
            return de;
        }
        return null;
      ...
      function P(A, z, D, F, j) {
        ...
        for (var U in X) {
          ...
          if (r(E, U) && typeof de != "function")
            return G(D, F, j, U, B(de));
          if (!de)
            return new g(
              "Invalid " + F + " `" + j + "` key `" + U + "` supplied to `" + D + "`.\nBad object: " + JSON.stringify(A[z], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(E), null, "  ")
            );
          var O = de(L, U, D, F, j + "." + U, t);
          if (O)
            return O;
        }
        return null;
...
if (process.env.NODE_ENV !== "production") {
  var ri = _r(), oi = !0;
  ct.exports = ni()(ri.isElement, oi);
} else
  ct.exports = ti()();
var ii = ct.exports;
const s = /* @__PURE__ */ Ko(ii);
function Mr(e) {
  var n, t, r = "";
...
function Ar(e, n, t, r, o) {
  ...
  let c;
  const l = i.type;
  return typeof l == "function" && !si(l) && (c = "Did you accidentally use a plain function component for an element instead?"), c !== void 0 ? new Error(`Invalid ${r} \`${a}\` supplied to \`${t}\`. Expected an element that can hold a ref. ${c} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function ci(e, n, t, r, o) {
  ...
  typeof window > "u")
    return null;
  let c;
  return typeof i == "function" && !ai(i) && (c = "Did you accidentally provide a plain function component instead?"), c !== void 0 ? new Error(`Invalid ${r} \`${a}\` supplied to \`${t}\`. Expected an element type that can hold a ref. ${c} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const li = gn(s.elementType, ci), ui = "exact-prop: ​";
function Br(e) {
...
const di = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function fi(e) {
  const n = `${e}`.match(di);
  return n && n[1] || "";
}
function jr(e, n = "") {
  return e.displayName || e.name || fi(e) || n;
}
function Xt(e, n, t) {
  const r = jr(n);
...
const hi = s.oneOfType([s.func, s.object]), mi = hi;
function ke(e) {
  if (typeof e != "string")
...
const bi = typeof window < "u" ? w.useLayoutEffect : w.useEffect, On = bi;
function Jt(e) {
  const n = w.useRef(e);
  return On(() => {
    n.current = e;
...
Fr.isRequired = Lr;
ut.isRequired = ut;
const zr = process.env.NODE_ENV === "production" ? ut : Fr;
function Ur(e, n) {
  const t = k({}, n);
...
function Re(e, n, t = "Mui") {
  const r = Si[n];
  return r ? `${t}-${r}` : `${ki.generate(e)}-${n}`;
}
function Fe(e, n, t = "Mui") {
  const r = {};
  return n.forEach((o) => {
    r[o] = Re(e, o, t);
  }), r;
}
function wi(e, n = Number.MIN_SAFE_INTEGER, t = Number.MAX_SAFE_INTEGER) {
...
const Ri = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function rn(e) {
  var n;
  const {
    elementType: t,
...
const Ni = ["values", "unit", "step"], _i = (e) => {
...
function $i(e) {
  const {
    ...
    unit: t = "px",
    step: r = 5
  } = e, o = ae(e, Ni), i = _i(n), a = Object.keys(i);
  function c(f) {
...
const Mi = {
  borderRadius: 4
}, Ii = Mi, Ai = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, Ie = Ai;
function dn(e, n) {
  return n ? Ee(e, n, {
    clone: !1
...
const Vi = {
  ...
  if (e.length > 2)
    if (tr[e])
      ...
      return [e];
  const [n, t] = e.split(""), r = Vi[n], o = Li[t] || "";
  return Array.isArray(o) ? o.map((i) => r + i) : [r + o];
}), Bn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], jn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], zi = [...Bn, ...jn];
function bn(e, n, t, r) {
  var o;
...
function Hi(e, n, t, r) {
  if (n.indexOf(t) === -1)
    return null;
  const o = Fi(t), i = Ui(o, r), a = e[t];
  return Pe(e, a, i);
}
function Kr(e, n) {
  const t = Gr(e.theme);
  return Object.keys(e).map((r) => Hi(e, n, r, t)).reduce(dn, {});
}
function ce(e) {
  return Kr(e, Bn);
}
...
le.filterProps = jn;
process.env.NODE_ENV !== "production" && zi.reduce((e, n) => (e[n] = Ie, e), {});
function qi(e = 8) {
  if (e.mui)
    return e;
  const n = Gr({
...
const Wi = ye("border", me), Gi = ye("borderTop", me), Ki = ye("borderRight", me), Xi = ye("borderBottom", me), Yi = ye("borderLeft", me), Ji = ye("borderColor"), Zi = ye("borderTopColor"), Qi = ye("borderRightColor"), es = ye("borderBottomColor"), ns = ye("borderLeftColor"), ts = ye("outline", me), rs = ye("outlineColor"), Ln = (e) => {
...
Vn(Wi, Gi, Ki, Xi, Yi, Ji, Zi, Qi, es, ns, Ln, ts, rs);
const Fn = (e) => {
...
Vn(Fn, zn, Un, os, is, ss, as, cs, ls, us, ds, fs);
function nn(e, n) {
  return n === "grey" ? n : e;
}
const ps = ue({
...
function ws() {
  ...
  function n(t) {
    ...
    function c(l) {
      ...
      if (!u)
        return null;
      const d = Di(i.breakpoints), p = Object.keys(d);
      let f = d;
...
const Xr = ws();
Xr.filterProps = ["sx"];
const vt = Xr, Os = ["breakpoints", "palette", "spacing", "shape"];
function Et(e = {}, ...n) {
  const {
    breakpoints: t = {},
    palette: r = {},
...
const _s = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function $s(e) {
  return Object.keys(e).length === 0;
}
function Ms(e) {
...
const Is = (e, n) => n.components && n.components[e] && n.components[e].styleOverrides ? n.components[e].styleOverrides : null, Pn = (e) => {
  let n = 0;
  const t = {};
...
const Bs = Et(), or = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function kn({
  defaultTheme: e,
  theme: n,
  themeId: t
...
function Vs(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, c = {}) => {
    Do(a, (x) => x.filter((m) => !(m != null && m.__mui_systemSx)));
    const {
      name: l,
      slot: u,
      ...
      overridesResolver: f = js(or(u))
    } = c, y = ae(c, _s), b = d !== void 0 ? d : (
    ...
    let T = Tn;
    u === "Root" || u === "root" ? T = r : u ? T = o : Ms(a) && (T = void 0);
    const V = Io(a, k({
      shouldForwardProp: T,
      label: h
    }, y)), v = (x, ...m) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        let R;
        l && (R = `${l}${ke(u || "")}`), R === void 0 && (R = `Styled(${pi(a)})`), Z.displayName = R;
      }
...
function xt(e, n = 0, t = 1) {
  return process.env.NODE_ENV !== "production" && (e < n || e > t) && console.error(`MUI: The value provided ${e} is out of range [${n}, ${t}].`), wi(e, n, t);
}
function zs(e) {
  e = e.slice(1);
...
function sr(e) {
  e = je(e);
  let n = e.type === "hsl" || e.type === "hsla" ? je(Us(e)).values : e.values;
...
const Gs = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Xe = na, ta = ["mode", "contrastThreshold", "tonalOffset"], lr = {
...
function ur(e, n, t, r) {
  ...
  e[n] || (e.hasOwnProperty(t) ? e[n] = e[t] : n === "light" ? e.light = qs(e.main, o) : n === "dark" && (e.dark = Hs(e.main, i)));
}
function ra(e = "light") {
  return e === "dark" ? {
    main: Ge[200],
...
function la(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ae(e, ta), i = e.primary || ra(n), a = e.secondary || oa(n), c = e.error || ia(n), l = e.info || sa(n), u = e.success || aa(n), d = e.warning || ca(n);
  function p(g) {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return ur(g, "light", V, r), ur(g, "dark", v, r), g.contrastText || (g.contrastText = p(g.main)), g;
  }, y = {
    dark: Zn,
    light: lr
  };
...
const ua = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function da(e) {
...
function fa(e, n) {
  ...
  const y = o / 14, b = p || ((T) => `${T / u * y}rem`), g = (T, V, v, x, m) => k({
    fontFamily: r,
    fontWeight: T,
    fontSize: b(V),
...
const pa = 0.2, ha = 0.14, ma = 0.12;
function se(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${pa})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${ha})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${ma})`].join(",");
}
const ga = ["none", se(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), se(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), se(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), se(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), se(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), se(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), se(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), se(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), se(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), se(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), se(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), se(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), se(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), se(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), se(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), se(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), se(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), se(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), se(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), se(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), se(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), se(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), se(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), se(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], ba = ga, ya = ["duration", "easing", "delay"], va = {
...
function Ta(e) {
  const n = k({}, va, e.easing), t = k({}, Ea, e.duration);
  return k({
...
const ka = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Sa = ka, wa = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Oa(e = {}, ...n) {
  const {
    mixins: t = {},
    palette: r = {},
...
const Ca = Oa(), Tt = Ca, kt = "$$material", Zr = (e) => Tn(e) && e !== "classes", Pa = Vs({
  themeId: kt,
  defaultTheme: Tt,
...
const _a = ["children", "className", "component", "dense", "disablePadding", "subheader"], $a = (e) => {
  const {
    classes: n,
    disablePadding: t,
    dense: r,
  ...
  return /* @__PURE__ */ C(Ra.Provider, {
    value: p,
    children: /* @__PURE__ */ xe(Ma, k({
      as: a,
...
const Ia = eo, Aa = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Qn(e, n, t) {
...
const to = /* @__PURE__ */ w.forwardRef(function(n, t) {
  ...
  } = n, f = ae(n, Aa), y = w.useRef(null), b = w.useRef({
    keys: [],
    repeating: !0,
...
const Da = to, Ba = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function ja(e) {
...
function Fa(e) {
  const n = [], t = [];
  return Array.from(e.querySelectorAll(Ba)).forEach((r, o) => {
    const i = ja(r);
    i === -1 || !La(r) || (i === 0 ? n.push(r) : t.push({
      documentOrder: o,
      tabIndex: i,
      node: r
    }));
...
const _n = /* @__PURE__ */ w.forwardRef(function(n, t) {
  ...
  return /* @__PURE__ */ C(w.Fragment, {
    children: a && /* @__PURE__ */ Bo.createPortal(r, a)
  });
});
...
function Za(e) {
  const {
    ...
    open: d,
    rootRef: p
  } = e, f = w.useRef({}), y = w.useRef(null), b = w.useRef(null), g = Me(b, p), [h, T] = w.useState(!d), V = Ya(l);
  let v = !0;
...
var ec = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.shape({
  enter: s.number,
  exit: s.number,
  appear: s.number
}).isRequired]) : null;
...
const tc = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function pt(e) {
  return `scale(${e}, ${e ** 2})`;
}
const rc = {
  ...
  const {
  ...
  } = n, T = ae(n, tc), V = w.useRef(), v = w.useRef(), x = qn(), m = w.useRef(null), I = Me(m, i.ref, t), _ = (N) => ($) => {
    if (N) {
      const B = m.current;
      $ === void 0 ? N(B) : N(B, $);
    }
    ...
    g === "auto" && (V.current = setTimeout(N, v.current || 0)), r && r(m.current, N);
  };
  return w.useEffect(() => () => {
...
St.muiSupportAuto = !0;
const oc = St, ic = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], sc = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  const r = qn(), o = {
    ...
    timeout: T = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: V = oo
  } = n, v = ae(n, ic), x = w.useRef(null), m = Me(x, c.ref, t), I = (M) => (N) => {
    if (M) {
      const $ = x.current;
      N === void 0 ? M($) : M($, N);
    }
...
const lc = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], uc = (e) => {
  const {
    classes: n,
    invisible: t
  } = e;
  ...
  const a = ze({
    ...
    slotProps: b = {},
    slots: g = {},
    TransitionComponent: h = ac,
    transitionDuration: T
  } = a, V = ae(a, lc), v = k({}, a, {
    component: u,
    invisible: f
  }), x = uc(v), m = (r = b.root) != null ? r : p.root;
  return /* @__PURE__ */ C(h, k({
    in: y,
    timeout: T
  }, V, {
    children: /* @__PURE__ */ C(dc, k({
      "aria-hidden": !0
    }, m, {
...
const hc = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], mc = (e) => {
  const {
    open: n,
    exited: t,
    classes: r
  ...
  const L = (r = (o = M == null ? void 0 : M.root) != null ? o : T.Root) != null ? r : gc, W = (i = (a = M == null ? void 0 : M.backdrop) != null ? a : T.Backdrop) != null ? i : d, X = (c = ee == null ? void 0 : ee.root) != null ? c : V.root, U = (l = ee == null ? void 0 : ee.backdrop) != null ? l : V.backdrop, de = rn({
    elementType: L,
    externalSlotProps: X,
    ...
    ownerState: D,
    className: Ce(f, X == null ? void 0 : X.className, F == null ? void 0 : F.root, !D.open && D.exited && (F == null ? void 0 : F.hidden))
  }), O = rn({
    elementType: W,
    externalSlotProps: U,
    additionalProps: p,
    ...
    className: Ce(U == null ? void 0 : U.className, p == null ? void 0 : p.className, F == null ? void 0 : F.backdrop),
    ownerState: D
  });
...
const xc = ["className", "component", "elevation", "square", "variant"], Tc = (e) => {
  const {
    square: n,
    elevation: t,
    variant: r,
...
const Oc = ["onEntering"], Cc = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], Pc = ["slotProps"];
function vr(e, n) {
  let t = 0;
...
const Rc = (e) => {
  ...
  const a = ze({
    ...
    TransitionComponent: I = oc,
    transitionDuration: _ = "auto",
    TransitionProps: {
      onEntering: K
    } = {},
    disableScrollLock: Z = !1
  } = a, R = ae(a.TransitionProps, Oc), G = ae(a, Cc), q = (r = x == null ? void 0 : x.paper) != null ? r : V, ee = w.useRef(), M = Me(ee, q.ref), N = k({}, a, {
    anchorOrigin: u,
    anchorReference: p,
    elevation: g,
    marginThreshold: h,
...
`)), h !== null && Ue < h) {
  ...
  let F = _;
  _ === "auto" && !I.muiSupportAuto && (F = void 0);
  const j = b || (l ? be(Sn(l)).body : void 0), L = (o = v == null ? void 0 : v.root) != null ? o : Nc, W = (i = v == null ? void 0 : v.paper) != null ? i : uo, X = rn({
    elementType: W,
...
const Mc = ["onEntering"], Ic = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Ac = {
  vertical: "top",
  horizontal: "right"
}, Dc = {
  vertical: "top",
  ...
  const i = ze({
    ...
    slots: V = {},
    slotProps: v = {}
  } = i, x = ae(i.TransitionProps, Mc), m = ae(i, Ic), I = qn(), _ = I.direction === "rtl", K = k({}, i, {
    autoFocus: a,
    ...
    TransitionProps: x,
    variant: T
  }), Z = Bc(K), R = a && !u && f, G = w.useRef(null), q = (Q, E) => {
...
`)), Q.props.disabled || (T === "selectedMenu" && Q.props.selected || M === -1) && (M = E));
  ...
  const N = (r = V.paper) != null ? r : Vc, $ = (o = v.paper) != null ? o : y, B = rn({
    elementType: V.root,
  ...
  return /* @__PURE__ */ C(jc, k({
    onClose: p,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: _ ? "right" : "left"
    },
    transformOrigin: _ ? Ac : Dc,
    slots: {
      paper: N,
      root: V.root
    },
...
const Fc = po;
function vl(e) {
  const { className: n, commandHandler: t, items: r } = e, [o, i] = Qe.useState(void 0), a = (l) => {
    l.preventDefault(), i(
      o === void 0 ? {
        mouseX: l.clientX + 2,
        mouseY: l.clientY - 6
  ...
  return /* @__PURE__ */ xe("div", { onContextMenu: a, style: { cursor: "context-menu" }, children: [
    "children",
    /* @__PURE__ */ C(
      Fc,
      {
        className: `${n} papi-context-menu`,
        open: o !== void 0,
        onClose: c,
        anchorReference: "anchorPosition",
        anchorPosition: o !== void 0 ? { top: o.mouseY, left: o.mouseX } : void 0,
        children: /* @__PURE__ */ C(Nr, { items: r, commandHandler: t, onClick: c })
      }
    )
  ] });
}
var zc = Object.defineProperty, Uc = (e, n, t) => n in e ? zc(e, n, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[n] = t, J = (e, n, t) => (Uc(e, typeof n != "symbol" ? n + "" : n, t), t);
const Ve = [
  "GEN",
  "EXO",
  "LEV",
...
function* Gc() {
  for (let e = 1; e <= Ve.length; e++)
    yield e;
}
const Kc = 1, go = Ve.length;
function Xc() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function Ct(e, n = "***") {
  const t = e - 1;
  return t < 0 || t >= Ve.length ? n : Ve[t];
}
function bo(e) {
...
function El({ scrRef: e, handleSubmit: n, id: t }) {
  const r = (l) => {
    n(l);
  }, o = (l, u) => {
  ...
  return /* @__PURE__ */ xe("span", { id: t, children: [
    ...
    /* @__PURE__ */ C(
      ...
      {
        onClick: () => n(At(e, 1)),
        isDisabled: e.chapterNum >= Lo(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ C(
...
function xl({ onSearch: e, placeholder: n, isFullWidth: t }) {
  const [r, o] = en(""), i = (a) => {
    o(a), e(a);
  };
  return /* @__PURE__ */ C(Co, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ C(
    Mn,
    {
      isFullWidth: t,
...
const el = ({ onChange: e, disabled: n, checked: t, ...r }) => /* @__PURE__ */ C(
  Ho,
  {
    ...r,
    isChecked: t,
...
const tl = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], rl = (e) => {
  const {
    color: n,
    fontSize: t,
    classes: r
  ...
  const r = ze({
    ...
    titleAccess: p,
    viewBox: f = "0 0 24 24"
  } = r, y = ae(r, tl), b = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", g = k({}, r, {
    color: a,
    component: c,
    fontSize: l,
...
function Ol({
  ...
  let h = e;
  return !h && n && (h = n(l)), /* @__PURE__ */ C("div", { ref: f, style: { position: "relative" }, children: /* @__PURE__ */ C(_o, { position: "static", id: o, children: /* @__PURE__ */ xe($o, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    h ? /* @__PURE__ */ C(
      Rr,
      {
        edge: "start",
    ...
    h ? /* @__PURE__ */ C(
      Mo,
      {
        ...
        children: /* @__PURE__ */ C(Go, { commandHandler: g, columns: h.columns })
      }
    ) : void 0
  ] }) }) });
}
...
.papi-menu.paratext .papi-menu-item {
  background-color: darkgreen;
  color: greenyellow;
}

.papi-menu.paratext.bright .papi-menu-item {
  background-color: greenyellow;
  color: darkgreen;
}
