...
import { getChaptersForBook as _l, deepEqual as po, substring as Pl, formatScrRef as Rr, compareScrRefs as Xr, scrRefToBBBCCCVVV as _r, getLocalizeKeyForScrollGroupId as pt, NumberFormat as $l, formatBytes as Il } from "platform-bible-utils";
...
import { useReactTable as ci, getCoreRowModel as di, getPaginationRowModel as Al, getSortedRowModel as pi, getFilteredRowModel as Ml, flexRender as wn, getExpandedRowModel as Dl, getGroupedRowModel as jl } from "@tanstack/react-table";
...
import Bl, { ThemeContext as Vl, internal_processStyles as zl } from "@mui/styled-engine";
import { MenuItem as Fl, ListItemText as Ll, ListItemIcon as fi, Menu as Gl, Grid as mi, List as Ul, IconButton as hi, Drawer as Xl, AppBar as Hl, Toolbar as Yl } from "@mui/material";
...
), uo = ft.Root, gi = ft.Trigger, tc = ft.Group, ch = ft.Portal, dh = ft.Sub, ph = ft.RadioGroup, ec = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  ft.SubTrigger,
  {
    ref: o,
    className: N(
...
var oc = Object.defineProperty, ac = (t, e, n) => e in t ? oc(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, et = (t, e, n) => ac(t, typeof e != "symbol" ? e + "" : e, n);
const xe = [
  "GEN",
  "EXO",
  "LEV",
...
const fn = ot.allBookIds, vc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, da = ["OT", "NT", "DC"], yc = 32 + 32 + 32, xc = [
  /^(\w+)$/i,
...
function wh({ scrRef: t, handleSubmit: e }) {
  const n = xt(), [r, o] = ut(""), [a, i] = ut(
    ot.bookNumberToId(t.bookNum)
  ), [l, c] = ut(t.chapterNum ?? 0), [d, p] = ut(
    ot.bookNumberToId(t.bookNum)
  ), [m, w] = ut(!1), [g, v] = ut(m), f = be(void 0), h = be(void 0), k = be(void 0), T = Et(
    (I) => Nc(I).filter((M) => {
    ...
    xc.forEach((I) => {
      const M = r.match(I);
      if (M) {
        const [H, G = void 0, B = void 0] = M.slice(1), Z = Sc(H);
    ...
    (I) => {
      m ? (I.key === "ArrowDown" || I.key === "ArrowUp") && (typeof k < "u" && // Ref uses null
  ...
  return se(() => {
    ...
    const I = setTimeout(() => {
      if (g && h.current && k.current) {
        const H = k.current.offsetTop - yc;
  ...
  }, [g]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(uo, { modal: !1, open: m, onOpenChange: b, children: [
    /* @__PURE__ */ s(gi, { asChild: !0, children: /* @__PURE__ */ s(
      Ql,
      {
        ...
        handleKeyDown: $,
        handleOnClick: () => {
          i(ot.bookNumberToId(t.bookNum)), p(ot.bookNumberToId(t.bookNum)), c(t.chapterNum > 0 ? t.chapterNum : 0), w(!0), f.current.focus();
        },
        onFocus: () => {
          E.current = !0;
        },
        ...
        children: /* @__PURE__ */ x("div", { className: "rtl:tw-ps-2", children: [
          ...
          da.map(
            (I, M) => T(I).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ s(Cn, { className: "tw-font-semibold tw-text-foreground/80", children: vc[I] }),
...
const Tc = qe(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? We : "button", { className: N(Tc({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const Cc = qe(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Mt = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(li.Root, { ref: n, className: N("pr-twp", Cc(), t), ...e }));
...
const Oc = Wt.Portal, Ri = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Wt.Overlay,
  {
    ref: n,
    className: N(
...
const Rc = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = xt();
  return /* @__PURE__ */ x(Oc, { children: [
    /* @__PURE__ */ s(Ri, {}),
    /* @__PURE__ */ x(
      Wt.Content,
      {
...
Rc.displayName = Wt.Content.displayName;
...
$c.displayName = _t.Separator.displayName;
...
function qr({
  ...
  const [h, k] = ut(!1);
  return /* @__PURE__ */ x(Ci, { open: h, onOpenChange: k, ...f, children: [
...
var Mc = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(Mc || {});
...
function mh({
  ...
  const p = Pr(d, "%webView_bookSelector_currentBook%"), m = Pr(d, "%webView_bookSelector_choose%"), w = Pr(d, "%webView_bookSelector_chooseBooks%"), [g, v] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), f = (h) => {
    v(h), t(h);
...
function Dc({ table: t }) {
  return /* @__PURE__ */ x(uo, { children: [
    /* @__PURE__ */ s(Rl, { asChild: !0, children: /* @__PURE__ */ x(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Ve = bt.Root, jc = bt.Group, ze = bt.Value, Ne = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = xt();
  return /* @__PURE__ */ x(
    bt.Trigger,
    {
...
Bc.displayName = bt.Label.displayName;
...
Vc.displayName = bt.Separator.displayName;
function zc({ table: t }) {
...
const Lc = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "caption",
  {
    ref: n,
...
function Gc({
  ...
  var h;
  const [l, c] = ut([]), [d, p] = ut([]), [m, w] = ut({}), [g, v] = ut({}), f = ci({
    data: e,
    columns: t,
    getCoreRowModel: di(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ s(Dc, { table: f }),
    /* @__PURE__ */ x(ir, { stickyHeader: a, children: [
      /* @__PURE__ */ s(sr, { stickyHeader: a, children: f.getHeaderGroups().map((k) => /* @__PURE__ */ s(ie, { children: k.headers.map((T) => /* @__PURE__ */ s(yn, { children: T.isPlaceholder ? void 0 : wn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
      /* @__PURE__ */ s(lr, { children: (h = f.getRowModel().rows) != null && h.length ? f.getRowModel().rows.map((k) => /* @__PURE__ */ s(
        ie,
        {
          onClick: () => i(k, f),
...
}, Yc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ii = qe(
...
), Wc = S.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  ui.Root,
  {
    ref: o,
...
Wc.displayName = ui.Root.displayName;
...
const cr = (t) => t === "asc" ? /* @__PURE__ */ s(wl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(fl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(ml, { className: "tw-ms-2 tw-h-4 tw-w-4" }), hh = (t) => ({
  accessorKey: "item",
  ...
  return Xc(t).forEach((p) => {
    p.startsWith("\\id") && (i = Hc(p), l = 0, c = 0), p.startsWith("\\c") && (l = pa(p), c = 0), p.startsWith("\\v") && (c = pa(p), l === 0 && (l = e.chapterNum));
    let m = o.exec(p) ?? void 0;
    for (; m; ) {
      const w = [];
      m.forEach((h) => w.push(h));
      const g = m.index, v = a.find((h) => po(h.items, w)), f = {
        reference: {
          bookNum: i !== void 0 ? i : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: Pl(p, Math.max(0, g - 25), Math.min(g + 25, p.length))
      };
      if (v)
...
function yh({
  ...
  const m = Zt(n, "%webView_inventory_all%"), w = Zt(n, "%webView_inventory_approved%"), g = Zt(n, "%webView_inventory_unapproved%"), v = Zt(n, "%webView_inventory_unknown%"), f = Zt(n, "%webView_inventory_scope_currentBook%"), h = Zt(n, "%webView_inventory_scope_chapter%"), k = Zt(n, "%webView_inventory_scope_verse%"), T = Zt(n, "%webView_inventory_filter_text%"), C = Zt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [_, F] = ut("all"), [R, $] = ut(""), [L, D] = ut([]), I = Ct(() => l ? r instanceof RegExp ? Jc(
    l,
    t,
    a,
    i,
        ...
        Ve,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(ke, { children: [
              /* @__PURE__ */ s(Bt, { value: "all", children: m }),
...
function Zc({
  ...
  const [p, m] = ut(!1), w = Et(
    (f) => {
      var k;
      const h = (k = t.find((T) => T.label === f)) == null ? void 0 : k.value;
      h && r(
    ...
    if (!l)
      return t;
    const f = t.filter((k) => k.starred).sort((k, T) => k.label.localeCompare(T.label)), h = t.filter((k) => !k.starred).sort((k, T) => {
      const C = n.includes(k.value), E = n.includes(T.value);
      return C && !E ? -1 : !C && E ? 1 : k.label.localeCompare(T.label);
    });
    return [...f, ...h];
  }, [t, n, l]);
  return /* @__PURE__ */ s("div", { className: d, children: /* @__PURE__ */ x(Ci, { open: p, onOpenChange: m, children: [
    /* @__PURE__ */ s(Oi, { asChild: !0, children: /* @__PURE__ */ x(
      wt,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ s(go, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(bo, { children: [
      ...
      /* @__PURE__ */ x(yo, { children: [
        ...
        /* @__PURE__ */ s(_i, { children: v.map((f) => {
          ...
          return /* @__PURE__ */ x(
            No,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ s("div", { className: "tw-w-4", children: f.starred && /* @__PURE__ */ s(hl, { className: "tw-h-4 tw-w-4" }) }),
...
function xh({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(ji, { children: [
      /* @__PURE__ */ s(Bi, { children: t.map((i) => /* @__PURE__ */ s(Qc, { value: i.value, children: i.value }, i.key)) }),
...
const td = Tn.Provider, ed = Tn.Root, nd = Tn.Trigger, zi = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  Tn.Content,
  {
    ref: r,
    sideOffset: e,
...
const rd = "16rem", od = "3rem", Fi = S.createContext(void 0);
function dr() {
...
const Li = S.forwardRef(
  ({
    ...
    const [d, p] = S.useState(t), m = e ?? d, w = S.useCallback(
      (C) => {
        const E = typeof C == "function" ? C(m) : C;
        n ? n(E) : p(E);
      },
      [n, m]
    ), g = S.useCallback(() => w((C) => !C), [w]), v = m ? "expanded" : "collapsed", k = xt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = S.useMemo(
      () => ({
        state: v,
        open: m,
        setOpen: w,
    ...
    return /* @__PURE__ */ s(Fi.Provider, { value: T, children: /* @__PURE__ */ s(td, { delayDuration: 0, children: /* @__PURE__ */ s(
      "div",
      {
        style: (
...
const ad = S.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = dr();
  return /* @__PURE__ */ x(
    wt,
    {
...
const sd = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Ke,
  {
    ref: n,
    "data-sidebar": "input",
...
const dd = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Eo,
  {
    ref: n,
...
const pd = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? We : "button",
  {
    ref: r,
  ...
  ({
    ...
    const c = t ? We : "button", { state: d } = dr(), p = /* @__PURE__ */ s(
      c,
      {
        ...
        "data-size": r,
        "data-active": e,
        className: N(ud({ variant: n, size: r }), a),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ x(ed, { children: [
...
const wd = S.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ s(
  e ? We : "button",
  {
    ref: o,
...
const md = S.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
...
const bd = S.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ s(
  t ? We : "a",
  {
    ref: a,
...
function vd({
  ...
  return /* @__PURE__ */ s(
    Gi,
    {
      ...
      collapsible: "none",
      variant: "inset",
      className: N("tw-w-96 tw-gap-2 tw-overflow-y-auto tw-bg-slate-100", c),
      children: /* @__PURE__ */ x(Xi, { children: [
        /* @__PURE__ */ x(Kr, { children: [
          /* @__PURE__ */ s(Jr, { className: "tw-text-sm tw-text-gray-400", children: a }),
          /* @__PURE__ */ s(Zr, { children: /* @__PURE__ */ s(Hi, { children: e.map((w) => /* @__PURE__ */ s(Yi, { children: /* @__PURE__ */ s(
            Wi,
            {
              className: N(
              ...
              onClick: () => d(w),
              isActive: m(w),
              children: /* @__PURE__ */ s("span", { className: "tw-pl-3", children: w })
            }
          ) }, w)) }) })
        ] }),
        /* @__PURE__ */ x(Kr, { children: [
...
const oe = "scrBook", yd = "scrRef", fe = "source", xd = "details", Nd = "Scripture Reference", kd = "Scripture Book", qi = "Type", Ed = "Details";
function Sd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, wa = (t) => `${Td({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function kh({
  sources: t,
  ...
  const [c, d] = ut([]), [p, m] = ut([{ id: oe, desc: !1 }]), [w, g] = ut({}), v = Ct(
    ...
    !e && /* @__PURE__ */ x(
      Ve,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(ke, { position: "item-aligned", children: /* @__PURE__ */ s(jc, { children: C.map((R) => /* @__PURE__ */ s(Bt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
                    ...
                    children: (() => D.getIsGrouped() ? /* @__PURE__ */ x(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ s(oi, {}) : /* @__PURE__ */ s(yl, {})),
                          " ",
...
function _d() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = i, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = v, it.Memo = g, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = m, it.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === m || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === i || b.$$typeof === l || b.$$typeof === p || b.$$typeof === h || b.$$typeof === k || b.$$typeof === T || b.$$typeof === f);
  }, it.typeOf = C, it;
}
var st = {};
/** @license React v16.13.1
...
function Pd() {
  return ma || (ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(A) {
      ...
      A === r || A === d || A === a || A === o || A === m || A === w || typeof A == "object" && A !== null && (A.$$typeof === v || A.$$typeof === g || A.$$typeof === i || A.$$typeof === l || A.$$typeof === p || A.$$typeof === h || A.$$typeof === k || A.$$typeof === T || A.$$typeof === f);
    }
    function E(A) {
    ...
    var b = c, _ = d, F = l, R = i, $ = e, L = p, D = r, I = v, M = g, H = n, G = a, B = o, Z = m, at = !1;
    function rt(A) {
...
var ha;
function Zi() {
  return ha || (ha = 1, process.env.NODE_ENV === "production" ? zn.exports = _d() : zn.exports = Pd()), zn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ad() {
  if (xa)
    return Vr;
  xa = 1;
  var t = Zi(), e = $d(), n = Co(), r = Qi(), o = Id(), a = function() {
  };
  ...
  return Vr = function(l, c) {
    ...
    function h(y) {
      ...
      function X(K, W, q, Y, J, Q, dt) {
        ...
        return W[q] == null ? K ? W[q] === null ? new f("The " + J + " `" + Q + "` is marked as required " + ("in `" + Y + "`, but its value is `null`.")) : new f("The " + J + " `" + Q + "` is marked as required in " + ("`" + Y + "`, but its value is `undefined`.")) : null : y(W, q, Y, J, Q);
      }
      var z = X.bind(null, !1);
    ...
    function C(y) {
      function O(U, X, z, K, W) {
        ...
        if (!Array.isArray(q)) {
          var Y = B(q);
          return new f("Invalid " + K + " `" + W + "` of type " + ("`" + Y + "` supplied to `" + z + "`, expected an array."));
        }
    ...
    function E() {
      function y(O, U, X, z, K) {
        ...
        if (!l(W)) {
          var q = B(W);
          return new f("Invalid " + z + " `" + K + "` of type " + ("`" + q + "` supplied to `" + X + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(y);
    ...
    function b() {
      function y(O, U, X, z, K) {
        ...
        if (!t.isValidElementType(W)) {
          var q = B(W);
          return new f("Invalid " + z + " `" + K + "` of type " + ("`" + q + "` supplied to `" + X + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(y);
    ...
    function _(y) {
      function O(U, X, z, K, W) {
        if (!(U[X] instanceof y)) {
          ...
          return new f("Invalid " + K + " `" + W + "` of type " + ("`" + Y + "` supplied to `" + z + "`, expected ") + ("instance of `" + q + "`."));
        }
        return null;
      }
      return h(O);
    ...
    function F(y) {
      ...
      function O(U, X, z, K, W) {
        ...
        return new f("Invalid " + K + " `" + W + "` of value `" + String(q) + "` " + ("supplied to `" + z + "`, expected one of " + J + "."));
      }
      return h(O);
    }
    function R(y) {
      function O(U, X, z, K, W) {
        ...
        var q = U[X], Y = B(q);
        if (Y !== "object")
          return new f("Invalid " + K + " `" + W + "` of type " + ("`" + Y + "` supplied to `" + z + "`, expected an object."));
        for (var J in q)
          if (r(q, J)) {
            var Q = y(q, J, z, K, W + "." + J, n);
            if (Q instanceof Error)
    ...
    function $(y) {
      ...
      function X(z, K, W, q, Y) {
        ...
        return new f("Invalid " + q + " `" + Y + "` supplied to " + ("`" + W + "`" + Nt + "."));
      }
      return h(X);
    }
    function L() {
      function y(O, U, X, z, K) {
        return H(O[U]) ? null : new f("Invalid " + z + " `" + K + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return h(y);
    }
    ...
    function I(y) {
      function O(U, X, z, K, W) {
        var q = U[X], Y = B(q);
        if (Y !== "object")
          return new f("Invalid " + K + " `" + W + "` of type `" + Y + "` " + ("supplied to `" + z + "`, expected `object`."));
        for (var J in y) {
          var Q = y[J];
...
function ts(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Vd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${i}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const es = To(u.element, ts);
es.isRequired = To(u.element.isRequired, ts);
const ns = es, zd = "exact-prop: ​";
function Fd(t) {
...
function Gd() {
  return Ea || (Ea = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), m = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, f = !1, h = !1, k = !1, T = !1, C;
    C = Symbol.for("react.module.reference");
    function E(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || T || V === r || V === d || V === p || k || V === g || v || f || h || typeof V == "object" && V !== null && (V.$$typeof === w || V.$$typeof === m || V.$$typeof === a || V.$$typeof === i || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    var _ = i, F = a, R = t, $ = c, L = n, D = w, I = m, M = e, H = o, G = r, B = d, Z = p, at = !1, rt = !1;
    function y(V) {
...
process.env.NODE_ENV === "production" ? to.exports = Ld() : to.exports = Gd();
var Sa = to.exports;
...
const Yd = u.oneOfType([u.func, u.object]), os = Yd;
function qt(t) {
  if (typeof t != "string")
...
const tp = typeof window < "u" ? j.useLayoutEffect : j.useEffect, Ge = tp;
let Ca = 0;
function ep(t) {
...
function pp(t) {
  t.addEventListener("keydown", cp, !0), t.addEventListener("mousedown", Fr, !0), t.addEventListener("pointerdown", Fr, !0), t.addEventListener("touchstart", Fr, !0), t.addEventListener("visibilitychange", dp, !0);
}
function up(t) {
  const {
    target: e
...
function ss() {
  ...
  function n() {
    return e.current ? (no = !0, ip.start(100, () => {
      no = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function mp(t, e = Number.MIN_SAFE_INTEGER, n = Number.MAX_SAFE_INTEGER) {
...
const hp = ["values", "unit", "step"], gp = (t) => {
...
function bp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = kt(t, hp), a = gp(e), i = Object.keys(a);
  function l(w) {
...
const vp = {
  borderRadius: 4
}, yp = vp, xp = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.string, u.object, u.array]) : {}, le = xp;
function mn(t, e) {
  return e ? Qt(t, e, {
    clone: !1
...
function vt(t) {
  const {
    ...
    return te(i, l, (m) => {
      let w = Jn(d, o, m);
      return m === w && typeof m == "string" && (w = Jn(d, o, `${e}${m === "default" ? "" : qt(m)}`, m)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
const Sp = {
  ...
  if (t.length > 2)
    if ($a[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = Sp[e], o = Tp[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), fr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], mr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Op = [...fr, ...mr];
function Rn(t, e, n, r) {
  var o;
...
function _p(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = Cp(n), a = Rp(o, r), i = t[n];
  return te(t, i, a);
}
function ws(t, e) {
  const n = us(t.theme);
  return Object.keys(t).map((r) => _p(t, e, r, n)).reduce(mn, {});
}
function ht(t) {
  return ws(t, fr);
}
...
gt.filterProps = mr;
process.env.NODE_ENV !== "production" && Op.reduce((t, e) => (t[e] = le, t), {});
function Pp(t = 8) {
  if (t.mui)
    return t;
  const e = us({
...
const $p = Gt("border", Vt), Ip = Gt("borderTop", Vt), Ap = Gt("borderRight", Vt), Mp = Gt("borderBottom", Vt), Dp = Gt("borderLeft", Vt), jp = Gt("borderColor"), Bp = Gt("borderTopColor"), Vp = Gt("borderRightColor"), zp = Gt("borderBottomColor"), Fp = Gt("borderLeftColor"), Lp = Gt("outline", Vt), Gp = Gt("outlineColor"), gr = (t) => {
...
hr($p, Ip, Ap, Mp, Dp, jp, Bp, Vp, zp, Fp, gr, Lp, Gp);
const br = (t) => {
...
hr(br, vr, yr, Up, Xp, Hp, Yp, Wp, qp, Kp, Jp, Zp);
function Be(t, e) {
  return e === "grey" ? e : t;
}
const Qp = vt({
...
function pu() {
  function t(n, r, o, a) {
    ...
    const w = wr(o, d) || {};
    return m ? m(i) : te(i, r, (v) => {
      let f = Jn(w, p, v);
      return v === f && typeof v == "string" && (f = Jn(w, p, `${n}${v === "default" ? "" : qt(v)}`, v)), c === !1 ? f : {
        [c]: f
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = Np(a.breakpoints), m = Object.keys(p);
      let w = p;
...
function Io(t = {}, ...e) {
  ...
  return d.applyStyles = uu, d = e.reduce((p, m) => Qt(p, m), d), d.unstable_sxConfig = P({}, Po, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(m) {
    return $o({
      sx: m,
      theme: this
    });
...
const hu = ["ownerState"], gu = ["variants"], bu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function vu(t) {
  return Object.keys(t).length === 0;
}
function yu(t) {
...
const xu = Io(), Ia = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Fn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function ku(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    zl(i, (b) => b.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = Nu(Ia(d))
    } = l, g = kt(l, bu), v = p !== void 0 ? p : (
    ...
    let k = Hn;
    d === "Root" || d === "root" ? k = r : d ? k = o : yu(i) && (k = void 0);
    const T = Bl(i, P({
      shouldForwardProp: k,
      label: h
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${qt(d || "")}`), D === void 0 && (D = `Styled(${Hd(i)})`), L.displayName = D;
      }
...
function Ao(t, e = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (t < e || t > n) && console.error(`MUI: The value provided ${t} is out of range [${e}, ${n}].`), mp(t, e, n);
}
function Tu(t) {
  t = t.slice(1);
...
function Aa(t) {
  t = Se(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Se(Cu(t)).values : t.values;
...
const Pu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Me = Vu, zu = ["mode", "contrastThreshold", "tonalOffset"], Da = {
...
function ja(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = Ru(t.main, o) : e === "dark" && (t.dark = Ou(t.main, a)));
}
function Fu(t = "light") {
  return t === "dark" ? {
    main: Ie[200],
...
function Yu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = kt(t, zu), a = t.primary || Fu(e), i = t.secondary || Lu(e), l = t.error || Gu(e), c = t.info || Uu(e), d = t.success || Xu(e), p = t.warning || Hu(e);
  function m(f) {
    const h = Ma(f, Lr.text.primary) >= n ? Lr.text.primary : Da.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Ma(f, h);
...
`));
  ...
  const w = ({
    ...
    if (f = P({}, f), !f.main && f[k] && (f.main = f[k]), !f.hasOwnProperty("main"))
...
} });` : Le(12, h ? ` (${h})` : "", JSON.stringify(f.main)));
    return ja(f, "light", T, r), ja(f, "dark", C, r), f.contrastText || (f.contrastText = m(f.main)), f;
  }, g = {
    dark: Lr,
    light: Da
  };
...
function Ku(t, e) {
  ...
  const g = o / 14, v = m || ((k) => `${k / d * g}rem`), f = (k, T, C, E, b) => P({
    fontFamily: r,
    fontWeight: k,
    fontSize: v(T),
    ...
    button: f(l, 14, 1.75, 0.4, Ba),
    caption: f(i, 12, 1.66, 0.4),
    overline: f(i, 12, 2.66, 1, Ba),
...
const tw = ["none", mt(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), mt(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), mt(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), mt(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), mt(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), mt(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), mt(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), mt(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), mt(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), mt(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), mt(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), mt(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), mt(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), mt(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), mt(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), mt(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), mt(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), mt(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), mt(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), mt(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), mt(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), mt(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), mt(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), mt(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], ew = tw, nw = ["duration", "easing", "delay"], rw = {
...
function iw(t) {
  const e = P({}, rw, t.easing), n = P({}, ow, t.duration);
  return P({
...
const sw = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, lw = sw, cw = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function dw(t = {}, ...e) {
  const {
    mixins: n = {},
    palette: r = {},
  ...
  if (d = Qt(d, i), d = e.reduce((p, m) => Qt(p, m), d), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return d.unstable_sxConfig = P({}, Po, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(m) {
    return $o({
      sx: m,
      theme: this
    });
...
const uw = (t) => Hn(t) && t !== "classes", ww = ku({
  themeId: Do,
  defaultTheme: Mo,
...
const mw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], hw = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
  ...
  const r = jo({
    ...
    titleAccess: m,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, mw), v = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", f = P({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
`)), cs.configure(t);
  ...
  createSvgIcon: bs,
  debounce: qd,
  deprecatedPropType: Kd,
  isMuiElement: Jd,
  ownerDocument: qn,
  ownerWindow: Zd,
  requirePropFactory: Qd,
  setRef: Kn,
  unstable_ClassNameGenerator: bw,
...
}, Symbol.toStringTag, { value: "Module" })), yw = /* @__PURE__ */ Od(vw);
var La;
function xw() {
...
var vs = So.default = void 0, kw = Nw(xw()), Ew = Qs;
vs = So.default = (0, kw.default)(/* @__PURE__ */ (0, Ew.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Sw(t) {
...
}, Cw = /* @__PURE__ */ j.createContext(Tw);
function Ow(t) {
  const {
...
function Pw(t) {
  ...
  if (!e) {
    const g = ve(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = P({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = P({}, n, o, r);
    return g.length > 0 && (f.className = g), Object.keys(v).length > 0 && (f.style = v), {
      props: f,
      internalRef: void 0
    };
  }
  const i = Rw(P({}, o, r)), l = Ga(r), c = Ga(o), d = e(i), p = ve(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = P({}, d, n, c, l);
  return p.length > 0 && (w.className = p), Object.keys(m).length > 0 && (w.style = m), {
    props: w,
    internalRef: d.ref
  };
}
const $w = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function Iw(t) {
  var e;
  const {
    elementType: n,
...
process.env.NODE_ENV !== "production" && (Zn["propTypes"] = Fd(Zn.propTypes));
var Ot = "top", Ft = "bottom", Lt = "right", Rt = "left", Vo = "auto", $n = [Ot, Ft, Lt, Rt], Ue = "start", kn = "end", Bw = "clippingParents", Ns = "viewport", sn = "popper", Vw = "reference", Ua = /* @__PURE__ */ $n.reduce(function(t, e) {
  return t.concat([e + "-" + Ue, e + "-" + kn]);
}, []), ks = /* @__PURE__ */ [].concat($n, [Vo]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Ue, e + "-" + kn]);
}, []), zw = "beforeRead", Fw = "read", Lw = "afterRead", Gw = "beforeMain", Uw = "main", Xw = "afterMain", Hw = "beforeWrite", Yw = "write", Ww = "afterWrite", qw = [zw, Fw, Lw, Gw, Uw, Xw, Hw, Yw, Ww];
function Kt(t) {
...
function He(t, e, n) {
  ...
  var i = Te(t) ? Dt(t) : window, l = i.visualViewport, c = !Es() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, m = r.width / o, w = r.height / a;
  return {
    width: m,
    height: w,
    top: p,
...
function In(t) {
  for (var e = Dt(t), n = Xa(t); n && Qw(n) && ee(n).position === "static"; )
    n = Xa(n);
  return n && (Kt(n) === "html" || Kt(n) === "body" && ee(n).position === "static") ? e : n || tf(t) || e;
}
function Lo(t) {
...
function rf(t) {
  ...
  if (!(!a || !i)) {
    var m = nf(o.padding, n), w = Fo(a), g = c === "y" ? Ot : Rt, v = c === "y" ? Ft : Lt, f = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = In(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - h / 2, E = m[g], b = T - w[p] - m[v], _ = T / 2 - w[p] / 2 + C, F = hn(E, _, b), R = c;
...
function Ha(t) {
  ...
  if (d) {
    ...
    if (_ === Dt(n) && (_ = ce(n), ee(_).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), _ = _, o === Ot || (o === Rt || o === Lt) && a === kn) {
      E = Ft;
      var $ = m && _ === b && b.visualViewport ? b.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        _[F]
      );
      f -= $ - r.height, f *= c ? 1 : -1;
    ...
    if (o === Rt || (o === Ot || o === Ft) && a === kn) {
      C = Lt;
      var L = m && _ === b && b.visualViewport ? b.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        _[R]
      );
      g -= L - r.width, g *= c ? 1 : -1;
  ...
  if (g = I.x, f = I.y, c) {
    var M;
    return Object.assign({}, D, (M = {}, M[E] = T ? "0" : "", M[C] = k ? "0" : "", M.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + f + "px)" : "translate3d(" + g + "px, " + f + "px, 0)", M));
  }
  return Object.assign({}, D, (e = {}, e[E] = T ? f + "px" : "", e[C] = k ? g + "px" : "", e.transform = "", e));
}
function cf(t) {
...
function Wa(t, e, n) {
  return e === Ns ? oo(mf(t, n)) : Te(e) ? gf(e, n) : oo(hf(ce(t)));
}
function bf(t) {
...
function vf(t, e, n, r) {
  var o = e === "clippingParents" ? bf(t) : [].concat(e), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, d) {
    var p = Wa(t, d, r);
...
function En(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Bw : l, d = n.rootBoundary, p = d === void 0 ? Ns : d, m = n.elementContext, w = m === void 0 ? sn : m, g = n.altBoundary, v = g === void 0 ? !1 : g, f = n.padding, h = f === void 0 ? 0 : f, k = Cs(typeof h != "number" ? h : Os(h, $n)), T = w === sn ? Vw : sn, C = t.rects.popper, E = t.elements[v ? T : w], b = vf(Te(E) ? E : E.contextElement || ce(t.elements.popper), c, p, i), _ = He(t.elements.reference), F = _s({
    reference: _,
    element: C,
    strategy: "absolute",
    placement: o
...
function yf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? ks : c, p = Ye(r), m = p ? l ? Ua : Ua.filter(function(v) {
    return Ye(v) === p;
  }) : $n, w = m.filter(function(v) {
...
function Nf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, m = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, h = e.options.placement, k = Yt(h), T = k === h, C = c || (T || !v ? [Wn(h)] : xf(h)), E = [h].concat(C).reduce(function(z, K) {
      return z.concat(Yt(K) === Vo ? yf(e, {
        placement: K,
        boundary: p,
        rootBoundary: m,
        padding: d,
...
function Ef(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, i = En(e, {
    ...
    altBoundary: !0
  }), c = qa(i, r), d = qa(l, o, a), p = Ka(c), m = Ka(d);
  e.modifiersData[n] = {
...
function $f(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, m = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, h = En(e, {
    boundary: c,
    rootBoundary: d,
    padding: m,
    altBoundary: p
  }), k = Yt(e.placement), T = Ye(e.placement), C = !T, E = Lo(k), b = Pf(E), _ = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, $ = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, L = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
  ...
  if (_) {
    ...
    if (l) {
      var de, St = E === "x" ? Ot : Rt, Mn = E === "x" ? Ft : Lt, Xt = _[b], Ce = b === "y" ? "height" : "width", pe = Xt + h[St], Oe = Xt - h[Mn], Re = [Ot, Rt].indexOf(k) !== -1, _e = (de = D == null ? void 0 : D[b]) != null ? de : 0, ue = Re ? pe : Xt - F[Ce] - R[Ce] - _e + L.altAxis, Ze = Re ? Xt + F[Ce] + R[Ce] - _e - L.altAxis : Oe, Dn = g && Re ? ef(ue, Xt, Ze) : hn(g ? ue : pe, Xt, g ? Ze : Oe);
      _[b] = Dn, I[b] = Dn - Xt;
    }
    e.modifiersData[r] = I;
  }
...
function jf(t, e, n) {
  ...
  Xo(a)) && (l = Mf(e)), zt(e) ? (c = He(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Uo(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = Vf(Ff([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (Za(T, C)) {
            p.rects = {
              reference: jf(T, In(C), p.options.strategy === "fixed"),
              popper: Fo(C)
...
var Gf = [uf, _f, df, Zw, Of, kf, If, af, Sf], Uf = /* @__PURE__ */ Lf({
  defaultModifiers: Gf
});
const Ps = "Popper";
function Xf(t) {
...
Dw(Ps, ["root"]);
const Hf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Yf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Wf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Kf = () => Oo({
  root: ["root"]
}, Ow(Xf)), Jf = {}, Zf = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, h = kt(e, Hf), k = j.useRef(null), T = Ee(k, n), C = j.useRef(null), E = Ee(C, w), b = j.useRef(E);
  Ge(() => {
    b.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const _ = Wf(p, i), [F, R] = j.useState(_), [$, L] = j.useState(tr(o));
  j.useEffect(() => {
...
`));
  ...
  const I = Kf(), M = (r = v.root) != null ? r : "div", H = Iw({
    elementType: M,
...
var em = function(e) {
  ...
  return n.componentDidMount = function() {
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Vn.findDOMNode(this), l], d = c[0], p = c[1], m = this.getTimeouts(), w = l ? m.appear : m.enter;
    if (!o && !i || Qa.disabled) {
      this.safeSetState({
        status: je
      }, function() {
...
const om = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function so(t) {
  return `scale(${t}, ${t ** 2})`;
}
const am = {
  ...
  const {
    ...
    TransitionComponent: h = nm
  } = e, k = kt(e, om), T = dn(), C = j.useRef(), E = Is(), b = j.useRef(null), _ = Ee(b, a.ref, n), F = (G) => (B) => {
    if (G) {
      const Z = b.current;
      B === void 0 ? G(Z) : G(Z, B);
    }
    ...
    let y;
    f === "auto" ? (y = E.transitions.getAutoHeightDuration(G.clientHeight), C.current = y) : y = Z, G.style.transition = [E.transitions.create("opacity", {
      duration: y,
      delay: at
    ...
    let rt;
    f === "auto" ? (rt = E.transitions.getAutoHeightDuration(G.clientHeight), C.current = rt) : rt = B, G.style.transition = [E.transitions.create("opacity", {
      duration: rt,
      delay: Z
    }), E.transitions.create("transform", {
      ...
      easing: at
    })].join(","), G.style.opacity = 0, G.style.transform = so(0.75), m && m(G);
  }), M = F(w);
  return /* @__PURE__ */ s(h, P({
    ...
    onExiting: D,
    addEndListener: (G) => {
      f === "auto" && T.start(C.current || 0, G), r && r(b.current, G);
    },
...
Ho.muiSupportAuto = !0;
const ei = Ho, im = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], sm = Pn($s, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ms(), a = jo({
    ...
    slots: C,
    slotProps: E
  } = a, b = kt(a, im), _ = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = P({
    anchorEl: i,
    container: p,
    disablePortal: m,
    keepMounted: w,
...
const cm = ps("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ae = cm, dm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function pm(t) {
  return Math.round(t * 1e5) / 1e5;
}
const um = (t) => {
...
const js = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r, o, a, i, l, c, d, p, m, w, g, v, f, h, k, T, C, E, b;
  const _ = jo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: Nt
  } = _, V = kt(_, dm), yt = /* @__PURE__ */ j.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
...
`));
  const Ws = j.useMemo(() => {
    ...
    touch: pe.current
  }), Or = um(nn), ra = (r = (o = Q.popper) != null ? o : $.Popper) != null ? r : wm, oa = (a = (i = (l = Q.transition) != null ? l : $.Transition) != null ? i : A) != null ? a : ei, aa = (c = (d = Q.tooltip) != null ? d : $.Tooltip) != null ? c : fm, ia = (p = (m = Q.arrow) != null ? m : $.Arrow) != null ? p : mm, qs = pn(ra, P({}, Y, (w = J.popper) != null ? w : L.popper, {
    className: ve(Or.popper, Y == null ? void 0 : Y.className, (g = (v = J.popper) != null ? v : L.popper) == null ? void 0 : g.className)
  }), nn), Ks = pn(oa, P({}, Nt, (f = J.transition) != null ? f : L.transition), nn), Js = pn(aa, P({}, (h = J.tooltip) != null ? h : L.tooltip, {
  ...
  const {
    ...
    Fl,
    {
      ...
      children: n ? /* @__PURE__ */ x(ne, { children: [
        ri(a, n, !0),
        /* @__PURE__ */ s(Ll, { primary: n, inset: !a && o }),
        m ? /* @__PURE__ */ s(fi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(vs, {}) }) : ri(i, n, !1)
      ] }) : h
    }
  );
  return r ? /* @__PURE__ */ s(hm, { title: r, placement: "right", children: /* @__PURE__ */ s("div", { children: k }) }) : k;
}
function Vs(t) {
...
const bm = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function zs(t) {
  ...
  return /* @__PURE__ */ x(
    mi,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ s(Ul, { id: n, dense: !0, className: a ?? "", children: /* @__PURE__ */ s(
          vm,
          {
            commandHandler: t,
            menuDefinition: e,
...
function Em({
  ...
  const [c, d] = ut(!1), [p, m] = ut(!1), w = Et(() => {
    c && d(!1), m(!1);
  }, [c]), g = Et((E) => {
    E.stopPropagation(), d((b) => {
      const _ = !b;
      return _ && E.shiftKey ? m(!0) : _ || m(!1), _;
    });
  }, []), v = Et(
    (E) => (w(), r(E)),
    [r, w]
...
const An = er(({ className: t, ...e }, n) => /* @__PURE__ */ s(xl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
function Ph({
  ...
  const a = be(void 0);
  return /* @__PURE__ */ s("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ s(Hl, { position: "static", id: r, children: /* @__PURE__ */ x(
    Yl,
    {
...
), Tm = S.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: N(Sm({ variant: e }), t), ...n }));
...
const Om = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: N("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Om.displayName = "AlertDescription";
const Rm = qe(
...
function _m({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ s("div", { className: N("pr-twp", Rm({ variant: e }), t), ...n });
}
...
jm.displayName = cn.Root.displayName;
const Bm = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    Yr.Root,
    {
...
Bm.displayName = Yr.Root.displayName;
const Ih = Pt.Root, Vm = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    Pt.List,
    {
...
Vm.displayName = Pt.List.displayName;
...
zm.displayName = Pt.Trigger.displayName;
...
Fm.displayName = Pt.Content.displayName;
function Ah({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ s(
    wt,
    {
      ...
      children: t ? /* @__PURE__ */ s(An, { size: 15 }) : /* @__PURE__ */ x(ne, { children: [
        /* @__PURE__ */ s(Nl, { size: 25, className: N("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
const Lm = er((t, e) => /* @__PURE__ */ x(
  wt,
  {
    ...
    ...t,
    children: [
      /* @__PURE__ */ s(kl, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ s(
        nr,
        {
...
function Vh({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ x(uo, { children: [
    ...
    /* @__PURE__ */ s(or, { children: e.map((n) => /* @__PURE__ */ x("div", { children: [
      ...
      /* @__PURE__ */ s(tc, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(wo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(vi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(ar, {})
    ] }, n.label)) })
  ] }) });
}
function zh({ id: t, message: e }) {
      ...
      children: [
        ...
        /* @__PURE__ */ x("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ s(El, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
...
function Lh({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ x("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ s(Um, { versionHistory: o }),
...
function Gh({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ s("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((m) => {
      var w;
      return /* @__PURE__ */ x(_m, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ s(
          wt,
          {
            variant: "ghost",
...
function Uh({
  ...
  const c = Xm(
    ...
    var h, k, T, C, E, b;
    const f = v !== g ? ((k = (h = t[g]) == null ? void 0 : h.uiNames) == null ? void 0 : k[v]) ?? ((C = (T = t[g]) == null ? void 0 : T.uiNames) == null ? void 0 : C.en) : void 0;
