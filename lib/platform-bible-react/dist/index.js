import { jsxs as me, jsx as w, Fragment as Wr } from "react/jsx-runtime";
import * as oe from "react";
import { forwardRef as Gr, useState as _e, useMemo as _n, useCallback as Ke, useRef as Sn, useEffect as tn } from "react";
import * as Y from "@radix-ui/react-dropdown-menu";
import { ChevronRight as Hr, Check as qr, Circle as Xr } from "lucide-react";
import Yr, { clsx as Kr } from "clsx";
import { twMerge as Jr } from "tailwind-merge";
import { Button as Zr, Autocomplete as Qr, TextField as xr, FormControlLabel as Fn, FormLabel as et, Checkbox as nt, MenuItem as rt, Grid as kr, IconButton as Sr, Paper as tt, Slider as ot, Snackbar as at, Switch as it, AppBar as st, Toolbar as ct, Drawer as lt } from "@mui/material";
import { offsetBook as Ln, FIRST_SCR_BOOK_NUM as ut, offsetChapter as Un, FIRST_SCR_CHAPTER_NUM as dt, getChaptersForBook as ft, offsetVerse as Wn, FIRST_SCR_VERSE_NUM as pt } from "platform-bible-utils";
import ht, { SelectColumn as mt } from "react-data-grid";
import gt, { ThemeContext as bt, internal_processStyles as yt } from "@mui/styled-engine";
function we(...e) {
  return Jr(Kr(e));
}
const vt = Y.Root, wt = Y.Trigger, xt = oe.forwardRef(({ className: e, inset: n, children: r, ...t }, o) => /* @__PURE__ */ me(
  Y.SubTrigger,
  {
    ref: o,
    className: we(
    ...
    children: [
      r,
      /* @__PURE__ */ w(Hr, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
xt.displayName = Y.SubTrigger.displayName;
const kt = oe.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ w(
  Y.SubContent,
  {
    ref: r,
    className: we(
...
kt.displayName = Y.SubContent.displayName;
...
const St = oe.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ w(
  Y.Item,
  {
    ref: t,
    className: we(
...
const Et = oe.forwardRef(({ className: e, children: n, checked: r, ...t }, o) => /* @__PURE__ */ me(
  Y.CheckboxItem,
  {
    ref: o,
    className: we(
    ...
    ...t,
    children: [
      /* @__PURE__ */ w("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ w(Y.ItemIndicator, { children: /* @__PURE__ */ w(qr, { className: "pr-h-4 pr-w-4" }) }) }),
      n
    ]
  }
));
Et.displayName = Y.CheckboxItem.displayName;
const Ct = oe.forwardRef(({ className: e, children: n, ...r }, t) => /* @__PURE__ */ me(
  Y.RadioItem,
  {
    ref: t,
    className: we(
    ...
    ...r,
    children: [
      /* @__PURE__ */ w("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ w(Y.ItemIndicator, { children: /* @__PURE__ */ w(Xr, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      n
    ]
  }
));
Ct.displayName = Y.RadioItem.displayName;
const Tt = oe.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ w(
  Y.Label,
  {
    ref: t,
...
Tt.displayName = Y.Label.displayName;
const _t = oe.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ w(
  Y.Separator,
  {
    ref: r,
...
_t.displayName = Y.Separator.displayName;
...
const Ot = Gr(
  ({ handleSearch: e, handleClick: n, ...r }, t) => /* @__PURE__ */ w(
    Cr,
    {
      ...r,
      type: "text",
...
function Nt({ endChapter: e, activeChapter: n, handleSelectChapter: r }) {
...
function Bi() {
  const [e, n] = _e("");
  return /* @__PURE__ */ w("div", { children: /* @__PURE__ */ me(vt, { children: [
    /* @__PURE__ */ w(wt, { asChild: !0, children: /* @__PURE__ */ w(
      Ot,
      {
        value: e,
        handleSearch: (o) => {
...
function Di({
  ...
  return /* @__PURE__ */ me(Wr, { children: [
    /* @__PURE__ */ w(
      Fn,
      {
...
var Be = /* @__PURE__ */ ((e) => (e.After = "after", e.Before = "before", e.Above = "above", e.Below = "below", e))(Be || {});
function Rt({
  id: e,
  isChecked: n,
  labelText: r = "",
  labelPosition: t = Be.After,
  isIndeterminate: o = !1,
  isDefaultChecked: a,
  isDisabled: i = !1,
  hasError: l = !1,
  ...
  let p;
  if (r) {
    const d = t === Be.Before || t === Be.Above, v = /* @__PURE__ */ w("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: r }), b = t === Be.Before || t === Be.After, h = b ? v : /* @__PURE__ */ w("div", { children: v }), f = b ? u : /* @__PURE__ */ w("div", { children: u });
    p = /* @__PURE__ */ me(
      et,
      {
...
function It({ commandHandler: e, name: n, className: r, items: t, id: o }) {
...
function At({ commandHandler: e, className: n, columns: r, id: t }) {
  return /* @__PURE__ */ w(
    kr,
    {
      container: !0,
...
var Pt = Object.defineProperty, Mt = (e, n, r) => n in e ? Pt(e, n, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[n] = r, I = (e, n, r) => (Mt(e, typeof n != "symbol" ? n + "" : n, r), r);
const Oe = [
  "GEN",
  "EXO",
  "LEV",
...
function Fe(e, n = !0) {
  return n && (e = e.toUpperCase()), e in Gn ? Gn[e] : 0;
}
function Nn(e) {
  return Fe(e) > 0;
}
...
const Te = class {
  ...
  constructor(e) {
    if (I(this, "name"), I(this, "fullPath"), I(this, "isPresent"), I(this, "hasVerseSegments"), I(this, "isCustomized"), I(this, "baseVersification"), I(this, "scriptureBooks"), I(this, "_type"), e != null)
...
let se = Te;
I(se, "Original", new Te(ke.Original)), I(se, "Septuagint", new Te(ke.Septuagint)), I(se, "Vulgate", new Te(ke.Vulgate)), I(se, "English", new Te(ke.English)), I(se, "RussianProtestant", new Te(ke.RussianProtestant)), I(se, "RussianOrthodox", new Te(ke.RussianOrthodox));
function Hn(e, n) {
  const r = n[0];
...
const $ = class {
  constructor(e, n, r, t) {
    if (I(this, "firstChapter"), I(this, "lastChapter"), I(this, "lastVerse"), I(this, "hasSegmentsDefined"), I(this, "text"), I(this, "BBBCCCVVVS"), I(this, "longHashCode"), I(this, "versification"), I(this, "rtlMark", "‏"), I(this, "_bookNum", 0), I(this, "_chapterNum", 0), I(this, "_verseNum", 0), I(this, "_verse"), r == null && t == null)
  ...
  allVerses(e = !1, n = $.verseRangeSeparators, r = $.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const t = [], o = Hn(this._verse, r);
    for (const a of o.map((i) => Hn(i, n))) {
      const i = this.clone();
      i.verse = a[0];
      const l = i.verseNum;
...
let be = $;
I(be, "defaultVersification", se.English), I(be, "verseRangeSeparator", "-"), I(be, "verseSequenceIndicator", ","), I(be, "verseRangeSeparators", [$.verseRangeSeparator]), I(be, "verseSequenceIndicators", [$.verseSequenceIndicator]), I(be, "chapterDigitShifter", 1e3), I(be, "bookDigitShifter", $.chapterDigitShifter * $.chapterDigitShifter), I(be, "bcvMaxValue", $.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
I(be, "ValidStatusType", $r);
...
function Vi({ scrRef: e, handleSubmit: n, id: r }) {
  const t = (c) => {
    n(c);
  }, o = (c, s) => {
  ...
  return /* @__PURE__ */ me("span", { id: r, children: [
    ...
    /* @__PURE__ */ w(
      ...
      {
        onClick: () => n(Un(e, 1)),
        isDisabled: e.chapterNum >= ft(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ w(
    ...
    /* @__PURE__ */ w(
      ...
      {
        onClick: () => n(Wn(e, -1)),
        isDisabled: e.verseNum <= pt,
        children: "<"
      }
    ),
    /* @__PURE__ */ w($e, { onClick: () => n(Wn(e, 1)), children: ">" })
  ] });
}
function Fi({ onSearch: e, placeholder: n, isFullWidth: r }) {
  const [t, o] = _e(""), a = (i) => {
    o(i), e(i);
  };
  return /* @__PURE__ */ w(tt, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ w(
    Qe,
    {
      isFullWidth: r,
...
const Ht = ({ onChange: e, disabled: n, checked: r, ...t }) => /* @__PURE__ */ w(
  Rt,
  {
    ...t,
    isChecked: r,
...
function Gi({
  ...
  return /* @__PURE__ */ w(
    ht,
    {
      ...
      onPaste: ue,
      onScroll: T,
      renderers: { renderCheckbox: Ht },
      className: H ?? "rdg-light"
    }
  );
}
function z() {
...
function fe(e, n, r = {
  ...
  return Se(e) && Se(n) && Object.keys(n).forEach((o) => {
    o !== "__proto__" && (Se(n[o]) && o in e && Se(e[o]) ? t[o] = fe(e[o], n[o], r) : r.clone ? t[o] = Se(n[o]) ? Ir(n[o]) : n[o] : t[o] = n[o]);
  }), t;
}
function qt(e) {
...
function Yt() {
  return Yn || (Yn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var m = c, Q = s, re = l, pe = i, ue = n, T = u, H = t, Z = b, te = v, U = r, de = a, ee = o, ge = p, Ce = !1;
    function Ne(y) {
    ...
    V.AsyncMode = m, V.ConcurrentMode = Q, V.ContextConsumer = re, V.ContextProvider = pe, V.Element = ue, V.ForwardRef = T, V.Fragment = H, V.Lazy = Z, V.Memo = te, V.Portal = U, V.Profiler = de, V.StrictMode = ee, V.Suspense = ge, V.isAsyncMode = Ne, V.isConcurrentMode = g, V.isContextConsumer = x, V.isContextProvider = R, V.isElement = O, V.isForwardRef = E, V.isFragment = A, V.isLazy = _, V.isMemo = N, V.isPortal = P, V.isProfiler = D, V.isStrictMode = M, V.isSuspense = ne, V.isValidElementType = B, V.typeOf = C;
  }()), V;
}
var Kn;
function Ar() {
  return Kn || (Kn = 1, process.env.NODE_ENV === "production" ? Ye.exports = Xt() : Ye.exports = Yt()), Ye.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Zt() {
  if (nr)
    return vn;
  nr = 1;
  var e = Ar(), n = Kt(), r = $n(), t = Pr(), o = Jt(), a = function() {
  };
  ...
  return vn = function(l, c) {
    ...
    function f(g) {
      ...
      function O(A, _, N, P, D, M, ne) {
        ...
        return _[N] == null ? A ? _[N] === null ? new h("The " + D + " `" + M + "` is marked as required " + ("in `" + P + "`, but its value is `null`.")) : new h("The " + D + " `" + M + "` is marked as required in " + ("`" + P + "`, but its value is `undefined`.")) : null : g(_, N, P, D, M);
      }
      var E = O.bind(null, !1);
      return E.isRequired = O.bind(null, !0), E;
    }
    function S(g) {
      function x(R, O, E, A, _, N) {
        var P = R[O], D = ee(P);
        if (D !== g) {
          var M = ge(P);
          return new h(
            "Invalid " + A + " `" + _ + "` of type " + ("`" + M + "` supplied to `" + E + "`, expected ") + ("`" + g + "`."),
            { expectedType: g }
          );
        }
        return null;
    ...
    function B(g) {
      function x(R, O, E, A, _) {
        if (typeof g != "function")
          return new h("Property `" + _ + "` of component `" + E + "` has invalid PropType notation inside arrayOf.");
        var N = R[O];
        if (!Array.isArray(N)) {
          var P = ee(N);
          return new h("Invalid " + A + " `" + _ + "` of type " + ("`" + P + "` supplied to `" + E + "`, expected an array."));
        }
        for (var D = 0; D < N.length; D++) {
          var M = g(N, D, E, A, _ + "[" + D + "]", r);
    ...
    function C() {
      function g(x, R, O, E, A) {
        var _ = x[R];
        if (!l(_)) {
          var N = ee(_);
          return new h("Invalid " + E + " `" + A + "` of type " + ("`" + N + "` supplied to `" + O + "`, expected a single ReactElement."));
        }
        return null;
      }
      return f(g);
    ...
    function m() {
      function g(x, R, O, E, A) {
        ...
        if (!e.isValidElementType(_)) {
          var N = ee(_);
          return new h("Invalid " + E + " `" + A + "` of type " + ("`" + N + "` supplied to `" + O + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return f(g);
    ...
    function Q(g) {
      function x(R, O, E, A, _) {
        if (!(R[O] instanceof g)) {
          var N = g.name || d, P = Ne(R[O]);
          return new h("Invalid " + A + " `" + _ + "` of type " + ("`" + P + "` supplied to `" + E + "`, expected ") + ("instance of `" + N + "`."));
        }
        return null;
      }
      return f(x);
    ...
    function re(g) {
      ...
      function x(R, O, E, A, _) {
        for (var N = R[O], P = 0; P < g.length; P++)
          if (b(N, g[P]))
            return null;
        ...
        return new h("Invalid " + A + " `" + _ + "` of value `" + String(N) + "` " + ("supplied to `" + E + "`, expected one of " + D + "."));
      }
      return f(x);
    }
    function pe(g) {
      function x(R, O, E, A, _) {
        ...
        var N = R[O], P = ee(N);
        if (P !== "object")
          return new h("Invalid " + A + " `" + _ + "` of type " + ("`" + P + "` supplied to `" + E + "`, expected an object."));
        for (var D in N)
          if (t(N, D)) {
            var M = g(N, D, E, A, _ + "." + D, r);
            if (M instanceof Error)
    ...
    function ue(g) {
      ...
      function O(E, A, _, N, P) {
        for (var D = [], M = 0; M < g.length; M++) {
          var ne = g[M], y = ne(E, A, _, N, P, r);
          if (y == null)
            return null;
          y.data && t(y.data, "expectedType") && D.push(y.data.expectedType);
        }
        var ie = D.length > 0 ? ", expected one of type [" + D.join(", ") + "]" : "";
        return new h("Invalid " + N + " `" + P + "` supplied to " + ("`" + _ + "`" + ie + "."));
      }
      return f(O);
    }
    function T() {
      function g(x, R, O, E, A) {
        return U(x[R]) ? null : new h("Invalid " + E + " `" + A + "` supplied to " + ("`" + O + "`, expected a ReactNode."));
      }
      return f(g);
    }
    function H(g, x, R, O, E) {
      return new h(
    ...
    function Z(g) {
      function x(R, O, E, A, _) {
        var N = R[O], P = ee(N);
        if (P !== "object")
          return new h("Invalid " + A + " `" + _ + "` of type `" + P + "` " + ("supplied to `" + E + "`, expected `object`."));
        for (var D in g) {
          var M = g[D];
          if (typeof M != "function")
            return H(E, A, _, D, ge(M));
          var ne = M(N, D, E, A, _ + "." + D, r);
          if (ne)
            return ne;
        }
        return null;
      ...
      function x(R, O, E, A, _) {
        ...
        for (var M in D) {
          ...
          if (t(g, M) && typeof ne != "function")
            return H(E, A, _, M, ge(ne));
          if (!ne)
            return new h(
              "Invalid " + A + " `" + _ + "` key `" + M + "` supplied to `" + E + "`.\nBad object: " + JSON.stringify(R[O], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(g), null, "  ")
            );
          var y = ne(N, M, E, A, _ + "." + M, r);
          if (y)
            return y;
        }
        return null;
...
if (process.env.NODE_ENV !== "production") {
  var eo = Ar(), no = !0;
  Cn.exports = Zt()(eo.isElement, no);
} else
  Cn.exports = Qt()();
var ro = Cn.exports;
const W = /* @__PURE__ */ qt(ro);
function je(e) {
...
function oo() {
  return or || (or = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var Q = i, re = a, pe = e, ue = c, T = r, H = d, Z = p, te = n, U = o, de = t, ee = s, ge = u, Ce = !1, Ne = !1;
    function g(k) {
    ...
    L.ContextConsumer = Q, L.ContextProvider = re, L.Element = pe, L.ForwardRef = ue, L.Fragment = T, L.Lazy = H, L.Memo = Z, L.Portal = te, L.Profiler = U, L.StrictMode = de, L.Suspense = ee, L.SuspenseList = ge, L.isAsyncMode = g, L.isConcurrentMode = x, L.isContextConsumer = R, L.isContextProvider = O, L.isElement = E, L.isForwardRef = A, L.isFragment = _, L.isLazy = N, L.isMemo = P, L.isPortal = D, L.isProfiler = M, L.isStrictMode = ne, L.isSuspense = y, L.isSuspenseList = ie, L.isValidElementType = C, L.typeOf = m;
  }()), L;
}
process.env.NODE_ENV === "production" ? Tn.exports = to() : Tn.exports = oo();
var ar = Tn.exports;
const ao = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function io(e) {
  const n = `${e}`.match(ao);
  return n && n[1] || "";
}
function Mr(e, n = "") {
  return e.displayName || e.name || io(e) || n;
}
function ir(e, n, r) {
  const t = Mr(n);
...
function In(e, n, r = "Mui") {
  const t = po[n];
  return t ? `${r}-${t}` : `${fo.generate(e)}-${n}`;
}
function ho(e, n, r = "Mui") {
  const t = {};
  return n.forEach((o) => {
    t[o] = In(e, o, r);
  }), t;
}
function mo(e, n = Number.MIN_SAFE_INTEGER, r = Number.MAX_SAFE_INTEGER) {
...
const go = ["values", "unit", "step"], bo = (e) => {
...
function yo(e) {
  const {
    ...
    unit: r = "px",
    step: t = 5
  } = e, o = xe(e, go), a = bo(n), i = Object.keys(a);
  function l(d) {
...
const vo = {
  borderRadius: 4
}, wo = vo, xo = process.env.NODE_ENV !== "production" ? W.oneOfType([W.number, W.string, W.object, W.array]) : {}, Ee = xo;
function We(e, n) {
  return n ? fe(e, n, {
    clone: !1
...
function ve(e, n, r) {
  ...
  if (typeof n == "object") {
    ...
    return Object.keys(n).reduce((i, l) => {
      if (Object.keys(a.values || An).indexOf(l) !== -1) {
        const c = a.up(l);
        i[c] = r(n[l], l);
      } else {
        const c = l;
...
function Ro(e, n, r, t) {
  if (n.indexOf(r) === -1)
    return null;
  const o = _o(r), a = No(o, t), i = e[r];
  return ve(e, i, a);
}
function Dr(e, n) {
  const r = Br(e.theme);
  return Object.keys(e).map((t) => Ro(e, n, t, r)).reduce(We, {});
}
function q(e) {
  return Dr(e, an);
}
...
X.filterProps = sn;
process.env.NODE_ENV !== "production" && Oo.reduce((e, n) => (e[n] = Ee, e), {});
function $o(e = 8) {
  if (e.mui)
    return e;
  const n = Br({
...
function cn(...e) {
  const n = e.reduce((t, o) => (o.filterProps.forEach((a) => {
    t[a] = o;
  }), t), {}), r = (t) => Object.keys(t).reduce((o, a) => n[a] ? We(o, n[a](t)) : o, {});
...
const Io = le("border", ce), Ao = le("borderTop", ce), Po = le("borderRight", ce), Mo = le("borderBottom", ce), zo = le("borderLeft", ce), Bo = le("borderColor"), Do = le("borderTopColor"), jo = le("borderRightColor"), Vo = le("borderBottomColor"), Fo = le("borderLeftColor"), Lo = le("outline", ce), Uo = le("outlineColor"), ln = (e) => {
...
cn(Io, Ao, Po, Mo, zo, Bo, Do, jo, Vo, Fo, ln, Lo, Uo);
const un = (e) => {
...
cn(un, dn, fn, Wo, Go, Ho, qo, Xo, Yo, Ko, Jo, Zo);
function De(e, n) {
  return n === "grey" ? n : e;
}
const Qo = K({
...
const ra = K({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const n = (r) => {
      var t, o;
      const a = ((t = e.theme) == null || (t = t.breakpoints) == null || (t = t.values) == null ? void 0 : t[r]) || An[r];
...
function da() {
  ...
  function n(r) {
    ...
    function l(c) {
      ...
      if (!s)
        return null;
      const u = ko(a.breakpoints), p = Object.keys(u);
      let d = u;
...
const jr = da();
jr.filterProps = ["sx"];
const zn = jr, fa = ["breakpoints", "palette", "spacing", "shape"];
function Bn(e = {}, ...n) {
  const {
    breakpoints: r = {},
    palette: t = {},
...
const ya = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function va(e) {
  return Object.keys(e).length === 0;
}
function wa(e) {
...
const xa = (e, n) => n.components && n.components[e] && n.components[e].styleOverrides ? n.components[e].styleOverrides : null, nn = (e) => {
  let n = 0;
  const r = {};
...
const Ea = Bn(), dr = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Ze({
  defaultTheme: e,
  theme: n,
  themeId: r
...
function Ta(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    yt(i, (C) => C.filter((m) => !(m != null && m.__mui_systemSx)));
    const {
      name: c,
      slot: s,
      ...
      overridesResolver: d = Ca(dr(s))
    } = l, v = xe(l, ya), b = u !== void 0 ? u : (
    ...
    let S = Je;
    s === "Root" || s === "root" ? S = t : s ? S = o : wa(i) && (S = void 0);
    const J = gt(i, z({
      shouldForwardProp: S,
      label: f
    }, v)), B = (C, ...m) => {
      const Q = m ? m.map((T) => {
        ...
        if (Se(T)) {
          let H = T, Z;
          return T && T.variants && (Z = T.variants, delete H.variants, H = (te) => {
            let U = T;
      ...
      if (Se(C)) {
        let T;
        C && C.variants && (T = C.variants, delete re.variants, re = (H) => {
          let Z = C;
          return rn(H, nn(T), T).forEach((U) => {
            Z = fe(Z, U);
          }), Z;
        });
      } else
      ...
      if (process.env.NODE_ENV !== "production") {
        let T;
        c && (T = `${c}${he(s || "")}`), T === void 0 && (T = `Styled(${so(i)})`), ue.displayName = T;
      }
...
function Fr(e, n = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < n || e > r) && console.error(`MUI: The value provided ${e} is out of range [${n}, ${r}].`), mo(e, n, r);
}
function Na(e) {
  e = e.slice(1);
...
function pr(e) {
  e = Ve(e);
  let n = e.type === "hsl" || e.type === "hsla" ? Ve(Ra(e)).values : e.values;
...
const Pa = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, ze = La, Ua = ["mode", "contrastThreshold", "tonalOffset"], mr = {
...
function gr(e, n, r, t) {
  ...
  e[n] || (e.hasOwnProperty(r) ? e[n] = e[r] : n === "light" ? e.light = Ia(e.main, o) : n === "dark" && (e.dark = $a(e.main, a)));
}
function Wa(e = "light") {
  return e === "dark" ? {
    main: Pe[200],
...
function Ka(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = xe(e, Ua), a = e.primary || Wa(n), i = e.secondary || Ga(n), l = e.error || Ha(n), c = e.info || qa(n), s = e.success || Xa(n), u = e.warning || Ya(n);
  function p(h) {
...
const ei = 0.2, ni = 0.14, ri = 0.12;
function G(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${ei})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${ni})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${ri})`].join(",");
}
const ti = ["none", G(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), G(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), G(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), G(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), G(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), G(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), G(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), G(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), G(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), G(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), G(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), G(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), G(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), G(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), G(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), G(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), G(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), G(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), G(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), G(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), G(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), G(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), G(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), G(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], oi = ti, ai = ["duration", "easing", "delay"], ii = {
...
function li(e) {
  const n = z({}, ii, e.easing), r = z({}, si, e.duration);
  return z({
...
const ui = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, di = ui, fi = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function pi(e = {}, ...n) {
  const {
    mixins: r = {},
    palette: t = {},
...
const gi = (e) => Je(e) && e !== "classes", bi = Ta({
  themeId: Ur,
  defaultTheme: Lr,
...
const wi = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], xi = (e) => {
  ...
  const t = mi({
    ...
    titleAccess: p,
    viewBox: d = "0 0 24 24"
  } = t, v = xe(t, wi), b = /* @__PURE__ */ oe.isValidElement(o) && o.type === "svg", h = z({}, t, {
    color: i,
    component: l,
    fontSize: c,
  ...
  u || (f.viewBox = d);
  const S = xi(h);
  return /* @__PURE__ */ me(ki, z({
    as: l,
    className: Yr(S.root, a),
    focusable: "false",
    color: s,
...
function Hi({
  ...
  let f = e;
  return !f && n && (f = n(c)), /* @__PURE__ */ w("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ w(st, { position: "static", id: o, children: /* @__PURE__ */ me(ct, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ w(
      Sr,
      {
        edge: "start",
    ...
    f ? /* @__PURE__ */ w(
      lt,
      {
        ...
        children: /* @__PURE__ */ w(At, { commandHandler: h, columns: f.columns })
      }
    ) : void 0
  ] }) }) });
}
...
const Ti = (e, n, r = {}) => {
  ...
  const [a, i] = _e(() => t.current), [l, c] = _e(!0);
  return tn(() => {
    let s = !0;
    return c(!!e), (async () => {
      if (e) {
...
`, "top");
export {
  Bi as BookChapterControl,
  $e as Button,
  Di as ChapterRangeSelector,
  Rt as Checkbox,
  En as ComboBox,
  At as GridMenu,
  ji as IconButton,
