import cs, { jsxs as pe, jsx as E, Fragment as Un } from "react/jsx-runtime";
import * as x from "react";
import $t, { forwardRef as Oi, useCallback as Pe, useState as xe, useRef as ft, useEffect as Lt, useLayoutEffect as Eo, useMemo as Ft } from "react";
import { getChaptersForBook as Si, offsetBook as To, FIRST_SCR_BOOK_NUM as us, offsetChapter as ko, FIRST_SCR_CHAPTER_NUM as ps, offsetVerse as Oo, FIRST_SCR_VERSE_NUM as ds } from "platform-bible-utils";
...
import Ee, { clsx as ws } from "clsx";
...
import { Autocomplete as Ts, TextField as ks, FormControlLabel as So, FormLabel as Os, Checkbox as Ss, MenuItem as Cs, ListItemText as Ps, ListItemIcon as Pi, Menu as Ns, Grid as Ni, List as Rs, IconButton as Ri, Drawer as $s, Paper as Ms, Slider as Is, Snackbar as _s, Switch as As, AppBar as Ds, Toolbar as js } from "@mui/material";
...
*/
te(Ce, "ValidStatusType", ji);
class Kt extends Error {
}
function ye(...e) {
  return xs(ws(e));
}
const nl = ge.Root, rl = ge.Trigger, ol = x.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ pe(
  ge.SubTrigger,
  {
    ref: o,
    className: ye(
    ...
    children: [
      n,
      /* @__PURE__ */ E(fs, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
ol.displayName = ge.SubTrigger.displayName;
const il = x.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ E(
  ge.SubContent,
  {
    ref: n,
    className: ye(
...
il.displayName = ge.SubContent.displayName;
const Bi = x.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ E(ge.Portal, { children: /* @__PURE__ */ E(
  ge.Content,
  {
    ref: r,
    sideOffset: t,
...
const Li = x.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ E(
  ge.Item,
  {
    ref: r,
    className: ye(
...
const al = x.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ pe(
  ge.CheckboxItem,
  {
    ref: o,
    className: ye(
    ...
    ...r,
    children: [
      /* @__PURE__ */ E("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ E(ge.ItemIndicator, { children: /* @__PURE__ */ E(hs, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
al.displayName = ge.CheckboxItem.displayName;
const sl = x.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ pe(
  ge.RadioItem,
  {
    ref: r,
    className: ye(
    ...
    ...n,
    children: [
      /* @__PURE__ */ E("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ E(ge.ItemIndicator, { children: /* @__PURE__ */ E(ms, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
sl.displayName = ge.RadioItem.displayName;
const Br = x.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ E(
  ge.Label,
  {
    ref: r,
...
const Fi = x.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ E(
  ge.Separator,
  {
    ref: n,
...
const Lr = x.forwardRef(
  ({ className: e, type: t, ...n }, r) => /* @__PURE__ */ E(
    "input",
    {
      type: t,
      className: ye(
...
function cl({
  ...
  return /* @__PURE__ */ E("div", { className: ye("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: i.map((l) => /* @__PURE__ */ E(
    "div",
    {
      className: ye(
  ...
  ({
    ...
    Li,
    {
      ...
      children: [
        ...
        n && /* @__PURE__ */ E("div", { children: s })
      ]
    },
    e
  )
);
function pl({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ pe(Br, { className: "pr-flex pr-justify-between", children: [
    /* @__PURE__ */ E("p", { className: "pr-inline-block pr-align-middle", children: "Go To" }),
...
function Dh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = xe(""), [o, i] = xe(
    ...
    ce.bookNumberToId(e.bookNum)
  ), [p, f] = xe(!1), [d, b] = xe(p), v = ft(void 0), g = ft(void 0), h = ft(void 0), T = Pe(
    (C) => ml(C).filter((R) => {
    ...
    if (c === o) {
      ...
      s + $ <= 0 || s + $ > Xt(c) ? l(0) : $ !== 0 && (l(s + $), C.preventDefault());
    }
  };
  return Lt(() => {
  ...
  }, [d]), /* @__PURE__ */ E("div", { children: /* @__PURE__ */ pe(nl, { modal: !1, open: p, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ pe(
      Bi,
      {
        ...
        children: [
          ...
          No.map(
            (C, R) => T(C).length > 0 && /* @__PURE__ */ pe("div", { children: [
              /* @__PURE__ */ E(Br, { className: "pr-font-semibold pr-text-slate-700", children: dl[C] }),
              T(C).map(($) => /* @__PURE__ */ E("div", { children: /* @__PURE__ */ E(
                ul,
                {
                  bookId: $,
              ...
              No.length - 1 !== R ? /* @__PURE__ */ E(Fi, {}) : void 0
            ] }, C)
          )
        ]
      }
...
const yl = Ci(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, i) => /* @__PURE__ */ E(r ? Es : "button", { className: ye(yl({ variant: t, size: n, className: e })), ref: i, ...o })
);
...
function jh({
  ...
  const o = Ft(
    ...
    [r]
  ), [i, s] = xe(o[0]), [l, c] = xe(o[o.length - 1]);
  Lt(() => {
    s(o[0]), c(o[o.length - 1]);
  }, [o]);
  const u = (f, d) => {
    s(d), e(d), d > l && (c(d), t(d));
  }, p = (f, d) => {
...
function zi({
  ...
  let f;
  if (n) {
    const d = r === Nt.Before || r === Nt.Above, b = /* @__PURE__ */ E("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === Nt.Before || r === Nt.After, g = v ? b : /* @__PURE__ */ E("div", { children: b }), h = v ? p : /* @__PURE__ */ E("div", { children: p });
    f = /* @__PURE__ */ pe(
      Os,
      {
...
function Bh({
  ...
  return /* @__PURE__ */ pe("fieldset", { id: e, className: t, children: [
    n && /* @__PURE__ */ E("legend", { children: n }),
    r.map((l) => /* @__PURE__ */ E(
      zi,
      {
...
function El() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = p, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === r || m === u || m === i || m === o || m === f || m === d || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === b || m.$$typeof === s || m.$$typeof === l || m.$$typeof === p || m.$$typeof === h || m.$$typeof === T || m.$$typeof === I || m.$$typeof === g);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function Tl() {
  return $o || ($o = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(_) {
      ...
      _ === r || _ === u || _ === i || _ === o || _ === f || _ === d || typeof _ == "object" && _ !== null && (_.$$typeof === v || _.$$typeof === b || _.$$typeof === s || _.$$typeof === l || _.$$typeof === p || _.$$typeof === h || _.$$typeof === T || _.$$typeof === I || _.$$typeof === g);
    }
    function w(_) {
...
function Sl() {
  if (jo)
    return pr;
  jo = 1;
  var e = Ui(), t = kl(), n = Fr(), r = Hi(), o = Ol(), i = function() {
  };
...
function Ye(e, t, n = {
  ...
  return dt(e) && dt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (dt(t[o]) && o in e && dt(e[o]) ? r[o] = Ye(e[o], t[o], n) : n.clone ? r[o] = dt(t[o]) ? Wi(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function $l(e) {
  const {
...
const Gi = zt(a.element, qi);
Gi.isRequired = zt(a.element.isRequired, qi);
const hn = Gi;
function Ml(e) {
  const {
    prototype: t = {}
...
function jl() {
  return Fo || (Fo = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, g = !1, h = !1, T = !1, I = !1, y;
    y = Symbol.for("react.module.reference");
    function w(N) {
      return !!(typeof N == "string" || typeof N == "function" || N === n || N === o || I || N === r || N === u || N === p || T || N === b || v || g || h || typeof N == "object" && N !== null && (N.$$typeof === d || N.$$typeof === f || N.$$typeof === i || N.$$typeof === s || N.$$typeof === c || // This needs to include all possible module reference object
...
na.isRequired = ta;
Cr.isRequired = Cr;
const ra = process.env.NODE_ENV === "production" ? Cr : na;
function oa(e, t) {
  const n = k({}, t);
...
function hc(e) {
  ...
  const s = la(k({}, o, r)), l = qo(r), c = qo(o), u = t(s), p = Ee(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), d = k({}, u, n, c, l);
...
process.env.NODE_ENV !== "production" && (Dn["propTypes"] = Ki(Dn.propTypes));
function Oc(e) {
  return typeof e == "function" ? e() : e;
}
const un = /* @__PURE__ */ x.forwardRef(function(t, n) {
  const {
    children: r,
    container: o,
    disablePortal: i = !1
...
class Rc {
  ...
  remove(t, n = !0) {
    ...
    if (i.modals.splice(i.modals.indexOf(t), 1), this.modals.splice(r, 1), i.modals.length === 0)
      i.restore && i.restore(), t.modalRef && on(t.modalRef, n), Ko(i.container, t.mount, t.modalRef, i.hiddenSiblings, !1), this.containers.splice(o, 1);
    else {
...
function _c(e) {
  const {
    ...
    open: p,
    rootRef: f
  } = e, d = x.useRef({}), b = x.useRef(null), v = x.useRef(null), g = Le(v, f), [h, T] = x.useState(!p), I = Mc(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const w = () => Te(b.current), m = () => (d.current.modalRef = v.current, d.current.mount = b.current, d.current), S = () => {
    o.mount(m(), {
      disableScrollLock: r
  ...
  }), L = x.useCallback(() => o.isTopModal(m()), [o]), B = cn((M) => {
    b.current = M, M && (p && L() ? S() : v.current && on(v.current, y));
  }), F = x.useCallback(() => {
    o.remove(m(), y);
  }, [y, o]);
  x.useEffect(() => () => {
...
var Ne = "top", Fe = "bottom", Ve = "right", Re = "left", zr = "auto", gn = [Ne, Fe, Ve, Re], At = "start", pn = "end", Ac = "clippingParents", pa = "viewport", Yt = "popper", Dc = "reference", Xo = /* @__PURE__ */ gn.reduce(function(e, t) {
  return e.concat([t + "-" + At, t + "-" + pn]);
}, []), da = /* @__PURE__ */ [].concat(gn, [zr]).reduce(function(e, t) {
  return e.concat([t, t + "-" + At, t + "-" + pn]);
...
function jt(e, t, n) {
  ...
  var s = vt(e) ? Ae(e) : window, l = s.visualViewport, c = !fa() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / i, f = r.width / o, d = r.height / i;
  return {
    width: f,
    height: d,
    top: p,
...
var Qc = function(t, n) {
  ...
  })) : t, ga(typeof t != "number" ? t : ba(t, gn));
};
function eu(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Ue(n.placement), c = Wr(l), u = [Re, Ve].indexOf(l) >= 0, p = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = Qc(o.padding, n), d = Hr(i), b = c === "y" ? Ne : Re, v = c === "y" ? Fe : Ve, g = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], h = s[c] - n.rects.reference[c], T = bn(i), I = T ? c === "y" ? T.clientHeight || 0 : T.clientWidth || 0 : 0, y = g / 2 - h / 2, w = f[b], m = I - d[p] - f[v], S = I / 2 - d[p] / 2 + y, P = an(w, S, m), L = c;
...
function Jo(e) {
  ...
  b = h.x, g = h.y;
  var T = s.hasOwnProperty("x"), I = s.hasOwnProperty("y"), y = Re, w = Ne, m = window;
  if (u) {
    var S = bn(n), P = "clientHeight", L = "clientWidth";
    if (S === Ae(n) && (S = at(n), Ze(S).position !== "static" && l === "absolute" && (P = "scrollHeight", L = "scrollWidth")), S = S, o === Ne || (o === Re || o === Ve) && i === pn) {
      w = Fe;
  ...
  if (b = R.x, g = R.y, c) {
    var $;
    return Object.assign({}, C, ($ = {}, $[w] = I ? "0" : "", $[y] = T ? "0" : "", $.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", $));
  }
  return Object.assign({}, C, (t = {}, t[w] = I ? g + "px" : "", t[y] = T ? b + "px" : "", t.transform = "", t));
}
function iu(e) {
...
function va(e) {
  return ["html", "body", "#document"].indexOf(We(e)) >= 0 ? e.ownerDocument.body : Be(e) && Kr(e) ? e : va(Wn(e));
}
function sn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = va(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Ae(r), s = o ? [i].concat(i.visualViewport || [], Kr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function Qo(e, t, n) {
  return t === pa ? Nr(pu(e, n)) : vt(t) ? fu(t, n) : Nr(du(at(e)));
}
function hu(e) {
  var t = sn(Wn(e)), n = ["absolute", "fixed"].indexOf(Ze(e).position) >= 0, r = n && Be(e) ? bn(e) : e;
  return vt(r) ? t.filter(function(o) {
    return vt(o) && ha(o, r) && We(o) !== "body";
  }) : [];
}
function mu(e, t, n, r) {
...
function dn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Ac : l, u = n.rootBoundary, p = u === void 0 ? pa : u, f = n.elementContext, d = f === void 0 ? Yt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, h = g === void 0 ? 0 : g, T = ga(typeof h != "number" ? h : ba(h, gn)), I = d === Yt ? Dc : Yt, y = e.rects.popper, w = e.elements[v ? I : d], m = mu(vt(w) ? w : w.contextElement || at(e.elements.popper), c, p, s), S = jt(e.elements.reference), P = ya({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
  }), L = Nr(Object.assign({}, y, P)), B = d === Yt ? L : S, F = {
  ...
  if (d === Yt && C) {
    ...
    Object.keys(F).forEach(function($) {
      var j = [Ve, Fe].indexOf($) >= 0 ? 1 : -1, D = [Ne, Fe].indexOf($) >= 0 ? "y" : "x";
      F[$] += R[D] * j;
    });
  }
  return F;
...
function gu(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? da : c, p = Bt(r), f = p ? l ? Xo : Xo.filter(function(v) {
    return Bt(v) === p;
...
function vu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, p = n.boundary, f = n.rootBoundary, d = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, h = t.options.placement, T = Ue(h), I = T === h, y = c || (I || !v ? [Rn(h)] : bu(h)), w = [h].concat(y).reduce(function(z, H) {
      ...
      var C = w[F], R = Ue(C), $ = Bt(C) === At, j = [Ne, Fe].indexOf(R) >= 0, D = j ? "width" : "height", M = dn(t, {
        placement: C,
        boundary: p,
        rootBoundary: f,
        altBoundary: d,
...
function ti(e) {
  return [Ne, Ve, Fe, Re].some(function(t) {
    return e[t] >= 0;
  });
}
function wu(e) {
...
function Eu(e, t, n) {
  var r = Ue(e), o = [Re, Ne].indexOf(r) >= 0 ? -1 : 1, i = typeof n == "function" ? n(Object.assign({}, t, {
    placement: e
  })) : n, s = i[0], l = i[1];
...
function Tu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, i = o === void 0 ? [0, 0] : o, s = da.reduce(function(p, f) {
...
function Pu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, p = n.altBoundary, f = n.padding, d = n.tether, b = d === void 0 ? !0 : d, v = n.tetherOffset, g = v === void 0 ? 0 : v, h = dn(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: p
  }), T = Ue(t.placement), I = Bt(t.placement), y = !I, w = Wr(T), m = Cu(w), S = t.modifiersData.popperOffsets, P = t.rects.reference, L = t.rects.popper, B = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, F = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (S) {
    if (i) {
      var $, j = w === "y" ? Ne : Re, D = w === "y" ? Fe : Ve, M = w === "y" ? "height" : "width", V = S[w], Q = V + h[j], Z = V - h[D], O = b ? -L[M] / 2 : 0, A = I === At ? P[M] : L[M], U = I === At ? -L[M] : -P[M], K = t.elements.arrow, z = b && K ? Hr(K) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ma(), q = H[j], G = H[D], W = an(0, P[M], z[M]), X = y ? P[M] / 2 - O - W - q - F.mainAxis : A - W - q - F.mainAxis, Y = y ? -P[M] / 2 + O + W + G + F.mainAxis : U + W + G + F.mainAxis, ne = t.elements.arrow && bn(t.elements.arrow), _ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = ($ = C == null ? void 0 : C[w]) != null ? $ : 0, N = V + X - J - _, re = V + Y - J, ve = an(b ? jn(Q, N) : Q, V, b ? ht(Z, re) : Z);
      S[w] = ve, R[w] = ve - V;
    }
    if (l) {
      var Oe, me = w === "x" ? Ne : Re, lt = w === "x" ? Fe : Ve, Se = S[m], Ge = m === "y" ? "height" : "width", $e = Se + h[me], Ke = Se - h[lt], we = [Ne, Re].indexOf(T) !== -1, wt = (Oe = C == null ? void 0 : C[m]) != null ? Oe : 0, ct = we ? $e : Se - P[Ge] - L[Ge] - wt + F.altAxis, Ut = we ? Se + P[Ge] + L[Ge] - wt - F.altAxis : Ke, xn = b && we ? Zc(ct, Se, Ut) : an(b ? ct : $e, Se, b ? Ut : Ke);
      S[m] = xn, R[m] = xn - Se;
    }
    t.modifiersData[r] = R;
  }
  ...
  return function(l, c, u) {
    ...
    var p = {
      ...
      setOptions: function(T) {
        var I = typeof T == "function" ? T(p.options) : T;
        g(), p.options = Object.assign({}, i, p.options, I), p.scrollParents = {
          reference: vt(l) ? sn(l) : l.contextElement ? sn(l.contextElement) : [],
          popper: sn(c)
        };
      ...
      forceUpdate: function() {
        if (!d) {
          var T = p.elements, I = T.reference, y = T.popper;
          if (ri(I, y)) {
            p.rects = {
    ...
    function v() {
      p.orderedModifiers.forEach(function(h) {
        var T = h.name, I = h.options, y = I === void 0 ? {} : I, w = h.effect;
...
const qu = () => et({
  ...
  } = t, h = ue(t, zu), T = x.useRef(null), I = Le(T, n), y = x.useRef(null), w = Le(y, d), m = x.useRef(w);
  gt(() => {
    m.current = w;
...
`));
  ...
  if (i)
    ...
    const F = Bn(r);
    P = F && qn(F) ? Te(F).body : Te(null).body;
  }
  ...
  return /* @__PURE__ */ E(un, {
    disablePortal: l,
    container: P,
    children: /* @__PURE__ */ E(Ku, k({
      anchorEl: r,
      direction: s,
      disablePortal: l,
      modifiers: u,
...
function Ta(e, t) {
  const n = Ea(e.theme);
  return Object.keys(e).map((r) => cp(e, t, r, n)).reduce(ln, {});
}
function fe(e) {
  return Ta(e, Kn);
}
...
function nd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    let T = $n;
    u === "Root" || u === "root" ? T = r : u ? T = o : Qp(s) && (T = void 0);
    const I = Bs(s, k({
      shouldForwardProp: T,
      label: h
...
The color object needs to have a \`main\` property or a \`${T}\` property.` : It(11, h ? ` (${h})` : "", T));
...
function Nd(e, t) {
  ...
  const b = o / 14, v = f || ((T) => `${T / u * b}rem`), g = (T, I, y, w, m) => k({
    fontFamily: r,
    fontWeight: T,
    fontSize: v(I),
...
const Hd = Ud(), to = Hd, no = "$$material", Ca = (e) => $n(e) && e !== "classes", Wd = nd({
  themeId: no,
  defaultTheme: to,
...
const Pa = $t.createContext(null);
var Kd = function(t) {
  return t.scrollTop;
}, nn = "unmounted", ut = "exited", pt = "entering", Rt = "entered", $r = "exiting", nt = /* @__PURE__ */ function(e) {
  qd(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return i.appearStatus = null, r.in ? l ? (c = ut, i.appearStatus = pt) : c = Rt : r.unmountOnExit || r.mountOnEnter ? c = nn : c = ut, i.state = {
      status: c
...
const Yd = {
  ...
  const {
    ...
    TransitionComponent: h = Na
  } = t, T = ue(t, Xd), I = en(), y = x.useRef(), w = wn(), m = x.useRef(null), S = Le(m, i.ref, n), P = (D) => (M) => {
    if (D) {
      const V = m.current;
      M === void 0 ? D(V) : D(V, M);
    }
...
}, mi = Jd, Zd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Qd = ke(xa, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), $a = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r;
  const o = Oa(), i = tt({
    props: t,
    name: "MuiPopper"
...
const Ia = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, p, f, d, b, v, g, h, T, I, y, w, m;
  const S = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: J
  } = S, N = ue(S, nf), re = /* @__PURE__ */ x.isValidElement(L) ? L : /* @__PURE__ */ E("span", {
    children: L
  }), ve = wn(), Oe = ve.direction === "rtl", [me, lt] = x.useState(), [Se, Ge] = x.useState(null), $e = x.useRef(!1), Ke = j || Z, we = en(), wt = en(), ct = en(), Ut = en(), [xn, so] = Zi({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const nr = Ji(O), Ht = x.useRef(), En = cn(() => {
  ...
  const lo = (ee) => {
    ...
    $e.current && ee.type !== "touchstart" || (me && me.removeAttribute("title"), wt.clear(), ct.clear(), M || Pn && V ? wt.start(Pn ? V : M, () => {
      lo(ee);
    }) : lo(ee));
  }, co = (ee) => {
    wt.clear(), ct.start(A, () => {
    ...
    onFocus: Za,
    ref: Qa
  } = Qi(), [, po] = x.useState(!1), fo = (ee) => {
    Ja(ee), uo.current === !1 && (po(!1), co(ee));
  }, ho = (ee) => {
    me || lt(ee.currentTarget), Za(ee), uo.current === !0 && (po(!0), rr(ee));
  }, mo = (ee) => {
    $e.current = !0;
    const Me = re.props;
    Me.onTouchStart && Me.onTouchStart(ee);
  }, go = rr, bo = co, es = (ee) => {
    mo(ee), ct.clear(), we.clear(), En(), Ht.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Ut.start(Q, () => {
      document.body.style.WebkitUserSelect = Ht.current, rr(ee);
    });
  }, ts = (ee) => {
  ...
  x.useEffect(() => {
    if (!Xe)
      return;
    function ee(Me) {
      (Me.key === "Escape" || Me.key === "Esc") && Tn(Me);
    }
    return document.addEventListener("keydown", ee), () => {
      document.removeEventListener("keydown", ee);
    };
  }, [Tn, Xe]);
  const ns = Le(re.ref, Qa, lt, n);
  !ne && ne !== 0 && (Xe = !1);
  const or = x.useRef(), rs = (ee) => {
    const Me = re.props;
    Me.onMouseMove && Me.onMouseMove(ee), Zt = {
      x: ee.clientX,
      y: ee.clientY
    }, or.current && or.current.update();
  }, Wt = {}, ir = typeof ne == "string";
  C ? (Wt.title = !Xe && ir && !$ ? ne : null, Wt["aria-describedby"] = Xe ? nr : null) : (Wt["aria-label"] = ir ? ne : null, Wt["aria-labelledby"] = Xe && !ir ? nr : null);
  const De = k({}, Wt, N, re.props, {
    className: Ee(N.className, re.props.className),
    onTouchStart: mo,
    ref: ns
  }, Z ? {
    onMouseMove: rs
...
`));
  ...
  const qt = {};
  D || (De.onTouchStart = es, De.onTouchEnd = ts), $ || (De.onMouseOver = Nn(go, De.onMouseOver), De.onMouseLeave = Nn(bo, De.onMouseLeave), Ke || (qt.onMouseOver = go, qt.onMouseLeave = bo)), R || (De.onFocus = Nn(ho, De.onFocus), De.onBlur = Nn(fo, De.onBlur), Ke || (qt.onFocus = ho, qt.onBlur = fo)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const os = x.useMemo(() => {
    var ee;
    let Me = [{
    ...
    touch: $e.current
  }), ar = of(Gt), vo = (r = (o = Y.popper) != null ? o : B.Popper) != null ? r : af, yo = (i = (s = (l = Y.transition) != null ? l : B.Transition) != null ? s : _) != null ? i : Ir, wo = (c = (u = Y.tooltip) != null ? u : B.Tooltip) != null ? c : sf, xo = (p = (f = Y.arrow) != null ? f : B.Arrow) != null ? p : lf, is = tn(vo, k({}, W, (d = X.popper) != null ? d : F.popper, {
    className: Ee(ar.popper, W == null ? void 0 : W.className, (b = (v = X.popper) != null ? v : F.popper) == null ? void 0 : b.className)
  }), Gt), as = tn(yo, k({}, J, (g = X.transition) != null ? g : F.transition), Gt), ss = tn(wo, k({}, (h = X.tooltip) != null ? h : F.tooltip, {
    className: Ee(ar.tooltip, (T = (I = X.tooltip) != null ? I : F.tooltip) == null ? void 0 : T.className)
  }), Gt), ls = tn(xo, k({}, (y = X.arrow) != null ? y : F.arrow, {
    className: Ee(ar.arrow, (w = (m = X.arrow) != null ? m : F.arrow) == null ? void 0 : w.className)
  }), Gt);
  return /* @__PURE__ */ pe(x.Fragment, {
    children: [/* @__PURE__ */ x.cloneElement(re, De), /* @__PURE__ */ E(vo, k({
      as: G ?? Ma,
      placement: q,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ pe(wo, k({}, ss, {
          children: [ne, P ? /* @__PURE__ */ E(xo, k({}, ls, {
            ref: Ge
          })) : null]
        }))
      }))
...
const df = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], ff = (e) => {
  ...
  return /* @__PURE__ */ pe(hf, k({
    ...
    ownerState: g,
    children: [v ? o.props.children : o, f ? /* @__PURE__ */ E("title", {
      children: f
    }) : null]
  }));
});
...
var Da = oo.default = void 0, wf = yf(vf()), xf = cs;
Da = oo.default = (0, wf.default)(/* @__PURE__ */ (0, xf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function yi(e, t, n) {
  return e ? /* @__PURE__ */ E(Pi, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ E("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function ja(e) {
  const {
    onClick: t,
    ...
    Cs,
    {
      ...
      children: n ? /* @__PURE__ */ pe(Un, { children: [
        yi(i, n, !0),
        /* @__PURE__ */ E(Ps, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ E(Pi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ E(Da, {}) }) : yi(s, n, !1)
      ] }) : h
    }
  );
  return r ? /* @__PURE__ */ E(cf, { title: r, placement: "right", children: /* @__PURE__ */ E("div", { children: T }) }) : T;
}
function Ba(e) {
...
function Ef(e) {
  const [t, n] = xe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (u) => {
    ...
    let u = Ba(i).filter((p) => "menuItem" in p.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return u = u.filter(
      (p) => "menuItem" in p.group && p.group.menuItem === r.id
    ), /* @__PURE__ */ E(ao, { ...e, includedGroups: u });
  };
  return /* @__PURE__ */ pe(Un, { children: [
    /* @__PURE__ */ E(ja, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ E(
      Ns,
      {
        anchorEl: t,
...
function ao(e) {
  ...
  return /* @__PURE__ */ E("div", { role: "menu", "aria-label": u, children: i.map((p, f) => {
...
function kf(e) {
  ...
  )), /* @__PURE__ */ E(ao, { ...e, includedGroups: i });
}
function Of({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ pe(
    Ni,
    {
      ...
      children: [
        /* @__PURE__ */ E("h3", { "aria-label": r.label, className: `papi-menu-column-header ${i ?? ""}`, children: r.label }),
        /* @__PURE__ */ E(Rs, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ E(
          kf,
          {
            commandHandler: e,
            menuDefinition: t,
...
const za = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const g = (y) => {
    const w = b.current, m = y.key, S = Te(w).activeElement;
    if (m === "ArrowDown")
      y.preventDefault(), Qt(w, S, u, c, vr);
    else if (m === "ArrowUp")
      y.preventDefault(), Qt(w, S, u, c, wi);
    else if (m === "Home")
      y.preventDefault(), Qt(w, null, u, c, vr);
    else if (m === "End")
      y.preventDefault(), Qt(w, null, u, c, wi);
    else if (m.length === 1) {
      ...
      const F = S && !P.repeating && Va(S, P);
      P.previousKeyMatched && (F || Qt(w, S, !1, c, vr, P)) ? y.preventDefault() : P.previousKeyMatched = !1;
    }
    p && p(y);
  }, h = Le(b, n);
  let T = -1;
...
const Lf = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Ff = (e) => {
  ...
  return /* @__PURE__ */ E(h, k({
    ...
    children: /* @__PURE__ */ E(Vf, k({
      "aria-hidden": !0
    }, m, {
      as: (o = (i = g.root) != null ? i : p.Root) != null ? o : u,
      className: Ee(w.root, c, m == null ? void 0 : m.className),
...
const Hf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Wf = (e) => {
  ...
  const G = (r = (o = j == null ? void 0 : j.root) != null ? o : T.Root) != null ? r : qf, W = (i = (s = j == null ? void 0 : j.backdrop) != null ? s : T.Backdrop) != null ? i : p, X = (l = $ == null ? void 0 : $.root) != null ? l : I.root, Y = (c = $ == null ? void 0 : $.backdrop) != null ? c : I.backdrop, ne = bt({
    elementType: G,
    externalSlotProps: X,
  ...
  return !F && !R && (!K || U) ? null : /* @__PURE__ */ E(un, {
    ref: O,
    container: g,
    disablePortal: S,
    children: /* @__PURE__ */ pe(G, k({}, ne, {
      children: [!B && p ? /* @__PURE__ */ E(W, k({}, _)) : null, /* @__PURE__ */ E(Dn, {
        disableEnforceFocus: w,
        disableAutoFocus: y,
        disableRestoreFocus: P,
        isEnabled: A,
...
const oh = (e) => {
  ...
  const s = tt({
    ...
    const J = In(c), N = J && J.nodeType === 1 ? J : Te($.current).body, re = N.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const lt = Oe + N.height, Se = me + N.width, Ge = _t(In(c)), $e = Ge.innerHeight - h, Ke = Ge.innerWidth - h;
    if (h !== null && Oe < h) {
      const we = Oe - h;
    ...
    if (process.env.NODE_ENV !== "production" && N.height > $e && N.height && $e && console.error(["MUI: The popover component is too tall.", `Some part of it can not be seen on the screen (${N.height - $e}px).`, "Please consider adding a `max-height` to improve the user-experience."].join(`
`)), h !== null && me < h) {
      const we = me - h;
  ...
  }, [c, f, V, Q, h]), [O, A] = x.useState(T), U = x.useCallback(() => {
    const J = $.current;
    if (!J)
      return;
    const N = Z(J);
  ...
  const q = v || (c ? Te(In(c)).body : void 0), G = (o = y == null ? void 0 : y.root) != null ? o : ih, W = (i = y == null ? void 0 : y.paper) != null ? i : Ga, X = bt({
    elementType: W,
  ...
  return /* @__PURE__ */ E(G, k({}, _, !sa(G) && {
    slotProps: ne,
    disableScrollLock: B
  }, {
    children: /* @__PURE__ */ E(S, k({
      appear: !0,
      in: T,
      onEntering: K,
      onExited: z,
...
`)), Z.props.disabled || (T === "selectedMenu" && Z.props.selected || j === -1) && (j = O));
  ...
  return /* @__PURE__ */ E(fh, k({
    ...
    children: /* @__PURE__ */ E(mh, k({
      ...
      className: Ee(B.list, p.className),
      children: l
    }))
  }));
});
...
function Lh({
  ...
  var u;
  const [o, i] = $t.useState(void 0), s = Pe(
    (p) => {
      p.preventDefault(), i(
        o === void 0 ? {
          mouseX: p.clientX + 2,
...
function yh({
  ...
  const [T] = _r(
    ...
    Pe(async () => (e == null ? void 0 : e(!0)) ?? n ?? T, [e, n, T, c]),
    n ?? T
  ), y = p && I ? I : T;
  return /* @__PURE__ */ pe(Un, { children: [
    /* @__PURE__ */ E(
...
), Ya = x.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ E($i.Root, { ref: n, className: ye(wh(), e), ...t }));
Ya.displayName = $i.Root.displayName;
function zn({
  id: e,
  isDisabled: t = !1,
  hasError: n = !1,
  ...
  return /* @__PURE__ */ pe("div", { className: "pr-inline-grid pr-items-center pr-gap-1.5", children: [
    ...
    /* @__PURE__ */ E("p", { className: ye({ "pr-hidden": !r }), children: r })
  ] });
}
let yr;
...
function Vh({ scrRef: e, handleSubmit: t, id: n }) {
  ...
  return /* @__PURE__ */ pe("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    ...
    /* @__PURE__ */ E(
      ...
      {
        onClick: () => t(Oo(e, -1)),
        isDisabled: e.verseNum <= ds,
        children: "<"
      }
    ),
    /* @__PURE__ */ E(xt, { onClick: () => t(Oo(e, 1)), children: ">" })
  ] });
}
function zh({ onSearch: e, placeholder: t }) {
  const [n, r] = xe(""), o = (i) => {
    r(i), e(i);
  };
  return /* @__PURE__ */ E(Ms, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ E(
    zn,
    {
...
function ki({ onRowChange: e, row: t, column: n }) {
  ...
  return (
    ...
    // eslint-disable-next-line no-type-assertion/no-type-assertion
    /* @__PURE__ */ E(zn, { defaultValue: t[n.key], onChange: r })
  );
}
const xh = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ E(
  zi,
  {
    ...r,
    isChecked: n,
...
function Gh({
  ...
  const i = ft(void 0);
  return /* @__PURE__ */ E("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ E(Ds, { position: "static", id: r, children: /* @__PURE__ */ pe(js, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ E(
      yh,
      {
        commandHandler: t,
    ...
    o ? /* @__PURE__ */ E("div", { className: "papi-toolbar-children", children: o }) : void 0
  ] }) }) });
}
const Kh = (e, t) => {
  Lt(() => {
