...
import { getChaptersForBook as cl, deepEqual as to, substring as dl, formatScrRef as Tr, compareScrRefs as zr, scrRefToBBBCCCVVV as Cr, getLocalizeKeyForScrollGroupId as ue, NumberFormat as pl, formatBytes as ul } from "platform-bible-utils";
...
function Tm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = de(""), [o, a] = de(
    ...
    oe.bookNumberToId(e.bookNum)
  ), [p, h] = de(!1), [f, v] = de(p), g = gt(void 0), w = gt(void 0), m = gt(void 0), N = $e(
    (k) => tc(k).filter((j) => {
    ...
    const { key: j } = k;
    j === "ArrowRight" || j === "ArrowLeft" || j === "ArrowDown" || j === "ArrowUp" || j === "Enter" || (g.current.dispatchEvent(new KeyboardEvent("keydown", { key: j })), g.current.focus());
  }, _ = (k) => {
    const { key: j } = k;
    if (c === o) {
      if (j === "Enter") {
  ...
  return it(() => {
    ...
    /* @__PURE__ */ s(fi, { asChild: !0, children: /* @__PURE__ */ s(
      $l,
      {
        ...
        handleKeyDown: H,
        handleOnClick: () => {
          a(oe.bookNumberToId(e.bookNum)), d(oe.bookNumberToId(e.bookNum)), l(e.chapterNum > 0 ? e.chapterNum : 0), h(!0), g.current.focus();
        },
        onFocus: () => {
          C.current = !0;
        },
...
), Ge = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(Qa.Root, { ref: n, className: T("pr-twp", ic(), e), ...t }));
Ge.displayName = Qa.Root.displayName;
...
function ta({
  ...
  const [w, m] = de(!1);
  return /* @__PURE__ */ x(bi, { open: w, onOpenChange: m, ...g, children: [
...
function Sm({
  ...
  const p = Sr(d, "%webView_bookSelector_currentBook%"), h = Sr(d, "%webView_bookSelector_choose%"), f = Sr(d, "%webView_bookSelector_chooseBooks%"), [v, g] = de(
    "current book"
    /* CURRENT_BOOK */
  ), w = (m) => {
    g(m), e(m);
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Ge, { className: "tw-ml-1", children: p })
          ] }),
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Ge, { className: "tw-ml-1", children: f })
          ] }),
...
function Nc({
  ...
  var m;
  const [l, c] = de([]), [d, p] = de([]), [h, f] = de({}), [v, g] = de({}), w = ei({
    data: t,
    columns: e,
    getCoreRowModel: ti(),
    ...
    /* @__PURE__ */ x(rr, { stickyHeader: a, children: [
      ...
      /* @__PURE__ */ s(ar, { children: (m = w.getRowModel().rows) != null && m.length ? w.getRowModel().rows.map((N) => /* @__PURE__ */ s(
        at,
        {
          ...
          children: N.getVisibleCells().map(($) => /* @__PURE__ */ s(Lt, { children: cn($.column.columnDef.cell, $.getContext()) }, $.id))
        },
        N.id
      )) : /* @__PURE__ */ s(at, { children: /* @__PURE__ */ s(Lt, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
const ir = (e) => e === "asc" ? /* @__PURE__ */ s(qs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ s(Ks, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Om = (e) => ({
  ...
  return Ec(e).forEach((p) => {
    ...
    for (; h; ) {
      ...
      const v = h.index, g = a.find((m) => to(m.items, f)), w = {
        reference: {
          bookNum: i !== void 0 ? i : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: dl(p, Math.max(0, v - 25), Math.min(v + 25, p.length))
      };
      if (g)
        g.count += 1, g.occurrences.push(w);
      else {
        const m = {
          items: f,
          count: 1,
...
function $m({
  ...
  const h = Je(n, "%webView_inventory_all%"), f = Je(n, "%webView_inventory_approved%"), v = Je(n, "%webView_inventory_unapproved%"), g = Je(n, "%webView_inventory_unknown%"), w = Je(n, "%webView_inventory_scope_currentBook%"), m = Je(n, "%webView_inventory_scope_chapter%"), N = Je(n, "%webView_inventory_scope_verse%"), $ = Je(n, "%webView_inventory_filter_text%"), C = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = de(!1), [P, L] = de("all"), [H, S] = de(""), [_, k] = de([]), j = Te(() => l ? r instanceof RegExp ? Pc(
    l,
    e,
    a,
    i,
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Bt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(Nt, { children: [
              ...
              /* @__PURE__ */ s(Me, { value: "unapproved", children: v }),
              /* @__PURE__ */ s(Me, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
      ...
      o && /* @__PURE__ */ x("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ s(Ge, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? C })
      ] })
    ] }),
...
function Im({
  ...
  const [d, p] = de(!1), h = $e(
    (g) => {
      r(
        n.includes(g) ? n.filter((w) => w !== g) : [...n, g]
      );
    },
    [n, r]
  ), f = () => {
    var g;
    return n.length === 1 ? ((g = e.find((w) => w.value === n[0])) == null ? void 0 : g.label) ?? o : i || o;
  }, v = Te(() => {
    if (!l)
      return e;
    const g = e.filter((m) => m.starred).sort((m, N) => m.label.localeCompare(N.label)), w = e.filter((m) => !m.starred).sort((m, N) => {
  ...
  return /* @__PURE__ */ x(bi, { open: d, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ s(so, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(lo, { children: [
      ...
      /* @__PURE__ */ x(po, { children: [
        ...
        /* @__PURE__ */ s(xi, { children: v.map((g) => {
          const w = t ? t(g) : void 0;
          return /* @__PURE__ */ x(
            wo,
            {
              value: g.value,
              ...
              children: [
                ...
                /* @__PURE__ */ s("div", { className: "tw-w-4", children: g.starred && /* @__PURE__ */ s(Zs, { className: "tw-h-4 tw-w-4" }) }),
                /* @__PURE__ */ s("div", { className: "tw-flex-grow", children: g.label }),
...
function Dm({
  ...
  const [d, p] = de([]), [h, f] = de([{ id: rt, desc: !1 }]), [v, g] = de({}), w = Te(
  ...
  }, L = (S, _) => S.getIsGrouped() ? "" : T("banded-row", _ % 2 === 0 ? "even" : "odd"), H = (S, _, k) => {
...
function Uc() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = d, ie.ContextConsumer = l, ie.ContextProvider = i, ie.Element = t, ie.ForwardRef = p, ie.Fragment = r, ie.Lazy = g, ie.Memo = v, ie.Portal = n, ie.Profiler = a, ie.StrictMode = o, ie.Suspense = h, ie.isAsyncMode = function(b) {
    return E(b) || C(b) === c;
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === h || b === f || typeof b == "object" && b !== null && (b.$$typeof === g || b.$$typeof === v || b.$$typeof === i || b.$$typeof === l || b.$$typeof === p || b.$$typeof === m || b.$$typeof === N || b.$$typeof === $ || b.$$typeof === w);
  }, ie.typeOf = C, ie;
}
var se = {};
/** @license React v16.13.1
...
function Gc() {
  return aa || (aa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(I) {
      ...
      I === r || I === d || I === a || I === o || I === h || I === f || typeof I == "object" && I !== null && (I.$$typeof === g || I.$$typeof === v || I.$$typeof === i || I.$$typeof === l || I.$$typeof === p || I.$$typeof === m || I.$$typeof === N || I.$$typeof === $ || I.$$typeof === w);
    }
    function E(I) {
    ...
    var b = c, P = d, L = l, H = i, S = t, _ = p, k = r, j = g, D = v, J = n, q = a, U = o, ee = h, ae = !1;
    function re(I) {
    ...
    se.AsyncMode = b, se.ConcurrentMode = P, se.ContextConsumer = L, se.ContextProvider = H, se.Element = S, se.ForwardRef = _, se.Fragment = k, se.Lazy = j, se.Memo = D, se.Portal = J, se.Profiler = q, se.StrictMode = U, se.Suspense = ee, se.isAsyncMode = re, se.isConcurrentMode = y, se.isContextConsumer = O, se.isContextProvider = z, se.isElement = F, se.isForwardRef = V, se.isFragment = W, se.isLazy = X, se.isMemo = Y, se.isPortal = G, se.isProfiler = K, se.isStrictMode = Z, se.isSuspense = pe, se.isValidElementType = C, se.typeOf = E;
  }()), se;
}
var ia;
function Ai() {
...
function Yc() {
  ...
  return Dr = function(l, c) {
    ...
    function C(y) {
      function O(z, F, V, W, X) {
        if (typeof y != "function")
          return new w("Property `" + X + "` of component `" + V + "` has invalid PropType notation inside arrayOf.");
        var Y = z[F];
        if (!Array.isArray(Y)) {
          var G = U(Y);
          return new w("Invalid " + W + " `" + X + "` of type " + ("`" + G + "` supplied to `" + V + "`, expected an array."));
        }
    ...
    function E() {
      function y(O, z, F, V, W) {
        var X = O[z];
        if (!l(X)) {
          var Y = U(X);
          return new w("Invalid " + V + " `" + W + "` of type " + ("`" + Y + "` supplied to `" + F + "`, expected a single ReactElement."));
        }
        return null;
      }
      return m(y);
    ...
    function b() {
      function y(O, z, F, V, W) {
        ...
        if (!e.isValidElementType(X)) {
          var Y = U(X);
          return new w("Invalid " + V + " `" + W + "` of type " + ("`" + Y + "` supplied to `" + F + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return m(y);
    ...
    function P(y) {
      function O(z, F, V, W, X) {
        if (!(z[F] instanceof y)) {
          var Y = y.name || f, G = re(z[F]);
          return new w("Invalid " + W + " `" + X + "` of type " + ("`" + G + "` supplied to `" + V + "`, expected ") + ("instance of `" + Y + "`."));
        }
        return null;
      }
      return m(O);
    ...
    function L(y) {
      ...
      function O(z, F, V, W, X) {
        ...
        return new w("Invalid " + W + " `" + X + "` of value `" + String(Y) + "` " + ("supplied to `" + V + "`, expected one of " + K + "."));
      }
      return m(O);
    }
    function H(y) {
      function O(z, F, V, W, X) {
        if (typeof y != "function")
          return new w("Property `" + X + "` of component `" + V + "` has invalid PropType notation inside objectOf.");
        var Y = z[F], G = U(Y);
        if (G !== "object")
          return new w("Invalid " + W + " `" + X + "` of type " + ("`" + G + "` supplied to `" + V + "`, expected an object."));
        for (var K in Y)
          if (r(Y, K)) {
            var Z = y(Y, K, V, W, X + "." + K, n);
            if (Z instanceof Error)
    ...
    function S(y) {
      ...
      for (var O = 0; O < y.length; O++) {
        ...
        if (typeof z != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ae(z) + " at index " + O + "."
          ), i;
      }
      function F(V, W, X, Y, G) {
        for (var K = [], Z = 0; Z < y.length; Z++) {
          var pe = y[Z], I = pe(V, W, X, Y, G, n);
          if (I == null)
            return null;
    ...
    function _() {
      function y(O, z, F, V, W) {
        return J(O[z]) ? null : new w("Invalid " + V + " `" + W + "` supplied to " + ("`" + F + "`, expected a ReactNode."));
      }
      return m(y);
    }
    function k(y, O, z, F, V) {
      return new w(
        (y || "React class") + ": " + O + " type `" + z + "." + F + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + V + "`."
      );
    }
    function j(y) {
      function O(z, F, V, W, X) {
        var Y = z[F], G = U(Y);
        if (G !== "object")
          return new w("Invalid " + W + " `" + X + "` of type `" + G + "` " + ("supplied to `" + V + "`, expected `object`."));
        for (var K in y) {
          var Z = y[K];
          if (typeof Z != "function")
            return k(V, W, X, K, ee(Z));
          var pe = Z(Y, K, V, W, X + "." + K, n);
          if (pe)
            return pe;
        }
        return null;
...
function td() {
  ...
  return le.ContextConsumer = i, le.ContextProvider = a, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = f, le.Memo = h, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = d, le.SuspenseList = p, le.isAsyncMode = function() {
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === d || m === p || m === v || typeof m == "object" && m !== null && (m.$$typeof === f || m.$$typeof === h || m.$$typeof === a || m.$$typeof === i || m.$$typeof === c || m.$$typeof === g || m.getModuleId !== void 0);
  }, le.typeOf = w, le;
}
var ce = {};
/**
...
function nd() {
  return fa || (fa = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), v = Symbol.for("react.offscreen"), g = !1, w = !1, m = !1, N = !1, $ = !1, C;
    C = Symbol.for("react.module.reference");
    function E(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === n || B === o || $ || B === r || B === d || B === p || N || B === v || g || w || m || typeof B == "object" && B !== null && (B.$$typeof === f || B.$$typeof === h || B.$$typeof === a || B.$$typeof === i || B.$$typeof === c || // This needs to include all possible module reference object
    ...
    var P = i, L = a, H = e, S = c, _ = n, k = f, j = h, D = t, J = o, q = r, U = d, ee = p, ae = !1, re = !1;
    function y(B) {
    ...
    ce.ContextConsumer = P, ce.ContextProvider = L, ce.Element = H, ce.ForwardRef = S, ce.Fragment = _, ce.Lazy = k, ce.Memo = j, ce.Portal = D, ce.Profiler = J, ce.StrictMode = q, ce.Suspense = U, ce.SuspenseList = ee, ce.isAsyncMode = y, ce.isConcurrentMode = O, ce.isContextConsumer = z, ce.isContextProvider = F, ce.isElement = V, ce.isForwardRef = W, ce.isFragment = X, ce.isLazy = Y, ce.isMemo = G, ce.isPortal = K, ce.isProfiler = Z, ce.isStrictMode = pe, ce.isSuspense = I, ce.isSuspenseList = xe, ce.isValidElementType = E, ce.typeOf = b;
  }()), ce;
}
...
function _d(e) {
  ...
  function d(f, v) {
    const g = i.indexOf(v);
    return `@media (min-width:${typeof t[f] == "number" ? t[f] : f}${n}) and (max-width:${(g !== -1 && typeof t[i[g]] == "number" ? t[i[g]] : v) - r / 100}${n})`;
  }
  function p(f) {
  ...
  function h(f) {
    const v = i.indexOf(f);
    return v === 0 ? l(i[1]) : v === i.length - 1 ? c(i[v]) : d(f, i[i.indexOf(f) + 1]).replace("@media", "@media not all and");
  }
  return R({
    keys: i,
    values: a,
...
const Hd = ze("border", je), Xd = ze("borderTop", je), Yd = ze("borderRight", je), Wd = ze("borderBottom", je), qd = ze("borderLeft", je), Kd = ze("borderColor"), Jd = ze("borderTopColor"), Zd = ze("borderRightColor"), Qd = ze("borderBottomColor"), ep = ze("borderLeftColor"), tp = ze("outline", je), np = ze("outlineColor"), wr = (e) => {
...
function Ep() {
  function e(n, r, o, a) {
    ...
    const f = cr(o, d) || {};
    return h ? h(i) : Qe(i, r, (g) => {
      let w = Wn(f, p, g);
      return g === w && typeof g == "string" && (w = Wn(f, p, `${n}${g === "default" ? "" : We(g)}`, g)), c === !1 ? w : {
        [c]: w
      };
    });
  }
...
function Mp(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    yl(i, (b) => b.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const $ = bl(i, R({
      shouldForwardProp: N,
      label: m
    }, v)), C = (b) => typeof b == "function" && b.__emotion_real !== b || ht(b) ? (P) => Gn(b, R({}, P, {
      theme: Bn({
        theme: P.theme,
        defaultTheme: n,
        themeId: t
...
function Ea(e) {
  e = Et(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Et(Lp(e)).values : e.values;
...
} });` : zt(12, m ? ` (${m})` : "", JSON.stringify(w.main)));
    return Sa(w, "light", $, r), Sa(w, "dark", C, r), w.contrastText || (w.contrastText = h(w.main)), w;
  }, v = {
    dark: Br,
    light: Ca
  };
  return process.env.NODE_ENV !== "production" && (v[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), Ze(R({
...
function cu(e, t) {
  ...
  const v = o / 14, g = h || ((N) => `${N / d * v}rem`), w = (N, $, C, E, b) => R({
    fontFamily: r,
    fontWeight: N,
    fontSize: g($),
...
function ku(e = {}, ...t) {
  ...
  if (d = Ze(d, i), d = t.reduce((p, h) => Ze(p, h), d), process.env.NODE_ENV !== "production") {
    const p = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], h = (f, v) => {
      ...
      for (g in f) {
        const w = f[g];
        if (p.indexOf(g) !== -1 && Object.keys(w).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const m = lr("", g);
            console.error([`MUI: The \`${v}\` component increases the CSS specificity of the \`${g}\` internal state.`, "You can not override it like this: ", JSON.stringify(f, null, 2), "", `Instead, you need to use the '&.${m}' syntax:`, JSON.stringify({
              root: {
                [`&.${m}`]: w
              }
...
`));
    ...
    Object.keys(d.components).forEach((f) => {
      const v = d.components[f].styleOverrides;
...
const Ou = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ru = (e) => {
  ...
  const r = So({
    ...
    titleAccess: h,
    viewBox: f = "0 0 24 24"
  } = r, v = Ne(r, Ou), g = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", w = R({}, r, {
    color: i,
    component: l,
    fontSize: c,
  ...
  return /* @__PURE__ */ x(Pu, R({
    ...
    ownerState: w,
    children: [g ? o.props.children : o, h ? /* @__PURE__ */ s("title", {
      children: h
    }) : null]
  }));
});
...
function Gu(e) {
  ...
  if (!t) {
    const v = bt(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), g = R({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = R({}, n, o, r);
    return v.length > 0 && (w.className = v), Object.keys(g).length > 0 && (w.style = g), {
      props: w,
      internalRef: void 0
    };
  }
  const i = Fu(R({}, o, r)), l = Ia(r), c = Ia(o), d = t(i), p = bt(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = R({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = R({}, d, n, c, l);
...
var Ce = "top", Ve = "bottom", Le = "right", Se = "left", Ro = "auto", Rn = [Ce, Ve, Le, Se], Ut = "start", vn = "end", Ju = "clippingParents", os = "viewport", nn = "popper", Zu = "reference", Aa = /* @__PURE__ */ Rn.reduce(function(e, t) {
...
function Ht(e, t, n) {
  ...
  t && Be(e) && (o = e.offsetWidth > 0 && Gt(r.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && Gt(r.height) / e.offsetHeight || 1);
...
function hw(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Xe(n.placement), c = $o(l), d = [Se, Le].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var h = mw(o.padding, n), f = _o(a), v = c === "y" ? Ce : Se, g = c === "y" ? Ve : Le, w = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], m = i[c] - n.rects.reference[c], N = Pn(a), $ = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, C = w / 2 - m / 2, E = h[v], b = $ - f[p] - h[g], P = $ / 2 - f[p] / 2 + C, L = un(E, P, b), H = c;
    n.modifiersData[r] = (t = {}, t[H] = L, t.centerOffset = L - P, t);
  }
}
function gw(e) {
...
function Ma(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, i = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, p = e.roundOffsets, h = e.isFixed, f = i.x, v = f === void 0 ? 0 : f, g = i.y, w = g === void 0 ? 0 : g, m = typeof p == "function" ? p({
    x: v,
    y: w
  }) : {
    x: v,
  ...
  v = m.x, w = m.y;
  var N = i.hasOwnProperty("x"), $ = i.hasOwnProperty("y"), C = Se, E = Ce, b = window;
  if (d) {
    var P = Pn(n), L = "clientHeight", H = "clientWidth";
    if (P === Ae(n) && (P = lt(n), et(P).position !== "static" && l === "absolute" && (L = "scrollHeight", H = "scrollWidth")), P = P, o === Ce || (o === Se || o === Le) && a === vn) {
      E = Ve;
      var S = h && P === b && b.visualViewport ? b.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        P[L]
      );
    ...
    if (o === Se || (o === Ce || o === Ve) && a === vn) {
      C = Le;
      var _ = h && P === b && b.visualViewport ? b.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        P[H]
      );
      v -= _ - r.width, v *= c ? 1 : -1;
  ...
  if (v = j.x, w = j.y, c) {
    var D;
    return Object.assign({}, k, (D = {}, D[E] = $ ? "0" : "", D[C] = N ? "0" : "", D.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + v + "px, " + w + "px)" : "translate3d(" + v + "px, " + w + "px, 0)", D));
  }
  return Object.assign({}, k, (t = {}, t[E] = $ ? w + "px" : "", t[C] = N ? v + "px" : "", t.transform = "", t));
}
function xw(e) {
...
function Pw(e) {
  var t = wn(br(e)), n = ["absolute", "fixed"].indexOf(et(e).position) >= 0, r = n && Be(e) ? Pn(e) : e;
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Ju : l, d = n.rootBoundary, p = d === void 0 ? os : d, h = n.elementContext, f = h === void 0 ? nn : h, v = n.altBoundary, g = v === void 0 ? !1 : v, w = n.padding, m = w === void 0 ? 0 : w, N = cs(typeof m != "number" ? m : ds(m, Rn)), $ = f === nn ? Zu : nn, C = e.rects.popper, E = e.elements[g ? $ : f], b = _w(Tt(E) ? E : E.contextElement || lt(e.elements.popper), c, p, i), P = Ht(e.elements.reference), L = us({
    reference: P,
    element: C,
    strategy: "absolute",
    placement: o
  }), H = Kr(Object.assign({}, C, L)), S = f === nn ? H : P, _ = {
    top: b.top - S.top + N.top,
    bottom: S.bottom - b.bottom + N.bottom,
    left: b.left - S.left + N.left,
    right: S.right - b.right + N.right
...
function $w(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? as : c, p = Xt(r), h = p ? l ? Aa : Aa.filter(function(g) {
    return Xt(g) === p;
  }) : Rn, f = h.filter(function(g) {
    return d.indexOf(g) >= 0;
  });
  f.length === 0 && (f = h);
  var v = f.reduce(function(g, w) {
    return g[w] = yn(e, {
      placement: w,
      boundary: o,
      rootBoundary: a,
  ...
  return Object.keys(v).sort(function(g, w) {
    return v[g] - v[w];
  });
}
function Iw(e) {
...
function Aw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, f = n.altBoundary, v = n.flipVariations, g = v === void 0 ? !0 : v, w = n.allowedAutoPlacements, m = t.options.placement, N = Xe(m), $ = N === m, C = c || ($ || !g ? [Hn(m)] : Iw(m)), E = [m].concat(C).reduce(function(V, W) {
    ...
    }, []), b = t.rects.reference, P = t.rects.popper, L = /* @__PURE__ */ new Map(), H = !0, S = E[0], _ = 0; _ < E.length; _++) {
      var k = E[_], j = Xe(k), D = Xt(k) === Ut, J = [Ce, Ve].indexOf(j) >= 0, q = J ? "width" : "height", U = yn(t, {
        placement: k,
        boundary: p,
        rootBoundary: h,
        altBoundary: f,
      ...
      b[q] > P[q] && (ee = Hn(ee));
      var ae = Hn(ee), re = [];
      if (a && re.push(U[j] <= 0), l && re.push(U[ee] <= 0, U[ae] <= 0), re.every(function(V) {
        return V;
      })) {
        S = k, H = !1;
        break;
...
function Gw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, f = n.tether, v = f === void 0 ? !0 : f, g = n.tetherOffset, w = g === void 0 ? 0 : g, m = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: p
  }), N = Xe(t.placement), $ = Xt(t.placement), C = !$, E = $o(N), b = Uw(E), P = t.modifiersData.popperOffsets, L = t.rects.reference, H = t.rects.popper, S = typeof w == "function" ? w(Object.assign({}, t.rects, {
    placement: t.placement
  })) : w, _ = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
  ...
  if (P) {
    if (a) {
      var D, J = E === "y" ? Ce : Se, q = E === "y" ? Ve : Le, U = E === "y" ? "height" : "width", ee = P[E], ae = ee + m[J], re = ee - m[q], y = v ? -H[U] / 2 : 0, O = $ === Ut ? L[U] : H[U], z = $ === Ut ? -H[U] : -L[U], F = t.elements.arrow, V = v && F ? _o(F) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ls(), X = W[J], Y = W[q], G = un(0, L[U], V[U]), K = C ? L[U] / 2 - y - G - X - _.mainAxis : O - G - X - _.mainAxis, Z = C ? -L[U] / 2 + y + G + Y + _.mainAxis : z + G + Y + _.mainAxis, pe = t.elements.arrow && Pn(t.elements.arrow), I = pe ? E === "y" ? pe.clientTop || 0 : pe.clientLeft || 0 : 0, xe = (D = k == null ? void 0 : k[E]) != null ? D : 0, B = ee + K - xe - I, ye = ee + Z - xe, Fe = un(v ? Kn(ae, B) : ae, ee, v ? vt(re, ye) : re);
      P[E] = Fe, j[E] = Fe - ee;
    }
    if (l) {
      var ct, ke = E === "x" ? Ce : Se, $n = E === "x" ? Ve : Le, Ue = P[b], Ct = b === "y" ? "height" : "width", dt = Ue + m[ke], St = Ue - m[$n], Ot = [Ce, Se].indexOf(N) !== -1, Rt = (ct = k == null ? void 0 : k[b]) != null ? ct : 0, pt = Ot ? dt : Ue - L[Ct] - H[Ct] - Rt + _.altAxis, Wt = Ot ? Ue + L[Ct] + H[Ct] - Rt - _.altAxis : St, In = v && Ot ? fw(pt, Ue, Wt) : un(v ? pt : dt, Ue, v ? Wt : St);
      P[b] = In, j[b] = In - Ue;
    }
    t.modifiersData[r] = j;
  }
...
function qw(e, t, n) {
  n === void 0 && (n = !1);
  var r = Be(t), o = Be(t) && Ww(t), a = lt(t), i = Ht(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Do(a)) && (l = Yw(t)), Be(t) ? (c = Ht(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Ao(a))), {
        ...
        if (!f) {
          ...
          if (Fa($, C)) {
            ...
            for (var E = 0; E < p.orderedModifiers.length; E++) {
              ...
              var b = p.orderedModifiers[E], P = b.fn, L = b.options, H = L === void 0 ? {} : L, S = b.name;
...
var tf = [Ew, Fw, Nw, pw, Lw, Dw, Hw, bw, jw], nf = /* @__PURE__ */ ef({
  defaultModifiers: tf
});
const ws = "Popper";
function rf(e) {
...
const cf = () => bo({
  ...
  } = t, m = Ne(t, of), N = M.useRef(null), $ = kt(N, n), C = M.useRef(null), E = kt(C, f), b = M.useRef(E);
  Ft(() => {
    b.current = E;
  }, [E]), M.useImperativeHandle(f, () => C.current, []);
  const P = sf(p, i), [L, H] = M.useState(P), [S, _] = M.useState(Jn(o));
  M.useEffect(() => {
...
`));
  ...
  const j = cf(), D = (r = g.root) != null ? r : "div", J = Xu({
    elementType: D,
  ...
  if (a)
    ...
    const _ = Jn(r);
    L = _ && vr(_) ? Xn(_).body : Xn(null).body;
  }
...
const bf = {
  ...
  } = t, N = Ne(t, gf), $ = an(), C = M.useRef(), E = ms(), b = M.useRef(null), P = kt(b, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = b.current;
  ...
  return /* @__PURE__ */ s(m, R({
    ...
    onExiting: k,
    addEndListener: (q) => {
      w === "auto" && $.start(C.current || 0, q), r && r(b.current, q);
    },
...
const Ha = Mo, vf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], yf = On(fs, {
  ...
  const o = Ji(), a = So({
    ...
    slots: C,
    slotProps: E
  } = a, b = Ne(a, vf), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, L = R({
    anchorEl: i,
    container: p,
    disablePortal: h,
    keepMounted: f,
...
const vs = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, i, l, c, d, p, h, f, v, g, w, m, N, $, C, E, b;
  const P = So({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: xe
  } = P, B = Ne(P, kf), ye = /* @__PURE__ */ M.isValidElement(H) ? H : /* @__PURE__ */ s("span", {
    children: H
  }), Fe = ms(), ct = Fe.direction === "rtl", [ke, $n] = M.useState(), [Ue, Ct] = M.useState(null), dt = M.useRef(!1), St = J || re, Ot = an(), Rt = an(), pt = an(), Wt = an(), [In, jo] = Fi({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Bo = (Q) => {
    ...
    (Q) => {
      Xa.start(800 + O, () => {
        Ln = !1;
      }), jo(!1), F && Ke && F(Q), Ot.start(Fe.transitions.duration.shortest, () => {
        dt.current = !1;
      });
    }
  ), xr = (Q) => {
    dt.current && Q.type !== "touchstart" || (ke && ke.removeAttribute("title"), Rt.clear(), pt.clear(), U || Ln && ee ? Rt.start(Ln ? ee : U, () => {
      Bo(Q);
    }) : Bo(Q));
  }, Vo = (Q) => {
    Rt.clear(), pt.start(O, () => {
  ...
  const De = R({}, Kt, B, ye.props, {
    className: bt(B.className, ye.props.className),
    onTouchStart: Go,
    ref: Os
  }, re ? {
    onMouseMove: Rs
...
`));
  ...
  const Jt = {};
  q || (De.onTouchStart = Cs, De.onTouchEnd = Ss), D || (De.onMouseOver = zn(Ho, De.onMouseOver), De.onMouseLeave = zn(Xo, De.onMouseLeave), St || (Jt.onMouseOver = Ho, Jt.onMouseLeave = Xo)), j || (De.onFocus = zn(Uo, De.onFocus), De.onBlur = zn(Fo, De.onBlur), St || (Jt.onFocus = Uo, Jt.onBlur = Fo)), process.env.NODE_ENV !== "production" && ye.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ye.props.title}\` or the Tooltip component.`].join(`
`));
  const Ps = M.useMemo(() => {
    var Q;
    let Pe = [{
    ...
    className: bt(Er.popper, G == null ? void 0 : G.className, (v = (g = K.popper) != null ? g : _.popper) == null ? void 0 : v.className)
    ...
    className: bt(Er.arrow, (E = (b = K.arrow) != null ? b : _.arrow) == null ? void 0 : E.className)
  }), Zt);
    ...
    children: [/* @__PURE__ */ M.cloneElement(ye, De), /* @__PURE__ */ s(Yo, R({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(qo, R({}, Is, {
          children: [pe, L ? /* @__PURE__ */ s(Ko, R({}, As, {
            ref: Ct
          })) : null]
        }))
      }))
...
function Ns(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: a, allowForLeadingIcons: i } = Te(() => {
    const p = o && o.length > 0 ? o : (
      ...
      xs(t).filter((g) => !("menuItem" in g.group))
    ), h = Object.values(p).sort(
      (g, w) => (g.group.order || 0) - (w.group.order || 0)
    ), f = [];
    h.forEach((g) => {
      _f(g.id, t.items).forEach(
    ...
    return { items: f, allowForLeadingIcons: v };
...
function jf({
  ...
  it(() => {
    if (c) {
      ...
      if (E) {
        const b = E.getBoundingClientRect(), P = window.scrollY, L = window.scrollX, H = b.top + P + E.clientHeight, S = b.left + L;
        m({ top: H, left: S });
      }
    }
  }, [c, o]);
...
function nm({ id: e, versionHistory: t }) {
  ...
  function a(l) {
    ...
    let v = "";
    return p > 0 ? v = `${p.toString()} year${p === 1 ? "" : "s"} ago` : h > 0 ? v = `${h.toString()} month${h === 1 ? "" : "s"} ago` : f === 0 ? v = "today" : v = `${f.toString()} day${f === 1 ? "" : "s"} ago`, v;
  }
...
function nh({
  ...
  ), [c, d] = de(t), [p, h] = de(!1), f = (g) => {
    d(g), o && o(g), r && r([g, ...n.filter((w) => w !== g)]), a && n.find((w) => w == g) && a([...n.filter((w) => w !== g)]), h(!1);
  }, v = (g, w) => {
    var N, $, C, E, b, P;
    const m = w !== g ? (($ = (N = e[g]) == null ? void 0 : N.uiNames) == null ? void 0 : $[w]) ?? ((E = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
    return m ? `${(b = e[g]) == null ? void 0 : b.autonym} (${m})` : (P = e[g]) == null ? void 0 : P.autonym;
  };
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-max-w-sm tw-p-4", children: [
    /* @__PURE__ */ x(
      Bt,
      {
        name: "uiLanguage",
        ...
        children: [
          ...
          /* @__PURE__ */ s(Nt, { children: Object.keys(e).map((g) => /* @__PURE__ */ s(Me, { value: g, children: v(g, t) }, g)) })
        ]
      }
    ),
    c !== "en" && /* @__PURE__ */ x(tt, { children: [
      /* @__PURE__ */ s(Ge, { className: "tw-ml-3", children: l }),
      n.map((g) => v(g, t))
    ] })
  ] });
}
