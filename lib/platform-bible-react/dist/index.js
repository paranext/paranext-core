...
function Wt({
  ...
  return /* @__PURE__ */ o(
    ke.Item,
    {
      ref: e,
      className: m(
        "tw:relative tw:flex tw:cursor-default tw:select-none tw:items-center tw:rounded-sm tw:px-2 tw:py-1.5 tw:text-sm tw:outline-none tw:data-[disabled=true]:pointer-events-none tw:data-[selected=true]:bg-accent tw:data-[selected=true]:text-accent-foreground tw:data-[disabled=true]:opacity-50",
        t
      ),
      ...r
    }
...
function Ed({
  ...
  const w = wt(), [d, h] = S(!1), [f, u] = S(""), [g, v] = S(""), [b, x] = S("books"), [y, k] = S(void 0), [_, L] = S(!1), j = U(void 0), I = U(void 0), D = U(void 0), C = U(void 0), T = U({}), V = B(
    (R) => {
      e(R), l && l(R);
    },
    [e, l]
  ...
  return Rt(() => {
    const R = setTimeout(() => {
      if (d && b === "books" && D.current && C.current) {
        const N = D.current, P = C.current, q = P.offsetTop, G = N.clientHeight, nt = P.clientHeight, tt = q - G / 2 + nt / 2;
        N.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), u(Yr(t.book));
...
function kc({
  ...
  const [I, D] = S(rn), [C, T] = S(
    void 0
  ), V = n, [$, O] = S(!1), [A, Y] = S(!1), [M, J] = S(!1), [Ct, Dt] = S(!1), [St, pt] = S(!1), [lt, K] = S(_), [rt, ot] = S(!1), it = U(void 0), [bt, Kt] = S(/* @__PURE__ */ new Map());
  H(() => {
    let E = !0;
    return (async () => {
  ...
  const qt = z(() => Pt[0], [Pt]), _e = U(null), Zt = U(void 0), Gt = B(() => {
    var E;
...
function Uc({
  ...
  return /* @__PURE__ */ p(se, { children: [
    /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(Nt, { children: [
      ...
      /* @__PURE__ */ o(_t, { children: /* @__PURE__ */ o("p", { children: Gc(t, r) }) })
    ] }) }),
...
function Xd({
  ...
  const [g, v] = S("generated"), [b, x] = S("*"), [y, k] = S("f"), [_, L] = S(!1), [j, I] = S(!0), [D, C] = S(!1), T = U(!1), V = U(""), [$, O] = S(!1), [A, Y] = S(), [M, J] = S(), [Ct, Dt] = S(), [St, pt] = S(), lt = U(null), K = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (P && or("note", P)) {
      ...
      let tt = "custom";
      nt === Ur ? tt = "generated" : nt === Hr ? tt = "hidden" : nt && x(nt), v(tt), k(((G = P.insert.note) == null ? void 0 : G.style) ?? "f"), N = setTimeout(() => {
        var mt;
  ...
  const ot = B(
    (N, P, q = !1) => {
      ...
      if (G && or("note", G)) {
        if (G.insert.note) {
          let st;
          N === "custom" ? st = P : N === "generated" ? st = Ur : st = Hr, G.insert.note.caller = st;
        }
  ...
  return H(() => {
    ...
    var q;
    const N = ((q = h.current) == null ? void 0 : q.querySelector(".editor-input")) ?? void 0, P = (G) => {
      !$ && N && document.activeElement === N && G.key === l ? (G.preventDefault(), R()) : $ && G.key === "Escape" && (G.preventDefault(), O(!1));
    };
...
function Rw({
  ...
  }, [b, x] = S(!1), [y, k] = S(""), _ = U(void 0), L = U(!1);
  ...
  return /* @__PURE__ */ p(
    nr.Root,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o(nr.Thumb, { className: "tw:block tw:h-5 tw:w-5 tw:rounded-full tw:border-2 tw:border-primary tw:bg-background tw:ring-offset-background tw:transition-colors tw:focus-visible:outline-none tw:focus-visible:ring-2 tw:focus-visible:ring-ring tw:focus-visible:ring-offset-2 tw:disabled:pointer-events-none tw:disabled:opacity-50" })
      ]
    }
  );
}
...
function yu({
  ...
  return /* @__PURE__ */ o(
    ...
    {
      className: m(
        "pr-twp tw:flex tw:min-h-[80px] tw:w-full tw:rounded-md tw:border tw:border-input tw:bg-background tw:px-3 tw:py-2 tw:text-base tw:ring-offset-background tw:placeholder:text-muted-foreground tw:focus-visible:outline-none tw:focus-visible:ring-2 tw:focus-visible:ring-ring tw:focus-visible:ring-offset-2 tw:disabled:cursor-not-allowed tw:disabled:opacity-50 tw:md:text-sm",
        t
      ),
      ref: e,
      ...r
