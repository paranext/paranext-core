...
import { c as b, g as $e, a as Vr, C as er, L as Hn, u as tn, T as Vt, b as bt, d as xt, e as yt, A as xa, D as je, f as Te, h as Fe, i as cr, j as We, B as et, x as ks, k as _s, l as Ns, I as Cs, m as To, n as Ze, r as De, o as Es, p as qn, P as lr, q as Dr, s as dr, t as wr, v as Ma, w as Oa, y as So, z as ur, E as Ia, F as $t, R as Ro, G as ya, H as so, J as co, K as lo, M as wo, N as Gn, O as wa, Q as Do, S as Fr, U as Ur, V as yr, W as Ts, X as ir, Y as Je, Z as Ue, _ as Ye, $ as kr, a0 as Mo, a1 as Oo, a2 as ka, a3 as Io, a4 as Wn, a5 as Ss, a6 as Rs, a7 as Ds, a8 as uo, a9 as Yn, aa as za, ab as Ms, ac as Xn, ad as Os, ae as Is, af as zs, ag as en, ah as Ps, ai as As, aj as $s, ak as Jn, al as Zn, am as zo, an as Vs, ao as Qn, ap as Ha, aq as rn, ar as qa, as as Ls, at as Bs, au as js, av as Fs, aw as Us, ax as Ks, ay as Gr, az as Po, aA as Hs, aB as qs } from "./resizable-D8feGGuN.js";
import { aC as gf, aD as ff, aE as mf, aF as vf, aG as bf, aH as xf, aI as yf, aJ as kf, aK as _f, aL as Nf, aM as Cf, aN as Ef, aO as Tf, aP as Sf, aQ as Rf, aR as Df, aS as Mf, aT as Of, aU as If, aV as zf, aW as Pf, aX as Af, aY as $f, aZ as Vf, a_ as Lf, a$ as Bf, b0 as jf, b1 as Ff, b2 as Uf, b3 as Kf, b4 as Hf, b5 as qf, b6 as Gf, b7 as Wf, b8 as Yf, b9 as Xf, ba as Jf } from "./resizable-D8feGGuN.js";
import { jsx as a, jsxs as u, Fragment as gt } from "react/jsx-runtime";
import { Canon as Kt } from "@sillsdev/scripture";
import { Check as Qe, Clock as an, ChevronsLeft as on, ChevronsRight as nn, ChevronUp as ti, ChevronDown as sr, ArrowLeft as Gs, ArrowRight as Ws, BoldIcon as Ys, ItalicIcon as Xs, X as ei, AtSign as ri, Pencil as Js, Trash2 as Zs, Undo2 as Qs, ArrowUp as ai, MoreHorizontal as tc, MailOpen as ec, Mail as rc, FilterIcon as ac, ArrowLeftIcon as oc, ChevronLeftIcon as nc, ChevronRightIcon as ic, ArrowRightIcon as sc, Copy as oi, Filter as cc, User as lc, Link as dc, CircleHelp as wc, Undo as uc, Redo as pc, SquareX as ni, FunctionSquare as ii, SquareSigma as si, Ban as hc, AlertCircle as po, CircleCheckIcon as gc, CircleXIcon as fc, CircleHelpIcon as mc, ArrowUpIcon as vc, ArrowDownIcon as bc, ScrollText as xc, ChevronRight as yc, ChevronLeft as kc, ChevronsUpDown as _c, MenuIcon as Nc, Menu as Cc, EllipsisVertical as Ec, MoreVertical as Tc } from "lucide-react";
import { Section as At, compareScrRefs as _a, getChaptersForBook as Sc, formatScrRef as Ve, formatReplacementString as Xe, getSectionForBook as ua, formatRelativeDate as Rc, sanitizeHtml as Ao, NumberFormat as ci, formatBytes as Dc, getCurrentLocale as Mc, usfmMarkers as pa, isPlatformError as Oc, ABORTED as Ic, getErrorMessage as zc, getFormatCallerFunction as Pc, deepEqual as Ac, isString as sn, scrRefToBBBCCCVVV as Ga, defaultScrRef as Wa, formatScrRefRange as $c, getLocalizeKeyForScrollGroupId as cn, formatReplacementStringToArray as ln, collectUsjMarkers as Vc } from "platform-bible-utils";
import ee, { useRef as L, useMemo as P, createContext as Wr, useContext as Pa, useState as _, useEffect as Z, useCallback as V, useId as Na, useImperativeHandle as Lc, useLayoutEffect as re, Fragment as Yr, Component as Bc, createElement as dn, Suspense as jc, forwardRef as li, memo as di } from "react";
import { IconSelector as wi, IconCheck as Aa, IconChevronDown as Fc, IconChevronUp as Uc, IconLayoutSidebar as Kc, IconLayoutSidebarRight as Hc, IconChevronRight as ui, IconSearch as qc, IconLoader as Gc, IconAlertOctagon as Wc, IconAlertTriangle as Yc, IconInfoCircle as Xc, IconCircleCheck as Jc } from "@tabler/icons-react";
import { createEditor as pi, $getRoot as tr, $createParagraphNode as Xr, $getSelection as ce, HISTORY_MERGE_TAG as $o, ParagraphNode as hi, TextNode as gi, $getPreviousSelection as Zc, $isRangeSelection as Se, $caretFromPoint as Qc, $getSiblingCaret as fi, $getChildCaret as tl, $getAdjacentChildCaret as el, $isChildCaret as rl, $normalizeCaret as al, $setSelectionFromCaretRange as ol, $getCollapsedCaretRange as nl, $getCaretInDirection as wn, $splitAtPointCaretNext as il, $isTextPointCaret as sl, $findMatchingParent as mi, $isElementNode as Kr, mergeRegister as Be, getDOMTextNode as cl, isHTMLElement as ll, CLEAR_EDITOR_COMMAND as vi, COMMAND_PRIORITY_EDITOR as Vo, shallowMergeConfig as dl, defineExtension as ge, safeCast as pr, createState as wl, FORMAT_TEXT_COMMAND as bi, $isNodeSelection as xi, COMMAND_PRIORITY_LOW as yi, RootNode as ul, LineBreakNode as pl, TabNode as hl, $isEditorState as gl, createCommand as fl, CLICK_COMMAND as ml, isDOMNode as vl, $getNodeFromDOMNode as bl, $createNodeSelection as xl, $setSelection as yl, $getEditor as kl, DecoratorNode as ho, $getState as _l, toggleTextFormatType as un, TEXT_TYPE_TO_FORMAT as Nl, $setState as Cl, addClassNamesToElement as ki, $create as El, $getNodeByKey as Tl, removeClassNamesFromElement as Sl, KEY_TAB_COMMAND as Rl, $isBlockElementNode as Dl, $createRangeSelection as Ml, $normalizeSelection__EXPERIMENTAL as Ol, OUTDENT_CONTENT_COMMAND as Il, INDENT_CONTENT_COMMAND as pn, INSERT_TAB_COMMAND as zl, COMMAND_PRIORITY_CRITICAL as Lo, $isDecoratorNode as Pl, $isParagraphNode as Al, $isTextNode as go, SELECTION_CHANGE_COMMAND as _i, $insertNodes as $l } from "lexical";
...
import { Avatar as Bo, Select as ae, Checkbox as hn, Slot as Jr, Tabs as ke, Menubar as Me, ContextMenu as Ht, Progress as gn, Slider as na, Switch as fn } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as fo, HIDDEN_NOTE_CALLER as mo, getDefaultViewOptions as Jl, isInsertEmbedOpOfType as Ir, getMarkerMenuItems as Zl, defaultStyleInfo as Ql, Editorial as td } from "@eten-tech-foundation/platform-editor";
...
let vo = "keyboard", vn = !1;
function cd() {
  vn || typeof document > "u" || (vn = !0, document.addEventListener(
    "pointerdown",
    () => {
      vo = "pointer";
    },
...
function Xa({
  ...
  const B = De(), U = sd(), [O, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [G, $] = _(
    ...
    () => bd(ne, _e),
    [ne, _e]
  ), Jt = Xt.has(t.book), ze = P(() => Y.trim() ? xo(
  ...
  const { otLong: Tt, ntLong: Gt, dcLong: ar, extraLong: Ke } = {
    ...
    (v) => {
      ...
      if (k === "books" && !jt && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const Bt = q === Nt.current ? Nt.current : void 0, pe = (Bt == null ? void 0 : Bt.selectionStart) ?? 0, Zt = (Bt == null ? void 0 : Bt.selectionEnd) ?? 0, xe = B === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
                  ...
                  !M && Object.entries(ze).map(([v, q]) => {
                    if (q.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Ze, { heading: Pe(v), children: q.map((lt) => /* @__PURE__ */ a(
                          Ri,
                          {
                            bookId: lt,
                            onSelect: (Ft) => K(Ft),
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Td = zi ? re : Z, ca = { tag: $o };
...
const Rd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
...
const Pd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
function Ad(t) {
    ...
    w.read(() => {
      ...
      if ((B || U) && N !== null && A !== null) {
        const O = function(S, D, W, Y, z, k, ot) {
          ...
          return I.setStart(..._n(D, W, Y)), I.setEnd(..._n(z, k, ot)), I;
        }(t, h, m, N, f, T, A);
        d(), d = jd(t, O, e);
      }
...
function Gd(t, e, r) {
  ...
  return sl(o) && Ca(283), o.insert(t.isInline() ? Xr().append(t) : t), wn(fi(t.getLatest(), "next"), e.direction);
}
function Wd(t) {
  const e = ce();
  if (!Se(e)) return !1;
...
let Ea, Le = 0, Ta = 0, Jd = 0, _o = 0, fa = 0;
function Cn(t) {
  if (ht === void 0) return;
  let e = t.n;
...
te.prototype.brand = Yd, te.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Vi(this), En(this), Le++;
  const t = ht;
...
const iw = ge({ config: pr({ setOptions: Tn, updateOptions: Tn }), init: ({ $initialEditorState: t = nw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ul, gi, pl, hl, hi] }), Sn = Symbol.for("@lexical/extension/LexicalBuilder");
function Rn() {
}
function sw(t) {
  throw t;
...
const cw = /* @__PURE__ */ new Set(), Dn = ge({ build(t, e, r) {
  ...
  return { watchNodeKey: function(i) {
    const c = Zd(() => (s.value || cw).has(i)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(i);
    const w = l !== void 0;
...
const _w = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
...
const Bw = "verseText", gh = Object.freeze([
...
const Ww = {
  ...
  const dt = V(
    (E) => {
      ...
      ut.current = ct, at || I(ct), k == null || k(l, Pn(ct) ? void 0 : ct);
    },
    [at, k, l]
  ), tt = V(
    (E, ct) => {
  ...
  ze.current = l, Z(() => () => {
    var ct;
    const { current: E } = ut;
    E.assignedUser !== void 0 && E.assignedUser === Xt.current && E.editorState === void 0 && !$r(E.commentEdits) && ((ct = Jt.current) == null || ct.call(Jt, ze.current, void 0));
  }, []);
  const M = P(
          ...
          n && /* @__PURE__ */ u(gt, { children: [
            ...
            T !== !1 && (!qt || de(G)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (E) => {
                  Wo(E) && (E.preventDefault(), E.stopPropagation(), (de(G) || $ !== void 0 && $ !== pt) && Ke());
                },
                onKeyDown: (E) => {
...
var wu = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(wu || {});
...
function uu({ id: t, versionHistory: e }) {
...
function Ih({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(uu, { versionHistory: n }),
...
const fu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(gt, { children: [
...
function mu({
  ...
  return /* @__PURE__ */ u(je, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: fu(t, o, e) }) }) }),
...
const vu = (t, e) => t === "f" ? /* @__PURE__ */ u(gt, { children: [
  /* @__PURE__ */ a(ii, {}),
  " ",
...
function xu({
  ...
  return /* @__PURE__ */ u(je, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: vu(t, r) }) }) }),
      /* @__PURE__ */ a(yt, { children: /* @__PURE__ */ a("p", { children: bu(t, r) }) })
    ] }) }),
...
function Ph({
  ...
  const _e = () => {
    ...
    if (K && Ir("note", K)) {
      ...
      O !== "x" && R === "x" ? st == null || st.forEach((it) => Tu(it)) : O === "x" && R !== "x" && (st == null || st.forEach((it) => Su(it))), (nt = h.current) == null || nt.applyUpdate([K, { delete: 1 }]);
    }
  }, le = (R) => {
  ...
  return /* @__PURE__ */ u(gt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(gt, { children: Du(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Io, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      Ye,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(kr, { className: o, children: Iu(c.text) })
        ]
      },
...
const Pu = (t) => {
  ...
  return e ? e[1] : "";
}, $u = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Kh = Object.freeze([
...
function Hh({
  ...
  }, [U, ot]), X = P(() => I.length === 0 ? [] : Vu(I, S, W), [I, S, W]), G = P(() => {
    var kt, mt;
    if (!U) return d;
...
const Bu = "16rem", ju = "3rem", cs = ee.createContext(void 0);
function Ba() {
...
function Yu({
  ...
  const c = t ? Jr.Root : "button", { state: d } = Ba(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: b(Wu({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Uu,
    {
      ...
      children: /* @__PURE__ */ u(Hu, { children: [
        /* @__PURE__ */ u(Bn, { children: [
          ...
          /* @__PURE__ */ a(Fn, { children: /* @__PURE__ */ a(qu, { children: Object.entries(e).map(([g, T]) => /* @__PURE__ */ a(Gu, { children: /* @__PURE__ */ a(
            Yu,
            {
              onClick: () => p(g),
              isActive: x(g),
    ...
    /* @__PURE__ */ u(
      Fu,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ku, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
}
const qe = "scrBook", Ju = "scrRef", nr = "source", Zu = "details", Qu = "Scripture Reference", tp = "Scripture Book", ls = "Type", ep = "Details";
function rp(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, Un = (t) => `${ap({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ig({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(ou, { children: N.map((S) => /* @__PURE__ */ a(ye, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
...
function cg({
  ...
  const B = Ut(
    ...
    [r, n, g, s]
  ), Jt = mt.find((F) => F.value === t), ze = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? $c(jt, Pt, {
...
] }, `tooltip-${c.label}-${c.command}`) : /* @__PURE__ */ u(Bs, { children: [
  /* @__PURE__ */ u(bt, { children: [
    /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(js, { children: c.label }) }),
    c.tooltip && /* @__PURE__ */ a(yt, { children: c.tooltip })
  ] }),
...
function Eo({
  ...
  const l = Na(), w = dp(e), p = s && w.length > 1;
...
const pp = Object.freeze([520, 420, 340]), gs = ee.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = hs(n, pp), l = Mi() ?? d, w = l >= Br.MINIMUM;
...
const hp = ee.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ke.Trigger,
  {
    ref: r,
    ...e,
...
function gg({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(fs, { children: [
      /* @__PURE__ */ a(ms, { children: t.map((c) => /* @__PURE__ */ a(hp, { value: c.value, children: c.value }, c.key)) }),
...
const Pr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    ...
    return c.length > 0 && i < n.length - 1 && d.push(/* @__PURE__ */ a(yp, {}, `separator-${s}`)), d;
  });
};
function Ep({
  menuData: t,
  ...
  if (ed(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(gp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ws(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(fp, { children: [
...
function tf({
  ...
  return /* @__PURE__ */ a(
    ke.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: b("pr-twp", Pp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
