...
function ff(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, y = n.tetherOffset, m = y === void 0 ? 0 : y, h = _n(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Kt(e.placement), T = Ze(e.placement), C = !T, S = aa(k), b = wf(S), _ = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (_) {
    if (a) {
      var J, j = S === "y" ? Pt : _t, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = _[S], H = G + h[j], rt = G - h[M], N = g ? -R[A] / 2 : 0, O = T === qe ? F[A] : R[A], U = T === qe ? -R[A] : -F[A], X = e.elements.arrow, z = g && X ? oa(X) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var fe, Ct = S === "x" ? Pt : _t, Fn = S === "x" ? Gt : Ut, Ht = _[b], Ie = b === "y" ? "height" : "width", me = Ht + h[Ct], $e = Ht - h[Fn], Me = [Pt, _t].indexOf(k) !== -1, Ae = (fe = D == null ? void 0 : D[b]) != null ? fe : 0, he = Me ? me : Ht - F[Ie] - R[Ie] - Ae + L.altAxis, on = Me ? Ht + F[Ie] + R[Ie] - Ae - L.altAxis : $e, Ln = g && Me ? jw(he, Ht, on) : kn(g ? he : me, Ht, g ? on : $e);
      _[b] = Ln, tt[b] = Ln - Ht;
    }
