import { jsx as r, jsxs as l, Fragment as Ye } from "react/jsx-runtime";
import u, { forwardRef as Ue, useState as P, createContext as Or, useContext as Mr, useCallback as U, useRef as Q, useMemo as q, useEffect as dt, useLayoutEffect as fn, Fragment as En } from "react";
import { Check as _t, CircleSlash as zr, ChevronRight as Ke, Circle as qe, X as Je, Search as Dn, ChevronsUpDown as We, FilterIcon as Br, ChevronDown as ce, ChevronUp as Ar, ArrowLeftIcon as Ir, ChevronLeftIcon as Pr, ChevronRightIcon as Fr, ArrowRightIcon as jr, Filter as Xr, User as Gr, Link as $r, CircleHelp as Lr, Star as Hr, CircleCheckIcon as Yr, CircleXIcon as Ur, CircleHelpIcon as Kr, ArrowUpIcon as qr, ArrowDownIcon as Jr, ArrowUpDownIcon as Wr, PanelLeft as Zr, PanelRight as Qr, ScrollText as ta, ChevronLeft as ea, MenuIcon as na, Menu as ra, EllipsisVertical as aa, Copy as oa, LoaderCircle as sa } from "lucide-react";
...
import { formatScrRef as Ot, MODIFIER_KEYS as gn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Ze, isString as Ve, compareScrRefs as Pe, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
const tn = G.Trigger, In = G.Group, ka = G.Portal, Ca = G.Sub, Js = G.RadioGroup;
function ue({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Qe.Provider, { value: n, children: /* @__PURE__ */ r(G.Root, { ...e }) });
}
...
en.displayName = G.CheckboxItem.displayName;
const jn = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(qe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
D(at, "Original", new at(mt.Original)), D(at, "Septuagint", new at(mt.Septuagint)), D(at, "Vulgate", new at(mt.Vulgate)), D(at, "English", new at(mt.English)), D(at, "RussianProtestant", new at(mt.RussianProtestant)), D(at, "RussianOrthodox", new at(mt.RussianOrthodox));
let Dt = at;
function vn(t, e) {
  const n = e[0];
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Dt(mt[i]);
        } catch {
...
D(et, "defaultVersification", Dt.English), D(et, "verseRangeSeparator", "-"), D(et, "verseSequenceIndicator", ","), D(et, "verseRangeSeparators", [et.verseRangeSeparator]), D(et, "verseSequenceIndicators", [et.verseSequenceIndicator]), D(et, "chapterDigitShifter", 1e3), D(et, "bookDigitShifter", et.chapterDigitShifter * et.chapterDigitShifter), D(et, "bcvMaxValue", et.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
D(et, "ValidStatusType", Yn);
...
const xn = 6, on = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), Un = Object.fromEntries(
  on.map((t) => [t, M.bookIdToEnglishName(t)])
), ja = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function Zs({
  ...
  const o = W(), [s, i] = P(
    () => Ot(t, "English")
  ), [w, c] = P(""), [p, g] = P(t.book), [v, f] = P(t.chapterNum ?? 0), [h, _] = P(t.book), [T, k] = P(!1), [y, S] = P(T), [V, A] = P(!1), [z, gt] = P(), L = Q(void 0), x = Q(void 0), b = Q(void 0), B = Q(void 0), R = U(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (E, N) => {
            ...
            const j = N.exec(m);
            if (j) {
              const [F, ut = void 0, oe = void 0] = j.slice(1), st = kn(F) ?? (M.isBookIdValid(F) ? F.toLocaleUpperCase() : void 0);
              if (st) {
                const wt = ut ? parseInt(ut, 10) : void 0;
                if (wt && wt > It(st)) return;
                const xt = oe ? parseInt(oe, 10) : void 0;
                return {
                  book: st,
                  chapterNum: wt,
                  verseNum: xt
    ...
    if (!(!z || !z.chapterNum))
      return z.verseNum ? [z.chapterNum] : Array.from({ length: It(h) }, (m, E) => E + 1).filter(
        (m) => {
          var E;
    ...
    i(Ot(t, "English")), c(""), g(t.book), _(t.book);
  }, [t]), vt = U((m) => {
    if (ot.current) {
      ot.current = !1;
      return;
    ...
    (m, E, N, j) => {
      if (f(t.book !== m ? 1 : t.chapterNum), E || It(m) === -1) {
        e({
          book: m,
          chapterNum: N ?? 1,
          verseNum: j ?? 1
    ...
    yn.forEach((m) => {
      const E = m.exec(w);
      if (E) {
        const [N, j = void 0, F = void 0] = E.slice(1), ut = kn(N);
    ...
    (m) => {
      if (T ? m.key === "ArrowDown" ? (B != null && B.current ? B.current.focus() : b != null && b.current ? b.current.focus() : x.current && x.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === L.current && (k(!1), m.preventDefault(), m.stopPropagation()) : m.key !== "Tab" && m.key !== "Escape" && k(!0), document.activeElement === L.current) {
        if (/^[a-zA-Z]$/.test(m.key) && (Y(it ? w + m.key : m.key), A(!0), m.preventDefault()), V)
          Y(w + m.key), m.preventDefault();
        else {
          if (/^\d$/.test(m.key)) {
            const N = s.match(
    ...
    (m) => {
      const { key: E } = m;
      Nn.has(E) || (ae(m), m.preventDefault());
    },
    [ae]
  ), Dr = U((m) => {
    const { key: E } = m;
    ...
    (m, E) => {
      ...
      if (Nn.has(N)) {
        if (h === p || C === 1) {
          ...
          const ut = N === "ArrowRight" && !o || N === "ArrowRight" && o === "ltr" || N === "ArrowLeft" && o === "rtl", oe = N === "ArrowLeft" && !o || N === "ArrowLeft" && o === "ltr" || N === "ArrowRight" && o === "rtl", Ee = Array.from(
            { length: It(h) },
            (se, Rt) => Rt + 1
          ), st = p !== h || C === 1 ? K ?? Ee : Ee, wt = st.indexOf(v);
          let xt = v;
          if (ut)
            ...
            const se = st[wt] + xn, Rt = st.find((De) => De >= se);
            Rt !== void 0 && (xt = Rt);
          } else if (N === "ArrowUp") {
            const se = st[wt] - xn, Rt = st.slice().reverse().find((De) => De <= se);
            Rt !== void 0 && (xt = Rt);
          }
          if (xt !== v) {
      ...
      ae(m), m.preventDefault(), m.stopPropagation();
    },
    [
      o,
      h,
  ...
  return dt(() => {
    C === 1 ? f(1) : p === h ? p === t.book ? f(t.chapterNum) : f(1) : f(0);
  }, [h, t.book, t.chapterNum, p, C]), dt(() => {
    if (!K || C > 1) return;
    K.indexOf(v) === -1 && f(K[0]);
  }, [h, v, p, K, C]), dt(() => {
    tt();
    ...
    const m = setTimeout(() => {
      ...
      !y && document.activeElement !== L.current && !((E = L.current) != null && E.contains(document.activeElement)) && document.activeElement !== x.current && !((N = x.current) != null && N.contains(document.activeElement)) && tt();
    }, 10);
    return () => {
      clearTimeout(m);
    };
    ...
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          g(t.book), _(t.book), f(t.chapterNum > 0 ? t.chapterNum : 0), L.current.focus();
        },
        onFocus: () => {
          ot.current = !0, A(!1), gt(R(s));
        },
        onBlur: () => {
          C === 0 && tt();
        },
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Z.map((m, E) => /* @__PURE__ */ l("div", { children: [
            ...
            m.books.map((N, j) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              ...
              {
                bookId: N,
                handleSelectBook: () => At(N, !1),
                shouldExpandChildren: p.toLowerCase() === N.toLowerCase() || C === 1,
                handleHighlightBook: () => _(N),
                ...
                children: /* @__PURE__ */ r(
                  Fa,
                  {
                    ...
                    highlightedChapter: p === h || C === 1 ? v : 0,
...
const fe = Qt.Root, ge = Qt.Trigger, re = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = W();
...
const Ya = ht.Portal, Kn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ht.Overlay,
  {
    ref: n,
    className: d(
...
Kn.displayName = ht.Overlay.displayName;
...
Ka.displayName = ht.Title.displayName;
...
be.displayName = nt.displayName;
const ve = u.forwardRef(({ className: t, ...e }, n) => {
  const a = W();
...
ve.displayName = nt.Input.displayName;
...
xe.displayName = nt.List.displayName;
const ye = u.forwardRef((t, e) => /* @__PURE__ */ r(nt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
ye.displayName = nt.Empty.displayName;
...
qn.displayName = nt.Separator.displayName;
...
Ne.displayName = nt.Item.displayName;
function Ja(t) {
...
function Ge({
  ...
  const [k, y] = P(!1);
  return /* @__PURE__ */ l(fe, { open: k, onOpenChange: y, ...T, children: [
    ...
    /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ l(be, { children: [
          /* @__PURE__ */ r(ve, { placeholder: g, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(ye, { children: v }),
          /* @__PURE__ */ r(xe, { children: e.map((S) => /* @__PURE__ */ l(
            Ne,
            {
              value: w(S),
              onSelect: () => {
...
function ti({
  ...
  const g = Me(p, "%webView_bookSelector_currentBook%"), v = Me(p, "%webView_bookSelector_choose%"), f = Me(p, "%webView_bookSelector_chooseBooks%"), [h, _] = P(
    "current book"
    /* CURRENT_BOOK */
  ), T = (k) => {
    _(k), t(k);
...
const jt = H.Root, to = H.Group, Xt = H.Value, eo = St(
...
lt.displayName = H.Item.displayName;
...
const ke = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: d("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
function io({
  ...
  var k;
  const [w, c] = P([]), [p, g] = P([]), [v, f] = P({}), [h, _] = P({}), T = On({
    data: e,
    columns: t,
    getCoreRowModel: zn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(ke, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ce, { stickyHeader: s, children: T.getHeaderGroups().map((y) => /* @__PURE__ */ r(Ct, { children: y.headers.map((S) => /* @__PURE__ */ r(te, { children: S.isPlaceholder ? void 0 : Jt(S.column.columnDef.header, S.getContext()) }, S.id)) }, y.id)) }),
      /* @__PURE__ */ r(_e, { children: (k = T.getRowModel().rows) != null && k.length ? T.getRowModel().rows.map((y) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(y, T),
          "data-state": y.getIsSelected() && "selected",
          children: y.getVisibleCells().map((S) => /* @__PURE__ */ r(Gt, { children: Jt(S.column.columnDef.cell, S.getContext()) }, S.id))
        },
        y.id
...
function ei({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = q(
    () => ({
      overrides: {
        a: {
...
function ni({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(ue, { children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ l(X, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ne, { children: n.map((a) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(In, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(en, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(jn, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(Ft, {})
    ] }, a.label)) })
  ] }) });
}
function ri({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new ca("en", {
    notation: "compact",
...
function po({
  ...
  const [v, f] = P(!1), h = U(
    ...
    const k = t.filter((S) => S.starred).sort((S, V) => S.label.localeCompare(V.label)), y = t.filter((S) => !S.starred).sort((S, V) => {
      const A = n.includes(S.value), z = n.includes(V.value);
      return A && !z ? -1 : !A && z ? 1 : S.label.localeCompare(V.label);
    });
    return [...k, ...y];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(fe, { open: v, onOpenChange: f, children: [
    /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ l(
      X,
      {
        variant: "ghost",
          ...
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              "div",
              {
                ...
                children: /* @__PURE__ */ r("div", { className: "tw-font-normal", children: _() })
              }
            )
          ] }),
    ...
    /* @__PURE__ */ r(re, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(be, { children: [
      ...
      return /* @__PURE__ */ l(le, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          X,
          {
            ...
            onClick: () => a(n.filter((_) => _ !== f)),
            children: /* @__PURE__ */ r(Je, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (h = t.find((_) => _.value === f)) == null ? void 0 : h.label
      ] }, f);
...
ln.displayName = Fe.Root.displayName;
const Zn = St(
...
tr.displayName = pe.Root.displayName;
...
const Se = (t) => t === "asc" ? /* @__PURE__ */ r(qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), si = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, fo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", pi = Object.freeze([
...
function ui({
  ...
  const p = yt(n, "%webView_inventory_all%"), g = yt(n, "%webView_inventory_approved%"), v = yt(n, "%webView_inventory_unapproved%"), f = yt(n, "%webView_inventory_unknown%"), h = yt(n, "%webView_inventory_scope_currentBook%"), _ = yt(n, "%webView_inventory_scope_chapter%"), T = yt(n, "%webView_inventory_filter_text%"), k = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, S] = P(!1), [V, A] = P("all"), [z, gt] = P(""), [L, x] = P([]), b = q(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), B = q(() => {
    if (y) return b;
    const C = [];
    return b.forEach((Y) => {
      const ot = Y.items[0], tt = C.find(
        (vt) => vt.items[0] === ot
      );
      tt ? (tt.count += Y.count, tt.occurrences = tt.occurrences.concat(Y.occurrences)) : C.push({
        items: [ot],
        count: Y.count,
    ...
    var ot, tt;
    if (!y) return c;
    const C = (ot = a == null ? void 0 : a.tableHeaders) == null ? void 0 : ot.length;
    if (!C) return c;
    const Y = [];
    for (let vt = 0; vt < C; vt++)
      Y.push(
        ho(
          ((tt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : tt[vt]) || "Additional Item",
          vt + 1
        )
      );
    return [...Y, ...c];
...
const cn = ee.Provider, pn = ee.Root, un = ee.Trigger, Te = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ee.Content,
  {
    ref: a,
    sideOffset: e,
...
const nr = u.forwardRef(
  ({
    ...
    const [p, g] = u.useState(t), v = e ?? p, f = u.useCallback(
      (V) => {
        const A = typeof V == "function" ? V(v) : V;
        n ? n(A) : g(A);
      },
      [n, v]
    ), h = u.useCallback(() => f((V) => !V), [f]), _ = v ? "expanded" : "collapsed", y = W() === "ltr" ? i : i === "primary" ? "secondary" : "primary", S = u.useMemo(
      () => ({
        state: _,
        open: v,
        setOpen: f,
...
const Ro = St(
  ...
  ({
    ...
    const c = t ? $t : "button", { state: p } = Re(), g = /* @__PURE__ */ r(
      c,
      {
        ref: w,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Te, { side: "right", align: "center", hidden: p !== "collapsed", ...o })
    ] })) : g;
  }
);
...
function Bo({
  ...
  const p = U(
    ...
    (f) => {
      const h = n.find((_) => _.projectId === f);
    ...
    rr,
    {
      ...
      children: /* @__PURE__ */ l(or, { children: [
        /* @__PURE__ */ l($e, { children: [
          ...
          /* @__PURE__ */ r(He, { children: /* @__PURE__ */ r(sr, { children: Object.entries(e).map(([f, h]) => /* @__PURE__ */ r(ir, { children: /* @__PURE__ */ r(
            wr,
            {
              onClick: () => p(f),
              isActive: v(f),
...
const Nt = "scrBook", Ao = "scrRef", Vt = "source", Io = "details", Po = "Scripture Reference", Fo = "Scripture Book", dr = "Type", jo = "Details";
function Xo(t, e) {
  const n = e ?? !1;
  return [
    {
...
const Go = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Pe(t.start, t.end) === 0 ? `${Oe(t.start)}+${e}` : `${Oe(t.start)}+${e}-${Oe(t.end)}+${n}`;
...
function hi({
  ...
  const [c, p] = P([]), [g, v] = P([{ id: Nt, desc: !1 }]), [f, h] = P({}), _ = q(
  ...
  dt(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const B = _.find((R) => _n(R) === b[0]) || void 0;
        B && w(B);
      }
    }
  }, [f, _, w, k]);
    ...
    !e && /* @__PURE__ */ l(
      jt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Bt, { position: "item-aligned", children: /* @__PURE__ */ r(to, { children: V.map((x) => /* @__PURE__ */ r(lt, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(ke, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ce, { children: k.getHeaderGroups().map((x) => /* @__PURE__ */ r(Ct, { children: x.headers.filter((b) => b.column.columnDef.header).map((b) => (
      ...
      /* @__PURE__ */ r(_e, { children: k.getRowModel().rows.map((x, b) => {
        const B = W();
        return /* @__PURE__ */ r(
          Ct,
          {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      X,
                      {
                        ...
                        children: [
                          ...
                          !x.getIsExpanded() && (B === "ltr" ? /* @__PURE__ */ r(Ke, {}) : /* @__PURE__ */ r(ea, {})),
                          " ",
...
function Uo({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(fe, { open: k, onOpenChange: y, children: [
      /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ l(
        X,
        {
          variant: "outline",
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var B;
        return /* @__PURE__ */ r(le, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((B = o.get(b)) == null ? void 0 : B.localizedName) || M.bookIdToEnglishName(b) || b }, b);
      }),
...
function gi({
  ...
  const c = Et(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), v = Et(i, "%webView_scope_selector_current_book%"), f = Et(i, "%webView_scope_selector_choose_books%"), h = Et(i, "%webView_scope_selector_scope%"), _ = Et(i, "%webView_scope_selector_select_books%"), T = [
      ...
      /* @__PURE__ */ r(
        sn,
        {
          ...
          children: k.map(({ value: y, label: S, id: V }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(we, { className: "tw-me-2", value: y, id: V }),
...
function Tn({
  ...
  return /* @__PURE__ */ l(ue, { variant: s, children: [
    /* @__PURE__ */ r(tn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(X, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(na, {}) }) }),
...
const Zo = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    $.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(qe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
    ...
    const w = e.filter((p) => p.group === s).sort((p, g) => p.order - g.order).map((p) => /* @__PURE__ */ l(pn, { children: [
      /* @__PURE__ */ r(un, { asChild: !0, children: "command" in p ? /* @__PURE__ */ l(
        Nr,
        {
          ...
          children: [
            p.iconPathBefore && /* @__PURE__ */ r(de, { icon: p.iconPathBefore, menuLabel: p.label, leading: !0 }),
            p.label,
            p.iconPathAfter && /* @__PURE__ */ r(de, { icon: p.iconPathAfter, menuLabel: p.label })
          ]
        },
      ...
      p.tooltip && /* @__PURE__ */ r(Te, { children: p.tooltip })
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (_ = s.current) == null || _.focus(), Kt(s, [f, h]);
        break;
      case "alt+l":
    ...
    const g = new MutationObserver((h) => {
      h.forEach((_) => {
        if (_.attributeName === "data-state" && _.target instanceof HTMLElement) {
          const T = _.target.getAttribute("data-state");
          n(T === "open");
        }
      });
    });
...
function Si({
  ...
  const c = es(
    ...
    o && o(h), a && a([h, ...n.filter((_) => _ !== h)]), s && n.find((_) => _ === h) && s([...n.filter((_) => _ !== h)]), g(!1);
  }, f = (h, _) => {
    var k, y, S, V, A, z;
    const T = _ !== h ? ((y = (k = t[h]) == null ? void 0 : k.uiNames) == null ? void 0 : y[_]) ?? ((V = (S = t[h]) == null ? void 0 : S.uiNames) == null ? void 0 : V.en) : void 0;
...
function ns({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(X, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(oa, {}) })
    ] }),
    /* @__PURE__ */ r("div", { className: "tw-prose tw-w-full", children: /* @__PURE__ */ r("pre", { className: "tw-text-xs", children: t }) })
  ] });
}
function Ri({ errorDetails: t, handleCopyNotify: e, localizedStrings: n, children: a }) {
  return /* @__PURE__ */ l(fe, { children: [
    /* @__PURE__ */ r(ge, { children: a }),
    /* @__PURE__ */ r(re, { className: "tw-min-w-80 tw-max-w-96", children: /* @__PURE__ */ r(
      ns,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
const Vi = ct.Trigger, vs = ct.Portal, Oi = ct.Close, Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Overlay,
  {
    ref: n,
...
ks.displayName = ct.Title.displayName;
const Cs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Description,
  {
    ref: n,
...
Cs.displayName = ct.Description.displayName;
...
_s.displayName = je.Root.displayName;
function Mi({ ...t }) {
  return /* @__PURE__ */ r(
    va,
    {
...
Ts.displayName = Xe.Root.displayName;
const zi = rt.Root, Rs = u.forwardRef(({ className: t, ...e }, n) => {
  const a = W();
  return /* @__PURE__ */ r(
    rt.List,
    {
...
export {
  ...
  Ri as ErrorPopover,
  oi as Filter,
  ni as FilterDropdown,
  ai as Footer,
  pi as INVENTORY_STRING_KEYS,
  Ht as Input,
  ui as Inventory,
  J as Label,
  ei as MarkdownRenderer,
  ri as MoreInfo,
  po as MultiSelectComboBox,
  ki as NavigationContentSearch,
  fe as Popover,
  ...
  fi as SCOPE_SELECTOR_STRING_KEYS,
  gi as ScopeSelector,
  hi as ScriptureResultsViewer,
  bi as ScrollGroupSelector,
  lr as SearchBar,
  jt as Select,
  Bt as SelectContent,
  to as SelectGroup,
  ...
  xi as SettingsListItem,
  Bo as SettingsSidebar,
  mi as SettingsSidebarContentSearch,
  Cn as Skeleton,
  Ss as Slider,
  Mi as Sonner,
  as as Spinner,
  ...
  d as cn,
  ci as getBookIdFromUSFM,
  li as getLinesFromUSFM,
  di as getNumberFromUSFM,
  fo as getStatusForItem,
  Ci as getToolbarOSReservedSpaceClassName,
  ii as inventoryCountColumn,
  si as inventoryItemColumn,
  wi as inventoryStatusColumn,
