...
function Qp({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      className: v("tw:@container/toolbar tw:border tw:px-4 tw:text-foreground", o),
      ref: w,
