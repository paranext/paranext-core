import ll, { jsx as i, jsxs as y, Fragment as ae } from "react/jsx-runtime";
import * as j from "react";
import S, { forwardRef as sr, useCallback as Ot, useState as st, useRef as ye, useEffect as Kt, useLayoutEffect as da, useMemo as Tt } from "react";
...
nt(Mt, "Original", new Mt(Yt.Original)), nt(Mt, "Septuagint", new Mt(Yt.Septuagint)), nt(Mt, "Vulgate", new Mt(Yt.Vulgate)), nt(Mt, "English", new Mt(Yt.English)), nt(Mt, "RussianProtestant", new Mt(Yt.RussianProtestant)), nt(Mt, "RussianOrthodox", new Mt(Yt.RussianOrthodox));
let me = Mt;
function wa(t, e) {
  const n = e[0];
...
const Rt = class it {
    ...
    if (nt(this, "firstChapter"), nt(this, "lastChapter"), nt(this, "lastVerse"), nt(this, "hasSegmentsDefined"), nt(this, "text"), nt(this, "BBBCCCVVVS"), nt(this, "longHashCode"), nt(this, "versification"), nt(this, "rtlMark", "‏"), nt(this, "_bookNum", 0), nt(this, "_chapterNum", 0), nt(this, "_verseNum", 0), nt(this, "_verse"), r == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof it) {
          ...
          if (e == null)
            return;
          const a = e instanceof me ? e : it.defaultVersification;
          this.setEmpty(a);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return s && (c = new me(s)), n ? new it(n, r.toString(), l, c) : new it();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = a[0], a.length > 1)
        try {
          const s = +a[1].trim();
          this.versification = new me(Yt[s]);
        } catch {
...
function Sc({
  ...
  const a = Array.from({ length: e }, (l, c) => c + 1), s = Ot(
    (l) => {
      o(l);
    },
    [o]
...
function bh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = st(""), [o, a] = st(
    ...
    ct.bookNumberToId(t.bookNum)
  ), [u, m] = st(!1), [w, g] = st(u), b = ye(void 0), f = ye(void 0), h = ye(void 0), k = Ot(
    (T) => Pc(T).filter((D) => {
    ...
    _c.forEach((T) => {
      const D = n.match(T);
      if (D) {
        const [M, Q = void 0, K = void 0] = D.slice(1), G = Ac(M);
        (ct.isBookIdValid(M) || G) && v(
          G ?? M,
          !0,
          Q ? parseInt(Q, 10) : 1,
          K ? parseInt(K, 10) : 1
...
), St = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(wi.Root, { ref: n, className: N("pr-twp", Dc(), t), ...e }));
...
const Bc = Jt.Portal, $i = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Jt.Overlay,
  {
    ref: n,
    className: N(
...
jc.displayName = Jt.Content.displayName;
...
Vc.displayName = Jt.Title.displayName;
...
zc.displayName = Jt.Description.displayName;
...
No.displayName = $t.Input.displayName;
...
ko.displayName = $t.List.displayName;
const Eo = S.forwardRef((t, e) => /* @__PURE__ */ i($t.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Eo.displayName = $t.Empty.displayName;
...
Ii.displayName = $t.Group.displayName;
...
const Ue = Nt.Root, Xc = Nt.Group, Ge = Nt.Value, Ee = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  Nt.Trigger,
  {
    ref: r,
    className: N(
    ...
    children: [
      e,
      /* @__PURE__ */ i(Nt.Icon, { asChild: !0, children: /* @__PURE__ */ i(Cn, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
    ]
  }
));
Ee.displayName = Nt.Trigger.displayName;
...
Ai.displayName = Nt.ScrollUpButton.displayName;
...
Mi.displayName = Nt.ScrollDownButton.displayName;
const Te = S.forwardRef(({ className: t, children: e, position: n = "popper", ...r }, o) => /* @__PURE__ */ i(Nt.Portal, { children: /* @__PURE__ */ y(
  Nt.Content,
  {
    ref: o,
    className: N(
...
const zt = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  Nt.Item,
  {
    ref: r,
    className: N(
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(Nt.ItemIndicator, { children: /* @__PURE__ */ i(Sn, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ i(Nt.ItemText, { children: e })
    ]
  }
));
...
Wc.displayName = Nt.Separator.displayName;
function qc({ table: t }) {
    ...
    /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ y(
        Ue,
        {
          ...
          children: [
            /* @__PURE__ */ i(Ee, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ i(Ge, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ i(Te, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ i(zt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const de = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  "th",
  {
    ref: n,
    className: N(
...
const Dt = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  "td",
  {
    ref: n,
...
function Zc({
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ y($n, { stickyHeader: a, children: [
      /* @__PURE__ */ i(In, { stickyHeader: a, children: f.getHeaderGroups().map((k) => /* @__PURE__ */ i(Wt, { children: k.headers.map((_) => /* @__PURE__ */ i(de, { children: _.isPlaceholder ? void 0 : mn(_.column.columnDef.header, _.getContext()) }, _.id)) }, k.id)) }),
      /* @__PURE__ */ i(An, { children: (h = f.getRowModel().rows) != null && h.length ? f.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        Wt,
        {
          onClick: () => s(k, f),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((_) => /* @__PURE__ */ i(Dt, { children: mn(_.column.columnDef.cell, _.getContext()) }, _.id))
        },
        k.id
      )) : /* @__PURE__ */ i(Wt, { children: /* @__PURE__ */ i(Dt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Qc({
  ...
  return /* @__PURE__ */ y($n, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(In, { stickyHeader: !0, children: /* @__PURE__ */ y(Wt, { children: [
      /* @__PURE__ */ i(de, { children: r }),
      /* @__PURE__ */ i(de, { children: o })
    ] }) }),
    /* @__PURE__ */ i(An, { children: a.length > 0 && a.map((s) => /* @__PURE__ */ y(
      Wt,
      {
        ...
        children: [
          /* @__PURE__ */ i(Dt, { children: `${ct.bookNumberToEnglishName(s.reference.bookNum)} ${s.reference.chapterNum}:${s.reference.verseNum}` }),
          /* @__PURE__ */ i(Dt, { children: s.text })
        ]
      },
...
function Th({
  ...
  const m = ee(n, "%webView_inventory_all%"), w = ee(n, "%webView_inventory_approved%"), g = ee(n, "%webView_inventory_unapproved%"), b = ee(n, "%webView_inventory_unknown%"), f = ee(n, "%webView_inventory_scope_currentBook%"), h = ee(n, "%webView_inventory_scope_chapter%"), k = ee(n, "%webView_inventory_scope_verse%"), _ = ee(n, "%webView_inventory_filter_text%"), C = ee(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, v] = st(!1), [P, L] = st("all"), [Y, O] = st(""), [$, T] = st([]), D = Tt(() => l ? r instanceof RegExp ? id(
    l,
    t,
    a,
    s,
    ...
    const x = [];
    return D.forEach((R) => {
      const F = R.items[0], U = x.find(
        (V) => V.items[0] === F
      );
      U ? (U.count += R.count, U.occurrences = U.occurrences.concat(R.occurrences)) : x.push({
        items: [F],
        count: R.count,
  ...
  }, [E, D]), Q = Tt(() => ad(M, P, Y), [M, P, Y]), K = Tt(() => {
    var F, U;
    if (!E)
      return u;
    const x = (F = o == null ? void 0 : o.tableHeaders) == null ? void 0 : F.length;
    if (!x)
      return u;
    const R = [];
    for (let V = 0; V < x; V++)
      R.push(
        od(
          ((U = o == null ? void 0 : o.tableHeaders) == null ? void 0 : U[V]) || "Additional Item",
          V + 1
        )
      );
    return [...R, ...u];
    ...
    /* @__PURE__ */ y("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ y(
        Ue,
        {
          ...
          defaultValue: P,
          children: [
            /* @__PURE__ */ i(Ee, { className: "tw-m-1", children: /* @__PURE__ */ i(Ge, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ y(Ue, { onValueChange: (x) => tt(x), defaultValue: c, children: [
        /* @__PURE__ */ i(Ee, { className: "tw-m-1", children: /* @__PURE__ */ i(Ge, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ y(Te, { children: [
...
Li.displayName = It.List.displayName;
...
Fi.displayName = It.Content.displayName;
function Sh({
  tabList: t,
  onSearch: e,
  searchPlaceholder: n,
...
const le = "scrBook", Rd = "scrRef", he = "source", _d = "details", Pd = "Scripture Reference", $d = "Scripture Book", Zi = "Type", Id = "Details";
function Ad(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ct.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === le ? _r(o.start) : void 0;
      },
...
function Oh({
  ...
  const [d, u] = st([]), [m, w] = st([{ id: le, desc: !1 }]), [g, b] = st({}), f = Tt(
  ...
  }, L = (O, $) => O.getIsGrouped() ? "" : N("banded-row", $ % 2 === 0 ? "even" : "odd"), Y = (O, $, T) => {
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ y(
      Ue,
      {
        ...
        children: [
          /* @__PURE__ */ i(Ee, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ i(Ge, {}) }),
          /* @__PURE__ */ i(Te, { position: "item-aligned", children: /* @__PURE__ */ i(Xc, { children: E.map((O) => /* @__PURE__ */ i(zt, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ y($n, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(In, { children: k.getHeaderGroups().map((O) => /* @__PURE__ */ i(Wt, { children: O.headers.filter(($) => $.column.columnDef.header).map(($) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ i(de, { colSpan: $.colSpan, className: "top-0 tw-sticky", children: $.isPlaceholder ? void 0 : /* @__PURE__ */ y("div", { children: [
      ...
      /* @__PURE__ */ i(An, { children: k.getRowModel().rows.map((O, $) => /* @__PURE__ */ i(
        Wt,
        {
          ...
          children: O.getVisibleCells().map((T) => {
            if (!(T.getIsPlaceholder() || T.column.columnDef.enableGrouping && !T.getIsGrouped() && (T.column.columnDef.id !== he || !n)))
              return /* @__PURE__ */ i(
                Dt,
                {
                  className: N(
    ...
    Ue,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ i(
          ...
          {
            style: { zIndex: 250 },
            children: t.map((a) => /* @__PURE__ */ i(zt, { value: `${a}`, children: o[ft(a)] }, `${a}`))
          }
        )
      ]
    }
...
function ne(t, e, n = {
  ...
  return ve(t) && ve(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ve(e[o]) && o in t && ve(t[o]) ? r[o] = ne(t[o], e[o], n) : n.clone ? r[o] = ve(e[o]) ? ts(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
...
function zd() {
  return va || (va = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var v = c, P = d, L = l, Y = s, O = e, $ = u, T = r, D = b, M = g, Q = n, K = a, G = o, tt = m, ot = !1;
    function at(A) {
    ...
    ut.AsyncMode = v, ut.ConcurrentMode = P, ut.ContextConsumer = L, ut.ContextProvider = Y, ut.Element = O, ut.ForwardRef = $, ut.Fragment = T, ut.Lazy = D, ut.Memo = M, ut.Portal = Q, ut.Profiler = K, ut.StrictMode = G, ut.Suspense = tt, ut.isAsyncMode = at, ut.isConcurrentMode = x, ut.isContextConsumer = R, ut.isContextProvider = F, ut.isElement = U, ut.isForwardRef = V, ut.isFragment = J, ut.isLazy = W, ut.isMemo = q, ut.isPortal = X, ut.isProfiler = Z, ut.isStrictMode = H, ut.isSuspense = lt, ut.isValidElementType = C, ut.typeOf = E;
  }()), ut;
}
var ya;
function es() {
...
function Ud() {
  ...
  return zr = function(l, c) {
      ...
      function U(J, W, q, X, Z, H, lt) {
        if (X = X || w, H = H || q, lt !== n) {
          if (c) {
            ...
            F < 3 && (a(
              "You are manually calling a React.PropTypes validation function for the `" + H + "` prop on `" + X + "`. This is deprecated and will throw in the standalone `prop-types` package. You may be seeing this warning due to a third-party PropTypes library. See https://fb.me/react-warning-dont-call-proptypes for details."
            ), R[Et] = !0, F++);
          }
        }
        return W[q] == null ? J ? W[q] === null ? new f("The " + Z + " `" + H + "` is marked as required " + ("in `" + X + "`, but its value is `null`.")) : new f("The " + Z + " `" + H + "` is marked as required in " + ("`" + X + "`, but its value is `undefined`.")) : null : x(W, q, X, Z, H);
      }
      var V = U.bind(null, !1);
      return V.isRequired = U.bind(null, !0), V;
    }
    function k(x) {
      function R(F, U, V, J, W, q) {
        var X = F[U], Z = G(X);
        if (Z !== x) {
          var H = tt(X);
          return new f(
            "Invalid " + J + " `" + W + "` of type " + ("`" + H + "` supplied to `" + V + "`, expected ") + ("`" + x + "`."),
            { expectedType: x }
          );
        }
        return null;
    ...
    function C(x) {
      function R(F, U, V, J, W) {
        if (typeof x != "function")
          return new f("Property `" + W + "` of component `" + V + "` has invalid PropType notation inside arrayOf.");
        var q = F[U];
        if (!Array.isArray(q)) {
          var X = G(q);
          return new f("Invalid " + J + " `" + W + "` of type " + ("`" + X + "` supplied to `" + V + "`, expected an array."));
        }
        for (var Z = 0; Z < q.length; Z++) {
          var H = x(q, Z, V, J, W + "[" + Z + "]", n);
    ...
    function E() {
      function x(R, F, U, V, J) {
        var W = R[F];
        if (!l(W)) {
          var q = G(W);
          return new f("Invalid " + V + " `" + J + "` of type " + ("`" + q + "` supplied to `" + U + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(x);
    ...
    function v() {
      function x(R, F, U, V, J) {
        ...
        if (!t.isValidElementType(W)) {
          var q = G(W);
          return new f("Invalid " + V + " `" + J + "` of type " + ("`" + q + "` supplied to `" + U + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(x);
    ...
    function P(x) {
      function R(F, U, V, J, W) {
        if (!(F[U] instanceof x)) {
          var q = x.name || w, X = at(F[U]);
          return new f("Invalid " + J + " `" + W + "` of type " + ("`" + X + "` supplied to `" + V + "`, expected ") + ("instance of `" + q + "`."));
        }
        return null;
      }
      return h(R);
    ...
    function L(x) {
      ...
      function R(F, U, V, J, W) {
        for (var q = F[U], X = 0; X < x.length; X++)
          if (b(q, x[X]))
            return null;
        ...
        return new f("Invalid " + J + " `" + W + "` of value `" + String(q) + "` " + ("supplied to `" + V + "`, expected one of " + Z + "."));
      }
      return h(R);
    }
    function Y(x) {
      function R(F, U, V, J, W) {
        if (typeof x != "function")
          return new f("Property `" + W + "` of component `" + V + "` has invalid PropType notation inside objectOf.");
        var q = F[U], X = G(q);
        if (X !== "object")
          return new f("Invalid " + J + " `" + W + "` of type " + ("`" + X + "` supplied to `" + V + "`, expected an object."));
        for (var Z in q)
          if (r(q, Z)) {
            var H = x(q, Z, V, J, W + "." + Z, n);
            if (H instanceof Error)
    ...
    function O(x) {
      ...
      for (var R = 0; R < x.length; R++) {
        ...
        if (typeof F != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ot(F) + " at index " + R + "."
          ), s;
      }
      function U(V, J, W, q, X) {
        for (var Z = [], H = 0; H < x.length; H++) {
          var lt = x[H], A = lt(V, J, W, q, X, n);
          if (A == null)
            return null;
          A.data && r(A.data, "expectedType") && Z.push(A.data.expectedType);
        }
        var Et = Z.length > 0 ? ", expected one of type [" + Z.join(", ") + "]" : "";
        return new f("Invalid " + q + " `" + X + "` supplied to " + ("`" + W + "`" + Et + "."));
      }
      return h(U);
    }
    function $() {
      function x(R, F, U, V, J) {
        return Q(R[F]) ? null : new f("Invalid " + V + " `" + J + "` supplied to " + ("`" + U + "`, expected a ReactNode."));
      }
      return h(x);
    }
    function T(x, R, F, U, V) {
      return new f(
        (x || "React class") + ": " + R + " type `" + F + "." + U + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + V + "`."
      );
    }
    function D(x) {
      function R(F, U, V, J, W) {
        var q = F[U], X = G(q);
        if (X !== "object")
          return new f("Invalid " + J + " `" + W + "` of type `" + X + "` " + ("supplied to `" + V + "`, expected `object`."));
        for (var Z in x) {
          var H = x[Z];
          if (typeof H != "function")
            return T(V, J, W, Z, tt(H));
          var lt = H(q, Z, V, J, W + "." + Z, n);
          if (lt)
            return lt;
        }
        return null;
      ...
      function R(F, U, V, J, W) {
        ...
        for (var H in Z) {
          ...
          if (r(x, H) && typeof lt != "function")
            return T(V, J, W, H, tt(lt));
          if (!lt)
            return new f(
              "Invalid " + J + " `" + W + "` key `" + H + "` supplied to `" + V + "`.\nBad object: " + JSON.stringify(F[U], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(x), null, "  ")
            );
          var A = lt(q, H, V, J, W + "." + H, n);
          if (A)
            return A;
        }
        return null;
...
function Zd() {
  return Oa || (Oa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var P = s, L = a, Y = t, O = c, $ = n, T = w, D = m, M = e, Q = o, K = r, G = d, tt = u, ot = !1, at = !1;
    function x(B) {
    ...
    wt.ContextConsumer = P, wt.ContextProvider = L, wt.Element = Y, wt.ForwardRef = O, wt.Fragment = $, wt.Lazy = T, wt.Memo = D, wt.Portal = M, wt.Profiler = Q, wt.StrictMode = K, wt.Suspense = G, wt.SuspenseList = tt, wt.isAsyncMode = x, wt.isConcurrentMode = R, wt.isContextConsumer = F, wt.isContextProvider = U, wt.isElement = V, wt.isForwardRef = J, wt.isFragment = W, wt.isLazy = q, wt.isMemo = X, wt.isPortal = Z, wt.isProfiler = H, wt.isStrictMode = lt, wt.isSuspense = A, wt.isSuspenseList = Et, wt.isValidElementType = E, wt.typeOf = v;
  }()), wt;
}
...
function Cu(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = Ct(t, Tu), a = Su(e), s = Object.keys(a);
  function l(w) {
...
const Ou = {
  borderRadius: 4
}, Ru = Ou, _u = process.env.NODE_ENV !== "production" ? p.oneOfType([p.number, p.string, p.object, p.array]) : {}, ue = _u;
function gn(t, e) {
  return e ? ne(t, e, {
    clone: !1
...
function kt(t) {
  const {
    ...
    return re(s, l, (m) => {
      let w = rr(d, o, m);
      return m === w && typeof m == "string" && (w = rr(d, o, `${e}${m === "default" ? "" : Zt(m)}`, m)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
yt.propTypes = process.env.NODE_ENV !== "production" ? mr.reduce((t, e) => (t[e] = ue, t), {}) : {};
yt.filterProps = mr;
function xt(t) {
  return hs(t, hr);
}
xt.propTypes = process.env.NODE_ENV !== "production" ? hr.reduce((t, e) => (t[e] = ue, t), {}) : {};
xt.filterProps = hr;
process.env.NODE_ENV !== "production" && Bu.reduce((t, e) => (t[e] = ue, t), {});
function zu(t = 8) {
  if (t.mui)
    return t;
  const e = ms({
...
const Lu = Ht("border", Lt), Fu = Ht("borderTop", Lt), Uu = Ht("borderRight", Lt), Gu = Ht("borderBottom", Lt), Hu = Ht("borderLeft", Lt), Xu = Ht("borderColor"), Yu = Ht("borderTopColor"), Wu = Ht("borderRightColor"), qu = Ht("borderBottomColor"), Ku = Ht("borderLeftColor"), Ju = Ht("outline", Lt), Zu = Ht("outlineColor"), br = (t) => {
...
function yp() {
  function t(n, r, o, a) {
    ...
    return m ? m(s) : re(s, r, (b) => {
      let f = rr(w, u, b);
      return b === f && typeof b == "string" && (f = rr(w, u, `${n}${b === "default" ? "" : Zt(b)}`, b)), c === !1 ? f : {
        [c]: f
      };
    });
  }
...
function Do(t = {}, ...e) {
  ...
  return d.applyStyles = xp, d = e.reduce((u, m) => ne(u, m), d), d.unstable_sxConfig = I({}, Ao, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return Mo({
      sx: m,
      theme: this
    });
...
function $p(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const _ = Wl(s, I({
      shouldForwardProp: k,
      label: h
    }, g)), C = (v) => typeof v == "function" && v.__emotion_real !== v || ve(v) ? (P) => Zn(v, I({}, P, {
      theme: Xn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let T;
        c && (T = `${c}${Zt(d || "")}`), T === void 0 && (T = `Styled(${eu(s)})`), $.displayName = T;
      }
...
function ys(t, e) {
  return t = Ce(t), e = Bo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, Nr(t);
}
function Bp(t, e) {
  if (t = Ce(t), e = Bo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
function nw(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Ct(t, qp), a = t.primary || Kp(e), s = t.secondary || Jp(e), l = t.error || Zp(e), c = t.info || Qp(e), d = t.success || tw(e), u = t.warning || ew(e);
  function m(f) {
...
const theme2 = createTheme({ palette: {
  ...
  return process.env.NODE_ENV !== "production" && (g[e] || console.error(`MUI: The palette mode \`${e}\` is not supported.`)), ne(I({
...
const Ew = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Tw = (t) => {
  ...
  const r = zo({
    ...
    titleAccess: m,
    viewBox: w = "0 0 24 24"
  } = r, g = Ct(r, Ew), b = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", f = I({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function zw(t) {
  ...
  if (!e) {
    const g = xe(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), b = I({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = I({}, n, o, r);
    return g.length > 0 && (f.className = g), Object.keys(b).length > 0 && (f.style = b), {
      props: f,
      internalRef: void 0
    };
  }
  const s = jw(I({}, o, r)), l = Ya(r), c = Ya(o), d = e(s), u = xe(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = I({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = I({}, d, n, c, l);
...
var _t = "top", Ut = "bottom", Gt = "right", Pt = "left", Fo = "auto", Vn = [_t, Ut, Gt, Pt], Ye = "start", En = "end", Yw = "clippingParents", Ts = "viewport", cn = "popper", Ww = "reference", Wa = /* @__PURE__ */ Vn.reduce(function(t, e) {
...
function af(t) {
  ...
  Object.keys(e.elements).forEach(function(n) {
    ...
    !Ft(a) || !Qt(a) || (Object.assign(a.style, r), Object.keys(o).forEach(function(s) {
      var l = o[s];
...
function sf(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Ft(o) || !Qt(o) || (Object.assign(o.style, l), Object.keys(a).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
var Ne = Math.max, ar = Math.min, We = Math.round;
function oo() {
...
function qe(t, e, n) {
  ...
  e && Ft(t) && (o = t.offsetWidth > 0 && We(r.width) / t.offsetWidth || 1, a = t.offsetHeight > 0 && We(r.height) / t.offsetHeight || 1);
  var s = Oe(t) ? jt(t) : window, l = s.visualViewport, c = !Cs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / a, m = r.width / o, w = r.height / a;
  return {
    width: m,
    height: w,
    top: u,
...
function df(t) {
  ...
  var o = kr(t);
  for (Uo(o) && (o = o.host); Ft(o) && ["html", "body"].indexOf(Qt(o)) < 0; ) {
    var a = oe(o);
...
function zn(t) {
  for (var e = jt(t), n = qa(t); n && cf(n) && oe(n).position === "static"; )
    n = qa(n);
  return n && (Qt(n) === "html" || Qt(n) === "body" && oe(n).position === "static") ? e : n || df(t) || e;
}
function Ho(t) {
...
function wf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = qt(n.placement), c = Ho(l), d = [Pt, Gt].indexOf(l) >= 0, u = d ? "height" : "width";
  if (!(!a || !s)) {
    var m = pf(o.padding, n), w = Go(a), g = c === "y" ? _t : Pt, b = c === "y" ? Ut : Gt, f = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], k = zn(a), _ = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - h / 2, E = m[g], v = _ - w[u] - m[b], P = _ / 2 - w[u] / 2 + C, L = bn(E, P, v), Y = c;
    n.modifiersData[r] = (e = {}, e[Y] = L, e.centerOffset = L - P, e);
  }
}
function ff(t) {
...
function Ka(t) {
  ...
  g = h.x, f = h.y;
  var k = s.hasOwnProperty("x"), _ = s.hasOwnProperty("y"), C = Pt, E = _t, v = window;
  if (d) {
    var P = zn(n), L = "clientHeight", Y = "clientWidth";
    if (P === jt(n) && (P = pe(n), oe(P).position !== "static" && l === "absolute" && (L = "scrollHeight", Y = "scrollWidth")), P = P, o === _t || (o === Pt || o === Gt) && a === En) {
      E = Ut;
...
function Yo(t) {
  return qe(pe(t)).left + Xo(t).scrollLeft;
}
function Ef(t, e) {
...
function Tf(t) {
  var e, n = pe(t), r = Xo(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = Ne(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = Ne(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Yo(t), c = -r.scrollTop;
  return oe(o || n).direction === "rtl" && (l += Ne(n.clientWidth, o ? o.clientWidth : 0) - a), {
    width: a,
    height: s,
    x: l,
    y: c
...
function $s(t) {
  return ["html", "body", "#document"].indexOf(Qt(t)) >= 0 ? t.ownerDocument.body : Ft(t) && Wo(t) ? t : $s(kr(t));
}
function vn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = $s(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = jt(r), s = o ? [a].concat(a.visualViewport || [], Wo(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function Za(t, e, n) {
  return e === Ts ? ao(Ef(t, n)) : Oe(e) ? Sf(e, n) : ao(Tf(pe(t)));
}
function Cf(t) {
  var e = vn(kr(t)), n = ["absolute", "fixed"].indexOf(oe(t).position) >= 0, r = n && Ft(t) ? zn(t) : t;
  return Oe(r) ? e.filter(function(o) {
    return Oe(o) && Os(o, r) && Qt(o) !== "body";
  }) : [];
}
function Of(t, e, n, r) {
  var o = e === "clippingParents" ? Cf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var u = Za(t, d, r);
    return c.top = Ne(u.top, c.top), c.right = ar(u.right, c.right), c.bottom = ar(u.bottom, c.bottom), c.left = Ne(u.left, c.left), c;
  }, Za(t, s, r));
...
function Tn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Yw : l, d = n.rootBoundary, u = d === void 0 ? Ts : d, m = n.elementContext, w = m === void 0 ? cn : m, g = n.altBoundary, b = g === void 0 ? !1 : g, f = n.padding, h = f === void 0 ? 0 : f, k = _s(typeof h != "number" ? h : Ps(h, Vn)), _ = w === cn ? Ww : cn, C = t.rects.popper, E = t.elements[b ? _ : w], v = Of(Oe(E) ? E : E.contextElement || pe(t.elements.popper), c, u, s), P = qe(t.elements.reference), L = Is({
    reference: P,
    element: C,
    strategy: "absolute",
    placement: o
  }), Y = ao(Object.assign({}, C, L)), O = w === cn ? Y : P, $ = {
  ...
  if (w === cn && T) {
    ...
    Object.keys($).forEach(function(M) {
      var Q = [Gt, Ut].indexOf(M) >= 0 ? 1 : -1, K = [_t, Ut].indexOf(M) >= 0 ? "y" : "x";
      $[M] += D[K] * Q;
    });
  }
  return $;
...
function Pf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, m = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, b = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, h = e.options.placement, k = qt(h), _ = k === h, C = c || (_ || !b ? [Qn(h)] : _f(h)), E = [h].concat(C).reduce(function(V, J) {
      return V.concat(qt(J) === Fo ? Rf(e, {
        placement: J,
        boundary: u,
        rootBoundary: m,
        padding: d,
    ...
    }, []), v = e.rects.reference, P = e.rects.popper, L = /* @__PURE__ */ new Map(), Y = !0, O = E[0], $ = 0; $ < E.length; $++) {
      var T = E[$], D = qt(T), M = Ke(T) === Ye, Q = [_t, Ut].indexOf(D) >= 0, K = Q ? "width" : "height", G = Tn(e, {
        placement: T,
        boundary: u,
        rootBoundary: m,
        altBoundary: w,
        padding: d
      }), tt = Q ? M ? Gt : Pt : M ? Ut : _t;
      v[K] > P[K] && (tt = Qn(tt));
      var ot = Qn(tt), at = [];
      if (a && at.push(G[D] <= 0), l && at.push(G[tt] <= 0, G[ot] <= 0), at.every(function(V) {
        return V;
      })) {
        O = T, Y = !1;
        break;
    ...
    if (Y)
      for (var x = b ? 3 : 1, R = function(J) {
        var W = E.find(function(q) {
          var X = L.get(q);
          if (X)
            return X.slice(0, J).every(function(Z) {
              return Z;
            });
        });
        if (W)
...
function ti(t) {
  return [_t, Gt, Ut, Pt].some(function(e) {
    return t[e] >= 0;
  });
}
function If(t) {
...
function Mf(t, e, n) {
  var r = qt(t), o = [Pt, _t].indexOf(r) >= 0 ? -1 : 1, a = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, s = a[0], l = a[1];
  return s = s || 0, l = (l || 0) * o, [Pt, Gt].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function Lf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, m = n.padding, w = n.tether, g = w === void 0 ? !0 : w, b = n.tetherOffset, f = b === void 0 ? 0 : b, h = Tn(e, {
    ...
    padding: m,
    altBoundary: u
  }), k = qt(e.placement), _ = Ke(e.placement), C = !_, E = Ho(k), v = zf(E), P = e.modifiersData.popperOffsets, L = e.rects.reference, Y = e.rects.popper, O = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, $ = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if (P) {
    if (a) {
      var M, Q = E === "y" ? _t : Pt, K = E === "y" ? Ut : Gt, G = E === "y" ? "height" : "width", tt = P[E], ot = tt + h[Q], at = tt - h[K], x = g ? -Y[G] / 2 : 0, R = _ === Ye ? L[G] : Y[G], F = _ === Ye ? -Y[G] : -L[G], U = e.elements.arrow, V = g && U ? Go(U) : {
        width: 0,
        height: 0
      }, J = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Rs(), W = J[Q], q = J[K], X = bn(0, L[G], V[G]), Z = C ? L[G] / 2 - x - X - W - $.mainAxis : R - X - W - $.mainAxis, H = C ? -L[G] / 2 + x + X + q + $.mainAxis : F + X + q + $.mainAxis, lt = e.elements.arrow && zn(e.elements.arrow), A = lt ? E === "y" ? lt.clientTop || 0 : lt.clientLeft || 0 : 0, Et = (M = T == null ? void 0 : T[E]) != null ? M : 0, B = tt + Z - Et - A, z = tt + H - Et, rt = bn(g ? ar(ot, B) : ot, tt, g ? Ne(at, z) : at);
      P[E] = rt, D[E] = rt - tt;
    }
    if (l) {
      var bt, vt = E === "x" ? _t : Pt, se = E === "x" ? Ut : Gt, Xt = P[v], Pe = v === "y" ? "height" : "width", we = Xt + h[vt], $e = Xt - h[se], Ie = [_t, Pt].indexOf(k) !== -1, Ae = (bt = T == null ? void 0 : T[v]) != null ? bt : 0, fe = Ie ? we : Xt - L[Pe] - Y[Pe] - Ae + $.altAxis, tn = Ie ? Xt + L[Pe] + Y[Pe] - Ae - $.altAxis : $e, Ln = g && Ie ? uf(fe, Xt, tn) : bn(g ? fe : we, Xt, g ? tn : $e);
      P[v] = Ln, D[v] = Ln - Xt;
    }
    e.modifiersData[r] = D;
  }
...
function Xf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && Hf(e), a = pe(e), s = qe(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Wo(a)) && (l = Gf(e)), Ft(e) ? (c = qe(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Yo(a))), {
    ...
    var u = {
      ...
      setOptions: function(k) {
        ...
        f(), u.options = Object.assign({}, a, u.options, _), u.scrollParents = {
          reference: Oe(l) ? vn(l) : l.contextElement ? vn(l.contextElement) : [],
          popper: vn(c)
        };
        ...
        if (!w) {
          ...
          if (ni(_, C)) {
            ...
            for (var E = 0; E < u.orderedModifiers.length; E++) {
              ...
              var v = u.orderedModifiers[E], P = v.fn, L = v.options, Y = L === void 0 ? {} : L, O = v.name;
...
const am = () => Po({
  ...
  } = e, h = Ct(e, em), k = j.useRef(null), _ = Se(k, n), C = j.useRef(null), E = Se(C, w), v = j.useRef(E);
  Xe(() => {
    v.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const P = rm(u, s), [L, Y] = j.useState(P), [O, $] = j.useState(ir(o));
  j.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, _ = Ct(e, nm), [C, E] = j.useState(!0), v = () => {
    E(!1);
  }, P = () => {
    E(!0);
  };
...
var dm = function(e) {
  return e.scrollTop;
}, fn = "unmounted", ge = "exited", be = "entering", Le = "entered", so = "exiting", ie = /* @__PURE__ */ function(t) {
  lm(e, t);
  function e(r, o) {
    var a;
    a = t.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = ge, a.appearStatus = be) : c = Le : r.unmountOnExit || r.mountOnEnter ? c = fn : c = ge, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== be && s !== Le && (a = be) : (s === be || s === Le) && (a = so);
    }
    ...
    var l = Ct(a, ["children", "in", "mountOnEnter", "unmountOnExit", "appear", "enter", "exit", "timeout", "addEndListener", "onEnter", "onEntering", "onEntered", "onExit", "onExiting", "onExited", "nodeRef"]);
    return (
...
const fm = {
  ...
  const {
  ...
  } = e, k = Ct(e, wm), _ = pn(), C = j.useRef(), E = Ds(), v = j.useRef(null), P = Se(v, a.ref, n), L = (K) => (G) => {
    if (K) {
      const tt = v.current;
      G === void 0 ? K(tt) : K(tt, G);
    }
  }, Y = L(u), O = L((K, G) => {
    pm(K);
    const {
    ...
    let at;
    f === "auto" ? (at = E.transitions.getAutoHeightDuration(K.clientHeight), C.current = at) : at = G, K.style.transition = [E.transitions.create("opacity", {
      duration: at,
      delay: tt
    }), E.transitions.create("transform", {
  ...
  return /* @__PURE__ */ i(h, I({
    ...
    children: (K, G) => /* @__PURE__ */ j.cloneElement(a, I({
      style: I({
        opacity: 0,
        transform: lo(0.75),
...
const ai = qo, mm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], hm = jn(Ms, {
  ...
  const o = bs(), a = zo({
    ...
    slots: C,
    slotProps: E
  } = a, v = Ct(a, mm), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, L = I({
    anchorEl: s,
    container: u,
    disablePortal: m,
    keepMounted: w,
...
const bm = fs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ce = bm, vm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function ym(t) {
  return Math.round(t * 1e5) / 1e5;
}
const xm = (t) => {
  ...
  [`&[data-popper-placement*="right"] .${ce.arrow}`]: I({}, e.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${ce.arrow}`]: I({}, e.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  [`.${ce.popper}[data-popper-placement*="left"] &`]: I({
  ...
  [`.${ce.popper}[data-popper-placement*="right"] &`]: I({
  ...
  [`.${ce.popper}[data-popper-placement*="top"] &`]: I({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, e.touch && {
    marginBottom: "24px"
  }),
  [`.${ce.popper}[data-popper-placement*="bottom"] &`]: I({
...
const zs = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const P = zo({
    ...
    TransitionProps: Et
  } = P, B = Ct(P, vm), z = /* @__PURE__ */ j.isValidElement(Y) ? Y : /* @__PURE__ */ i("span", {
    children: Y
  }), rt = Ds(), bt = rt.direction === "rtl", [vt, se] = j.useState(), [Xt, Pe] = j.useState(null), we = j.useRef(!1), $e = Q || at, Ie = pn(), Ae = pn(), fe = pn(), tn = pn(), [Ln, Ko] = cs({
    controlled: J,
    default: !1,
    name: "Tooltip",
    state: "open"
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    j.useEffect(() => {
      vt && vt.disabled && !et && lt !== "" && vt.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [lt, vt, et]);
  }
  ...
  const Jo = (et) => {
    ...
    (et) => {
      ii.start(800 + R, () => {
        Wn = !1;
      }), Ko(!1), U && te && U(et), Ie.start(rt.transitions.duration.shortest, () => {
        we.current = !1;
      });
    }
  ), Sr = (et) => {
    we.current && et.type !== "touchstart" || (vt && vt.removeAttribute("title"), Ae.clear(), fe.clear(), G || Wn && tt ? Ae.start(Wn ? tt : G, () => {
      Jo(et);
    }) : Jo(et));
  }, Zo = (et) => {
    Ae.clear(), fe.start(R, () => {
    ...
    onFocus: Js,
    ref: Zs
  } = ds(), [, ta] = j.useState(!1), ea = (et) => {
    Ks(et), Qo.current === !1 && (ta(!1), Zo(et));
  }, na = (et) => {
    vt || se(et.currentTarget), Js(et), Qo.current === !0 && (ta(!0), Sr(et));
  }, ra = (et) => {
    we.current = !0;
    const At = z.props;
    At.onTouchStart && At.onTouchStart(et);
  }, oa = Sr, aa = Zo, Qs = (et) => {
    ra(et), fe.clear(), Ie.clear(), Fn(), en.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", tn.start(ot, () => {
      document.body.style.WebkitUserSelect = en.current, Sr(et);
    });
  }, tl = (et) => {
    z.props.onTouchEnd && z.props.onTouchEnd(et), Fn(), fe.start(F, () => {
      Un(et);
    });
  };
  j.useEffect(() => {
  ...
  const el = Se(z.ref, Zs, se, n);
  !lt && lt !== 0 && (te = !1);
  const Cr = j.useRef(), nl = (et) => {
    const At = z.props;
    At.onMouseMove && At.onMouseMove(et), dn = {
      x: et.clientX,
      y: et.clientY
    }, Cr.current && Cr.current.update();
  }, nn = {}, Or = typeof lt == "string";
  T ? (nn.title = !te && Or && !M ? lt : null, nn["aria-describedby"] = te ? Tr : null) : (nn["aria-label"] = Or ? lt : null, nn["aria-labelledby"] = te && !Or ? Tr : null);
  const Vt = I({}, nn, B, z.props, {
    className: xe(B.className, z.props.className),
    onTouchStart: ra,
    ref: el
  }, at ? {
    onMouseMove: nl
  } : {});
  process.env.NODE_ENV !== "production" && (Vt["data-mui-internal-clone-element"] = !0, j.useEffect(() => {
    vt && !vt.getAttribute("data-mui-internal-clone-element") && console.error(["MUI: The `children` component of the Tooltip is not forwarding its props correctly.", "Please make sure that props are spread on the same element that the ref is applied to."].join(`
`));
  }, [vt]));
  const rn = {};
  K || (Vt.onTouchStart = Qs, Vt.onTouchEnd = tl), M || (Vt.onMouseOver = qn(oa, Vt.onMouseOver), Vt.onMouseLeave = qn(aa, Vt.onMouseLeave), $e || (rn.onMouseOver = oa, rn.onMouseLeave = aa)), D || (Vt.onFocus = qn(na, Vt.onFocus), Vt.onBlur = qn(ea, Vt.onBlur), $e || (rn.onFocus = na, rn.onBlur = ea)), process.env.NODE_ENV !== "production" && z.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${z.props.title}\` or the Tooltip component.`].join(`
`));
  const rl = j.useMemo(() => {
    var et;
    let At = [{
    ...
    return (et = X.popperOptions) != null && et.modifiers && (At = At.concat(X.popperOptions.modifiers)), I({}, X.popperOptions, {
      modifiers: At
    });
  }, [Xt, X]), on = I({}, P, {
    isRtl: bt,
    ...
    touch: we.current
  }), Rr = xm(on), ia = (r = (o = H.popper) != null ? o : O.Popper) != null ? r : Nm, sa = (a = (s = (l = H.transition) != null ? l : O.Transition) != null ? s : A) != null ? a : ai, la = (c = (d = H.tooltip) != null ? d : O.Tooltip) != null ? c : km, ca = (u = (m = H.arrow) != null ? m : O.Arrow) != null ? u : Em, ol = wn(ia, I({}, X, (w = Z.popper) != null ? w : $.popper, {
    className: xe(Rr.popper, X == null ? void 0 : X.className, (g = (b = Z.popper) != null ? b : $.popper) == null ? void 0 : g.className)
  }), on), al = wn(sa, I({}, Et, (f = Z.transition) != null ? f : $.transition), on), il = wn(la, I({}, (h = Z.tooltip) != null ? h : $.tooltip, {
    className: xe(Rr.tooltip, (k = (_ = Z.tooltip) != null ? _ : $.tooltip) == null ? void 0 : k.className)
  }), on), sl = wn(ca, I({}, (C = Z.arrow) != null ? C : $.arrow, {
    className: xe(Rr.arrow, (E = (v = Z.arrow) != null ? v : $.arrow) == null ? void 0 : E.className)
  }), on);
  return /* @__PURE__ */ y(j.Fragment, {
    children: [/* @__PURE__ */ j.cloneElement(z, Vt), /* @__PURE__ */ i(ia, I({
      as: q ?? Vs,
      placement: W,
      anchorEl: at ? {
      ...
      children: ({
        ...
        timeout: rt.transitions.duration.shorter
      }, et, al, {
        children: /* @__PURE__ */ y(la, I({}, il, {
          children: [lt, L ? /* @__PURE__ */ i(ca, I({}, sl, {
            ref: Pe
          })) : null]
        }))
      }))
...
function Im({
  ...
  Kt(() => {
    if (c) {
      ...
      if (E) {
        const v = E.getBoundingClientRect(), P = window.scrollY, L = window.scrollX, Y = v.top + P + E.clientHeight, O = v.left + L;
        h({ top: Y, left: O });
      }
    }
  }, [c, o]);
  const [k] = co(
    Ot(async () => (t == null ? void 0 : t(!1)) ?? e, [t, e, c]),
    e
  ), [_] = co(
    Ot(async () => (t == null ? void 0 : t(!0)) ?? n ?? k, [t, n, k, c]),
    n ?? k
  ), C = u && _ ? _ : k;
  return /* @__PURE__ */ y(ae, { children: [
    /* @__PURE__ */ i(
...
const _e = sr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Cl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
const jh = It.Root, Fm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.List,
  {
    ref: n,
    className: N(
...
Fm.displayName = It.List.displayName;
...
Um.displayName = It.Trigger.displayName;
...
Gm.displayName = It.Content.displayName;
function Vh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ i(
    mt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(_e, { size: 15 }) : /* @__PURE__ */ y(ae, { children: [
...
}, ci = (t, e, n) => /* @__PURE__ */ i(mt, { variant: "outline", onClick: () => n(t.dblEntryUid, "install"), children: e }), qm = (t, e, n, r, o, a) => e.includes(t.dblEntryUid) ? /* @__PURE__ */ i(mt, { variant: "outline", children: /* @__PURE__ */ i(_e, { className: "tw-h-5 tw-py-[1px]" }) }) : t.installed ? t.updateAvailable ? ci(t, r, a) : /* @__PURE__ */ i(St, { className: "tw-my-2 tw-flex tw-h-6 tw-items-center", children: o }) : ci(t, n, a);
function qh({
  localizedStrings: t,
  resources: e,
  ...
  const m = t["%resources_action%"], w = t["%resources_any%"], g = t["%resources_dialog_subtitle%"], b = t["%resources_dialog_title%"], f = t["%resources_filterInput%"], h = t["%resources_filterBy%"], k = t["%resources_fullName%"], _ = t["%resources_get%"], C = t["%resources_installed%"], E = t["%resources_language%"], v = t["%resources_languages%"], P = t["%resources_loadingResources%"], L = t["%resources_noResults%"], Y = t["%resources_open%"], O = t["%resources_remove%"], $ = t["%resources_results%"], T = t["%resources_showing%"], D = t["%resources_size%"], M = t["%resources_type%"], Q = t["%resources_types%"], K = t["%resources_type_DBL%"], G = t["%resources_type_ER%"], tt = t["%resources_type_SLR%"], ot = t["%resources_type_XR%"], at = t["%resources_type_unknown%"], x = t["%resources_update%"], [R, F] = st([]), U = (z, rt) => {
    if (!c || !d)
      return;
    const bt = {
      dblEntryUid: z,
      action: rt === "install" ? "installing" : "removing"
    };
    F((se) => [...se, bt]), (rt === "install" ? c : d)(z).catch((se) => {
      console.debug(Ul(se));
    });
  };
  Kt(() => {
    F(
      (z) => z.filter((rt) => {
        const bt = e.find((vt) => vt.dblEntryUid === rt.dblEntryUid);
        return bt ? !(rt.action === "installing" && bt.installed || rt.action === "removing" && !bt.installed) : !0;
      })
    );
  }, [e]);
  const [V, J] = st(""), W = Tt(() => e.filter((z) => {
    const rt = V.toLowerCase();
    return z.displayName.toLowerCase().includes(rt) || z.fullName.toLowerCase().includes(rt) || z.bestLanguageName.toLowerCase().includes(rt);
  }), [e, V]), q = Tt(() => [
    { value: "DBLResource", label: K },
    { value: "EnhancedResource", label: G },
    { value: "SourceLanguageResource", label: tt },
    { value: "XmlResource", label: ot }
  ], [K, G, tt, ot]), X = Tt(() => W.filter((z) => r.includes(z.type)), [W, r]);
  Kt(() => {
    a.length === 0 && s(
      Array.from(
        new Set(
          e.filter((z) => z.installed === !0).map((z) => z.bestLanguageName)
        )
      )
    );
  }, [e, a.length, s]);
  const Z = Tt(() => X.filter((z) => a.includes(z.bestLanguageName)), [a, X]), [H, lt] = st({
    key: "bestLanguageName",
    direction: "ascending"
  }), A = Tt(() => [...Z].sort((z, rt) => {
    let bt, vt;
    return H.key === "action" ? (bt = (z.installed ? 10 : 0) + (z.updateAvailable ? 1 : 0), vt = (rt.installed ? 10 : 0) + (rt.updateAvailable ? 1 : 0)) : (bt = z[H.key], vt = rt[H.key]), bt < vt ? H.direction === "ascending" ? -1 : 1 : bt > vt ? H.direction === "ascending" ? 1 : -1 : 0;
  }), [H.direction, H.key, Z]), Et = (z) => {
    const rt = { key: z, direction: "ascending" };
    H.key === z && H.direction === "ascending" && (rt.direction = "descending"), lt(rt);
  }, B = (z, rt) => /* @__PURE__ */ i(de, { onClick: () => Et(z), children: /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
    rt,
    H.key !== z && /* @__PURE__ */ i(wo, { className: "tw-pl-1", size: 16 }),
    H.key === z && (H.direction === "ascending" ? /* @__PURE__ */ i(pi, { className: "tw-pl-1", size: 16 }) : /* @__PURE__ */ i(Cn, { className: "tw-pl-1", size: 16 }))
  ] }) });
  return /* @__PURE__ */ i("div", { className: u, children: /* @__PURE__ */ y(Gs, { className: "tw-flex tw-h-screen tw-flex-col tw-rounded-none tw-border-0", children: [
    /* @__PURE__ */ i(Hs, { className: "tw-flex-shrink-0", children: /* @__PURE__ */ y("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-gap-2", children: [
        /* @__PURE__ */ i(St, { className: "tw-mb-2", children: h }),
        /* @__PURE__ */ i(
          li,
          {
            entries: q,
    ...
    /* @__PURE__ */ i(Ws, { className: "tw-flex-grow tw-overflow-auto", children: n || !e ? /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-2", children: [
      /* @__PURE__ */ i(St, { children: P }),
      /* @__PURE__ */ i(_e, {})
    ] }) : /* @__PURE__ */ i("div", { children: A.length === 0 ? /* @__PURE__ */ i("div", { className: "tw-m-4 tw-flex tw-justify-center", children: /* @__PURE__ */ i(St, { children: L }) }) : /* @__PURE__ */ y($n, { stickyHeader: !0, children: [
      ...
      /* @__PURE__ */ i(An, { children: A.map((z) => {
        var rt;
        return /* @__PURE__ */ y(Wt, { children: [
          /* @__PURE__ */ i(Dt, { children: /* @__PURE__ */ i(ua, { className: "tw-pr-0", size: 18 }) }),
          /* @__PURE__ */ i(Dt, { children: z.displayName }),
          /* @__PURE__ */ i(Dt, { className: "tw-font-medium", children: z.fullName }),
          /* @__PURE__ */ i(Dt, { children: z.bestLanguageName }),
          /* @__PURE__ */ i(Dt, { children: ((rt = q.find((bt) => bt.value === z.type)) == null ? void 0 : rt.label) ?? at }),
          /* @__PURE__ */ i(Dt, { children: z.size }),
          /* @__PURE__ */ i(Dt, { children: /* @__PURE__ */ y("div", { className: "tw-flex tw-justify-between", children: [
            qm(
              z,
              R.map((bt) => bt.dblEntryUid),
              _,
              x,
              C,
              U
            ),
            z.installed && /* @__PURE__ */ y(cr, { children: [
              ...
              /* @__PURE__ */ y(Rn, { align: "start", children: [
                ...
                /* @__PURE__ */ i(
                  tr,
                  {
                    onClick: () => U(z.dblEntryUid, "remove"),
        ...
        ] }, z.displayName + z.fullName);
      }) })
    ] }) }) }),
    /* @__PURE__ */ i(qs, { className: "tw-flex-shrink-0 tw-justify-center tw-border-t tw-p-2 tw-pt-4", children: A.length > 0 && /* @__PURE__ */ i(St, { children: `${T} ${A.length} ${$}` }) })
  ] }) });
}
const Km = (t, e) => t[e] ?? e;
function Kh({
  ...
  return /* @__PURE__ */ y("div", { className: N("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ y(
      Ue,
      {
        ...
        dir: c,
        children: [
          /* @__PURE__ */ i(Ee, { children: /* @__PURE__ */ i(Ge, {}) }),
          /* @__PURE__ */ i(
            Te,
            {
              className: "tw-z-[250]",
              dir: c,
              children: Object.keys(t).map((b) => /* @__PURE__ */ i(zt, { value: b, children: g(b, e) }, b))
            }
          )
        ]
      }
