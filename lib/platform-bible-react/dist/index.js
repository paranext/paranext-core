...
import { createEditor as So, $getRoot as qt, $createParagraphNode as Nn, $getSelection as Lt, HISTORY_MERGE_TAG as gr, ParagraphNode as To, TextNode as Ro, $isTokenOrSegmented as oi, $getCharacterOffsets as ai, $cloneWithPropertiesEphemeral as si, $findMatchingParent as ii, $isElementNode as we, CLEAR_EDITOR_COMMAND as Do, COMMAND_PRIORITY_EDITOR as Oo, $isRangeSelection as Je, shallowMergeConfig as li, defineExtension as jt, safeCast as nn, RootNode as wi, LineBreakNode as ci, TabNode as di, $isEditorState as pi, createCommand as ui, CLICK_COMMAND as mi, isDOMNode as hi, $getNodeFromDOMNode as fi, $isNodeSelection as gi, $createNodeSelection as bi, $setSelection as vi, COMMAND_PRIORITY_LOW as xi, DecoratorNode as yi, $create as Ni, $getNodeByKey as ki, INDENT_CONTENT_COMMAND as Hr, COMMAND_PRIORITY_CRITICAL as br, KEY_TAB_COMMAND as _i, $createRangeSelection as Ci, $normalizeSelection__EXPERIMENTAL as Ei, OUTDENT_CONTENT_COMMAND as Si, INSERT_TAB_COMMAND as Ti, $isBlockElementNode as hn, $isDecoratorNode as Ri, $isParagraphNode as Di, $isTextNode as fn, SELECTION_CHANGE_COMMAND as Mo, FORMAT_TEXT_COMMAND as Oi, getRegisteredNode as Mi, isHTMLElement as Ii, isDocumentFragment as Xr, isDOMDocumentNode as Ai, ArtificialNode__DO_NOT_USE as Io, $createLineBreakNode as Ao, $isRootOrShadowRoot as Vi, isBlockDomNode as Kr, isInlineDomNode as Ur, $insertNodes as Pi } from "lexical";
...
import { createHeadlessEditor as Po } from "@lexical/headless";
...
import { useReactTable as Lo, getFilteredRowModel as Xi, getSortedRowModel as Bo, getPaginationRowModel as Ki, getCoreRowModel as jo, flexRender as Xe, getGroupedRowModel as Ui, getExpandedRowModel as Yi } from "@tanstack/react-table";
...
const Fo = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = lt();
...
Fo.displayName = Ct.Content.displayName;
...
Ko.displayName = "CommandShortcut";
...
function hp({
  ...
  const w = lt(), [p, m] = D(!1), [f, u] = D(""), [g, N] = D(""), [k, C] = D("books"), [_, x] = D(void 0), [E, I] = D(!1), R = rt(void 0), S = rt(void 0), O = rt(void 0), y = rt(void 0), T = rt({}), V = j(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
    ...
    (v) => {
      const z = k === "chapters" ? _ : M == null ? void 0 : M.book;
      z && (V({
        book: z,
        chapterNum: v,
        verseNum: 1
      }), m(!1), C("books"), x(void 0), N(""));
    },
    [V, k, _, M]
  ), bt = j(
    (v) => {
    ...
    (v) => {
      ...
      if ((k === "chapters" || k === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ct = k === "chapters" ? _ : M == null ? void 0 : M.book;
        if (!ct) return;
        const mt = (() => {
          if (!f) return 1;
          const Be = f.match(/(\d+)$/);
    ...
    const { isLetter: z, isDigit: Z } = Jr(v.key);
    (z || Z) && (v.preventDefault(), N((ct) => ct + v.key), S.current.focus(), I(!1));
  }, []);
  return $t(() => {
    const v = setTimeout(() => {
      if (p && k === "books" && O.current && y.current) {
        const z = O.current, Z = y.current, ct = Z.offsetTop, mt = z.clientHeight, re = Z.clientHeight, It = ct - mt / 2 + re / 2;
        z.scrollTo({
          top: Math.max(0, It),
          behavior: "smooth"
        }), u(or(e.book));
  ...
  }, [k, _, M, e.book, e.chapterNum]), /* @__PURE__ */ d(ge, { open: p, onOpenChange: dt, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
...
), it = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Eo.Root, { ref: n, className: h("pr-twp", kl(), e), ...t }));
...
function ar({
  ...
  const [_, x] = D(!1), E = c ?? l, I = (S) => S.length > 0 && typeof S[0] == "object" && "options" in S[0], R = (S, O) => {
    ...
    /* @__PURE__ */ o(
      ee,
      {
        ...
        children: /* @__PURE__ */ d(Qt, { children: [
          /* @__PURE__ */ o(Ae, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ o(on, { children: f }),
...
function bp({
  ...
  const p = Bn(w, "%webView_bookSelector_currentBook%"), m = Bn(w, "%webView_bookSelector_choose%"), f = Bn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = D(
    "current book"
    /* CURRENT_BOOK */
  ), N = (k) => {
    g(k), e(k);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(it, { className: "tw-ms-1", children: f })
          ] }),
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = ra ? $t : q, cn = { tag: gr };
function Ml({ initialConfig: e, children: t }) {
  const n = $(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Dl(null, r), p = So({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Nn();
            u.append(g);
            const N = ra ? document.activeElement : null;
            (Lt() !== null || N !== null && N === m.getRootElement()) && g.select();
          }
        }, cn);
  ...
  }, []), o(na.Provider, { value: n, children: t });
}
...
function zl() {
  return function(e) {
    const [t] = Mt(), n = $(() => e(t), [t, e]), [r, a] = D(() => n.initialValueFn()), s = rt(r);
    return Bl(() => {
...
function Fl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !oi(t) && r !== null) {
    ...
    if (w || p) {
      ...
      let k, C = 0;
      u ? (C = m > f ? f : m, k = m > f ? m : f) : g ? (C = i ? f : m, k = void 0) : N && (C = 0, k = i ? m : f);
...
function Jl(e) {
  ...
  la(this), K = e, this.f &= -2, 8 & this.f && Tr(this), _n();
}
function Ne(e, t) {
...
ut.prototype.brand = Ul, ut.prototype.h = function() {
  ...
  if (this.g = un, this.f |= 1, this.i > 0 && !ia(this)) return this.f &= -2, !0;
  const e = K;
  try {
    eo(this), K = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, wa(this), eo(this), Ut++;
  const e = K;
...
jt({ build: (e, t, n) => Cn(t), config: nn({ $onClear: ca }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
...
const ir = jt({ build: (e) => pa(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function ua(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = ua(n[a], r[a]);
    return e;
  }
  return t;
}
const Rr = 0, lr = 1, ma = 2, zn = 3, dn = 4, ye = 5, Fn = 6, ze = 7;
function Gn(e) {
  return e.id === Rr;
}
function ha(e) {
...
function Zl(e) {
  return function(t) {
    return t.id === lr;
  }(e) || J(305, String(e.id), String(lr)), Object.assign(e, { id: ma });
}
...
}, name: "@lexical/extension/InitialState", nodes: [wi, Ro, ci, di, To] }), ro = Symbol.for("@lexical/extension/LexicalBuilder");
function oo() {
}
function rw(e) {
  throw e;
    ...
    for (const p of l) {
      ...
      if (m.onError !== void 0 && (t.onError = m.onError), m.disableEvents !== void 0 && (t.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (t.parentEditor = m.parentEditor), m.editable !== void 0 && (t.editable = m.editable), m.namespace !== void 0 && (t.namespace = m.namespace), m.$initialEditorState !== void 0 && (t.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of Wl(m)) {
        if (typeof f != "function") {
          ...
          u && J(302, m.name, f.replace.name, u.extension.name), r.set(f.replace, p);
        }
        n.add(f);
      }
      if (m.html) {
...
const ow = /* @__PURE__ */ new Set(), ao = jt({ build(e, t, n) {
  const r = n.getDependency(ir).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = pa(() => {
  }, () => Wt(() => {
  ...
  return Jt(e.registerCommand(mi, (i) => {
    if (hi(i.target)) {
      ...
      if (sw(l)) return function(c, w = !1) {
        const p = Lt(), m = c.isSelected(), f = c.getKey();
        let u;
    ...
    Yl(() => {
      ...
      for (const [p, m] of i.entries()) if (m === "destroyed") w.delete(p), c = !0;
        ...
        f ? f.domNode.value = u : (c = !0, w.set(p, { domNode: We(u), selectedSignal: r(p) }));
      }
...
function iw(e, t) {
  return Jt(e.registerCommand(_i, (n) => {
    ...
    const a = function(s) {
      ...
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, p = w.getNode(), m = Zr(p);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Ci();
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (Je(g)) {
                ...
                if (fn(k) && w >= 0 && p >= 0 && (C = w, _ = w + p, g.setTextNodeRange(k, C, k, _)), C === _ && m === "" || (g.insertRawText(m), k = N.getNode()), fn(k)) {
                  C = f, _ = f + u;
...
jt({ build: (e, t, n) => Cn(t), config: nn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Wt(() => n.getOutput().disabled.value ? void 0 : ba(e)) });
function pw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : q;
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: N, role: k = "textbox", spellCheck: C = !0, style: _, tabIndex: x, "data-testid": E, ...I }, R) {
  const [S, O] = D(e.isEditable()), y = j((V) => {
  ...
  return va(() => (O(e.isEditable()), e.registerEditableListener((V) => {
    O(V);
  })), [e]), o("div", { "aria-activedescendant": S ? t : void 0, "aria-autocomplete": S ? n : "none", "aria-controls": S ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": S && k === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": S ? m : void 0, "aria-readonly": !S || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: S, "data-testid": E, id: N, ref: T, role: k, spellCheck: C, style: _, tabIndex: x, ...I });
}
const yw = tn(xw);
function io(e) {
  return e.getEditorState().read(ga(e.isComposing()));
...
function Ew({
  ...
  return /* @__PURE__ */ o(xa.Provider, { value: i, children: s });
}
function ya() {
  const e = fr(xa);
  if (!e)
...
function Sw() {
  const [e, t] = D(void 0), n = j(() => {
    ...
    return /* @__PURE__ */ o(nl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Fo, { children: [
      /* @__PURE__ */ o(Go, { children: /* @__PURE__ */ o(Ho, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = j(
    (s, i, l = !1) => {
...
Dw.displayName = Vo.Root.displayName;
...
function Ow() {
  const { activeEditor: e } = ya(), [t, n] = D([]), r = j((a) => {
    if (Je(a) || Gi(a)) {
      const s = [];
      lo.forEach(({ format: i }) => {
...
function Vw(e, t) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Io && i.insertAfter(Ao());
    for (const i of s) {
...
function _a(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], N = _a(e, g, f, r);
    !a && we(t) && N && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ii(p) || Xr(p)) && p.append(f), n.append(p), m) {
      const u = m.call(i, p);
...
function Ea(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  ...
  for (let g = 0; g < m.length; g++) f.push(...Ea(m[g], t, n, u, new Map(a), l));
  return p != null && (f = p(f)), Kr(e) && (f = $w(e, f, u ? () => {
    const g = new Io();
    return n.push(g), g;
  } : Nn)), l == null ? f.length > 0 ? i = i.concat(f) : Kr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Ur(g.nextSibling) && Ur(g.previousSibling);
  }(e) && (i = i.concat(Ao())) : we(l) && l.append(...f), i;
}
function $w(e, t, n) {
...
function Bw(e) {
  ...
  const t = e.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Po({
...
function wo({
  ...
  const [m, f] = D(!1), [u, g] = D(), [N, k] = D(!1), C = rt(null);
  q(() => {
    let y = !0;
    if (!r) {
      k(!1);
    ...
    if (r && N)
      return /* @__PURE__ */ d(at, { children: [
        !Qs(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              f(!0), g(Bw(Gr(e.contents))), c == null || c(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ra, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Da, { className: "tw-text-xs tw-font-medium", children: R }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              onKeyDown: (y) => {
                Sa(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  wr,
        ...
        O && /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(Pe, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(xo, {}) }) }),
...
function Jw({
  ...
  const [C, _] = D(co), [x, E] = D(!1), [I, R] = D(!1), [S, O] = D(!1), [y, T] = D(!1), [V, B] = D(!1), [F, A] = D(void 0), [W, M] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      M(!1), yt(!1);
                    ...
                    /* @__PURE__ */ d(ge, { open: V, onOpenChange: B, children: [
                      /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          ...
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !W || !f || f.length === 0 || !f.includes(s),
                      ...
                      /* @__PURE__ */ o(
                        ee,
                        {
                          ...
                          children: /* @__PURE__ */ o(Qt, { children: /* @__PURE__ */ o(te, { children: f == null ? void 0 : f.map((v) => /* @__PURE__ */ o(
                            zt,
                            {
                              onSelect: () => {
                                A(v !== a ? v : void 0), B(!1);
...
function xp({
  ...
  const [f, u] = D(), g = t.filter(
    ...
    u(R);
  }, []), { listboxRef: _, activeId: x, handleKeyDown: E } = Rl({
    options: N,
    onOptionSelect: k
  }), I = j(
    (R) => {
...
function wc({
  ...
  var R;
  const [p, m] = D([]), [f, u] = D([]), [g, N] = D({}), [k, C] = D({}), _ = $(() => t ?? [], [t]), x = Lo({
    data: _,
    columns: e,
    getCoreRowModel: jo(),
  ...
  return c ? I = Array.from({ length: 10 }).map((y, T) => `skeleton-row-${T}`).map((y) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(pe, { colSpan: E.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, y)) : ((R = x.getRowModel().rows) == null ? void 0 : R.length) > 0 ? I = x.getRowModel().rows.map((S) => /* @__PURE__ */ o(
    ...
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: x.getHeaderGroups().map((S) => /* @__PURE__ */ o(At, { children: S.headers.map((O) => /* @__PURE__ */ o(Qe, { children: O.isPlaceholder ? void 0 : Xe(O.column.columnDef.header, O.getContext()) }, O.id)) }, S.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(yo, {}) })
        ] }),
...
function _p({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(ve, { children: [
    ...
    /* @__PURE__ */ o(ne, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Oa, { children: w.itemType === 0 ? /* @__PURE__ */ o(at, { children: w.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Yt,
        {
          checked: r[p][f],
...
function fc({
  ...
  const s = fo(), [i, l] = D(e), [c, w] = D(n);
  return q(() => {
    l(e);
  }, [e]), q(() => {
    c !== n && w(n);
  }, [n]), /* @__PURE__ */ d(ve, { onOpenChange: (m) => {
    m || (i !== "custom" || c ? (t(i), r(c)) : (l(e), w(n)));
  }, children: [
    ...
    /* @__PURE__ */ d(ne, { className: "tw-z-[300]", children: [
      ...
      /* @__PURE__ */ o(
        Yt,
        {
          onMouseMove: () => {
            var m;
            i === "custom" && ((m = s.current) == null || m.focus());
          },
          checked: i === "custom",
...
function Tp({
  ...
  const l = rt(null), c = fo(), [w, p] = D("generated"), [m, f] = D("*"), [u, g] = D("f"), N = $(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (E && $n("note", E)) {
      ...
      let O = "custom";
      S === Qn ? O = "generated" : S === tr ? O = "hidden" : S && f(S), p(O), g(((R = E.insert.note) == null ? void 0 : R.style) ?? "f"), E.insert.note && (E.insert.note.caller = ""), x = setTimeout(() => {
        var y;
  ...
  const k = j(() => {
    var E, I;
    const x = (I = (E = l.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : I.at(0);
    x && $n("note", x) && (x.insert.note && (w === "custom" ? x.insert.note.caller = m : x.insert.note.caller = w === "generated" ? Qn : tr), t([x]));
  }, [w, m, t]), C = () => {
    var E;
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Kt, { children: [
            /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: C, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(yo, {}) }) }),
...
function Op({
  ...
  const m = p ? kc(p, "%webView_footnoteList_header%") : "Footnotes", f = c ?? ri(n, void 0), u = (x, E) => {
    w == null || w(x, E, a);
  ...
  return q(() => {
    ...
    r === "vertical" && /* @__PURE__ */ o("h2", { className: "tw-mb-1 tw-font-semibold", children: m }),
    /* @__PURE__ */ o(
      "div",
      {
        role: "listbox",
...
function Bp({
  ...
  const m = Tt(n, "%webView_inventory_all%"), f = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), N = Tt(n, "%webView_inventory_scope_currentBook%"), k = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), x = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), E = Tt(n, "%webView_inventory_no_results%"), [I, R] = D(!1), [S, O] = D("all"), [y, T] = D(""), [V, B] = D([]), F = $(() => {
    const P = e ?? [];
  ...
  }, [I, F]), W = $(() => A.length === 0 ? [] : Tc(A, S, y), [A, S, y]), M = $(() => {
    var dt, wt;
    if (!I) return c;
        ...
        De,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(fe, { children: [
              /* @__PURE__ */ o(kt, { value: "all", children: m }),
              /* @__PURE__ */ o(kt, { value: "approved", children: f }),
      ...
      /* @__PURE__ */ o(Bt, { children: a.map((s) => /* @__PURE__ */ d(
        zt,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ o(Ko, { className: "tw-font-sans", children: s.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const Dc = "16rem", Oc = "3rem", La = b.createContext(void 0);
function Dn() {
...
const Ba = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), m = t ?? w, f = b.useCallback(
      (x) => {
        const E = typeof x == "function" ? x(m) : x;
        n ? n(E) : p(E);
      },
      [n, m]
    ), u = b.useCallback(() => f((x) => !x), [f]), g = m ? "expanded" : "collapsed", C = lt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", _ = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
...
const Xt = "scrBook", Uc = "scrRef", ie = "source", Yc = "details", qc = "Scripture Reference", Jc = "Scripture Book", Ka = "Type", Wc = "Details";
function Zc(e, t) {
  const n = t ?? !1;
  return [
    {
...
function Gp({
  ...
  const [w, p] = D([]), [m, f] = D([{ id: Xt, desc: !1 }]), [u, g] = D({}), N = $(
  ...
  q(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const V = N.find((B) => mo(B) === T[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, N, l, C]);
  const _ = a ?? Jc, x = s ?? Ka, E = [
  ...
  }, S = (y, T) => y.getIsGrouped() ? "" : h("banded-row", T % 2 === 0 ? "even" : "odd"), O = (y, T, V) => {
    ...
    !t && /* @__PURE__ */ d(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(fe, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: E.map((y) => /* @__PURE__ */ o(kt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
...
function ed({
  ...
  }, [k, C] = D(!1), [_, x] = D(""), E = rt(void 0), I = rt(!1);
  ...
  const R = $(() => Y.allBookIds.filter(
    ...
    (A) => {
      ...
      n(
        Ua(R, A, t) ? t.filter((M) => !W.includes(M)) : [.../* @__PURE__ */ new Set([...t, ...W])]
      );
    },
    [t, n, R]
  ), B = () => {
...
function Xp({
  ...
  const w = oe(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), f = oe(i, "%webView_scope_selector_current_book%"), u = oe(i, "%webView_scope_selector_choose_books%"), g = oe(i, "%webView_scope_selector_scope%"), N = oe(i, "%webView_scope_selector_select_books%"), k = [
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: C.map(({ value: _, label: x, id: E }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(gn, { className: "tw-me-2", value: _, id: E }),
...
const qa = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  /* @__PURE__ */ o(de, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ o(Kw, { children: /* @__PURE__ */ o(Ia, { children: qa(
      e,
      t,
      Ya(e, l.id),
      r
...
function hr({
  ...
  return /* @__PURE__ */ d(ve, { variant: s, children: [
    ...
    /* @__PURE__ */ o(ne, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(go, { children: [
      /* @__PURE__ */ o(Oa, { children: /* @__PURE__ */ o(Vt, { children: qa(t.groups, t.items, c, e) }) }),
...
function Zp({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Wa, { children: [
      /* @__PURE__ */ o(Za, { children: e.map((l) => /* @__PURE__ */ o(nd, { value: l.value, children: l.value }, l.key)) }),
...
ad.displayName = et.CheckboxItem.displayName;
...
sd.displayName = et.RadioItem.displayName;
...
id.displayName = et.Label.displayName;
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Fe(s, [f, u]);
        break;
      case "alt+l":
        (N = i.current) == null || N.focus(), Fe(i, [f, u]);
        break;
      case "alt+n":
        (k = l.current) == null || k.focus(), Fe(l, [f, u]);
        break;
      case "alt+h":
        (C = c.current) == null || C.focus(), Fe(c, [f, u]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ o(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(rd, { children: [
...
function eu({
  ...
  const w = wd(
    ...
    return k ? `${(I = e[g]) == null ? void 0 : I.autonym} (${k})` : (R = e[g]) == null ? void 0 : R.autonym;
  };
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ o(Pe, { className: h(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(xo, {}) }) }),
...
const au = nt.Root, su = nt.Trigger, iu = nt.Group, lu = nt.Portal, wu = nt.Sub, cu = nt.RadioGroup, fd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  nt.SubTrigger,
  {
    ref: a,
    className: h(
...
fd.displayName = nt.SubTrigger.displayName;
...
gd.displayName = nt.SubContent.displayName;
const bd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(nt.Portal, { children: /* @__PURE__ */ o(
  nt.Content,
  {
    ref: n,
    className: h(
...
bd.displayName = nt.Content.displayName;
...
vd.displayName = nt.Item.displayName;
...
xd.displayName = nt.CheckboxItem.displayName;
...
yd.displayName = nt.RadioItem.displayName;
...
kd.displayName = nt.Separator.displayName;
...
const du = Et.Trigger, Ed = Et.Portal, pu = Et.Close, ws = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
