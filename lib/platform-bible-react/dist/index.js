...
import { c as v, g as Te, a as zr, C as Ue, L as Kn, u as Qo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as De, f as ve, h as Me, i as br, j as Ae, B as J, x as fs, k as ms, l as vs, I as bs, m as _o, n as Be, r as ye, o as xs, p as Hn, P as Ze, q as xr, s as Xe, t as Je, v as Na, w as Ca, y as No, z as Qe, E as Ea, F as Rt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as qn, O as na, Q as Eo, S as $r, U as Vr, V as dr, W as ys, X as ks, Y as We, Z as Le, _ as ze, $ as $e, a0 as wr, a1 as To, a2 as So, a3 as fa, a4 as Ro, a5 as Gn, a6 as _s, a7 as Ns, a8 as Cs, a9 as io, aa as Wn, ab as Ta, ac as Es, ad as Yn, ae as Ts, af as Ss, ag as Rs, ah as tn, ai as Os, aj as Ds, ak as Ms, al as Zn, am as Xn, an as Oo, ao as zs, ap as Jn, aq as Ba, ar as en, as as ja, at as Is, au as Ps, av as As, aw as $s, ax as Vs, ay as jr, az as Do, aA as Ls, aB as Bs } from "./resizable-Bp3EoU-Z.js";
import { aC as df, aD as wf, aE as uf, aF as pf, aG as hf, aH as gf, aI as ff, aJ as mf, aK as vf, aL as bf, aM as xf, aN as yf, aO as kf, aP as _f, aQ as Nf, aR as Cf, aS as Ef, aT as Tf, aU as Sf, aV as Rf, aW as Of, aX as Df, aY as Mf, aZ as zf, a_ as If, a$ as Pf, b0 as Af, b1 as $f, b2 as Vf, b3 as Lf, b4 as Bf, b5 as jf, b6 as Ff, b7 as Uf, b8 as Kf, b9 as Hf, ba as qf, bb as Gf, bc as Wf, bd as Yf, be as Zf, bf as Xf, bg as Jf, bh as Qf } from "./resizable-Bp3EoU-Z.js";
...
import Gt, { useRef as F, useMemo as V, createContext as Fr, useContext as Sa, useState as N, useEffect as X, useCallback as j, useId as co, useImperativeHandle as Mc, useLayoutEffect as Wt, Fragment as Ur, Component as zc, createElement as ln, Suspense as Ic, forwardRef as Io } from "react";
...
function rd({
  ...
  const z = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), M = P ? (
...
function id({
  ...
  const [h, g] = N(!1), [f, x] = N(!1), b = co(), D = F(!1), y = w !== void 0, C = y ? w : h, E = n === "" ? "" : Jt(n, od), P = Jt(s, nd), T = (M) => {
    M || (D.current = !0, x(!1)), y || g(M), p == null || p(M);
  }, L = (M) => {
    if (M && D.current) {
      D.current = !1;
      return;
  ...
  return /* @__PURE__ */ u(De, { open: C, onOpenChange: T, modal: !1, children: [
    /* @__PURE__ */ a(Ot, { children: E ? /* @__PURE__ */ u(Ct, { open: f, onOpenChange: L, children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ve, { asChild: !0, children: z }) }),
      /* @__PURE__ */ a(Tt, { children: E })
    ] }) : /* @__PURE__ */ a(ve, { asChild: !0, children: z }) }),
    /* @__PURE__ */ u(
      Me,
      {
        id: i,
...
function Ha({
  ...
  const T = ye(), L = td(), [A, z] = N(!1), [M, W] = N(""), [K, et] = N(""), [_, tt] = N("books"), [I, O] = N(void 0), [G, ct] = N(
    void 0
  ), [ot, pt] = N(void 0), [_t, Y] = N(!1), [ut, mt] = N(!1), [lt, Nt] = N(!1), [kt, ft] = N(!1), ce = F(null), te = F(!1), Dt = F(void 0), vt = F(void 0), Ut = F(void 0), re = F(void 0), Mt = F({}), zt = F({}), bt = j(
    (m) => {
      e(m), l && l(m);
    },
    [e, l]
    ...
    if (!k) return;
    const m = M.startsWith(`${k.book} `) ? M : "", q = ta(m), at = Mr(m);
    return {
      book: k.book,
  ...
  const U = j(() => {
    ...
    (m) => {
      z(m), m && (tt("books"), O(void 0), ct(void 0), pt(void 0), et(""), ft(!1), Nt(!1), mt(S));
    },
    [S]
  );
  X(() => {
  ...
  const { otLong: kr, ntLong: _r, dcLong: Nr, extraLong: Cr } = {
    ...
    () => L >= Pr.TIGHT ? zr(t.book, s) : Te(t.book, s),
    [t.book, s, L]
  ...
  }, [_, k, de, Q, M]), /* @__PURE__ */ u(Ze, { open: A, onOpenChange: Ce, modal: y, children: [
                  ...
                  k && $ && /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ u(
                    Ue,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: zr(k.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
...
function yn({
  ...
  const [C, E] = N(!1), P = d ?? l, T = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], L = (A, z) => {
    const M = l(A), W = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, K = `${z ?? ""}${M}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Ue,
      {
        value: M,
    ...
    /* @__PURE__ */ a(
      Xe,
      {
        ...
        children: /* @__PURE__ */ u(Je, { children: [
          ...
          /* @__PURE__ */ a(Qe, { children: T(e) ? e.map((A) => /* @__PURE__ */ a(Be, { heading: A.groupHeading, children: A.options.map((z) => L(z, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(Be, { children: e.map((A) => L(A)) }) })
        ] })
      }
    )
  ] });
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((T || L) && E !== null && P !== null) {
        const A = function(z, M, W, K, et, _, tt) {
          const I = (z._window ? z._window.document : document).createRange();
          return I.setStart(...kn(M, W, K)), I.setEnd(...kn(et, _, tt)), I;
        }(t, h, f, E, g, D, P);
        l(), l = Id(t, A, e);
      }
...
function qd(t) {
  ...
  zi(this), wt = t, this.f &= -2, 8 & this.f && jo(this), Da();
}
function lr(t, e) {
...
qt.prototype.brand = Fd, qt.prototype.h = function() {
  ...
  return wt = t, zi(this), this.f &= -2, !0;
...
function vw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: x, role: b = "textbox", spellCheck: D = !0, style: y, tabIndex: C, "data-testid": E, ...P }, T) {
  const [L, A] = N(t.isEditable()), z = j((W) => {
...
const zw = "verseText", lh = Object.freeze([
...
function In({
  ...
  const g = j(
    ...
    [t.user]
  ), y = V(() => zo(t.contents), [t.contents]), C = V(
    ...
    "div",
    {
      ...
      children: [
        ...
        P && /* @__PURE__ */ u(De, { children: [
          ...
          /* @__PURE__ */ a(Me, { align: "end", children: P })
        ] })
      ]
    }
  );
...
function rs({
  ...
  X(() => {
    if (!o) {
      Mt.current !== "idle" && (tt(void 0), O(void 0), Mt.current = "idle");
      return;
    }
    Mt.current === "idle" && (Mt.current = "pending"), mt ? Mt.current === "pending" && L !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    L !== s && (tt(L), Mt.current = "auto-populated") : Mt.current === "auto-populated" && (tt(void 0), Mt.current = "pending");
  }, [o, L, mt, s]);
  const zt = V(
  ...
  const bt = V(() => zt[0], [zt]), ae = F(null), Zt = F(void 0), ee = j(() => {
    var R;
  ...
  }, [s, r]), It = V(() => zt.slice(1), [zt]), S = V(() => It.length ?? 0, [It.length]), H = V(() => S > 0, [S]), k = V(() => ct || S <= 2 ? It : It.slice(-2), [It, S, ct]), $ = V(() => ct || S <= 2 ? 0 : S - 2, [S, ct]), Z = V(
                      ...
                      /* @__PURE__ */ a(
                        Xe,
                        {
                          ...
                          children: /* @__PURE__ */ a(Je, { children: /* @__PURE__ */ a(Qe, { children: x == null ? void 0 : x.map((R) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                tt(R !== s ? R : void 0), Mt.current = "user-selected", O(void 0), ut(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function Fw({
  ...
  let z;
  L ? z = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : s || (z = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), K = (I) => I ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: I }) : W, et = () => {
    const I = o ?? "accept";
...
function tu({
  ...
  let P;
  return l ? P = Array.from({ length: 10 }).map((z, M) => `skeleton-row-${M}`).map((z) => /* @__PURE__ */ a($e, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(wr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(dr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? P = C.getRowModel().rows.map((L) => /* @__PURE__ */ a(
    $e,
    {
      onClick: () => i(L, C),
...
function Oh({
  ...
  const [x, b] = N("generated"), [D, y] = N("generated"), [C, E] = N("*"), [P, T] = N("*"), [L, A] = N("f"), [z, M] = N(!1), [W, K] = N(!0), [et, _] = N(!1), tt = F(!1), I = F(""), [O, G] = N(!1), ct = cu(), [ot, pt] = N(), _t = F(null), Y = F(
    void 0
...
const Ou = (t) => {
  ...
  return e ? e[1] : "";
}, Mu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Lh = Object.freeze([
...
function Bh({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), x = fe(r, "%webView_inventory_unapproved%"), b = fe(r, "%webView_inventory_unknown%"), D = fe(r, "%webView_inventory_scope_currentBook%"), y = fe(r, "%webView_inventory_scope_chapter%"), C = fe(r, "%webView_inventory_scope_verse%"), E = fe(r, "%webView_inventory_filter_text%"), P = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = fe(r, "%webView_inventory_no_results%"), [L, A] = N(!1), [z, M] = N("all"), [W, K] = N(""), [et, _] = N([]), tt = V(() => {
    const Y = t ?? [];
  ...
  }, [L, tt]), O = V(() => I.length === 0 ? [] : zu(I, z, W), [I, z, W]), G = V(() => {
    var mt, lt;
    if (!L) return l;
...
function eg({
  ...
  X(() => {
    if (c) {
      const z = D.getSelectedRowModel().rowsById, M = Object.keys(z);
      if (M.length === 1) {
        const W = x.find((K) => Fn(K) === M[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, x, c, D]);
  const y = n ?? Yu, C = s ?? ns, E = [
    ...
    !z.getIsGrouped() && !z.getIsSelected() && z.getToggleSelectedHandler()(M);
  }, L = (z, M) => z.getIsGrouped() ? "" : v("banded-row", M % 2 === 0 ? "even" : "odd"), A = (z, M, W) => {
    if (!((z == null ? void 0 : z.length) === 0 || M.depth < W.column.getGroupedIndex())) {
      if (M.getIsGrouped())
        switch (M.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      gr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(vr, { position: "item-aligned", children: /* @__PURE__ */ a(Zw, { children: E.map((z) => /* @__PURE__ */ a(ue, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(To, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(So, { children: D.getHeaderGroups().map((z) => /* @__PURE__ */ a($e, { children: z.headers.filter((M) => M.column.columnDef.header).map((M) => (
      ...
      /* @__PURE__ */ a(Ro, { children: D.getRowModel().rows.map((z, M) => {
        const W = ye();
        return /* @__PURE__ */ a(
          $e,
          {
                    ...
                    children: K.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(hc, {}) : /* @__PURE__ */ a(gc, {})),
                          " ",
...
function ag({
  ...
  const T = Lt(
    i,
    "%webView_scope_selector_selected_text%"
  ), L = Lt(i, "%webView_scope_selector_verse%"), A = Lt(i, "%webView_scope_selector_chapter%"), z = Lt(i, "%webView_scope_selector_book%"), M = Lt(
    i,
    "%webView_scope_selector_current_verse%"
  ), W = Lt(
    i,
  ...
  }, te = F(null), Dt = F(null), vt = F(!1), Ut = F(null), re = F(!1), [Mt, zt] = N(void 0), bt = F(!1), ae = F(!1), Zt = F(null), ee = j((B) => {
    if (B) {
      zt("start"), bt.current = !1;
      return;
    }
    zt((Q) => Q === "start" ? void 0 : Q), bt.current && (bt.current = !1, requestAnimationFrame(() => {
      var Pt;
  ...
  ), Nr = Mt === "end", Cr = Mt === "start", rr = "tw:text-muted-foreground", He = p === "dropdown" && it === "range", Ia = He ? xt : $t, Pa = He ? Ce : x ? Ne : ce, Er = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
...
export {
  ...
  hf as CONTENT_ZOOM_CSS_VARIABLE_PREFIX,
  gf as CONTENT_ZOOM_DEFAULT_CSS_VARIABLE,
  ff as CONTENT_ZOOM_POPUP_ATTRIBUTE,
  ...
  Df as KbdGroup,
  Rt as Label,
  Mf as MAIN_CONTENT_ZOOM_AREA_ID,
  ...
  Uf as Z_INDEX_CONNECTION_LOST,
  Kf as Z_INDEX_FIRST_RUN,
  Hf as Z_INDEX_MODAL,
  qf as Z_INDEX_MODAL_BACKDROP,
  Gf as Z_INDEX_ONBOARDING_TOUR,
  Wf as Z_INDEX_OVERLAY,
  Yf as badgeVariants,
  ...
  Rh as measureElement,
  lu as measureRange,
  zp as pickTabIconUrl,
  em as sonner,
  Qf as useContentZoomArea,
  Jg as useEvent,
  Qg as useEventAsync,
