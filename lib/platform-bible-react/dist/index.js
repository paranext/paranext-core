...
import { c as v, g as Re, a as zr, C as Ge, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as pa, D as Ie, f as ke, h as ze, i as kr, j as Be, B as J, x as fs, k as ms, l as vs, I as bs, m as ko, n as Ke, r as Ce, o as xs, p as Kn, P as tr, q as _r, s as er, t as rr, v as _a, w as Na, y as _o, z as ar, E as Ca, F as Mt, R as No, G as ha, H as eo, J as ro, K as ao, M as oo, N as Hn, O as oa, Q as Co, S as Vr, U as Lr, V as pr, W as ys, X as Ze, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as Eo, a1 as To, a2 as ga, a3 as So, a4 as qn, a5 as ks, a6 as _s, a7 as Ns, a8 as no, a9 as Gn, aa as Ea, ab as Cs, ac as Wn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as Yn, al as Xn, am as Ro, an as Os, ao as Jn, ap as La, aq as tn, ar as Ba, as as Is, at as zs, au as Ps, av as As, aw as $s, ax as Do, ay as Mo, az as Vs, aA as Ls } from "./resizable-CuMhGVyM.js";
import { aB as rf, aC as af, aD as of, aE as nf, aF as sf, aG as cf, aH as lf, aI as df, aJ as wf, aK as uf, aL as pf, aM as hf, aN as gf, aO as ff, aP as mf, aQ as vf, aR as bf, aS as xf, aT as yf, aU as kf, aV as _f, aW as Nf, aX as Cf, aY as Ef, aZ as Tf, a_ as Sf, a$ as Rf, b0 as Df, b1 as Mf, b2 as Of, b3 as If, b4 as zf, b5 as Pf, b6 as Af, b7 as $f, b8 as Vf, b9 as Lf, ba as Bf } from "./resizable-CuMhGVyM.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Zn, ChevronDown as Qe, ArrowLeft as Bs, ArrowRight as js, BoldIcon as Fs, ItalicIcon as Us, X as Oo, AtSign as Qn, Pencil as Ks, Trash2 as Hs, ArrowUp as ti, MoreHorizontal as qs, MailOpen as Gs, Mail as Ws, FilterIcon as Ys, ArrowLeftIcon as Xs, ChevronLeftIcon as Js, ChevronRightIcon as Zs, ArrowRightIcon as Qs, Copy as ei, Filter as tc, User as ec, Link as rc, CircleHelp as ac, Undo as oc, Redo as nc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as ic, AlertCircle as io, CircleCheckIcon as sc, CircleXIcon as cc, CircleHelpIcon as lc, ArrowUpIcon as dc, ArrowDownIcon as wc, ScrollText as uc, ChevronRight as pc, ChevronLeft as hc, ChevronsUpDown as gc, MenuIcon as fc, Menu as mc, EllipsisVertical as vc, MoreVertical as bc } from "lucide-react";
import { Section as Dt, compareScrRefs as fa, getChaptersForBook as xc, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as na, formatRelativeDate as yc, sanitizeHtml as Io, NumberFormat as ni, formatBytes as kc, getCurrentLocale as _c, usfmMarkers as ia, isPlatformError as Nc, ABORTED as Cc, getErrorMessage as Ec, getFormatCallerFunction as Tc, deepEqual as Sc, isString as on, scrRefToBBBCCCVVV as ja, defaultScrRef as Fa, formatScrRefRange as Rc, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as Dc } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Fr, useContext as Ta, useState as _, useEffect as Y, useCallback as j, useId as so, useImperativeHandle as Mc, useLayoutEffect as Jt, Fragment as Ur, Component as Oc, createElement as cn, Suspense as Ic, forwardRef as ii } from "react";
...
import { Avatar as $o, Select as Zt, Checkbox as un, Slot as Hr, Tabs as fe, Menubar as Ee, ContextMenu as Ft, Progress as pn, Slider as Zr, Switch as hn } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as wo, HIDDEN_NOTE_CALLER as uo, getDefaultViewOptions as Ul, isInsertEmbedOpOfType as Dr, getMarkerMenuItems as Kl, defaultStyleInfo as Hl, Editorial as ql } from "@eten-tech-foundation/platform-editor";
...
function ed({
  ...
  Y(() => {
    ...
    const N = (q) => !!q && q.scrollWidth > q.clientWidth, rt = () => {
      po !== "pointer" && (T || N(h.current) || N(l.current)) && C(!0);
    }, O = () => C(!1);
...
function nd({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = so(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, ad), P = re(s, od), T = (M) => {
...
function wd(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : jt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
  ), i = go(s), c = Object.values(i).flat(), l = go(t);
  return {
...
function pd({
  ...
  switch (o === "rtl" ? ud(e) : e) {
    ...
    case "ArrowRight":
      return t < r ? t + 1 : 1;
    case "ArrowUp":
      return Math.max(1, t - fo);
    case "ArrowDown":
      return Math.min(r, t + fo);
    default:
      return t;
  }
}
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(
      "div",
      {
        ...
        style: { gridTemplateColumns: `repeat(${fo}, minmax(0, 1fr))` },
...
function Ka({
  ...
  const T = Ce(), B = Ql(), [z, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    void 0
    ...
    () => wd(ne, ie),
    [ne, ie]
  ), kt = zt.has(t.book), ve = V(() => U.trim() ? go(
    Ut.filter((m) => ko(m, U, s))
  ) : lt ? Ae : se, [
    se,
    Ae,
    Ut,
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (m) => {
      ...
      if ((N === "chapters" || N === "verses") && (m.key === " " || m.key === "Enter")) {
        ...
        const de = (() => {
          if (N === "verses") {
            const Rr = q, Jo = ot, Va = Qr(M);
            return !Rr || !Jo || Va === void 0 ? void 0 : {
              isDisabled: cr(Rr, Jo)(Va),
              activate: () => S(Va)
            };
          }
          const Gt = O, he = Ir(M);
                      ...
                      ({ onClick: m, disabled: H, title: at, icon: Lt, group: Kt }, yt) => {
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(Ur, { children: [
                            yt > 0 && Kt !== G[yt - 1].group && /* @__PURE__ */ a(_o, {}),
                            H ? (
...
var mo = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(mo || {});
((t) => {
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bd = Di ? Jt : Y, ea = { tag: zo };
...
const Td = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Sd(t) {
...
function Vd(t) {
  ...
  if (_e(e)) r = Hc(e.focus, "next");
    ...
    r = r || qc(qe(), "previous").getFlipped().insert(Kr());
  }
  const o = Ld(t, r), n = Gc(o), s = Wc(n) ? Yc(n) : o;
...
let va, Me = 0, ba = 0, Ud = 0, vo = 0, la = 0;
function _n(t) {
  if (st === void 0) return;
  let e = t.n;
...
function Hd(t) {
  ...
  Ii(this), st = t, this.f &= -2, 8 & this.f && Bo(this), Da();
}
function ur(t, e) {
...
Yt.prototype.brand = jd, Yt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Me !== 0 && ba === 0 && e.l !== vo && (e.l = vo, va = { S: e, v: e.v, i: e.i, o: va });
...
const Ga = al("format", { parse: (t) => typeof t == "number" ? t : 0 });
class $i extends co {
  $config() {
...
const bo = ue({ build: (t) => Vi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const jo = 0, xo = 1, Bi = 2, Wa = 3, ra = 4, wr = 5, Ya = 6, Mr = 7;
function Xa(t) {
  return t.id === jo;
}
function ji(t) {
...
function Wd(t) {
  return function(e) {
    return e.id === xo;
  }(t) || ut(305, String(t.id), String(xo)), Object.assign(t, { id: Bi });
}
...
class fr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Xa(s) || ut(300, i, n || "[unknown]"), Xa(c = s) || ut(304, String(c.id), String(jo)), s = Object.assign(c, { id: xo }), o.state = s;
...
const tw = /* @__PURE__ */ new Set(), Sn = ue({ build(t, e, r) {
  const o = r.getDependency(bo).output, n = jr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Vi(() => {
  }, () => Ne(() => {
...
}, dependencies: [bo], name: "@lexical/extension/NodeSelection" }), ew = cl("INSERT_HORIZONTAL_RULE_COMMAND");
class mr extends co {
  static getType() {
...
ue({ dependencies: [bo, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [mr], register(t, e, r) {
...
const gw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function jw({
  ...
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), U = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : W, tt = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(ua, { html: R }) : W : U(O === "reject" ? t.rejectedResultText : t.resultText);
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(qw, { ...q, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...q })
          },
          I.id
        );
      })
...
function Zw({
  ...
  return l ? P = Array.from({ length: 10 }).map((D, M) => `skeleton-row-${M}`).map((D) => /* @__PURE__ */ a(je, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(hr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(pr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? P = C.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Eo, { stickyHeader: s, children: [
      /* @__PURE__ */ a(To, { stickyHeader: s, children: C.getHeaderGroups().map((B) => /* @__PURE__ */ a(je, { children: B.headers.map((z) => /* @__PURE__ */ a(ga, { className: "tw:p-0", children: z.isPlaceholder ? void 0 : Pr(z.column.columnDef.header, z.getContext()) }, z.id)) }, B.id)) }),
      /* @__PURE__ */ a(So, { children: P })
    ] }),
...
function ou({
  ...
  const l = Co(), d = An(n, "%undoButton_tooltip%"), w = An(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Na, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
        J,
    ...
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(_o, {}),
...
function nu({
  ...
  return Y(() => {
    var l;
    const s = Co(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
function Nh({
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      z !== "x" && S === "x" ? nt == null || nt.forEach((ct) => mu(ct)) : z === "x" && S !== "x" && (nt == null || nt.forEach((ct) => vu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (S) => {
...
function Nu({
  ...
  return /* @__PURE__ */ u(Eo, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(To, { stickyHeader: !0, children: /* @__PURE__ */ u(je, { children: [
      /* @__PURE__ */ a(ga, { children: n }),
      /* @__PURE__ */ a(ga, { children: s })
    ] }) }),
    /* @__PURE__ */ a(So, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      je,
      {
        onClick: () => {
          e(c.reference);
...
function zh({
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Su(O, D, W), [O, D, W]), q = V(() => {
    var vt, pt;
    if (!B) return l;
...
function Yh({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Eo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(To, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(je, { children: D.headers.filter((M) => M.column.columnDef.header).map((M) => (
      ...
      /* @__PURE__ */ a(So, { children: R.getRowModel().rows.map((D, M) => {
        const W = Ce();
        return /* @__PURE__ */ a(
          je,
          {
...
function Wu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
    ...
    () => Object.values(Dt).filter(
      (N) => (s == null ? void 0 : s[N]) !== void 0 && Ro(T, N).length === 0
...
function Ju({
  ...
  const i = Ro(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    J,
    {
      variant: "outline",
      size: "sm",
...
function Jh({
  ...
  ), Cr = Rt === "end", Er = Rt === "start", nr = "tw:text-muted-foreground", Ye = p === "dropdown" && K === "range", Ia = Ye ? et : Ut, za = Ye ? ct : x ? $e : me, Tr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
      ...
      ro,
      {
        ...
        children: /* @__PURE__ */ u(La, { container: Se, children: [
          ...
          /* @__PURE__ */ u(tn, { children: [
            ...
            /* @__PURE__ */ a(J, { onClick: Yr, children: ot })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && ce && /* @__PURE__ */ a(eo, { open: K === "range", onOpenChange: dr, children: /* @__PURE__ */ a(
      ro,
      {
        ...
        children: /* @__PURE__ */ u(La, { container: sr, children: [
          ...
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => dr(!1), children: dt }),
            /* @__PURE__ */ a(J, { ref: ie, onClick: Yr, children: ot })
          ] })
        ] })
      }
    ) })
  ...
  return /* @__PURE__ */ u(Ie, { variant: s, children: [
    /* @__PURE__ */ a(
      ke,
      {
        ...
        id: c,
        onPointerDown: d,
        children: /* @__PURE__ */ a(J, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(fc, {}) })
      }
    ),
    /* @__PURE__ */ a(
      ze,
      {
        ...
        onCloseAutoFocus: (p) => {
          l.current && p.preventDefault();
        },
        children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, h]) => typeof p == "boolean" || typeof h == "boolean" ? 0 : p.order - h.order).map(([p], h, g) => /* @__PURE__ */ u(Ur, { children: [
          /* @__PURE__ */ a(qn, { children: /* @__PURE__ */ a(Ot, { children: ss(e.groups, e.items, p, t) }) }),
          h < g.length - 1 && /* @__PURE__ */ a(Ze, {})
        ] }, p))
      }
    )
  ] });
  ...
  return /* @__PURE__ */ a(sp, { children: /* @__PURE__ */ a(
    Ee.Content,
    {
      ...
      className: v(
        ...
        // With tw:bg-popover/70 gone, the base class already paints tw:bg-popover, so the muted
        // variant's override is redundant; removed it and the menu-context read that fed it.
