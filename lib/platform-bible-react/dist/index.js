...
import p, { useCallback as F, useMemo as L, useState as P, useRef as H, useLayoutEffect as dn, createContext as Cr, useContext as _r, useEffect as Et, forwardRef as Cn, Fragment as _n } from "react";
...
import { getChaptersForBook as eo, formatScrRef as Jt, NumberFormat as no, formatBytes as ro, deepEqual as Ue, isString as Te, compareScrRefs as Ae, scrRefToBBBCCCVVV as Re, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
import * as Tn from "@radix-ui/react-label";
import * as te from "@radix-ui/react-radio-group";
import { useReactTable as Rn, getFilteredRowModel as oo, getSortedRowModel as En, getPaginationRowModel as ao, getCoreRowModel as Vn, flexRender as Wt, getGroupedRowModel as so, getExpandedRowModel as io } from "@tanstack/react-table";
import * as B from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as wo } from "@radix-ui/react-dropdown-menu";
import * as G from "@radix-ui/react-select";
import lo from "markdown-to-jsx";
...
import { Toaster as po } from "sonner";
import { toast as qi } from "sonner";
import * as Kt from "@radix-ui/react-slider";
import * as je from "@radix-ui/react-switch";
const mo = Tr({ prefix: "tw-" });
function l(...t) {
  return mo(Sr(t));
}
const uo = Ct(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ft : "button", { className: l(uo({ variant: e, size: n, className: t })), ref: s, ...a })
);
z.displayName = "Button";
const ho = "layoutDirection";
function Y() {
  const t = localStorage.getItem(ho);
  return t === "rtl" ? t : "ltr";
}
const fo = ut.Portal, zn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
    className: l(
...
const go = p.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Y();
...
bo.displayName = ut.Title.displayName;
...
vo.displayName = ut.Description.displayName;
...
var xo = Object.defineProperty, yo = (t, e, n) => e in t ? xo(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => yo(t, typeof e != "symbol" ? e + "" : e, n);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
const Q = class D {
    ...
    if (R(this, "firstChapter"), R(this, "lastChapter"), R(this, "lastVerse"), R(this, "hasSegmentsDefined"), R(this, "text"), R(this, "BBBCCCVVVS"), R(this, "longHashCode"), R(this, "versification"), R(this, "rtlMark", "‏"), R(this, "_bookNum", 0), R(this, "_chapterNum", 0), R(this, "_verseNum", 0), R(this, "_verse"), o == null && a == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof D) {
          ...
          if (e == null) return;
          const s = e instanceof Tt ? e : D.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let m;
    return i && (m = new Tt(i)), n ? new D(n, o.toString(), w, m) : new D();
  }
  /**
...
function Oo(t, e) {
  ...
  const n = zo.reduce(
    (o, a) => {
      if (o) return o;
      const s = a.exec(t.trim());
      if (s) {
        const [i, w = void 0, m = void 0] = s.slice(1);
        let c;
        const u = i.toLowerCase(), g = e.filter((h) => at[h].toLowerCase().includes(u) || h.toLowerCase().includes(u));
        if (g.length === 1 && ([c] = g), !c && w && M.isBookIdValid(i)) {
...
function gn({
  ...
  if (t)
    return /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r("div", { className: l("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: mt(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Vt,
      {
        value: `${t} ${at[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ti({
  ...
  const a = Y(), [s, i] = P(!1), [w, m] = P(""), [c, u] = P(""), [g, h] = P("books"), [f, b] = P(void 0), [_, k] = P(!1), S = H(void 0), x = H(void 0), V = H(void 0), I = H(void 0), W = H({}), nt = L(() => o ? o() : Fn, [o]), it = L(() => ({
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: O, isDigit: X } = hn(N.key);
      if (g === "chapters") {
        if (N.key === "Backspace") {
        ...
        if (O || X) {
          if (N.preventDefault(), N.stopPropagation(), h("books"), b(void 0), X && f) {
            const Z = at[f];
            u(`${Z} ${N.key}`);
          } else
            u(N.key);
    ...
    const { isLetter: O, isDigit: X } = hn(N.key);
    (O || X) && (N.preventDefault(), u((Z) => Z + N.key), x.current.focus(), k(!1));
  }, []);
  return dn(() => {
    const N = setTimeout(() => {
      if (s && g === "books" && V.current && I.current) {
        const O = V.current, X = I.current, Z = X.offsetTop, K = O.clientHeight, xt = X.clientHeight, ft = Z - K / 2 + xt / 2;
        O.scrollTo({
          top: Math.max(0, ft),
          behavior: "smooth"
        }), m(fn(t.book));
    ...
    /* @__PURE__ */ r(Lt, { forceMount: !0, className: "tw-z-[250] tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      oe,
      {
        ref: S,
        onKeyDown: ht,
        ...
        children: [
          g === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Ht.map(({ onClick: N, disabled: O, title: X, icon: Z }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
              ...
              !y && Object.entries(v).map(([N, O]) => {
                if (O.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Pt, { heading: Mo[N], children: O.map((X) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: l(
...
), U = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Tn.Root, { ref: n, className: l("pr-twp", Ao(), t), ...e }));
U.displayName = Tn.Root.displayName;
...
var jo = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(jo || {});
...
function ni({
  ...
  const u = Ve(c, "%webView_bookSelector_currentBook%"), g = Ve(c, "%webView_bookSelector_choose%"), h = Ve(c, "%webView_bookSelector_chooseBooks%"), [f, b] = P(
    "current book"
    /* CURRENT_BOOK */
  ), _ = (k) => {
    b(k), t(k);
    ...
    Je,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(U, { className: "tw-flex tw-items-center", children: o.map((k) => M.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
}), Gn = B.Trigger, Ln = B.Group, $o = B.Portal, Fo = B.Sub, Go = B.RadioGroup;
...
Lo.displayName = "DropdownMenuShortcut";
function Xo({ table: t }) {
  return /* @__PURE__ */ d(Ze, { children: [
    /* @__PURE__ */ r(wo, { asChild: !0, children: /* @__PURE__ */ d(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Bt = G.Root, Ho = G.Group, jt = G.Value, Uo = Ct(
  ...
  return /* @__PURE__ */ d(
    G.Trigger,
    {
      className: l(Uo({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
const st = p.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  G.Item,
  {
    ref: o,
    className: l(
...
qo.displayName = G.Separator.displayName;
function Ko({ table: t }) {
...
function ee(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Jo(o)
  );
}
  ...
  p.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        ee(i, '[tabindex]:not([tabindex="-1"])').forEach((u) => {
...
const ke = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
ke.displayName = "TableBody";
const Wo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? ee(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
const kt = p.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const w = p.useMemo(
    ...
    (u) => {
      ...
      if (u.key === "ArrowDown" || u.key === "ArrowUp")
        u.preventDefault(), ta(f, b, u.key);
      else if (u.key === "ArrowLeft" || u.key === "ArrowRight")
        u.preventDefault(), Qo(w, _, u.key);
...
function na({
  ...
  var k;
  const [w, m] = P([]), [c, u] = P([]), [g, h] = P({}), [f, b] = P({}), _ = Rn({
    data: e,
    columns: t,
    getCoreRowModel: Vn(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    n && o && /* @__PURE__ */ r(Ko, { table: _ })
  ] });
}
function ri({ id: t, markdown: e, className: n, anchorTarget: o }) {
  const a = L(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(lo, { options: a, children: e }) });
}
const oi = Object.freeze([
  "%webView_error_dump_header%",
  "%webView_error_dump_info_message%"
]), vn = (t, e) => t[e] ?? e;
function ra({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
...
function ai({
  ...
  return /* @__PURE__ */ d(ie, { children: [
    ...
    /* @__PURE__ */ r(Lt, { className: l("tw-min-w-80 tw-max-w-96", a), children: /* @__PURE__ */ r(
      ra,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function si({ id: t, label: e, groups: n }) {
  const [o, a] = P(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ze, { children: [
    ...
    /* @__PURE__ */ r(ve, { children: n.map((c, u) => /* @__PURE__ */ d("div", { children: [
...
function aa({ id: t, versionHistory: e }) {
  const [n, o] = P(!1), a = /* @__PURE__ */ new Date();
  function s(w) {
...
const sa = Ct(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: l("pr-twp", sa({ variant: e }), t), ...n })
);
...
function ia({
  ...
  const [g, h] = P(!1), f = F(
    ...
    const k = t.filter((x) => x.starred).sort((x, V) => x.label.localeCompare(V.label)), S = t.filter((x) => !x.starred).sort((x, V) => {
      const I = n.includes(x.value), W = n.includes(V.value);
      return I && !W ? -1 : !I && W ? 1 : x.label.localeCompare(V.label);
    });
    return [...k, ...S];
  }, [t, n, m]);
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ d(ie, { open: g, onOpenChange: h, children: [
    ...
    /* @__PURE__ */ r(Lt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(oe, { children: [
...
), la = p.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Dn.Root,
  {
    ref: a,
...
la.displayName = Dn.Root.displayName;
const Wn = p.createContext({
  size: "default",
  variant: "default"
}), Zn = p.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = Y();
  return /* @__PURE__ */ r(
    ge.Root,
    {
...
const ce = p.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = p.useContext(Wn);
  return /* @__PURE__ */ r(
    ge.Item,
    {
      ref: s,
...
const Ce = (t) => t === "asc" ? /* @__PURE__ */ r(Hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Yr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), di = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, ca = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fi = Object.freeze([
...
function gi({
  ...
  const c = gt(n, "%webView_inventory_all%"), u = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = P(!1), [I, W] = P("all"), [nt, it] = P(""), [C, v] = P([]), y = L(() => t.length === 0 ? [] : ma(t, a, s), [t, a, s]), E = L(() => {
    if (x) return y;
    const T = [];
    return y.forEach((q) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(U, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? S })
      ] })
    ] }),
...
const ua = "16rem", ha = "3rem", Qn = p.createContext(void 0);
function Se() {
...
const tr = p.forwardRef(
  ({
    ...
    const [c, u] = p.useState(t), g = e ?? c, h = p.useCallback(
      (V) => {
        const I = typeof V == "function" ? V(g) : V;
        n ? n(I) : u(I);
      },
      [n, g]
    ), f = p.useCallback(() => h((V) => !V), [h]), b = g ? "expanded" : "collapsed", S = Y() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = p.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
...
const er = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Se();
...
const fa = p.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Se();
  return /* @__PURE__ */ d(
    z,
    {
...
va.displayName = "SidebarHeader";
const xa = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
const Na = p.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ft : "button",
  {
    ref: o,
...
Na.displayName = "SidebarGroupAction";
const Le = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
  ...
  ({
    ...
    const m = t ? Ft : "button", { state: c } = Se(), u = /* @__PURE__ */ r(
      m,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: l(ka({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Ca = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ft : "button",
  {
    ref: a,
...
Ca.displayName = "SidebarMenuAction";
const _a = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
_a.displayName = "SidebarMenuBadge";
const Sa = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Ta.displayName = "SidebarMenuSub";
const Ra = p.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Ra.displayName = "SidebarMenuSubItem";
const Ea = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ft : "a",
  {
    ref: s,
...
function Va({
  ...
  return /* @__PURE__ */ r(
    er,
    {
      ...
      collapsible: "none",
      variant: "inset",
      className: l("tw-w-96 tw-gap-2 tw-overflow-y-auto", m),
...
const sn = Cn(
  ({ value: t, onSearch: e, placeholder: n, isFullWidth: o, className: a, isDisabled: s = !1 }, i) => {
    const w = Y();
    return /* @__PURE__ */ d("div", { className: l("tw-relative", { "tw-w-full": o }, a), children: [
      /* @__PURE__ */ r(
        Sn,
        {
          className: l(
...
const yt = "scrBook", Da = "scrRef", Rt = "source", Ma = "details", za = "Scripture Reference", Oa = "Scripture Book", ir = "Type", Ia = "Details";
function Aa(t, e) {
  const n = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: Ma,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Ia,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, yn = (t) => `${Pa({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function vi({
  sources: t,
  ...
  const [m, c] = P([]), [u, g] = P([{ id: yt, desc: !1 }]), [h, f] = P({}), b = L(
  ...
  }, nt = (C, v) => C.getIsGrouped() ? "" : l("banded-row", v % 2 === 0 ? "even" : "odd"), it = (C, v, y) => {
    ...
    !e && /* @__PURE__ */ d(
      Bt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(zt, { position: "item-aligned", children: /* @__PURE__ */ r(Ho, { children: V.map((C) => /* @__PURE__ */ r(st, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function $a({
  ...
  return /* @__PURE__ */ d(
    Vt,
    {
      ...
      onSelect: () => {
        s.current || (n(t, o.current), o.current = !1), i.current && clearTimeout(i.current), i.current = setTimeout(() => {
          s.current = !1;
        }, 100);
      },
      onMouseDown: (c) => {
...
function Fa({
  ...
  const s = wn(e, t).length === 0, i = a["%scripture_section_ot_short%"], w = a["%scripture_section_nt_short%"], m = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function Ga({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], w = o["%webView_book_selector_search_books%"], m = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], u = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], h = o["%scripture_section_ot_long%"], f = o["%scripture_section_nt_long%"], b = o["%scripture_section_dc_long%"], _ = o["%scripture_section_extra_long%"], [k, S] = P(!1), x = H(void 0), V = H(!1);
  if (t.length !== M.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const I = L(() => M.allBookIds.filter(
    ...
    (v, y = !1) => {
      ...
      const E = I.findIndex((rt) => rt === x.current), J = I.findIndex((rt) => rt === v);
      if (E === -1 || J === -1) return;
      const [Ot, Ht] = [
        Math.min(E, J),
        Math.max(E, J)
      ], dt = I.slice(Ot, Ht + 1).map((rt) => rt);
      n(
    ...
    (v) => {
      const y = wn(I, v).map((E) => E);
      n(
        wr(I, v, e) ? e.filter((E) => !y.includes(E)) : [.../* @__PURE__ */ new Set([...e, ...y])]
      );
    },
    [e, n, I]
  ), it = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ d(ie, { open: k, onOpenChange: S, children: [
      ...
      /* @__PURE__ */ r(Lt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
        oe,
        {
          onKeyDown: (v) => {
      ...
      /* @__PURE__ */ r(
        Je,
        {
          ...
          children: k.map(({ value: S, label: x, id: V }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(U, { htmlFor: V, children: x })
          ] }, V))
        }
      )
    ] }),
...
function Ni({
  ...
  return /* @__PURE__ */ d(
    Bt,
    {
      ...
      children: [
        /* @__PURE__ */ r(Mt, { size: a, className: l("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          jt,
          {
            placeholder: i[A(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          zt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((m) => /* @__PURE__ */ r(st, { value: `${m}`, children: i[A(m)] }, `${m}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, m) => w.order - m.order).map((w) => /* @__PURE__ */ d(on, { children: [
  /* @__PURE__ */ r(an, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    Un,
    {
      onClick: () => {
        o(w);
    ...
    /* @__PURE__ */ r($o, { children: /* @__PURE__ */ r(Hn, { children: dr(
      t,
      e,
      lr(t, w.id),
      o
...
function kn({
  ...
  return /* @__PURE__ */ d(Ze, { variant: s, children: [
    /* @__PURE__ */ r(Gn, { "aria-label": n, className: a, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: o ?? /* @__PURE__ */ r(Wr, {}) }) }),
    /* @__PURE__ */ r(ve, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, m]) => typeof w == "boolean" || typeof m == "boolean" ? 0 : w.order - m.order).map(([w], m, c) => /* @__PURE__ */ d(_n, { children: [
...
function Ti({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(cr, { children: [
      /* @__PURE__ */ r(pr, { children: t.map((i) => /* @__PURE__ */ r(La, { value: i.value, children: i.value }, i.key)) }),
...
const br = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = lt();
...
const Ua = p.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = lt();
  return /* @__PURE__ */ d(
    j.CheckboxItem,
    {
...
Ua.displayName = j.CheckboxItem.displayName;
const Ya = p.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = lt();
  return /* @__PURE__ */ d(
    j.RadioItem,
    {
...
Ya.displayName = j.RadioItem.displayName;
const qa = p.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: o,
    className: l("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
qa.displayName = j.Label.displayName;
...
const qt = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, u) => c.order - u.order).map((c) => /* @__PURE__ */ d(on, { children: [
      /* @__PURE__ */ r(an, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        vr,
        {
          onClick: () => {
            o(c);
    ...
    return w.length > 0 && i < a.length - 1 && m.push(/* @__PURE__ */ r(xr, {}, `separator-${s}`)), m;
  });
};
function Ka({
  menuData: t,
  ...
  const a = H(void 0), s = H(void 0), i = H(void 0), w = H(void 0), m = H(void 0), c = (u) => {
    switch (u) {
      case "platform.app":
        return s;
  ...
  if (co(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, g) => {
    ...
    return /* @__PURE__ */ r(ur, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, g]) => typeof u == "boolean" || typeof g == "boolean" ? 0 : u.order - g.order).map(([u, g]) => /* @__PURE__ */ d(Xa, { children: [
...
function Vi({
  ...
  const m = Ja(
    ...
    return _ ? `${(I = t[f]) == null ? void 0 : I.autonym} (${_})` : (W = t[f]) == null ? void 0 : W.autonym;
  };
  return /* @__PURE__ */ d("div", { className: l("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ d(Zt, { children: [
      /* @__PURE__ */ r(U, { className: "tw-ms-3", children: m }),
...
function Wa({ item: t, createLabel: e, createComplexLabel: n }) {
...
const Za = Cn(({ className: t, ...e }, n) => /* @__PURE__ */ r(to, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ d("div", { className: l("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": o }), children: [
    ...
    /* @__PURE__ */ r(
      le,
      {
        ...
        placeholder: i,
        required: w,
        className: l(m, { "tw-border-red-600": n }),
        defaultValue: c,
        value: u,
        onChange: g,
        onFocus: h,
...
), ts = p.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, role: "alert", className: l(Qa({ variant: e }), t), ...n }));
...
const ns = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
rs.displayName = Gt.Root.displayName;
...
os.displayName = Gt.Image.displayName;
...
as.displayName = Gt.Fallback.displayName;
...
const ls = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const zi = $.Root, Oi = $.Trigger, Ii = $.Group, Ai = $.Portal, Pi = $.Sub, Bi = $.RadioGroup, ps = p.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  $.SubTrigger,
  {
    ref: a,
    className: l(
...
ps.displayName = $.SubTrigger.displayName;
...
const us = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r($.Portal, { children: /* @__PURE__ */ r(
  $.Content,
  {
    ref: n,
    className: l(
...
us.displayName = $.Content.displayName;
const hs = p.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  $.Item,
  {
    ref: o,
    className: l(
...
hs.displayName = $.Item.displayName;
const fs = p.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  $.CheckboxItem,
  {
    ref: a,
    className: l(
...
fs.displayName = $.CheckboxItem.displayName;
const gs = p.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  $.RadioItem,
  {
    ref: o,
    className: l(
...
gs.displayName = $.RadioItem.displayName;
const bs = p.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: o,
    className: l(
...
bs.displayName = $.Label.displayName;
...
xs.displayName = "ContextMenuShortcut";
...
ys.displayName = "Drawer";
const ji = wt.Trigger, Ns = wt.Portal, $i = wt.Close, kr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
...
const ks = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = p.useContext(Nr), i = {
...
Ss.displayName = wt.Title.displayName;
...
Ts.displayName = wt.Description.displayName;
const Rs = p.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Be.Root,
  {
    ref: o,
    className: l(
...
Rs.displayName = Be.Root.displayName;
function Fi({ ...t }) {
  return /* @__PURE__ */ r(
    po,
    {
...
Es.displayName = Kt.Root.displayName;
...
const Gi = et.Root, Ds = p.forwardRef(({ className: t, ...e }, n) => {
  const o = Y();
  return /* @__PURE__ */ r(
    et.List,
    {
...
Ds.displayName = et.List.displayName;
const Ms = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  et.Trigger,
  {
    ref: n,
...
Ms.displayName = et.Trigger.displayName;
...
zs.displayName = et.Content.displayName;
...
const As = (t, e, n = {}) => {
  ...
  const a = H(null), [s, i] = P(void 0), [w, m] = P(void 0), c = F(
    (h) => {
      i(h);
...
export {
  ...
  os as AvatarImage,
  ei as BOOK_SELECTOR_STRING_KEYS,
  me as Badge,
  ti as BookChapterControl,
  jo as BookSelectionMode,
  ni as BookSelector,
  z as Button,
  ss as Card,
  ds as CardContent,
  ...
  us as ContextMenuContent,
  Ii as ContextMenuGroup,
  ...
  ai as ErrorPopover,
  li as Filter,
  si as FilterDropdown,
  wi as Footer,
  fi as INVENTORY_STRING_KEYS,
  le as Input,
  gi as Inventory,
  U as Label,
  ri as MarkdownRenderer,
  ii as MoreInfo,
  ...
  xi as SCOPE_SELECTOR_STRING_KEYS,
  yi as ScopeSelector,
  vi as ScriptureResultsViewer,
  Ni as ScrollGroupSelector,
  sn as SearchBar,
  Bt as Select,
  zt as SelectContent,
  Ho as SelectGroup,
  ...
  qo as SelectSeparator,
  Mt as SelectTrigger,
  jt as SelectValue,
  nn as Separator,
  ki as SettingsList,
  _i as SettingsListHeader,
  Ci as SettingsListItem,
  Va as SettingsSidebar,
  ...
  ci as inventoryCountColumn,
  di as inventoryItemColumn,
  pi as inventoryStatusColumn,
  Uo as selectTriggerVariants,
  qi as sonner,
  Li as useEvent,
  Xi as useEventAsync,
  Hi as useListbox,
