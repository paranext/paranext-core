import Di, { jsx as i, jsxs as x, Fragment as st } from "react/jsx-runtime";
import * as M from "react";
import A, { forwardRef as Zn, useCallback as $e, useState as pe, useRef as gt, useEffect as at, useLayoutEffect as Jo, useMemo as Te } from "react";
import { History as Mi, ChevronRight as Wa, Check as xn, Circle as qa, ArrowDownWideNarrow as Bi, Clock as ji, Bookmark as Vi, X as Ka, Search as Ja, ChevronsUpDown as Za, FilterIcon as Li, ChevronDown as Qn, ChevronUp as zi, ArrowLeftIcon as Fi, ChevronLeftIcon as Ui, ChevronRightIcon as Gi, ArrowRightIcon as Hi, CircleCheckIcon as Xi, CircleXIcon as Yi, CircleHelpIcon as Wi, ArrowUpIcon as qi, ArrowDownIcon as Ki, ArrowUpDownIcon as Ji, Star as Zi, ChevronLeft as Qi, LoaderCircle as el, Download as tl, Filter as nl, User as rl, Link as ol, CircleHelp as al } from "lucide-react";
...
import { getChaptersForBook as cl, deepEqual as to, substring as dl, formatScrRef as Tr, compareScrRefs as zr, scrRefToBBBCCCVVV as Cr, getLocalizeKeyForScrollGroupId as ue, NumberFormat as ul, formatBytes as pl } from "platform-bible-utils";
...
import { useReactTable as es, getCoreRowModel as ts, getPaginationRowModel as fl, getSortedRowModel as ns, getFilteredRowModel as ml, flexRender as sn, getExpandedRowModel as hl, getGroupedRowModel as gl } from "@tanstack/react-table";
...
import * as rs from "@radix-ui/react-toggle";
...
import { MenuItem as xl, ListItemText as Nl, ListItemIcon as as, Menu as kl, Grid as ss, List as El, IconButton as is, Drawer as Tl, AppBar as Cl, Toolbar as Sl } from "@mui/material";
...
function Ul(e) {
  return ls[e - 1].includes("*obsolete*");
}
function Gl() {
  const e = {};
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = a[0], a.length > 1)
        try {
          const s = +a[1].trim();
          this.versification = new pt(Ge[s]);
        } catch {
...
const ao = we.Root, fs = we.Trigger, Hl = we.Group, xm = we.Portal, Nm = we.Sub, km = we.RadioGroup, Xl = A.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ x(
  we.SubTrigger,
  {
    ref: o,
    className: T(
    ...
    children: [
      n,
      /* @__PURE__ */ i(Wa, { className: "tw-ml-auto tw-h-4 tw-w-4" })
    ]
  }
));
Xl.displayName = we.SubTrigger.displayName;
const Yl = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  we.SubContent,
  {
    ref: n,
    className: T(
...
const tr = A.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ i(we.Portal, { children: /* @__PURE__ */ i(
  we.Content,
  {
    ref: r,
    sideOffset: t,
...
const ms = A.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ i(
  we.Item,
  {
    ref: r,
    className: T(
...
ms.displayName = we.Item.displayName;
const so = A.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ x(
  we.CheckboxItem,
  {
    ref: o,
    className: T(
    ...
    ...r,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(we.ItemIndicator, { children: /* @__PURE__ */ i(xn, { className: "tw-h-4 tw-w-4" }) }) }),
      t
    ]
  }
));
so.displayName = we.CheckboxItem.displayName;
const hs = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  we.RadioItem,
  {
    ref: r,
    className: T(
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(we.ItemIndicator, { children: /* @__PURE__ */ i(qa, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
hs.displayName = we.RadioItem.displayName;
const En = A.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ i(
  we.Label,
  {
    ref: r,
...
const nr = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  we.Separator,
  {
    ref: n,
...
function Em({ scrRef: e, handleSubmit: t }) {
  const [n, r] = pe(""), [o, a] = pe(
    ...
    oe.bookNumberToId(e.bookNum)
  ), [u, h] = pe(!1), [w, g] = pe(u), v = gt(void 0), f = gt(void 0), m = gt(void 0), N = $e(
    (k) => tc(k).filter((B) => {
  ...
  }, [w]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(ao, { modal: !1, open: u, onOpenChange: E, children: [
    /* @__PURE__ */ i(fs, { asChild: !0, children: /* @__PURE__ */ i(
      $l,
      {
        ref: v,
        value: n,
        ...
        children: [
          ...
          ea.map(
            (k, B) => N(k).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ i(En, { className: "tw-font-semibold tw-text-foreground/80", children: Zl[k] }),
              ...
              ea.length - 1 !== B ? /* @__PURE__ */ i(nr, {}) : void 0
            ] }, k)
          )
        ]
      }
...
const ac = Nn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? wl : "button", { className: T(ac({ variant: t, size: n, className: e })), ref: a, ...o })
);
me.displayName = "Button";
const sc = Nn(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), He = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(Qa.Root, { ref: n, className: T("pr-twp", sc(), e), ...t }));
He.displayName = Qa.Root.displayName;
const gs = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  pn.Root,
  {
...
gs.displayName = pn.Root.displayName;
const Gr = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  pn.Item,
  {
    ref: n,
    className: T(
    ...
    ...t,
    children: /* @__PURE__ */ i(pn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ i(qa, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Gr.displayName = pn.Item.displayName;
const bs = wn.Root, vs = wn.Trigger, io = A.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ i(wn.Portal, { children: /* @__PURE__ */ i(
  wn.Content,
  {
    ref: o,
    align: t,
...
io.displayName = wn.Content.displayName;
const ic = Ye.Portal, ys = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ye.Overlay,
  {
    ref: n,
    className: T(
...
ys.displayName = Ye.Overlay.displayName;
const lc = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(ic, { children: [
  /* @__PURE__ */ i(ys, {}),
  /* @__PURE__ */ x(
    Ye.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ x(Ye.Close, { className: "tw-absolute tw-right-4 tw-top-4 tw-rounded-sm tw-opacity-70 tw-ring-offset-background tw-transition-opacity hover:tw-opacity-100 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-ring focus:tw-ring-offset-2 disabled:tw-pointer-events-none data-[state=open]:tw-bg-accent data-[state=open]:tw-text-muted-foreground", children: [
          /* @__PURE__ */ i(Ka, { className: "tw-h-4 tw-w-4" }),
...
const cc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ye.Title,
  {
    ref: n,
...
const dc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ye.Description,
  {
    ref: n,
...
const lo = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe,
  {
    ref: n,
    className: T(
...
const co = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
  /* @__PURE__ */ i(Ja, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
  /* @__PURE__ */ i(
    Oe.Input,
    {
      ref: n,
...
const uo = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.List,
  {
    ref: n,
...
const po = A.forwardRef((e, t) => /* @__PURE__ */ i(Oe.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
po.displayName = Oe.Empty.displayName;
const xs = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.Group,
  {
    ref: n,
    className: T(
...
xs.displayName = Oe.Group.displayName;
const uc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.Separator,
  {
    ref: n,
...
uc.displayName = Oe.Separator.displayName;
const wo = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.Item,
  {
    ref: n,
    className: T(
...
function ta({
  ...
  const [f, m] = pe(!1);
  return /* @__PURE__ */ x(bs, { open: f, onOpenChange: m, ...v, children: [
    /* @__PURE__ */ i(vs, { asChild: !0, children: /* @__PURE__ */ x(
      me,
      {
        variant: u,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ i(Za, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(io, { align: h, className: "tw-w-[200px] tw-p-0", dir: w, children: /* @__PURE__ */ x(lo, { children: [
      /* @__PURE__ */ i(co, { dir: w, placeholder: c, className: "tw-text-inherit" }),
      /* @__PURE__ */ i(po, { children: d }),
      /* @__PURE__ */ i(uo, { children: t.map((N) => /* @__PURE__ */ x(
        wo,
        {
          value: a(N),
          onSelect: () => {
...
function Cm({
  ...
  const u = Sr(d, "%webView_bookSelector_currentBook%"), h = Sr(d, "%webView_bookSelector_choose%"), w = Sr(d, "%webView_bookSelector_chooseBooks%"), [g, v] = pe(
    "current book"
    /* CURRENT_BOOK */
  ), f = (m) => {
    v(m), e(m);
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(He, { className: "tw-ml-1", children: u })
          ] }),
...
function mc({ table: e }) {
  return /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ i(ll, { asChild: !0, children: /* @__PURE__ */ x(me, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ i(Li, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ x(tr, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ i(En, { children: "Toggle columns" }),
      /* @__PURE__ */ i(nr, {}),
...
const fn = be.Root, hc = be.Group, mn = be.Value, Mt = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  be.Trigger,
  {
    ...
    children: [
      t,
      /* @__PURE__ */ i(be.Icon, { asChild: !0, children: /* @__PURE__ */ i(Qn, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
    ]
  }
));
Mt.displayName = be.Trigger.displayName;
const Ns = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  be.ScrollUpButton,
  {
    ref: n,
    className: T("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...t,
    children: /* @__PURE__ */ i(zi, { className: "tw-h-4 tw-w-4" })
  }
));
Ns.displayName = be.ScrollUpButton.displayName;
const ks = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  be.ScrollDownButton,
  {
    ref: n,
    className: T("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...t,
    children: /* @__PURE__ */ i(Qn, { className: "tw-h-4 tw-w-4" })
  }
));
ks.displayName = be.ScrollDownButton.displayName;
const Bt = A.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ i(be.Portal, { children: /* @__PURE__ */ x(
  be.Content,
  {
    ref: o,
    className: T(
...
const gc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  be.Label,
  {
    ref: n,
...
const Ue = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  be.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(be.ItemIndicator, { children: /* @__PURE__ */ i(xn, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ i(be.ItemText, { children: t })
    ]
  }
));
Ue.displayName = be.Item.displayName;
const bc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  be.Separator,
  {
    ref: n,
    className: T("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
      ...
      /* @__PURE__ */ x(
        me,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ i(Gi, { className: "tw-h-4 tw-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ x(
        me,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ i(Hi, { className: "tw-h-4 tw-w-4" })
          ]
        }
      )
    ] })
...
const rr = A.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => /* @__PURE__ */ i("div", { className: T("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !t }), children: /* @__PURE__ */ i(
  "table",
  {
    ref: r,
...
const or = A.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => /* @__PURE__ */ i(
  "thead",
  {
    ref: r,
    className: T(
...
const ar = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i("tbody", { ref: n, className: T("[&_tr:last-child]:tw-border-0", e), ...t }));
ar.displayName = "TableBody";
const yc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  "tfoot",
  {
    ref: n,
...
const hn = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  "th",
  {
    ref: n,
    className: T(
...
const jt = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  "td",
  {
    ref: n,
...
const xc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  "caption",
  {
    ref: n,
...
function Nc({
  ...
  var m;
  const [l, c] = pe([]), [d, u] = pe([]), [h, w] = pe({}), [g, v] = pe({}), f = es({
    data: t,
    columns: e,
    getCoreRowModel: ts(),
    ...n && { getPaginationRowModel: fl() },
    onSortingChange: c,
    getSortedRowModel: ns(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(rr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(or, { stickyHeader: a, children: f.getHeaderGroups().map((N) => /* @__PURE__ */ i(ot, { children: N.headers.map((I) => /* @__PURE__ */ i(hn, { children: I.isPlaceholder ? void 0 : sn(I.column.columnDef.header, I.getContext()) }, I.id)) }, N.id)) }),
      /* @__PURE__ */ i(ar, { children: (m = f.getRowModel().rows) != null && m.length ? f.getRowModel().rows.map((N) => /* @__PURE__ */ i(
        ot,
        {
          onClick: () => s(N, f),
          "data-state": N.getIsSelected() && "selected",
          children: N.getVisibleCells().map((I) => /* @__PURE__ */ i(jt, { children: sn(I.column.columnDef.cell, I.getContext()) }, I.id))
        },
        N.id
...
function kc({
  ...
  return /* @__PURE__ */ x(rr, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(or, { stickyHeader: !0, children: /* @__PURE__ */ x(ot, { children: [
...
const fo = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Fr.Root,
  {
    ref: n,
    className: T(
    ...
    children: /* @__PURE__ */ i(
      Fr.Indicator,
      {
        ...
        children: /* @__PURE__ */ i(xn, { className: "tw-h-4 tw-w-4" })
      }
    )
  }
));
...
}, Cc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Es = Nn(
...
), Sc = A.forwardRef(({ className: e, variant: t, size: n, ...r }, o) => /* @__PURE__ */ i(
  rs.Root,
  {
    ref: o,
    className: T(Es({ variant: t, size: n, className: e })),
    ...r
  }
));
Sc.displayName = rs.Root.displayName;
const Ts = A.createContext({
  size: "default",
  variant: "default"
}), Cs = A.forwardRef(({ className: e, variant: t, size: n, children: r, ...o }, a) => /* @__PURE__ */ i(
  er.Root,
  {
    ref: a,
...
const sr = (e) => e === "asc" ? /* @__PURE__ */ i(qi, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ i(Ki, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Ji, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Sm = (e) => ({
  accessorKey: "item",
  ...
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ i("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ x(me, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    sr(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: a }) => /* @__PURE__ */ i("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ x(me, { variant: "ghost", onClick: () => a.toggleSorting(void 0), children: [
    e,
    sr(a.getIsSorted())
  ] }) }),
  cell: ({ row: a }) => {
    const s = a.getValue("status"), l = a.getValue("item");
    return /* @__PURE__ */ x(Cs, { value: s, variant: "outline", type: "single", children: [
      /* @__PURE__ */ i(
        Fn,
        {
          onClick: () => Or(
  ...
  return Ec(e).forEach((u) => {
    u.startsWith("\\id") && (s = Tc(u), l = 0, c = 0), u.startsWith("\\c") && (l = na(u), c = 0), u.startsWith("\\v") && (c = na(u), l === 0 && (l = t.chapterNum));
    let h = o.exec(u) ?? void 0;
    for (; h; ) {
      const w = [];
      h.forEach((m) => w.push(m));
      const g = h.index, v = a.find((m) => to(m.items, w)), f = {
        reference: {
          bookNum: s !== void 0 ? s : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: dl(u, Math.max(0, g - 25), Math.min(g + 25, u.length))
      };
      if (v)
...
function _m({
  ...
  const h = Je(n, "%webView_inventory_all%"), w = Je(n, "%webView_inventory_approved%"), g = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), f = Je(n, "%webView_inventory_scope_currentBook%"), m = Je(n, "%webView_inventory_scope_chapter%"), N = Je(n, "%webView_inventory_scope_verse%"), I = Je(n, "%webView_inventory_filter_text%"), O = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = pe(!1), [_, L] = pe("all"), [H, C] = pe(""), [P, k] = pe([]), B = Te(() => l ? r instanceof RegExp ? Pc(
    l,
    e,
    a,
    s,
    r
  ) : r(l, e, a, s) : [], [l, r, e, a, s]), D = Te(() => {
    if (E)
      return B;
    const y = [];
    return B.forEach((S) => {
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        fn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(Bt, { children: [
              ...
              /* @__PURE__ */ i(Ue, { value: "unapproved", children: g }),
              /* @__PURE__ */ i(Ue, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ x(fn, { onValueChange: (y) => ee(y), defaultValue: c, children: [
        ...
        /* @__PURE__ */ x(Bt, { children: [
          ...
          /* @__PURE__ */ i(Ue, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ i(
        kn,
...
function $m({
  ...
  const [c, d] = pe(!1), u = $e(
    (g) => {
      r(
        n.includes(g) ? n.filter((v) => v !== g) : [...n, g]
      );
    },
    [n, r]
  ), h = () => {
    var g;
    return n.length === 1 ? ((g = e.find((v) => v.value === n[0])) == null ? void 0 : g.label) ?? o : a || o;
  }, w = Te(() => {
    if (!s)
      return e;
    const g = e.filter((f) => f.starred).sort((f, m) => f.label.localeCompare(m.label)), v = e.filter((f) => !f.starred).sort((f, m) => {
      const N = n.includes(f.value), I = n.includes(m.value);
      return N && !I ? -1 : !N && I ? 1 : f.label.localeCompare(m.label);
    });
    return [...g, ...v];
  }, [e, n, s]);
  return /* @__PURE__ */ x(bs, { open: c, onOpenChange: d, children: [
    /* @__PURE__ */ i(vs, { asChild: !0, children: /* @__PURE__ */ x(
      me,
      {
        variant: "outline",
        ...
        children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ i("div", { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50", children: /* @__PURE__ */ i("span", { className: "tw-flex tw-h-full tw-w-full tw-items-center tw-justify-center", children: l }) }),
            h()
          ] }),
          /* @__PURE__ */ i(Za, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(io, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(lo, { children: [
      /* @__PURE__ */ i(co, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ x(uo, { children: [
        /* @__PURE__ */ i(po, { children: "No item found." }),
        /* @__PURE__ */ i(xs, { children: w.map((g) => {
          const v = t ? t(g) : void 0;
          return /* @__PURE__ */ x(
            wo,
            {
              value: g.value,
              ...
              children: [
                /* @__PURE__ */ i("div", { className: "w-4", children: /* @__PURE__ */ i(
                  xn,
                  {
                    className: T(
                      "tw-h-4 tw-w-4",
                      n.includes(g.value) ? "tw-opacity-100" : "tw-opacity-0"
                    )
                  }
                ) }),
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: g.starred && /* @__PURE__ */ i(Zi, { className: "tw-h-4 tw-w-4" }) }),
                /* @__PURE__ */ i("div", { className: "tw-flex-grow", children: g.label }),
                t && /* @__PURE__ */ i("div", { className: "tw-w-10 tw-text-right tw-text-muted-foreground", children: v })
              ]
            },
            g.value
          );
...
function _c({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-relative", children: [
    /* @__PURE__ */ i(Ja, { className: "tw-absolute tw-left-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-opacity-50" }),
    /* @__PURE__ */ i(
      kn,
      {
        className: T(
...
const Ss = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Re.Root,
  {
...
Ss.displayName = Re.List.displayName;
const Os = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Re.List,
  {
    ref: n,
    className: T(
...
Os.displayName = Re.List.displayName;
const $c = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Re.Trigger,
  {
    ref: n,
    ...t,
...
)), Rs = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Re.Content,
  {
    ref: n,
    className: T(
...
Rs.displayName = Re.Content.displayName;
function Im({
  tabList: e,
  onSearch: t,
  searchPlaceholder: n,
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(Ss, { dir: a, children: [
      /* @__PURE__ */ i(Os, { children: e.map((s) => /* @__PURE__ */ i($c, { value: s.value, children: s.value }, s.key)) }),
      e.map((s) => /* @__PURE__ */ i(Rs, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
const nt = "scrBook", Ic = "scrRef", wt = "source", Ac = "details", Dc = "Scripture Reference", Mc = "Scripture Book", Ps = "Type", Bc = "Details";
function jc(e, t) {
  const n = t ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: wt,
      header: n ? (e == null ? void 0 : e.typeColumnName) ?? Ps : void 0,
...
function Am({
  ...
  const [d, u] = pe([]), [h, w] = pe([{ id: nt, desc: !1 }]), [g, v] = pe({}), f = Te(
    ...
    !t && /* @__PURE__ */ x(
      fn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Bt, { position: "item-aligned", children: /* @__PURE__ */ i(hc, { children: E.map((C) => /* @__PURE__ */ i(Ue, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(rr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ i(or, { children: N.getHeaderGroups().map((C) => /* @__PURE__ */ i(ot, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
      ...
      /* @__PURE__ */ i(ar, { children: N.getRowModel().rows.map((C, P) => /* @__PURE__ */ i(
        ot,
        {
                ...
                jt,
                {
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ x(
                    me,
                    {
                      ...
                      type: "button",
                      children: [
                        C.getIsExpanded() && /* @__PURE__ */ i(Qn, {}),
                        !C.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ i(Wa, {}) : /* @__PURE__ */ i(Qi, {})),
                        " ",
    ...
    fn,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ i(
          ...
          {
            style: { zIndex: 250 },
            children: e.map((a) => /* @__PURE__ */ i(Ue, { value: `${a}`, children: o[ue(a)] }, `${a}`))
          }
        )
      ]
    }
...
const _s = A.forwardRef(({ className: e, orientation: t = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ i(
  os.Root,
  {
    ref: o,
    decorative: n,
...
_s.displayName = os.Root.displayName;
...
function Ze(e, t, n = {
  ...
  return ht(e) && ht(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (ht(t[o]) && o in e && ht(e[o]) ? r[o] = Ze(e[o], t[o], n) : n.clone ? r[o] = ht(t[o]) ? Is(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
var Hr = { exports: {} }, Bn = { exports: {} }, se = {};
...
function Uc() {
  if (oa)
    return se;
  oa = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, a = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, d = e ? Symbol.for("react.concurrent_mode") : 60111, u = e ? Symbol.for("react.forward_ref") : 60112, h = e ? Symbol.for("react.suspense") : 60113, w = e ? Symbol.for("react.suspense_list") : 60120, g = e ? Symbol.for("react.memo") : 60115, v = e ? Symbol.for("react.lazy") : 60116, f = e ? Symbol.for("react.block") : 60121, m = e ? Symbol.for("react.fundamental") : 60117, N = e ? Symbol.for("react.responder") : 60118, I = e ? Symbol.for("react.scope") : 60119;
  function O(b) {
  ...
  return se.AsyncMode = c, se.ConcurrentMode = d, se.ContextConsumer = l, se.ContextProvider = s, se.Element = t, se.ForwardRef = u, se.Fragment = r, se.Lazy = v, se.Memo = g, se.Portal = n, se.Profiler = a, se.StrictMode = o, se.Suspense = h, se.isAsyncMode = function(b) {
    return E(b) || O(b) === c;
  }, se.isConcurrentMode = E, se.isContextConsumer = function(b) {
    return O(b) === l;
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === h || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === s || b.$$typeof === l || b.$$typeof === u || b.$$typeof === m || b.$$typeof === N || b.$$typeof === I || b.$$typeof === f);
  }, se.typeOf = O, se;
}
var ie = {};
/** @license React v16.13.1
...
function Gc() {
  return aa || (aa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function O($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === h || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === g || $.$$typeof === s || $.$$typeof === l || $.$$typeof === u || $.$$typeof === m || $.$$typeof === N || $.$$typeof === I || $.$$typeof === f);
    }
    function E($) {
    ...
    var b = c, _ = d, L = l, H = s, C = t, P = u, k = r, B = v, D = g, J = n, q = a, U = o, ee = h, ae = !1;
    function re($) {
    ...
    ie.AsyncMode = b, ie.ConcurrentMode = _, ie.ContextConsumer = L, ie.ContextProvider = H, ie.Element = C, ie.ForwardRef = P, ie.Fragment = k, ie.Lazy = B, ie.Memo = D, ie.Portal = J, ie.Profiler = q, ie.StrictMode = U, ie.Suspense = ee, ie.isAsyncMode = re, ie.isConcurrentMode = y, ie.isContextConsumer = S, ie.isContextProvider = z, ie.isElement = F, ie.isForwardRef = V, ie.isFragment = W, ie.isLazy = X, ie.isMemo = Y, ie.isPortal = G, ie.isProfiler = K, ie.isStrictMode = Z, ie.isSuspense = de, ie.isValidElementType = O, ie.typeOf = E;
  }()), ie;
}
var sa;
function As() {
  return sa || (sa = 1, process.env.NODE_ENV === "production" ? Bn.exports = Uc() : Bn.exports = Gc()), Bn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Yc() {
  if (ua)
    return Dr;
  ua = 1;
  var e = As(), t = Hc(), n = go(), r = Ds(), o = Xc(), a = function() {
  };
...
const Bs = ho(p.element, Ms);
Bs.isRequired = ho(p.element.isRequired, Ms);
const js = Bs, Qc = "exact-prop: ​";
function ed(e) {
...
function td() {
  ...
  return le.ContextConsumer = s, le.ContextProvider = a, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = w, le.Memo = h, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = d, le.SuspenseList = u, le.isAsyncMode = function() {
    return !1;
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === d || m === u || m === g || typeof m == "object" && m !== null && (m.$$typeof === w || m.$$typeof === h || m.$$typeof === a || m.$$typeof === s || m.$$typeof === c || m.$$typeof === v || m.getModuleId !== void 0);
  }, le.typeOf = f, le;
}
var ce = {};
/**
...
function nd() {
  return fa || (fa = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, f = !1, m = !1, N = !1, I = !1, O;
    O = Symbol.for("react.module.reference");
    function E(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || I || j === r || j === d || j === u || N || j === g || v || f || m || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === h || j.$$typeof === a || j.$$typeof === s || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var _ = s, L = a, H = e, C = c, P = n, k = w, B = h, D = t, J = o, q = r, U = d, ee = u, ae = !1, re = !1;
    function y(j) {
...
const sd = p.oneOfType([p.func, p.object]), Ls = sd;
function We(e) {
  if (typeof e != "string")
...
function _d(e) {
  ...
  function d(w, g) {
    const v = s.indexOf(g);
    return `@media (min-width:${typeof t[w] == "number" ? t[w] : w}${n}) and (max-width:${(v !== -1 && typeof t[s[v]] == "number" ? t[s[v]] : g) - r / 100}${n})`;
  }
  function u(w) {
...
he.propTypes = process.env.NODE_ENV !== "production" ? dr.reduce((e, t) => (e[t] = it, e), {}) : {};
he.filterProps = dr;
function ge(e) {
  return qs(e, ur);
}
ge.propTypes = process.env.NODE_ENV !== "production" ? ur.reduce((e, t) => (e[t] = it, e), {}) : {};
ge.filterProps = ur;
...
const Hd = Le("border", Me), Xd = Le("borderTop", Me), Yd = Le("borderRight", Me), Wd = Le("borderBottom", Me), qd = Le("borderLeft", Me), Kd = Le("borderColor"), Jd = Le("borderTopColor"), Zd = Le("borderRightColor"), Qd = Le("borderBottomColor"), eu = Le("borderLeftColor"), tu = Le("outline", Me), nu = Le("outlineColor"), wr = (e) => {
...
function Eu() {
  ...
  function t(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const u = Dd(a.breakpoints), h = Object.keys(u);
      let w = u;
...
function ko(e = {}, ...t) {
  ...
  return d.applyStyles = Tu, d = t.reduce((u, h) => Ze(u, h), d), d.unstable_sxConfig = R({}, xo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(h) {
    return No({
      sx: h,
      theme: this
    });
...
const Au = ko(), ka = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function jn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Mu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    yl(s, (b) => b.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    let N = Un;
    d === "Root" || d === "root" ? N = r : d ? N = o : Iu(s) && (N = void 0);
    const I = bl(s, R({
      shouldForwardProp: N,
      label: m
    }, g)), O = (b) => typeof b == "function" && b.__emotion_real !== b || ht(b) ? (_) => Gn(b, R({}, _, {
      theme: jn({
        theme: _.theme,
        defaultTheme: n,
        themeId: t
...
function Ea(e) {
  e = Nt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Nt(Lu(e)).values : e.values;
...
const Gu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, $t = Zu, Qu = ["mode", "contrastThreshold", "tonalOffset"], Ca = {
...
const theme2 = createTheme({ palette: {
  ...
  return process.env.NODE_ENV !== "production" && (g[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), Ze(R({
...
function cp(e, t) {
  ...
  const g = o / 14, v = h || ((N) => `${N / d * g}rem`), f = (N, I, O, E, b) => R({
    fontFamily: r,
    fontWeight: N,
    fontSize: v(I),
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((u) => `${u} ${typeof s == "string" ? s : Pa(s)} ${l} ${typeof c == "string" ? c : Pa(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: n
...
function kp(e = {}, ...t) {
  ...
  if (d = Ze(d, s), d = t.reduce((u, h) => Ze(u, h), d), process.env.NODE_ENV !== "production") {
    const u = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], h = (w, g) => {
      let v;
      for (v in w) {
        const f = w[v];
...
`));
  ...
  return d.unstable_sxConfig = R({}, xo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(h) {
    return No({
      sx: h,
      theme: this
    });
...
const Tp = (e) => Un(e) && e !== "classes", Cp = Mu({
  themeId: Co,
  defaultTheme: To,
...
const Op = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Rp = (e) => {
  ...
  const r = So({
    ...
    titleAccess: h,
    viewBox: w = "0 0 24 24"
  } = r, g = Ne(r, Op), v = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", f = R({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
var ti = mo.default = void 0, Mp = Dp(Ap()), Bp = Di;
ti = mo.default = (0, Mp.default)(/* @__PURE__ */ (0, Bp.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function jp(e) {
...
function Gp(e) {
  ...
  if (!t) {
    const g = bt(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = R({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = R({}, n, o, r);
    return g.length > 0 && (f.className = g), Object.keys(v).length > 0 && (f.style = v), {
      props: f,
      internalRef: void 0
    };
  }
  const s = Fp(R({}, o, r)), l = Ia(r), c = Ia(o), d = t(s), u = bt(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = R({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = R({}, d, n, c, l);
...
function Xp(e) {
  ...
  const {
    ...
    externalSlotProps: l
  })), u = xt(d, l == null ? void 0 : l.ref, (t = e.additionalProps) == null ? void 0 : t.ref);
  return on(n, R({}, c, {
    ref: u
  }), o);
}
...
var Ce = "top", je = "bottom", Ve = "right", Se = "left", Ro = "auto", Rn = [Ce, je, Ve, Se], zt = "start", vn = "end", Jp = "clippingParents", oi = "viewport", en = "popper", Zp = "reference", Aa = /* @__PURE__ */ Rn.reduce(function(e, t) {
  return e.concat([t + "-" + zt, t + "-" + vn]);
}, []), ai = /* @__PURE__ */ [].concat(Rn, [Ro]).reduce(function(e, t) {
...
function Ut(e, t, n) {
  ...
  var s = kt(e) ? Ae(e) : window, l = s.visualViewport, c = !si() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / a, h = r.width / o, w = r.height / a;
  return {
    width: h,
    height: w,
    top: u,
...
function Pn(e) {
  for (var t = Ae(e), n = Da(e); n && pw(n) && et(n).position === "static"; )
    n = Da(n);
...
var mw = function(t, n) {
  ...
  })) : t, ci(typeof t != "number" ? t : di(t, Rn));
};
function hw(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Xe(n.placement), c = $o(l), d = [Se, Ve].indexOf(l) >= 0, u = d ? "height" : "width";
  if (!(!a || !s)) {
    var h = mw(o.padding, n), w = _o(a), g = c === "y" ? Ce : Se, v = c === "y" ? je : Ve, f = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], m = s[c] - n.rects.reference[c], N = Pn(a), I = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, O = f / 2 - m / 2, E = h[g], b = I - w[u] - h[v], _ = I / 2 - w[u] / 2 + O, L = dn(E, _, b), H = c;
...
function Ma(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, u = e.roundOffsets, h = e.isFixed, w = s.x, g = w === void 0 ? 0 : w, v = s.y, f = v === void 0 ? 0 : v, m = typeof u == "function" ? u({
    x: g,
    y: f
  }) : {
    x: g,
  ...
  g = m.x, f = m.y;
  var N = s.hasOwnProperty("x"), I = s.hasOwnProperty("y"), O = Se, E = Ce, b = window;
  if (d) {
    ...
    if (_ === Ae(n) && (_ = lt(n), et(_).position !== "static" && l === "absolute" && (L = "scrollHeight", H = "scrollWidth")), _ = _, o === Ce || (o === Se || o === Ve) && a === vn) {
      E = je;
      var C = h && _ === b && b.visualViewport ? b.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        _[L]
      );
    ...
    if (o === Se || (o === Ce || o === je) && a === vn) {
      O = Ve;
      var P = h && _ === b && b.visualViewport ? b.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        _[H]
      );
      g -= P - r.width, g *= c ? 1 : -1;
  ...
  if (g = B.x, f = B.y, c) {
    var D;
    return Object.assign({}, k, (D = {}, D[E] = I ? "0" : "", D[O] = N ? "0" : "", D.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + f + "px)" : "translate3d(" + g + "px, " + f + "px, 0)", D));
  }
  return Object.assign({}, k, (t = {}, t[E] = I ? f + "px" : "", t[O] = N ? g + "px" : "", t.transform = "", t));
}
function xw(e) {
...
function Ow(e) {
  var t, n = lt(e), r = Io(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = vt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = vt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Ao(e), c = -r.scrollTop;
...
function ui(e) {
  return ["html", "body", "#document"].indexOf(qe(e)) >= 0 ? e.ownerDocument.body : Be(e) && Do(e) ? e : ui(br(e));
}
function un(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ui(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), a = Ae(r), s = o ? [a].concat(a.visualViewport || [], Do(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function ja(e, t, n) {
  return t === oi ? Kr(Sw(e, n)) : kt(t) ? Rw(t, n) : Kr(Ow(lt(e)));
}
function Pw(e) {
  var t = un(br(e)), n = ["absolute", "fixed"].indexOf(et(e).position) >= 0, r = n && Be(e) ? Pn(e) : e;
  return kt(r) ? t.filter(function(o) {
    return kt(o) && ii(o, r) && qe(o) !== "body";
  }) : [];
}
function _w(e, t, n, r) {
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, s = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Jp : l, d = n.rootBoundary, u = d === void 0 ? oi : d, h = n.elementContext, w = h === void 0 ? en : h, g = n.altBoundary, v = g === void 0 ? !1 : g, f = n.padding, m = f === void 0 ? 0 : f, N = ci(typeof m != "number" ? m : di(m, Rn)), I = w === en ? Zp : en, O = e.rects.popper, E = e.elements[v ? I : w], b = _w(kt(E) ? E : E.contextElement || lt(e.elements.popper), c, u, s), _ = Ut(e.elements.reference), L = pi({
    reference: _,
    element: O,
    strategy: "absolute",
    placement: o
  }), H = Kr(Object.assign({}, O, L)), C = w === en ? H : _, P = {
    top: b.top - C.top + N.top,
    bottom: C.bottom - b.bottom + N.bottom,
    left: b.left - C.left + N.left,
    right: C.right - b.right + N.right
...
function $w(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? ai : c, u = Gt(r), h = u ? l ? Aa : Aa.filter(function(v) {
    return Gt(v) === u;
...
function Aw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, h = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, m = t.options.placement, N = Xe(m), I = N === m, O = c || (I || !v ? [Hn(m)] : Iw(m)), E = [m].concat(O).reduce(function(V, W) {
    ...
    }, []), b = t.rects.reference, _ = t.rects.popper, L = /* @__PURE__ */ new Map(), H = !0, C = E[0], P = 0; P < E.length; P++) {
...
function Mw(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, s = yn(t, {
    ...
    altBoundary: !0
  }), c = Va(s, r), d = Va(l, o, a), u = La(c), h = La(d);
  t.modifiersData[n] = {
...
function jw(e, t, n) {
  ...
  return s = s || 0, l = (l || 0) * o, [Se, Ve].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function Vw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, a = o === void 0 ? [0, 0] : o, s = ai.reduce(function(u, h) {
    return u[h] = jw(h, t.rects, a), u;
...
function Gw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, h = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: u
  }), N = Xe(t.placement), I = Gt(t.placement), O = !I, E = $o(N), b = Uw(E), _ = t.modifiersData.popperOffsets, L = t.rects.reference, H = t.rects.popper, C = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, P = typeof C == "number" ? {
    mainAxis: C,
    altAxis: C
  ...
  if (_) {
    if (a) {
      var D, J = E === "y" ? Ce : Se, q = E === "y" ? je : Ve, U = E === "y" ? "height" : "width", ee = _[E], ae = ee + m[J], re = ee - m[q], y = g ? -H[U] / 2 : 0, S = I === zt ? L[U] : H[U], z = I === zt ? -H[U] : -L[U], F = t.elements.arrow, V = g && F ? _o(F) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : li(), X = W[J], Y = W[q], G = dn(0, L[U], V[U]), K = O ? L[U] / 2 - y - G - X - P.mainAxis : S - G - X - P.mainAxis, Z = O ? -L[U] / 2 + y + G + Y + P.mainAxis : z + G + Y + P.mainAxis, de = t.elements.arrow && Pn(t.elements.arrow), $ = de ? E === "y" ? de.clientTop || 0 : de.clientLeft || 0 : 0, xe = (D = k == null ? void 0 : k[E]) != null ? D : 0, j = ee + K - xe - $, ye = ee + Z - xe, ze = dn(g ? Kn(ae, j) : ae, ee, g ? vt(re, ye) : re);
      _[E] = ze, B[E] = ze - ee;
    }
    if (l) {
      var ct, ke = E === "x" ? Ce : Se, $n = E === "x" ? je : Ve, Fe = _[b], Et = b === "y" ? "height" : "width", dt = Fe + m[ke], Tt = Fe - m[$n], Ct = [Ce, Se].indexOf(N) !== -1, St = (ct = k == null ? void 0 : k[b]) != null ? ct : 0, ut = Ct ? dt : Fe - L[Et] - H[Et] - St + P.altAxis, Xt = Ct ? Fe + L[Et] + H[Et] - St - P.altAxis : Tt, In = g && Ct ? fw(ut, Fe, Xt) : dn(g ? ut : dt, Fe, g ? Xt : Tt);
      _[b] = In, B[b] = In - Fe;
    }
    t.modifiersData[r] = B;
  }
    ...
    var u = {
      ...
      setOptions: function(N) {
        ...
        f(), u.options = Object.assign({}, a, u.options, I), u.scrollParents = {
          reference: kt(l) ? un(l) : l.contextElement ? un(l.contextElement) : [],
          popper: un(c)
        };
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (Fa(I, O)) {
            u.rects = {
              reference: qw(I, Pn(O), u.options.strategy === "fixed"),
              popper: _o(O)
            ...
            for (var E = 0; E < u.orderedModifiers.length; E++) {
              ...
              var b = u.orderedModifiers[E], _ = b.fn, L = b.options, H = L === void 0 ? {} : L, C = b.name;
...
const cf = () => bo({
  ...
  } = t, m = Ne(t, of), N = M.useRef(null), I = xt(N, n), O = M.useRef(null), E = xt(O, w), b = M.useRef(E);
  Lt(() => {
    b.current = E;
  }, [E]), M.useImperativeHandle(w, () => O.current, []);
  const _ = sf(u, s), [L, H] = M.useState(_), [C, P] = M.useState(Jn(o));
  M.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: m = {},
    slots: N = {}
  } = t, I = Ne(t, af), [O, E] = M.useState(!0), b = () => {
    E(!1);
  }, _ = () => {
    E(!0);
  };
...
var ff = function(t) {
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== mt && s !== At && (a = mt) : (s === mt || s === At) && (a = Zr);
    }
    ...
    if (o === void 0 && (o = !1), a !== null)
      if (this.cancelNextCallback(), a === mt) {
        if (this.props.unmountOnExit || this.props.mountOnEnter) {
          var s = this.props.nodeRef ? this.props.nodeRef.current : Mn.findDOMNode(this);
          s && ff(s);
        }
        this.performEnter(o);
      } else
    ...
    var a = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Mn.findDOMNode(this), l], d = c[0], u = c[1], h = this.getTimeouts(), w = l ? h.appear : h.enter;
    if (!o && !s || Ua.disabled) {
      this.safeSetState({
        status: At
      }, function() {
    ...
    var o = this, a = this.props.exit, s = this.getTimeouts(), l = this.props.nodeRef ? void 0 : Mn.findDOMNode(this);
    if (!a || Ua.disabled) {
      this.safeSetState({
        status: ft
      }, function() {
    ...
    var s = this.props.nodeRef ? this.props.nodeRef.current : Mn.findDOMNode(this), l = o == null && !this.props.addEndListener;
    if (!s || l) {
    ...
    return (
      ...
      /* @__PURE__ */ A.createElement(hi.Provider, {
        value: null
      }, typeof s == "function" ? s(o, l) : A.cloneElement(A.Children.only(s), l))
    );
  }, t;
}(A.Component);
tt.contextType = hi;
...
const bf = {
  ...
  } = t, N = Ne(t, gf), I = rn(), O = M.useRef(), E = mi(), b = M.useRef(null), _ = xt(b, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = b.current;
  ...
  return /* @__PURE__ */ i(m, R({
    ...
    onExiting: k,
    addEndListener: (q) => {
      f === "auto" && I.start(O.current || 0, q), r && r(b.current, q);
    },
...
Mo.muiSupportAuto = !0;
const Ha = Mo, vf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], yf = On(fi, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), gi = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r;
  const o = Js(), a = So({
    props: t,
    name: "MuiPopper"
    ...
    slots: O,
    slotProps: E
  } = a, b = Ne(a, vf), _ = (r = O == null ? void 0 : O.root) != null ? r : c == null ? void 0 : c.Root, L = R({
    anchorEl: s,
    container: u,
    disablePortal: h,
    keepMounted: w,
...
const Nf = Ys("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), rt = Nf, kf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Ef(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Tf = (e) => {
  ...
  backgroundColor: e.vars ? e.vars.palette.Tooltip.bg : Qs(e.palette.grey[700], 0.92),
  ...
  color: e.vars ? e.vars.palette.Tooltip.bg : Qs(e.palette.grey[700], 0.9),
  "&::before": {
    content: '""',
    margin: "auto",
    display: "block",
...
const vi = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, s, l, c, d, u, h, w, g, v, f, m, N, I, O, E, b;
  const _ = So({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: H
  }), ze = mi(), ct = ze.direction === "rtl", [ke, $n] = M.useState(), [Fe, Et] = M.useState(null), dt = M.useRef(!1), Tt = J || re, Ct = rn(), St = rn(), ut = rn(), Xt = rn(), [In, Bo] = Fs({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const yr = zs(y), Yt = M.useRef(), An = Yr(() => {
  ...
  const jo = (Q) => {
    ...
    dt.current && Q.type !== "touchstart" || (ke && ke.removeAttribute("title"), St.clear(), ut.clear(), U || Ln && ee ? St.start(Ln ? ee : U, () => {
      jo(Q);
    }) : jo(Q));
  }, Vo = (Q) => {
    St.clear(), ut.start(S, () => {
    ...
    onFocus: Ei,
    ref: Ti
  } = Us(), [, zo] = M.useState(!1), Fo = (Q) => {
    ki(Q), Lo.current === !1 && (zo(!1), Vo(Q));
  }, Uo = (Q) => {
    ke || $n(Q.currentTarget), Ei(Q), Lo.current === !0 && (zo(!0), xr(Q));
  }, Go = (Q) => {
    dt.current = !0;
    const Pe = ye.props;
    Pe.onTouchStart && Pe.onTouchStart(Q);
  }, Ho = xr, Xo = Vo, Ci = (Q) => {
    Go(Q), ut.clear(), Ct.clear(), An(), Yt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Xt.start(ae, () => {
  ...
  const Oi = xt(ye.ref, Ti, $n, n);
  !de && de !== 0 && (Ke = !1);
  const Nr = M.useRef(), Ri = (Q) => {
    const Pe = ye.props;
...
`));
  ...
  const qt = {};
  q || (De.onTouchStart = Ci, De.onTouchEnd = Si), D || (De.onMouseOver = zn(Ho, De.onMouseOver), De.onMouseLeave = zn(Xo, De.onMouseLeave), Tt || (qt.onMouseOver = Ho, qt.onMouseLeave = Xo)), B || (De.onFocus = zn(Uo, De.onFocus), De.onBlur = zn(Fo, De.onBlur), Tt || (qt.onFocus = Uo, qt.onBlur = Fo)), process.env.NODE_ENV !== "production" && ye.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ye.props.title}\` or the Tooltip component.`].join(`
`));
  const Pi = M.useMemo(() => {
    var Q;
    let Pe = [{
    ...
    touch: dt.current
  }), Er = Tf(Kt), Yo = (r = (o = Z.popper) != null ? o : C.Popper) != null ? r : Cf, Wo = (a = (s = (l = Z.transition) != null ? l : C.Transition) != null ? s : $) != null ? a : Ha, qo = (c = (d = Z.tooltip) != null ? d : C.Tooltip) != null ? c : Sf, Ko = (u = (h = Z.arrow) != null ? h : C.Arrow) != null ? u : Of, _i = on(Yo, R({}, G, (w = K.popper) != null ? w : P.popper, {
    className: bt(Er.popper, G == null ? void 0 : G.className, (g = (v = K.popper) != null ? v : P.popper) == null ? void 0 : g.className)
  }), Kt), $i = on(Wo, R({}, xe, (f = K.transition) != null ? f : P.transition), Kt), Ii = on(qo, R({}, (m = K.tooltip) != null ? m : P.tooltip, {
    className: bt(Er.tooltip, (N = (I = K.tooltip) != null ? I : P.tooltip) == null ? void 0 : N.className)
  }), Kt), Ai = on(Ko, R({}, (O = K.arrow) != null ? O : P.arrow, {
    className: bt(Er.arrow, (E = (b = K.arrow) != null ? b : P.arrow) == null ? void 0 : E.className)
  }), Kt);
  return /* @__PURE__ */ x(M.Fragment, {
    children: [/* @__PURE__ */ M.cloneElement(ye, De), /* @__PURE__ */ i(Yo, R({
      as: Y ?? bi,
      placement: X,
      anchorEl: re ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(qo, R({}, Ii, {
          children: [de, L ? /* @__PURE__ */ i(Ko, R({}, Ai, {
            ref: Et
          })) : null]
        }))
      }))
...
const Rf = vi;
function Ya(e, t, n) {
  return e ? /* @__PURE__ */ i(as, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ i("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function yi(e) {
  const {
    onClick: t,
    ...
    xl,
    {
      ...
      onClick: t,
      id: f,
      children: n ? /* @__PURE__ */ x(st, { children: [
        Ya(a, n, !0),
        /* @__PURE__ */ i(Nl, { primary: n, inset: !a && o }),
        h ? /* @__PURE__ */ i(as, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(ti, {}) }) : Ya(s, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ i(Rf, { title: r, placement: "right", children: /* @__PURE__ */ i("div", { children: N }) }) : N;
}
function xi(e) {
...
function Pf(e) {
  const [t, n] = pe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = e, s = (d) => {
    ...
    let d = xi(a).filter((u) => "menuItem" in u.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return d = d.filter(
      (u) => "menuItem" in u.group && u.group.menuItem === r.id
    ), /* @__PURE__ */ i(Ni, { ...e, includedGroups: d });
  };
  return /* @__PURE__ */ x(st, { children: [
    /* @__PURE__ */ i(yi, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ i(
      kl,
      {
        anchorEl: t,
...
function Ni(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: a, allowForLeadingIcons: s } = Te(() => {
    const u = o && o.length > 0 ? o : (
      // We're apparently laying out a single-column menu (presumably a context menu). In this
      // case, all groups should be included except ones that belong to a submenu.
      xi(t).filter((v) => !("menuItem" in v.group))
...
function $f(e) {
  ...
  )), /* @__PURE__ */ i(Ni, { ...e, includedGroups: a });
}
function If({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ x(
    ss,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ i(El, { id: n, dense: !0, className: a ?? "", children: /* @__PURE__ */ i(
          $f,
          {
            commandHandler: e,
            menuDefinition: t,
...
function Bf({
  ...
  at(() => {
    if (c) {
      ...
      if (E) {
        const b = E.getBoundingClientRect(), _ = window.scrollY, L = window.scrollX, H = b.top + _ + E.clientHeight, C = b.left + L;
        m({ top: H, left: C });
      }
    }
  }, [c, o]);
...
const _n = Zn(({ className: e, ...t }, n) => /* @__PURE__ */ i(el, { size: 35, className: T("tw-animate-spin", e), ...t, ref: n }));
...
function Fm({
  ...
  const a = gt(void 0);
  return /* @__PURE__ */ i("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ i(Cl, { position: "static", id: r, children: /* @__PURE__ */ x(
    Sl,
    {
...
), Vf = A.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: T(jf({ variant: t }), e), ...n }));
...
const zf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i("div", { ref: n, className: T("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
...
function Um({ className: e, variant: t, ...n }) {
  return /* @__PURE__ */ i("div", { className: T("pr-twp", Ff({ variant: t }), e), ...n });
}
...
const Xf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i("p", { ref: n, className: T("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
const Kf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ur.Root,
  {
    className: T(
...
const Hm = Re.Root, Jf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Re.List,
  {
    ref: n,
    className: T(
...
const Zf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Re.Trigger,
  {
    ref: n,
    className: T(
...
const Qf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Re.Content,
  {
    ref: n,
    className: T(
...
function Xm({
  ...
  return /* @__PURE__ */ i(
    me,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ i(_n, { size: 15 }) : /* @__PURE__ */ x(st, { children: [
        /* @__PURE__ */ i(tl, { size: 25, className: T("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Ym({
  ...
  return /* @__PURE__ */ i(
    me,
    {
      ...
      onClick: t,
      ...r,
      children: e ? /* @__PURE__ */ x(st, { children: [
...
function Km({
  ...
  return /* @__PURE__ */ i("div", { id: e, className: T("pr-twp tw-prose", n), children: /* @__PURE__ */ i(Pl, { options: o, children: t }) });
}
const em = Zn((e, t) => /* @__PURE__ */ x(
  me,
  {
    ...
    ...e,
    children: [
      /* @__PURE__ */ i(nl, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ i(
        Qn,
        {
...
function Jm({ id: e, groups: t }) {
  return /* @__PURE__ */ i("div", { id: e, children: /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ i(fs, { asChild: !0, children: /* @__PURE__ */ i(em, {}) }),
    /* @__PURE__ */ i(tr, { children: t.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ i(En, { children: n.label }),
      /* @__PURE__ */ i(Hl, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(so, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(hs, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(nr, {})
    ] }, n.label)) })
  ] }) });
}
...
function nm({ id: e, versionHistory: t }) {
  ...
  function a(l) {
    ...
    let g = "";
    return u > 0 ? g = `${u.toString()} year${u === 1 ? "" : "s"} ago` : h > 0 ? g = `${h.toString()} month${h === 1 ? "" : "s"} ago` : w === 0 ? g = "today" : g = `${w.toString()} day${w === 1 ? "" : "s"} ago`, g;
  }
...
function eh({
  ...
  return /* @__PURE__ */ i("div", { id: e, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ x("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ i(nm, { versionHistory: o }),
