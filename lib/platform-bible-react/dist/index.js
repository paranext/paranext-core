...
var Si = (t, e, r) => e in t ? zi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Mt = (t, e, r) => Si(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Lt, Z as Di, B as j, c as h, a as Ri, g as $e, b as ja, C as Ee, A as ve, P as Te, d as Pe, e as ze, f as Ve, h as Ie, i as we, j as Ir, k as $i, l as Qo, m as Mi, n as ca, o as uo, u as Oi, p as tn, q as Ai, s as Pi, t as po, v as kr, w as Zr, T as te, S as Ze, x as ee, y as re, z as ae, D as Ke, E as vr, F as ke, G as _e, H as Ne, I as Vi, J as _r, K as Ge, L as Me, M as Ea, N as en, O as Ii, Q as Bi, R as rn, U as an, V as Li, W as Fi, X as ji, Y as Ui, _ as qi, $ as la, a0 as da, a1 as nr, a2 as Ki, a3 as Gi, a4 as Hi, a5 as Yi, a6 as Wi, a7 as Nr, a8 as Ua } from "./resizable-BhRKzO_u.js";
import { a9 as Ph, aa as Vh, ab as Ih, ac as Bh, ad as Lh, ae as Fh, af as jh, ag as Uh, ah as qh } from "./resizable-BhRKzO_u.js";
import { jsx as a, jsxs as w, Fragment as Q } from "react/jsx-runtime";
import { Canon as Wt } from "@sillsdev/scripture";
import { Check as Oe, Clock as ho, ArrowLeft as Xi, ArrowRight as Ji, ChevronDown as Qe, BoldIcon as Zi, ItalicIcon as Qi, X as Qr, AtSign as on, Pencil as ts, Trash2 as es, ArrowUp as nn, MoreHorizontal as rs, MailOpen as as, Mail as os, ChevronUp as ns, FilterIcon as is, ArrowLeftIcon as ss, ChevronLeftIcon as cs, ChevronRightIcon as ls, ArrowRightIcon as ds, Copy as sn, Filter as ws, User as us, Link as ps, CircleHelp as hs, ChevronsUpDown as cn, Star as gs, Undo as fs, Redo as ms, SquareX as ln, FunctionSquare as dn, SquareSigma as wn, Ban as vs, AlertCircle as Ta, CircleCheckIcon as bs, CircleXIcon as xs, CircleHelpIcon as ys, ArrowUpIcon as ks, ArrowDownIcon as _s, Search as Ns, LoaderCircle as Cs, ScrollText as Es, ChevronRight as Ts, ChevronLeft as zs, MenuIcon as Ss, Menu as Ds, EllipsisVertical as Rs, MoreVertical as go } from "lucide-react";
import { Section as lt, formatScrRef as xe, getSectionForBook as gr, formatRelativeDate as $s, formatReplacementString as be, sanitizeHtml as Ms, NumberFormat as Os, formatBytes as As, getCurrentLocale as Ps, usfmMarkers as Br, getFormatCallerFunction as Vs, deepEqual as Is, isString as fo, compareScrRefs as za, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Bs, getLocalizeKeyForScrollGroupId as mo } from "platform-bible-utils";
import wt, { useRef as K, useMemo as B, useState as N, useCallback as L, useEffect as Y, useLayoutEffect as Xt, createContext as qa, useContext as un, Component as Ls, createElement as vo, Suspense as Fs, forwardRef as ta, Fragment as pn } from "react";
import { Dialog as ue, Label as js, RadioGroup as Sa, ToggleGroup as hn, Slot as ir, Avatar as Ka, Select as At, Checkbox as bo, Tabs as ce, Menubar as ge, ContextMenu as zt, Progress as xo, Slider as Mr, Switch as yo } from "radix-ui";
import { createEditor as gn, $getRoot as Ae, $createParagraphNode as Cr, $getSelection as Bt, HISTORY_MERGE_TAG as Ga, ParagraphNode as fn, TextNode as mn, $getPreviousSelection as Us, $isRangeSelection as pe, $caretFromPoint as qs, $getSiblingCaret as vn, $getChildCaret as Ks, $getAdjacentChildCaret as Gs, $isChildCaret as Hs, $normalizeCaret as Ys, $setSelectionFromCaretRange as Ws, $getCollapsedCaretRange as Xs, $getCaretInDirection as ko, $splitAtPointCaretNext as Js, $isTextPointCaret as Zs, $findMatchingParent as bn, $isElementNode as br, mergeRegister as Ce, getDOMTextNode as Qs, isHTMLElement as tc, CLEAR_EDITOR_COMMAND as xn, COMMAND_PRIORITY_EDITOR as Ha, shallowMergeConfig as ec, defineExtension as oe, safeCast as He, createState as rc, FORMAT_TEXT_COMMAND as yn, $isNodeSelection as kn, COMMAND_PRIORITY_LOW as _n, RootNode as ac, LineBreakNode as oc, TabNode as nc, $isEditorState as ic, createCommand as sc, CLICK_COMMAND as cc, isDOMNode as lc, $getNodeFromDOMNode as dc, $createNodeSelection as wc, $setSelection as uc, $getEditor as pc, DecoratorNode as Da, $getState as hc, toggleTextFormatType as _o, TEXT_TYPE_TO_FORMAT as gc, $setState as fc, addClassNamesToElement as Nn, $create as mc, $getNodeByKey as vc, removeClassNamesFromElement as bc, KEY_TAB_COMMAND as xc, $isBlockElementNode as yc, $createRangeSelection as kc, $normalizeSelection__EXPERIMENTAL as _c, OUTDENT_CONTENT_COMMAND as Nc, INDENT_CONTENT_COMMAND as No, INSERT_TAB_COMMAND as Cc, COMMAND_PRIORITY_CRITICAL as Ya, $isDecoratorNode as Ec, $isParagraphNode as Tc, $isTextNode as Ra, SELECTION_CHANGE_COMMAND as Cn, $insertNodes as zc } from "lexical";
import { HeadingNode as Sc, QuoteNode as Dc, registerRichText as Rc } from "@lexical/rich-text";
import { flushSync as $c, createPortal as Mc } from "react-dom";
import { IconX as Oc, IconCheck as ea, IconChevronDown as Ac, IconChevronUp as Pc, IconSelector as Vc, IconLayoutSidebar as Ic, IconLayoutSidebarRight as Bc, IconChevronRight as En, IconLoader as Lc, IconAlertOctagon as Fc, IconAlertTriangle as jc, IconInfoCircle as Uc, IconCircleCheck as qc } from "@tabler/icons-react";
import { $isTableSelection as Kc } from "@lexical/table";
...
import { useReactTable as zn, getFilteredRowModel as Yc, getSortedRowModel as Sn, getPaginationRowModel as Wc, getCoreRowModel as Dn, flexRender as fr, getGroupedRowModel as Xc, getExpandedRowModel as Jc } from "@tanstack/react-table";
import Zc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as $a, HIDDEN_NOTE_CALLER as Ma, getDefaultViewOptions as Qc, isInsertEmbedOpOfType as Or, Editorial as tl } from "@eten-tech-foundation/platform-editor";
...
import { toast as Gh } from "sonner";
function Oa({ ...t }) {
  return /* @__PURE__ */ a(ue.Root, { "data-slot": "dialog", ...t });
}
function $u({ ...t }) {
  return /* @__PURE__ */ a(ue.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function ol({ ...t }) {
  return /* @__PURE__ */ a(ue.Portal, { "data-slot": "dialog-portal", ...t });
}
function Mu({ ...t }) {
  return /* @__PURE__ */ a(ue.Close, { "data-slot": "dialog-close", ...t });
}
function nl({
  className: t,
  ...
  return /* @__PURE__ */ w(ol, { children: [
    ...
    /* @__PURE__ */ w(
      ue.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ue.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ w(j, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Oc, {}),
...
function Co({
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ue.Close, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Rn({
  ...
  const p = K(!1), f = () => {
    u || (p.current || o == null || o(e), setTimeout(() => {
      p.current = !1;
    }, 100));
  }, g = (v) => {
    if (u) {
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      className: h(
        ...
        {
          "tw:border-s-red-200": i === lt.OT,
          "tw:border-s-purple-200": i === lt.NT,
          "tw:border-s-indigo-200": i === lt.DC,
          "tw:border-s-amber-200": i === lt.Extra
        }
      ),
      children: /* @__PURE__ */ w(
        Ee,
        {
          ...
          disabled: u,
          className: h(s, u && "tw:cursor-not-allowed tw:opacity-50"),
          children: [
            c && /* @__PURE__ */ a(
              Oe,
              {
...
function il({
  ...
  return /* @__PURE__ */ w(Te, { open: u, onOpenChange: p, children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(
      j,
      {
        ...
        className: d,
        "aria-label": n,
        children: /* @__PURE__ */ a(ho, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ a(ze, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(we, { heading: i, children: t.map((g) => /* @__PURE__ */ w(
      Ee,
      {
        onSelect: () => f(g),
        className: h("tw:flex tw:items-center", c),
        children: [
          /* @__PURE__ */ a(ho, { className: "tw:mr-2 tw:h-4 tw:w-4 tw:opacity-50" }),
...
function Mn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(we, { children: /* @__PURE__ */ a("div", { className: h("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function pa({
  ...
  const C = Lt(), [y, _] = N(!1), [V, F] = N(""), [I, $] = N(""), [x, z] = N("books"), [A, D] = N(void 0), [R, W] = N(
    void 0
  ), [q, M] = N(void 0), [Z, ft] = N(!1), st = K(null), Ft = K(!1), vt = K(void 0), St = K(void 0), U = K(void 0), et = K(void 0), at = K({}), ot = K({}), nt = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Pt = B(() => o ? o() : $i, [o]), mt = B(() => ({
    [lt.OT]: Pt.filter((G) => Wt.isBookOT(G)),
    [lt.NT]: Pt.filter((G) => Wt.isBookNT(G)),
    [lt.DC]: Pt.filter((G) => Wt.isBookDC(G)),
    [lt.Extra]: Pt.filter((G) => Wt.extraBooks().includes(G))
  }), [Pt]), jt = B(() => Object.values(mt).flat(), [mt]), Ut = B(() => {
    if (!I.trim()) return mt;
    const b = {
      [lt.OT]: [],
      [lt.NT]: [],
    ...
    return [lt.OT, lt.NT, lt.DC, lt.Extra].forEach((J) => {
      b[J] = mt[J].filter((Ct) => Qo(Ct, I, n));
    }), b;
  }, [mt, I, n]), S = B(
    () => Mi(I, jt, n),
    [I, jt, n]
  ...
  const Vt = L(() => {
    if (S) {
      const b = S.chapterNum ?? 1, G = S.verseNum ?? 1;
      if (u && ca(S.book, b, G, u))
        return;
      nt({
        book: S.book,
        chapterNum: b,
    ...
    (b) => {
      const G = R ?? (S == null ? void 0 : S.book), J = q ?? (S == null ? void 0 : S.chapterNum);
      !G || !J || (nt({
        book: G,
        chapterNum: J,
        verseNum: b
    ...
    (b) => {
      const G = x === "chapters" ? A : S == null ? void 0 : S.book;
      if (G) {
        if (l && l(G, b) > 1) {
          W(G), M(b), z("verses"), F("");
          return;
    ...
    z("books"), D(void 0), W(void 0), M(void 0), setTimeout(() => {
      St.current && St.current.focus();
    }, 0);
  }, []), P = L(() => {
    const b = R;
    W(void 0), M(void 0), b ? (D(b), z("chapters"), F("")) : Gt();
  }, [R, Gt]), H = L((b) => {
    _(b), b && (z("books"), D(void 0), W(void 0), M(void 0), $(""));
  }, []), { otLong: it, ntLong: rt, dcLong: pt, extraLong: bt } = {
    ...
    () => Ai(I),
    [I]
  ), yt = B(() => !l || !S || !S.chapterNum || !ut ? !1 : l(S.book, S.chapterNum) > 0, [l, S, ut]), Le = L(
    (b) => u ? uo(b, u) : !1,
    [u]
  ), De = L(
    (b) => (G) => u ? Pi(b, G, u) : !1,
    ...
    (b, G) => (J) => u ? ca(b, G, J, u) : !1,
    [u]
  ), Fe = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", lr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", dr = L(
    (b) => {
    ...
    (b) => {
      var Jt, Ye, wr;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: J } = po(b.key);
      ...
      if (x === "verses" && Ct) {
        ...
        Ht !== gt && (b.preventDefault(), b.stopPropagation(), F(
          `${$t} ${ve[$t] || ""} ${kt}:${Ht}`
        ), setTimeout(() => {
          const je = ot.current[Ht];
          je && je.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((x === "chapters" || x === "books" && S) && Ct) {
        const $t = x === "chapters" ? A : S == null ? void 0 : S.book;
        if (!$t) return;
        x === "chapters" && ((wr = vt.current) == null || wr.focus());
        const kt = (() => {
          if (!V) return 1;
          const Yt = V.match(/(\d+)$/);
        ...
        gt !== kt && (b.preventDefault(), b.stopPropagation(), F(
          `${$t} ${ve[$t] || ""} ${gt}`
        ), setTimeout(() => {
    ...
    const { isLetter: G, isDigit: J } = po(b.key);
    (G || J) && (b.preventDefault(), $((Jt) => Jt + b.key), St.current.focus(), ft(!1));
  }, []);
  return Xt(() => {
    const b = setTimeout(() => {
      if (y && x === "books" && U.current && et.current) {
        const G = U.current, J = et.current, Ct = J.offsetTop, Jt = G.clientHeight, Ye = J.clientHeight, wr = Ct - Jt / 2 + Ye / 2;
        G.scrollTo({
          top: Math.max(0, wr),
          behavior: "smooth"
        }), F($n(t.book));
  ...
  }, [x, A, S, t.book, t.chapterNum]), Xt(() => {
    if (x === "verses" && R && q !== void 0) {
      const b = R === t.book && q === t.chapterNum, G = b ? t.verseNum : 1;
      F(
        `${R} ${ve[R] || ""} ${q}:${G}`
      ), setTimeout(() => {
        if (U.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ w(Te, { open: y, onOpenChange: H, modal: v, children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(
      j,
      {
        ref: st,
    ...
    /* @__PURE__ */ a(
      ze,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: G } = b;
          y && st.current && G instanceof Node && st.current.contains(G) && (Ft.current = !0, H(!1));
        },
        onCloseAutoFocus: k,
        children: /* @__PURE__ */ w(
          Ve,
          {
            ...
            shouldFilter: !1,
            children: [
              x === "books" ? /* @__PURE__ */ w("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Kt.map(({ onClick: b, disabled: G, title: J, icon: Ct }) => /* @__PURE__ */ a(
                  j,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  j,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: x === "verses" ? P : Gt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: C === "ltr" ? /* @__PURE__ */ a(Xi, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ji, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                x === "chapters" && A && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: $e(A, n) }),
                x === "verses" && R && q !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${$e(R, n)} ${q}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: x === "verses" ? lr : Fe
                  }
                )
              ] }),
              !Z && /* @__PURE__ */ w(Ie, { ref: U, children: [
                x === "books" && /* @__PURE__ */ w(Q, { children: [
                  !S && Object.entries(Ut).map(([b, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(we, { heading: xt(b), children: G.map((J) => /* @__PURE__ */ a(
                          Rn,
                          {
                            bookId: J,
                            onSelect: (Ct) => qt(Ct),
                  ...
                  S && /* @__PURE__ */ a(we, { children: /* @__PURE__ */ a(
                    Ee,
                    {
                      value: `${S.book} ${ve[S.book]} ${S.chapterNum || ""}:${S.verseNum || ""})}`,
                      onSelect: Vt,
                      disabled: !!u && ca(
                        S.book,
                        S.chapterNum ?? 1,
                      ...
                      children: xe(
                        ...
                        n ? ja(S.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  S && yt && S.chapterNum && l && /* @__PURE__ */ w(Q, { children: [
                    /* @__PURE__ */ w("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${$e(S.book, n)} ${S.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      To,
                      {
                        ...
                        onVerseSelect: ne,
                        setVerseRef: dt,
                        isVerseDisabled: cr(S.book, S.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  S && !yt && Ir(S.book) > 1 && /* @__PURE__ */ w(Q, { children: [
                    /* @__PURE__ */ w("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: $e(S.book, n) }),
                ...
                x === "chapters" && A && /* @__PURE__ */ a(
                  Eo,
                  {
                    ...
                    onChapterSelect: Rt,
                    setChapterRef: E,
                    isChapterDisabled: De(A),
                    className: "tw:p-4"
                  }
                ),
                x === "verses" && R && q !== void 0 && l && /* @__PURE__ */ a(
                  To,
                  {
                    bookId: R,
                    chapterNum: q,
...
function zo({
  ...
  const [y, _] = N(!1), V = l ?? d, F = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], I = ($, x) => {
    const z = d($), A = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, D = `${x ?? ""}${z}${A ?? ""}`;
    return /* @__PURE__ */ w(
      Ee,
      {
        value: z,
  ...
  return /* @__PURE__ */ w(Te, { open: y, onOpenChange: _, ...C, children: [
    ...
    /* @__PURE__ */ a(
      ze,
      {
        ...
        children: /* @__PURE__ */ w(Ve, { children: [
          /* @__PURE__ */ a(kr, { placeholder: f, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(Zr, { children: g }),
          /* @__PURE__ */ a(Ie, { children: F(e) ? e.map(($) => /* @__PURE__ */ a(we, { heading: $.groupHeading, children: $.options.map((x) => I(x, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(we, { children: e.map(($) => I($)) }) })
        ] })
      }
    )
  ] });
...
function Bu({
  ...
  const u = ha(l, "%webView_bookSelector_currentBook%"), p = ha(l, "%webView_bookSelector_choose%"), f = ha(l, "%webView_bookSelector_chooseBooks%"), [g, m] = N(
    "current book"
    /* CurrentBook */
  ), k = (v) => {
    m(v), t(v);
      ...
      children: /* @__PURE__ */ w("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        /* @__PURE__ */ w("div", { className: "tw:grid tw:grid-cols-[25%_25%_50%]", children: [
          /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(_t, { className: "tw:ms-1", children: u })
          ] }),
        ...
        /* @__PURE__ */ w("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:flex tw:items-center", children: o.map((v) => Wt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            j,
            {
...
const Pn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, dl = Pn ? Xt : Y, Ar = { tag: Ga };
function wl({ initialConfig: t, children: e }) {
  const r = B(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = ll(null, o), u = gn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, u), theme: o });
    return function(p, f) {
      if (f !== null) {
        if (f === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const m = Cr();
            g.append(m);
            const k = Pn ? document.activeElement : null;
            (Bt() !== null || k !== null && k === p.getRootElement()) && m.select();
          }
        }, Ar);
        else if (f !== null) switch (typeof f) {
          case "string": {
            const g = p.parseEditorState(f);
            p.setEditorState(g, Ar);
            break;
          }
          case "object":
            p.setEditorState(f, Ar);
            break;
          case "function":
            p.update(() => {
              Ae().isEmpty() && f(p);
...
function pl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = fe();
  return ul(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: d }) => {
      e && i.size === 0 && s.size === 0 || t && d.has(Ga) || c.isEmpty() || r(n, o, d);
    });
  }, [o, t, e, r]), null;
}
const Wa = {
...
const vl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function bl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function xl() {
  return function(t) {
    const [e] = fe(), r = B(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = K(o);
    return vl(() => {
...
function yl(t, e) {
  ...
  s.sort((l, u) => {
    const p = l.top - u.top;
    return Math.abs(p) <= 3 ? l.left - u.left : p;
  });
  for (let l = 0; l < d; l++) {
    const u = s[l], p = c && c.top <= u.top && c.top + c.height > u.top && c.left + c.width > u.left, f = u.width + i === o.width;
    p || f ? (s.splice(l--, 1), d--) : c = u;
  }
  return s;
}
function Kr(t, ...e) {
...
const Vn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, kl = Vn && "documentMode" in document ? document.documentMode : null;
!(!Vn || !("InputEvent" in window) || kl) && "getTargetRanges" in new window.InputEvent("input");
function de(t) {
  return `${t}px`;
}
const _l = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function Nl(t, e, r) {
  let o = null, n = null, i = null, s = [];
  const c = document.createElement("div");
  function d() {
    o === null && Kr(182), n === null && Kr(183);
    const { left: p, top: f } = n.getBoundingClientRect(), g = yl(t, e);
    var m, k;
    c.isConnected || (k = c, (m = n).insertBefore(k, m.firstChild));
    let v = !1;
    for (let T = 0; T < g.length; T++) {
      const C = g[T], y = s[T] || document.createElement("div"), _ = y.style;
      _.position !== "absolute" && (_.position = "absolute", v = !0);
      const V = de(C.left - p);
      _.left !== V && (_.left = V, v = !0);
      const F = de(C.top - f);
      _.top !== F && (y.style.top = F, v = !0);
      const I = de(C.width);
  ...
  const u = t.registerRootListener(function p() {
    const f = t.getRootElement();
    if (f === null) return l();
    const g = f.parentElement;
    if (!tc(g)) return l();
    l(), o = f, n = g, i = new MutationObserver((m) => {
...
function El(t, e = Cl) {
  ...
  function l(u) {
    u.read(() => {
      ...
      }(p), m = f.getNode(), k = m.getKey(), v = f.offset, T = g.getNode(), C = T.getKey(), y = g.offset, _ = t.getElementByKey(k), V = t.getElementByKey(C), F = r === null || _ !== o || v !== n || k !== r.getKey(), I = i === null || V !== s || y !== c || C !== i.getKey();
      if ((F || I) && _ !== null && V !== null) {
        const $ = function(x, z, A, D, R, W, q) {
          const M = (x._window ? x._window.document : document).createRange();
          return M.setStart(...So(z, A, D)), M.setEnd(...So(R, W, q)), M;
        }(t, f, m, _, g, T, V);
        d(), d = Nl(t, $, e);
      }
  ...
  return l(t.getEditorState()), Ce(t.registerUpdateListener(({ editorState: u }) => l(u)), () => {
    d();
  });
}
function Tl(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = El(t, e));
  };
...
function zl(t) {
  const e = bn(t, (r) => br(r) && !r.isInline());
  return br(e) || Kr(4, t.__key), e;
}
function Sl(t) {
  const e = Bt() || Us();
  let r;
  if (pe(e)) r = qs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = vn(c, "next"));
    }
    r = r || Ks(Ae(), "previous").getFlipped().insert(Cr());
  }
  const o = Dl(t, r), n = Gs(o), i = Hs(n) ? Ys(n) : o;
  return Ws(Xs(i)), t.getLatest();
}
function Dl(t, e, r) {
  let o = ko(e, "next");
  for (let n = o; n; n = Js(n, r)) o = n;
  return Zs(o) && Kr(283), o.insert(t.isInline() ? Cr().append(t) : t), ko(vn(t.getLatest(), "next"), e.direction);
}
function Rl(t) {
  const e = Bt();
  if (!pe(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = bn(i, (l) => br(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
const $l = Symbol.for("preact-signals");
function ra() {
  if (ye > 1) return void ye--;
  let t, e = !1;
  for (!function() {
    let r = Gr;
    for (Gr = void 0; r !== void 0; ) r.S.v === r.v && (r.S.i = r.i), r = r.o;
  }(); mr !== void 0; ) {
    let r = mr;
    for (mr = void 0, Hr++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && In(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
let Gr, ye = 0, Hr = 0, Ol = 0, Ia = 0, Lr = 0;
function Ro(t) {
  if (tt === void 0) return;
  let e = t.n;
...
function Ue(t, e) {
  Ot.call(this, void 0), this.x = t, this.s = void 0, this.g = Lr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Al(t, e) {
  return new Ue(t, e);
}
...
function Pl(t) {
  ...
  Bn(this), tt = t, this.f &= -2, 8 & this.f && Ja(this), ra();
}
function Xe(t, e) {
...
function sr(t, e = {}) {
  const r = {};
  for (const o in t) {
    const n = e[o], i = xr(n === void 0 ? t[o] : n);
    r[o] = i;
  }
  return r;
}
Ot.prototype.brand = $l, Ot.prototype.h = function() {
  return !0;
}, Ot.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : Do(() => {
    var r;
  ...
  if (this.t !== void 0) {
    const e = t.e, r = t.x;
    e !== void 0 && (e.x = r, t.e = void 0), r !== void 0 && (r.e = e, t.x = void 0), t === this.t && (this.t = r, r === void 0 && Do(() => {
      var o;
...
}, Object.defineProperty(Ot.prototype, "value", { get() {
  const t = Ro(this);
  return t !== void 0 && (t.i = this.i), this.v;
}, set(t) {
  if (t !== this.v) {
    if (Hr > 100) throw new Error("Cycle detected");
    (function(e) {
      ye !== 0 && Hr === 0 && e.l !== Ia && (e.l = Ia, Gr = { S: e, v: e.v, i: e.i, o: Gr });
    })(this), this.v = t, this.i++, Lr++, ye++;
    try {
...
} }), Ue.prototype = new Ot(), Ue.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Lr)) return !0;
  if (this.g = Lr, this.f |= 1, this.i > 0 && !In(this)) return this.f &= -2, !0;
  const t = tt;
  try {
    $o(this), tt = this;
    const e = this.x();
  ...
  Ot.prototype.S.call(this, t);
}, Ue.prototype.U = function(t) {
  if (this.t !== void 0 && (Ot.prototype.U.call(this, t), this.t === void 0)) {
    this.f &= -33;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ln(this), $o(this), ye++;
  const t = tt;
  return tt = this, Pl.bind(this, t);
}, Xe.prototype.N = function() {
  2 & this.f || (this.f |= 2, this.u = mr, mr = this);
}, Xe.prototype.d = function() {
  this.f |= 8, 1 & this.f || Ja(this);
}, Xe.prototype.dispose = function() {
  this.d();
};
oe({ build: (t, e, r) => sr(e), config: He({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Fn() {
  const t = Ae(), e = Bt(), r = Cr();
  t.clear(), t.append(r), e !== null && r.select(), pe(e) && (e.format = 0);
}
function jn(t, e = Fn) {
  return t.registerCommand(xn, (r) => (t.update(e), !0), Ha);
}
oe({ build: (t, e, r) => sr(e), config: He({ $onClear: Fn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return he(() => jn(t, o.value));
} });
function Vl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const fa = rc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Un extends Da {
  $config() {
    return this.config("decorator-text", { extends: Da, stateConfigs: [{ flat: !0, stateConfig: fa }] });
  }
  getFormat() {
    return hc(this, fa);
  }
  getFormatFlags(e, r) {
    return _o(this.getFormat(), e, r);
  }
  hasFormat(e) {
    const r = gc[e];
  ...
  toggleFormat(e) {
    const r = this.getFormat(), o = _o(r, e, null);
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [Un], register: (t, e, r) => t.registerCommand(yn, (o) => {
  const n = Bt();
  if (kn(n) || pe(n)) for (const i of n.getNodes()) Il(i) && i.toggleFormat(o);
  return !1;
}, _n) });
function qn(t, e) {
  let r;
...
const Ba = oe({ build: (t) => qn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function Kn(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = Kn(r[n], o[n]);
    return t;
  }
  return e;
}
const Za = 0, La = 1, Gn = 2, ma = 3, Pr = 4, We = 5, va = 6, pr = 7;
function ba(t) {
  return t.id === Za;
}
function Hn(t) {
...
function Bl(t) {
  return function(e) {
    return e.id === La;
  }(t) || ct(305, String(t.id), String(La)), Object.assign(t, { id: Gn });
}
...
class Fl {
  constructor(e, r) {
    ...
    Mt(this, "state");
    Mt(this, "_signal");
    this.builder = e, this.extension = r, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Za };
  }
  mergeConfigs() {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, d, l) {
      return Object.assign(c, { config: d, id: ma, registerState: l });
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Pr && ct(307, String(r.id), String(We)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
    const n = { ...r.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(i, s, c) {
      return Object.assign(i, { id: We, output: s, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== We && ct(308, String(o.id), String(We));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(i) {
      return Object.assign(i, { id: va });
    }(o), () => {
      const i = this.state;
      i.id !== pr && ct(309, String(o.id), String(pr)), this.state = function(s) {
        return Object.assign(s, { id: We });
      }(i), n && n();
    };
  }
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== va && ct(310, String(r.id), String(va)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Pr;
    }(e) || ct(313, String(e.id), String(Pr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= ma;
    }(e) || ct(314, String(e.id), String(ma)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getInitDependency(e) {
    ...
    return r === void 0 && ct(315, this.extension.name, e.name), r.getExtensionInitDependency();
  }
  getDependency(e) {
    const r = this.builder.getExtensionRep(e);
    return r === void 0 && ct(315, this.extension.name, e.name), r.getExtensionDependency();
  }
  getState() {
    const e = this.state;
    return function(r) {
      return r.id >= pr;
    }(e) || ct(316, String(e.id), String(pr)), e;
  }
...
function jl() {
  const t = Ae();
  t.isEmpty() && t.append(Cr());
}
const Ul = oe({ config: He({ setOptions: Mo, updateOptions: Mo }), init: ({ $initialEditorState: t = jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ac, mn, oc, nc, fn] }), Oo = Symbol.for("@lexical/extension/LexicalBuilder");
function Ao() {
}
function ql(t) {
  throw t;
...
class Je {
  ...
  static maybeFromEditor(e) {
    const r = e[Oo];
    return r && (r.PACKAGE_VERSION !== xa && ct(292, r.PACKAGE_VERSION, xa), r instanceof Je || ct(293)), r;
  }
  static fromEditor(e) {
    const r = Je.maybeFromEditor(e);
    return r === void 0 && ct(294), r;
  }
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(gn({ ...o, ...r ? { onError: (i) => {
      r(i, n);
    } } : {} }), { [Oo]: this });
  ...
  getExtensionRep(e) {
    ...
    if (r) return r.extension !== e && ct(295, e.name), r;
  }
  addEdge(e, r, o) {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && ct(298, o.name), !n) {
      n = new Fl(this, o), this.extensionNameMap.set(o.name, n);
      const i = this.conflicts.get(o.name);
      typeof i == "string" && ct(299, o.name, i);
      for (const s of o.conflictsWith || []) this.extensionNameMap.has(s) && ct(299, o.name, s), this.conflicts.set(s, o.name);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ba(i) || ct(300, s, n || "[unknown]"), ba(c = i) || ct(304, String(c.id), String(Za)), i = Object.assign(c, { id: La }), o.state = i;
      const d = this.outgoingConfigEdges.get(s);
      if (d) for (const l of d.keys()) {
        const u = this.extensionNameMap.get(l);
        u && r(u, s);
      }
  ...
  buildCreateEditorArgs() {
    ...
    for (const u of c) {
      const { extension: p } = u;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const f of Vl(p)) {
        if (typeof f != "function") {
          const g = o.get(f.replace);
          g && ct(302, p.name, f.replace.name, g.extension.name), o.set(f.replace, u);
        }
        r.add(f);
      }
      if (p.html) {
        if (p.html.export) for (const [f, g] of p.html.export.entries()) n.set(f, g);
        p.html.import && Object.assign(i, p.html.import);
      }
      p.theme && Kn(s, p.theme);
    }
    ...
    for (const u of c) u.init(e);
    return e.onError || (e.onError = ql), e;
  }
}
const Kl = /* @__PURE__ */ new Set(), Po = oe({ build(t, e, r) {
  const o = r.getDependency(Ba).output, n = xr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = qn(() => {
  }, () => he(() => {
    const s = i.peek(), { watchedNodeKeys: c } = n.value;
    let d, l = !1;
    o.value.read(() => {
      if (Bt()) for (const [u, p] of c.entries()) {
        if (p.size === 0) {
          c.delete(u);
          continue;
        }
        const f = vc(u), g = f && f.isSelected() || !1;
        l = l || g !== (!!s && s.has(u)), g && (d = d || /* @__PURE__ */ new Set(), d.add(u));
      }
    }), !l && d && s && d.size === s.size || (i.value = d);
  }));
  return { watchNodeKey: function(s) {
    const c = Al(() => (i.value || Kl).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const u = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), u || (d.set(s, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [Ba], name: "@lexical/extension/NodeSelection" }), Gl = sc("INSERT_HORIZONTAL_RULE_COMMAND");
class tr extends Da {
  static getType() {
...
oe({ dependencies: [Ba, Po], name: "@lexical/extension/HorizontalRule", nodes: () => [tr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Po).output, n = xr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ce(t.registerCommand(Gl, (s) => {
    const c = Bt();
    if (!pe(c)) return !1;
    ...
    return !0;
  }, Ha), t.registerCommand(cc, (s) => {
    if (lc(s.target)) {
      const c = dc(s.target);
      if (Yl(c)) return function(d, l = !1) {
        const u = Bt(), p = d.isSelected(), f = d.getKey();
        let g;
        l && kn(u) ? g = u : (g = wc(), uc(g)), p ? g.delete(f) : g.add(f);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, _n), t.registerMutationListener(tr, (s, c) => {
    Ml(() => {
      let d = !1;
      const { nodeSelections: l } = n.peek();
      for (const [u, p] of s.entries()) if (p === "destroyed") l.delete(u), d = !0;
      else {
        const f = l.get(u), g = t.getElementByKey(u);
        f ? f.domNode.value = g : (d = !0, l.set(u, { domNode: xr(g), selectedSignal: o(u) }));
      }
    ...
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(he(() => {
      const l = c.value;
      l && (d.value ? Nn(l, i) : bc(l, i));
    }));
    return Ce(...s);
  }));
} });
oe({ build: (t, e) => sr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: He({ $getParentEditor: function() {
  const t = pc();
...
oe({ build: (t, e, r) => sr(e), config: He({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return he(() => {
    if (!o.disabled.value) return Tl(t, o.onReposition.value);
  });
} });
function Yn(t) {
  return t.canBeEmpty();
}
function Wl(t, e, r = Yn) {
  return Ce(t.registerCommand(xc, (o) => {
    const n = Bt();
    if (!pe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((f) => yc(f) && f.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, u = l.getNode(), p = zl(u);
      if (p.canIndent()) {
        const f = p.getKey();
        let g = kc();
        if (g.anchor.set(f, 0, "element"), g.focus.set(f, 0, "element"), g = _c(g), g.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Nc : No : Cc;
    return t.dispatchCommand(i, void 0);
  }, Ha), t.registerCommand(No, () => {
...
oe({ build: (t, e, r) => sr(e), config: He({ $canIndent: Yn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return he(() => {
    if (!o.value) return Wl(t, n, i);
  });
} });
const Xl = oe({ name: "@lexical/react/ReactProvider" });
function Jl() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (pe(m)) {
                const k = m.anchor;
                let v = k.getNode(), T = 0, C = 0;
                if (Ra(v) && l >= 0 && u >= 0 && (T = l, C = l + u, m.setTextNodeRange(v, T, v, C)), T === C && p === "" || (m.insertRawText(p), v = k.getNode()), Ra(v)) {
                  T = f, C = f + g;
                  const y = v.getTextContentSize();
                  T = T > y ? y : T, C = C > y ? y : C, m.setTextNodeRange(v, T, v, C);
                }
...
oe({ build: (t, e, r) => sr(e), config: He({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => he(() => r.getOutput().disabled.value ? void 0 : Xn(t)) });
function td(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const to = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
  ...
  return function(r, o) {
    ...
    return to(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], u = a(o, { onError: (f) => r._onError(f), children: a(Fs, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
        p !== null && s.push(Mc(u, p, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
}
function rd({ editor: t, ErrorBoundary: e }) {
  return function(r) {
...
function Vo(t) {
  return t.getEditorState().read(Wn(t.isComposing()));
}
function ad({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = fe();
  return function(n) {
    to(() => Ce(Rc(n), Xn(n)), [n]);
  }(o), w(Q, { children: [t, a(od, { content: e }), a(rd, { editor: o, ErrorBoundary: r })] });
}
function od({ content: t }) {
...
const id = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function sd({ onClear: t }) {
  const [e] = fe();
  return id(() => jn(e, t), [e, t]), null;
}
const Jn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function cd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: u, ariaOwns: p, ariaRequired: f, autoCapitalize: g, className: m, id: k, role: v = "textbox", spellCheck: T = !0, style: C, tabIndex: y, "data-testid": _, ...V }, F) {
  const [I, $] = N(t.isEditable()), x = L((A) => {
    A && A.ownerDocument && A.ownerDocument.defaultView ? t.setRootElement(A) : t.setRootElement(null);
  }, [t]), z = B(() => /* @__PURE__ */ function(...A) {
    return (D) => {
      for (const R of A) typeof R == "function" ? R(D) : R != null && (R.current = D);
    };
  }(F, x), [x, F]);
  return Jn(() => ($(t.isEditable()), t.registerEditableListener((A) => {
    $(A);
  })), [t]), a("div", { "aria-activedescendant": I ? e : void 0, "aria-autocomplete": I ? r : "none", "aria-controls": I ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": I && v === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": d, "aria-labelledby": l, "aria-multiline": u, "aria-owns": I ? p : void 0, "aria-readonly": !I || void 0, "aria-required": f, autoCapitalize: g, className: m, contentEditable: I, "data-testid": _, id: k, ref: z, role: v, spellCheck: T, style: C, tabIndex: y, ...V });
}
const ld = ta(cd);
function Io(t) {
  return t.getEditorState().read(Wn(t.isComposing()));
...
function wd(t, e) {
  ...
  return w(Q, { children: [a(ld, { editor: n, ...o, ref: e }), r != null && a(ud, { editor: n, content: r })] });
}
function ud({ content: t, editor: e }) {
  const r = function(s) {
    const [c, d] = N(() => Io(s));
    return Jn(() => {
      function l() {
...
function gd() {
  const [t, e] = N(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Oa, { open: !0, onOpenChange: r, children: /* @__PURE__ */ w(Aa, { children: [
      /* @__PURE__ */ a(Ur, { children: /* @__PURE__ */ a(qr, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function fd({
  ...
  const [e] = fe(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = gd(), d = () => {
  };
...
const Bo = [
  { format: "bold", icon: Zi, label: "Bold" },
...
function bd() {
  const { activeEditor: t } = Qn(), [e, r] = N([]), o = L((n) => {
    if (pe(n) || Kc(n)) {
      const i = [];
      Bo.forEach(({ format: s }) => {
  ...
  return md(o), /* @__PURE__ */ a(
    ei,
    {
      ...
      variant: "outline",
      size: "sm",
      children: Bo.map(({ format: n, icon: i, label: s }) => /* @__PURE__ */ a(
        Fr,
        {
          value: n,
          "aria-label": s,
...
function yd({
  ...
  return /* @__PURE__ */ w("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(fd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(bd, {}) }) }),
      ...
      /* @__PURE__ */ a(
        ad,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(pd, { placeholder: t }) }),
          ErrorBoundary: ml
        }
      ),
      e && /* @__PURE__ */ a(nd, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(xd, { onClear: r }),
      /* @__PURE__ */ a(sd, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ a(
          wl,
          {
            ...
            children: /* @__PURE__ */ w(te, { children: [
              /* @__PURE__ */ a(yd, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                pl,
                {
...
function ai(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : ai(e.children)
  ) : !1;
}
function Zt(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? ai(t.root.children) : !1;
}
function _d(t) {
  if (!t || t.trim() === "")
...
function ii({
  ...
  const s = Lo(o, "%cancelButton_tooltip%"), c = i ?? Lo(o, "%acceptButton_tooltip%");
  return /* @__PURE__ */ w(ro, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
      ...
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(oi, {}),
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: c }) })
    ] }) })
  ] });
}
function jr(t, e) {
...
function Fu({
  ...
  const [i, s] = N(Cd), [c, d] = N(n), [l, u] = N(!1), p = K(void 0), f = K(null);
  Y(() => {
    let v = !0;
    const T = f.current;
    if (!T) return;
  ...
  const g = L(() => {
    ...
    const v = Wr(i);
    e(v, c);
  }, [i, e, c]), m = o["%commentEditor_placeholder%"] ?? "Type your comment here...", k = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ w("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ w(Te, { open: l, onOpenChange: u, children: [
      /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ w(
        j,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ a(
        ze,
        {
          ...
          children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Ie, { children: t.map((v) => /* @__PURE__ */ a(
            Ee,
            {
              onSelect: () => {
                d(v || void 0), u(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: ya(v, o) })
            },
            v || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : ao(v) && (v.preventDefault(), v.stopPropagation(), Zt(i) && g());
        },
        onKeyDown: (v) => {
...
function Fo({
  ...
  const g = L(
    ...
    async (_) => {
      if (_ && _.stopPropagation(), !u || !n) return;
      await n(
        t.id,
        Wr(u)
  ...
  }, [t.date, r]), v = B(() => t.user, [t.user]), T = B(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), C = B(() => Ms(t.contents), [t.contents]), y = B(() => {
    if (o && c)
      return /* @__PURE__ */ w(Q, { children: [
        /* @__PURE__ */ w(
          Ke,
          {
            onClick: (_) => {
              _.stopPropagation(), l(!0), p(_d(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ w(
          Ke,
          {
            ...
            children: [
              /* @__PURE__ */ a(es, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(zd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Sd, { className: "tw:text-xs tw:font-medium", children: T }) }),
        /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          /* @__PURE__ */ w("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ w(vr, { variant: "secondary", className: "tw:text-xs tw:font-normal", children: [
              "→ ",
              jr(t.assignedUser, r)
            ] })
          ] }),
          d && /* @__PURE__ */ w(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), g()) : ao(_) && (_.preventDefault(), _.stopPropagation(), Zt(u) && m());
              },
              onKeyDown: (_) => {
                eo(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
        ...
        y && /* @__PURE__ */ w(ke, { children: [
          /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(rs, {}) }) }),
          /* @__PURE__ */ a(Ne, { align: "end", children: y })
        ] })
      ]
    }
  );
...
function Dd({
  ...
  const [$, x] = N(jo), [z, A] = N(), [D, R] = N(), W = o, [q, M] = N(!1), [Z, ft] = N(!1), [st, Ft] = N(!1), [vt, St] = N(!1), [U, et] = N(!1), [at, ot] = N(_), [nt, Pt] = N(!1), mt = K(void 0), [jt, Ut] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let E = !0;
    return (async () => {
      const ut = C ? await C(d) : !1;
      E && et(ut);
    })(), () => {
      E = !1;
    };
  ...
  Y(() => {
    if (!o) {
      S.current !== "idle" && (A(void 0), R(void 0), S.current = "idle");
      return;
    }
    S.current === "idle" && (S.current = "pending"), vt ? S.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (A(I), S.current = "auto-populated") : S.current === "auto-populated" && (A(void 0), S.current = "pending");
  }, [o, I, vt, i]);
  const Dt = B(() => e.filter((E) => !E.deleted), [e]);
  Y(() => {
    let E = !0;
    if (!o || !y) {
      Ut(/* @__PURE__ */ new Map());
  ...
  const Vt = B(() => Dt[0], [Dt]), ne = K(null), qt = K(void 0), Rt = L(() => {
    var E;
    (E = qt.current) == null || E.call(qt), x(jo);
  }, []), Se = L(() => {
    const E = !at;
    ot(E), Pt(!E), m == null || m(d, E);
  }, [at, m, d]);
  Y(() => {
    M(!1);
  }, [o]), Y(() => {
    if (o && !at && !nt) {
      ...
      return mt.current = E, () => clearTimeout(E);
    }
  ...
  }, [i, r]), P = B(() => Dt.slice(1), [Dt]), H = B(() => P.length ?? 0, [P.length]), it = B(() => H > 0, [H]), rt = B(() => q || H <= 2 ? P : P.slice(-2), [P, H, q]), pt = B(() => q || H <= 2 ? 0 : H - 2, [H, q]), bt = B(
    () => H === 1 ? Kt.singleReply : be(Kt.multipleReplies, { count: H }),
    [H, Kt]
  ), xt = B(
    () => pt === 1 ? Kt.singleReply : be(Kt.multipleReplies, { count: pt }),
    [pt, Kt]
  );
  Y(() => {
    !o && Z && it && ft(!1);
  ...
  const ht = L(
    async (E) => {
      ...
      dt && await p({ threadId: d, contents: dt }) && Rt();
    },
    [
      Rt,
      $,
    ...
    async (E) => {
      const dt = Zt($) ? Wr($) : void 0, ut = E.status ? E.assignedUser : z ?? E.assignedUser, yt = await p({
        ...E,
        contents: dt,
        assignedUser: ut
      });
      return yt && (ut !== void 0 && R(ut), dt && Rt()), yt;
    },
    [Rt, $, p, z]
  );
  if (Dt.length !== 0)
    return /* @__PURE__ */ a(
      Ed,
      {
        ...
        className: h(
          ...
          {
            "tw:bg-primary-foreground": !o && u !== "Resolved" && at,
            "tw:bg-background": o && u !== "Resolved" && at,
            "tw:bg-muted": u === "Resolved",
            "tw:bg-accent": !at && !o && u !== "Resolved"
          }
        ),
        onClick: () => {
          c(d);
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ w(Td, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              Gt && /* @__PURE__ */ a(vr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Gt }),
              /* @__PURE__ */ a(
                j,
                {
                  variant: "ghost",
                  ...
                  children: at ? /* @__PURE__ */ a(as, {}) : /* @__PURE__ */ a(os, {})
                }
              ),
              U && u !== "Resolved" && /* @__PURE__ */ a(
                j,
                {
                  variant: "ghost",
                  size: "icon",
            ...
            /* @__PURE__ */ a(
              Fo,
              {
                ...
                isThreadExpanded: o,
                threadStatus: u,
                handleAddCommentToThread: Nt,
                handleUpdateComment: f,
                handleDeleteComment: g,
                onEditingChange: ft,
                canEditOrDelete: (!Z && jt.get(Vt.id)) ?? !1,
                canUserResolveThread: U
              }
            )
          ] }),
          /* @__PURE__ */ w(Q, { children: [
            it && !o && /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      ...
                      q ? /* @__PURE__ */ a(ns, {}) : /* @__PURE__ */ a(Qe, {})
                    ] })
                  ]
                }
              ),
              rt.map((E) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Fo,
                {
                  comment: E,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: g,
                  onEditingChange: ft,
                  canEditOrDelete: (!Z && jt.get(E.id)) ?? !1
                }
              ) }, E.id)),
              v !== !1 && (!Z || Zt($)) && /* @__PURE__ */ w(
                "div",
                {
                  ...
                  onKeyDownCapture: (E) => {
                    ao(E) && (E.preventDefault(), E.stopPropagation(), (Zt($) || z !== void 0 && z !== D) && ht());
                  },
                  onKeyDown: (E) => {
                    eo(E), (E.key === "Enter" || E.key === " ") && E.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Yr,
                    ...
                    /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && (Zt($) || z !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: be(
                      ...
                      /* @__PURE__ */ w(Te, { open: st, onOpenChange: Ft, children: [
                        /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(
                          j,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !vt || !k || k.length === 0 || !k.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          ze,
                          {
                            ...
                            align: "end",
                            onKeyDown: (E) => {
                              E.key === "Escape" && (E.stopPropagation(), Ft(!1));
                            },
                            children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Ie, { children: k == null ? void 0 : k.map((E) => /* @__PURE__ */ a(
                              Ee,
                              {
                                onSelect: () => {
                                  A(E !== i ? E : void 0), S.current = "user-selected", R(void 0), Ft(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: jr(E, r) })
                              },
                              E || "unassigned"
                            )) }) })
                          }
...
function Wu({
  ...
  const [T, C] = N(/* @__PURE__ */ new Set()), [y, _] = N(), [V, F] = N(), I = L(
    async (M) => {
      const Z = await i(M);
      return Z !== void 0 && M.assignedUser !== void 0 && M.assignedUser !== "" && F(M.assignedUser), Z;
    },
    [i]
  );
  Y(() => {
  ...
  const $ = r.filter(
    (M) => M.comments.some((Z) => !Z.deleted)
  ), x = $.map((M) => ({ id: M.id })), z = L(
    (M) => {
      C((Z) => new Set(Z).add(M.id)), _(M.id), k == null || k(M.id);
    },
    [k]
  ), A = L(
    (M) => {
      ...
      C((ft) => {
        const st = new Set(ft);
        return st.has(M) ? st.delete(M) : st.add(M), st;
      }), _(M), k == null || k(Z ? void 0 : M);
    },
    [T, k]
  ), { listboxRef: D, activeId: R, handleKeyDown: W } = Vi({
    options: x,
    onOptionSelect: z
  }), q = L(
    (M) => {
      M.key === "Escape" ? (y && T.has(y) && (C((Z) => {
        const ft = new Set(Z);
        return ft.delete(y), ft;
      }), _(void 0), k == null || k(void 0)), M.preventDefault(), M.stopPropagation()) : W(M);
    },
    [y, T, W, k]
  );
  return /* @__PURE__ */ a(
...
function Rd({ table: t }) {
  return /* @__PURE__ */ w(ke, { children: [
    /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ w(j, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(is, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ w(Ne, { align: "end", className: "tw:w-[150px]", children: [
...
function er({ ...t }) {
  return /* @__PURE__ */ a(At.Root, { "data-slot": "select", ...t });
}
...
function rr({ ...t }) {
  return /* @__PURE__ */ a(At.Value, { "data-slot": "select-value", ...t });
}
function ar({ className: t, size: e = "default", children: r, ...o }) {
  const n = Lt();
  return /* @__PURE__ */ w(
    At.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(At.Icon, { asChild: !0, children: /* @__PURE__ */ a(Vc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
function or({
  ...
  const i = Lt();
  return /* @__PURE__ */ a(At.Portal, { children: /* @__PURE__ */ w(
    At.Content,
    {
...
function ie({
  ...
  return /* @__PURE__ */ w(
    At.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(At.ItemIndicator, { children: /* @__PURE__ */ a(ea, { className: "tw:pointer-events-none" }) }) }),
        /* @__PURE__ */ a(At.ItemText, { children: e })
      ]
    }
  );
}
    ...
    /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ w(
        er,
        {
          ...
          children: [
            /* @__PURE__ */ a(ar, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(rr, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(or, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ie, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  wt.useEffect(() => {
    ...
    const c = () => {
      requestAnimationFrame(() => {
        yr(s, '[tabindex]:not([tabindex="-1"])').forEach((u) => {
    ...
    const r = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const n = t.current ? yr(t.current) : [], i = n.indexOf(document.activeElement), s = o.key === "ArrowRight" ? i + 1 : i - 1;
...
function se({
  ...
  const c = wt.useMemo(
    () => s.current ? yr(s.current) : [],
    [s]
  ), d = wt.useCallback(
    (u) => {
      const { current: p } = s;
      if (!p || !p.parentElement) return;
      const f = p.closest("table"), g = f ? (
        // getFocusableElements returns an HTMLElement[] but we are filtering for HTMLTableRowElements
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        yr(f).filter(
          (v) => v.tagName === "TR"
        )
      ) : [], m = g.indexOf(p), k = c.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (u.key === "ArrowDown" || u.key === "ArrowUp")
        u.preventDefault(), Bd(g, m, u.key);
      else if (u.key === "ArrowLeft" || u.key === "ArrowRight")
        u.preventDefault(), Id(c, k, u.key);
...
function Ld({
  ...
  var F;
  const [u, p] = N([]), [f, g] = N([]), [m, k] = N({}), [v, T] = N({}), C = B(() => e ?? [], [e]), y = zn({
    data: C,
    columns: t,
    getCoreRowModel: Dn(),
  ...
  let V;
  return d ? V = Array.from({ length: 10 }).map((x, z) => `skeleton-row-${z}`).map((x) => /* @__PURE__ */ a(se, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Ea, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((F = y.getRowModel().rows) == null ? void 0 : F.length) > 0 ? V = y.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    se,
    {
      onClick: () => s(I, y),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map(($) => /* @__PURE__ */ a(Qt, { children: fr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    I.id
  )) : V = /* @__PURE__ */ a(se, { children: /* @__PURE__ */ a(Qt, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ w("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Rd, { table: y }),
    /* @__PURE__ */ w(aa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(oo, { stickyHeader: i, children: y.getHeaderGroups().map((I) => /* @__PURE__ */ a(se, { children: I.headers.map(($) => /* @__PURE__ */ a(Xr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : fr($.column.columnDef.header, $.getContext()) }, $.id)) }, I.id)) }),
      /* @__PURE__ */ a(oa, { children: V })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ w("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(sn, {}) })
        ] }),
...
function rp({
  ...
  return /* @__PURE__ */ w(Te, { onOpenChange: (u) => {
    u || c(!1);
  }, children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: o }),
    /* @__PURE__ */ w(ze, { id: i, className: h("tw:min-w-80 tw:max-w-96", n), children: [
...
function ap({ id: t, label: e, groups: r }) {
  const [o, n] = N(
    ...
    s((f) => (f[l] = u, { ...f }));
    const p = r[l].items.find((f) => f.id === u);
    p ? p.onUpdate(u) : console.error(`Could not find dropdown radio item with id '${u}'!`);
  };
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ w(ke, { children: [
    /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ w(j, { variant: "default", children: [
      /* @__PURE__ */ a(ws, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(Qe, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Ne, { children: r.map((l, u) => /* @__PURE__ */ w("div", { children: [
      /* @__PURE__ */ a(_r, { children: l.label }),
      /* @__PURE__ */ a(en, { children: l.itemType === 0 ? /* @__PURE__ */ a(Q, { children: l.items.map((p, f) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Me,
        {
          checked: o[u][f],
          onCheckedChange: () => c(u, f),
          children: p.label
        }
      ) }, p.id)) }) : /* @__PURE__ */ a(
        Ii,
        {
          value: i[u],
          onValueChange: (p) => d(u, p),
          children: l.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Bi, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Ge, {})
    ] }, l.label)) })
...
function op({
  ...
  }).format(Object.values(r).reduce((u, p) => u + p, 0)), l = () => {
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        e && /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-col tw:items-center tw:gap-1 tw:px-4", children: [
        ...
        /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-col tw:items-center tw:gap-1 tw:px-4", children: [
        ...
        (n || s) && /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-col tw:gap-1 tw:px-4", children: [
...
function qd({ id: t, versionHistory: e }) {
  ...
  function i(c) {
    const d = new Date(c), l = new Date(n.getTime() - d.getTime()), u = l.getUTCFullYear() - 1970, p = l.getUTCMonth(), f = l.getUTCDate() - 1;
    let g = "";
    return u > 0 ? g = `${u.toString()} year${u === 1 ? "" : "s"} ago` : p > 0 ? g = `${p.toString()} month${p === 1 ? "" : "s"} ago` : f === 0 ? g = "today" : g = `${f.toString()} day${f === 1 ? "" : "s"} ago`, g;
  }
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp", id: t, children: [
    ...
    /* @__PURE__ */ a("ul", { className: "tw:list-disc tw:pl-5 tw:pr-4 tw:text-xs tw:text-foreground", children: (r ? s : s.slice(0, 5)).map((c) => /* @__PURE__ */ w("div", { className: "tw:mt-3 tw:flex tw:justify-between", children: [
...
function np({
  ...
  const s = B(() => As(r), [r]), d = ((l) => {
    const u = new Intl.DisplayNames(Ps(), { type: "language" });
    return l.map((p) => u.of(p));
  })(o);
...
function si({
  ...
  const [T, C] = N(!1), y = L(
    (z) => {
      var D;
      const A = (D = t.find((R) => R.label === z)) == null ? void 0 : D.value;
      A && r(
        e.includes(A) ? e.filter((R) => R !== A) : [...e, A]
      );
    },
    [t, e, r]
  ), _ = () => d || o, V = B(() => {
    if (!f) return t;
    const z = t.filter((D) => D.starred).sort((D, R) => D.label.localeCompare(R.label)), A = t.filter((D) => !D.starred).sort((D, R) => {
      const W = e.includes(D.value), q = e.includes(R.value);
      return W && !q ? -1 : !W && q ? 1 : D.label.localeCompare(R.label);
    });
    return [...z, ...A];
  }, [t, e, f]), F = () => {
    r(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ w(Te, { open: $, onOpenChange: u ?? C, children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ w(
      j,
      {
        variant: k,
        ...
        children: [
          ...
          /* @__PURE__ */ a(cn, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(ze, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ w(Ve, { children: [
      /* @__PURE__ */ a(kr, { placeholder: `Search ${o.toLowerCase()}...` }),
      n && /* @__PURE__ */ w("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: F, children: i }),
        /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: I, children: s })
      ] }),
      /* @__PURE__ */ w(Ie, { children: [
        /* @__PURE__ */ a(Zr, { children: c }),
        /* @__PURE__ */ a(we, { children: V.map((z) => /* @__PURE__ */ w(
          Ee,
          {
            value: z.label,
            onSelect: y,
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(gs, { className: "tw:h-4 tw:w-4" }),
...
function ip({
  ...
  return /* @__PURE__ */ w("div", { id: p, className: "tw:flex tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ a(
      si,
      {
        entries: t,
    ...
    e.length > 0 ? /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:items-center tw:gap-2", children: e.map((f) => {
      var g;
      return /* @__PURE__ */ w(vr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          j,
          {
            variant: "ghost",
            ...
            children: /* @__PURE__ */ a(Qr, { className: "tw:h-3 tw:w-3" })
          }
        ),
        (g = t.find((m) => m.value === f)) == null ? void 0 : g.label
      ] }, f);
    }) }) : /* @__PURE__ */ a(_t, { children: u })
  ] });
}
...
function sp({ className: t, ...e }) {
  return /* @__PURE__ */ a(
    ...
    {
      "data-slot": "kbd-group",
      className: h("pr-twp tw:inline-flex tw:items-center tw:gap-1", t),
      ...e
    }
  );
}
...
function Gd({
  ...
  const d = B(() => /Macintosh/i.test(navigator.userAgent), []), l = Go(n, "%undoButton_tooltip%"), u = Go(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ w(ro, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
        j,
      ...
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ w("p", { children: [
        l,
        i && /* @__PURE__ */ w(Q, { children: [
          " ",
          /* @__PURE__ */ a(Ko, { children: d ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(oi, {}),
    e && /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
        j,
        {
          "aria-label": u,
...
function Hd({
  ...
  return Y(() => {
    ...
    const i = /Macintosh/i.test(navigator.userAgent), s = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, c = (l) => {
      ...
      const u = l.key.toLowerCase();
      if (i) {
        if (!l.metaKey) return;
        !l.shiftKey && u === "z" ? (l.preventDefault(), r && ((p = e.current) == null || p.undo())) : l.shiftKey && u === "z" && (l.preventDefault(), o && ((f = e.current) == null || f.redo()));
      } else {
        if (!l.ctrlKey) return;
        !l.shiftKey && u === "z" ? (l.preventDefault(), r && ((g = e.current) == null || g.undo())) : (u === "y" || l.shiftKey && u === "z") && (l.preventDefault(), o && ((m = e.current) == null || m.redo()));
      }
    };
    return document.addEventListener("keydown", c), () => document.removeEventListener("keydown", c);
  }, [o, r, e]), /* @__PURE__ */ a("div", { ref: n, children: t });
}
const Yd = (t, e, r) => t === "generated" ? /* @__PURE__ */ w(Q, { children: [
  /* @__PURE__ */ a("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ w(Q, { children: [
  /* @__PURE__ */ a("p", { children: "-" }),
  " ",
...
function Wd({
  ...
  const i = K(null), s = K(null), c = K(!1), [d, l] = N(t), [u, p] = N(r), [f, g] = N(!1);
  Y(() => {
    l(t);
  }, [t]), Y(() => {
    u !== r && p(r);
  ...
  const m = (v) => {
    c.current = !1, g(v), v || (d !== "custom" || u ? (e(d), o(u)) : (l(t), p(r)));
  }, k = (v) => {
    var T, C, y, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((T = i.current) == null || T.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((y = i.current) == null ? void 0 : y.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ w(ke, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: Yd(t, n, r) }) }) }),
      /* @__PURE__ */ a(ae, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ w(
      Ne,
      {
        ...
        children: [
          /* @__PURE__ */ a(_r, { children: n["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(Ge, {}),
          /* @__PURE__ */ a(
            Me,
            {
...
const Xd = (t, e) => t === "f" ? /* @__PURE__ */ w(Q, { children: [
  /* @__PURE__ */ a(dn, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ w(Q, { children: [
  /* @__PURE__ */ a(wn, {}),
  " ",
...
function Zd({
  ...
  return /* @__PURE__ */ w(ke, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: Xd(t, r) }) }) }),
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: Jd(t, r) }) })
    ] }) }),
    /* @__PURE__ */ w(Ne, { style: { zIndex: rn }, children: [
  ...
  return /* @__PURE__ */ w(
    Ee,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Li, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function ew({
  ...
  return /* @__PURE__ */ w(Ve, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      kr,
      {
    ...
    /* @__PURE__ */ w(Ie, { children: [
      ...
      /* @__PURE__ */ a(we, { children: s.map((d) => {
        var l;
        return /* @__PURE__ */ a(
          Ho,
          {
      ...
      c.length > 0 && /* @__PURE__ */ w(Q, { children: [
        s.length > 0 && /* @__PURE__ */ a(an, { alwaysRender: !0 }),
        /* @__PURE__ */ a(we, { children: c.map((d) => {
          var l;
          return /* @__PURE__ */ a(
            Ho,
            {
...
function cp({
  ...
  const u = K(null), p = K(null), f = K(null), g = K(null);
  Xt(() => {
    if (!g.current) return;
    const { width: P } = g.current.getBoundingClientRect();
    P > 0 && (g.current.style.width = `${P}px`);
  }, []);
  const [m, k] = N("generated"), [v, T] = N("generated"), [C, y] = N("*"), [_, V] = N("*"), [F, I] = N("f"), [$, x] = N(!1), [z, A] = N(!0), [D, R] = N(!1), W = K(!1), q = K(""), [M, Z] = N(!1), [ft, st] = N(), [Ft, vt] = N(), [St, U] = N(), [et, at] = N(), ot = K(null), nt = B(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? Qc(), noteMode: "expanded" }
    }),
    [s, c]
  ), Pt = B(
    () => rw(
  ...
  Y(() => {
    ...
    if (H && Or("note", H)) {
      const pt = (it = H.insert.note) == null ? void 0 : it.caller;
      let bt = "custom";
      pt === $a ? bt = "generated" : pt === Ma ? bt = "hidden" : pt && (y(pt), V(pt)), k(bt), T(bt), I(((rt = H.insert.note) == null ? void 0 : rt.style) ?? "f"), P = setTimeout(() => {
        var xt;
        (xt = u.current) == null || xt.applyUpdate([H]);
      }, 0);
    }
    return () => {
      P && clearTimeout(P);
  ...
  const mt = L(
    (P, H, it = !1) => {
      var pt, bt, xt;
      const rt = (bt = (pt = u.current) == null ? void 0 : pt.getNoteOps(0)) == null ? void 0 : bt.at(0);
      if (rt && Or("note", rt)) {
        if (rt.insert.note) {
          let ht;
          P === "custom" ? ht = H : P === "generated" ? ht = $a : ht = Ma, rt.insert.note.caller = ht;
        }
  ...
  const S = K({ book: n.book, chapterNum: n.chapterNum });
  Xt(() => {
    (S.current.book !== n.book || S.current.chapterNum !== n.chapterNum) && (S.current = { book: n.book, chapterNum: n.chapterNum }, Ut.current());
  }, [n.book, n.chapterNum]);
  const Dt = () => {
    var H;
    ...
    var it, rt, pt, bt, xt;
    I(P);
    const H = (rt = (it = u.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : rt.at(0);
    if (H && Or("note", H)) {
      H.insert.note && (H.insert.note.style = P);
      const ht = (bt = (pt = H.insert.note) == null ? void 0 : pt.contents) == null ? void 0 : bt.ops;
      F !== "x" && P === "x" ? ht == null || ht.forEach((Nt) => aw(Nt)) : F === "x" && P !== "x" && (ht == null || ht.forEach((Nt) => ow(Nt))), (xt = u.current) == null || xt.applyUpdate([H, { delete: 1 }]);
    }
  }, Rt = (P) => {
    at(P.contextMarker), R(P.canRedo);
  }, Se = L(
    (P) => {
      var it, rt, pt, bt, xt;
      const H = (rt = (it = u.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : rt.at(0);
      if (H && Or("note", H)) {
        P.content.length > 1 && setTimeout(() => {
          var E;
          (E = u.current) == null || E.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const ht = (pt = H.insert.note) == null ? void 0 : pt.style, Nt = (xt = (bt = H.insert.note) == null ? void 0 : bt.contents) == null ? void 0 : xt.ops;
        if (ht || x(!1), x(
          ht === "x" ? !!(Nt != null && Nt.every((E) => {
            var ut, yt;
            if (!((ut = E.attributes) != null && ut.char)) return !0;
            const dt = ((yt = E.attributes) == null ? void 0 : yt.char).style;
            return dt === "xt" || dt === "xo" || dt === "xq";
          })) : !!(Nt != null && Nt.every((E) => {
            var ut, yt;
            if (!((ut = E.attributes) != null && ut.char)) return !0;
            const dt = ((yt = E.attributes) == null ? void 0 : yt.char).style;
            return dt === "ft" || dt === "fr" || dt === "fq";
          }))
        ), !W.current) {
          W.current = !0, q.current = JSON.stringify(H), A(!0);
          return;
        }
        A(JSON.stringify(H) === q.current), mt(m, C);
      } else
        x(!1), A(!0);
    },
    [m, C, mt]
    ...
    if (f.current && Pt.length && P && P.rangeCount > 0) {
      const H = P.getRangeAt(0).getBoundingClientRect(), it = f.current.getBoundingClientRect();
      st(H.left - it.left), vt(H.top - it.top), U(H.height), Z(!0);
    }
  }, [Pt, f]);
  Y(() => {
    const P = () => {
    ...
    var P;
    M && ((P = ot.current) == null || P.focus());
  }, [M]), Y(() => {
    var it;
    const P = ((it = p.current) == null ? void 0 : it.querySelector(".editor-input")) ?? void 0, H = (rt) => {
      !M && P && document.activeElement === P && rt.key === c ? (rt.preventDefault(), Kt()) : M && rt.key === "Escape" && (rt.preventDefault(), Z(!1));
    };
  ...
  return /* @__PURE__ */ w(Q, { children: [
    /* @__PURE__ */ w("div", { ref: g, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      /* @__PURE__ */ w("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ w(ro, { children: [
          /* @__PURE__ */ a(
            Gd,
            {
              onUndoClick: () => {
                var P;
                return (P = u.current) == null ? void 0 : P.undo();
              },
              onRedoClick: () => {
                var P;
                return (P = u.current) == null ? void 0 : P.redo();
              },
              canUndo: !z,
              canRedo: D,
              localizedStrings: d
      ...
      /* @__PURE__ */ w(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
              /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
                j,
                {
                  "aria-label": Gt,
              ...
              /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: Gt }) })
            ] }) }) })
          ]
        }
      )
      ...
      if (typeof i == "string") {
        ...
        return /* @__PURE__ */ w(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(Ta, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
...
function cw({
  ...
  const d = o ? /* @__PURE__ */ a("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, l = o ? /* @__PURE__ */ a("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, u = n && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
  // specific class name in case styling is needed.
  /* @__PURE__ */ w("span", { className: h("note-caller tw:inline-block", { formatted: i }), children: [
    n,
    " "
  ] }), p = s && /* @__PURE__ */ w(Q, { children: [
    no(t.marker, [s], o, !1),
    " "
  ] }), f = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", k = h(f, g);
  return /* @__PURE__ */ w(Q, { children: [
    /* @__PURE__ */ w("div", { className: h("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: [
      d,
      u
    ] }),
    /* @__PURE__ */ a("div", { className: h("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: p }),
    /* @__PURE__ */ a(
      "div",
      {
        className: h(
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(Q, { children: iw(t.marker, c, o, l) })
      }
    )
  ] });
}
function dp({
  ...
  const u = d ?? Vs(r, void 0), p = (C, y) => {
    l == null || l(C, y, n);
  }, f = i ? r.findIndex((C) => C === i) : -1, [g, m] = N(f), k = (C, y, _) => {
    if (r.length)
      switch (C.key) {
        case "Enter":
        case " ":
          C.preventDefault(), l == null || l(y, _, n);
          break;
      }
  }, v = (C) => {
    if (r.length)
      switch (C.key) {
        case "ArrowDown":
          C.preventDefault(), m((y) => Math.min(y + 1, r.length - 1));
          break;
        case "ArrowUp":
          C.preventDefault(), m((y) => Math.max(y - 1, 0));
          break;
      }
  }, T = K([]);
  return Y(() => {
    var C;
    g >= 0 && g < T.current.length && ((C = T.current[g]) == null || C.focus());
  }, [g]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((C, y) => {
            ...
            return /* @__PURE__ */ w(Q, { children: [
              ...
              y < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Ze, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function dw({
  ...
  const n = r["%webView_inventory_occurrences_table_header_reference%"], i = r["%webView_inventory_occurrences_table_header_occurrence%"], s = B(() => {
    ...
    return t.forEach((l) => {
      const u = `${l.reference.book}:${l.reference.chapterNum}:${l.reference.verseNum}:${l.text}`;
      d.has(u) || (d.add(u), c.push(l));
    }), c;
  }, [t]);
  return /* @__PURE__ */ w(aa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(oo, { stickyHeader: !0, children: /* @__PURE__ */ w(se, { children: [
      /* @__PURE__ */ a(Xr, { children: n }),
      /* @__PURE__ */ a(Xr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(oa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ w(
      se,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(Qt, { children: xe(c.reference, "English") }),
          /* @__PURE__ */ a(Qt, { className: o, children: lw(c.text) })
        ]
      },
...
const ww = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ a(ks, { className: "tw:h-4 tw:w-4" });
  if (t === "desc")
    return /* @__PURE__ */ a(_s, { className: "tw:h-4 tw:w-4" });
}, na = (t, e, r) => /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
  /* @__PURE__ */ w(
    re,
    {
  ...
  /* @__PURE__ */ a(ae, { side: "bottom", children: e })
] }) }), wp = (t) => ({
  accessorKey: "item",
  ...
  accessorKey: "status",
  header: ({ column: i }) => na(i, t, "tw:justify-center"),
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ w(ei, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Fr,
          {
            onClick: (d) => {
              d.stopPropagation(), ka(
                [c],
                "approved",
                e,
                r,
  ...
  return e ? e[1] : "";
}, pw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", mp = Object.freeze([
  ...
  const n = fo(o.key) ? o.key : o.key[0];
  return {
    items: fo(o.key) ? [o.key] : o.key,
    count: o.count,
...
function vp({
  ...
  const g = le(r, "%webView_inventory_all%"), m = le(r, "%webView_inventory_approved%"), k = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), T = le(r, "%webView_inventory_scope_currentBook%"), C = le(r, "%webView_inventory_scope_chapter%"), y = le(r, "%webView_inventory_scope_verse%"), _ = le(r, "%webView_inventory_filter_text%"), V = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), F = le(r, "%webView_inventory_no_results%"), [I, $] = N(!1), [x, z] = N("all"), [A, D] = N(""), [R, W] = N([]), q = B(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : gw(U, n, i);
  }, [t, n, i]), M = B(() => {
    if (I) return q;
    const U = [];
    return q.forEach((et) => {
      const at = et.items[0], ot = U.find(
        (nt) => nt.items[0] === at
      );
      ot ? (ot.count += et.count, ot.occurrences = ot.occurrences.concat(et.occurrences)) : U.push({
        items: [at],
        count: et.count,
  ...
  }, [I, q]), Z = B(() => M.length === 0 ? [] : hw(M, x, A), [M, x, A]), ft = B(() => {
    var at, ot;
    if (!I) return d;
  ...
  Y(() => {
    Z.length === 0 ? W([]) : Z.length === 1 && W(Z[0].items);
  }, [Z]);
  const st = (U, et) => {
    et.setRowSelection(() => {
      const ot = {};
      return ot[U.index] = !0, ot;
    });
    ...
    if (M.length === 0 || R.length === 0) return [];
    const U = M.filter((et) => Is(
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ w("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ w("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ w(
        er,
        {
          onValueChange: (U) => vt(U),
          defaultValue: x,
          children: [
            /* @__PURE__ */ a(ar, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(rr, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ w(or, { children: [
              /* @__PURE__ */ a(ie, { value: "all", children: g }),
              /* @__PURE__ */ a(ie, { value: "approved", children: m }),
      ...
      /* @__PURE__ */ w(er, { onValueChange: (U) => Ft(U), defaultValue: s, children: [
        /* @__PURE__ */ a(ar, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(rr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ w(or, { children: [
          /* @__PURE__ */ a(ie, { value: "book", children: T }),
          /* @__PURE__ */ a(ie, { value: "chapter", children: C }),
          /* @__PURE__ */ a(ie, { value: "verse", children: y })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Tr,
      ...
      o && /* @__PURE__ */ a(te, { children: /* @__PURE__ */ w(ee, { children: [
        /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ w("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            li,
            {
          ...
          /* @__PURE__ */ a(_t, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? V })
        ] }) }),
        /* @__PURE__ */ a(ae, { children: (o == null ? void 0 : o.checkboxText) ?? V })
      ] }) })
    ] }),
        ...
        children: [
          ...
          t && /* @__PURE__ */ w(
            j,
            {
              ...
              children: [
                /* @__PURE__ */ a(Qr, { className: "tw:h-4 tw:w-4" }),
...
ia.displayName = "SearchBar";
const di = ta(({ className: t, ...e }, r) => /* @__PURE__ */ a(Cs, { size: 35, className: h("tw:animate-spin", t), ...e, ref: r }));
di.displayName = "Spinner";
function fw(t, e = 50) {
  const [r, o] = N(e), n = K(null);
  return Y(() => {
    o(e);
  }, [t, e]), Y(() => {
...
function _a({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ w(Q, { children: [
      /* @__PURE__ */ a(se, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ w(
        se,
        {
          ...
          children: [
            /* @__PURE__ */ a(Qt, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ w(Q, { children: [
              /* @__PURE__ */ a(Oe, { className: "tw:h-3.5 tw:w-3.5", "aria-hidden": !0 }),
              /* @__PURE__ */ a("span", { className: "tw:sr-only", children: t })
            ] }) }),
            /* @__PURE__ */ a(Qt, { className: "tw:border-0 tw:py-1 tw:pr-2 tw:font-normal tw:whitespace-nowrap", children: o.displayName }),
            /* @__PURE__ */ a(Qt, { className: "tw:border-0 tw:py-1 tw:pl-2", children: o.fullName }),
            /* @__PURE__ */ a(Qt, { className: "tw:border-0 tw:py-1 tw:pl-4 tw:text-right tw:text-muted-foreground", children: o.bestLanguageName })
          ]
        },
        o.dblEntryUid
      ))
...
function xp({
  ...
  const [s, c] = N(""), [d, l] = N([]), u = B(
    () => t.filter((R) => !r || R.type === r).filter((R) => mw(R, s)).filter(
      (R) => d.length === 0 || d.includes(R.bestLanguageName)
    ),
    [t, r, s, d]
  ), p = B(
    () => u.filter((R) => o == null ? void 0 : o.includes(R.dblEntryUid)),
    [u, o]
  ), f = B(
    () => u.filter((R) => R.installed && !(o != null && o.includes(R.dblEntryUid))),
    [u, o]
  ), g = B(
    () => u.filter(
    ...
    [u, o]
  ), { visibleItems: m, sentinelRef: k, hasMore: v } = fw(g), T = B(
    () => Array.from(new Set(t.map((R) => R.bestLanguageName))).map((R) => ({
      label: R,
      value: R
    })),
    [t]
  ), C = p.length === 0 && f.length === 0 && g.length === 0, y = me(n, "%resourcePicker_title%"), _ = me(n, "%resourcePicker_search_placeholder%"), V = me(n, "%resourcePicker_language_filter_any%"), F = me(
    n,
    "%resourcePicker_section_already_selected%"
  ), I = me(n, "%resourcePicker_section_installed%"), $ = me(
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = me(n, "%resourcePicker_no_results%"), z = me(n, "%resourcePicker_showing_count%"), A = B(() => {
    if (d.length === T.length || d.length === 0)
      return V;
    if (d.length === 1) {
      const R = T.find((W) => W.value === d[0]);
      if (R) return R.label;
    }
    return be(
      me(n, "%resourcePicker_language_filter_multipleSelected%"),
      {
        selectCount: d.length
      }
    );
  }, [d, T, V, n]), D = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ w(Q, { children: [
    /* @__PURE__ */ a(Ur, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(qr, { children: y }) }),
    /* @__PURE__ */ w("div", { className: "tw:flex tw:gap-2 tw:p-4", children: [
      /* @__PURE__ */ a(
        ia,
        {
          value: s,
    ...
    D && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: be(z, {
      filtered: u.length,
      total: t.length
    }) }),
    /* @__PURE__ */ w("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(di, {}) }),
      C && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: x }),
      !C && !e && /* @__PURE__ */ a(aa, { children: /* @__PURE__ */ w(oa, { children: [
        /* @__PURE__ */ a(_a, { label: F, resources: p }),
        /* @__PURE__ */ a(_a, { label: I, resources: f, onSelect: i }),
        /* @__PURE__ */ a(
          _a,
          {
            label: $,
        ...
        v && /* @__PURE__ */ a(se, { className: "tw:border-0", children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: k, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const vw = "16rem", bw = "3rem", wi = wt.createContext(void 0);
function sa() {
  const t = wt.useContext(wi);
  if (!t)
...
function xw({
  ...
  const [d, l] = wt.useState(t), u = e ?? d, p = wt.useCallback(
    (y) => {
      const _ = typeof y == "function" ? y(u) : y;
      r ? r(_) : l(_);
    },
    [r, u]
  ), f = wt.useCallback(() => p((y) => !y), [p]), g = u ? "expanded" : "collapsed", v = Lt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = wt.useMemo(
    () => ({
      state: g,
      open: u,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(wi.Provider, { value: T, children: /* @__PURE__ */ a(
    "div",
    {
...
function yp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ w(
    j,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Ic, {}) : /* @__PURE__ */ a(Bc, {}),
...
function Tw({
  ...
  const c = t ? ir.Root : "button", { state: d } = sa(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: h(Ew({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ w(ee, { children: [
    /* @__PURE__ */ a(re, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      ae,
      {
        side: "right",
...
function Dp({
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      ...r,
      children: [
        e && /* @__PURE__ */ a(Ea, { className: "tw:size-4 tw:rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ a(
          Ea,
          {
...
function zw({
  ...
  const l = L(
    ...
    (g) => {
      const m = r.find((k) => k.projectId === g);
  ...
  return /* @__PURE__ */ a(
    yw,
    {
      ...
      children: /* @__PURE__ */ w(_w, { children: [
        /* @__PURE__ */ w(Yo, { children: [
          /* @__PURE__ */ a(Wo, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(Xo, { children: /* @__PURE__ */ a(Nw, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(Cw, { children: /* @__PURE__ */ a(
            Tw,
            {
              onClick: () => l(g),
              isActive: f(g),
        ...
        /* @__PURE__ */ w(Yo, { children: [
          /* @__PURE__ */ a(Wo, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(Xo, { className: "tw:pl-3", children: /* @__PURE__ */ w(
            "div",
            {
              className: h(
              ...
              children: [
                /* @__PURE__ */ a(Es, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  ji,
                  {
                    mode: "project",
...
const Re = "scrBook", Sw = "scrRef", qe = "source", Dw = "details", Rw = "Scripture Reference", $w = "Scripture Book", ui = "Type", Mw = "Details";
function Ow(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Wt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Re ? xe(n.start) : void 0;
      },
      getGroupingValue: (o) => Wt.bookIdToNumber(o.start.book),
      sortingFn: (o, n) => za(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
...
const Aw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || za(t.start, t.end) === 0 ? `${wa(t.start)}+${e}` : `${wa(t.start)}+${e}-${wa(t.end)}+${r}`;
}, Jo = (t) => `${Aw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ap({
  sources: t,
  ...
  const [l, u] = N([]), [p, f] = N([{ id: Re, desc: !1 }]), [g, m] = N({}), k = B(
  ...
  Y(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const A = k.find((D) => Jo(D) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [g, k, c, T]);
  const C = n ?? $w, y = i ?? ui, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${C}`, value: [Re] },
  ...
  }, I = (x, z) => x.getIsGrouped() ? "" : h("banded-row", z % 2 === 0 ? "even" : "odd"), $ = (x, z, A) => {
  ...
  return /* @__PURE__ */ w("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ w(
      er,
      {
        ...
        children: [
          /* @__PURE__ */ a(ar, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(rr, {}) }),
          /* @__PURE__ */ a(or, { position: "item-aligned", children: /* @__PURE__ */ a($d, { children: _.map((x) => /* @__PURE__ */ a(ie, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ w(aa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(oo, { children: T.getHeaderGroups().map((x) => /* @__PURE__ */ a(se, { children: x.headers.filter((z) => z.column.columnDef.header).map((z) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Xr, { colSpan: z.colSpan, className: "tw:sticky top-0", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ w("div", { children: [
          ...
          " ",
          fr(z.column.columnDef.header, z.getContext())
        ] }) }, z.id)
      )) }, x.id)) }),
      /* @__PURE__ */ a(oa, { children: T.getRowModel().rows.map((x, z) => {
        const A = Lt();
        return /* @__PURE__ */ a(
          se,
          {
                  ...
                  Qt,
                  {
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ w(
                      j,
                      {
                        ...
                        type: "button",
                        children: [
                          x.getIsExpanded() && /* @__PURE__ */ a(Qe, {}),
                          !x.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a(Ts, {}) : /* @__PURE__ */ a(zs, {})),
                          " ",
                          fr(D.column.columnDef.cell, D.getContext()),
                          " (",
                          x.subRows.length,
                          ")"
                        ]
...
const hi = (t, e, r) => io(t, e).every((o) => r.includes(o));
function Pw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], u = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: g, extraLong: m } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [k, v] = N(!1), [T, C] = N(""), y = K(void 0), _ = K(!1), V = B(
    () => pi(t),
    [t]
  ), F = B(() => {
    if (!T.trim()) {
    ...
    (D, R = !1) => {
      ...
      const W = V.findIndex((st) => st === y.current), q = V.findIndex((st) => st === D);
      if (W === -1 || q === -1) return;
      const [M, Z] = [
        Math.min(W, q),
        Math.max(W, q)
      ], ft = V.slice(M, Z + 1).map((st) => st);
      r(
        e.includes(D) ? e.filter((st) => !ft.includes(st)) : [.../* @__PURE__ */ new Set([...e, ...ft])]
      );
    },
    [e, r, V]
  ), $ = (D) => {
    I(D, _.current), _.current = !1;
  }, x = (D, R) => {
    D.preventDefault(), I(R, D.shiftKey);
  }, z = () => {
    r(V.map((D) => D));
  }, A = () => {
    r([]);
  ...
  return /* @__PURE__ */ w(
    Te,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(ze, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ w(
          Ve,
          {
            shouldFilter: !1,
            onKeyDown: (D) => {
              D.key === "Enter" && (_.current = D.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                kr,
              ...
              /* @__PURE__ */ w("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: z, children: d }),
                /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: A, children: l })
              ] }),
              /* @__PURE__ */ w(Ie, { children: [
                /* @__PURE__ */ a(Zr, { children: u }),
                Object.values(lt).map((D, R) => {
                  const W = F[D];
                  if (W.length !== 0)
                    return /* @__PURE__ */ w(pn, { children: [
                      /* @__PURE__ */ a(
                        we,
                        {
                          heading: tn(D, p, f, g, m),
                          children: W.map((q) => /* @__PURE__ */ a(
                            Rn,
                            {
                              bookId: q,
                      ...
                      R < Object.values(lt).length - 1 && /* @__PURE__ */ a(an, {})
                    ] }, D);
                })
              ] })
            ]
...
function Vw({
  ...
  return /* @__PURE__ */ a(
    j,
    {
      ...
      onClick: () => o(t),
      className: h(
        hi(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: qi(
        t,
...
function Iw({
  ...
  const i = o["%webView_book_selector_more%"], s = B(
    () => pi(t),
    [t]
  ), c = L(
    (d) => {
      const l = io(s, d).map((u) => u);
      r(
        hi(s, d, e) ? e.filter((u) => !l.includes(u)) : [.../* @__PURE__ */ new Set([...e, ...l])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ w("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(lt).map((d) => /* @__PURE__ */ a(
      Vw,
      {
        section: d,
        availableBookIds: s,
    ...
    e.length > 0 && /* @__PURE__ */ w("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Na ? Na : Zo
      ).map((d) => /* @__PURE__ */ a(vr, { className: "tw:hover:bg-secondary", variant: "secondary", children: $e(d, n) }, d)),
      e.length > Na && /* @__PURE__ */ a(
        vr,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - Zo} ${i}`
        }
      )
    ] })
  ] });
...
function Vp({
  ...
  const _ = Tt(
    s,
    "%webView_scope_selector_selected_text%"
  ), V = Tt(s, "%webView_scope_selector_verse%"), F = Tt(s, "%webView_scope_selector_chapter%"), I = Tt(s, "%webView_scope_selector_book%"), $ = Tt(
    s,
    "%webView_scope_selector_current_verse%"
  ), x = Tt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), z = Tt(s, "%webView_scope_selector_current_book%"), A = Tt(s, "%webView_scope_selector_choose_books%"), D = Tt(s, "%webView_scope_selector_scope%"), R = Tt(s, "%webView_scope_selector_select_books%"), W = Tt(s, "%webView_scope_selector_range%"), q = Tt(s, "%webView_scope_selector_select_range%"), M = Tt(s, "%webView_scope_selector_range_start%"), Z = Tt(s, "%webView_scope_selector_range_end%"), ft = Tt(s, "%webView_scope_selector_ok%"), st = Tt(s, "%webView_scope_selector_cancel%"), Ft = Tt(s, "%webView_scope_selector_navigate%"), vt = (O) => {
    if (!m) return;
  ...
  ], U = (O, X, It = !1) => /* @__PURE__ */ w(Q, { children: [
    O,
    X && !It && /* @__PURE__ */ w("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), et = e ? St.filter((O) => e.includes(O.value)) : St, at = m ?? ua, ot = u ?? at, nt = p ?? at, Pt = () => {
  }, mt = K(null), jt = K(null), Ut = K(!1), S = K(null), Dt = K(!1), [Vt, ne] = N(void 0), qt = K(!1), Rt = K(!1), Se = K(null), Kt = L((O) => {
    if (O) {
      ne("start"), qt.current = !1;
      return;
    }
    ne((X) => X === "start" ? void 0 : X), qt.current && (qt.current = !1, requestAnimationFrame(() => {
      var It;
      const X = (It = mt.current) == null ? void 0 : It.querySelector("button");
      X == null || X.click();
    }));
  }, []), Gt = L((O) => {
    if (O) {
    ...
    (O) => {
      f == null || f(O), g == null || g(O), qt.current = !0;
    },
    [f, g]
  ), H = L(
    (O) => {
      g == null || g(O), Rt.current = !0;
    },
    [g]
  ), it = L(
    (O) => {
      r(O), O === "selectedBooks" && n.length === 0 && (m != null && m.book) && i([m.book]);
    },
    [r, n, m, i]
  ), rt = et.find((O) => O.value === t), pt = () => t === "selectedBooks" && n.length > 0 ? n.map((O) => O.toUpperCase()).join(", ") : t === "range" ? Bs(ot, nt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : rt ? U(rt.label, rt.scrRefSuffix) : t, bt = et.filter(
    (O) => O.value !== "selectedBooks" && O.value !== "range"
  ), xt = et.find((O) => O.value === "selectedBooks"), ht = et.find((O) => O.value === "range"), [Nt, E] = N(!1), [dt, ut] = N(void 0), [yt, Le] = N(void 0), [De, cr] = N(void 0), [Fe, lr] = N(void 0), [dr, zr] = N([]), Sr = l === "dropdown" && dt === "selectedBooks", b = /* @__PURE__ */ a(
    Iw,
    {
      availableBookInfo: o,
      selectedBookIds: Sr ? dr : n,
      onChangeSelectedBookIds: Sr ? zr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), G = Vt === "end", J = Vt === "start", Ct = "tw:text-muted-foreground", Jt = l === "dropdown" && dt === "range", Ye = Jt ? cr : P, $t = Jt ? lr : g ? H : Pt, kt = /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ w("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: h(G && Ct), children: M }),
      /* @__PURE__ */ a(
        pa,
        {
    ...
    /* @__PURE__ */ w("div", { ref: mt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: h(J && Ct), children: Z }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: T,
          disableReferencesUpTo: Jt ? De ?? ot : ot,
          onOpenChange: Gt,
          onCloseAutoFocus: (O) => {
            var X;
            Rt.current && (Rt.current = !1, O.preventDefault(), (X = Se.current) == null || X.focus());
          },
          className: h(J && Ct),
          modal: !0,
          align: "start"
  ...
  Y(() => {
    ...
    const X = requestAnimationFrame(() => {
      O = requestAnimationFrame(() => {
        var It;
        (It = Et.current[t]) == null || It.focus();
      });
    });
    return () => {
      cancelAnimationFrame(X), O && cancelAnimationFrame(O);
    };
  }, [Nt, t]);
  const [Yt, je] = N(null), [Dr, ki] = N(null), [Rr, _i] = N(null), Ni = 200, [Ci, Ei] = N(!1);
  Y(() => {
    if (!Rr || typeof ResizeObserver > "u") return;
    const O = new ResizeObserver(([X]) => {
      Ei(X.contentRect.width < Ni);
    });
    return O.observe(Rr), () => O.disconnect();
  }, [Rr]);
  const so = L(
    (O) => {
      Le(O), cr(ot), lr(nt), zr(n), E(!1), ut(O);
    },
    [ot, nt, n]
  ), co = L(() => {
    yt !== void 0 && (yt === "range" ? (De && (f == null || f(De)), Fe && (g == null || g(Fe))) : yt === "selectedBooks" && i(dr), it(yt), ut(void 0), Le(void 0));
  }, [
    yt,
    De,
    Fe,
    ...
    O || (ut(void 0), Le(void 0));
  }, []), lo = L((O) => {
    var X;
    O.preventDefault(), (X = Ht.current) == null || X.focus();
  }, []), wo = (O) => t === O ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Oe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ w("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ w("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(_t, { children: D }),
      l === "dropdown" ? /* @__PURE__ */ w(ke, { open: Nt, onOpenChange: E, children: [
        /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ w(
          j,
          {
            ref: Ht,
            variant: "outline",
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: pt() }),
              /* @__PURE__ */ a(Qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ w(la, { container: Rr, children: [
              bt.map(({ value: O, label: X, dropdownLabel: It, scrRefSuffix: ur, id: Ti }) => /* @__PURE__ */ w(
                Ke,
                {
                  ref: gt(O),
                  ...
                  children: [
                    t === O && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Oe, { className: "tw:h-4 tw:w-4" }) }),
                    U(It ?? X, ur, Ci)
                  ]
                },
                Ti
              ...
              k && /* @__PURE__ */ w(Q, { children: [
                /* @__PURE__ */ a(Ge, {}),
                /* @__PURE__ */ a(_r, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Ft }),
                /* @__PURE__ */ a(
                  Ke,
                  {
                    ref: S,
                    ...
                    onSelect: (O) => {
                      var X, It;
                      if (O.preventDefault(), Ut.current) {
                        Ut.current = !1;
                        return;
                      }
                      Dt.current || (It = (X = jt.current) == null ? void 0 : X.querySelector("button")) == null || It.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (O) => {
                          const X = O.target instanceof HTMLElement ? O.target : void 0;
                          X != null && X.closest("button") && (Ut.current = !0, requestAnimationFrame(() => {
                            Ut.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          pa,
                          {
                            ...
                            onCloseAutoFocus: (O) => {
                              var X;
                              O.preventDefault(), (X = S.current) == null || X.focus();
                            },
                            modal: !0,
                            className: "tw:w-full tw:min-w-0 tw:max-w-none tw:justify-between tw:px-2 tw:font-normal",
                            triggerContent: /* @__PURE__ */ w(Q, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: xe(m ?? ua, "id") }),
                              /* @__PURE__ */ a(Qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        On,
        {
          ...
          children: et.map(({ value: O, label: X, scrRefSuffix: It, id: ur }) => /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Pa, { className: "tw:me-2", value: O, id: ur }),
            /* @__PURE__ */ a(_t, { htmlFor: ur, children: U(X, It) })
          ] }, ur))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ w("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { children: R }),
      b
    ] }),
    l === "radio" && t === "range" && kt,
    l === "dropdown" && xt && /* @__PURE__ */ a(Oa, { open: dt === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      Aa,
      {
        ref: ki,
        onCloseAutoFocus: lo,
        onEscapeKeyDown: (O) => {
          Dr != null && Dr.querySelector('[data-state="open"]') && O.preventDefault();
        },
        children: /* @__PURE__ */ w(la, { container: Dr, children: [
          /* @__PURE__ */ a(Ur, { className: "tw:pe-8", children: /* @__PURE__ */ a(qr, { children: A }) }),
          b,
          /* @__PURE__ */ w(Co, { children: [
            /* @__PURE__ */ a(j, { variant: "outline", onClick: () => $r(!1), children: st }),
            /* @__PURE__ */ a(j, { onClick: co, children: ft })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ht && /* @__PURE__ */ a(Oa, { open: dt === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      Aa,
      {
        ref: je,
        onCloseAutoFocus: lo,
        onEscapeKeyDown: (O) => {
          Yt != null && Yt.querySelector('[data-state="open"]') && O.preventDefault();
        },
        children: /* @__PURE__ */ w(la, { container: Yt, children: [
          /* @__PURE__ */ a(Ur, { className: "tw:pe-8", children: /* @__PURE__ */ a(qr, { children: q }) }),
          kt,
          /* @__PURE__ */ w(Co, { children: [
            /* @__PURE__ */ a(j, { variant: "outline", onClick: () => $r(!1), children: st }),
            /* @__PURE__ */ a(j, { ref: Se, onClick: co, children: ft })
          ] })
        ] })
      }
    ) })
...
function Ip({
  ...
  return /* @__PURE__ */ w(
    er,
    {
      ...
      children: [
        /* @__PURE__ */ a(ar, { size: n, className: h("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          rr,
          {
            placeholder: c[mo(e)] ?? e
          }
        ) }),
        /* @__PURE__ */ a(
          or,
          {
            ...
            style: { zIndex: nr },
            children: t.map((l) => /* @__PURE__ */ a(ie, { value: `${l}`, children: c[mo(l)] }, `${l}`))
          }
        )
      ]
    }
...
const fi = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ w(ee, { children: [
  /* @__PURE__ */ a(re, { asChild: !0, children: "command" in c ? /* @__PURE__ */ w(
    Ke,
    {
      onClick: () => {
        o(c);
    ...
    /* @__PURE__ */ a(Gi, { children: c.label }),
    /* @__PURE__ */ a(Hi, { children: /* @__PURE__ */ a(Yi, { children: fi(
      t,
      e,
      gi(t, c.id),
      o
  ...
  c.tooltip && /* @__PURE__ */ a(ae, { children: c.tooltip })
...
function Fa({
  ...
  return /* @__PURE__ */ w(ke, { variant: i, children: [
    /* @__PURE__ */ a(_e, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(j, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ss, {}) }) }),
    /* @__PURE__ */ a(Ne, { align: "start", style: { zIndex: nr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, u) => /* @__PURE__ */ w(pn, { children: [
      /* @__PURE__ */ a(en, { children: /* @__PURE__ */ a(te, { children: fi(e.groups, e.items, d, t) }) }),
      l < u.length - 1 && /* @__PURE__ */ a(Ge, {})
    ] }, d)) })
  ] });
}
const mi = wt.forwardRef(
...
function jp({
  ...
  return /* @__PURE__ */ w(mi, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Fa,
      {
        onSelectMenuItem: t,
...
function Up({
  ...
  return /* @__PURE__ */ a(mi, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    Fa,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const vi = wt.forwardRef(({ className: t, ...e }, r) => {
  const o = Lt();
  return /* @__PURE__ */ a(
    ce.Root,
    {
...
vi.displayName = ce.List.displayName;
const bi = wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.List,
  {
    ref: r,
    className: h(
...
bi.displayName = ce.List.displayName;
const Fw = wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Trigger,
  {
    ref: r,
    ...e,
...
function qp({
  ...
  return /* @__PURE__ */ w("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ w(vi, { children: [
      /* @__PURE__ */ a(bi, { children: t.map((c) => /* @__PURE__ */ a(Fw, { value: c.value, children: c.value }, c.key)) }),
...
function jw({
  ...
  return /* @__PURE__ */ a(Wi.Provider, { value: o, children: /* @__PURE__ */ a(
    ge.Root,
    {
      "data-slot": "menubar",
      className: h(
  ...
  return /* @__PURE__ */ a(
    ge.Trigger,
    {
      ...
      className: h(
        ...
        Ua({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
...
function Gw({
  ...
  const i = Nr();
  return /* @__PURE__ */ a(qw, { children: /* @__PURE__ */ a(
    ge.Content,
    {
  ...
  return /* @__PURE__ */ a(
    ge.Item,
    {
      ...
      className: h(
        ...
        // CUSTOM: Apply variant-driven styles from menu context
        Ua({ variant: n.variant, className: t })
      ),
      ...o
    }
  );
...
function Xw({
  ...
  return /* @__PURE__ */ w(
    ge.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(En, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
...
const hr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, u) => l.order - u.order).map((l) => /* @__PURE__ */ w(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: "command" in l ? /* @__PURE__ */ w(
        Hw,
        {
          onClick: () => {
            o(l);
      ...
      ) : /* @__PURE__ */ w(Ww, { children: [
        /* @__PURE__ */ a(Xw, { children: l.label }),
        /* @__PURE__ */ a(Jw, { children: yi(
          t,
          e,
          gi(t, l.id),
          o
      ...
      l.tooltip && /* @__PURE__ */ a(ae, { children: l.tooltip })
    ] }, `tooltip-${l.label}-${"command" in l ? l.command : l.id}`)), d = [...c];
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(Yw, {}, `separator-${i}`)), d;
  });
};
function Zw({
  menuData: t,
  ...
  const n = K(void 0), i = K(void 0), s = K(void 0), c = K(void 0), d = K(void 0), l = (u) => {
    switch (u) {
      case "platform.app":
        return i;
  ...
  if (el(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, p) => {
    var m, k, v, T;
    u.preventDefault();
    const f = { key: "Escape", code: "Escape", keyCode: 27, bubbles: !0 }, g = { key: " ", code: "Space", keyCode: 32, bubbles: !0 };
    switch (p.hotkey) {
      case "alt":
        hr(i, [f]);
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), hr(i, [f, g]);
        break;
      case "alt+l":
        (k = s.current) == null || k.focus(), hr(s, [f, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), hr(c, [f, g]);
        break;
      case "alt+h":
        (T = d.current) == null || T.focus(), hr(d, [f, g]);
        break;
    }
  }), Y(() => {
    ...
    const u = new MutationObserver((g) => {
      g.forEach((m) => {
        if (m.attributeName === "data-state" && m.target instanceof HTMLElement) {
          const k = m.target.getAttribute("data-state");
          r(k === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ a(jw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, p]) => typeof u == "boolean" || typeof p == "boolean" ? 0 : u.order - p.order).map(([u, p]) => /* @__PURE__ */ w(Uw, { children: [
      /* @__PURE__ */ a(Kw, { ref: l(u), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        Gw,
        {
          style: { zIndex: nr },
          children: /* @__PURE__ */ a(te, { children: yi(t.groups, t.items, u, e) })
        }
      )
    ] }, u)) });
}
...
function Hp({
  ...
  const l = Qw(
    ...
    n && n(m), o && o([m, ...r.filter((k) => k !== m)]), i && r.find((k) => k === m) && i([...r.filter((k) => k !== m)]), p(!1);
  }, g = (m, k) => {
    var T, C, y, _, V, F;
    const v = k !== m ? ((C = (T = t[m]) == null ? void 0 : T.uiNames) == null ? void 0 : C[k]) ?? ((_ = (y = t[m]) == null ? void 0 : y.uiNames) == null ? void 0 : _.en) : void 0;
    return v ? `${(V = t[m]) == null ? void 0 : V.autonym} (${v})` : (F = t[m]) == null ? void 0 : F.autonym;
  };
  return /* @__PURE__ */ w("div", { id: d, className: h("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ w(
      er,
      {
        name: "uiLanguage",
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: nr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(ie, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(_t, { className: "tw:font-normal tw:text-muted-foreground", children: be(l, {
      fallbackLanguages: (r == null ? void 0 : r.length) > 0 ? r.map((m) => g(m, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function tu({ item: t, createLabel: e, createComplexLabel: r }) {
...
function eu({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: e, children: r.map((c) => /* @__PURE__ */ w("div", { className: "tw:m-2 tw:flex tw:items-center", children: [
    /* @__PURE__ */ a(
      li,
      {
      ...
      children: [
        /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ w("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ w(ke, { children: [
              /* @__PURE__ */ a(_e, { className: h(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(go, {}) }) }),
              /* @__PURE__ */ a(Ne, { align: "end", children: l })
            ] }) }),
            e && l && /* @__PURE__ */ w(ke, { children: [
              /* @__PURE__ */ a(_e, { className: h(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(go, {}) }) }),
              /* @__PURE__ */ a(Ne, { align: "end", children: l })
            ] })
          ] }),
...
function ch({
  ...
  return /* @__PURE__ */ w(
    zt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(En, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function vh({
  ...
  const n = Lt();
  return /* @__PURE__ */ w(au, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(ou, {}),
    /* @__PURE__ */ w(
      Be.Content,
      {
...
function zh({
  ...
  return /* @__PURE__ */ a(
    ce.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: h("pr-twp", nu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
cu(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Iu as BOOK_SELECTOR_STRING_KEYS,
  vr as Badge,
  ...
  j as Button,
  ro as ButtonGroup,
  oi as ButtonGroupSeparator,
  Lu as ButtonGroupText,
  ni as CANCEL_ACCEPT_BUTTONS_STRING_KEYS,
  ju as COMMENT_EDITOR_STRING_KEYS,
  Uu as COMMENT_LIST_STRING_KEYS,
  ii as CancelAcceptButtons,
  Ed as Card,
  Td as CardContent,
  ...
  ew as MarkerMenu,
  op as MoreInfo,
  si as MultiSelectComboBox,
  qp as NavigationContentSearch,
  Te as Popover,
  Fi as PopoverAnchor,
  ze as PopoverContent,
  Vh as PopoverDescription,
  Ih as PopoverHeader,
  la as PopoverPortalContainerProvider,
  Bh as PopoverTitle,
  Pe as PopoverTrigger,
  _h as Progress,
  bp as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  On as RadioGroup,
  Pa as RadioGroupItem,
  il as RecentSearches,
  Lh as ResizableHandle,
  Fh as ResizablePanel,
  jh as ResizablePanelGroup,
  xp as ResourcePickerDialog,
  Wp as ResultsCard,
  Pp as SCOPE_SELECTOR_STRING_KEYS,
  Bw as SELECT_BOOKS_STRING_KEYS,
  Vp as ScopeSelector,
  Ap as ScriptureResultsViewer,
  Ip as ScrollGroupSelector,
  ia as SearchBar,
  er as Select,
  Iw as SelectBooks,
  Pw as SelectBooksPicker,
  or as SelectContent,
  $d as SelectGroup,
  ie as SelectItem,
  Xu as SelectLabel,
  ...
  Ju as SelectSeparator,
  ar as SelectTrigger,
  rr as SelectValue,
  Ze as Separator,
  Bp as SettingsList,
  Fp as SettingsListHeader,
  Lp as SettingsListItem,
  ...
  Di as Z_INDEX_MODAL,
  Ri as Z_INDEX_MODAL_BACKDROP,
  Ui as Z_INDEX_OVERLAY,
  Uh as badgeVariants,
  Nd as buttonGroupVariants,
  qh as buttonVariants,
  h as cn,
