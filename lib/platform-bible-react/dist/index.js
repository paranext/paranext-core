...
import b, { forwardRef as nn, useRef as Y, useMemo as F, useState as R, useCallback as K, useLayoutEffect as Zt, createContext as kn, useContext as mr, useEffect as q, Component as ps, createElement as Lr, Suspense as us, Fragment as po } from "react";
import { Command as kt } from "cmdk";
import { X as Pe, Search as uo, Check as Vt, Clock as Vr, ChevronsLeft as jr, ChevronsRight as zr, ChevronLeft as Yn, ChevronRight as Re, ArrowLeft as ms, ArrowRight as fs, Circle as _n, ChevronDown as $e, BoldIcon as hs, ItalicIcon as gs, AtSign as mo, Pencil as bs, Trash2 as vs, ArrowUp as fo, MoreHorizontal as ho, MailOpen as xs, Mail as ys, ChevronUp as go, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as bo, Filter as Ts, User as Rs, Link as Ss, CircleHelp as Ds, ChevronsUpDown as vo, Star as Ms, SquareX as xo, FunctionSquare as yo, SquareSigma as No, Ban as Os, AlertCircle as Xn, CircleCheckIcon as Is, CircleXIcon as As, CircleHelpIcon as Ps, ArrowUpIcon as $s, ArrowDownIcon as Ls, PanelLeft as Vs, PanelRight as js, ScrollText as zs, MenuIcon as Fs, Menu as Bs, EllipsisVertical as Ks, LoaderCircle as Gs, GripVertical as qs } from "lucide-react";
import { clsx as Us } from "clsx";
import { extendTailwindMerge as Hs } from "tailwind-merge";
import * as $t from "@radix-ui/react-dialog";
import { Canon as wt } from "@sillsdev/scripture";
import { includes as ln, Section as U, getChaptersForBook as Ys, formatScrRef as be, getSectionForBook as He, formatRelativeDate as Xs, formatReplacementString as ge, sanitizeHtml as Ws, NumberFormat as Js, formatBytes as Zs, getCurrentLocale as Qs, usfmMarkers as un, getFormatCallerFunction as ti, deepEqual as ei, isString as Fr, compareScrRefs as Wn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import { createEditor as _o, $getRoot as ie, $createParagraphNode as Cn, $getSelection as Lt, HISTORY_MERGE_TAG as fr, ParagraphNode as Co, TextNode as Eo, $isTokenOrSegmented as ni, $getCharacterOffsets as ri, $cloneWithPropertiesEphemeral as oi, $findMatchingParent as To, $isElementNode as ae, $isRangeSelection as ye, CLEAR_EDITOR_COMMAND as Ro, COMMAND_PRIORITY_EDITOR as So, mergeRegister as le, shallowMergeConfig as ai, defineExtension as Gt, safeCast as rn, createState as si, FORMAT_TEXT_COMMAND as Do, $isNodeSelection as Mo, COMMAND_PRIORITY_LOW as Oo, RootNode as ii, LineBreakNode as li, TabNode as wi, $isEditorState as ci, createCommand as di, CLICK_COMMAND as pi, isDOMNode as ui, $getNodeFromDOMNode as mi, $createNodeSelection as fi, $setSelection as hi, DecoratorNode as Jn, $getState as gi, toggleTextFormatType as Br, TEXT_TYPE_TO_FORMAT as bi, $setState as vi, addClassNamesToElement as Io, $create as xi, $getNodeByKey as yi, removeClassNamesFromElement as Ni, KEY_TAB_COMMAND as ki, $isBlockElementNode as hn, $createRangeSelection as _i, $normalizeSelection__EXPERIMENTAL as Ci, OUTDENT_CONTENT_COMMAND as Ei, INDENT_CONTENT_COMMAND as Kr, INSERT_TAB_COMMAND as Ti, COMMAND_PRIORITY_CRITICAL as hr, $isDecoratorNode as Ri, $isParagraphNode as Si, $isTextNode as gn, SELECTION_CHANGE_COMMAND as Ao, getRegisteredNode as Di, isHTMLElement as Mi, isDocumentFragment as Gr, isDOMDocumentNode as Oi, ArtificialNode__DO_NOT_USE as Po, $createLineBreakNode as $o, $isRootOrShadowRoot as Ii, isBlockDomNode as qr, isInlineDomNode as Ur, $insertNodes as Ai } from "lexical";
import * as Ve from "@radix-ui/react-tooltip";
import { TooltipTrigger as Pi } from "@radix-ui/react-tooltip";
import { HeadingNode as $i, QuoteNode as Li, registerRichText as Vi } from "@lexical/rich-text";
import { flushSync as ji, createPortal as zi } from "react-dom";
...
import { DropdownMenuTrigger as Bi } from "@radix-ui/react-dropdown-menu";
import { useReactTable as zo, getFilteredRowModel as Ki, getSortedRowModel as Fo, getPaginationRowModel as Gi, getCoreRowModel as Bo, flexRender as Ye, getGroupedRowModel as qi, getExpandedRowModel as Ui } from "@tanstack/react-table";
import * as lt from "@radix-ui/react-select";
import Hi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Zn, HIDDEN_NOTE_CALLER as Qn, getDefaultViewOptions as Yi, isInsertEmbedOpOfType as wn, Editorial as Xi } from "@eten-tech-foundation/platform-editor";
...
const tl = $t.Root, el = $t.Portal, Ko = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Overlay,
  {
    ref: n,
    className: f(
...
Go.displayName = $t.Content.displayName;
...
const nl = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Description,
  {
    ref: n,
...
nl.displayName = $t.Description.displayName;
...
Ho.displayName = kt.Separator.displayName;
const qt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  kt.Item,
  {
    ref: n,
...
const Jo = nn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Le : "button", { className: f(Zo({ variant: e, size: n, className: t })), ref: i, ...a })
);
B.displayName = "Button";
const ne = Se.Root, de = Se.Trigger, ol = Se.Anchor, Ut = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ft();
...
function rr(t, e, n) {
  return `${t} ${ve[t]}${e ? ` ${br(t, e)} ${Te(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function al({
  recentSearches: t,
...
function ip({
  ...
  const w = ft(), [p, u] = R(!1), [h, m] = R(""), [g, x] = R(""), [v, y] = R("books"), [N, _] = R(void 0), [k, z] = R(!1), L = Y(void 0), T = Y(void 0), $ = Y(void 0), C = Y(void 0), S = Y({}), V = K(
    ...
    (E) => {
      if (E.ctrlKey) return;
      const { isLetter: X, isDigit: nt } = Hr(E.key);
      if (v === "chapters") {
        if (E.key === "Backspace") {
          ...
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              B,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(ms, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fs, { className: "tw-h-4 tw-w-4" })
              }
            ),
...
), mt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ko.Root, { ref: n, className: f("pr-twp", wl(), t), ...e }));
...
xr.displayName = Ze.Root.displayName;
...
var ar = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(ar || {});
((t) => {
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ul = ta ? Zt : q, cn = { tag: fr };
function ml({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = pl(null, o), p = _o({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, El = ea && "documentMode" in document ? document.documentMode : null;
!(!ea || !("InputEvent" in window) || El) && "getTargetRanges" in new window.InputEvent("input");
function Tl(t) {
  const e = To(t, (n) => ae(n) && !n.isInline());
...
function Rl(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = To(i, (w) => ae(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
function Ol(t) {
  ...
  ra(this), J = t, this.f &= -2, 8 & this.f && kr(this), Tn();
}
function Ee(t, e) {
...
vt.prototype.brand = Sl, vt.prototype.h = function() {
  ...
  if (this.g = mn, this.f |= 1, this.i > 0 && !na(this)) return this.f &= -2, !0;
  const t = J;
  try {
    Jr(this), J = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, oa(this), Jr(this), se++;
  const t = J;
...
Gt({ build: (t, e, n) => Rn(e), config: rn({ $onClear: aa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return we(() => sa(t, o.value));
} });
function Il(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Vn = si("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ia extends Jn {
  $config() {
...
Gt({ name: "@lexical/extension/DecoratorText", nodes: () => [ia], register: (t, e, n) => t.registerCommand(Do, (o) => {
  const a = Lt();
  if (Mo(a) || ye(a)) for (const i of a.getNodes()) Al(i) && i.toggleFormat(o);
  return !1;
}, Oo) });
function la(t, e) {
  let n;
...
const ir = Gt({ build: (t) => la(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const _r = 0, lr = 1, ca = 2, jn = 3, dn = 4, Ce = 5, zn = 6, Ge = 7;
function Fn(t) {
  return t.id === _r;
}
function da(t) {
...
function Pl(t) {
  return function(e) {
    return e.id === lr;
  }(t) || et(305, String(t.id), String(lr)), Object.assign(t, { id: ca });
}
...
class Ll {
  constructor(e, n) {
    ...
    bt(this, "state");
    bt(this, "_signal");
    this.builder = e, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: _r };
  }
  mergeConfigs() {
...
const jl = Gt({ config: rn({ setOptions: Zr, updateOptions: Zr }), init: ({ $initialEditorState: t = Vl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: i } = a;
    if (ci(i)) t.setEditorState(i, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ii, Eo, li, wi, Co] }), Qr = Symbol.for("@lexical/extension/LexicalBuilder");
function to() {
}
function zl(t) {
  throw t;
...
class We {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Fn(i) || et(300, s, a || "[unknown]"), Fn(l = i) || et(304, String(l.id), String(_r)), i = Object.assign(l, { id: lr }), o.state = i;
...
const Fl = /* @__PURE__ */ new Set(), eo = Gt({ build(t, e, n) {
  const o = n.getDependency(ir).output, a = Qe({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = la(() => {
    ...
    o.value.read(() => {
      if (Lt()) for (const [p, u] of l.entries()) {
        ...
        const h = yi(p), m = h && h.isSelected() || !1;
...
Gt({ dependencies: [ir, eo], name: "@lexical/extension/HorizontalRule", nodes: () => [De], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(eo).output, a = Qe({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return le(t.registerCommand(pi, (s) => {
    if (ui(s.target)) {
      const l = mi(s.target);
      if (Kl(l)) return function(c, w = !1) {
        const p = Lt(), u = c.isSelected(), h = c.getKey();
        let m;
        w && Mo(p) ? m = p : (m = fi(), hi(m)), u ? m.delete(h) : m.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Oo), t.registerMutationListener(De, (s, l) => {
    Dl(() => {
      let c = !1;
...
function Gl(t, e, n = ua) {
  return le(t.registerCommand(ki, (o) => {
    const a = Lt();
    if (!ye(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      if (u.canIndent()) {
        const h = u.getKey();
        let m = _i();
        if (m.anchor.set(h, 0, "element"), m.focus.set(h, 0, "element"), m = Ci(m), m.anchor.is(w)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Ei : Kr : Ti;
    return t.dispatchCommand(i, void 0);
  }, So), t.registerCommand(Kr, () => {
...
Gt({ build: (t, e, n) => Rn(e), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => we(() => n.getOutput().disabled.value ? void 0 : fa(t)) });
function Xl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return Cr(() => n.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = r(o, { onError: (h) => n._onError(h), children: r(us, { fallback: null, children: a[w] }) }), u = n.getElementByKey(w);
        u !== null && s.push(zi(p, u, w));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function cw() {
  const [t, e] = R(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(tl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Go, { children: [
...
uw.displayName = Lo.Root.displayName;
const xa = b.createContext({
  size: "default",
  variant: "default"
}), Er = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, i) => {
  const s = ft();
  return /* @__PURE__ */ r(
    En.Root,
    {
...
Er.displayName = En.Root.displayName;
...
function bw(t, e) {
  const n = Oi(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
...
function ya(t, e, n, o = null) {
  ...
  const l = ae(s) ? s.getChildren() : [], c = Di(t, s.getType());
  let w;
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], x = ya(t, g, h, o);
    !a && ae(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Mi(p) || Gr(p)) && p.append(h), n.append(p), u) {
      const m = u.call(s, p);
...
function ka(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const m = (l == null || !Ii(l)) && (l != null && hn(l) || o);
  for (let g = 0; g < u.length; g++) h.push(...ka(u[g], e, n, m, new Map(a), l));
  return p != null && (h = p(h)), qr(t) && (h = xw(t, h, m ? () => {
    const g = new Po();
    return n.push(g), g;
  } : Cn)), l == null ? h.length > 0 ? s = s.concat(h) : qr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Ur(g.nextSibling) && Ur(g.previousSibling);
  }(t) && (s = s.concat($o())) : ae(l) && l.append(...h), s;
}
function xw(t, e, n) {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Rr(y) && (y.preventDefault(), y.stopPropagation(), It(a) && h());
        },
        onKeyDown: (y) => {
          Tr(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          vn,
          {
...
Oe.displayName = jo.Root.displayName;
...
Ra.displayName = je.Root.displayName;
...
Sa.displayName = je.Fallback.displayName;
const Sr = kn(void 0);
function zt() {
  const t = mr(Sr);
  if (!t)
...
}), Fe = ot.Trigger, Da = ot.Group, Ow = ot.Portal, Iw = ot.Sub, Aw = ot.RadioGroup;
function _e({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Sr.Provider, { value: n, children: /* @__PURE__ */ r(ot.Root, { ...e }) });
}
...
Ia.displayName = ot.RadioItem.displayName;
...
function ao({
  ...
  const m = K(
    ...
    [t.user]
  ), N = F(() => Ws(t.contents), [t.contents]), _ = F(() => {
    if (o && l)
      return /* @__PURE__ */ d(ct, { children: [
        /* @__PURE__ */ d(
          yn,
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ra, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Sa, { className: "tw-text-xs tw-font-medium", children: y }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), m()) : Rr(k) && (k.preventDefault(), k.stopPropagation(), It(p) && g());
              },
              onKeyDown: (k) => {
                Tr(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
        ...
        _ && /* @__PURE__ */ d(_e, { children: [
          /* @__PURE__ */ r(Fe, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ho, {}) }) }),
...
function $w({
  ...
  const yt = F(() => pt[0], [pt]), Ot = Y(null), ht = Y(void 0), gt = K(() => {
    var O;
    (O = ht.current) == null || O.call(ht), $(so);
  }, []), Yt = K(() => {
    const O = !P;
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              B,
              {
                ...
                children: P ? /* @__PURE__ */ r(xs, {}) : /* @__PURE__ */ r(ys, {})
              }
            ),
          ...
          o && /* @__PURE__ */ d(ct, { children: [
            ...
            v !== !1 && (!A || It(T)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (O) => {
                  Rr(O) && (O.preventDefault(), O.stopPropagation(), (It(T) || C !== void 0) && Ar());
                },
                onKeyDown: (O) => {
                  Tr(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    vn,
...
function Lw({ table: t }) {
  return /* @__PURE__ */ d(_e, { children: [
    /* @__PURE__ */ r(Bi, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
Aa.displayName = lt.ScrollUpButton.displayName;
...
function Xw({
  ...
  var L;
  const [p, u] = R([]), [h, m] = R([]), [g, x] = R({}), [v, y] = R({}), N = F(() => e ?? [], [e]), _ = zo({
    data: N,
    columns: t,
    getCoreRowModel: Bo(),
    ...n && { getPaginationRowModel: Gi() },
    onSortingChange: u,
...
function fp({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Hi, { options: i, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(bo, {}) })
        ] }),
...
function bp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(_e, { children: [
    ...
    /* @__PURE__ */ r(pe, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Da, { children: w.itemType === 0 ? /* @__PURE__ */ r(ct, { children: w.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Jt,
        {
          checked: o[p][h],
        ...
        Aw,
        {
          ...
          children: w.items.map((u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Ia, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ r(Be, {})
    ] }, w.label)) })
        ...
        /* @__PURE__ */ r(Qt, { children: z.map((S) => /* @__PURE__ */ d(
          qt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ r(Ms, { className: "tw-h-4 tw-w-4" }),
...
function sc({
  ...
  return /* @__PURE__ */ d(_e, { children: [
    /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Pi, { asChild: !0, children: /* @__PURE__ */ r(Fe, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: oc(t, n) }) }) }),
...
function lc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Os, { className: e, size: 16 });
}
...
const Mr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tr.Root,
  {
    ref: n,
    className: f(
...
const vc = (t) => {
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ d(Er, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        Je,
        {
          onClick: (c) => {
...
const _c = "16rem", Cc = "3rem", La = b.createContext(void 0);
function In() {
...
const Va = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(La.Provider, { value: N, children: /* @__PURE__ */ r(Rt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ec = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    B,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Vs, {}) : /* @__PURE__ */ r(js, {}),
...
pr.displayName = "SidebarGroupContent";
    ...
    ja,
    {
      ...
      children: /* @__PURE__ */ d(Fa, { children: [
        /* @__PURE__ */ d(cr, { children: [
          ...
          /* @__PURE__ */ r(pr, { children: /* @__PURE__ */ r(Ba, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Ka, { children: /* @__PURE__ */ r(
            Ga,
            {
              onClick: () => w(h),
              isActive: u(h),
        ...
        /* @__PURE__ */ d(cr, { children: [
          /* @__PURE__ */ r(dr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(pr, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            or,
            {
              buttonVariant: "ghost",
...
const oe = "scrBook", Fc = "scrRef", he = "source", Bc = "details", Kc = "Scripture Reference", Gc = "Scripture Book", qa = "Type", qc = "Details";
function Uc(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, wo = (t) => `${Hc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ap({
  sources: t,
  ...
  q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const V = x.find((j) => wo(j) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [m, x, l, y]);
  const N = a ?? Gc, _ = i ?? qa, k = [
...
function Yc({
  ...
  const i = Ir(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    B,
    {
      variant: "outline",
...
function Xc({
  ...
  const L = F(() => wt.allBookIds.filter(
    ...
    (A) => {
      const H = Ir(L, A).map((M) => M);
      n(
        Ua(L, A, e) ? e.filter((M) => !H.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, n, L]
  ), j = () => {
                  ...
                  Object.values(U).map((A, H) => {
                    ...
                    if (M.length !== 0)
                      return /* @__PURE__ */ d(po, { children: [
                        ...
                        H < Object.values(U).length - 1 && /* @__PURE__ */ r(Ho, {})
                      ] }, A);
                  })
                ] })
              ]
...
const Ya = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Pt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Ow, { children: /* @__PURE__ */ r(Oa, { children: Ya(
      t,
      e,
      Ha(t, l.id),
      o
...
function ur({
  ...
  return /* @__PURE__ */ d(_e, { variant: i, children: [
    /* @__PURE__ */ r(Fe, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Fs, {}) }) }),
    /* @__PURE__ */ r(pe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(po, { children: [
...
function Fp({
  ...
  return /* @__PURE__ */ d(Xa, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    ...
    l && /* @__PURE__ */ r("div", { className: "tw-flex tw-h-full tw-shrink tw-grow-[1] tw-flex-row tw-flex-wrap tw-items-start tw-justify-center tw-gap-x-1 tw-gap-y-2 tw-overflow-clip", children: l }),
...
function Kp({
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Wa, { children: [
      /* @__PURE__ */ r(Ja, { children: t.map((l) => /* @__PURE__ */ r(Wc, { value: l.value, children: l.value }, l.key)) }),
...
const Qa = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  ...
  return /* @__PURE__ */ r(Sr.Provider, { value: a, children: /* @__PURE__ */ r(
    at.Root,
    {
      ref: o,
      className: f(
...
Qa.displayName = at.Root.displayName;
...
ts.displayName = at.Trigger.displayName;
...
es.displayName = at.SubTrigger.displayName;
...
ns.displayName = at.SubContent.displayName;
...
rs.displayName = at.Content.displayName;
...
as.displayName = at.Separator.displayName;
const qe = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([i], s) => {
    ...
    return l.length > 0 && s < a.length - 1 && c.push(/* @__PURE__ */ r(as, {}, `separator-${i}`)), c;
  });
};
function nd({
  menuData: t,
  ...
  if (Wi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    var g, x, v, y;
    p.preventDefault();
    ...
    return /* @__PURE__ */ r(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(Jc, { children: [
      /* @__PURE__ */ r(ts, { ref: w(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        rs,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Rt, { children: ss(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(_e, { children: [
              /* @__PURE__ */ r(Fe, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ho, {}) }) }),
...
const ad = nn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Gs, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
const nu = jt.Trigger, xd = jt.Portal, ru = jt.Close, ls = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  jt.Overlay,
  {
    ref: n,
