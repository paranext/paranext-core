...
var cs = (e, t, n) => t in e ? ds(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var pt = (e, t, n) => cs(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as c, Fragment as at } from "react/jsx-runtime";
import b, { forwardRef as Qe, useRef as rt, useMemo as B, useState as D, useCallback as z, useLayoutEffect as Pt, createContext as vn, useContext as fr, useEffect as q, Component as ps, createElement as Br, Suspense as us, createRef as ms, Fragment as go } from "react";
import { Command as ft } from "cmdk";
import { X as tn, Search as bo, Check as Ot, Clock as zr, ChevronsLeft as jr, ChevronsRight as Gr, ChevronLeft as qn, ChevronRight as Ce, ArrowLeft as hs, ArrowRight as fs, Circle as xn, ChevronDown as pe, BoldIcon as gs, ItalicIcon as bs, UnderlineIcon as vs, StrikethroughIcon as xs, Pencil as ys, Trash2 as Ns, ArrowUp as vo, MoreHorizontal as xo, ChevronUp as Jn, AtSign as ks, FilterIcon as _s, ArrowLeftIcon as Cs, ChevronLeftIcon as Es, ChevronRightIcon as Ss, ArrowRightIcon as Ts, Copy as yo, Filter as Rs, User as Ds, Link as Os, CircleHelp as Is, ChevronsUpDown as No, Star as Ms, FunctionSquare as ko, SquareSigma as _o, SquareX as As, AlertCircle as Wn, CircleCheckIcon as Vs, CircleXIcon as $s, CircleHelpIcon as Ps, ArrowUpIcon as Ls, ArrowDownIcon as Bs, ArrowUpDownIcon as zs, PanelLeft as js, PanelRight as Gs, ScrollText as Fs, MenuIcon as Hs, Menu as Xs, EllipsisVertical as Ks, LoaderCircle as Us, GripVertical as Ys } from "lucide-react";
import { clsx as qs } from "clsx";
import { extendTailwindMerge as Js } from "tailwind-merge";
import * as Ct from "@radix-ui/react-dialog";
import { includes as ln, Section as H, getChaptersForBook as Ws, formatScrRef as Ht, getSectionForBook as Fe, formatRelativeDate as Zs, formatReplacementString as ie, sanitizeHtml as Qs, parseParatextHtml as Fr, hasCustomParatextTags as ti, NumberFormat as ei, formatBytes as ni, getCurrentLocale as ri, getFormatCallerFunction as oi, deepEqual as Co, isString as Vn, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
import { createEditor as So, $getRoot as Yt, $createParagraphNode as yn, $getSelection as Lt, HISTORY_MERGE_TAG as gr, ParagraphNode as To, TextNode as Ro, $isTokenOrSegmented as ai, $getCharacterOffsets as si, $cloneWithPropertiesEphemeral as ii, $findMatchingParent as li, $isElementNode as le, CLEAR_EDITOR_COMMAND as Do, COMMAND_PRIORITY_EDITOR as Oo, $isRangeSelection as qe, shallowMergeConfig as wi, defineExtension as Bt, safeCast as en, RootNode as di, LineBreakNode as ci, TabNode as pi, $isEditorState as ui, createCommand as mi, CLICK_COMMAND as hi, isDOMNode as fi, $getNodeFromDOMNode as gi, $isNodeSelection as bi, $createNodeSelection as vi, $setSelection as xi, COMMAND_PRIORITY_LOW as yi, DecoratorNode as Ni, $create as ki, $getNodeByKey as _i, INDENT_CONTENT_COMMAND as Hr, COMMAND_PRIORITY_CRITICAL as br, KEY_TAB_COMMAND as Ci, $createRangeSelection as Ei, $normalizeSelection__EXPERIMENTAL as Si, OUTDENT_CONTENT_COMMAND as Ti, INSERT_TAB_COMMAND as Ri, $isBlockElementNode as mn, $isDecoratorNode as Di, $isParagraphNode as Oi, $isTextNode as hn, SELECTION_CHANGE_COMMAND as Io, FORMAT_TEXT_COMMAND as Ii, getRegisteredNode as Mi, isHTMLElement as Ai, isDocumentFragment as Xr, isDOMDocumentNode as Vi, ArtificialNode__DO_NOT_USE as Mo, $createLineBreakNode as Ao, $isRootOrShadowRoot as $i, isBlockDomNode as Kr, isInlineDomNode as Ur, $insertNodes as Pi } from "lexical";
import * as nn from "@radix-ui/react-tooltip";
import { TooltipTrigger as Li } from "@radix-ui/react-tooltip";
import { HeadingNode as Bi, QuoteNode as zi, registerRichText as ji } from "@lexical/rich-text";
import { flushSync as Gi, createPortal as Fi } from "react-dom";
...
import { useReactTable as Lo, getFilteredRowModel as Ki, getSortedRowModel as Bo, getPaginationRowModel as Ui, getCoreRowModel as zo, flexRender as He, getGroupedRowModel as Yi, getExpandedRowModel as qi } from "@tanstack/react-table";
import * as st from "@radix-ui/react-select";
import Ji from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Qn, HIDDEN_NOTE_CALLER as tr, getDefaultViewOptions as Wi, isInsertEmbedOpOfType as Pn, Editorial as Zi } from "@eten-tech-foundation/platform-editor";
...
const el = Js({ prefix: "tw-" });
function m(...e) {
  return el(qs(e));
}
const nl = "layoutDirection";
function lt() {
  const e = localStorage.getItem(nl);
  return e === "rtl" ? e : "ltr";
}
const rl = Ct.Root, ol = Ct.Portal, jo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
    className: m(
...
const Go = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = lt();
  return /* @__PURE__ */ c(ol, { children: [
    /* @__PURE__ */ o(jo, {}),
    /* @__PURE__ */ c(
      Ct.Content,
      {
...
Ho.displayName = Ct.Title.displayName;
const al = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Description,
  {
    ref: n,
...
al.displayName = Ct.Description.displayName;
...
var sl = Object.defineProperty, il = (e, t, n) => t in e ? sl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, F = (e, t, n) => il(e, typeof t != "symbol" ? t + "" : t, n);
const ue = [
  "GEN",
  "EXO",
  "LEV",
...
const ht = class X {
    ...
    if (F(this, "firstChapter"), F(this, "lastChapter"), F(this, "lastVerse"), F(this, "hasSegmentsDefined"), F(this, "text"), F(this, "BBBCCCVVVS"), F(this, "longHashCode"), F(this, "versification"), F(this, "rtlMark", "‏"), F(this, "_bookNum", 0), F(this, "_chapterNum", 0), F(this, "_verseNum", 0), F(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        ...
        if (t != null && t instanceof X) {
          ...
          if (t == null) return;
          const s = t instanceof oe ? t : X.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let d;
    return i && (d = new oe(i)), n ? new X(n, r.toString(), l, d) : new X();
  }
  /**
...
const ta = Qe(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Ie : "button", { className: m(vl({ variant: t, size: n, className: e })), ref: s, ...a })
);
P.displayName = "Button";
const be = Ee.Root, ve = Ee.Trigger, gp = Ee.Anchor, te = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = lt();
...
te.displayName = Ee.Content.displayName;
function or(e, t, n) {
  return `${e} ${we[e]}${t ? ` ${kr(e, t)} ${_e(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function xl({
  recentSearches: e,
...
function Wr({
  ...
  if (e)
    return /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Dt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Qt,
      {
        value: `${e} ${we[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function vp({
  ...
  const w = lt(), [p, f] = D(!1), [h, u] = D(""), [g, x] = D(""), [k, C] = D("books"), [_, y] = D(void 0), [E, M] = D(!1), R = rt(void 0), S = rt(void 0), O = rt(void 0), N = rt(void 0), T = rt({}), V = z(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
  ...
  }), [L]), A = B(() => Object.values(G).flat(), [G]), W = B(() => {
    if (!g.trim()) return G;
    const v = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    (v) => {
      ...
      if ((k === "chapters" || k === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const dt = k === "chapters" ? _ : I == null ? void 0 : I.book;
        if (!dt) return;
        const mt = (() => {
          if (!h) return 1;
          const Le = h.match(/(\d+)$/);
        ...
        switch (v.key) {
          case "ArrowLeft":
            mt !== 0 && (Mt = mt > 1 ? mt - 1 : ne);
            break;
          case "ArrowRight":
            mt !== 0 && (Mt = mt < ne ? mt + 1 : 1);
            break;
          case "ArrowUp":
            Mt = mt === 0 ? ne : Math.max(1, mt - Lr);
            break;
          case "ArrowDown":
            Mt = mt === 0 ? 1 : Math.min(ne, mt + Lr);
            break;
          default:
            return;
        }
        Mt !== mt && (v.preventDefault(), v.stopPropagation(), u(or(dt, a, Mt)), setTimeout(() => {
    ...
    const { isLetter: j, isDigit: Z } = Jr(v.key);
    (j || Z) && (v.preventDefault(), x((dt) => dt + v.key), S.current.focus(), M(!1));
  }, []);
  return Pt(() => {
    const v = setTimeout(() => {
      if (p && k === "books" && O.current && N.current) {
        const j = O.current, Z = N.current, dt = Z.offsetTop, mt = j.clientHeight, ne = Z.clientHeight, Mt = dt - mt / 2 + ne / 2;
        j.scrollTo({
          top: Math.max(0, Mt),
          behavior: "smooth"
        }), u(or(e.book));
  ...
  }, [k, _, I, e.book, e.chapterNum]), /* @__PURE__ */ c(be, { open: p, onOpenChange: ct, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
      P,
      {
    ...
    /* @__PURE__ */ o(te, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ c(
      fe,
      {
        ...
        shouldFilter: !1,
        children: [
          k === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: $.map(({ onClick: v, disabled: j, title: Z, icon: dt }) => /* @__PURE__ */ o(
              P,
              {
                variant: "ghost",
                size: "sm",
          ...
          !E && /* @__PURE__ */ c(ge, { ref: O, children: [
            k === "books" && /* @__PURE__ */ c(at, { children: [
              !I && Object.entries(W).map(([v, j]) => {
                if (j.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(qt, { heading: On(v), children: j.map((Z) => /* @__PURE__ */ o(
                      ta,
                      {
                        bookId: Z,
                        onSelect: (dt) => yt(dt),
              ...
              I && /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(
                Qt,
                {
                  value: `${I.book} ${we[I.book]} ${I.chapterNum || ""}:${I.verseNum || ""})}`,
                  onSelect: ot,
              ...
              I && Dt(I.book) > 1 && /* @__PURE__ */ c(at, { children: [
...
), it = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Eo.Root, { ref: n, className: m("pr-twp", _l(), e), ...t }));
it.displayName = Eo.Root.displayName;
...
function ar({
  ...
  const [_, y] = D(!1), E = d ?? l, M = (S) => S.length > 0 && typeof S[0] == "object" && "options" in S[0], R = (S, O) => {
  ...
  return /* @__PURE__ */ c(be, { open: _, onOpenChange: y, ...C, children: [
    ...
    /* @__PURE__ */ o(
      te,
      {
        ...
        children: /* @__PURE__ */ c(fe, { children: [
          ...
          /* @__PURE__ */ o(ge, { children: M(t) ? t.map((S) => /* @__PURE__ */ o(qt, { heading: S.groupHeading, children: S.options.map((O) => R(O, S.groupHeading)) }, S.groupHeading)) : t.map((S) => R(S)) })
        ] })
      }
    )
  ] });
...
var Sl = /* @__PURE__ */ ((e) => (e.CURRENT_BOOK = "current book", e.CHOOSE_BOOKS = "choose books", e))(Sl || {});
...
const kp = [
  ...
  "%no_comments%"
], Tl = ["input", "select", "textarea", "button"], Rl = ["button", "textbox"], Dl = ({
  options: e,
  onFocusChange: t,
  onOptionSelect: n,
  onCharacterPress: r
}) => {
  const a = rt(null), [s, i] = D(void 0), [l, d] = D(void 0), w = z(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || Tl.includes(g)) return !0;
    const x = u.getAttribute("role");
    if (x && Rl.includes(x)) return !0;
    const k = u.getAttribute("tabindex");
    return k !== void 0 && k !== "-1";
  }, h = z(
    (u) => {
      var S;
      const g = u.target, x = (O) => O ? document.getElementById(O) : void 0, k = x(l), C = x(s);
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Il = na ? Pt : q, wn = { tag: gr };
function Ml({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: d } = e, w = Ol(null, r), p = So({ editable: e.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, h) {
      if (h !== null) {
...
const Al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function Vl({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return Al(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      t && s.size === 0 && i.size === 0 || e && d.has(gr) || l.isEmpty() || n(a, r, d);
    });
  }, [r, e, t, n]), null;
}
const Er = {
  ...
  mark: "",
  markOverlap: ""
}, Vt = nn.Provider, Xt = nn.Root, de = nn.Trigger, $t = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  nn.Content,
  {
    ref: r,
    sideOffset: t,
...
$t.displayName = nn.Content.displayName;
const Sr = [
  Bi,
  To,
  Ro,
...
class Pl extends ps {
  ...
  componentDidUpdate(t, n) {
    ...
    if (r && n.error !== null && Ll(t.resetKeys, a)) {
      var s, i;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function jl(e) {
...
function Fl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ai(t) && r !== null) {
    const [a, s] = r, i = e.isBackward(), l = a.getNode(), d = s.getNode(), w = t.is(l), p = t.is(d);
    if (w || p) {
      const [f, h] = si(e), u = l.is(d), g = t.is(i ? d : l), x = t.is(i ? l : d);
      let k, C = 0;
      u ? (C = f > h ? h : f, k = f > h ? f : h) : g ? (C = i ? h : f, k = void 0) : x && (C = 0, k = i ? f : h);
      const _ = t.__text.slice(C, k);
      _ !== t.__text && (n === "clone" && (t = ii(t)), t.__text = _);
    }
  }
  return t;
}
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Xl = ra && "documentMode" in document ? document.documentMode : null;
!(!ra || !("InputEvent" in window) || Xl) && "getTargetRanges" in new window.InputEvent("input");
function oa(...e) {
  const t = [];
...
function Zr(e) {
  const t = li(e, (n) => le(n) && !n.isInline());
  return le(t) || Hl(4, e.__key), t;
}
function Ul(e, t) {
  const n = [];
...
ut.prototype.brand = Yl, ut.prototype.h = function() {
  return !0;
  ...
  if (this.g = pn, this.f |= 1, this.i > 0 && !sa(this)) return this.f &= -2, !0;
  const e = K;
  try {
    eo(this), K = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, la(this), eo(this), Kt++;
  const e = K;
  return K = this, Wl.bind(this, e);
...
function wa() {
  const e = Yt(), t = Lt(), n = yn();
  e.clear(), e.append(n), t !== null && n.select(), qe(t) && (t.format = 0);
}
function da(e, t = wa) {
  return e.registerCommand(Do, (n) => (e.update(t), !0), Oo);
}
Bt({ build: (e, t, n) => Cn(t), config: en({ $onClear: wa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Wt(() => da(e, r.value));
} });
function Zl(e) {
...
const Rr = 0, lr = 1, ua = 2, jn = 3, dn = 4, Ne = 5, Gn = 6, ze = 7;
function Fn(e) {
  return e.id === Rr;
}
function ma(e) {
...
class ew {
  ...
  init(t) {
    ...
    const r = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...r, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, d, w) {
      return Object.assign(l, { config: d, id: jn, registerState: w });
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || tw;
  }
  getPeerNameSet() {
...
const rw = Bt({ config: en({ setOptions: no, updateOptions: no }), init: ({ $initialEditorState: e = nw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
  const a = r.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (ui(s)) e.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [di, Ro, ci, pi, To] }), ro = Symbol.for("@lexical/extension/LexicalBuilder");
function oo() {
}
function ow(e) {
  throw e;
...
class Ke {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(So({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [ro]: this });
  ...
  addExtension(t) {
    ...
    if (a !== void 0 && a.extension !== r && J(298, r.name), !a) {
      a = new ew(this, r), this.extensionNameMap.set(r.name, a);
  ...
  buildCreateEditorArgs() {
    ...
    return t.onError || (t.onError = ow), t;
  }
}
const aw = /* @__PURE__ */ new Set(), ao = Bt({ build(e, t, n) {
  ...
  return { watchNodeKey: function(i) {
    const l = Jl(() => (s.value || aw).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
Bt({ dependencies: [ir, ao], name: "@lexical/extension/HorizontalRule", nodes: [Se], register(e, t, n) {
  ...
  return Jt(e.registerCommand(hi, (i) => {
    if (fi(i.target)) {
      const l = gi(i.target);
      if (iw(l)) return function(d, w = !1) {
        const p = Lt(), f = d.isSelected(), h = d.getKey();
        let u;
        w && bi(p) ? u = p : (u = vi(), xi(u)), f ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, yi), e.registerMutationListener(Se, (i, l) => {
    ql(() => {
      let d = !1;
      ...
      for (const [p, f] of i.entries()) if (f === "destroyed") w.delete(p), d = !0;
        ...
        h ? h.domNode.value = u : (d = !0, w.set(p, { domNode: Je(u), selectedSignal: r(p) }));
      }
    ...
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(Wt(() => {
      const w = l.value;
      w && (d.value ? aa(w, s) : Kl(w, s));
    }));
    return Jt(...i);
  }));
} });
function lw(e, t) {
  return Jt(e.registerCommand(Ci, (n) => {
    const r = Lt();
    if (!qe(r)) return !1;
    n.preventDefault();
    const a = function(s) {
      const i = s.getNodes();
      if (Ul(i, (h) => mn(h) && h.canIndent() ? h : null).length > 0) return !0;
      const l = s.anchor, d = s.focus, w = d.isBefore(l) ? d : l, p = w.getNode(), f = Zr(p);
      if (f.canIndent()) {
        const h = f.getKey();
        let u = Ei();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Si(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(r) ? n.shiftKey ? Ti : Hr : Ri;
...
Bt({ build: (e, t, n) => Cn(t), config: en({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  ...
  return Wt(() => {
    if (!r.value) return lw(e, a);
  });
} });
const ww = Bt({ name: "@lexical/react/ReactProvider" });
function dw() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            e.update(() => {
              ...
              if (qe(g)) {
                const x = g.anchor;
                let k = x.getNode(), C = 0, _ = 0;
                if (hn(k) && w >= 0 && p >= 0 && (C = w, _ = w + p, g.setTextNodeRange(k, C, k, _)), C === _ && f === "" || (g.insertRawText(f), k = x.getNode()), hn(k)) {
                  C = h, _ = h + u;
                  const y = k.getTextContentSize();
                  C = C > y ? y : C, _ = _ > y ? y : _, g.setTextNodeRange(k, C, k, _);
                }
...
Bt({ build: (e, t, n) => Cn(t), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Wt(() => n.getOutput().disabled.value ? void 0 : ga(e)) });
function uw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
  ...
  return function(n, r) {
    ...
    return Dr(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], p = o(r, { onError: (h) => n._onError(h), children: o(us, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
...
function hw({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    ...
    if (r && r.hasExtensionByName(ww.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) r.hasExtensionByName(a) && uw(320, a);
      return !0;
    }
    return !1;
  }(e) ? null : o(mw, { editor: e, ErrorBoundary: t });
}
function so(e) {
  return e.getEditorState().read(fa(e.isComposing()));
}
function fw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [r] = It();
  return function(a) {
    Dr(() => Jt(ji(a), ga(a)), [a]);
  }(r), c(at, { children: [e, o(gw, { content: t }), o(hw, { editor: r, ErrorBoundary: n })] });
}
function gw({ content: e }) {
...
function bw({ defaultSelection: e }) {
  const [t] = It();
  return q(() => {
    t.focus(() => {
...
const vw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function xw({ onClear: e }) {
  const [t] = It();
  return vw(() => da(t, e), [t, e]), null;
}
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function yw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: k = "textbox", spellCheck: C = !0, style: _, tabIndex: y, "data-testid": E, ...M }, R) {
  const [S, O] = D(e.isEditable()), N = z((V) => {
    V && V.ownerDocument && V.ownerDocument.defaultView ? e.setRootElement(V) : e.setRootElement(null);
  }, [e]), T = B(() => /* @__PURE__ */ function(...V) {
    return (L) => {
      for (const G of V) typeof G == "function" ? G(L) : G != null && (G.current = L);
    };
  }(R, N), [N, R]);
  return ba(() => (O(e.isEditable()), e.registerEditableListener((V) => {
    O(V);
  })), [e]), o("div", { "aria-activedescendant": S ? t : void 0, "aria-autocomplete": S ? n : "none", "aria-controls": S ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": S && k === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": S ? f : void 0, "aria-readonly": !S || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: S, "data-testid": E, id: x, ref: T, role: k, spellCheck: C, style: _, tabIndex: y, ...M });
}
const Nw = Qe(yw);
function io(e) {
  return e.getEditorState().read(fa(e.isComposing()));
...
function _w(e, t) {
  ...
  return c(at, { children: [o(Nw, { editor: a, ...r, ref: t }), n != null && o(Cw, { editor: a, content: n })] });
}
function Cw({ content: e, editor: t }) {
  const n = function(i) {
    const [l, d] = D(() => io(i));
    return ba(() => {
      function w() {
...
function Tw() {
  const [e, t] = D(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(rl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Go, { children: [
      /* @__PURE__ */ o(Fo, { children: /* @__PURE__ */ o(Ho, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Rw({
  ...
  const [t] = It(), [n, r] = D(t), [a, s] = D("paragraph"), [i, l] = Tw(), d = () => {
  };
...
Ow.displayName = Vo.Root.displayName;
...
function Aw({
  ...
  return /* @__PURE__ */ c("div", { className: "tw-relative", children: [
    /* @__PURE__ */ o(Rw, { children: () => /* @__PURE__ */ o("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ o(Iw, {}) }) }),
      ...
      /* @__PURE__ */ o(
        fw,
        {
          contentEditable: /* @__PURE__ */ o("div", { ref: (s) => {
            s !== void 0 && r(s);
          }, children: /* @__PURE__ */ o(Ew, { placeholder: e }) }),
          ErrorBoundary: Bl
        }
      ),
      t && /* @__PURE__ */ o(bw, { defaultSelection: "rootEnd" }),
...
function wr({
  ...
  return /* @__PURE__ */ o("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ o(
    Ml,
    {
      ...
      children: /* @__PURE__ */ c(Vt, { children: [
        /* @__PURE__ */ o(Aw, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ o(
          Vl,
          {
...
function $w(e, t) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Mo && i.insertAfter(Ao());
    for (const i of s) {
...
function ka(e, t, n, r = null) {
  ...
  let i = t;
  r !== null && hn(t) && (i = Fl(r, t, "clone"));
  const l = le(i) ? i.getChildren() : [], d = Mi(e, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = ka(e, g, h, r);
    !a && le(t) && x && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ai(p) || Xr(p)) && p.append(h), n.append(p), f) {
      const u = f.call(i, p);
...
function Ca(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const d = function(g, x) {
    const { nodeName: k } = g, C = x._htmlConversions.get(k.toLowerCase());
    let _ = null;
  ...
  let h = [];
  const u = (l == null || !$i(l)) && (l != null && mn(l) || r);
  for (let g = 0; g < f.length; g++) h.push(...Ca(f[g], t, n, u, new Map(a), l));
  return p != null && (h = p(h)), Kr(e) && (h = Lw(e, h, u ? () => {
    const g = new Mo();
    return n.push(g), g;
  ...
  }(e) && (i = i.concat(Ao())) : le(l) && l.append(...h), i;
}
function Lw(e, t, n) {
...
function zw(e) {
  ...
  if (n.update(
    () => {
      const s = new DOMParser().parseFromString(t, "text/html"), i = $w(n, s);
      Yt().clear(), Pi(i);
    },
    {
      discrete: !0
...
const jw = Zt(
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: m("pr-twp", jw({ variant: t }), e), ...n })
);
...
const Hw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
Ta.displayName = Me.Root.displayName;
...
Kw.displayName = Me.Image.displayName;
...
Ra.displayName = Me.Fallback.displayName;
const Mr = vn(void 0);
function St() {
  const e = fr(Mr);
  if (!e)
...
}), Ve = tt.Trigger, Da = tt.Group, Uw = tt.Portal, Yw = tt.Sub, qw = tt.RadioGroup;
...
Oa.displayName = tt.SubTrigger.displayName;
...
Ia.displayName = tt.SubContent.displayName;
...
const Ma = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = St();
  return /* @__PURE__ */ c(
    tt.RadioItem,
    {
...
Ma.displayName = tt.RadioItem.displayName;
...
Jw.displayName = "DropdownMenuShortcut";
function un(e, t) {
...
function wo({
  ...
  const [f, h] = D(!1), [u, g] = D(), [x, k] = D(!1), C = rt(null);
  q(() => {
    let N = !0;
    if (!r) {
      k(!1);
  ...
  const _ = z(() => {
    ...
    return ie(n["%comment_dateAtTime%"], {
      date: T,
      time: V
    });
    ...
    if (r && x)
      return /* @__PURE__ */ c(at, { children: [
        !ti(e.contents) && /* @__PURE__ */ c(
          gn,
          {
            onClick: () => {
              h(!0), g(zw(Fr(e.contents))), d == null || d(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: C,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), _()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), Gt(u) && y());
              },
              onKeyDown: (N) => {
        ...
        O && /* @__PURE__ */ c(xe, { children: [
          /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o(P, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(xo, {}) }) }),
          /* @__PURE__ */ o(ee, { align: "end", children: O })
        ] })
      ]
    }
  );
...
function Ww({
  ...
  const [C, _] = D(co), [y, E] = D(!1), [M, R] = D(!1), [S, O] = D(!1), [N, T] = D(!1), [V, L] = D(!1), [G, A] = D(void 0), [W, I] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      I(!1), yt(!1);
  ...
  const _t = B(() => e.filter((v) => !v.deleted), [e]), bt = B(() => _t[0], [_t]), $ = rt(null), Q = rt(void 0), ct = z(() => {
    var v;
  ...
  const wt = B(
  ...
  }, [a, t]), jt = B(() => _t.slice(1), [_t]), vt = B(() => jt.length ?? 0, [jt.length]), On = B(() => vt > 0, [vt]), In = B(() => S || vt <= 2 ? jt : jt.slice(-2), [jt, vt, S]), ye = B(() => S || vt <= 2 ? 0 : vt - 2, [vt, S]), an = B(
    () => vt === 1 ? wt.singleReply : ie(wt.multipleReplies, { count: vt }),
    [vt, wt]
  ), Mn = B(
    () => ye === 1 ? wt.singleReply : ie(wt.multipleReplies, { count: ye }),
    [ye, wt]
  ), sn = z(async () => {
    const v = Gt(C) ? dr(C) : void 0;
    if (G !== void 0) {
      await w({
        threadId: l,
        contents: v,
    ...
    v && await w({ threadId: l, contents: v }) && ct();
  }, [ct, C, w, G, l]), An = z(
    async (v) => {
      const j = Gt(C) ? dr(C) : void 0, Z = await w({
        ...v,
        contents: j,
        assignedUser: G ?? v.assignedUser
      });
      return Z && j && ct(), Z && G !== void 0 && A(void 0), Z;
    },
    [ct, C, w, G]
  );
  return /* @__PURE__ */ o(
    Ir,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(Sa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            M && /* @__PURE__ */ o(
              P,
              {
                ...
                children: y ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(pe, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
          ...
          n && /* @__PURE__ */ c(at, { children: [
            ...
            u !== !1 && (!N || Gt(C)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (v) => {
                  v.key === "Enter" && v.shiftKey && (v.preventDefault(), v.stopPropagation(), (Gt(C) || G !== void 0) && sn());
                },
                onKeyDown: (v) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    G !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ie(
                    ...
                    /* @__PURE__ */ c(be, { open: V, onOpenChange: L, children: [
                      /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
                        P,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ o(
                        te,
                        {
                          ...
                          children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: h == null ? void 0 : h.map((v) => /* @__PURE__ */ o(
                            Qt,
                            {
                              onSelect: () => {
                                A(v !== a ? v : void 0), L(!1);
...
function _p({
  ...
  const [h, u] = D(), g = t.filter(
    ...
    u(R);
  }, []), { listboxRef: _, activeId: y, handleKeyDown: E } = Dl({
    options: x,
    onOptionSelect: k
  }), M = z(
    (R) => {
...
function Zw({ table: e }) {
  return /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o(Xi, { asChild: !0, children: /* @__PURE__ */ c(P, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const De = st.Root, Qw = st.Group, Oe = st.Value, td = Zt(
  ...
  return /* @__PURE__ */ c(
    st.Trigger,
    {
      className: m(td({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
...
ed.displayName = st.Label.displayName;
const kt = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  st.Item,
  {
    ref: r,
    className: m(
...
function We(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && od(r)
  );
}
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), ld(u, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), id(l, x, p.key);
...
function dd({
  ...
  var R;
  const [p, f] = D([]), [h, u] = D([]), [g, x] = D({}), [k, C] = D({}), _ = B(() => t ?? [], [t]), y = Lo({
    data: _,
    columns: e,
    getCoreRowModel: zo(),
    ...n && { getPaginationRowModel: Ui() },
    onSortingChange: f,
    getSortedRowModel: Bo(),
    onColumnFiltersChange: u,
    getFilteredRowModel: Ki(),
  ...
  let M;
  return d ? M = Array.from({ length: 10 }).map((N, T) => `skeleton-row-${T}`).map((N) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(ce, { colSpan: E.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(cr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, N)) : ((R = y.getRowModel().rows) == null ? void 0 : R.length) > 0 ? M = y.getRowModel().rows.map((S) => /* @__PURE__ */ o(
    At,
    {
      onClick: () => i(S, y),
    ...
    S.id
  )) : M = /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(ce, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Zw, { table: y }),
    /* @__PURE__ */ c(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: y.getHeaderGroups().map((S) => /* @__PURE__ */ o(At, { children: S.headers.map((O) => /* @__PURE__ */ o(Ze, { children: O.isPlaceholder ? void 0 : He(O.column.columnDef.header, O.getContext()) }, O.id)) }, S.id)) }),
...
function Cp({
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: /* @__PURE__ */ o(Ji, { options: s, children: t })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(P, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(yo, {}) })
        ] }),
...
function Sp({
  ...
  return /* @__PURE__ */ c(be, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ c(te, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
var ud = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(ud || {});
function Tp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ c(P, { variant: "default", children: [
    ...
    /* @__PURE__ */ o(ee, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ o(Da, { children: w.itemType === 0 ? /* @__PURE__ */ o(at, { children: w.items.map((f, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Ut,
        {
          checked: r[p][h],
        ...
        qw,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Ma, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ o($e, {})
    ] }, w.label)) })
...
function md({ id: e, versionHistory: t }) {
...
function Dp({
  ...
  const i = B(() => ni(n), [n]), d = ((w) => {
    const p = new Intl.DisplayNames(ri(), { type: "language" });
  ...
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ o(md, { versionHistory: a }),
...
function hd({
  ...
  const [C, _] = D(!1), y = z(
    (T) => {
      var L;
      const V = (L = e.find((G) => G.label === T)) == null ? void 0 : L.value;
      V && n(
    ...
    if (!h) return e;
    const T = e.filter((L) => L.starred).sort((L, G) => L.label.localeCompare(G.label)), V = e.filter((L) => !L.starred).sort((L, G) => {
      const A = t.includes(L.value), W = t.includes(G.value);
      return A && !W ? -1 : !A && W ? 1 : L.label.localeCompare(G.label);
    });
    return [...T, ...V];
  }, [e, t, h]), R = () => {
    n(e.map((T) => T.value));
  ...
  return /* @__PURE__ */ o("div", { id: k, className: g, children: /* @__PURE__ */ c(be, { open: O, onOpenChange: p ?? _, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ c(
      P,
      {
        variant: x,
        ...
        children: [
          ...
          /* @__PURE__ */ o(No, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(te, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(fe, { children: [
      ...
      a && /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ o(P, { variant: "ghost", size: "sm", onClick: R, children: s }),
        /* @__PURE__ */ o(P, { variant: "ghost", size: "sm", onClick: S, children: i })
      ] }),
      /* @__PURE__ */ c(ge, { children: [
        /* @__PURE__ */ o(kn, { children: l }),
        /* @__PURE__ */ o(qt, { children: M.map((T) => /* @__PURE__ */ c(
          Qt,
          {
            value: T.label,
            onSelect: y,
...
const fd = (e, t, n) => e === "generated" ? /* @__PURE__ */ c(at, { children: [
...
function gd({
  ...
  return q(() => {
    ...
    /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ c(Xt, { children: [
      /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o(P, { variant: "outline", className: "tw-h-6", children: fd(e, a, n) }) }) }),
...
const bd = (e, t) => e === "f" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ o(ko, {}),
  " ",
...
function xd({
  ...
  return /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ c(Xt, { children: [
      /* @__PURE__ */ o(Li, { asChild: !0, children: /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o(
        P,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ o($t, { children: /* @__PURE__ */ o("p", { children: vd(e, n) }) })
    ] }) }),
...
function Ip({
  ...
  const l = rt(null), d = ms(), [w, p] = D("generated"), [f, h] = D("*"), [u, g] = D("f"), x = B(
    () => ({
      ...s,
      markerMenuTrigger: s.markerMenuTrigger ?? "\\",
      hasExternalUI: !0,
      view: { ...s.view ?? Wi(), noteMode: "expanded" }
    }),
    [s]
  );
  q(() => {
    ...
    if (E && Pn("note", E)) {
      ...
      let O = "custom";
      S === Qn ? O = "generated" : S === tr ? O = "hidden" : S && h(S), p(O), g(((R = E.insert.note) == null ? void 0 : R.style) ?? "f"), E.insert.note && (E.insert.note.caller = ""), y = setTimeout(() => {
        var N;
  ...
  const k = z(() => {
    ...
    y && Pn("note", y) && (y.insert.note && (w === "custom" ? y.insert.note.caller = f : y.insert.note.caller = w === "generated" ? Qn : tr), t([y]));
  }, [w, f, t]), C = () => {
    var E;
    const y = (E = d.current) == null ? void 0 : E.getElementsByClassName("editor-input")[0];
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ o(
          xd,
          {
            ...
            handleNoteTypeChange: (y) => {
              ...
              E && Pn("note", E) && (E.insert.note && (E.insert.note.style = y), (S = l.current) == null || S.applyUpdate([{ delete: 1 }, E]));
            },
            localizedStrings: i
          }
        ),
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ c(Xt, { children: [
          /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(P, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(tn, {}) }) }),
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ o(Zi, { options: x, onScrRefChange: () => {
          }, scrRef: r, ref: l }),
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ c(Xt, { children: [
            /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(P, { onClick: C, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(yo, {}) }) }),
...
function kd({
  ...
  const d = r ? /* @__PURE__ */ o("span", { className: "marker", children: `\\${e.marker} ` }) : void 0, w = r ? /* @__PURE__ */ o("span", { className: "marker", children: ` \\${e.marker}*` }) : void 0, p = /* @__PURE__ */ c(at, { children: [
    ...
    /* @__PURE__ */ c("span", { className: m("note-caller", { formatted: s }), children: [
      a,
      " "
    ] }),
  ...
  return /* @__PURE__ */ c(at, { children: [
    /* @__PURE__ */ c("div", { className: m("textual-note-header tw-text-nowrap tw-pr-2", u), children: [
      d,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: m("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ o(at, { children: yd(e.marker, l, r, w) }) })
  ] });
}
const Ap = ["%webView_footnoteList_header%"], _d = (e, t) => e[t] ?? t;
function Vp({
  className: e,
  classNameForItems: t,
  footnotes: n,
  ...
  const f = p ? _d(p, "%webView_footnoteList_header%") : "Footnotes", h = d ?? oi(n, void 0), u = (y, E) => {
    w == null || w(y, E, a);
  }, g = s ? n.findIndex((y) => y === s) : 0, [x, k] = D(g), C = (y) => {
    if (n.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), k((E) => Math.min(E + 1, n.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), k((E) => Math.max(E - 1, 0));
          break;
        case "Enter":
        case " ":
          y.preventDefault(), w == null || w(n[x], x, a);
          break;
      }
  }, _ = rt([]);
  return q(() => {
    var y;
    x >= 0 && x < _.current.length && ((y = _.current[x]) == null || y.focus());
...
function Ed({
  ...
  return /* @__PURE__ */ c(En, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Sn, { stickyHeader: !0, children: /* @__PURE__ */ c(At, { children: [
    ...
    /* @__PURE__ */ o(Tn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      At,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ce, { children: Cd(i.text) })
        ]
      },
...
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(zs, { className: "tw-ms-2 tw-h-4 tw-w-4" }), $p = (e) => ({
  accessorKey: "item",
  accessorFn: (t) => t.items[0],
  header: ({ column: t }) => /* @__PURE__ */ c(P, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Rn(t.getIsSorted())
  ] })
}), Sd = (e, t) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ c(P, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    e,
    Rn(n.getIsSorted())
  ] })
}), Pp = (e) => ({
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ c(P, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Rn(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ c(P, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    e,
    Rn(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ c(Or, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ o(
        Ue,
        {
          onClick: (d) => {
            d.stopPropagation(), Xn(
              [l],
              "approved",
              t,
              n,
  ...
  return t ? t[1] : "";
}, Td = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Gp = Object.freeze([
...
function Fp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), h = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), x = Tt(n, "%webView_inventory_scope_currentBook%"), k = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), y = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), E = Tt(n, "%webView_inventory_no_results%"), [M, R] = D(!1), [S, O] = D("all"), [N, T] = D(""), [V, L] = D([]), G = B(() => {
    const $ = e ?? [];
    return $.length === 0 ? [] : Dd($, a, s);
  }, [e, a, s]), A = B(() => {
    if (M) return G;
    const $ = [];
    return G.forEach((Q) => {
      const ct = Q.items[0], wt = $.find(
        (Nt) => Nt.items[0] === ct
      );
      wt ? (wt.count += Q.count, wt.occurrences = wt.occurrences.concat(Q.occurrences)) : $.push({
        items: [ct],
        count: Q.count,
  ...
  }, [M, G]), W = B(() => A.length === 0 ? [] : Rd(A, S, N), [A, S, N]), I = B(() => {
    var ct, wt;
    if (!M) return d;
    const $ = (ct = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ct.length;
    if (!$) return d;
    const Q = [];
    for (let Nt = 0; Nt < $; Nt++)
      Q.push(
    ...
    return [...Q, ...d];
  }, [r == null ? void 0 : r.tableHeaders, d, M]);
  q(() => {
  ...
  return /* @__PURE__ */ c("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ c(De, { onValueChange: ($) => yt($), defaultValue: i, children: [
...
const Od = "16rem", Id = "3rem", Pa = b.createContext(void 0);
function Dn() {
...
const La = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), f = t ?? w, h = b.useCallback(
      ...
      [n, f]
    ), u = b.useCallback(() => h((y) => !y), [h]), g = f ? "expanded" : "collapsed", C = lt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", _ = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
...
const Md = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Dn();
  return /* @__PURE__ */ c(
    P,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ o(js, {}) : /* @__PURE__ */ o(Gs, {}),
...
Ld.displayName = "SidebarSeparator";
...
const Bd = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: r,
...
const zd = Zt(
  ...
  ({
    ...
    const d = e ? Ie : "button", { state: w } = Dn(), p = /* @__PURE__ */ o(
      d,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": t,
        className: m(zd({ variant: n, size: r }), s),
        ...i
      }
    );
...
const jd = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: a,
...
jd.displayName = "SidebarMenuAction";
...
const Fd = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
const Kd = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? Ie : "a",
  {
    ref: s,
...
function Ud({
  ...
  return /* @__PURE__ */ o(
    Ba,
    {
      ...
      children: /* @__PURE__ */ c(ja, { children: [
        /* @__PURE__ */ c(pr, { children: [
          /* @__PURE__ */ o(ur, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(mr, { children: /* @__PURE__ */ o(Ga, { children: Object.entries(t).map(([h, u]) => /* @__PURE__ */ o(Fa, { children: /* @__PURE__ */ o(
            Ha,
            {
              onClick: () => w(h),
              isActive: f(h),
...
const $r = Qe(
  ({ value: e, onSearch: t, placeholder: n, isFullWidth: r, className: a, isDisabled: s = !1, id: i }, l) => {
    const d = lt();
    return /* @__PURE__ */ c("div", { id: i, className: m("tw-relative", { "tw-w-full": r }, a), children: [
      /* @__PURE__ */ o(
        bo,
        {
          className: m(
...
const Ft = "scrBook", Yd = "scrRef", se = "source", qd = "details", Jd = "Scripture Reference", Wd = "Scripture Book", Xa = "Type", Zd = "Details";
function Qd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: Ft,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Jd,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? Y.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Ft ? Ht(a.start) : void 0;
      },
    ...
    {
      accessorFn: (r) => Ht(r.start),
      id: Yd,
      header: void 0,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? void 0 : Ht(a.start);
      },
      sortingFn: (r, a) => Zn(r.original.start, a.original.start),
      enableGrouping: !1
    },
    ...
    },
    {
      ...
      id: qd,
      header: (e == null ? void 0 : e.detailsColumnName) ?? Zd,
      cell: (r) => r.getValue(),
      enableGrouping: !1
    }
  ];
...
}, mo = (e) => `${tc({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Xp({
  sources: e,
  ...
  const [w, p] = D([]), [f, h] = D([{ id: Ft, desc: !1 }]), [u, g] = D({}), x = B(
  ...
  q(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const V = x.find((L) => mo(L) === T[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, x, l, C]);
  const _ = a ?? Wd, y = s ?? Xa, E = [
  ...
  }, S = (N, T) => N.getIsGrouped() ? "" : m("banded-row", T % 2 === 0 ? "even" : "odd"), O = (N, T, V) => {
    ...
    !t && /* @__PURE__ */ c(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(he, { position: "item-aligned", children: /* @__PURE__ */ o(Qw, { children: E.map((N) => /* @__PURE__ */ o(kt, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ o(At, { children: N.headers.filter((T) => T.column.columnDef.header).map((T) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(Ze, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ o(Tn, { children: C.getRowModel().rows.map((N, T) => {
        const V = lt();
        return /* @__PURE__ */ o(
          At,
          {
            ...
            children: N.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== se || !n)))
                return /* @__PURE__ */ o(
                  ce,
                  {
                    className: m(
...
function ec({
  ...
  const s = Pr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    P,
    {
      variant: "outline",
...
function nc({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], d = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], f = r["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
  ...
  }, [k, C] = D(!1), [_, y] = D(""), E = rt(void 0), M = rt(!1);
  ...
  const R = B(() => Y.allBookIds.filter(
    ...
    (A, W = !1) => {
      if (!W || !E.current) {
        n(
          t.includes(A) ? t.filter(($) => $ !== A) : [...t, A]
        ), E.current = A;
        return;
      }
      const I = R.findIndex(($) => $ === E.current), ot = R.findIndex(($) => $ === A);
      if (I === -1 || ot === -1) return;
      const [yt, _t] = [
        Math.min(I, ot),
        Math.max(I, ot)
      ], bt = R.slice(yt, _t + 1).map(($) => $);
      n(
        t.includes(A) ? t.filter(($) => !bt.includes($)) : [.../* @__PURE__ */ new Set([...t, ...bt])]
      );
    },
    [t, n, R]
  ), N = (A) => {
    ...
    (A) => {
      const W = Pr(R, A).map((I) => I);
      n(
        Ka(R, A, t) ? t.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...t, ...W])]
      );
    },
    [t, n, R]
  ), L = () => {
            ...
            fe,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(P, { variant: "ghost", size: "sm", onClick: L, children: d }),
                ...
                /* @__PURE__ */ c(ge, { children: [
                  ...
                  Object.values(H).map((A, W) => {
                    const I = S[A];
                    if (I.length !== 0)
                      return /* @__PURE__ */ c(go, { children: [
                        /* @__PURE__ */ o(
                          qt,
                          {
                            heading: Zo(A, h, u, g, x),
                        ...
                        W < Object.values(H).length - 1 && /* @__PURE__ */ o(Xo, {})
                      ] }, A);
                  })
                ] })
              ]
...
function Up({
  ...
  const w = re(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = re(i, "%webView_scope_selector_current_book%"), u = re(i, "%webView_scope_selector_choose_books%"), g = re(i, "%webView_scope_selector_scope%"), x = re(i, "%webView_scope_selector_select_books%"), k = [
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: C.map(({ value: _, label: y, id: E }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
...
function Yp({
  ...
  return /* @__PURE__ */ c(
    De,
    {
      ...
      children: [
        /* @__PURE__ */ o(me, { size: a, className: m("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          Oe,
          {
            placeholder: l[U(t)] ?? t
          }
...
const Ya = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  ) : /* @__PURE__ */ c(Yw, { children: [
    /* @__PURE__ */ o(Oa, { children: l.label }),
    /* @__PURE__ */ o(Uw, { children: /* @__PURE__ */ o(Ia, { children: Ya(
      e,
      t,
      Ua(e, l.id),
      r
...
function hr({
  ...
  return /* @__PURE__ */ c(xe, { variant: s, children: [
    /* @__PURE__ */ o(Ve, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(P, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Hs, {}) }) }),
    /* @__PURE__ */ o(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(go, { children: [
      /* @__PURE__ */ o(Da, { children: /* @__PURE__ */ o(Vt, { children: Ya(t.groups, t.items, d, e) }) }),
...
function Zp({
  ...
  return /* @__PURE__ */ c(qa, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ o(
      hr,
      {
        onSelectMenuItem: e,
...
function tu({
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(Ja, { children: [
      /* @__PURE__ */ o(Wa, { children: e.map((l) => /* @__PURE__ */ o(rc, { value: l.value, children: l.value }, l.key)) }),
...
const sc = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = St();
  return /* @__PURE__ */ c(
    et.CheckboxItem,
    {
...
sc.displayName = et.CheckboxItem.displayName;
const ic = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = St();
  return /* @__PURE__ */ c(
    et.RadioItem,
    {
...
ic.displayName = et.RadioItem.displayName;
const lc = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  et.Label,
  {
    ref: r,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
lc.displayName = et.Label.displayName;
...
const je = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ o(as, {}, `separator-${s}`)), d;
  });
};
function wc({
  menuData: e,
  ...
  if (Qi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), je(i, [h, u]);
        break;
      case "alt+n":
        (k = l.current) == null || k.focus(), je(l, [h, u]);
        break;
      case "alt+h":
        (C = d.current) == null || C.focus(), je(d, [h, u]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ o(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(oc, { children: [
...
function ru({
  ...
  const w = dc(
    ...
    var C, _, y, E, M, R;
    const k = x !== g ? ((_ = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : _[x]) ?? ((E = (y = e[g]) == null ? void 0 : y.uiNames) == null ? void 0 : E.en) : void 0;
  ...
  return /* @__PURE__ */ c("div", { id: d, className: m("pr-twp tw-max-w-sm", l), children: [
    ...
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(it, { className: "tw-font-normal tw-text-muted-foreground", children: ie(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, t)).join(", ") : e.en.autonym
    }) }) })
  ] });
}
function cc({ item: e, createLabel: t, createComplexLabel: n }) {
...
function mc({
  ...
  return /* @__PURE__ */ c("div", { className: m("tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none"), children: [
    /* @__PURE__ */ c(
      P,
      {
        variant: "link",
        ...
        children: [
          /* @__PURE__ */ o("span", { className: m({ "tw-me-2": i === "allText" }), children: t ? uc(e, t, s) : pc(e, s) }),
          i === "allText" && fo(n, r)
        ]
      }
    ),
...
function au({
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      onDoubleClick: p,
      onKeyDown: (g) => {
        const x = document.activeElement, k = (x == null ? void 0 : x.closest("button")) || (x == null ? void 0 : x.tagName) === "BUTTON";
        (g.key === "Enter" || g.key === " ") && (k || (g.preventDefault(), n == null || n()));
      },
      role: "button",
      tabIndex: 0,
      "aria-pressed": t,
      ...
      children: [
        /* @__PURE__ */ c("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": t }), children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
                ...
                children: [
                  /* @__PURE__ */ o(
                    mc,
                    {
                      ...
                      onClick: (g) => {
                        g == null || g.stopPropagation(), n(), p == null || p();
                      },
            ...
            t && l && /* @__PURE__ */ o("div", { className: "tw-p-1", children: /* @__PURE__ */ c(xe, { children: [
              /* @__PURE__ */ o(Ve, { className: w, asChild: !0, children: /* @__PURE__ */ o(P, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(xo, {}) }) }),
              /* @__PURE__ */ o(ee, { align: "end", children: l })
            ] }) })
          ] }),
          t && d && /* @__PURE__ */ o("div", { className: "tw-ms-1 tw-w-fit tw-min-w-0 tw-max-w-full tw-overflow-hidden tw-break-words", children: d })
        ] }),
        w && /* @__PURE__ */ o(
          "div",
          {
...
const hc = Qe(({ className: e, ...t }, n) => /* @__PURE__ */ o(Us, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
function su({
  ...
  return /* @__PURE__ */ c("div", { className: m("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": r }), children: [
    /* @__PURE__ */ o(
      it,
      {
        htmlFor: e,
...
), gc = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const vc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
vc.displayName = "AlertDescription";
const iu = nt.Root, lu = nt.Trigger, wu = nt.Group, du = nt.Portal, cu = nt.Sub, pu = nt.RadioGroup, xc = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
xc.displayName = nt.SubTrigger.displayName;
const yc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  nt.SubContent,
  {
    ref: n,
    className: m(
...
yc.displayName = nt.SubContent.displayName;
const Nc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(nt.Portal, { children: /* @__PURE__ */ o(
  nt.Content,
  {
    ref: n,
    className: m(
...
Nc.displayName = nt.Content.displayName;
const kc = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Item,
  {
    ref: r,
    className: m(
...
kc.displayName = nt.Item.displayName;
const _c = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
_c.displayName = nt.CheckboxItem.displayName;
const Cc = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: r,
    className: m(
...
Cc.displayName = nt.RadioItem.displayName;
const Ec = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Label,
  {
    ref: r,
    className: m(
...
Sc.displayName = nt.Separator.displayName;
...
Tc.displayName = "ContextMenuShortcut";
...
Rc.displayName = "Drawer";
const uu = Et.Trigger, Dc = Et.Portal, mu = Et.Close, ws = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
const Oc = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Ac.displayName = Et.Title.displayName;
...
Vc.displayName = Et.Description.displayName;
const $c = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  nr.Root,
  {
    ref: r,
    className: m(
...
$c.displayName = nr.Root.displayName;
function hu({
  className: e,
  ...t
}) {
...
function gu({
  ...
  return /* @__PURE__ */ o(
    vr.PanelResizeHandle,
    {
      ...
      ...n,
      children: e && /* @__PURE__ */ o("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ o(Ys, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function bu({ ...e }) {
...
const Lc = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ o(
    rr.Root,
    {
...
Lc.displayName = rr.Root.displayName;
const vu = gt.Root, Bc = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ o(
    gt.List,
    {
...
Bc.displayName = gt.List.displayName;
const zc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Trigger,
  {
    ref: n,
    className: m(
...
zc.displayName = gt.Trigger.displayName;
const jc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Content,
  {
    ref: n,
    className: m(
...
jc.displayName = gt.Content.displayName;
...
const Hc = (e, t, n = {}) => {
  ...
  r.current = t;
  const a = rt(n);
  a.current = Fc(a.current);
  const [s, i] = D(() => r.current), [l, d] = D(!0);
  return q(() => {
    let w = !0;
    return d(!!e), (async () => {
      if (e) {
...
export {
  ...
  _p as CommentList,
  iu as ContextMenu,
  _c as ContextMenuCheckboxItem,
  Nc as ContextMenuContent,
  wu as ContextMenuGroup,
  kc as ContextMenuItem,
  Ec as ContextMenuLabel,
  du as ContextMenuPortal,
  pu as ContextMenuRadioGroup,
  Cc as ContextMenuRadioItem,
  Sc as ContextMenuSeparator,
  Tc as ContextMenuShortcut,
  cu as ContextMenuSub,
  yc as ContextMenuSubContent,
  ...
  rc as VerticalTabsTrigger,
  jw as badgeVariants,
  vl as buttonVariants,
  m as cn,
