...
import m, { forwardRef as Je, useRef as nt, useMemo as H, useState as O, useCallback as B, useLayoutEffect as Cn, createContext as Yr, useContext as Kr, useEffect as It, Fragment as jn } from "react";
import { Command as it } from "cmdk";
import { X as We, Search as $n, Check as St, Clock as _n, ChevronsLeft as Sn, ChevronsRight as Rn, ChevronLeft as $e, ChevronRight as Gt, ArrowLeft as qr, ArrowRight as Jr, Circle as be, ChevronsUpDown as Ze, FilterIcon as Wr, ChevronDown as ve, ChevronUp as Zr, ArrowLeftIcon as Qr, ChevronLeftIcon as to, ChevronRightIcon as eo, ArrowRightIcon as no, Copy as ro, Filter as oo, User as ao, Link as so, CircleHelp as io, Star as wo, AlertCircle as ze, CircleCheckIcon as lo, CircleXIcon as co, CircleHelpIcon as po, ArrowUpIcon as uo, ArrowDownIcon as mo, ArrowUpDownIcon as ho, PanelLeft as fo, PanelRight as go, ScrollText as bo, MenuIcon as vo, Menu as xo, EllipsisVertical as yo, LoaderCircle as No } from "lucide-react";
import { clsx as ko } from "clsx";
import { extendTailwindMerge as Co } from "tailwind-merge";
import * as vt from "@radix-ui/react-dialog";
import { includes as ue, Section as M, getChaptersForBook as _o, formatScrRef as Bt, getSectionForBook as re, NumberFormat as So, formatBytes as Ro, getCurrentLocale as To, deepEqual as Qe, isString as Ve, compareScrRefs as Be, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as j } from "platform-bible-utils";
...
import { useReactTable as Bn, getFilteredRowModel as Eo, getSortedRowModel as Ln, getPaginationRowModel as Vo, getCoreRowModel as Gn, flexRender as oe, getGroupedRowModel as Mo, getExpandedRowModel as Do } from "@tanstack/react-table";
import * as G from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as Io } from "@radix-ui/react-dropdown-menu";
import * as U from "@radix-ui/react-select";
import Oo from "markdown-to-jsx";
...
import { useHotkeys as Ao } from "react-hotkeys-hook";
...
const $o = "layoutDirection";
function tt() {
  const t = localStorage.getItem($o);
  return t === "rtl" ? t : "ltr";
}
const zo = vt.Portal, Hn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Overlay,
  {
    ref: n,
    className: c(
...
const Bo = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = tt();
...
Bo.displayName = vt.Content.displayName;
const Lo = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Title,
  {
    ref: n,
...
Lo.displayName = vt.Title.displayName;
...
Go.displayName = vt.Description.displayName;
...
var Fo = Object.defineProperty, Xo = (t, e, n) => e in t ? Fo(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, V = (t, e, n) => Xo(t, typeof e != "symbol" ? e + "" : e, n);
const At = [
  "GEN",
  "EXO",
  "LEV",
...
const er = Je(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ut : "button", { className: c(na({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
), Q = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(zn.Root, { ref: n, className: c("pr-twp", ia(), t), ...e }));
...
}), nr = G.Trigger, rr = G.Group, ca = G.Portal, pa = G.Sub, ua = G.RadioGroup;
...
ma.displayName = "DropdownMenuShortcut";
function ha({ table: t }) {
  return /* @__PURE__ */ d(wn, { children: [
    /* @__PURE__ */ r(Io, { asChild: !0, children: /* @__PURE__ */ d(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Ft = U.Root, fa = U.Group, Xt = U.Value, ga = Rt(
...
ba.displayName = U.Label.displayName;
...
va.displayName = U.Separator.displayName;
function xa({ table: t }) {
...
function we(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && ya(o)
  );
}
  ...
  const w = m.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), _a(g, b, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), Ca(w, y, p.key);
...
function Vi({ id: t, markdown: e, className: n, anchorTarget: o }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: c("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Oo, { options: a, children: e }) });
}
...
function Ai({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(Ma, { versionHistory: a }),
...
const Da = Rt(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: c("pr-twp", Da({ variant: e }), t), ...n })
);
...
const $a = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function La(t) {
  let e = "", n = t;
  for (; n >= 0; )
    e = String.fromCharCode(97 + n % 26) + e, n = Math.floor(n / 26) - 1;
  return e;
}
function ji({
  footnotes: t,
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      className: c("tw-flex tw-flex-col tw-gap-1", s),
      children: t.map((u, l) => {
        const p = u === o, f = u.sid ?? u.marker ?? `footnote-${l}`;
        return /* @__PURE__ */ r(
          cr,
          {
            role: "option",
  ...
  return /* @__PURE__ */ d(Ce, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Se, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      _t,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ht, { children: `${$.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
const ur = m.createContext({
  size: "default",
  variant: "default"
}), mr = m.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = tt();
  return /* @__PURE__ */ r(
    xe.Root,
    {
...
mr.displayName = xe.Root.displayName;
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(uo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(mo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ho, { className: "tw-ms-2 tw-h-4 tw-w-4" }), $i = (t) => ({
  accessorKey: "item",
        ...
        Ft,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(jt, { children: [
              ...
              /* @__PURE__ */ r(ut, { value: "approved", children: f }),
              /* @__PURE__ */ r(ut, { value: "unapproved", children: h }),
              /* @__PURE__ */ r(ut, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
...
const un = de.Provider, mn = de.Root, hn = de.Trigger, Te = m.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  de.Content,
  {
    ref: o,
    sideOffset: e,
...
const fr = m.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(hr.Provider, { value: N, children: /* @__PURE__ */ r(un, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ct = "scrBook", cs = "scrRef", Mt = "source", ps = "details", us = "Scripture Reference", ms = "Scripture Book", kr = "Type", hs = "Details";
function fs(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Ct,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? us,
      cell: (o) => {
...
function Yi({
  ...
  const S = Bn({
    ...
    getExpandedRowModel: Do(),
    getGroupedRowModel: Mo(),
    getCoreRowModel: Gn(),
    getSortedRowModel: Ln(),
    getRowId: An,
    autoResetExpanded: !1,
    ...
    !e && /* @__PURE__ */ d(
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(fa, { children: z.map((_) => /* @__PURE__ */ r(ut, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ r(Gt, {}) : /* @__PURE__ */ r($e, {})),
                          " ",
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((l) => /* @__PURE__ */ r(ut, { value: `${l}`, children: w[j(l)] }, `${l}`))
          }
        )
      ]
    }
...
const Sr = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ d(pa, { children: [
    /* @__PURE__ */ r(or, { children: w.label }),
    /* @__PURE__ */ r(ca, { children: /* @__PURE__ */ r(ar, { children: Sr(
      t,
      e,
      _r(t, w.id),
      o
...
function qe({
  ...
  return /* @__PURE__ */ d(wn, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, l]) => typeof u == "boolean" || typeof l == "boolean" ? 0 : u.order - l.order).map(([u], l, p) => /* @__PURE__ */ d(jn, { children: [
      /* @__PURE__ */ r(rr, { children: /* @__PURE__ */ r(un, { children: Sr(e.groups, e.items, u, t) }) }),
...
function Ss({
  ...
  if (Ao(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    var b, y, x, S;
    p.preventDefault();
    ...
    return /* @__PURE__ */ r(Mr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ d(ys, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(un, { children: $r(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
      ...
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((b) => /* @__PURE__ */ r(ut, { value: b, children: g(b, e) }, b))
            }
          )
        ]
      }
...
const ww = X.Root, lw = X.Trigger, dw = X.Group, cw = X.Portal, pw = X.Sub, uw = X.RadioGroup, js = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  X.SubTrigger,
  {
    ref: a,
    className: c(
...
const mw = mt.Trigger, Ys = mt.Portal, hw = mt.Close, Br = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
...
Br.displayName = mt.Overlay.displayName;
...
Ws.displayName = mt.Title.displayName;
...
Zs.displayName = mt.Description.displayName;
