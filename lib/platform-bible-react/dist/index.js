...
import { c as m, g as Ee, a as Yr, C as De, u as Eo, T as Vt, b as Lt, d as jt, e as Ft, A as he, P as je, f as er, B as Z, h as Fe, i as Be, j as Ue, k as ze, l as Ui, m as Ki, n as qi, E as Hi, o as Xa, r as ke, p as Gi, q as vn, s as oa, t as na, L as Et, R as Ja, v as Xr, D as Da, w as Ma, x as Oa, y as Ia, z as bn, F as jr, G as Za, H as xn, I as Qa, J as Ze, K as Nr, M as Ke, N as qe, O as He, S as Cr, Q as sr, U as Wi, V as Sr, W as tr, X as Ae, Z as rr, Y as Pe, _ as cr, $ as to, a0 as eo, a1 as Jr, a2 as ro, a3 as yn, a4 as Yi, a5 as Xi, a6 as Ji, a7 as $a, a8 as kn, a9 as ia, aa as Zi, ab as _n, ac as Qi, ad as ts, ae as es, af as To, ag as rs, ah as as, ai as os, aj as ns, ak as Nn, al as Cn, am as ao, an as is, ao as En, ap as ga, aq as So, ar as fa, as as ss, at as cs, au as ls, av as ds, aw as ws, ax as zr, ay as oo, az as us, aA as ps } from "./resizable-BcQjWEy-.js";
import { aB as Sg, aC as zg, aD as Rg, aE as Dg, aF as Mg, aG as Og, aH as Ig, aI as $g, aJ as Pg, aK as Ag, aL as Vg, aM as Lg, aN as jg, aO as Fg, aP as Bg, aQ as Ug, aR as Kg, aS as qg, aT as Hg, aU as Gg, aV as Wg, aW as Yg, aX as Xg, aY as Jg } from "./resizable-BcQjWEy-.js";
import { jsx as a, jsxs as u, Fragment as dt } from "react/jsx-runtime";
import { Canon as At } from "@sillsdev/scripture";
import { Check as Ve, Clock as zo, ChevronsLeft as Ro, ChevronsRight as Do, ChevronLeft as Pa, ChevronRight as Aa, ArrowLeft as hs, ArrowRight as gs, ChevronDown as wr, BoldIcon as fs, ItalicIcon as ms, X as no, AtSign as Tn, Pencil as vs, Trash2 as bs, ArrowUp as Sn, MoreHorizontal as xs, MailOpen as ys, Mail as ks, ChevronUp as _s, FilterIcon as Ns, ArrowLeftIcon as Cs, ChevronLeftIcon as Es, ChevronRightIcon as Ts, ArrowRightIcon as Ss, Copy as zn, Filter as zs, User as Rs, Link as Ds, CircleHelp as Ms, Undo as Os, Redo as Is, SquareX as Rn, FunctionSquare as Dn, SquareSigma as Mn, Ban as $s, AlertCircle as Va, CircleCheckIcon as Ps, CircleXIcon as As, CircleHelpIcon as Vs, ArrowUpIcon as Ls, ArrowDownIcon as js, ScrollText as Fs, ChevronsUpDown as Bs, MenuIcon as Us, Menu as Ks, EllipsisVertical as qs, MoreVertical as Hs } from "lucide-react";
import { Section as ut, getChaptersForBook as Gs, formatScrRef as Te, getSectionForBook as Fr, formatRelativeDate as Ws, formatReplacementString as Qe, sanitizeHtml as io, NumberFormat as On, formatBytes as Ys, getCurrentLocale as Xs, usfmMarkers as Br, isPlatformError as Js, ABORTED as Zs, getErrorMessage as Qs, getFormatCallerFunction as tc, deepEqual as ec, isString as Mo, compareScrRefs as La, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as rc, getLocalizeKeyForScrollGroupId as Oo, formatReplacementStringToArray as Io, collectUsjMarkers as ac } from "platform-bible-utils";
import Gt, { useRef as H, useMemo as P, createContext as sa, useContext as so, useState as _, useEffect as W, useCallback as j, useImperativeHandle as oc, useLayoutEffect as Jt, Component as nc, createElement as $o, Suspense as ic, forwardRef as In, useId as Po, Fragment as ca } from "react";
...
import { Avatar as uo, Select as Wt, Checkbox as jo, Slot as Dr, Tabs as ge, Menubar as _e, ContextMenu as Bt, Progress as Fo, Slider as $r, Switch as Bo } from "radix-ui";
...
function Cl({
  ...
  W(() => {
    ...
    const O = (J) => !!J && J.scrollWidth > J.clientWidth, B = () => {
      Ka !== "pointer" && (C || O(h.current) || O(l.current)) && S(!0);
    }, I = () => S(!1);
        ...
        children: [
          /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                Y,
                Y && F && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                F
              ]
            }
          ) }),
...
function El({
  ...
  return /* @__PURE__ */ u(je, { open: b, onOpenChange: v, children: [
    ...
    /* @__PURE__ */ a(Fe, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(ze, { heading: i, children: t.map((x) => /* @__PURE__ */ u(
      De,
      {
        onSelect: () => R(x),
...
function xa({
  ...
  const C = ke(), K = _l(), M = A ?? K, [z, q] = _(!1), [Y, F] = _(""), [Q, O] = _(""), [B, I] = _("books"), [E, J] = _(void 0), [et, ft] = _(
    void 0
  ), [at, Dt] = _(void 0), [tt, st] = _(!1), ht = H(null), mt = H(!1), ct = H(void 0), Mt = H(void 0), pt = H(void 0), le = H(void 0), Qt = H({}), Tt = H({}), bt = j(
    (k) => {
      e(k), c && c(k);
    },
    [e, c]
  ...
  }), [kt]), vt = P(() => Object.values(Ot).flat(), [Ot]), St = P(() => {
    if (!Q.trim()) return Ot;
    const k = {
      [ut.OT]: [],
      [ut.NT]: [],
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((nt) => {
      k[nt] = Ot[nt].filter((zt) => Xa(zt, Q, n));
    }), k;
  }, [Ot, Q, n]), D = P(
    () => Dl(Q, vt, n),
    [Q, vt, n]
  ...
  const oe = j(() => {
    ...
    q(k), k && (I("books"), J(void 0), ft(void 0), Dt(void 0), O(""));
  }, []);
  W(() => {
    N && It(!1);
  }, [N, It]);
  ...
  const { otLong: me, ntLong: ae, dcLong: T, extraLong: U } = {
    ...
    () => M >= Ur.TIGHT ? Yr(t.book, n) : Ee(t.book, n),
    [t.book, n, M]
    ...
    () => zl(Q),
    [Q]
  ), Nt = P(() => !d || !D || !D.chapterNum || !_t ? !1 : d(D.book, D.chapterNum) > 0, [d, D, _t]), Ut = j(
    (k) => w ? Ko(k, w) : !1,
    [w]
  ), Yt = j(
    (k) => (X) => w ? Rl(k, X, w) : !1,
    ...
    [w]
  ), Me = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Mr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", _o = j(
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), p && p.includes(k.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), oe());
    },
    [p, D, oe]
  ), ha = j(
    (k) => {
      ...
      if ((B === "chapters" || B === "verses") && (k.key === " " || k.key === "Enter")) {
        ...
        const Kt = (Oe = ct.current) == null ? void 0 : Oe.querySelector(
      ...
      if (B === "verses" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), re();
        return;
      }
      ...
      if (B === "verses" && zt) {
        ...
        switch (k.key) {
          case "ArrowLeft":
            xt !== 0 && (ie = xt > 1 ? xt - 1 : Kt);
            break;
          case "ArrowRight":
            xt !== 0 && (ie = xt < Kt ? xt + 1 : 1);
            break;
          case "ArrowUp":
            ie = xt === 0 ? Kt : Math.max(1, xt - ue);
            break;
          case "ArrowDown":
            ie = xt === 0 ? 1 : Math.min(Kt, xt + ue);
            break;
          default:
            return;
        }
        ie !== xt && (k.preventDefault(), k.stopPropagation(), F(
          `${Rt} ${he[Rt] || ""} ${Ct}:${ie}`
        ), setTimeout(() => {
          const Ie = Tt.current[ie];
      ...
      if ((B === "chapters" || B === "books" && D) && zt) {
        ...
        switch (k.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            xt = Ct === 0 ? Kt : Math.max(1, Ct - ie);
            break;
          case "ArrowDown":
            xt = Ct === 0 ? 1 : Math.min(Kt, Ct + ie);
            break;
          default:
            return;
        }
    ...
    const { isLetter: X, isDigit: nt } = qo(k.key);
    (X || nt) && (k.preventDefault(), O((Oe) => Oe + k.key), Mt.current.focus(), st(!1));
  }, []);
  return Jt(() => {
    const k = setTimeout(() => {
      if (z && B === "books" && pt.current && le.current) {
        const X = pt.current, nt = le.current, zt = nt.offsetTop, Oe = X.clientHeight, Ce = nt.clientHeight, or = zt - Oe / 2 + Ce / 2;
        X.scrollTo({
          top: Math.max(0, or),
          behavior: "smooth"
        }), F(Qn(t.book));
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(je, { open: z, onOpenChange: It, modal: R, children: [
          ...
          Be,
          {
            ...
            children: [
              B === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                B === "verses" && et && at !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ee(et, n)} ${at}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: B === "verses" ? Mr : Me
                  }
                )
              ] }),
                  ...
                  !D && Object.entries(St).map(([k, X]) => {
                    if (X.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(ze, { heading: y(k), children: X.map((nt) => /* @__PURE__ */ a(
                          Zn,
                          {
                            bookId: nt,
                            onSelect: (zt) => We(zt),
                  ...
                  D && Nt && D.chapterNum && d && /* @__PURE__ */ u(dt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Go,
                      {
                        ...
                        onVerseSelect: ne,
                        setVerseRef: gt,
                        isVerseDisabled: Ye(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !Nt && lr(D.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
function Wo({
  ...
  const [S, N] = _(!1), A = d ?? l, C = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], K = (M, z) => {
    const q = l(M), Y = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, F = `${z ?? ""}${q}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      De,
      {
        value: q,
  ...
  return /* @__PURE__ */ u(je, { open: S, onOpenChange: N, ...x, children: [
    /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ u(
      Z,
      {
        variant: f,
    ...
    Ja,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Et, { className: "tw:flex tw:items-center", children: o.map((v) => At.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            Z,
            {
...
const ri = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $l = ri ? Jt : W, Ar = { tag: co };
...
const Al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : W;
...
const Ul = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : W;
function Kl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function ql() {
  return function(t) {
    const [e] = Ne(), r = P(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = H(o);
    return Ul(() => {
...
function Jl(t, e = Xl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, R = g.getNode(), x = R.getKey(), S = g.offset, N = t.getElementByKey(b), A = t.getElementByKey(x), C = r === null || N !== o || v !== n || b !== r.getKey(), K = i === null || A !== s || S !== c || x !== i.getKey();
      if ((C || K) && N !== null && A !== null) {
        const M = function(z, q, Y, F, Q, O, B) {
          const I = (z._window ? z._window.document : document).createRange();
          return I.setStart(...Yo(q, Y, F)), I.setEnd(...Yo(Q, O, B)), I;
        }(t, h, f, N, g, R, A);
        l(), l = Yl(t, M, e);
      }
      r = f, o = N, n = v, i = R, s = A, c = S;
    });
  }
...
function td(t) {
  const e = Zt() || mc();
  let r;
  if (xe(e)) r = vc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = jn(c, "next"));
    }
    r = r || bc(Le(), "previous").getFlipped().insert(Rr());
  }
...
let Qr, Se = 0, ta = 0, nd = 0, Ha = 0, qr = 0;
function Jo(t) {
  if (it === void 0) return;
  let e = t.n;
...
Ht.prototype.brand = ad, Ht.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Se !== 0 && ta === 0 && e.l !== Ha && (e.l = Ha, Qr = { S: e, v: e.v, i: e.i, o: Qr });
    })(this), this.v = t, this.i++, qr++, Se++;
    try {
...
} }), Xe.prototype = new Ht(), Xe.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ii(this), Zo(this), Se++;
  const t = it;
...
function si() {
  const t = Le(), e = Zt(), r = Rr();
  t.clear(), t.append(r), e !== null && r.select(), xe(e) && (e.format = 0);
}
function ci(t, e = si) {
  return t.registerCommand(Bn, (r) => (t.update(e), !0), lo);
}
ce({ build: (t, e, r) => mr(e), config: ar({ $onClear: si }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ye(() => ci(t, o.value));
} });
function cd(t) {
...
ce({ name: "@lexical/extension/DecoratorText", nodes: () => [li], register: (t, e, r) => t.registerCommand(Un, (o) => {
  const n = Zt();
  if (Kn(n) || xe(n)) for (const i of n.getNodes()) ld(i) && i.toggleFormat(o);
  return !1;
}, qn) });
function di(t, e) {
  let r;
...
const Ga = ce({ build: (t) => di(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const mo = 0, Wa = 1, ui = 2, Na = 3, Vr = 4, nr = 5, Ca = 6, xr = 7;
function Ea(t) {
  return t.id === mo;
}
function pi(t) {
...
class ud {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Vr && wt(307, String(r.id), String(nr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const hd = ce({ config: ar({ setOptions: Qo, updateOptions: Qo }), init: ({ $initialEditorState: t = pd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class dr {
  ...
  static maybeFromEditor(e) {
    const r = e[tn];
    return r && (r.PACKAGE_VERSION !== Ta && wt(292, r.PACKAGE_VERSION, Ta), r instanceof dr || wt(293)), r;
  }
  static fromEditor(e) {
...
const fd = /* @__PURE__ */ new Set(), rn = ce({ build(t, e, r) {
...
ce({ dependencies: [Ga, rn], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  ...
  return Re(t.registerCommand(md, (s) => {
    const c = Zt();
    if (!xe(c)) return !1;
...
function xd(t, e, r = hi) {
  return Re(t.registerCommand(Wc, (o) => {
    const n = Zt();
    if (!xe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
ce({ build: (t, e, r) => mr(e), config: ar({ $canIndent: hi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ye(() => {
    if (!o.value) return xd(t, n, i);
  });
} });
const yd = ce({ name: "@lexical/react/ReactProvider" });
function kd() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (xe(f)) {
                ...
                if (Fa(v) && d >= 0 && w >= 0 && (R = d, x = d + w, f.setTextNodeRange(v, R, v, x)), R === x && p === "" || (f.insertRawText(p), v = b.getNode()), Fa(v)) {
                  R = h, x = h + g;
...
ce({ build: (t, e, r) => mr(e), config: ar({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ye(() => r.getOutput().disabled.value ? void 0 : fi(t)) });
function Cd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const bo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : W;
...
function Fd({
  ...
  const [e] = Ne(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = jd(), l = () => {
  };
...
function Ud() {
  const { activeEditor: t } = bi(), [e, r] = _([]), o = j((n) => {
    if (xe(n) || cl(n)) {
      const i = [];
      nn.forEach(({ format: s }) => {
...
function kp({
  ...
  const [i, s] = _(Yd), [c, l] = _(n), [d, w] = _(!1), p = H(void 0), h = H(null);
  W(() => {
    let v = !0;
    const R = h.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : yo(v) && (v.preventDefault(), v.stopPropagation(), se(i) && g());
        },
        onKeyDown: (v) => {
...
function cn({
  ...
  const g = j(
    ...
    [t.user]
  ), x = P(() => io(t.contents), [t.contents]), S = P(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), N = !!t.conflictResolutionAction && !S, A = P(() => {
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          Ze,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : yo(C) && (C.preventDefault(), C.stopPropagation(), se(w) && f());
              },
              onKeyDown: (C) => {
        ...
        A && /* @__PURE__ */ u(Ke, { children: [
          /* @__PURE__ */ a(qe, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(xs, {}) }) }),
          /* @__PURE__ */ a(He, { align: "end", children: A })
        ] })
      ]
    }
  );
...
function Si({
  ...
  const [F, Q] = _(ln), [O, B] = _(), [I, E] = _(), J = o, [et, ft] = _(!1), [at, Dt] = _(!1), [tt, st] = _(!1), [ht, mt] = _(!1), [ct, Mt] = _(!1), [pt, le] = _(N), [Qt, Tt] = _(!1), bt = H(void 0), [kt, Ot] = _(/* @__PURE__ */ new Map());
  W(() => {
    let y = !0;
    return (async () => {
  ...
  const D = P(() => St[0], [St]), de = H(null), oe = H(void 0), ne = j(() => {
    var y;
    (y = oe.current) == null || y.call(oe), Q(ln);
  }, []), We = j(() => {
    const y = !pt;
    le(y), Tt(!y), f == null || f(l, y);
  }, [pt, f, l]);
  W(() => {
    ft(!1);
  }, [o]), W(() => {
  ...
  }, [i, r]), ee = P(() => St.slice(1), [St]), yt = P(() => ee.length ?? 0, [ee.length]), re = P(() => yt > 0, [yt]), It = P(() => et || yt <= 2 ? ee : ee.slice(-2), [ee, yt, et]), $t = P(() => et || yt <= 2 ? 0 : yt - 2, [yt, et]), fe = P(
    () => yt === 1 ? te.singleReply : Qe(te.multipleReplies, { count: yt }),
    [yt, te]
  ), me = P(
    () => $t === 1 ? te.singleReply : Qe(te.multipleReplies, { count: $t }),
    [$t, te]
  );
  W(() => {
    !o && at && re && Dt(!1);
  ...
  const ae = j(
    async (y) => {
      ...
      $ && await p({ threadId: l, contents: $ }) && ne();
    },
    [
      ne,
      F,
    ...
    async (y) => {
      const $ = se(F) ? ra(F) : void 0, G = y.status ? y.assignedUser : O ?? y.assignedUser, V = await p({
        ...y,
        contents: $,
        assignedUser: G
      });
      return V && (G !== void 0 && E(G), $ && ne()), V;
    },
    [ne, F, p, O]
  );
      ...
      children: /* @__PURE__ */ u(Zd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        ...
        /* @__PURE__ */ u(dt, { children: [
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            Y && It.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            $t > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    et ? /* @__PURE__ */ a(_s, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            ...
            v !== !1 && (!at || se(F)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (y) => {
                  yo(y) && (y.preventDefault(), y.stopPropagation(), (se(F) || O !== void 0 && O !== I) && ae());
                },
                onKeyDown: (y) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    O !== void 0 && (se(F) || O !== I) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Qe(
                    ...
                    /* @__PURE__ */ u(je, { open: tt, onOpenChange: st, children: [
                      ...
                      /* @__PURE__ */ a(
                        Fe,
                        {
                          ...
                          children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ue, { children: b == null ? void 0 : b.map((y) => /* @__PURE__ */ a(
                            De,
                            {
                              onSelect: () => {
                              ...
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Hr(y, r) })
                            },
                            y || "unassigned"
                          )) }) })
                        }
...
function aw({
  ...
  const [s, c] = _("accept"), l = Po(), d = Po(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = P(
    ...
    () => Gr(t.mergedText ?? ""),
    [t.mergedText]
  ), x = P(() => io(t.contents), [t.contents]);
  if (!Ci(t))
    return /* @__PURE__ */ a(Wr, { html: x });
  const S = (I) => {
  ...
  const q = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: q }), F = (I) => I ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: I }) : Y, Q = () => {
    const I = o ?? "accept";
    return I === "merged" ? t.mergedText ? /* @__PURE__ */ a(Wr, { html: R }) : Y : F(I === "reject" ? t.rejectedResultText : t.resultText);
    ...
    if (e === "Resolved") {
      for (let x = o.length - 1; x >= 0; x -= 1)
        if (o[x].status === "Resolved")
          return Ei(o[x].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function Dp({
  ...
  const [x, S] = _(/* @__PURE__ */ new Set()), [N, A] = _(), [C, K] = _(), M = j(
    async (E) => {
      const J = await i(E);
  ...
  W(() => {
    f && (S((E) => new Set(E).add(f)), A(f));
  }, [f]);
  const z = r.filter(
    (E) => E.comments.some((J) => !J.deleted)
  ), q = z.map((E) => ({ id: E.id })), Y = j(
    (E) => {
      S((J) => new Set(J).add(E.id)), A(E.id), b == null || b(E.id);
    },
    [b]
  ), F = j(
    (E) => {
...
function hw({
  ...
  var C;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, R] = _({}), x = P(() => e ?? [], [e]), S = Yn({
    data: x,
    columns: t,
    getCoreRowModel: Jn(),
  ...
  let A;
  return l ? A = Array.from({ length: 10 }).map((z, q) => `skeleton-row-${q}`).map((z) => /* @__PURE__ */ a(Pe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((C = S.getRowModel().rows) == null ? void 0 : C.length) > 0 ? A = S.getRowModel().rows.map((K) => /* @__PURE__ */ a(
    Pe,
    {
      onClick: () => s(K, S),
      "data-state": K.getIsSelected() && "selected",
      children: K.getVisibleCells().map((M) => /* @__PURE__ */ a(cr, { children: kr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    K.id
  )) : A = /* @__PURE__ */ a(Pe, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(lw, { table: S }),
    /* @__PURE__ */ u(to, { stickyHeader: i, children: [
      /* @__PURE__ */ a(eo, { stickyHeader: i, children: S.getHeaderGroups().map((K) => /* @__PURE__ */ a(Pe, { children: K.headers.map((M) => /* @__PURE__ */ a(Jr, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : kr(M.column.columnDef.header, M.getContext()) }, M.id)) }, K.id)) }),
...
function _w({
  ...
  const i = H(null), s = H(null), c = H(!1), [l, d] = _(t), [w, p] = _(r), [h, g] = _(!1), f = H(l);
  f.current = l;
  const b = H(w);
  b.current = w, W(() => {
    d(t);
  ...
  const v = (x) => {
    ...
    var S, N, A, C;
    x.stopPropagation(), document.activeElement === s.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((S = i.current) == null || S.focus(), c.current = !0) : document.activeElement === i.current && x.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), c.current = !1) : document.activeElement === i.current && x.key === "ArrowLeft" && ((A = i.current) == null ? void 0 : A.selectionStart) === 0 && ((C = s.current) == null || C.focus(), c.current = !1), l === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && v(!1);
  };
  return /* @__PURE__ */ u(Ke, { open: h, onOpenChange: v, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(qe, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: kw(t, n, r) }) }) }),
...
function Ew({
  ...
  return /* @__PURE__ */ u(Ke, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(qe, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: Nw(t, r) }) }) }),
      /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ a("p", { children: Cw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(He, { style: { zIndex: kn }, children: [
...
function Fp({
  ...
  var ae;
  const h = H(null), g = H(null), f = H(null), b = H(null);
  Jt(() => {
    if (!b.current) return;
    const { width: T } = b.current.getBoundingClientRect();
    T > 0 && (b.current.style.width = `${T}px`);
  }, []);
  const [v, R] = _("generated"), [x, S] = _("generated"), [N, A] = _("*"), [C, K] = _("*"), [M, z] = _("f"), [q, Y] = _(!1), [F, Q] = _(!0), [O, B] = _(!1), I = H(!1), E = H(""), [J, et] = _(!1), [ft, at] = _(), [Dt, tt] = _(), [st, ht] = _(), [mt, ct] = _(), Mt = H(null), pt = H(
    void 0
  ), le = H(0), Qt = H(void 0), Tt = P(
    () => ({
      ...s,
  ...
  W(() => {
    var G, V;
    let T, U, y;
    I.current = !1, Qt.current = void 0, Q(!0);
    const $ = e == null ? void 0 : e.at(0);
    if ($ && br("note", $)) {
      const ot = (G = $.insert.note) == null ? void 0 : G.caller;
      let lt = "custom";
      ot === Ba ? lt = "generated" : ot === Ua ? lt = "hidden" : ot && (A(ot), K(ot)), R(lt), S(lt), z(((V = $.insert.note) == null ? void 0 : V.style) ?? "f"), T = setTimeout(() => {
        var gt, _t, Nt;
        (gt = h.current) == null || gt.applyUpdate([$]), (_t = h.current) == null || _t.selectNote(0), (Nt = h.current) == null || Nt.focus(), U = requestAnimationFrame(() => {
          y = setTimeout(() => {
            var Ut, Yt;
            kt() || ((Ut = h.current) == null || Ut.selectNote(0), (Yt = h.current) == null || Yt.focus());
          }, 0);
        });
      }, 0);
    }
  ...
  const Ot = j(
    (T = !1) => {
      ...
      U && br("note", U) && (r == null || r([U]), T && d && i && ((G = d.current) == null || G.replaceEmbedUpdate(i, [U])));
    },
    [i, r, p, d]
  ), vt = j(
    (T, U) => {
      ...
      let $;
      T === "custom" ? $ = U : T === "generated" ? $ = Ba : $ = Ua, y.insert.note.caller !== $ && (y.insert.note.caller = $, (ot = h.current) == null || ot.applyUpdate([y, { delete: 1 }]));
    },
    []
  ), St = j(() => {
    var T;
  ...
  const de = H({ book: n.book, chapterNum: n.chapterNum });
  Jt(() => {
  ...
  const oe = () => {
    ...
    if (U && br("note", U)) {
      ...
      M !== "x" && T === "x" ? lt == null || lt.forEach((gt) => Ow(gt)) : M === "x" && T !== "x" && (lt == null || lt.forEach((gt) => Iw(gt))), (ot = h.current) == null || ot.applyUpdate([U, { delete: 1 }]);
    }
  }, we = (T) => {
      ...
      if (U && br("note", U)) {
        ...
        if (lt || Y(!1), Y(
          lt === "x" ? !!(gt != null && gt.every((_t) => {
            ...
            const Nt = ((Yt = _t.attributes) == null ? void 0 : Yt.char).style;
    ...
    (T, U, y) => {
      ...
      ts({
        ...
        clearSessionIfCurrent: (V) => To(pt, V),
        ...
        runSessionKey: (V) => re.current(V),
        show: (V) => w.show(U.map(Mw), $, G, V),
        ...
        onShowError: (V) => {
          (!Js(V) || V.code !== Zs) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Qs(V)}`
          );
        }
      });
    },
  ...
  W(() => {
    ...
    yt,
    c,
    (ae = Tt.view) == null ? void 0 : ae.markerMode,
    Tt.styleInfo,
    w,
    $t,
    kt
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
              ...
              /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ a("p", { children: me }) })
            ] }) }) })
          ]
        }
      )
...
function jw({
  ...
  return /* @__PURE__ */ u(to, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(eo, { stickyHeader: !0, children: /* @__PURE__ */ u(Pe, { children: [
    ...
    /* @__PURE__ */ a(ro, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Pe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { className: o, children: Lw(c.text) })
        ]
      },
...
function Jp({
  ...
  const g = ve(r, "%webView_inventory_all%"), f = ve(r, "%webView_inventory_approved%"), b = ve(r, "%webView_inventory_unapproved%"), v = ve(r, "%webView_inventory_unknown%"), R = ve(r, "%webView_inventory_scope_currentBook%"), x = ve(r, "%webView_inventory_scope_chapter%"), S = ve(r, "%webView_inventory_scope_verse%"), N = ve(r, "%webView_inventory_filter_text%"), A = ve(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = ve(r, "%webView_inventory_no_results%"), [K, M] = _(!1), [z, q] = _("all"), [Y, F] = _(""), [Q, O] = _([]), B = P(() => {
    const tt = t ?? [];
  ...
  }, [K, B]), E = P(() => I.length === 0 ? [] : Kw(I, z, Y), [I, z, Y]), J = P(() => {
    var ht, mt;
    if (!K) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(pr, { onValueChange: (tt) => ft(tt), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(fr, { children: [
          ...
          /* @__PURE__ */ a(pe, { value: "verse", children: S })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ia,
      ...
      o && /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
        /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Et, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? A })
        ] }) }),
...
function Ww({
  ...
  const [l, d] = Gt.useState(t), w = e ?? l, p = Gt.useCallback(
    ...
    [r, w]
  ), h = Gt.useCallback(() => p((S) => !S), [p]), g = w ? "expanded" : "collapsed", v = ke() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = Gt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
const $e = "scrBook", au = "scrRef", Je = "source", ou = "details", nu = "Scripture Reference", iu = "Scripture Book", Di = "Type", su = "Details";
function cu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? At.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === $e ? Te(n.start) : void 0;
      },
...
function uh({
  ...
  const [d, w] = _([]), [p, h] = _([{ id: $e, desc: !1 }]), [g, f] = _({}), b = P(
  ...
  W(() => {
    if (c) {
      ...
      if (q.length === 1) {
        const Y = b.find((F) => fn(F) === q[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, R]);
  const x = n ?? iu, S = i ?? Di, N = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [$e] },
    { label: `Group by ${S}`, value: [Je] },
    {
  ...
  }, K = (z, q) => z.getIsGrouped() ? "" : m("banded-row", q % 2 === 0 ? "even" : "odd"), M = (z, q, Y) => {
    if (!((z == null ? void 0 : z.length) === 0 || q.depth < Y.column.getGroupedIndex())) {
      if (q.getIsGrouped())
        switch (q.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(dw, { children: N.map((z) => /* @__PURE__ */ a(pe, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(to, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(eo, { children: R.getHeaderGroups().map((z) => /* @__PURE__ */ a(Pe, { children: z.headers.filter((q) => q.column.columnDef.header).map((q) => (
        ...
        return /* @__PURE__ */ a(
          Pe,
          {
            ...
            children: z.getVisibleCells().map((F) => {
              if (!(F.getIsPlaceholder() || F.column.columnDef.enableGrouping && !F.getIsGrouped() && (F.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  cr,
                  {
                    className: m(
                    ...
                    children: F.getIsGrouped() ? /* @__PURE__ */ u(
                      Z,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Aa, {}) : /* @__PURE__ */ a(Pa, {})),
                          " ",
                          kr(F.column.columnDef.cell, F.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function du({
  ...
  }, [v, R] = _(!1), [x, S] = _(""), N = H(void 0), A = H(!1), C = P(
    () => Cn(t),
    [t]
  ), K = P(() => {
    if (!x.trim()) {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ra ? Ra : mn
      ).map((d) => /* @__PURE__ */ a(Nr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ee(d, n) }, d)),
...
function hh({
  ...
  const A = Pt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = Pt(s, "%webView_scope_selector_current_book%"), F = Pt(s, "%webView_scope_selector_choose_books%"), Q = Pt(s, "%webView_scope_selector_scope%"), O = Pt(s, "%webView_scope_selector_select_books%"), B = Pt(s, "%webView_scope_selector_range%"), I = Pt(s, "%webView_scope_selector_select_range%"), E = Pt(s, "%webView_scope_selector_range_start%"), J = Pt(s, "%webView_scope_selector_range_end%"), et = Pt(s, "%webView_scope_selector_ok%"), ft = Pt(s, "%webView_scope_selector_cancel%"), at = Pt(s, "%webView_scope_selector_navigate%"), Dt = (L) => {
    if (!b) return;
  ...
  ] }), ht = e ? tt.filter((L) => e.includes(L.value)) : tt, mt = b ?? va, ct = p ?? mt, Mt = h ?? mt, pt = () => {
  }, le = H(null), Qt = H(null), Tt = H(!1), bt = H(null), kt = H(!1), [Ot, vt] = _(void 0), St = H(!1), D = H(!1), de = H(null), oe = j((L) => {
    if (L) {
    ...
    vt((rt) => rt === "start" ? void 0 : rt), St.current && (St.current = !1, requestAnimationFrame(() => {
      var Xt;
      const rt = (Xt = le.current) == null ? void 0 : Xt.querySelector("button");
      rt == null || rt.click();
    }));
  }, []), ne = j((L) => {
    if (L) {
    ...
    [r, n, b, i]
  ), ee = ht.find((L) => L.value === t), yt = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? rc(ct, Mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ee ? st(ee.label, ee.scrRefSuffix) : t, re = ht.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), It = ht.find((L) => L.value === "selectedBooks"), $t = ht.find((L) => L.value === "range"), [fe, me] = _(!1), [ae, T] = _(void 0), [U, y] = _(void 0), [$, G] = _(void 0), [V, ot] = _(void 0), [lt, gt] = _([]), _t = w === "dropdown" && ae === "selectedBooks", Nt = /* @__PURE__ */ a(
    hu,
    {
      availableBookInfo: o,
  ...
  ), Ut = Ot === "end", Yt = Ot === "start", Ye = "tw:text-muted-foreground", Me = w === "dropdown" && ae === "range", Mr = Me ? G : We, ha = Me ? ot : f ? te : pt, Or = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: m(Ut && Ye), children: E }),
      /* @__PURE__ */ a(
        xa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: le, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Yt && Ye), children: J }),
      /* @__PURE__ */ a(
        xa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: R,
          getEndVerse: x,
          disableReferencesUpTo: Me ? $ ?? ct : ct,
          onOpenChange: ne,
          onCloseAutoFocus: (L) => {
            var rt;
            D.current && (D.current = !1, L.preventDefault(), (rt = de.current) == null || rt.focus());
          },
          className: m(Yt && Ye),
          modal: !0,
          align: "start"
  ...
  const [zt, Oe] = _(null), [Ce, or] = _(null), [Rt, Ct] = _(null), Kt = 200, [xt, ie] = _(!1);
  W(() => {
    if (!Rt || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([rt]) => {
      ie(rt.contentRect.width < Kt);
    });
    return L.observe(Rt), () => L.disconnect();
  }, [Rt]);
  const ue = j(
    (L) => {
      y(L), G(ct), ot(Mt), gt(n), me(!1), T(L);
    },
    [ct, Mt, n]
  ), Ie = j(() => {
    U !== void 0 && (U === "range" ? ($ && (g == null || g($)), V && (f == null || f(V))) : U === "selectedBooks" && i(lt), we(U), T(void 0), y(void 0));
  }, [
    U,
    $,
    V,
  ...
  }, []), Co = (L) => t === L ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Ke, { open: fe, onOpenChange: me, children: [
        ...
        /* @__PURE__ */ a(
          He,
          {
            ...
            children: /* @__PURE__ */ u(ga, { container: Rt, children: [
              re.map(({ value: L, label: rt, dropdownLabel: Xt, scrRefSuffix: vr, id: ji }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: X(L),
                  ...
                  children: [
                    t === L && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }),
                    st(Xt ?? rt, vr, xt)
                  ]
                },
                ji
                ...
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ...
                    onSelect: (L) => {
                      ...
                      kt.current || (Xt = (rt = Qt.current) == null ? void 0 : rt.querySelector("button")) == null || Xt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          xa,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(dt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Te(b ?? va, "id") }),
                              /* @__PURE__ */ a(wr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ja,
        {
          ...
          children: ht.map(({ value: L, label: rt, scrRefSuffix: Xt, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Xr, { className: "tw:me-2", value: L, id: vr }),
            /* @__PURE__ */ a(Et, { htmlFor: vr, children: st(rt, Xt) })
          ] }, vr))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && Or,
    w === "dropdown" && It && /* @__PURE__ */ a(Da, { open: ae === "selectedBooks", onOpenChange: Ir, children: /* @__PURE__ */ a(
      Ma,
      {
        ref: or,
        onCloseAutoFocus: No,
        onEscapeKeyDown: (L) => {
          Ce != null && Ce.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(ga, { container: Ce, children: [
          /* @__PURE__ */ a(Oa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ia, { children: F }) }),
          Nt,
    ...
    w === "dropdown" && $t && /* @__PURE__ */ a(Da, { open: ae === "range", onOpenChange: Ir, children: /* @__PURE__ */ a(
      Ma,
      {
        ref: Oe,
        onCloseAutoFocus: No,
        ...
        children: /* @__PURE__ */ u(ga, { container: zt, children: [
          /* @__PURE__ */ a(Oa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ia, { children: I }) }),
          Or,
          /* @__PURE__ */ u(So, { children: [
            /* @__PURE__ */ a(Z, { variant: "outline", onClick: () => Ir(!1), children: ft }),
...
function gh({
  ...
  return /* @__PURE__ */ u(
    pr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(gr, { size: n, className: m("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          hr,
          {
        ...
        /* @__PURE__ */ a(
          fr,
          {
            ...
            style: { zIndex: rr },
            children: t.map((w) => /* @__PURE__ */ a(pe, { value: `${w}`, children: l[Oo(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Ya({
  ...
  return /* @__PURE__ */ u(Ke, { variant: i, children: [
    /* @__PURE__ */ a(qe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(Z, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Us, {}) }) }),
    /* @__PURE__ */ a(He, { align: "start", style: { zIndex: rr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ca, { children: [
...
Pi.displayName = ge.List.displayName;
...
Ai.displayName = ge.List.displayName;
...
Vi.displayName = ge.Content.displayName;
function yh({
  tabList: t,
  searchValue: e,
  onSearch: r,
...
function Nh({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: Qe(d, {
