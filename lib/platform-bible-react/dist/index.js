...
var Qi = (t, e, r) => e in t ? Ji(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Jt = (t, e, r) => Qi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Te, a as zr, C as Le, u as Do, T as Bt, b as Ft, d as Ut, e as Kt, A as be, P as Ge, f as cr, B as X, h as We, i as Ye, j as Xe, k as Ae, x as ts, l as es, m as rs, I as as, n as so, r as De, o as os, p as _n, q as wa, s as ua, L as Dt, R as co, t as aa, D as Ba, v as Fa, w as Ua, y as Ka, z as Nn, E as Yr, F as lo, G as Cn, H as wo, J as ir, K as Ir, M as Ze, N as Je, O as Qe, S as Pr, Q as hr, U as ns, V as Vr, W as sr, X as Ke, Z as lr, Y as Fe, _ as gr, $ as uo, a0 as po, a1 as oa, a2 as ho, a3 as En, a4 as is, a5 as ss, a6 as cs, a7 as Ha, a8 as Tn, a9 as pa, aa as ls, ab as Sn, ac as ds, ad as ws, ae as us, af as Mo, ag as ps, ah as hs, ai as gs, aj as fs, ak as Rn, al as zn, am as go, an as ms, ao as Dn, ap as Ca, aq as Oo, ar as Ea, as as vs, at as bs, au as xs, av as ys, aw as ks, ax as Lr, ay as fo, az as _s, aA as Ns } from "./resizable-5NEfrGIS.js";
import { aB as Og, aC as Ig, aD as Pg, aE as $g, aF as Ag, aG as Vg, aH as Lg, aI as jg, aJ as Bg, aK as Fg, aL as Ug, aM as Kg, aN as Hg, aO as qg, aP as Gg, aQ as Wg, aR as Yg, aS as Xg, aT as Zg, aU as Jg, aV as Qg, aW as tf, aX as ef, aY as rf, aZ as af, a_ as of, a$ as nf, b0 as sf, b1 as cf, b2 as lf, b3 as df, b4 as wf, b5 as uf, b6 as pf, b7 as hf, b8 as gf, b9 as ff } from "./resizable-5NEfrGIS.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as Io, ChevronsLeft as Po, ChevronsRight as $o, ChevronLeft as qa, ChevronRight as Ga, ArrowLeft as Cs, ArrowRight as Es, ChevronDown as vr, BoldIcon as Ts, ItalicIcon as Ss, X as mo, AtSign as Mn, Pencil as Rs, Trash2 as zs, ArrowUp as On, MoreHorizontal as Ds, MailOpen as Ms, Mail as Os, ChevronUp as Is, FilterIcon as Ps, ArrowLeftIcon as $s, ChevronLeftIcon as As, ChevronRightIcon as Vs, ArrowRightIcon as Ls, Copy as In, Filter as js, User as Bs, Link as Fs, CircleHelp as Us, Undo as Ks, Redo as Hs, SquareX as Pn, FunctionSquare as $n, SquareSigma as An, Ban as qs, AlertCircle as Wa, CircleCheckIcon as Gs, CircleXIcon as Ws, CircleHelpIcon as Ys, ArrowUpIcon as Xs, ArrowDownIcon as Zs, ScrollText as Js, ChevronsUpDown as Qs, MenuIcon as tc, Menu as ec, EllipsisVertical as rc, MoreVertical as ac } from "lucide-react";
import { Section as zt, getChaptersForBook as oc, formatScrRef as Pe, formatReplacementString as Ue, getSectionForBook as Xr, formatRelativeDate as nc, sanitizeHtml as vo, NumberFormat as Vn, formatBytes as ic, getCurrentLocale as sc, usfmMarkers as Zr, deepEqual as Ln, isPlatformError as cc, ABORTED as lc, getErrorMessage as dc, getFormatCallerFunction as wc, isString as Ao, compareScrRefs as Ya, scrRefToBBBCCCVVV as Ta, defaultScrRef as Sa, formatScrRefRange as uc, getLocalizeKeyForScrollGroupId as Vo, formatReplacementStringToArray as Lo, collectUsjMarkers as pc } from "platform-bible-utils";
import ne, { useRef as j, useMemo as $, createContext as jr, useContext as ha, useState as _, useEffect as G, useCallback as V, useImperativeHandle as jn, useLayoutEffect as te, Component as hc, createElement as jo, Suspense as gc, forwardRef as Bn, useId as Bo, Fragment as br } from "react";
import { IconSelector as Fn, IconCheck as ga, IconChevronDown as fc, IconChevronUp as mc, IconLayoutSidebar as vc, IconLayoutSidebarRight as bc, IconChevronRight as Un, IconSearch as xc, IconLoader as yc, IconAlertOctagon as kc, IconAlertTriangle as _c, IconInfoCircle as Nc, IconCircleCheck as Cc } from "@tabler/icons-react";
import { createEditor as Kn, $getRoot as qe, $createParagraphNode as Br, $getSelection as ie, HISTORY_MERGE_TAG as bo, ParagraphNode as Hn, TextNode as qn, $getPreviousSelection as Ec, $isRangeSelection as Re, $caretFromPoint as Tc, $getSiblingCaret as Gn, $getChildCaret as Sc, $getAdjacentChildCaret as Rc, $isChildCaret as zc, $normalizeCaret as Dc, $setSelectionFromCaretRange as Mc, $getCollapsedCaretRange as Oc, $getCaretInDirection as Fo, $splitAtPointCaretNext as Ic, $isTextPointCaret as Pc, $findMatchingParent as Wn, $isElementNode as $r, mergeRegister as Ve, getDOMTextNode as $c, isHTMLElement as Ac, CLEAR_EDITOR_COMMAND as Yn, COMMAND_PRIORITY_EDITOR as xo, shallowMergeConfig as Vc, defineExtension as ge, safeCast as dr, createState as Lc, FORMAT_TEXT_COMMAND as Xn, $isNodeSelection as Zn, COMMAND_PRIORITY_LOW as Jn, RootNode as jc, LineBreakNode as Bc, TabNode as Fc, $isEditorState as Uc, createCommand as Kc, CLICK_COMMAND as Hc, isDOMNode as qc, $getNodeFromDOMNode as Gc, $createNodeSelection as Wc, $setSelection as Yc, $getEditor as Xc, DecoratorNode as Xa, $getState as Zc, toggleTextFormatType as Uo, TEXT_TYPE_TO_FORMAT as Jc, $setState as Qc, addClassNamesToElement as Qn, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as rl, KEY_TAB_COMMAND as al, $isBlockElementNode as ol, $createRangeSelection as nl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as Ko, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as yo, $isDecoratorNode as ll, $isParagraphNode as dl, $isTextNode as Za, SELECTION_CHANGE_COMMAND as ti, $insertNodes as wl } from "lexical";
...
import { Avatar as ko, Select as ee, Checkbox as Ho, Slot as Fr, Tabs as xe, Menubar as Me, ContextMenu as Ht, Progress as qo, Slider as Ur, Switch as Go } from "radix-ui";
import { useReactTable as ri, getFilteredRowModel as xl, getSortedRowModel as ai, getPaginationRowModel as yl, getCoreRowModel as oi, flexRender as Dr, getGroupedRowModel as kl, getExpandedRowModel as _l } from "@tanstack/react-table";
import Nl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ja, HIDDEN_NOTE_CALLER as Qa, getDefaultViewOptions as Cl, isInsertEmbedOpOfType as Tr, getMarkerMenuItems as El, defaultStyleInfo as Tl, Editorial as Sl } from "@eten-tech-foundation/platform-editor";
import { cva as ni } from "class-variance-authority";
import { useHotkeys as Rl } from "react-hotkeys-hook";
import { Drawer as tr } from "vaul";
...
function ii({
  ...
  const g = j(!1), m = () => {
    ...
    () => zr(e, l),
    [e, l]
  ), x = !!p && !w, E = `${b} (${R})`, P = x ? h || `${E}, ${p}` : E, K = /* @__PURE__ */ u(
    Le,
    {
      ref: t,
...
function Il({
  ...
  const {
    ...
    onPointerEnter: m,
    onPointerLeave: f
  } = Do(), [b, R] = _(!1), [x, E] = _(!1), P = j(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), K = n && e !== void 0, C = i ?? (e !== void 0 && !n);
  G(() => {
    var z;
    Ol();
    const et = (z = P.current) == null ? void 0 : z.closest('button, [role="combobox"], [tabindex]');
    if (!et) return;
    const N = (W) => !!W && W.scrollWidth > W.clientWidth, Q = () => {
      to !== "pointer" && (C || N(h.current) || N(l.current)) && E(!0);
    }, D = () => E(!1);
    return et.addEventListener("focus", Q), et.addEventListener("blur", D), () => {
      et.removeEventListener("focus", Q), et.removeEventListener("blur", D);
    };
  }, [C, h, l]);
  const B = V(() => {
    C && R(!0), m(), K && w();
  ...
  return (
    ...
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(
      Ft,
      {
        open: g || d || b || x,
        onOpenChange: (et) => {
        ...
        children: [
          /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                U,
                U && L && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                L
              ]
            }
          ) }),
          /* @__PURE__ */ a(Kt, { children: s })
        ]
      }
    ) })
  );
...
function Pl({
  ...
  const [h, g] = _(!1), m = w !== void 0, f = m ? w : h, b = (x) => {
    m || g(x), p == null || p(x);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Ge, { open: f, onOpenChange: b, children: [
    /* @__PURE__ */ a(cr, { asChild: !0, children: /* @__PURE__ */ a(
      X,
      {
        variant: d,
        size: "icon",
    ...
    /* @__PURE__ */ a(We, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ye, { children: /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ a(Ae, { heading: i, children: t.map((x) => /* @__PURE__ */ u(
      Le,
      {
        onSelect: () => R(x),
...
function Dp(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
  ...
  const o = Al.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && l) {
          const g = ((m) => Object.keys(be).find(
            (f) => be[f].toLowerCase() === m.toLowerCase()
          ))(c);
...
function Bl(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), i = n.size === 0 ? t : jt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
...
function di({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function za({
  ...
  const C = De(), B = Ml(), [I, k] = _(!1), [T, U] = _(""), [L, et] = _(""), [N, Q] = _("books"), [D, z] = _(void 0), [W, it] = _(
    void 0
  ), [ot, ut] = _(void 0), [It, Z] = _(!1), [ct, nt] = _(!1), gt = j(null), vt = j(!1), Mt = j(void 0), Nt = j(void 0), Xt = j(void 0), fe = j(void 0), se = j({}), re = j({}), Ot = V(
    (y) => {
      e(y), l && l(y);
    },
    [e, l]
    ...
    projectBooksBySection: Pt,
    reachableBooksBySection: $t,
    reachableBooks: At,
    projectBooks: de,
    booksOutsideProject: yt
  } = $(
    () => Bl(le, ft),
    [le, ft]
  ), ae = yt.has(t.book), ce = $(() => L.trim() ? eo(
    At.filter((y) => so(y, L, i))
  ) : ct ? $t : Pt, [
    Pt,
    $t,
    At,
  ...
  const bt = V(() => {
    if (M) {
      const y = M.chapterNum ?? 1, rt = M.verseNum ?? 1;
      if (p && Ra(M.book, y, rt, p))
        return;
      Ot({
        book: M.book,
        chapterNum: y,
    ...
    (y) => {
      const rt = W ?? (M == null ? void 0 : M.book), at = ot ?? (M == null ? void 0 : M.chapterNum);
      !rt || !at || (Ot({
        book: rt,
        chapterNum: at,
        verseNum: y
    ...
    (y) => {
      const rt = N === "chapters" ? D : M == null ? void 0 : M.book;
      if (rt) {
        if (w && w(rt, y) > 1) {
          it(rt), ut(y), Q("verses"), U("");
          return;
        }
        Ot({
          book: rt,
    ...
    Q("books"), z(void 0), it(void 0), ut(void 0), setTimeout(() => {
      Nt.current && Nt.current.focus();
    }, 0);
  }, []), ue = V(() => {
    const y = W;
    it(void 0), ut(void 0), y ? (z(y), Q("chapters"), U("")) : Zt();
  }, [W, Zt]), Wt = V(
    (y) => {
      k(y), y && (Q("books"), z(void 0), it(void 0), ut(void 0), et(""), nt(ae));
    },
    [ae]
  );
  G(() => {
  ...
  const { otLong: kt, ntLong: Vt, dcLong: _e, extraLong: me } = {
    ...
    (y) => M ? !!M.chapterNum && !y.toString().includes(M.chapterNum.toString()) : !1,
    [M]
  ), ar = $(
    () => Pe(
      t,
    ...
    () => B >= Mr.TIGHT ? zr(t.book, i) : Te(t.book, i),
    [t.book, i, B]
  ), F = `${t.chapterNum}:${t.verseNum}`, Y = V((y) => (rt) => {
    se.current[y] = rt;
  }, []), H = V((y) => (rt) => {
    re.current[y] = rt;
  }, []), J = $(
    () => Vl(L),
    [L]
  ), q = $(() => !w || !M || !M.chapterNum || !J ? !1 : w(M.book, M.chapterNum) > 0, [w, M, J]), st = N === "books" && !It && !L.trim() && yt.size > 0, pt = V(
    (y) => p ? Yo(y, p) : !1,
    [p]
  ), mt = V(
    (y) => (rt) => p ? Ll(y, rt, p) : !1,
    ...
    [p]
  ), St = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", Rt = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) || "Select verse", pe = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", Ne = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", xa = V(
    (y) => Ue(Ne, {
      book: `${Te(y, i)} (${zr(
        y,
        i
    ...
    [Ne, i]
  ), wr = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", ya = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", ka = V(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), h && h.includes(y.key) && M && M.chapterNum !== void 0 && M.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), bt());
    },
    [h, M, bt]
  ), _a = V(
    (y) => {
      ...
      if ((N === "chapters" || N === "verses") && (y.key === " " || y.key === "Enter")) {
        const dt = y.target instanceof HTMLElement ? y.target : void 0;
        ...
        const Yt = (Ie = Mt.current) == null ? void 0 : Ie.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (Yt) {
          y.preventDefault(), y.stopPropagation(), Yt.click();
          return;
        }
      }
      ...
      if (N === "verses" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), ue();
        return;
      }
      const oe = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key);
      if (N === "verses" && oe) {
        const dt = W, xt = ot;
        if (!dt || !xt || !w) return;
        const Yt = w(dt, xt);
        if (!Yt) return;
        (A = Mt.current) == null || A.focus();
        const Et = (() => {
          if (!T) return 1;
          const Er = T.match(/:(\d+)$/);
          return Er ? parseInt(Er[1], 10) : 0;
        })();
        let Ce = Et;
        const je = 6;
        switch (y.key) {
          case "ArrowLeft":
            Et !== 0 && (Ce = Et > 1 ? Et - 1 : Yt);
            break;
          case "ArrowRight":
            Et !== 0 && (Ce = Et < Yt ? Et + 1 : 1);
            break;
          case "ArrowUp":
            Ce = Et === 0 ? Yt : Math.max(1, Et - je);
            break;
          case "ArrowDown":
            Ce = Et === 0 ? 1 : Math.min(Yt, Et + je);
            break;
          default:
            return;
        }
        Ce !== Et && (y.preventDefault(), y.stopPropagation(), U(
          ...
          const Er = re.current[Ce];
          Er && Er.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((N === "chapters" || N === "books" && M) && oe) {
        const dt = N === "chapters" ? D : M == null ? void 0 : M.book;
        if (!dt) return;
        N === "chapters" && ((tt = Mt.current) == null || tt.focus());
        const xt = (() => {
          if (!T) return 1;
          const je = T.match(/(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            xt !== 0 && (Et = xt > 1 ? xt - 1 : Yt);
            break;
          case "ArrowRight":
            xt !== 0 && (Et = xt < Yt ? xt + 1 : 1);
            break;
          case "ArrowUp":
            Et = xt === 0 ? Yt : Math.max(1, xt - Ce);
            break;
          case "ArrowDown":
            Et = xt === 0 ? 1 : Math.min(Yt, xt + Ce);
            break;
          default:
            return;
        }
        Et !== xt && (y.preventDefault(), y.stopPropagation(), U(
          `${dt} ${be[dt] || ""} ${Et}`
        ), setTimeout(() => {
          const je = se.current[Et];
    ...
    if (y.key === "ArrowUp" || y.key === "ArrowDown") {
      (oe = Nt.current) == null || oe.focus();
      return;
    }
    const { isLetter: rt, isDigit: at } = Xo(y.key);
    (rt || at) && (y.preventDefault(), et((Ie) => Ie + y.key), Nt.current.focus(), Z(!1));
  }, []);
  return te(() => {
    const y = setTimeout(() => {
      if (I && N === "books" && Xt.current && fe.current) {
        const rt = Xt.current, at = fe.current, oe = at.offsetTop, Ie = rt.clientHeight, A = at.clientHeight, tt = oe - Ie / 2 + A / 2;
        rt.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), U(li(t.book));
    ...
    if (N === "chapters" && D) {
      ...
      U(
        ...
        if (Xt.current)
          if (y) {
            const at = se.current[t.chapterNum];
  ...
  }, [N, D, M, t.book, t.chapterNum]), te(() => {
    if (N === "verses" && W && ot !== void 0) {
      const y = W === t.book && ot === t.chapterNum, rt = y ? t.verseNum : 1;
      U(
        `${W} ${be[W] || ""} ${ot}:${rt}`
      ), setTimeout(() => {
        if (Xt.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ge, { open: I, onOpenChange: Wt, modal: x, children: [
    /* @__PURE__ */ a(cr, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        ref: gt,
        ...
        onClick: (y) => {
          vt.current && (vt.current = !1, y.preventDefault());
        },
        children: [
          g ?? /* @__PURE__ */ a(
            Il,
            {
              primary: S,
              secondary: F,
              showSecondary: B < Mr.MINIMUM,
              isPartial: B >= Mr.TIGHT,
              fullText: ar
            }
          ),
          f && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      We,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: rt } = y;
          I && gt.current && rt instanceof Node && gt.current.contains(rt) && (vt.current = !0, Wt(!1));
        },
        onCloseAutoFocus: R,
        children: /* @__PURE__ */ u(
          Ye,
              ...
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                /* @__PURE__ */ u("div", { className: "tw:relative tw:flex-1", children: [
                  ...
                  c && c.length > 0 && /* @__PURE__ */ a(
                    ...
                    {
                      recentSearches: c,
                      onSearchItemSelect: ye,
                      renderItem: (y) => Pe(y, "English"),
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ke.map(
                  ({ onClick: y, disabled: rt, title: at, icon: oe }) => /* @__PURE__ */ a(
                    X,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: N === "verses" ? ue : Zt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: C === "ltr" ? /* @__PURE__ */ a(Cs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Es, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                N === "chapters" && D && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Te(D, i) }),
                N === "verses" && W && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Te(W, i)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: N === "verses" ? Rt : St
                  }
                )
              ] }),
              !It && /* @__PURE__ */ u(Xe, { ref: Xt, children: [
                N === "books" && /* @__PURE__ */ u(ht, { children: [
                  !M && Object.entries(ce).map(([y, rt]) => {
                    if (rt.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ae, { heading: er(y), children: rt.map((at) => /* @__PURE__ */ a(
                          ii,
                          {
                            bookId: at,
                            onSelect: (oe) => we(oe),
                            ...
                            localizedBookNames: i,
                            disabled: pt(at),
                            dimmedReason: yt.has(at) ? pe : void 0,
                            dimmedDescription: yt.has(at) ? xa(at) : void 0
                          },
                          at
                        )) }, y)
                      );
                  }),
                  M && /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(
                    Le,
                    {
                      value: `${M.book} ${be[M.book]} ${M.chapterNum || ""}:${M.verseNum || ""})}`,
                      onSelect: bt,
                      disabled: !!p && Ra(
                        M.book,
                        M.chapterNum ?? 1,
                      ...
                      children: Pe(
                        ...
                        // one control.
                        i ? zr(M.book, i) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  M && q && M.chapterNum && w && /* @__PURE__ */ u(ht, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Te(M.book, i)} ${M.chapterNum}` }),
                      /* @__PURE__ */ a("span", { children: Rt })
                    ] }),
                    /* @__PURE__ */ a(
                      Jo,
                      {
                        ...
                        onVerseSelect: Tt,
                        setVerseRef: H,
                        isVerseDisabled: _t(M.book, M.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  M && !q && fr(M.book) > 1 && /* @__PURE__ */ u(ht, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Te(M.book, i) }),
                      /* @__PURE__ */ a("span", { children: St })
                    ] }),
                    /* @__PURE__ */ a(
                      Zo,
                      {
                ...
                N === "chapters" && D && /* @__PURE__ */ a(
                  Zo,
                  {
                    ...
                    onChapterSelect: Gt,
                    setChapterRef: Y,
                    isChapterDisabled: mt(D),
                    className: "tw:p-4"
                  }
                ),
                N === "verses" && W && ot !== void 0 && w && /* @__PURE__ */ a(
                  Jo,
                  {
                    bookId: W,
                    chapterNum: ot,
...
function Qo({
  ...
  const [E, P] = _(!1), K = d ?? l, C = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], B = (I, k) => {
    const T = l(I), U = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, L = `${k ?? ""}${T}${U ?? ""}`;
    return /* @__PURE__ */ u(
      Le,
      {
        value: T,
  ...
  return /* @__PURE__ */ u(Ge, { open: E, onOpenChange: P, ...x, children: [
    /* @__PURE__ */ a(cr, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: m,
        ...
        children: [
          ...
          /* @__PURE__ */ a(vr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(
      We,
      {
        ...
        children: /* @__PURE__ */ u(Ye, { children: [
          ...
          /* @__PURE__ */ a(Xe, { children: C(e) ? e.map((I) => /* @__PURE__ */ a(Ae, { heading: I.groupHeading, children: I.options.map((k) => B(k, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(Ae, { children: e.map((I) => B(I)) }) })
        ] })
      }
    )
  ] });
...
function Ip({
  ...
  const w = Da(d, "%webView_bookSelector_currentBook%"), p = Da(d, "%webView_bookSelector_choose%"), h = Da(d, "%webView_bookSelector_chooseBooks%"), [g, m] = _(
    "current book"
    /* CurrentBook */
  ), f = (b) => {
    m(b), t(b);
    ...
    co,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Dt, { className: "tw:flex tw:items-center", children: o.map((b) => jt.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ a(
            X,
            {
...
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = ui ? te : G, Hr = { tag: bo };
function ql({ initialConfig: t, children: e }) {
  const r = $(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Kl(null, o), w = Kn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const m = Br();
            g.append(m);
            const f = ui ? document.activeElement : null;
            (ie() !== null || f !== null && f === p.getRootElement()) && m.select();
          }
        }, Hr);
...
const Gl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : G;
...
const Ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : G;
function td(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function ed() {
  return function(t) {
    const [e] = Oe(), r = $(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = j(o);
    return Ql(() => {
...
function nd(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      const x = g[R], E = s[R] || document.createElement("div"), P = E.style;
      P.position !== "absolute" && (P.position = "absolute", b = !0);
      const K = Se(x.left - p);
      P.left !== K && (P.left = K, b = !0);
      const C = Se(x.top - h);
      P.top !== C && (E.style.top = C, b = !0);
      const B = Se(x.width);
      P.width !== B && (E.style.width = B, b = !0);
      const I = Se(x.height);
      P.height !== I && (E.style.height = I, b = !0), E.parentNode !== c && (c.append(E), b = !0), s[R] = E;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    d(), o = h, n = g, i = new MutationObserver((m) => {
      const f = t.getRootElement(), b = f && f.parentElement;
      if (f !== o || b !== n) return p();
...
function sd(t, e = id) {
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(I) {
        const k = I.getStartEndPoints();
        return I.isBackward() ? [k[1], k[0]] : k;
      }(p), m = h.getNode(), f = m.getKey(), b = h.offset, R = g.getNode(), x = R.getKey(), E = g.offset, P = t.getElementByKey(f), K = t.getElementByKey(x), C = r === null || P !== o || b !== n || f !== r.getKey(), B = i === null || K !== s || E !== c || x !== i.getKey();
      if ((C || B) && P !== null && K !== null) {
        const I = function(k, T, U, L, et, N, Q) {
          const D = (k._window ? k._window.document : document).createRange();
          return D.setStart(...tn(T, U, L)), D.setEnd(...tn(et, N, Q)), D;
        }(t, h, m, P, g, R, K);
        l(), l = nd(t, I, e);
      }
      r = m, o = P, n = b, i = R, s = K, c = E;
    });
  }
  return d(t.getEditorState()), Ve(t.registerUpdateListener(({ editorState: w }) => d(w)), () => {
    l();
  });
}
function cd(t, e) {
...
function ld(t) {
  const e = Wn(t, (r) => $r(r) && !r.isInline());
  return $r(e) || na(4, t.__key), e;
}
function dd(t) {
  const e = ie() || Ec();
  let r;
  if (Re(e)) r = Tc(e.focus, "next");
    ...
    r = r || Sc(qe(), "previous").getFlipped().insert(Br());
  }
...
function wd(t, e, r) {
  ...
  return Pc(o) && na(283), o.insert(t.isInline() ? Br().append(t) : t), Fo(Gn(t.getLatest(), "next"), e.direction);
}
function ud(t) {
  const e = ie();
  if (!Re(e)) return !1;
...
let ia, $e = 0, sa = 0, gd = 0, ao = 0, Qr = 0;
function rn(t) {
  if (lt === void 0) return;
  let e = t.n;
...
function or(t, e) {
  Qt.call(this, void 0), this.x = t, this.s = void 0, this.g = Qr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function fd(t, e) {
  return new or(t, e);
}
...
function md(t) {
  ...
  gi(this), lt = t, this.f &= -2, 8 & this.f && Co(this), ma();
}
function pr(t, e) {
...
Qt.prototype.brand = pd, Qt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      $e !== 0 && sa === 0 && e.l !== ao && (e.l = ao, ia = { S: e, v: e.v, i: e.i, o: ia });
    })(this), this.v = t, this.i++, Qr++, $e++;
    try {
  ...
  if (this.g = Qr, this.f |= 1, this.i > 0 && !hi(this)) return this.f &= -2, !0;
  const t = lt;
  try {
    an(this), lt = this;
    const e = this.x();
  ...
  return lt = t, gi(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, fi(this), an(this), $e++;
  const t = lt;
  return lt = this, md.bind(this, t);
...
ge({ build: (t, e, r) => Cr(e), config: dr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function mi() {
  const t = qe(), e = ie(), r = Br();
  t.clear(), t.append(r), e !== null && r.select(), Re(e) && (e.format = 0);
}
function vi(t, e = mi) {
  return t.registerCommand(Yn, (r) => (t.update(e), !0), xo);
}
ge({ build: (t, e, r) => Cr(e), config: dr({ $onClear: mi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ze(() => vi(t, o.value));
} });
function vd(t) {
...
ge({ name: "@lexical/extension/DecoratorText", nodes: () => [bi], register: (t, e, r) => t.registerCommand(Xn, (o) => {
  const n = ie();
  if (Zn(n) || Re(n)) for (const i of n.getNodes()) bd(i) && i.toggleFormat(o);
  return !1;
}, Jn) });
function xi(t, e) {
  let r;
...
const oo = ge({ build: (t) => xi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Eo = 0, no = 1, ki = 2, Ia = 3, qr = 4, ur = 5, Pa = 6, Sr = 7;
function $a(t) {
  return t.id === Eo;
}
function _i(t) {
...
function xd(t) {
  return function(e) {
    return e.id === no;
  }(t) || wt(305, String(t.id), String(no)), Object.assign(t, { id: ki });
}
...
class kd {
  ...
  init(e) {
    ...
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(c, l, d) {
      return Object.assign(c, { id: qr, initResult: l, registerState: d });
    }(i, s, n);
  }
  build(e) {
    const r = this.state;
    let o;
    r.id !== qr && wt(307, String(r.id), String(ur)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
    const n = { ...r.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(i, s, c) {
      return Object.assign(i, { id: ur, output: s, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== ur && wt(308, String(o.id), String(ur));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(i) {
      return Object.assign(i, { id: Pa });
    }(o), () => {
      const i = this.state;
      i.id !== Sr && wt(309, String(o.id), String(Sr)), this.state = function(s) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= qr;
    }(e) || wt(313, String(e.id), String(qr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Sr;
    }(e) || wt(316, String(e.id), String(Sr)), e;
  }
...
const Nd = ge({ config: dr({ setOptions: on, updateOptions: on }), init: ({ $initialEditorState: t = _d }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [jc, qn, Bc, Fc, Hn] }), nn = Symbol.for("@lexical/extension/LexicalBuilder");
function sn() {
}
function Cd(t) {
  throw t;
...
class mr {
  ...
  static maybeFromEditor(e) {
    const r = e[nn];
    return r && (r.PACKAGE_VERSION !== Aa && wt(292, r.PACKAGE_VERSION, Aa), r instanceof mr || wt(293)), r;
  }
  static fromEditor(e) {
    const r = mr.maybeFromEditor(e);
  ...
  buildEditor() {
    ...
    return e = Ve(this.registerEditor(o), () => o.setRootElement(null)), o;
  }
...
const Ed = /* @__PURE__ */ new Set(), cn = ge({ build(t, e, r) {
  const o = r.getDependency(oo).output, n = Ar({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = xi(() => {
  }, () => ze(() => {
    const s = i.peek(), { watchedNodeKeys: c } = n.value;
    let l, d = !1;
    o.value.read(() => {
      if (ie()) for (const [w, p] of c.entries()) {
        if (p.size === 0) {
          c.delete(w);
          continue;
        }
...
ge({ dependencies: [oo, cn], name: "@lexical/extension/HorizontalRule", nodes: () => [xr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(cn).output, n = Ar({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ve(t.registerCommand(Td, (s) => {
    const c = ie();
    if (!Re(c)) return !1;
    ...
    if (qc(s.target)) {
      ...
      if (Rd(c)) return function(l, d = !1) {
        const w = ie(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Zn(w) ? g = w : (g = Wc(), Yc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Jn), t.registerMutationListener(xr, (s, c) => {
    hd(() => {
      let l = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = g : (l = !0, d.set(w, { domNode: Ar(g), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(ze(() => {
      const d = c.value;
      d && (l.value ? Qn(d, i) : rl(d, i));
    }));
    return Ve(...s);
  }));
} });
ge({ build: (t, e) => Cr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: dr({ $getParentEditor: function() {
  const t = Xc();
  return mr.fromEditor(t), t;
...
ge({ build: (t, e, r) => Cr(e), config: dr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ze(() => {
...
function zd(t, e, r = Ni) {
  return Ve(t.registerCommand(al, (o) => {
    const n = ie();
    if (!Re(n)) return !1;
    o.preventDefault();
    const i = function(s) {
    ...
    const o = typeof e == "number" ? e : e ? e.peek() : null, n = ie();
    if (!Re(n)) return !1;
...
ge({ build: (t, e, r) => Cr(e), config: dr({ $canIndent: Ni, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ze(() => {
    if (!o.value) return zd(t, n, i);
  });
} });
const Dd = ge({ name: "@lexical/react/ReactProvider" });
function Md() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (Re(m)) {
                const f = m.anchor;
                let b = f.getNode(), R = 0, x = 0;
                if (Za(b) && d >= 0 && w >= 0 && (R = d, x = d + w, m.setTextNodeRange(b, R, b, x)), R === x && p === "" || (m.insertRawText(p), b = f.getNode()), Za(b)) {
                  R = h, x = h + g;
                  const E = b.getTextContentSize();
                  R = R > E ? E : R, x = x > E ? E : x, m.setTextNodeRange(b, R, b, x);
                }
...
ge({ build: (t, e, r) => Cr(e), config: dr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ze(() => r.getOutput().disabled.value ? void 0 : Ei(t)) });
function Pd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const So = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : G;
...
function Vd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    So(() => Ve(hl(n), Ei(n)), [n]);
  }(o), u(ht, { children: [t, a(Ld, { content: e }), a(Ad, { editor: o, ErrorBoundary: r })] });
}
function Ld({ content: t }) {
  const [e] = Oe(), r = function(n) {
    ...
    return So(() => {
      ...
      return c(), Ve(n.registerUpdateListener(() => {
        c();
...
const Bd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : G;
function Fd({ onClear: t }) {
  const [e] = Oe();
  return Bd(() => vi(e, t), [e, t]), null;
}
const Ti = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : G;
function Ud({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: m, id: f, role: b = "textbox", spellCheck: R = !0, style: x, tabIndex: E, "data-testid": P, ...K }, C) {
  const [B, I] = _(t.isEditable()), k = V((U) => {
    U && U.ownerDocument && U.ownerDocument.defaultView ? t.setRootElement(U) : t.setRootElement(null);
  }, [t]), T = $(() => /* @__PURE__ */ function(...U) {
    return (L) => {
      for (const et of U) typeof et == "function" ? et(L) : et != null && (et.current = L);
    };
  }(C, k), [k, C]);
  return Ti(() => (I(t.isEditable()), t.registerEditableListener((U) => {
    I(U);
  })), [t]), a("div", { "aria-activedescendant": B ? e : void 0, "aria-autocomplete": B ? r : "none", "aria-controls": B ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": B && b === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": B ? p : void 0, "aria-readonly": !B || void 0, "aria-required": h, autoCapitalize: g, className: m, contentEditable: B, "data-testid": P, id: f, ref: T, role: b, spellCheck: R, style: x, tabIndex: E, ...K });
}
const Kd = Bn(Ud);
function dn(t) {
  return t.getEditorState().read(Ci(t.isComposing()));
...
function qd(t, e) {
  ...
  return u(ht, { children: [a(Kd, { editor: n, ...o, ref: e }), r != null && a(Gd, { editor: n, content: r })] });
}
function Gd({ content: t, editor: e }) {
  const r = function(s) {
    ...
    return Ti(() => {
      ...
      return d(), Ve(s.registerUpdateListener(() => {
        d();
...
function Qd() {
  const { activeEditor: t } = Ri(), [e, r] = _([]), o = V((n) => {
    if (Re(n) || ml(n)) {
      const i = [];
      wn.forEach(({ format: s }) => {
...
function Oi({
  ...
  return /* @__PURE__ */ u(lo, { children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
...
const ow = "verseText", Pp = Object.freeze([
...
function $p({
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ge, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(cr, { asChild: !0, children: /* @__PURE__ */ u(
        X,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ a(
        We,
        {
          ...
          children: /* @__PURE__ */ a(Ye, { children: /* @__PURE__ */ a(Xe, { children: t.map((b) => /* @__PURE__ */ a(
            Le,
            {
              onSelect: () => {
                l(b || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: Va(b, o) })
            },
            b || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : zo(b) && (b.preventDefault(), b.stopPropagation(), he(i) && g());
        },
        onKeyDown: (b) => {
          Ro(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          ca,
          {
...
function pn({
  ...
  const g = V(
    ...
    [t.user]
  ), x = $(() => vo(t.contents), [t.contents]), E = $(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), P = !!t.conflictResolutionAction && !E, K = $(() => {
    if (o && c)
      return /* @__PURE__ */ u(ht, { children: [
        /* @__PURE__ */ u(
          ir,
          {
            onClick: (C) => {
              C.stopPropagation(), d(!0), p(aw(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(lw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(dw, { className: "tw:text-xs tw:font-medium", children: R }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ u(Ir, { variant: "secondary", className: "tw:text-xs tw:font-normal", children: [
              "→ ",
              ta(t.assignedUser, r)
            ] })
          ] }),
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : zo(C) && (C.preventDefault(), C.stopPropagation(), he(w) && m());
              },
              onKeyDown: (C) => {
        ...
        K && /* @__PURE__ */ u(Ze, { children: [
          /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ds, {}) }) }),
  ...
  if (t)
    return /* @__PURE__ */ a(
      X,
      {
        ...
        "aria-label": o,
        children: /* @__PURE__ */ a(He, { className: "tw:h-4 tw:w-4" })
      }
    );
}
const hn = {
...
function Vi({
  ...
  const [L, et] = _(hn), [N, Q] = _(), [D, z] = _(), W = o, [it, ot] = _(!1), [ut, It] = _(!1), [Z, ct] = _(!1), [nt, gt] = _(!1), [vt, Mt] = _(!1), [Nt, Xt] = _(P), [fe, se] = _(!1), re = j(void 0), [Ot, le] = _(/* @__PURE__ */ new Map());
  G(() => {
    let O = !0;
    return (async () => {
      const kt = x ? await x(l) : !1;
      O && Mt(kt);
    })(), () => {
      O = !1;
    };
    ...
    let O = !0;
    if (!o) {
      gt(!1), le(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const kt = R ? await R(l) : !1;
      O && gt(kt);
    })(), () => {
      O = !1;
    };
  ...
  G(() => {
    if (!o) {
      ft.current !== "idle" && (Q(void 0), z(void 0), ft.current = "idle");
      return;
    }
    ft.current === "idle" && (ft.current = "pending"), nt ? ft.current === "pending" && B !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    B !== i && (Q(B), ft.current = "auto-populated") : ft.current === "auto-populated" && (Q(void 0), ft.current = "pending");
  }, [o, B, nt, i]);
  const Pt = $(
    () => I ?? e.filter((O) => !O.deleted),
    [I, e]
  );
  G(() => {
    let O = !0;
  ...
  const $t = $(() => Pt[0], [Pt]), At = j(null), de = j(void 0), yt = V(() => {
    var O;
    (O = de.current) == null || O.call(de), et(hn);
  }, []), ae = V(() => {
    const O = !Nt;
    Xt(O), se(!O), m == null || m(l, O);
  }, [Nt, m, l]);
  G(() => {
    ot(!1);
  }, [o]), G(() => {
    if (o && !Nt && !fe) {
      ...
      return re.current = O, () => clearTimeout(O);
    }
  ...
  }, [i, r]), qt = $(() => Pt.slice(1), [Pt]), bt = $(() => qt.length ?? 0, [qt.length]), Tt = $(() => bt > 0, [bt]), we = $(() => it || bt <= 2 ? qt : qt.slice(-2), [qt, bt, it]), Gt = $(() => it || bt <= 2 ? 0 : bt - 2, [bt, it]), ye = $(
    () => bt === 1 ? ce.singleReply : Ue(ce.multipleReplies, { count: bt }),
    [bt, ce]
  ), ke = $(
    () => Gt === 1 ? ce.singleReply : Ue(ce.multipleReplies, { count: Gt }),
    [Gt, ce]
  );
  G(() => {
    !o && ut && Tt && It(!1);
  ...
  const Zt = V(
    async (O) => {
      ...
      Ct && await p({ threadId: l, contents: Ct }) && yt();
    },
    [
      yt,
      L,
    ...
    async (O) => {
      const Ct = he(L) ? la(L) : void 0, kt = O.status ? O.assignedUser : N ?? O.assignedUser, Vt = await p({
        ...O,
        contents: Ct,
        assignedUser: kt
      });
      return Vt && (kt !== void 0 && z(kt), Ct && yt()), Vt;
    },
    [yt, L, p, N]
  );
  ...
  const Wt = /* @__PURE__ */ a(
    pn,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: ue,
      handleUpdateComment: h,
      handleDeleteComment: g,
      onEditingChange: It,
      canEditOrDelete: (!ut && Ot.get($t.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(cw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            M && /* @__PURE__ */ a(Ir, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: M }),
            /* @__PURE__ */ a(
              X,
              {
                variant: "ghost",
            ...
            T === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: vt && w !== "Resolved",
                  onClick: () => ue({ threadId: l, status: "Resolved" }),
            ...
            "p",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("span", { className: t, children: [
                  $t.contextBefore,
                  /* @__PURE__ */ a("span", { className: "tw:font-bold", children: $t.selectedText }),
                  $t.contextAfter
                ] })
              ]
            }
        ...
        /* @__PURE__ */ u(ht, { children: [
          Tt && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: ye })
          ] }),
          !o && he(L) && /* @__PURE__ */ a(
            ca,
            {
              editorSerializedState: L,
              onSerializedChange: (O) => et(O),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(ht, { children: [
            U && we.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Gt > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (O) => {
                  O.stopPropagation(), ot(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (O) => {
                  (O.key === "Enter" || O.key === " ") && (O.preventDefault(), O.stopPropagation(), ot(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Pr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: ke }),
                    it ? /* @__PURE__ */ a(Is, {}) : /* @__PURE__ */ a(vr, {})
                  ] })
                ]
              }
            ),
            we.map((O) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              pn,
              {
                comment: O,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: It,
                canEditOrDelete: (!ut && Ot.get(O.id)) ?? !1
              }
            ) }, O.id)),
            b !== !1 && (!ut || he(L)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (O) => {
                  zo(O) && (O.preventDefault(), O.stopPropagation(), (he(L) || N !== void 0 && N !== D) && Zt());
                },
                onKeyDown: (O) => {
                  Ro(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ca,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    N !== void 0 && (he(L) || N !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ue(
                    ...
                    /* @__PURE__ */ u(Ge, { open: Z, onOpenChange: ct, children: [
                      /* @__PURE__ */ a(cr, { asChild: !0, children: /* @__PURE__ */ a(
                        X,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !nt || !f || f.length === 0 || !f.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        We,
                        {
                          ...
                          align: "end",
                          onKeyDown: (O) => {
                            O.key === "Escape" && (O.stopPropagation(), ct(!1));
                          },
                          children: /* @__PURE__ */ a(Ye, { children: /* @__PURE__ */ a(Xe, { children: f == null ? void 0 : f.map((O) => /* @__PURE__ */ a(
                            Le,
                            {
                              onSelect: () => {
                                Q(O !== i ? O : void 0), ft.current = "user-selected", z(void 0), ct(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), uw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ea = (t) => uw(vo(t));
function ra({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function pw({
  ...
  const [s, c] = _("accept"), l = Bo(), d = Bo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", m = p ? "accept" : s, f = $(
    () => ea(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = $(
    () => ea(t.acceptedText ?? ""),
    ...
    () => ea(t.mergedText ?? ""),
    [t.mergedText]
  ), x = $(() => vo(t.contents), [t.contents]);
  if (!Pi(t))
    return /* @__PURE__ */ a(ra, { html: x });
  const E = (D) => {
  ...
  const T = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: T }), L = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : U, et = () => {
    const D = o ?? "accept";
    return D === "merged" ? t.mergedText ? /* @__PURE__ */ a(ra, { html: R }) : U : L(D === "reject" ? t.rejectedResultText : t.resultText);
  }, N = (D) => p && D.value === "reject", Q = (D) => {
    const z = m === D.value, W = `${d}-${D.value}`, it = N(D);
    return (
  ...
  return (
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", onClick: (D) => D.stopPropagation(), children: [
      ...
      w && /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2", "data-slot": "conflict-loading", children: [
        /* @__PURE__ */ a(hr, { className: "tw:h-8 tw:w-full" }),
        /* @__PURE__ */ a(hr, { className: "tw:h-8 tw:w-full" }),
        /* @__PURE__ */ a(hr, { className: "tw:h-8 tw:w-24" })
      ] }),
      !w && h && et(),
      !w && !h && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(
          co,
          {
            ...
            children: C.map((D) => N(D) ? /* @__PURE__ */ a(Bt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
              /* @__PURE__ */ a(Ut, { asChild: !0, children: Q(D) }),
              /* @__PURE__ */ a(Kt, { children: P })
            ] }) }, D.value) : Q(D))
          }
        ),
        /* @__PURE__ */ a(Bt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
    ...
    if (e === "Resolved") {
      for (let x = o.length - 1; x >= 0; x -= 1)
        if (o[x].status === "Resolved")
          return $i(o[x].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
  return { conflictOptions: i, isResolving: c, resolve: m, resolvedResolution: b, showResolveCheck: i !== "loading" && i !== "none" };
}
function vw(t) {
  const {
    comments: e,
...
function Hp({
  ...
  const [x, E] = _(/* @__PURE__ */ new Set()), [P, K] = _(), [C, B] = _(), I = V(
    async (z) => {
      const W = await i(z);
      return W !== void 0 && z.assignedUser !== void 0 && z.assignedUser !== "" && B(z.assignedUser), W;
    },
    [i]
  );
  G(() => {
    m && (E((z) => new Set(z).add(m)), K(m));
  }, [m]);
  const k = r.filter(
    (z) => z.comments.some((W) => !W.deleted)
  ), T = k.map((z) => ({ id: z.id })), U = V(
    (z) => {
      E((W) => new Set(W).add(z.id)), K(z.id), f == null || f(z.id);
    },
    [f]
  ), L = V(
    (z) => {
      ...
      }), K(z), f == null || f(W ? void 0 : z);
    },
    [x, f]
  ), { listboxRef: et, activeId: N, handleKeyDown: Q } = ns({
    options: T,
    onOptionSelect: U
  }), D = V(
    (z) => {
      z.key === "Escape" ? (P && x.has(P) && (E((W) => {
        const it = new Set(W);
        return it.delete(P), it;
      }), K(void 0), f == null || f(void 0)), z.preventDefault(), z.stopPropagation()) : Q(z);
    },
    [P, x, Q, f]
  );
  return /* @__PURE__ */ a(
      ...
      children: k.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(vw, { ...W, conflictResolution: R }) : /* @__PURE__ */ a(Vi, { ...W })
          },
          z.id
        );
      })
...
function bw({ table: t }) {
  return /* @__PURE__ */ u(Ze, { children: [
    /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ u(X, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Ps, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(Qe, { align: "end", className: "tw:w-[150px]", children: [
      /* @__PURE__ */ a(Vr, { children: "Toggle columns" }),
      /* @__PURE__ */ a(sr, {}),
...
function _r({ className: t, size: e = "default", children: r, ...o }) {
  const n = De();
  return /* @__PURE__ */ u(
    ee.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(ee.Icon, { asChild: !0, children: /* @__PURE__ */ a(Fn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ve({
  ...
  return /* @__PURE__ */ u(
    ee.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(ee.ItemIndicator, { children: /* @__PURE__ */ a(ga, { className: "tw:pointer-events-none" }) }) }),
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ u(
        yr,
        {
          ...
          children: [
            /* @__PURE__ */ a(_r, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(kr, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(Nr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ve, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Nw({
  ...
  var C;
  const [w, p] = _([]), [h, g] = _([]), [m, f] = _({}), [b, R] = _({}), x = $(() => e ?? [], [e]), E = ri({
    data: x,
    columns: t,
    getCoreRowModel: oi(),
  ...
  let K;
  return l ? K = Array.from({ length: 10 }).map((k, T) => `skeleton-row-${T}`).map((k) => /* @__PURE__ */ a(Fe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(gr, { colSpan: P.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(hr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, k)) : ((C = E.getRowModel().rows) == null ? void 0 : C.length) > 0 ? K = E.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    Fe,
    {
      onClick: () => s(B, E),
      "data-state": B.getIsSelected() && "selected",
      children: B.getVisibleCells().map((I) => /* @__PURE__ */ a(gr, { children: Dr(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    B.id
  )) : K = /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(gr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(bw, { table: E }),
    /* @__PURE__ */ u(uo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(po, { stickyHeader: i, children: E.getHeaderGroups().map((B) => /* @__PURE__ */ a(Fe, { children: B.headers.map((I) => /* @__PURE__ */ a(oa, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : Dr(I.column.columnDef.header, I.getContext()) }, I.id)) }, B.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(X, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(In, {}) })
        ] }),
...
function Xp({
  ...
  return /* @__PURE__ */ u(Ge, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(cr, { asChild: !0, children: o }),
    /* @__PURE__ */ u(We, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Zp({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ze, { children: [
    /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ u(X, { variant: "default", children: [
      /* @__PURE__ */ a(js, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(vr, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Qe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Vr, { children: d.label }),
      /* @__PURE__ */ a(En, { children: d.itemType === 0 ? /* @__PURE__ */ a(ht, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ke,
        {
          checked: o[w][h],
        ...
        is,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(ss, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(sr, {})
    ] }, d.label)) })
...
function Qp({
  ...
  const s = $(() => ic(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(sc(), { type: "language" });
...
function th({
  ...
  return /* @__PURE__ */ u("div", { id: p, className: "tw:flex tw:items-center tw:gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:items-center tw:gap-2", children: e.map((h) => {
      var g;
      return /* @__PURE__ */ u(Ir, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          X,
          {
            variant: "ghost",
...
function Mw({
  ...
  return /* @__PURE__ */ u(lo, { children: [
    ...
    e && /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(
        X,
        {
          "aria-label": w,
...
const Iw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ht, { children: [
...
function Pw({
  ...
  const n = j(null), i = j(null), s = j(!1), [c, l] = _(t), [d, w] = _(e), [p, h] = _(!1), g = j(!1), m = j(c);
  m.current = c;
  const f = j(d);
  f.current = d, G(() => {
    l(t);
  ...
  const b = (x) => {
    if (s.current = !1, h(x), !x) {
      const E = m.current, P = f.current;
      E !== "custom" || P ? (E !== t || P !== e) && r(E, P) : (l(t), w(e));
    }
  }, R = (x) => {
    var E, P, K, C;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((E = n.current) == null || E.focus(), s.current = !0) : document.activeElement === n.current && x.key === "ArrowUp" ? ((P = i.current) == null || P.focus(), s.current = !1) : document.activeElement === n.current && x.key === "ArrowLeft" && ((K = n.current) == null ? void 0 : K.selectionStart) === 0 && ((C = i.current) == null || C.focus(), s.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === n.current) && b(!1);
  };
  return /* @__PURE__ */ u(Ze, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: Iw(t, o, e) }) }) }),
    ...
    /* @__PURE__ */ u(
      Qe,
      {
        ...
        children: [
          /* @__PURE__ */ a(Vr, { children: o["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(sr, {}),
          /* @__PURE__ */ a(
            Ke,
            {
          ...
          /* @__PURE__ */ a(
            Ke,
            {
              ...
              onClick: (x) => {
                var E;
                if (x.stopPropagation(), g.current && x.target !== n.current) {
                  b(!1);
                  return;
                }
                s.current = !0, (E = n.current) == null || E.focus();
              },
...
const $w = (t, e) => t === "f" ? /* @__PURE__ */ u(ht, { children: [
  /* @__PURE__ */ a($n, {}),
  " ",
...
function Vw({
  ...
  return /* @__PURE__ */ u(Ze, { children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: $w(t, r) }) }) }),
      /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ a("p", { children: Aw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Qe, { style: { zIndex: Tn }, children: [
      /* @__PURE__ */ a(Vr, { children: r["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ a(sr, {}),
      /* @__PURE__ */ u(
        Ke,
        {
...
function jw({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? qs, { className: e, size: 16 });
}
function Bw({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: t !== "none" && /* @__PURE__ */ a(He, { size: 16 })
    }
  );
}
function mn({
...
function Fw({
  ...
  return /* @__PURE__ */ u(Ye, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Xe, { children: [
      ...
      /* @__PURE__ */ a(Ae, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          mn,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(Ae, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            mn,
            {
...
function Uw(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, s]) => {
    i.push(
      ...s.map((c) => ({
        marker: c,
        title: r[Zr[c].description] ?? Zr[c].description,
        action: () => {
          var l;
...
function eh({
  ...
  var ar;
  const f = j(null), b = j(null), R = j(null), x = j(null), E = j(i);
  G(() => {
    E.current = i;
  }, [i]);
  const P = j(h);
  ...
  const K = V(() => {
    var F, Y;
    const S = P.current;
    S !== void 0 && S !== "end" ? (F = f.current) == null || F.selectNoteTextOffset(0, S.utf16Offset) : (Y = f.current) == null || Y.selectNote(0);
  }, []);
  te(() => {
  ...
  const [C, B] = _("generated"), [I, k] = _("generated"), [T, U] = _("*"), [L, et] = _("*"), [N, Q] = _("f"), [D, z] = _(!1), [W, it] = _(!0), [ot, ut] = _(!1), It = j(!1), Z = j(""), ct = j(void 0), [nt, gt] = _(!1), [vt, Mt] = _(), [Nt, Xt] = _(), [fe, se] = _(), [re, Ot] = _(), le = j(null), ft = j(
    void 0
  ), Pt = j(0), $t = j(void 0), At = $(
    () => ({
      ...s,
  ...
  const yt = V(() => {
    var H, J, q;
    const S = (H = b.current) == null ? void 0 : H.querySelector(".editor-input"), F = S == null ? void 0 : S.querySelector("span.note"), Y = (q = (J = b.current) == null ? void 0 : J.ownerDocument.getSelection()) == null ? void 0 : q.anchorNode;
    return !!F && !!Y && F.contains(Y);
  }, []), ae = V(
    (S = !1) => {
      var Y, H, J;
      m == null || m();
      const F = (H = (Y = f.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (F && Tr("note", F) && (r == null || r([F]), S && d && E.current)) {
        if (w && Ln(F, ct.current)) return;
        ct.current = F, (J = d.current) == null || J.replaceEmbedUpdate(E.current, [F]);
      }
    },
    [w, r, m, d]
  ), ce = V(
    (S, F) => {
      var J, q, st;
      const Y = (q = (J = f.current) == null ? void 0 : J.getNoteOps(0)) == null ? void 0 : q.at(0);
      if (!Y || !Tr("note", Y) || !Y.insert.note) return;
      let H;
      S === "custom" ? H = F : S === "generated" ? H = Ja : H = Qa, Y.insert.note.caller !== H && (Y.insert.note.caller = H, (st = f.current) == null || st.applyUpdate([Y, { delete: 1 }]));
    },
    []
  ), M = j(void 0), qt = j(ae);
  G(() => {
  ...
  const bt = V(() => {
    M.current !== void 0 && (clearTimeout(M.current), M.current = void 0);
  }, []), Tt = V(() => {
    M.current !== void 0 && (bt(), qt.current(!0));
  }, [bt]), we = V(() => {
    bt(), M.current = setTimeout(() => {
      M.current = void 0, qt.current(!0);
    }, Gw);
  }, [bt]);
  G(() => {
    var J, q;
    let S, F, Y;
    It.current = !1, $t.current = void 0, it(!0);
    const H = e == null ? void 0 : e.at(0);
    if (ct.current = H, H && Tr("note", H)) {
      const st = (J = H.insert.note) == null ? void 0 : J.caller;
      let pt = "custom";
      st === Ja ? pt = "generated" : st === Qa ? pt = "hidden" : st && (U(st), et(st)), B(pt), k(pt), Q(((q = H.insert.note) == null ? void 0 : q.style) ?? "f"), S = setTimeout(() => {
        var _t, St, Rt, pe;
        const mt = (St = (_t = f.current) == null ? void 0 : _t.getNoteOps(0)) == null ? void 0 : St.at(0);
        (Rt = f.current) == null || Rt.applyUpdate(mt ? [H, { delete: 1 }] : [H]), K(), (pe = f.current) == null || pe.focus(), F = requestAnimationFrame(() => {
          Y = setTimeout(() => {
            var Ne;
            yt() || (K(), (Ne = f.current) == null || Ne.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      Tt(), S && clearTimeout(S), F !== void 0 && cancelAnimationFrame(F), Y !== void 0 && clearTimeout(Y);
    };
  }, [e, Tt, yt, K]), te(() => () => Tt(), [Tt]), jn(p, () => ({ flushPendingEdits: Tt }), [Tt]);
  const Gt = V(() => {
    var S;
    ft.current || (S = f.current) == null || S.commitPendingMarkerEdits(), w ? Tt() : (bt(), ae(!0)), o();
  }, [bt, Tt, w, o, ae]), ye = j(Gt);
  te(() => {
    ye.current = Gt;
  });
  const ke = j({ book: n.book, chapterNum: n.chapterNum });
  te(() => {
    (ke.current.book !== n.book || ke.current.chapterNum !== n.chapterNum) && (ke.current = { book: n.book, chapterNum: n.chapterNum }, ye.current());
  }, [n.book, n.chapterNum]);
  const Zt = () => {
    var F;
    const S = (F = b.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    S != null && S.textContent && navigator.clipboard.writeText(S.textContent);
  }, ue = V(
    (S, F) => {
      m == null || m(), B(S), U(F), ce(S, F), w && Tt();
    },
    [ce, Tt, w, m]
  ), Wt = (S) => {
    var Y, H, J, q, st;
    ...
    if (F && Tr("note", F)) {
      ...
      const pt = (q = (J = F.insert.note) == null ? void 0 : J.contents) == null ? void 0 : q.ops;
      N !== "x" && S === "x" ? pt == null || pt.forEach((mt) => Hw(mt)) : N === "x" && S !== "x" && (pt == null || pt.forEach((mt) => qw(mt))), (st = f.current) == null || st.applyUpdate([F, { delete: 1 }]);
    }
  }, O = (S) => {
    Ot(S.contextMarker), ut(S.canRedo);
  }, Ct = V(
    (S) => {
      var Y, H, J, q, st;
      const F = (H = (Y = f.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (F && Tr("note", F)) {
        S.content.length > 1 && setTimeout(() => {
          var _t;
          (_t = f.current) == null || _t.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const pt = (J = F.insert.note) == null ? void 0 : J.style, mt = (st = (q = F.insert.note) == null ? void 0 : q.contents) == null ? void 0 : st.ops;
        if (pt || z(!1), z(
          pt === "x" ? !!(mt != null && mt.every((_t) => {
            var Rt, pe;
            if (!((Rt = _t.attributes) != null && Rt.char)) return !0;
            const St = ((pe = _t.attributes) == null ? void 0 : pe.char).style;
          ...
          It.current = !0, Z.current = JSON.stringify(F), it(!0);
          return;
        }
        it(JSON.stringify(F) === Z.current), ae(), w && we();
      } else
        z(!1), it(!0);
    },
    [w, ae, we]
    ...
    if (R.current && de.length && S && S.rangeCount > 0) {
      const F = S.getRangeAt(0).getBoundingClientRect(), Y = R.current.getBoundingClientRect();
      Mt(F.left - Y.left), Xt(F.top - Y.top), se(F.height), gt(!0);
    }
  }, [de, R]), Vt = j(() => {
  }), _e = V(
    (S, F, Y) => {
      ...
      ws({
        ...
        clearSessionIfCurrent: (q) => Mo(ft, q),
        ...
        restoreSelectionIfLost: () => {
          ...
          if (!((q = f.current) != null && q.getSelection())) {
            const mt = $t.current;
            mt ? (st = f.current) == null || st.setSelection(mt) : (pt = f.current) == null || pt.selectNote(0);
          }
        },
        focusEditor: () => {
          var q;
        ...
        applyItem: (q) => {
          var st;
          return (st = f.current) == null ? void 0 : st.applyMarkerMenuSelection(q, {
            trigger: "backslash",
    ...
    var Y;
    const S = (Y = f.current) == null ? void 0 : Y.getMarkerMenuContext();
    if (!S) return !1;
    const F = El(At.styleInfo ?? Tl, S);
    return F.length === 0 ? !1 : (_e(S, F, { passive: !S.hasTextSelection }), !0);
  }, [_e, At.styleInfo]), er = V(
    (S) => {
      const F = ft.current;
      if (!F || !g) return;
      us(S, F, {
        ...
        commitTyped: (H) => {
          var J;
          return (J = f.current) == null ? void 0 : J.commitTypedMarker(H);
        },
        commitTypedAndReopen: (H) => {
          var J;
          (J = f.current) == null || J.commitTypedMarker(H, { trailingSpace: !1 }), me();
        },
        commitTypedCloser: (H) => {
          var J;
          return (J = f.current) == null ? void 0 : J.commitTypedCloser(H);
        },
        commitItem: (H) => {
          var q;
          const J = F.items.find((st) => st.marker === H);
          J && ((q = f.current) == null || q.applyMarkerMenuSelection(J, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  G(() => {
    ...
    const S = (F) => {
      var J, q;
      const Y = (J = b.current) == null ? void 0 : J.querySelector(".editor-input");
      if (!Y || F.target !== Y) return;
      const H = (q = f.current) == null ? void 0 : q.getSelection();
      H && ($t.current = H);
    };
    ...
    var S;
    nt && ((S = le.current) == null || S.focus());
  }, [nt]), G(() => {
    var Y;
    const S = () => {
      var H;
      return ((H = b.current) == null ? void 0 : H.querySelector(".editor-input")) ?? void 0;
    };
    if (((Y = At.view) == null ? void 0 : Y.markerMode) === "editable") {
      const H = (q) => {
        var mt, _t, St, Rt;
        if (hs(q)) return;
        const st = S();
        if (!st || document.activeElement !== st) return;
        if (ft.current && g) {
          Vt.current(q);
          return;
        }
        if (q.key === "Enter" && !yt()) {
          q.preventDefault(), q.stopPropagation(), (mt = f.current) == null || mt.selectNote(0), (_t = f.current) == null || _t.focus();
          return;
        }
        if (g && q.key === c) {
          if (!yt()) {
            q.preventDefault(), q.stopPropagation(), (St = f.current) == null || St.selectNote(0), (Rt = f.current) == null || Rt.focus();
            return;
          }
          me() && (q.preventDefault(), q.stopPropagation());
        }
      }, J = () => {
        var st, pt;
        const q = S();
        !q || document.activeElement !== q || yt() || ((st = f.current) == null || st.selectNote(0), (pt = f.current) == null || pt.focus());
      };
      return document.addEventListener("keydown", H, { capture: !0 }), document.addEventListener("paste", J, { capture: !0 }), () => {
        document.removeEventListener("keydown", H, { capture: !0 }), document.removeEventListener("paste", J, { capture: !0 });
      };
    }
    const F = (H) => {
      const J = S();
      !nt && J && document.activeElement === J && H.key === c ? (H.preventDefault(), kt()) : nt && H.key === "Escape" && (H.preventDefault(), gt(!1));
    };
    ...
    kt,
    c,
    (ar = At.view) == null ? void 0 : ar.markerMode,
    At.styleInfo,
    g,
    me,
    yt
    ...
    const S = () => {
      var H, J, q;
      const F = ((H = b.current) == null ? void 0 : H.querySelector(".editor-input")) ?? void 0;
      if (!F || document.activeElement !== F) return;
      const Y = document.getSelection();
      Y && !Y.isCollapsed || yt() || ((J = f.current) == null || J.selectNote(0), (q = f.current) == null || q.focus());
    };
  ...
  const rr = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(ht, { children: [
    /* @__PURE__ */ u(
      "div",
      {
        ref: x,
        className: v("footnote-editor tw:grid tw:gap-[12px]", w && "tw:w-full"),
        children: [
          ...
          /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
                  /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(
                    X,
                    {
                      "aria-label": rr,
                  ...
                  /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ a("p", { children: rr }) })
                ] }) }) })
              ]
            }
          )
    ...
    /* @__PURE__ */ u(Ge, { open: nt, children: [
      /* @__PURE__ */ a(
        ps,
        {
          className: "tw:absolute",
...
function Zw(t, e, r = !0, o = void 0, n = void 0) {
  const i = [];
  let s = [];
  (e ?? []).forEach((l) => {
...
function Jw(t, e, r, o = !1) {
  const { marker: n } = t, i = `${o ? "+" : ""}${n}`;
  return /* @__PURE__ */ u("span", { children: [
    n ? r && /* @__PURE__ */ a("span", { className: "marker", children: `\\${i}${Li}` }) : /* @__PURE__ */ a(
      Wa,
      {
    ...
    ji(n, t.content, r, !0, !0),
    n && r && Xw(t) && /* @__PURE__ */ a("span", { className: "marker", children: `\\${i}*` })
  ] }, e);
}
function Qw({
  footnote: t,
  ...
  const n = r ? r(t.caller) : t.caller, i = n !== t.caller, s = o ? /* @__PURE__ */ a("span", { className: "marker", children: `\\${t.marker}` }) : void 0, c = o ? /* @__PURE__ */ a("span", { className: "marker", children: `\\${t.marker}*` }) : void 0, l = t.category ? (
    ...
    /* @__PURE__ */ u("span", { className: "note-category", children: [
      o && /* @__PURE__ */ a("span", { className: "marker", children: `\\cat${Li}` }),
      t.category,
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: i }), children: n }), w = e === "horizontal" ? "horizontal" : "vertical", p = o ? "marker-visible" : "", h = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", g = v(w, p);
  return /* @__PURE__ */ u(ht, { children: [
    /* @__PURE__ */ u("div", { className: v("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", g), children: [
      s,
      !!s && !!d && " ",
      d
    ] }),
...
function ah({
  ...
  const m = d ?? wc(r, void 0), f = g ? h : void 0, b = j([]), R = (k, T, U) => {
    if (p) {
      const L = b.current[T], et = L ? zw(U.clientX, U.clientY, L) : "end";
      p(k, T, n, et);
      return;
    }
    w == null || w(k, T, n);
  }, x = i ? r.findIndex((k) => k === i) : -1, [E, P] = _(x), K = (k, T, U) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
    ...
    if (r.length && !(f !== void 0 && k.target instanceof HTMLElement && k.target.closest('li[data-state="editing"]')))
      switch (k.key) {
        case "ArrowDown":
          k.preventDefault(), P((T) => Wr(T, 1, C, f));
          break;
        case "ArrowUp":
          k.preventDefault(), P((T) => Wr(T, -1, C, f));
          break;
  ...
  G(() => {
    ...
    var k;
    E >= 0 && E < b.current.length && ((k = b.current[E]) == null || k.focus());
  }, [E]);
  const I = i ? r.findIndex((k) => k === i) : -1;
  return G(() => {
    var k;
    I < 0 || I >= b.current.length || (k = b.current[I]) == null || k.scrollIntoView({ block: "nearest" });
  }, [I, s]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
      ...
      children: /* @__PURE__ */ a(
        "ul",
        {
          ...
          children: r.map((k, T) => {
            const U = k === i, L = `${n}-${T}`, et = T === h && !!g, N = T < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Pr, { tabIndex: -1, className: "tw:col-span-2" });
            return et ? /* @__PURE__ */ u(br, { children: [
              /* @__PURE__ */ a(
                "li",
                {
                  "data-state": "editing",
...
function eu({
  ...
  return /* @__PURE__ */ u(uo, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(po, { stickyHeader: !0, children: /* @__PURE__ */ u(Fe, { children: [
      /* @__PURE__ */ a(oa, { children: n }),
      /* @__PURE__ */ a(oa, { children: i })
    ] }) }),
    /* @__PURE__ */ a(ho, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Fe,
      {
        ...
        children: [
          /* @__PURE__ */ a(gr, { children: Pe(c.reference, "English") }),
          /* @__PURE__ */ a(gr, { className: o, children: tu(c.text) })
        ]
      },
...
const ru = (t) => {
...
}, va = (t, e, r) => /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
  /* @__PURE__ */ u(
    Ut,
    {
  ...
  return e ? e[1] : "";
}, ou = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", dh = Object.freeze([
...
function wh({
  ...
  const g = Ee(r, "%webView_inventory_all%"), m = Ee(r, "%webView_inventory_approved%"), f = Ee(r, "%webView_inventory_unapproved%"), b = Ee(r, "%webView_inventory_unknown%"), R = Ee(r, "%webView_inventory_scope_currentBook%"), x = Ee(r, "%webView_inventory_scope_chapter%"), E = Ee(r, "%webView_inventory_scope_verse%"), P = Ee(r, "%webView_inventory_filter_text%"), K = Ee(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = Ee(r, "%webView_inventory_no_results%"), [B, I] = _(!1), [k, T] = _("all"), [U, L] = _(""), [et, N] = _([]), Q = $(() => {
    const Z = t ?? [];
    return Z.length === 0 ? [] : iu(Z, n, i);
  }, [t, n, i]), D = $(() => {
    if (B) return Q;
    const Z = [];
    return Q.forEach((ct) => {
      const nt = ct.items[0], gt = Z.find(
        (vt) => vt.items[0] === nt
      );
      gt ? (gt.count += ct.count, gt.occurrences = gt.occurrences.concat(ct.occurrences)) : Z.push({
        items: [nt],
        count: ct.count,
  ...
  }, [B, Q]), z = $(() => D.length === 0 ? [] : nu(D, k, U), [D, k, U]), W = $(() => {
    var nt, gt;
    if (!B) return l;
    const Z = (nt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : nt.length;
    if (!Z) return l;
    const ct = [];
    for (let vt = 0; vt < Z; vt++)
      ct.push(
        au(
          ((gt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : gt[vt]) || "Additional Item",
          vt + 1
        )
      );
    return [...ct, ...l];
  ...
  G(() => {
    z.length === 0 ? N([]) : z.length === 1 && N(z[0].items);
  }, [z]);
  const it = (Z, ct) => {
    ct.setRowSelection(() => {
      const gt = {};
      return gt[Z.index] = !0, gt;
    });
    const nt = Z.original.items;
    N(nt), h && nt.length > 0 && h(nt[0]);
  }, ot = (Z) => {
    ...
    if (D.length === 0 || et.length === 0) return [];
    const Z = D.filter((ct) => Ln(
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        yr,
        {
          onValueChange: (Z) => ut(Z),
          defaultValue: k,
          children: [
            /* @__PURE__ */ a(_r, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(kr, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(Nr, { children: [
              /* @__PURE__ */ a(ve, { value: "all", children: g }),
              /* @__PURE__ */ a(ve, { value: "approved", children: m }),
              /* @__PURE__ */ a(ve, { value: "unapproved", children: f }),
              /* @__PURE__ */ a(ve, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(yr, { onValueChange: (Z) => ot(Z), defaultValue: s, children: [
        /* @__PURE__ */ a(_r, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(kr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(Nr, { children: [
          /* @__PURE__ */ a(ve, { value: "book", children: R }),
      ...
      o && /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
        ...
        /* @__PURE__ */ a(Kt, { children: (o == null ? void 0 : o.checkboxText) ?? K })
      ] }) })
    ] }),
...
const su = "16rem", cu = "3rem", Fi = ne.createContext(void 0);
function ba() {
  const t = ne.useContext(Fi);
  if (!t)
...
function lu({
  ...
  const [l, d] = ne.useState(t), w = e ?? l, p = ne.useCallback(
    (E) => {
      const P = typeof E == "function" ? E(w) : E;
      r ? r(P) : d(P);
    },
    [r, w]
  ), h = ne.useCallback(() => p((E) => !E), [p]), g = w ? "expanded" : "collapsed", b = De() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = ne.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Fi.Provider, { value: R, children: /* @__PURE__ */ a(
    "div",
    {
...
function uh({ className: t, onClick: e, ...r }) {
...
function fu({
  ...
  const c = t ? Fr.Root : "button", { state: l } = ba(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(gu({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ u(Ft, { children: [
    /* @__PURE__ */ a(Ut, { asChild: !0, children: d }),
    /* @__PURE__ */ a(
      Kt,
      {
        side: "right",
...
function yh({
  ...
  const [o] = ne.useState(() => `${Math.floor(Math.random() * 40) + 50}%`), n = { "--skeleton-width": o };
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      ...r,
      children: [
        e && /* @__PURE__ */ a(hr, { className: "tw:size-4 tw:rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ a(
          hr,
          {
...
function mu({
  ...
  return /* @__PURE__ */ a(
    du,
    {
      ...
      children: /* @__PURE__ */ u(uu, { children: [
        /* @__PURE__ */ u(vn, { children: [
          /* @__PURE__ */ a(bn, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(xn, { children: /* @__PURE__ */ a(pu, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(hu, { children: /* @__PURE__ */ a(
            fu,
            {
              onClick: () => d(g),
              isActive: h(g),
        ...
        /* @__PURE__ */ u(vn, { children: [
          ...
          /* @__PURE__ */ a(xn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(Js, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  gs,
                  {
                    mode: "project",
    ...
    /* @__PURE__ */ u(
      lu,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(wu, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Be = "scrBook", vu = "scrRef", nr = "source", bu = "details", xu = "Scripture Reference", yu = "Scripture Book", Ui = "Type", ku = "Details";
function _u(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Be,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? xu,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? jt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Be ? Pe(n.start) : void 0;
      },
    ...
    },
    {
      ...
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? void 0 : Pe(n.start);
      },
      sortingFn: (o, n) => Ya(o.original.start, n.original.start),
      enableGrouping: !1
    },
    {
      ...
      id: nr,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? Ui : void 0,
    ...
    },
    {
      ...
      id: bu,
      header: (t == null ? void 0 : t.detailsColumnName) ?? ku,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, yn = (t) => `${Nu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Eh({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Be, desc: !1 }]), [g, m] = _({}), f = $(
  ...
  G(() => {
    if (c) {
      const k = R.getSelectedRowModel().rowsById, T = Object.keys(k);
      if (T.length === 1) {
        const U = f.find((L) => yn(L) === T[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, f, c, R]);
  const x = n ?? yu, E = i ?? Ui, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [Be] },
    { label: `Group by ${E}`, value: [nr] },
    {
      label: `Group by ${x} and ${E}`,
      value: [Be, nr]
    },
    {
      label: `Group by ${E} and ${x}`,
      value: [nr, Be]
    }
  ], K = (k) => {
    w(JSON.parse(k));
  ...
  }, B = (k, T) => k.getIsGrouped() ? "" : v("banded-row", T % 2 === 0 ? "even" : "odd"), I = (k, T, U) => {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      yr,
      {
        ...
        children: [
          /* @__PURE__ */ a(_r, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(kr, {}) }),
          /* @__PURE__ */ a(Nr, { position: "item-aligned", children: /* @__PURE__ */ a(xw, { children: P.map((k) => /* @__PURE__ */ a(ve, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: R.getHeaderGroups().map((k) => /* @__PURE__ */ a(Fe, { children: k.headers.filter((T) => T.column.columnDef.header).map((T) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(oa, { colSpan: T.colSpan, className: "tw:sticky top-0", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Dr(T.column.columnDef.header, T.getContext())
        ] }) }, T.id)
      )) }, k.id)) }),
      /* @__PURE__ */ a(ho, { children: R.getRowModel().rows.map((k, T) => {
        const U = De();
        return /* @__PURE__ */ a(
          Fe,
          {
            ...
            children: k.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== nr || !r)))
                return /* @__PURE__ */ a(
                  gr,
                  {
                    className: v(
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ a(vr, {}),
                          !k.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ a(Ga, {}) : /* @__PURE__ */ a(qa, {})),
                          " ",
                          Dr(L.column.columnDef.cell, L.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
function Cu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: m, extraLong: f } = {
  ...
  }, [b, R] = _(!1), [x, E] = _(""), P = j(void 0), K = j(!1), C = $(
    () => zn(t),
    [t]
  ), B = $(() => {
    if (!x.trim()) {
    ...
    (N, Q = !1) => {
      if (!Q || !P.current) {
        r(
          e.includes(N) ? e.filter((ut) => ut !== N) : [...e, N]
        ), P.current = N;
        return;
      }
      const D = C.findIndex((ut) => ut === P.current), z = C.findIndex((ut) => ut === N);
      if (D === -1 || z === -1) return;
      const [W, it] = [
        Math.min(D, z),
        Math.max(D, z)
      ], ot = C.slice(W, it + 1).map((ut) => ut);
      r(
        e.includes(N) ? e.filter((ut) => !ot.includes(ut)) : [.../* @__PURE__ */ new Set([...e, ...ot])]
      );
    },
    [e, r, C]
  ), k = (N) => {
    ...
    N.preventDefault(), I(Q, N.shiftKey);
  }, U = () => {
    r(C.map((N) => N));
  }, L = () => {
    r([]);
    ...
    () => Object.values(zt).filter(
      (N) => (i == null ? void 0 : i[N]) !== void 0 && go(C, N).length === 0
        ...
        /* @__PURE__ */ a(cr, { asChild: !0, children: /* @__PURE__ */ u(
          X,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a(Qs, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
              ...
              Ye,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(X, { variant: "ghost", size: "sm", onClick: L, children: w })
                  ] }),
                  /* @__PURE__ */ u(Xe, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(ua, { children: p }),
                    Object.values(zt).filter((N) => B[N].length > 0).map((N, Q) => {
                      const D = B[N];
                      return /* @__PURE__ */ u(br, { children: [
                        Q > 0 && /* @__PURE__ */ a(Sn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Ae,
                          {
                            heading: _n(N, h, g, m, f),
                            children: D.map((z) => /* @__PURE__ */ a(
                              ii,
                              {
                                bookId: z,
                  ...
                  et.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: et.map(({ section: N, explanation: Q }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: Q }, N)) })
                ]
              }
            )
          }
...
function Tu({
  ...
  return /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ft, { children: [
    /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(
      Eu,
      {
        className: o,
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ja ? ja : kn
      ).map((d) => /* @__PURE__ */ a(Ir, { className: "tw:hover:bg-secondary", variant: "secondary", children: Te(d, n) }, d)),
...
function Sh({
  ...
  const K = Lt(
    s,
    "%webView_scope_selector_selected_text%"
  ), C = Lt(s, "%webView_scope_selector_verse%"), B = Lt(s, "%webView_scope_selector_chapter%"), I = Lt(s, "%webView_scope_selector_book%"), k = Lt(
    s,
    "%webView_scope_selector_current_verse%"
  ), T = Lt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), U = Lt(s, "%webView_scope_selector_current_book%"), L = Lt(s, "%webView_scope_selector_choose_books%"), et = Lt(s, "%webView_scope_selector_scope%"), N = Lt(s, "%webView_scope_selector_select_books%"), Q = Lt(s, "%webView_scope_selector_range%"), D = Lt(s, "%webView_scope_selector_select_range%"), z = Lt(s, "%webView_scope_selector_range_start%"), W = Lt(s, "%webView_scope_selector_range_end%"), it = Lt(s, "%webView_scope_selector_ok%"), ot = Lt(s, "%webView_scope_selector_cancel%"), ut = Lt(s, "%webView_scope_selector_navigate%"), It = (A) => {
    if (!f) return;
  ...
  ], ct = (A, tt, dt = !1) => /* @__PURE__ */ u(ht, { children: [
    A,
    tt && !dt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), nt = e ? Z.filter((A) => e.includes(A.value)) : Z, gt = f ?? Sa, vt = p ?? gt, Mt = h ?? gt, Nt = () => {
  }, Xt = j(null), fe = j(null), se = j(!1), re = j(null), Ot = j(!1), [le, ft] = _(void 0), Pt = j(!1), $t = j(!1), At = j(null), de = V((A) => {
    if (A) {
      ft("start"), Pt.current = !1;
      return;
    }
    ft((tt) => tt === "start" ? void 0 : tt), Pt.current && (Pt.current = !1, requestAnimationFrame(() => {
      var dt;
      const tt = (dt = Xt.current) == null ? void 0 : dt.querySelector("button");
      tt == null || tt.click();
    }));
  }, []), yt = V((A) => {
    if (A) {
    ...
    ft((tt) => tt === "end" ? void 0 : tt);
  }, []), ae = V(
    (A) => {
      g == null || g(A), m == null || m(A), Pt.current = !0;
    },
    [g, m]
  ), ce = V(
    (A) => {
      m == null || m(A), $t.current = !0;
    },
    [m]
  ), M = V(
    (A) => {
    ...
    [r, n, f, i]
  ), qt = nt.find((A) => A.value === t), bt = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? uc(vt, Mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : qt ? ct(qt.label, qt.scrRefSuffix) : t, Tt = nt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), we = nt.find((A) => A.value === "selectedBooks"), Gt = nt.find((A) => A.value === "range"), [ye, ke] = _(!1), [Zt, ue] = _(void 0), [Wt, O] = _(void 0), [Ct, kt] = _(void 0), [Vt, _e] = _(void 0), [me, er] = _([]), rr = w === "dropdown" && Zt === "selectedBooks", ar = /* @__PURE__ */ a(
    Ru,
    {
      availableBookInfo: o,
      selectedBookIds: rr ? me : n,
      onChangeSelectedBookIds: rr ? er : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), S = le === "end", F = le === "start", Y = "tw:text-muted-foreground", H = w === "dropdown" && Zt === "range", J = H ? kt : ae, st = H ? _e : m ? ce : Nt, pt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Dt, { htmlFor: "scope-range-start", className: v(S && Y), children: z }),
      /* @__PURE__ */ a(
        za,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Xt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Dt, { htmlFor: "scope-range-end", className: v(F && Y), children: W }),
      /* @__PURE__ */ a(
        za,
        {
          id: "scope-range-end",
          ...
          localizedStrings: R,
          getEndVerse: x,
          disableReferencesUpTo: H ? Ct ?? vt : vt,
          onOpenChange: yt,
          onCloseAutoFocus: (A) => {
            var tt;
            $t.current && ($t.current = !1, A.preventDefault(), (tt = At.current) == null || tt.focus());
          },
          className: v(F && Y),
          modal: !0,
          align: "start"
  ...
  G(() => {
    ...
    const tt = requestAnimationFrame(() => {
      A = requestAnimationFrame(() => {
        var dt;
        (dt = mt.current[t]) == null || dt.focus();
      });
    });
    return () => {
      cancelAnimationFrame(tt), A && cancelAnimationFrame(A);
    };
  }, [ye, t]);
  const [Rt, pe] = _(null), [Ne, xa] = _(null), [wr, ya] = _(null), ka = 200, [_a, Na] = _(!1);
  G(() => {
    if (!wr || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([tt]) => {
      Na(tt.contentRect.width < ka);
    });
    return A.observe(wr), () => A.disconnect();
  }, [wr]);
  const y = V(
    (A) => {
      O(A), kt(vt), _e(Mt), er(n), ke(!1), ue(A);
    },
    [vt, Mt, n]
  ), rt = V(() => {
    Wt !== void 0 && (Wt === "range" ? (Ct && (g == null || g(Ct)), Vt && (m == null || m(Vt))) : Wt === "selectedBooks" && i(me), M(Wt), ue(void 0), O(void 0));
  }, [
    Wt,
    Ct,
    Vt,
    ...
    A || (ue(void 0), O(void 0));
  }, []), oe = V((A) => {
    var tt;
    A.preventDefault(), (tt = St.current) == null || tt.focus();
  }, []), Ie = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(He, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(Dt, { children: et }),
      w === "dropdown" ? /* @__PURE__ */ u(Ze, { open: ye, onOpenChange: ke, children: [
        ...
        /* @__PURE__ */ a(
          Qe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Ca, { container: wr, children: [
              Tt.map(({ value: A, label: tt, dropdownLabel: dt, scrRefSuffix: xt, id: Yt }) => /* @__PURE__ */ u(
                ir,
                {
                  ref: _t(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(He, { className: "tw:h-4 tw:w-4" }) }),
                    ct(dt ?? tt, xt, _a)
                  ]
                },
                Yt
              ...
              b && /* @__PURE__ */ u(ht, { children: [
                /* @__PURE__ */ a(sr, {}),
                /* @__PURE__ */ a(Vr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: ut }),
                /* @__PURE__ */ a(
                  ir,
                  {
                    ref: re,
                    ...
                    onSelect: (A) => {
                      var tt, dt;
                      if (A.preventDefault(), se.current) {
                        se.current = !1;
                        return;
                      }
                      Ot.current || (dt = (tt = fe.current) == null ? void 0 : tt.querySelector("button")) == null || dt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          const tt = A.target instanceof HTMLElement ? A.target : void 0;
                          tt != null && tt.closest("button") && (se.current = !0, requestAnimationFrame(() => {
                            se.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          za,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var tt;
                              A.preventDefault(), (tt = re.current) == null || tt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(ht, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Pe(f ?? Sa, "id") }),
                              /* @__PURE__ */ a(vr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        co,
        {
          ...
          children: nt.map(({ value: A, label: tt, scrRefSuffix: dt, id: xt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(aa, { className: "tw:me-2", value: A, id: xt }),
            /* @__PURE__ */ a(Dt, { htmlFor: xt, children: ct(tt, dt) })
          ] }, xt))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && pt,
    w === "dropdown" && we && /* @__PURE__ */ a(Ba, { open: Zt === "selectedBooks", onOpenChange: at, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: xa,
        onCloseAutoFocus: oe,
        onEscapeKeyDown: (A) => {
          Ne != null && Ne.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(Ca, { container: Ne, children: [
          /* @__PURE__ */ a(Ua, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ka, { children: L }) }),
          ar,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => at(!1), children: ot }),
            /* @__PURE__ */ a(X, { onClick: rt, children: it })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Gt && /* @__PURE__ */ a(Ba, { open: Zt === "range", onOpenChange: at, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: pe,
        onCloseAutoFocus: oe,
        onEscapeKeyDown: (A) => {
          Rt != null && Rt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(Ca, { container: Rt, children: [
          /* @__PURE__ */ a(Ua, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ka, { children: D }) }),
          pt,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => at(!1), children: ot }),
            /* @__PURE__ */ a(X, { ref: At, onClick: rt, children: it })
          ] })
        ] })
      }
    ) })
...
function Rh({
  ...
  return /* @__PURE__ */ u(
    yr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(_r, { size: n, className: v("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          kr,
          {
...
const Hi = (t, e, r, o) => r ? Object.entries(t).filter(
  ([i, s]) => "column" in s && s.column === r || i === r
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Ft, { children: [
  /* @__PURE__ */ a(Ut, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(bs, { children: c.label }),
    /* @__PURE__ */ a(xs, { children: /* @__PURE__ */ a(ys, { children: Hi(
      t,
      e,
      Ki(t, c.id),
      o
...
function io({
  ...
  return /* @__PURE__ */ u(Ze, { variant: i, children: [
    /* @__PURE__ */ a(Je, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(X, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(tc, {}) }) }),
    /* @__PURE__ */ a(Qe, { align: "start", style: { zIndex: lr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(br, { children: [
      /* @__PURE__ */ a(En, { children: /* @__PURE__ */ a(Bt, { children: Hi(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(sr, {})
    ] }, l)) })
  ] });
}
const Mu = 8;
...
const Iu = Object.freeze([520, 420, 340]), Gi = ne.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = qi(n, Iu), d = ci() ?? l, w = d >= Mr.MINIMUM;
...
function Oh({
  ...
  return /* @__PURE__ */ u(Gi, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      io,
      {
        onSelectMenuItem: t,
...
function Ih({
  ...
  return /* @__PURE__ */ a(Gi, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    io,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Wi = ne.forwardRef(({ className: t, ...e }, r) => {
  const o = De();
  return /* @__PURE__ */ a(
    xe.Root,
    {
...
const Yi = ne.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  xe.List,
  {
    ref: r,
    className: v(
...
Yi.displayName = xe.List.displayName;
const Pu = ne.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  xe.Trigger,
  {
    ref: r,
    ...e,
...
)), Xi = ne.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  xe.Content,
  {
    ref: r,
    className: v(
...
Xi.displayName = xe.Content.displayName;
function Ph({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Wi, { children: [
      /* @__PURE__ */ a(Yi, { children: t.map((c) => /* @__PURE__ */ a(Pu, { value: c.value, children: c.value }, c.key)) }),
...
function ju({
  ...
  const i = Lr();
  return /* @__PURE__ */ a(Vu, { children: /* @__PURE__ */ a(
    Me.Content,
    {
...
function Ku({
  ...
  return /* @__PURE__ */ u(
    Me.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Un, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
...
const Rr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        Bu,
        {
          onClick: () => {
            o(d);
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ a(da, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ a(da, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(Uu, { children: [
        /* @__PURE__ */ a(Ku, { children: d.label }),
        /* @__PURE__ */ a(Hu, { children: Zi(
          t,
          e,
          Ki(t, d.id),
          o
      ...
      d.tooltip && /* @__PURE__ */ a(Kt, { children: d.tooltip })
    ] }, `tooltip-${d.label}-${"command" in d ? d.command : d.id}`)), l = [...c];
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(Fu, {}, `separator-${i}`)), l;
  });
};
function qu({
  menuData: t,
  ...
  if (Rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), Rr(i, [h, g]);
        break;
      case "alt+l":
        (f = s.current) == null || f.focus(), Rr(s, [h, g]);
        break;
      case "alt+n":
        (b = c.current) == null || b.focus(), Rr(c, [h, g]);
        break;
      case "alt+h":
        (R = l.current) == null || R.focus(), Rr(l, [h, g]);
        break;
    }
  }), G(() => {
    ...
    return /* @__PURE__ */ a($u, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Au, { children: [
      /* @__PURE__ */ a(Lu, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        ju,
        {
          style: { zIndex: lr },
          children: /* @__PURE__ */ a(Bt, { children: Zi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const Gu = Object.freeze([950, 800, 700]);
function $h(t) {
  switch (t) {
    case void 0:
      return;
...
function Ah({
  ...
  return /* @__PURE__ */ a(fa.Provider, { value: m, children: /* @__PURE__ */ a(
    "div",
    {
...
function Vh({
  ...
  const d = Wu(
    ...
    var R, x, E, P, K, C;
    const b = f !== m ? ((x = (R = t[m]) == null ? void 0 : R.uiNames) == null ? void 0 : x[f]) ?? ((P = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : P.en) : void 0;
    return b ? `${(K = t[m]) == null ? void 0 : K.autonym} (${b})` : (C = t[m]) == null ? void 0 : C.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ u(
      yr,
      {
        ...
        onOpenChange: (m) => p(m),
        children: [
          /* @__PURE__ */ a(_r, { children: /* @__PURE__ */ a(kr, {}) }),
          /* @__PURE__ */ a(
            Nr,
            {
              style: { zIndex: lr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(ve, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Dt, { className: "tw:font-normal tw:text-muted-foreground", children: Ue(d, {
...
function jh({
  ...
  const [s, c] = _(""), l = $(
    ...
    return l.filter(({ keywords: f }) => f.some((b) => b.toLowerCase().includes(m)));
  }, [l, s]), w = l.length > 1, p = o["%firstRun_language_search_placeholder%"] ?? "", h = o["%firstRun_language_noResults%"] ?? "", g = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(Ye, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(_s, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        "input",
        {
      ...
      /* @__PURE__ */ a(Ns, { children: /* @__PURE__ */ a(xc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Xe, { children: [
...
function Fh({
  ...
  const c = t ? Lo(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Ju(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
  return /* @__PURE__ */ u(Bt, { children: [
    /* @__PURE__ */ a("span", { role: "status", className: "tw:sr-only", children: c }),
    /* @__PURE__ */ u(Ft, { open: t, onOpenChange: () => {
    }, children: [
      /* @__PURE__ */ a(
        Ut,
        {
      ...
      /* @__PURE__ */ a(
        Kt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Lo(d, {
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(br, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
            ...
            d && (e || h && m) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ze, { children: [
                  /* @__PURE__ */ a(Je, { className: v(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    X,
                    {
...
function Hh({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = $(() => {
    const c = new Vn(o);
    return (l) => c.format(l);
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: s.map((c) => {
    let l = "upcoming";
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(br, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(He, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function tg({
  ...
  return /* @__PURE__ */ u(
    Ht.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Un, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function rg({
  ...
  return /* @__PURE__ */ u(
    Ht.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Ht.ItemIndicator, { children: /* @__PURE__ */ a(ga, {}) }) }),
        e
      ]
    }
  );
...
function sg({ ...t }) {
  return /* @__PURE__ */ a(tr.Root, { "data-slot": "drawer", ...t });
}
function cg({ ...t }) {
  return /* @__PURE__ */ a(tr.Trigger, { "data-slot": "drawer-trigger", ...t });
}
function Qu({ ...t }) {
  return /* @__PURE__ */ a(tr.Portal, { "data-slot": "drawer-portal", ...t });
}
function lg({ ...t }) {
  return /* @__PURE__ */ a(tr.Close, { "data-slot": "drawer-close", ...t });
}
function tp({
  className: t,
  ...e
...
function dg({
  ...
  const n = De();
  return /* @__PURE__ */ u(Qu, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(tp, {}),
    /* @__PURE__ */ u(
      tr.Content,
      {
...
const ap = (t, e, r = {}) => {
  ...
  const [e, r] = _(!1), [o, n] = _(!1), [i, s] = _(0), c = j(void 0), l = $(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
...
function Tg(t) {
  const e = $(() => pc(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const op = () => {
  const [t, e] = _(
...
function zg({ value: t, children: e }) {
  return /* @__PURE__ */ a(si.Provider, { value: t, children: /* @__PURE__ */ a(fa.Provider, { value: t, children: e }) });
}
function ip(t, e = "top") {
...
export {
  ...
  Pp as CONFLICT_NOTE_STRING_KEYS,
  Oi as CancelAcceptButtons,
  sw as Card,
  cw as CardContent,
  ...
  ss as DropdownMenuRadioItem,
  sr as DropdownMenuSeparator,
  Fg as DropdownMenuShortcut,
  vs as DropdownMenuSub,
  ys as DropdownMenuSubContent,
  bs as DropdownMenuSubTrigger,
  ...
  Ew as ErrorDump,
  Xp as ErrorPopover,
  rh as FOOTNOTE_EDITOR_STRING_KEYS,
  th as Filter,
  Zp as FilterDropdown,
  Qp as Footer,
  eh as FootnoteEditor,
  Qw as FootnoteItem,
  ah as FootnoteList,
  Gw as INLINE_APPLY_DEBOUNCE_MS,
  Lh as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  dh as INVENTORY_STRING_KEYS,
  pa as Input,
  jh as InterfaceLanguagePicker,
  wh as Inventory,
  Ha as Kbd,
  Xg as KbdGroup,
  Dt as Label,
  ...
  Ph as NavigationContentSearch,
  Ge as Popover,
  ps as PopoverAnchor,
  We as PopoverContent,
  Zg as PopoverDescription,
  Jg as PopoverHeader,
  ...
  Uh as ResultsCard,
  af as RetryableErrorView,
  Th as SCOPE_SELECTOR_STRING_KEYS,
  zu as SELECT_BOOKS_STRING_KEYS,
  Mr as SHRINK_STEP,
  Sh as ScopeSelector,
  ...
  wu as SidebarInset,
  pu as SidebarMenu,
  bh as SidebarMenuAction,
  xh as SidebarMenuBadge,
  fu as SidebarMenuButton,
  hu as SidebarMenuItem,
  yh as SidebarMenuSkeleton,
  kh as SidebarMenuSub,
  Nh as SidebarMenuSubButton,
  _h as SidebarMenuSubItem,
  lu as SidebarProvider,
  ph as SidebarRail,
  mh as SidebarSeparator,
  uh as SidebarTrigger,
  hr as Skeleton,
  mg as Slider,
  fg as Sonner,
  of as Spinner,
  ...
  Pu as VerticalTabsTrigger,
  Hh as WizardStepper,
  lr as Z_INDEX_ABOVE_DOCK,
  Tn as Z_INDEX_ABOVE_POPOVER,
  cf as Z_INDEX_CONNECTION_LOST,
  lf as Z_INDEX_FIRST_RUN,
  df as Z_INDEX_MODAL,
  wf as Z_INDEX_MODAL_BACKDROP,
  uf as Z_INDEX_ONBOARDING_TOUR,
  fs as Z_INDEX_OVERLAY,
  pf as badgeVariants,
  hf as buttonGroupVariants,
  gf as buttonVariants,
  v as cn,
  lh as getBookIdFromUSFM,
  zw as getCaretPositionFromClick,
  Lp as getCommentThreadElementId,
  va as getInventoryHeader,
  sh as getLinesFromUSFM,
  ch as getNumberFromUSFM,
  ou as getStatusForItem,
  ...
  wo as isMacOs,
  ff as isWindows,
  Kw as markerMenuItemToPaletteItem,
  np as pickTabIconUrl,
  vf as sonner,
  _g as useEvent,
  Ng as useEventAsync,
  Tg as useExtraValidMarkers,
  ns as useListbox,
  ap as usePromise,
  Dp as useRecentSearches,
  Cg as useRetryablePromise,
  Sg as useRunWhenVisible,
  qi as useShrinkStep,
  ci as useShrinkStepOverride,
