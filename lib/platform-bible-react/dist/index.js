...
import p, { forwardRef as Lt, createContext as qn, useContext as Jn, useCallback as Y, useState as P, useRef as Q, useEffect as at, useLayoutEffect as Fe, useMemo as tt, Fragment as Kn } from "react";
...
import { useReactTable as Ze, getFilteredRowModel as Er, getSortedRowModel as Qe, getPaginationRowModel as zr, getCoreRowModel as tn, flexRender as Dt, getGroupedRowModel as Ir, getExpandedRowModel as Mr } from "@tanstack/react-table";
...
const ke = A.Trigger, rn = A.Group, Xr = A.Portal, jr = A.Sub, ns = A.RadioGroup;
function Ut({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ne.Provider, { value: n, children: /* @__PURE__ */ r(A.Root, { ...e }) });
}
...
an.displayName = A.SubTrigger.displayName;
...
on.displayName = A.SubContent.displayName;
const Ot = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = L();
...
Ce.displayName = A.Item.displayName;
const Se = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    A.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(A.ItemIndicator, { children: /* @__PURE__ */ r(kt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Se.displayName = A.CheckboxItem.displayName;
const sn = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    A.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(A.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
sn.displayName = A.RadioItem.displayName;
...
qt.displayName = A.Label.displayName;
...
Xt.displayName = A.Separator.displayName;
...
var Gr = Object.defineProperty, $r = (t, e, n) => e in t ? Gr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, _ = (t, e, n) => $r(t, typeof e != "symbol" ? e + "" : e, n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
function ea({
  ...
  const s = Array.from({ length: e }, (i, c) => c + 1), w = Y(
    (i) => {
      o(i);
    },
    [o]
...
const na = 6, Ee = X.allBookIds.filter((t) => !X.isObsolete(X.bookIdToNumber(t))), ra = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
  ...
  "ArrowRight",
  "Enter"
]), ia = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', zt = (t) => Rr(X.bookIdToNumber(t));
function wa() {
...
function as({
  ...
  const o = L(), [s, w] = P(
    () => bt(t, "English")
  ), [i, c] = P(""), [u, g] = P(t.book), [b, f] = P(t.chapterNum ?? 0), [m, k] = P(t.book), [R, x] = P(!1), [y, C] = P(R), S = Q(void 0), j = Q(void 0), $ = Q(void 0), _t = Y(
    (h) => {
      const z = a ? a() : Ee;
      return {
    ...
    (h, z, v, I) => {
      if (f(t.book !== h ? 1 : t.chapterNum), z || zt(h) === -1) {
        e({
          book: h,
          chapterNum: v ?? 1,
          verseNum: I ?? 1
    ...
    (h) => {
      R ? h.key === "ArrowDown" ? ($ != null && $.current ? $.current.focus() : j.current && j.current.focus(), h.preventDefault()) : h.key === "Escape" && document.activeElement === S.current && (x(!1), h.preventDefault(), h.stopPropagation()) : x(!0);
    },
    [R]
  ), ft = Y((h) => {
    if (!sa.has(h.key)) {
      if (h.key === "Tab") {
        if (h.shiftKey)
          ...
          const z = [
            ...
            (I) => {
              var q, G;
              return I instanceof HTMLElement && ((I.offsetWidth > 0 || I.offsetHeight > 0) && !((q = j.current) != null && q.contains(I)) && !((G = S.current) != null && G.contains(I)) || I === h.target);
            }
          ), v = h.target instanceof HTMLElement ? z.indexOf(h.target) : -1;
    ...
    (h) => {
      const { key: z } = h;
      Ye.has(z) || (ft(h), h.preventDefault());
    },
    [ft]
  ), E = Y(
    (h, z) => {
      ...
      if (Ye.has(v)) {
        if (m === u) {
          ...
          else v === "ArrowDown" ? G = na : v === "ArrowUp" && (G = -6);
          if (b + G <= 0 || b + G > zt(m))
            f(0);
          else if (G !== 0) {
            f(b + G), h.preventDefault();
            return;
          }
        }
        if (z === 0 && v === "ArrowUp") {
  ...
  return at(() => {
    ...
    /* @__PURE__ */ r(
      Ot,
      {
        ...
        onFocus: (h) => {
          var z, v;
          !((z = S.current) != null && z.contains(h.relatedTarget)) && !((v = j.current) != null && v.contains(h.relatedTarget)) && S.current.select();
        },
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Le.map((h, z) => {
          const v = _t(h);
          return v.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(qt, { className: "tw-font-semibold tw-text-foreground/80", children: ra[h] }),
            ...
            Le.length - 1 !== z ? /* @__PURE__ */ r(Xt, {}) : void 0
          ] }, h);
        }) })
      }
    )
...
function ss({
  ...
  const g = se(u, "%webView_bookSelector_currentBook%"), b = se(u, "%webView_bookSelector_choose%"), f = se(u, "%webView_bookSelector_chooseBooks%"), [m, k] = P(
    "current book"
    /* CURRENT_BOOK */
  ), R = (x) => {
    k(x), t(x);
...
function ya({ table: t }) {
  return /* @__PURE__ */ d(Ut, { children: [
    ...
    /* @__PURE__ */ d(Ot, { align: "end", className: "tw-w-[150px]", children: [
...
const vt = F.Root, Na = F.Group, xt = F.Value, ka = dt(
  ...
  return /* @__PURE__ */ d(
    F.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(F.Icon, { asChild: !0, children: /* @__PURE__ */ r(Yt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
function Ea({
  ...
  var x;
  const [i, c] = P([]), [u, g] = P([]), [b, f] = P({}), [m, k] = P({}), R = Ze({
    data: e,
    columns: t,
    getCoreRowModel: tn(),
...
const jt = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(sr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function ps({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ut, { children: [
    ...
    /* @__PURE__ */ r(Ot, { children: e.map((n) => /* @__PURE__ */ d("div", { children: [
...
function Ma({ id: t, versionHistory: e }) {
  ...
  function s(i) {
    ...
    let m = "";
    return g > 0 ? m = `${g.toString()} year${g === 1 ? "" : "s"} ago` : b > 0 ? m = `${b.toString()} month${b === 1 ? "" : "s"} ago` : f === 0 ? m = "today" : m = `${f.toString()} day${f === 1 ? "" : "s"} ago`, m;
  }
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      ...
      return /* @__PURE__ */ d(yn, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        ...
        (m = t.find((k) => k.value === f)) == null ? void 0 : m.label
      ] }, f);
...
const Zt = (t) => t === "asc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(br, { className: "tw-ms-2 tw-h-4 tw-w-4" }), fs = (t) => ({
  ...
  return e ? e[1] : "";
}, Oa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ks = Object.freeze([
...
function Cs({
  ...
  const u = it(n, "%webView_inventory_all%"), g = it(n, "%webView_inventory_approved%"), b = it(n, "%webView_inventory_unapproved%"), f = it(n, "%webView_inventory_unknown%"), m = it(n, "%webView_inventory_scope_currentBook%"), k = it(n, "%webView_inventory_scope_chapter%"), R = it(n, "%webView_inventory_filter_text%"), x = it(
    n,
    "%webView_inventory_show_additional_items%"
    ...
    const E = [];
    return T.forEach((h) => {
      const z = h.items[0], v = E.find(
        (I) => I.items[0] === z
      );
      v ? (v.count += h.count, v.occurrences = v.occurrences.concat(h.occurrences)) : E.push({
        items: [z],
        count: h.count,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(vt, { onValueChange: (E) => re(E), defaultValue: w, children: [
        ...
        /* @__PURE__ */ d(gt, { children: [
          /* @__PURE__ */ r(et, { value: "book", children: m }),
...
const Ae = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  nn.Root,
  {
    ref: o,
    decorative: n,
...
Ae.displayName = nn.Root.displayName;
...
const Oe = At.Provider, Xe = At.Root, je = At.Trigger, Qt = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  At.Content,
  {
    ref: a,
    sideOffset: e,
...
const Rn = p.forwardRef(
  ({
    ...
    const [u, g] = p.useState(t), b = e ?? u, f = p.useCallback(
      ...
      [n, b]
    ), m = p.useCallback(() => f((S) => !S), [f]), k = b ? "expanded" : "collapsed", y = L() === "ltr" ? w : w === "primary" ? "secondary" : "primary", C = p.useMemo(
      () => ({
        state: k,
        open: b,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(Sn.Provider, { value: C, children: /* @__PURE__ */ r(Oe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
function ro({
  ...
  const u = Y(
    ...
    (f) => {
      const m = n.find((k) => k.projectId === f);
    ...
    Tn,
    {
      ...
      children: /* @__PURE__ */ d(En, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(zn, { children: Object.entries(e).map(([f, m]) => /* @__PURE__ */ r(In, { children: /* @__PURE__ */ r(
            Mn,
            {
              onClick: () => u(f),
              isActive: b(f),
...
function Rs({
  ...
  const [c, u] = P([]), [g, b] = P([{ id: wt, desc: !1 }]), [f, m] = P({}), k = tt(
...
const Pn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Xr, { children: /* @__PURE__ */ r(on, { children: Pn(
      t,
      e,
      Bn(t, i.id),
      a
...
function qe({
  ...
  return /* @__PURE__ */ d(Ut, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Ot, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, c]) => typeof i == "boolean" || typeof c == "boolean" ? 0 : i.order - c.order).map(([i], c, u) => /* @__PURE__ */ d(Kn, { children: [
      /* @__PURE__ */ r(rn, { children: /* @__PURE__ */ r(Oe, { children: Pn(e.groups, e.items, i, t) }) }),
...
function Ms({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(An, { children: [
      /* @__PURE__ */ r(On, { children: t.map((w) => /* @__PURE__ */ r(po, { value: w.value, children: w.value }, w.key)) }),
      t.map((w) => /* @__PURE__ */ r(Xn, { value: w.value, children: w.content }, w.key))
    ] })
  ] });
}
function uo({ ...t }) {
  return /* @__PURE__ */ r(O.Menu, { ...t });
}
function mo({ ...t }) {
  return /* @__PURE__ */ r(O.Sub, { "data-slot": "menubar-sub", ...t });
}
...
jn.displayName = O.Root.displayName;
...
Fn.displayName = O.Trigger.displayName;
...
Gn.displayName = O.SubTrigger.displayName;
...
$n.displayName = O.SubContent.displayName;
const Ln = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const w = nt();
...
Ln.displayName = O.Content.displayName;
...
Yn.displayName = O.Item.displayName;
const ho = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    O.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(O.ItemIndicator, { children: /* @__PURE__ */ r(kt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
ho.displayName = O.CheckboxItem.displayName;
const go = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    O.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(O.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
go.displayName = O.RadioItem.displayName;
...
fo.displayName = O.Label.displayName;
...
Hn.displayName = O.Separator.displayName;
const It = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
...
function bo({
  ...
  if (Vr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    var k, R, x, y;
    g.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (k = s.current) == null || k.focus(), It(s, [f, m]);
        break;
      case "alt+l":
        (R = w.current) == null || R.focus(), It(w, [f, m]);
        break;
      case "alt+n":
        (x = i.current) == null || x.focus(), It(i, [f, m]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), It(c, [f, m]);
        break;
    }
  }), at(() => {
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ d(uo, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Oe, { children: Un(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
...
function Bs({
  ...
  const c = vo(
    ...
    o && o(m), a && a([m, ...n.filter((k) => k !== m)]), s && n.find((k) => k === m) && s([...n.filter((k) => k !== m)]), g(!1);
  }, f = (m, k) => {
    var x, y, C, S, j, $;
    const R = k !== m ? ((y = (x = t[m]) == null ? void 0 : x.uiNames) == null ? void 0 : y[k]) ?? ((S = (C = t[m]) == null ? void 0 : C.uiNames) == null ? void 0 : S.en) : void 0;
    return R ? `${(j = t[m]) == null ? void 0 : j.autonym} (${R})` : ($ = t[m]) == null ? void 0 : $.autonym;
  };
      ...
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((m) => /* @__PURE__ */ r(et, { value: m, children: f(m, e) }, m))
            }
          )
        ]
      }
...
Oo.displayName = W.Content.displayName;
const js = (t, e) => {
  at(() => {
    if (!t) return () => {
    };
