            ...
            children: [
              ...
              !Q && /* @__PURE__ */ u(He, { ref: wt, children: [
                R === "books" && /* @__PURE__ */ u(it, { children: [
                  ...
                  D && !yt && tr(D.book) > 1 && /* @__PURE__ */ u(it, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
ae({ build: (t, e, r) => dr(e), config: Ye({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
ae({ build: (t, e, r) => dr(e), config: Ye({ $onClear: Wn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const io = 0, Pa = 1, ti = 2, ha = 3, Ar = 4, Xe = 5, ga = 6, gr = 7;
function fa(t) {
  return t.id === io;
}
function ei(t) {
...
class Hl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ar && lt(307, String(r.id), String(Xe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const Wl = ae({ config: Ye({ setOptions: Uo, updateOptions: Uo }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class er {
  ...
  static maybeFromEditor(e) {
    const r = e[Ko];
    return r && (r.PACKAGE_VERSION !== ma && lt(292, r.PACKAGE_VERSION, ma), r instanceof er || lt(293)), r;
  }
  static fromEditor(e) {
...
ae({ dependencies: [Va, Go], name: "@lexical/extension/HorizontalRule", nodes: () => [or], register(t, e, r) {
  ...
  return Ce(t.registerCommand(Zl, (s) => {
    ...
    return !1;
  }, On), t.registerMutationListener(or, (s, c) => {
    jl(() => {
      let d = !1;
...
ae({ build: (t, e) => dr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ye({ $getParentEditor: function() {
  const t = mc();
...
ae({ build: (t, e, r) => dr(e), config: Ye({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return he(() => {
...
ae({ build: (t, e, r) => dr(e), config: Ye({ $canIndent: ri, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ae({ build: (t, e, r) => dr(e), config: Ye({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => he(() => r.getOutput().disabled.value ? void 0 : oi(t)) });
function id(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
  ...
  if (t)
    return /* @__PURE__ */ a(
      G,
      {
        ...
        "aria-label": o,
        children: /* @__PURE__ */ a(rr, { className: "tw:h-4 tw:w-4" })
      }
    );
}
const Zo = {
  ...
  return (
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", onClick: (O) => O.stopPropagation(), children: [
      ...
      w && /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2", "data-slot": "conflict-loading", children: [
        /* @__PURE__ */ a(Ze, { className: "tw:h-8 tw:w-full" }),
        /* @__PURE__ */ a(Ze, { className: "tw:h-8 tw:w-full" }),
        /* @__PURE__ */ a(Ze, { className: "tw:h-8 tw:w-24" })
      ] }),
      !w && g && Y(),
      ...
      /* @__PURE__ */ u(
        nr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(cr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(se, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Wd({
  ...
  let B;
  return d ? B = Array.from({ length: 10 }).map((N, j) => `skeleton-row-${j}`).map((N) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qe, { colSpan: I.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Ze, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((T = k.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    Re,
    {
      onClick: () => s(V, k),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map(($) => /* @__PURE__ */ a(Qe, { children: vr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    V.id
  )) : B = /* @__PURE__ */ a(Re, { children: /* @__PURE__ */ a(Qe, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
  ...
  return /* @__PURE__ */ u(qa, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Ha, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Re,
      {
        ...
        children: [
          /* @__PURE__ */ a(Qe, { children: be(c.reference, "English") }),
          /* @__PURE__ */ a(Qe, { className: o, children: vw(c.text) })
        ]
      },
...
function bp({
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(nr, { onValueChange: (U) => _t(U), defaultValue: s, children: [
...
function Sp({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      ...r,
      children: [
        e && /* @__PURE__ */ a(Ze, { className: "tw:size-4 tw:rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ a(
          Ze,
          {
    ...
    !e && /* @__PURE__ */ u(
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { position: "item-aligned", children: /* @__PURE__ */ a(qd, { children: I.map((N) => /* @__PURE__ */ a(se, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
...
function Ip({
  ...
  const I = Et(
  ...
  ), zr = D === "end", Sr = D === "start", We = "tw:text-muted-foreground", b = l === "dropdown" && Rt === "range", H = b ? $t : P, Pt = b ? de : h ? X : oe, ve = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-start", className: m(zr && We), children: O }),
      /* @__PURE__ */ a(
        da,
        {
    ...
    /* @__PURE__ */ u("div", { ref: at, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-end", className: m(Sr && We), children: S }),
      /* @__PURE__ */ a(
        da,
        {
          id: "scope-range-end",
  ...
  }, []), mo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(rr, { className: "tw:h-4 tw:w-4" }) }) : void 0;
            ...
            children: /* @__PURE__ */ u(na, { container: Jt, children: [
              ct.map(({ value: M, label: J, dropdownLabel: Ut, scrRefSuffix: hr, id: Ai }) => /* @__PURE__ */ u(
                Le,
                {
                  ...
                  children: [
                    t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(rr, { className: "tw:h-4 tw:w-4" }) }),
                    U(Ut ?? J, hr, $i)
                  ]
                },
                Ai
...
function ja({
  ...
  return /* @__PURE__ */ u(ke, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ne, { align: "start", style: { zIndex: lr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(kn, { children: [
