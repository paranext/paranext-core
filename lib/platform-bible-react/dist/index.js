...
import { jsx as o, jsxs as c, Fragment as ot } from "react/jsx-runtime";
import g, { forwardRef as We, useRef as rt, useMemo as B, useState as A, useCallback as j, useLayoutEffect as Vt, createContext as mn, useContext as lr, useEffect as W, Component as ws, createElement as Mr, Suspense as ds, createRef as cs, Fragment as lo } from "react";
import { Command as ft } from "cmdk";
import { X as Ze, Search as wo, Check as Rt, Clock as Ar, ChevronsLeft as Vr, ChevronsRight as $r, ChevronLeft as jn, ChevronRight as be, ArrowLeft as ps, ArrowRight as us, Circle as hn, ChevronDown as se, BoldIcon as ms, ItalicIcon as hs, UnderlineIcon as fs, StrikethroughIcon as gs, Pencil as bs, Trash2 as vs, ArrowUp as co, MoreHorizontal as po, ChevronUp as Fn, AtSign as xs, FilterIcon as ys, ArrowLeftIcon as Ns, ChevronLeftIcon as ks, ChevronRightIcon as _s, ArrowRightIcon as Cs, Copy as uo, Filter as Es, User as Ss, Link as Ts, CircleHelp as Rs, ChevronsUpDown as mo, Star as Ds, FunctionSquare as ho, SquareSigma as fo, SquareX as Os, AlertCircle as Gn, CircleCheckIcon as Is, CircleXIcon as Ms, CircleHelpIcon as As, ArrowUpIcon as Vs, ArrowDownIcon as $s, ArrowUpDownIcon as Ps, PanelLeft as Ls, PanelRight as Bs, ScrollText as zs, MenuIcon as js, Menu as Fs, EllipsisVertical as Gs, LoaderCircle as Hs, GripVertical as Xs } from "lucide-react";
import { clsx as Ks } from "clsx";
import { extendTailwindMerge as Us } from "tailwind-merge";
import * as Nt from "@radix-ui/react-dialog";
import { includes as rn, Section as G, getChaptersForBook as Ys, formatScrRef as he, getSectionForBook as ze, formatRelativeDate as qs, formatReplacementString as fe, sanitizeHtml as Js, parseParatextHtml as Pr, hasCustomParatextTags as Ws, NumberFormat as Zs, formatBytes as Qs, getCurrentLocale as ti, getFormatCallerFunction as ei, deepEqual as go, isString as En, compareScrRefs as Hn, scrRefToBBBCCCVVV as Sn, getLocalizeKeyForScrollGroupId as Y } from "platform-bible-utils";
...
import { createEditor as vo, $getRoot as Xt, $createParagraphNode as fn, $getSelection as $t, HISTORY_MERGE_TAG as wr, ParagraphNode as xo, TextNode as yo, $isTokenOrSegmented as ni, $getCharacterOffsets as ri, $cloneWithPropertiesEphemeral as oi, $findMatchingParent as ai, $isElementNode as ne, CLEAR_EDITOR_COMMAND as No, COMMAND_PRIORITY_EDITOR as ko, $isRangeSelection as Ke, shallowMergeConfig as si, defineExtension as Pt, safeCast as Qe, RootNode as ii, LineBreakNode as li, TabNode as wi, $isEditorState as di, createCommand as ci, CLICK_COMMAND as pi, isDOMNode as ui, $getNodeFromDOMNode as mi, $isNodeSelection as hi, $createNodeSelection as fi, $setSelection as gi, COMMAND_PRIORITY_LOW as bi, DecoratorNode as vi, $create as xi, $getNodeByKey as yi, INDENT_CONTENT_COMMAND as Lr, COMMAND_PRIORITY_CRITICAL as dr, KEY_TAB_COMMAND as Ni, $createRangeSelection as ki, $normalizeSelection__EXPERIMENTAL as _i, OUTDENT_CONTENT_COMMAND as Ci, INSERT_TAB_COMMAND as Ei, $isBlockElementNode as wn, $isDecoratorNode as Si, $isParagraphNode as Ti, $isTextNode as dn, SELECTION_CHANGE_COMMAND as _o, FORMAT_TEXT_COMMAND as Ri, getRegisteredNode as Di, isHTMLElement as Oi, isDocumentFragment as Br, isDOMDocumentNode as Ii, ArtificialNode__DO_NOT_USE as Co, $createLineBreakNode as Eo, $isRootOrShadowRoot as Mi, isBlockDomNode as zr, isInlineDomNode as jr, $insertNodes as Ai } from "lexical";
...
import { useReactTable as Do, getFilteredRowModel as Gi, getSortedRowModel as Oo, getPaginationRowModel as Hi, getCoreRowModel as Io, flexRender as je, getGroupedRowModel as Xi, getExpandedRowModel as Ki } from "@tanstack/react-table";
...
const tl = Nt.Root, el = Nt.Portal, Mo = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Nt.Overlay,
  {
    ref: n,
    className: m(
...
Mo.displayName = Nt.Overlay.displayName;
const Ao = g.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = wt();
  return /* @__PURE__ */ c(el, { children: [
    /* @__PURE__ */ o(Mo, {}),
    /* @__PURE__ */ c(
      Nt.Content,
      {
...
Ao.displayName = Nt.Content.displayName;
...
$o.displayName = Nt.Title.displayName;
const nl = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Nt.Description,
  {
    ref: n,
...
const bn = g.forwardRef((e, t) => /* @__PURE__ */ o(ft.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
bn.displayName = ft.Empty.displayName;
const Kt = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  ft.Group,
  {
    ref: n,
    className: m(
...
Po.displayName = ft.Separator.displayName;
...
de.displayName = ft.Item.displayName;
...
function Te(e, t = !0) {
  return t && (e = e.toUpperCase()), e in Fr ? Fr[e] : 0;
}
function ur(e) {
  return Te(e) > 0;
}
...
const ht = class X {
  ...
  static fromJSON(t) {
    ...
    let d;
    return i && (d = new Qt(i)), n ? new X(n, r.toString(), l, d) : new X();
  }
  /**
  ...
  allVerses(t = !1, n = X.verseRangeSeparators, r = X.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], s = Gr(this._verse, r);
    for (const i of s.map((l) => Gr(l, n))) {
      const l = this.clone();
      l.verse = i[0];
      const d = l.verseNum;
...
const Xo = q.allBookIds.filter(
  (e) => !q.isObsolete(q.bookIdToNumber(e))
), re = Object.fromEntries(
  Xo.map((e) => [e, q.bookIdToEnglishName(e)])
);
function fr(e, t, n) {
...
const Re = ve.Root, De = ve.Trigger, cp = ve.Anchor, ce = g.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = wt();
...
function gl({
  ...
  return /* @__PURE__ */ c(Re, { open: l, onOpenChange: d, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ o(Ar, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ o(ce, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(Ee, { children: /* @__PURE__ */ o(Se, { children: /* @__PURE__ */ o(Kt, { heading: s, children: e.map((p) => /* @__PURE__ */ c(
      de,
      {
        onSelect: () => w(p),
        className: "tw-flex tw-items-center",
        children: [
          /* @__PURE__ */ o(Ar, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function xl(e, t, n, r) {
  const a = j(() => {
    if (e.chapterNum > 1)
      ...
      if (d > 0) {
        const w = t[d - 1], p = Math.max(Tt(w), 1);
        r({
          book: w,
          chapterNum: p,
          verseNum: 1
...
function up({
  ...
  const w = wt(), [p, f] = A(!1), [h, u] = A(""), [b, x] = A(""), [y, D] = A("books"), [N, v] = A(void 0), [C, V] = A(!1), k = rt(void 0), _ = rt(void 0), T = rt(void 0), E = rt(void 0), S = rt({}), $ = j(
    (R) => {
      t(R), l && l(R);
    },
    [t, l]
  ...
  }), [z]), O = B(() => Object.values(H).flat(), [H]), Z = B(() => {
    if (!b.trim()) return H;
    const R = {
      [G.OT]: [],
      [G.NT]: [],
    ...
    (R) => {
      ...
      f(R), R && (D("books"), v(void 0), x(""));
    },
    [y, I]
  ), { otLong: dt, ntLong: vt, dcLong: Ae, extraLong: Dr } = {
    ...
    (R) => {
      if (R.ctrlKey) return;
      const { isLetter: U, isDigit: it } = Hr(R.key);
      if (y === "chapters") {
        if (R.key === "Backspace") {
        ...
        if (U || it) {
          if (R.preventDefault(), R.stopPropagation(), D("books"), v(void 0), it && N) {
            const ct = re[N];
            x(`${ct} ${R.key}`);
          } else
            x(R.key);
      ...
      if ((y === "chapters" || y === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(R.key)) {
        ...
        switch (R.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Ot = mt === 0 ? Wt : Math.max(1, mt - Ir);
            break;
          case "ArrowDown":
            Ot = mt === 0 ? 1 : Math.min(Wt, mt + Ir);
            break;
          default:
            return;
        }
        Ot !== mt && (R.preventDefault(), R.stopPropagation(), u(Jn(ct, a, Ot)), setTimeout(() => {
    ...
    const { isLetter: U, isDigit: it } = Hr(R.key);
    (U || it) && (R.preventDefault(), x((ct) => ct + R.key), _.current.focus(), V(!1));
  }, []);
  return Vt(() => {
    const R = setTimeout(() => {
      if (p && y === "books" && T.current && E.current) {
        const U = T.current, it = E.current, ct = it.offsetTop, mt = U.clientHeight, Wt = it.clientHeight, Ot = ct - mt / 2 + Wt / 2;
        U.scrollTo({
          top: Math.max(0, Ot),
          behavior: "smooth"
        }), u(Jn(e.book));
  ...
  }, [y, N, M, e.book, e.chapterNum]), /* @__PURE__ */ c(Re, { open: p, onOpenChange: st, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
    ...
    /* @__PURE__ */ o(ce, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ c(
      Ee,
      {
        ref: k,
        onKeyDown: as,
        ...
        children: [
          y === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: P.map(({ onClick: R, disabled: U, title: it, icon: ct }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
          ...
          !C && /* @__PURE__ */ c(Se, { ref: T, children: [
            y === "books" && /* @__PURE__ */ c(ot, { children: [
              !M && Object.entries(Z).map(([R, U]) => {
                if (U.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Kt, { heading: es(R), children: U.map((it) => /* @__PURE__ */ o(
                      Ko,
                      {
                        bookId: it,
                        onSelect: (ct) => yt(ct),
              ...
              M && /* @__PURE__ */ o(Kt, { children: /* @__PURE__ */ o(
                de,
                {
                  ...
                  children: he(
                    ...
                    a ? hr(M.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              M && Tt(M.book) > 1 && /* @__PURE__ */ c(ot, { children: [
...
), lt = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(bo.Root, { ref: n, className: m("pr-twp", yl(), e), ...t }));
lt.displayName = bo.Root.displayName;
const gr = g.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    Xe.Root,
    {
...
cn.displayName = Xe.Item.displayName;
function Nl(e) {
...
function Wn({
  ...
  const [N, v] = A(!1), C = d ?? l, V = (_) => _.length > 0 && typeof _[0] == "object" && "options" in _[0], k = (_, T) => {
    const E = l(_), S = typeof _ == "object" && "secondaryLabel" in _ ? _.secondaryLabel : void 0, $ = `${T ?? ""}${E}${S ?? ""}`;
    return /* @__PURE__ */ c(
      de,
      {
        value: E,
  ...
  return /* @__PURE__ */ c(Re, { open: N, onOpenChange: v, ...D, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ c(
      L,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ o(
      ce,
      {
        ...
        children: /* @__PURE__ */ c(Ee, { children: [
          ...
          /* @__PURE__ */ o(Se, { children: V(t) ? t.map((_) => /* @__PURE__ */ o(Kt, { heading: _.groupHeading, children: _.options.map((T) => k(T, _.groupHeading)) }, _.groupHeading)) : t.map((_) => k(_)) })
        ] })
      }
    )
  ] });
...
function fp({
  ...
  const p = Dn(w, "%webView_bookSelector_currentBook%"), f = Dn(w, "%webView_bookSelector_choose%"), h = Dn(w, "%webView_bookSelector_chooseBooks%"), [u, b] = A(
    "current book"
    /* CURRENT_BOOK */
  ), x = (y) => {
    b(y), e(y);
...
const gp = [
  ...
  const a = rt(null), [s, i] = A(void 0), [l, d] = A(void 0), w = j(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || Cl.includes(b)) return !0;
    const x = u.getAttribute("role");
    if (x && El.includes(x)) return !0;
    const y = u.getAttribute("tabindex");
    return y !== void 0 && y !== "-1";
  }, h = j(
    (u) => {
      var _;
      const b = u.target, x = (T) => T ? document.getElementById(T) : void 0, y = x(l), D = x(s);
      if (!!(y && b && y.contains(b) && b !== y) && f(b)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const E = T.findIndex(($) => $ === b);
          if (E === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(E + 1, T.length - 1) : S = Math.max(E - 1, 0), S !== E && (u.preventDefault(), u.stopPropagation(), (_ = T[S]) == null || _.focus());
          return;
        }
        return;
      }
...
const Yo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Rl = Yo ? Vt : W, on = { tag: wr };
function Dl({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: d } = e, w = Tl(null, r), p = vo({ editable: e.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, h) {
      if (h !== null) {
...
function Il({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return Ol(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      t && s.size === 0 && i.size === 0 || e && d.has(wr) || l.isEmpty() || n(a, r, d);
    });
  }, [r, e, t, n]), null;
}
const br = {
  ...
  mark: "",
  markOverlap: ""
}, Mt = tn.Provider, Ft = tn.Root, oe = tn.Trigger, At = g.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  tn.Content,
  {
    ref: r,
    sideOffset: t,
...
function Bl() {
  return function(e) {
    const [t] = Dt(), n = B(() => e(t), [t, e]), [r, a] = A(() => n.initialValueFn()), s = rt(r);
    return Pl(() => {
...
function zl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ni(t) && r !== null) {
    ...
    if (w || p) {
      const [f, h] = ri(e), u = l.is(d), b = t.is(i ? d : l), x = t.is(i ? l : d);
      let y, D = 0;
      u ? (D = f > h ? h : f, y = f > h ? f : h) : b ? (D = i ? h : f, y = void 0) : x && (D = 0, y = i ? f : h);
      const N = t.__text.slice(D, y);
      N !== t.__text && (n === "clone" && (t = oi(t)), t.__text = N);
    }
  }
  return t;
}
...
const qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fl = qo && "documentMode" in document ? document.documentMode : null;
!(!qo || !("InputEvent" in window) || Fl) && "getTargetRanges" in new window.InputEvent("input");
function Jo(...e) {
  const t = [];
...
function Yl(e) {
  ...
  Qo(this), K = e, this.f &= -2, 8 & this.f && xr(this), vn();
}
function me(e, t) {
...
ut.prototype.brand = Xl, ut.prototype.h = function() {
  ...
  const t = this.t;
  t !== e && e.e === void 0 && (e.x = t, this.t = e, t !== void 0 ? t.e = e : Ur(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const t = e.e, n = e.x;
    t !== void 0 && (t.x = n, e.e = void 0), n !== void 0 && (n.e = t, e.x = void 0), e === this.t && (this.t = n, n === void 0 && Ur(() => {
      var r;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ta(this), qr(this), Gt++;
  const e = K;
...
Pt({ build: (e, t, n) => xn(t), config: Qe({ $onClear: ea }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Yt(() => na(e, r.value));
} });
function ql(e) {
...
const Qn = Pt({ build: (e) => ra(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const yr = 0, tr = 1, aa = 2, In = 3, an = 4, ue = 5, Mn = 6, Pe = 7;
function An(e) {
  return e.id === yr;
}
function sa(e) {
...
function Jl(e) {
  return function(t) {
    return t.id === tr;
  }(e) || J(305, String(e.id), String(tr)), Object.assign(e, { id: aa });
}
...
class Zl {
  ...
  init(t) {
    ...
    this.state = s, this.extension.init && (i = this.extension.init(t, s.config, r)), this.state = function(l, d, w) {
      return Object.assign(l, { id: an, initResult: d, registerState: w });
    }(s, i, a);
  }
  build(t) {
    const n = this.state;
...
const tw = Pt({ config: Qe({ setOptions: Jr, updateOptions: Jr }), init: ({ $initialEditorState: e = Ql }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [ii, yo, li, wi, xo] }), Wr = Symbol.for("@lexical/extension/LexicalBuilder");
function Zr() {
}
function ew(e) {
  throw e;
...
const nw = /* @__PURE__ */ new Set(), Qr = Pt({ build(e, t, n) {
  const r = n.getDependency(Qn).output, a = Ue({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ra(() => {
  }, () => Yt(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let d, w = !1;
    r.value.read(() => {
      if ($t()) for (const [p, f] of l.entries()) {
        if (f.size === 0) {
          l.delete(p);
          continue;
        }
        const h = yi(p), u = h && h.isSelected() || !1;
        w = w || u !== (!!i && i.has(p)), u && (d = d || /* @__PURE__ */ new Set(), d.add(p));
      }
    }), !w && d && i && d.size === i.size || (s.value = d);
  }));
  return { watchNodeKey: function(i) {
    const l = Ul(() => (s.value || nw).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
Pt({ dependencies: [Qn, Qr], name: "@lexical/extension/HorizontalRule", nodes: [xe], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(Qr).output, a = Ue({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return Ut(e.registerCommand(pi, (i) => {
    if (ui(i.target)) {
      const l = mi(i.target);
      if (ow(l)) return function(d, w = !1) {
        const p = $t(), f = d.isSelected(), h = d.getKey();
        let u;
        w && hi(p) ? u = p : (u = fi(), gi(u)), f ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    Kl(() => {
      ...
      for (const [p, f] of i.entries()) if (f === "destroyed") w.delete(p), d = !0;
        ...
        h ? h.domNode.value = u : (d = !0, w.set(p, { domNode: Ue(u), selectedSignal: r(p) }));
      }
      d && (a.value = { nodeSelections: w });
    });
  }), Yt(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(Yt(() => {
      const w = l.value;
      w && (d.value ? Wo(w, s) : Gl(w, s));
    }));
    return Ut(...i);
  }));
} });
function aw(e, t) {
  return Ut(e.registerCommand(Ni, (n) => {
    ...
    const a = function(s) {
      ...
      const l = s.anchor, d = s.focus, w = d.isBefore(l) ? d : l, p = w.getNode(), f = Kr(p);
      if (f.canIndent()) {
        const h = f.getKey();
        let u = ki();
      ...
      return !1;
    }(r) ? n.shiftKey ? Ci : Lr : Ei;
    return e.dispatchCommand(a, void 0);
  }, ko), e.registerCommand(Lr, () => {
    const n = typeof t == "number" ? t : t ? t.peek() : null;
    if (n == null) return !1;
    const r = $t();
    if (!Ke(r)) return !1;
    const a = r.getNodes().map((s) => Kr(s).getIndent());
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            e.update(() => {
              ...
              if (Ke(b)) {
                const x = b.anchor;
                let y = x.getNode(), D = 0, N = 0;
                if (dn(y) && w >= 0 && p >= 0 && (D = w, N = w + p, b.setTextNodeRange(y, D, y, N)), D === N && f === "" || (b.insertRawText(f), y = x.getNode()), dn(y)) {
                  D = h, N = h + u;
                  const v = y.getTextContentSize();
                  D = D > v ? v : D, N = N > v ? v : N, b.setTextNodeRange(y, D, y, N);
                }
...
Pt({ build: (e, t, n) => xn(t), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Yt(() => n.getOutput().disabled.value ? void 0 : wa(e)) });
function dw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
function cw({ editor: e, ErrorBoundary: t }) {
  return function(n, r) {
    ...
    return Nr(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], p = o(r, { onError: (h) => n._onError(h), children: o(ds, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
        f !== null && i.push(zi(p, f, w));
      }
      return i;
    }, [r, a, n]);
  }(e, t);
...
function pw({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    ...
    return !1;
  }(e) ? null : o(cw, { editor: e, ErrorBoundary: t });
}
function to(e) {
...
function uw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Nr(() => Ut(Li(a), wa(a)), [a]);
  }(r), c(ot, { children: [e, o(mw, { content: t }), o(pw, { editor: r, ErrorBoundary: n })] });
}
...
function bw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: b, id: x, role: y = "textbox", spellCheck: D = !0, style: N, tabIndex: v, "data-testid": C, ...V }, k) {
  ...
  return da(() => (T(e.isEditable()), e.registerEditableListener(($) => {
    T($);
  })), [e]), o("div", { "aria-activedescendant": _ ? t : void 0, "aria-autocomplete": _ ? n : "none", "aria-controls": _ ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": _ && y === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": _ ? f : void 0, "aria-readonly": !_ || void 0, "aria-required": h, autoCapitalize: u, className: b, contentEditable: _, "data-testid": C, id: x, ref: S, role: y, spellCheck: D, style: N, tabIndex: v, ...V });
}
const vw = We(bw);
function eo(e) {
  return e.getEditorState().read(la(e.isComposing()));
...
function yw(e, t) {
  ...
  return c(ot, { children: [o(vw, { editor: a, ...r, ref: t }), n != null && o(Nw, { editor: a, content: n })] });
}
...
function Cw() {
  const [e, t] = A(void 0), n = j(() => {
    t(void 0);
  }, []), r = B(() => {
    if (e === void 0)
      return;
    const { title: s, content: i } = e;
    return /* @__PURE__ */ o(tl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Ao, { children: [
...
function Ew({
  ...
  const [t] = Dt(), [n, r] = A(t), [a, s] = A("paragraph"), [i, l] = Cw(), d = () => {
  };
...
), Tw = g.forwardRef(({ className: e, variant: t, size: n, ...r }, a) => /* @__PURE__ */ o(
  So.Root,
  {
    ref: a,
...
Tw.displayName = So.Root.displayName;
const ma = g.createContext({
  size: "default",
  variant: "default"
}), kr = g.forwardRef(({ className: e, variant: t, size: n, children: r, ...a }, s) => {
  const i = wt();
  return /* @__PURE__ */ o(
    gn.Root,
    {
...
const He = g.forwardRef(({ className: e, children: t, variant: n, size: r, ...a }, s) => {
...
function Rw() {
  const { activeEditor: e } = pa(), [t, n] = A([]), r = j((a) => {
    if (Ke(a) || ji(a)) {
      const s = [];
      no.forEach(({ format: i }) => {
  ...
  return Sw(r), /* @__PURE__ */ o(
    kr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: no.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ o(
        He,
        {
          value: a,
          "aria-label": i,
...
function ha(e, t, n, r = null) {
  ...
  let i = t;
  r !== null && dn(t) && (i = zl(r, t, "clone"));
  const l = ne(i) ? i.getChildren() : [], d = Di(e, i.getType());
  let w;
  ...
  if (a && !s) {
    if ((Oi(p) || Br(p)) && p.append(h), n.append(p), f) {
      const u = f.call(i, p);
      u && (Br(p) ? p.replaceChildren(u) : p.replaceWith(u));
    }
  } else n.append(h);
  return a;
}
...
function ga(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const d = function(b, x) {
    const { nodeName: y } = b, D = x._htmlConversions.get(y.toLowerCase());
    let N = null;
    if (D !== void 0) for (const v of D) {
      const C = v(b);
  ...
  return p != null && (h = p(h)), zr(e) && (h = Vw(e, h, u ? () => {
    const b = new Co();
    return n.push(b), b;
  } : fn)), l == null ? h.length > 0 ? i = i.concat(h) : zr(e) && function(b) {
    return b.nextSibling == null || b.previousSibling == null ? !1 : jr(b.nextSibling) && jr(b.previousSibling);
...
const jw = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
const xa = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ce.Root,
  {
    ref: n,
    className: m(
...
const Gw = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ce.Image,
  {
    ref: n,
...
function pe({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Cr.Provider, { value: n, children: /* @__PURE__ */ o(tt.Root, { ...t }) });
}
const ka = g.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = _t();
  return /* @__PURE__ */ c(
    tt.SubTrigger,
    {
...
const Jt = g.forwardRef(({ className: e, sideOffset: t = 4, children: n, ...r }, a) => {
  const s = wt();
...
const Ht = g.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = _t();
  return /* @__PURE__ */ c(
    tt.CheckboxItem,
    {
...
const Ca = g.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = _t();
  return /* @__PURE__ */ c(
    tt.RadioItem,
    {
...
const nn = g.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  tt.Label,
  {
    ref: r,
...
function ro({
  ...
  const x = j(() => {
    ...
    const k = new Date(e.date), _ = qs(
      k,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), T = k.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [e.date, r]), N = B(() => e.user, [e.user]), v = B(
    ...
    if (a && n)
      return /* @__PURE__ */ c(ot, { children: [
        !Ws(e.contents) && /* @__PURE__ */ c(
          pn,
          {
            onClick: () => {
              f(!0), u(Pw(Pr(e.contents))), w == null || w(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(xa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(ya, { className: "tw-text-xs tw-font-medium", children: v }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ o("p", { className: "tw-text-sm tw-font-medium", children: N }),
            /* @__PURE__ */ o("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: D })
          ] }),
          p && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: b,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), x()) : k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), zt(h) && y());
              },
              onKeyDown: (k) => {
                ba(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  er,
        ...
        a && !t && s !== "Resolved" && i && /* @__PURE__ */ o(
          L,
          {
            ...
            onClick: (k) => {
              k.stopPropagation(), i(e.thread, !0);
            },
            children: /* @__PURE__ */ o(Rt, {})
          }
        ),
        V && /* @__PURE__ */ c(pe, { children: [
          /* @__PURE__ */ o(Oe, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(po, {}) }) }),
          /* @__PURE__ */ o(Jt, { align: "end", children: V })
        ] })
      ]
    }
  );
...
function Yw({
  ...
  const [u, b] = A($n), [x, y] = A(!1), [D, N] = A(!1), [v, C] = A(!1), [V, k] = A(!1), _ = B(() => e.filter((I) => !I.deleted), [e]), T = B(() => _[0], [_]), E = rt(null), S = rt(void 0);
  W(() => {
    const I = E.current;
    if (!I) return;
    const st = () => {
  ...
  const $ = B(
    ...
    [a, t]
  ), H = B(() => _.slice(1), [_]), O = B(() => H.length ?? 0, [H.length]), Z = B(() => O > 0, [O]), M = B(() => v || O <= 2 ? H : H.slice(-2), [H, O, v]), Q = B(() => v || O <= 2 ? 0 : O - 2, [O, v]), yt = B(
    () => O === 1 ? $.singleReply : fe($.multipleReplies, { count: O }),
    [O, $]
  ), Bt = B(
    ...
    var st;
    await p(l, nr(u)) && ((st = S.current) == null || st.call(S), b($n));
  }, [u, p, l]), P = j(
    async (I, st) => {
      var Ae;
      if (!w) return !1;
      const dt = zt(u) ? nr(u) : void 0, vt = await w(I, st, dt);
      return vt && dt && ((Ae = S.current) == null || Ae.call(S), b($n)), vt;
    },
    [u, w]
  );
  return /* @__PURE__ */ o(
    _r,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(va, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            D && /* @__PURE__ */ o(
              L,
              {
                ...
                children: x ? /* @__PURE__ */ o(Fn, {}) : /* @__PURE__ */ o(se, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
            ro,
            {
              ...
              isThreadExpanded: n,
              threadStatus: d,
              isEditable: _.length === 1 && (T == null ? void 0 : T.user) === s,
              handleSetCommentThreadStatus: P,
              handleUpdateComment: f,
              handleDeleteComment: h,
              onEditingChange: k
            }
        ...
        /* @__PURE__ */ c(ot, { children: [
          Z && !n && /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          n && /* @__PURE__ */ c(ot, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    v ? /* @__PURE__ */ o(Fn, {}) : /* @__PURE__ */ o(se, {})
                  ] })
                ]
              }
            ),
            M.map((I) => {
              const dt = I.id === H[H.length - 1].id && I.user === s;
            ...
            (!V || zt(u)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (I) => {
                  I.key === "Enter" && I.shiftKey && (I.preventDefault(), I.stopPropagation(), zt(u) && Ct());
                },
                onKeyDown: (I) => {
                  ba(I), (I.key === "Enter" || I.key === " ") && I.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    er,
...
function bp({
  ...
  const [d, w] = A(), p = t.filter(
    ...
    w(N);
  }, []), { listboxRef: b, activeId: x, handleKeyDown: y } = Sl({
    options: f,
    onOptionSelect: h
  }), D = j(
    (N) => {
...
function qw({ table: e }) {
  return /* @__PURE__ */ c(pe, { children: [
    /* @__PURE__ */ o(Fi, { asChild: !0, children: /* @__PURE__ */ c(L, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(ys, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ c(Jt, { align: "end", className: "tw-w-[150px]", children: [
...
const Ne = at.Root, Jw = at.Group, ke = at.Value, Ww = qt(
  ...
  return /* @__PURE__ */ c(
    at.Trigger,
    {
      ...
      children: [
        t,
        /* @__PURE__ */ o(at.Icon, { asChild: !0, children: /* @__PURE__ */ o(se, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
le.displayName = at.Trigger.displayName;
const Ea = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  at.ScrollUpButton,
  {
    ref: n,
...
Ea.displayName = at.ScrollUpButton.displayName;
...
Sa.displayName = at.ScrollDownButton.displayName;
const we = g.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, a) => {
  const s = wt();
  return /* @__PURE__ */ o(at.Portal, { children: /* @__PURE__ */ c(
    at.Content,
    {
      ref: a,
      className: m(
...
we.displayName = at.Content.displayName;
const Zw = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  at.Label,
  {
    ref: n,
...
Zw.displayName = at.Label.displayName;
const xt = g.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  at.Item,
  {
    ref: r,
    className: m(
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(at.ItemIndicator, { children: /* @__PURE__ */ o(Rt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ o(at.ItemText, { children: t })
    ]
  }
));
xt.displayName = at.Item.displayName;
...
Qw.displayName = at.Separator.displayName;
function td({ table: e }) {
...
function qe(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && ed(r)
  );
}
...
const nd = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "tfoot",
  {
    ref: n,
  ...
  const l = g.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), ad(u, b, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), od(l, x, p.key);
...
const Je = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "th",
  {
    ref: n,
    className: m(
...
const sd = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "caption",
  {
    ref: n,
...
function id({
  ...
  var k;
  const [p, f] = A([]), [h, u] = A([]), [b, x] = A({}), [y, D] = A({}), N = B(() => t ?? [], [t]), v = Do({
    data: N,
    columns: e,
    getCoreRowModel: Io(),
  ...
  let V;
  return d ? V = Array.from({ length: 10 }).map((E, S) => `skeleton-row-${S}`).map((E) => /* @__PURE__ */ o(It, { children: /* @__PURE__ */ o(ae, { colSpan: C.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(rr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((k = v.getRowModel().rows) == null ? void 0 : k.length) > 0 ? V = v.getRowModel().rows.map((_) => /* @__PURE__ */ o(
    It,
    {
      onClick: () => i(_, v),
      "data-state": _.getIsSelected() && "selected",
      children: _.getVisibleCells().map((T) => /* @__PURE__ */ o(ae, { children: je(T.column.columnDef.cell, T.getContext()) }, T.id))
    },
    _.id
  )) : V = /* @__PURE__ */ o(It, { children: /* @__PURE__ */ o(ae, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(qw, { table: v }),
    /* @__PURE__ */ c(yn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Nn, { stickyHeader: s, children: v.getHeaderGroups().map((_) => /* @__PURE__ */ o(It, { children: _.headers.map((T) => /* @__PURE__ */ o(Je, { children: T.isPlaceholder ? void 0 : je(T.column.columnDef.header, T.getContext()) }, T.id)) }, _.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(uo, {}) })
        ] }),
...
function yp({
  ...
  return /* @__PURE__ */ c(Re, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ c(ce, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
var dd = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(dd || {});
function Np({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ c(pe, { children: [
    /* @__PURE__ */ o(Oe, { asChild: !0, children: /* @__PURE__ */ c(L, { variant: "default", children: [
      /* @__PURE__ */ o(Es, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(se, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ o(Jt, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      /* @__PURE__ */ o(nn, { children: w.label }),
      /* @__PURE__ */ o(Na, { children: w.itemType === 0 ? /* @__PURE__ */ o(ot, { children: w.items.map((f, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Ht,
        {
          checked: r[p][h],
...
function cd({ id: e, versionHistory: t }) {
...
function _p({
  ...
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ o(cd, { versionHistory: a }),
...
function pd({
  ...
  const [D, N] = A(!1), v = j(
    ...
    const S = e.filter((z) => z.starred).sort((z, H) => z.label.localeCompare(H.label)), $ = e.filter((z) => !z.starred).sort((z, H) => {
      const O = t.includes(z.value), Z = t.includes(H.value);
      return O && !Z ? -1 : !O && Z ? 1 : z.label.localeCompare(H.label);
    });
    return [...S, ...$];
  }, [e, t, h]), k = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: y, className: b, children: /* @__PURE__ */ c(Re, { open: T, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ c(
      L,
      {
        variant: x,
    ...
    /* @__PURE__ */ o(ce, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(Ee, { children: [
...
function Cp({
  ...
  return /* @__PURE__ */ c("div", { id: f, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    t.length > 0 ? /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: t.map((h) => {
      var u;
      return /* @__PURE__ */ c(Ye, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ o(
          L,
          {
            variant: "ghost",
...
const ud = (e, t, n) => e === "generated" ? /* @__PURE__ */ c(ot, { children: [
  /* @__PURE__ */ o("p", { children: "+" }),
  " ",
  t["%footnoteEditor_callerDropdown_item_generated%"]
] }) : e === "hidden" ? /* @__PURE__ */ c(ot, { children: [
  /* @__PURE__ */ o("p", { children: "-" }),
  " ",
...
function md({
  ...
  return W(() => {
    ...
    l !== n && d(n);
  }, [n]), /* @__PURE__ */ c(pe, { onOpenChange: (p) => {
    p || (s !== "custom" || l ? (t(s), r(l)) : (i(e), d(n)));
  }, children: [
    /* @__PURE__ */ o(Mt, { children: /* @__PURE__ */ c(Ft, { children: [
      /* @__PURE__ */ o(oe, { asChild: !0, children: /* @__PURE__ */ o(Oe, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: ud(e, a, n) }) }) }),
      /* @__PURE__ */ o(At, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ c(Jt, { className: "tw-z-[300]", children: [
...
const hd = (e, t) => e === "f" ? /* @__PURE__ */ c(ot, { children: [
  /* @__PURE__ */ o(ho, {}),
  " ",
  t["%footnoteEditor_noteType_footnote_label%"]
] }) : e === "fe" ? /* @__PURE__ */ c(ot, { children: [
  /* @__PURE__ */ o(fo, {}),
  " ",
...
function gd({
  ...
  return /* @__PURE__ */ c(pe, { children: [
    /* @__PURE__ */ o(Mt, { children: /* @__PURE__ */ c(Ft, { children: [
      ...
      /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o("p", { children: fd(e, n) }) })
    ] }) }),
    e !== "x" && /* @__PURE__ */ c(Jt, { className: "tw-z-[300]", children: [
...
function Ep({
  ...
  const l = rt(null), d = cs(), [w, p] = A("generated"), [f, h] = A("*"), [u, b] = A("f"), x = B(
    () => ({
      ...s,
  ...
  W(() => {
    ...
    if (C && Tn("note", C)) {
      const _ = (V = C.insert.note) == null ? void 0 : V.caller;
      let T = "custom";
      _ === Xn ? T = "generated" : _ === Kn ? T = "hidden" : _ && h(_), p(T), b(((k = C.insert.note) == null ? void 0 : k.style) ?? "f"), C.insert.note && (C.insert.note.caller = ""), v = setTimeout(() => {
        var E;
        (E = l.current) == null || E.applyUpdate([{ delete: 1 }, C]);
      }, 0);
    }
    return () => {
      v && clearTimeout(v);
  ...
  const y = j(() => {
    ...
    v && Tn("note", v) && (v.insert.note && (w === "custom" ? v.insert.note.caller = f : v.insert.note.caller = w === "generated" ? Xn : Kn), t([v]));
  }, [w, f, t]), D = () => {
    var C;
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
        ...
        /* @__PURE__ */ o(
          gd,
          {
            ...
            handleNoteTypeChange: (v) => {
              var V, k, _;
              b(v);
              const C = (k = (V = l.current) == null ? void 0 : V.getNoteOps(0)) == null ? void 0 : k.at(0);
              C && Tn("note", C) && (C.insert.note && (C.insert.note.style = v), (_ = l.current) == null || _.applyUpdate([{ delete: 1 }, C]));
            },
            localizedStrings: i
          }
        ),
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ o(qi, { options: x, onScrRefChange: () => {
          }, scrRef: r, ref: l }),
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Mt, { children: /* @__PURE__ */ c(Ft, { children: [
            /* @__PURE__ */ o(oe, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: D, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(uo, {}) }) }),
...
function xd({
  ...
  const d = r ? /* @__PURE__ */ o("span", { className: "marker", children: `\\${e.marker} ` }) : void 0, w = r ? /* @__PURE__ */ o("span", { className: "marker", children: ` \\${e.marker}*` }) : void 0, p = /* @__PURE__ */ c(ot, { children: [
  ...
  return /* @__PURE__ */ c(ot, { children: [
    ...
    /* @__PURE__ */ o("div", { className: m("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ o(ot, { children: bd(e.marker, l, r, w) }) })
  ] });
}
const Tp = ["%webView_footnoteList_header%"], yd = (e, t) => e[t] ?? t;
function Rp({
  className: e,
  classNameForItems: t,
  footnotes: n,
  ...
  const f = p ? yd(p, "%webView_footnoteList_header%") : "Footnotes", h = d ?? ei(n, void 0), u = (v, C) => {
    w == null || w(v, C, a);
  }, b = s ? n.findIndex((v) => v === s) : 0, [x, y] = A(b), D = (v) => {
    if (n.length)
      switch (v.key) {
        case "ArrowDown":
          ...
          "div",
          {
            ...
            children: n.map((v, C) => {
              ...
              return /* @__PURE__ */ c(ot, { children: [
                ...
                C < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(ye, {})
              ] });
            })
          }
        )
...
function kd({
  ...
  return /* @__PURE__ */ c(yn, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Nn, { stickyHeader: !0, children: /* @__PURE__ */ c(It, { children: [
      /* @__PURE__ */ o(Je, { children: r }),
      /* @__PURE__ */ o(Je, { children: a })
    ] }) }),
    /* @__PURE__ */ o(kn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      It,
      {
        onClick: () => {
          t(i.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ o(ae, { children: Nd(i.text) })
        ]
      },
...
const Sr = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Un.Root,
  {
    ref: n,
    className: m(
...
Sr.displayName = Un.Root.displayName;
const _n = (e) => e === "asc" ? /* @__PURE__ */ o(Vs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Dp = (e) => ({
  ...
  header: ({ column: t }) => /* @__PURE__ */ c(L, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    _n(t.getIsSorted())
  ] })
}), _d = (e, t) => ({
  ...
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ c(L, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    _n(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ c(L, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    e,
    _n(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ c(kr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ o(
        He,
        {
          onClick: (d) => {
  ...
  return t ? t[1] : "";
}, Cd = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", $p = Object.freeze([
...
function Pp({
  ...
  const f = Et(n, "%webView_inventory_all%"), h = Et(n, "%webView_inventory_approved%"), u = Et(n, "%webView_inventory_unapproved%"), b = Et(n, "%webView_inventory_unknown%"), x = Et(n, "%webView_inventory_scope_currentBook%"), y = Et(n, "%webView_inventory_scope_chapter%"), D = Et(n, "%webView_inventory_scope_verse%"), N = Et(n, "%webView_inventory_filter_text%"), v = Et(
    n,
    "%webView_inventory_show_additional_items%"
  ), C = Et(n, "%webView_inventory_no_results%"), [V, k] = A(!1), [_, T] = A("all"), [E, S] = A(""), [$, z] = A([]), H = B(() => {
    const P = e ?? [];
    return P.length === 0 ? [] : Sd(P, a, s);
  }, [e, a, s]), O = B(() => {
    if (V) return H;
    const P = [];
    return H.forEach((I) => {
      const st = I.items[0], dt = P.find(
        (vt) => vt.items[0] === st
      );
      dt ? (dt.count += I.count, dt.occurrences = dt.occurrences.concat(I.occurrences)) : P.push({
        items: [st],
        count: I.count,
  ...
  }, [V, H]), Z = B(() => O.length === 0 ? [] : Ed(O, _, E), [O, _, E]), M = B(() => {
    var st, dt;
    if (!V) return d;
    ...
    for (let vt = 0; vt < P; vt++)
      I.push(
        _d(
          ((dt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : dt[vt]) || "Additional Item",
          vt + 1
        )
      );
    return [...I, ...d];
  ...
  const Q = (P, I) => {
    ...
    if (O.length === 0 || $.length === 0) return [];
    const P = O.filter((I) => go(
      V ? I.items : [I.items[0]],
      $
    ));
        ...
        Ne,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ c(we, { children: [
              ...
              /* @__PURE__ */ o(xt, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ c(Ne, { onValueChange: (P) => yt(P), defaultValue: i, children: [
        /* @__PURE__ */ o(le, { className: "tw-m-1", children: /* @__PURE__ */ o(ke, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(we, { children: [
          /* @__PURE__ */ o(xt, { value: "book", children: x }),
          /* @__PURE__ */ o(xt, { value: "chapter", children: y }),
          /* @__PURE__ */ o(xt, { value: "verse", children: D })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Me,
...
const Td = "16rem", Rd = "3rem", Ra = g.createContext(void 0);
function Cn() {
...
const Da = g.forwardRef(
  ({
    ...
    const [w, p] = g.useState(e), f = t ?? w, h = g.useCallback(
      (v) => {
        const C = typeof v == "function" ? v(f) : v;
        n ? n(C) : p(C);
      },
      [n, f]
    ), u = g.useCallback(() => h((v) => !v), [h]), b = f ? "expanded" : "collapsed", D = wt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = g.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ o(Ra.Provider, { value: N, children: /* @__PURE__ */ o(Mt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Oa = g.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Cn();
...
const Dd = g.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Cn();
  return /* @__PURE__ */ c(
    L,
    {
...
Ad.displayName = "SidebarFooter";
const Vd = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  ye,
  {
    ref: n,
...
const ar = g.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? _e : "div",
  {
    ref: r,
...
const $d = g.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? _e : "button",
  {
    ref: r,
...
$d.displayName = "SidebarGroupAction";
...
const Pd = qt(
  ...
  ({
    ...
    const d = e ? _e : "button", { state: w } = Cn(), p = /* @__PURE__ */ o(
      d,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": t,
        className: m(Pd({ variant: n, size: r }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o(oe, { asChild: !0, children: p }),
      /* @__PURE__ */ o(At, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : p;
  }
);
$a.displayName = "SidebarMenuButton";
const Ld = g.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? _e : "button",
  {
    ref: a,
...
const zd = g.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
zd.displayName = "SidebarMenuSkeleton";
...
jd.displayName = "SidebarMenuSub";
const Fd = g.forwardRef(
  ({ ...e }, t) => /* @__PURE__ */ o("li", { ref: t, ...e })
);
Fd.displayName = "SidebarMenuSubItem";
const Gd = g.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? _e : "a",
  {
    ref: s,
...
const jt = "scrBook", Xd = "scrRef", ee = "source", Kd = "details", Ud = "Scripture Reference", Yd = "Scripture Book", Pa = "Type", qd = "Details";
function Jd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: jt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Ud,
      cell: (r) => {
    ...
    },
    {
      ...
      id: Kd,
      header: (e == null ? void 0 : e.detailsColumnName) ?? qd,
      cell: (r) => r.getValue(),
      enableGrouping: !1
    }
  ];
...
}, so = (e) => `${Wd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Bp({
  sources: e,
  ...
  const [w, p] = A([]), [f, h] = A([{ id: jt, desc: !1 }]), [u, b] = A({}), x = B(
  ...
  W(() => {
    if (l) {
      const E = D.getSelectedRowModel().rowsById, S = Object.keys(E);
      if (S.length === 1) {
        const $ = x.find((z) => so(z) === S[0]) || void 0;
        $ && l($);
      }
    }
  }, [u, x, l, D]);
  const N = a ?? Yd, v = s ?? Pa, C = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [jt] },
    { label: `Group by ${v}`, value: [ee] },
    {
  ...
  }, _ = (E, S) => E.getIsGrouped() ? "" : m("banded-row", S % 2 === 0 ? "even" : "odd"), T = (E, S, $) => {
    ...
    !t && /* @__PURE__ */ c(
      Ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(we, { position: "item-aligned", children: /* @__PURE__ */ o(Jw, { children: C.map((E) => /* @__PURE__ */ o(xt, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(yn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Nn, { children: D.getHeaderGroups().map((E) => /* @__PURE__ */ o(It, { children: E.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(Je, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ o(kn, { children: D.getRowModel().rows.map((E, S) => {
        const $ = wt();
        return /* @__PURE__ */ o(
          It,
          {
              ...
              if (!(z.getIsPlaceholder() || z.column.columnDef.enableGrouping && !z.getIsGrouped() && (z.column.columnDef.id !== ee || !n)))
                return /* @__PURE__ */ o(
                  ae,
                  {
                    ...
                    children: z.getIsGrouped() ? /* @__PURE__ */ c(
                      L,
                      {
                        variant: "link",
...
}), La = (e, t, n) => Rr(e, t).every((r) => n.includes(r));
function Zd({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
...
function Qd({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], d = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], f = r["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: b, extraLong: x } = {
  ...
  }, [y, D] = A(!1), [N, v] = A(""), C = rt(void 0), V = rt(!1);
  if (e.length !== q.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const k = B(() => q.allBookIds.filter(
    (O, Z) => e[Z] === "1" && !q.isObsolete(q.bookIdToNumber(O))
  ), [e]), _ = B(() => {
    if (!N.trim()) {
      const M = {
        [G.OT]: [],
    ...
    (O, Z = !1) => {
      if (!Z || !C.current) {
        n(
          t.includes(O) ? t.filter((P) => P !== O) : [...t, O]
        ), C.current = O;
        return;
      }
      const M = k.findIndex((P) => P === C.current), Q = k.findIndex((P) => P === O);
      if (M === -1 || Q === -1) return;
      const [yt, Bt] = [
        Math.min(M, Q),
        Math.max(M, Q)
      ], Ct = k.slice(yt, Bt + 1).map((P) => P);
      n(
        t.includes(O) ? t.filter((P) => !Ct.includes(P)) : [.../* @__PURE__ */ new Set([...t, ...Ct])]
      );
    },
    [t, n, k]
  ), E = (O) => {
    T(O, V.current), V.current = !1;
  }, S = (O, Z) => {
    O.preventDefault(), T(Z, O.shiftKey);
  }, $ = j(
    (O) => {
      const Z = Rr(k, O).map((M) => M);
      n(
        La(k, O, t) ? t.filter((M) => !Z.includes(M)) : [.../* @__PURE__ */ new Set([...t, ...Z])]
      );
    },
    [t, n, k]
  ), z = () => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ c(
      Re,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ce, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            Ee,
            {
              shouldFilter: !1,
              onKeyDown: (O) => {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: z, children: d }),
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: H, children: w })
                ] }),
                /* @__PURE__ */ c(Se, { children: [
                  /* @__PURE__ */ o(bn, { children: p }),
                  Object.values(G).map((O, Z) => {
                    const M = _[O];
                    if (M.length !== 0)
                      return /* @__PURE__ */ c(lo, { children: [
                        /* @__PURE__ */ o(
                          Kt,
                          {
                            heading: Ho(O, h, u, b, x),
                        ...
                        Z < Object.values(G).length - 1 && /* @__PURE__ */ o(Po, {})
                      ] }, O);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ c("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Ln ? Ln : io
      ).map((O) => /* @__PURE__ */ o(Ye, { className: "hover:tw-bg-secondary", variant: "secondary", children: ge(O, a) }, O)),
...
function jp({
  ...
  const w = Zt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Zt(i, "%webView_scope_selector_current_book%"), u = Zt(i, "%webView_scope_selector_choose_books%"), b = Zt(i, "%webView_scope_selector_scope%"), x = Zt(i, "%webView_scope_selector_select_books%"), y = [
  ...
  ], D = t ? y.filter((N) => t.includes(N.value)) : y;
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        gr,
        {
          ...
          children: D.map(({ value: N, label: v, id: C }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(cn, { className: "tw-me-2", value: N, id: C }),
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Ft, { children: [
  /* @__PURE__ */ o(oe, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    pn,
    {
      onClick: () => {
        r(l);
...
function ir({
  ...
  return /* @__PURE__ */ c(pe, { variant: s, children: [
    /* @__PURE__ */ o(Oe, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(L, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(js, {}) }) }),
    /* @__PURE__ */ o(Jt, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(lo, { children: [
      /* @__PURE__ */ o(Na, { children: /* @__PURE__ */ o(Mt, { children: za(t.groups, t.items, d, e) }) }),
      w < p.length - 1 && /* @__PURE__ */ o(Ie, {})
    ] }, d)) })
  ] });
}
const ja = g.forwardRef(
...
const Fa = g.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    gt.Root,
    {
...
const Ga = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.List,
  {
    ref: n,
    className: m(
...
const tc = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Trigger,
  {
    ref: n,
    ...t,
...
)), Ha = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Content,
  {
    ref: n,
    className: m(
...
function Yp({
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(Fa, { children: [
      /* @__PURE__ */ o(Ga, { children: e.map((l) => /* @__PURE__ */ o(tc, { value: l.value, children: l.value }, l.key)) }),
...
const Xa = g.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  const a = g.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ o(Cr.Provider, { value: a, children: /* @__PURE__ */ o(
    et.Root,
    {
      ref: r,
      className: m(
...
const Ua = g.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = _t();
  return /* @__PURE__ */ c(
    et.SubTrigger,
    {
...
const Ya = g.forwardRef(({ className: e, ...t }, n) => {
  const r = _t();
  return /* @__PURE__ */ o(
    et.SubContent,
    {
...
const qa = g.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: r = 8, ...a }, s) => {
  const i = _t();
...
const Ja = g.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = _t();
  return /* @__PURE__ */ o(
    et.Item,
    {
...
const rc = g.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = _t();
  return /* @__PURE__ */ c(
    et.CheckboxItem,
    {
...
rc.displayName = et.CheckboxItem.displayName;
const oc = g.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = _t();
  return /* @__PURE__ */ c(
    et.RadioItem,
    {
...
oc.displayName = et.RadioItem.displayName;
const ac = g.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  et.Label,
  {
    ref: r,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
ac.displayName = et.Label.displayName;
const Wa = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  et.Separator,
  {
    ref: n,
    className: m("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
const Le = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Ft, { children: [
      /* @__PURE__ */ o(oe, { asChild: !0, children: "command" in w ? /* @__PURE__ */ c(
        Ja,
        {
          onClick: () => {
            r(w);
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ o(Wa, {}, `separator-${s}`)), d;
  });
};
function sc({
  menuData: e,
  ...
  if (Ji(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), Le(s, [h, u]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Le(i, [h, u]);
        break;
      case "alt+n":
        (y = l.current) == null || y.focus(), Le(l, [h, u]);
        break;
      case "alt+h":
        (D = d.current) == null || D.focus(), Le(d, [h, u]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ o(Xa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(ec, { children: [
      /* @__PURE__ */ o(Ka, { ref: w(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ o(
        qa,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Mt, { children: Za(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function Wp({
  ...
  const w = ic(
    ...
    var D, N, v, C, V, k;
    const y = x !== b ? ((N = (D = e[b]) == null ? void 0 : D.uiNames) == null ? void 0 : N[x]) ?? ((C = (v = e[b]) == null ? void 0 : v.uiNames) == null ? void 0 : C.en) : void 0;
    return y ? `${(V = e[b]) == null ? void 0 : V.autonym} (${y})` : (k = e[b]) == null ? void 0 : k.autonym;
  };
      ...
      Ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(e).map((b) => /* @__PURE__ */ o(xt, { value: b, children: u(b, t) }, b))
            }
          )
        ]
      }
...
function lc({ item: e, createLabel: t, createComplexLabel: n }) {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ c(pe, { children: [
              /* @__PURE__ */ o(Oe, { className: m(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(po, {}) }) }),
...
const wc = We(({ className: e, ...t }, n) => /* @__PURE__ */ o(Hs, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
wc.displayName = "Spinner";
function tu({
  id: e,
  isDisabled: t = !1,
  hasError: n = !1,
...
), cc = g.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
pc.displayName = "AlertTitle";
const uc = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
uc.displayName = "AlertDescription";
const eu = nt.Root, nu = nt.Trigger, ru = nt.Group, ou = nt.Portal, au = nt.Sub, su = nt.RadioGroup, mc = g.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
mc.displayName = nt.SubTrigger.displayName;
const hc = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  nt.SubContent,
  {
    ref: n,
    className: m(
...
hc.displayName = nt.SubContent.displayName;
const fc = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(nt.Portal, { children: /* @__PURE__ */ o(
  nt.Content,
  {
    ref: n,
    className: m(
...
fc.displayName = nt.Content.displayName;
const gc = g.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Item,
  {
    ref: r,
    className: m(
...
gc.displayName = nt.Item.displayName;
const bc = g.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
bc.displayName = nt.CheckboxItem.displayName;
const vc = g.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: r,
    className: m(
...
vc.displayName = nt.RadioItem.displayName;
const xc = g.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Label,
  {
    ref: r,
    className: m(
...
xc.displayName = nt.Label.displayName;
const yc = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  nt.Separator,
  {
    ref: n,
...
yc.displayName = nt.Separator.displayName;
...
Nc.displayName = "ContextMenuShortcut";
...
kc.displayName = "Drawer";
const iu = kt.Trigger, _c = kt.Portal, lu = kt.Close, ts = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  kt.Overlay,
  {
    ref: n,
...
const Cc = g.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
  const { direction: s = "bottom" } = g.useContext(Qa), i = {
...
Tc.displayName = kt.Title.displayName;
...
Rc.displayName = kt.Description.displayName;
const Dc = g.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  Yn.Root,
  {
    ref: r,
    className: m(
...
Dc.displayName = Yn.Root.displayName;
function wu({
  className: e,
  ...t
}) {
...
const Oc = g.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ c(
    Be.Root,
    {
...
Oc.displayName = Be.Root.displayName;
...
Ic.displayName = qn.Root.displayName;
const uu = gt.Root, Mc = g.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    gt.List,
    {
...
Mc.displayName = gt.List.displayName;
const Ac = g.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Trigger,
  {
    ref: n,
    className: m(
...
Ac.displayName = gt.Trigger.displayName;
...
Vc.displayName = gt.Content.displayName;
...
export {
  ...
  bp as CommentList,
  eu as ContextMenu,
  bc as ContextMenuCheckboxItem,
  fc as ContextMenuContent,
  ru as ContextMenuGroup,
  gc as ContextMenuItem,
  xc as ContextMenuLabel,
  ou as ContextMenuPortal,
  su as ContextMenuRadioGroup,
  vc as ContextMenuRadioItem,
  yc as ContextMenuSeparator,
  Nc as ContextMenuShortcut,
  au as ContextMenuSub,
  hc as ContextMenuSubContent,
  mc as ContextMenuSubTrigger,
  nu as ContextMenuTrigger,
  id as DataTable,
  kc as Drawer,
  lu as DrawerClose,
  Cc as DrawerContent,
  Rc as DrawerDescription,
  Sc as DrawerFooter,
  Ec as DrawerHeader,
  ts as DrawerOverlay,
  _c as DrawerPortal,
  ...
  Fd as SidebarMenuSubItem,
  Da as SidebarProvider,
  Od as SidebarRail,
  Vd as SidebarSeparator,
  Dd as SidebarTrigger,
  rr as Skeleton,
  Oc as Slider,
  pu as Sonner,
  wc as Spinner,
