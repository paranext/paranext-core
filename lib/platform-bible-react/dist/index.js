...
import Yt, { useRef as B, useMemo as A, createContext as ua, useContext as vo, useState as _, useEffect as W, useCallback as L, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Uo, Suspense as pc, forwardRef as Fn, useId as Ko, Fragment as pa } from "react";
...
function Ra({
  ...
  const U = ye(), V = zl(), D = T ?? V, [K, Y] = _(!1), [H, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [q, nt] = _(void 0), [at, pt] = _(
    void 0
  ), [dt, J] = _(void 0), [wt, gt] = _(!1), [ft, mt] = _(!1), Jt = B(null), vt = B(!1), Pt = B(void 0), At = B(void 0), bt = B(void 0), Bt = B(void 0), Tt = B({}), Ft = B({}), ct = L(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
  ...
  const { otLong: st, ntLong: ht, dcLong: xt, extraLong: _t } = {
    ...
    [t.book, i, D]
  ), He = `${t.chapterNum}:${t.verseNum}`, $r = L((k) => (rt) => {
    Tt.current[k] = rt;
  }, []), va = L((k) => (rt) => {
    Ft.current[k] = rt;
  }, []), Pr = A(
    () => Pl(I),
    [I]
  ), fr = A(() => !w || !M || !M.chapterNum || !Pr ? !1 : w(M.book, M.chapterNum) > 0, [w, M, Pr]), Ar = N === "books" && !wt && !I.trim() && Kt.size > 0, mr = L(
    (k) => p ? Zo(k, p) : !1,
    [p]
  ), vr = L(
    (k) => (rt) => p ? Al(k, rt, p) : !1,
    ...
    [We, i]
  ), ya = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", ka = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", _a = L(
    (k) => {
...
function Ql() {
  return function(t) {
    const [e] = _e(), r = A(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = B(o);
    return Jl(() => {
...
function Bd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: v = "textbox", spellCheck: R = !0, style: y, tabIndex: C, "data-testid": E, ...$ }, T) {
  const [U, V] = _(t.isEditable()), D = L((Y) => {
...
function Pi({
  ...
  const [H, Q] = _(mn), [I, tt] = _(), [N, z] = _(), q = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(E), [At, bt] = _(!1), Bt = B(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let x = !0;
    return (async () => {
  ...
  const Vt = A(() => kt[0], [kt]), ie = B(null), se = B(void 0), Ut = L(() => {
    var x;
  ...
  const S = L(
    async (x) => {
      ...
      j && await p({ threadId: l, contents: j }) && Ut();
    },
    [
      Ut,
      H,
    ...
    async (x) => {
      const j = oe(H) ? sa(H) : void 0, P = x.status ? x.assignedUser : I ?? x.assignedUser, et = await p({
        ...x,
        contents: j,
        assignedUser: P
      });
      return et && (P !== void 0 && z(P), j && Ut()), et;
    },
    [Ut, H, p, I]
  );
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            ...
            v !== !1 && (!pt || oe(H)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  Mo(x) && (x.preventDefault(), x.stopPropagation(), (oe(H) || I !== void 0 && I !== N) && S());
                },
                onKeyDown: (x) => {
...
function ww({
  ...
  const [s, c] = _("accept"), l = Ko(), d = Ko(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = A(
    () => Qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Qr(t.acceptedText ?? ""),
...
function Lp({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [E, $] = _(), [T, U] = _(), V = L(
    async (z) => {
      const q = await i(z);
...
function kw({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, R] = _({}), y = A(() => e ?? [], [e]), C = ai({
    data: y,
    columns: t,
    getCoreRowModel: ni(),
...
function Dw({
  ...
  const n = B(null), i = B(null), s = B(!1), [c, l] = _(t), [d, w] = _(e), [p, h] = _(!1), g = B(!1), f = B(c);
  f.current = c;
  const b = B(d);
  b.current = d, W(() => {
    l(t);
...
function Yp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [E, $] = _("*"), [T, U] = _("*"), [V, D] = _("f"), [K, Y] = _(!1), [H, Q] = _(!0), [I, tt] = _(!1), N = B(!1), z = B(""), [q, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = B(null), vt = B(
    void 0
  ), Pt = B(0), At = B(void 0), bt = A(
    () => ({
      ...s,
  ...
  const Tt = L(() => {
    var x, j, P;
    const S = (x = g.current) == null ? void 0 : x.querySelector(".editor-input"), F = S == null ? void 0 : S.querySelector("span.note"), G = (P = (j = g.current) == null ? void 0 : j.ownerDocument.getSelection()) == null ? void 0 : P.anchorNode;
  ...
  W(() => {
    ...
    if (x && xr("note", x)) {
      const et = (j = x.insert.note) == null ? void 0 : j.caller;
      let st = "custom";
      et === Ja ? st = "generated" : et === Za ? st = "hidden" : et && ($(et), U(et)), R(st), C(st), D(((P = x.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
        (ht = h.current) == null || ht.applyUpdate([x]), (xt = h.current) == null || xt.selectNote(0), (_t = h.current) == null || _t.focus(), F = requestAnimationFrame(() => {
          G = setTimeout(() => {
            var jt, re;
  ...
  const Ft = L(
    (S = !1) => {
      var G, x, j;
      p == null || p();
      const F = (x = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : x.at(0);
    ...
    (S, F) => {
      ...
      let x;
      S === "custom" ? x = F : S === "generated" ? x = Ja : x = Za, G.insert.note.caller !== x && (G.insert.note.caller = x, (et = h.current) == null || et.applyUpdate([G, { delete: 1 }]));
    },
    []
  ), kt = L(() => {
    var S;
  ...
  const ie = B({ book: n.book, chapterNum: n.chapterNum });
  te(() => {
  ...
  const se = () => {
    ...
    if (F && xr("note", F)) {
      ...
      V !== "x" && S === "x" ? st == null || st.forEach((ht) => Bw(ht)) : V === "x" && S !== "x" && (st == null || st.forEach((ht) => Fw(ht))), (et = h.current) == null || et.applyUpdate([F, { delete: 1 }]);
    }
  }, Kt = (S) => {
    ...
    (S) => {
      ...
      if (F && xr("note", F)) {
        ...
        if (st || Y(!1), Y(
          ...
          N.current = !0, z.current = JSON.stringify(F), Q(!0);
          return;
        }
        Q(JSON.stringify(F) === z.current), Ft();
      } else
        Y(!1), Q(!0);
    },
    [Ft]
    ...
    if (f.current && Bt.length && S && S.rangeCount > 0) {
      ...
      pt(F.left - G.left), J(F.top - G.top), gt(F.height), nt(!0);
    }
  }, [Bt, f]), M = B(() => {
  }), ce = L(
    (S, F, G) => {
    ...
    (S) => {
      ...
      cs(S, F, {
        ...
        commitTyped: (x) => {
          var j;
          return (j = h.current) == null ? void 0 : j.commitTypedMarker(x);
        },
        commitTypedAndReopen: (x) => {
          var j;
          (j = h.current) == null || j.commitTypedMarker(x, { trailingSpace: !1 }), Lt();
        },
        commitTypedCloser: (x) => {
          var j;
          return (j = h.current) == null ? void 0 : j.commitTypedCloser(x);
        },
        commitItem: (x) => {
          var P;
          const j = F.items.find((et) => et.marker === x);
  ...
  W(() => {
    ...
    const F = (x) => {
      const j = S();
      !q && j && document.activeElement === j && x.key === c ? (x.preventDefault(), Zt()) : q && x.key === "Escape" && (x.preventDefault(), nt(!1));
    };
...
function xh({
  ...
  W(() => {
    if (c) {
      ...
      if (K.length === 1) {
        const Y = b.find((H) => Nn(H) === K[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, R]);
...
function vu({
  ...
  }, [v, R] = _(!1), [y, C] = _(""), E = B(void 0), $ = B(!1), T = A(
    () => On(t),
    [t]
  ), U = A(() => {
    if (!y.trim()) {
...
function kh({
  ...
  }, Pt = B(null), At = B(null), bt = B(!1), Bt = B(null), Tt = B(!1), [Ft, ct] = _(void 0), kt = B(!1), Vt = B(!1), ie = B(null), se = L((O) => {
    if (O) {
  ...
  ), Lt = gt.find((O) => O.value === "selectedBooks"), Ht = gt.find((O) => O.value === "range"), [ue, pe] = _(!1), [S, F] = _(void 0), [G, x] = _(void 0), [j, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", jt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  const Lr = L(
    (O) => {
      x(O), P(mt), st(Jt), xt(n), pe(!1), F(O);
    },
    [mt, Jt, n]
  ), jr = L(() => {
    G !== void 0 && (G === "range" ? (j && (g == null || g(j)), et && (f == null || f(et))) : G === "selectedBooks" && i(ht), ae(G), F(void 0), x(void 0));
  }, [
    G,
    j,
    et,
...
const Ju = (t, e, r = {}) => {
  ...
  const [e, r] = _(!1), [o, n] = _(!1), i = B(0), [s, c] = _(
    void 0
  ), l = L((g) => {
    i.current += 1;
    const f = i.current;
    return async () => {
      try {
        const b = await g();
        return f === i.current && (r(!1), n(!0)), b;
      } catch (b) {
        throw f === i.current && (r(!0), n(!0)), b;
      }
    };
  }, []);
  W(() => {
