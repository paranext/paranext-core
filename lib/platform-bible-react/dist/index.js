...
import Me from "@radix-ui/react-tabs";
...
const rl = fe.Root, ol = fe.Trigger, Wh = fe.Group, qh = fe.Portal, Xh = fe.Sub, Gh = fe.RadioGroup, il = me.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ ue(
  fe.SubTrigger,
  {
    ref: o,
    className: de(
...
function tm({ onSearch: e, placeholder: t }) {
  const [n, r] = Ee(""), o = (i) => {
    r(i), e(i);
  };
...
}, cm = Me.Root, Th = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  Me.List,
  {
    ref: n,
    className: de(
...
const pm = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  Me.Trigger,
  {
    ref: n,
    ...t,
