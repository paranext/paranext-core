...
import { X as qe, Search as Rn, ChevronsLeft as fn, ChevronsRight as gn, ChevronLeft as je, ChevronRight as ne, ArrowLeft as zr, Circle as Je, ChevronsUpDown as Ke, Check as At, FilterIcon as Or, ChevronDown as be, ChevronUp as Br, ArrowLeftIcon as Ar, ChevronLeftIcon as Pr, ChevronRightIcon as Ir, ArrowRightIcon as jr, Copy as $r, Filter as Xr, User as Fr, Link as Gr, CircleHelp as Lr, Star as Hr, CircleCheckIcon as Yr, CircleXIcon as Ur, CircleHelpIcon as qr, ArrowUpIcon as Jr, ArrowDownIcon as Kr, ArrowUpDownIcon as Wr, PanelLeft as Zr, PanelRight as Qr, ScrollText as ta, MenuIcon as ea, Menu as na, EllipsisVertical as ra, LoaderCircle as aa } from "lucide-react";
...
R(st, "Original", new st(mt.Original)), R(st, "Septuagint", new st(mt.Septuagint)), R(st, "Vulgate", new st(mt.Vulgate)), R(st, "English", new st(mt.English)), R(st, "RussianProtestant", new st(mt.RussianProtestant)), R(st, "RussianOrthodox", new st(mt.RussianOrthodox));
let Et = st;
function vn(t, e) {
  const n = e[0];
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Et(mt[i]);
        } catch {
...
const Va = ht.Portal, Xn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ht.Overlay,
  {
    ref: n,
    className: d(
...
Xn.displayName = ht.Overlay.displayName;
...
Da.displayName = ht.Content.displayName;
...
Ma.displayName = ht.Title.displayName;
...
za.displayName = ht.Description.displayName;
...
function qs({
  ...
  const o = J(), [s, i] = A(!1), [w, u] = A(""), [c, m] = A(""), [b, h] = A("books"), [f, x] = A(void 0), _ = U(void 0), y = U(void 0), C = U(void 0), N = U(void 0), D = U({}), O = H(() => a ? a() : Gn, [a]), K = H(() => ({
    OT: O.filter((k) => M.isBookOT(k)),
    NT: O.filter((k) => M.isBookNT(k)),
    DC: O.filter((k) => M.isBookDC(k)),
    Extra: O.filter((k) => M.extraBooks().includes(k))
  }), [O]), G = H(() => Object.values(K).flat(), [K]), St = H(() => {
    if (!c.trim()) return K;
    const v = c.toLowerCase(), k = { OT: [], NT: [], DC: [], Extra: [] };
    return ["OT", "NT", "DC", "Extra"].forEach((Q) => {
      k[Q] = K[Q].filter((Y) => lt[Y].toLowerCase().includes(v) || Y.toLowerCase().includes(v));
    }), k;
  }, [K, c]), S = I(
    (v) => {
      if (!v.trim()) return;
      const k = Ba.reduce(
        (P, Q) => {
          ...
          if (Y) {
            const [ot, it = void 0, Jt = void 0] = Y.slice(1);
            let tt;
            const Ee = ((wt) => Object.keys(lt).find(
              (It) => lt[It].toLowerCase() === wt.toLowerCase()
            ))(ot);
            if (Ee && G.includes(Ee) && (tt = Ee), !tt && M.isBookIdValid(ot)) {
              const wt = ot.toUpperCase();
              G.includes(wt) && (tt = wt);
            }
            if (!tt) {
              const wt = ot.toLowerCase(), It = G.filter((mn) => lt[mn].toLowerCase().includes(wt) || mn.toLowerCase().includes(wt));
              It.length === 1 && ([tt] = It);
            }
            if (tt) {
              let wt = it ? parseInt(it, 10) : void 0;
              wt && wt > xt(tt) && (wt = Math.max(xt(tt), 1));
    ...
    (v) => {
      const k = b === "chapters" ? f : g == null ? void 0 : g.book;
      k && (e({
        book: k,
        chapterNum: v,
        verseNum: 1
    ...
    if (t.chapterNum > 1)
      ...
      if (v > 0) {
        const k = G[v - 1], P = Math.max(xt(k), 1);
        e({
          book: k,
          chapterNum: P,
          verseNum: 1
    ...
    {
      onClick: Tt,
      disabled: (t.chapterNum === xt(t.book) || xt(t.book) === -1) && G.indexOf(t.book) === G.length - 1,
      title: "Next chapter",
      icon: o === "ltr" ? gn : fn
    }
  ], [
  ...
  }, [f, g == null ? void 0 : g.book, t.book, t.chapterNum]), qt = I((v, k) => `${v} ${lt[v]}${k ? ` ${k}` : ""}`, []), un = I((v) => (k) => {
    D.current[v] = k;
  }, []), Sr = I((v) => {
    ...
    (v) => {
      if (v.ctrlKey) return;
      const k = /^[a-zA-Z]$/.test(v.key), P = /^[0-9]$/.test(v.key);
      if (b === "chapters") {
        if (v.key === "Backspace") {
          v.preventDefault(), v.stopPropagation(), ft();
          return;
        }
        if (k || P) {
      ...
      if ((b === "chapters" || b === "books" && g) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        ...
        switch (v.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            it = Y === 0 ? ot : Math.max(1, Y - Jt);
            break;
          case "ArrowDown":
            it = Y === 0 ? 1 : Math.min(ot, Y + Jt);
            break;
          default:
            return;
        }
        it !== Y && (v.preventDefault(), v.stopPropagation(), u(qt(Q, it)), setTimeout(() => {
          const tt = D.current[it];
  ...
  return hn(() => {
    const v = setTimeout(() => {
      if (s && b === "books" && C.current && N.current) {
        const k = C.current, P = N.current, Q = P.offsetTop, Y = k.clientHeight, ot = P.clientHeight, it = Q - Y / 2 + ot / 2;
        k.scrollTo({
          top: Math.max(0, it),
          behavior: "smooth"
        }), u(qt(t.book));
    ...
    if (b === "chapters" && f) {
      ...
      setTimeout(() => {
        if (C.current)
          if (v) {
            const k = D.current[t.chapterNum];
      ...
      we,
      {
        ...
        children: [
          b === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: T.map(({ onClick: v, disabled: k, title: P, icon: Q }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
          ...
          /* @__PURE__ */ l(de, { ref: C, children: [
            b === "books" && /* @__PURE__ */ l(ee, { children: [
              ...
              g && /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(
                Nt,
                {
                  value: `${g.book} ${lt[g.book]} ${g.chapterNum || ""}:${g.verseNum || ""})}`,
                  onSelect: X,
              ...
              g && F && F.endChapter > 1 && /* @__PURE__ */ l(ee, { children: [
                ...
                /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-px-4 tw-pb-4", children: Array.from({ length: F.endChapter }, (v, k) => k + 1).map(
                  (v) => /* @__PURE__ */ r(
                    Nt,
                    {
                      value: `${g.book} ${lt[g.book]} ${v}`,
                      onSelect: () => W(v),
                      ref: un(v),
                      className: d(
            ...
            b === "chapters" && /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-p-4", children: F && Array.from({ length: F.endChapter }, (v, k) => k + 1).map(
              (v) => /* @__PURE__ */ r(
                Nt,
                {
                  value: `${f || ""} ${lt[f || ""] || ""} ${v}`,
...
function Ge({
  ...
  const [y, C] = A(!1);
  return /* @__PURE__ */ l(ce, { open: y, onOpenChange: C, ..._, children: [
...
const dt = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  L.Item,
  {
    ref: a,
    className: d(
...
dt.displayName = L.Item.displayName;
      ...
      /* @__PURE__ */ l(
        $t,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Bt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(dt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function no({
  ...
  var y;
  const [w, u] = A([]), [c, m] = A([]), [b, h] = A({}), [f, x] = A({}), _ = Vn({
    data: e,
    columns: t,
    getCoreRowModel: Mn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(La, { table: _ }),
    /* @__PURE__ */ l(ke, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ce, { stickyHeader: s, children: _.getHeaderGroups().map((C) => /* @__PURE__ */ r(Ct, { children: C.headers.map((N) => /* @__PURE__ */ r(se, { children: N.isPlaceholder ? void 0 : te(N.column.columnDef.header, N.getContext()) }, N.id)) }, C.id)) }),
      /* @__PURE__ */ r(_e, { children: (y = _.getRowModel().rows) != null && y.length ? _.getRowModel().rows.map((C) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(C, _),
          "data-state": C.getIsSelected() && "selected",
          children: C.getVisibleCells().map((N) => /* @__PURE__ */ r(Ft, { children: te(N.column.columnDef.cell, N.getContext()) }, N.id))
        },
        C.id
...
function io({
  ...
  const [b, h] = A(!1), f = I(
    (y) => {
      var N;
      const C = (N = t.find((D) => D.label === y)) == null ? void 0 : N.value;
      C && a(
    ...
    if (!u) return t;
    const y = t.filter((N) => N.starred).sort((N, D) => N.label.localeCompare(D.label)), C = t.filter((N) => !N.starred).sort((N, D) => {
  ...
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(ce, { open: b, onOpenChange: h, children: [
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(we, { children: [
      ...
      /* @__PURE__ */ l(de, { children: [
        ...
        /* @__PURE__ */ r(Dt, { children: _.map((y) => {
...
function ci({
  ...
  const c = bt(n, "%webView_inventory_all%"), m = bt(n, "%webView_inventory_approved%"), b = bt(n, "%webView_inventory_unapproved%"), h = bt(n, "%webView_inventory_unknown%"), f = bt(n, "%webView_inventory_scope_currentBook%"), x = bt(n, "%webView_inventory_scope_chapter%"), _ = bt(n, "%webView_inventory_scope_verse%"), y = bt(n, "%webView_inventory_filter_text%"), C = bt(
    n,
    "%webView_inventory_show_additional_items%"
    ...
    const T = [];
    return X.forEach((Z) => {
      const ut = Z.items[0], gt = T.find(
        (F) => F.items[0] === ut
      );
      gt ? (gt.count += Z.count, gt.occurrences = gt.occurrences.concat(Z.occurrences)) : T.push({
        items: [ut],
        count: Z.count,
    ...
    for (let F = 0; F < T; F++)
      Z.push(
        co(
          ((gt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : gt[F]) || "Additional Item",
          F + 1
        )
      );
    return [...Z, ...u];
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        $t,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l(Bt, { children: [
              /* @__PURE__ */ r(dt, { value: "all", children: c }),
              /* @__PURE__ */ r(dt, { value: "approved", children: m }),
              /* @__PURE__ */ r(dt, { value: "unapproved", children: b }),
              /* @__PURE__ */ r(dt, { value: "unknown", children: h })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ l($t, { onValueChange: (T) => Tt(T), defaultValue: i, children: [
        ...
        /* @__PURE__ */ l(Bt, { children: [
          /* @__PURE__ */ r(dt, { value: "book", children: f }),
          /* @__PURE__ */ r(dt, { value: "chapter", children: x }),
          /* @__PURE__ */ r(dt, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ r(
        ue,
...
const nr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), b = e ?? c, h = p.useCallback(
      ...
      [n, b]
    ), f = p.useCallback(() => h((D) => !D), [h]), x = b ? "expanded" : "collapsed", C = J() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = p.useMemo(
      () => ({
        state: x,
        open: b,
        setOpen: h,
    ...
    !e && /* @__PURE__ */ l(
      $t,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Bt, { position: "item-aligned", children: /* @__PURE__ */ r(Ha, { children: D.map((S) => /* @__PURE__ */ r(dt, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
...
function Go({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(ce, { open: y, onOpenChange: C, children: [
      /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ l(
        z,
        {
          variant: "outline",
...
function hi({
  ...
  const u = Rt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), b = Rt(i, "%webView_scope_selector_current_book%"), h = Rt(i, "%webView_scope_selector_choose_books%"), f = Rt(i, "%webView_scope_selector_scope%"), x = Rt(i, "%webView_scope_selector_select_books%"), _ = [
  ...
  ], y = e ? _.filter((C) => e.includes(C.value)) : _;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        tn,
        {
          ...
          children: y.map(({ value: C, label: N, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(he, { className: "tw-me-2", value: C, id: D }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Bt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(dt, { value: `${u}`, children: i[B(u)] }, `${u}`))
          }
        )
      ]
    }
  ...
  if (ua(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, b) => {
    ...
    switch (b.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (_ = i.current) == null || _.focus(), Wt(i, [h, f]);
        break;
      case "alt+n":
        (y = w.current) == null || y.focus(), Wt(w, [h, f]);
        break;
      case "alt+h":
        (C = u.current) == null || C.focus(), Wt(u, [h, f]);
        break;
    }
  }), Mt(() => {
...
function Ci({
  ...
  const u = Wo(
    ...
    var y, C, N, D, O, K;
    const _ = x !== f ? ((C = (y = t[f]) == null ? void 0 : y.uiNames) == null ? void 0 : C[x]) ?? ((D = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : D.en) : void 0;
    return _ ? `${(O = t[f]) == null ? void 0 : O.autonym} (${_})` : (K = t[f]) == null ? void 0 : K.autonym;
  };
      ...
      $t,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((f) => /* @__PURE__ */ r(dt, { value: f, children: h(f, e) }, f))
            }
          )
        ]
      }
