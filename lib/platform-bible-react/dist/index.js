...
import c, { forwardRef as Lt, createContext as Yn, useContext as Ln, useCallback as tt, useState as P, useRef as W, useEffect as dt, useLayoutEffect as Xe, useMemo as Z, Fragment as Hn } from "react";
...
import { useReactTable as qe, getFilteredRowModel as kr, getSortedRowModel as Je, getPaginationRowModel as Cr, getCoreRowModel as Ke, flexRender as Bt, getGroupedRowModel as Sr, getExpandedRowModel as Rr } from "@tanstack/react-table";
...
const ye = V.Trigger, Qe = V.Group, Vr = V.Portal, Dr = V.Sub, Ho = V.RadioGroup;
function qt({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(xe.Provider, { value: n, children: /* @__PURE__ */ r(V.Root, { ...e }) });
}
...
tn.displayName = V.SubTrigger.displayName;
...
nn.displayName = V.RadioItem.displayName;
...
Br.displayName = "DropdownMenuShortcut";
...
S(q, "Original", new q(nt.Original)), S(q, "Septuagint", new q(nt.Septuagint)), S(q, "Vulgate", new q(nt.Vulgate)), S(q, "English", new q(nt.English)), S(q, "RussianProtestant", new q(nt.RussianProtestant)), S(q, "RussianOrthodox", new q(nt.RussianOrthodox));
let ut = q;
function Fe(t, e) {
  const n = e[0];
...
const L = class T {
  constructor(e, n, a, o) {
    if (S(this, "firstChapter"), S(this, "lastChapter"), S(this, "lastVerse"), S(this, "hasSegmentsDefined"), S(this, "text"), S(this, "BBBCCCVVVS"), S(this, "longHashCode"), S(this, "versification"), S(this, "rtlMark", "‏"), S(this, "_bookNum", 0), S(this, "_chapterNum", 0), S(this, "_verseNum", 0), S(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, l = n != null && n instanceof ut ? n : void 0;
        ...
        if (e != null && e instanceof T) {
          ...
          if (e == null) return;
          const s = e instanceof ut ? e : T.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let p;
    return l && (p = new ut(l)), n ? new T(n, a.toString(), i, p) : new T();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const l = +s[1].trim();
          this.versification = new ut(nt[l]);
        } catch {
...
const Te = A.allBookIds.filter((t) => !A.isObsolete(A.bookIdToNumber(t))), Kr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
], It = (t) => xr(A.bookIdToNumber(t));
function Qr() {
  return Te.map((e) => A.bookIdToEnglishName(e));
}
function ta(t) {
...
function ea(t) {
  ...
  if (ta(e))
    return Te.find((a) => A.bookIdToEnglishName(a) === e);
}
function qo({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = F(), [s, l] = P(""), [i, p] = P(t.book), [u, h] = P(t.chapterNum ?? 0), [b, g] = P(t.book), [m, y] = P(!1), [_, N] = P(m), k = W(void 0), v = W(void 0), E = W(void 0), $ = tt(
    (C) => {
      const z = a ? a() : Te;
      return {
        OT: z.filter((O) => A.isBookOT(O)),
        NT: z.filter((O) => A.isBookNT(O)),
        DC: z.filter((O) => A.isBookDC(O))
      }[C].filter((O) => {
        const j = A.bookIdToEnglishName(O).toLowerCase(), f = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
        return j.includes(f) || // Match book name
    ...
    (C, z, O, j) => {
      if (h(t.book !== C ? 1 : t.chapterNum), z || It(C) === -1) {
        e({
          book: C,
          chapterNum: O ?? 1,
          verseNum: j ?? 1
    ...
    Zr.forEach((C) => {
      const z = C.exec(s);
      if (z) {
        const [O, j = void 0, f = void 0] = z.slice(1), G = ea(O);
        (A.isBookIdValid(O) || G) && x(
          G ?? O,
          !0,
          j ? parseInt(j, 10) : 1,
          f ? parseInt(f, 10) : 1
    ...
    (C) => {
      m ? (C.key === "ArrowDown" || C.key === "ArrowUp") && (E != null && E.current ? E.current.focus() : v.current && v.current.focus(), C.preventDefault()) : y(!0);
    },
    [m]
  ), ct = (C) => {
    const { key: z } = C;
    ...
    if (b === i) {
      if (z === "Enter") {
        C.preventDefault(), x(i, !0, u);
        return;
      }
      const O = z === "ArrowRight" && !o || z === "ArrowRight" && o === "ltr" || z === "ArrowLeft" && o === "rtl", j = z === "ArrowLeft" && !o || z === "ArrowLeft" && o === "ltr" || z === "ArrowRight" && o === "rtl";
      let f = 0;
      if (O)
        if (u < It(b))
          f = 1;
      ...
      u + f <= 0 || u + f > It(b) ? h(0) : f !== 0 && (h(u + f), C.preventDefault());
    }
  };
  return dt(() => {
    ...
    const C = setTimeout(() => {
      if (_ && v.current && E.current && !s) {
        const O = E.current.offsetTop - Wr;
        v.current.scrollTo({ top: O, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(C);
    };
  }, [_, s]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(qt, { modal: !1, open: m, onOpenChange: zt, children: [
    /* @__PURE__ */ r(ye, { asChild: !0, children: /* @__PURE__ */ r(
      Ir,
      {
        ...
        handleKeyDown: B,
        handleOnClick: () => {
          p(t.book), g(t.book), h(t.chapterNum > 0 ? t.chapterNum : 0), y(!0), l(Dt(t, "English")), k.current.focus();
        },
        onFocus: () => {
          at.current = !0;
        },
      ...
      jt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ge.map((C, z) => {
          ...
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Jt, { className: "tw-font-semibold tw-text-foreground/80", children: Kr[C] }),
            O.map((j) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              qr,
              {
                bookId: j,
                handleSelectBook: () => x(j, !1),
                isSelected: i === j,
                handleHighlightBook: () => g(j),
                handleKeyDown: ne,
                bookType: C,
                ref: (f) => {
                  i === j && (E.current = f);
                ...
                children: /* @__PURE__ */ r(
                  Jr,
                  {
                    ...
                    endChapter: It(j),
                    activeChapter: t.book === j ? t.chapterNum : 0,
            ...
            Ge.length - 1 !== z ? /* @__PURE__ */ r(Ft, {}) : void 0
          ] }, C);
        }) })
      }
    )
...
const na = bt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? St : "button", { className: w(na({ variant: e, size: n, className: t })), ref: s, ...o })
);
M.displayName = "Button";
const ra = bt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ue.Root, { ref: n, className: w("pr-twp", ra(), t), ...e }));
Y.displayName = Ue.Root.displayName;
...
dn.displayName = Pt.Root.displayName;
const ce = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Pt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(fe, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ce.displayName = Pt.Item.displayName;
const cn = Ot.Root, pn = Ot.Trigger, _e = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = F();
...
_e.displayName = Ot.Content.displayName;
...
const Me = c.forwardRef((t, e) => /* @__PURE__ */ r(H.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
function pe({
  ...
  const [N, k] = P(!1);
  return /* @__PURE__ */ d(cn, { open: N, onOpenChange: k, ..._, children: [
    ...
    /* @__PURE__ */ r(
      _e,
      {
        ...
        children: /* @__PURE__ */ d(ze, { children: [
          ...
          /* @__PURE__ */ r(Ie, { children: e.map((v) => /* @__PURE__ */ d(
            Ve,
            {
              value: i(v),
              onSelect: () => {
...
function Ko({
  ...
  const h = ae(u, "%webView_bookSelector_currentBook%"), b = ae(u, "%webView_bookSelector_choose%"), g = ae(u, "%webView_bookSelector_chooseBooks%"), [m, y] = P(
    "current book"
    /* CURRENT_BOOK */
  ), _ = (N) => {
    y(N), t(N);
    ...
    dn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Y, { className: "tw-flex tw-items-center", children: a.map((N) => A.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ r(
            M,
            {
...
function pa({ table: t }) {
  return /* @__PURE__ */ d(qt, { children: [
    /* @__PURE__ */ r(Jn, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const xt = X.Root, ua = X.Group, yt = X.Value, gt = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = F();
  return /* @__PURE__ */ d(
    X.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(X.Icon, { asChild: !0, children: /* @__PURE__ */ r(Ht, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
hn.displayName = X.ScrollUpButton.displayName;
...
gn.displayName = X.ScrollDownButton.displayName;
const ft = c.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = F();
...
ma.displayName = X.Label.displayName;
const K = c.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  X.Item,
  {
    ref: a,
    className: w(
...
K.displayName = X.Item.displayName;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        xt,
        {
          ...
          children: [
            /* @__PURE__ */ r(gt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(yt, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(ft, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(K, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function va({
  ...
  var N;
  const [i, p] = P([]), [u, h] = P([]), [b, g] = P({}), [m, y] = P({}), _ = qe({
    data: e,
    columns: t,
    getCoreRowModel: Ke(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(pa, { table: _ }),
    /* @__PURE__ */ d(Kt, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Wt, { stickyHeader: s, children: _.getHeaderGroups().map((k) => /* @__PURE__ */ r(lt, { children: k.headers.map((v) => /* @__PURE__ */ r(At, { children: v.isPlaceholder ? void 0 : Bt(v.column.columnDef.header, v.getContext()) }, v.id)) }, k.id)) }),
      /* @__PURE__ */ r(Zt, { children: (N = _.getRowModel().rows) != null && N.length ? _.getRowModel().rows.map((k) => /* @__PURE__ */ r(
        lt,
        {
          onClick: () => l(k, _),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((v) => /* @__PURE__ */ r(Nt, { children: Bt(v.column.columnDef.cell, v.getContext()) }, v.id))
        },
        k.id
      )) : /* @__PURE__ */ r(lt, { children: /* @__PURE__ */ r(Nt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && a && /* @__PURE__ */ r(ga, { table: _ })
  ] });
}
const Gt = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(nr, { size: 35, className: w("tw-animate-spin", t), ...e, ref: n }));
...
function Wo({
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r(Gt, { size: 15 }) : /* @__PURE__ */ d(kt, { children: [
...
function Ca({
  ...
  const [b, g] = P(!1), m = tt(
    (N) => {
      var v;
      const k = (v = t.find((E) => E.label === N)) == null ? void 0 : v.value;
      k && a(
    ...
    if (!p) return t;
    const N = t.filter((v) => v.starred).sort((v, E) => v.label.localeCompare(E.label)), k = t.filter((v) => !v.starred).sort((v, E) => {
      const $ = n.includes(v.value), Q = n.includes(E.value);
      return $ && !Q ? -1 : !$ && Q ? 1 : v.label.localeCompare(E.label);
    });
    return [...N, ...k];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: h, children: /* @__PURE__ */ d(cn, { open: b, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ r(_e, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(ze, { children: [
      ...
      /* @__PURE__ */ d(Ie, { children: [
        ...
        /* @__PURE__ */ r(mn, { children: _.map((N) => {
          ...
          return /* @__PURE__ */ d(
            Ve,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: N.starred && /* @__PURE__ */ r(wr, { className: "tw-h-4 tw-w-4" }) }),
...
function Sa({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = Z(() => {
    const l = [];
    return t.forEach((i) => {
  ...
  return /* @__PURE__ */ d(Kt, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Wt, { stickyHeader: !0, children: /* @__PURE__ */ d(lt, { children: [
    ...
    /* @__PURE__ */ r(Zt, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ d(
      lt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Nt, { children: `${A.bookIdToEnglishName(l.reference.book)} ${l.reference.chapterNum}:${l.reference.verseNum}` }),
          /* @__PURE__ */ r(Nt, { children: l.text })
        ]
      },
...
xn.displayName = Ut.Root.displayName;
...
const Qt = (t) => t === "asc" ? /* @__PURE__ */ r(pr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), is = (t) => ({
  accessorKey: "item",
  ...
  return t.forEach((o) => {
    const s = a.find(
      (l) => ve(l.items, typeof o.inventoryText == "string" ? [o.inventoryText] : o.inventoryText)
    );
    if (s)
      ...
      const l = {
        items: typeof o.inventoryText == "string" ? [o.inventoryText] : o.inventoryText,
        count: 1,
        status: _a(
          typeof o.inventoryText == "string" ? o.inventoryText : o.inventoryText[0],
          e,
          n
        ),
        occurrences: [
...
function ms({
  ...
  const u = ot(n, "%webView_inventory_all%"), h = ot(n, "%webView_inventory_approved%"), b = ot(n, "%webView_inventory_unapproved%"), g = ot(n, "%webView_inventory_unknown%"), m = ot(n, "%webView_inventory_scope_currentBook%"), y = ot(n, "%webView_inventory_scope_chapter%"), _ = ot(n, "%webView_inventory_scope_verse%"), N = ot(n, "%webView_inventory_filter_text%"), k = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [v, E] = P(!1), [$, Q] = P("all"), [at, zt] = P(""), [x, R] = P([]), J = Z(() => t.length === 0 ? [] : Ea(t, o, s), [t, o, s]), B = Z(() => {
    if (v) return J;
    const f = [];
    return J.forEach((G) => {
      const it = G.items[0], pt = f.find(
        (vt) => vt.items[0] === it
      );
      pt ? (pt.count += G.count, pt.occurrences = pt.occurrences.concat(G.occurrences)) : f.push({
        items: [it],
        count: G.count,
  ...
  }, [v, J]), ct = Z(() => za(B, $, at), [B, $, at]), ne = Z(() => {
    var it, pt;
    if (!v) return p;
    const f = (it = a == null ? void 0 : a.tableHeaders) == null ? void 0 : it.length;
    if (!f) return p;
    const G = [];
    for (let vt = 0; vt < f; vt++)
      G.push(
        Ta(
          ((pt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : pt[vt]) || "Additional Item",
          vt + 1
        )
      );
    return [...G, ...p];
  }, [a == null ? void 0 : a.tableHeaders, p, v]);
  dt(() => {
    ct.length === 0 ? R([]) : ct.length === 1 && R(ct[0].items);
  }, [ct]);
  const C = (f, G) => {
    G.setRowSelection(() => {
      const it = {};
      return it[f.index] = !0, it;
    }), R(f.original.items);
  }, z = (f) => {
    ...
    if (B.length === 0 || x.length === 0) return [];
    const f = B.filter((G) => ve(
      v ? G.items : [G.items[0]],
      x
    ));
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        xt,
        {
          ...
          defaultValue: $,
          children: [
            /* @__PURE__ */ r(gt, { className: "tw-m-1", children: /* @__PURE__ */ r(yt, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ d(ft, { children: [
              /* @__PURE__ */ r(K, { value: "all", children: u }),
              /* @__PURE__ */ r(K, { value: "approved", children: h }),
              /* @__PURE__ */ r(K, { value: "unapproved", children: b }),
              /* @__PURE__ */ r(K, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(xt, { onValueChange: (f) => z(f), defaultValue: l, children: [
        /* @__PURE__ */ r(gt, { className: "tw-m-1", children: /* @__PURE__ */ r(yt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ft, { children: [
          /* @__PURE__ */ r(K, { value: "book", children: m }),
          /* @__PURE__ */ r(K, { value: "chapter", children: y }),
          /* @__PURE__ */ r(K, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Tt,
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(Y, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? k })
      ] })
    ] }),
...
const Pe = Xt.Provider, Oe = Xt.Root, Ae = Xt.Trigger, te = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Xt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Ia = "16rem", Ma = "3rem", yn = c.createContext(void 0);
function ee() {
...
const Nn = c.forwardRef(
  ({
    ...
    const [u, h] = c.useState(t), b = e ?? u, g = c.useCallback(
      ...
      [n, b]
    ), m = c.useCallback(() => g((E) => !E), [g]), y = b ? "expanded" : "collapsed", k = F() === "ltr" ? l : l === "primary" ? "secondary" : "primary", v = c.useMemo(
      () => ({
        state: y,
        open: b,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(yn.Provider, { value: v, children: /* @__PURE__ */ r(Pe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Va = c.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = ee();
  return /* @__PURE__ */ d(
    M,
    {
...
const ja = bt(
  ...
  ({
    ...
    const p = t ? St : "button", { state: u } = ee(), h = /* @__PURE__ */ r(
      p,
      {
        ref: i,
...
const wt = "scrBook", qa = "scrRef", mt = "source", Ja = "details", Ka = "Scripture Reference", Wa = "Scripture Book", En = "Type", Za = "Details";
function Qa(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? A.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === wt ? Dt(o.start) : void 0;
      },
...
function gs({
  ...
  const [p, u] = P([]), [h, b] = P([{ id: wt, desc: !1 }]), [g, m] = P({}), y = Z(
  ...
  dt(() => {
    if (i) {
      const x = N.getSelectedRowModel().rowsById, R = Object.keys(x);
      if (R.length === 1) {
        const J = y.find((B) => Ye(B) === R[0]) || void 0;
        J && i(J);
      }
    }
  }, [g, y, i, N]);
  const k = o ?? Wa, v = s ?? En, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [wt] },
    { label: `Group by ${v}`, value: [mt] },
    {
  ...
  }, at = (x, R) => x.getIsGrouped() ? "" : w("banded-row", R % 2 === 0 ? "even" : "odd"), zt = (x, R, J) => {
    if (!((x == null ? void 0 : x.length) === 0 || R.depth < J.column.getGroupedIndex())) {
      if (R.getIsGrouped())
        switch (R.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      xt,
      {
        ...
        children: [
          /* @__PURE__ */ r(gt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(yt, {}) }),
          /* @__PURE__ */ r(ft, { position: "item-aligned", children: /* @__PURE__ */ r(ua, { children: E.map((x) => /* @__PURE__ */ r(K, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Kt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Wt, { children: N.getHeaderGroups().map((x) => /* @__PURE__ */ r(lt, { children: x.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(At, { colSpan: R.colSpan, className: "top-0 tw-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Zt, { children: N.getRowModel().rows.map((x, R) => {
        const J = F();
        return /* @__PURE__ */ r(
          lt,
          {
            ...
            className: w(at(x, R)),
            onClick: (B) => Q(x, B),
            children: x.getVisibleCells().map((B) => {
              if (!(B.getIsPlaceholder() || B.column.columnDef.enableGrouping && !B.getIsGrouped() && (B.column.columnDef.id !== mt || !n)))
                return /* @__PURE__ */ r(
                  Nt,
                  {
                    className: w(
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        ...
                        type: "button",
                        children: [
                          x.getIsExpanded() && /* @__PURE__ */ r(Ht, {}),
                          !x.getIsExpanded() && (J === "ltr" ? /* @__PURE__ */ r(ge, {}) : /* @__PURE__ */ r(br, {})),
                          " ",
                          Bt(B.column.columnDef.cell, B.getContext()),
                          " (",
                          x.subRows.length,
                          ")"
                        ]
...
function fs({
  ...
  return /* @__PURE__ */ d(
    xt,
    {
      ...
      children: [
        /* @__PURE__ */ r(gt, { className: w("pr-twp tw-w-auto", o), children: /* @__PURE__ */ r(
          yt,
          {
            placeholder: s[I(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          ft,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((i) => /* @__PURE__ */ r(K, { value: `${i}`, children: s[I(i)] }, `${i}`))
          }
        )
      ]
    }
...
const Mn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Ae, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Vr, { children: /* @__PURE__ */ r(en, { children: Mn(
      t,
      e,
      In(t, i.id),
      a
...
function ys({
  ...
  return /* @__PURE__ */ d(qt, { variant: s, children: [
    /* @__PURE__ */ r(ye, { "aria-label": n, className: o, asChild: !0, id: l, children: /* @__PURE__ */ r(M, { variant: "ghost", className: "tw-h-6 tw-p-1", children: a ?? /* @__PURE__ */ r(vr, {}) }) }),
    /* @__PURE__ */ r(jt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, p]) => typeof i == "boolean" || typeof p == "boolean" ? 0 : i.order - p.order).map(([i], p, u) => /* @__PURE__ */ d(Hn, { children: [
      /* @__PURE__ */ r(Qe, { children: /* @__PURE__ */ r(Pe, { children: Mn(e.groups, e.items, i, t) }) }),
...
const Dn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.List,
  {
    ref: n,
    className: w(
...
)), Bn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Content,
  {
    ref: n,
    className: w(
...
Bn.displayName = U.Content.displayName;
function Ns({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Vn, { children: [
      /* @__PURE__ */ r(Dn, { children: t.map((l) => /* @__PURE__ */ r(eo, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(Bn, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function no({ ...t }) {
...
Pn.displayName = D.Root.displayName;
...
On.displayName = D.Trigger.displayName;
...
ao.displayName = D.CheckboxItem.displayName;
...
oo.displayName = D.RadioItem.displayName;
...
so.displayName = D.Label.displayName;
const Gn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  D.Separator,
  {
    ref: n,
...
function io({
  ...
  const o = W(void 0), s = W(void 0), l = W(void 0), i = W(void 0), p = W(void 0), u = (h) => {
    switch (h) {
      case "platform.app":
        return s;
  ...
  if (_r(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (h, b) => {
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (y = s.current) == null || y.focus(), Mt(s, [g, m]);
        break;
      case "alt+l":
        (_ = l.current) == null || _.focus(), Mt(l, [g, m]);
        break;
      case "alt+n":
        (N = i.current) == null || N.focus(), Mt(i, [g, m]);
        break;
      case "alt+h":
        (k = p.current) == null || k.focus(), Mt(p, [g, m]);
        break;
    }
  }), dt(() => {
...
function Ss({
  ...
  const p = wo(
    ...
    var N, k, v, E, $, Q;
    const _ = y !== m ? ((k = (N = t[m]) == null ? void 0 : N.uiNames) == null ? void 0 : k[y]) ?? ((E = (v = t[m]) == null ? void 0 : v.uiNames) == null ? void 0 : E.en) : void 0;
    return _ ? `${($ = t[m]) == null ? void 0 : $.autonym} (${_})` : (Q = t[m]) == null ? void 0 : Q.autonym;
  };
  return /* @__PURE__ */ d("div", { className: w("pr-twp tw-max-w-sm", i), children: [
    /* @__PURE__ */ d(
      xt,
      {
        ...
        onOpenChange: (m) => h(m),
        children: [
          /* @__PURE__ */ r(gt, { children: /* @__PURE__ */ r(yt, {}) }),
          /* @__PURE__ */ r(
            ft,
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((m) => /* @__PURE__ */ r(K, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
...
ho.displayName = Rt.Root.displayName;
...
go.displayName = Rt.Image.displayName;
...
fo.displayName = Rt.Fallback.displayName;
...
const Co = c.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ d(
    Vt.Root,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r(Vt.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ r(Vt.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ r(Vt.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
Co.displayName = Vt.Root.displayName;
...
export {
  ...
  Vn as VerticalTabs,
  Bn as VerticalTabsContent,
  Dn as VerticalTabsList,
