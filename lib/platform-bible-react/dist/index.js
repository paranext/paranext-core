...
const Ae = j.Trigger, bn = j.Group, Zr = j.Portal, Qr = j.Sub, Ts = j.RadioGroup;
...
const ha = 6, $e = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), ga = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, rn = ["OT", "NT", "DC"], fa = 96, ba = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), va = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', jt = (t) => jr(M.bookIdToNumber(t));
function xa() {
      ...
      Ut,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: rn.map((h, V) => {
          ...
          return C.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(ae, { className: "tw-font-semibold tw-text-foreground/80", children: ga[h] }),
...
const ka = gt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Mt : "button", { className: l(ka({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const Ca = gt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(pn.Root, { ref: n, className: l("pr-twp", Ca(), t), ...e }));
...
const Rt = G.Root, za = G.Group, Et = G.Value, Oa = gt(
  ...
  return /* @__PURE__ */ d(
    G.Trigger,
    {
      className: l(Oa({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
function zs({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
...
function Bs({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
...
function As({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(re, { children: [
    /* @__PURE__ */ r(Ae, { asChild: !0, children: /* @__PURE__ */ r(Fa, {}) }),
...
function js({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new Xr("en", {
    notation: "compact",
...
Ua.displayName = gn.Root.displayName;
...
const me = (t) => t === "asc" ? /* @__PURE__ */ r(Rr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Er, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Gs = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Ja = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", qs = Object.freeze([
...
function Js({
  ...
  const u = pt(n, "%webView_inventory_all%"), g = pt(n, "%webView_inventory_approved%"), v = pt(n, "%webView_inventory_unapproved%"), f = pt(n, "%webView_inventory_unknown%"), m = pt(n, "%webView_inventory_scope_currentBook%"), N = pt(n, "%webView_inventory_scope_chapter%"), T = pt(n, "%webView_inventory_filter_text%"), y = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, _] = P(!1), [S, z] = P("all"), [$, ft] = P(""), [lt, k] = P([]), b = et(() => t.length === 0 ? [] : Wa(t, o, s), [t, o, s]), F = et(() => {
    if (x) return b;
    const D = [];
    return b.forEach((h) => {
...
const ut = "scrBook", go = "scrRef", xt = "source", fo = "details", bo = "Scripture Reference", vo = "Scripture Book", Ln = "Type", xo = "Details";
function yo(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, sn = (t) => `${No({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ws({
  sources: t,
    ...
    !e && /* @__PURE__ */ d(
      Rt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ct, { position: "item-aligned", children: /* @__PURE__ */ r(za, { children: S.map((k) => /* @__PURE__ */ r(rt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
...
Vo.displayName = X.CheckboxItem.displayName;
...
function Oo({
  ...
  if (Ur(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    return /* @__PURE__ */ r(Wn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ d(Eo, { children: [
...
), Po = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(Ao({ variant: e }), t), ...n }));
...
const Xo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Fo.displayName = zt.Root.displayName;
...
Go.displayName = zt.Image.displayName;
...
$o.displayName = zt.Fallback.displayName;
const Lo = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
...
const Uo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const ci = at.Trigger, Wo = at.Portal, pi = at.Close, or = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
...
const Zo = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(Wo, { children: [
  /* @__PURE__ */ r(or, {}),
  /* @__PURE__ */ d(
    at.Content,
    {
...
const rs = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  yt.Root,
  {
    ref: a,
...
rs.displayName = yt.Root.displayName;
function ui({ ...t }) {
  return /* @__PURE__ */ r(
    qr,
    {
...
const mi = Q.Root, ss = p.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.List,
    {
...
export {
  ...
  Zs as SCOPE_SELECTOR_STRING_KEYS,
  Qs as ScopeSelector,
  Ws as ScriptureResultsViewer,
  rs as ScrollArea,
  ti as ScrollGroupSelector,
  $n as SearchBar,
  Rt as Select,
  Ct as SelectContent,
  za as SelectGroup,
  ...
  l as cn,
  Us as getBookIdFromUSFM,
  Ys as getLinesFromUSFM,
  Hs as getNumberFromUSFM,
  Ja as getStatusForItem,
  si as getToolbarOSReservedSpaceClassName,
  $s as inventoryCountColumn,
