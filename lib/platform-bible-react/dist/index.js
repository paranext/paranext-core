...
import { extendTailwindMerge as ci, twMerge as li } from "tailwind-merge";
import { Slot as ke, Dialog as Yt, Popover as rr, Label as di, RadioGroup as ra, Tooltip as Le, ToggleGroup as Ro, Separator as wi, Avatar as ya, DropdownMenu as vt, Select as Et, Checkbox as Ua, Tabs as Kt, Menubar as Qt, ContextMenu as bt, Progress as Ka, Slider as dr, Switch as Ga } from "radix-ui";
...
import { createEditor as jo, $getRoot as ce, $createParagraphNode as We, $getSelection as Tt, HISTORY_MERGE_TAG as Na, ParagraphNode as Fo, TextNode as Bo, $isTokenOrSegmented as gs, $getCharacterOffsets as hs, $cloneWithPropertiesEphemeral as fs, $getPreviousSelection as ms, $isRangeSelection as Xt, $caretFromPoint as vs, $getSiblingCaret as Uo, $getChildCaret as bs, $getAdjacentChildCaret as xs, $isChildCaret as ys, $normalizeCaret as ks, $setSelectionFromCaretRange as _s, $getCollapsedCaretRange as Ns, $getCaretInDirection as Za, $splitAtPointCaretNext as Cs, $isTextPointCaret as Es, $findMatchingParent as Ko, $isElementNode as ie, mergeRegister as le, getDOMTextNode as zs, isHTMLElement as Go, CLEAR_EDITOR_COMMAND as qo, COMMAND_PRIORITY_EDITOR as Ca, shallowMergeConfig as Ts, defineExtension as jt, safeCast as Oe, createState as Ss, FORMAT_TEXT_COMMAND as Ho, $isNodeSelection as Wo, COMMAND_PRIORITY_LOW as Yo, RootNode as Ds, LineBreakNode as Rs, TabNode as $s, $isEditorState as Ms, createCommand as Os, CLICK_COMMAND as As, isDOMNode as Is, $getNodeFromDOMNode as Ps, $createNodeSelection as Ls, $setSelection as Vs, $getEditor as js, DecoratorNode as sa, $getState as Fs, toggleTextFormatType as Qa, TEXT_TYPE_TO_FORMAT as Bs, $setState as Us, addClassNamesToElement as Xo, $create as Ks, $getNodeByKey as Gs, removeClassNamesFromElement as qs, KEY_TAB_COMMAND as Hs, $isBlockElementNode as yr, $createRangeSelection as Ws, $normalizeSelection__EXPERIMENTAL as Ys, OUTDENT_CONTENT_COMMAND as Xs, INDENT_CONTENT_COMMAND as to, INSERT_TAB_COMMAND as Js, COMMAND_PRIORITY_CRITICAL as Ea, $isDecoratorNode as Zs, $isParagraphNode as Qs, $isTextNode as kr, SELECTION_CHANGE_COMMAND as Jo, getRegisteredNode as tc, isDocumentFragment as eo, isDOMDocumentNode as ec, ArtificialNode__DO_NOT_USE as Zo, $createLineBreakNode as Qo, $isRootOrShadowRoot as rc, isBlockDomNode as ro, isInlineDomNode as ao, $insertNodes as ac } from "lexical";
import { HeadingNode as oc, QuoteNode as nc, registerRichText as ic } from "@lexical/rich-text";
import { flushSync as sc, createPortal as cc } from "react-dom";
import { $isTableSelection as lc } from "@lexical/table";
import { createHeadlessEditor as tn } from "@lexical/headless";
import { useReactTable as en, getFilteredRowModel as dc, getSortedRowModel as rn, getPaginationRowModel as wc, getCoreRowModel as an, flexRender as tr, getGroupedRowModel as uc, getExpandedRowModel as pc } from "@tanstack/react-table";
import gc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ca, HIDDEN_NOTE_CALLER as la, getDefaultViewOptions as hc, isInsertEmbedOpOfType as ur, Editorial as fc } from "@eten-tech-foundation/platform-editor";
...
function f(...t) {
  ...
  }), li(n.join(" ")).split(" ").filter(Boolean).map((l) => {
    const d = o.get(l);
    return d ? kc(l, d) : l;
  }).join(" ");
}
const Ye = 250, on = 300, _c = 400, Nc = 450, Cc = 500, nn = te(
...
function Dc({
  ...
  const s = st();
  return /* @__PURE__ */ u(Tc, { children: [
    /* @__PURE__ */ a(Sc, { className: o }),
    /* @__PURE__ */ u(
      Yt.Content,
      {
...
function cr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Rc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        $e.Input,
        {
      ...
      /* @__PURE__ */ a(Mc, { children: /* @__PURE__ */ a(pi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function jc(t, e, r, o) {
  const n = j(() => {
    if (t.chapterNum > 1)
      ...
      if (l > 0) {
        const d = e[l - 1], w = Math.max(Wt(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function no({
  ...
  if (t)
    return /* @__PURE__ */ a(Jt, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: Wt(t) }, (s, c) => c + 1).map((s) => /* @__PURE__ */ a(
      de,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function $u({
  ...
  const d = st(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, N] = T("books"), [x, _] = T(void 0), [k, I] = T(!1), O = G(void 0), A = G(void 0), C = G(void 0), z = G(void 0), E = G({}), M = j(
    ...
    [Y.OT]: P.filter((W) => ct.isBookOT(W)),
    [Y.NT]: P.filter((W) => ct.isBookNT(W)),
    [Y.DC]: P.filter((W) => ct.isBookDC(W)),
    [Y.Extra]: P.filter((W) => ct.extraBooks().includes(W))
...
function pa({
  ...
  const [_, k] = T(!1), I = d ?? l, O = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
    const E = l(C), M = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, P = `${z ?? ""}${E}${M ?? ""}`;
    return /* @__PURE__ */ u(
      de,
      {
        value: E,
    ...
    pn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(ft, { className: "tw:flex tw:items-center", children: o.map((v) => ct.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            V,
            {
...
const hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Kc = hn ? At : K, pr = { tag: Na };
function Gc({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Uc(null, o), w = jo({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Zc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function Qc(t) {
...
const fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, al = fn && "documentMode" in document ? document.documentMode : null;
!(!fn || !("InputEvent" in window) || al) && "getTargetRanges" in new window.InputEvent("input");
function Ht(t) {
  return `${t}px`;
}
...
function nl(t, e, r) {
  ...
  function l() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = el(t, e);
    var m, b;
...
function sl(t, e = il) {
  ...
  function d(w) {
    w.read(() => {
      const g = Tt();
      if (!Xt(g)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, p] = function(C) {
        const z = C.getStartEndPoints();
        return C.isBackward() ? [z[1], z[0]] : z;
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, N = p.getNode(), x = N.getKey(), _ = p.offset, k = t.getElementByKey(b), I = t.getElementByKey(x), O = r === null || k !== o || v !== n || b !== r.getKey(), A = i === null || I !== s || _ !== c || x !== i.getKey();
...
function dl(t) {
  ...
  if (Xt(e)) r = vs(e.focus, "next");
    ...
    r = r || bs(ce(), "previous").getFlipped().insert(We());
  }
  const o = wl(t, r), n = xs(o), i = ys(n) ? ks(n) : o;
...
function ul(t) {
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Ko(i, (d) => ie(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Nr, se = 0, Cr = 0, hl = 0, ha = 0, vr = 0;
function co(t) {
  if (X === void 0) return;
  let e = t.n;
...
Ct.prototype.brand = pl, Ct.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, bn(this), lo(this), se++;
  const t = X;
  return X = this, ml.bind(this, t);
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [kn], register: (t, e, r) => t.registerCommand(Ho, (o) => {
  const n = Tt();
  if (Wo(n) || Xt(n)) for (const i of n.getNodes()) bl(i) && i.toggleFormat(o);
  return !1;
}, Yo) });
function _n(t, e) {
  let r;
...
const Nl = jt({ config: Oe({ setOptions: wo, updateOptions: wo }), init: ({ $initialEditorState: t = _l }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class je {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Wr(i) || Q(300, s, n || "[unknown]"), Wr(c = i) || Q(304, String(c.id), String(Ma)), i = Object.assign(c, { id: ma }), o.state = i;
...
const El = /* @__PURE__ */ new Set(), go = jt({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = fl(() => (i.value || El).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(s, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), zl = Os("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
...
jt({ dependencies: [fa, go], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return le(t.registerCommand(zl, (s) => {
    const c = Tt();
    if (!Xt(c)) return !1;
    ...
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(Zt(() => {
      const d = c.value;
      d && (l.value ? Xo(d, i) : qs(d, i));
    }));
    return le(...s);
  }));
} });
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Zt(() => {
    if (!o.disabled.value) return cl(t, o.onReposition.value);
  });
} });
function zn(t) {
  return t.canBeEmpty();
}
function Dl(t, e, r = zn) {
  return le(t.registerCommand(Hs, (o) => {
    ...
    const i = function(s) {
      ...
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), g = ll(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Ws();
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: zn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Zt(() => {
    if (!o.value) return Dl(t, n, i);
  });
} });
const Rl = jt({ name: "@lexical/react/ReactProvider" });
function $l() {
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Zt(() => r.getOutput().disabled.value ? void 0 : Sn(t)) });
function Al(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
  ...
  return function(r, o) {
    ...
    return Aa(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(ps, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(cc(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Pl({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Rl.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Al(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Il, { editor: t, ErrorBoundary: e });
}
function ho(t) {
  return t.getEditorState().read(Tn(t.isComposing()));
}
function Ll({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = ee();
  return function(n) {
    Aa(() => le(ic(n), Sn(n)), [n]);
  }(o), u(et, { children: [t, a(Vl, { content: e }), a(Pl, { editor: o, ErrorBoundary: r })] });
}
function Vl({ content: t }) {
...
function ql(t, e) {
  ...
  return u(et, { children: [a(Kl, { editor: n, ...o, ref: e }), r != null && a(Hl, { editor: n, content: r })] });
}
...
function Xl() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(zc, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Dc, { children: [
...
function Jl({
  ...
  const [e] = ee(), [r, o] = T(e), [n, i] = T("paragraph"), [s, c] = Xl(), l = () => {
  };
...
function rd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Jl, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(td, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Ll,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Wl, { placeholder: t }) }),
          ErrorBoundary: Jc
        }
      ),
...
function An(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && kr(e) && (s = rl(o, e, "clone"));
  const c = ie(s) ? s.getChildren() : [], l = tc(t, s.getType());
  let d;
...
function Pn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (c == null || !rc(c)) && (c != null && yr(c) || o);
  ...
  }(t) && (s = s.concat(Qo())) : ie(c) && c.append(...h), s;
}
function id(t, e, r) {
...
function Pu({
  ...
  const [i, s] = T(ld), [c, l] = T(n), [d, w] = T(!1), g = G(void 0), h = G(null);
  K(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
...
const Lu = Object.freeze([
  ...
  const n = G(null), [i, s] = T(void 0), [c, l] = T(void 0), d = j(
    (p) => {
      s(p);
...
function Nd({
  ...
  const [C, z] = T(xo), [E, M] = T(), [P, q] = T(), D = o, [H, y] = T(!1), [F, lt] = T(!1), [xt, Mt] = T(!1), [dt, St] = T(!1), [U, nt] = T(!1), [at, wt] = T(k), [zt, ge] = T(!1), yt = G(void 0), [he, re] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
  ...
  const ae = L(() => Ft[0], [Ft]), $ = G(null), W = G(void 0), Z = j(() => {
    var S;
    (S = W.current) == null || S.call(W), z(xo);
  }, []), ut = j(() => {
    const S = !at;
    wt(S), ge(!S), m == null || m(l, S);
  }, [at, m, l]);
  K(() => {
    y(!1);
  }, [o]), K(() => {
  ...
  const mt = j(
    async (S) => {
      ...
      gt && await g({ threadId: l, contents: gt }) && Z();
    },
    [
      Z,
      C,
...
function Od({
  ...
  return l ? I = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((O = _.getRowModel().rows) == null ? void 0 : O.length) > 0 ? I = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    A.id
  )) : I = /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ a(ve, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function Ud({
  ...
  const i = G(null), s = G(null), c = G(!1), [l, d] = T(t), [w, g] = T(r), [h, p] = T(!1);
  K(() => {
    d(t);
  }, [t]), K(() => {
    w !== r && g(r);
  ...
  return /* @__PURE__ */ u(
    de,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Oc, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function Yd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  ...
  return /* @__PURE__ */ u(Ne, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ce, { children: [
      ...
      /* @__PURE__ */ a(Jt, { children: i.map((c) => {
        var l;
        return /* @__PURE__ */ a(
          Co,
          {
      ...
      s.length > 0 && /* @__PURE__ */ u(et, { children: [
        ...
        /* @__PURE__ */ a(Jt, { children: s.map((c) => {
          var l;
          return /* @__PURE__ */ a(
            Co,
            {
...
function op({
  ...
  const [m, b] = T("generated"), [v, N] = T("generated"), [x, _] = T("*"), [k, I] = T("*"), [O, A] = T("f"), [C, z] = T(!1), [E, M] = T(!0), [P, q] = T(!1), D = G(!1), H = G(""), [y, F] = T(!1), [lt, xt] = T(), [Mt, dt] = T(), [St, U] = T(), [nt, at] = T(), wt = G(null), zt = L(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  K(() => {
    ...
    if (B && ur("note", B)) {
      ...
      let _t = "custom";
      pt === ca ? _t = "generated" : pt === la ? _t = "hidden" : pt && (_(pt), I(pt)), b(_t), N(_t), A(((it = B.insert.note) == null ? void 0 : it.style) ?? "f"), R = setTimeout(() => {
        var Rt;
  ...
  const yt = j(
    (R, B, rt = !1) => {
      ...
      if (it && ur("note", it)) {
        if (it.insert.note) {
          let mt;
          R === "custom" ? mt = B : R === "generated" ? mt = ca : mt = la, it.insert.note.caller = mt;
        }
  ...
  K(() => {
    ...
    const R = ((rt = g.current) == null ? void 0 : rt.querySelector(".editor-input")) ?? void 0, B = (it) => {
      !y && R && document.activeElement === R && it.key === c ? (it.preventDefault(), ot()) : y && it.key === "Escape" && (it.preventDefault(), F(!1));
    };
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(et, { children: tw(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Pr, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ve, { className: o, children: aw(c.text) })
        ]
      },
...
function gp({
  ...
  }, [A, H]), F = L(() => y.length === 0 ? [] : cw(y, z, M), [y, z, M]), lt = L(() => {
    var at, wt;
    if (!A) return l;
...
function fp({
  ...
  const [s, c] = T(""), [l, d] = T([]), w = L(
    () => t.filter((D) => !r || D.type === r).filter((D) => ww(D, s)).filter(
      (D) => l.length === 0 || l.includes(D.bestLanguageName)
    ),
    [t, r, s, l]
  ), g = L(
  ...
  }, [l, N, I, n]), q = s.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(et, { children: [
...
function Rw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], { otLong: h, ntLong: p, dcLong: m, extraLong: b } = {
  ...
  const O = L(() => ct.allBookIds.filter(
    (D, H) => t[H] === "1" && !ct.isObsolete(ct.bookIdToNumber(D))
  ), [t]), A = L(() => {
    if (!x.trim()) {
      const y = {
        [Y.OT]: [],
                  ...
                  Object.values(Y).map((D, H) => {
                    ...
                    if (y.length !== 0)
                      return /* @__PURE__ */ u(Vo, { children: [
                        ...
                        H < Object.values(Y).length - 1 && /* @__PURE__ */ a(ln, {})
                      ] }, D);
                  })
                ] })
              ]
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          He,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((d) => /* @__PURE__ */ a(Ut, { value: `${d}`, children: c[J(d)] }, `${d}`))
          }
        )
      ]
    }
...
const Zn = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Lt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(kd, { children: c.label }),
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ls, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Vo, { children: [
      /* @__PURE__ */ a(Un, { children: /* @__PURE__ */ a(It, { children: Zn(e.groups, e.items, l, t) }) }),
...
function jp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ti, { children: [
      /* @__PURE__ */ a(ei, { children: t.map((c) => /* @__PURE__ */ a($w, { value: c.value, children: c.value }, c.key)) }),
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(Vw, {}, `separator-${i}`)), l;
  });
};
function Uw({
  menuData: t,
