...
import { includes as an, Section as q, getChaptersForBook as Ls, formatScrRef as ue, getSectionForBook as Ge, formatRelativeDate as Vs, formatReplacementString as pe, sanitizeHtml as js, NumberFormat as zs, formatBytes as Fs, getCurrentLocale as Bs, getFormatCallerFunction as Gs, deepEqual as Ks, isString as Ar, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as X } from "platform-bible-utils";
...
import { createEditor as go, $getRoot as te, $createParagraphNode as Nn, $getSelection as Bt, HISTORY_MERGE_TAG as dr, ParagraphNode as bo, TextNode as vo, $isTokenOrSegmented as Us, $getCharacterOffsets as qs, $cloneWithPropertiesEphemeral as Hs, $findMatchingParent as Ys, $isElementNode as me, CLEAR_EDITOR_COMMAND as xo, COMMAND_PRIORITY_EDITOR as yo, $isRangeSelection as Xe, mergeRegister as ee, shallowMergeConfig as Xs, defineExtension as Kt, safeCast as tn, RootNode as Ws, LineBreakNode as Js, TabNode as Zs, $isEditorState as Qs, createCommand as ti, CLICK_COMMAND as ei, isDOMNode as ni, $getNodeFromDOMNode as ri, $isNodeSelection as oi, $createNodeSelection as ai, $setSelection as si, COMMAND_PRIORITY_LOW as ii, DecoratorNode as li, addClassNamesToElement as No, $create as wi, $getNodeByKey as ci, removeClassNamesFromElement as di, KEY_TAB_COMMAND as pi, $isBlockElementNode as un, $createRangeSelection as ui, $normalizeSelection__EXPERIMENTAL as mi, OUTDENT_CONTENT_COMMAND as fi, INDENT_CONTENT_COMMAND as Pr, INSERT_TAB_COMMAND as hi, COMMAND_PRIORITY_CRITICAL as pr, $isDecoratorNode as gi, $isParagraphNode as bi, $isTextNode as mn, SELECTION_CHANGE_COMMAND as ko, FORMAT_TEXT_COMMAND as vi, getRegisteredNode as xi, isHTMLElement as yi, isDocumentFragment as $r, isDOMDocumentNode as Ni, ArtificialNode__DO_NOT_USE as _o, $createLineBreakNode as Co, $isRootOrShadowRoot as ki, isBlockDomNode as Lr, isInlineDomNode as Vr, $insertNodes as _i } from "lexical";
...
import { useReactTable as So, getFilteredRowModel as Ii, getSortedRowModel as Do, getPaginationRowModel as Ai, getCoreRowModel as Mo, flexRender as Ke, getGroupedRowModel as Pi, getExpandedRowModel as $i } from "@tanstack/react-table";
...
const Ki = Rt.Root, Ui = Rt.Portal, Oo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Overlay,
  {
    ref: n,
    className: f(
...
qi.displayName = Rt.Description.displayName;
...
const zo = Qe(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: f(Yi({ variant: e, size: n, className: t })), ref: s, ...a })
);
V.displayName = "Button";
const oe = Ce.Root, ae = Ce.Trigger, Bd = Ce.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = wt();
...
function Gd(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
), lt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ho.Root, { ref: n, className: f("pr-twp", Qi(), t), ...e }));
...
const Bo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ol = Bo ? Ft : H, ln = { tag: dr };
function al({ initialConfig: t, children: e }) {
  const n = j(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = rl(null, o), p = go({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: o });
    return function(m, h) {
      if (h !== null) {
...
function fl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Us(e) && o !== null) {
    ...
    if (w || p) {
      const [m, h] = qs(t), u = l.is(c), g = e.is(i ? c : l), x = e.is(i ? l : c);
      let v, y = 0;
...
const Go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, gl = Go && "documentMode" in document ? document.documentMode : null;
!(!Go || !("InputEvent" in window) || gl) && "getTargetRanges" in new window.InputEvent("input");
function Fr(t) {
...
class Cl {
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || _l;
  }
  getPeerNameSet() {
...
const Rl = Kt({ config: tn({ setOptions: Ur, updateOptions: Ur }), init: ({ $initialEditorState: t = El }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class qe {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && J(298, o.name), !a) {
      a = new Cl(this, o), this.extensionNameMap.set(o.name, a);
  ...
  buildCreateEditorArgs() {
    ...
    for (const p of l) {
      const { extension: m } = p;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of Nl(m)) {
    ...
    return e.onError || (e.onError = Tl), e;
  }
}
const Sl = /* @__PURE__ */ new Set(), Yr = Kt({ build(t, e, n) {
  ...
  return { watchNodeKey: function(i) {
    const l = xl(() => (s.value || Sl).has(i)), { watchedNodeKeys: c } = a.peek();
    let w = c.get(i);
    const p = w !== void 0;
...
class Ee extends li {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: Dl, priority: 0 }) };
  }
  exportDOM() {
  ...
  return ee(t.registerCommand(pi, (n) => {
    ...
    const a = function(s) {
      ...
      if (p.canIndent()) {
        const m = p.getKey();
        let h = ui();
        if (h.anchor.set(m, 0, "element"), h.focus.set(m, 0, "element"), h = mi(h), h.anchor.is(c)) return !0;
      }
      return !1;
...
Kt({ build: (t, e, n) => Cn(e), config: tn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  ...
  return ne(() => {
    if (!o.value) return Ol(t, a);
  });
} });
const Il = Kt({ name: "@lexical/react/ReactProvider" });
function Al() {
...
function jl({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(Il.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && Ll(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(Vl, { editor: t, ErrorBoundary: e });
}
function Xr(t) {
...
function zl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    yr(() => ee(Ti(a), ea(a)), [a]);
  }(o), d(at, { children: [t, r(Fl, { content: e }), r(jl, { editor: o, ErrorBoundary: n })] });
}
function Fl({ content: t }) {
...
function Bl({ defaultSelection: t }) {
  const [e] = $t();
  return H(() => {
    e.focus(() => {
...
const Gl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function Kl({ onClear: t }) {
  const [e] = $t();
  return Gl(() => Yo(e, t), [e, t]), null;
}
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function Ul({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: C, "data-testid": S, ...$ }, L) {
...
function Yl(t, e) {
  ...
  return d(at, { children: [r(ql, { editor: a, ...o, ref: e }), n != null && r(Xl, { editor: a, content: n })] });
}
function Xl({ content: t, editor: e }) {
  const n = function(i) {
    const [l, c] = A(() => Wr(i));
    return na(() => {
      function w() {
...
function Zl() {
  const [t, e] = A(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Ki, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Io, { children: [
...
function Ql({
  ...
  const [e] = $t(), [n, o] = A(e), [a, s] = A("paragraph"), [i, l] = Zl(), c = () => {
  };
...
ew.displayName = Eo.Root.displayName;
...
function ow({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Ql, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(nw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        zl,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(Wl, { placeholder: t }) }),
          ErrorBoundary: dl
        }
      ),
      e && /* @__PURE__ */ r(Bl, { defaultSelection: "rootEnd" }),
...
function wa(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (h = p(h)), Lr(t) && (h = lw(t, h, u ? () => {
    const g = new _o();
    return n.push(g), g;
...
function Yd({
  ...
  const [a, s] = A(cw), [i, l] = A(void 0), [c, w] = A(!1), p = W(void 0), m = W(null);
  H(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
...
const Xd = Object.freeze([
  ...
  "%no_comments%"
], dw = ["input", "select", "textarea", "button"], pw = ["button", "textbox"], uw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", mw({ variant: e }), t), ...n })
);
...
const gw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
vw.displayName = Ae.Image.displayName;
...
}), $e = Z.Trigger, ha = Z.Group, xw = Z.Portal, yw = Z.Sub, Nw = Z.RadioGroup;
...
function Zr({
  ...
  const u = G(() => {
    ...
    [t.user]
  ), N = j(() => js(t.contents), [t.contents]), C = j(() => {
    if (o && l)
      return /* @__PURE__ */ d(at, { children: [
        /* @__PURE__ */ d(
          bn,
          {
            onClick: () => {
              w(!0), m(ww(t.contents)), i == null || i(!0);
            },
            children: [
...
function Jd({
  ...
  const S = n.filter(
    ...
    [v, x]
  ), { listboxRef: R, activeId: E, handleKeyDown: T } = uw({
    options: $,
    onOptionSelect: L
  }), P = G(
    (_) => {
...
const Se = rt.Root, Ew = rt.Group, De = rt.Value, Rw = re(
...
Tw.displayName = rt.Label.displayName;
...
Sw.displayName = rt.Separator.displayName;
function Dw({ table: t }) {
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), Pw(u, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), Aw(l, x, p.key);
...
const Gw = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(at, { children: [
...
function Kw({
  ...
  return /* @__PURE__ */ d(ve, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(jt, { asChild: !0, children: /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Gw(t, a, n) }) }) }),
...
const Uw = (t, e) => t === "f" ? /* @__PURE__ */ d(at, { children: [
  /* @__PURE__ */ r(mo, {}),
  " ",
...
function Hw({
  ...
  return /* @__PURE__ */ d(ve, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ci, { asChild: !0, children: /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Uw(t, n) }) }) }),
...
function ap({
  ...
  const C = G(() => {
    ...
    if (R && sn("note", R)) {
      ...
      g !== "x" && k === "x" ? D == null || D.forEach((F) => Yw(F)) : g === "x" && k !== "x" && (D == null || D.forEach((F) => Xw(F))), (z = c.current) == null || z.applyUpdate([R, { delete: 1 }]);
    }
  }, L = (k) => {
    var E, T, P, _, z;
    const R = (T = (E = c.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : T.at(0);
  ...
  return /* @__PURE__ */ d(at, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(at, { children: Jw(t.marker, l, o, w) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ r(Tn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(he, { className: o, children: tc(l.text) })
        ]
      },
...
const Sn = (t) => t === "asc" ? /* @__PURE__ */ r(_s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Cs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Es, { className: "tw-ms-2 tw-h-4 tw-w-4" }), lp = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, rc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", mp = Object.freeze([
...
function fp({
  ...
  }, [k, F]), U = j(() => O.length === 0 ? [] : oc(O, E, P), [O, E, P]), it = j(() => {
    var ft, ct;
    if (!k) return c;
...
const sc = "16rem", ic = "3rem", ka = b.createContext(void 0);
function Dn() {
...
const mc = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: o,
...
mc.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const c = t ? Ie : "button", { state: w } = Dn(), p = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: f(fc({ variant: n, size: o }), s),
        ...i
      }
    );
...
const yc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ie : "a",
  {
    ref: s,
...
const Zt = "scrBook", kc = "scrRef", de = "source", _c = "details", Cc = "Scripture Reference", Ec = "Scripture Book", Ma = "Type", Rc = "Details";
function Tc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Zt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Cc,
      cell: (o) => {
...
}, no = (t) => `${Sc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function vp({
  sources: t,
    ...
    !e && /* @__PURE__ */ d(
      Se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(be, { position: "item-aligned", children: /* @__PURE__ */ r(Ew, { children: S.map((E) => /* @__PURE__ */ r(yt, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
const Aa = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(jt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(xw, { children: /* @__PURE__ */ r(ba, { children: Aa(
      t,
      e,
      Ia(t, l.id),
      o
...
function wr({
  ...
  return /* @__PURE__ */ d(ve, { variant: s, children: [
    /* @__PURE__ */ r($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(V, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ds, {}) }) }),
...
function Tp({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d($a, { children: [
      /* @__PURE__ */ r(La, { children: t.map((l) => /* @__PURE__ */ r(Oc, { value: l.value, children: l.value }, l.key)) }),
...
const Pc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Dt();
  return /* @__PURE__ */ d(
    Q.CheckboxItem,
    {
...
Pc.displayName = Q.CheckboxItem.displayName;
const $c = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Dt();
  return /* @__PURE__ */ d(
    Q.RadioItem,
    {
...
$c.displayName = Q.RadioItem.displayName;
const Lc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Q.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Lc.displayName = Q.Label.displayName;
...
function Vc({
  ...
  if (zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ r(ja, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(Ic, { children: [
...
const Fc = Qe(({ className: t, ...e }, n) => /* @__PURE__ */ r(Is, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
Fc.displayName = "Spinner";
function Ap({
  id: t,
  isDisabled: e = !1,
  hasError: n = !1,
...
), Gc = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Kc.displayName = "AlertTitle";
const Uc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Uc.displayName = "AlertDescription";
const Pp = tt.Root, $p = tt.Trigger, Lp = tt.Group, Vp = tt.Portal, jp = tt.Sub, zp = tt.RadioGroup, qc = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  tt.SubTrigger,
  {
    ref: a,
    className: f(
...
qc.displayName = tt.SubTrigger.displayName;
...
Hc.displayName = tt.SubContent.displayName;
const Yc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(tt.Portal, { children: /* @__PURE__ */ r(
  tt.Content,
  {
    ref: n,
    className: f(
...
Yc.displayName = tt.Content.displayName;
...
Xc.displayName = tt.Item.displayName;
const Wc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  tt.CheckboxItem,
  {
    ref: a,
    className: f(
...
Wc.displayName = tt.CheckboxItem.displayName;
const Jc = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  tt.RadioItem,
  {
    ref: o,
    className: f(
...
Jc.displayName = tt.RadioItem.displayName;
const Zc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  tt.Label,
  {
    ref: o,
    className: f(
...
Zc.displayName = tt.Label.displayName;
...
Qc.displayName = tt.Separator.displayName;
...
const Fp = St.Trigger, nd = St.Portal, Bp = St.Close, Ya = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Overlay,
  {
    ref: n,
...
sd.displayName = St.Title.displayName;
...
ld.displayName = Zn.Root.displayName;
function Gp({
  className: t,
  ...e
}) {
...
const wd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ d(
    Be.Root,
    {
...
wd.displayName = Be.Root.displayName;
...
cd.displayName = Qn.Root.displayName;
const Hp = xt.Root, dd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ r(
    xt.List,
    {
...
dd.displayName = xt.List.displayName;
...
pd.displayName = xt.Trigger.displayName;
...
gd(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  vw as AvatarImage,
  Ud as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  qd as BOOK_SELECTOR_STRING_KEYS,
  Re as Badge,
  Kd as BookChapterControl,
  nl as BookSelectionMode,
  Hd as BookSelector,
  V as Button,
  Xd as COMMENT_EDITOR_STRING_KEYS,
  Wd as COMMENT_LIST_STRING_KEYS,
  pa as Card,
  ua as CardContent,
  ...
  Yc as ContextMenuContent,
  Lp as ContextMenuGroup,
  Xc as ContextMenuItem,
  Zc as ContextMenuLabel,
  Vp as ContextMenuPortal,
  zp as ContextMenuRadioGroup,
  Jc as ContextMenuRadioItem,
  Qc as ContextMenuSeparator,
  ...
  Qd as ERROR_POPOVER_STRING_KEYS,
  jw as ErrorDump,
  tp as ErrorPopover,
  ...
  Zd as MarkdownRenderer,
  gp as MarkerMenu,
  np as MoreInfo,
  Bw as MultiSelectComboBox,
