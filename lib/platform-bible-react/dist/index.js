...
import c, { forwardRef as Ut, useCallback as tt, useState as B, useRef as Z, useEffect as lt, useLayoutEffect as je, useMemo as Q, Fragment as Hn } from "react";
...
import { useReactTable as Ke, getFilteredRowModel as Cr, getSortedRowModel as We, getPaginationRowModel as Sr, getCoreRowModel as Ze, flexRender as Ot, getGroupedRowModel as Rr, getExpandedRowModel as Tr } from "@tanstack/react-table";
...
import { useHotkeys as zr } from "react-hotkeys-hook";
...
const Kt = I.Root, Ne = I.Trigger, en = I.Group, Dr = I.Portal, Br = I.Sub, Ko = I.RadioGroup, nn = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  I.SubTrigger,
  {
    ref: o,
    className: l(
...
var Ar = Object.defineProperty, Pr = (t, e, n) => e in t ? Ar(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, S = (t, e, n) => Pr(t, typeof e != "symbol" ? e + "" : e, n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
const _e = D.allBookIds.filter((t) => !D.isObsolete(D.bookIdToNumber(t))), Wr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, $e = ["OT", "NT", "DC"], Zr = 96, Qr = [
...
function Zo({
  ...
  const o = $(), [i, w] = B(""), [s, p] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, v] = B(!1), [x, y] = B(h), N = Z(void 0), k = Z(void 0), A = Z(void 0), j = tt(
    ...
    Qr.forEach((C) => {
      const z = i.match(C);
      if (z) {
        const [O, G = void 0, F = void 0] = z.slice(1), Mt = na(O);
  ...
  return lt(() => {
    ...
    const C = setTimeout(() => {
      if (x && k.current && A.current) {
        const O = A.current.offsetTop - Zr;
      ...
      Ft,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: $e.map((C, z) => {
          ...
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Wt, { className: "tw-font-semibold tw-text-foreground/80", children: Wr[C] }),
...
const ra = ft(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, i) => /* @__PURE__ */ r(a ? St : "button", { className: l(ra({ variant: e, size: n, className: t })), ref: i, ...o })
);
M.displayName = "Button";
const aa = ft(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Je.Root, { ref: n, className: l("pr-twp", aa(), t), ...e }));
...
const oa = nt.Portal, hn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Overlay,
  {
    ref: n,
    className: l(
...
sa.displayName = nt.Content.displayName;
...
ia.displayName = nt.Title.displayName;
...
wa.displayName = nt.Description.displayName;
...
la.displayName = U.Separator.displayName;
...
const xt = X.Root, ma = X.Group, yt = X.Value, ht = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = $();
  return /* @__PURE__ */ d(
    X.Trigger,
    {
...
ga.displayName = X.Separator.displayName;
function fa({ table: t }) {
...
function xa({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    n && a && /* @__PURE__ */ r(fa, { table: x })
  ] });
}
const $t = Ut(({ className: t, ...e }, n) => /* @__PURE__ */ r(nr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      children: t ? /* @__PURE__ */ r($t, { size: 15 }) : /* @__PURE__ */ d(kt, { children: [
        /* @__PURE__ */ r(rr, { size: 25, className: l("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
var Na = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Na || {});
function ss({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Kt, { children: [
    /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r(ya, {}) }),
...
function ka({ id: t, versionHistory: e }) {
...
function ls({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ d("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ r(ka, { versionHistory: o }),
...
function Sa({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ r("div", { className: l("pr-twp", Ca({ variant: e }), t), ...n });
}
function Ra({
  entries: t,
...
function ds({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var g;
      return /* @__PURE__ */ d(Sa, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          M,
          {
            variant: "ghost",
...
const xn = c.createContext({
  size: "default",
  variant: "default"
}), yn = c.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, i) => {
  const w = $();
  return /* @__PURE__ */ r(
    Jt.Root,
    {
...
yn.displayName = Jt.Root.displayName;
...
const ee = (t) => t === "asc" ? /* @__PURE__ */ r(pr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), cs = (t) => ({
  accessorKey: "item",
  ...
  return Ea(t).forEach((m) => {
    ...
    for (; f; ) {
      ...
      const h = f.index, v = i.find((y) => ye(y.items, g)), x = {
        ...
        text: kr(m, Math.max(0, h - 25), Math.min(h + 25, m.length))
      };
      if (v)
...
const Ba = "16rem", Oa = "3rem", Nn = c.createContext(void 0);
function re() {
...
const kn = c.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Nn.Provider, { value: k, children: /* @__PURE__ */ r(Ae, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Cn = c.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, i) => {
  const w = re();
    ...
    Cn,
    {
      ...
      children: /* @__PURE__ */ d(Rn, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(Tn, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(_n, { children: /* @__PURE__ */ r(
            zn,
            {
              onClick: () => u(g),
              isActive: f(g),
...
const it = "scrBook", Za = "scrRef", ut = "source", Qa = "details", to = "Scripture Reference", eo = "Scripture Book", Mn = "Type", no = "Details";
function ro(t, e) {
  const n = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ d(
      xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(gt, { position: "item-aligned", children: /* @__PURE__ */ r(ma, { children: A.map((b) => /* @__PURE__ */ r(W, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !b.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(br, {})),
                          " ",
...
const Vn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Xe, { asChild: !0, children: "command" in s ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Dr, { children: /* @__PURE__ */ r(rn, { children: Vn(
      t,
      e,
      In(t, s.id),
      a
  ...
  return /* @__PURE__ */ d(Kt, { children: [
    /* @__PURE__ */ r(
      Ne,
      {
        ...
        asChild: !0,
        id: i,
        children: a ?? /* @__PURE__ */ r(vr, {})
      }
    ),
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, s]) => typeof w == "boolean" || typeof s == "boolean" ? 0 : w.order - s.order).map(([w], s, p) => /* @__PURE__ */ d(Hn, { children: [
      /* @__PURE__ */ r(en, { children: /* @__PURE__ */ r(Ae, { children: Vn(e.groups, e.items, w, t) }) }),
...
Dn.displayName = q.List.displayName;
const Bn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  q.List,
  {
    ref: n,
...
const Pn = c.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  ...
  return /* @__PURE__ */ r(An.Provider, { value: o, children: /* @__PURE__ */ r(
    V.Root,
    {
      ref: a,
      className: l(
...
function po({
  ...
  if (zr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    var v, x, y, N;
    m.preventDefault();
    ...
    return /* @__PURE__ */ r(Pn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(so, { children: [
