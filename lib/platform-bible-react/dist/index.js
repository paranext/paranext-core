...
import { c as b, g as $e, a as Vr, C as er, L as Kn, t as ks, u as tn, T as Vt, b as bt, d as xt, e as yt, f as Hn, A as ba, D as Fe, h as Te, i as je, j as cr, k as We, B as et, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Je, r as De, p as Ts, q as Gn, P as lr, s as Dr, v as dr, w as wr, y as Da, z as Oa, E as Eo, F as ur, G as Ma, H as $t, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as qn, S as da, U as So, V as jr, W as Ur, X as yr, Y as Ss, Z as ir, _ as Ze, $ as Ue, a0 as Ye, a1 as kr, a2 as Ro, a3 as Do, a4 as ya, a5 as Oo, a6 as Wn, a7 as Rs, a8 as Ds, a9 as Os, aa as wo, ab as Yn, ac as Ia, ad as Ms, ae as Xn, af as Is, ag as zs, ah as Ps, ai as en, aj as As, ak as $s, al as Vs, am as Zn, an as Jn, ao as Mo, ap as Ls, aq as Qn, ar as Ka, as as rn, at as Ha, au as Bs, av as Fs, aw as js, ax as Us, ay as Ks, az as Hs, aA as Gs, aB as qs, aC as Ws, aD as Io, aE as zo, aF as Ys, aG as Xs } from "./resizable-FCXMv0ns.js";
import { aH as xf, aI as yf, aJ as kf, aK as _f, aL as Nf, aM as Cf, aN as Ef, aO as Tf, aP as Sf, aQ as Rf, aR as Df, aS as Of, aT as Mf, aU as If, aV as zf, aW as Pf, aX as Af, aY as $f, aZ as Vf, a_ as Lf, a$ as Bf, b0 as Ff, b1 as jf, b2 as Uf, b3 as Kf, b4 as Hf, b5 as Gf, b6 as qf, b7 as Wf, b8 as Yf, b9 as Xf, ba as Zf, bb as Jf, bc as Qf, bd as tm, be as em, bf as rm, bg as am, bh as om } from "./resizable-FCXMv0ns.js";
import { jsx as a, jsxs as u, Fragment as gt } from "react/jsx-runtime";
import { Canon as Kt } from "@sillsdev/scripture";
import { Check as Qe, Clock as an, ChevronsLeft as on, ChevronsRight as nn, ChevronUp as ti, ChevronDown as sr, ArrowLeft as Zs, ArrowRight as Js, BoldIcon as Qs, ItalicIcon as tc, X as ei, AtSign as ri, Pencil as ec, Trash2 as rc, Undo2 as ac, ArrowUp as ai, MoreHorizontal as oc, MailOpen as nc, Mail as ic, FilterIcon as sc, ArrowLeftIcon as cc, ChevronLeftIcon as lc, ChevronRightIcon as dc, ArrowRightIcon as wc, Copy as oi, Filter as uc, User as pc, Link as hc, CircleHelp as gc, Undo as fc, Redo as mc, SquareX as ni, FunctionSquare as ii, SquareSigma as si, Ban as vc, AlertCircle as uo, CircleCheckIcon as bc, CircleXIcon as xc, CircleHelpIcon as yc, ArrowUpIcon as kc, ArrowDownIcon as _c, ScrollText as Nc, ChevronRight as Cc, ChevronLeft as Ec, ChevronsUpDown as Tc, MenuIcon as Sc, Menu as Rc, EllipsisVertical as Dc, MoreVertical as Oc } from "lucide-react";
...
import { Avatar as Bo, Select as ae, Checkbox as hn, Slot as Xr, Tabs as ke, Menubar as Oe, ContextMenu as Ht, Progress as gn, Slider as oa, Switch as fn } from "radix-ui";
...
function fd({
  ...
  const [h, f] = _(!1), [m, x] = _(!1), g = _a(), E = L(!1), y = w !== void 0, C = y ? w : h, N = n === "" ? "" : se(n, hd), A = se(s, gd), B = (D) => {
...
function Ya({
  ...
  const B = De(), U = wd(), [M, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [q, $] = _(
    void 0
  ), [at, ut] = _(void 0), [dt, tt] = _(!1), [pt, kt] = _(!1), [mt, Rt] = _(!1), [Ft, Pt] = _(!1), fe = L(null), we = L(!1), _t = L(void 0), Nt = L(void 0), Et = L(void 0), oe = L(void 0), me = L({}), Dt = L({}), Ot = V(
    (v) => {
      e(v), d && d(v);
    },
    [e, d]
    ...
    if (!O) return;
    const v = D.startsWith(`${O.book} `) ? D : "", G = na(v), lt = Ar(v);
    return {
      book: O.book,
      chapterNum: lt ?? O.chapterNum ?? 1,
      verseNum: G ?? O.verseNum ?? 1
    };
  }, [O, D]), Gt = L(!1);
  Z(() => {
    if (!Gt.current) {
  ...
  const It = V(() => {
    ...
    (v) => {
      const G = q ?? (O == null ? void 0 : O.book), lt = at ?? (O == null ? void 0 : O.chapterNum);
      !G || !lt || (Ot({
        book: G,
        chapterNum: lt,
        verseNum: v
    ...
    (v) => {
      const G = k === "chapters" ? I : O == null ? void 0 : O.book;
      if (G) {
        if (w && w(G, v) > 1) {
          $(G), ut(v), ot("verses"), W("");
          return;
  ...
  const { otLong: Tt, ntLong: qt, dcLong: ar, extraLong: Ke } = {
    ...
    () => bd(Y),
    [Y]
  ), zt = P(() => !w || !O || !O.chapterNum || !wt ? !1 : w(O.book, O.chapterNum) > 0, [w, O, wt]), He = k === "books" && !dt && !Y.trim() && Xt.size > 0, Ba = V(
    (v) => p ? vn(v, p) : !1,
    [p]
  ), Ae = V(
    (v) => (G) => p ? xd(v, G, p) : !1,
    ...
    (v) => {
      (v.key === "Home" || v.key === "End") && v.stopPropagation(), h && h.includes(v.key) && O && O.chapterNum !== void 0 && O.verseNum !== void 0 && (v.preventDefault(), v.stopPropagation(), It());
    },
    [h, O, It]
  ), aa = V(
    (v) => {
      ...
      if (k === "books" && O && !dt && v.key === "Enter" && !(G !== Nt.current && !!(G != null && G.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (v.shiftKey || k === "books" && G !== Nt.current && (G != null && G.closest('button, a, [role="button"]')))
        return;
      const St = (() => {
        const Bt = k === "books" && O && zt && O.chapterNum ? { bookId: O.book, chapterNum: O.chapterNum } : void 0, pe = k === "verses" ? { bookId: q, chapterNum: at } : Bt;
        if (pe) {
          const { bookId: Jt, chapterNum: xe } = pe;
          return !Jt || !xe || !w ? void 0 : {
            max: w(Jt, xe),
            current: na(D) ?? 0,
            buildValue: (Mr) => pa(Jt, xe, Mr),
            refs: Dt,
        ...
        if (k === "chapters" || k === "books" && O && qe(O.book) > 1) {
          const Jt = k === "chapters" ? I : O == null ? void 0 : O.book;
          return Jt ? {
            max: qe(Jt),
            current: Ar(D) ?? 0,
  ...
  re(() => {
    const v = setTimeout(() => {
      if (M && k === "books" && Et.current && oe.current) {
  ...
  const rt = O ? `${O.book} ${O.chapterNum ?? ""} ${O.verseNum ?? ""} ${zt}` : "", Lt = L(""), ue = L(""), be = P(() => {
    if (k !== "books" || !O || dt) return;
    const { book: v, chapterNum: G, verseNum: lt } = O;
    if (zt && G && w)
      return {
        max: w(v, G),
  ...
  }, [k, O, be, rt, D]), /* @__PURE__ */ u(lr, { open: M, onOpenChange: it, modal: y, children: [
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        onPointerDownOutside: (v) => {
          const { target: G } = v;
          M && fe.current && G instanceof Node && fe.current.contains(G) && (we.current = !0, it(!1));
        },
        onCloseAutoFocus: E,
            ...
            children: [
              ...
              !dt && /* @__PURE__ */ u(ur, { ref: Et, children: [
                k === "books" && /* @__PURE__ */ u(gt, { children: [
                  ...
                  O && Mt && /* @__PURE__ */ a(Je, { children: /* @__PURE__ */ u(
                    er,
                    {
                      value: pd,
                      onSelect: It,
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: Vr(O.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  O && zt && O.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  /* @__PURE__ */ a(
                    xn,
                    {
                      ...
                      onVerseSelect: R,
                      setVerseRef: ct,
                      isVerseDisabled: fr(O.book, O.chapterNum),
                      suppressKeyboardHighlight: mt,
                      className: "tw:px-4 tw:pb-4"
                    }
                  ),
                  O && !zt && qe(O.book) > 1 && // No heading here either, for the same reason as the verse preview above:
...
function yn({
  ...
  const [C, N] = _(!1), A = l ?? d, B = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], U = (M, S) => {
    const D = d(M), W = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, Y = `${S ?? ""}${D}${W ?? ""}`;
    return /* @__PURE__ */ u(
      er,
      {
        value: D,
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        children: /* @__PURE__ */ u(wr, { children: [
          ...
          /* @__PURE__ */ a(ur, { children: B(e) ? e.map((M) => /* @__PURE__ */ a(Je, { heading: M.groupHeading, children: M.options.map((S) => U(S, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(Je, { children: e.map((M) => U(M)) }) })
        ] })
      }
    )
  ] });
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dd = zi ? re : Z, sa = { tag: $o };
...
const Vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
function Ld(t) {
  ...
  function l(w) {
    w.read(() => {
      ...
      if ((B || U) && N !== null && A !== null) {
        const M = function(S, D, W, Y, z, k, ot) {
...
ge({ build: (t, e, r) => Or(e), config: pr({ $canIndent: Gi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
const Ew = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
...
function Sw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: f, className: m, id: x, role: g = "textbox", spellCheck: E = !0, style: y, tabIndex: C, "data-testid": N, ...A }, B) {
  const [U, M] = _(t.isEditable()), S = V((W) => {
...
function Ow(t, e) {
  ...
  return u(gt, { children: [a(Rw, { editor: n, ...o, ref: e }), r != null && a(Mw, { editor: n, content: r })] });
}
...
function Aw({
  ...
  const [e] = Me(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Pw(), d = () => {
  };
  ...
  return (
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ a(Od, { initialConfig: l, children: /* @__PURE__ */ u(Vt, { children: [
          /* @__PURE__ */ a(
            Bw,
            {
              placeholder: n,
...
const Uw = "verseText", bh = Object.freeze([
...
function Pn({
  ...
  const C = V(
    ...
    [t.user]
  ), M = P(() => Po(t.contents), [t.contents]), S = P(
...
const Zw = {
  ...
  var gr;
  const [ot, I] = _({}), X = z ?? ot, q = X.editorState ?? Zw, $ = X.assignedUser, at = k !== void 0, ut = L(X);
  ut.current = X;
  const dt = V(
    (T) => {
    ...
    [X.commentEdits, dt]
  ), [pt, kt] = _(), mt = n, [Rt, Ft] = _(!1), [Pt, fe] = _(!1), [we, _t] = _(!1), [Nt, Et] = _(!1), [oe, me] = _(!1), [Dt, Ot] = _(A), [ne, _e] = _(!1), ve = L(void 0), [Ie, le] = _(/* @__PURE__ */ new Map());
  Z(() => {
    let T = !0;
    return (async () => {
  ...
  Z(() => {
    ...
    Yt.current === "idle" && (Yt.current = "pending"), Nt ? Yt.current === "pending" && M !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    M !== i && (dt({ assignedUser: M }), Yt.current = "auto-populated") : Yt.current === "auto-populated" && (dt({ assignedUser: void 0 }), Yt.current = "pending");
  }, [n, M, Nt, i, dt]);
  const Xt = L(pt);
  Xt.current = pt;
  const Zt = L(k);
  ...
  const O = P(
    ...
    if (!T) return T;
    const ct = new Set(O.map((zt) => zt.id)), wt = Object.fromEntries(
  ...
  const It = P(() => O[0], [O]), R = L(null), K = L(void 0), J = V(() => {
    var T;
  ...
  }, [i, o]), st = P(() => O.slice(1), [O]), it = P(() => st.length ?? 0, [st.length]), vt = P(() => it > 0, [it]), Ct = P(() => {
    if (Rt || it <= 2)
      return st;
...
function Rh({
  ...
  const [N, A] = _(/* @__PURE__ */ new Set()), [B, U] = _(), [M, S] = _(), D = V(
    async ($) => {
      const at = await s($);
      ...
      children: W.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(nu, { ...at, conflictResolution: E }) : /* @__PURE__ */ a(is, { ...at })
          },
          $.id
        );
      })
...
const Dh = "data-platform-content-zoom-root", iu = Ao(
  function({ area: e, ...r }, o) {
    return /* @__PURE__ */ a(
      "div",
      {
...
function uu({
  ...
  return d ? A = Array.from({ length: 10 }).map((S, D) => `skeleton-row-${D}`).map((S) => /* @__PURE__ */ a(Ye, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(kr, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(yr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((B = C.getRowModel().rows) == null ? void 0 : B.length) > 0 ? A = C.getRowModel().rows.map((U) => /* @__PURE__ */ a(
    Ye,
    {
      ...
      children: U.getVisibleCells().map((M) => /* @__PURE__ */ a(kr, { children: Lr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    U.id
    ...
    /* @__PURE__ */ u(Ro, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Do, { stickyHeader: s, children: C.getHeaderGroups().map((U) => /* @__PURE__ */ a(Ye, { children: U.headers.map((M) => /* @__PURE__ */ a(ya, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : Lr(M.column.columnDef.header, M.getContext()) }, M.id)) }, U.id)) }),
      /* @__PURE__ */ a(Oo, { children: A })
    ] }),
...
function Bh({
  ...
  const [g, E] = _("generated"), [y, C] = _("generated"), [N, A] = _("*"), [B, U] = _("*"), [M, S] = _("f"), [D, W] = _(!1), [Y, z] = _(!0), [k, ot] = _(!1), I = L(!1), X = L(""), [q, $] = _(!1), [at, ut] = _(), [dt, tt] = _(), [pt, kt] = _(), [mt, Rt] = _(), Ft = L(null), Pt = L(
    void 0
  ...
  re(() => {
    (ne.current.book !== n.book || ne.current.chapterNum !== n.chapterNum) && (ne.current = { book: n.book, chapterNum: n.chapterNum }, Ot.current());
  }, [n.book, n.chapterNum]);
  const _e = () => {
    var K;
    ...
    if (K && Ir("note", K)) {
      ...
      M !== "x" && R === "x" ? st == null || st.forEach((it) => Ou(it)) : M === "x" && R !== "x" && (st == null || st.forEach((it) => Mu(it))), (nt = h.current) == null || nt.applyUpdate([K, { delete: 1 }]);
    }
  }, le = (R) => {
    ...
    (R) => {
      ...
      Ps(R, K, {
        ...
        commitTypedAndReopen: (H) => {
          var Q;
          (Q = h.current) == null || Q.commitTypedMarker(H, { trailingSpace: !1 }), O();
        },
        commitTypedCloser: (H) => {
          var Q;
...
const Lu = (t) => {
  ...
  return e ? e[1] : "";
}, Fu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Yh = Object.freeze([
...
function Xh({
  ...
  const f = Ce(r, "%webView_inventory_all%"), m = Ce(r, "%webView_inventory_approved%"), x = Ce(r, "%webView_inventory_unapproved%"), g = Ce(r, "%webView_inventory_unknown%"), E = Ce(r, "%webView_inventory_scope_currentBook%"), y = Ce(r, "%webView_inventory_scope_chapter%"), C = Ce(r, "%webView_inventory_scope_verse%"), N = Ce(r, "%webView_inventory_filter_text%"), A = Ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), B = Ce(r, "%webView_inventory_no_results%"), [U, M] = _(!1), [S, D] = _("all"), [W, Y] = _(""), [z, k] = _([]), ot = P(() => {
    const tt = t ?? [];
  ...
  }, [U, ot]), X = P(() => I.length === 0 ? [] : ju(I, S, W), [I, S, W]), q = P(() => {
    var kt, mt;
    if (!U) return d;
...
const Ku = "16rem", Hu = "3rem", cs = ee.createContext(void 0);
function La() {
...
const Ge = "scrBook", ep = "scrRef", nr = "source", rp = "details", ap = "Scripture Reference", op = "Scripture Book", ls = "Type", np = "Details";
function ip(t, e) {
  const r = e ?? !1;
  return [
    {
...
function wg({
  ...
  }, U = (S, D) => S.getIsGrouped() ? "" : b("banded-row", D % 2 === 0 ? "even" : "odd"), M = (S, D, W) => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(cu, { children: N.map((S) => /* @__PURE__ */ a(ye, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ro, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      ...
      /* @__PURE__ */ a(Oo, { children: E.getRowModel().rows.map((S, D) => {
        const W = De();
        return /* @__PURE__ */ a(
          Ye,
          {
...
function cp({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: m, extraLong: x } = {
    ...
    () => Object.values(At).filter(
      (k) => (s == null ? void 0 : s[k]) !== void 0 && Mo(B, k).length === 0
...
function pg({
  ...
  const B = Ut(
    i,
    "%webView_scope_selector_selected_text%"
  ), U = Ut(i, "%webView_scope_selector_verse%"), M = Ut(i, "%webView_scope_selector_chapter%"), S = Ut(i, "%webView_scope_selector_book%"), D = Ut(
    i,
    "%webView_scope_selector_current_verse%"
  ), W = Ut(
    i,
  ...
  }, we = L(null), _t = L(null), Nt = L(!1), Et = L(null), oe = L(!1), [me, Dt] = _(void 0), Ot = L(!1), ne = L(!1), _e = L(null), ve = V((j) => {
    if (j) {
      Dt("start"), Ot.current = !1;
      return;
    }
    Dt((rt) => rt === "start" ? void 0 : rt), Ot.current && (Ot.current = !1, requestAnimationFrame(() => {
      var Lt;
    ...
    (j) => {
      m == null || m(j), x == null || x(j), Ot.current = !0;
    },
    [m, x]
  ), Yt = V(
    (j) => {
    ...
    repeatBookName: !0
  }) : Zt ? kt(Zt.label, Zt.scrRefSuffix) : t, O = mt.filter(
    (j) => j.value !== "selectedBooks" && j.value !== "range"
  ), Mt = mt.find((j) => j.value === "selectedBooks"), Gt = mt.find((j) => j.value === "range"), [It, R] = _(!1), [K, J] = _(void 0), [H, Q] = _(void 0), [F, nt] = _(void 0), [st, it] = _(void 0), [vt, Ct] = _([]), Tt = p === "dropdown" && K === "selectedBooks", qt = /* @__PURE__ */ a(
    wp,
    {
      availableBookInfo: o,
        ...
        /* @__PURE__ */ a(
          je,
          {
            ...
            children: /* @__PURE__ */ u(Ka, { container: mr, children: [
              O.map(({ value: j, label: rt, dropdownLabel: Lt, scrRefSuffix: ue, id: be }) => {
...
const mp = Object.freeze([520, 420, 340]), gs = ee.forwardRef(
...
const vp = ee.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ke.Trigger,
  {
    ref: r,
    ...e,
...
export {
  ...
  Zf as Z_INDEX_NESTED_MODAL,
  Jf as Z_INDEX_NESTED_MODAL_BACKDROP,
  Qf as Z_INDEX_ONBOARDING_TOUR,
  tm as Z_INDEX_OVERLAY,
  em as badgeVariants,
  rm as buttonGroupVariants,
  am as buttonVariants,
  b as cn,
