...
import { c as b, g as $e, a as Vr, C as er, L as Un, t as ks, u as Qo, T as Vt, b as bt, d as xt, e as yt, f as Kn, A as ba, D as je, h as Te, i as Fe, j as cr, k as We, B as et, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Ze, r as De, p as Ts, q as Hn, P as lr, s as Dr, v as dr, w as wr, y as Da, z as Ma, E as Eo, F as ur, G as Oa, H as $t, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as qn, S as da, U as So, V as Fr, W as Ur, X as yr, Y as Ss, Z as ir, _ as Je, $ as Ue, a0 as Ye, a1 as kr, a2 as Ro, a3 as Do, a4 as ya, a5 as Mo, a6 as Gn, a7 as Rs, a8 as Ds, a9 as Ms, aa as wo, ab as Wn, ac as Ia, ad as Os, ae as Yn, af as Is, ag as zs, ah as Ps, ai as tn, aj as As, ak as $s, al as Vs, am as Xn, an as Jn, ao as Oo, ap as Ls, aq as Zn, ar as Ka, as as en, at as Ha, au as Bs, av as js, aw as Fs, ax as Us, ay as Ks, az as Hs, aA as qs, aB as Gs, aC as Ws, aD as Io, aE as zo, aF as Ys, aG as Xs } from "./resizable-39QAMVZg.js";
import { aH as vf, aI as bf, aJ as xf, aK as yf, aL as kf, aM as _f, aN as Nf, aO as Cf, aP as Ef, aQ as Tf, aR as Sf, aS as Rf, aT as Df, aU as Mf, aV as Of, aW as If, aX as zf, aY as Pf, aZ as Af, a_ as $f, a$ as Vf, b0 as Lf, b1 as Bf, b2 as jf, b3 as Ff, b4 as Uf, b5 as Kf, b6 as Hf, b7 as qf, b8 as Gf, b9 as Wf, ba as Yf, bb as Xf, bc as Jf, bd as Zf, be as Qf, bf as tm } from "./resizable-39QAMVZg.js";
...
import { Section as At, compareScrRefs as ka, getChaptersForBook as Oc, formatScrRef as Ve, formatReplacementString as Xe, getSectionForBook as wa, formatRelativeDate as Ic, sanitizeHtml as Po, NumberFormat as si, formatBytes as zc, getCurrentLocale as Pc, usfmMarkers as ua, isPlatformError as Ac, ABORTED as $c, getErrorMessage as Vc, getFormatCallerFunction as Lc, deepEqual as Bc, isString as nn, scrRefToBBBCCCVVV as qa, defaultScrRef as Ga, formatScrRefRange as jc, getLocalizeKeyForScrollGroupId as sn, formatReplacementStringToArray as cn, collectUsjMarkers as Fc } from "platform-bible-utils";
import ee, { useRef as L, useMemo as P, createContext as Gr, useContext as za, useEffect as J, useState as _, useCallback as V, useId as _a, useImperativeHandle as Uc, useLayoutEffect as re, Fragment as Wr, Component as Kc, createElement as ln, Suspense as Hc, forwardRef as ci, memo as li } from "react";
...
function Ya({
  ...
  const B = De(), U = wd(), [O, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [G, $] = _(
    void 0
...
const Jw = {
  ...
  var gr;
  const [ot, I] = _({}), X = z ?? ot, G = X.editorState ?? Jw, $ = X.assignedUser, at = k !== void 0, ut = L(X);
  ut.current = X;
  const dt = V(
    (T) => {
