...
import b, { forwardRef as rn, useRef as Q, useMemo as L, useState as M, useCallback as z, useLayoutEffect as Kt, createContext as En, useContext as br, useEffect as Y, Component as fs, createElement as jr, Suspense as gs, createRef as bs, Fragment as go } from "react";
import { Command as yt } from "cmdk";
import { X as Ae, Search as bo, Check as Mt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Gr, ChevronLeft as Qn, ChevronRight as Se, ArrowLeft as vs, ArrowRight as xs, Circle as Sn, ChevronDown as be, BoldIcon as ys, ItalicIcon as Ns, UnderlineIcon as ks, StrikethroughIcon as _s, AtSign as vo, Pencil as Cs, Trash2 as Es, ArrowUp as xo, MoreHorizontal as yo, ChevronUp as tr, FilterIcon as Ss, ArrowLeftIcon as Ts, ChevronLeftIcon as Rs, ChevronRightIcon as Ds, ArrowRightIcon as Ms, Copy as No, Filter as Os, User as Is, Link as As, CircleHelp as Ps, ChevronsUpDown as ko, Star as Vs, SquareX as _o, FunctionSquare as Co, SquareSigma as Eo, AlertCircle as er, CircleCheckIcon as $s, CircleXIcon as Ls, CircleHelpIcon as Bs, ArrowUpIcon as js, ArrowDownIcon as zs, PanelLeft as Fs, PanelRight as Gs, ScrollText as Hs, MenuIcon as Ks, Menu as Xs, EllipsisVertical as Us, LoaderCircle as Ys, GripVertical as qs } from "lucide-react";
...
const ol = Dt.Root, al = Dt.Portal, Go = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Dt.Overlay,
  {
    ref: n,
    className: h(
...
Go.displayName = Dt.Overlay.displayName;
...
Ho.displayName = Dt.Content.displayName;
...
Xo.displayName = Dt.Title.displayName;
...
Lt.displayName = yt.Item.displayName;
...
var il = Object.defineProperty, ll = (e, t, n) => t in e ? il(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, H = (e, t, n) => ll(e, typeof t != "symbol" ? t + "" : t, n);
const ve = [
  "GEN",
  "EXO",
  "LEV",
...
H(xt, "defaultVersification", we.English), H(xt, "verseRangeSeparator", "-"), H(xt, "verseSequenceIndicator", ","), H(xt, "verseRangeSeparators", [xt.verseRangeSeparator]), H(xt, "verseSequenceIndicators", [xt.verseSequenceIndicator]), H(xt, "chapterDigitShifter", 1e3), H(xt, "bookDigitShifter", xt.chapterDigitShifter * xt.chapterDigitShifter), H(xt, "bcvMaxValue", xt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
H(xt, "ValidStatusType", ta);
...
const ra = rn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Pe : "button", { className: h(oa({ variant: t, size: n, className: e })), ref: s, ...a })
);
...
function bp({
  ...
  const c = dt(), [p, m] = M(!1), [f, u] = M(""), [g, k] = M(""), [v, N] = M("books"), [y, S] = M(void 0), [P, j] = M(!1), A = Q(void 0), x = Q(void 0), C = Q(void 0), E = Q(void 0), _ = Q({}), I = z(
    ...
    [K.OT]: V.filter((U) => Z.isBookOT(U)),
    [K.NT]: V.filter((U) => Z.isBookNT(U)),
    [K.DC]: V.filter((U) => Z.isBookDC(U)),
    [K.Extra]: V.filter((U) => Z.extraBooks().includes(U))
  }), [V]), R = L(() => Object.values(G).flat(), [G]), F = L(() => {
    if (!g.trim()) return G;
    const O = {
      [K.OT]: [],
      [K.NT]: [],
    ...
    [v, $]
  ), { otLong: bt, ntLong: mt, dcLong: ht, extraLong: Ft } = {
          ...
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o(
              B,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ o(vs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(xs, { className: "tw-h-4 tw-w-4" })
              }
            ),
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(To.Root, { ref: n, className: h("pr-twp", _l(), e), ...t }));
...
const sa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Rl = sa ? Kt : Y, mn = { tag: vr };
function Dl({ initialConfig: e, children: t }) {
  const n = L(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: w } = e, c = Tl(null, r), p = Ro({ editable: e.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Tn();
            u.append(g);
            const k = sa ? document.activeElement : null;
...
const Ml = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function Ol({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  const [r] = Bt();
  return Ml(() => {
...
const Tr = {
  ...
  mark: "",
  markOverlap: ""
}, Et = an.Provider, Rt = an.Root, $t = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  an.Trigger,
  {
    ref: r,
    className: t ? h(oa({ variant: t }), e) : "",
    ...n
  }
)), St = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  an.Content,
  {
    ref: r,
    sideOffset: t,
...
function Vl({ children: e, onError: t }) {
...
const $l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function Ll(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function Bl() {
  return function(e) {
    const [t] = Bt(), n = L(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = Q(r);
    return $l(() => {
...
const ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fl = ia && "documentMode" in document ? document.documentMode : null;
!(!ia || !("InputEvent" in window) || Fl) && "getTargetRanges" in new window.InputEvent("input");
function la(...e) {
  const t = [];
...
gt.prototype.brand = Kl, gt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, pa(this), no(this), te++;
  const e = q;
  return q = this, Yl.bind(this, e);
...
const Mr = 0, pr = 1, ga = 2, Hn = 3, hn = 4, _e = 5, Kn = 6, He = 7;
function Xn(e) {
  return e.id === Mr;
}
function ba(e) {
...
class Zl {
  ...
  register(t, n) {
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== He && tt(309, String(r.id), String(He)), this.state = function(i) {
...
const tc = Yt({ config: on({ setOptions: ro, updateOptions: ro }), init: ({ $initialEditorState: e = Ql }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
class Je {
  ...
  buildCreateEditorArgs() {
    ...
    return t.onError || (t.onError = ec), t;
  }
}
const nc = /* @__PURE__ */ new Set(), so = Yt({ build(e, t, n) {
  ...
  return { watchNodeKey: function(i) {
    const l = Ul(() => (s.value || nc).has(i)), { watchedNodeKeys: w } = a.peek();
    let c = w.get(i);
    const p = c !== void 0;
...
Yt({ build: (e, t, n) => Mn(t), config: on({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  ...
  return re(() => {
    if (!r.value) return ac(e, a);
  });
} });
const sc = Yt({ name: "@lexical/react/ReactProvider" });
function ic() {
...
Yt({ build: (e, t, n) => Mn(t), config: on({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => re(() => n.getOutput().disabled.value ? void 0 : ya(e)) });
function wc(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
function dc({ editor: e, ErrorBoundary: t }) {
  return function(n, r) {
    ...
    return Or(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], p = o(r, { onError: (f) => n._onError(f), children: o(gs, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(Hi(p, m, c));
      }
      return i;
    }, [r, a, n]);
  }(e, t);
...
function pc({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    ...
    if (r && r.hasExtensionByName(sc.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) r.hasExtensionByName(a) && wc(320, a);
      return !0;
    }
    return !1;
  }(e) ? null : o(dc, { editor: e, ErrorBoundary: t });
}
function io(e) {
  return e.getEditorState().read(xa(e.isComposing()));
}
function uc({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [r] = Bt();
  return function(a) {
    Or(() => ne(Fi(a), ya(a)), [a]);
  }(r), d(lt, { children: [e, o(mc, { content: t }), o(pc, { editor: r, ErrorBoundary: n })] });
}
...
function hc({ defaultSelection: e }) {
  const [t] = Bt();
  return Y(() => {
    t.focus(() => {
...
const fc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function gc({ onClear: e }) {
  const [t] = Bt();
  return fc(() => ma(t, e), [t, e]), null;
}
const Na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function bc({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: k, role: v = "textbox", spellCheck: N = !0, style: y, tabIndex: S, "data-testid": P, ...j }, A) {
  const [x, C] = M(e.isEditable()), E = z((I) => {
    I && I.ownerDocument && I.ownerDocument.defaultView ? e.setRootElement(I) : e.setRootElement(null);
  }, [e]), _ = L(() => /* @__PURE__ */ function(...I) {
    return (V) => {
...
function yc(e, t) {
  ...
  return d(lt, { children: [o(vc, { editor: a, ...r, ref: t }), n != null && o(Nc, { editor: a, content: n })] });
}
function Nc({ content: e, editor: t }) {
  const n = function(i) {
    const [l, w] = M(() => lo(i));
    return Na(() => {
      function c() {
...
function Cc() {
  const [e, t] = M(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(ol, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ho, { children: [
      /* @__PURE__ */ o(Ko, { children: /* @__PURE__ */ o(Xo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Ec({
  ...
  const [t] = Bt(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Cc(), w = () => {
  };
...
), Tc = b.forwardRef(({ className: e, variant: t, size: n, ...r }, a) => /* @__PURE__ */ o(
  $o.Root,
  {
    ref: a,
...
Tc.displayName = $o.Root.displayName;
...
function Mc({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ o(Ec, { children: () => /* @__PURE__ */ o("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ o(Rc, {}) }) }),
      ...
      /* @__PURE__ */ o(
        uc,
        {
          contentEditable: /* @__PURE__ */ o("div", { ref: (s) => {
            s !== void 0 && r(s);
          }, children: /* @__PURE__ */ o(kc, { placeholder: e }) }),
          ErrorBoundary: Vl
        }
      ),
      t && /* @__PURE__ */ o(hc, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ o(Dc, { onClear: n }),
      /* @__PURE__ */ o(gc, {})
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ o("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ o(
    Dl,
    {
      ...
      children: /* @__PURE__ */ d(Et, { children: [
        /* @__PURE__ */ o(Mc, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ o(
          Ol,
          {
...
function Ra(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (f = p(f)), Ur(e) && (f = Pc(e, f, u ? () => {
    const g = new Po();
    return n.push(g), g;
...
function Vc(e) {
  ...
  if (n.update(
    () => {
      const s = new DOMParser().parseFromString(t, "text/html"), i = Ic(n, s);
      ee().clear(), Li(i);
    },
    {
      discrete: !0
...
function Np({
  ...
  const [a, s] = M($c), [i, l] = M(void 0), [w, c] = M(!1), p = Q(void 0), m = Q(null);
  Y(() => {
    let N = !0;
    const y = m.current;
    if (!y) return;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ o(Et, { children: /* @__PURE__ */ d(Rt, { children: [
          /* @__PURE__ */ o($t, { asChild: !0, children: /* @__PURE__ */ o(B, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(Ae, {}) }) }),
          /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: k }) })
        ] }) }),
        /* @__PURE__ */ o(Et, { children: /* @__PURE__ */ d(Rt, { children: [
...
const kp = Object.freeze([
  ...
  "%no_comments%"
], Lc = ["input", "select", "textarea", "button"], Bc = ["button", "textbox"], jc = ({
  options: e,
  onFocusChange: t,
  onOptionSelect: n,
  onCharacterPress: r
...
Ia.displayName = Ve.Root.displayName;
...
Xc.displayName = Ve.Image.displayName;
...
Aa.displayName = Ve.Fallback.displayName;
const Pr = En(void 0);
function It() {
  const e = br(Pr);
  if (!e)
...
}), Be = rt.Trigger, Pa = rt.Group, Uc = rt.Portal, Yc = rt.Sub, qc = rt.RadioGroup;
...
function wo({
  ...
  }, [e.date, n]), S = L(() => e.user, [e.user]), P = L(
    ...
    if (r && c)
      return /* @__PURE__ */ d(lt, { children: [
        !ei(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              f(!0), g(Vc(Hr(e.contents))), w == null || w(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ia, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Aa, { className: "tw-text-xs tw-font-medium", children: P }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: k,
              onKeyDownCapture: (x) => {
                x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), v()) : x.key === "Enter" && x.shiftKey && (x.preventDefault(), x.stopPropagation(), Tt(u) && N());
              },
              onKeyDown: (x) => {
        ...
        A && /* @__PURE__ */ d(Ne, { children: [
          /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(yo, {}) }) }),
...
function Wc({
  ...
  const [y, S] = M(po), [P, j] = M(!1), [A, x] = M(!1), [C, E] = M(!1), [_, I] = M(!1), [V, G] = M(!1), [R, F] = M(void 0), [D, J] = M(!1), [pt, jt] = M(!1), [zt, ct] = M(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    if (!r) {
      J(!1), jt(!1), ct(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
  ...
  const $ = L(() => t.filter((T) => !T.deleted), [t]);
  Y(() => {
    let T = !0;
    if (!r || !N) {
      ct(/* @__PURE__ */ new Map());
  ...
  const et = L(() => $[0], [$]), bt = Q(null), mt = Q(void 0), ht = z(() => {
    var T;
  ...
  const Ft = L(
  ...
  }, [s, n]), le = L(() => $.slice(1), [$]), _t = L(() => le.length ?? 0, [le.length]), wn = L(() => _t > 0, [_t]), $n = L(() => C || _t <= 2 ? le : le.slice(-2), [le, _t, C]), ke = L(() => C || _t <= 2 ? 0 : _t - 2, [_t, C]), Ln = L(
    () => _t === 1 ? Ft.singleReply : ue(Ft.multipleReplies, { count: _t }),
    [_t, Ft]
  ), O = L(
    () => ke === 1 ? Ft.singleReply : ue(Ft.multipleReplies, { count: ke }),
    [ke, Ft]
  ), U = z(async () => {
    const T = Tt(y) ? kn(y) : void 0;
    if (R !== void 0) {
      await p({
        threadId: w,
        contents: T,
    ...
    async (T) => {
      const nt = Tt(y) ? kn(y) : void 0, ut = await p({
        ...T,
        contents: nt,
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          ...
          /* @__PURE__ */ o(
            wo,
            {
              ...
              handleDeleteComment: f,
              onEditingChange: I,
              canEditOrDelete: zt.get(et.id) ?? !1,
          ...
          r && /* @__PURE__ */ d(lt, { children: [
            ...
            g !== !1 && (!_ || Tt(y)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  T.key === "Enter" && T.shiftKey && (T.preventDefault(), T.stopPropagation(), (Tt(y) || R !== void 0) && U());
                },
                onKeyDown: (T) => {
...
function Cp({
  ...
  const y = n.filter(
    ...
    [g]
  ), { listboxRef: A, activeId: x, handleKeyDown: C } = jc({
    options: S,
    onOptionSelect: P
  }), E = z(
    (_) => {
...
function Zc({ table: e }) {
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Xi, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(Ss, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Oe = it.Root, Qc = it.Group, Ie = it.Value, tw = oe(
  ...
  return /* @__PURE__ */ d(
    it.Trigger,
    {
      className: h(tw({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
...
const ew = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  it.Label,
  {
    ref: n,
...
ew.displayName = it.Label.displayName;
...
nw.displayName = it.Separator.displayName;
function rw({ table: e }) {
...
function en(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && ow(r)
  );
}
...
const aw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "tfoot",
  {
    ref: n,
...
function ww({
  ...
  var A;
  const [p, m] = M([]), [f, u] = M([]), [g, k] = M({}), [v, N] = M({}), y = L(() => t ?? [], [t]), S = jo({
    data: y,
    columns: e,
    getCoreRowModel: Fo(),
  ...
  return w ? j = Array.from({ length: 10 }).map((E, _) => `skeleton-row-${_}`).map((E) => /* @__PURE__ */ o(Gt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ o(ge, { colSpan: P.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(ur, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((A = S.getRowModel().rows) == null ? void 0 : A.length) > 0 ? j = S.getRowModel().rows.map((x) => /* @__PURE__ */ o(
    ...
    x.id
  )) : j = /* @__PURE__ */ o(Gt, { children: /* @__PURE__ */ o(ge, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Zc, { table: S }),
    /* @__PURE__ */ d(On, { stickyHeader: s, children: [
      /* @__PURE__ */ o(In, { stickyHeader: s, children: S.getHeaderGroups().map((x) => /* @__PURE__ */ o(Gt, { children: x.headers.map((C) => (
        /* CUSTOM: tw-p-0, let consumers define padding on their own */
        /* @__PURE__ */ o(nn, { className: "tw-p-0", children: C.isPlaceholder ? void 0 : Ye(C.column.columnDef.header, C.getContext()) }, C.id)
      )) }, x.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(No, {}) })
        ] }),
...
function Rp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "default", children: [
    ...
    /* @__PURE__ */ o(ie, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Pa, { children: c.itemType === 0 ? /* @__PURE__ */ o(lt, { children: c.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Ht,
        {
          checked: r[p][f],
        ...
        qc,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(La, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ o(je, {})
    ] }, c.label)) })
...
function mw({ id: e, versionHistory: t }) {
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(ae, { open: C, onOpenChange: p ?? y, children: [
    ...
    /* @__PURE__ */ o(Wt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(qt, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: A, children: s }),
        /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: x, children: i })
      ] }),
        ...
        /* @__PURE__ */ o(Ut, { children: j.map((_) => /* @__PURE__ */ d(
          Lt,
          {
            ...
            children: [
              ...
              _.starred && /* @__PURE__ */ o(Vs, { className: "tw-h-4 tw-w-4" }),
...
const fw = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(lt, { children: [
...
function gw({
  ...
  return /* @__PURE__ */ d(Ne, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o(Et, { children: /* @__PURE__ */ d(Rt, { children: [
      /* @__PURE__ */ o($t, { asChild: !0, children: /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "outline", className: "tw-h-6", children: fw(e, a, n) }) }) }),
...
const bw = (e, t) => e === "f" ? /* @__PURE__ */ d(lt, { children: [
  /* @__PURE__ */ o(Co, {}),
  " ",
...
function xw({
  ...
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Et, { children: /* @__PURE__ */ d(Rt, { children: [
      /* @__PURE__ */ o(Bi, { asChild: !0, children: /* @__PURE__ */ o(Be, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "outline", className: "tw-h-6", children: bw(e, n) }) }) }),
      /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: vw(e, n) }) })
    ] }) }),
...
function Ip({
  ...
  const w = Q(null), c = bs(), [p, m] = M("generated"), [f, u] = M("*"), [g, k] = M("f"), [v, N] = M(!1), y = L(
    () => ({
      ...i,
  ...
  const S = z(() => {
    ...
    if (C && un("note", C)) {
      ...
      g !== "x" && x === "x" ? R == null || R.forEach((F) => yw(F)) : g === "x" && x !== "x" && (R == null || R.forEach((F) => Nw(F))), (G = w.current) == null || G.applyUpdate([{ delete: 1 }, C]);
    }
  }, A = () => {
    var C, E, _, I, V;
    const x = (E = (C = w.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : E.at(0);
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Et, { children: /* @__PURE__ */ d(Rt, { children: [
          /* @__PURE__ */ o($t, { asChild: !0, children: /* @__PURE__ */ o(B, { onClick: r, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(Ae, {}) }) }),
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Et, { children: /* @__PURE__ */ d(Rt, { children: [
            /* @__PURE__ */ o($t, { asChild: !0, children: /* @__PURE__ */ o(B, { onClick: P, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(No, {}) }) }),
  ...
  return /* @__PURE__ */ d(lt, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(lt, { children: kw(e.marker, l, r, c) })
      }
    )
  ] });
}
...
function Sw({
  ...
  return /* @__PURE__ */ d(On, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(In, { stickyHeader: !0, children: /* @__PURE__ */ d(Gt, { children: [
    ...
    /* @__PURE__ */ o(An, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Gt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ge, { className: r, children: Ew(l.text) })
        ]
      },
...
const Tw = (e) => {
  if (e === "asc")
    return /* @__PURE__ */ o(js, { className: "tw-h-4 tw-w-4" });
  if (e === "desc")
    return /* @__PURE__ */ o(zs, { className: "tw-h-4 tw-w-4" });
}, Pn = (e, t, n) => /* @__PURE__ */ o(Et, { children: /* @__PURE__ */ d(Rt, { children: [
  /* @__PURE__ */ d(
    $t,
    {
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw-w-6 tw-max-w-fit tw-flex-1 tw-overflow-hidden tw-text-ellipsis", children: t }),
        Tw(e.getIsSorted())
      ]
    }
  ),
  /* @__PURE__ */ o(St, { side: "bottom", children: t })
] }) }), Vp = (e) => ({
  accessorKey: "item",
  accessorFn: (t) => t.items[0],
  header: ({ column: t }) => Pn(t, e)
}), Rw = (e, t) => ({
  accessorKey: `item${t}`,
  accessorFn: (n) => n.items[t],
  header: ({ column: n }) => Pn(n, e)
}), $p = (e) => ({
  accessorKey: "count",
  header: ({ column: t }) => Pn(t, e, "tw-justify-end"),
  cell: ({ row: t }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: t.getValue("count") })
}), qn = (e, t, n, r, a, s) => {
  let i = [...n];
  e.forEach((w) => {
  ...
  accessorKey: "status",
  header: ({ column: s }) => Pn(s, e, "tw-justify-center"),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ d(Ir, { value: i, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ o(
        We,
        {
          onClick: (w) => {
...
function Gp({
  ...
  const f = At(n, "%webView_inventory_all%"), u = At(n, "%webView_inventory_approved%"), g = At(n, "%webView_inventory_unapproved%"), k = At(n, "%webView_inventory_unknown%"), v = At(n, "%webView_inventory_scope_currentBook%"), N = At(n, "%webView_inventory_scope_chapter%"), y = At(n, "%webView_inventory_scope_verse%"), S = At(n, "%webView_inventory_filter_text%"), P = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = At(n, "%webView_inventory_no_results%"), [A, x] = M(!1), [C, E] = M("all"), [_, I] = M(""), [V, G] = M([]), R = L(() => {
    const $ = e ?? [];
    return $.length === 0 ? [] : Ow($, a, s);
  }, [e, a, s]), F = L(() => {
    if (A) return R;
    const $ = [];
    return R.forEach((et) => {
      const bt = et.items[0], mt = $.find(
        (ht) => ht.items[0] === bt
      );
      mt ? (mt.count += et.count, mt.occurrences = mt.occurrences.concat(et.occurrences)) : $.push({
        items: [bt],
        count: et.count,
  ...
  }, [A, R]), D = L(() => F.length === 0 ? [] : Mw(F, C, _), [F, C, _]), J = L(() => {
    var bt, mt;
    if (!A) return w;
    const $ = (bt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : bt.length;
    if (!$) return w;
    const et = [];
    for (let ht = 0; ht < $; ht++)
      et.push(
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(Oe, { onValueChange: ($) => jt($), defaultValue: i, children: [
...
const Iw = "16rem", Aw = "3rem", Fa = b.createContext(void 0);
function Vn() {
...
const Ga = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ o(Fa.Provider, { value: y, children: /* @__PURE__ */ o(Et, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Fw = oe(
  ...
  ({
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o($t, { asChild: !0, children: p }),
...
const Kw = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
const Qt = "scrBook", Jw = "scrRef", pe = "source", Ww = "details", Zw = "Scripture Reference", Qw = "Scripture Book", Ja = "Type", td = "Details";
function ed(e, t) {
  const n = t ?? !1;
  return [
    {
...
function Up({
  ...
  const [c, p] = M([]), [m, f] = M([{ id: Qt, desc: !1 }]), [u, g] = M({}), k = L(
    ...
    !t && /* @__PURE__ */ d(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ye, { position: "item-aligned", children: /* @__PURE__ */ o(Qc, { children: P.map((E) => /* @__PURE__ */ o(Ct, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(On, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(In, { children: N.getHeaderGroups().map((E) => /* @__PURE__ */ o(Gt, { children: E.headers.filter((_) => _.column.columnDef.header).map((_) => (
...
function od({
  ...
  const A = L(() => Z.allBookIds.filter(
    ...
    (R, F = !1) => {
      ...
      const [pt, jt] = [
        Math.min(D, J),
        Math.max(D, J)
      ], zt = A.slice(pt, jt + 1).map((ct) => ct);
      n(
        t.includes(R) ? t.filter((ct) => !zt.includes(ct)) : [.../* @__PURE__ */ new Set([...t, ...zt])]
      );
    },
    [t, n, A]
  ), E = (R) => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(K).map((R) => /* @__PURE__ */ o(
      rd,
      {
        section: R,
        availableBookIds: A,
            ...
            qt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: V, children: w }),
                  /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: G, children: c })
                ] }),
                /* @__PURE__ */ d(Jt, { children: [
                  ...
                  Object.values(K).map((R, F) => {
                    ...
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(go, { children: [
                        ...
                        F < Object.values(K).length - 1 && /* @__PURE__ */ o(Uo, {})
                      ] }, R);
                  })
                ] })
              ]
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ d(Rt, { children: [
  /* @__PURE__ */ o($t, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    _n,
    {
      onClick: () => {
        r(l);
    ...
    /* @__PURE__ */ o(Uc, { children: /* @__PURE__ */ o($a, { children: Qa(
      e,
      t,
      Za(e, l.id),
      r
...
function gr({
  ...
  return /* @__PURE__ */ d(Ne, { variant: s, children: [
    /* @__PURE__ */ o(Be, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(B, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Ks, {}) }) }),
    /* @__PURE__ */ o(ie, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(go, { children: [
      /* @__PURE__ */ o(Pa, { children: /* @__PURE__ */ o(Et, { children: Qa(t.groups, t.items, w, e) }) }),
...
function nu({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(es, { children: [
      /* @__PURE__ */ o(ns, { children: e.map((l) => /* @__PURE__ */ o(ad, { value: l.value, children: l.value }, l.key)) }),
...
const cs = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = It();
  return /* @__PURE__ */ o(
    ot.Item,
    {
...
cs.displayName = ot.Item.displayName;
...
const Ke = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((c) => c.group === s).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ d(Rt, { children: [
      /* @__PURE__ */ o($t, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        cs,
        {
          onClick: () => {
            r(c);
        ...
        /* @__PURE__ */ o(ss, { children: c.label }),
    ...
    return l.length > 0 && i < a.length - 1 && w.push(/* @__PURE__ */ o(ws, {}, `separator-${s}`)), w;
  });
};
function dd({
  menuData: e,
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (k = i.current) == null || k.focus(), Ke(i, [f, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Ke(l, [f, u]);
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), Ke(w, [f, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ o(os, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(sd, { children: [
      /* @__PURE__ */ o(as, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        ls,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Et, { children: ds(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(Ne, { children: [
              /* @__PURE__ */ o(Be, { className: h(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(yo, {}) }) }),
...
const hu = Ot.Trigger, Rd = Ot.Portal, fu = Ot.Close, us = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ot.Overlay,
  {
    ref: n,
...
us.displayName = Ot.Overlay.displayName;
