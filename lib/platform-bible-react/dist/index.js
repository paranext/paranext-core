...
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Sa, useState as _, useEffect as W, useCallback as j, useId as co, useImperativeHandle as Oc, useLayoutEffect as Zt, Fragment as Kr, Component as Mc, createElement as cn, Suspense as zc, forwardRef as ii } from "react";
...
function ed({
  ...
  W(() => {
    ...
    return tt.addEventListener("focus", rt), tt.addEventListener("blur", M), () => {
      tt.removeEventListener("focus", rt), tt.removeEventListener("blur", M);
    };
  }, [T, h, l]);
  const B = j(() => {
    T && R(!0), f(), P && w();
  ...
  const D = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), O = P ? (
...
function nd({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = co(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, ad), P = re(s, od), T = (O) => {
    O || (R.current = !0, x(!1)), k || g(O), p == null || p(O);
  }, B = (O) => {
    if (O && R.current) {
      R.current = !1;
      return;
  ...
  return /* @__PURE__ */ u(ze, { open: C, onOpenChange: T, modal: !1, children: [
    /* @__PURE__ */ a(Mt, { children: E ? /* @__PURE__ */ u(Ct, { open: f, onOpenChange: B, children: [
...
function Ha({
  ...
  const T = Ce(), B = Ql(), [I, D] = _(!1), [O, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [M, z] = _(void 0), [q, it] = _(
    void 0
    ...
    if (!A) return;
    const m = O.startsWith(`${A.book} `) ? O : "", H = ta(m), at = zr(m);
    return {
      book: A.book,
  ...
  const Qt = j(() => {
    ...
    (m) => {
      const H = N === "chapters" ? M : A == null ? void 0 : A.book;
      if (H) {
        if (w && w(H, m) > 1) {
    ...
    (m) => {
      ...
      const yt = (() => {
        ...
        if (N === "chapters" || N === "books" && A && Le(A.book) > 1) {
          const Gt = N === "chapters" ? M : A == null ? void 0 : A.book;
          return Gt ? {
            max: Le(Gt),
            current: zr(O) ?? 0,
  ...
  Zt(() => {
    ...
    if (N === "chapters" && M) {
      const m = M === t.book, H = m ? t.chapterNum : 1;
      Y(gr(M, H)), setTimeout(() => {
        if (xt.current)
          if (m) {
  ...
  }, [N, A, pe, Q, O]), /* @__PURE__ */ u(tr, { open: I, onOpenChange: ct, modal: k, children: [
          ...
          rr,
          {
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u(
                ...
                N === "chapters" && M && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Re(M, s) }),
...
function xn({
  ...
  const [C, E] = _(!1), P = d ?? l, T = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], B = (I, D) => {
    const O = l(I), Y = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, U = `${D ?? ""}${O}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      Ge,
      {
        value: O,
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bd = Di ? Zt : W, ra = { tag: Io };
...
const Oi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Od = Oi && "documentMode" in document ? document.documentMode : null;
!(!Oi || !("InputEvent" in window) || Od) && "getTargetRanges" in new window.InputEvent("input");
function ye(t) {
  return `${t}px`;
}
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((T || B) && E !== null && P !== null) {
        const I = function(D, O, Y, U, tt, N, rt) {
          const M = (D._window ? D._window.document : document).createRange();
          return M.setStart(...yn(O, Y, U)), M.setEnd(...yn(tt, N, rt)), M;
        }(t, h, f, E, g, R, P);
        l(), l = zd(t, I, e);
      }
...
let ba, Oe = 0, xa = 0, Ud = 0, bo = 0, da = 0;
function _n(t) {
  if (st === void 0) return;
  let e = t.n;
...
function Hd(t) {
  ...
  zi(this), st = t, this.f &= -2, 8 & this.f && Bo(this), Oa();
}
function ur(t, e) {
...
Wt.prototype.brand = jd, Wt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Oe !== 0 && xa === 0 && e.l !== bo && (e.l = bo, ba = { S: e, v: e.v, i: e.i, o: ba });
    })(this), this.v = t, this.i++, da++, Oe++;
    try {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ii(this), Nn(this), Oe++;
  const t = st;
...
const jo = 0, yo = 1, Bi = 2, Wa = 3, aa = 4, wr = 5, Xa = 6, Or = 7;
function Za(t) {
  return t.id === jo;
}
function ji(t) {
...
class Xd {
  ...
  register(e, r) {
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== Or && ut(309, String(o.id), String(Or)), this.state = function(i) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Or;
    }(e) || ut(316, String(e.id), String(Or)), e;
  }
...
ue({ dependencies: [xo, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [mr], register(t, e, r) {
  ...
  return Me(t.registerCommand(ew, (i) => {
    const c = ae();
    if (!_e(c)) return !1;
...
function ow(t, e, r = Fi) {
  return Me(t.registerCommand(yl, (o) => {
    const n = ae();
    if (!_e(n)) return !1;
    o.preventDefault();
    const s = function(i) {
...
function Zi({
  ...
  return /* @__PURE__ */ u(Ca, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
        Z,
        {
          "aria-label": i,
...
const Mw = "verseText", oh = Object.freeze([
...
function rs({
  ...
  const [U, tt] = _(In), [N, rt] = _(), [M, z] = _(), q = o, [it, ot] = _(!1), [dt, St] = _(!1), [J, lt] = _(!1), [vt, pt] = _(!1), [zt, Ht] = _(!1), [wt, me] = _(E), [oe, bt] = _(!1), gt = F(void 0), [xt, qt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let y = !0;
    return (async () => {
      const $ = k ? await k(l) : !1;
          ...
          o && /* @__PURE__ */ u(ht, { children: [
            ...
            b !== !1 && (!dt || we(U)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (y) => {
                  Ho(y) && (y.preventDefault(), y.stopPropagation(), (we(U) || N !== void 0 && N !== M) && S());
                },
                onKeyDown: (y) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    N !== void 0 && (we(U) || N !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Fe(
...
function jw({
  ...
  const O = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: O }), U = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : Y, tt = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(pa, { html: R }) : Y : U(M === "reject" ? t.rejectedResultText : t.resultText);
  }, N = (M) => p && M.value === "reject", rt = (M) => {
    const z = f === M.value, q = `${d}-${M.value}`, it = N(M);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(
          Co,
          {
            ...
            children: T.map((M) => N(M) ? /* @__PURE__ */ a(Mt, { delayDuration: 0, children: /* @__PURE__ */ u(Ct, { children: [
              /* @__PURE__ */ a(Et, { asChild: !0, children: rt(M) }),
              /* @__PURE__ */ a(Tt, { children: E })
            ] }) }, M.value) : rt(M))
          }
        ),
        /* @__PURE__ */ a(Mt, { delayDuration: 0, children: /* @__PURE__ */ u(Ct, { children: [
...
function ou({
  ...
  return /* @__PURE__ */ u(Ca, { children: [
    ...
    e && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
        Z,
        {
          "aria-label": w,
...
function Nh({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [I, D] = _("f"), [O, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), M = F(!1), z = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, J] = _(), [lt, vt] = _(), [pt, zt] = _(), Ht = F(null), wt = F(
    void 0
  ...
  W(() => {
    var G, $;
    let S, K, X;
    M.current = !1, oe.current = void 0, tt(!0);
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      I !== "x" && S === "x" ? nt == null || nt.forEach((ct) => mu(ct)) : I === "x" && S !== "x" && (nt == null || nt.forEach((ct) => vu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (S) => {
    ...
    (S) => {
      ...
      if (K && Dr("note", K)) {
        ...
        if (nt || Y(!1), Y(
          ...
          M.current = !0, z.current = JSON.stringify(K), tt(!0);
          return;
        }
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ct, { children: [
              /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
                Z,
                {
                  "aria-label": ce,
...
}, Ma = (t, e, r) => /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ct, { children: [
  /* @__PURE__ */ u(
    Et,
    {
...
function Ih({
  ...
  const g = xe(r, "%webView_inventory_all%"), f = xe(r, "%webView_inventory_approved%"), x = xe(r, "%webView_inventory_unapproved%"), b = xe(r, "%webView_inventory_unknown%"), R = xe(r, "%webView_inventory_scope_currentBook%"), k = xe(r, "%webView_inventory_scope_chapter%"), C = xe(r, "%webView_inventory_scope_verse%"), E = xe(r, "%webView_inventory_filter_text%"), P = xe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = xe(r, "%webView_inventory_no_results%"), [B, I] = _(!1), [D, O] = _("all"), [Y, U] = _(""), [tt, N] = _([]), rt = V(() => {
    const J = t ?? [];
  ...
  }, [B, rt]), z = V(() => M.length === 0 ? [] : Su(M, D, Y), [M, D, Y]), q = V(() => {
    var vt, pt;
    if (!B) return l;
  ...
  const it = (J, lt) => {
    ...
    if (M.length === 0 || tt.length === 0) return [];
    const J = M.filter((lt) => Sc(
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ct, { children: [
        /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Ot, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? P })
        ] }) }),
...
const Du = "16rem", Ou = "3rem", os = Xt.createContext(void 0);
function za() {
...
function Wh({
  ...
  W(() => {
    if (c) {
      const D = R.getSelectedRowModel().rowsById, O = Object.keys(D);
      if (O.length === 1) {
        const Y = x.find((U) => jn(U) === O[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, x, c, R]);
  ...
  }, B = (D, O) => D.getIsGrouped() ? "" : v("banded-row", O % 2 === 0 ? "even" : "odd"), I = (D, O, Y) => {
    if (!((D == null ? void 0 : D.length) === 0 || O.depth < Y.column.getGroupedIndex())) {
      if (O.getIsGrouped())
        switch (O.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(To, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(So, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(je, { children: D.headers.filter((O) => O.column.columnDef.header).map((O) => (
        ...
        /* @__PURE__ */ a(fa, { colSpan: O.colSpan, className: "tw:sticky top-0", children: O.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Pr(O.column.columnDef.header, O.getContext())
        ] }) }, O.id)
      )) }, D.id)) }),
      /* @__PURE__ */ a(Ro, { children: R.getRowModel().rows.map((D, O) => {
        const Y = Ce();
        return /* @__PURE__ */ a(
          je,
          {
...
function Yu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
    ...
    (N, rt = !1) => {
      ...
      const M = T.findIndex((dt) => dt === E.current), z = T.findIndex((dt) => dt === N);
      if (M === -1 || z === -1) return;
      const [q, it] = [
        Math.min(M, z),
        Math.max(M, z)
...
function Xu({
  ...
  return /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ct, { children: [
    /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
      Wu,
      {
        className: o,
...
function Zh({
  ...
  const T = Bt(
    i,
    "%webView_scope_selector_selected_text%"
  ), B = Bt(i, "%webView_scope_selector_verse%"), I = Bt(i, "%webView_scope_selector_chapter%"), D = Bt(i, "%webView_scope_selector_book%"), O = Bt(
    i,
    "%webView_scope_selector_current_verse%"
  ), Y = Bt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), U = Bt(i, "%webView_scope_selector_current_book%"), tt = Bt(i, "%webView_scope_selector_choose_books%"), N = Bt(i, "%webView_scope_selector_scope%"), rt = Bt(i, "%webView_scope_selector_select_books%"), M = Bt(i, "%webView_scope_selector_range%"), z = Bt(i, "%webView_scope_selector_select_range%"), q = Bt(i, "%webView_scope_selector_range_start%"), it = Bt(i, "%webView_scope_selector_range_end%"), ot = Bt(i, "%webView_scope_selector_ok%"), dt = Bt(i, "%webView_scope_selector_cancel%"), St = Bt(i, "%webView_scope_selector_navigate%"), J = (L) => {
    if (!b) return;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ot, { htmlFor: "scope-range-start", className: v(Cr && nr), children: q }),
      /* @__PURE__ */ a(
        Ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: oe, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ot, { htmlFor: "scope-range-end", className: v(Er && nr), children: it }),
      /* @__PURE__ */ a(
        Ha,
        {
          id: "scope-range-end",
          ...
          children: pt.map(({ value: L, label: Q, scrRefSuffix: At, id: le }) => {
            ...
            return /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-0.5", children: [
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
                ...
                /* @__PURE__ */ a(Ot, { htmlFor: le, children: vt(Q, At) })
              ] }),
...
function ko({
  ...
  return /* @__PURE__ */ u(ze, { variant: s, children: [
    ...
    /* @__PURE__ */ a(Ie, { align: "start", style: { zIndex: Pe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Kr, { children: [
      /* @__PURE__ */ a(qn, { children: /* @__PURE__ */ a(Mt, { children: ss(e.groups, e.items, l, t) }) }),
  ...
  if (Gl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(np, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(ip, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Pe },
          children: /* @__PURE__ */ a(Mt, { children: ps(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function sg({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Ot, { className: "tw:font-normal tw:text-muted-foreground", children: Fe(d, {
...
export {
  ...
  sf as CONTENT_ZOOM_CSS_VARIABLE_PREFIX,
  cf as CONTENT_ZOOM_DEFAULT_CSS_VARIABLE,
  lf as CONTENT_ZOOM_POPUP_ATTRIBUTE,
  df as CONTENT_ZOOM_ROOT_ATTRIBUTE,
  ...
  wf as ContentZoomAreaProvider,
  uf as ContentZoomRoot,
  gg as ContextMenu,
