...
import { jsx as r, jsxs as p, Fragment as nt } from "react/jsx-runtime";
...
function mp({
  ...
  const c = ht(), [d, m] = S(!1), [f, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, F] = S(!1), j = H(void 0), R = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), V = K(
    ...
    [v, pt]
  ), { otLong: st, ntLong: it, dcLong: wt, extraLong: xt } = {
      ...
      ne,
      {
        ...
        children: [
          ...
          !C && /* @__PURE__ */ p(re, { ref: $, children: [
            v === "books" && /* @__PURE__ */ p(nt, { children: [
              ...
              I && Gt(I.book) > 1 && /* @__PURE__ */ p(nt, { children: [
...
function vl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = gl(null, o), d = To({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, f) {
      if (f !== null) {
...
function Sl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !ii(e) && o !== null) {
    ...
    if (c || d) {
      const [m, f] = li(t), u = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let v, y = 0;
  ...
  return de(t.registerCommand(gi, (i) => {
    if (bi(i.target)) {
      ...
      if (Yl(l)) return function(w, c = !1) {
        ...
        let u;
        c && Ao(d) ? u = d : (u = xi(), yi(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
...
function Xl(t, e, n = fa) {
  return de(t.registerCommand(Ri, (o) => {
    ...
    const s = function(i) {
      ...
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), m = Il(d);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Si();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Di(u), u.anchor.is(c)) return !0;
      }
      return !1;
  ...
  return function(n, o) {
    ...
    return Rr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (f) => n._onError(f), children: r(fs, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(Ui(d, m, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function rw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Rr(() => de(Ki(a), ga(a)), [a]);
  }(o), p(nt, { children: [t, r(ow, { content: e }), r(nw, { editor: o, ErrorBoundary: n })] });
}
...
function dw(t, e) {
  ...
  return p(nt, { children: [r(ww, { editor: a, ...o, ref: e }), n != null && r(pw, { editor: a, content: n })] });
}
...
function bp({
  ...
  const [a, s] = S(Tw), [i, l] = S(void 0), [w, c] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
...
}), Ce = rt.Trigger, Ia = rt.Group, Lw = rt.Portal, Vw = rt.Sub, jw = rt.RadioGroup;
function ue({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ir.Provider, { value: n, children: /* @__PURE__ */ r(rt.Root, { ...e }) });
}
...
Aa.displayName = rt.SubContent.displayName;
...
Pa.displayName = rt.RadioItem.displayName;
    ...
    if (o && l)
      return /* @__PURE__ */ p(nt, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), m(Ew(t.contents)), i == null || i(!0);
            },
            children: [
...
function Fw({
  ...
  const [R, $] = S(lo), [E, D] = S(
    void 0
  ), V = o, [P, O] = S(!1), [A, W] = S(!1), [I, J] = S(!1), [Tt, At] = S(!1), [Mt, gt] = S(!1), [pt, G] = S(C), [st, it] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
...
function Cp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Ia, { children: c.itemType === 0 ? /* @__PURE__ */ r(nt, { children: c.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][f],
        ...
        jw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Pa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ge, {})
    ] }, c.label)) })
  ...
  return /* @__PURE__ */ p(nt, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ p("p", { children: [
        ...
        s && /* @__PURE__ */ p(nt, { children: [
          " ",
          /* @__PURE__ */ r("kbd", { className: "tw-rounded tw-border tw-border-border tw-bg-muted tw-px-1 tw-py-0.5 tw-font-mono tw-text-xs", children: w ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ p("p", { children: [
        ...
        s && /* @__PURE__ */ p(nt, { children: [
          " ",
          /* @__PURE__ */ r("kbd", { className: "tw-rounded tw-border tw-border-border tw-bg-muted tw-px-1 tw-py-0.5 tw-font-mono tw-text-xs", children: w ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const wc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(nt, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ p(nt, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
const dc = (t, e) => t === "f" ? /* @__PURE__ */ p(nt, { children: [
  /* @__PURE__ */ r(_o, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ p(nt, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function hc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  ...
  return /* @__PURE__ */ p(ne, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(re, { children: [
      ...
      i.length > 0 && /* @__PURE__ */ p(nt, { children: [
...
function Sp({
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      N !== "x" && _ === "x" ? ct == null || ct.forEach((Rt) => bc(Rt)) : N === "x" && _ !== "x" && (ct == null || ct.forEach((Rt) => vc(Rt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
    ...
    (_) => {
      ...
      if (L && dn("note", L)) {
        ...
        R(JSON.stringify(L) === V.current), it(g, v);
      } else
        F(!1), R(!0);
    },
    [g, v, it]
    ...
    if (f.current && st.length && _ && _.rangeCount > 0) {
  ...
  return /* @__PURE__ */ p(nt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(nt, { children: yc(t.marker, l, o, c) })
      }
    )
  ] });
}
...
function jp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), F = Kt(
    ...
    const G = [];
    return W.forEach((st) => {
      const it = st.items[0], wt = G.find(
        (xt) => xt.items[0] === it
      );
      wt ? (wt.count += st.count, wt.occurrences = wt.occurrences.concat(st.occurrences)) : G.push({
        items: [it],
        count: st.count,
  ...
  const At = (G, st) => {
    ...
    const G = I.filter((st) => si(
      R ? st.items : [st.items[0]],
      O
    ));
...
function fr({
  ...
  return /* @__PURE__ */ p(ue, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(ho, { children: [
      /* @__PURE__ */ r(Ia, { children: /* @__PURE__ */ r(kt, { children: Wa(e.groups, e.items, w, t) }) }),
...
es.displayName = ot.Root.displayName;
...
rs.displayName = ot.SubTrigger.displayName;
...
os.displayName = ot.SubContent.displayName;
...
as.displayName = ot.Content.displayName;
...
ss.displayName = ot.Item.displayName;
...
id.displayName = ot.RadioItem.displayName;
...
ld.displayName = ot.Label.displayName;
...
is.displayName = ot.Separator.displayName;
const Ye = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
...
const ru = at.Root, ou = at.Trigger, au = at.Group, su = at.Portal, iu = at.Sub, lu = at.RadioGroup, gd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  at.SubTrigger,
  {
    ref: a,
    className: h(
...
gd.displayName = at.SubTrigger.displayName;
...
bd.displayName = at.SubContent.displayName;
const vd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(at.Portal, { children: /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: h(
...
vd.displayName = at.Content.displayName;
...
xd.displayName = at.Item.displayName;
...
yd.displayName = at.CheckboxItem.displayName;
...
Nd.displayName = at.RadioItem.displayName;
...
kd.displayName = at.Label.displayName;
...
_d.displayName = at.Separator.displayName;
