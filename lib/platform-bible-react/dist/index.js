...
import v, { forwardRef as Fn, useRef as q, useMemo as z, useState as I, useCallback as G, useEffect as J, useLayoutEffect as te, createContext as gr, useContext as uo, Component as Ii, createElement as Fo, Suspense as Di, Fragment as mo } from "react";
...
function ba({
  ...
  const T = kt(), [D, k] = I(!1), [C, S] = I(""), [R, E] = I(""), [b, O] = I("books"), [$, V] = I(void 0), [A, j] = I(
    void 0
  ), [H, Y] = I(void 0), [tt, Tt] = I(!1), Bt = q(null), $t = q(!1), it = q(void 0), ht = q(void 0), K = q(void 0), nt = q(void 0), lt = q({}), rt = q({}), at = G(
    (_) => {
      e(_), l && l(_);
    },
    [e, c]
  ...
  const fe = G(() => {
    ...
    const _ = A;
    j(void 0), Y(void 0), _ ? (V(_), O("chapters"), S("")) : vt();
  }, [A, vt]), St = G((_) => {
    k(_), _ && (O("books"), V(void 0), j(void 0), Y(void 0), E(""));
    ...
    (k) => {
      ...
      if (b === "verses" && Rt) {
        ...
        Zt !== bt && (_.preventDefault(), _.stopPropagation(), S(
          `${zt} ${ae[zt] || ""} ${Ct}:${Zt}`
        ), setTimeout(() => {
      ...
      if ((b === "chapters" || b === "books" && P) && Rt) {
        ...
        bt !== Ct && (_.preventDefault(), _.stopPropagation(), S(
          `${zt} ${ae[zt] || ""} ${bt}`
        ), setTimeout(() => {
    ...
    (U || Z) && (_.preventDefault(), E((ne) => ne + _.key), ht.current.focus(), Tt(!1));
  }, []);
  return te(() => {
    const _ = setTimeout(() => {
      if (D && b === "books" && K.current && nt.current) {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ w(Ce, { open: D, onOpenChange: St, modal: x, children: [
    ...
    /* @__PURE__ */ a(
      _e,
      {
        ...
        onPointerDownOutside: (_) => {
          const { target: U } = _;
          D && Bt.current && U instanceof Node && Bt.current.contains(U) && ($t.current = !0, St(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          $e,
              ...
              b === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  V,
                  {
                    ...
                    children: T === "ltr" ? /* @__PURE__ */ r(Oi, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ta, { className: "tw-h-4 tw-w-4" })
                  }
                ),
...
function tn({
  ...
  const [D, k] = I(!1), C = c ?? d, S = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], R = (E, b) => {
    const O = d(E), $ = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, V = `${b ?? ""}${O}${$ ?? ""}`;
    return /* @__PURE__ */ w(
      we,
      {
        value: S,
  ...
  return /* @__PURE__ */ w(Ce, { open: D, onOpenChange: k, ...T, children: [
    ...
    /* @__PURE__ */ a(
      _e,
      {
        ...
        children: /* @__PURE__ */ w(ke, { children: [
          ...
          /* @__PURE__ */ r(_e, { children: S(e) ? e.map((E) => /* @__PURE__ */ r(le, { heading: E.groupHeading, children: E.options.map((b) => R(b, E.groupHeading)) }, E.groupHeading)) : e.map((E) => R(E)) })
        ] })
      }
    )
  ] });
...
function Fp({
  ...
  const p = Or(c, "%webView_bookSelector_currentBook%"), m = Or(c, "%webView_bookSelector_choose%"), h = Or(c, "%webView_bookSelector_chooseBooks%"), [u, g] = I(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
function Zl() {
  return function(t) {
    const [e] = Ee(), n = z(() => t(e), [e, t]), [o, a] = I(() => n.initialValueFn()), s = q(o);
    return nd(() => {
...
function td(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !Nl(e) && o !== null) {
    ...
    if (c || p) {
      ...
      const T = e.__text.slice(N, x);
      T !== e.__text && (n === "clone" && (e = _l(e)), e.__text = T);
    }
  }
  return e;
}
...
function ad(t, e, r) {
  ...
  function d() {
    ...
    for (let N = 0; N < u.length; N++) {
      const T = u[N], D = i[N] || document.createElement("div"), k = D.style;
      k.position !== "absolute" && (k.position = "absolute", x = !0);
      const C = ge(T.left - m);
      k.left !== C && (k.left = C, x = !0);
      const S = ge(T.top - h);
      k.top !== S && (D.style.top = S, x = !0);
      const R = ge(T.width);
      k.width !== R && (D.style.width = R, x = !0);
      const E = ge(T.height);
      k.height !== E && (D.style.height = E, x = !0), D.parentNode !== l && (l.append(D), x = !0), i[N] = D;
    }
  ...
  const w = t.registerRootListener(function g() {
    ...
    l(), o = m, n = p, i = new MutationObserver((f) => {
      ...
      if (x !== o || v !== n) return g();
      for (const D of f) if (!c.contains(D.target)) return d();
    }), i.observe(p, rd), d();
  });
  return () => {
    w(), l();
  ...
  function l(w) {
    w.read(() => {
      ...
      const [h, u] = function(E) {
        const b = E.getStartEndPoints();
        return E.isBackward() ? [b[1], b[0]] : b;
      }(m), g = h.getNode(), y = g.getKey(), x = h.offset, N = u.getNode(), T = N.getKey(), D = u.offset, k = t.getElementByKey(y), C = t.getElementByKey(T), S = n === null || k !== o || x !== a || y !== n.getKey(), R = s === null || C !== i || D !== l || T !== s.getKey();
      if ((S || R) && k !== null && C !== null) {
        const E = function(b, O, $, V, A, j, H) {
          const Y = (b._window ? b._window.document : document).createRange();
          return Y.setStart(...aa(O, $, V)), Y.setEnd(...aa(A, j, H)), Y;
        }(t, h, g, k, u, N, C);
        d(), d = cd(t, E, e);
      }
      n = g, o = k, a = x, s = N, i = C, l = D;
    });
  }
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ve(g)) {
                const y = g.anchor;
                let x = y.getNode(), N = 0, T = 0;
                if (sr(x) && c >= 0 && p >= 0 && (N = c, T = c + p, g.setTextNodeRange(x, N, x, T)), N === T && m === "" || (g.insertRawText(m), x = y.getNode()), sr(x)) {
                  N = h, T = h + u;
                  const D = x.getTextContentSize();
                  N = N > D ? D : N, T = T > D ? D : T, g.setTextNodeRange(x, N, x, T);
                }
...
function Ud({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: N = !0, style: T, tabIndex: D, "data-testid": k, ...C }, S) {
  const [R, E] = I(t.isEditable()), b = G(($) => {
...
function Yd({
  ...
  const [e] = Ee(), [n, o] = I(e), [a, s] = I("paragraph"), [i, l] = tw(), d = () => {
  };
...
function ow() {
  const { activeEditor: t } = Ds(), [e, n] = I([]), o = G((a) => {
    if (ve(a) || bc(a)) {
      const s = [];
      fa.forEach(({ format: i }) => {
...
function $s(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  const d = function(g, y) {
    ...
    let T = null;
    if (N !== void 0) for (const D of N) {
      const k = D(g);
      k !== null && (T === null || (T.priority || 0) <= (k.priority || 0)) && (T = k);
    }
...
function Up({
  ...
  const [a, s] = I(pw), [i, l] = I(void 0), [d, c] = I(!1), p = q(void 0), m = q(null);
  J(() => {
    let N = !0;
    const T = m.current;
    if (!T) return;
...
const Kp = Object.freeze([
  ...
  const a = q(null), [s, i] = I(void 0), [l, d] = I(void 0), c = G(
    (u) => {
      i(u);
    ...
    (u) => {
      var R;
      const g = u.target, y = (E) => E ? document.getElementById(E) : void 0, x = y(l), N = y(s);
      if (!!(x && g && x.contains(g) && g !== x) && m(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const E = t.find((b) => b.id === l);
            E && c(E.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const b = E.findIndex(($) => $ === g);
          if (b === -1) return;
          let O;
          u.key === "ArrowDown" ? O = Math.min(b + 1, E.length - 1) : O = Math.max(b - 1, 0), O !== b && (u.preventDefault(), u.stopPropagation(), (R = E[O]) == null || R.focus());
          return;
        }
        return;
      }
      ...
      switch (u.key) {
        case "ArrowDown":
          C = Math.min(k + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          C = Math.max(k - 1, 0), u.preventDefault();
          break;
        case "Home":
          C = 0, u.preventDefault();
          break;
        case "End":
          C = t.length - 1, u.preventDefault();
          break;
        case " ":
        case "Enter":
...
function gn({
  ...
  const u = G(
    ...
    [t.user]
  ), T = z(() => fl(t.contents), [t.contents]), D = z(() => {
    if (o && l)
      return /* @__PURE__ */ w(st, { children: [
        /* @__PURE__ */ w(
          ...
          {
            onClick: (k) => {
              k.stopPropagation(), c(!0), m(ww(t.contents)), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), u()) : Oo(k) && (k.preventDefault(), k.stopPropagation(), se(p) && g());
              },
              onKeyDown: (k) => {
        ...
        D && /* @__PURE__ */ w(Ne, { children: [
          ...
          /* @__PURE__ */ r(ce, { align: "end", children: D })
        ] })
      ]
    }
  );
...
function kw({
  ...
  canUserEditOrDeleteCommentCallback: D,
  isRead: k = !1,
  autoReadDelay: C = 5,
  onVerseRefClick: S
}) {
  const [R, E] = I(ga), [b, O] = I(
    void 0
  ), $ = o, [V, A] = I(!1), [j, H] = I(!1), [Y, tt] = I(!1), [Tt, Bt] = I(!1), [$t, it] = I(!1), [ht, K] = I(k), [nt, lt] = I(!1), rt = q(void 0), [at, Gt] = I(/* @__PURE__ */ new Map());
  J(() => {
    let M = !0;
    return (async () => {
  ...
  const Ft = z(() => It[0], [It]), me = q(null), P = q(void 0), Jt = G(() => {
    var M;
    (M = P.current) == null || M.call(P), E(ga);
  }, []), fe = G(() => {
    const M = !ht;
...
function Qp({
  ...
  const [N, T] = I(/* @__PURE__ */ new Set()), [D, k] = I();
  J(() => {
    g && (T((A) => new Set(A).add(g)), k(g));
  }, [g]);
  const C = n.filter(
    (A) => A.comments.some((j) => !j.deleted)
  ), S = C.map((A) => ({ id: A.id })), R = G(
    (A) => {
      T((j) => new Set(j).add(A.id)), k(A.id), y == null || y(A.id);
    },
    [y]
  ), E = G(
    (A) => {
    ...
    (A) => {
      A.key === "Escape" ? (D && N.has(D) && (T((j) => {
        const H = new Set(j);
        return H.delete(D), H;
      }), k(void 0), y == null || y(void 0)), A.preventDefault(), A.stopPropagation()) : $(A);
    },
    [D, N, $, y]
  );
  X(() => {
...
function $w({
  ...
  var R;
  const [m, h] = I([]), [u, g] = I([]), [y, x] = I({}), [N, T] = I({}), D = z(() => e ?? [], [e]), k = ts({
    data: D,
    columns: t,
    getCoreRowModel: ns(),
  ...
  let S;
  return d ? S = Array.from({ length: 10 }).map((O, $) => `skeleton-row-${$}`).map((O) => /* @__PURE__ */ r(Te, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Qe, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(io, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, O)) : ((R = k.getRowModel().rows) == null ? void 0 : R.length) > 0 ? S = k.getRowModel().rows.map((E) => /* @__PURE__ */ r(
    Te,
    {
      onClick: () => i(E, k),
      "data-state": E.getIsSelected() && "selected",
      className: p == null ? void 0 : p(E),
      children: E.getVisibleCells().map((b) => /* @__PURE__ */ r(Qe, { children: An(b.column.columnDef.cell, b.getContext()) }, b.id))
    },
    E.id
  )) : S = /* @__PURE__ */ r(Te, { children: /* @__PURE__ */ r(Qe, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ w("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Tw, { table: k }),
    /* @__PURE__ */ w(Nr, { stickyHeader: s, children: [
      /* @__PURE__ */ r(kr, { stickyHeader: s, children: k.getHeaderGroups().map((E) => /* @__PURE__ */ r(Te, { children: E.headers.map((b) => /* @__PURE__ */ r(Bn, { className: "tw-p-0", children: b.isPlaceholder ? void 0 : An(b.column.columnDef.header, b.getContext()) }, b.id)) }, E.id)) }),
      /* @__PURE__ */ r(_r, { children: S })
    ] }),
...
function Hw({ row: t, mode: e, strings: n, onClick: o, onOpen: a }) {
  const [s, i] = I(!1), l = q(null), d = !!(t.language || t.languageCode), c = d || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, p = G(() => {
    if (c) {
      i(!0);
      return;
    }
...
function Yw(t) {
  const [e, n] = I(!1), [o, a] = I(""), [s, i] = I(t.defaultGroupByOpenTabs ?? !0), [l, d] = I(!1), c = zw(t.localizedStrings), p = z(() => t.mode === "project" ? Br({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    let S = p;
    return C && (S = S.filter(
      (R) => R.shortName.toLowerCase().includes(C) || R.fullName.toLowerCase().includes(C) || (R.language ?? "").toLowerCase().includes(C) || (R.languageCode ?? "").toLowerCase().includes(C)
    )), t.mode === "project-multi" && l && (S = S.filter((R) => R.isSelected)), S;
  }, [p, o, t.mode, l]), h = z(
    () => Gw(m, s),
    [m, s]
  ), u = z(() => {
    ...
    return t.projects.forEach((S) => {
      const R = t.openTabs.filter((b) => b.projectId === S.id);
      if (R.length === 0) {
      ...
      R.forEach((b) => {
        E.has(b.scrollGroupId) || (E.add(b.scrollGroupId), C.push({ projectId: S.id, scrollGroupId: b.scrollGroupId }));
      });
    }), C;
  }, [t.mode, t.projects, t.openTabs]), g = (C) => {
    ...
    switch (t.mode) {
      case "project": {
        t.onChangeSelection({ projectId: C.projectId }), n(!1);
        return;
      }
      case "project-multi": {
        const S = t.selection.pairs, R = (b) => b.projectId === C.projectId && b.scrollGroupId === C.scrollGroupId, E = S.some(R) ? S.filter((b) => !R(b)) : [...S, { projectId: C.projectId, scrollGroupId: C.scrollGroupId }];
        t.onChangeSelection({ pairs: E }), E.length === 0 && l && d(!1);
        return;
      }
      case "projectScrollGroup": {
        if (C.isBoundButClosed && C.scrollGroupId !== void 0) {
          t.onOpenProjectInGroup(C.projectId, C.scrollGroupId), n(!1);
          return;
        }
        if (C.scrollGroupId !== void 0) {
          t.onChangeSelection({
        ...
        t.onChangeSelection({ projectId: C.projectId, scrollGroupId: S }), t.onOpenProjectInGroup(C.projectId, S), n(!1);
      }
    }
  }, v = () => {
    if (t.mode !== "project-multi") return;
    const C = t.selection.pairs, S = new Set(C.map((E) => `${E.projectId}:${E.scrollGroupId ?? ""}`)), R = [...C];
    u.forEach((E) => {
      const b = `${E.projectId}:${E.scrollGroupId ?? ""}`;
      S.has(b) || (S.add(b), R.push(E));
    ...
    switch (t.mode) {
      case "project": {
        const C = t.projects.find((R) => R.id === t.selection.projectId), S = C ? C.shortName : t.buttonPlaceholder ?? "";
      ...
      case "project-multi": {
        ...
        if (C.forEach((b) => {
          ...
          O && S.push({ project: O, scrollGroupId: b.scrollGroupId });
        }), S.length === 0) {
          const b = t.buttonPlaceholder ?? "";
          return { node: b, title: b };
        }
        if (t.getSelectedText) {
          const b = t.getSelectedText(S);
          return { node: b, title: b };
        }
        const R = S.map(
          ({ project: b, scrollGroupId: O }) => O === void 0 ? b.shortName : `${b.shortName} (${Gn(O)})`
        ).join(", ");
        if (S.length === 1) return { node: R, title: R };
        const E = S.length.toString();
        return {
          node: /* @__PURE__ */ w(st, { children: [
            /* @__PURE__ */ r(ye, { variant: "muted", className: "tw-shrink-0", children: E }),
      ...
      case "projectScrollGroup": {
        ...
        const R = `${C.shortName} · ${Gn(S)}`;
        return { node: R, title: R };
      }
      default:
        return { node: "", title: "" };
    }
  }, [t]), D = t.mode === "project-multi" ? /* @__PURE__ */ r(fo, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }) : /* @__PURE__ */ r(De, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }), k = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? g : void 0;
  return /* @__PURE__ */ w(Ce, { open: e, onOpenChange: n, children: [
    /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ w(
      F,
      {
        ...
        children: [
          /* @__PURE__ */ r("span", { className: "tw-flex tw-min-w-0 tw-flex-1 tw-items-baseline tw-gap-2 tw-overflow-hidden tw-whitespace-nowrap tw-text-start", children: typeof T.node == "string" ? /* @__PURE__ */ r("span", { className: "tw-min-w-0 tw-truncate", children: T.node }) : T.node }),
          D
        ]
      }
    ) }),
      ...
      _e,
      {
        ...
        children: /* @__PURE__ */ a(Ut, { delayDuration: 400, children: /* @__PURE__ */ u($e, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-border-b tw-py-2 tw-pe-4 tw-ps-2", children: [
            t.hideSelectAll ? /* @__PURE__ */ r("span", { "aria-hidden": !0 }) : /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: x, children: `${c.selectAll} (${u.length.toString()})` }),
          ...
          /* @__PURE__ */ w(_e, { children: [
            ...
            h.map((C, S) => /* @__PURE__ */ w(mo, { children: [
              /* @__PURE__ */ r(le, { heading: Xw(C, c), children: C.rows.map((R) => /* @__PURE__ */ r(
                Hw,
                {
                  row: I,
                  mode: t.mode,
...
function Hw({
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ w(Ce, { open: E, onOpenChange: p ?? T, children: [
    /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ w(
      F,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(pe, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ w(ke, { children: [
      ...
      /* @__PURE__ */ w(_e, { children: [
        ...
        /* @__PURE__ */ r(le, { children: C.map((O) => /* @__PURE__ */ w(
          we,
          {
            value: O.label,
            onSelect: D,
...
function Zw({
  ...
  const s = q(null), i = q(null), l = q(!1), [d, c] = I(t), [p, m] = I(n), [h, u] = I(!1);
  J(() => {
    c(t);
  }, [t]), J(() => {
    p !== n && m(n);
  ...
  const g = (x) => {
    ...
    var N, T, D, k;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((N = s.current) == null || N.focus(), l.current = !0) : document.activeElement === s.current && x.key === "ArrowUp" ? ((T = i.current) == null || T.focus(), l.current = !1) : document.activeElement === s.current && x.key === "ArrowLeft" && ((D = s.current) == null ? void 0 : D.selectionStart) === 0 && ((k = i.current) == null || k.focus(), l.current = !1), d === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
...
function wg({
  ...
  const [g, y] = I("generated"), [x, N] = I("*"), [T, D] = I("f"), [k, C] = I(!1), [S, R] = I(!0), [E, b] = I(!1), O = q(!1), $ = q(""), [V, A] = I(!1), [j, H] = I(), [Y, tt] = I(), [Tt, Bt] = I(), [$t, it] = I(), ht = q(null), K = z(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  J(() => {
    ...
    if (X && Wn("note", X)) {
      ...
      let xt = "custom";
      vt === Wr ? xt = "generated" : vt === Jr ? xt = "hidden" : vt && N(vt), y(xt), D(((ct = X.insert.note) == null ? void 0 : ct.style) ?? "f"), B = setTimeout(() => {
        var St;
  ...
  const Ot = () => {
    ...
    if (X && Wn("note", X)) {
      ...
      T !== "x" && B === "x" ? gt == null || gt.forEach((_t) => up(_t)) : T === "x" && B !== "x" && (gt == null || gt.forEach((_t) => mp(_t))), (St = p.current) == null || St.applyUpdate([X, { delete: 1 }]);
    }
  }, Mt = (P) => {
    ...
    if (m.current && Vt.length && P && P.rangeCount > 0) {
      ...
      _t(Y.left - lt.left), tt(Y.top - lt.top), G(Y.height), W(!0);
    }
  }, [Vt, m]);
  X(() => {
    const P = () => {
    ...
    const P = ((lt = g.current) == null ? void 0 : lt.querySelector(".editor-input")) ?? void 0, Y = (nt) => {
      !$ && P && document.activeElement === P && nt.key === c ? (nt.preventDefault(), Jt()) : $ && nt.key === "Escape" && (nt.preventDefault(), W(!1));
    };
...
function pg({
  ...
  const p = d ?? vl(n, void 0), m = (T, D) => {
    c == null || c(T, D, a);
  }, h = s ? n.findIndex((T) => T === s) : -1, [u, g] = I(h), y = (T, D, k) => {
    if (n.length)
      switch (T.key) {
        case "Enter":
        case " ":
          T.preventDefault(), c == null || c(D, k, a);
          break;
      }
  }, x = (T) => {
    if (n.length)
      switch (T.key) {
        case "ArrowDown":
          T.preventDefault(), g((D) => Math.min(D + 1, n.length - 1));
          break;
        case "ArrowUp":
          T.preventDefault(), g((D) => Math.max(D - 1, 0));
          break;
      }
  }, N = q([]);
  return J(() => {
    var T;
    u >= 0 && u < N.current.length && ((T = N.current[u]) == null || T.focus());
  }, [u]), /* @__PURE__ */ r(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((T, D) => {
            ...
            return /* @__PURE__ */ w(st, { children: [
              ...
              D < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(mn, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function yg({
  ...
  const u = he(n, "%webView_inventory_all%"), g = he(n, "%webView_inventory_approved%"), y = he(n, "%webView_inventory_unapproved%"), x = he(n, "%webView_inventory_unknown%"), N = he(n, "%webView_inventory_scope_currentBook%"), T = he(n, "%webView_inventory_scope_chapter%"), D = he(n, "%webView_inventory_scope_verse%"), k = he(n, "%webView_inventory_filter_text%"), C = he(
    n,
    "%webView_inventory_show_additional_items%"
  ), S = he(n, "%webView_inventory_no_results%"), [R, E] = I(!1), [b, O] = I("all"), [$, V] = I(""), [A, j] = I([]), H = z(() => {
    const K = t ?? [];
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ w(fn, { onValueChange: (K) => $t(K), defaultValue: i, children: [
        ...
        /* @__PURE__ */ w(nn, { children: [
          ...
          /* @__PURE__ */ r(re, { value: "chapter", children: T }),
          /* @__PURE__ */ r(re, { value: "verse", children: D })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Or,
      ...
      o && /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
        /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ r(Et, { className: "tw-m-1 tw-truncate", children: (o == null ? void 0 : o.checkboxText) ?? C })
        ] }) }),
        /* @__PURE__ */ r(Pt, { children: (o == null ? void 0 : o.checkboxText) ?? C })
      ] }) })
    ] }),
...
const Js = v.forwardRef(
  ({
    ...
    const [c, p] = v.useState(t), m = e ?? c, h = v.useCallback(
      (D) => {
        const k = typeof D == "function" ? D(m) : D;
        n ? n(k) : p(k);
      },
      [n, m]
    ), u = v.useCallback(() => h((D) => !D), [h]), g = m ? "expanded" : "collapsed", N = kt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = v.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ws.Provider, { value: T, children: /* @__PURE__ */ r(At, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
function Ag({
  ...
  const [c, p] = I([]), [m, h] = I([{ id: Ge, desc: !1 }]), [u, g] = I({}), y = z(
  ...
  const T = a ?? Hp, D = s ?? oi, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${T}`, value: [Ge] },
    { label: `Group by ${D}`, value: [Je] },
    {
  ...
  }, R = (b, O) => b.getIsGrouped() ? "" : f("banded-row", O % 2 === 0 ? "even" : "odd"), E = (b, O, $) => {
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(nn, { position: "item-aligned", children: /* @__PURE__ */ r(Sw, { children: k.map((b) => /* @__PURE__ */ r(re, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
...
function ju({
  ...
  }, [x, N] = I(!1), [T, D] = I(""), k = q(void 0), C = q(!1);
  if (t.length !== wt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const S = z(() => wt.allBookIds.filter(
    ...
    (j, H = !1) => {
      ...
      const Y = S.findIndex((it) => it === k.current), tt = S.findIndex((it) => it === j);
      if (Y === -1 || tt === -1) return;
      const [Tt, Bt] = [
        Math.min(Y, tt),
        Math.max(Y, tt)
      ], $t = S.slice(Tt, Bt + 1).map((it) => it);
      n(
    ...
    E(j, C.current), C.current = !1;
  }, O = (j, H) => {
    j.preventDefault(), E(H, j.shiftKey);
  }, $ = G(
    (j) => {
      const H = jo(S, j).map((Y) => Y);
      n(
        ai(S, j, e) ? e.filter((Y) => !H.includes(Y)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, n, S]
  ), V = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ a(_e, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
            $e,
            {
              shouldFilter: !1,
              onKeyDown: (j) => {
                j.key === "Enter" && (C.current = j.shiftKey);
              },
              children: [
                /* @__PURE__ */ a(
                  mr,
...
function jg({
  ...
  const k = Mt(
    i,
    "%webView_scope_selector_selected_text%"
  ), C = Mt(i, "%webView_scope_selector_verse%"), S = Mt(i, "%webView_scope_selector_chapter%"), R = Mt(i, "%webView_scope_selector_book%"), E = Mt(
    i,
    "%webView_scope_selector_current_verse%"
  ), b = St(
    s,
  ...
  }, It = q(null), Ft = q(null), me = q(!1), P = q(null), Jt = q(!1), [fe, Dt] = I(void 0), B = q(!1), X = q(!1), et = q(null), ct = G((L) => {
    if (L) {
  ...
  ), yt = nt.find((L) => L.value === "selectedBooks"), pt = nt.find((L) => L.value === "range"), [Le, He] = I(!1), [Ue, an] = I(void 0), [Ve, _n] = I(void 0), [Be, Cn] = I(void 0), [Ye, En] = I(void 0), [Tn, Kn] = I([]), qn = c === "dropdown" && Ue === "selectedBooks", _ = /* @__PURE__ */ r(
    Jp,
    {
      availableBookInfo: o,
  ...
  ), H = Bt === "end", Z = Bt === "start", zt = "tw:text-muted-foreground", re = l === "dropdown" && ut === "range", or = re ? br : P, At = re ? xr : p ? Y : Vt, Nt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Qt, Xe] = I(null), [Hn, Ni] = I(null), [Un, ki] = I(null), _i = 200, [Ci, Ei] = I(!1);
  J(() => {
  ...
  const Io = j(
    (A) => {
      Ke(A), br(st), xr(ct), Ar(n), R(!1), gt(A);
    },
    [st, ct, n]
  ), Do = j(() => {
...
function Wg({
  ...
  const l = Zu(
    ...
    var N, T, D, k, C, S;
    const x = y !== g ? ((T = (N = t[g]) == null ? void 0 : N.uiNames) == null ? void 0 : T[y]) ?? ((k = (D = t[g]) == null ? void 0 : D.uiNames) == null ? void 0 : k.en) : void 0;
    return x ? `${(C = t[g]) == null ? void 0 : C.autonym} (${x})` : (S = t[g]) == null ? void 0 : S.autonym;
  };
