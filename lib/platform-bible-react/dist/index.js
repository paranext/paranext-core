...
import p, { forwardRef as Ye, useRef as nt, useMemo as H, useCallback as $, useState as I, useLayoutEffect as fn, createContext as Ar, useContext as Pr, useEffect as Mt, Fragment as En } from "react";
...
import { getLocalizedBookName as Ot, getLocalizedBookId as qe, Section as A, ALL_ENGLISH_BOOK_NAMES as Vt, doesBookMatchQuery as Je, getChaptersForBook as ua, ALL_BOOK_IDS as ma, getLocalizedSectionNames as Mn, getSectionLongName as Dn, formatScrRef as Wt, getSectionForBook as Zt, NumberFormat as ha, formatBytes as fa, deepEqual as We, isString as Te, compareScrRefs as Pe, scrRefToBBBCCCVVV as Ee, getSectionShortName as ga, getLocalizeKeyForScrollGroupId as O } from "platform-bible-utils";
...
import { useReactTable as zn, getFilteredRowModel as ba, getSortedRowModel as On, getPaginationRowModel as va, getCoreRowModel as An, flexRender as Qt, getGroupedRowModel as xa, getExpandedRowModel as ya } from "@tanstack/react-table";
...
const Ta = ft.Portal, jn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
const Ea = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
...
const ve = p.forwardRef((t, e) => /* @__PURE__ */ r(wt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
const it = class V {
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Tt(i)), n ? new V(n, a.toString(), w, u) : new V();
  }
  /**
...
const Un = Ye(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Xt : "button", { className: d(La({ variant: e, size: n, className: t })), ref: s, ...o })
);
D.displayName = "Button";
const le = ee.Root, de = ee.Trigger, Ht = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = et();
...
function Xe(t, e, n) {
  return `${t} ${Vt[t]}${e ? ` ${qe(t, e)} ${Ot(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
const Ve = {
...
function Nn({
  ...
  if (t)
    return /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r("div", { className: d("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ht(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Gt,
      {
        value: `${t} ${Vt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function di({
  ...
  const i = et(), [w, u] = I(!1), [c, m] = I(""), [g, h] = I(""), [f, b] = I("books"), [v, x] = I(void 0), [C, y] = I(!1), M = nt(void 0), B = nt(void 0), W = nt(void 0), Y = nt(void 0), gt = nt({}), k = H(() => a ? a() : ma, [a]), T = H(() => ({
    [A.OT]: k.filter((z) => L.isBookOT(z)),
    [A.NT]: k.filter((z) => L.isBookNT(z)),
    [A.DC]: k.filter((z) => L.isBookDC(z)),
    [A.Extra]: k.filter((z) => L.extraBooks().includes(z))
    ...
    (N) => {
      const z = f === "chapters" ? v : _ == null ? void 0 : _.book;
      z && (e({
        book: z,
        chapterNum: N,
        verseNum: 1
    ...
    [f, j]
  ), { otLong: Z, ntLong: ot, dcLong: q, extraLong: bt } = Mn(s), Vr = $(
    (N) => Dn(N, Z, ot, q, bt),
    [Z, ot, q, bt]
  ), Mr = $(
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: z, isDigit: J } = yn(N.key);
      if (f === "chapters") {
        if (N.key === "Backspace") {
    ...
    const { isLetter: z, isDigit: J } = yn(N.key);
    (z || J) && (N.preventDefault(), h((at) => at + N.key), B.current.focus(), y(!1));
  }, []);
  return fn(() => {
    const N = setTimeout(() => {
      if (w && f === "books" && W.current && Y.current) {
        const z = W.current, J = Y.current, at = J.offsetTop, st = z.clientHeight, St = J.clientHeight, vt = at - st / 2 + St / 2;
        z.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), m(Xe(t.book));
    ...
    if (f === "chapters" && v) {
      ...
      setTimeout(() => {
        if (W.current)
          if (N) {
            const z = gt.current[t.chapterNum];
      ...
      se,
      {
        ...
        children: [
          f === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: U.map(({ onClick: N, disabled: z, title: J, icon: at }) => /* @__PURE__ */ r(
              D,
              {
                variant: "ghost",
                size: "sm",
            ...
            v && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ot(v, o) })
          ] }),
          !C && /* @__PURE__ */ l(we, { ref: W, children: [
            f === "books" && /* @__PURE__ */ l(te, { children: [
              !_ && Object.entries(P).map(([N, z]) => {
                if (z.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Pt, { heading: Vr(N), children: z.map((J) => /* @__PURE__ */ r(
                      Un,
                      {
                        bookId: J,
                        onSelect: (at) => R(at),
              ...
              _ && ht(_.book) > 1 && /* @__PURE__ */ l(te, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ot(_.book, o) }),
                /* @__PURE__ */ r(
                  Nn,
                  {
                    bookId: _.book,
...
), tt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(In.Root, { ref: n, className: d("pr-twp", Ka(), t), ...e }));
tt.displayName = In.Root.displayName;
const en = p.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    ne.Root,
    {
    ...
    en,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(tt, { className: "tw-flex tw-items-center", children: a.map((x) => L.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            D,
            {
...
const Jn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    X.SubTrigger,
    {
...
const Zn = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = et(), s = ut();
  return /* @__PURE__ */ r(
    X.Item,
    {
...
const an = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    X.CheckboxItem,
    {
...
const on = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
...
const er = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  K.ScrollDownButton,
  {
    ref: n,
    className: d("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
...
const kt = p.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a = !1, ...o }, s) => {
...
function ho({
  ...
  var x;
  const [w, u] = I([]), [c, m] = I([]), [g, h] = I({}), [f, b] = I({}), v = zn({
    data: e,
    columns: t,
    getCoreRowModel: An(),
...
function fo({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(D, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Yr, {}) })
    ] }),
...
function fi({
  ...
  return /* @__PURE__ */ l(le, { children: [
    ...
    /* @__PURE__ */ r(Ht, { className: d("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      fo,
      {
        errorDetails: t,
        handleCopyNotify: e,
  ...
  return /* @__PURE__ */ l(Ne, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Ce, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      kt,
      {
        ...
        children: [
          /* @__PURE__ */ r($t, { children: `${L.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
), No = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Pn.Root,
  {
    ref: o,
...
const rr = p.createContext({
  size: "default",
  variant: "default"
}), ar = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = et();
  return /* @__PURE__ */ r(
    be.Root,
    {
...
const pe = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = p.useContext(rr);
  return /* @__PURE__ */ r(
    be.Item,
    {
      ref: s,
...
const _e = (t) => t === "asc" ? /* @__PURE__ */ r(ea, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(na, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ra, { className: "tw-ms-2 tw-h-4 tw-w-4" }), yi = (t) => ({
  accessorKey: "item",
...
function Ti({
  ...
  const c = xt(n, "%webView_inventory_all%"), m = xt(n, "%webView_inventory_approved%"), g = xt(n, "%webView_inventory_unapproved%"), h = xt(n, "%webView_inventory_unknown%"), f = xt(n, "%webView_inventory_scope_currentBook%"), b = xt(n, "%webView_inventory_scope_chapter%"), v = xt(n, "%webView_inventory_scope_verse%"), x = xt(n, "%webView_inventory_filter_text%"), C = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, M] = I(!1), [B, W] = I("all"), [Y, gt] = I(""), [k, T] = I([]), rt = H(() => t.length === 0 ? [] : So(t, o, s), [t, o, s]), P = H(() => {
    if (y) return rt;
    const S = [];
    return rt.forEach((Z) => {
    ...
    return [...Z, ...u];
  }, [a == null ? void 0 : a.tableHeaders, u, y]);
  Mt(() => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Bt, { onValueChange: (S) => Q(S), defaultValue: i, children: [
...
const wn = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Bn.Root,
  {
    ref: o,
    decorative: n,
...
const ln = oe.Provider, dn = oe.Root, cn = oe.Trigger, Se = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  oe.Content,
  {
    ref: a,
    sideOffset: e,
...
const Ro = "16rem", To = "3rem", or = p.createContext(void 0);
function Re() {
  const t = p.useContext(or);
  if (!t)
...
const sr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), g = e ?? c, h = p.useCallback(
      ...
      [n, g]
    ), f = p.useCallback(() => h((M) => !M), [h]), b = g ? "expanded" : "collapsed", C = et() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = p.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
...
const ir = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Re();
...
const Ao = _t(
  ...
  ({
    ...
    const u = t ? Xt : "button", { state: c } = Re(), m = /* @__PURE__ */ r(
      u,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(Ao({ variant: n, size: a }), s),
        ...i
      }
    );
...
const Po = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Xt : "button",
  {
    ref: o,
...
Po.displayName = "SidebarMenuAction";
...
Bo.displayName = "SidebarMenuBadge";
const jo = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
const Nt = "scrBook", Lo = "scrRef", Et = "source", Ho = "details", Yo = "Scripture Reference", Uo = "Scripture Book", ur = "Type", Ko = "Details";
function qo(t, e) {
  const n = e ?? !1;
  return [
    {
...
function Vi({
  ...
  const [u, c] = I([]), [m, g] = I([{ id: Nt, desc: !1 }]), [h, f] = I({}), b = H(
    ...
    !e && /* @__PURE__ */ l(
      Bt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(zt, { position: "item-aligned", children: /* @__PURE__ */ r(ro, { children: M.map((k) => /* @__PURE__ */ r(ct, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
...
function Wo({
  ...
  const s = un(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    D,
    {
      variant: "outline",
...
function Zo({
  ...
  const Y = H(() => L.allBookIds.filter(
    (R, Q) => t[Q] === "1" && !L.isObsolete(L.bookIdToNumber(R))
  ), [t]), gt = H(() => {
    if (!y.trim()) {
      const U = {
        [A.OT]: [],
    ...
    (R) => {
      const Q = un(Y, R).map((U) => U);
      n(
        mr(Y, R, e) ? e.filter((U) => !Q.includes(U)) : [.../* @__PURE__ */ new Set([...e, ...Q])]
      );
    },
    [e, n, Y]
  ), _ = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
                  ...
                  Object.values(A).map((R, Q) => {
                    ...
                    if (U.length !== 0)
                      return /* @__PURE__ */ l(En, { children: [
                        ...
                        Q < Object.values(A).length - 1 && /* @__PURE__ */ r($n, {})
                      ] }, R);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Ie ? Ie : Rn
      ).map((R) => /* @__PURE__ */ r(me, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ot(R, o) }, R)),
      ...
      /* @__PURE__ */ r(
        en,
        {
          ...
          children: x.map(({ value: C, label: y, id: M }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(tt, { htmlFor: M, children: y })
          ] }, M))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          zt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(ct, { value: `${u}`, children: i[O(u)] }, `${u}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ l(dn, { children: [
...
function Tn({
  ...
  return /* @__PURE__ */ l(rn, { variant: s, children: [
    /* @__PURE__ */ r(Kn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(D, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(ia, {}) }) }),
    /* @__PURE__ */ r(xe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w], u, c) => /* @__PURE__ */ l(En, { children: [
...
const br = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  lt.List,
  {
    ref: n,
    className: d(
...
)), vr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  lt.Content,
  {
    ref: n,
    className: d(
...
function Bi({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(gr, { children: [
      /* @__PURE__ */ r(br, { children: t.map((i) => /* @__PURE__ */ r(Qo, { value: i.value, children: i.value }, i.key)) }),
...
const xr = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
...
const yr = p.forwardRef(({ className: t, ...e }, n) => {
  const a = ut();
  return /* @__PURE__ */ r(
    F.Trigger,
    {
...
const Nr = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
const Cr = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ut();
...
const _r = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
const ns = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
...
ns.displayName = F.CheckboxItem.displayName;
const rs = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ut();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
...
const as = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
const Sr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  F.Separator,
  {
    ref: n,
    className: d("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
const qt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    ...
    return w.length > 0 && i < o.length - 1 && u.push(/* @__PURE__ */ r(Sr, {}, `separator-${s}`)), u;
  });
};
function os({
  menuData: t,
  ...
  if (Ca(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (C = u.current) == null || C.focus(), qt(u, [h, f]);
        break;
    }
  }), Mt(() => {
    ...
    return /* @__PURE__ */ r(xr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ l(ts, { children: [
...
const ws = Ye(({ className: t, ...e }, n) => /* @__PURE__ */ r(da, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), ds = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(ls({ variant: e }), t), ...n }));
...
const ps = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
ps.displayName = "AlertDescription";
const us = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Ft.Root,
  {
    ref: n,
    className: d(
...
ms.displayName = Ft.Image.displayName;
...
hs.displayName = Ft.Fallback.displayName;
const fs = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
const vs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
vs.displayName = "CardDescription";
const xs = p.forwardRef(
...
const Li = G.Root, Hi = G.Trigger, Yi = G.Group, Ui = G.Portal, Ki = G.Sub, qi = G.RadioGroup, Ns = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  G.SubTrigger,
  {
    ref: o,
    className: d(
...
Ns.displayName = G.SubTrigger.displayName;
...
ks.displayName = G.SubContent.displayName;
const Cs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(G.Portal, { children: /* @__PURE__ */ r(
  G.Content,
  {
    ref: n,
    className: d(
...
Cs.displayName = G.Content.displayName;
const _s = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  G.Item,
  {
    ref: a,
    className: d(
...
_s.displayName = G.Item.displayName;
const Ss = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ l(
  G.CheckboxItem,
  {
    ref: o,
    className: d(
...
Ss.displayName = G.CheckboxItem.displayName;
const Rs = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  G.RadioItem,
  {
    ref: a,
    className: d(
...
Rs.displayName = G.RadioItem.displayName;
const Ts = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: a,
    className: d(
...
Es.displayName = G.Separator.displayName;
...
const Ji = pt.Trigger, Ds = pt.Portal, Wi = pt.Close, Er = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
const Is = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = p.useContext(Tr), i = {
...
As.displayName = pt.Title.displayName;
...
Ps.displayName = pt.Description.displayName;
const Bs = p.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  je.Root,
  {
    ref: a,
    className: d(
...
Bs.displayName = je.Root.displayName;
function Zi({ ...t }) {
  return /* @__PURE__ */ r(
    _a,
    {
...
const js = p.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ l(
    Jt.Root,
    {
...
const Qi = lt.Root, Xs = p.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    lt.List,
    {
...
Fs.displayName = lt.Trigger.displayName;
...
Gs.displayName = lt.Content.displayName;
...
const Ys = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = I(void 0), [w, u] = I(void 0), c = $(
    (h) => {
      i(h);
