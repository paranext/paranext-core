import Es, { jsxs as ne, jsx as b, Fragment as Yn } from "react/jsx-runtime";
import * as E from "react";
import oe, { forwardRef as _a, useCallback as Pe, useState as Ee, useRef as yt, useEffect as zt, useLayoutEffect as Ro, useMemo as vn } from "react";
...
var nl = Object.defineProperty, rl = (e, t, n) => t in e ? nl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, re = (e, t, n) => rl(e, typeof t != "symbol" ? t + "" : t, n);
const xt = [
  "GEN",
  "EXO",
  "LEV",
...
re(De, "Original", new De(qe.Original)), re(De, "Septuagint", new De(qe.Septuagint)), re(De, "Vulgate", new De(qe.Vulgate)), re(De, "English", new De(qe.English)), re(De, "RussianProtestant", new De(qe.RussianProtestant)), re(De, "RussianOrthodox", new De(qe.RussianOrthodox));
let ht = De;
function Do(e, t) {
  const n = t[0];
...
re(Se, "defaultVersification", ht.English), re(Se, "verseRangeSeparator", "-"), re(Se, "verseSequenceIndicator", ","), re(Se, "verseRangeSeparators", [Se.verseRangeSeparator]), re(Se, "verseSequenceIndicators", [Se.verseSequenceIndicator]), re(Se, "chapterDigitShifter", 1e3), re(Se, "bookDigitShifter", Se.chapterDigitShifter * Se.chapterDigitShifter), re(Se, "bcvMaxValue", Se.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
re(Se, "ValidStatusType", Wa);
...
const hl = me.Root, gl = me.Trigger, Th = me.Group, Nh = me.Portal, Oh = me.Sub, Ch = me.RadioGroup, bl = oe.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ ne(
  me.SubTrigger,
  {
    ref: o,
    className: Y(
...
const vl = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  me.SubContent,
  {
    ref: n,
    className: Y(
...
const qa = oe.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ b(me.Portal, { children: /* @__PURE__ */ b(
  me.Content,
  {
    ref: r,
    sideOffset: t,
...
const Xa = oe.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ b(
  me.Item,
  {
    ref: r,
    className: Y(
...
const yl = oe.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ ne(
  me.CheckboxItem,
  {
    ref: o,
    className: Y(
...
const wl = oe.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ne(
  me.RadioItem,
  {
    ref: r,
    className: Y(
...
const Wr = oe.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ b(
  me.Label,
  {
    ref: r,
...
const Ya = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  me.Separator,
  {
    ref: n,
...
const El = _a(
  ({ handleSearch: e, handleKeyDown: t, handleOnClick: n, handleSubmit: r, ...o }, a) => /* @__PURE__ */ ne("div", { className: "pr-relative", children: [
    /* @__PURE__ */ b(
      qr,
      {
        ...o,
...
function Nl({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ ne(Wr, { className: "pr-flex pr-justify-between", children: [
...
function Sh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ee(""), [o, a] = Ee(
    ...
    ue.bookNumberToId(e.bookNum)
  ), [d, f] = Ee(!1), [u, v] = Ee(d), y = yt(void 0), g = yt(void 0), m = yt(void 0), k = Pe(
    (C) => Pl(C).filter((R) => {
  ...
  }, [u]), /* @__PURE__ */ b("div", { className: "pr-flex", children: /* @__PURE__ */ ne(hl, { modal: !1, open: d, onOpenChange: x, children: [
    ...
    /* @__PURE__ */ ne(
      qa,
      {
        ...
        children: [
          ...
          jo.map(
            (C, R) => k(C).length > 0 && /* @__PURE__ */ ne("div", { children: [
              /* @__PURE__ */ b(Wr, { className: "pr-font-semibold pr-text-slate-700", children: Ol[C] }),
              k(C).map(($) => /* @__PURE__ */ b("div", { children: /* @__PURE__ */ b(
                Tl,
                {
                  bookId: $,
...
const Il = un.Root, Al = un.Trigger, Ga = E.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ b(un.Portal, { children: /* @__PURE__ */ b(
  un.Content,
  {
    ref: o,
    align: t,
...
const Dl = Ye.Portal, Ka = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Ye.Overlay,
  {
    ref: n,
    className: Y(
...
const jl = E.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ne(Dl, { children: [
  /* @__PURE__ */ b(Ka, {}),
  /* @__PURE__ */ ne(
    Ye.Content,
    {
      ...
      children: [
        t,
        /* @__PURE__ */ ne(Ye.Close, { className: "pr-absolute pr-right-4 pr-top-4 pr-rounded-sm pr-opacity-70 pr-ring-offset-background pr-transition-opacity hover:pr-opacity-100 focus:pr-outline-none focus:pr-ring-2 focus:pr-ring-ring focus:pr-ring-offset-2 disabled:pr-pointer-events-none data-[state=open]:pr-bg-accent data-[state=open]:pr-text-muted-foreground", children: [
...
const Bl = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Ye.Title,
  {
    ref: n,
...
const Ll = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Ye.Description,
  {
    ref: n,
...
const Ja = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Me,
  {
    ref: n,
    className: Y(
...
const Za = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ ne("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", "cmdk-input-wrapper": "", children: [
...
const Qa = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Me.List,
  {
    ref: n,
...
const ei = E.forwardRef((e, t) => /* @__PURE__ */ b(Me.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
ei.displayName = Me.Empty.displayName;
const Fl = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Me.Group,
  {
    ref: n,
    className: Y(
...
const Vl = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Me.Separator,
  {
    ref: n,
...
const ti = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Me.Item,
  {
    ref: n,
    className: Y(
...
function Sr({
  ...
  const [d, f] = Ee(!1);
  return /* @__PURE__ */ ne(Il, { open: d, onOpenChange: f, children: [
    /* @__PURE__ */ b(Al, { asChild: !0, children: /* @__PURE__ */ ne(
      lt,
      {
        variant: p,
        role: "combobox",
    ...
    /* @__PURE__ */ b(Ga, { className: "pr-w-[200px] pr-p-0", children: /* @__PURE__ */ ne(Ja, { children: [
      /* @__PURE__ */ b(Za, { placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ b(ei, { children: c }),
      /* @__PURE__ */ b(Qa, { children: t.map((u) => /* @__PURE__ */ ne(
        ti,
        {
          value: a(u),
          onSelect: () => {
...
function Rh({
  ...
  return /* @__PURE__ */ ne("fieldset", { id: e, className: t, children: [
...
function Wl() {
  if (Bo)
    return le;
  Bo = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, a = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, p = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, f = e ? Symbol.for("react.suspense") : 60113, u = e ? Symbol.for("react.suspense_list") : 60120, v = e ? Symbol.for("react.memo") : 60115, y = e ? Symbol.for("react.lazy") : 60116, g = e ? Symbol.for("react.block") : 60121, m = e ? Symbol.for("react.fundamental") : 60117, k = e ? Symbol.for("react.responder") : 60118, _ = e ? Symbol.for("react.scope") : 60119;
  function w(h) {
  ...
  return le.AsyncMode = c, le.ConcurrentMode = p, le.ContextConsumer = l, le.ContextProvider = s, le.Element = t, le.ForwardRef = d, le.Fragment = r, le.Lazy = y, le.Memo = v, le.Portal = n, le.Profiler = a, le.StrictMode = o, le.Suspense = f, le.isAsyncMode = function(h) {
    ...
    return typeof h == "string" || typeof h == "function" || h === r || h === p || h === a || h === o || h === f || h === u || typeof h == "object" && h !== null && (h.$$typeof === y || h.$$typeof === v || h.$$typeof === s || h.$$typeof === l || h.$$typeof === d || h.$$typeof === m || h.$$typeof === k || h.$$typeof === _ || h.$$typeof === g);
  }, le.typeOf = w, le;
}
var ce = {};
/** @license React v16.13.1
...
function ql() {
  return Lo || (Lo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(I) {
      ...
      I === r || I === p || I === a || I === o || I === f || I === u || typeof I == "object" && I !== null && (I.$$typeof === y || I.$$typeof === v || I.$$typeof === s || I.$$typeof === l || I.$$typeof === d || I.$$typeof === m || I.$$typeof === k || I.$$typeof === _ || I.$$typeof === g);
    }
    function x(I) {
    ...
    var h = c, O = p, S = l, L = s, B = t, F = d, C = r, R = y, $ = v, j = n, D = a, M = o, V = f, ee = !1;
    function Q(I) {
      return ee || (ee = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), N(I) || x(I) === c;
    }
    function N(I) {
      return x(I) === p;
    }
    ...
    ce.AsyncMode = h, ce.ConcurrentMode = O, ce.ContextConsumer = S, ce.ContextProvider = L, ce.Element = B, ce.ForwardRef = F, ce.Fragment = C, ce.Lazy = R, ce.Memo = $, ce.Portal = j, ce.Profiler = D, ce.StrictMode = M, ce.Suspense = V, ce.isAsyncMode = Q, ce.isConcurrentMode = N, ce.isContextConsumer = A, ce.isContextProvider = U, ce.isElement = G, ce.isForwardRef = z, ce.isFragment = H, ce.isLazy = q, ce.isMemo = X, ce.isPortal = W, ce.isProfiler = K, ce.isStrictMode = J, ce.isSuspense = ae, ce.isValidElementType = w, ce.typeOf = x;
  }()), ce;
}
var Fo;
function ri() {
      ...
      function G(H, q, X, W, K, J, ae) {
        if (W = W || u, J = J || X, ae !== n) {
          if (c) {
            ...
            var Z = W + ":" + X;
            !A[Z] && // Avoid spamming the console because they are often not actionable except for lib authors
            U < 3 && (a(
    ...
    function B(N) {
      ...
      for (var A = 0; A < N.length; A++) {
        ...
        if (typeof U != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ee(U) + " at index " + A + "."
          ), s;
      }
      function G(z, H, q, X, W) {
        ...
        return new g("Invalid " + X + " `" + W + "` supplied to " + ("`" + q + "`" + Z + "."));
      }
      return m(G);
    }
    function F() {
...
function ic() {
  return Yo || (Yo = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), p = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), u = Symbol.for("react.lazy"), v = Symbol.for("react.offscreen"), y = !1, g = !1, m = !1, k = !1, _ = !1, w;
    w = Symbol.for("react.module.reference");
    function x(P) {
      return !!(typeof P == "string" || typeof P == "function" || P === n || P === o || _ || P === r || P === p || P === d || k || P === v || y || g || m || typeof P == "object" && P !== null && (P.$$typeof === u || P.$$typeof === f || P.$$typeof === a || P.$$typeof === s || P.$$typeof === c || // This needs to include all possible module reference object
    ...
    var O = s, S = a, L = e, B = c, F = n, C = u, R = f, $ = t, j = o, D = r, M = p, V = d, ee = !1, Q = !1;
    function N(P) {
...
function ui({
  ...
  const {
    current: o
  } = E.useRef(e !== void 0), [a, s] = E.useState(t), l = o ? e : a;
  if (process.env.NODE_ENV !== "production") {
    E.useEffect(() => {
...
}, Ic = /* @__PURE__ */ E.createContext(_c);
function Ac(e) {
  const {
...
function Vn(e) {
  const {
    ...
    isEnabled: s = Xc,
    open: l
  } = e, c = E.useRef(!1), p = E.useRef(null), d = E.useRef(null), f = E.useRef(null), u = E.useRef(null), v = E.useRef(!1), y = E.useRef(null), g = ze(t.ref, y), m = E.useRef(null);
  E.useEffect(() => {
...
const mn = /* @__PURE__ */ E.forwardRef(function(t, n) {
  const {
    children: r,
    container: o,
    disablePortal: a = !1
...
function rp(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, u = E.useRef({}), v = E.useRef(null), y = E.useRef(null), g = ze(y, f), [m, k] = E.useState(!d), _ = tp(c);
  let w = !0;
  ...
  }), L = E.useCallback(() => o.isTopModal(h()), [o]), B = fn((M) => {
  ...
  const C = (M) => (V) => {
    var ee;
    (ee = M.onKeyDown) == null || ee.call(M, V), !(V.key !== "Escape" || V.which === 229 || // Wait until IME is settled.
    !L()) && (n || (V.stopPropagation(), p && p(V, "escapeKeyDown")));
  }, R = (M) => (V) => {
    var ee;
    (ee = M.onClick) == null || ee.call(M, V), V.target === V.currentTarget && p && p(V, "backdropClick");
  };
  return {
    getRootProps: (M = {}) => {
      const V = Ei(e);
...
function kp(e) {
  ...
  if (!(!a || !s)) {
    var f = Ep(o.padding, n), u = Jr(a), v = c === "y" ? Re : $e, y = c === "y" ? Ue : He, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], k = En(a), _ = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, w = g / 2 - m / 2, x = f[v], h = _ - u[d] - f[y], O = _ / 2 - u[d] / 2 + w, S = cn(x, O, h), L = c;
...
function aa(e) {
  ...
  v = m.x, g = m.y;
  var k = s.hasOwnProperty("x"), _ = s.hasOwnProperty("y"), w = $e, x = Re, h = window;
  if (p) {
  ...
  if (v = R.x, g = R.y, c) {
    var $;
    return Object.assign({}, C, ($ = {}, $[x] = _ ? "0" : "", $[w] = k ? "0" : "", $.transform = (h.devicePixelRatio || 1) <= 1 ? "translate(" + v + "px, " + g + "px)" : "translate3d(" + v + "px, " + g + "px, 0)", $));
  }
  return Object.assign({}, C, (t = {}, t[x] = _ ? g + "px" : "", t[w] = k ? v + "px" : "", t.transform = "", t));
}
function Sp(e) {
...
function Vp(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, p = n.padding, d = n.boundary, f = n.rootBoundary, u = n.altBoundary, v = n.flipVariations, y = v === void 0 ? !0 : v, g = n.allowedAutoPlacements, m = t.options.placement, k = Xe(m), _ = k === m, w = c || (_ || !y ? [An(m)] : Fp(m)), x = [m].concat(w).reduce(function(z, H) {
      ...
      h[D] > O[D] && (V = An(V));
      var ee = An(V), Q = [];
      if (a && Q.push(M[R] <= 0), l && Q.push(M[V] <= 0, M[ee] <= 0), Q.every(function(z) {
        return z;
      })) {
        B = C, L = !1;
        break;
...
function Jp(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, p = n.rootBoundary, d = n.altBoundary, f = n.padding, u = n.tether, v = u === void 0 ? !0 : u, y = n.tetherOffset, g = y === void 0 ? 0 : y, m = gn(t, {
    ...
    padding: f,
    altBoundary: d
  }), k = Xe(t.placement), _ = Vt(t.placement), w = !_, x = Zr(k), h = Kp(x), O = t.modifiersData.popperOffsets, S = t.rects.reference, L = t.rects.popper, B = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, F = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (O) {
    if (a) {
      var $, j = x === "y" ? Re : $e, D = x === "y" ? Ue : He, M = x === "y" ? "height" : "width", V = O[x], ee = V + m[j], Q = V - m[D], N = v ? -L[M] / 2 : 0, A = _ === Bt ? S[M] : L[M], U = _ === Bt ? -L[M] : -S[M], G = t.elements.arrow, z = v && G ? Jr(G) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Pi(), q = H[j], X = H[D], W = cn(0, S[M], z[M]), K = w ? S[M] / 2 - N - W - q - F.mainAxis : A - W - q - F.mainAxis, J = w ? -S[M] / 2 + N + W + X + F.mainAxis : U + W + X + F.mainAxis, ae = t.elements.arrow && En(t.elements.arrow), I = ae ? x === "y" ? ae.clientTop || 0 : ae.clientLeft || 0 : 0, Z = ($ = C == null ? void 0 : C[x]) != null ? $ : 0, P = V + K - Z - I, ie = V + J - Z, we = cn(v ? zn(ee, P) : ee, V, v ? wt(Q, ie) : Q);
      O[x] = we, R[x] = we - V;
    }
    if (l) {
      var Oe, ve = x === "x" ? Re : $e, ft = x === "x" ? Ue : He, Ce = O[h], Ze = h === "y" ? "height" : "width", Ie = Ce + m[ve], Qe = Ce - m[ft], xe = [Re, $e].indexOf(k) !== -1, Ot = (Oe = C == null ? void 0 : C[h]) != null ? Oe : 0, mt = xe ? Ie : Ce - S[Ze] - L[Ze] - Ot + F.altAxis, Wt = xe ? Ce + S[Ze] + L[Ze] - Ot - F.altAxis : Qe, On = v && xe ? xp(mt, Ce, Wt) : cn(v ? mt : Ie, Ce, v ? Wt : Qe);
      O[h] = On, R[h] = On - Ce;
    }
    t.modifiersData[r] = R;
  }
  ...
  return function(l, c, p) {
    ...
    var d = {
      ...
      setOptions: function(k) {
        var _ = typeof k == "function" ? k(d.options) : k;
      ...
      forceUpdate: function() {
        if (!u) {
          var k = d.elements, _ = k.reference, w = k.popper;
          if (da(_, w)) {
            d.rects = {
    ...
    function y() {
      d.orderedModifiers.forEach(function(m) {
        var k = m.name, _ = m.options, w = _ === void 0 ? {} : _, x = m.effect;
...
const hd = () => at({
  root: ["root"]
}, Ac(pd)), gd = {}, bd = /* @__PURE__ */ E.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, m = fe(t, dd), k = E.useRef(null), _ = ze(k, n), w = E.useRef(null), x = ze(w, u), h = E.useRef(x);
  Et(() => {
    h.current = x;
  }, [x]), E.useImperativeHandle(u, () => w.current, []);
  const O = fd(d, s), [S, L] = E.useState(O), [B, F] = E.useState(Un(o));
  E.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: m = {},
    slots: k = {}
  } = t, _ = fe(t, ud), [w, x] = E.useState(!0), h = () => {
    x(!1);
  }, O = () => {
    x(!0);
  };
...
function Nu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    let k = Dn;
    p === "Root" || p === "root" ? k = r : p ? k = o : Eu(s) && (k = void 0);
    const _ = Ks(s, T({
      shouldForwardProp: k,
      label: m
...
function Zu(e, t) {
  ...
  const v = o / 14, y = f || ((k) => `${k / p * v}rem`), g = (k, _, w, x, h) => T({
    fontFamily: r,
    fontWeight: k,
    fontSize: y(_),
...
function Nn() {
  const e = Fi(lo);
  return process.env.NODE_ENV !== "production" && E.useDebugValue(e), e[co] || e;
}
function it({
  props: e,
  name: t
...
const zi = oe.createContext(null);
var vf = function(t) {
  return t.scrollTop;
...
const wf = {
...
}, xr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), po = /* @__PURE__ */ E.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = t, k = fe(t, yf), _ = rn(), w = E.useRef(), x = Nn(), h = E.useRef(null), O = ze(h, a.ref, n), S = (D) => (M) => {
    if (D) {
      const V = h.current;
      M === void 0 ? D(V) : D(V, M);
    }
    ...
    let Q;
    g === "auto" ? (Q = x.transitions.getAutoHeightDuration(D.clientHeight), w.current = Q) : Q = M, D.style.transition = [x.transitions.create("opacity", {
      duration: Q,
      delay: V
    }), x.transitions.create("transform", {
      duration: xr ? Q : Q * 0.666,
      delay: xr ? V : V || Q * 0.333,
      easing: ee
  ...
  return /* @__PURE__ */ b(m, T({
    ...
    children: (D, M) => /* @__PURE__ */ E.cloneElement(a, T({
      style: T({
        opacity: 0,
        transform: Br(0.75),
...
const Xi = /* @__PURE__ */ E.forwardRef(function(t, n) {
  var r, o, a, s, l, c, p, d, f, u, v, y, g, m, k, _, w, x, h;
  const O = it({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: Z
  } = O, P = fe(O, Of), ie = /* @__PURE__ */ E.isValidElement(L) ? L : /* @__PURE__ */ b("span", {
    children: L
  }), we = Nn(), Oe = we.direction === "rtl", [ve, ft] = E.useState(), [Ce, Ze] = E.useState(null), Ie = E.useRef(!1), Qe = j || Q, xe = rn(), Ot = rn(), mt = rn(), Wt = rn(), [On, go] = ui({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    E.useEffect(() => {
      ve && ve.disabled && !te && ae !== "" && ve.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [ae, ve, te]);
  }
  const sr = di(N), qt = E.useRef(), Cn = fn(() => {
    qt.current !== void 0 && (document.body.style.WebkitUserSelect = qt.current, qt.current = void 0), Wt.clear();
  });
  E.useEffect(() => Cn, [Cn]);
  const bo = (te) => {
    Ta.clear(), _n = !0, go(!0), z && !et && z(te);
  }, Sn = fn(
    /**
    ...
    (te) => {
      Ta.start(800 + A, () => {
        _n = !1;
      }), go(!1), G && et && G(te), xe.start(we.transitions.duration.shortest, () => {
        Ie.current = !1;
      });
    }
  ), lr = (te) => {
    Ie.current && te.type !== "touchstart" || (ve && ve.removeAttribute("title"), Ot.clear(), mt.clear(), M || _n && V ? Ot.start(_n ? V : M, () => {
      bo(te);
    }) : bo(te));
  }, vo = (te) => {
    Ot.clear(), mt.start(A, () => {
    ...
    onFocus: ds,
    ref: us
  } = fi(), [, wo] = E.useState(!1), xo = (te) => {
    ps(te), yo.current === !1 && (wo(!1), vo(te));
  }, Eo = (te) => {
    ve || ft(te.currentTarget), ds(te), yo.current === !0 && (wo(!0), lr(te));
  }, ko = (te) => {
    Ie.current = !0;
    const Ae = ie.props;
    Ae.onTouchStart && Ae.onTouchStart(te);
  }, To = lr, No = vo, fs = (te) => {
    ko(te), mt.clear(), xe.clear(), Cn(), qt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Wt.start(ee, () => {
      document.body.style.WebkitUserSelect = qt.current, lr(te);
    });
  }, ms = (te) => {
    ie.props.onTouchEnd && ie.props.onTouchEnd(te), Cn(), mt.start(U, () => {
      Sn(te);
    });
  };
  E.useEffect(() => {
...
`));
  ...
  }), Gt), ys = on(Co, T({}, Z, (g = K.transition) != null ? g : F.transition), Gt), ws = on(So, T({}, (m = K.tooltip) != null ? m : F.tooltip, {
    className: ke(dr.tooltip, (k = (_ = K.tooltip) != null ? _ : F.tooltip) == null ? void 0 : k.className)
  }), Gt), xs = on(Po, T({}, (w = K.arrow) != null ? w : F.arrow, {
    className: ke(dr.arrow, (x = (h = K.arrow) != null ? h : F.arrow) == null ? void 0 : x.className)
  }), Gt);
  return /* @__PURE__ */ ne(E.Fragment, {
    children: [/* @__PURE__ */ E.cloneElement(ie, Le), /* @__PURE__ */ b(Oo, T({
      as: X ?? qi,
      placement: q,
      anchorEl: Q ? {
...
const Af = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Df = (e) => {
  ...
  const r = it({
    ...
    titleAccess: f,
    viewBox: u = "0 0 24 24"
  } = r, v = fe(r, Af), y = /* @__PURE__ */ E.isValidElement(o) && o.type === "svg", g = T({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Gi(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${t}Icon`), n.muiName = Na.muiName, /* @__PURE__ */ E.memo(/* @__PURE__ */ E.forwardRef(n));
}
const Bf = {
  configure: (e) => {
...
function Ji(e) {
  const {
    ...
    Fs,
    {
      ...
      onClick: t,
      id: g,
      children: n ? /* @__PURE__ */ ne(Yn, { children: [
        Ca(a, n, !0),
  ...
  return r ? /* @__PURE__ */ b(Mf, { title: r, placement: "right", children: /* @__PURE__ */ b("div", { children: k }) }) : k;
}
function Zi(e) {
...
function Wf(e) {
  ...
  return /* @__PURE__ */ ne(Yn, { children: [
...
const ns = /* @__PURE__ */ E.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
  ...
  } = t, u = fe(t, nm), v = E.useRef(null), y = E.useRef({
    keys: [],
    repeating: !0,
...
`)), w.props.disabled || (f === "selectedMenu" && w.props.selected || k === -1) && (k = x), k === x && (w.props.disabled || w.props.muiSkipListHighlight || w.type.muiSkipListHighlight) && (k += 1, k >= s.length && (k = -1));
  ...
  const _ = E.Children.map(s, (w, x) => {
    if (x === k) {
      const h = {};
      return a && (h.autoFocus = !0), w.props.tabIndex === void 0 && f === "selectedMenu" && (h.tabIndex = 0), /* @__PURE__ */ E.cloneElement(w, h);
    }
    return w;
  });
...
const rm = ns, om = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], am = {
  ...
  } = t, w = fe(t, om), x = E.useRef(null), h = ze(x, l.ref, n), O = (j) => (D) => {
    if (j) {
      const M = x.current;
      D === void 0 ? j(M) : j(M, D);
    }
...
const fm = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], mm = (e) => {
  ...
  if (y.props.tabIndex === void 0 && (q.tabIndex = "-1"), G) {
    ...
    q.onEnter = Z, q.onExited = P;
  }
  const X = (r = (o = j == null ? void 0 : j.root) != null ? o : k.Root) != null ? r : hm, W = (a = (s = j == null ? void 0 : j.backdrop) != null ? s : k.Backdrop) != null ? a : d, K = (l = $ == null ? void 0 : $.root) != null ? l : _.root, J = (c = $ == null ? void 0 : $.backdrop) != null ? c : _.backdrop, ae = kt({
    elementType: X,
    externalSlotProps: K,
  ...
  return !F && !R && (!G || U) ? null : /* @__PURE__ */ b(mn, {
    ...
    children: /* @__PURE__ */ ne(X, T({}, ae, {
      children: [!B && d ? /* @__PURE__ */ b(W, T({}, I)) : null, /* @__PURE__ */ b(Vn, {
        ...
        isEnabled: A,
        open: R,
        children: /* @__PURE__ */ E.cloneElement(y, q)
      })]
    }))
  });
});
...
const Cm = (e) => {
  ...
  const s = it({
  ...
  } = s, F = fe(s.TransitionProps, Tm), C = fe(s, Nm), R = (r = x == null ? void 0 : x.paper) != null ? r : _, $ = E.useRef(), j = ze($, R.ref), D = T({}, s, {
    anchorOrigin: p,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
    ...
    TransitionProps: F
  }), M = Cm(D), V = E.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const Z = Bn(c), P = Z && Z.nodeType === 1 ? Z : Te($.current).body, ie = P.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
  ...
  }, [c, p.horizontal, p.vertical, d, f]), ee = E.useCallback((Z) => ({
    vertical: Pa(Z, h.vertical),
    horizontal: Ra(Z, h.horizontal)
  }), [h.horizontal, h.vertical]), Q = E.useCallback((Z) => {
    const P = {
      width: Z.offsetWidth,
...
`)), m !== null && ve < m) {
  ...
  }, [c, f, V, ee, m]), [N, A] = E.useState(k), U = E.useCallback(() => {
    const Z = $.current;
    if (!Z)
      return;
    const P = Q(Z);
    P.top !== null && (Z.style.top = P.top), P.left !== null && (Z.style.left = P.left), Z.style.transformOrigin = P.transformOrigin, A(!0);
  }, [Q]);
  ...
  E.useEffect(() => {
    ...
    return P.addEventListener("resize", Z), () => {
      Z.clear(), P.removeEventListener("resize", Z);
    };
  }, [c, k, U]);
  let H = S;
...
const $m = ["onEntering"], Mm = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], _m = {
  ...
  const a = it({
    ...
    TransitionProps: x,
    variant: k
  }), B = Am(L), F = s && !p && u, C = E.useRef(null), R = (Q, N) => {
    C.current && C.current.adjustStyleForScrollbar(Q, O), m && m(Q, N);
  }, $ = (Q) => {
    Q.key === "Tab" && (Q.preventDefault(), f && f(Q, "tabKeyDown"));
  };
  let j = -1;
  E.Children.map(l, (Q, N) => {
    /* @__PURE__ */ E.isValidElement(Q) && (process.env.NODE_ENV !== "production" && Ln.isFragment(Q) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), Q.props.disabled || (k === "selectedMenu" && Q.props.selected || j === -1) && (j = N));
  });
...
function $h({
  ...
  var p;
  const [o, a] = oe.useState(void 0), s = Pe(
    (d) => {
      d.preventDefault(), a(
        o === void 0 ? {
          mouseX: d.clientX + 2,
  ...
  return (((p = n == null ? void 0 : n.items) == null ? void 0 : p.length) ?? 0) === 0 || !r ? r : /* @__PURE__ */ ne(
    "div",
    {
...
), ho = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(La.Root, { ref: n, className: Y(Um(), e), ...t }));
...
function Xn({
  ...
  return /* @__PURE__ */ ne("div", { className: Y("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": r }), children: [
    /* @__PURE__ */ b(
      ho,
      {
        htmlFor: e,
...
function _h({ scrRef: e, handleSubmit: t, id: n }) {
  ...
  return /* @__PURE__ */ ne("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    /* @__PURE__ */ ne("div", { className: "pr-inline-grid pr-items-center pr-gap-1.5", children: [
...
function Lh({
  ...
  const a = yt(void 0);
  return /* @__PURE__ */ b("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ b(Ys, { position: "static", id: r, children: /* @__PURE__ */ ne(Gs, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ b(
      zm,
      {
        commandHandler: t,
...
}, zh = _e.Root, Wm = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  _e.List,
  {
    ref: n,
    className: Y(
...
const qm = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  _e.Trigger,
  {
    ref: n,
    className: Y(
...
const Xm = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  _e.Content,
  {
    ref: n,
    className: Y(
...
const Ym = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  _e.Root,
  {
...
const Gm = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  _e.List,
  {
    ref: n,
    className: Y(
...
const Uh = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  _e.Trigger,
  {
    ref: n,
    ...t,
...
)), Km = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  _e.Content,
  {
    ref: n,
    className: Y(
...
const eh = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b("p", { ref: n, className: Y("pr-text-sm pr-text-muted-foreground", e), ...t }));
eh.displayName = "CardDescription";
const th = oe.forwardRef(
  ({ className: e, ...t }, n) => /* @__PURE__ */ b("div", { ref: n, className: Y("pr-p-6 pr-pt-0", e), ...t })
);
th.displayName = "CardContent";
const nh = oe.forwardRef(
...
), oh = oe.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ b("div", { ref: r, role: "alert", className: Y(rh({ variant: t }), e), ...n }));
oh.displayName = "Alert";
const ah = oe.forwardRef(
  ({ className: e, ...t }, n) => /* @__PURE__ */ ne(
    "h5",
    {
      ref: n,
...
const ih = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b("div", { ref: n, className: Y("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
ih.displayName = "AlertDescription";
const sh = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ ne(
  nn.Root,
  {
    ref: n,
    className: Y(
...
const lh = oe.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Cr.Root,
  {
    className: Y(
