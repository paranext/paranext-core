...
import { r as Gt, Z as Fi, B as U, c as g, a as Bi, C as Oe, P as Re, b as Be, d as $e, e as Ue, f as Ke, g as he, h as Cr, i as aa, T as Ft, S as or, j as Bt, k as Ut, l as Kt, D as Ze, m as yr, n as Te, o as ze, p as De, u as Ui, q as Er, s as Qe, t as Le, v as Oa, w as un, x as Ki, y as qi, z as pn, A as hn, E as Gi, F as Hi, G as Yi, H as Wi, I as pa, J as ha, K as wr, L as Xi, M as Ji, N as Zi, O as Qi, Q as ts, R as Tr, U as Ya } from "./resizable-CUvCloPJ.js";
...
import { includes as Mr, Section as tt, getChaptersForBook as es, formatScrRef as Ce, getSectionForBook as vr, formatRelativeDate as rs, formatReplacementString as Ne, sanitizeHtml as Wa, NumberFormat as as, formatBytes as os, getCurrentLocale as ns, usfmMarkers as jr, getFormatCallerFunction as is, deepEqual as ss, isString as yo, compareScrRefs as Ra, scrRefToBBBCCCVVV as ga, defaultScrRef as fa, formatScrRefRange as cs, getLocalizeKeyForScrollGroupId as ko } from "platform-bible-utils";
import { Check as je, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as $a, ChevronRight as Ma, ArrowLeft as ls, ArrowRight as ds, ChevronDown as nr, BoldIcon as ws, ItalicIcon as us, X as oa, AtSign as gn, Pencil as ps, Trash2 as hs, ArrowUp as fn, MoreHorizontal as gs, MailOpen as fs, Mail as ms, ChevronUp as vs, FilterIcon as bs, ArrowLeftIcon as xs, ChevronLeftIcon as ys, ChevronRightIcon as ks, ArrowRightIcon as _s, Copy as mn, Filter as Ns, User as Cs, Link as Es, CircleHelp as Ts, ChevronsUpDown as vn, Star as zs, Undo as Ds, Redo as Ss, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Os, AlertCircle as Aa, CircleCheckIcon as Rs, CircleXIcon as $s, CircleHelpIcon as Ms, ArrowUpIcon as As, ArrowDownIcon as Ps, Search as Is, LoaderCircle as Vs, ScrollText as Ls, MenuIcon as js, Menu as Fs, EllipsisVertical as Bs, MoreVertical as Eo } from "lucide-react";
import ut, { useRef as q, useMemo as L, useState as C, useCallback as j, useEffect as X, useLayoutEffect as Jt, createContext as Xa, useContext as kn, Component as Us, createElement as To, Suspense as Ks, forwardRef as na, useId as zo, Fragment as _n } from "react";
import { Dialog as ge, Label as qs, RadioGroup as Pa, ToggleGroup as Nn, Slot as ur, Avatar as Ja, Select as It, Checkbox as Do, Tabs as le, Menubar as ve, ContextMenu as $t, Progress as So, Slider as Ar, Switch as Oo } from "radix-ui";
import { createEditor as Cn, $getRoot as Fe, $createParagraphNode as zr, $getSelection as qt, HISTORY_MERGE_TAG as Za, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Gs, $isRangeSelection as fe, $caretFromPoint as Hs, $getSiblingCaret as zn, $getChildCaret as Ys, $getAdjacentChildCaret as Ws, $isChildCaret as Xs, $normalizeCaret as Js, $setSelectionFromCaretRange as Zs, $getCollapsedCaretRange as Qs, $getCaretInDirection as Ro, $splitAtPointCaretNext as tc, $isTextPointCaret as ec, $findMatchingParent as Dn, $isElementNode as kr, mergeRegister as Se, getDOMTextNode as rc, isHTMLElement as ac, CLEAR_EDITOR_COMMAND as Sn, COMMAND_PRIORITY_EDITOR as Qa, shallowMergeConfig as oc, defineExtension as te, safeCast as tr, createState as nc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as Rn, COMMAND_PRIORITY_LOW as $n, RootNode as ic, LineBreakNode as sc, TabNode as cc, $isEditorState as lc, createCommand as dc, CLICK_COMMAND as wc, isDOMNode as uc, $getNodeFromDOMNode as pc, $createNodeSelection as hc, $setSelection as gc, $getEditor as fc, DecoratorNode as Ia, $getState as mc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as vc, $setState as bc, addClassNamesToElement as Mn, $create as xc, $getNodeByKey as yc, removeClassNamesFromElement as kc, KEY_TAB_COMMAND as _c, $isBlockElementNode as Nc, $createRangeSelection as Cc, $normalizeSelection__EXPERIMENTAL as Ec, OUTDENT_CONTENT_COMMAND as Tc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as zc, COMMAND_PRIORITY_CRITICAL as to, $isDecoratorNode as Dc, $isParagraphNode as Sc, $isTextNode as Va, SELECTION_CHANGE_COMMAND as An, $insertNodes as Oc } from "lexical";
...
import { IconX as Ic, IconCheck as ia, IconChevronDown as Vc, IconChevronUp as Lc, IconSelector as jc, IconLayoutSidebar as Fc, IconLayoutSidebarRight as Bc, IconChevronRight as Pn, IconLoader as Uc, IconAlertOctagon as Kc, IconAlertTriangle as qc, IconInfoCircle as Gc, IconCircleCheck as Hc } from "@tabler/icons-react";
...
import { useReactTable as Vn, getFilteredRowModel as Jc, getSortedRowModel as Ln, getPaginationRowModel as Zc, getCoreRowModel as jn, flexRender as br, getGroupedRowModel as Qc, getExpandedRowModel as tl } from "@tanstack/react-table";
import el from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as La, HIDDEN_NOTE_CALLER as ja, getDefaultViewOptions as rl, isInsertEmbedOpOfType as Pr, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
function va({
  ...
  const T = Gt(), [_, N] = C(!1), [A, F] = C(""), [V, P] = C(""), [y, z] = C("books"), [I, E] = C(void 0), [S, W] = C(
    void 0
  ), [O, Y] = C(void 0), [st, B] = C(!1), Z = q(null), Nt = q(!1), gt = q(void 0), Dt = q(void 0), K = q(void 0), ot = q(void 0), mt = q({}), ct = q({}), Q = j(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Vt = L(() => o ? o() : Bn, [o]), xt = L(() => ({
    [tt.OT]: Vt.filter((b) => wt.isBookOT(b)),
    [tt.NT]: Vt.filter((b) => wt.isBookNT(b)),
    [tt.DC]: Vt.filter((b) => wt.isBookDC(b)),
    [tt.Extra]: Vt.filter((b) => wt.extraBooks().includes(b))
    ...
    return [tt.OT, tt.NT, tt.DC, tt.Extra].forEach((G) => {
  ...
  }, []), { otLong: et, ntLong: nt, dcLong: vt, extraLong: yt } = {
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: b } = x;
          _ && Z.current && b instanceof Node && Z.current.contains(b) && (Nt.current = !0, H(!1));
        },
        onCloseAutoFocus: k,
        children: /* @__PURE__ */ u(
          Ue,
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Hn ? Jt : X, Ir = { tag: Za };
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : X;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : X;
function zl(t) {
...
function Vl(t) {
  ...
  if (fe(e)) r = Hs(e.focus, "next");
    ...
    r = r || Ys(Fe(), "previous").getFlipped().insert(zr());
  }
...
function Ll(t, e, r) {
  ...
  return ec(o) && Xr(283), o.insert(t.isInline() ? zr().append(t) : t), Ro(zn(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = qt();
  if (!fe(e)) return !1;
...
let Jr, Ee = 0, Zr = 0, Ul = 0, Ka = 0, Br = 0;
function Uo(t) {
  if (it === void 0) return;
  let e = t.n;
...
const ya = nc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ti extends Ia {
  $config() {
...
const Zl = te({ config: tr({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const td = /* @__PURE__ */ new Set(), Yo = te({ build(t, e, r) {
...
const nd = te({ name: "@lexical/react/ReactProvider" });
function id() {
...
const gd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : X;
...
function Cd({
  ...
  const [e] = be(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = Nd(), d = () => {
  };
...
function rp({
  ...
  const [i, s] = C(Md), [c, d] = C(n), [l, w] = C(!1), p = q(void 0), f = q(null);
  X(() => {
    let v = !0;
    const D = f.current;
    if (!D) return;
    ...
    if (o && c)
      return /* @__PURE__ */ u(at, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (N) => {
              N.stopPropagation(), l(!0), p(Rd(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        _ && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(gs, {}) }) }),
...
), jd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => jd(Wa(t));
...
function Bd({
  ...
  if (!(t.conflictType === Fd && !!t.resultText))
    return /* @__PURE__ */ a(Gr, { html: N });
  const F = (O) => {
    const Y = O === "reject" || O === "merge" ? O : "accept";
    l(Y), o == null || o(Y);
  }, V = e["%conflict_note_stale_notice%"] ?? "The verse has been edited since this conflict was recorded, so rejecting is no longer available. Accept keeps the current text.", P = k ? [
    {
      value: "merge",
...
function qd({
  ...
  const [z, I] = C(tn), [E, S] = C(), [W, O] = C(), Y = o, [st, B] = C(!1), [Z, Nt] = C(!1), [gt, Dt] = C(!1), [K, ot] = C(!1), [mt, ct] = C(!1), [Q, Vt] = C(N), [xt, Ht] = C(!1), Lt = q(void 0), [R, ee] = C(/* @__PURE__ */ new Map()), St = l.type === "Conflict", [re, ae] = C("none"), [oe, Me] = C("accept"), [xe, Yt] = C(!1);
  X(() => {
    let b = !0;
    return (async () => {
  ...
  }, [St, H, w]), vt = St && et.conflictType === "verseText" && !!et.resultText, yt = q(null), ft = q(void 0), lt = j(() => {
    var b;
  ...
  const x = vt ? /* @__PURE__ */ a(
    ...
    Qo,
    {
      ...
      handleDeleteComment: h,
      onEditingChange: Nt,
      canEditOrDelete: (!Z && R.get(et.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    Ad,
    {
      ...
      className: g(
        ...
        {
          "tw:bg-primary-foreground": !o && w !== "Resolved" && Q,
          "tw:bg-background": o && w !== "Resolved" && Q,
          "tw:bg-muted": w === "Resolved",
          "tw:bg-accent": !Q && !o && w !== "Resolved"
        }
      ),
      onClick: () => {
        c(d);
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              U,
              {
                ...
                "aria-label": Q ? r["%comment_aria_mark_as_unread%"] ?? "Mark as unread" : r["%comment_aria_mark_as_read%"] ?? "Mark as read",
                children: Q ? /* @__PURE__ */ a(fs, {}) : /* @__PURE__ */ a(ms, {})
              }
            ),
          ...
          o && /* @__PURE__ */ u(at, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    st ? /* @__PURE__ */ a(vs, {}) : /* @__PURE__ */ a(nr, {})
                  ] })
                ]
              }
            ),
            ne.map((b) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Qo,
              {
                ...
                handleDeleteComment: h,
                onEditingChange: Nt,
                canEditOrDelete: (!Z && R.get(b.id)) ?? !1
              }
            ) }, b.id)),
            v !== !1 && (!Z || Zt(z)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
...
function dp({
  ...
  const [_, N] = C(/* @__PURE__ */ new Set()), [A, F] = C(), [V, P] = C(), y = j(
    async (B) => {
      const Z = await i(B);
      return Z !== void 0 && B.assignedUser !== void 0 && B.assignedUser !== "" && P(B.assignedUser), Z;
    },
    [i]
  );
  X(() => {
  ...
  const z = r.filter(
    (B) => B.comments.some((Z) => !Z.deleted)
  ), I = z.map((B) => ({ id: B.id })), E = j(
    (B) => {
      N((Z) => new Set(Z).add(B.id)), F(B.id), k == null || k(B.id);
    },
    [k]
  ), S = j(
    (B) => {
      ...
      }), F(B), k == null || k(Z ? void 0 : B);
    },
    [_, k]
  ), { listboxRef: W, activeId: O, handleKeyDown: Y } = Ui({
    options: I,
    onOptionSelect: E
  }), st = j(
    (B) => {
      B.key === "Escape" ? (A && _.has(A) && (N((Z) => {
        const Nt = new Set(Z);
...
function _p({
  ...
  const [m, k] = C("generated"), [v, D] = C("generated"), [T, _] = C("*"), [N, A] = C("*"), [F, V] = C("f"), [P, y] = C(!1), [z, I] = C(!0), [E, S] = C(!1), W = q(!1), O = q(""), [Y, st] = C(!1), [B, Z] = C(), [Nt, gt] = C(), [Dt, K] = C(), [ot, mt] = C(), ct = q(null), Q = L(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  X(() => {
    ...
    if (H && Pr("note", H)) {
      const vt = (et = H.insert.note) == null ? void 0 : et.caller;
      let yt = "custom";
  ...
  const xt = j(
    ($, H, et = !1) => {
      ...
      if (nt && Pr("note", nt)) {
        ...
        r == null || r([nt]), et && l && i && ((ft = l.current) == null || ft.replaceEmbedUpdate(i, [nt]));
      }
    },
    [i, r, l]
  ), Ht = j(() => {
  ...
  const ee = () => {
    ...
    var et, nt, vt, yt, ft;
    V($);
    const H = (nt = (et = w.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : nt.at(0);
    if (H && Pr("note", H)) {
    ...
    if (f.current && Vt.length && $ && $.rangeCount > 0) {
      const H = $.getRangeAt(0).getBoundingClientRect(), et = f.current.getBoundingClientRect();
      Z(H.left - et.left), gt(H.top - et.top), K(H.height), st(!0);
    }
  }, [Vt, f]);
  X(() => {
    const $ = () => {
    ...
    var et;
    const $ = ((et = p.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, H = (nt) => {
...
function $p({
  ...
  const h = we(r, "%webView_inventory_all%"), m = we(r, "%webView_inventory_approved%"), k = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), D = we(r, "%webView_inventory_scope_currentBook%"), T = we(r, "%webView_inventory_scope_chapter%"), _ = we(r, "%webView_inventory_scope_verse%"), N = we(r, "%webView_inventory_filter_text%"), A = we(
    ...
    for (let Q = 0; Q < K; Q++)
      ot.push(
        Tw(
          ((ct = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ct[Q]) || "Additional Item",
          Q + 1
        )
      );
    return [...ot, ...d];
...
const yi = na(({ className: t, ...e }, r) => /* @__PURE__ */ a(Vs, { size: 35, className: g("tw:animate-spin", t), ...e, ref: r }));
...
const $w = "16rem", Mw = "3rem", ki = ut.createContext(void 0);
function ua() {
  const t = ut.useContext(ki);
  if (!t)
...
const Ie = "scrBook", Kw = "scrRef", Je = "source", qw = "details", Gw = "Scripture Reference", Hw = "Scripture Book", _i = "Type", Yw = "Details";
function Ww(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Jw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: h, extraLong: m } = {
    ...
    (E, S = !1) => {
      ...
      const W = A.findIndex((Z) => Z === _.current), O = A.findIndex((Z) => Z === E);
      if (W === -1 || O === -1) return;
      const [Y, st] = [
        Math.min(W, O),
        Math.max(W, O)
      ], B = A.slice(Y, st + 1).map((Z) => Z);
      r(
        e.includes(E) ? e.filter((Z) => !B.includes(Z)) : [.../* @__PURE__ */ new Set([...e, ...B])]
      );
    },
    [e, r, A]
  ), P = (E) => {
                ...
                Object.values(tt).map((E, S) => {
                  ...
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(_n, { children: [
                      ...
                      S < Object.values(tt).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, E);
                })
              ] })
            ]
...
function Zp({
  ...
  const N = Rt(
  ...
  ] }), ot = e ? Dt.filter((M) => e.includes(M.value)) : Dt, mt = m ?? fa, ct = w ?? mt, Q = p ?? mt, Vt = () => {
    ...
    [r, n, m, i]
  ), nt = ot.find((M) => M.value === t), vt = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? cs(ct, Q, {
  ...
  const [Xt, We] = C(null), [Or, $i] = C(null), [Rr, Mi] = C(null), Ai = 200, [Pi, Ii] = C(!1);
  X(() => {
    if (!Rr || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([J]) => {
      Ii(J.contentRect.width < Ai);
    });
    return M.observe(Rr), () => M.disconnect();
  }, [Rr]);
  const mo = j(
    (M) => {
      ye(M), de(ct), Ge(Q), He(n), bt(!1), Tt(M);
    },
    [ct, Q, n]
  ), vo = j(() => {
    pt !== void 0 && (pt === "range" ? (ne && (f == null || f(ne)), ke && (h == null || h(ke))) : pt === "selectedBooks" && i(Ae), et(pt), Tt(void 0), ye(void 0));
  }, [
    pt,
    ne,
    ke,
        ...
        /* @__PURE__ */ a(
          De,
          {
            ...
            children: /* @__PURE__ */ u(pa, { container: Rr, children: [
              yt.map(({ value: M, label: J, dropdownLabel: jt, scrRefSuffix: gr, id: Vi }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: ht(M),
      ...
      Ba,
      {
        ...
        children: /* @__PURE__ */ u(pa, { container: Or, children: [
          ...
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => $r(!1), children: Z }),
...
function Ha({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(js, {}) }) }),
...
const Di = ut.forwardRef(({ className: t, ...e }, r) => {
  const o = Gt();
  return /* @__PURE__ */ a(
    le.Root,
    {
...
const Si = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.List,
  {
    ref: r,
    className: g(
...
)), Oi = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Content,
  {
    ref: r,
    className: g(
...
function nh({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Di, { children: [
      /* @__PURE__ */ a(Si, { children: t.map((c) => /* @__PURE__ */ a(ru, { value: c.value, children: c.value }, c.key)) }),
