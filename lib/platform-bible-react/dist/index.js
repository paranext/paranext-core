...
function Ra({
  ...
  const F = ye(), A = zl(), D = T ?? A, [U, Y] = _(!1), [H, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [G, nt] = _(void 0), [at, pt] = _(
    void 0
...
function nd(t, e = od) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, R = g.getNode(), y = R.getKey(), C = g.offset, E = t.getElementByKey(b), $ = t.getElementByKey(y), T = r === null || E !== o || v !== n || b !== r.getKey(), F = i === null || $ !== s || C !== c || y !== i.getKey();
      if ((T || F) && E !== null && $ !== null) {
...
function Pi({
  ...
  const [H, Q] = _(mn), [I, tt] = _(), [N, z] = _(), G = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(E), [At, bt] = _(!1), Bt = K(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let x = !0;
    return (async () => {
...
function ww({
  ...
  const [s, c] = _("accept"), l = Ko(), d = Ko(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = V(
    () => Qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = V(
    () => Qr(t.acceptedText ?? ""),
...
function Vp({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [E, $] = _(), [T, F] = _(), A = j(
    async (z) => {
      const G = await i(z);
      return G !== void 0 && z.assignedUser !== void 0 && z.assignedUser !== "" && F(z.assignedUser), G;
    },
    [i]
  );
  W(() => {
  ...
  const D = r.filter(
    ...
    (z) => {
      C((G) => new Set(G).add(z.id)), $(z.id), b == null || b(z.id);
    },
    [b]
  ), H = j(
    (z) => {
...
function kw({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, R] = _({}), y = V(() => e ?? [], [e]), C = ai({
    data: y,
    columns: t,
    getCoreRowModel: ni(),
      ...
      return /* @__PURE__ */ u(Er, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          X,
          {
            ...
            onClick: () => r(e.filter((b) => b !== g)),
            children: /* @__PURE__ */ a(fo, { className: "tw:h-3 tw:w-3" })
          }
        ),
        (f = t.find((b) => b.value === g)) == null ? void 0 : f.label
      ] }, g);
    }) }) : /* @__PURE__ */ a(Et, { children: p })
  ] });
}
...
function Wp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [E, $] = _("*"), [T, F] = _("*"), [A, D] = _("f"), [U, Y] = _(!1), [H, Q] = _(!0), [I, tt] = _(!1), N = K(!1), z = K(""), [G, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = K(null), vt = K(
    void 0
  ...
  const Tt = j(() => {
    var x, L, P;
    const S = (x = g.current) == null ? void 0 : x.querySelector(".editor-input"), B = S == null ? void 0 : S.querySelector("span.note"), q = (P = (L = g.current) == null ? void 0 : L.ownerDocument.getSelection()) == null ? void 0 : P.anchorNode;
  ...
  W(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let st = "custom";
      et === Ja ? st = "generated" : et === Za ? st = "hidden" : et && ($(et), F(et)), R(st), C(st), D(((P = x.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
  ...
  const Ft = j(
    ...
    (S, B) => {
      ...
      let x;
      S === "custom" ? x = B : S === "generated" ? x = Ja : x = Za, q.insert.note.caller !== x && (q.insert.note.caller = x, (et = h.current) == null || et.applyUpdate([q, { delete: 1 }]));
    },
    []
  ), kt = j(() => {
    var S;
  ...
  W(() => {
    ...
    const B = (x) => {
      const L = S();
      !G && L && document.activeElement === L && x.key === c ? (x.preventDefault(), Zt()) : G && x.key === "Escape" && (x.preventDefault(), nt(!1));
    };
...
function oh({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), b = fe(r, "%webView_inventory_unapproved%"), v = fe(r, "%webView_inventory_unknown%"), R = fe(r, "%webView_inventory_scope_currentBook%"), y = fe(r, "%webView_inventory_scope_chapter%"), C = fe(r, "%webView_inventory_scope_verse%"), E = fe(r, "%webView_inventory_filter_text%"), $ = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = fe(r, "%webView_inventory_no_results%"), [F, A] = _(!1), [D, U] = _("all"), [Y, H] = _(""), [Q, I] = _([]), tt = V(() => {
    const J = t ?? [];
  ...
  }, [F, tt]), z = V(() => N.length === 0 ? [] : Zw(N, D, Y), [N, D, Y]), G = V(() => {
    var gt, ft;
    if (!F) return l;
...
function bh({
  ...
  const [d, w] = _([]), [p, h] = _([{ id: ze, desc: !1 }]), [g, f] = _({}), b = V(
  ...
  W(() => {
    if (c) {
      ...
      if (U.length === 1) {
        const Y = b.find((H) => Nn(H) === U[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, R]);
...
function yh({
  ...
  ), Lt = gt.find((O) => O.value === "selectedBooks"), Ht = gt.find((O) => O.value === "range"), [ue, pe] = _(!1), [S, B] = _(void 0), [q, x] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", jt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  const Lr = j(
    ...
    q !== void 0 && (q === "range" ? (L && (g == null || g(L)), et && (f == null || f(et))) : q === "selectedBooks" && i(ht), ae(q), B(void 0), x(void 0));
  }, [
    q,
    L,
    et,
