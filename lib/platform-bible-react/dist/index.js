...
import b, { forwardRef as We, useRef as rt, useMemo as B, useState as A, useCallback as j, useLayoutEffect as Vt, createContext as mn, useContext as lr, useEffect as W, Component as ws, createElement as Ir, Suspense as ds, createRef as cs, Fragment as io } from "react";
...
const Re = ve.Root, De = ve.Trigger, cp = ve.Anchor, ce = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = wt();
...
function gl({
  ...
  return /* @__PURE__ */ p(Re, { open: l, onOpenChange: d, children: [
    ...
    /* @__PURE__ */ o(ce, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(Ee, { children: /* @__PURE__ */ o(Se, { children: /* @__PURE__ */ o(Kt, { heading: s, children: e.map((c) => /* @__PURE__ */ p(
      de,
      {
        onSelect: () => w(c),
      ...
      if (i) {
        ...
        if (!c && d) {
          ...
          if (u && t.includes(u) && (c = u), !c && n) {
            ...
            g && t.includes(g[0]) && ([c] = g);
          }
        }
        if (c) {
          let h = d ? parseInt(d, 10) : void 0;
          h && h > Tt(c) && (h = Math.max(Tt(c), 1));
...
function xl(e, t, n, r) {
  const a = j(() => {
    if (e.chapterNum > 1)
      ...
      if (d > 0) {
        const w = t[d - 1], c = Math.max(Tt(w), 1);
        r({
          book: w,
          chapterNum: c,
          verseNum: 1
...
function up({
  ...
  const w = wt(), [c, f] = A(!1), [h, u] = A(""), [g, v] = A(""), [y, D] = A("books"), [N, x] = A(void 0), [C, V] = A(!1), k = rt(void 0), _ = rt(void 0), T = rt(void 0), E = rt(void 0), S = rt({}), $ = j(
    (R) => {
      t(R), l && l(R);
    },
    [t, l]
    ...
    (R) => {
      ...
      f(R), R && (D("books"), x(void 0), v(""));
    },
    [y, I]
  ), { otLong: dt, ntLong: vt, dcLong: Ae, extraLong: Rr } = {
    ...
    (R) => {
      if (R.ctrlKey) return;
      const { isLetter: U, isDigit: it } = Gr(R.key);
      if (y === "chapters") {
        if (R.key === "Backspace") {
        ...
        if (U || it) {
          if (R.preventDefault(), R.stopPropagation(), D("books"), x(void 0), it && N) {
            const ct = re[N];
            v(`${ct} ${R.key}`);
          } else
            v(R.key);
    ...
    const { isLetter: U, isDigit: it } = Gr(R.key);
    (U || it) && (R.preventDefault(), v((ct) => ct + R.key), _.current.focus(), V(!1));
  }, []);
  return Vt(() => {
    const R = setTimeout(() => {
      if (c && y === "books" && T.current && E.current) {
  ...
  }, [y, N, M, e.book, e.chapterNum]), /* @__PURE__ */ p(Re, { open: c, onOpenChange: st, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
    ...
    /* @__PURE__ */ o(ce, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ p(
      Ee,
      {
        ...
        children: [
          ...
          !C && /* @__PURE__ */ p(Se, { ref: T, children: [
            y === "books" && /* @__PURE__ */ p(at, { children: [
              ...
              M && Tt(M.book) > 1 && /* @__PURE__ */ p(at, { children: [
...
function Wn({
  ...
  const [N, x] = A(!1), C = d ?? l, V = (_) => _.length > 0 && typeof _[0] == "object" && "options" in _[0], k = (_, T) => {
  ...
  return /* @__PURE__ */ p(Re, { open: N, onOpenChange: x, ...D, children: [
...
function fp({
  ...
  const c = Dn(w, "%webView_bookSelector_currentBook%"), f = Dn(w, "%webView_bookSelector_choose%"), h = Dn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = A(
    "current book"
    /* CURRENT_BOOK */
  ), v = (y) => {
    g(y), e(y);
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(lt, { className: "tw-ms-1", children: c })
          ] }),
...
const gp = [
  ...
  const a = rt(null), [s, i] = A(void 0), [l, d] = A(void 0), w = j(
    ...
    (u) => {
      var _;
      const g = u.target, v = (T) => T ? document.getElementById(T) : void 0, y = v(l), D = v(s);
...
function Dl({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: d } = e, w = Tl(null, r), c = bo({ editable: e.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, c), theme: r });
    return function(f, h) {
      if (h !== null) {
...
function zl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ni(t) && r !== null) {
    ...
    if (w || c) {
      const [f, h] = ri(e), u = l.is(d), g = t.is(i ? d : l), v = t.is(i ? l : d);
      let y, D = 0;
      u ? (D = f > h ? h : f, y = f > h ? f : h) : g ? (D = i ? h : f, y = void 0) : v && (D = 0, y = i ? f : h);
  ...
  const r = n.getDependency(Qn).output, a = Ue({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = na(() => {
    ...
    r.value.read(() => {
      if ($t()) for (const [c, f] of l.entries()) {
        ...
        const h = yi(c), u = h && h.isSelected() || !1;
  ...
  return Ut(e.registerCommand(pi, (i) => {
    if (ui(i.target)) {
      ...
      if (ow(l)) return function(d, w = !1) {
        ...
        let u;
        w && hi(c) ? u = c : (u = fi(), gi(u)), f ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    Kl(() => {
      ...
      for (const [c, f] of i.entries()) if (f === "destroyed") w.delete(c), d = !0;
        ...
        h ? h.domNode.value = u : (d = !0, w.set(c, { domNode: Ue(u), selectedSignal: r(c) }));
      }
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            e.update(() => {
              ...
              if (Ke(g)) {
                const v = g.anchor;
                let y = v.getNode(), D = 0, N = 0;
                if (dn(y) && w >= 0 && c >= 0 && (D = w, N = w + c, g.setTextNodeRange(y, D, y, N)), D === N && f === "" || (g.insertRawText(f), y = v.getNode()), dn(y)) {
                  D = h, N = h + u;
                  const x = y.getTextContentSize();
                  D = D > x ? x : D, N = N > x ? x : N, g.setTextNodeRange(y, D, y, N);
                }
  ...
  return function(n, r) {
    ...
    return Nr(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], c = o(r, { onError: (h) => n._onError(h), children: o(ds, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
        f !== null && i.push(zi(c, f, w));
      }
      return i;
    }, [r, a, n]);
  }(e, t);
...
function bw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: c, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: v, role: y = "textbox", spellCheck: D = !0, style: N, tabIndex: x, "data-testid": C, ...V }, k) {
  ...
  return wa(() => (T(e.isEditable()), e.registerEditableListener(($) => {
    T($);
  })), [e]), o("div", { "aria-activedescendant": _ ? t : void 0, "aria-autocomplete": _ ? n : "none", "aria-controls": _ ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": _ && y === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": c, "aria-owns": _ ? f : void 0, "aria-readonly": !_ || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: _, "data-testid": C, id: v, ref: S, role: y, spellCheck: D, style: N, tabIndex: x, ...V });
}
const vw = We(bw);
function to(e) {
  return e.getEditorState().read(ia(e.isComposing()));
...
function _w({
  ...
  return /* @__PURE__ */ o(da.Provider, { value: i, children: s });
}
function ca() {
  const e = lr(da);
  if (!e)
...
function Rw() {
  const { activeEditor: e } = ca(), [t, n] = A([]), r = j((a) => {
    if (Ke(a) || ji(a)) {
      const s = [];
      eo.forEach(({ format: i }) => {
...
function ma(e, t, n, r = null) {
  ...
  if (a && !s) {
    if ((Oi(c) || Lr(c)) && c.append(h), n.append(c), f) {
      const u = f.call(i, c);
...
function fa(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const d = function(g, v) {
    const { nodeName: y } = g, D = v._htmlConversions.get(y.toLowerCase());
    let N = null;
    if (D !== void 0) for (const x of D) {
      const C = x(g);
  ...
  return c != null && (h = c(h)), Br(e) && (h = Vw(e, h, u ? () => {
    const g = new _o();
    return n.push(g), g;
...
function no({
  ...
  }, [e.date, r]), N = B(() => e.user, [e.user]), x = B(
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(xa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(ya, { className: "tw-text-xs tw-font-medium", children: x }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), v()) : k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), zt(h) && y());
              },
              onKeyDown: (k) => {
                ga(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  er,
...
function Yw({
  ...
  const [u, g] = A($n), [v, y] = A(!1), [D, N] = A(!1), [x, C] = A(!1), [V, k] = A(!1), _ = B(() => e.filter((I) => !I.deleted), [e]), T = B(() => _[0], [_]), E = rt(null), S = rt(void 0);
  W(() => {
    const I = E.current;
    if (!I) return;
    const st = () => {
  ...
  const $ = B(
    ...
    [a, t]
  ), H = B(() => _.slice(1), [_]), O = B(() => H.length ?? 0, [H.length]), Z = B(() => O > 0, [O]), M = B(() => x || O <= 2 ? H : H.slice(-2), [H, O, x]), Q = B(() => x || O <= 2 ? 0 : O - 2, [O, x]), yt = B(
    ...
    var st;
    await c(l, nr(u)) && ((st = S.current) == null || st.call(S), g($n));
  }, [u, c, l]), P = j(
    async (I, st) => {
      var Ae;
      if (!w) return !1;
      const dt = zt(u) ? nr(u) : void 0, vt = await w(I, st, dt);
      return vt && dt && ((Ae = S.current) == null || Ae.call(S), g($n)), vt;
    },
    [u, w]
  );
  return /* @__PURE__ */ o(
          ...
          n && /* @__PURE__ */ p(at, { children: [
            ...
            (!V || zt(u)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDown: (I) => {
                  ga(I), (I.key === "Enter" || I.key === " ") && I.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    er,
...
function bp({
  ...
  const [d, w] = A(), c = t.filter(
    ...
    w(N);
  }, []), { listboxRef: g, activeId: v, handleKeyDown: y } = Sl({
    options: f,
    onOptionSelect: h
  }), D = j(
    (N) => {
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        qe(i, '[tabindex]:not([tabindex="-1"])').forEach((c) => {
  ...
  const l = b.useMemo(
    ...
    (c) => {
      ...
      if (c.key === "ArrowDown" || c.key === "ArrowUp")
        c.preventDefault(), ad(u, g, c.key);
      else if (c.key === "ArrowLeft" || c.key === "ArrowRight")
        c.preventDefault(), od(l, v, c.key);
...
function id({
  ...
  var k;
  const [c, f] = A([]), [h, u] = A([]), [g, v] = A({}), [y, D] = A({}), N = B(() => t ?? [], [t]), x = Ro({
    data: N,
    columns: e,
    getCoreRowModel: Oo(),
  ...
  }), C = x.getVisibleFlatColumns();
  let V;
  return d ? V = Array.from({ length: 10 }).map((E, S) => `skeleton-row-${S}`).map((E) => /* @__PURE__ */ o(It, { children: /* @__PURE__ */ o(ae, { colSpan: C.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(rr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((k = x.getRowModel().rows) == null ? void 0 : k.length) > 0 ? V = x.getRowModel().rows.map((_) => /* @__PURE__ */ o(
    It,
    {
      onClick: () => i(_, x),
    ...
    a && /* @__PURE__ */ o(qw, { table: x }),
    /* @__PURE__ */ p(yn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Nn, { stickyHeader: s, children: x.getHeaderGroups().map((_) => /* @__PURE__ */ o(It, { children: _.headers.map((T) => /* @__PURE__ */ o(Je, { children: T.isPlaceholder ? void 0 : je(T.column.columnDef.header, T.getContext()) }, T.id)) }, _.id)) }),
...
function Np({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ p(pe, { children: [
    ...
    /* @__PURE__ */ o(Jt, { children: n.map((w, c) => /* @__PURE__ */ p("div", { children: [
...
function _p({
  ...
  const i = B(() => Qs(n), [n]), d = ((w) => {
    const c = new Intl.DisplayNames(ti(), { type: "language" });
...
function pd({
  ...
  return /* @__PURE__ */ o("div", { id: y, className: g, children: /* @__PURE__ */ p(Re, { open: T, onOpenChange: c ?? N, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ p(
      L,
      {
        variant: v,
    ...
    /* @__PURE__ */ o(ce, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(Ee, { children: [
      ...
      /* @__PURE__ */ p(Se, { children: [
        ...
        /* @__PURE__ */ o(Kt, { children: V.map((S) => /* @__PURE__ */ p(
          de,
          {
            value: S.label,
            onSelect: x,
...
const ud = (e, t, n) => e === "generated" ? /* @__PURE__ */ p(at, { children: [
...
const hd = (e, t) => e === "f" ? /* @__PURE__ */ p(at, { children: [
  /* @__PURE__ */ o(mo, {}),
  " ",
...
function Ep({
  ...
  const l = rt(null), d = cs(), [w, c] = A("generated"), [f, h] = A("*"), [u, g] = A("f"), v = B(
    () => ({
      ...s,
  ...
  W(() => {
    ...
    if (C && Tn("note", C)) {
      ...
      let T = "custom";
      _ === Xn ? T = "generated" : _ === Kn ? T = "hidden" : _ && h(_), c(T), g(((k = C.insert.note) == null ? void 0 : k.style) ?? "f"), C.insert.note && (C.insert.note.caller = ""), x = setTimeout(() => {
        var E;
  ...
  const y = j(() => {
    var C, V;
    const x = (V = (C = l.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : V.at(0);
    x && Tn("note", x) && (x.insert.note && (w === "custom" ? x.insert.note.caller = f : x.insert.note.caller = w === "generated" ? Xn : Kn), t([x]));
  }, [w, f, t]), D = () => {
    var C;
    const x = (C = d.current) == null ? void 0 : C.getElementsByClassName("editor-input")[0];
        ...
        /* @__PURE__ */ o(
          gd,
          {
            ...
            handleNoteTypeChange: (x) => {
              ...
              C && Tn("note", C) && (C.insert.note && (C.insert.note.style = x), (_ = l.current) == null || _.applyUpdate([{ delete: 1 }, C]));
            },
            localizedStrings: i
          }
        ),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Mt, { children: /* @__PURE__ */ p(Ft, { children: [
            /* @__PURE__ */ o(oe, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: D, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(po, {}) }) }),
...
function xd({
  ...
  const d = r ? /* @__PURE__ */ o("span", { className: "marker", children: `\\${e.marker} ` }) : void 0, w = r ? /* @__PURE__ */ o("span", { className: "marker", children: ` \\${e.marker}*` }) : void 0, c = a && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
  ...
  return /* @__PURE__ */ p(at, { children: [
    ...
    /* @__PURE__ */ o("div", { className: m("textual-note-body tw-pr-0.5", g, v), children: l && l.length > 0 && /* @__PURE__ */ o(at, { children: bd(e.marker, l, r, w) }) })
  ] });
}
...
function Rp({
  ...
  const f = c ? yd(c, "%webView_footnoteList_header%") : "Footnotes", h = d ?? ei(n, void 0), u = (x, C) => {
    w == null || w(x, C, a);
  }, g = s ? n.findIndex((x) => x === s) : 0, [v, y] = A(g), D = (x) => {
    if (n.length)
      switch (x.key) {
        case "ArrowDown":
          x.preventDefault(), y((C) => Math.min(C + 1, n.length - 1));
          break;
        case "ArrowUp":
          x.preventDefault(), y((C) => Math.max(C - 1, 0));
          break;
        case "Enter":
        case " ":
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ o(
          "ul",
          {
            ...
            children: n.map((x, C) => {
              const V = x === s, k = `${a}-${C}`;
              return console.log(t), /* @__PURE__ */ p(at, { children: [
                /* @__PURE__ */ o(
                  "li",
                  {
                    ref: (_) => {
                ...
                C < n.length - 1 && r === "vertical" && /* @__PURE__ */ o("li", { tabIndex: -1, className: "tw-col-span-2", children: /* @__PURE__ */ o(ye, {}) })
              ] });
            })
          }
        )
...
function Pp({
  ...
  const f = Et(n, "%webView_inventory_all%"), h = Et(n, "%webView_inventory_approved%"), u = Et(n, "%webView_inventory_unapproved%"), g = Et(n, "%webView_inventory_unknown%"), v = Et(n, "%webView_inventory_scope_currentBook%"), y = Et(n, "%webView_inventory_scope_chapter%"), D = Et(n, "%webView_inventory_scope_verse%"), N = Et(n, "%webView_inventory_filter_text%"), x = Et(
    n,
    "%webView_inventory_show_additional_items%"
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      r && /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(lt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? x })
      ] })
    ] }),
...
const Td = "16rem", Rd = "3rem", Ra = b.createContext(void 0);
function Cn() {
...
const Da = b.forwardRef(
  ({
    ...
    const [w, c] = b.useState(e), f = t ?? w, h = b.useCallback(
      (x) => {
        const C = typeof x == "function" ? x(f) : x;
        n ? n(C) : c(C);
      },
      [n, f]
    ), u = b.useCallback(() => h((x) => !x), [h]), g = f ? "expanded" : "collapsed", D = wt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
...
const Dd = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Cn();
  return /* @__PURE__ */ p(
    L,
    {
...
const $d = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? _e : "button",
  {
    ref: r,
...
const Ld = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? _e : "button",
  {
    ref: a,
...
const zd = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
const Gd = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? _e : "a",
  {
    ref: s,
...
}, ao = (e) => `${Wd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Bp({
  sources: e,
  ...
  const [w, c] = A([]), [f, h] = A([{ id: jt, desc: !1 }]), [u, g] = A({}), v = B(
  ...
  const N = a ?? Yd, x = s ?? Pa, C = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [jt] },
    { label: `Group by ${x}`, value: [ee] },
    {
...
function Zd({
  ...
  const s = Tr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    L,
    {
      variant: "outline",
...
function Qd({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], d = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], c = r["%webView_book_selector_no_book_found%"], f = r["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: v } = {
  ...
  }, [y, D] = A(!1), [N, x] = A(""), C = rt(void 0), V = rt(!1);
...
function jp({
  ...
  const w = Zt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Zt(i, "%webView_scope_selector_current_book%"), u = Zt(i, "%webView_scope_selector_choose_books%"), g = Zt(i, "%webView_scope_selector_scope%"), v = Zt(i, "%webView_scope_selector_select_books%"), y = [
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        gr,
        {
          ...
          children: D.map(({ value: N, label: x, id: C }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(cn, { className: "tw-me-2", value: N, id: C }),
            /* @__PURE__ */ o(lt, { htmlFor: C, children: x })
          ] }, C))
        }
      )
    ] }),
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ p(Ft, { children: [
...
function ir({
  ...
  return /* @__PURE__ */ p(pe, { variant: s, children: [
    ...
    /* @__PURE__ */ o(Jt, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, c) => /* @__PURE__ */ p(io, { children: [
...
const rc = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = _t();
  return /* @__PURE__ */ p(
    et.CheckboxItem,
    {
...
const oc = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = _t();
  return /* @__PURE__ */ p(
    et.RadioItem,
    {
...
const ac = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  et.Label,
  {
    ref: r,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
const Le = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ p(Ft, { children: [
...
function sc({
  ...
  if (Ji(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (c, f) => {
    var g, v, y, D;
    c.preventDefault();
    ...
    return /* @__PURE__ */ o(Xa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, f]) => typeof c == "boolean" || typeof f == "boolean" ? 0 : c.order - f.order).map(([c, f]) => /* @__PURE__ */ p(ec, { children: [
      /* @__PURE__ */ o(Ka, { ref: w(c), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ o(
        qa,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Mt, { children: Za(e.groups, e.items, c, t) })
        }
      )
    ] }, c)) });
}
...
function Wp({
  ...
  const w = ic(
    ...
    var D, N, x, C, V, k;
    const y = v !== g ? ((N = (D = e[g]) == null ? void 0 : D.uiNames) == null ? void 0 : N[v]) ?? ((C = (x = e[g]) == null ? void 0 : x.uiNames) == null ? void 0 : C.en) : void 0;
    return y ? `${(V = e[g]) == null ? void 0 : V.autonym} (${y})` : (k = e[g]) == null ? void 0 : k.autonym;
  };
...
), cc = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const uc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
uc.displayName = "AlertDescription";
const eu = nt.Root, nu = nt.Trigger, ru = nt.Group, ou = nt.Portal, au = nt.Sub, su = nt.RadioGroup, mc = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ p(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
const fc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(nt.Portal, { children: /* @__PURE__ */ o(
  nt.Content,
  {
    ref: n,
    className: m(
...
const gc = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Item,
  {
    ref: r,
    className: m(
...
const bc = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ p(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
const vc = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ p(
  nt.RadioItem,
  {
    ref: r,
    className: m(
...
const xc = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Label,
  {
    ref: r,
    className: m(
...
const iu = kt.Trigger, _c = kt.Portal, lu = kt.Close, ts = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  kt.Overlay,
  {
    ref: n,
...
const Cc = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
const Dc = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  Yn.Root,
  {
    ref: r,
    className: m(
...
const Oc = b.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ p(
    Be.Root,
    {
...
const uu = gt.Root, Mc = b.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    gt.List,
    {
