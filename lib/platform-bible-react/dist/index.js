...
import x, { forwardRef as pn, useRef as G, useMemo as z, useState as S, useCallback as K, useLayoutEffect as Lt, createContext as On, useContext as Nr, useEffect as q, Component as As, createElement as Xr, Suspense as Ps, Fragment as Do } from "react";
import { Command as It } from "cmdk";
import { X as Be, Search as Io, Check as zt, Clock as Wr, ChevronsLeft as Jr, ChevronsRight as Zr, ChevronLeft as rr, ChevronRight as Xt, ArrowLeft as Ls, ArrowRight as $s, Circle as An, ChevronDown as Ke, BoldIcon as Vs, ItalicIcon as js, AtSign as Mo, Pencil as Fs, Trash2 as zs, ArrowUp as kr, MoreHorizontal as Oo, MailOpen as Bs, Mail as Ks, ChevronUp as Ao, FilterIcon as Us, ArrowLeftIcon as Gs, ChevronLeftIcon as qs, ChevronRightIcon as Hs, ArrowRightIcon as Ys, Copy as Po, Filter as Xs, User as Ws, Link as Js, CircleHelp as Zs, ChevronsUpDown as Lo, Star as Qs, Undo as ti, Redo as ei, SquareX as $o, FunctionSquare as Vo, SquareSigma as jo, Ban as ni, AlertCircle as or, CircleCheckIcon as ri, CircleXIcon as oi, CircleHelpIcon as ai, ArrowUpIcon as si, ArrowDownIcon as ii, PanelLeft as li, PanelRight as ci, ScrollText as wi, MenuIcon as di, Menu as pi, EllipsisVertical as ui, GripVertical as mi, MoreVertical as Qr, LoaderCircle as fi } from "lucide-react";
...
import { createEditor as zo, $getRoot as ce, $createParagraphNode as Ge, $getSelection as Dt, HISTORY_MERGE_TAG as _r, ParagraphNode as Bo, TextNode as Ko, $isTokenOrSegmented as Ei, $getCharacterOffsets as Ti, $cloneWithPropertiesEphemeral as Ri, $getPreviousSelection as Si, $isRangeSelection as Wt, $caretFromPoint as Di, $getSiblingCaret as Uo, $getChildCaret as Ii, $getAdjacentChildCaret as Mi, $isChildCaret as Oi, $normalizeCaret as Ai, $setSelectionFromCaretRange as Pi, $getCollapsedCaretRange as Li, $getCaretInDirection as eo, $splitAtPointCaretNext as $i, $isTextPointCaret as Vi, $findMatchingParent as Go, $isElementNode as se, mergeRegister as we, getDOMTextNode as ji, isHTMLElement as qo, CLEAR_EDITOR_COMMAND as Ho, COMMAND_PRIORITY_EDITOR as Cr, shallowMergeConfig as Fi, defineExtension as $t, safeCast as Me, createState as zi, FORMAT_TEXT_COMMAND as Yo, $isNodeSelection as Xo, COMMAND_PRIORITY_LOW as Wo, RootNode as Bi, LineBreakNode as Ki, TabNode as Ui, $isEditorState as Gi, createCommand as qi, CLICK_COMMAND as Hi, isDOMNode as Yi, $getNodeFromDOMNode as Xi, $createNodeSelection as Wi, $setSelection as Ji, $getEditor as Zi, DecoratorNode as sr, $getState as Qi, toggleTextFormatType as no, TEXT_TYPE_TO_FORMAT as tl, $setState as el, addClassNamesToElement as Jo, $create as nl, $getNodeByKey as rl, removeClassNamesFromElement as ol, KEY_TAB_COMMAND as al, $isBlockElementNode as kn, $createRangeSelection as sl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as ll, INDENT_CONTENT_COMMAND as ro, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as Er, $isDecoratorNode as wl, $isParagraphNode as dl, $isTextNode as _n, SELECTION_CHANGE_COMMAND as Zo, getRegisteredNode as pl, isDocumentFragment as oo, isDOMDocumentNode as ul, ArtificialNode__DO_NOT_USE as Qo, $createLineBreakNode as ta, $isRootOrShadowRoot as ml, isBlockDomNode as ao, isInlineDomNode as so, $insertNodes as fl } from "lexical";
...
import { GENERATOR_NOTE_CALLER as ir, HIDDEN_NOTE_CALLER as lr, getDefaultViewOptions as Sl, isInsertEmbedOpOfType as hn, Editorial as Dl } from "@eten-tech-foundation/platform-editor";
...
function du({
  ...
  const d = gt(), [w, u] = S(!1), [m, f] = S(""), [h, v] = S(""), [b, y] = S("books"), [N, C] = S(void 0), [_, $] = S(!1), j = G(void 0), O = G(void 0), T = G(void 0), E = G(void 0), k = G({}), M = K(
    (P) => {
      e(P), l && l(P);
    },
    [e, l]
  ), D = z(() => o ? o() : fa, [o]), L = z(() => ({
    [Q.OT]: D.filter((R) => ht.isBookOT(R)),
    [Q.NT]: D.filter((R) => ht.isBookNT(R)),
    [Q.DC]: D.filter((R) => ht.isBookDC(R)),
    [Q.Extra]: D.filter((R) => ht.extraBooks().includes(R))
  }), [D]), V = z(() => Object.values(L).flat(), [L]), W = z(() => {
    if (!h.trim()) return L;
    const P = {
      [Q.OT]: [],
      [Q.NT]: [],
    ...
    (P) => {
      const R = b === "chapters" ? N : A == null ? void 0 : A.book;
      R && (M({
        book: R,
        chapterNum: P,
        verseNum: 1
      }), u(!1), y("books"), C(void 0), v(""));
    },
    [M, b, N, A]
  ), at = K(
    (P) => {
    ...
    (P) => A ? !!A.chapterNum && !P.toString().includes(A.chapterNum.toString()) : !1,
    [A]
  ), Gt = z(
    () => Ce(
      t,
    ...
    (P.key === "Home" || P.key === "End") && P.stopPropagation();
  }, []), oe = K(
    (P) => {
      if (P.ctrlKey) return;
      const { isLetter: R, isDigit: F } = io(P.key);
      if (b === "chapters") {
        if (P.key === "Backspace") {
        ...
        if (R || F) {
          if (P.preventDefault(), P.stopPropagation(), y("books"), C(void 0), F && N) {
            const Y = Ee[N];
            v(`${Y} ${P.key}`);
          } else
            v(P.key);
      ...
      if ((b === "chapters" || b === "books" && A) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(P.key)) {
        const Y = b === "chapters" ? N : A == null ? void 0 : A.book;
        if (!Y) return;
        const X = (() => {
          if (!m) return 1;
          const mt = m.match(/(\d+)$/);
        ...
        rt !== X && (P.preventDefault(), P.stopPropagation(), f(pr(Y, a, rt)), setTimeout(() => {
          const mt = k.current[rt];
    ...
    if (P.shiftKey || P.key === "Tab" || P.key === " ") return;
    const { isLetter: R, isDigit: F } = io(P.key);
    (R || F) && (P.preventDefault(), v((Y) => Y + P.key), O.current.focus(), $(!1));
  }, []);
  return Lt(() => {
    const P = setTimeout(() => {
      if (w && b === "books" && T.current && E.current) {
        const R = T.current, F = E.current, Y = F.offsetTop, X = R.clientHeight, pt = F.clientHeight, rt = Y - X / 2 + pt / 2;
        R.scrollTo({
          top: Math.max(0, rt),
          behavior: "smooth"
        }), f(pr(t.book));
    ...
    if (b === "chapters" && N) {
      ...
      setTimeout(() => {
        if (T.current)
          if (P) {
            const R = k.current[t.chapterNum];
  ...
  }, [b, N, A, t.book, t.chapterNum]), /* @__PURE__ */ p(me, { open: w, onOpenChange: H, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
      U,
      {
          ...
          b === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            /* @__PURE__ */ p("div", { className: "tw-relative tw-flex-1", children: [
              ...
              s && s.length > 0 && /* @__PURE__ */ r(
                Kl,
                {
                  ...
                  renderItem: (P) => Ce(P, "English"),
                  getItemKey: (P) => `${P.book}-${P.chapterNum}-${P.verseNum}`,
                  ariaLabel: i == null ? void 0 : i["%history_recentSearches_ariaLabel%"],
                  groupHeading: i == null ? void 0 : i["%history_recent%"]
                }
              )
            ] }),
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: J.map(({ onClick: P, disabled: R, title: F, icon: Y }) => /* @__PURE__ */ r(
              U,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              U,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ r(Ls, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r($s, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Le(N, a) })
          ] }),
          !_ && /* @__PURE__ */ p(ue, { ref: T, children: [
            b === "books" && /* @__PURE__ */ p(st, { children: [
              !A && Object.entries(W).map(([P, R]) => {
                if (R.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Jt, { heading: re(P), children: R.map((F) => /* @__PURE__ */ r(
                      ha,
                      {
                        bookId: F,
                        onSelect: (Y) => Et(Y),
              ...
              A && /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(
                te,
                {
                  value: `${A.book} ${Ee[A.book]} ${A.chapterNum || ""}:${A.verseNum || ""})}`,
                  onSelect: tt,
              ...
              A && Yt(A.book) > 1 && /* @__PURE__ */ p(st, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Le(A.book, a) }),
                /* @__PURE__ */ r(
                  lo,
                  {
                    bookId: A.book,
...
function ur({
  ...
  const [C, _] = S(!1), $ = d ?? c, j = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], O = (T, E) => {
    const k = c(T), M = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, D = `${E ?? ""}${k}${M ?? ""}`;
    return /* @__PURE__ */ p(
      te,
      {
        value: k,
  ...
  return /* @__PURE__ */ p(me, { open: C, onOpenChange: _, ...N, children: [
    ...
    /* @__PURE__ */ r(
      ee,
      {
        ...
        children: /* @__PURE__ */ p(pe, { children: [
          ...
          /* @__PURE__ */ r(ue, { children: j(e) ? e.map((T) => /* @__PURE__ */ r(Jt, { heading: T.groupHeading, children: T.options.map((E) => O(E, T.groupHeading)) }, T.groupHeading)) : e.map((T) => O(T)) })
        ] })
      }
    )
  ] });
...
function mu({
  ...
  const w = Un(d, "%webView_bookSelector_currentBook%"), u = Un(d, "%webView_bookSelector_choose%"), m = Un(d, "%webView_bookSelector_chooseBooks%"), [f, h] = S(
    "current book"
    /* CurrentBook */
  ), v = (b) => {
    h(b), t(b);
...
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Jl = va ? Lt : q, gn = { tag: _r };
function Zl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, d = Wl(null, o), w = zo({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, w), theme: o });
    return function(u, m) {
      if (m !== null) {
...
function ic() {
  return function(t) {
    const [e] = ne(), n = z(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), i = G(o);
    return ac(() => {
...
function pc(t, e, n) {
  ...
  function c() {
    ...
    for (let y = 0; y < f.length; y++) {
      const N = f[y], C = s[y] || document.createElement("div"), _ = C.style;
      _.position !== "absolute" && (_.position = "absolute", b = !0);
      const $ = Ht(N.left - u);
      _.left !== $ && (_.left = $, b = !0);
      const j = Ht(N.top - m);
      _.top !== j && (C.style.top = j, b = !0);
      const O = Ht(N.width);
      _.width !== O && (C.style.width = O, b = !0);
      const T = Ht(N.height);
      _.height !== T && (C.style.height = T, b = !0), C.parentNode !== l && (l.append(C), b = !0), s[y] = C;
    }
...
function mc(t, e = uc) {
  ...
  function d(w) {
    w.read(() => {
      ...
      const [m, f] = function(T) {
        const E = T.getStartEndPoints();
        return T.isBackward() ? [E[1], E[0]] : E;
      }(u), h = m.getNode(), v = h.getKey(), b = m.offset, y = f.getNode(), N = y.getKey(), C = f.offset, _ = t.getElementByKey(v), $ = t.getElementByKey(N), j = n === null || _ !== o || b !== a || v !== n.getKey(), O = i === null || $ !== s || C !== l || N !== i.getKey();
      if ((j || O) && _ !== null && $ !== null) {
        const T = function(E, k, M, D, L, V, W) {
          const A = (E._window ? E._window.document : document).createRange();
          return A.setStart(...co(k, M, D)), A.setEnd(...co(L, V, W)), A;
        }(t, m, h, _, f, y, $);
        c(), c = pc(t, T, e);
      }
      n = h, o = _, a = b, i = y, s = $, l = C;
    });
  }
...
function bc(t, e, n) {
  ...
  return Vi(o) && En(283), o.insert(t.isInline() ? Ge().append(t) : t), eo(Uo(t.getLatest(), "next"), e.direction);
}
function vc(t) {
  const e = Dt();
  if (!Wt(e)) return !1;
...
let Tn, ie = 0, Rn = 0, Nc = 0, fr = 0, yn = 0;
function po(t) {
  if (et === void 0) return;
  let e = t.n;
...
const qn = zi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ea extends sr {
  $config() {
...
const Ic = $t({ config: Me({ setOptions: mo, updateOptions: mo }), init: ({ $initialEditorState: t = Dc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Bi, Ko, Ki, Ui, Bo] }), fo = Symbol.for("@lexical/extension/LexicalBuilder");
function ho() {
}
function Mc(t) {
  throw t;
...
const Oc = /* @__PURE__ */ new Set(), go = $t({ build(t, e, n) {
  const o = n.getDependency(hr).output, a = ln({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Ta(() => {
    ...
    o.value.read(() => {
      if (Dt()) for (const [w, u] of l.entries()) {
        ...
        const m = rl(w), f = m && m.isSelected() || !1;
...
}, dependencies: [hr], name: "@lexical/extension/NodeSelection" }), Ac = qi("INSERT_HORIZONTAL_RULE_COMMAND");
class je extends sr {
  static getType() {
...
$t({ dependencies: [hr, go], name: "@lexical/extension/HorizontalRule", nodes: () => [je], register(t, e, n) {
  ...
  return we(t.registerCommand(Ac, (s) => {
    ...
    return !0;
  }, Cr), t.registerCommand(Hi, (s) => {
    if (Yi(s.target)) {
      const l = Xi(s.target);
      if (Lc(l)) return function(c, d = !1) {
        const w = Dt(), u = c.isSelected(), m = c.getKey();
        let f;
        d && Xo(w) ? f = w : (f = Wi(), Ji(f)), u ? f.delete(m) : f.add(m);
      }(l, s.shiftKey), !0;
    }
    return !1;
...
function $c(t, e, n = Ia) {
  return we(t.registerCommand(al, (o) => {
    ...
    const i = function(s) {
      ...
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), u = hc(w);
      if (u.canIndent()) {
        const m = u.getKey();
        let f = sl();
        if (f.anchor.set(m, 0, "element"), f.focus.set(m, 0, "element"), f = il(f), f.anchor.is(d)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? ll : ro : cl;
            ...
            t.update(() => {
              ...
              if (Wt(h)) {
                ...
                if (_n(b) && d >= 0 && w >= 0 && (y = d, N = d + w, h.setTextNodeRange(b, y, b, N)), y === N && u === "" || (h.insertRawText(u), b = v.getNode()), _n(b)) {
                  ...
                  y = y > C ? C : y, N = N > C ? C : N, h.setTextNodeRange(b, y, b, N);
                }
  ...
  return function(n, o) {
    ...
    return $r(() => n.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = r(o, { onError: (m) => n._onError(m), children: r(Ps, { fallback: null, children: a[d] }) }), u = n.getElementByKey(d);
        u !== null && s.push(yl(w, u, d));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function Gc({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    $r(() => we(vl(a), Oa(a)), [a]);
  }(o), p(st, { children: [t, r(qc, { content: e }), r(Uc, { editor: o, ErrorBoundary: n })] });
}
...
function Wc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: u, ariaRequired: m, autoCapitalize: f, className: h, id: v, role: b = "textbox", spellCheck: y = !0, style: N, tabIndex: C, "data-testid": _, ...$ }, j) {
  const [O, T] = S(t.isEditable()), E = K((M) => {
    M && M.ownerDocument && M.ownerDocument.defaultView ? t.setRootElement(M) : t.setRootElement(null);
  }, [t]), k = z(() => /* @__PURE__ */ function(...M) {
    return (D) => {
      for (const L of M) typeof L == "function" ? L(D) : L != null && (L.current = D);
    };
  }(j, E), [E, j]);
  return Aa(() => (T(t.isEditable()), t.registerEditableListener((M) => {
    T(M);
  })), [t]), r("div", { "aria-activedescendant": O ? e : void 0, "aria-autocomplete": O ? n : "none", "aria-controls": O ? o : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": O && b === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": d, "aria-multiline": w, "aria-owns": O ? u : void 0, "aria-readonly": !O || void 0, "aria-required": m, autoCapitalize: f, className: h, contentEditable: O, "data-testid": _, id: v, ref: k, role: b, spellCheck: y, style: N, tabIndex: C, ...$ });
}
const Jc = pn(Wc);
function vo(t) {
  return t.getEditorState().read(Ma(t.isComposing()));
...
function Qc(t, e) {
  ...
  return p(st, { children: [r(Jc, { editor: a, ...o, ref: e }), n != null && r(tw, { editor: a, content: n })] });
}
...
function ow({
  ...
  const [e] = ne(), [n, o] = S(e), [a, i] = S("paragraph"), [s, l] = rw(), c = () => {
  };
...
function iw() {
  const { activeEditor: t } = La(), [e, n] = S([]), o = K((a) => {
    if (Wt(a) || Nl(a)) {
      const i = [];
      xo.forEach(({ format: s }) => {
...
function za(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  return w != null && (m = w(m)), ao(t) && (m = uw(t, m, f ? () => {
    const h = new Qo();
    return n.push(h), h;
...
function fu({
  ...
  const [a, i] = S(fw), [s, l] = S(void 0), [c, d] = S(!1), w = G(void 0), u = G(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
...
], hw = ["input", "select", "textarea", "button"], gw = ["button", "textbox"], zr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = G(null), [i, s] = S(void 0), [l, c] = S(void 0), d = K(
    (f) => {
      s(f);
    ...
    (f) => {
      var O;
      const h = f.target, v = (T) => T ? document.getElementById(T) : void 0, b = v(l), y = v(i);
      if (!!(b && h && b.contains(h) && h !== b) && u(h)) {
        if (f.key === "Escape" || f.key === "ArrowLeft" && !h.isContentEditable) {
          if (l) {
            f.preventDefault(), f.stopPropagation();
            const T = t.find((E) => E.id === l);
            T && d(T.id);
          }
          return;
        }
        if (f.key === "ArrowDown" || f.key === "ArrowUp") {
          ...
          const E = T.findIndex((M) => M === h);
          if (E === -1) return;
          let k;
          f.key === "ArrowDown" ? k = Math.min(E + 1, T.length - 1) : k = Math.max(E - 1, 0), k !== E && (f.preventDefault(), f.stopPropagation(), (O = T[k]) == null || O.focus());
          return;
        }
        return;
      }
      const _ = t.findIndex((T) => T.id === i);
      let $ = _;
      switch (f.key) {
        case "ArrowDown":
...
function yo({
  ...
  const f = K(
    (_) => {
      _ && _.stopPropagation(), d(!1), u(void 0), s == null || s(!1);
    },
    [s]
  ), h = K(
    async (_) => {
      if (_ && _.stopPropagation(), !w || !a) return;
      await a(
        t.id,
        Dn(w)
    ...
    [t.user]
  ), N = z(() => xi(t.contents), [t.contents]), C = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(st, { children: [
        /* @__PURE__ */ p(
          In,
          {
            onClick: (_) => {
              _.stopPropagation(), d(!0), u(mw(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: m,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), f()) : Fr(_) && (_.preventDefault(), _.stopPropagation(), jt(w) && h());
              },
              onKeyDown: (_) => {
                jr(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
...
function Rw({
  ...
  const [O, T] = S(No), [E, k] = S(
    void 0
  ), M = o, [D, L] = S(!1), [V, W] = S(!1), [A, tt] = S(!1), [Et, B] = S(!1), [at, J] = S(!1), [Z, H] = S(_), [wt, dt] = S(!1), ut = G(void 0), [Tt, re] = S(/* @__PURE__ */ new Map());
  q(() => {
    let I = !0;
    return (async () => {
  ...
  const Ut = z(() => e.filter((I) => !I.deleted), [e]);
  q(() => {
    let I = !0;
    if (!o || !C) {
      re(/* @__PURE__ */ new Map());
  ...
  const Gt = z(() => Ut[0], [Ut]), Oe = G(null), he = G(void 0), oe = K(() => {
    var I;
    (I = he.current) == null || I.call(he), T(No);
  }, []), Ze = K(() => {
    const I = !Z;
    H(I), dt(!I), h == null || h(c, I);
  }, [Z, h, c]);
  q(() => {
    L(!1);
  }, [o]), q(() => {
    if (o && !Z && !wt) {
      ...
      return ut.current = I, () => clearTimeout(I);
    }
  ...
  }, [i, n]), F = z(() => Ut.slice(1), [Ut]), Y = z(() => F.length ?? 0, [F.length]), X = z(() => Y > 0, [Y]), pt = z(() => D || Y <= 2 ? F : F.slice(-2), [F, Y, D]), rt = z(() => D || Y <= 2 ? 0 : Y - 2, [Y, D]), _t = z(
    () => Y === 1 ? P.singleReply : _e(P.multipleReplies, { count: Y }),
    [Y, P]
  ), mt = z(
    () => rt === 1 ? P.singleReply : _e(P.multipleReplies, { count: rt }),
    [rt, P]
  );
  q(() => {
    !o && V && X && W(!1);
  ...
  const Ot = K(
    ...
    async (I) => {
      const Ct = jt(O) ? Dn(O) : void 0, xt = await u({
        ...I,
        contents: Ct,
        assignedUser: E ?? I.assignedUser
      });
      return xt && Ct && oe(), xt && E !== void 0 && k(void 0), xt;
    },
    [oe, O, u, E]
  );
  if (Gt)
        ...
        children: /* @__PURE__ */ p(Ga, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              R && /* @__PURE__ */ r(Se, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: R }),
              /* @__PURE__ */ r(
                U,
                {
                  variant: "ghost",
            ...
            o && /* @__PURE__ */ p(st, { children: [
              rt > 0 && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (I) => {
                    (I.key === "Enter" || I.key === " ") && (I.preventDefault(), I.stopPropagation(), L(!0));
                  },
                  children: [
                    /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Ft, {}) }),
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                      /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: mt }),
                      D ? /* @__PURE__ */ r(Ao, {}) : /* @__PURE__ */ r(Ke, {})
                    ] })
                  ]
                }
              ),
              pt.map((I) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
                yo,
                {
                  comment: I,
                  localizedStrings: n,
                  ...
                  handleDeleteComment: f,
                  onEditingChange: W,
                  canEditOrDelete: (!V && Tt.get(I.id)) ?? !1
                }
              ) }, I.id)),
              b !== !1 && (!V || jt(O)) && /* @__PURE__ */ p(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (I) => {
                    Fr(I) && (I.preventDefault(), I.stopPropagation(), (jt(O) || E !== void 0) && Ot());
                  },
                  onKeyDown: (I) => {
                    jr(I), (I.key === "Enter" || I.key === " ") && I.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ r(
                      Sn,
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      ...
                      /* @__PURE__ */ p(me, { open: A, onOpenChange: tt, children: [
                        /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
                          U,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ r(
                          ee,
                          {
                            ...
                            align: "end",
                            onKeyDown: (I) => {
                              I.key === "Escape" && (I.stopPropagation(), tt(!1));
                            },
                            children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: v == null ? void 0 : v.map((I) => /* @__PURE__ */ r(
                              te,
                              {
                                onSelect: () => {
                                  k(I !== i ? I : void 0), tt(!1);
                                ...
                                className: "tw-flex tw-items-center",
                                children: /* @__PURE__ */ r("span", { children: Nn(I, n) })
                              },
                              I || "unassigned"
                            )) }) })
                          }
...
function bu({
  ...
  const [y, N] = S(/* @__PURE__ */ new Set()), [C, _] = S();
  q(() => {
    h && (N((L) => new Set(L).add(h)), _(h));
  }, [h]);
  const $ = n.filter(
    (L) => L.comments.some((V) => !V.deleted)
  ), j = $.map((L) => ({ id: L.id })), O = K(
    (L) => {
      N((V) => new Set(V).add(L.id)), _(L.id), v == null || v(L.id);
    },
    [v]
  ), T = K(
    (L) => {
      ...
      }), _(L), v == null || v(V ? void 0 : L);
    },
    [y, v]
  ), { listboxRef: E, activeId: k, handleKeyDown: M } = zr({
    options: j,
    onOptionSelect: O
  }), D = K(
    (L) => {
      L.key === "Escape" ? (C && y.has(C) && (N((V) => {
        const W = new Set(V);
        return W.delete(C), W;
      }), _(void 0), v == null || v(void 0)), L.preventDefault(), L.stopPropagation()) : M(L);
    },
    [C, y, M, v]
  );
  return /* @__PURE__ */ r(
  ...
  const l = x.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), jw(f, h, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Vw(l, v, w.key);
...
function zw({
  ...
  var j;
  const [w, u] = S([]), [m, f] = S([]), [h, v] = S({}), [b, y] = S({}), N = z(() => e ?? [], [e]), C = oa({
    data: N,
    columns: t,
    getCoreRowModel: sa(),
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((E, k) => `skeleton-row-${k}`).map((E) => /* @__PURE__ */ r(ae, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Te, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dn, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = C.getRowModel().rows) == null ? void 0 : j.length) > 0 ? $ = C.getRowModel().rows.map((O) => /* @__PURE__ */ r(
    ae,
    {
      onClick: () => s(O, C),
      "data-state": O.getIsSelected() && "selected",
      children: O.getVisibleCells().map((T) => /* @__PURE__ */ r(Te, { children: rn(T.column.columnDef.cell, T.getContext()) }, T.id))
    },
    O.id
    ...
    a && /* @__PURE__ */ r(Sw, { table: C }),
    /* @__PURE__ */ p($n, { stickyHeader: i, children: [
      /* @__PURE__ */ r(Vn, { stickyHeader: i, children: C.getHeaderGroups().map((O) => /* @__PURE__ */ r(ae, { children: O.headers.map((T) => /* @__PURE__ */ r(wn, { className: "tw-p-0", children: T.isPlaceholder ? void 0 : rn(T.column.columnDef.header, T.getContext()) }, T.id)) }, O.id)) }),
...
function qw({
  ...
  const [y, N] = S(!1), C = K(
    (k) => {
      var D;
      const M = (D = t.find((L) => L.label === k)) == null ? void 0 : D.value;
      M && n(
        e.includes(M) ? e.filter((L) => L !== M) : [...e, M]
      );
    },
    [t, e, n]
  ), _ = () => c || o, $ = z(() => {
    if (!m) return t;
    const k = t.filter((D) => D.starred).sort((D, L) => D.label.localeCompare(L.label)), M = t.filter((D) => !D.starred).sort((D, L) => {
      const V = e.includes(D.value), W = e.includes(L.value);
      return V && !W ? -1 : !V && W ? 1 : D.label.localeCompare(L.label);
    });
    return [...k, ...M];
  }, [t, e, m]), j = () => {
    n(t.map((k) => k.value));
  ...
  return /* @__PURE__ */ r("div", { id: b, className: h, children: /* @__PURE__ */ p(me, { open: T, onOpenChange: w ?? N, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ p(
      U,
      {
        variant: v,
    ...
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(pe, { children: [
      ...
      /* @__PURE__ */ p(ue, { children: [
        ...
        /* @__PURE__ */ r(Jt, { children: $.map((k) => /* @__PURE__ */ p(
          te,
          {
            value: k.label,
            onSelect: C,
            ...
            children: [
              ...
              k.starred && /* @__PURE__ */ r(Qs, { className: "tw-h-4 tw-w-4" }),
...
const Ww = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(st, { children: [
...
function Jw({
  ...
  const i = G(null), s = G(null), l = G(!1), [c, d] = S(t), [w, u] = S(n), [m, f] = S(!1);
  q(() => {
    d(t);
  }, [t]), q(() => {
    w !== n && u(n);
  ...
  const h = (b) => {
    ...
    var y, N, C, _;
    b.stopPropagation(), document.activeElement === s.current && b.key === "ArrowDown" || b.key === "ArrowRight" ? ((y = i.current) == null || y.focus(), l.current = !0) : document.activeElement === i.current && b.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), l.current = !1) : document.activeElement === i.current && b.key === "ArrowLeft" && ((C = i.current) == null ? void 0 : C.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), l.current = !1), c === "custom" && b.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && h(!1);
  };
...
const Zw = (t, e) => t === "f" ? /* @__PURE__ */ p(st, { children: [
  /* @__PURE__ */ r(Vo, {}),
  " ",
...
function Eu({
  ...
  Lt(() => {
    if (!f.current) return;
    const { width: R } = f.current.getBoundingClientRect();
    R > 0 && (f.current.style.width = `${R}px`);
  }, []);
  const [h, v] = S("generated"), [b, y] = S("*"), [N, C] = S("f"), [_, $] = S(!1), [j, O] = S(!0), [T, E] = S(!1), k = G(!1), M = G(""), [D, L] = S(!1), [V, W] = S(), [A, tt] = S(), [Et, B] = S(), [at, J] = S(), Z = G(null), H = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  q(() => {
    ...
    if (F && hn("note", F)) {
      ...
      let rt = "custom";
      pt === ir ? rt = "generated" : pt === lr ? rt = "hidden" : pt && y(pt), v(rt), C(((X = F.insert.note) == null ? void 0 : X.style) ?? "f"), R = setTimeout(() => {
        var _t;
  ...
  const dt = K(
    (R, F, Y = !1) => {
      ...
      if (X && hn("note", X)) {
        if (X.insert.note) {
          let mt;
          R === "custom" ? mt = F : R === "generated" ? mt = ir : mt = lr, X.insert.note.caller = mt;
        }
  ...
  const Ut = () => {
    var F;
    const R = (F = u.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    ...
    if (F && hn("note", F)) {
      ...
      N !== "x" && R === "x" ? mt == null || mt.forEach((Ot) => ad(Ot)) : N === "x" && R !== "x" && (mt == null || mt.forEach((Ot) => sd(Ot))), (_t = w.current) == null || _t.applyUpdate([F, { delete: 1 }]);
    }
  }, oe = (R) => {
    J(R.contextMarker), E(R.canRedo);
  }, Ze = K(
    (R) => {
      var Y, X, pt, rt, _t;
      const F = (X = (Y = w.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : X.at(0);
      if (F && hn("note", F)) {
        ...
        if (mt || $(!1), $(
          mt === "x" ? !!(Ot != null && Ot.every((Vt) => {
            ...
            const I = ((xt = Vt.attributes) == null ? void 0 : xt.char).style;
          ...
          k.current = !0, M.current = JSON.stringify(F), O(!0);
          return;
        }
        O(JSON.stringify(F) === M.current), dt(h, b);
      } else
        $(!1), O(!0);
    },
    [h, b, dt]
    ...
    if (m.current && wt.length && R && R.rangeCount > 0) {
      const F = R.getRangeAt(0).getBoundingClientRect(), Y = m.current.getBoundingClientRect();
      W(F.left - Y.left), tt(F.top - Y.top), B(F.height), L(!0);
    }
  }, [wt, m]);
  return q(() => {
    const R = () => {
    ...
    var R;
    D && ((R = Z.current) == null || R.focus());
  }, [D]), q(() => {
    var Y;
    const R = ((Y = u.current) == null ? void 0 : Y.querySelector(".editor-input")) ?? void 0, F = (X) => {
      !D && R && document.activeElement === R && X.key === l ? (X.preventDefault(), P()) : D && X.key === "Escape" && (X.preventDefault(), L(!1));
    };
    return document.addEventListener("keydown", F), () => {
      document.removeEventListener("keydown", F);
    };
  }, [D, P, l]), /* @__PURE__ */ p(st, { children: [
    /* @__PURE__ */ p("div", { ref: f, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(Xw, { editorRef: w, children: /* @__PURE__ */ r(
              Dl,
              {
                options: H,
                onStateChange: oe,
  ...
  return /* @__PURE__ */ p(st, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(st, { children: ld(t.marker, l, o, d) })
      }
    )
  ] });
}
function Ru({
  ...
  const w = c ?? _i(n, void 0), u = (N, C) => {
    d == null || d(N, C, a);
  }, m = i ? n.findIndex((N) => N === i) : -1, [f, h] = S(m), v = (N, C, _) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), d == null || d(C, _, a);
          break;
      }
  }, b = (N) => {
    if (n.length)
      switch (N.key) {
        case "ArrowDown":
          N.preventDefault(), h((C) => Math.min(C + 1, n.length - 1));
          break;
        case "ArrowUp":
          N.preventDefault(), h((C) => Math.max(C - 1, 0));
          break;
      }
  }, y = G([]);
  return q(() => {
        ...
        "ul",
        {
          ...
          children: n.map((N, C) => {
            ...
            return /* @__PURE__ */ p(st, { children: [
              ...
              C < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(Ft, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function Lu({
  ...
  const f = qt(n, "%webView_inventory_all%"), h = qt(n, "%webView_inventory_approved%"), v = qt(n, "%webView_inventory_unapproved%"), b = qt(n, "%webView_inventory_unknown%"), y = qt(n, "%webView_inventory_scope_currentBook%"), N = qt(n, "%webView_inventory_scope_chapter%"), C = qt(n, "%webView_inventory_scope_verse%"), _ = qt(n, "%webView_inventory_filter_text%"), $ = qt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = qt(n, "%webView_inventory_no_results%"), [O, T] = S(!1), [E, k] = S("all"), [M, D] = S(""), [L, V] = S([]), W = z(() => {
    const H = t ?? [];
  ...
  }, [O, W]), tt = z(() => A.length === 0 ? [] : hd(A, E, M), [A, E, M]), Et = z(() => {
    var dt, ut;
    if (!O) return c;
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ p(Fe, { onValueChange: (H) => at(H), defaultValue: s, children: [
        ...
        /* @__PURE__ */ p(Ie, { children: [
          ...
          /* @__PURE__ */ r(Pt, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Je,
...
const ns = x.forwardRef(
  ({
    ...
    const [d, w] = x.useState(t), u = e ?? d, m = x.useCallback(
      ...
      [n, u]
    ), f = x.useCallback(() => m((C) => !C), [m]), h = u ? "expanded" : "collapsed", y = gt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = x.useMemo(
      () => ({
        state: h,
        open: u,
        setOpen: m,
...
}, To = (t) => `${zd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Vu({
  sources: t,
  ...
  const [d, w] = S([]), [u, m] = S([{ id: ge, desc: !1 }]), [f, h] = S({}), v = z(
    () => t.flatMap((E) => E.data.map((k) => ({
      ...k,
      source: E.source
    }))),
    [t]
  ...
  q(() => {
    if (l) {
      const E = y.getSelectedRowModel().rowsById, k = Object.keys(E);
      if (k.length === 1) {
        const M = v.find((D) => To(D) === k[0]) || void 0;
        M && l(M);
      }
    }
  }, [f, v, l, y]);
  const N = a ?? Vd, C = i ?? cs, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [ge] },
    { label: `Group by ${C}`, value: [ke] },
    {
  ...
  }, O = (E, k) => E.getIsGrouped() ? "" : g("banded-row", k % 2 === 0 ? "even" : "odd"), T = (E, k, M) => {
    if (!((E == null ? void 0 : E.length) === 0 || k.depth < M.column.getGroupedIndex())) {
      if (k.getIsGrouped())
        switch (k.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ p("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ p($n, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Vn, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(ae, { children: E.headers.filter((k) => k.column.columnDef.header).map((k) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(wn, { colSpan: k.colSpan, className: "top-0 tw-sticky", children: k.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          rn(k.column.columnDef.header, k.getContext())
        ] }) }, k.id)
      )) }, E.id)) }),
      /* @__PURE__ */ r(jn, { children: y.getRowModel().rows.map((E, k) => {
        const M = gt();
        return /* @__PURE__ */ r(
          ae,
          {
            ...
            children: E.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== ke || !n)))
                return /* @__PURE__ */ r(
                  Te,
                  {
                    className: g(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ p(
                      U,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (M === "ltr" ? /* @__PURE__ */ r(Xt, {}) : /* @__PURE__ */ r(rr, {})),
                          " ",
                          rn(D.column.columnDef.cell, D.getContext()),
                          " (",
                          E.subRows.length,
                          ")"
                        ]
...
function Kd({
  ...
  const j = z(() => ht.allBookIds.filter(
    ...
    (V, W = !1) => {
      ...
      const A = j.findIndex((J) => J === _.current), tt = j.findIndex((J) => J === V);
      if (A === -1 || tt === -1) return;
      const [Et, B] = [
        Math.min(A, tt),
        Math.max(A, tt)
    ...
    T(V, $.current), $.current = !1;
  }, k = (V, W) => {
    V.preventDefault(), T(W, V.shiftKey);
  }, M = K(
    (V) => {
      const W = qr(j, V).map((A) => A);
      n(
        ws(j, V, e) ? e.filter((A) => !W.includes(A)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), D = () => {
            ...
            pe,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: D, children: c }),
                  /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: L, children: d })
                ] }),
                /* @__PURE__ */ p(ue, { children: [
                      ...
                      return /* @__PURE__ */ p(Do, { children: [
                        /* @__PURE__ */ r(
                          Jt,
                          {
                            ...
                            children: A.map((tt) => /* @__PURE__ */ r(
                              ha,
                              {
                                bookId: tt,
                                isSelected: e.includes(tt),
                                onSelect: () => E(tt),
                                onMouseDown: (Et) => k(Et, tt),
                                section: nn(tt),
                                showCheck: !0,
                                localizedBookNames: a,
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Ir,
        {
          ...
          children: y.map(({ value: N, label: C, id: _ }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Cn, { className: "tw-me-2", value: N, id: _ }),
            /* @__PURE__ */ r(yt, { htmlFor: _, children: C })
          ] }, _))
        }
      )
    ] }),
...
function Wd({
  ...
  if (Il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, u) => {
    var h, v, b, y;
    w.preventDefault();
    ...
    return /* @__PURE__ */ r(gs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w, u]) => /* @__PURE__ */ p(Gd, { children: [
...
function Wu({
  ...
  const d = Jd(
    ...
    var y, N, C, _, $, j;
    const b = v !== h ? ((N = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : N[v]) ?? ((_ = (C = t[h]) == null ? void 0 : C.uiNames) == null ? void 0 : _.en) : void 0;
...
Es.displayName = "Drawer";
const Ju = Bt.Trigger, Zd = Bt.Portal, Zu = Bt.Close, Ts = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Overlay,
  {
    ref: n,
...
Ts.displayName = Bt.Overlay.displayName;
const Rs = x.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, container: o, ...a }, i) => {
  const { direction: s = "bottom" } = x.useContext(Cs), l = o ? "tw-absolute" : "tw-fixed", c = {
  ...
  return /* @__PURE__ */ p(Zd, { container: o, children: [
    !o && /* @__PURE__ */ r(Ts, {}),
    /* @__PURE__ */ p(
      Bt.Content,
      {
...
const np = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Description,
  {
    ref: n,
    className: g("tw-text-sm tw-text-muted-foreground", t),
...
np.displayName = Bt.Description.displayName;
function Hr({
  items: t,
  renderItem: e,
  ...
  const [m, f] = S(), h = G(null), v = a ?? m, b = z(
    () => m ? t.find((k) => k.id === m) : void 0,
    [m, t]
  ), y = z(() => t.map((k) => ({ id: k.id })), [t]), N = (k) => {
    o == null || o(k), n && f(k.id === m ? void 0 : k.id);
  }, C = (k) => {
    const M = t.find((D) => D.id === k.id);
    M && N(M);
  }, { listboxRef: _, activeId: $, handleKeyDown: j, focusOption: O } = zr({
    options: y,
    onOptionSelect: C,
    onCharacterPress: w
  }), T = () => {
    const k = m;
    f(void 0), k && requestAnimationFrame(() => {
      var M;
      O(k), (M = _.current) == null || M.focus();
    });
  };
  if (s)
    return /* @__PURE__ */ r("div", { className: g("tw-flex tw-flex-col tw-gap-2 tw-p-2", u), children: Array.from({ length: 6 }, (k, M) => /* @__PURE__ */ r(
      dn,
      {
      ...
      children: t.map((k) => {
        ...
        return /* @__PURE__ */ r(
          "li",
          {
            ...
            onClick: () => N(k),
            onKeyDown: (D) => {
              (D.key === "Enter" || D.key === " ") && (D.preventDefault(), N(k));
            },
            className: g(
      ...
      Es,
      {
        ...
        children: /* @__PURE__ */ r(
          Rs,
          {
            ...
            children: /* @__PURE__ */ r("div", { className: "tw-h-full tw-overflow-y-auto tw-p-4", children: b && n(b, T) })
          }
        )
      }
    )
...
function em({
  ...
  const [m, f] = S(a), [h, v] = S(-1), b = G(null), y = G(null), [N, C] = S(!1), [_, $] = S(0);
  q(() => {
    const B = b.current;
    if (!B) return;
  ...
  const j = _ > 0 ? ip / _ * 100 : 20, O = _ > 0 ? lp / _ * 100 : 30;
  q(() => {
    var B;
  ...
  const T = K(
    ...
    [d]
  ), E = t.find((B) => B.id === m), k = E && !N, M = E && N, D = K(
    (B) => {
    ...
    (B) => {
      ...
      if (B.key === "ArrowDown") {
        ...
        if (Z === h) return;
        v(Z), N || D(t[Z]);
      } else (B.key === "Enter" || B.key === " ") && N && h >= 0 && (B.preventDefault(), D(t[h]));
    },
    [t, h, N, D, m]
  ), V = K(() => {
    const B = m;
  ...
  return /* @__PURE__ */ p("div", { className: g("tw-flex tw-h-full tw-flex-col tw-overflow-hidden", u), children: [
    ...
    /* @__PURE__ */ r("div", { ref: b, className: "tw-relative tw-flex tw-flex-1 tw-overflow-hidden", children: cp({
      showSideBySide: !!k,
      showFullDetail: !!M,
      listElement: Et,
      detailElement: E && n ? n(E, V) : void 0,
      listMinPct: j,
      detailMinPct: O,
      detailPanelRef: W
    }) })
...
function cp({
  ...
  return t && o !== void 0 ? /* @__PURE__ */ p(ap, { direction: "horizontal", children: [
...
function wp({
  ...
  var f, h, v;
  const o = G(null), a = G(null), [i, s] = S(0);
  q(() => {
    const b = o.current, y = a.current;
    if (!b || !y) return;
    const N = () => {
      const _ = b.clientWidth, $ = Array.from(y.children).filter(
        (k) => k instanceof HTMLElement
      );
      if ($.length === 0) return;
      if ($.reduce((k, M) => k + M.offsetWidth, 0) <= _ - 4) {
        s(0);
        return;
      }
      const O = $.map((k) => k.offsetWidth), T = t.length, E = 44;
      for (let k = 1; k < T; k += 1) {
        let M = E;
        if (k < T - 1) {
          M += O[0] ?? 0;
          for (let D = k + 1; D < T; D += 1) M += O[D] ?? 0;
        } else
          M += O[T - 1] ?? 0;
        if (M <= _ - 4) {
          s(k);
    ...
    return C.observe(b), N(), () => C.disconnect();
  }, [t]);
...
function Ss(t, e) {
  var n;
  return t.id === e ? !0 : ((n = t.children) == null ? void 0 : n.some((o) => Ss(o, e))) ?? !1;
}
function Ds({
  domains: t,
  currentPath: e,
  ...
  return /* @__PURE__ */ r("ul", { className: g("tw-space-y-0.5", { "tw-ml-3": a.length > 0 }), children: t.map((s) => {
    const l = [...a, s], c = s.id === n, d = s.children && s.children.length > 0, u = Ss(s, n) && s.id !== n, m = s.id === n;
    return /* @__PURE__ */ r(
      pp,
      {
        domain: s,
...
function up({ item: t, createLabel: e, createComplexLabel: n }) {
...
const mp = pn(({ className: t, ...e }, n) => /* @__PURE__ */ r(fi, { size: 35, className: g("tw-animate-spin", t), ...e, ref: n }));
...
), hp = x.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const bp = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: g("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
bp.displayName = "AlertDescription";
const lm = ct.Root, cm = ct.Trigger, wm = ct.Group, dm = ct.Portal, pm = ct.Sub, um = ct.RadioGroup, vp = x.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ct.SubTrigger,
  {
    ref: a,
    className: g(
...
vp.displayName = ct.SubTrigger.displayName;
const xp = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.SubContent,
  {
    ref: n,
    className: g(
...
xp.displayName = ct.SubContent.displayName;
const yp = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ct.Portal, { children: /* @__PURE__ */ r(
  ct.Content,
  {
    ref: n,
    className: g(
...
yp.displayName = ct.Content.displayName;
const Np = x.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ct.Item,
  {
    ref: o,
    className: g(
...
Np.displayName = ct.Item.displayName;
const kp = x.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ct.CheckboxItem,
  {
    ref: a,
    className: g(
...
kp.displayName = ct.CheckboxItem.displayName;
const _p = x.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ct.RadioItem,
  {
    ref: o,
    className: g(
...
_p.displayName = ct.RadioItem.displayName;
const Cp = x.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ct.Label,
  {
    ref: o,
    className: g(
...
Cp.displayName = ct.Label.displayName;
const Ep = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Separator,
  {
    ref: n,
...
Ep.displayName = ct.Separator.displayName;
function Tp({ className: t, ...e }) {
  return /* @__PURE__ */ r(
    "span",
    {
...
Tp.displayName = "ContextMenuShortcut";
...
export {
  ...
  wm as ContextMenuGroup,
  Np as ContextMenuItem,
  Cp as ContextMenuLabel,
  dm as ContextMenuPortal,
  um as ContextMenuRadioGroup,
  _p as ContextMenuRadioItem,
  Ep as ContextMenuSeparator,
  Tp as ContextMenuShortcut,
  pm as ContextMenuSub,
  xp as ContextMenuSubContent,
  vp as ContextMenuSubTrigger,
  cm as ContextMenuTrigger,
  zw as DataTable,
  $l as Dialog,
  cu as DialogClose,
  wa as DialogContent,
  ...
  em as ErDictionaryFilteredList,
  tm as ErDictionaryList,
  nm as ErEncyclopediaList,
  rm as ErMediaList,
  Kw as ErrorDump,
  yu as ErrorPopover,
  ...
  Qu as SOURCE_LANGUAGE_INDEXED_LIST_STRING_KEYS,
  Fu as ScopeSelector,
