import Zs, { jsx as s, jsxs as x, Fragment as ie } from "react/jsx-runtime";
import * as D from "react";
import T, { forwardRef as tr, useCallback as kt, useState as ut, useRef as ge, useEffect as ae, useLayoutEffect as aa, useMemo as Tt } from "react";
...
import { getChaptersForBook as Cl, deepEqual as lo, substring as Ol, formatScrRef as Or, compareScrRefs as Gr, scrRefToBBBCCCVVV as Rr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Rl, formatBytes as _l } from "platform-bible-utils";
...
import { useReactTable as li, getCoreRowModel as ci, getPaginationRowModel as Pl, getSortedRowModel as di, getFilteredRowModel as $l, flexRender as dn, getExpandedRowModel as Il, getGroupedRowModel as Al } from "@tanstack/react-table";
...
import { MenuItem as Bl, ListItemText as Vl, ListItemIcon as wi, Menu as zl, Grid as fi, List as Ll, IconButton as mi, Drawer as Fl, AppBar as Ul, Toolbar as Gl } from "@mui/material";
...
et($t, "Original", new $t(Gt.Original)), et($t, "Septuagint", new $t(Gt.Septuagint)), et($t, "Vulgate", new $t(Gt.Vulgate)), et($t, "English", new $t(Gt.English)), et($t, "RussianProtestant", new $t(Gt.RussianProtestant)), et($t, "RussianOrthodox", new $t(Gt.RussianOrthodox));
let ue = $t;
function sa(t, e) {
  const n = e[0];
...
const wo = wt.Root, Ni = wt.Trigger, lc = wt.Group, rh = wt.Portal, oh = wt.Sub, ah = wt.RadioGroup, cc = T.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  wt.SubTrigger,
  {
    ref: o,
    className: N(
...
function ih({ scrRef: t, handleSubmit: e }) {
  const [n, r] = ut(""), [o, a] = ut(
    ot.bookNumberToId(t.bookNum)
  ), [i, l] = ut(t.chapterNum ?? 0), [c, d] = ut(
    ot.bookNumberToId(t.bookNum)
  ), [p, f] = ut(!1), [w, g] = ut(p), b = ge(void 0), m = ge(void 0), h = ge(void 0), k = kt(
    (E) => bc(E).filter((j) => {
    ...
    gc.forEach((E) => {
      const j = n.match(E);
      if (j) {
        const [M, J = void 0, q = void 0] = j.slice(1), U = xc(M);
        (ot.isBookIdValid(M) || U) && v(
          U ?? M,
          !0,
          J ? parseInt(J, 10) : 1,
          q ? parseInt(q, 10) : 1
    ...
    if (c === o) {
      ...
      i + M <= 0 || i + M > en(c) ? l(0) : M !== 0 && (l(i + M), E.preventDefault());
    }
  };
  return ae(() => {
  ...
  }, [w]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(wo, { modal: !1, open: p, onOpenChange: S, children: [
    /* @__PURE__ */ s(Ni, { asChild: !0, children: /* @__PURE__ */ s(
      ql,
      {
        ...
        handleKeyDown: H,
        handleOnClick: () => {
          a(ot.bookNumberToId(t.bookNum)), d(ot.bookNumberToId(t.bookNum)), l(t.chapterNum > 0 ? t.chapterNum : 0), f(!0), b.current.focus();
        },
        onFocus: () => {
          C.current = !0;
        },
...
const Nc = Xe(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? He : "button", { className: N(Nc({ variant: e, size: n, className: t })), ref: a, ...o })
);
mt.displayName = "Button";
const kc = Xe(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Ht = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(si.Root, { ref: n, className: N("pr-twp", kc(), t), ...e }));
Ht.displayName = si.Root.displayName;
...
Si.displayName = mn.Root.displayName;
const Yr = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  mn.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ s(mn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ s(ri, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Yr.displayName = mn.Item.displayName;
const Ti = hn.Root, Ci = hn.Trigger, mo = T.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(hn.Portal, { children: /* @__PURE__ */ s(
  hn.Content,
  {
    ref: o,
    align: e,
...
mo.displayName = hn.Content.displayName;
...
function lh({
  ...
  const p = _r(d, "%webView_bookSelector_currentBook%"), f = _r(d, "%webView_bookSelector_choose%"), w = _r(d, "%webView_bookSelector_chooseBooks%"), [g, b] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), m = (h) => {
    b(h), t(h);
...
const gn = bt.Root, Ic = bt.Group, bn = bt.Value, De = T.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ x(
  bt.Trigger,
  {
    ref: r,
    className: N(
...
function Vc({
  ...
  var h;
  const [l, c] = ut([]), [d, p] = ut([]), [f, w] = ut({}), [g, b] = ut({}), m = li({
    data: e,
    columns: t,
    getCoreRowModel: ci(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ s($c, { table: m }),
    /* @__PURE__ */ x(ar, { stickyHeader: a, children: [
      /* @__PURE__ */ s(ir, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ s(oe, { children: k.headers.map((I) => /* @__PURE__ */ s(vn, { children: I.isPlaceholder ? void 0 : dn(I.column.columnDef.header, I.getContext()) }, I.id)) }, k.id)) }),
      /* @__PURE__ */ s(sr, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ s(
        oe,
        {
          onClick: () => i(k, m),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((I) => /* @__PURE__ */ s(Be, { children: dn(I.column.columnDef.cell, I.getContext()) }, I.id))
        },
        k.id
...
}, Uc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", $i = Xe(
...
), Gc = T.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  pi.Root,
  {
    ref: o,
...
Gc.displayName = pi.Root.displayName;
...
const Gn = T.forwardRef(({ className: t, children: e, variant: n, size: r, ...o }, a) => {
...
const lr = (t) => t === "asc" ? /* @__PURE__ */ s(ul, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(wl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(fl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ch = (t) => ({
  accessorKey: "item",
  ...
  return Lc(t).forEach((p) => {
    p.startsWith("\\id") && (i = Fc(p), l = 0, c = 0), p.startsWith("\\c") && (l = ca(p), c = 0), p.startsWith("\\v") && (c = ca(p), l === 0 && (l = e.chapterNum));
    let f = o.exec(p) ?? void 0;
    for (; f; ) {
      const w = [];
      f.forEach((h) => w.push(h));
      const g = f.index, b = a.find((h) => lo(h.items, w)), m = {
        reference: {
...
function wh({
  ...
  const f = Jt(n, "%webView_inventory_all%"), w = Jt(n, "%webView_inventory_approved%"), g = Jt(n, "%webView_inventory_unapproved%"), b = Jt(n, "%webView_inventory_unknown%"), m = Jt(n, "%webView_inventory_scope_currentBook%"), h = Jt(n, "%webView_inventory_scope_chapter%"), k = Jt(n, "%webView_inventory_scope_verse%"), I = Jt(n, "%webView_inventory_filter_text%"), C = Jt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = ut(!1), [$, z] = ut("all"), [H, O] = ut(""), [P, E] = ut([]), j = Tt(() => l ? r instanceof RegExp ? Yc(
    l,
    t,
    a,
    i,
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        gn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(je, { children: [
              ...
              /* @__PURE__ */ s(Ut, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ x(gn, { onValueChange: (y) => tt(y), defaultValue: c, children: [
        ...
        /* @__PURE__ */ x(je, { children: [
          ...
          /* @__PURE__ */ s(Ut, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ s(
        Ye,
      ...
      o && /* @__PURE__ */ x("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ s(Ht, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? C })
      ] })
    ] }),
...
function fh({
  ...
  const [d, p] = ut(!1), f = kt(
    ...
    var b;
    return n.length === 1 ? ((b = t.find((m) => m.value === n[0])) == null ? void 0 : b.label) ?? o : i || o;
  }, g = Tt(() => {
    if (!l)
      return t;
          ...
          return /* @__PURE__ */ x(
            yo,
            {
              ...
              children: [
                ...
                e && /* @__PURE__ */ s("div", { className: "tw-w-10 tw-text-right tw-text-muted-foreground", children: m })
              ]
            },
            b.value
          );
...
const Li = T.forwardRef(
  ({
    ...
    const [c, d] = T.useState(t), p = e ?? c, f = T.useCallback(
      ...
      [n, p]
    ), w = T.useCallback(() => f((m) => !m), [f]), g = p ? "expanded" : "collapsed", b = T.useMemo(
      () => ({
        state: g,
        open: p,
        setOpen: f,
...
function fd({
  ...
  return /* @__PURE__ */ s(
    Fi,
    {
      ...
      children: /* @__PURE__ */ x(Gi, { children: [
        /* @__PURE__ */ x(qr, { children: [
          /* @__PURE__ */ s(Kr, { className: "tw-text-sm tw-text-gray-400", children: a }),
          /* @__PURE__ */ s(Jr, { children: /* @__PURE__ */ s(Hi, { children: e.map((f) => /* @__PURE__ */ s(Xi, { children: /* @__PURE__ */ s(
            Yi,
            {
              className: N(
...
const ne = "scrBook", md = "scrRef", we = "source", hd = "details", gd = "Scripture Reference", bd = "Scripture Book", Wi = "Type", vd = "Details";
function yd(t, e) {
  const n = e ?? !1;
  return [
    {
...
function gh({
  ...
  const [d, p] = ut([]), [f, w] = ut([{ id: ne, desc: !1 }]), [g, b] = ut({}), m = Tt(
  ...
  ae(() => {
    if (l) {
      ...
      if (P.length === 1) {
        const E = m.find((j) => pa(j) === P[0]) || void 0;
        E && l(E);
      }
    }
  }, [g, m, l, k]);
  ...
  }, z = (O, P) => O.getIsGrouped() ? "" : N("banded-row", P % 2 === 0 ? "even" : "odd"), H = (O, P, E) => {
    if (!((O == null ? void 0 : O.length) === 0 || P.depth < E.column.getGroupedIndex())) {
      if (P.getIsGrouped())
        switch (P.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ x(
      gn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(je, { position: "item-aligned", children: /* @__PURE__ */ s(Ic, { children: S.map((O) => /* @__PURE__ */ s(Ut, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(ar, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(ir, { children: k.getHeaderGroups().map((O) => /* @__PURE__ */ s(oe, { children: O.headers.filter((P) => P.column.columnDef.header).map((P) => (
        ...
        /* @__PURE__ */ s(vn, { colSpan: P.colSpan, className: "top-0 tw-sticky", children: P.isPlaceholder ? void 0 : /* @__PURE__ */ x("div", { children: [
          ...
          " ",
          dn(P.column.columnDef.header, P.getContext())
        ] }) }, P.id)
      )) }, O.id)) }),
      /* @__PURE__ */ s(sr, { children: k.getRowModel().rows.map((O, P) => /* @__PURE__ */ s(
        oe,
        {
                  ...
                  children: (() => E.getIsGrouped() ? /* @__PURE__ */ x(
                    mt,
                    {
                      ...
                      children: [
                        ...
                        " ",
                        dn(E.column.columnDef.cell, E.getContext()),
                        " (",
                        O.subRows.length,
                        ")"
                      ]
...
function Sd() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = i, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = b, it.Memo = g, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = f, it.isAsyncMode = function(v) {
    return S(v) || C(v) === c;
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === a || v === o || v === f || v === w || typeof v == "object" && v !== null && (v.$$typeof === b || v.$$typeof === g || v.$$typeof === i || v.$$typeof === l || v.$$typeof === p || v.$$typeof === h || v.$$typeof === k || v.$$typeof === I || v.$$typeof === m);
  }, it.typeOf = C, it;
}
var st = {};
/** @license React v16.13.1
...
function Td() {
  return wa || (wa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(A) {
      ...
      A === r || A === d || A === a || A === o || A === f || A === w || typeof A == "object" && A !== null && (A.$$typeof === b || A.$$typeof === g || A.$$typeof === i || A.$$typeof === l || A.$$typeof === p || A.$$typeof === h || A.$$typeof === k || A.$$typeof === I || A.$$typeof === m);
    }
    function S(A) {
    ...
    var v = c, $ = d, z = l, H = i, O = e, P = p, E = r, j = b, M = g, J = n, q = a, U = o, tt = f, at = !1;
    function rt(A) {
    ...
    st.AsyncMode = v, st.ConcurrentMode = $, st.ContextConsumer = z, st.ContextProvider = H, st.Element = O, st.ForwardRef = P, st.Fragment = E, st.Lazy = j, st.Memo = M, st.Portal = J, st.Profiler = q, st.StrictMode = U, st.Suspense = tt, st.isAsyncMode = rt, st.isConcurrentMode = y, st.isContextConsumer = R, st.isContextProvider = L, st.isElement = F, st.isForwardRef = V, st.isFragment = W, st.isLazy = X, st.isMemo = Y, st.isPortal = G, st.isProfiler = K, st.isStrictMode = Z, st.isSuspense = dt, st.isValidElementType = C, st.typeOf = S;
  }()), st;
}
var fa;
function Ji() {
...
function Rd() {
  ...
  return Br = function(l, c) {
    ...
    function P() {
      function y(R, L, F, V, W) {
        return J(R[L]) ? null : new m("Invalid " + V + " `" + W + "` supplied to " + ("`" + F + "`, expected a ReactNode."));
      }
      return h(y);
    }
    function E(y, R, L, F, V) {
      return new m(
...
function jd() {
  ...
  return lt.ContextConsumer = i, lt.ContextProvider = a, lt.Element = t, lt.ForwardRef = c, lt.Fragment = n, lt.Lazy = w, lt.Memo = f, lt.Portal = e, lt.Profiler = o, lt.StrictMode = r, lt.Suspense = d, lt.SuspenseList = p, lt.isAsyncMode = function() {
    ...
    return typeof h == "string" || typeof h == "function" || h === n || h === o || h === r || h === d || h === p || h === g || typeof h == "object" && h !== null && (h.$$typeof === w || h.$$typeof === f || h.$$typeof === a || h.$$typeof === i || h.$$typeof === c || h.$$typeof === b || h.getModuleId !== void 0);
  }, lt.typeOf = m, lt;
}
var ct = {};
/**
...
function Bd() {
  return Na || (Na = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), b = !1, m = !1, h = !1, k = !1, I = !1, C;
    C = Symbol.for("react.module.reference");
    function S(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === n || B === o || I || B === r || B === d || B === p || k || B === g || b || m || h || typeof B == "object" && B !== null && (B.$$typeof === w || B.$$typeof === f || B.$$typeof === a || B.$$typeof === i || B.$$typeof === c || // This needs to include all possible module reference object
    ...
    var $ = i, z = a, H = t, O = c, P = n, E = w, j = f, M = e, J = o, q = r, U = d, tt = p, at = !1, rt = !1;
    function y(B) {
    ...
    ct.ContextConsumer = $, ct.ContextProvider = z, ct.Element = H, ct.ForwardRef = O, ct.Fragment = P, ct.Lazy = E, ct.Memo = j, ct.Portal = M, ct.Profiler = J, ct.StrictMode = q, ct.Suspense = U, ct.SuspenseList = tt, ct.isAsyncMode = y, ct.isConcurrentMode = R, ct.isContextConsumer = L, ct.isContextProvider = F, ct.isElement = V, ct.isForwardRef = W, ct.isFragment = X, ct.isLazy = Y, ct.isMemo = G, ct.isPortal = K, ct.isProfiler = Z, ct.isStrictMode = dt, ct.isSuspense = A, ct.isSuspenseList = xt, ct.isValidElementType = S, ct.typeOf = v;
  }()), ct;
}
...
const Fd = u.oneOfType([u.func, u.object]), rs = Fd;
function Wt(t) {
  if (typeof t != "string")
...
const qd = typeof window < "u" ? D.useLayoutEffect : D.useEffect, ze = qd;
let Sa = 0;
function Kd(t) {
...
function wp(t) {
  ...
  function d(w, g) {
    const b = i.indexOf(g);
    return `@media (min-width:${typeof e[w] == "number" ? e[w] : w}${n}) and (max-width:${(b !== -1 && typeof e[i[b]] == "number" ? e[i[b]] : g) - r / 100}${n})`;
  }
  function p(w) {
...
function us(t, e) {
  const n = ps(t.theme);
  return Object.keys(t).map((r) => Sp(t, e, r, n)).reduce(un, {});
}
function ht(t) {
  return us(t, wr);
}
...
const Cp = zt("border", Dt), Op = zt("borderTop", Dt), Rp = zt("borderRight", Dt), _p = zt("borderBottom", Dt), Pp = zt("borderLeft", Dt), $p = zt("borderColor"), Ip = zt("borderTopColor"), Ap = zt("borderRightColor"), Mp = zt("borderBottomColor"), Dp = zt("borderLeftColor"), jp = zt("outline", Dt), Bp = zt("outlineColor"), hr = (t) => {
...
mr(gr, br, vr, Vp, zp, Lp, Fp, Up, Gp, Hp, Xp, Yp);
function Me(t, e) {
  return e === "grey" ? e : t;
}
const Wp = vt({
...
function iu() {
  function t(n, r, o, a) {
    ...
    const w = ur(o, d) || {};
    return f ? f(i) : Qt(i, r, (b) => {
      let m = Kn(w, p, b);
      return b === m && typeof b == "string" && (m = Kn(w, p, `${n}${b === "default" ? "" : Wt(b)}`, b)), c === !1 ? m : {
        [c]: m
      };
    });
  }
...
function Po(t = {}, ...e) {
  ...
  return d.applyStyles = su, d = e.reduce((p, f) => Zt(p, f), d), d.unstable_sxConfig = _({}, Ro, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return _o({
      sx: f,
      theme: this
    });
...
function bu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    jl(i, (v) => v.filter(($) => !($ != null && $.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const I = Ml(i, _({
      shouldForwardProp: k,
      label: h
    }, g)), C = (v) => typeof v == "function" && v.__emotion_real !== v || he(v) ? ($) => Xn(v, _({}, $, {
      theme: zn({
        theme: $.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let E;
        c && (E = `${c}${Wt(d || "")}`), E === void 0 && (E = `Styled(${Ld(i)})`), P.displayName = E;
      }
...
function $a(t) {
  t = Ne(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Ne(Nu(t)).values : t.values;
...
function hs(t, e) {
  return t = Ne(t), e = $o(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, yr(t);
}
function ku(t, e) {
  if (t = Ne(t), e = $o(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
const Tu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, $e = Au, Mu = ["mode", "contrastThreshold", "tonalOffset"], Aa = {
...
function Fu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Nt(t, Mu), a = t.primary || Du(e), i = t.secondary || ju(e), l = t.error || Bu(e), c = t.info || Vu(e), d = t.success || zu(e), p = t.warning || Lu(e);
  function f(m) {
    const h = Ia(m, Lr.text.primary) >= n ? Lr.text.primary : Aa.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Ia(m, h);
...
The color object needs to have a \`main\` property or a \`${k}\` property.` : Ve(11, h ? ` (${h})` : "", k));
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ma(m, "light", I, r), Ma(m, "dark", C, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, g = {
    dark: Lr,
    light: Aa
  };
...
function Hu(t, e) {
  ...
  const g = o / 14, b = f || ((k) => `${k / d * g}rem`), m = (k, I, C, S, v) => _({
    fontFamily: r,
    fontWeight: k,
    fontSize: b(I),
    ...
    button: m(l, 14, 1.75, 0.4, Da),
    caption: m(i, 12, 1.66, 0.4),
    overline: m(i, 12, 2.66, 1, Da),
...
`));
  ...
  return d.unstable_sxConfig = _({}, Ro, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return _o({
      sx: f,
      theme: this
    });
...
const dw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], pw = (t) => {
  ...
  const r = Mo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = Nt(r, dw), b = /* @__PURE__ */ D.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
function Tw(t) {
  ...
  if (!e) {
    const g = be(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), b = _({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), m = _({}, n, o, r);
    return g.length > 0 && (m.className = g), Object.keys(b).length > 0 && (m.style = b), {
      props: m,
      internalRef: void 0
    };
  }
  const i = Ew(_({}, o, r)), l = La(r), c = La(o), d = e(i), p = be(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
var Ct = "top", Bt = "bottom", Vt = "right", Ot = "left", jo = "auto", Pn = [Ct, Bt, Vt, Ot], Le = "start", Nn = "end", Iw = "clippingParents", xs = "viewport", rn = "popper", Aw = "reference", Fa = /* @__PURE__ */ Pn.reduce(function(t, e) {
  return t.concat([e + "-" + Le, e + "-" + Nn]);
}, []), Ns = /* @__PURE__ */ [].concat(Pn, [jo]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Le, e + "-" + Nn]);
}, []), Mw = "beforeRead", Dw = "read", jw = "afterRead", Bw = "beforeMain", Vw = "main", zw = "afterMain", Lw = "beforeWrite", Fw = "write", Uw = "afterWrite", Gw = [Mw, Dw, jw, Bw, Vw, zw, Lw, Fw, Uw];
function qt(t) {
...
var ve = Math.max, Zn = Math.min, Fe = Math.round;
function no() {
...
function Ue(t, e, n) {
  ...
  var i = ke(t) ? At(t) : window, l = i.visualViewport, c = !ks() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function qw(t) {
  ...
  var o = xr(t);
  for (Bo(o) && (o = o.host); jt(o) && ["html", "body"].indexOf(qt(o)) < 0; ) {
    var a = te(o);
...
function $n(t) {
  for (var e = At(t), n = Ua(t); n && Ww(n) && te(n).position === "static"; )
    n = Ua(n);
...
function Zw(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Xt(n.placement), c = zo(l), d = [Ot, Vt].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var f = Jw(o.padding, n), w = Vo(a), g = c === "y" ? Ct : Ot, b = c === "y" ? Bt : Vt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = $n(a), I = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, S = f[g], v = I - w[p] - f[b], $ = I / 2 - w[p] / 2 + C, z = wn(S, $, v), H = c;
...
function Ga(t) {
  var e, n = t.popper, r = t.popperRect, o = t.placement, a = t.variation, i = t.offsets, l = t.position, c = t.gpuAcceleration, d = t.adaptive, p = t.roundOffsets, f = t.isFixed, w = i.x, g = w === void 0 ? 0 : w, b = i.y, m = b === void 0 ? 0 : b, h = typeof p == "function" ? p({
    x: g,
    y: m
  }) : {
    x: g,
  ...
  if (d) {
    var $ = $n(n), z = "clientHeight", H = "clientWidth";
    if ($ === At(n) && ($ = le(n), te($).position !== "static" && l === "absolute" && (z = "scrollHeight", H = "scrollWidth")), $ = $, o === Ct || (o === Ot || o === Vt) && a === Nn) {
      S = Bt;
      var O = f && $ === v && v.visualViewport ? v.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        $[z]
      );
      m -= O - r.height, m *= c ? 1 : -1;
    }
    if (o === Ot || (o === Ct || o === Bt) && a === Nn) {
      C = Vt;
      var P = f && $ === v && v.visualViewport ? v.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        $[H]
      );
      g -= P - r.width, g *= c ? 1 : -1;
  ...
  if (g = j.x, m = j.y, c) {
    var M;
    return Object.assign({}, E, (M = {}, M[S] = I ? "0" : "", M[C] = k ? "0" : "", M.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", M));
  }
  return Object.assign({}, E, (e = {}, e[S] = I ? m + "px" : "", e[C] = k ? g + "px" : "", e.transform = "", e));
}
function rf(t) {
  ...
  e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, Ga(Object.assign({}, d, {
    offsets: e.modifiersData.popperOffsets,
    position: e.options.strategy,
    adaptive: i,
    roundOffsets: c
  })))), e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, Ga(Object.assign({}, d, {
...
function Fo(t) {
  return Ue(le(t)).left + Lo(t).scrollLeft;
}
function df(t, e) {
...
function pf(t) {
  var e, n = le(t), r = Lo(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = ve(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = ve(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Fo(t), c = -r.scrollTop;
...
function Os(t) {
  return ["html", "body", "#document"].indexOf(qt(t)) >= 0 ? t.ownerDocument.body : jt(t) && Uo(t) ? t : Os(xr(t));
}
function fn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Os(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = At(r), i = o ? [a].concat(a.visualViewport || [], Uo(r) ? r : []) : r, l = e.concat(i);
  return o ? l : (
...
function Xa(t, e, n) {
  return e === xs ? ro(df(t, n)) : ke(e) ? uf(e, n) : ro(pf(le(t)));
}
function wf(t) {
  var e = fn(xr(t)), n = ["absolute", "fixed"].indexOf(te(t).position) >= 0, r = n && jt(t) ? $n(t) : t;
  return ke(r) ? e.filter(function(o) {
    return ke(o) && Es(o, r) && qt(o) !== "body";
  }) : [];
}
function ff(t, e, n, r) {
...
function kn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Iw : l, d = n.rootBoundary, p = d === void 0 ? xs : d, f = n.elementContext, w = f === void 0 ? rn : f, g = n.altBoundary, b = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Ts(typeof h != "number" ? h : Cs(h, Pn)), I = w === rn ? Aw : rn, C = t.rects.popper, S = t.elements[b ? I : w], v = ff(ke(S) ? S : S.contextElement || le(t.elements.popper), c, p, i), $ = Ue(t.elements.reference), z = Rs({
    reference: $,
    element: C,
    strategy: "absolute",
    placement: o
  }), H = ro(Object.assign({}, C, z)), O = w === rn ? H : $, P = {
  ...
  if (w === rn && E) {
    ...
    Object.keys(P).forEach(function(M) {
      var J = [Vt, Bt].indexOf(M) >= 0 ? 1 : -1, q = [Ct, Bt].indexOf(M) >= 0 ? "y" : "x";
      P[M] += j[q] * J;
    });
  }
  return P;
...
function mf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ns : c, p = Ge(r), f = p ? l ? Fa : Fa.filter(function(b) {
    return Ge(b) === p;
  }) : Pn, w = f.filter(function(b) {
...
function gf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, b = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Xt(h), I = k === h, C = c || (I || !b ? [Yn(h)] : hf(h)), S = [h].concat(C).reduce(function(V, W) {
      return V.concat(Xt(W) === jo ? mf(e, {
        placement: W,
        boundary: p,
        rootBoundary: f,
        padding: d,
    ...
    }, []), v = e.rects.reference, $ = e.rects.popper, z = /* @__PURE__ */ new Map(), H = !0, O = S[0], P = 0; P < S.length; P++) {
      var E = S[P], j = Xt(E), M = Ge(E) === Le, J = [Ct, Bt].indexOf(j) >= 0, q = J ? "width" : "height", U = kn(e, {
        placement: E,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
        padding: d
      }), tt = J ? M ? Vt : Ot : M ? Bt : Ct;
      v[q] > $[q] && (tt = Yn(tt));
      var at = Yn(tt), rt = [];
...
function Wa(t) {
  return [Ct, Vt, Bt, Ot].some(function(e) {
    return t[e] >= 0;
  });
}
function vf(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, i = kn(e, {
    ...
    altBoundary: !0
  }), c = Ya(i, r), d = Ya(l, o, a), p = Wa(c), f = Wa(d);
  e.modifiersData[n] = {
...
function xf(t, e, n) {
  ...
  return i = i || 0, l = (l || 0) * o, [Ot, Vt].indexOf(r) >= 0 ? {
    x: l,
    y: i
  } : {
    x: i,
...
function Nf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, i = Ns.reduce(function(p, f) {
    return p[f] = xf(f, e.rects, a), p;
...
function Cf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, b = n.tetherOffset, m = b === void 0 ? 0 : b, h = kn(e, {
    boundary: c,
    rootBoundary: d,
    padding: f,
    altBoundary: p
  }), k = Xt(e.placement), I = Ge(e.placement), C = !I, S = zo(k), v = Tf(S), $ = e.modifiersData.popperOffsets, z = e.rects.reference, H = e.rects.popper, O = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, P = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if ($) {
    if (a) {
      var M, J = S === "y" ? Ct : Ot, q = S === "y" ? Bt : Vt, U = S === "y" ? "height" : "width", tt = $[S], at = tt + h[J], rt = tt - h[q], y = g ? -H[U] / 2 : 0, R = I === Le ? z[U] : H[U], L = I === Le ? -H[U] : -z[U], F = e.elements.arrow, V = g && F ? Vo(F) : {
        width: 0,
        height: 0
      }, W = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Ss(), X = W[J], Y = W[q], G = wn(0, z[U], V[U]), K = C ? z[U] / 2 - y - G - X - P.mainAxis : R - G - X - P.mainAxis, Z = C ? -z[U] / 2 + y + G + Y + P.mainAxis : L + G + Y + P.mainAxis, dt = e.elements.arrow && $n(e.elements.arrow), A = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, xt = (M = E == null ? void 0 : E[S]) != null ? M : 0, B = tt + K - xt - A, yt = tt + Z - xt, Lt = wn(g ? Zn(at, B) : at, tt, g ? ve(rt, yt) : rt);
      $[S] = Lt, j[S] = Lt - tt;
    }
    if (l) {
      var ce, Et = S === "x" ? Ct : Ot, An = S === "x" ? Bt : Vt, Ft = $[v], Ee = v === "y" ? "height" : "width", de = Ft + h[Et], Se = Ft - h[An], Te = [Ct, Ot].indexOf(k) !== -1, Ce = (ce = E == null ? void 0 : E[v]) != null ? ce : 0, pe = Te ? de : Ft - z[Ee] - H[Ee] - Ce + P.altAxis, qe = Te ? Ft + z[Ee] + H[Ee] - Ce - P.altAxis : Se, Mn = g && Te ? Kw(pe, Ft, qe) : wn(g ? pe : de, Ft, g ? qe : Se);
      $[v] = Mn, j[v] = Mn - Ft;
    }
    e.modifiersData[r] = j;
  }
...
function $f(t, e, n) {
  n === void 0 && (n = !1);
  var r = jt(e), o = jt(e) && Pf(e), a = le(e), i = Ue(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Uo(a)) && (l = _f(e)), jt(e) ? (c = Ue(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Fo(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        m(), p.options = Object.assign({}, a, p.options, I), p.scrollParents = {
        ...
        if (!w) {
          ...
          if (Ka(I, C)) {
            ...
            for (var S = 0; S < p.orderedModifiers.length; S++) {
              ...
              var v = p.orderedModifiers[S], $ = v.fn, z = v.options, H = z === void 0 ? {} : z, O = v.name;
              typeof $ == "function" && (p = $({
                state: p,
                options: H,
                name: O,
...
Pw(_s, ["root"]);
const Lf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Ff = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Uf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Hf = () => To({
  ...
  } = e, h = Nt(e, Lf), k = D.useRef(null), I = xe(k, n), C = D.useRef(null), S = xe(C, w), v = D.useRef(S);
  ze(() => {
    v.current = S;
  }, [S]), D.useImperativeHandle(w, () => C.current, []);
  const $ = Uf(p, i), [z, H] = D.useState($), [O, P] = D.useState(Qn(o));
  D.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, I = Nt(e, Ff), [C, S] = D.useState(!0), v = () => {
    S(!1);
  }, $ = () => {
    S(!0);
  };
  ...
  if (a)
    ...
    const P = Qn(r);
    z = P && Nr(P) ? Wn(P).body : Wn(null).body;
  }
  const H = !p && c && (!m || C) ? "none" : void 0, O = m ? {
    in: p,
    onEnter: v,
    onExited: $
  } : void 0;
...
var Kf = function(e) {
  return e.scrollTop;
}, cn = "unmounted", fe = "exited", me = "entering", Ae = "entered", ao = "exiting", ee = /* @__PURE__ */ function(t) {
  Wf(e, t);
  function e(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Bn.findDOMNode(this), l], d = c[0], p = c[1], f = this.getTimeouts(), w = l ? f.appear : f.enter;
    if (!o && !i || Ja.disabled) {
      this.safeSetState({
        status: Ae
      }, function() {
...
const tm = {
...
}, Fr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Go = /* @__PURE__ */ D.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = Nt(e, Qf), I = sn(), C = D.useRef(), S = $s(), v = D.useRef(null), $ = xe(v, a.ref, n), z = (q) => (U) => {
    if (q) {
      const tt = v.current;
    ...
    let y;
    m === "auto" ? (y = S.transitions.getAutoHeightDuration(q.clientHeight), C.current = y) : y = tt, q.style.transition = [S.transitions.create("opacity", {
      duration: y,
      delay: at
    ...
    let rt;
    m === "auto" ? (rt = S.transitions.getAutoHeightDuration(q.clientHeight), C.current = rt) : rt = U, q.style.transition = [S.transitions.create("opacity", {
      duration: rt,
      delay: tt
    }), S.transitions.create("transform", {
  ...
  return /* @__PURE__ */ s(h, _({
    ...
    onExiting: E,
    addEndListener: (q) => {
      m === "auto" && I.start(C.current || 0, q), r && r(v.current, q);
    },
...
Go.muiSupportAuto = !0;
const Qa = Go, em = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], nm = _n(Ps, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = fs(), a = Mo({
    ...
    slots: C,
    slotProps: S
  } = a, v = Nt(a, em), $ = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, z = _({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const om = ds("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), re = om, am = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function im(t) {
  return Math.round(t * 1e5) / 1e5;
}
const sm = (t) => {
...
const Ds = /* @__PURE__ */ D.forwardRef(function(e, n) {
  var r, o, a, i, l, c, d, p, f, w, g, b, m, h, k, I, C, S, v;
  const $ = Mo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: xt
  } = $, B = Nt($, am), yt = /* @__PURE__ */ D.isValidElement(H) ? H : /* @__PURE__ */ s("span", {
    children: H
  }), Lt = $s(), ce = Lt.direction === "rtl", [Et, An] = D.useState(), [Ft, Ee] = D.useState(null), de = D.useRef(!1), Se = J || rt, Te = sn(), Ce = sn(), pe = sn(), qe = sn(), [Mn, Ho] = as({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Xo = (Q) => {
    ...
    (Q) => {
      ti.start(800 + R, () => {
        Fn = !1;
      }), Ho(!1), F && Kt && F(Q), Te.start(Lt.transitions.duration.shortest, () => {
        de.current = !1;
      });
    }
  ), Er = (Q) => {
    de.current && Q.type !== "touchstart" || (Et && Et.removeAttribute("title"), Ce.clear(), pe.clear(), U || Fn && tt ? Ce.start(Fn ? tt : U, () => {
      Xo(Q);
    }) : Xo(Q));
  }, Yo = (Q) => {
    Ce.clear(), pe.start(R, () => {
    ...
    Et || An(Q.currentTarget), Ls(Q), Wo.current === !0 && (qo(!0), Er(Q));
  }, Zo = (Q) => {
    de.current = !0;
    const Pt = yt.props;
    Pt.onTouchStart && Pt.onTouchStart(Q);
  }, Qo = Er, ta = Yo, Us = (Q) => {
    Zo(Q), pe.clear(), Te.clear(), Dn(), Ke.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", qe.start(at, () => {
      document.body.style.WebkitUserSelect = Ke.current, Er(Q);
    });
  }, Gs = (Q) => {
    yt.props.onTouchEnd && yt.props.onTouchEnd(Q), Dn(), pe.start(L, () => {
      jn(Q);
    });
  };
  D.useEffect(() => {
  ...
  E ? (Je.title = !Kt && Tr && !M ? dt : null, Je["aria-describedby"] = Kt ? kr : null) : (Je["aria-label"] = Tr ? dt : null, Je["aria-labelledby"] = Kt && !Tr ? kr : null);
  const Mt = _({}, Je, B, yt.props, {
...
`));
  ...
  const Ze = {};
  q || (Mt.onTouchStart = Us, Mt.onTouchEnd = Gs), M || (Mt.onMouseOver = Un(Qo, Mt.onMouseOver), Mt.onMouseLeave = Un(ta, Mt.onMouseLeave), Se || (Ze.onMouseOver = Qo, Ze.onMouseLeave = ta)), j || (Mt.onFocus = Un(Jo, Mt.onFocus), Mt.onBlur = Un(Ko, Mt.onBlur), Se || (Ze.onFocus = Jo, Ze.onBlur = Ko)), process.env.NODE_ENV !== "production" && yt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${yt.props.title}\` or the Tooltip component.`].join(`
`));
  const Ys = D.useMemo(() => {
    var Q;
    let Pt = [{
    ...
    return (Q = G.popperOptions) != null && Q.modifiers && (Pt = Pt.concat(G.popperOptions.modifiers)), _({}, G.popperOptions, {
      modifiers: Pt
    });
  }, [Ft, G]), Qe = _({}, $, {
    isRtl: ce,
    ...
    touch: de.current
  }), Cr = sm(Qe), ea = (r = (o = Z.popper) != null ? o : O.Popper) != null ? r : lm, na = (a = (i = (l = Z.transition) != null ? l : O.Transition) != null ? i : A) != null ? a : Qa, ra = (c = (d = Z.tooltip) != null ? d : O.Tooltip) != null ? c : cm, oa = (p = (f = Z.arrow) != null ? f : O.Arrow) != null ? p : dm, Ws = ln(ea, _({}, G, (w = K.popper) != null ? w : P.popper, {
    className: be(Cr.popper, G == null ? void 0 : G.className, (g = (b = K.popper) != null ? b : P.popper) == null ? void 0 : g.className)
  }), Qe), qs = ln(na, _({}, xt, (m = K.transition) != null ? m : P.transition), Qe), Ks = ln(ra, _({}, (h = K.tooltip) != null ? h : P.tooltip, {
    className: be(Cr.tooltip, (k = (I = K.tooltip) != null ? I : P.tooltip) == null ? void 0 : k.className)
  }), Qe), Js = ln(oa, _({}, (C = K.arrow) != null ? C : P.arrow, {
    className: be(Cr.arrow, (S = (v = K.arrow) != null ? v : P.arrow) == null ? void 0 : S.className)
  }), Qe);
    ...
    children: [/* @__PURE__ */ D.cloneElement(yt, Mt), /* @__PURE__ */ s(ea, _({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(ra, _({}, Ks, {
          children: [dt, z ? /* @__PURE__ */ s(oa, _({}, Js, {
            ref: Ee
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Bl,
    {
      ...
      children: n ? /* @__PURE__ */ x(ie, { children: [
        ...
        f ? /* @__PURE__ */ s(wi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(bs, {}) }) : ei(i, n, !1)
      ] }) : h
    }
  );
...
function vm({
  ...
  ae(() => {
    if (c) {
      ...
      if (S) {
        const v = S.getBoundingClientRect(), $ = window.scrollY, z = window.scrollX, H = v.top + $ + S.clientHeight, O = v.left + z;
        h({ top: H, left: O });
      }
    }
  }, [c, o]);
...
function Th({ className: t, variant: e, ...n }) {
...
Pm.displayName = an.Root.displayName;
...
const Oh = _t.Root, Im = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  _t.List,
  {
    ref: n,
    className: N(
...
function Rh({
  ...
  return /* @__PURE__ */ s(
    mt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ s(In, { size: 15 }) : /* @__PURE__ */ x(ie, { children: [
...
export {
  ...
  N as cn,
  Fc as getBookNumFromId,
  Lc as getLinesFromUSFM,
  ca as getNumberFromUSFM,
  Uc as getStatusForItem,
