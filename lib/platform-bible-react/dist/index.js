...
var Mt = (t, e, r) => Bi(t, typeof e != "symbol" ? e + "" : e, r);
import { r as jt, Z as Ui, B as F, c as m, a as Ki, C as Ce, P as Ee, b as Me, d as Te, e as Ae, f as Ie, g as we, h as kr, i as Zr, T as Qt, S as Qe, j as te, k as ee, l as re, D as Ue, m as br, n as xe, o as ye, p as ke, u as qi, q as _r, s as qe, t as Re, v as _a, w as ln, x as Gi, y as Hi, z as dn, A as wn, E as Yi, F as Wi, G as Xi, H as Ji, I as ia, J as sa, K as Qr, L as Zi, M as Qi, N as ts, O as es, Q as rs, R as Nr, U as Ba } from "./resizable-CUvCloPJ.js";
import { V as Xh, W as Jh, X as Zh, Y as Qh, _ as tg, $ as eg, a0 as rg, a1 as ag, a2 as og } from "./resizable-CUvCloPJ.js";
import { jsx as a, jsxs as u, Fragment as st } from "react/jsx-runtime";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as Or, Section as Z, getChaptersForBook as as, formatScrRef as me, getSectionForBook as fr, formatRelativeDate as os, formatReplacementString as Ke, sanitizeHtml as ns, NumberFormat as is, formatBytes as ss, getCurrentLocale as cs, usfmMarkers as Vr, getFormatCallerFunction as ls, deepEqual as ds, isString as fo, compareScrRefs as Na, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as ws, getLocalizeKeyForScrollGroupId as mo } from "platform-bible-utils";
import { Check as Ge, Clock as vo, ChevronsLeft as bo, ChevronsRight as xo, ChevronLeft as Ca, ChevronRight as Ea, ArrowLeft as us, ArrowRight as ps, ChevronDown as tr, BoldIcon as hs, ItalicIcon as gs, X as ta, AtSign as un, Pencil as fs, Trash2 as ms, ArrowUp as pn, MoreHorizontal as vs, MailOpen as bs, Mail as xs, ChevronUp as ys, FilterIcon as ks, ArrowLeftIcon as _s, ChevronLeftIcon as Ns, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as hn, Filter as Ts, User as zs, Link as Ss, CircleHelp as Ds, ChevronsUpDown as gn, Star as $s, Undo as Os, Redo as Rs, SquareX as fn, FunctionSquare as mn, SquareSigma as vn, Ban as Ms, AlertCircle as Ta, CircleCheckIcon as As, CircleXIcon as Is, CircleHelpIcon as Ps, ArrowUpIcon as Vs, ArrowDownIcon as Ls, ScrollText as Fs, Search as js, MenuIcon as Bs, Menu as Us, EllipsisVertical as Ks, MoreVertical as yo, LoaderCircle as qs } from "lucide-react";
import ut, { useRef as q, useMemo as B, useState as C, useCallback as P, useEffect as Y, useLayoutEffect as Xt, createContext as Ua, useContext as bn, Component as Gs, createElement as ko, Suspense as Hs, forwardRef as ea, Fragment as xn } from "react";
import { Dialog as ue, Label as Ys, RadioGroup as za, ToggleGroup as yn, Slot as ir, Avatar as Ka, Select as It, Checkbox as _o, Tabs as se, Menubar as ge, ContextMenu as St, Progress as No, Slider as Rr, Switch as Co } from "radix-ui";
import { createEditor as kn, $getRoot as _e, $createParagraphNode as sr, $getSelection as Ft, HISTORY_MERGE_TAG as qa, ParagraphNode as _n, TextNode as Nn, $isTokenOrSegmented as Ws, $getCharacterOffsets as Xs, $cloneWithPropertiesEphemeral as Js, $getPreviousSelection as Zs, $isRangeSelection as pe, $caretFromPoint as Qs, $getSiblingCaret as Cn, $getChildCaret as tc, $getAdjacentChildCaret as ec, $isChildCaret as rc, $normalizeCaret as ac, $setSelectionFromCaretRange as oc, $getCollapsedCaretRange as nc, $getCaretInDirection as Eo, $splitAtPointCaretNext as ic, $isTextPointCaret as sc, $findMatchingParent as En, $isElementNode as ve, mergeRegister as Ne, getDOMTextNode as cc, isHTMLElement as Tn, CLEAR_EDITOR_COMMAND as zn, COMMAND_PRIORITY_EDITOR as Ga, shallowMergeConfig as lc, defineExtension as ae, safeCast as He, createState as dc, FORMAT_TEXT_COMMAND as Sn, $isNodeSelection as Dn, COMMAND_PRIORITY_LOW as $n, RootNode as wc, LineBreakNode as uc, TabNode as pc, $isEditorState as hc, createCommand as gc, CLICK_COMMAND as fc, isDOMNode as mc, $getNodeFromDOMNode as vc, $createNodeSelection as bc, $setSelection as xc, $getEditor as yc, DecoratorNode as Sa, $getState as kc, toggleTextFormatType as To, TEXT_TYPE_TO_FORMAT as _c, $setState as Nc, addClassNamesToElement as On, $create as Cc, $getNodeByKey as Ec, removeClassNamesFromElement as Tc, KEY_TAB_COMMAND as zc, $isBlockElementNode as Ur, $createRangeSelection as Sc, $normalizeSelection__EXPERIMENTAL as Dc, OUTDENT_CONTENT_COMMAND as $c, INDENT_CONTENT_COMMAND as zo, INSERT_TAB_COMMAND as Oc, COMMAND_PRIORITY_CRITICAL as Ha, $isDecoratorNode as Rc, $isParagraphNode as Mc, $isTextNode as Kr, SELECTION_CHANGE_COMMAND as Rn, getRegisteredNode as Ac, isDocumentFragment as So, isDOMDocumentNode as Ic, ArtificialNode__DO_NOT_USE as Mn, $createLineBreakNode as An, $isRootOrShadowRoot as Pc, isBlockDomNode as Do, isInlineDomNode as $o, $insertNodes as Vc } from "lexical";
import { HeadingNode as Lc, QuoteNode as Fc, registerRichText as jc } from "@lexical/rich-text";
import { flushSync as Bc, createPortal as Uc } from "react-dom";
import { IconX as Kc, IconCheck as ra, IconChevronDown as qc, IconChevronUp as Gc, IconSelector as Hc, IconLayoutSidebar as Yc, IconLayoutSidebarRight as Wc, IconChevronRight as In, IconLoader as Xc, IconAlertOctagon as Jc, IconAlertTriangle as Zc, IconInfoCircle as Qc, IconCircleCheck as tl } from "@tabler/icons-react";
import { $isTableSelection as el } from "@lexical/table";
import { cva as Cr } from "class-variance-authority";
import { createHeadlessEditor as Pn } from "@lexical/headless";
import { useReactTable as Vn, getFilteredRowModel as rl, getSortedRowModel as Ln, getPaginationRowModel as al, getCoreRowModel as Fn, flexRender as mr, getGroupedRowModel as ol, getExpandedRowModel as nl } from "@tanstack/react-table";
import il from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Da, HIDDEN_NOTE_CALLER as $a, getDefaultViewOptions as sl, isInsertEmbedOpOfType as Mr, Editorial as cl } from "@eten-tech-foundation/platform-editor";
  ...
  return /* @__PURE__ */ u(ul, { children: [
    ...
    /* @__PURE__ */ u(
      ue.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ue.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(F, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Kc, {}),
...
function Oo({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ue.Close, { asChild: !0, children: /* @__PURE__ */ a(F, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Er({ className: t, type: e, ...r }) {
  return /* @__PURE__ */ a(
    "input",
    {
      type: e,
...
function Wa(t, e, r) {
  ...
  return !!(Or(n.toLowerCase(), o) || Or(t.toLowerCase(), o) || (i ? Or(i.localizedName.toLowerCase(), o) || Or(i.localizedId.toLowerCase(), o) : !1));
}
function Un({
  ref: t,
  bookId: e,
...
function gl({
  ...
  return /* @__PURE__ */ u(Ee, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Te, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(we, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Ce,
      {
        onSelect: () => g(h),
...
function qn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(we, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function wa({
  ...
  const N = jt(), [k, _] = C(!1), [V, U] = C(""), [I, O] = C(""), [y, z] = C("books"), [A, D] = C(void 0), [L, X] = C(
    void 0
  ), [K, $] = C(void 0), [Q, mt] = C(!1), ct = q(null), Bt = q(!1), bt = q(void 0), Dt = q(void 0), j = q(void 0), et = q(void 0), at = q({}), ot = q({}), nt = P(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Pt = B(() => o ? o() : Bn, [o]), vt = B(() => ({
    [Z.OT]: Pt.filter((G) => dt.isBookOT(G)),
    [Z.NT]: Pt.filter((G) => dt.isBookNT(G)),
    [Z.DC]: Pt.filter((G) => dt.isBookDC(G)),
    [Z.Extra]: Pt.filter((G) => dt.extraBooks().includes(G))
  }), [Pt]), Ut = B(() => Object.values(vt).flat(), [vt]), Kt = B(() => {
    if (!I.trim()) return vt;
    const b = {
      [Z.OT]: [],
      [Z.NT]: [],
  ...
  const Vt = P(() => {
    ...
    (b) => {
      const G = L ?? (S == null ? void 0 : S.book), J = K ?? (S == null ? void 0 : S.chapterNum);
      !G || !J || (nt({
        book: G,
        chapterNum: J,
        verseNum: b
    ...
    (b) => {
      const G = y === "chapters" ? A : S == null ? void 0 : S.book;
      if (G) {
        if (l && l(G, b) > 1) {
          X(G), $(b), z("verses"), U("");
          return;
    ...
    z("books"), D(void 0), X(void 0), $(void 0), setTimeout(() => {
      Dt.current && Dt.current.focus();
    }, 0);
  }, []), M = P(() => {
    const b = L;
    X(void 0), $(void 0), b ? (D(b), z("chapters"), U("")) : Ht();
  }, [L, Ht]), H = P((b) => {
    _(b), b && (z("books"), D(void 0), X(void 0), $(void 0), O(""));
  }, []), { otLong: it, ntLong: rt, dcLong: ht, extraLong: xt } = {
    ...
    () => ml(I),
    [I]
  ), kt = B(() => !l || !S || !S.chapterNum || !pt ? !1 : l(S.book, S.chapterNum) > 0, [l, S, pt]), Ve = P(
    (b) => w ? Ro(b, w) : !1,
    [w]
  ), Se = P(
    (b) => (G) => w ? vl(b, G, w) : !1,
    ...
    (b, G) => (J) => w ? da(b, G, J, w) : !1,
    [w]
  ), Le = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", dr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", wr = P(
    (b) => {
    ...
    (b) => {
      ...
      if ((y === "chapters" || y === "verses") && (b.key === " " || b.key === "Enter")) {
        const Rt = b.target instanceof HTMLElement ? b.target : void 0;
      ...
      if (y === "verses" && Et) {
        ...
        Yt !== ft && (b.preventDefault(), b.stopPropagation(), U(
          ...
          const Fe = ot.current[Yt];
          Fe && Fe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((y === "chapters" || y === "books" && S) && Et) {
        const Rt = y === "chapters" ? A : S == null ? void 0 : S.book;
        if (!Rt) return;
        y === "chapters" && ((ur = bt.current) == null || ur.focus());
        const _t = (() => {
          if (!V) return 1;
          const Wt = V.match(/(\d+)$/);
    ...
    const { isLetter: G, isDigit: J } = Mo(b.key);
    (G || J) && (b.preventDefault(), O((Jt) => Jt + b.key), Dt.current.focus(), mt(!1));
  }, []);
  return Xt(() => {
    const b = setTimeout(() => {
      if (k && y === "books" && j.current && et.current) {
        const G = j.current, J = et.current, Et = J.offsetTop, Jt = G.clientHeight, Ye = J.clientHeight, ur = Et - Jt / 2 + Ye / 2;
        G.scrollTo({
          top: Math.max(0, ur),
          behavior: "smooth"
        }), U(Kn(t.book));
  ...
  }, [y, A, S, t.book, t.chapterNum]), Xt(() => {
    if (y === "verses" && L && K !== void 0) {
      const b = L === t.book && K === t.chapterNum, G = b ? t.verseNum : 1;
      U(
        `${L} ${ie[L] || ""} ${K}:${G}`
      ), setTimeout(() => {
        if (j.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ee, { open: k, onOpenChange: H, modal: v, children: [
    /* @__PURE__ */ a(Me, { asChild: !0, children: /* @__PURE__ */ a(
      F,
      {
        ref: ct,
        ...
        children: g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Nt })
      }
    ) }),
    /* @__PURE__ */ a(
      Te,
              ...
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                /* @__PURE__ */ u("div", { className: "tw:relative tw:flex-1", children: [
                  ...
                  s && s.length > 0 && /* @__PURE__ */ a(
                    ...
                    {
                      recentSearches: s,
                      onSearchItemSelect: ze,
                      renderItem: (b) => me(b, "English"),
                ...
                /* @__PURE__ */ a(
                  F,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: y === "verses" ? M : Ht,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: N === "ltr" ? /* @__PURE__ */ a(us, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ps, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                y === "chapters" && A && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: $e(A, n) }),
                y === "verses" && L && K !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${$e(L, n)} ${K}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? dr : Le
                  }
                )
              ] }),
              !Q && /* @__PURE__ */ u(Ie, { ref: j, children: [
                y === "books" && /* @__PURE__ */ u(st, { children: [
                  !S && Object.entries(Kt).map(([b, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(we, { heading: yt(b), children: G.map((J) => /* @__PURE__ */ a(
                          Un,
                          {
                            bookId: J,
                            onSelect: (Et) => qt(Et),
                  ...
                  S && /* @__PURE__ */ a(we, { children: /* @__PURE__ */ a(
                    Ce,
                    {
                      ...
                      children: me(
                        ...
                        n ? Ya(S.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  S && kt && S.chapterNum && l && /* @__PURE__ */ u(st, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Io,
                      {
                        ...
                        onVerseSelect: oe,
                        setVerseRef: wt,
                        isVerseDisabled: lr(S.book, S.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  S && !kt && de(S.book) > 1 && /* @__PURE__ */ u(st, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                ...
                y === "chapters" && A && /* @__PURE__ */ a(
                  Ao,
                  {
                    ...
                    onChapterSelect: Ot,
                    setChapterRef: T,
                    isChapterDisabled: Se(A),
                    className: "tw:p-4"
                  }
                ),
                y === "verses" && L && K !== void 0 && l && /* @__PURE__ */ a(
                  Io,
                  {
                    bookId: L,
                    chapterNum: K,
...
function Po({
  ...
  const [k, _] = C(!1), V = l ?? d, U = (O) => O.length > 0 && typeof O[0] == "object" && "options" in O[0], I = (O, y) => {
    const z = d(O), A = typeof O == "object" && "secondaryLabel" in O ? O.secondaryLabel : void 0, D = `${y ?? ""}${z}${A ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: z,
    ...
    /* @__PURE__ */ a(
      Te,
      {
        ...
        children: /* @__PURE__ */ u(Ae, { children: [
          /* @__PURE__ */ a(kr, { placeholder: g, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(Zr, { children: h }),
          /* @__PURE__ */ a(Ie, { children: U(e) ? e.map((O) => /* @__PURE__ */ a(we, { heading: O.groupHeading, children: O.options.map((y) => I(y, O.groupHeading)) }, O.groupHeading)) : /* @__PURE__ */ a(we, { children: e.map((O) => I(O)) }) })
        ] })
      }
    )
  ] });
...
function rp({
  ...
  const w = ua(l, "%webView_bookSelector_currentBook%"), p = ua(l, "%webView_bookSelector_choose%"), g = ua(l, "%webView_bookSelector_chooseBooks%"), [h, f] = C(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = Yn ? Xt : Y, Ar = { tag: qa };
function Cl({ initialConfig: t, children: e }) {
  const r = B(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = _l(null, o), w = kn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function Rl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ml() {
  return function(t) {
    const [e] = fe(), r = B(() => t(e), [e, t]), [o, n] = C(() => r.initialValueFn()), i = q(o);
    return Ol(() => {
...
function Il(t, e, r = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !Ws(e) && o !== null) {
    const [n, i] = o, s = t.isBackward(), c = n.getNode(), d = i.getNode(), l = e.is(c), w = e.is(d);
    if (l || w) {
      const [p, g] = Xs(t), h = c.is(d), f = e.is(s ? d : c), x = e.is(s ? c : d);
      let v, E = 0;
      h ? (E = p > g ? g : p, v = p > g ? p : g) : f ? (E = s ? g : p, v = void 0) : x && (E = 0, v = s ? p : g);
      const N = e.__text.slice(E, v);
      N !== e.__text && (r === "clone" && (e = Js(e)), e.__text = N);
    }
  }
  return e;
}
...
const Wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = Wn && "documentMode" in document ? document.documentMode : null;
!(!Wn || !("InputEvent" in window) || Pl) && "getTargetRanges" in new window.InputEvent("input");
function le(t) {
  return `${t}px`;
}
...
function Ll(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < h.length; E++) {
      const N = h[E], k = s[E] || document.createElement("div"), _ = k.style;
      _.position !== "absolute" && (_.position = "absolute", v = !0);
      const V = le(N.left - p);
      _.left !== V && (_.left = V, v = !0);
      const U = le(N.top - g);
      _.top !== U && (k.style.top = U, v = !0);
      const I = le(N.width);
      _.width !== I && (k.style.width = I, v = !0);
      const O = le(N.height);
      _.height !== O && (k.style.height = O, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[E] = k;
    }
...
function jl(t, e = Fl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, E = h.getNode(), N = E.getKey(), k = h.offset, _ = t.getElementByKey(x), V = t.getElementByKey(N), U = r === null || _ !== o || v !== n || x !== r.getKey(), I = i === null || V !== s || k !== c || N !== i.getKey();
      if ((U || I) && _ !== null && V !== null) {
        const O = function(y, z, A, D, L, X, K) {
          const $ = (y._window ? y._window.document : document).createRange();
          return $.setStart(...Vo(z, A, D)), $.setEnd(...Vo(L, X, K)), $;
        }(t, g, f, _, h, E, V);
        d(), d = Ll(t, O, e);
      }
      r = f, o = _, n = v, i = E, s = V, c = k;
    });
  }
...
function Ul(t) {
  const e = En(t, (r) => ve(r) && !r.isInline());
  return ve(e) || qr(4, t.__key), e;
}
function Kl(t) {
  const e = Ft() || Zs();
  let r;
  if (pe(e)) r = Qs(e.focus, "next");
    ...
    r = r || tc(_e(), "previous").getFlipped().insert(sr());
  }
...
function ql(t, e, r) {
  ...
  return sc(o) && qr(283), o.insert(t.isInline() ? sr().append(t) : t), Eo(Cn(t.getLatest(), "next"), e.direction);
}
function Gl(t) {
  const e = Ft();
  if (!pe(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = En(i, (l) => ve(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Gr, be = 0, Hr = 0, Wl = 0, Va = 0, Fr = 0;
function Fo(t) {
  if (tt === void 0) return;
  let e = t.n;
...
function je(t, e) {
  At.call(this, void 0), this.x = t, this.s = void 0, this.g = Fr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Xl(t, e) {
  return new je(t, e);
}
...
function Jl(t) {
  ...
  Jn(this), tt = t, this.f &= -2, 8 & this.f && Za(this), aa();
}
function Xe(t, e) {
...
At.prototype.brand = Hl, At.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Hr === 0 && e.l !== Va && (e.l = Va, Gr = { S: e, v: e.v, i: e.i, o: Gr });
...
} }), je.prototype = new At(), je.prototype.h = function() {
  ...
  return tt = t, Jn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Zn(this), jo(this), be++;
  const t = tt;
  return tt = this, Jl.bind(this, t);
...
ae({ build: (t, e, r) => cr(e), config: He({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Qn() {
  const t = _e(), e = Ft(), r = sr();
  t.clear(), t.append(r), e !== null && r.select(), pe(e) && (e.format = 0);
}
function ti(t, e = Qn) {
  return t.registerCommand(zn, (r) => (t.update(e), !0), Ga);
}
ae({ build: (t, e, r) => cr(e), config: He({ $onClear: Qn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return he(() => ti(t, o.value));
} });
function Zl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ha = dc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ei extends Sa {
  $config() {
    return this.config("decorator-text", { extends: Sa, stateConfigs: [{ flat: !0, stateConfig: ha }] });
  }
  getFormat() {
    return kc(this, ha);
  }
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [ei], register: (t, e, r) => t.registerCommand(Sn, (o) => {
  const n = Ft();
  if (Dn(n) || pe(n)) for (const i of n.getNodes()) Ql(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function ri(t, e) {
  let r;
...
const La = ae({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Qa = 0, Fa = 1, oi = 2, ga = 3, Ir = 4, We = 5, fa = 6, hr = 7;
function ma(t) {
  return t.id === Qa;
}
function ni(t) {
...
function td(t) {
  return function(e) {
    return e.id === Fa;
  }(t) || lt(305, String(t.id), String(Fa)), Object.assign(t, { id: oi });
}
...
class rd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && lt(307, String(r.id), String(We)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== We && lt(308, String(o.id), String(We));
...
const od = ae({ config: He({ setOptions: Bo, updateOptions: Bo }), init: ({ $initialEditorState: t = ad }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [wc, Nn, uc, pc, _n] }), Uo = Symbol.for("@lexical/extension/LexicalBuilder");
function Ko() {
}
function nd(t) {
  throw t;
...
class Je {
  ...
  static maybeFromEditor(e) {
    const r = e[Uo];
    return r && (r.PACKAGE_VERSION !== va && lt(292, r.PACKAGE_VERSION, va), r instanceof Je || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ma(i) || lt(300, s, n || "[unknown]"), ma(c = i) || lt(304, String(c.id), String(Qa)), i = Object.assign(c, { id: Fa }), o.state = i;
...
const id = /* @__PURE__ */ new Set(), qo = ae({ build(t, e, r) {
  const o = r.getDependency(La).output, n = xr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ri(() => {
  }, () => he(() => {
...
}, dependencies: [La], name: "@lexical/extension/NodeSelection" }), sd = gc("INSERT_HORIZONTAL_RULE_COMMAND");
class er extends Sa {
  static getType() {
...
ae({ dependencies: [La, qo], name: "@lexical/extension/HorizontalRule", nodes: () => [er], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(qo).output, n = xr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ne(t.registerCommand(sd, (s) => {
    const c = Ft();
    if (!pe(c)) return !1;
    ...
    return !0;
  }, Ga), t.registerCommand(fc, (s) => {
    if (mc(s.target)) {
      const c = vc(s.target);
      if (ld(c)) return function(d, l = !1) {
        const w = Ft(), p = d.isSelected(), g = d.getKey();
        let h;
        l && Dn(w) ? h = w : (h = bc(), xc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, $n), t.registerMutationListener(er, (s, c) => {
    Yl(() => {
      let d = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        g ? g.domNode.value = h : (d = !0, l.set(w, { domNode: xr(h), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(he(() => {
      const l = c.value;
      l && (d.value ? On(l, i) : Tc(l, i));
    }));
    return Ne(...s);
  }));
} });
ae({ build: (t, e) => cr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: He({ $getParentEditor: function() {
  const t = yc();
...
ae({ build: (t, e, r) => cr(e), config: He({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return he(() => {
...
function dd(t, e, r = ii) {
  return Ne(t.registerCommand(zc, (o) => {
    const n = Ft();
    if (!pe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => Ur(g) && g.canIndent()).length > 0) return !0;
      ...
      return !1;
    }(n) ? o.shiftKey ? $c : zo : Oc;
    return t.dispatchCommand(i, void 0);
  }, Ga), t.registerCommand(zo, () => {
...
ae({ build: (t, e, r) => cr(e), config: He({ $canIndent: ii, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return he(() => {
    if (!o.value) return dd(t, n, i);
  });
} });
const wd = ae({ name: "@lexical/react/ReactProvider" });
function ud() {
  return _e().getTextContent();
}
function pd(t, e = !0) {
  if (t) return !1;
  let r = ud();
...
function hd(t) {
  if (!pd(t, !1)) return !1;
  const e = _e().getChildren(), r = e.length;
  if (r > 1) return !1;
  for (let o = 0; o < r; o++) {
    const n = e[o];
    if (Rc(n)) return !1;
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (pe(f)) {
                ...
                if (Kr(v) && l >= 0 && w >= 0 && (E = l, N = l + w, f.setTextNodeRange(v, E, v, N)), E === N && p === "" || (f.insertRawText(p), v = x.getNode()), Kr(v)) {
                  E = g, N = g + h;
...
ae({ build: (t, e, r) => cr(e), config: He({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => he(() => r.getOutput().disabled.value ? void 0 : ci(t)) });
function gd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function Dd() {
  const [t, e] = C(void 0), r = P(() => {
    e(void 0);
  }, []), o = B(() => {
    if (t === void 0)
      return;
    const { title: i, content: s } = t;
    return /* @__PURE__ */ a(Oa, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ra, { children: [
      /* @__PURE__ */ a(Ma, { children: /* @__PURE__ */ a(Aa, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = P(
    (i, s, c = !1) => {
...
function $d({
  ...
  const [e] = fe(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = Dd(), d = () => {
  };
...
function Md() {
  const { activeEditor: t } = wi(), [e, r] = C([]), o = P((n) => {
    if (pe(n) || el(n)) {
      const i = [];
      Yo.forEach(({ format: s }) => {
...
function Id({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a($d, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Md, {}) }) }),
...
function Vd(t, e) {
  ...
  let o = [];
  const n = [];
  for (const i of r) if (!gi.has(i.nodeName)) {
    const s = fi(i, t, n, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Mn && s.insertAfter(An());
    for (const s of i) {
...
function Ld(t, e) {
  ...
  const r = document.createElement("div"), o = _e().getChildren();
  for (let n = 0; n < o.length; n++)
    hi(t, o[n], r, e);
  return r.innerHTML;
}
function hi(t, e, r, o = null) {
  ...
  const i = ve(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && Kr(e) && (s = Il(o, e, "clone"));
  const c = ve(s) ? s.getChildren() : [], d = Ac(t, s.getType());
  let l;
  ...
  for (let h = 0; h < c.length; h++) {
    const f = c[h], x = hi(t, f, g, o);
    !n && ve(e) && x && e.extractWithChild(f, o, "html") && (n = !0);
  }
  if (n && !i) {
    if ((Tn(w) || So(w)) && w.append(g), r.append(w), p) {
      const h = p.call(s, w);
      h && (So(w) ? w.replaceChildren(h) : w.replaceWith(h));
    }
  } else r.append(g);
  return n;
}
const gi = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function fi(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (gi.has(t.nodeName)) return s;
  let c = null;
  const d = function(f, x) {
    const { nodeName: v } = f, E = x._htmlConversions.get(v.toLowerCase());
    let N = null;
    if (E !== void 0) for (const k of E) {
      const _ = k(f);
  ...
  let g = [];
  const h = (c == null || !Pc(c)) && (c != null && Ur(c) || o);
  for (let f = 0; f < p.length; f++) g.push(...fi(p[f], e, r, h, new Map(n), c));
  return w != null && (g = w(g)), Do(t) && (g = Fd(t, g, h ? () => {
    const f = new Mn();
    return r.push(f), f;
  } : sr)), c == null ? g.length > 0 ? s = s.concat(g) : Do(t) && function(f) {
    return f.nextSibling == null || f.previousSibling == null ? !1 : $o(f.nextSibling) && $o(f.previousSibling);
  }(t) && (s = s.concat(An())) : ve(c) && c.append(...g), s;
}
function Fd(t, e, r) {
  ...
  for (let s = 0; s < e.length; s++) {
    const c = e[s];
    if (Ur(c)) o && !c.getFormat() && c.setFormat(o), n.push(c);
    else if (i.push(c), s === e.length - 1 || s < e.length - 1 && Ur(e[s + 1])) {
      const d = r();
...
function jd(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Vd(e, n);
      _e().clear(), Vc(i);
    },
    {
      discrete: !0
...
function op({
  ...
  const [i, s] = C(Ud), [c, d] = C(n), [l, w] = C(!1), p = q(void 0), g = q(null);
  Y(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ee, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(Me, { asChild: !0, children: /* @__PURE__ */ u(
        F,
        {
          variant: "outline",
...
function Xo({
  ...
  const h = P(
    ...
    const _ = new Date(t.date), V = os(
      _,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), U = _.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), v = B(() => t.user, [t.user]), E = B(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), N = B(() => ns(t.contents), [t.contents]), k = B(() => {
    if (o && c)
      return /* @__PURE__ */ u(st, { children: [
        /* @__PURE__ */ u(
          Ue,
          {
            onClick: (_) => {
              _.stopPropagation(), l(!0), p(jd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Gd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Hd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), h()) : oo(_) && (_.preventDefault(), _.stopPropagation(), Zt(w) && f());
              },
              onKeyDown: (_) => {
        ...
        k && /* @__PURE__ */ u(xe, { children: [
          /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ a(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(vs, {}) }) }),
          /* @__PURE__ */ a(ke, { align: "end", children: k })
        ] })
      ]
    }
  );
...
function Yd({
  ...
  const [O, y] = C(Jo), [z, A] = C(), [D, L] = C(), X = o, [K, $] = C(!1), [Q, mt] = C(!1), [ct, Bt] = C(!1), [bt, Dt] = C(!1), [j, et] = C(!1), [at, ot] = C(_), [nt, Pt] = C(!1), vt = q(void 0), [Ut, Kt] = C(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  Y(() => {
    if (!o) {
      S.current !== "idle" && (A(void 0), L(void 0), S.current = "idle");
      return;
    }
  ...
  const $t = B(() => e.filter((T) => !T.deleted), [e]);
  Y(() => {
    let T = !0;
    if (!o || !k) {
      Kt(/* @__PURE__ */ new Map());
  ...
  const Vt = B(() => $t[0], [$t]), oe = q(null), qt = q(void 0), Ot = P(() => {
    var T;
    (T = qt.current) == null || T.call(qt), y(Jo);
  }, []), ze = P(() => {
    const T = !at;
    ot(T), Pt(!T), f == null || f(d, T);
  }, [at, f, d]);
  Y(() => {
    $(!1);
  }, [o]), Y(() => {
  ...
  }, [i, r]), M = B(() => $t.slice(1), [$t]), H = B(() => M.length ?? 0, [M.length]), it = B(() => H > 0, [H]), rt = B(() => K || H <= 2 ? M : M.slice(-2), [M, H, K]), ht = B(() => K || H <= 2 ? 0 : H - 2, [H, K]), xt = B(
    () => H === 1 ? Gt.singleReply : Ke(Gt.multipleReplies, { count: H }),
    [H, Gt]
  ), yt = B(
    () => ht === 1 ? Gt.singleReply : Ke(Gt.multipleReplies, { count: ht }),
    [ht, Gt]
  );
  Y(() => {
    !o && Q && it && mt(!1);
  ...
  const gt = P(
    async (T) => {
      ...
      wt && await p({ threadId: d, contents: wt }) && Ot();
    },
    [
      Ot,
      O,
    ...
    async (T) => {
      const wt = Zt(O) ? Wr(O) : void 0, pt = T.status ? T.assignedUser : z ?? T.assignedUser, kt = await p({
        ...T,
        contents: wt,
        assignedUser: pt
      });
      return kt && (pt !== void 0 && L(pt), wt && Ot()), kt;
    },
    [Ot, O, p, z]
  );
  if ($t.length !== 0)
    return /* @__PURE__ */ a(
      Kd,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ u(qd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u(st, { children: [
            it && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            o && /* @__PURE__ */ u(st, { children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      ...
                      K ? /* @__PURE__ */ a(ys, {}) : /* @__PURE__ */ a(tr, {})
                    ] })
                  ]
                }
              ),
              rt.map((T) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Xo,
                {
                  comment: T,
                  localizedStrings: r,
              ...
              v !== !1 && (!Q || Zt(O)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (T) => {
                    oo(T) && (T.preventDefault(), T.stopPropagation(), (Zt(O) || z !== void 0 && z !== D) && gt());
                  },
                  onKeyDown: (T) => {
                    ro(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Yr,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && (Zt(O) || z !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ke(
                      ...
                      /* @__PURE__ */ u(Ee, { open: ct, onOpenChange: Bt, children: [
                        /* @__PURE__ */ a(Me, { asChild: !0, children: /* @__PURE__ */ a(
                          F,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ a(
                          Te,
                          {
                            ...
                            children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Ie, { children: x == null ? void 0 : x.map((T) => /* @__PURE__ */ a(
                              Ce,
                              {
                                onSelect: () => {
                                  A(T !== i ? T : void 0), S.current = "user-selected", L(void 0), Bt(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function up({
  ...
  const [E, N] = C(/* @__PURE__ */ new Set()), [k, _] = C(), [V, U] = C(), I = P(
    async ($) => {
      const Q = await i($);
  ...
  Y(() => {
    f && (N(($) => new Set($).add(f)), _(f));
  }, [f]);
  const O = r.filter(
    ($) => $.comments.some((Q) => !Q.deleted)
  ), y = O.map(($) => ({ id: $.id })), z = P(
    ($) => {
      N((Q) => new Set(Q).add($.id)), _($.id), x == null || x($.id);
    },
    [x]
  ), A = P(
    ($) => {
    ...
    [E, x]
  ), { listboxRef: D, activeId: L, handleKeyDown: X } = qi({
    options: y,
    onOptionSelect: z
  }), K = P(
    ($) => {
      $.key === "Escape" ? (k && E.has(k) && (N((Q) => {
        const mt = new Set(Q);
        return mt.delete(k), mt;
      }), _(void 0), x == null || x(void 0)), $.preventDefault(), $.stopPropagation()) : X($);
    },
    [k, E, X, x]
  );
  return /* @__PURE__ */ a(
...
function Wd({ table: t }) {
  return /* @__PURE__ */ u(xe, { children: [
    /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ u(F, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function or({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    It.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(It.Icon, { asChild: !0, children: /* @__PURE__ */ a(Hc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ne({
  ...
  return /* @__PURE__ */ u(
    It.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(It.ItemIndicator, { children: /* @__PURE__ */ a(ra, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        rr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(nr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ne, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  const c = ut.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), aw(h, f, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), rw(c, x, w.key);
...
function ow({
  ...
  var U;
  const [w, p] = C([]), [g, h] = C([]), [f, x] = C({}), [v, E] = C({}), N = B(() => e ?? [], [e]), k = Vn({
    data: N,
    columns: t,
    getCoreRowModel: Fn(),
  ...
  let V;
  return d ? V = Array.from({ length: 10 }).map((y, z) => `skeleton-row-${z}`).map((y) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Ze, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(_a, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((U = k.getRowModel().rows) == null ? void 0 : U.length) > 0 ? V = k.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    Oe,
    {
      onClick: () => s(I, k),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((O) => /* @__PURE__ */ a(Ze, { children: mr(O.column.columnDef.cell, O.getContext()) }, O.id))
    },
    I.id
  )) : V = /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a(Ze, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Wd, { table: k }),
    /* @__PURE__ */ u(no, { stickyHeader: i, children: [
      /* @__PURE__ */ a(io, { stickyHeader: i, children: k.getHeaderGroups().map((I) => /* @__PURE__ */ a(Oe, { children: I.headers.map((O) => /* @__PURE__ */ a(Xr, { className: "tw:p-0", children: O.isPlaceholder ? void 0 : mr(O.column.columnDef.header, O.getContext()) }, O.id)) }, I.id)) }),
      /* @__PURE__ */ a(so, { children: V })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(hn, {}) })
        ] }),
...
function bp({
  ...
  return /* @__PURE__ */ u(Ee, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Te, { id: i, className: m("tw:min-w-80 tw:max-w-96", n), children: [
...
function xp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(xe, { children: [
    /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ u(F, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(ke, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(ln, { children: l.itemType === 0 ? /* @__PURE__ */ a(st, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Re,
        {
          checked: o[w][g],
...
function kp({
  ...
  const s = B(() => ss(r), [r]), d = ((l) => {
    const w = new Intl.DisplayNames(cs(), { type: "language" });
...
function lw({
  ...
  const [E, N] = C(!1), k = P(
    (z) => {
      var D;
      const A = (D = t.find((L) => L.label === z)) == null ? void 0 : D.value;
      A && r(
        e.includes(A) ? e.filter((L) => L !== A) : [...e, A]
      );
    },
    [t, e, r]
  ), _ = () => d || o, V = B(() => {
    if (!g) return t;
    const z = t.filter((D) => D.starred).sort((D, L) => D.label.localeCompare(L.label)), A = t.filter((D) => !D.starred).sort((D, L) => {
      const X = e.includes(D.value), K = e.includes(L.value);
      return X && !K ? -1 : !X && K ? 1 : D.label.localeCompare(L.label);
    });
    return [...z, ...A];
  }, [t, e, g]), U = () => {
    r(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: f, children: /* @__PURE__ */ u(Ee, { open: O, onOpenChange: w ?? N, children: [
    /* @__PURE__ */ a(Me, { asChild: !0, children: /* @__PURE__ */ u(
      F,
      {
        variant: x,
    ...
    /* @__PURE__ */ a(Te, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ae, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(F, { variant: "ghost", size: "sm", onClick: U, children: i }),
        /* @__PURE__ */ a(F, { variant: "ghost", size: "sm", onClick: I, children: s })
      ] }),
      /* @__PURE__ */ u(Ie, { children: [
        /* @__PURE__ */ a(Zr, { children: c }),
        /* @__PURE__ */ a(we, { children: V.map((z) => /* @__PURE__ */ u(
          Ce,
          {
            value: z.label,
            onSelect: k,
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a($s, { className: "tw:h-4 tw:w-4" }),
...
function ww({
  ...
  const d = B(() => /Macintosh/i.test(navigator.userAgent), []), l = en(n, "%undoButton_tooltip%"), w = en(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(ao, { children: [
    /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ u(te, { children: [
      /* @__PURE__ */ a(ee, { asChild: !0, children: /* @__PURE__ */ a(
        F,
      ...
      /* @__PURE__ */ a(re, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(st, { children: [
          " ",
          /* @__PURE__ */ a(tn, { children: d ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(bi, {}),
    e && /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ u(te, { children: [
      ...
      /* @__PURE__ */ a(re, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(st, { children: [
          " ",
          /* @__PURE__ */ a(tn, { children: d ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function hw({
  ...
  const f = (v) => {
    ...
    var E, N, k, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(xe, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ u(te, { children: [
      /* @__PURE__ */ a(ee, { asChild: !0, children: /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ a(F, { variant: "outline", className: "tw:h-6", children: pw(t, n, r) }) }) }),
...
function mw({
  ...
  return /* @__PURE__ */ u(xe, { children: [
    /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ u(te, { children: [
      /* @__PURE__ */ a(ee, { asChild: !0, children: /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ a(F, { variant: "outline", className: "tw:h-6", children: gw(t, r) }) }) }),
      /* @__PURE__ */ a(re, { children: /* @__PURE__ */ a("p", { children: fw(t, r) }) })
    ] }) }),
...
function rn({
  ...
  return /* @__PURE__ */ u(
    Ce,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(bw, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
...
function xw({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = C(""), [i, s] = B(() => {
...
function Np({
  ...
  Xt(() => {
    if (!h.current) return;
    const { width: M } = h.current.getBoundingClientRect();
    M > 0 && (h.current.style.width = `${M}px`);
  }, []);
  const [f, x] = C("generated"), [v, E] = C("generated"), [N, k] = C("*"), [_, V] = C("*"), [U, I] = C("f"), [O, y] = C(!1), [z, A] = C(!0), [D, L] = C(!1), X = q(!1), K = q(""), [$, Q] = C(!1), [mt, ct] = C(), [Bt, bt] = C(), [Dt, j] = C(), [et, at] = C(), ot = q(null), nt = B(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (H && Mr("note", H)) {
      const ht = (it = H.insert.note) == null ? void 0 : it.caller;
      let xt = "custom";
      ht === Da ? xt = "generated" : ht === $a ? xt = "hidden" : ht && (k(ht), V(ht)), x(xt), E(xt), I(((rt = H.insert.note) == null ? void 0 : rt.style) ?? "f"), M = setTimeout(() => {
        var yt;
  ...
  const vt = P(
    (M, H, it = !1) => {
      var ht, xt, yt;
      const rt = (xt = (ht = w.current) == null ? void 0 : ht.getNoteOps(0)) == null ? void 0 : xt.at(0);
      if (rt && Mr("note", rt)) {
        if (rt.insert.note) {
          let gt;
          M === "custom" ? gt = H : M === "generated" ? gt = Da : gt = $a, rt.insert.note.caller = gt;
        }
        r == null || r([rt]), it && l && i && ((yt = l.current) == null || yt.replaceEmbedUpdate(i, [rt]));
      }
    },
    [i, r, l]
  ), Ut = P(() => {
  ...
  const S = q({ book: n.book, chapterNum: n.chapterNum });
  Xt(() => {
    (S.current.book !== n.book || S.current.chapterNum !== n.chapterNum) && (S.current = { book: n.book, chapterNum: n.chapterNum }, Kt.current());
  }, [n.book, n.chapterNum]);
  const $t = () => {
    var H;
    const M = (H = p.current) == null ? void 0 : H.getElementsByClassName("editor-input")[0];
    ...
    if (H && Mr("note", H)) {
      ...
      U !== "x" && M === "x" ? gt == null || gt.forEach((Nt) => kw(Nt)) : U === "x" && M !== "x" && (gt == null || gt.forEach((Nt) => _w(Nt))), (yt = w.current) == null || yt.applyUpdate([H, { delete: 1 }]);
    }
  }, Ot = (M) => {
    at(M.contextMarker), L(M.canRedo);
  }, ze = P(
    (M) => {
      var it, rt, ht, xt, yt;
      const H = (rt = (it = w.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : rt.at(0);
      if (H && Mr("note", H)) {
        ...
        const gt = (ht = H.insert.note) == null ? void 0 : ht.style, Nt = (yt = (xt = H.insert.note) == null ? void 0 : xt.contents) == null ? void 0 : yt.ops;
        if (gt || y(!1), y(
          gt === "x" ? !!(Nt != null && Nt.every((T) => {
            var pt, kt;
          ...
          X.current = !0, K.current = JSON.stringify(H), A(!0);
          return;
        }
        A(JSON.stringify(H) === K.current), vt(f, N);
      } else
        y(!1), A(!0);
    },
    [f, N, vt]
    ...
    if (g.current && Pt.length && M && M.rangeCount > 0) {
      const H = M.getRangeAt(0).getBoundingClientRect(), it = g.current.getBoundingClientRect();
      ct(H.left - it.left), bt(H.top - it.top), j(H.height), Q(!0);
    }
  }, [Pt, g]);
  Y(() => {
    const M = () => {
    ...
    var M;
    $ && ((M = ot.current) == null || M.focus());
  }, [$]), Y(() => {
    var it;
    const M = ((it = p.current) == null ? void 0 : it.querySelector(".editor-input")) ?? void 0, H = (rt) => {
      !$ && M && document.activeElement === M && rt.key === c ? (rt.preventDefault(), Gt()) : $ && rt.key === "Escape" && (rt.preventDefault(), Q(!1));
    };
  ...
  return /* @__PURE__ */ u(st, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(st, { children: Cw(t.marker, c, o, l) })
      }
    )
  ] });
}
function Ep({
  ...
  const w = d ?? ls(r, void 0), p = (N, k) => {
    l == null || l(N, k, n);
  }, g = i ? r.findIndex((N) => N === i) : -1, [h, f] = C(g), x = (N, k, _) => {
    if (r.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), l == null || l(k, _, n);
          break;
      }
  }, v = (N) => {
    if (r.length)
        ...
        "ul",
        {
          ...
          children: r.map((N, k) => {
            ...
            return /* @__PURE__ */ u(st, { children: [
              ...
              k < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Qe, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function Sw({
  ...
  return /* @__PURE__ */ u(no, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(io, { stickyHeader: !0, children: /* @__PURE__ */ u(Oe, { children: [
      /* @__PURE__ */ a(Xr, { children: n }),
      /* @__PURE__ */ a(Xr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(so, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(Ze, { children: me(c.reference, "English") }),
          /* @__PURE__ */ a(Ze, { className: o, children: zw(c.text) })
        ]
      },
...
const Dw = (t) => {
...
}, oa = (t, e, r) => /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ u(te, { children: [
  /* @__PURE__ */ u(
    ee,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(pi, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          jr,
          {
            onClick: (d) => {
  ...
  return e ? e[1] : "";
}, Ow = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Rp = Object.freeze([
...
function Mp({
  ...
  const h = ce(r, "%webView_inventory_all%"), f = ce(r, "%webView_inventory_approved%"), x = ce(r, "%webView_inventory_unapproved%"), v = ce(r, "%webView_inventory_unknown%"), E = ce(r, "%webView_inventory_scope_currentBook%"), N = ce(r, "%webView_inventory_scope_chapter%"), k = ce(r, "%webView_inventory_scope_verse%"), _ = ce(r, "%webView_inventory_filter_text%"), V = ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), U = ce(r, "%webView_inventory_no_results%"), [I, O] = C(!1), [y, z] = C("all"), [A, D] = C(""), [L, X] = C([]), K = B(() => {
    const j = t ?? [];
    return j.length === 0 ? [] : Mw(j, n, i);
  }, [t, n, i]), $ = B(() => {
    if (I) return K;
    const j = [];
    return K.forEach((et) => {
  ...
  }, [I, K]), Q = B(() => $.length === 0 ? [] : Rw($, y, A), [$, y, A]), mt = B(() => {
    var at, ot;
    if (!I) return d;
  ...
  const ct = (j, et) => {
    ...
    if ($.length === 0 || L.length === 0) return [];
    const j = $.filter((et) => ds(
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(rr, { onValueChange: (j) => Bt(j), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(nr, { children: [
          ...
          /* @__PURE__ */ a(ne, { value: "chapter", children: N }),
          /* @__PURE__ */ a(ne, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Er,
      ...
      o && /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ u(te, { children: [
        /* @__PURE__ */ a(ee, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Ct, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? V })
        ] }) }),
        /* @__PURE__ */ a(re, { children: (o == null ? void 0 : o.checkboxText) ?? V })
      ] }) })
    ] }),
...
const Aw = "16rem", Iw = "3rem", Ni = ut.createContext(void 0);
function na() {
  const t = ut.useContext(Ni);
  if (!t)
...
function Pw({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), g = ut.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = jt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Kw({
  ...
  const c = t ? ir.Root : "button", { state: d } = na(), l = /* @__PURE__ */ a(
    c,
    {
...
function Kp({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      ...r,
      children: [
        e && /* @__PURE__ */ a(_a, { className: "tw:size-4 tw:rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ a(
          _a,
          {
    ...
    Vw,
    {
      ...
      children: /* @__PURE__ */ u(Fw, { children: [
        /* @__PURE__ */ u(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(jw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Bw, { children: /* @__PURE__ */ a(
            Kw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const De = "scrBook", Gw = "scrRef", Be = "source", Hw = "details", Yw = "Scripture Reference", Ww = "Scripture Book", Ci = "Type", Xw = "Details";
function Jw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === De ? me(n.start) : void 0;
      },
...
const Zw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Na(t.start, t.end) === 0 ? `${ca(t.start)}+${e}` : `${ca(t.start)}+${e}-${ca(t.end)}+${r}`;
}, sn = (t) => `${Zw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Wp({
  sources: t,
  ...
  const [l, w] = C([]), [p, g] = C([{ id: De, desc: !1 }]), [h, f] = C({}), x = B(
  ...
  Y(() => {
    if (c) {
      const y = E.getSelectedRowModel().rowsById, z = Object.keys(y);
      if (z.length === 1) {
        const A = x.find((D) => sn(D) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [h, x, c, E]);
  const N = n ?? Ww, k = i ?? Ci, _ = [
  ...
  }, I = (y, z) => y.getIsGrouped() ? "" : m("banded-row", z % 2 === 0 ? "even" : "odd"), O = (y, z, A) => {
    if (!((y == null ? void 0 : y.length) === 0 || z.depth < A.column.getGroupedIndex())) {
      if (z.getIsGrouped())
        switch (z.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      rr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(nr, { position: "item-aligned", children: /* @__PURE__ */ a(Xd, { children: _.map((y) => /* @__PURE__ */ a(ne, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(no, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(io, { children: E.getHeaderGroups().map((y) => /* @__PURE__ */ a(Oe, { children: y.headers.filter((z) => z.column.columnDef.header).map((z) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Xr, { colSpan: z.colSpan, className: "tw:sticky top-0", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(so, { children: E.getRowModel().rows.map((y, z) => {
        const A = jt();
        return /* @__PURE__ */ a(
          Oe,
          {
            ...
            children: y.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== Be || !r)))
                return /* @__PURE__ */ a(
                  Ze,
                  {
                    className: m(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a(Ea, {}) : /* @__PURE__ */ a(Ca, {})),
                          " ",
                          mr(D.column.columnDef.cell, D.getContext()),
                          " (",
                          y.subRows.length,
                          ")"
                        ]
...
const Ti = (t, e, r) => wo(t, e).every((o) => r.includes(o));
function Qw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [x, v] = C(!1), [E, N] = C(""), k = q(void 0), _ = q(!1), V = B(
    () => Ei(t),
    [t]
  ), U = B(() => {
    if (!E.trim()) {
    ...
    (D, L = !1) => {
      ...
      const X = V.findIndex((ct) => ct === k.current), K = V.findIndex((ct) => ct === D);
      if (X === -1 || K === -1) return;
      const [$, Q] = [
        Math.min(X, K),
        Math.max(X, K)
      ], mt = V.slice($, Q + 1).map((ct) => ct);
      r(
    ...
    D.preventDefault(), I(L, D.shiftKey);
  }, z = () => {
    r(V.map((D) => D));
  }, A = () => {
    r([]);
          ...
          Ae,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(F, { variant: "ghost", size: "sm", onClick: z, children: d }),
                /* @__PURE__ */ a(F, { variant: "ghost", size: "sm", onClick: A, children: l })
              ] }),
              /* @__PURE__ */ u(Ie, { children: [
                /* @__PURE__ */ a(Zr, { children: w }),
                Object.values(Z).map((D, L) => {
                  const X = U[D];
                  if (X.length !== 0)
                    return /* @__PURE__ */ u(xn, { children: [
                      /* @__PURE__ */ a(
                        we,
                        {
                          heading: jn(D, p, g, h, f),
                          children: X.map((K) => /* @__PURE__ */ a(
                            Un,
                            {
                              bookId: K,
                      ...
                      L < Object.values(Z).length - 1 && /* @__PURE__ */ a(wn, {})
                    ] }, D);
                })
              ] })
            ]
...
function tu({
  ...
  const i = wo(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], l = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    F,
    {
      variant: "outline",
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ya ? ya : cn
      ).map((d) => /* @__PURE__ */ a(br, { className: "tw:hover:bg-secondary", variant: "secondary", children: $e(d, n) }, d)),
...
function Jp({
  ...
  const _ = zt(
    s,
    "%webView_scope_selector_selected_text%"
  ), V = zt(s, "%webView_scope_selector_verse%"), U = zt(s, "%webView_scope_selector_chapter%"), I = zt(s, "%webView_scope_selector_book%"), O = zt(
    s,
    "%webView_scope_selector_current_verse%"
  ), y = zt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), z = zt(s, "%webView_scope_selector_current_book%"), A = zt(s, "%webView_scope_selector_choose_books%"), D = zt(s, "%webView_scope_selector_scope%"), L = zt(s, "%webView_scope_selector_select_books%"), X = zt(s, "%webView_scope_selector_range%"), K = zt(s, "%webView_scope_selector_select_range%"), $ = zt(s, "%webView_scope_selector_range_start%"), Q = zt(s, "%webView_scope_selector_range_end%"), mt = zt(s, "%webView_scope_selector_ok%"), ct = zt(s, "%webView_scope_selector_cancel%"), Bt = zt(s, "%webView_scope_selector_navigate%"), bt = (R) => {
    if (!f) return;
    const W = f.book.toUpperCase();
    switch (R) {
      case "verse":
        return me(f, "id");
      case "chapter":
        return `${W} ${f.chapterNum}`;
      case "book":
        return W;
      default:
        return;
  ...
  ], j = (R, W, Lt = !1) => /* @__PURE__ */ u(st, { children: [
    R,
    W && !Lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      W
    ] })
  ] }), et = e ? Dt.filter((R) => e.includes(R.value)) : Dt, at = f ?? la, ot = w ?? at, nt = p ?? at, Pt = () => {
  }, vt = q(null), Ut = q(null), Kt = q(!1), S = q(null), $t = q(!1), [Vt, oe] = C(void 0), qt = q(!1), Ot = q(!1), ze = q(null), Gt = P((R) => {
    if (R) {
      oe("start"), qt.current = !1;
      return;
    }
    oe((W) => W === "start" ? void 0 : W), qt.current && (qt.current = !1, requestAnimationFrame(() => {
      var Lt;
      const W = (Lt = vt.current) == null ? void 0 : Lt.querySelector("button");
      W == null || W.click();
    }));
  }, []), Ht = P((R) => {
    if (R) {
    ...
    (R) => {
      h == null || h(R), Ot.current = !0;
    },
    [h]
  ), it = P(
    (R) => {
      r(R), R === "selectedBooks" && n.length === 0 && (f != null && f.book) && i([f.book]);
    },
    [r, n, f, i]
  ), rt = et.find((R) => R.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((R) => R.toUpperCase()).join(", ") : t === "range" ? ws(ot, nt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : rt ? j(rt.label, rt.scrRefSuffix) : t, xt = et.filter(
    (R) => R.value !== "selectedBooks" && R.value !== "range"
  ), yt = et.find((R) => R.value === "selectedBooks"), gt = et.find((R) => R.value === "range"), [Nt, T] = C(!1), [wt, pt] = C(void 0), [kt, Ve] = C(void 0), [Se, lr] = C(void 0), [Le, dr] = C(void 0), [wr, Tr] = C([]), zr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    eu,
    {
      availableBookInfo: o,
      selectedBookIds: zr ? wr : n,
      onChangeSelectedBookIds: zr ? Tr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), G = Vt === "end", J = Vt === "start", Et = "tw:text-muted-foreground", Jt = l === "dropdown" && wt === "range", Ye = Jt ? lr : M, Rt = Jt ? dr : h ? H : Pt, _t = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-start", className: m(G && Et), children: $ }),
      /* @__PURE__ */ a(
        wa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-end", className: m(J && Et), children: Q }),
      /* @__PURE__ */ a(
        wa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: Jt ? Se ?? ot : ot,
          onOpenChange: Ht,
          onCloseAutoFocus: (R) => {
            var W;
            Ot.current && (Ot.current = !1, R.preventDefault(), (W = ze.current) == null || W.focus());
          },
          className: m(J && Et),
          modal: !0,
          align: "start"
  ...
  const [Wt, Fe] = C(null), [Sr, Ai] = C(null), [Dr, Ii] = C(null), Pi = 200, [Vi, Li] = C(!1);
  Y(() => {
    if (!Dr || typeof ResizeObserver > "u") return;
    const R = new ResizeObserver(([W]) => {
      Li(W.contentRect.width < Pi);
    });
    return R.observe(Dr), () => R.disconnect();
  }, [Dr]);
  const uo = P(
    (R) => {
      Ve(R), lr(ot), dr(nt), Tr(n), T(!1), pt(R);
    },
    [ot, nt, n]
  ), po = P(() => {
    kt !== void 0 && (kt === "range" ? (Se && (g == null || g(Se)), Le && (h == null || h(Le))) : kt === "selectedBooks" && i(wr), it(kt), pt(void 0), Ve(void 0));
  }, [
    kt,
    Se,
    Le,
    ...
    R || (pt(void 0), Ve(void 0));
  }, []), ho = P((R) => {
    var W;
    R.preventDefault(), (W = Yt.current) == null || W.focus();
  }, []), go = (R) => t === R ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ge, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !N && /* @__PURE__ */ a(Ct, { children: D }),
      l === "dropdown" ? /* @__PURE__ */ u(xe, { open: Nt, onOpenChange: T, children: [
        ...
        /* @__PURE__ */ a(
          ke,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ia, { container: Dr, children: [
              xt.map(({ value: R, label: W, dropdownLabel: Lt, scrRefSuffix: pr, id: Fi }) => /* @__PURE__ */ u(
                Ue,
                {
                  ref: ft(R),
                  ...
                  children: [
                    t === R && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ge, { className: "tw:h-4 tw:w-4" }) }),
                    j(Lt ?? W, pr, Vi)
                  ]
                },
                Fi
              ...
              x && /* @__PURE__ */ u(st, { children: [
                /* @__PURE__ */ a(qe, {}),
                /* @__PURE__ */ a(_r, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Bt }),
                /* @__PURE__ */ a(
                  Ue,
                  {
                    ref: S,
                    ...
                    onSelect: (R) => {
                      ...
                      $t.current || (Lt = (W = Ut.current) == null ? void 0 : W.querySelector("button")) == null || Lt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (R) => {
                          ...
                          W != null && W.closest("button") && (Kt.current = !0, requestAnimationFrame(() => {
                            Kt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          wa,
                          {
                            ...
                            onCloseAutoFocus: (R) => {
                              var W;
                              R.preventDefault(), (W = S.current) == null || W.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(st, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: me(f ?? la, "id") }),
                              /* @__PURE__ */ a(tr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Gn,
        {
          ...
          children: et.map(({ value: R, label: W, scrRefSuffix: Lt, id: pr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Ia, { className: "tw:me-2", value: R, id: pr }),
            /* @__PURE__ */ a(Ct, { htmlFor: pr, children: j(W, Lt) })
          ] }, pr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && _t,
    l === "dropdown" && yt && /* @__PURE__ */ a(Oa, { open: wt === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      Ra,
      {
        ref: Ai,
        onCloseAutoFocus: ho,
        ...
        children: /* @__PURE__ */ u(ia, { container: Sr, children: [
          /* @__PURE__ */ a(Ma, { className: "tw:pe-8", children: /* @__PURE__ */ a(Aa, { children: A }) }),
          b,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(F, { variant: "outline", onClick: () => $r(!1), children: ct }),
            /* @__PURE__ */ a(F, { onClick: po, children: mt })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(Oa, { open: wt === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      Ra,
      {
        ref: Fe,
        onCloseAutoFocus: ho,
        ...
        children: /* @__PURE__ */ u(ia, { container: Wt, children: [
          /* @__PURE__ */ a(Ma, { className: "tw:pe-8", children: /* @__PURE__ */ a(Aa, { children: K }) }),
          _t,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(F, { variant: "outline", onClick: () => $r(!1), children: ct }),
            /* @__PURE__ */ a(F, { ref: ze, onClick: po, children: mt })
          ] })
        ] })
      }
    ) })
...
function Zp({
  ...
  return /* @__PURE__ */ u(
    rr,
    {
      ...
      children: [
        /* @__PURE__ */ a(or, { size: n, className: m("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          ar,
          {
        ...
        /* @__PURE__ */ a(
          nr,
          {
            ...
            style: { zIndex: Qr },
            children: t.map((l) => /* @__PURE__ */ a(ne, { value: `${l}`, children: c[mo(l)] }, `${l}`))
          }
        )
      ]
    }
...
const Si = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(ee, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(ts, { children: /* @__PURE__ */ a(es, { children: Si(
      t,
      e,
      zi(t, c.id),
      o
...
function ja({
  ...
  return /* @__PURE__ */ u(xe, { variant: i, children: [
    /* @__PURE__ */ a(ye, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(F, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Bs, {}) }) }),
    /* @__PURE__ */ a(ke, { align: "start", style: { zIndex: Qr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(xn, { children: [
      /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Qt, { children: Si(e.groups, e.items, d, t) }) }),
...
const $i = ut.forwardRef(({ className: t, ...e }, r) => {
  const o = jt();
  return /* @__PURE__ */ a(
    se.Root,
    {
...
$i.displayName = se.List.displayName;
...
Oi.displayName = se.List.displayName;
const ou = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Trigger,
  {
    ref: r,
    ...e,
...
function oh({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u($i, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(ou, { value: c.value, children: c.value }, c.key)) }),
  ...
  return /* @__PURE__ */ a(
    ge.Trigger,
    {
      ...
      className: m(
        ...
        Ba({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
  ...
  return /* @__PURE__ */ a(
    ge.Item,
    {
      ...
      className: m(
        ...
        // CUSTOM: Apply variant-driven styles from menu context
        Ba({ variant: n.variant, className: t })
      ),
      ...o
    }
  );
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(te, { children: [
      /* @__PURE__ */ a(ee, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(pu, { children: l.label }),
        /* @__PURE__ */ a(hu, { children: Mi(
          t,
          e,
          zi(t, l.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(wu, {}, `separator-${i}`)), d;
  });
};
function gu({
  menuData: t,
  ...
  if (ll(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (f = i.current) == null || f.focus(), gr(i, [g, h]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), gr(s, [g, h]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), gr(c, [g, h]);
        break;
      case "alt+h":
        (E = d.current) == null || E.focus(), gr(d, [g, h]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(nu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(iu, { children: [
      /* @__PURE__ */ a(cu, { ref: l(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        lu,
        {
          style: { zIndex: Qr },
          children: /* @__PURE__ */ a(Qt, { children: Mi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function sh({
  ...
  const l = fu(
    ...
    var E, N, k, _, V, U;
    const v = x !== f ? ((N = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : N[x]) ?? ((_ = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : _.en) : void 0;
    return v ? `${(V = t[f]) == null ? void 0 : V.autonym} (${v})` : (U = t[f]) == null ? void 0 : U.autonym;
  };
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(xe, { children: [
              /* @__PURE__ */ a(ye, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(F, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(yo, {}) }) }),
...
const bu = ea(({ className: t, ...e }, r) => /* @__PURE__ */ a(qs, { size: 35, className: m("tw:animate-spin", t), ...e, ref: r }));
bu.displayName = "Spinner";
function dh({
  id: t,
  isDisabled: e = !1,
  hasError: r = !1,
...
function Nh({
  ...
  return /* @__PURE__ */ u(
    St.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(St.ItemIndicator, { children: /* @__PURE__ */ a(ra, {}) }) }),
        e
      ]
    }
  );
...
export {
  ...
  Qr as Z_INDEX_ABOVE_DOCK,
  dn as Z_INDEX_FOOTNOTE_EDITOR,
  Ui as Z_INDEX_MODAL,
  Ki as Z_INDEX_MODAL_BACKDROP,
