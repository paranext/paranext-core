...
import G, { forwardRef as Eo, useCallback as Ce, useState as ie, useRef as $t, useEffect as Ve, useLayoutEffect as ma, useMemo as hn } from "react";
import { History as Bl, ChevronRight as jl, Check as ko, Circle as Ll, ArrowDownWideNarrow as Fl, Clock as Vl, Bookmark as zl, FilterIcon as Ul, ChevronDown as No, ChevronUp as Hl, ArrowLeftIcon as Gl, ChevronLeftIcon as Wl, ChevronRightIcon as Xl, ArrowRightIcon as Yl, X as ql, Search as Kl, ChevronsUpDown as Jl, CircleCheckIcon as ha, CircleXIcon as ga, CircleHelpIcon as ba, ArrowUpIcon as Zl, ArrowDownIcon as Ql, ArrowUpDownIcon as ec, LoaderCircle as gn, Download as tc, Filter as rc, User as nc, Link as oc, CircleHelp as ac } from "lucide-react";
...
import { getChaptersForBook as cc, compareScrRefs as ao, scrRefToBBBCCCVVV as Fn, formatScrRef as Vn, split as pc } from "platform-bible-utils";
...
const Ro = ge.Root, ji = ge.Trigger, Wc = ge.Group, Tv = ge.Portal, Cv = ge.Sub, Sv = ge.RadioGroup, Xc = G.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ _(
  ge.SubTrigger,
  {
    ref: o,
    className: F(
    ...
    children: [
      r,
      /* @__PURE__ */ u(jl, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
Xc.displayName = ge.SubTrigger.displayName;
const Yc = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u(
  ge.SubContent,
  {
    ref: r,
    className: F(
...
Yc.displayName = ge.SubContent.displayName;
...
function Jc({
  ...
  return /* @__PURE__ */ u("div", { className: F("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: a.map((l) => /* @__PURE__ */ u(
    "div",
    {
      className: F(
...
function Ov({ scrRef: e, handleSubmit: t }) {
  const [r, n] = ie(""), [o, a] = ie(
    ...
    tp.forEach((k) => {
      const S = r.match(k);
      if (S) {
        const [$, V = void 0, H = void 0] = S.slice(1), M = ap($);
  ...
  return Ve(() => {
    ...
    /* @__PURE__ */ u(ji, { asChild: !0, children: /* @__PURE__ */ u(
      Mc,
      {
        ref: h,
        value: r,
...
const ip = To(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ u(n ? hc : "button", { className: F(ip({ variant: t, size: r, className: e })), ref: a, ...o })
);
...
const Vi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u(
  xe.ScrollUpButton,
  {
    ref: r,
...
const xn = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u("thead", { ref: r, className: F("[&_tr]:pr-border-b", e), ...t }));
xn.displayName = "TableHeader";
const En = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u("tbody", { ref: r, className: F("[&_tr:last-child]:pr-border-0", e), ...t }));
...
const qt = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u(
  "td",
  {
    ref: r,
    ...
    /* @__PURE__ */ u("div", { className: "pr-twp pr-font-sans", children: /* @__PURE__ */ _(wn, { children: [
      ...
      /* @__PURE__ */ u(En, { children: (f = h.getRowModel().rows) != null && f.length ? h.getRowModel().rows.map((b) => /* @__PURE__ */ u(
        vt,
        {
          ...
          children: b.getVisibleCells().map((x) => /* @__PURE__ */ u(qt, { children: wr(x.column.columnDef.cell, x.getContext()) }, x.id))
        },
        b.id
      )) : /* @__PURE__ */ u(vt, { children: /* @__PURE__ */ u(qt, { colSpan: e.length, className: "pr-h-24 pr-text-center", children: "No results." }) }) })
    ] }) }),
...
const Yi = G.forwardRef((e, t) => /* @__PURE__ */ u(Ae.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
...
const qi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u(
  Ae.Item,
  {
    ref: r,
    className: F(
...
function Rp() {
  return Na || (Na = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(j) {
      ...
      j === n || j === d || j === a || j === o || j === v || j === g || typeof j == "object" && j !== null && (j.$$typeof === h || j.$$typeof === p || j.$$typeof === i || j.$$typeof === l || j.$$typeof === m || j.$$typeof === b || j.$$typeof === x || j.$$typeof === P || j.$$typeof === f);
    }
    function E(j) {
    ...
    var y = c, C = d, T = l, A = i, B = t, L = m, k = n, S = h, $ = p, V = r, H = a, M = o, z = v, te = !1;
    function Q(j) {
    ...
    de.AsyncMode = y, de.ConcurrentMode = C, de.ContextConsumer = T, de.ContextProvider = A, de.Element = B, de.ForwardRef = L, de.Fragment = k, de.Lazy = S, de.Memo = $, de.Portal = V, de.Profiler = H, de.StrictMode = M, de.Suspense = z, de.isAsyncMode = Q, de.isConcurrentMode = O, de.isContextConsumer = I, de.isContextProvider = U, de.isElement = q, de.isForwardRef = W, de.isFragment = X, de.isLazy = K, de.isMemo = J, de.isPortal = Y, de.isProfiler = Z, de.isStrictMode = ee, de.isSuspense = se, de.isValidElementType = w, de.typeOf = E;
  }()), de;
}
var Ta;
function Zi() {
...
function _p() {
  ...
  return Xn = function(l, c) {
    ...
    function b(O) {
      if (process.env.NODE_ENV !== "production")
        var I = {}, U = 0;
      function q(X, K, J, Y, Z, ee, se) {
        if (Y = Y || g, ee = ee || J, se !== r) {
          if (c) {
            var j = new Error(
        ...
        return K[J] == null ? X ? K[J] === null ? new f("The " + Z + " `" + ee + "` is marked as required " + ("in `" + Y + "`, but its value is `null`.")) : new f("The " + Z + " `" + ee + "` is marked as required in " + ("`" + Y + "`, but its value is `undefined`.")) : null : O(K, J, Y, Z, ee);
      }
      var W = q.bind(null, !1);
      return W.isRequired = q.bind(null, !0), W;
    }
    function x(O) {
      function I(U, q, W, X, K, J) {
        var Y = U[q], Z = M(Y);
        if (Z !== O) {
          var ee = z(Y);
          return new f(
    ...
    function E() {
      function O(I, U, q, W, X) {
        var K = I[U];
        if (!l(K)) {
          var J = M(K);
          return new f("Invalid " + W + " `" + X + "` of type " + ("`" + J + "` supplied to `" + q + "`, expected a single ReactElement."));
        }
        return null;
      }
      return b(O);
    ...
    function y() {
      function O(I, U, q, W, X) {
        ...
        if (!e.isValidElementType(K)) {
          var J = M(K);
          return new f("Invalid " + W + " `" + X + "` of type " + ("`" + J + "` supplied to `" + q + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return b(O);
    ...
    function C(O) {
      function I(U, q, W, X, K) {
        if (!(U[q] instanceof O)) {
          var J = O.name || g, Y = Q(U[q]);
          return new f("Invalid " + X + " `" + K + "` of type " + ("`" + Y + "` supplied to `" + W + "`, expected ") + ("instance of `" + J + "`."));
        }
        return null;
      }
      return b(I);
    ...
    function T(O) {
      ...
      function I(U, q, W, X, K) {
        for (var J = U[q], Y = 0; Y < O.length; Y++)
          if (h(J, O[Y]))
            return null;
    ...
    function A(O) {
      function I(U, q, W, X, K) {
        ...
        var J = U[q], Y = M(J);
        if (Y !== "object")
          return new f("Invalid " + X + " `" + K + "` of type " + ("`" + Y + "` supplied to `" + W + "`, expected an object."));
        for (var Z in J)
          if (n(J, Z)) {
            var ee = O(J, Z, W, X, K + "." + Z, r);
            if (ee instanceof Error)
    ...
    function B(O) {
      ...
      function q(W, X, K, J, Y) {
        for (var Z = [], ee = 0; ee < O.length; ee++) {
          var se = O[ee], j = se(W, X, K, J, Y, r);
          if (j == null)
            return null;
          j.data && n(j.data, "expectedType") && Z.push(j.data.expectedType);
        }
        var re = Z.length > 0 ? ", expected one of type [" + Z.join(", ") + "]" : "";
        return new f("Invalid " + J + " `" + Y + "` supplied to " + ("`" + K + "`" + re + "."));
      }
      return b(q);
    }
    function L() {
      function O(I, U, q, W, X) {
        return V(I[U]) ? null : new f("Invalid " + W + " `" + X + "` supplied to " + ("`" + q + "`, expected a ReactNode."));
      }
      return b(O);
    }
    function k(O, I, U, q, W) {
      return new f(
        (O || "React class") + ": " + I + " type `" + U + "." + q + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + W + "`."
      );
    }
    function S(O) {
      function I(U, q, W, X, K) {
        var J = U[q], Y = M(J);
        if (Y !== "object")
          return new f("Invalid " + X + " `" + K + "` of type `" + Y + "` " + ("supplied to `" + W + "`, expected `object`."));
        for (var Z in O) {
          var ee = O[Z];
...
function es(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Bp(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
const Fp = nr(s.elementType, Lp), Vp = "exact-prop: ​";
function rs(e) {
...
function Up() {
  return Ma || (Ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var C = i, T = a, A = e, B = c, L = r, k = g, S = v, $ = t, V = o, H = n, M = d, z = m, te = !1, Q = !1;
    function O(D) {
    ...
    fe.ContextConsumer = C, fe.ContextProvider = T, fe.Element = A, fe.ForwardRef = B, fe.Fragment = L, fe.Lazy = k, fe.Memo = S, fe.Portal = $, fe.Profiler = V, fe.StrictMode = H, fe.Suspense = M, fe.SuspenseList = z, fe.isAsyncMode = O, fe.isConcurrentMode = I, fe.isContextConsumer = U, fe.isContextProvider = q, fe.isElement = W, fe.isForwardRef = X, fe.isFragment = K, fe.isLazy = J, fe.isMemo = Y, fe.isPortal = Z, fe.isProfiler = ee, fe.isStrictMode = se, fe.isSuspense = j, fe.isSuspenseList = re, fe.isValidElementType = E, fe.typeOf = y;
  }()), fe;
}
...
function ed(e, t) {
  const r = N.useRef(Ba);
  return r.current === Ba && (r.current = e(t)), r;
}
const td = [];
function rd(e) {
  N.useEffect(e, td);
...
const _d = qe("border", He), Md = qe("borderTop", He), Id = qe("borderRight", He), Ad = qe("borderBottom", He), Dd = qe("borderLeft", He), Bd = qe("borderColor"), jd = qe("borderTopColor"), Ld = qe("borderRightColor"), Fd = qe("borderBottomColor"), Vd = qe("borderLeftColor"), zd = qe("outline", He), Ud = qe("outlineColor"), On = (e) => {
...
Sn(_d, Md, Id, Ad, Dd, Bd, jd, Ld, Fd, Vd, On, zd, Ud);
const Rn = (e) => {
...
Sn(Rn, Pn, $n, Hd, Gd, Wd, Xd, Yd, qd, Kd, Jd, Zd);
function Yt(e, t) {
  return t === "grey" ? t : e;
}
const Qd = ke({
...
const xu = jo(), Va = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Yr({
  defaultTheme: e,
  theme: t,
  themeId: r
...
const $u = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ut = Lu, Fu = ["mode", "contrastThreshold", "tonalOffset"], Ha = {
...
function Xu(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = he(e, Fu), a = e.primary || Vu(t), i = e.secondary || zu(t), l = e.error || Uu(t), c = e.info || Hu(t), d = e.success || Gu(t), m = e.warning || Wu(t);
  function v(f) {
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((m) => `${m} ${typeof i == "string" ? i : Ya(i)} ${l} ${typeof c == "string" ? c : Ya(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: r
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const w = Oe(h.current), E = (T) => {
      ...
      if ((w.activeElement === d.current || w.activeElement === m.current) && (A = a(h.current)), A.length > 0) {
        var B, L;
        const k = !!((B = b.current) != null && B.shiftKey && ((L = b.current) == null ? void 0 : L.key) === "Tab"), S = A[0], $ = A[A.length - 1];
...
function qf(e) {
  ...
  }), A = N.useCallback(() => o.isTopModal(y()), [o]), B = Pr((M) => {
...
var Me = "top", Xe = "bottom", Ye = "right", Ie = "left", Uo = "auto", Fr = [Me, Xe, Ye, Ie], Zt = "start", Mr = "end", Kf = "clippingParents", Ss = "viewport", ur = "popper", Jf = "reference", ei = /* @__PURE__ */ Fr.reduce(function(e, t) {
  return e.concat([t + "-" + Zt, t + "-" + Mr]);
}, []), Os = /* @__PURE__ */ [].concat(Fr, [Uo]).reduce(function(e, t) {
...
function er(e, t, r) {
  ...
  var i = Bt(e) ? ze(e) : window, l = i.visualViewport, c = !Rs() && r, d = (n.left + (c && l ? l.offsetLeft : 0)) / o, m = (n.top + (c && l ? l.offsetTop : 0)) / a, v = n.width / o, g = n.height / a;
  return {
    width: v,
    height: g,
    top: m,
...
var mm = function(t, r) {
  ...
  })) : t, _s(typeof t != "number" ? t : Ms(t, Fr));
};
function hm(e) {
  var t, r = e.state, n = e.name, o = e.options, a = r.elements.arrow, i = r.modifiersData.popperOffsets, l = Ze(r.placement), c = Wo(l), d = [Ie, Ye].indexOf(l) >= 0, m = d ? "height" : "width";
  if (!(!a || !i)) {
    var v = mm(o.padding, r), g = Go(a), p = c === "y" ? Me : Ie, h = c === "y" ? Xe : Ye, f = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], x = Vr(a), P = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = f / 2 - b / 2, E = v[p], y = P - g[m] - v[h], C = P / 2 - g[m] / 2 + w, T = Nr(E, C, y), A = c;
...
function ri(e) {
  ...
  if (d) {
    var C = Vr(r), T = "clientHeight", A = "clientWidth";
    if (C === ze(r) && (C = Et(r), pt(C).position !== "static" && l === "absolute" && (T = "scrollHeight", A = "scrollWidth")), C = C, o === Me || (o === Ie || o === Ye) && a === Mr) {
      E = Xe;
...
function Sm(e) {
  var t, r = Et(e), n = Xo(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = _t(r.scrollWidth, r.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = _t(r.scrollHeight, r.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -n.scrollLeft + Yo(e), c = -n.scrollTop;
...
function Is(e) {
  return ["html", "body", "#document"].indexOf(tt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && qo(e) ? e : Is(Mn(e));
}
function Tr(e, t) {
  var r;
  t === void 0 && (t = []);
  var n = Is(e), o = n === ((r = e.ownerDocument) == null ? void 0 : r.body), a = ze(n), i = o ? [a].concat(a.visualViewport || [], qo(n) ? n : []) : n, l = t.concat(i);
  return o ? l : (
...
function oi(e, t, r) {
  return t === Ss ? mo(Cm(e, r)) : Bt(t) ? Om(t, r) : mo(Sm(Et(e)));
}
function Rm(e) {
  var t = Tr(Mn(e)), r = ["absolute", "fixed"].indexOf(pt(e).position) >= 0, n = r && Ge(e) ? Vr(e) : e;
  return Bt(n) ? t.filter(function(o) {
    return Bt(o) && Ps(o, n) && tt(o) !== "body";
  }) : [];
}
function Pm(e, t, r, n) {
...
function Ir(e, t) {
  ...
  if (g === ur && k) {
    ...
    Object.keys(L).forEach(function($) {
      var V = [Ye, Xe].indexOf($) >= 0 ? 1 : -1, H = [Me, Xe].indexOf($) >= 0 ? "y" : "x";
      L[$] += S[H] * V;
    });
  }
  return L;
...
function Mm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    ...
    }, []), y = t.rects.reference, C = t.rects.popper, T = /* @__PURE__ */ new Map(), A = !0, B = E[0], L = 0; L < E.length; L++) {
    ...
    if (A)
      for (var O = h ? 3 : 1, I = function(X) {
        var K = E.find(function(J) {
          var Y = T.get(J);
          if (Y)
            return Y.slice(0, X).every(function(Z) {
              return Z;
            });
        });
        if (K)
...
function Um(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, d = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, f = h === void 0 ? 0 : h, b = Ir(t, {
    ...
    padding: v,
    altBoundary: m
  }), x = Ze(t.placement), P = tr(t.placement), w = !P, E = Wo(x), y = zm(E), C = t.modifiersData.popperOffsets, T = t.rects.reference, A = t.rects.popper, B = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, L = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (C) {
    if (a) {
      var $, V = E === "y" ? Me : Ie, H = E === "y" ? Xe : Ye, M = E === "y" ? "height" : "width", z = C[E], te = z + b[V], Q = z - b[H], O = p ? -A[M] / 2 : 0, I = P === Zt ? T[M] : A[M], U = P === Zt ? -A[M] : -T[M], q = t.elements.arrow, W = p && q ? Go(q) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : $s(), K = X[V], J = X[H], Y = Nr(0, T[M], W[M]), Z = w ? T[M] / 2 - O - Y - K - L.mainAxis : I - Y - K - L.mainAxis, ee = w ? -T[M] / 2 + O + Y + J + L.mainAxis : U + Y + J + L.mainAxis, se = t.elements.arrow && Vr(t.elements.arrow), j = se ? E === "y" ? se.clientTop || 0 : se.clientLeft || 0 : 0, re = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, D = z + Z - re - j, le = z + ee - re, Ne = Nr(p ? un(te, D) : te, z, p ? _t(Q, le) : Q);
      C[E] = Ne, S[E] = Ne - z;
    }
    if (l) {
      var Pe, Ee = E === "x" ? Me : Ie, kt = E === "x" ? Xe : Ye, $e = C[y], nt = y === "y" ? "height" : "width", Be = $e + b[Ee], ot = $e - b[kt], Te = [Me, Ie].indexOf(x) !== -1, jt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, Nt = Te ? Be : $e - T[nt] - A[nt] - jt + L.altAxis, or = Te ? $e + T[nt] + A[nt] - jt - L.altAxis : ot, Ur = p && Te ? fm(Nt, $e, or) : Nr(p ? Nt : Be, $e, p ? or : ot);
      C[y] = Ur, S[y] = Ur - $e;
    }
    t.modifiersData[n] = S;
  }
...
function Ym(e, t, r) {
  ...
  qo(a)) && (l = Wm(t)), Ge(t) ? (c = er(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Yo(a))), {
    ...
    var m = {
      ...
      setOptions: function(x) {
        ...
        f(), m.options = Object.assign({}, a, m.options, P), m.scrollParents = {
          reference: Bt(l) ? Tr(l) : l.contextElement ? Tr(l.contextElement) : [],
          popper: Tr(c)
        };
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (li(P, w)) {
            m.rects = {
              reference: Ym(P, Vr(w), m.options.strategy === "fixed"),
              popper: Go(w)
            ...
            for (var E = 0; E < m.orderedModifiers.length; E++) {
              ...
              var y = m.orderedModifiers[E], C = y.fn, T = y.options, A = T === void 0 ? {} : T, B = y.name;
...
var eh = [km, Vm, xm, pm, Lm, Im, Hm, bm, Dm], th = /* @__PURE__ */ Qm({
  defaultModifiers: eh
});
const Ds = "Popper";
function rh(e) {
...
const sh = () => dt({
  ...
  const C = ah(m, i), [T, A] = N.useState(C), [B, L] = N.useState(fn(o));
  N.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && B && In(B) && B.nodeType === 1) {
...
`));
  ...
  const S = sh(), $ = (n = h.root) != null ? n : "div", V = Dt({
    elementType: $,
  ...
  const A = !m && c && (!f || w) ? "none" : void 0, B = f ? {
    in: m,
    onEnter: y,
    onExited: C
  } : void 0;
...
}, pi = hh, gh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], bh = Re(Bs, {
  name: "MuiPopper",
  slot: "Root",
...
const Us = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const C = ut({
    ...
    children: A
  }), Ne = zr(), Pe = Ne.direction === "rtl", [Ee, kt] = N.useState(), [$e, nt] = N.useState(null), Be = N.useRef(!1), ot = V || Q, Te = br(), jt = br(), Nt = br(), or = br(), [Ur, ea] = is({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const ta = (ne) => {
    ...
    (ne) => {
      di.start(800 + I, () => {
        Kr = !1;
      }), ea(!1), q && at && q(ne), Te.start(Ne.transitions.duration.shortest, () => {
        Be.current = !1;
      });
    }
  ), Dn = (ne) => {
    Be.current && ne.type !== "touchstart" || (Ee && Ee.removeAttribute("title"), jt.clear(), Nt.clear(), M || Kr && z ? jt.start(Kr ? z : M, () => {
      ta(ne);
    }) : ta(ne));
  }, ra = (ne) => {
    jt.clear(), Nt.start(I, () => {
  ...
  N.useEffect(() => {
    if (!at)
      return;
    function ne(je) {
      (je.key === "Escape" || je.key === "Esc") && Gr(je);
    }
  ...
  !se && se !== 0 && (at = !1);
  const Bn = N.useRef(), Pl = (ne) => {
    const je = le.props;
    je.onMouseMove && je.onMouseMove(ne), fr = {
      x: ne.clientX,
      y: ne.clientY
    }, Bn.current && Bn.current.update();
  }, ir = {}, jn = typeof se == "string";
  k ? (ir.title = !at && jn && !$ ? se : null, ir["aria-describedby"] = at ? An : null) : (ir["aria-label"] = jn ? se : null, ir["aria-labelledby"] = at && !jn ? An : null);
...
`));
  const $l = N.useMemo(() => {
    ...
    return (ne = Y.popperOptions) != null && ne.modifiers && (je = je.concat(Y.popperOptions.modifiers)), R({}, Y.popperOptions, {
      modifiers: je
    });
  }, [$e, Y]), lr = R({}, C, {
    isRtl: Pe,
    ...
    touch: Be.current
  }), Ln = Eh(lr), pa = (n = (o = ee.popper) != null ? o : B.Popper) != null ? n : kh, da = (a = (i = (l = ee.transition) != null ? l : B.Transition) != null ? i : j) != null ? a : vo, ua = (c = (d = ee.tooltip) != null ? d : B.Tooltip) != null ? c : Nh, fa = (m = (v = ee.arrow) != null ? v : B.Arrow) != null ? m : Th, _l = vr(pa, R({}, Y, (g = Z.popper) != null ? g : L.popper, {
    className: Se(Ln.popper, Y == null ? void 0 : Y.className, (p = (h = Z.popper) != null ? h : L.popper) == null ? void 0 : p.className)
...
const Bh = Xs, jh = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Qn(e, t, r) {
...
const qs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const f = (w) => {
    ...
    if (y === "ArrowDown")
      ...
      const T = h.current, A = y.toLowerCase(), B = performance.now();
      T.keys.length > 0 && (B - T.lastTime > 500 ? (T.keys = [], T.repeating = !0, T.previousKeyMatched = !0) : T.repeating && A !== T.keys[0] && (T.repeating = !1)), T.lastTime = B, T.keys.push(A);
      const L = C && !T.repeating && Ys(C, T);
...
const Lh = qs, Fh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Vh = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  } = t, w = he(t, Fh), E = N.useRef(null), y = We(E, l.ref, r), C = (V) => (H) => {
    if (V) {
      const M = E.current;
      H === void 0 ? V(M) : V(M, H);
    }
...
const qh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Kh = (e) => {
  ...
  const J = (n = (o = V == null ? void 0 : V.root) != null ? o : x.Root) != null ? n : Jh, Y = (a = (i = V == null ? void 0 : V.backdrop) != null ? i : x.Backdrop) != null ? a : m, Z = (l = $ == null ? void 0 : $.root) != null ? l : P.root, ee = (c = $ == null ? void 0 : $.backdrop) != null ? c : P.backdrop, se = Dt({
    elementType: J,
    externalSlotProps: Z,
  ...
  return !L && !S && (!q || U) ? null : /* @__PURE__ */ u(_r, {
    ref: O,
    container: f,
    disablePortal: C,
    children: /* @__PURE__ */ _(J, R({}, se, {
      children: [!B && m ? /* @__PURE__ */ u(Y, R({}, j)) : null, /* @__PURE__ */ u(dn, {
        disableEnforceFocus: E,
        disableAutoFocus: w,
        disableRestoreFocus: T,
        isEnabled: I,
...
const cg = (e) => {
  ...
  } = i, L = he(i.TransitionProps, ig), k = he(i, sg), S = (n = E == null ? void 0 : E.paper) != null ? n : P, $ = N.useRef(), V = We($, S.ref), H = R({}, i, {
    anchorOrigin: d,
    anchorReference: v,
    elevation: f,
    marginThreshold: b,
...
`));
    ...
    const kt = Pe + D.height, $e = Ee + D.width, nt = Jt(rn(c)), Be = nt.innerHeight - b, ot = nt.innerWidth - b;
    if (b !== null && Pe < b) {
      const Te = Pe - b;
...
`)), b !== null && Ee < b) {
  ...
  N.useEffect(() => (B && window.addEventListener("scroll", U), () => window.removeEventListener("scroll", U)), [c, B, U]);
  const q = (re, D) => {
    A && A(re, D), U();
  }, W = () => {
    I(!1);
  ...
  const K = h || (c ? Oe(rn(c)).body : void 0), J = (o = w == null ? void 0 : w.root) != null ? o : pg, Y = (a = w == null ? void 0 : w.paper) != null ? a : el, Z = Dt({
    elementType: Y,
...
const fg = ["onEntering"], mg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], hg = {
  ...
  const a = ut({
    ...
    TransitionProps: E,
    variant: x
  }), B = bg(A), L = i && !d && g, k = N.useRef(null), S = (Q, O) => {
...
function Ng({
  ...
  Ve(() => {
    if (c) {
      ...
      if (E) {
        const y = E.getBoundingClientRect(), C = window.scrollY, T = window.scrollX, A = y.top + C + E.clientHeight, B = y.left + T;
        b({ top: A, left: B });
      }
    }
  }, [c, o]);
...
function Mv({
  ...
  }, B = (k, S) => k.getIsGrouped() ? "" : F("banded-row", S % 2 === 0 ? "even" : "odd"), L = (k, S, $) => {
...
), ol = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u($i.Root, { ref: r, className: F($g(), e), ...t }));
...
function _g({
  ...
  return /* @__PURE__ */ _("div", { className: F("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": n }), children: [
    ...
    /* @__PURE__ */ u("p", { className: F({ "pr-hidden": !o }), children: o })
  ] });
}
...
const Bg = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u(
  De.List,
  {
    ref: r,
    className: F(
...
const Fv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u(
  De.Trigger,
  {
    ref: r,
    ...t,
...
)), jg = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u(
  De.Content,
  {
    ref: r,
    className: F(
  ...
  return Ve(
    ...
    /* @__PURE__ */ u(En, { children: l.map((d) => /* @__PURE__ */ _(
      vt,
      {
        ...
        children: [
          /* @__PURE__ */ u(qt, { children: `${me.bookNumberToEnglishName(d.reference.bookNum)} ${d.reference.chapterNum}:${d.reference.verseNum}` }),
          /* @__PURE__ */ u(qt, { children: d.snippet })
        ]
      },
      d.key
    )) })
...
function Vv({
  ...
  const l = r["%webView_characterInventory_characters_all%"], c = r["%webView_characterInventory_characters_approved%"], d = r["%webView_characterInventory_characters_unapproved%"], m = r["%webView_characterInventory_characters_unknown%"], v = r["%webView_inventory_scope_book%"], g = r["%webView_inventory_scope_chapter%"], p = r["%webView_inventory_scope_verse%"], h = r["%webView_inventory_filter_text%"], [f, b] = ie([]), [x, P] = ie([]), [w, E] = ie(void 0), [y, C] = ie("book"), [T, A] = ie("all"), [B, L] = ie(""), [k, S] = ie([]), [$, V] = ie(""), H = (M, z) => {
    S((te) => {
      ...
      return M.forEach((O) => {
        ...
        let I = [...O];
        return M.forEach((U) => {
          z === !0 ? I.includes(U) || I.push(U) : I = I.filter((q) => q !== U);
  ...
  }, [f, x, w, T, B]), /* @__PURE__ */ _("div", { className: "pr-twp", children: [
  ...
  return /* @__PURE__ */ u(
    ve,
    {
      ...
      children: e ? /* @__PURE__ */ u(gn, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ _(yt, { children: [
        /* @__PURE__ */ u(tc, { size: 25, className: F("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
...
const Ab = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Db = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, kl = [al, il, sl, ll, pl, cl, dl, ul, vl, xl, yl, El], Bb = [...kl, /^[^\n]+(?:  \n|\n{2,})/, wo, xo];
function jb(e) {
...
var ae;
function Gb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || jb, t.namedCodesToUnicode = t.namedCodesToUnicode ? Pt({}, yi, t.namedCodesToUnicode) : yi;
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(f, b, x) {
      ...
      if (P !== -1) {
        const w = function(T) {
          return T.indexOf("-") !== -1 && T.match(ab) === null && (T = T.replace(pb, function(A, B) {
          ...
          return T === "style" ? A.split(/;\s?/).reduce(function(B, L) {
            const k = L.slice(0, L.indexOf(":"));
            return B[k.replace(/(-[a-z])/g, (S) => S[1].toUpperCase())] = L.slice(k.length + 1).trim(), B;
...
` }, paragraph: { t: Vb, i: ae.LOW, l: eo, h: (p, h, f) => n("p", { key: f.k }, h(p.v, f)) }, ref: { t: mt(db), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: ro }, refImage: { t: ht(ub), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, f) => n("img", { key: f.k, alt: p.D, src: Gt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: mt(fb), i: ae.MAX, l: (p, h, f) => ({ v: h(p[1], f), Z: h(p[0].replace(mb, "\\$1"), f), P: p[2] }), h: (p, h, f) => l[p.P] ? n("a", { key: f.k, href: Gt(l[p.P].B), title: l[p.P].F }, h(p.v, f)) : n("span", { key: f.k }, h(p.Z, f)) }, table: { t: it(ul), i: ae.HIGH, l: Fb, h: (p, h, f) => n("table", { key: f.k }, n("thead", null, n("tr", null, p.L.map(function(b, x) {
  ...
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: hr(wo), i: ae.HIGH, l(p, h, f) {
    const [, b] = p[3].match(Pb), x = new RegExp(`^${b}`, "gm"), P = p[3].replace(x, ""), w = (E = P, Bb.some((A) => A.test(E)) ? Ub : nn);
    var E;
      ...
      for (; b; ) {
        ...
        for (; E < h.length; ) {
          ...
          if (T) {
            ...
            const B = C.l(T, f, x);
            B.type == null && (B.type = y), P.push(B), w = A;
            break;
          }
          E++;
        }
...
var Yb = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(Yb || {});
function Xv({ id: e, groups: t }) {
  return /* @__PURE__ */ u("div", { id: e, children: /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ u(ji, { asChild: !0, children: /* @__PURE__ */ u(Xb, {}) }),
    /* @__PURE__ */ u(vn, { children: t.map((r) => /* @__PURE__ */ _("div", { children: [
      /* @__PURE__ */ u(Ar, { children: r.label }),
      /* @__PURE__ */ u(Wc, { children: r.items.map((n) => /* @__PURE__ */ u("div", { children: n.itemType === 0 ? /* @__PURE__ */ u(Po, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ u(Fi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ u(yn, {})
    ] }, r.label)) })
  ] }) });
}
function Yv({ id: e, message: t }) {
...
function qv({
  ...
  const a = new Intl.NumberFormat("en-GB", {
    notation: "compact",
      ...
      children: [
        ...
        /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            ...
            /* @__PURE__ */ u("span", { className: "pr-text-xs pr-font-semibold pr-text-gray-700", children: a })
          ] }),
          /* @__PURE__ */ u("span", { className: "pr-text-xs pr-text-gray-500", children: "USERS" })
        ] }),
        /* @__PURE__ */ u("div", { className: "pr-mx-2 pr-h-10 pr-border-l pr-border-gray-300" }),
        /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ u("div", { className: "pr-flex pr-items-center", children: n.slice(0, 3).map((l) => /* @__PURE__ */ u(
            "span",
            {
...
function Kv({
  ...
  const a = (c, d = 2) => {
    if (c === 0)
      return "0 Bytes";
    const m = 1024, v = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], g = Math.floor(Math.log(c) / Math.log(m));
    return `${parseFloat((c / m ** g).toFixed(d))} ${v[g]}`;
  }, l = ((c) => {
  ...
  return /* @__PURE__ */ u("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ _("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ u(qb, { versionHistory: o }),
    ...
    /* @__PURE__ */ _("div", { className: "pr-md:mt-0 pr-mt-4 pr-flex-1 pr-space-y-3", children: [
      ...
      /* @__PURE__ */ _("div", { className: "pr-flex pr-items-start pr-justify-between pr-pr-4 pr-text-xs pr-text-gray-600", children: [
        /* @__PURE__ */ _("p", { className: "pr-flex pr-flex-col pr-justify-start", children: [
          ...
          /* @__PURE__ */ u("span", { className: "pr-font-semibold", children: a(r) })
        ] }),
        /* @__PURE__ */ u("div", { className: "pr-flex pr-w-3/4 pr-items-center pr-justify-between pr-text-xs pr-text-gray-600", children: /* @__PURE__ */ _("p", { className: "pr-flex pr-flex-col pr-justify-start", children: [
          ...
          /* @__PURE__ */ u("span", { className: "pr-font-semibold", children: l.join(", ") })
        ] }) })
      ] })
    ] })
  ] }) });
...
const Qb = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u("p", { ref: r, className: F("pr-text-sm pr-text-muted-foreground", e), ...t }));
Qb.displayName = "CardDescription";
const ev = G.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ u("div", { ref: r, className: F("pr-p-6 pr-pt-0", e), ...t })
);
ev.displayName = "CardContent";
const tv = G.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ u("div", { ref: r, className: F("pr-flex pr-items-center pr-p-6 pr-pt-0", e), ...t })
);
...
), nv = G.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ u("div", { ref: n, role: "alert", className: F(rv({ variant: t }), e), ...r }));
...
const av = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ u("div", { ref: r, className: F("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
...
export {
  ...
  Dg as VerticalTabs,
  jg as VerticalTabsContent,
  Bg as VerticalTabsList,
