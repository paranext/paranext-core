        ...
        children: [
          ...
          Na.map(
            (E, R) => x(E).length > 0 && /* @__PURE__ */ $("div", { children: [
              /* @__PURE__ */ d(Vr, { className: "pr-font-semibold pr-text-foreground/80", children: dp[E] }),
...
const _r = ke.Root, wp = ke.Group, Ir = ke.Value, Zt = X.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  ke.Trigger,
  {
    ref: n,
    className: B(
...
function Lu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const O = Fc(i, P({
      ...
      if (process.env.NODE_ENV !== "production") {
        let E;
        c && (E = `${c}${tt(f || "")}`), E === void 0 && (E = `Styled(${ld(i)})`), F.displayName = E;
      }
...
function $m(e) {
  ...
  if (!(!a || !i)) {
    var v = Pm(o.padding, r), g = Yo(a), p = c === "y" ? Me : Ae, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], x = Xr(a), O = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, k = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + w, S = Rr(k, T, y), I = c;
...
function Lr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? um : l, f = r.rootBoundary, m = f === void 0 ? Is : f, v = r.elementContext, g = v === void 0 ? br : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, x = Bs(typeof b != "number" ? b : Ls(b, Wr)), O = g === br ? fm : br, w = e.rects.popper, k = e.elements[h ? O : g], y = Wm(Ft(k) ? k : k.contextElement || Tt(e.elements.popper), c, m, i), T = ar(e.elements.reference), S = Vs({
    reference: T,
    element: w,
    strategy: "absolute",
    placement: o
...
function qm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, x = Qe(b), O = x === b, w = c || (O || !h ? [ln(b)] : Ym(b)), k = [b].concat(w).reduce(function(U, K) {
...
function ah(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Lr(t, {
    ...
    padding: v,
    altBoundary: m
  }), x = Qe(t.placement), O = ir(t.placement), w = !O, k = qo(x), y = oh(k), T = t.modifiersData.popperOffsets, S = t.rects.reference, I = t.rects.popper, A = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, F = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (T) {
    ...
    if (l) {
      var $e, Ee = k === "x" ? Me : Ae, St = k === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + b[Ee], at = _e - b[St], Se = [Me, Ae].indexOf(x) !== -1, Vt = ($e = E == null ? void 0 : E[y]) != null ? $e : 0, Ct = Se ? Be : _e - S[ot] - I[ot] - Vt + F.altAxis, cr = Se ? _e + S[ot] + I[ot] - Vt - F.altAxis : at, Kr = p && Se ? Rm(Ct, _e, cr) : Rr(p ? Ct : Be, _e, p ? cr : at);
      T[y] = Kr, R[y] = Kr - _e;
    }
    t.modifiersData[n] = R;
  }
...
const Eh = () => ut({
  ...
  } = t, b = ge(t, yh), x = N.useRef(null), O = We(x, r), w = N.useRef(null), k = We(w, g), y = N.useRef(k);
  jt(() => {
    y.current = k;
...
`));
  ...
  const R = Eh(), _ = (n = h.root) != null ? n : "div", z = Lt({
    elementType: _,
...
const Ph = {
  ...
  } = t, x = ge(t, Rh), O = kr(), w = N.useRef(), k = Yr(), y = N.useRef(null), T = We(y, a.ref, r), S = (H) => (D) => {
    if (H) {
      const G = y.current;
      D === void 0 ? H(G) : H(G, D);
    }
...
`));
  const Vl = N.useMemo(() => {
    ...
    touch: Be.current
  }), zn = Bh(fr), fa = (n = (o = ee.popper) != null ? o : A.Popper) != null ? n : Lh, ma = (a = (i = (l = ee.transition) != null ? l : A.Transition) != null ? i : L) != null ? a : ko, ha = (c = (f = ee.tooltip) != null ? f : A.Tooltip) != null ? c : Fh, ga = (m = (v = ee.arrow) != null ? v : A.Arrow) != null ? m : Vh, zl = Er(fa, P({}, J, (g = Q.popper) != null ? g : F.popper, {
...
const tg = tl, rg = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], ng = {
  ...
  } = t, w = ge(t, rg), k = N.useRef(null), y = We(k, l.ref, r), T = (z) => (H) => {
    if (z) {
      const D = k.current;
      H === void 0 ? z(D) : z(D, H);
    }
...
const Tg = (e) => {
  ...
  } = i, F = ge(i.TransitionProps, kg), E = ge(i, Eg), R = (n = k == null ? void 0 : k.paper) != null ? n : O, _ = N.useRef(), z = We(_, R.ref), H = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
const Rg = ["onEntering"], Pg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], $g = {
  ...
  const a = ft({
    ...
    slots: O = {},
    slotProps: w = {}
  } = a, k = ge(a.TransitionProps, Rg), y = ge(a, Pg), T = Yr(), S = T.direction === "rtl", I = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: k,
    variant: x
  }), A = Ig(I), F = i && !f && g, E = N.useRef(null), R = (V, C) => {
    ...
    !t && /* @__PURE__ */ $(
      _r,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Qt, { position: "item-aligned", children: /* @__PURE__ */ d(wp, { children: T.map((E) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
var ae;
function tv(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Yb, t.namedCodesToUnicode = t.namedCodesToUnicode ? It({}, Ei, t.namedCodesToUnicode) : Ei;
...
` }, paragraph: { t: Jb, i: ae.LOW, l: oo, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: gt(xb), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: io }, refImage: { t: bt(kb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Yt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: gt(Eb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(Nb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Yt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: st(kl), i: ae.HIGH, l: Kb, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, x) {
  ...
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: wr(No), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(Fb), x = new RegExp(`^${b}`, "gm"), O = p[3].replace(x, ""), w = (k = O, Xb.some((I) => I.test(k)) ? Qb : pn);
    var k;
