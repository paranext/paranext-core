...
var Kt = (t, e, r) => Xi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as ge, a as Cr, C as Te, u as Do, T as Mt, b as Ot, d as It, e as $t, A as we, P as Ae, f as Je, B as J, h as Ve, i as Le, j as je, k as Ce, x as Ji, l as Zi, m as Qi, I as ts, n as no, r as be, o as es, p as _n, q as la, s as da, L as Ct, R as io, t as ea, D as La, v as ja, w as Ba, y as Fa, z as Nn, E as Gr, F as so, G as Cn, H as co, J as Ye, K as Rr, M as Be, N as Fe, O as Ue, S as zr, Q as ir, U as rs, V as Or, W as Xe, X as Ie, Z as Ze, Y as Me, _ as sr, $ as lo, a0 as wo, a1 as ra, a2 as uo, a3 as En, a4 as as, a5 as os, a6 as ns, a7 as Ua, a8 as Tn, a9 as wa, aa as is, ab as Sn, ac as ss, ad as cs, ae as ls, af as Mo, ag as ds, ah as ws, ai as us, aj as ps, ak as Rn, al as zn, am as po, an as hs, ao as Dn, ap as _a, aq as Oo, ar as Na, as as gs, at as fs, au as ms, av as vs, aw as bs, ax as Ir, ay as ho, az as xs, aA as ys } from "./resizable-4-0w1we4.js";
...
import { Section as Nt, getChaptersForBook as ec, formatScrRef as _e, formatReplacementString as Oe, getSectionForBook as Wr, formatRelativeDate as rc, sanitizeHtml as fo, NumberFormat as Vn, formatBytes as ac, getCurrentLocale as oc, usfmMarkers as Yr, isPlatformError as nc, ABORTED as ic, getErrorMessage as sc, getFormatCallerFunction as cc, deepEqual as lc, isString as Ao, compareScrRefs as Ga, scrRefToBBBCCCVVV as Ca, defaultScrRef as Ea, formatScrRefRange as dc, getLocalizeKeyForScrollGroupId as Vo, formatReplacementStringToArray as Lo, collectUsjMarkers as wc } from "platform-bible-utils";
import qt, { useRef as U, useMemo as A, createContext as $r, useContext as ua, useState as _, useEffect as Y, useCallback as j, useImperativeHandle as uc, useLayoutEffect as Jt, Component as pc, createElement as jo, Suspense as hc, forwardRef as Ln, useId as Bo, Fragment as Pr } from "react";
...
import { Avatar as xo, Select as Gt, Checkbox as Ho, Slot as Vr, Tabs as ue, Menubar as xe, ContextMenu as Pt, Progress as qo, Slider as Fr, Switch as Go } from "radix-ui";
...
function Sa({
  ...
  const E = be(), B = Dl(), [I, z] = _(!1), [K, W] = _(""), [F, Q] = _(""), [C, tt] = _("books"), [D, M] = _(void 0), [H, it] = _(
    void 0
  ), [ot, ut] = _(void 0), [Qt, Z] = _(!1), [dt, vt] = _(!1), ht = U(null), Et = U(!1), xt = U(void 0), lt = U(void 0), Wt = U(void 0), te = U(void 0), At = U({}), Rt = U({}), ft = j(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
  ...
  const { otLong: O, ntLong: rt, dcLong: st, extraLong: mt } = {
    ...
    [t.book, i, B]
  ), Lr = `${t.chapterNum}:${t.verseNum}`, mr = j((k) => (et) => {
    At.current[k] = et;
  }, []), He = j((k) => (et) => {
    Rt.current[k] = et;
  }, []), Re = A(
    () => Al(F),
    [F]
  ), jr = A(() => !w || !V || !V.chapterNum || !Re ? !1 : w(V.book, V.chapterNum) > 0, [w, V, Re]), zo = C === "books" && !Qt && !F.trim() && Xt.size > 0, va = j(
    (k) => p ? Yo(k, p) : !1,
    [p]
  ), vr = j(
    (k) => (et) => p ? Vl(k, et, p) : !1,
    ...
    (k) => {
      ...
      if ((C === "chapters" || C === "verses") && (k.key === " " || k.key === "Enter")) {
        ...
        const yt = (ke = xt.current) == null ? void 0 : ke.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (yt) {
          k.preventDefault(), k.stopPropagation(), yt.click();
          return;
        }
      }
      ...
      if (C === "verses" && Ft) {
        ...
        switch (k.key) {
          case "ArrowLeft":
            gt !== 0 && (re = gt > 1 ? gt - 1 : yt);
            break;
          case "ArrowRight":
            gt !== 0 && (re = gt < yt ? gt + 1 : 1);
            break;
          case "ArrowUp":
            re = gt === 0 ? yt : Math.max(1, gt - ze);
            break;
          case "ArrowDown":
            re = gt === 0 ? 1 : Math.min(yt, gt + ze);
            break;
          default:
            return;
        }
        re !== gt && (k.preventDefault(), k.stopPropagation(), W(
          `${G} ${we[G] || ""} ${nt}:${re}`
        ), setTimeout(() => {
          const yr = Rt.current[re];
      ...
      if ((C === "chapters" || C === "books" && V) && Ft) {
        ...
        switch (k.key) {
          case "ArrowLeft":
            nt !== 0 && (gt = nt > 1 ? nt - 1 : yt);
            break;
          case "ArrowRight":
            nt !== 0 && (gt = nt < yt ? nt + 1 : 1);
            break;
          case "ArrowUp":
            gt = nt === 0 ? yt : Math.max(1, nt - re);
            break;
          case "ArrowDown":
            gt = nt === 0 ? 1 : Math.min(yt, nt + re);
            break;
          default:
            return;
        }
  ...
  return Jt(() => {
    const k = setTimeout(() => {
      if (I && C === "books" && Wt.current && te.current) {
        const et = Wt.current, at = te.current, Ft = at.offsetTop, ke = et.clientHeight, qe = at.clientHeight, P = Ft - ke / 2 + qe / 2;
        et.scrollTo({
          top: Math.max(0, P),
          behavior: "smooth"
        }), W(si(t.book));
        ...
        children: /* @__PURE__ */ u(
          Le,
          {
            ...
            children: [
              ...
              !Qt && /* @__PURE__ */ u(je, { ref: Wt, children: [
                C === "books" && /* @__PURE__ */ u(wt, { children: [
                  ...
                  V && jr && V.chapterNum && w && /* @__PURE__ */ u(wt, { children: [
                  ...
                  V && !jr && cr(V.book) > 1 && /* @__PURE__ */ u(wt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Kl = di ? Jt : Y, Kr = { tag: mo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            ...
            (Zt() !== null || x !== null && x === p.getRootElement()) && f.select();
          }
        }, Kr);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const g = p.parseEditorState(h);
            p.setEditorState(g, Kr);
            break;
          }
          case "object":
...
const ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function ld(t) {
  ...
  if (me(e)) r = Ec(e.focus, "next");
    ...
    r = r || Tc(Pe(), "previous").getFlipped().insert(Ar());
  }
...
function dd(t, e, r) {
  ...
  return Ic(o) && aa(283), o.insert(t.isInline() ? Ar().append(t) : t), Fo(Hn(t.getLatest(), "next"), e.direction);
}
function wd(t) {
  const e = Zt();
  if (!me(e)) return !1;
...
let oa, Ne = 0, na = 0, hd = 0, eo = 0, Jr = 0;
function rn(t) {
  if (ct === void 0) return;
  let e = t.n;
...
function Ge(t, e) {
  Ht.call(this, void 0), this.x = t, this.s = void 0, this.g = Jr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function gd(t, e) {
  return new Ge(t, e);
}
...
Ht.prototype.brand = ud, Ht.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ne !== 0 && na === 0 && e.l !== eo && (e.l = eo, oa = { S: e, v: e.v, i: e.i, o: oa });
    })(this), this.v = t, this.i++, Jr++, Ne++;
    try {
...
const No = 0, ao = 1, xi = 2, Ma = 3, Hr = 4, or = 5, Oa = 6, _r = 7;
function Ia(t) {
  return t.id === No;
}
function yi(t) {
...
class yd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Hr && pt(307, String(r.id), String(or)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Hr;
    }(e) || pt(313, String(e.id), String(Hr)), e.initResult;
  }
  getInitPeer(e) {
...
const Eo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
const jd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Bd({ onClear: t }) {
  const [e] = ye();
  return jd(() => fi(e, t), [e, t]), null;
}
const Ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Pi({
  ...
  const [F, Q] = _(hn), [C, tt] = _(), [D, M] = _(), H = o, [it, ot] = _(!1), [ut, Qt] = _(!1), [Z, dt] = _(!1), [vt, ht] = _(!1), [Et, xt] = _(!1), [lt, Wt] = _(T), [te, At] = _(!1), Rt = U(void 0), [ft, Yt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let b = !0;
    return (async () => {
  ...
  const S = j(
    ...
    async (b) => {
      const q = oe(F) ? sa(F) : void 0, O = b.status ? b.assignedUser : C ?? b.assignedUser, rt = await p({
        ...b,
        contents: q,
        assignedUser: O
      });
                        ...
                        Ve,
                        {
                          ...
                          children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(je, { children: x == null ? void 0 : x.map((b) => /* @__PURE__ */ a(
                            Te,
                            {
                              ...
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Zr(b, r) })
                            },
                            b || "unassigned"
                          )) }) })
                        }
...
), ww = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Qr = (t) => ww(fo(t));
function ta({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function uw({
  ...
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), F = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : W, Q = () => {
    const D = o ?? "accept";
    return D === "merged" ? t.mergedText ? /* @__PURE__ */ a(ta, { html: R }) : W : F(D === "reject" ? t.rejectedResultText : t.resultText);
...
function _w({
  ...
  return l ? $ = Array.from({ length: 10 }).map((z, K) => `skeleton-row-${K}`).map((z) => /* @__PURE__ */ a(Me, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(sr, { colSpan: T.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((E = N.getRowModel().rows) == null ? void 0 : E.length) > 0 ? $ = N.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(lo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(wo, { stickyHeader: i, children: N.getHeaderGroups().map((B) => /* @__PURE__ */ a(Me, { children: B.headers.map((I) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : Er(I.column.columnDef.header, I.getContext()) }, I.id)) }, B.id)) }),
...
function Wp({
  ...
  const [m, R] = _("generated"), [y, N] = _("generated"), [T, $] = _("*"), [E, B] = _("*"), [I, z] = _("f"), [K, W] = _(!1), [F, Q] = _(!0), [C, tt] = _(!1), D = U(!1), M = U(""), [H, it] = _(!1), [ot, ut] = _(), [Qt, Z] = _(), [dt, vt] = _(), [ht, Et] = _(), xt = U(null), lt = U(
    void 0
  ), Wt = U(0), te = U(void 0), At = A(
    () => ({
      ...s,
  ...
  Y(() => {
    var q, O;
    let S, L, X;
    D.current = !1, te.current = void 0, Q(!0);
    ...
    if (b && kr("note", b)) {
      ...
      rt === Xa ? st = "generated" : rt === Ja ? st = "hidden" : rt && ($(rt), B(rt)), R(st), N(st), z(((O = b.insert.note) == null ? void 0 : O.style) ?? "f"), S = setTimeout(() => {
        ...
        (mt = h.current) == null || mt.applyUpdate([b]), (kt = h.current) == null || kt.selectNote(0), (St = h.current) == null || St.focus(), L = requestAnimationFrame(() => {
          X = setTimeout(() => {
            var Bt, ee;
            ft() || ((Bt = h.current) == null || Bt.selectNote(0), (ee = h.current) == null || ee.focus());
          }, 0);
        });
      }, 0);
    }
      ...
      if (L && kr("note", L)) {
        ...
        if (st || W(!1), W(
          st === "x" ? !!(mt != null && mt.every((kt) => {
            ...
            const St = ((ee = kt.attributes) == null ? void 0 : ee.char).style;
...
function oh({
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    ...
    Qt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:m-1 tw:flex-1 tw:overflow-auto tw:rounded-md tw:border", children: /* @__PURE__ */ a(
      Yw,
      {
        classNameForText: p,
        occurrenceData: Qt,
...
const eu = "16rem", ru = "3rem", Vi = qt.createContext(void 0);
function ma() {
...
function du({
  ...
  const c = t ? Vr.Root : "button", { state: l } = ma(), d = /* @__PURE__ */ a(
    c,
    {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(lo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(wo, { children: R.getHeaderGroups().map((z) => /* @__PURE__ */ a(Me, { children: z.headers.filter((K) => K.column.columnDef.header).map((K) => (
        ...
        /* @__PURE__ */ a(ra, { colSpan: K.colSpan, className: "tw:sticky top-0", children: K.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
...
function yh({
  ...
  const E = zt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), F = zt(s, "%webView_scope_selector_current_book%"), Q = zt(s, "%webView_scope_selector_choose_books%"), C = zt(s, "%webView_scope_selector_scope%"), tt = zt(s, "%webView_scope_selector_select_books%"), D = zt(s, "%webView_scope_selector_range%"), M = zt(s, "%webView_scope_selector_select_range%"), H = zt(s, "%webView_scope_selector_range_start%"), it = zt(s, "%webView_scope_selector_range_end%"), ot = zt(s, "%webView_scope_selector_ok%"), ut = zt(s, "%webView_scope_selector_cancel%"), Qt = zt(s, "%webView_scope_selector_navigate%"), Z = (P) => {
    if (!m) return;
  ...
  ] }), ht = e ? dt.filter((P) => e.includes(P.value)) : dt, Et = m ?? Ea, xt = h ?? Et, lt = g ?? Et, Wt = () => {
  }, te = U(null), At = U(null), Rt = U(!1), ft = U(null), Yt = U(!1), [Tt, _t] = _(void 0), Vt = U(!1), Lt = U(!1), ie = U(null), Xt = j((P) => {
    if (P) {
    ...
    _t((G) => G === "start" ? void 0 : G), Vt.current && (Vt.current = !1, requestAnimationFrame(() => {
      var nt;
      const G = (nt = te.current) == null ? void 0 : nt.querySelector("button");
      G == null || G.click();
    }));
  }, []), Se = j((P) => {
    if (P) {
  ...
  ), Ut = ht.find((P) => P.value === "selectedBooks"), le = ht.find((P) => P.value === "range"), [pe, S] = _(!1), [L, X] = _(void 0), [b, q] = _(void 0), [O, rt] = _(void 0), [st, mt] = _(void 0), [kt, St] = _([]), Bt = p === "dropdown" && L === "selectedBooks", ee = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  ), Lr = Tt === "end", mr = Tt === "start", He = "tw:text-muted-foreground", Re = p === "dropdown" && L === "range", jr = Re ? rt : ae, va = Re ? mt : x ? V : Wt, vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-start", className: v(Lr && He), children: H }),
      /* @__PURE__ */ a(
        Sa,
        {
  ...
  const [er, Br] = _(null), [rr, ba] = _(null), [ar, xa] = _(null), ya = 200, [ka, k] = _(!1);
  Y(() => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      p === "dropdown" ? /* @__PURE__ */ u(Be, { open: pe, onOpenChange: S, children: [
        ...
        /* @__PURE__ */ a(
          Ue,
          {
            ...
            children: /* @__PURE__ */ u(_a, { container: ar, children: [
              ce.map(({ value: P, label: G, dropdownLabel: nt, scrRefSuffix: yt, id: gt }) => /* @__PURE__ */ u(
                Ye,
                {
                  ref: tr(P),
                  disabled: !!(d != null && d[P]),
                  title: d == null ? void 0 : d[P],
              ...
              R && /* @__PURE__ */ u(wt, { children: [
                /* @__PURE__ */ a(Xe, {}),
                /* @__PURE__ */ a(Or, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Qt }),
                /* @__PURE__ */ a(
                  Ye,
                  {
                    ref: ft,
        ...
        io,
        {
          ...
          children: ht.map(({ value: P, label: G, scrRefSuffix: nt, id: yt }) => {
            const gt = d == null ? void 0 : d[P], re = /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
              /* @__PURE__ */ a(
                ea,
                {
                  className: "tw:me-2",
              ...
              /* @__PURE__ */ a(Ct, { htmlFor: yt, children: vt(G, nt) })
            ] });
            return d ? /* @__PURE__ */ a(
              ji,
              {
...
function oo({
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ue, { align: "start", style: { zIndex: Ze }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Pr, { children: [
...
const Tu = Object.freeze([520, 420, 340]), Ki = qt.forwardRef(
...
const Hi = qt.forwardRef(({ className: t, ...e }, r) => {
  const o = be();
  return /* @__PURE__ */ a(
    ue.Root,
    {
...
const qi = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.List,
  {
    ref: r,
    className: v(
...
const Su = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.Trigger,
  {
    ref: r,
    ...e,
...
)), Gi = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.Content,
  {
    ref: r,
    className: v(
...
function Vh({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: s.map((c) => {
    let l = "upcoming";
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(Pr, { children: [
