...
function Bv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = ce(""), [o, a] = ce(
    ...
    ($) => mp($).filter((k) => {
      const R = he.bookIdToEnglishName(k).toLowerCase(), I = r.replace(/[^a-zA-Z]/g, "").toLowerCase();
      return R.includes(I) || // Match book name
      k.toLowerCase().includes(I);
    }),
    [r]
  ), O = ($) => {
    n($);
    ...
    fp.forEach(($) => {
      const k = r.match($);
      if (k) {
        const [R, I = void 0, U = void 0] = k.slice(1), j = bp(R);
  ...
  }, [g]), /* @__PURE__ */ d("div", { className: "pr-twp pr-flex", children: /* @__PURE__ */ _($o, { modal: !1, open: m, onOpenChange: E, children: [
        ...
        children: [
          ...
          Na.map(
            ($, k) => x($).length > 0 && /* @__PURE__ */ _("div", { children: [
              ...
              Na.length - 1 !== k ? /* @__PURE__ */ d(En, {}) : void 0
            ] }, $)
          )
        ]
      }
...
const _r = Ee.Root, wp = Ee.Group, Ir = Ee.Value, Zt = X.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  Ee.Trigger,
  {
    ref: n,
    className: L(
...
const Qt = X.forwardRef(({ className: e, children: t, position: r = "popper", ...n }, o) => /* @__PURE__ */ d(Ee.Portal, { children: /* @__PURE__ */ _(
  Ee.Content,
  {
    ref: o,
    className: L(
...
Je.displayName = Ee.Item.displayName;
...
function Gp() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = f, S = l, M = i, D = t, V = m, $ = n, k = h, R = p, I = r, U = a, j = o, G = v, te = !1;
    function z(F) {
    ...
    de.AsyncMode = y, de.ConcurrentMode = T, de.ContextConsumer = S, de.ContextProvider = M, de.Element = D, de.ForwardRef = V, de.Fragment = $, de.Lazy = k, de.Memo = R, de.Portal = I, de.Profiler = U, de.StrictMode = j, de.Suspense = G, de.isAsyncMode = z, de.isConcurrentMode = C, de.isContextConsumer = B, de.isContextProvider = W, de.isElement = Y, de.isForwardRef = H, de.isFragment = K, de.isLazy = q, de.isMemo = Z, de.isPortal = J, de.isProfiler = Q, de.isStrictMode = ee, de.isSuspense = ie, de.isValidElementType = w, de.typeOf = E;
  }()), de;
}
var Pa;
function os() {
...
function ad() {
  return Ba || (Ba = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var T = i, S = a, M = e, D = c, V = r, $ = g, k = v, R = t, I = o, U = n, j = f, G = m, te = !1, z = !1;
    function C(A) {
...
const Ad = {
  borderRadius: 4
}, Dd = Ad, jd = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, kt = jd;
function Cr(e, t) {
  return t ? lt(e, t, {
    clone: !1
...
we.propTypes = process.env.NODE_ENV !== "production" ? Rn.reduce((e, t) => (e[t] = kt, e), {}) : {};
we.filterProps = Rn;
process.env.NODE_ENV !== "production" && Hd.reduce((e, t) => (e[t] = kt, e), {});
function Xd(e = 8) {
  if (e.mui)
    return e;
  const t = xs({
    ...
    const O = Fc(i, P({
      ...
      c && g && M.push(($) => {
        ...
        if (!k.components || !k.components[c] || !k.components[c].styleOverrides)
          return null;
        const R = k.components[c].styleOverrides, I = {};
        ...
        const R = tn(P({}, $, {
          defaultTheme: r,
          themeId: t
        })), I = R == null || (k = R.components) == null || (k = k[c]) == null ? void 0 : k.variants;
        return sn({
          variants: I
        }, P({}, $, {
          theme: R
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const w = Re(h.current), E = (S) => {
      ...
      if ((w.activeElement === f.current || w.activeElement === m.current) && (M = a(h.current)), M.length > 0) {
        var D, V;
        const $ = !!((D = b.current) != null && D.shiftKey && ((V = b.current) == null ? void 0 : V.key) === "Tab"), k = M[0], R = M[M.length - 1];
        typeof k != "string" && typeof R != "string" && ($ ? R.focus() : k.focus());
      } else
        S.focus();
    };
...
function $m(e) {
  ...
  if (!(!a || !i)) {
    var v = Pm(o.padding, r), g = Yo(a), p = c === "y" ? Me : Ae, h = c === "y" ? Ye : qe, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], x = Xr(a), O = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, E = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + w, S = Rr(E, T, y), M = c;
...
function si(e) {
  ...
  if (p = k.x, u = k.y, c) {
    var R;
    return Object.assign({}, $, (R = {}, R[E] = O ? "0" : "", R[w] = x ? "0" : "", R.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + u + "px)" : "translate3d(" + p + "px, " + u + "px, 0)", R));
  }
  return Object.assign({}, $, (t = {}, t[E] = O ? u + "px" : "", t[w] = x ? p + "px" : "", t.transform = "", t));
}
function Dm(e) {
...
function Lr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? um : l, f = r.rootBoundary, m = f === void 0 ? Is : f, v = r.elementContext, g = v === void 0 ? br : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, x = Bs(typeof b != "number" ? b : Ls(b, Wr)), O = g === br ? fm : br, w = e.rects.popper, E = e.elements[h ? O : g], y = Wm(Ft(E) ? E : E.contextElement || Nt(e.elements.popper), c, m, i), T = ar(e.elements.reference), S = Vs({
    reference: T,
    element: w,
    strategy: "absolute",
    placement: o
...
function qm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, x = Qe(b), O = x === b, w = c || (O || !h ? [ln(b)] : Ym(b)), E = [b].concat(w).reduce(function(H, K) {
      ...
      var $ = E[V], k = Qe($), R = ir($) === nr, I = [Me, Ye].indexOf(k) >= 0, U = I ? "width" : "height", j = Lr(t, {
        placement: $,
        boundary: m,
        rootBoundary: v,
        altBoundary: g,
      ...
      y[U] > T[U] && (G = ln(G));
      var te = ln(G), z = [];
      if (a && z.push(j[k] <= 0), l && z.push(j[G] <= 0, j[te] <= 0), z.every(function(H) {
        return H;
      })) {
        D = $, M = !1;
        break;
...
function ah(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Lr(t, {
    ...
    padding: v,
    altBoundary: m
  }), x = Qe(t.placement), O = ir(t.placement), w = !O, E = qo(x), y = oh(E), T = t.modifiersData.popperOffsets, S = t.rects.reference, M = t.rects.popper, D = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, V = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
    ...
    mainAxis: 0,
    altAxis: 0
  }, D), $ = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, k = {
    x: 0,
    y: 0
  };
  if (T) {
    if (a) {
      var R, I = E === "y" ? Me : Ae, U = E === "y" ? Ye : qe, j = E === "y" ? "height" : "width", G = T[E], te = G + b[I], z = G - b[U], C = p ? -M[j] / 2 : 0, B = O === nr ? S[j] : M[j], W = O === nr ? -M[j] : -S[j], Y = t.elements.arrow, H = p && Y ? Yo(Y) : {
        width: 0,
        height: 0
      }, K = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : js(), q = K[I], Z = K[U], J = Rr(0, S[j], H[j]), Q = w ? S[j] / 2 - C - J - q - V.mainAxis : B - J - q - V.mainAxis, ee = w ? -S[j] / 2 + C + J + Z + V.mainAxis : W + J + Z + V.mainAxis, ie = t.elements.arrow && Xr(t.elements.arrow), F = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = (R = $ == null ? void 0 : $[E]) != null ? R : 0, A = G + Q - re - F, se = G + ee - re, Te = Rr(p ? gn(te, A) : te, G, p ? Mt(z, se) : z);
      T[E] = Te, k[E] = Te - G;
    }
    if (l) {
      var $e, ke = E === "x" ? Me : Ae, Tt = E === "x" ? Ye : qe, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + b[ke], at = _e - b[Tt], Se = [Me, Ae].indexOf(x) !== -1, Vt = ($e = $ == null ? void 0 : $[y]) != null ? $e : 0, St = Se ? Be : _e - S[ot] - M[ot] - Vt + V.altAxis, cr = Se ? _e + S[ot] + M[ot] - Vt - V.altAxis : at, Kr = p && Se ? Rm(St, _e, cr) : Rr(p ? St : Be, _e, p ? cr : at);
      T[y] = Kr, k[y] = Kr - _e;
    }
    t.modifiersData[n] = k;
  }
...
const kh = () => ut({
  ...
  } = t, b = ge(t, yh), x = N.useRef(null), O = Xe(x, r), w = N.useRef(null), E = Xe(w, g), y = N.useRef(E);
  jt(() => {
    y.current = E;
...
`));
  ...
  const k = kh(), R = (n = h.root) != null ? n : "div", I = Lt({
    elementType: R,
...
const Ph = {
  ...
  const {
  ...
  } = t, x = ge(t, Rh), O = Er(), w = N.useRef(), E = Yr(), y = N.useRef(null), T = Xe(y, a.ref, r), S = (U) => (j) => {
    if (U) {
      const G = y.current;
      j === void 0 ? U(G) : U(G, j);
    }
    ...
    let C;
    u === "auto" ? (C = E.transitions.getAutoHeightDuration(U.clientHeight), w.current = C) : C = G, U.style.transition = [E.transitions.create("opacity", {
      duration: C,
      delay: te
    ...
    let z;
    u === "auto" ? (z = E.transitions.getAutoHeightDuration(U.clientHeight), w.current = z) : z = j, U.style.transition = [E.transitions.create("opacity", {
      duration: z,
      delay: G
    }), E.transitions.create("transform", {
...
const qs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const T = ft({
    ...
    children: M
  }), Te = Yr(), $e = Te.direction === "rtl", [ke, Tt] = N.useState(), [_e, ot] = N.useState(null), Be = N.useRef(!1), at = I || z, Se = Er(), Vt = Er(), St = Er(), cr = Er(), [Kr, na] = us({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const oa = (ne) => {
    ...
    ke || Tt(ne.currentTarget), Al(ne), ia.current === !0 && (sa(!0), Ln(ne));
  }, pa = (ne) => {
    Be.current = !0;
    const Le = se.props;
...
`));
  ...
  const ur = {};
  U || (Ue.onTouchStart = jl, Ue.onTouchEnd = Bl), R || (Ue.onMouseOver = on(da, Ue.onMouseOver), Ue.onMouseLeave = on(ua, Ue.onMouseLeave), at || (ur.onMouseOver = da, ur.onMouseLeave = ua)), k || (Ue.onFocus = on(ca, Ue.onFocus), Ue.onBlur = on(la, Ue.onBlur), at || (ur.onFocus = ca, ur.onBlur = la)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Vl = N.useMemo(() => {
    var ne;
    let Le = [{
    ...
    touch: Be.current
  }), zn = Bh(fr), fa = (n = (o = ee.popper) != null ? o : D.Popper) != null ? n : Lh, ma = (a = (i = (l = ee.transition) != null ? l : D.Transition) != null ? i : F) != null ? a : Eo, ha = (c = (f = ee.tooltip) != null ? f : D.Tooltip) != null ? c : Fh, ga = (m = (v = ee.arrow) != null ? v : D.Arrow) != null ? m : Vh, zl = kr(fa, P({}, J, (g = Q.popper) != null ? g : V.popper, {
    className: Oe(zn.popper, J == null ? void 0 : J.className, (p = (h = Q.popper) != null ? h : V.popper) == null ? void 0 : p.className)
  }), fr), Ul = kr(ma, P({}, re, (u = Q.transition) != null ? u : V.transition), fr), Hl = kr(ha, P({}, (b = Q.tooltip) != null ? b : V.tooltip, {
    className: Oe(zn.tooltip, (x = (O = Q.tooltip) != null ? O : V.tooltip) == null ? void 0 : x.className)
  }), fr), Gl = kr(ga, P({}, (w = Q.arrow) != null ? w : V.arrow, {
    className: Oe(zn.arrow, (E = (y = Q.arrow) != null ? y : V.arrow) == null ? void 0 : E.className)
  }), fr);
  return /* @__PURE__ */ _(N.Fragment, {
...
const tl = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const u = (w) => {
    ...
    if (y === "ArrowDown")
      ...
      S.previousKeyMatched && (V || yr(E, T, !1, c, no, S)) ? w.preventDefault() : S.previousKeyMatched = !1;
    }
    m && m(w);
  }, b = Xe(p, r);
  let x = -1;
...
const tg = tl, rg = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], ng = {
  ...
  } = t, w = ge(t, rg), E = N.useRef(null), y = Xe(E, l.ref, r), T = (I) => (U) => {
    if (I) {
      const j = E.current;
      U === void 0 ? I(j) : I(j, U);
    }
...
const dg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], ug = (e) => {
  ...
  return !V && !k && (!Y || W) ? null : /* @__PURE__ */ d(jr, {
    ref: C,
    container: u,
    disablePortal: T,
...
const Tg = (e) => {
  ...
  } = i, V = ge(i.TransitionProps, Eg), $ = ge(i, kg), k = (n = E == null ? void 0 : E.paper) != null ? n : O, R = N.useRef(), I = Xe(R, k.ref), U = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
`));
    ...
    const Tt = $e + A.height, _e = ke + A.width, ot = rr(cn(c)), Be = ot.innerHeight - b, at = ot.innerWidth - b;
    if (b !== null && $e < b) {
      const Se = $e - b;
      $e -= Se, se.vertical += Se;
...
`)), b !== null && ke < b) {
  ...
  const q = h || (c ? Re(cn(c)).body : void 0), Z = (o = w == null ? void 0 : w.root) != null ? o : Sg, J = (a = w == null ? void 0 : w.paper) != null ? a : il, Q = Lt({
    ...
    ownerState: U,
    className: Oe(j.paper, k == null ? void 0 : k.className)
  }), ee = Lt({
    elementType: Z,
...
const Rg = ["onEntering"], Pg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], $g = {
  ...
  const a = ft({
    ...
    slots: O = {},
    slotProps: w = {}
  } = a, E = ge(a.TransitionProps, Rg), y = ge(a, Pg), T = Yr(), S = T.direction === "rtl", M = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: x
  }), D = Ig(M), V = i && !f && g, $ = N.useRef(null), k = (z, C) => {
...
function qv({
  ...
  const [f, m] = ce([]), [v, g] = ce([{ id: vt, desc: !1 }]), [p, h] = ce(() => e.flatMap((k) => {
    const R = k.source;
    return k.data.map((I) => ({
      ...I,
      source: R
  ...
  const O = Ce(
    ...
    (k) => `${O(k.start, k.end)} ${k.source} ${k.detail}`,
    [O]
  ), E = Pi({
    data: p,
    columns: x,
  ...
  Ge(() => {
    if (l) {
      const k = E.getSelectedRowModel().rowsById, R = Object.keys(k);
      if (R.length === 1) {
  ...
  }, V = (k, R) => k.getIsGrouped() ? "" : L("banded-row", R % 2 === 0 ? "even" : "odd"), $ = (k, R, I) => {
    if (!((k == null ? void 0 : k.length) === 0 || R.depth < I.column.getGroupedIndex())) {
      if (R.getIsGrouped())
        switch (R.depth) {
          case 1:
            return "pr-ps-4";
    ...
    !t && /* @__PURE__ */ _(
      _r,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Qt, { position: "item-aligned", children: /* @__PURE__ */ d(wp, { children: S.map((k) => /* @__PURE__ */ d(Je, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ _(kn, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ d(Nn, { children: E.getHeaderGroups().map((k) => /* @__PURE__ */ d(wt, { children: k.headers.filter((R) => R.column.columnDef.header).map((R) => (
      ...
      /* @__PURE__ */ d(Tn, { children: E.getRowModel().rows.map((k, R) => /* @__PURE__ */ d(
        wt,
        {
...
function Zv({
  ...
  return /* @__PURE__ */ _("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ _(pl, { children: [
      /* @__PURE__ */ d(dl, { children: e.map((a) => /* @__PURE__ */ d(Yg, { value: a.value, children: a.value }, a.key)) }),
      e.map((a) => /* @__PURE__ */ d(ul, { value: a.value, children: a.content }, a.key))
    ] })
  ] });
}
...
function o0({
  ...
  const a = It(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Bc, { position: "static", id: n, children: /* @__PURE__ */ _(
    Lc,
    {
...
var ae;
function tv(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Yb, t.namedCodesToUnicode = t.namedCodesToUnicode ? _t({}, ki, t.namedCodesToUnicode) : ki;
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, x) {
      ...
      if (O !== -1) {
        ...
        }(b.slice(O + 1).trim()), y = Ei[w] || w, T = u[y] = function(S, M) {
          return S === "style" ? M.split(/;\s?/).reduce(function(D, V) {
            const $ = V.slice(0, V.indexOf(":"));
            return D[$.replace(/(-[a-z])/g, (k) => k[1].toUpperCase())] = V.slice($.length + 1).trim(), D;
...
` }, paragraph: { t: Jb, i: ae.LOW, l: oo, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: gt(xb), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: io }, refImage: { t: bt(Eb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Yt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: gt(kb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(Nb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Yt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: st(El), i: ae.HIGH, l: Kb, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, x) {
  ...
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: wr(No), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(Fb), x = new RegExp(`^${b}`, "gm"), O = p[3].replace(x, ""), w = (E = O, Xb.some((M) => M.test(E)) ? Qb : pn);
    var E;
