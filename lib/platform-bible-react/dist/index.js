...
const $o = be.Root, Gi = be.Trigger, ip = be.Group, Lv = be.Portal, Fv = be.Sub, Vv = be.RadioGroup, sp = X.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ $(
  be.SubTrigger,
  {
    ref: o,
    className: L(
...
function zv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = fe(""), [o, a] = fe(
    ...
    hp.forEach((k) => {
      const M = r.match(k);
      if (M) {
        const [D, z = void 0, H = void 0] = M.slice(1), j = yp(D);
  ...
  return Je(() => {
    ...
    const k = setTimeout(() => {
      if (g && u.current && b.current) {
        const D = b.current.offsetTop - mp;
...
const wp = So(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? Oc : "button", { className: L(wp({ variant: t, size: r, className: e })), ref: a, ...o })
);
...
]), Io = (e) => e === "asc" ? /* @__PURE__ */ d(ac, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(ic, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(sc, { className: "pr-ms-2 pr-h-4 pr-w-4" }), $p = (e, t, r) => {
  let n = e;
...
const Ip = $r.Root, Mp = $r.Trigger, Ki = X.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d($r.Portal, { children: /* @__PURE__ */ d(
  $r.Content,
  {
    ref: o,
    align: t,
...
const Ap = et.Portal, Ji = X.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  et.Overlay,
  {
    ref: r,
    className: L(
...
function Sa({
  ...
  const [p, h] = fe(!1);
  return /* @__PURE__ */ $(Ip, { open: p, onOpenChange: h, ...g, children: [
...
function Kp() {
  if (Aa)
    return Jn;
  Aa = 1;
  var e = as(), t = Yp(), r = Ao(), n = is(), o = qp(), a = function() {
  };
...
function ks(e, t) {
  const r = Es(e.theme);
  return Object.keys(e).map((n) => Yd(e, t, n, r)).reduce(Sr, {});
}
function ye(e) {
  return ks(e, On);
}
...
function Vu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    let w = an;
    f === "Root" || f === "root" ? w = n : f ? w = o : Bu(i) && (w = void 0);
    const O = Vc(i, P({
      shouldForwardProp: w,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${tt(f || "")}`), k === void 0 && (k = `Styled(${pd(i)})`), _.displayName = k;
      }
...
const Cf = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Sf = Cf, Of = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Rf(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: n = {},
...
var Rs = Mo.default = void 0, Vf = Ff(Lf()), zf = Xl;
Rs = Mo.default = (0, Vf.default)(/* @__PURE__ */ (0, zf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Ps(e) {
...
function fm(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = N.useRef({}), p = N.useRef(null), h = N.useRef(null), u = We(h, v), [b, w] = N.useState(!m), O = dm(c);
  let x = !0;
...
var Me = "top", Xe = "bottom", Ye = "right", Ae = "left", Wo = "auto", Wr = [Me, Xe, Ye, Ae], nr = "start", Br = "end", mm = "clippingParents", Ms = "viewport", br = "popper", hm = "reference", ai = /* @__PURE__ */ Wr.reduce(function(e, t) {
...
function Im(e) {
  ...
  if (!(!a || !i)) {
    var v = _m(o.padding, r), g = Yo(a), p = c === "y" ? Me : Ae, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], w = Xr(a), O = w ? c === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = u / 2 - b / 2, E = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + x, C = Rr(E, T, y), I = c;
...
function ci(e, t, r) {
  return t === Ms ? vo(Hm(e, r)) : Ft(t) ? Wm(t, r) : vo(Gm(Tt(e)));
}
function Xm(e) {
...
function Lr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? mm : l, f = r.rootBoundary, m = f === void 0 ? Ms : f, v = r.elementContext, g = v === void 0 ? br : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, w = Ls(typeof b != "number" ? b : Fs(b, Wr)), O = g === br ? hm : br, x = e.rects.popper, E = e.elements[h ? O : g], y = Ym(Ft(E) ? E : E.contextElement || Tt(e.elements.popper), c, m, i), T = ar(e.elements.reference), C = zs({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
...
function Jm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, w = Qe(b), O = w === b, x = c || (O || !h ? [ln(b)] : Km(b)), E = [b].concat(x).reduce(function(U, K) {
...
function sh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Lr(t, {
    ...
    padding: v,
    altBoundary: m
  }), w = Qe(t.placement), O = ir(t.placement), x = !O, E = qo(w), y = ih(E), T = t.modifiersData.popperOffsets, C = t.rects.reference, I = t.rects.popper, R = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, _ = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
  ...
  if (T) {
    ...
    if (l) {
      var $e, ke = E === "x" ? Me : Ae, Ct = E === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + b[ke], at = _e - b[Ct], Ce = [Me, Ae].indexOf(w) !== -1, Vt = ($e = k == null ? void 0 : k[y]) != null ? $e : 0, St = Ce ? Be : _e - C[ot] - I[ot] - Vt + _.altAxis, cr = Ce ? _e + C[ot] + I[ot] - Vt - _.altAxis : at, Kr = p && Ce ? $m(St, _e, cr) : Rr(p ? St : Be, _e, p ? cr : at);
      T[y] = Kr, M[y] = Kr - _e;
    }
    t.modifiersData[n] = M;
  }
...
const Th = () => ut({
  root: ["root"]
}, Gf(wh)), Ch = {}, Sh = /* @__PURE__ */ N.forwardRef(function(t, r) {
  var n;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, b = ge(t, xh), w = N.useRef(null), O = We(w, r), x = N.useRef(null), E = We(x, g), y = N.useRef(E);
  jt(() => {
    y.current = E;
  }, [E]), N.useImperativeHandle(g, () => x.current, []);
  const T = kh(m, i), [C, I] = N.useState(T), [R, _] = N.useState(bn(o));
  N.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: b = {},
    slots: w = {}
  } = t, O = ge(t, Eh), [x, E] = N.useState(!0), y = () => {
    E(!1);
  }, T = () => {
    E(!0);
  };
...
const _h = {
  ...
  } = t, w = ge(t, $h), O = Er(), x = N.useRef(), E = Yr(), y = N.useRef(null), T = We(y, a.ref, r), C = (H) => (j) => {
    if (H) {
      const G = y.current;
      j === void 0 ? H(G) : H(G, j);
    }
...
const Eo = Qo, Ih = (e) => {
  ...
  const o = Ts(), a = ft({
    ...
    slots: x,
    slotProps: E
  } = a, y = ge(a, Mh), T = (n = x == null ? void 0 : x.root) != null ? n : c == null ? void 0 : c.Root, C = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const Ks = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const T = ft({
    ...
    TransitionProps: re
  } = T, A = ge(T, Bh), se = /* @__PURE__ */ N.isValidElement(I) ? I : /* @__PURE__ */ d("span", {
    children: I
...
`));
  const zl = N.useMemo(() => {
    ...
    touch: Be.current
  }), zn = Fh(fr), fa = (n = (o = ee.popper) != null ? o : R.Popper) != null ? n : Vh, ma = (a = (i = (l = ee.transition) != null ? l : R.Transition) != null ? i : F) != null ? a : Eo, ha = (c = (f = ee.tooltip) != null ? f : R.Tooltip) != null ? c : zh, ga = (m = (v = ee.arrow) != null ? v : R.Arrow) != null ? m : Uh, Ul = kr(fa, P({}, J, (g = Q.popper) != null ? g : _.popper, {
...
const ng = rl, og = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], ag = {
  ...
  } = t, x = ge(t, og), E = N.useRef(null), y = We(E, l.ref, r), T = (z) => (H) => {
    if (z) {
      const j = E.current;
      H === void 0 ? z(j) : z(j, H);
    }
...
const Ng = ["onEntering"], Tg = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], Cg = ["slotProps"];
function yi(e, t) {
  let r = 0;
...
const Sg = (e) => {
  ...
  } = i, _ = ge(i.TransitionProps, Ng), k = ge(i, Tg), M = (n = E == null ? void 0 : E.paper) != null ? n : O, D = N.useRef(), z = We(D, M.ref), H = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
const $g = ["onEntering"], _g = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Ig = {
  ...
  const a = ft({
    ...
    slots: O = {},
    slotProps: x = {}
  } = a, E = ge(a.TransitionProps, $g), y = ge(a, _g), T = Yr(), C = T.direction === "rtl", I = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: w
  }), R = Ag(I), _ = i && !f && g, k = N.useRef(null), M = (V, S) => {
...
const vt = "scrBook", Ug = "scrRef", $t = "source", Hg = "details", Gg = "Scripture Reference", Wg = "Scripture Book", pl = "Type", Xg = "Details";
function Yg(e, t) {
  const r = t ?? !1;
  return [
    {
    ...
    !t && /* @__PURE__ */ $(
      _r,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Qt, { position: "item-aligned", children: /* @__PURE__ */ d(Ep, { children: E.map((R) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
...
), hl = X.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Bi.Root,
  {
    ref: r,
    className: L("pr-twp pr-font-sans", Zg(), e),
    ...t
  }
));
...
), eb = X.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: L(Qg({ variant: t }), e), ...r }));
...
tb.displayName = "AlertTitle";
const rb = X.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: L("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
rb.displayName = "AlertDescription";
...
const ib = X.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: L("pr-text-sm pr-text-muted-foreground", e), ...t }));
ib.displayName = "CardDescription";
...
const cb = X.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $(
  xr.Root,
  {
    ref: r,
    className: L(
...
cb.displayName = xr.Root.displayName;
const pb = X.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  po.Root,
  {
    className: L(
...
pb.displayName = po.Root.displayName;
const p0 = je.Root, db = X.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.List,
  {
    ref: r,
    className: L(
...
db.displayName = je.List.displayName;
...
ub.displayName = je.Trigger.displayName;
...
fb.displayName = je.Content.displayName;
function d0({
  isInstalling: e,
  handleClick: t,
  buttonText: r,
...
const mb = ["children", "options"], ki = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), Ni = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, hb = ["style", "script"], gb = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, bb = /mailto:/i, vb = /\n{2,}$/, gl = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, yb = /^ *> ?/gm, wb = /^ {2,}\n/, xb = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, bl = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, vl = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, Eb = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, kb = /^(?:\n *)*\n/, Nb = /\r\n?/g, Tb = /^\[\^([^\]]+)](:.*)\n/, Cb = /^\[\^([^\]]+)]/, Sb = /\f/g, Ob = /^\s*?\[(x|\s)\]/, yl = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, wl = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, xl = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, No = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, Rb = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, El = /^<!--[\s\S]*?(?:-->)/, Pb = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, To = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, $b = /^\{.*\}$/, _b = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, Ib = /^<([^ >]+@[^ >]+)>/, Mb = /^<([^ >]+:\/[^ >]+)>/, Ab = /-([a-z])?/gi, kl = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, Db = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, jb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, Bb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, Lb = /(\[|\])/g, Fb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, Vb = /\t/g, zb = /^ *\| */, Ub = /(^ *\||\| *$)/g, Hb = / *$/, Gb = /^ *:-+: *$/, Wb = /^ *:-+ *$/, Xb = /^ *-+: *$/, Yb = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, qb = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, Kb = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, Jb = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, Zb = /^\\([^0-9A-Za-z\s])/, Qb = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, ev = /^\n+/, tv = /^([ \t]*)/, rv = /\\([^\\])/g, Ti = / *\n+$/, nv = /(?:^|\n)( *)$/, ta = "(?:\\d+\\.)", ra = "(?:[*+-])";
function Nl(e) {
  return "( *)(" + (e === 1 ? ta : ra) + ") +";
}
...
const _l = $l(1), Il = $l(2);
function Ci(e, t) {
  const r = t === 1, n = r ? _l : Il, o = r ? Rl : Pl, a = r ? ov : av;
  return { t(i, l, c) {
    const f = nv.exec(c);
    return f && (l.o || !l._ && !l.u) ? n.exec(i = f[1] + i) : null;
  }, i: ae.HIGH, l(i, l, c) {
    const f = r ? +i[2] : void 0, m = i[0].replace(vb, `
`).match(o);
    let v = !1;
...
const iv = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, sv = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Ml = [gl, bl, vl, yl, xl, wl, El, kl, Rl, _l, Pl, Il], lv = [...Ml, /^[^\n]+(?:  \n|\n{2,})/, No, To];
function cv(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function pv(e) {
  return Xb.test(e) ? "right" : Gb.test(e) ? "center" : Wb.test(e) ? "left" : null;
}
function Si(e, t, r) {
  const n = r.$;
  r.$ = !0;
...
function dv(e, t, r) {
  r._ = !0;
  const n = Si(e[1], t, r), o = e[2].replace(Ub, "").split("|").map(pv), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(f) {
      return Si(f, l, c);
    });
...
var ae;
function gv(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || cv, t.namedCodesToUnicode = t.namedCodesToUnicode ? It({}, Ni, t.namedCodesToUnicode) : Ni;
  ...
  function n(p, h, ...u) {
    ...
    }(p, t.overrides), It({}, h, b, { className: hv(h == null ? void 0 : h.className, b.className) || void 0 }), ...u);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = Fb.test(p) === !1);
    const u = m(f(h ? p : `${p.trimEnd().replace(ev, "")}
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, w) {
      ...
      if (O !== -1) {
        const x = function(C) {
          return C.indexOf("-") !== -1 && C.match(Pb) === null && (C = C.replace(Ab, function(I, R) {
          ...
          }, {}) : C === "href" ? Yt(I) : (I.match($b) && (I = I.slice(1, I.length - 1)), I === "true" || I !== "false" && I);
        }(x, E);
  ...
  const i = [], l = {}, c = { blockQuote: { t: st(gl), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(yb, ""), u) }), h: (p, h, u) => n("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: wr(wb), i: ae.HIGH, l: ao, h: (p, h, u) => n("br", { key: u.k }) }, breakThematic: { t: st(xb), i: ae.HIGH, l: ao, h: (p, h, u) => n("hr", { key: u.k }) }, codeBlock: { t: st(vl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => n("pre", { key: u.k }, n("code", It({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: st(bl), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: bt(Eb), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => n("code", { key: u.k }, p.v) }, footnote: { t: st(Tb), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: io }, footnoteReference: { t: gt(Cb), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B) }, n("sup", { key: u.k }, p.v)) }, gfmTask: { t: gt(Ob), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => n("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: st(t.enforceAtxHeadings ? wl : yl), i: ae.HIGH, l: (p, h, u) => ({ v: pn(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => n(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: st(xl), i: ae.MAX, l: (p, h, u) => ({ v: pn(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: wr(El), i: ae.HIGH, l: () => ({}), h: io }, image: { t: bt(sv), i: ae.HIGH, l: (p) => ({ D: p[1], B: Ri(p[2]), F: p[3] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Yt(p.B) }) }, link: { t: gt(iv), i: ae.LOW, l: (p, h, u) => ({ v: fv(h, p[1], u), B: Ri(p[2]), F: p[3] }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: gt(Mb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : gt(_b)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: gt(Ib), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
    return bb.test(u) || (u = "mailto:" + u), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: u, type: "link" };
  } }, orderedList: Ci(n, 1), unorderedList: Ci(n, 2), newlineCoalescer: { t: st(kb), i: ae.LOW, l: ao, h: () => `
` }, paragraph: { t: uv, i: ae.LOW, l: oo, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: gt(Db), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: io }, refImage: { t: bt(jb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Yt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: gt(Bb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(Lb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Yt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: st(kl), i: ae.HIGH, l: dv, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, w) {
    ...
    return h.$ ? (h._ = !0, zb.exec(p)) : null;
  }, i: ae.HIGH, l: function() {
    return { type: "tableSeparator" };
  }, h: () => " | " }, text: { t: wr(Qb), i: ae.MIN, l: (p) => ({ v: p[0].replace(Rb, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: bt(Yb), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: bt(qb), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: bt(Zb), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: bt(Kb), i: ae.LOW, l: oo, h: (p, h, u) => n("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: bt(Jb), i: ae.LOW, l: oo, h: (p, h, u) => n("del", { key: u.k }, h(p.v, u)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: wr(No), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(tv), w = new RegExp(`^${b}`, "gm"), O = p[3].replace(w, ""), x = (E = O, lv.some((I) => I.test(E)) ? mv : pn);
    var E;
    const y = p[1].toLowerCase(), T = hb.indexOf(y) !== -1;
    u.N = u.N || y === "a";
...
const bv = (e) => {
  ...
  return N.cloneElement(gv(t, r), n);
};
function h0({ id: e, markdown: t }) {
  return /* @__PURE__ */ d("div", { id: e, className: "pr-prose", children: /* @__PURE__ */ d(bv, { children: t }) });
}
const vv = yn((e, t) => /* @__PURE__ */ $(
  xe,
  {
    ref: t,
...
var yv = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(yv || {});
function g0({ id: e, groups: t }) {
  return /* @__PURE__ */ d("div", { id: e, children: /* @__PURE__ */ $($o, { children: [
    /* @__PURE__ */ d(Gi, { asChild: !0, children: /* @__PURE__ */ d(vv, {}) }),
    /* @__PURE__ */ d(xn, { children: t.map((r) => /* @__PURE__ */ $("div", { children: [
      /* @__PURE__ */ d(Vr, { children: r.label }),
      /* @__PURE__ */ d(ip, { children: r.items.map((n) => /* @__PURE__ */ d("div", { children: n.itemType === 0 ? /* @__PURE__ */ d(_o, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ d(Xi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ d(En, {})
    ] }, r.label)) })
  ] }) });
}
...
function wv({ id: e, versionHistory: t }) {
...
function y0({
  ...
  return /* @__PURE__ */ d("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ $("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ d(wv, { versionHistory: o }),
