...
import { c as m, g as Te, a as Ba, C as Ne, A as se, P as Me, b as He, B as K, d as Oe, e as $e, f as Ae, h as ke, i as Pi, k as Vi, j as ji, E as Li, l as Ua, r as pe, m as Fi, n as cn, o as Qr, p as ta, L as Nt, R as Ka, q as Gr, D as Na, s as Ca, t as Ea, u as Ta, T as ln, v as Pr, w as At, x as Ga, y as It, z as Pt, F as Vt, G as dn, H as qa, I as Ke, J as xr, K as Ie, M as Pe, N as Ve, S as yr, O as er, Q as Bi, U as Nr, V as qe, W as Se, Z as Ye, X as ze, Y as rr, _ as Ha, $ as Ya, a0 as qr, a1 as Wa, a2 as wn, a3 as Ui, a4 as Ki, a5 as Gi, a6 as za, a7 as un, a8 as ea, a9 as pn, aa as qi, ab as Hi, ac as Yi, ad as Wi, ae as hn, af as gn, ag as Xa, ah as Xi, ai as fn, aj as ca, ak as bo, al as la, am as Ji, an as Zi, ao as Qi, ap as ts, aq as es, ar as Cr, as as Ja, at as rs, au as as } from "./resizable-WH6eKveD.js";
...
import { Section as wt, getChaptersForBook as Ps, formatScrRef as xe, getSectionForBook as Vr, formatRelativeDate as Vs, formatReplacementString as Ge, sanitizeHtml as Qa, NumberFormat as _n, formatBytes as js, getCurrentLocale as Ls, usfmMarkers as jr, getFormatCallerFunction as Fs, deepEqual as Bs, isString as _o, compareScrRefs as Ma, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as No, formatReplacementStringToArray as Co, collectUsjMarkers as Ks } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as O, useState as k, useCallback as L, useEffect as H, useImperativeHandle as Gs, useLayoutEffect as ee, createContext as to, useContext as Nn, Component as qs, createElement as Eo, Suspense as Hs, forwardRef as Cn, useId as To, Fragment as ra } from "react";
...
import { HeadingNode as Kc, QuoteNode as Gc, registerRichText as qc } from "@lexical/rich-text";
...
import { Avatar as oo, Select as qt, Checkbox as Do, Slot as Tr, Tabs as ce, Menubar as he, ContextMenu as Dt, Progress as Mo, Slider as Dr, Switch as Oo } from "radix-ui";
...
function pa({
  ...
  const B = pe(), [N, P] = k(!1), [I, E] = k(""), [V, G] = k(""), [S, et] = k("books"), [R, X] = k(void 0), [C, z] = k(
    void 0
  ), [Y, nt] = k(void 0), [bt, ut] = k(!1), Mt = F(null), q = F(!1), Z = F(void 0), ct = F(void 0), lt = F(void 0), ft = F(void 0), jt = F({}), gt = F({}), xt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ...
  const Ct = L(() => {
    ...
    P(x), x && (et("books"), X(void 0), z(void 0), nt(void 0), G(""));
  }, []);
  H(() => {
    $ && at(!1);
  }, [$, at]);
  ...
  const { otLong: pt, ntLong: mt, dcLong: zt, extraLong: Ft } = {
    ...
    const { isLetter: U, isDigit: Q } = Ao(x.key);
    (U || Q) && (x.preventDefault(), G((be) => be + x.key), ct.current.focus(), ut(!1));
  }, []);
  return ee(() => {
    const x = setTimeout(() => {
    ...
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
      K,
      {
        ...
        onClick: (x) => {
          q.current && (q.current = !1, x.preventDefault());
        },
        children: [
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: U } = x;
          N && Mt.current && U instanceof Node && Mt.current.contains(U) && (q.current = !0, at(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          $e,
...
function Vo({
  ...
  const [_, $] = k(!1), B = d ?? l, N = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], P = (I, E) => {
    const V = l(I), G = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, S = `${E ?? ""}${V}${G ?? ""}`;
    return /* @__PURE__ */ u(
      Ne,
      {
        value: V,
...
function Ol(t, e = Ml) {
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((N || P) && $ !== null && B !== null) {
        const I = function(E, V, G, S, et, R, X) {
          const C = (E._window ? E._window.document : document).createRange();
          return C.setStart(...jo(V, G, S)), C.setEnd(...jo(et, R, X)), C;
        }(t, g, f, $, h, T, B);
        l(), l = Dl(t, I, e);
      }
...
function Be(t, e) {
  Gt.call(this, void 0), this.x = t, this.s = void 0, this.g = Fr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Bl(t, e) {
  return new Be(t, e);
}
...
Gt.prototype.brand = jl, Gt.prototype.h = function() {
  return !0;
...
} }), Be.prototype = new Gt(), Be.prototype.h = function() {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [ti], register: (t, e, r) => t.registerCommand($n, (o) => {
  const n = Jt();
  if (An(n) || we(n)) for (const i of n.getNodes()) Gl(i) && i.toggleFormat(o);
  return !1;
}, In) });
function ei(t, e) {
  let r;
...
const Zl = /* @__PURE__ */ new Set(), qo = ne({ build(t, e, r) {
...
ne({ dependencies: [ja, qo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(qo).output, n = _r({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
...
function gd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: g, autoCapitalize: h, className: f, id: b, role: v = "textbox", spellCheck: T = !0, style: y, tabIndex: _, "data-testid": $, ...B }, N) {
  const [P, I] = k(t.isEditable()), E = L((G) => {
    G && G.ownerDocument && G.ownerDocument.defaultView ? t.setRootElement(G) : t.setRootElement(null);
  }, [t]), V = O(() => /* @__PURE__ */ function(...G) {
    return (S) => {
      for (const et of G) typeof et == "function" ? et(S) : et != null && (et.current = S);
    };
  }(N, E), [E, N]);
  return ci(() => (I(t.isEditable()), t.registerEditableListener((G) => {
    I(G);
...
function bi({
  ...
  const [S, et] = k(Zo), [R, X] = k(), [C, z] = k(), Y = o, [nt, bt] = k(!1), [ut, Mt] = k(!1), [q, Z] = k(!1), [ct, lt] = k(!1), [ft, jt] = k(!1), [gt, xt] = k($), [Ht, Tt] = k(!1), Zt = F(void 0), [fe, M] = k(/* @__PURE__ */ new Map());
  H(() => {
    let D = !0;
    return (async () => {
  ...
  const rt = O(
    ...
    () => it === 1 ? rt.singleReply : Ge(rt.multipleReplies, { count: it }),
    [it, rt]
  ), Ft = O(
    () => mt === 1 ? rt.singleReply : Ge(rt.multipleReplies, { count: mt }),
    [mt, rt]
  );
  H(() => {
    !o && ut && kt && Mt(!1);
      ...
      children: /* @__PURE__ */ u($d, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        ...
        /* @__PURE__ */ u(st, { children: [
          ...
          o && /* @__PURE__ */ u(st, { children: [
            G && pt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            mt > 0 && /* @__PURE__ */ u(
              "div",
              {
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    R !== void 0 && (oe(S) || R !== C) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
                    ...
                    /* @__PURE__ */ u(Me, { open: q, onOpenChange: Z, children: [
                      /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(
                        K,
                        {
                          size: "icon",
...
function jd({
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", G = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), S = (C) => C ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: C }) : G, et = () => {
    const C = o ?? "accept";
    return C === "merged" ? t.mergedText ? /* @__PURE__ */ a(Kr, { html: T }) : G : S(C === "reject" ? t.rejectedResultText : t.resultText);
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    qt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(qt.Icon, { asChild: !0, children: /* @__PURE__ */ a(En, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ie({
  ...
  return /* @__PURE__ */ u(
    qt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(qt.ItemIndicator, { children: /* @__PURE__ */ a(aa, { className: "tw:pointer-events-none" }) }) }),
...
function Xd({
  ...
  return l ? B = Array.from({ length: 10 }).map((E, V) => `skeleton-row-${V}`).map((E) => /* @__PURE__ */ a(ze, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: $.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((N = _.getRowModel().rows) == null ? void 0 : N.length) > 0 ? B = _.getRowModel().rows.map((P) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Ha, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ya, { stickyHeader: i, children: _.getHeaderGroups().map((P) => /* @__PURE__ */ a(ze, { children: P.headers.map((I) => /* @__PURE__ */ a(qr, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : vr(I.column.columnDef.header, I.getContext()) }, I.id)) }, P.id)) }),
...
function rw({
  ...
  const l = qa(), d = tn(n, "%undoButton_tooltip%"), w = tn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ga, { children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(It, { children: [
      /* @__PURE__ */ a(Pt, { asChild: !0, children: /* @__PURE__ */ a(
        K,
...
function vp({
  ...
  const [f, b] = k("generated"), [v, T] = k("generated"), [y, _] = k("*"), [$, B] = k("*"), [N, P] = k("f"), [I, E] = k(!1), [V, G] = k(!0), [S, et] = k(!1), R = F(!1), X = F(""), [C, z] = k(!1), [Y, nt] = k(), [bt, ut] = k(), [Mt, q] = k(), [Z, ct] = k(), lt = F(null), ft = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const Zt = () => {
    ...
    (j) => {
      ...
      if (J && Mr("note", J)) {
        ...
        if (pt || E(!1), E(
          ...
          R.current = !0, X.current = JSON.stringify(J), G(!0);
          return;
        }
        G(JSON.stringify(J) === X.current), gt(f, y);
      } else
        E(!1), G(!0);
    },
    [f, y, gt]
    ...
    if (g.current && jt.length && j && j.rangeCount > 0) {
      ...
      nt(J.left - rt.left), ut(J.top - rt.top), q(J.height), z(!0);
    }
  }, [jt, g]);
  H(() => {
    const j = () => {
...
function zp({
  ...
  const h = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), T = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), _ = le(r, "%webView_inventory_scope_verse%"), $ = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), N = le(r, "%webView_inventory_no_results%"), [P, I] = k(!1), [E, V] = k("all"), [G, S] = k(""), [et, R] = k([]), X = O(() => {
    const q = t ?? [];
    return q.length === 0 ? [] : Ew(q, n, i);
  }, [t, n, i]), C = O(() => {
    if (P) return X;
    const q = [];
    return X.forEach((Z) => {
      const ct = Z.items[0], lt = q.find(
        (ft) => ft.items[0] === ct
      );
      lt ? (lt.count += Z.count, lt.occurrences = lt.occurrences.concat(Z.occurrences)) : q.push({
        items: [ct],
        count: Z.count,
  ...
  }, [P, X]), z = O(() => C.length === 0 ? [] : Cw(C, E, G), [C, E, G]), Y = O(() => {
    var ct, lt;
    if (!P) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(sr, { onValueChange: (q) => bt(q), defaultValue: s, children: [
...
function Up({
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const G = b.find((S) => nn(S) === V[0]) || void 0;
        G && c(G);
      }
    }
  }, [h, b, c, T]);
  ...
  }, P = (E, V) => E.getIsGrouped() ? "" : m("banded-row", V % 2 === 0 ? "even" : "odd"), I = (E, V, G) => {
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(qd, { children: $.map((E) => /* @__PURE__ */ a(ie, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ u(
                      K,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (G === "ltr" ? /* @__PURE__ */ a(Ra, {}) : /* @__PURE__ */ a(Sa, {})),
                          " ",
...
function Gp({
  ...
  ] }), ct = e ? q.filter((A) => e.includes(A.value)) : q, lt = b ?? wa, ft = p ?? lt, jt = g ?? lt, gt = () => {
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Ie, { open: zt, onOpenChange: Ft, children: [
        ...
        Ka,
        {
          ...
          children: ct.map(({ value: A, label: W, scrRefSuffix: Wt, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: gr }),
...
function eh({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Nt, { className: "tw:font-normal tw:text-muted-foreground", children: Ge(d, {
