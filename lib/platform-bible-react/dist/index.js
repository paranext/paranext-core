...
function yc({
  ...
  const w = st(), [p, f] = D(!1), [h, m] = D(""), [g, N] = D(""), [x, C] = D("books"), [E, y] = D(void 0), [_, O] = D(!1), T = W(void 0), R = W(void 0), I = W(void 0), k = W(void 0), S = W({}), A = z(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
    ...
    (v) => {
      const j = x === "chapters" ? E : M == null ? void 0 : M.book;
      j && (A({
        book: j,
        chapterNum: v,
        verseNum: 1
    ...
    (v) => {
      ...
      if ((x === "chapters" || x === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const lt = x === "chapters" ? E : M == null ? void 0 : M.book;
        if (!lt) return;
        const ct = (() => {
          if (!h) return 1;
          const _e = h.match(/(\d+)$/);
    ...
    const { isLetter: j, isDigit: J } = gr(v.key);
    (j || J) && (v.preventDefault(), N((lt) => lt + v.key), R.current.focus(), O(!1));
  }, []);
  return Mt(() => {
    const v = setTimeout(() => {
    ...
    if (x === "chapters" && E) {
      ...
      setTimeout(() => {
        if (I.current)
          if (v) {
            const j = S.current[t.chapterNum];
  ...
  }, [x, E, M, t.book, t.chapterNum]), /* @__PURE__ */ c(se, { open: p, onOpenChange: wt, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ r(
      $,
      {
          ...
          !_ && /* @__PURE__ */ c(ae, { ref: I, children: [
            x === "books" && /* @__PURE__ */ c(rt, { children: [
              ...
              M && /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(
                Ft,
                {
                  value: `${M.book} ${Jt[M.book]} ${M.chapterNum || ""}:${M.verseNum || ""})}`,
                  onSelect: nt,
                  ...
                  children: ce(
                    ...
                    a ? Yn(M.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              M && Et(M.book) > 1 && /* @__PURE__ */ c(rt, { children: [
...
function Dn({
  ...
  const [E, y] = D(!1), _ = d ?? l, O = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], T = (R, I) => {
    const k = l(R), S = typeof R == "object" && "secondaryLabel" in R ? R.secondaryLabel : void 0, A = `${I ?? ""}${k}${S ?? ""}`;
    return /* @__PURE__ */ c(
      Ft,
      {
        value: k,
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ c(oe, { children: [
          ...
          /* @__PURE__ */ r(ae, { children: O(e) ? e.map((R) => /* @__PURE__ */ r(zt, { heading: R.groupHeading, children: R.options.map((I) => T(I, R.groupHeading)) }, R.groupHeading)) : e.map((R) => T(R)) })
        ] })
      }
    )
  ] });
    ...
    (m) => {
      ...
      if (!!(x && g && x.contains(g) && g !== x) && f(g)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          if (k === -1) return;
          let S;
          m.key === "ArrowDown" ? S = Math.min(k + 1, I.length - 1) : S = Math.max(k - 1, 0), S !== k && (m.preventDefault(), m.stopPropagation(), (R = I[S]) == null || R.focus());
          return;
        }
        return;
      }
      ...
      switch (m.key) {
        case "ArrowDown":
          O = Math.min(_ + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          O = Math.max(_ - 1, 0), m.preventDefault();
          break;
        case "Home":
          O = 0, m.preventDefault();
          break;
        case "End":
          O = t.length - 1, m.preventDefault();
          break;
        case " ":
        case "Enter":
...
function Ti({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: m, className: g, id: N, role: x = "textbox", spellCheck: C = !0, style: E, tabIndex: y, "data-testid": _, ...O }, T) {
  ...
  return fo(() => (I(t.isEditable()), t.registerEditableListener((A) => {
    I(A);
  })), [t]), r("div", { "aria-activedescendant": R ? e : void 0, "aria-autocomplete": R ? n : "none", "aria-controls": R ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": R && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": R ? f : void 0, "aria-readonly": !R || void 0, "aria-required": h, autoCapitalize: m, className: g, contentEditable: R, "data-testid": _, id: N, ref: S, role: x, spellCheck: C, style: E, tabIndex: y, ...O });
}
const Ri = Pe(Ti);
function yr(t) {
  return t.getEditorState().read(mo(t.isComposing()));
...
function kr({
  ...
  }, [t.date, n]), O = B(() => t.user, [t.user]), T = B(
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Eo, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(To, { className: "tw-text-xs tw-font-medium", children: T }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ r("p", { className: "tw-text-sm tw-font-medium", children: O }),
...
function rl({
  ...
  const [C, E] = D(_r), [y, _] = D(!1), [O, T] = D(!1), [R, I] = D(!1), [k, S] = D(!1), [A, L] = D(!1), [F, V] = D(void 0), [q, M] = D(!1), [nt, gt] = D(!1);
  Y(() => {
    let v = !0;
    if (!n) {
      M(!1), gt(!1);
  ...
  }, [a, e]), At = B(() => xt.slice(1), [xt]), ht = B(() => At.length ?? 0, [At.length]), on = B(() => ht > 0, [ht]), an = B(() => R || ht <= 2 ? At : At.slice(-2), [At, ht, R]), we = B(() => R || ht <= 2 ? 0 : ht - 2, [ht, R]), je = B(
...
function Ec({
  ...
  const [h, m] = D(), g = e.filter(
    ...
    (T) => {
      T.key === "Escape" ? (m(void 0), T.preventDefault(), T.stopPropagation()) : _(T);
    },
    [_]
  );
  return /* @__PURE__ */ r(
...
function fl({
  ...
  let O;
  return d ? O = Array.from({ length: 10 }).map((k, S) => `skeleton-row-${S}`).map((k) => /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(Zt, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(An, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((T = y.getRowModel().rows) == null ? void 0 : T.length) > 0 ? O = y.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    Dt,
    {
      onClick: () => i(R, y),
      "data-state": R.getIsSelected() && "selected",
      children: R.getVisibleCells().map((I) => /* @__PURE__ */ r(Zt, { children: De(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    R.id
  )) : O = /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(Zt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(ol, { table: y }),
    /* @__PURE__ */ c(Qe, { stickyHeader: s, children: [
      /* @__PURE__ */ r(tn, { stickyHeader: s, children: y.getHeaderGroups().map((R) => /* @__PURE__ */ r(Dt, { children: R.headers.map((I) => /* @__PURE__ */ r(Ae, { children: I.isPlaceholder ? void 0 : De(I.column.columnDef.header, I.getContext()) }, I.id)) }, R.id)) }),
      /* @__PURE__ */ r(en, { children: O })
    ] }),
...
function yl({
  ...
  const [C, E] = D(!1), y = z(
    (S) => {
      var L;
      const A = (L = t.find((F) => F.label === S)) == null ? void 0 : L.value;
      A && n(
    ...
    if (!h) return t;
    const S = t.filter((L) => L.starred).sort((L, F) => L.label.localeCompare(F.label)), A = t.filter((L) => !L.starred).sort((L, F) => {
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ c(se, { open: I, onOpenChange: p ?? E, children: [
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(oe, { children: [
      ...
      a && /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: T, children: s }),
        /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
      /* @__PURE__ */ c(ae, { children: [
        /* @__PURE__ */ r(Ze, { children: l }),
        /* @__PURE__ */ r(zt, { children: O.map((S) => /* @__PURE__ */ c(
          Ft,
          {
            value: S.label,
            onSelect: y,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ r(Ta, { className: "tw-h-4 tw-w-4" }),
...
function kl({
  ...
  const g = (x) => {
    ...
    var E, y, _, O, T;
    const C = ((E = i.current) == null ? void 0 : E.dir) !== "ltr";
    x.key === "ArrowDown" || C && x.key === "ArrowRight" || !C && x.key === "ArrowLeft" ? ((y = s.current) == null || y.focus(), l.current = !0) : x.key === "ArrowUp" ? ((_ = i.current) == null || _.focus(), l.current = !1) : (C && x.key === "ArrowLeft" || !C && x.key === "ArrowRight") && ((O = s.current) == null ? void 0 : O.selectionStart) === 0 && ((T = i.current) == null || T.focus(), l.current = !1), d === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
...
function Vc({
  ...
  Y(() => {
    ...
    if (_ && pn("note", _)) {
      const R = (O = _.insert.note) == null ? void 0 : O.caller;
      let I = "custom";
      R === _n ? I = "generated" : R === Cn ? I = "hidden" : R && h(R), p(I), g(((T = _.insert.note) == null ? void 0 : T.style) ?? "f"), _.insert.note && (_.insert.note.caller = ""), y = setTimeout(() => {
        var k;
  ...
  const x = z(() => {
    var _, O;
    const y = (O = (_ = l.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : O.at(0);
        ...
        /* @__PURE__ */ r(
          El,
          {
            ...
            handleNoteTypeChange: (y) => {
              var O, T, R;
              g(y);
              const _ = (T = (O = l.current) == null ? void 0 : O.getNoteOps(0)) == null ? void 0 : T.at(0);
              _ && pn("note", _) && (_.insert.note && (_.insert.note.style = y), (R = l.current) == null || R.applyUpdate([{ delete: 1 }, _]));
            },
            localizedStrings: i
          }
        ),
...
function Xc({
  ...
  const f = _t(n, "%webView_inventory_all%"), h = _t(n, "%webView_inventory_approved%"), m = _t(n, "%webView_inventory_unapproved%"), g = _t(n, "%webView_inventory_unknown%"), N = _t(n, "%webView_inventory_scope_currentBook%"), x = _t(n, "%webView_inventory_scope_chapter%"), C = _t(n, "%webView_inventory_scope_verse%"), E = _t(n, "%webView_inventory_filter_text%"), y = _t(
    n,
    "%webView_inventory_show_additional_items%"
  ), _ = _t(n, "%webView_inventory_no_results%"), [O, T] = D(!1), [R, I] = D("all"), [k, S] = D(""), [A, L] = D([]), F = B(() => {
    const P = t ?? [];
  ...
  }, [O, F]), q = B(() => V.length === 0 ? [] : Al(V, R, k), [V, R, k]), M = B(() => {
    var wt, it;
    if (!O) return d;
...
function Uc({
  ...
  Y(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const A = N.find((L) => Tr(L) === S[0]) || void 0;
        A && l(A);
      }
    }
  }, [m, N, l, C]);
  ...
  }, R = (k, S) => k.getIsGrouped() ? "" : u("banded-row", S % 2 === 0 ? "even" : "odd"), I = (k, S, A) => {
    if (!((k == null ? void 0 : k.length) === 0 || S.depth < A.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ c(Qe, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(tn, { children: C.getHeaderGroups().map((k) => /* @__PURE__ */ r(Dt, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Ae, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
          ...
          " ",
          De(S.column.columnDef.header, S.getContext())
        ] }) }, S.id)
      )) }, k.id)) }),
      /* @__PURE__ */ r(en, { children: C.getRowModel().rows.map((k, S) => {
        const A = st();
        return /* @__PURE__ */ r(
          Dt,
          {
...
function lw({
  ...
  }, [x, C] = D(!1), [E, y] = D(""), _ = W(void 0), O = W(!1);
  if (t.length !== U.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const T = B(() => U.allBookIds.filter(
    ...
    (V, q = !1) => {
      ...
      const M = T.findIndex((P) => P === _.current), nt = T.findIndex((P) => P === V);
      if (M === -1 || nt === -1) return;
      const [gt, xt] = [
        Math.min(M, nt),
        Math.max(M, nt)
      ], mt = T.slice(gt, xt + 1).map((P) => P);
      n(
    ...
    I(V, O.current), O.current = !1;
  }, S = (V, q) => {
    V.preventDefault(), I(q, V.shiftKey);
  }, A = z(
    (V) => {
      const q = sr(T, V).map((M) => M);
      n(
        Ho(T, V, e) ? e.filter((M) => !q.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, T]
  ), L = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Gt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            oe,
            {
              shouldFilter: !1,
              onKeyDown: (V) => {
                V.key === "Enter" && (O.current = V.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Be,
                      ...
                      return /* @__PURE__ */ c(Sr, { children: [
                        /* @__PURE__ */ r(
                          zt,
                          {
                            ...
                            children: M.map((nt) => /* @__PURE__ */ r(
                              co,
                              {
                                bookId: nt,
                                isSelected: e.includes(nt),
                                onSelect: () => k(nt),
                                onMouseDown: (gt) => S(gt, nt),
                                section: Re(nt),
                                showCheck: !0,
                                localizedBookNames: a,
...
function ad({
  ...
  const w = fw(
    ...
    return x ? `${(O = t[g]) == null ? void 0 : O.autonym} (${x})` : (T = t[g]) == null ? void 0 : T.autonym;
  };
