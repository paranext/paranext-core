...
import c, { forwardRef as Lt, useCallback as tt, useState as B, useRef as Z, useEffect as dt, useLayoutEffect as Oe, useMemo as Q } from "react";
...
import { useReactTable as Le, getFilteredRowModel as yr, getSortedRowModel as Ue, getPaginationRowModel as Nr, getCoreRowModel as qe, flexRender as Ot, getGroupedRowModel as kr, getExpandedRowModel as Cr } from "@tanstack/react-table";
...
const Jt = V.Root, xe = V.Trigger, We = V.Group, Ir = V.Portal, Mr = V.Sub, qo = V.RadioGroup, Ze = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  V.SubTrigger,
  {
    ref: o,
    className: d(
...
Ze.displayName = V.SubTrigger.displayName;
const Qe = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  V.SubContent,
  {
    ref: n,
    className: d(
...
Qe.displayName = V.SubContent.displayName;
...
const tn = c.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  V.RadioItem,
  {
    ref: a,
    className: d(
...
tn.displayName = V.RadioItem.displayName;
...
function _t(t, e = !0) {
  return e && (t = t.toUpperCase()), t in Ae ? Ae[t] : 0;
}
function Ce(t) {
  return _t(t) > 0;
}
...
function $r(t) {
  return en[t - 1].includes("*obsolete*");
}
function Hr() {
  const t = {};
...
const H = class T {
  ...
  allVerses(e = !1, n = T.verseRangeSeparators, a = T.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], s = Pe(this._verse, a);
    for (const w of s.map((i) => Pe(i, n))) {
      const i = this.clone();
      i.verse = w[0];
      const p = i.verseNum;
...
const Re = _.allBookIds.filter((t) => !_.isObsolete(_.bookIdToNumber(t))), qr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Xe = ["OT", "NT", "DC"], Jr = 96, Kr = [
  /^(\w+)$/i,
  ...
  return dt(() => {
    ...
    /* @__PURE__ */ r(
      Ft,
      {
        ...
        ref: k,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Xe.map((C, E) => {
          const O = j(C);
          return O.length > 0 && /* @__PURE__ */ l("div", { children: [
            ...
            Xe.length - 1 !== E ? /* @__PURE__ */ r(Gt, {}) : void 0
          ] }, C);
        }) })
      }
    )
...
), J = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(He.Root, { ref: n, className: d("pr-twp", ea(), t), ...e }));
J.displayName = He.Root.displayName;
const wn = c.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    At.Root,
    {
...
wn.displayName = At.Root.displayName;
...
const dn = Pt.Root, ln = Pt.Trigger, Te = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = Y();
...
const na = nt.Portal, cn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Overlay,
  {
    ref: n,
    className: d(
...
cn.displayName = nt.Overlay.displayName;
...
const ze = c.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(Ye, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      L.Input,
      {
        ref: n,
...
pn.displayName = L.Group.displayName;
...
function pe({
  ...
  const [y, N] = B(!1);
  return /* @__PURE__ */ l(dn, { open: y, onOpenChange: N, ...x, children: [
...
mn.displayName = X.ScrollDownButton.displayName;
...
function fa({
  ...
  var y;
  const [i, p] = B([]), [m, u] = B([]), [f, g] = B({}), [h, v] = B({}), x = Le({
    data: e,
    columns: t,
    getCoreRowModel: qe(),
...
function as({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(Jt, { children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(ba, {}) }),
    /* @__PURE__ */ r(Ft, { children: e.map((n) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(Kt, { children: n.label }),
      /* @__PURE__ */ r(We, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Ne, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(tn, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Gt, {})
    ] }, n.label)) })
  ] }) });
}
...
function ka({
  ...
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(dn, { open: u, onOpenChange: f, children: [
    /* @__PURE__ */ r(ln, { asChild: !0, children: /* @__PURE__ */ l(
      M,
      {
        variant: "ghost",
        ...
        children: [
          ...
          /* @__PURE__ */ r($e, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Te, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(_e, { children: [
      ...
      /* @__PURE__ */ l(Ee, { children: [
        ...
        /* @__PURE__ */ r(pn, { children: v.map((x) => {
...
const Sa = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), je = (t) => {
...
}, Ta = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", hn = bt(
  ...
  {
    ref: o,
    className: d(hn({ variant: e, size: n, className: t })),
    ...a
  }
));
_a.displayName = Je.Root.displayName;
const gn = c.createContext({
  size: "default",
  variant: "default"
}), fn = c.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const w = Y();
  return /* @__PURE__ */ r(
    qt.Root,
    {
...
const te = (t) => t === "asc" ? /* @__PURE__ */ r(dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(lr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(cr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ds = (t) => ({
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(fn, { value: w, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          onClick: () => oe(
  ...
  return Sa(t).forEach((u) => {
    u.startsWith("\\id") && (w = Ra(u), i = 0, p = 0), u.startsWith("\\c") && (i = je(u), p = 0), u.startsWith("\\v") && (p = je(u), i === 0 && (i = e.chapterNum));
    ...
    for (; f; ) {
      ...
      const h = f.index, v = s.find((y) => ve(y.items, g)), x = {
        ...
        text: xr(u, Math.max(0, h - 25), Math.min(h + 25, u.length))
      };
      if (v)
...
De.displayName = Ke.Root.displayName;
...
const bn = jt.Provider, vn = jt.Root, xn = jt.Trigger, Be = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  jt.Content,
  {
    ref: a,
    sideOffset: e,
...
Be.displayName = jt.Content.displayName;
...
const Nn = c.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(yn.Provider, { value: k, children: /* @__PURE__ */ r(bn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Fa = bt(
  ...
  ({
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(xn, { asChild: !0, children: u }),
      /* @__PURE__ */ r(Be, { side: "right", align: "center", hidden: m !== "collapsed", ...o })
    ] })) : u;
  }
);
...
const $a = c.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(Fe, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          Fe,
          {
    ...
    kn,
    {
      ...
      children: /* @__PURE__ */ l(Sn, { children: [
        /* @__PURE__ */ l(ue, { children: [
          ...
          /* @__PURE__ */ r(he, { children: /* @__PURE__ */ r(Rn, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(Tn, { children: /* @__PURE__ */ r(
            _n,
            {
              className: d(
...
}, Ge = (t) => `${eo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function hs({
  sources: t,
  ...
  dt(() => {
    if (i) {
      ...
      if (z.length === 1) {
        const K = v.find((P) => Ge(P) === z[0]) || void 0;
        K && i(K);
      }
    }
  }, [g, v, i, y]);
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ l(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !b.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(ge, {}) : /* @__PURE__ */ r(hr, {})),
                          " ",
...
const no = (t, e) => {
...
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, p) => i.order - p.order).map((i) => /* @__PURE__ */ r(bn, { children: /* @__PURE__ */ l(vn, { children: [
  /* @__PURE__ */ r(xn, { asChild: !0, children: "command" in i ? /* @__PURE__ */ r(
    ye,
    {
      onClick: () => {
        a(i);
    ...
    /* @__PURE__ */ r(Ze, { children: i.label }),
    /* @__PURE__ */ r(Ir, { children: /* @__PURE__ */ r(Qe, { children: In(
      t,
      e,
      no(t, i.id),
      a
  ...
  i.tooltip && /* @__PURE__ */ r(Be, { children: i.tooltip })
] }) }))) : void 0;
function xs({
  commandHandler: t,
  menuData: e,
  ...
  return /* @__PURE__ */ l(Jt, { children: [
    ...
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, i]) => typeof w == "boolean" || typeof i == "boolean" ? 0 : w.order - i.order).map(([w], i, p) => /* @__PURE__ */ l(ft, { children: [
      /* @__PURE__ */ r(We, { children: In(e.groups, e.items, w, t) }, w),
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((m) => m.group === s).sort((m, u) => m.order - u.order).map(
      (m) => "command" in m ? /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ r(Pn, { children: m.label }),
...
function co({
  ...
  if (Rr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, f) => {
    var v, x, y, N;
    u.preventDefault();
    ...
    return /* @__PURE__ */ r(On, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, f]) => typeof u == "boolean" || typeof f == "boolean" ? 0 : u.order - f.order).map(([u, f]) => /* @__PURE__ */ l(ao, { children: [
      /* @__PURE__ */ r(An, { ref: m(u), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        jn,
        {
          className: "tw-z-[250]",
          children: Yn(t.groups, t.items, u, e)
        }
      )
    ] }, u)) });
}
