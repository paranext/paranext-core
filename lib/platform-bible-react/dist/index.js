...
import { c as m, g as Se, a as Ua, C as Ce, A as ie, P as Me, b as Ye, B as K, d as $e, e as Ie, f as Ae, h as xe, i as Vi, k as Li, j as ji, E as Bi, l as Ka, r as se, m as Fi, n as dn, o as ea, p as ra, L as Et, R as qa, q as Gr, D as Ca, s as Ea, t as Ta, u as za, T as wn, v as Lr, w as Ht, x as Ga, y as Yt, z as Wt, F as Xt, G as un, H as Ha, I as qe, J as kr, K as ye, M as ke, N as _e, S as _r, O as tr, Q as Ui, U as Er, V as He, W as De, Z as We, X as Re, Y as er, _ as Ya, $ as Wa, a0 as Hr, a1 as Xa, a2 as pn, a3 as Ki, a4 as qi, a5 as Gi, a6 as yo, a7 as hn, a8 as aa, a9 as gn, aa as Hi, ab as Yi, ac as Wi, ad as Xi, ae as fn, af as Ji, ag as ca, ah as ko, ai as la, aj as Zi, ak as Qi, al as ts, am as es, an as rs, ao as Tr, ap as Ja, aq as as, ar as os, as as ns } from "./resizable-C_uryyUe.js";
...
import { Check as or, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as Sa, ChevronRight as Ra, ArrowLeft as is, ArrowRight as ss, ChevronDown as nr, BoldIcon as cs, ItalicIcon as ls, X as Za, AtSign as mn, Pencil as ds, Trash2 as ws, ArrowUp as vn, MoreHorizontal as us, MailOpen as ps, Mail as hs, ChevronUp as gs, FilterIcon as fs, ArrowLeftIcon as ms, ChevronLeftIcon as vs, ChevronRightIcon as bs, ArrowRightIcon as xs, Copy as bn, Filter as ys, User as ks, Link as _s, CircleHelp as Ns, Undo as Cs, Redo as Es, SquareX as xn, FunctionSquare as yn, SquareSigma as kn, Ban as Ts, AlertCircle as Da, CircleCheckIcon as zs, CircleXIcon as Ss, CircleHelpIcon as Rs, ArrowUpIcon as Ds, ArrowDownIcon as Os, ScrollText as Ms, ChevronsUpDown as $s, MenuIcon as Is, Menu as As, EllipsisVertical as Ps, MoreVertical as Eo } from "lucide-react";
import { Section as wt, getChaptersForBook as Vs, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ls, formatReplacementString as Ge, sanitizeHtml as Qa, NumberFormat as js, formatBytes as Bs, getCurrentLocale as Fs, usfmMarkers as jr, getFormatCallerFunction as Us, deepEqual as Ks, isString as To, compareScrRefs as Oa, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as qs, getLocalizeKeyForScrollGroupId as zo, collectUsjMarkers as Gs } from "platform-bible-utils";
import Gt, { useRef as U, useMemo as A, useState as _, useCallback as B, useEffect as H, useImperativeHandle as Hs, useLayoutEffect as Ft, createContext as to, useContext as _n, Component as Ys, createElement as So, Suspense as Ws, forwardRef as Nn, useId as Yr, Fragment as Cn } from "react";
...
import { createEditor as zn, $getRoot as Oe, $createParagraphNode as zr, $getSelection as Jt, HISTORY_MERGE_TAG as eo, ParagraphNode as Sn, TextNode as Rn, $getPreviousSelection as ic, $isRangeSelection as ue, $caretFromPoint as sc, $getSiblingCaret as Dn, $getChildCaret as cc, $getAdjacentChildCaret as lc, $isChildCaret as dc, $normalizeCaret as wc, $setSelectionFromCaretRange as uc, $getCollapsedCaretRange as pc, $getCaretInDirection as Ro, $splitAtPointCaretNext as hc, $isTextPointCaret as gc, $findMatchingParent as On, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as fc, isHTMLElement as mc, CLEAR_EDITOR_COMMAND as Mn, COMMAND_PRIORITY_EDITOR as ro, shallowMergeConfig as vc, defineExtension as re, safeCast as Xe, createState as bc, FORMAT_TEXT_COMMAND as $n, $isNodeSelection as In, COMMAND_PRIORITY_LOW as An, RootNode as xc, LineBreakNode as yc, TabNode as kc, $isEditorState as _c, createCommand as Nc, CLICK_COMMAND as Cc, isDOMNode as Ec, $getNodeFromDOMNode as Tc, $createNodeSelection as zc, $setSelection as Sc, $getEditor as Rc, DecoratorNode as Ma, $getState as Dc, toggleTextFormatType as Do, TEXT_TYPE_TO_FORMAT as Oc, $setState as Mc, addClassNamesToElement as Pn, $create as $c, $getNodeByKey as Ic, removeClassNamesFromElement as Ac, KEY_TAB_COMMAND as Pc, $isBlockElementNode as Vc, $createRangeSelection as Lc, $normalizeSelection__EXPERIMENTAL as jc, OUTDENT_CONTENT_COMMAND as Bc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Fc, COMMAND_PRIORITY_CRITICAL as ao, $isDecoratorNode as Uc, $isParagraphNode as Kc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Vn, $insertNodes as qc } from "lexical";
...
import { Avatar as oo, Select as Ut, Checkbox as Mo, Slot as Sr, Tabs as ce, Menubar as he, ContextMenu as Ot, Progress as $o, Slider as Or, Switch as Io } from "radix-ui";
import { useReactTable as jn, getFilteredRowModel as tl, getSortedRowModel as Bn, getPaginationRowModel as el, getCoreRowModel as Fn, flexRender as xr, getGroupedRowModel as rl, getExpandedRowModel as al } from "@tanstack/react-table";
...
function pa({
  ...
  const F = se(), [C, M] = _(!1), [$, E] = _(""), [V, G] = _(""), [y, J] = _("books"), [j, X] = _(void 0), [z, I] = _(
    void 0
  ...
  }), [Mt]), Zt = A(() => Object.values(Vt).flat(), [Vt]), fe = A(() => {
    if (!V.trim()) return Vt;
    const b = {
      [wt.OT]: [],
      [wt.NT]: [],
    ...
    return [wt.OT, wt.NT, wt.DC, wt.Extra].forEach((rt) => {
      b[rt] = Vt[rt].filter((Pt) => Ka(Pt, V, n));
    }), b;
  }, [Vt, V, n]), R = A(
    () => gl(V, Zt, n),
    [V, Zt, n]
  ...
  const zt = B(() => {
    ...
    (b) => {
      const W = z ?? (R == null ? void 0 : R.book), rt = O ?? (R == null ? void 0 : R.chapterNum);
      !W || !rt || (yt({
        book: W,
        chapterNum: rt,
        verseNum: b
    ...
    J("books"), X(void 0), I(void 0), Y(void 0), setTimeout(() => {
      pt.current && pt.current.focus();
    }, 0);
  }, []), ot = B(() => {
    const b = z;
    I(void 0), Y(void 0), b ? (X(b), J("chapters"), E("")) : et();
  }, [z, et]), it = B((b) => {
    M(b), b && (J("books"), X(void 0), I(void 0), Y(void 0), G(""));
  }, []);
  H(() => {
    D && it(!1);
  }, [D, it]);
  ...
  const { otLong: gt, ntLong: mt, dcLong: $t, extraLong: Rt } = {
    ...
    () => pl(V),
    [V]
  ), oe = A(() => !l || !R || !R.chapterNum || !kt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, kt]), Le = B(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), ur = B(
    (b) => (W) => w ? hl(b, W, w) : !1,
    ...
    (b) => {
      var me, Te, Be;
      if (b.ctrlKey) return;
      const { isLetter: W, isDigit: rt } = Po(b.key);
      ...
      if (y === "verses" && Pt) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            vt !== 0 && (Lt = vt > 1 ? vt - 1 : Ct);
            break;
          case "ArrowRight":
            vt !== 0 && (Lt = vt < Ct ? vt + 1 : 1);
            break;
          case "ArrowUp":
            Lt = vt === 0 ? Ct : Math.max(1, vt - le);
            break;
          case "ArrowDown":
            Lt = vt === 0 ? 1 : Math.min(Ct, vt + le);
            break;
          default:
            return;
        }
        Lt !== vt && (b.preventDefault(), b.stopPropagation(), E(
          `${St} ${ie[St] || ""} ${Nt}:${Lt}`
        ), setTimeout(() => {
          const Fe = ht.current[Lt];
          Fe && Fe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((y === "chapters" || y === "books" && R) && Pt) {
        const St = y === "chapters" ? j : R == null ? void 0 : R.book;
        if (!St) return;
        ...
        switch (b.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            vt = Nt === 0 ? Ct : Math.max(1, Nt - Lt);
            break;
          case "ArrowDown":
            vt = Nt === 0 ? 1 : Math.min(Ct, Nt + Lt);
            break;
          default:
            return;
        }
  ...
  return Ft(() => {
    const b = setTimeout(() => {
      if (C && y === "books" && at.current && bt.current) {
        const W = at.current, rt = bt.current, Pt = rt.offsetTop, me = W.clientHeight, Te = rt.clientHeight, Be = Pt - me / 2 + Te / 2;
        W.scrollTo({
          top: Math.max(0, Be),
          behavior: "smooth"
        }), E(Kn(t.book));
  ...
  }, [y, j, R, t.book, t.chapterNum]), Ft(() => {
    if (y === "verses" && z && O !== void 0) {
      const b = z === t.book && O === t.chapterNum, W = b ? t.verseNum : 1;
      E(
        `${z} ${ie[z] || ""} ${O}:${W}`
      ), setTimeout(() => {
        if (at.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Me, { open: C, onOpenChange: it, modal: T, children: [
          ...
          Ie,
          {
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                y === "verses" && z && O !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Se(z, n)} ${O}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !lt && /* @__PURE__ */ u(Ae, { ref: at, children: [
                  ...
                  !R && Object.entries(fe).map(([b, W]) => {
                    if (W.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(xe, { heading: Kt(b), children: W.map((rt) => /* @__PURE__ */ a(
                          Un,
                          {
                            bookId: rt,
                            onSelect: (Pt) => Ee(Pt),
                ...
                y === "verses" && z && O !== void 0 && l && /* @__PURE__ */ a(
                  Lo,
                  {
                    bookId: z,
                    chapterNum: O,
...
function jo({
  ...
  const [N, D] = _(!1), F = l ?? d, C = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], M = ($, E) => {
    const V = d($), G = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, y = `${E ?? ""}${V}${G ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: V,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ie, { children: [
          ...
          /* @__PURE__ */ a(Ae, { children: C(e) ? e.map(($) => /* @__PURE__ */ a(xe, { heading: $.groupHeading, children: $.options.map((E) => M(E, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map(($) => M($)) }) })
        ] })
      }
    )
  ] });
...
function tp({
  ...
  const w = ha(l, "%webView_bookSelector_currentBook%"), p = ha(l, "%webView_bookSelector_choose%"), g = ha(l, "%webView_bookSelector_chooseBooks%"), [h, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Hn ? Ft : H, Ir = { tag: eo };
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Sl() {
  return function(t) {
    const [e] = ge(), r = A(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = U(o);
    return Tl(() => {
...
function Ml(t, e, r) {
  ...
  const w = t.registerRootListener(function p() {
    ...
    l(), o = g, n = h, i = new MutationObserver((f) => {
      ...
      if (x !== o || v !== n) return p();
      for (const T of f) if (!c.contains(T.target)) return d();
    }), i.observe(h, Ol), d();
  });
  return () => {
    w(), l();
...
function Il(t, e = $l) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, T = h.getNode(), k = T.getKey(), N = h.offset, D = t.getElementByKey(x), F = t.getElementByKey(k), C = r === null || D !== o || v !== n || x !== r.getKey(), M = i === null || F !== s || N !== c || k !== i.getKey();
      if ((C || M) && D !== null && F !== null) {
        const $ = function(E, V, G, y, J, j, X) {
          const z = (E._window ? E._window.document : document).createRange();
          return z.setStart(...Bo(V, G, y)), z.setEnd(...Bo(J, j, X)), z;
        }(t, g, f, D, h, T, F);
        d(), d = Ml(t, $, e);
      }
...
function Vl(t) {
  ...
  if (ue(e)) r = sc(e.focus, "next");
    ...
    r = r || cc(Oe(), "previous").getFlipped().insert(zr());
  }
  const o = Ll(t, r), n = lc(o), i = dc(n) ? wc(n) : o;
  return uc(pc(i)), t.getLatest();
}
function Ll(t, e, r) {
  let o = Ro(e, "next");
  for (let n = o; n; n = hc(n, r)) o = n;
  return gc(o) && Wr(283), o.insert(t.isInline() ? zr().append(t) : t), Ro(Dn(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = Jt();
  if (!ue(e)) return !1;
...
let Xr, be = 0, Jr = 0, Ul = 0, Va = 0, Fr = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function ql(t) {
  ...
  Xn(this), nt = t, this.f &= -2, 8 & this.f && co(this), na();
}
function Qe(t, e) {
...
Bt.prototype.brand = Bl, Bt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Jr === 0 && e.l !== Va && (e.l = Va, Xr = { S: e, v: e.v, i: e.i, o: Xr });
...
re({ build: (t, e, r) => wr(e), config: Xe({ $onClear: Zn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const La = re({ build: (t) => ei(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const lo = 0, ja = 1, ai = 2, ma = 3, Ar = 4, Ze = 5, va = 6, mr = 7;
function ba(t) {
  return t.id === lo;
}
function oi(t) {
...
function Yl(t) {
  return function(e) {
    return e.id === ja;
  }(t) || dt(305, String(t.id), String(ja)), Object.assign(t, { id: ai });
}
...
class Xl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ar && dt(307, String(r.id), String(Ze)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const Zl = re({ config: Xe({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[Go];
    return r && (r.PACKAGE_VERSION !== xa && dt(292, r.PACKAGE_VERSION, xa), r instanceof ar || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ba(i) || dt(300, s, n || "[unknown]"), ba(c = i) || dt(304, String(c.id), String(lo)), i = Object.assign(c, { id: ja }), o.state = i;
...
const td = /* @__PURE__ */ new Set(), Yo = re({ build(t, e, r) {
  const o = r.getDependency(La).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ei(() => {
  }, () => pe(() => {
...
re({ dependencies: [La, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
...
function od(t, e, r = ni) {
  return Ne(t.registerCommand(Pc, (o) => {
    const n = Jt();
    if (!ue(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => Vc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Pl(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Lc();
      ...
      return !1;
    }(n) ? o.shiftKey ? Bc : Oo : Fc;
    return t.dispatchCommand(i, void 0);
  }, ro), t.registerCommand(Oo, () => {
...
re({ build: (t, e, r) => wr(e), config: Xe({ $canIndent: ni, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                ...
                if ($a(v) && l >= 0 && w >= 0 && (T = l, k = l + w, f.setTextNodeRange(v, T, v, k)), T === k && p === "" || (f.insertRawText(p), v = x.getNode()), $a(v)) {
                  T = g, k = g + h;
...
re({ build: (t, e, r) => wr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : si(t)) });
function ld(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
...
const gd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function fd({ onClear: t }) {
  const [e] = ge();
  return gd(() => Qn(e, t), [e, t]), null;
}
const ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
...
function Td() {
  const { activeEditor: t } = di(), [e, r] = _([]), o = B((n) => {
    if (ue(n) || Jc(n)) {
      const i = [];
      Jo.forEach(({ format: s }) => {
...
function rp({
  ...
  const [i, s] = _(Md), [c, d] = _(n), [l, w] = _(!1), p = U(void 0), g = U(null);
  H(() => {
    let v = !0;
    const T = g.current;
    if (!T) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : ho(v) && (v.preventDefault(), v.stopPropagation(), ee(i) && h());
        },
        onKeyDown: (v) => {
...
function Qo({
  ...
  }, [t.date, r]), v = A(() => t.user, [t.user]), T = A(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = A(() => Qa(t.contents), [t.contents]), N = A(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), D = !!t.conflictResolutionAction && !N, F = A(() => {
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          qe,
          {
            onClick: (C) => {
              C.stopPropagation(), l(!0), p(Dd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Pd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Vd, { className: "tw:text-xs tw:font-medium", children: T }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), h()) : ho(C) && (C.preventDefault(), C.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (C) => {
                po(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
        ...
        F && /* @__PURE__ */ u(ye, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(us, {}) }) }),
...
function bi({
  ...
  const [y, J] = _(tn), [j, X] = _(), [z, I] = _(), O = o, [Y, lt] = _(!1), [ut, Tt] = _(!1), [q, tt] = _(!1), [pt, at] = _(!1), [bt, ae] = _(!1), [ht, yt] = _(D), [Mt, Vt] = _(!1), Zt = U(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
      const kt = k ? await k(d) : !1;
      S && ae(kt);
    })(), () => {
      S = !1;
    };
  ...
  H(() => {
    if (!o) {
      _t.current !== "idle" && (X(void 0), I(void 0), _t.current = "idle");
      return;
    }
    _t.current === "idle" && (_t.current = "pending"), pt ? _t.current === "pending" && M !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    M !== i && (X(M), _t.current = "auto-populated") : _t.current === "auto-populated" && (X(void 0), _t.current = "pending");
  }, [o, M, pt, i]);
  const zt = A(
  ...
  const Qt = A(() => zt[0], [zt]), Ee = U(null), te = U(void 0), L = B(() => {
    var S;
    (S = te.current) == null || S.call(te), J(tn);
  }, []), Q = B(() => {
    const S = !ht;
    yt(S), Vt(!S), f == null || f(d, S);
  }, [ht, f, d]);
  H(() => {
    lt(!1);
  }, [o]), H(() => {
  ...
  }, [i, r]), it = A(() => zt.slice(1), [zt]), st = A(() => it.length ?? 0, [it.length]), ft = A(() => st > 0, [st]), gt = A(() => Y || st <= 2 ? it : it.slice(-2), [it, st, Y]), mt = A(() => Y || st <= 2 ? 0 : st - 2, [st, Y]), $t = A(
    () => st === 1 ? et.singleReply : Ge(et.multipleReplies, { count: st }),
    [st, et]
  ), Rt = A(
    () => mt === 1 ? et.singleReply : Ge(et.multipleReplies, { count: mt }),
    [mt, et]
  );
  H(() => {
    !o && ut && ft && Tt(!1);
  ...
  const Kt = B(
    async (S) => {
      ...
      At && await p({ threadId: d, contents: At }) && L();
    },
    [
      L,
      y,
    ...
    async (S) => {
      const At = ee(y) ? Qr(y) : void 0, kt = S.status ? S.assignedUser : j ?? S.assignedUser, oe = await p({
        ...S,
        contents: At,
        assignedUser: kt
      });
      return oe && (kt !== void 0 && I(kt), At && L()), oe;
    },
    [L, y, p, j]
  );
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            gt.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Qo,
              {
                ...
                handleDeleteComment: h,
                onEditingChange: Tt,
                canEditOrDelete: (!ut && fe.get(S.id)) ?? !1
              }
            ) }, S.id)),
            v !== !1 && (!ut || ee(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  ho(S) && (S.preventDefault(), S.stopPropagation(), (ee(y) || j !== void 0 && j !== z) && Kt());
                },
                onKeyDown: (S) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    j !== void 0 && (ee(y) || j !== z) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ae, { children: x == null ? void 0 : x.map((S) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                X(S !== i ? S : void 0), _t.current = "user-selected", I(void 0), tt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Ur(S, r) })
                            },
                            S || "unassigned"
                          )) }) })
                        }
...
function Bd({
  ...
  const [s, c] = _("accept"), d = Yr(), l = Yr(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = A(
    () => Kr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Kr(t.acceptedText ?? ""),
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", G = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), y = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : G, J = () => {
    const z = o ?? "accept";
    return z === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: T }) : G : y(z === "reject" ? t.rejectedResultText : t.resultText);
  }, j = (z) => p && z.value === "reject", X = (z) => {
    const I = f === z.value, O = `${l}-${z.value}`, Y = j(z);
    return (
      ...
      !w && !g && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          qa,
          {
            ...
            children: C.map((z) => j(z) ? /* @__PURE__ */ a(Ht, { delayDuration: 0, children: /* @__PURE__ */ u(Yt, { children: [
              /* @__PURE__ */ a(Wt, { asChild: !0, children: X(z) }),
              /* @__PURE__ */ a(Xt, { children: D })
            ] }) }, z.value) : X(z))
          }
        ),
...
function Gd(t) {
  ...
  } = t, c = A(() => e.filter((T) => !T.deleted), [e]), d = A(
...
function wp({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [D, F] = _(), [C, M] = _(), $ = B(
    async (I) => {
      const O = await i(I);
      return O !== void 0 && I.assignedUser !== void 0 && I.assignedUser !== "" && M(I.assignedUser), O;
    },
    [i]
  );
  H(() => {
    f && (N((I) => new Set(I).add(f)), F(f));
  }, [f]);
  const E = r.filter(
    (I) => I.comments.some((O) => !O.deleted)
  ), V = E.map((I) => ({ id: I.id })), G = B(
    (I) => {
      N((O) => new Set(O).add(I.id)), F(I.id), x == null || x(I.id);
    },
    [x]
  ), y = B(
    (I) => {
      ...
      }), F(I), x == null || x(O ? void 0 : I);
    },
    [k, x]
  ), { listboxRef: J, activeId: j, handleKeyDown: X } = Ui({
    options: V,
    onOptionSelect: G
  }), z = B(
    (I) => {
      I.key === "Escape" ? (D && k.has(D) && (N((O) => {
        const Y = new Set(O);
        return Y.delete(D), Y;
      }), F(void 0), x == null || x(void 0)), I.preventDefault(), I.stopPropagation()) : X(I);
    },
    [D, k, X, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: E.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Gd, { ...O, conflictResolution: T }) : /* @__PURE__ */ a(bi, { ...O })
          },
          I.id
        );
      })
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ut.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ut.Icon, { asChild: !0, children: /* @__PURE__ */ a(En, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Zd({
  ...
  var C;
  const [w, p] = _([]), [g, h] = _([]), [f, x] = _({}), [v, T] = _({}), k = A(() => e ?? [], [e]), N = jn({
    data: k,
    columns: t,
    getCoreRowModel: Fn(),
  ...
  return d ? F = Array.from({ length: 10 }).map((E, V) => `skeleton-row-${V}`).map((E) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: D.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((C = N.getRowModel().rows) == null ? void 0 : C.length) > 0 ? F = N.getRowModel().rows.map((M) => /* @__PURE__ */ a(
    ...
    M.id
  )) : F = /* @__PURE__ */ a(Re, { children: /* @__PURE__ */ a(er, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Hd, { table: N }),
    /* @__PURE__ */ u(Ya, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Wa, { stickyHeader: i, children: N.getHeaderGroups().map((M) => /* @__PURE__ */ a(Re, { children: M.headers.map(($) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : xr($.column.columnDef.header, $.getContext()) }, $.id)) }, M.id)) }),
...
function ow({
  ...
  const d = Ha(), l = rn(n, "%undoButton_tooltip%"), w = rn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ga, { children: [
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(
        K,
...
function nw({
  ...
  return H(() => {
    var d;
    const i = Ha(), s = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, c = (l) => {
      var p, g, h, f;
...
const iw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ct, { children: [
...
function sw({
  ...
  const f = (v) => {
    ...
    var T, k, N, D;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((T = i.current) == null || T.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((D = s.current) == null || D.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
const cw = (t, e) => t === "f" ? /* @__PURE__ */ u(ct, { children: [
  /* @__PURE__ */ a(yn, {}),
  " ",
...
function dw({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
      /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ a("p", { children: lw(t, r) }) })
    ] }) }),
...
function yp({
  ...
  const [f, x] = _("generated"), [v, T] = _("generated"), [k, N] = _("*"), [D, F] = _("*"), [C, M] = _("f"), [$, E] = _(!1), [V, G] = _(!0), [y, J] = _(!1), j = U(!1), X = U(""), [z, I] = _(!1), [O, Y] = _(), [lt, ut] = _(), [Tt, q] = _(), [tt, pt] = _(), at = U(null), bt = A(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Ia ? st = "generated" : it === Aa ? st = "hidden" : it && (N(it), F(it)), x(st), T(st), M(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), L = setTimeout(() => {
        var ft;
  ...
  const ht = B(
    (L, Q, et = !1) => {
      ...
      if (ot && Mr("note", ot)) {
        if (ot.insert.note) {
          let gt;
          L === "custom" ? gt = Q : L === "generated" ? gt = Ia : gt = Aa, ot.insert.note.caller = gt;
        }
        r == null || r([ot]), et && l && i && ((ft = l.current) == null || ft.replaceEmbedUpdate(i, [ot]));
      }
    },
    [i, r, l]
  ), yt = B(() => {
  ...
  const Vt = U({ book: n.book, chapterNum: n.chapterNum });
  Ft(() => {
    (Vt.current.book !== n.book || Vt.current.chapterNum !== n.chapterNum) && (Vt.current = { book: n.book, chapterNum: n.chapterNum }, Mt.current());
  }, [n.book, n.chapterNum]);
  const Zt = () => {
    var Q;
    ...
    if (Q && Mr("note", Q)) {
      ...
      C !== "x" && L === "x" ? gt == null || gt.forEach((mt) => gw(mt)) : C === "x" && L !== "x" && (gt == null || gt.forEach((mt) => fw(mt))), (ft = w.current) == null || ft.applyUpdate([Q, { delete: 1 }]);
    }
  }, zt = (L) => {
    ...
    if (g.current && ae.length && L && L.rangeCount > 0) {
      ...
      Y(Q.left - et.left), ut(Q.top - et.top), q(Q.height), I(!0);
    }
  }, [ae, g]);
  H(() => {
    const L = () => {
...
function kw({
  ...
  return /* @__PURE__ */ u(Ya, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Wa, { stickyHeader: !0, children: /* @__PURE__ */ u(Re, { children: [
    ...
    /* @__PURE__ */ a(Xa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Re,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(er, { className: o, children: yw(c.text) })
        ]
      },
...
const _w = (t) => {
...
}, ia = (t, e, r) => /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
  /* @__PURE__ */ u(
    Wt,
    {
  ...
  return e ? e[1] : "";
}, Cw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Rp = Object.freeze([
...
function Dp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), T = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), D = de(r, "%webView_inventory_filter_text%"), F = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = de(r, "%webView_inventory_no_results%"), [M, $] = _(!1), [E, V] = _("all"), [G, y] = _(""), [J, j] = _([]), X = A(() => {
    const q = t ?? [];
  ...
  }, [M, X]), I = A(() => z.length === 0 ? [] : Ew(z, E, G), [z, E, G]), O = A(() => {
    var pt, at;
    if (!M) return d;
  ...
  H(() => {
    I.length === 0 ? j([]) : I.length === 1 && j(I[0].items);
  }, [I]);
  const Y = (q, tt) => {
    tt.setRowSelection(() => {
      const at = {};
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
        ...
        /* @__PURE__ */ a(Xt, { children: (o == null ? void 0 : o.checkboxText) ?? F })
      ] }) })
    ] }),
...
const zw = "16rem", Sw = "3rem", ki = Gt.createContext(void 0);
function sa() {
  const t = Gt.useContext(ki);
  if (!t)
...
function Rw({
  ...
  const [d, l] = Gt.useState(t), w = e ?? d, p = Gt.useCallback(
    (N) => {
      const D = typeof N == "function" ? N(w) : N;
      r ? r(D) : l(D);
    },
    [r, w]
  ), g = Gt.useCallback(() => p((N) => !N), [p]), h = w ? "expanded" : "collapsed", v = se() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = Gt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Pw({
  ...
  const c = t ? Sr.Root : "button", { state: d } = sa(), l = /* @__PURE__ */ a(
    c,
    {
...
const ze = "scrBook", Lw = "scrRef", Ke = "source", jw = "details", Bw = "Scripture Reference", Fw = "Scripture Book", _i = "Type", Uw = "Details";
function Kw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? xt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ze ? ve(n.start) : void 0;
      },
...
function Gp({
  ...
  const [l, w] = _([]), [p, g] = _([{ id: ze, desc: !1 }]), [h, f] = _({}), x = A(
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const G = x.find((y) => cn(y) === V[0]) || void 0;
        G && c(G);
      }
    }
  }, [h, x, c, T]);
  const k = n ?? Fw, N = i ?? _i, D = [
  ...
  }, M = (E, V) => E.getIsGrouped() ? "" : m("banded-row", V % 2 === 0 ? "even" : "odd"), $ = (E, V, G) => {
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Yd, { children: D.map((E) => /* @__PURE__ */ a(ne, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ya, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Wa, { children: T.getHeaderGroups().map((E) => /* @__PURE__ */ a(Re, { children: E.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(Xa, { children: T.getRowModel().rows.map((E, V) => {
        const G = se();
        return /* @__PURE__ */ a(
          Re,
          {
...
function Gw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [x, v] = _(!1), [T, k] = _(""), N = U(void 0), D = U(!1), F = A(
    () => Ni(t),
    [t]
  ), C = A(() => {
    if (!T.trim()) {
    ...
    M(y, D.current), D.current = !1;
  }, E = (y, J) => {
    y.preventDefault(), M(J, y.shiftKey);
  }, V = () => {
    r(F.map((y) => y));
  }, G = () => {
    r([]);
          ...
          Ie,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: V, children: d }),
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: G, children: l })
              ] }),
              /* @__PURE__ */ u(Ae, { children: [
...
function Yp({
  ...
  const D = Dt(
    s,
    "%webView_scope_selector_selected_text%"
  ), F = Dt(s, "%webView_scope_selector_verse%"), C = Dt(s, "%webView_scope_selector_chapter%"), M = Dt(s, "%webView_scope_selector_book%"), $ = Dt(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = Dt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = Dt(s, "%webView_scope_selector_current_book%"), G = Dt(s, "%webView_scope_selector_choose_books%"), y = Dt(s, "%webView_scope_selector_scope%"), J = Dt(s, "%webView_scope_selector_select_books%"), j = Dt(s, "%webView_scope_selector_range%"), X = Dt(s, "%webView_scope_selector_select_range%"), z = Dt(s, "%webView_scope_selector_range_start%"), I = Dt(s, "%webView_scope_selector_range_end%"), O = Dt(s, "%webView_scope_selector_ok%"), Y = Dt(s, "%webView_scope_selector_cancel%"), lt = Dt(s, "%webView_scope_selector_navigate%"), ut = (P) => {
    if (!f) return;
  ...
  ], q = (P, Z, qt = !1) => /* @__PURE__ */ u(ct, { children: [
    P,
    Z && !qt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), tt = e ? Tt.filter((P) => e.includes(P.value)) : Tt, pt = f ?? wa, at = w ?? pt, bt = p ?? pt, ae = () => {
  }, ht = U(null), yt = U(null), Mt = U(!1), Vt = U(null), Zt = U(!1), [fe, R] = _(void 0), _t = U(!1), zt = U(!1), Qt = U(null), Ee = B((P) => {
    if (P) {
    ...
    R((Z) => Z === "start" ? void 0 : Z), _t.current && (_t.current = !1, requestAnimationFrame(() => {
      var qt;
      const Z = (qt = ht.current) == null ? void 0 : qt.querySelector("button");
      Z == null || Z.click();
    }));
  }, []), te = B((P) => {
    if (P) {
    ...
    [r, n, f, i]
  ), ot = tt.find((P) => P.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? qs(at, bt, {
  ...
  ), ft = tt.find((P) => P.value === "selectedBooks"), gt = tt.find((P) => P.value === "range"), [mt, $t] = _(!1), [Rt, Kt] = _(void 0), [It, Ve] = _(void 0), [S, At] = _(void 0), [kt, oe] = _(void 0), [Le, ur] = _([]), pr = l === "dropdown" && Rt === "selectedBooks", hr = /* @__PURE__ */ a(
    Yw,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Je = "tw:text-muted-foreground", je = l === "dropdown" && Rt === "range", b = je ? At : L, rt = je ? oe : h ? Q : ae, Pt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: m(gr && Je), children: z }),
      /* @__PURE__ */ a(
        pa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ht, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Rr && Je), children: I }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
          ...
          onCloseAutoFocus: (P) => {
            var Z;
            zt.current && (zt.current = !1, P.preventDefault(), (Z = Qt.current) == null || Z.focus());
          },
          className: m(Rr && Je),
          modal: !0,
          align: "start"
  ...
  const [St, Nt] = _(null), [Ct, vt] = _(null), [Lt, le] = _(null), Fe = 200, [Mi, $i] = _(!1);
  H(() => {
    if (!Lt || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([Z]) => {
      $i(Z.contentRect.width < Fe);
    });
    return P.observe(Lt), () => P.disconnect();
  }, [Lt]);
  const mo = B(
    (P) => {
      Ve(P), At(at), oe(bt), ur(n), $t(!1), Kt(P);
    },
    [at, bt, n]
  ), vo = B(() => {
    It !== void 0 && (It === "range" ? (S && (g == null || g(S)), kt && (h == null || h(kt))) : It === "selectedBooks" && i(Le), et(It), Kt(void 0), Ve(void 0));
  }, [
    It,
    S,
    kt,
    ...
    P || (Kt(void 0), Ve(void 0));
  }, []), bo = B((P) => {
    var Z;
    P.preventDefault(), (Z = Be.current) == null || Z.focus();
  }, []), xo = (P) => t === P ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Et, { children: y }),
      l === "dropdown" ? /* @__PURE__ */ u(ye, { open: mt, onOpenChange: $t, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ca, { container: Lt, children: [
              st.map(({ value: P, label: Z, dropdownLabel: qt, scrRefSuffix: fr, id: Ii }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Te(P),
                  ...
                  children: [
                    t === P && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }),
                    q(qt ?? Z, fr, Mi)
                  ]
                },
                Ii
                ...
                /* @__PURE__ */ a(
                  qe,
                  {
                    ...
                    onSelect: (P) => {
                      ...
                      Zt.current || (qt = (Z = yt.current) == null ? void 0 : Z.querySelector("button")) == null || qt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          pa,
                          {
                            ...
                            onCloseAutoFocus: (P) => {
                              var Z;
                              P.preventDefault(), (Z = Vt.current) == null || Z.focus();
                            },
                            modal: !0,
        ...
        qa,
        {
          ...
          children: tt.map(({ value: P, label: Z, scrRefSuffix: qt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: P, id: fr }),
            /* @__PURE__ */ a(Et, { htmlFor: fr, children: q(Z, qt) })
          ] }, fr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && Pt,
    l === "dropdown" && ft && /* @__PURE__ */ a(Ca, { open: Rt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: vt,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(ca, { container: Ct, children: [
          /* @__PURE__ */ a(Ta, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: G }) }),
          hr,
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Dr(!1), children: Y }),
            /* @__PURE__ */ a(K, { onClick: vo, children: O })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(Ca, { open: Rt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: Nt,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (P) => {
          St != null && St.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(ca, { container: St, children: [
          /* @__PURE__ */ a(Ta, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: X }) }),
          Pt,
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Dr(!1), children: Y }),
            /* @__PURE__ */ a(K, { ref: Qt, onClick: vo, children: O })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: We },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: d[zo(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Ba({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(K, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Is, {}) }) }),
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Cn, { children: [
      /* @__PURE__ */ a(pn, { children: /* @__PURE__ */ a(Ht, { children: Ti(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(He, {})
    ] }, d)) })
  ] });
}
const zi = Gt.forwardRef(
...
const Si = Gt.forwardRef(({ className: t, ...e }, r) => {
  const o = se();
  return /* @__PURE__ */ a(
    ce.Root,
    {
...
const Ri = Gt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.List,
  {
    ref: r,
    className: m(
...
const Jw = Gt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Trigger,
  {
    ref: r,
    ...e,
...
)), Di = Gt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Content,
  {
    ref: r,
    className: m(
...
Di.displayName = ce.Content.displayName;
function eh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  if (sl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (T = d.current) == null || T.focus(), vr(d, [g, h]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ a(Zw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Qw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: We },
          children: /* @__PURE__ */ a(Ht, { children: Oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function oh({
  ...
  return /* @__PURE__ */ u("div", { id: d, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: Ge(l, {
...
function ih({
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(as, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(os, { children: /* @__PURE__ */ a(tc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(ye, { children: [
              /* @__PURE__ */ a(ke, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(K, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Eo, {}) }) }),
...
function Yh(t) {
  const e = A(() => Gs(t).slice().sort().join(" "), [t]);
...
const Fa = 288, yu = 176, Vr = 12, ku = 6;
function _u(t) {
...
function Cu(t, e, r) {
  const o = (i) => Math.max(8, Math.min(i, window.innerWidth - Fa - 8)), n = (i) => Math.max(8, Math.min(i, window.innerHeight - r - 8));
  switch (e) {
    case "top":
      return {
        top: n(t.top - Vr - r),
    ...
    case "left":
      return { top: n(t.top), left: o(t.left - Fa - Vr) };
    case "right":
...
function Xh({
  ...
  const [l, w] = _([]), [p, g] = _(0), [h, f] = _(void 0), [x, v] = _(yu), T = U(null), k = U(null), N = U(void 0), D = Yr(), F = Yr();
  Ft(() => {
    if (!e) {
      w([]), g(0), f(void 0);
      return;
  ...
  const G = Nu(C.side ?? "bottom"), y = Cu(h, G, x), J = C.spotlightPadding ?? ku, j = h.left - J, X = h.top - J, z = h.width + J * 2, I = h.height + J * 2;
  return /* @__PURE__ */ u(
    "div",
    {
      role: "dialog",
          ...
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ a("defs", { children: /* @__PURE__ */ u("mask", { id: D, children: [
                ...
                /* @__PURE__ */ a("rect", { x: j, y: X, width: z, height: I, rx: "6", fill: "black" })
              ] }) }),
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between tw:pt-1", children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
                  !$ && /* @__PURE__ */ a(K, { variant: "outline", size: "sm", onClick: V, children: s }),
                  /* @__PURE__ */ a(K, { ref: T, size: "sm", onClick: E, children: M ? d : i })
                ] })
              ] })
            ]
          }
