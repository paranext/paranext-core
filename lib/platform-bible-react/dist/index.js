...
import { History as Gl, ChevronRight as Ci, Check as No, Circle as Wl, ArrowDownWideNarrow as Xl, Clock as Yl, Bookmark as ql, FilterIcon as Kl, ChevronDown as bn, ChevronUp as Jl, ArrowLeftIcon as Zl, ChevronLeftIcon as Ql, ChevronRightIcon as ec, ArrowRightIcon as tc, ArrowUpIcon as rc, ArrowDownIcon as nc, ArrowUpDownIcon as oc, CircleCheckIcon as ga, CircleXIcon as ba, CircleHelpIcon as va, X as ac, Search as ic, ChevronsUpDown as sc, ChevronLeft as lc, LoaderCircle as vn, Download as cc, Filter as pc, User as dc, Link as uc, CircleHelp as fc } from "lucide-react";
import Ce, { clsx as mc } from "clsx";
import { extendTailwindMerge as hc } from "tailwind-merge";
import * as ge from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as gc } from "@radix-ui/react-dropdown-menu";
import { getChaptersForBook as bc, compareScrRefs as io, scrRefToBBBCCCVVV as Vn, formatScrRef as zn, NumberFormat as vc, formatBytes as yc } from "platform-bible-utils";
import { useReactTable as Oi, getCoreRowModel as Ri, getPaginationRowModel as wc, getSortedRowModel as Pi, getFilteredRowModel as xc, flexRender as kr, getExpandedRowModel as kc, getGroupedRowModel as Ec } from "@tanstack/react-table";
...
import { FormControlLabel as ya, FormLabel as Tc, Checkbox as Sc, MenuItem as Cc, ListItemText as Oc, ListItemIcon as $i, Menu as Rc, Grid as _i, List as Pc, IconButton as Ii, Drawer as $c, Slider as _c, Snackbar as Ic, Switch as Mc, AppBar as Ac, Toolbar as Dc } from "@mui/material";
import * as Or from "@radix-ui/react-popover";
import { Command as Ae } from "cmdk";
import * as Qe from "@radix-ui/react-dialog";
import jc, { ThemeContext as Bc, internal_processStyles as Lc } from "@mui/styled-engine";
...
const Vc = hc({ prefix: "pr-" });
function F(...e) {
  return Vc(mc(e));
}
const jr = W.forwardRef(
...
var Uc = Object.defineProperty, Hc = (e, t, r) => t in e ? Uc(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => Hc(e, typeof t != "symbol" ? t + "" : t, r);
const At = [
  "GEN",
  "EXO",
  "LEV",
...
const Ro = ge.Root, zi = ge.Trigger, tp = ge.Group, _v = ge.Portal, Iv = ge.Sub, Mv = ge.RadioGroup, rp = W.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ _(
  ge.SubTrigger,
  {
    ref: o,
    className: F(
...
rp.displayName = ge.SubTrigger.displayName;
const np = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ge.SubContent,
  {
    ref: r,
    className: F(
...
np.displayName = ge.SubContent.displayName;
...
const Ui = W.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ d(
  ge.Item,
  {
    ref: n,
    className: F(
...
const Hi = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  ge.RadioItem,
  {
    ref: n,
    className: F(
...
const Br = W.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ d(
  ge.Label,
  {
    ref: n,
...
function sp({ handleSort: e, handleLocationHistory: t, handleBookmarks: r }) {
...
const Er = me.allBookIds, lp = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ka = ["OT", "NT", "DC"], cp = 32 + 32 + 32, pp = [
  /^(\w+)$/i,
...
function Av({ scrRef: e, handleSubmit: t }) {
  const [r, n] = ce(""), [o, a] = ce(
    ...
    pp.forEach(($) => {
      const E = r.match($);
      if (E) {
        const [R, I = void 0, U = void 0] = E.slice(1), B = mp(R);
  ...
  return He(() => {
    ...
    const $ = setTimeout(() => {
      if (g && u.current && b.current) {
        const R = b.current.offsetTop - cp;
        ...
        children: [
          ...
          ka.map(
            ($, E) => x($).length > 0 && /* @__PURE__ */ _("div", { children: [
              /* @__PURE__ */ d(Br, { className: "pr-font-semibold pr-text-slate-700", children: lp[$] }),
...
const hp = To(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? Nc : "button", { className: F(hp({ variant: t, size: r, className: e })), ref: a, ...o })
);
we.displayName = "Button";
function gp({ table: e }) {
  return /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ d(gc, { asChild: !0, children: /* @__PURE__ */ _(we, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
...
const sn = xe.Root, bp = xe.Group, ln = xe.Value, Rr = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  xe.Trigger,
  {
    ref: n,
    className: F(
    ...
    children: [
      t,
      /* @__PURE__ */ d(xe.Icon, { asChild: !0, children: /* @__PURE__ */ d(bn, { className: "pr-h-4 pr-w-4 pr-opacity-50" }) })
    ]
  }
));
...
const Wi = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.ScrollDownButton,
  {
    ref: r,
    className: F("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
    ...t,
    children: /* @__PURE__ */ d(bn, { className: "pr-h-4 pr-w-4" })
  }
));
...
vp.displayName = xe.Label.displayName;
...
const yp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.Separator,
  {
    ref: r,
    className: F("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
...
yp.displayName = xe.Separator.displayName;
function wp({ table: e }) {
...
const xn = W.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d("div", { className: F("pr-relative pr-w-full", { "pr-overflow-auto": !t }), children: /* @__PURE__ */ d(
  "table",
  {
    ref: n,
...
const En = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("tbody", { ref: r, className: F("[&_tr:last-child]:pr-border-0", e), ...t }));
En.displayName = "TableBody";
const xp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "tfoot",
  {
    ref: r,
...
const Jt = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ...
  {
    ref: r,
    className: F("pr-p-4 pr-align-middle [&:has([role=checkbox])]:pr-pe-0", e),
    ...t
  }
));
Jt.displayName = "TableCell";
const kp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "caption",
  {
    ref: r,
...
]), $o = (e) => e === "asc" ? /* @__PURE__ */ d(rc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(nc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(oc, { className: "pr-ms-2 pr-h-4 pr-w-4" }), Sp = (e, t, r) => {
  let n = e;
...
}), Op = Or.Root, Rp = Or.Trigger, Xi = W.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d(Or.Portal, { children: /* @__PURE__ */ d(
  Or.Content,
  {
    ref: o,
    align: t,
...
const Pp = Qe.Portal, Yi = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Overlay,
  {
    ref: r,
    className: F(
...
const $p = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(Pp, { children: [
  /* @__PURE__ */ d(Yi, {}),
  /* @__PURE__ */ _(
    Qe.Content,
    {
...
$p.displayName = Qe.Content.displayName;
const _p = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Title,
  {
    ref: r,
...
_p.displayName = Qe.Title.displayName;
const Ip = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Description,
  {
    ref: r,
...
Ip.displayName = Qe.Description.displayName;
...
const Ki = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
...
const Zi = W.forwardRef((e, t) => /* @__PURE__ */ d(Ae.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
...
Mp.displayName = Ae.Group.displayName;
const Ap = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ae.Separator,
  {
    ref: r,
...
Ap.displayName = Ae.Separator.displayName;
const Qi = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ae.Item,
  {
    ref: r,
...
function Ta({
  ...
  const [g, p] = ce(!1);
  return /* @__PURE__ */ _(Op, { open: g, onOpenChange: p, ...v, children: [
    /* @__PURE__ */ d(Rp, { asChild: !0, children: /* @__PURE__ */ _(
      we,
      {
        variant: f,
        role: "combobox",
        ...
        Qi,
        {
          ...
          children: [
            /* @__PURE__ */ d(
              No,
              {
                className: F("pr-me-2 pr-h-4 pr-w-4", {
...
function zp() {
  return Ca || (Ca = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(V) {
      ...
      V === n || V === f || V === a || V === o || V === v || V === g || typeof V == "object" && V !== null && (V.$$typeof === h || V.$$typeof === p || V.$$typeof === i || V.$$typeof === l || V.$$typeof === m || V.$$typeof === b || V.$$typeof === x || V.$$typeof === O || V.$$typeof === u);
    }
    function k(V) {
    ...
    function Q(V) {
      return Z || (Z = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), C(V) || k(V) === c;
    }
    function C(V) {
      return k(V) === f;
    }
...
var Oa;
function rs() {
  return Oa || (Oa = 1, process.env.NODE_ENV === "production" ? Kr.exports = Vp() : Kr.exports = zp()), Kr.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Gp() {
  if (Ia)
    return Yn;
  Ia = 1;
  var e = rs(), t = Up(), r = Io(), n = ns(), o = Hp(), a = function() {
  };
    ...
    function S(C) {
      ...
      function A(H, J, G, X, q) {
        for (var K = H[J], Y = 0; Y < C.length; Y++)
          if (h(K, C[Y]))
            return null;
        var ee = JSON.stringify(C, function(ie, V) {
          var re = L(V);
    ...
    function j(C) {
      ...
      function J(G, X, q, K, Y) {
        for (var ee = [], te = 0; te < C.length; te++) {
          var ie = C[te], V = ie(G, X, q, K, Y, r);
          if (V == null)
            return null;
          V.data && n(V.data, "expectedType") && ee.push(V.data.expectedType);
        }
...
if (process.env.NODE_ENV !== "production") {
  var Xp = rs(), Yp = !0;
  lo.exports = Gp()(Xp.isElement, Yp);
} else
  lo.exports = Wp()();
var qp = lo.exports;
const s = /* @__PURE__ */ Bp(qp);
function Kp(e) {
  const {
    prototype: t = {}
  } = e;
...
function os(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Kp(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function Zp(e, t, r, n, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof a == "function" && !Jp(a) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Qp = ar(s.elementType, Zp), ed = "exact-prop: ​";
function is(e) {
...
const id = s.oneOfType([s.func, s.object]), Mo = id;
function et(e) {
  if (typeof e != "string")
...
const pd = typeof window < "u" ? N.useLayoutEffect : N.useEffect, Dt = pd;
let Ba = 0;
function dd(e) {
...
function vd(e) {
  ...
  return !!(r === "INPUT" && bd[t] && !e.readOnly || r === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function yd(e) {
...
function xd(e) {
  e.addEventListener("keydown", yd, !0), e.addEventListener("mousedown", Kn, !0), e.addEventListener("pointerdown", Kn, !0), e.addEventListener("touchstart", Kn, !0), e.addEventListener("visibilitychange", wd, !0);
}
function kd(e) {
  const {
    target: t
...
function ds() {
  const e = N.useCallback((o) => {
    o != null && xd(o.ownerDocument);
  }, []), t = N.useRef(!1);
  function r() {
    return t.current ? (uo = !0, gd.start(100, () => {
      uo = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
...
ms.isRequired = fs;
fo.isRequired = fo;
const hs = process.env.NODE_ENV === "production" ? fo : ms;
function gs(e, t) {
  const r = P({}, t);
...
const _d = {
  borderRadius: 4
}, Id = _d, Md = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, kt = Md;
function Nr(e, t) {
  return t ? st(e, t, {
    clone: !1
...
const Bd = {
  ...
  if (e.length > 2)
    if (Ua[e])
      ...
      return [e];
  const [t, r] = e.split(""), n = Bd[t], o = Ld[r] || "";
  return Array.isArray(o) ? o.map((a) => n + a) : [n + o];
}), Sn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Cn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Vd = [...Sn, ...Cn];
function Vr(e, t, r, n) {
  var o;
...
function Ud(e, t, r, n) {
  if (t.indexOf(r) === -1)
    return null;
  const o = Fd(r), a = zd(o, n), i = e[r];
  return ct(e, i, a);
}
function ws(e, t) {
  const r = ys(e.theme);
  return Object.keys(e).map((n) => Ud(e, t, n, r)).reduce(Nr, {});
}
function ve(e) {
  return ws(e, Sn);
}
...
ye.filterProps = Cn;
process.env.NODE_ENV !== "production" && Vd.reduce((e, t) => (e[t] = kt, e), {});
function Hd(e = 8) {
  if (e.mui)
    return e;
  const t = ys({
...
const Gd = qe("border", Ue), Wd = qe("borderTop", Ue), Xd = qe("borderRight", Ue), Yd = qe("borderBottom", Ue), qd = qe("borderLeft", Ue), Kd = qe("borderColor"), Jd = qe("borderTopColor"), Zd = qe("borderRightColor"), Qd = qe("borderBottomColor"), eu = qe("borderLeftColor"), tu = qe("outline", Ue), ru = qe("outlineColor"), Rn = (e) => {
...
On(Gd, Wd, Xd, Yd, qd, Kd, Jd, Zd, Qd, eu, Rn, tu, ru);
const Pn = (e) => {
...
On(Pn, $n, _n, nu, ou, au, iu, su, lu, cu, pu, du);
function Kt(e, t) {
  return t === "grey" ? t : e;
}
const uu = Ee({
...
function Nu() {
  ...
  function t(r) {
    ...
    function l(c) {
      ...
      if (!f)
        return null;
      const m = Ad(a.breakpoints), v = Object.keys(m);
      let g = m;
...
function Lo(e = {}, ...t) {
  ...
  return f.applyStyles = Tu, f = t.reduce((m, v) => st(m, v), f), f.unstable_sxConfig = P({}, jo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return Bo({
      sx: v,
      theme: this
    });
...
const Ru = ["ownerState"], Pu = ["variants"], $u = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function _u(e) {
  return Object.keys(e).length === 0;
}
function Iu(e) {
...
const Mu = Lo(), Ha = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Jr({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Du(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Lc(i, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: f,
      ...
      overridesResolver: g = Au(Ha(f))
    } = l, p = he(l, $u), h = m !== void 0 ? m : (
    ...
    let x = tn;
    f === "Root" || f === "root" ? x = n : f ? x = o : Iu(i) && (x = void 0);
    const O = jc(i, P({
      shouldForwardProp: x,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let $;
        c && ($ = `${c}${et(f || "")}`), $ === void 0 && ($ = `Styled(${ad(i)})`), z.displayName = $;
      }
...
function Fo(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), Od(e, t, r);
}
function Lu(e) {
  e = e.slice(1);
...
function Ga(e) {
  e = jt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? jt(Fu(e)).values : e.values;
...
const Hu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Gt = Zu, Qu = ["mode", "contrastThreshold", "tonalOffset"], Xa = {
...
function Ya(e, t, r, n) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = zu(e.main, o) : t === "dark" && (e.dark = Vu(e.main, a)));
}
function ef(e = "light") {
  return e === "dark" ? {
    main: Ut[200],
...
function sf(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = he(e, Qu), a = e.primary || ef(t), i = e.secondary || tf(t), l = e.error || rf(t), c = e.info || nf(t), f = e.success || of(t), m = e.warning || af(t);
  function v(u) {
...
const df = 0.2, uf = 0.14, ff = 0.12;
function be(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${df})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${uf})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${ff})`].join(",");
}
const mf = ["none", be(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), be(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), be(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), be(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), be(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), be(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), be(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), be(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), be(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), be(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), be(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), be(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), be(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), be(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), be(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), be(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), be(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), be(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), be(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), be(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), be(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), be(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), be(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), be(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], hf = mf, gf = ["duration", "easing", "delay"], bf = {
...
function wf(e) {
  const t = P({}, bf, e.easing), r = P({}, vf, e.duration);
  return P({
...
const xf = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, kf = xf, Ef = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Nf(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: n = {},
...
const Ns = (e) => tn(e) && e !== "classes", Sf = Du({
  themeId: zo,
  defaultTheme: Vo,
...
const Of = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Rf = (e) => {
  ...
  const n = ut({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = n, p = he(n, Of), h = /* @__PURE__ */ N.isValidElement(o) && o.type === "svg", u = P({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), If = /* @__PURE__ */ Lp(_f);
var Qa;
function Mf() {
...
var Ss = _o.default = void 0, Df = Af(Mf()), jf = Hl;
Ss = _o.default = (0, Df.default)(/* @__PURE__ */ (0, jf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Cs(e) {
...
}, Lf = /* @__PURE__ */ N.createContext(Bf);
function Ff(e) {
  const {
...
function Jf(e) {
  const t = [], r = [];
  return Array.from(e.querySelectorAll(Xf)).forEach((n, o) => {
    const a = Yf(n);
    a === -1 || !Kf(n) || (a === 0 ? t.push(n) : r.push({
      documentOrder: o,
      tabIndex: a,
      node: n
    }));
...
process.env.NODE_ENV !== "production" && (fn["propTypes"] = is(fn.propTypes));
function Qf(e) {
...
const Mr = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  return /* @__PURE__ */ d(N.Fragment, {
    children: i && /* @__PURE__ */ Fc.createPortal(n, i)
  });
});
...
function lm(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = N.useRef({}), p = N.useRef(null), h = N.useRef(null), u = We(h, v), [b, x] = N.useState(!m), O = im(c);
  let w = !0;
...
var Ie = "top", Xe = "bottom", Ye = "right", Me = "left", Ho = "auto", Ur = [Ie, Xe, Ye, Me], er = "start", Ar = "end", cm = "clippingParents", $s = "viewport", mr = "popper", pm = "reference", ni = /* @__PURE__ */ Ur.reduce(function(e, t) {
  return e.concat([t + "-" + er, t + "-" + Ar]);
}, []), _s = /* @__PURE__ */ [].concat(Ur, [Ho]).reduce(function(e, t) {
  return e.concat([t, t + "-" + er, t + "-" + Ar]);
}, []), dm = "beforeRead", um = "read", fm = "afterRead", mm = "beforeMain", hm = "main", gm = "afterMain", bm = "beforeWrite", vm = "write", ym = "afterWrite", wm = [dm, um, fm, mm, hm, gm, bm, vm, ym];
function tt(e) {
...
function Hr(e) {
  for (var t = Ve(e), r = oi(e); r && Nm(r) && pt(r).position === "static"; )
    r = oi(r);
  return r && (tt(r) === "html" || tt(r) === "body" && pt(r).position === "static") ? t : r || Tm(e) || t;
}
function Xo(e) {
...
function Om(e) {
  ...
  if (!(!a || !i)) {
    var v = Cm(o.padding, r), g = Wo(a), p = c === "y" ? Ie : Me, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], x = Hr(a), O = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, k = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + w, S = Sr(k, T, y), M = c;
...
function Bs(e) {
  return ["html", "body", "#document"].indexOf(tt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && Ko(e) ? e : Bs(Mn(e));
}
function Cr(e, t) {
  var r;
  t === void 0 && (t = []);
...
function si(e, t, r) {
  return t === $s ? ho(Lm(e, r)) : Lt(t) ? Vm(t, r) : ho(Fm(Et(e)));
}
function zm(e) {
  var t = Cr(Mn(e)), r = ["absolute", "fixed"].indexOf(pt(e).position) >= 0, n = r && Ge(e) ? Hr(e) : e;
  return Lt(n) ? t.filter(function(o) {
    return Lt(o) && Ms(o, n) && tt(o) !== "body";
  }) : [];
}
function Um(e, t, r, n) {
  var o = t === "clippingParents" ? zm(e) : [].concat(t), a = [].concat(o, [r]), i = a[0], l = a.reduce(function(c, f) {
    var m = si(e, f, n);
...
function Dr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? cm : l, f = r.rootBoundary, m = f === void 0 ? $s : f, v = r.elementContext, g = v === void 0 ? mr : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, x = Ds(typeof b != "number" ? b : js(b, Ur)), O = g === mr ? pm : mr, w = e.rects.popper, k = e.elements[h ? O : g], y = Um(Lt(k) ? k : k.contextElement || Et(e.elements.popper), c, m, i), T = rr(e.elements.reference), S = Ls({
    reference: T,
    element: w,
    strategy: "absolute",
    placement: o
  }), M = ho(Object.assign({}, w, S)), j = g === mr ? M : T, z = {
...
function Wm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, x = Ze(b), O = x === b, w = c || (O || !h ? [nn(b)] : Gm(b)), k = [b].concat(w).reduce(function(G, X) {
      return G.concat(Ze(X) === Ho ? Hm(t, {
        placement: X,
        boundary: m,
        rootBoundary: v,
        padding: f,
...
function rh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Dr(t, {
    ...
    padding: v,
    altBoundary: m
  }), x = Ze(t.placement), O = nr(t.placement), w = !O, k = Xo(x), y = th(k), T = t.modifiersData.popperOffsets, S = t.rects.reference, M = t.rects.popper, j = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, z = typeof j == "number" ? {
    mainAxis: j,
    altAxis: j
  ...
  if (T) {
    if (a) {
      var R, I = k === "y" ? Ie : Me, U = k === "y" ? Xe : Ye, B = k === "y" ? "height" : "width", L = T[k], Z = L + b[I], Q = L - b[U], C = p ? -M[B] / 2 : 0, A = O === er ? S[B] : M[B], H = O === er ? -M[B] : -S[B], J = t.elements.arrow, G = p && J ? Wo(J) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : As(), q = X[I], K = X[U], Y = Sr(0, S[B], G[B]), ee = w ? S[B] / 2 - C - Y - q - z.mainAxis : A - Y - q - z.mainAxis, te = w ? -S[B] / 2 + C + Y + K + z.mainAxis : H + Y + K + z.mainAxis, ie = t.elements.arrow && Hr(t.elements.arrow), V = ie ? k === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = (R = $ == null ? void 0 : $[k]) != null ? R : 0, D = L + ee - re - V, se = L + te - re, Ne = Sr(p ? mn(Z, D) : Z, L, p ? It(Q, se) : Q);
      T[k] = Ne, E[k] = Ne - L;
    }
    if (l) {
      var Pe, ke = k === "x" ? Ie : Me, Nt = k === "x" ? Xe : Ye, $e = T[y], nt = y === "y" ? "height" : "width", je = $e + b[ke], ot = $e - b[Nt], Te = [Ie, Me].indexOf(x) !== -1, Ft = (Pe = $ == null ? void 0 : $[y]) != null ? Pe : 0, Tt = Te ? je : $e - S[nt] - M[nt] - Ft + z.altAxis, ir = Te ? $e + S[nt] + M[nt] - Ft - z.altAxis : ot, Wr = p && Te ? Sm(Tt, $e, ir) : Sr(p ? Tt : je, $e, p ? ir : ot);
      T[y] = Wr, E[y] = Wr - $e;
    }
    t.modifiersData[n] = E;
  }
...
function sh(e, t, r) {
  r === void 0 && (r = !1);
  var n = Ge(t), o = Ge(t) && ih(t), a = Et(t), i = rr(e, o, r), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Ko(a)) && (l = ah(t)), Ge(t) ? (c = rr(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = qo(a))), {
  ...
  return function(l, c, f) {
    ...
    var m = {
      ...
      setOptions: function(x) {
        ...
        var w = ch(dh([].concat(n, m.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (di(O, w)) {
            m.rects = {
              reference: sh(O, Hr(w), m.options.strategy === "fixed"),
              popper: Wo(w)
...
var fh = [Dm, eh, Mm, Em, Zm, Xm, nh, Pm, qm], mh = /* @__PURE__ */ uh({
  defaultModifiers: fh
});
const Fs = "Popper";
function hh(e) {
...
const wh = () => dt({
  root: ["root"]
}, Ff(hh)), xh = {}, kh = /* @__PURE__ */ N.forwardRef(function(t, r) {
  var n;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, b = he(t, gh), x = N.useRef(null), O = We(x, r), w = N.useRef(null), k = We(w, g), y = N.useRef(k);
  Dt(() => {
    y.current = k;
  }, [k]), N.useImperativeHandle(g, () => w.current, []);
  const T = vh(m, i), [S, M] = N.useState(T), [j, z] = N.useState(hn(o));
  N.useEffect(() => {
...
`));
  ...
  const E = wh(), R = (n = h.root) != null ? n : "div", I = Bt({
    elementType: R,
  ...
  const {
    ...
    slotProps: b = {},
    slots: x = {}
  } = t, O = he(t, bh), [w, k] = N.useState(!0), y = () => {
    k(!1);
  }, T = () => {
    k(!0);
  };
  ...
  if (a)
    ...
    const z = hn(n);
    S = z && An(z) ? Oe(z).body : Oe(null).body;
  }
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || yh(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
var Th = function(t) {
  ...
  return r.componentDidMount = function() {
    ...
    return (
      ...
      /* @__PURE__ */ W.createElement(zs.Provider, {
        value: null
...
const Sh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function vo(e) {
  return `scale(${e}, ${e ** 2})`;
}
const Ch = {
  ...
  } = t, x = he(t, Sh), O = yr(), w = N.useRef(), k = Gr(), y = N.useRef(null), T = We(y, a.ref, r), S = (U) => (B) => {
    if (U) {
      const L = y.current;
      B === void 0 ? U(L) : U(L, B);
    }
...
const yo = Jo, Oh = (e) => {
...
}, fi = Oh, Rh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Ph = Re(Vs, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ks(), a = ut({
    ...
    slots: w,
    slotProps: k
  } = a, y = he(a, Rh), T = (n = w == null ? void 0 : w.root) != null ? n : c == null ? void 0 : c.Root, S = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const _h = xt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), vt = _h, Ih = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Mh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Ah = (e) => {
...
const Xs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const T = ut({
    ...
    slots: te = {},
    title: ie,
    TransitionComponent: V = yo,
    TransitionProps: re
  } = T, D = he(T, Ih), se = /* @__PURE__ */ N.isValidElement(M) ? M : /* @__PURE__ */ d("span", {
    children: M
  }), Ne = Gr(), Pe = Ne.direction === "rtl", [ke, Nt] = N.useState(), [$e, nt] = N.useState(null), je = N.useRef(!1), ot = I || Q, Te = yr(), Ft = yr(), Tt = yr(), ir = yr(), [Wr, ta] = ps({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Dn = cs(C), sr = N.useRef(), Xr = _r(() => {
  ...
  const ra = (ne) => {
    ...
    ke || Nt(ne.currentTarget), Il(ne), oa.current === !0 && (aa(!0), jn(ne));
  }, la = (ne) => {
    je.current = !0;
    const Be = se.props;
...
`));
  const Ll = N.useMemo(() => {
    ...
    touch: je.current
  }), Fn = Ah(pr), da = (n = (o = te.popper) != null ? o : j.Popper) != null ? n : Dh, ua = (a = (i = (l = te.transition) != null ? l : j.Transition) != null ? i : V) != null ? a : yo, fa = (c = (f = te.tooltip) != null ? f : j.Tooltip) != null ? c : jh, ma = (m = (v = te.arrow) != null ? v : j.Arrow) != null ? m : Bh, Fl = wr(da, P({}, Y, (g = ee.popper) != null ? g : z.popper, {
    className: Ce(Fn.popper, Y == null ? void 0 : Y.className, (p = (h = ee.popper) != null ? h : z.popper) == null ? void 0 : p.className)
  }), pr), Vl = wr(ua, P({}, re, (u = ee.transition) != null ? u : z.transition), pr), zl = wr(fa, P({}, (b = ee.tooltip) != null ? b : z.tooltip, {
    className: Ce(Fn.tooltip, (x = (O = ee.tooltip) != null ? O : z.tooltip) == null ? void 0 : x.className)
  }), pr), Ul = wr(ma, P({}, (w = ee.arrow) != null ? w : z.arrow, {
    className: Ce(Fn.arrow, (k = (y = ee.arrow) != null ? y : z.arrow) == null ? void 0 : k.className)
  }), pr);
  return /* @__PURE__ */ _(N.Fragment, {
  ...
  const {
    ...
    Cc,
    {
      ...
      children: r ? /* @__PURE__ */ _(wt, { children: [
        hi(a, r, !0),
        /* @__PURE__ */ d(Oc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ d($i, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ d(Ss, {}) }) : hi(i, r, !1)
      ] }) : b
    }
  );
  return n ? /* @__PURE__ */ d(Lh, { title: n, placement: "right", children: /* @__PURE__ */ d("div", { children: x }) }) : x;
}
function qs(e) {
...
const Vh = (e, t) => t.filter((o) => o.group === e).sort((o, a) => (o.order || 0) - (a.order || 0));
function Zo(e) {
  ...
  return /* @__PURE__ */ _(
    _i,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d(Pc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ d(
          zh,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Xh = ["children", "className", "component", "dense", "disablePadding", "subheader"], Yh = (e) => {
  const {
    classes: t,
    disablePadding: r,
    dense: n,
  ...
  return /* @__PURE__ */ d(Gh.Provider, {
    value: v,
    children: /* @__PURE__ */ _(qh, P({
      as: i,
...
const Kh = Js, Jh = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function eo(e, t, r) {
...
const Qs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  } = t, g = he(t, Jh), p = N.useRef(null), h = N.useRef({
    keys: [],
    repeating: !0,
  ...
  const u = (w) => {
    ...
    if (y === "ArrowDown")
      ...
      const z = T && !S.repeating && Zs(T, S);
      S.previousKeyMatched && (z || gr(k, T, !1, c, eo, S)) ? w.preventDefault() : S.previousKeyMatched = !1;
    }
    m && m(w);
  }, b = We(p, r);
  let x = -1;
...
const Zh = Qs, Qh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], eg = {
  entering: {
    opacity: 1
  },
  entered: {
...
const ng = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], og = (e) => {
  ...
  const i = ut({
    ...
    component: f,
    invisible: g
  }), k = og(w), y = (n = h.root) != null ? n : v.root;
  return /* @__PURE__ */ d(b, P({
    in: p,
    timeout: x
  }, O, {
    children: /* @__PURE__ */ d(ag, P({
      "aria-hidden": !0
    }, y, {
...
const lg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], cg = (e) => {
  const {
    open: t,
    exited: r,
    classes: n
  ...
  const K = (n = (o = I == null ? void 0 : I.root) != null ? o : x.Root) != null ? n : pg, Y = (a = (i = I == null ? void 0 : I.backdrop) != null ? i : x.Backdrop) != null ? a : m, ee = (l = R == null ? void 0 : R.root) != null ? l : O.root, te = (c = R == null ? void 0 : R.backdrop) != null ? c : O.backdrop, ie = Bt({
    elementType: K,
  ...
  return !z && !E && (!J || H) ? null : /* @__PURE__ */ d(Mr, {
    ...
    children: /* @__PURE__ */ _(K, P({}, ie, {
      children: [!j && m ? /* @__PURE__ */ d(Y, P({}, V)) : null, /* @__PURE__ */ d(fn, {
        disableEnforceFocus: k,
        disableAutoFocus: w,
        disableRestoreFocus: S,
        isEnabled: A,
...
const mg = ["className", "component", "elevation", "square", "variant"], hg = (e) => {
  const {
    square: t,
    elevation: r,
    variant: n,
...
const yg = ["onEntering"], wg = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], xg = ["slotProps"];
function bi(e, t) {
  let r = 0;
...
const kg = (e) => {
  ...
  } = i, z = he(i.TransitionProps, yg), $ = he(i, wg), E = (n = k == null ? void 0 : k.paper) != null ? n : O, R = N.useRef(), I = We(R, E.ref), U = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
`)), b !== null && ke < b) {
  ...
  const q = h || (c ? Oe(on(c)).body : void 0), K = (o = w == null ? void 0 : w.root) != null ? o : Eg, Y = (a = w == null ? void 0 : w.paper) != null ? a : ol, ee = Bt({
    elementType: Y,
...
const Sg = ["onEntering"], Cg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Og = {
  vertical: "top",
  horizontal: "right"
}, Rg = {
  vertical: "top",
  ...
  const a = ut({
    ...
    slots: O = {},
    slotProps: w = {}
  } = a, k = he(a.TransitionProps, Sg), y = he(a, Cg), T = Gr(), S = T.direction === "rtl", M = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: k,
    variant: x
  }), j = Pg(M), z = i && !f && g, $ = N.useRef(null), E = (Q, C) => {
...
`)), Q.props.disabled || (x === "selectedMenu" && Q.props.selected || I === -1) && (I = C));
  ...
  const U = (n = O.paper) != null ? n : _g, B = (o = w.paper) != null ? o : p, L = Bt({
    elementType: O.root,
...
const bt = "scrBook", Bg = "scrRef", Rt = "source", Lg = "details", Fg = "Scripture Reference", Vg = "Scripture Book", sl = "Type", zg = "Details";
function Ug(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      id: bt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Fg,
      cell: (n) => {
    ...
    },
    {
      ...
      id: Lg,
      header: (e == null ? void 0 : e.detailsColumnName) ?? zg,
      cell: (n) => n.getValue(),
      enableGrouping: !1
    }
  ];
...
function Gv({
  ...
  }, z = (E, R) => E.getIsGrouped() ? "" : F("banded-row", R % 2 === 0 ? "even" : "odd"), $ = (E, R, I) => {
    ...
    !t && /* @__PURE__ */ _(
      sn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Pr, { position: "item-aligned", children: /* @__PURE__ */ d(bp, { children: S.map((E) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
function Hg({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [n, o] = ce(""), a = (i) => {
    o(i), e(i);
  };
  return /* @__PURE__ */ d(
...
const ll = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Root,
  {
...
const cl = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.List,
  {
    ref: r,
    className: F(
...
)), pl = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Content,
  {
    ref: r,
    className: F(
...
function Yv({
  ...
  return /* @__PURE__ */ _("div", { className: "pr-twp", children: [
    /* @__PURE__ */ _("div", { className: "pr-space-y-2 pr-pb-2", children: [
    ...
    /* @__PURE__ */ _(ll, { children: [
      /* @__PURE__ */ d(cl, { children: e.map((a) => /* @__PURE__ */ d(Gg, { value: a.value, children: a.value }, a.key)) }),
      e.map((a) => /* @__PURE__ */ d(pl, { value: a.value, children: a.content }, a.key))
    ] })
  ] });
}
const dl = N.forwardRef(({ className: e, orientation: t = "horizontal", decorative: r = !0, ...n }, o) => /* @__PURE__ */ d(
  Mi.Root,
  {
    ref: o,
    decorative: r,
...
function Kv({
  ...
  return /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-justify-between pr-space-x-4 pr-py-2", children: [
    ...
    n ? /* @__PURE__ */ d("p", { className: "pr-text-sm pr-text-muted-foreground", children: o }) : r()
  ] });
}
function Jv({
  primary: e,
...
), ul = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(Ai.Root, { ref: r, className: F(Wg(), e), ...t }));
...
function e0({
  ...
  const a = _t(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Ac, { position: "static", id: n, children: /* @__PURE__ */ _(Dc, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ d(
      jg,
      {
        commandHandler: t,
...
const t0 = De.Root, Xg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.List,
  {
    ref: r,
    className: F(
...
Xg.displayName = De.List.displayName;
const Yg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    className: F(
...
Yg.displayName = De.Trigger.displayName;
const qg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Content,
  {
    ref: r,
    className: F(
...
qg.displayName = De.Content.displayName;
function r0({
  isInstalling: e,
  handleClick: t,
  buttonText: r,
  ...
  return /* @__PURE__ */ d(
    we,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ d(vn, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ _(wt, { children: [
        /* @__PURE__ */ d(cc, { size: 25, className: F("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
  ...
  return /* @__PURE__ */ d(
    we,
    {
      ...
      children: e ? /* @__PURE__ */ _(wt, { children: [
        /* @__PURE__ */ d(vn, { size: 15, className: "pr-mr-1 pr-animate-spin pr-text-white" }),
        "Enabling..."
      ] }) : "Enable"
    }
  );
...
function o0({
  ...
  return /* @__PURE__ */ d(
    we,
    {
      ...
      ...n,
      children: e ? /* @__PURE__ */ _(wt, { children: [
        /* @__PURE__ */ d(vn, { size: 15, className: "pr-mr-1 pr-animate-spin pr-text-black" }),
        "Disabling..."
      ] }) : "Disable"
    }
  );
...
const Kg = ["children", "options"], wi = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), xi = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, Jg = ["style", "script"], Zg = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, Qg = /mailto:/i, eb = /\n{2,}$/, fl = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, tb = /^ *> ?/gm, rb = /^ {2,}\n/, nb = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, ml = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, hl = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, ob = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, ab = /^(?:\n *)*\n/, ib = /\r\n?/g, sb = /^\[\^([^\]]+)](:.*)\n/, lb = /^\[\^([^\]]+)]/, cb = /\f/g, pb = /^\s*?\[(x|\s)\]/, gl = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, bl = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, vl = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, xo = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, db = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, yl = /^<!--[\s\S]*?(?:-->)/, ub = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, ko = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, fb = /^\{.*\}$/, mb = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, hb = /^<([^ >]+@[^ >]+)>/, gb = /^<([^ >]+:\/[^ >]+)>/, bb = /-([a-z])?/gi, wl = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, vb = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, yb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, wb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, xb = /(\[|\])/g, kb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, Eb = /\t/g, Nb = /^ *\| */, Tb = /(^ *\||\| *$)/g, Sb = / *$/, Cb = /^ *:-+: *$/, Ob = /^ *:-+ *$/, Rb = /^ *-+: *$/, Pb = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, $b = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, _b = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, Ib = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, Mb = /^\\([^0-9A-Za-z\s])/, Ab = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, Db = /^\n+/, jb = /^([ \t]*)/, Bb = /\\([^\\])/g, ki = / *\n+$/, Lb = /(?:^|\n)( *)$/, Qo = "(?:\\d+\\.)", ea = "(?:[*+-])";
function xl(e) {
  return "( *)(" + (e === 1 ? Qo : ea) + ") +";
}
...
function Ei(e, t) {
  const r = t === 1, n = r ? Rl : Pl, o = r ? Sl : Cl, a = r ? Fb : Vb;
  return { t(i, l, c) {
    const f = Lb.exec(c);
    return f && (l.o || !l._ && !l.u) ? n.exec(i = f[1] + i) : null;
  }, i: ae.HIGH, l(i, l, c) {
    const f = r ? +i[2] : void 0, m = i[0].replace(eb, `
`).match(o);
    let v = !1;
...
const zb = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Ub = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, $l = [fl, ml, hl, gl, vl, bl, yl, wl, Sl, Rl, Cl, Pl], Hb = [...$l, /^[^\n]+(?:  \n|\n{2,})/, xo, ko];
function Gb(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function Wb(e) {
  return Rb.test(e) ? "right" : Cb.test(e) ? "center" : Ob.test(e) ? "left" : null;
}
function Ni(e, t, r) {
  const n = r.$;
  r.$ = !0;
  ...
  return o.forEach(function(i, l) {
    i.type === "tableSeparator" ? l !== 0 && l !== o.length - 1 && a.push([]) : (i.type !== "text" || o[l + 1] != null && o[l + 1].type !== "tableSeparator" || (i.v = i.v.replace(Sb, "")), a[a.length - 1].push(i));
  }), a;
}
function Xb(e, t, r) {
  r._ = !0;
  const n = Ni(e[1], t, r), o = e[2].replace(Tb, "").split("|").map(Wb), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(f) {
      return Ni(f, l, c);
    });
...
var ae;
function Zb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Gb, t.namedCodesToUnicode = t.namedCodesToUnicode ? $t({}, xi, t.namedCodesToUnicode) : xi;
  ...
  function n(p, h, ...u) {
    ...
    }(p, t.overrides), $t({}, h, b, { className: Jb(h == null ? void 0 : h.className, b.className) || void 0 }), ...u);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = kb.test(p) === !1);
    const u = m(f(h ? p : `${p.trimEnd().replace(Db, "")}
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, x) {
      ...
      if (O !== -1) {
        const w = function(S) {
          return S.indexOf("-") !== -1 && S.match(ub) === null && (S = S.replace(bb, function(M, j) {
          ...
          }, {}) : S === "href" ? Xt(M) : (M.match(fb) && (M = M.slice(1, M.length - 1)), M === "true" || M !== "false" && M);
        }(w, k);
  ...
  const i = [], l = {}, c = { blockQuote: { t: it(fl), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(tb, ""), u) }), h: (p, h, u) => n("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: br(rb), i: ae.HIGH, l: ro, h: (p, h, u) => n("br", { key: u.k }) }, breakThematic: { t: it(nb), i: ae.HIGH, l: ro, h: (p, h, u) => n("hr", { key: u.k }) }, codeBlock: { t: it(hl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => n("pre", { key: u.k }, n("code", $t({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(ml), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: gt(ob), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => n("code", { key: u.k }, p.v) }, footnote: { t: it(sb), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: no }, footnoteReference: { t: ht(lb), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => n("a", { key: u.k, href: Xt(p.B) }, n("sup", { key: u.k }, p.v)) }, gfmTask: { t: ht(pb), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => n("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? bl : gl), i: ae.HIGH, l: (p, h, u) => ({ v: an(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => n(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: it(vl), i: ae.MAX, l: (p, h, u) => ({ v: an(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: br(yl), i: ae.HIGH, l: () => ({}), h: no }, image: { t: gt(Ub), i: ae.HIGH, l: (p) => ({ D: p[1], B: Si(p[2]), F: p[3] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Xt(p.B) }) }, link: { t: ht(zb), i: ae.LOW, l: (p, h, u) => ({ v: qb(h, p[1], u), B: Si(p[2]), F: p[3] }), h: (p, h, u) => n("a", { key: u.k, href: Xt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: ht(gb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : ht(mb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: ht(hb), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
    return Qg.test(u) || (u = "mailto:" + u), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: u, type: "link" };
  } }, orderedList: Ei(n, 1), unorderedList: Ei(n, 2), newlineCoalescer: { t: it(ab), i: ae.LOW, l: ro, h: () => `
` }, paragraph: { t: Yb, i: ae.LOW, l: to, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: ht(vb), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: no }, refImage: { t: gt(yb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Xt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: ht(wb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(xb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Xt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: it(wl), i: ae.HIGH, l: Xb, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, x) {
    ...
    return h.$ ? (h._ = !0, Nb.exec(p)) : null;
  }, i: ae.HIGH, l: function() {
    return { type: "tableSeparator" };
  }, h: () => " | " }, text: { t: br(Ab), i: ae.MIN, l: (p) => ({ v: p[0].replace(db, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: gt(Pb), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: gt($b), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: gt(Mb), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: gt(_b), i: ae.LOW, l: to, h: (p, h, u) => n("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: gt(Ib), i: ae.LOW, l: to, h: (p, h, u) => n("del", { key: u.k }, h(p.v, u)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: br(xo), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(jb), x = new RegExp(`^${b}`, "gm"), O = p[3].replace(x, ""), w = (k = O, Hb.some((M) => M.test(k)) ? Kb : an);
    var k;
    const y = p[1].toLowerCase(), T = Jg.indexOf(y) !== -1;
    u.N = u.N || y === "a";
...
const Qb = (e) => {
  ...
  return N.cloneElement(Zb(t, r), n);
};
function i0({ id: e, markdown: t }) {
  return /* @__PURE__ */ d("div", { id: e, className: "pr-prose", children: /* @__PURE__ */ d(Qb, { children: t }) });
}
const ev = Eo((e, t) => /* @__PURE__ */ _(
  we,
  {
    ref: t,
    ...
    ...e,
    children: [
      /* @__PURE__ */ d(pc, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ d(
        bn,
        {
...
function s0({ id: e, groups: t }) {
  return /* @__PURE__ */ d("div", { id: e, children: /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ d(zi, { asChild: !0, children: /* @__PURE__ */ d(ev, {}) }),
    /* @__PURE__ */ d(yn, { children: t.map((r) => /* @__PURE__ */ _("div", { children: [
      /* @__PURE__ */ d(Br, { children: r.label }),
      /* @__PURE__ */ d(tp, { children: r.items.map((n) => /* @__PURE__ */ d("div", { children: n.itemType === 0 ? /* @__PURE__ */ d(Po, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ d(Hi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ d(wn, {})
    ] }, r.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            /* @__PURE__ */ d(dc, { className: "pr-mr-1 pr-h-4 pr-w-4" }),
        ...
        /* @__PURE__ */ _("div", { className: "pr-ml-auto pr-flex pr-flex-col pr-space-y-2", children: [
          /* @__PURE__ */ _(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ d(uc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ _(
...
function rv({ id: e, versionHistory: t }) {
...
function p0({
  ...
  return /* @__PURE__ */ d("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ _("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ d(rv, { versionHistory: o }),
...
av.displayName = "CardTitle";
const iv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: F("pr-text-sm pr-text-muted-foreground", e), ...t }));
iv.displayName = "CardDescription";
const sv = W.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: F("pr-p-6 pr-pt-0", e), ...t })
);
sv.displayName = "CardContent";
...
), pv = W.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: F(cv({ variant: t }), e), ...r }));
pv.displayName = "Alert";
const dv = W.forwardRef(
...
dv.displayName = "AlertTitle";
const uv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: F("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
uv.displayName = "AlertDescription";
const fv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ _(
  vr.Root,
  {
    ref: r,
    className: F(
...
fv.displayName = vr.Root.displayName;
const mv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  so.Root,
  {
    className: F(
...
mv.displayName = so.Root.displayName;
function hv(e, t = "top") {
...
export {
  pv as Alert,
  uv as AlertDescription,
  dv as AlertTitle,
  Av as BookChapterControl,
  we as Button,
  nv as Card,
  sv as CardContent,
  iv as CardDescription,
  lv as CardFooter,
  ov as CardHeader,
  av as CardTitle,
  Vv as ChapterRangeSelector,
  jp as Checkbox,
  zv as Checklist,
  Ta as ComboBox,
  Uv as ContextMenu,
  ...
  Ys as MenuItem,
  c0 as MoreInfo,
  Yv as NavigationContentSearch,
  l0 as NoExtensionsFound,
  Gv as ScriptureResultsViewer,
  Hg as SearchBar,
  sn as Select,
  Pr as SelectContent,
  bp as SelectGroup,
  ...
  ln as SelectValue,
  qv as SettingsList,
  Jv as SettingsListHeader,
  Kv as SettingsListItem,
  fv as ShadCnSlider,
  mv as ShadCnSwitch,
  Wv as Slider,
  Xv as Snackbar,
  ...
  e0 as Toolbar,
  a0 as UpdateButton,
  rv as VersionHistory,
  ll as VerticalTabs,
  pl as VerticalTabsContent,
  cl as VerticalTabsList,
  Gg as VerticalTabsTrigger,
  hp as buttonVariants,
  $o as getSortingIcon,
  Lv as inventoryCountColumn,
  Bv as inventoryItemColumn,
  Fv as inventoryStatusColumn,
  d0 as useEvent,
  u0 as useEventAsync,
  wo as usePromise
};
