...
import b, { forwardRef as nn, useRef as Z, useMemo as F, useState as S, useCallback as G, useLayoutEffect as Wt, createContext as kn, useContext as dr, useEffect as K, Component as os, createElement as Ar, Suspense as as, createRef as Pr, Fragment as wo } from "react";
import { Command as kt } from "cmdk";
import { X as Ae, Search as co, Check as Lt, Clock as $r, ChevronsLeft as Lr, ChevronsRight as Vr, ChevronLeft as Hn, ChevronRight as Re, ArrowLeft as ss, ArrowRight as is, Circle as _n, ChevronDown as Pe, BoldIcon as ls, ItalicIcon as ws, AtSign as po, Pencil as cs, Trash2 as ds, ArrowUp as uo, MoreHorizontal as mo, MailOpen as ps, Mail as us, ChevronUp as fo, FilterIcon as ms, ArrowLeftIcon as fs, ChevronLeftIcon as hs, ChevronRightIcon as gs, ArrowRightIcon as bs, Copy as ho, Filter as vs, User as xs, Link as ys, CircleHelp as Ns, ChevronsUpDown as go, Star as ks, SquareX as bo, FunctionSquare as vo, SquareSigma as xo, Ban as _s, AlertCircle as Yn, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Rs, ArrowUpIcon as Ts, ArrowDownIcon as Ss, PanelLeft as Ds, PanelRight as Ms, ScrollText as Os, MenuIcon as Is, Menu as As, EllipsisVertical as Ps, LoaderCircle as $s, GripVertical as Ls } from "lucide-react";
...
import { includes as ln, Section as U, getChaptersForBook as zs, formatScrRef as ge, getSectionForBook as Ue, formatRelativeDate as Fs, formatReplacementString as he, sanitizeHtml as Bs, NumberFormat as Gs, formatBytes as Ks, getCurrentLocale as qs, usfmMarkers as un, getFormatCallerFunction as Us, deepEqual as Hs, isString as jr, compareScrRefs as Xn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as No, $getRoot as se, $createParagraphNode as Cn, $getSelection as Jt, HISTORY_MERGE_TAG as pr, ParagraphNode as ko, TextNode as _o, $isTokenOrSegmented as Ys, $getCharacterOffsets as Xs, $cloneWithPropertiesEphemeral as Ws, $findMatchingParent as Js, $isElementNode as be, CLEAR_EDITOR_COMMAND as Co, COMMAND_PRIORITY_EDITOR as Eo, $isRangeSelection as Ze, mergeRegister as ie, shallowMergeConfig as Zs, defineExtension as Qt, safeCast as rn, RootNode as Qs, LineBreakNode as ti, TabNode as ei, $isEditorState as ni, createCommand as ri, CLICK_COMMAND as oi, isDOMNode as ai, $getNodeFromDOMNode as si, $isNodeSelection as ii, $createNodeSelection as li, $setSelection as wi, COMMAND_PRIORITY_LOW as ci, DecoratorNode as di, addClassNamesToElement as Ro, $create as pi, $getNodeByKey as ui, removeClassNamesFromElement as mi, KEY_TAB_COMMAND as fi, $isBlockElementNode as hn, $createRangeSelection as hi, $normalizeSelection__EXPERIMENTAL as gi, OUTDENT_CONTENT_COMMAND as bi, INDENT_CONTENT_COMMAND as zr, INSERT_TAB_COMMAND as vi, COMMAND_PRIORITY_CRITICAL as ur, $isDecoratorNode as xi, $isParagraphNode as yi, $isTextNode as gn, SELECTION_CHANGE_COMMAND as To, FORMAT_TEXT_COMMAND as Ni, getRegisteredNode as ki, isHTMLElement as _i, isDocumentFragment as Fr, isDOMDocumentNode as Ci, ArtificialNode__DO_NOT_USE as So, $createLineBreakNode as Do, $isRootOrShadowRoot as Ei, isBlockDomNode as Br, isInlineDomNode as Gr, $insertNodes as Ri } from "lexical";
...
import { useReactTable as Ao, getFilteredRowModel as $i, getSortedRowModel as Po, getPaginationRowModel as Li, getCoreRowModel as $o, flexRender as He, getGroupedRowModel as Vi, getExpandedRowModel as ji } from "@tanstack/react-table";
import * as lt from "@radix-ui/react-select";
import zi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Wn, HIDDEN_NOTE_CALLER as Jn, getDefaultViewOptions as Fi, isInsertEmbedOpOfType as wn, Editorial as Bi } from "@eten-tech-foundation/platform-editor";
...
const qi = js({ prefix: "tw-" });
function m(...t) {
  return qi(Vs(t));
}
const Ui = "layoutDirection";
function ft() {
  const t = localStorage.getItem(Ui);
  return t === "rtl" ? t : "ltr";
}
const Hi = $t.Root, Yi = $t.Portal, Lo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Overlay,
  {
    ref: n,
    className: m(
...
Xi.displayName = $t.Description.displayName;
...
Fo.displayName = kt.Separator.displayName;
...
const Ko = wt.allBookIds.filter(
  (t) => !wt.isObsolete(wt.bookIdToNumber(t))
), ve = Object.fromEntries(
  Ko.map((t) => [t, wt.bookIdToEnglishName(t)])
);
function hr(t, e, n) {
...
const qo = nn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? $e : "button", { className: m(Uo({ variant: e, size: n, className: t })), ref: i, ...a })
);
B.displayName = "Button";
const ne = Te.Root, ce = Te.Trigger, Ji = Te.Anchor, Kt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ft();
  ...
  return /* @__PURE__ */ d(ne, { open: c, onOpenChange: w, children: [
    /* @__PURE__ */ r(ce, { asChild: !0, children: /* @__PURE__ */ r(
      B,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ r($r, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ r(Kt, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(Zt, { heading: i, children: t.map((u) => /* @__PURE__ */ d(
      Gt,
      {
        ...
        children: [
          /* @__PURE__ */ r($r, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function Wd(t, e, n = (a, i) => a === i, o = 15) {
  return (a) => {
    const i = t.filter(
      (l) => !n(l, a)
    ), s = [a, ...i.slice(0, o - 1)];
...
function Jd({
  ...
  const w = ft(), [p, u] = S(!1), [h, f] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, _] = S(void 0), [k, z] = S(!1), L = Z(void 0), R = Z(void 0), $ = Z(void 0), C = Z(void 0), D = Z({}), V = G(
    (E) => {
      e(E), l && l(E);
    },
    [e, l]
    ...
    [v, P]
  ), { otLong: q, ntLong: tt, dcLong: Y, extraLong: it } = {
    ...
    (E) => {
      if (E.ctrlKey) return;
      const { isLetter: X, isDigit: nt } = Kr(E.key);
      if (v === "chapters") {
        if (E.key === "Backspace") {
    ...
    const { isLetter: X, isDigit: nt } = Kr(E.key);
    (X || nt) && (E.preventDefault(), x((rt) => rt + E.key), R.current.focus(), z(!1));
  }, []);
  return Wt(() => {
    const E = setTimeout(() => {
      if (p && v === "books" && $.current && C.current) {
        const X = $.current, nt = C.current, rt = nt.offsetTop, ut = X.clientHeight, Ht = nt.clientHeight, Nt = rt - ut / 2 + Ht / 2;
        X.scrollTo({
          top: Math.max(0, Nt),
          behavior: "smooth"
        }), f(er(t.book));
    ...
    if (v === "chapters" && N) {
      ...
      setTimeout(() => {
        if ($.current)
          if (E) {
            const X = D.current[t.chapterNum];
  ...
  }, [v, N, M, t.book, t.chapterNum]), /* @__PURE__ */ d(ne, { open: p, onOpenChange: T, children: [
    /* @__PURE__ */ r(ce, { asChild: !0, children: /* @__PURE__ */ r(
      B,
      {
              ...
              !M && Object.entries(H).map(([E, X]) => {
                if (X.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Zt, { heading: xt(E), children: X.map((nt) => /* @__PURE__ */ r(
                      qo,
                      {
                        bookId: nt,
                        onSelect: (rt) => Ct(rt),
...
), mt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(yo.Root, { ref: n, className: m("pr-twp", nl(), t), ...e }));
mt.displayName = yo.Root.displayName;
...
function nr({
  ...
  const [N, _] = S(!1), k = c ?? l, z = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], L = (R, $) => {
    const C = l(R), D = typeof R == "object" && "secondaryLabel" in R ? R.secondaryLabel : void 0, V = `${$ ?? ""}${C}${D ?? ""}`;
    return /* @__PURE__ */ d(
      Gt,
      {
        value: C,
...
function tp({
  ...
  const p = $n(w, "%webView_bookSelector_currentBook%"), u = $n(w, "%webView_bookSelector_choose%"), h = $n(w, "%webView_bookSelector_chooseBooks%"), [f, g] = S(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), t(v);
...
const Yo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, il = Yo ? Wt : K, cn = { tag: pr };
function ll({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = sl(null, o), p = No({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
const wl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : K;
...
const br = {
  ...
  {
    ref: o,
    className: e ? m(Uo({ variant: e }), t) : t,
    ...n
  }
));
...
const fl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : K;
function hl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function gl() {
  return function(t) {
    const [e] = qt(), n = F(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), i = Z(o);
    return fl(() => {
...
const Xo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Xo && "documentMode" in document ? document.documentMode : null;
!(!Xo || !("InputEvent" in window) || xl) && "getTargetRanges" in new window.InputEvent("input");
function Ur(t) {
  const e = Js(t, (n) => be(n) && !n.isInline());
  return be(e) || vl(4, t.__key), e;
}
...
function _l(t) {
  ...
  Jo(this), J = t, this.f &= -2, 8 & this.f && xr(this), Rn();
}
function Ce(t, e) {
...
vt.prototype.brand = yl, vt.prototype.h = function() {
  return !0;
}, vt.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : Hr(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const e = t.e, n = t.x;
    e !== void 0 && (e.x = n, t.e = void 0), n !== void 0 && (n.e = e, t.x = void 0), t === this.t && (this.t = n, n === void 0 && Hr(() => {
      var o;
  ...
  if (this.g = mn, this.f |= 1, this.i > 0 && !Wo(this)) return this.f &= -2, !0;
  const t = J;
  try {
    Xr(this), J = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Zo(this), Xr(this), ae++;
  const t = J;
  return J = this, _l.bind(this, t);
...
Qt({ build: (t, e, n) => Tn(e), config: rn({ $onClear: Qo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return le(() => ta(t, o.value));
} });
function Cl(t) {
...
const or = Qt({ build: (t) => ea(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const yr = 0, ar = 1, ra = 2, Vn = 3, dn = 4, _e = 5, jn = 6, Ge = 7;
function zn(t) {
  return t.id === yr;
}
function oa(t) {
...
function El(t) {
  return function(e) {
    return e.id === ar;
  }(t) || et(305, String(t.id), String(ar)), Object.assign(t, { id: ra });
}
...
const Dl = Qt({ config: rn({ setOptions: Wr, updateOptions: Wr }), init: ({ $initialEditorState: t = Sl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Qs, _o, ti, ei, ko] }), Jr = Symbol.for("@lexical/extension/LexicalBuilder");
function Zr() {
}
function Ml(t) {
  throw t;
...
const Ol = /* @__PURE__ */ new Set(), Qr = Qt({ build(t, e, n) {
  const o = n.getDependency(or).output, a = Qe({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ea(() => {
  }, () => le(() => {
...
Qt({ dependencies: [or, Qr], name: "@lexical/extension/HorizontalRule", nodes: () => [Se], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(Qr).output, a = Qe({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ie(t.registerCommand(oi, (s) => {
    if (ai(s.target)) {
      const l = si(s.target);
    ...
    return !1;
  }, ci), t.registerMutationListener(Se, (s, l) => {
    Nl(() => {
      let c = !1;
    ...
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) s.push(le(() => {
      const w = l.value;
      w && (c.value ? Ro(w, i) : mi(w, i));
    }));
    return ie(...s);
  }));
} });
function Pl(t, e) {
  return ie(t.registerCommand(fi, (n) => {
    const o = Jt();
    if (!Ze(o)) return !1;
    n.preventDefault();
    const a = function(i) {
      ...
      return !1;
    }(o) ? n.shiftKey ? bi : zr : vi;
    return t.dispatchCommand(a, void 0);
  }, Eo), t.registerCommand(zr, () => {
...
const $l = Qt({ name: "@lexical/react/ReactProvider" });
function Ll() {
...
Qt({ build: (t, e, n) => Tn(e), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => le(() => n.getOutput().disabled.value ? void 0 : ia(t)) });
function zl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Nr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : K;
  ...
  return function(n, o) {
    ...
    return Nr(() => n.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = r(o, { onError: (h) => n._onError(h), children: r(as, { fallback: null, children: a[w] }) }), u = n.getElementByKey(w);
...
function Gl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Nr(() => ie(Mi(a), ia(a)), [a]);
  }(o), d(ct, { children: [t, r(Kl, { content: e }), r(Bl, { editor: o, ErrorBoundary: n })] });
}
...
const Ul = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : K;
function Hl({ onClear: t }) {
  const [e] = qt();
  return Ul(() => ta(e, t), [e, t]), null;
}
const la = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : K;
...
function Jl(t, e) {
  ...
  return d(ct, { children: [r(Xl, { editor: a, ...o, ref: e }), n != null && r(Zl, { editor: a, content: n })] });
}
...
function ew() {
  const [t, e] = S(void 0), n = G(() => {
    e(void 0);
  }, []), o = F(() => {
    if (t === void 0)
      return;
    const { title: i, content: s } = t;
    return /* @__PURE__ */ r(Hi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Vo, { children: [
...
function nw({
  ...
  const [e] = qt(), [n, o] = S(e), [a, i] = S("paragraph"), [s, l] = ew(), c = () => {
  };
...
ow.displayName = Mo.Root.displayName;
...
function aw() {
  const { activeEditor: t } = ca(), [e, n] = S([]), o = G((a) => {
    if (Ze(a) || Ai(a)) {
      const i = [];
      no.forEach(({ format: s }) => {
...
function ua(t, e, n, o = null) {
  ...
  let s = e;
  o !== null && gn(e) && (s = bl(o, e, "clone"));
  const l = be(s) ? s.getChildren() : [], c = ki(t, s.getType());
  let w;
  ...
  if (a && !i) {
    if ((_i(p) || Fr(p)) && p.append(h), n.append(p), u) {
      const f = u.call(s, p);
      f && (Fr(p) ? p.replaceChildren(f) : p.replaceWith(f));
    }
  } else n.append(h);
  return a;
}
...
function fa(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const f = (l == null || !Ei(l)) && (l != null && hn(l) || o);
  for (let g = 0; g < u.length; g++) h.push(...fa(u[g], e, n, f, new Map(a), l));
  return p != null && (h = p(h)), Br(t) && (h = dw(t, h, f ? () => {
    const g = new So();
    return n.push(g), g;
  } : Cn)), l == null ? h.length > 0 ? s = s.concat(h) : Br(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Gr(g.nextSibling) && Gr(g.previousSibling);
  }(t) && (s = s.concat(Do())) : be(l) && l.append(...h), s;
}
function dw(t, e, n) {
...
function ep({
  ...
  const [a, i] = S(uw), [s, l] = S(void 0), [c, w] = S(!1), p = Z(void 0), u = Z(null);
  K(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
...
const np = Object.freeze([
  ...
  const a = Z(null), [i, s] = S(void 0), [l, c] = S(void 0), w = G(
    (f) => {
      s(f);
    ...
    (f) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && u(g)) {
        ...
        if (f.key === "ArrowDown" || f.key === "ArrowUp") {
          ...
          if (C === -1) return;
          let D;
          f.key === "ArrowDown" ? D = Math.min(C + 1, $.length - 1) : D = Math.max(C - 1, 0), D !== C && (f.preventDefault(), f.stopPropagation(), (R = $[D]) == null || R.focus());
          return;
        }
        return;
      }
...
Me.displayName = Io.Root.displayName;
...
xa.displayName = Ve.Root.displayName;
...
Nw.displayName = Ve.Image.displayName;
...
}), ze = ot.Trigger, Na = ot.Group, kw = ot.Portal, _w = ot.Sub, Cw = ot.RadioGroup;
...
function ro({
  ...
  const f = G(
    ...
    [t.user]
  ), N = F(() => Bs(t.contents), [t.contents]), _ = F(() => {
    if (o && l)
      return /* @__PURE__ */ d(ct, { children: [
        /* @__PURE__ */ d(
          yn,
    ...
    "div",
    {
      ...
      children: [
        ...
        _ && /* @__PURE__ */ d(ke, { children: [
          /* @__PURE__ */ r(ze, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(mo, {}) }) }),
...
function Rw({
  ...
  const [R, $] = S(oo), [C, D] = S(
    void 0
  ), V = o, [j, I] = S(!1), [A, H] = S(!1), [M, W] = S(!1), [Ct, Dt] = S(!1), [Mt, dt] = S(!1), [P, T] = S(k), [q, tt] = S(!1), Y = Z(void 0), [it, xt] = S(/* @__PURE__ */ new Map());
  K(() => {
    let O = !0;
    return (async () => {
  ...
  const yt = F(() => pt[0], [pt]), Ot = Z(null), ht = Z(void 0), gt = G(() => {
    var O;
    (O = ht.current) == null || O.call(ht), $(oo);
  }, []), Ut = G(() => {
    const O = !P;
    T(O), tt(!O), g == null || g(c, O);
  }, [P, g, c]);
  K(() => {
    I(!1);
  }, [o]), K(() => {
    if (o && !P && !q) {
      ...
      return Y.current = O, () => clearTimeout(O);
    }
  ...
  const Mr = G(
    ...
    async (O) => {
      ...
      return Et && zt && gt(), Et && C !== void 0 && D(void 0), Et;
    },
    [gt, R, u, C]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ d(va, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            X && /* @__PURE__ */ r(De, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: X }),
            /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
                ...
                children: P ? /* @__PURE__ */ r(ps, {}) : /* @__PURE__ */ r(us, {})
              }
            ),
...
function op({
  ...
  const [y, N] = S(/* @__PURE__ */ new Set()), [_, k] = S();
  K(() => {
  ...
  const z = n.filter(
    ...
    [y, x]
  ), { listboxRef: C, activeId: D, handleKeyDown: V } = hw({
    options: L,
    onOptionSelect: R
  }), j = G(
    (I) => {
...
function Tw({ table: t }) {
  return /* @__PURE__ */ d(ke, { children: [
    /* @__PURE__ */ r(Pi, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Oe = lt.Root, Sw = lt.Group, Ie = lt.Value, Dw = we(
...
Ea.displayName = lt.ScrollUpButton.displayName;
...
Ra.displayName = lt.ScrollDownButton.displayName;
...
Mw.displayName = lt.Label.displayName;
...
Ow.displayName = lt.Separator.displayName;
function Iw({ table: t }) {
...
function zw({
  ...
  var L;
  const [p, u] = S([]), [h, f] = S([]), [g, x] = S({}), [v, y] = S({}), N = F(() => e ?? [], [e]), _ = Ao({
    data: N,
    columns: t,
    getCoreRowModel: $o(),
...
function Bw({
  ...
  const a = so(n, "%webView_error_dump_header%"), i = so(n, "%webView_error_dump_info_message%");
  function s() {
...
function lp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ke, { children: [
    ...
    /* @__PURE__ */ r(de, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Na, { children: w.itemType === 0 ? /* @__PURE__ */ r(ct, { children: w.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Xt,
        {
          checked: o[p][h],
        ...
        Cw,
        {
          ...
          children: w.items.map((u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Ca, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ r(Fe, {})
    ] }, w.label)) })
...
function qw({
  ...
  const [y, N] = S(!1), _ = G(
    (D) => {
      var j;
      const V = (j = t.find((I) => I.label === D)) == null ? void 0 : j.value;
      V && n(
    ...
    if (!h) return t;
    const D = t.filter((j) => j.starred).sort((j, I) => j.label.localeCompare(I.label)), V = t.filter((j) => !j.starred).sort((j, I) => {
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(ne, { open: $, onOpenChange: p ?? N, children: [
    ...
    /* @__PURE__ */ r(Kt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
      ...
      /* @__PURE__ */ d(ee, { children: [
        ...
        /* @__PURE__ */ r(Zt, { children: z.map((D) => /* @__PURE__ */ d(
          Gt,
          {
            value: D.label,
            onSelect: _,
...
const Uw = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(ct, { children: [
...
function Hw({
  ...
  const i = Z(null), s = Z(null), l = Z(!1), [c, w] = S(t), [p, u] = S(n), [h, f] = S(!1);
  K(() => {
    w(t);
  }, [t]), K(() => {
    p !== n && u(n);
  ...
  return /* @__PURE__ */ d(ke, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Pt, { asChild: !0, children: /* @__PURE__ */ r(ze, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: Uw(t, a, n) }) }) }),
...
const Yw = (t, e) => t === "f" ? /* @__PURE__ */ d(ct, { children: [
  /* @__PURE__ */ r(vo, {}),
  " ",
...
function Ww({
  ...
  return /* @__PURE__ */ d(ke, { children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ti, { asChild: !0, children: /* @__PURE__ */ r(ze, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: Yw(t, n) }) }) }),
      /* @__PURE__ */ r(St, { children: /* @__PURE__ */ r("p", { children: Xw(t, n) }) })
    ] }) }),
...
function Zw({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? _s, { className: e, size: 16 });
}
      ...
      /* @__PURE__ */ r(Zt, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ d(
          Gt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Zw, { icon: s.icon }) }) }),
              /* @__PURE__ */ d("div", { children: [
...
function pp({
  ...
  const w = Z(null), p = Pr(), u = Pr(), [h, f] = S("generated"), [g, x] = S("*"), [v, y] = S("f"), [N, _] = S(!1), [k, z] = S(!1), [L, R] = S(), [$, C] = S(), [D, V] = S(), [j, I] = S(), A = Z(null), H = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  K(() => {
    ...
    if (T && wn("note", T)) {
      const Y = (q = T.insert.note) == null ? void 0 : q.caller;
      let it = "custom";
      Y === Wn ? it = "generated" : Y === Jn ? it = "hidden" : Y && x(Y), f(it), y(((tt = T.insert.note) == null ? void 0 : tt.style) ?? "f"), P = setTimeout(() => {
        var xt;
        (xt = w.current) == null || xt.applyUpdate([T]);
      }, 0);
    }
    return () => {
      P && clearTimeout(P);
  ...
  const W = G(() => {
    var T, q;
    const P = (q = (T = w.current) == null ? void 0 : T.getNoteOps(0)) == null ? void 0 : q.at(0);
    P && wn("note", P) && (P.insert.note && (h === "custom" ? P.insert.note.caller = g : P.insert.note.caller = h === "generated" ? Wn : Jn), n([P]));
  }, [h, g, n]), Ct = () => {
    var T;
    const P = (T = p.current) == null ? void 0 : T.getElementsByClassName("editor-input")[0];
    P != null && P.textContent && navigator.clipboard.writeText(P.textContent);
  }, Dt = (P) => {
    var q, tt, Y, it, xt;
    y(P);
    const T = (tt = (q = w.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : tt.at(0);
    if (T && wn("note", T)) {
      T.insert.note && (T.insert.note.style = P);
      const pt = (it = (Y = T.insert.note) == null ? void 0 : Y.contents) == null ? void 0 : it.ops;
      v !== "x" && P === "x" ? pt == null || pt.forEach((yt) => ec(yt)) : v === "x" && P !== "x" && (pt == null || pt.forEach((yt) => nc(yt))), (xt = w.current) == null || xt.applyUpdate([T, { delete: 1 }]);
    }
  }, Mt = (P) => {
    var q, tt, Y, it, xt, pt;
    (q = w.current) == null || q.focus();
    const T = (Y = (tt = w.current) == null ? void 0 : tt.getNoteOps(0)) == null ? void 0 : Y.at(0);
    if (T && wn("note", T)) {
      P.content.length > 1 && setTimeout(() => {
        var ht;
        (ht = w.current) == null || ht.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
      const yt = (it = T.insert.note) == null ? void 0 : it.style, Ot = (pt = (xt = T.insert.note) == null ? void 0 : xt.contents) == null ? void 0 : pt.ops;
      yt || _(!1), _(
    ...
    var q;
    const P = ((q = p.current) == null ? void 0 : q.querySelector(".editor-input")) ?? void 0, T = window.getSelection();
    if (u.current && P && document.activeElement === P && M.length && T && T.rangeCount > 0) {
      const tt = T.getRangeAt(0).getBoundingClientRect(), Y = u.current.getBoundingClientRect();
      R(tt.left - Y.left), C(tt.top - Y.top), V(tt.height), z(!0);
    }
  }, [M, p, u]);
  return K(() => {
    const P = () => {
    ...
    const P = (T) => {
      !k && T.key === l ? (T.preventDefault(), dt()) : k && T.key === "Escape" && z(!1);
    };
  ...
  return /* @__PURE__ */ d(ct, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: oc(t.marker, l, o, w) })
      }
    )
  ] });
}
function mp({
  ...
  const p = c ?? Us(n, void 0), u = (N, _) => {
    w == null || w(N, _, a);
  }, h = i ? n.findIndex((N) => N === i) : -1, [f, g] = S(h), x = (N, _, k) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
    ...
    /* @__PURE__ */ r(Mn, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ d(
      Yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(xe, { className: o, children: ic(l.text) })
        ]
      },
...
const wc = (t) => {
  ...
  return e ? e[1] : "";
}, dc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", yp = Object.freeze([
  ...
  const a = jr(o.key) ? o.key : o.key[0];
  return {
    items: jr(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || dc(a, e, n),
...
function Np({
  ...
  const f = Ft(n, "%webView_inventory_all%"), g = Ft(n, "%webView_inventory_approved%"), x = Ft(n, "%webView_inventory_unapproved%"), v = Ft(n, "%webView_inventory_unknown%"), y = Ft(n, "%webView_inventory_scope_currentBook%"), N = Ft(n, "%webView_inventory_scope_chapter%"), _ = Ft(n, "%webView_inventory_scope_verse%"), k = Ft(n, "%webView_inventory_filter_text%"), z = Ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = Ft(n, "%webView_inventory_no_results%"), [R, $] = S(!1), [C, D] = S("all"), [V, j] = S(""), [I, A] = S([]), H = F(() => {
    const T = t ?? [];
    return T.length === 0 ? [] : uc(T, a, i);
  }, [t, a, i]), M = F(() => {
    if (R) return H;
    const T = [];
    return H.forEach((q) => {
      const tt = q.items[0], Y = T.find(
        (it) => it.items[0] === tt
      );
      Y ? (Y.count += q.count, Y.occurrences = Y.occurrences.concat(q.occurrences)) : T.push({
        items: [tt],
        count: q.count,
  ...
  }, [R, H]), W = F(() => M.length === 0 ? [] : pc(M, C, V), [M, C, V]), Ct = F(() => {
    var tt, Y;
    if (!R) return c;
    const T = (tt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : tt.length;
    if (!T) return c;
    const q = [];
    for (let it = 0; it < T; it++)
      q.push(
        cc(
          ((Y = o == null ? void 0 : o.tableHeaders) == null ? void 0 : Y[it]) || "Additional Item",
          it + 1
        )
      );
    return [...q, ...c];
  ...
  const Dt = (T, q) => {
    q.setRowSelection(() => {
      const Y = {};
      return Y[T.index] = !0, Y;
    });
    const tt = T.original.items;
    A(tt), h && tt.length > 0 && h(tt[0]);
  }, Mt = (T) => {
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(Oe, { onValueChange: (T) => Mt(T), defaultValue: s, children: [
...
const mc = "16rem", fc = "3rem", Sa = b.createContext(void 0);
function In() {
...
const Da = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Sa.Provider, { value: N, children: /* @__PURE__ */ r(Tt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
Rc.displayName = "SidebarMenuSub";
const Tc = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Tc.displayName = "SidebarMenuSubItem";
    ...
    Ma,
    {
      ...
      children: /* @__PURE__ */ d(Ia, { children: [
        /* @__PURE__ */ d(ir, { children: [
          ...
          /* @__PURE__ */ r(wr, { children: /* @__PURE__ */ r(Aa, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(Pa, { children: /* @__PURE__ */ r(
            $a,
            {
              onClick: () => w(h),
              isActive: u(h),
...
const oe = "scrBook", Mc = "scrRef", fe = "source", Oc = "details", Ic = "Scripture Reference", Ac = "Scripture Book", La = "Type", Pc = "Details";
function $c(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, io = (t) => `${Lc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function _p({
  sources: t,
  ...
  const [w, p] = S([]), [u, h] = S([{ id: oe, desc: !1 }]), [f, g] = S({}), x = F(
  ...
  K(() => {
    if (l) {
      const C = y.getSelectedRowModel().rowsById, D = Object.keys(C);
      if (D.length === 1) {
        const V = x.find((j) => io(j) === D[0]) || void 0;
        V && l(V);
      }
    }
  }, [f, x, l, y]);
  const N = a ?? Ac, _ = i ?? La, k = [
  ...
  }, R = (C, D) => C.getIsGrouped() ? "" : m("banded-row", D % 2 === 0 ? "even" : "odd"), $ = (C, D, V) => {
    if (!((C == null ? void 0 : C.length) === 0 || D.depth < V.column.getGroupedIndex())) {
      if (D.getIsGrouped())
        switch (D.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ne, { position: "item-aligned", children: /* @__PURE__ */ r(Sw, { children: k.map((C) => /* @__PURE__ */ r(Rt, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Sn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Dn, { children: y.getHeaderGroups().map((C) => /* @__PURE__ */ r(Yt, { children: C.headers.filter((D) => D.column.columnDef.header).map((D) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(en, { colSpan: D.colSpan, className: "top-0 tw-sticky", children: D.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          He(D.column.columnDef.header, D.getContext())
        ] }) }, D.id)
      )) }, C.id)) }),
      /* @__PURE__ */ r(Mn, { children: y.getRowModel().rows.map((C, D) => {
        const V = ft();
        return /* @__PURE__ */ r(
          Yt,
          {
...
}), Va = (t, e, n) => Dr(t, e).every((o) => n.includes(o));
function Vc({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
...
function jc({
  ...
  }, [v, y] = S(!1), [N, _] = S(""), k = Z(void 0), z = Z(!1);
  ...
  const L = F(() => wt.allBookIds.filter(
    ...
    (A) => {
      ...
      n(
        Va(L, A, e) ? e.filter((M) => !H.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, n, L]
  ), j = () => {
                  ...
                  Object.values(U).map((A, H) => {
                    ...
                    if (M.length !== 0)
                      return /* @__PURE__ */ d(wo, { children: [
                        ...
                        H < Object.values(U).length - 1 && /* @__PURE__ */ r(Fo, {})
                      ] }, A);
                  })
                ] })
              ]
...
const za = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Pt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(kw, { children: /* @__PURE__ */ r(_a, { children: za(
      t,
      e,
      ja(t, l.id),
      o
...
function cr({
  ...
  return /* @__PURE__ */ d(ke, { variant: i, children: [
    /* @__PURE__ */ r(ze, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Is, {}) }) }),
    /* @__PURE__ */ r(de, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(wo, { children: [
      /* @__PURE__ */ r(Na, { children: /* @__PURE__ */ r(Tt, { children: za(e.groups, e.items, c, t) }) }),
...
function Mp({
  ...
  return /* @__PURE__ */ d(Fa, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      cr,
      {
        onSelectMenuItem: t,
...
function Op({
  ...
  return /* @__PURE__ */ r(Fa, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    cr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
Ga.displayName = _t.List.displayName;
...
)), Ka = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  _t.Content,
  {
    ref: n,
    className: m(
...
Ka.displayName = _t.Content.displayName;
function Ip({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Ba, { children: [
      /* @__PURE__ */ r(Ga, { children: t.map((l) => /* @__PURE__ */ r(zc, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(Ka, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Fc({ ...t }) {
...
Ua.displayName = at.Trigger.displayName;
...
Gc.displayName = at.CheckboxItem.displayName;
const Kc = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = jt();
  return /* @__PURE__ */ d(
    at.RadioItem,
    {
...
Kc.displayName = at.RadioItem.displayName;
...
qc.displayName = at.Label.displayName;
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((w) => w.group === i).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Pt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        ...
        /* @__PURE__ */ r(Ha, { children: w.label }),
    ...
    return l.length > 0 && s < a.length - 1 && c.push(/* @__PURE__ */ r(Ja, {}, `separator-${i}`)), c;
  });
};
function Uc({
  menuData: t,
  ...
  const a = Z(void 0), i = Z(void 0), s = Z(void 0), l = Z(void 0), c = Z(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return i;
  ...
  if (Gi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(Fc, { children: [
      /* @__PURE__ */ r(Ua, { ref: w(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        Xa,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Tt, { children: Za(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ke, { children: [
              /* @__PURE__ */ r(ze, { className: m(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(mo, {}) }) }),
...
const Xc = nn(({ className: t, ...e }, n) => /* @__PURE__ */ r($s, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
const zp = st.Root, Fp = st.Trigger, Bp = st.Group, Gp = st.Portal, Kp = st.Sub, qp = st.RadioGroup, td = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  st.SubTrigger,
  {
    ref: a,
    className: m(
...
const nd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(st.Portal, { children: /* @__PURE__ */ r(
  st.Content,
  {
    ref: n,
    className: m(
...
nd.displayName = st.Content.displayName;
...
od.displayName = st.CheckboxItem.displayName;
...
ad.displayName = st.RadioItem.displayName;
...
sd.displayName = st.Label.displayName;
...
const Up = Vt.Trigger, cd = Vt.Portal, Hp = Vt.Close, ts = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vt.Overlay,
  {
    ref: n,
...
ts.displayName = Vt.Overlay.displayName;
...
md.displayName = Vt.Title.displayName;
...
fd.displayName = Vt.Description.displayName;
...
gd.displayName = qe.Root.displayName;
...
bd.displayName = tr.Root.displayName;
const Zp = _t.Root, vd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ft();
  return /* @__PURE__ */ r(
    _t.List,
    {
...
vd.displayName = _t.List.displayName;
...
xd.displayName = _t.Trigger.displayName;
...
yd.displayName = _t.Content.displayName;
...
export {
  ...
  Nw as AvatarImage,
  Zd as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  Qd as BOOK_SELECTOR_STRING_KEYS,
  De as Badge,
  Jd as BookChapterControl,
