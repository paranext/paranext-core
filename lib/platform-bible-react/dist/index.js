...
import p, { forwardRef as $t, createContext as Yn, useContext as Hn, useCallback as tt, useState as O, useRef as K, useEffect as wt, useLayoutEffect as Xe, useMemo as W, Fragment as Un } from "react";
...
const ye = D.Trigger, tn = D.Group, Pr = D.Portal, Ar = D.Sub, Ko = D.RadioGroup;
...
Ot.displayName = D.Content.displayName;
...
function Zo({
  ...
  const o = F(), [s, w] = O(""), [i, c] = O(t.book), [u, h] = O(t.chapterNum ?? 0), [b, g] = O(t.book), [m, y] = O(!1), [z, k] = O(m), x = K(void 0), N = K(void 0), E = K(void 0), $ = tt(
    (C) => {
      const I = a ? a() : Te;
      return {
        OT: I.filter((A) => X.isBookOT(A)),
        NT: I.filter((A) => X.isBookNT(A)),
        DC: I.filter((A) => X.isBookDC(A))
      }[C].filter((A) => {
    ...
    ea.forEach((C) => {
      const I = C.exec(s);
      if (I) {
        const [A, f = void 0, T = void 0] = I.slice(1), Z = aa(A);
    ...
    if (b === i) {
      ...
      const A = I === "ArrowRight" && !o || I === "ArrowRight" && o === "ltr" || I === "ArrowLeft" && o === "rtl", f = I === "ArrowLeft" && !o || I === "ArrowLeft" && o === "ltr" || I === "ArrowRight" && o === "rtl";
      let T = 0;
      if (A)
        if (u < zt(b))
          T = 1;
  ...
  return wt(() => {
    ...
    const C = setTimeout(() => {
      if (z && N.current && E.current && !s) {
        const A = E.current.offsetTop - ta;
  ...
  }, [z, s]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Ht, { modal: !1, open: m, onOpenChange: ct, children: [
...
function ts({
  ...
  const h = ae(u, "%webView_bookSelector_currentBook%"), b = ae(u, "%webView_bookSelector_choose%"), g = ae(u, "%webView_bookSelector_chooseBooks%"), [m, y] = O(
    "current book"
    /* CURRENT_BOOK */
  ), z = (k) => {
    y(k), t(k);
...
function ka({
  ...
  var k;
  const [i, c] = O([]), [u, h] = O([]), [b, g] = O({}), [m, y] = O({}), z = Je({
    data: e,
    columns: t,
    getCoreRowModel: We(),
...
function bs({
  ...
  const u = ot(n, "%webView_inventory_all%"), h = ot(n, "%webView_inventory_approved%"), b = ot(n, "%webView_inventory_unapproved%"), g = ot(n, "%webView_inventory_unknown%"), m = ot(n, "%webView_inventory_scope_currentBook%"), y = ot(n, "%webView_inventory_scope_chapter%"), z = ot(n, "%webView_inventory_filter_text%"), k = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, N] = O(!1), [E, $] = O("all"), [q, dt] = O(""), [ct, v] = O([]), R = W(() => t.length === 0 ? [] : Da(t, o, s), [t, o, s]), L = W(() => {
    if (x) return R;
    const f = [];
    return R.forEach((T) => {
...
const Pe = At.Provider, Ae = At.Root, Oe = At.Trigger, Zt = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  At.Content,
  {
    ref: a,
    sideOffset: e,
...
Zt.displayName = At.Content.displayName;
...
const Aa = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Qt();
  return /* @__PURE__ */ d(
    V,
    {
...
const La = lt(
  ...
  ({
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Oe, { asChild: !0, children: h }),
...
function xs({
  ...
  const [c, u] = O([]), [h, b] = O([{ id: st, desc: !1 }]), [g, m] = O({}), y = W(
...
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, c) => i.order - c.order).map((i) => /* @__PURE__ */ d(Ae, { children: [
  /* @__PURE__ */ r(Oe, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    Ne,
    {
      onClick: () => {
        a(i);
...
function Ye({
  ...
  return /* @__PURE__ */ d(Ht, { variant: s, children: [
    /* @__PURE__ */ r(ye, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(V, { variant: "ghost", className: "tw-h-6 tw-p-1", children: a ?? /* @__PURE__ */ r(xr, {}) }) }),
    /* @__PURE__ */ r(Ot, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, c]) => typeof i == "boolean" || typeof c == "boolean" ? 0 : i.order - c.order).map(([i], c, u) => /* @__PURE__ */ d(Un, { children: [
...
const An = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
...
An.displayName = B.Root.displayName;
...
On.displayName = B.Trigger.displayName;
...
const Et = (t, e) => {
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((u) => u.group === s).sort((u, h) => u.order - h.order).map((u) => /* @__PURE__ */ d(Ae, { children: [
      /* @__PURE__ */ r(Oe, { asChild: !0, children: "command" in u ? /* @__PURE__ */ d(
        Gn,
        {
          onClick: () => {
            a(u);
...
function po({
  ...
  if (Ir(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (h, b) => {
    ...
    return /* @__PURE__ */ r(An, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, h]) => typeof h == "object").sort(([, h], [, b]) => typeof h == "boolean" || typeof b == "boolean" ? 0 : h.order - b.order).map(([h, b]) => /* @__PURE__ */ d(so, { children: [
