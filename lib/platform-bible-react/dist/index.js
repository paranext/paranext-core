...
var mt = (t, e, n) => es(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as d, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as tn, useRef as W, useMemo as z, useState as M, useCallback as B, useLayoutEffect as Bt, createContext as kn, useContext as pr, useEffect as H, Component as ns, createElement as Ir, Suspense as rs, createRef as os, Fragment as so } from "react";
import { Command as bt } from "cmdk";
import { X as Oe, Search as io, Check as Rt, Clock as Or, ChevronsLeft as Ar, ChevronsRight as Pr, ChevronLeft as Hn, ChevronRight as Ee, ArrowLeft as as, ArrowRight as ss, Circle as _n, ChevronDown as be, BoldIcon as is, ItalicIcon as ls, UnderlineIcon as ws, StrikethroughIcon as cs, AtSign as lo, Pencil as ds, Trash2 as ps, ArrowUp as wo, MoreHorizontal as co, MailOpen as us, Mail as ms, ChevronUp as Yn, FilterIcon as fs, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as bs, ArrowRightIcon as vs, Copy as po, Filter as xs, User as ys, Link as Ns, CircleHelp as ks, ChevronsUpDown as uo, Star as _s, SquareX as mo, FunctionSquare as fo, SquareSigma as ho, AlertCircle as Xn, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as Rs, ArrowDownIcon as Ss, ArrowUpDownIcon as Ds, PanelLeft as Ms, PanelRight as Is, ScrollText as Os, MenuIcon as As, Menu as Ps, EllipsisVertical as $s, LoaderCircle as Ls, GripVertical as Vs } from "lucide-react";
...
import { includes as wn, Section as q, getChaptersForBook as Fs, formatScrRef as me, getSectionForBook as Ke, formatRelativeDate as Bs, formatReplacementString as ue, sanitizeHtml as Gs, NumberFormat as Ks, formatBytes as Us, getCurrentLocale as qs, getFormatCallerFunction as Hs, deepEqual as Ys, isString as $r, compareScrRefs as Wn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as X } from "platform-bible-utils";
...
import { createEditor as bo, $getRoot as te, $createParagraphNode as Cn, $getSelection as Gt, HISTORY_MERGE_TAG as ur, ParagraphNode as vo, TextNode as xo, $isTokenOrSegmented as Xs, $getCharacterOffsets as Ws, $cloneWithPropertiesEphemeral as Js, $findMatchingParent as Zs, $isElementNode as fe, CLEAR_EDITOR_COMMAND as yo, COMMAND_PRIORITY_EDITOR as No, $isRangeSelection as We, shallowMergeConfig as Qs, defineExtension as Ut, safeCast as en, RootNode as ti, LineBreakNode as ei, TabNode as ni, $isEditorState as ri, createCommand as oi, CLICK_COMMAND as ai, isDOMNode as si, $getNodeFromDOMNode as ii, $isNodeSelection as li, $createNodeSelection as wi, $setSelection as ci, COMMAND_PRIORITY_LOW as di, DecoratorNode as pi, $create as ui, $getNodeByKey as mi, INDENT_CONTENT_COMMAND as Lr, COMMAND_PRIORITY_CRITICAL as mr, KEY_TAB_COMMAND as fi, $createRangeSelection as hi, $normalizeSelection__EXPERIMENTAL as gi, OUTDENT_CONTENT_COMMAND as bi, INSERT_TAB_COMMAND as vi, $isBlockElementNode as hn, $isDecoratorNode as xi, $isParagraphNode as yi, $isTextNode as gn, SELECTION_CHANGE_COMMAND as ko, FORMAT_TEXT_COMMAND as Ni, getRegisteredNode as ki, isHTMLElement as _i, isDocumentFragment as Vr, isDOMDocumentNode as Ci, ArtificialNode__DO_NOT_USE as _o, $createLineBreakNode as Co, $isRootOrShadowRoot as Ei, isBlockDomNode as jr, isInlineDomNode as zr, $insertNodes as Ti } from "lexical";
...
import { useReactTable as So, getFilteredRowModel as $i, getSortedRowModel as Do, getPaginationRowModel as Li, getCoreRowModel as Mo, flexRender as Ue, getGroupedRowModel as Vi, getExpandedRowModel as ji } from "@tanstack/react-table";
import * as rt from "@radix-ui/react-select";
import zi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Jn, HIDDEN_NOTE_CALLER as Zn, getDefaultViewOptions as Fi, isInsertEmbedOpOfType as cn, Editorial as Bi } from "@eten-tech-foundation/platform-editor";
...
const Hi = Tt.Root, Yi = Tt.Portal, Io = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Tt.Overlay,
  {
    ref: n,
    className: f(
...
Io.displayName = Tt.Overlay.displayName;
const Oo = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ct();
...
Oo.displayName = Tt.Content.displayName;
...
$o.displayName = bt.Separator.displayName;
...
const jo = at.allBookIds.filter(
  (t) => !at.isObsolete(at.bookIdToNumber(t))
), he = Object.fromEntries(
  jo.map((t) => [t, at.bookIdToEnglishName(t)])
);
function gr(t, e, n) {
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ d(
          ...
          {
            ref: w,
            value: c || `${t} ${at.bookIdToEnglishName(t)}`,
            onSelect: m,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
...
const oe = Te.Root, ae = Te.Trigger, Hd = Te.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ct();
...
Yt.displayName = Te.Content.displayName;
function nr(t, e, n) {
...
function Zi({
  ...
  return /* @__PURE__ */ d(oe, { open: c, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Ht, { children: /* @__PURE__ */ r(Kt, { heading: s, children: t.map((m) => /* @__PURE__ */ d(
      Pt,
      {
        onSelect: () => p(m),
...
function Yd(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function el(t, e, n, o) {
  ...
  return z(() => [
    ...
    {
      onClick: s,
      disabled: e.length === 0 || (t.chapterNum === Ot(t.book) || Ot(t.book) === -1) && e.indexOf(t.book) === e.length - 1,
      title: "Next chapter",
      icon: n === "ltr" ? Pr : Ar
    }
  ], [
...
function Xd({
  ...
  const w = ct(), [p, m] = M(!1), [h, u] = M(""), [g, y] = M(""), [v, N] = M("books"), [k, T] = M(void 0), [P, $] = M(!1), L = W(void 0), x = W(void 0), E = W(void 0), _ = W(void 0), R = W({}), C = B(
    (I) => {
      e(I), l && l(I);
    },
    [e, l]
    ...
    (I) => {
      ...
      m(I), I && (N("books"), T(void 0), y(""));
    },
    [v, yt]
  ), { otLong: it, ntLong: ut, dcLong: dt, extraLong: gt } = {
    ...
    (I) => {
      ...
      if (v === "chapters") {
        ...
        if (K || nt) {
          if (I.preventDefault(), I.stopPropagation(), N("books"), T(void 0), nt && k) {
            const ot = he[k];
            y(`${ot} ${I.key}`);
          } else
            y(I.key);
      ...
      if ((v === "chapters" || v === "books" && D) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(I.key)) {
        ...
        switch (I.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            kt = Z === 0 ? Vt : Math.max(1, Z - le);
            break;
          case "ArrowDown":
            kt = Z === 0 ? 1 : Math.min(Vt, Z + le);
            break;
          default:
            return;
        }
        kt !== Z && (I.preventDefault(), I.stopPropagation(), u(nr(ot, a, kt)), setTimeout(() => {
          const we = R.current[kt];
  ...
  return Bt(() => {
    const I = setTimeout(() => {
      if (p && v === "books" && E.current && _.current) {
        const K = E.current, nt = _.current, ot = nt.offsetTop, Z = K.clientHeight, Vt = nt.clientHeight, kt = ot - Z / 2 + Vt / 2;
        K.scrollTo({
          top: Math.max(0, kt),
          behavior: "smooth"
        }), u(nr(t.book));
    ...
    if (v === "chapters" && k) {
      ...
      setTimeout(() => {
        if (E.current)
          if (I) {
            const K = R.current[t.chapterNum];
  ...
  }, [v, k, D, t.book, t.chapterNum]), /* @__PURE__ */ d(oe, { open: p, onOpenChange: j, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
      V,
      {
    ...
    /* @__PURE__ */ r(Yt, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      qt,
      {
        ref: L,
        onKeyDown: Ne,
        ...
        children: [
          ...
          !P && /* @__PURE__ */ d(Ht, { ref: E, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              ...
              D && Ot(D.book) > 1 && /* @__PURE__ */ d(lt, { children: [
...
function rr({
  ...
  const [k, T] = M(!1), P = c ?? l, $ = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], L = (x, E) => {
    const _ = l(x), R = typeof x == "object" && "secondaryLabel" in x ? x.secondaryLabel : void 0, C = `${E ?? ""}${_}${R ?? ""}`;
    return /* @__PURE__ */ d(
      Pt,
      {
        value: _,
  ...
  return /* @__PURE__ */ d(oe, { open: k, onOpenChange: T, ...N, children: [
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ d(qt, { children: [
          ...
          /* @__PURE__ */ r(Ht, { children: $(e) ? e.map((x) => /* @__PURE__ */ r(Kt, { heading: x.groupHeading, children: x.options.map((E) => L(E, x.groupHeading)) }, x.groupHeading)) : e.map((x) => L(x)) })
        ] })
      }
    )
  ] });
...
const Bo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, il = Bo ? Bt : H, dn = { tag: ur };
function ll({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = sl(null, o), p = bo({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Cn();
            u.append(g);
            const y = Bo ? document.activeElement : null;
...
function cl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return wl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: c }) => {
      e && s.size === 0 && i.size === 0 || t && c.has(ur) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const vr = {
...
function Ko(...t) {
  const e = [];
  for (const n of t) if (n && typeof n == "string") for (const [o] of n.matchAll(/\S+/g)) e.push(o);
  return e;
}
function ee(...t) {
  return () => {
...
function Gr(t) {
  const e = Zs(t, (n) => fe(n) && !n.isInline());
...
function El(t) {
  ...
  Ho(this), Y = t, this.f &= -2, 8 & this.f && yr(this), Tn();
}
function _e(t, e) {
...
ft.prototype.brand = kl, ft.prototype.h = function() {
  return !0;
  ...
  if (this.g = mn, this.f |= 1, this.i > 0 && !qo(this)) return this.f &= -2, !0;
  const t = Y;
  try {
    qr(this), Y = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Yo(this), qr(this), Qt++;
  const t = Y;
  return Y = this, El.bind(this, t);
...
Ut({ build: (t, e, n) => Rn(e), config: en({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
Ut({ build: (t, e, n) => Rn(e), config: en({ $onClear: Xo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return ne(() => Wo(t, o.value));
} });
function Tl(t) {
...
const ar = Ut({ build: (t) => Jo(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Nr = 0, sr = 1, Qo = 2, Vn = 3, pn = 4, ke = 5, jn = 6, Fe = 7;
function zn(t) {
  return t.id === Nr;
}
function ta(t) {
...
function Rl(t) {
  return function(e) {
    return e.id === sr;
  }(t) || J(305, String(t.id), String(sr)), Object.assign(t, { id: Qo });
}
...
class Dl {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Vn;
    }(e) || J(314, String(e.id), String(Vn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
...
const Il = Ut({ config: en({ setOptions: Hr, updateOptions: Hr }), init: ({ $initialEditorState: t = Ml }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (ri(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ti, xo, ei, ni, vo] }), Yr = Symbol.for("@lexical/extension/LexicalBuilder");
function Xr() {
}
function Ol(t) {
  throw t;
...
class He {
  ...
  buildCreateEditorArgs() {
    ...
    for (const p of l) {
      const { extension: m } = p;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of Tl(m)) {
...
const Al = /* @__PURE__ */ new Set(), Wr = Ut({ build(t, e, n) {
  const o = n.getDependency(ar).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Jo(() => {
  }, () => ne(() => {
...
Ut({ dependencies: [ar, Wr], name: "@lexical/extension/HorizontalRule", nodes: [Re], register(t, e, n) {
  ...
  return ee(t.registerCommand(ai, (i) => {
    if (si(i.target)) {
      const l = ii(i.target);
      if ($l(l)) return function(c, w = !1) {
        const p = Gt(), m = c.isSelected(), h = c.getKey();
        let u;
        w && li(p) ? u = p : (u = wi(), ci(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, di), t.registerMutationListener(Re, (i, l) => {
    _l(() => {
      let c = !1;
      ...
      for (const [p, m] of i.entries()) if (m === "destroyed") w.delete(p), c = !0;
        ...
        h ? h.domNode.value = u : (c = !0, w.set(p, { domNode: Je(u), selectedSignal: o(p) }));
      }
...
function Ll(t, e) {
  return ee(t.registerCommand(fi, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Nl(i, (h) => hn(h) && h.canIndent() ? h : null).length > 0) return !0;
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, p = w.getNode(), m = Gr(p);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = hi();
...
Ut({ build: (t, e, n) => Rn(e), config: en({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a } = n.getOutput();
  return ne(() => {
    if (!o.value) return Ll(t, a);
  });
} });
const Vl = Ut({ name: "@lexical/react/ReactProvider" });
function jl() {
...
Ut({ build: (t, e, n) => Rn(e), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ne(() => n.getOutput().disabled.value ? void 0 : ra(t)) });
function Bl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return kr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = r(o, { onError: (h) => n._onError(h), children: r(rs, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
...
function Kl({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    return !1;
  }(t) ? null : r(Gl, { editor: t, ErrorBoundary: e });
}
function Jr(t) {
...
function Ul({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    kr(() => ee(Mi(a), ra(a)), [a]);
  }(o), d(lt, { children: [t, r(ql, { content: e }), r(Kl, { editor: o, ErrorBoundary: n })] });
}
...
const Yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : H;
function Xl({ onClear: t }) {
  const [e] = $t();
  return Yl(() => Wo(e, t), [e, t]), null;
}
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : H;
function Wl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: v = "textbox", spellCheck: N = !0, style: k, tabIndex: T, "data-testid": P, ...$ }, L) {
  const [x, E] = M(t.isEditable()), _ = B((C) => {
    C && C.ownerDocument && C.ownerDocument.defaultView ? t.setRootElement(C) : t.setRootElement(null);
  }, [t]), R = z(() => /* @__PURE__ */ function(...C) {
    return (A) => {
      for (const G of C) typeof G == "function" ? G(A) : G != null && (G.current = A);
    };
  }(L, _), [_, L]);
  return oa(() => (E(t.isEditable()), t.registerEditableListener((C) => {
    E(C);
  })), [t]), r("div", { "aria-activedescendant": x ? e : void 0, "aria-autocomplete": x ? n : "none", "aria-controls": x ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": x && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": x ? m : void 0, "aria-readonly": !x || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: x, "data-testid": P, id: y, ref: R, role: v, spellCheck: N, style: k, tabIndex: T, ...$ });
}
const Jl = tn(Wl);
function Zr(t) {
  return t.getEditorState().read(na(t.isComposing()));
...
function rw() {
  const [t, e] = M(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Hi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Oo, { children: [
...
function ow({
  ...
  const [e] = $t(), [n, o] = M(e), [a, s] = M("paragraph"), [i, l] = rw(), c = () => {
  };
...
const Qr = [
  ...
  { format: "underline", icon: ws, label: "Underline" },
  { format: "strikethrough", icon: cs, label: "Strikethrough" }
];
function iw() {
  const { activeEditor: t } = sa(), [e, n] = M([]), o = B((a) => {
    if (We(a) || Ai(a)) {
      const s = [];
      Qr.forEach(({ format: i }) => {
...
function wa(t, e, n, o = null) {
  ...
  const l = fe(i) ? i.getChildren() : [], c = ki(t, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = wa(t, g, h, o);
    !a && fe(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((_i(p) || Vr(p)) && p.append(h), n.append(p), m) {
      const u = m.call(i, p);
...
function da(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (h = p(h)), jr(t) && (h = uw(t, h, u ? () => {
    const g = new _o();
    return n.push(g), g;
  ...
  }(t) && (i = i.concat(Co())) : fe(l) && l.append(...h), i;
}
function uw(t, e, n) {
...
function mw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = dw(e, a);
      te().clear(), Ti(s);
    },
    {
      discrete: !0
...
function Qd({
  ...
  const [a, s] = M(fw), [i, l] = M(void 0), [c, w] = M(!1), p = W(void 0), m = W(null);
  H(() => {
    let N = !0;
    const k = m.current;
    if (!k) return;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
          /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Oe, {}) }) }),
...
const tp = Object.freeze([
  ...
  const a = W(null), [s, i] = M(void 0), [l, c] = M(void 0), w = B(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (_ === -1) return;
          let R;
          u.key === "ArrowDown" ? R = Math.min(_ + 1, E.length - 1) : R = Math.max(_ - 1, 0), R !== _ && (u.preventDefault(), u.stopPropagation(), (x = E[R]) == null || x.focus());
          return;
        }
        return;
      }
...
const Nw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
De.displayName = Ro.Root.displayName;
...
ha.displayName = Pe.Root.displayName;
...
_w.displayName = Pe.Image.displayName;
...
ga.displayName = Pe.Fallback.displayName;
const Er = kn(void 0);
function Dt() {
  const t = pr(Er);
  if (!t)
...
}), Le = Q.Trigger, ba = Q.Group, Cw = Q.Portal, Ew = Q.Sub, Tw = Q.RadioGroup;
...
va.displayName = Q.SubTrigger.displayName;
...
xa.displayName = Q.SubContent.displayName;
...
const Ft = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    Q.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(Rt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
ya.displayName = Q.RadioItem.displayName;
...
Ve.displayName = Q.Separator.displayName;
...
function to({
  ...
  }, [t.date, n]), T = z(() => t.user, [t.user]), P = z(
    () => t.user.split(" ").map((x) => x[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), $ = z(() => Gs(t.contents), [t.contents]), L = z(() => {
    if (o && w)
      return /* @__PURE__ */ d(lt, { children: [
        /* @__PURE__ */ d(
          yn,
          {
            onClick: () => {
              h(!0), g(mw(t.contents)), c == null || c(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(ha, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(ga, { className: "tw-text-xs tw-font-medium", children: P }) }),
        ...
        L && /* @__PURE__ */ d(ye, { children: [
          /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(co, {}) }) }),
...
function Sw({
  ...
  const [$, L] = M(eo), [x, E] = M(!1), [_, R] = M(!1), [C, A] = M(!1), [G, O] = M(!1), [U, D] = M(!1), [F, st] = M(void 0), [ht, Lt] = M(!1), [pt, yt] = M(!1), [j, it] = M(T), [ut, dt] = M(!1), gt = W(void 0), [an, ze] = M(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    if (!o) {
      Lt(!1), yt(!1), ze(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Jt = v ? await v(c) : !1;
      if (!S) return;
      const ln = N ? await N(c) : !1;
      S && (Lt(Jt), yt(ln));
    })(), () => {
      S = !1;
    };
  ...
  const Nt = z(() => Wt[0], [Wt]), sn = W(null), Ne = W(void 0), ie = B(() => {
    var S;
    (S = Ne.current) == null || S.call(Ne), L(eo);
  }, []), I = B(() => {
    const S = !j;
    it(S), dt(!S), u == null || u(c, S);
  }, [j, u, c]);
  H(() => {
    const S = sn.current;
    if (!S)
  ...
  const K = z(
  ...
  }, [s, n]), ot = z(() => Wt.slice(1), [Wt]), Z = z(() => ot.length ?? 0, [ot.length]), Vt = z(() => Z > 0, [Z]), kt = z(() => C || Z <= 2 ? ot : ot.slice(-2), [ot, Z, C]), le = z(() => C || Z <= 2 ? 0 : Z - 2, [Z, C]), we = z(
    ...
    S && await p({ threadId: c, contents: S }) && ie();
  }, [ie, $, p, F, c]), Za = B(
    async (S) => {
    ...
    ma,
    {
      ...
      children: /* @__PURE__ */ d(fa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ r(
              V,
              {
                ...
                children: j ? /* @__PURE__ */ r(us, {}) : /* @__PURE__ */ r(ms, {})
              }
            ),
        ...
        /* @__PURE__ */ d(lt, { children: [
          Vt && !o && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
            ...
            le > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(De, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: Ja }),
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ d(oe, { open: U, onOpenChange: D, children: [
                      /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
                        V,
                        {
                          size: "icon",
...
function np({
  ...
  const T = n.filter(
    ...
    [y]
  ), { listboxRef: x, activeId: E, handleKeyDown: _ } = bw({
    options: P,
    onOptionSelect: $
  }), R = B(
    (C) => {
...
function Dw({ table: t }) {
  return /* @__PURE__ */ d(ye, { children: [
    /* @__PURE__ */ r(Pi, { asChild: !0, children: /* @__PURE__ */ d(V, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(fs, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Me = rt.Root, Mw = rt.Group, Ie = rt.Value, Iw = re(
  ...
  return /* @__PURE__ */ d(
    rt.Trigger,
    {
      className: f(Iw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
Ow.displayName = rt.Label.displayName;
const xt = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  rt.Item,
  {
    ref: o,
    className: f(
...
function Bw({
  ...
  var L;
  const [p, m] = M([]), [h, u] = M([]), [g, y] = M({}), [v, N] = M({}), k = z(() => e ?? [], [e]), T = So({
    data: k,
    columns: t,
    getCoreRowModel: Mo(),
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((_, R) => `skeleton-row-${R}`).map((_) => /* @__PURE__ */ r(jt, { children: /* @__PURE__ */ r(ge, { colSpan: P.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ir, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((L = T.getRowModel().rows) == null ? void 0 : L.length) > 0 ? $ = T.getRowModel().rows.map((x) => /* @__PURE__ */ r(
    jt,
    {
      onClick: () => i(x, T),
    ...
    x.id
  )) : $ = /* @__PURE__ */ r(jt, { children: /* @__PURE__ */ r(ge, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Dw, { table: T }),
    /* @__PURE__ */ d(Sn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Dn, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ r(jt, { children: x.headers.map((E) => /* @__PURE__ */ r(Qe, { children: E.isPlaceholder ? void 0 : Ue(E.column.columnDef.header, E.getContext()) }, E.id)) }, x.id)) }),
...
function ap({
  ...
  return /* @__PURE__ */ d(oe, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ d(Yt, { id: s, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function sp({ id: t, label: e, groups: n }) {
  const [o, a] = M(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ye, { children: [
    /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ d(V, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(se, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(ba, { children: w.itemType === 0 ? /* @__PURE__ */ r(lt, { children: w.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Ft,
        {
          checked: o[p][h],
        ...
        Tw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(ya, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ve, {})
    ] }, w.label)) })
...
function lp({
  ...
  const i = z(() => Us(n), [n]), c = ((w) => {
    const p = new Intl.DisplayNames(qs(), { type: "language" });
...
function Hw({
  ...
  const [N, k] = M(!1), T = B(
    (R) => {
      var A;
      const C = (A = t.find((G) => G.label === R)) == null ? void 0 : A.value;
      C && n(
    ...
    if (!h) return t;
    const R = t.filter((A) => A.starred).sort((A, G) => A.label.localeCompare(G.label)), C = t.filter((A) => !A.starred).sort((A, G) => {
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(oe, { open: E, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ d(
      V,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(qt, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ r(V, { variant: "ghost", size: "sm", onClick: x, children: i })
      ] }),
      /* @__PURE__ */ d(Ht, { children: [
        /* @__PURE__ */ r(rn, { children: l }),
        /* @__PURE__ */ r(Kt, { children: $.map((R) => /* @__PURE__ */ d(
          Pt,
          {
            value: R.label,
            onSelect: T,
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ r(_s, { className: "tw-h-4 tw-w-4" }),
...
const Yw = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(lt, { children: [
...
function Xw({
  ...
  const s = W(null), i = W(null), l = W(!1), [c, w] = M(t), [p, m] = M(n), [h, u] = M(!1);
  H(() => {
    w(t);
  }, [t]), H(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var N, k, T, P;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = s.current) == null || N.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((k = i.current) == null || k.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((T = s.current) == null ? void 0 : T.selectionStart) === 0 && ((P = i.current) == null || P.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(ye, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Yw(t, a, n) }) }) }),
...
const Ww = (t, e) => t === "f" ? /* @__PURE__ */ d(lt, { children: [
  /* @__PURE__ */ r(fo, {}),
  " ",
...
function Zw({
  ...
  return /* @__PURE__ */ d(ye, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ri, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Ww(t, n) }) }) }),
      /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: Jw(t, n) }) })
    ] }) }),
...
function cp({
  ...
  const c = W(null), w = os(), [p, m] = M("generated"), [h, u] = M("*"), [g, y] = M("f"), [v, N] = M(!1), k = z(
    () => ({
      ...i,
  ...
  H(() => {
    ...
    if (E && cn("note", E)) {
      ...
      let A = "custom";
      C === Jn ? A = "generated" : C === Zn ? A = "hidden" : C && u(C), m(A), y(((R = E.insert.note) == null ? void 0 : R.style) ?? "f"), x = setTimeout(() => {
        var G;
        (G = c.current) == null || G.applyUpdate([E]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const T = B(() => {
    var E, _;
    const x = (_ = (E = c.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    x && cn("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = h : x.insert.note.caller = p === "generated" ? Jn : Zn), n([x]));
  }, [p, h, n]), P = () => {
    var E;
    ...
    var _, R, C, A, G;
    y(x);
    const E = (R = (_ = c.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : R.at(0);
    if (E && cn("note", E)) {
      E.insert.note && (E.insert.note.style = x);
      const O = (A = (C = E.insert.note) == null ? void 0 : C.contents) == null ? void 0 : A.ops;
      g !== "x" && x === "x" ? O == null || O.forEach((U) => Qw(U)) : g === "x" && x !== "x" && (O == null || O.forEach((U) => tc(U))), (G = c.current) == null || G.applyUpdate([E, { delete: 1 }]);
    }
  }, L = (x) => {
    var _, R, C, A, G;
    const E = (R = (_ = c.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : R.at(0);
    if (E && cn("note", E)) {
      x.content.length > 1 && setTimeout(() => {
        var D;
        (D = c.current) == null || D.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
          /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Oe, {}) }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
            /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: P, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(po, {}) }) }),
  ...
  return /* @__PURE__ */ d(lt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: nc(t.marker, l, o, w) })
      }
    )
  ] });
}
  ...
  const p = c ?? Hs(n, void 0), m = (k, T) => {
    ...
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), w == null || w(T, P, a);
          break;
      }
  }, v = (k) => {
    if (n.length)
        ...
        "ul",
        {
          ...
          children: n.map((k, T) => {
            ...
            return /* @__PURE__ */ d(lt, { children: [
              ...
              T < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(De, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function sc({
  ...
  return /* @__PURE__ */ d(Sn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Dn, { stickyHeader: !0, children: /* @__PURE__ */ d(jt, { children: [
      /* @__PURE__ */ r(Qe, { children: a }),
      /* @__PURE__ */ r(Qe, { children: s })
    ] }) }),
    /* @__PURE__ */ r(Mn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      jt,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ r(ge, { className: o, children: ac(l.text) })
        ]
      },
...
Rr.displayName = Qn.Root.displayName;
const In = (t) => t === "asc" ? /* @__PURE__ */ r(Rs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Ss, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ds, { className: "tw-ms-2 tw-h-4 tw-w-4" }), up = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d(_r, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Ye,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, lc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", vp = Object.freeze([
...
function xp({
  ...
  const u = It(n, "%webView_inventory_all%"), g = It(n, "%webView_inventory_approved%"), y = It(n, "%webView_inventory_unapproved%"), v = It(n, "%webView_inventory_unknown%"), N = It(n, "%webView_inventory_scope_currentBook%"), k = It(n, "%webView_inventory_scope_chapter%"), T = It(n, "%webView_inventory_scope_verse%"), P = It(n, "%webView_inventory_filter_text%"), $ = It(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = It(n, "%webView_inventory_no_results%"), [x, E] = M(!1), [_, R] = M("all"), [C, A] = M(""), [G, O] = M([]), U = z(() => {
    const j = t ?? [];
    return j.length === 0 ? [] : cc(j, a, s);
  }, [t, a, s]), D = z(() => {
    if (x) return U;
    const j = [];
    return U.forEach((it) => {
      const ut = it.items[0], dt = j.find(
        (gt) => gt.items[0] === ut
      );
      dt ? (dt.count += it.count, dt.occurrences = dt.occurrences.concat(it.occurrences)) : j.push({
        items: [ut],
        count: it.count,
  ...
  }, [x, U]), F = z(() => D.length === 0 ? [] : wc(D, _, C), [D, _, C]), st = z(() => {
    var ut, dt;
    if (!x) return c;
    ...
    for (let gt = 0; gt < j; gt++)
      it.push(
        ic(
          ((dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt[gt]) || "Additional Item",
          gt + 1
        )
      );
    return [...it, ...c];
  }, [o == null ? void 0 : o.tableHeaders, c, x]);
  H(() => {
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(Me, { onValueChange: (j) => Lt(j), defaultValue: i, children: [
        ...
        /* @__PURE__ */ d(xe, { children: [
          ...
          /* @__PURE__ */ r(xt, { value: "verse", children: T })
        ] })
      ] }),
      /* @__PURE__ */ r(
        je,
...
function Np({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = M(""), a = z(() => {
  ...
  return /* @__PURE__ */ d(qt, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ d(Ht, { children: [
      ...
      /* @__PURE__ */ r(Kt, { children: a.map((s) => /* @__PURE__ */ d(
        Pt,
        {
...
const Ea = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), m = e ?? w, h = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => h((T) => !T), [h]), g = m ? "expanded" : "collapsed", N = ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", k = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ca.Provider, { value: k, children: /* @__PURE__ */ r(Ct, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ta = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = On();
...
const uc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = On();
  return /* @__PURE__ */ d(
    V,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Ms, {}) : /* @__PURE__ */ r(Is, {}),
...
const vc = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ae : "button",
  {
    ref: o,
...
const xc = re(
  ...
  ({
    ...
    const c = t ? Ae : "button", { state: w } = On(), p = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: f(xc({ variant: n, size: o }), s),
        ...i
      }
    );
...
const yc = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ae : "button",
  {
    ref: a,
...
const Ec = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ae : "a",
  {
    ref: s,
    ...
    Ta,
    {
      ...
      children: /* @__PURE__ */ d(Sa, { children: [
        /* @__PURE__ */ d(lr, { children: [
          ...
          /* @__PURE__ */ r(cr, { children: /* @__PURE__ */ r(Da, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Ma, { children: /* @__PURE__ */ r(
            Ia,
            {
              onClick: () => w(h),
              isActive: m(h),
...
const Zt = "scrBook", Rc = "scrRef", pe = "source", Sc = "details", Dc = "Scripture Reference", Mc = "Scripture Book", Oa = "Type", Ic = "Details";
function Oc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Zt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Dc,
      cell: (o) => {
    ...
    },
    {
      ...
      id: pe,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Oa : void 0,
    ...
    },
    {
      ...
      id: Sc,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Ic,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, oo = (t) => `${Ac({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function _p({
  sources: t,
  ...
  H(() => {
    if (l) {
      const _ = N.getSelectedRowModel().rowsById, R = Object.keys(_);
      if (R.length === 1) {
        const C = y.find((A) => oo(A) === R[0]) || void 0;
        C && l(C);
      }
    }
  }, [u, y, l, N]);
  const k = a ?? Mc, T = s ?? Oa, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [Zt] },
    { label: `Group by ${T}`, value: [pe] },
    {
  ...
  }, x = (_, R) => _.getIsGrouped() ? "" : f("banded-row", R % 2 === 0 ? "even" : "odd"), E = (_, R, C) => {
    if (!((_ == null ? void 0 : _.length) === 0 || R.depth < C.column.getGroupedIndex())) {
      if (R.getIsGrouped())
        switch (R.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      Me,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(xe, { position: "item-aligned", children: /* @__PURE__ */ r(Mw, { children: P.map((_) => /* @__PURE__ */ r(xt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Sn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Dn, { children: N.getHeaderGroups().map((_) => /* @__PURE__ */ r(jt, { children: _.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Qe, { colSpan: R.colSpan, className: "top-0 tw-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Ue(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, _.id)) }),
      /* @__PURE__ */ r(Mn, { children: N.getRowModel().rows.map((_, R) => {
        const C = ct();
        return /* @__PURE__ */ r(
          jt,
          {
...
}), Aa = (t, e, n) => Dr(t, e).every((o) => n.includes(o));
function Pc({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Dr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    V,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        Aa(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Wi(
        t,
...
function $c({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, N] = M(!1), [k, T] = M(""), P = W(void 0), $ = W(!1);
  if (t.length !== at.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const L = z(() => at.allBookIds.filter(
    ...
    (O, U = !1) => {
      ...
      const D = L.findIndex((pt) => pt === P.current), F = L.findIndex((pt) => pt === O);
      if (D === -1 || F === -1) return;
      const [st, ht] = [
        Math.min(D, F),
        Math.max(D, F)
      ], Lt = L.slice(st, ht + 1).map((pt) => pt);
      n(
        e.includes(O) ? e.filter((pt) => !Lt.includes(pt)) : [.../* @__PURE__ */ new Set([...e, ...Lt])]
      );
    },
    [e, n, L]
  ), _ = (O) => {
    ...
    (O) => {
      const U = Dr(L, O).map((D) => D);
      n(
        Aa(L, O, e) ? e.filter((D) => !U.includes(D)) : [.../* @__PURE__ */ new Set([...e, ...U])]
      );
    },
    [e, n, L]
  ), A = () => {
    ...
    /* @__PURE__ */ d(
      oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Yt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
            qt,
            {
              shouldFilter: !1,
              onKeyDown: (O) => {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(V, { variant: "ghost", size: "sm", onClick: A, children: c }),
                  /* @__PURE__ */ r(V, { variant: "ghost", size: "sm", onClick: G, children: w })
                ] }),
                /* @__PURE__ */ d(Ht, { children: [
                  ...
                  Object.values(q).map((O, U) => {
                    ...
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(so, { children: [
                        ...
                        U < Object.values(q).length - 1 && /* @__PURE__ */ r($o, {})
                      ] }, O);
                  })
                ] })
              ]
...
function Ep({
  ...
  const w = ce(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = ce(i, "%webView_scope_selector_current_book%"), u = ce(i, "%webView_scope_selector_choose_books%"), g = ce(i, "%webView_scope_selector_scope%"), y = ce(i, "%webView_scope_selector_select_books%"), v = [
      ...
      /* @__PURE__ */ r(
        br,
        {
          ...
          children: N.map(({ value: k, label: T, id: P }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(wt, { htmlFor: P, children: T })
          ] }, P))
        }
      )
    ] }),
...
const $a = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(zt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    yn,
    {
      onClick: () => {
        o(l);
...
function dr({
  ...
  return /* @__PURE__ */ d(ye, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(V, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(As, {}) }) }),
    /* @__PURE__ */ r(se, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(so, { children: [
      /* @__PURE__ */ r(ba, { children: /* @__PURE__ */ r(Ct, { children: $a(e.groups, e.items, c, t) }) }),
...
const Lc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Trigger,
  {
    ref: n,
    ...e,
...
za.displayName = vt.Content.displayName;
function Op({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Va, { children: [
      /* @__PURE__ */ r(ja, { children: t.map((l) => /* @__PURE__ */ r(Lc, { value: l.value, children: l.value }, l.key)) }),
...
Fa.displayName = tt.Root.displayName;
...
Ba.displayName = tt.Trigger.displayName;
...
Ga.displayName = tt.SubTrigger.displayName;
...
Ka.displayName = tt.SubContent.displayName;
const Ua = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Dt();
...
Ua.displayName = tt.Content.displayName;
...
qa.displayName = tt.Item.displayName;
const zc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Dt();
  return /* @__PURE__ */ d(
    tt.CheckboxItem,
    {
...
const Fc = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Dt();
  return /* @__PURE__ */ d(
    tt.RadioItem,
    {
...
Fc.displayName = tt.RadioItem.displayName;
const Bc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  tt.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Bc.displayName = tt.Label.displayName;
const Ha = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.Separator,
  {
    ref: n,
...
Ha.displayName = tt.Separator.displayName;
const Be = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(zt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        qa,
        {
          onClick: () => {
            o(w);
  ...
  if (Gi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (N = c.current) == null || N.focus(), Be(c, [h, u]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ r(Fa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(Vc, { children: [
      /* @__PURE__ */ r(Ba, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        Ua,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Ct, { children: Ya(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function $p({
  ...
  const w = Kc(
    ...
    var N, k, T, P, $, L;
    const v = y !== g ? ((k = (N = t[g]) == null ? void 0 : N.uiNames) == null ? void 0 : k[y]) ?? ((P = (T = t[g]) == null ? void 0 : T.uiNames) == null ? void 0 : P.en) : void 0;
...
function Uc({ item: t, createLabel: e, createComplexLabel: n }) {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ye, { children: [
              /* @__PURE__ */ r(Le, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(V, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(co, {}) }) }),
              /* @__PURE__ */ r(se, { align: "end", children: l })
            ] })
          ] }),
...
const qc = tn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ls, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
), Yc = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Xc.displayName = "AlertTitle";
const Wc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Wc.displayName = "AlertDescription";
const zp = et.Root, Fp = et.Trigger, Bp = et.Group, Gp = et.Portal, Kp = et.Sub, Up = et.RadioGroup, Jc = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  et.SubTrigger,
  {
    ref: a,
    className: f(
...
Jc.displayName = et.SubTrigger.displayName;
...
Zc.displayName = et.SubContent.displayName;
const Qc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(et.Portal, { children: /* @__PURE__ */ r(
  et.Content,
  {
    ref: n,
    className: f(
...
Qc.displayName = et.Content.displayName;
...
td.displayName = et.Item.displayName;
const ed = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  et.CheckboxItem,
  {
    ref: a,
    className: f(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(et.ItemIndicator, { children: /* @__PURE__ */ r(Rt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
ed.displayName = et.CheckboxItem.displayName;
const nd = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  et.RadioItem,
  {
    ref: o,
    className: f(
...
nd.displayName = et.RadioItem.displayName;
...
rd.displayName = et.Label.displayName;
...
od.displayName = et.Separator.displayName;
...
sd.displayName = "Drawer";
const qp = St.Trigger, id = St.Portal, Hp = St.Close, Wa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Overlay,
  {
    ref: n,
...
const ld = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
dd.displayName = St.Title.displayName;
...
pd.displayName = St.Description.displayName;
const ud = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  tr.Root,
  {
    ref: o,
    className: f(
...
ud.displayName = tr.Root.displayName;
function Yp({
  className: t,
  ...e
}) {
...
md.displayName = Ge.Root.displayName;
const fd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ct();
  return /* @__PURE__ */ r(
    er.Root,
    {
...
fd.displayName = er.Root.displayName;
const Zp = vt.Root, hd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ct();
  return /* @__PURE__ */ r(
    vt.List,
    {
...
hd.displayName = vt.List.displayName;
...
gd.displayName = vt.Trigger.displayName;
...
bd.displayName = vt.Content.displayName;
...
Nd(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  _w as AvatarImage,
  Wd as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  Jd as BOOK_SELECTOR_STRING_KEYS,
  Se as Badge,
  ...
  np as CommentList,
  zp as ContextMenu,
  ed as ContextMenuCheckboxItem,
  Qc as ContextMenuContent,
  Bp as ContextMenuGroup,
  td as ContextMenuItem,
  rd as ContextMenuLabel,
  Gp as ContextMenuPortal,
  Up as ContextMenuRadioGroup,
  nd as ContextMenuRadioItem,
  od as ContextMenuSeparator,
  ad as ContextMenuShortcut,
  Kp as ContextMenuSub,
  Zc as ContextMenuSubContent,
  Jc as ContextMenuSubTrigger,
  Fp as ContextMenuTrigger,
  Bw as DataTable,
  sd as Drawer,
  Hp as DrawerClose,
  ld as DrawerContent,
  pd as DrawerDescription,
  cd as DrawerFooter,
  wd as DrawerHeader,
  Wa as DrawerOverlay,
  id as DrawerPortal,
  ...
  Ap as getToolbarOSReservedSpaceClassName,
