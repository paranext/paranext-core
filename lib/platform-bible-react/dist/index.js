...
import Nt, { forwardRef as ts, useState as Ve, useRef as Nn, useCallback as $e, useMemo as Bt, useEffect as Vn } from "react";
...
const Xs = w.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ de(
  ge.CheckboxItem,
  {
    ref: o,
    className: Qe(
...
const Js = ts(
  ({ handleSearch: e, handleKeyDown: t, ...n }, r) => /* @__PURE__ */ de("div", { className: "input-container", children: [
    /* @__PURE__ */ T(
      Ii,
      {
        ...n,
...
function gh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = me, [r, o] = Ve(""), [i, s] = Ve(""), [l, c] = Ve(!1), u = Nn(void 0), d = $e(
    (S) => ({
      OT: n.filter((x) => me.isBookOT(x)),
      NT: n.filter((x) => me.isBookNT(x)),
      DC: n.filter((x) => me.isBookDC(x))
    })[S],
    [n]
  ), f = $e(
    (S) => d(S).filter(
      (y) => me.bookIdToEnglishName(y).toLowerCase().includes(r.toLowerCase()) || y.toLowerCase().includes(r.toLowerCase())
    ),
    [d, r]
  ), p = (S) => {
    o(S);
  }, b = $e((S) => yi(me.bookIdToNumber(S)), []), v = (S) => {
    s(i !== S ? S : ""), b(S) === -1 && t({
  ...
  return /* @__PURE__ */ T("div", { children: /* @__PURE__ */ de(Ws, { modal: !1, open: l, onOpenChange: h, children: [
    ...
    /* @__PURE__ */ T(Ni, { className: "menu-content", onKeyDown: E, children: tl.map((S) => /* @__PURE__ */ de("div", { children: [
      /* @__PURE__ */ T(Mi, { className: "menu-label", children: el[S] }),
        ...
        Qs,
        {
          ...
          children: /* @__PURE__ */ T(
            Zs,
            {
              ...
              endChapter: b(y),
              activeChapter: e.bookNum === me.bookIdToNumber(y) ? e.chapterNum : 0
            }
          )
        }
      ) }, y)),
...
function il() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === r || m === u || m === i || m === o || m === f || m === p || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === b || m.$$typeof === s || m.$$typeof === l || m.$$typeof === d || m.$$typeof === h || m.$$typeof === E || m.$$typeof === S || m.$$typeof === g);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function al() {
  return Oo || (Oo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y($) {
      ...
      $ === r || $ === u || $ === i || $ === o || $ === f || $ === p || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === b || $.$$typeof === s || $.$$typeof === l || $.$$typeof === d || $.$$typeof === h || $.$$typeof === E || $.$$typeof === S || $.$$typeof === g);
    }
    function x($) {
    ...
    var m = c, C = u, P = l, A = s, I = t, D = d, B = r, z = v, G = b, L = n, _ = i, N = o, j = f, Q = !1;
    function Z($) {
      return Q || (Q = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), O($) || x($) === c;
    }
    function O($) {
      return x($) === u;
    }
...
function xl() {
  return Io || (Io = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, g = !1, h = !1, E = !1, S = !1, y;
    y = Symbol.for("react.module.reference");
    function x(R) {
      return !!(typeof R == "string" || typeof R == "function" || R === n || R === o || S || R === r || R === u || R === d || E || R === b || v || g || h || typeof R == "object" && R !== null && (R.$$typeof === p || R.$$typeof === f || R.$$typeof === i || R.$$typeof === s || R.$$typeof === c || // This needs to include all possible module reference object
    ...
    var C = s, P = i, A = e, I = c, D = n, B = p, z = f, G = t, L = o, _ = r, N = u, j = d, Q = !1, Z = !1;
    function O(R) {
    ...
    le.ContextConsumer = C, le.ContextProvider = P, le.Element = A, le.ForwardRef = I, le.Fragment = D, le.Lazy = B, le.Memo = z, le.Portal = G, le.Profiler = L, le.StrictMode = _, le.Suspense = N, le.SuspenseList = j, le.isAsyncMode = O, le.isConcurrentMode = M, le.isContextConsumer = V, le.isContextProvider = K, le.isElement = F, le.isForwardRef = U, le.isFragment = W, le.isLazy = q, le.isMemo = H, le.isPortal = X, le.isProfiler = Y, le.isStrictMode = ne, le.isSuspense = $, le.isSuspenseList = J, le.isValidElementType = x, le.typeOf = m;
  }()), le;
}
...
}, Kl = /* @__PURE__ */ w.createContext(Gl);
function Xl(e) {
  const {
...
function _n(e) {
  const {
    ...
    isEnabled: s = sc,
    open: l
  } = e, c = w.useRef(!1), u = w.useRef(null), d = w.useRef(null), f = w.useRef(null), p = w.useRef(null), b = w.useRef(!1), v = w.useRef(null), g = je(t.ref, v), h = w.useRef(null);
  w.useEffect(() => {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    const y = we(v.current), x = (P) => {
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (A = i(v.current)), A.length > 0) {
        var I, D;
        const B = !!((I = h.current) != null && I.shiftKey && ((D = h.current) == null ? void 0 : D.key) === "Tab"), z = A[0], G = A[A.length - 1];
    ...
    return () => {
      clearInterval(C), y.removeEventListener("focusin", m), y.removeEventListener("keydown", x, !0);
    };
  }, [n, r, o, s, l, i]);
  const E = (y) => {
...
const an = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    ...
    container: o,
    disablePortal: i = !1
  } = t, [s, l] = w.useState(null), c = je(/* @__PURE__ */ w.isValidElement(r) ? r.ref : null, n);
  if (mt(() => {
...
function bc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), b = w.useRef(null), v = w.useRef(null), g = je(v, f), [h, E] = w.useState(!d), S = mc(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const x = () => we(b.current), m = () => (p.current.modalRef = v.current, p.current.mount = b.current, p.current), C = () => {
    o.mount(m(), {
      disableScrollLock: r
    }), v.current && (v.current.scrollTop = 0);
  }, P = on(() => {
    const N = hc(t) || x().body;
    o.add(m(), N), v.current && C();
  }), A = w.useCallback(() => o.isTopModal(m()), [o]), I = on((N) => {
...
var Se = "top", Be = "bottom", Le = "right", Ce = "left", Br = "auto", pn = [Se, Be, Le, Ce], It = "start", sn = "end", vc = "clippingParents", ra = "viewport", Gt = "popper", yc = "reference", Uo = /* @__PURE__ */ pn.reduce(function(e, t) {
...
function Nc(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !De(i) || !He(i) || (Object.assign(i.style, r), Object.keys(o).forEach(function(s) {
      var l = o[s];
...
function $c(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !De(o) || !He(o) || (Object.assign(o.style, l), Object.keys(i).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
function Ic(e) {
  ...
  var o = Un(e);
  for (Lr(o) && (o = o.host); De(o) && ["html", "body"].indexOf(He(o)) < 0; ) {
    var i = Je(o);
...
function fn(e) {
  for (var t = _e(e), n = Ho(e); n && _c(n) && Je(n).position === "static"; )
    n = Ho(n);
  return n && (He(n) === "html" || He(n) === "body" && Je(n).position === "static") ? t : n || Ic(e) || t;
}
function Vr(e) {
...
function jc(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = ze(n.placement), c = Vr(l), u = [Ce, Le].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = Dc(o.padding, n), p = Fr(i), b = c === "y" ? Se : Ce, v = c === "y" ? Be : Le, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], h = s[c] - n.rects.reference[c], E = fn(i), S = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - h / 2, x = f[b], m = S - p[d] - f[v], C = S / 2 - p[d] / 2 + y, P = tn(x, C, m), A = c;
...
function Wo(e) {
  ...
  b = h.x, g = h.y;
  var E = s.hasOwnProperty("x"), S = s.hasOwnProperty("y"), y = Ce, x = Se, m = window;
  if (u) {
    var C = fn(n), P = "clientHeight", A = "clientWidth";
    if (C === _e(n) && (C = at(n), Je(C).position !== "static" && l === "absolute" && (P = "scrollHeight", A = "scrollWidth")), C = C, o === Se || (o === Ce || o === Le) && i === sn) {
      x = Be;
      var I = f && C === m && m.visualViewport ? m.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        C[P]
      );
      g -= I - r.height, g *= c ? 1 : -1;
    }
    if (o === Ce || (o === Se || o === Be) && i === sn) {
      y = Le;
      var D = f && C === m && m.visualViewport ? m.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        C[A]
      );
      b -= D - r.width, b *= c ? 1 : -1;
  ...
  if (b = z.x, g = z.y, c) {
    var G;
    return Object.assign({}, B, (G = {}, G[x] = S ? "0" : "", G[y] = E ? "0" : "", G.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", G));
  }
  return Object.assign({}, B, (t = {}, t[x] = S ? g + "px" : "", t[y] = E ? b + "px" : "", t.transform = "", t));
}
function zc(e) {
...
function ua(e) {
  return ["html", "body", "#document"].indexOf(He(e)) >= 0 ? e.ownerDocument.body : De(e) && Hr(e) ? e : ua(Un(e));
}
function nn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ua(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = _e(r), s = o ? [i].concat(i.visualViewport || [], Hr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function Go(e, t, n) {
  return t === ra ? Cr(Kc(e, n)) : bt(t) ? Yc(t, n) : Cr(Xc(at(e)));
}
function Jc(e) {
  var t = nn(Un(e)), n = ["absolute", "fixed"].indexOf(Je(e).position) >= 0, r = n && De(e) ? fn(e) : e;
  return bt(r) ? t.filter(function(o) {
    return bt(o) && aa(o, r) && He(o) !== "body";
  }) : [];
}
function Zc(e, t, n, r) {
...
function da(e) {
  var t = e.reference, n = e.element, r = e.placement, o = r ? ze(r) : null, i = r ? jt(r) : null, s = t.x + t.width / 2 - n.width / 2, l = t.y + t.height / 2 - n.height / 2, c;
  switch (o) {
    case Se:
      c = {
        x: s,
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? vc : l, u = n.rootBoundary, d = u === void 0 ? ra : u, f = n.elementContext, p = f === void 0 ? Gt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, h = g === void 0 ? 0 : g, E = la(typeof h != "number" ? h : ca(h, pn)), S = p === Gt ? yc : Gt, y = e.rects.popper, x = e.elements[v ? S : p], m = Zc(bt(x) ? x : x.contextElement || at(e.elements.popper), c, d, s), C = Dt(e.elements.reference), P = da({
    reference: C,
    element: y,
    strategy: "absolute",
    placement: o
  }), A = Cr(Object.assign({}, y, P)), I = p === Gt ? A : C, D = {
    top: m.top - I.top + E.top,
    bottom: I.bottom - m.bottom + E.bottom,
    left: m.left - I.left + E.left,
    right: I.right - m.right + E.right
  }, B = e.modifiersData.offset;
  if (p === Gt && B) {
    var z = B[o];
    Object.keys(D).forEach(function(G) {
      var L = [Le, Be].indexOf(G) >= 0 ? 1 : -1, _ = [Se, Be].indexOf(G) >= 0 ? "y" : "x";
      D[G] += z[_] * L;
    });
  }
  return D;
...
function tu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, h = t.options.placement, E = ze(h), S = E === h, y = c || (S || !v ? [Sn(h)] : eu(h)), x = [h].concat(y).reduce(function(F, U) {
      return F.concat(ze(U) === Br ? Qc(t, {
        placement: U,
        boundary: d,
        rootBoundary: f,
        padding: u,
    ...
    }, []), m = t.rects.reference, C = t.rects.popper, P = /* @__PURE__ */ new Map(), A = !0, I = x[0], D = 0; D < x.length; D++) {
      var B = x[D], z = ze(B), G = jt(B) === It, L = [Se, Be].indexOf(z) >= 0, _ = L ? "width" : "height", N = ln(t, {
        placement: B,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function Xo(e) {
  return [Se, Le, Be, Ce].some(function(t) {
    return e[t] >= 0;
  });
}
function ru(e) {
...
function iu(e, t, n) {
  var r = ze(e), o = [Ce, Se].indexOf(r) >= 0 ? -1 : 1, i = typeof n == "function" ? n(Object.assign({}, t, {
    placement: e
  })) : n, s = i[0], l = i[1];
...
function du(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, h = ln(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), E = ze(t.placement), S = jt(t.placement), y = !S, x = Vr(E), m = uu(x), C = t.modifiersData.popperOffsets, P = t.rects.reference, A = t.rects.popper, I = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, D = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (C) {
    if (i) {
      var G, L = x === "y" ? Se : Ce, _ = x === "y" ? Be : Le, N = x === "y" ? "height" : "width", j = C[x], Q = j + h[L], Z = j - h[_], O = b ? -A[N] / 2 : 0, M = S === It ? P[N] : A[N], V = S === It ? -A[N] : -P[N], K = t.elements.arrow, F = b && K ? Fr(K) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : sa(), W = U[L], q = U[_], H = tn(0, P[N], F[N]), X = y ? P[N] / 2 - O - H - W - D.mainAxis : M - H - W - D.mainAxis, Y = y ? -P[N] / 2 + O + H + q + D.mainAxis : V + H + q + D.mainAxis, ne = t.elements.arrow && fn(t.elements.arrow), $ = ne ? x === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[x]) != null ? G : 0, R = j + X - J - $, re = j + Y - J, ve = tn(b ? In(Q, R) : Q, j, b ? ft(Z, re) : Z);
      C[x] = ve, z[x] = ve - j;
    }
    if (l) {
      var Te, he = x === "x" ? Se : Ce, lt = x === "x" ? Be : Le, ke = C[m], qe = m === "y" ? "height" : "width", Pe = ke + h[he], Ge = ke - h[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[m]) != null ? Te : 0, ct = ye ? Pe : ke - P[qe] - A[qe] - yt + D.altAxis, Vt = ye ? ke + P[qe] + A[qe] - yt - D.altAxis : Ge, bn = b && ye ? Ac(ct, ke, Vt) : tn(b ? ct : Pe, ke, b ? Vt : Ge);
      C[m] = bn, z[m] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
function gu(e, t, n) {
  n === void 0 && (n = !1);
  var r = De(t), o = De(t) && mu(t), i = at(t), s = Dt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Hr(i)) && (l = hu(t)), De(t) ? (c = Dt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Ur(i))), {
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      forceUpdate: function() {
        if (!p) {
          ...
          if (Jo(S, y)) {
            d.rects = {
              reference: gu(S, fn(y), d.options.strategy === "fixed"),
              popper: Fr(y)
            ...
            for (var x = 0; x < d.orderedModifiers.length; x++) {
              ...
              var m = d.orderedModifiers[x], C = m.fn, P = m.options, A = P === void 0 ? {} : P, I = m.name;
    ...
    function v() {
      d.orderedModifiers.forEach(function(h) {
        var E = h.name, S = h.options, y = S === void 0 ? {} : S, x = h.effect;
...
const Ru = () => et({
  root: ["root"]
}, Xl(ku)), Nu = {}, $u = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, h = ce(t, Ou), E = w.useRef(null), S = je(E, n), y = w.useRef(null), x = je(y, p), m = w.useRef(x);
  mt(() => {
    m.current = x;
  }, [x]), w.useImperativeHandle(p, () => y.current, []);
  const C = Cu(d, s), [P, A] = w.useState(C), [I, D] = w.useState(An(o));
  w.useEffect(() => {
...
`));
  ...
  const z = Ru(), G = (r = v.root) != null ? r : "div", L = gt({
    elementType: G,
  ...
  const {
    ...
    slotProps: h = {},
    slots: E = {}
  } = t, S = ce(t, Su), [y, x] = w.useState(!0), m = () => {
    x(!1);
  }, C = () => {
    x(!0);
  };
  ...
  if (i)
    ...
    const D = An(r);
    P = D && Hn(D) ? we(D).body : we(null).body;
  }
...
function be(e) {
  const {
    ...
    return Ze(s, l, (f) => {
      let p = Dn(u, o, f);
      return f === p && typeof f == "string" && (p = Dn(u, o, `${t}${f === "default" ? "" : Ue(f)}`, f)), n === !1 ? p : {
        [n]: p
      };
    });
  };
...
const Ku = Fe("border", Ae), Xu = Fe("borderTop", Ae), Yu = Fe("borderRight", Ae), Ju = Fe("borderBottom", Ae), Zu = Fe("borderLeft", Ae), Qu = Fe("borderColor"), ed = Fe("borderTopColor"), td = Fe("borderRightColor"), nd = Fe("borderBottomColor"), rd = Fe("borderLeftColor"), od = Fe("outline", Ae), id = Fe("outlineColor"), Xn = (e) => {
...
Kn(Ku, Xu, Yu, Ju, Zu, Qu, ed, td, nd, rd, Xn, od, id);
const Yn = (e) => {
...
Kn(Yn, Jn, Zn, ad, sd, ld, cd, ud, dd, pd, fd, hd);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const md = be({
...
function Cd() {
  function e(n, r, o, i) {
    ...
    return f ? f(s) : Ze(s, r, (v) => {
      let g = Dn(p, d, v);
      return v === g && typeof v == "string" && (g = Dn(p, d, `${n}${v === "default" ? "" : Ue(v)}`, v)), c === !1 ? g : {
        [c]: g
      };
    });
  }
...
function Xr(e = {}, ...t) {
  ...
  return u.applyStyles = Pd, u = t.reduce((d, f) => Xe(d, f), u), u.unstable_sxConfig = k({}, Gr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Kr({
      sx: f,
      theme: this
    });
...
const jd = Xr(), ei = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Tn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Ld(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    Rs(s, (m) => m.filter((C) => !(C != null && C.__mui_systemSx)));
    const {
      name: c,
      slot: u,
    ...
    const S = Cs(s, k({
      shouldForwardProp: E,
      label: h
    }, b)), y = (m) => typeof m == "function" && m.__emotion_real !== m || pt(m) ? (C) => Pn(m, k({}, C, {
      theme: Tn({
        theme: C.theme,
        defaultTheme: n,
        themeId: t
      ...
      c && p && A.push((B) => {
        ...
        return Object.entries(G).forEach(([_, N]) => {
          L[_] = Pn(N, k({}, B, {
            theme: z
          }));
        }), p(B, L);
      ...
      if (process.env.NODE_ENV !== "production") {
        let B;
        c && (B = `${c}${Ue(u || "")}`), B === void 0 && (B = `Styled(${Tl(s)})`), D.displayName = B;
      }
...
function cp(e) {
  ...
  function f(g) {
    const h = ni(g, fr.text.primary) >= n ? fr.text.primary : ri.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = ni(g, h);
...
The color object needs to have a \`main\` property or a \`${E}\` property.` : Mt(11, h ? ` (${h})` : "", E));
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return oi(g, "light", S, r), oi(g, "dark", y, r), g.contrastText || (g.contrastText = f(g.main)), g;
  }, b = {
    dark: fr,
    light: ri
  };
...
function pp(e, t) {
  ...
  const b = o / 14, v = f || ((E) => `${E / u * b}rem`), g = (E, S, y, x, m) => k({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(S),
...
const _p = {
  ...
  const {
    ...
    TransitionComponent: h = wa
  } = t, E = ce(t, Mp), S = Jt(), y = w.useRef(), x = gn(), m = w.useRef(null), C = je(m, i.ref, n), P = (_) => (N) => {
    if (_) {
      const j = m.current;
      N === void 0 ? _(j) : _(j, N);
    }
    ...
    let Z;
    g === "auto" ? (Z = x.transitions.getAutoHeightDuration(_.clientHeight), y.current = Z) : Z = N, _.style.transition = [x.transitions.create("opacity", {
      duration: Z,
      delay: j
    }), x.transitions.create("transform", {
  ...
  return /* @__PURE__ */ T(h, k({
    ...
    onExiting: B,
    addEndListener: (_) => {
      g === "auto" && S.start(y.current || 0, _), r && r(m.current, _);
    },
    timeout: g === "auto" ? null : g
  }, E, {
    children: (_, N) => /* @__PURE__ */ w.cloneElement(i, k({
      style: k({
        opacity: 0,
        transform: Nr(0.75),
        visibility: _ === "exited" && !l ? "hidden" : void 0
      }, _p[_], v, i.props.style),
      ref: C
    }, N))
  }));
});
...
const $r = Qr, Ip = (e) => {
  ...
  const o = ba(), i = tt({
    ...
    slots: y,
    slotProps: x
  } = i, m = ce(i, Ap), C = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, P = k({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Oa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, b, v, g, h, E, S, y, x, m;
  const C = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: J
  } = C, R = ce(C, Lp), re = /* @__PURE__ */ w.isValidElement(A) ? A : /* @__PURE__ */ T("span", {
    children: A
  }), ve = gn(), Te = ve.direction === "rtl", [he, lt] = w.useState(), [ke, qe] = w.useState(null), Pe = w.useRef(!1), Ge = L || Z, ye = Jt(), yt = Jt(), ct = Jt(), Vt = Jt(), [bn, ro] = Hi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const oo = (ee) => {
    ...
    (ee) => {
      ui.start(800 + M, () => {
        kn = !1;
      }), ro(!1), K && Ke && K(ee), ye.start(ve.transitions.duration.shortest, () => {
        Pe.current = !1;
      });
    }
  ), tr = (ee) => {
    Pe.current && ee.type !== "touchstart" || (he && he.removeAttribute("title"), yt.clear(), ct.clear(), N || kn && j ? yt.start(kn ? j : N, () => {
      oo(ee);
    }) : oo(ee));
  }, io = (ee) => {
    yt.clear(), ct.start(M, () => {
  ...
  const Ie = k({}, Ut, R, re.props, {
    className: xe(R.className, re.props.className),
    onTouchStart: uo,
    ref: Ga
  }, Z ? {
    onMouseMove: Ka
  } : {});
  process.env.NODE_ENV !== "production" && (Ie["data-mui-internal-clone-element"] = !0, w.useEffect(() => {
...
`));
  ...
  const Ht = {};
  _ || (Ie.onTouchStart = Wa, Ie.onTouchEnd = qa), G || (Ie.onMouseOver = On(po, Ie.onMouseOver), Ie.onMouseLeave = On(fo, Ie.onMouseLeave), Ge || (Ht.onMouseOver = po, Ht.onMouseLeave = fo)), z || (Ie.onFocus = On(co, Ie.onFocus), Ie.onBlur = On(lo, Ie.onBlur), Ge || (Ht.onFocus = co, Ht.onBlur = lo)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Xa = w.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Pe.current
  }), or = Vp(Wt), ho = (r = (o = Y.popper) != null ? o : I.Popper) != null ? r : zp, mo = (i = (s = (l = Y.transition) != null ? l : I.Transition) != null ? s : $) != null ? i : $r, go = (c = (u = Y.tooltip) != null ? u : I.Tooltip) != null ? c : Up, bo = (d = (f = Y.arrow) != null ? f : I.Arrow) != null ? d : Hp, Ya = Zt(ho, k({}, H, (p = X.popper) != null ? p : D.popper, {
    className: xe(or.popper, H == null ? void 0 : H.className, (b = (v = X.popper) != null ? v : D.popper) == null ? void 0 : b.className)
  }), Wt), Ja = Zt(mo, k({}, J, (g = X.transition) != null ? g : D.transition), Wt), Za = Zt(go, k({}, (h = X.tooltip) != null ? h : D.tooltip, {
    className: xe(or.tooltip, (E = (S = X.tooltip) != null ? S : D.tooltip) == null ? void 0 : E.className)
  }), Wt), Qa = Zt(bo, k({}, (y = X.arrow) != null ? y : D.arrow, {
    className: xe(or.arrow, (x = (m = X.arrow) != null ? m : D.arrow) == null ? void 0 : x.className)
  }), Wt);
  return /* @__PURE__ */ de(w.Fragment, {
    children: [/* @__PURE__ */ w.cloneElement(re, Ie), /* @__PURE__ */ T(ho, k({
      as: q ?? ka,
      placement: W,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ de(go, k({}, Za, {
          children: [ne, P ? /* @__PURE__ */ T(bo, k({}, Qa, {
            ref: qe
          })) : null]
        }))
      }))
...
const Kp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Xp = (e) => {
  ...
  const r = tt({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, b = ce(r, Kp), v = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", g = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function of(e) {
  const [t, n] = Ve(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (u) => {
    n(u.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
...
const Ia = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  } = t, p = ce(t, gf), b = w.useRef(null), v = w.useRef({
    keys: [],
    repeating: !0,
  ...
  mt(() => {
    ...
    adjustStyleForScrollbar: (y, x) => {
      ...
      if (y.clientHeight < b.current.clientHeight && m) {
        const C = `${qi(we(y))}px`;
        b.current.style[x.direction === "rtl" ? "paddingLeft" : "paddingRight"] = C, b.current.style.width = `calc(100% + ${C})`;
      }
      return b.current;
    }
  }), []);
  const g = (y) => {
    const x = b.current, m = y.key, C = we(x).activeElement;
    if (m === "ArrowDown")
      y.preventDefault(), Yt(x, C, u, c, gr);
    else if (m === "ArrowUp")
      y.preventDefault(), Yt(x, C, u, c, hi);
    else if (m === "Home")
      y.preventDefault(), Yt(x, null, u, c, gr);
    else if (m === "End")
      y.preventDefault(), Yt(x, null, u, c, hi);
    else if (m.length === 1) {
      const P = v.current, A = m.toLowerCase(), I = performance.now();
      ...
      const D = C && !P.repeating && _a(C, P);
      P.previousKeyMatched && (D || Yt(x, C, !1, c, gr, P)) ? y.preventDefault() : P.previousKeyMatched = !1;
    }
    d && d(y);
  }, h = je(b, n);
  let E = -1;
...
`)), y.props.disabled || (f === "selectedMenu" && y.props.selected || E === -1) && (E = x), E === x && (y.props.disabled || y.props.muiSkipListHighlight || y.type.muiSkipListHighlight) && (E += 1, E >= s.length && (E = -1));
  ...
  const S = w.Children.map(s, (y, x) => {
    if (x === E) {
      const m = {};
      return i && (m.autoFocus = !0), y.props.tabIndex === void 0 && f === "selectedMenu" && (m.tabIndex = 0), /* @__PURE__ */ w.cloneElement(y, m);
    }
    return y;
  });
...
const bf = Ia, vf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], yf = {
  ...
  const r = gn(), o = {
    ...
    timeout: E = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: S = wa
  } = t, y = ce(t, vf), x = w.useRef(null), m = je(x, l.ref, n), C = (L) => (_) => {
    if (L) {
      const N = x.current;
      _ === void 0 ? L(N) : L(N, _);
    }
    ...
    L.style.webkitTransition = r.transitions.create("opacity", N), L.style.transition = r.transitions.create("opacity", N), d && d(L, _);
  }), I = C(f), D = C(g), B = C((L) => {
    const _ = Bn({
      style: h,
      timeout: E,
...
const Ef = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Tf = (e) => {
  ...
  const s = tt({
    ...
    slotProps: v = {},
    slots: g = {},
    TransitionComponent: h = xf,
    transitionDuration: E
  } = s, S = ce(s, Ef), y = k({}, s, {
    component: u,
    invisible: p
  }), x = Tf(y), m = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ T(h, k({
    in: b,
    timeout: E
  }, S, {
    children: /* @__PURE__ */ T(kf, k({
      ...
      className: xe(x.root, c, m == null ? void 0 : m.className),
...
const Cf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Pf = (e) => {
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : Rf, H = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : E.Backdrop) != null ? i : d, X = (l = G == null ? void 0 : G.root) != null ? l : S.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : S.backdrop, ne = gt({
    elementType: q,
    externalSlotProps: X,
  ...
  return !D && !z && (!K || V) ? null : /* @__PURE__ */ T(an, {
    ...
    children: /* @__PURE__ */ de(q, k({}, ne, {
      children: [!I && d ? /* @__PURE__ */ T(H, k({}, $)) : null, /* @__PURE__ */ T(_n, {
        disableEnforceFocus: x,
        disableAutoFocus: y,
        disableRestoreFocus: P,
        isEnabled: M,
...
const Vf = (e) => {
  ...
  const s = tt({
  ...
  } = s, D = ce(s.TransitionProps, Bf), B = ce(s, Lf), z = (r = x == null ? void 0 : x.paper) != null ? r : S, G = w.useRef(), L = je(G, z.ref), _ = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: h,
    ...
    TransitionProps: D
  }), N = Vf(_), j = w.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = Rn(c), R = J && J.nodeType === 1 ? J : we(G.current).body, re = R.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    vertical: mi(J, m.vertical),
    horizontal: gi(J, m.horizontal)
  }), [m.horizontal, m.vertical]), Z = w.useCallback((J) => {
    const R = {
      width: J.offsetWidth,
    ...
    const lt = Te + R.height, ke = he + R.width, qe = _t(Rn(c)), Pe = qe.innerHeight - h, Ge = qe.innerWidth - h;
    if (h !== null && Te < h) {
      const ye = Te - h;
...
`)), h !== null && he < h) {
  ...
  }, [c, f, j, Q, h]), [O, M] = w.useState(E), V = w.useCallback(() => {
    const J = G.current;
    if (!J)
      return;
    const R = Z(J);
  ...
  const W = v || (c ? we(Rn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : zf, H = (i = y == null ? void 0 : y.paper) != null ? i : La, X = gt({
    elementType: H,
    ...
    ownerState: _,
    className: xe(N.paper, z == null ? void 0 : z.className)
  }), Y = gt({
    elementType: q,
...
const Wf = ["onEntering"], qf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Gf = {
  ...
  const i = tt({
    ...
    slots: S = {},
    slotProps: y = {}
  } = i, x = ce(i.TransitionProps, Wf), m = ce(i, qf), C = gn(), P = C.direction === "rtl", A = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: x,
    variant: E
  }), I = Xf(A), D = s && !u && p, B = w.useRef(null), z = (Z, O) => {
    B.current && B.current.adjustStyleForScrollbar(Z, C), h && h(Z, O);
  }, G = (Z) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const _ = (r = S.paper) != null ? r : Jf, N = (o = y.paper) != null ? o : b, j = gt({
    elementType: S.root,
...
const Mr = (e, t, n = {}) => {
  ...
  const [i, s] = Ve(() => r.current), [l, c] = Ve(!0);
  return Vn(() => {
    let u = !0;
    return c(!!e), (async () => {
      if (e) {
...
function nh({
  ...
  const [c, u] = Ve(!1), [d, f] = Ve(!1), p = $e(() => {
    c && u(!1), f(!1);
  }, [c]), b = $e((x) => {
    x.stopPropagation(), u((m) => {
      const C = !m;
      return C && x.shiftKey ? f(!0) : C || f(!1), C;
    });
  }, []), v = $e(
    (x) => (p(), r(x)),
    [r, p]
  ...
  Vn(() => {
    if (c) {
      ...
      if (x) {
        const m = x.getBoundingClientRect(), C = window.scrollY, P = window.scrollX, A = m.top + C + x.clientHeight, I = m.left + P;
        h({ top: A, left: I });
      }
    }
  }, [c, o]);
