...
const de = u.forwardRef(({ className: t, ...e }, n) => {
  const a = tt();
...
function Vi({
  ...
  const c = tt(), [p, g] = O(!1), [h, f] = O(""), [b, y] = O(""), [v, S] = O("books"), [N, C] = O(void 0), [$, W] = O(!1), L = nt(void 0), at = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), U = B(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
...
), Q = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Gn.Root, { ref: n, className: d("pr-twp", co(), t), ...e }));
...
function Ii({
  ...
  const p = Ie(c, "%webView_bookSelector_currentBook%"), g = Ie(c, "%webView_bookSelector_choose%"), h = Ie(c, "%webView_bookSelector_chooseBooks%"), [f, b] = O(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    b(v), t(v);
...
const cr = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ht();
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
...
cr.displayName = G.RadioItem.displayName;
...
function Mo({
  ...
  var S;
  const [m, c] = O([]), [p, g] = O([]), [h, f] = O({}), [b, y] = O({}), v = Fn({
    data: e,
    columns: t,
    getCoreRowModel: Hn(),
...
function Ao({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const m = new Date(w), c = new Date(o.getTime() - m.getTime()), p = c.getUTCFullYear() - 1970, g = c.getUTCMonth(), h = c.getUTCDate() - 1;
    let f = "";
          ...
          return /* @__PURE__ */ l(
            $t,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: S.starred && /* @__PURE__ */ r(ca, { className: "tw-h-4 tw-w-4" }) }),
...
function $o({
  ...
  const m = a ? /* @__PURE__ */ r("span", { className: Ye, children: `\\${t.marker} ` }) : void 0, c = a ? /* @__PURE__ */ r("span", { className: Ye, children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(bt, { children: [
...
const Go = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function Li({
  ...
  const p = c ? Ho(c, "%webView_footnoteList_header%") : "Footnotes", g = w ?? Ma(e, void 0), h = (f) => {
    m && m(f);
  };
  return /* @__PURE__ */ l(bt, { children: [
...
const fn = ce.Provider, gn = ce.Root, bn = ce.Trigger, Te = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ce.Content,
  {
    ref: a,
    sideOffset: e,
...
const is = Tt(
  ...
  ({
    ...
    const m = t ? Ut : "button", { state: c } = Ee(), p = /* @__PURE__ */ r(
      m,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(is({ variant: n, size: a }), s),
        ...i
      }
    );
...
const cs = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
function Wi({
  ...
  const [c, p] = O([]), [g, h] = O([{ id: _t, desc: !1 }]), [f, b] = O({}), y = H(
...
function Ns({
  ...
  const s = xn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], m = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    I,
    {
      variant: "outline",
...
function We({
  ...
  return /* @__PURE__ */ l(dn, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, c]) => typeof m == "boolean" || typeof c == "boolean" ? 0 : m.order - c.order).map(([m], c, p) => /* @__PURE__ */ l(Bn, { children: [
...
function Vs({
  ...
  const o = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), m = nt(void 0), c = (p) => {
    switch (p) {
      case "platform.app":
        return s;
...
const Is = Ze(({ className: t, ...e }, n) => /* @__PURE__ */ r(ka, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
const di = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = O(void 0), [w, m] = O(void 0), c = B(
    (h) => {
      i(h);
