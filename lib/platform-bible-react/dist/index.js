...
import g, { forwardRef as Ve, useRef as et, useMemo as L, useState as M, useCallback as B, useLayoutEffect as It, createContext as Sn, useContext as Dn, useEffect as q, Suspense as sa, createRef as ia, Fragment as yr } from "react";
import { Command as dt } from "cmdk";
import { X as Me, Search as Nr, Check as _t, Clock as tr, ChevronsLeft as er, ChevronsRight as nr, ChevronLeft as wn, ChevronRight as ae, ArrowLeft as la, ArrowRight as wa, Circle as He, ChevronDown as Yt, BoldIcon as da, ItalicIcon as ca, UnderlineIcon as pa, StrikethroughIcon as ua, Pencil as ma, Trash2 as ha, ArrowUp as kr, MoreHorizontal as _r, ChevronUp as dn, AtSign as fa, FilterIcon as ga, ArrowLeftIcon as ba, ChevronLeftIcon as va, ChevronRightIcon as xa, ArrowRightIcon as ya, Copy as Cr, Filter as Na, User as ka, Link as _a, CircleHelp as Ca, ChevronsUpDown as Er, Star as Ea, FunctionSquare as Tr, SquareSigma as Rr, SquareX as Ta, AlertCircle as cn, CircleCheckIcon as Ra, CircleXIcon as Sa, CircleHelpIcon as Da, ArrowUpIcon as Ia, ArrowDownIcon as Oa, ArrowUpDownIcon as Va, PanelLeft as Ma, PanelRight as Aa, ScrollText as Pa, MenuIcon as $a, Menu as La, EllipsisVertical as za, LoaderCircle as Ba, GripVertical as ja } from "lucide-react";
import { clsx as Fa } from "clsx";
import { extendTailwindMerge as Ga } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { includes as Le, Section as F, getChaptersForBook as Ha, formatScrRef as ne, getSectionForBook as _e, formatRelativeDate as Xa, formatReplacementString as re, sanitizeHtml as Ka, parseParatextHtml as rr, hasCustomParatextTags as Ua, NumberFormat as Ya, formatBytes as qa, getCurrentLocale as Ja, getFormatCallerFunction as Wa, deepEqual as Sr, isString as Qe, compareScrRefs as pn, scrRefToBBBCCCVVV as tn, getLocalizeKeyForScrollGroupId as K } from "platform-bible-utils";
...
import { createEditor as Za, $getRoot as qt, $createParagraphNode as In, $getSelection as Se, HISTORY_MERGE_TAG as Ir, ParagraphNode as Qa, TextNode as ts, $isDecoratorNode as es, $isElementNode as Ce, $isParagraphNode as ns, $isTextNode as Be, $isTokenOrSegmented as rs, $getCharacterOffsets as os, $isRangeSelection as On, CLEAR_EDITOR_COMMAND as Or, COMMAND_PRIORITY_EDITOR as as, SELECTION_CHANGE_COMMAND as Vr, COMMAND_PRIORITY_CRITICAL as Mr, FORMAT_TEXT_COMMAND as ss, $cloneWithProperties as is, getRegisteredNode as ls, isHTMLElement as ws, isDocumentFragment as or, ArtificialNode__DO_NOT_USE as Ar, $createLineBreakNode as Pr, $isRootOrShadowRoot as ds, $isBlockElementNode as un, isBlockDomNode as ar, isInlineDomNode as sr, $insertNodes as cs } from "lexical";
...
import { useReactTable as Br, getFilteredRowModel as xs, getSortedRowModel as jr, getPaginationRowModel as ys, getCoreRowModel as Fr, flexRender as Ee, getGroupedRowModel as Ns, getExpandedRowModel as ks } from "@tanstack/react-table";
import * as nt from "@radix-ui/react-select";
import _s from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as mn, HIDDEN_NOTE_CALLER as hn, getDefaultViewOptions as Cs, isInsertEmbedOpOfType as en, Editorial as Es } from "@eten-tech-foundation/platform-editor";
...
import * as gn from "@radix-ui/react-progress";
import * as Vn from "react-resizable-panels";
import { Toaster as Rs } from "sonner";
import { toast as Cc } from "sonner";
import * as ke from "@radix-ui/react-slider";
import * as bn from "@radix-ui/react-switch";
...
const Is = ft.Root, Os = ft.Portal, Gr = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: u(
...
const Hr = g.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = st();
...
Vs.displayName = ft.Description.displayName;
...
const Ur = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.Separator,
  {
    ref: n,
...
Ur.displayName = dt.Separator.displayName;
...
var Ms = Object.defineProperty, As = (t, e, n) => e in t ? Ms(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, j = (t, e, n) => As(t, typeof e != "symbol" ? e + "" : e, n);
const Jt = [
  "GEN",
  "EXO",
  "LEV",
...
function Zr(t) {
  const e = typeof t == "number" ? Pn(t) : t;
  return An(e) && !Mn.includes(e);
}
function Gs(t) {
  const e = typeof t == "number" ? Pn(t) : t;
  return An(e) && Mn.includes(e);
...
const wt = class H {
  ...
  parse(e) {
    ...
    if (o.length !== 2 || U.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !H.isVerseParseable(o[1]))
      throw new ye("Invalid reference : " + e);
...
const eo = U.allBookIds.filter(
  (t) => !U.isObsolete(U.bookIdToNumber(t))
), Xt = Object.fromEntries(
  eo.map((t) => [t, U.bookIdToEnglishName(t)])
);
function Ln(t, e, n) {
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ d(
          ...
          {
            ref: w,
            value: p || `${t} ${U.bookIdToEnglishName(t)}`,
            onSelect: f,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
...
function vn(t, e, n) {
  return `${t} ${Xt[t]}${e ? ` ${$n(t, e)} ${oe(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function Ys({
  recentSearches: t,
...
function xd({
  ...
  const w = st(), [c, f] = M(!1), [h, m] = M(""), [b, v] = M(""), [y, O] = M("books"), [N, x] = M(void 0), [_, A] = M(!1), C = et(void 0), E = et(void 0), S = et(void 0), T = et(void 0), R = et({}), P = B(
    ...
    [F.OT]: z.filter((X) => U.isBookOT(X)),
    [F.NT]: z.filter((X) => U.isBookNT(X)),
    [F.DC]: z.filter((X) => U.isBookDC(X)),
    [F.Extra]: z.filter((X) => U.extraBooks().includes(X))
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: X, isDigit: ot } = wr(D.key);
      if (y === "chapters") {
        if (D.key === "Backspace") {
      ...
      if ((y === "chapters" || y === "books" && V) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        ...
        Tt !== lt && (D.preventDefault(), D.stopPropagation(), m(vn(it, a, Tt)), setTimeout(() => {
  ...
  return It(() => {
    ...
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      $,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: na })
      }
    ) }),
              ...
              !V && Object.entries(J).map(([D, X]) => {
                if (X.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r($t, { heading: ta(D), children: X.map((ot) => /* @__PURE__ */ r(
                      no,
                      {
                        bookId: ot,
                        onSelect: (it) => ht(it),
...
), at = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Dr.Root, { ref: n, className: u("pr-twp", Zs(), t), ...e }));
at.displayName = Dr.Root.displayName;
const zn = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    Re.Root,
    {
...
zn.displayName = Re.Root.displayName;
const je = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Re.Item,
  {
    ref: n,
    className: u(
    ...
    ...e,
    children: /* @__PURE__ */ r(Re.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(He, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
...
function kd({
  ...
  const c = rn(w, "%webView_bookSelector_currentBook%"), f = rn(w, "%webView_bookSelector_choose%"), h = rn(w, "%webView_bookSelector_chooseBooks%"), [m, b] = M(
    "current book"
    /* CURRENT_BOOK */
  ), v = (y) => {
    b(y), t(y);
    ...
    zn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(at, { className: "tw-flex tw-items-center", children: o.map((y) => U.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ r(
            $,
            {
...
const oo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, si = oo ? It : q, ze = { tag: Ir };
function ii({ initialConfig: t, children: e }) {
  const n = L(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: p } = t, w = ai(null, o), c = Za({ editable: t.editable, html: p, namespace: a, nodes: s, onError: (f) => i(f, c), theme: o });
    return function(f, h) {
      if (h !== null) {
...
var cr = { error: null }, di = function(t) {
  var e, n;
  function o() {
  ...
  n = t, (e = o).prototype = Object.create(n.prototype), e.prototype.constructor = e, yn(e, n), o.getDerivedStateFromError = function(s) {
    return { error: s };
  };
  var a = o.prototype;
  return a.reset = function() {
    ...
    if (s !== null) {
      ...
      if (Ze.isValidElement(w)) return w;
      if (typeof l == "function") return l(c);
      if (p) return Ze.createElement(p, c);
...
function bi(t, e) {
  ...
  if (e.isSelected(t) && !rs(e) && n !== null) {
    ...
    if (p || w) {
      const [c, f] = os(t), h = i.is(l), m = e.is(s ? l : i), b = e.is(s ? i : l);
      let v, y = 0;
...
const so = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vi = so && "documentMode" in document ? document.documentMode : null;
!(!so || !("InputEvent" in window) || vi) && "getTargetRanges" in new window.InputEvent("input");
function Fn(...t) {
  return () => {
          ...
          if (p) {
            ...
            t.update(() => {
              ...
              if (On(v)) {
                ...
                if (Be(O) && w >= 0 && c >= 0 && (N = w, x = w + c, v.setTextNodeRange(O, N, O, x)), N === x && f === "" || (v.insertRawText(f), O = y.getNode()), Be(O)) {
                  N = h, x = h + m;
...
const Nn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function pr(t) {
...
function yi({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Ct(), a = function(s, i) {
    ...
    return Nn(() => s.registerDecoratorListener((w) => {
      fs(() => {
        p(w);
      });
    }), [s]), q(() => {
      ...
      for (let f = 0; f < c.length; f++) {
        const h = c[f], m = r(i, { onError: (v) => s._onError(v), children: r(sa, { fallback: null, children: l[h] }) }), b = s.getElementByKey(h);
  ...
  return function(s) {
    Nn(() => Fn(hs(s), xi(s)), [s]);
  }(o), d(rt, { children: [t, r(Ni, { content: e }), a] });
}
function Ni({ content: t }) {
  const [e] = Ct(), n = function(a) {
    ...
    return Nn(() => {
      ...
      return l(), Fn(a.registerUpdateListener(() => {
        l();
...
function Ci({ onClear: t }) {
  const [e] = Ct();
  return _i(() => e.registerCommand(Or, (n) => (e.update(() => {
    if (t == null) {
      const o = qt(), a = Se(), s = In();
      o.clear(), o.append(s), a !== null && s.select(), On(a) && (a.format = 0);
    } else t();
  }), !0), as), [e, t]), null;
}
...
function Si(t, e) {
  ...
  return d(rt, { children: [r(Ti, { editor: a, ...o, ref: e }), n != null && r(Di, { editor: a, content: n })] });
}
function Di({ content: t, editor: e }) {
  const n = function(i) {
    ...
    return io(() => {
      ...
      return w(), Fn(i.registerUpdateListener(() => {
        w();
...
function Vi() {
  const [t, e] = M(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Is, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Hr, { children: [
      /* @__PURE__ */ r(Xr, { children: /* @__PURE__ */ r(Kr, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = B(
    (s, i, l = !1) => {
...
function Mi({
  ...
  const [e] = Ct(), [n, o] = M(e), [a, s] = M("paragraph"), [i, l] = Vi(), p = () => {
  };
...
Pi.displayName = $r.Root.displayName;
const po = g.createContext({
  size: "default",
  variant: "default"
}), Gn = g.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = st();
  return /* @__PURE__ */ r(
    Xe.Root,
    {
...
Te.displayName = Xe.Item.displayName;
const mr = [
...
function uo(t, e, n, o = null) {
  ...
  if (o !== null) {
    let m = is(e);
    m = Be(m) && o !== null ? bi(o, m) : m, i = m;
  }
  const l = Ce(i) ? i.getChildren() : [], p = ls(t, i.getType());
  let w;
  ...
  for (let m = 0; m < l.length; m++) {
    const b = l[m], v = uo(t, b, h, o);
    !a && Ce(e) && v && e.extractWithChild(b, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((ws(c) || or(c)) && c.append(h), n.append(c), f) {
      const m = f.call(i, c);
...
function ho(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const m = (l == null || !ds(l)) && (l != null && un(l) || o);
  for (let b = 0; b < f.length; b++) h.push(...ho(f[b], e, n, m, new Map(a), l));
  return c != null && (h = c(h)), ar(t) && (h = Gi(t, h, m ? () => {
    const b = new Ar();
    return n.push(b), b;
  } : In)), l == null ? h.length > 0 ? i = i.concat(h) : ar(t) && function(b) {
    return b.nextSibling == null || b.previousSibling == null ? !1 : sr(b.nextSibling) && sr(b.previousSibling);
...
const vo = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ce.Root,
  {
    ref: n,
    className: u(
...
vo.displayName = ce.Root.displayName;
...
xo.displayName = ce.Fallback.displayName;
const Xn = Sn(void 0);
function bt() {
  const t = Dn(Xn);
  if (!t)
...
}), ge = Z.Trigger, yo = Z.Group, Zi = Z.Portal, Qi = Z.Sub, tl = Z.RadioGroup;
...
const No = g.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = bt();
  return /* @__PURE__ */ d(
    Z.SubTrigger,
    {
...
No.displayName = Z.SubTrigger.displayName;
const ko = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Z.SubContent,
  {
    ref: n,
    className: u(
...
ko.displayName = Z.SubContent.displayName;
...
const Fe = g.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = st(), s = bt();
  return /* @__PURE__ */ r(
    Z.Item,
    {
...
Fe.displayName = Z.Item.displayName;
...
const _o = g.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = bt();
  return /* @__PURE__ */ d(
    Z.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Z.ItemIndicator, { children: /* @__PURE__ */ r(He, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
_o.displayName = Z.RadioItem.displayName;
...
function hr({
  ...
  handleSetCommentThreadStatus: i,
    ...
    if (a && n)
      return /* @__PURE__ */ d(rt, { children: [
        !Ua(t.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              f(!0), m(Xi(rr(t.contents))), w == null || w(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(vo, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(xo, { className: "tw-text-xs tw-font-medium", children: x }) }),
          ...
          !c && /* @__PURE__ */ r(
            "div",
            {
              className: u(
                ...
                // tw-prose has a max width defined on it, that we might want to override
                "tw-max-w-none",
                {
                  "tw-line-clamp-3": !a
                }
        ...
        a && !e && s !== "Resolved" && i && /* @__PURE__ */ r(
          $,
          {
            ...
            onClick: (C) => {
              C.stopPropagation(), i(t.thread, !0);
            },
...
function nl({
  ...
  threadId: l,
  threadStatus: p,
  handleSetCommentThreadStatus: w,
  handleAddComment: c,
  handleUpdateComment: f,
  handleDeleteComment: h
}) {
  const [m, b] = M(fr), [v, y] = M(!1), [O, N] = M(!1), [x, _] = M(!1), [A, C] = M(!1), E = L(() => t.filter((k) => !k.deleted), [t]), S = L(() => E[0], [E]), T = et(null), R = et(void 0);
  q(() => {
    const k = T.current;
    if (!k) return;
    const Y = () => {
  ...
  const P = L(
    ...
    var Y;
    await c(l, fo(m)) && ((Y = R.current) == null || Y.call(R), b(fr));
  }, [m, c, l]);
  return /* @__PURE__ */ r(
    Hn,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ d(bo, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            O && /* @__PURE__ */ r(
              $,
              {
                ...
                children: v ? /* @__PURE__ */ r(dn, {}) : /* @__PURE__ */ r(Yt, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
...
function Cd({
  ...
  localizedStrings: o,
  handleAddComment: a,
  handleSetCommentThreadStatus: s,
  ...
  const [p, w] = M(), c = e.filter(
    ...
    w(N);
  }, []), { listboxRef: b, activeId: v, handleKeyDown: y } = oi({
    options: f,
    onOptionSelect: h
  }), O = B(
    (N) => {
...
function rl({ table: t }) {
  return /* @__PURE__ */ d(ee, { children: [
    /* @__PURE__ */ r(vs, { asChild: !0, children: /* @__PURE__ */ d($, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const le = nt.Root, ol = nt.Group, we = nt.Value, al = Lt(
...
const Co = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(dn, { className: "tw-h-4 tw-w-4" })
  }
));
Co.displayName = nt.ScrollUpButton.displayName;
...
Eo.displayName = nt.ScrollDownButton.displayName;
...
sl.displayName = nt.Label.displayName;
...
il.displayName = nt.Separator.displayName;
function ll({ table: t }) {
...
const Ue = g.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
...
const Ye = g.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: u(
...
const qe = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: u("[&_tr:last-child]:tw-border-0", t), ...e }));
  ...
  const l = g.useMemo(
    ...
    (c) => {
      ...
      if (c.key === "ArrowDown" || c.key === "ArrowUp")
        c.preventDefault(), ul(m, b, c.key);
      else if (c.key === "ArrowLeft" || c.key === "ArrowRight")
        c.preventDefault(), pl(l, v, c.key);
...
function hl({
  ...
  var C;
  const [c, f] = M([]), [h, m] = M([]), [b, v] = M({}), [y, O] = M({}), N = L(() => e ?? [], [e]), x = Br({
    data: N,
    columns: t,
    getCoreRowModel: Fr(),
  ...
  let A;
  return p ? A = Array.from({ length: 10 }).map((T, R) => `skeleton-row-${R}`).map((T) => /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r(Ut, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(_n, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, T)) : ((C = x.getRowModel().rows) == null ? void 0 : C.length) > 0 ? A = x.getRowModel().rows.map((E) => /* @__PURE__ */ r(
    Rt,
    {
      onClick: () => i(E, x),
      "data-state": E.getIsSelected() && "selected",
      children: E.getVisibleCells().map((S) => /* @__PURE__ */ r(Ut, { children: Ee(S.column.columnDef.cell, S.getContext()) }, S.id))
    },
    E.id
    ...
    /* @__PURE__ */ d(Ue, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ye, { stickyHeader: s, children: x.getHeaderGroups().map((E) => /* @__PURE__ */ r(Rt, { children: E.headers.map((S) => /* @__PURE__ */ r(Oe, { children: S.isPlaceholder ? void 0 : Ee(S.column.columnDef.header, S.getContext()) }, S.id)) }, E.id)) }),
...
function Sd({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ee, { children: [
    ...
    /* @__PURE__ */ r(zt, { children: n.map((w, c) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(yo, { children: w.itemType === 0 ? /* @__PURE__ */ r(rt, { children: w.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Pt,
        {
          checked: o[c][h],
        ...
        tl,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(_o, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(be, {})
    ] }, w.label)) })
...
function Id({
  ...
  const i = L(() => qa(n), [n]), p = ((w) => {
    const c = new Intl.DisplayNames(Ja(), { type: "language" });
        ...
        /* @__PURE__ */ r($t, { children: A.map((R) => /* @__PURE__ */ d(
          Qt,
          {
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ r(Ea, { className: "tw-h-4 tw-w-4" }),
...
const yl = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(rt, { children: [
...
function Nl({
  ...
  return q(() => {
    ...
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Kt, { asChild: !0, children: /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "outline", className: "tw-h-6", children: yl(t, a, n) }) }) }),
      ...
      /* @__PURE__ */ r(
        Pt,
        {
          ...
          children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
            ...
            /* @__PURE__ */ r("span", { className: "tw-w-10 tw-text-center", children: mn })
          ] })
        }
      ),
      /* @__PURE__ */ r(
...
const kl = (t, e) => t === "f" ? /* @__PURE__ */ d(rt, { children: [
  /* @__PURE__ */ r(Tr, {}),
  " ",
...
function Vd({
  ...
  const l = et(null), p = ia(), [w, c] = M("generated"), [f, h] = M("*"), [m, b] = M("f"), v = L(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (_ && en("note", _)) {
      ...
      let S = "custom";
      E === mn ? S = "generated" : E === hn ? S = "hidden" : E && h(E), c(S), b(((C = _.insert.note) == null ? void 0 : C.style) ?? "f"), _.insert.note && (_.insert.note.caller = ""), x = setTimeout(() => {
        var T;
  ...
  const y = B(() => {
    ...
    x && en("note", x) && (x.insert.note && (w === "custom" ? x.insert.note.caller = f : x.insert.note.caller = w === "generated" ? mn : hn), e([x]));
  }, [w, f, e]), O = () => {
    var _;
        ...
        /* @__PURE__ */ r(
          Cl,
          {
            ...
            handleNoteTypeChange: (x) => {
              ...
              _ && en("note", _) && (_.insert.note && (_.insert.note.style = x), (E = l.current) == null || E.applyUpdate([{ delete: 1 }, _]));
            },
            localizedStrings: i
          }
        ),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
            /* @__PURE__ */ r(Kt, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: O, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cr, {}) }) }),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ d(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ r(cn, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
...
function Rl({
  ...
  return /* @__PURE__ */ d(rt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: u("textual-note-body tw-pr-0.5", m), children: l && l.length > 0 && /* @__PURE__ */ r(rt, { children: El(t.marker, l, o, w) }) })
  ] });
}
...
function Pd({
  ...
  const f = c ? Sl(c, "%webView_footnoteList_header%") : "Footnotes", h = p ?? Wa(n, void 0), m = (x, _) => {
    w == null || w(x, _, a);
...
function Il({
  ...
  return /* @__PURE__ */ d(Ue, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ye, { stickyHeader: !0, children: /* @__PURE__ */ d(Rt, { children: [
      /* @__PURE__ */ r(Oe, { children: o }),
      /* @__PURE__ */ r(Oe, { children: a })
    ] }) }),
    /* @__PURE__ */ r(qe, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      Rt,
      {
        onClick: () => {
          e(i.reference);
        ...
        children: [
          /* @__PURE__ */ r(Ut, { children: `${U.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
const Un = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  fn.Root,
  {
    ref: n,
    className: u(
...
Un.displayName = fn.Root.displayName;
const Je = (t) => t === "asc" ? /* @__PURE__ */ r(Ia, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Oa, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Va, { className: "tw-ms-2 tw-h-4 tw-w-4" }), $d = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d(Gn, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Te,
        {
          onClick: (p) => {
            p.stopPropagation(), on(
              [l],
              "approved",
              e,
              n,
  ...
  return t.forEach((a) => {
    const s = o.find(
      (i) => Sr(
        i.items,
        Qe(a.inventoryText) ? [a.inventoryText] : a.inventoryText
      )
    );
    if (s)
      ...
      const i = {
        items: Qe(a.inventoryText) ? [a.inventoryText] : a.inventoryText,
        count: 1,
        status: Vl(
          Qe(a.inventoryText) ? a.inventoryText : a.inventoryText[0],
          e,
          n
        ),
        occurrences: [
...
function Hd({
  ...
  }, [A, G]), J = L(() => I.length === 0 ? [] : Ml(I, E, T), [I, E, T]), V = L(() => {
    var ut, xt;
    if (!A) return p;
...
const Pl = "16rem", $l = "3rem", Ro = g.createContext(void 0);
function We() {
  const t = g.useContext(Ro);
  if (!t)
    throw new Error("useSidebar must be used within a SidebarProvider.");
  return t;
}
const So = g.forwardRef(
  ({
    defaultOpen: t = !0,
    open: e,
    onOpenChange: n,
    ...
    return /* @__PURE__ */ r(Ro.Provider, { value: N, children: /* @__PURE__ */ r(St, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
So.displayName = "SidebarProvider";
const Do = g.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = We();
...
Oo.displayName = "SidebarContent";
const Cn = g.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
Cn.displayName = "SidebarGroup";
const En = g.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? de : "div",
  {
    ref: o,
...
En.displayName = "SidebarGroupLabel";
...
Mo.displayName = "SidebarMenuItem";
const Xl = Lt(
  ...
  ({
    ...
    const p = t ? de : "button", { state: w } = We(), c = /* @__PURE__ */ r(
      p,
      {
        ref: l,
...
Ao.displayName = "SidebarMenuButton";
...
function Zl({
  ...
  return /* @__PURE__ */ r(
    Do,
    {
      ...
      children: /* @__PURE__ */ d(Oo, { children: [
        /* @__PURE__ */ d(Cn, { children: [
          /* @__PURE__ */ r(En, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Tn, { children: /* @__PURE__ */ r(Vo, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Mo, { children: /* @__PURE__ */ r(
            Ao,
            {
              onClick: () => w(h),
              isActive: f(h),
        ...
        /* @__PURE__ */ d(Cn, { children: [
          /* @__PURE__ */ r(En, { className: "tw-text-sm", children: i }),
    ...
    /* @__PURE__ */ d(
      So,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Io, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Mt = "scrBook", Ql = "scrRef", Gt = "source", tw = "details", ew = "Scripture Reference", nw = "Scripture Book", Po = "Type", rw = "Details";
function ow(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? U.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Mt ? ne(a.start) : void 0;
      },
      getGroupingValue: (o) => U.bookIdToNumber(o.start.book),
      sortingFn: (o, a) => pn(o.original.start, a.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id: Gt,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Po : void 0,
...
const aw = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || pn(t.start, t.end) === 0 ? `${tn(t.start)}+${e}` : `${tn(t.start)}+${e}-${tn(t.end)}+${n}`;
}, vr = (t) => `${aw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Kd({
  sources: t,
    ...
    !e && /* @__PURE__ */ d(
      le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Zt, { position: "item-aligned", children: /* @__PURE__ */ r(ol, { children: _.map((T) => /* @__PURE__ */ r(mt, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Ue, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ye, { children: O.getHeaderGroups().map((T) => /* @__PURE__ */ r(Rt, { children: T.headers.filter((R) => R.column.columnDef.header).map((R) => (
      ...
      /* @__PURE__ */ r(qe, { children: O.getRowModel().rows.map((T, R) => {
        const P = st();
        return /* @__PURE__ */ r(
          Rt,
          {
                    ...
                    children: z.getIsGrouped() ? /* @__PURE__ */ d(
                      $,
                      {
                        ...
                        children: [
                          ...
                          !T.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(ae, {}) : /* @__PURE__ */ r(wn, {})),
                          " ",
...
}), $o = (t, e, n) => qn(t, e).every((o) => n.includes(o));
function sw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    $,
    {
      ...
      onClick: () => o(t),
      className: u(
        $o(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Ks(
        t,
...
function iw({
  ...
  const C = L(() => U.allBookIds.filter(
    (I, J) => t[J] === "1" && !U.isObsolete(U.bookIdToNumber(I))
  ), [t]), E = L(() => {
    if (!N.trim()) {
      const V = {
        [F.OT]: [],
    ...
    (I) => {
      ...
      n(
        $o(C, I, e) ? e.filter((V) => !J.includes(V)) : [.../* @__PURE__ */ new Set([...e, ...J])]
      );
    },
    [e, n, C]
  ), z = () => {
                  ...
                  Object.values(F).map((I, J) => {
                    ...
                    if (V.length !== 0)
                      return /* @__PURE__ */ d(yr, { children: [
                        ...
                        J < Object.values(F).length - 1 && /* @__PURE__ */ r(Ur, {})
                      ] }, I);
                  })
                ] })
              ]
      ...
      /* @__PURE__ */ r(
        zn,
        {
          ...
          children: O.map(({ value: N, label: x, id: _ }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(je, { className: "tw-me-2", value: N, id: _ }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Zt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(mt, { value: `${w}`, children: l[K(w)] }, `${w}`))
          }
        )
      ]
    }
...
const zo = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Kt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(No, { children: l.label }),
    /* @__PURE__ */ r(Zi, { children: /* @__PURE__ */ r(ko, { children: zo(
      t,
      e,
      Lo(t, l.id),
      o
...
function Rn({
  ...
  return /* @__PURE__ */ d(ee, { variant: s, children: [
    /* @__PURE__ */ r(ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r($, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r($a, {}) }) }),
    /* @__PURE__ */ r(zt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, w]) => typeof p == "boolean" || typeof w == "boolean" ? 0 : p.order - w.order).map(([p], w, c) => /* @__PURE__ */ d(yr, { children: [
      /* @__PURE__ */ r(yo, { children: /* @__PURE__ */ r(St, { children: zo(e.groups, e.items, p, t) }) }),
...
function Qd({
  ...
  return /* @__PURE__ */ d(Bo, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      Rn,
      {
        onSelectMenuItem: t,
...
function tc({
  ...
  return /* @__PURE__ */ r(Bo, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    Rn,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const jo = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ct.Root,
    {
...
jo.displayName = ct.List.displayName;
const Fo = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.List,
  {
    ref: n,
    className: u(
...
)), Go = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Content,
  {
    ref: n,
    className: u(
...
Go.displayName = ct.Content.displayName;
function ec({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(jo, { children: [
      /* @__PURE__ */ r(Fo, { children: t.map((l) => /* @__PURE__ */ r(lw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(Go, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function ww({ ...t }) {
...
const Ho = g.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = g.useMemo(
    () => ({
      variant: e
    }),
...
Ho.displayName = Q.Root.displayName;
const Xo = g.forwardRef(({ className: t, ...e }, n) => {
  const o = bt();
  return /* @__PURE__ */ r(
    Q.Trigger,
    {
...
Xo.displayName = Q.Trigger.displayName;
...
Uo.displayName = Q.SubContent.displayName;
const Yo = g.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = bt();
...
Yo.displayName = Q.Content.displayName;
const qo = g.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = bt();
  return /* @__PURE__ */ r(
    Q.Item,
    {
...
qo.displayName = Q.Item.displayName;
...
const pw = g.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    Q.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(He, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
const Jo = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Q.Separator,
  {
    ref: n,
    className: u("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
Jo.displayName = Q.Separator.displayName;
const Ne = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    ...
    return l.length > 0 && i < a.length - 1 && p.push(/* @__PURE__ */ r(Jo, {}, `separator-${s}`)), p;
  });
};
function mw({
  menuData: t,
  ...
  if (Ts(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (c, f) => {
    var b, v, y, O;
    c.preventDefault();
    ...
    return /* @__PURE__ */ r(Ho, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, f]) => typeof c == "boolean" || typeof f == "boolean" ? 0 : c.order - f.order).map(([c, f]) => /* @__PURE__ */ d(ww, { children: [
      /* @__PURE__ */ r(Xo, { ref: w(c), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Yo,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(St, { children: Wo(t.groups, t.items, c, e) })
        }
      )
    ] }, c)) });
}
...
const gw = Ve(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ba, { size: 35, className: u("tw-animate-spin", t), ...e, ref: n }));
...
const Tw = g.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  tt.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(tt.ItemIndicator, { children: /* @__PURE__ */ r(He, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
...
function Iw({
  ...
  return /* @__PURE__ */ r(Zo.Provider, { value: o, children: /* @__PURE__ */ r(
    gt.Root,
    {
...
const mc = gt.Trigger, Ow = gt.Portal, hc = gt.Close, Qo = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  gt.Overlay,
  {
    ref: n,
...
Qo.displayName = gt.Overlay.displayName;
const Vw = g.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = g.useContext(Zo), i = {
...
Pw.displayName = gt.Title.displayName;
...
$w.displayName = gt.Description.displayName;
...
Lw.displayName = gn.Root.displayName;
function fc({
  className: t,
  ...e
}) {
...
zw.displayName = ke.Root.displayName;
...
Bw.displayName = bn.Root.displayName;
const xc = ct.Root, jw = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ct.List,
    {
...
jw.displayName = ct.List.displayName;
...
Fw.displayName = ct.Trigger.displayName;
...
Gw.displayName = ct.Content.displayName;
...
export {
  ...
  jo as VerticalTabs,
  Go as VerticalTabsContent,
  Fo as VerticalTabsList,
