import wl, { jsx as i, jsxs as N, Fragment as ae } from "react/jsx-runtime";
import * as B from "react";
import E, { forwardRef as cr, useCallback as St, useState as pt, useRef as Ft, useEffect as ne, useLayoutEffect as ba, useMemo as Rt } from "react";
import ye, { clsx as fl } from "clsx";
...
import { ChevronRight as vo, Check as Je, Circle as yo, X as xo, Search as gi, ChevronsUpDown as bi, FilterIcon as gl, ChevronDown as dr, ChevronUp as bl, ArrowLeftIcon as vl, ChevronLeftIcon as yl, ChevronRightIcon as xl, ArrowRightIcon as Nl, LoaderCircle as kl, Download as El, Filter as Sl, User as Cl, Link as Tl, CircleHelp as Rl, Star as Ol, CircleCheckIcon as _l, CircleXIcon as Pl, CircleHelpIcon as Il, ArrowUpIcon as $l, ArrowDownIcon as Ml, ArrowUpDownIcon as Al, PanelLeft as Dl, PanelRight as jl, ScrollText as Bl, ChevronLeft as Vl } from "lucide-react";
import { getChaptersForBook as zl, NumberFormat as Fl, formatBytes as Ll, deepEqual as No, substring as Gl, formatScrRef as Vr, compareScrRefs as no, scrRefToBBBCCCVVV as zr, getLocalizeKeyForScrollGroupId as dt } from "platform-bible-utils";
import { Slot as Ze } from "@radix-ui/react-slot";
import { cva as Re } from "class-variance-authority";
import * as vi from "@radix-ui/react-label";
...
import { useReactTable as yi, getFilteredRowModel as Ul, getSortedRowModel as xi, getPaginationRowModel as Xl, getCoreRowModel as Ni, flexRender as vn, getGroupedRowModel as Yl, getExpandedRowModel as Hl } from "@tanstack/react-table";
...
import * as Ei from "@radix-ui/react-separator";
...
import { MenuItem as Ql, ListItemText as tc, ListItemIcon as Si, Menu as ec, Grid as Ci, List as nc, IconButton as Ti, Drawer as rc } from "@mui/material";
...
const ko = wt.Root, Ri = wt.Trigger, cc = wt.Group, nh = wt.Portal, rh = wt.Sub, oh = wt.RadioGroup, dc = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  wt.SubTrigger,
  {
    ref: o,
    className: y(
    ...
    children: [
      n,
      /* @__PURE__ */ i(vo, { className: "tw-ml-auto tw-h-4 tw-w-4" })
    ]
  }
));
dc.displayName = wt.SubTrigger.displayName;
...
pc.displayName = wt.SubContent.displayName;
...
ur.displayName = wt.Content.displayName;
const Oi = E.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ i(
    wt.Item,
    {
...
Oi.displayName = wt.Item.displayName;
const Eo = E.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ N(
  wt.CheckboxItem,
  {
    ref: o,
    className: y(
    ...
    ...r,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ i(wt.ItemIndicator, { children: /* @__PURE__ */ i(Je, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
Eo.displayName = wt.CheckboxItem.displayName;
const _i = E.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  wt.RadioItem,
  {
    ref: r,
    className: y(
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ i(wt.ItemIndicator, { children: /* @__PURE__ */ i(yo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
_i.displayName = wt.RadioItem.displayName;
...
wr.displayName = wt.Label.displayName;
...
fr.displayName = wt.Separator.displayName;
...
function en(t, e = !0) {
  return e && (t = t.toUpperCase()), t in va ? va[t] : 0;
}
function Co(t) {
  return en(t) > 0;
}
...
function kc(t) {
  return Pi[t - 1].includes("*obsolete*");
}
function Ec() {
  const t = {};
...
var Di = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(Di || {});
const Tt = class ot {
  constructor(e, n, r, o) {
   ...
   */
  get book() {
    return ht.bookNumberToId(this.bookNum, "");
  }
  set book(e) {
    this.bookNum = ht.bookIdToNumber(e);
  }
  /**
  ...
  parse(e) {
    ...
    if (r.length !== 2 || ht.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !ot.isVerseParseable(r[1]))
      throw new ln("Invalid reference : " + e);
  ...
  allVerses(e = !1, n = ot.verseRangeSeparators, r = ot.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], a = ya(this._verse, r);
    for (const s of a.map((l) => ya(l, n))) {
      const l = this.clone();
      l.verse = s[0];
      const c = l.verseNum;
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > ht.lastBook ? 2 : (ht.isCanonical(this._bookNum), 0);
  }
  setEmpty(e = ot.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = e;
  }
  updateInternal(e, n, r) {
    this.bookNum = ht.bookIdToNumber(e), this.chapter = n, this.verse = r;
  }
};
nt(Tt, "defaultVersification", me.English), nt(Tt, "verseRangeSeparator", "-"), nt(Tt, "verseSequenceIndicator", ","), nt(Tt, "verseRangeSeparators", [Tt.verseRangeSeparator]), nt(Tt, "verseSequenceIndicators", [Tt.verseSequenceIndicator]), nt(Tt, "chapterDigitShifter", 1e3), nt(Tt, "bookDigitShifter", Tt.chapterDigitShifter * Tt.chapterDigitShifter), nt(Tt, "bcvMaxValue", Tt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
nt(Tt, "ValidStatusType", Di);
      ...
      children: [
        /* @__PURE__ */ i(
          "span",
          {
            ...
            children: ht.bookIdToEnglishName(t)
          }
        ),
...
const Ro = ht.allBookIds.filter((t) => !ht.isObsolete(ht.bookIdToNumber(t))), Tc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, xa = ["OT", "NT", "DC"], Rc = 96, Oc = [
  /^(\w+)$/i,
...
], cn = (t) => zl(ht.bookIdToNumber(t));
function _c() {
  return Ro.map((e) => ht.bookIdToEnglishName(e));
}
function Pc(t) {
...
function Ic(t) {
  ...
  if (Pc(e))
    return Ro.find((r) => ht.bookIdToEnglishName(r) === e);
}
function ih({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = Nt(), [a, s] = pt(""), [l, c] = pt(t.book), [d, p] = pt(t.chapterNum ?? 0), [f, w] = pt(t.book), [m, b] = pt(!1), [h, g] = pt(m), k = Ft(void 0), C = Ft(void 0), T = Ft(void 0), S = St(
    (j) => {
      const M = r ? r() : Ro;
      return {
        OT: M.filter((A) => ht.isBookOT(A)),
        NT: M.filter((A) => ht.isBookNT(A)),
        DC: M.filter((A) => ht.isBookDC(A))
      }[j].filter((A) => {
        const G = ht.bookIdToEnglishName(A).toLowerCase(), H = a.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (j, M, A, G) => {
      if (p(t.book !== j ? 1 : t.chapterNum), M || cn(j) === -1) {
        e({
          book: j,
          chapterNum: A || 1,
          verseNum: G || 1
    ...
    Oc.forEach((j) => {
      const M = a.match(j);
      if (M) {
        const [A, G = void 0, H = void 0] = M.slice(1), rt = Ic(A);
        (ht.isBookIdValid(A) || rt) && R(
          rt ?? A,
          !0,
          G ? parseInt(G, 10) : 1,
          H ? parseInt(H, 10) : 1
    ...
    (j) => {
      m ? (j.key === "ArrowDown" || j.key === "ArrowUp") && (typeof T < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      T.current !== null ? T.current.focus() : typeof C < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      C.current !== null && C.current.focus(), j.preventDefault()) : b(!0);
    },
    [m]
  ), tt = (j) => {
    const { key: M } = j;
  ...
  return ne(() => {
    l === f ? l === t.book ? p(t.chapterNum) : p(1) : p(0);
  }, [f, t.book, t.chapterNum, l]), ba(() => {
    g(m);
  }, [m]), ba(() => {
    const j = setTimeout(() => {
      if (h && C.current && T.current) {
        const A = T.current.offsetTop - Rc;
        C.current.scrollTo({ top: A, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(j);
    };
  }, [h]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ N(ko, { modal: !1, open: m, onOpenChange: F, children: [
    /* @__PURE__ */ i(Ri, { asChild: !0, children: /* @__PURE__ */ i(
      sc,
      {
        ref: k,
        value: a,
        ...
        handleKeyDown: D,
        handleOnClick: () => {
          c(t.book), w(t.book), p(t.chapterNum > 0 ? t.chapterNum : 0), b(!0), k.current.focus();
        },
        onFocus: () => {
          P.current = !0;
        },
        handleSubmit: L,
        placeholder: `${ht.bookIdToEnglishName(t.book)} ${t.chapterNum}:${t.verseNum}`,
        className: n
      }
    ) }),
    /* @__PURE__ */ i(
      ur,
      {
        ...
        ref: C,
        children: /* @__PURE__ */ i("div", { className: "rtl:tw-ps-2", children: xa.map((j, M) => {
          const A = S(j);
          return A.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ i(wr, { className: "tw-font-semibold tw-text-foreground/80", children: Tc[j] }),
            ...
            xa.length - 1 !== M ? /* @__PURE__ */ i(fr, {}) : void 0
          ] }, j);
        }) })
      }
    )
...
const $c = Re(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? Ze : "button", { className: y($c({ variant: e, size: n, className: t })), ref: a, ...o })
);
ut.displayName = "Button";
const Mc = Re(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Dt = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(vi.Root, { ref: n, className: y("pr-twp", Mc(), t), ...e }));
Dt.displayName = vi.Root.displayName;
...
ji.displayName = kn.Root.displayName;
const ao = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  kn.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ i(kn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ i(yo, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ao.displayName = kn.Item.displayName;
const Bi = En.Root, Vi = En.Trigger, Oo = E.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => {
  const a = Nt();
...
Oo.displayName = En.Content.displayName;
const Ac = Kt.Portal, zi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Kt.Overlay,
  {
    ref: n,
    className: y(
...
zi.displayName = Kt.Overlay.displayName;
const Dc = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(Ac, { children: [
    /* @__PURE__ */ i(zi, {}),
    /* @__PURE__ */ N(
      Kt.Content,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ N(
            Kt.Close,
            {
              ...
              children: [
                /* @__PURE__ */ i(xo, { className: "tw-h-4 tw-w-4" }),
...
Dc.displayName = Kt.Content.displayName;
...
jc.displayName = Kt.Title.displayName;
...
Bc.displayName = Kt.Description.displayName;
...
_o.displayName = Pt.displayName;
const Po = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ i(gi, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ i(
      Pt.Input,
      {
        ref: n,
...
Po.displayName = Pt.Input.displayName;
...
Io.displayName = Pt.List.displayName;
const $o = E.forwardRef((t, e) => /* @__PURE__ */ i(Pt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
$o.displayName = Pt.Empty.displayName;
...
Fi.displayName = Pt.Group.displayName;
...
Vc.displayName = Pt.Separator.displayName;
...
Mo.displayName = Pt.Item.displayName;
function zc(t) {
...
function io({
  ...
  const [g, k] = pt(!1);
  return /* @__PURE__ */ N(Bi, { open: g, onOpenChange: k, ...h, children: [
    /* @__PURE__ */ i(Vi, { asChild: !0, children: /* @__PURE__ */ N(
      ut,
      {
        variant: w,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ i(bi, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(
      Oo,
      {
        ...
        children: /* @__PURE__ */ N(_o, { children: [
          /* @__PURE__ */ i(Po, { placeholder: p, className: "tw-text-inherit" }),
          /* @__PURE__ */ i($o, { children: f }),
          /* @__PURE__ */ i(Io, { children: e.map((C) => /* @__PURE__ */ N(
            Mo,
            {
              value: l(C),
              onSelect: () => {
...
function lh({
  ...
  const p = Fr(d, "%webView_bookSelector_currentBook%"), f = Fr(d, "%webView_bookSelector_choose%"), w = Fr(d, "%webView_bookSelector_chooseBooks%"), [m, b] = pt(
    "current book"
    /* CURRENT_BOOK */
  ), h = (g) => {
    b(g), t(g);
    ...
    ji,
    {
      ...
      children: /* @__PURE__ */ N("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ i(Dt, { className: "tw-flex tw-items-center", children: r.map((g) => ht.bookIdToEnglishName(g)).join(", ") }),
          /* @__PURE__ */ i(
            ut,
            {
...
function Gc({ table: t }) {
  return /* @__PURE__ */ N(ko, { children: [
    /* @__PURE__ */ i(hl, { asChild: !0, children: /* @__PURE__ */ N(ut, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Le = vt.Root, Uc = vt.Group, Ge = vt.Value, ke = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(
    vt.Trigger,
    {
...
const Li = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  vt.ScrollUpButton,
  {
    ref: n,
...
Li.displayName = vt.ScrollUpButton.displayName;
...
Gi.displayName = vt.ScrollDownButton.displayName;
...
Yc.displayName = vt.Separator.displayName;
function Hc({ table: t }) {
...
function Kc({
  ...
  var g;
  const [l, c] = pt([]), [d, p] = pt([]), [f, w] = pt({}), [m, b] = pt({}), h = yi({
    data: e,
    columns: t,
    getCoreRowModel: Ni(),
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ i(Gc, { table: h }),
    /* @__PURE__ */ N(mr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(hr, { stickyHeader: a, children: h.getHeaderGroups().map((k) => /* @__PURE__ */ i(ce, { children: k.headers.map((C) => /* @__PURE__ */ i(Sn, { children: C.isPlaceholder ? void 0 : vn(C.column.columnDef.header, C.getContext()) }, C.id)) }, k.id)) }),
      /* @__PURE__ */ i(gr, { children: (g = h.getRowModel().rows) != null && g.length ? h.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        ce,
        {
          onClick: () => s(k, h),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((C) => /* @__PURE__ */ i(Ue, { children: vn(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        k.id
    ...
    n && r && /* @__PURE__ */ i(Hc, { table: h })
  ] });
}
const Pn = cr(({ className: t, ...e }, n) => /* @__PURE__ */ i(kl, { size: 35, className: y("tw-animate-spin", t), ...e, ref: n }));
...
function ch({
  ...
  return /* @__PURE__ */ i(
    ut,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(Pn, { size: 15 }) : /* @__PURE__ */ N(ae, { children: [
        /* @__PURE__ */ i(El, { size: 25, className: y("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
}
function dh({ isEnabling: t, handleClick: e, className: n, ...r }) {
  return /* @__PURE__ */ i(
    ut,
    {
      className: y(
      ...
      children: t ? /* @__PURE__ */ N(ae, { children: [
        /* @__PURE__ */ i(Pn, { size: 15, className: "tw-mr-1 tw-text-white" }),
        "Enabling..."
      ] }) : "Enable"
    }
  );
...
function ph({
  ...
  return /* @__PURE__ */ i(
    ut,
    {
      ...
      ...r,
      children: t ? /* @__PURE__ */ N(ae, { children: [
        /* @__PURE__ */ i(Pn, { size: 15, className: "tw-mr-1 tw-text-black" }),
        "Disabling..."
      ] }) : "Disable"
    }
  );
}
function uh({ isUpdating: t, handleClick: e, className: n, ...r }) {
  return /* @__PURE__ */ i(
    ut,
    {
      className: y(
...
function wh({ id: t, markdown: e, className: n, anchorTarget: r }) {
  const o = Rt(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ i("div", { id: t, className: y("pr-twp tw-prose", n), children: /* @__PURE__ */ i(ql, { options: o, children: e }) });
}
const Jc = cr((t, e) => /* @__PURE__ */ N(
  ut,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ i(Sl, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ i(
        dr,
        {
...
var Zc = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Zc || {});
function fh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ N(ko, { children: [
    /* @__PURE__ */ i(Ri, { asChild: !0, children: /* @__PURE__ */ i(Jc, {}) }),
    /* @__PURE__ */ i(ur, { children: e.map((n) => /* @__PURE__ */ N("div", { children: [
      /* @__PURE__ */ i(wr, { children: n.label }),
      /* @__PURE__ */ i(cc, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(Eo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(_i, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(fr, {})
    ] }, n.label)) })
  ] }) });
}
function mh({ id: t, message: e }) {
...
function hh({ id: t, category: e, downloads: n, languages: r, moreInfoUrl: o }) {
  const a = new Fl("en", {
    notation: "compact",
...
function Qc({ id: t, versionHistory: e }) {
  const [n, r] = pt(!1), o = /* @__PURE__ */ new Date();
  function a(l) {
...
function ed({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ i("div", { className: y("pr-twp", td({ variant: e }), t), ...n });
}
function nd({
  entries: t,
  ...
  const [p, f] = pt(!1), w = St(
    (h) => {
      var k;
      const g = (k = t.find((C) => C.label === h)) == null ? void 0 : k.value;
      g && r(
        n.includes(g) ? n.filter((C) => C !== g) : [...n, g]
      );
    },
    [t, n, r]
  ), m = () => s || o, b = Rt(() => {
    if (!l) return t;
    const h = t.filter((k) => k.starred).sort((k, C) => k.label.localeCompare(C.label)), g = t.filter((k) => !k.starred).sort((k, C) => {
      const T = n.includes(k.value), S = n.includes(C.value);
      return T && !S ? -1 : !T && S ? 1 : k.label.localeCompare(C.label);
    });
    return [...h, ...g];
  }, [t, n, l]);
  return /* @__PURE__ */ i("div", { className: d, children: /* @__PURE__ */ N(Bi, { open: p, onOpenChange: f, children: [
    /* @__PURE__ */ i(Vi, { asChild: !0, children: /* @__PURE__ */ N(
      ut,
      {
        variant: "ghost",
        ...
        children: [
          ...
          /* @__PURE__ */ i(bi, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(Oo, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ N(_o, { children: [
      /* @__PURE__ */ i(Po, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ N(Io, { children: [
        /* @__PURE__ */ i($o, { children: a }),
        /* @__PURE__ */ i(Fi, { children: b.map((h) => {
          ...
          return /* @__PURE__ */ N(
            Mo,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: h.starred && /* @__PURE__ */ i(Ol, { className: "tw-h-4 tw-w-4" }) }),
...
function bh({
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ i("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ N(ed, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ i(
          ut,
          {
            variant: "ghost",
            ...
            children: /* @__PURE__ */ i(xo, { className: "tw-h-3 tw-w-3" })
          }
        ),
...
function rd({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], a = Rt(() => {
    const s = [];
    return t.forEach((l) => {
      s.some((c) => No(c, l)) || s.push(l);
    }), s;
  }, [t]);
  return /* @__PURE__ */ N(mr, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(hr, { stickyHeader: !0, children: /* @__PURE__ */ N(ce, { children: [
    ...
    /* @__PURE__ */ i(gr, { children: a.length > 0 && a.map((s) => /* @__PURE__ */ N(
      ce,
      {
        ...
        children: [
          /* @__PURE__ */ i(Ue, { children: `${ht.bookIdToEnglishName(s.reference.book)} ${s.reference.chapterNum}:${s.reference.verseNum}` }),
...
Ao.displayName = ro.Root.displayName;
const Ui = Re(
...
), od = E.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ i(
  ki.Root,
  {
    ref: o,
    className: y(Ui({ variant: e, size: n, className: t })),
    ...r
  }
));
od.displayName = ki.Root.displayName;
const Xi = E.createContext({
  size: "default",
  variant: "default"
}), Yi = E.forwardRef(({ className: t, variant: e, size: n, children: r, ...o }, a) => {
  const s = Nt();
  return /* @__PURE__ */ i(
    pr.Root,
    {
...
const Jn = E.forwardRef(({ className: t, children: e, variant: n, size: r, ...o }, a) => {
  const s = E.useContext(Xi);
  return /* @__PURE__ */ i(
    pr.Item,
    {
      ref: a,
...
const br = (t) => t === "asc" ? /* @__PURE__ */ i($l, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Ml, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Al, { className: "tw-ms-2 tw-h-4 tw-w-4" }), vh = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ N(ut, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    br(e.getIsSorted())
  ] })
}), ad = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ N(ut, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    br(n.getIsSorted())
  ] })
}), yh = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ i("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ N(ut, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    br(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: a }) => /* @__PURE__ */ i("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ N(ut, { variant: "ghost", onClick: () => a.toggleSorting(void 0), children: [
    t,
    br(a.getIsSorted())
  ] }) }),
  cell: ({ row: a }) => {
    const s = a.getValue("status"), l = a.getValue("item");
    return /* @__PURE__ */ N(Yi, { value: s, variant: "outline", type: "single", children: [
      /* @__PURE__ */ i(
        Jn,
        {
          onClick: () => Lr(
  ...
  return e ? e[1] : "";
}, ld = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Nh = Object.freeze([
  ...
  if (!t) return [];
  const a = [];
  let s = e.book, l = e.chapterNum, c = e.verseNum;
  return id(t).forEach((p) => {
    p.startsWith("\\id") && (s = sd(p), l = 0, c = 0), p.startsWith("\\c") && (l = Na(p), c = 0), p.startsWith("\\v") && (c = Na(p), l === 0 && (l = e.chapterNum));
    let f = o.exec(p) ?? void 0;
    for (; f; ) {
      const w = [];
      f.forEach((g) => w.push(g));
      const m = f.index, b = a.find((g) => No(g.items, w)), h = {
        reference: {
          book: s !== void 0 ? s : "",
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: Gl(p, Math.max(0, m - 25), Math.min(m + 25, p.length))
      };
      if (b)
...
function kh({
  ...
  const f = te(n, "%webView_inventory_all%"), w = te(n, "%webView_inventory_approved%"), m = te(n, "%webView_inventory_unapproved%"), b = te(n, "%webView_inventory_unknown%"), h = te(n, "%webView_inventory_scope_currentBook%"), g = te(n, "%webView_inventory_scope_chapter%"), k = te(n, "%webView_inventory_scope_verse%"), C = te(n, "%webView_inventory_filter_text%"), T = te(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = pt(!1), [P, F] = pt("all"), [R, I] = pt(""), [L, D] = pt([]), tt = Rt(() => l ? r instanceof RegExp ? dd(l, t, a, s, r) : r(l, t, a, s) : [], [l, r, t, a, s]), J = Rt(() => {
    if (S) return tt;
    const x = [];
    return tt.forEach((O) => {
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ N("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      o && /* @__PURE__ */ N("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ i(Dt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? T })
      ] })
    ] }),
...
const Do = E.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ i(
  Ei.Root,
  {
    ref: o,
    decorative: n,
...
Do.displayName = Ei.Root.displayName;
...
const Hi = _n.Provider, qi = _n.Root, Wi = _n.Trigger, jo = E.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ i(
  _n.Content,
  {
    ref: r,
    sideOffset: e,
...
jo.displayName = _n.Content.displayName;
const pd = "16rem", ud = "3rem", Ki = E.createContext(void 0);
function vr() {
...
const Ji = E.forwardRef(
  ({
    ...
    const [d, p] = E.useState(t), f = e ?? d, w = E.useCallback(
      ...
      [n, f]
    ), m = E.useCallback(() => w((T) => !T), [w]), b = f ? "expanded" : "collapsed", k = Nt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = E.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: w,
    ...
    return /* @__PURE__ */ i(Ki.Provider, { value: C, children: /* @__PURE__ */ i(Hi, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const wd = E.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = vr();
  return /* @__PURE__ */ N(
    ut,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ i(Dl, {}) : /* @__PURE__ */ i(jl, {}),
...
const bd = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Do,
  {
    ref: n,
...
const vd = E.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? Ze : "button",
  {
    ref: r,
  ...
  ({
    ...
    const c = t ? Ze : "button", { state: d } = vr(), p = /* @__PURE__ */ i(
      c,
      {
        ...
        "data-size": r,
        "data-active": e,
        className: y(yd({ variant: n, size: r }), a),
        ...s
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ i(Wi, { asChild: !0, children: p }),
      /* @__PURE__ */ i(jo, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
rs.displayName = "SidebarMenuButton";
const xd = E.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ i(
  e ? Ze : "button",
  {
    ref: o,
...
const kd = E.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ i(ka, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ i(
          ka,
          {
...
const Cd = E.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ i(
  t ? Ze : "a",
  {
    ref: a,
    ...
    Zi,
    {
      ...
      children: /* @__PURE__ */ N(ts, { children: [
        /* @__PURE__ */ N(so, { children: [
          ...
          /* @__PURE__ */ i(co, { children: /* @__PURE__ */ i(es, { children: Object.entries(e).map(([w, m]) => /* @__PURE__ */ i(ns, { children: /* @__PURE__ */ i(
            rs,
            {
              className: y(
...
const se = "scrBook", Rd = "scrRef", he = "source", Od = "details", _d = "Scripture Reference", Pd = "Scripture Book", as = "Type", Id = "Details";
function $d(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ht.bookIdToEnglishName(o.start.book) : r.row.groupingColumnId === se ? Vr(o.start) : void 0;
      },
      getGroupingValue: (r) => ht.bookIdToNumber(r.start.book),
...
}, Ea = (t) => `${Md({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Sh({
  sources: t,
  ...
  const [c, d] = pt([]), [p, f] = pt([{ id: se, desc: !1 }]), [w, m] = pt({}), b = Rt(
  ...
  ne(() => {
    if (l) {
      ...
      if (I.length === 1) {
        const L = b.find((D) => Ea(D) === I[0]) || void 0;
        L && l(L);
      }
    }
  }, [w, b, l, g]);
  const k = o ?? Pd, C = a ?? as, T = [
    ...
    !e && /* @__PURE__ */ N(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ee, { position: "item-aligned", children: /* @__PURE__ */ i(Uc, { children: T.map((R) => /* @__PURE__ */ i(Vt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ N(mr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(hr, { children: g.getHeaderGroups().map((R) => /* @__PURE__ */ i(ce, { children: R.headers.filter((I) => I.column.columnDef.header).map((I) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ i(Sn, { colSpan: I.colSpan, className: "top-0 tw-sticky", children: I.isPlaceholder ? void 0 : /* @__PURE__ */ N("div", { children: [
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ N(
                      ut,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ i(vo, {}) : /* @__PURE__ */ i(Vl, {})),
                          " ",
      ...
      children: [
        ...
        /* @__PURE__ */ i(
          Ee,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((l) => /* @__PURE__ */ i(Vt, { value: `${l}`, children: a[dt(l)] }, `${l}`))
          }
        )
      ]
    }
...
is.displayName = It.List.displayName;
const ss = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.List,
  {
    ref: n,
    className: y(
...
const Ad = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Trigger,
  {
    ref: n,
    ...e,
...
)), ls = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Content,
  {
    ref: n,
    className: y(
...
ls.displayName = It.Content.displayName;
function _h({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(is, { children: [
      /* @__PURE__ */ i(ss, { children: t.map((s) => /* @__PURE__ */ i(Ad, { value: s.value, children: s.value }, s.key)) }),
      t.map((s) => /* @__PURE__ */ i(ls, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
const cs = E.createContext(void 0);
function Oe() {
  const t = E.useContext(cs);
  if (!t)
...
function Dd({ ...t }) {
  return /* @__PURE__ */ i(ft.Menu, { ...t });
}
function jd({ ...t }) {
  return /* @__PURE__ */ i(ft.Sub, { "data-slot": "menubar-sub", ...t });
}
const ds = E.forwardRef(({ className: t, variant: e = "default", ...n }, r) => {
  const o = E.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ i(cs.Provider, { value: o, children: /* @__PURE__ */ i(
    ft.Root,
    {
      ref: r,
      className: y(
...
ds.displayName = ft.Root.displayName;
const ps = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Oe();
  return /* @__PURE__ */ i(
    ft.Trigger,
    {
      ...
      className: y(
        ...
        // CUSTOM
        In({ variant: r.variant, className: t })
...
ps.displayName = ft.Trigger.displayName;
  ...
  return /* @__PURE__ */ N(
    ft.SubTrigger,
    {
      ...
      className: y(
        ...
        e && "tw-pl-8",
        In({ variant: a.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...r,
...
us.displayName = ft.SubTrigger.displayName;
const ws = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Oe();
  return /* @__PURE__ */ i(
    ft.SubContent,
    {
...
ws.displayName = ft.SubContent.displayName;
const fs = E.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: r = 8, ...o }, a) => {
  const s = Oe();
...
fs.displayName = ft.Content.displayName;
const ms = E.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ i(
    ft.Item,
    {
      ...
      className: y(
        ...
        e && "tw-pl-8",
        In({ variant: o.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...n
...
ms.displayName = ft.Item.displayName;
const Bd = E.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    ft.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(ft.ItemIndicator, { children: /* @__PURE__ */ i(Je, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Bd.displayName = ft.CheckboxItem.displayName;
const Vd = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ N(
    ft.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(ft.ItemIndicator, { children: /* @__PURE__ */ i(yo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Vd.displayName = ft.RadioItem.displayName;
const zd = E.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ i(
  ft.Label,
  {
    ref: r,
    className: y("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
zd.displayName = ft.Label.displayName;
const hs = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  ft.Separator,
  {
    ref: n,
    className: y("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
hs.displayName = ft.Separator.displayName;
const dn = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var r;
  ...
  return o.flatMap(([a], s) => {
    const l = e.filter((d) => d.group === a).sort((d, p) => d.order - p.order).map((d) => /* @__PURE__ */ i(Hi, { children: /* @__PURE__ */ N(qi, { children: [
      /* @__PURE__ */ i(Wi, { asChild: !0, children: "command" in d ? /* @__PURE__ */ i(
        ms,
        {
          onClick: () => {
            r(d);
        ...
        d.command
      ) : /* @__PURE__ */ N(jd, { children: [
        /* @__PURE__ */ i(us, { children: d.label }),
        /* @__PURE__ */ i(ws, { children: gs(
          t,
          e,
          Fd(t, d.id),
          r
      ...
      d.tooltip && /* @__PURE__ */ i(jo, { children: d.tooltip })
    ] }) })), c = [...l];
    return l.length > 0 && s < o.length - 1 && c.push(/* @__PURE__ */ i(hs, {}, `${a}-separator`)), c;
  });
};
function Ld({
  menuData: t,
  ...
  if (Wl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    var b, h, g, k;
    p.preventDefault();
    ...
    return /* @__PURE__ */ i(ds, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ N(Dd, { children: [
      /* @__PURE__ */ i(ps, { ref: d(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ i(
        fs,
        {
          className: "tw-z-[250]",
          children: gs(t.groups, t.items, p, e)
        }
      )
    ] }, p)) });
}
...
function $h({
  ...
  const c = Gd(
    ...
    var g, k, C, T, S, v;
    const h = b !== m ? ((k = (g = t[m]) == null ? void 0 : g.uiNames) == null ? void 0 : k[b]) ?? ((T = (C = t[m]) == null ? void 0 : C.uiNames) == null ? void 0 : T.en) : void 0;
...
function ee(t, e, n = {
  ...
  return ve(t) && ve(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ve(e[o]) && o in t && ve(t[o]) ? r[o] = ee(t[o], e[o], n) : n.clone ? r[o] = ve(e[o]) ? vs(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
var Un = { exports: {} }, Xn = { exports: {} }, at = {};
...
function Yd() {
  ...
  return at.AsyncMode = c, at.ConcurrentMode = d, at.ContextConsumer = l, at.ContextProvider = s, at.Element = e, at.ForwardRef = p, at.Fragment = r, at.Lazy = b, at.Memo = m, at.Portal = n, at.Profiler = a, at.StrictMode = o, at.Suspense = f, at.isAsyncMode = function(v) {
    return S(v) || T(v) === c;
  }, at.isConcurrentMode = S, at.isContextConsumer = function(v) {
    return T(v) === l;
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === a || v === o || v === f || v === w || typeof v == "object" && v !== null && (v.$$typeof === b || v.$$typeof === m || v.$$typeof === s || v.$$typeof === l || v.$$typeof === p || v.$$typeof === g || v.$$typeof === k || v.$$typeof === C || v.$$typeof === h);
  }, at.typeOf = T, at;
}
var it = {};
/** @license React v16.13.1
...
function Hd() {
  return Ta || (Ta = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function T($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === f || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === b || $.$$typeof === m || $.$$typeof === s || $.$$typeof === l || $.$$typeof === p || $.$$typeof === g || $.$$typeof === k || $.$$typeof === C || $.$$typeof === h);
    }
    function S($) {
    ...
    it.AsyncMode = v, it.ConcurrentMode = P, it.ContextConsumer = F, it.ContextProvider = R, it.Element = I, it.ForwardRef = L, it.Fragment = D, it.Lazy = tt, it.Memo = J, it.Portal = j, it.Profiler = M, it.StrictMode = A, it.Suspense = G, it.isAsyncMode = rt, it.isConcurrentMode = x, it.isContextConsumer = O, it.isContextProvider = U, it.isElement = X, it.isForwardRef = z, it.isFragment = K, it.isLazy = q, it.isMemo = W, it.isPortal = Y, it.isProfiler = Z, it.isStrictMode = Q, it.isSuspense = ct, it.isValidElementType = T, it.typeOf = S;
  }()), it;
}
var Ra;
function ys() {
  return Ra || (Ra = 1, process.env.NODE_ENV === "production" ? Xn.exports = Yd() : Xn.exports = Hd()), Xn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var qr, Pa;
function xs() {
  return Pa || (Pa = 1, qr = Function.call.bind(Object.prototype.hasOwnProperty)), qr;
}
var Wr, Ia;
function Wd() {
  if (Ia) return Wr;
  ...
  if (process.env.NODE_ENV !== "production") {
    var e = /* @__PURE__ */ Vo(), n = {}, r = /* @__PURE__ */ xs();
    t = function(a) {
      var s = "Warning: " + a;
...
function Kd() {
  if ($a) return Kr;
  $a = 1;
  var t = ys(), e = qd(), n = /* @__PURE__ */ Vo(), r = /* @__PURE__ */ xs(), o = /* @__PURE__ */ Wd(), a = function() {
  };
    ...
    function F(x) {
      ...
      function O(U, X, z, K, q) {
        for (var W = U[X], Y = 0; Y < x.length; Y++)
          if (b(W, x[Y]))
            return null;
        var Z = JSON.stringify(x, function(ct, $) {
          var kt = G($);
...
var Aa;
function Zd() {
  if (Aa) return Un.exports;
  if (Aa = 1, process.env.NODE_ENV !== "production") {
    var t = ys(), e = !0;
    Un.exports = /* @__PURE__ */ Kd()(t.isElement, e);
  } else
    Un.exports = /* @__PURE__ */ Jd()();
  return Un.exports;
}
var Qd = /* @__PURE__ */ Zd();
const u = /* @__PURE__ */ bs(Qd);
function tp(t) {
  const {
    prototype: e = {}
  } = t;
...
function Ns(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !tp(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const zo = Bo(u.element, Ns);
zo.isRequired = Bo(u.element.isRequired, Ns);
const ep = "exact-prop: ​";
function np(t) {
...
function rp() {
  ...
  return st.ContextConsumer = s, st.ContextProvider = a, st.Element = t, st.ForwardRef = c, st.Fragment = n, st.Lazy = w, st.Memo = f, st.Portal = e, st.Profiler = o, st.StrictMode = r, st.Suspense = d, st.SuspenseList = p, st.isAsyncMode = function() {
    return !1;
...
function op() {
  return ja || (ja = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), m = Symbol.for("react.offscreen"), b = !1, h = !1, g = !1, k = !1, C = !1, T;
    T = Symbol.for("react.module.reference");
    function S(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || C || V === r || V === d || V === p || k || V === m || b || h || g || typeof V == "object" && V !== null && (V.$$typeof === w || V.$$typeof === f || V.$$typeof === a || V.$$typeof === s || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    lt.ContextConsumer = P, lt.ContextProvider = F, lt.Element = R, lt.ForwardRef = I, lt.Fragment = L, lt.Lazy = D, lt.Memo = tt, lt.Portal = J, lt.Profiler = j, lt.StrictMode = M, lt.Suspense = A, lt.SuspenseList = G, lt.isAsyncMode = x, lt.isConcurrentMode = O, lt.isContextConsumer = U, lt.isContextProvider = X, lt.isElement = z, lt.isForwardRef = K, lt.isFragment = q, lt.isLazy = W, lt.isMemo = Y, lt.isPortal = Z, lt.isProfiler = Q, lt.isStrictMode = ct, lt.isSuspense = $, lt.isSuspenseList = kt, lt.isValidElementType = S, lt.typeOf = v;
  }()), lt;
}
var Ba;
function ap() {
  return Ba || (Ba = 1, process.env.NODE_ENV === "production" ? Yn.exports = rp() : Yn.exports = op()), Yn.exports;
}
var Va = ap();
const ip = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function sp(t) {
  const e = `${t}`.match(ip);
  return e && e[1] || "";
}
function ks(t, e = "") {
  return t.displayName || t.name || sp(t) || e;
}
function za(t, e, n) {
  const r = ks(e);
...
function lp(t) {
  if (t != null) {
    ...
    if (typeof t == "function")
      return ks(t, "Component");
    if (typeof t == "object")
      switch (t.$$typeof) {
        case Va.ForwardRef:
          return za(t, t.render, "ForwardRef");
        case Va.Memo:
          return za(t, t.type, "memo");
        default:
          return;
      }
  }
...
const Es = u.oneOfType([u.func, u.object]);
function Jt(t) {
  if (typeof t != "string")
...
function gp(t, e) {
  const n = B.useRef(Ga);
  return n.current === Ga && (n.current = t(e)), n;
}
const bp = [];
function vp(t) {
  B.useEffect(t, bp);
...
function Sp(t) {
  t.addEventListener("keydown", kp, !0), t.addEventListener("mousedown", Zr, !0), t.addEventListener("pointerdown", Zr, !0), t.addEventListener("touchstart", Zr, !0), t.addEventListener("visibilitychange", Ep, !0);
}
function Cp(t) {
  const {
    target: e
...
function Ts() {
  ...
  function n() {
    return e.current ? (uo = !0, yp.start(100, () => {
      uo = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function Pp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = Et(t, Op), a = _p(e), s = Object.keys(a);
  function l(w) {
...
function yt(t) {
  const {
    ...
    return re(s, l, (f) => {
      let w = rr(d, o, f);
      return f === w && typeof f == "string" && (w = rr(d, o, `${e}${f === "default" ? "" : Jt(f)}`, f)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
const Dp = {
  ...
  if (t.length > 2)
    if (Ya[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = Dp[e], o = jp[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), kr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Er = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Vp = [...kr, ...Er];
function Mn(t, e, n, r) {
  var o;
...
function Fp(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = Bp(n), a = zp(o, r), s = t[n];
  return re(t, s, a);
}
function $s(t, e) {
  const n = Is(t.theme);
  return Object.keys(t).map((r) => Fp(t, e, r, n)).reduce(yn, {});
}
function gt(t) {
  return $s(t, kr);
}
...
bt.filterProps = Er;
process.env.NODE_ENV !== "production" && Vp.reduce((t, e) => (t[e] = de, t), {});
function Lp(t = 8) {
  if (t.mui)
    return t;
  const e = Is({
...
const Gp = Xt("border", zt), Up = Xt("borderTop", zt), Xp = Xt("borderRight", zt), Yp = Xt("borderBottom", zt), Hp = Xt("borderLeft", zt), qp = Xt("borderColor"), Wp = Xt("borderTopColor"), Kp = Xt("borderRightColor"), Jp = Xt("borderBottomColor"), Zp = Xt("borderLeftColor"), Qp = Xt("outline", zt), tu = Xt("outlineColor"), Cr = (t) => {
...
Sr(Gp, Up, Xp, Yp, Hp, qp, Wp, Kp, Jp, Zp, Cr, Qp, tu);
const Tr = (t) => {
...
Sr(Tr, Rr, Or, eu, nu, ru, ou, au, iu, su, lu, cu);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const du = yt({
...
function xu() {
  function t(n, r, o, a) {
    ...
    return f ? f(s) : re(s, r, (b) => {
      let h = rr(w, p, b);
      return b === h && typeof b == "string" && (h = rr(w, p, `${n}${b === "default" ? "" : Jt(b)}`, b)), c === !1 ? h : {
        [c]: h
      };
    });
  }
...
function Xo(t = {}, ...e) {
  ...
  return d.applyStyles = Nu, d = e.reduce((p, f) => ee(p, f), d), d.unstable_sxConfig = _({}, Uo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return _r({
      sx: f,
      theme: this
    });
...
const Cu = ["ownerState"], Tu = ["variants"], Ru = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Ou(t) {
  return Object.keys(t).length === 0;
}
function _u(t) {
...
const Pu = Xo(), Ha = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Hn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function $u(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    Zl(s, (v) => v.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = Iu(Ha(d))
    } = l, m = Et(l, Ru), b = p !== void 0 ? p : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), h = f || !1;
    let g;
    process.env.NODE_ENV !== "production" && c && (g = `${c}-${Ha(d || "Root")}`);
    let k = Zn;
    d === "Root" || d === "root" ? k = r : d ? k = o : _u(s) && (k = void 0);
    const C = Kl(s, _({
      shouldForwardProp: k,
      label: g
    }, m)), T = (v) => typeof v == "function" && v.__emotion_real !== v || ve(v) ? (P) => Qn(v, _({}, P, {
      theme: Hn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Jt(d || "")}`), D === void 0 && (D = `Styled(${lp(s)})`), L.displayName = D;
      }
...
function Mu(t) {
  ...
  return !e || !e.components || !e.components[n] || !e.components[n].defaultProps ? r : Rs(e.components[n].defaultProps, r);
}
function Au({
  props: t,
  name: e,
...
function qa(t) {
  t = Ce(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Ce(ju(t)).values : t.values;
...
function Ds(t, e) {
  return t = Ce(t), e = Yo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, Pr(t);
}
function Bu(t, e) {
  if (t = Ce(t), e = Yo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
const Tn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, Lu = ["mode", "contrastThreshold", "tonalOffset"], Ka = {
...
function Wu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Et(t, Lu), a = t.primary || Gu(e), s = t.secondary || Uu(e), l = t.error || Xu(e), c = t.info || Yu(e), d = t.success || Hu(e), p = t.warning || qu(e);
  function f(h) {
    const g = Wa(h, Qr.text.primary) >= n ? Qr.text.primary : Ka.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Wa(h, g);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ja(h, "light", C, r), Ja(h, "dark", T, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, m = {
    dark: Qr,
    light: Ka
  };
...
function Zu(t, e) {
  ...
  const m = o / 14, b = f || ((k) => `${k / d * m}rem`), h = (k, C, T, S, v) => _({
    fontFamily: r,
    fontWeight: k,
    fontSize: b(C),
...
const Qu = 0.2, tw = 0.14, ew = 0.12;
function mt(...t) {
  return [`${t[0]}px ${t[1]}px ${t[2]}px ${t[3]}px rgba(0,0,0,${Qu})`, `${t[4]}px ${t[5]}px ${t[6]}px ${t[7]}px rgba(0,0,0,${tw})`, `${t[8]}px ${t[9]}px ${t[10]}px ${t[11]}px rgba(0,0,0,${ew})`].join(",");
}
const nw = ["none", mt(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), mt(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), mt(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), mt(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), mt(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), mt(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), mt(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), mt(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), mt(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), mt(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), mt(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), mt(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), mt(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), mt(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), mt(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), mt(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), mt(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), mt(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), mt(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), mt(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), mt(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), mt(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), mt(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), mt(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], rw = ["duration", "easing", "delay"], ow = {
...
function sw(t) {
  const e = _({}, ow, t.easing), n = _({}, aw, t.duration);
  return _({
    getAutoHeightDuration: iw,
    create: (o = ["all"], a = {}) => {
      const {
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((p) => `${p} ${typeof s == "string" ? s : ti(s)} ${l} ${typeof c == "string" ? c : ti(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
const lw = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, cw = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function dw(t = {}, ...e) {
  const {
    mixins: n = {},
    palette: r = {},
...
const pw = (t) => Zn(t) && t !== "classes", Dn = $u({
  themeId: qo,
  defaultTheme: Ho,
...
const ww = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], fw = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
...
}), or = /* @__PURE__ */ B.forwardRef(function(e, n) {
  const r = Wo({
    props: e,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, m = Et(r, ww), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", h = _({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function js(t, e) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${e}Icon`), n.muiName = or.muiName, /* @__PURE__ */ B.memo(/* @__PURE__ */ B.forwardRef(n));
}
const hw = {
  configure: (t) => {
...
`)), Os.configure(t);
  ...
  ownerDocument: er,
  ownerWindow: wp,
  requirePropFactory: fp,
  setRef: nr,
  unstable_ClassNameGenerator: hw,
...
}, Symbol.toStringTag, { value: "Module" })), bw = /* @__PURE__ */ Ud(gw);
var ei;
function vw() {
...
function yw() {
  ...
  var e = t(/* @__PURE__ */ vw()), n = wl;
  return pn.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), pn;
}
var xw = /* @__PURE__ */ yw();
const Nw = /* @__PURE__ */ bs(xw);
function kw(t) {
  return typeof t == "string";
}
function gn(t, e, n) {
  return t === void 0 || kw(t) ? e : _({}, e, {
    ownerState: _({}, e.ownerState, n)
  });
}
const Ew = {
  disableDefaultClasses: !1
}, Sw = /* @__PURE__ */ B.createContext(Ew);
function Cw(t) {
  const {
...
function Ow(t) {
  ...
  const s = Tw(_({}, o, r)), l = ri(r), c = ri(o), d = e(s), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
  return p.length > 0 && (w.className = p), Object.keys(f).length > 0 && (w.style = f), {
    props: w,
    internalRef: d.ref
  };
}
const _w = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function Pw(t) {
  var e;
  const {
    elementType: n,
...
process.env.NODE_ENV !== "production" && (ar.propTypes = {
   ...
   */
  container: u.oneOfType([Cn, u.func]),
  /**
...
process.env.NODE_ENV !== "production" && (ar.propTypes = np(ar.propTypes));
var Ot = "top", Gt = "bottom", Ut = "right", _t = "left", Ko = "auto", jn = [Ot, Gt, Ut, _t], He = "start", Rn = "end", Dw = "clippingParents", Vs = "viewport", wn = "popper", jw = "reference", oi = /* @__PURE__ */ jn.reduce(function(t, e) {
  return t.concat([e + "-" + He, e + "-" + Rn]);
}, []), zs = /* @__PURE__ */ [].concat(jn, [Ko]).reduce(function(t, e) {
  return t.concat([e, e + "-" + He, e + "-" + Rn]);
}, []), Bw = "beforeRead", Vw = "read", zw = "afterRead", Fw = "beforeMain", Lw = "main", Gw = "afterMain", Uw = "beforeWrite", Xw = "write", Yw = "afterWrite", Hw = [Bw, Vw, zw, Fw, Lw, Gw, Uw, Xw, Yw];
function Zt(t) {
...
var xe = Math.max, ir = Math.min, qe = Math.round;
function wo() {
...
function We(t, e, n) {
  ...
  var s = Te(t) ? jt(t) : window, l = s.visualViewport, c = !Fs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function Ir(t) {
  return Zt(t) === "html" ? t : (
    ...
    (Jo(t) ? t.host : null) || // ShadowRoot detected
...
function Zw(t) {
  ...
  var o = Ir(t);
  for (Jo(o) && (o = o.host); Lt(o) && ["html", "body"].indexOf(Zt(o)) < 0; ) {
    var a = oe(o);
...
function Bn(t) {
  for (var e = jt(t), n = ai(t); n && Jw(n) && oe(n).position === "static"; )
    n = ai(n);
  return n && (Zt(n) === "html" || Zt(n) === "body" && oe(n).position === "static") ? e : n || Zw(t) || e;
}
function Qo(t) {
...
var tf = function(e, n) {
  ...
  })) : e, Us(typeof e != "number" ? e : Xs(e, jn));
};
function ef(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Wt(n.placement), c = Qo(l), d = [_t, Ut].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !s)) {
    var f = tf(o.padding, n), w = Zo(a), m = c === "y" ? Ot : _t, b = c === "y" ? Gt : Ut, h = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = Bn(a), C = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, T = h / 2 - g / 2, S = f[m], v = C - w[p] - f[b], P = C / 2 - w[p] / 2 + T, F = xn(S, P, v), R = c;
    n.modifiersData[r] = (e = {}, e[R] = F, e.centerOffset = F - P, e);
  }
}
function nf(t) {
  var e = t.state, n = t.options, r = n.element, o = r === void 0 ? "[data-popper-arrow]" : r;
  o != null && (typeof o == "string" && (o = e.elements.popper.querySelector(o), !o) || Ls(e.elements.popper, o) && (e.elements.arrow = o));
}
const rf = {
  name: "arrow",
  enabled: !0,
...
function ii(t) {
  ...
  m = g.x, h = g.y;
  var k = s.hasOwnProperty("x"), C = s.hasOwnProperty("y"), T = _t, S = Ot, v = window;
  if (d) {
    var P = Bn(n), F = "clientHeight", R = "clientWidth";
    if (P === jt(n) && (P = pe(n), oe(P).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), P = P, o === Ot || (o === _t || o === Ut) && a === Rn) {
      S = Gt;
  ...
  if (m = tt.x, h = tt.y, c) {
    var J;
    return Object.assign({}, D, (J = {}, J[S] = C ? "0" : "", J[T] = k ? "0" : "", J.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + h + "px)" : "translate3d(" + m + "px, " + h + "px, 0)", J));
  }
  return Object.assign({}, D, (e = {}, e[S] = C ? h + "px" : "", e[T] = k ? m + "px" : "", e.transform = "", e));
}
function sf(t) {
  ...
  e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, ii(Object.assign({}, d, {
    offsets: e.modifiersData.popperOffsets,
    position: e.options.strategy,
    adaptive: s,
    roundOffsets: c
  })))), e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, ii(Object.assign({}, d, {
...
function ea(t) {
  return We(pe(t)).left + ta(t).scrollLeft;
}
function wf(t, e) {
...
function ff(t) {
  var e, n = pe(t), r = ta(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = xe(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = xe(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + ea(t), c = -r.scrollTop;
...
function Ys(t) {
  return ["html", "body", "#document"].indexOf(Zt(t)) >= 0 ? t.ownerDocument.body : Lt(t) && na(t) ? t : Ys(Ir(t));
}
function Nn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Ys(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = jt(r), s = o ? [a].concat(a.visualViewport || [], na(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function li(t, e, n) {
  return e === Vs ? fo(wf(t, n)) : Te(e) ? mf(e, n) : fo(ff(pe(t)));
}
function hf(t) {
  var e = Nn(Ir(t)), n = ["absolute", "fixed"].indexOf(oe(t).position) >= 0, r = n && Lt(t) ? Bn(t) : t;
  return Te(r) ? e.filter(function(o) {
    return Te(o) && Ls(o, r) && Zt(o) !== "body";
  }) : [];
}
function gf(t, e, n, r) {
  var o = e === "clippingParents" ? hf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var p = li(t, d, r);
    return c.top = xe(p.top, c.top), c.right = ir(p.right, c.right), c.bottom = ir(p.bottom, c.bottom), c.left = xe(p.left, c.left), c;
  }, li(t, s, r));
...
function On(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Dw : l, d = n.rootBoundary, p = d === void 0 ? Vs : d, f = n.elementContext, w = f === void 0 ? wn : f, m = n.altBoundary, b = m === void 0 ? !1 : m, h = n.padding, g = h === void 0 ? 0 : h, k = Us(typeof g != "number" ? g : Xs(g, jn)), C = w === wn ? jw : wn, T = t.rects.popper, S = t.elements[b ? C : w], v = gf(Te(S) ? S : S.contextElement || pe(t.elements.popper), c, p, s), P = We(t.elements.reference), F = Hs({
    reference: P,
    element: T,
    placement: o
  }), R = fo(Object.assign({}, T, F)), I = w === wn ? R : P, L = {
...
function bf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? zs : c, p = Ke(r), f = p ? l ? oi : oi.filter(function(b) {
    return Ke(b) === p;
  }) : jn, w = f.filter(function(b) {
...
function yf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, m = n.flipVariations, b = m === void 0 ? !0 : m, h = n.allowedAutoPlacements, g = e.options.placement, k = Wt(g), C = k === g, T = c || (C || !b ? [tr(g)] : vf(g)), S = [g].concat(T).reduce(function(z, K) {
      return z.concat(Wt(K) === Ko ? bf(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
...
function Nf(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, s = On(e, {
    ...
    altBoundary: !0
  }), c = ci(s, r), d = ci(l, o, a), p = di(c), f = di(d);
  e.modifiersData[n] = {
...
function Sf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, s = zs.reduce(function(p, f) {
    return p[f] = Ef(f, e.rects, a), p;
...
function _f(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, m = w === void 0 ? !0 : w, b = n.tetherOffset, h = b === void 0 ? 0 : b, g = On(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Wt(e.placement), C = Ke(e.placement), T = !C, S = Qo(k), v = Of(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof h == "function" ? h(Object.assign({}, e.rects, {
    placement: e.placement
  })) : h, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    if (a) {
      var J, j = S === "y" ? Ot : _t, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = P[S], H = G + g[j], rt = G - g[M], x = m ? -R[A] / 2 : 0, O = C === He ? F[A] : R[A], U = C === He ? -R[A] : -F[A], X = e.elements.arrow, z = m && X ? Zo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Gs(), q = K[j], W = K[M], Y = xn(0, F[A], z[A]), Z = T ? F[A] / 2 - x - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = T ? -F[A] / 2 + x + Y + W + L.mainAxis : U + Y + W + L.mainAxis, ct = e.elements.arrow && Bn(e.elements.arrow), $ = ct ? S === "y" ? ct.clientTop || 0 : ct.clientLeft || 0 : 0, kt = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - kt - $, xt = G + Q - kt, Yt = xn(m ? ir(H, V) : H, G, m ? xe(rt, xt) : rt);
      P[S] = Yt, tt[S] = Yt - G;
    }
    if (l) {
      var ue, Ct = S === "x" ? Ot : _t, Vn = S === "x" ? Gt : Ut, Ht = P[v], _e = v === "y" ? "height" : "width", we = Ht + g[Ct], Pe = Ht - g[Vn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = Ie ? we : Ht - F[_e] - R[_e] - $e + L.altAxis, nn = Ie ? Ht + F[_e] + R[_e] - $e - L.altAxis : Pe, zn = m && Ie ? Qw(fe, Ht, nn) : xn(m ? fe : we, Ht, m ? nn : Pe);
      P[v] = zn, tt[v] = zn - Ht;
    }
...
function Af(t, e, n) {
  n === void 0 && (n = !1);
  var r = Lt(e), o = Lt(e) && Mf(e), a = pe(e), s = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  na(a)) && (l = $f(e)), Lt(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = ea(a))), {
...
function zf(t) {
  t === void 0 && (t = {});
  var e = t, n = e.defaultModifiers, r = n === void 0 ? [] : n, o = e.defaultOptions, a = o === void 0 ? pi : o;
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        h(), p.options = Object.assign({}, a, p.options, C), p.scrollParents = {
          reference: Te(l) ? Nn(l) : l.contextElement ? Nn(l.contextElement) : [],
          popper: Nn(c)
        };
        var T = jf(Vf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          var k = p.elements, C = k.reference, T = k.popper;
          if (ui(C, T)) {
            p.rects = {
              reference: Af(C, Bn(T), p.options.strategy === "fixed"),
              popper: Zo(T)
    ...
    function b() {
      p.orderedModifiers.forEach(function(g) {
        var k = g.name, C = g.options, T = C === void 0 ? {} : C, S = g.effect;
...
var Ff = [df, Rf, lf, Kw, Cf, xf, Pf, rf, kf], Lf = /* @__PURE__ */ zf({
  defaultModifiers: Ff
});
const Gf = "Popper";
function Uf(t) {
...
const Xf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Yf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Hf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Wf = () => Fo({
  root: ["root"]
}, Cw(Uf)), Kf = {}, Jf = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, g = Et(e, Xf), k = B.useRef(null), C = Se(k, n), T = B.useRef(null), S = Se(T, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
  }, [S]), B.useImperativeHandle(w, () => T.current, []);
  const P = Hf(p, s), [F, R] = B.useState(P), [I, L] = B.useState(sr(o));
  B.useEffect(() => {
...
`));
  ...
  const tt = Wf(), J = (r = b.root) != null ? r : "div", j = Pw({
    elementType: J,
...
}), qs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  const {
    anchorEl: r,
    children: o,
    container: a,
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, C = Et(e, Yf), [T, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
  ...
  if (a)
    ...
    const L = sr(r);
    F = L && $r(L) ? er(L).body : er(null).body;
  }
  const R = !p && c && (!h || T) ? "none" : void 0, I = h ? {
    in: p,
    onEnter: v,
    onExited: P
  } : void 0;
...
process.env.NODE_ENV !== "production" && (qs.propTypes = {
   ...
   */
  anchorEl: Bo(u.oneOfType([Cn, u.object, u.func]), (t) => {
    if (t.open) {
...
function Ws() {
  const t = As(Ho);
  return process.env.NODE_ENV !== "production" && B.useDebugValue(t), t[qo] || t;
}
function mo(t, e) {
...
var tm = function(e) {
  return e.scrollTop;
}, bn = "unmounted", ge = "exited", be = "entering", ze = "entered", ho = "exiting", ie = /* @__PURE__ */ function(t) {
  Zf(e, t);
  function e(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    var a = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Gn.findDOMNode(this), l], d = c[0], p = c[1], f = this.getTimeouts(), w = l ? f.appear : f.enter;
    if (!o && !s || wi.disabled) {
      this.safeSetState({
        status: ze
      }, function() {
    ...
    return (
      ...
      /* @__PURE__ */ E.createElement(Ks.Provider, {
        value: null
...
const rm = {
...
}, to = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), lr = /* @__PURE__ */ B.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = Et(e, nm), C = hn(), T = B.useRef(), S = Ws(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
    ...
    let x;
    h === "auto" ? (x = S.transitions.getAutoHeightDuration(M.clientHeight), T.current = x) : x = G, M.style.transition = [S.transitions.create("opacity", {
      duration: x,
      delay: H
    ...
    let rt;
    h === "auto" ? (rt = S.transitions.getAutoHeightDuration(M.clientHeight), T.current = rt) : rt = A, M.style.transition = [S.transitions.create("opacity", {
      duration: rt,
      delay: G
    }), S.transitions.create("transform", {
  ...
  return /* @__PURE__ */ i(g, _({
    ...
    onExiting: D,
    addEndListener: (M) => {
      h === "auto" && C.start(T.current || 0, M), r && r(v.current, M);
    },
...
lr.muiSupportAuto = !0;
const om = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], am = Dn(qs, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (t, e) => e.root
})({}), ra = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const o = Ms(), a = Wo({
    props: e,
    name: "MuiPopper"
    ...
    slots: T,
    slotProps: S
  } = a, v = Et(a, om), P = (r = T == null ? void 0 : T.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
process.env.NODE_ENV !== "production" && (ra.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: u.oneOfType([Cn, u.object, u.func]),
  /**
   * Popper render function or node.
   */
  children: u.oneOfType([u.node, u.func]),
...
const le = Ps("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), sm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function lm(t) {
  return Math.round(t * 1e5) / 1e5;
}
const cm = (t) => {
...
const Js = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r, o, a, s, l, c, d, p, f, w, m, b, h, g, k, C, T, S, v;
  const P = Wo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    slots: Q = {},
    title: ct,
    TransitionComponent: $ = lr,
    TransitionProps: kt
  } = P, V = Et(P, sm), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
  }), Yt = Ws(), ue = Yt.direction === "rtl", [Ct, Vn] = B.useState(), [Ht, _e] = B.useState(null), we = B.useRef(!1), Pe = j || rt, Ie = hn(), $e = hn(), fe = hn(), nn = hn(), [zn, oa] = Cs({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    B.useEffect(() => {
      Ct && Ct.disabled && !et && ct !== "" && Ct.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [ct, Ct, et]);
  }
  const Mr = Ss(x), rn = B.useRef(), Fn = po(() => {
    rn.current !== void 0 && (document.body.style.WebkitUserSelect = rn.current, rn.current = void 0), nn.clear();
  });
  B.useEffect(() => Fn, [Fn]);
  const aa = (et) => {
    mi.clear(), Wn = !0, oa(!0), z && !Qt && z(et);
  }, Ln = po(
    /**
    ...
    (et) => {
      mi.start(800 + O, () => {
        Wn = !1;
      }), oa(!1), X && Qt && X(et), Ie.start(Yt.transitions.duration.shortest, () => {
        we.current = !1;
      });
    }
  ), Ar = (et) => {
    we.current && et.type !== "touchstart" || (Ct && Ct.removeAttribute("title"), $e.clear(), fe.clear(), A || Wn && G ? $e.start(Wn ? G : A, () => {
      aa(et);
    }) : aa(et));
  }, ia = (et) => {
    $e.clear(), fe.start(O, () => {
    ...
    onFocus: nl,
    ref: rl
  } = Ts(), [, la] = B.useState(!1), ca = (et) => {
    el(et), sa.current === !1 && (la(!1), ia(et));
  }, da = (et) => {
    Ct || Vn(et.currentTarget), nl(et), sa.current === !0 && (la(!0), Ar(et));
  }, pa = (et) => {
    we.current = !0;
    const $t = xt.props;
    $t.onTouchStart && $t.onTouchStart(et);
  }, ua = Ar, wa = ia, ol = (et) => {
    pa(et), fe.clear(), Ie.clear(), Fn(), rn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", nn.start(H, () => {
      document.body.style.WebkitUserSelect = rn.current, Ar(et);
    });
  }, al = (et) => {
    xt.props.onTouchEnd && xt.props.onTouchEnd(et), Fn(), fe.start(U, () => {
      Ln(et);
    });
  };
  B.useEffect(() => {
    if (!Qt)
      return;
    function et($t) {
      ($t.key === "Escape" || $t.key === "Esc") && Ln($t);
    }
    return document.addEventListener("keydown", et), () => {
      document.removeEventListener("keydown", et);
    };
  }, [Ln, Qt]);
  const il = Se(xt.ref, rl, Vn, n);
  !ct && ct !== 0 && (Qt = !1);
  const Dr = B.useRef(), sl = (et) => {
    const $t = xt.props;
    $t.onMouseMove && $t.onMouseMove(et), fn = {
      x: et.clientX,
      y: et.clientY
    }, Dr.current && Dr.current.update();
  }, on = {}, jr = typeof ct == "string";
  D ? (on.title = !Qt && jr && !J ? ct : null, on["aria-describedby"] = Qt ? Mr : null) : (on["aria-label"] = jr ? ct : null, on["aria-labelledby"] = Qt && !jr ? Mr : null);
...
`));
  ...
  const an = {};
  M || (Bt.onTouchStart = ol, Bt.onTouchEnd = al), J || (Bt.onMouseOver = Kn(ua, Bt.onMouseOver), Bt.onMouseLeave = Kn(wa, Bt.onMouseLeave), Pe || (an.onMouseOver = ua, an.onMouseLeave = wa)), tt || (Bt.onFocus = Kn(da, Bt.onFocus), Bt.onBlur = Kn(ca, Bt.onBlur), Pe || (an.onFocus = da, an.onBlur = ca)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const ll = B.useMemo(() => {
    var et;
    let $t = [{
    ...
    touch: we.current
  }), Br = cm(sn), fa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : dm, ma = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : lr, ha = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : pm, ga = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : um, cl = gn(fa, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ye(Br.popper, Y == null ? void 0 : Y.className, (m = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : m.className)
  }), sn), dl = gn(ma, _({}, kt, (h = Z.transition) != null ? h : L.transition), sn), pl = gn(ha, _({}, (g = Z.tooltip) != null ? g : L.tooltip, {
    className: ye(Br.tooltip, (k = (C = Z.tooltip) != null ? C : L.tooltip) == null ? void 0 : k.className)
  }), sn), ul = gn(ga, _({}, (T = Z.arrow) != null ? T : L.arrow, {
    className: ye(Br.arrow, (S = (v = Z.arrow) != null ? v : L.arrow) == null ? void 0 : S.className)
  }), sn);
  return /* @__PURE__ */ N(B.Fragment, {
    children: [/* @__PURE__ */ B.cloneElement(xt, Bt), /* @__PURE__ */ i(fa, _({
      as: W ?? ra,
      placement: q,
      anchorEl: rt ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(ha, _({}, pl, {
          children: [ct, F ? /* @__PURE__ */ i(ga, _({}, ul, {
            ref: _e
          })) : null]
        }))
      }))
...
function hi(t, e, n) {
  return t ? /* @__PURE__ */ i(Si, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ i("img", { src: t, alt: `${n ? "Leading" : "Trailing"} icon for ${e}` }) }) : void 0;
}
function Zs(t) {
  const {
    onClick: e,
    ...
    Ql,
    {
      ...
      children: n ? /* @__PURE__ */ N(ae, { children: [
        ...
        f ? /* @__PURE__ */ i(Si, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(Nw, {}) }) : hi(s, n, !1)
      ] }) : g
    }
  );
  return r ? /* @__PURE__ */ i(Js, { title: r, placement: "right", children: /* @__PURE__ */ i("div", { children: k }) }) : k;
}
function Qs(t) {
  return Object.entries(t.groups).map(([n, r]) => ({ id: n, group: r }));
}
function wm(t) {
  const [e, n] = pt(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = t, s = (d) => {
    n(d.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
...
const fm = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function tl(t) {
...
function gm({ commandHandler: t, className: e, multiColumnMenu: n, id: r }) {
...
const bo = (t, e, n = {}) => {
  ...
  const [a, s] = pt(() => r.current), [l, c] = pt(!0);
  return ne(() => {
    let d = !0;
    return c(!!t), (async () => {
      if (t) {
...
), xm = E.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: y(ym({ variant: e }), t), ...n }));
...
const km = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("div", { ref: n, className: y("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Em.displayName = Qe.Root.displayName;
const Sm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Qe.Image,
  {
    ref: n,
...
Sm.displayName = Qe.Image.displayName;
...
Cm.displayName = Qe.Fallback.displayName;
...
const _m = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const $m = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ N(
    mn.Root,
    {
...
$m.displayName = mn.Root.displayName;
const Mm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    oo.Root,
    {
...
Mm.displayName = oo.Root.displayName;
const Vh = It.Root, Am = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    It.List,
    {
...
Am.displayName = It.List.displayName;
const Dm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Trigger,
  {
    ref: n,
    className: y(
...
Dm.displayName = It.Trigger.displayName;
const jm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Content,
  {
    ref: n,
    className: y(
...
jm.displayName = It.Content.displayName;
const zh = (t, e) => {
  ne(() => {
    if (!t) return () => {
    };
...
export {
  ...
  Oi as DropdownMenuItem,
  Zc as DropdownMenuItemType,
  ...
  Zs as MenuItem,
  hh as MoreInfo,
  nd as MultiSelectComboBox,
  _h as NavigationContentSearch,
  mh as NoExtensionsFound,
  Bi as Popover,
  ...
  is as VerticalTabs,
  ls as VerticalTabsContent,
  ss as VerticalTabsList,
  Ad as VerticalTabsTrigger,
  td as badgeVariants,
  $c as buttonVariants,
  y as cn,
  sd as getBookIdFromUSFM,
  id as getLinesFromUSFM,
