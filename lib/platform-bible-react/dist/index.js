import { jsx as r, jsxs as l, Fragment as wn } from "react/jsx-runtime";
import p, { forwardRef as Re, createContext as sr, useContext as ir, useCallback as U, useState as j, useRef as q, useEffect as it, useLayoutEffect as Ze, useMemo as et, Fragment as ln } from "react";
...
import { ChevronRight as Ee, Check as Ct, Circle as De, X as Ve, Search as dn, ChevronsUpDown as Me, FilterIcon as cr, ChevronDown as Wt, ChevronUp as pr, ArrowLeftIcon as ur, ChevronLeftIcon as mr, ChevronRightIcon as hr, ArrowRightIcon as fr, Filter as gr, User as br, Link as vr, CircleHelp as xr, Star as yr, CircleCheckIcon as Nr, CircleXIcon as kr, CircleHelpIcon as Cr, ArrowUpIcon as _r, ArrowDownIcon as Sr, ArrowUpDownIcon as Tr, PanelLeft as Rr, PanelRight as Er, ScrollText as Dr, ChevronLeft as Vr, MenuIcon as Mr, Menu as zr, EllipsisVertical as Or, LoaderCircle as Ir, Copy as Br } from "lucide-react";
import { formatScrRef as St, MODIFIER_KEYS as Pr, getChaptersForBook as Ar, NumberFormat as jr, formatBytes as Xr, deepEqual as ze, isString as ue, compareScrRefs as xe, scrRefToBBBCCCVVV as me, getLocalizeKeyForScrollGroupId as B } from "platform-bible-utils";
...
const Ie = X.Trigger, gn = X.Group, Wr = X.Portal, Zr = X.Sub, Ss = X.RadioGroup;
...
const ma = 6, Fe = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), ha = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
  ...
  "ArrowRight",
  "Enter"
]), ba = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', Pt = (t) => Ar(M.bookIdToNumber(t));
function va() {
      ...
      Yt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: en.map((h, V) => {
          ...
          return C.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(te, { className: "tw-font-semibold tw-text-foreground/80", children: ha[h] }),
...
const Na = ft(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Dt : "button", { className: d(Na({ variant: e, size: n, className: t })), ref: s, ...o })
);
P.displayName = "Button";
const ka = ft(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(cn.Root, { ref: n, className: d("pr-twp", ka(), t), ...e }));
...
function Va({ table: t }) {
  return /* @__PURE__ */ l(Qt, { children: [
    /* @__PURE__ */ r(dr, { asChild: !0, children: /* @__PURE__ */ l(P, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Tt = G.Root, Ma = G.Group, Rt = G.Value, za = ft(
...
Ia.displayName = G.Separator.displayName;
function Ba({ table: t }) {
...
function ja({
  ...
  var y;
  const [w, c] = j([]), [u, f] = j([]), [v, g] = j({}), [m, N] = j({}), T = pn({
    data: e,
    columns: t,
    getCoreRowModel: mn(),
...
function Vs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = et(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp", n), children: /* @__PURE__ */ r(Yr, { options: o, children: e }) });
}
...
const Ga = ft(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", Ga({ variant: e }), t), ...n })
);
...
const Vn = ft(
  ...
  {
    ref: o,
    className: d(Vn({ variant: e, size: n, className: t })),
    ...a
  }
));
...
const de = (t) => t === "asc" ? /* @__PURE__ */ r(_r, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Sr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Tr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Bs = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Ua = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Gs = Object.freeze([
...
function $s({
  ...
  const u = pt(n, "%webView_inventory_all%"), f = pt(n, "%webView_inventory_approved%"), v = pt(n, "%webView_inventory_unapproved%"), g = pt(n, "%webView_inventory_unknown%"), m = pt(n, "%webView_inventory_scope_currentBook%"), N = pt(n, "%webView_inventory_scope_chapter%"), T = pt(n, "%webView_inventory_filter_text%"), y = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, _] = j(!1), [S, z] = j("all"), [$, gt] = j(""), [lt, k] = j([]), b = et(() => t.length === 0 ? [] : Ja(t, o, s), [t, o, s]), A = et(() => {
    if (x) return b;
    const D = [];
    return b.forEach((h) => {
...
const Ka = "16rem", Wa = "3rem", On = p.createContext(void 0);
function pe() {
...
const Za = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = pe();
  return /* @__PURE__ */ l(
    P,
    {
  ...
  ({
    ...
    const c = t ? Dt : "button", { state: u } = pe(), f = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: d(oo({ variant: n, size: a }), s),
        ...i
      }
    );
...
const wo = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
const po = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Dt : "a",
  {
    ref: s,
    ...
    Bn,
    {
      ...
      children: /* @__PURE__ */ l(An, { children: [
        /* @__PURE__ */ l(_e, { children: [
          ...
          /* @__PURE__ */ r(Te, { children: /* @__PURE__ */ r(jn, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(Xn, { children: /* @__PURE__ */ r(
            Fn,
            {
              onClick: () => u(g),
              isActive: v(g),
...
const ut = "scrBook", mo = "scrRef", xt = "source", ho = "details", fo = "Scripture Reference", go = "Scripture Book", $n = "Type", bo = "Details";
function vo(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, an = (t) => `${xo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ys({
  sources: t,
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      P,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ r(Ee, {}) : /* @__PURE__ */ r(Vr, {})),
                          " ",
              ...
              Object.values(mt).map((b, A) => {
                ...
                if (R.length !== 0)
                  return /* @__PURE__ */ l(ln, { children: [
                    ...
                    A < Object.values(mt).length - 1 && /* @__PURE__ */ r(Rn, {})
                  ] }, b);
              })
            ] })
          ]
...
function sn({
  ...
  return /* @__PURE__ */ l(Qt, { variant: s, children: [
    /* @__PURE__ */ r(Ie, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(P, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Mr, {}) }) }),
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ l(ln, { children: [
...
const Eo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
...
Eo.displayName = F.CheckboxItem.displayName;
...
const Vo = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
function Mo({
  ...
  if (Hr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (f, v) => {
    ...
    return /* @__PURE__ */ r(Kn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, f]) => typeof f == "object").sort(([, f], [, v]) => typeof f == "boolean" || typeof v == "boolean" ? 0 : f.order - v.order).map(([f, v]) => /* @__PURE__ */ l(To, { children: [
...
const Io = Re(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ir, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function oi({ errorDetails: t, handleCopyNotify: e }) {
  function n() {
    navigator.clipboard.writeText(t), e && e();
  }
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-flex-col tw-justify-start tw-items-start tw-gap-4 tw-w-full", children: [
    /* @__PURE__ */ l("div", { className: "tw-self-stretch tw-inline-flex tw-justify-start tw-items-start tw-gap-4", children: [
      /* @__PURE__ */ l("div", { className: "tw-flex-1 tw-inline-flex tw-flex-col tw-justify-start tw-items-start", children: [
        /* @__PURE__ */ r("div", { className: "tw-text-center tw-justify-center tw-text-color-text tw-text-lg tw-font-semibold tw-leading-loose", children: "Error details" }),
        /* @__PURE__ */ r("div", { className: "tw-self-stretch tw-justify-center tw-text-muted-foreground tw-text-sm tw-font-normal tw-leading-tight", children: "Need help? Share this stack trace with our tech support team so we can resolve your issue quickly." })
      ] }),
      /* @__PURE__ */ r(P, { variant: "secondary", size: "icon", className: "size-8", onClick: n, children: /* @__PURE__ */ r(Br, {}) })
    ] }),
...
), Po = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(Bo({ variant: e }), t), ...n }));
...
const jo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Fo.displayName = Vt.Image.displayName;
...
Go.displayName = Vt.Fallback.displayName;
...
const Ho = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const si = at.Trigger, Ko = at.Portal, ii = at.Close, or = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
...
const ns = p.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Ne.Root,
  {
    ref: a,
    className: d(
...
ns.displayName = Ne.Root.displayName;
function wi({ ...t }) {
  return /* @__PURE__ */ r(
    Ur,
    {
...
const li = Q.Root, os = p.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.List,
    {
...
os.displayName = Q.List.displayName;
...
ss.displayName = Q.Trigger.displayName;
...
is.displayName = Q.Content.displayName;
const di = (t, e) => {
  it(() => {
    if (!t) return () => {
    };
...
export {
  ...
  Hs as SCOPE_SELECTOR_STRING_KEYS,
  Us as ScopeSelector,
  ...
  Ue as Separator,
  Js as SettingsList,
  Ws as SettingsListHeader,
  Ks as SettingsListItem,
  uo as SettingsSidebar,
  Ls as SettingsSidebarContentSearch,
  rn as Skeleton,
  rs as Slider,
  wi as Sonner,
  Io as Spinner,
  ...
  d as cn,
  Fs as getBookIdFromUSFM,
  js as getLinesFromUSFM,
  Xs as getNumberFromUSFM,
  Ua as getStatusForItem,
  ti as getToolbarOSReservedSpaceClassName,
  Ps as inventoryCountColumn,
  Bs as inventoryItemColumn,
  As as inventoryStatusColumn,
