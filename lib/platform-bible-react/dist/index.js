...
import b, { forwardRef as sn, useRef as H, useMemo as F, useState as S, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as Y, Component as fs, createElement as jr, Suspense as hs, Fragment as ho } from "react";
...
const il = Mt.Root, gp = Mt.Trigger, ll = Mt.Portal, bp = Mt.Close, qo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
    className: h(
...
Xo.displayName = Mt.Title.displayName;
...
Be.displayName = Tt.Input.displayName;
...
const wn = b.forwardRef((t, e) => /* @__PURE__ */ r(Tt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
const Qo = sn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? ze : "button", { className: h(ta({ variant: e, size: n, className: t })), ref: s, ...a })
);
B.displayName = "Button";
const Ke = 250, ea = 300, pl = 400, vp = 450, xp = 500, re = Ie.Root, ue = Ie.Trigger, ul = Ie.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = mt();
...
function ml({
  ...
  const [u, m] = S(!1), g = d !== void 0, x = g ? d : u, v = (y) => {
    g || m(y), f == null || f(y);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ p(re, { open: x, onOpenChange: v, children: [
    ...
    (a, s) => {
      ...
      if (i) {
        ...
        if (f.length === 1 && ([d] = f), !d && w) {
          ...
          if (!d && n) {
            const u = Array.from(n.entries()).find(
              ([, m]) => m.localizedId.toLowerCase() === l.toLowerCase()
            );
            u && e.includes(u[0]) && ([d] = u);
          }
        }
        if (!d && w) {
...
function Np({
  ...
  const c = mt(), [d, f] = S(!1), [u, m] = S(""), [g, x] = S(""), [v, N] = S("books"), [y, k] = S(void 0), [C, j] = S(!1), z = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
    ...
    (D) => {
      const _ = v === "chapters" ? y : I == null ? void 0 : I.book;
      _ && (V({
        book: _,
        chapterNum: D,
        verseNum: 1
    ...
    (D) => {
      ...
      if ((v === "chapters" || v === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        const U = v === "chapters" ? y : I == null ? void 0 : I.book;
        if (!U) return;
        const q = (() => {
          if (!u) return 1;
          const ct = u.match(/(\d+)$/);
        ...
        tt !== q && (D.preventDefault(), D.stopPropagation(), m(sr(U, a, tt)), setTimeout(() => {
  ...
  }, [v, y, I, t.book, t.chapterNum]), /* @__PURE__ */ p(re, { open: d, onOpenChange: G, children: [
    /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ r(
      B,
      {
...
), ht = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Eo.Root, { ref: n, className: h("pr-twp", bl(), t), ...e }));
...
function ir({
  ...
  const [k, C] = S(!1), j = c ?? w, z = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], A = (M, E) => {
...
function Cp({
  ...
  const d = jn(c, "%webView_bookSelector_currentBook%"), f = jn(c, "%webView_bookSelector_choose%"), u = jn(c, "%webView_bookSelector_chooseBooks%"), [m, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(ht, { className: "tw-ms-1", children: u })
          ] }),
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = ra ? At : Y, un = { tag: br };
function kl({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = yl(null, o), d = To({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (f) => i(f, d), theme: o });
    return function(f, u) {
      if (u !== null) {
...
const Cr = {
  ...
  mark: "",
  markOverlap: ""
}, kt = ke.Provider, Ct = ke.Root, Et = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  ke.Trigger,
  {
    ref: o,
...
const _t = b.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(ke.Portal, { children: /* @__PURE__ */ r(
  ke.Content,
  {
    ref: a,
    sideOffset: e,
...
function Il() {
  return function(t) {
    const [e] = Xt(), n = F(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), s = H(o);
    return Dl(() => {
...
function Ol(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !wi(e) && o !== null) {
    ...
    if (c || d) {
      const [f, u] = ci(t), m = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let v, N = 0;
      m ? (N = f > u ? u : f, v = f > u ? f : u) : g ? (N = i ? u : f, v = void 0) : x && (N = 0, v = i ? f : u);
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = oa && "documentMode" in document ? document.documentMode : null;
!(!oa || !("InputEvent" in window) || Pl) && "getTargetRanges" in new window.InputEvent("input");
function $l(t) {
  const e = Do(t, (n) => ie(n) && !n.isInline());
  return ie(e) || Al(4, t.__key), e;
}
function Ll(t) {
  const e = Vt();
  if (!Ne(e)) return !1;
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [ca], register: (t, e, n) => t.registerCommand(Oo, (o) => {
  const a = Vt();
  if (Ao(a) || Ne(a)) for (const s of a.getNodes()) Kl(s) && s.toggleFormat(o);
  return !1;
}, Po) });
function da(t, e) {
  let n;
...
const Yl = qt({ config: ln({ setOptions: to, updateOptions: to }), init: ({ $initialEditorState: t = Hl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class tn {
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: f } = d;
      if (f.onError !== void 0 && (e.onError = f.onError), f.disableEvents !== void 0 && (e.disableEvents = f.disableEvents), f.parentEditor !== void 0 && (e.parentEditor = f.parentEditor), f.editable !== void 0 && (e.editable = f.editable), f.namespace !== void 0 && (e.namespace = f.namespace), f.$initialEditorState !== void 0 && (e.$initialEditorState = f.$initialEditorState), f.nodes) for (const u of Bl(f)) {
        if (typeof u != "function") {
          const m = o.get(u.replace);
          m && et(302, f.name, u.replace.name, m.extension.name), o.set(u.replace, d);
        }
        n.add(u);
      }
      if (f.html) {
        if (f.html.export) for (const [u, m] of f.html.export.entries()) a.set(u, m);
...
const Wl = /* @__PURE__ */ new Set(), ro = qt({ build(t, e, n) {
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = da(() => {
    ...
    o.value.read(() => {
      if (Vt()) for (const [d, f] of l.entries()) {
        ...
        const u = Ri(d), m = u && u.isSelected() || !1;
  ...
  return ce(t.registerCommand(vi, (i) => {
    if (xi(i.target)) {
      ...
      if (Zl(l)) return function(w, c = !1) {
        const d = Vt(), f = w.isSelected(), u = w.getKey();
        let m;
        c && Ao(d) ? m = d : (m = Ni(), ki(m)), f ? m.delete(u) : m.add(u);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    jl(() => {
      ...
      for (const [d, f] of i.entries()) if (f === "destroyed") c.delete(d), w = !0;
        ...
        const u = c.get(d), m = t.getElementByKey(d);
        u ? u.domNode.value = m : (w = !0, c.set(d, { domNode: rn(m), selectedSignal: o(d) }));
      }
...
function Ql(t, e, n = ha) {
  return ce(t.registerCommand(Di, (o) => {
    const a = Vt();
    if (!Ne(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((u) => vn(u) && u.canIndent()).length > 0) return !0;
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), f = $l(d);
      if (f.canIndent()) {
        const u = f.getKey();
        let m = Mi();
        if (m.anchor.set(u, 0, "element"), m.focus.set(u, 0, "element"), m = Ii(m), m.anchor.is(c)) return !0;
      }
      return !1;
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (Ne(g)) {
                ...
                if (xn(v) && c >= 0 && d >= 0 && (N = c, y = c + d, g.setTextNodeRange(v, N, v, y)), N === y && f === "" || (g.insertRawText(f), v = x.getNode()), xn(v)) {
                  N = u, y = u + m;
  ...
  return function(n, o) {
    ...
    return Sr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (u) => n._onError(u), children: r(hs, { fallback: null, children: a[c] }) }), f = n.getElementByKey(c);
...
function vw() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(il, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Ho, { children: [
...
Nw.displayName = zo.Root.displayName;
...
function _a(t, e, n, o = null) {
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], x = _a(t, g, u, o);
    !a && ie(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Vi(d) || qr(d)) && d.append(u), n.append(d), f) {
      const m = f.call(i, d);
...
function Ea(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let u = [];
  const m = (l == null || !zi(l)) && (l != null && vn(l) || o);
  for (let g = 0; g < f.length; g++) u.push(...Ea(f[g], e, n, m, new Map(a), l));
  return d != null && (u = d(u)), Hr(t) && (u = Sw(t, u, m ? () => {
    const g = new Vo();
    return n.push(g), g;
  } : Rn)), l == null ? u.length > 0 ? i = i.concat(u) : Hr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Yr(g.nextSibling) && Yr(g.previousSibling);
  }(t) && (i = i.concat(jo())) : ie(l) && l.append(...u), i;
}
function Sw(t, e, n) {
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Ir(N) && (N.preventDefault(), N.stopPropagation(), Lt(a) && u());
        },
        onKeyDown: (N) => {
...
const Tp = Object.freeze([
  ...
  const a = H(null), [s, i] = S(void 0), [l, w] = S(void 0), c = K(
    ...
    if (m.isContentEditable || Iw.includes(g)) return !0;
    ...
    (m) => {
      var A;
      const g = m.target, x = (M) => M ? document.getElementById(M) : void 0, v = x(l), N = x(s);
      if (!!(v && g && v.contains(g) && g !== v) && f(g)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          if (E === -1) return;
          let R;
          m.key === "ArrowDown" ? R = Math.min(E + 1, M.length - 1) : R = Math.max(E - 1, 0), R !== E && (m.preventDefault(), m.stopPropagation(), (A = M[R]) == null || A.focus());
          return;
        }
        return;
      }
      ...
      switch (m.key) {
        case "ArrowDown":
          j = Math.min(C + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          j = Math.max(C - 1, 0), m.preventDefault();
          break;
        case "Home":
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: h("pr-twp", Pw({ variant: e }), t), ...n })
);
...
zw.displayName = Fe.Image.displayName;
...
}), Ge = nt.Trigger, Oa = nt.Group, Fw = nt.Portal, Bw = nt.Sub, Kw = nt.RadioGroup;
...
function io({
  ...
  }, [t.date, n]), v = F(() => t.user, [t.user]), N = F(
    ...
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), f(Dw(t.contents)), i == null || i(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: u,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), m()) : Ir(C) && (C.preventDefault(), C.stopPropagation(), Lt(d) && g());
              },
              onKeyDown: (C) => {
...
function Uw({
  ...
  const [A, M] = S(lo), [E, R] = S(
    void 0
  ), V = o, [$, O] = S(!1), [P, W] = S(!1), [I, J] = S(!1), [St, Pt] = S(!1), [It, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
...
function Sp({
  ...
  canUserResolveThreadCallback: u,
...
const $e = dt.Root, Hw = dt.Group, Le = dt.Value, Yw = pe(
  ...
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      className: h(Yw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
const An = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const Qt = b.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const l = b.useMemo(
    ...
    (d) => {
      ...
      const u = f.closest("table"), m = u ? (
        // getFocusableElements returns an HTMLElement[] but we are filtering for HTMLTableRowElements
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        on(u).filter(
          (v) => v.tagName === "TR"
        )
      ) : [], g = m.indexOf(f), x = l.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), nc(m, g, d.key);
...
function oc({
  ...
  var z;
  const [d, f] = S([]), [u, m] = S([]), [g, x] = S({}), [v, N] = S({}), y = F(() => e ?? [], [e]), k = Ko({
    data: y,
    columns: t,
    getCoreRowModel: Uo(),
...
function Op({ id: t, label: e, groups: n }) {
  const [o, a] = S(
    ...
    i((u) => (u[c] = d, { ...u }));
    const f = n[c].items.find((u) => u.id === d);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(Ee, { children: [
    ...
    /* @__PURE__ */ r(me, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Oa, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((f, u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][u],
          onCheckedChange: () => l(d, u),
          children: f.label
        }
      ) }, f.id)) }) : /* @__PURE__ */ r(
        Kw,
...
function lc({ id: t, versionHistory: e }) {
  ...
  function s(l) {
    const w = new Date(l), c = new Date(a.getTime() - w.getTime()), d = c.getUTCFullYear() - 1970, f = c.getUTCMonth(), u = c.getUTCDate() - 1;
    let m = "";
    return d > 0 ? m = `${d.toString()} year${d === 1 ? "" : "s"} ago` : f > 0 ? m = `${f.toString()} month${f === 1 ? "" : "s"} ago` : u === 0 ? m = "today" : m = `${u.toString()} day${u === 1 ? "" : "s"} ago`, m;
  }
...
function wc({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ p(re, { open: M, onOpenChange: d ?? y, children: [
    /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ p(
      B,
      {
        variant: x,
...
function $p({
  ...
  return /* @__PURE__ */ p("div", { id: f, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: e.map((u) => {
      var m;
      return /* @__PURE__ */ p(Ae, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          B,
          {
            ...
            onClick: () => n(e.filter((g) => g !== u)),
            children: /* @__PURE__ */ r(Ve, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (m = t.find((g) => g.value === u)) == null ? void 0 : m.label
      ] }, u);
  ...
  return Y(() => {
    ...
    const o = /Macintosh/i.test(navigator.userAgent), a = ((i = n.current) == null ? void 0 : i.querySelector(".editor-input")) ?? void 0, s = (l) => {
      ...
      if (o) {
        ...
        if (!l.ctrlKey) return;
        !l.shiftKey && w === "z" ? (l.preventDefault(), (f = e.current) == null || f.undo()) : (w === "y" || l.shiftKey && w === "z") && (l.preventDefault(), (u = e.current) == null || u.redo());
      }
    };
...
function mc({
  ...
  const s = H(null), i = H(null), l = H(!1), [w, c] = S(t), [d, f] = S(n), [u, m] = S(!1);
  Y(() => {
    c(t);
  }, [t]), Y(() => {
    d !== n && f(n);
  ...
  const g = (v) => {
    l.current = !1, m(v), v || (w !== "custom" || d ? (e(w), o(d)) : (c(t), f(n)));
  }, x = (v) => {
    var N, y, k, C;
  ...
  return /* @__PURE__ */ p(Ee, { open: u, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: uc(t, a, n) }) }) }),
...
function gc({
  ...
  return /* @__PURE__ */ p(Ee, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Bi, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: fc(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: hc(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(me, { style: { zIndex: ea }, children: [
...
function Lp({
  ...
  const d = H(null), f = H(null), u = H(null), m = H(null);
  At(() => {
    if (!m.current) return;
    const { width: _ } = m.current.getBoundingClientRect();
    _ > 0 && (m.current.style.width = `${_}px`);
  }, []);
  const [g, x] = S("generated"), [v, N] = S("*"), [y, k] = S("f"), [C, j] = S(!1), [z, A] = S(!0), [M, E] = S(!1), R = H(!1), V = H(""), [$, O] = S(!1), [P, W] = S(), [I, J] = S(), [St, Pt] = S(), [It, gt] = S(), pt = H(null), G = F(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const Bt = () => {
    ...
    if (L && pn("note", L)) {
      ...
      y !== "x" && _ === "x" ? ct == null || ct.forEach((Dt) => Nc(Dt)) : y === "x" && _ !== "x" && (ct == null || ct.forEach((Dt) => kc(Dt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
    ...
    if (u.current && at.length && _ && _.rangeCount > 0) {
      const L = _.getRangeAt(0).getBoundingClientRect(), U = u.current.getBoundingClientRect();
...
function Tc({
  ...
  /* @__PURE__ */ p("span", { className: h("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    Ar(t.marker, [i], o, !1),
    " "
  ] }), u = e === "horizontal" ? "horizontal" : "vertical", m = o ? "marker-visible" : "", g = e === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", x = h(u, m);
  return /* @__PURE__ */ p(lt, { children: [
...
function jp({
  ...
  const d = w ?? ii(n, void 0), f = (y, k) => {
    c == null || c(y, k, a);
  }, u = s ? n.findIndex((y) => y === s) : -1, [m, g] = S(u), x = (y, k, C) => {
    if (n.length)
      switch (y.key) {
        case "Enter":
        case " ":
    ...
    /* @__PURE__ */ r(An, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Qt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ye, { className: o, children: Rc(l.text) })
        ]
      },
...
function Hp({
  ...
  const m = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), N = Kt(n, "%webView_inventory_scope_currentBook%"), y = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), j = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), z = Kt(n, "%webView_inventory_no_results%"), [A, M] = S(!1), [E, R] = S("all"), [V, $] = S(""), [O, P] = S([]), W = F(() => {
    const G = t ?? [];
  ...
  }, [A, W]), J = F(() => I.length === 0 ? [] : Oc(I, E, V), [I, E, V]), St = F(() => {
    var st, wt;
    if (!A) return w;
...
const Pc = "16rem", $c = "3rem", za = b.createContext(void 0);
function $n() {
...
const Fa = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), f = e ?? c, u = b.useCallback(
      (k) => {
        const C = typeof k == "function" ? k(f) : k;
        n ? n(C) : d(C);
      },
      [n, f]
    ), m = b.useCallback(() => u((k) => !k), [u]), g = f ? "expanded" : "collapsed", N = mt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: u,
...
const Ba = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = $n();
  ...
  ({
    ...
    const w = t ? ze : "button", { state: c } = $n(), d = /* @__PURE__ */ r(
      w,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: h(Gc({ variant: n, size: o }), s),
        ...i
      }
    );
...
function Jc({
  ...
  const c = K(
    ...
    (u) => {
      const m = n.find((g) => g.projectId === u);
      return m ? m.projectName : u;
    },
    [n]
  ), f = K(
    ...
    Ba,
    {
      ...
      children: /* @__PURE__ */ p(Ga, { children: [
        /* @__PURE__ */ p(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(Ua, { children: Object.entries(e).map(([u, m]) => /* @__PURE__ */ r(qa, { children: /* @__PURE__ */ r(
            Ha,
            {
              onClick: () => c(u),
              isActive: f(u),
        ...
        /* @__PURE__ */ p(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            ir,
            {
              ...
              options: n.flatMap((u) => u.projectId),
              getOptionLabel: d,
              buttonPlaceholder: l,
              onChange: (u) => {
                const m = d(u);
...
const se = "scrBook", Zc = "scrRef", ge = "source", Qc = "details", td = "Scripture Reference", ed = "Scripture Book", Ya = "Type", nd = "Details";
function rd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, mo = (t) => `${od({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Xp({
  sources: t,
  ...
  const [c, d] = S([]), [f, u] = S([{ id: se, desc: !1 }]), [m, g] = S({}), x = F(
  ...
  Y(() => {
    if (l) {
      const E = N.getSelectedRowModel().rowsById, R = Object.keys(E);
      if (R.length === 1) {
        const V = x.find(($) => mo($) === R[0]) || void 0;
        V && l(V);
      }
    }
  }, [m, x, l, N]);
  const y = a ?? ed, k = s ?? Ya, C = [
  ...
  }, A = (E, R) => E.getIsGrouped() ? "" : h("banded-row", R % 2 === 0 ? "even" : "odd"), M = (E, R, V) => {
    ...
    !e && /* @__PURE__ */ p(
      $e,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ce, { position: "item-aligned", children: /* @__PURE__ */ r(Hw, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(In, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: N.getHeaderGroups().map((E) => /* @__PURE__ */ r(Qt, { children: E.headers.filter((R) => R.column.columnDef.header).map((R) => (
      ...
      /* @__PURE__ */ r(An, { children: N.getRowModel().rows.map((E, R) => {
        const V = mt();
        return /* @__PURE__ */ r(
          Qt,
          {
...
function sd({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: u, ntLong: m, dcLong: g, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, N] = S(!1), [y, k] = S(""), C = H(void 0), j = H(!1);
...
function Jp({
  ...
  const c = fe(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), u = fe(i, "%webView_scope_selector_current_book%"), m = fe(i, "%webView_scope_selector_choose_books%"), g = fe(i, "%webView_scope_selector_scope%"), x = fe(i, "%webView_scope_selector_select_books%"), v = [
    ...
    { value: "book", label: u, id: "scope-book" },
...
const Ja = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Et, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r(Fw, { children: /* @__PURE__ */ r(Pa, { children: Ja(
      t,
      e,
      Wa(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(Ee, { variant: s, children: [
    ...
    /* @__PURE__ */ r(me, { align: "start", style: { zIndex: Ke }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(ho, { children: [
...
function ou({
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(Qa, { children: [
      /* @__PURE__ */ r(ts, { children: t.map((l) => /* @__PURE__ */ r(id, { value: l.value, children: l.value }, l.key)) }),
...
const ss = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Ft();
...
function ud({
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, f) => {
    var g, x, v, N;
    d.preventDefault();
    const u = { key: "Escape", code: "Escape", keyCode: 27, bubbles: !0 }, m = { key: " ", code: "Space", keyCode: 32, bubbles: !0 };
    switch (f.hotkey) {
      case "alt":
        Xe(s, [u]);
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Xe(s, [u, m]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Xe(i, [u, m]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Xe(l, [u, m]);
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), Xe(w, [u, m]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(ns, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, f]) => typeof d == "boolean" || typeof f == "boolean" ? 0 : d.order - f.order).map(([d, f]) => /* @__PURE__ */ p(ld, { children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            c && (e || u) && /* @__PURE__ */ r(
              ...
              {
                className: h(
                  !e && u && "tw-invisible group-hover:tw-visible"
                ),
                children: /* @__PURE__ */ p(Ee, { children: [
...
const hd = sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Js, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
...
const xd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const gu = zt.Trigger, Md = zt.Portal, bu = zt.Close, ds = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
