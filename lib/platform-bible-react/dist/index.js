...
import { r as Yt, Z as Gi, B as K, c as f, a as Hi, C as Oe, P as Re, b as je, d as $e, e as Fe, f as Be, g as me, h as Nr, i as oa, T as Ut, S as ar, j as Kt, k as qt, l as Gt, D as We, m as xr, n as Te, o as ze, p as Se, q as er, u as Yi, s as Cr, t as Xe, v as Ie, w as un, x as Wi, y as Xi, z as pn, A as hn, E as Ji, F as Zi, G as Qi, H as ts, I as ha, J as ga, K as dr, L as es, M as rs, N as as, O as os, Q as ns, R as Er, U as Ya } from "./resizable-CX1Q8cJa.js";
import { V as sg, W as cg, X as lg, Y as dg, _ as wg, $ as ug, a0 as pg, a1 as hg, a2 as gg } from "./resizable-CX1Q8cJa.js";
import { jsx as a, jsxs as u, Fragment as rt } from "react/jsx-runtime";
import { Canon as ut } from "@sillsdev/scripture";
import { includes as Ar, Section as tt, getChaptersForBook as is, formatScrRef as Ce, getSectionForBook as mr, formatRelativeDate as ss, formatReplacementString as Ne, sanitizeHtml as Wa, NumberFormat as cs, formatBytes as ls, getCurrentLocale as ds, usfmMarkers as Fr, getFormatCallerFunction as ws, deepEqual as us, isString as yo, compareScrRefs as Ra, scrRefToBBBCCCVVV as fa, defaultScrRef as ma, formatScrRefRange as ps, getLocalizeKeyForScrollGroupId as ko, collectUsjMarkers as hs } from "platform-bible-utils";
import { Check as Ve, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as $a, ChevronRight as Ma, ArrowLeft as gs, ArrowRight as fs, ChevronDown as or, BoldIcon as ms, ItalicIcon as vs, X as na, AtSign as gn, Pencil as bs, Trash2 as xs, ArrowUp as fn, MoreHorizontal as ys, MailOpen as ks, Mail as _s, ChevronUp as Ns, FilterIcon as Cs, ArrowLeftIcon as Es, ChevronLeftIcon as Ts, ChevronRightIcon as zs, ArrowRightIcon as Ss, Copy as mn, Filter as Ds, User as Os, Link as Rs, CircleHelp as $s, ChevronsUpDown as vn, Star as Ms, Undo as As, Redo as Ps, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Is, AlertCircle as Aa, CircleCheckIcon as Vs, CircleXIcon as Ls, CircleHelpIcon as js, ArrowUpIcon as Fs, ArrowDownIcon as Bs, Search as Us, LoaderCircle as Ks, ScrollText as qs, MenuIcon as Gs, Menu as Hs, EllipsisVertical as Ys, MoreVertical as Eo } from "lucide-react";
import pt, { useRef as G, useMemo as M, useState as N, useCallback as B, useEffect as W, useLayoutEffect as te, createContext as Xa, useContext as kn, Component as Ws, createElement as To, Suspense as Xs, forwardRef as ia, useId as zo, Fragment as _n } from "react";
import { Dialog as ve, Label as Js, RadioGroup as Pa, ToggleGroup as Nn, Slot as wr, Avatar as Ja, Select as Ft, Checkbox as So, Tabs as pe, Menubar as ye, ContextMenu as $t, Progress as Do, Slider as Pr, Switch as Oo } from "radix-ui";
import { createEditor as Cn, $getRoot as Le, $createParagraphNode as Tr, $getSelection as Ht, HISTORY_MERGE_TAG as Za, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Zs, $isRangeSelection as be, $caretFromPoint as Qs, $getSiblingCaret as zn, $getChildCaret as tc, $getAdjacentChildCaret as ec, $isChildCaret as rc, $normalizeCaret as ac, $setSelectionFromCaretRange as oc, $getCollapsedCaretRange as nc, $getCaretInDirection as Ro, $splitAtPointCaretNext as ic, $isTextPointCaret as sc, $findMatchingParent as Sn, $isElementNode as yr, mergeRegister as De, getDOMTextNode as cc, isHTMLElement as lc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as Qa, shallowMergeConfig as dc, defineExtension as se, safeCast as Je, createState as wc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as Rn, COMMAND_PRIORITY_LOW as $n, RootNode as uc, LineBreakNode as pc, TabNode as hc, $isEditorState as gc, createCommand as fc, CLICK_COMMAND as mc, isDOMNode as vc, $getNodeFromDOMNode as bc, $createNodeSelection as xc, $setSelection as yc, $getEditor as kc, DecoratorNode as Ia, $getState as _c, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as Nc, $setState as Cc, addClassNamesToElement as Mn, $create as Ec, $getNodeByKey as Tc, removeClassNamesFromElement as zc, KEY_TAB_COMMAND as Sc, $isBlockElementNode as Dc, $createRangeSelection as Oc, $normalizeSelection__EXPERIMENTAL as Rc, OUTDENT_CONTENT_COMMAND as $c, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Mc, COMMAND_PRIORITY_CRITICAL as to, $isDecoratorNode as Ac, $isParagraphNode as Pc, $isTextNode as Va, SELECTION_CHANGE_COMMAND as An, $insertNodes as Ic } from "lexical";
import { HeadingNode as Vc, QuoteNode as Lc, registerRichText as jc } from "@lexical/rich-text";
import { flushSync as Fc, createPortal as Bc } from "react-dom";
import { IconX as Uc, IconCheck as sa, IconChevronDown as Kc, IconChevronUp as qc, IconSelector as Gc, IconLayoutSidebar as Hc, IconLayoutSidebarRight as Yc, IconChevronRight as Pn, IconLoader as Wc, IconAlertOctagon as Xc, IconAlertTriangle as Jc, IconInfoCircle as Zc, IconCircleCheck as Qc } from "@tabler/icons-react";
...
import { useReactTable as Vn, getFilteredRowModel as al, getSortedRowModel as Ln, getPaginationRowModel as ol, getCoreRowModel as jn, flexRender as vr, getGroupedRowModel as nl, getExpandedRowModel as il } from "@tanstack/react-table";
import sl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as La, HIDDEN_NOTE_CALLER as ja, getDefaultViewOptions as cl, isInsertEmbedOpOfType as Ir, Editorial as ll } from "@eten-tech-foundation/platform-editor";
...
const Bn = ut.allBookIds.filter(
  (t) => !ut.isObsolete(ut.bookIdToNumber(t))
), we = Object.fromEntries(
  Bn.map((t) => [t, ut.bookIdToEnglishName(t)])
);
function ro(t, e, r) {
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ u(
        ...
        {
          ref: t,
          value: l || `${e} ${ut.bookIdToEnglishName(e)}`,
          onSelect: g,
          onMouseDown: h,
          role: "option",
          "aria-selected": r,
...
function ba({
  ...
  const k = Yt(), [_, R] = N(!1), [j, T] = N(""), [$, A] = N(""), [x, D] = N("books"), [L, C] = N(void 0), [z, q] = N(
    void 0
  ), [U, P] = N(void 0), [F, et] = N(!1), Z = G(null), Nt = G(!1), mt = G(void 0), Tt = G(void 0), H = G(void 0), at = G(void 0), vt = G({}), ct = G({}), lt = B(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Wt = M(() => o ? o() : Bn, [o]), dt = M(() => ({
    [tt.OT]: Wt.filter((Y) => ut.isBookOT(Y)),
    [tt.NT]: Wt.filter((Y) => ut.isBookNT(Y)),
    [tt.DC]: Wt.filter((Y) => ut.isBookDC(Y)),
    [tt.Extra]: Wt.filter((Y) => ut.extraBooks().includes(Y))
  }), [Wt]), Xt = M(() => Object.values(dt).flat(), [dt]), ee = M(() => {
    if (!$.trim()) return dt;
    const b = {
      [tt.OT]: [],
      [tt.NT]: [],
  ...
  const ce = B(() => {
    if (O) {
      const b = O.chapterNum ?? 1, Y = O.verseNum ?? 1;
      if (w && va(O.book, b, Y, w))
        return;
      lt({
        book: O.book,
        chapterNum: b,
    ...
    (b) => {
      const Y = z ?? (O == null ? void 0 : O.book), Q = U ?? (O == null ? void 0 : O.chapterNum);
      !Y || !Q || (lt({
        book: Y,
        chapterNum: Q,
        verseNum: b
    ...
    (b) => {
      const Y = x === "chapters" ? L : O == null ? void 0 : O.book;
      if (Y) {
        if (l && l(Y, b) > 1) {
          q(Y), P(b), D("verses"), T("");
          return;
    ...
    D("books"), C(void 0), q(void 0), P(void 0), setTimeout(() => {
      Tt.current && Tt.current.focus();
    }, 0);
  }, []), V = B(() => {
    const b = z;
    q(void 0), P(void 0), b ? (C(b), D("chapters"), T("")) : Pt();
  }, [z, Pt]), J = B((b) => {
    R(b), b && (D("books"), C(void 0), q(void 0), P(void 0), A(""));
  }, []), { otLong: ot, ntLong: nt, dcLong: ht, extraLong: st } = {
    ...
    () => vl($),
    [$]
  ), Dt = M(() => !l || !O || !O.chapterNum || !It ? !1 : l(O.book, O.chapterNum) > 0, [l, O, It]), Ke = B(
    (b) => w ? Po(b, w) : !1,
    [w]
  ), S = B(
    (b) => (Y) => w ? bl(b, Y, w) : !1,
    ...
    (b, Y) => (Q) => w ? va(b, Y, Q, w) : !1,
    [w]
  ), yt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", le = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", qe = B(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && O && O.chapterNum !== void 0 && O.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), ce());
    },
    [p, O, ce]
  ), Dr = B(
    (b) => {
      var oe, Ze, pr;
      if (b.ctrlKey) return;
      const { isLetter: Y, isDigit: Q } = Io(b.key);
      if ((x === "chapters" || x === "verses") && (b.key === " " || b.key === "Enter")) {
        const Vt = b.target instanceof HTMLElement ? b.target : void 0;
        ...
        const Ot = (oe = mt.current) == null ? void 0 : oe.querySelector(
      ...
      if ((x === "chapters" || x === "verses") && (Y || Q)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (x === "chapters" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), Pt();
        return;
      }
      ...
      if (x === "verses" && Et) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            ft !== 0 && (Zt = ft > 1 ? ft - 1 : Ot);
            break;
          case "ArrowRight":
            ft !== 0 && (Zt = ft < Ot ? ft + 1 : 1);
            break;
          case "ArrowUp":
            Zt = ft === 0 ? Ot : Math.max(1, ft - Qt);
            break;
          case "ArrowDown":
            Zt = ft === 0 ? 1 : Math.min(Ot, ft + Qt);
            break;
          default:
            return;
        }
        Zt !== ft && (b.preventDefault(), b.stopPropagation(), T(
          `${Vt} ${we[Vt] || ""} ${kt}:${Zt}`
        ), setTimeout(() => {
          const Ge = ct.current[Zt];
          Ge && Ge.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((x === "chapters" || x === "books" && O) && Et) {
        const Vt = x === "chapters" ? L : O == null ? void 0 : O.book;
        if (!Vt) return;
        ...
        switch (b.key) {
          case "ArrowLeft":
            kt !== 0 && (ft = kt > 1 ? kt - 1 : Ot);
            break;
          case "ArrowRight":
            kt !== 0 && (ft = kt < Ot ? kt + 1 : 1);
            break;
          case "ArrowUp":
            ft = kt === 0 ? Ot : Math.max(1, kt - Zt);
            break;
          case "ArrowDown":
            ft = kt === 0 ? 1 : Math.min(Ot, kt + Zt);
            break;
          default:
            return;
        }
        ft !== kt && (b.preventDefault(), b.stopPropagation(), T(
          `${Vt} ${we[Vt] || ""} ${ft}`
        ), setTimeout(() => {
          const Qt = vt.current[ft];
    ...
    const { isLetter: Y, isDigit: Q } = Io(b.key);
    (Y || Q) && (b.preventDefault(), A((oe) => oe + b.key), Tt.current.focus(), et(!1));
  }, []);
  return te(() => {
    const b = setTimeout(() => {
      if (_ && x === "books" && H.current && at.current) {
        const Y = H.current, Q = at.current, Et = Q.offsetTop, oe = Y.clientHeight, Ze = Q.clientHeight, pr = Et - oe / 2 + Ze / 2;
        Y.scrollTo({
          top: Math.max(0, pr),
          behavior: "smooth"
        }), T(Kn(t.book));
    ...
    if (x === "chapters" && L) {
      const b = L === t.book, Y = b ? t.chapterNum : 1;
      T(
        `${L} ${we[L] || ""} ${Y}`
      ), setTimeout(() => {
        if (H.current)
  ...
  }, [x, L, O, t.book, t.chapterNum]), te(() => {
    if (x === "verses" && z && U !== void 0) {
      const b = z === t.book && U === t.chapterNum, Y = b ? t.verseNum : 1;
      T(
        `${z} ${we[z] || ""} ${U}:${Y}`
      ), setTimeout(() => {
        if (H.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Re, { open: _, onOpenChange: J, modal: v, children: [
    /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ a(
      K,
      {
        ref: Z,
        ...
        onClick: (b) => {
          Nt.current && (Nt.current = !1, b.preventDefault());
        },
        children: g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: xt })
      }
    ) }),
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: Y } = b;
          _ && Z.current && Y instanceof Node && Z.current.contains(Y) && (Nt.current = !0, J(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          Fe,
          {
            ...
            children: [
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Me.map(({ onClick: b, disabled: Y, title: Q, icon: Et }) => /* @__PURE__ */ a(
                  K,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  K,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: x === "verses" ? V : Pt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: k === "ltr" ? /* @__PURE__ */ a(gs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(fs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                x === "chapters" && L && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Pe(L, n) }),
                x === "verses" && z && U !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Pe(z, n)} ${U}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: x === "verses" ? le : yt
                  }
                )
              ] }),
              !F && /* @__PURE__ */ u(Be, { ref: H, children: [
                x === "books" && /* @__PURE__ */ u(rt, { children: [
                  !O && Object.entries(ee).map(([b, Y]) => {
                    if (Y.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(me, { heading: bt(b), children: Y.map((Q) => /* @__PURE__ */ a(
                          Un,
                          {
                            bookId: Q,
                            onSelect: (Et) => Ct(Et),
                  ...
                  O && Dt && O.chapterNum && l && /* @__PURE__ */ u(rt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Pe(O.book, n)} ${O.chapterNum}` }),
                      /* @__PURE__ */ a("span", { children: le })
                    ] }),
                    /* @__PURE__ */ a(
                      Lo,
                      {
                        ...
                        onVerseSelect: Jt,
                        setVerseRef: St,
                        isVerseDisabled: At(O.book, O.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  O && !Dt && fe(O.book) > 1 && /* @__PURE__ */ u(rt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Pe(O.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Vo,
                      {
                        ...
                        setChapterRef: Mt,
                        isChapterDimmed: gt,
                        isChapterDisabled: S(O.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                x === "chapters" && L && /* @__PURE__ */ a(
                  Vo,
                  {
                    bookId: L,
                    scrRef: t,
                    onChapterSelect: zt,
                    setChapterRef: Mt,
                    isChapterDisabled: S(L),
                    className: "tw:p-4"
                  }
                ),
                x === "verses" && z && U !== void 0 && l && /* @__PURE__ */ a(
                  Lo,
                  {
                    bookId: z,
                    chapterNum: U,
...
function jo({
  ...
  const [_, R] = N(!1), j = l ?? d, T = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], $ = (A, x) => {
    const D = d(A), L = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, C = `${x ?? ""}${D}${L ?? ""}`;
    return /* @__PURE__ */ u(
      Oe,
      {
        value: D,
  ...
  return /* @__PURE__ */ u(Re, { open: _, onOpenChange: R, ...k, children: [
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          ...
          /* @__PURE__ */ a(Be, { children: T(e) ? e.map((A) => /* @__PURE__ */ a(me, { heading: A.groupHeading, children: A.options.map((x) => $(x, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(me, { children: e.map((A) => $(A)) }) })
        ] })
      }
    )
  ] });
...
function cp({
  ...
  const w = xa(l, "%webView_bookSelector_currentBook%"), p = xa(l, "%webView_bookSelector_choose%"), g = xa(l, "%webView_bookSelector_chooseBooks%"), [h, m] = N(
    "current book"
    /* CurrentBook */
  ), y = (v) => {
    m(v), t(v);
    ...
    ao,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:flex tw:items-center", children: o.map((v) => ut.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            K,
            {
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cl = Hn ? te : W, Vr = { tag: Za };
function El({ initialConfig: t, children: e }) {
  const r = M(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = Nl(null, o), w = Cn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
        if (g === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            ...
            (Ht() !== null || y !== null && y === p.getRootElement()) && m.select();
          }
        }, Vr);
...
const $l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function Ml(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Al() {
  return function(t) {
    const [e] = ke(), r = M(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = G(o);
    return $l(() => {
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Il = Yn && "documentMode" in document ? document.documentMode : null;
!(!Yn || !("InputEvent" in window) || Il) && "getTargetRanges" in new window.InputEvent("input");
function ge(t) {
  return `${t}px`;
}
...
function Ll(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: g } = n.getBoundingClientRect(), h = Pl(t, e);
    var m, y;
    c.isConnected || (y = c, (m = n).insertBefore(y, m.firstChild));
    let v = !1;
    for (let E = 0; E < h.length; E++) {
      const k = h[E], _ = s[E] || document.createElement("div"), R = _.style;
      R.position !== "absolute" && (R.position = "absolute", v = !0);
      const j = ge(k.left - p);
      R.left !== j && (R.left = j, v = !0);
      const T = ge(k.top - g);
      R.top !== T && (_.style.top = T, v = !0);
      const $ = ge(k.width);
      R.width !== $ && (_.style.width = $, v = !0);
      const A = ge(k.height);
      R.height !== A && (_.style.height = A, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[E] = _;
    }
...
function Fl(t, e = jl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = g.getNode(), y = m.getKey(), v = g.offset, E = h.getNode(), k = E.getKey(), _ = h.offset, R = t.getElementByKey(y), j = t.getElementByKey(k), T = r === null || R !== o || v !== n || y !== r.getKey(), $ = i === null || j !== s || _ !== c || k !== i.getKey();
      if ((T || $) && R !== null && j !== null) {
        const A = function(x, D, L, C, z, q, U) {
          const P = (x._window ? x._window.document : document).createRange();
          return P.setStart(...Fo(D, L, C)), P.setEnd(...Fo(z, q, U)), P;
        }(t, g, m, R, h, E, j);
        d(), d = Ll(t, A, e);
      }
      r = m, o = R, n = v, i = E, s = j, c = _;
    });
  }
...
function Kl(t) {
  const e = Ht() || Zs();
  let r;
  if (be(e)) r = Qs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = zn(c, "next"));
    }
    r = r || tc(Le(), "previous").getFlipped().insert(Tr());
  }
  const o = ql(t, r), n = ec(o), i = rc(n) ? ac(n) : o;
  return oc(nc(i)), t.getLatest();
}
function ql(t, e, r) {
  let o = Ro(e, "next");
  for (let n = o; n; n = ic(n, r)) o = n;
  return sc(o) && Jr(283), o.insert(t.isInline() ? Tr().append(t) : t), Ro(zn(t.getLatest(), "next"), e.direction);
}
function Gl(t) {
  const e = Ht();
  if (!be(e)) return !1;
...
let Zr, Ee = 0, Qr = 0, Wl = 0, Ka = 0, Ur = 0;
function Uo(t) {
  if (it === void 0) return;
  let e = t.n;
...
function He(t, e) {
  jt.call(this, void 0), this.x = t, this.s = void 0, this.g = Ur - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Xl(t, e) {
  return new He(t, e);
}
...
function Jl(t) {
  ...
  Xn(this), it = t, this.f &= -2, 8 & this.f && io(this), ca();
}
function tr(t, e) {
...
jt.prototype.brand = Hl, jt.prototype.h = function() {
  return !0;
...
} }), He.prototype = new jt(), He.prototype.h = function() {
  ...
  return it = t, Xn(this), this.f &= -2, !0;
...
se({ build: (t, e, r) => ur(e), config: Je({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Zn() {
  const t = Le(), e = Ht(), r = Tr();
  t.clear(), t.append(r), e !== null && r.select(), be(e) && (e.format = 0);
}
function Qn(t, e = Zn) {
  return t.registerCommand(Dn, (r) => (t.update(e), !0), Qa);
}
se({ build: (t, e, r) => ur(e), config: Je({ $onClear: Zn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const ka = wc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ti extends Ia {
  $config() {
...
se({ name: "@lexical/extension/DecoratorText", nodes: () => [ti], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Ht();
  if (Rn(n) || be(n)) for (const i of n.getNodes()) Ql(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function ei(t, e) {
  let r;
...
const so = 0, Ga = 1, ai = 2, _a = 3, Lr = 4, Qe = 5, Na = 6, gr = 7;
function Ca(t) {
  return t.id === so;
}
function oi(t) {
...
function td(t) {
  return function(e) {
    return e.id === Ga;
  }(t) || wt(305, String(t.id), String(Ga)), Object.assign(t, { id: ai });
}
...
class rd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Lr && wt(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== gr && wt(309, String(o.id), String(gr)), this.state = function(s) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Na && wt(310, String(r.id), String(Na)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Lr;
    }(e) || wt(313, String(e.id), String(Lr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= _a;
    }(e) || wt(314, String(e.id), String(_a)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= gr;
    }(e) || wt(316, String(e.id), String(gr)), e;
  }
...
const od = se({ config: Je({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = ad }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (gc(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [uc, Tn, pc, hc, En] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function nd(t) {
  throw t;
...
class rr {
  ...
  static maybeFromEditor(e) {
    const r = e[Go];
    return r && (r.PACKAGE_VERSION !== Ea && wt(292, r.PACKAGE_VERSION, Ea), r instanceof rr || wt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ca(i) || wt(300, s, n || "[unknown]"), Ca(c = i) || wt(304, String(c.id), String(so)), i = Object.assign(c, { id: Ga }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const g of Zl(p)) {
        if (typeof g != "function") {
          const h = o.get(g.replace);
          h && wt(302, p.name, g.replace.name, h.extension.name), o.set(g.replace, w);
        }
        r.add(g);
      }
      if (p.html) {
...
se({ dependencies: [qa, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return De(t.registerCommand(sd, (s) => {
    const c = Ht();
    if (!be(c)) return !1;
    ...
    return !0;
  }, Qa), t.registerCommand(mc, (s) => {
    if (vc(s.target)) {
      const c = bc(s.target);
      if (ld(c)) return function(d, l = !1) {
        const w = Ht(), p = d.isSelected(), g = d.getKey();
        let h;
        l && Rn(w) ? h = w : (h = xc(), yc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, $n), t.registerMutationListener(nr, (s, c) => {
    Yl(() => {
      let d = !1;
    ...
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(xe(() => {
      const l = c.value;
      l && (d.value ? Mn(l, i) : zc(l, i));
    }));
    return De(...s);
  }));
} });
se({ build: (t, e) => ur({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Je({ $getParentEditor: function() {
  const t = kc();
...
se({ build: (t, e, r) => ur(e), config: Je({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return xe(() => {
...
function dd(t, e, r = ni) {
  return De(t.registerCommand(Sc, (o) => {
    const n = Ht();
    if (!be(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => Dc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Ul(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Oc();
...
se({ build: (t, e, r) => ur(e), config: Je({ $canIndent: ni, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (be(m)) {
                const y = m.anchor;
                let v = y.getNode(), E = 0, k = 0;
                if (Va(v) && l >= 0 && w >= 0 && (E = l, k = l + w, m.setTextNodeRange(v, E, v, k)), E === k && p === "" || (m.insertRawText(p), v = y.getNode()), Va(v)) {
                  E = g, k = g + h;
                  const _ = v.getTextContentSize();
                  E = E > _ ? _ : E, k = k > _ ? _ : k, m.setTextNodeRange(v, E, v, k);
                }
...
se({ build: (t, e, r) => ur(e), config: Je({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => xe(() => r.getOutput().disabled.value ? void 0 : si(t)) });
function gd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
  ...
  return function(r, o) {
    ...
    return lo(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (g) => r._onError(g), children: a(Xs, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
        p !== null && s.push(Bc(w, p, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function vd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    lo(() => De(jc(n), si(n)), [n]);
  }(o), u(rt, { children: [t, a(bd, { content: e }), a(md, { editor: o, ErrorBoundary: r })] });
}
...
function Ed(t, e) {
  ...
  return u(rt, { children: [a(Nd, { editor: n, ...o, ref: e }), r != null && a(Td, { editor: n, content: r })] });
}
...
function Od({
  ...
  const [e] = ke(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Dd(), d = () => {
  };
...
function Md() {
  const { activeEditor: t } = di(), [e, r] = N([]), o = B((n) => {
    if (be(n) || tl(n)) {
      const i = [];
      Jo.forEach(({ format: s }) => {
...
function Pd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Od, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Md, {}) }) }),
        ...
        children: /* @__PURE__ */ a(
          El,
          {
            ...
            children: /* @__PURE__ */ u(Ut, { children: [
              /* @__PURE__ */ a(Pd, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                zl,
                {
...
const jd = "verseText", dp = Object.freeze([
...
function bi(t) {
  return (t == null ? void 0 : t.conflictType) === jd;
}
function xi(t) {
...
function wp({
  ...
  const [i, s] = N(Fd), [c, d] = N(n), [l, w] = N(!1), p = G(void 0), g = G(null);
  W(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
...
function Qo({
  ...
  }, [t.date, r]), v = M(() => t.user, [t.user]), E = M(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = M(() => Wa(t.contents), [t.contents]), _ = M(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), R = !!t.conflictResolutionAction && !_, j = M(() => {
    if (o && c)
      return /* @__PURE__ */ u(rt, { children: [
        /* @__PURE__ */ u(
          We,
          {
            onClick: (T) => {
              T.stopPropagation(), l(!0), p(Vd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Kd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(qd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), h()) : po(T) && (T.preventDefault(), T.stopPropagation(), ne(w) && m());
              },
              onKeyDown: (T) => {
        ...
        j && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ys, {}) }) }),
...
function ki({
  ...
  const [C, z] = N(tn), [q, U] = N(), [P, F] = N(), et = o, [Z, Nt] = N(!1), [mt, Tt] = N(!1), [H, at] = N(!1), [vt, ct] = N(!1), [lt, Wt] = N(!1), [dt, Xt] = N(R), [ee, O] = N(!1), re = G(void 0), [ce, Jt] = N(/* @__PURE__ */ new Map());
  W(() => {
    let S = !0;
    return (async () => {
      const yt = k ? await k(d) : !1;
      S && Wt(yt);
    })(), () => {
      S = !1;
    };
    ...
    let S = !0;
    if (!o) {
      ct(!1), Jt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const yt = E ? await E(d) : !1;
      S && ct(yt);
    })(), () => {
      S = !1;
    };
  ...
  W(() => {
    if (!o) {
      Ct.current !== "idle" && (U(void 0), F(void 0), Ct.current = "idle");
      return;
    }
    Ct.current === "idle" && (Ct.current = "pending"), vt ? Ct.current === "pending" && $ !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    $ !== i && (U($), Ct.current = "auto-populated") : Ct.current === "auto-populated" && (U(void 0), Ct.current = "pending");
  }, [o, $, vt, i]);
  const zt = M(
  ...
  const ae = M(() => zt[0], [zt]), Me = G(null), Pt = G(void 0), V = B(() => {
    var S;
    (S = Pt.current) == null || S.call(Pt), z(tn);
  }, []), J = B(() => {
    const S = !dt;
    Xt(S), O(!S), m == null || m(d, S);
  }, [dt, m, d]);
  W(() => {
    Nt(!1);
  }, [o]), W(() => {
    if (o && !dt && !ee) {
      ...
      return re.current = S, () => clearTimeout(S);
    }
  ...
  }, [i, r]), ht = M(() => zt.slice(1), [zt]), st = M(() => ht.length ?? 0, [ht.length]), bt = M(() => st > 0, [st]), gt = M(() => Z || st <= 2 ? ht : ht.slice(-2), [ht, st, Z]), xt = M(() => Z || st <= 2 ? 0 : st - 2, [st, Z]), Mt = M(
    () => st === 1 ? ot.singleReply : Ne(ot.multipleReplies, { count: st }),
    [st, ot]
  ), St = M(
    () => xt === 1 ? ot.singleReply : Ne(ot.multipleReplies, { count: xt }),
    [xt, ot]
  );
  W(() => {
    !o && mt && bt && Tt(!1);
  ...
  const It = B(
    async (S) => {
      ...
      At && await p({ threadId: d, contents: At }) && V();
    },
    [
      V,
      C,
    ...
    async (S) => {
      const At = ne(C) ? ea(C) : void 0, yt = S.status ? S.assignedUser : q ?? S.assignedUser, le = await p({
        ...S,
        contents: At,
        assignedUser: yt
      });
      return le && (yt !== void 0 && F(yt), At && V()), le;
    },
    [V, C, p, q]
  );
  ...
  const Ke = /* @__PURE__ */ a(
    Qo,
    {
      ...
      handleDeleteComment: h,
      onEditingChange: Tt,
      canEditOrDelete: (!mt && ce.get(ae.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Ud, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              K,
              {
                ...
                children: dt ? /* @__PURE__ */ a(ks, {}) : /* @__PURE__ */ a(_s, {})
              }
            ),
            D === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: lt && w !== "Resolved",
                  onClick: () => Dt({ threadId: d, status: "Resolved" }),
          ...
          /* @__PURE__ */ a("div", { className: "tw:flex tw:max-w-full tw:flex-wrap tw:items-baseline tw:gap-2", children: /* @__PURE__ */ u(
            "p",
            {
              ...
              className: f(
                ...
                {
                  "tw:overflow-visible tw:text-clip tw:whitespace-normal tw:break-words": et
                },
                { "tw:whitespace-nowrap": !et }
              ),
              children: [
                n && T ? /* @__PURE__ */ a(
                  K,
        ...
        /* @__PURE__ */ u(rt, { children: [
          bt && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(ar, {}) }),
          ...
          o && /* @__PURE__ */ u(rt, { children: [
            L && gt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            xt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    Z ? /* @__PURE__ */ a(Ns, {}) : /* @__PURE__ */ a(or, {})
                  ] })
                ]
              }
            ),
            gt.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Qo,
              {
                comment: S,
                localizedStrings: r,
                ...
                handleDeleteComment: h,
                onEditingChange: Tt,
                canEditOrDelete: (!mt && ce.get(S.id)) ?? !1
              }
            ) }, S.id)),
            v !== !1 && (!mt || ne(C)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (S) => {
                  po(S) && (S.preventDefault(), S.stopPropagation(), (ne(C) || q !== void 0 && q !== P) && It());
                },
                onKeyDown: (S) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    q !== void 0 && (ne(C) || q !== P) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ne(
                    ...
                    /* @__PURE__ */ u(Re, { open: H, onOpenChange: at, children: [
                      /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ a(
                        K,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: y == null ? void 0 : y.map((S) => /* @__PURE__ */ a(
                            Oe,
                            {
                              onSelect: () => {
                                U(S !== i ? S : void 0), Ct.current = "user-selected", F(void 0), at(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), Hd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Gr = (t) => Hd(Wa(t));
function Hr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Yd({
  ...
  const [s, c] = N("accept"), d = zo(), l = zo(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", m = p ? "accept" : s, y = M(
    () => Gr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = M(
    () => Gr(t.acceptedText ?? ""),
    ...
    () => Gr(t.mergedText ?? ""),
    [t.mergedText]
  ), k = M(() => Wa(t.contents), [t.contents]);
  if (!bi(t))
    return /* @__PURE__ */ a(Hr, { html: k });
  const _ = (P) => {
    c(P === "reject" || P === "merge" ? P : "accept");
  }, R = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", j = h ? [
    {
      value: "merge",
  ...
  let x;
  $ ? x = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (x = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const D = e["%conflict_note_no_result%"] ?? "No result preview available.", L = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: D }), C = (P) => P ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: P }) : L, z = () => {
    const P = o ?? "accept";
    return P === "merged" ? t.mergedText ? /* @__PURE__ */ a(Hr, { html: E }) : L : C(P === "reject" ? t.rejectedResultText : t.resultText);
  }, q = (P) => p && P.value === "reject", U = (P) => {
    const F = m === P.value, et = `${l}-${P.value}`, Z = q(P);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          className: f(
            ...
            F ? "tw:border-border tw:bg-accent/50" : "tw:border-transparent tw:hover:bg-accent/30",
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: d, className: "tw:sr-only", children: R }),
            /* @__PURE__ */ a(Hr, { html: P.html })
          ]
        },
        P.value
      )
      ...
      !w && !g && /* @__PURE__ */ u(rt, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: T.map((P) => q(P) ? /* @__PURE__ */ a(Ut, { delayDuration: 0, children: /* @__PURE__ */ u(Kt, { children: [
              /* @__PURE__ */ a(qt, { asChild: !0, children: U(P) }),
              /* @__PURE__ */ a(Gt, { side: "right", children: R })
            ] }) }, P.value) : U(P))
          }
        ),
...
function Zd({
  ...
  const [i, s] = N("loading"), [c, d] = N(!1), [l, w] = N(), p = n == null ? void 0 : n.getOptions, g = n == null ? void 0 : n.resolve;
  W(() => {
    let k = !0;
    if (!r) {
      s("loading");
    ...
    if (e === "Resolved") {
      for (let k = o.length - 1; k >= 0; k -= 1)
        if (o[k].status === "Resolved")
          return xi(o[k].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? l;
...
function Qd(t) {
  ...
  } = t, c = M(() => e.filter((E) => !E.deleted), [e]), d = M(
    () => c.find((E) => E.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Zd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function bp({
  ...
  const [k, _] = N(/* @__PURE__ */ new Set()), [R, j] = N(), [T, $] = N(), A = B(
    async (F) => {
      const et = await i(F);
      return et !== void 0 && F.assignedUser !== void 0 && F.assignedUser !== "" && $(F.assignedUser), et;
    },
    [i]
  );
  W(() => {
    m && (_((F) => new Set(F).add(m)), j(m));
  }, [m]);
  const x = r.filter(
    (F) => F.comments.some((et) => !et.deleted)
  ), D = x.map((F) => ({ id: F.id })), L = B(
    (F) => {
      _((et) => new Set(et).add(F.id)), j(F.id), y == null || y(F.id);
    },
    [y]
  ), C = B(
    (F) => {
      ...
      _((Z) => {
        const Nt = new Set(Z);
        return Nt.has(F) ? Nt.delete(F) : Nt.add(F), Nt;
      }), j(F), y == null || y(et ? void 0 : F);
    },
    [k, y]
  ), { listboxRef: z, activeId: q, handleKeyDown: U } = Yi({
    options: D,
    onOptionSelect: L
  }), P = B(
    (F) => {
      F.key === "Escape" ? (R && k.has(R) && (_((et) => {
        const Z = new Set(et);
        return Z.delete(R), Z;
      }), j(void 0), y == null || y(void 0)), F.preventDefault(), F.stopPropagation()) : U(F);
    },
    [R, k, U, y]
  );
  return /* @__PURE__ */ a(
      ...
      children: x.map((F) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: F.type === "Conflict" ? /* @__PURE__ */ a(Qd, { ...et, conflictResolution: E }) : /* @__PURE__ */ a(ki, { ...et })
          },
          F.id
        );
      })
...
function cr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ft.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ft.Icon, { asChild: !0, children: /* @__PURE__ */ a(Gc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function de({
  ...
  return /* @__PURE__ */ u(
    Ft.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ft.ItemIndicator, { children: /* @__PURE__ */ a(sa, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        ir,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(lr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(de, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function _r(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && nw(o)
  );
}
function la({
  className: t,
  ...
  const c = pt.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), cw(h, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), sw(c, y, w.key);
...
function lw({
  ...
  var T;
  const [w, p] = N([]), [g, h] = N([]), [m, y] = N({}), [v, E] = N({}), k = M(() => e ?? [], [e]), _ = Vn({
    data: k,
    columns: t,
    getCoreRowModel: jn(),
  ...
  }), R = _.getVisibleFlatColumns();
  let j;
  return d ? j = Array.from({ length: 10 }).map((x, D) => `skeleton-row-${D}`).map((x) => /* @__PURE__ */ a(ue, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ie, { colSpan: R.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? j = _.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    ue,
    {
      onClick: () => s($, _),
      "data-state": $.getIsSelected() && "selected",
      children: $.getVisibleCells().map((A) => /* @__PURE__ */ a(ie, { children: vr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    $.id
  )) : j = /* @__PURE__ */ a(ue, { children: /* @__PURE__ */ a(ie, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(tw, { table: _ }),
    /* @__PURE__ */ u(la, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ho, { stickyHeader: i, children: _.getHeaderGroups().map(($) => /* @__PURE__ */ a(ue, { children: $.headers.map((A) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : vr(A.column.columnDef.header, A.getContext()) }, A.id)) }, $.id)) }),
      /* @__PURE__ */ a(da, { children: j })
    ] }),
...
function Tp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(K, { variant: "default", children: [
      /* @__PURE__ */ a(Ds, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
    ...
    /* @__PURE__ */ a(Se, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(un, { children: l.itemType === 0 ? /* @__PURE__ */ a(rt, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        Wi,
        {
          ...
          children: l.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Xi, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Xe, {})
    ] }, l.label)) })
...
function Sp({
  ...
  const s = M(() => ls(r), [r]), d = ((l) => {
    const w = new Intl.DisplayNames(ds(), { type: "language" });
...
function _i({
  ...
  const [E, k] = N(!1), _ = B(
    (D) => {
      var C;
      const L = (C = t.find((z) => z.label === D)) == null ? void 0 : C.value;
      L && r(
        e.includes(L) ? e.filter((z) => z !== L) : [...e, L]
      );
    },
    [t, e, r]
  ), R = () => d || o, j = M(() => {
    if (!g) return t;
    const D = t.filter((C) => C.starred).sort((C, z) => C.label.localeCompare(z.label)), L = t.filter((C) => !C.starred).sort((C, z) => {
      const q = e.includes(C.value), U = e.includes(z.value);
      return q && !U ? -1 : !q && U ? 1 : C.label.localeCompare(z.label);
    });
    return [...D, ...L];
  }, [t, e, g]), T = () => {
    r(t.map((D) => D.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Re, { open: A, onOpenChange: w ?? k, children: [
    /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ u(
      K,
      {
        variant: y,
    ...
    /* @__PURE__ */ a($e, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Fe, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: $, children: s })
      ] }),
      /* @__PURE__ */ u(Be, { children: [
        /* @__PURE__ */ a(oa, { children: c }),
        /* @__PURE__ */ a(me, { children: j.map((D) => /* @__PURE__ */ u(
          Oe,
          {
            value: D.label,
            onSelect: _,
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ a(Ms, { className: "tw:h-4 tw:w-4" }),
...
function gw({
  ...
  const d = M(() => /Macintosh/i.test(navigator.userAgent), []), l = on(n, "%undoButton_tooltip%"), w = on(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(uo, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(
        K,
...
const mw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(rt, { children: [
...
function vw({
  ...
  const i = G(null), s = G(null), c = G(!1), [d, l] = N(t), [w, p] = N(r), [g, h] = N(!1);
  W(() => {
    l(t);
  }, [t]), W(() => {
    w !== r && p(r);
  ...
  const m = (v) => {
    ...
    var E, k, _, R;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((R = s.current) == null || R.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Te, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: mw(t, n, r) }) }) }),
...
const bw = (t, e) => t === "f" ? /* @__PURE__ */ u(rt, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function yw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: bw(t, r) }) }) }),
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: xw(t, r) }) })
    ] }) }),
...
function Rp({
  ...
  const [m, y] = N("generated"), [v, E] = N("generated"), [k, _] = N("*"), [R, j] = N("*"), [T, $] = N("f"), [A, x] = N(!1), [D, L] = N(!0), [C, z] = N(!1), q = G(!1), U = G(""), [P, F] = N(!1), [et, Z] = N(), [Nt, mt] = N(), [Tt, H] = N(), [at, vt] = N(), ct = G(null), lt = M(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (J && Ir("note", J)) {
      const ht = (ot = J.insert.note) == null ? void 0 : ot.caller;
      let st = "custom";
      ht === La ? st = "generated" : ht === ja ? st = "hidden" : ht && (_(ht), j(ht)), y(st), E(st), $(((nt = J.insert.note) == null ? void 0 : nt.style) ?? "f"), V = setTimeout(() => {
        var bt;
        (bt = w.current) == null || bt.applyUpdate([J]);
      }, 0);
    }
    return () => {
      V && clearTimeout(V);
  ...
  const dt = B(
    (V, J, ot = !1) => {
      var ht, st, bt;
      const nt = (st = (ht = w.current) == null ? void 0 : ht.getNoteOps(0)) == null ? void 0 : st.at(0);
      if (nt && Ir("note", nt)) {
        if (nt.insert.note) {
          let gt;
          V === "custom" ? gt = J : V === "generated" ? gt = La : gt = ja, nt.insert.note.caller = gt;
        }
        r == null || r([nt]), ot && l && i && ((bt = l.current) == null || bt.replaceEmbedUpdate(i, [nt]));
      }
    },
    [i, r, l]
  ), Xt = B(() => {
  ...
  const O = G({ book: n.book, chapterNum: n.chapterNum });
  te(() => {
    (O.current.book !== n.book || O.current.chapterNum !== n.chapterNum) && (O.current = { book: n.book, chapterNum: n.chapterNum }, ee.current());
  }, [n.book, n.chapterNum]);
  const re = () => {
    var J;
    const V = (J = p.current) == null ? void 0 : J.getElementsByClassName("editor-input")[0];
    ...
    var ot, nt, ht, st, bt;
    $(V);
    const J = (nt = (ot = w.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : nt.at(0);
    if (J && Ir("note", J)) {
      J.insert.note && (J.insert.note.style = V);
      const gt = (st = (ht = J.insert.note) == null ? void 0 : ht.contents) == null ? void 0 : st.ops;
      T !== "x" && V === "x" ? gt == null || gt.forEach((xt) => Ew(xt)) : T === "x" && V !== "x" && (gt == null || gt.forEach((xt) => Tw(xt))), (bt = w.current) == null || bt.applyUpdate([J, { delete: 1 }]);
    }
  }, zt = (V) => {
    vt(V.contextMarker), z(V.canRedo);
  }, ae = B(
    (V) => {
      var ot, nt, ht, st, bt;
      const J = (nt = (ot = w.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : nt.at(0);
      if (J && Ir("note", J)) {
        ...
        const gt = (ht = J.insert.note) == null ? void 0 : ht.style, xt = (bt = (st = J.insert.note) == null ? void 0 : st.contents) == null ? void 0 : bt.ops;
        if (gt || x(!1), x(
          gt === "x" ? !!(xt != null && xt.every((Mt) => {
            var It, Dt;
            if (!((It = Mt.attributes) != null && It.char)) return !0;
            const St = ((Dt = Mt.attributes) == null ? void 0 : Dt.char).style;
          ...
          q.current = !0, U.current = JSON.stringify(J), L(!0);
          return;
        }
        L(JSON.stringify(J) === U.current), dt(m, k);
      } else
        x(!1), L(!0);
    },
    [m, k, dt]
    ...
    if (g.current && Wt.length && V && V.rangeCount > 0) {
      const J = V.getRangeAt(0).getBoundingClientRect(), ot = g.current.getBoundingClientRect();
      Z(J.left - ot.left), mt(J.top - ot.top), H(J.height), F(!0);
    }
  }, [Wt, g]);
  W(() => {
    const V = () => {
    ...
    var V;
    P && ((V = ct.current) == null || V.focus());
  }, [P]), W(() => {
    var ot;
    const V = ((ot = p.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0, J = (nt) => {
      !P && V && document.activeElement === V && nt.key === c ? (nt.preventDefault(), Me()) : P && nt.key === "Escape" && (nt.preventDefault(), F(!1));
    };
    return document.addEventListener("keydown", J), () => {
      document.removeEventListener("keydown", J);
    };
  }, [P, Me, c]);
  const Pt = d["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(rt, { children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
              ...
              /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: Pt }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(rt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(rt, { children: Sw(t.marker, c, o, l) })
      }
    )
  ] });
}
function Mp({
  ...
  const w = d ?? ws(r, void 0), p = (k, _) => {
    l == null || l(k, _, n);
  }, g = i ? r.findIndex((k) => k === i) : -1, [h, m] = N(g), y = (k, _, R) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), l == null || l(_, R, n);
          break;
      }
  }, v = (k) => {
    if (r.length)
      switch (k.key) {
        case "ArrowDown":
          k.preventDefault(), m((_) => Math.min(_ + 1, r.length - 1));
          break;
        case "ArrowUp":
          k.preventDefault(), m((_) => Math.max(_ - 1, 0));
          break;
      }
  }, E = G([]);
  return W(() => {
        ...
        "ul",
        {
          ...
          children: r.map((k, _) => {
            ...
            return /* @__PURE__ */ u(rt, { children: [
              ...
              _ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(ar, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function $w({
  ...
  return /* @__PURE__ */ u(la, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(ho, { stickyHeader: !0, children: /* @__PURE__ */ u(ue, { children: [
    ...
    /* @__PURE__ */ a(da, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ue,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ie, { className: o, children: Rw(c.text) })
        ]
      },
...
const Mw = (t) => {
...
}, wa = (t, e, r) => /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
  /* @__PURE__ */ u(
    qt,
    {
  ...
  return e ? e[1] : "";
}, Pw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Fp = Object.freeze([
...
function Bp({
  ...
  const h = he(r, "%webView_inventory_all%"), m = he(r, "%webView_inventory_approved%"), y = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), E = he(r, "%webView_inventory_scope_currentBook%"), k = he(r, "%webView_inventory_scope_chapter%"), _ = he(r, "%webView_inventory_scope_verse%"), R = he(r, "%webView_inventory_filter_text%"), j = he(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = he(r, "%webView_inventory_no_results%"), [$, A] = N(!1), [x, D] = N("all"), [L, C] = N(""), [z, q] = N([]), U = M(() => {
    const H = t ?? [];
    return H.length === 0 ? [] : Vw(H, n, i);
  }, [t, n, i]), P = M(() => {
    if ($) return U;
    const H = [];
    return U.forEach((at) => {
      const vt = at.items[0], ct = H.find(
        (lt) => lt.items[0] === vt
      );
      ct ? (ct.count += at.count, ct.occurrences = ct.occurrences.concat(at.occurrences)) : H.push({
        items: [vt],
        count: at.count,
  ...
  }, [$, U]), F = M(() => P.length === 0 ? [] : Iw(P, x, L), [P, x, L]), et = M(() => {
    var vt, ct;
    if (!$) return d;
    ...
    for (let lt = 0; lt < H; lt++)
      at.push(
        Aw(
          ((ct = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ct[lt]) || "Additional Item",
          lt + 1
        )
      );
    return [...at, ...d];
  ...
  W(() => {
    F.length === 0 ? q([]) : F.length === 1 && q(F[0].items);
  }, [F]);
  const Z = (H, at) => {
    at.setRowSelection(() => {
      const ct = {};
      return ct[H.index] = !0, ct;
    });
    const vt = H.original.items;
    q(vt), g && vt.length > 0 && g(vt[0]);
  }, Nt = (H) => {
    ...
    if (P.length === 0 || z.length === 0) return [];
    const H = P.filter((at) => us(
      $ ? at.items : [at.items[0]],
      z
    ));
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        ir,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(lr, { children: [
              /* @__PURE__ */ a(de, { value: "all", children: h }),
      ...
      o && /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
        ...
        /* @__PURE__ */ a(Gt, { children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] }) })
    ] }),
...
const Ei = ia(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ks, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
Ei.displayName = "Spinner";
function Lw(t, e = 50) {
  const [r, o] = N(e), n = G(null);
  return W(() => {
    o(e);
  }, [t, e]), W(() => {
...
function Sa({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(rt, { children: [
      /* @__PURE__ */ a(ue, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(ie, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        ue,
        {
...
function Kp({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = M(
    () => t.filter((z) => !r || z.type === r).filter((z) => jw(z, s)).filter(
      (z) => d.length === 0 || d.includes(z.bestLanguageName)
    ),
    [t, r, s, d]
  ), p = M(
    () => w.filter((z) => o == null ? void 0 : o.includes(z.dblEntryUid)),
    [w, o]
  ), g = M(
    () => w.filter((z) => z.installed && !(o != null && o.includes(z.dblEntryUid))),
    [w, o]
  ), h = M(
    () => w.filter(
      (z) => !z.installed && !(o != null && o.includes(z.dblEntryUid))
    ),
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = Lw(h), E = M(
    () => Array.from(new Set(t.map((z) => z.bestLanguageName))).map((z) => ({
      label: z,
      value: z
    })),
    [t]
  ), k = p.length === 0 && g.length === 0 && h.length === 0, _ = _e(n, "%resourcePicker_title%"), R = _e(n, "%resourcePicker_search_placeholder%"), j = _e(n, "%resourcePicker_language_filter_any%"), T = _e(
    n,
    "%resourcePicker_section_already_selected%"
  ), $ = _e(n, "%resourcePicker_section_installed%"), A = _e(
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = _e(n, "%resourcePicker_no_results%"), D = _e(n, "%resourcePicker_showing_count%"), L = M(() => {
    if (d.length === E.length || d.length === 0)
      return j;
    if (d.length === 1) {
      const z = E.find((q) => q.value === d[0]);
      if (z) return z.label;
    }
    return Ne(
  ...
  }, [d, E, j, n]), C = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(rt, { children: [
    /* @__PURE__ */ a(Yr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Wr, { children: _ }) }),
    ...
    C && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: Ne(D, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(Ei, {}) }),
      k && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: x }),
      !k && !e && /* @__PURE__ */ a(la, { children: /* @__PURE__ */ u(da, { children: [
        /* @__PURE__ */ a(Sa, { label: T, resources: p }),
        /* @__PURE__ */ a(Sa, { label: $, resources: g, onSelect: i }),
        /* @__PURE__ */ a(
          Sa,
          {
            label: A,
        ...
        v && /* @__PURE__ */ a(ue, { className: "tw:border-0", children: /* @__PURE__ */ a(ie, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: y, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const Fw = "16rem", Bw = "3rem", Ti = pt.createContext(void 0);
function pa() {
  const t = pt.useContext(Ti);
  if (!t)
...
function Uw({
  ...
  const [d, l] = pt.useState(t), w = e ?? d, p = pt.useCallback(
    (_) => {
      const R = typeof _ == "function" ? _(w) : _;
      r ? r(R) : l(R);
    },
    [r, w]
  ), g = pt.useCallback(() => p((_) => !_), [p]), h = w ? "expanded" : "collapsed", v = Yt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = pt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function qp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    K,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Hc, {}) : /* @__PURE__ */ a(Yc, {}),
...
function Xw({
  ...
  const c = t ? wr.Root : "button", { state: d } = pa(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(Ww({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Kw,
    {
      ...
      children: /* @__PURE__ */ u(Gw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Hw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(Yw, { children: /* @__PURE__ */ a(
            Xw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const Ae = "scrBook", Zw = "scrRef", Ye = "source", Qw = "details", tu = "Scripture Reference", eu = "Scripture Book", zi = "Type", ru = "Details";
function au(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ut.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ae ? Ce(n.start) : void 0;
      },
...
function nh({
  ...
  const [l, w] = N([]), [p, g] = N([{ id: Ae, desc: !1 }]), [h, m] = N({}), y = M(
    () => t.flatMap((x) => x.data.map((D) => ({
      ...D,
      source: x.source
    }))),
    [t]
  ...
  W(() => {
    if (c) {
      const x = E.getSelectedRowModel().rowsById, D = Object.keys(x);
      if (D.length === 1) {
        const L = y.find((C) => dn(C) === D[0]) || void 0;
        L && c(L);
      }
    }
  }, [h, y, c, E]);
  const k = n ?? eu, _ = i ?? zi, R = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [Ae] },
    { label: `Group by ${_}`, value: [Ye] },
    {
    ...
    !x.getIsGrouped() && !x.getIsSelected() && x.getToggleSelectedHandler()(D);
  }, $ = (x, D) => x.getIsGrouped() ? "" : f("banded-row", D % 2 === 0 ? "even" : "odd"), A = (x, D, L) => {
    if (!((x == null ? void 0 : x.length) === 0 || D.depth < L.column.getGroupedIndex())) {
      if (D.getIsGrouped())
        switch (D.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(ew, { children: R.map((x) => /* @__PURE__ */ a(de, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(la, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(ho, { children: E.getHeaderGroups().map((x) => /* @__PURE__ */ a(ue, { children: x.headers.filter((D) => D.column.columnDef.header).map((D) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ra, { colSpan: D.colSpan, className: "tw:sticky top-0", children: D.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          vr(D.column.columnDef.header, D.getContext())
        ] }) }, D.id)
      )) }, x.id)) }),
      /* @__PURE__ */ a(da, { children: E.getRowModel().rows.map((x, D) => {
        const L = Yt();
        return /* @__PURE__ */ a(
          ue,
          {
            ...
            children: x.getVisibleCells().map((C) => {
              if (!(C.getIsPlaceholder() || C.column.columnDef.enableGrouping && !C.getIsGrouped() && (C.column.columnDef.id !== Ye || !r)))
                return /* @__PURE__ */ a(
                  ie,
                  {
                    className: f(
                    ...
                    children: C.getIsGrouped() ? /* @__PURE__ */ u(
                      K,
                      {
                        ...
                        children: [
                          ...
                          !x.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a($a, {})),
                          " ",
                          vr(C.column.columnDef.cell, C.getContext()),
                          " (",
                          x.subRows.length,
                          ")"
                        ]
...
function Si(t) {
  ...
  return ut.allBookIds.filter(
    (e, r) => t[r] === "1" && !ut.isObsolete(ut.bookIdToNumber(e))
  );
}
function fo(t, e) {
  return t.filter((r) => {
...
const Di = (t, e, r) => fo(t, e).every((o) => r.includes(o));
function nu({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: m } = {
  ...
  }, [y, v] = N(!1), [E, k] = N(""), _ = G(void 0), R = G(!1), j = M(
    () => Si(t),
    [t]
  ), T = M(() => {
    if (!E.trim()) {
    ...
    (C, z = !1) => {
      if (!z || !_.current) {
        r(
          e.includes(C) ? e.filter((Z) => Z !== C) : [...e, C]
        ), _.current = C;
        return;
      }
      const q = j.findIndex((Z) => Z === _.current), U = j.findIndex((Z) => Z === C);
      if (q === -1 || U === -1) return;
      const [P, F] = [
        Math.min(q, U),
        Math.max(q, U)
      ], et = j.slice(P, F + 1).map((Z) => Z);
      r(
        e.includes(C) ? e.filter((Z) => !et.includes(Z)) : [.../* @__PURE__ */ new Set([...e, ...et])]
      );
    },
    [e, r, j]
  ), A = (C) => {
    $(C, R.current), R.current = !1;
  }, x = (C, z) => {
    C.preventDefault(), $(z, C.shiftKey);
  }, D = () => {
    r(j.map((C) => C));
  }, L = () => {
    r([]);
      ...
      children: [
        ...
        /* @__PURE__ */ a($e, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Fe,
          {
            shouldFilter: !1,
            onKeyDown: (C) => {
              C.key === "Enter" && (R.current = C.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                Nr,
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: D, children: d }),
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: L, children: l })
              ] }),
              /* @__PURE__ */ u(Be, { children: [
                /* @__PURE__ */ a(oa, { children: w }),
                Object.values(tt).map((C, z) => {
                  const q = T[C];
                  if (q.length !== 0)
                    return /* @__PURE__ */ u(_n, { children: [
                      /* @__PURE__ */ a(
                        me,
                        {
                          heading: Fn(C, p, g, h, m),
                          children: q.map((U) => /* @__PURE__ */ a(
                            Un,
                            {
                              bookId: U,
                      ...
                      z < Object.values(tt).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, C);
                })
              ] })
            ]
...
function iu({
  ...
  return /* @__PURE__ */ a(
    K,
    {
      ...
      onClick: () => o(t),
      className: f(
        Di(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: gl(
        t,
...
function su({
  ...
  const i = o["%webView_book_selector_more%"], s = M(
    ...
    (d) => {
      ...
      r(
        Di(s, d, e) ? e.filter((w) => !l.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...l])]
      );
    },
    [e, r, s]
  );
...
function sh({
  ...
  const R = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = Rt(s, "%webView_scope_selector_verse%"), T = Rt(s, "%webView_scope_selector_chapter%"), $ = Rt(s, "%webView_scope_selector_book%"), A = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), x = Rt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), D = Rt(s, "%webView_scope_selector_current_book%"), L = Rt(s, "%webView_scope_selector_choose_books%"), C = Rt(s, "%webView_scope_selector_scope%"), z = Rt(s, "%webView_scope_selector_select_books%"), q = Rt(s, "%webView_scope_selector_range%"), U = Rt(s, "%webView_scope_selector_select_range%"), P = Rt(s, "%webView_scope_selector_range_start%"), F = Rt(s, "%webView_scope_selector_range_end%"), et = Rt(s, "%webView_scope_selector_ok%"), Z = Rt(s, "%webView_scope_selector_cancel%"), Nt = Rt(s, "%webView_scope_selector_navigate%"), mt = (I) => {
    if (!m) return;
  ...
  ], H = (I, X, Bt = !1) => /* @__PURE__ */ u(rt, { children: [
    I,
    X && !Bt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), at = e ? Tt.filter((I) => e.includes(I.value)) : Tt, vt = m ?? ma, ct = w ?? vt, lt = p ?? vt, Wt = () => {
  }, dt = G(null), Xt = G(null), ee = G(!1), O = G(null), re = G(!1), [ce, Jt] = N(void 0), Ct = G(!1), zt = G(!1), ae = G(null), Me = B((I) => {
    if (I) {
      Jt("start"), Ct.current = !1;
      return;
    }
    Jt((X) => X === "start" ? void 0 : X), Ct.current && (Ct.current = !1, requestAnimationFrame(() => {
      var Bt;
      const X = (Bt = dt.current) == null ? void 0 : Bt.querySelector("button");
      X == null || X.click();
    }));
  }, []), Pt = B((I) => {
    if (I) {
    ...
    (I) => {
      g == null || g(I), h == null || h(I), Ct.current = !0;
    },
    [g, h]
  ), J = B(
    (I) => {
      h == null || h(I), zt.current = !0;
    },
    [h]
  ), ot = B(
    (I) => {
      r(I), I === "selectedBooks" && n.length === 0 && (m != null && m.book) && i([m.book]);
    },
    [r, n, m, i]
  ), nt = at.find((I) => I.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((I) => I.toUpperCase()).join(", ") : t === "range" ? ps(ct, lt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : nt ? H(nt.label, nt.scrRefSuffix) : t, st = at.filter(
    (I) => I.value !== "selectedBooks" && I.value !== "range"
  ), bt = at.find((I) => I.value === "selectedBooks"), gt = at.find((I) => I.value === "range"), [xt, Mt] = N(!1), [St, It] = N(void 0), [Dt, Ke] = N(void 0), [S, At] = N(void 0), [yt, le] = N(void 0), [qe, Dr] = N([]), Or = l === "dropdown" && St === "selectedBooks", b = /* @__PURE__ */ a(
    su,
    {
      availableBookInfo: o,
      selectedBookIds: Or ? qe : n,
      onChangeSelectedBookIds: Or ? Dr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), Y = ce === "end", Q = ce === "start", Et = "tw:text-muted-foreground", oe = l === "dropdown" && St === "range", Ze = oe ? At : V, Vt = oe ? le : h ? J : Wt, kt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: f(Y && Et), children: P }),
      /* @__PURE__ */ a(
        ba,
        {
    ...
    /* @__PURE__ */ u("div", { ref: dt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: f(Q && Et), children: F }),
      /* @__PURE__ */ a(
        ba,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: oe ? S ?? ct : ct,
          onOpenChange: Pt,
          onCloseAutoFocus: (I) => {
            var X;
            zt.current && (zt.current = !1, I.preventDefault(), (X = ae.current) == null || X.focus());
          },
          className: f(Q && Et),
          modal: !0,
          align: "start"
  ...
  W(() => {
    ...
    const X = requestAnimationFrame(() => {
      I = requestAnimationFrame(() => {
        var Bt;
        (Bt = Ot.current[t]) == null || Bt.focus();
      });
    });
    return () => {
      cancelAnimationFrame(X), I && cancelAnimationFrame(I);
    };
  }, [xt, t]);
  const [Qt, Ge] = N(null), [Rr, Vi] = N(null), [$r, Li] = N(null), ji = 200, [Fi, Bi] = N(!1);
  W(() => {
    if (!$r || typeof ResizeObserver > "u") return;
    const I = new ResizeObserver(([X]) => {
      Bi(X.contentRect.width < ji);
    });
    return I.observe($r), () => I.disconnect();
  }, [$r]);
  const mo = B(
    (I) => {
      Ke(I), At(ct), le(lt), Dr(n), Mt(!1), It(I);
    },
    [ct, lt, n]
  ), vo = B(() => {
    Dt !== void 0 && (Dt === "range" ? (S && (g == null || g(S)), yt && (h == null || h(yt))) : Dt === "selectedBooks" && i(qe), ot(Dt), It(void 0), Ke(void 0));
  }, [
    Dt,
    S,
    yt,
    ...
    I || (It(void 0), Ke(void 0));
  }, []), bo = B((I) => {
    var X;
    I.preventDefault(), (X = Zt.current) == null || X.focus();
  }, []), xo = (I) => t === I ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(_t, { children: C }),
      l === "dropdown" ? /* @__PURE__ */ u(Te, { open: xt, onOpenChange: Mt, children: [
        ...
        /* @__PURE__ */ a(
          Se,
          {
            ...
            children: /* @__PURE__ */ u(ha, { container: $r, children: [
              st.map(({ value: I, label: X, dropdownLabel: Bt, scrRefSuffix: hr, id: Ui }) => /* @__PURE__ */ u(
                We,
                {
                  ref: ft(I),
              ...
              y && /* @__PURE__ */ u(rt, { children: [
                /* @__PURE__ */ a(Xe, {}),
                /* @__PURE__ */ a(Cr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Nt }),
                /* @__PURE__ */ a(
                  We,
                  {
                    ref: O,
                    ...
                    onSelect: (I) => {
                      var X, Bt;
                      if (I.preventDefault(), ee.current) {
                        ee.current = !1;
                        return;
                      }
                      re.current || (Bt = (X = Xt.current) == null ? void 0 : X.querySelector("button")) == null || Bt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (I) => {
                          const X = I.target instanceof HTMLElement ? I.target : void 0;
                          X != null && X.closest("button") && (ee.current = !0, requestAnimationFrame(() => {
                            ee.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ba,
                          {
                            ...
                            onCloseAutoFocus: (I) => {
                              var X;
                              I.preventDefault(), (X = O.current) == null || X.focus();
                            },
                            modal: !0,
        ...
        ao,
        {
          ...
          children: at.map(({ value: I, label: X, scrRefSuffix: Bt, id: hr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Xr, { className: "tw:me-2", value: I, id: hr }),
            /* @__PURE__ */ a(_t, { htmlFor: hr, children: H(X, Bt) })
          ] }, hr))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { children: z }),
      b
    ] }),
    l === "radio" && t === "range" && kt,
    l === "dropdown" && bt && /* @__PURE__ */ a(Fa, { open: St === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: Vi,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (I) => {
          Rr != null && Rr.querySelector('[data-state="open"]') && I.preventDefault();
        },
        children: /* @__PURE__ */ u(ha, { container: Rr, children: [
          /* @__PURE__ */ a(Yr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Wr, { children: L }) }),
          b,
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Mr(!1), children: Z }),
            /* @__PURE__ */ a(K, { onClick: vo, children: et })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(Fa, { open: St === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: Ge,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (I) => {
          Qt != null && Qt.querySelector('[data-state="open"]') && I.preventDefault();
        },
        children: /* @__PURE__ */ u(ha, { container: Qt, children: [
          ...
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Mr(!1), children: Z }),
            /* @__PURE__ */ a(K, { ref: ae, onClick: vo, children: et })
          ] })
        ] })
      }
    ) })
...
function ch({
  ...
  return /* @__PURE__ */ u(
    ir,
    {
      ...
      children: [
        /* @__PURE__ */ a(cr, { size: n, className: f("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          sr,
          {
        ...
        /* @__PURE__ */ a(
          lr,
          {
            ...
            style: { zIndex: dr },
            children: t.map((l) => /* @__PURE__ */ a(de, { value: `${l}`, children: c[ko(l)] }, `${l}`))
          }
        )
      ]
    }
...
function Ha({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(K, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Gs, {}) }) }),
    /* @__PURE__ */ a(Se, { align: "start", style: { zIndex: dr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(_n, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Ut, { children: Ri(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Xe, {})
    ] }, d)) })
  ] });
}
const $i = pt.forwardRef(
...
function uh({
  ...
  return /* @__PURE__ */ u($i, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Ha,
      {
        onSelectMenuItem: t,
...
const Mi = pt.forwardRef(({ className: t, ...e }, r) => {
  const o = Yt();
  return /* @__PURE__ */ a(
    pe.Root,
    {
...
Mi.displayName = pe.List.displayName;
const Ai = pt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.List,
  {
    ref: r,
    className: f(
...
Ai.displayName = pe.List.displayName;
const du = pt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Trigger,
  {
    ref: r,
    ...e,
...
)), Pi = pt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Content,
  {
    ref: r,
    className: f(
...
function hh({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Mi, { children: [
      /* @__PURE__ */ a(Ai, { children: t.map((c) => /* @__PURE__ */ a(du, { value: c.value, children: c.value }, c.key)) }),
...
const fr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(mu, {}, `separator-${i}`)), d;
  });
};
function yu({
  menuData: t,
  ...
  if (dl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(wu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(uu, { children: [
      /* @__PURE__ */ a(hu, { ref: l(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        gu,
        {
          style: { zIndex: dr },
          children: /* @__PURE__ */ a(Ut, { children: Ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function mh({
  ...
  const l = ku(
    ...
    var E, k, _, R, j, T;
    const v = y !== m ? ((k = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : k[y]) ?? ((R = (_ = t[m]) == null ? void 0 : _.uiNames) == null ? void 0 : R.en) : void 0;
      ...
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: dr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(de, { value: m, children: h(m, e) }, m))
            }
          )
        ]
      }
...
function _u({ item: t, createLabel: e, createComplexLabel: r }) {
...
function Mh({
  ...
  return /* @__PURE__ */ u(
    $t.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a($t.ItemIndicator, { children: /* @__PURE__ */ a(sa, {}) }) }),
        e
      ]
    }
  );
...
function Zh({
  ...
  return /* @__PURE__ */ a(
    pe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", zu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
Ou(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Kp as ResourcePickerDialog,
  bh as ResultsCard,
  ih as SCOPE_SELECTOR_STRING_KEYS,
  ...
  ar as Separator,
  lh as SettingsList,
  wh as SettingsListHeader,
  dh as SettingsListItem,
  Jw as SettingsSidebar,
  oh as SettingsSidebarContentSearch,
  Kw as Sidebar,
  ...
  th as SidebarMenuSkeleton,
  eh as SidebarMenuSub,
  ah as SidebarMenuSubButton,
  rh as SidebarMenuSubItem,
