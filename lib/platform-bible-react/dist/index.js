...
function yh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = me, [r, o] = ze(""), [i, s] = ze(""), [l, c] = ze(!1), u = Nn(void 0), d = $e(
    (S) => ({
      OT: n.filter((w) => me.isBookOT(w)),
      NT: n.filter((w) => me.isBookNT(w)),
      DC: n.filter((w) => me.isBookDC(w))
    })[S],
    [n]
  ), f = $e(
    (S) => d(S).filter(
    ...
    o(S);
  }, b = $e((S) => wi(me.bookIdToNumber(S)), []), v = (S) => {
    s(i !== S ? S : ""), b(S) === -1 && (t({
...
function cl() {
  return So || (So = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var m = c, C = u, P = l, A = s, _ = t, D = d, B = r, z = v, G = b, L = n, I = i, N = o, j = f, Q = !1;
    function Z($) {
...
function wc(e) {
  ...
  }), A = x.useCallback(() => o.isTopModal(m()), [o]), _ = on((N) => {
...
}, []), Tc = "beforeRead", kc = "read", Oc = "afterRead", Sc = "beforeMain", Cc = "main", Pc = "afterMain", Rc = "beforeWrite", Nc = "write", $c = "afterWrite", Mc = [Tc, kc, Oc, Sc, Cc, Pc, Rc, Nc, $c];
function We(e) {
...
function hu(e) {
  ...
  if (C) {
    if (i) {
      var G, L = w === "y" ? Se : Ce, I = w === "y" ? Le : Fe, N = w === "y" ? "height" : "width", j = C[w], Q = j + h[L], Z = j - h[I], O = b ? -A[N] / 2 : 0, M = S === _t ? P[N] : A[N], V = S === _t ? -A[N] : -P[N], X = t.elements.arrow, F = b && X ? Vr(X) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var Te, he = w === "x" ? Se : Ce, lt = w === "x" ? Le : Fe, ke = C[m], Ge = m === "y" ? "height" : "width", Pe = ke + h[he], Xe = ke - h[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[m]) != null ? Te : 0, ct = ye ? Pe : ke - P[Ge] - A[Ge] - yt + D.altAxis, Vt = ye ? ke + P[Ge] + A[Ge] - yt - D.altAxis : Xe, bn = b && ye ? Bc(ct, ke, Vt) : tn(b ? ct : Pe, ke, b ? Vt : Xe);
      C[m] = bn, z[m] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
oc(pa, ["root"]);
const Pu = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Ru = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Nu(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const Mu = () => et({
  ...
  const C = Nu(d, s), [P, A] = x.useState(C), [_, D] = x.useState(An(o));
  x.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: E = {}
  } = t, S = ce(t, Ru), [y, w] = x.useState(!0), m = () => {
    w(!1);
  }, C = () => {
    w(!0);
  };
...
const Np = Rp(), Zr = Np, Qr = "$$material", ya = (e) => Cn(e) && e !== "classes", $p = zd({
  themeId: Qr,
  defaultTheme: Zr,
...
const Dp = {
  ...
  } = t, E = ce(t, Ap), S = Jt(), y = x.useRef(), w = gn(), m = x.useRef(null), C = Be(m, i.ref, n), P = (I) => (N) => {
    if (I) {
      const j = m.current;
      N === void 0 ? I(j) : I(j, N);
    }
...
const Oa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const C = tt({
    ...
    TransitionProps: J
  } = C, R = ce(C, zp), re = /* @__PURE__ */ x.isValidElement(A) ? A : /* @__PURE__ */ T("span", {
    children: A
  }), ve = gn(), Te = ve.direction === "rtl", [he, lt] = x.useState(), [ke, Ge] = x.useState(null), Pe = x.useRef(!1), Xe = L || Z, ye = Jt(), yt = Jt(), ct = Jt(), Vt = Jt(), [bn, oo] = Hi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const io = (ee) => {
    ...
    he || lt(ee.currentTarget), Ua(ee), so.current === !0 && (lo(!0), tr(ee));
  }, po = (ee) => {
    Pe.current = !0;
    const Re = re.props;
...
const Nf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], $f = (e) => {
  const {
    open: t,
    exited: n,
    classes: r
...
`));
    ...
    const lt = Te + R.height, ke = he + R.width, Ge = It(Rn(c)), Pe = Ge.innerHeight - h, Xe = Ge.innerWidth - h;
    if (h !== null && Te < h) {
      const ye = Te - h;
...
`)), h !== null && he < h) {
  ...
  const W = v || (c ? xe(Rn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : Wf, H = (i = y == null ? void 0 : y.paper) != null ? i : La, K = gt({
    elementType: H,
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const I = (r = S.paper) != null ? r : eh, N = (o = y.paper) != null ? o : b, j = gt({
    elementType: S.root,
