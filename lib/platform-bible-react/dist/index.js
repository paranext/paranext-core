...
import { jsx as o, jsxs as p, Fragment as it } from "react/jsx-runtime";
import b, { forwardRef as We, useRef as rt, useMemo as B, useState as A, useCallback as j, useLayoutEffect as Vt, createContext as mn, useContext as lr, useEffect as W, Component as ws, createElement as Ir, Suspense as cs, createRef as ds, Fragment as io } from "react";
...
const Re = ve.Root, De = ve.Trigger, cp = ve.Anchor, de = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = wt();
...
function dp(e, t, n = (a, s) => a === s, r = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, r - 1)];
...
function pp({
  ...
  const w = wt(), [d, f] = A(!1), [h, u] = A(""), [g, y] = A(""), [N, R] = A("books"), [v, x] = A(void 0), [T, V] = A(!1), k = rt(void 0), C = rt(void 0), S = rt(void 0), _ = rt(void 0), E = rt({}), $ = j(
    (D) => {
      t(D), l && l(D);
    },
    [t, l]
    ...
    (D) => {
      const U = N === "chapters" ? v : M == null ? void 0 : M.book;
      U && ($({
        book: U,
        chapterNum: D,
        verseNum: 1
      }), f(!1), R("books"), x(void 0), y(""));
    },
    [$, N, v, M]
  ), Ct = j(
    (D) => {
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: U, isDigit: st } = Gr(D.key);
      if (N === "chapters") {
        if (D.key === "Backspace") {
        ...
        if (U || st) {
          if (D.preventDefault(), D.stopPropagation(), R("books"), x(void 0), st && v) {
            const dt = re[v];
            y(`${dt} ${D.key}`);
          } else
            y(D.key);
      ...
      if ((N === "chapters" || N === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        const dt = N === "chapters" ? v : M == null ? void 0 : M.book;
        if (!dt) return;
        const mt = (() => {
          if (!h) return 1;
          const Ve = h.match(/(\d+)$/);
    ...
    const { isLetter: U, isDigit: st } = Gr(D.key);
    (U || st) && (D.preventDefault(), y((dt) => dt + D.key), C.current.focus(), V(!1));
  }, []);
  return Vt(() => {
    const D = setTimeout(() => {
      if (d && N === "books" && S.current && _.current) {
        const U = S.current, st = _.current, dt = st.offsetTop, mt = U.clientHeight, Wt = st.clientHeight, Ot = dt - mt / 2 + Wt / 2;
        U.scrollTo({
          top: Math.max(0, Ot),
          behavior: "smooth"
        }), u(Jn(e.book));
    ...
    if (N === "chapters" && v) {
      ...
      setTimeout(() => {
        if (S.current)
          if (D) {
            const U = E.current[e.chapterNum];
  ...
  }, [N, v, M, e.book, e.chapterNum]), /* @__PURE__ */ p(Re, { open: d, onOpenChange: at, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
    ...
    /* @__PURE__ */ o(de, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ p(
      Ee,
      {
        ...
        shouldFilter: !1,
        children: [
          N === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: P.map(({ onClick: D, disabled: U, title: st, icon: dt }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            v && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: ge(v, a) })
          ] }),
          !T && /* @__PURE__ */ p(Se, { ref: S, children: [
            N === "books" && /* @__PURE__ */ p(it, { children: [
              !M && Object.entries(Z).map(([D, U]) => {
                if (U.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Kt, { heading: es(D), children: U.map((st) => /* @__PURE__ */ o(
                      Xo,
                      {
                        bookId: st,
                        onSelect: (dt) => yt(dt),
              ...
              M && Tt(M.book) > 1 && /* @__PURE__ */ p(it, { children: [
...
function Wn({
  ...
  const [v, x] = A(!1), T = c ?? l, V = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], k = (C, S) => {
    const _ = l(C), E = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, $ = `${S ?? ""}${_}${E ?? ""}`;
    return /* @__PURE__ */ p(
      ce,
      {
        value: _,
        ...
        children: [
          ...
          /* @__PURE__ */ p("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: [
            _,
            E && /* @__PURE__ */ p("span", { className: "tw-text-muted-foreground", children: [
              " · ",
              E
            ] })
          ] })
  ...
  return /* @__PURE__ */ p(Re, { open: v, onOpenChange: x, ...R, children: [
    ...
    /* @__PURE__ */ o(
      de,
      {
        ...
        children: /* @__PURE__ */ p(Ee, { children: [
          ...
          /* @__PURE__ */ o(Se, { children: V(t) ? t.map((C) => /* @__PURE__ */ o(Kt, { heading: C.groupHeading, children: C.options.map((S) => k(S, C.groupHeading)) }, C.groupHeading)) : t.map((C) => k(C)) })
        ] })
      }
    )
  ] });
...
function hp({
  ...
  const d = Dn(w, "%webView_bookSelector_currentBook%"), f = Dn(w, "%webView_bookSelector_choose%"), h = Dn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = A(
    "current book"
    /* CURRENT_BOOK */
  ), y = (N) => {
    g(N), e(N);
    ...
    gr,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ o(lt, { className: "tw-flex tw-items-center", children: r.map((N) => q.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ o(
            L,
            {
...
const fp = [
  ...
  const a = rt(null), [s, i] = A(void 0), [l, c] = A(void 0), w = j(
    (u) => {
      i(u);
    ...
    if (y && El.includes(y)) return !0;
    const N = u.getAttribute("tabindex");
    return N !== void 0 && N !== "-1";
  }, h = j(
    (u) => {
      var C;
      const g = u.target, y = (S) => S ? document.getElementById(S) : void 0, N = y(l), R = y(s);
      if (!!(N && g && N.contains(g) && g !== N) && f(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const S = e.find((_) => _.id === l);
            S && w(S.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const _ = S.findIndex(($) => $ === g);
          if (_ === -1) return;
          let E;
          u.key === "ArrowDown" ? E = Math.min(_ + 1, S.length - 1) : E = Math.max(_ - 1, 0), E !== _ && (u.preventDefault(), u.stopPropagation(), (C = S[E]) == null || C.focus());
          return;
        }
        return;
      }
      const T = e.findIndex((S) => S.id === s);
      let V = T;
      switch (u.key) {
        case "ArrowDown":
          V = Math.min(T + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          V = Math.max(T - 1, 0), u.preventDefault();
          break;
        case "Home":
      ...
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            const g = fn();
            u.append(g);
            const y = Uo ? document.activeElement : null;
            ($t() !== null || y !== null && y === f.getRootElement()) && g.select();
          }
        }, on);
...
function zl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ni(t) && r !== null) {
    ...
    if (w || d) {
      const [f, h] = ri(e), u = l.is(c), g = t.is(i ? c : l), y = t.is(i ? l : c);
      let N, R = 0;
      u ? (R = f > h ? h : f, N = f > h ? f : h) : g ? (R = i ? h : f, N = void 0) : y && (R = 0, N = i ? f : h);
      const v = t.__text.slice(R, N);
      v !== t.__text && (n === "clone" && (t = oi(t)), t.__text = v);
    }
  }
  return t;
}
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (Ke(g)) {
                const y = g.anchor;
                let N = y.getNode(), R = 0, v = 0;
                if (cn(N) && w >= 0 && d >= 0 && (R = w, v = w + d, g.setTextNodeRange(N, R, N, v)), R === v && f === "" || (g.insertRawText(f), N = y.getNode()), cn(N)) {
                  R = h, v = h + u;
                  const x = N.getTextContentSize();
                  R = R > x ? x : R, v = v > x ? x : v, g.setTextNodeRange(N, R, N, v);
                }
...
function uw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Nr(() => Ut(Li(a), la(a)), [a]);
  }(r), p(it, { children: [e, o(mw, { content: t }), o(pw, { editor: r, ErrorBoundary: n })] });
}
...
function yw(e, t) {
  ...
  return p(it, { children: [o(vw, { editor: a, ...r, ref: t }), n != null && o(Nw, { editor: a, content: n })] });
}
...
function Ew({
  ...
  const [t] = Dt(), [n, r] = A(t), [a, s] = A("paragraph"), [i, l] = Cw(), c = () => {
  };
...
function Rw() {
  const { activeEditor: e } = da(), [t, n] = A([]), r = j((a) => {
    if (Ke(a) || ji(a)) {
      const s = [];
      eo.forEach(({ format: i }) => {
...
function ma(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = ma(e, g, h, r);
    !a && ne(t) && y && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
...
function fa(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const c = function(g, y) {
    const { nodeName: N } = g, R = y._htmlConversions.get(N.toLowerCase());
    let v = null;
    if (R !== void 0) for (const x of R) {
      const T = x(g);
      T !== null && (v === null || (v.priority || 0) <= (T.priority || 0)) && (v = T);
    }
...
function no({
  ...
  const y = j(() => {
    ...
    const k = new Date(e.date), C = qs(
      k,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), S = k.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [e.date, r]), v = B(() => e.user, [e.user]), x = B(
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), y()) : k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), zt(h) && N());
              },
              onKeyDown: (k) => {
...
function Yw({
  ...
  const [u, g] = A($n), [y, N] = A(!1), [R, v] = A(!1), [x, T] = A(!1), [V, k] = A(!1), C = B(() => e.filter((I) => !I.deleted), [e]), S = B(() => C[0], [C]), _ = rt(null), E = rt(void 0);
  W(() => {
    const I = _.current;
    if (!I) return;
    const at = () => {
      v(I.scrollWidth > I.clientWidth);
    };
    return at(), window.addEventListener("resize", at), () => window.removeEventListener("resize", at);
  }, [S == null ? void 0 : S.verse]), W(() => {
    T(!1);
  }, [n]);
  const $ = B(
    () => ({
    ...
    [a, t]
  ), H = B(() => C.slice(1), [C]), O = B(() => H.length ?? 0, [H.length]), Z = B(() => O > 0, [O]), M = B(() => x || O <= 2 ? H : H.slice(-2), [H, O, x]), Q = B(() => x || O <= 2 ? 0 : O - 2, [O, x]), yt = B(
    ...
    var at;
    await d(l, nr(u)) && ((at = E.current) == null || at.call(E), g($n));
  }, [u, d, l]), P = j(
    async (I, at) => {
      var Ae;
      if (!w) return !1;
      const ct = zt(u) ? nr(u) : void 0, vt = await w(I, at, ct);
      return vt && ct && ((Ae = E.current) == null || Ae.call(E), g($n)), vt;
    },
    [u, w]
  );
  return /* @__PURE__ */ o(
          ...
          /* @__PURE__ */ p("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            R && /* @__PURE__ */ o(
              L,
              {
                ...
                size: "icon",
                onClick: (I) => {
                  I.stopPropagation(), N(!y);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": y ? "Collapse text" : "Expand text",
                children: y ? /* @__PURE__ */ o(Fn, {}) : /* @__PURE__ */ o(se, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
            no,
            {
              ...
              isThreadExpanded: n,
              threadStatus: c,
              isEditable: C.length === 1 && (S == null ? void 0 : S.user) === s,
          ...
          n && /* @__PURE__ */ p(it, { children: [
            Q > 0 && /* @__PURE__ */ p(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (I) => {
                  (I.key === "Enter" || I.key === " ") && (I.preventDefault(), I.stopPropagation(), T(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(ye, {}) }),
            ...
            M.map((I) => {
              const ct = I.id === H[H.length - 1].id && I.user === s;
...
function gp({
  ...
  const [c, w] = A(), d = t.filter(
    ...
    w(v);
  }, []), { listboxRef: g, activeId: y, handleKeyDown: N } = Sl({
    options: f,
    onOptionSelect: h
  }), R = j(
    (v) => {
      v.key === "Escape" ? (w(void 0), v.preventDefault(), v.stopPropagation()) : N(v);
    },
    [N]
  );
  return /* @__PURE__ */ o(
...
function ic({
  ...
  var k;
  const [d, f] = A([]), [h, u] = A([]), [g, y] = A({}), [N, R] = A({}), v = B(() => t ?? [], [t]), x = Ro({
    data: v,
    columns: e,
    getCoreRowModel: Oo(),
  ...
  }), T = x.getVisibleFlatColumns();
  let V;
  return c ? V = Array.from({ length: 10 }).map((_, E) => `skeleton-row-${E}`).map((_) => /* @__PURE__ */ o(It, { children: /* @__PURE__ */ o(ae, { colSpan: T.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(rr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((k = x.getRowModel().rows) == null ? void 0 : k.length) > 0 ? V = x.getRowModel().rows.map((C) => /* @__PURE__ */ o(
    It,
    {
      onClick: () => i(C, x),
      "data-state": C.getIsSelected() && "selected",
      children: C.getVisibleCells().map((S) => /* @__PURE__ */ o(ae, { children: je(S.column.columnDef.cell, S.getContext()) }, S.id))
    },
    C.id
    ...
    /* @__PURE__ */ p(yn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Nn, { stickyHeader: s, children: x.getHeaderGroups().map((C) => /* @__PURE__ */ o(It, { children: C.headers.map((S) => /* @__PURE__ */ o(Je, { children: S.isPlaceholder ? void 0 : je(S.column.columnDef.header, S.getContext()) }, S.id)) }, C.id)) }),
...
function yp({ id: e, label: t, groups: n }) {
  const [r, a] = A(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ p(pe, { children: [
    ...
    /* @__PURE__ */ o(Jt, { children: n.map((w, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ o(Na, { children: w.itemType === 0 ? /* @__PURE__ */ o(it, { children: w.items.map((f, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Ht,
        {
          checked: r[d][h],
...
function pc({
  ...
  const [R, v] = A(!1), x = j(
    (E) => {
      var z;
      const $ = (z = e.find((H) => H.label === E)) == null ? void 0 : z.value;
      $ && n(
    ...
    if (!h) return e;
    const E = e.filter((z) => z.starred).sort((z, H) => z.label.localeCompare(H.label)), $ = e.filter((z) => !z.starred).sort((z, H) => {
  ...
  return /* @__PURE__ */ o("div", { id: N, className: g, children: /* @__PURE__ */ p(Re, { open: S, onOpenChange: d ?? v, children: [
    /* @__PURE__ */ o(De, { asChild: !0, children: /* @__PURE__ */ p(
      L,
      {
        variant: y,
    ...
    /* @__PURE__ */ o(de, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(Ee, { children: [
      ...
      /* @__PURE__ */ p(Se, { children: [
        ...
        /* @__PURE__ */ o(Kt, { children: V.map((E) => /* @__PURE__ */ p(
          ce,
          {
            value: E.label,
            onSelect: x,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ o(Ds, { className: "tw-h-4 tw-w-4" }),
...
const uc = (e, t, n) => e === "generated" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ o("p", { children: "+" }),
  " ",
  t["%footnoteEditor_callerDropdown_item_generated%"]
] }) : e === "hidden" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ o("p", { children: "-" }),
  " ",
...
const hc = (e, t) => e === "f" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ o(mo, {}),
  " ",
  t["%footnoteEditor_noteType_footnote_label%"]
] }) : e === "fe" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ o(ho, {}),
  " ",
...
function Cp({
  ...
  const l = rt(null), c = ds(), [w, d] = A("generated"), [f, h] = A("*"), [u, g] = A("f"), y = B(
    () => ({
      ...s,
  ...
  W(() => {
    ...
    if (T && Tn("note", T)) {
      const C = (V = T.insert.note) == null ? void 0 : V.caller;
      let S = "custom";
      C === Xn ? S = "generated" : C === Kn ? S = "hidden" : C && h(C), d(S), g(((k = T.insert.note) == null ? void 0 : k.style) ?? "f"), T.insert.note && (T.insert.note.caller = ""), x = setTimeout(() => {
        var _;
        (_ = l.current) == null || _.applyUpdate([{ delete: 1 }, T]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const N = j(() => {
    var T, V;
    const x = (V = (T = l.current) == null ? void 0 : T.getNoteOps(0)) == null ? void 0 : V.at(0);
    x && Tn("note", x) && (x.insert.note && (w === "custom" ? x.insert.note.caller = f : x.insert.note.caller = w === "generated" ? Xn : Kn), t([x]));
  }, [w, f, t]), R = () => {
    var T;
    const x = (T = c.current) == null ? void 0 : T.getElementsByClassName("editor-input")[0];
        ...
        /* @__PURE__ */ o(
          gc,
          {
            ...
            handleNoteTypeChange: (x) => {
              var V, k, C;
              g(x);
              const T = (k = (V = l.current) == null ? void 0 : V.getNoteOps(0)) == null ? void 0 : k.at(0);
              T && Tn("note", T) && (T.insert.note && (T.insert.note.style = x), (C = l.current) == null || C.applyUpdate([{ delete: 1 }, T]));
            },
            localizedStrings: i
          }
        ),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Mt, { children: /* @__PURE__ */ p(Ft, { children: [
            /* @__PURE__ */ o(oe, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: R, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(po, {}) }) }),
...
function xc({
  ...
  return /* @__PURE__ */ p(it, { children: [
    /* @__PURE__ */ p("div", { className: m("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: [
      c,
      d
    ] }),
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(it, { children: bc(e.marker, l, r, w) })
      }
    )
  ] });
}
function Sp({
  ...
  const d = c ?? ei(n, void 0), f = (v, x) => {
    w == null || w(v, x, a);
  }, h = s ? n.findIndex((v) => v === s) : -1, [u, g] = A(h), y = (v, x, T) => {
    if (n.length)
      switch (v.key) {
        case "Enter":
        case " ":
          v.preventDefault(), w == null || w(x, T, a);
          break;
      }
  }, N = (v) => {
    if (n.length)
      switch (v.key) {
        case "ArrowDown":
          v.preventDefault(), g((x) => Math.min(x + 1, n.length - 1));
          break;
        case "ArrowUp":
          v.preventDefault(), g((x) => Math.max(x - 1, 0));
          break;
      }
  }, R = rt([]);
  return W(() => {
        ...
        "ul",
        {
          ...
          children: n.map((v, x) => {
            ...
            return /* @__PURE__ */ p(it, { children: [
              ...
              x < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(ye, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
    ...
    /* @__PURE__ */ o(kn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ p(
      It,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ae, { children: yc(i.text) })
        ]
      },
...
const _n = (e) => e === "asc" ? /* @__PURE__ */ o(Vs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Tp = (e) => ({
  accessorKey: "item",
  ...
  return t ? t[1] : "";
}, _c = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Ap = Object.freeze([
...
function Vp({
  ...
  const f = Et(n, "%webView_inventory_all%"), h = Et(n, "%webView_inventory_approved%"), u = Et(n, "%webView_inventory_unapproved%"), g = Et(n, "%webView_inventory_unknown%"), y = Et(n, "%webView_inventory_scope_currentBook%"), N = Et(n, "%webView_inventory_scope_chapter%"), R = Et(n, "%webView_inventory_scope_verse%"), v = Et(n, "%webView_inventory_filter_text%"), x = Et(
    n,
    "%webView_inventory_show_additional_items%"
  ), T = Et(n, "%webView_inventory_no_results%"), [V, k] = A(!1), [C, S] = A("all"), [_, E] = A(""), [$, z] = A([]), H = B(() => {
    const P = e ?? [];
    return P.length === 0 ? [] : Ec(P, a, s);
  }, [e, a, s]), O = B(() => {
    if (V) return H;
    const P = [];
    return H.forEach((I) => {
      const at = I.items[0], ct = P.find(
        (vt) => vt.items[0] === at
      );
      ct ? (ct.count += I.count, ct.occurrences = ct.occurrences.concat(I.occurrences)) : P.push({
        items: [at],
        count: I.count,
  ...
  }, [V, H]), Z = B(() => O.length === 0 ? [] : Cc(O, C, _), [O, C, _]), M = B(() => {
    var at, ct;
    if (!V) return c;
    const P = (at = r == null ? void 0 : r.tableHeaders) == null ? void 0 : at.length;
    if (!P) return c;
    const I = [];
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ p(Ne, { onValueChange: (P) => yt(P), defaultValue: i, children: [
        ...
        /* @__PURE__ */ p(we, { children: [
          /* @__PURE__ */ o(xt, { value: "book", children: y }),
          /* @__PURE__ */ o(xt, { value: "chapter", children: N }),
          /* @__PURE__ */ o(xt, { value: "verse", children: R })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Me,
...
const Sc = "16rem", Tc = "3rem", Ra = b.createContext(void 0);
function Cn() {
...
const Da = b.forwardRef(
  ({
    ...
    const [w, d] = b.useState(e), f = t ?? w, h = b.useCallback(
      (x) => {
        const T = typeof x == "function" ? x(f) : x;
        n ? n(T) : d(T);
      },
      [n, f]
    ), u = b.useCallback(() => h((x) => !x), [h]), g = f ? "expanded" : "collapsed", R = wt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", v = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ o(Ra.Provider, { value: v, children: /* @__PURE__ */ o(Mt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Rc = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Cn();
  return /* @__PURE__ */ p(
    L,
    {
...
Ac.displayName = "SidebarSeparator";
...
const Vc = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? _e : "button",
  {
    ref: r,
...
const Pc = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? _e : "button",
  {
    ref: a,
...
Lc.displayName = "SidebarMenuBadge";
const Bc = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
const Fc = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? _e : "a",
  {
    ref: s,
...
Fc.displayName = "SidebarMenuSubButton";
function Gc({
  id: e,
  extensionLabels: t,
  projectInfo: n,
...
const jt = "scrBook", Hc = "scrRef", ee = "source", Xc = "details", Kc = "Scripture Reference", Uc = "Scripture Book", Pa = "Type", Yc = "Details";
function qc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: jt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Kc,
      cell: (r) => {
...
}, ao = (e) => `${Jc({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Pp({
  sources: e,
  ...
  const [w, d] = A([]), [f, h] = A([{ id: jt, desc: !1 }]), [u, g] = A({}), y = B(
    () => e.flatMap((_) => _.data.map((E) => ({
      ...E,
      source: _.source
    }))),
    [e]
  ...
  W(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const $ = y.find((z) => ao(z) === E[0]) || void 0;
        $ && l($);
      }
    }
  }, [u, y, l, R]);
  const v = a ?? Uc, x = s ?? Pa, T = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${v}`, value: [jt] },
    { label: `Group by ${x}`, value: [ee] },
    {
      label: `Group by ${v} and ${x}`,
      value: [jt, ee]
    },
    {
      label: `Group by ${x} and ${v}`,
      value: [ee, jt]
    }
  ], V = (_) => {
    d(JSON.parse(_));
  ...
  }, C = (_, E) => _.getIsGrouped() ? "" : m("banded-row", E % 2 === 0 ? "even" : "odd"), S = (_, E, $) => {
    if (!((_ == null ? void 0 : _.length) === 0 || E.depth < $.column.getGroupedIndex())) {
      if (E.getIsGrouped())
        switch (E.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ p(
      Ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(we, { position: "item-aligned", children: /* @__PURE__ */ o(Jw, { children: T.map((_) => /* @__PURE__ */ o(xt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(yn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Nn, { children: R.getHeaderGroups().map((_) => /* @__PURE__ */ o(It, { children: _.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(Je, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          je(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, _.id)) }),
      /* @__PURE__ */ o(kn, { children: R.getRowModel().rows.map((_, E) => {
        const $ = wt();
        return /* @__PURE__ */ o(
          It,
          {
            ...
            className: m(C(_, E)),
            onClick: (z) => k(_, z),
            children: _.getVisibleCells().map((z) => {
                  ...
                  ae,
                  {
                    ...
                    children: z.getIsGrouped() ? /* @__PURE__ */ p(
                      L,
                      {
                        ...
                        type: "button",
                        children: [
                          _.getIsExpanded() && /* @__PURE__ */ o(se, {}),
                          !_.getIsExpanded() && ($ === "ltr" ? /* @__PURE__ */ o(be, {}) : /* @__PURE__ */ o(jn, {})),
                          " ",
...
function Zc({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], c = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], d = r["%webView_book_selector_no_book_found%"], f = r["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: y } = {
  ...
  }, [N, R] = A(!1), [v, x] = A(""), T = rt(void 0), V = rt(!1);
  ...
  const k = B(() => q.allBookIds.filter(
    ...
    (O, Z = !1) => {
      ...
      const M = k.findIndex((P) => P === T.current), Q = k.findIndex((P) => P === O);
      if (M === -1 || Q === -1) return;
      const [yt, Bt] = [
        Math.min(M, Q),
        Math.max(M, Q)
    ...
    S(O, V.current), V.current = !1;
  }, E = (O, Z) => {
    O.preventDefault(), S(Z, O.shiftKey);
  }, $ = j(
    (O) => {
...
function Bp({
  ...
  const w = Zt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Zt(i, "%webView_scope_selector_current_book%"), u = Zt(i, "%webView_scope_selector_choose_books%"), g = Zt(i, "%webView_scope_selector_scope%"), y = Zt(i, "%webView_scope_selector_select_books%"), N = [
  ...
  ], R = t ? N.filter((v) => t.includes(v.value)) : N;
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        gr,
        {
          ...
          children: R.map(({ value: v, label: x, id: T }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(dn, { className: "tw-me-2", value: v, id: T }),
            /* @__PURE__ */ o(lt, { htmlFor: T, children: x })
          ] }, T))
        }
      )
    ] }),
    e === "selectedBooks" && /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ o(lt, { children: y }),
      /* @__PURE__ */ o(
        Zc,
        {
          availableBookInfo: r,
...
const Qc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Trigger,
  {
    ref: n,
    ...t,
...
function Kp({
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(Fa, { children: [
      /* @__PURE__ */ o(Ga, { children: e.map((l) => /* @__PURE__ */ o(Qc, { value: l.value, children: l.value }, l.key)) }),
...
const nd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = _t();
  return /* @__PURE__ */ p(
    et.CheckboxItem,
    {
...
nd.displayName = et.CheckboxItem.displayName;
const rd = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = _t();
  return /* @__PURE__ */ p(
    et.RadioItem,
    {
...
rd.displayName = et.RadioItem.displayName;
...
od.displayName = et.Label.displayName;
  ...
  if (Ji(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Le(i, [h, u]);
        break;
      case "alt+n":
        (N = l.current) == null || N.focus(), Le(l, [h, u]);
        break;
      case "alt+h":
        (R = c.current) == null || R.focus(), Le(c, [h, u]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ o(Xa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, f]) => typeof d == "boolean" || typeof f == "boolean" ? 0 : d.order - f.order).map(([d, f]) => /* @__PURE__ */ p(td, { children: [
...
function qp({
  ...
  const w = sd(
    ...
    var R, v, x, T, V, k;
    const N = y !== g ? ((v = (R = e[g]) == null ? void 0 : R.uiNames) == null ? void 0 : v[y]) ?? ((T = (x = e[g]) == null ? void 0 : x.uiNames) == null ? void 0 : T.en) : void 0;
    return N ? `${(V = e[g]) == null ? void 0 : V.autonym} (${N})` : (k = e[g]) == null ? void 0 : k.autonym;
  };
...
function id({ item: e, createLabel: t, createComplexLabel: n }) {
...
const ld = We(({ className: e, ...t }, n) => /* @__PURE__ */ o(Hs, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
ld.displayName = "Spinner";
function Zp({
  id: e,
  isDisabled: t = !1,
  hasError: n = !1,
...
), cd = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
dd.displayName = "AlertTitle";
const pd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
pd.displayName = "AlertDescription";
const Qp = nt.Root, tu = nt.Trigger, eu = nt.Group, nu = nt.Portal, ru = nt.Sub, ou = nt.RadioGroup, ud = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ p(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
ud.displayName = nt.SubTrigger.displayName;
...
md.displayName = nt.SubContent.displayName;
const hd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(nt.Portal, { children: /* @__PURE__ */ o(
  nt.Content,
  {
    ref: n,
    className: m(
...
hd.displayName = nt.Content.displayName;
const fd = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Item,
  {
    ref: r,
    className: m(
...
fd.displayName = nt.Item.displayName;
const gd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ p(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
gd.displayName = nt.CheckboxItem.displayName;
const bd = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ p(
  nt.RadioItem,
  {
    ref: r,
    className: m(
...
bd.displayName = nt.RadioItem.displayName;
...
vd.displayName = nt.Label.displayName;
...
xd.displayName = nt.Separator.displayName;
...
yd.displayName = "ContextMenuShortcut";
...
const au = kt.Trigger, kd = kt.Portal, su = kt.Close, ts = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  kt.Overlay,
  {
    ref: n,
...
const _d = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Sd.displayName = kt.Title.displayName;
...
Td.displayName = kt.Description.displayName;
const Rd = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  Yn.Root,
  {
    ref: r,
    className: m(
...
Rd.displayName = Yn.Root.displayName;
function iu({
  className: e,
  ...t
}) {
...
const Dd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ p(
    Be.Root,
    {
...
Od.displayName = qn.Root.displayName;
const du = gt.Root, Id = b.forwardRef(({ className: e, ...t }, n) => {
  const r = wt();
  return /* @__PURE__ */ o(
    gt.List,
    {
...
Id.displayName = gt.List.displayName;
const Md = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Trigger,
  {
    ref: n,
...
Md.displayName = gt.Trigger.displayName;
...
Ad.displayName = gt.Content.displayName;
...
export {
  ...
  gp as CommentList,
  Qp as ContextMenu,
  gd as ContextMenuCheckboxItem,
  hd as ContextMenuContent,
  eu as ContextMenuGroup,
  fd as ContextMenuItem,
  vd as ContextMenuLabel,
  nu as ContextMenuPortal,
  ou as ContextMenuRadioGroup,
  bd as ContextMenuRadioItem,
  xd as ContextMenuSeparator,
  yd as ContextMenuShortcut,
  ru as ContextMenuSub,
  md as ContextMenuSubContent,
  ud as ContextMenuSubTrigger,
  ...
  wu as ResizableHandle,
  lu as ResizablePanel,
