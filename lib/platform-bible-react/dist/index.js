...
function wa({
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    () => dl(V),
    [V]
  ), oe = D(() => !l || !R || !R.chapterNum || !xt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, xt]), je = L(
    (b) => w ? Io(b, w) : !1,
    [w]
  ), ur = L(
    (b) => (G) => w ? wl(b, G, w) : !1,
...
const Jl = /* @__PURE__ */ new Set(), Ho = re({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = Bl(() => (i.value || Jl).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const w = l !== void 0;
  ...
  return Ne(t.registerCommand(Zl, (s) => {
    ...
    if (_c(s.target)) {
      ...
      if (td(c)) return function(d, l = !1) {
        ...
        let h;
        l && $n(w) ? h = w : (h = Cc(), Ec(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function ed(t, e, r = oi) {
  return Ne(t.registerCommand($c, (o) => {
    ...
    const i = function(s) {
      ...
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = $l(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Ac();
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (we(f)) {
                ...
                if (Oa(v) && l >= 0 && w >= 0 && (E = l, k = l + w, f.setTextNodeRange(v, E, v, k)), E === k && p === "" || (f.insertRawText(p), v = x.getNode()), Oa(v)) {
                  E = g, k = g + h;
    ...
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (z) => {
              z.stopPropagation(), l(!0), p(zd(t.contents)), s == null || s(!0);
            },
            children: [
...
function Pd({
  ...
  const [s, c] = _("accept"), d = zo(), l = zo(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = D(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = D(
    () => Ur(t.acceptedText ?? ""),
...
function Ud(t) {
  const {
    ...
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Fd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function ew({
  ...
  const d = Ka(), l = en(n, "%undoButton_tooltip%"), w = en(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ua, { children: [
    /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
      /* @__PURE__ */ a(Yt, { asChild: !0, children: /* @__PURE__ */ a(
        U,
  ...
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: gw(t.marker, c, o, l) })
      }
    )
  ] });
}
...
function Lp({
  ...
  ), ht = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [gt, Mt] = _(!1), [zt, Ut] = _(void 0), [$t, Pe] = _(void 0), [S, It] = _(void 0), [xt, oe] = _(void 0), [je, ur] = _([]), pr = l === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    qw,
    {
      availableBookInfo: o,
...
function ja({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Za, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Gt, { children: Ei(e.groups, e.items, d, t) }) }),
...
function ah({
  ...
  const n = r || "en", i = D(
    ...
    [o, n]
  ), s = Math.min(Math.max(t, 1), e), c = Array.from({ length: e }, (d, l) => l + 1);
