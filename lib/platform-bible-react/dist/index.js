...
import b, { forwardRef as tn, useRef as rt, useMemo as z, useState as I, useCallback as j, useLayoutEffect as Lt, createContext as vn, useContext as pr, useEffect as Q, Component as ds, createElement as $r, Suspense as cs, createRef as ps, Fragment as po } from "react";
import { Command as ft } from "cmdk";
import { X as en, Search as uo, Check as Ot, Clock as Pr, ChevronsLeft as Lr, ChevronsRight as Br, ChevronLeft as Xn, ChevronRight as Ee, ArrowLeft as us, ArrowRight as ms, Circle as xn, ChevronDown as pe, BoldIcon as hs, ItalicIcon as fs, UnderlineIcon as gs, StrikethroughIcon as bs, Pencil as vs, Trash2 as xs, ArrowUp as mo, MoreHorizontal as ho, ChevronUp as Un, AtSign as ys, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as fo, Filter as Ss, User as Ts, Link as Rs, CircleHelp as Ds, ChevronsUpDown as go, Star as Os, FunctionSquare as bo, SquareSigma as vo, SquareX as Is, AlertCircle as Kn, CircleCheckIcon as Ms, CircleXIcon as As, CircleHelpIcon as Vs, ArrowUpIcon as $s, ArrowDownIcon as Ps, ArrowUpDownIcon as Ls, PanelLeft as Bs, PanelRight as zs, ScrollText as js, MenuIcon as Fs, Menu as Gs, EllipsisVertical as Hs, LoaderCircle as Xs, GripVertical as Us } from "lucide-react";
import { clsx as Ks } from "clsx";
import { extendTailwindMerge as Ys } from "tailwind-merge";
import * as _t from "@radix-ui/react-dialog";
import { includes as sn, Section as G, getChaptersForBook as qs, formatScrRef as _e, getSectionForBook as He, formatRelativeDate as Js, formatReplacementString as ie, sanitizeHtml as Ws, parseParatextHtml as zr, hasCustomParatextTags as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, getFormatCallerFunction as ni, deepEqual as xo, isString as On, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as Y } from "platform-bible-utils";
...
import { createEditor as No, $getRoot as Yt, $createParagraphNode as yn, $getSelection as Bt, HISTORY_MERGE_TAG as ur, ParagraphNode as ko, TextNode as _o, $isTokenOrSegmented as ri, $getCharacterOffsets as oi, $cloneWithPropertiesEphemeral as ai, $findMatchingParent as si, $isElementNode as le, CLEAR_EDITOR_COMMAND as Co, COMMAND_PRIORITY_EDITOR as Eo, $isRangeSelection as Je, shallowMergeConfig as ii, defineExtension as zt, safeCast as nn, RootNode as li, LineBreakNode as wi, TabNode as di, $isEditorState as ci, createCommand as pi, CLICK_COMMAND as ui, isDOMNode as mi, $getNodeFromDOMNode as hi, $isNodeSelection as fi, $createNodeSelection as gi, $setSelection as bi, COMMAND_PRIORITY_LOW as vi, DecoratorNode as xi, $create as yi, $getNodeByKey as Ni, INDENT_CONTENT_COMMAND as jr, COMMAND_PRIORITY_CRITICAL as mr, KEY_TAB_COMMAND as ki, $createRangeSelection as _i, $normalizeSelection__EXPERIMENTAL as Ci, OUTDENT_CONTENT_COMMAND as Ei, INSERT_TAB_COMMAND as Si, $isBlockElementNode as mn, $isDecoratorNode as Ti, $isParagraphNode as Ri, $isTextNode as hn, SELECTION_CHANGE_COMMAND as So, FORMAT_TEXT_COMMAND as Di, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as Fr, isDOMDocumentNode as Mi, ArtificialNode__DO_NOT_USE as To, $createLineBreakNode as Ro, $isRootOrShadowRoot as Ai, isBlockDomNode as Gr, isInlineDomNode as Hr, $insertNodes as Vi } from "lexical";
...
import { GENERATOR_NOTE_CALLER as qn, HIDDEN_NOTE_CALLER as Jn, getDefaultViewOptions as qi, isInsertEmbedOpOfType as Mn, Editorial as Ji } from "@eten-tech-foundation/platform-editor";
import * as Wn from "@radix-ui/react-checkbox";
...
on.displayName = ft.Input.displayName;
...
ge.displayName = ft.List.displayName;
...
qt.displayName = ft.Group.displayName;
...
zo.displayName = ft.Separator.displayName;
const Qt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  ft.Item,
  {
    ref: n,
...
F(ht, "defaultVersification", oe.English), F(ht, "verseRangeSeparator", "-"), F(ht, "verseSequenceIndicator", ","), F(ht, "verseRangeSeparators", [ht.verseRangeSeparator]), F(ht, "verseSequenceIndicators", [ht.verseSequenceIndicator]), F(ht, "chapterDigitShifter", 1e3), F(ht, "bookDigitShifter", ht.chapterDigitShifter * ht.chapterDigitShifter), F(ht, "bcvMaxValue", ht.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
F(ht, "ValidStatusType", Uo);
...
function mp({
  ...
  const w = dt(), [p, f] = I(!1), [m, u] = I(""), [g, x] = I(""), [y, R] = I("books"), [N, v] = I(void 0), [C, V] = I(!1), _ = rt(void 0), E = rt(void 0), D = rt(void 0), k = rt(void 0), S = rt({}), L = j(
    ...
    [y, ot]
  ), { otLong: bt, ntLong: kt, dcLong: A, extraLong: vt } = {
    ...
    (T) => {
      ...
      if ((y === "chapters" || y === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(T.key)) {
        const ct = y === "chapters" ? N : M == null ? void 0 : M.book;
        if (!ct) return;
        const mt = (() => {
          if (!m) return 1;
          const Be = m.match(/(\d+)$/);
        ...
        switch (T.key) {
          case "ArrowLeft":
            mt !== 0 && (At = mt > 1 ? mt - 1 : ne);
            break;
          case "ArrowRight":
            mt !== 0 && (At = mt < ne ? mt + 1 : 1);
            break;
          case "ArrowUp":
            At = mt === 0 ? ne : Math.max(1, mt - Vr);
            break;
          case "ArrowDown":
            At = mt === 0 ? 1 : Math.min(ne, mt + Vr);
            break;
          default:
            return;
        }
        At !== mt && (T.preventDefault(), T.stopPropagation(), u(tr(ct, a, At)), setTimeout(() => {
    ...
    const { isLetter: K, isDigit: lt } = Kr(T.key);
    (K || lt) && (T.preventDefault(), x((ct) => ct + T.key), E.current.focus(), V(!1));
  }, []);
  return Lt(() => {
    const T = setTimeout(() => {
      if (p && y === "books" && D.current && k.current) {
        const K = D.current, lt = k.current, ct = lt.offsetTop, mt = K.clientHeight, ne = lt.clientHeight, At = ct - mt / 2 + ne / 2;
        K.scrollTo({
          top: Math.max(0, At),
          behavior: "smooth"
        }), u(tr(e.book));
      ...
      fe,
      {
        ...
        children: [
          y === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: $.map(({ onClick: T, disabled: K, title: lt, icon: ct }) => /* @__PURE__ */ o(
              B,
              {
                variant: "ghost",
                size: "sm",
...
const fn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  qe.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ o(qe.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ o(xn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
...
function gp({
  ...
  const p = Vn(w, "%webView_bookSelector_currentBook%"), f = Vn(w, "%webView_bookSelector_choose%"), m = Vn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = I(
    "current book"
    /* CURRENT_BOOK */
  ), x = (y) => {
    g(y), e(y);
...
function ql(e) {
  ...
  na(this), U = e, this.f &= -2, 8 & this.f && _r(this), _n();
}
function ke(e, t) {
...
} }), ae.prototype = new ut(), ae.prototype.h = function() {
...
zt({ build: (e, t, n) => Cn(t), config: nn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
...
function oa() {
  const e = Yt(), t = Bt(), n = yn();
  e.clear(), e.append(n), t !== null && n.select(), Je(t) && (t.format = 0);
}
function aa(e, t = oa) {
  return e.registerCommand(Co, (n) => (e.update(t), !0), Eo);
}
zt({ build: (e, t, n) => Cn(t), config: nn({ $onClear: oa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
...
const rr = zt({ build: (e) => sa(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Cr = 0, or = 1, la = 2, Pn = 3, wn = 4, Ne = 5, Ln = 6, je = 7;
function Bn(e) {
  return e.id === Cr;
}
function wa(e) {
...
function Wl(e) {
  return function(t) {
    return t.id === or;
  }(e) || Z(305, String(e.id), String(or)), Object.assign(e, { id: la });
}
...
class Ql {
  ...
  init(t) {
    ...
    const r = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...r, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, d, w) {
      return Object.assign(l, { config: d, id: Pn, registerState: w });
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Ln && Z(310, String(n.id), String(Ln)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Pn;
    }(t) || Z(314, String(t.id), String(Pn)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
...
class Ke {
  ...
  static maybeFromEditor(t) {
    const n = t[to];
    return n && (n.PACKAGE_VERSION !== zn && Z(292, n.PACKAGE_VERSION, zn), n instanceof Ke || Z(293)), n;
  }
  static fromEditor(t) {
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Bn(s) || Z(300, i, a || "[unknown]"), Bn(l = s) || Z(304, String(l.id), String(Cr)), s = Object.assign(l, { id: or }), r.state = s;
    ...
    for (const r of this.extensionNameMap.values()) Bn(r.state) && n(r);
...
const rw = /* @__PURE__ */ new Set(), no = zt({ build(e, t, n) {
  const r = n.getDependency(rr).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = sa(() => {
  }, () => Wt(() => {
...
zt({ dependencies: [rr, no], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
...
function sw(e, t) {
  return Jt(e.registerCommand(ki, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Xl(i, (m) => mn(m) && m.canIndent() ? m : null).length > 0) return !0;
...
zt({ build: (e, t, n) => Cn(t), config: nn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
          ...
          if (d) {
            ...
            e.update(() => {
              ...
              if (Je(g)) {
                ...
                if (hn(y) && w >= 0 && p >= 0 && (R = w, N = w + p, g.setTextNodeRange(y, R, y, N)), R === N && f === "" || (g.insertRawText(f), y = x.getNode()), hn(y)) {
                  R = m, N = m + u;
...
zt({ build: (e, t, n) => Cn(t), config: nn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Wt(() => n.getOutput().disabled.value ? void 0 : pa(e)) });
function cw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
Sr.displayName = Nn.Root.displayName;
...
Ye.displayName = Nn.Item.displayName;
const ao = [
...
function Dw() {
  const { activeEditor: e } = ha(), [t, n] = I([]), r = j((a) => {
    if (Je(a) || Fi(a)) {
      const s = [];
      ao.forEach(({ format: i }) => {
...
function xa(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (m = p(m)), Gr(e) && (m = $w(e, m, u ? () => {
    const g = new To();
    return n.push(g), g;
  } : yn)), l == null ? m.length > 0 ? i = i.concat(m) : Gr(e) && function(g) {
...
function qw({
  ...
  const X = z(
    ...
    var vt, St;
    const A = Gt(u) ? sr(u) : void 0;
    if (k !== void 0) {
      await w({
        threadId: l,
        contents: A,
        assignedUser: k
      }) && (S(void 0), A && ((vt = O.current) == null || vt.call(O), g(cn)));
      return;
    }
    ...
    async (A) => {
      var ye;
      const vt = Gt(u) ? sr(u) : void 0, St = await w({
        ...A,
        contents: vt,
        assignedUser: A.assignedUser ?? k
      });
      return St && vt && ((ye = O.current) == null || ye.call(O), g(cn)), St && k !== void 0 && S(void 0), St;
    },
    [u, w, k]
  );
  return /* @__PURE__ */ o(
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            R && /* @__PURE__ */ o(
              B,
              {
                ...
                children: x ? /* @__PURE__ */ o(Un, {}) : /* @__PURE__ */ o(pe, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
          ...
          n && /* @__PURE__ */ c(at, { children: [
            ...
            (!V || Gt(u)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (A) => {
                  A.key === "Enter" && A.shiftKey && (A.preventDefault(), A.stopPropagation(), (Gt(u) || k !== void 0) && bt());
                },
                onKeyDown: (A) => {
                  ya(A), (A.key === "Enter" || A.key === " ") && A.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    ar,
                    ...
                    /* @__PURE__ */ c(be, { open: E, onOpenChange: D, children: [
                      ...
                      /* @__PURE__ */ o(
                        te,
                        {
                          ...
                          children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: m == null ? void 0 : m.map((A) => /* @__PURE__ */ o(
                            Qt,
                            {
                              onSelect: () => {
                                S(A !== a ? A : void 0), D(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ o("span", { children: un(A, t) })
                            },
                            A || "unassigned"
                          )) }) })
                        }
...
function ld({
  ...
  var _;
  const [p, f] = I([]), [m, u] = I([]), [g, x] = I({}), [y, R] = I({}), N = z(() => t ?? [], [t]), v = Mo({
    data: N,
    columns: e,
    getCoreRowModel: Vo(),
  ...
  return d ? V = Array.from({ length: 10 }).map((k, S) => `skeleton-row-${S}`).map((k) => /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(ce, { colSpan: C.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(ir, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((_ = v.getRowModel().rows) == null ? void 0 : _.length) > 0 ? V = v.getRowModel().rows.map((E) => /* @__PURE__ */ o(
    ...
    /* @__PURE__ */ c(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: v.getHeaderGroups().map((E) => /* @__PURE__ */ o(Vt, { children: E.headers.map((D) => /* @__PURE__ */ o(Qe, { children: D.isPlaceholder ? void 0 : Xe(D.column.columnDef.header, D.getContext()) }, D.id)) }, E.id)) }),
      /* @__PURE__ */ o(Tn, { children: V })
    ] }),
      ...
      /* @__PURE__ */ o(
        Kt,
        {
          ...
          children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
            ...
            /* @__PURE__ */ o("span", { className: "tw-w-10 tw-text-center", children: Jn })
          ] })
        }
      ),
      /* @__PURE__ */ o(
...
function Sp({
  ...
  Q(() => {
    ...
    if (C && Mn("note", C)) {
      ...
      let D = "custom";
      E === qn ? D = "generated" : E === Jn ? D = "hidden" : E && m(E), p(D), g(((_ = C.insert.note) == null ? void 0 : _.style) ?? "f"), C.insert.note && (C.insert.note.caller = ""), v = setTimeout(() => {
        var k;
  ...
  const y = j(() => {
    ...
    v && Mn("note", v) && (v.insert.note && (w === "custom" ? v.insert.note.caller = f : v.insert.note.caller = w === "generated" ? qn : Jn), t([v]));
  }, [w, f, t]), R = () => {
    var C;
        ...
        /* @__PURE__ */ o(
          bd,
          {
            ...
            handleNoteTypeChange: (v) => {
              ...
              C && Mn("note", C) && (C.insert.note && (C.insert.note.style = v), (E = l.current) == null || E.applyUpdate([{ delete: 1 }, C]));
            },
            localizedStrings: i
          }
        ),
...
function _d({
  ...
  return /* @__PURE__ */ c(En, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Sn, { stickyHeader: !0, children: /* @__PURE__ */ c(Vt, { children: [
      /* @__PURE__ */ o(Qe, { children: r }),
      /* @__PURE__ */ o(Qe, { children: a })
    ] }) }),
    /* @__PURE__ */ o(Tn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      Vt,
      {
        onClick: () => {
          t(i.reference);
...
Or.displayName = Wn.Root.displayName;
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Op = (e) => ({
  accessorKey: "item",
  ...
  return e.forEach((a) => {
    const s = r.find(
      (i) => xo(
        i.items,
        On(a.inventoryText) ? [a.inventoryText] : a.inventoryText
      )
    );
    if (s)
      ...
      const i = {
        items: On(a.inventoryText) ? [a.inventoryText] : a.inventoryText,
        count: 1,
        status: Ed(
          On(a.inventoryText) ? a.inventoryText : a.inventoryText[0],
          t,
          n
        ),
        occurrences: [
...
function Lp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), m = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), x = Tt(n, "%webView_inventory_scope_currentBook%"), y = Tt(n, "%webView_inventory_scope_chapter%"), R = Tt(n, "%webView_inventory_scope_verse%"), N = Tt(n, "%webView_inventory_filter_text%"), v = Tt(
    ...
    const $ = [];
    return J.forEach((ot) => {
      const yt = ot.items[0], bt = $.find(
        (kt) => kt.items[0] === yt
      );
      bt ? (bt.count += ot.count, bt.occurrences = bt.occurrences.concat(ot.occurrences)) : $.push({
        items: [yt],
        count: ot.count,
    ...
    for (let kt = 0; kt < $; kt++)
      ot.push(
        Cd(
          ((bt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : bt[kt]) || "Additional Item",
          kt + 1
        )
      );
    return [...ot, ...d];
...
const Ld = Zt(
  ...
  ({
    ...
    const d = e ? Me : "button", { state: w } = Dn(), p = /* @__PURE__ */ o(
      d,
      {
        ref: l,
  ...
  return [
    {
      ...
      sortingFn: (r, a) => Yn(r.original.start, a.original.start),
      enableGrouping: !0
    },
    {
...
function zp({
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ c(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: R.getHeaderGroups().map((k) => /* @__PURE__ */ o(Vt, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => (
      ...
      /* @__PURE__ */ o(Tn, { children: R.getRowModel().rows.map((k, S) => {
        const L = dt();
        return /* @__PURE__ */ o(
          Vt,
          {
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ c(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ o(Ee, {}) : /* @__PURE__ */ o(Xn, {})),
                          " ",
      ...
      /* @__PURE__ */ o(
        yr,
        {
          ...
          children: R.map(({ value: N, label: v, id: C }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(fn, { className: "tw-me-2", value: N, id: C }),
...
Xa.displayName = gt.List.displayName;
...
Ua.displayName = gt.List.displayName;
...
Ka.displayName = gt.Content.displayName;
function qp({
  tabList: e,
  searchValue: t,
  onSearch: n,
...
const mu = gt.Root, Ac = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    gt.List,
    {
...
Ac.displayName = gt.List.displayName;
...
Vc.displayName = gt.Trigger.displayName;
...
$c.displayName = gt.Content.displayName;
