...
var Kn = (t, e, r) => e in t ? Un(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var bt = (t, e, r) => Kn(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Slot as _e, Dialog as Ft, Popover as Ye, Label as Hn, RadioGroup as Gr, Tooltip as Re, ToggleGroup as ko, Separator as Wn, Avatar as wa, DropdownMenu as gt, Select as yt, Checkbox as Aa, Tabs as At, Menubar as Kt, ContextMenu as ht, Progress as Pa, Slider as nr, Switch as La } from "radix-ui";
import { cva as te } from "class-variance-authority";
import { IconX as Yn, IconCheck as Ne, IconSearch as Xn, IconChevronRight as ua, IconChevronDown as Jn, IconChevronUp as Zn, IconSelector as Qn, IconLayoutSidebar as ti, IconLayoutSidebarRight as ei, IconLoader as ri, IconAlertOctagon as ai, IconAlertTriangle as oi, IconInfoCircle as ni, IconCircleCheck as ii } from "@tabler/icons-react";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as ir, Section as Y, getChaptersForBook as si, formatScrRef as xe, getSectionForBook as Ge, formatRelativeDate as li, formatReplacementString as be, sanitizeHtml as ci, NumberFormat as di, formatBytes as wi, getCurrentLocale as ui, usfmMarkers as ur, getFormatCallerFunction as pi, deepEqual as gi, isString as Va, compareScrRefs as Hr, scrRefToBBBCCCVVV as Mr, getLocalizeKeyForScrollGroupId as Z } from "platform-bible-utils";
import { Check as Ve, Clock as ja, ChevronsLeft as Fa, ChevronsRight as Ba, ChevronLeft as Wr, ChevronRight as Yr, ArrowLeft as hi, ArrowRight as fi, ChevronDown as Cr, BoldIcon as mi, ItalicIcon as vi, X as tr, AtSign as _o, Pencil as bi, Trash2 as xi, ArrowUp as No, MoreHorizontal as yi, MailOpen as ki, Mail as _i, ChevronUp as Ni, FilterIcon as Ci, ArrowLeftIcon as Ei, ChevronLeftIcon as zi, ChevronRightIcon as Ti, ArrowRightIcon as Si, Copy as Co, Filter as Ri, User as Di, Link as Mi, CircleHelp as $i, ChevronsUpDown as Eo, Star as Oi, Undo as Ii, Redo as Ai, SquareX as zo, FunctionSquare as To, SquareSigma as So, Ban as Pi, AlertCircle as Xr, CircleCheckIcon as Li, CircleXIcon as Vi, CircleHelpIcon as ji, ArrowUpIcon as Fi, ArrowDownIcon as Bi, ScrollText as Ui, Search as Ki, MenuIcon as qi, Menu as Gi, EllipsisVertical as Hi, MoreVertical as Ua, LoaderCircle as Wi } from "lucide-react";
import et, { forwardRef as er, useRef as G, useMemo as F, useState as S, useCallback as B, useLayoutEffect as Rt, createContext as Er, useContext as pa, useEffect as H, Component as Yi, createElement as Ka, Suspense as Xi, Fragment as Ro } from "react";
import { createEditor as Do, $getRoot as Jt, $createParagraphNode as je, $getSelection as Et, HISTORY_MERGE_TAG as ga, ParagraphNode as Mo, TextNode as $o, $isTokenOrSegmented as Ji, $getCharacterOffsets as Zi, $cloneWithPropertiesEphemeral as Qi, $getPreviousSelection as ts, $isRangeSelection as Bt, $caretFromPoint as es, $getSiblingCaret as Oo, $getChildCaret as rs, $getAdjacentChildCaret as as, $isChildCaret as os, $normalizeCaret as ns, $setSelectionFromCaretRange as is, $getCollapsedCaretRange as ss, $getCaretInDirection as qa, $splitAtPointCaretNext as ls, $isTextPointCaret as cs, $findMatchingParent as Io, $isElementNode as Yt, mergeRegister as Zt, getDOMTextNode as ds, isHTMLElement as Ao, CLEAR_EDITOR_COMMAND as Po, COMMAND_PRIORITY_EDITOR as ha, shallowMergeConfig as ws, defineExtension as Dt, safeCast as Ce, createState as us, FORMAT_TEXT_COMMAND as Lo, $isNodeSelection as Vo, COMMAND_PRIORITY_LOW as jo, RootNode as ps, LineBreakNode as gs, TabNode as hs, $isEditorState as fs, createCommand as ms, CLICK_COMMAND as vs, isDOMNode as bs, $getNodeFromDOMNode as xs, $createNodeSelection as ys, $setSelection as ks, $getEditor as _s, DecoratorNode as Jr, $getState as Ns, toggleTextFormatType as Ga, TEXT_TYPE_TO_FORMAT as Cs, $setState as Es, addClassNamesToElement as Fo, $create as zs, $getNodeByKey as Ts, removeClassNamesFromElement as Ss, KEY_TAB_COMMAND as Rs, $isBlockElementNode as fr, $createRangeSelection as Ds, $normalizeSelection__EXPERIMENTAL as Ms, OUTDENT_CONTENT_COMMAND as $s, INDENT_CONTENT_COMMAND as Ha, INSERT_TAB_COMMAND as Os, COMMAND_PRIORITY_CRITICAL as fa, $isDecoratorNode as Is, $isParagraphNode as As, $isTextNode as mr, SELECTION_CHANGE_COMMAND as Bo, getRegisteredNode as Ps, isDocumentFragment as Wa, isDOMDocumentNode as Ls, ArtificialNode__DO_NOT_USE as Uo, $createLineBreakNode as Ko, $isRootOrShadowRoot as Vs, isBlockDomNode as Ya, isInlineDomNode as Xa, $insertNodes as js } from "lexical";
import { HeadingNode as Fs, QuoteNode as Bs, registerRichText as Us } from "@lexical/rich-text";
import { flushSync as Ks, createPortal as qs } from "react-dom";
import { $isTableSelection as Gs } from "@lexical/table";
import { createHeadlessEditor as qo } from "@lexical/headless";
import { useReactTable as Go, getFilteredRowModel as Hs, getSortedRowModel as Ho, getPaginationRowModel as Ws, getCoreRowModel as Wo, flexRender as He, getGroupedRowModel as Ys, getExpandedRowModel as Xs } from "@tanstack/react-table";
import Js from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Zr, HIDDEN_NOTE_CALLER as Qr, getDefaultViewOptions as Zs, isInsertEmbedOpOfType as sr, Editorial as Qs } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as tl } from "react-hotkeys-hook";
import { Drawer as ue } from "vaul";
import * as ma from "react-resizable-panels";
import { useTheme as el } from "next-themes";
import { Toaster as rl } from "sonner";
import { toast as hg } from "sonner";
function ta(t) {
  const e = [];
  let r = "", o = 0;
...
function al(t) {
  ...
  const e = ta(t), r = e.findIndex((i) => i.startsWith("-tw-"));
  if (r !== -1) {
    const i = e[r].slice(4);
...
function ol(t, e) {
  ...
  const r = ta(t);
  if (r[0] !== "tw") return t;
  const o = r.slice(1, -1), n = r[r.length - 1], i = ta(e), s = i.some((c) => c.startsWith("-tw-")), l = i.some((c) => c.startsWith("!tw-"));
  if (s && n.startsWith("-")) {
    const c = n.slice(1);
    return [...o, `-tw-${c}`].join(":");
  }
...
function f(...t) {
  ...
  }), Gn(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const d = o.get(c);
    return d ? ol(c, d) : c;
  }).join(" ");
}
const Fe = 250, Yo = 300, nl = 400, il = 450, sl = 500, Xo = te(
...
function j({
  ...
  return /* @__PURE__ */ a(
    i,
    {
      ...
      "data-variant": e,
      "data-size": r,
      className: f(Xo({ variant: e, size: r, className: t })),
      ...n
    }
  );
}
...
function cl({ ...t }) {
  return /* @__PURE__ */ a(Ft.Root, { "data-slot": "dialog", ...t });
}
function iu({ ...t }) {
  return /* @__PURE__ */ a(Ft.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function dl({ ...t }) {
  return /* @__PURE__ */ a(Ft.Portal, { "data-slot": "dialog-portal", ...t });
}
function su({ ...t }) {
  return /* @__PURE__ */ a(Ft.Close, { "data-slot": "dialog-close", ...t });
}
function wl({
  className: t,
...
function ul({
  ...
  const s = lt();
  return /* @__PURE__ */ u(dl, { children: [
    /* @__PURE__ */ a(wl, { className: o }),
    /* @__PURE__ */ u(
      Ft.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(Ft.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(j, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Yn, {}),
...
function lu({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(Ft.Close, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function ar({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(hl, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        ke.Input,
        {
      ...
      /* @__PURE__ */ a(ml, { children: /* @__PURE__ */ a(Xn, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function ee({
  ...
  return /* @__PURE__ */ u(
    ke.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ a(Ne, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
const Qo = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), ye = Object.fromEntries(
  Qo.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function ba(t, e, r) {
...
function ea(t, e, r) {
  return `${t} ${ye[t]}${e ? ` ${va(t, e)} ${De(t, e)}` : ""}${r ? ` ${r}` : ""}`;
}
function yl({
  recentSearches: t,
  ...
  return /* @__PURE__ */ u(re, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ a(ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(pe, { children: /* @__PURE__ */ a(ge, { children: /* @__PURE__ */ a(Qt, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      ee,
      {
        onSelect: () => h(p),
...
function gu(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (l) => !r(l, n)
    ), s = [n, ...i.slice(0, o - 1)];
  ...
  const o = kl.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && c) {
          const p = ((m) => Object.keys(ye).find(
            (b) => ye[b].toLowerCase() === m.toLowerCase()
          ))(l);
...
function Nl(t, e, r, o) {
  const n = B(() => {
    if (t.chapterNum > 1)
      ...
      if (c > 0) {
        const d = e[c - 1], w = Math.max(jt(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function Za({
  ...
  if (t)
    return /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: jt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
      ee,
      {
        value: `${t} ${ye[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function hu({
  ...
  const d = lt(), [w, g] = S(!1), [h, p] = S(""), [m, b] = S(""), [v, x] = S("books"), [y, _] = S(void 0), [k, A] = S(!1), V = G(void 0), $ = G(void 0), E = G(void 0), N = G(void 0), T = G({}), L = B(
    (R) => {
      e(R), l && l(R);
    },
    [e, l]
    ...
    (R) => {
      if (R.ctrlKey) return;
      const { isLetter: C, isDigit: P } = Ja(R.key);
      if (v === "chapters") {
        if (R.key === "Backspace") {
          R.preventDefault(), R.stopPropagation(), ct();
          return;
        }
        if (C || P) {
      ...
      if ((v === "chapters" || v === "books" && D) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(R.key)) {
        ...
        Q !== q && (R.preventDefault(), R.stopPropagation(), p(ea(K, n, Q)), setTimeout(() => {
  ...
  }, [v, y, D, t.book, t.chapterNum]), /* @__PURE__ */ u(re, { open: w, onOpenChange: U, children: [
    /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ a(
      j,
      {
        ...
        children: /* @__PURE__ */ a("span", { className: "tw:truncate", children: Ht })
      }
    ) }),
    /* @__PURE__ */ a(ae, { id: c, forceMount: !0, className: "tw:w-[280px] tw:p-0", align: "center", children: /* @__PURE__ */ u(
      pe,
      {
        ref: V,
        onKeyDown: Wt,
          ...
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a(
              j,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a(hi, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(fi, { className: "tw:h-4 tw:w-4" })
              }
            ),
            y && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: De(y, n) })
          ] }),
          !k && /* @__PURE__ */ u(ge, { ref: E, children: [
            v === "books" && /* @__PURE__ */ u(nt, { children: [
              !D && Object.entries(W).map(([R, C]) => {
                if (C.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ a(Qt, { heading: Gt(R), children: C.map((P) => /* @__PURE__ */ a(
                      tn,
                      {
                        bookId: P,
                        onSelect: (K) => zt(K),
              ...
              D && /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ a(
                ee,
                {
                  value: `${D.book} ${ye[D.book]} ${D.chapterNum || ""}:${D.verseNum || ""})}`,
                  onSelect: X,
                  ...
                  children: xe(
                    ...
                    n ? va(D.book, n) : void 0
                  )
                },
                "top-match"
              ) }),
              D && jt(D.book) > 1 && /* @__PURE__ */ u(nt, { children: [
...
function aa({
  ...
  const [_, k] = S(!1), A = d ?? c, V = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], $ = (E, N) => {
    const T = c(E), L = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, I = `${N ?? ""}${T}${L ?? ""}`;
    return /* @__PURE__ */ u(
      ee,
      {
        value: T,
  ...
  return /* @__PURE__ */ u(re, { open: _, onOpenChange: k, ...y, children: [
    ...
    /* @__PURE__ */ a(
      ae,
      {
        ...
        style: i,
        children: /* @__PURE__ */ u(pe, { children: [
          /* @__PURE__ */ a(ar, { placeholder: h, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(zr, { children: p }),
          /* @__PURE__ */ a(ge, { children: V(e) ? e.map((E) => /* @__PURE__ */ a(Qt, { heading: E.groupHeading, children: E.options.map((N) => $(N, E.groupHeading)) }, E.groupHeading)) : e.map((E) => $(E)) })
        ] })
      }
    )
  ] });
...
var oa = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(oa || {});
((t) => {
...
function vu({
  ...
  const w = Or(d, "%webView_bookSelector_currentBook%"), g = Or(d, "%webView_bookSelector_choose%"), h = Or(d, "%webView_bookSelector_chooseBooks%"), [p, m] = S(
    "current book"
    /* CurrentBook */
  ), b = (v) => {
    m(v), t(v);
...
const an = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Tl = an ? Rt : H, lr = { tag: ga };
function Sl({ initialConfig: t, children: e }) {
  const r = F(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: c } = t, d = zl(null, o), w = Do({ editable: t.editable, html: c, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
        if (h === void 0) g.update(() => {
          ...
          if (p.isEmpty()) {
            const m = je();
            p.append(m);
            const b = an ? document.activeElement : null;
            (Et() !== null || b !== null && b === g.getRootElement()) && m.select();
          }
        }, lr);
  ...
  }, []), a(rn.Provider, { value: r, children: e });
}
const Rl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : H;
function Dl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = qt();
  return Rl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(ga) || l.isEmpty() || r(n, o, c);
    });
  }, [o, t, e, r]), null;
}
const xa = {
...
function Nt({
  ...
  return /* @__PURE__ */ a(
    Re.Trigger,
    {
      ...
      className: e ? f(Xo({ variant: e }), t) : t,
      ...r
    }
  );
}
...
class $l extends Yi {
  constructor(e) {
    super(e), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = Ir;
  }
...
function Il({ children: t, onError: e }) {
  return a($l, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : H;
function Pl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ll() {
  return function(t) {
    const [e] = qt(), r = F(() => t(e), [e, t]), [o, n] = S(() => r.initialValueFn()), i = G(o);
    return Al(() => {
...
function jl(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !Ji(e) && o !== null) {
    ...
    if (d || w) {
      const [g, h] = Zi(t), p = l.is(c), m = e.is(s ? c : l), b = e.is(s ? l : c);
      let v, x = 0;
...
const on = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fl = on && "documentMode" in document ? document.documentMode : null;
!(!on || !("InputEvent" in window) || Fl) && "getTargetRanges" in new window.InputEvent("input");
function Vt(t) {
  return `${t}px`;
}
...
function Ul(t, e, r) {
  ...
  function c() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = Vl(t, e);
    var m, b;
  ...
  const w = t.registerRootListener(function g() {
    ...
    d(), o = h, n = p, i = new MutationObserver((m) => {
      ...
      if (b !== o || v !== n) return g();
      for (const x of m) if (!l.contains(x.target)) return c();
    }), i.observe(p, Bl), c();
  });
  return () => {
    w(), d();
...
function Kl(t) {
  for (const e of t) {
    const r = e.style;
    r.background !== "Highlight" && (r.background = "Highlight"), r.color !== "HighlightText" && (r.color = "HighlightText"), r.marginTop !== Vt(-1.5) && (r.marginTop = Vt(-1.5)), r.paddingTop !== Vt(4) && (r.paddingTop = Vt(4)), r.paddingBottom !== Vt(0) && (r.paddingBottom = Vt(0));
  }
}
function ql(t, e = Kl) {
  ...
  function d(w) {
    w.read(() => {
      const g = Et();
      if (!Bt(g)) return r = null, n = null, i = null, l = null, c(), void (c = () => {
      });
      ...
      if ((V || $) && k !== null && A !== null) {
        const E = function(N, T, L, I, M, O, W) {
          ...
          return D.setStart(...Qa(T, L, I)), D.setEnd(...Qa(M, O, W)), D;
        }(t, h, m, k, p, x, A);
        c(), c = Ul(t, E, e);
      }
  ...
  return d(t.getEditorState()), Zt(t.registerUpdateListener(({ editorState: w }) => d(w)), () => {
    c();
  });
}
function Gl(t, e) {
...
function Hl(t) {
  const e = Io(t, (r) => Yt(r) && !r.isInline());
  return Yt(e) || vr(4, t.__key), e;
}
function Wl(t) {
  const e = Et() || ts();
  let r;
  if (Bt(e)) r = es(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (r = Oo(l, "next"));
    }
    r = r || rs(Jt(), "previous").getFlipped().insert(je());
  }
  const o = Yl(t, r), n = as(o), i = os(n) ? ns(n) : o;
  return is(ss(i)), t.getLatest();
}
function Yl(t, e, r) {
  let o = qa(e, "next");
  for (let n = o; n; n = ls(n, r)) o = n;
  return cs(o) && vr(283), o.insert(t.isInline() ? je().append(t) : t), qa(Oo(t.getLatest(), "next"), e.direction);
}
function Xl(t) {
  const e = Et();
  if (!Bt(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const l = Io(i, (d) => Yt(d) && !d.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
function Tr() {
  ...
  for (!function() {
    ...
    for (We = void 0, xr++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && nn(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
let br, Xt = 0, xr = 0, Ql = 0, na = 0, pr = 0;
function eo(t) {
  if (J === void 0) return;
  let e = t.n;
...
function ec(t) {
  ...
  sn(this), J = t, this.f &= -2, 8 & this.f && ka(this), Tr();
}
function Se(t, e) {
...
xt.prototype.brand = Jl, xt.prototype.h = function() {
  return !0;
  ...
  if (this.t !== void 0) {
    const e = t.e, r = t.x;
    e !== void 0 && (e.x = r, t.e = void 0), r !== void 0 && (r.e = e, t.x = void 0), t === this.t && (this.t = r, r === void 0 && to(() => {
      var o;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Xt !== 0 && xr === 0 && e.l !== na && (e.l = na, br = { S: e, v: e.v, i: e.i, o: br });
    })(this), this.v = t, this.i++, pr++, Xt++;
    try {
  ...
  if (this.g = pr, this.f |= 1, this.i > 0 && !nn(this)) return this.f &= -2, !0;
  const t = J;
  try {
    ro(this), J = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ln(this), ro(this), Xt++;
  const t = J;
...
Dt({ build: (t, e, r) => Be(e), config: Ce({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
  return Ut(() => o.disabled.value ? void 0 : t.registerRootListener((n) => {
    t.focus(() => {
...
function cn() {
  const t = Jt(), e = Et(), r = je();
  t.clear(), t.append(r), e !== null && r.select(), Bt(e) && (e.format = 0);
}
function dn(t, e = cn) {
  return t.registerCommand(Po, (r) => (t.update(e), !0), ha);
}
Dt({ build: (t, e, r) => Be(e), config: Ce({ $onClear: cn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Ut(() => dn(t, o.value));
} });
function rc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Ar = us("format", { parse: (t) => typeof t == "number" ? t : 0 });
class wn extends Jr {
  $config() {
    return this.config("decorator-text", { extends: Jr, stateConfigs: [{ flat: !0, stateConfig: Ar }] });
  }
  getFormat() {
    return Ns(this, Ar);
  }
  getFormatFlags(e, r) {
    return Ga(this.getFormat(), e, r);
  }
  hasFormat(e) {
    const r = Cs[e];
  ...
  toggleFormat(e) {
    const r = this.getFormat(), o = Ga(r, e, null);
...
Dt({ name: "@lexical/extension/DecoratorText", nodes: () => [wn], register: (t, e, r) => t.registerCommand(Lo, (o) => {
  const n = Et();
  if (Vo(n) || Bt(n)) for (const i of n.getNodes()) ac(i) && i.toggleFormat(o);
  return !1;
}, jo) });
function un(t, e) {
  let r;
...
const ia = Dt({ build: (t) => un(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function pn(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = pn(r[n], o[n]);
    return t;
  }
  return e;
}
const _a = 0, sa = 1, gn = 2, Pr = 3, cr = 4, Te = 5, Lr = 6, Ke = 7;
function Vr(t) {
  return t.id === _a;
}
function hn(t) {
...
function oc(t) {
  return function(e) {
    return e.id === sa;
  }(t) || tt(305, String(t.id), String(sa)), Object.assign(t, { id: gn });
}
...
class ic {
  constructor(e, r) {
    ...
    bt(this, "state");
    bt(this, "_signal");
    this.builder = e, this.extension = r, this.configs = /* @__PURE__ */ new Set(), this.state = { id: _a };
  }
  mergeConfigs() {
    let e = this.extension.config || {};
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : ws;
    for (const o of this.configs) e = r(e, o);
    return e;
  }
  init(e) {
    const r = this.state;
    hn(r) || tt(306, String(r.id));
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(l, c, d) {
      return Object.assign(l, { config: c, id: Pr, registerState: d });
    }(r, this.mergeConfigs(), o);
    let s;
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(l, c, d) {
      return Object.assign(l, { id: cr, initResult: c, registerState: d });
    }(i, s, n);
  }
  build(e) {
    const r = this.state;
    let o;
    r.id !== cr && tt(307, String(r.id), String(Te)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Lr && tt(310, String(r.id), String(Lr)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= cr;
    }(e) || tt(313, String(e.id), String(cr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Pr;
    }(e) || tt(314, String(e.id), String(Pr)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const lc = Dt({ config: Ce({ setOptions: ao, updateOptions: ao }), init: ({ $initialEditorState: t = sc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (fs(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [ps, $o, gs, hs, Mo] }), oo = Symbol.for("@lexical/extension/LexicalBuilder");
function no() {
}
function cc(t) {
  throw t;
...
class Me {
  ...
  static fromExtensions(e) {
    const r = [dr(lc)];
    for (const o of e) r.push(dr(o));
    return new Me(r);
  }
  static maybeFromEditor(e) {
    const r = e[oo];
    return r && (r.PACKAGE_VERSION !== jr && tt(292, r.PACKAGE_VERSION, jr), r instanceof Me || tt(293)), r;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(Do({ ...o, ...r ? { onError: (i) => {
      r(i, n);
    } } : {} }), { [oo]: this });
  ...
  buildEditor() {
    ...
    return e = Zt(this.registerEditor(o), () => o.setRootElement(null)), o;
  }
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && tt(298, o.name), !n) {
      n = new ic(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var l;
      Vr(i) || tt(300, s, n || "[unknown]"), Vr(l = i) || tt(304, String(l.id), String(_a)), i = Object.assign(l, { id: sa }), o.state = i;
      const c = this.outgoingConfigEdges.get(s);
      if (c) for (const d of c.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = oc(i), o.state = i, e.push(o);
    };
    for (const o of this.extensionNameMap.values()) Vr(o.state) && r(o);
...
const dc = /* @__PURE__ */ new Set(), io = Dt({ build(t, e, r) {
  const o = r.getDependency(ia).output, n = Xe({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = un(() => {
  }, () => Ut(() => {
    const s = i.peek(), { watchedNodeKeys: l } = n.value;
    let c, d = !1;
    o.value.read(() => {
      if (Et()) for (const [w, g] of l.entries()) {
        if (g.size === 0) {
          l.delete(w);
          continue;
        }
        const h = Ts(w), p = h && h.isSelected() || !1;
        d = d || p !== (!!s && s.has(w)), p && (c = c || /* @__PURE__ */ new Set(), c.add(w));
      }
    }), !d && c && s && c.size === s.size || (i.value = c);
  }));
  return { watchNodeKey: function(s) {
    const l = tc(() => (i.value || dc).has(s)), { watchedNodeKeys: c } = n.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), n.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [ia], name: "@lexical/extension/NodeSelection" }), wc = ms("INSERT_HORIZONTAL_RULE_COMMAND");
class Oe extends Jr {
  static getType() {
...
Dt({ dependencies: [ia, io], name: "@lexical/extension/HorizontalRule", nodes: () => [Oe], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(io).output, n = Xe({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Zt(t.registerCommand(wc, (s) => {
    const l = Et();
    if (!Bt(l)) return !1;
    ...
    return !0;
  }, ha), t.registerCommand(vs, (s) => {
    if (bs(s.target)) {
      const l = xs(s.target);
      if (pc(l)) return function(c, d = !1) {
        const w = Et(), g = c.isSelected(), h = c.getKey();
        let p;
        d && Vo(w) ? p = w : (p = ys(), ks(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, jo), t.registerMutationListener(Oe, (s, l) => {
    Zl(() => {
      let c = !1;
      ...
      for (const [w, g] of s.entries()) if (g === "destroyed") d.delete(w), c = !0;
        ...
        h ? h.domNode.value = p : (c = !0, d.set(w, { domNode: Xe(p), selectedSignal: o(w) }));
      }
      c && (n.value = { nodeSelections: d });
    });
  }), Ut(() => {
    const s = [];
    for (const { domNode: l, selectedSignal: c } of n.value.nodeSelections.values()) s.push(Ut(() => {
      const d = l.value;
      d && (c.value ? Fo(d, i) : Ss(d, i));
    }));
    return Zt(...s);
  }));
} });
Dt({ build: (t, e) => Be({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ce({ $getParentEditor: function() {
  const t = _s();
  return Me.fromEditor(t), t;
}, inheritEditableFromParent: !1 }), init: (t, e, r) => {
  const o = e.$getParentEditor();
  t.parentEditor = o, t.theme = t.theme || o._config.theme;
}, name: "@lexical/extension/NestedEditor", register: (t, e, r) => Ut(() => {
...
Dt({ build: (t, e, r) => Be(e), config: Ce({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ut(() => {
...
function gc(t, e, r = fn) {
  return Zt(t.registerCommand(Rs, (o) => {
    const n = Et();
    if (!Bt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => fr(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), g = Hl(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Ds();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = Ms(p), p.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? $s : Ha : Os;
    return t.dispatchCommand(i, void 0);
  }, ha), t.registerCommand(Ha, () => {
    const o = typeof e == "number" ? e : e ? e.peek() : null, n = Et();
    if (!Bt(n)) return !1;
...
Dt({ build: (t, e, r) => Be(e), config: Ce({ $canIndent: fn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Ut(() => {
    if (!o.value) return gc(t, n, i);
  });
} });
const hc = Dt({ name: "@lexical/react/ReactProvider" });
function fc() {
...
function vc(t) {
  if (!mc(t, !1)) return !1;
  const e = Jt().getChildren(), r = e.length;
  if (r > 1) return !1;
  for (let o = 0; o < r; o++) {
    const n = e[o];
    if (Is(n)) return !1;
    if (Yt(n)) {
      if (!As(n) || n.__indent !== 0) return !1;
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Bt(m)) {
                ...
                if (mr(v) && d >= 0 && w >= 0 && (x = d, y = d + w, m.setTextNodeRange(v, x, v, y)), x === y && g === "" || (m.insertRawText(g), v = b.getNode()), mr(v)) {
                  x = h, y = h + p;
...
Dt({ build: (t, e, r) => Be(e), config: Ce({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ut(() => r.getOutput().disabled.value ? void 0 : vn(t)) });
function bc(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Ca = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : H;
function xc({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, i] = S(() => r.getDecorators());
    return Ca(() => r.registerDecoratorListener((s) => {
      Ks(() => {
        i(s);
      });
    }), [r]), H(() => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = a(o, { onError: (h) => r._onError(h), children: a(Xi, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(qs(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function yc({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(hc.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && bc(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(xc, { editor: t, ErrorBoundary: e });
}
function so(t) {
  return t.getEditorState().read(mn(t.isComposing()));
}
function kc({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = qt();
  return function(n) {
    Ca(() => Zt(Us(n), vn(n)), [n]);
  }(o), u(nt, { children: [t, a(_c, { content: e }), a(yc, { editor: o, ErrorBoundary: r })] });
}
function _c({ content: t }) {
  const [e] = qt(), r = function(n) {
    ...
    return Ca(() => {
      ...
      return l(), Zt(n.registerUpdateListener(() => {
        l();
...
const Cc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : H;
function Ec({ onClear: t }) {
  const [e] = qt();
  return Cc(() => dn(e, t), [e, t]), null;
}
const bn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : H;
...
function Rc(t, e) {
  ...
  return u(nt, { children: [a(Tc, { editor: n, ...o, ref: e }), r != null && a(Dc, { editor: n, content: r })] });
}
function Dc({ content: t, editor: e }) {
  const r = function(s) {
    const [l, c] = S(() => lo(s));
    return bn(() => {
      function d() {
      ...
      return d(), Zt(s.registerUpdateListener(() => {
        d();
...
function $c({
  ...
  return /* @__PURE__ */ a(xn.Provider, { value: s, children: i });
}
function yn() {
  const t = pa(xn);
  if (!t)
...
function Oc() {
  const [t, e] = S(void 0), r = B(() => {
    ...
    return /* @__PURE__ */ a(cl, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(ul, { children: [
      /* @__PURE__ */ a(pl, { children: /* @__PURE__ */ a(gl, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = B(
    (i, s, l = !1) => {
...
function Ic({
  ...
  const [e] = qt(), [r, o] = S(e), [n, i] = S("paragraph"), [s, l] = Oc(), c = () => {
  };
...
function Lc() {
  const { activeEditor: t } = yn(), [e, r] = S([]), o = B((n) => {
    if (Bt(n) || Gs(n)) {
      const i = [];
      co.forEach(({ format: s }) => {
  ...
  return Ac(o), /* @__PURE__ */ a(
    _n,
    {
      ...
      variant: "outline",
      size: "sm",
      children: co.map(({ format: n, icon: i, label: s }) => /* @__PURE__ */ a(
        gr,
        {
          value: n,
          "aria-label": s,
          onClick: () => {
            t.dispatchCommand(Lo, n);
          },
...
function Vc({ onClear: t }) {
  const [e] = qt();
  H(() => {
    t && t(() => {
      e.dispatchCommand(Po, void 0);
    });
  }, [e, t]);
}
function jc({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Ic, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Lc, {}) }) }),
      ...
      /* @__PURE__ */ a(
        kc,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Mc, { placeholder: t }) }),
          ErrorBoundary: Il
        }
      ),
      e && /* @__PURE__ */ a(Nc, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(Vc, { onClear: r }),
      /* @__PURE__ */ a(Ec, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ a(
          Sl,
          {
            ...
            children: /* @__PURE__ */ u(kt, { children: [
              /* @__PURE__ */ a(jc, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Dl,
                {
...
function Bc(t, e) {
  ...
  let o = [];
  const n = [];
  for (const i of r) if (!Cn.has(i.nodeName)) {
    const s = En(i, t, n, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Uo && s.insertAfter(Ko());
    for (const s of i) {
...
function Uc(t, e) {
  ...
  const r = document.createElement("div"), o = Jt().getChildren();
  for (let n = 0; n < o.length; n++)
    Nn(t, o[n], r, e);
  return r.innerHTML;
}
function Nn(t, e, r, o = null) {
  let n = o === null || e.isSelected(o);
  const i = Yt(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && mr(e) && (s = jl(o, e, "clone"));
  const l = Yt(s) ? s.getChildren() : [], c = Ps(t, s.getType());
  let d;
  ...
  for (let p = 0; p < l.length; p++) {
    const m = l[p], b = Nn(t, m, h, o);
    !n && Yt(e) && b && e.extractWithChild(m, o, "html") && (n = !0);
  }
  if (n && !i) {
    if ((Ao(w) || Wa(w)) && w.append(h), r.append(w), g) {
      const p = g.call(s, w);
      p && (Wa(w) ? w.replaceChildren(p) : w.replaceWith(p));
    }
  } else r.append(h);
  return n;
}
const Cn = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function En(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (Cn.has(t.nodeName)) return s;
  let l = null;
  ...
  let h = [];
  const p = (l == null || !Vs(l)) && (l != null && fr(l) || o);
  for (let m = 0; m < g.length; m++) h.push(...En(g[m], e, r, p, new Map(n), l));
  return w != null && (h = w(h)), Ya(t) && (h = Kc(t, h, p ? () => {
    const m = new Uo();
    return r.push(m), m;
  } : je)), l == null ? h.length > 0 ? s = s.concat(h) : Ya(t) && function(m) {
    return m.nextSibling == null || m.previousSibling == null ? !1 : Xa(m.nextSibling) && Xa(m.previousSibling);
  }(t) && (s = s.concat(Ko())) : Yt(l) && l.append(...h), s;
}
function Kc(t, e, r) {
...
function Tn(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : Tn(e.children)
  ) : !1;
}
function It(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? Tn(t.root.children) : !1;
}
function qc(t) {
  if (!t || t.trim() === "")
...
function bu({
  ...
  const [n, i] = S(Gc), [s, l] = S(void 0), [c, d] = S(!1), w = G(void 0), g = G(null);
  H(() => {
    let x = !0;
    const y = g.current;
    if (!y) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between", children: [
      ...
      /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
        /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
          /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(j, { onClick: r, className: "tw:h-6 tw:w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ a(tr, {}) }) }),
          /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: b }) })
        ] }) }),
        /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
          ...
          /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: m }) })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(re, { open: c, onOpenChange: d, children: [
      /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ u(
        j,
        {
          variant: "outline",
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ a(_o, { className: "tw:h-4 tw:w-4" }),
            /* @__PURE__ */ a("span", { children: Fr(s !== void 0 ? s : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        ae,
        {
          ...
          children: /* @__PURE__ */ a(pe, { children: /* @__PURE__ */ a(ge, { children: t.map((x) => /* @__PURE__ */ a(
            ee,
            {
              onSelect: () => {
                l(x === "" ? void 0 : x), d(!1);
              ...
              className: "tw:flex tw:items-center",
              children: /* @__PURE__ */ a("span", { children: Fr(x, o) })
            },
            x || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (x) => {
          x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), r()) : za(x) && (x.preventDefault(), x.stopPropagation(), It(n) && h());
        },
        onKeyDown: (x) => {
          Ea(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          yr,
          {
...
], Hc = ["input", "select", "textarea", "button"], Wc = ["button", "textbox"], Yc = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
}) => {
  const n = G(null), [i, s] = S(void 0), [l, c] = S(void 0), d = B(
    (p) => {
      s(p);
    ...
    if (p.isContentEditable || Hc.includes(m)) return !0;
    const b = p.getAttribute("role");
    if (b && Wc.includes(b)) return !0;
...
function ce({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ a(Ta.Provider, { value: o, children: /* @__PURE__ */ a(gt.Root, { "data-slot": "dropdown-menu", dir: r, ...e }) });
}
function ed({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ a(
          "span",
          {
            ...
            children: /* @__PURE__ */ a(gt.ItemIndicator, { children: /* @__PURE__ */ a(Ne, {}) })
          }
        ),
        e
      ]
...
function nd({
  ...
  return /* @__PURE__ */ u(
    gt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(ua, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function wo({
  ...
  const p = B(
    ...
    return be(r["%comment_dateAtTime%"], {
      date: A,
      time: V
    });
    ...
    if (o && l)
      return /* @__PURE__ */ u(nt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(qc(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Qc, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(td, { className: "tw:text-xs tw:font-medium", children: x }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), p()) : za(k) && (k.preventDefault(), k.stopPropagation(), It(w) && m());
              },
              onKeyDown: (k) => {
                Ea(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
        ...
        _ && /* @__PURE__ */ u(ce, { children: [
          /* @__PURE__ */ a(de, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(yi, {}) }) }),
          /* @__PURE__ */ a(we, { align: "end", children: _ })
        ] })
      ]
    }
  );
...
function sd({
  ...
  const [$, E] = S(uo), [N, T] = S(
    void 0
  ), L = o, [I, M] = S(!1), [O, W] = S(!1), [D, X] = S(!1), [zt, Mt] = S(!1), [St, ut] = S(!1), [ct, U] = S(k), [rt, at] = S(!1), it = G(void 0), [vt, Gt] = S(/* @__PURE__ */ new Map());
  H(() => {
    let z = !0;
    return (async () => {
  ...
  const Pt = F(() => e.filter((z) => !z.deleted), [e]);
  H(() => {
    let z = !0;
    if (!o || !_) {
      Gt(/* @__PURE__ */ new Map());
  ...
  const Ht = F(() => Pt[0], [Pt]), ze = G(null), ne = G(void 0), Wt = B(() => {
    var z;
    (z = ne.current) == null || z.call(ne), E(uo);
  }, []), Ue = B(() => {
    const z = !ct;
    U(z), at(!z), m == null || m(c, z);
  }, [ct, m, c]);
  H(() => {
    M(!1);
  }, [o]), H(() => {
  ...
  const R = F(
    ...
    const z = hr(i, r);
    return be(r["%comment_assigned_to%"], {
      assignedUser: z
    });
  }, [i, r]), P = F(() => Pt.slice(1), [Pt]), K = F(() => P.length ?? 0, [P.length]), q = F(() => K > 0, [K]), ot = F(() => I || K <= 2 ? P : P.slice(-2), [P, K, I]), Q = F(() => I || K <= 2 ? 0 : K - 2, [K, I]), ft = F(
    () => K === 1 ? R.singleReply : be(R.multipleReplies, { count: K }),
    [K, R]
  ), st = F(
    () => Q === 1 ? R.singleReply : be(R.multipleReplies, { count: Q }),
    [Q, R]
  );
  H(() => {
    !o && O && q && W(!1);
  ...
  const Tt = B(
    async (z) => {
      ...
      mt && await g({ threadId: c, contents: mt }) && Wt();
    },
    [
      Wt,
      $,
    ...
    async (z) => {
      ...
      return wt && mt && Wt(), wt && N !== void 0 && T(void 0), wt;
    },
    [Wt, $, g, N]
  );
  return /* @__PURE__ */ a(
    Jc,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ u(Zc, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              j,
              {
                ...
                children: ct ? /* @__PURE__ */ a(ki, {}) : /* @__PURE__ */ a(_i, {})
              }
            ),
          ...
          /* @__PURE__ */ a(
            wo,
            {
              ...
              handleDeleteComment: p,
              onEditingChange: W,
              canEditOrDelete: (!O && vt.get(Ht.id)) ?? !1,
          ...
          o && /* @__PURE__ */ u(nt, { children: [
            ...
            v !== !1 && (!O || It($)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (z) => {
                  za(z) && (z.preventDefault(), z.stopPropagation(), (It($) || N !== void 0) && Tt());
                },
                onKeyDown: (z) => {
                  Ea(z), (z.key === "Enter" || z.key === " ") && z.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    yr,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    N !== void 0 && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: be(
                    ...
                    /* @__PURE__ */ u(re, { open: D, onOpenChange: X, children: [
                      /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ a(
                        j,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !zt || !b || b.length === 0 || !b.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(pe, { children: /* @__PURE__ */ a(ge, { children: b == null ? void 0 : b.map((z) => /* @__PURE__ */ a(
                            ee,
                            {
                              onSelect: () => {
                                T(z !== i ? z : void 0), X(!1);
...
function Tu({
  ...
  const A = r.filter(
    ...
    [x, b]
  ), { listboxRef: N, activeId: T, handleKeyDown: L } = Yc({
    options: V,
    onOptionSelect: $
  }), I = B(
    (M) => {
...
function ld({ table: t }) {
  return /* @__PURE__ */ u(ce, { children: [
    /* @__PURE__ */ a(de, { asChild: !0, children: /* @__PURE__ */ u(j, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Ci, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(we, { align: "end", className: "tw:w-[150px]", children: [
...
function Pe({
  ...
  return /* @__PURE__ */ u(
    yt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(yt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Qn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Ot({
  ...
  return /* @__PURE__ */ u(
    yt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(yt.ItemIndicator, { children: /* @__PURE__ */ a(Ne, { className: "tw:pointer-events-none" }) }) }),
...
function Qe(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && pd(o)
  );
}
function Sa({
  className: t,
  ...
  const l = et.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), fd(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), hd(l, b, w.key);
...
function md({
  ...
  var V;
  const [w, g] = S([]), [h, p] = S([]), [m, b] = S({}), [v, x] = S({}), y = F(() => e ?? [], [e]), _ = Go({
    data: y,
    columns: t,
    getCoreRowModel: Wo(),
    ...r && { getPaginationRowModel: Ws() },
    onSortingChange: g,
    getSortedRowModel: Ho(),
    onColumnFiltersChange: p,
    getFilteredRowModel: Hs(),
  ...
  return c ? A = Array.from({ length: 10 }).map((N, T) => `skeleton-row-${T}`).map((N) => /* @__PURE__ */ a(se, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a($e, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ca, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? A = _.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    ...
    $.id
  )) : A = /* @__PURE__ */ a(se, { children: /* @__PURE__ */ a($e, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(ld, { table: _ }),
    /* @__PURE__ */ u(Sa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ra, { stickyHeader: i, children: _.getHeaderGroups().map(($) => /* @__PURE__ */ a(se, { children: $.headers.map((E) => /* @__PURE__ */ a(_r, { className: "tw:p-0", children: E.isPlaceholder ? void 0 : He(E.column.columnDef.header, E.getContext()) }, E.id)) }, $.id)) }),
      /* @__PURE__ */ a(Da, { children: A })
    ] }),
...
function $u({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(Js, { options: i, children: e })
    }
  );
}
...
function bd({
  ...
  const n = go(r, "%webView_error_dump_header%"), i = go(r, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Co, {}) })
        ] }),
...
function Iu({
  ...
  return /* @__PURE__ */ u(re, { onOpenChange: (w) => {
    w || l(!1);
  }, children: [
    /* @__PURE__ */ a(he, { asChild: !0, children: o }),
    /* @__PURE__ */ u(ae, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
...
var xd = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(xd || {});
function Au({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ce, { children: [
    /* @__PURE__ */ a(de, { asChild: !0, children: /* @__PURE__ */ u(j, { variant: "default", children: [
      /* @__PURE__ */ a(Ri, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(Cr, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(we, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Sr, { children: d.label }),
      /* @__PURE__ */ a(Sn, { children: d.itemType === 0 ? /* @__PURE__ */ a(nt, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        le,
        {
          checked: o[w][h],
        ...
        rd,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(ad, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(or, {})
    ] }, d.label)) })
...
function yd({ id: t, versionHistory: e }) {
...
function Lu({
  ...
  const s = F(() => wi(r), [r]), c = ((d) => {
    const w = new Intl.DisplayNames(ui(), { type: "language" });
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(yd, { versionHistory: n }),
...
function kd({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(re, { open: E, onOpenChange: w ?? y, children: [
    /* @__PURE__ */ a(he, { asChild: !0, children: /* @__PURE__ */ u(
      j,
      {
        variant: b,
        ...
        children: [
          ...
          /* @__PURE__ */ a(Eo, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(ae, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(pe, { children: [
      ...
      /* @__PURE__ */ u(ge, { children: [
        /* @__PURE__ */ a(zr, { children: l }),
        /* @__PURE__ */ a(Qt, { children: A.map((T) => /* @__PURE__ */ u(
          ee,
          {
            value: T.label,
            onSelect: _,
            ...
            children: [
              ...
              T.starred && /* @__PURE__ */ a(Oi, { className: "tw:h-4 tw:w-4" }),
...
function Nd({
  ...
  return /* @__PURE__ */ u(nt, { children: [
    ...
    e && /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      ...
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ u("p", { children: [
        ho(n, "%redoButton_tooltip%"),
        i && ` (${c ? "⌘⇧Z" : "Ctrl+Y"})`
      ] }) })
    ] }) })
  ] });
}
function Cd({ children: t, editorRef: e }) {
  const r = G(null);
  return H(() => {
    var s;
    const o = /Macintosh/i.test(navigator.userAgent), n = ((s = r.current) == null ? void 0 : s.querySelector(".editor-input")) ?? void 0, i = (l) => {
      ...
      if (o) {
        ...
        if (!l.ctrlKey) return;
        !l.shiftKey && c === "z" ? (l.preventDefault(), (g = e.current) == null || g.undo()) : (c === "y" || l.shiftKey && c === "z") && (l.preventDefault(), (h = e.current) == null || h.redo());
      }
    };
    return document.addEventListener("keydown", i), () => document.removeEventListener("keydown", i);
  }, [e]), /* @__PURE__ */ a("div", { ref: r, children: t });
}
const Ed = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(nt, { children: [
...
function zd({
  ...
  const i = G(null), s = G(null), l = G(!1), [c, d] = S(t), [w, g] = S(r), [h, p] = S(!1);
  H(() => {
    d(t);
  }, [t]), H(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    ...
    var x, y, _, k;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((x = i.current) == null || x.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((k = s.current) == null || k.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(ce, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(de, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: Ed(t, n, r) }) }) }),
      /* @__PURE__ */ a(Ct, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      we,
      {
          ...
          /* @__PURE__ */ a(
            le,
            {
              ...
              children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ a("span", { className: "tw:w-10 tw:text-center", children: Zr })
              ] })
            }
          ),
          /* @__PURE__ */ a(
...
const Td = (t, e) => t === "f" ? /* @__PURE__ */ u(nt, { children: [
  /* @__PURE__ */ a(To, {}),
  " ",
  ...
  return t === "f" && (r = e["%footnoteEditor_noteType_footnote_label%"]), be(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: r
  });
};
function Rd({
  ...
  return /* @__PURE__ */ u(ce, { children: [
    /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(de, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: Td(t, r) }) }) }),
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: Sd(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(we, { style: { zIndex: Yo }, children: [
...
function Md({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Pi, { className: e, size: 16 });
}
function fo({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ u(
    ee,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Md, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(vl, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function $d({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = S(""), [i, s] = F(() => {
  ...
  return /* @__PURE__ */ u(pe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      ar,
      {
    ...
    /* @__PURE__ */ u(ge, { children: [
      /* @__PURE__ */ a(zr, { children: t["%markerMenu_noResults%"] }),
      /* @__PURE__ */ a(Qt, { children: i.map((l) => {
        var c;
        return /* @__PURE__ */ a(
          fo,
          {
      ...
      s.length > 0 && /* @__PURE__ */ u(nt, { children: [
        i.length > 0 && /* @__PURE__ */ a(Jo, { alwaysRender: !0 }),
        /* @__PURE__ */ a(Qt, { children: s.map((l) => {
          var c;
          return /* @__PURE__ */ a(
            fo,
            {
...
function ju({
  ...
  const [m, b] = S("generated"), [v, x] = S("*"), [y, _] = S("f"), [k, A] = S(!1), [V, $] = S(!0), [E, N] = S(!1), T = G(!1), L = G(""), [I, M] = S(!1), [O, W] = S(), [D, X] = S(), [zt, Mt] = S(), [St, ut] = S(), ct = G(null), U = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...s.view ?? Zs(), noteMode: "expanded" }
    }),
    [s, l]
  ), rt = F(
    () => Od(
  ...
  H(() => {
    ...
    if (P && sr("note", P)) {
      ...
      let Q = "custom";
      ot === Zr ? Q = "generated" : ot === Qr ? Q = "hidden" : ot && x(ot), b(Q), _(((q = P.insert.note) == null ? void 0 : q.style) ?? "f"), C = setTimeout(() => {
        var ft;
  ...
  const at = B(
    (C, P, K = !1) => {
      ...
      if (q && sr("note", q)) {
        if (q.insert.note) {
          let st;
          C === "custom" ? st = P : C === "generated" ? st = Zr : st = Qr, q.insert.note.caller = st;
        }
        r == null || r([q]), K && d && i && ((ft = d.current) == null || ft.replaceEmbedUpdate(i, [q]));
      }
    },
    [i, r, d]
  ), it = B(() => {
  ...
  const Gt = G({ book: n.book, chapterNum: n.chapterNum });
  Rt(() => {
    (Gt.current.book !== n.book || Gt.current.chapterNum !== n.chapterNum) && (Gt.current = { book: n.book, chapterNum: n.chapterNum }, vt.current());
  }, [n.book, n.chapterNum]);
  const Pt = () => {
    var P;
    ...
    if (P && sr("note", P)) {
      ...
      y !== "x" && C === "x" ? st == null || st.forEach((Tt) => Id(Tt)) : y === "x" && C !== "x" && (st == null || st.forEach((Tt) => Ad(Tt))), (ft = w.current) == null || ft.applyUpdate([P, { delete: 1 }]);
    }
  }, Wt = (C) => {
    ...
    (C) => {
      ...
      if (P && sr("note", P)) {
        ...
        const st = (ot = P.insert.note) == null ? void 0 : ot.style, Tt = (ft = (Q = P.insert.note) == null ? void 0 : Q.contents) == null ? void 0 : ft.ops;
        if (st || A(!1), A(
          st === "x" ? !!(Tt != null && Tt.every(($t) => {
            var mt, wt;
      ...
      /* @__PURE__ */ u("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-end tw:gap-4", children: [
          ...
          /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
            ...
            /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: c["%footnoteEditor_saveButton_tooltip%"] }) })
          ] }) }),
          /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
            /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(j, { onClick: o, className: "tw:h-6 tw:w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ a(tr, {}) }) }),
            /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: c["%footnoteEditor_cancelButton_tooltip%"] }) })
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ a("div", { className: t, children: /* @__PURE__ */ a(Cd, { editorRef: w, children: /* @__PURE__ */ a(
              Qs,
              {
                options: U,
                onStateChange: Wt,
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
              ...
              /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: c["%footnoteEditor_copyButton_tooltip%"] }) })
            ] }) }) })
          ]
        }
      )
      ...
      if (typeof i == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(Xr, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
  ...
  return /* @__PURE__ */ u(nt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ a(nt, { children: Ld(t.marker, l, o, d) })
      }
    )
  ] });
}
...
function Bd({
  ...
  return /* @__PURE__ */ u(Sa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ra, { stickyHeader: !0, children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(_r, { children: n }),
      /* @__PURE__ */ a(_r, { children: i })
    ] }) }),
    /* @__PURE__ */ a(Da, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      se,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          /* @__PURE__ */ a($e, { children: xe(l.reference, "English") }),
          /* @__PURE__ */ a($e, { className: o, children: Fd(l.text) })
        ]
      },
...
const Ud = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ a(Fi, { className: "tw:h-4 tw:w-4" });
  if (t === "desc")
    return /* @__PURE__ */ a(Bi, { className: "tw:h-4 tw:w-4" });
}, Rr = (t, e, r) => /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
  /* @__PURE__ */ u(
    Nt,
    {
  ...
  header: ({ column: e }) => Rr(e, t)
}), Kd = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (r) => r.items[e],
  header: ({ column: r }) => Rr(r, t)
}), Ku = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => Rr(e, t, "tw:justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: i }) => Rr(i, t, "tw:justify-center"),
  cell: ({ row: i }) => {
    const s = i.getValue("status"), l = i.getValue("item");
    return /* @__PURE__ */ u(_n, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
      /* @__PURE__ */ a(
        gr,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, qd = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Yu = Object.freeze([
  ...
  const n = Va(o.key) ? o.key : o.key[0];
  return {
    items: Va(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || qd(n, e, r),
...
function Xu({
  ...
  const p = Lt(r, "%webView_inventory_all%"), m = Lt(r, "%webView_inventory_approved%"), b = Lt(r, "%webView_inventory_unapproved%"), v = Lt(r, "%webView_inventory_unknown%"), x = Lt(r, "%webView_inventory_scope_currentBook%"), y = Lt(r, "%webView_inventory_scope_chapter%"), _ = Lt(r, "%webView_inventory_scope_verse%"), k = Lt(r, "%webView_inventory_filter_text%"), A = Lt(
    r,
    "%webView_inventory_show_additional_items%"
  ), V = Lt(r, "%webView_inventory_no_results%"), [$, E] = S(!1), [N, T] = S("all"), [L, I] = S(""), [M, O] = S([]), W = F(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : Hd(U, n, i);
  }, [t, n, i]), D = F(() => {
    if ($) return W;
    const U = [];
    return W.forEach((rt) => {
  ...
  }, [$, W]), X = F(() => D.length === 0 ? [] : Gd(D, N, L), [D, N, L]), zt = F(() => {
    var at, it;
    if (!$) return c;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
        ...
        /* @__PURE__ */ a(Ct, { children: (o == null ? void 0 : o.checkboxText) ?? A })
      ] }) })
    ] }),
...
const Wd = "16rem", Yd = "3rem", Mn = et.createContext(void 0);
function Dr() {
  const t = et.useContext(Mn);
  if (!t)
...
function Xd({
  ...
  const [c, d] = et.useState(t), w = e ?? c, g = et.useCallback(
    (_) => {
    ...
    "--sidebar-width": Wd,
    "--sidebar-width-icon": Yd,
    ...n
  };
  return /* @__PURE__ */ a(Mn.Provider, { value: x, children: /* @__PURE__ */ a(
    "div",
    {
...
function Ju({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = Dr();
  return /* @__PURE__ */ u(
    j,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(ti, {}) : /* @__PURE__ */ a(ei, {}),
...
function aw({
  ...
  const l = t ? _e.Root : "button", { state: c } = Dr(), d = /* @__PURE__ */ a(
    l,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(rw({ variant: r, size: o }), i),
      ...s
    }
  );
...
function ow({
  ...
  return /* @__PURE__ */ a(
    Jd,
    {
      ...
      children: /* @__PURE__ */ u(Qd, { children: [
        /* @__PURE__ */ u(mo, { children: [
          /* @__PURE__ */ a(vo, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(bo, { children: /* @__PURE__ */ a(tw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(ew, { children: /* @__PURE__ */ a(
            aw,
            {
              onClick: () => d(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ u(mo, { children: [
          /* @__PURE__ */ a(vo, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(bo, { className: "tw:pl-3", children: /* @__PURE__ */ a(
            aa,
            {
              buttonVariant: "ghost",
    ...
    /* @__PURE__ */ u(
      Xd,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Zd, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const ie = "scrBook", nw = "scrRef", ve = "source", iw = "details", sw = "Scripture Reference", lw = "Scripture Book", $n = "Type", cw = "Details";
function dw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: ie,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? sw,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ie ? xe(n.start) : void 0;
      },
      getGroupingValue: (o) => dt.bookIdToNumber(o.start.book),
      sortingFn: (o, n) => Hr(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id: ve,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? $n : void 0,
...
const ww = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Hr(t.start, t.end) === 0 ? `${Mr(t.start)}+${e}` : `${Mr(t.start)}+${e}-${Mr(t.end)}+${r}`;
}, xo = (t) => `${ww({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function wp({
  sources: t,
  ...
  const [d, w] = S([]), [g, h] = S([{ id: ie, desc: !1 }]), [p, m] = S({}), b = F(
  ...
  H(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const L = b.find((I) => xo(I) === T[0]) || void 0;
        L && l(L);
      }
    }
  }, [p, b, l, x]);
  const y = n ?? lw, _ = i ?? $n, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [ie] },
    { label: `Group by ${_}`, value: [ve] },
    {
    ...
    !e && /* @__PURE__ */ u(
      Ie,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Le, { position: "item-aligned", children: /* @__PURE__ */ a(cd, { children: k.map((N) => /* @__PURE__ */ a(Ot, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Sa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ra, { children: x.getHeaderGroups().map((N) => /* @__PURE__ */ a(se, { children: N.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ a(Da, { children: x.getRowModel().rows.map((N, T) => {
        const L = lt();
        return /* @__PURE__ */ a(
          se,
          {
            ...
            children: N.getVisibleCells().map((I) => {
              if (!(I.getIsPlaceholder() || I.column.columnDef.enableGrouping && !I.getIsGrouped() && (I.column.columnDef.id !== ve || !r)))
                return /* @__PURE__ */ a(
                  $e,
                  {
                    className: f(
                    ...
                    children: I.getIsGrouped() ? /* @__PURE__ */ u(
                      j,
                      {
                        ...
                        type: "button",
                        children: [
                          N.getIsExpanded() && /* @__PURE__ */ a(Cr, {}),
                          !N.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ a(Yr, {}) : /* @__PURE__ */ a(Wr, {})),
                          " ",
...
const Oa = (t, e) => t.filter((r) => {
  try {
    return Ge(r) === e;
  } catch {
    return !1;
  }
}), On = (t, e, r) => Oa(t, e).every((o) => r.includes(o));
function uw({
  section: t,
  availableBookIds: e,
  selectedBookIds: r,
  ...
  const i = Oa(e, t).length === 0, s = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], c = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    j,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        On(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: bl(
        t,
...
function pw({
  ...
  const V = F(() => dt.allBookIds.filter(
    ...
    (O) => {
      const W = Oa(V, O).map((D) => D);
      r(
        On(V, O, e) ? e.filter((D) => !W.includes(D)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, r, V]
  ), I = () => {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    /* @__PURE__ */ u(
      re,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ae, { className: "tw:w-full tw:p-0", align: "start", children: /* @__PURE__ */ u(
            pe,
            {
              shouldFilter: !1,
              onKeyDown: (O) => {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  ...
                  /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: M, children: d })
                ] }),
                /* @__PURE__ */ u(ge, { children: [
                  /* @__PURE__ */ a(zr, { children: w }),
                  Object.values(Y).map((O, W) => {
                    ...
                    if (D.length !== 0)
                      return /* @__PURE__ */ u(Ro, { children: [
                        ...
                        W < Object.values(Y).length - 1 && /* @__PURE__ */ a(Jo, {})
                      ] }, O);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      ...
      e.length > Ur && /* @__PURE__ */ a(
        Je,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - yo} ${g}`
        }
      )
    ] })
  ] });
...
function pp({
  ...
  const d = fe(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), h = fe(s, "%webView_scope_selector_current_book%"), p = fe(s, "%webView_scope_selector_choose_books%"), m = fe(s, "%webView_scope_selector_scope%"), b = fe(s, "%webView_scope_selector_select_books%"), v = [
      ...
      /* @__PURE__ */ a(
        en,
        {
          ...
          children: x.map(({ value: y, label: _, id: k }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ra, { className: "tw:me-2", value: y, id: k }),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          Le,
          {
            ...
            style: { zIndex: Fe },
            children: t.map((d) => /* @__PURE__ */ a(Ot, { value: `${d}`, children: l[Z(d)] }, `${d}`))
          }
        )
      ]
    }
...
const An = (t, e, r, o) => r ? Object.entries(t).filter(
  ([i, s]) => "column" in s && s.column === r || i === r
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((l) => l.group === i).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ u(_t, { children: [
  /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(nd, { children: l.label }),
    /* @__PURE__ */ a(ed, { children: /* @__PURE__ */ a(id, { children: An(
      t,
      e,
      In(t, l.id),
      o
...
function da({
  ...
  return /* @__PURE__ */ u(ce, { variant: i, children: [
    /* @__PURE__ */ a(de, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(j, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(qi, {}) }) }),
    /* @__PURE__ */ a(we, { align: "start", style: { zIndex: Fe }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(Ro, { children: [
      /* @__PURE__ */ a(Sn, { children: /* @__PURE__ */ a(kt, { children: An(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(or, {})
    ] }, c)) })
  ] });
}
const Pn = et.forwardRef(
...
function vp({
  ...
  return /* @__PURE__ */ u(Pn, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      da,
      {
        onSelectMenuItem: t,
...
function bp({
  ...
  return /* @__PURE__ */ a(Pn, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    da,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Ln = et.forwardRef(({ className: t, ...e }, r) => {
  const o = lt();
  return /* @__PURE__ */ a(
    At.Root,
    {
...
Ln.displayName = At.List.displayName;
const Vn = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  At.List,
  {
    ref: r,
    className: f(
...
Vn.displayName = At.List.displayName;
const gw = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  At.Trigger,
  {
    ref: r,
    ...e,
...
)), jn = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  At.Content,
  {
    ref: r,
    className: f(
...
jn.displayName = At.Content.displayName;
function xp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ln, { children: [
      /* @__PURE__ */ a(Vn, { children: t.map((l) => /* @__PURE__ */ a(gw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ a(jn, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function hw({
  ...
  return /* @__PURE__ */ a(Ta.Provider, { value: o, children: /* @__PURE__ */ a(
    Kt.Root,
    {
      "data-slot": "menubar",
      className: f(
...
function fw({ ...t }) {
  return /* @__PURE__ */ a(Kt.Menu, { "data-slot": "menubar-menu", ...t });
}
function mw({ ...t }) {
  return /* @__PURE__ */ a(Kt.Portal, { "data-slot": "menubar-portal", ...t });
}
function vw({
  className: t,
  ...e
...
function bw({
  ...
  const i = oe();
  return /* @__PURE__ */ a(mw, { children: /* @__PURE__ */ a(
    Kt.Content,
    {
...
function kw({ ...t }) {
  return /* @__PURE__ */ a(Kt.Sub, { "data-slot": "menubar-sub", ...t });
}
function _w({
  className: t,
  inset: e,
  ...
  return /* @__PURE__ */ u(
    Kt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(ua, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
...
const qe = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const l = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        xw,
        {
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ a(Nr, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ a(Nr, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(kw, { children: [
        /* @__PURE__ */ a(_w, { children: d.label }),
        /* @__PURE__ */ a(Nw, { children: Fn(
          t,
          e,
          In(t, d.id),
          o
    ...
    return l.length > 0 && s < n.length - 1 && c.push(/* @__PURE__ */ a(yw, {}, `separator-${i}`)), c;
  });
};
function Cw({
  menuData: t,
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, x;
    w.preventDefault();
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (x = c.current) == null || x.focus(), qe(c, [h, p]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ a(hw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(fw, { children: [
      /* @__PURE__ */ a(vw, { ref: d(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        bw,
        {
          style: { zIndex: Fe },
          children: /* @__PURE__ */ a(kt, { children: Fn(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function _p({
  ...
  return /* @__PURE__ */ u("div", { id: c, className: f("pr-twp tw:max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(pt, { className: "tw:font-normal tw:text-muted-foreground", children: be(d, {
      fallbackLanguages: (r == null ? void 0 : r.length) > 0 ? r.map((m) => p(m, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function zw({ item: t, createLabel: e, createComplexLabel: r }) {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(ce, { children: [
              /* @__PURE__ */ a(de, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ua, {}) }) }),
              /* @__PURE__ */ a(we, { align: "end", children: d })
            ] }) }),
            e && d && /* @__PURE__ */ u(ce, { children: [
              /* @__PURE__ */ a(de, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ua, {}) }) }),
              /* @__PURE__ */ a(we, { align: "end", children: d })
            ] })
          ] }),
...
const Tw = er(({ className: t, ...e }, r) => /* @__PURE__ */ a(Wi, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
Tw.displayName = "Spinner";
function Ep({
  id: t,
  isDisabled: e = !1,
  hasError: r = !1,
...
function jp({
  ...
  return /* @__PURE__ */ u(
    ht.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(ht.ItemIndicator, { children: /* @__PURE__ */ a(Ne, {}) }) }),
        e
      ]
    }
  );
...
function Wp({
  ...
  const n = lt();
  return /* @__PURE__ */ u(Rw, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Dw, {}),
    /* @__PURE__ */ u(
      ue.Content,
      {
...
function ag({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    rl,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(ii, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(ni, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(oi, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(ai, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(ri, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function sg({
  ...
  return /* @__PURE__ */ a(
    At.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Mw({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
Iw(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Ap as ContextMenuContent,
  Mp as ContextMenuGroup,
  Pp as ContextMenuItem,
  Bp as ContextMenuLabel,
  $p as ContextMenuPortal,
  Ip as ContextMenuRadioGroup,
  Fp as ContextMenuRadioItem,
  Up as ContextMenuSeparator,
  Kp as ContextMenuShortcut,
  Op as ContextMenuSub,
  Vp as ContextMenuSubContent,
  Lp as ContextMenuSubTrigger,
  Dp as ContextMenuTrigger,
  md as DataTable,
  cl as Dialog,
  su as DialogClose,
  ul as DialogContent,
  ...
  la as DropdownMenuItem,
  xd as DropdownMenuItemType,
  ...
  zu as DropdownMenuShortcut,
  od as DropdownMenuSub,
  id as DropdownMenuSubContent,
  nd as DropdownMenuSubTrigger,
  de as DropdownMenuTrigger,
  vd as ERROR_DUMP_STRING_KEYS,
  Ou as ERROR_POPOVER_STRING_KEYS,
  Cd as EditorKeyboardShortcuts,
  bd as ErrorDump,
  Iu as ErrorPopover,
  Fu as FOOTNOTE_EDITOR_STRING_KEYS,
  Vu as Filter,
  Au as FilterDropdown,
  Lu as Footer,
  ju as FootnoteEditor,
  jd as FootnoteItem,
  Bu as FootnoteList,
  Yu as INVENTORY_STRING_KEYS,
  rr as Input,
  Xu as Inventory,
  pt as Label,
  Dd as MARKER_MENU_STRING_KEYS,
  $u as MarkdownRenderer,
  $d as MarkerMenu,
  Pu as MoreInfo,
  kd as MultiSelectComboBox,
  xp as NavigationContentSearch,
  re as Popover,
  xl as PopoverAnchor,
  ae as PopoverContent,
  pu as PopoverDescription,
  wu as PopoverHeader,
  uu as PopoverTitle,
  ...
  Ot as SelectItem,
  Su as SelectLabel,
  wd as SelectScrollDownButton,
  dd as SelectScrollUpButton,
  ...
  fp as SettingsListItem,
  ow as SettingsSidebar,
  dp as SettingsSidebarContentSearch,
  Jd as Sidebar,
  Qd as SidebarContent,
  ep as SidebarFooter,
  mo as SidebarGroup,
  ...
  Xd as SidebarProvider,
  Zu as SidebarRail,
  rp as SidebarSeparator,
  Ju as SidebarTrigger,
  ca as Skeleton,
  og as Slider,
  ag as Sonner,
  Tw as Spinner,
  ng as Switch,
  da as TabDropdownMenu,
  bp as TabFloatingMenu,
  vp as TabToolbar,
  Sa as Table,
  Da as TableBody,
  Mu as TableCaption,
  ...
  _d as UNDO_REDO_BUTTONS_STRING_KEYS,
  _p as UiLanguageSelector,
  Nd as UndoRedoButtons,
  Ln as VerticalTabs,
  jn as VerticalTabsContent,
  Vn as VerticalTabsList,
  gw as VerticalTabsTrigger,
  Fe as Z_INDEX_ABOVE_DOCK,
  Yo as Z_INDEX_FOOTNOTE_EDITOR,
  sl as Z_INDEX_MODAL,
  il as Z_INDEX_MODAL_BACKDROP,
  nl as Z_INDEX_OVERLAY,
  Xc as badgeVariants,
  Xo as buttonVariants,
  f as cn,
  Wu as getBookIdFromUSFM,
  Rr as getInventoryHeader,
  Gu as getLinesFromUSFM,
  Hu as getNumberFromUSFM,
  qd as getStatusForItem,
  yp as getToolbarOSReservedSpaceClassName,
  Ku as inventoryCountColumn,
  Uu as inventoryItemColumn,
  qu as inventoryStatusColumn,
  hg as sonner,
  dg as useEvent,
  wg as useEventAsync,
  Yc as useListbox,
  Ow as usePromise,
  gu as useRecentSearches,
  Dr as useSidebar,
  ug as useStylesheet
};
