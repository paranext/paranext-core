...
var Et = (e, t, n) => (Es(e, typeof t != "symbol" ? t + "" : t, n), n);
import Ts, { jsxs as ue, jsx as x, Fragment as Kn } from "react/jsx-runtime";
import * as E from "react";
import It, { forwardRef as Xn, useCallback as Ne, useState as xe, useRef as ft, useEffect as zt, useLayoutEffect as Mo, Children as an, isValidElement as Bn, createElement as Rr, cloneElement as Di, Fragment as ks, useMemo as wt } from "react";
import { getChaptersForBook as ji, offsetBook as Io, FIRST_SCR_BOOK_NUM as Os, offsetChapter as _o, FIRST_SCR_CHAPTER_NUM as Ss, offsetVerse as Ao, FIRST_SCR_VERSE_NUM as Cs, format as fr, compare as Do } from "platform-bible-utils";
...
te(Ce, "defaultVersification", Rt.English), te(Ce, "verseRangeSeparator", "-"), te(Ce, "verseSequenceIndicator", ","), te(Ce, "verseRangeSeparators", [Ce.verseRangeSeparator]), te(Ce, "verseSequenceIndicators", [Ce.verseSequenceIndicator]), te(Ce, "chapterDigitShifter", 1e3), te(Ce, "bookDigitShifter", Ce.chapterDigitShifter * Ce.chapterDigitShifter), te(Ce, "bcvMaxValue", Ce.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
te(Ce, "ValidStatusType", Ki);
class Yt extends Error {
}
function ye(...e) {
  return Ds(As(e));
}
const xl = ge.Root, El = ge.Trigger, Tl = E.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ ue(
  ge.SubTrigger,
  {
    ref: o,
    className: ye(
...
const kl = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  ge.SubContent,
  {
    ref: n,
    className: ye(
...
const Xi = E.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ x(ge.Portal, { children: /* @__PURE__ */ x(
  ge.Content,
  {
    ref: r,
    sideOffset: t,
...
const Yi = E.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Item,
  {
    ref: r,
    className: ye(
...
const Ol = E.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ ue(
  ge.CheckboxItem,
  {
    ref: o,
    className: ye(
...
const Sl = E.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ue(
  ge.RadioItem,
  {
    ref: r,
    className: ye(
...
const Kr = E.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Label,
  {
    ref: r,
...
Kr.displayName = ge.Label.displayName;
const Ji = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  ge.Separator,
  {
    ref: n,
...
function Nl({
  ...
  const i = Array.from({ length: t }, (l, c) => c + 1), s = Ne(
    (l) => {
      o(l);
    },
    [o]
...
function Rl({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ ue(Kr, { className: "pr-flex pr-justify-between", children: [
...
const sn = ie.allBookIds, $l = {
  ...
  OT: sn.filter((n) => ie.isBookOT(n)),
  NT: sn.filter((n) => ie.isBookNT(n)),
  DC: sn.filter((n) => ie.isBookDC(n))
})[e], Jt = (e) => ji(ie.bookIdToNumber(e));
function Al() {
  return sn.map((t) => ie.bookIdToEnglishName(t));
}
function Dl(e) {
...
function jl(e) {
  ...
  if (Dl(t))
    return sn.find((r) => ie.bookIdToEnglishName(r) === t);
}
function mm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = xe(""), [o, i] = xe(
    ...
    ie.bookNumberToId(e.bookNum)
  ), [d, h] = xe(!1), [f, b] = xe(d), v = ft(void 0), g = ft(void 0), m = ft(void 0), T = Ne(
    (C) => _l(C).filter((R) => {
    ...
    Il.forEach((C) => {
      const R = n.match(C);
      if (R) {
        const [$, F = void 0, D = void 0] = R.slice(1), M = jl($);
    ...
    (C) => {
      ...
      // eslint-disable-next-line no-null/no-null
      g.current !== null && g.current.focus(), C.preventDefault()) : h(!0);
    },
    [d]
  ), L = (C) => {
    const { key: R } = C;
  ...
  return zt(() => {
  ...
  }, [c, e.bookNum, e.chapterNum, o]), Mo(() => {
    b(d);
  }, [d]), Mo(() => {
    const C = setTimeout(() => {
      if (f && g.current && m.current) {
        const $ = m.current.offsetTop - Ml;
  ...
  }, [f]), /* @__PURE__ */ x("div", { children: /* @__PURE__ */ ue(xl, { modal: !1, open: d, onOpenChange: y, children: [
    /* @__PURE__ */ x(El, { asChild: !0, children: /* @__PURE__ */ x(
      Cl,
      {
        ...
        handleKeyDown: B,
        handleOnClick: () => {
          i(ie.bookNumberToId(e.bookNum)), u(ie.bookNumberToId(e.bookNum)), l(e.chapterNum > 0 ? e.chapterNum : 0), h(!0), v.current.focus();
        },
        onFocus: () => {
          w.current = !0;
        },
    ...
    /* @__PURE__ */ ue(
      Xi,
      {
        ...
        children: [
          ...
          Fo.map(
            (C, R) => T(C).length > 0 && /* @__PURE__ */ ue("div", { children: [
              /* @__PURE__ */ x(Kr, { className: "pr-font-semibold pr-text-slate-700", children: $l[C] }),
              T(C).map(($) => /* @__PURE__ */ x("div", { children: /* @__PURE__ */ x(
                Pl,
                {
                  bookId: $,
              ...
              Fo.length - 1 !== R ? /* @__PURE__ */ x(Ji, {}) : void 0
            ] }, C)
          )
        ]
      }
...
const Zi = /* @__PURE__ */ Xn((e, t) => {
  const { children: n, ...r } = e, o = an.toArray(n), i = o.find(Vl);
  if (i) {
    const s = i.props.children, l = o.map((c) => c === i ? an.count(s) > 1 ? an.only(null) : /* @__PURE__ */ Bn(s) ? s.props.children : null : c);
    return /* @__PURE__ */ Rr($r, k({}, r, {
      ref: t
...
const $r = /* @__PURE__ */ Xn((e, t) => {
  ...
  }) : an.count(n) > 1 ? an.only(null) : null;
});
...
function Hl({
  ...
  let h;
  if (n) {
    const f = r === $t.Before || r === $t.Above, b = /* @__PURE__ */ x("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === $t.Before || r === $t.After, g = v ? b : /* @__PURE__ */ x("div", { children: b }), m = v ? d : /* @__PURE__ */ x("div", { children: d });
    h = /* @__PURE__ */ ue(
      Ls,
      {
...
function Gl() {
  if (Vo)
    return ae;
  Vo = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, u = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, h = e ? Symbol.for("react.suspense") : 60113, f = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, v = e ? Symbol.for("react.lazy") : 60116, g = e ? Symbol.for("react.block") : 60121, m = e ? Symbol.for("react.fundamental") : 60117, T = e ? Symbol.for("react.responder") : 60118, I = e ? Symbol.for("react.scope") : 60119;
  function w(p) {
  ...
  return ae.AsyncMode = c, ae.ConcurrentMode = u, ae.ContextConsumer = l, ae.ContextProvider = s, ae.Element = t, ae.ForwardRef = d, ae.Fragment = r, ae.Lazy = v, ae.Memo = b, ae.Portal = n, ae.Profiler = i, ae.StrictMode = o, ae.Suspense = h, ae.isAsyncMode = function(p) {
    return y(p) || w(p) === c;
    ...
    return typeof p == "string" || typeof p == "function" || p === r || p === u || p === i || p === o || p === h || p === f || typeof p == "object" && p !== null && (p.$$typeof === v || p.$$typeof === b || p.$$typeof === s || p.$$typeof === l || p.$$typeof === d || p.$$typeof === m || p.$$typeof === T || p.$$typeof === I || p.$$typeof === g);
  }, ae.typeOf = w, ae;
}
var se = {};
/** @license React v16.13.1
...
function Kl() {
  return zo || (zo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(_) {
      ...
      _ === r || _ === u || _ === i || _ === o || _ === h || _ === f || typeof _ == "object" && _ !== null && (_.$$typeof === v || _.$$typeof === b || _.$$typeof === s || _.$$typeof === l || _.$$typeof === d || _.$$typeof === m || _.$$typeof === T || _.$$typeof === I || _.$$typeof === g);
    }
    function y(_) {
    ...
    var p = c, S = u, N = l, B = s, L = t, j = d, C = r, R = v, $ = b, F = n, D = i, M = o, V = h, Q = !1;
    function Z(_) {
...
var Uo;
function ea() {
  return Uo || (Uo = 1, process.env.NODE_ENV === "production" ? Nn.exports = Gl() : Nn.exports = Kl()), Nn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var br, qo;
function ta() {
  return qo || (qo = 1, br = Function.call.bind(Object.prototype.hasOwnProperty)), br;
}
var vr, Go;
function Yl() {
  if (Go)
...
function Jl() {
  if (Ko)
    return yr;
  Ko = 1;
  var e = ea(), t = Xl(), n = Yr(), r = ta(), o = Yl(), i = function() {
  };
...
function sc() {
  ...
  return le.ContextConsumer = s, le.ContextProvider = i, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = f, le.Memo = h, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = u, le.SuspenseList = d, le.isAsyncMode = function() {
    return !1;
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === u || m === d || m === b || typeof m == "object" && m !== null && (m.$$typeof === f || m.$$typeof === h || m.$$typeof === i || m.$$typeof === s || m.$$typeof === c || m.$$typeof === v || m.getModuleId !== void 0);
  }, le.typeOf = g, le;
}
var ce = {};
/**
...
function lc() {
  return Jo || (Jo = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, g = !1, m = !1, T = !1, I = !1, w;
    w = Symbol.for("react.module.reference");
    function y(P) {
      return !!(typeof P == "string" || typeof P == "function" || P === n || P === o || I || P === r || P === u || P === d || T || P === b || v || g || m || typeof P == "object" && P !== null && (P.$$typeof === f || P.$$typeof === h || P.$$typeof === i || P.$$typeof === s || P.$$typeof === c || // This needs to include all possible module reference object
    ...
    var S = s, N = i, B = e, L = c, j = n, C = f, R = h, $ = t, F = o, D = r, M = u, V = d, Q = !1, Z = !1;
    function O(P) {
...
process.env.NODE_ENV === "production" ? _r.exports = sc() : _r.exports = lc();
var Ln = _r.exports;
...
const pc = a.oneOfType([a.func, a.object]), Jr = pc;
function He(e) {
  if (typeof e != "string")
...
function mc(e, t) {
  ...
  return (o) => (i, s, l, c, u, ...d) => {
    const h = u || s, f = n == null ? void 0 : n[h];
    if (f) {
...
const gc = typeof window < "u" ? E.useLayoutEffect : E.useEffect, gt = gc;
let Qo = 0;
function bc(e) {
...
function Sc() {
  this.visibilityState === "hidden" && Dr && (Yn = !0);
}
function Cc(e) {
...
function ua() {
  ...
  function n() {
    return t.current ? (Dr = !0, Ec.start(100, () => {
      Dr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
fa.isRequired = pa;
jr.isRequired = jr;
const ha = process.env.NODE_ENV === "production" ? jr : fa;
function ma(e, t) {
  const n = k({}, t);
...
function rn(e, t, n) {
  return e === void 0 || va(e) ? t : k({}, t, {
    ownerState: k({}, t.ownerState, n)
  });
}
const Ac = {
  disableDefaultClasses: !1
}, Dc = /* @__PURE__ */ E.createContext(Ac);
function jc(e) {
  const {
...
function Lc(e) {
  ...
  const s = ya(k({}, o, r)), l = ri(r), c = ri(o), u = t(s), d = Ee(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = k({}, u, n, c, l);
...
function Vn(e) {
  const {
    ...
    isEnabled: s = Xc,
    open: l
  } = e, c = E.useRef(!1), u = E.useRef(null), d = E.useRef(null), h = E.useRef(null), f = E.useRef(null), b = E.useRef(!1), v = E.useRef(null), g = Le(t.ref, v), m = E.useRef(null);
  E.useEffect(() => {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    if (!l || !v.current)
      return;
    const w = Te(v.current), y = (N) => {
      m.current = N, !(r || !s() || N.key !== "Tab") && w.activeElement === v.current && N.shiftKey && (c.current = !0, d.current && d.current.focus());
    }, p = () => {
      const N = v.current;
      if (N === null)
        return;
      ...
      if ((w.activeElement === u.current || w.activeElement === d.current) && (B = i(v.current)), B.length > 0) {
        var L, j;
        const C = !!((L = m.current) != null && L.shiftKey && ((j = m.current) == null ? void 0 : j.key) === "Tab"), R = B[0], $ = B[B.length - 1];
...
process.env.NODE_ENV !== "production" && (fn["propTypes"] = ia(fn.propTypes));
function Jc(e) {
  const t = Te(e);
...
class tu {
  ...
  remove(t, n = !0) {
    ...
    if (i.modals.splice(i.modals.indexOf(t), 1), this.modals.splice(r, 1), i.modals.length === 0)
      i.restore && i.restore(), t.modalRef && ln(t.modalRef, n), ii(i.container, t.mount, t.modalRef, i.hiddenSiblings, !1), this.containers.splice(o, 1);
    else {
...
function iu(e) {
  const {
    ...
    open: d,
    rootRef: h
  } = e, f = E.useRef({}), b = E.useRef(null), v = E.useRef(null), g = Le(v, h), [m, T] = E.useState(!d), I = ru(c);
  let w = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (w = !1);
  const y = () => Te(b.current), p = () => (f.current.modalRef = v.current, f.current.mount = b.current, f.current), S = () => {
    o.mount(p(), {
      disableScrollLock: r
  ...
  }), B = E.useCallback(() => o.isTopModal(p()), [o]), L = pn((M) => {
    b.current = M, M && (d && B() ? S() : v.current && ln(v.current, w));
  }), j = E.useCallback(() => {
    o.remove(p(), w);
  }, [w, o]);
  E.useEffect(() => () => {
  ...
  return {
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: Ar(M, c == null ? void 0 : c.props.onEnter),
        onExited: Ar(V, c == null ? void 0 : c.props.onExited)
      };
    },
    rootRef: g,
    portalRef: L,
...
var Pe = "top", Fe = "bottom", Ve = "right", Re = "left", Zr = "auto", yn = [Pe, Fe, Ve, Re], Bt = "start", hn = "end", au = "clippingParents", Ea = "viewport", Zt = "popper", su = "reference", ai = /* @__PURE__ */ yn.reduce(function(e, t) {
  return e.concat([t + "-" + Bt, t + "-" + hn]);
}, []), Ta = /* @__PURE__ */ [].concat(yn, [Zr]).reduce(function(e, t) {
...
var ht = Math.max, zn = Math.min, Lt = Math.round;
function Br() {
...
function Ft(e, t, n) {
  ...
  var s = vt(e) ? Ae(e) : window, l = s.visualViewport, c = !ka() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, d = (r.top + (c && l ? l.offsetTop : 0)) / i, h = r.width / o, f = r.height / i;
  return {
    width: h,
    height: f,
    top: d,
...
function Jn(e) {
  return We(e) === "html" ? e : (
    ...
    (Qr(e) ? e.host : null) || // ShadowRoot detected
...
function Eu(e) {
  ...
  var o = Jn(e);
  for (Qr(o) && (o = o.host); Be(o) && ["html", "body"].indexOf(We(o)) < 0; ) {
    var i = Ze(o);
...
var ku = function(t, n) {
  ...
  })) : t, Ca(typeof t != "number" ? t : Na(t, yn));
};
function Ou(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Ue(n.placement), c = to(l), u = [Re, Ve].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var h = ku(o.padding, n), f = eo(i), b = c === "y" ? Pe : Re, v = c === "y" ? Fe : Ve, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], T = wn(i), I = T ? c === "y" ? T.clientHeight || 0 : T.clientWidth || 0 : 0, w = g / 2 - m / 2, y = h[b], p = I - f[d] - h[v], S = I / 2 - f[d] / 2 + w, N = cn(y, S, p), B = c;
...
function li(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, i = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, h = e.isFixed, f = s.x, b = f === void 0 ? 0 : f, v = s.y, g = v === void 0 ? 0 : v, m = typeof d == "function" ? d({
    x: b,
    y: g
  }) : {
    x: b,
  ...
  b = m.x, g = m.y;
  var T = s.hasOwnProperty("x"), I = s.hasOwnProperty("y"), w = Re, y = Pe, p = window;
  if (u) {
    var S = wn(n), N = "clientHeight", B = "clientWidth";
    if (S === Ae(n) && (S = at(n), Ze(S).position !== "static" && l === "absolute" && (N = "scrollHeight", B = "scrollWidth")), S = S, o === Pe || (o === Re || o === Ve) && i === hn) {
      y = Fe;
      var L = h && S === p && p.visualViewport ? p.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        S[N]
      );
      g -= L - r.height, g *= c ? 1 : -1;
    }
    if (o === Re || (o === Pe || o === Fe) && i === hn) {
      w = Ve;
      var j = h && S === p && p.visualViewport ? p.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        S[B]
      );
      b -= j - r.width, b *= c ? 1 : -1;
  ...
  if (b = R.x, g = R.y, c) {
    var $;
    return Object.assign({}, C, ($ = {}, $[y] = I ? "0" : "", $[w] = T ? "0" : "", $.transform = (p.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", $));
  }
  return Object.assign({}, C, (t = {}, t[y] = I ? g + "px" : "", t[w] = T ? b + "px" : "", t.transform = "", t));
}
function Ru(e) {
...
function ro(e) {
  return Ft(at(e)).left + no(e).scrollLeft;
}
function Du(e, t) {
...
function ju(e) {
  var t, n = at(e), r = no(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = ht(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = ht(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + ro(e), c = -r.scrollTop;
...
function Pa(e) {
  return ["html", "body", "#document"].indexOf(We(e)) >= 0 ? e.ownerDocument.body : Be(e) && oo(e) ? e : Pa(Jn(e));
}
function un(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = Pa(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Ae(r), s = o ? [i].concat(i.visualViewport || [], oo(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function ui(e, t, n) {
  return t === Ea ? Lr(Du(e, n)) : vt(t) ? Bu(t, n) : Lr(ju(at(e)));
}
function Lu(e) {
  var t = un(Jn(e)), n = ["absolute", "fixed"].indexOf(Ze(e).position) >= 0, r = n && Be(e) ? wn(e) : e;
  return vt(r) ? t.filter(function(o) {
    return vt(o) && Oa(o, r) && We(o) !== "body";
  }) : [];
}
function Fu(e, t, n, r) {
...
function mn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? au : l, u = n.rootBoundary, d = u === void 0 ? Ea : u, h = n.elementContext, f = h === void 0 ? Zt : h, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, T = Ca(typeof m != "number" ? m : Na(m, yn)), I = f === Zt ? su : Zt, w = e.rects.popper, y = e.elements[v ? I : f], p = Fu(vt(y) ? y : y.contextElement || at(e.elements.popper), c, d, s), S = Ft(e.elements.reference), N = Ra({
    reference: S,
    element: w,
    strategy: "absolute",
    placement: o
  }), B = Lr(Object.assign({}, w, N)), L = f === Zt ? B : S, j = {
    top: p.top - L.top + T.top,
    bottom: L.bottom - p.bottom + T.bottom,
    left: p.left - L.left + T.left,
    right: L.right - p.right + T.right
  }, C = e.modifiersData.offset;
  if (f === Zt && C) {
    var R = C[o];
    Object.keys(j).forEach(function($) {
      var F = [Ve, Fe].indexOf($) >= 0 ? 1 : -1, D = [Pe, Fe].indexOf($) >= 0 ? "y" : "x";
      j[$] += R[D] * F;
    });
  }
  return j;
...
function Vu(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? Ta : c, d = Vt(r), h = d ? l ? ai : ai.filter(function(v) {
    return Vt(v) === d;
  }) : yn, f = h.filter(function(v) {
...
function Uu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, h = n.rootBoundary, f = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, T = Ue(m), I = T === m, w = c || (I || !v ? [In(m)] : zu(m)), y = [m].concat(w).reduce(function(z, H) {
      return z.concat(Ue(H) === Zr ? Vu(t, {
        placement: H,
        boundary: d,
        rootBoundary: h,
        padding: u,
      ...
      var C = y[j], R = Ue(C), $ = Vt(C) === Bt, F = [Pe, Fe].indexOf(R) >= 0, D = F ? "width" : "height", M = mn(t, {
        placement: C,
        boundary: d,
        rootBoundary: h,
        altBoundary: f,
...
function Wu(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, s = mn(t, {
    ...
    altBoundary: !0
  }), c = di(s, r), u = di(l, o, i), d = pi(c), h = pi(u);
  t.modifiersData[n] = {
...
function Ku(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, i = o === void 0 ? [0, 0] : o, s = Ta.reduce(function(d, h) {
    return d[h] = Gu(h, t.rects, i), d;
...
function Qu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, h = n.padding, f = n.tether, b = f === void 0 ? !0 : f, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = mn(t, {
    boundary: c,
    rootBoundary: u,
    padding: h,
    altBoundary: d
  }), T = Ue(t.placement), I = Vt(t.placement), w = !I, y = to(T), p = Zu(y), S = t.modifiersData.popperOffsets, N = t.rects.reference, B = t.rects.popper, L = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, j = typeof L == "number" ? {
    mainAxis: L,
    altAxis: L
  ...
  if (S) {
    if (i) {
      var $, F = y === "y" ? Pe : Re, D = y === "y" ? Fe : Ve, M = y === "y" ? "height" : "width", V = S[y], Q = V + m[F], Z = V - m[D], O = b ? -B[M] / 2 : 0, A = I === Bt ? N[M] : B[M], U = I === Bt ? -B[M] : -N[M], K = t.elements.arrow, z = b && K ? eo(K) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Sa(), q = H[F], G = H[D], W = cn(0, N[M], z[M]), X = w ? N[M] / 2 - O - W - q - j.mainAxis : A - W - q - j.mainAxis, Y = w ? -N[M] / 2 + O + W + G + j.mainAxis : U + W + G + j.mainAxis, ne = t.elements.arrow && wn(t.elements.arrow), _ = ne ? y === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = ($ = C == null ? void 0 : C[y]) != null ? $ : 0, P = V + X - J - _, re = V + Y - J, ve = cn(b ? zn(Q, P) : Q, V, b ? ht(Z, re) : Z);
      S[y] = ve, R[y] = ve - V;
    }
    if (l) {
      var Oe, me = y === "x" ? Pe : Re, lt = y === "x" ? Fe : Ve, Se = S[p], Ge = p === "y" ? "height" : "width", $e = Se + m[me], Ke = Se - m[lt], we = [Pe, Re].indexOf(T) !== -1, xt = (Oe = C == null ? void 0 : C[p]) != null ? Oe : 0, ct = we ? $e : Se - N[Ge] - B[Ge] - xt + j.altAxis, Wt = we ? Se + N[Ge] + B[Ge] - xt - j.altAxis : Ke, kn = b && we ? Tu(ct, Se, Wt) : cn(b ? ct : $e, Se, b ? Wt : Ke);
      S[p] = kn, R[p] = kn - Se;
    }
    t.modifiersData[r] = R;
  }
...
function od(e, t, n) {
  n === void 0 && (n = !1);
  var r = Be(t), o = Be(t) && rd(t), i = at(t), s = Ft(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  oo(i)) && (l = nd(t)), Be(t) ? (c = Ft(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = ro(i))), {
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      setOptions: function(T) {
        var I = typeof T == "function" ? T(d.options) : T;
        g(), d.options = Object.assign({}, i, d.options, I), d.scrollParents = {
          reference: vt(l) ? un(l) : l.contextElement ? un(l.contextElement) : [],
          popper: un(c)
        };
        var w = ad(ld([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          var T = d.elements, I = T.reference, w = T.popper;
          if (hi(I, w)) {
            d.rects = {
              reference: od(I, wn(w), d.options.strategy === "fixed"),
              popper: eo(w)
    ...
    function v() {
      d.orderedModifiers.forEach(function(m) {
        var T = m.name, I = m.options, w = I === void 0 ? {} : I, y = m.effect;
        if (typeof y == "function") {
          var p = y({
            state: d,
            name: T,
...
var ud = [Iu, Ju, $u, wu, Xu, Hu, ed, Cu, qu], dd = /* @__PURE__ */ cd({
  defaultModifiers: ud
});
const $a = "Popper";
function pd(e) {
...
const bd = () => et({
  root: ["root"]
}, jc(pd)), vd = {}, yd = /* @__PURE__ */ E.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, m = de(t, fd), T = E.useRef(null), I = Le(T, n), w = E.useRef(null), y = Le(w, f), p = E.useRef(y);
  gt(() => {
    p.current = y;
  }, [y]), E.useImperativeHandle(f, () => w.current, []);
  const S = md(d, s), [N, B] = E.useState(S), [L, j] = E.useState(Un(o));
  E.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && L && Zn(L) && L.nodeType === 1) {
...
`));
    ...
    c != null && (M = M.concat(c)), h && h.modifiers != null && (M = M.concat(h.modifiers));
    const V = dd(L, T.current, k({
      placement: S
    }, h, {
      modifiers: M
    }));
  ...
  const R = bd(), $ = (r = v.root) != null ? r : "div", F = bt({
    elementType: $,
  ...
  const {
    ...
    slotProps: m = {},
    slots: T = {}
  } = t, I = de(t, hd), [w, y] = E.useState(!0), p = () => {
    y(!1);
  }, S = () => {
    y(!0);
  };
  ...
  if (i)
    ...
    const j = Un(r);
    N = j && Zn(j) ? Te(j).body : Te(null).body;
  }
...
function Qe(e, t, n) {
  ...
  if (typeof t == "object") {
    ...
    return Object.keys(t).reduce((s, l) => {
      if (Object.keys(i.values || io).indexOf(l) !== -1) {
        const c = i.up(l);
        s[c] = n(t[l], l);
      } else {
        const c = l;
...
function be(e) {
  const {
    ...
    return Qe(s, l, (h) => {
      let f = Hn(u, o, h);
      return h === f && typeof h == "string" && (f = Hn(u, o, `${t}${h === "default" ? "" : He(h)}`, h)), n === !1 ? f : {
        [n]: f
      };
    });
  };
...
function _a(e, t) {
  const n = Ia(e.theme);
  return Object.keys(e).map((r) => _d(e, t, r, n)).reduce(dn, {});
}
function fe(e) {
  return _a(e, er);
}
...
const Dd = ze("border", je), jd = ze("borderTop", je), Bd = ze("borderRight", je), Ld = ze("borderBottom", je), Fd = ze("borderLeft", je), Vd = ze("borderColor"), zd = ze("borderTopColor"), Ud = ze("borderRightColor"), Hd = ze("borderBottomColor"), Wd = ze("borderLeftColor"), qd = ze("outline", je), Gd = ze("outlineColor"), rr = (e) => {
...
nr(Dd, jd, Bd, Ld, Fd, Vd, zd, Ud, Hd, Wd, rr, qd, Gd);
const or = (e) => {
...
function mp() {
  function e(n, r, o, i) {
    ...
    return h ? h(s) : Qe(s, r, (v) => {
      let g = Hn(f, d, v);
      return v === g && typeof v == "string" && (g = Hn(f, d, `${n}${v === "default" ? "" : He(v)}`, v)), c === !1 ? g : {
        [c]: g
      };
    });
  }
  function t(n) {
    ...
    if (!o)
      return null;
    const s = (r = i.unstable_sxConfig) != null ? r : so;
    function l(c) {
      let u = c;
      ...
      if (!u)
        return null;
      const d = Sd(i.breakpoints), h = Object.keys(d);
      let f = d;
...
function co(e = {}, ...t) {
  ...
  return u.applyStyles = gp, u = t.reduce((d, h) => Ye(d, h), u), u.unstable_sxConfig = k({}, so, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(h) {
    return lo({
      sx: h,
      theme: this
    });
...
const Op = co(), bi = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Rn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Cp(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    el(s, (p) => p.filter((S) => !(S != null && S.__mui_systemSx)));
    const {
      name: c,
      slot: u,
    ...
    let T = _n;
    u === "Root" || u === "root" ? T = r : u ? T = o : kp(s) && (T = void 0);
    const I = Zs(s, k({
      shouldForwardProp: T,
      label: m
    }, b)), w = (p) => typeof p == "function" && p.__emotion_real !== p || pt(p) ? (S) => An(p, k({}, S, {
      theme: Rn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let C;
        c && (C = `${c}${He(u || "")}`), C === void 0 && (C = `Styled(${dc(s)})`), j.displayName = C;
      }
...
function vi(e) {
  e = yt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? yt($p(e)).values : e.values;
...
function Wn(e, t) {
  return e = yt(e), t = uo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, sr(e);
}
function Mp(e, t) {
  if (e = yt(e), t = uo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Ap = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Nt = Up, Hp = ["mode", "contrastThreshold", "tonalOffset"], wi = {
...
function Jp(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = de(e, Hp), i = e.primary || Wp(t), s = e.secondary || qp(t), l = e.error || Gp(t), c = e.info || Kp(t), u = e.success || Xp(t), d = e.warning || Yp(t);
  function h(g) {
...
The color object needs to have a \`main\` property or a \`${T}\` property.` : Dt(11, m ? ` (${m})` : "", T));
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return xi(g, "light", I, r), xi(g, "dark", w, r), g.contrastText || (g.contrastText = h(g.main)), g;
  }, b = {
    dark: Tr,
    light: wi
  };
...
function ef(e, t) {
  ...
  const b = o / 14, v = h || ((T) => `${T / u * b}rem`), g = (T, I, w, y, p) => k({
    fontFamily: r,
    fontWeight: T,
    fontSize: v(I),
...
function df(e) {
  const t = k({}, lf, e.easing), n = k({}, cf, e.duration);
  return k({
    ...
    create: (o = ["all"], i = {}) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        ...
        !d(o) && !Array.isArray(o) && console.error('MUI: Argument "props" must be a string or Array.'), !h(s) && !d(s) && console.error(`MUI: Argument "duration" must be a number or a string but found ${s}.`), d(l) || console.error('MUI: Argument "easing" must be a string.'), !h(c) && !d(c) && console.error('MUI: Argument "delay" must be a number or a string.'), typeof i != "object" && console.error(["MUI: Secong argument of transition.create must be an object.", "Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
...
function mf(e = {}, ...t) {
  ...
  if (u = Ye(u, s), u = t.reduce((d, h) => Ye(d, h), u), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return u.unstable_sxConfig = k({}, so, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(h) {
    return lo({
      sx: h,
      theme: this
    });
...
const gf = mf(), po = gf, fo = "$$material", Ba = (e) => _n(e) && e !== "classes", bf = Cp({
  themeId: fo,
  defaultTheme: po,
...
function Tn() {
  const e = ja(po);
  return process.env.NODE_ENV !== "production" && E.useDebugValue(e), e[fo] || e;
}
function tt({
  props: e,
  name: t
...
const La = It.createContext(null);
var wf = function(t) {
  return t.scrollTop;
}, on = "unmounted", ut = "exited", dt = "entering", Mt = "entered", Vr = "exiting", nt = /* @__PURE__ */ function(e) {
  vf(t, e);
  function t(r, o) {
    var i;
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== dt && s !== Mt && (i = dt) : (s === dt || s === Mt) && (i = Vr);
    }
    ...
    var i = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Cn.findDOMNode(this), l], u = c[0], d = c[1], h = this.getTimeouts(), f = l ? h.appear : h.enter;
    if (!o && !s || Oi.disabled) {
      this.safeSetState({
        status: Mt
      }, function() {
    ...
    return (
      ...
      /* @__PURE__ */ It.createElement(La.Provider, {
        value: null
...
const Ef = {
...
}, kr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), ho = /* @__PURE__ */ E.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = t, T = de(t, xf), I = nn(), w = E.useRef(), y = Tn(), p = E.useRef(null), S = Le(p, i.ref, n), N = (D) => (M) => {
    if (D) {
      const V = p.current;
      M === void 0 ? D(V) : D(V, M);
    }
    ...
    g === "auto" ? (Z = y.transitions.getAutoHeightDuration(D.clientHeight), w.current = Z) : Z = M, D.style.transition = [y.transitions.create("opacity", {
      ...
      easing: Q
    })].join(","), D.style.opacity = 0, D.style.transform = zr(0.75), h && h(D);
  }), $ = N(f);
  return /* @__PURE__ */ x(m, k({
    appear: o,
    in: l,
    nodeRef: p,
    onEnter: L,
...
const Ur = ho, Tf = (e) => {
...
}, Si = Tf, kf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Of = ke(Ma, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = Da(), i = tt({
    ...
    slots: w,
    slotProps: y
  } = i, p = de(i, kf), S = (r = w == null ? void 0 : w.root) != null ? r : c == null ? void 0 : c.Root, N = k({
    anchorEl: s,
    container: d,
    disablePortal: h,
    keepMounted: f,
...
const Ha = /* @__PURE__ */ E.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, h, f, b, v, g, m, T, I, w, y, p;
  const S = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    slots: Y = {},
    title: ne,
    TransitionComponent: _ = Ur,
    TransitionProps: J
  } = S, P = de(S, Nf), re = /* @__PURE__ */ E.isValidElement(B) ? B : /* @__PURE__ */ x("span", {
    children: B
  }), ve = Tn(), Oe = ve.direction === "rtl", [me, lt] = E.useState(), [Se, Ge] = E.useState(null), $e = E.useRef(!1), Ke = F || Z, we = nn(), xt = nn(), ct = nn(), Wt = nn(), [kn, vo] = ca({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const yo = (ee) => {
    ...
    (ee) => {
      Ci.start(800 + A, () => {
        $n = !1;
      }), vo(!1), K && Xe && K(ee), we.start(ve.transitions.duration.shortest, () => {
        $e.current = !1;
      });
    }
  ), cr = (ee) => {
    $e.current && ee.type !== "touchstart" || (me && me.removeAttribute("title"), xt.clear(), ct.clear(), M || $n && V ? xt.start($n ? V : M, () => {
      yo(ee);
    }) : yo(ee));
  }, wo = (ee) => {
    xt.clear(), ct.start(A, () => {
    ...
    onFocus: us,
    ref: ds
  } = ua(), [, Eo] = E.useState(!1), To = (ee) => {
    cs(ee), xo.current === !1 && (Eo(!1), wo(ee));
  }, ko = (ee) => {
    me || lt(ee.currentTarget), us(ee), xo.current === !0 && (Eo(!0), cr(ee));
  }, Oo = (ee) => {
    $e.current = !0;
    const Me = re.props;
    Me.onTouchStart && Me.onTouchStart(ee);
  }, So = cr, Co = wo, ps = (ee) => {
    Oo(ee), ct.clear(), we.clear(), On(), qt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Wt.start(Q, () => {
      document.body.style.WebkitUserSelect = qt.current, cr(ee);
    });
  }, fs = (ee) => {
    re.props.onTouchEnd && re.props.onTouchEnd(ee), On(), ct.start(U, () => {
      Sn(ee);
    });
  };
  E.useEffect(() => {
    if (!Xe)
      return;
    function ee(Me) {
      (Me.key === "Escape" || Me.key === "Esc") && Sn(Me);
    }
  ...
  !ne && ne !== 0 && (Xe = !1);
  const ur = E.useRef(), ms = (ee) => {
    const Me = re.props;
    Me.onMouseMove && Me.onMouseMove(ee), en = {
      x: ee.clientX,
      y: ee.clientY
    }, ur.current && ur.current.update();
  }, Gt = {}, dr = typeof ne == "string";
  C ? (Gt.title = !Xe && dr && !$ ? ne : null, Gt["aria-describedby"] = Xe ? lr : null) : (Gt["aria-label"] = dr ? ne : null, Gt["aria-labelledby"] = Xe && !dr ? lr : null);
  const De = k({}, Gt, P, re.props, {
    className: Ee(P.className, re.props.className),
    onTouchStart: Oo,
    ref: hs
  }, Z ? {
    onMouseMove: ms
...
`));
  ...
  const Kt = {};
  D || (De.onTouchStart = ps, De.onTouchEnd = fs), $ || (De.onMouseOver = Mn(So, De.onMouseOver), De.onMouseLeave = Mn(Co, De.onMouseLeave), Ke || (Kt.onMouseOver = So, Kt.onMouseLeave = Co)), R || (De.onFocus = Mn(ko, De.onFocus), De.onBlur = Mn(To, De.onBlur), Ke || (Kt.onFocus = ko, Kt.onBlur = To)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const gs = E.useMemo(() => {
    var ee;
    let Me = [{
    ...
    return (ee = W.popperOptions) != null && ee.modifiers && (Me = Me.concat(W.popperOptions.modifiers)), k({}, W.popperOptions, {
      modifiers: Me
    });
  }, [Se, W]), Xt = k({}, S, {
    isRtl: Oe,
    ...
    touch: $e.current
  }), pr = Rf(Xt), No = (r = (o = Y.popper) != null ? o : L.Popper) != null ? r : $f, Po = (i = (s = (l = Y.transition) != null ? l : L.Transition) != null ? s : _) != null ? i : Ur, Ro = (c = (u = Y.tooltip) != null ? u : L.Tooltip) != null ? c : Mf, $o = (d = (h = Y.arrow) != null ? h : L.Arrow) != null ? d : If, bs = rn(No, k({}, W, (f = X.popper) != null ? f : j.popper, {
    className: Ee(pr.popper, W == null ? void 0 : W.className, (b = (v = X.popper) != null ? v : j.popper) == null ? void 0 : b.className)
  }), Xt), vs = rn(Po, k({}, J, (g = X.transition) != null ? g : j.transition), Xt), ys = rn(Ro, k({}, (m = X.tooltip) != null ? m : j.tooltip, {
    className: Ee(pr.tooltip, (T = (I = X.tooltip) != null ? I : j.tooltip) == null ? void 0 : T.className)
  }), Xt), ws = rn($o, k({}, (w = X.arrow) != null ? w : j.arrow, {
    className: Ee(pr.arrow, (y = (p = X.arrow) != null ? p : j.arrow) == null ? void 0 : y.className)
  }), Xt);
  return /* @__PURE__ */ ue(E.Fragment, {
    children: [/* @__PURE__ */ E.cloneElement(re, De), /* @__PURE__ */ x(No, k({
      as: G ?? Ua,
      placement: q,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ ue(Ro, k({}, ys, {
          children: [ne, N ? /* @__PURE__ */ x($o, k({}, ws, {
            ref: Ge
          })) : null]
        }))
      }))
...
const jf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Bf = (e) => {
  ...
  const r = tt({
    ...
    titleAccess: h,
    viewBox: f = "0 0 24 24"
  } = r, b = de(r, jf), v = /* @__PURE__ */ E.isValidElement(o) && o.type === "svg", g = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
  ...
  return /* @__PURE__ */ ue(Lf, k({
    ...
    ownerState: g,
    children: [v ? o.props.children : o, h ? /* @__PURE__ */ x("title", {
      children: h
    }) : null]
  }));
});
...
function qa(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${t}Icon`), n.muiName = Ni.muiName, /* @__PURE__ */ E.memo(/* @__PURE__ */ E.forwardRef(n));
}
const Ff = {
  configure: (e) => {
...
}, Symbol.toStringTag, { value: "Module" })), zf = /* @__PURE__ */ ql(Vf);
var Pi;
function Uf() {
...
var Ga = mo.default = void 0, Wf = Hf(Uf()), qf = Ts;
Ga = mo.default = (0, Wf.default)(/* @__PURE__ */ (0, qf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Ri(e, t, n) {
  ...
  const {
    ...
    Vs,
    {
      ...
      children: n ? /* @__PURE__ */ ue(Kn, { children: [
        ...
        h ? /* @__PURE__ */ x(Li, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ x(Ga, {}) }) : Ri(s, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ x(_f, { title: r, placement: "right", children: /* @__PURE__ */ x("div", { children: T }) }) : T;
}
function Xa(e) {
...
function Gf(e) {
  const [t, n] = xe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (u) => {
    ...
    ), /* @__PURE__ */ x(bo, { ...e, includedGroups: u });
  };
  return /* @__PURE__ */ ue(Kn, { children: [
...
function bo(e) {
  ...
  }, [o, t]), l = ({ item: d, isLastItemInGroup: h }) => ({
  ...
  return /* @__PURE__ */ x("div", { role: "menu", "aria-label": u, children: i.map((d, h) => {
...
function Xf(e) {
  ...
  )), /* @__PURE__ */ x(bo, { ...e, includedGroups: i });
}
function Yf({
  commandHandler: e,
  menuDefinition: t,
...
const Ya = /* @__PURE__ */ E.createContext({});
...
const Qa = /* @__PURE__ */ E.forwardRef(function(t, n) {
  ...
  } = t, f = de(t, oh), b = E.useRef(null), v = E.useRef({
    keys: [],
    repeating: !0,
  ...
  const g = (w) => {
    const y = b.current, p = w.key, S = Te(y).activeElement;
    if (p === "ArrowDown")
      w.preventDefault(), tn(y, S, u, c, Sr);
    else if (p === "ArrowUp")
      w.preventDefault(), tn(y, S, u, c, $i);
    else if (p === "Home")
      w.preventDefault(), tn(y, null, u, c, Sr);
    else if (p === "End")
      w.preventDefault(), tn(y, null, u, c, $i);
    else if (p.length === 1) {
      ...
      const j = S && !N.repeating && Za(S, N);
      N.previousKeyMatched && (j || tn(y, S, !1, c, Sr, N)) ? w.preventDefault() : N.previousKeyMatched = !1;
    }
    d && d(w);
  }, m = Le(b, n);
  let T = -1;
  E.Children.forEach(s, (w, y) => {
    if (!/* @__PURE__ */ E.isValidElement(w)) {
      T === y && (T += 1, T >= s.length && (T = -1));
      return;
    }
...
`)), w.props.disabled || (h === "selectedMenu" && w.props.selected || T === -1) && (T = y), T === y && (w.props.disabled || w.props.muiSkipListHighlight || w.type.muiSkipListHighlight) && (T += 1, T >= s.length && (T = -1));
  });
  const I = E.Children.map(s, (w, y) => {
    if (y === T) {
      const p = {};
      return i && (p.autoFocus = !0), w.props.tabIndex === void 0 && h === "selectedMenu" && (p.tabIndex = 0), /* @__PURE__ */ E.cloneElement(w, p);
    }
    return w;
  });
  return /* @__PURE__ */ x(rh, k({
    role: "menu",
    ref: m,
    className: l,
    onKeyDown: g,
...
const ih = Qa, ah = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], sh = {
  ...
  } = t, w = de(t, ah), y = E.useRef(null), p = Le(y, l.ref, n), S = (F) => (D) => {
    if (F) {
      const M = y.current;
      D === void 0 ? F(M) : F(M, D);
    }
  ...
  return /* @__PURE__ */ x(I, k({
    ...
    children: (F, D) => /* @__PURE__ */ E.cloneElement(l, k({
      style: k({
        opacity: 0,
        visibility: F === "exited" && !u ? "hidden" : void 0
      }, sh[F], m, l.props.style),
      ref: p
    }, D))
  }));
});
...
const uh = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], dh = (e) => {
  ...
  const s = tt({
    ...
    component: u,
    invisible: f
  }), y = dh(w), p = (r = v.root) != null ? r : h.root;
  return /* @__PURE__ */ x(m, k({
    in: b,
    timeout: T
  }, I, {
    children: /* @__PURE__ */ x(ph, k({
      "aria-hidden": !0
    }, p, {
      as: (o = (i = g.root) != null ? i : d.Root) != null ? o : u,
      className: Ee(y.root, c, p == null ? void 0 : p.className),
...
const mh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], gh = (e) => {
  ...
  const G = (r = (o = F == null ? void 0 : F.root) != null ? o : T.Root) != null ? r : bh, W = (i = (s = F == null ? void 0 : F.backdrop) != null ? s : T.Backdrop) != null ? i : d, X = (l = $ == null ? void 0 : $.root) != null ? l : I.root, Y = (c = $ == null ? void 0 : $.backdrop) != null ? c : I.backdrop, ne = bt({
    elementType: G,
    externalSlotProps: X,
    ...
    ownerState: z,
    className: Ee(f, X == null ? void 0 : X.className, H == null ? void 0 : H.root, !z.open && z.exited && (H == null ? void 0 : H.hidden))
  }), _ = bt({
    elementType: W,
    externalSlotProps: Y,
    additionalProps: h,
    ...
    className: Ee(Y == null ? void 0 : Y.className, h == null ? void 0 : h.className, H == null ? void 0 : H.backdrop),
    ownerState: z
  });
  return !j && !R && (!K || U) ? null : /* @__PURE__ */ x(fn, {
    ref: O,
    container: g,
    disablePortal: S,
    children: /* @__PURE__ */ ue(G, k({}, ne, {
      children: [!L && d ? /* @__PURE__ */ x(W, k({}, _)) : null, /* @__PURE__ */ x(Vn, {
        disableEnforceFocus: y,
        disableAutoFocus: w,
        disableRestoreFocus: N,
        isEnabled: A,
...
const Ph = (e) => {
  ...
  const s = tt({
  ...
  } = s, j = de(s.TransitionProps, Sh), C = de(s, Ch), R = (r = y == null ? void 0 : y.paper) != null ? r : I, $ = E.useRef(), F = Le($, R.ref), D = k({}, s, {
    anchorOrigin: u,
    anchorReference: h,
    elevation: g,
    marginThreshold: m,
    ...
    TransitionProps: j
  }), M = Ph(D), V = E.useCallback(() => {
    if (h === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = Dn(c), P = J && J.nodeType === 1 ? J : Te($.current).body, re = P.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
  ...
  }, [c, u.horizontal, u.vertical, d, h]), Q = E.useCallback((J) => ({
    vertical: Mi(J, p.vertical),
    horizontal: Ii(J, p.horizontal)
  }), [p.horizontal, p.vertical]), Z = E.useCallback((J) => {
    const P = {
      width: J.offsetWidth,
    ...
    const lt = Oe + P.height, Se = me + P.width, Ge = jt(Dn(c)), $e = Ge.innerHeight - m, Ke = Ge.innerWidth - m;
    if (m !== null && Oe < m) {
      const we = Oe - m;
    ...
    if (process.env.NODE_ENV !== "production" && P.height > $e && P.height && $e && console.error(["MUI: The popover component is too tall.", `Some part of it can not be seen on the screen (${P.height - $e}px).`, "Please consider adding a `max-height` to improve the user-experience."].join(`
`)), m !== null && me < m) {
      const we = me - m;
  ...
  }, [c, h, V, Q, m]), [O, A] = E.useState(T), U = E.useCallback(() => {
    const J = $.current;
    if (!J)
      return;
    const P = Z(J);
  ...
  E.useEffect(() => (L && window.addEventListener("scroll", U), () => window.removeEventListener("scroll", U)), [c, L, U]);
  const K = (J, P) => {
    B && B(J, P), U();
  }, z = () => {
    A(!1);
  ...
  const q = v || (c ? Te(Dn(c)).body : void 0), G = (o = w == null ? void 0 : w.root) != null ? o : Rh, W = (i = w == null ? void 0 : w.paper) != null ? i : os, X = bt({
    elementType: W,
    ...
    ownerState: D,
    className: Ee(M.paper, R == null ? void 0 : R.className)
  }), Y = bt({
    elementType: G,
    ...
    ownerState: D,
    className: Ee(M.root, b)
  }), {
    slotProps: ne
  } = Y, _ = de(Y, Nh);
  return /* @__PURE__ */ x(G, k({}, _, !va(G) && {
    slotProps: ne,
    disableScrollLock: L
  }, {
...
const Ih = ["onEntering"], _h = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Ah = {
  ...
  const i = tt({
    ...
    slots: I = {},
    slotProps: w = {}
  } = i, y = de(i.TransitionProps, Ih), p = de(i, _h), S = Tn(), N = S.direction === "rtl", B = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: y,
    variant: T
  }), L = jh(B), j = s && !u && f, C = E.useRef(null), R = (Z, O) => {
    C.current && C.current.adjustStyleForScrollbar(Z, S), m && m(Z, O);
  }, $ = (Z) => {
    Z.key === "Tab" && (Z.preventDefault(), h && h(Z, "tabKeyDown"));
  };
  let F = -1;
  E.Children.map(l, (Z, O) => {
    /* @__PURE__ */ E.isValidElement(Z) && (process.env.NODE_ENV !== "production" && Ln.isFragment(Z) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), Z.props.disabled || (T === "selectedMenu" && Z.props.selected || F === -1) && (F = O));
  });
  const D = (r = I.paper) != null ? r : Lh, M = (o = w.paper) != null ? o : b, V = bt({
    elementType: I.root,
  ...
  return /* @__PURE__ */ x(Bh, k({
    onClose: h,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: N ? "right" : "left"
    },
    transformOrigin: N ? Ah : Dh,
    slots: {
      paper: D,
      root: I.root
    },
    ...
    children: /* @__PURE__ */ x(Fh, k({
      ...
      className: Ee(L.list, d.className),
      children: l
    }))
  }));
});
...
function bm({
  ...
  var u;
  const [o, i] = It.useState(void 0), s = Ne(
    (d) => {
      d.preventDefault(), i(
        o === void 0 ? {
          mouseX: d.clientX + 2,
...
function Hh({
  ...
  const [c, u] = xe(!1), [d, h] = xe(!1), f = Ne(() => {
    c && u(!1), h(!1);
  }, [c]), b = Ne((y) => {
    y.stopPropagation(), u((p) => {
      const S = !p;
      return S && y.shiftKey ? h(!0) : S || h(!1), S;
    });
  }, []), v = Ne(
    (y) => (f(), r(y)),
    [r, f]
  ...
  const [T] = Hr(
    ...
    Ne(async () => (e == null ? void 0 : e(!0)) ?? n ?? T, [e, n, T, c]),
    n ?? T
  ), w = d && I ? I : T;
  return /* @__PURE__ */ ue(Kn, { children: [
    /* @__PURE__ */ x(
...
), ss = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  zi.Root,
  {
    ref: n,
    className: ye(Wh(), e),
...
function ym({ scrRef: e, handleSubmit: t, id: n }) {
  const r = (c) => {
    ...
    const h = { bookNum: ie.bookIdToNumber(u.bookId), chapterNum: 1, verseNum: 1 };
    r(h);
  }, i = (c) => {
    t({ ...e, chapterNum: +c.target.value });
  }, s = (c) => {
    t({ ...e, verseNum: +c.target.value });
  }, l = wt(() => Nr()[e.bookNum - 1], [e.bookNum]);
  return /* @__PURE__ */ ue("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    ...
    /* @__PURE__ */ x(Tt, { onClick: () => t(Ao(e, 1)), children: ">" })
  ] });
}
class qh {
  constructor() {
...
class wm {
  constructor(t, n, r) {
    ...
    this.data = t, this.resultsUpdated = new qh();
  }
  updateData(t) {
    this.data = t;
...
const _t = "scrBook", Gh = "scrRef", jn = "source", Kh = "details", Xh = "Scripture Reference", Yh = "Scripture Book", ls = "Type", Jh = "Details";
function Zh(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ie.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === _t ? fr(o.start) : void 0;
      },
      getGroupingValue: (r) => r.start.bookNum,
      sortingFn: (r, o) => Do(r.original.start, o.original.start),
      enableGrouping: !0
    },
    {
...
function xm({
  ...
  const [l, c] = xe([]), [u, d] = xe([{ id: _t, desc: !1 }]), [h, f] = xe(() => e.flatMap((y) => {
  ...
  const b = wt(
    ...
    { label: `Group by ${m}`, value: [jn] },
    {
      label: `Group by ${g} and ${m}`,
      value: [_t, jn]
    },
    {
      label: `Group by ${m} and ${g}`,
      value: [jn, _t]
    }
  ], I = (y) => {
  ...
  return /* @__PURE__ */ ue("div", { className: "p-2", children: [
    ...
    !t && /* @__PURE__ */ x("select", { onChange: I, children: T.map((y) => /* @__PURE__ */ x("option", { value: JSON.stringify(y.value), children: y.label }, y.label)) }),
    /* @__PURE__ */ ue("table", { children: [
      t && /* @__PURE__ */ x("thead", { children: v.getHeaderGroups().map((y) => /* @__PURE__ */ x("tr", { children: y.headers.map((p) => /* @__PURE__ */ x("th", { colSpan: p.colSpan, children: p.isPlaceholder ? void 0 : /* @__PURE__ */ ue("div", { children: [
        ...
        " ",
        hr(p.column.columnDef.header, p.getContext())
      ] }) }, p.id)) }, y.id)) }),
              ...
              children: (() => p.getIsGrouped() ? /* @__PURE__ */ ue(
                "button",
                {
                  ...
                  children: [
                    y.getIsExpanded() ? "👇" : "👉",
                    " ",
                    hr(p.column.columnDef.cell, p.getContext()),
                    " (",
                    y.subRows.length,
                    ")"
                  ]
...
function Em({ onSearch: e, placeholder: t }) {
  ...
  return /* @__PURE__ */ x(qs, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ x(
    Gn,
    {
...
function Ai({ onRowChange: e, row: t, column: n }) {
  ...
  return (
    ...
    // eslint-disable-next-line no-type-assertion/no-type-assertion
    /* @__PURE__ */ x(Gn, { defaultValue: t[n.key], onChange: r })
  );
}
...
function Sm({
  ...
  const $ = wt(() => {
    const F = e.map((D) => typeof D.editable == "function" ? {
      ...
      renderEditCell: D.renderEditCell || Ai
    } : D.editable && !D.renderEditCell ? { ...D, renderEditCell: Ai } : D.renderEditCell && !D.editable ? { ...D, editable: !1 } : D);
    return d ? [{ ...ll, minWidth: h }, ...F] : F;
  }, [e, d, h]);
  return /* @__PURE__ */ x(
    sl,
    {
