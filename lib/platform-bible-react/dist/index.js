...
var Wt = (t, e, r) => Yi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as xe, a as Cr, C as Me, u as Do, T as $t, b as Pt, d as At, e as Vt, A as pe, P as je, f as tr, B as X, h as Be, i as Fe, j as Ue, k as ze, x as Xi, l as Ji, m as Zi, I as Qi, n as io, r as Ne, o as ts, p as _n, q as ia, s as sa, L as Et, R as so, t as Zr, D as ja, v as Ba, w as Fa, y as Ua, z as Nn, E as Hr, F as co, G as Cn, H as lo, J as Ze, K as Rr, M as Ke, N as He, O as qe, S as zr, Q as sr, U as es, V as Or, W as Qe, X as Ae, Z as er, Y as $e, _ as cr, $ as wo, a0 as uo, a1 as Qr, a2 as po, a3 as En, a4 as rs, a5 as as, a6 as os, a7 as Ka, a8 as Tn, a9 as ca, aa as ns, ab as Sn, ac as is, ad as ss, ae as cs, af as Mo, ag as ls, ah as ds, ai as ws, aj as Rn, ak as zn, al as ho, am as us, an as Dn, ao as Na, ap as Oo, aq as Ca, ar as ps, as as hs, at as gs, au as fs, av as ms, aw as Ir, ax as go, ay as vs, az as bs } from "./resizable-BTh0w_GD.js";
import { aA as Cg, aB as Eg, aC as Tg, aD as Sg, aE as Rg, aF as zg, aG as Dg, aH as Mg, aI as Og, aJ as Ig, aK as $g, aL as Pg, aM as Ag, aN as Vg, aO as Lg, aP as jg, aQ as Bg, aR as Fg, aS as Ug, aT as Kg, aU as Hg, aV as qg, aW as Gg, aX as Wg, aY as Yg, aZ as Xg, a_ as Jg, a$ as Zg, b0 as Qg, b1 as tf, b2 as ef, b3 as rf, b4 as af, b5 as of, b6 as nf, b7 as sf, b8 as cf, b9 as lf } from "./resizable-BTh0w_GD.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as It } from "@sillsdev/scripture";
import { Check as Ve, Clock as Io, ChevronsLeft as $o, ChevronsRight as Po, ChevronLeft as Ha, ChevronRight as qa, ArrowLeft as xs, ArrowRight as ys, ChevronDown as wr, BoldIcon as ks, ItalicIcon as _s, X as fo, AtSign as Mn, Pencil as Ns, Trash2 as Cs, ArrowUp as On, MoreHorizontal as Es, MailOpen as Ts, Mail as Ss, ChevronUp as Rs, FilterIcon as zs, ArrowLeftIcon as Ds, ChevronLeftIcon as Ms, ChevronRightIcon as Os, ArrowRightIcon as Is, Copy as In, Filter as $s, User as Ps, Link as As, CircleHelp as Vs, Undo as Ls, Redo as js, SquareX as $n, FunctionSquare as Pn, SquareSigma as An, Ban as Bs, AlertCircle as Ga, CircleCheckIcon as Fs, CircleXIcon as Us, CircleHelpIcon as Ks, ArrowUpIcon as Hs, ArrowDownIcon as qs, ScrollText as Gs, ChevronsUpDown as Ws, MenuIcon as Ys, Menu as Xs, EllipsisVertical as Js, MoreVertical as Zs } from "lucide-react";
import { Section as Ct, getChaptersForBook as Qs, formatScrRef as Se, formatReplacementString as Pe, getSectionForBook as qr, formatRelativeDate as tc, sanitizeHtml as mo, NumberFormat as Vn, formatBytes as ec, getCurrentLocale as rc, usfmMarkers as Nr, isPlatformError as ac, ABORTED as oc, getErrorMessage as nc, getFormatCallerFunction as ic, deepEqual as sc, isString as Ao, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as cc, getLocalizeKeyForScrollGroupId as Vo, formatReplacementStringToArray as Lo, collectUsjMarkers as lc } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as P, createContext as $r, useContext as la, useState as _, useEffect as Y, useCallback as L, useImperativeHandle as dc, useLayoutEffect as te, Component as wc, createElement as jo, Suspense as uc, forwardRef as Ln, useId as Bo, Fragment as da } from "react";
...
import { createEditor as Fn, $getRoot as Le, $createParagraphNode as Pr, $getSelection as ee, HISTORY_MERGE_TAG as vo, ParagraphNode as Un, TextNode as Kn, $getPreviousSelection as _c, $isRangeSelection as ke, $caretFromPoint as Nc, $getSiblingCaret as Hn, $getChildCaret as Cc, $getAdjacentChildCaret as Ec, $isChildCaret as Tc, $normalizeCaret as Sc, $setSelectionFromCaretRange as Rc, $getCollapsedCaretRange as zc, $getCaretInDirection as Fo, $splitAtPointCaretNext as Dc, $isTextPointCaret as Mc, $findMatchingParent as qn, $isElementNode as Dr, mergeRegister as De, getDOMTextNode as Oc, isHTMLElement as Ic, CLEAR_EDITOR_COMMAND as Gn, COMMAND_PRIORITY_EDITOR as bo, shallowMergeConfig as $c, defineExtension as de, safeCast as rr, createState as Pc, FORMAT_TEXT_COMMAND as Wn, $isNodeSelection as Yn, COMMAND_PRIORITY_LOW as Xn, RootNode as Ac, LineBreakNode as Vc, TabNode as Lc, $isEditorState as jc, createCommand as Bc, CLICK_COMMAND as Fc, isDOMNode as Uc, $getNodeFromDOMNode as Kc, $createNodeSelection as Hc, $setSelection as qc, $getEditor as Gc, DecoratorNode as Ya, $getState as Wc, toggleTextFormatType as Uo, TEXT_TYPE_TO_FORMAT as Yc, $setState as Xc, addClassNamesToElement as Jn, $create as Jc, $getNodeByKey as Zc, removeClassNamesFromElement as Qc, KEY_TAB_COMMAND as tl, $isBlockElementNode as el, $createRangeSelection as rl, $normalizeSelection__EXPERIMENTAL as al, OUTDENT_CONTENT_COMMAND as ol, INDENT_CONTENT_COMMAND as Ko, INSERT_TAB_COMMAND as nl, COMMAND_PRIORITY_CRITICAL as xo, $isDecoratorNode as il, $isParagraphNode as sl, $isTextNode as Xa, SELECTION_CHANGE_COMMAND as Zn, $insertNodes as cl } from "lexical";
...
import { Avatar as yo, Select as Jt, Checkbox as Ho, Slot as Ar, Tabs as he, Menubar as Ce, ContextMenu as Lt, Progress as qo, Slider as jr, Switch as Go } from "radix-ui";
import { useReactTable as ti, getFilteredRowModel as ml, getSortedRowModel as ei, getPaginationRowModel as vl, getCoreRowModel as ri, flexRender as Er, getGroupedRowModel as bl, getExpandedRowModel as xl } from "@tanstack/react-table";
...
function oi({
  ...
  const g = F(!1), f = () => {
    ...
    () => Cr(e, l),
    [e, l]
  ), N = !!p && !w, T = `${b} (${S})`, k = N ? h || `${T}, ${p}` : T, R = /* @__PURE__ */ u(
    Me,
    {
      ref: t,
      ...
      className: v(
        ...
        N && "tw:bg-muted/50 tw:text-muted-foreground/50"
      ),
      children: [
        c && /* @__PURE__ */ a(
          Ve,
        ...
        N && // Visible rather than hover-only: cmdk never moves DOM focus onto an item (the input keeps
...
function Dl({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: x
  } = Do(), [b, S] = _(!1), [N, T] = _(!1), k = F(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), R = n && e !== void 0, C = i ?? (e !== void 0 && !n);
  Y(() => {
    var O;
    zl();
    const Q = (O = k.current) == null ? void 0 : O.closest('button, [role="combobox"], [tabindex]');
    if (!Q) return;
    const E = (H) => !!H && H.scrollWidth > H.clientWidth, tt = () => {
      Qa !== "pointer" && (C || E(h.current) || E(l.current)) && T(!0);
    }, M = () => T(!1);
    return Q.addEventListener("focus", tt), Q.addEventListener("blur", M), () => {
      Q.removeEventListener("focus", tt), Q.removeEventListener("blur", M);
    };
  }, [C, h, l]);
  const j = L(() => {
    C && S(!0), f(), R && w();
  ...
  const z = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), K = R ? (
...
function Ml({
  ...
  const [h, g] = _(!1), f = w !== void 0, x = f ? w : h, b = (N) => {
    f || g(N), p == null || p(N);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(je, { open: x, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ a(Be, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(ze, { heading: i, children: t.map((N) => /* @__PURE__ */ u(
      Me,
      {
        onSelect: () => S(N),
...
function _p(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function to(t) {
  return {
    [Ct.OT]: t.filter((e) => It.isBookOT(e)),
    [Ct.NT]: t.filter((e) => It.isBookNT(e)),
    [Ct.DC]: t.filter((e) => It.isBookDC(e)),
    [Ct.Extra]: t.filter((e) => It.extraBooks().includes(e))
  };
}
function Vl(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), i = n.size === 0 ? t : It.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
  ), s = to(i), c = Object.values(s).flat(), l = to(t);
  return {
...
function ci({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(ze, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function Ra({
  ...
  const C = Ne(), j = Rl(), [D, z] = _(!1), [K, W] = _(""), [B, Q] = _(""), [E, tt] = _("books"), [M, O] = _(void 0), [H, ot] = _(
    void 0
  ), [at, wt] = _(void 0), [Ht, J] = _(!1), [st, ht] = _(!1), gt = F(null), ft = F(!1), kt = F(void 0), pt = F(void 0), qt = F(void 0), re = F(void 0), jt = F({}), Bt = F({}), mt = L(
    (y) => {
      e(y), l && l(y);
    },
    [e, l]
    ...
    projectBooksBySection: bt,
    reachableBooksBySection: Rt,
    reachableBooks: oe,
    projectBooks: ie,
    ...
    () => Vl(ae, ut),
    [ae, ut]
  ), ge = Gt.has(t.book), se = P(() => B.trim() ? to(
    oe.filter((y) => io(y, B, i))
  ) : st ? Rt : bt, [
    bt,
    Rt,
    oe,
  ...
  const Tt = L(() => {
    if ($) {
      const y = $.chapterNum ?? 1, et = $.verseNum ?? 1;
      if (p && Sa($.book, y, et, p))
        return;
      mt({
        book: $.book,
    ...
    (y) => {
      const et = H ?? ($ == null ? void 0 : $.book), rt = at ?? ($ == null ? void 0 : $.chapterNum);
      !et || !rt || (mt({
        book: et,
        chapterNum: rt,
        verseNum: y
    ...
    (y) => {
      const et = E === "chapters" ? M : $ == null ? void 0 : $.book;
      if (et) {
        if (w && w(et, y) > 1) {
          ot(et), wt(y), tt("verses"), W("");
          return;
        }
        mt({
          book: et,
    ...
    tt("books"), O(void 0), ot(void 0), wt(void 0), setTimeout(() => {
      pt.current && pt.current.focus();
    }, 0);
  }, []), ne = L(() => {
    const y = H;
    ot(void 0), wt(void 0), y ? (O(y), tt("chapters"), W("")) : Ut();
  }, [H, Ut]), zt = L(
    (y) => {
      z(y), y && (tt("books"), O(void 0), ot(void 0), wt(void 0), Q(""), ht(ge));
    },
    [ge]
  );
  Y(() => {
  ...
  const { otLong: U, ntLong: A, dcLong: G, extraLong: q } = {
    ...
    (y) => $ ? !!$.chapterNum && !y.toString().includes($.chapterNum.toString()) : !1,
    [$]
  ), Dt = P(
    () => Se(
      t,
      i ? xe(t.book, i) : "English"
    ),
    [t, i]
  ), _t = P(
    () => j >= Tr.TIGHT ? Cr(t.book, i) : xe(t.book, i),
    [t.book, i, j]
  ), St = `${t.chapterNum}:${t.verseNum}`, Nt = L((y) => (et) => {
    jt.current[y] = et;
  }, []), Mt = L((y) => (et) => {
    Bt.current[y] = et;
  }, []), Vr = P(
    () => $l(B),
    [B]
  ), fa = P(() => !w || !$ || !$.chapterNum || !Vr ? !1 : w($.book, $.chapterNum) > 0, [w, $, Vr]), ma = E === "books" && !Ht && !B.trim() && Gt.size > 0, Lr = L(
    (y) => p ? Yo(y, p) : !1,
    [p]
  ), vr = L(
    (y) => (et) => p ? Pl(y, et, p) : !1,
    ...
    (y, et) => (rt) => p ? Sa(y, et, rt, p) : !1,
    [p]
  ), br = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", We = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) || "Select verse", va = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", Ye = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", ba = L(
    (y) => Pe(Ye, {
      book: `${xe(y, i)} (${Cr(
        y,
        i
    ...
    [Ye, i]
  ), or = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", xa = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", ya = L(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), h && h.includes(y.key) && $ && $.chapterNum !== void 0 && $.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), Tt());
    },
    [h, $, Tt]
  ), ka = L(
    (y) => {
      var Te, V, Z;
      if (y.ctrlKey) return;
      const { isLetter: et, isDigit: rt } = Xo(y.key);
      if ((E === "chapters" || E === "verses") && (y.key === " " || y.key === "Enter")) {
        const ct = y.target instanceof HTMLElement ? y.target : void 0;
        if (!!(ct != null && ct.closest(
          'button, a, input, select, textarea, [role="button"]'
        ))) {
          y.stopPropagation();
          return;
        }
        const Kt = (Te = kt.current) == null ? void 0 : Te.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (Kt) {
          y.preventDefault(), y.stopPropagation(), Kt.click();
          return;
        }
      }
      if ((E === "chapters" || E === "verses") && (et || rt)) {
        y.preventDefault(), y.stopPropagation();
        return;
      }
      if (E === "chapters" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), Ut();
        return;
      }
      if (E === "verses" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), ne();
        return;
      }
      const Qt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key);
      if (E === "verses" && Qt) {
        const ct = H, vt = at;
        if (!ct || !vt || !w) return;
        const Kt = w(ct, vt);
        if (!Kt) return;
        (V = kt.current) == null || V.focus();
        const yt = (() => {
          if (!K) return 1;
          const xr = K.match(/:(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            yt !== 0 && (ve = yt > 1 ? yt - 1 : Kt);
            break;
          case "ArrowRight":
            yt !== 0 && (ve = yt < Kt ? yt + 1 : 1);
            break;
          case "ArrowUp":
            ve = yt === 0 ? Kt : Math.max(1, yt - Oe);
            break;
          case "ArrowDown":
            ve = yt === 0 ? 1 : Math.min(Kt, yt + Oe);
            break;
          default:
            return;
        }
        ve !== yt && (y.preventDefault(), y.stopPropagation(), W(
          `${ct} ${pe[ct] || ""} ${vt}:${ve}`
        ), setTimeout(() => {
          const xr = Bt.current[ve];
          xr && xr.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((E === "chapters" || E === "books" && $) && Qt) {
        const ct = E === "chapters" ? M : $ == null ? void 0 : $.book;
        if (!ct) return;
        E === "chapters" && ((Z = kt.current) == null || Z.focus());
        const vt = (() => {
          if (!K) return 1;
          const Oe = K.match(/(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            vt !== 0 && (yt = vt > 1 ? vt - 1 : Kt);
            break;
          case "ArrowRight":
            vt !== 0 && (yt = vt < Kt ? vt + 1 : 1);
            break;
          case "ArrowUp":
            yt = vt === 0 ? Kt : Math.max(1, vt - ve);
            break;
          case "ArrowDown":
            yt = vt === 0 ? 1 : Math.min(Kt, vt + ve);
            break;
          default:
            return;
        }
        yt !== vt && (y.preventDefault(), y.stopPropagation(), W(
          `${ct} ${pe[ct] || ""} ${yt}`
        ), setTimeout(() => {
          const Oe = jt.current[yt];
    ...
    if (y.key === "ArrowUp" || y.key === "ArrowDown") {
      (Qt = pt.current) == null || Qt.focus();
      return;
    }
    const { isLetter: et, isDigit: rt } = Xo(y.key);
    (et || rt) && (y.preventDefault(), Q((Te) => Te + y.key), pt.current.focus(), J(!1));
  }, []);
  return te(() => {
    const y = setTimeout(() => {
      if (D && E === "books" && qt.current && re.current) {
        const et = qt.current, rt = re.current, Qt = rt.offsetTop, Te = et.clientHeight, V = rt.clientHeight, Z = Qt - Te / 2 + V / 2;
        et.scrollTo({
          top: Math.max(0, Z),
          behavior: "smooth"
        }), W(si(t.book));
    ...
    if (E === "chapters" && M) {
      const y = M === t.book, et = y ? t.chapterNum : 1;
      W(
        `${M} ${pe[M] || ""} ${et}`
      ), setTimeout(() => {
        if (qt.current)
          if (y) {
            const rt = jt.current[t.chapterNum];
  ...
  }, [E, M, $, t.book, t.chapterNum]), te(() => {
    if (E === "verses" && H && at !== void 0) {
      const y = H === t.book && at === t.chapterNum, et = y ? t.verseNum : 1;
      W(
        `${H} ${pe[H] || ""} ${at}:${et}`
      ), setTimeout(() => {
        if (qt.current)
          if (y) {
            const rt = Bt.current[t.verseNum];
            rt && rt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            qt.current.scrollTo({ top: 0 });
        kt.current && kt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(je, { open: D, onOpenChange: zt, modal: N, children: [
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            Dl,
            {
              primary: _t,
              secondary: St,
              showSecondary: j < Tr.MINIMUM,
              isPartial: j >= Tr.TIGHT,
              fullText: Dt
            }
          ),
          x && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: et } = y;
          D && gt.current && et instanceof Node && gt.current.contains(et) && (ft.current = !0, zt(!1));
        },
        onCloseAutoFocus: S,
        children: /* @__PURE__ */ u(
          Fe,
          {
            ...
            shouldFilter: !1,
            children: [
              E === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: we.map(
                  ({ onClick: y, disabled: et, title: rt, icon: Qt }) => /* @__PURE__ */ a(
                    X,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: E === "verses" ? ne : Ut,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: C === "ltr" ? /* @__PURE__ */ a(xs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ys, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                E === "chapters" && M && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: xe(M, i) }),
                E === "verses" && H && at !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${xe(H, i)} ${at}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: E === "verses" ? We : br
                  }
                )
              ] }),
              !Ht && /* @__PURE__ */ u(Ue, { ref: qt, children: [
                E === "books" && /* @__PURE__ */ u(lt, { children: [
                  !$ && Object.entries(se).map(([y, et]) => {
                    if (et.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ze, { heading: nt(y), children: et.map((rt) => /* @__PURE__ */ a(
                          oi,
                          {
                            bookId: rt,
                            onSelect: (Qt) => ce(Qt),
                            section: qr(rt),
                            commandValue: `${rt} ${pe[rt]}`,
                            ref: rt === t.book ? re : void 0,
                            localizedBookNames: i,
                            disabled: Lr(rt),
                            dimmedReason: Gt.has(rt) ? va : void 0,
                            dimmedDescription: Gt.has(rt) ? ba(rt) : void 0
                          },
                          rt
                        )) }, y)
                      );
                  ...
                  $ && /* @__PURE__ */ a(ze, { children: /* @__PURE__ */ a(
                    Me,
                    {
                      value: `${$.book} ${pe[$.book]} ${$.chapterNum || ""}:${$.verseNum || ""})}`,
                      onSelect: Tt,
                      disabled: !!p && Sa(
                        $.book,
                        $.chapterNum ?? 1,
                  ...
                  $ && fa && $.chapterNum && w && /* @__PURE__ */ u(lt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${xe($.book, i)} ${$.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Zo,
                      {
                        ...
                        onVerseSelect: fe,
                        setVerseRef: Mt,
                        isVerseDisabled: ar($.book, $.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  $ && !fa && lr($.book) > 1 && /* @__PURE__ */ u(lt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: xe($.book, i) }),
                    ...
                    /* @__PURE__ */ a(
                      Jo,
                      {
                        ...
                        setChapterRef: Nt,
                        isChapterDimmed: xt,
                        isChapterDisabled: vr($.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                E === "chapters" && M && /* @__PURE__ */ a(
                  Jo,
                  {
                    bookId: M,
                    scrRef: t,
                    onChapterSelect: Ft,
                    setChapterRef: Nt,
                    isChapterDisabled: vr(M),
                    className: "tw:p-4"
                  }
                ),
                E === "verses" && H && at !== void 0 && w && /* @__PURE__ */ a(
                  Zo,
                  {
                    bookId: H,
                    chapterNum: at,
...
function Qo({
  ...
  const [T, k] = _(!1), R = d ?? l, C = (D) => D.length > 0 && typeof D[0] == "object" && "options" in D[0], j = (D, z) => {
    const K = l(D), W = typeof D == "object" && "secondaryLabel" in D ? D.secondaryLabel : void 0, B = `${z ?? ""}${K}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Me,
      {
        value: K,
  ...
  return /* @__PURE__ */ u(je, { open: T, onOpenChange: k, ...N, children: [
    /* @__PURE__ */ a(tr, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          ...
          /* @__PURE__ */ a(Ue, { children: C(e) ? e.map((D) => /* @__PURE__ */ a(ze, { heading: D.groupHeading, children: D.options.map((z) => j(z, D.groupHeading)) }, D.groupHeading)) : /* @__PURE__ */ a(ze, { children: e.map((D) => j(D)) }) })
        ] })
      }
    )
  ] });
    ...
    so,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Et, { className: "tw:flex tw:items-center", children: o.map((b) => It.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ a(
            X,
            {
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fl = di ? te : Y, Fr = { tag: vo };
function Ul({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Bl(null, o), w = Fn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          case "string": {
            ...
            p.setEditorState(g, Fr);
            break;
          }
          case "object":
            p.setEditorState(h, Fr);
            break;
          case "function":
            p.update(() => {
              Le().isEmpty() && h(p);
...
const Kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : Y;
function Hl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return Kl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: l }) => {
      e && i.size === 0 && s.size === 0 || t && l.has(vo) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const ko = {
...
const Xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : Y;
function Jl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Zl() {
  return function(t) {
    const [e] = Ee(), r = P(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = F(o);
    return Xl(() => {
...
function rd(t, e, r) {
  ...
  function l() {
    ...
    for (let S = 0; S < g.length; S++) {
      const N = g[S], T = s[S] || document.createElement("div"), k = T.style;
      k.position !== "absolute" && (k.position = "absolute", b = !0);
      const R = ye(N.left - p);
      k.left !== R && (k.left = R, b = !0);
      const C = ye(N.top - h);
      k.top !== C && (T.style.top = C, b = !0);
      const j = ye(N.width);
      k.width !== j && (T.style.width = j, b = !0);
      const D = ye(N.height);
      k.height !== D && (T.style.height = D, b = !0), T.parentNode !== c && (c.append(T), b = !0), s[S] = T;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    d(), o = h, n = g, i = new MutationObserver((f) => {
      ...
      if (x !== o || b !== n) return p();
      for (const S of f) if (!c.contains(S.target)) return l();
    }), i.observe(g, ed), l();
  });
  return () => {
    w(), d();
...
function od(t, e = ad) {
  ...
  function d(w) {
    w.read(() => {
      const p = ee();
      if (!ke(p)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, g] = function(D) {
        const z = D.getStartEndPoints();
        return D.isBackward() ? [z[1], z[0]] : z;
      }(p), f = h.getNode(), x = f.getKey(), b = h.offset, S = g.getNode(), N = S.getKey(), T = g.offset, k = t.getElementByKey(x), R = t.getElementByKey(N), C = r === null || k !== o || b !== n || x !== r.getKey(), j = i === null || R !== s || T !== c || N !== i.getKey();
      if ((C || j) && k !== null && R !== null) {
        const D = function(z, K, W, B, Q, E, tt) {
          const M = (z._window ? z._window.document : document).createRange();
          return M.setStart(...tn(K, W, B)), M.setEnd(...tn(Q, E, tt)), M;
        }(t, h, f, k, g, S, R);
        l(), l = rd(t, D, e);
      }
      r = f, o = k, n = b, i = S, s = R, c = T;
    });
  }
...
function nd(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = od(t, e));
  };
...
function id(t) {
  const e = qn(t, (r) => Dr(r) && !r.isInline());
...
function sd(t) {
  ...
  const o = cd(t, r), n = Ec(o), i = Tc(n) ? Sc(n) : o;
  return Rc(zc(i)), t.getLatest();
}
function cd(t, e, r) {
  let o = Fo(e, "next");
  for (let n = o; n; n = Dc(n, r)) o = n;
  return Mc(o) && ta(283), o.insert(t.isInline() ? Pr().append(t) : t), Fo(Hn(t.getLatest(), "next"), e.direction);
}
function ld(t) {
  const e = ee();
  if (!ke(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = qn(i, (d) => Dr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function Xe(t, e) {
  Yt.call(this, void 0), this.x = t, this.s = void 0, this.g = Wr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function pd(t, e) {
  return new Xe(t, e);
}
...
function hd(t) {
  ...
  pi(this), it = t, this.f &= -2, 8 & this.f && No(this), pa();
}
function ir(t, e) {
...
function mr(t, e = {}) {
  const r = {};
  for (const o in t) {
    const n = e[o], i = Mr(n === void 0 ? t[o] : n);
    r[o] = i;
  }
  return r;
}
Yt.prototype.brand = dd, Yt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, hi(this), an(this), Re++;
  const t = it;
  return it = this, hd.bind(this, t);
...
de({ build: (t, e, r) => mr(e), config: rr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function gi() {
  const t = Le(), e = ee(), r = Pr();
  t.clear(), t.append(r), e !== null && r.select(), ke(e) && (e.format = 0);
}
function fi(t, e = gi) {
  return t.registerCommand(Gn, (r) => (t.update(e), !0), bo);
}
de({ build: (t, e, r) => mr(e), config: rr({ $onClear: gi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return _e(() => fi(t, o.value));
} });
function gd(t) {
...
de({ name: "@lexical/extension/DecoratorText", nodes: () => [mi], register: (t, e, r) => t.registerCommand(Wn, (o) => {
  const n = ee();
  if (Yn(n) || ke(n)) for (const i of n.getNodes()) fd(i) && i.toggleFormat(o);
  return !1;
}, Xn) });
function vi(t, e) {
  let r;
...
const ao = de({ build: (t) => vi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Co = 0, oo = 1, xi = 2, Oa = 3, Ur = 4, nr = 5, Ia = 6, kr = 7;
function $a(t) {
  return t.id === Co;
}
function yi(t) {
...
function md(t) {
  return function(e) {
    return e.id === oo;
  }(t) || dt(305, String(t.id), String(oo)), Object.assign(t, { id: xi });
}
...
class bd {
  ...
  init(e) {
    ...
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(c, l, d) {
      return Object.assign(c, { id: Ur, initResult: l, registerState: d });
    }(i, s, n);
  }
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ur && dt(307, String(r.id), String(nr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== kr && dt(309, String(o.id), String(kr)), this.state = function(s) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ia && dt(310, String(r.id), String(Ia)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Ur;
    }(e) || dt(313, String(e.id), String(Ur)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Oa;
    }(e) || dt(314, String(e.id), String(Oa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= kr;
    }(e) || dt(316, String(e.id), String(kr)), e;
  }
...
const yd = de({ config: rr({ setOptions: on, updateOptions: on }), init: ({ $initialEditorState: t = xd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (jc(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [Ac, Kn, Vc, Lc, Un] }), nn = Symbol.for("@lexical/extension/LexicalBuilder");
function sn() {
}
function kd(t) {
  throw t;
...
class dr {
  ...
  static fromExtensions(e) {
    const r = [Kr(yd)];
    for (const o of e) r.push(Kr(o));
    return new dr(r);
  }
  static maybeFromEditor(e) {
    const r = e[nn];
    return r && (r.PACKAGE_VERSION !== Pa && dt(292, r.PACKAGE_VERSION, Pa), r instanceof dr || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      $a(i) || dt(300, s, n || "[unknown]"), $a(c = i) || dt(304, String(c.id), String(Co)), i = Object.assign(c, { id: oo }), o.state = i;
      const l = this.outgoingConfigEdges.get(s);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = md(i), o.state = i, e.push(o);
    };
...
const _d = /* @__PURE__ */ new Set(), cn = de({ build(t, e, r) {
  const o = r.getDependency(ao).output, n = Mr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = vi(() => {
  }, () => _e(() => {
  ...
  return { watchNodeKey: function(s) {
    const c = pd(() => (i.value || _d).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
...
de({ dependencies: [ao, cn], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(cn).output, n = Mr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return De(t.registerCommand(Nd, (s) => {
    const c = ee();
    if (!ke(c)) return !1;
    ...
    return !1;
  }, Xn), t.registerMutationListener(ur, (s, c) => {
    wd(() => {
      let l = !1;
    ...
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(_e(() => {
      const d = c.value;
      d && (l.value ? Jn(d, i) : Qc(d, i));
    }));
    return De(...s);
  }));
} });
de({ build: (t, e) => mr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: rr({ $getParentEditor: function() {
  const t = Gc();
...
de({ build: (t, e, r) => mr(e), config: rr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return _e(() => {
...
function Td(t, e, r = ki) {
  return De(t.registerCommand(tl, (o) => {
    ...
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => el(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = id(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = rl();
      ...
      return !1;
    }(n) ? o.shiftKey ? ol : Ko : nl;
    return t.dispatchCommand(i, void 0);
  }, bo), t.registerCommand(Ko, () => {
...
de({ build: (t, e, r) => mr(e), config: rr({ $canIndent: ki, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return _e(() => {
    if (!o.value) return Td(t, n, i);
  });
} });
const Sd = de({ name: "@lexical/react/ReactProvider" });
function Rd() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ke(f)) {
                const x = f.anchor;
                let b = x.getNode(), S = 0, N = 0;
                if (Xa(b) && d >= 0 && w >= 0 && (S = d, N = d + w, f.setTextNodeRange(b, S, b, N)), S === N && p === "" || (f.insertRawText(p), b = x.getNode()), Xa(b)) {
                  S = h, N = h + g;
                  const T = b.getTextContentSize();
                  S = S > T ? T : S, N = N > T ? T : N, f.setTextNodeRange(b, S, b, N);
                }
...
de({ build: (t, e, r) => mr(e), config: rr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => _e(() => r.getOutput().disabled.value ? void 0 : Ni(t)) });
function Md(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const To = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : Y;
function Od({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, i] = _(() => r.getDecorators());
    return To(() => r.registerDecoratorListener((s) => {
      ul(() => {
        i(s);
      });
    }), [r]), Y(() => {
...
function $d({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    To(() => De(wl(n), Ni(n)), [n]);
  }(o), u(lt, { children: [t, a(Pd, { content: e }), a(Id, { editor: o, ErrorBoundary: r })] });
}
...
const Vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : Y;
function Ld({ onClear: t }) {
  const [e] = Ee();
  return Vd(() => fi(e, t), [e, t]), null;
}
const Ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : Y;
function jd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: x, role: b = "textbox", spellCheck: S = !0, style: N, tabIndex: T, "data-testid": k, ...R }, C) {
  const [j, D] = _(t.isEditable()), z = L((W) => {
    W && W.ownerDocument && W.ownerDocument.defaultView ? t.setRootElement(W) : t.setRootElement(null);
  }, [t]), K = P(() => /* @__PURE__ */ function(...W) {
    return (B) => {
      for (const Q of W) typeof Q == "function" ? Q(B) : Q != null && (Q.current = B);
    };
  }(C, z), [z, C]);
  return Ci(() => (D(t.isEditable()), t.registerEditableListener((W) => {
    D(W);
  })), [t]), a("div", { "aria-activedescendant": j ? e : void 0, "aria-autocomplete": j ? r : "none", "aria-controls": j ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": j && b === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": j ? p : void 0, "aria-readonly": !j || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: j, "data-testid": k, id: x, ref: K, role: b, spellCheck: S, style: N, tabIndex: T, ...R });
}
const Bd = Ln(jd);
function dn(t) {
  return t.getEditorState().read(_i(t.isComposing()));
...
function Ud(t, e) {
  ...
  return u(lt, { children: [a(Bd, { editor: n, ...o, ref: e }), r != null && a(Kd, { editor: n, content: r })] });
}
...
function Gd() {
  const [t, e] = _(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(ja, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ba, { children: [
      /* @__PURE__ */ a(Fa, { children: /* @__PURE__ */ a(Ua, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function Wd({
  ...
  const [e] = Ee(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Gd(), l = () => {
  };
...
function Zd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Wd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Xd, {}) }) }),
        ...
        children: /* @__PURE__ */ a(
          Ul,
          {
            ...
            children: /* @__PURE__ */ u($t, { children: [
              /* @__PURE__ */ a(Zd, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Hl,
                {
...
function tw(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = fl(e, n);
      Le().clear(), cl(i);
    },
    {
      discrete: !0
...
const ew = "verseText", Tp = Object.freeze([
...
function Sp({
  ...
  const [i, s] = _(rw), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  Y(() => {
    let b = !0;
    const S = h.current;
    if (!S) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : Ro(b) && (b.preventDefault(), b.stopPropagation(), le(i) && g());
        },
        onKeyDown: (b) => {
...
function pn({
  ...
  const g = L(
    ...
    const C = new Date(t.date), j = tc(
      C,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), D = C.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), b = P(() => t.user, [t.user]), S = P(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), N = P(() => mo(t.contents), [t.contents]), T = P(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), k = !!t.conflictResolutionAction && !T, R = P(() => {
    if (o && c)
      return /* @__PURE__ */ u(lt, { children: [
        /* @__PURE__ */ u(
          Ze,
          {
            onClick: (C) => {
              C.stopPropagation(), d(!0), p(tw(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(iw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(sw, { className: "tw:text-xs tw:font-medium", children: S }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : Ro(C) && (C.preventDefault(), C.stopPropagation(), le(w) && f());
              },
              onKeyDown: (C) => {
                So(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
          ...
          !l && /* @__PURE__ */ u(lt, { children: [
            t.status === "Resolved" && !k && /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: r["%comment_status_resolved%"] }),
        ...
        R && /* @__PURE__ */ u(Ke, { children: [
          /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Es, {}) }) }),
          /* @__PURE__ */ a(qe, { align: "end", children: R })
        ] })
      ]
    }
  );
...
function Pi({
  ...
  const [B, Q] = _(hn), [E, tt] = _(), [M, O] = _(), H = o, [ot, at] = _(!1), [wt, Ht] = _(!1), [J, st] = _(!1), [ht, gt] = _(!1), [ft, kt] = _(!1), [pt, qt] = _(k), [re, jt] = _(!1), Bt = F(void 0), [mt, ae] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let m = !0;
    return (async () => {
      const U = N ? await N(l) : !1;
      m && kt(U);
    })(), () => {
      m = !1;
    };
    ...
    let m = !0;
    if (!o) {
      gt(!1), ae(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const U = S ? await S(l) : !1;
      m && gt(U);
    })(), () => {
      m = !1;
    };
  ...
  Y(() => {
    if (!o) {
      ut.current !== "idle" && (tt(void 0), O(void 0), ut.current = "idle");
      return;
    }
    ut.current === "idle" && (ut.current = "pending"), ht ? ut.current === "pending" && j !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    j !== i && (tt(j), ut.current = "auto-populated") : ut.current === "auto-populated" && (tt(void 0), ut.current = "pending");
  }, [o, j, ht, i]);
  const bt = P(
    () => D ?? e.filter((m) => !m.deleted),
    [D, e]
  );
  Y(() => {
    let m = !0;
  ...
  const Rt = P(() => bt[0], [bt]), oe = F(null), ie = F(void 0), Gt = L(() => {
    var m;
    (m = ie.current) == null || m.call(ie), Q(hn);
  }, []), ge = L(() => {
    const m = !pt;
    qt(m), jt(!m), f == null || f(l, m);
  }, [pt, f, l]);
  Y(() => {
    at(!1);
  }, [o]), Y(() => {
    if (o && !pt && !re) {
      ...
      return Bt.current = m, () => clearTimeout(m);
    }
  ...
  }, [i, r]), Zt = P(() => bt.slice(1), [bt]), Tt = P(() => Zt.length ?? 0, [Zt.length]), fe = P(() => Tt > 0, [Tt]), ce = P(() => ot || Tt <= 2 ? Zt : Zt.slice(-2), [Zt, Tt, ot]), Ft = P(() => ot || Tt <= 2 ? 0 : Tt - 2, [Tt, ot]), me = P(
    () => Tt === 1 ? se.singleReply : Pe(se.multipleReplies, { count: Tt }),
    [Tt, se]
  ), we = P(
    () => Ft === 1 ? se.singleReply : Pe(se.multipleReplies, { count: Ft }),
    [Ft, se]
  );
  Y(() => {
    !o && wt && fe && Ht(!1);
  ...
  const Ut = L(
    async (m) => {
      ...
      I && await p({ threadId: l, contents: I }) && Gt();
    },
    [
      Gt,
      B,
    ...
    async (m) => {
      const I = le(B) ? oa(B) : void 0, U = m.status ? m.assignedUser : E ?? m.assignedUser, A = await p({
        ...m,
        contents: I,
        assignedUser: U
      });
      return A && (U !== void 0 && O(U), I && Gt()), A;
    },
    [Gt, B, p, E]
  );
  ...
  const zt = /* @__PURE__ */ a(
    pn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Ht,
      canEditOrDelete: (!wt && mt.get(Rt.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    ow,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ u(nw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            $ && /* @__PURE__ */ a(Rr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: $ }),
            /* @__PURE__ */ a(
              X,
              {
                variant: "ghost",
          ...
          /* @__PURE__ */ a("div", { className: "tw:flex tw:max-w-full tw:flex-wrap tw:items-baseline tw:gap-2", children: /* @__PURE__ */ u(
            "p",
            {
              ...
              className: v(
                ...
                {
                  "tw:overflow-visible tw:text-clip tw:whitespace-normal tw:break-words": H
                },
                { "tw:whitespace-nowrap": !H }
              ),
              children: [
                n && C ? /* @__PURE__ */ a(
                  X,
        ...
        /* @__PURE__ */ u(lt, { children: [
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            W && ce.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Ft > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (m) => {
                  m.stopPropagation(), at(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (m) => {
                  (m.key === "Enter" || m.key === " ") && (m.preventDefault(), m.stopPropagation(), at(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(zr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: we }),
                    ot ? /* @__PURE__ */ a(Rs, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            ce.map((m) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              pn,
              {
                comment: m,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Ht,
                canEditOrDelete: (!wt && mt.get(m.id)) ?? !1
              }
            ) }, m.id)),
            b !== !1 && (!wt || le(B)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (m) => {
                  Ro(m) && (m.preventDefault(), m.stopPropagation(), (le(B) || E !== void 0 && E !== M) && Ut());
                },
                onKeyDown: (m) => {
                  So(m), (m.key === "Enter" || m.key === " ") && m.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    aa,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    E !== void 0 && (le(B) || E !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Pe(
                    ...
                    /* @__PURE__ */ u(je, { open: J, onOpenChange: st, children: [
                      /* @__PURE__ */ a(tr, { asChild: !0, children: /* @__PURE__ */ a(
                        X,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Be,
                        {
                          ...
                          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ue, { children: x == null ? void 0 : x.map((m) => /* @__PURE__ */ a(
                            Me,
                            {
                              onSelect: () => {
                                tt(m !== i ? m : void 0), ut.current = "user-selected", O(void 0), st(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Yr(m, r) })
                            },
                            m || "unassigned"
                          )) }) })
                        }
...
), lw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Xr = (t) => lw(mo(t));
function Jr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function dw({
  ...
  const [s, c] = _("accept"), l = Bo(), d = Bo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = P(
    () => Xr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = P(
    () => Xr(t.acceptedText ?? ""),
    ...
    () => Xr(t.mergedText ?? ""),
    [t.mergedText]
  ), N = P(() => mo(t.contents), [t.contents]);
  if (!Oi(t))
    return /* @__PURE__ */ a(Jr, { html: N });
  const T = (M) => {
    c(M === "reject" || M === "merge" ? M : "accept");
  }, k = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", R = g ? [
    {
      value: "merge",
  ...
  let z;
  j ? z = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (z = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), B = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : W, Q = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(Jr, { html: S }) : W : B(M === "reject" ? t.rejectedResultText : t.resultText);
  }, E = (M) => p && M.value === "reject", tt = (M) => {
    const O = f === M.value, H = `${d}-${M.value}`, ot = E(M);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: l, className: "tw:sr-only", children: k }),
            /* @__PURE__ */ a(Jr, { html: M.html })
          ]
        },
        M.value
      )
      ...
      !w && !h && /* @__PURE__ */ u(lt, { children: [
        ...
        /* @__PURE__ */ a(
          so,
          {
            ...
            children: C.map((M) => E(M) ? /* @__PURE__ */ a($t, { delayDuration: 0, children: /* @__PURE__ */ u(Pt, { children: [
              /* @__PURE__ */ a(At, { asChild: !0, children: tt(M) }),
              /* @__PURE__ */ a(Vt, { children: k })
            ] }) }, M.value) : tt(M))
          }
        ),
    ...
    if (e === "Resolved") {
      for (let N = o.length - 1; N >= 0; N -= 1)
        if (o[N].status === "Resolved")
          return Ii(o[N].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function gw(t) {
  ...
  } = t, c = P(() => e.filter((S) => !S.deleted), [e]), l = P(
...
function Ap({
  ...
  const [N, T] = _(/* @__PURE__ */ new Set()), [k, R] = _(), [C, j] = _(), D = L(
    async (O) => {
      const H = await i(O);
      return H !== void 0 && O.assignedUser !== void 0 && O.assignedUser !== "" && j(O.assignedUser), H;
    },
    [i]
  );
  Y(() => {
    f && (T((O) => new Set(O).add(f)), R(f));
  }, [f]);
  const z = r.filter(
    (O) => O.comments.some((H) => !H.deleted)
  ), K = z.map((O) => ({ id: O.id })), W = L(
    (O) => {
      T((H) => new Set(H).add(O.id)), R(O.id), x == null || x(O.id);
    },
    [x]
  ), B = L(
    (O) => {
      ...
      T((ot) => {
        const at = new Set(ot);
        return at.has(O) ? at.delete(O) : at.add(O), at;
      }), R(O), x == null || x(H ? void 0 : O);
    },
    [N, x]
  ), { listboxRef: Q, activeId: E, handleKeyDown: tt } = es({
    options: K,
    onOptionSelect: W
  }), M = L(
    (O) => {
      O.key === "Escape" ? (k && N.has(k) && (T((H) => {
        const ot = new Set(H);
        return ot.delete(k), ot;
      }), R(void 0), x == null || x(void 0)), O.preventDefault(), O.stopPropagation()) : tt(O);
    },
    [k, N, tt, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: z.map((O) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: O.type === "Conflict" ? /* @__PURE__ */ a(gw, { ...H, conflictResolution: S }) : /* @__PURE__ */ a(Pi, { ...H })
          },
          O.id
        );
      })
...
function fw({ table: t }) {
  return /* @__PURE__ */ u(Ke, { children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(X, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function gr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Jt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Jt.Icon, { asChild: !0, children: /* @__PURE__ */ a(jn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ue({
  ...
  return /* @__PURE__ */ u(
    Jt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Jt.ItemIndicator, { children: /* @__PURE__ */ a(wa, { className: "tw:pointer-events-none" }) }) }),
...
function yw({
  ...
  var C;
  const [w, p] = _([]), [h, g] = _([]), [f, x] = _({}), [b, S] = _({}), N = P(() => e ?? [], [e]), T = ti({
    data: N,
    columns: t,
    getCoreRowModel: ri(),
  ...
  let R;
  return l ? R = Array.from({ length: 10 }).map((z, K) => `skeleton-row-${K}`).map((z) => /* @__PURE__ */ a($e, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((C = T.getRowModel().rows) == null ? void 0 : C.length) > 0 ? R = T.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    $e,
    {
      onClick: () => s(j, T),
      "data-state": j.getIsSelected() && "selected",
      children: j.getVisibleCells().map((D) => /* @__PURE__ */ a(cr, { children: Er(D.column.columnDef.cell, D.getContext()) }, D.id))
    },
    j.id
  )) : R = /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(fw, { table: T }),
    /* @__PURE__ */ u(wo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: T.getHeaderGroups().map((j) => /* @__PURE__ */ a($e, { children: j.headers.map((D) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: D.isPlaceholder ? void 0 : Er(D.column.columnDef.header, D.getContext()) }, D.id)) }, j.id)) }),
      /* @__PURE__ */ a(po, { children: R })
    ] }),
...
function jp({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(yl, { options: i, children: e })
    }
  );
}
...
function Fp({
  ...
  return /* @__PURE__ */ u(je, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Be, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Up({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ke, { children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(X, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(qe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(En, { children: d.itemType === 0 ? /* @__PURE__ */ a(lt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ae,
        {
          checked: o[w][h],
      ...
      return /* @__PURE__ */ u(Rr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          X,
          {
            ...
            children: /* @__PURE__ */ a(fo, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function Tw({
  ...
  const l = lo(), d = fn(n, "%undoButton_tooltip%"), w = fn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(co, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(At, { asChild: !0, children: /* @__PURE__ */ a(
        X,
...
function Sw({
  ...
  return Y(() => {
    var l;
    const i = lo(), s = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
const Rw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(lt, { children: [
...
function zw({
  ...
  const i = F(!1), s = F(null), c = F(null), l = F(!1), [d, w] = _(t), [p, h] = _(e), [g, f] = _(!1), x = F(!1), b = F(d);
  b.current = d;
  const S = F(p);
  S.current = p, Y(() => {
    w(t);
  ...
  const N = (k) => {
    if (l.current = !1, f(k), !k) {
      const R = b.current, C = S.current;
      R !== "custom" || C ? (R !== t || C !== e) && (i.current = !0, r(R, C)) : (w(t), h(e));
    }
  }, T = (k) => {
    var R, C, j, D;
    k.stopPropagation(), document.activeElement === c.current && k.key === "ArrowDown" || k.key === "ArrowRight" ? ((R = s.current) == null || R.focus(), l.current = !0) : document.activeElement === s.current && k.key === "ArrowUp" ? ((C = c.current) == null || C.focus(), l.current = !1) : document.activeElement === s.current && k.key === "ArrowLeft" && ((j = s.current) == null ? void 0 : j.selectionStart) === 0 && ((D = c.current) == null || D.focus(), l.current = !1), d === "custom" && k.key === "Enter" && (document.activeElement === c.current || document.activeElement === s.current) && N(!1);
  };
  return /* @__PURE__ */ u(Ke, { open: g, onOpenChange: N, children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(At, { asChild: !0, children: /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: Rw(t, o, e) }) }) }),
    ...
    /* @__PURE__ */ u(
      qe,
      {
        style: { zIndex: Tn },
        onEscapeKeyDown: () => {
          b.current = t, S.current = e, w(t), h(e);
        },
        onCloseAutoFocus: (k) => {
          i.current && (i.current = !1, k.preventDefault(), n());
        },
        onClick: () => {
        ...
        onMouseMove: () => {
          var k;
          l.current && ((k = s.current) == null || k.focus());
        },
        children: [
          ...
          /* @__PURE__ */ a(
            Ae,
            {
              ...
              onClick: (k) => {
                var R;
                if (k.stopPropagation(), x.current && k.target !== s.current) {
                  N(!1);
                  return;
                }
                l.current = !0, (R = s.current) == null || R.focus();
              },
              ...
              children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ a(
                  ca,
                  {
                    tabIndex: 0,
                    onMouseDown: (k) => {
                      k.stopPropagation(), w("custom"), l.current = !0;
                    },
                    ref: s,
...
const Dw = (t, e) => t === "f" ? /* @__PURE__ */ u(lt, { children: [
  /* @__PURE__ */ a(Pn, {}),
  " ",
...
function Ow({
  ...
  return /* @__PURE__ */ u(Ke, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(At, { asChild: !0, children: /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: Dw(t, r) }) }) }),
      /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ a("p", { children: Mw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(
      qe,
      {
  ...
  return /* @__PURE__ */ u(
    Me,
    {
      ...
      children: [
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a($w, { icon: t.icon }) }) }),
...
function Aw({
  ...
  return /* @__PURE__ */ u(Fe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ue, { children: [
      ...
      /* @__PURE__ */ a(ze, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          mn,
          {
...
function Vw(t, e, r, o, n) {
  if (!o || o === "p") return [];
  const i = Nr[o], s = i != null && i.children ? i : n && Nr[n];
  if (!s || !s.children) return [];
  const c = [];
  return Object.entries(s.children).forEach(([, l]) => {
    c.push(
      ...l.map((d) => ({
        marker: d,
        title: r[Nr[d].description] ?? Nr[d].description,
        action: () => {
          var w;
          (w = t.current) == null || w.insertMarker(d), e();
        }
      }))
    );
  }), c.sort((l, d) => (l.marker ?? l.title).localeCompare(d.marker ?? d.title));
}
function Lw(t) {
  return {
    id: t.marker,
...
function Gp({
  ...
  te(() => {
    if (!x.current) return;
    const { width: m } = x.current.getBoundingClientRect();
    m > 0 && (x.current.style.width = `${m}px`);
  }, []);
  const [b, S] = _("generated"), [N, T] = _("generated"), [k, R] = _("*"), [C, j] = _("*"), [D, z] = _("f"), [K, W] = _(!1), [B, Q] = _(!0), [E, tt] = _(!1), M = F(!1), O = F(""), [H, ot] = _(!1), [at, wt] = _(), [Ht, J] = _(), [st, ht] = _(), [gt, ft] = _(), kt = F(null), pt = F(
    void 0
  ), qt = F(0), re = F(void 0), jt = L(() => {
    var I, U, A;
    if ((I = h.current) != null && I.getSelection()) return;
    const m = re.current;
    m ? (U = h.current) == null || U.setSelection(m) : (A = h.current) == null || A.selectNote(0);
  }, []), Bt = L(() => {
    var m;
    jt(), (m = h.current) == null || m.focus();
  }, [jt]), mt = P(
    () => ({
      ...s,
  ...
  Y(() => {
    var m;
    H || (m = h.current) == null || m.focus();
  }, [D, H]);
  const ut = L(() => {
    var A, G, q;
    const m = (A = g.current) == null ? void 0 : A.querySelector(".editor-input"), I = m == null ? void 0 : m.querySelector("span.note"), U = (q = (G = g.current) == null ? void 0 : G.ownerDocument.getSelection()) == null ? void 0 : q.anchorNode;
    return !!I && !!U && I.contains(U);
  }, []);
  Y(() => {
    var G, q;
    let m, I, U;
    M.current = !1, re.current = void 0, Q(!0);
    const A = e == null ? void 0 : e.at(0);
    if (A && yr("note", A)) {
      const nt = (G = A.insert.note) == null ? void 0 : G.caller;
      let xt = "custom";
      nt === Ja ? xt = "generated" : nt === Za ? xt = "hidden" : nt && (R(nt), j(nt)), S(xt), T(xt), z(((q = A.insert.note) == null ? void 0 : q.style) ?? "f"), m = setTimeout(() => {
        var Dt, _t, St;
        (Dt = h.current) == null || Dt.applyUpdate([A]), (_t = h.current) == null || _t.selectNote(0), (St = h.current) == null || St.focus(), I = requestAnimationFrame(() => {
          U = setTimeout(() => {
            var Nt, Mt;
            ut() || ((Nt = h.current) == null || Nt.selectNote(0), (Mt = h.current) == null || Mt.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      m && clearTimeout(m), I !== void 0 && cancelAnimationFrame(I), U !== void 0 && clearTimeout(U);
    };
  }, [e, i, ut]);
  const bt = L(
    (m = !1) => {
      var U, A, G;
      p == null || p();
      const I = (A = (U = h.current) == null ? void 0 : U.getNoteOps(0)) == null ? void 0 : A.at(0);
      I && yr("note", I) && (r == null || r([I]), m && d && i && ((G = d.current) == null || G.replaceEmbedUpdate(i, [I])));
    },
    [i, r, p, d]
  ), Rt = L(
    (m) => {
      var U, A, G;
      const I = (U = h.current) == null ? void 0 : U.getSelection();
      (A = h.current) == null || A.applyUpdate([m, { delete: 1 }]), I && ((G = h.current) == null || G.setSelection(I)), Bt();
    },
    [Bt]
  ), oe = L(
    (m, I) => {
      var G, q;
      const U = (q = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : q.at(0);
      if (!U || !yr("note", U) || !U.insert.note) return;
      let A;
      m === "custom" ? A = I : m === "generated" ? A = Ja : A = Za, U.insert.note.caller !== A && (U.insert.note.caller = A, Rt(U));
    },
    [Rt]
  ), ie = L(() => {
    var m;
    pt.current || (m = h.current) == null || m.commitPendingMarkerEdits(), bt(!0), o();
  }, [o, bt]), Gt = F(ie);
  te(() => {
    Gt.current = ie;
  });
  const ge = F({ book: n.book, chapterNum: n.chapterNum });
  te(() => {
    (ge.current.book !== n.book || ge.current.chapterNum !== n.chapterNum) && (ge.current = { book: n.book, chapterNum: n.chapterNum }, Gt.current());
  }, [n.book, n.chapterNum]);
  const se = () => {
    var I;
    const m = (I = g.current) == null ? void 0 : I.getElementsByClassName("editor-input")[0];
    m != null && m.textContent && navigator.clipboard.writeText(m.textContent);
  }, $ = L(
    (m, I) => {
      p == null || p(), S(m), R(I), oe(m, I);
    },
    [oe, p]
  ), Zt = (m) => {
    var U, A, G, q;
    ...
    const I = (A = (U = h.current) == null ? void 0 : U.getNoteOps(0)) == null ? void 0 : A.at(0);
    if (I && yr("note", I)) {
      I.insert.note && (I.insert.note.style = m);
      const nt = (q = (G = I.insert.note) == null ? void 0 : G.contents) == null ? void 0 : q.ops;
      D !== "x" && m === "x" ? nt == null || nt.forEach((xt) => jw(xt)) : D === "x" && m !== "x" && (nt == null || nt.forEach((xt) => Bw(xt))), Rt(I);
    }
  }, Tt = (m) => {
    ft(m.contextMarker), tt(m.canRedo);
  }, fe = L(
    (m) => {
      var U, A, G, q, nt;
      const I = (A = (U = h.current) == null ? void 0 : U.getNoteOps(0)) == null ? void 0 : A.at(0);
      if (I && yr("note", I)) {
        ...
        const xt = (G = I.insert.note) == null ? void 0 : G.style, Dt = (nt = (q = I.insert.note) == null ? void 0 : q.contents) == null ? void 0 : nt.ops;
        if (xt || W(!1), W(
          xt === "x" ? !!(Dt != null && Dt.every((_t) => {
            var Nt, Mt;
            if (!((Nt = _t.attributes) != null && Nt.char)) return !0;
            const St = ((Mt = _t.attributes) == null ? void 0 : Mt.char).style;
          ...
          M.current = !0, O.current = JSON.stringify(I), Q(!0);
          return;
        }
        Q(JSON.stringify(I) === O.current), bt();
      } else
        W(!1), Q(!0);
    },
    [bt]
    ...
    if (f.current && ae.length && m && m.rangeCount > 0) {
      const I = m.getRangeAt(0).getBoundingClientRect(), U = f.current.getBoundingClientRect();
      wt(I.left - U.left), J(I.top - U.top), ht(I.height), ot(!0);
    }
  }, [ae, f]), Ft = F(() => {
  }), me = L(
    (m, I, U) => {
      const { anchorRect: A } = m;
      if (!w || !A) return;
      const { passive: G } = U;
      ss({
        items: I,
        ...
        clearSessionIfCurrent: (q) => Mo(pt, q),
        ...
        applyItem: (q) => {
          var nt;
          return (nt = h.current) == null ? void 0 : nt.applyMarkerMenuSelection(q, {
            trigger: "backslash",
        ...
        onShowError: (q) => {
          (!ac(q) || q.code !== oc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${nc(q)}`
          );
        }
      });
    },
    ...
    var U;
    const m = (U = h.current) == null ? void 0 : U.getMarkerMenuContext();
    if (!m) return !1;
    const I = _l(mt.styleInfo ?? Nl, m);
    return I.length === 0 ? !1 : (me(m, I, { passive: !m.hasTextSelection }), !0);
  }, [me, mt.styleInfo]), Ut = L(
    (m) => {
      const I = pt.current;
      if (!I || !w) return;
      cs(m, I, {
        ...
        commitTyped: (A) => {
          var G;
          return (G = h.current) == null ? void 0 : G.commitTypedMarker(A);
        },
        commitTypedAndReopen: (A) => {
          var G;
          (G = h.current) == null || G.commitTypedMarker(A, { trailingSpace: !1 }), we();
        },
        commitTypedCloser: (A) => {
          var G;
          return (G = h.current) == null ? void 0 : G.commitTypedCloser(A);
        },
        commitItem: (A) => {
          var q;
          const G = I.items.find((nt) => nt.marker === A);
          G && ((q = h.current) == null || q.applyMarkerMenuSelection(G, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    const m = (I) => {
      var G, q;
      const U = (G = g.current) == null ? void 0 : G.querySelector(".editor-input");
      if (!U || I.target !== U) return;
      const A = (q = h.current) == null ? void 0 : q.getSelection();
      A && (re.current = A);
    };
    ...
    var m;
    H && ((m = kt.current) == null || m.focus());
  }, [H]), Y(() => {
    var U;
    const m = () => {
      var A;
      return ((A = g.current) == null ? void 0 : A.querySelector(".editor-input")) ?? void 0;
    };
    if (((U = mt.view) == null ? void 0 : U.markerMode) === "editable") {
      const A = (q) => {
        var Dt, _t, St, Nt;
        if (ds(q)) return;
        const nt = m();
        ...
        if (q.key === "Enter" && !ut()) {
          q.preventDefault(), q.stopPropagation(), (Dt = h.current) == null || Dt.selectNote(0), (_t = h.current) == null || _t.focus();
          return;
        }
        if (w && q.key === c) {
          if (!ut()) {
            q.preventDefault(), q.stopPropagation(), (St = h.current) == null || St.selectNote(0), (Nt = h.current) == null || Nt.focus();
            return;
          }
          we() && (q.preventDefault(), q.stopPropagation());
        }
      }, G = () => {
        var nt, xt;
        const q = m();
        !q || document.activeElement !== q || ut() || ((nt = h.current) == null || nt.selectNote(0), (xt = h.current) == null || xt.focus());
      };
      return document.addEventListener("keydown", A, { capture: !0 }), document.addEventListener("paste", G, { capture: !0 }), () => {
        document.removeEventListener("keydown", A, { capture: !0 }), document.removeEventListener("paste", G, { capture: !0 });
      };
    }
    const I = (A) => {
      const G = m();
      !H && G && document.activeElement === G && A.key === c ? (A.preventDefault(), ce()) : H && A.key === "Escape" && (A.preventDefault(), ot(!1));
    };
    ...
    ce,
    c,
    (zt = mt.view) == null ? void 0 : zt.markerMode,
    mt.styleInfo,
    w,
    we,
    ut
    ...
    const m = () => {
      var A, G, q;
      const I = ((A = g.current) == null ? void 0 : A.querySelector(".editor-input")) ?? void 0;
      if (!I || document.activeElement !== I) return;
      const U = document.getSelection();
      U && !U.isCollapsed || ut() || ((G = h.current) == null || G.selectNote(0), (q = h.current) == null || q.focus());
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Pt, { children: [
              ...
              /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ a("p", { children: ne }) })
            ] }) }) })
          ]
        }
      )
...
const Wp = Object.freeze([
  ...Iw,
  ...Object.entries(Nr).map(([, t]) => t.description).filter((t) => !!t),
...
function Hw({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: i }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    zo(t.marker, [s], o, !1),
    " "
  ] }), g = !!l, f = !!w, x = !!p, b = e === "horizontal" ? "horizontal" : "vertical", S = o ? "marker-visible" : "", N = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", T = v(b, S);
  return /* @__PURE__ */ u(lt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(lt, { children: Uw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Yp({
  ...
  const p = d ?? ic(r, void 0), h = (k, R) => {
    w == null || w(k, R, n);
  }, g = i ? r.findIndex((k) => k === i) : -1, [f, x] = _(g), b = (k, R, C) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), w == null || w(R, C, n);
          break;
      }
  }, S = (k) => {
    if (r.length)
      switch (k.key) {
        case "ArrowDown":
          k.preventDefault(), x((R) => Math.min(R + 1, r.length - 1));
          break;
        case "ArrowUp":
  ...
  Y(() => {
    var k;
    f >= 0 && f < N.current.length && ((k = N.current[f]) == null || k.focus());
  }, [f]);
  const T = i ? r.findIndex((k) => k === i) : -1;
  return Y(() => {
    var k;
    T < 0 || T >= N.current.length || (k = N.current[T]) == null || k.scrollIntoView({ block: "nearest" });
  }, [T, s]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Hw,
                      {
                        footnote: k,
                        layout: o,
                        formatCaller: () => p(k.caller, R),
                        showMarkers: c
                      }
                    )
                  }
                ),
                R < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(zr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, j)
            );
          })
        }
...
function Gw({
  ...
  return /* @__PURE__ */ u(wo, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(uo, { stickyHeader: !0, children: /* @__PURE__ */ u($e, { children: [
      /* @__PURE__ */ a(Qr, { children: n }),
      /* @__PURE__ */ a(Qr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(po, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      $e,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(cr, { children: Se(c.reference, "English") }),
          /* @__PURE__ */ a(cr, { className: o, children: qw(c.text) })
        ]
      },
...
const Ww = (t) => {
  ...
  return e ? e[1] : "";
}, Xw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", rh = Object.freeze([
...
function ah({
  ...
  const g = be(r, "%webView_inventory_all%"), f = be(r, "%webView_inventory_approved%"), x = be(r, "%webView_inventory_unapproved%"), b = be(r, "%webView_inventory_unknown%"), S = be(r, "%webView_inventory_scope_currentBook%"), N = be(r, "%webView_inventory_scope_chapter%"), T = be(r, "%webView_inventory_scope_verse%"), k = be(r, "%webView_inventory_filter_text%"), R = be(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = be(r, "%webView_inventory_no_results%"), [j, D] = _(!1), [z, K] = _("all"), [W, B] = _(""), [Q, E] = _([]), tt = P(() => {
    const J = t ?? [];
    return J.length === 0 ? [] : Zw(J, n, i);
  }, [t, n, i]), M = P(() => {
    if (j) return tt;
    const J = [];
    return tt.forEach((st) => {
      const ht = st.items[0], gt = J.find(
        (ft) => ft.items[0] === ht
      );
      gt ? (gt.count += st.count, gt.occurrences = gt.occurrences.concat(st.occurrences)) : J.push({
        items: [ht],
        count: st.count,
  ...
  }, [j, tt]), O = P(() => M.length === 0 ? [] : Jw(M, z, W), [M, z, W]), H = P(() => {
    var ht, gt;
    if (!j) return l;
  ...
  Y(() => {
    O.length === 0 ? E([]) : O.length === 1 && E(O[0].items);
  }, [O]);
  const ot = (J, st) => {
    st.setRowSelection(() => {
      const gt = {};
    ...
    if (M.length === 0 || Q.length === 0) return [];
    const J = M.filter((st) => sc(
      j ? st.items : [st.items[0]],
      Q
    ));
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(pr, { onValueChange: (J) => at(J), defaultValue: s, children: [
        /* @__PURE__ */ a(gr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(hr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(fr, { children: [
          /* @__PURE__ */ a(ue, { value: "book", children: S }),
          /* @__PURE__ */ a(ue, { value: "chapter", children: N }),
      ...
      o && /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Pt, { children: [
        /* @__PURE__ */ a(At, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Et, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? R })
        ] }) }),
        /* @__PURE__ */ a(Vt, { children: (o == null ? void 0 : o.checkboxText) ?? R })
      ] }) })
    ] }),
    ...
    Ht.length > 0 && /* @__PURE__ */ a("div", { className: "tw:m-1 tw:flex-1 tw:overflow-auto tw:rounded-md tw:border", children: /* @__PURE__ */ a(
      Gw,
      {
        classNameForText: p,
        occurrenceData: Ht,
...
const Qw = "16rem", tu = "3rem", Vi = Xt.createContext(void 0);
function ga() {
  const t = Xt.useContext(Vi);
  if (!t)
...
function eu({
  ...
  const [l, d] = Xt.useState(t), w = e ?? l, p = Xt.useCallback(
    ...
    [r, w]
  ), h = Xt.useCallback(() => p((T) => !T), [p]), g = w ? "expanded" : "collapsed", b = Ne() === "ltr" ? s : s === "primary" ? "secondary" : "primary", S = Xt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Vi.Provider, { value: S, children: /* @__PURE__ */ a(
    "div",
    {
...
function oh({ className: t, onClick: e, ...r }) {
...
function cu({
  ...
  const c = t ? Ar.Root : "button", { state: l } = ga(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(su({ variant: r, size: o }), i),
      ...s
    }
  );
...
function lu({
  ...
  return /* @__PURE__ */ a(
    ru,
    {
      ...
      children: /* @__PURE__ */ u(ou, { children: [
        /* @__PURE__ */ u(vn, { children: [
          /* @__PURE__ */ a(bn, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(xn, { children: /* @__PURE__ */ a(nu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(iu, { children: /* @__PURE__ */ a(
            cu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Ie = "scrBook", du = "scrRef", Je = "source", wu = "details", uu = "Scripture Reference", pu = "Scripture Book", Li = "Type", hu = "Details";
function gu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? It.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ie ? Se(n.start) : void 0;
      },
...
}, yn = (t) => `${fu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function vh({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Ie, desc: !1 }]), [g, f] = _({}), x = P(
    () => t.flatMap((z) => z.data.map((K) => ({
      ...K,
      source: z.source
    }))),
    [t]
  ...
  Y(() => {
    if (c) {
      const z = S.getSelectedRowModel().rowsById, K = Object.keys(z);
      if (K.length === 1) {
        const W = x.find((B) => yn(B) === K[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, x, c, S]);
  const N = n ?? pu, T = i ?? Li, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [Ie] },
    ...
    !z.getIsGrouped() && !z.getIsSelected() && z.getToggleSelectedHandler()(K);
  }, j = (z, K) => z.getIsGrouped() ? "" : v("banded-row", K % 2 === 0 ? "even" : "odd"), D = (z, K, W) => {
    if (!((z == null ? void 0 : z.length) === 0 || K.depth < W.column.getGroupedIndex())) {
      if (K.getIsGrouped())
        switch (K.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(mw, { children: k.map((z) => /* @__PURE__ */ a(ue, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(wo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(uo, { children: S.getHeaderGroups().map((z) => /* @__PURE__ */ a($e, { children: z.headers.filter((K) => K.column.columnDef.header).map((K) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Qr, { colSpan: K.colSpan, className: "tw:sticky top-0", children: K.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Er(K.column.columnDef.header, K.getContext())
        ] }) }, K.id)
      )) }, z.id)) }),
      /* @__PURE__ */ a(po, { children: S.getRowModel().rows.map((z, K) => {
        const W = Ne();
        return /* @__PURE__ */ a(
          $e,
          {
            ...
            className: v(j(z, K)),
            onClick: (B) => C(z, B),
            children: z.getVisibleCells().map((B) => {
              if (!(B.getIsPlaceholder() || B.column.columnDef.enableGrouping && !B.getIsGrouped() && (B.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  cr,
                  {
                    className: v(
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        type: "button",
                        children: [
                          z.getIsExpanded() && /* @__PURE__ */ a(wr, {}),
                          !z.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(qa, {}) : /* @__PURE__ */ a(Ha, {})),
                          " ",
                          Er(B.column.columnDef.cell, B.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function mu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [b, S] = _(!1), [N, T] = _(""), k = F(void 0), R = F(!1), C = P(
    () => zn(t),
    [t]
  ), j = P(() => {
    if (!N.trim()) {
    ...
    (E, tt = !1) => {
      if (!tt || !k.current) {
        r(
          e.includes(E) ? e.filter((wt) => wt !== E) : [...e, E]
        ), k.current = E;
        return;
      }
      const M = C.findIndex((wt) => wt === k.current), O = C.findIndex((wt) => wt === E);
      if (M === -1 || O === -1) return;
      const [H, ot] = [
        Math.min(M, O),
        Math.max(M, O)
      ], at = C.slice(H, ot + 1).map((wt) => wt);
      r(
        e.includes(E) ? e.filter((wt) => !at.includes(wt)) : [.../* @__PURE__ */ new Set([...e, ...at])]
      );
    },
    [e, r, C]
  ), z = (E) => {
    D(E, R.current), R.current = !1;
  }, K = (E, tt) => {
    E.preventDefault(), D(tt, E.shiftKey);
  }, W = () => {
    r(C.map((E) => E));
  }, B = () => {
    r([]);
    ...
    () => Object.values(Ct).filter(
      (E) => (i == null ? void 0 : i[E]) !== void 0 && ho(C, E).length === 0
    ).map((E) => ({ section: E, explanation: i == null ? void 0 : i[E] })),
    [i, C]
  );
  return /* @__PURE__ */ u(
    je,
          ...
          Be,
          {
            ...
            children: /* @__PURE__ */ u(
              Fe,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (E) => {
                  E.key === "Enter" && (R.current = E.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    ia,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(X, { variant: "ghost", size: "sm", onClick: B, children: w })
                  ] }),
                  /* @__PURE__ */ u(Ue, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(sa, { children: p }),
                    Object.values(Ct).filter((E) => j[E].length > 0).map((E, tt) => {
                      const M = j[E];
                      return /* @__PURE__ */ u(da, { children: [
                        tt > 0 && /* @__PURE__ */ a(Sn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          ze,
                          {
                            heading: _n(E, h, g, f, x),
                  ...
                  Q.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Q.map(({ section: E, explanation: tt }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: tt }, E)) })
                ]
              }
            )
          }
...
function xu({
  ...
  const s = ho(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    X,
    {
      variant: "outline",
      size: "sm",
...
function xh({
  ...
  const R = Ot(
    s,
    "%webView_scope_selector_selected_text%"
  ), C = Ot(s, "%webView_scope_selector_verse%"), j = Ot(s, "%webView_scope_selector_chapter%"), D = Ot(s, "%webView_scope_selector_book%"), z = Ot(
    s,
    "%webView_scope_selector_current_verse%"
  ), K = Ot(
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = Ot(s, "%webView_scope_selector_current_book%"), B = Ot(s, "%webView_scope_selector_choose_books%"), Q = Ot(s, "%webView_scope_selector_scope%"), E = Ot(s, "%webView_scope_selector_select_books%"), tt = Ot(s, "%webView_scope_selector_range%"), M = Ot(s, "%webView_scope_selector_select_range%"), O = Ot(s, "%webView_scope_selector_range_start%"), H = Ot(s, "%webView_scope_selector_range_end%"), ot = Ot(s, "%webView_scope_selector_ok%"), at = Ot(s, "%webView_scope_selector_cancel%"), wt = Ot(s, "%webView_scope_selector_navigate%"), Ht = (V) => {
    if (!x) return;
    const Z = x.book.toUpperCase();
    switch (V) {
      case "verse":
        return Se(x, "id");
      case "chapter":
        return `${Z} ${x.chapterNum}`;
      case "book":
        return Z;
      default:
        return;
  ...
  ], st = (V, Z, ct = !1) => /* @__PURE__ */ u(lt, { children: [
    V,
    Z && !ct && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), ht = e ? J.filter((V) => e.includes(V.value)) : J, gt = x ?? Ta, ft = p ?? gt, kt = h ?? gt, pt = () => {
  }, qt = F(null), re = F(null), jt = F(!1), Bt = F(null), mt = F(!1), [ae, ut] = _(void 0), bt = F(!1), Rt = F(!1), oe = F(null), ie = L((V) => {
    if (V) {
      ut("start"), bt.current = !1;
      return;
    }
    ut((Z) => Z === "start" ? void 0 : Z), bt.current && (bt.current = !1, requestAnimationFrame(() => {
      var ct;
      const Z = (ct = qt.current) == null ? void 0 : ct.querySelector("button");
      Z == null || Z.click();
    }));
  }, []), Gt = L((V) => {
    if (V) {
    ...
    (V) => {
      g == null || g(V), f == null || f(V), bt.current = !0;
    },
    [g, f]
  ), se = L(
    (V) => {
      f == null || f(V), Rt.current = !0;
    },
    [f]
  ), $ = L(
    (V) => {
      r(V), V === "selectedBooks" && n.length === 0 && (x != null && x.book) && i([x.book]);
    },
    [r, n, x, i]
  ), Zt = ht.find((V) => V.value === t), Tt = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? cc(ft, kt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Zt ? st(Zt.label, Zt.scrRefSuffix) : t, fe = ht.filter(
    (V) => V.value !== "selectedBooks" && V.value !== "range"
  ), ce = ht.find((V) => V.value === "selectedBooks"), Ft = ht.find((V) => V.value === "range"), [me, we] = _(!1), [Ut, ne] = _(void 0), [zt, m] = _(void 0), [I, U] = _(void 0), [A, G] = _(void 0), [q, nt] = _([]), xt = w === "dropdown" && Ut === "selectedBooks", Dt = /* @__PURE__ */ a(
    yu,
    {
      availableBookInfo: o,
      selectedBookIds: xt ? q : n,
      onChangeSelectedBookIds: xt ? nt : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), _t = ae === "end", St = ae === "start", Nt = "tw:text-muted-foreground", Mt = w === "dropdown" && Ut === "range", Vr = Mt ? U : ge, ma = Mt ? G : f ? se : pt, Lr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: v(_t && Nt), children: O }),
      /* @__PURE__ */ a(
        Ra,
        {
    ...
    /* @__PURE__ */ u("div", { ref: qt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: v(St && Nt), children: H }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
          ...
          localizedStrings: S,
          getEndVerse: N,
          disableReferencesUpTo: Mt ? I ?? ft : ft,
          onOpenChange: Gt,
          onCloseAutoFocus: (V) => {
            var Z;
            Rt.current && (Rt.current = !1, V.preventDefault(), (Z = oe.current) == null || Z.focus());
          },
          className: v(St && Nt),
          modal: !0,
          align: "start"
  ...
  Y(() => {
    ...
    return () => {
      cancelAnimationFrame(Z), V && cancelAnimationFrame(V);
    };
  }, [me, t]);
  ...
  Y(() => {
    ...
    const V = new ResizeObserver(([Z]) => {
      _a(Z.contentRect.width < ya);
    });
    return V.observe(or), () => V.disconnect();
  }, [or]);
  const y = L(
    (V) => {
      m(V), U(ft), G(kt), nt(n), we(!1), ne(V);
    },
    [ft, kt, n]
  ), et = L(() => {
    zt !== void 0 && (zt === "range" ? (I && (g == null || g(I)), A && (f == null || f(A))) : zt === "selectedBooks" && i(q), $(zt), ne(void 0), m(void 0));
  }, [
    zt,
    I,
    A,
    ...
    V || (ne(void 0), m(void 0));
  }, []), Qt = L((V) => {
    var Z;
    V.preventDefault(), (Z = br.current) == null || Z.focus();
  }, []), Te = (V) => t === V ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !T && /* @__PURE__ */ a(Et, { children: Q }),
      w === "dropdown" ? /* @__PURE__ */ u(Ke, { open: me, onOpenChange: we, children: [
        /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
          X,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Tt() }),
              /* @__PURE__ */ a(wr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          qe,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: or, children: [
              fe.map(({ value: V, label: Z, dropdownLabel: ct, scrRefSuffix: vt, id: Kt }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: ar(V),
                  ...
                  children: [
                    t === V && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }),
                    st(ct ?? Z, vt, ka)
                  ]
                },
                Kt
              ...
              b && /* @__PURE__ */ u(lt, { children: [
                ...
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ...
                    onSelect: (V) => {
                      var Z, ct;
                      if (V.preventDefault(), jt.current) {
                        jt.current = !1;
                        return;
                      }
                      mt.current || (ct = (Z = re.current) == null ? void 0 : Z.querySelector("button")) == null || ct.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (V) => {
                          const Z = V.target instanceof HTMLElement ? V.target : void 0;
                          Z != null && Z.closest("button") && (jt.current = !0, requestAnimationFrame(() => {
                            jt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          Ra,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var Z;
                              V.preventDefault(), (Z = Bt.current) == null || Z.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(lt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Se(x ?? Ta, "id") }),
                              /* @__PURE__ */ a(wr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        so,
        {
          ...
          children: ht.map(({ value: V, label: Z, scrRefSuffix: ct, id: vt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: V, id: vt }),
            /* @__PURE__ */ a(Et, { htmlFor: vt, children: st(Z, ct) })
          ] }, vt))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && Lr,
    w === "dropdown" && ce && /* @__PURE__ */ a(ja, { open: Ut === "selectedBooks", onOpenChange: rt, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: ba,
        onCloseAutoFocus: Qt,
        onEscapeKeyDown: (V) => {
          Ye != null && Ye.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(Na, { container: Ye, children: [
          /* @__PURE__ */ a(Fa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ua, { children: B }) }),
          Dt,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => rt(!1), children: at }),
            /* @__PURE__ */ a(X, { onClick: et, children: ot })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Ft && /* @__PURE__ */ a(ja, { open: Ut === "range", onOpenChange: rt, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: va,
        onCloseAutoFocus: Qt,
        onEscapeKeyDown: (V) => {
          We != null && We.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(Na, { container: We, children: [
          /* @__PURE__ */ a(Fa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ua, { children: M }) }),
          Lr,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => rt(!1), children: at }),
            /* @__PURE__ */ a(X, { ref: oe, onClick: et, children: ot })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          fr,
          {
            ...
            style: { zIndex: er },
            children: t.map((w) => /* @__PURE__ */ a(ue, { value: `${w}`, children: l[Vo(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Pt, { children: [
...
function no({
  ...
  return /* @__PURE__ */ u(Ke, { variant: i, children: [
    /* @__PURE__ */ a(He, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(X, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ys, {}) }) }),
...
const Eu = Object.freeze([520, 420, 340]), Ui = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    const [n, i] = _(void 0), s = F(o);
    s.current = o;
    const c = L((p) => {
      i(p ?? void 0);
      const h = s.current;
      typeof h == "function" ? h(p) : h && (h.current = p);
    }, []), l = Fi(n, Eu), d = ii() ?? l, w = d >= Tr.MINIMUM;
...
function Ch({
  ...
  return /* @__PURE__ */ u(Ui, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      no,
      {
        onSelectMenuItem: t,
...
const Ki = Xt.forwardRef(({ className: t, ...e }, r) => {
  const o = Ne();
  return /* @__PURE__ */ a(
    he.Root,
    {
...
Ki.displayName = he.List.displayName;
const Hi = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.List,
  {
    ref: r,
    className: v(
...
const Tu = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
...
)), qi = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Content,
  {
    ref: r,
    className: v(
...
qi.displayName = he.Content.displayName;
function Th({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ki, { children: [
      /* @__PURE__ */ a(Hi, { children: t.map((c) => /* @__PURE__ */ a(Tu, { value: c.value, children: c.value }, c.key)) }),
  ...
  return /* @__PURE__ */ a(
    Ce.Trigger,
    {
      ...
      className: v(
        ...
        go({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
  ...
  return /* @__PURE__ */ a(
    Ce.Item,
    {
      ...
      className: v(
        ...
        // CUSTOM: Apply variant-driven styles from menu context
        go({ variant: n.variant, className: t })
      ),
      ...o
    }
  );
...
const _r = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Pt, { children: [
...
function Vu({
  ...
  const n = F(void 0), i = F(void 0), s = F(void 0), c = F(void 0), l = F(void 0), d = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (El(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), _r(s, [h, g]);
        break;
      case "alt+n":
        (b = c.current) == null || b.focus(), _r(c, [h, g]);
        break;
      case "alt+h":
        (S = l.current) == null || S.focus(), _r(l, [h, g]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(Su, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Ru, { children: [
      /* @__PURE__ */ a(Du, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        Mu,
        {
          style: { zIndex: er },
...
const Lu = Object.freeze([950, 800, 700]);
function Sh(t) {
  switch (t) {
    case void 0:
      return;
...
function zh({
  ...
  const d = ju(
    ...
    var S, N, T, k, R, C;
    const b = x !== f ? ((N = (S = t[f]) == null ? void 0 : S.uiNames) == null ? void 0 : N[x]) ?? ((k = (T = t[f]) == null ? void 0 : T.uiNames) == null ? void 0 : k.en) : void 0;
    return b ? `${(R = t[f]) == null ? void 0 : R.autonym} (${b})` : (C = t[f]) == null ? void 0 : C.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: Pe(d, {
...
function Mh({
  ...
  return /* @__PURE__ */ u(Fe, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
            ...
            d && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ke, { children: [
                  /* @__PURE__ */ a(He, { className: v(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    X,
                    {
...
function Ah({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = P(() => {
    const c = new Vn(o);
    return (l) => c.format(l);
...
function ug({
  ...
  return /* @__PURE__ */ a(
    he.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Gu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
const Yu = (t, e, r = {}) => {
  ...
  const [e, r] = _(!1), [o, n] = _(!1), [i, s] = _(0), c = F(void 0), l = P(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
...
function bg(t) {
  const e = P(() => lc(t).slice().sort().join(" "), [t]);
...
function kg({ value: t, children: e }) {
...
Zu(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Tp as CONFLICT_NOTE_STRING_KEYS,
  Di as CancelAcceptButtons,
  ow as Card,
  nw as CardContent,
  Ip as CardDescription,
  $p as CardFooter,
  Mp as CardHeader,
  Op as CardTitle,
  ...
  Sp as CommentEditor,
  Ap as CommentList,
  dw as ConflictNoteCard,
  Vh as ContextMenu,
  Wh as ContextMenuCheckboxItem,
  Kh as ContextMenuContent,
  jh as ContextMenuGroup,
  Hh as ContextMenuItem,
  Xh as ContextMenuLabel,
  Bh as ContextMenuPortal,
  Uh as ContextMenuRadioGroup,
  Yh as ContextMenuRadioItem,
  Jh as ContextMenuSeparator,
  Zh as ContextMenuShortcut,
  Fh as ContextMenuSub,
  Gh as ContextMenuSubContent,
  qh as ContextMenuSubTrigger,
  Lh as ContextMenuTrigger,
  yw as DataTable,
  Ih as DestructiveKeyConfirmation,
  ja as Dialog,
  Rg as DialogClose,
  Ba as DialogContent,
  zg as DialogDescription,
  Oo as DialogFooter,
  Fa as DialogHeader,
  Dg as DialogOverlay,
  Mg as DialogPortal,
  Ua as DialogTitle,
  Og as DialogTrigger,
  bu as DisabledActionTooltip,
  vu as DisabledTooltipWrapper,
  Qh as Drawer,
  eg as DrawerClose,
  rg as DrawerContent,
  ig as DrawerDescription,
  og as DrawerFooter,
  ag as DrawerHeader,
  qu as DrawerOverlay,
  Hu as DrawerPortal,
  ...
  ca as Input,
  Mh as InterfaceLanguagePicker,
  ah as Inventory,
  Ka as Kbd,
  Fg as KbdGroup,
  Et as Label,
  Iw as MARKER_MENU_STRING_KEYS,
  jp as MarkdownRenderer,
  Aw as MarkerMenu,
  Kp as MoreInfo,
  ...
  qg as ResizableHandle,
  Gg as ResizablePanel,
  Wg as ResizablePanelGroup,
  $h as ResultsCard,
  Yg as RetryableErrorView,
  bh as SCOPE_SELECTOR_STRING_KEYS,
  ku as SELECT_BOOKS_STRING_KEYS,
  Tr as SHRINK_STEP,
  xh as ScopeSelector,
  vh as ScriptureResultsViewer,
  yh as ScrollGroupSelector,
  Rn as SearchBar,
  pr as Select,
  yu as SelectBooks,
  mu as SelectBooksPicker,
  fr as SelectContent,
  mw as SelectGroup,
  ue as SelectItem,
  Vp as SelectLabel,
  bw as SelectScrollDownButton,
  vw as SelectScrollUpButton,
  ...
  lu as SettingsSidebar,
  mh as SettingsSidebarContentSearch,
  ua as ShrinkStepContext,
  kg as ShrinkStepOverride,
  ni as ShrinkStepOverrideContext,
  ru as Sidebar,
  ou as SidebarContent,
  ch as SidebarFooter,
  vn as SidebarGroup,
  dh as SidebarGroupAction,
  ...
  au as SidebarInset,
  nu as SidebarMenu,
  wh as SidebarMenuAction,
  uh as SidebarMenuBadge,
  cu as SidebarMenuButton,
  iu as SidebarMenuItem,
  ph as SidebarMenuSkeleton,
  hh as SidebarMenuSub,
  fh as SidebarMenuSubButton,
  gh as SidebarMenuSubItem,
  eu as SidebarProvider,
  nh as SidebarRail,
  lh as SidebarSeparator,
  oh as SidebarTrigger,
  sr as Skeleton,
  lg as Slider,
  cg as Sonner,
  Xg as Spinner,
  ...
  Qg as Z_INDEX_CONNECTION_LOST,
  tf as Z_INDEX_FIRST_RUN,
  ef as Z_INDEX_MODAL,
  rf as Z_INDEX_MODAL_BACKDROP,
  af as Z_INDEX_ONBOARDING_TOUR,
  of as Z_INDEX_OVERLAY,
  nf as badgeVariants,
  sf as buttonGroupVariants,
  cf as buttonVariants,
  v as cn,
  eh as getBookIdFromUSFM,
  Dp as getCommentThreadElementId,
  ha as getInventoryHeader,
  Qp as getLinesFromUSFM,
  th as getNumberFromUSFM,
  Xw as getStatusForItem,
  ...
  lo as isMacOs,
  lf as isWindows,
  Lw as markerMenuItemToPaletteItem,
  Ju as pickTabIconUrl,
  wf as sonner,
  gg as useEvent,
  fg as useEventAsync,
  bg as useExtraValidMarkers,
  es as useListbox,
  Yu as usePromise,
  _p as useRecentSearches,
  mg as useRetryablePromise,
  ...
  ga as useSidebar,
  vg as useStylesheet,
  yg as useTabIconSelection,
  Do as useTruncationTooltip,
  Xu as useViewVisibility
};
