...
import rt, { forwardRef as Rr, useRef as U, useMemo as B, useState as T, useCallback as j, useEffect as X, useLayoutEffect as ee, createContext as da, useContext as to, Component as is, createElement as Oo, Suspense as ss, Fragment as eo } from "react";
...
import { Slot as Ge, Dialog as pe, Popover as Sr, Label as ws, RadioGroup as Ra, Tooltip as sr, ToggleGroup as Tn, Separator as us, Avatar as ro, DropdownMenu as It, Select as Lt, Checkbox as Mo, Tabs as le, Menubar as xe, ContextMenu as Dt, Progress as Ao, Slider as Fr, Switch as Po } from "radix-ui";
import { cva as ye } from "class-variance-authority";
import { IconX as ps, IconCheck as er, IconSearch as gs, IconChevronRight as ao, IconChevronDown as hs, IconChevronUp as fs, IconSelector as ms, IconLayoutSidebar as vs, IconLayoutSidebarRight as bs, IconLoader as xs, IconAlertOctagon as ys, IconAlertTriangle as ks, IconInfoCircle as Ns, IconCircleCheck as _s } from "@tabler/icons-react";
...
const Or = 250, ei = 300, co = 400, yc = 450, kc = 500, Nc = 550, ri = ye(
...
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fc = wi ? ee : X, Kr = { tag: no };
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(f)) {
                ...
                if (ra(v) && c >= 0 && w >= 0 && (D = c, _ = c + w, f.setTextNodeRange(v, D, v, _)), D === _ && g === "" || (f.insertRawText(g), v = x.getNode()), ra(v)) {
                  D = m, _ = m + p;
...
function kw({
  ...
  const ft = j(
    ...
    async (R) => {
      const ut = ae(y) ? sa(y) : void 0, gt = R.status ? R.assignedUser : S ?? R.assignedUser, kt = await g({
        ...R,
        contents: ut,
        assignedUser: gt
      });
...
function $w({
  ...
  return d ? N = Array.from({ length: 10 }).map((b, S) => `skeleton-row-${S}`).map((b) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, b)) : ((E = z.getRowModel().rows) == null ? void 0 : E.length) > 0 ? N = z.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(_o, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Co, { stickyHeader: i, children: z.getHeaderGroups().map((I) => /* @__PURE__ */ a(Ve, { children: I.headers.map((y) => /* @__PURE__ */ a(la, { className: "tw:p-0", children: y.isPlaceholder ? void 0 : zr(y.column.columnDef.header, y.getContext()) }, y.id)) }, I.id)) }),
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(_o, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Co, { children: D.getHeaderGroups().map((b) => /* @__PURE__ */ a(Ve, { children: b.headers.filter((S) => S.column.columnDef.header).map((S) => (
        ...
        /* @__PURE__ */ a(la, { colSpan: S.colSpan, className: "tw:sticky top-0", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
...
function jg({
  ...
  ), yt = ot.find((A) => A.value === "selectedBooks"), ft = ot.find((A) => A.value === "range"), [Ct, R] = T(!1), [ut, gt] = T(void 0), [kt, Ke] = T(void 0), [Pe, br] = T(void 0), [qe, xr] = T(void 0), [yr, Pr] = T([]), jr = c === "dropdown" && ut === "selectedBooks", k = /* @__PURE__ */ a(
    ju,
    {
      availableBookInfo: o,
  ...
  const [te, He] = T(null), [Lr, Zi] = T(null), [Vr, Qi] = T(null), ts = 200, [es, rs] = T(!1);
  X(() => {
    if (!Vr || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([J]) => {
      rs(J.contentRect.width < ts);
    });
    return A.observe(Vr), () => A.disconnect();
  }, [Vr]);
  const Io = j(
    (A) => {
      Ke(A), br(st), xr(lt), Pr(n), R(!1), gt(A);
    },
    [st, lt, n]
  ), Do = j(() => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      c === "dropdown" ? /* @__PURE__ */ u(me, { open: Ct, onOpenChange: R, children: [
        ...
        /* @__PURE__ */ a(
          be,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ma, { container: Vr, children: [
    ...
    c === "dropdown" && yt && /* @__PURE__ */ a(Ga, { open: ut === "selectedBooks", onOpenChange: Br, children: /* @__PURE__ */ a(
      Ua,
      {
        ...
        onCloseAutoFocus: $o,
        onEscapeKeyDown: (A) => {
          Lr != null && Lr.querySelector('[data-state="open"]') && A.preventDefault();
        },
