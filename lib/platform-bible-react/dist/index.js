...
import { toast as gm } from "sonner";
...
const Qi = "data-platform-content-zoom-root", Th = "data-platform-content-zoom-scope", jw = "data-platform-content-zoom-label", ts = Dr(void 0);
function Sh({ area: t, children: e }) {
...
const eu = {
  ...
  var Ke;
  const rt = Mr(), [X, L] = N({}), J = ot ?? X, j = J.editorState ?? eu, W = J.assignedUser, ut = b !== void 0, mt = P(J);
  mt.current = J;
  const H = V(
    (R) => {
      ...
      children: Y.map((j) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: j.type === "Conflict" ? /* @__PURE__ */ a(lu, { ...W, conflictResolution: C }) : /* @__PURE__ */ a(ls, { ...W })
          },
          j.id
        );
      })
...
function Yh({
  ...
  const [x, g] = N("generated"), [C, E] = N("generated"), [T, k] = N("*"), [z, S] = N("*"), [M, I] = N("f"), [O, D] = N(!1), [Y, Z] = N(!0), [ot, b] = N(!1), rt = P(!1), X = P(""), [L, J] = N(!1), j = Nu(), [W, ut] = N(), mt = P(null), H = P(
    void 0
...
const Xu = "16rem", Ju = "3rem", ws = Jt.createContext(void 0);
function Fa() {
...
const He = "scrBook", cp = "scrRef", nr = "source", lp = "details", dp = "Scripture Reference", wp = "Scripture Book", us = "Type", up = "Details";
function pp(t, e) {
  const r = e ?? !1;
  return [
    {
...
const Np = Object.freeze([520, 420, 340]), vs = Jt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = ms(n, Np), l = Oi() ?? d, w = l >= Hr.MINIMUM;
...
function Rg({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(bs, { children: [
      /* @__PURE__ */ a(xs, { children: t.map((c) => /* @__PURE__ */ a(Cp, { value: c.value, children: c.value }, c.key)) }),
...
function $p({
  ...
  if (ld(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Ep, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: hs(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(Tp, { children: [
...
export {
  ...
  jw as CONTENT_ZOOM_LABEL_ATTRIBUTE,
