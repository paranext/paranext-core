...
import { c as m, g as me, a as _r, C as Se, u as Io, T as Dt, b as Mt, d as Ot, e as It, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Xi, l as Ji, m as Zi, I as Qi, n as io, r as ye, o as ts, p as En, q as la, s as da, L as Et, R as so, t as ea, D as ja, v as Ba, w as Fa, y as Ua, z as Tn, E as Hr, F as co, G as Sn, H as lo, J as Je, K as Er, M as je, N as Be, O as Fe, S as Tr, Q as nr, U as es, V as zr, W as Ze, X as Oe, Z as tr, Y as De, _ as ir, $ as wo, a0 as uo, a1 as ra, a2 as po, a3 as Rn, a4 as rs, a5 as as, a6 as os, a7 as Ka, a8 as zn, a9 as wa, aa as ns, ab as Dn, ac as is, ad as ss, ae as cs, af as $o, ag as ls, ah as ds, ai as ws, aj as us, ak as Mn, al as On, am as ho, an as ps, ao as In, ap as Na, aq as Po, ar as Ca, as as hs, at as gs, au as fs, av as ms, aw as vs, ax as Dr, ay as go, az as bs, aA as xs } from "./resizable-DOBsMv5h.js";
import { aB as Mg, aC as Og, aD as Ig, aE as $g, aF as Pg, aG as Ag, aH as Vg, aI as Lg, aJ as jg, aK as Bg, aL as Fg, aM as Ug, aN as Kg, aO as qg, aP as Hg, aQ as Gg, aR as Wg, aS as Yg, aT as Xg, aU as Jg, aV as Zg, aW as Qg, aX as tf, aY as ef, aZ as rf, a_ as af, a$ as of } from "./resizable-DOBsMv5h.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as zt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Ao, ChevronsLeft as Vo, ChevronsRight as Lo, ChevronLeft as qa, ChevronRight as Ha, ArrowLeft as ys, ArrowRight as ks, ChevronDown as lr, BoldIcon as _s, ItalicIcon as Ns, X as fo, AtSign as $n, Pencil as Cs, Trash2 as Es, ArrowUp as Pn, MoreHorizontal as Ts, MailOpen as Ss, Mail as Rs, ChevronUp as zs, FilterIcon as Ds, ArrowLeftIcon as Ms, ChevronLeftIcon as Os, ChevronRightIcon as Is, ArrowRightIcon as $s, Copy as An, Filter as Ps, User as As, Link as Vs, CircleHelp as Ls, Undo as js, Redo as Bs, SquareX as Vn, FunctionSquare as Ln, SquareSigma as jn, Ban as Fs, AlertCircle as Ga, CircleCheckIcon as Us, CircleXIcon as Ks, CircleHelpIcon as qs, ArrowUpIcon as Hs, ArrowDownIcon as Gs, ScrollText as Ws, ChevronsUpDown as Ys, MenuIcon as Xs, Menu as Js, EllipsisVertical as Zs, MoreVertical as Qs } from "lucide-react";
import { Section as Ct, getChaptersForBook as tc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as Gr, formatRelativeDate as ec, sanitizeHtml as mo, NumberFormat as Bn, formatBytes as rc, getCurrentLocale as ac, usfmMarkers as Wr, isPlatformError as oc, ABORTED as nc, getErrorMessage as ic, getFormatCallerFunction as sc, deepEqual as cc, isString as jo, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as lc, getLocalizeKeyForScrollGroupId as Bo, formatReplacementStringToArray as Fo, collectUsjMarkers as dc } from "platform-bible-utils";
import Yt, { useRef as K, useMemo as V, createContext as ua, useContext as vo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Uo, Suspense as pc, forwardRef as Fn, useId as Ko, Fragment as pa } from "react";
...
import { createEditor as qn, $getRoot as $e, $createParagraphNode as Mr, $getSelection as ee, HISTORY_MERGE_TAG as bo, ParagraphNode as Hn, TextNode as Gn, $getPreviousSelection as Nc, $isRangeSelection as be, $caretFromPoint as Cc, $getSiblingCaret as Wn, $getChildCaret as Ec, $getAdjacentChildCaret as Tc, $isChildCaret as Sc, $normalizeCaret as Rc, $setSelectionFromCaretRange as zc, $getCollapsedCaretRange as Dc, $getCaretInDirection as qo, $splitAtPointCaretNext as Mc, $isTextPointCaret as Oc, $findMatchingParent as Yn, $isElementNode as Sr, mergeRegister as Te, getDOMTextNode as Ic, isHTMLElement as $c, CLEAR_EDITOR_COMMAND as Xn, COMMAND_PRIORITY_EDITOR as xo, shallowMergeConfig as Pc, defineExtension as ne, safeCast as er, createState as Ac, FORMAT_TEXT_COMMAND as Jn, $isNodeSelection as Zn, COMMAND_PRIORITY_LOW as Qn, RootNode as Vc, LineBreakNode as Lc, TabNode as jc, $isEditorState as Bc, createCommand as Fc, CLICK_COMMAND as Uc, isDOMNode as Kc, $getNodeFromDOMNode as qc, $createNodeSelection as Hc, $setSelection as Gc, $getEditor as Wc, DecoratorNode as Ya, $getState as Yc, toggleTextFormatType as Ho, TEXT_TYPE_TO_FORMAT as Xc, $setState as Jc, addClassNamesToElement as ti, $create as Zc, $getNodeByKey as Qc, removeClassNamesFromElement as tl, KEY_TAB_COMMAND as el, $isBlockElementNode as rl, $createRangeSelection as al, $normalizeSelection__EXPERIMENTAL as ol, OUTDENT_CONTENT_COMMAND as nl, INDENT_CONTENT_COMMAND as Go, INSERT_TAB_COMMAND as il, COMMAND_PRIORITY_CRITICAL as yo, $isDecoratorNode as sl, $isParagraphNode as cl, $isTextNode as Xa, SELECTION_CHANGE_COMMAND as ei, $insertNodes as ll } from "lexical";
...
import { Avatar as ko, Select as Xt, Checkbox as Wo, Slot as Or, Tabs as we, Menubar as ke, ContextMenu as $t, Progress as Yo, Slider as Br, Switch as Xo } from "radix-ui";
import { useReactTable as ai, getFilteredRowModel as vl, getSortedRowModel as oi, getPaginationRowModel as bl, getCoreRowModel as ni, flexRender as Nr, getGroupedRowModel as xl, getExpandedRowModel as yl } from "@tanstack/react-table";
...
function Ml({
  ...
  W(() => {
    ...
    if (!Q) return;
    const I = (H) => !!H && H.scrollWidth > H.clientWidth, tt = () => {
        ...
        children: [
          /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                Y,
                Y && q && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                q
              ]
            }
          ) }),
...
function Ra({
  ...
  const F = ye(), A = zl(), D = T ?? A, [U, Y] = _(!1), [q, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [H, nt] = _(void 0), [at, pt] = _(
    void 0
    ...
    () => Ll(kt, Vt),
    [kt, Vt]
  ), ae = Kt.has(t.book), Zt = V(() => I.trim() ? to(
  ...
  const Lt = j(() => {
    ...
    (k) => {
      const rt = N === "chapters" ? H : M == null ? void 0 : M.book;
      if (rt) {
        if (w && w(rt, k) > 1) {
  ...
  const { otLong: st, ntLong: ht, dcLong: xt, extraLong: _t } = {
    ...
    [t.book, i, D]
  ), qe = `${t.chapterNum}:${t.verseNum}`, $r = j((k) => (rt) => {
    Tt.current[k] = rt;
  }, []), va = j((k) => (rt) => {
    Ft.current[k] = rt;
  }, []), Pr = V(
    ...
    (k) => {
      ...
      if ((N === "chapters" || N === "verses") && (k.key === " " || k.key === "Enter")) {
        const Ht = k.target instanceof HTMLElement ? k.target : void 0;
        if (!!(Ht != null && Ht.closest(
      ...
      if ((N === "chapters" || N === "books" && M) && O) {
        const Ht = N === "chapters" ? H : M == null ? void 0 : M.book;
        if (!Ht) return;
  ...
  return te(() => {
    ...
    if (N === "chapters" && H) {
      const k = H === t.book, rt = k ? t.chapterNum : 1;
      Q(
        `${H} ${de[H] || ""} ${rt}`
      ), setTimeout(() => {
        if (bt.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Pe, { open: U, onOpenChange: L, modal: y, children: [
              ...
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    ...
                    tabIndex: -1,
                    children: F === "ltr" ? /* @__PURE__ */ a(ys, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ks, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                N === "chapters" && H && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: me(H, i) }),
                  ...
                  M && fr && M.chapterNum && w && /* @__PURE__ */ u(lt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      en,
                      {
                        ...
                        onVerseSelect: qt,
                        setVerseRef: va,
                        isVerseDisabled: He(M.book, M.chapterNum),
...
function rn({
  ...
  const [C, E] = _(!1), $ = d ?? l, T = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], F = (A, D) => {
    const U = l(A), Y = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, q = `${D ?? ""}${U}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      Se,
      {
        value: U,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Le, { children: T(e) ? e.map((A) => /* @__PURE__ */ a(Ee, { heading: A.groupHeading, children: A.options.map((D) => F(D, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map((A) => F(A)) }) })
        ] })
      }
    )
  ] });
...
function Kl({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Fl(null, o), w = qn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
function ad(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      ...
      const F = ve(y.width);
      E.width !== F && (C.style.width = F, v = !0);
      const A = ve(y.height);
      E.height !== A && (C.style.height = A, v = !0), C.parentNode !== c && (c.append(C), v = !0), s[R] = C;
    }
...
function nd(t, e = od) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), x = f.getKey(), v = h.offset, R = g.getNode(), y = R.getKey(), C = g.offset, E = t.getElementByKey(x), $ = t.getElementByKey(y), T = r === null || E !== o || v !== n || x !== r.getKey(), F = i === null || $ !== s || C !== c || y !== i.getKey();
      if ((T || F) && E !== null && $ !== null) {
        const A = function(D, U, Y, q, Q, I, tt) {
          const N = (D._window ? D._window.document : document).createRange();
          return N.setStart(...an(U, Y, q)), N.setEnd(...an(Q, I, tt)), N;
        }(t, h, f, E, g, R, $);
        l(), l = ad(t, A, e);
      }
...
function sd(t) {
  const e = Yn(t, (r) => Sr(r) && !r.isInline());
...
function ld(t, e, r) {
  ...
  return Oc(o) && aa(283), o.insert(t.isInline() ? Mr().append(t) : t), qo(Wn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = ee();
  if (!be(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Yn(i, (d) => Sr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function fi(t, e = gi) {
  return t.registerCommand(Xn, (r) => (t.update(e), !0), xo);
}
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [mi], register: (t, e, r) => t.registerCommand(Jn, (o) => {
  const n = ee();
  if (Zn(n) || be(n)) for (const i of n.getNodes()) md(i) && i.toggleFormat(o);
  return !1;
}, Qn) });
function vi(t, e) {
  let r;
...
const kd = ne({ config: er({ setOptions: cn, updateOptions: cn }), init: ({ $initialEditorState: t = yd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Vc, Gn, Lc, jc, Hn] }), ln = Symbol.for("@lexical/extension/LexicalBuilder");
function dn() {
}
function _d(t) {
  throw t;
...
const Nd = /* @__PURE__ */ new Set(), wn = ne({ build(t, e, r) {
  ...
  return Te(t.registerCommand(Cd, (s) => {
    ...
    if (Kc(s.target)) {
      ...
      if (Td(c)) return function(l, d = !1) {
        ...
        let g;
        d && Zn(w) ? g = w : (g = Hc(), Gc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function Kd(t, e) {
  ...
  return u(lt, { children: [a(Fd, { editor: n, ...o, ref: e }), r != null && a(qd, { editor: n, content: r })] });
}
...
function Rp({
  ...
  const [i, s] = _(aw), [c, l] = _(n), [d, w] = _(!1), p = K(void 0), h = K(null);
  W(() => {
    let v = !0;
    const R = h.current;
    if (!R) return;
...
function Pi({
  ...
  const [q, Q] = _(mn), [I, tt] = _(), [N, z] = _(), H = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(E), [At, bt] = _(!1), Bt = K(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let b = !0;
    return (async () => {
  ...
  }, [i, r]), Zt = V(() => kt.slice(1), [kt]), M = V(() => Zt.length ?? 0, [Zt.length]), ce = V(() => M > 0, [M]), Lt = V(() => nt || M <= 2 ? Zt : Zt.slice(-2), [Zt, M, nt]), qt = V(() => nt || M <= 2 ? 0 : M - 2, [M, nt]), ue = V(
    () => M === 1 ? Kt.singleReply : Me(Kt.multipleReplies, { count: M }),
    [M, Kt]
  ), pe = V(
    () => qt === 1 ? Kt.singleReply : Me(Kt.multipleReplies, { count: qt }),
    [qt, Kt]
  );
  W(() => {
    !o && pt && ce && dt(!1);
  ...
  const S = j(
    ...
    async (b) => {
      const L = oe(q) ? sa(q) : void 0, P = b.status ? b.assignedUser : I ?? b.assignedUser, et = await p({
        ...b,
        contents: L,
        assignedUser: P
      });
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            ...
            v !== !1 && (!pt || oe(q)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (b) => {
                  Mo(b) && (b.preventDefault(), b.stopPropagation(), (oe(q) || I !== void 0 && I !== N) && S());
                },
                onKeyDown: (b) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    I !== void 0 && (oe(q) || I !== N) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Me(
...
function ww({
  ...
  const U = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: U }), q = (N) => N ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: N }) : Y, Q = () => {
    const N = o ?? "accept";
    return N === "merged" ? t.mergedText ? /* @__PURE__ */ a(ta, { html: R }) : Y : q(N === "reject" ? t.rejectedResultText : t.resultText);
  }, I = (N) => p && N.value === "reject", tt = (N) => {
    const z = f === N.value, H = `${d}-${N.value}`, nt = I(N);
    return (
...
function Vp({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [E, $] = _(), [T, F] = _(), A = j(
    async (z) => {
      const H = await i(z);
      return H !== void 0 && z.assignedUser !== void 0 && z.assignedUser !== "" && F(z.assignedUser), H;
    },
    [i]
  );
  W(() => {
  ...
  const D = r.filter(
    (z) => z.comments.some((H) => !H.deleted)
  ), U = D.map((z) => ({ id: z.id })), Y = j(
    (z) => {
      C((H) => new Set(H).add(z.id)), $(z.id), x == null || x(z.id);
    },
    [x]
  ), q = j(
    (z) => {
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(fw, { ...H, conflictResolution: R }) : /* @__PURE__ */ a(Pi, { ...H })
          },
          z.id
        );
      })
...
function kw({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, x] = _({}), [v, R] = _({}), y = V(() => e ?? [], [e]), C = ai({
    data: y,
    columns: t,
    getCoreRowModel: ni(),
  ...
  return l ? $ = Array.from({ length: 10 }).map((D, U) => `skeleton-row-${U}`).map((D) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ir, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? $ = C.getRowModel().rows.map((F) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(wo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: C.getHeaderGroups().map((F) => /* @__PURE__ */ a(De, { children: F.headers.map((A) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : Nr(A.column.columnDef.header, A.getContext()) }, A.id)) }, F.id)) }),
...
function Kp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(je, { children: [
    ...
    /* @__PURE__ */ a(Fe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Rn, { children: d.itemType === 0 ? /* @__PURE__ */ a(lt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][h],
...
function Wp({
  ...
  var pe;
  const h = K(null), g = K(null), f = K(null), x = K(null);
  te(() => {
    if (!x.current) return;
    const { width: S } = x.current.getBoundingClientRect();
    S > 0 && (x.current.style.width = `${S}px`);
  }, []);
  const [v, R] = _("generated"), [y, C] = _("generated"), [E, $] = _("*"), [T, F] = _("*"), [A, D] = _("f"), [U, Y] = _(!1), [q, Q] = _(!0), [I, tt] = _(!1), N = K(!1), z = K(""), [H, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = K(null), vt = K(
    void 0
  ...
  W(() => {
    ...
    if (b && xr("note", b)) {
      ...
      let st = "custom";
      et === Ja ? st = "generated" : et === Za ? st = "hidden" : et && ($(et), F(et)), R(st), C(st), D(((P = b.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
  ...
  const se = () => {
    ...
    if (B && xr("note", B)) {
      ...
      A !== "x" && S === "x" ? st == null || st.forEach((ht) => Bw(ht)) : A === "x" && S !== "x" && (st == null || st.forEach((ht) => Fw(ht))), (et = h.current) == null || et.applyUpdate([B, { delete: 1 }]);
    }
  }, Kt = (S) => {
  ...
  W(() => {
    ...
    const B = (b) => {
      const L = S();
      !H && L && document.activeElement === L && b.key === c ? (b.preventDefault(), Zt()) : H && b.key === "Escape" && (b.preventDefault(), nt(!1));
    };
...
function oh({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), x = fe(r, "%webView_inventory_unapproved%"), v = fe(r, "%webView_inventory_unknown%"), R = fe(r, "%webView_inventory_scope_currentBook%"), y = fe(r, "%webView_inventory_scope_chapter%"), C = fe(r, "%webView_inventory_scope_verse%"), E = fe(r, "%webView_inventory_filter_text%"), $ = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = fe(r, "%webView_inventory_no_results%"), [F, A] = _(!1), [D, U] = _("all"), [Y, q] = _(""), [Q, I] = _([]), tt = V(() => {
    const J = t ?? [];
  ...
  }, [F, tt]), z = V(() => N.length === 0 ? [] : Zw(N, D, Y), [N, D, Y]), H = V(() => {
    var gt, ft;
    if (!F) return l;
...
function bh({
  ...
  const [d, w] = _([]), [p, h] = _([{ id: ze, desc: !1 }]), [g, f] = _({}), x = V(
  ...
  W(() => {
    if (c) {
      const D = R.getSelectedRowModel().rowsById, U = Object.keys(D);
      if (U.length === 1) {
        const Y = x.find((q) => Nn(q) === U[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, x, c, R]);
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(wo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(uo, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(De, { children: D.headers.filter((U) => U.column.columnDef.header).map((U) => (
      ...
      /* @__PURE__ */ a(po, { children: R.getRowModel().rows.map((D, U) => {
        const Y = ye();
        return /* @__PURE__ */ a(
          De,
          {
            ...
            className: m(F(D, U)),
            onClick: (q) => T(D, q),
            children: D.getVisibleCells().map((q) => {
              if (!(q.getIsPlaceholder() || q.column.columnDef.enableGrouping && !q.getIsGrouped() && (q.column.columnDef.id !== Xe || !r)))
                return /* @__PURE__ */ a(
                  ir,
                  {
                    className: m(
                    ...
                    children: q.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Ha, {}) : /* @__PURE__ */ a(qa, {})),
                          " ",
                          Nr(q.column.columnDef.cell, q.getContext()),
                          " (",
                          D.subRows.length,
                          ")"
                        ]
...
function vu({
  ...
  }, [v, R] = _(!1), [y, C] = _(""), E = K(void 0), $ = K(!1), T = V(
    () => On(t),
    [t]
  ), F = V(() => {
    if (!y.trim()) {
              ...
              Ve,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(X, { variant: "ghost", size: "sm", onClick: q, children: w })
                  ] }),
...
function yh({
  ...
  const $ = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = Rt(s, "%webView_scope_selector_verse%"), F = Rt(s, "%webView_scope_selector_chapter%"), A = Rt(s, "%webView_scope_selector_book%"), D = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), U = Rt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = Rt(s, "%webView_scope_selector_current_book%"), q = Rt(s, "%webView_scope_selector_choose_books%"), Q = Rt(s, "%webView_scope_selector_scope%"), I = Rt(s, "%webView_scope_selector_select_books%"), tt = Rt(s, "%webView_scope_selector_range%"), N = Rt(s, "%webView_scope_selector_select_range%"), z = Rt(s, "%webView_scope_selector_range_start%"), H = Rt(s, "%webView_scope_selector_range_end%"), nt = Rt(s, "%webView_scope_selector_ok%"), at = Rt(s, "%webView_scope_selector_cancel%"), pt = Rt(s, "%webView_scope_selector_navigate%"), dt = (O) => {
    if (!x) return;
  ...
  ), Lt = gt.find((O) => O.value === "selectedBooks"), qt = gt.find((O) => O.value === "range"), [ue, pe] = _(!1), [S, B] = _(void 0), [G, b] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", jt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  ), re = Ft === "end", Ir = Ft === "start", rr = "tw:text-muted-foreground", qe = w === "dropdown" && S === "range", $r = qe ? P : Ke, Pr = qe ? st : f ? Kt : vt, fr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: Pt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Ir && rr), children: H }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
          ...
          localizedStrings: R,
          getEndVerse: y,
          disableReferencesUpTo: qe ? L ?? mt : mt,
          onOpenChange: Ut,
          onCloseAutoFocus: (O) => {
            var Z;
  ...
  const [He, Vr] = _(null), [Ge, ba] = _(null), [We, xa] = _(null), ya = 200, [ka, _a] = _(!1);
  W(() => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
        ...
        /* @__PURE__ */ a(
          Fe,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: We, children: [
              ce.map(({ value: O, label: Z, dropdownLabel: Nt, scrRefSuffix: he, id: Ht }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: mr(O),
    ...
    w === "dropdown" && Lt && /* @__PURE__ */ a(ja, { open: S === "selectedBooks", onOpenChange: k, children: /* @__PURE__ */ a(
      Ba,
      {
        ...
        children: /* @__PURE__ */ u(Na, { container: Ge, children: [
          /* @__PURE__ */ a(Fa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ua, { children: q }) }),
          jt,
    ...
    w === "dropdown" && qt && /* @__PURE__ */ a(ja, { open: S === "range", onOpenChange: k, children: /* @__PURE__ */ a(
      Ba,
      {
        ...
        onCloseAutoFocus: rt,
        onEscapeKeyDown: (O) => {
          He != null && He.querySelector('[data-state="open"]') && O.preventDefault();
        },
        children: /* @__PURE__ */ u(Na, { container: He, children: [
...
function no({
  ...
  return /* @__PURE__ */ u(je, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Fe, { align: "start", style: { zIndex: tr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(pa, { children: [
      /* @__PURE__ */ a(Rn, { children: /* @__PURE__ */ a(Dt, { children: Bi(e.groups, e.items, l, t) }) }),
...
)), Hi = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Content,
  {
    ref: r,
    className: m(
...
Hi.displayName = we.Content.displayName;
function Sh({
  tabList: t,
  searchValue: e,
  onSearch: r,
