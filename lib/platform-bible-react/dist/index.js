...
function Ht(t, e, n) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
      className: l("tw-max-h-5 tw-max-w-5", n ? "tw-mr-2" : "tw-ml-2"),
      src: t,
...
const Vn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Xe, { asChild: !0, children: "command" in s ? /* @__PURE__ */ d(
    ke,
    {
      ...
      children: [
        Ht(s.iconPathBefore, s.label, !0),
        s.label,
        Ht(s.iconPathAfter, s.label, !1)
      ]
    },
    ...
    const s = e.filter((u) => u.group === i).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ d(Pe, { children: [
      /* @__PURE__ */ r(Xe, { asChild: !0, children: "command" in u ? /* @__PURE__ */ d(
        $n,
        {
          ...
          children: [
            Ht(u.iconPathBefore, u.label, !0),
            u.label,
            Ht(u.iconPathAfter, u.label, !1)
          ]
        },
