...
import m, { forwardRef as Ue, useRef as nt, useMemo as H, useCallback as L, useState as I, useLayoutEffect as fn, createContext as Ar, useContext as Pr, useEffect as Mt, Fragment as En } from "react";
import { Command as wt } from "cmdk";
import { X as Ye, Search as Vn, Check as Ct, ChevronsLeft as gn, ChevronsRight as bn, ChevronLeft as Pe, ChevronRight as Pt, ArrowLeft as Br, ArrowRight as zr, Circle as fe, ChevronsUpDown as Ke, FilterIcon as jr, ChevronDown as ge, ChevronUp as Lr, ArrowLeftIcon as $r, ChevronLeftIcon as Fr, ChevronRightIcon as Gr, ArrowRightIcon as Xr, Copy as Hr, Filter as Ur, User as Yr, Link as Kr, CircleHelp as qr, Star as Jr, CircleCheckIcon as Wr, CircleXIcon as Zr, CircleHelpIcon as Qr, ArrowUpIcon as to, ArrowDownIcon as eo, ArrowUpDownIcon as no, PanelLeft as ro, PanelRight as oo, ScrollText as ao, MenuIcon as so, Menu as io, EllipsisVertical as wo, LoaderCircle as lo } from "lucide-react";
import { clsx as co } from "clsx";
import { extendTailwindMerge as po } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { getLocalizedBookName as At, getLocalizedBookId as qe, Section as P, ALL_ENGLISH_BOOK_NAMES as Vt, doesBookMatchQuery as Je, getChaptersForBook as mo, ALL_BOOK_IDS as uo, getSectionLongName as Mn, formatScrRef as Wt, getSectionForBook as Zt, NumberFormat as ho, formatBytes as fo, getCurrentLocale as go, deepEqual as We, isString as Te, compareScrRefs as Be, scrRefToBBBCCCVVV as Ee, getSectionShortName as bo, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
...
import { useReactTable as In, getFilteredRowModel as vo, getSortedRowModel as On, getPaginationRowModel as xo, getCoreRowModel as An, flexRender as Qt, getGroupedRowModel as yo, getExpandedRowModel as No } from "@tanstack/react-table";
import * as $ from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as ko } from "@radix-ui/react-dropdown-menu";
...
import { useHotkeys as _o } from "react-hotkeys-hook";
...
zn.displayName = ft.Overlay.displayName;
const Vo = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = et();
  return /* @__PURE__ */ l(Eo, { children: [
    /* @__PURE__ */ r(zn, {}),
    /* @__PURE__ */ l(
      ft.Content,
      {
...
Vo.displayName = ft.Content.displayName;
...
Mo.displayName = ft.Title.displayName;
...
Do.displayName = ft.Description.displayName;
...
const ie = m.forwardRef(({ className: t, ...e }, n) => {
  const o = et();
...
const ve = m.forwardRef((t, e) => /* @__PURE__ */ r(wt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
Bt.displayName = wt.Group.displayName;
...
jn.displayName = wt.Separator.displayName;
const Gt = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Item,
  {
    ref: n,
    className: d(
...
var Io = Object.defineProperty, Oo = (t, e, n) => e in t ? Io(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => Oo(t, typeof e != "symbol" ? e + "" : e, n);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
const it = class V {
    ...
    if (E(this, "firstChapter"), E(this, "lastChapter"), E(this, "lastVerse"), E(this, "hasSegmentsDefined"), E(this, "text"), E(this, "BBBCCCVVVS"), E(this, "longHashCode"), E(this, "versification"), E(this, "rtlMark", "‏"), E(this, "_bookNum", 0), E(this, "_chapterNum", 0), E(this, "_verseNum", 0), E(this, "_verse"), o == null && a == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof V) {
          ...
          if (e == null) return;
          const s = e instanceof Tt ? e : V.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let p;
    return i && (p = new Tt(i)), n ? new V(n, o.toString(), w, p) : new V();
  }
  /**
  ...
  parse(e) {
    ...
    if (o.length !== 2 || X.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !V.isVerseParseable(o[1]))
      throw new Kt("Invalid reference : " + e);
  ...
  updateInternal(e, n, o) {
    this.bookNum = X.bookIdToNumber(e), this.chapter = n, this.verse = o;
  }
};
...
const Un = Ue(
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        className: d(
          ...
          {
            "tw-border-s-red-200": a === P.OT,
            "tw-border-s-purple-200": a === P.NT,
            "tw-border-s-indigo-200": a === P.DC,
            "tw-border-s-amber-200": a === P.Extra
          }
        ),
        children: /* @__PURE__ */ l(
          Gt,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? $t : "button", { className: d(Ho({ variant: e, size: n, className: t })), ref: s, ...a })
);
D.displayName = "Button";
const le = ee.Root, de = ee.Trigger, Ht = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = et();
...
function $e(t, e, n) {
  return `${t} ${Vt[t]}${e ? ` ${qe(t, e)} ${At(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
const Ve = {
...
function Nn({
  ...
  if (t)
    return /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r("div", { className: d("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ht(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Gt,
      {
        value: `${t} ${Vt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ci({
  ...
  const i = et(), [w, p] = I(!1), [c, u] = I(""), [g, h] = I(""), [f, b] = I("books"), [v, x] = I(void 0), [C, y] = I(!1), M = nt(void 0), z = nt(void 0), W = nt(void 0), U = nt(void 0), gt = nt({}), k = H(() => o ? o() : uo, [o]), T = H(() => ({
    [P.OT]: k.filter((O) => X.isBookOT(O)),
    [P.NT]: k.filter((O) => X.isBookNT(O)),
    [P.DC]: k.filter((O) => X.isBookDC(O)),
    [P.Extra]: k.filter((O) => X.extraBooks().includes(O))
  }), [k]), rt = H(() => Object.values(T).flat(), [T]), B = H(() => {
    if (!g.trim()) return T;
    const N = {
      [P.OT]: [],
      [P.NT]: [],
    ...
    return [P.OT, P.NT, P.DC, P.Extra].forEach((J) => {
      N[J] = T[J].filter((ot) => Je(ot, g, a));
    }), N;
  }, [T, g, a]), _ = H(
    () => Yo(g, rt, a),
    [g, rt, a]
    ...
    (N) => {
      ...
      if ((f === "chapters" || f === "books" && _) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key)) {
        ...
        vt !== st && (N.preventDefault(), N.stopPropagation(), u($e(ot, a, vt)), setTimeout(() => {
    ...
    const { isLetter: O, isDigit: J } = yn(N.key);
    (O || J) && (N.preventDefault(), h((ot) => ot + N.key), z.current.focus(), y(!1));
  }, []);
  return fn(() => {
    const N = setTimeout(() => {
      if (w && f === "books" && W.current && U.current) {
        const O = W.current, J = U.current, ot = J.offsetTop, st = O.clientHeight, St = J.clientHeight, vt = ot - st / 2 + St / 2;
        O.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), u($e(t.book));
    ...
    /* @__PURE__ */ r(de, { asChild: !0, children: /* @__PURE__ */ r(
      D,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: Mr })
      }
    ) }),
      ...
      se,
      {
        ...
        children: [
          f === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Y.map(({ onClick: N, disabled: O, title: J, icon: ot }) => /* @__PURE__ */ r(
              D,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              D,
              {
                ...
                tabIndex: -1,
                children: i === "ltr" ? /* @__PURE__ */ r(Br, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(zr, { className: "tw-h-4 tw-w-4" })
              }
            ),
            v && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: At(v, a) })
          ] }),
          !C && /* @__PURE__ */ l(we, { ref: W, children: [
            f === "books" && /* @__PURE__ */ l(te, { children: [
              !_ && Object.entries(B).map(([N, O]) => {
                if (O.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Bt, { heading: Er(N), children: O.map((J) => /* @__PURE__ */ r(
                      Un,
                      {
                        bookId: J,
                        onSelect: (ot) => R(ot),
              ...
              _ && /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r(
                Gt,
                {
                  ...
                  children: Wt(
                    ...
                    a ? qe(_.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              _ && ht(_.book) > 1 && /* @__PURE__ */ l(te, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: At(_.book, a) }),
                /* @__PURE__ */ r(
                  Nn,
                  {
                    bookId: _.book,
...
), Q = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Dn.Root, { ref: n, className: d("pr-twp", qo(), t), ...e }));
Q.displayName = Dn.Root.displayName;
const en = m.forwardRef(({ className: t, ...e }, n) => {
  const o = et();
  return /* @__PURE__ */ r(
    ne.Root,
    {
...
const me = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ne.Item,
  {
    ref: n,
    className: d(
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ l(se, { children: [
          /* @__PURE__ */ r(ie, { placeholder: u, className: "tw-text-inherit" }),
...
var Zo = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(Zo || {});
...
function ui({
  ...
  const u = Me(c, "%webView_bookSelector_currentBook%"), g = Me(c, "%webView_bookSelector_choose%"), h = Me(c, "%webView_bookSelector_chooseBooks%"), [f, b] = I(
    "current book"
    /* CURRENT_BOOK */
  ), v = (x) => {
    b(x), t(x);
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(Q, { className: "tw-ms-1", children: u })
          ] }),
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Q, { className: "tw-flex tw-items-center", children: o.map((x) => X.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            D,
            {
...
}), Yn = $.Trigger, Kn = $.Group, Qo = $.Portal, ta = $.Sub, ea = $.RadioGroup;
function rn({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(nn.Provider, { value: n, children: /* @__PURE__ */ r($.Root, { ...e }) });
}
const qn = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    $.SubTrigger,
    {
...
qn.displayName = $.SubTrigger.displayName;
const Jn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $.SubContent,
  {
    ref: n,
...
Jn.displayName = $.SubContent.displayName;
const xe = m.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = et();
...
xe.displayName = $.Content.displayName;
...
Wn.displayName = $.Item.displayName;
const on = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    $.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const Zn = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ l(
    $.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(fe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Zn.displayName = $.RadioItem.displayName;
const an = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: o,
...
an.displayName = $.Label.displayName;
...
ye.displayName = $.Separator.displayName;
...
function ra({ table: t }) {
  return /* @__PURE__ */ l(rn, { children: [
    /* @__PURE__ */ r(ko, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(jr, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const zt = K.Root, oa = K.Group, jt = K.Value, aa = _t(
...
), It = m.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = et();
  return /* @__PURE__ */ l(
    K.Trigger,
    {
      className: d(aa({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
Qn.displayName = K.ScrollUpButton.displayName;
...
const sa = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  K.Label,
  {
    ref: n,
...
sa.displayName = K.Label.displayName;
...
ia.displayName = K.Separator.displayName;
function wa({ table: t }) {
...
function re(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && la(o)
  );
}
const Ne = m.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
  ...
  m.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        re(i, '[tabindex]:not([tabindex="-1"])').forEach((u) => {
...
const ke = m.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: d(
...
const Ce = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const kt = m.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const w = m.useMemo(
    ...
    (u) => {
      ...
      if (u.key === "ArrowDown" || u.key === "ArrowUp")
        u.preventDefault(), ma(f, b, u.key);
      else if (u.key === "ArrowLeft" || u.key === "ArrowRight")
        u.preventDefault(), pa(w, v, u.key);
...
function ha({
  ...
  var x;
  const [w, p] = I([]), [c, u] = I([]), [g, h] = I({}), [f, b] = I({}), v = In({
    data: e,
    columns: t,
    getCoreRowModel: An(),
    ...n && { getPaginationRowModel: xo() },
    onSortingChange: p,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    a && /* @__PURE__ */ r(ra, { table: v }),
    /* @__PURE__ */ l(Ne, { stickyHeader: s, children: [
      /* @__PURE__ */ r(ke, { stickyHeader: s, children: v.getHeaderGroups().map((C) => /* @__PURE__ */ r(kt, { children: C.headers.map((y) => /* @__PURE__ */ r(oe, { children: y.isPlaceholder ? void 0 : Qt(y.column.columnDef.header, y.getContext()) }, y.id)) }, C.id)) }),
    ...
    n && o && /* @__PURE__ */ r(wa, { table: v })
  ] });
}
function hi({ id: t, markdown: e, className: n, anchorTarget: o }) {
  const a = H(
    () => ({
      overrides: {
        a: {
...
function ga({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const o = Cn(n, "%webView_error_dump_header%"), a = Cn(n, "%webView_error_dump_info_message%");
  function s() {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(D, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Hr, {}) })
    ] }),
...
function bi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(rn, { children: [
    /* @__PURE__ */ r(Yn, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "default", children: [
      /* @__PURE__ */ r(Ur, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ge, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(xe, { children: n.map((c, u) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(an, { children: c.label }),
      /* @__PURE__ */ r(Kn, { children: c.itemType === 0 ? /* @__PURE__ */ r(te, { children: c.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        on,
        {
          checked: o[u][h],
        ...
        ea,
        {
          ...
          children: c.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Zn, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(ye, {})
    ] }, c.label)) })
...
function va({ id: t, versionHistory: e }) {
...
function xi({
  ...
  const i = H(() => fo(n), [n]), p = ((c) => {
    const u = new Intl.DisplayNames(go(), { type: "language" });
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(va, { versionHistory: a }),
...
const xa = _t(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: d("pr-twp", xa({ variant: e }), t), ...n })
);
...
function ya({
  ...
  const [g, h] = I(!1), f = L(
    ...
    const x = t.filter((y) => y.starred).sort((y, M) => y.label.localeCompare(M.label)), C = t.filter((y) => !y.starred).sort((y, M) => {
      const z = n.includes(y.value), W = n.includes(M.value);
      return z && !W ? -1 : !z && W ? 1 : y.label.localeCompare(M.label);
    });
    return [...x, ...C];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ l(le, { open: g, onOpenChange: h, children: [
    /* @__PURE__ */ r(de, { asChild: !0, children: /* @__PURE__ */ l(
      D,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(se, { children: [
      ...
      /* @__PURE__ */ l(we, { children: [
        ...
        /* @__PURE__ */ r(Bt, { children: v.map((x) => {
          ...
          return /* @__PURE__ */ l(
            Gt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: x.starred && /* @__PURE__ */ r(Jr, { className: "tw-h-4 tw-w-4" }) }),
  ...
  return /* @__PURE__ */ l(Ne, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Ce, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      kt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Lt, { children: `${X.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
const sn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ze.Root,
  {
    ref: n,
    className: d(
...
sn.displayName = ze.Root.displayName;
...
), ka = m.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Pn.Root,
  {
    ref: a,
    className: d(er({ variant: e, size: n, className: t })),
    ...o
  }
));
ka.displayName = Pn.Root.displayName;
const nr = m.createContext({
  size: "default",
  variant: "default"
}), rr = m.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = et();
  return /* @__PURE__ */ r(
    be.Root,
    {
...
rr.displayName = be.Root.displayName;
const pe = m.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = m.useContext(nr);
  return /* @__PURE__ */ r(
    be.Item,
    {
      ref: s,
...
const _e = (t) => t === "asc" ? /* @__PURE__ */ r(to, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(eo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(no, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ni = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(rr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        pe,
        {
          onClick: (p) => {
  ...
  return e ? e[1] : "";
}, _a = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ti = Object.freeze([
...
function Ei({
  ...
  const c = xt(n, "%webView_inventory_all%"), u = xt(n, "%webView_inventory_approved%"), g = xt(n, "%webView_inventory_unapproved%"), h = xt(n, "%webView_inventory_unknown%"), f = xt(n, "%webView_inventory_scope_currentBook%"), b = xt(n, "%webView_inventory_scope_chapter%"), v = xt(n, "%webView_inventory_scope_verse%"), x = xt(n, "%webView_inventory_filter_text%"), C = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, M] = I(!1), [z, W] = I("all"), [U, gt] = I(""), [k, T] = I([]), rt = H(() => t.length === 0 ? [] : Ra(t, a, s), [t, a, s]), B = H(() => {
    if (y) return rt;
    const S = [];
    return rt.forEach((Z) => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(zt, { onValueChange: (S) => tt(S), defaultValue: i, children: [
...
const wn = m.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Bn.Root,
  {
    ref: a,
    decorative: n,
...
const ln = ae.Provider, dn = ae.Root, cn = ae.Trigger, Se = m.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  ae.Content,
  {
    ref: o,
    sideOffset: e,
...
Se.displayName = ae.Content.displayName;
const Ta = "16rem", Ea = "3rem", or = m.createContext(void 0);
function Re() {
...
const ar = m.forwardRef(
  ({
    ...
    const [c, u] = m.useState(t), g = e ?? c, h = m.useCallback(
      (M) => {
        const z = typeof M == "function" ? M(g) : M;
        n ? n(z) : u(z);
      },
      [n, g]
    ), f = m.useCallback(() => h((M) => !M), [h]), b = g ? "expanded" : "collapsed", C = et() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = m.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
...
const sr = m.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Re();
...
const Va = m.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ l(
    D,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(ro, {}) : /* @__PURE__ */ r(oo, {}),
...
const Xe = m.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? $t : "div",
  {
    ref: o,
...
const Pa = m.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? $t : "button",
  {
    ref: o,
...
Pa.displayName = "SidebarGroupAction";
...
const Ba = _t(
  ...
  ({
    ...
    const p = t ? $t : "button", { state: c } = Re(), u = /* @__PURE__ */ r(
      p,
      {
        ref: w,
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(cn, { asChild: !0, children: u }),
      /* @__PURE__ */ r(Se, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : u;
  }
);
...
const La = m.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
$a.displayName = "SidebarMenuSub";
const Fa = m.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Fa.displayName = "SidebarMenuSubItem";
const Ga = m.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? $t : "a",
  {
    ref: s,
...
Ga.displayName = "SidebarMenuSubButton";
function Xa({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  return /* @__PURE__ */ r(
    sr,
    {
      ...
      children: /* @__PURE__ */ l(wr, { children: [
        /* @__PURE__ */ l(Ge, { children: [
          /* @__PURE__ */ r(Xe, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(He, { children: /* @__PURE__ */ r(lr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(dr, { children: /* @__PURE__ */ r(
            cr,
            {
              onClick: () => c(h),
              isActive: g(h),
    ...
    /* @__PURE__ */ l(
      ar,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ir, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Nt = "scrBook", Ha = "scrRef", Et = "source", Ua = "details", Ya = "Scripture Reference", Ka = "Scripture Book", pr = "Type", qa = "Details";
function Ja(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Nt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Ya,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? X.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Nt ? Wt(a.start) : void 0;
      },
      getGroupingValue: (o) => X.bookIdToNumber(o.start.book),
...
}, Sn = (t) => `${Wa({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Mi({
  sources: t,
  ...
  const [p, c] = I([]), [u, g] = I([{ id: Nt, desc: !1 }]), [h, f] = I({}), b = H(
  ...
  Mt(() => {
    if (w) {
      ...
      if (T.length === 1) {
        const rt = b.find((B) => Sn(B) === T[0]) || void 0;
        rt && w(rt);
      }
    }
  }, [h, b, w, x]);
  const C = a ?? Ka, y = s ?? pr, M = [
    ...
    !e && /* @__PURE__ */ l(
      zt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ot, { position: "item-aligned", children: /* @__PURE__ */ r(oa, { children: M.map((k) => /* @__PURE__ */ r(ct, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
        ...
        return /* @__PURE__ */ r(
          kt,
          {
            ...
            children: k.getVisibleCells().map((B) => {
              if (!(B.getIsPlaceholder() || B.column.columnDef.enableGrouping && !B.getIsGrouped() && (B.column.columnDef.id !== Et || !n)))
                return /* @__PURE__ */ r(
                  Lt,
                  {
                    className: d(
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ l(
                      D,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (rt === "ltr" ? /* @__PURE__ */ r(Pt, {}) : /* @__PURE__ */ r(Pe, {})),
                          " ",
                          Qt(B.column.columnDef.cell, B.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
const mn = (t, e) => t.filter((n) => {
  try {
    return Zt(n) === e;
  } catch {
    return !1;
  }
}), mr = (t, e, n) => mn(t, e).every((o) => n.includes(o));
function Za({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = mn(e, t).length === 0, i = a["%scripture_section_ot_short%"], w = a["%scripture_section_nt_short%"], p = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    D,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: d(
        mr(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: bo(
        t,
...
function Qa({
  ...
  }, [x, C] = I(!1), [y, M] = I(""), z = nt(void 0), W = nt(!1);
  if (t.length !== X.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const U = H(() => X.allBookIds.filter(
    (R, tt) => t[tt] === "1" && !X.isObsolete(X.bookIdToNumber(R))
  ), [t]), gt = H(() => {
    if (!y.trim()) {
      const Y = {
        [P.OT]: [],
    ...
    (R, tt = !1) => {
      ...
      const Y = U.findIndex((q) => q === z.current), j = U.findIndex((q) => q === R);
      if (Y === -1 || j === -1) return;
      const [S, Z] = [
        Math.min(Y, j),
        Math.max(Y, j)
    ...
    (R) => {
      const tt = mn(U, R).map((Y) => Y);
      n(
        mr(U, R, e) ? e.filter((Y) => !tt.includes(Y)) : [.../* @__PURE__ */ new Set([...e, ...tt])]
      );
    },
    [e, n, U]
  ), _ = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(P).map((R) => /* @__PURE__ */ r(
      Za,
      {
        section: R,
        availableBookIds: U,
            ...
            se,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(D, { variant: "ghost", size: "sm", onClick: Ut, children: c })
                ] }),
                /* @__PURE__ */ l(we, { children: [
                  /* @__PURE__ */ r(ve, { children: u }),
                  Object.values(P).map((R, tt) => {
                    const Y = gt[R];
                    if (Y.length !== 0)
                      return /* @__PURE__ */ l(En, { children: [
                        ...
                        tt < Object.values(P).length - 1 && /* @__PURE__ */ r(jn, {})
                      ] }, R);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Ie ? Ie : Rn
      ).map((R) => /* @__PURE__ */ r(ue, { className: "hover:tw-bg-secondary", variant: "secondary", children: At(R, a) }, R)),
      ...
      /* @__PURE__ */ r(
        en,
        {
          ...
          children: x.map(({ value: C, label: y, id: M }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(me, { className: "tw-me-2", value: C, id: M }),
...
function Oi({
  ...
  return /* @__PURE__ */ l(
    zt,
    {
      ...
      children: [
        /* @__PURE__ */ r(It, { size: a, className: d("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          jt,
          {
            placeholder: i[A(e)] ?? e
          }
...
const hr = (t, e, n, o) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ l(dn, { children: [
  /* @__PURE__ */ r(cn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(qn, { children: w.label }),
    /* @__PURE__ */ r(Qo, { children: /* @__PURE__ */ r(Jn, { children: hr(
      t,
      e,
      ur(t, w.id),
      o
...
function Tn({
  ...
  return /* @__PURE__ */ l(rn, { variant: s, children: [
    /* @__PURE__ */ r(Yn, { "aria-label": n, className: a, asChild: !0, id: i, children: /* @__PURE__ */ r(D, { variant: "ghost", size: "icon", children: o ?? /* @__PURE__ */ r(so, {}) }) }),
    /* @__PURE__ */ r(xe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w], p, c) => /* @__PURE__ */ l(En, { children: [
      /* @__PURE__ */ r(Kn, { children: /* @__PURE__ */ r(ln, { children: hr(e.groups, e.items, w, t) }) }),
...
fr.displayName = lt.List.displayName;
...
)), br = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  lt.Content,
  {
    ref: n,
    className: d(
...
br.displayName = lt.Content.displayName;
function ji({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(fr, { children: [
      /* @__PURE__ */ r(gr, { children: t.map((i) => /* @__PURE__ */ r(ts, { value: i.value, children: i.value }, i.key)) }),
...
const vr = m.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = m.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(nn.Provider, { value: a, children: /* @__PURE__ */ r(
    F.Root,
    {
      ref: o,
      className: d(
...
vr.displayName = F.Root.displayName;
...
xr.displayName = F.Trigger.displayName;
const yr = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
yr.displayName = F.SubTrigger.displayName;
const Nr = m.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    F.SubContent,
    {
...
const kr = m.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = mt();
...
kr.displayName = F.Content.displayName;
const Cr = m.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
Cr.displayName = F.Item.displayName;
const rs = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
...
const os = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
...
os.displayName = F.RadioItem.displayName;
const as = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: o,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
as.displayName = F.Label.displayName;
...
_r.displayName = F.Separator.displayName;
const qt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, u) => c.order - u.order).map((c) => /* @__PURE__ */ l(dn, { children: [
      /* @__PURE__ */ r(cn, { asChild: !0, children: "command" in c ? /* @__PURE__ */ l(
        ...
        /* @__PURE__ */ r(yr, { children: c.label }),
    ...
    return w.length > 0 && i < a.length - 1 && p.push(/* @__PURE__ */ r(_r, {}, `separator-${s}`)), p;
  });
};
function ss({
  menuData: t,
  ...
  if (_o(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, g) => {
    var b, v, x, C;
    u.preventDefault();
    ...
    return /* @__PURE__ */ r(vr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, g]) => typeof u == "boolean" || typeof g == "boolean" ? 0 : u.order - g.order).map(([u, g]) => /* @__PURE__ */ l(es, { children: [
      /* @__PURE__ */ r(xr, { ref: c(u), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        kr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(ln, { children: Sr(t.groups, t.items, u, e) })
        }
      )
    ] }, u)) });
}
...
function Fi({
  ...
  const p = is(
    ...
    return v ? `${(z = t[f]) == null ? void 0 : z.autonym} (${v})` : (W = t[f]) == null ? void 0 : W.autonym;
  };
...
const ls = Ue(({ className: t, ...e }, n) => /* @__PURE__ */ r(lo, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), cs = m.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, role: "alert", className: d(ds({ variant: e }), t), ...n }));
...
const ms = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
us.displayName = Ft.Root.displayName;
...
const xs = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Hi = G.Root, Ui = G.Trigger, Yi = G.Group, Ki = G.Portal, qi = G.Sub, Ji = G.RadioGroup, ks = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  G.SubTrigger,
  {
    ref: a,
    className: d(
...
const _s = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(G.Portal, { children: /* @__PURE__ */ r(
  G.Content,
  {
    ref: n,
    className: d(
...
const Ss = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  G.Item,
  {
    ref: o,
    className: d(
...
const Rs = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ l(
  G.CheckboxItem,
  {
    ref: a,
    className: d(
...
const Ts = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  G.RadioItem,
  {
    ref: o,
    className: d(
...
const Es = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: o,
    className: d(
...
function Ds({
  ...
  return /* @__PURE__ */ r(Rr.Provider, { value: o, children: /* @__PURE__ */ r(
    pt.Root,
    {
...
const Wi = pt.Trigger, Is = pt.Portal, Zi = pt.Close, Tr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
Tr.displayName = pt.Overlay.displayName;
const Os = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = m.useContext(Rr), i = {
...
zs.displayName = pt.Description.displayName;
const js = m.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  je.Root,
  {
    ref: o,
    className: d(
...
const Ls = m.forwardRef(({ className: t, ...e }, n) => {
  const o = et();
  return /* @__PURE__ */ l(
    Jt.Root,
    {
...
const $s = m.forwardRef(({ className: t, ...e }, n) => {
  const o = et();
  return /* @__PURE__ */ r(
    Le.Root,
    {
...
const tw = lt.Root, Fs = m.forwardRef(({ className: t, ...e }, n) => {
  const o = et();
  return /* @__PURE__ */ r(
    lt.List,
    {
...
Xs.displayName = lt.Content.displayName;
...
const Ys = (t, e, n = {}) => {
  ...
  const a = nt(null), [s, i] = I(void 0), [w, p] = I(void 0), c = L(
    (h) => {
      i(h);
...
export {
  ...
  Pi as SettingsListItem,
  Xa as SettingsSidebar,
