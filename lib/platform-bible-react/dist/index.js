...
function Tn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, a = n.boundary, u = a === void 0 ? Wc : a, c = n.rootBoundary, d = c === void 0 ? Qs : c, g = n.elementContext, p = g === void 0 ? un : g, f = n.altBoundary, h = f === void 0 ? !1 : f, m = n.padding, v = m === void 0 ? 0 : m, w = oa(typeof v != "number" ? v : ia(v, $n)), O = p === un ? Xc : un, y = e.rects.popper, S = e.elements[h ? O : p], b = Td(Nt(S) ? S : S.contextElement || bt(e.elements.popper), u, d, s), R = Yt(e.elements.reference), $ = aa({
    reference: R,
    element: y,
    strategy: "absolute",
    placement: o
...
function Bd(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !1 : s, u = n.boundary, c = n.rootBoundary, d = n.altBoundary, g = n.padding, p = n.tether, f = p === void 0 ? !0 : p, h = n.tetherOffset, m = h === void 0 ? 0 : h, v = Tn(t, {
    ...
    padding: g,
    altBoundary: d
  }), w = Je(t.placement), O = Kt(t.placement), y = !O, S = Po(w), b = Ld(S), R = t.modifiersData.popperOffsets, $ = t.rects.reference, D = t.rects.popper, F = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, B = typeof F == "number" ? {
    mainAxis: F,
    altAxis: F
  ...
  if (R) {
    if (i) {
      var k, _ = S === "y" ? Ie : Ae, A = S === "y" ? We : Xe, I = S === "y" ? "height" : "width", j = R[S], Z = j + v[_], te = j - v[A], P = f ? -D[I] / 2 : 0, L = O === Wt ? $[I] : D[I], H = O === Wt ? -D[I] : -$[I], X = t.elements.arrow, z = f && X ? To(X) : {
        width: 0,
        height: 0
...
const xa = /* @__PURE__ */ C.forwardRef(function(t, n) {
  ...
  const R = ct({
    ...
    children: D
  }), Ee = An(), $e = Ee.direction === "rtl", [xe, yt] = C.useState(), [_e, tt] = C.useState(null), Fe = C.useRef(!1), nt = _ || te, Re = gn(), _t = gn(), xt = gn(), en = gn(), [Dn, Wo] = Bs({
    controlled: G,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Sr = Ls(P), tn = C.useRef(), Fn = En(() => {
  ...
  const Xo = (re) => {
    ...
    ei(re), xt.clear(), Re.clear(), Fn(), tn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", en.start(Z, () => {
...
`));
  const gl = C.useMemo(() => {
    ...
    touch: Fe.current
  }), kr = vg(on), ri = (r = (o = Q.popper) != null ? o : F.Popper) != null ? r : bg, oi = (i = (s = (a = Q.transition) != null ? a : F.Transition) != null ? s : V) != null ? i : uo, ii = (u = (c = Q.tooltip) != null ? c : F.Tooltip) != null ? u : wg, si = (d = (g = Q.arrow) != null ? g : F.Arrow) != null ? d : yg, ml = mn(ri, T({}, U, (p = Y.popper) != null ? p : B.popper, {
    className: Pe(kr.popper, U == null ? void 0 : U.className, (f = (h = Y.popper) != null ? h : B.popper) == null ? void 0 : f.className)
  }), on), hl = mn(oi, T({}, ne, (m = Y.transition) != null ? m : B.transition), on), vl = mn(ii, T({}, (v = Y.tooltip) != null ? v : B.tooltip, {
...
class bv {
   ...
   *
   * @param {string | ScriptureCheckDefinition} [source] - Object that defines/describes the backing source associated with this results source, ensuring
  ...
  /**
   * Updates the results data with new Scripture item details and dispatches a 'resultsUpdated' event.
   */
  updateData(t) {
    this.data = t;
...
function wv({
  ...
  mt(() => {
    const E = (k) => {
      const { detail: _ } = k, A = _, I = A.src, j = A.data.map((Z) => ({
        ...Z,
        source: I
      }));
