...
import { c as v, g as $e, a as qa, C as Re, A as he, P as Le, b as rr, B as W, d as je, e as Fe, f as Be, h as Se, i as Bi, k as Ui, j as Ki, E as qi, l as Ga, r as ke, m as Gi, n as un, o as ta, p as ea, L as zt, R as Ha, q as Gr, D as Ea, s as Ta, t as Sa, u as za, T as pn, v as Vr, w as jt, x as Ya, y as Ft, z as Bt, F as Ut, G as hn, H as Wa, I as Qe, J as _r, K as Ue, M as Ke, N as qe, S as Nr, O as sr, Q as Hi, U as Tr, V as er, W as Ae, Z as ar, X as Ie, Y as cr, _ as Xa, $ as Ja, a0 as Hr, a1 as Za, a2 as gn, a3 as Yi, a4 as Wi, a5 as Xi, a6 as Ra, a7 as fn, a8 as ra, a9 as mn, aa as Ji, ab as Zi, ac as Qi, ad as ts, ae as vn, af as bn, ag as Qa, ah as es, ai as xn, aj as la, ak as ko, al as da, am as rs, an as as, ao as os, ap as ns, aq as is, ar as Sr, as as to, at as ss, au as cs } from "./resizable-DlO-uoQ8.js";
...
import { Avatar as so, Select as Zt, Checkbox as $o, Slot as Rr, Tabs as ge, Menubar as _e, ContextMenu as Ot, Progress as Io, Slider as Mr, Switch as Ao } from "radix-ui";
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ u(
        Re,
        {
          ...
          "aria-label": `${Mt.bookIdToEnglishName(e)} (${e.toLocaleUpperCase()})`,
          disabled: w,
...
function fl({
  ...
  const [h, g] = k(!1), m = w !== void 0, x = m ? w : h, f = (N) => {
    m || g(N), p == null || p(N);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Le, { open: x, onOpenChange: f, children: [
    ...
    /* @__PURE__ */ a(je, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Se, { heading: i, children: t.map((N) => /* @__PURE__ */ u(
      Re,
      {
        onSelect: () => S(N),
  ...
  const o = vl.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && l) {
          const g = ((m) => Object.keys(he).find(
            (x) => he[x].toLowerCase() === m.toLowerCase()
          ))(c);
...
function Wn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Se, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function ha({
  ...
  const G = ke(), [T, P] = k(!1), [A, z] = k(""), [j, X] = k(""), [D, rt] = k("books"), [O, et] = k(void 0), [R, $] = k(
    void 0
  ), [q, it] = k(void 0), [kt, ht] = k(!1), $t = U(null), J = U(!1), at = U(void 0), ct = U(void 0), dt = U(void 0), ft = U(void 0), Qt = U({}), mt = U({}), Ct = F(
    (y) => {
      e(y), c && c(y);
    },
    [e, c]
  ), Kt = I(() => o ? o() : Gi, [o]), _t = I(() => ({
    [ut.OT]: Kt.filter((Y) => Mt.isBookOT(Y)),
    [ut.NT]: Kt.filter((Y) => Mt.isBookNT(Y)),
    [ut.DC]: Kt.filter((Y) => Mt.isBookDC(Y)),
    [ut.Extra]: Kt.filter((Y) => Mt.extraBooks().includes(Y))
  }), [Kt]), qt = I(() => Object.values(_t).flat(), [_t]), It = I(() => {
    if (!j.trim()) return _t;
    const y = {
      [ut.OT]: [],
      [ut.NT]: [],
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((nt) => {
      y[nt] = _t[nt].filter((Yt) => Ga(Yt, j, n));
    }), y;
  }, [_t, j, n]), M = I(
    () => yl(j, qt, n),
    [j, qt, n]
  ...
  const Et = F(() => {
    if (M) {
      const y = M.chapterNum ?? 1, Y = M.verseNum ?? 1;
      if (w && pa(M.book, y, Y, w))
        return;
      Ct({
        book: M.book,
        chapterNum: y,
    ...
    (y) => {
      const Y = R ?? (M == null ? void 0 : M.book), nt = q ?? (M == null ? void 0 : M.chapterNum);
      !Y || !nt || (Ct({
        book: Y,
        chapterNum: nt,
        verseNum: y
    ...
    (y) => {
      const Y = D === "chapters" ? O : M == null ? void 0 : M.book;
      if (Y) {
        if (d && d(Y, y) > 1) {
          $(Y), it(y), rt("verses"), z("");
          return;
    ...
    rt("books"), et(void 0), $(void 0), it(void 0), setTimeout(() => {
      ct.current && ct.current.focus();
    }, 0);
  }, []), re = F(() => {
    const y = R;
    $(void 0), it(void 0), y ? (et(y), rt("chapters"), z("")) : At();
  }, [R, At]), Tt = F((y) => {
    P(y), y && (rt("books"), et(void 0), $(void 0), it(void 0), X(""));
  }, []);
  H(() => {
    E && Tt(!1);
  }, [E, Tt]);
  ...
  H(() => {
    var y;
    St !== 0 && ((y = ct.current) == null || y.focus());
  }, [St]), Js(
    _,
    () => ({
      open: () => {
  ...
  const { otLong: Gt, ntLong: Ht, dcLong: de, extraLong: me } = {
    ...
    () => bl(j),
    [j]
  ), Z = I(() => !d || !M || !M.chapterNum || !B ? !1 : d(M.book, M.chapterNum) > 0, [d, M, B]), ot = F(
    (y) => w ? Vo(y, w) : !1,
    [w]
  ), pt = F(
    (y) => (Y) => w ? xl(y, Y, w) : !1,
    ...
    (y, Y) => (nt) => w ? pa(y, Y, nt, w) : !1,
    [w]
  ), bt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Nt = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Pt = F(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), p && p.includes(y.key) && M && M.chapterNum !== void 0 && M.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), Et());
    },
    [p, M, Et]
  ), Ye = F(
    (y) => {
      var Ce, We, Me;
      if (y.ctrlKey) return;
      const { isLetter: Y, isDigit: nt } = Lo(y.key);
      if ((D === "chapters" || D === "verses") && (y.key === " " || y.key === "Enter")) {
        const Vt = y.target instanceof HTMLElement ? y.target : void 0;
        ...
        const Lt = (Ce = at.current) == null ? void 0 : Ce.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (Lt) {
          y.preventDefault(), y.stopPropagation(), Lt.click();
          return;
        }
      }
      if ((D === "chapters" || D === "verses") && (Y || nt)) {
      ...
      if (D === "verses" && Yt) {
        ...
        switch (y.key) {
          case "ArrowLeft":
            gt !== 0 && (ne = gt > 1 ? gt - 1 : Lt);
            break;
          case "ArrowRight":
            gt !== 0 && (ne = gt < Lt ? gt + 1 : 1);
            break;
          case "ArrowUp":
            ne = gt === 0 ? Lt : Math.max(1, gt - ae);
            break;
          case "ArrowDown":
            ne = gt === 0 ? 1 : Math.min(Lt, gt + ae);
            break;
          default:
            return;
        }
        ne !== gt && (y.preventDefault(), y.stopPropagation(), z(
          `${Vt} ${he[Vt] || ""} ${xt}:${ne}`
        ), setTimeout(() => {
          const Xe = mt.current[ne];
          Xe && Xe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((D === "chapters" || D === "books" && M) && Yt) {
        const Vt = D === "chapters" ? O : M == null ? void 0 : M.book;
        if (!Vt) return;
        D === "chapters" && ((Me = at.current) == null || Me.focus());
        const xt = (() => {
          if (!A) return 1;
          const ae = A.match(/(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            xt !== 0 && (gt = xt > 1 ? xt - 1 : Lt);
            break;
          case "ArrowRight":
            xt !== 0 && (gt = xt < Lt ? xt + 1 : 1);
            break;
          case "ArrowUp":
            gt = xt === 0 ? Lt : Math.max(1, xt - ne);
            break;
          case "ArrowDown":
            gt = xt === 0 ? 1 : Math.min(Lt, xt + ne);
            break;
          default:
            return;
        }
        gt !== xt && (y.preventDefault(), y.stopPropagation(), z(
          `${Vt} ${he[Vt] || ""} ${gt}`
        ), setTimeout(() => {
          const ae = Qt.current[gt];
    ...
    const { isLetter: Y, isDigit: nt } = Lo(y.key);
    (Y || nt) && (y.preventDefault(), X((Ce) => Ce + y.key), ct.current.focus(), ht(!1));
  }, []);
  return oe(() => {
    const y = setTimeout(() => {
      if (T && D === "books" && dt.current && ft.current) {
        const Y = dt.current, nt = ft.current, Yt = nt.offsetTop, Ce = Y.clientHeight, We = nt.clientHeight, Me = Yt - Ce / 2 + We / 2;
        Y.scrollTo({
          top: Math.max(0, Me),
          behavior: "smooth"
        }), z(Yn(t.book));
    ...
    if (D === "chapters" && O) {
      const y = O === t.book, Y = y ? t.chapterNum : 1;
      z(
        `${O} ${he[O] || ""} ${Y}`
      ), setTimeout(() => {
        if (dt.current)
  ...
  }, [D, O, M, t.book, t.chapterNum]), oe(() => {
    if (D === "verses" && R && q !== void 0) {
      const y = R === t.book && q === t.chapterNum, Y = y ? t.verseNum : 1;
      z(
        `${R} ${he[R] || ""} ${q}:${Y}`
      ), setTimeout(() => {
        if (dt.current)
          if (y) {
            const nt = mt.current[t.verseNum];
            nt && nt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            dt.current.scrollTo({ top: 0 });
        at.current && at.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Le, { open: T, onOpenChange: Tt, modal: S, children: [
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: Y } = y;
          T && $t.current && Y instanceof Node && $t.current.contains(Y) && (J.current = !0, Tt(!1));
        },
        onCloseAutoFocus: f,
        children: /* @__PURE__ */ u(
          Fe,
          {
            ...
            children: [
              D === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: He.map(
                  ({ onClick: y, disabled: Y, title: nt, icon: Yt }) => /* @__PURE__ */ a(
                    W,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  W,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: D === "verses" ? re : At,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: G === "ltr" ? /* @__PURE__ */ a(ls, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ds, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                D === "chapters" && O && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: $e(O, n) }),
                D === "verses" && R && q !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${$e(R, n)} ${q}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: D === "verses" ? Nt : bt
                  }
                )
              ] }),
              !kt && /* @__PURE__ */ u(Be, { ref: dt, children: [
                D === "books" && /* @__PURE__ */ u(lt, { children: [
                  !M && Object.entries(It).map(([y, Y]) => {
                    if (Y.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Se, { heading: C(y), children: Y.map((nt) => /* @__PURE__ */ a(
                          Hn,
                          {
                            bookId: nt,
                            onSelect: (Yt) => De(Yt),
                  ...
                  M && /* @__PURE__ */ a(Se, { children: /* @__PURE__ */ a(
                    Re,
                    {
                      ...
                      children: Ee(
                        ...
                        // one control.
                        n ? qa(M.book, n) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  M && Z && M.chapterNum && d && /* @__PURE__ */ u(lt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${$e(M.book, n)} ${M.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Fo,
                      {
                        ...
                        endVerse: d(M.book, M.chapterNum),
                        scrRef: t,
                        onVerseSelect: Rt,
                        setVerseRef: L,
                        isVerseDisabled: vt(M.book, M.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  M && !Z && lr(M.book) > 1 && /* @__PURE__ */ u(lt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: $e(M.book, n) }),
                      /* @__PURE__ */ a("span", { children: bt })
                    ] }),
                    /* @__PURE__ */ a(
                      jo,
                      {
                        ...
                        setChapterRef: b,
                        isChapterDimmed: K,
                        isChapterDisabled: pt(M.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                D === "chapters" && O && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: O,
                    scrRef: t,
                    onChapterSelect: ce,
                    setChapterRef: b,
                    isChapterDisabled: pt(O),
                    className: "tw:p-4"
                  }
                ),
                D === "verses" && R && q !== void 0 && d && /* @__PURE__ */ a(
                  Fo,
                  {
                    bookId: R,
                    chapterNum: q,
...
function Bo({
  ...
  const [_, E] = k(!1), G = d ?? l, T = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], P = (A, z) => {
    const j = l(A), X = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, D = `${z ?? ""}${j}${X ?? ""}`;
    return /* @__PURE__ */ u(
      Re,
      {
        value: j,
  ...
  return /* @__PURE__ */ u(Le, { open: _, onOpenChange: E, ...N, children: [
    /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ u(
      W,
      {
        variant: m,
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          ...
          /* @__PURE__ */ a(Be, { children: T(e) ? e.map((A) => /* @__PURE__ */ a(Se, { heading: A.groupHeading, children: A.options.map((z) => P(z, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(Se, { children: e.map((A) => P(A)) }) })
        ] })
      }
    )
  ] });
...
function wp({
  ...
  const w = ga(d, "%webView_bookSelector_currentBook%"), p = ga(d, "%webView_bookSelector_choose%"), h = ga(d, "%webView_bookSelector_chooseBooks%"), [g, m] = k(
    "current book"
    /* CurrentBook */
  ), x = (f) => {
    m(f), t(f);
    ...
    Ha,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(zt, { className: "tw:flex tw:items-center", children: o.map((f) => Mt.bookIdToEnglishName(f)).join(", ") }),
          /* @__PURE__ */ a(
            W,
            {
...
const Jn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cl = Jn ? oe : H, Ir = { tag: oo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            ...
            (ee() !== null || x !== null && x === p.getRootElement()) && m.select();
          }
        }, Ir);
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : H;
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : H;
function $l(t) {
...
function Ll(t, e, r) {
  ...
  function l() {
    ...
    for (let S = 0; S < g.length; S++) {
      const N = g[S], _ = s[S] || document.createElement("div"), E = _.style;
      E.position !== "absolute" && (E.position = "absolute", f = !0);
      const G = be(N.left - p);
      E.left !== G && (E.left = G, f = !0);
      const T = be(N.top - h);
      E.top !== T && (_.style.top = T, f = !0);
      const P = be(N.width);
      E.width !== P && (_.style.width = P, f = !0);
      const A = be(N.height);
      E.height !== A && (_.style.height = A, f = !0), _.parentNode !== c && (c.append(_), f = !0), s[S] = _;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    d(), o = h, n = g, i = new MutationObserver((m) => {
      const x = t.getRootElement(), f = x && x.parentElement;
      if (x !== o || f !== n) return p();
...
function Fl(t, e = jl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), m = h.getNode(), x = m.getKey(), f = h.offset, S = g.getNode(), N = S.getKey(), _ = g.offset, E = t.getElementByKey(x), G = t.getElementByKey(N), T = r === null || E !== o || f !== n || x !== r.getKey(), P = i === null || G !== s || _ !== c || N !== i.getKey();
      if ((T || P) && E !== null && G !== null) {
        const A = function(z, j, X, D, rt, O, et) {
          const R = (z._window ? z._window.document : document).createRange();
          return R.setStart(...Uo(j, X, D)), R.setEnd(...Uo(rt, O, et)), R;
        }(t, h, m, E, g, S, G);
        l(), l = Ll(t, A, e);
      }
      r = m, o = E, n = f, i = S, s = G, c = _;
    });
  }
...
function Kl(t) {
  const e = ee() || dc();
  let r;
  if (xe(e)) r = wc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = In(c, "next"));
    }
    r = r || uc(Ve(), "previous").getFlipped().insert(zr());
  }
...
let Wr, Te = 0, Xr = 0, Wl = 0, ja = 0, Br = 0;
function qo(t) {
  if (st === void 0) return;
  let e = t.n;
...
function Jl(t) {
  ...
  ti(this), st = t, this.f &= -2, 8 & this.f && wo(this), ia();
}
function ir(t, e) {
...
Xt.prototype.brand = Hl, Xt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Te !== 0 && Xr === 0 && e.l !== ja && (e.l = ja, Wr = { S: e, v: e.v, i: e.i, o: Wr });
    })(this), this.v = t, this.i++, Br++, Te++;
    try {
  ...
  return st = t, ti(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ei(this), Go(this), Te++;
  const t = st;
  return st = this, Jl.bind(this, t);
...
function ri() {
  const t = Ve(), e = ee(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), xe(e) && (e.format = 0);
}
function ai(t, e = ri) {
  return t.registerCommand(Pn, (r) => (t.update(e), !0), no);
}
se({ build: (t, e, r) => mr(e), config: or({ $onClear: ri }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ye(() => ai(t, o.value));
} });
function Zl(t) {
...
se({ name: "@lexical/extension/DecoratorText", nodes: () => [oi], register: (t, e, r) => t.registerCommand(Vn, (o) => {
  const n = ee();
  if (Ln(n) || xe(n)) for (const i of n.getNodes()) Ql(i) && i.toggleFormat(o);
  return !1;
}, jn) });
function ni(t, e) {
  let r;
...
const Fa = se({ build: (t) => ni(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function td(t) {
  return function(e) {
    return e.id === Ba;
  }(t) || wt(305, String(t.id), String(Ba)), Object.assign(t, { id: si });
}
...
class rd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ar && wt(307, String(r.id), String(nr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ba && wt(310, String(r.id), String(ba)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Ar;
    }(e) || wt(313, String(e.id), String(Ar)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= va;
    }(e) || wt(314, String(e.id), String(va)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const od = se({ config: or({ setOptions: Ho, updateOptions: Ho }), init: ({ $initialEditorState: t = ad }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class dr {
  ...
  static maybeFromEditor(e) {
    const r = e[Yo];
    return r && (r.PACKAGE_VERSION !== ya && wt(292, r.PACKAGE_VERSION, ya), r instanceof dr || wt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      xa(i) || wt(300, s, n || "[unknown]"), xa(c = i) || wt(304, String(c.id), String(uo)), i = Object.assign(c, { id: Ba }), o.state = i;
...
const id = /* @__PURE__ */ new Set(), Xo = se({ build(t, e, r) {
...
se({ dependencies: [Fa, Xo], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  ...
  return ze(t.registerCommand(sd, (s) => {
    const c = ee();
    if (!xe(c)) return !1;
...
function dd(t, e, r = li) {
  return ze(t.registerCommand(Fc, (o) => {
    const n = ee();
    if (!xe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
se({ build: (t, e, r) => mr(e), config: or({ $canIndent: li, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ye(() => {
    if (!o.value) return dd(t, n, i);
  });
} });
const wd = se({ name: "@lexical/react/ReactProvider" });
function ud() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (xe(m)) {
                const x = m.anchor;
                let f = x.getNode(), S = 0, N = 0;
                if (Aa(f) && d >= 0 && w >= 0 && (S = d, N = d + w, m.setTextNodeRange(f, S, f, N)), S === N && p === "" || (m.insertRawText(p), f = x.getNode()), Aa(f)) {
                  S = h, N = h + g;
                  const _ = f.getTextContentSize();
                  S = S > _ ? _ : S, N = N > _ ? _ : N, m.setTextNodeRange(f, S, f, N);
                }
...
se({ build: (t, e, r) => mr(e), config: or({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ye(() => r.getOutput().disabled.value ? void 0 : wi(t)) });
function gd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : H;
...
const yd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : H;
function kd({ onClear: t }) {
  const [e] = Ne();
  return yd(() => ai(e, t), [e, t]), null;
}
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : H;
function _d({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: m, id: x, role: f = "textbox", spellCheck: S = !0, style: N, tabIndex: _, "data-testid": E, ...G }, T) {
  const [P, A] = k(t.isEditable()), z = F((X) => {
    X && X.ownerDocument && X.ownerDocument.defaultView ? t.setRootElement(X) : t.setRootElement(null);
  }, [t]), j = I(() => /* @__PURE__ */ function(...X) {
    return (D) => {
      for (const rt of X) typeof rt == "function" ? rt(D) : rt != null && (rt.current = D);
    };
  }(T, z), [z, T]);
  return ui(() => (A(t.isEditable()), t.registerEditableListener((X) => {
    A(X);
  })), [t]), a("div", { "aria-activedescendant": P ? e : void 0, "aria-autocomplete": P ? r : "none", "aria-controls": P ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": P && f === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": P ? p : void 0, "aria-readonly": !P || void 0, "aria-required": h, autoCapitalize: g, className: m, contentEditable: P, "data-testid": E, id: x, ref: j, role: f, spellCheck: S, style: N, tabIndex: _, ...G });
}
const Nd = zn(_d);
function Zo(t) {
  return t.getEditorState().read(di(t.isComposing()));
...
function Dd({
  ...
  const [e] = Ne(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = Rd(), l = () => {
  };
...
function Od() {
  const { activeEditor: t } = hi(), [e, r] = k([]), o = F((n) => {
    if (xe(n) || el(n)) {
      const i = [];
      Qo.forEach(({ format: s }) => {
...
function pp({
  ...
  const [i, s] = k(Ld), [c, l] = k(n), [d, w] = k(!1), p = U(void 0), h = U(null);
  H(() => {
    let f = !0;
    const S = h.current;
    if (!S) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Le, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        je,
        {
          ...
          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: t.map((f) => /* @__PURE__ */ a(
            Re,
            {
              onSelect: () => {
                l(f || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: ka(f, o) })
            },
            f || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (f) => {
          f.key === "Escape" ? (f.preventDefault(), f.stopPropagation(), r()) : fo(f) && (f.preventDefault(), f.stopPropagation(), ie(i) && g());
        },
        onKeyDown: (f) => {
          go(f), (f.key === "Enter" || f.key === " ") && f.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Jr,
          {
...
function en({
  ...
  }, [t.date, r]), f = I(() => t.user, [t.user]), S = I(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), N = I(() => ro(t.contents), [t.contents]), _ = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), E = !!t.conflictResolutionAction && !_, G = I(() => {
    if (o && c)
      return /* @__PURE__ */ u(lt, { children: [
        /* @__PURE__ */ u(
          Qe,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : fo(T) && (T.preventDefault(), T.stopPropagation(), ie(w) && m());
              },
              onKeyDown: (T) => {
        ...
        G && /* @__PURE__ */ u(Ue, { children: [
          /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(gs, {}) }) }),
          /* @__PURE__ */ a(qe, { align: "end", children: G })
        ] })
      ]
    }
  );
...
function _i({
  ...
  const [D, rt] = k(rn), [O, et] = k(), [R, $] = k(), q = o, [it, kt] = k(!1), [ht, $t] = k(!1), [J, at] = k(!1), [ct, dt] = k(!1), [ft, Qt] = k(!1), [mt, Ct] = k(E), [Kt, _t] = k(!1), qt = U(void 0), [It, M] = k(/* @__PURE__ */ new Map());
  H(() => {
    let b = !0;
    return (async () => {
      const B = N ? await N(l) : !1;
      b && Qt(B);
    })(), () => {
      b = !1;
    };
    ...
    let b = !0;
    if (!o) {
      dt(!1), M(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const B = S ? await S(l) : !1;
      b && dt(B);
    })(), () => {
      b = !1;
    };
  ...
  H(() => {
    if (!o) {
      yt.current !== "idle" && (et(void 0), $(void 0), yt.current = "idle");
      return;
    }
    yt.current === "idle" && (yt.current = "pending"), ct ? yt.current === "pending" && P !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    P !== i && (et(P), yt.current = "auto-populated") : yt.current === "auto-populated" && (et(void 0), yt.current = "pending");
  }, [o, P, ct, i]);
  const Et = I(
    () => A ?? e.filter((b) => !b.deleted),
    [A, e]
  );
  H(() => {
    let b = !0;
  ...
  const Rt = I(() => Et[0], [Et]), De = U(null), ce = U(void 0), le = F(() => {
    var b;
    (b = ce.current) == null || b.call(ce), rt(rn);
  }, []), He = F(() => {
    const b = !mt;
    Ct(b), _t(!b), m == null || m(l, b);
  }, [mt, m, l]);
  H(() => {
    kt(!1);
  }, [o]), H(() => {
    if (o && !mt && !Kt) {
      ...
      return qt.current = b, () => clearTimeout(b);
    }
    qt.current && (clearTimeout(qt.current), qt.current = void 0);
  }, [o, mt, Kt, G, l, m]);
  const At = I(
    () => ({
  ...
  }, [i, r]), Tt = I(() => Et.slice(1), [Et]), St = I(() => Tt.length ?? 0, [Tt.length]), fe = I(() => St > 0, [St]), Gt = I(() => it || St <= 2 ? Tt : Tt.slice(-2), [Tt, St, it]), Ht = I(() => it || St <= 2 ? 0 : St - 2, [St, it]), de = I(
    () => St === 1 ? At.singleReply : tr(At.multipleReplies, { count: St }),
    [St, At]
  ), me = I(
    () => Ht === 1 ? At.singleReply : tr(At.multipleReplies, { count: Ht }),
    [Ht, At]
  );
  H(() => {
    !o && ht && fe && $t(!1);
  ...
  const C = F(
    async (b) => {
      ...
      L && await p({ threadId: l, contents: L }) && le();
    },
    [
      le,
      D,
    ...
    async (b) => {
      const L = ie(D) ? Zr(D) : void 0, B = b.status ? b.assignedUser : O ?? b.assignedUser, Z = await p({
        ...b,
        contents: L,
        assignedUser: B
      });
      return Z && (B !== void 0 && $(B), L && le()), Z;
    },
    [le, D, p, O]
  );
  ...
  const Q = /* @__PURE__ */ a(
    en,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: $t,
      canEditOrDelete: (!ht && It.get(Rt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Bd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              W,
              {
                ...
                children: mt ? /* @__PURE__ */ a(fs, {}) : /* @__PURE__ */ a(ms, {})
              }
            ),
            j === void 0 ? (
        ...
        /* @__PURE__ */ u(lt, { children: [
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            X && Gt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Ht > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (b) => {
                  b.stopPropagation(), kt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (b) => {
                  (b.key === "Enter" || b.key === " ") && (b.preventDefault(), b.stopPropagation(), kt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Nr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: me }),
                    it ? /* @__PURE__ */ a(vs, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            Gt.map((b) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              en,
              {
                comment: b,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: $t,
                canEditOrDelete: (!ht && It.get(b.id)) ?? !1
              }
            ) }, b.id)),
            f !== !1 && (!ht || ie(D)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (b) => {
                  fo(b) && (b.preventDefault(), b.stopPropagation(), (ie(D) || O !== void 0 && O !== R) && C());
                },
                onKeyDown: (b) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    O !== void 0 && (ie(D) || O !== R) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: tr(
                    ...
                    /* @__PURE__ */ u(Le, { open: J, onOpenChange: at, children: [
                      /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ a(
                        W,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        je,
                        {
                          ...
                          align: "end",
                          onKeyDown: (b) => {
                            b.key === "Escape" && (b.stopPropagation(), at(!1));
                          },
                          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: x == null ? void 0 : x.map((b) => /* @__PURE__ */ a(
                            Re,
                            {
                              onSelect: () => {
                                et(b !== i ? b : void 0), yt.current = "user-selected", $(void 0), at(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function Hd({
  ...
  const [s, c] = k("accept"), l = Ro(), d = Ro(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", m = p ? "accept" : s, x = I(
    () => Kr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), f = I(
    () => Kr(t.acceptedText ?? ""),
    ...
    () => Kr(t.mergedText ?? ""),
    [t.mergedText]
  ), N = I(() => ro(t.contents), [t.contents]);
  if (!xi(t))
    return /* @__PURE__ */ a(qr, { html: N });
  const _ = (R) => {
    c(R === "reject" || R === "merge" ? R : "accept");
  }, E = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", G = g ? [
    {
      value: "merge",
  ...
  let z;
  P ? z = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (z = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const j = e["%conflict_note_no_result%"] ?? "No result preview available.", X = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: j }), D = (R) => R ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: R }) : X, rt = () => {
    const R = o ?? "accept";
    return R === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: S }) : X : D(R === "reject" ? t.rejectedResultText : t.resultText);
  }, O = (R) => p && R.value === "reject", et = (R) => {
    const $ = m === R.value, q = `${d}-${R.value}`, it = O(R);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(lt, { children: [
        ...
        /* @__PURE__ */ a(
          Ha,
          {
            ...
            children: T.map((R) => O(R) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
              /* @__PURE__ */ a(Bt, { asChild: !0, children: et(R) }),
              /* @__PURE__ */ a(Ut, { children: E })
            ] }) }, R.value) : et(R))
          }
        ),
...
function Jd({
  ...
  return { conflictOptions: i, isResolving: c, resolve: m, resolvedResolution: f, showResolveCheck: i !== "loading" && i !== "none" };
}
function Zd(t) {
  const {
    comments: e,
...
function kp({
  ...
  const [N, _] = k(/* @__PURE__ */ new Set()), [E, G] = k(), [T, P] = k(), A = F(
    async ($) => {
      const q = await i($);
      return q !== void 0 && $.assignedUser !== void 0 && $.assignedUser !== "" && P($.assignedUser), q;
    },
    [i]
  );
  H(() => {
    m && (_(($) => new Set($).add(m)), G(m));
  }, [m]);
  const z = r.filter(
    ($) => $.comments.some((q) => !q.deleted)
  ), j = z.map(($) => ({ id: $.id })), X = F(
    ($) => {
      _((q) => new Set(q).add($.id)), G($.id), x == null || x($.id);
    },
    [x]
  ), D = F(
    ($) => {
      ...
      _((it) => {
        const kt = new Set(it);
        return kt.has($) ? kt.delete($) : kt.add($), kt;
      }), G($), x == null || x(q ? void 0 : $);
    },
    [N, x]
  ), { listboxRef: rt, activeId: O, handleKeyDown: et } = Hi({
    options: j,
    onOptionSelect: X
  }), R = F(
    ($) => {
      $.key === "Escape" ? (E && N.has(E) && (_((q) => {
        const it = new Set(q);
        return it.delete(E), it;
      }), G(void 0), x == null || x(void 0)), $.preventDefault(), $.stopPropagation()) : et($);
    },
    [E, N, et, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: z.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Zd, { ...q, conflictResolution: S }) : /* @__PURE__ */ a(_i, { ...q })
          },
          $.id
        );
      })
...
function Qd({ table: t }) {
  return /* @__PURE__ */ u(Ue, { children: [
    /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ u(W, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function ow({
  ...
  var T;
  const [w, p] = k([]), [h, g] = k([]), [m, x] = k({}), [f, S] = k({}), N = I(() => e ?? [], [e]), _ = Kn({
    data: N,
    columns: t,
    getCoreRowModel: Gn(),
  ...
  }), E = _.getVisibleFlatColumns();
  let G;
  return l ? G = Array.from({ length: 10 }).map((z, j) => `skeleton-row-${j}`).map((z) => /* @__PURE__ */ a(Ie, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? G = _.getRowModel().rows.map((P) => /* @__PURE__ */ a(
    Ie,
    {
      onClick: () => s(P, _),
      "data-state": P.getIsSelected() && "selected",
      children: P.getVisibleCells().map((A) => /* @__PURE__ */ a(cr, { children: yr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    P.id
  )) : G = /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Qd, { table: _ }),
    /* @__PURE__ */ u(Xa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ja, { stickyHeader: i, children: _.getHeaderGroups().map((P) => /* @__PURE__ */ a(Ie, { children: P.headers.map((A) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : yr(A.column.columnDef.header, A.getContext()) }, A.id)) }, P.id)) }),
      /* @__PURE__ */ a(Za, { children: G })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(W, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(_n, {}) })
        ] }),
...
function Tp({
  ...
  return /* @__PURE__ */ u(Le, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(je, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Sp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ue, { children: [
    /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ u(W, { variant: "default", children: [
...
function vw({
  ...
  const m = (f) => {
    c.current = !1, g(f), f || (l !== "custom" || w ? (e(l), o(w)) : (d(t), p(r)));
  }, x = (f) => {
    var S, N, _, E;
    f.stopPropagation(), document.activeElement === s.current && f.key === "ArrowDown" || f.key === "ArrowRight" ? ((S = i.current) == null || S.focus(), c.current = !0) : document.activeElement === i.current && f.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), c.current = !1) : document.activeElement === i.current && f.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((E = s.current) == null || E.focus(), c.current = !1), l === "custom" && f.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Ue, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "outline", className: "tw:h-6", children: mw(t, n, r) }) }) }),
    ...
    /* @__PURE__ */ u(
      qe,
      {
        ...
        onMouseMove: () => {
          var f;
          c.current && ((f = i.current) == null || f.focus());
        },
        children: [
          ...
          /* @__PURE__ */ a(
            Ae,
            {
              ...
              onClick: (f) => {
                var S;
                f.stopPropagation(), c.current = !0, (S = i.current) == null || S.focus();
              },
              ...
              children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ a(
                  ra,
                  {
                    tabIndex: 0,
                    onMouseDown: (f) => {
                      f.stopPropagation(), d("custom"), c.current = !0;
                    },
                    ref: i,
                    className: "tw:h-auto tw:w-10 tw:p-0 tw:text-center",
                    value: w,
                    onKeyDown: (f) => {
                      f.key === "Enter" || f.key === "ArrowUp" || f.key === "ArrowDown" || f.key === "ArrowLeft" || f.key === "ArrowRight" || f.stopPropagation();
                    },
                    maxLength: 1,
...
function yw({
  ...
  return /* @__PURE__ */ u(Ue, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "outline", className: "tw:h-6", children: bw(t, r) }) }) }),
      /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ a("p", { children: xw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(qe, { style: { zIndex: fn }, children: [
...
function Mp({
  ...
  var me;
  const h = U(null), g = U(null), m = U(null), x = U(null);
  oe(() => {
    if (!x.current) return;
    const { width: C } = x.current.getBoundingClientRect();
    C > 0 && (x.current.style.width = `${C}px`);
  }, []);
  const [f, S] = k("generated"), [N, _] = k("generated"), [E, G] = k("*"), [T, P] = k("*"), [A, z] = k("f"), [j, X] = k(!1), [D, rt] = k(!0), [O, et] = k(!1), R = U(!1), $ = U(""), [q, it] = k(!1), [kt, ht] = k(), [$t, J] = k(), [at, ct] = k(), [dt, ft] = k(), Qt = U(null), mt = U(void 0), Ct = U(0), Kt = U(void 0), _t = I(
    () => ({
      ...s,
  ...
  H(() => {
    var C;
    q || (C = h.current) == null || C.focus();
  }, [A, q]);
  const It = F(() => {
    var b, L, B;
    const C = (b = g.current) == null ? void 0 : b.querySelector(".editor-input"), K = C == null ? void 0 : C.querySelector("span.note"), Q = (B = (L = g.current) == null ? void 0 : L.ownerDocument.getSelection()) == null ? void 0 : B.anchorNode;
    return !!K && !!Q && K.contains(Q);
  }, []);
  H(() => {
    var L, B;
    let C, K, Q;
    R.current = !1, Kt.current = void 0, rt(!0);
    const b = e == null ? void 0 : e.at(0);
    if (b && Or("note", b)) {
      const Z = (L = b.insert.note) == null ? void 0 : L.caller;
      let ot = "custom";
      Z === Pa ? ot = "generated" : Z === Va ? ot = "hidden" : Z && (G(Z), P(Z)), S(ot), _(ot), z(((B = b.insert.note) == null ? void 0 : B.style) ?? "f"), C = setTimeout(() => {
        var pt, vt, bt;
        (pt = h.current) == null || pt.applyUpdate([b]), (vt = h.current) == null || vt.selectNote(0), (bt = h.current) == null || bt.focus(), K = requestAnimationFrame(() => {
          Q = setTimeout(() => {
            var Nt, Pt;
            It() || ((Nt = h.current) == null || Nt.selectNote(0), (Pt = h.current) == null || Pt.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      C && clearTimeout(C), K !== void 0 && cancelAnimationFrame(K), Q !== void 0 && clearTimeout(Q);
    };
  }, [e, i, It]);
  const M = F(
    (C, K, Q = !1) => {
      var L, B, Z;
      p == null || p();
      const b = (B = (L = h.current) == null ? void 0 : L.getNoteOps(0)) == null ? void 0 : B.at(0);
      if (b && Or("note", b)) {
        if (b.insert.note) {
          let ot;
          C === "custom" ? ot = K : C === "generated" ? ot = Pa : ot = Va, b.insert.note.caller = ot;
        }
        r == null || r([b]), Q && d && i && ((Z = d.current) == null || Z.replaceEmbedUpdate(i, [b]));
      }
    },
    [i, r, p, d]
  ), yt = F(() => {
    var C;
    mt.current || (C = h.current) == null || C.commitPendingMarkerEdits(), M(f, E, !0), o();
  }, [f, E, o, M]), Et = U(yt);
  oe(() => {
    Et.current = yt;
  });
  const Rt = U({ book: n.book, chapterNum: n.chapterNum });
  oe(() => {
    (Rt.current.book !== n.book || Rt.current.chapterNum !== n.chapterNum) && (Rt.current = { book: n.book, chapterNum: n.chapterNum }, Et.current());
  }, [n.book, n.chapterNum]);
  const De = () => {
    var K;
    const C = (K = g.current) == null ? void 0 : K.getElementsByClassName("editor-input")[0];
    ...
    var Q, b, L, B, Z;
    z(C);
    const K = (b = (Q = h.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : b.at(0);
    if (K && Or("note", K)) {
      K.insert.note && (K.insert.note.style = C);
      const ot = (B = (L = K.insert.note) == null ? void 0 : L.contents) == null ? void 0 : B.ops;
      A !== "x" && C === "x" ? ot == null || ot.forEach((pt) => Sw(pt)) : A === "x" && C !== "x" && (ot == null || ot.forEach((pt) => zw(pt))), (Z = h.current) == null || Z.applyUpdate([K, { delete: 1 }]);
    }
  }, At = (C) => {
    ft(C.contextMarker), et(C.canRedo);
  }, re = F(
    (C) => {
      var Q, b, L, B, Z;
      const K = (b = (Q = h.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : b.at(0);
      if (K && Or("note", K)) {
        ...
        const ot = (L = K.insert.note) == null ? void 0 : L.style, pt = (Z = (B = K.insert.note) == null ? void 0 : B.contents) == null ? void 0 : Z.ops;
        if (ot || X(!1), X(
          ot === "x" ? !!(pt != null && pt.every((vt) => {
            var Nt, Pt;
            if (!((Nt = vt.attributes) != null && Nt.char)) return !0;
            const bt = ((Pt = vt.attributes) == null ? void 0 : Pt.char).style;
          ...
          R.current = !0, $.current = JSON.stringify(K), rt(!0);
          return;
        }
        rt(JSON.stringify(K) === $.current), M(f, E);
      } else
        X(!1), rt(!0);
    },
    [f, E, M]
    ...
    if (m.current && qt.length && C && C.rangeCount > 0) {
      const K = C.getRangeAt(0).getBoundingClientRect(), Q = m.current.getBoundingClientRect();
      ht(K.left - Q.left), J(K.top - Q.top), ct(K.height), it(!0);
    }
  }, [qt, m]), St = U(() => {
  }), fe = F(
    (C, K, Q) => {
      const { anchorRect: b } = C;
      if (!w || !b) return;
      const { passive: L } = Q;
      Ct.current += 1;
      const B = Ct.current;
      mt.current = {
        kind: L ? "backslash" : "selection",
        token: B,
        filter: "",
        items: K
      }, w.show(K.map(Tw), b, L, {
        ...
        keys: uw(L ? "backslash" : "selection"),
        onKey: (Z) => St.current(Z)
      }).then((Z) => {
        var ot, pt, vt, bt, Nt, Pt;
        if (_a(mt, B), Z !== void 0) {
          if (!((ot = h.current) != null && ot.getSelection())) {
            const we = Kt.current;
            we ? (pt = h.current) == null || pt.setSelection(we) : (vt = h.current) == null || vt.selectNote(0);
          }
          (bt = h.current) == null || bt.focus();
          const Ye = K.find((we) => we.marker === Z);
          Ye && ((Nt = h.current) == null || Nt.applyMarkerMenuSelection(Ye, {
            trigger: "backslash",
        ...
        } else L || (Pt = h.current) == null || Pt.focus();
      }).catch(() => {
        var Z;
        _a(mt, B), L || (Z = h.current) == null || Z.focus();
      });
    },
    [w]
  ), Gt = F(() => {
    var Q;
    const C = (Q = h.current) == null ? void 0 : Q.getMarkerMenuContext();
    if (!C) return !1;
    const K = dl(_t.styleInfo ?? wl, C);
    return K.length === 0 ? !1 : (fe(C, K, { passive: !C.hasTextSelection }), !0);
  }, [fe, _t.styleInfo]), Ht = F(
    (C) => {
      const K = mt.current;
      if (!K || !w) return;
      pw(C, K, {
        ...
        commitTyped: (b) => {
          var L;
          return (L = h.current) == null ? void 0 : L.commitTypedMarker(b);
        },
        commitTypedAndReopen: (b) => {
          var L;
          (L = h.current) == null || L.commitTypedMarker(b, { trailingSpace: !1 }), Gt();
        },
        commitTypedCloser: (b) => {
          var L;
          return (L = h.current) == null ? void 0 : L.commitTypedCloser(b);
        },
        commitItem: (b) => {
          var B;
          const L = K.items.find((Z) => Z.marker === b);
          L && ((B = h.current) == null || B.applyMarkerMenuSelection(L, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  H(() => {
    ...
    const C = (K) => {
      var L, B;
      const Q = (L = g.current) == null ? void 0 : L.querySelector(".editor-input");
      if (!Q || K.target !== Q) return;
      const b = (B = h.current) == null ? void 0 : B.getSelection();
      b && (Kt.current = b);
    };
    ...
    if (((Q = _t.view) == null ? void 0 : Q.markerMode) === "editable") {
      const b = (B) => {
        var pt, vt, bt, Nt;
        if (Ni(B)) return;
        const Z = C();
        ...
        if (B.key === "Enter" && !It()) {
          B.preventDefault(), B.stopPropagation(), (pt = h.current) == null || pt.selectNote(0), (vt = h.current) == null || vt.focus();
          return;
        }
        if (w && B.key === c) {
          if (!It()) {
            B.preventDefault(), B.stopPropagation(), (bt = h.current) == null || bt.selectNote(0), (Nt = h.current) == null || Nt.focus();
            return;
          }
          Gt() && (B.preventDefault(), B.stopPropagation());
        }
      }, L = () => {
        var Z, ot;
        const B = C();
        !B || document.activeElement !== B || It() || ((Z = h.current) == null || Z.selectNote(0), (ot = h.current) == null || ot.focus());
      };
      return document.addEventListener("keydown", b, { capture: !0 }), document.addEventListener("paste", L, { capture: !0 }), () => {
        document.removeEventListener("keydown", b, { capture: !0 }), document.removeEventListener("paste", L, { capture: !0 });
      };
    }
    const K = (b) => {
      const L = C();
      !q && L && document.activeElement === L && b.key === c ? (b.preventDefault(), Tt()) : q && b.key === "Escape" && (b.preventDefault(), it(!1));
    };
    ...
    Tt,
    c,
    (me = _t.view) == null ? void 0 : me.markerMode,
    _t.styleInfo,
    w,
    Gt,
    It
    ...
    const C = () => {
      var b, L, B;
      const K = ((b = g.current) == null ? void 0 : b.querySelector(".editor-input")) ?? void 0;
      if (!K || document.activeElement !== K) return;
      const Q = document.getSelection();
      Q && !Q.isCollapsed || It() || ((L = h.current) == null || L.selectNote(0), (B = h.current) == null || B.focus());
    };
    return document.addEventListener("pointerup", C), document.addEventListener("selectionchange", C), () => {
      document.removeEventListener("pointerup", C), document.removeEventListener("selectionchange", C);
    };
  }, [It]);
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(Ya, { children: [
          /* @__PURE__ */ a(
            gw,
            {
              onUndoClick: () => {
                var C;
                return (C = h.current) == null ? void 0 : C.undo();
              },
              onRedoClick: () => {
                var C;
                return (C = h.current) == null ? void 0 : C.redo();
              },
              canUndo: !D,
              canRedo: O,
              localizedStrings: l
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
              ...
              /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ a("p", { children: de }) })
            ] }) }) })
          ]
        }
      )
...
function Ow({
  ...
  /* @__PURE__ */ u("span", { className: v("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    mo(t.marker, [s], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", x = v(h, g);
  return /* @__PURE__ */ u(lt, { children: [
...
function $p({
  ...
  const w = l ?? Hs(r, void 0), p = (_, E) => {
    d == null || d(_, E, n);
  }, h = i ? r.findIndex((_) => _ === i) : -1, [g, m] = k(h), x = (_, E, G) => {
    if (r.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), d == null || d(E, G, n);
          break;
      }
  }, f = (_) => {
    if (r.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), m((E) => Math.min(E + 1, r.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), m((E) => Math.max(E - 1, 0));
          break;
      }
  }, S = U([]);
  H(() => {
  ...
  const N = i ? r.findIndex((_) => _ === i) : -1;
  return H(() => {
    var _;
    N < 0 || N >= S.current.length || (_ = S.current[N]) == null || _.scrollIntoView({ block: "nearest" });
  }, [N]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Ow,
                      {
                        footnote: _,
                        layout: o,
                        formatCaller: () => w(_.caller, E),
                        showMarkers: s
                      }
                    )
                  }
                ),
                E < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Nr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, T)
            );
          })
        }
...
function Iw({
  ...
  return /* @__PURE__ */ u(Xa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ja, { stickyHeader: !0, children: /* @__PURE__ */ u(Ie, { children: [
...
}, sa = (t, e, r) => /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
  /* @__PURE__ */ u(
    Bt,
    {
...
function Bp({
  ...
  const g = ve(r, "%webView_inventory_all%"), m = ve(r, "%webView_inventory_approved%"), x = ve(r, "%webView_inventory_unapproved%"), f = ve(r, "%webView_inventory_unknown%"), S = ve(r, "%webView_inventory_scope_currentBook%"), N = ve(r, "%webView_inventory_scope_chapter%"), _ = ve(r, "%webView_inventory_scope_verse%"), E = ve(r, "%webView_inventory_filter_text%"), G = ve(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = ve(r, "%webView_inventory_no_results%"), [P, A] = k(!1), [z, j] = k("all"), [X, D] = k(""), [rt, O] = k([]), et = I(() => {
    const J = t ?? [];
    ...
    return et.forEach((at) => {
      const ct = at.items[0], dt = J.find(
        (ft) => ft.items[0] === ct
      );
      dt ? (dt.count += at.count, dt.occurrences = dt.occurrences.concat(at.occurrences)) : J.push({
        items: [ct],
        count: at.count,
  ...
  }, [P, et]), $ = I(() => R.length === 0 ? [] : Lw(R, z, X), [R, z, X]), q = I(() => {
    var ct, dt;
    if (!P) return l;
    ...
    for (let ft = 0; ft < J; ft++)
      at.push(
        Pw(
          ((dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt[ft]) || "Additional Item",
          ft + 1
        )
      );
    return [...at, ...l];
  }, [o == null ? void 0 : o.tableHeaders, l, P]);
  H(() => {
    $.length === 0 ? O([]) : $.length === 1 && O($[0].items);
  }, [$]);
  const it = (J, at) => {
    at.setRowSelection(() => {
      const dt = {};
    ...
    if (R.length === 0 || rt.length === 0) return [];
    const J = R.filter((at) => Ys(
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        pr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(fr, { children: [
              ...
              /* @__PURE__ */ a(pe, { value: "approved", children: m }),
              /* @__PURE__ */ a(pe, { value: "unapproved", children: x }),
              /* @__PURE__ */ a(pe, { value: "unknown", children: f })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(pr, { onValueChange: (J) => kt(J), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
        /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(zt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? G })
        ] }) }),
        /* @__PURE__ */ a(Ut, { children: (o == null ? void 0 : o.checkboxText) ?? G })
      ] }) })
    ] }),
...
function Uw({
  ...
  const [l, d] = Jt.useState(t), w = e ?? l, p = Jt.useCallback(
    (_) => {
      const E = typeof _ == "function" ? _(w) : _;
      r ? r(E) : d(E);
    },
    [r, w]
  ), h = Jt.useCallback(() => p((_) => !_), [p]), g = w ? "expanded" : "collapsed", f = ke() === "ltr" ? s : s === "primary" ? "secondary" : "primary", S = Jt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
    ...
    Kw,
    {
      ...
      children: /* @__PURE__ */ u(Gw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Hw, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(Yw, { children: /* @__PURE__ */ a(
            Xw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Oe = "scrBook", Zw = "scrRef", Ze = "source", Qw = "details", tu = "Scripture Reference", eu = "Scripture Book", Si = "Type", ru = "Details";
function au(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Mt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Oe ? Ee(n.start) : void 0;
      },
...
function ah({
  ...
  const [d, w] = k([]), [p, h] = k([{ id: Oe, desc: !1 }]), [g, m] = k({}), x = I(
    () => t.flatMap((z) => z.data.map((j) => ({
      ...j,
      source: z.source
    }))),
    [t]
  ...
  H(() => {
    if (c) {
      const z = S.getSelectedRowModel().rowsById, j = Object.keys(z);
      if (j.length === 1) {
        const X = x.find((D) => dn(D) === j[0]) || void 0;
        X && c(X);
      }
    }
  }, [g, x, c, S]);
  const N = n ?? eu, _ = i ?? Si, E = [
    ...
    !z.getIsGrouped() && !z.getIsSelected() && z.getToggleSelectedHandler()(j);
  }, P = (z, j) => z.getIsGrouped() ? "" : v("banded-row", j % 2 === 0 ? "even" : "odd"), A = (z, j, X) => {
    if (!((z == null ? void 0 : z.length) === 0 || j.depth < X.column.getGroupedIndex())) {
      if (j.getIsGrouped())
        switch (j.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(tw, { children: E.map((z) => /* @__PURE__ */ a(pe, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Xa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ja, { children: S.getHeaderGroups().map((z) => /* @__PURE__ */ a(Ie, { children: z.headers.filter((j) => j.column.columnDef.header).map((j) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Hr, { colSpan: j.colSpan, className: "tw:sticky top-0", children: j.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          yr(j.column.columnDef.header, j.getContext())
        ] }) }, j.id)
      )) }, z.id)) }),
      /* @__PURE__ */ a(Za, { children: S.getRowModel().rows.map((z, j) => {
        const X = ke();
        return /* @__PURE__ */ a(
          Ie,
          {
            ...
            children: z.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== Ze || !r)))
                return /* @__PURE__ */ a(
                  cr,
                  {
                    className: v(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      W,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (X === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
                          yr(D.column.columnDef.cell, D.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function nu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: m, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [f, S] = k(!1), [N, _] = k(""), E = U(void 0), G = U(!1), T = I(
    () => bn(t),
    [t]
  ), P = I(() => {
    if (!N.trim()) {
    ...
    (O, et = !1) => {
      ...
      const R = T.findIndex((ht) => ht === E.current), $ = T.findIndex((ht) => ht === O);
      if (R === -1 || $ === -1) return;
      const [q, it] = [
        Math.min(R, $),
        Math.max(R, $)
      ], kt = T.slice(q, it + 1).map((ht) => ht);
      r(
        e.includes(O) ? e.filter((ht) => !kt.includes(ht)) : [.../* @__PURE__ */ new Set([...e, ...kt])]
      );
    },
    [e, r, T]
  ), z = (O) => {
    A(O, G.current), G.current = !1;
  }, j = (O, et) => {
    O.preventDefault(), A(et, O.shiftKey);
  }, X = () => {
    r(T.map((O) => O));
  }, D = () => {
    r([]);
          ...
          je,
          {
            ...
            children: /* @__PURE__ */ u(
              Fe,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (O) => {
                  O.key === "Enter" && (G.current = O.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    ta,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(W, { variant: "ghost", size: "sm", onClick: D, children: w })
                  ] }),
                  /* @__PURE__ */ u(Be, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(ea, { children: p }),
                    Object.values(ut).filter((O) => P[O].length > 0).map((O, et) => {
                      const R = P[O];
                      return /* @__PURE__ */ u(aa, { children: [
                        et > 0 && /* @__PURE__ */ a(mn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Se,
                          {
                            heading: un(O, h, g, m, x),
                            children: R.map(($) => /* @__PURE__ */ a(
                              Hn,
                              {
                                bookId: $,
                  ...
                  rt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: rt.map(({ section: O, explanation: et }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: et }, O)) })
                ]
              }
            )
          }
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ca ? Ca : wn
      ).map((d) => /* @__PURE__ */ a(_r, { className: "tw:hover:bg-secondary", variant: "secondary", children: $e(d, n) }, d)),
...
function nh({
  ...
  const G = Dt(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = Dt(s, "%webView_scope_selector_verse%"), P = Dt(s, "%webView_scope_selector_chapter%"), A = Dt(s, "%webView_scope_selector_book%"), z = Dt(
    s,
    "%webView_scope_selector_current_verse%"
  ), j = Dt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), X = Dt(s, "%webView_scope_selector_current_book%"), D = Dt(s, "%webView_scope_selector_choose_books%"), rt = Dt(s, "%webView_scope_selector_scope%"), O = Dt(s, "%webView_scope_selector_select_books%"), et = Dt(s, "%webView_scope_selector_range%"), R = Dt(s, "%webView_scope_selector_select_range%"), $ = Dt(s, "%webView_scope_selector_range_start%"), q = Dt(s, "%webView_scope_selector_range_end%"), it = Dt(s, "%webView_scope_selector_ok%"), kt = Dt(s, "%webView_scope_selector_cancel%"), ht = Dt(s, "%webView_scope_selector_navigate%"), $t = (V) => {
    if (!x) return;
    const tt = x.book.toUpperCase();
    switch (V) {
      case "verse":
        return Ee(x, "id");
      case "chapter":
        return `${tt} ${x.chapterNum}`;
      case "book":
        return tt;
      default:
        return;
    ...
    { value: "selectedText", label: G, id: "scope-selected-text" },
    {
      value: "verse",
      label: T,
      dropdownLabel: z,
  ...
  ], at = (V, tt, te = !1) => /* @__PURE__ */ u(lt, { children: [
    V,
    tt && !te && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), ct = e ? J.filter((V) => e.includes(V.value)) : J, dt = x ?? ua, ft = p ?? dt, Qt = h ?? dt, mt = () => {
  }, Ct = U(null), Kt = U(null), _t = U(!1), qt = U(null), It = U(!1), [M, yt] = k(void 0), Et = U(!1), Rt = U(!1), De = U(null), ce = F((V) => {
    if (V) {
      yt("start"), Et.current = !1;
      return;
    }
    yt((tt) => tt === "start" ? void 0 : tt), Et.current && (Et.current = !1, requestAnimationFrame(() => {
      var te;
      const tt = (te = Ct.current) == null ? void 0 : te.querySelector("button");
      tt == null || tt.click();
    }));
  }, []), le = F((V) => {
    if (V) {
    ...
    yt((tt) => tt === "end" ? void 0 : tt);
  }, []), He = F(
    (V) => {
      g == null || g(V), m == null || m(V), Et.current = !0;
    },
    [g, m]
  ), At = F(
    (V) => {
      m == null || m(V), Rt.current = !0;
    },
    [m]
  ), re = F(
    (V) => {
    ...
    [r, n, x, i]
  ), Tt = ct.find((V) => V.value === t), St = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? Ws(ft, Qt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Tt ? at(Tt.label, Tt.scrRefSuffix) : t, fe = ct.filter(
    (V) => V.value !== "selectedBooks" && V.value !== "range"
  ), Gt = ct.find((V) => V.value === "selectedBooks"), Ht = ct.find((V) => V.value === "range"), [de, me] = k(!1), [C, K] = k(void 0), [Q, b] = k(void 0), [L, B] = k(void 0), [Z, ot] = k(void 0), [pt, vt] = k([]), bt = w === "dropdown" && C === "selectedBooks", Nt = /* @__PURE__ */ a(
    lu,
    {
      availableBookInfo: o,
      selectedBookIds: bt ? pt : n,
      onChangeSelectedBookIds: bt ? vt : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Pt = M === "end", Ye = M === "start", we = "tw:text-muted-foreground", y = w === "dropdown" && C === "range", Y = y ? B : He, Yt = y ? ot : m ? At : mt, Ce = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-start", className: v(Pt && we), children: $ }),
      /* @__PURE__ */ a(
        ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ct, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-end", className: v(Ye && we), children: q }),
      /* @__PURE__ */ a(
        ha,
        {
          id: "scope-range-end",
          ...
          localizedStrings: S,
          getEndVerse: N,
          disableReferencesUpTo: y ? L ?? ft : ft,
          onOpenChange: le,
          onCloseAutoFocus: (V) => {
            var tt;
            Rt.current && (Rt.current = !1, V.preventDefault(), (tt = De.current) == null || tt.focus());
          },
          className: v(Ye && we),
          modal: !0,
          align: "start"
  ...
  const [xt, Lt] = k(null), [gt, ne] = k(null), [ae, Xe] = k(null), Ai = 200, [Pi, Vi] = k(!1);
  H(() => {
    if (!ae || typeof ResizeObserver > "u") return;
    const V = new ResizeObserver(([tt]) => {
      Vi(tt.contentRect.width < Ai);
    });
    return V.observe(ae), () => V.disconnect();
  }, [ae]);
  const vo = F(
    (V) => {
      b(V), B(ft), ot(Qt), vt(n), me(!1), K(V);
    },
    [ft, Qt, n]
  ), bo = F(() => {
    Q !== void 0 && (Q === "range" ? (L && (g == null || g(L)), Z && (m == null || m(Z))) : Q === "selectedBooks" && i(pt), re(Q), K(void 0), b(void 0));
  }, [
    Q,
    L,
    Z,
    ...
    var tt;
    V.preventDefault(), (tt = Vt.current) == null || tt.focus();
  }, []), yo = (V) => t === V ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Pe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !_ && /* @__PURE__ */ a(zt, { children: rt }),
      w === "dropdown" ? /* @__PURE__ */ u(Ue, { open: de, onOpenChange: me, children: [
        ...
        /* @__PURE__ */ a(
          qe,
          {
            ...
            children: /* @__PURE__ */ u(la, { container: ae, children: [
              fe.map(({ value: V, label: tt, dropdownLabel: te, scrRefSuffix: vr, id: Li }) => /* @__PURE__ */ u(
                Qe,
                {
                  ref: Me(V),
              ...
              f && /* @__PURE__ */ u(lt, { children: [
                ...
                /* @__PURE__ */ a(
                  Qe,
                  {
                    ...
                    onSelect: (V) => {
                      var tt, te;
                      if (V.preventDefault(), _t.current) {
                        _t.current = !1;
                        return;
                      }
                      It.current || (te = (tt = Kt.current) == null ? void 0 : tt.querySelector("button")) == null || te.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (V) => {
                          ...
                          tt != null && tt.closest("button") && (_t.current = !0, requestAnimationFrame(() => {
                            _t.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ha,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var tt;
                              V.preventDefault(), (tt = qt.current) == null || tt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(lt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ee(x ?? ua, "id") }),
                              /* @__PURE__ */ a(wr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ha,
        {
          ...
          children: ct.map(({ value: V, label: tt, scrRefSuffix: te, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: V, id: vr }),
            /* @__PURE__ */ a(zt, { htmlFor: vr, children: at(tt, te) })
          ] }, vr))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { children: O }),
      Nt
    ] }),
    w === "radio" && t === "range" && Ce,
    w === "dropdown" && Gt && /* @__PURE__ */ a(Ea, { open: C === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: ne,
        onCloseAutoFocus: xo,
        onEscapeKeyDown: (V) => {
          gt != null && gt.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: gt, children: [
          ...
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(W, { variant: "outline", onClick: () => Dr(!1), children: kt }),
            /* @__PURE__ */ a(W, { onClick: bo, children: it })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Ht && /* @__PURE__ */ a(Ea, { open: C === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: Lt,
        onCloseAutoFocus: xo,
        onEscapeKeyDown: (V) => {
          xt != null && xt.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: xt, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: R }) }),
          Ce,
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(W, { variant: "outline", onClick: () => Dr(!1), children: kt }),
            /* @__PURE__ */ a(W, { ref: De, onClick: bo, children: it })
          ] })
        ] })
      }
    ) })
...
function Ka({
  ...
  return /* @__PURE__ */ u(Ue, { variant: i, children: [
    /* @__PURE__ */ a(Ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(W, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a(qe, { align: "start", style: { zIndex: ar }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(gn, { children: /* @__PURE__ */ a(jt, { children: Ri(e.groups, e.items, l, t) }) }),
  ...
  if (pl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), xr(i, [h, g]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), xr(s, [h, g]);
        break;
      case "alt+n":
        (f = c.current) == null || f.focus(), xr(c, [h, g]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ a(pu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(hu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ar },
          children: /* @__PURE__ */ a(jt, { children: Ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function gh({
  ...
  const d = Nu(
    ...
    var S, N, _, E, G, T;
    const f = x !== m ? ((N = (S = t[m]) == null ? void 0 : S.uiNames) == null ? void 0 : N[x]) ?? ((E = (_ = t[m]) == null ? void 0 : _.uiNames) == null ? void 0 : E.en) : void 0;
    return f ? `${(G = t[m]) == null ? void 0 : G.autonym} (${f})` : (T = t[m]) == null ? void 0 : T.autonym;
  };
      ...
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: ar },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(pe, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
...
function mh({
  ...
  const [s, c] = k(""), l = I(
    ...
    return l.filter(({ keywords: x }) => x.some((f) => f.toLowerCase().includes(m)));
        ...
        return /* @__PURE__ */ u(
          Re,
          {
            ...
            children: [
              ...
              f && /* @__PURE__ */ a("span", { className: "tw:sr-only", children: g })
            ]
          },
          m
        );
...
function hg(t) {
  const e = I(() => Xs(t).slice().sort().join(" "), [t]);
