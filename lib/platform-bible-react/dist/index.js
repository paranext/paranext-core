...
import { formatScrRef as Pt, getChaptersForBook as kr, NumberFormat as Cr, formatBytes as Sr, deepEqual as ye, substring as Rr, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as M } from "platform-bible-utils";
...
import { useReactTable as We, getFilteredRowModel as Tr, getSortedRowModel as Ze, getPaginationRowModel as _r, getCoreRowModel as Qe, flexRender as Ot, getGroupedRowModel as zr, getExpandedRowModel as Er } from "@tanstack/react-table";
...
const ke = D.Trigger, nn = D.Group, Pr = D.Portal, Or = D.Sub, Zo = D.RadioGroup;
...
rn.displayName = D.SubTrigger.displayName;
...
an.displayName = D.SubContent.displayName;
...
const Se = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    D.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(D.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
on.displayName = D.RadioItem.displayName;
...
Yt.displayName = D.Separator.displayName;
...
const ze = P.allBookIds.filter((t) => !P.isObsolete(P.bookIdToNumber(t))), ta = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function ts({
  ...
  const o = $(), [i, w] = B(""), [s, p] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, b] = B(!1), [S, x] = B(h), k = Z(void 0), y = Z(void 0), E = Z(void 0), j = et(
    (N) => {
      const z = a ? a() : ze;
      return {
        OT: z.filter((A) => P.isBookOT(A)),
        NT: z.filter((A) => P.isBookNT(A)),
        DC: z.filter((A) => P.isBookDC(A))
      }[N].filter((A) => {
        const G = P.bookIdToEnglishName(A).toLowerCase(), F = i.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (N, z, A, G) => {
      if (m(t.book !== N ? 1 : t.chapterNum), z || Vt(N) === -1) {
        e({
          book: N,
          chapterNum: A ?? 1,
          verseNum: G ?? 1
    ...
    na.forEach((N) => {
      const z = N.exec(i);
      if (z) {
        const [A, G = void 0, F = void 0] = z.slice(1), It = oa(A);
        (P.isBookIdValid(A) || It) && v(
          It ?? A,
          !0,
          G ? parseInt(G, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    if (f === s) {
      ...
      const A = z === "ArrowRight" && !o || z === "ArrowRight" && o === "ltr" || z === "ArrowLeft" && o === "rtl", G = z === "ArrowLeft" && !o || z === "ArrowLeft" && o === "ltr" || z === "ArrowRight" && o === "rtl";
      let F = 0;
      if (A)
        if (u < Vt(f))
          F = 1;
      ...
      u + F <= 0 || u + F > Vt(f) ? m(0) : F !== 0 && (m(u + F), N.preventDefault());
    }
  };
  return ct(() => {
    ...
    const N = setTimeout(() => {
      if (S && y.current && E.current && !i) {
        const A = E.current.offsetTop - ea;
        y.current.scrollTo({ top: A, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(N);
    ...
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Br,
      {
        ...
        handleKeyDown: O,
        handleOnClick: () => {
          p(t.book), g(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), b(!0), w(Pt(t, "English")), k.current.focus();
        },
        onFocus: () => {
          ot.current = !0;
        },
...
De.displayName = U.List.displayName;
...
const dt = c.forwardRef(
  ({ className: t, onKeyDown: e, onSelect: n, ...a }, o) => {
    ...
    return c.useEffect(() => {
      typeof o == "function" ? o(i.current) : o && o && "current" in o && (o.current = i.current);
    }, [o]), /* @__PURE__ */ r(
      "tr",
      {
        ref: i,
        ...
        onKeyDown: (s) => {
          ...
          const u = Array.from(
            p.parentElement.querySelectorAll('tr[tabindex="0"]')
          ), m = u.indexOf(p);
          let f;
          s.key === "ArrowDown" && m < u.length - 1 ? f = u[m + 1] : s.key === "ArrowUp" && m > 0 ? f = u[m - 1] : s.key === "Enter" && n && (s.preventDefault(), n(s)), f && (s.preventDefault(), f.focus()), e == null || e(s);
        },
        className: l(
...
function ka({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Qt, { stickyHeader: i, children: [
      /* @__PURE__ */ r(te, { stickyHeader: i, children: S.getHeaderGroups().map((k) => /* @__PURE__ */ r(dt, { children: k.headers.map((y) => /* @__PURE__ */ r(Ft, { children: y.isPlaceholder ? void 0 : Ot(y.column.columnDef.header, y.getContext()) }, y.id)) }, k.id)) }),
...
const ne = (t) => t === "asc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), us = (t) => ({
  ...
  return e ? e[1] : "";
}, Va = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", gs = Object.freeze([
  ...
  return Ia(t).forEach((m) => {
    m.startsWith("\\id") && (w = Da(m), s = 0, p = 0), m.startsWith("\\c") && (s = Le(m), p = 0), m.startsWith("\\v") && (p = Le(m), s === 0 && (s = e.chapterNum));
...
function fs({
  ...
  const f = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), h = st(n, "%webView_inventory_unapproved%"), b = st(n, "%webView_inventory_unknown%"), S = st(n, "%webView_inventory_scope_currentBook%"), x = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_scope_verse%"), y = st(n, "%webView_inventory_filter_text%"), E = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, tt] = B(!1), [ot, Et] = B("all"), [v, _] = B(""), [K, O] = B([]), Mt = Q(() => s ? a instanceof RegExp ? Aa(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((L) => {
...
const Oe = Gt.Provider, Xe = Gt.Root, je = Gt.Trigger, re = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Gt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Pa = "16rem", Oa = "3rem", Cn = c.createContext(void 0);
function ae() {
...
const Sn = c.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Cn.Provider, { value: y, children: /* @__PURE__ */ r(Oe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const lt = "scrBook", to = "scrRef", ht = "source", eo = "details", no = "Scripture Reference", ro = "Scripture Book", Dn = "Type", ao = "Details";
function oo(t, e) {
  const n = e ?? !1;
  return [
    {
        ...
        return /* @__PURE__ */ r(
          dt,
          {
            ...
            children: v.getVisibleCells().map((O) => {
              if (!(O.getIsPlaceholder() || O.column.columnDef.enableGrouping && !O.getIsGrouped() && (O.column.columnDef.id !== ht || !n)))
                return /* @__PURE__ */ r(
                  kt,
                  {
                    className: l(
...
function Cs({
  ...
  return /* @__PURE__ */ d(Wt, { variant: i, children: [
    ...
    /* @__PURE__ */ r($t, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ d(Jn, { children: [
      /* @__PURE__ */ r(nn, { children: /* @__PURE__ */ r(Oe, { children: Bn(e.groups, e.items, s, t) }) }),
  ...
  if (Ir(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    ...
    return /* @__PURE__ */ r(Xn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(wo, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Oe, { children: Hn(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
Eo.displayName = At.Root.displayName;
...
Vo.displayName = q.Content.displayName;
const Ds = (t, e) => {
  ct(() => {
    if (!t) return () => {
    };
