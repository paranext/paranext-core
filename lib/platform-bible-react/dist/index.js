...
function ng({
  ...
  const l = r["%webView_inventory_all%"], c = r["%webView_inventory_approved%"], p = r["%webView_inventory_unapproved%"], u = r["%webView_inventory_unknown%"], h = r["%webView_inventory_scope_book%"], f = r["%webView_inventory_scope_chapter%"], b = r["%webView_inventory_scope_verse%"], y = r["%webView_inventory_filter_text%"], [v, m] = de([]), [x, I] = de([]), [w, E] = de(void 0), [g, O] = de("book"), [S, L] = de("all"), [D, V] = de(""), [C, _] = de([]), [M, B] = de(""), z = (P, j) => {
    _((te) => {
      let Q = [];
      return P.forEach((k) => {
