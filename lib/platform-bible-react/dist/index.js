...
function hl(e) {
  ...
  const a = Vi(T({}, o, r)), l = Do(r), c = Do(o), u = t(a), d = be(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = T({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), p = T({}, u, n, c, l);
...
process.env.NODE_ENV !== "production" && (Nn["propTypes"] = Pi(Nn.propTypes));
function kl(e) {
...
process.env.NODE_ENV !== "production" && (rn["propTypes"] = Pi(rn.propTypes));
function Sl(e) {
  const t = ve(e);
...
function ec(e) {
  ...
  if (!(!i || !a)) {
    var f = Ql(o.padding, n), p = Ar(i), b = c === "y" ? Oe : ke, v = c === "y" ? Ae : De, g = n.rects.reference[d] + n.rects.reference[c] - a[c] - n.rects.popper[d], m = a[c] - n.rects.reference[c], E = dn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - m / 2, x = f[b], h = $ - p[d] - f[v], k = $ / 2 - p[d] / 2 + y, S = Qt(x, k, h), A = c;
...
function Cc(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !1 : a, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = sn(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Le(t.placement), $ = At(t.placement), y = !$, x = Dr(E), h = Pc(x), k = t.modifiersData.popperOffsets, S = t.rects.reference, A = t.rects.popper, I = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, D = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (k) {
    ...
    if (l) {
      var Ee, fe = x === "x" ? Oe : ke, it = x === "x" ? Ae : De, we = k[h], Ue = h === "y" ? "height" : "width", Se = we + m[fe], He = we - m[it], ge = [Oe, ke].indexOf(E) !== -1, bt = (Ee = B == null ? void 0 : B[h]) != null ? Ee : 0, st = ge ? Se : we - S[Ue] - A[Ue] - bt + D.altAxis, Lt = ge ? we + S[Ue] + A[Ue] - bt - D.altAxis : He, mn = b && ge ? Zl(st, we, Lt) : Qt(b ? st : Se, we, b ? Lt : He);
      k[h] = mn, z[h] = mn - we;
    }
    t.modifiersData[r] = z;
  }
...
const qc = () => Ye({
  ...
  const k = Hc(d, a), [S, A] = w.useState(k), [I, D] = w.useState(Mn(o));
  w.useEffect(() => {
...
const Yd = {
  ...
  } = t, E = ce(t, Kd), $ = Kt(), y = w.useRef(), x = hn(), h = w.useRef(null), k = Ie(h, i.ref, n), S = (_) => (R) => {
    if (_) {
      const j = h.current;
      R === void 0 ? _(j) : _(j, R);
    }
...
}, ii = Jd, Zd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Qd = xe(es, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), us = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const o = os(), i = Je({
    props: t,
    name: "MuiPopper"
    ...
    slots: y,
    slotProps: x
  } = i, h = ce(i, Zd), k = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, S = T({
    anchorEl: a,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const ps = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  const k = Je({
    ...
    TransitionProps: J
  } = k, C = ce(k, np), re = /* @__PURE__ */ w.isValidElement(A) ? A : /* @__PURE__ */ P("span", {
    children: A
  }), me = hn(), Ee = me.direction === "rtl", [fe, it] = w.useState(), [we, Ue] = w.useState(null), Se = w.useRef(!1), He = L || Z, ge = Kt(), bt = Kt(), st = Kt(), Lt = Kt(), [mn, to] = $i({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Jn = Ni(O), Ft = w.useRef(), gn = nn(() => {
...
`));
  const zs = w.useMemo(() => {
    ...
    touch: Se.current
  }), tr = op(Ut), po = (r = (o = Y.popper) != null ? o : I.Popper) != null ? r : ip, fo = (i = (a = (l = Y.transition) != null ? l : I.Transition) != null ? a : N) != null ? i : Rr, ho = (c = (u = Y.tooltip) != null ? u : I.Tooltip) != null ? c : sp, mo = (d = (f = Y.arrow) != null ? f : I.Arrow) != null ? d : ap, Us = Yt(po, T({}, H, (p = K.popper) != null ? p : D.popper, {
    className: be(tr.popper, H == null ? void 0 : H.className, (b = (v = K.popper) != null ? v : D.popper) == null ? void 0 : b.className)
  }), Ut), Hs = Yt(fo, T({}, J, (g = K.transition) != null ? g : D.transition), Ut), Ws = Yt(ho, T({}, (m = K.tooltip) != null ? m : D.tooltip, {
    className: be(tr.tooltip, (E = ($ = K.tooltip) != null ? $ : D.tooltip) == null ? void 0 : E.className)
  }), Ut), qs = Yt(mo, T({}, (y = K.arrow) != null ? y : D.arrow, {
  ...
  return /* @__PURE__ */ ye(w.Fragment, {
    children: [/* @__PURE__ */ w.cloneElement(re, $e), /* @__PURE__ */ P(po, T({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ ye(ho, T({}, Ws, {
          children: [ne, S ? /* @__PURE__ */ P(mo, T({}, qs, {
            ref: Ue
          })) : null]
        }))
      }))
...
var ms = Kr.default = void 0, yp = vp(bp()), xp = Gs;
ms = Kr.default = (0, yp.default)(/* @__PURE__ */ (0, xp.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function ci(e, t, n) {
  ...
  const {
    ...
    Zs,
    {
      ...
      children: n ? /* @__PURE__ */ ye(jn, { children: [
        ci(i, n, !0),
        /* @__PURE__ */ P(Qs, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ P(vi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ P(ms, {}) }) : ci(a, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ P(lp, { title: r, placement: "right", children: /* @__PURE__ */ P("div", { children: E }) }) : E;
}
function bs(e) {
...
function Ep(e) {
  ...
  return /* @__PURE__ */ ye(jn, { children: [
    /* @__PURE__ */ P(gs, { onClick: a, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ P(
      ea,
      {
        anchorEl: t,
  ...
  return /* @__PURE__ */ ye(
    yi,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ P(ta, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ P(
          Tp,
          {
            commandHandler: e,
            menuDefinition: t,
...
const vs = /* @__PURE__ */ w.createContext({});
...
const Cp = ["children", "className", "component", "dense", "disablePadding", "subheader"], Rp = (e) => {
  ...
  paddingTop: 0
})), ys = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = Je({
    props: t,
    name: "MuiList"
  }), {
...
const Es = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
...
}), ks = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = Je({
    props: t,
    name: "MuiPaper"
  }), {
...
`)), m !== null && fe < m) {
  ...
  const W = v || (c ? ve(Pn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : of, H = (i = y == null ? void 0 : y.paper) != null ? i : Ss, K = ft({
    elementType: H,
...
const lf = ["onEntering"], cf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], uf = {
  ...
  const i = Je({
    ...
    slots: $ = {},
    slotProps: y = {}
  } = i, x = ce(i.TransitionProps, lf), h = ce(i, cf), k = hn(), S = k.direction === "rtl", A = T({}, i, {
    autoFocus: a,
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  return /* @__PURE__ */ P(ff, T({
    onClose: f,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: S ? "right" : "left"
    },
    transformOrigin: S ? uf : df,
    slots: {
      paper: _,
      root: $.root
    },
...
function qf({ onSearch: e, placeholder: t, isFullWidth: n }) {
  ...
  return /* @__PURE__ */ P(ra, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ P(
    Dn,
    {
      isFullWidth: n,
...
const Mf = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ P(
  ya,
  {
    ...r,
    isChecked: n,
...
function Jf({
  ...
  const i = br(void 0);
  return /* @__PURE__ */ P("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ P(aa, { position: "static", id: r, children: /* @__PURE__ */ ye(la, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ P(
      yf,
      {
        commandHandler: t,
