    ...
    return /* @__PURE__ */ l("div", { className: "tw-relative tw-max-w-48", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          ...
          onFocus: (g) => {
            var h;
            b(!0), (h = p.onFocus) == null || h.call(p, g);
          },
          onBlur: (g) => {
            var h;
            b(!1), (h = p.onBlur) == null || h.call(p, g);
          },
          ref: c
        }
      ),
...
function Ws({
  ...
  const o = W(), [s, i] = B(
    () => Mt(t, "English")
  ), [w, p] = B(""), [c, f] = B(t.book), [b, g] = B(t.chapterNum ?? 0), [h, k] = B(t.book), [S, N] = B(!1), [_, x] = B(S), [M, z] = B(!1), [A, mt] = B(), U = Z(void 0), y = Z(void 0), v = Z(void 0), I = Z(void 0), R = H(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (V, C) => {
    ...
    if (!(!A || !A.chapterNum))
      return A.verseNum ? [A.chapterNum] : Array.from({ length: Pt(h) }, (m, V) => V + 1).filter(
        (m) => {
          var V;
    ...
    i(Mt(t, "English")), p(""), f(t.book), k(t.book);
  }, [t]), gt = H((m) => {
    if (K.current) {
      K.current = !1;
      return;
      ...
      if (Nn.has(C)) {
        if (h === c || tt === 1) {
          ...
          const Rt = C === "ArrowRight" && !o || C === "ArrowRight" && o === "ltr" || C === "ArrowLeft" && o === "rtl", oe = C === "ArrowLeft" && !o || C === "ArrowLeft" && o === "ltr" || C === "ArrowRight" && o === "rtl", Ve = Array.from(
            { length: Pt(h) },
            (se, Et) => Et + 1
          ), it = c !== h || tt === 1 ? $ ?? Ve : Ve, dt = it.indexOf(b);
          let yt = b;
          if (Rt)
  ...
  return ct(() => {
    tt === 1 ? g(1) : c === h ? c === t.book ? g(t.chapterNum) : g(1) : g(0);
...
function Qs({
  ...
  const f = ze(c, "%webView_bookSelector_currentBook%"), b = ze(c, "%webView_bookSelector_choose%"), g = ze(c, "%webView_bookSelector_chooseBooks%"), [h, k] = B(
    "current book"
    /* CURRENT_BOOK */
  ), S = (N) => {
    k(N), t(N);
...
function io({
  ...
  var N;
  const [w, p] = B([]), [c, f] = B([]), [b, g] = B({}), [h, k] = B({}), S = On({
    data: e,
    columns: t,
    getCoreRowModel: zn(),
...
function ri({ id: t, label: e, groups: n }) {
  const [a, o] = B(
    ...
    i((g) => (g[c] = f, { ...g }));
    const b = n[c].items.find((g) => g.id === f);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(me, { children: [
    ...
    /* @__PURE__ */ r(ne, { children: n.map((c, f) => /* @__PURE__ */ l("div", { children: [
...
function co({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const p = new Date(w), c = new Date(o.getTime() - p.getTime()), f = c.getUTCFullYear() - 1970, b = c.getUTCMonth(), g = c.getUTCDate() - 1;
    let h = "";
    return f > 0 ? h = `${f.toString()} year${f === 1 ? "" : "s"} ago` : b > 0 ? h = `${b.toString()} month${b === 1 ? "" : "s"} ago` : g === 0 ? h = "today" : h = `${g.toString()} day${g === 1 ? "" : "s"} ago`, h;
  }
...
function uo({
  ...
  return /* @__PURE__ */ r("div", { className: f, children: /* @__PURE__ */ l(ge, { open: b, onOpenChange: g, children: [
    /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ l(
      F,
      {
        variant: "ghost",
...
function mi({
  ...
  const c = bt(n, "%webView_inventory_all%"), f = bt(n, "%webView_inventory_approved%"), b = bt(n, "%webView_inventory_unapproved%"), g = bt(n, "%webView_inventory_unknown%"), h = bt(n, "%webView_inventory_scope_currentBook%"), k = bt(n, "%webView_inventory_scope_chapter%"), S = bt(n, "%webView_inventory_scope_verse%"), N = bt(n, "%webView_inventory_filter_text%"), _ = bt(
    n,
    "%webView_inventory_show_additional_items%"
...
const nr = u.forwardRef(
  ({
    ...
    const [c, f] = u.useState(t), b = e ?? c, g = u.useCallback(
      (M) => {
        const z = typeof M == "function" ? M(b) : M;
        n ? n(z) : f(z);
      },
      [n, b]
    ), h = u.useCallback(() => g((M) => !M), [g]), k = b ? "expanded" : "collapsed", _ = W() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = u.useMemo(
      () => ({
        state: k,
        open: b,
        setOpen: g,
...
const Eo = St(
  ...
  ({
    ...
    const p = t ? $t : "button", { state: c } = Ee(), f = /* @__PURE__ */ r(
      p,
      {
        ref: w,
    ...
    rr,
    {
      ...
      children: /* @__PURE__ */ l(or, { children: [
        /* @__PURE__ */ l(Le, { children: [
          ...
          /* @__PURE__ */ r(Ye, { children: /* @__PURE__ */ r(sr, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(ir, { children: /* @__PURE__ */ r(
            wr,
            {
              onClick: () => c(g),
              isActive: b(g),
...
function fi({
  ...
  const [p, c] = B([]), [f, b] = B([{ id: Nt, desc: !1 }]), [g, h] = B({}), k = q(
...
function bi({
  ...
  const p = Vt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), b = Vt(i, "%webView_scope_selector_current_book%"), g = Vt(i, "%webView_scope_selector_choose_books%"), h = Vt(i, "%webView_scope_selector_scope%"), k = Vt(i, "%webView_scope_selector_select_books%"), S = [
...
const Kt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, f) => c.order - f.order).map((c) => /* @__PURE__ */ l(pn, { children: [
...
function es({
  ...
  const o = Z(void 0), s = Z(void 0), i = Z(void 0), w = Z(void 0), p = Z(void 0), c = (f) => {
    switch (f) {
      case "platform.app":
        return s;
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (f, b) => {
    ...
    switch (b.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), Kt(w, [g, h]);
        break;
      case "alt+h":
        (_ = p.current) == null || _.focus(), Kt(p, [g, h]);
        break;
    }
  }), ct(() => {
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, f]) => typeof f == "object").sort(([, f], [, b]) => typeof f == "boolean" || typeof b == "boolean" ? 0 : f.order - b.order).map(([f, b]) => /* @__PURE__ */ l(Jo, { children: [
      /* @__PURE__ */ r(br, { ref: c(f), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        yr,
        {
          className: "tw-z-[250]",
...
function Ti({
  ...
  const p = ns(
    ...
    return S ? `${(z = t[h]) == null ? void 0 : z.autonym} (${S})` : (A = t[h]) == null ? void 0 : A.autonym;
  };
