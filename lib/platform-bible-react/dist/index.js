...
function Nc({
  ...
  var m;
  const [l, c] = ue([]), [d, p] = ue([]), [h, w] = ue({}), [g, v] = ue({}), f = ei({
    data: t,
    columns: e,
    getCoreRowModel: ti(),
...
function $m({
  ...
  return /* @__PURE__ */ x(bi, { open: c, onOpenChange: d, children: [
    /* @__PURE__ */ s(vi, { asChild: !0, children: /* @__PURE__ */ x(
      me,
      {
        variant: "outline",
    ...
    /* @__PURE__ */ s(so, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(lo, { children: [
      ...
      /* @__PURE__ */ x(po, { children: [
        /* @__PURE__ */ s(uo, { children: "No item found." }),
        /* @__PURE__ */ s(xi, { children: w.map((g) => {
...
function hw(e) {
  ...
  if (!(!a || !i)) {
    var h = mw(o.padding, n), w = _o(a), g = c === "y" ? Ce : Se, v = c === "y" ? je : Ve, f = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], m = i[c] - n.rects.reference[c], N = Pn(a), I = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, O = f / 2 - m / 2, E = h[g], b = I - w[p] - h[v], _ = I / 2 - w[p] / 2 + O, L = dn(E, _, b), H = c;
