...
import { c as b, g as Re, a as zr, C as Ge, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as Ie, f as ke, h as ze, i as kr, j as Be, B as J, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ke, r as Ce, o as xs, p as Kn, P as tr, q as _r, s as er, t as rr, v as Na, w as Ca, y as No, z as ar, E as Ea, F as Mt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as pr, W as ys, X as Ze, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as qn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Gn, aa as Ta, ab as Cs, ac as Yn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as Wn, al as Xn, am as Do, an as Os, ao as Jn, ap as Ba, aq as tn, ar as ja, as as Is, at as zs, au as Ps, av as As, aw as $s, ax as Fr, ay as Mo, az as Vs, aA as Ls } from "./resizable-OsY4GN1K.js";
import { aB as af, aC as of, aD as nf, aE as sf, aF as cf, aG as lf, aH as df, aI as wf, aJ as uf, aK as pf, aL as hf, aM as gf, aN as ff, aO as mf, aP as vf, aQ as bf, aR as xf, aS as yf, aT as kf, aU as _f, aV as Nf, aW as Cf, aX as Ef, aY as Tf, aZ as Sf, a_ as Rf, a$ as Df, b0 as Mf, b1 as Of, b2 as If, b3 as zf, b4 as Pf, b5 as Af, b6 as $f, b7 as Vf, b8 as Lf, b9 as Bf, ba as jf } from "./resizable-OsY4GN1K.js";
...
import { Section as Dt, compareScrRefs as ma, getChaptersForBook as xc, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as ia, formatRelativeDate as yc, sanitizeHtml as Io, NumberFormat as ni, formatBytes as kc, getCurrentLocale as _c, usfmMarkers as sa, isPlatformError as Nc, ABORTED as Cc, getErrorMessage as Ec, getFormatCallerFunction as Tc, deepEqual as Sc, isString as on, scrRefToBBBCCCVVV as Fa, defaultScrRef as Ua, formatScrRefRange as Rc, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as Dc } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Sa, useState as _, useEffect as W, useCallback as j, useId as co, useImperativeHandle as Mc, useLayoutEffect as Jt, Fragment as Kr, Component as Oc, createElement as cn, Suspense as Ic, forwardRef as ii } from "react";
import { IconSelector as si, IconCheck as Ra, IconChevronDown as zc, IconChevronUp as Pc, IconLayoutSidebar as Ac, IconLayoutSidebarRight as $c, IconChevronRight as ci, IconSearch as Vc, IconLoader as Lc, IconAlertOctagon as Bc, IconAlertTriangle as jc, IconInfoCircle as Fc, IconCircleCheck as Uc } from "@tabler/icons-react";
...
function nd({
  ...
  const [h, f] = _(!1), [m, x] = _(!1), g = co(), S = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, ad), P = re(s, od), T = (M) => {
...
function Ha({
  ...
  const T = Ce(), B = Ql(), [z, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    void 0
  ...
  const Qt = j(() => {
    ...
    const v = q;
    it(void 0), dt(void 0), v ? (I(v), rt("chapters"), Y("")) : et();
  }, [q, et]), ct = j(
    (v) => {
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    () => cd(U),
    [U]
  ), be = V(() => !w || !A || !A.chapterNum || !ir ? !1 : w(A.book, A.chapterNum) > 0, [w, A, ir]), sr = N === "books" && !St && !U.trim() && zt.size > 0, Aa = j(
    (v) => p ? mn(v, p) : !1,
    [p]
  ), Se = j(
    (v) => (H) => p ? ld(v, H, p) : !1,
    ...
    (v) => {
      ...
      if (!(!!H && !!((Wo = bt.current) != null && Wo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const $t = bt.current ? gd(bt.current) : [];
        if ($t.length === 0) {
                      ...
                      return (
                        ...
                        /* @__PURE__ */ a(Ke, { heading: nr(v), children: H.map((at) => /* @__PURE__ */ a(
                          Ci,
                          {
                            ...
                            dimmedDescription: zt.has(at) ? Wr(at) : void 0
                          },
                          at
                        )) }, v)
                      );
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bd = Di ? Jt : W, ra = { tag: zo };
...
const yd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : W;
...
const Td = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : W;
function Sd(t) {
...
function Id(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), f = Dd(t, e);
    var m, x;
...
let ba, Me = 0, xa = 0, Ud = 0, bo = 0, da = 0;
function _n(t) {
  if (st === void 0) return;
  let e = t.n;
...
function Hd(t) {
  ...
  Ii(this), st = t, this.f &= -2, 8 & this.f && Bo(this), Ma();
}
function ur(t, e) {
...
Wt.prototype.brand = jd, Wt.prototype.h = function() {
  return !0;
...
ue({ name: "@lexical/extension/DecoratorText", nodes: () => [$i], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = ae();
  if (fi(n) || _e(n)) for (const s of n.getNodes()) Gd(s) && s.toggleFormat(o);
  return !1;
}, mi) });
function Vi(t, e) {
  let r;
...
const Zd = ue({ config: or({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = Jd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const tw = /* @__PURE__ */ new Set(), Sn = ue({ build(t, e, r) {
...
const nw = ue({ name: "@lexical/react/ReactProvider" });
function iw() {
...
function uw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Uo(() => Oe(Ol(n), Ki(n)), [n]);
  }(o), u(ht, { children: [t, a(pw, { content: e }), a(ww, { editor: o, ErrorBoundary: r })] });
}
...
const gw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : W;
...
function xw(t, e) {
  ...
  return u(ht, { children: [a(vw, { editor: n, ...o, ref: e }), r != null && a(yw, { editor: n, content: r })] });
}
...
function Cw({
  ...
  const [e] = Te(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Nw(), l = () => {
  };
...
), Bw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ua = (t) => Bw(Io(t));
function pa({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function qw(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: f } = Hw({
    threadId: n,
    threadStatus: s,
    isSelected: o,
    activeComments: c,
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(qw, { ...q, conflictResolution: S }) : /* @__PURE__ */ a(rs, { ...q })
          },
          I.id
        );
      })
...
const iu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ht, { children: [
...
function su({
  ...
  return /* @__PURE__ */ u(Ie, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: iu(t, o, e) }) }) }),
...
function du({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: cu(t, r) }) }) }),
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: lu(t, r) }) })
    ] }) }),
...
function Nh({
  ...
  const [g, S] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      z !== "x" && R === "x" ? nt == null || nt.forEach((ct) => mu(ct)) : z === "x" && R !== "x" && (nt == null || nt.forEach((ct) => vu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (R) => {
    ...
    (R, K, X) => {
      ...
      Ts({
        ...
        onShowError: ($) => {
          (!Nc($) || $.code !== Cc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Ec($)}`
          );
        }
      });
    },
  ...
  return /* @__PURE__ */ u(ht, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ht, { children: xu(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Ro, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      je,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { className: o, children: _u(c.text) })
        ]
      },
...
function zh({
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Su(O, D, Y), [O, D, Y]), q = V(() => {
    var vt, pt;
    if (!B) return l;
...
const Du = "16rem", Mu = "3rem", os = Xt.createContext(void 0);
function Ia() {
...
function Lu({
  ...
  const c = t ? qr.Root : "button", { state: l } = Ia(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    Iu,
    {
      ...
      children: /* @__PURE__ */ u(Pu, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Au, { children: Object.entries(e).map(([g, S]) => /* @__PURE__ */ a($u, { children: /* @__PURE__ */ a(
            Lu,
            {
              onClick: () => p(g),
              isActive: x(g),
...
const Ve = "scrBook", ju = "scrRef", Je = "source", Fu = "details", Uu = "Scripture Reference", Ku = "Scripture Book", ns = "Type", Hu = "Details";
function qu(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Wh({
  ...
  }, B = (D, M) => D.getIsGrouped() ? "" : b("banded-row", M % 2 === 0 ? "even" : "odd"), z = (D, M, Y) => {
    ...
    !e && /* @__PURE__ */ u(
      vr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(yr, { position: "item-aligned", children: /* @__PURE__ */ a(Yw, { children: E.map((D) => /* @__PURE__ */ a(ge, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
...
function Jh({
  ...
  ] }), pt = e ? lt.filter((L) => e.includes(L.value)) : lt, It = g ?? Ua, Ht = h ?? It, wt = f ?? It, me = () => {
  ...
  ), Cr = Rt === "end", Er = Rt === "start", nr = "tw:text-muted-foreground", We = p === "dropdown" && K === "range", za = We ? et : Ut, Pa = We ? ct : x ? $e : me, Tr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
...
function ko({
  ...
  return /* @__PURE__ */ u(Ie, { variant: s, children: [
    ...
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: Pe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Kr, { children: [
...
const ap = Object.freeze([520, 420, 340]), ls = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = cs(n, ap), d = Ti() ?? l, w = d >= Ar.MINIMUM;
...
const op = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Trigger,
  {
    ref: r,
    ...e,
