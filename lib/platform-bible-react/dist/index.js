...
import Xl, { ThemeContext as Hl, internal_processStyles as Yl } from "@mui/styled-engine";
...
const xn = mt.Root, nr = mt.Trigger, bc = mt.Group, dh = mt.Portal, uh = mt.Sub, ph = mt.RadioGroup, vc = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ v(
  mt.SubTrigger,
  {
    ref: o,
    className: N(
...
function wh({ scrRef: t, handleSubmit: e, direction: n }) {
  const [r, o] = st(""), [a, s] = st(
    it.bookNumberToId(t.bookNum)
  ), [l, c] = st(t.chapterNum ?? 0), [u, d] = st(
    it.bookNumberToId(t.bookNum)
    ...
    Cc.forEach((P) => {
      const B = r.match(P);
      if (B) {
        const [q, H = void 0, z = void 0] = B.slice(1), tt = Pc(q);
    ...
    if (u === a) {
      ...
      l + z <= 0 || l + z > an(u) ? c(0) : z !== 0 && (c(l + z), P.preventDefault());
    }
  };
  return Kt(() => {
    a === u ? a === it.bookNumberToId(t.bookNum) ? c(t.chapterNum) : c(1) : c(0);
  }, [u, t.bookNum, t.chapterNum, a]), da(() => {
    y(f);
  }, [f]), da(() => {
    const P = setTimeout(() => {
      if (g && h.current && x.current) {
        const q = x.current.offsetTop - Sc;
    ...
    /* @__PURE__ */ i(nr, { asChild: !0, children: /* @__PURE__ */ i(
      ac,
      {
        ...
        handleKeyDown: O,
        handleOnClick: () => {
          s(it.bookNumberToId(t.bookNum)), d(it.bookNumberToId(t.bookNum)), c(t.chapterNum > 0 ? t.chapterNum : 0), w(!0), m.current.focus();
        },
        onFocus: () => {
          T.current = !0;
        },
        ...
        children: /* @__PURE__ */ v("div", { dir: n, className: N({ "tw-ps-2": n === "rtl" }), children: [
          ...
          fa.map(
            (P, B) => $(P).length > 0 && /* @__PURE__ */ v("div", { children: [
              /* @__PURE__ */ i(_n, { className: "tw-font-semibold tw-text-foreground/80", children: Tc[P] }),
...
const Mc = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ v(Ac, { children: [
  /* @__PURE__ */ i(Pi, {}),
  /* @__PURE__ */ v(
    Jt.Content,
    {
      ...
      wt,
      {
        ...
        children: [
          /* @__PURE__ */ v("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ i("span", { className: "tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: a ? l(a) : u })
          ] }),
    ...
    /* @__PURE__ */ i(
      yo,
      {
        ...
        children: /* @__PURE__ */ v(xo, { children: [
          /* @__PURE__ */ i(No, { dir: y, placeholder: d, className: "tw-text-inherit" }),
...
function mh({
  ...
  const f = Dr(u, "%webView_bookSelector_currentBook%"), w = Dr(u, "%webView_bookSelector_choose%"), g = Dr(u, "%webView_bookSelector_chooseBooks%"), [y, m] = st(
    "current book"
    /* CURRENT_BOOK */
  ), h = (x) => {
    m(x), t(x);
...
function Fc({ table: t }) {
  return /* @__PURE__ */ v(xn, { children: [
    /* @__PURE__ */ i(Ml, { asChild: !0, children: /* @__PURE__ */ v(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Nn = vt.Root, Uc = vt.Group, kn = vt.Value, Fe = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ v(
  vt.Trigger,
  {
    ref: r,
    className: N(
...
Xc.displayName = vt.Separator.displayName;
function Hc({ table: t }) {
...
function qc({
  ...
  var h;
  const [l, c] = st([]), [u, d] = st([]), [f, w] = st({}), [g, y] = st({}), m = wi({
    data: e,
    columns: t,
    getCoreRowModel: fi(),
...
const fr = (t) => t === "asc" ? /* @__PURE__ */ i(vl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(yl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), hh = (t) => ({
  ...
  let s = [...n];
  t.forEach((c) => {
    e === "approved" ? s.includes(c) || s.push(c) : s = s.filter((u) => u !== c);
  }), r(s);
  let l = [...o];
  t.forEach((c) => {
    e === "unapproved" ? l.includes(c) || l.push(c) : l = l.filter((u) => u !== c);
  }), a(l);
}, bh = (t, e, n, r, o, a = "ltr") => ({
  accessorKey: "status",
  ...
  return Jc(t).forEach((d) => {
    d.startsWith("\\id") && (s = Zc(d), l = 0, c = 0), d.startsWith("\\c") && (l = ma(d), c = 0), d.startsWith("\\v") && (c = ma(d), l === 0 && (l = e.chapterNum));
    let f = o.exec(d) ?? void 0;
    for (; f; ) {
      const w = [];
      ...
      const g = f.index, y = a.find((h) => ho(h.items, w)), m = {
        ...
        text: Bl(d, Math.max(0, g - 25), Math.min(g + 25, d.length))
      };
      if (y)
...
function yh({
  ...
  const w = ee(n, "%webView_inventory_all%"), g = ee(n, "%webView_inventory_approved%"), y = ee(n, "%webView_inventory_unapproved%"), m = ee(n, "%webView_inventory_unknown%"), h = ee(n, "%webView_inventory_scope_currentBook%"), x = ee(n, "%webView_inventory_scope_chapter%"), $ = ee(n, "%webView_inventory_scope_verse%"), _ = ee(n, "%webView_inventory_filter_text%"), T = ee(
    n,
    "%webView_inventory_show_additional_items%"
  ), [b, I] = st(!1), [F, J] = st("all"), [O, A] = st(""), [D, P] = st([]), B = Nt(() => l ? r instanceof RegExp ? rd(
    l,
    t,
    a,
    s,
    ...
    return [...U, ...d];
  }, [o == null ? void 0 : o.tableHeaders, d, b]);
  Kt(() => {
    P([]);
  }, [H]);
  const tt = (E, U) => {
...
function xh({
  ...
  return /* @__PURE__ */ v(Ri, { open: d, onOpenChange: f, children: [
    /* @__PURE__ */ i(_i, { asChild: !0, children: /* @__PURE__ */ v(
      wt,
      {
        variant: "outline",
    ...
    /* @__PURE__ */ i(yo, { align: "start", className: "tw-w-full tw-p-0", dir: u, children: /* @__PURE__ */ v(xo, { children: [
...
const Gi = S.forwardRef(
  ({
    ...
    const [c, u] = S.useState(t), d = e ?? c, f = S.useCallback(
      (m) => {
        const h = typeof m == "function" ? m(d) : m;
        n ? n(h) : u(h);
      },
      [n, d]
    ), w = S.useCallback(() => f((m) => !m), [f]), g = d ? "expanded" : "collapsed", y = S.useMemo(
      () => ({
        state: g,
        open: d,
        setOpen: f,
    ...
    return /* @__PURE__ */ i(Ui.Provider, { value: y, children: /* @__PURE__ */ i(ad, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const gd = Je(
  ...
  ({
    ...
    const c = t ? Ke : "button", { state: u } = mr(), d = /* @__PURE__ */ i(
      c,
      {
        ref: l,
    ...
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ v(id, { children: [
      /* @__PURE__ */ i(sd, { asChild: !0, children: d }),
      /* @__PURE__ */ i(Fi, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : d;
  }
);
          ...
          /* @__PURE__ */ i(ro, { children: /* @__PURE__ */ i(Wi, { children: e.map((f) => /* @__PURE__ */ i(qi, { children: /* @__PURE__ */ i(
            Ki,
            {
              className: N(
                ...
                { "tw-bg-white tw-text-gray-900 tw-shadow-sm": d(f) }
              ),
              onClick: () => c(f),
              isActive: d(f),
...
function Eh({
  ...
  const [u, d] = st([]), [f, w] = st([{ id: ie, desc: !1 }]), [g, y] = st({}), m = Nt(
    ...
    !e && /* @__PURE__ */ v(
      Nn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ue, { position: "item-aligned", children: /* @__PURE__ */ i(Uc, { children: T.map((O) => /* @__PURE__ */ i(Ht, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
                  ...
                  children: (() => D.getIsGrouped() ? /* @__PURE__ */ v(
                    wt,
                    {
                      ...
                      children: [
                        ...
                        !O.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ i(ci, {}) : /* @__PURE__ */ i(El, {})),
                        " ",
...
function Md() {
  ...
  return lt.AsyncMode = c, lt.ConcurrentMode = u, lt.ContextConsumer = l, lt.ContextProvider = s, lt.Element = e, lt.ForwardRef = d, lt.Fragment = r, lt.Lazy = y, lt.Memo = g, lt.Portal = n, lt.Profiler = a, lt.StrictMode = o, lt.Suspense = f, lt.isAsyncMode = function(b) {
    return T(b) || _(b) === c;
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === u || b === a || b === o || b === f || b === w || typeof b == "object" && b !== null && (b.$$typeof === y || b.$$typeof === g || b.$$typeof === s || b.$$typeof === l || b.$$typeof === d || b.$$typeof === h || b.$$typeof === x || b.$$typeof === $ || b.$$typeof === m);
  }, lt.typeOf = _, lt;
}
var ct = {};
/** @license React v16.13.1
...
function Dd() {
  return va || (va = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function _(C) {
      ...
      C === r || C === u || C === a || C === o || C === f || C === w || typeof C == "object" && C !== null && (C.$$typeof === y || C.$$typeof === g || C.$$typeof === s || C.$$typeof === l || C.$$typeof === d || C.$$typeof === h || C.$$typeof === x || C.$$typeof === $ || C.$$typeof === m);
    }
    function T(C) {
    ...
    var b = c, I = u, F = l, J = s, O = e, A = d, D = r, P = y, B = g, q = n, H = a, z = o, tt = f, rt = !1;
    function at(C) {
...
var ya;
function ts() {
  return ya || (ya = 1, process.env.NODE_ENV === "production" ? Hn.exports = Md() : Hn.exports = Dd()), Hn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Yd() {
  ...
  return dt.ContextConsumer = s, dt.ContextProvider = a, dt.Element = t, dt.ForwardRef = c, dt.Fragment = n, dt.Lazy = w, dt.Memo = f, dt.Portal = e, dt.Profiler = o, dt.StrictMode = r, dt.Suspense = u, dt.SuspenseList = d, dt.isAsyncMode = function() {
    return !1;
    ...
    return typeof h == "string" || typeof h == "function" || h === n || h === o || h === r || h === u || h === d || h === g || typeof h == "object" && h !== null && (h.$$typeof === w || h.$$typeof === f || h.$$typeof === a || h.$$typeof === s || h.$$typeof === c || h.$$typeof === y || h.getModuleId !== void 0);
  }, dt.typeOf = m, dt;
}
var ut = {};
/**
...
function Wd() {
  return Oa || (Oa = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), y = !1, m = !1, h = !1, x = !1, $ = !1, _;
    _ = Symbol.for("react.module.reference");
    function T(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || $ || V === r || V === u || V === d || x || V === g || y || m || h || typeof V == "object" && V !== null && (V.$$typeof === w || V.$$typeof === f || V.$$typeof === a || V.$$typeof === s || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    var I = s, F = a, J = t, O = c, A = n, D = w, P = f, B = e, q = o, H = r, z = u, tt = d, rt = !1, at = !1;
    function k(V) {
...
function ou(t, e) {
  ...
  return (o) => (a, s, l, c, u, ...d) => {
    const f = u || s, w = n == null ? void 0 : n[f];
    if (w) {
      const g = w(a, s, l, c, u, ...d);
      if (g)
        return g;
    }
...
const au = typeof window < "u" ? j.useLayoutEffect : j.useEffect, Xe = au;
let Pa = 0;
function iu(t) {
...
`));
    ...
    j.useEffect(() => {
      !o && u !== e && console.error([`MUI: A component is changing the default ${r} state of an uncontrolled ${n} after being initialized. To suppress this warning opt to use a controlled ${n}.`].join(`
`));
    }, [JSON.stringify(e)]);
  }
...
function hu(t) {
  t.addEventListener("keydown", fu, !0), t.addEventListener("mousedown", Hr, !0), t.addEventListener("pointerdown", Hr, !0), t.addEventListener("touchstart", Hr, !0), t.addEventListener("visibilitychange", mu, !0);
}
function gu(t) {
  const {
    target: e
...
function ku(t) {
  ...
  function d(w) {
    return s.indexOf(w) + 1 < s.length ? u(w, s[s.indexOf(w) + 1]) : l(w);
  }
  function f(w) {
    const g = s.indexOf(w);
    return g === 0 ? l(s[1]) : g === s.length - 1 ? c(s[g]) : u(w, s[s.indexOf(w) + 1]).replace("@media", "@media not all and");
  }
  return M({
    keys: s,
    values: a,
...
function yt(t) {
  const {
    ...
    if (s[e] == null)
      return null;
    const l = s[e], c = s.theme, u = br(c, r) || {};
    return re(s, l, (f) => {
      let w = sr(u, o, f);
      return f === w && typeof f == "string" && (w = sr(u, o, `${e}${f === "default" ? "" : Zt(f)}`, f)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
const Bu = Ut("border", Vt), ju = Ut("borderTop", Vt), Vu = Ut("borderRight", Vt), zu = Ut("borderBottom", Vt), Lu = Ut("borderLeft", Vt), Fu = Ut("borderColor"), Uu = Ut("borderTopColor"), Gu = Ut("borderRightColor"), Xu = Ut("borderBottomColor"), Hu = Ut("borderLeftColor"), Yu = Ut("outline", Vt), Wu = Ut("outlineColor"), Nr = (t) => {
...
xr(Bu, ju, Vu, zu, Lu, Fu, Uu, Gu, Xu, Hu, Nr, Yu, Wu);
const kr = (t) => {
...
function hp() {
  function t(n, r, o, a) {
    ...
    return f ? f(s) : re(s, r, (y) => {
      let m = sr(w, d, y);
      return y === m && typeof y == "string" && (m = sr(w, d, `${n}${y === "default" ? "" : Zt(y)}`, y)), c === !1 ? m : {
        [c]: m
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!u)
        return null;
      const d = Cu(a.breakpoints), f = Object.keys(d);
      let w = d;
...
function Do(t = {}, ...e) {
  ...
  return u.applyStyles = gp, u = e.reduce((d, f) => ne(d, f), u), u.unstable_sxConfig = M({}, Ao, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Mo({
      sx: f,
      theme: this
    });
...
function Qn(t, e) {
  ...
  if (o && typeof o == "object" && Array.isArray(o.variants)) {
    ...
    return a.forEach((c) => {
      ...
      }), u && (Array.isArray(l) || (l = [l]), l.push(typeof c.style == "function" ? c.style(M({
        ownerState: n
      }, r, n)) : c.style));
    }), l;
  }
...
function Op(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    Yl(s, (b) => b.filter((I) => !(I != null && I.__mui_systemSx)));
    const {
      name: c,
      slot: u,
      ...
      overridesResolver: w = Cp(Ba(u))
    } = l, g = kt(l, kp), y = d !== void 0 ? d : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      u && u !== "Root" && u !== "root" || !1
    ), m = f || !1;
    let h;
    process.env.NODE_ENV !== "production" && c && (h = `${c}-${Ba(u || "Root")}`);
    let x = Zn;
    u === "Root" || u === "root" ? x = r : u ? x = o : Tp(s) && (x = void 0);
    const $ = Xl(s, M({
      shouldForwardProp: x,
      label: h
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Zt(u || "")}`), D === void 0 && (D = `Styled(${Jd(s)})`), A.displayName = D;
      }
...
function $p(t) {
  ...
  const {
    values: e
  } = t, n = e[0], r = e[1] / 100, o = e[2] / 100, a = r * Math.min(o, 1 - o), s = (u, d = (u + n / 30) % 12) => o - a * Math.max(Math.min(d - 3, 9 - d, 1), -1);
  let l = "rgb";
...
const Dp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, De = Gp, Xp = ["mode", "contrastThreshold", "tonalOffset"], za = {
...
function Zp(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = kt(t, Xp), a = t.primary || Hp(e), s = t.secondary || Yp(e), l = t.error || Wp(e), c = t.info || qp(e), u = t.success || Kp(e), d = t.warning || Jp(e);
  function f(m) {
...
function ew(t, e) {
  ...
  const g = o / 14, y = f || ((x) => `${x / u * g}rem`), m = (x, $, _, T, b) => M({
    fontFamily: r,
    fontWeight: x,
    fontSize: y($),
...
function uw(t) {
  ...
  return M({
    ...
    create: (o = ["all"], a = {}) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        const d = (w) => typeof w == "string", f = (w) => !isNaN(parseFloat(w));
...
`)), Object.keys(u).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(u).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((d) => `${d} ${typeof s == "string" ? s : Ga(s)} ${l} ${typeof c == "string" ? c : Ga(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
function mw(t = {}, ...e) {
  ...
  if (u = ne(u, s), u = e.reduce((d, f) => ne(d, f), u), process.env.NODE_ENV !== "production") {
    const d = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], f = (w, g) => {
      let y;
      for (y in w) {
        const m = w[y];
...
`));
    ...
    Object.keys(u.components).forEach((w) => {
      const g = u.components[w].styleOverrides;
      g && w.indexOf("Mui") === 0 && f(g, w);
    });
  }
  return u.unstable_sxConfig = M({}, Ao, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Mo({
      sx: f,
      theme: this
    });
...
const yw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], xw = (t) => {
  ...
  return {
    ...
    fontSize: {
      ...
      large: ((u = t.typography) == null || (d = u.pxToRem) == null ? void 0 : d.call(u, 35)) || "2.1875rem"
    }[e.fontSize],
  ...
  const r = zo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, yw), y = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", m = M({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Dw(t) {
  ...
  const s = Aw(M({}, o, r)), l = Ya(r), c = Ya(o), u = e(s), d = ye(u == null ? void 0 : u.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = M({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = M({}, u, n, c, l);
  return d.length > 0 && (w.className = d), Object.keys(f).length > 0 && (w.style = f), {
    props: w,
    internalRef: u.ref
  };
}
...
function jw(t) {
  ...
  const {
    ...
    externalSlotProps: l
  })), d = ke(u, l == null ? void 0 : l.ref, (e = t.additionalProps) == null ? void 0 : e.ref);
  return pn(n, M({}, c, {
    ref: d
  }), o);
}
...
const lr = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  if (Xe(() => {
    ...
    if (/* @__PURE__ */ j.isValidElement(r)) {
      ...
      return /* @__PURE__ */ j.cloneElement(r, u);
    }
...
process.env.NODE_ENV !== "production" && (lr["propTypes"] = Hd(lr.propTypes));
var Ct = "top", Lt = "bottom", Ft = "right", Ot = "left", Fo = "auto", Vn = [Ct, Lt, Ft, Ot], He = "start", Sn = "end", Uw = "clippingParents", Es = "viewport", ln = "popper", Gw = "reference", Wa = /* @__PURE__ */ Vn.reduce(function(t, e) {
  return t.concat([e + "-" + He, e + "-" + Sn]);
}, []), Ts = /* @__PURE__ */ [].concat(Vn, [Fo]).reduce(function(t, e) {
  return t.concat([e, e + "-" + He, e + "-" + Sn]);
}, []), Xw = "beforeRead", Hw = "read", Yw = "afterRead", Ww = "beforeMain", qw = "main", Kw = "afterMain", Jw = "beforeWrite", Zw = "write", Qw = "afterWrite", tf = [Xw, Hw, Yw, Ww, qw, Kw, Jw, Zw, Qw];
function Qt(t) {
...
function nf(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      var o = e.elements[r], a = e.attributes[r] || {}, s = Object.keys(e.styles.hasOwnProperty(r) ? e.styles[r] : n[r]), l = s.reduce(function(c, u) {
        return c[u] = "", c;
      }, {});
...
function We(t, e, n) {
  ...
  var s = Te(t) ? Dt(t) : window, l = s.visualViewport, c = !Ss() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, d = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: d,
...
function cf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = qt(n.placement), c = Xo(l), u = [Ot, Ft].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!a || !s)) {
    var f = lf(o.padding, n), w = Go(a), g = c === "y" ? Ct : Ot, y = c === "y" ? Lt : Ft, m = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], h = s[c] - n.rects.reference[c], x = zn(a), $ = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, _ = m / 2 - h / 2, T = f[g], b = $ - w[d] - f[y], I = $ / 2 - w[d] / 2 + _, F = gn(T, I, b), J = c;
...
function Ka(t) {
  var e, n = t.popper, r = t.popperRect, o = t.placement, a = t.variation, s = t.offsets, l = t.position, c = t.gpuAcceleration, u = t.adaptive, d = t.roundOffsets, f = t.isFixed, w = s.x, g = w === void 0 ? 0 : w, y = s.y, m = y === void 0 ? 0 : y, h = typeof d == "function" ? d({
    x: g,
    y: m
  }) : {
    x: g,
...
function ff(t) {
  var e = t.state, n = t.options, r = n.gpuAcceleration, o = r === void 0 ? !0 : r, a = n.adaptive, s = a === void 0 ? !0 : a, l = n.roundOffsets, c = l === void 0 ? !0 : l, u = {
  ...
  e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, Ka(Object.assign({}, u, {
    offsets: e.modifiersData.popperOffsets,
    position: e.options.strategy,
    adaptive: s,
    roundOffsets: c
  })))), e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, Ka(Object.assign({}, u, {
...
function hf(t) {
  var e = t.state, n = t.instance, r = t.options, o = r.scroll, a = o === void 0 ? !0 : o, s = r.resize, l = s === void 0 ? !0 : s, c = Dt(e.elements.popper), u = [].concat(e.scrollParents.reference, e.scrollParents.popper);
  return a && u.forEach(function(d) {
    d.addEventListener("scroll", n.update, Wn);
  }), l && c.addEventListener("resize", n.update, Wn), function() {
    a && u.forEach(function(d) {
      d.removeEventListener("scroll", n.update, Wn);
...
function yf(t, e) {
  ...
  if (o) {
    ...
    var u = Ss();
    (u || !u && e === "fixed") && (l = o.offsetLeft, c = o.offsetTop);
  }
  return {
    width: a,
    height: s,
...
function Ef(t, e, n, r) {
  var o = e === "clippingParents" ? kf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, u) {
    var d = Za(t, u, r);
    return c.top = xe(d.top, c.top), c.right = cr(d.right, c.right), c.bottom = cr(d.bottom, c.bottom), c.left = xe(d.left, c.left), c;
  }, Za(t, s, r));
...
function Cn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Uw : l, u = n.rootBoundary, d = u === void 0 ? Es : u, f = n.elementContext, w = f === void 0 ? ln : f, g = n.altBoundary, y = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, x = Rs(typeof h != "number" ? h : _s(h, Vn)), $ = w === ln ? Gw : ln, _ = t.rects.popper, T = t.elements[y ? $ : w], b = Ef(Te(T) ? T : T.contextElement || de(t.elements.popper), c, d, s), I = We(t.elements.reference), F = $s({
    reference: I,
    element: _,
    strategy: "absolute",
    placement: o
...
function Tf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? Ts : c, d = qe(r), f = d ? l ? Wa : Wa.filter(function(y) {
    return qe(y) === d;
...
function Cf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, y = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, x = qt(h), $ = x === h, _ = c || ($ || !y ? [tr(h)] : Sf(h)), T = [h].concat(_).reduce(function(G, W) {
      return G.concat(qt(W) === Fo ? Tf(e, {
        placement: W,
        boundary: d,
        rootBoundary: f,
        padding: u,
...
function Rf(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, s = Cn(e, {
    ...
    altBoundary: !0
  }), c = Qa(s, r), u = Qa(l, o, a), d = ti(c), f = ti(u);
  e.modifiersData[n] = {
...
function $f(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, s = Ts.reduce(function(d, f) {
    return d[f] = Pf(f, e.rects, a), d;
  }, {}), l = s[e.placement], c = l.x, u = l.y;
  e.modifiersData.popperOffsets != null && (e.modifiersData.popperOffsets.x += c, e.modifiersData.popperOffsets.y += u), e.modifiersData[r] = s;
}
const If = {
  name: "offset",
  enabled: !0,
...
function Bf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, y = n.tetherOffset, m = y === void 0 ? 0 : y, h = Cn(e, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), x = qt(e.placement), $ = qe(e.placement), _ = !$, T = Xo(x), b = Df(T), I = e.modifiersData.popperOffsets, F = e.rects.reference, J = e.rects.popper, O = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, A = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if (I) {
    ...
    if (l) {
      var ue, Tt = T === "x" ? Ct : Ot, Ln = T === "x" ? Lt : Ft, Xt = I[b], Oe = b === "y" ? "height" : "width", pe = Xt + h[Tt], Re = Xt - h[Ln], _e = [Ct, Ot].indexOf(x) !== -1, Pe = (ue = D == null ? void 0 : D[b]) != null ? ue : 0, we = _e ? pe : Xt - F[Oe] - J[Oe] - Pe + A.altAxis, Qe = _e ? Xt + F[Oe] + J[Oe] - Pe - A.altAxis : Re, Fn = g && _e ? sf(we, Xt, Qe) : gn(g ? we : pe, Xt, g ? Qe : Re);
      I[b] = Fn, P[b] = Fn - Xt;
    }
    e.modifiersData[r] = P;
  }
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      setOptions: function(x) {
        ...
        m(), d.options = Object.assign({}, a, d.options, $), d.scrollParents = {
          reference: Te(l) ? bn(l) : l.contextElement ? bn(l.contextElement) : [],
          popper: bn(c)
        };
        var _ = Gf(Hf([].concat(r, d.options.modifiers)));
        return d.orderedModifiers = _.filter(function(T) {
          return T.enabled;
        }), y(), g.update();
      },
      ...
      forceUpdate: function() {
        if (!w) {
          var x = d.elements, $ = x.reference, _ = x.popper;
          if (ni($, _)) {
            d.rects = {
              reference: Ff($, zn(_), d.options.strategy === "fixed"),
              popper: Go(_)
            ...
            for (var T = 0; T < d.orderedModifiers.length; T++) {
              ...
              var b = d.orderedModifiers[T], I = b.fn, F = b.options, J = F === void 0 ? {} : F, O = b.name;
    ...
    g.setOptions(u).then(function(h) {
      !w && u.onFirstUpdate && u.onFirstUpdate(h);
    });
    function y() {
...
const em = () => Po({
  ...
  } = e, h = kt(e, Jf), x = j.useRef(null), $ = ke(x, n), _ = j.useRef(null), T = ke(_, w), b = j.useRef(T);
  Xe(() => {
    b.current = T;
  }, [T]), j.useImperativeHandle(w, () => _.current, []);
  const I = Qf(d, s), [F, J] = j.useState(I), [O, A] = j.useState(dr(o));
  j.useEffect(() => {
...
`));
  ...
  const P = em(), B = (r = y.root) != null ? r : "div", q = jw({
    elementType: B,
  ...
  const J = !d && c && (!m || _) ? "none" : void 0, O = m ? {
    in: d,
    onEnter: b,
    onExited: I
  } : void 0;
...
var im = function(e) {
  ...
  return n.componentDidMount = function() {
    ...
    var a = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Xn.findDOMNode(this), l], u = c[0], d = c[1], f = this.getTimeouts(), w = l ? f.appear : f.enter;
    if (!o && !s || ri.disabled) {
      this.safeSetState({
        status: je
      }, function() {
    ...
    this.props.onEnter(u, d), this.safeSetState({
      ...
      a.props.onEntering(u, d), a.onTransitionEnd(w, function() {
        a.safeSetState({
          status: je
        }, function() {
...
const dm = {
  ...
  } = e, x = kt(e, cm), $ = un(), _ = j.useRef(), T = Ms(), b = j.useRef(null), I = ke(b, a.ref, n), F = (H) => (z) => {
    if (H) {
      const tt = b.current;
...
const ai = qo, um = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], pm = jn(As, {
  ...
  const o = gs(), a = zo({
    ...
    slots: _,
    slotProps: T
  } = a, b = kt(a, um), I = (r = _ == null ? void 0 : _.root) != null ? r : c == null ? void 0 : c.Root, F = M({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: w,
...
const Vs = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r, o, a, s, l, c, u, d, f, w, g, y, m, h, x, $, _, T, b;
  const I = zo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: ft
  } = I, V = kt(I, mm), xt = /* @__PURE__ */ j.isValidElement(J) ? J : /* @__PURE__ */ i("span", {
    children: J
...
`));
  const el = j.useMemo(() => {
    ...
    touch: pe.current
  }), Ir = gm(rn), ia = (r = (o = R.popper) != null ? o : O.Popper) != null ? r : bm, sa = (a = (s = (l = R.transition) != null ? l : O.Transition) != null ? s : C) != null ? a : ai, la = (c = (u = R.tooltip) != null ? u : O.Tooltip) != null ? c : vm, ca = (d = (f = R.arrow) != null ? f : O.Arrow) != null ? d : ym, nl = pn(ia, M({}, K, (w = Q.popper) != null ? w : A.popper, {
...
function zs(t) {
  ...
  return r ? /* @__PURE__ */ i(xm, { title: r, placement: "right", children: /* @__PURE__ */ i("div", { children: x }) }) : x;
}
function Ls(t) {
  return Object.entries(t.groups).map(([n, r]) => ({ id: n, group: r }));
}
function Nm(t) {
  const [e, n] = st(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = t, s = (u) => {
    n(u.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
    let u = Ls(a).filter((d) => "menuItem" in d.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return u = u.filter(
      (d) => "menuItem" in d.group && d.group.menuItem === r.id
    ), /* @__PURE__ */ i(Fs, { ...t, includedGroups: u });
  };
  return /* @__PURE__ */ v(le, { children: [
...
function Fs(t) {
  ...
  }, [o, e]), l = ({ item: d, isLastItemInGroup: f }) => ({
  ...
  return /* @__PURE__ */ i("div", { role: "menu", "aria-label": u, children: a.map((d, f) => {
...
function Rm({
  ...
  const [c, u] = st(!1), [d, f] = st(!1), w = Et(() => {
    c && u(!1), f(!1);
  }, [c]), g = Et((T) => {
    T.stopPropagation(), u((b) => {
      const I = !b;
...
function $h({
  ...
  const a = ve(void 0);
  return /* @__PURE__ */ i("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ i(Ql, { position: "static", id: r, children: /* @__PURE__ */ v(
    tc,
    {
...
const Dm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ v(
  dn.Root,
  {
    ref: n,
    className: N(
...
const Bm = S.forwardRef(({ className: t, direction: e, ...n }, r) => /* @__PURE__ */ i(
  Qr.Root,
  {
    className: N(
...
function Um({ id: t, versionHistory: e }) {
  ...
  function a(l) {
    const c = new Date(l), u = new Date(o.getTime() - c.getTime()), d = u.getUTCFullYear() - 1970, f = u.getUTCMonth(), w = u.getUTCDate() - 1;
    let g = "";
    return d > 0 ? g = `${d.toString()} year${d === 1 ? "" : "s"} ago` : f > 0 ? g = `${f.toString()} month${f === 1 ? "" : "s"} ago` : w === 0 ? g = "today" : g = `${w.toString()} day${w === 1 ? "" : "s"} ago`, g;
  }
...
}, li = (t, e, n) => /* @__PURE__ */ i(wt, { variant: "outline", onClick: () => n(t.dblEntryUid, "install"), children: e }), Xm = (t, e, n, r, o, a) => e.includes(t.dblEntryUid) ? /* @__PURE__ */ i(wt, { variant: "outline", children: /* @__PURE__ */ i(Ce, { className: "tw-h-5 tw-py-[1px]" }) }) : t.installed ? t.updateAvailable ? li(t, r, a) : /* @__PURE__ */ i(Mt, { className: "tw-my-2 tw-flex tw-h-6 tw-items-center", children: o }) : li(t, n, a);
function Hh({
  localizedStrings: t,
  dblResources: e,
  ...
  const d = t["%resources_action%"], f = t["%resources_dialog_subtitle%"], w = t["%resources_dialog_title%"], g = t["%resources_filterInput%"], y = t["%resources_fullName%"], m = t["%resources_get%"], h = t["%resources_installed%"], x = t["%resources_language%"], $ = t["%resources_languageFilter%"], _ = t["%resources_loadingResources%"], T = t["%resources_noResults%"], b = t["%resources_open%"], I = t["%resources_remove%"], F = t["%resources_size%"], J = t["%resources_type%"], O = t["%resources_type_DBL%"], A = t["%resources_type_ER%"], D = t["%resources_type_SLR%"], P = t["%resources_type_XR%"], B = t["%resources_type_unknown%"], q = t["%resources_update%"], [H, z] = st([]), tt = (R, X) => {
    ...
    z((V) => [...V, C]), (X === "install" ? c : u)(R).catch((V) => {
      console.debug(zl(V));
    });
  };
  Kt(() => {
