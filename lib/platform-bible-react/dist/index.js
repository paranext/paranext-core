...
import { getChaptersForBook as fr, NumberFormat as br, formatBytes as vr, deepEqual as xe, substring as xr, formatScrRef as re, compareScrRefs as le, scrRefToBBBCCCVVV as ae, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
const Jt = V.Root, ye = V.Trigger, tn = V.Group, Ir = V.Portal, Mr = V.Sub, qo = V.RadioGroup, en = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  V.SubTrigger,
  {
    ref: o,
    className: l(
...
function da({ table: t }) {
  return /* @__PURE__ */ d(Jt, { children: [
    /* @__PURE__ */ r(Ln, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const $t = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(Qn, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function Qo({
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r($t, { size: 15 }) : /* @__PURE__ */ d(ft, { children: [
...
const te = (t) => t === "asc" ? /* @__PURE__ */ r(lr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(cr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ls = (t) => ({
  ...
  return Sa(t).forEach((m) => {
    m.startsWith("\\id") && (w = Ra(m), i = 0, p = 0), m.startsWith("\\c") && (i = $e(m), p = 0), m.startsWith("\\v") && (p = $e(m), i === 0 && (i = e.chapterNum));
...
function us({
  ...
  }, [j, Et]), C = Q(() => Ea(dt, rt, b), [dt, rt, b]), E = Q(() => {
    var st, ct;
    if (!j) return m;
...
const Ya = c.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
Ya.displayName = "SidebarMenuSkeleton";
...
function xs({
  ...
  return /* @__PURE__ */ d(Jt, { children: [
    ...
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, i]) => typeof w == "boolean" || typeof i == "boolean" ? 0 : w.order - i.order).map(([w], i, p) => /* @__PURE__ */ d(ft, { children: [
      /* @__PURE__ */ r(tn, { children: /* @__PURE__ */ r(Oe, { children: In(e.groups, e.items, w, t) }) }, w),
