...
import u, { forwardRef as ce, useState as B, createContext as Mr, useContext as Or, useCallback as $, useRef as q, useMemo as J, useEffect as dt, useLayoutEffect as gn, Fragment as Dn } from "react";
import { Check as Ct, CircleSlash as zr, ChevronRight as Ue, Circle as qe, X as Je, Search as Vn, ChevronsUpDown as We, FilterIcon as Br, ChevronDown as pe, ChevronUp as Ir, ArrowLeftIcon as Ar, ChevronLeftIcon as Pr, ChevronRightIcon as jr, ArrowRightIcon as Fr, Copy as Xr, Filter as Gr, User as $r, Link as Lr, CircleHelp as Hr, Star as Yr, CircleCheckIcon as Kr, CircleXIcon as Ur, CircleHelpIcon as qr, ArrowUpIcon as Jr, ArrowDownIcon as Wr, ArrowUpDownIcon as Zr, PanelLeft as Qr, PanelRight as ta, ScrollText as ea, ChevronLeft as na, MenuIcon as ra, Menu as aa, EllipsisVertical as oa, LoaderCircle as sa } from "lucide-react";
...
import { formatScrRef as Mt, MODIFIER_KEYS as bn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Ze, isString as Me, compareScrRefs as je, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
import { useReactTable as On, getFilteredRowModel as ua, getSortedRowModel as zn, getPaginationRowModel as ma, getCoreRowModel as Bn, flexRender as Jt, getGroupedRowModel as ha, getExpandedRowModel as fa } from "@tanstack/react-table";
...
import * as In from "@radix-ui/react-toggle";
    ...
    return /* @__PURE__ */ l("div", { className: "tw-relative tw-max-w-48", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          ...
          onFocus: (m) => {
            var h;
            v(!0), (h = c.onFocus) == null || h.call(c, m);
          },
          onBlur: (m) => {
            var h;
            v(!1), (h = c.onBlur) == null || h.call(c, m);
          },
          ref: p
        }
      ),
...
const jn = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    X.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ r(Ue, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
...
jt.displayName = X.Separator.displayName;
...
const et = class M {
    ...
    if (E(this, "firstChapter"), E(this, "lastChapter"), E(this, "lastVerse"), E(this, "hasSegmentsDefined"), E(this, "text"), E(this, "BBBCCCVVVS"), E(this, "longHashCode"), E(this, "versification"), E(this, "rtlMark", "‏"), E(this, "_bookNum", 0), E(this, "_chapterNum", 0), E(this, "_verseNum", 0), E(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof M) {
          ...
          if (e == null) return;
          const s = e instanceof Dt ? e : M.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new Dt(i)), n ? new M(n, a.toString(), w, c) : new M();
  }
  /**
...
function ja({
  ...
  const i = Array.from({ length: e }, (c, p) => p + 1), w = $(
    (c) => {
      o(c);
    },
    [o]
...
const yn = 6, on = O.allBookIds.filter((t) => !O.isObsolete(O.bookIdToNumber(t))), Un = Object.fromEntries(
...
function Ws({
  ...
  const o = Z(), [s, i] = B(
    () => Mt(t, "English")
  ), [w, c] = B(""), [p, g] = B(t.book), [v, m] = B(t.chapterNum ?? 0), [h, x] = B(t.book), [C, y] = B(!1), [N, T] = B(C), [D, A] = B(!1), [z, ft] = B(), Y = q(void 0), k = q(void 0), b = q(void 0), I = q(void 0), R = $(
    (f) => {
      if (f.trim())
        return Nn.reduce(
          (V, S) => {
            ...
            const K = S.exec(f);
            if (K) {
              const [F, Tt = void 0, oe = void 0] = K.slice(1), st = Cn(F) ?? (O.isBookIdValid(F) ? F.toLocaleUpperCase() : void 0);
              if (st) {
                const wt = Tt ? parseInt(Tt, 10) : void 0;
                if (wt && wt > At(st)) return;
                const vt = oe ? parseInt(oe, 10) : void 0;
                return {
                  book: st,
                  chapterNum: wt,
                  verseNum: vt
    ...
    if (!(!z || !z.chapterNum))
      return z.verseNum ? [z.chapterNum] : Array.from({ length: At(h) }, (f, V) => V + 1).filter(
        (f) => {
          var V;
          return (z == null ? void 0 : z.chapterNum) && f.toString().includes((V = z == null ? void 0 : z.chapterNum) == null ? void 0 : V.toString());
        }
      );
  }, [h, z]), it = J(() => {
    const f = R(s.trim());
    return f ? f.book !== t.book || (f.chapterNum ?? 0) !== t.chapterNum || (f.verseNum ?? 0) !== t.verseNum : !0;
  }, [s, t, R]), gt = J(
    () => !!z && it,
    [z, it]
  ), St = $(
    (f) => {
      const V = a ? a() : on;
      return {
        OT: V.filter((S) => O.isBookOT(S)),
        NT: V.filter((S) => O.isBookNT(S)),
        DC: V.filter((S) => O.isBookDC(S))
      }[f].filter((S) => {
        const K = Un[S].toLowerCase(), F = w.length > 0 && /^\d/.test(w) ? (
        ...
        return gt ? K === F || // Match full book name
        S.toLowerCase() === F : K.includes(F) || // Match partial book name
    ...
    () => Q.reduce((f, V) => f + V.books.length, 0),
    [Q]
  ), H = $(
    (f) => {
      i(f), c(f), ft(R(f.trim()));
    ...
    i(Mt(t, "English")), c(""), g(t.book), x(t.book);
  }, [t]), bt = $((f) => {
    if (ot.current) {
      ot.current = !1;
      return;
    ...
    (f, V, S, K) => {
      if (m(t.book !== f ? 1 : t.chapterNum), V || At(f) === -1) {
        e({
          book: f,
          chapterNum: S ?? 1,
          verseNum: K ?? 1
    ...
    Nn.forEach((f) => {
      const V = f.exec(w);
      if (V) {
        const [S, K = void 0, F = void 0] = V.slice(1), Tt = Cn(S);
        (O.isBookIdValid(S) || Tt) && It(
          Tt ?? S,
          !0,
          K ? parseInt(K, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    (f) => {
      if (!C)
        f.key !== "Tab" && f.key !== "Escape" && y(!0);
      else if (f.key === "Tab") {
        f.preventDefault(), f.stopPropagation();
        return;
      } else f.key === "ArrowDown" ? (I != null && I.current ? I.current.focus() : b != null && b.current ? b.current.focus() : k.current && k.current.focus(), f.preventDefault()) : f.key === "Escape" && document.activeElement === Y.current && (y(!1), f.preventDefault(), f.stopPropagation());
      if (document.activeElement === Y.current) {
        if (/^[a-zA-Z]$/.test(f.key) && (H(it ? w + f.key : f.key), A(!0), f.preventDefault()), /^\d$/.test(f.key)) {
          const V = s;
          if (D)
            H(w + f.key);
          else {
        ...
        if (!D && f.key === ":") {
          ...
          if (S) {
            const K = S[1], F = K.endsWith(":") ? `${K}` : `${K}:`;
            H(F), A(!0), f.preventDefault();
          }
        }
        bn.has(f.key) || A(!0);
      }
    ...
    bn.has(f.key) || (f.key === "Tab" && f.shiftKey && (Y.current.focus(), f.preventDefault()), f.stopPropagation(), Y.current.focus(), Y.current.dispatchEvent(new KeyboardEvent("keydown", { ...f, view: void 0 })));
  }, []), Er = $(
    (f) => {
      const { key: V } = f;
      kn.has(V) || (ae(f), f.preventDefault());
    },
    [ae]
  ), Dr = $((f) => {
    const { key: V } = f;
    V === "ArrowUp" && (f.preventDefault(), Y.current.focus());
  }, []), Vr = $(
    (f, V) => {
      const { key: S } = f;
      if (kn.has(S)) {
        if (h === p || _ === 1) {
          const F = _ === 1 ? h : p;
          if (S === "Enter") {
            f.preventDefault(), It(F, !0, v);
            return;
          }
          const Tt = S === "ArrowRight" && !o || S === "ArrowRight" && o === "ltr" || S === "ArrowLeft" && o === "rtl", oe = S === "ArrowLeft" && !o || S === "ArrowLeft" && o === "ltr" || S === "ArrowRight" && o === "rtl", De = Array.from(
            { length: At(h) },
            (se, Rt) => Rt + 1
          ), st = p !== h || _ === 1 ? U ?? De : De, wt = st.indexOf(v);
          let vt = v;
          if (Tt)
            ...
            const se = st[wt] + yn, Rt = st.find((Ve) => Ve >= se);
            Rt !== void 0 && (vt = Rt);
          } else if (S === "ArrowUp") {
            const se = st[wt] - yn, Rt = st.slice().reverse().find((Ve) => Ve <= se);
            Rt !== void 0 && (vt = Rt);
          }
          if (vt !== v) {
            m(vt), f.preventDefault();
            return;
          }
        }
        if (V === 0 && S === "ArrowUp" && !gt) {
          f.preventDefault(), Y.current.focus();
          return;
        }
        return;
      }
      ae(f), f.preventDefault(), f.stopPropagation();
    },
    [
      o,
      h,
  ...
  return dt(() => {
    _ === 1 ? m(1) : p === h ? p === t.book ? m(t.chapterNum) : m(1) : m(0);
  }, [h, t.book, t.chapterNum, p, _]), dt(() => {
    if (!U || _ > 1) return;
    U.indexOf(v) === -1 && m(U[0]);
  }, [h, v, p, U, _]), dt(() => {
    tt();
    ...
    const f = setTimeout(() => {
      var V, S;
      if (N && k.current && b.current) {
        const F = b.current.offsetTop - Ga;
        k.current.scrollTo({ top: F, behavior: "instant" }), Y.current.focus();
      }
      !N && document.activeElement !== Y.current && !((V = Y.current) != null && V.contains(document.activeElement)) && document.activeElement !== k.current && !((S = k.current) != null && S.contains(document.activeElement)) && tt();
    }, 10);
    return () => {
      clearTimeout(f);
    };
  }, [N, tt]), /* @__PURE__ */ l(me, { modal: !1, open: C, onOpenChange: bt, children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          g(t.book), x(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), Y.current.focus();
        },
        onFocus: () => {
    ...
    _ > 0 && /* @__PURE__ */ r(
      ne,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((f, V) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(fe, { className: "tw-font-semibold tw-text-foreground/80", children: Fa[f.bookType] }),
            f.books.map((S, K) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Pa,
              {
                bookId: S,
                handleSelectBook: () => It(S, !1),
                shouldExpandChildren: p.toLowerCase() === S.toLowerCase() || _ === 1,
                handleHighlightBook: () => x(S),
                handleKeyDown: (F) => Vr(F, K),
                bookType: f.bookType,
                ref: (F) => {
                  p === S && (b.current = F);
                },
                children: /* @__PURE__ */ r(
                  ja,
                  {
                    ...
                    matchingChapters: it ? U : void 0
                  }
                )
              }
            ) }, S)),
            V < Q.length - 1 && /* @__PURE__ */ r(jt, {})
          ] }, f.bookType))
        ] })
      }
    )
...
), W = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Mn.Root, { ref: n, className: d("pr-twp", La(), t), ...e }));
W.displayName = Mn.Root.displayName;
...
const Ha = mt.Portal, qn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
    className: d(
...
qn.displayName = mt.Overlay.displayName;
...
Ua.displayName = mt.Description.displayName;
...
xe.displayName = nt.Input.displayName;
...
ye.displayName = nt.List.displayName;
const Ne = u.forwardRef((t, e) => /* @__PURE__ */ r(nt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Ne.displayName = nt.Empty.displayName;
...
ke.displayName = nt.Item.displayName;
function qa(t) {
...
function $e({
  ...
  const [y, N] = B(!1);
  return /* @__PURE__ */ l(ge, { open: y, onOpenChange: N, ...C, children: [
    ...
    /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ l(ve, { children: [
          /* @__PURE__ */ r(xe, { placeholder: g, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(Ne, { children: v }),
          /* @__PURE__ */ r(ye, { children: e.map((T) => /* @__PURE__ */ l(
            ke,
            {
              value: w(T),
              onSelect: () => {
...
function Qs({
  ...
  const g = ze(p, "%webView_bookSelector_currentBook%"), v = ze(p, "%webView_bookSelector_choose%"), m = ze(p, "%webView_bookSelector_chooseBooks%"), [h, x] = B(
    "current book"
    /* CURRENT_BOOK */
  ), C = (y) => {
    x(y), t(y);
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(W, { className: "tw-ms-1", children: g })
          ] }),
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(W, { className: "tw-flex tw-items-center", children: a.map((y) => O.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ r(
            j,
            {
...
function Za({ table: t }) {
  return /* @__PURE__ */ l(me, { children: [
    /* @__PURE__ */ r(la, { asChild: !0, children: /* @__PURE__ */ l(j, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Ft = L.Root, Qa = L.Group, Xt = L.Value, to = _t(
...
Wn.displayName = L.ScrollUpButton.displayName;
...
Zn.displayName = L.ScrollDownButton.displayName;
...
const lt = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  L.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
...
function so({
  ...
  var y;
  const [w, c] = B([]), [p, g] = B([]), [v, m] = B({}), [h, x] = B({}), C = On({
    data: e,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(Za, { table: C }),
    /* @__PURE__ */ l(Ce, { stickyHeader: s, children: [
      /* @__PURE__ */ r(_e, { stickyHeader: s, children: C.getHeaderGroups().map((N) => /* @__PURE__ */ r(kt, { children: N.headers.map((T) => /* @__PURE__ */ r(te, { children: T.isPlaceholder ? void 0 : Jt(T.column.columnDef.header, T.getContext()) }, T.id)) }, N.id)) }),
      /* @__PURE__ */ r(Se, { children: (y = C.getRowModel().rows) != null && y.length ? C.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        kt,
        {
          onClick: () => i(N, C),
          "data-state": N.getIsSelected() && "selected",
          children: N.getVisibleCells().map((T) => /* @__PURE__ */ r(Gt, { children: Jt(T.column.columnDef.cell, T.getContext()) }, T.id))
        },
        N.id
...
function io({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Xr, {}) })
    ] }),
...
function ri({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(me, { children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ l(j, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ne, { children: n.map((a) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(fe, { children: a.label }),
      /* @__PURE__ */ r(Pn, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(en, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(Xn, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(jt, {})
    ] }, a.label)) })
  ] }) });
}
function ai({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new ca("en", {
    notation: "compact",
...
function lo({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const c = new Date(w), p = new Date(o.getTime() - c.getTime()), g = p.getUTCFullYear() - 1970, v = p.getUTCMonth(), m = p.getUTCDate() - 1;
    let h = "";
    return g > 0 ? h = `${g.toString()} year${g === 1 ? "" : "s"} ago` : v > 0 ? h = `${v.toString()} month${v === 1 ? "" : "s"} ago` : m === 0 ? h = "today" : h = `${m.toString()} day${m === 1 ? "" : "s"} ago`, h;
  }
...
function po({
  ...
  const [v, m] = B(!1), h = $(
    (y) => {
      var T;
      const N = (T = t.find((D) => D.label === y)) == null ? void 0 : T.value;
      N && a(
        n.includes(N) ? n.filter((D) => D !== N) : [...n, N]
      );
    },
    [t, n, a]
  ), x = () => i || o, C = J(() => {
    if (!c) return t;
    const y = t.filter((T) => T.starred).sort((T, D) => T.label.localeCompare(D.label)), N = t.filter((T) => !T.starred).sort((T, D) => {
      const A = n.includes(T.value), z = n.includes(D.value);
      return A && !z ? -1 : !A && z ? 1 : T.label.localeCompare(D.label);
    });
    return [...y, ...N];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(ge, { open: v, onOpenChange: m, children: [
    /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ l(
      j,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(re, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ve, { children: [
      ...
      /* @__PURE__ */ l(ye, { children: [
        ...
        /* @__PURE__ */ r(wn, { children: C.map((y) => {
          const N = e ? e(y) : void 0;
          return /* @__PURE__ */ l(
            ke,
            {
              value: y.label,
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((m) => {
      ...
      return /* @__PURE__ */ l(le, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        ...
        (h = t.find((x) => x.value === m)) == null ? void 0 : h.label
      ] }, m);
    }) }) : /* @__PURE__ */ r(W, { children: v })
  ] });
}
function uo({
  occurrenceData: t,
  ...
  return /* @__PURE__ */ l(Ce, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(_e, { stickyHeader: !0, children: /* @__PURE__ */ l(kt, { children: [
...
mo.displayName = In.Root.displayName;
...
er.displayName = ue.Root.displayName;
...
const Te = (t) => t === "asc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ii = (t) => ({
  ...
  header: ({ column: e }) => /* @__PURE__ */ l(j, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Te(e.getIsSorted())
  ] })
}), ho = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ l(j, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    Te(n.getIsSorted())
  ] })
}), wi = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ l(j, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Te(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ l(j, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    Te(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
...
function mi({
  ...
  const p = xt(n, "%webView_inventory_all%"), g = xt(n, "%webView_inventory_approved%"), v = xt(n, "%webView_inventory_unapproved%"), m = xt(n, "%webView_inventory_unknown%"), h = xt(n, "%webView_inventory_scope_currentBook%"), x = xt(n, "%webView_inventory_scope_chapter%"), C = xt(n, "%webView_inventory_filter_text%"), y = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [N, T] = B(!1), [D, A] = B("all"), [z, ft] = B(""), [Y, k] = B([]), b = J(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), I = J(() => {
    if (N) return b;
    const _ = [];
    return b.forEach((H) => {
      const ot = H.items[0], tt = _.find(
        (bt) => bt.items[0] === ot
      );
      tt ? (tt.count += H.count, tt.occurrences = tt.occurrences.concat(H.occurrences)) : _.push({
        items: [ot],
        count: H.count,
  ...
  const it = (_, H) => {
    ...
    if (I.length === 0 || Y.length === 0) return [];
    const _ = I.filter((H) => Ze(
      N ? H.items : [H.items[0]],
      Y
    ));
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Ft,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l(Bt, { children: [
              ...
              /* @__PURE__ */ r(lt, { value: "unknown", children: m })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ l(Ft, { onValueChange: (_) => gt(_), defaultValue: i, children: [
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(W, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? y })
      ] })
    ] }),
...
const rr = u.forwardRef(
  ({
    ...
    const [p, g] = u.useState(t), v = e ?? p, m = u.useCallback(
      (D) => {
        const A = typeof D == "function" ? D(v) : D;
        n ? n(A) : g(A);
      },
      [n, v]
    ), h = u.useCallback(() => m((D) => !D), [m]), x = v ? "expanded" : "collapsed", N = Z() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = u.useMemo(
      () => ({
        state: x,
        open: v,
        setOpen: m,
    ...
    return /* @__PURE__ */ r(nr.Provider, { value: T, children: /* @__PURE__ */ r(cn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Ro = _t(
  ...
  ({
    ...
    const c = t ? $t : "button", { state: p } = Ee(), g = /* @__PURE__ */ r(
      c,
      {
        ref: w,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Re, { side: "right", align: "center", hidden: p !== "collapsed", ...o })
    ] })) : g;
  }
);
...
function Bo({
  ...
  const p = $(
    ...
    (m) => {
      const h = n.find((x) => x.projectId === m);
    ...
    ar,
    {
      ...
      children: /* @__PURE__ */ l(sr, { children: [
        /* @__PURE__ */ l(Le, { children: [
          ...
          /* @__PURE__ */ r(Ye, { children: /* @__PURE__ */ r(ir, { children: Object.entries(e).map(([m, h]) => /* @__PURE__ */ r(wr, { children: /* @__PURE__ */ r(
            lr,
            {
              onClick: () => p(m),
              isActive: v(m),
...
const yt = "scrBook", Io = "scrRef", Vt = "source", Ao = "details", Po = "Scripture Reference", jo = "Scripture Book", dr = "Type", Fo = "Details";
function Xo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? O.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === yt ? Mt(o.start) : void 0;
      },
...
const Go = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || je(t.start, t.end) === 0 ? `${Oe(t.start)}+${e}` : `${Oe(t.start)}+${e}-${Oe(t.end)}+${n}`;
}, Tn = (t) => `${Go({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function fi({
  sources: t,
  ...
  const [c, p] = B([]), [g, v] = B([{ id: yt, desc: !1 }]), [m, h] = B({}), x = J(
  ...
  dt(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const I = x.find((R) => Tn(R) === b[0]) || void 0;
        I && w(I);
      }
    }
  }, [m, x, w, y]);
  const N = o ?? jo, T = s ?? dr, D = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [yt] },
    { label: `Group by ${T}`, value: [Vt] },
    {
  ...
  }, ft = (k, b) => k.getIsGrouped() ? "" : d("banded-row", b % 2 === 0 ? "even" : "odd"), Y = (k, b, I) => {
    if (!((k == null ? void 0 : k.length) === 0 || b.depth < I.column.getGroupedIndex())) {
      if (b.getIsGrouped())
        switch (b.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ l(
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Bt, { position: "item-aligned", children: /* @__PURE__ */ r(Qa, { children: D.map((k) => /* @__PURE__ */ r(lt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Ce, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(_e, { children: y.getHeaderGroups().map((k) => /* @__PURE__ */ r(kt, { children: k.headers.filter((b) => b.column.columnDef.header).map((b) => (
      ...
      /* @__PURE__ */ r(Se, { children: y.getRowModel().rows.map((k, b) => {
        const I = Z();
        return /* @__PURE__ */ r(
          kt,
          {
                  ...
                  Gt,
                  {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      j,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ r(pe, {}),
                          !k.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ r(Ue, {}) : /* @__PURE__ */ r(na, {})),
                          " ",
...
function Ko({
  ...
  const A = J(() => O.allBookIds.filter(
    ...
    (b, I = !1) => {
      ...
      const R = A.findIndex((Q) => Q === T.current), U = A.findIndex((Q) => Q === b);
      if (R === -1 || U === -1) return;
      const [it, gt] = [
        Math.min(R, U),
        Math.max(R, U)
      ], St = A.slice(it, gt + 1).map((Q) => Q);
      n(
        e.includes(b) ? e.filter((Q) => !St.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...St])]
      );
    },
    [e, n, A]
  ), ft = $(
    (b) => {
      const I = hn(A, b).map((R) => R);
      n(
        cr(A, b, e) ? e.filter((R) => !I.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...I])]
      );
    },
    [e, n, A]
  ), Y = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(ge, { open: y, onOpenChange: N, children: [
      /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ l(
        j,
        {
          variant: "outline",
        ...
        ve,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              ...
              /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: k, children: p })
            ] }),
            /* @__PURE__ */ l(ye, { children: [
              /* @__PURE__ */ r(Ne, { children: g }),
              Object.values(Nt).map((b, I) => {
                const R = A.filter(
                  (U) => Pt(U) === b
                );
                if (R.length !== 0)
                  return /* @__PURE__ */ l(Dn, { children: [
                    ...
                    I < Object.values(Nt).length - 1 && /* @__PURE__ */ r(Jn, {})
                  ] }, b);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var I;
        return /* @__PURE__ */ r(le, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((I = o.get(b)) == null ? void 0 : I.localizedName) || O.bookIdToEnglishName(b) || b }, b);
      }),
...
function bi({
  ...
  const c = Et(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), v = Et(i, "%webView_scope_selector_current_book%"), m = Et(i, "%webView_scope_selector_choose_books%"), h = Et(i, "%webView_scope_selector_scope%"), x = Et(i, "%webView_scope_selector_select_books%"), C = [
  ...
  ], y = e ? C.filter((N) => e.includes(N.value)) : C;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        sn,
        {
          ...
          children: y.map(({ value: N, label: T, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(we, { className: "tw-me-2", value: N, id: D }),
            /* @__PURE__ */ r(W, { htmlFor: D, children: T })
          ] }, D))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Bt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(lt, { value: `${c}`, children: i[P(c)] }, `${c}`))
          }
        )
      ]
    }
...
function En({
  ...
  return /* @__PURE__ */ l(me, { variant: s, children: [
    /* @__PURE__ */ r(tn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(j, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(ra, {}) }) }),
...
const Ut = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((p) => p.group === s).sort((p, g) => p.order - g.order).map((p) => /* @__PURE__ */ l(pn, { children: [
      ...
      p.tooltip && /* @__PURE__ */ r(Re, { children: p.tooltip })
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (x = s.current) == null || x.focus(), Ut(s, [m, h]);
        break;
      case "alt+l":
        (C = i.current) == null || C.focus(), Ut(i, [m, h]);
        break;
      case "alt+n":
        (y = w.current) == null || y.focus(), Ut(w, [m, h]);
        break;
      case "alt+h":
        (N = c.current) == null || N.focus(), Ut(c, [m, h]);
        break;
    }
  }), dt(() => {
...
function Ti({
  ...
  const c = es(
    ...
    o && o(h), a && a([h, ...n.filter((x) => x !== h)]), s && n.find((x) => x === h) && s([...n.filter((x) => x !== h)]), g(!1);
  }, m = (h, x) => {
    var y, N, T, D, A, z;
    const C = x !== h ? ((N = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : N[x]) ?? ((D = (T = t[h]) == null ? void 0 : T.uiNames) == null ? void 0 : D.en) : void 0;
    return C ? `${(A = t[h]) == null ? void 0 : A.autonym} (${C})` : (z = t[h]) == null ? void 0 : z.autonym;
  };
      ...
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((h) => /* @__PURE__ */ r(lt, { value: h, children: m(h, e) }, h))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ l(Ke, { children: [
      /* @__PURE__ */ r(W, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ l(W, { children: [
        "Currently:",
        " ",
...
const rs = ce(({ className: t, ...e }, n) => /* @__PURE__ */ r(sa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
const Di = ct.Trigger, bs = ct.Portal, Vi = ct.Close, Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Overlay,
  {
    ref: n,
...
Ns.displayName = ct.Title.displayName;
...
Cs.displayName = Xe.Root.displayName;
function Mi({ ...t }) {
  return /* @__PURE__ */ r(
    va,
    {
...
Ss.displayName = Ge.Root.displayName;
const Oi = rt.Root, Ts = u.forwardRef(({ className: t, ...e }, n) => {
  const a = Z();
  return /* @__PURE__ */ r(
    rt.List,
    {
...
const Ms = (t, e, n = {}) => {
  ...
  const o = q(null), [s, i] = B(void 0), [w, c] = B(void 0), p = $(
    (m) => {
      i(m);
      const h = t.find((C) => C.id === m);
      h && (e == null || e(h));
    ...
    (m) => {
      const h = t.find((x) => x.id === m);
      h && (c((x) => x === m ? void 0 : m), n == null || n(h));
    },
    [n, t]
  ), v = $(
    (m) => {
      const h = t.findIndex((y) => y.id === s);
      let x = h;
      switch (m.key) {
        case "ArrowDown":
          x = Math.min(h + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          x = Math.max(h - 1, 0), m.preventDefault();
          break;
        case "Home":
        ...
        case " ":
        case "Enter":
          s && g(s), m.preventDefault(), m.stopPropagation();
          return;
        default:
