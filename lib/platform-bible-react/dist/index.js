...
import c, { forwardRef as Lt, useCallback as tt, useState as B, useRef as Z, useEffect as dt, useLayoutEffect as Be, useMemo as Q } from "react";
...
const Jt = V.Root, xe = V.Trigger, Ke = V.Group, _r = V.Portal, zr = V.Sub, qo = V.RadioGroup, We = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  V.SubTrigger,
  {
    ref: o,
    className: d(
...
function Ko({
  ...
  return dt(() => {
    i === f ? i === _.bookNumberToId(t.bookNum) ? u(t.chapterNum) : u(1) : u(0);
  }, [f, t.bookNum, t.chapterNum, i]), Be(() => {
    y(h);
  }, [h]), Be(() => {
    const C = setTimeout(() => {
      ...
      Ft,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Pe.map((C, E) => {
          ...
          return O.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(Kt, { className: "tw-font-semibold tw-text-foreground/80", children: Hr[C] }),
            ...
            Pe.length - 1 !== E ? /* @__PURE__ */ r(Gt, {}) : void 0
          ] }, C);
        }) })
      }
    )
...
function ma({
  ...
  var y;
  const [i, p] = B([]), [m, u] = B([]), [f, g] = B({}), [h, v] = B({}), x = He({
    data: e,
    columns: t,
    getCoreRowModel: Ue(),
...
const Yt = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(Kn, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function fa({ id: t, versionHistory: e }) {
  ...
  function s(i) {
    const p = new Date(i), m = new Date(o.getTime() - p.getTime()), u = m.getUTCFullYear() - 1970, f = m.getUTCMonth(), g = m.getUTCDate() - 1;
    let h = "";
...
const te = (t) => t === "asc" ? /* @__PURE__ */ r(sr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ir, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ds = (t) => ({
  ...
  let w = [...n];
  t.forEach((p) => {
    e === "approved" ? w.includes(p) || w.push(p) : w = w.filter((m) => m !== p);
  }), a(w);
  let i = [...o];
  t.forEach((p) => {
    e === "unapproved" ? i.includes(p) || i.push(p) : i = i.filter((m) => m !== p);
  }), s(i);
}, cs = (t, e, n, a, o) => ({
  accessorKey: "status",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(gn, { value: w, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          onClick: () => oe(
  ...
  return Na(t).forEach((u) => {
    u.startsWith("\\id") && (w = ka(u), i = 0, p = 0), u.startsWith("\\c") && (i = Xe(u), p = 0), u.startsWith("\\v") && (p = Xe(u), i === 0 && (i = e.chapterNum));
...
function us({
  ...
  const f = at(n, "%webView_inventory_all%"), g = at(n, "%webView_inventory_approved%"), h = at(n, "%webView_inventory_unapproved%"), v = at(n, "%webView_inventory_unknown%"), x = at(n, "%webView_inventory_scope_currentBook%"), y = at(n, "%webView_inventory_scope_chapter%"), N = at(n, "%webView_inventory_scope_verse%"), k = at(n, "%webView_inventory_filter_text%"), A = at(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, ot] = B(!1), [rt, zt] = B("all"), [b, z] = B(""), [K, P] = B([]), Et = Q(() => i ? a instanceof RegExp ? _a(
    i,
    t,
    s,
    w,
  ...
  return /* @__PURE__ */ r(
    xn,
    {
      ...
      children: /* @__PURE__ */ l(Nn, { children: [
        ...
        /* @__PURE__ */ l(ue, { children: [
          /* @__PURE__ */ r(me, { className: "tw-text-sm tw-text-gray-400", children: w }),
...
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, p) => i.order - p.order).map(
  (i) => "command" in i ? /* @__PURE__ */ r(
    ye,
    {
      onClick: () => {
        a(i);
    ...
    /* @__PURE__ */ r(We, { children: i.label }),
...
function xs({
  ...
  return /* @__PURE__ */ l(Jt, { children: [
    ...
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, w]) => typeof s == "boolean" || typeof w == "boolean" ? 0 : s.order - w.order).map(([s], w, i) => /* @__PURE__ */ l(ft, { children: [
      /* @__PURE__ */ r(Ke, { children: _n(e.groups, e.items, s, t) }, s),
      w < i.length - 1 && /* @__PURE__ */ r(Gt, {})
    ] })) })
  ] });
}
...
function ys({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(zn, { children: [
      /* @__PURE__ */ r(En, { children: t.map((w) => /* @__PURE__ */ r(ro, { value: w.value, children: w.value }, w.key)) }),
      t.map((w) => /* @__PURE__ */ r(In, { value: w.value, children: w.content }, w.key))
    ] })
  ] });
}
...
const Dt = (t, e) => {
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((m) => m.group === s).sort((m, u) => m.order - u.order).map(
    ...
    return i.length > 0 && w < o.length - 1 && p.push(/* @__PURE__ */ r(Xn, {}, `${s}-separator`)), p;
  });
};
function co({
  menuData: t,
  ...
  const o = Z(void 0), s = Z(void 0), w = Z(void 0), i = Z(void 0), p = Z(void 0), m = (u) => {
    switch (u) {
...
const Mo = (t, e, n = {}) => {
  ...
  return dt(() => {
    ...
    return p(!!t), (async () => {
      ...
      m = !1, o.current.preserveValue || w(() => a.current);
    };
  }, [t]), [s, i];
}, ie = () => !1, Es = (t, e) => {
  const [n] = Mo(
