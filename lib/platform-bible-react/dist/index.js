...
R(st, "Original", new st(ht.Original)), R(st, "Septuagint", new st(ht.Septuagint)), R(st, "Vulgate", new st(ht.Vulgate)), R(st, "English", new st(ht.English)), R(st, "RussianProtestant", new st(ht.RussianProtestant)), R(st, "RussianOrthodox", new st(ht.RussianOrthodox));
let Et = st;
function vn(t, e) {
  const n = e[0];
