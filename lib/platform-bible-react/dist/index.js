...
import { c as v, g as Ee, a as Fa, C as ke, A as ie, P as De, b as We, B as q, d as Me, e as Oe, f as $e, h as xe, i as Pi, k as Vi, j as ji, E as Li, l as Ua, r as pe, X as Bi, m as ln, n as Qr, o as ta, L as Nt, R as Ka, p as qr, D as Na, q as Ca, s as Ea, t as Ta, T as dn, u as Vr, v as Pt, w as qa, x as Vt, y as jt, z as Lt, F as wn, G as Ga, H as Ge, I as kr, J as Ie, K as Ae, M as Pe, S as _r, N as er, O as Fi, Q as Er, U as Ye, V as ze, Z as Xe, W as Te, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as un, a3 as Ui, a4 as Ki, a5 as qi, a6 as za, a7 as pn, a8 as ea, a9 as hn, aa as Gi, ab as Hi, ac as Yi, ad as Wi, ae as gn, af as Xi, ag as sa, ah as xo, ai as ca, aj as Ji, ak as Zi, al as Qi, am as ts, an as es, ao as Tr, ap as Xa, aq as rs, ar as as } from "./resizable-BFsXE-ZH.js";
import { as as Jh, at as Zh, au as Qh, av as tg, aw as eg, ax as rg, ay as ag, az as og, aA as ng, aB as ig, aC as sg, aD as cg, aE as lg, aF as dg, aG as wg, aH as ug, aI as pg, aJ as hg, aK as gg, aL as fg, aM as mg, aN as vg, aO as bg, aP as xg, aQ as yg } from "./resizable-BFsXE-ZH.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Se, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Sa, ChevronRight as Ra, ArrowLeft as os, ArrowRight as ns, ChevronDown as nr, BoldIcon as is, ItalicIcon as ss, X as Ja, AtSign as fn, Pencil as cs, Trash2 as ls, ArrowUp as mn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as vn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Cs, AlertCircle as Da, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Rs, ScrollText as Ds, ChevronsUpDown as Ms, MenuIcon as Os, Menu as $s, EllipsisVertical as Is, MoreVertical as As } from "lucide-react";
import { Section as dt, getChaptersForBook as Ps, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Vs, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as kn, formatBytes as js, getCurrentLocale as Ls, usfmMarkers as jr, getFormatCallerFunction as Bs, deepEqual as Fs, isString as No, compareScrRefs as Ma, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as Co, formatReplacementStringToArray as Eo, collectUsjMarkers as Ks } from "platform-bible-utils";
...
import { createEditor as Tn, $getRoot as Re, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as zn, TextNode as Sn, $getPreviousSelection as oc, $isRangeSelection as we, $caretFromPoint as nc, $getSiblingCaret as Rn, $getChildCaret as ic, $getAdjacentChildCaret as sc, $isChildCaret as cc, $normalizeCaret as lc, $setSelectionFromCaretRange as dc, $getCollapsedCaretRange as wc, $getCaretInDirection as So, $splitAtPointCaretNext as uc, $isTextPointCaret as pc, $findMatchingParent as Dn, $isElementNode as Nr, mergeRegister as ye, getDOMTextNode as hc, isHTMLElement as gc, CLEAR_EDITOR_COMMAND as Mn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as fc, defineExtension as re, safeCast as Je, createState as mc, FORMAT_TEXT_COMMAND as On, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as In, RootNode as vc, LineBreakNode as bc, TabNode as xc, $isEditorState as yc, createCommand as kc, CLICK_COMMAND as _c, isDOMNode as Nc, $getNodeFromDOMNode as Cc, $createNodeSelection as Ec, $setSelection as Tc, $getEditor as zc, DecoratorNode as Oa, $getState as Sc, toggleTextFormatType as Ro, TEXT_TYPE_TO_FORMAT as Rc, $setState as Dc, addClassNamesToElement as An, $create as Mc, $getNodeByKey as Oc, removeClassNamesFromElement as $c, KEY_TAB_COMMAND as Ic, $isBlockElementNode as Ac, $createRangeSelection as Pc, $normalizeSelection__EXPERIMENTAL as Vc, OUTDENT_CONTENT_COMMAND as jc, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as Lc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Bc, $isParagraphNode as Fc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Pn, $insertNodes as Uc } from "lexical";
...
import { Avatar as ao, Select as Gt, Checkbox as Mo, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Oo, Slider as Mr, Switch as $o } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as al, isInsertEmbedOpOfType as Or, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
function cl({
  ...
  return /* @__PURE__ */ u(De, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Me, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      ke,
      {
        onSelect: () => E(y),
...
function ua({
  ...
  const B = pe(), [z, I] = _(!1), [A, C] = _(""), [P, U] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    ...
    [dt.OT]: Mt.filter((G) => vt.isBookOT(G)),
    [dt.NT]: Mt.filter((G) => vt.isBookNT(G)),
    [dt.DC]: Mt.filter((G) => vt.isBookDC(G)),
    [dt.Extra]: Mt.filter((G) => vt.extraBooks().includes(G))
  }), [Mt]), Jt = D(() => Object.values(Ft).flat(), [Ft]), fe = D(() => {
    if (!P.trim()) return Ft;
    const x = {
      [dt.OT]: [],
      [dt.NT]: [],
  ...
  const { otLong: pt, ntLong: gt, dcLong: Ot, extraLong: zt } = {
...
function jo({
  ...
  const [N, M] = _(!1), B = d ?? l, z = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
  ...
  return /* @__PURE__ */ u(De, { open: N, onOpenChange: M, ...y, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        variant: f,
...
function Dl(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < g.length; E++) {
      const y = g[E], N = s[E] || document.createElement("div"), M = N.style;
      M.position !== "absolute" && (M.position = "absolute", m = !0);
      const B = de(y.left - p);
      M.left !== B && (M.left = B, m = !0);
      const z = de(y.top - h);
      M.top !== z && (N.style.top = z, m = !0);
      const I = de(y.width);
      M.width !== I && (N.style.width = I, m = !0);
      const A = de(y.height);
      M.height !== A && (N.style.height = A, m = !0), N.parentNode !== c && (c.append(N), m = !0), s[E] = N;
    }
...
function Ol(t, e = Ml) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, E = g.getNode(), y = E.getKey(), N = g.offset, M = t.getElementByKey(b), B = t.getElementByKey(y), z = r === null || M !== o || m !== n || b !== r.getKey(), I = i === null || B !== s || N !== c || y !== i.getKey();
      if ((z || I) && M !== null && B !== null) {
...
function Zn(t, e = Jn) {
  return t.registerCommand(Mn, (r) => (t.update(e), !0), eo);
}
...
class Qn extends Oa {
  $config() {
    return this.config("decorator-text", { extends: Oa, stateConfigs: [{ flat: !0, stateConfig: ga }] });
  }
  getFormat() {
    return Sc(this, ga);
  }
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = Xt();
  ...
  const o = r.getDependency(ja).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ti(() => {
    ...
    o.value.read(() => {
      if (Xt()) for (const [w, p] of c.entries()) {
        ...
        const h = Oc(w), g = h && h.isSelected() || !1;
...
function Zo({
  ...
  const g = L(
    ...
    [t.contents]
  ), M = !!t.conflictResolutionAction && !N, B = D(() => {
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          Ge,
...
function vi({
  ...
  const [k, J] = _(Qo), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Bt] = _(!1), [K, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(M), [Mt, Ft] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
  ...
  }, [i, r]), it = D(() => Ct.slice(1), [Ct]), st = D(() => it.length ?? 0, [it.length]), ht = D(() => st > 0, [st]), pt = D(() => Z || st <= 2 ? it : it.slice(-2), [it, st, Z]), gt = D(() => Z || st <= 2 ? 0 : st - 2, [st, Z]), Ot = D(
                    ...
                    /* @__PURE__ */ u(De, { open: K, onOpenChange: tt, children: [
                      ...
                      /* @__PURE__ */ a(
                        Me,
                        {
                          ...
                          children: /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a($e, { children: b == null ? void 0 : b.map((S) => /* @__PURE__ */ a(
                            ke,
                            {
                              onSelect: () => {
...
function jd({
  ...
  }, M = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", B = g ? [
    {
      value: "merge",
...
function sp({
  ...
  const [y, N] = _(/* @__PURE__ */ new Set()), [M, B] = _(), [z, I] = _(), A = L(
    async ($) => {
      const W = await i($);
...
function nw({
  ...
  const f = (m) => {
    ...
    var E, y, N, M;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((M = s.current) == null || M.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
...
function mp({
  ...
  const [f, b] = _("generated"), [m, E] = _("generated"), [y, N] = _("*"), [M, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [P, U] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, K] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
    ...
    (V) => {
      ...
      if (Q && Or("note", Q)) {
        V.content.length > 1 && setTimeout(() => {
          var Ot;
          (Ot = w.current) == null || Ot.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const pt = (it = Q.insert.note) == null ? void 0 : it.style, gt = (ht = (st = Q.insert.note) == null ? void 0 : st.contents) == null ? void 0 : ht.ops;
        if (pt || C(!1), C(
          pt === "x" ? !!(gt != null && gt.every((Ot) => {
            var Ht, $t;
            if (!((Ht = Ot.attributes) != null && Ht.char)) return !0;
            const zt = (($t = Ot.attributes) == null ? void 0 : $t.char).style;
...
function bp({
  ...
  const w = l ?? Bs(r, void 0), p = (y, N) => {
    d == null || d(y, N, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = _(h), b = (y, N, M) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), d == null || d(N, M, n);
          break;
      }
  }, m = (y) => {
    if (r.length)
...
function Tp({
  ...
  const g = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), m = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), M = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
...
function Sw({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    (N) => {
      const M = typeof N == "function" ? N(w) : N;
      r ? r(M) : d(M);
    },
    [r, w]
    ...
    Rw,
    {
      ...
      children: /* @__PURE__ */ u(Mw, { children: [
        /* @__PURE__ */ u(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(Ow, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a($w, { children: /* @__PURE__ */ a(
            Aw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Kw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ma(t.start, t.end) === 0 ? `${la(t.start)}+${e}` : `${la(t.start)}+${e}-${la(t.end)}+${r}`;
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Gd, { children: M.map((C) => /* @__PURE__ */ a(ne, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function qw({
  ...
  }, [b, m] = _(!1), [E, y] = _(""), N = F(void 0), M = F(!1), B = D(
    () => _i(t),
    [t]
  ), z = D(() => {
    if (!E.trim()) {
  ...
  return /* @__PURE__ */ u(
    De,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(Me, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Oe,
          {
            shouldFilter: !1,
            onKeyDown: (k) => {
              k.key === "Enter" && (M.current = k.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                Qr,
...
function Kp({
  ...
  const M = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), P = St(s, "%webView_scope_selector_current_book%"), U = St(s, "%webView_scope_selector_choose_books%"), k = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), $ = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Dt = St(s, "%webView_scope_selector_navigate%"), Tt = (O) => {
    if (!f) return;
  ...
  ], K = (O, X, Yt = !1) => /* @__PURE__ */ u(ct, { children: [
    O,
    X && !Yt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), tt = e ? Bt.filter((O) => e.includes(O.value)) : Bt, wt = f ?? da, at = w ?? wt, mt = p ?? wt, ae = () => {
  }, ut = F(null), bt = F(null), Mt = F(!1), Ft = F(null), Jt = F(!1), [fe, R] = _(void 0), yt = F(!1), Ct = F(!1), Zt = F(null), _e = L((O) => {
    if (O) {
    ...
    (O) => {
      h == null || h(O), g == null || g(O), yt.current = !0;
    },
    [h, g]
  ), Q = L(
    (O) => {
      g == null || g(O), Ct.current = !0;
    },
    [g]
  ), et = L(
    (O) => {
      r(O), O === "selectedBooks" && n.length === 0 && (f != null && f.book) && i([f.book]);
    },
    [r, n, f, i]
  ), ot = tt.find((O) => O.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map((O) => O.toUpperCase()).join(", ") : t === "range" ? Us(at, mt, {
  ...
  ), ht = tt.find((O) => O.value === "selectedBooks"), pt = tt.find((O) => O.value === "range"), [gt, Ot] = _(!1), [zt, Ht] = _(void 0), [$t, je] = _(void 0), [S, It] = _(void 0), [xt, oe] = _(void 0), [Le, ur] = _([]), pr = d === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Hw,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { ref: ut, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ua,
        {
          ...
          onCloseAutoFocus: (O) => {
            var X;
            Ct.current && (Ct.current = !1, O.preventDefault(), (X = Zt.current) == null || X.focus());
          },
          className: v(Rr && Ze),
          modal: !0,
          align: "start"
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Ut, ce] = _(null), Ue = 200, [Mi, Oi] = _(!1);
  H(() => {
    if (!Ut || typeof ResizeObserver > "u") return;
    const O = new ResizeObserver(([X]) => {
      Oi(X.contentRect.width < Ue);
    });
    return O.observe(Ut), () => O.disconnect();
  }, [Ut]);
  const fo = L(
    (O) => {
      je(O), It(at), oe(mt), ur(n), Ot(!1), Ht(O);
    },
    [at, mt, n]
  ), mo = L(() => {
    ...
    O || (Ht(void 0), je(void 0));
  }, []), vo = L((O) => {
    var X;
    O.preventDefault(), (X = Fe.current) == null || X.focus();
  }, []), bo = (O) => t === O ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(Nt, { children: k }),
      d === "dropdown" ? /* @__PURE__ */ u(Ie, { open: gt, onOpenChange: Ot, children: [
        ...
        /* @__PURE__ */ a(
          Pe,
          {
            ...
            children: /* @__PURE__ */ u(sa, { container: Ut, children: [
              st.map(({ value: O, label: X, dropdownLabel: Yt, scrRefSuffix: fr, id: $i }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: Ne(O),
                  ...
                  children: [
                    t === O && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" }) }),
                    K(Yt ?? X, fr, Mi)
                  ]
                },
                $i
                    ...
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (O) => {
                          ...
                          X != null && X.closest("button") && (Mt.current = !0, requestAnimationFrame(() => {
                            Mt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ua,
                          {
                            ...
                            onCloseAutoFocus: (O) => {
                              var X;
                              O.preventDefault(), (X = Ft.current) == null || X.focus();
                            },
                            modal: !0,
        ...
        Ka,
        {
          ...
          children: tt.map(({ value: O, label: X, scrRefSuffix: Yt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(qr, { className: "tw:me-2", value: O, id: fr }),
    ...
    d === "dropdown" && ht && /* @__PURE__ */ a(Na, { open: zt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ca,
      {
        ...
        onCloseAutoFocus: vo,
        onEscapeKeyDown: (O) => {
          _t != null && _t.querySelector('[data-state="open"]') && O.preventDefault();
        },
    ...
    d === "dropdown" && pt && /* @__PURE__ */ a(Na, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ca,
      {
        ...
        onCloseAutoFocus: vo,
        onEscapeKeyDown: (O) => {
          Et != null && Et.querySelector('[data-state="open"]') && O.preventDefault();
        },
...
function Ba({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    /* @__PURE__ */ a(Ae, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Os, {}) }) }),
...
function th({
  ...
  const d = cu(
    ...
    var E, y, N, M, B, z;
    const m = b !== f ? ((y = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : y[b]) ?? ((M = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : M.en) : void 0;
