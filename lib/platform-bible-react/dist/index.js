...
function Jp({
  ...
  const s = I(() => cu(Object.entries(t)), [t]), c = s.length > 1, d = o["%firstRun_language_search_placeholder%"] ?? "", l = o["%firstRun_language_noResults%"] ?? "", w = o["%firstRun_language_selected%"] ?? "";
      ...
      s.map(([p, g]) => {
        ...
        return /* @__PURE__ */ u(
          Ee,
          {
            ...
            keywords: [
              g.autonym,
              ...Object.values(g.uiNames ?? {}),
              ...g.otherNames ?? []
            ],
            "aria-current": h ? "true" : void 0,
            "data-checked": h ? "true" : void 0,
            onSelect: () => r(p),
            children: [
              /* @__PURE__ */ a("span", { children: g.autonym }),
              h && /* @__PURE__ */ a("span", { className: "tw:sr-only", children: w })
            ]
          },
          p
        );
