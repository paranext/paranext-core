import Ms, { jsx as s, jsxs as x, Fragment as nt } from "react/jsx-runtime";
import * as M from "react";
import A, { forwardRef as Zn, useCallback as $e, useState as pe, useRef as gt, useEffect as Qe, useLayoutEffect as Jo, useMemo as Te } from "react";
import { History as Bs, ChevronRight as qa, Check as xn, Circle as Ka, ArrowDownWideNarrow as js, Clock as Vs, Bookmark as Ls, X as Ja, Search as Za, ChevronsUpDown as Qa, FilterIcon as zs, ChevronDown as Qn, ChevronUp as Fs, ArrowLeftIcon as Us, ChevronLeftIcon as Gs, ChevronRightIcon as Hs, ArrowRightIcon as Xs, CircleCheckIcon as Ys, CircleXIcon as Ws, CircleHelpIcon as qs, ArrowUpIcon as Ks, ArrowDownIcon as Js, ArrowUpDownIcon as Zs, Star as Qs, ChevronLeft as el, LoaderCircle as tl, Download as nl, Filter as rl, User as ol, Link as al, CircleHelp as il } from "lucide-react";
import bt, { clsx as sl } from "clsx";
...
import { getChaptersForBook as dl, deepEqual as to, substring as ul, formatScrRef as Tr, compareScrRefs as zr, scrRefToBBBCCCVVV as Cr, getLocalizeKeyForScrollGroupId as ue, NumberFormat as pl, formatBytes as wl } from "platform-bible-utils";
import { Slot as fl } from "@radix-ui/react-slot";
import { cva as Nn } from "class-variance-authority";
import * as ei from "@radix-ui/react-label";
...
import { useReactTable as ti, getCoreRowModel as ni, getPaginationRowModel as ml, getSortedRowModel as ri, getFilteredRowModel as hl, flexRender as cn, getExpandedRowModel as gl, getGroupedRowModel as bl } from "@tanstack/react-table";
...
import vl, { ThemeContext as yl, internal_processStyles as xl } from "@mui/styled-engine";
import { MenuItem as Nl, ListItemText as kl, ListItemIcon as ii, Menu as El, Grid as si, List as Tl, IconButton as li, Drawer as Cl, AppBar as Sl, Toolbar as Ol } from "@mui/material";
...
var Al = Object.defineProperty, Dl = (e, t, n) => t in e ? Al(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => Dl(e, typeof t != "symbol" ? t + "" : t, n);
const yt = [
  "GEN",
  "EXO",
  "LEV",
...
te(_e, "Original", new _e(He.Original)), te(_e, "Septuagint", new _e(He.Septuagint)), te(_e, "Vulgate", new _e(He.Vulgate)), te(_e, "English", new _e(He.English)), te(_e, "RussianProtestant", new _e(He.RussianProtestant)), te(_e, "RussianOrthodox", new _e(He.RussianOrthodox));
let pt = _e;
function Qo(e, t) {
  const n = t[0];
...
const Ee = class ne {
  constructor(t, n, r, o) {
    if (te(this, "firstChapter"), te(this, "lastChapter"), te(this, "lastVerse"), te(this, "hasSegmentsDefined"), te(this, "text"), te(this, "BBBCCCVVVS"), te(this, "longHashCode"), te(this, "versification"), te(this, "rtlMark", "‏"), te(this, "_bookNum", 0), te(this, "_chapterNum", 0), te(this, "_verseNum", 0), te(this, "_verse"), r == null && o == null)
      if (t != null && typeof t == "string") {
        const a = t, i = n != null && n instanceof pt ? n : void 0;
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new pt(i)), n ? new ne(n, r.toString(), l, c) : new ne();
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = a[0], a.length > 1)
        try {
          const i = +a[1].trim();
          this.versification = new pt(He[i]);
        } catch {
...
*/
te(Ee, "ValidStatusType", fi);
class Qt extends Error {
}
const ao = we.Root, mi = we.Trigger, Xl = we.Group, km = we.Portal, Em = we.Sub, Tm = we.RadioGroup, Yl = A.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ x(
  we.SubTrigger,
  {
    ref: o,
    className: T(
    ...
    children: [
      n,
      /* @__PURE__ */ s(qa, { className: "tw-ml-auto tw-h-4 tw-w-4" })
    ]
  }
));
Yl.displayName = we.SubTrigger.displayName;
const Wl = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  we.SubContent,
  {
    ref: n,
    className: T(
...
Wl.displayName = we.SubContent.displayName;
...
const hi = A.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ s(
  we.Item,
  {
    ref: r,
    className: T(
...
hi.displayName = we.Item.displayName;
...
const gi = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  we.RadioItem,
  {
    ref: r,
    className: T(
    ...
    ...n,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(we.ItemIndicator, { children: /* @__PURE__ */ s(Ka, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
gi.displayName = we.RadioItem.displayName;
...
function Zl({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
...
function Cm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = pe(""), [o, a] = pe(
    oe.bookNumberToId(e.bookNum)
  ), [i, l] = pe(e.chapterNum ?? 0), [c, d] = pe(
    oe.bookNumberToId(e.bookNum)
  ), [u, h] = pe(!1), [w, b] = pe(u), v = gt(void 0), f = gt(void 0), m = gt(void 0), N = $e(
    (k) => nc(k).filter((B) => {
    ...
    tc.forEach((k) => {
      const B = n.match(k);
      if (B) {
        const [D, J = void 0, q = void 0] = B.slice(1), U = ac(D);
  ...
  return Qe(() => {
    ...
    const k = setTimeout(() => {
      if (w && f.current && m.current) {
        const D = m.current.offsetTop - ec;
  ...
  }, [w]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(ao, { modal: !1, open: u, onOpenChange: E, children: [
        ...
        children: [
          ...
          ea.map(
            (k, B) => N(k).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ s(En, { className: "tw-font-semibold tw-text-foreground/80", children: Ql[k] }),
...
const ic = Nn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? fl : "button", { className: T(ic({ variant: t, size: n, className: e })), ref: a, ...o })
);
me.displayName = "Button";
const sc = Nn(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Ge = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(ei.Root, { ref: n, className: T("pr-twp", sc(), e), ...t }));
Ge.displayName = ei.Root.displayName;
const bi = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  fn.Root,
  {
...
bi.displayName = fn.Root.displayName;
const Gr = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  fn.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ s(fn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ s(Ka, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Gr.displayName = fn.Item.displayName;
const vi = mn.Root, yi = mn.Trigger, so = A.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(mn.Portal, { children: /* @__PURE__ */ s(
  mn.Content,
  {
    ref: o,
    align: t,
...
so.displayName = mn.Content.displayName;
const lc = Ye.Portal, xi = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Ye.Overlay,
  {
    ref: n,
    className: T(
...
xi.displayName = Ye.Overlay.displayName;
const cc = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(lc, { children: [
  /* @__PURE__ */ s(xi, {}),
  /* @__PURE__ */ x(
    Ye.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ x(Ye.Close, { className: "tw-absolute tw-right-4 tw-top-4 tw-rounded-sm tw-opacity-70 tw-ring-offset-background tw-transition-opacity hover:tw-opacity-100 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-ring focus:tw-ring-offset-2 disabled:tw-pointer-events-none data-[state=open]:tw-bg-accent data-[state=open]:tw-text-muted-foreground", children: [
          /* @__PURE__ */ s(Ja, { className: "tw-h-4 tw-w-4" }),
...
cc.displayName = Ye.Content.displayName;
...
dc.displayName = Ye.Title.displayName;
const uc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Ye.Description,
  {
    ref: n,
...
uc.displayName = Ye.Description.displayName;
...
const co = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
  /* @__PURE__ */ s(Za, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
  /* @__PURE__ */ s(
    Oe.Input,
    {
      ref: n,
...
const uo = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Oe.List,
  {
    ref: n,
...
uo.displayName = Oe.List.displayName;
const po = A.forwardRef((e, t) => /* @__PURE__ */ s(Oe.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
po.displayName = Oe.Empty.displayName;
...
Ni.displayName = Oe.Group.displayName;
...
function ta({
  ...
  const [f, m] = pe(!1);
  return /* @__PURE__ */ x(vi, { open: f, onOpenChange: m, ...v, children: [
    /* @__PURE__ */ s(yi, { asChild: !0, children: /* @__PURE__ */ x(
      me,
      {
        variant: u,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ s(Qa, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(so, { align: h, className: "tw-w-[200px] tw-p-0", dir: w, children: /* @__PURE__ */ x(lo, { children: [
      ...
      /* @__PURE__ */ s(po, { children: d }),
      /* @__PURE__ */ s(uo, { children: t.map((N) => /* @__PURE__ */ x(
        wo,
        {
          value: a(N),
          onSelect: () => {
...
function fc({
  ...
  return /* @__PURE__ */ x(nt, { children: [
    /* @__PURE__ */ s(Ge, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ s(
      ta,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ s(Ge, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ s(
      ta,
      {
        isDisabled: o,
...
var mc = /* @__PURE__ */ ((e) => (e.CURRENT_BOOK = "current book", e.CHOOSE_BOOKS = "choose books", e))(mc || {});
...
function Om({
  ...
  const u = Sr(d, "%webView_bookSelector_currentBook%"), h = Sr(d, "%webView_bookSelector_choose%"), w = Sr(d, "%webView_bookSelector_chooseBooks%"), [b, v] = pe(
    "current book"
    /* CURRENT_BOOK */
  ), f = (m) => {
    v(m), e(m);
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Ge, { className: "tw-ml-1", children: u })
          ] }),
          /* @__PURE__ */ s(Ge, { className: "tw-flex tw-items-center", children: t }),
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Ge, { className: "tw-ml-1", children: w })
          ] }),
          /* @__PURE__ */ s(Ge, { className: "tw-flex tw-items-center", children: r.map((m) => oe.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ s(
            me,
            {
...
function hc({ table: e }) {
  return /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ s(cl, { asChild: !0, children: /* @__PURE__ */ x(me, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ s(zs, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const jt = be.Root, gc = be.Group, Vt = be.Value, xt = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  be.Trigger,
  {
    ref: r,
    className: T(
...
xt.displayName = be.Trigger.displayName;
const ki = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  be.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ s(Fs, { className: "tw-h-4 tw-w-4" })
  }
));
ki.displayName = be.ScrollUpButton.displayName;
const Ei = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  be.ScrollDownButton,
  {
    ref: n,
    className: T("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
...
Ei.displayName = be.ScrollDownButton.displayName;
const Nt = A.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ s(be.Portal, { children: /* @__PURE__ */ x(
  be.Content,
  {
    ref: o,
    className: T(
...
Nt.displayName = be.Content.displayName;
...
bc.displayName = be.Label.displayName;
const Me = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  be.Item,
  {
    ref: r,
    className: T(
...
Me.displayName = be.Item.displayName;
const vc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  be.Separator,
  {
    ref: n,
    className: T("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
vc.displayName = be.Separator.displayName;
function yc({ table: e }) {
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ x(
        jt,
        {
          ...
          children: [
            /* @__PURE__ */ s(xt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ s(Vt, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ s(Nt, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ s(Me, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
      ...
      /* @__PURE__ */ x(
        me,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s(Xs, { className: "tw-h-4 tw-w-4" })
          ]
        }
      )
    ] })
...
const Lt = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  "td",
  {
    ref: n,
...
const Nc = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  "caption",
  {
    ref: n,
...
function kc({
  ...
  var m;
  const [l, c] = pe([]), [d, u] = pe([]), [h, w] = pe({}), [b, v] = pe({}), f = ti({
    data: t,
    columns: e,
    getCoreRowModel: ni(),
    ...n && { getPaginationRowModel: ml() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ s(hc, { table: f }),
    /* @__PURE__ */ x(rr, { stickyHeader: a, children: [
      /* @__PURE__ */ s(or, { stickyHeader: a, children: f.getHeaderGroups().map((N) => /* @__PURE__ */ s(it, { children: N.headers.map((I) => /* @__PURE__ */ s(hn, { children: I.isPlaceholder ? void 0 : cn(I.column.columnDef.header, I.getContext()) }, I.id)) }, N.id)) }),
      /* @__PURE__ */ s(ar, { children: (m = f.getRowModel().rows) != null && m.length ? f.getRowModel().rows.map((N) => /* @__PURE__ */ s(
        it,
        {
          ...
          children: N.getVisibleCells().map((I) => /* @__PURE__ */ s(Lt, { children: cn(I.column.columnDef.cell, I.getContext()) }, I.id))
        },
        N.id
      )) : /* @__PURE__ */ s(it, { children: /* @__PURE__ */ s(Lt, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Ec({
  ...
  return /* @__PURE__ */ x(rr, { stickyHeader: !0, children: [
    /* @__PURE__ */ s(or, { stickyHeader: !0, children: /* @__PURE__ */ x(it, { children: [
    ...
    /* @__PURE__ */ s(ar, { children: a.length > 0 && a.map((i) => /* @__PURE__ */ x(
      it,
      {
        ...
        children: [
          /* @__PURE__ */ s(Lt, { children: `${oe.bookNumberToEnglishName(i.reference.bookNum)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ s(Lt, { children: i.text })
        ]
      },
...
}, Sc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Ti = Nn(
...
), Oc = A.forwardRef(({ className: e, variant: t, size: n, ...r }, o) => /* @__PURE__ */ s(
  oi.Root,
  {
    ref: o,
    className: T(Ti({ variant: t, size: n, className: e })),
    ...r
  }
));
Oc.displayName = oi.Root.displayName;
const Ci = A.createContext({
  size: "default",
  variant: "default"
}), Si = A.forwardRef(({ className: e, variant: t, size: n, children: r, ...o }, a) => /* @__PURE__ */ s(
  er.Root,
  {
    ref: a,
...
const ir = (e) => e === "asc" ? /* @__PURE__ */ s(Ks, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ s(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(Zs, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Rm = (e) => ({
  accessorKey: "item",
  ...
  cell: ({ row: a }) => {
    ...
    return /* @__PURE__ */ x(Si, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ s(
        Fn,
        {
          onClick: () => Or(
  ...
  return Tc(e).forEach((u) => {
    u.startsWith("\\id") && (i = Cc(u), l = 0, c = 0), u.startsWith("\\c") && (l = na(u), c = 0), u.startsWith("\\v") && (c = na(u), l === 0 && (l = t.chapterNum));
    ...
    for (; h; ) {
      ...
      const b = h.index, v = a.find((m) => to(m.items, w)), f = {
        ...
        text: ul(u, Math.max(0, b - 25), Math.min(b + 25, u.length))
      };
      if (v)
...
function Im({
  ...
  const h = Je(n, "%webView_inventory_all%"), w = Je(n, "%webView_inventory_approved%"), b = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), f = Je(n, "%webView_inventory_scope_currentBook%"), m = Je(n, "%webView_inventory_scope_chapter%"), N = Je(n, "%webView_inventory_scope_verse%"), I = Je(n, "%webView_inventory_filter_text%"), O = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, g] = pe(!1), [_, L] = pe("all"), [H, C] = pe(""), [P, k] = pe([]), B = Te(() => l ? r instanceof RegExp ? _c(
    l,
    e,
    a,
    i,
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ x(
        jt,
        {
          ...
          defaultValue: _,
          children: [
            /* @__PURE__ */ s(xt, { className: "tw-m-1", children: /* @__PURE__ */ s(Vt, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ x(Nt, { children: [
              /* @__PURE__ */ s(Me, { value: "all", children: h }),
              /* @__PURE__ */ s(Me, { value: "approved", children: w }),
              /* @__PURE__ */ s(Me, { value: "unapproved", children: b }),
              /* @__PURE__ */ s(Me, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ x(jt, { onValueChange: (y) => ee(y), defaultValue: c, children: [
        /* @__PURE__ */ s(xt, { className: "tw-m-1", children: /* @__PURE__ */ s(Vt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ x(Nt, { children: [
          /* @__PURE__ */ s(Me, { value: "book", children: f }),
          /* @__PURE__ */ s(Me, { value: "chapter", children: m }),
          /* @__PURE__ */ s(Me, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ s(
        kn,
      ...
      o && /* @__PURE__ */ x("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ s(Ge, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? O })
      ] })
    ] }),
...
function Am({
  ...
  return /* @__PURE__ */ x(vi, { open: d, onOpenChange: u, children: [
    /* @__PURE__ */ s(yi, { asChild: !0, children: /* @__PURE__ */ x(
      me,
      {
        variant: "outline",
        ...
        children: [
          ...
          /* @__PURE__ */ s(Qa, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(so, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(lo, { children: [
      ...
      /* @__PURE__ */ x(uo, { children: [
        /* @__PURE__ */ s(po, { children: a }),
        /* @__PURE__ */ s(Ni, { children: b.map((v) => {
          ...
          return /* @__PURE__ */ x(
            wo,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ s("div", { className: "tw-w-4", children: v.starred && /* @__PURE__ */ s(Qs, { className: "tw-h-4 tw-w-4" }) }),
...
function $c({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-relative", children: [
    /* @__PURE__ */ s(Za, { className: "tw-absolute tw-left-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-opacity-50" }),
    /* @__PURE__ */ s(
      kn,
      {
        className: T(
...
const Ri = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Re.List,
  {
    ref: n,
    className: T(
...
const Ic = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Re.Trigger,
  {
    ref: n,
    ...t,
...
)), Pi = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Re.Content,
  {
    ref: n,
    className: T(
...
Pi.displayName = Re.Content.displayName;
function Dm({
  tabList: e,
  onSearch: t,
  searchPlaceholder: n,
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(Oi, { dir: a, children: [
      /* @__PURE__ */ s(Ri, { children: e.map((i) => /* @__PURE__ */ s(Ic, { value: i.value, children: i.value }, i.key)) }),
      e.map((i) => /* @__PURE__ */ s(Pi, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
const ot = "scrBook", Ac = "scrRef", wt = "source", Dc = "details", Mc = "Scripture Reference", Bc = "Scripture Book", _i = "Type", jc = "Details";
function Vc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: ot,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Mc,
      cell: (r) => {
    ...
    },
    {
      ...
      id: wt,
      header: n ? (e == null ? void 0 : e.typeColumnName) ?? _i : void 0,
...
}, ra = (e) => `${Lc({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Mm({
  sources: e,
  ...
  const [d, u] = pe([]), [h, w] = pe([{ id: ot, desc: !1 }]), [b, v] = pe({}), f = Te(
  ...
  const I = o ?? Bc, O = a ?? _i, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${I}`, value: [ot] },
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ x(
      jt,
      {
        ...
        children: [
          /* @__PURE__ */ s(xt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ s(Vt, {}) }),
          /* @__PURE__ */ s(Nt, { position: "item-aligned", children: /* @__PURE__ */ s(gc, { children: E.map((C) => /* @__PURE__ */ s(Me, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(rr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ s(or, { children: N.getHeaderGroups().map((C) => /* @__PURE__ */ s(it, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ x(
                    me,
                    {
                      ...
                      children: [
                        ...
                        !C.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ s(qa, {}) : /* @__PURE__ */ s(el, {})),
                        " ",
...
function Bm({
  ...
  return /* @__PURE__ */ x(
    jt,
    {
      ...
      children: [
        /* @__PURE__ */ s(xt, { className: "pr-twp tw-w-auto", children: /* @__PURE__ */ s(
          Vt,
          {
        ...
        /* @__PURE__ */ s(
          ...
          {
            style: { zIndex: 250 },
            children: e.map((a) => /* @__PURE__ */ s(Me, { value: `${a}`, children: o[ue(a)] }, `${a}`))
          }
        )
      ]
    }
...
const $i = A.forwardRef(({ className: e, orientation: t = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ s(
  ai.Root,
  {
    ref: o,
    decorative: n,
...
$i.displayName = ai.Root.displayName;
...
function zm({
  ...
  return /* @__PURE__ */ s("div", { id: e, className: t, children: n.map((i) => /* @__PURE__ */ x("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    ...
    /* @__PURE__ */ s(Ge, { children: a ? a(i) : i })
  ] }, i)) });
}
function zc(e) {
...
function Ze(e, t, n = {
  ...
  return ht(e) && ht(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (ht(t[o]) && o in e && ht(e[o]) ? r[o] = Ze(e[o], t[o], n) : n.clone ? r[o] = ht(t[o]) ? Ai(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
...
function Gc() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = d, ie.ContextConsumer = l, ie.ContextProvider = i, ie.Element = t, ie.ForwardRef = u, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = a, ie.StrictMode = o, ie.Suspense = h, ie.isAsyncMode = function(g) {
    return E(g) || O(g) === c;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === d || g === a || g === o || g === h || g === w || typeof g == "object" && g !== null && (g.$$typeof === v || g.$$typeof === b || g.$$typeof === i || g.$$typeof === l || g.$$typeof === u || g.$$typeof === m || g.$$typeof === N || g.$$typeof === I || g.$$typeof === f);
  }, ie.typeOf = O, ie;
}
var se = {};
/** @license React v16.13.1
...
function Hc() {
  return aa || (aa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function O($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === h || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === b || $.$$typeof === i || $.$$typeof === l || $.$$typeof === u || $.$$typeof === m || $.$$typeof === N || $.$$typeof === I || $.$$typeof === f);
    }
    function E($) {
    ...
    var g = c, _ = d, L = l, H = i, C = t, P = u, k = r, B = v, D = b, J = n, q = a, U = o, ee = h, ae = !1;
    function re($) {
...
var ia;
function Di() {
  return ia || (ia = 1, process.env.NODE_ENV === "production" ? Bn.exports = Gc() : Bn.exports = Hc()), Bn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Wc() {
  if (ua)
    return Dr;
  ua = 1;
  var e = Di(), t = Xc(), n = go(), r = Mi(), o = Yc(), a = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var Kc = Di(), Jc = !0;
  Hr.exports = Wc()(Kc.isElement, Jc);
} else
  Hr.exports = qc()();
var Zc = Hr.exports;
const p = /* @__PURE__ */ zc(Zc);
function Qc(e) {
  const {
    prototype: t = {}
  } = e;
...
function Bi(e, t, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Qc(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${i}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ji = ho(p.element, Bi);
ji.isRequired = ho(p.element.isRequired, Bi);
const Vi = ji, ed = "exact-prop: ​";
function td(e) {
...
function nd() {
  ...
  return le.ContextConsumer = i, le.ContextProvider = a, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = w, le.Memo = h, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = d, le.SuspenseList = u, le.isAsyncMode = function() {
    return !1;
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === d || m === u || m === b || typeof m == "object" && m !== null && (m.$$typeof === w || m.$$typeof === h || m.$$typeof === a || m.$$typeof === i || m.$$typeof === c || m.$$typeof === v || m.getModuleId !== void 0);
  }, le.typeOf = f, le;
}
var ce = {};
/**
...
function rd() {
  return fa || (fa = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, f = !1, m = !1, N = !1, I = !1, O;
    O = Symbol.for("react.module.reference");
    function E(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || I || j === r || j === d || j === u || N || j === b || v || f || m || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === h || j.$$typeof === a || j.$$typeof === i || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var _ = i, L = a, H = e, C = c, P = n, k = w, B = h, D = t, J = o, q = r, U = d, ee = u, ae = !1, re = !1;
    function y(j) {
...
process.env.NODE_ENV === "production" ? Xr.exports = nd() : Xr.exports = rd();
var ma = Xr.exports;
...
const sd = p.oneOfType([p.func, p.object]), zi = sd;
function We(e) {
  if (typeof e != "string")
...
function wd(e, t) {
  ...
  return (o) => (a, i, l, c, d, ...u) => {
    const h = d || i, w = n == null ? void 0 : n[h];
    if (w) {
      const b = w(a, i, l, c, d, ...u);
      if (b)
        return b;
    }
...
const fd = typeof window < "u" ? M.useLayoutEffect : M.useEffect, Ft = fd;
let ga = 0;
function md(e) {
...
function Nd(e) {
  ...
  return !!(n === "INPUT" && xd[t] && !e.readOnly || n === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function kd(e) {
...
function Td(e) {
  e.addEventListener("keydown", kd, !0), e.addEventListener("mousedown", Br, !0), e.addEventListener("pointerdown", Br, !0), e.addEventListener("touchstart", Br, !0), e.addEventListener("visibilitychange", Ed, !0);
}
function Cd(e) {
  const {
    target: t
...
function Gi() {
  const e = M.useCallback((o) => {
    o != null && Td(o.ownerDocument);
  }, []), t = M.useRef(!1);
  function n() {
    return t.current ? (Wr = !0, yd.start(100, () => {
      Wr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
const Pd = ["values", "unit", "step"], _d = (e) => {
...
function $d(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = Ne(e, Pd), a = _d(t), i = Object.keys(a);
  function l(w) {
...
const Id = {
  borderRadius: 4
}, Ad = Id, Dd = process.env.NODE_ENV !== "production" ? p.oneOfType([p.number, p.string, p.object, p.array]) : {}, st = Dd;
function un(e, t) {
  return t ? Ze(e, t, {
    clone: !1
...
const Vd = {
  ...
  if (e.length > 2)
    if (Na[e])
      ...
      return [e];
  const [t, n] = e.split(""), r = Vd[t], o = Ld[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), dr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], ur = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Fd = [...dr, ...ur];
function Cn(e, t, n, r) {
  var o;
...
function Gd(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = zd(n), a = Ud(o, r), i = e[n];
  return et(e, i, a);
}
function Ki(e, t) {
  const n = qi(e.theme);
  return Object.keys(e).map((r) => Gd(e, t, r, n)).reduce(un, {});
}
function he(e) {
  return Ki(e, dr);
}
...
ge.propTypes = process.env.NODE_ENV !== "production" ? ur.reduce((e, t) => (e[t] = st, e), {}) : {};
ge.filterProps = ur;
process.env.NODE_ENV !== "production" && Fd.reduce((e, t) => (e[t] = st, e), {});
function Hd(e = 8) {
  if (e.mui)
    return e;
  const t = qi({
...
const Xd = ze("border", Be), Yd = ze("borderTop", Be), Wd = ze("borderRight", Be), qd = ze("borderBottom", Be), Kd = ze("borderLeft", Be), Jd = ze("borderColor"), Zd = ze("borderTopColor"), Qd = ze("borderRightColor"), eu = ze("borderBottomColor"), tu = ze("borderLeftColor"), nu = ze("outline", Be), ru = ze("outlineColor"), wr = (e) => {
...
pr(Xd, Yd, Wd, qd, Kd, Jd, Zd, Qd, eu, tu, wr, nu, ru);
const fr = (e) => {
...
pr(fr, mr, hr, ou, au, iu, su, lu, cu, du, uu, pu);
function Bt(e, t) {
  return t === "grey" ? t : e;
}
const wu = ve({
...
function Tu() {
  function e(n, r, o, a) {
    ...
    const w = cr(o, d) || {};
    return h ? h(i) : et(i, r, (v) => {
      let f = Wn(w, u, v);
      return v === f && typeof v == "string" && (f = Wn(w, u, `${n}${v === "default" ? "" : We(v)}`, v)), c === !1 ? f : {
        [c]: f
      };
    });
  }
  function t(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const u = Md(a.breakpoints), h = Object.keys(u);
      let w = u;
...
function ko(e = {}, ...t) {
  ...
  return d.applyStyles = Cu, d = t.reduce((u, h) => Ze(u, h), d), d.unstable_sxConfig = R({}, xo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return No({
      sx: h,
      theme: this
    });
...
const Pu = ["ownerState"], _u = ["variants"], $u = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Iu(e) {
  return Object.keys(e).length === 0;
}
function Au(e) {
...
const Du = ko(), ka = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function jn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Bu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    xl(i, (g) => g.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = Mu(ka(d))
    } = l, b = Ne(l, $u), v = u !== void 0 ? u : (
    ...
    let N = Un;
    d === "Root" || d === "root" ? N = r : d ? N = o : Au(i) && (N = void 0);
    const I = vl(i, R({
      shouldForwardProp: N,
      label: m
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${We(d || "")}`), k === void 0 && (k = `Styled(${id(i)})`), P.displayName = k;
      }
...
function zu(e) {
  ...
  const {
    values: t
  } = e, n = t[0], r = t[1] / 100, o = t[2] / 100, a = r * Math.min(o, 1 - o), i = (d, u = (d + n / 30) % 12) => o - a * Math.max(Math.min(u - 3, 9 - u, 1), -1);
  let l = "rgb";
...
function Ea(e) {
  e = Et(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Et(zu(e)).values : e.values;
...
function es(e, t) {
  return e = Et(e), t = Eo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, gr(e);
}
function Fu(e, t) {
  if (e = Et(e), t = Eo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Hu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, At = Qu, ep = ["mode", "contrastThreshold", "tonalOffset"], Ca = {
...
function Sa(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Uu(e.main, o) : t === "dark" && (e.dark = Fu(e.main, a)));
}
function tp(e = "light") {
  return e === "dark" ? {
    main: $t[200],
...
function sp(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = Ne(e, ep), a = e.primary || tp(t), i = e.secondary || np(t), l = e.error || rp(t), c = e.info || op(t), d = e.success || ap(t), u = e.warning || ip(t);
  function h(f) {
...
The color object needs to have a \`main\` property or a \`${N}\` property.` : zt(11, m ? ` (${m})` : "", N));
...
} });` : zt(12, m ? ` (${m})` : "", JSON.stringify(f.main)));
...
const up = 0.2, pp = 0.14, wp = 0.12;
function fe(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${up})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${pp})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${wp})`].join(",");
}
const fp = ["none", fe(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), fe(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), fe(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), fe(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), fe(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), fe(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), fe(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), fe(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), fe(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), fe(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), fe(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), fe(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), fe(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), fe(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), fe(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), fe(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), fe(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), fe(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), fe(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), fe(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), fe(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), fe(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), fe(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), fe(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], mp = fp, hp = ["duration", "easing", "delay"], gp = {
...
function yp(e) {
  const t = R({}, gp, e.easing), n = R({}, bp, e.duration);
  return R({
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((u) => `${u} ${typeof i == "string" ? i : Pa(i)} ${l} ${typeof c == "string" ? c : Pa(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: n
...
const xp = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Np = xp, kp = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Ep(e = {}, ...t) {
  const {
    mixins: n = {},
    palette: r = {},
  ...
  if (d = Ze(d, i), d = t.reduce((u, h) => Ze(u, h), d), process.env.NODE_ENV !== "production") {
...
const Cp = (e) => Un(e) && e !== "classes", Sp = Bu({
  themeId: Co,
  defaultTheme: To,
  rootShouldForwardProp: Cp
}), On = Sp;
function Op(e) {
...
const Rp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Pp = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  const r = So({
    ...
    titleAccess: h,
    viewBox: w = "0 0 24 24"
  } = r, b = Ne(r, Rp), v = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", f = R({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
`)), Xi.configure(e);
  ...
  __proto__: null,
  capitalize: We,
  createChainedFunction: ld,
  createSvgIcon: ts,
  debounce: cd,
  deprecatedPropType: dd,
  isMuiElement: ud,
  ownerDocument: Xn,
  ownerWindow: pd,
...
}, Symbol.toStringTag, { value: "Module" })), Ap = /* @__PURE__ */ Fc(Ip);
var $a;
function Dp() {
...
var ns = mo.default = void 0, Bp = Mp(Dp()), jp = Ms;
ns = mo.default = (0, Bp.default)(/* @__PURE__ */ (0, jp.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Vp(e) {
...
function sn(e, t, n) {
  return e === void 0 || Vp(e) ? t : R({}, t, {
    ownerState: R({}, t.ownerState, n)
  });
}
const Lp = {
  disableDefaultClasses: !1
}, zp = /* @__PURE__ */ M.createContext(Lp);
function Fp(e) {
  const {
...
function Hp(e) {
  ...
  const i = Up(R({}, o, r)), l = Ia(r), c = Ia(o), d = t(i), u = bt(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = R({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = R({}, d, n, c, l);
  return u.length > 0 && (w.className = u), Object.keys(h).length > 0 && (w.style = h), {
    props: w,
    internalRef: d.ref
  };
}
const Xp = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function Yp(e) {
  var t;
  const {
    elementType: n,
...
const qn = /* @__PURE__ */ M.forwardRef(function(t, n) {
  const {
    ...
    container: o,
    disablePortal: a = !1
  } = t, [i, l] = M.useState(null), c = kt(/* @__PURE__ */ M.isValidElement(r) ? r.ref : null, n);
  if (Ft(() => {
    a || l(Jp(o) || document.body);
  }, [o, a]), Ft(() => {
    if (i && !a)
      return Yn(n, i), () => {
        Yn(n, null);
  ...
  return /* @__PURE__ */ s(M.Fragment, {
    children: i && /* @__PURE__ */ Rl.createPortal(r, i)
  });
});
...
process.env.NODE_ENV !== "production" && (qn["propTypes"] = td(qn.propTypes));
var Ce = "top", Ve = "bottom", Le = "right", Se = "left", Ro = "auto", Rn = [Ce, Ve, Le, Se], Ut = "start", vn = "end", Zp = "clippingParents", as = "viewport", nn = "popper", Qp = "reference", Aa = /* @__PURE__ */ Rn.reduce(function(e, t) {
  return e.concat([t + "-" + Ut, t + "-" + vn]);
}, []), is = /* @__PURE__ */ [].concat(Rn, [Ro]).reduce(function(e, t) {
  return e.concat([t, t + "-" + Ut, t + "-" + vn]);
}, []), ew = "beforeRead", tw = "read", nw = "afterRead", rw = "beforeMain", ow = "main", aw = "afterMain", iw = "beforeWrite", sw = "write", lw = "afterWrite", cw = [ew, tw, nw, rw, ow, aw, iw, sw, lw];
function qe(e) {
...
function dw(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !je(a) || !qe(a) || (Object.assign(a.style, r), Object.keys(o).forEach(function(i) {
      var l = o[i];
...
var vt = Math.max, Kn = Math.min, Gt = Math.round;
function qr() {
...
function Ht(e, t, n) {
  ...
  var i = Tt(e) ? Ae(e) : window, l = i.visualViewport, c = !ss() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / a, h = r.width / o, w = r.height / a;
  return {
    width: h,
    height: w,
    top: u,
...
function fw(e) {
  ...
  var o = br(e);
  for (Po(o) && (o = o.host); je(o) && ["html", "body"].indexOf(qe(o)) < 0; ) {
    var a = tt(o);
...
function Pn(e) {
  for (var t = Ae(e), n = Da(e); n && ww(n) && tt(n).position === "static"; )
    n = Da(n);
  return n && (qe(n) === "html" || qe(n) === "body" && tt(n).position === "static") ? t : n || fw(e) || t;
}
function $o(e) {
...
var hw = function(t, n) {
  ...
  })) : t, ds(typeof t != "number" ? t : us(t, Rn));
};
function gw(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Xe(n.placement), c = $o(l), d = [Se, Le].indexOf(l) >= 0, u = d ? "height" : "width";
  if (!(!a || !i)) {
    var h = hw(o.padding, n), w = _o(a), b = c === "y" ? Ce : Se, v = c === "y" ? Ve : Le, f = n.rects.reference[u] + n.rects.reference[c] - i[c] - n.rects.popper[u], m = i[c] - n.rects.reference[c], N = Pn(a), I = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, O = f / 2 - m / 2, E = h[b], g = I - w[u] - h[v], _ = I / 2 - w[u] / 2 + O, L = pn(E, _, g), H = c;
...
function Ma(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, i = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, u = e.roundOffsets, h = e.isFixed, w = i.x, b = w === void 0 ? 0 : w, v = i.y, f = v === void 0 ? 0 : v, m = typeof u == "function" ? u({
    x: b,
    y: f
  }) : {
    x: b,
  ...
  if (d) {
    ...
    if (_ === Ae(n) && (_ = lt(n), tt(_).position !== "static" && l === "absolute" && (L = "scrollHeight", H = "scrollWidth")), _ = _, o === Ce || (o === Se || o === Le) && a === vn) {
      E = Ve;
...
function Ao(e) {
  return Ht(lt(e)).left + Io(e).scrollLeft;
}
function Ow(e, t) {
...
function ps(e) {
  return ["html", "body", "#document"].indexOf(qe(e)) >= 0 ? e.ownerDocument.body : je(e) && Do(e) ? e : ps(br(e));
}
function wn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function ja(e, t, n) {
  return t === as ? Kr(Ow(e, n)) : Tt(t) ? Pw(t, n) : Kr(Rw(lt(e)));
}
function _w(e) {
  var t = wn(br(e)), n = ["absolute", "fixed"].indexOf(tt(e).position) >= 0, r = n && je(e) ? Pn(e) : e;
  return Tt(r) ? t.filter(function(o) {
    return Tt(o) && ls(o, r) && qe(o) !== "body";
  }) : [];
}
function $w(e, t, n, r) {
  var o = t === "clippingParents" ? _w(e) : [].concat(t), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, d) {
    var u = ja(e, d, r);
    return c.top = vt(u.top, c.top), c.right = Kn(u.right, c.right), c.bottom = Kn(u.bottom, c.bottom), c.left = vt(u.left, c.left), c;
  }, ja(e, i, r));
  return l.width = l.right - l.left, l.height = l.bottom - l.top, l.x = l.left, l.y = l.top, l;
}
function ws(e) {
  var t = e.reference, n = e.element, r = e.placement, o = r ? Xe(r) : null, a = r ? Xt(r) : null, i = t.x + t.width / 2 - n.width / 2, l = t.y + t.height / 2 - n.height / 2, c;
  switch (o) {
    case Ce:
      c = {
        x: i,
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Zp : l, d = n.rootBoundary, u = d === void 0 ? as : d, h = n.elementContext, w = h === void 0 ? nn : h, b = n.altBoundary, v = b === void 0 ? !1 : b, f = n.padding, m = f === void 0 ? 0 : f, N = ds(typeof m != "number" ? m : us(m, Rn)), I = w === nn ? Qp : nn, O = e.rects.popper, E = e.elements[v ? I : w], g = $w(Tt(E) ? E : E.contextElement || lt(e.elements.popper), c, u, i), _ = Ht(e.elements.reference), L = ws({
    reference: _,
    element: O,
    strategy: "absolute",
    placement: o
  ...
  if (w === nn && k) {
    ...
    Object.keys(P).forEach(function(D) {
      var J = [Le, Ve].indexOf(D) >= 0 ? 1 : -1, q = [Ce, Ve].indexOf(D) >= 0 ? "y" : "x";
      P[D] += B[q] * J;
    });
  }
  return P;
...
function Iw(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? is : c, u = Xt(r), h = u ? l ? Aa : Aa.filter(function(v) {
    return Xt(v) === u;
...
function Dw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, u = n.boundary, h = n.rootBoundary, w = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, f = n.allowedAutoPlacements, m = t.options.placement, N = Xe(m), I = N === m, O = c || (I || !v ? [Hn(m)] : Aw(m)), E = [m].concat(O).reduce(function(V, W) {
      return V.concat(Xe(W) === Ro ? Iw(t, {
        placement: W,
        boundary: u,
        rootBoundary: h,
        padding: d,
      ...
      var k = E[P], B = Xe(k), D = Xt(k) === Ut, J = [Ce, Ve].indexOf(B) >= 0, q = J ? "width" : "height", U = yn(t, {
        placement: k,
        boundary: u,
        rootBoundary: h,
        altBoundary: w,
        padding: d
      }), ee = J ? D ? Le : Se : D ? Ve : Ce;
      g[q] > _[q] && (ee = Hn(ee));
      var ae = Hn(ee), re = [];
...
function Bw(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, i = yn(t, {
    ...
    altBoundary: !0
  }), c = Va(i, r), d = Va(l, o, a), u = La(c), h = La(d);
  t.modifiersData[n] = {
...
function Vw(e, t, n) {
  ...
  return i = i || 0, l = (l || 0) * o, [Se, Le].indexOf(r) >= 0 ? {
    x: l,
    y: i
  } : {
    x: i,
...
function Lw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, a = o === void 0 ? [0, 0] : o, i = is.reduce(function(u, h) {
    return u[h] = Vw(h, t.rects, a), u;
...
function Hw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, h = n.padding, w = n.tether, b = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: u
  }), N = Xe(t.placement), I = Xt(t.placement), O = !I, E = $o(N), g = Gw(E), _ = t.modifiersData.popperOffsets, L = t.rects.reference, H = t.rects.popper, C = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, P = typeof C == "number" ? {
    mainAxis: C,
    altAxis: C
  ...
  if (_) {
    if (a) {
      var D, J = E === "y" ? Ce : Se, q = E === "y" ? Ve : Le, U = E === "y" ? "height" : "width", ee = _[E], ae = ee + m[J], re = ee - m[q], y = b ? -H[U] / 2 : 0, S = I === Ut ? L[U] : H[U], z = I === Ut ? -H[U] : -L[U], F = t.elements.arrow, V = b && F ? _o(F) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : cs(), X = W[J], Y = W[q], G = pn(0, L[U], V[U]), K = O ? L[U] / 2 - y - G - X - P.mainAxis : S - G - X - P.mainAxis, Z = O ? -L[U] / 2 + y + G + Y + P.mainAxis : z + G + Y + P.mainAxis, de = t.elements.arrow && Pn(t.elements.arrow), $ = de ? E === "y" ? de.clientTop || 0 : de.clientLeft || 0 : 0, xe = (D = k == null ? void 0 : k[E]) != null ? D : 0, j = ee + K - xe - $, ye = ee + Z - xe, Fe = pn(b ? Kn(ae, j) : ae, ee, b ? vt(re, ye) : re);
      _[E] = Fe, B[E] = Fe - ee;
    }
    if (l) {
      var ct, ke = E === "x" ? Ce : Se, $n = E === "x" ? Ve : Le, Ue = _[g], Ct = g === "y" ? "height" : "width", dt = Ue + m[ke], St = Ue - m[$n], Ot = [Ce, Se].indexOf(N) !== -1, Rt = (ct = k == null ? void 0 : k[g]) != null ? ct : 0, ut = Ot ? dt : Ue - L[Ct] - H[Ct] - Rt + P.altAxis, Wt = Ot ? Ue + L[Ct] + H[Ct] - Rt - P.altAxis : St, In = b && Ot ? mw(ut, Ue, Wt) : pn(b ? ut : dt, Ue, b ? Wt : St);
      _[g] = In, B[g] = In - Ue;
    }
    t.modifiersData[r] = B;
  }
...
function Kw(e, t, n) {
  n === void 0 && (n = !1);
  var r = je(t), o = je(t) && qw(t), a = lt(t), i = Ht(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Do(a)) && (l = Ww(t)), je(t) ? (c = Ht(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Ao(a))), {
  ...
  return function(l, c, d) {
    ...
    var u = {
      ...
      setOptions: function(N) {
        var I = typeof N == "function" ? N(u.options) : N;
        f(), u.options = Object.assign({}, a, u.options, I), u.scrollParents = {
          reference: Tt(l) ? wn(l) : l.contextElement ? wn(l.contextElement) : [],
          popper: wn(c)
        };
        var O = Zw(ef([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          var N = u.elements, I = N.reference, O = N.popper;
          if (Fa(I, O)) {
            u.rects = {
              reference: Kw(I, Pn(O), u.options.strategy === "fixed"),
              popper: _o(O)
            ...
            for (var E = 0; E < u.orderedModifiers.length; E++) {
              ...
              var g = u.orderedModifiers[E], _ = g.fn, L = g.options, H = L === void 0 ? {} : L, C = g.name;
...
var nf = [Tw, Uw, kw, pw, zw, Mw, Xw, vw, jw], rf = /* @__PURE__ */ tf({
  defaultModifiers: nf
});
const fs = "Popper";
function of(e) {
...
Kp(fs, ["root"]);
const af = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], sf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function lf(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const df = () => bo({
  root: ["root"]
}, Fp(of)), uf = {}, pf = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, m = Ne(t, af), N = M.useRef(null), I = kt(N, n), O = M.useRef(null), E = kt(O, w), g = M.useRef(E);
  Ft(() => {
    g.current = E;
  }, [E]), M.useImperativeHandle(w, () => O.current, []);
  const _ = lf(u, i), [L, H] = M.useState(_), [C, P] = M.useState(Jn(o));
  M.useEffect(() => {
...
`));
  ...
  const B = df(), D = (r = v.root) != null ? r : "div", J = Yp({
    elementType: D,
  ...
  const {
    ...
    slotProps: m = {},
    slots: N = {}
  } = t, I = Ne(t, sf), [O, E] = M.useState(!0), g = () => {
    E(!1);
  }, _ = () => {
    E(!0);
  };
...
process.env.NODE_ENV !== "production" && (ms.propTypes = {
   ...
   */
  anchorEl: ho(p.oneOfType([gn, p.object, p.func]), (e) => {
    if (e.open) {
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || cf(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
var ff = process.env.NODE_ENV !== "production" ? p.oneOfType([p.number, p.shape({
  enter: p.number,
  exit: p.number,
  appear: p.number
}).isRequired]) : null;
...
var mf = function(t) {
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== mt && i !== Mt && (a = mt) : (i === mt || i === Mt) && (a = Zr);
    }
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Mn.findDOMNode(this), l], d = c[0], u = c[1], h = this.getTimeouts(), w = l ? h.appear : h.enter;
    if (!o && !i || Ua.disabled) {
      this.safeSetState({
        status: Mt
      }, function() {
    ...
    return (
      ...
      /* @__PURE__ */ A.createElement(gs.Provider, {
        value: null
...
rt.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  nodeRef: p.shape({
    current: typeof Element > "u" ? p.any : function(e, t, n, r, o, a) {
      var i = e[t];
      return p.instanceOf(i && "ownerDocument" in i ? i.ownerDocument.defaultView.Element : Element)(e, t, n, r, o, a);
    }
  }),
  /**
...
const vf = {
  ...
  const {
    ...
    TransitionComponent: m = hf
  } = t, N = Ne(t, bf), I = an(), O = M.useRef(), E = hs(), g = M.useRef(null), _ = kt(g, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = g.current;
...
Mo.muiSupportAuto = !0;
const Ha = Mo, yf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], xf = On(ms, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = Zi(), a = So({
    ...
    slots: O,
    slotProps: E
  } = a, g = Ne(a, yf), _ = (r = O == null ? void 0 : O.root) != null ? r : c == null ? void 0 : c.Root, L = R({
    anchorEl: i,
    container: u,
    disablePortal: h,
    keepMounted: w,
...
const kf = Wi("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), at = kf, Ef = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Tf(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Cf = (e) => {
  ...
  backgroundColor: e.vars ? e.vars.palette.Tooltip.bg : es(e.palette.grey[700], 0.92),
  ...
  color: e.vars ? e.vars.palette.Tooltip.bg : es(e.palette.grey[700], 0.9),
  "&::before": {
    content: '""',
    margin: "auto",
    display: "block",
...
const ys = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, i, l, c, d, u, h, w, b, v, f, m, N, I, O, E, g;
  const _ = So({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: xe
  } = _, j = Ne(_, Ef), ye = /* @__PURE__ */ M.isValidElement(H) ? H : /* @__PURE__ */ s("span", {
    children: H
  }), Fe = hs(), ct = Fe.direction === "rtl", [ke, $n] = M.useState(), [Ue, Ct] = M.useState(null), dt = M.useRef(!1), St = J || re, Ot = an(), Rt = an(), ut = an(), Wt = an(), [In, Bo] = Ui({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const yr = Fi(y), qt = M.useRef(), An = Yr(() => {
  ...
  const jo = (Q) => {
    ...
    (Q) => {
      Xa.start(800 + S, () => {
        Ln = !1;
      }), Bo(!1), F && Ke && F(Q), Ot.start(Fe.transitions.duration.shortest, () => {
        dt.current = !1;
      });
    }
  ), xr = (Q) => {
    dt.current && Q.type !== "touchstart" || (ke && ke.removeAttribute("title"), Rt.clear(), ut.clear(), U || Ln && ee ? Rt.start(Ln ? ee : U, () => {
      jo(Q);
    }) : jo(Q));
  }, Vo = (Q) => {
    Rt.clear(), ut.start(S, () => {
    ...
    onFocus: Ts,
    ref: Cs
  } = Gi(), [, zo] = M.useState(!1), Fo = (Q) => {
    Es(Q), Lo.current === !1 && (zo(!1), Vo(Q));
  }, Uo = (Q) => {
    ke || $n(Q.currentTarget), Ts(Q), Lo.current === !0 && (zo(!0), xr(Q));
  }, Go = (Q) => {
    dt.current = !0;
    const Pe = ye.props;
    Pe.onTouchStart && Pe.onTouchStart(Q);
  }, Ho = xr, Xo = Vo, Ss = (Q) => {
    Go(Q), ut.clear(), Ot.clear(), An(), qt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Wt.start(ae, () => {
      document.body.style.WebkitUserSelect = qt.current, xr(Q);
    });
  }, Os = (Q) => {
    ye.props.onTouchEnd && ye.props.onTouchEnd(Q), An(), ut.start(z, () => {
      Dn(Q);
    });
  };
  M.useEffect(() => {
  ...
  const Rs = kt(ye.ref, Cs, $n, n);
  !de && de !== 0 && (Ke = !1);
  const Nr = M.useRef(), Ps = (Q) => {
    const Pe = ye.props;
    Pe.onMouseMove && Pe.onMouseMove(Q), rn = {
      x: Q.clientX,
      y: Q.clientY
    }, Nr.current && Nr.current.update();
  }, Kt = {}, kr = typeof de == "string";
  k ? (Kt.title = !Ke && kr && !D ? de : null, Kt["aria-describedby"] = Ke ? yr : null) : (Kt["aria-label"] = kr ? de : null, Kt["aria-labelledby"] = Ke && !kr ? yr : null);
  const De = R({}, Kt, j, ye.props, {
...
`));
  ...
  const Jt = {};
  q || (De.onTouchStart = Ss, De.onTouchEnd = Os), D || (De.onMouseOver = zn(Ho, De.onMouseOver), De.onMouseLeave = zn(Xo, De.onMouseLeave), St || (Jt.onMouseOver = Ho, Jt.onMouseLeave = Xo)), B || (De.onFocus = zn(Uo, De.onFocus), De.onBlur = zn(Fo, De.onBlur), St || (Jt.onFocus = Uo, Jt.onBlur = Fo)), process.env.NODE_ENV !== "production" && ye.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ye.props.title}\` or the Tooltip component.`].join(`
`));
  const _s = M.useMemo(() => {
    var Q;
    let Pe = [{
    ...
    touch: dt.current
  }), Er = Cf(Zt), Yo = (r = (o = Z.popper) != null ? o : C.Popper) != null ? r : Sf, Wo = (a = (i = (l = Z.transition) != null ? l : C.Transition) != null ? i : $) != null ? a : Ha, qo = (c = (d = Z.tooltip) != null ? d : C.Tooltip) != null ? c : Of, Ko = (u = (h = Z.arrow) != null ? h : C.Arrow) != null ? u : Rf, $s = sn(Yo, R({}, G, (w = K.popper) != null ? w : P.popper, {
    className: bt(Er.popper, G == null ? void 0 : G.className, (b = (v = K.popper) != null ? v : P.popper) == null ? void 0 : b.className)
  }), Zt), Is = sn(Wo, R({}, xe, (f = K.transition) != null ? f : P.transition), Zt), As = sn(qo, R({}, (m = K.tooltip) != null ? m : P.tooltip, {
    className: bt(Er.tooltip, (N = (I = K.tooltip) != null ? I : P.tooltip) == null ? void 0 : N.className)
  }), Zt), Ds = sn(Ko, R({}, (O = K.arrow) != null ? O : P.arrow, {
  ...
  return /* @__PURE__ */ x(M.Fragment, {
    children: [/* @__PURE__ */ M.cloneElement(ye, De), /* @__PURE__ */ s(Yo, R({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(qo, R({}, As, {
          children: [de, L ? /* @__PURE__ */ s(Ko, R({}, Ds, {
            ref: Ct
          })) : null]
        }))
      }))
...
const Pf = ys;
function Ya(e, t, n) {
  return e ? /* @__PURE__ */ s(ii, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ s("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function xs(e) {
  const {
    onClick: t,
    ...
    Nl,
    {
      ...
      children: n ? /* @__PURE__ */ x(nt, { children: [
        Ya(a, n, !0),
        /* @__PURE__ */ s(kl, { primary: n, inset: !a && o }),
        h ? /* @__PURE__ */ s(ii, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(ns, {}) }) : Ya(i, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ s(Pf, { title: r, placement: "right", children: /* @__PURE__ */ s("div", { children: N }) }) : N;
}
function Ns(e) {
  return Object.entries(e.groups).map(([n, r]) => ({ id: n, group: r }));
}
function _f(e) {
  const [t, n] = pe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = e, i = (d) => {
    n(d.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
    let d = Ns(a).filter((u) => "menuItem" in u.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return d = d.filter(
      (u) => "menuItem" in u.group && u.group.menuItem === r.id
    ), /* @__PURE__ */ s(ks, { ...e, includedGroups: d });
  };
  return /* @__PURE__ */ x(nt, { children: [
    /* @__PURE__ */ s(xs, { onClick: i, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ s(
      El,
      {
        anchorEl: t,
...
const $f = (e, t) => t.filter((o) => o.group === e).sort((o, a) => (o.order || 0) - (a.order || 0));
function ks(e) {
  ...
  return /* @__PURE__ */ s("div", { role: "menu", "aria-label": d, children: a.map((u, h) => {
...
function If(e) {
  ...
  )), /* @__PURE__ */ s(ks, { ...e, includedGroups: a });
}
function Af({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ x(
    si,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ s(Tl, { id: n, dense: !0, className: a ?? "", children: /* @__PURE__ */ s(
          If,
          {
            commandHandler: e,
            menuDefinition: t,
...
const eo = (e, t, n = {}) => {
  ...
  const [a, i] = pe(() => r.current), [l, c] = pe(!0);
  return Qe(() => {
    let d = !0;
    return c(!!e), (async () => {
      if (e) {
...
const _n = Zn(({ className: e, ...t }, n) => /* @__PURE__ */ s(tl, { size: 35, className: T("tw-animate-spin", e), ...t, ref: n }));
...
function Gm({
  ...
  const a = gt(void 0);
  return /* @__PURE__ */ s("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ s(Sl, { position: "static", id: r, children: /* @__PURE__ */ x(
    Ol,
    {
...
), Lf = A.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: T(Vf({ variant: t }), e), ...n }));
Lf.displayName = "Alert";
const zf = A.forwardRef(
...
zf.displayName = "AlertTitle";
const Ff = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s("div", { ref: n, className: T("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Ff.displayName = "AlertDescription";
const Uf = Nn(
...
function Hm({ className: e, variant: t, ...n }) {
  return /* @__PURE__ */ s("div", { className: T("pr-twp", Uf({ variant: t }), e), ...n });
}
...
Xf.displayName = "CardTitle";
const Yf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s("p", { ref: n, className: T("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
Yf.displayName = "CardDescription";
const Wf = A.forwardRef(
  ({ className: e, ...t }, n) => /* @__PURE__ */ s("div", { ref: n, className: T("pr-twp tw-p-6 tw-pt-0", e), ...t })
);
Wf.displayName = "CardContent";
const qf = A.forwardRef(
  ({ className: e, ...t }, n) => /* @__PURE__ */ s(
    "div",
    {
      ref: n,
...
const Kf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  on.Root,
  {
    ref: n,
    className: T(
...
Kf.displayName = on.Root.displayName;
const Jf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Ur.Root,
  {
    className: T(
...
Jf.displayName = Ur.Root.displayName;
const Ym = Re.Root, Zf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Re.List,
  {
    ref: n,
    className: T(
...
Zf.displayName = Re.List.displayName;
...
Qf.displayName = Re.Trigger.displayName;
const em = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Re.Content,
  {
    ref: n,
    className: T(
...
em.displayName = Re.Content.displayName;
function Wm({
  isInstalling: e,
  handleClick: t,
  buttonText: n,
  ...
  return /* @__PURE__ */ s(
    me,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ s(_n, { size: 15 }) : /* @__PURE__ */ x(nt, { children: [
        /* @__PURE__ */ s(nl, { size: 25, className: T("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Zm({
  ...
  return /* @__PURE__ */ s("div", { id: e, className: T("pr-twp tw-prose", n), children: /* @__PURE__ */ s(_l, { options: o, children: t }) });
}
const tm = Zn((e, t) => /* @__PURE__ */ x(
  me,
  {
    ref: t,
...
var nm = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(nm || {});
function Qm({ id: e, groups: t }) {
  return /* @__PURE__ */ s("div", { id: e, children: /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ s(mi, { asChild: !0, children: /* @__PURE__ */ s(tm, {}) }),
    /* @__PURE__ */ s(tr, { children: t.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ s(En, { children: n.label }),
      /* @__PURE__ */ s(Xl, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(io, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(gi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(nr, {})
    ] }, n.label)) })
  ] }) });
}
function eh({ id: e, message: t }) {
...
function rm({ id: e, versionHistory: t }) {
...
function rh({
  ...
  return Qe(() => {
    o([]);
  }, [o]), /* @__PURE__ */ x("div", { className: "pr-twp tw-p-4 tw-max-w-sm", children: [
    /* @__PURE__ */ x(jt, { name: "uiLanguage", value: l, onValueChange: d, children: [
      /* @__PURE__ */ s(xt, { children: /* @__PURE__ */ s(Vt, {}) }),
      /* @__PURE__ */ s(Nt, { children: e.map((u) => /* @__PURE__ */ s(Me, { value: u.tag, children: Wa(u, t.tag) }, u.tag)) })
    ] }),
    l !== "en" && /* @__PURE__ */ x(nt, { children: [
      /* @__PURE__ */ s(Ge, { className: "tw-ml-3", children: i }),
      n.map((u) => Wa(u, t.tag))
    ] })
  ] });
}
...
export {
  ...
  zf as AlertTitle,
  Sm as BOOK_SELECTOR_STRING_KEYS,
  Hm as Badge,
  Cm as BookChapterControl,
  mc as BookSelectionMode,
  Om as BookSelector,
  me as Button,
  Gf as Card,
  Wf as CardContent,
  ...
  Xl as DropdownMenuGroup,
  hi as DropdownMenuItem,
  nm as DropdownMenuItemType,
  ...
  nh as Footer,
  Df as GridMenu,
  jf as HamburgerMenuButton,
  $m as INVENTORY_STRING_KEYS,
  Fm as IconButton,
  kn as Input,
  Wm as InstallButton,
  Im as Inventory,
  Ge as Label,
  Zm as MarkdownRenderer,
  xs as MenuItem,
  th as MoreInfo,
  Am as MultiSelectComboBox,
  ...
  $i as Separator,
  jm as SettingsList,
  Lm as SettingsListHeader,
  Vm as SettingsListItem,
  Kf as Slider,
  Xm as Sonner,
  _n as Spinner,
  Jf as Switch,
  ...
  T as cn,
  Cc as getBookNumFromId,
  Tc as getLinesFromUSFM,
  na as getNumberFromUSFM,
  Sc as getStatusForItem,
  Pm as inventoryCountColumn,
  Rm as inventoryItemColumn,
  _m as inventoryStatusColumn,
  lh as sonner,
  oh as useEvent,
  ah as useEventAsync,
  eo as usePromise
