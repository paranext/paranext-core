...
var Gt = (t, e, r) => Xi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as ge, a as _r, C as Se, u as Do, T as Mt, b as Ot, d as It, e as $t, A as le, P as Ve, f as Qe, B as X, h as Le, i as je, j as Be, k as Ee, x as Ji, l as Zi, m as Qi, I as ts, n as io, r as be, o as es, p as _n, q as ia, s as sa, L as Tt, R as so, t as Zr, D as ja, v as Ba, w as Fa, y as Ua, z as Nn, E as Kr, F as co, G as Cn, H as lo, J as Je, K as Tr, M as Fe, N as Ue, O as Ke, S as Sr, Q as ir, U as rs, V as Dr, W as Ze, X as $e, Z as tr, Y as Oe, _ as sr, $ as wo, a0 as uo, a1 as Qr, a2 as po, a3 as En, a4 as as, a5 as os, a6 as ns, a7 as Ka, a8 as Tn, a9 as ca, aa as is, ab as Sn, ac as ss, ad as cs, ae as ls, af as Mo, ag as ds, ah as ws, ai as us, aj as Rn, ak as zn, al as ho, am as ps, an as Dn, ao as Na, ap as Oo, aq as Ca, ar as hs, as as gs, at as fs, au as ms, av as vs, aw as Mr, ax as go, ay as bs, az as xs } from "./resizable-BTh0w_GD.js";
import { aA as Tg, aB as Sg, aC as Rg, aD as zg, aE as Dg, aF as Mg, aG as Og, aH as Ig, aI as $g, aJ as Pg, aK as Ag, aL as Vg, aM as Lg, aN as jg, aO as Bg, aP as Fg, aQ as Ug, aR as Kg, aS as Hg, aT as Gg, aU as qg, aV as Wg, aW as Yg, aX as Xg, aY as Jg, aZ as Zg, a_ as Qg, a$ as tf, b0 as ef, b1 as rf, b2 as af, b3 as of, b4 as nf, b5 as sf, b6 as cf, b7 as lf, b8 as df, b9 as wf } from "./resizable-BTh0w_GD.js";
import { jsx as a, jsxs as u, Fragment as dt } from "react/jsx-runtime";
import { Canon as Dt } from "@sillsdev/scripture";
import { Check as Pe, Clock as Io, ChevronsLeft as $o, ChevronsRight as Po, ChevronLeft as Ha, ChevronRight as Ga, ArrowLeft as ys, ArrowRight as ks, ChevronDown as dr, BoldIcon as _s, ItalicIcon as Ns, X as fo, AtSign as Mn, Pencil as Cs, Trash2 as Es, ArrowUp as On, MoreHorizontal as Ts, MailOpen as Ss, Mail as Rs, ChevronUp as zs, FilterIcon as Ds, ArrowLeftIcon as Ms, ChevronLeftIcon as Os, ChevronRightIcon as Is, ArrowRightIcon as $s, Copy as In, Filter as Ps, User as As, Link as Vs, CircleHelp as Ls, Undo as js, Redo as Bs, SquareX as $n, FunctionSquare as Pn, SquareSigma as An, Ban as Fs, AlertCircle as qa, CircleCheckIcon as Us, CircleXIcon as Ks, CircleHelpIcon as Hs, ArrowUpIcon as Gs, ArrowDownIcon as qs, ScrollText as Ws, ChevronsUpDown as Ys, MenuIcon as Xs, Menu as Js, EllipsisVertical as Zs, MoreVertical as Qs } from "lucide-react";
import { Section as Et, getChaptersForBook as tc, formatScrRef as Ne, formatReplacementString as Ie, getSectionForBook as Hr, formatRelativeDate as ec, sanitizeHtml as mo, NumberFormat as Vn, formatBytes as rc, getCurrentLocale as ac, usfmMarkers as Gr, isPlatformError as oc, ABORTED as nc, getErrorMessage as ic, getFormatCallerFunction as sc, deepEqual as cc, isString as Ao, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as lc, getLocalizeKeyForScrollGroupId as Vo, formatReplacementStringToArray as Lo, collectUsjMarkers as dc } from "platform-bible-utils";
import Wt, { useRef as B, useMemo as V, createContext as Or, useContext as la, useState as N, useEffect as Y, useCallback as j, useImperativeHandle as wc, useLayoutEffect as jt, Component as uc, createElement as jo, Suspense as pc, forwardRef as Ln, useId as Bo, Fragment as da } from "react";
...
import { Avatar as yo, Select as Yt, Checkbox as Ho, Slot as $r, Tabs as de, Menubar as xe, ContextMenu as Pt, Progress as Go, Slider as Lr, Switch as qo } from "radix-ui";
...
function oi({
  ...
  const g = B(!1), f = () => {
    ...
    () => _r(e, l),
    [e, l]
  ), x = !!p && !w, C = `${v} (${R})`, E = x ? h || `${C}, ${p}` : C, $ = /* @__PURE__ */ u(
    Se,
    {
      ref: t,
...
function Ml({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: y
  } = Do(), [v, R] = N(!1), [x, C] = N(!1), E = B(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), $ = n && e !== void 0, _ = i ?? (e !== void 0 && !n);
  Y(() => {
    var O;
    Dl();
    const Q = (O = E.current) == null ? void 0 : O.closest('button, [role="combobox"], [tabindex]');
    if (!Q) return;
    const T = (G) => !!G && G.scrollWidth > G.clientWidth, et = () => {
      Qa !== "pointer" && (_ || T(h.current) || T(l.current)) && C(!0);
    }, M = () => C(!1);
    return Q.addEventListener("focus", et), Q.addEventListener("blur", M), () => {
      Q.removeEventListener("focus", et), Q.removeEventListener("blur", M);
    };
  }, [_, h, l]);
  const I = j(() => {
    _ && R(!0), f(), $ && w();
...
function Ol({
  ...
  const [h, g] = N(!1), f = w !== void 0, y = f ? w : h, v = (x) => {
    f || g(x), p == null || p(x);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Ve, { open: y, onOpenChange: v, children: [
    ...
    /* @__PURE__ */ a(Le, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ee, { heading: i, children: t.map((x) => /* @__PURE__ */ u(
      Se,
      {
        onSelect: () => R(x),
      ...
      if (s) {
        ...
        if (!w && l) {
          const g = ((f) => Object.keys(le).find(
            (y) => le[y].toLowerCase() === f.toLowerCase()
          ))(c);
...
function Ra({
  ...
  const _ = be(), I = zl(), [D, z] = N(!1), [K, W] = N(""), [F, Q] = N(""), [T, et] = N("books"), [M, O] = N(void 0), [G, nt] = N(
    void 0
  ), [ot, ut] = N(void 0), [Bt, J] = N(!1), [st, ft] = N(!1), mt = B(null), vt = B(!1), _t = B(void 0), ht = B(void 0), Ft = B(void 0), re = B(void 0), St = B({}), Ut = B({}), gt = j(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
    ...
    () => Ll(Xt, xt),
    [Xt, xt]
  ), Re = Zt.has(t.book), oe = V(() => F.trim() ? to(
    Jt.filter((k) => io(k, F, i))
  ) : st ? At : Nt, [
    Nt,
    At,
    Jt,
  ...
  const yt = j(() => {
    if (A) {
      const k = A.chapterNum ?? 1, rt = A.verseNum ?? 1;
      if (p && Sa(A.book, k, rt, p))
        return;
      gt({
        book: A.book,
        chapterNum: k,
    ...
    (k) => {
      const rt = G ?? (A == null ? void 0 : A.book), at = ot ?? (A == null ? void 0 : A.chapterNum);
      !rt || !at || (gt({
        book: rt,
        chapterNum: at,
        verseNum: k
    ...
    (k) => {
      const rt = T === "chapters" ? M : A == null ? void 0 : A.book;
      if (rt) {
        if (w && w(rt, k) > 1) {
    ...
    et("books"), O(void 0), nt(void 0), ut(void 0), setTimeout(() => {
      ht.current && ht.current.focus();
    }, 0);
  }, []), U = j(() => {
    const k = G;
    nt(void 0), ut(void 0), k ? (O(k), et("chapters"), W("")) : S();
  }, [G, S]), q = j(
    (k) => {
      z(k), k && (et("books"), O(void 0), nt(void 0), ut(void 0), Q(""), ft(Re));
    },
    [Re]
  );
  Y(() => {
  ...
  const { otLong: P, ntLong: tt, dcLong: ct, extraLong: pt } = {
    ...
    (k) => A ? !!A.chapterNum && !k.toString().includes(A.chapterNum.toString()) : !1,
    [A]
  ), Vt = V(
    () => Ne(
      t,
    ...
    () => I >= Cr.TIGHT ? _r(t.book, i) : ge(t.book, i),
    [t.book, i, I]
  ), Pr = `${t.chapterNum}:${t.verseNum}`, Ge = j((k) => (rt) => {
    St.current[k] = rt;
  }, []), ze = j((k) => (rt) => {
    Ut.current[k] = rt;
  }, []), Ar = V(
    () => Pl(F),
    [F]
  ), fa = V(() => !w || !A || !A.chapterNum || !Ar ? !1 : w(A.book, A.chapterNum) > 0, [w, A, Ar]), ma = T === "books" && !Bt && !F.trim() && Zt.size > 0, Vr = j(
    (k) => p ? Yo(k, p) : !1,
    [p]
  ), mr = j(
    (k) => (rt) => p ? Al(k, rt, p) : !1,
    ...
    [We, i]
  ), ar = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", xa = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", ya = j(
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), h && h.includes(k.key) && A && A.chapterNum !== void 0 && A.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), yt());
    },
    [h, A, yt]
  ), ka = j(
    (k) => {
      ...
      if (T === "verses" && te) {
        ...
        pe !== kt && (k.preventDefault(), k.stopPropagation(), W(
          ...
          const br = Ut.current[pe];
          br && br.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((T === "chapters" || T === "books" && A) && te) {
        const lt = T === "chapters" ? M : A == null ? void 0 : A.book;
        if (!lt) return;
        T === "chapters" && ((Z = _t.current) == null || Z.focus());
        const bt = (() => {
          if (!K) return 1;
          const De = K.match(/(\d+)$/);
  ...
  return jt(() => {
    const k = setTimeout(() => {
      if (D && T === "books" && Ft.current && re.current) {
        const rt = Ft.current, at = re.current, te = at.offsetTop, _e = rt.clientHeight, L = at.clientHeight, Z = te - _e / 2 + L / 2;
        rt.scrollTo({
          top: Math.max(0, Z),
          behavior: "smooth"
        }), W(si(t.book));
    ...
    if (T === "chapters" && M) {
      const k = M === t.book, rt = k ? t.chapterNum : 1;
      W(
        `${M} ${le[M] || ""} ${rt}`
      ), setTimeout(() => {
        if (Ft.current)
  ...
  }, [T, M, A, t.book, t.chapterNum]), jt(() => {
    if (T === "verses" && G && ot !== void 0) {
      const k = G === t.book && ot === t.chapterNum, rt = k ? t.verseNum : 1;
      W(
        `${G} ${le[G] || ""} ${ot}:${rt}`
      ), setTimeout(() => {
        if (Ft.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ve, { open: D, onOpenChange: q, modal: x, children: [
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            Ml,
            {
              primary: ae,
              secondary: Pr,
              showSecondary: I < Cr.MINIMUM,
              isPartial: I >= Cr.TIGHT,
              fullText: Vt
            }
          ),
          y && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: rt } = k;
          D && mt.current && rt instanceof Node && mt.current.contains(rt) && (vt.current = !0, q(!1));
        },
        onCloseAutoFocus: R,
        children: /* @__PURE__ */ u(
          je,
            ...
            children: [
              T === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ke.map(
                  ({ onClick: k, disabled: rt, title: at, icon: te }) => /* @__PURE__ */ a(
                    X,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: T === "verses" ? U : S,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: _ === "ltr" ? /* @__PURE__ */ a(ys, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ks, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                T === "chapters" && M && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ge(M, i) }),
                T === "verses" && G && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ge(G, i)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: T === "verses" ? qe : vr
                  }
                )
              ] }),
              !Bt && /* @__PURE__ */ u(Be, { ref: Ft, children: [
                T === "books" && /* @__PURE__ */ u(dt, { children: [
                  !A && Object.entries(oe).map(([k, rt]) => {
                    if (rt.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Ee, { heading: Ct(k), children: rt.map((at) => /* @__PURE__ */ a(
                          oi,
                          {
                            ...
                            localizedBookNames: i,
                            disabled: Vr(at),
                            dimmedReason: Zt.has(at) ? va : void 0,
                            dimmedDescription: Zt.has(at) ? ba(at) : void 0
                          },
                          at
                        )) }, k)
                      );
                  }),
                  A && /* @__PURE__ */ a(Ee, { children: /* @__PURE__ */ a(
                    Se,
                    {
                      ...
                      children: Ne(
                        ...
                        // one control.
                        i ? _r(A.book, i) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  A && fa && A.chapterNum && w && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${ge(A.book, i)} ${A.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Zo,
                      {
                        ...
                        onVerseSelect: se,
                        setVerseRef: ze,
                        isVerseDisabled: rr(A.book, A.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  A && !fa && cr(A.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: ge(A.book, i) }),
                    ...
                    /* @__PURE__ */ a(
                      Jo,
                      {
                        ...
                        setChapterRef: Ge,
                        isChapterDimmed: Rt,
                        isChapterDisabled: mr(A.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                T === "chapters" && M && /* @__PURE__ */ a(
                  Jo,
                  {
                    bookId: M,
                    scrRef: t,
                    onChapterSelect: Ht,
                    setChapterRef: Ge,
                    isChapterDisabled: mr(M),
                    className: "tw:p-4"
                  }
                ),
                T === "verses" && G && ot !== void 0 && w && /* @__PURE__ */ a(
                  Zo,
                  {
                    bookId: G,
                    chapterNum: ot,
...
function Qo({
  ...
  const [C, E] = N(!1), $ = d ?? l, _ = (D) => D.length > 0 && typeof D[0] == "object" && "options" in D[0], I = (D, z) => {
    const K = l(D), W = typeof D == "object" && "secondaryLabel" in D ? D.secondaryLabel : void 0, F = `${z ?? ""}${K}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Se,
      {
        value: K,
  ...
  return /* @__PURE__ */ u(Ve, { open: C, onOpenChange: E, ...x, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        children: /* @__PURE__ */ u(je, { children: [
          ...
          /* @__PURE__ */ a(Be, { children: _(e) ? e.map((D) => /* @__PURE__ */ a(Ee, { heading: D.groupHeading, children: D.options.map((z) => I(z, D.groupHeading)) }, D.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map((D) => I(D)) }) })
        ] })
      }
    )
  ] });
...
function Sp({
  ...
  const w = za(d, "%webView_bookSelector_currentBook%"), p = za(d, "%webView_bookSelector_choose%"), h = za(d, "%webView_bookSelector_chooseBooks%"), [g, f] = N(
    "current book"
    /* CurrentBook */
  ), y = (v) => {
    f(v), t(v);
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ul = di ? jt : Y, Br = { tag: vo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = Ir();
            g.append(f);
            const y = di ? document.activeElement : null;
...
const Hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : Y;
...
const Jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : Y;
function Zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ql() {
  return function(t) {
    const [e] = ye(), r = V(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = B(o);
    return Jl(() => {
...
function ad(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      const x = g[R], C = s[R] || document.createElement("div"), E = C.style;
      E.position !== "absolute" && (E.position = "absolute", v = !0);
      const $ = fe(x.left - p);
      E.left !== $ && (E.left = $, v = !0);
      const _ = fe(x.top - h);
      E.top !== _ && (C.style.top = _, v = !0);
      const I = fe(x.width);
      E.width !== I && (C.style.width = I, v = !0);
      const D = fe(x.height);
      E.height !== D && (C.style.height = D, v = !0), C.parentNode !== c && (c.append(C), v = !0), s[R] = C;
    }
...
function nd(t, e = od) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), y = f.getKey(), v = h.offset, R = g.getNode(), x = R.getKey(), C = g.offset, E = t.getElementByKey(y), $ = t.getElementByKey(x), _ = r === null || E !== o || v !== n || y !== r.getKey(), I = i === null || $ !== s || C !== c || x !== i.getKey();
      if ((_ || I) && E !== null && $ !== null) {
        const D = function(z, K, W, F, Q, T, et) {
          const M = (z._window ? z._window.document : document).createRange();
          return M.setStart(...tn(K, W, F)), M.setEnd(...tn(Q, T, et)), M;
        }(t, h, f, E, g, R, $);
        l(), l = ad(t, D, e);
      }
      r = f, o = E, n = v, i = R, s = $, c = C;
    });
  }
...
function sd(t) {
  const e = Gn(t, (r) => Rr(r) && !r.isInline());
...
function dd(t) {
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Gn(i, (d) => Rr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function fi(t, e = gi) {
  return t.registerCommand(qn, (r) => (t.update(e), !0), bo);
}
  ...
  return Te(t.registerCommand(Cd, (s) => {
    ...
    if (Kc(s.target)) {
      ...
      if (Td(c)) return function(l, d = !1) {
        ...
        let g;
        d && Yn(w) ? g = w : (g = Gc(), qc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (me(f)) {
                const y = f.anchor;
                let v = y.getNode(), R = 0, x = 0;
                if (Xa(v) && d >= 0 && w >= 0 && (R = d, x = d + w, f.setTextNodeRange(v, R, v, x)), R === x && p === "" || (f.insertRawText(p), v = y.getNode()), Xa(v)) {
                  R = h, x = h + g;
                  const C = v.getTextContentSize();
                  R = R > C ? C : R, x = x > C ? C : x, f.setTextNodeRange(v, R, v, x);
                }
...
const To = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : Y;
...
function Yd({
  ...
  const [e] = ye(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Wd(), l = () => {
  };
...
function Jd() {
  const { activeEditor: t } = Ti(), [e, r] = N([]), o = j((n) => {
    if (me(n) || gl(n)) {
      const i = [];
      wn.forEach(({ format: s }) => {
...
const rw = "verseText", Rp = Object.freeze([
...
function zp({
  ...
  const [i, s] = N(aw), [c, l] = N(n), [d, w] = N(!1), p = B(void 0), h = B(null);
  Y(() => {
    let v = !0;
    const R = h.current;
    if (!R) return;
...
function pn({
  ...
  const g = j(
    ...
    const _ = new Date(t.date), I = ec(
      _,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), D = _.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    [t.user]
  ), x = V(() => mo(t.contents), [t.contents]), C = V(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), E = !!t.conflictResolutionAction && !C, $ = V(() => {
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          Je,
          {
            onClick: (_) => {
              _.stopPropagation(), d(!0), p(ew(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), g()) : Ro(_) && (_.preventDefault(), _.stopPropagation(), ne(w) && f());
              },
              onKeyDown: (_) => {
...
function Pi({
  ...
  const [F, Q] = N(hn), [T, et] = N(), [M, O] = N(), G = o, [nt, ot] = N(!1), [ut, Bt] = N(!1), [J, st] = N(!1), [ft, mt] = N(!1), [vt, _t] = N(!1), [ht, Ft] = N(E), [re, St] = N(!1), Ut = B(void 0), [gt, Xt] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let b = !0;
    return (async () => {
      const P = x ? await x(l) : !1;
      b && _t(P);
    })(), () => {
      b = !1;
    };
  ...
  Y(() => {
    if (!o) {
      xt.current !== "idle" && (et(void 0), O(void 0), xt.current = "idle");
      return;
    }
    xt.current === "idle" && (xt.current = "pending"), ft ? xt.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (et(I), xt.current = "auto-populated") : xt.current === "auto-populated" && (et(void 0), xt.current = "pending");
  }, [o, I, ft, i]);
  const Nt = V(
    () => D ?? e.filter((b) => !b.deleted),
    [D, e]
  );
  Y(() => {
    let b = !0;
  ...
  const At = V(() => Nt[0], [Nt]), Jt = B(null), we = B(void 0), Zt = j(() => {
    var b;
    (b = we.current) == null || b.call(we), Q(hn);
  }, []), Re = j(() => {
    const b = !ht;
    Ft(b), St(!b), f == null || f(l, b);
  }, [ht, f, l]);
  Y(() => {
    ot(!1);
  }, [o]), Y(() => {
    if (o && !ht && !re) {
      ...
      return Ut.current = b, () => clearTimeout(b);
    }
  ...
  }, [i, r]), Kt = V(() => Nt.slice(1), [Nt]), yt = V(() => Kt.length ?? 0, [Kt.length]), se = V(() => yt > 0, [yt]), Qt = V(() => nt || yt <= 2 ? Kt : Kt.slice(-2), [Kt, yt, nt]), Ht = V(() => nt || yt <= 2 ? 0 : yt - 2, [yt, nt]), ue = V(
    () => yt === 1 ? oe.singleReply : Ie(oe.multipleReplies, { count: yt }),
    [yt, oe]
  ), ke = V(
    () => Ht === 1 ? oe.singleReply : Ie(oe.multipleReplies, { count: Ht }),
    [Ht, oe]
  );
  Y(() => {
    !o && ut && se && Bt(!1);
  ...
  const S = j(
    async (b) => {
      ...
      H && await p({ threadId: l, contents: H }) && Zt();
    },
    [
      Zt,
      F,
    ...
    async (b) => {
      const H = ne(F) ? oa(F) : void 0, P = b.status ? b.assignedUser : T ?? b.assignedUser, tt = await p({
        ...b,
        contents: H,
        assignedUser: P
      });
      return tt && (P !== void 0 && O(P), H && Zt()), tt;
    },
    [Zt, F, p, T]
  );
      ...
      children: /* @__PURE__ */ u(iw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            A && /* @__PURE__ */ a(Tr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: A }),
            /* @__PURE__ */ a(
              X,
              {
                variant: "ghost",
        ...
        /* @__PURE__ */ u(dt, { children: [
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            ...
            Qt.map((b) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              pn,
              {
                comment: b,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Bt,
                canEditOrDelete: (!ut && gt.get(b.id)) ?? !1
              }
            ) }, b.id)),
            v !== !1 && (!ut || ne(F)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (b) => {
                  Ro(b) && (b.preventDefault(), b.stopPropagation(), (ne(F) || T !== void 0 && T !== M) && S());
                },
                onKeyDown: (b) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    T !== void 0 && (ne(F) || T !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ie(
                    ...
                    /* @__PURE__ */ u(Ve, { open: J, onOpenChange: st, children: [
                      /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(
                        X,
                        {
                          ...
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !ft || !y || y.length === 0 || !y.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        Le,
                        {
                          ...
                          align: "end",
                          onKeyDown: (b) => {
                            b.key === "Escape" && (b.stopPropagation(), st(!1));
                          },
                          children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: y == null ? void 0 : y.map((b) => /* @__PURE__ */ a(
                            Se,
                            {
                              onSelect: () => {
                                et(b !== i ? b : void 0), xt.current = "user-selected", O(void 0), st(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Yr(b, r) })
                            },
                            b || "unassigned"
                          )) }) })
                        }
...
function ww({
  ...
  const [s, c] = N("accept"), l = Bo(), d = Bo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, y = V(
    () => Xr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = V(
    () => Xr(t.acceptedText ?? ""),
    ...
    () => Xr(t.mergedText ?? ""),
    [t.mergedText]
  ), x = V(() => mo(t.contents), [t.contents]);
  if (!Oi(t))
    return /* @__PURE__ */ a(Jr, { html: x });
  const C = (M) => {
    c(M === "reject" || M === "merge" ? M : "accept");
  }, E = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", $ = g ? [
    {
      value: "merge",
  ...
  let z;
  I ? z = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (z = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), F = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : W, Q = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(Jr, { html: R }) : W : F(M === "reject" ? t.rejectedResultText : t.resultText);
  }, T = (M) => p && M.value === "reject", et = (M) => {
    const O = f === M.value, G = `${d}-${M.value}`, nt = T(M);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          so,
          {
            ...
            children: _.map((M) => T(M) ? /* @__PURE__ */ a(Mt, { delayDuration: 0, children: /* @__PURE__ */ u(Ot, { children: [
              /* @__PURE__ */ a(It, { asChild: !0, children: et(M) }),
              /* @__PURE__ */ a($t, { children: E })
            ] }) }, M.value) : et(M))
          }
        ),
...
function Lp({
  ...
  const [x, C] = N(/* @__PURE__ */ new Set()), [E, $] = N(), [_, I] = N(), D = j(
    async (O) => {
      const G = await i(O);
      return G !== void 0 && O.assignedUser !== void 0 && O.assignedUser !== "" && I(O.assignedUser), G;
    },
    [i]
  );
  Y(() => {
    f && (C((O) => new Set(O).add(f)), $(f));
  }, [f]);
  const z = r.filter(
    (O) => O.comments.some((G) => !G.deleted)
  ), K = z.map((O) => ({ id: O.id })), W = j(
    (O) => {
      C((G) => new Set(G).add(O.id)), $(O.id), y == null || y(O.id);
    },
    [y]
  ), F = j(
    (O) => {
      ...
      }), $(O), y == null || y(G ? void 0 : O);
    },
    [x, y]
  ), { listboxRef: Q, activeId: T, handleKeyDown: et } = rs({
    options: K,
    onOptionSelect: W
  }), M = j(
    (O) => {
      O.key === "Escape" ? (E && x.has(E) && (C((G) => {
        const nt = new Set(G);
        return nt.delete(E), nt;
      }), $(void 0), y == null || y(void 0)), O.preventDefault(), O.stopPropagation()) : et(O);
    },
    [E, x, et, y]
  );
  return /* @__PURE__ */ a(
      ...
      children: z.map((O) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: O.type === "Conflict" ? /* @__PURE__ */ a(fw, { ...G, conflictResolution: R }) : /* @__PURE__ */ a(Pi, { ...G })
          },
          O.id
        );
      })
...
function hr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Yt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Yt.Icon, { asChild: !0, children: /* @__PURE__ */ a(jn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function kw({
  ...
  var _;
  const [w, p] = N([]), [h, g] = N([]), [f, y] = N({}), [v, R] = N({}), x = V(() => e ?? [], [e]), C = ti({
    data: x,
    columns: t,
    getCoreRowModel: ri(),
  ...
  let $;
  return l ? $ = Array.from({ length: 10 }).map((z, K) => `skeleton-row-${K}`).map((z) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(sr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((_ = C.getRowModel().rows) == null ? void 0 : _.length) > 0 ? $ = C.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    Oe,
    {
      onClick: () => s(I, C),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((D) => /* @__PURE__ */ a(sr, { children: Nr(D.column.columnDef.cell, D.getContext()) }, D.id))
    },
    I.id
  )) : $ = /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a(sr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(mw, { table: C }),
    /* @__PURE__ */ u(wo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: C.getHeaderGroups().map((I) => /* @__PURE__ */ a(Oe, { children: I.headers.map((D) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: D.isPlaceholder ? void 0 : Nr(D.column.columnDef.header, D.getContext()) }, D.id)) }, I.id)) }),
...
function Dw({
  ...
  const n = B(null), i = B(null), s = B(!1), [c, l] = N(t), [d, w] = N(e), [p, h] = N(!1), g = B(!1), f = B(c);
  f.current = c;
  const y = B(d);
  y.current = d, Y(() => {
    l(t);
  ...
  const v = (x) => {
    ...
    var C, E, $, _;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), s.current = !0) : document.activeElement === n.current && x.key === "ArrowUp" ? ((E = i.current) == null || E.focus(), s.current = !1) : document.activeElement === n.current && x.key === "ArrowLeft" && (($ = n.current) == null ? void 0 : $.selectionStart) === 0 && ((_ = i.current) == null || _.focus(), s.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === n.current) && v(!1);
  };
...
function Lw(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, s]) => {
    i.push(
      ...s.map((c) => ({
        marker: c,
        title: r[Gr[c].description] ?? Gr[c].description,
        action: () => {
          var l;
...
function Yp({
  ...
  var ke;
  const h = B(null), g = B(null), f = B(null), y = B(null);
  jt(() => {
    if (!y.current) return;
    const { width: S } = y.current.getBoundingClientRect();
    S > 0 && (y.current.style.width = `${S}px`);
  }, []);
  const [v, R] = N("generated"), [x, C] = N("generated"), [E, $] = N("*"), [_, I] = N("*"), [D, z] = N("f"), [K, W] = N(!1), [F, Q] = N(!0), [T, et] = N(!1), M = B(!1), O = B(""), [G, nt] = N(!1), [ot, ut] = N(), [Bt, J] = N(), [st, ft] = N(), [mt, vt] = N(), _t = B(null), ht = B(
    void 0
  ), Ft = B(0), re = B(void 0), St = V(
    () => ({
      ...s,
  ...
  const gt = j(() => {
    var b, H, P;
    const S = (b = g.current) == null ? void 0 : b.querySelector(".editor-input"), U = S == null ? void 0 : S.querySelector("span.note"), q = (P = (H = g.current) == null ? void 0 : H.ownerDocument.getSelection()) == null ? void 0 : P.anchorNode;
    return !!U && !!q && U.contains(q);
  }, []);
  Y(() => {
    var H, P;
    let S, U, q;
    ...
    if (b && xr("note", b)) {
      const tt = (H = b.insert.note) == null ? void 0 : H.caller;
      let ct = "custom";
      tt === Ja ? ct = "generated" : tt === Za ? ct = "hidden" : tt && ($(tt), I(tt)), R(ct), C(ct), z(((P = b.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var pt, Ct, Rt;
        (pt = h.current) == null || pt.applyUpdate([b]), (Ct = h.current) == null || Ct.selectNote(0), (Rt = h.current) == null || Rt.focus(), U = requestAnimationFrame(() => {
          q = setTimeout(() => {
            var Vt, ae;
    ...
    return () => {
      S && clearTimeout(S), U !== void 0 && cancelAnimationFrame(U), q !== void 0 && clearTimeout(q);
    };
  }, [e, i, gt]);
  const Xt = j(
    (S = !1) => {
      var q, b, H;
      p == null || p();
      const U = (b = (q = h.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : b.at(0);
      U && xr("note", U) && (r == null || r([U]), S && d && i && ((H = d.current) == null || H.replaceEmbedUpdate(i, [U])));
    },
    [i, r, p, d]
  ), xt = j(
    (S, U) => {
      var H, P, tt;
      const q = (P = (H = h.current) == null ? void 0 : H.getNoteOps(0)) == null ? void 0 : P.at(0);
      if (!q || !xr("note", q) || !q.insert.note) return;
      let b;
      S === "custom" ? b = U : S === "generated" ? b = Ja : b = Za, q.insert.note.caller !== b && (q.insert.note.caller = b, (tt = h.current) == null || tt.applyUpdate([q, { delete: 1 }]));
    },
    []
  ), Nt = j(() => {
    var S;
    ht.current || (S = h.current) == null || S.commitPendingMarkerEdits(), Xt(!0), o();
  }, [o, Xt]), At = B(Nt);
  jt(() => {
    At.current = Nt;
  });
  const Jt = B({ book: n.book, chapterNum: n.chapterNum });
  jt(() => {
  ...
  const we = () => {
    ...
    if (U && xr("note", U)) {
      ...
      const ct = (P = (H = U.insert.note) == null ? void 0 : H.contents) == null ? void 0 : P.ops;
      D !== "x" && S === "x" ? ct == null || ct.forEach((pt) => Bw(pt)) : D === "x" && S !== "x" && (ct == null || ct.forEach((pt) => Fw(pt))), (tt = h.current) == null || tt.applyUpdate([U, { delete: 1 }]);
    }
  }, oe = (S) => {
    ...
    (S) => {
      ...
      if (U && xr("note", U)) {
        ...
        const ct = (H = U.insert.note) == null ? void 0 : H.style, pt = (tt = (P = U.insert.note) == null ? void 0 : P.contents) == null ? void 0 : tt.ops;
        if (ct || W(!1), W(
          ...
          M.current = !0, O.current = JSON.stringify(U), Q(!0);
          return;
        }
        Q(JSON.stringify(U) === O.current), Xt();
      } else
        W(!1), Q(!0);
    },
    [Xt]
    ...
    if (f.current && Ut.length && S && S.rangeCount > 0) {
      const U = S.getRangeAt(0).getBoundingClientRect(), q = f.current.getBoundingClientRect();
      ut(U.left - q.left), J(U.top - q.top), ft(U.height), nt(!0);
    }
  }, [Ut, f]), yt = B(() => {
  }), se = j(
    (S, U, q) => {
      ...
      cs({
        ...
        clearSessionIfCurrent: (P) => Mo(ht, P),
        ...
        onShowError: (P) => {
          (!oc(P) || P.code !== nc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${ic(P)}`
          );
        }
      });
    },
    ...
    var q;
    const S = (q = h.current) == null ? void 0 : q.getMarkerMenuContext();
    if (!S) return !1;
    const U = Nl(St.styleInfo ?? Cl, S);
    return U.length === 0 ? !1 : (se(S, U, { passive: !S.hasTextSelection }), !0);
  }, [se, St.styleInfo]), Ht = j(
    (S) => {
      const U = ht.current;
      if (!U || !w) return;
      ls(S, U, {
        ...
        commitTyped: (b) => {
          var H;
          return (H = h.current) == null ? void 0 : H.commitTypedMarker(b);
        },
        commitTypedAndReopen: (b) => {
          var H;
          (H = h.current) == null || H.commitTypedMarker(b, { trailingSpace: !1 }), Qt();
        },
        commitTypedCloser: (b) => {
          var H;
          return (H = h.current) == null ? void 0 : H.commitTypedCloser(b);
        },
        commitItem: (b) => {
          var P;
          const H = U.items.find((tt) => tt.marker === b);
          H && ((P = h.current) == null || P.applyMarkerMenuSelection(H, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    const S = (U) => {
      var H, P;
      const q = (H = g.current) == null ? void 0 : H.querySelector(".editor-input");
      if (!q || U.target !== q) return;
      const b = (P = h.current) == null ? void 0 : P.getSelection();
      b && (re.current = b);
    };
    ...
    if (((q = St.view) == null ? void 0 : q.markerMode) === "editable") {
      const b = (P) => {
        var pt, Ct, Rt, Vt;
        if (ws(P)) return;
        const tt = S();
        ...
        if (P.key === "Enter" && !gt()) {
          P.preventDefault(), P.stopPropagation(), (pt = h.current) == null || pt.selectNote(0), (Ct = h.current) == null || Ct.focus();
          return;
        }
        if (w && P.key === c) {
          if (!gt()) {
            P.preventDefault(), P.stopPropagation(), (Rt = h.current) == null || Rt.selectNote(0), (Vt = h.current) == null || Vt.focus();
            return;
          }
          Qt() && (P.preventDefault(), P.stopPropagation());
        }
      }, H = () => {
        var tt, ct;
        const P = S();
        !P || document.activeElement !== P || gt() || ((tt = h.current) == null || tt.selectNote(0), (ct = h.current) == null || ct.focus());
      };
      return document.addEventListener("keydown", b, { capture: !0 }), document.addEventListener("paste", H, { capture: !0 }), () => {
        document.removeEventListener("keydown", b, { capture: !0 }), document.removeEventListener("paste", H, { capture: !0 });
      };
    }
    const U = (b) => {
      const H = S();
      !G && H && document.activeElement === H && b.key === c ? (b.preventDefault(), Kt()) : G && b.key === "Escape" && (b.preventDefault(), nt(!1));
    };
    ...
    const S = () => {
      var b, H, P;
      const U = ((b = g.current) == null ? void 0 : b.querySelector(".editor-input")) ?? void 0;
      if (!U || document.activeElement !== U) return;
      const q = document.getSelection();
      q && !q.isCollapsed || gt() || ((H = h.current) == null || H.selectNote(0), (P = h.current) == null || P.focus());
    };
...
function Gw({
  ...
  /* @__PURE__ */ a("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    zo(t.marker, [s], o, !1),
    " "
  ] }), g = !!l, f = !!w, y = !!p, v = e === "horizontal" ? "horizontal" : "vertical", R = o ? "marker-visible" : "", x = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = m(v, R);
  return /* @__PURE__ */ u(dt, { children: [
...
function Jp({
  ...
  const p = d ?? sc(r, void 0), h = (E, $) => {
    w == null || w(E, $, n);
  }, g = i ? r.findIndex((E) => E === i) : -1, [f, y] = N(g), v = (E, $, _) => {
    if (r.length)
      switch (E.key) {
        case "Enter":
        case " ":
          E.preventDefault(), w == null || w($, _, n);
          break;
      }
  }, R = (E) => {
    if (r.length)
      switch (E.key) {
        case "ArrowDown":
          E.preventDefault(), y(($) => Math.min($ + 1, r.length - 1));
          break;
        case "ArrowUp":
          E.preventDefault(), y(($) => Math.max($ - 1, 0));
          break;
      }
  }, x = B([]);
  Y(() => {
  ...
  const C = i ? r.findIndex((E) => E === i) : -1;
  return Y(() => {
    var E;
    C < 0 || C >= x.current.length || (E = x.current[C]) == null || E.scrollIntoView({ block: "nearest" });
  }, [C, s]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Gw,
                      {
                        footnote: E,
                        layout: o,
                        formatCaller: () => p(E.caller, $),
                        showMarkers: c
                      }
                    )
                  }
                ),
                $ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Sr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, I)
            );
          })
        }
...
function nh({
  ...
  const g = he(r, "%webView_inventory_all%"), f = he(r, "%webView_inventory_approved%"), y = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), R = he(r, "%webView_inventory_scope_currentBook%"), x = he(r, "%webView_inventory_scope_chapter%"), C = he(r, "%webView_inventory_scope_verse%"), E = he(r, "%webView_inventory_filter_text%"), $ = he(
    r,
    "%webView_inventory_show_additional_items%"
  ), _ = he(r, "%webView_inventory_no_results%"), [I, D] = N(!1), [z, K] = N("all"), [W, F] = N(""), [Q, T] = N([]), et = V(() => {
    const J = t ?? [];
  ...
  }, [I, et]), O = V(() => M.length === 0 ? [] : Zw(M, z, W), [M, z, W]), G = V(() => {
    var ft, mt;
    if (!I) return l;
  ...
  Y(() => {
    O.length === 0 ? T([]) : O.length === 1 && T(O[0].items);
  }, [O]);
  const nt = (J, st) => {
    st.setRowSelection(() => {
      const mt = {};
    ...
    const J = M.filter((st) => cc(
      I ? st.items : [st.items[0]],
      Q
    ));
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        ur,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(gr, { children: [
              ...
              /* @__PURE__ */ a(ce, { value: "unapproved", children: y }),
      ...
      /* @__PURE__ */ u(ur, { onValueChange: (J) => ot(J), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(gr, { children: [
          ...
          /* @__PURE__ */ a(ce, { value: "chapter", children: x }),
      ...
      o && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
        /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Tt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? $ })
        ] }) }),
...
const tu = "16rem", eu = "3rem", Vi = Wt.createContext(void 0);
function ga() {
  const t = Wt.useContext(Vi);
  if (!t)
...
function ru({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    ...
    [r, w]
  ), h = Wt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", v = be() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = Wt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function xh({
  ...
  const [d, w] = N([]), [p, h] = N([{ id: Me, desc: !1 }]), [g, f] = N({}), y = V(
  ...
  Y(() => {
    if (c) {
      ...
      if (K.length === 1) {
        const W = y.find((F) => yn(F) === K[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, y, c, R]);
  const x = n ?? hu, C = i ?? Li, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [Me] },
  ...
  }, I = (z, K) => z.getIsGrouped() ? "" : m("banded-row", K % 2 === 0 ? "even" : "odd"), D = (z, K, W) => {
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gr, { position: "item-aligned", children: /* @__PURE__ */ a(vw, { children: E.map((z) => /* @__PURE__ */ a(ce, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
        ...
        return /* @__PURE__ */ a(
          Oe,
          {
            ...
            children: z.getVisibleCells().map((F) => {
              if (!(F.getIsPlaceholder() || F.column.columnDef.enableGrouping && !F.getIsGrouped() && (F.column.columnDef.id !== Xe || !r)))
                return /* @__PURE__ */ a(
                  sr,
                  {
                    className: m(
                    ...
                    children: F.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(Ga, {}) : /* @__PURE__ */ a(Ha, {})),
                          " ",
...
function vu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: y } = {
  ...
  }, [v, R] = N(!1), [x, C] = N(""), E = B(void 0), $ = B(!1), _ = V(
    () => zn(t),
    [t]
  ), I = V(() => {
    if (!x.trim()) {
    ...
    (T, et = !1) => {
      if (!et || !E.current) {
        r(
          e.includes(T) ? e.filter((ut) => ut !== T) : [...e, T]
        ), E.current = T;
        return;
      }
      const M = _.findIndex((ut) => ut === E.current), O = _.findIndex((ut) => ut === T);
      if (M === -1 || O === -1) return;
      const [G, nt] = [
        Math.min(M, O),
        Math.max(M, O)
      ], ot = _.slice(G, nt + 1).map((ut) => ut);
      r(
        e.includes(T) ? e.filter((ut) => !ot.includes(ut)) : [.../* @__PURE__ */ new Set([...e, ...ot])]
      );
    },
    [e, r, _]
  ), z = (T) => {
    D(T, $.current), $.current = !1;
  }, K = (T, et) => {
    T.preventDefault(), D(et, T.shiftKey);
  }, W = () => {
    r(_.map((T) => T));
  }, F = () => {
    r([]);
    ...
    () => Object.values(Et).filter(
      (T) => (i == null ? void 0 : i[T]) !== void 0 && ho(_, T).length === 0
          ...
          Le,
          {
            ...
            children: /* @__PURE__ */ u(
              je,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (T) => {
                  T.key === "Enter" && ($.current = T.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    ia,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(X, { variant: "ghost", size: "sm", onClick: F, children: w })
                  ] }),
                  /* @__PURE__ */ u(Be, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(sa, { children: p }),
                    Object.values(Et).filter((T) => I[T].length > 0).map((T, et) => {
                      const M = I[T];
                  ...
                  Q.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Q.map(({ section: T, explanation: et }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: et }, T)) })
                ]
              }
            )
          }
...
function kh({
  ...
  const $ = zt(
    s,
    "%webView_scope_selector_selected_text%"
  ), _ = zt(s, "%webView_scope_selector_verse%"), I = zt(s, "%webView_scope_selector_chapter%"), D = zt(s, "%webView_scope_selector_book%"), z = zt(
    s,
    "%webView_scope_selector_current_verse%"
  ), K = zt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = zt(s, "%webView_scope_selector_current_book%"), F = zt(s, "%webView_scope_selector_choose_books%"), Q = zt(s, "%webView_scope_selector_scope%"), T = zt(s, "%webView_scope_selector_select_books%"), et = zt(s, "%webView_scope_selector_range%"), M = zt(s, "%webView_scope_selector_select_range%"), O = zt(s, "%webView_scope_selector_range_start%"), G = zt(s, "%webView_scope_selector_range_end%"), nt = zt(s, "%webView_scope_selector_ok%"), ot = zt(s, "%webView_scope_selector_cancel%"), ut = zt(s, "%webView_scope_selector_navigate%"), Bt = (L) => {
    if (!y) return;
  ...
  ], st = (L, Z, lt = !1) => /* @__PURE__ */ u(dt, { children: [
    L,
    Z && !lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), ft = e ? J.filter((L) => e.includes(L.value)) : J, mt = y ?? Ta, vt = p ?? mt, _t = h ?? mt, ht = () => {
  }, Ft = B(null), re = B(null), St = B(!1), Ut = B(null), gt = B(!1), [Xt, xt] = N(void 0), Nt = B(!1), At = B(!1), Jt = B(null), we = j((L) => {
    if (L) {
    ...
    xt((Z) => Z === "start" ? void 0 : Z), Nt.current && (Nt.current = !1, requestAnimationFrame(() => {
      var lt;
      const Z = (lt = Ft.current) == null ? void 0 : lt.querySelector("button");
      Z == null || Z.click();
    }));
  }, []), Zt = j((L) => {
    if (L) {
    ...
    (L) => {
      g == null || g(L), f == null || f(L), Nt.current = !0;
    },
    [g, f]
  ), oe = j(
    (L) => {
      f == null || f(L), At.current = !0;
    },
    [f]
  ), A = j(
    (L) => {
      r(L), L === "selectedBooks" && n.length === 0 && (y != null && y.book) && i([y.book]);
    },
    [r, n, y, i]
  ), Kt = ft.find((L) => L.value === t), yt = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? lc(vt, _t, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Kt ? st(Kt.label, Kt.scrRefSuffix) : t, se = ft.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), Qt = ft.find((L) => L.value === "selectedBooks"), Ht = ft.find((L) => L.value === "range"), [ue, ke] = N(!1), [S, U] = N(void 0), [q, b] = N(void 0), [H, P] = N(void 0), [tt, ct] = N(void 0), [pt, Ct] = N([]), Rt = w === "dropdown" && S === "selectedBooks", Vt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  ), ae = Xt === "end", Pr = Xt === "start", Ge = "tw:text-muted-foreground", ze = w === "dropdown" && S === "range", Ar = ze ? P : Re, ma = ze ? ct : f ? oe : ht, Vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-start", className: m(ae && Ge), children: O }),
      /* @__PURE__ */ a(
        Ra,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ft, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-end", className: m(Pr && Ge), children: G }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
          ...
          onCloseAutoFocus: (L) => {
            var Z;
            At.current && (At.current = !1, L.preventDefault(), (Z = Jt.current) == null || Z.focus());
          },
          className: m(Pr && Ge),
          modal: !0,
          align: "start"
  ...
  Y(() => {
    ...
    return () => {
      cancelAnimationFrame(Z), L && cancelAnimationFrame(L);
    };
  }, [ue, t]);
  const [qe, va] = N(null), [We, ba] = N(null), [ar, xa] = N(null), ya = 200, [ka, _a] = N(!1);
  Y(() => {
    if (!ar || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([Z]) => {
      _a(Z.contentRect.width < ya);
    });
    return L.observe(ar), () => L.disconnect();
  }, [ar]);
  const k = j(
    (L) => {
      b(L), P(vt), ct(_t), Ct(n), ke(!1), U(L);
    },
    [vt, _t, n]
  ), rt = j(() => {
    q !== void 0 && (q === "range" ? (H && (g == null || g(H)), tt && (f == null || f(tt))) : q === "selectedBooks" && i(pt), A(q), U(void 0), b(void 0));
  }, [
    q,
    H,
    tt,
    ...
    var Z;
    L.preventDefault(), (Z = vr.current) == null || Z.focus();
  }, []), _e = (L) => t === L ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Pe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Fe, { open: ue, onOpenChange: ke, children: [
        ...
        /* @__PURE__ */ a(
          Ke,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: ar, children: [
              se.map(({ value: L, label: Z, dropdownLabel: lt, scrRefSuffix: bt, id: Lt }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: rr(L),
                  ...
                  children: [
                    t === L && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Pe, { className: "tw:h-4 tw:w-4" }) }),
                    st(lt ?? Z, bt, ka)
                  ]
                },
                Lt
              ...
              v && /* @__PURE__ */ u(dt, { children: [
                ...
                /* @__PURE__ */ a(
                  Je,
                  {
                    ...
                    onSelect: (L) => {
                      var Z, lt;
                      if (L.preventDefault(), St.current) {
                        St.current = !1;
                        return;
                      }
                    ...
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (L) => {
                          const Z = L.target instanceof HTMLElement ? L.target : void 0;
                        ...
                        children: /* @__PURE__ */ a(
                          Ra,
                          {
                            ...
                            onCloseAutoFocus: (L) => {
                              var Z;
                              L.preventDefault(), (Z = Ut.current) == null || Z.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(dt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ne(y ?? Ta, "id") }),
                              /* @__PURE__ */ a(dr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        so,
        {
          ...
          children: ft.map(({ value: L, label: Z, scrRefSuffix: lt, id: bt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: L, id: bt }),
    ...
    w === "radio" && t === "range" && Vr,
    w === "dropdown" && Qt && /* @__PURE__ */ a(ja, { open: S === "selectedBooks", onOpenChange: at, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: ba,
        onCloseAutoFocus: te,
        onEscapeKeyDown: (L) => {
          We != null && We.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(Na, { container: We, children: [
          /* @__PURE__ */ a(Fa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ua, { children: F }) }),
          Vt,
    ...
    w === "dropdown" && Ht && /* @__PURE__ */ a(ja, { open: S === "range", onOpenChange: at, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: va,
        onCloseAutoFocus: te,
        ...
        children: /* @__PURE__ */ u(Na, { container: qe, children: [
          /* @__PURE__ */ a(Fa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ua, { children: M }) }),
          Vr,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => at(!1), children: ot }),
            /* @__PURE__ */ a(X, { ref: Jt, onClick: rt, children: nt })
          ] })
        ] })
      }
    ) })
...
const Tu = Object.freeze([520, 420, 340]), Ui = Wt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    const [n, i] = N(void 0), s = B(o);
    s.current = o;
    const c = j((p) => {
      i(p ?? void 0);
      const h = s.current;
...
const Ki = Wt.forwardRef(({ className: t, ...e }, r) => {
  const o = be();
  return /* @__PURE__ */ a(
    de.Root,
    {
...
const Hi = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  de.List,
  {
    ref: r,
    className: m(
...
const Su = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  de.Trigger,
  {
    ref: r,
    ...e,
...
)), Gi = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  de.Content,
  {
    ref: r,
    className: m(
...
Gi.displayName = de.Content.displayName;
function Rh({
  tabList: t,
  searchValue: e,
  onSearch: r,
...
function Mh({
  ...
  const d = Bu(
    ...
    var R, x, C, E, $, _;
    const v = y !== f ? ((x = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : x[y]) ?? ((E = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
    return v ? `${($ = t[f]) == null ? void 0 : $.autonym} (${v})` : (_ = t[f]) == null ? void 0 : _.autonym;
  };
...
function Ih({
  ...
  const [s, c] = N(""), [l, d] = N(), w = B(null), p = B(null), h = B(/* @__PURE__ */ new Map()), [g, f] = N(), y = V(
    () => Uu(Object.entries(t)).map(([_, I]) => ({
      tag: _,
      info: I,
      keywords: [
        I.autonym,
        ...Object.values(I.uiNames ?? {}),
        ...I.otherNames ?? []
      ].map(Wi)
    })),
    [t]
    ...
    var I;
    const _ = (D) => !!D && v.some((z) => z.tag === D);
    return _(l) ? l : _(e) ? e : ((I = v[0]) == null ? void 0 : I.tag) ?? "";
  }, [l, e, v]), x = y.length > 1;
  jt(() => {
    var _;
    f((_ = p.current) == null ? void 0 : _.id);
  }, []), jt(() => {
    const _ = h.current.get(R), I = x ? w.current : void 0;
    I && (_ ? I.setAttribute("aria-activedescendant", _.id) : I.removeAttribute("aria-activedescendant")), _ && R !== l && _.scrollIntoView({ block: "nearest" });
  }, [R, l, x]);
  const C = o["%firstRun_language_search_placeholder%"] ?? "", E = o["%firstRun_language_noResults%"] ?? "", $ = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(
    je,
    {
      id: i,
      ...
      onValueChange: d,
      children: [
        x && // Plain <input> (not CommandPrimitive.Input) so cmdk cannot update this field after
        ...
        /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(bs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
          /* @__PURE__ */ a(
            "input",
            {
              ...
              value: s,
              onChange: (_) => {
                c(_.currentTarget.value), d(void 0);
              },
        ...
        /* @__PURE__ */ u(Be, { ref: p, children: [
          /* @__PURE__ */ a(sa, { children: E }),
          v.map(({ tag: _, info: I }) => {
            const D = _ === e;
            return /* @__PURE__ */ u(
              Se,
              {
                ref: (z) => {
                  z ? h.current.set(_, z) : h.current.delete(_);
                },
                value: _,
                "aria-current": D ? "true" : void 0,
                "data-checked": D ? "true" : void 0,
                onSelect: () => r(_),
                children: [
                  /* @__PURE__ */ a("span", { dir: "auto", children: I.autonym }),
                  D && /* @__PURE__ */ a("span", { className: "tw:sr-only", children: $ })
                ]
              },
              _
            );
...
const Ju = (t, e, r = {}) => {
  ...
  const [e, r] = N(!1), [o, n] = N(!1), [i, s] = N(0), c = B(void 0), l = V(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
