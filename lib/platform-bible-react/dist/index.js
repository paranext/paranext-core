...
import c, { forwardRef as Ut, useCallback as tt, useState as B, useRef as Z, useEffect as dt, useLayoutEffect as Be, useMemo as Q } from "react";
import { clsx as Fn } from "clsx";
import { extendTailwindMerge as Gn } from "tailwind-merge";
import * as V from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as Yn } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as ge, Check as Ct, Circle as fe, X as be, Search as Ge, ChevronsUpDown as Ye, FilterIcon as $n, ChevronDown as qt, ChevronUp as Hn, ArrowLeftIcon as Ln, ChevronLeftIcon as Un, ChevronRightIcon as qn, ArrowRightIcon as Jn, LoaderCircle as Kn, Download as Wn, Filter as Zn, User as Qn, Link as tr, CircleHelp as er, Star as nr, CircleCheckIcon as rr, CircleXIcon as ar, CircleHelpIcon as or, ArrowUpIcon as sr, ArrowDownIcon as ir, ArrowUpDownIcon as wr, PanelLeft as dr, PanelRight as lr, ScrollText as cr, ChevronLeft as pr, MenuIcon as ur } from "lucide-react";
import { getChaptersForBook as mr, NumberFormat as hr, formatBytes as gr, deepEqual as ve, substring as fr, formatScrRef as ne, compareScrRefs as we, scrRefToBBBCCCVVV as re, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
import { useReactTable as He, getFilteredRowModel as br, getSortedRowModel as Le, getPaginationRowModel as vr, getCoreRowModel as Ue, flexRender as Ot, getGroupedRowModel as xr, getExpandedRowModel as yr } from "@tanstack/react-table";
import * as X from "@radix-ui/react-select";
import Nr from "markdown-to-jsx";
import * as de from "@radix-ui/react-checkbox";
import * as Jt from "@radix-ui/react-toggle-group";
...
import { useHotkeys as kr } from "react-hotkeys-hook";
...
const Rr = Ut(
  ({
    ...
    className: o,
    ...s
  }, i) => /* @__PURE__ */ r("div", { className: "tw-relative", children: /* @__PURE__ */ r(
    Tt,
    {
      ...s,
      type: "text",
...
const Kt = V.Root, xe = V.Trigger, Ke = V.Group, _r = V.Portal, zr = V.Sub, qo = V.RadioGroup, We = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  V.SubTrigger,
  {
    ref: o,
    className: d(
...
We.displayName = V.SubTrigger.displayName;
...
Ze.displayName = V.SubContent.displayName;
...
const ye = c.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = Y();
  return /* @__PURE__ */ r(
    V.Item,
    {
...
ye.displayName = V.Item.displayName;
const Ne = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ l(
  V.CheckboxItem,
  {
    ref: o,
    className: d(
...
Ne.displayName = V.CheckboxItem.displayName;
const Qe = c.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  V.RadioItem,
  {
    ref: a,
    className: d(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(V.ItemIndicator, { children: /* @__PURE__ */ r(fe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
Qe.displayName = V.RadioItem.displayName;
const Gt = c.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  V.Label,
  {
    ref: a,
...
Gt.displayName = V.Label.displayName;
...
Yt.displayName = V.Separator.displayName;
...
var Ir = Object.defineProperty, Mr = (t, e, n) => e in t ? Ir(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, S = (t, e, n) => Mr(t, typeof e != "symbol" ? e + "" : e, n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
function _t(t, e = !0) {
  return e && (t = t.toUpperCase()), t in Oe ? Oe[t] : 0;
}
function Ce(t) {
  return _t(t) > 0;
}
...
function rn(t) {
  return t <= 0 || t > nn ? "******" : tn[t - 1];
}
function Xr(t) {
  return rn(_t(t));
}
function an(t) {
  const e = typeof t == "number" ? Se(t) : t;
  return Ce(e) && !ke.includes(e);
}
function jr(t) {
  const e = typeof t == "number" ? Se(t) : t;
  return Ce(e) && ke.includes(e);
...
function Fr(t) {
  return tn[t - 1].includes("*obsolete*");
}
function Gr() {
  const t = {};
...
const H = class T {
  constructor(e, n, a, o) {
    if (S(this, "firstChapter"), S(this, "lastChapter"), S(this, "lastVerse"), S(this, "hasSegmentsDefined"), S(this, "text"), S(this, "BBBCCCVVVS"), S(this, "longHashCode"), S(this, "versification"), S(this, "rtlMark", "‏"), S(this, "_bookNum", 0), S(this, "_chapterNum", 0), S(this, "_verseNum", 0), S(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, i = n != null && n instanceof pt ? n : void 0;
  ...
  static fromJSON(e) {
    ...
    let p;
    return i && (p = new pt(i)), n ? new T(n, a.toString(), w, p) : new T();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new pt(et[i]);
        } catch {
  ...
  allVerses(e = !1, n = T.verseRangeSeparators, a = T.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], s = Ae(this._verse, a);
    for (const i of s.map((w) => Ae(w, n))) {
      const w = this.clone();
      w.verse = i[0];
      const p = w.verseNum;
...
function $r({
  ...
  const s = Array.from({ length: e }, (w, p) => p + 1), i = tt(
    (w) => {
      o(w);
    },
    [o]
  ...
  return /* @__PURE__ */ r("div", { className: d("tw-flex tw-flex-wrap tw-items-start tw-justify-start tw-self-stretch"), children: s.map((w) => /* @__PURE__ */ r(
    "div",
    {
      ...
      onClick: (p) => {
        p.preventDefault(), p.stopPropagation(), t(w);
      },
      role: "button",
      onKeyDown: (p) => {
        p.key === "Enter" && t(w);
...
const Re = _.allBookIds.filter((t) => !_.isObsolete(_.bookIdToNumber(t))), Hr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Pe = ["OT", "NT", "DC"], Lr = 96, Ur = [
  /^(\w+)$/i,
...
], Vt = (t) => mr(_.bookIdToNumber(t));
function qr() {
  return Re.map((e) => _.bookIdToEnglishName(e));
}
function Jr(t) {
...
function Kr(t) {
  ...
  if (Jr(e))
    return Re.find((a) => _.bookIdToEnglishName(a) === e);
}
function Ko({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = Y(), [s, i] = B(""), [w, p] = B(
    _.bookNumberToId(t.bookNum)
  ), [m, u] = B(t.chapterNum ?? 0), [f, g] = B(
    _.bookNumberToId(t.bookNum)
    ...
    Ur.forEach((C) => {
      const E = s.match(C);
      if (E) {
        const [O, G = void 0, F = void 0] = E.slice(1), It = Kr(O);
    ...
    if (f === w) {
      ...
      m + F <= 0 || m + F > Vt(f) ? u(0) : F !== 0 && (u(m + F), C.preventDefault());
    }
  };
  return dt(() => {
    w === f ? w === _.bookNumberToId(t.bookNum) ? u(t.chapterNum) : u(1) : u(0);
  }, [f, t.bookNum, t.chapterNum, w]), Be(() => {
    y(h);
  }, [h]), Be(() => {
    const C = setTimeout(() => {
      if (x && k.current && A.current) {
        const O = A.current.offsetTop - Lr;
  ...
  }, [x]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ l(Kt, { modal: !1, open: h, onOpenChange: zt, children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(
      Rr,
      {
        ...
        handleKeyDown: P,
        handleOnClick: () => {
          p(_.bookNumberToId(t.bookNum)), g(_.bookNumberToId(t.bookNum)), u(t.chapterNum > 0 ? t.chapterNum : 0), v(!0), N.current.focus();
        },
        onFocus: () => {
          rt.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      Ft,
      {
        ...
        ref: k,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Pe.map((C, E) => {
          const O = j(C);
          return O.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(Gt, { className: "tw-font-semibold tw-text-foreground/80", children: Hr[C] }),
            ...
            Pe.length - 1 !== E ? /* @__PURE__ */ r(Yt, {}) : void 0
          ] }, C);
        }) })
      }
    )
...
const Wr = bt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? St : "button", { className: d(Wr({ variant: e, size: n, className: t })), ref: s, ...o })
);
M.displayName = "Button";
const Zr = bt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), J = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r($e.Root, { ref: n, className: d("pr-twp", Zr(), t), ...e }));
J.displayName = $e.Root.displayName;
const sn = c.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    At.Root,
    {
...
sn.displayName = At.Root.displayName;
const ce = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  At.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(At.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(fe, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ce.displayName = At.Item.displayName;
const wn = Pt.Root, dn = Pt.Trigger, Te = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = Y();
...
const Qr = nt.Portal, ln = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Overlay,
  {
    ref: n,
    className: d(
...
ln.displayName = nt.Overlay.displayName;
const ta = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = Y();
...
ta.displayName = nt.Content.displayName;
const ea = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Title,
  {
    ref: n,
...
ea.displayName = nt.Title.displayName;
...
na.displayName = nt.Description.displayName;
const _e = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  L,
  {
    ref: n,
    className: d(
...
const ze = c.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(Ge, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      L.Input,
      {
        ref: n,
...
ze.displayName = L.Input.displayName;
...
Ee.displayName = L.List.displayName;
const Ie = c.forwardRef((t, e) => /* @__PURE__ */ r(L.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Ie.displayName = L.Empty.displayName;
const cn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  L.Group,
  {
    ref: n,
    className: d(
...
cn.displayName = L.Group.displayName;
...
ra.displayName = L.Separator.displayName;
...
Me.displayName = L.Item.displayName;
function aa(t) {
...
function pe({
  ...
  const [y, N] = B(!1);
  return /* @__PURE__ */ l(wn, { open: y, onOpenChange: N, ...x, children: [
    /* @__PURE__ */ r(dn, { asChild: !0, children: /* @__PURE__ */ l(
      M,
      {
        variant: g,
        role: "combobox",
...
function Zo({
  ...
  const u = ae(m, "%webView_bookSelector_currentBook%"), f = ae(m, "%webView_bookSelector_choose%"), g = ae(m, "%webView_bookSelector_chooseBooks%"), [h, v] = B(
    "current book"
    /* CURRENT_BOOK */
  ), x = (y) => {
    v(y), t(y);
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(J, { className: "tw-ms-1", children: u })
          ] }),
...
function ia({ table: t }) {
  return /* @__PURE__ */ l(Kt, { children: [
    /* @__PURE__ */ r(Yn, { asChild: !0, children: /* @__PURE__ */ l(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r($n, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ l(Ft, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ r(Gt, { children: "Toggle columns" }),
      /* @__PURE__ */ r(Yt, {}),
...
const yt = X.Root, wa = X.Group, Nt = X.Value, ht = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = Y();
  return /* @__PURE__ */ l(
    X.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(X.Icon, { asChild: !0, children: /* @__PURE__ */ r(qt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
pn.displayName = X.ScrollUpButton.displayName;
const un = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  X.ScrollDownButton,
  {
    ref: n,
    className: d("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
...
da.displayName = X.Label.displayName;
...
la.displayName = X.Separator.displayName;
function ca({ table: t }) {
...
function ma({
  ...
  var y;
  const [w, p] = B([]), [m, u] = B([]), [f, g] = B({}), [h, v] = B({}), x = He({
    data: e,
    columns: t,
    getCoreRowModel: Ue(),
    ...n && { getPaginationRowModel: vr() },
    onSortingChange: p,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    n && a && /* @__PURE__ */ r(ca, { table: x })
  ] });
}
const $t = Ut(({ className: t, ...e }, n) => /* @__PURE__ */ r(Kn, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function Qo({
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r($t, { size: 15 }) : /* @__PURE__ */ l(ft, { children: [
        /* @__PURE__ */ r(Wn, { size: 25, className: d("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function rs({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Nr, { options: o, children: e }) });
}
const ha = Ut((t, e) => /* @__PURE__ */ l(
  M,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ r(Zn, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ r(
        qt,
        {
...
function as({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(Kt, { children: [
    /* @__PURE__ */ r(xe, { asChild: !0, children: /* @__PURE__ */ r(ha, {}) }),
    /* @__PURE__ */ r(Ft, { children: e.map((n) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(Gt, { children: n.label }),
      /* @__PURE__ */ r(Ke, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Ne, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(Qe, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Yt, {})
    ] }, n.label)) })
  ] }) });
}
...
function ss({
  ...
  }).format(Object.values(n).reduce((w, p) => w + p, 0)), i = () => {
      ...
      children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ r(Qn, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ l("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ l(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ r(tr, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ l(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ r(er, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function fa({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const p = new Date(w), m = new Date(o.getTime() - p.getTime()), u = m.getUTCFullYear() - 1970, f = m.getUTCMonth(), g = m.getUTCDate() - 1;
    let h = "";
...
function va({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ r("div", { className: d("pr-twp", ba({ variant: e }), t), ...n });
}
function xa({
  entries: t,
  ...
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(wn, { open: u, onOpenChange: f, children: [
    /* @__PURE__ */ r(dn, { asChild: !0, children: /* @__PURE__ */ l(
      M,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Te, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(_e, { children: [
      /* @__PURE__ */ r(ze, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ l(Ee, { children: [
        /* @__PURE__ */ r(Ie, { children: s }),
        /* @__PURE__ */ r(cn, { children: v.map((x) => {
          ...
          return /* @__PURE__ */ l(
            Me,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: x.starred && /* @__PURE__ */ r(nr, { className: "tw-h-4 tw-w-4" }) }),
...
function ws({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var g;
      return /* @__PURE__ */ l(va, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          M,
          {
            variant: "ghost",
...
function ya({
  ...
  return /* @__PURE__ */ l(Wt, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Qt, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      wt,
      {
        onClick: () => {
          e(i.reference);
        ...
        children: [
          /* @__PURE__ */ r(kt, { children: `${_.bookNumberToEnglishName(i.reference.bookNum)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(kt, { children: i.text })
        ]
      },
...
}, Ca = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", mn = bt(
...
), Sa = c.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  qe.Root,
  {
    ref: o,
    className: d(mn({ variant: e, size: n, className: t })),
    ...a
  }
));
Sa.displayName = qe.Root.displayName;
const hn = c.createContext({
  size: "default",
  variant: "default"
}), gn = c.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = Y();
  return /* @__PURE__ */ r(
    Jt.Root,
    {
...
Lt.displayName = Jt.Item.displayName;
const te = (t) => t === "asc" ? /* @__PURE__ */ r(sr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ir, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ds = (t) => ({
  accessorKey: "item",
  ...
  let i = [...n];
  t.forEach((p) => {
    e === "approved" ? i.includes(p) || i.push(p) : i = i.filter((m) => m !== p);
  }), a(i);
  let w = [...o];
  t.forEach((p) => {
    e === "unapproved" ? w.includes(p) || w.push(p) : w = w.filter((m) => m !== p);
  }), s(w);
}, cs = (t, e, n, a, o) => ({
  accessorKey: "status",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(gn, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Lt,
        {
          onClick: () => oe(
  ...
  if (!t) return [];
  const s = [];
  let i = e.bookNum, w = e.chapterNum, p = e.verseNum;
  return Na(t).forEach((u) => {
    u.startsWith("\\id") && (i = ka(u), w = 0, p = 0), u.startsWith("\\c") && (w = Xe(u), p = 0), u.startsWith("\\v") && (p = Xe(u), w === 0 && (w = e.chapterNum));
    let f = o.exec(u) ?? void 0;
    for (; f; ) {
      const g = [];
      f.forEach((y) => g.push(y));
      const h = f.index, v = s.find((y) => ve(y.items, g)), x = {
        reference: {
          bookNum: i !== void 0 ? i : -1,
          chapterNum: w !== void 0 ? w : -1,
          verseNum: p !== void 0 ? p : -1
        },
        text: fr(u, Math.max(0, h - 25), Math.min(h + 25, u.length))
      };
      if (v)
...
function us({
  ...
  const f = at(n, "%webView_inventory_all%"), g = at(n, "%webView_inventory_approved%"), h = at(n, "%webView_inventory_unapproved%"), v = at(n, "%webView_inventory_unknown%"), x = at(n, "%webView_inventory_scope_currentBook%"), y = at(n, "%webView_inventory_scope_chapter%"), N = at(n, "%webView_inventory_scope_verse%"), k = at(n, "%webView_inventory_filter_text%"), A = at(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, ot] = B(!1), [rt, zt] = B("all"), [b, z] = B(""), [K, P] = B([]), Et = Q(() => w ? a instanceof RegExp ? _a(
    w,
    t,
    s,
    i,
    a
  ) : a(w, t, s, i) : [], [w, a, t, s, i]), lt = Q(() => {
    if (j) return Et;
    const R = [];
    return Et.forEach(($) => {
  ...
  }, [j, Et]), C = Q(() => Ta(lt, rt, b), [lt, rt, b]), E = Q(() => {
    var st, ct;
    if (!j) return u;
    ...
    return [...$, ...u];
  }, [o == null ? void 0 : o.tableHeaders, u, j]);
  dt(() => {
    P([]);
  }, [C]);
  const O = (R, $) => {
...
const De = c.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Je.Root,
  {
    ref: o,
    decorative: n,
...
De.displayName = Je.Root.displayName;
...
const za = jt.Provider, Ea = jt.Root, Ia = jt.Trigger, fn = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  jt.Content,
  {
    ref: a,
    sideOffset: e,
...
fn.displayName = jt.Content.displayName;
const Ma = "16rem", Va = "3rem", bn = c.createContext(void 0);
function ee() {
...
const vn = c.forwardRef(
  ({
    ...
    const [m, u] = c.useState(t), f = e ?? m, g = c.useCallback(
      (A) => {
        const j = typeof A == "function" ? A(f) : A;
        n ? n(j) : u(j);
      },
      [n, f]
    ), h = c.useCallback(() => g((A) => !A), [g]), v = f ? "expanded" : "collapsed", N = Y() === "ltr" ? i : i === "primary" ? "secondary" : "primary", k = c.useMemo(
      () => ({
        state: v,
        open: f,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(bn.Provider, { value: k, children: /* @__PURE__ */ r(za, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const xn = c.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = ee();
...
const Da = c.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    M,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(dr, {}) : /* @__PURE__ */ r(lr, {}),
...
Cn.displayName = "SidebarMenuItem";
const Fa = bt(
  ...
  ({
    ...
    const p = t ? St : "button", { state: m } = ee(), u = /* @__PURE__ */ r(
      p,
      {
        ref: w,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Ia, { asChild: !0, children: u }),
      /* @__PURE__ */ r(fn, { side: "right", align: "center", hidden: m !== "collapsed", ...o })
    ] })) : u;
  }
);
Sn.displayName = "SidebarMenuButton";
...
function qa({
  ...
  return /* @__PURE__ */ r(
    xn,
    {
      ...
      children: /* @__PURE__ */ l(Nn, { children: [
        /* @__PURE__ */ l(ue, { children: [
          /* @__PURE__ */ r(me, { className: "tw-text-sm tw-text-gray-400", children: s }),
          /* @__PURE__ */ r(he, { children: /* @__PURE__ */ r(kn, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(Cn, { children: /* @__PURE__ */ r(
            Sn,
            {
              className: d(
        ...
        /* @__PURE__ */ l(ue, { children: [
          /* @__PURE__ */ r(me, { className: "tw-text-sm tw-text-gray-400", children: i }),
    ...
    /* @__PURE__ */ l(
      vn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(yn, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const it = "scrBook", Ja = "scrRef", ut = "source", Ka = "details", Wa = "Scripture Reference", Za = "Scripture Book", Tn = "Type", Qa = "Details";
function to(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? _.bookNumberToEnglishName(o.start.bookNum) : a.row.groupingColumnId === it ? ne(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: ut,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Tn : void 0,
...
}, Fe = (t) => `${eo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function hs({
  sources: t,
  ...
  const [p, m] = B([]), [u, f] = B([{ id: it, desc: !1 }]), [g, h] = B({}), v = Q(
  ...
  dt(() => {
    if (w) {
      ...
      if (z.length === 1) {
        const K = v.find((P) => Fe(P) === z[0]) || void 0;
        K && w(K);
      }
    }
  }, [g, v, w, y]);
  const N = o ?? Za, k = s ?? Tn, A = [
    ...
    !e && /* @__PURE__ */ l(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(gt, { position: "item-aligned", children: /* @__PURE__ */ r(wa, { children: A.map((b) => /* @__PURE__ */ r(W, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
                  ...
                  kt,
                  {
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ l(
                      M,
                      {
                        ...
                        type: "button",
                        children: [
                          b.getIsExpanded() && /* @__PURE__ */ r(qt, {}),
                          !b.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(ge, {}) : /* @__PURE__ */ r(pr, {})),
                          " ",
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          gt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(W, { value: `${w}`, children: s[I(w)] }, `${w}`))
          }
        )
      ]
    }
...
}, _n = (t, e, n, a) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map(
  (w) => "command" in w ? /* @__PURE__ */ r(
    ye,
    {
      onClick: () => {
        a(w);
    ...
    w.command
  ) : /* @__PURE__ */ l(zr, { children: [
    /* @__PURE__ */ r(We, { children: w.label }),
    /* @__PURE__ */ r(_r, { children: /* @__PURE__ */ r(Ze, { children: _n(
      t,
      e,
      no(t, w.id),
      a
...
function xs({
  ...
  return /* @__PURE__ */ l(Kt, { children: [
    /* @__PURE__ */ r(
      ...
      {
        "aria-label": n,
        className: d("tw-cursor-pointer", a),
        asChild: !0,
        children: o ?? /* @__PURE__ */ r(ur, {})
      }
    ),
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, i]) => typeof s == "boolean" || typeof i == "boolean" ? 0 : s.order - i.order).map(([s, i], w, p) => /* @__PURE__ */ l(ft, { children: [
      /* @__PURE__ */ r(Gt, { children: typeof i == "object" && "label" in i && i.label }, s),
      /* @__PURE__ */ r(Ke, { children: _n(e.groups, e.items, s, t) }),
      w < p.length - 1 && /* @__PURE__ */ r(Yt, {})
    ] })) })
  ] });
}
const zn = c.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    U.Root,
    {
...
zn.displayName = U.List.displayName;
...
En.displayName = U.List.displayName;
...
)), In = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Content,
  {
    ref: n,
    className: d(
...
In.displayName = U.Content.displayName;
function ys({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(zn, { children: [
      /* @__PURE__ */ r(En, { children: t.map((i) => /* @__PURE__ */ r(ro, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(In, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
const Mn = c.createContext(void 0);
function vt() {
  const t = c.useContext(Mn);
  if (!t)
...
const Vn = c.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = c.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(Mn.Provider, { value: o, children: /* @__PURE__ */ r(
    D.Root,
    {
      ref: a,
      className: d(
...
Vn.displayName = D.Root.displayName;
...
Dn.displayName = D.Trigger.displayName;
const Bn = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = vt();
  return /* @__PURE__ */ l(
    D.SubTrigger,
    {
...
Bn.displayName = D.SubTrigger.displayName;
...
const An = c.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = vt();
...
An.displayName = D.Content.displayName;
const Pn = c.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = vt();
  return /* @__PURE__ */ r(
    D.Item,
    {
...
Pn.displayName = D.Item.displayName;
...
const io = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    D.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(D.ItemIndicator, { children: /* @__PURE__ */ r(fe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
Xn.displayName = D.Separator.displayName;
const Dt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((m) => m.group === s).sort((m, u) => m.order - u.order).map(
      (m) => "command" in m ? /* @__PURE__ */ r(
        Pn,
        {
          onClick: () => {
            a(m);
        ...
        /* @__PURE__ */ r(Bn, { children: m.label }),
        /* @__PURE__ */ r(On, { children: jn(
          t,
          e,
          lo(t, m.id),
          a
    ...
    return w.length > 0 && i < o.length - 1 && p.push(/* @__PURE__ */ r(Xn, {}, `${s}-separator`)), p;
  });
};
function co({
  menuData: t,
  ...
  const o = Z(void 0), s = Z(void 0), i = Z(void 0), w = Z(void 0), p = Z(void 0), m = (u) => {
    switch (u) {
  ...
  if (kr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, f) => {
    var v, x, y, N;
    u.preventDefault();
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Dt(i, [g, h]);
        break;
      case "alt+n":
        (y = w.current) == null || y.focus(), Dt(w, [g, h]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ r(Vn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, f]) => typeof u == "boolean" || typeof f == "boolean" ? 0 : u.order - f.order).map(([u, f]) => /* @__PURE__ */ l(ao, { children: [
      /* @__PURE__ */ r(Dn, { ref: m(u), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        An,
        {
          className: "tw-z-[250]",
          children: jn(t.groups, t.items, u, e)
        }
      )
    ] }, u)) });
}
...
function Cs({
  ...
  const p = po(
    ...
    o && o(h), a && a([h, ...n.filter((v) => v !== h)]), s && n.find((v) => v === h) && s([...n.filter((v) => v !== h)]), u(!1);
  }, g = (h, v) => {
    var y, N, k, A, j, ot;
  ...
  return /* @__PURE__ */ r("div", { id: t, className: e, children: n.map((i) => /* @__PURE__ */ l("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ r(
      Ve,
      {
        ...
        onCheckedChange: (w) => o(i, w)
      }
    ),
    /* @__PURE__ */ r(J, { children: s ? s(i) : i })
  ] }, i)) });
}
function Rs({
  id: t,
...
To.displayName = le.Root.displayName;
...
const Mo = (t, e, n = {}) => {
  ...
  return dt(() => {
    ...
    return p(!!t), (async () => {
      ...
      m = !1, o.current.preserveValue || i(() => a.current);
    };
  }, [t]), [s, w];
}, ie = () => !1, Es = (t, e) => {
  const [n] = Mo(
...
export {
  ...
  zn as VerticalTabs,
  In as VerticalTabsContent,
  En as VerticalTabsList,
  ro as VerticalTabsTrigger,
  ba as badgeVariants,
  Wr as buttonVariants,
  d as cn,
  ka as getBookNumFromId,
  Na as getLinesFromUSFM,
  Xe as getNumberFromUSFM,
  Ca as getStatusForItem,
