import { jsx as r, jsxs as d, Fragment as ft } from "react/jsx-runtime";
import c, { forwardRef as Lt, useCallback as tt, useState as B, useRef as Z, useEffect as lt, useLayoutEffect as Xe, useMemo as Q } from "react";
...
const Jt = M.Root, ye = M.Trigger, tn = M.Group, Ir = M.Portal, Mr = M.Sub, qo = M.RadioGroup, en = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  M.SubTrigger,
  {
    ref: o,
    className: l(
...
const H = class _ {
  ...
  static fromJSON(e) {
    ...
    let p;
    return w && (p = new pt(w)), n ? new _(n, a.toString(), i, p) : new _();
  }
  /**
...
const _e = D.allBookIds.filter((t) => !D.isObsolete(D.bookIdToNumber(t))), qr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function Ko({
  ...
  const o = Y(), [s, w] = B(""), [i, p] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, v] = B(!1), [x, y] = B(h), N = Z(void 0), k = Z(void 0), A = Z(void 0), j = tt(
    (C) => {
      const z = a ? a() : _e;
      return {
        ...
        const G = D.bookIdToEnglishName(O).toLowerCase(), F = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    Kr.forEach((C) => {
      const z = s.match(C);
      if (z) {
        const [O, G = void 0, F = void 0] = z.slice(1), It = Qr(O);
...
const ta = bt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? St : "button", { className: l(ta({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const ea = bt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), J = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(qe.Root, { ref: n, className: l("pr-twp", ea(), t), ...e }));
...
var la = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(la || {});
    ...
    cn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(J, { className: "tw-flex tw-items-center", children: a.map((y) => D.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
function da({ table: t }) {
  return /* @__PURE__ */ d(Jt, { children: [
    /* @__PURE__ */ r(Ln, { asChild: !0, children: /* @__PURE__ */ d(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function fa({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(da, { table: x }),
    /* @__PURE__ */ d(Wt, { stickyHeader: s, children: [
...
const Yt = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(Qn, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function Qo({
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r(Yt, { size: 15 }) : /* @__PURE__ */ d(ft, { children: [
        /* @__PURE__ */ r(tr, { size: 25, className: l("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function ts({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      ...
      onClick: e,
      ...a,
      children: t ? /* @__PURE__ */ d(ft, { children: [
...
function rs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Sr, { options: o, children: e }) });
}
const ba = Lt((t, e) => /* @__PURE__ */ d(
  I,
  {
    ref: e,
...
function Na({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ r("div", { className: l("pr-twp", ya({ variant: e }), t), ...n });
}
function ka({
  entries: t,
...
function ws({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var g;
      return /* @__PURE__ */ d(Na, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          I,
          {
            variant: "ghost",
...
function Ca({
  ...
  return /* @__PURE__ */ d(Wt, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Qt, { children: s.length > 0 && s.map((w) => /* @__PURE__ */ d(
      wt,
      {
        onClick: () => {
          e(w.reference);
...
Sa.displayName = Ze.Root.displayName;
...
const te = (t) => t === "asc" ? /* @__PURE__ */ r(lr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(cr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ls = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, za = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ps = Object.freeze([
  ...
  if (!t) return [];
  const s = [];
  let w = e.book, i = e.chapterNum, p = e.verseNum;
  return _a(t).forEach((m) => {
    m.startsWith("\\id") && (w = Ta(m), i = 0, p = 0), m.startsWith("\\c") && (i = Ye(m), p = 0), m.startsWith("\\v") && (p = Ye(m), i === 0 && (i = e.chapterNum));
...
function us({
  ...
  const f = at(n, "%webView_inventory_all%"), g = at(n, "%webView_inventory_approved%"), h = at(n, "%webView_inventory_unapproved%"), v = at(n, "%webView_inventory_unknown%"), x = at(n, "%webView_inventory_scope_currentBook%"), y = at(n, "%webView_inventory_scope_chapter%"), N = at(n, "%webView_inventory_scope_verse%"), k = at(n, "%webView_inventory_filter_text%"), A = at(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, ot] = B(!1), [rt, zt] = B("all"), [b, T] = B(""), [K, P] = B([]), Et = Q(() => i ? a instanceof RegExp ? Ia(i, t, s, w, a) : a(i, t, s, w) : [], [i, a, t, s, w]), dt = Q(() => {
    if (j) return Et;
    const R = [];
    return Et.forEach(($) => {
  ...
  }, [j, Et]), C = Q(() => Ea(dt, rt, b), [dt, rt, b]), z = Q(() => {
    var st, ct;
    if (!j) return m;
  ...
  ({
    ...
    const p = t ? St : "button", { state: u } = ne(), m = /* @__PURE__ */ r(
      p,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: l(Fa({ variant: n, size: a }), s),
        ...w
      }
    );
...
function qa({
  ...
  return /* @__PURE__ */ r(
    kn,
    {
      ...
      collapsible: "none",
      variant: "inset",
      className: l("tw-w-96 tw-gap-2 tw-overflow-y-auto tw-bg-muted/50", p),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          gt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((i) => /* @__PURE__ */ r(W, { value: `${i}`, children: s[E(i)] }, `${i}`))
          }
        )
      ]
    }
...
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, p) => i.order - p.order).map((i) => /* @__PURE__ */ r(Oe, { children: /* @__PURE__ */ d(Ae, { children: [
...
function xs({
  ...
  return /* @__PURE__ */ d(Jt, { children: [
    ...
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, i]) => typeof w == "boolean" || typeof i == "boolean" ? 0 : w.order - i.order).map(([w], i, p) => /* @__PURE__ */ d(ft, { children: [
...
so.displayName = V.CheckboxItem.displayName;
...
io.displayName = V.RadioItem.displayName;
...
wo.displayName = V.Label.displayName;
const Gn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  V.Separator,
  {
    ref: n,
...
const Dt = (t, e) => {
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((u) => u.group === s).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ r(Oe, { children: /* @__PURE__ */ d(Ae, { children: [
...
function co({
  ...
  if (Rr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    ...
    return /* @__PURE__ */ r(On, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(ao, { children: [
...
function Cs({
  ...
  return /* @__PURE__ */ d("div", { className: l("pr-twp tw-max-w-sm", i), children: [
    ...
    e !== "en" && /* @__PURE__ */ d(ft, { children: [
      /* @__PURE__ */ r(J, { className: "tw-ms-3", children: p }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ d(J, { children: [
        "Currently:",
        " ",
...
), mo = c.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(uo({ variant: e }), t), ...n }));
...
const go = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const ko = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
_o.displayName = ce.Root.displayName;
const Ts = U.Root, To = c.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    U.List,
    {
...
To.displayName = U.List.displayName;
...
export {
  ...
  l as cn,
  Ta as getBookIdFromUSFM,
  _a as getLinesFromUSFM,
  Ye as getNumberFromUSFM,
  za as getStatusForItem,
  Ns as getToolbarOSReservedSpaceClassName,
  ds as inventoryCountColumn,
  ls as inventoryItemColumn,
