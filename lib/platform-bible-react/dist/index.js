...
function Ha({
  ...
  const Qt = j(() => {
    ...
    const m = q;
    it(void 0), dt(void 0), m ? (z(m), rt("chapters"), Y("")) : et();
  }, [q, et]), ct = j(
    (m) => {
...
function Bw({
  ...
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), U = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : Y, tt = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(pa, { html: R }) : Y : U(O === "reject" ? t.rejectedResultText : t.resultText);
...
function _h({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [I, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), z = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, zt] = _(), Ht = F(null), wt = F(
    void 0
...
function Yh({
  ...
  }, B = (D, M) => D.getIsGrouped() ? "" : v("banded-row", M % 2 === 0 ? "even" : "odd"), I = (D, M, Y) => {
