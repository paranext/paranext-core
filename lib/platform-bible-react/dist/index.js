...
function Ml({
  ...
  return /* @__PURE__ */ u(Ve, { open: b, onOpenChange: v, children: [
    ...
    /* @__PURE__ */ a(Le, { id: i, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ee, { heading: s, children: t.map((y) => /* @__PURE__ */ u(
      Se,
      {
        onSelect: () => R(y),
...
function _p(t, e, r = (n, s) => n === s, o = 15) {
  return (n) => {
    const s = t.filter(
      (c) => !r(c, n)
    ), i = [n, ...s.slice(0, o - 1)];
...
function Vl(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : Dt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
...
function Ra({
  ...
  const E = be(), F = Rl(), [O, z] = _(!1), [K, W] = _(""), [j, Q] = _(""), [N, et] = _("books"), [D, M] = _(void 0), [q, nt] = _(
    void 0
  ), [ot, ut] = _(void 0), [jt, J] = _(!1), [ct, gt] = _(!1), mt = U(null), vt = U(!1), _t = U(void 0), ft = U(void 0), Bt = U(void 0), re = U(void 0), St = U({}), Ft = U({}), ht = L(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
  ...
  const yt = L(() => {
    ...
    (k) => {
      z(k), k && (et("books"), M(void 0), nt(void 0), ut(void 0), Q(""), gt(Re));
    },
    [Re]
  );
  Y(() => {
  ...
  const { otLong: $, ntLong: tt, dcLong: lt, extraLong: pt } = {
    ...
    () => F >= Cr.TIGHT ? _r(t.book, s) : ge(t.book, s),
    [t.book, s, F]
    ...
    [p]
  ), vr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", Ge = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) || "Select verse", va = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", We = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", ba = L(
    (k) => Ie(We, {
      book: `${ge(k, s)} (${_r(
        k,
        s
    ...
    [We, s]
  ), ar = (i == null ? void 0 : i["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", xa = (i == null ? void 0 : i["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", ya = L(
    (k) => {
    ...
    (k) => {
      ...
      if ((N === "chapters" || N === "books" && P) && Qt) {
        const dt = N === "chapters" ? D : P == null ? void 0 : P.book;
        if (!dt) return;
    ...
    if (k.key === "ArrowUp" || k.key === "ArrowDown") {
      (Qt = ft.current) == null || Qt.focus();
      return;
    }
    const { isLetter: rt, isDigit: at } = Xo(k.key);
    (rt || at) && (k.preventDefault(), Q((_e) => _e + k.key), ft.current.focus(), J(!1));
  }, []);
  return te(() => {
    const k = setTimeout(() => {
          ...
          je,
          {
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                N === "chapters" && D && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ge(D, s) }),
                N === "verses" && q && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ge(q, s)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !jt && /* @__PURE__ */ u(Be, { ref: Bt, children: [
                N === "books" && /* @__PURE__ */ u(st, { children: [
                  ...
                  P && /* @__PURE__ */ a(Ee, { children: /* @__PURE__ */ a(
                    Se,
                    {
                      ...
                      children: Ne(
                        ...
                        // one control.
                        s ? _r(P.book, s) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  P && fa && P.chapterNum && w && /* @__PURE__ */ u(st, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${ge(P.book, s)} ${P.chapterNum}` }),
                  ...
                  P && !fa && cr(P.book) > 1 && /* @__PURE__ */ u(st, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: ge(P.book, s) }),
...
function Zl() {
  return function(t) {
    const [e] = ye(), r = A(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), s = U(o);
    return Xl(() => {
...
function rd(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      const y = g[R], C = i[R] || document.createElement("div"), T = C.style;
      ...
      const O = fe(y.height);
      T.height !== O && (C.style.height = O, v = !0), C.parentNode !== c && (c.append(C), v = !0), i[R] = C;
    }
...
function od(t, e = ad) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, R = g.getNode(), y = R.getKey(), C = g.offset, T = t.getElementByKey(b), I = t.getElementByKey(y), E = r === null || T !== o || v !== n || b !== r.getKey(), F = s === null || I !== i || C !== c || y !== s.getKey();
...
function ld(t) {
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(i)) continue;
    const c = qn(s, (d) => Rr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
ie({ name: "@lexical/extension/DecoratorText", nodes: () => [mi], register: (t, e, r) => t.registerCommand(Wn, (o) => {
  const n = ee();
  if (Yn(n) || me(n)) for (const s of n.getNodes()) fd(s) && s.toggleFormat(o);
  return !1;
}, Xn) });
function vi(t, e) {
  let r;
...
class bd {
  ...
  build(e) {
    ...
    this.state = function(s, i, c) {
      return Object.assign(s, { id: or, output: i, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== yr && wt(309, String(o.id), String(yr)), this.state = function(i) {
...
class lr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      $a(s) || wt(300, i, n || "[unknown]"), $a(c = s) || wt(304, String(c.id), String(Co)), s = Object.assign(c, { id: oo }), o.state = s;
...
const _d = /* @__PURE__ */ new Set(), cn = ie({ build(t, e, r) {
  const o = r.getDependency(ao).output, n = zr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = vi(() => {
  }, () => ve(() => {
...
ie({ dependencies: [ao, cn], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(cn).output, n = zr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Te(t.registerCommand(Nd, (i) => {
    const c = ee();
    if (!me(c)) return !1;
    ...
    return !1;
  }, Xn), t.registerMutationListener(wr, (i, c) => {
    wd(() => {
      let l = !1;
    ...
    const i = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) i.push(ve(() => {
      const d = c.value;
...
function $d({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    To(() => Te(wl(n), Ni(n)), [n]);
  }(o), u(st, { children: [t, a(Pd, { content: e }), a(Id, { editor: o, ErrorBoundary: r })] });
}
...
function jd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: v = "textbox", spellCheck: R = !0, style: y, tabIndex: C, "data-testid": T, ...I }, E) {
  ...
  return Ci(() => (O(t.isEditable()), t.registerEditableListener((W) => {
    O(W);
  })), [t]), a("div", { "aria-activedescendant": F ? e : void 0, "aria-autocomplete": F ? r : "none", "aria-controls": F ? o : void 0, "aria-describedby": n, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": F && v === "combobox" ? !!i : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": F ? p : void 0, "aria-readonly": !F || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: F, "data-testid": T, id: b, ref: K, role: v, spellCheck: R, style: y, tabIndex: C, ...I });
}
const Bd = Ln(jd);
function dn(t) {
  return t.getEditorState().read(_i(t.isComposing()));
...
function Ud(t, e) {
  ...
  return u(st, { children: [a(Bd, { editor: n, ...o, ref: e }), r != null && a(Kd, { editor: n, content: r })] });
}
function Kd({ content: t, editor: e }) {
  ...
  if (te(() => (n(e.isEditable()), e.registerEditableListener((i) => {
    n(i);
  })), [e]), !r) return null;
  let s = null;
...
function Wd({
  ...
  const [e] = ye(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Gd(), l = () => {
  };
...
function Xd() {
  ...
  return Yd(o), /* @__PURE__ */ a(
    Nn,
    {
      ...
      variant: "outline",
      size: "sm",
      children: wn.map(({ format: n, icon: s, label: i }) => /* @__PURE__ */ a(
        Kr,
        {
          value: n,
          "aria-label": i,
...
function Di({
  ...
  const i = un(o, "%cancelButton_tooltip%"), c = s ?? un(o, "%acceptButton_tooltip%");
  return /* @__PURE__ */ u(co, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      ...
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: i }) })
    ] }) }),
    /* @__PURE__ */ a(Cn, {}),
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
...
function Sp({
  ...
  const [s, i] = _(rw), [c, l] = _(n), [d, w] = _(!1), p = U(void 0), h = U(null);
  Y(() => {
    let v = !0;
    const R = h.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : Ro(v) && (v.preventDefault(), v.stopPropagation(), ne(s) && g());
        },
        onKeyDown: (v) => {
    ...
    if (o && c)
      return /* @__PURE__ */ u(st, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (E) => {
              E.stopPropagation(), d(!0), p(tw(t.contents)), i == null || i(!0);
            },
            children: [
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ a(
                aa,
                {
                  ...
                  actions: /* @__PURE__ */ u(st, { children: [
                    /* @__PURE__ */ a("div", { className: "tw:flex-1" }),
                    /* @__PURE__ */ a(
                      X,
                      {
...
function Pi({
  ...
  const [j, Q] = _(hn), [N, et] = _(), [D, M] = _(), q = o, [nt, ot] = _(!1), [ut, jt] = _(!1), [J, ct] = _(!1), [gt, mt] = _(!1), [vt, _t] = _(!1), [ft, Bt] = _(T), [re, St] = _(!1), Ft = U(void 0), [ht, Yt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
      const $ = y ? await y(l) : !1;
  ...
  Y(() => {
    ...
    xt.current === "idle" && (xt.current = "pending"), gt ? xt.current === "pending" && F !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    F !== s && (et(F), xt.current = "auto-populated") : xt.current === "auto-populated" && (et(void 0), xt.current = "pending");
  }, [o, F, gt, s]);
  const Nt = A(
  ...
  }, [s, r]), Ut = A(() => Nt.slice(1), [Nt]), yt = A(() => Ut.length ?? 0, [Ut.length]), se = A(() => yt > 0, [yt]), Zt = A(() => nt || yt <= 2 ? Ut : Ut.slice(-2), [Ut, yt, nt]), Kt = A(() => nt || yt <= 2 ? 0 : yt - 2, [yt, nt]), ue = A(
  ...
  const G = /* @__PURE__ */ a(
    pn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: jt,
      canEditOrDelete: (!ut && ht.get(At.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    ow,
    {
      ...
      className: m(
        ...
        {
          "tw:bg-card": w !== "Resolved" && ft,
          "tw:bg-muted": w === "Resolved",
          "tw:bg-accent": !ft && w !== "Resolved"
        }
      ),
      onClick: () => {
        c(l);
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              X,
              {
                ...
                children: ft ? /* @__PURE__ */ a(Ts, {}) : /* @__PURE__ */ a(Ss, {})
              }
            ),
            K === void 0 ? (
          ...
          o && /* @__PURE__ */ u(st, { children: [
            ...
            Zt.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              pn,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: jt,
                canEditOrDelete: (!ut && ht.get(x.id)) ?? !1
              }
            ) }, x.id)),
            v !== !1 && (!ut || ne(j)) && /* @__PURE__ */ a(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                children: /* @__PURE__ */ a(
                  aa,
                  {
                    ...
                    actions: /* @__PURE__ */ u(st, { children: [
                      ...
                      /* @__PURE__ */ u(Ve, { open: J, onOpenChange: ct, children: [
                        /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(
                          X,
                          {
                            size: "icon-sm",
                        ...
                        /* @__PURE__ */ a(
                          Le,
                          {
                            ...
                            children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: b == null ? void 0 : b.map((x) => /* @__PURE__ */ a(
                              ...
                              {
                                onSelect: () => {
                                  et(x !== s ? x : void 0), xt.current = "user-selected", M(void 0), ct(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function dw({
  ...
  const [i, c] = _("accept"), l = Bo(), d = Bo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : i, b = A(
    () => Xr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Xr(t.acceptedText ?? ""),
  ...
  let z;
  F ? z = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : s || (z = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
...
function yw({
  ...
  return l ? I = Array.from({ length: 10 }).map((z, K) => `skeleton-row-${K}`).map((z) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(sr, { colSpan: T.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((E = C.getRowModel().rows) == null ? void 0 : E.length) > 0 ? I = C.getRowModel().rows.map((F) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(wo, { stickyHeader: s, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: s, children: C.getHeaderGroups().map((F) => /* @__PURE__ */ a(Oe, { children: F.headers.map((O) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: O.isPlaceholder ? void 0 : Nr(O.column.columnDef.header, O.getContext()) }, O.id)) }, F.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(X, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ a(In, {}) })
        ] }),
...
function Fp({
  ...
  return /* @__PURE__ */ u(Ve, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Le, { id: s, className: m("tw:min-w-80 tw:max-w-96", n), children: [
      i && r["%webView_error_dump_copied_message%"] && /* @__PURE__ */ a(Tt, { children: r["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ a(
        _w,
        {
          errorDetails: t,
...
function Up({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Fe, { children: [
    ...
    /* @__PURE__ */ a(Ke, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(En, { children: d.itemType === 0 ? /* @__PURE__ */ a(st, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        $e,
        {
          checked: o[w][h],
...
function Sw({
  ...
  return Y(() => {
    var l;
    const s = lo(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
const Rw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(st, { children: [
...
function zw({
  ...
  const n = U(null), s = U(null), i = U(!1), [c, l] = _(t), [d, w] = _(e), [p, h] = _(!1), g = U(!1), f = U(c);
  f.current = c;
  const b = U(d);
  b.current = d, Y(() => {
    l(t);
  ...
  const v = (y) => {
    ...
    var C, T, I, E;
    y.stopPropagation(), document.activeElement === s.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), i.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((T = s.current) == null || T.focus(), i.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && ((I = n.current) == null ? void 0 : I.selectionStart) === 0 && ((E = s.current) == null || E.focus(), i.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && v(!1);
  };
...
const Dw = (t, e) => t === "f" ? /* @__PURE__ */ u(st, { children: [
  /* @__PURE__ */ a(Pn, {}),
  " ",
...
function Aw({
  ...
  return /* @__PURE__ */ u(je, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Be, { children: [
      ...
      /* @__PURE__ */ a(Ee, { children: i.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          mn,
          {
...
function Gp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [T, I] = _("*"), [E, F] = _("*"), [O, z] = _("f"), [K, W] = _(!1), [j, Q] = _(!0), [N, et] = _(!1), D = U(!1), M = U(""), [q, nt] = _(!1), [ot, ut] = _(), [jt, J] = _(), [ct, gt] = _(), [mt, vt] = _(), _t = U(null), ft = U(
    void 0
  ...
  Y(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let lt = "custom";
      tt === Ja ? lt = "generated" : tt === Za ? lt = "hidden" : tt && (I(tt), F(tt)), R(lt), C(lt), z((($ = x.insert.note) == null ? void 0 : $.style) ?? "f"), S = setTimeout(() => {
        var pt, Ct, Rt;
        (pt = h.current) == null || pt.applyUpdate([x]), (Ct = h.current) == null || Ct.selectNote(0), (Rt = h.current) == null || Rt.focus(), B = requestAnimationFrame(() => {
          G = setTimeout(() => {
            var Vt, ae;
            ht() || ((Vt = h.current) == null || Vt.selectNote(0), (ae = h.current) == null || ae.focus());
          }, 0);
        });
      }, 0);
    }
  ...
  const Yt = L(
    (S = !1) => {
      ...
      B && xr("note", B) && (r == null || r([B]), S && d && s && ((H = d.current) == null || H.replaceEmbedUpdate(s, [B])));
    },
    [s, r, p, d]
  ), xt = L(
    (S, B) => {
    ...
    var S;
    ft.current || (S = h.current) == null || S.commitPendingMarkerEdits(), Yt(!0), o();
  }, [o, Yt]), At = U(Nt);
  te(() => {
    At.current = Nt;
  });
  ...
  const we = () => {
    ...
    if (B && xr("note", B)) {
      ...
      const lt = ($ = (H = B.insert.note) == null ? void 0 : H.contents) == null ? void 0 : $.ops;
      O !== "x" && S === "x" ? lt == null || lt.forEach((pt) => jw(pt)) : O === "x" && S !== "x" && (lt == null || lt.forEach((pt) => Bw(pt))), (tt = h.current) == null || tt.applyUpdate([B, { delete: 1 }]);
    }
  }, oe = (S) => {
    ...
    (S) => {
      ...
      if (B && xr("note", B)) {
        ...
        const lt = (H = B.insert.note) == null ? void 0 : H.style, pt = (tt = ($ = B.insert.note) == null ? void 0 : $.contents) == null ? void 0 : tt.ops;
        if (lt || W(!1), W(
    ...
    if (f.current && Ft.length && S && S.rangeCount > 0) {
      ...
      ut(B.left - G.left), J(B.top - G.top), gt(B.height), nt(!0);
    }
  }, [Ft, f]), yt = U(() => {
  }), se = L(
    (S, B, G) => {
      ...
      ss({
        ...
        restoreSelectionIfLost: () => {
          ...
          if (!(($ = h.current) != null && $.getSelection())) {
            const pt = re.current;
            pt ? (tt = h.current) == null || tt.setSelection(pt) : (lt = h.current) == null || lt.selectNote(0);
          }
        },
        focusEditor: () => {
          var $;
  ...
  Y(() => {
    ...
    if (((G = St.view) == null ? void 0 : G.markerMode) === "editable") {
      const x = ($) => {
        ...
        var tt, lt;
        const $ = S();
        !$ || document.activeElement !== $ || ht() || ((tt = h.current) == null || tt.selectNote(0), (lt = h.current) == null || lt.focus());
      };
    ...
    const S = () => {
      ...
      G && !G.isCollapsed || ht() || ((H = h.current) == null || H.selectNote(0), ($ = h.current) == null || $.focus());
    };
  ...
  return /* @__PURE__ */ u(st, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(st, { children: Uw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Yp({
  ...
  const p = d ?? ic(r, void 0), h = (T, I) => {
    w == null || w(T, I, n);
  }, g = s ? r.findIndex((T) => T === s) : -1, [f, b] = _(g), v = (T, I, E) => {
    if (r.length)
      switch (T.key) {
        case "Enter":
        case " ":
...
function ah({
  ...
  const g = he(r, "%webView_inventory_all%"), f = he(r, "%webView_inventory_approved%"), b = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), R = he(r, "%webView_inventory_scope_currentBook%"), y = he(r, "%webView_inventory_scope_chapter%"), C = he(r, "%webView_inventory_scope_verse%"), T = he(r, "%webView_inventory_filter_text%"), I = he(
    ...
    const J = t ?? [];
    return J.length === 0 ? [] : Zw(J, n, s);
  }, [t, n, s]), D = A(() => {
    if (F) return et;
    const J = [];
    return et.forEach((ct) => {
      const gt = ct.items[0], mt = J.find(
        (vt) => vt.items[0] === gt
      );
      mt ? (mt.count += ct.count, mt.occurrences = mt.occurrences.concat(ct.occurrences)) : J.push({
        items: [gt],
        count: ct.count,
  ...
  const nt = (J, ct) => {
    ...
    const J = D.filter((ct) => sc(
      F ? ct.items : [ct.items[0]],
      Q
    ));
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(ur, { onValueChange: (J) => ot(J), defaultValue: i, children: [
...
function eu({
  ...
  const [l, d] = Gt.useState(t), w = e ?? l, p = Gt.useCallback(
    ...
    [r, w]
  ), h = Gt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", v = be() === "ltr" ? i : i === "primary" ? "secondary" : "primary", R = Gt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function cu({
  ...
  const c = t ? $r.Root : "button", { state: l } = ga(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: m(su({ variant: r, size: o }), s),
      ...i
    }
  );
...
function mu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
    ...
    () => Object.values(Et).filter(
      (N) => (s == null ? void 0 : s[N]) !== void 0 && ho(E, N).length === 0
...
function xu({
  ...
  const i = ho(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    X,
    {
      variant: "outline",
      size: "sm",
...
function xh({
  ...
  const I = zt(
    i,
    "%webView_scope_selector_selected_text%"
  ), E = zt(i, "%webView_scope_selector_verse%"), F = zt(i, "%webView_scope_selector_chapter%"), O = zt(i, "%webView_scope_selector_book%"), z = zt(
    i,
    "%webView_scope_selector_current_verse%"
  ), K = zt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), W = zt(i, "%webView_scope_selector_current_book%"), j = zt(i, "%webView_scope_selector_choose_books%"), Q = zt(i, "%webView_scope_selector_scope%"), N = zt(i, "%webView_scope_selector_select_books%"), et = zt(i, "%webView_scope_selector_range%"), D = zt(i, "%webView_scope_selector_select_range%"), M = zt(i, "%webView_scope_selector_range_start%"), q = zt(i, "%webView_scope_selector_range_end%"), nt = zt(i, "%webView_scope_selector_ok%"), ot = zt(i, "%webView_scope_selector_cancel%"), ut = zt(i, "%webView_scope_selector_navigate%"), jt = (V) => {
    if (!b) return;
  ...
  ], ct = (V, Z, dt = !1) => /* @__PURE__ */ u(st, { children: [
    V,
    Z && !dt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), gt = e ? J.filter((V) => e.includes(V.value)) : J, mt = b ?? Ta, vt = p ?? mt, _t = h ?? mt, ft = () => {
  }, Bt = U(null), re = U(null), St = U(!1), Ft = U(null), ht = U(!1), [Yt, xt] = _(void 0), Nt = U(!1), At = U(!1), Xt = U(null), we = L((V) => {
    if (V) {
    ...
    xt((Z) => Z === "start" ? void 0 : Z), Nt.current && (Nt.current = !1, requestAnimationFrame(() => {
      var dt;
      const Z = (dt = Bt.current) == null ? void 0 : dt.querySelector("button");
      Z == null || Z.click();
    }));
  }, []), Jt = L((V) => {
    if (V) {
    ...
    [r, n, b, s]
  ), Ut = gt.find((V) => V.value === t), yt = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? cc(vt, _t, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Ut ? ct(Ut.label, Ut.scrRefSuffix) : t, se = gt.filter(
    (V) => V.value !== "selectedBooks" && V.value !== "range"
  ), Zt = gt.find((V) => V.value === "selectedBooks"), Kt = gt.find((V) => V.value === "range"), [ue, ke] = _(!1), [S, B] = _(void 0), [G, x] = _(void 0), [H, $] = _(void 0), [tt, lt] = _(void 0), [pt, Ct] = _([]), Rt = w === "dropdown" && S === "selectedBooks", Vt = /* @__PURE__ */ a(
    yu,
    {
      availableBookInfo: o,
      selectedBookIds: Rt ? pt : n,
      onChangeSelectedBookIds: Rt ? Ct : s,
      localizedStrings: i,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), ae = Yt === "end", Pr = Yt === "start", qe = "tw:text-muted-foreground", ze = w === "dropdown" && S === "range", Ar = ze ? $ : Re, ma = ze ? lt : f ? oe : ft, Vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const k = L(
    (V) => {
      x(V), $(vt), lt(_t), Ct(n), ke(!1), B(V);
    },
    [vt, _t, n]
  ), rt = L(() => {
    G !== void 0 && (G === "range" ? (H && (g == null || g(H)), tt && (f == null || f(tt))) : G === "selectedBooks" && s(pt), P(G), B(void 0), x(void 0));
  }, [
    G,
    H,
    tt,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Fe, { open: ue, onOpenChange: ke, children: [
        ...
        /* @__PURE__ */ a(
          Ke,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: ar, children: [
              se.map(({ value: V, label: Z, dropdownLabel: dt, scrRefSuffix: bt, id: Lt }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: rr(V),
                ...
                /* @__PURE__ */ a(
                  Je,
                  {
                    ...
                    onSelect: (V) => {
                      ...
                      ht.current || (dt = (Z = re.current) == null ? void 0 : Z.querySelector("button")) == null || dt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
        ...
        so,
        {
          ...
          children: gt.map(({ value: V, label: Z, scrRefSuffix: dt, id: bt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: V, id: bt }),
            /* @__PURE__ */ a(Tt, { htmlFor: bt, children: ct(Z, dt) })
          ] }, bt))
        }
      )
    ] }),
...
function yh({
  ...
  return /* @__PURE__ */ u(
    ur,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(hr, { size: n, className: m("pr-twp tw:w-auto", s), children: /* @__PURE__ */ a(
          pr,
          {
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Ot, { children: [
...
function no({
  ...
  return /* @__PURE__ */ u(Fe, { variant: s, children: [
    /* @__PURE__ */ a(Ue, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(X, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(Ys, {}) }) }),
...
const kr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    const c = e.filter((d) => d.group === s).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ot, { children: [
    ...
    return c.length > 0 && i < n.length - 1 && l.push(/* @__PURE__ */ a(Iu, {}, `separator-${s}`)), l;
  });
};
function Vu({
  menuData: t,
  ...
  if (El(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (f = s.current) == null || f.focus(), kr(s, [h, g]);
        break;
      case "alt+l":
        (b = i.current) == null || b.focus(), kr(i, [h, g]);
        break;
      case "alt+n":
...
function Mh({
  ...
  return /* @__PURE__ */ u(je, { id: s, className: m("pr-twp", n), shouldFilter: !1, children: [
...
function Ih({
  ...
  const c = t ? Lo(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Ku(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
...
const Yu = (t, e, r = {}) => {
  ...
  const [e, r] = _(!1), [o, n] = _(!1), [s, i] = _(0), c = U(void 0), l = A(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
