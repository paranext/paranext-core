...
var Ai = (t, e, r) => e in t ? Ri(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Rt = (t, e, r) => Ai(t, typeof e != "symbol" ? e + "" : e, r);
import { r as jt, Z as Pi, B as U, c as f, a as Ii, C as Ne, P as Ce, b as Re, d as Ee, e as Ae, f as Pe, g as pe, h as _r, i as ta, T as te, S as Qe, j as ee, k as re, l as ae, D as Ge, m as br, n as Ie, o as Ve, p as Le, u as Vi, q as Nr, s as He, t as Oe, v as za, w as nn, x as Li, y as Fi, z as sn, A as cn, E as ji, F as Bi, G as Ui, H as Ki, I as da, J as wa, K as ir, L as qi, M as Gi, N as Hi, O as Yi, Q as Wi, R as Cr, U as Ga } from "./resizable-CnUlSkqn.js";
import { V as Bh, W as Uh, X as Kh, Y as qh, _ as Gh, $ as Hh, a0 as Yh, a1 as Wh, a2 as Xh } from "./resizable-CnUlSkqn.js";
import { jsx as a, jsxs as u, Fragment as tt } from "react/jsx-runtime";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as Rr, Section as Z, getChaptersForBook as Xi, formatScrRef as ye, getSectionForBook as fr, formatRelativeDate as Ji, formatReplacementString as xe, sanitizeHtml as Zi, NumberFormat as Qi, formatBytes as ts, getCurrentLocale as es, usfmMarkers as Fr, getFormatCallerFunction as rs, deepEqual as as, isString as mo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as os, getLocalizeKeyForScrollGroupId as vo } from "platform-bible-utils";
import { Check as $e, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronLeft as Da, ChevronRight as Oa, ArrowLeft as ns, ArrowRight as is, ChevronDown as tr, BoldIcon as ss, ItalicIcon as cs, X as ea, AtSign as ln, Pencil as ls, Trash2 as ds, ArrowUp as dn, MoreHorizontal as ws, MailOpen as us, Mail as ps, ChevronUp as hs, FilterIcon as gs, ArrowLeftIcon as fs, ChevronLeftIcon as ms, ChevronRightIcon as vs, ArrowRightIcon as bs, Copy as wn, Filter as xs, User as ys, Link as ks, CircleHelp as _s, ChevronsUpDown as un, Star as Ns, Undo as Cs, Redo as Es, SquareX as pn, FunctionSquare as hn, SquareSigma as gn, Ban as Ts, AlertCircle as $a, CircleCheckIcon as zs, CircleXIcon as Ss, CircleHelpIcon as Ds, ArrowUpIcon as Os, ArrowDownIcon as $s, Search as Ms, LoaderCircle as Rs, ScrollText as As, MenuIcon as Ps, Menu as Is, EllipsisVertical as Vs, MoreVertical as Ls } from "lucide-react";
import ut, { useRef as q, useMemo as F, useState as C, useCallback as L, useEffect as Y, useLayoutEffect as Xt, createContext as Ha, useContext as fn, Component as Fs, createElement as ko, Suspense as js, forwardRef as ra, Fragment as mn } from "react";
import { Dialog as he, Label as Bs, RadioGroup as Ma, ToggleGroup as vn, Slot as sr, Avatar as Ya, Select as Pt, Checkbox as _o, Tabs as le, Menubar as me, ContextMenu as St, Progress as No, Slider as Ar, Switch as Co } from "radix-ui";
import { createEditor as bn, $getRoot as Me, $createParagraphNode as Er, $getSelection as Ft, HISTORY_MERGE_TAG as Wa, ParagraphNode as xn, TextNode as yn, $getPreviousSelection as Us, $isRangeSelection as ge, $caretFromPoint as Ks, $getSiblingCaret as kn, $getChildCaret as qs, $getAdjacentChildCaret as Gs, $isChildCaret as Hs, $normalizeCaret as Ys, $setSelectionFromCaretRange as Ws, $getCollapsedCaretRange as Xs, $getCaretInDirection as Eo, $splitAtPointCaretNext as Js, $isTextPointCaret as Zs, $findMatchingParent as _n, $isElementNode as xr, mergeRegister as _e, getDOMTextNode as Qs, isHTMLElement as tc, CLEAR_EDITOR_COMMAND as Nn, COMMAND_PRIORITY_EDITOR as Xa, shallowMergeConfig as ec, defineExtension as oe, safeCast as Ye, createState as rc, FORMAT_TEXT_COMMAND as Cn, $isNodeSelection as En, COMMAND_PRIORITY_LOW as Tn, RootNode as ac, LineBreakNode as oc, TabNode as nc, $isEditorState as ic, createCommand as sc, CLICK_COMMAND as cc, isDOMNode as lc, $getNodeFromDOMNode as dc, $createNodeSelection as wc, $setSelection as uc, $getEditor as pc, DecoratorNode as Ra, $getState as hc, toggleTextFormatType as To, TEXT_TYPE_TO_FORMAT as gc, $setState as fc, addClassNamesToElement as zn, $create as mc, $getNodeByKey as vc, removeClassNamesFromElement as bc, KEY_TAB_COMMAND as xc, $isBlockElementNode as yc, $createRangeSelection as kc, $normalizeSelection__EXPERIMENTAL as _c, OUTDENT_CONTENT_COMMAND as Nc, INDENT_CONTENT_COMMAND as zo, INSERT_TAB_COMMAND as Cc, COMMAND_PRIORITY_CRITICAL as Ja, $isDecoratorNode as Ec, $isParagraphNode as Tc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Sn, $insertNodes as zc } from "lexical";
...
import { IconX as Rc, IconCheck as aa, IconChevronDown as Ac, IconChevronUp as Pc, IconSelector as Ic, IconLayoutSidebar as Vc, IconLayoutSidebarRight as Lc, IconChevronRight as Dn, IconLoader as Fc, IconAlertOctagon as jc, IconAlertTriangle as Bc, IconInfoCircle as Uc, IconCircleCheck as Kc } from "@tabler/icons-react";
import { $isTableSelection as qc } from "@lexical/table";
import { cva as Tr } from "class-variance-authority";
import { createHeadlessEditor as On } from "@lexical/headless";
import { $generateHtmlFromNodes as Gc, $generateNodesFromDOM as Hc } from "@lexical/html";
import { useReactTable as $n, getFilteredRowModel as Yc, getSortedRowModel as Mn, getPaginationRowModel as Wc, getCoreRowModel as Rn, flexRender as mr, getGroupedRowModel as Xc, getExpandedRowModel as Jc } from "@tanstack/react-table";
...
const Pn = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), se = Object.fromEntries(
  Pn.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function Qa(t, e, r) {
...
function sl({
  ...
  const [g, h] = C(!1), m = w !== void 0, x = m ? w : g, v = (k) => {
    m || h(k), p == null || p(k);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Ce, { open: x, onOpenChange: v, children: [
    ...
    /* @__PURE__ */ a(Ee, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Pe, { children: /* @__PURE__ */ a(pe, { heading: i, children: t.map((k) => /* @__PURE__ */ u(
      Ne,
      {
        onSelect: () => E(k),
      ...
      if (s) {
        ...
        if (!w && d) {
          const h = ((m) => Object.keys(se).find(
            (x) => se[x].toLowerCase() === m.toLowerCase()
          ))(c);
...
function ga({
  ...
  const k = jt(), [_, N] = C(!1), [I, j] = C(""), [V, $] = C(""), [y, z] = C("books"), [A, D] = C(void 0), [O, W] = C(
    void 0
  ), [K, M] = C(void 0), [Q, mt] = C(!1), ct = q(null), Bt = q(!1), bt = q(void 0), Dt = q(void 0), B = q(void 0), rt = q(void 0), ot = q({}), nt = q({}), it = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const Vt = L(() => {
    ...
    (b) => {
      const G = O ?? (S == null ? void 0 : S.book), J = K ?? (S == null ? void 0 : S.chapterNum);
      !G || !J || (it({
        book: G,
        chapterNum: J,
        verseNum: b
    ...
    const b = O;
    W(void 0), M(void 0), b ? (D(b), z("chapters"), j("")) : Ht();
  }, [O, Ht]), H = L((b) => {
    N(b), b && (z("books"), D(void 0), W(void 0), M(void 0), $(""));
    ...
    (b) => {
      var Jt, We, ur;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: J } = Oo(b.key);
      ...
      if (y === "verses" && Et) {
        ...
        Yt !== ft && (b.preventDefault(), b.stopPropagation(), j(
          `${Mt} ${se[Mt] || ""} ${_t}:${Yt}`
        ), setTimeout(() => {
      ...
      if ((y === "chapters" || y === "books" && S) && Et) {
        const Mt = y === "chapters" ? A : S == null ? void 0 : S.book;
        if (!Mt) return;
        ...
        ft !== _t && (b.preventDefault(), b.stopPropagation(), j(
          `${Mt} ${se[Mt] || ""} ${ft}`
        ), setTimeout(() => {
    ...
    const { isLetter: G, isDigit: J } = Oo(b.key);
    (G || J) && (b.preventDefault(), $((Jt) => Jt + b.key), Dt.current.focus(), mt(!1));
  }, []);
  return Xt(() => {
    const b = setTimeout(() => {
      if (_ && y === "books" && B.current && rt.current) {
        const G = B.current, J = rt.current, Et = J.offsetTop, Jt = G.clientHeight, We = J.clientHeight, ur = Et - Jt / 2 + We / 2;
        G.scrollTo({
          top: Math.max(0, ur),
          behavior: "smooth"
        }), j(Vn(t.book));
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ce, { open: _, onOpenChange: H, modal: v, children: [
    /* @__PURE__ */ a(Re, { asChild: !0, children: /* @__PURE__ */ a(
      U,
      {
        ref: ct,
    ...
    /* @__PURE__ */ a(
      Ee,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: G } = b;
          _ && ct.current && G instanceof Node && ct.current.contains(G) && (Bt.current = !0, H(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          Ae,
              ...
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  U,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: y === "verses" ? P : Ht,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: k === "ltr" ? /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                y === "chapters" && A && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: De(A, n) }),
                y === "verses" && O && K !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${De(O, n)} ${K}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? dr : Be
                  }
                )
              ] }),
              !Q && /* @__PURE__ */ u(Pe, { ref: B, children: [
                y === "books" && /* @__PURE__ */ u(tt, { children: [
                  ...
                  S && /* @__PURE__ */ a(pe, { children: /* @__PURE__ */ a(
                    Ne,
                    {
                      value: `${S.book} ${se[S.book]} ${S.chapterNum || ""}:${S.verseNum || ""})}`,
                      onSelect: Vt,
                      disabled: !!w && ha(
                        S.book,
                        S.chapterNum ?? 1,
                  ...
                  S && kt && S.chapterNum && l && /* @__PURE__ */ u(tt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${De(S.book, n)} ${S.chapterNum}` }),
                  ...
                  S && !kt && ue(S.book) > 1 && /* @__PURE__ */ u(tt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: De(S.book, n) }),
                ...
                y === "chapters" && A && /* @__PURE__ */ a(
                  $o,
                  {
                    ...
                    onChapterSelect: $t,
                    setChapterRef: T,
                    isChapterDisabled: ze(A),
                    className: "tw:p-4"
                  }
                ),
                y === "verses" && O && K !== void 0 && l && /* @__PURE__ */ a(
                  Mo,
                  {
                    bookId: O,
                    chapterNum: K,
...
function Ro({
  ...
  const [_, N] = C(!1), I = l ?? d, j = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, y) => {
    const z = d($), A = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, D = `${y ?? ""}${z}${A ?? ""}`;
    return /* @__PURE__ */ u(
      Ne,
      {
        value: z,
  ...
  return /* @__PURE__ */ u(Ce, { open: _, onOpenChange: N, ...k, children: [
    ...
    /* @__PURE__ */ a(
      Ee,
      {
        ...
        children: /* @__PURE__ */ u(Ae, { children: [
          ...
          /* @__PURE__ */ a(Pe, { children: j(e) ? e.map(($) => /* @__PURE__ */ a(pe, { heading: $.groupHeading, children: $.options.map((y) => V(y, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(pe, { children: e.map(($) => V($)) }) })
        ] })
      }
    )
  ] });
...
function qu({
  ...
  const w = fa(l, "%webView_bookSelector_currentBook%"), p = fa(l, "%webView_bookSelector_choose%"), g = fa(l, "%webView_bookSelector_chooseBooks%"), [h, m] = C(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    m(v), t(v);
...
const Bn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Bn ? Xt : Y, Ir = { tag: Wa };
function ml({ initialConfig: t, children: e }) {
  const r = F(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = gl(null, o), w = bn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
        if (g === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            const m = Er();
            h.append(m);
            const x = Bn ? document.activeElement : null;
            (Ft() !== null || x !== null && x === p.getRootElement()) && m.select();
          }
        }, Ir);
...
const Nl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function Cl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function El() {
  return function(t) {
    const [e] = ve(), r = F(() => t(e), [e, t]), [o, n] = C(() => r.initialValueFn()), i = q(o);
    return Nl(() => {
...
const Un = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zl = Un && "documentMode" in document ? document.documentMode : null;
!(!Un || !("InputEvent" in window) || zl) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
...
function Dl(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < h.length; E++) {
      const k = h[E], _ = s[E] || document.createElement("div"), N = _.style;
      N.position !== "absolute" && (N.position = "absolute", v = !0);
      const I = we(k.left - p);
      N.left !== I && (N.left = I, v = !0);
      const j = we(k.top - g);
      N.top !== j && (_.style.top = j, v = !0);
      const V = we(k.width);
      N.width !== V && (_.style.width = V, v = !0);
      const $ = we(k.height);
      N.height !== $ && (_.style.height = $, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[E] = _;
    }
...
function $l(t, e = Ol) {
  ...
  function l(w) {
    w.read(() => {
      ...
      const [g, h] = function($) {
        const y = $.getStartEndPoints();
        return $.isBackward() ? [y[1], y[0]] : y;
      }(p), m = g.getNode(), x = m.getKey(), v = g.offset, E = h.getNode(), k = E.getKey(), _ = h.offset, N = t.getElementByKey(x), I = t.getElementByKey(k), j = r === null || N !== o || v !== n || x !== r.getKey(), V = i === null || I !== s || _ !== c || k !== i.getKey();
      if ((j || V) && N !== null && I !== null) {
        const $ = function(y, z, A, D, O, W, K) {
          const M = (y._window ? y._window.document : document).createRange();
          return M.setStart(...Ao(z, A, D)), M.setEnd(...Ao(O, W, K)), M;
        }(t, g, m, N, h, E, I);
        d(), d = Dl(t, $, e);
      }
      r = m, o = N, n = v, i = E, s = I, c = _;
    });
  }
  return l(t.getEditorState()), _e(t.registerUpdateListener(({ editorState: w }) => l(w)), () => {
    d();
  });
}
function Ml(t, e) {
...
function Rl(t) {
  const e = _n(t, (r) => xr(r) && !r.isInline());
  return xr(e) || Hr(4, t.__key), e;
}
function Al(t) {
  const e = Ft() || Us();
  let r;
  if (ge(e)) r = Ks(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = kn(c, "next"));
    }
    r = r || qs(Me(), "previous").getFlipped().insert(Er());
  }
...
function Pl(t, e, r) {
  ...
  return Zs(o) && Hr(283), o.insert(t.isInline() ? Er().append(t) : t), Eo(kn(t.getLatest(), "next"), e.direction);
}
function Il(t) {
  const e = Ft();
  if (!ge(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = _n(i, (l) => xr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Yr, ke = 0, Wr = 0, Fl = 0, Ba = 0, Br = 0;
function Io(t) {
  if (et === void 0) return;
  let e = t.n;
...
function ro(t) {
  ...
  t.x = void 0, t.s = void 0, Gn(t);
}
function Bl(t) {
  if (et !== this) throw new Error("Out-of-order effect");
  qn(this), et = t, this.f &= -2, 8 & this.f && ro(this), oa();
}
function Je(t, e) {
...
At.prototype.brand = Vl, At.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ke !== 0 && Wr === 0 && e.l !== Ba && (e.l = Ba, Yr = { S: e, v: e.v, i: e.i, o: Yr });
  ...
  if (this.g = Br, this.f |= 1, this.i > 0 && !Kn(this)) return this.f &= -2, !0;
  const t = et;
  try {
    Vo(this), et = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Gn(this), Vo(this), ke++;
  const t = et;
  return et = this, Bl.bind(this, t);
...
oe({ build: (t, e, r) => cr(e), config: Ye({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Hn() {
  const t = Me(), e = Ft(), r = Er();
  t.clear(), t.append(r), e !== null && r.select(), ge(e) && (e.format = 0);
}
function Yn(t, e = Hn) {
  return t.registerCommand(Nn, (r) => (t.update(e), !0), Xa);
}
oe({ build: (t, e, r) => cr(e), config: Ye({ $onClear: Hn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return fe(() => Yn(t, o.value));
} });
function Ul(t) {
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [Wn], register: (t, e, r) => t.registerCommand(Cn, (o) => {
  const n = Ft();
  if (En(n) || ge(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, Tn) });
function Xn(t, e) {
  let r;
...
const Ua = oe({ build: (t) => Xn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function Jn(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = Jn(r[n], o[n]);
    return t;
  }
  return e;
}
const ao = 0, Ka = 1, Zn = 2, ba = 3, Vr = 4, Xe = 5, xa = 6, hr = 7;
function ya(t) {
  return t.id === ao;
}
function Qn(t) {
...
function ql(t) {
  return function(e) {
    return e.id === Ka;
  }(t) || lt(305, String(t.id), String(Ka)), Object.assign(t, { id: Zn });
}
...
class Hl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Vr && lt(307, String(r.id), String(Xe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== Xe && lt(308, String(o.id), String(Xe));
...
const Wl = oe({ config: Ye({ setOptions: Lo, updateOptions: Lo }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ac, yn, oc, nc, xn] }), Fo = Symbol.for("@lexical/extension/LexicalBuilder");
function jo() {
}
function Xl(t) {
  throw t;
...
class Ze {
  ...
  static maybeFromEditor(e) {
    const r = e[Fo];
    return r && (r.PACKAGE_VERSION !== ka && lt(292, r.PACKAGE_VERSION, ka), r instanceof Ze || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ya(i) || lt(300, s, n || "[unknown]"), ya(c = i) || lt(304, String(c.id), String(ao)), i = Object.assign(c, { id: Ka }), o.state = i;
...
const Jl = /* @__PURE__ */ new Set(), Bo = oe({ build(t, e, r) {
  const o = r.getDependency(Ua).output, n = yr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Xn(() => {
  }, () => fe(() => {
...
oe({ dependencies: [Ua, Bo], name: "@lexical/extension/HorizontalRule", nodes: () => [er], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Bo).output, n = yr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return _e(t.registerCommand(Zl, (s) => {
    const c = Ft();
    if (!ge(c)) return !1;
    ...
    if (lc(s.target)) {
      ...
      if (td(c)) return function(d, l = !1) {
        ...
        let h;
        l && En(w) ? h = w : (h = wc(), uc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Tn), t.registerMutationListener(er, (s, c) => {
    Ll(() => {
      let d = !1;
    ...
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(fe(() => {
      const l = c.value;
      l && (d.value ? zn(l, i) : bc(l, i));
    }));
    return _e(...s);
  }));
} });
oe({ build: (t, e) => cr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ye({ $getParentEditor: function() {
  const t = pc();
...
oe({ build: (t, e, r) => cr(e), config: Ye({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return fe(() => {
...
function ed(t, e, r = ti) {
  return _e(t.registerCommand(xc, (o) => {
    const n = Ft();
    if (!ge(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => yc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Rl(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = kc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = _c(h), h.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Nc : zo : Cc;
    return t.dispatchCommand(i, void 0);
  }, Xa), t.registerCommand(zo, () => {
...
oe({ build: (t, e, r) => cr(e), config: Ye({ $canIndent: ti, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return fe(() => {
    if (!o.value) return ed(t, n, i);
  });
} });
const rd = oe({ name: "@lexical/react/ReactProvider" });
function ad() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(m)) {
                ...
                if (Aa(v) && l >= 0 && w >= 0 && (E = l, k = l + w, m.setTextNodeRange(v, E, v, k)), E === k && p === "" || (m.insertRawText(p), v = x.getNode()), Aa(v)) {
                  E = g, k = g + h;
...
oe({ build: (t, e, r) => cr(e), config: Ye({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => fe(() => r.getOutput().disabled.value ? void 0 : ri(t)) });
function id(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const no = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
...
function ld({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    no(() => _e(Oc(n), ri(n)), [n]);
  }(o), u(tt, { children: [t, a(dd, { content: e }), a(cd, { editor: o, ErrorBoundary: r })] });
}
...
function md(t, e) {
  ...
  return u(tt, { children: [a(gd, { editor: n, ...o, ref: e }), r != null && a(vd, { editor: n, content: r })] });
}
function vd({ content: t, editor: e }) {
  const r = function(s) {
    ...
    return ai(() => {
      ...
      return l(), _e(s.registerUpdateListener(() => {
        l();
...
function xd({
  ...
  return /* @__PURE__ */ a(oi.Provider, { value: s, children: i });
}
function ni() {
  const t = fn(oi);
  if (!t)
...
function kd({
  ...
  const [e] = ve(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = yd(), d = () => {
  };
...
function Cd() {
  const { activeEditor: t } = ni(), [e, r] = C([]), o = L((n) => {
    if (ge(n) || qc(n)) {
      const i = [];
      qo.forEach(({ format: s }) => {
...
function ui({
  ...
  const s = Go(o, "%cancelButton_tooltip%"), c = i ?? Go(o, "%acceptButton_tooltip%");
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
        U,
        {
          "aria-label": s,
...
function Hu({
  ...
  const [i, s] = C(Od), [c, d] = C(n), [l, w] = C(!1), p = q(void 0), g = q(null);
  Y(() => {
    let v = !0;
    const E = g.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ce, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(Re, { asChild: !0, children: /* @__PURE__ */ u(
        U,
        {
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ a(ln, { className: "tw:h-4 tw:w-4" }),
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : co(v) && (v.preventDefault(), v.stopPropagation(), Zt(i) && h());
        },
        onKeyDown: (v) => {
...
function Ho({
  ...
  const h = L(
    ...
    [t.user]
  ), k = F(() => Zi(t.contents), [t.contents]), _ = F(() => {
    if (o && c)
      return /* @__PURE__ */ u(tt, { children: [
        /* @__PURE__ */ u(
          Ge,
          {
            onClick: (N) => {
              N.stopPropagation(), l(!0), p(Sd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Rd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ad, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), h()) : co(N) && (N.preventDefault(), N.stopPropagation(), Zt(w) && m());
              },
              onKeyDown: (N) => {
        ...
        _ && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ws, {}) }) }),
...
function Pd({
  ...
  const [$, y] = C(Yo), [z, A] = C(), [D, O] = C(), W = o, [K, M] = C(!1), [Q, mt] = C(!1), [ct, Bt] = C(!1), [bt, Dt] = C(!1), [B, rt] = C(!1), [ot, nt] = C(N), [it, It] = C(!1), vt = q(void 0), [Ut, Kt] = C(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  Y(() => {
    if (!o) {
      S.current !== "idle" && (A(void 0), O(void 0), S.current = "idle");
      return;
    }
    S.current === "idle" && (S.current = "pending"), bt ? S.current === "pending" && V !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    V !== i && (A(V), S.current = "auto-populated") : S.current === "auto-populated" && (A(void 0), S.current = "pending");
  }, [o, V, bt, i]);
  ...
  const Vt = F(() => Ot[0], [Ot]), ne = q(null), qt = q(void 0), $t = L(() => {
    var T;
    (T = qt.current) == null || T.call(qt), y(Yo);
  }, []), Te = L(() => {
    const T = !ot;
    nt(T), It(!T), m == null || m(d, T);
  }, [ot, m, d]);
  Y(() => {
    M(!1);
  }, [o]), Y(() => {
  ...
  }, [i, r]), P = F(() => Ot.slice(1), [Ot]), H = F(() => P.length ?? 0, [P.length]), st = F(() => H > 0, [H]), at = F(() => K || H <= 2 ? P : P.slice(-2), [P, H, K]), ht = F(() => K || H <= 2 ? 0 : H - 2, [H, K]), xt = F(
  ...
  const gt = L(
    ...
    async (T) => {
      const wt = Zt($) ? Jr($) : void 0, pt = T.status ? T.assignedUser : z ?? T.assignedUser, kt = await p({
        ...T,
        contents: wt,
        assignedUser: pt
      });
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                U,
                {
                  ...
                  children: ot ? /* @__PURE__ */ a(us, {}) : /* @__PURE__ */ a(ps, {})
                }
              ),
            ...
            o && /* @__PURE__ */ u(tt, { children: [
              ht > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (T) => {
                    (T.key === "Enter" || T.key === " ") && (T.preventDefault(), T.stopPropagation(), M(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Qe, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: yt }),
                      K ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(tr, {})
                    ] })
                  ]
                }
              ),
              ...
              v !== !1 && (!Q || Zt($)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (T) => {
                    co(T) && (T.preventDefault(), T.stopPropagation(), (Zt($) || z !== void 0 && z !== D) && gt());
                  },
                  onKeyDown: (T) => {
                    io(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Xr,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && (Zt($) || z !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: xe(
                      ...
                      /* @__PURE__ */ u(Ce, { open: ct, onOpenChange: Bt, children: [
                        /* @__PURE__ */ a(Re, { asChild: !0, children: /* @__PURE__ */ a(
                          U,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ a(
                          Ee,
                          {
                            ...
                            children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Pe, { children: x == null ? void 0 : x.map((T) => /* @__PURE__ */ a(
                              Ne,
                              {
                                onSelect: () => {
                                  A(T !== i ? T : void 0), S.current = "user-selected", O(void 0), Bt(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function ep({
  ...
  const [E, k] = C(/* @__PURE__ */ new Set()), [_, N] = C(), [I, j] = C(), V = L(
    async (M) => {
      const Q = await i(M);
      return Q !== void 0 && M.assignedUser !== void 0 && M.assignedUser !== "" && j(M.assignedUser), Q;
    },
    [i]
  );
  Y(() => {
    m && (k((M) => new Set(M).add(m)), N(m));
  }, [m]);
  const $ = r.filter(
    (M) => M.comments.some((Q) => !Q.deleted)
  ), y = $.map((M) => ({ id: M.id })), z = L(
    (M) => {
      k((Q) => new Set(Q).add(M.id)), N(M.id), x == null || x(M.id);
    },
    [x]
  ), A = L(
    (M) => {
      ...
      }), N(M), x == null || x(Q ? void 0 : M);
    },
    [E, x]
  ), { listboxRef: D, activeId: O, handleKeyDown: W } = Vi({
    options: y,
    onOptionSelect: z
  }), K = L(
    (M) => {
      M.key === "Escape" ? (_ && E.has(_) && (k((Q) => {
        const mt = new Set(Q);
        return mt.delete(_), mt;
      }), N(void 0), x == null || x(void 0)), M.preventDefault(), M.stopPropagation()) : W(M);
    },
    [_, E, W, x]
  );
  return /* @__PURE__ */ a(
...
function Id({ table: t }) {
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      ...
      /* @__PURE__ */ u(
        rr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(nr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ie, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Gd({
  ...
  var j;
  const [w, p] = C([]), [g, h] = C([]), [m, x] = C({}), [v, E] = C({}), k = F(() => e ?? [], [e]), _ = $n({
    data: k,
    columns: t,
    getCoreRowModel: Rn(),
  ...
  let I;
  return d ? I = Array.from({ length: 10 }).map((y, z) => `skeleton-row-${z}`).map((y) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((j = _.getRowModel().rows) == null ? void 0 : j.length) > 0 ? I = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ce,
    {
      onClick: () => s(V, _),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map(($) => /* @__PURE__ */ a(Qt, { children: mr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    V.id
  )) : I = /* @__PURE__ */ a(ce, { children: /* @__PURE__ */ a(Qt, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Id, { table: _ }),
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(lo, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map(($) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : mr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(U, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(wn, {}) })
        ] }),
...
function cp({
  ...
  return /* @__PURE__ */ u(Ce, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Ee, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
...
function lp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "default", children: [
      /* @__PURE__ */ a(xs, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(tr, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Le, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Nr, { children: l.label }),
      /* @__PURE__ */ a(nn, { children: l.itemType === 0 ? /* @__PURE__ */ a(tt, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][g],
...
function pi({
  ...
  const [E, k] = C(!1), _ = L(
    (z) => {
      var D;
      const A = (D = t.find((O) => O.label === z)) == null ? void 0 : D.value;
      A && r(
    ...
    if (!g) return t;
    const z = t.filter((D) => D.starred).sort((D, O) => D.label.localeCompare(O.label)), A = t.filter((D) => !D.starred).sort((D, O) => {
      const W = e.includes(D.value), K = e.includes(O.value);
      return W && !K ? -1 : !W && K ? 1 : D.label.localeCompare(O.label);
    });
    return [...z, ...A];
  }, [t, e, g]), j = () => {
    r(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Ce, { open: $, onOpenChange: w ?? k, children: [
    /* @__PURE__ */ a(Re, { asChild: !0, children: /* @__PURE__ */ u(
      U,
      {
        variant: x,
        ...
        children: [
          ...
          /* @__PURE__ */ a(un, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(Ee, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ae, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: j, children: i }),
        ...
        /* @__PURE__ */ a(pe, { children: I.map((z) => /* @__PURE__ */ u(
          Ne,
          {
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Ns, { className: "tw:h-4 tw:w-4" }),
...
function Zd({
  ...
  const d = F(() => /Macintosh/i.test(navigator.userAgent), []), l = Zo(n, "%undoButton_tooltip%"), w = Zo(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
        U,
      ...
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ u("p", { children: [
        l,
        i && /* @__PURE__ */ u(tt, { children: [
          " ",
          /* @__PURE__ */ a(Jo, { children: d ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(di, {}),
    e && /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
        U,
        {
          "aria-label": w,
      ...
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(tt, { children: [
          " ",
          /* @__PURE__ */ a(Jo, { children: d ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const tw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(tt, { children: [
...
function ew({
  ...
  const m = (v) => {
    ...
    var E, k, _, N;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((N = s.current) == null || N.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Ie, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: tw(t, n, r) }) }) }),
...
const rw = (t, e) => t === "f" ? /* @__PURE__ */ u(tt, { children: [
  /* @__PURE__ */ a(hn, {}),
  " ",
...
function ow({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: rw(t, r) }) }) }),
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: aw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Le, { style: { zIndex: sn }, children: [
...
function sw({
  ...
  const [n, i] = C(""), [s, c] = F(() => {
    ...
    const l = e.filter(
      (p) => {
        var g;
        return (g = p.marker) == null ? void 0 : g.toLowerCase().includes(d);
      }
    ), w = e.filter(
  ...
  return /* @__PURE__ */ u(Ae, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Pe, { children: [
      ...
      c.length > 0 && /* @__PURE__ */ u(tt, { children: [
        s.length > 0 && /* @__PURE__ */ a(cn, { alwaysRender: !0 }),
...
function hp({
  ...
  const [m, x] = C("generated"), [v, E] = C("generated"), [k, _] = C("*"), [N, I] = C("*"), [j, V] = C("f"), [$, y] = C(!1), [z, A] = C(!0), [D, O] = C(!1), W = q(!1), K = q(""), [M, Q] = C(!1), [mt, ct] = C(), [Bt, bt] = C(), [Dt, B] = C(), [rt, ot] = C(), nt = q(null), it = F(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (H && Pr("note", H)) {
      ...
      let xt = "custom";
      ht === Pa ? xt = "generated" : ht === Ia ? xt = "hidden" : ht && (_(ht), I(ht)), x(xt), E(xt), V(((at = H.insert.note) == null ? void 0 : at.style) ?? "f"), P = setTimeout(() => {
        var yt;
  ...
  const vt = L(
    (P, H, st = !1) => {
      ...
      if (at && Pr("note", at)) {
        if (at.insert.note) {
          let gt;
          P === "custom" ? gt = H : P === "generated" ? gt = Pa : gt = Ia, at.insert.note.caller = gt;
        }
  ...
  const Ot = () => {
    ...
    if (H && Pr("note", H)) {
      ...
      j !== "x" && P === "x" ? gt == null || gt.forEach((Ct) => lw(Ct)) : j === "x" && P !== "x" && (gt == null || gt.forEach((Ct) => dw(Ct))), (yt = w.current) == null || yt.applyUpdate([H, { delete: 1 }]);
    }
  }, $t = (P) => {
    ...
    (P) => {
      ...
      if (H && Pr("note", H)) {
        ...
        A(JSON.stringify(H) === K.current), vt(m, k);
      } else
        y(!1), A(!0);
    },
    [m, k, vt]
    ...
    if (g.current && It.length && P && P.rangeCount > 0) {
      ...
      ct(H.left - st.left), bt(H.top - st.top), B(H.height), Q(!0);
    }
  }, [It, g]);
  Y(() => {
    const P = () => {
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
              /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
                U,
                {
                  "aria-label": Ht,
              ...
              /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: Ht }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(tt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(tt, { children: uw(t.marker, c, o, l) })
      }
    )
  ] });
}
function fp({
  ...
  const w = d ?? rs(r, void 0), p = (k, _) => {
    l == null || l(k, _, n);
  }, g = i ? r.findIndex((k) => k === i) : -1, [h, m] = C(g), x = (k, _, N) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
        ...
        "ul",
        {
          ...
          children: r.map((k, _) => {
            ...
            return /* @__PURE__ */ u(tt, { children: [
              ...
              _ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Qe, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function fw({
  ...
  return /* @__PURE__ */ u(na, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(lo, { stickyHeader: !0, children: /* @__PURE__ */ u(ce, { children: [
    ...
    /* @__PURE__ */ a(ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ce,
      {
        ...
        children: [
          /* @__PURE__ */ a(Qt, { children: ye(c.reference, "English") }),
          /* @__PURE__ */ a(Qt, { className: o, children: gw(c.text) })
        ]
      },
...
const mw = (t) => {
...
}, sa = (t, e, r) => /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
  /* @__PURE__ */ u(
    re,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(si, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Ur,
          {
            onClick: (d) => {
  ...
  return e ? e[1] : "";
}, bw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", _p = Object.freeze([
...
function Np({
  ...
  const h = de(r, "%webView_inventory_all%"), m = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), E = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), _ = de(r, "%webView_inventory_scope_verse%"), N = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), j = de(r, "%webView_inventory_no_results%"), [V, $] = C(!1), [y, z] = C("all"), [A, D] = C(""), [O, W] = C([]), K = F(() => {
    const B = t ?? [];
    return B.length === 0 ? [] : yw(B, n, i);
  }, [t, n, i]), M = F(() => {
    if (V) return K;
    const B = [];
    return K.forEach((rt) => {
      const ot = rt.items[0], nt = B.find(
        (it) => it.items[0] === ot
      );
      nt ? (nt.count += rt.count, nt.occurrences = nt.occurrences.concat(rt.occurrences)) : B.push({
        items: [ot],
        count: rt.count,
  ...
  }, [V, K]), Q = F(() => M.length === 0 ? [] : xw(M, y, A), [M, y, A]), mt = F(() => {
    var ot, nt;
    if (!V) return d;
    const B = (ot = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ot.length;
    if (!B) return d;
    const rt = [];
  ...
  const ct = (B, rt) => {
    rt.setRowSelection(() => {
      const nt = {};
      return nt[B.index] = !0, nt;
    });
    const ot = B.original.items;
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(rr, { onValueChange: (B) => Bt(B), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
        /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            gi,
            {
        ...
        /* @__PURE__ */ a(ae, { children: (o == null ? void 0 : o.checkboxText) ?? I })
      ] }) })
    ] }),
...
const fi = ra(({ className: t, ...e }, r) => /* @__PURE__ */ a(Rs, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
fi.displayName = "Spinner";
function kw(t, e = 50) {
...
function Ca({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(tt, { children: [
      /* @__PURE__ */ a(ce, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(Nt, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        ce,
        {
          ...
          children: [
            /* @__PURE__ */ a(Qt, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(tt, { children: [
              /* @__PURE__ */ a($e, { className: "tw:h-3.5 tw:w-3.5", "aria-hidden": !0 }),
...
function Ep({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = F(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: x, hasMore: v } = kw(h), E = F(
    () => Array.from(new Set(t.map((O) => O.bestLanguageName))).map((O) => ({
      label: O,
      value: O
    })),
    [t]
  ), k = p.length === 0 && g.length === 0 && h.length === 0, _ = be(n, "%resourcePicker_title%"), N = be(n, "%resourcePicker_search_placeholder%"), I = be(n, "%resourcePicker_language_filter_any%"), j = be(
    n,
    "%resourcePicker_section_already_selected%"
  ), V = be(n, "%resourcePicker_section_installed%"), $ = be(
    n,
    "%resourcePicker_section_available_to_download%"
  ), y = be(n, "%resourcePicker_no_results%"), z = be(n, "%resourcePicker_showing_count%"), A = F(() => {
    if (d.length === E.length || d.length === 0)
      return I;
    if (d.length === 1) {
      const O = E.find((W) => W.value === d[0]);
      if (O) return O.label;
    }
    return xe(
  ...
  }, [d, E, I, n]), D = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(tt, { children: [
    /* @__PURE__ */ a(qr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Gr, { children: _ }) }),
    ...
    D && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: xe(z, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(fi, {}) }),
      k && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: y }),
      !k && !e && /* @__PURE__ */ a(na, { children: /* @__PURE__ */ u(ia, { children: [
        /* @__PURE__ */ a(Ca, { label: j, resources: p }),
        /* @__PURE__ */ a(Ca, { label: V, resources: g, onSelect: i }),
        /* @__PURE__ */ a(
          Ca,
          {
            label: $,
        ...
        v && /* @__PURE__ */ a(ce, { className: "tw:border-0", children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: x, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const Nw = "16rem", Cw = "3rem", mi = ut.createContext(void 0);
function la() {
  const t = ut.useContext(mi);
  if (!t)
...
function Ew({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), g = ut.useCallback(() => p((_) => !_), [p]), h = w ? "expanded" : "collapsed", v = jt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(mi.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
...
function Mw({
  ...
  const c = t ? sr.Root : "button", { state: d } = la(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f($w({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ u(ee, { children: [
    ...
    Tw,
    {
      ...
      children: /* @__PURE__ */ u(Sw, { children: [
        /* @__PURE__ */ u(tn, { children: [
          ...
          /* @__PURE__ */ a(rn, { children: /* @__PURE__ */ a(Dw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(Ow, { children: /* @__PURE__ */ a(
            Mw,
            {
              onClick: () => l(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ u(tn, { children: [
          ...
          /* @__PURE__ */ a(rn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              className: f(
...
const Se = "scrBook", Aw = "scrRef", qe = "source", Pw = "details", Iw = "Scripture Reference", Vw = "Scripture Book", vi = "Type", Lw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Se ? ye(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: qe,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? vi : void 0,
...
}, an = (t) => `${jw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function jp({
  sources: t,
  ...
  const [l, w] = C([]), [p, g] = C([{ id: Se, desc: !1 }]), [h, m] = C({}), x = F(
  ...
  Y(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const A = x.find((D) => an(D) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [h, x, c, E]);
  const k = n ?? Vw, _ = i ?? vi, N = [
  ...
  }, V = (y, z) => y.getIsGrouped() ? "" : f("banded-row", z % 2 === 0 ? "even" : "odd"), $ = (y, z, A) => {
    ...
    !e && /* @__PURE__ */ u(
      rr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(nr, { position: "item-aligned", children: /* @__PURE__ */ a(Vd, { children: N.map((y) => /* @__PURE__ */ a(ie, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(na, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(lo, { children: E.getHeaderGroups().map((y) => /* @__PURE__ */ a(ce, { children: y.headers.filter((z) => z.column.columnDef.header).map((z) => (
      ...
      /* @__PURE__ */ a(ia, { children: E.getRowModel().rows.map((y, z) => {
        const A = jt();
        return /* @__PURE__ */ a(
          ce,
          {
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      U,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a(Oa, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
...
const xi = (t, e, r) => uo(t, e).every((o) => r.includes(o));
function Bw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: m } = {
  ...
  }, [x, v] = C(!1), [E, k] = C(""), _ = q(void 0), N = q(!1), I = F(
    () => bi(t),
    [t]
  ), j = F(() => {
    if (!E.trim()) {
    ...
    (D, O = !1) => {
      ...
      const W = I.findIndex((ct) => ct === _.current), K = I.findIndex((ct) => ct === D);
      if (W === -1 || K === -1) return;
      const [M, Q] = [
        Math.min(W, K),
        Math.max(W, K)
    ...
    V(D, N.current), N.current = !1;
  }, y = (D, O) => {
    D.preventDefault(), V(O, D.shiftKey);
  }, z = () => {
    r(I.map((D) => D));
  }, A = () => {
    r([]);
          ...
          Ae,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                ...
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: A, children: l })
              ] }),
              /* @__PURE__ */ u(Pe, { children: [
                ...
                Object.values(Z).map((D, O) => {
                  ...
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(mn, { children: [
                      ...
                      O < Object.values(Z).length - 1 && /* @__PURE__ */ a(cn, {})
                    ] }, D);
                })
              ] })
            ]
...
function Kw({
  ...
  const i = o["%webView_book_selector_more%"], s = F(
    ...
    (d) => {
      ...
      r(
        xi(s, d, e) ? e.filter((w) => !l.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...l])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ea ? Ea : on
      ).map((d) => /* @__PURE__ */ a(br, { className: "tw:hover:bg-secondary", variant: "secondary", children: De(d, n) }, d)),
      e.length > Ea && /* @__PURE__ */ a(
        br,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - on} ${i}`
        }
      )
    ] })
  ] });
...
function Up({
  ...
  const N = zt(
  ...
  ], B = (R, X, Lt = !1) => /* @__PURE__ */ u(tt, { children: [
    R,
    X && !Lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), rt = e ? Dt.filter((R) => e.includes(R.value)) : Dt, ot = m ?? pa, nt = w ?? ot, it = p ?? ot, It = () => {
  }, vt = q(null), Ut = q(null), Kt = q(!1), S = q(null), Ot = q(!1), [Vt, ne] = C(void 0), qt = q(!1), $t = q(!1), Te = q(null), Gt = L((R) => {
    if (R) {
    ...
    [r, n, m, i]
  ), at = rt.find((R) => R.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((R) => R.toUpperCase()).join(", ") : t === "range" ? os(nt, it, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : at ? B(at.label, at.scrRefSuffix) : t, xt = rt.filter(
    (R) => R.value !== "selectedBooks" && R.value !== "range"
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, T] = C(!1), [wt, pt] = C(void 0), [kt, je] = C(void 0), [ze, lr] = C(void 0), [Be, dr] = C(void 0), [wr, Sr] = C([]), Dr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    Kw,
    {
      availableBookInfo: o,
  ...
  ), G = Vt === "end", J = Vt === "start", Et = "tw:text-muted-foreground", Jt = l === "dropdown" && wt === "range", We = Jt ? lr : P, Mt = Jt ? dr : h ? H : It, _t = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ga,
        {
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: Jt ? ze ?? nt : nt,
          onOpenChange: Ht,
          onCloseAutoFocus: (R) => {
            var X;
            $t.current && ($t.current = !1, R.preventDefault(), (X = Te.current) == null || X.focus());
          },
          className: f(J && Et),
          modal: !0,
          align: "start"
  ...
  const [Wt, Ue] = C(null), [Or, zi] = C(null), [$r, Si] = C(null), Di = 200, [Oi, $i] = C(!1);
  Y(() => {
    if (!$r || typeof ResizeObserver > "u") return;
    const R = new ResizeObserver(([X]) => {
      $i(X.contentRect.width < Di);
    });
    return R.observe($r), () => R.disconnect();
  }, [$r]);
  const po = L(
    (R) => {
      je(R), lr(nt), dr(it), Sr(n), T(!1), pt(R);
    },
    [nt, it, n]
  ), ho = L(() => {
    kt !== void 0 && (kt === "range" ? (ze && (g == null || g(ze)), Be && (h == null || h(Be))) : kt === "selectedBooks" && i(wr), st(kt), pt(void 0), je(void 0));
  }, [
    kt,
    ze,
    Be,
    ...
    R || (pt(void 0), je(void 0));
  }, []), go = L((R) => {
    var X;
    R.preventDefault(), (X = Yt.current) == null || X.focus();
  }, []), fo = (R) => t === R ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a($e, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Nt, { children: D }),
      l === "dropdown" ? /* @__PURE__ */ u(Ie, { open: Ct, onOpenChange: T, children: [
        ...
        /* @__PURE__ */ a(
          Le,
          {
            ...
            children: /* @__PURE__ */ u(da, { container: $r, children: [
              xt.map(({ value: R, label: X, dropdownLabel: Lt, scrRefSuffix: pr, id: Mi }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: ft(R),
                  ...
                  children: [
                    t === R && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a($e, { className: "tw:h-4 tw:w-4" }) }),
                    B(Lt ?? X, pr, Oi)
                  ]
                },
                Mi
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ga,
                          {
                            ...
                            onCloseAutoFocus: (R) => {
                              var X;
                              R.preventDefault(), (X = S.current) == null || X.focus();
                            },
                            modal: !0,
        ...
        Fn,
        {
          ...
          children: rt.map(({ value: R, label: X, scrRefSuffix: Lt, id: pr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(Nt, { htmlFor: pr, children: B(X, Lt) })
          ] }, pr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && _t,
    l === "dropdown" && yt && /* @__PURE__ */ a(Va, { open: wt === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      La,
      {
        ref: zi,
        onCloseAutoFocus: go,
        ...
        children: /* @__PURE__ */ u(da, { container: Or, children: [
          ...
          /* @__PURE__ */ u(So, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Mr(!1), children: ct }),
            /* @__PURE__ */ a(U, { onClick: ho, children: mt })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(Va, { open: wt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      La,
      {
        ref: Ue,
        onCloseAutoFocus: go,
        ...
        children: /* @__PURE__ */ u(da, { container: Wt, children: [
          ...
          /* @__PURE__ */ u(So, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Mr(!1), children: ct }),
            /* @__PURE__ */ a(U, { ref: Te, onClick: ho, children: mt })
          ] })
        ] })
      }
    ) })
...
function Kp({
  ...
  return /* @__PURE__ */ u(
    rr,
    {
      ...
      children: [
        /* @__PURE__ */ a(or, { size: n, className: f("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          ar,
          {
        ...
        /* @__PURE__ */ a(
          nr,
          {
            ...
            style: { zIndex: ir },
            children: t.map((l) => /* @__PURE__ */ a(ie, { value: `${l}`, children: c[vo(l)] }, `${l}`))
          }
        )
      ]
    }
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(ee, { children: [
  /* @__PURE__ */ a(re, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    Ge,
    {
      onClick: () => {
        o(c);
    ...
    /* @__PURE__ */ a(Hi, { children: /* @__PURE__ */ a(Yi, { children: ki(
      t,
      e,
      yi(t, c.id),
      o
...
function qa({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    /* @__PURE__ */ a(Ve, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ps, {}) }) }),
    /* @__PURE__ */ a(Le, { align: "start", style: { zIndex: ir }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(mn, { children: [
      /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(te, { children: ki(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(He, {})
    ] }, d)) })
  ] });
}
const _i = ut.forwardRef(
...
function Yp({
  ...
  return /* @__PURE__ */ u(_i, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      qa,
      {
        onSelectMenuItem: t,
...
function Wp({
  ...
  return /* @__PURE__ */ a(_i, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    qa,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Ni = ut.forwardRef(({ className: t, ...e }, r) => {
  const o = jt();
  return /* @__PURE__ */ a(
    le.Root,
    {
...
Ni.displayName = le.List.displayName;
const Ci = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.List,
  {
    ref: r,
    className: f(
...
Ci.displayName = le.List.displayName;
const Hw = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Trigger,
  {
    ref: r,
    ...e,
...
)), Ei = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Content,
  {
    ref: r,
    className: f(
...
Ei.displayName = le.Content.displayName;
function Xp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ni, { children: [
      /* @__PURE__ */ a(Ci, { children: t.map((c) => /* @__PURE__ */ a(Hw, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(Ei, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function Yw({
...
const gr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        Qw,
        {
          onClick: () => {
            o(l);
  ...
  if (el(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Yw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Ww, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ir },
          children: /* @__PURE__ */ a(te, { children: Ti(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Qp({
  ...
  const l = nu(
    ...
    var E, k, _, N, I, j;
    const v = x !== m ? ((k = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : k[x]) ?? ((N = (_ = t[m]) == null ? void 0 : _.uiNames) == null ? void 0 : N.en) : void 0;
    return v ? `${(I = t[m]) == null ? void 0 : I.autonym} (${v})` : (j = t[m]) == null ? void 0 : j.autonym;
  };
            ...
            l && (e || g && m) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ie, { children: [
                  /* @__PURE__ */ a(Ve, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    U,
                    {
                  ...
                  /* @__PURE__ */ a(Le, { align: "end", children: l })
                ] })
              }
            )
          ] }),
...
function Rh({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", wu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  sw as MarkerMenu,
  dp as MoreInfo,
  pi as MultiSelectComboBox,
  Xp as NavigationContentSearch,
  Ce as Popover,
  Bi as PopoverAnchor,
  Ee as PopoverContent,
  Uh as PopoverDescription,
  Kh as PopoverHeader,
  da as PopoverPortalContainerProvider,
  qh as PopoverTitle,
  Re as PopoverTrigger,
  Sh as Progress,
  Cp as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  Fn as RadioGroup,
  Fa as RadioGroupItem,
  sl as RecentSearches,
  Gh as ResizableHandle,
  Hh as ResizablePanel,
  Yh as ResizablePanelGroup,
  Ep as ResourcePickerDialog,
  eh as ResultsCard,
  ...
  sn as Z_INDEX_FOOTNOTE_EDITOR,
  Pi as Z_INDEX_MODAL,
  Ii as Z_INDEX_MODAL_BACKDROP,
  Ki as Z_INDEX_OVERLAY,
  Wh as badgeVariants,
