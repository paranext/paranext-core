...
import { c as v, g as Ae, a as Ur, C as tr, L as Hn, t as Ts, u as rn, T as zt, b as Nt, d as Ct, e as Et, f as qn, A as ka, r as re, D as Be, h as Te, i as Fe, j as cr, k as Ge, B as et, x as Ss, l as Rs, m as Ds, I as Os, n as To, o as Xe, p as De, q as Ms, s as Gn, P as lr, v as Rr, w as dr, y as wr, z as Ia, E as za, F as So, G as ur, H as Pa, J as It, R as Ro, K as _a, M as so, N as co, O as lo, Q as wo, S as Wn, U as ha, V as Do, W as Gr, X as Wr, Y as xr, Z as Is, _ as ir, $ as Ze, a0 as je, a1 as We, a2 as yr, a3 as Oo, a4 as Mo, a5 as Na, a6 as Io, a7 as Yn, a8 as zs, a9 as Ps, aa as As, ab as uo, ac as Zn, ad as Aa, ae as $s, af as Xn, ag as Vs, ah as Ls, ai as Bs, aj as an, ak as Fs, al as js, am as Us, an as Ks, ao as Jn, ap as Qn, aq as zo, ar as Hs, as as ti, at as Ha, au as on, av as qa, aw as qs, ax as Gs, ay as Ws, az as Ys, aA as Zs, aB as Xs, aC as Js, aD as Qs, aE as tc, aF as Po, aG as Ao, aH as ec, aI as rc } from "./resizable-0S_3B9Wz.js";
import { aJ as Df, aK as Of, aL as Mf, aM as If, aN as zf, aO as Pf, aP as Af, aQ as $f, aR as Vf, aS as Lf, aT as Bf, aU as Ff, aV as jf, aW as Uf, aX as Kf, aY as Hf, aZ as qf, a_ as Gf, a$ as Wf, b0 as Yf, b1 as Zf, b2 as Xf, b3 as Jf, b4 as Qf, b5 as tm, b6 as em, b7 as rm, b8 as am, b9 as om, ba as nm, bb as im, bc as sm, bd as cm, be as lm, bf as dm, bg as wm, bh as um, bi as pm, bj as hm, bk as gm } from "./resizable-0S_3B9Wz.js";
...
import { Section as Mt, compareScrRefs as Ca, getChaptersForBook as Vc, formatScrRef as $e, formatReplacementString as Ye, getSectionForBook as ga, formatRelativeDate as Lc, sanitizeHtml as $o, NumberFormat as li, formatBytes as Bc, getCurrentLocale as Fc, usfmMarkers as Br, isPlatformError as jc, ABORTED as Uc, getErrorMessage as Kc, getFormatCallerFunction as Hc, deepEqual as qc, isString as ln, scrRefToBBBCCCVVV as Ga, defaultScrRef as Wa, formatScrRefRange as Gc, getLocalizeKeyForScrollGroupId as dn, formatReplacementStringToArray as wn, collectUsjMarkers as Wc } from "platform-bible-utils";
import Jt, { useRef as P, useMemo as A, createContext as Dr, useContext as Jr, useEffect as tt, useState as N, useCallback as V, useId as Ea, useImperativeHandle as Yc, useLayoutEffect as Ut, Fragment as Qr, Component as Zc, createElement as ho, Suspense as Xc, forwardRef as Vo, memo as di } from "react";
import { IconSelector as wi, IconCheck as $a, IconChevronDown as Jc, IconChevronUp as Qc, IconLayoutSidebar as tl, IconLayoutSidebarRight as el, IconChevronRight as ui, IconSearch as rl, IconLoader as al, IconAlertOctagon as ol, IconAlertTriangle as nl, IconInfoCircle as il, IconCircleCheck as sl } from "@tabler/icons-react";
...
function yd({
  ...
  const [h, f] = N(!1), [y, b] = N(!1), g = Ea(), C = P(!1), E = w !== void 0, T = E ? w : h, k = n === "" ? "" : re(n, bd), z = re(s, xd), S = (D) => {
...
function ew(t, e, r) {
  ...
  return ml(o) && Ta(283), o.insert(t.isInline() ? ta().append(t) : t), un(fi(t.getLatest(), "next"), e.direction);
}
function rw(t) {
  const e = ae();
  if (!Se(e)) return !1;
...
let Sa, Ve = 0, Ra = 0, nw = 0, _o = 0, va = 0;
function Cn(t) {
  if (wt === void 0) return;
  let e = t.n;
...
const Qa = yl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ji extends go {
  $config() {
...
const ms = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => fs(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(Nt, { children: [
  /* @__PURE__ */ a(Ct, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Xs, { children: /* @__PURE__ */ a(Js, { children: ms(
      t,
      e,
      hs(t, c.id),
      o
...
function Eo({
  ...
  const l = Ea(), w = kp(e), p = s && w.length > 1;
  Mi();
  const h = P(null), f = () => Gs(h.current ?? void 0);
      ...
      /* @__PURE__ */ a(Ct, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        Mp,
        {
          ...
          children: [
            ...
            l.shortcut && /* @__PURE__ */ a(zp, { children: l.shortcut })
          ]
        },
    ...
    wr,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(ec, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
          ...
          /* @__PURE__ */ a(rc, { children: /* @__PURE__ */ a(rl, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
        ] }) }),
