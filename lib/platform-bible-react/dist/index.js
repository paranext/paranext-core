...
function Cv({
  ...
  return /* @__PURE__ */ j("div", { className: "pr-twp pr-flex pr-w-full pr-flex-col", children: [
    !t && /* @__PURE__ */ j(
      or,
      {
    ...
    /* @__PURE__ */ j(br, { className: "pr-flex pr-h-full pr-flex-col pr-p-0", children: [
      t && /* @__PURE__ */ m(vr, { children: w.getHeaderGroups().map((k) => /* @__PURE__ */ m(vt, { children: k.headers.filter((O) => O.column.columnDef.header).map((O) => /* @__PURE__ */ m(Sn, { colSpan: O.colSpan, children: O.isPlaceholder ? void 0 : /* @__PURE__ */ j("div", { children: [
      ...
      /* @__PURE__ */ m(yr, { className: "pr-overflow-y-auto", children: w.getRowModel().rows.map((k, O) => /* @__PURE__ */ m(
        vt,
        {
