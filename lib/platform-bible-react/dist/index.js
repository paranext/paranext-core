...
const tn = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), be = Object.fromEntries(
  tn.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function xa(t, e, r) {
...
function xu({
  ...
  const c = ct(), [w, g] = S(!1), [h, p] = S(""), [m, b] = S(""), [v, x] = S("books"), [y, _] = S(void 0), [k, A] = S(!1), V = G(void 0), $ = G(void 0), E = G(void 0), N = G(void 0), T = G({}), L = B(
    (R) => {
      e(R), l && l(R);
    },
    [e, l]
  ), I = F(() => o ? o() : tn, [o]), M = F(() => ({
    [Y.OT]: I.filter((C) => dt.isBookOT(C)),
    [Y.NT]: I.filter((C) => dt.isBookNT(C)),
    [Y.DC]: I.filter((C) => dt.isBookDC(C)),
    [Y.Extra]: I.filter((C) => dt.extraBooks().includes(C))
    ...
    Hr.Item,
    {
      ...
      children: /* @__PURE__ */ a(
        Hr.Indicator,
        {
          ...
          children: /* @__PURE__ */ a("span", { className: "tw:absolute tw:top-1/2 tw:start-1/2 tw:size-2 tw:-translate-x-1/2 rtl:tw:translate-x-1/2 tw:-translate-y-1/2 tw:rounded-full tw:bg-primary-foreground" })
        }
      )
    }
  );
    ...
    rn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(pt, { className: "tw:flex tw:items-center", children: o.map((v) => dt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            j,
            {
...
function le({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ a(Sa.Provider, { value: r, children: /* @__PURE__ */ a(gt.Root, { "data-slot": "dropdown-menu", ...e }) });
}
function oc({
  ...t
}) {
...
function cc({
  ...
  const [$, E] = S(po), [N, T] = S(
    void 0
  ), L = o, [I, M] = S(!1), [O, W] = S(!1), [D, X] = S(!1), [Et, Mt] = S(!1), [St, ut] = S(!1), [lt, U] = S(k), [rt, at] = S(!1), it = G(void 0), [vt, qt] = S(/* @__PURE__ */ new Map());
  H(() => {
    let z = !0;
    return (async () => {
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              j,
              {
                ...
                children: lt ? /* @__PURE__ */ a(_i, {}) : /* @__PURE__ */ a(Ni, {})
              }
            ),
  ...
  return /* @__PURE__ */ a(yt.Portal, { children: /* @__PURE__ */ u(
    yt.Content,
    {
      ...
      className: f(
        ...
        r === "popper" && "tw:data-[side=bottom]:translate-y-1 tw:data-[side=left]:-translate-x-1 rtl:tw:data-[side=left]:translate-x-1 tw:data-[side=right]:translate-x-1 rtl:tw:data-[side=right]:-translate-x-1 tw:data-[side=top]:-translate-y-1",
        t
      ),
      position: r,
      align: o,
...
function qu({
  ...
  const [m, b] = S("generated"), [v, x] = S("*"), [y, _] = S("f"), [k, A] = S(!1), [V, $] = S(!0), [E, N] = S(!1), T = G(!1), L = G(""), [I, M] = S(!1), [O, W] = S(), [D, X] = S(), [Et, Mt] = S(), [St, ut] = S(), lt = G(null), U = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
...
function Qc({
  ...
  const [d, c] = et.useState(t), w = e ?? d, g = et.useCallback(
    ...
    [r, w]
  ), h = et.useCallback(() => g((_) => !_), [g]), p = w ? "expanded" : "collapsed", v = ct() === "ltr" ? s : s === "primary" ? "secondary" : "primary", x = et.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
  ...
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ne ? ve(n.start) : void 0;
      },
...
function fw({
  ...
  const V = F(() => dt.allBookIds.filter(
    (O, W) => t[W] === "1" && !dt.isObsolete(dt.bookIdToNumber(O))
  ), [t]), $ = F(() => {
    if (!y.trim()) {
      const D = {
        [Y.OT]: [],
  ...
  return /* @__PURE__ */ u($w, { "data-slot": "drawer-portal", children: [
    ...
    /* @__PURE__ */ u(
      ce.Content,
      {
        ...
        ...o,
        children: [
          !r && /* @__PURE__ */ a("div", { className: "tw:mx-auto tw:mt-4 tw:hidden tw:h-1 tw:w-[100px] tw:shrink-0 tw:rounded-full tw:bg-muted tw:group-data-[vaul-drawer-direction=bottom]/drawer-content:block" }),
          e
        ]
      }
    )
