...
const fo = Ct(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Ft : "button", { className: c(fo({ variant: e, size: n, className: t })), ref: i, ...a })
);
...
function bn({
  ...
  if (t)
    return /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: mt(t) }, (s, w) => w + 1).map((s) => /* @__PURE__ */ r(
      Vt,
      {
        value: `${t} ${at[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function ri({
  ...
  const a = Y(), [i, s] = I(!1), [w, p] = I(""), [l, u] = I(""), [g, h] = I("books"), [f, b] = I(void 0), [_, k] = I(!1), S = U(void 0), x = U(void 0), V = U(void 0), A = U(void 0), W = U({}), nt = L(() => o ? o() : Fn, [o]), it = L(() => ({
...
function sa({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Pr, {}) })
    ] }),
...
function xi({
  ...
  const l = gt(n, "%webView_inventory_all%"), u = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = I(!1), [A, W] = I("all"), [nt, it] = I(""), [C, v] = I([]), y = L(() => t.length === 0 ? [] : fa(t, a, i), [t, a, i]), E = L(() => {
    if (x) return y;
    const T = [];
    return y.forEach((q) => {
...
function Ei({
  ...
  return /* @__PURE__ */ d(cr, { className: `tw-w-full tw-border tw-bg-background ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      Xe,
      {
        onSelectMenuItem: t,
...
), rs = m.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const js = (t, e, n = {}) => {
  ...
  const a = U(null), [i, s] = I(void 0), [w, p] = I(void 0), l = F(
    (h) => {
      s(h);
