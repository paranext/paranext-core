...
import { c as v, g as Ee, a as Fa, C as ke, A as ie, P as De, b as We, B as q, d as Oe, e as Me, f as $e, h as xe, i as Pi, k as Vi, j as ji, E as Li, l as Ua, r as pe, m as Bi, n as ln, o as Qr, p as ta, L as Nt, R as Ka, q as qr, D as Na, s as Ca, t as Ea, u as Ta, T as dn, v as Vr, w as Pt, x as qa, y as Vt, z as jt, F as Lt, G as wn, H as Ga, I as Ge, J as kr, K as Ie, M as Ae, N as Pe, S as _r, O as er, Q as Fi, U as Er, V as Ye, W as ze, Z as Xe, X as Te, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as un, a3 as Ui, a4 as Ki, a5 as qi, a6 as za, a7 as pn, a8 as ea, a9 as hn, aa as Gi, ab as Hi, ac as Yi, ad as gn, ae as Wi, af as sa, ag as xo, ah as ca, ai as Xi, aj as Ji, ak as Zi, al as Qi, am as ts, an as Tr, ao as Xa, ap as es, aq as rs } from "./resizable-4yBprkPB.js";
import { ar as Xh, as as Jh, at as Zh, au as Qh, av as tg, aw as eg, ax as rg, ay as ag, az as og, aA as ng, aB as ig, aC as sg, aD as cg, aE as lg, aF as dg, aG as wg, aH as ug, aI as pg, aJ as hg, aK as gg, aL as fg, aM as mg, aN as vg, aO as bg, aP as xg, aQ as yg } from "./resizable-4yBprkPB.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Se, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Sa, ChevronRight as Ra, ArrowLeft as as, ArrowRight as os, ChevronDown as nr, BoldIcon as ns, ItalicIcon as is, X as Ja, AtSign as fn, Pencil as ss, Trash2 as cs, ArrowUp as mn, MoreHorizontal as ls, MailOpen as ds, Mail as ws, ChevronUp as us, FilterIcon as ps, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as fs, ArrowRightIcon as ms, Copy as vn, Filter as vs, User as bs, Link as xs, CircleHelp as ys, Undo as ks, Redo as _s, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Ns, AlertCircle as Da, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as zs, ArrowDownIcon as Ss, ScrollText as Rs, ChevronsUpDown as Ds, MenuIcon as Os, Menu as Ms, EllipsisVertical as $s, MoreVertical as Is } from "lucide-react";
import { Section as dt, getChaptersForBook as As, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ps, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as kn, formatBytes as Vs, getCurrentLocale as js, usfmMarkers as jr, getFormatCallerFunction as Ls, deepEqual as Bs, isString as No, compareScrRefs as Oa, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Co, formatReplacementStringToArray as Eo, collectUsjMarkers as Us } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Ks, useLayoutEffect as Qt, createContext as Qa, useContext as _n, Component as qs, createElement as To, Suspense as Gs, forwardRef as Nn, useId as zo, Fragment as ra } from "react";
import { IconSelector as Cn, IconCheck as aa, IconChevronDown as Hs, IconChevronUp as Ys, IconLayoutSidebar as Ws, IconLayoutSidebarRight as Xs, IconChevronRight as En, IconSearch as Js, IconLoader as Zs, IconAlertOctagon as Qs, IconAlertTriangle as tc, IconInfoCircle as ec, IconCircleCheck as rc } from "@tabler/icons-react";
import { createEditor as Tn, $getRoot as Re, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as zn, TextNode as Sn, $getPreviousSelection as ac, $isRangeSelection as we, $caretFromPoint as oc, $getSiblingCaret as Rn, $getChildCaret as nc, $getAdjacentChildCaret as ic, $isChildCaret as sc, $normalizeCaret as cc, $setSelectionFromCaretRange as lc, $getCollapsedCaretRange as dc, $getCaretInDirection as So, $splitAtPointCaretNext as wc, $isTextPointCaret as uc, $findMatchingParent as Dn, $isElementNode as Nr, mergeRegister as ye, getDOMTextNode as pc, isHTMLElement as hc, CLEAR_EDITOR_COMMAND as On, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as gc, defineExtension as re, safeCast as Je, createState as fc, FORMAT_TEXT_COMMAND as Mn, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as In, RootNode as mc, LineBreakNode as vc, TabNode as bc, $isEditorState as xc, createCommand as yc, CLICK_COMMAND as kc, isDOMNode as _c, $getNodeFromDOMNode as Nc, $createNodeSelection as Cc, $setSelection as Ec, $getEditor as Tc, DecoratorNode as Ma, $getState as zc, toggleTextFormatType as Ro, TEXT_TYPE_TO_FORMAT as Sc, $setState as Rc, addClassNamesToElement as An, $create as Dc, $getNodeByKey as Oc, removeClassNamesFromElement as Mc, KEY_TAB_COMMAND as $c, $isBlockElementNode as Ic, $createRangeSelection as Ac, $normalizeSelection__EXPERIMENTAL as Pc, OUTDENT_CONTENT_COMMAND as Vc, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as jc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Lc, $isParagraphNode as Bc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Pn, $insertNodes as Fc } from "lexical";
...
import { useReactTable as jn, getFilteredRowModel as Jc, getSortedRowModel as Ln, getPaginationRowModel as Zc, getCoreRowModel as Bn, flexRender as xr, getGroupedRowModel as Qc, getExpandedRowModel as tl } from "@tanstack/react-table";
import el from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as rl, isInsertEmbedOpOfType as Mr, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Gn ? Qt : H, Ir = { tag: to };
function ml({ initialConfig: t, children: e }) {
  const r = D(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = gl(null, o), w = Tn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zl = Hn && "documentMode" in document ? document.documentMode : null;
!(!Hn || !("InputEvent" in window) || zl) && "getTargetRanges" in new window.InputEvent("input");
function de(t) {
  return `${t}px`;
}
...
function Il(t) {
  ...
  if (we(e)) r = oc(e.focus, "next");
    ...
    r = r || nc(Re(), "previous").getFlipped().insert(zr());
  }
  const o = Al(t, r), n = ic(o), i = sc(n) ? cc(n) : o;
  return lc(dc(i)), t.getLatest();
}
function Al(t, e, r) {
  let o = So(e, "next");
  for (let n = o; n; n = wc(n, r)) o = n;
  return uc(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), So(Rn(t.getLatest(), "next"), e.direction);
}
function Pl(t) {
  const e = Xt();
  if (!we(e)) return !1;
...
let Yr, be = 0, Wr = 0, Ll = 0, Va = 0, Br = 0;
function Fo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
const ga = fc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends Ma {
  $config() {
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Mn, (o) => {
  const n = Xt();
  if ($n(n) || we(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, In) });
function ti(t, e) {
  let r;
...
const Wl = re({ config: Je({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [mc, Sn, vc, bc, zn] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Go() {
}
function Xl(t) {
  throw t;
...
const Jl = /* @__PURE__ */ new Set(), Ho = re({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = Bl(() => (i.value || Jl).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
  ...
  return ye(t.registerCommand(Zl, (s) => {
    ...
    if (_c(s.target)) {
      ...
      if (td(c)) return function(l, d = !1) {
        ...
        let g;
        d && $n(w) ? g = w : (g = Cc(), Ec(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function ed(t, e, r = oi) {
  return ye(t.registerCommand($c, (o) => {
    const n = Xt();
    if (!we(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Ic(h) && h.canIndent()).length > 0) return !0;
...
function Ju({
  ...
  const [i, s] = _(Rd), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  H(() => {
    let m = !0;
    const E = h.current;
    if (!E) return;
...
function Zo({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a($d, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Id, { className: "tw:text-xs tw:font-medium", children: E }) }),
        ...
        B && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ls, {}) }) }),
...
function Ud(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = Fd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Ud, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(vi, { ...W })
          },
          $.id
        );
      })
...
function ow({
  ...
  return /* @__PURE__ */ u(Ie, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: aw(t, n, r) }) }) }),
...
function sw({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: nw(t, r) }) }) }),
...
function Ep({
  ...
  }, [I, Y]), $ = D(() => T.length === 0 ? [] : Nw(T, C, U), [T, C, U]), W = D(() => {
    var wt, at;
    if (!I) return l;
...
const Ew = "16rem", Tw = "3rem", yi = Wt.createContext(void 0);
function ia() {
...
function Iw({
  ...
  const c = t ? Sr.Root : "button", { state: l } = ia(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v($w({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Sw,
    {
      ...
      children: /* @__PURE__ */ u(Dw, { children: [
        /* @__PURE__ */ u(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(Ow, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Mw, { children: /* @__PURE__ */ a(
            Iw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Ce = "scrBook", Pw = "scrRef", qe = "source", Vw = "details", jw = "Scripture Reference", Lw = "Scripture Book", ki = "Type", Bw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(qd, { children: O.map((C) => /* @__PURE__ */ a(ne, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function Up({
  ...
  const O = St(
    ...
    [r, n, f, i]
  ), ot = tt.find((M) => M.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Fs(at, mt, {
...
function Xp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(zi, { children: [
      /* @__PURE__ */ a(Si, { children: t.map((c) => /* @__PURE__ */ a(Ww, { value: c.value, children: c.value }, c.key)) }),
...
function Lh({
  ...
  return /* @__PURE__ */ a(
    se.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", fu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  Uh as useEvent,
  Kh as useEventAsync,
  Gh as useExtraValidMarkers,
  Fi as useListbox,
  vu as usePromise,
  Gu as useRecentSearches,
  ia as useSidebar,
  qh as useStylesheet,
  Hh as useTabIconSelection,
