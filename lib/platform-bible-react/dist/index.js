...
const Or = 250, ii = 300, po = 400, Ic = 450, si = 500, Dc = 550, li = Ne(
...
function vr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ w(Oc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        rr.Input,
        {
...
function wi({
  ...
  const h = F(!1), m = () => {
    u || (h.current || o == null || o(e), setTimeout(() => {
      h.current = !1;
    }, 100));
  }, p = (v) => {
    if (u) {
...
function Bc({
  ...
  return /* @__PURE__ */ w(Ce, { open: u, onOpenChange: h, children: [
    ...
    /* @__PURE__ */ a(Ee, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(be, { heading: i, children: t.map((p) => /* @__PURE__ */ w(
      _e,
      {
        onSelect: () => m(p),
      ...
      if (s) {
        ...
        if (!u && d) {
          const p = ((g) => Object.keys(se).find(
            (k) => se[k].toLowerCase() === g.toLowerCase()
          ))(l);
...
function ka({
  ...
  const x = kt(), [C, T] = I(!1), [O, M] = I(""), [E, N] = I(""), [y, _] = I("books"), [S, D] = I(void 0), [j, L] = I(
    void 0
    ...
    return [et.OT, et.NT, et.DC, et.Extra].forEach((tt) => {
      z[tt] = yt[tt].filter((St) => fo(St, E, n));
    }), z;
  }, [yt, E, n]), A = U(
    () => Kc(E, Wt, n),
    [E, Wt, n]
  ...
  const Kt = P(() => {
    if (A) {
      const z = A.chapterNum ?? 1, Y = A.verseNum ?? 1;
      if (u && ya(A.book, z, Y, u))
        return;
      wt({
        book: A.book,
        chapterNum: z,
    ...
    (z) => {
      const Y = j ?? (A == null ? void 0 : A.book), tt = H ?? (A == null ? void 0 : A.chapterNum);
      !Y || !tt || (wt({
        book: Y,
        chapterNum: tt,
        verseNum: z
    ...
    (z) => {
      const Y = y === "chapters" ? S : A == null ? void 0 : A.book;
      if (Y) {
        if (c && c(Y, z) > 1) {
          L(Y), R(z), _("verses"), M("");
          return;
    ...
    _("books"), D(void 0), L(void 0), R(void 0), setTimeout(() => {
      at.current && at.current.focus();
    }, 0);
  }, []), B = P(() => {
    const z = j;
    L(void 0), R(void 0), z ? (D(z), _("chapters"), M("")) : Zt();
  }, [j, Zt]), Z = P((z) => {
    T(z), z && (_("books"), D(void 0), L(void 0), R(void 0), N(""));
    ...
    (z) => A ? !!A.chapterNum && !z.toString().includes(A.chapterNum.toString()) : !1,
    [A]
  ), Tt = U(
    () => ze(
      t,
    ...
    () => Gc(E),
    [E]
  ), Ct = U(() => !c || !A || !A.chapterNum || !mt ? !1 : c(A.book, A.chapterNum) > 0, [c, A, mt]), He = P(
    (z) => u ? en(z, u) : !1,
    [u]
  ), Pe = P(
    (z) => (Y) => u ? Uc(z, Y, u) : !1,
    ...
    (z) => {
      (z.key === "Home" || z.key === "End") && z.stopPropagation(), h && h.includes(z.key) && A && A.chapterNum !== void 0 && A.verseNum !== void 0 && (z.preventDefault(), z.stopPropagation(), Kt());
    },
    [h, A, Kt]
  ), Pr = P(
    (z) => {
      ...
      if ((y === "chapters" || y === "verses") && (z.key === " " || z.key === "Enter")) {
        ...
        const At = (re = J.current) == null ? void 0 : re.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (At) {
          z.preventDefault(), z.stopPropagation(), At.click();
          return;
        }
      }
      ...
      if (y === "verses" && St) {
        ...
        switch (z.key) {
          case "ArrowLeft":
            xt !== 0 && (Qt = xt > 1 ? xt - 1 : At);
            break;
          case "ArrowRight":
            xt !== 0 && (Qt = xt < At ? xt + 1 : 1);
            break;
          case "ArrowUp":
            Qt = xt === 0 ? At : Math.max(1, xt - te);
            break;
          case "ArrowDown":
            Qt = xt === 0 ? 1 : Math.min(At, xt + te);
            break;
          default:
            return;
        }
        Qt !== xt && (z.preventDefault(), z.stopPropagation(), M(
          `${Vt} ${se[Vt] || ""} ${Et}:${Qt}`
        ), setTimeout(() => {
      ...
      if ((y === "chapters" || y === "books" && A) && St) {
        const Vt = y === "chapters" ? S : A == null ? void 0 : A.book;
        if (!Vt) return;
        ...
        switch (z.key) {
          case "ArrowLeft":
            Et !== 0 && (xt = Et > 1 ? Et - 1 : At);
            break;
          case "ArrowRight":
            Et !== 0 && (xt = Et < At ? Et + 1 : 1);
            break;
          case "ArrowUp":
            xt = Et === 0 ? At : Math.max(1, Et - Qt);
            break;
          case "ArrowDown":
            xt = Et === 0 ? 1 : Math.min(At, Et + Qt);
            break;
          default:
            return;
        }
        xt !== Et && (z.preventDefault(), z.stopPropagation(), M(
          `${Vt} ${se[Vt] || ""} ${xt}`
        ), setTimeout(() => {
    ...
    const { isLetter: Y, isDigit: tt } = rn(z.key);
    (Y || tt) && (z.preventDefault(), N((re) => re + z.key), at.current.focus(), pt(!1));
  }, []);
  return ee(() => {
    const z = setTimeout(() => {
      if (C && y === "books" && q.current && st.current) {
    ...
    if (y === "chapters" && S) {
      const z = S === t.book, Y = z ? t.chapterNum : 1;
      M(
        `${S} ${se[S] || ""} ${Y}`
      ), setTimeout(() => {
        if (q.current)
  ...
  }, [y, S, A, t.book, t.chapterNum]), ee(() => {
    if (y === "verses" && j && H !== void 0) {
      const z = j === t.book && H === t.chapterNum, Y = z ? t.verseNum : 1;
      M(
        `${j} ${se[j] || ""} ${H}:${Y}`
      ), setTimeout(() => {
        if (q.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ w(Ce, { open: C, onOpenChange: Z, modal: v, children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(
      G,
      {
        ref: K,
    ...
    /* @__PURE__ */ a(
      Ee,
      {
        ...
        onPointerDownOutside: (z) => {
          const { target: Y } = z;
          C && K.current && Y instanceof Node && K.current.contains(Y) && (it.current = !0, Z(!1));
        },
        onCloseAutoFocus: k,
        children: /* @__PURE__ */ w(
          $e,
          {
            ...
            children: [
              y === "books" ? /* @__PURE__ */ w("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  G,
                  {
                    ...
                    tabIndex: -1,
                    children: x === "ltr" ? /* @__PURE__ */ a(Us, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(An, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                y === "chapters" && S && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ve(S, n) }),
                y === "verses" && j && H !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ve(j, n)} ${H}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !X && /* @__PURE__ */ w(Ae, { ref: q, children: [
                y === "books" && /* @__PURE__ */ w(rt, { children: [
                  !A && Object.entries(Yt).map(([z, Y]) => {
                    if (Y.length !== 0)
                      return (
                  ...
                  A && /* @__PURE__ */ a(be, { children: /* @__PURE__ */ a(
                    _e,
                    {
                      ...
                      children: ze(
                        ...
                        n ? go(A.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  A && Ct && A.chapterNum && c && /* @__PURE__ */ w(rt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      on,
                      {
                        ...
                        onVerseSelect: ne,
                        setVerseRef: ft,
                        isVerseDisabled: xr(A.book, A.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  A && !Ct && ge(A.book) > 1 && /* @__PURE__ */ w(rt, { children: [
                    /* @__PURE__ */ w("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ a(
                      an,
                      {
                        ...
                        setChapterRef: $,
                        isChapterDimmed: bt,
                        isChapterDisabled: Pe(A.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                y === "chapters" && S && /* @__PURE__ */ a(
                  an,
                  {
                    bookId: S,
                    scrRef: t,
                ...
                y === "verses" && j && H !== void 0 && c && /* @__PURE__ */ a(
                  on,
                  {
                    bookId: j,
                    chapterNum: H,
...
function nn({
  ...
  const [C, T] = I(!1), O = c ?? d, M = (N) => N.length > 0 && typeof N[0] == "object" && "options" in N[0], E = (N, y) => {
    const _ = d(N), S = typeof N == "object" && "secondaryLabel" in N ? N.secondaryLabel : void 0, D = `${y ?? ""}${_}${S ?? ""}`;
    return /* @__PURE__ */ w(
      _e,
      {
        value: _,
  ...
  return /* @__PURE__ */ w(Ce, { open: C, onOpenChange: T, ...x, children: [
    ...
    /* @__PURE__ */ a(
      Ee,
      {
        ...
        children: /* @__PURE__ */ w($e, { children: [
          ...
          /* @__PURE__ */ a(Ae, { children: M(e) ? e.map((N) => /* @__PURE__ */ a(be, { heading: N.groupHeading, children: N.options.map((y) => E(y, N.groupHeading)) }, N.groupHeading)) : e.map((N) => E(N)) })
        ] })
      }
    )
  ] });
...
function ah({
  ...
  const u = Na(c, "%webView_bookSelector_currentBook%"), h = Na(c, "%webView_bookSelector_choose%"), m = Na(c, "%webView_bookSelector_chooseBooks%"), [p, g] = I(
    "current book"
    /* CurrentBook */
  ), k = (v) => {
    g(v), t(v);
...
function Jc({ initialConfig: t, children: e }) {
  const r = U(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: d } = t, c = Yc(null, o), u = Fn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (h) => s(h, u), theme: o });
    return function(h, m) {
      if (m !== null) {
        if (m === void 0) h.update(() => {
          ...
          if (p.isEmpty()) {
            ...
            (Ht() !== null || k !== null && k === h.getRootElement()) && g.select();
          }
        }, qr);
        else if (m !== null) switch (typeof m) {
          case "string": {
            const p = h.parseEditorState(m);
            h.setEditorState(p, qr);
            break;
          }
          case "object":
            h.setEditorState(m, qr);
            break;
          case "function":
            h.update(() => {
              De().isEmpty() && m(h);
...
function sd(t, e) {
  ...
  s.sort((c, u) => {
    const h = c.top - u.top;
    return Math.abs(h) <= 3 ? c.left - u.left : h;
  });
  for (let c = 0; c < d; c++) {
    const u = s[c], h = l && l.top <= u.top && l.top + l.height > u.top && l.left + l.width > u.left, m = u.width + i === o.width;
    h || m ? (s.splice(c--, 1), d--) : l = u;
  }
  return s;
}
function ld(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !yl(e) && o !== null) {
    ...
    if (c || u) {
      const [h, m] = kl(t), p = l.is(d), g = e.is(s ? d : l), k = e.is(s ? l : d);
      let v, b = 0;
      p ? (b = h > m ? m : h, v = h > m ? h : m) : g ? (b = s ? m : h, v = void 0) : k && (b = 0, v = s ? h : m);
      const x = e.__text.slice(b, v);
      x !== e.__text && (r === "clone" && (e = Nl(e)), e.__text = x);
    }
  }
  return e;
}
...
function wd(t, e, r) {
  ...
  function d() {
    ...
    const { left: h, top: m } = n.getBoundingClientRect(), p = sd(t, e);
    var g, k;
    l.isConnected || (k = l, (g = n).insertBefore(k, g.firstChild));
    let v = !1;
    for (let b = 0; b < p.length; b++) {
      const x = p[b], C = s[b] || document.createElement("div"), T = C.style;
      T.position !== "absolute" && (T.position = "absolute", v = !0);
      const O = he(x.left - h);
      T.left !== O && (T.left = O, v = !0);
      const M = he(x.top - m);
      T.top !== M && (C.style.top = M, v = !0);
      const E = he(x.width);
      T.width !== E && (C.style.width = E, v = !0);
      const N = he(x.height);
      T.height !== N && (C.style.height = N, v = !0), C.parentNode !== l && (l.append(C), v = !0), s[b] = C;
    }
  ...
  const u = t.registerRootListener(function h() {
    const m = t.getRootElement();
    if (m === null) return c();
    const p = m.parentElement;
    if (!Hn(p)) return c();
    c(), o = m, n = p, i = new MutationObserver((g) => {
      const k = t.getRootElement(), v = k && k.parentElement;
      if (k !== o || v !== n) return h();
      for (const b of g) if (!l.contains(b.target)) return d();
    }), i.observe(p, dd), d();
  });
  return () => {
    u(), c();
...
function pd(t, e = ud) {
  ...
  function c(u) {
    u.read(() => {
      const h = Ht();
      if (!ve(h)) return r = null, n = null, i = null, l = null, d(), void (d = () => {
      });
      const [m, p] = function(N) {
        const y = N.getStartEndPoints();
        return N.isBackward() ? [y[1], y[0]] : y;
      }(h), g = m.getNode(), k = g.getKey(), v = m.offset, b = p.getNode(), x = b.getKey(), C = p.offset, T = t.getElementByKey(k), O = t.getElementByKey(x), M = r === null || T !== o || v !== n || k !== r.getKey(), E = i === null || O !== s || C !== l || x !== i.getKey();
      if ((M || E) && T !== null && O !== null) {
        const N = function(y, _, S, D, j, L, H) {
          const R = (y._window ? y._window.document : document).createRange();
          return R.setStart(...sn(_, S, D)), R.setEnd(...sn(j, L, H)), R;
        }(t, m, g, T, p, b, O);
        d(), d = wd(t, N, e);
      }
      r = g, o = T, n = v, i = b, s = O, l = C;
    });
  }
...
const Rd = /* @__PURE__ */ new Set(), hn = oe({ build(t, e, r) {
  const o = r.getDependency(Qa).output, n = Dr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Ci(() => {
    ...
    let d, c = !1;
    o.value.read(() => {
      if (Ht()) for (const [u, h] of l.entries()) {
        if (h.size === 0) {
          l.delete(u);
          continue;
        }
  ...
  return Re(t.registerCommand($d, (s) => {
    ...
    if (Gl(s.target)) {
      ...
      if (Od(l)) return function(d, c = !1) {
        const u = Ht(), h = d.isSelected(), m = d.getKey();
        let p;
        c && Xn(u) ? p = u : (p = Kl(), ql(p)), h ? p.delete(m) : p.add(m);
      }(l, s.shiftKey), !0;
    }
    return !1;
    ...
    xd(() => {
      ...
      for (const [u, h] of s.entries()) if (h === "destroyed") c.delete(u), d = !0;
      else {
...
function Md(t, e, r = Si) {
  return Re(t.registerCommand(tc, (o) => {
    ...
    const i = function(s) {
      ...
      const l = s.anchor, d = s.focus, c = d.isBefore(l) ? d : l, u = c.getNode(), h = gd(u);
      if (h.canIndent()) {
        const m = h.getKey();
        let p = ec();
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ve(g)) {
                const k = g.anchor;
                let v = k.getNode(), b = 0, x = 0;
                if (aa(v) && c >= 0 && u >= 0 && (b = c, x = c + u, g.setTextNodeRange(v, b, v, x)), b === x && h === "" || (g.insertRawText(h), v = k.getNode()), aa(v)) {
                  b = m, x = m + p;
                  const C = v.getTextContentSize();
                  b = b > C ? C : b, x = x > C ? C : x, g.setTextNodeRange(v, b, v, x);
                }
  ...
  return function(r, o) {
    ...
    return ko(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const c = l[d], u = a(o, { onError: (m) => r._onError(m), children: a(ms, { fallback: null, children: n[c] }) }), h = r.getElementByKey(c);
        h !== null && s.push(gc(u, h, c));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Yd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: c, ariaMultiline: u, ariaOwns: h, ariaRequired: m, autoCapitalize: p, className: g, id: k, role: v = "textbox", spellCheck: b = !0, style: x, tabIndex: C, "data-testid": T, ...O }, M) {
  const [E, N] = I(t.isEditable()), y = P((S) => {
    S && S.ownerDocument && S.ownerDocument.defaultView ? t.setRootElement(S) : t.setRootElement(null);
  }, [t]), _ = U(() => /* @__PURE__ */ function(...S) {
    return (D) => {
      for (const j of S) typeof j == "function" ? j(D) : j != null && (j.current = D);
    };
  }(M, y), [y, M]);
  return Ri(() => (N(t.isEditable()), t.registerEditableListener((S) => {
    N(S);
  })), [t]), a("div", { "aria-activedescendant": E ? e : void 0, "aria-autocomplete": E ? r : "none", "aria-controls": E ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": E && v === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": c, "aria-multiline": u, "aria-owns": E ? h : void 0, "aria-readonly": !E || void 0, "aria-required": m, autoCapitalize: p, className: g, contentEditable: E, "data-testid": T, id: k, ref: _, role: v, spellCheck: b, style: x, tabIndex: C, ...O });
}
const Xd = pa(Yd);
function fn(t) {
  return t.getEditorState().read(Ii(t.isComposing()));
...
function iw() {
  const { activeEditor: t } = Ai(), [e, r] = I([]), o = P((n) => {
    if (ve(n) || fc(n)) {
      const i = [];
      mn.forEach(({ format: s }) => {
...
function Li(t, e, r, o = null) {
  ...
  for (let p = 0; p < l.length; p++) {
    const g = l[p], k = Li(t, g, m, o);
    !n && Se(e) && k && e.extractWithChild(g, o, "html") && (n = !0);
  }
  if (n && !i) {
    if ((Hn(u) || Jo(u)) && u.append(m), r.append(u), h) {
      const p = h.call(s, u);
...
function ji(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let l = null;
  const d = function(g, k) {
    const { nodeName: v } = g, b = k._htmlConversions.get(v.toLowerCase());
    let x = null;
    if (b !== void 0) for (const C of b) {
      const T = C(g);
  ...
  for (let g = 0; g < h.length; g++) m.push(...ji(h[g], e, r, p, new Map(n), l));
  return u != null && (m = u(m)), Zo(t) && (m = uw(t, m, p ? () => {
    const g = new ti();
    return r.push(g), g;
  } : mr)), l == null ? m.length > 0 ? s = s.concat(m) : Zo(t) && function(g) {
...
function nh({
  ...
  const [i, s] = I(gw), [l, d] = I(n), [c, u] = I(!1), h = F(void 0), m = F(null);
  W(() => {
    let v = !0;
    const b = m.current;
    if (!b) return;
  ...
  const p = P(() => {
    ...
    const v = la(i);
    e(v, l);
  }, [i, e, l]), g = o["%commentEditor_placeholder%"] ?? "Type your comment here...", k = o["%commentEditor_assignTo_label%"] ?? "Assign to";
...
const ih = Object.freeze([
  ...
  const n = F(null), [i, s] = I(void 0), [l, d] = I(void 0), c = P(
    ...
    (p) => {
      const g = t.find((k) => k.id === p);
      g && (d((k) => k === p ? void 0 : p), r == null || r(g));
    },
    [r, t]
  ), h = (p) => {
    if (!p) return !1;
    const g = p.tagName.toLowerCase();
    if (p.isContentEditable || fw.includes(g)) return !0;
    ...
    (p) => {
      var E;
      const g = p.target, k = (N) => N ? document.getElementById(N) : void 0, v = k(l), b = k(i);
      if (!!(v && g && v.contains(g) && g !== v) && h(g)) {
        if (p.key === "Escape" || p.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            p.preventDefault(), p.stopPropagation();
            const N = t.find((y) => y.id === l);
            N && c(N.id);
          }
          return;
        }
        if (p.key === "ArrowDown" || p.key === "ArrowUp") {
          ...
          const y = N.findIndex((S) => S === g);
          if (y === -1) return;
          let _;
          p.key === "ArrowDown" ? _ = Math.min(y + 1, N.length - 1) : _ = Math.max(y - 1, 0), _ !== y && (p.preventDefault(), p.stopPropagation(), (E = N[_]) == null || E.focus());
          return;
        }
        return;
      }
      const T = t.findIndex((N) => N.id === i);
      let O = T;
      switch (p.key) {
        case "ArrowDown":
          O = Math.min(T + 1, t.length - 1), p.preventDefault();
          break;
        case "ArrowUp":
          O = Math.max(T - 1, 0), p.preventDefault();
          break;
        case "Home":
          O = 0, p.preventDefault();
          break;
        case "End":
          O = t.length - 1, p.preventDefault();
          break;
        case " ":
        case "Enter":
...
function bn({
  ...
  const p = P(
    (T) => {
      T && T.stopPropagation(), c(!1), h(void 0), s == null || s(!1);
    },
    [s]
  ), g = P(
    async (T) => {
      if (T && T.stopPropagation(), !u || !n) return;
      await n(
        t.id,
        la(u)
  ...
  }, [t.date, r]), v = U(() => t.user, [t.user]), b = U(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), x = U(() => Ls(t.contents), [t.contents]), C = U(() => {
    if (o && l)
      return /* @__PURE__ */ w(rt, { children: [
        /* @__PURE__ */ w(
          Qe,
          {
            onClick: (T) => {
              T.stopPropagation(), c(!0), h(pw(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(yw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(kw, { className: "tw:text-xs tw:font-medium", children: b }) }),
        /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ w(
            "div",
            {
              ...
              ref: m,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), p()) : Co(T) && (T.preventDefault(), T.stopPropagation(), ae(u) && g());
              },
              onKeyDown: (T) => {
                No(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
              },
              onClick: (T) => {
                T.stopPropagation();
              },
...
function Sw({
  ...
  const [N, y] = I(xn), [_, S] = I(), [D, j] = I(), L = o, [H, R] = I(!1), [X, pt] = I(!1), [K, it] = I(!1), [J, at] = I(!1), [q, st] = I(!1), [ct, dt] = I(T), [wt, Ut] = I(!1), yt = F(void 0), [Wt, Yt] = I(/* @__PURE__ */ new Map());
  W(() => {
    let $ = !0;
    return (async () => {
  ...
  W(() => {
    if (!o) {
      A.current !== "idle" && (S(void 0), j(void 0), A.current = "idle");
      return;
    }
    A.current === "idle" && (A.current = "pending"), J ? A.current === "pending" && E !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    E !== i && (S(E), A.current = "auto-populated") : A.current === "auto-populated" && (S(void 0), A.current = "pending");
  }, [o, E, J, i]);
  const Pt = U(() => e.filter(($) => !$.deleted), [e]);
  W(() => {
    let $ = !0;
    if (!o || !C) {
      Yt(/* @__PURE__ */ new Map());
  ...
  W(() => {
    ...
    if (o && !ct && !wt) {
      ...
      return yt.current = $, () => clearTimeout($);
    }
  ...
  const bt = P(
    async ($) => {
      ...
      ft && await h({ threadId: d, contents: ft }) && jt();
    },
    [
      jt,
      N,
    ...
    async ($) => {
      const ft = ae(N) ? la(N) : void 0, mt = $.status ? $.assignedUser : _ ?? $.assignedUser, Ct = await h({
        ...$,
        contents: ft,
        assignedUser: mt
      });
      return Ct && (mt !== void 0 && j(mt), ft && jt()), Ct;
    },
    [jt, N, h, _]
  );
  if (Pt.length !== 0)
            ...
            o && /* @__PURE__ */ w(rt, { children: [
              vt > 0 && /* @__PURE__ */ w(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: ($) => {
                    ($.key === "Enter" || $.key === " ") && ($.preventDefault(), $.stopPropagation(), R(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(le, {}) }),
                    /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              lt.map(($) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                bn,
                {
                  comment: $,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: p,
                  onEditingChange: pt,
                  canEditOrDelete: (!X && Wt.get($.id)) ?? !1
                }
              ) }, $.id)),
              v !== !1 && (!X || ae(N)) && /* @__PURE__ */ w(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: ($) => {
                    Co($) && ($.preventDefault(), $.stopPropagation(), (ae(N) || _ !== void 0 && _ !== D) && bt());
                  },
                  onKeyDown: ($) => {
                    No($), ($.key === "Enter" || $.key === " ") && $.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      sa,
                    ...
                    /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      _ !== void 0 && (ae(N) || _ !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ze(
                      ...
                      /* @__PURE__ */ w(Ce, { open: K, onOpenChange: it, children: [
                        ...
                        /* @__PURE__ */ a(
                          Ee,
                          {
                            ...
                            align: "end",
                            onKeyDown: ($) => {
                              $.key === "Escape" && ($.stopPropagation(), it(!1));
                            },
                            children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(Ae, { children: k == null ? void 0 : k.map(($) => /* @__PURE__ */ a(
                              _e,
                              {
                                onSelect: () => {
                                  S($ !== i ? $ : void 0), A.current = "user-selected", j(void 0), it(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function hh({
  ...
  const [b, x] = I(/* @__PURE__ */ new Set()), [C, T] = I(), [O, M] = I(), E = P(
    async (R) => {
      const X = await i(R);
      return X !== void 0 && R.assignedUser !== void 0 && R.assignedUser !== "" && M(R.assignedUser), X;
    },
    [i]
  );
  W(() => {
    g && (x((R) => new Set(R).add(g)), T(g));
  }, [g]);
  const N = r.filter(
    (R) => R.comments.some((X) => !X.deleted)
  ), y = N.map((R) => ({ id: R.id })), _ = P(
    (R) => {
      x((X) => new Set(X).add(R.id)), T(R.id), k == null || k(R.id);
    },
    [k]
  ), S = P(
    (R) => {
      ...
      }), T(R), k == null || k(X ? void 0 : R);
    },
    [b, k]
  ), { listboxRef: D, activeId: j, handleKeyDown: L } = Eo({
    options: y,
    onOptionSelect: _
  }), H = P(
    (R) => {
      R.key === "Escape" ? (C && b.has(C) && (x((X) => {
        const pt = new Set(X);
        return pt.delete(C), pt;
      }), T(void 0), k == null || k(void 0)), R.preventDefault(), R.stopPropagation()) : L(R);
    },
    [C, b, L, k]
  );
  return /* @__PURE__ */ a(
...
function Be({
  ...
  const l = nt.useMemo(
    ...
    (u) => {
      ...
      const m = h.closest("table"), p = m ? (
        // getFocusableElements returns an HTMLElement[] but we are filtering for HTMLTableRowElements
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        Rr(m).filter(
          (v) => v.tagName === "TR"
        )
      ) : [], g = p.indexOf(h), k = l.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (u.key === "ArrowDown" || u.key === "ArrowUp")
        u.preventDefault(), Pw(p, g, u.key);
...
function jw({
  ...
  var M;
  const [u, h] = I([]), [m, p] = I([]), [g, k] = I({}), [v, b] = I({}), x = U(() => e ?? [], [e]), C = ai({
    data: x,
    columns: t,
    getCoreRowModel: ni(),
  ...
  let O;
  return d ? O = Array.from({ length: 10 }).map((y, _) => `skeleton-row-${_}`).map((y) => /* @__PURE__ */ a(Be, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(wr, { colSpan: T.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a($r, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((M = C.getRowModel().rows) == null ? void 0 : M.length) > 0 ? O = C.getRowModel().rows.map((E) => /* @__PURE__ */ a(
    Be,
    {
      onClick: () => s(E, C),
      "data-state": E.getIsSelected() && "selected",
      children: E.getVisibleCells().map((N) => /* @__PURE__ */ a(wr, { children: zr(N.column.columnDef.cell, N.getContext()) }, N.id))
    },
    E.id
  )) : O = /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(wr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: c }) }), /* @__PURE__ */ w("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(Iw, { table: C }),
    /* @__PURE__ */ w(zo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(So, { stickyHeader: i, children: C.getHeaderGroups().map((E) => /* @__PURE__ */ a(Be, { children: E.headers.map((N) => /* @__PURE__ */ a(ca, { className: "tw:p-0", children: N.isPlaceholder ? void 0 : zr(N.column.columnDef.header, N.getContext()) }, N.id)) }, E.id)) }),
      /* @__PURE__ */ a(Io, { children: O })
    ] }),
...
function qw({ row: t, mode: e, strings: r, onClick: o, onOpen: n, selectedRowRef: i }) {
  const [s, l] = I(!1), d = F(null), c = !!(t.language || t.languageCode), u = c || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, h = P(() => {
    if (u) {
      l(!0);
      return;
    }
    const b = d.current;
    b && b.scrollWidth > b.clientWidth && l(!0);
  }, [u]), m = /* @__PURE__ */ a(Ge, { className: f("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let p;
  e === "project" ? t.openGroups.length > 0 && (p = /* @__PURE__ */ a("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((b) => /* @__PURE__ */ a(ye, { variant: "secondary", children: Ar(b) }, b)) })) : t.scrollGroupId !== void 0 && (p = /* @__PURE__ */ w("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ a(
      Kw,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ w(
      G,
      {
        ...
        children: [
          /* @__PURE__ */ a(An, { className: "tw:h-3 tw:w-3" }),
          r.openButtonLabel
        ]
      }
    )
  ...
  ), k = t.scrollGroupId !== void 0 ? Ar(t.scrollGroupId) : void 0, v = t.isBoundButClosed && k ? r.boundButClosedTooltip.replace("{group}", k) : void 0;
  return /* @__PURE__ */ w(Dt, { open: s, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ w(
      $t,
      {
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && k && /* @__PURE__ */ w("div", { className: "tw:text-sm", children: [
...
function Ww(t) {
  const [e, r] = I(!1), [o, n] = I(""), [i, s] = I(t.defaultGroupByOpenTabs ?? !0), [l, d] = I(!1), c = F(null), u = P((E) => {
    r(E), E || n("");
  }, []);
  W(() => {
    if (!e) return;
    const E = window.requestAnimationFrame(() => {
      const N = c.current;
      N && N.scrollIntoView({ block: "nearest", behavior: "auto" });
    });
    return () => window.cancelAnimationFrame(E);
  }, [e]);
  const h = Gw(t.localizedStrings), m = U(() => t.mode === "project" ? Da({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), p = U(() => {
    const E = o.trim().toLowerCase();
    let N = m;
    return E && (N = N.filter(
      (y) => y.shortName.toLowerCase().includes(E) || y.fullName.toLowerCase().includes(E) || (y.language ?? "").toLowerCase().includes(E) || (y.languageCode ?? "").toLowerCase().includes(E)
    )), t.mode === "project-multi" && l && (N = N.filter((y) => y.isSelected)), N;
  }, [m, o, t.mode, l]), g = U(
    () => Bw(p, i),
    [p, i]
  ), k = U(() => {
    ...
    const E = [];
    return t.projects.forEach((N) => {
      const y = t.openTabs.filter((S) => S.projectId === N.id);
      if (y.length === 0) {
        E.push({ projectId: N.id });
        return;
      }
      const _ = /* @__PURE__ */ new Set();
      y.forEach((S) => {
        _.has(S.scrollGroupId) || (_.add(S.scrollGroupId), E.push({ projectId: N.id, scrollGroupId: S.scrollGroupId }));
      });
    }), E;
  }, [t.mode, t.projects, t.openTabs]), v = (E) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const N = t.selection.pairs, y = (S) => S.projectId === E.projectId && S.scrollGroupId === E.scrollGroupId, _ = N.some(y) ? N.filter((S) => !y(S)) : [...N, { projectId: E.projectId, scrollGroupId: E.scrollGroupId }];
      ...
      case "projectScrollGroup": {
        ...
        const N = t.selection.scrollGroupId ?? 0;
        t.onChangeSelection({ projectId: E.projectId, scrollGroupId: N }), t.onOpenProjectInGroup(E.projectId, N), r(!1);
      }
    }
  }, x = () => {
    if (t.mode !== "project-multi") return;
    const E = t.selection.pairs, N = new Set(E.map((_) => `${_.projectId}:${_.scrollGroupId ?? ""}`)), y = [...E];
    k.forEach((_) => {
      const S = `${_.projectId}:${_.scrollGroupId ?? ""}`;
      N.has(S) || (N.add(S), y.push(_));
    ...
    switch (t.mode) {
      case "project": {
        const E = t.projects.find((y) => y.id === t.selection.projectId), N = E ? E.shortName : t.buttonPlaceholder ?? "";
      ...
      case "project-multi": {
        ...
        const N = [];
        if (E.forEach((S) => {
          const D = t.projects.find((j) => j.id === S.projectId);
          D && N.push({ project: D, scrollGroupId: S.scrollGroupId });
        }), N.length === 0) {
          const S = t.buttonPlaceholder ?? "";
          return { node: S, title: S };
        }
        if (t.getSelectedText) {
          const S = t.getSelectedText(N);
          return { node: S, title: S };
        }
        const y = N.map(
          ({ project: S, scrollGroupId: D }) => D === void 0 ? S.shortName : `${S.shortName} (${Ar(D)})`
        ).join(", ");
        if (N.length === 1) return { node: y, title: y };
        const _ = N.length.toString();
        return {
          node: /* @__PURE__ */ w(rt, { children: [
            /* @__PURE__ */ a(ye, { variant: "muted", className: "tw:shrink-0", children: _ }),
            /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:truncate", children: y })
          ] }),
          title: `${_} ${y}`
        };
      }
      case "projectScrollGroup": {
        const E = t.projects.find((_) => _.id === t.selection.projectId);
        if (!E) {
          const _ = t.buttonPlaceholder ?? "";
          return { node: _, title: _ };
        }
        const N = t.selection.scrollGroupId;
        if (N === void 0)
          return { node: E.shortName, title: E.shortName };
        const y = `${E.shortName} · ${Ar(N)}`;
        return { node: y, title: y };
      }
      default:
        return { node: "", title: "" };
    }
  }, [t]), O = t.mode === "project-multi" ? /* @__PURE__ */ a(so, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : /* @__PURE__ */ a(tr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }), M = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? v : void 0;
  return /* @__PURE__ */ w(Ce, { open: e, onOpenChange: u, children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ w(
      G,
      {
        ...
        children: [
          /* @__PURE__ */ a("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof T.node == "string" ? /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:truncate", children: T.node }) : T.node }),
          O
        ]
      }
    ) }),
      ...
      Ee,
      {
        ...
        children: /* @__PURE__ */ a(It, { delayDuration: 400, children: /* @__PURE__ */ w($e, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ w("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: x, children: `${h.selectAll} (${k.length.toString()})` }),
            /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: C, children: `${h.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ w(Ae, { children: [
            /* @__PURE__ */ a(Lr, { children: t.commandEmptyMessage ?? "No projects found" }),
            g.map((E, N) => /* @__PURE__ */ w(ao, { children: [
              /* @__PURE__ */ a(be, { heading: Yw(E, h), children: E.rows.map((y) => /* @__PURE__ */ a(
                qw,
                {
                  row: y,
                  mode: t.mode,
...
function kh({ id: t, label: e, groups: r }) {
  const [o, n] = I(
    ...
    s((m) => (m[c] = u, { ...m }));
    const h = r[c].items.find((m) => m.id === u);
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ w(ce, { children: [
    ...
    /* @__PURE__ */ a(we, { children: r.map((c, u) => /* @__PURE__ */ w("div", { children: [
      ...
      /* @__PURE__ */ a(Ki, { children: c.itemType === 0 ? /* @__PURE__ */ a(rt, { children: c.items.map((h, m) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        fe,
        {
          checked: o[u][m],
        ...
        {
          value: i[u],
          onValueChange: (h) => d(u, h),
          children: c.items.map((h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Cw, { value: h.id, children: h.label }) }, h.id))
        }
      ) }),
      /* @__PURE__ */ a(Ue, {})
    ] }, c.label)) })
...
function Nh({
  ...
  }).format(Object.values(r).reduce((u, h) => u + h, 0)), c = () => {
...
function Qw({ id: t, versionHistory: e }) {
  ...
  function i(l) {
    const d = new Date(l), c = new Date(n.getTime() - d.getTime()), u = c.getUTCFullYear() - 1970, h = c.getUTCMonth(), m = c.getUTCDate() - 1;
    let p = "";
    return u > 0 ? p = `${u.toString()} year${u === 1 ? "" : "s"} ago` : h > 0 ? p = `${h.toString()} month${h === 1 ? "" : "s"} ago` : m === 0 ? p = "today" : p = `${m.toString()} day${m === 1 ? "" : "s"} ago`, p;
  }
...
function tu({
  ...
  const [b, x] = I(!1), C = P(
    (_) => {
      var D;
      const S = (D = t.find((j) => j.label === _)) == null ? void 0 : D.value;
      S && r(
        e.includes(S) ? e.filter((j) => j !== S) : [...e, S]
      );
    },
    [t, e, r]
  ), T = () => d || o, O = U(() => {
    if (!m) return t;
    const _ = t.filter((D) => D.starred).sort((D, j) => D.label.localeCompare(j.label)), S = t.filter((D) => !D.starred).sort((D, j) => {
      const L = e.includes(D.value), H = e.includes(j.value);
      return L && !H ? -1 : !L && H ? 1 : D.label.localeCompare(j.label);
    });
    return [..._, ...S];
  }, [t, e, m]), M = () => {
    r(t.map((_) => _.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: g, children: /* @__PURE__ */ w(Ce, { open: N, onOpenChange: u ?? x, children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ w(
      G,
      {
        variant: k,
    ...
    /* @__PURE__ */ a(Ee, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ w($e, { children: [
      ...
      n && /* @__PURE__ */ w("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: M, children: i }),
        /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: E, children: s })
      ] }),
      /* @__PURE__ */ w(Ae, { children: [
        /* @__PURE__ */ a(Lr, { children: l }),
        /* @__PURE__ */ a(be, { children: O.map((_) => /* @__PURE__ */ w(
          _e,
          {
            value: _.label,
            onSelect: C,
            ...
            children: [
              ...
              _.starred && /* @__PURE__ */ a(il, { className: "tw:h-4 tw:w-4" }),
...
function Ch({
  ...
  return /* @__PURE__ */ w("div", { id: h, className: "tw:flex tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ a(
      tu,
      {
        entries: t,
...
function au({
  ...
  return W(() => {
    ...
    const i = /Macintosh/i.test(navigator.userAgent), s = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, l = (c) => {
      ...
      if (i) {
        if (!c.metaKey) return;
        !c.shiftKey && u === "z" ? (c.preventDefault(), r && ((h = e.current) == null || h.undo())) : c.shiftKey && u === "z" && (c.preventDefault(), o && ((m = e.current) == null || m.redo()));
      } else {
        if (!c.ctrlKey) return;
        !c.shiftKey && u === "z" ? (c.preventDefault(), r && ((p = e.current) == null || p.undo())) : (u === "y" || c.shiftKey && u === "z") && (c.preventDefault(), o && ((g = e.current) == null || g.redo()));
      }
    };
...
function nu({
  ...
  const i = F(null), s = F(null), l = F(!1), [d, c] = I(t), [u, h] = I(r), [m, p] = I(!1);
  W(() => {
    c(t);
  }, [t]), W(() => {
    u !== r && h(r);
  ...
  const g = (v) => {
    l.current = !1, p(v), v || (d !== "custom" || u ? (e(d), o(u)) : (c(t), h(r)));
  }, k = (v) => {
    var b, x, C, T;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((b = i.current) == null || b.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((x = s.current) == null || x.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((C = i.current) == null ? void 0 : C.selectionStart) === 0 && ((T = s.current) == null || T.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ w(ce, { open: m, onOpenChange: g, children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ w(Dt, { children: [
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            fe,
            {
              ...
              onClick: (v) => {
                var b;
                v.stopPropagation(), l.current = !0, (b = i.current) == null || b.focus();
              },
...
function wu({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = I(""), [i, s] = U(() => {
    ...
    const d = e.filter(
      (u) => {
        var h;
        return (h = u.marker) == null ? void 0 : h.toLowerCase().includes(l);
      }
    ), c = e.filter(
...
function Eh({
  ...
  const u = F(null), h = F(null), m = F(null), p = F(null);
  ee(() => {
    if (!p.current) return;
    const { width: B } = p.current.getBoundingClientRect();
    B > 0 && (p.current.style.width = `${B}px`);
  }, []);
  const [g, k] = I("generated"), [v, b] = I("generated"), [x, C] = I("*"), [T, O] = I("*"), [M, E] = I("f"), [N, y] = I(!1), [_, S] = I(!0), [D, j] = I(!1), L = F(!1), H = F(""), [R, X] = I(!1), [pt, K] = I(), [it, J] = I(), [at, q] = I(), [st, ct] = I(), dt = F(null), wt = U(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (Z && Kr("note", Z)) {
      ...
      let Nt = "custom";
      vt === Ga ? Nt = "generated" : vt === Ua ? Nt = "hidden" : vt && (C(vt), O(vt)), k(Nt), b(Nt), E(((lt = Z.insert.note) == null ? void 0 : lt.style) ?? "f"), B = setTimeout(() => {
        var _t;
  ...
  ee(() => {
    (A.current.book !== n.book || A.current.chapterNum !== n.chapterNum) && (A.current = { book: n.book, chapterNum: n.chapterNum }, Yt.current());
  }, [n.book, n.chapterNum]);
  const Pt = () => {
    var Z;
    const B = (Z = h.current) == null ? void 0 : Z.getElementsByClassName("editor-input")[0];
    ...
    if (Z && Kr("note", Z)) {
      ...
      M !== "x" && B === "x" ? bt == null || bt.forEach((Tt) => pu(Tt)) : M === "x" && B !== "x" && (bt == null || bt.forEach((Tt) => hu(Tt))), (_t = u.current) == null || _t.applyUpdate([Z, { delete: 1 }]);
    }
  }, jt = (B) => {
    ct(B.contextMarker), j(B.canRedo);
  }, Le = P(
    (B) => {
      var ut, lt, vt, Nt, _t;
      const Z = (lt = (ut = u.current) == null ? void 0 : ut.getNoteOps(0)) == null ? void 0 : lt.at(0);
      if (Z && Kr("note", Z)) {
        B.content.length > 1 && setTimeout(() => {
          var $;
          ($ = u.current) == null || $.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const bt = (vt = Z.insert.note) == null ? void 0 : vt.style, Tt = (_t = (Nt = Z.insert.note) == null ? void 0 : Nt.contents) == null ? void 0 : _t.ops;
        if (bt || y(!1), y(
          bt === "x" ? !!(Tt != null && Tt.every(($) => {
            var mt, Ct;
            if (!((mt = $.attributes) != null && mt.char)) return !0;
            const ft = ((Ct = $.attributes) == null ? void 0 : Ct.char).style;
          ...
          L.current = !0, H.current = JSON.stringify(Z), S(!0);
          return;
        }
        S(JSON.stringify(Z) === H.current), yt(g, x);
      } else
        y(!1), S(!0);
    },
    [g, x, yt]
  ...
  W(() => {
    ...
    var ut;
    const B = ((ut = h.current) == null ? void 0 : ut.querySelector(".editor-input")) ?? void 0, Z = (lt) => {
...
function vu({
  ...
  /* @__PURE__ */ w("span", { className: f("note-caller tw:inline-block", { formatted: i }), children: [
    n,
    " "
  ] }), h = s && /* @__PURE__ */ w(rt, { children: [
    Do(t.marker, [s], o, !1),
    " "
  ] }), m = e === "horizontal" ? "horizontal" : "vertical", p = o ? "marker-visible" : "", g = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", k = f(m, p);
  return /* @__PURE__ */ w(rt, { children: [
    /* @__PURE__ */ w("div", { className: f("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: [
      d,
      u
    ] }),
    /* @__PURE__ */ a("div", { className: f("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: h }),
    /* @__PURE__ */ a(
      "div",
      {
        className: f(
...
function zh({
  ...
  const u = d ?? Bs(r, void 0), h = (x, C) => {
    c == null || c(x, C, n);
  }, m = i ? r.findIndex((x) => x === i) : -1, [p, g] = I(m), k = (x, C, T) => {
    if (r.length)
      switch (x.key) {
        case "Enter":
        case " ":
          x.preventDefault(), c == null || c(C, T, n);
          break;
      }
  }, v = (x) => {
    if (r.length)
      switch (x.key) {
        case "ArrowDown":
          x.preventDefault(), g((C) => Math.min(C + 1, r.length - 1));
          break;
        case "ArrowUp":
  ...
  return W(() => {
    var x;
    p >= 0 && p < b.current.length && ((x = b.current[p]) == null || x.focus());
  }, [p]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((x, C) => {
            ...
            return /* @__PURE__ */ w(rt, { children: [
              ...
              C < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(le, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
const yu = (t) => {
  ...
  return e ? e[1] : "";
}, Nu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Oh = Object.freeze([
...
function Mh({
  ...
  const p = pe(r, "%webView_inventory_all%"), g = pe(r, "%webView_inventory_approved%"), k = pe(r, "%webView_inventory_unapproved%"), v = pe(r, "%webView_inventory_unknown%"), b = pe(r, "%webView_inventory_scope_currentBook%"), x = pe(r, "%webView_inventory_scope_chapter%"), C = pe(r, "%webView_inventory_scope_verse%"), T = pe(r, "%webView_inventory_filter_text%"), O = pe(
    r,
    "%webView_inventory_show_additional_items%"
  ), M = pe(r, "%webView_inventory_no_results%"), [E, N] = I(!1), [y, _] = I("all"), [S, D] = I(""), [j, L] = I([]), H = U(() => {
    const q = t ?? [];
  ...
  }, [E, H]), X = U(() => R.length === 0 ? [] : _u(R, y, S), [R, y, S]), pt = U(() => {
    var ct, dt;
    if (!E) return d;
  ...
  return /* @__PURE__ */ a("div", { id: c, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ w("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ w("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        pr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ w(fr, { children: [
              ...
              /* @__PURE__ */ a(ie, { value: "approved", children: g }),
      ...
      /* @__PURE__ */ w(pr, { onValueChange: (q) => it(q), defaultValue: s, children: [
        ...
        /* @__PURE__ */ w(fr, { children: [
          /* @__PURE__ */ a(ie, { value: "book", children: b }),
          /* @__PURE__ */ a(ie, { value: "chapter", children: x }),
      ...
      o && /* @__PURE__ */ a(It, { children: /* @__PURE__ */ w(Dt, { children: [
        /* @__PURE__ */ a(Rt, { asChild: !0, children: /* @__PURE__ */ w("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(zt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? O })
        ] }) }),
        /* @__PURE__ */ a($t, { children: (o == null ? void 0 : o.checkboxText) ?? O })
      ] }) })
    ] }),
...
function zu({
  ...
  const [d, c] = nt.useState(t), u = e ?? d, h = nt.useCallback(
    (C) => {
      const T = typeof C == "function" ? C(u) : C;
      r ? r(T) : c(T);
    },
    [r, u]
  ), m = nt.useCallback(() => h((C) => !C), [h]), p = u ? "expanded" : "collapsed", v = kt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", b = nt.useMemo(
    () => ({
      state: p,
      open: u,
      setOpen: h,
  ...
  return /* @__PURE__ */ a(Wi.Provider, { value: b, children: /* @__PURE__ */ a(
    "div",
    {
...
function Mu({
  ...
  const c = P(
    ...
    (p) => {
      const g = r.find((k) => k.projectId === p);
      return g ? g.projectName : p;
    },
    [r]
  ), h = U(
    () => r.map((p) => ({
    ...
    Su,
    {
      ...
      children: /* @__PURE__ */ w(Du, { children: [
        /* @__PURE__ */ w(zn, { children: [
          ...
          /* @__PURE__ */ a(In, { children: /* @__PURE__ */ a(Ru, { children: Object.entries(e).map(([p, g]) => /* @__PURE__ */ a($u, { children: /* @__PURE__ */ a(
            Ou,
            {
              onClick: () => c(p),
              isActive: m(p),
...
function Jh({
  ...
  const [c, u] = I([]), [h, m] = I([{ id: je, desc: !1 }]), [p, g] = I({}), k = U(
    () => t.flatMap((y) => y.data.map((_) => ({
      ..._,
      source: y.source
    }))),
    [t]
  ...
  W(() => {
    if (l) {
      const y = b.getSelectedRowModel().rowsById, _ = Object.keys(y);
      if (_.length === 1) {
        const S = k.find((D) => Dn(D) === _[0]) || void 0;
        S && l(S);
      }
    }
  }, [p, k, l, b]);
  const x = n ?? Vu, C = i ?? Yi, T = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [je] },
    ...
    !y.getIsGrouped() && !y.getIsSelected() && y.getToggleSelectedHandler()(_);
  }, E = (y, _) => y.getIsGrouped() ? "" : f("banded-row", _ % 2 === 0 ? "even" : "odd"), N = (y, _, S) => {
    if (!((y == null ? void 0 : y.length) === 0 || _.depth < S.column.getGroupedIndex())) {
      if (_.getIsGrouped())
        switch (_.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ w(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(Dw, { children: T.map((y) => /* @__PURE__ */ a(ie, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ w(zo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(So, { children: b.getHeaderGroups().map((y) => /* @__PURE__ */ a(Be, { children: y.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ca, { colSpan: _.colSpan, className: "tw:sticky top-0", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ w("div", { children: [
      ...
      /* @__PURE__ */ a(Io, { children: b.getRowModel().rows.map((y, _) => {
        const S = kt();
        return /* @__PURE__ */ a(
          Be,
          {
            ...
            children: y.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  wr,
                  {
                    className: f(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ w(
                      G,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (S === "ltr" ? /* @__PURE__ */ a(Fe, {}) : /* @__PURE__ */ a(Va, {})),
                          " ",
...
function Ku({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], u = o["%webView_book_selector_no_book_found%"], h = o["%webView_book_selector_more%"], { otLong: m, ntLong: p, dcLong: g, extraLong: k } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, b] = I(!1), [x, C] = I(""), T = F(void 0), O = F(!1);
  if (t.length !== gt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const M = U(() => gt.allBookIds.filter(
    ...
    (L, H = !1) => {
      ...
      const R = M.findIndex((J) => J === T.current), X = M.findIndex((J) => J === L);
      if (R === -1 || X === -1) return;
      const [pt, K] = [
        Math.min(R, X),
        Math.max(R, X)
      ], it = M.slice(pt, K + 1).map((J) => J);
      r(
    ...
    N(L, O.current), O.current = !1;
  }, _ = (L, H) => {
    L.preventDefault(), N(H, L.shiftKey);
  }, S = P(
    (L) => {
      const H = $o(M, L).map((R) => R);
      r(
        Xi(M, L, e) ? e.filter((R) => !H.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, r, M]
  ), D = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ee, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ w(
            $e,
            {
              shouldFilter: !1,
              onKeyDown: (L) => {
                L.key === "Enter" && (O.current = L.shiftKey);
              },
              children: [
                /* @__PURE__ */ a(
                  vr,
                ...
                /* @__PURE__ */ w("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: D, children: d }),
                  /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: j, children: c })
                ] }),
                /* @__PURE__ */ w(Ae, { children: [
...
function Qh({
  ...
  const T = Ot(
    s,
    "%webView_scope_selector_selected_text%"
  ), O = Ot(s, "%webView_scope_selector_verse%"), M = Ot(s, "%webView_scope_selector_chapter%"), E = Ot(s, "%webView_scope_selector_book%"), N = Ot(
    s,
    "%webView_scope_selector_current_verse%"
  ), y = Ot(
    s,
    "%webView_scope_selector_current_chapter%"
  ), _ = Ot(s, "%webView_scope_selector_current_book%"), S = Ot(s, "%webView_scope_selector_choose_books%"), D = Ot(s, "%webView_scope_selector_scope%"), j = Ot(s, "%webView_scope_selector_select_books%"), L = Ot(s, "%webView_scope_selector_range%"), H = Ot(s, "%webView_scope_selector_select_range%"), R = Ot(s, "%webView_scope_selector_range_start%"), X = Ot(s, "%webView_scope_selector_range_end%"), pt = Ot(s, "%webView_scope_selector_ok%"), K = Ot(s, "%webView_scope_selector_cancel%"), it = Ot(s, "%webView_scope_selector_navigate%"), J = (V) => {
    if (!g) return;
  ...
  ], q = (V, Q, qt = !1) => /* @__PURE__ */ w(rt, { children: [
    V,
    Q && !qt && /* @__PURE__ */ w("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Q
    ] })
  ] }), st = e ? at.filter((V) => e.includes(V.value)) : at, ct = g ?? ba, dt = u ?? ct, wt = h ?? ct, Ut = () => {
  }, yt = F(null), Wt = F(null), Yt = F(!1), A = F(null), Pt = F(!1), [Kt, ne] = I(void 0), Xt = F(!1), jt = F(!1), Le = F(null), Jt = P((V) => {
    if (V) {
    ...
    (V) => {
      m == null || m(V), p == null || p(V), Xt.current = !0;
    },
    [m, p]
  ), Z = P(
    (V) => {
      p == null || p(V), jt.current = !0;
    },
    [p]
  ), ut = P(
    (V) => {
      r(V), V === "selectedBooks" && n.length === 0 && (g != null && g.book) && i([g.book]);
    },
    [r, n, g, i]
  ), lt = st.find((V) => V.value === t), vt = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? Gs(dt, wt, {
  ...
  ), _t = st.find((V) => V.value === "selectedBooks"), bt = st.find((V) => V.value === "range"), [Tt, $] = I(!1), [ft, mt] = I(void 0), [Ct, He] = I(void 0), [Pe, xr] = I(void 0), [We, yr] = I(void 0), [kr, Pr] = I([]), jr = c === "dropdown" && ft === "selectedBooks", z = /* @__PURE__ */ a(
    Ku,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ w("div", { ref: yt, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ka,
        {
          ...
          onCloseAutoFocus: (V) => {
            var Q;
            jt.current && (jt.current = !1, V.preventDefault(), (Q = Le.current) == null || Q.focus());
          },
          className: f(tt && St),
          modal: !0,
          align: "start"
  ...
  W(() => {
    ...
    return V.observe(Br), () => V.disconnect();
  }, [Br]);
  const Oo = P(
    (V) => {
      He(V), xr(dt), yr(wt), Pr(n), $(!1), mt(V);
    },
    [dt, wt, n]
  ), Mo = P(() => {
    ...
    V || (mt(void 0), He(void 0));
  }, []), Lo = P((V) => {
    var Q;
    V.preventDefault(), (Q = Qt.current) == null || Q.focus();
  }, []), Po = (V) => t === V ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ge, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ w("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ w("div", { className: "tw:grid tw:gap-2", children: [
      !x && /* @__PURE__ */ a(zt, { children: D }),
      c === "dropdown" ? /* @__PURE__ */ w(ce, { open: Tt, onOpenChange: $, children: [
        ...
        /* @__PURE__ */ a(
          we,
          {
            ...
            children: /* @__PURE__ */ w(xa, { container: Br, children: [
              Nt.map(({ value: V, label: Q, dropdownLabel: qt, scrRefSuffix: _r, id: ps }) => /* @__PURE__ */ w(
                Qe,
                {
                  ref: xt(V),
                  ...
                  children: [
                    t === V && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ge, { className: "tw:h-4 tw:w-4" }) }),
                    q(qt ?? Q, _r, ws)
                  ]
                },
                ps
              ...
              k && /* @__PURE__ */ w(rt, { children: [
                ...
                /* @__PURE__ */ a(
                  Qe,
                  {
                    ...
                    onSelect: (V) => {
                      var Q, qt;
                      if (V.preventDefault(), Yt.current) {
                        Yt.current = !1;
                        return;
                      }
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ka,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var Q;
                              V.preventDefault(), (Q = A.current) == null || Q.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ w(rt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ze(g ?? ba, "id") }),
                              /* @__PURE__ */ a(tr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        gi,
        {
          ...
          children: st.map(({ value: V, label: Q, scrRefSuffix: qt, id: _r }) => /* @__PURE__ */ w("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Xa, { className: "tw:me-2", value: V, id: _r }),
    ...
    c === "dropdown" && _t && /* @__PURE__ */ a(qa, { open: ft === "selectedBooks", onOpenChange: Fr, children: /* @__PURE__ */ a(
      Ha,
      {
        ...
        onCloseAutoFocus: Lo,
        onEscapeKeyDown: (V) => {
          Vr != null && Vr.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ w(xa, { container: Vr, children: [
          /* @__PURE__ */ a(Wa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ya, { children: S }) }),
          z,
    ...
    c === "dropdown" && bt && /* @__PURE__ */ a(qa, { open: ft === "range", onOpenChange: Fr, children: /* @__PURE__ */ a(
      Ha,
      {
        ...
        onCloseAutoFocus: Lo,
        onEscapeKeyDown: (V) => {
          te != null && te.querySelector('[data-state="open"]') && V.preventDefault();
        },
...
function eo({
  ...
  return /* @__PURE__ */ w(ce, { variant: i, children: [
    ...
    /* @__PURE__ */ a(we, { align: "start", style: { zIndex: Or }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, c]) => typeof d == "boolean" || typeof c == "boolean" ? 0 : d.order - c.order).map(([d], c, u) => /* @__PURE__ */ w(ao, { children: [
...
function op({
  ...
  if (_c(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, h) => {
    var g, k, v, b;
    u.preventDefault();
    ...
    switch (h.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = i.current) == null || g.focus(), Er(i, [m, p]);
        break;
      case "alt+l":
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (b = d.current) == null || b.focus(), Er(d, [m, p]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(Wu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, h]) => typeof u == "boolean" || typeof h == "boolean" ? 0 : u.order - h.order).map(([u, h]) => /* @__PURE__ */ w(Yu, { children: [
      /* @__PURE__ */ a(Ju, { ref: c(u), children: typeof h == "object" && "label" in h && h.label }),
      /* @__PURE__ */ a(
        Zu,
        {
          style: { zIndex: Or },
...
function cg({
  ...
  const c = np(
    ...
    n && n(g), o && o([g, ...r.filter((k) => k !== g)]), i && r.find((k) => k === g) && i([...r.filter((k) => k !== g)]), h(!1);
  }, p = (g, k) => {
    var b, x, C, T, O, M;
    const v = k !== g ? ((x = (b = t[g]) == null ? void 0 : b.uiNames) == null ? void 0 : x[k]) ?? ((T = (C = t[g]) == null ? void 0 : C.uiNames) == null ? void 0 : T.en) : void 0;
    return v ? `${(O = t[g]) == null ? void 0 : O.autonym} (${v})` : (M = t[g]) == null ? void 0 : M.autonym;
  };
      ...
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: Or },
              children: Object.keys(t).map((g) => /* @__PURE__ */ a(ie, { value: g, children: p(g, e) }, g))
            }
          )
        ]
      }
...
function Ao({
  ...
  const [m, p] = I(), g = F(null), k = n ?? m, v = U(
    () => m ? t.find((D) => D.id === m) : void 0,
    [m, t]
  ), b = U(() => t.map((D) => ({ id: D.id })), [t]), x = (D) => {
    o == null || o(D), r && p(D.id === m ? void 0 : D.id);
  }, C = (D) => {
    const j = t.find((L) => L.id === D.id);
    j && x(j);
  }, { listboxRef: T, activeId: O, handleKeyDown: M, focusOption: E } = Eo({
    options: b,
    onOptionSelect: C,
    onCharacterPress: u
  }), N = () => {
    const D = m;
    p(void 0), D && requestAnimationFrame(() => {
      var j;
      E(D), (j = T.current) == null || j.focus();
    });
  }, y = F(null);
  if (W(() => {
    if (!v) return;
    ...
    return D.addEventListener("keydown", j), () => D.removeEventListener("keydown", j);
  }, [v]), s)
    return /* @__PURE__ */ a("div", { className: f("tw:flex tw:flex-col tw:gap-2 tw:p-2", h), children: Array.from({ length: 6 }, (D, j) => /* @__PURE__ */ a(
      $r,
      {
      ...
      children: t.map((D) => {
        ...
        return /* @__PURE__ */ a(
          "li",
          {
            ...
            onClick: () => x(D),
            onKeyDown: (L) => {
              (L.key === "Enter" || L.key === " ") && (L.preventDefault(), x(D));
            },
            className: f(
  ...
  return /* @__PURE__ */ a(
    ...
    {
      ref: g,
      className: f("tw:relative tw:flex tw:h-full tw:overflow-hidden", h),
      children: S ? (
        ...
        /* @__PURE__ */ w(os, { direction: "horizontal", className: "tw:h-full tw:w-full", children: [
          /* @__PURE__ */ a(wa, { defaultSize: 33.3333, minSize: 20, children: /* @__PURE__ */ a("div", { className: "tw:h-full tw:overflow-y-auto", children: _ }) }),
          /* @__PURE__ */ a(ns, {}),
      ...
      ) : /* @__PURE__ */ a("div", { className: "tw:h-full tw:w-full tw:overflow-y-auto", children: _ })
    }
  );
}
function ip({
...
function ug({
  ...
  const [m, p] = I(n), [g, k] = I(-1), v = F(null), b = F(null), [x, C] = I(!1), [T, O] = I(0);
  W(() => {
    const K = v.current;
    if (!K) return;
  ...
  const M = T > 0 ? lp / T * 100 : 20, E = T > 0 ? cp / T * 100 : 30;
  W(() => {
    var K;
  ...
  const N = P(
    ...
    [c]
  ), y = t.find((K) => K.id === m), _ = y && !x, S = y && x, D = P(
    (K) => {
    ...
    (K) => {
      ...
      const it = m ? t.findIndex((at) => at.id === m) : -1, J = g >= 0 ? g : it;
      if (K.key === "ArrowDown") {
        K.preventDefault();
        ...
        if (at === g) return;
        k(at), x || D(t[at]);
      } else (K.key === "Enter" || K.key === " ") && x && g >= 0 && (K.preventDefault(), D(t[g]));
    },
    [t, g, x, D, m]
  ), L = P(() => {
    const K = m;
  ...
  W(() => {
    if (g < 0 || !b.current) return;
    const K = b.current.children[g];
          ...
          /* @__PURE__ */ a(
            "li",
            {
              ...
              className: f("tw:cursor-pointer tw:border-b tw:p-2", {
                "tw:bg-muted": J,
                "tw:hover:bg-muted": !J,
                "tw:ring-1 tw:ring-inset tw:ring-ring": g === it && !J
              }),
  ...
  return /* @__PURE__ */ w("div", { className: f("tw:flex tw:h-full tw:flex-col tw:overflow-hidden", h), children: [
...
function wp({
  ...
  W(() => {
    const v = o.current, b = n.current;
    if (!v || !b) return;
    const x = () => {
      const T = v.clientWidth, O = Array.from(b.children).filter(
        (_) => _ instanceof HTMLElement
      );
      if (O.length === 0) return;
      if (O.reduce((_, S) => _ + S.offsetWidth, 0) <= T - 4) {
        s(0);
        return;
      }
      const E = O.map((_) => _.offsetWidth), N = t.length, y = 44;
      for (let _ = 1; _ < N; _ += 1) {
        let S = y;
        if (_ < N - 1) {
          S += E[0] ?? 0;
          for (let D = _ + 1; D < N; D += 1) S += E[D] ?? 0;
        } else
          S += E[N - 1] ?? 0;
        if (S <= T - 4) {
          s(_);
    ...
    return C.observe(v), x(), () => C.disconnect();
  }, [t]);
  const l = i > 0, d = i >= t.length - 1, u = l ? d ? t.slice(0, -1) : t.slice(1, i + 1) : [], h = u.map((v) => v.label).join(" > "), m = ((p = u[0]) == null ? void 0 : p.id) ?? ((g = t[0]) == null ? void 0 : g.id);
  return /* @__PURE__ */ w("div", { ref: o, className: "tw:overflow-hidden", children: [
    /* @__PURE__ */ a(
      "div",
      {
        ...
        "aria-hidden": !0,
        children: t.map((v, b) => /* @__PURE__ */ w("span", { className: "tw:flex tw:shrink-0 tw:items-center tw:gap-0.5", children: [
          b > 0 && /* @__PURE__ */ a(Fe, { className: "tw:h-3 tw:w-3" }),
    ...
    /* @__PURE__ */ w("div", { className: "tw:inline-flex tw:items-center tw:gap-0.5", children: [
      ...
      l && /* @__PURE__ */ w(rt, { children: [
        ...
        /* @__PURE__ */ a(It, { delayDuration: 0, children: /* @__PURE__ */ w(Dt, { children: [
          ...
          /* @__PURE__ */ a($t, { side: "bottom", children: /* @__PURE__ */ a("p", { className: "tw:text-xs", children: h }) })
        ] }) })
      ] }),
      t.map((v, b) => {
        if (b === 0) return;
        const x = b === t.length - 1;
        if (!(b <= i && !x))
...
function up({
  ...
  W(() => {
    const b = requestAnimationFrame(() => {
      var x;
      (x = s.current) == null || x.scrollIntoView({ block: "center" });
    });
    return () => cancelAnimationFrame(b);
  }, [r]);
  const l = () => i.current ? Array.from(i.current.querySelectorAll("button")) : [], d = (b) => {
    const x = l();
    if (x.length === 0) return;
    const C = document.activeElement;
    let O = (C instanceof HTMLButtonElement ? x.indexOf(C) : -1) + b;
    O < 0 && (O = x.length - 1), O >= x.length && (O = 0), x[O].focus();
  }, c = (b) => {
    const x = l();
    x.length !== 0 && x[b === "first" ? 0 : x.length - 1].focus();
  }, u = (b) => {
    let x = b;
    for (; x && x !== i.current; ) {
      if (x instanceof HTMLLIElement && x.getAttribute("role") === "treeitem") return x;
      x = x.parentElement;
    }
  }, h = (b) => {
    if (!b) return;
    const x = b.querySelector(":scope > div > button");
    x == null || x.focus();
  }, m = (b) => {
    const x = b.querySelector(':scope > ul[role="group"]');
    return x ? Array.from(x.children).filter(
      (C) => C instanceof HTMLLIElement && C.getAttribute("role") === "treeitem"
    ) : [];
  }, p = (b) => {
    const x = b.parentElement;
    if (!(x instanceof HTMLUListElement) || x.getAttribute("role") !== "group") return;
    const C = x.parentElement;
    return C instanceof HTMLLIElement && C.getAttribute("role") === "treeitem" ? C : void 0;
  }, g = (b) => {
    const x = b.getAttribute("aria-expanded");
    if (x === "false") {
      const C = b.querySelector(":scope > div > button");
      C == null || C.click();
    } else if (x === "true") {
      const [C] = m(b);
      h(C);
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { ref: i, onKeyDown: (b) => {
      switch (b.key) {
        case "ArrowDown":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), d(1);
          break;
        case "ArrowUp":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), d(-1);
          break;
        case "ArrowRight": {
          const x = u(document.activeElement);
          if (!x) break;
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), g(x);
          break;
        }
        case "ArrowLeft": {
          const x = u(document.activeElement);
          if (!x) break;
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), k(x);
          break;
        }
        case "Home":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), c("first");
          break;
        case "End":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), c("last");
          break;
        case "Tab":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), d(b.shiftKey ? -1 : 1);
          break;
        case "Escape":
          b.preventDefault(), b.stopPropagation(), b.nativeEvent.stopImmediatePropagation(), n();
          break;
      }
    }, children: /* @__PURE__ */ a(
      ss,
...
function ss({
  ...
  return /* @__PURE__ */ a(
    "ul",
    {
      ...
      children: t.map((d) => {
        const c = [...n, d], u = d.id === r, h = d.children && d.children.length > 0, p = is(d, r) && d.id !== r, g = d.id === r;
        return /* @__PURE__ */ a(
          pp,
          {
            domain: d,
  ...
  return /* @__PURE__ */ w(
    "li",
    {
      ...
      children: [
        ...
        h && t.children && t.children.length > 0 && /* @__PURE__ */ a(
          ss,
          {
            domains: t.children,
            currentPath: s,
...
function gg({
  ...
  const c = U(() => t.map((g) => ({ id: g.id })), [t]), u = (g) => {
    const k = t.find((v) => v.id === g.id);
    k && (e == null || e(k));
  }, { listboxRef: h, activeId: m, handleKeyDown: p } = Eo({
    options: c,
    onOptionSelect: u,
    onCharacterPress: i
  });
  return n ? /* @__PURE__ */ a("div", { className: f("tw:flex tw:flex-col tw:gap-2 tw:p-2", s), children: Array.from({ length: 6 }, (g, k) => /* @__PURE__ */ a(
    $r,
    {
        ...
        return /* @__PURE__ */ w("div", { children: [
          /* @__PURE__ */ w(
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ w("div", { className: "tw:flex tw:items-baseline tw:gap-2", children: [
                  /* @__PURE__ */ a("span", { className: "scripture-font tw:text-sm", children: g.primaryText }),
                  /* @__PURE__ */ a(It, { children: /* @__PURE__ */ w(Dt, { children: [
                    /* @__PURE__ */ a(Rt, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:ml-1 tw:cursor-help tw:rounded tw:bg-accent tw:px-1.5 tw:py-0.5 tw:text-xs", children: g.occurrenceCount }) }),
                    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: l }) })
                  ] }) })
                ] }),
                /* @__PURE__ */ w("div", { className: "tw:mt-0.5 tw:flex tw:items-center tw:gap-2 tw:overflow-hidden", children: [
                  /* @__PURE__ */ a("p", { className: "tw:truncate tw:text-sm tw:text-muted-foreground", children: g.glosses }),
                  g.strongsCodes.map((v) => /* @__PURE__ */ a(It, { children: /* @__PURE__ */ w(Dt, { children: [
        ...
        /* @__PURE__ */ w("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ w("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && m && c && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ w(ce, { children: [
              /* @__PURE__ */ a(de, { className: f(h && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(G, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ho, {}) }) }),
              /* @__PURE__ */ a(we, { align: "end", children: c })
            ] }) }),
...
function Hg({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    Ec,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(As, { className: "tw:size-4" }),
...
export {
  ...
  Wg as Slider,
  Hg as Sonner,
  Ao as SourceLanguageIndexedList,
  gp as Spinner,
  Yg as Switch,
