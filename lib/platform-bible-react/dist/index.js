...
var Wt = (t, e, r) => Ji(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as ve, a as _r, C as Se, u as Io, T as Mt, b as Ot, d as It, e as $t, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Zi, l as Qi, m as ts, I as es, n as io, r as we, o as rs, p as En, q as la, s as da, L as Et, R as so, t as ea, D as ja, v as Ba, w as Fa, y as Ua, z as co, E as Tn, F as lo, G as Je, H as Er, J as je, K as Be, M as Fe, S as Tr, N as nr, O as as, Q as zr, U as Ze, V as Oe, Z as tr, W as De, X as ir, Y as wo, _ as uo, $ as ra, a0 as po, a1 as Sn, a2 as os, a3 as ns, a4 as is, a5 as Ka, a6 as Rn, a7 as wa, a8 as ss, a9 as zn, aa as cs, ab as ls, ac as ds, ad as $o, ae as ws, af as us, ag as ps, ah as hs, ai as Dn, aj as Mn, ak as ho, al as gs, am as On, an as Na, ao as Po, ap as Ca, aq as fs, ar as ms, as as vs, at as bs, au as xs, av as Dr, aw as go, ax as ys, ay as ks } from "./resizable-C93ywfdf.js";
import { az as Sg, aA as Rg, aB as zg, aC as Dg, aD as Mg, aE as Og, aF as Ig, aG as $g, aH as Pg, aI as Ag, aJ as Vg, aK as Lg, aL as jg, aM as Bg, aN as Fg, aO as Ug, aP as Kg, aQ as Hg, aR as qg, aS as Gg, aT as Wg, aU as Yg, aV as Xg, aW as Jg, aX as Zg, aY as Qg, aZ as tf, a_ as ef, a$ as rf, b0 as af, b1 as of, b2 as nf, b3 as sf, b4 as cf, b5 as lf, b6 as df } from "./resizable-C93ywfdf.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as Dt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Ao, ChevronsLeft as Vo, ChevronsRight as Lo, ChevronLeft as Ha, ChevronRight as qa, ArrowLeft as _s, ArrowRight as Ns, ChevronDown as lr, BoldIcon as Cs, ItalicIcon as Es, X as fo, AtSign as In, Pencil as Ts, Trash2 as Ss, ArrowUp as $n, MoreHorizontal as Rs, MailOpen as zs, Mail as Ds, ChevronUp as Ms, FilterIcon as Os, ArrowLeftIcon as Is, ChevronLeftIcon as $s, ChevronRightIcon as Ps, ArrowRightIcon as As, Copy as Pn, Filter as Vs, User as Ls, Link as js, CircleHelp as Bs, Undo as Fs, Redo as Us, SquareX as An, FunctionSquare as Vn, SquareSigma as Ln, Ban as Ks, AlertCircle as Ga, CircleCheckIcon as Hs, CircleXIcon as qs, CircleHelpIcon as Gs, ArrowUpIcon as Ws, ArrowDownIcon as Ys, ScrollText as Xs, ChevronsUpDown as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as tc, MoreVertical as ec } from "lucide-react";
import { Section as Ct, getChaptersForBook as rc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as qr, formatRelativeDate as ac, sanitizeHtml as mo, NumberFormat as jn, formatBytes as oc, getCurrentLocale as nc, usfmMarkers as Gr, isPlatformError as ic, ABORTED as sc, getErrorMessage as cc, getFormatCallerFunction as lc, deepEqual as dc, isString as jo, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as wc, getLocalizeKeyForScrollGroupId as Bo, formatReplacementStringToArray as Fo, collectUsjMarkers as uc } from "platform-bible-utils";
import St, { useRef as F, useMemo as A, createContext as ua, useContext as vo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as pc, useLayoutEffect as te, Component as hc, createElement as Uo, Suspense as gc, forwardRef as Bn, useId as Ko, Fragment as pa } from "react";
import { IconSelector as Fn, IconCheck as ha, IconChevronDown as fc, IconChevronUp as mc, IconLayoutSidebar as vc, IconLayoutSidebarRight as bc, IconChevronRight as Un, IconSearch as xc, IconLoader as yc, IconAlertOctagon as kc, IconAlertTriangle as _c, IconInfoCircle as Nc, IconCircleCheck as Cc } from "@tabler/icons-react";
import { createEditor as Kn, $getRoot as $e, $createParagraphNode as Mr, $getSelection as ee, HISTORY_MERGE_TAG as bo, ParagraphNode as Hn, TextNode as qn, $getPreviousSelection as Ec, $isRangeSelection as xe, $caretFromPoint as Tc, $getSiblingCaret as Gn, $getChildCaret as Sc, $getAdjacentChildCaret as Rc, $isChildCaret as zc, $normalizeCaret as Dc, $setSelectionFromCaretRange as Mc, $getCollapsedCaretRange as Oc, $getCaretInDirection as Ho, $splitAtPointCaretNext as Ic, $isTextPointCaret as $c, $findMatchingParent as Wn, $isElementNode as Sr, mergeRegister as Te, getDOMTextNode as Pc, isHTMLElement as Ac, CLEAR_EDITOR_COMMAND as Yn, COMMAND_PRIORITY_EDITOR as xo, shallowMergeConfig as Vc, defineExtension as ne, safeCast as er, createState as Lc, FORMAT_TEXT_COMMAND as Xn, $isNodeSelection as Jn, COMMAND_PRIORITY_LOW as Zn, RootNode as jc, LineBreakNode as Bc, TabNode as Fc, $isEditorState as Uc, createCommand as Kc, CLICK_COMMAND as Hc, isDOMNode as qc, $getNodeFromDOMNode as Gc, $createNodeSelection as Wc, $setSelection as Yc, $getEditor as Xc, DecoratorNode as Ya, $getState as Jc, toggleTextFormatType as qo, TEXT_TYPE_TO_FORMAT as Zc, $setState as Qc, addClassNamesToElement as Qn, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as rl, KEY_TAB_COMMAND as al, $isBlockElementNode as ol, $createRangeSelection as nl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as Go, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as yo, $isDecoratorNode as ll, $isParagraphNode as dl, $isTextNode as Xa, SELECTION_CHANGE_COMMAND as ti, $insertNodes as wl } from "lexical";
...
import { ToggleGroup as ei, Avatar as ko, Select as Xt, Checkbox as Wo, Slot as Or, Tabs as ue, Menubar as ke, ContextMenu as Pt, Progress as Yo, Slider as Br, Switch as Xo } from "radix-ui";
...
import { useReactTable as ai, getFilteredRowModel as xl, getSortedRowModel as oi, getPaginationRowModel as yl, getCoreRowModel as ni, flexRender as Nr, getGroupedRowModel as kl, getExpandedRowModel as _l } from "@tanstack/react-table";
import Nl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ja, HIDDEN_NOTE_CALLER as Za, getDefaultViewOptions as Cl, isInsertEmbedOpOfType as xr, getMarkerMenuItems as El, defaultStyleInfo as Tl, Editorial as Sl } from "@eten-tech-foundation/platform-editor";
...
function Ra({
  ...
  const U = we(), V = Ml(), D = T ?? V, [K, Y] = _(!1), [H, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [q, nt] = _(void 0), [at, pt] = _(
    void 0
  ), [dt, J] = _(void 0), [wt, gt] = _(!1), [ft, mt] = _(!1), Jt = F(null), vt = F(!1), At = F(void 0), Vt = F(void 0), bt = F(void 0), Ft = F(void 0), Tt = F({}), Ut = F({}), ct = j(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
    ...
    () => Bl(kt, Lt),
    [kt, Lt]
  ), ae = Ht.has(t.book), Zt = A(() => I.trim() ? to(
    Kt.filter((k) => io(k, I, i))
  ) : ft ? se : ie, [
    ie,
    se,
    Kt,
  ...
  const { otLong: st, ntLong: ht, dcLong: xt, extraLong: _t } = {
    ...
    () => D >= Wr.TIGHT ? _r(t.book, i) : ve(t.book, i),
    [t.book, i, D]
    ...
    () => Vl(I),
    [I]
  ), fr = A(() => !w || !M || !M.chapterNum || !Pr ? !1 : w(M.book, M.chapterNum) > 0, [w, M, Pr]), Ar = N === "books" && !wt && !I.trim() && Ht.size > 0, mr = j(
    (k) => p ? Zo(k, p) : !1,
    [p]
  ), vr = j(
    (k) => (rt) => p ? Ll(k, rt, p) : !1,
    ...
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), h && h.includes(k.key) && M && M.chapterNum !== void 0 && M.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), jt());
    },
    [h, M, jt]
  ), Lr = j(
    (k) => {
      ...
      if ((N === "chapters" || N === "books" && M) && O) {
        const Gt = N === "chapters" ? q : M == null ? void 0 : M.book;
        if (!Gt) return;
        ...
        yt !== Rt && (k.preventDefault(), k.stopPropagation(), Q(
          `${Gt} ${de[Gt] || ""} ${yt}`
        ), setTimeout(() => {
    ...
    const { isLetter: rt, isDigit: ot } = Qo(k.key);
    (rt || ot) && (k.preventDefault(), tt((Z) => Z + k.key), Vt.current.focus(), gt(!1));
  }, []);
  return te(() => {
    const k = setTimeout(() => {
      if (K && N === "books" && bt.current && Ft.current) {
        const rt = bt.current, ot = Ft.current, O = ot.offsetTop, Z = rt.clientHeight, Nt = ot.clientHeight, ge = O - Z / 2 + Nt / 2;
        rt.scrollTo({
          top: Math.max(0, ge),
          behavior: "smooth"
        }), Q(si(t.book));
    ...
    if (N === "verses" && at && dt !== void 0) {
      ...
      Q(
        ...
        if (bt.current)
          if (k) {
            const ot = Ut.current[t.verseNum];
            ot && ot.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            bt.current.scrollTo({ top: 0 });
        At.current && At.current.focus();
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            Il,
            {
              primary: rr,
              secondary: He,
              showSecondary: D < Wr.MINIMUM,
              isPartial: D >= Wr.TIGHT,
              fullText: Ir
            }
          ),
          x && /* @__PURE__ */ a(
              ...
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    ...
                    tabIndex: -1,
                    children: U === "ltr" ? /* @__PURE__ */ a(_s, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ns, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                  ...
                  !M && Object.entries(Zt).map(([k, rt]) => {
                    if (rt.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Ee, { heading: Bt(k), children: rt.map((ot) => /* @__PURE__ */ a(
                          ii,
                          {
                            bookId: ot,
                            onSelect: (O) => pe(O),
                            ...
                            localizedBookNames: i,
                            disabled: mr(ot),
                            dimmedReason: Ht.has(ot) ? ba : void 0,
                            dimmedDescription: Ht.has(ot) ? xa(ot) : void 0
                          },
                          ot
                        )) }, k)
                      );
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = di ? te : W, Ur = { tag: bo };
    ...
    w.read(() => {
      ...
      if ((T || U) && E !== null && $ !== null) {
        const V = function(D, K, Y, H, Q, I, tt) {
          ...
          return N.setStart(...an(K, Y, H)), N.setEnd(...an(Q, I, tt)), N;
        }(t, h, f, E, g, R, $);
        l(), l = nd(t, V, e);
      }
...
function wd(t, e, r) {
  ...
  return $c(o) && aa(283), o.insert(t.isInline() ? Mr().append(t) : t), Ho(Gn(t.getLatest(), "next"), e.direction);
}
function ud(t) {
  const e = ee();
  if (!xe(e)) return !1;
...
let oa, Ce = 0, na = 0, gd = 0, ro = 0, Xr = 0;
function nn(t) {
  if (it === void 0) return;
  let e = t.n;
...
function md(t) {
  ...
  pi(this), it = t, this.f &= -2, 8 & this.f && To(this), ga();
}
function or(t, e) {
...
Yt.prototype.brand = pd, Yt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, hi(this), sn(this), Ce++;
  const t = it;
...
const Ma = Lc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class mi extends Ya {
  $config() {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [mi], register: (t, e, r) => t.registerCommand(Xn, (o) => {
  const n = ee();
  if (Jn(n) || xe(n)) for (const i of n.getNodes()) bd(i) && i.toggleFormat(o);
  return !1;
}, Zn) });
function vi(t, e) {
  let r;
...
const So = 0, oo = 1, xi = 2, Oa = 3, Kr = 4, ar = 5, Ia = 6, yr = 7;
function $a(t) {
  return t.id === So;
}
function yi(t) {
...
}, name: "@lexical/extension/InitialState", nodes: [jc, qn, Bc, Fc, Hn] }), ln = Symbol.for("@lexical/extension/LexicalBuilder");
function dn() {
}
function Cd(t) {
  throw t;
...
class cr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      $a(i) || ut(300, s, n || "[unknown]"), $a(c = i) || ut(304, String(c.id), String(So)), i = Object.assign(c, { id: oo }), o.state = i;
...
}, dependencies: [ao], name: "@lexical/extension/NodeSelection" }), Td = Kc("INSERT_HORIZONTAL_RULE_COMMAND");
class dr extends Ya {
  static getType() {
...
ne({ dependencies: [ao, wn], name: "@lexical/extension/HorizontalRule", nodes: () => [dr], register(t, e, r) {
  ...
  return Te(t.registerCommand(Td, (s) => {
    ...
    if (qc(s.target)) {
      ...
      if (Rd(c)) return function(l, d = !1) {
        ...
        let g;
        d && Jn(w) ? g = w : (g = Wc(), Yc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
ne({ build: (t, e, r) => gr(e), config: er({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ye(() => r.getOutput().disabled.value ? void 0 : Ni(t)) });
function $d(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const nw = "verseText", Dp = Object.freeze([
...
function Mp({
  ...
  const [i, s] = _(iw), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  W(() => {
    let v = !0;
    const R = h.current;
    if (!R) return;
...
function fn({
    ...
    if (o && c)
      return /* @__PURE__ */ u(lt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(ow(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(dw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(ww, { className: "tw:text-xs tw:font-medium", children: R }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : Mo(T) && (T.preventDefault(), T.stopPropagation(), oe(w) && f());
              },
              onKeyDown: (T) => {
...
function Vi({
  ...
  const [H, Q] = _(mn), [I, tt] = _(), [N, z] = _(), q = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, At] = _(E), [Vt, bt] = _(!1), Ft = F(void 0), [Tt, Ut] = _(/* @__PURE__ */ new Map());
  W(() => {
    let b = !0;
    return (async () => {
  ...
  const Lt = A(() => kt[0], [kt]), ie = F(null), se = F(void 0), Kt = j(() => {
    var b;
    (b = se.current) == null || b.call(se), Q(mn);
  }, []), Ke = j(() => {
    const b = !vt;
  ...
  }, [i, r]), Zt = A(() => kt.slice(1), [kt]), M = A(() => Zt.length ?? 0, [Zt.length]), ce = A(() => M > 0, [M]), jt = A(() => nt || M <= 2 ? Zt : Zt.slice(-2), [Zt, M, nt]), qt = A(() => nt || M <= 2 ? 0 : M - 2, [M, nt]), pe = A(
    () => M === 1 ? Ht.singleReply : Me(Ht.multipleReplies, { count: M }),
    [M, Ht]
  ), he = A(
  ...
  const S = j(
    async (b) => {
      ...
      L && await p({ threadId: l, contents: L }) && Kt();
    },
    [
      Kt,
      H,
    ...
    async (b) => {
      ...
      return et && (P !== void 0 && z(P), L && Kt()), et;
    },
    [Kt, H, p, I]
  );
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            ...
            v !== !1 && (!pt || oe(H)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (b) => {
                  Mo(b) && (b.preventDefault(), b.stopPropagation(), (oe(H) || I !== void 0 && I !== N) && S());
                },
                onKeyDown: (b) => {
...
), pw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Qr = (t) => pw(mo(t));
function ta({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function hw({
  ...
  const [s, c] = _("accept"), l = Ko(), d = Ko(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = A(
    () => Qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Qr(t.acceptedText ?? ""),
...
function bw(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = vw({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(bw, { ...q, conflictResolution: R }) : /* @__PURE__ */ a(Vi, { ...q })
          },
          z.id
        );
      })
...
function Cw({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, x] = _({}), [v, R] = _({}), y = A(() => e ?? [], [e]), C = ai({
    data: y,
    columns: t,
    getCoreRowModel: ni(),
...
function Dw({
  ...
  const l = lo(), d = bn(n, "%undoButton_tooltip%"), w = bn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(co, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
        X,
...
const Ow = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(lt, { children: [
...
function Iw({
  ...
  return /* @__PURE__ */ u(je, { open: p, onOpenChange: v, children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: Ow(t, o, e) }) }) }),
...
const $w = (t, e) => t === "f" ? /* @__PURE__ */ u(lt, { children: [
  /* @__PURE__ */ a(Vn, {}),
  " ",
...
function Aw({
  ...
  return /* @__PURE__ */ u(je, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: $w(t, r) }) }) }),
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: Pw(t, r) }) })
    ] }) }),
...
function xn({
  ...
  return /* @__PURE__ */ u(
    Se,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(jw, { state: t.selectionState }),
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Lw, { icon: t.icon }) }) }),
...
function Jp({
  ...
  const se = () => {
    ...
    if (B && xr("note", B)) {
      ...
      V !== "x" && S === "x" ? st == null || st.forEach((ht) => Kw(ht)) : V === "x" && S !== "x" && (st == null || st.forEach((ht) => Hw(ht))), (et = h.current) == null || et.applyUpdate([B, { delete: 1 }]);
    }
  }, Ht = (S) => {
    ...
    (S) => {
      ...
      if (B && xr("note", B)) {
        ...
        Q(JSON.stringify(B) === z.current), Ut();
      } else
        Y(!1), Q(!0);
    },
    [Ut]
    ...
    (S) => {
      ...
      ds(S, B, {
        ...
        commitTypedAndReopen: (b) => {
          var L;
          (L = h.current) == null || L.commitTypedMarker(b, { trailingSpace: !1 }), jt();
        },
        commitTypedCloser: (b) => {
          var L;
  ...
  return /* @__PURE__ */ u(lt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(lt, { children: Gw(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(po, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ir, { className: o, children: Xw(c.text) })
        ]
      },
...
function sh({
  ...
  }, [U, tt]), z = A(() => N.length === 0 ? [] : eu(N, D, Y), [N, D, Y]), q = A(() => {
    var gt, ft;
    if (!U) return l;
...
const au = "16rem", ou = "3rem", ji = St.createContext(void 0);
function ma() {
  const t = St.useContext(ji);
  if (!t)
...
function uu({
  ...
  const c = t ? Or.Root : "button", { state: l } = ma(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: m(wu({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    iu,
    {
      ...
      children: /* @__PURE__ */ u(cu, { children: [
        /* @__PURE__ */ u(yn, { children: [
          ...
          /* @__PURE__ */ a(_n, { children: /* @__PURE__ */ a(lu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(du, { children: /* @__PURE__ */ a(
            uu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const ze = "scrBook", hu = "scrRef", Xe = "source", gu = "details", fu = "Scripture Reference", mu = "Scripture Book", Bi = "Type", vu = "Details";
function bu(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: gu,
      header: (t == null ? void 0 : t.detailsColumnName) ?? vu,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, Nn = (t) => `${xu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function kh({
  sources: t,
  ...
  W(() => {
    if (c) {
      ...
      if (K.length === 1) {
        const Y = x.find((H) => Nn(H) === K[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, x, c, R]);
  const y = n ?? mu, C = i ?? Bi, E = [
    ...
    !e && /* @__PURE__ */ u(
      wr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { position: "item-aligned", children: /* @__PURE__ */ a(yw, { children: E.map((D) => /* @__PURE__ */ a(le, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
...
function Nh({
  ...
  const $ = zt(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = zt(s, "%webView_scope_selector_verse%"), U = zt(s, "%webView_scope_selector_chapter%"), V = zt(s, "%webView_scope_selector_book%"), D = zt(
    s,
    "%webView_scope_selector_current_verse%"
  ), K = zt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = zt(s, "%webView_scope_selector_current_book%"), H = zt(s, "%webView_scope_selector_choose_books%"), Q = zt(s, "%webView_scope_selector_scope%"), I = zt(s, "%webView_scope_selector_select_books%"), tt = zt(s, "%webView_scope_selector_range%"), N = zt(s, "%webView_scope_selector_select_range%"), z = zt(s, "%webView_scope_selector_range_start%"), q = zt(s, "%webView_scope_selector_range_end%"), nt = zt(s, "%webView_scope_selector_ok%"), at = zt(s, "%webView_scope_selector_cancel%"), pt = zt(s, "%webView_scope_selector_navigate%"), dt = (O) => {
    if (!x) return;
  ...
  }, At = F(null), Vt = F(null), bt = F(!1), Ft = F(null), Tt = F(!1), [Ut, ct] = _(void 0), kt = F(!1), Lt = F(!1), ie = F(null), se = j((O) => {
    if (O) {
  ...
  ), jt = gt.find((O) => O.value === "selectedBooks"), qt = gt.find((O) => O.value === "range"), [pe, he] = _(!1), [S, B] = _(void 0), [G, b] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", Bt = /* @__PURE__ */ a(
    Cu,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { ref: At, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        Ra,
        {
          ...
          onCloseAutoFocus: (O) => {
            var Z;
            Lt.current && (Lt.current = !1, O.preventDefault(), (Z = ie.current) == null || Z.focus());
          },
          className: m(Ir && rr),
          modal: !0,
          align: "start"
      ...
      w === "dropdown" ? /* @__PURE__ */ u(je, { open: pe, onOpenChange: he, children: [
        ...
        /* @__PURE__ */ a(
          Fe,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: We, children: [
              ce.map(({ value: O, label: Z, dropdownLabel: Nt, scrRefSuffix: ge, id: Gt }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: mr(O),
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          Ra,
                          {
                            ...
                            onCloseAutoFocus: (O) => {
                              var Z;
                              O.preventDefault(), (Z = Ft.current) == null || Z.focus();
                            },
                            modal: !0,
        ...
        so,
        {
          ...
          children: gt.map(({ value: O, label: Z, scrRefSuffix: Nt, id: ge }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ea, { className: "tw:me-2", value: O, id: ge }),
...
function no({
  ...
  return /* @__PURE__ */ u(je, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Fe, { align: "start", style: { zIndex: tr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(pa, { children: [
      /* @__PURE__ */ a(Sn, { children: /* @__PURE__ */ a(Mt, { children: Ui(e.groups, e.items, l, t) }) }),
...
const zu = Object.freeze([520, 420, 340]), Hi = St.forwardRef(
...
const qi = St.forwardRef(({ className: t, ...e }, r) => {
  const o = we();
  return /* @__PURE__ */ a(
    ue.Root,
    {
...
const Gi = St.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.List,
  {
    ref: r,
    className: m(
...
Gi.displayName = ue.List.displayName;
const Du = St.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.Trigger,
  {
    ref: r,
    ...e,
...
)), Wi = St.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ue.Content,
  {
    ref: r,
    className: m(
...
Wi.displayName = ue.Content.displayName;
function Dh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(qi, { children: [
      /* @__PURE__ */ a(Gi, { children: t.map((c) => /* @__PURE__ */ a(Du, { value: c.value, children: c.value }, c.key)) }),
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(ju, { children: d.label }),
        /* @__PURE__ */ a(Bu, { children: Yi(
          t,
          e,
          Fi(t, d.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(Vu, {}, `separator-${i}`)), l;
  });
};
function Fu({
  menuData: t,
  ...
  if (Rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Mu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Ou, { children: [
      /* @__PURE__ */ a($u, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        Pu,
        {
          style: { zIndex: tr },
          children: /* @__PURE__ */ a(Mt, { children: Yi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const Uu = Object.freeze([950, 800, 700]);
function Mh(t) {
  switch (t) {
    case void 0:
      return;
...
function fg({
  ...
  return /* @__PURE__ */ a(
    ue.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", Ju({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  le as SelectItem,
  Fp as SelectLabel,
  _w as SelectScrollDownButton,
  kw as SelectScrollUpButton,
  ...
  uu as SidebarMenuButton,
  du as SidebarMenuItem,
  ...
  zw as UNDO_REDO_BUTTONS_STRING_KEYS,
  ...
  lo as isMacOs,
  df as isWindows,
  Uw as markerMenuItemToPaletteItem,
