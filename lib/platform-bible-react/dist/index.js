...
import b, { forwardRef as nn, useRef as Y, useMemo as F, useState as R, useCallback as K, useLayoutEffect as Zt, createContext as kn, useContext as ur, useEffect as q, Component as ds, createElement as $r, Suspense as ps, Fragment as po } from "react";
import { Command as kt } from "cmdk";
import { X as $e, Search as uo, Check as Vt, Clock as Lr, ChevronsLeft as Vr, ChevronsRight as jr, ChevronLeft as Yn, ChevronRight as Se, ArrowLeft as us, ArrowRight as ms, Circle as _n, ChevronDown as Le, BoldIcon as fs, ItalicIcon as hs, AtSign as mo, Pencil as gs, Trash2 as bs, ArrowUp as fo, MoreHorizontal as vs, MailOpen as xs, Mail as ys, ChevronUp as ho, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as go, Filter as Ts, User as Rs, Link as Ss, CircleHelp as Ds, ChevronsUpDown as bo, Star as Ms, SquareX as vo, FunctionSquare as xo, SquareSigma as yo, Ban as Os, AlertCircle as Xn, CircleCheckIcon as Is, CircleXIcon as As, CircleHelpIcon as Ps, ArrowUpIcon as $s, ArrowDownIcon as Ls, PanelLeft as Vs, PanelRight as js, ScrollText as zs, MenuIcon as Fs, Menu as Bs, EllipsisVertical as Ks, MoreVertical as zr, LoaderCircle as Gs, GripVertical as qs } from "lucide-react";
...
import { includes as ln, Section as U, getChaptersForBook as Ys, formatScrRef as ve, getSectionForBook as He, formatRelativeDate as Xs, formatReplacementString as be, sanitizeHtml as Ws, NumberFormat as Js, formatBytes as Zs, getCurrentLocale as Qs, usfmMarkers as un, getFormatCallerFunction as ti, deepEqual as ei, isString as Fr, compareScrRefs as Wn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import { createEditor as ko, $getRoot as le, $createParagraphNode as Cn, $getSelection as Lt, HISTORY_MERGE_TAG as mr, ParagraphNode as _o, TextNode as Co, $isTokenOrSegmented as ni, $getCharacterOffsets as ri, $cloneWithPropertiesEphemeral as oi, $findMatchingParent as Eo, $isElementNode as se, $isRangeSelection as Ne, CLEAR_EDITOR_COMMAND as To, COMMAND_PRIORITY_EDITOR as Ro, mergeRegister as we, shallowMergeConfig as ai, defineExtension as Gt, safeCast as rn, createState as si, FORMAT_TEXT_COMMAND as So, $isNodeSelection as Do, COMMAND_PRIORITY_LOW as Mo, RootNode as ii, LineBreakNode as li, TabNode as wi, $isEditorState as ci, createCommand as di, CLICK_COMMAND as pi, isDOMNode as ui, $getNodeFromDOMNode as mi, $createNodeSelection as fi, $setSelection as hi, DecoratorNode as Jn, $getState as gi, toggleTextFormatType as Br, TEXT_TYPE_TO_FORMAT as bi, $setState as vi, addClassNamesToElement as Oo, $create as xi, $getNodeByKey as yi, removeClassNamesFromElement as Ni, KEY_TAB_COMMAND as ki, $isBlockElementNode as hn, $createRangeSelection as _i, $normalizeSelection__EXPERIMENTAL as Ci, OUTDENT_CONTENT_COMMAND as Ei, INDENT_CONTENT_COMMAND as Kr, INSERT_TAB_COMMAND as Ti, COMMAND_PRIORITY_CRITICAL as fr, $isDecoratorNode as Ri, $isParagraphNode as Si, $isTextNode as gn, SELECTION_CHANGE_COMMAND as Io, getRegisteredNode as Di, isHTMLElement as Mi, isDocumentFragment as Gr, isDOMDocumentNode as Oi, ArtificialNode__DO_NOT_USE as Ao, $createLineBreakNode as Po, $isRootOrShadowRoot as Ii, isBlockDomNode as qr, isInlineDomNode as Ur, $insertNodes as Ai } from "lexical";
...
import { useReactTable as jo, getFilteredRowModel as Ki, getSortedRowModel as zo, getPaginationRowModel as Gi, getCoreRowModel as Fo, flexRender as Ye, getGroupedRowModel as qi, getExpandedRowModel as Ui } from "@tanstack/react-table";
...
const tl = $t.Root, el = $t.Portal, Bo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Overlay,
  {
    ref: n,
    className: m(
...
const Wo = nn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Ve : "button", { className: m(Jo({ variant: e, size: n, className: t })), ref: i, ...a })
);
B.displayName = "Button";
const re = De.Root, ue = De.Trigger, ol = De.Anchor, Ut = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ft();
...
function rr(t, e, n) {
  return `${t} ${xe[t]}${e ? ` ${gr(t, e)} ${Re(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function al({
  recentSearches: t,
...
), mt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(No.Root, { ref: n, className: m("pr-twp", wl(), t), ...e }));
...
var pl = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(pl || {});
...
const Qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = Qo ? Zt : q, cn = { tag: mr };
function fl({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = ul(null, o), p = ko({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (f) => s(f, p), theme: o });
    return function(f, h) {
      if (h !== null) {
...
const xr = {
  ...
  {
    ref: o,
    className: e ? m(Jo({ variant: e }), t) : t,
    ...n
  }
));
...
function Cl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !ni(e) && o !== null) {
    ...
    if (w || p) {
      const [f, h] = ri(t), u = l.is(c), g = e.is(s ? c : l), x = e.is(s ? l : c);
      let v, y = 0;
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Tl = ta && "documentMode" in document ? document.documentMode : null;
!(!ta || !("InputEvent" in window) || Tl) && "getTargetRanges" in new window.InputEvent("input");
function Rl(t) {
  const e = Eo(t, (n) => se(n) && !n.isInline());
...
function Sl(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = Eo(i, (w) => se(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
vt.prototype.brand = Dl, vt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ra(this), Jr(this), ie++;
  const t = J;
...
Gt({ name: "@lexical/extension/DecoratorText", nodes: () => [sa], register: (t, e, n) => t.registerCommand(So, (o) => {
  const a = Lt();
  if (Do(a) || Ne(a)) for (const i of a.getNodes()) Pl(i) && i.toggleFormat(o);
  return !1;
}, Mo) });
function ia(t, e) {
  let n;
...
const kr = 0, ir = 1, wa = 2, jn = 3, dn = 4, Ee = 5, zn = 6, Ge = 7;
function Fn(t) {
  return t.id === kr;
}
function ca(t) {
...
const zl = Gt({ config: rn({ setOptions: Zr, updateOptions: Zr }), init: ({ $initialEditorState: t = jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ii, Co, li, wi, _o] }), Qr = Symbol.for("@lexical/extension/LexicalBuilder");
function to() {
}
function Fl(t) {
  throw t;
...
const Bl = /* @__PURE__ */ new Set(), eo = Gt({ build(t, e, n) {
...
Gt({ dependencies: [sr, eo], name: "@lexical/extension/HorizontalRule", nodes: () => [Me], register(t, e, n) {
  ...
  return we(t.registerCommand(pi, (s) => {
    if (ui(s.target)) {
      const l = mi(s.target);
      if (Gl(l)) return function(c, w = !1) {
        const p = Lt(), f = c.isSelected(), h = c.getKey();
        let u;
        w && Do(p) ? u = p : (u = fi(), hi(u)), f ? u.delete(h) : u.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Mo), t.registerMutationListener(Me, (s, l) => {
    Ml(() => {
      let c = !1;
...
function ql(t, e, n = pa) {
  return we(t.registerCommand(ki, (o) => {
    const a = Lt();
    if (!Ne(a)) return !1;
    o.preventDefault();
    const i = function(s) {
...
Gt({ build: (t, e, n) => Rn(e), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ce(() => n.getOutput().disabled.value ? void 0 : ma(t)) });
function Wl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return _r(() => n.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = r(o, { onError: (h) => n._onError(h), children: r(ps, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
        f !== null && s.push(zi(p, f, w));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function dw() {
  const [t, e] = R(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(tl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ko, { children: [
...
const ba = pe(
  ...
  {
    ref: a,
    className: m(ba({ variant: e, size: n, className: t })),
    ...o
  }
));
mw.displayName = $o.Root.displayName;
...
function xa(t, e, n, o = null) {
  ...
  const l = se(s) ? s.getChildren() : [], c = Di(t, s.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = xa(t, g, h, o);
    !a && se(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Mi(p) || Gr(p)) && p.append(h), n.append(p), f) {
      const u = f.call(s, p);
      u && (Gr(p) ? p.replaceChildren(u) : p.replaceWith(u));
    }
  } else n.append(h);
  return a;
}
...
function Na(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const u = (l == null || !Ii(l)) && (l != null && hn(l) || o);
  for (let g = 0; g < f.length; g++) h.push(...Na(f[g], e, n, u, new Map(a), l));
  return p != null && (h = p(h)), qr(t) && (h = yw(t, h, u ? () => {
    const g = new Ao();
    return n.push(g), g;
  ...
  }(t) && (s = s.concat(Po())) : se(l) && l.append(...h), s;
}
function yw(t, e, n) {
...
Ie.displayName = Vo.Root.displayName;
...
Ta.displayName = ze.Root.displayName;
...
Ra.displayName = ze.Fallback.displayName;
const Rr = kn(void 0);
function zt() {
  const t = ur(Rr);
  if (!t)
...
}), ke = ot.Trigger, Sa = ot.Group, Iw = ot.Portal, Aw = ot.Sub, Pw = ot.RadioGroup;
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), u()) : Tr(k) && (k.preventDefault(), k.stopPropagation(), It(p) && g());
              },
              onKeyDown: (k) => {
        ...
        _ && /* @__PURE__ */ d(de, { children: [
          /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(vs, {}) }) }),
...
function Ww({
  ...
  var L;
  const [p, f] = R([]), [h, u] = R([]), [g, x] = R({}), [v, y] = R({}), N = F(() => e ?? [], [e]), _ = jo({
    data: N,
    columns: t,
    getCoreRowModel: Fo(),
...
function vp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(de, { children: [
    ...
    /* @__PURE__ */ r(te, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Sa, { children: w.itemType === 0 ? /* @__PURE__ */ r(ct, { children: w.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Jt,
        {
          checked: o[p][h],
        ...
        Pw,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Oa, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(Be, {})
    ] }, w.label)) })
...
function ic({
  ...
  return /* @__PURE__ */ d(de, { children: [
    /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Pi, { asChild: !0, children: /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: ac(t, n) }) }) }),
...
const Cc = "16rem", Ec = "3rem", $a = b.createContext(void 0);
function In() {
    ...
    Va,
    {
      ...
      children: /* @__PURE__ */ d(za, { children: [
        /* @__PURE__ */ d(wr, { children: [
          ...
          /* @__PURE__ */ r(dr, { children: /* @__PURE__ */ r(Fa, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Ba, { children: /* @__PURE__ */ r(
            Ka,
            {
              onClick: () => w(h),
              isActive: f(h),
...
const ae = "scrBook", Bc = "scrRef", ge = "source", Kc = "details", Gc = "Scripture Reference", qc = "Scripture Book", Ga = "Type", Uc = "Details";
function Hc(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, wo = (t) => `${Yc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Pp({
  sources: t,
...
const Ha = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Pt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Iw, { children: /* @__PURE__ */ r(Ma, { children: Ha(
      t,
      e,
      Ua(t, l.id),
      o
...
function pr({
  ...
  return /* @__PURE__ */ d(de, { variant: i, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Fs, {}) }) }),
    /* @__PURE__ */ r(te, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(po, { children: [
...
function Gp({
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Xa, { children: [
      /* @__PURE__ */ r(Wa, { children: t.map((l) => /* @__PURE__ */ r(Jc, { value: l.value, children: l.value }, l.key)) }),
...
function rd({
  ...
  if (Wi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    return /* @__PURE__ */ r(Za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ d(Zc, { children: [
      /* @__PURE__ */ r(Qa, { ref: w(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        ns,
        {
          className: "tw-z-[250]",
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && w && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ d(de, { children: [
              /* @__PURE__ */ r(ke, { className: m(f && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(zr, {}) }) }),
...
const sd = nn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Gs, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
const ru = jt.Trigger, yd = jt.Portal, ou = jt.Close, is = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  jt.Overlay,
  {
    ref: n,
