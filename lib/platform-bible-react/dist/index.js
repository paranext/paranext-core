...
function hp({
  ...
  const w = lt(), [p, f] = D(!1), [m, u] = D(""), [g, k] = D(""), [x, _] = D("books"), [C, y] = D(void 0), [E, M] = D(!1), S = Q(void 0), T = Q(void 0), O = Q(void 0), N = Q(void 0), R = Q({}), V = j(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
    ...
    (v) => {
      const z = x === "chapters" ? C : I == null ? void 0 : I.book;
      z && (V({
        book: z,
        chapterNum: v,
        verseNum: 1
    ...
    (v) => {
      ...
      if ((x === "chapters" || x === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ct = x === "chapters" ? C : I == null ? void 0 : I.book;
        if (!ct) return;
        const mt = (() => {
          if (!m) return 1;
          const Be = m.match(/(\d+)$/);
    ...
    const { isLetter: z, isDigit: Z } = Jr(v.key);
    (z || Z) && (v.preventDefault(), k((ct) => ct + v.key), T.current.focus(), M(!1));
  }, []);
  return $t(() => {
    const v = setTimeout(() => {
    ...
    if (x === "chapters" && C) {
      ...
      setTimeout(() => {
        if (O.current)
          if (v) {
            const z = R.current[e.chapterNum];
  ...
  }, [x, C, I, e.book, e.chapterNum]), /* @__PURE__ */ d(ge, { open: p, onOpenChange: dt, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        children: [
          ...
          !E && /* @__PURE__ */ d(te, { ref: O, children: [
            x === "books" && /* @__PURE__ */ d(at, { children: [
              ...
              I && /* @__PURE__ */ o(Bt, { children: /* @__PURE__ */ o(
                zt,
                {
                  value: `${I.book} ${ce[I.book]} ${I.chapterNum || ""}:${I.verseNum || ""})}`,
                  onSelect: ot,
...
function ar({
  ...
  const [C, y] = D(!1), E = c ?? l, M = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], S = (T, O) => {
    const N = l(T), R = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, V = `${O ?? ""}${N}${R ?? ""}`;
    return /* @__PURE__ */ d(
      zt,
      {
        value: N,
    ...
    /* @__PURE__ */ o(
      ee,
      {
        ...
        children: /* @__PURE__ */ d(Qt, { children: [
          ...
          /* @__PURE__ */ o(te, { children: M(t) ? t.map((T) => /* @__PURE__ */ o(Bt, { heading: T.groupHeading, children: T.options.map((O) => S(O, T.groupHeading)) }, T.groupHeading)) : t.map((T) => S(T)) })
        ] })
      }
    )
  ] });
    ...
    (u) => {
      ...
      if (!!(x && g && x.contains(g) && g !== x) && f(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (N === -1) return;
          let R;
          u.key === "ArrowDown" ? R = Math.min(N + 1, O.length - 1) : R = Math.max(N - 1, 0), R !== N && (u.preventDefault(), u.stopPropagation(), (T = O[R]) == null || T.focus());
          return;
        }
        return;
      }
...
function wo({
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ta, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Ra, { className: "tw-text-xs tw-font-medium", children: S }) }),
...
function Jw({
  ...
  const [_, C] = D(co), [y, E] = D(!1), [M, S] = D(!1), [T, O] = D(!1), [N, R] = D(!1), [V, B] = D(!1), [F, A] = D(void 0), [W, I] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      I(!1), yt(!1);
  ...
  }, [a, t]), Gt = $(() => _t.slice(1), [_t]), vt = $(() => Gt.length ?? 0, [Gt.length]), On = $(() => vt > 0, [vt]), Mn = $(() => T || vt <= 2 ? Gt : Gt.slice(-2), [Gt, vt, T]), xe = $(() => T || vt <= 2 ? 0 : vt - 2, [vt, T]), sn = $(
...
function xp({
  ...
  const [m, u] = D(), g = t.filter(
    ...
    (S) => {
      S.key === "Escape" ? (u(void 0), S.preventDefault(), S.stopPropagation()) : E(S);
    },
    [E]
  );
  return /* @__PURE__ */ o(
...
function wc({
  ...
  let M;
  return c ? M = Array.from({ length: 10 }).map((N, R) => `skeleton-row-${R}`).map((N) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(pe, { colSpan: E.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, N)) : ((S = y.getRowModel().rows) == null ? void 0 : S.length) > 0 ? M = y.getRowModel().rows.map((T) => /* @__PURE__ */ o(
    At,
    {
      onClick: () => i(T, y),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map((O) => /* @__PURE__ */ o(pe, { children: Xe(O.column.columnDef.cell, O.getContext()) }, O.id))
    },
    T.id
  )) : M = /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(pe, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Ww, { table: y }),
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: y.getHeaderGroups().map((T) => /* @__PURE__ */ o(At, { children: T.headers.map((O) => /* @__PURE__ */ o(Qe, { children: O.isPlaceholder ? void 0 : Xe(O.column.columnDef.header, O.getContext()) }, O.id)) }, T.id)) }),
...
function mc({
  ...
  const [_, C] = D(!1), y = j(
    (R) => {
      var B;
      const V = (B = e.find((F) => F.label === R)) == null ? void 0 : B.value;
      V && n(
    ...
    if (!m) return e;
    const R = e.filter((B) => B.starred).sort((B, F) => B.label.localeCompare(F.label)), V = e.filter((B) => !B.starred).sort((B, F) => {
        ...
        /* @__PURE__ */ o(Bt, { children: M.map((R) => /* @__PURE__ */ d(
          zt,
          {
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ o(Ms, { className: "tw-h-4 tw-w-4" }),
              /* @__PURE__ */ o("div", { className: "tw-flex-grow", children: R.label }),
              R.secondaryLabel && /* @__PURE__ */ o("div", { className: "tw-text-end tw-text-muted-foreground", children: R.secondaryLabel })
            ]
          },
          R.label
        )) })
...
function fc({
  ...
  const g = (x) => {
    ...
    var C, y, E, M, S;
    const _ = ((C = i.current) == null ? void 0 : C.dir) !== "ltr";
    x.key === "ArrowDown" || _ && x.key === "ArrowRight" || !_ && x.key === "ArrowLeft" ? ((y = s.current) == null || y.focus(), l.current = !0) : x.key === "ArrowUp" ? ((E = i.current) == null || E.focus(), l.current = !1) : (_ && x.key === "ArrowLeft" || !_ && x.key === "ArrowRight") && ((M = s.current) == null ? void 0 : M.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
...
function Tp({
  ...
  q(() => {
    ...
    if (E && $n("note", E)) {
      const T = (M = E.insert.note) == null ? void 0 : M.caller;
      let O = "custom";
      T === Qn ? O = "generated" : T === tr ? O = "hidden" : T && m(T), p(O), g(((S = E.insert.note) == null ? void 0 : S.style) ?? "f"), E.insert.note && (E.insert.note.caller = ""), y = setTimeout(() => {
        var N;
        ...
        /* @__PURE__ */ o(
          vc,
          {
            ...
            handleNoteTypeChange: (y) => {
              var M, S, T;
              g(y);
              const E = (S = (M = l.current) == null ? void 0 : M.getNoteOps(0)) == null ? void 0 : S.at(0);
              E && $n("note", E) && (E.insert.note && (E.insert.note.style = y), (T = l.current) == null || T.applyUpdate([{ delete: 1 }, E]));
            },
            localizedStrings: i
          }
        ),
...
function Bp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), m = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), k = Tt(n, "%webView_inventory_scope_currentBook%"), x = Tt(n, "%webView_inventory_scope_chapter%"), _ = Tt(n, "%webView_inventory_scope_verse%"), C = Tt(n, "%webView_inventory_filter_text%"), y = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), E = Tt(n, "%webView_inventory_no_results%"), [M, S] = D(!1), [T, O] = D("all"), [N, R] = D(""), [V, B] = D([]), F = $(() => {
    const P = e ?? [];
  ...
  }, [M, F]), W = $(() => A.length === 0 ? [] : Tc(A, T, N), [A, T, N]), I = $(() => {
    var dt, wt;
    if (!M) return c;
...
function Gp({
  ...
  q(() => {
    if (l) {
      const N = _.getSelectedRowModel().rowsById, R = Object.keys(N);
      if (R.length === 1) {
        const V = k.find((B) => mo(B) === R[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, k, l, _]);
  const C = a ?? Jc, y = s ?? Xa, E = [
    ...
    !N.getIsGrouped() && !N.getIsSelected() && N.getToggleSelectedHandler()(R);
  }, T = (N, R) => N.getIsGrouped() ? "" : h("banded-row", R % 2 === 0 ? "even" : "odd"), O = (N, R, V) => {
    if (!((N == null ? void 0 : N.length) === 0 || R.depth < V.column.getGroupedIndex())) {
      if (R.getIsGrouped())
        switch (R.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: _.getHeaderGroups().map((N) => /* @__PURE__ */ o(At, { children: N.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(Qe, { colSpan: R.colSpan, className: "top-0 tw-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          R.column.getCanGroup() ? /* @__PURE__ */ o(
            L,
            {
              variant: "ghost",
          ...
          " ",
          Xe(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, N.id)) }),
      /* @__PURE__ */ o(Tn, { children: _.getRowModel().rows.map((N, R) => {
        const V = lt();
        return /* @__PURE__ */ o(
          At,
          {
...
function ed({
  ...
  }, [x, _] = D(!1), [C, y] = D(""), E = Q(void 0), M = Q(!1);
  if (e.length !== Y.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const S = $(() => Y.allBookIds.filter(
    ...
    (A, W = !1) => {
      ...
      const I = S.findIndex((P) => P === E.current), ot = S.findIndex((P) => P === A);
      if (I === -1 || ot === -1) return;
      const [yt, _t] = [
        Math.min(I, ot),
        Math.max(I, ot)
      ], bt = S.slice(yt, _t + 1).map((P) => P);
      n(
    ...
    (A) => {
      const W = $r(S, A).map((I) => I);
      n(
        Ka(S, A, t) ? t.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...t, ...W])]
      );
    },
    [t, n, S]
  ), B = () => {
...
function eu({
  ...
  const w = wd(
    ...
    return x ? `${(M = e[g]) == null ? void 0 : M.autonym} (${x})` : (S = e[g]) == null ? void 0 : S.autonym;
  };
