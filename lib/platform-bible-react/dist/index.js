...
var At = (t, e, r) => Fi(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Gt, Z as Bi, B as U, c as f, a as Ui, C as Oe, P as Re, b as Be, d as $e, e as Ue, f as Ke, g as he, h as Cr, i as aa, T as Ft, S as or, j as Bt, k as Ut, l as Kt, D as Ze, m as yr, n as Te, o as ze, p as De, u as Ki, q as Er, s as Qe, t as Le, v as Oa, w as un, x as qi, y as Gi, z as pn, A as hn, E as Hi, F as Yi, G as Wi, H as Xi, I as pa, J as ha, K as wr, L as Ji, M as Zi, N as Qi, O as ts, Q as es, R as Tr, U as Ya } from "./resizable-CUvCloPJ.js";
...
import { includes as Mr, Section as et, getChaptersForBook as rs, formatScrRef as Ce, getSectionForBook as vr, formatRelativeDate as as, formatReplacementString as Ne, sanitizeHtml as Wa, NumberFormat as os, formatBytes as ns, getCurrentLocale as is, usfmMarkers as jr, getFormatCallerFunction as ss, deepEqual as cs, isString as yo, compareScrRefs as Ra, scrRefToBBBCCCVVV as ga, defaultScrRef as fa, formatScrRefRange as ls, getLocalizeKeyForScrollGroupId as ko } from "platform-bible-utils";
import { Check as je, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as $a, ChevronRight as Ma, ArrowLeft as ds, ArrowRight as ws, ChevronDown as nr, BoldIcon as us, ItalicIcon as ps, X as oa, AtSign as gn, Pencil as hs, Trash2 as gs, ArrowUp as fn, MoreHorizontal as fs, MailOpen as ms, Mail as vs, ChevronUp as bs, FilterIcon as xs, ArrowLeftIcon as ys, ChevronLeftIcon as ks, ChevronRightIcon as _s, ArrowRightIcon as Ns, Copy as mn, Filter as Cs, User as Es, Link as Ts, CircleHelp as zs, ChevronsUpDown as vn, Star as Ds, Undo as Ss, Redo as Os, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Rs, AlertCircle as Aa, CircleCheckIcon as $s, CircleXIcon as Ms, CircleHelpIcon as As, ArrowUpIcon as Ps, ArrowDownIcon as Is, Search as Vs, LoaderCircle as Ls, ScrollText as js, MenuIcon as Fs, Menu as Bs, EllipsisVertical as Us, MoreVertical as Eo } from "lucide-react";
import ut, { useRef as q, useMemo as L, useState as C, useCallback as j, useEffect as X, useLayoutEffect as Jt, createContext as Xa, useContext as kn, Component as Ks, createElement as To, Suspense as qs, forwardRef as na, useId as zo, Fragment as _n } from "react";
import { Dialog as ge, Label as Gs, RadioGroup as Pa, ToggleGroup as Nn, Slot as ur, Avatar as Ja, Select as It, Checkbox as Do, Tabs as le, Menubar as ve, ContextMenu as $t, Progress as So, Slider as Ar, Switch as Oo } from "radix-ui";
import { createEditor as Cn, $getRoot as Fe, $createParagraphNode as zr, $getSelection as qt, HISTORY_MERGE_TAG as Za, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Hs, $isRangeSelection as fe, $caretFromPoint as Ys, $getSiblingCaret as zn, $getChildCaret as Ws, $getAdjacentChildCaret as Xs, $isChildCaret as Js, $normalizeCaret as Zs, $setSelectionFromCaretRange as Qs, $getCollapsedCaretRange as tc, $getCaretInDirection as Ro, $splitAtPointCaretNext as ec, $isTextPointCaret as rc, $findMatchingParent as Dn, $isElementNode as kr, mergeRegister as Se, getDOMTextNode as ac, isHTMLElement as oc, CLEAR_EDITOR_COMMAND as Sn, COMMAND_PRIORITY_EDITOR as Qa, shallowMergeConfig as nc, defineExtension as te, safeCast as tr, createState as ic, FORMAT_TEXT_COMMAND as On, $isNodeSelection as Rn, COMMAND_PRIORITY_LOW as $n, RootNode as sc, LineBreakNode as cc, TabNode as lc, $isEditorState as dc, createCommand as wc, CLICK_COMMAND as uc, isDOMNode as pc, $getNodeFromDOMNode as hc, $createNodeSelection as gc, $setSelection as fc, $getEditor as mc, DecoratorNode as Ia, $getState as vc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as bc, $setState as xc, addClassNamesToElement as Mn, $create as yc, $getNodeByKey as kc, removeClassNamesFromElement as _c, KEY_TAB_COMMAND as Nc, $isBlockElementNode as Cc, $createRangeSelection as Ec, $normalizeSelection__EXPERIMENTAL as Tc, OUTDENT_CONTENT_COMMAND as zc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Dc, COMMAND_PRIORITY_CRITICAL as to, $isDecoratorNode as Sc, $isParagraphNode as Oc, $isTextNode as Va, SELECTION_CHANGE_COMMAND as An, $insertNodes as Rc } from "lexical";
...
import { IconX as Vc, IconCheck as ia, IconChevronDown as Lc, IconChevronUp as jc, IconSelector as Fc, IconLayoutSidebar as Bc, IconLayoutSidebarRight as Uc, IconChevronRight as Pn, IconLoader as Kc, IconAlertOctagon as qc, IconAlertTriangle as Gc, IconInfoCircle as Hc, IconCircleCheck as Yc } from "@tabler/icons-react";
...
import { useReactTable as Vn, getFilteredRowModel as Zc, getSortedRowModel as Ln, getPaginationRowModel as Qc, getCoreRowModel as jn, flexRender as br, getGroupedRowModel as tl, getExpandedRowModel as el } from "@tanstack/react-table";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as La, HIDDEN_NOTE_CALLER as ja, getDefaultViewOptions as al, isInsertEmbedOpOfType as Pr, Editorial as ol } from "@eten-tech-foundation/platform-editor";
  ...
  return /* @__PURE__ */ u(cl, { children: [
    ...
    /* @__PURE__ */ u(
      ge.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ge.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Vc, {}),
...
function Ao({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ge.Close, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function wl({
  ...
  return /* @__PURE__ */ u(Re, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a($e, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(he, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Oe,
      {
        onSelect: () => g(h),
      ...
      if (s) {
        ...
        if (!w && d) {
          const h = ((m) => Object.keys(se).find(
            (k) => se[k].toLowerCase() === m.toLowerCase()
          ))(c);
...
function qn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(he, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function va({
  ...
  const T = Gt(), [_, N] = C(!1), [A, F] = C(""), [V, P] = C(""), [y, z] = C("books"), [I, E] = C(void 0), [S, W] = C(
    void 0
  ), [O, Y] = C(void 0), [st, B] = C(!1), Q = q(null), Nt = q(!1), gt = q(void 0), Dt = q(void 0), K = q(void 0), ot = q(void 0), mt = q({}), ct = q({}), tt = j(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Vt = L(() => o ? o() : Bn, [o]), xt = L(() => ({
    [et.OT]: Vt.filter((b) => wt.isBookOT(b)),
    [et.NT]: Vt.filter((b) => wt.isBookNT(b)),
    [et.DC]: Vt.filter((b) => wt.isBookDC(b)),
    [et.Extra]: Vt.filter((b) => wt.extraBooks().includes(b))
  }), [Vt]), Ht = L(() => Object.values(xt).flat(), [xt]), Lt = L(() => {
    if (!V.trim()) return xt;
    const x = {
      [et.OT]: [],
      [et.NT]: [],
    ...
    return [et.OT, et.NT, et.DC, et.Extra].forEach((G) => {
      x[G] = xt[G].filter((rt) => ro(rt, V, n));
    }), x;
  }, [xt, V, n]), R = L(
    () => gl(V, Ht, n),
    [V, Ht, n]
  ...
  const St = j(() => {
    if (R) {
      const x = R.chapterNum ?? 1, b = R.verseNum ?? 1;
      if (w && ma(R.book, x, b, w))
        return;
      tt({
        book: R.book,
        chapterNum: x,
    ...
    (x) => {
      const b = S ?? (R == null ? void 0 : R.book), G = O ?? (R == null ? void 0 : R.chapterNum);
      !b || !G || (tt({
        book: b,
        chapterNum: G,
        verseNum: x
    ...
    (x) => {
      const b = y === "chapters" ? I : R == null ? void 0 : R.book;
      if (b) {
        if (l && l(b, x) > 1) {
          W(b), Y(x), z("verses"), F("");
          return;
    ...
    z("books"), E(void 0), W(void 0), Y(void 0), setTimeout(() => {
      Dt.current && Dt.current.focus();
    }, 0);
  }, []), $ = j(() => {
    const x = S;
    W(void 0), Y(void 0), x ? (E(x), z("chapters"), F("")) : Yt();
  }, [S, Yt]), H = j((x) => {
    N(x), x && (z("books"), E(void 0), W(void 0), Y(void 0), P(""));
  }, []), { otLong: Z, ntLong: nt, dcLong: vt, extraLong: yt } = {
    ...
    () => pl(V),
    [V]
  ), pt = L(() => !l || !R || !R.chapterNum || !Tt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, Tt]), ye = j(
    (x) => w ? Po(x, w) : !1,
    [w]
  ), ne = j(
    (x) => (b) => w ? hl(x, b, w) : !1,
    ...
    (x, b) => (G) => w ? ma(x, b, G, w) : !1,
    [w]
  ), ke = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ge = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Ae = j(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && R && R.chapterNum !== void 0 && R.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), St());
    },
    [p, R, St]
  ), He = j(
    (x) => {
      var zt, Pe, hr;
      if (x.ctrlKey) return;
      const { isLetter: b, isDigit: G } = Io(x.key);
      if ((y === "chapters" || y === "verses") && (x.key === " " || x.key === "Enter")) {
        ...
        const Ot = (zt = gt.current) == null ? void 0 : zt.querySelector(
      ...
      if (y === "verses" && rt) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            ht !== 0 && (Wt = ht > 1 ? ht - 1 : Ot);
            break;
          case "ArrowRight":
            ht !== 0 && (Wt = ht < Ot ? ht + 1 : 1);
            break;
          case "ArrowUp":
            Wt = ht === 0 ? Ot : Math.max(1, ht - Xt);
            break;
          case "ArrowDown":
            Wt = ht === 0 ? 1 : Math.min(Ot, ht + Xt);
            break;
          default:
            return;
        }
        Wt !== ht && (x.preventDefault(), x.stopPropagation(), F(
          `${Mt} ${se[Mt] || ""} ${kt}:${Wt}`
        ), setTimeout(() => {
          const We = ct.current[Wt];
          We && We.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((y === "chapters" || y === "books" && R) && rt) {
        const Mt = y === "chapters" ? I : R == null ? void 0 : R.book;
        if (!Mt) return;
        y === "chapters" && ((hr = gt.current) == null || hr.focus());
        const kt = (() => {
          if (!A) return 1;
          const Xt = A.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            kt !== 0 && (ht = kt > 1 ? kt - 1 : Ot);
            break;
          case "ArrowRight":
            kt !== 0 && (ht = kt < Ot ? kt + 1 : 1);
            break;
          case "ArrowUp":
            ht = kt === 0 ? Ot : Math.max(1, kt - Wt);
            break;
          case "ArrowDown":
            ht = kt === 0 ? 1 : Math.min(Ot, kt + Wt);
            break;
          default:
            return;
        }
        ht !== kt && (x.preventDefault(), x.stopPropagation(), F(
          `${Mt} ${se[Mt] || ""} ${ht}`
        ), setTimeout(() => {
          const Xt = mt.current[ht];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (rt = Dt.current) == null || rt.focus();
      return;
    }
    const { isLetter: b, isDigit: G } = Io(x.key);
    (b || G) && (x.preventDefault(), P((zt) => zt + x.key), Dt.current.focus(), B(!1));
  }, []);
  return Jt(() => {
    const x = setTimeout(() => {
      if (_ && y === "books" && K.current && ot.current) {
        const b = K.current, G = ot.current, rt = G.offsetTop, zt = b.clientHeight, Pe = G.clientHeight, hr = rt - zt / 2 + Pe / 2;
        b.scrollTo({
          top: Math.max(0, hr),
          behavior: "smooth"
        }), F(Kn(t.book));
    ...
    if (y === "chapters" && I) {
      const x = I === t.book, b = x ? t.chapterNum : 1;
      F(
        `${I} ${se[I] || ""} ${b}`
      ), setTimeout(() => {
        if (K.current)
          if (x) {
            const G = mt.current[t.chapterNum];
  ...
  }, [y, I, R, t.book, t.chapterNum]), Jt(() => {
    if (y === "verses" && S && O !== void 0) {
      const x = S === t.book && O === t.chapterNum, b = x ? t.verseNum : 1;
      F(
        `${S} ${se[S] || ""} ${O}:${b}`
      ), setTimeout(() => {
        if (K.current)
          if (x) {
            const G = ct.current[t.verseNum];
            G && G.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            K.current.scrollTo({ top: 0 });
        gt.current && gt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Re, { open: _, onOpenChange: H, modal: v, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
      U,
      {
        ref: Q,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: b } = x;
          _ && Q.current && b instanceof Node && Q.current.contains(b) && (Nt.current = !0, H(!1));
        },
        onCloseAutoFocus: k,
        children: /* @__PURE__ */ u(
          Ue,
          {
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: xe.map(({ onClick: x, disabled: b, title: G, icon: rt }) => /* @__PURE__ */ a(
                  U,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  U,
                  {
                    ...
                    tabIndex: -1,
                    children: T === "ltr" ? /* @__PURE__ */ a(ds, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ws, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                y === "chapters" && I && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ve(I, n) }),
                y === "verses" && S && O !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ve(S, n)} ${O}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? Ge : ke
                  }
                )
              ] }),
              !st && /* @__PURE__ */ u(Ke, { ref: K, children: [
                y === "books" && /* @__PURE__ */ u(at, { children: [
                  !R && Object.entries(Lt).map(([x, b]) => {
                    if (b.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(he, { heading: ft(x), children: b.map((G) => /* @__PURE__ */ a(
                          Un,
                          {
                            bookId: G,
                            onSelect: (rt) => ae(rt),
                  ...
                  R && /* @__PURE__ */ a(he, { children: /* @__PURE__ */ a(
                    Oe,
                    {
                      ...
                      children: Ce(
                        ...
                        n ? eo(R.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  R && pt && R.chapterNum && l && /* @__PURE__ */ u(at, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ve(R.book, n)} ${R.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Lo,
                      {
                        ...
                        onVerseSelect: re,
                        setVerseRef: Et,
                        isVerseDisabled: de(R.book, R.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  R && !pt && pe(R.book) > 1 && /* @__PURE__ */ u(at, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ve(R.book, n) }),
                ...
                y === "chapters" && I && /* @__PURE__ */ a(
                  Vo,
                  {
                    ...
                    onChapterSelect: oe,
                    setChapterRef: bt,
                    isChapterDisabled: ne(I),
                    className: "tw:p-4"
                  }
                ),
                y === "verses" && S && O !== void 0 && l && /* @__PURE__ */ a(
                  Lo,
                  {
                    bookId: S,
                    chapterNum: O,
...
function jo({
  ...
  const [_, N] = C(!1), A = l ?? d, F = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], V = (P, y) => {
    const z = d(P), I = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, E = `${y ?? ""}${z}${I ?? ""}`;
    return /* @__PURE__ */ u(
      Oe,
      {
        value: z,
  ...
  return /* @__PURE__ */ u(Re, { open: _, onOpenChange: N, ...T, children: [
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ue, { children: [
          /* @__PURE__ */ a(Cr, { placeholder: g, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(aa, { children: h }),
          /* @__PURE__ */ a(Ke, { children: F(e) ? e.map((P) => /* @__PURE__ */ a(he, { heading: P.groupHeading, children: P.options.map((y) => V(y, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(he, { children: e.map((P) => V(P)) }) })
        ] })
      }
    )
  ] });
...
function tp({
  ...
  const w = ba(l, "%webView_bookSelector_currentBook%"), p = ba(l, "%webView_bookSelector_choose%"), g = ba(l, "%webView_bookSelector_chooseBooks%"), [h, m] = C(
    "current book"
    /* CurrentBook */
  ), k = (v) => {
    m(v), t(v);
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Hn ? Jt : X, Ir = { tag: Za };
function yl({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = bl(null, o), w = Cn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
        if (g === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            const m = zr();
            h.append(m);
            const k = Hn ? document.activeElement : null;
            (qt() !== null || k !== null && k === p.getRootElement()) && m.select();
          }
        }, Ir);
...
const kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : X;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : X;
function Dl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Sl() {
  return function(t) {
    const [e] = be(), r = L(() => t(e), [e, t]), [o, n] = C(() => r.initialValueFn()), i = q(o);
    return zl(() => {
...
function Ml(t, e, r) {
  ...
  function d() {
    ...
    for (let D = 0; D < h.length; D++) {
      const T = h[D], _ = s[D] || document.createElement("div"), N = _.style;
      N.position !== "absolute" && (N.position = "absolute", v = !0);
      const A = ue(T.left - p);
      N.left !== A && (N.left = A, v = !0);
      const F = ue(T.top - g);
      N.top !== F && (_.style.top = F, v = !0);
      const V = ue(T.width);
      N.width !== V && (_.style.width = V, v = !0);
      const P = ue(T.height);
      N.height !== P && (_.style.height = P, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[D] = _;
    }
...
function Pl(t, e = Al) {
  ...
  function l(w) {
    w.read(() => {
      ...
      const [g, h] = function(P) {
        const y = P.getStartEndPoints();
        return P.isBackward() ? [y[1], y[0]] : y;
      }(p), m = g.getNode(), k = m.getKey(), v = g.offset, D = h.getNode(), T = D.getKey(), _ = h.offset, N = t.getElementByKey(k), A = t.getElementByKey(T), F = r === null || N !== o || v !== n || k !== r.getKey(), V = i === null || A !== s || _ !== c || T !== i.getKey();
      if ((F || V) && N !== null && A !== null) {
        const P = function(y, z, I, E, S, W, O) {
          const Y = (y._window ? y._window.document : document).createRange();
          return Y.setStart(...Fo(z, I, E)), Y.setEnd(...Fo(S, W, O)), Y;
        }(t, g, m, N, h, D, A);
        d(), d = Ml(t, P, e);
      }
      r = m, o = N, n = v, i = D, s = A, c = _;
    });
  }
...
function Vl(t) {
  const e = Dn(t, (r) => kr(r) && !r.isInline());
  return kr(e) || Xr(4, t.__key), e;
}
function Ll(t) {
  const e = qt() || Hs();
  let r;
  if (fe(e)) r = Ys(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = zn(c, "next"));
    }
    r = r || Ws(Fe(), "previous").getFlipped().insert(zr());
  }
...
function jl(t, e, r) {
  ...
  return rc(o) && Xr(283), o.insert(t.isInline() ? zr().append(t) : t), Ro(zn(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = qt();
  if (!fe(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Dn(i, (l) => kr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Jr, Ee = 0, Zr = 0, Kl = 0, Ka = 0, Br = 0;
function Uo(t) {
  if (it === void 0) return;
  let e = t.n;
...
function Gl(t) {
  ...
  Xn(this), it = t, this.f &= -2, 8 & this.f && io(this), sa();
}
function rr(t, e) {
...
Pt.prototype.brand = Bl, Pt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ee !== 0 && Zr === 0 && e.l !== Ka && (e.l = Ka, Jr = { S: e, v: e.v, i: e.i, o: Jr });
...
} }), Xe.prototype = new Pt(), Xe.prototype.h = function() {
...
te({ build: (t, e, r) => pr(e), config: tr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Zn() {
  const t = Fe(), e = qt(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), fe(e) && (e.format = 0);
}
function Qn(t, e = Zn) {
  return t.registerCommand(Sn, (r) => (t.update(e), !0), Qa);
}
te({ build: (t, e, r) => pr(e), config: tr({ $onClear: Zn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const ya = ic("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ti extends Ia {
  $config() {
...
te({ name: "@lexical/extension/DecoratorText", nodes: () => [ti], register: (t, e, r) => t.registerCommand(On, (o) => {
  const n = qt();
  if (Rn(n) || fe(n)) for (const i of n.getNodes()) Yl(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function ei(t, e) {
  let r;
...
const qa = te({ build: (t) => ei(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, Ga = 1, ai = 2, ka = 3, Vr = 4, er = 5, _a = 6, fr = 7;
function Na(t) {
  return t.id === so;
}
function oi(t) {
...
class Jl {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, d, l) {
      return Object.assign(c, { config: d, id: ka, registerState: l });
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Vr && dt(307, String(r.id), String(er)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== er && dt(308, String(o.id), String(er));
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= ka;
    }(e) || dt(314, String(e.id), String(ka)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const Ql = te({ config: tr({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [sc, Tn, cc, lc, En] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function td(t) {
  throw t;
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[Go];
    return r && (r.PACKAGE_VERSION !== Ca && dt(292, r.PACKAGE_VERSION, Ca), r instanceof ar || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Na(i) || dt(300, s, n || "[unknown]"), Na(c = i) || dt(304, String(c.id), String(so)), i = Object.assign(c, { id: Ga }), o.state = i;
...
const ed = /* @__PURE__ */ new Set(), Yo = te({ build(t, e, r) {
  const o = r.getDependency(qa).output, n = _r({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ei(() => {
  }, () => me(() => {
...
}, dependencies: [qa], name: "@lexical/extension/NodeSelection" }), rd = wc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends Ia {
  static getType() {
...
te({ dependencies: [qa, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Yo).output, n = _r({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Se(t.registerCommand(rd, (s) => {
    ...
    return !0;
  }, Qa), t.registerCommand(uc, (s) => {
    if (pc(s.target)) {
      const c = hc(s.target);
      if (od(c)) return function(d, l = !1) {
        const w = qt(), p = d.isSelected(), g = d.getKey();
        let h;
    ...
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(me(() => {
      const l = c.value;
      l && (d.value ? Mn(l, i) : _c(l, i));
    }));
    return Se(...s);
  }));
} });
te({ build: (t, e) => pr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: tr({ $getParentEditor: function() {
  const t = mc();
...
te({ build: (t, e, r) => pr(e), config: tr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return me(() => {
...
function nd(t, e, r = ni) {
  return Se(t.registerCommand(Nc, (o) => {
    const n = qt();
    if (!fe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
te({ build: (t, e, r) => pr(e), config: tr({ $canIndent: ni, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (fe(m)) {
                const k = m.anchor;
                let v = k.getNode(), D = 0, T = 0;
                if (Va(v) && l >= 0 && w >= 0 && (D = l, T = l + w, m.setTextNodeRange(v, D, v, T)), D === T && p === "" || (m.insertRawText(p), v = k.getNode()), Va(v)) {
                  D = g, T = g + h;
                  const _ = v.getTextContentSize();
                  D = D > _ ? _ : D, T = T > _ ? _ : T, m.setTextNodeRange(v, D, v, T);
                }
...
te({ build: (t, e, r) => pr(e), config: tr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => me(() => r.getOutput().disabled.value ? void 0 : si(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : X;
  ...
  return function(r, o) {
    ...
    return lo(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (g) => r._onError(g), children: a(qs, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
...
function pd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    lo(() => Se(Ac(n), si(n)), [n]);
  }(o), u(at, { children: [t, a(hd, { content: e }), a(ud, { editor: o, ErrorBoundary: r })] });
}
...
function yd(t, e) {
  ...
  return u(at, { children: [a(bd, { editor: n, ...o, ref: e }), r != null && a(kd, { editor: n, content: r })] });
}
...
function Ed({
  ...
  const [e] = be(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = Cd(), d = () => {
  };
...
function Dd() {
  const { activeEditor: t } = di(), [e, r] = C([]), o = j((n) => {
    if (fe(n) || Wc(n)) {
      const i = [];
      Jo.forEach(({ format: s }) => {
...
function rp({
  ...
  const [i, s] = C(Ad), [c, d] = C(n), [l, w] = C(!1), p = q(void 0), g = q(null);
  X(() => {
    let v = !0;
    const D = g.current;
    if (!D) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : po(v) && (v.preventDefault(), v.stopPropagation(), Zt(i) && h());
        },
        onKeyDown: (v) => {
...
function Qo({
  ...
  const h = j(
    ...
    const N = new Date(t.date), A = as(
      N,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), F = N.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), v = L(() => t.user, [t.user]), D = L(
    () => t.user.split(" ").map((N) => N[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), T = L(() => Wa(t.contents), [t.contents]), _ = L(() => {
    if (o && c)
      return /* @__PURE__ */ u(at, { children: [
        /* @__PURE__ */ u(
          Ze,
          {
            onClick: (N) => {
              N.stopPropagation(), l(!0), p($d(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Vd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ld, { className: "tw:text-xs tw:font-medium", children: D }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), h()) : po(N) && (N.preventDefault(), N.stopPropagation(), Zt(w) && m());
              },
              onKeyDown: (N) => {
        ...
        _ && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(fs, {}) }) }),
...
), Fd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => Fd(Wa(t));
function Gr({ html: t, className: e }) {
  return /* @__PURE__ */ a(
    "div",
    {
      className: f(jd, e),
...
function Bd({
  ...
  const [d, l] = C("accept"), w = r ?? d, p = zo(), g = zo(), h = n === "accept", m = n === "none", k = n === "acceptRejectOrMerge", v = h ? "accept" : w, D = L(
    () => qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), T = L(
    () => qr(t.acceptedText ?? ""),
    ...
    () => qr(t.mergedText ?? ""),
    [t.mergedText]
  ), N = L(() => Wa(t.contents), [t.contents]);
  if (!(t.conflictType === vi && !!t.resultText))
    return /* @__PURE__ */ a(Gr, { html: N });
  const F = (O) => {
    const Y = O === "reject" || O === "merge" ? O : "accept";
    l(Y), o == null || o(Y);
  }, V = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", P = k ? [
    {
      value: "merge",
  ...
  let E;
  z ? E = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : c || (E = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const S = () => {
    const O = i ?? "accept";
    return O === "merged" ? /* @__PURE__ */ a(Gr, { html: _ }) : O === "reject" ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: t.rejectedResultText }) : /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: t.resultText });
  }, W = (O) => {
    const Y = v === O.value, st = `${g}-${O.value}`, B = h && O.value === "reject";
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: p, className: "tw:sr-only", children: V }),
      ...
      m ? S() : /* @__PURE__ */ u(at, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: y.map((O) => h && O.value === "reject" ? /* @__PURE__ */ a(Ft, { delayDuration: 0, children: /* @__PURE__ */ u(Bt, { children: [
              /* @__PURE__ */ a(Ut, { asChild: !0, children: W(O) }),
              /* @__PURE__ */ a(Kt, { side: "right", children: V })
            ] }) }, O.value) : W(O))
          }
        ),
...
function Kd({
  ...
  const o = e["%conflict_note_summary_unresolved%"] ?? "Conflicting edits. Choose which change to keep.", n = qr(t.rejectedText ?? "");
  return /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:font-normal tw:text-muted-foreground", children: o }),
    n ? /* @__PURE__ */ a(Gr, { html: n }) : void 0
  ] });
}
const tn = {
  root: {
...
function qd({
  ...
  getConflictResolutionOptionsCallback: y
}) {
  const [z, I] = C(tn), [E, S] = C(), [W, O] = C(), Y = o, [st, B] = C(!1), [Q, Nt] = C(!1), [gt, Dt] = C(!1), [K, ot] = C(!1), [mt, ct] = C(!1), [tt, Vt] = C(N), [xt, Ht] = C(!1), Lt = q(void 0), [R, ee] = C(/* @__PURE__ */ new Map()), St = l.type === "Conflict", [re, ae] = C("none"), [oe, Me] = C("accept"), [xe, Yt] = C(!1);
  X(() => {
    let b = !0;
    return (async () => {
      const rt = T ? await T(d) : !1;
      b && ct(rt);
    })(), () => {
      b = !1;
    };
    ...
    let b = !0;
    if (!o) {
      ot(!1), ee(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const rt = D ? await D(d) : !1;
      b && ot(rt);
    })(), () => {
      b = !1;
    };
  ...
  X(() => {
    ...
    $.current === "idle" && ($.current = "pending"), K ? $.current === "pending" && V !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    V !== i && (S(V), $.current = "auto-populated") : $.current === "auto-populated" && (S(void 0), $.current = "pending");
  }, [o, V, K, i]);
  const H = L(() => e.filter((b) => !b.deleted), [e]);
  X(() => {
    let b = !0;
    if (!o || !_) {
      ee(/* @__PURE__ */ new Map());
  ...
  const Z = L(() => H[0], [H]), nt = L(() => {
    if (St) {
      for (let b = H.length - 1; b >= 0; b -= 1) {
        const G = H[b].conflictResolutionAction;
        if (G === "replaced") return "reject";
        if (G === "merged") return "merged";
      }
      return w === "Resolved" ? "accept" : void 0;
    }
  }, [St, H, w]), vt = St && (Z == null ? void 0 : Z.conflictType) === vi && !!(Z != null && Z.resultText), yt = q(null), ft = q(void 0), lt = j(() => {
    var b;
    (b = ft.current) == null || b.call(ft), I(tn);
  }, []), Ct = j(() => {
    const b = !tt;
    Vt(b), Ht(!b), m == null || m(d, b);
  }, [tt, m, d]);
  X(() => {
    B(!1);
  }, [o]), X(() => {
    if (o && !tt && !xt) {
      ...
      return Lt.current = b, () => clearTimeout(b);
    }
  ...
  }, [i, r]), Tt = L(() => H.slice(1), [H]), pt = L(() => Tt.length ?? 0, [Tt.length]), ye = L(() => pt > 0, [pt]), ne = L(() => st || pt <= 2 ? Tt : Tt.slice(-2), [Tt, pt, st]), de = L(() => st || pt <= 2 ? 0 : pt - 2, [pt, st]), ke = L(
    () => pt === 1 ? bt.singleReply : Ne(bt.multipleReplies, { count: pt }),
    [pt, bt]
  ), Ge = L(
    () => de === 1 ? bt.singleReply : Ne(bt.multipleReplies, { count: de }),
    [de, bt]
  );
  X(() => {
    !o && Q && ye && Nt(!1);
  ...
  const Ae = j(
    async (b) => {
      ...
      G && await p({ threadId: d, contents: G }) && lt();
    },
    [
      lt,
      z,
    ...
    async (b) => {
      const G = Zt(z) ? ta(z) : void 0, rt = b.status ? b.assignedUser : E ?? b.assignedUser, zt = await p({
        ...b,
        contents: G,
        assignedUser: rt
      });
      return zt && (rt !== void 0 && O(rt), G && lt()), zt;
    },
    [lt, z, p, E]
  ), Ye = j(
    async (b) => {
  ...
  const x = vt ? /* @__PURE__ */ a(
    Kd,
    {
      comment: Z,
      localizedStrings: r,
      resolvedResolution: nt
    }
  ) : /* @__PURE__ */ a(
    Qo,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: He,
      handleUpdateComment: g,
      handleDeleteComment: h,
      onEditingChange: Nt,
      canEditOrDelete: (!Q && R.get(Z.id)) ?? !1,
    ...
    Pd,
    {
      ...
      children: /* @__PURE__ */ u(Id, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            Et && /* @__PURE__ */ a(yr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Et }),
            /* @__PURE__ */ a(
              U,
              {
                variant: "ghost",
            ...
            mt && w !== "Resolved" && /* @__PURE__ */ a(
              U,
              {
                ...
                onClick: (b) => {
                  b.stopPropagation(), St ? Ye("accept") : He({
                    threadId: d,
                    status: "Resolved"
                  });
                },
          ...
          St && o ? /* @__PURE__ */ a(
            Bd,
            {
              ...
              availableActions: w === "Resolved" ? "none" : re,
              resolvedResolution: nt,
              onResolve: Ye,
              isResolving: xe
            }
        ...
        /* @__PURE__ */ u(at, { children: [
          ye && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          o && /* @__PURE__ */ u(at, { children: [
            St && ne.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "conflict-reply-gap", "aria-hidden": "true" }),
            de > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (b) => {
                  b.stopPropagation(), B(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (b) => {
                  (b.key === "Enter" || b.key === " ") && (b.preventDefault(), b.stopPropagation(), B(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(or, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Ge }),
                    st ? /* @__PURE__ */ a(bs, {}) : /* @__PURE__ */ a(nr, {})
                  ] })
                ]
              }
            ),
            ne.map((b) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Qo,
              {
                comment: b,
                localizedStrings: r,
                ...
                handleDeleteComment: h,
                onEditingChange: Nt,
                canEditOrDelete: (!Q && R.get(b.id)) ?? !1
              }
            ) }, b.id)),
            v !== !1 && (!Q || Zt(z)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (b) => {
                  po(b) && (b.preventDefault(), b.stopPropagation(), (Zt(z) || E !== void 0 && E !== W) && Ae());
                },
                onKeyDown: (b) => {
                  wo(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Qr,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    E !== void 0 && (Zt(z) || E !== W) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ne(
                    ...
                    /* @__PURE__ */ u(Re, { open: gt, onOpenChange: Dt, children: [
                      /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
                        U,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !K || !k || k.length === 0 || !k.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(Ke, { children: k == null ? void 0 : k.map((b) => /* @__PURE__ */ a(
                            Oe,
                            {
                              onSelect: () => {
                                S(b !== i ? b : void 0), $.current = "user-selected", O(void 0), Dt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function wp({
  ...
  getConflictResolutionOptionsCallback: T
}) {
  const [_, N] = C(/* @__PURE__ */ new Set()), [A, F] = C(), [V, P] = C(), y = j(
    async (B) => {
      const Q = await i(B);
      return Q !== void 0 && B.assignedUser !== void 0 && B.assignedUser !== "" && P(B.assignedUser), Q;
    },
    [i]
  );
  X(() => {
    m && (N((B) => new Set(B).add(m)), F(m));
  }, [m]);
  const z = r.filter(
    (B) => B.comments.some((Q) => !Q.deleted)
  ), I = z.map((B) => ({ id: B.id })), E = j(
    (B) => {
      N((Q) => new Set(Q).add(B.id)), F(B.id), k == null || k(B.id);
    },
    [k]
  ), S = j(
    (B) => {
      ...
      N((Nt) => {
        const gt = new Set(Nt);
        return gt.has(B) ? gt.delete(B) : gt.add(B), gt;
      }), F(B), k == null || k(Q ? void 0 : B);
    },
    [_, k]
  ), { listboxRef: W, activeId: O, handleKeyDown: Y } = Ki({
    options: I,
    onOptionSelect: E
  }), st = j(
    (B) => {
      B.key === "Escape" ? (A && _.has(A) && (N((Q) => {
        const Nt = new Set(Q);
        return Nt.delete(A), Nt;
      }), F(void 0), k == null || k(void 0)), B.preventDefault(), B.stopPropagation()) : Y(B);
    },
    [A, _, Y, k]
  );
  return /* @__PURE__ */ a(
...
function Gd({ table: t }) {
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    It.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(It.Icon, { asChild: !0, children: /* @__PURE__ */ a(Fc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ie({
  ...
  return /* @__PURE__ */ u(
    It.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(It.ItemIndicator, { children: /* @__PURE__ */ a(ia, { className: "tw:pointer-events-none" }) }) }),
...
function Nr(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Jd(o)
  );
}
function ca({
  className: t,
...
function ce({
  ...
  const c = ut.useMemo(
    ...
    (w) => {
      ...
      ) : [], m = h.indexOf(p), k = c.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), tw(h, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Qd(c, k, w.key);
...
function ew({
  ...
  var F;
  const [w, p] = C([]), [g, h] = C([]), [m, k] = C({}), [v, D] = C({}), T = L(() => e ?? [], [e]), _ = Vn({
    data: T,
    columns: t,
    getCoreRowModel: jn(),
  ...
  let A;
  return d ? A = Array.from({ length: 10 }).map((y, z) => `skeleton-row-${z}`).map((y) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Oa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((F = _.getRowModel().rows) == null ? void 0 : F.length) > 0 ? A = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ce,
    {
      onClick: () => s(V, _),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map((P) => /* @__PURE__ */ a(Qt, { children: br(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    V.id
  )) : A = /* @__PURE__ */ a(ce, { children: /* @__PURE__ */ a(Qt, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Gd, { table: _ }),
    /* @__PURE__ */ u(ca, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ho, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map((P) => /* @__PURE__ */ a(ea, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : br(P.column.columnDef.header, P.getContext()) }, P.id)) }, V.id)) }),
      /* @__PURE__ */ a(la, { children: A })
    ] }),
...
function bp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(De, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(un, { children: l.itemType === 0 ? /* @__PURE__ */ a(at, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Le,
        {
          checked: o[w][g],
        ...
        qi,
        {
          ...
          children: l.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Gi, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Qe, {})
    ] }, l.label)) })
...
function bi({
  ...
  const [D, T] = C(!1), _ = j(
    (z) => {
      var E;
      const I = (E = t.find((S) => S.label === z)) == null ? void 0 : E.value;
      I && r(
        e.includes(I) ? e.filter((S) => S !== I) : [...e, I]
      );
    },
    [t, e, r]
  ), N = () => d || o, A = L(() => {
    if (!g) return t;
    const z = t.filter((E) => E.starred).sort((E, S) => E.label.localeCompare(S.label)), I = t.filter((E) => !E.starred).sort((E, S) => {
      const W = e.includes(E.value), O = e.includes(S.value);
      return W && !O ? -1 : !W && O ? 1 : E.label.localeCompare(S.label);
    });
    return [...z, ...I];
  }, [t, e, g]), F = () => {
    r(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Re, { open: P, onOpenChange: w ?? T, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
      U,
      {
        variant: k,
    ...
    /* @__PURE__ */ a($e, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ue, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: F, children: i }),
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: V, children: s })
      ] }),
      /* @__PURE__ */ u(Ke, { children: [
        /* @__PURE__ */ a(aa, { children: c }),
        /* @__PURE__ */ a(he, { children: A.map((z) => /* @__PURE__ */ u(
          Oe,
          {
            value: z.label,
            onSelect: _,
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Ds, { className: "tw:h-4 tw:w-4" }),
      ...
      return /* @__PURE__ */ u(yr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          U,
          {
            ...
            children: /* @__PURE__ */ a(oa, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function sw({
  ...
  const d = L(() => /Macintosh/i.test(navigator.userAgent), []), l = on(n, "%undoButton_tooltip%"), w = on(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(uo, { children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(
        U,
...
const lw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(at, { children: [
...
function dw({
  ...
  const i = q(null), s = q(null), c = q(!1), [d, l] = C(t), [w, p] = C(r), [g, h] = C(!1);
  X(() => {
    l(t);
  }, [t]), X(() => {
    w !== r && p(r);
  ...
  const m = (v) => {
    ...
    var D, T, _, N;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((D = i.current) == null || D.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((T = s.current) == null || T.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((N = s.current) == null || N.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Te, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: lw(t, n, r) }) }) }),
...
const ww = (t, e) => t === "f" ? /* @__PURE__ */ u(at, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function pw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: ww(t, r) }) }) }),
      /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ a("p", { children: uw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(De, { style: { zIndex: pn }, children: [
...
function Np({
  ...
  const [m, k] = C("generated"), [v, D] = C("generated"), [T, _] = C("*"), [N, A] = C("*"), [F, V] = C("f"), [P, y] = C(!1), [z, I] = C(!0), [E, S] = C(!1), W = q(!1), O = q(""), [Y, st] = C(!1), [B, Q] = C(), [Nt, gt] = C(), [Dt, K] = C(), [ot, mt] = C(), ct = q(null), tt = L(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  X(() => {
    ...
    if (H && Pr("note", H)) {
      const vt = (Z = H.insert.note) == null ? void 0 : Z.caller;
      let yt = "custom";
      vt === La ? yt = "generated" : vt === ja ? yt = "hidden" : vt && (_(vt), A(vt)), k(yt), D(yt), V(((nt = H.insert.note) == null ? void 0 : nt.style) ?? "f"), $ = setTimeout(() => {
        var ft;
        (ft = w.current) == null || ft.applyUpdate([H]);
      }, 0);
    }
    return () => {
      $ && clearTimeout($);
  ...
  const xt = j(
    ($, H, Z = !1) => {
      var vt, yt, ft;
      const nt = (yt = (vt = w.current) == null ? void 0 : vt.getNoteOps(0)) == null ? void 0 : yt.at(0);
      if (nt && Pr("note", nt)) {
        if (nt.insert.note) {
          let lt;
          $ === "custom" ? lt = H : $ === "generated" ? lt = La : lt = ja, nt.insert.note.caller = lt;
        }
        r == null || r([nt]), Z && l && i && ((ft = l.current) == null || ft.replaceEmbedUpdate(i, [nt]));
      }
    },
    [i, r, l]
  ), Ht = j(() => {
  ...
  const R = q({ book: n.book, chapterNum: n.chapterNum });
  Jt(() => {
    (R.current.book !== n.book || R.current.chapterNum !== n.chapterNum) && (R.current = { book: n.book, chapterNum: n.chapterNum }, Lt.current());
  }, [n.book, n.chapterNum]);
  const ee = () => {
    var H;
    const $ = (H = p.current) == null ? void 0 : H.getElementsByClassName("editor-input")[0];
    ...
    var Z, nt, vt, yt, ft;
    V($);
    const H = (nt = (Z = w.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : nt.at(0);
    if (H && Pr("note", H)) {
      H.insert.note && (H.insert.note.style = $);
      const lt = (yt = (vt = H.insert.note) == null ? void 0 : vt.contents) == null ? void 0 : yt.ops;
      F !== "x" && $ === "x" ? lt == null || lt.forEach((Ct) => vw(Ct)) : F === "x" && $ !== "x" && (lt == null || lt.forEach((Ct) => bw(Ct))), (ft = w.current) == null || ft.applyUpdate([H, { delete: 1 }]);
    }
  }, oe = ($) => {
    mt($.contextMarker), S($.canRedo);
  }, Me = j(
    ($) => {
      var Z, nt, vt, yt, ft;
      const H = (nt = (Z = w.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : nt.at(0);
      if (H && Pr("note", H)) {
        $.content.length > 1 && setTimeout(() => {
          var bt;
          (bt = w.current) == null || bt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const lt = (vt = H.insert.note) == null ? void 0 : vt.style, Ct = (ft = (yt = H.insert.note) == null ? void 0 : yt.contents) == null ? void 0 : ft.ops;
        if (lt || y(!1), y(
          lt === "x" ? !!(Ct != null && Ct.every((bt) => {
            var Tt, pt;
            if (!((Tt = bt.attributes) != null && Tt.char)) return !0;
            const Et = ((pt = bt.attributes) == null ? void 0 : pt.char).style;
          ...
          W.current = !0, O.current = JSON.stringify(H), I(!0);
          return;
        }
        I(JSON.stringify(H) === O.current), xt(m, T);
      } else
        y(!1), I(!0);
    },
    [m, T, xt]
    ...
    if (g.current && Vt.length && $ && $.rangeCount > 0) {
      const H = $.getRangeAt(0).getBoundingClientRect(), Z = g.current.getBoundingClientRect();
      Q(H.left - Z.left), gt(H.top - Z.top), K(H.height), st(!0);
    }
  }, [Vt, g]);
  X(() => {
    const $ = () => {
    ...
    var $;
    Y && (($ = ct.current) == null || $.focus());
  }, [Y]), X(() => {
    var Z;
    const $ = ((Z = p.current) == null ? void 0 : Z.querySelector(".editor-input")) ?? void 0, H = (nt) => {
      !Y && $ && document.activeElement === $ && nt.key === c ? (nt.preventDefault(), xe()) : Y && nt.key === "Escape" && (nt.preventDefault(), st(!1));
    };
...
function _w({
  ...
  /* @__PURE__ */ u("span", { className: f("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    go(t.marker, [s], o, !1),
    " "
  ] }), g = e === "horizontal" ? "horizontal" : "vertical", h = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", k = f(g, h);
  return /* @__PURE__ */ u(at, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(at, { children: yw(t.marker, c, o, l) })
      }
    )
  ] });
}
function Ep({
  ...
  const w = d ?? ss(r, void 0), p = (T, _) => {
    l == null || l(T, _, n);
  }, g = i ? r.findIndex((T) => T === i) : -1, [h, m] = C(g), k = (T, _, N) => {
    if (r.length)
      switch (T.key) {
        case "Enter":
        case " ":
          T.preventDefault(), l == null || l(_, N, n);
          break;
      }
  }, v = (T) => {
    if (r.length)
      switch (T.key) {
        case "ArrowDown":
          T.preventDefault(), m((_) => Math.min(_ + 1, r.length - 1));
          break;
        case "ArrowUp":
          T.preventDefault(), m((_) => Math.max(_ - 1, 0));
          break;
      }
  }, D = q([]);
  return X(() => {
    var T;
    h >= 0 && h < D.current.length && ((T = D.current[h]) == null || T.focus());
  }, [h]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((T, _) => {
            ...
            return /* @__PURE__ */ u(at, { children: [
              ...
              _ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(or, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function Cw({
  ...
  return /* @__PURE__ */ u(ca, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(ho, { stickyHeader: !0, children: /* @__PURE__ */ u(ce, { children: [
    ...
    /* @__PURE__ */ a(la, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ce,
      {
        ...
        children: [
          /* @__PURE__ */ a(Qt, { children: Ce(c.reference, "English") }),
          /* @__PURE__ */ a(Qt, { className: o, children: Nw(c.text) })
        ]
      },
...
const Ew = (t) => {
...
}, da = (t, e, r) => /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
  /* @__PURE__ */ u(
    Ut,
    {
  ...
  return e ? e[1] : "";
}, zw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", $p = Object.freeze([
...
function Mp({
  ...
  const h = we(r, "%webView_inventory_all%"), m = we(r, "%webView_inventory_approved%"), k = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), D = we(r, "%webView_inventory_scope_currentBook%"), T = we(r, "%webView_inventory_scope_chapter%"), _ = we(r, "%webView_inventory_scope_verse%"), N = we(r, "%webView_inventory_filter_text%"), A = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), F = we(r, "%webView_inventory_no_results%"), [V, P] = C(!1), [y, z] = C("all"), [I, E] = C(""), [S, W] = C([]), O = L(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : Sw(K, n, i);
  }, [t, n, i]), Y = L(() => {
    if (V) return O;
    const K = [];
    return O.forEach((ot) => {
      const mt = ot.items[0], ct = K.find(
        (tt) => tt.items[0] === mt
      );
  ...
  }, [V, O]), st = L(() => Y.length === 0 ? [] : Dw(Y, y, I), [Y, y, I]), B = L(() => {
    var mt, ct;
    if (!V) return d;
    const K = (mt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : mt.length;
    if (!K) return d;
    const ot = [];
  ...
  X(() => {
    st.length === 0 ? W([]) : st.length === 1 && W(st[0].items);
  }, [st]);
  const Q = (K, ot) => {
    ot.setRowSelection(() => {
      const ct = {};
    ...
    const mt = K.original.items;
    W(mt), g && mt.length > 0 && g(mt[0]);
  }, Nt = (K) => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
        /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? A })
        ] }) }),
        ...
        children: [
          ...
          t && /* @__PURE__ */ u(
            U,
            {
              ...
              children: [
                /* @__PURE__ */ a(oa, { className: "tw:h-4 tw:w-4" }),
...
const ki = na(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ls, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
ki.displayName = "Spinner";
function Ow(t, e = 50) {
  const [r, o] = C(e), n = q(null);
  return X(() => {
    o(e);
  }, [t, e]), X(() => {
...
function za({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(at, { children: [
      /* @__PURE__ */ a(ce, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        ce,
        {
          ...
          children: [
            /* @__PURE__ */ a(Qt, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(at, { children: [
...
function Pp({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = L(
    () => t.filter((S) => !r || S.type === r).filter((S) => Rw(S, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: k, hasMore: v } = Ow(h), D = L(
    () => Array.from(new Set(t.map((S) => S.bestLanguageName))).map((S) => ({
      label: S,
      value: S
    })),
    [t]
  ), T = p.length === 0 && g.length === 0 && h.length === 0, _ = _e(n, "%resourcePicker_title%"), N = _e(n, "%resourcePicker_search_placeholder%"), A = _e(n, "%resourcePicker_language_filter_any%"), F = _e(
    n,
    "%resourcePicker_section_already_selected%"
  ), V = _e(n, "%resourcePicker_section_installed%"), P = _e(
    n,
    "%resourcePicker_section_available_to_download%"
  ), y = _e(n, "%resourcePicker_no_results%"), z = _e(n, "%resourcePicker_showing_count%"), I = L(() => {
    if (d.length === D.length || d.length === 0)
      return A;
    if (d.length === 1) {
      const S = D.find((W) => W.value === d[0]);
      if (S) return S.label;
    }
    return Ne(
  ...
  }, [d, D, A, n]), E = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(at, { children: [
    /* @__PURE__ */ a(Hr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Yr, { children: _ }) }),
    ...
    E && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: Ne(z, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      T && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: y }),
      !T && !e && /* @__PURE__ */ a(ca, { children: /* @__PURE__ */ u(la, { children: [
        /* @__PURE__ */ a(za, { label: F, resources: p }),
        /* @__PURE__ */ a(za, { label: V, resources: g, onSelect: i }),
        /* @__PURE__ */ a(
          za,
          {
            label: P,
        ...
        v && /* @__PURE__ */ a(ce, { className: "tw:border-0", children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: k, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const $w = "16rem", Mw = "3rem", _i = ut.createContext(void 0);
function ua() {
  const t = ut.useContext(_i);
  if (!t)
...
function Aw({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), g = ut.useCallback(() => p((_) => !_), [p]), h = w ? "expanded" : "collapsed", v = Gt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", D = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(_i.Provider, { value: D, children: /* @__PURE__ */ a(
    "div",
    {
...
function Bw({
  ...
  const c = t ? ur.Root : "button", { state: d } = ua(), l = /* @__PURE__ */ a(
    c,
    {
...
function Gp({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      ...r,
      children: [
        e && /* @__PURE__ */ a(Oa, { className: "tw:size-4 tw:rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ a(
          Oa,
          {
...
function Uw({
  ...
  const l = j(
    ...
    (h) => {
      const m = r.find((k) => k.projectId === h);
    ...
    Pw,
    {
      ...
      children: /* @__PURE__ */ u(Vw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Lw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(jw, { children: /* @__PURE__ */ a(
            Bw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const Ie = "scrBook", Kw = "scrRef", Je = "source", qw = "details", Gw = "Scripture Reference", Hw = "Scripture Book", Ni = "Type", Yw = "Details";
function Ww(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? wt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ie ? Ce(n.start) : void 0;
      },
...
const Xw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ra(t.start, t.end) === 0 ? `${ga(t.start)}+${e}` : `${ga(t.start)}+${e}-${ga(t.end)}+${r}`;
}, dn = (t) => `${Xw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Jp({
  sources: t,
  ...
  const [l, w] = C([]), [p, g] = C([{ id: Ie, desc: !1 }]), [h, m] = C({}), k = L(
  ...
  X(() => {
    if (c) {
      const y = D.getSelectedRowModel().rowsById, z = Object.keys(y);
      if (z.length === 1) {
        const I = k.find((E) => dn(E) === z[0]) || void 0;
        I && c(I);
      }
    }
  }, [h, k, c, D]);
  const T = n ?? Hw, _ = i ?? Ni, N = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${T}`, value: [Ie] },
    { label: `Group by ${_}`, value: [Je] },
    {
      label: `Group by ${T} and ${_}`,
      value: [Ie, Je]
    },
    {
      label: `Group by ${_} and ${T}`,
      value: [Je, Ie]
    }
  ], A = (y) => {
    w(JSON.parse(y));
  ...
  }, V = (y, z) => y.getIsGrouped() ? "" : f("banded-row", z % 2 === 0 ? "even" : "odd"), P = (y, z, I) => {
    if (!((y == null ? void 0 : y.length) === 0 || z.depth < I.column.getGroupedIndex())) {
      if (z.getIsGrouped())
        switch (z.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: N.map((y) => /* @__PURE__ */ a(ie, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ca, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(ho, { children: D.getHeaderGroups().map((y) => /* @__PURE__ */ a(ce, { children: y.headers.filter((z) => z.column.columnDef.header).map((z) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ea, { colSpan: z.colSpan, className: "tw:sticky top-0", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(la, { children: D.getRowModel().rows.map((y, z) => {
        const I = Gt();
        return /* @__PURE__ */ a(
          ce,
          {
            ...
            children: y.getVisibleCells().map((E) => {
              if (!(E.getIsPlaceholder() || E.column.columnDef.enableGrouping && !E.getIsGrouped() && (E.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  Qt,
                  {
                    className: f(
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ u(
                      U,
                      {
                        ...
                        type: "button",
                        children: [
                          y.getIsExpanded() && /* @__PURE__ */ a(nr, {}),
                          !y.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a($a, {})),
                          " ",
                          br(E.column.columnDef.cell, E.getContext()),
                          " (",
                          y.subRows.length,
                          ")"
                        ]
...
function Jw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: m } = {
  ...
  }, [k, v] = C(!1), [D, T] = C(""), _ = q(void 0), N = q(!1), A = L(
    () => Ci(t),
    [t]
  ), F = L(() => {
    if (!D.trim()) {
    ...
    (E, S = !1) => {
      ...
      const W = A.findIndex((Q) => Q === _.current), O = A.findIndex((Q) => Q === E);
      if (W === -1 || O === -1) return;
      const [Y, st] = [
        Math.min(W, O),
        Math.max(W, O)
      ], B = A.slice(Y, st + 1).map((Q) => Q);
      r(
        e.includes(E) ? e.filter((Q) => !B.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...B])]
      );
    },
    [e, r, A]
  ), P = (E) => {
    V(E, N.current), N.current = !1;
  }, y = (E, S) => {
    E.preventDefault(), V(S, E.shiftKey);
  }, z = () => {
    r(A.map((E) => E));
  }, I = () => {
    r([]);
      ...
      children: [
        ...
        /* @__PURE__ */ a($e, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Ue,
          {
            shouldFilter: !1,
            onKeyDown: (E) => {
              E.key === "Enter" && (N.current = E.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                Cr,
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                ...
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: I, children: l })
              ] }),
              /* @__PURE__ */ u(Ke, { children: [
                  ...
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(_n, { children: [
                      /* @__PURE__ */ a(
                        he,
                        {
                          heading: Fn(E, p, g, h, m),
                          children: W.map((O) => /* @__PURE__ */ a(
                            Un,
                            {
                              bookId: O,
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Da ? Da : wn
      ).map((d) => /* @__PURE__ */ a(yr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ve(d, n) }, d)),
...
function Qp({
  ...
  const N = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), A = Rt(s, "%webView_scope_selector_verse%"), F = Rt(s, "%webView_scope_selector_chapter%"), V = Rt(s, "%webView_scope_selector_book%"), P = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), y = Rt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), z = Rt(s, "%webView_scope_selector_current_book%"), I = Rt(s, "%webView_scope_selector_choose_books%"), E = Rt(s, "%webView_scope_selector_scope%"), S = Rt(s, "%webView_scope_selector_select_books%"), W = Rt(s, "%webView_scope_selector_range%"), O = Rt(s, "%webView_scope_selector_select_range%"), Y = Rt(s, "%webView_scope_selector_range_start%"), st = Rt(s, "%webView_scope_selector_range_end%"), B = Rt(s, "%webView_scope_selector_ok%"), Q = Rt(s, "%webView_scope_selector_cancel%"), Nt = Rt(s, "%webView_scope_selector_navigate%"), gt = (M) => {
    if (!m) return;
  ...
  ], K = (M, J, jt = !1) => /* @__PURE__ */ u(at, { children: [
    M,
    J && !jt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), ot = e ? Dt.filter((M) => e.includes(M.value)) : Dt, mt = m ?? fa, ct = w ?? mt, tt = p ?? mt, Vt = () => {
  }, xt = q(null), Ht = q(null), Lt = q(!1), R = q(null), ee = q(!1), [St, re] = C(void 0), ae = q(!1), oe = q(!1), Me = q(null), xe = j((M) => {
    if (M) {
      re("start"), ae.current = !1;
      return;
    }
    re((J) => J === "start" ? void 0 : J), ae.current && (ae.current = !1, requestAnimationFrame(() => {
      var jt;
      const J = (jt = xt.current) == null ? void 0 : jt.querySelector("button");
      J == null || J.click();
    }));
  }, []), Yt = j((M) => {
    if (M) {
    ...
    (M) => {
      g == null || g(M), h == null || h(M), ae.current = !0;
    },
    [g, h]
  ), H = j(
    (M) => {
      h == null || h(M), oe.current = !0;
    },
    [h]
  ), Z = j(
    (M) => {
      r(M), M === "selectedBooks" && n.length === 0 && (m != null && m.book) && i([m.book]);
    },
    [r, n, m, i]
  ), nt = ot.find((M) => M.value === t), vt = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? ls(ct, tt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : nt ? K(nt.label, nt.scrRefSuffix) : t, yt = ot.filter(
    (M) => M.value !== "selectedBooks" && M.value !== "range"
  ), ft = ot.find((M) => M.value === "selectedBooks"), lt = ot.find((M) => M.value === "range"), [Ct, bt] = C(!1), [Et, Tt] = C(void 0), [pt, ye] = C(void 0), [ne, de] = C(void 0), [ke, Ge] = C(void 0), [Ae, He] = C([]), Ye = l === "dropdown" && Et === "selectedBooks", x = /* @__PURE__ */ a(
    Qw,
    {
      availableBookInfo: o,
      selectedBookIds: Ye ? Ae : n,
      onChangeSelectedBookIds: Ye ? He : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), b = St === "end", G = St === "start", rt = "tw:text-muted-foreground", zt = l === "dropdown" && Et === "range", Pe = zt ? de : $, Mt = zt ? Ge : h ? H : Vt, kt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: f(b && rt), children: Y }),
      /* @__PURE__ */ a(
        va,
        {
    ...
    /* @__PURE__ */ u("div", { ref: xt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: f(G && rt), children: st }),
      /* @__PURE__ */ a(
        va,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: D,
          disableReferencesUpTo: zt ? ne ?? ct : ct,
          onOpenChange: Yt,
          onCloseAutoFocus: (M) => {
            var J;
            oe.current && (oe.current = !1, M.preventDefault(), (J = Me.current) == null || J.focus());
          },
          className: f(G && rt),
          modal: !0,
          align: "start"
  ...
  const [Xt, We] = C(null), [Or, Mi] = C(null), [Rr, Ai] = C(null), Pi = 200, [Ii, Vi] = C(!1);
  X(() => {
    if (!Rr || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([J]) => {
      Vi(J.contentRect.width < Pi);
    });
    return M.observe(Rr), () => M.disconnect();
  }, [Rr]);
  const mo = j(
    (M) => {
      ye(M), de(ct), Ge(tt), He(n), bt(!1), Tt(M);
    },
    [ct, tt, n]
  ), vo = j(() => {
    pt !== void 0 && (pt === "range" ? (ne && (g == null || g(ne)), ke && (h == null || h(ke))) : pt === "selectedBooks" && i(Ae), Z(pt), Tt(void 0), ye(void 0));
  }, [
    pt,
    ne,
    ke,
    ...
    M || (Tt(void 0), ye(void 0));
  }, []), bo = j((M) => {
    var J;
    M.preventDefault(), (J = Wt.current) == null || J.focus();
  }, []), xo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(je, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !T && /* @__PURE__ */ a(_t, { children: E }),
      l === "dropdown" ? /* @__PURE__ */ u(Te, { open: Ct, onOpenChange: bt, children: [
        ...
        /* @__PURE__ */ a(
          De,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(pa, { container: Rr, children: [
              yt.map(({ value: M, label: J, dropdownLabel: jt, scrRefSuffix: gr, id: Li }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: ht(M),
                  ...
                  children: [
                    t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(je, { className: "tw:h-4 tw:w-4" }) }),
                    K(jt ?? J, gr, Ii)
                  ]
                },
                Li
              ...
              k && /* @__PURE__ */ u(at, { children: [
                /* @__PURE__ */ a(Qe, {}),
                /* @__PURE__ */ a(Er, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Nt }),
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ref: R,
                    ...
                    onSelect: (M) => {
                      var J, jt;
                      if (M.preventDefault(), Lt.current) {
                        Lt.current = !1;
                        return;
                      }
                      ee.current || (jt = (J = Ht.current) == null ? void 0 : J.querySelector("button")) == null || jt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (M) => {
                          ...
                          J != null && J.closest("button") && (Lt.current = !0, requestAnimationFrame(() => {
                            Lt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          va,
                          {
                            ...
                            onCloseAutoFocus: (M) => {
                              var J;
                              M.preventDefault(), (J = R.current) == null || J.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(at, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ce(m ?? fa, "id") }),
                              /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        ao,
        {
          ...
          children: ot.map(({ value: M, label: J, scrRefSuffix: jt, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Wr, { className: "tw:me-2", value: M, id: gr }),
            /* @__PURE__ */ a(_t, { htmlFor: gr, children: K(J, jt) })
          ] }, gr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && kt,
    l === "dropdown" && ft && /* @__PURE__ */ a(Fa, { open: Et === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: Mi,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (M) => {
          Or != null && Or.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(pa, { container: Or, children: [
          /* @__PURE__ */ a(Hr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Yr, { children: I }) }),
          x,
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => $r(!1), children: Q }),
            /* @__PURE__ */ a(U, { onClick: vo, children: B })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && lt && /* @__PURE__ */ a(Fa, { open: Et === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: We,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (M) => {
          Xt != null && Xt.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(pa, { container: Xt, children: [
          /* @__PURE__ */ a(Hr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Yr, { children: O }) }),
          kt,
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => $r(!1), children: Q }),
            /* @__PURE__ */ a(U, { ref: Me, onClick: vo, children: B })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: wr },
            children: t.map((l) => /* @__PURE__ */ a(ie, { value: `${l}`, children: c[ko(l)] }, `${l}`))
          }
        )
      ]
    }
...
const zi = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Ut, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Qi, { children: /* @__PURE__ */ a(ts, { children: zi(
      t,
      e,
      Ti(t, c.id),
      o
...
function Ha({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Fs, {}) }) }),
    /* @__PURE__ */ a(De, { align: "start", style: { zIndex: wr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(_n, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Ft, { children: zi(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Qe, {})
    ] }, d)) })
  ] });
}
const Di = ut.forwardRef(
...
const Si = ut.forwardRef(({ className: t, ...e }, r) => {
  const o = Gt();
  return /* @__PURE__ */ a(
    le.Root,
    {
...
const Oi = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.List,
  {
    ref: r,
    className: f(
...
const ru = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Trigger,
  {
    ref: r,
    ...e,
...
)), Ri = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Content,
  {
    ref: r,
    className: f(
...
Ri.displayName = le.Content.displayName;
function ih({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Si, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(ru, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), mr(i, [g, h]);
        break;
      case "alt+l":
        (k = s.current) == null || k.focus(), mr(s, [g, h]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), mr(c, [g, h]);
        break;
      case "alt+h":
        (D = d.current) == null || D.focus(), mr(d, [g, h]);
        break;
    }
  }), X(() => {
    ...
    return /* @__PURE__ */ a(au, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(ou, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: wr },
          children: /* @__PURE__ */ a(Ft, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function lh({
  ...
  const l = hu(
    ...
    var D, T, _, N, A, F;
    const v = k !== m ? ((T = (D = t[m]) == null ? void 0 : D.uiNames) == null ? void 0 : T[k]) ?? ((N = (_ = t[m]) == null ? void 0 : _.uiNames) == null ? void 0 : N.en) : void 0;
    return v ? `${(A = t[m]) == null ? void 0 : A.autonym} (${v})` : (F = t[m]) == null ? void 0 : F.autonym;
  };
      ...
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: wr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(ie, { value: m, children: h(m, e) }, m))
            }
          )
        ]
      }
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(ze, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Eo, {}) }) }),
...
function Kh({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", xu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  Lh as Progress,
  Ap as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  ao as RadioGroup,
