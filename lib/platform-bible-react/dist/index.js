...
import lt, { useRef as q, useMemo as B, useState as k, useCallback as L, useEffect as W, useImperativeHandle as Ls, useLayoutEffect as Ht, createContext as Ga, useContext as hn, Component as Fs, createElement as xo, Suspense as js, forwardRef as ra, Fragment as gn } from "react";
...
function ga({
  ...
  const _ = Ut(), [V, K] = k(!1), [I, R] = k(""), [z, E] = k(""), [D, S] = k("books"), [$, X] = k(void 0), [F, M] = k(
    void 0
  ), [Y, ft] = k(void 0), [dt, qt] = k(!1), Dt = q(null), It = q(!1), j = q(void 0), tt = q(void 0), et = q(void 0), nt = q(void 0), vt = q({}), Yt = q({}), it = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
    ...
    return [ct.OT, ct.NT, ct.DC, ct.Extra].forEach((Q) => {
      b[Q] = Ct[Q].filter((Ot) => en(Ot, z, n));
    }), b;
  }, [Ct, z, n]), O = B(
    () => Mi(z, xt, n),
    [z, xt, n]
  ...
  const $t = L(() => {
    ...
    (b) => {
      const H = F ?? (O == null ? void 0 : O.book), Q = Y ?? (O == null ? void 0 : O.chapterNum);
      !H || !Q || (it({
        book: H,
        chapterNum: Q,
        verseNum: b
  ...
  W(() => {
    var b;
    ht !== 0 && ((b = tt.current) == null || b.focus());
  }, [ht]), Ls(
    N,
    () => ({
      open: () => {
  ...
  const { otLong: bt, ntLong: wt, dcLong: yt, extraLong: C } = {
    ...
    (b) => {
      var fe, Ue, $e;
      if (b.ctrlKey) return;
      const { isLetter: H, isDigit: Q } = go(b.key);
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (Ot = tt.current) == null || Ot.focus();
      return;
    }
    const { isLetter: H, isDigit: Q } = go(b.key);
    (H || Q) && (b.preventDefault(), E((fe) => fe + b.key), tt.current.focus(), qt(!1));
  }, []);
  return Ht(() => {
    const b = setTimeout(() => {
      if (V && D === "books" && et.current && nt.current) {
        const H = et.current, Q = nt.current, Ot = Q.offsetTop, fe = H.clientHeight, Ue = Q.clientHeight, $e = Ot - fe / 2 + Ue / 2;
        H.scrollTo({
          top: Math.max(0, $e),
          behavior: "smooth"
        }), R(On(t.book));
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Te, { open: V, onOpenChange: Z, modal: v, children: [
    /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ a(
      U,
      {
        ref: Dt,
    ...
    /* @__PURE__ */ a(
      ze,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: H } = b;
          V && Dt.current && H instanceof Node && Dt.current.contains(H) && (It.current = !0, Z(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          Be,
            ...
            children: [
              D === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: P.map(
                  ({ onClick: b, disabled: H, title: Q, icon: Ot }) => /* @__PURE__ */ a(
                    U,
                    {
                      variant: "ghost",
                      size: "sm",
              ...
              !dt && /* @__PURE__ */ u(Le, { ref: et, children: [
                  ...
                  !O && Object.entries(Bt).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(le, { heading: ut(b), children: H.map((Q) => /* @__PURE__ */ a(
                          Mn,
                          {
                            bookId: Q,
                            onSelect: (Ot) => Se(Ot),
...
function Do({
  ...
  const [y, _] = k(!1), V = d ?? l, K = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], I = (R, z) => {
  ...
  return /* @__PURE__ */ u(Te, { open: y, onOpenChange: _, ...N, children: [
...
function Lu({
  ...
  const w = fa(d, "%webView_bookSelector_currentBook%"), p = fa(d, "%webView_bookSelector_choose%"), f = fa(d, "%webView_bookSelector_chooseBooks%"), [g, m] = k(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    m(v), t(v);
...
function yl() {
  return function(t) {
    const [e] = he(), r = B(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = q(o);
    return bl(() => {
...
function Cl(t, e, r) {
  ...
  function l() {
    ...
    for (let T = 0; T < g.length; T++) {
      const N = g[T], y = s[T] || document.createElement("div"), _ = y.style;
      _.position !== "absolute" && (_.position = "absolute", v = !0);
      const V = ce(N.left - p);
      _.left !== V && (_.left = V, v = !0);
      const K = ce(N.top - f);
      _.top !== K && (y.style.top = K, v = !0);
      const I = ce(N.width);
      _.width !== I && (y.style.width = I, v = !0);
      const R = ce(N.height);
      _.height !== R && (y.style.height = R, v = !0), y.parentNode !== c && (c.append(y), v = !0), s[T] = y;
    }
...
function Tl(t, e = El) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), m = f.getNode(), x = m.getKey(), v = f.offset, T = g.getNode(), N = T.getKey(), y = g.offset, _ = t.getElementByKey(x), V = t.getElementByKey(N), K = r === null || _ !== o || v !== n || x !== r.getKey(), I = i === null || V !== s || y !== c || N !== i.getKey();
            ...
            t.update(() => {
              ...
              if (we(m)) {
                ...
                if (Ma(v) && d >= 0 && w >= 0 && (T = d, N = d + w, m.setTextNodeRange(v, T, v, N)), T === N && p === "" || (m.insertRawText(p), v = x.getNode()), Ma(v)) {
                  ...
                  T = T > y ? y : T, N = N > y ? y : N, m.setTextNodeRange(v, T, v, N);
                }
...
function md({
  ...
  const [e] = he(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = fd(), l = () => {
  };
...
function xd() {
  const { activeEditor: t } = ei(), [e, r] = k([]), o = L((n) => {
    if (we(n) || Gc(n)) {
      const i = [];
      Fo.forEach(({ format: s }) => {
...
function ju({
  ...
  const [i, s] = k(Ed), [c, l] = k(n), [d, w] = k(!1), p = q(void 0), f = q(null);
  W(() => {
    let v = !0;
    const T = f.current;
    if (!T) return;
...
function Uo({
  ...
  const g = L(
    ...
    [t.user]
  ), N = B(() => Ms(t.contents), [t.contents]), y = B(() => {
    if (o && c)
      return /* @__PURE__ */ u(rt, { children: [
        /* @__PURE__ */ u(
          He,
...
function Rd({
  ...
  const [R, z] = k(qo), [E, D] = k(), [S, $] = k(), X = o, [F, M] = k(!1), [Y, ft] = k(!1), [dt, qt] = k(!1), [Dt, It] = k(!1), [j, tt] = k(!1), [et, nt] = k(_), [vt, Yt] = k(!1), it = q(void 0), [Rt, Ct] = k(/* @__PURE__ */ new Map());
  W(() => {
    let C = !0;
    return (async () => {
  ...
  }, [i, r]), P = B(() => Bt.slice(1), [Bt]), G = B(() => P.length ?? 0, [P.length]), ot = B(() => G > 0, [G]), Z = B(() => F || G <= 2 ? P : P.slice(-2), [P, G, F]), ht = B(() => F || G <= 2 ? 0 : G - 2, [G, F]), _t = B(
        ...
        children: /* @__PURE__ */ u(zd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                U,
                {
                  ...
                  children: et ? /* @__PURE__ */ a(as, {}) : /* @__PURE__ */ a(os, {})
                }
              ),
          ...
          /* @__PURE__ */ u(rt, { children: [
            ...
            o && /* @__PURE__ */ u(rt, { children: [
              ...
              Z.map((C) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Uo,
                {
                  comment: C,
                  localizedStrings: r,
...
function Xu({
  ...
  const [T, N] = k(/* @__PURE__ */ new Set()), [y, _] = k(), [V, K] = k(), I = L(
    async (M) => {
      const Y = await i(M);
...
function Fd({
  ...
  var K;
  const [w, p] = k([]), [f, g] = k([]), [m, x] = k({}), [v, T] = k({}), N = B(() => e ?? [], [e]), y = Dn({
    data: N,
    columns: t,
    getCoreRowModel: $n(),
  ...
  let V;
  return l ? V = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Jt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((K = y.getRowModel().rows) == null ? void 0 : K.length) > 0 ? V = y.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ne,
    {
      onClick: () => s(I, y),
    ...
    n && /* @__PURE__ */ a($d, { table: y }),
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(io, { stickyHeader: i, children: y.getHeaderGroups().map((I) => /* @__PURE__ */ a(ne, { children: I.headers.map((R) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: R.isPlaceholder ? void 0 : br(R.column.columnDef.header, R.getContext()) }, R.id)) }, I.id)) }),
...
function Xd({
  ...
  const i = q(null), s = q(null), c = q(!1), [l, d] = k(t), [w, p] = k(r), [f, g] = k(!1);
  W(() => {
    d(t);
  }, [t]), W(() => {
    w !== r && p(r);
  ...
  const m = (v) => {
    ...
    var T, N, y, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((T = i.current) == null || T.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((y = i.current) == null ? void 0 : y.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
...
function lp({
  ...
  const [m, x] = k("generated"), [v, T] = k("generated"), [N, y] = k("*"), [_, V] = k("*"), [K, I] = k("f"), [R, z] = k(!1), [E, D] = k(!0), [S, $] = k(!1), X = q(!1), F = q(""), [M, Y] = k(!1), [ft, dt] = k(), [qt, Dt] = k(), [It, j] = k(), [tt, et] = k(), nt = q(null), vt = B(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (G && Pr("note", G)) {
      ...
      let _t = "custom";
      ht === Oa ? _t = "generated" : ht === Aa ? _t = "hidden" : ht && (y(ht), V(ht)), x(_t), T(_t), I(((Z = G.insert.note) == null ? void 0 : Z.style) ?? "f"), P = setTimeout(() => {
        var bt;
  ...
  const it = L(
    (P, G, ot = !1) => {
      var ht, _t, bt;
      const Z = (_t = (ht = w.current) == null ? void 0 : ht.getNoteOps(0)) == null ? void 0 : _t.at(0);
      if (Z && Pr("note", Z)) {
        if (Z.insert.note) {
          let wt;
          P === "custom" ? wt = G : P === "generated" ? wt = Oa : wt = Aa, Z.insert.note.caller = wt;
        }
        r == null || r([Z]), ot && d && i && ((bt = d.current) == null || bt.replaceEmbedUpdate(i, [Z]));
      }
    },
    [i, r, d]
  ), Rt = L(() => {
  ...
  const Bt = () => {
    ...
    var ot, Z, ht, _t, bt;
    I(P);
    const G = (Z = (ot = w.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : Z.at(0);
    if (G && Pr("note", G)) {
  ...
  W(() => {
    ...
    var ot;
    const P = ((ot = p.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0, G = (Z) => {
      !M && P && document.activeElement === P && Z.key === c ? (Z.preventDefault(), Lt()) : M && Z.key === "Escape" && (Z.preventDefault(), Y(!1));
    };
...
function wp({
  ...
  const w = l ?? Vs(r, void 0), p = (N, y) => {
    d == null || d(N, y, n);
  }, f = i ? r.findIndex((N) => N === i) : -1, [g, m] = k(f), x = (N, y, _) => {
    if (r.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), d == null || d(y, _, n);
          break;
      }
  }, v = (N) => {
    if (r.length)
      switch (N.key) {
        case "ArrowDown":
          N.preventDefault(), m((y) => Math.min(y + 1, r.length - 1));
          break;
        case "ArrowUp":
          N.preventDefault(), m((y) => Math.max(y - 1, 0));
          break;
      }
  }, T = q([]);
  return W(() => {
        ...
        "ul",
        {
          ...
          children: r.map((N, y) => {
            ...
            return /* @__PURE__ */ u(rt, { children: [
              ...
              y < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(er, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function bp({
  ...
  const g = se(r, "%webView_inventory_all%"), m = se(r, "%webView_inventory_approved%"), x = se(r, "%webView_inventory_unapproved%"), v = se(r, "%webView_inventory_unknown%"), T = se(r, "%webView_inventory_scope_currentBook%"), N = se(r, "%webView_inventory_scope_chapter%"), y = se(r, "%webView_inventory_scope_verse%"), _ = se(r, "%webView_inventory_filter_text%"), V = se(
    r,
    "%webView_inventory_show_additional_items%"
  ), K = se(r, "%webView_inventory_no_results%"), [I, R] = k(!1), [z, E] = k("all"), [D, S] = k(""), [$, X] = k([]), F = B(() => {
    const j = t ?? [];
    ...
    const j = [];
    return F.forEach((tt) => {
      const et = tt.items[0], nt = j.find(
        (vt) => vt.items[0] === et
      );
      nt ? (nt.count += tt.count, nt.occurrences = nt.occurrences.concat(tt.occurrences)) : j.push({
        items: [et],
        count: tt.count,
    ...
    var et, nt;
    if (!I) return l;
    const j = (et = o == null ? void 0 : o.tableHeaders) == null ? void 0 : et.length;
    if (!j) return l;
    const tt = [];
  ...
  const dt = (j, tt) => {
    ...
    const et = j.original.items;
    X(et), f && et.length > 0 && f(et[0]);
  }, qt = (j) => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(or, { onValueChange: (j) => qt(j), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(sr, { children: [
          ...
          /* @__PURE__ */ a(oe, { value: "verse", children: y })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Dr,
...
function yp({
  ...
  const [s, c] = k(""), [l, d] = k([]), w = B(
    ...
    [t]
  ), N = p.length === 0 && f.length === 0 && g.length === 0, y = me(n, "%resourcePicker_title%"), _ = me(n, "%resourcePicker_search_placeholder%"), V = me(n, "%resourcePicker_language_filter_any%"), K = me(
    n,
    "%resourcePicker_section_already_selected%"
  ...
  return /* @__PURE__ */ u(rt, { children: [
    /* @__PURE__ */ a(Kr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Gr, { children: y }) }),
...
function yw({
  ...
  const [l, d] = lt.useState(t), w = e ?? l, p = lt.useCallback(
    ...
    [r, w]
  ), f = lt.useCallback(() => p((y) => !y), [p]), g = w ? "expanded" : "collapsed", v = Ut() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = lt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Pp({
  ...
  const [d, w] = k([]), [p, f] = k([{ id: Me, desc: !1 }]), [g, m] = k({}), x = B(
...
function Vw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: g, extraLong: m } = {
  ...
  }, [x, v] = k(!1), [T, N] = k(""), y = q(void 0), _ = q(!1), V = B(
    () => gi(t),
    [t]
  ), K = B(() => {
    if (!T.trim()) {
    ...
    (S, $ = !1) => {
      ...
      const X = V.findIndex((dt) => dt === y.current), F = V.findIndex((dt) => dt === S);
      if (X === -1 || F === -1) return;
      const [M, Y] = [
        Math.min(X, F),
        Math.max(X, F)
...
function Ip({
  ...
  const _ = Et(
  ...
  ] }), tt = e ? It.filter((A) => e.includes(A.value)) : It, et = m ?? ha, nt = w ?? et, vt = p ?? et, Yt = () => {
  }, it = q(null), Rt = q(null), Ct = q(!1), xt = q(null), Bt = q(!1), [O, ae] = k(void 0), $t = q(!1), Mt = q(!1), Se = q(null), Lt = L((A) => {
    if (A) {
    ...
    [r, n, m, i]
  ), Z = tt.find((A) => A.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Bs(nt, vt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Z ? j(Z.label, Z.scrRefSuffix) : t, _t = tt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), bt = tt.find((A) => A.value === "selectedBooks"), wt = tt.find((A) => A.value === "range"), [yt, C] = k(!1), [ut, gt] = k(void 0), [Nt, De] = k(void 0), [Re, wr] = k(void 0), [je, Rr] = k(void 0), [Xe, ur] = k([]), pr = d === "dropdown" && ut === "selectedBooks", hr = /* @__PURE__ */ a(
    Bw,
    {
      availableBookInfo: o,
  ...
  const [mt, St] = k(null), [pt, Wt] = k(null), [Kt, qe] = k(null), Ni = 200, [Ci, Ei] = k(!1);
  W(() => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      d === "dropdown" ? /* @__PURE__ */ u(ke, { open: yt, onOpenChange: C, children: [
        ...
        Pn,
        {
          ...
          children: tt.map(({ value: A, label: J, scrRefSuffix: Ft, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
...
function Yp({
  ...
  const d = tu(
    ...
    var T, N, y, _, V, K;
    const v = x !== m ? ((N = (T = t[m]) == null ? void 0 : T.uiNames) == null ? void 0 : N[x]) ?? ((_ = (y = t[m]) == null ? void 0 : y.uiNames) == null ? void 0 : _.en) : void 0;
