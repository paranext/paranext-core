...
import { c as b, g as Re, a as zr, C as Ge, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as Ie, f as ke, h as ze, i as tr, j as Be, B as J, x as vs, k as bs, l as xs, I as ys, m as _o, n as Ke, r as Ce, o as ks, p as Kn, P as er, q as _r, s as rr, t as ar, v as Ca, w as Ea, y as No, z as or, E as Ta, F as Mt, R as Co, G as ga, H as ao, J as oo, K as no, M as io, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as hr, W as _s, X as Ze, Y as Ue, Z as Pe, _ as je, $ as gr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as qn, a5 as Ns, a6 as Cs, a7 as Es, a8 as so, a9 as Gn, aa as Sa, ab as Ts, ac as Wn, ad as Ss, ae as Rs, af as Ds, ag as Qo, ah as Ms, ai as Os, aj as Is, ak as Yn, al as Xn, am as Do, an as zs, ao as Jn, ap as ja, aq as tn, ar as Fa, as as Ps, at as $s, au as As, av as Vs, aw as Ls, ax as Bs, ay as Fr, az as Mo, aA as js, aB as Fs } from "./resizable-BZoqWCen.js";
import { aC as lf, aD as df, aE as wf, aF as uf, aG as pf, aH as hf, aI as gf, aJ as ff, aK as mf, aL as vf, aM as bf, aN as xf, aO as yf, aP as kf, aQ as _f, aR as Nf, aS as Cf, aT as Ef, aU as Tf, aV as Sf, aW as Rf, aX as Df, aY as Mf, aZ as Of, a_ as If, a$ as zf, b0 as Pf, b1 as $f, b2 as Af, b3 as Vf, b4 as Lf, b5 as Bf, b6 as jf, b7 as Ff, b8 as Uf, b9 as Kf, ba as Hf } from "./resizable-BZoqWCen.js";
...
function cd({
  ...
  const [h, f] = _(!1), [m, x] = _(!1), g = va(), S = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, id), P = re(s, sd), T = (M) => {
...
function qa({
  ...
  const T = Ce(), B = rd(), [z, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    void 0
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (v) => {
      ...
      if (!(!!H && !!((Yo = bt.current) != null && Yo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const At = bt.current ? vd(bt.current) : [];
        if (At.length === 0) {
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, kd = Di ? Jt : Y, ra = { tag: zo };
function _d({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: l } = t, d = yd(null, o), w = li({ editable: t.editable, html: l, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Nd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
const Dd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Md(t) {
...
const Mi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zd = Mi && "documentMode" in document ? document.documentMode : null;
!(!Mi || !("InputEvent" in window) || zd) && "getTargetRanges" in new window.InputEvent("input");
function ye(t) {
  return `${t}px`;
}
...
let xa, Me = 0, ya = 0, qd = 0, bo = 0, da = 0;
function _n(t) {
  if (st === void 0) return;
  let e = t.n;
...
Yt.prototype.brand = Kd, Yt.prototype.h = function() {
  return !0;
...
ue({ name: "@lexical/extension/DecoratorText", nodes: () => [Ai], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = ae();
  if (fi(n) || _e(n)) for (const s of n.getNodes()) Xd(s) && s.toggleFormat(o);
  return !1;
}, mi) });
function Vi(t, e) {
  let r;
...
const ew = ue({ config: nr({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = tw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const aw = /* @__PURE__ */ new Set(), Sn = ue({ build(t, e, r) {
...
}, dependencies: [xo], name: "@lexical/extension/NodeSelection" }), ow = wl("INSERT_HORIZONTAL_RULE_COMMAND");
class vr extends lo {
  static getType() {
...
ue({ dependencies: [xo, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [vr], register(t, e, r) {
  ...
  return Oe(t.registerCommand(ow, (i) => {
    const c = ae();
    if (!_e(c)) return !1;
...
const cw = ue({ name: "@lexical/react/ReactProvider" });
function lw() {
...
function gw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Uo(() => Oe(Pl(n), Ki(n)), [n]);
  }(o), u(ht, { children: [t, a(fw, { content: e }), a(hw, { editor: o, ErrorBoundary: r })] });
}
...
const vw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function bw({ onClear: t }) {
  const [e] = Te();
  return vw(() => $i(e, t), [e, t]), null;
}
...
function _w(t, e) {
  ...
  return u(ht, { children: [a(yw, { editor: n, ...o, ref: e }), r != null && a(Nw, { editor: n, content: r })] });
}
...
function Sw({
  ...
  const [e] = Te(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Tw(), l = () => {
  };
...
function dh({
  ...
  const [s, i] = _($w), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  Y(() => {
    let g = !0;
    const S = h.current;
    if (!S) return;
...
function In({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Bw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(jw, { className: "tw:text-xs tw:font-medium", children: S }) }),
...
), Uw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ua = (t) => Uw(Io(t));
function pa({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Yw(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: f } = Ww({
    threadId: n,
    threadStatus: s,
    isSelected: o,
    activeComments: c,
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Yw, { ...q, conflictResolution: S }) : /* @__PURE__ */ a(rs, { ...q })
          },
          I.id
        );
      })
...
const lu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ht, { children: [
...
function du({
  ...
  return /* @__PURE__ */ u(Ie, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: lu(t, o, e) }) }) }),
...
const wu = (t, e) => t === "f" ? /* @__PURE__ */ u(ht, { children: [
  /* @__PURE__ */ a(ai, {}),
  " ",
...
function pu({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: wu(t, r) }) }) }),
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: uu(t, r) }) })
    ] }) }),
...
function Rh({
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      z !== "x" && R === "x" ? nt == null || nt.forEach((ct) => xu(ct)) : z === "x" && R !== "x" && (nt == null || nt.forEach((ct) => yu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (R) => {
  ...
  return /* @__PURE__ */ u(ht, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ht, { children: _u(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Ro, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      je,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gr, { className: o, children: Eu(c.text) })
        ]
      },
...
const Su = (t) => {
  ...
  return e ? e[1] : "";
}, Du = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Vh = Object.freeze([
...
function Lh({
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Mu(O, D, W), [O, D, W]), q = V(() => {
    var vt, pt;
    if (!B) return l;
...
const Iu = "16rem", zu = "3rem", os = Xt.createContext(void 0);
function za() {
...
function Fu({
  ...
  const c = t ? qr.Root : "button", { state: l } = za(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: b(ju({ variant: r, size: o }), s),
      ...i
    }
  );
...
function Uu({
  ...
  return /* @__PURE__ */ a(
    $u,
    {
      ...
      children: /* @__PURE__ */ u(Vu, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          /* @__PURE__ */ a(Ln, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Lu, { children: Object.entries(e).map(([g, S]) => /* @__PURE__ */ a(Bu, { children: /* @__PURE__ */ a(
            Fu,
            {
              onClick: () => p(g),
              isActive: x(g),
    ...
    /* @__PURE__ */ u(
      Pu,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Au, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
}
const Ve = "scrBook", Ku = "scrRef", Je = "source", Hu = "details", qu = "Scripture Reference", Gu = "Scripture Book", ns = "Type", Wu = "Details";
function Yu(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, jn = (t) => `${Xu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function tg({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      br,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(kr, { position: "item-aligned", children: /* @__PURE__ */ a(Jw, { children: E.map((D) => /* @__PURE__ */ a(ge, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
...
function ko({
  ...
  const d = va(), w = op(e), p = s && w.length > 1;
...
const sp = Object.freeze([520, 420, 340]), ws = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = ds(n, sp), d = Ti() ?? l, w = d >= $r.MINIMUM;
...
const cp = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Trigger,
  {
    ref: r,
    ...e,
...
function lg({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(us, { children: [
      /* @__PURE__ */ a(ps, { children: t.map((c) => /* @__PURE__ */ a(cp, { value: c.value, children: c.value }, c.key)) }),
...
function pp({
  ...
  const i = Fr();
  return /* @__PURE__ */ a(wp, { children: /* @__PURE__ */ a(
    Ee.Content,
    {
...
const Or = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    ...
    return c.length > 0 && i < n.length - 1 && l.push(/* @__PURE__ */ a(gp, {}, `separator-${s}`)), l;
  });
};
function xp({
  menuData: t,
  ...
  if (Xl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(lp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ss(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(dp, { children: [
      /* @__PURE__ */ a(up, { ref: d(w), children: p.label }),
      /* @__PURE__ */ a(
        pp,
        {
          style: { zIndex: Pe },
...
export {
  ...
  mg as ResultsCard,
  Of as RetryableErrorView,
  eg as SCOPE_SELECTOR_STRING_KEYS,
  rp as SELECT_BOOKS_STRING_KEYS,
  $r as SHRINK_STEP,
  rg as ScopeSelector,
  ...
  Af as Z_INDEX_FIRST_RUN,
  Vf as Z_INDEX_MODAL,
  Lf as Z_INDEX_MODAL_BACKDROP,
  Bf as Z_INDEX_ONBOARDING_TOUR,
  jf as Z_INDEX_OVERLAY,
  Ff as badgeVariants,
  Uf as buttonGroupVariants,
  Kf as buttonVariants,
  b as cn,
  ...
  Eo as isMacOs,
  Hf as isWindows,
  bu as markerMenuItemToPaletteItem,
