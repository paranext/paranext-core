...
const Bo = tn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: m(Go({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
function Hc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function il({ initialConfig: t, children: e }) {
  const n = V(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = al(null, o), p = vo({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (u) => i(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
function hl() {
  return function(t) {
    const [e] = $t(), n = V(() => t(e), [e, t]), [o, a] = I(() => n.initialValueFn()), s = W(o);
    return ml(() => {
...
function gl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Ys(e) && o !== null) {
    ...
    if (w || p) {
      const [u, h] = Xs(t), f = l.is(d), g = e.is(i ? d : l), x = e.is(i ? l : d);
      let v, y = 0;
...
const Ml = /* @__PURE__ */ new Set(), Wr = Kt({ build(t, e, n) {
  const o = n.getDependency(rr).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Zo(() => {
  }, () => te(() => {
  ...
  return { watchNodeKey: function(i) {
    const l = Nl(() => (s.value || Ml).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
Kt({ dependencies: [rr, Wr], name: "@lexical/extension/HorizontalRule", nodes: () => [Ee], register(t, e, n) {
  ...
  return Qt(t.registerCommand(oi, (i) => {
    if (ai(i.target)) {
      const l = si(i.target);
...
function tw() {
  const [t, e] = I(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Hi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Po, { children: [
      /* @__PURE__ */ r($o, { children: /* @__PURE__ */ r(Lo, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = G(
    (s, i, l = !1) => {
...
function ew({
  ...
  const [e] = $t(), [n, o] = I(e), [a, s] = I("paragraph"), [i, l] = tw(), d = () => {
  };
...
function lw(t, e) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Eo && i.insertAfter(To());
    for (const i of s) {
...
function da(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && fn(e) && (i = gl(o, e, "clone"));
  const l = me(i) ? i.getChildren() : [], d = ki(t, i.getType());
  let w;
...
function pa(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  }(t) && (i = i.concat(To())) : me(l) && l.append(...h), i;
}
function dw(t, e, n) {
...
function Zc({
  ...
  const [a, s] = I(pw), [i, l] = I(void 0), [d, w] = I(!1), p = W(void 0), u = W(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
...
const Qc = Object.freeze([
  ...
  const a = W(null), [s, i] = I(void 0), [l, d] = I(void 0), w = G(
    (f) => {
      i(f);
    ...
    (f) => {
      var k;
      const g = f.target, x = (R) => R ? document.getElementById(R) : void 0, v = x(l), y = x(s);
    ...
    if (o && l)
      return /* @__PURE__ */ c(st, { children: [
        /* @__PURE__ */ c(
          ...
          {
            onClick: () => {
              w(!0), u(cw(t.contents)), i == null || i(!0);
            },
            children: [
...
function Ew({
  ...
  }, [s, n]), Z = V(() => Xt.slice(1), [Xt]), Q = V(() => Z.length ?? 0, [Z.length]), pt = V(() => Q > 0, [Q]), Vt = V(() => T || Q <= 2 ? Z : Z.slice(-2), [Z, Q, T]), bt = V(() => T || Q <= 2 ? 0 : Q - 2, [Q, T]), an = V(
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(uo, {}) })
        ] }),
...
function qw({
  ...
  const s = W(null), i = W(null), l = W(!1), [d, w] = I(t), [p, u] = I(n), [h, f] = I(!1);
  q(() => {
    w(t);
  }, [t]), q(() => {
    p !== n && u(n);
  ...
  const g = (v) => {
    ...
    var y, N, _, S;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((_ = s.current) == null ? void 0 : _.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
...
function cp({
  ...
  const p = d ?? qs(n, void 0), u = (N, _) => {
    w == null || w(N, _, a);
  }, h = s ? n.findIndex((N) => N === s) : -1, [f, g] = I(h), x = (N, _, S) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
function yp({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = I(""), a = V(() => {
      ...
      /* @__PURE__ */ r(Gt, { children: a.map((s) => {
        ...
        return /* @__PURE__ */ c(
          Pt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-6", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(wd, { icon: s.icon }) }) }),
              /* @__PURE__ */ c("div", { children: [
  ...
  ({
    ...
    const d = t ? Ie : "button", { state: w } = Mn(), p = /* @__PURE__ */ r(
      d,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: m(vd({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Cd = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ie : "a",
  {
    ref: s,
...
function Pd({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], u = o["%webView_book_selector_more%"], { otLong: h, ntLong: f, dcLong: g, extraLong: x } = {
...
function Cp({
  ...
  const w = we(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = we(i, "%webView_scope_selector_current_book%"), f = we(i, "%webView_scope_selector_choose_books%"), g = we(i, "%webView_scope_selector_scope%"), x = we(i, "%webView_scope_selector_select_books%"), v = [
...
function wr({
  ...
  return /* @__PURE__ */ c(ve, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(j, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Is, {}) }) }),
...
function Dp({
  ...
  return /* @__PURE__ */ c(Va, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      wr,
      {
        onSelectMenuItem: t,
...
const Be = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(Ya, {}, `separator-${s}`)), d;
  });
};
function Bd({
  menuData: t,
  ...
  if (Gi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    switch (u.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Be(i, [h, f]);
        break;
      case "alt+n":
