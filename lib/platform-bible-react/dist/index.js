...
import { r as Ut, Z as ji, B, c as f, a as Fi, C as De, P as Se, b as Fe, d as Re, e as Be, f as Ue, g as he, h as Nr, i as ta, T as Xt, S as Je, j as Jt, k as Zt, l as Qt, D as Xe, m as xr, n as Ce, o as Ee, p as Te, u as Bi, q as Cr, s as Ze, t as Ve, v as Sa, w as dn, x as Ui, y as Ki, z as wn, A as un, E as qi, F as Gi, G as Hi, H as Yi, I as wa, J as ua, K as ea, L as Wi, M as Xi, N as Ji, O as Zi, Q as Qi, R as Er, U as Ya } from "./resizable-CUvCloPJ.js";
...
import { includes as $r, Section as et, getChaptersForBook as ts, formatScrRef as _e, getSectionForBook as mr, formatRelativeDate as es, formatReplacementString as ke, sanitizeHtml as Lr, NumberFormat as rs, formatBytes as as, getCurrentLocale as os, usfmMarkers as jr, getFormatCallerFunction as ns, deepEqual as is, isString as bo, compareScrRefs as Ra, scrRefToBBBCCCVVV as pa, defaultScrRef as ha, formatScrRefRange as ss, getLocalizeKeyForScrollGroupId as xo } from "platform-bible-utils";
import { Check as Le, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Oa, ChevronRight as $a, ArrowLeft as cs, ArrowRight as ls, ChevronDown as lr, BoldIcon as ds, ItalicIcon as ws, X as ra, AtSign as pn, Pencil as us, Trash2 as ps, ArrowUp as hn, MoreHorizontal as hs, MailOpen as gs, Mail as fs, ChevronUp as ms, FilterIcon as vs, ArrowLeftIcon as bs, ChevronLeftIcon as xs, ChevronRightIcon as ys, ArrowRightIcon as ks, Copy as gn, Filter as _s, User as Ns, Link as Cs, CircleHelp as Es, ChevronsUpDown as fn, Star as Ts, Undo as zs, Redo as Ds, SquareX as mn, FunctionSquare as vn, SquareSigma as bn, Ban as Ss, AlertCircle as Ma, CircleCheckIcon as Rs, CircleXIcon as Os, CircleHelpIcon as $s, ArrowUpIcon as Ms, ArrowDownIcon as As, Search as Ps, LoaderCircle as Is, ScrollText as Vs, MenuIcon as Ls, Menu as js, EllipsisVertical as Fs, MoreVertical as No } from "lucide-react";
import dt, { useRef as q, useMemo as L, useState as N, useCallback as j, useEffect as Y, useLayoutEffect as Wt, createContext as Wa, useContext as xn, Component as Bs, createElement as Co, Suspense as Us, forwardRef as aa, useId as Ks, Fragment as yn } from "react";
import { Dialog as ge, Label as qs, RadioGroup as Aa, ToggleGroup as kn, Slot as wr, Avatar as Xa, Select as It, Checkbox as Eo, Tabs as de, Menubar as ve, ContextMenu as Ot, Progress as To, Slider as Mr, Switch as zo } from "radix-ui";
import { createEditor as _n, $getRoot as je, $createParagraphNode as Tr, $getSelection as Bt, HISTORY_MERGE_TAG as Ja, ParagraphNode as Nn, TextNode as Cn, $getPreviousSelection as Gs, $isRangeSelection as fe, $caretFromPoint as Hs, $getSiblingCaret as En, $getChildCaret as Ys, $getAdjacentChildCaret as Ws, $isChildCaret as Xs, $normalizeCaret as Js, $setSelectionFromCaretRange as Zs, $getCollapsedCaretRange as Qs, $getCaretInDirection as Do, $splitAtPointCaretNext as tc, $isTextPointCaret as ec, $findMatchingParent as Tn, $isElementNode as yr, mergeRegister as ze, getDOMTextNode as rc, isHTMLElement as ac, CLEAR_EDITOR_COMMAND as zn, COMMAND_PRIORITY_EDITOR as Za, shallowMergeConfig as oc, defineExtension as ae, safeCast as ar, createState as nc, FORMAT_TEXT_COMMAND as Dn, $isNodeSelection as Sn, COMMAND_PRIORITY_LOW as Rn, RootNode as ic, LineBreakNode as sc, TabNode as cc, $isEditorState as lc, createCommand as dc, CLICK_COMMAND as wc, isDOMNode as uc, $getNodeFromDOMNode as pc, $createNodeSelection as hc, $setSelection as gc, $getEditor as fc, DecoratorNode as Pa, $getState as mc, toggleTextFormatType as So, TEXT_TYPE_TO_FORMAT as vc, $setState as bc, addClassNamesToElement as On, $create as xc, $getNodeByKey as yc, removeClassNamesFromElement as kc, KEY_TAB_COMMAND as _c, $isBlockElementNode as Nc, $createRangeSelection as Cc, $normalizeSelection__EXPERIMENTAL as Ec, OUTDENT_CONTENT_COMMAND as Tc, INDENT_CONTENT_COMMAND as Ro, INSERT_TAB_COMMAND as zc, COMMAND_PRIORITY_CRITICAL as Qa, $isDecoratorNode as Dc, $isParagraphNode as Sc, $isTextNode as Ia, SELECTION_CHANGE_COMMAND as $n, $insertNodes as Rc } from "lexical";
import { HeadingNode as Oc, QuoteNode as $c, registerRichText as Mc } from "@lexical/rich-text";
  ...
  return /* @__PURE__ */ u(sl, { children: [
    ...
    /* @__PURE__ */ u(
      ge.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ge.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(B, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Ic, {}),
...
function Oo({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ge.Close, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
const jn = lt.allBookIds.filter(
  (t) => !lt.isObsolete(lt.bookIdToNumber(t))
), ce = Object.fromEntries(
  jn.map((t) => [t, lt.bookIdToEnglishName(t)])
);
function eo(t, e, r) {
  const o = e.trim().toLowerCase();
  if (!o) return !1;
  const n = lt.bookIdToEnglishName(t), i = r == null ? void 0 : r.get(t);
  return !!($r(n.toLowerCase(), o) || $r(t.toLowerCase(), o) || (i ? $r(i.localizedName.toLowerCase(), o) || $r(i.localizedId.toLowerCase(), o) : !1));
}
function Fn({
  ref: t,
  bookId: e,
...
function dl({
  ...
  return /* @__PURE__ */ u(Se, { open: w, onOpenChange: p, children: [
    /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(
      B,
      {
        variant: l,
        size: "icon",
    ...
    /* @__PURE__ */ a(Re, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(he, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      De,
      {
        onSelect: () => g(h),
...
function fa({
  ...
  const C = Ut(), [k, _] = N(!1), [$, F] = N(""), [P, M] = N(""), [x, T] = N("books"), [I, E] = N(void 0), [S, W] = N(
    void 0
  ), [G, Z] = N(void 0), [wt, U] = N(!1), Q = q(null), Et = q(!1), ht = q(void 0), zt = q(void 0), K = q(void 0), ot = q(void 0), bt = q({}), st = q({}), tt = j(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Vt = L(() => o ? o() : jn, [o]), kt = L(() => ({
    [et.OT]: Vt.filter((V) => lt.isBookOT(V)),
    [et.NT]: Vt.filter((V) => lt.isBookNT(V)),
    [et.DC]: Vt.filter((V) => lt.isBookDC(V)),
    [et.Extra]: Vt.filter((V) => lt.extraBooks().includes(V))
  }), [Vt]), Kt = L(() => Object.values(kt).flat(), [kt]), Lt = L(() => {
    if (!P.trim()) return kt;
    const b = {
      [et.OT]: [],
      [et.NT]: [],
    ...
    return [et.OT, et.NT, et.DC, et.Extra].forEach((X) => {
      b[X] = kt[X].filter((_t) => eo(_t, P, n));
    }), b;
  }, [kt, P, n]), R = L(
    () => hl(P, Kt, n),
    [P, Kt, n]
  ...
  const $t = j(() => {
    if (R) {
      const b = R.chapterNum ?? 1, V = R.verseNum ?? 1;
      if (w && ga(R.book, b, V, w))
        return;
      tt({
        book: R.book,
        chapterNum: b,
    ...
    (b) => {
      const V = S ?? (R == null ? void 0 : R.book), X = G ?? (R == null ? void 0 : R.chapterNum);
      !V || !X || (tt({
        book: V,
        chapterNum: X,
        verseNum: b
    ...
    (b) => {
      const V = x === "chapters" ? I : R == null ? void 0 : R.book;
      if (V) {
        if (l && l(V, b) > 1) {
          W(V), Z(b), T("verses"), F("");
          return;
    ...
    T("books"), E(void 0), W(void 0), Z(void 0), setTimeout(() => {
      zt.current && zt.current.focus();
    }, 0);
  }, []), O = j(() => {
    const b = S;
    W(void 0), Z(void 0), b ? (E(b), T("chapters"), F("")) : qt();
  }, [S, qt]), H = j((b) => {
    _(b), b && (T("books"), E(void 0), W(void 0), Z(void 0), M(""));
  }, []), { otLong: at, ntLong: it, dcLong: xt, extraLong: gt } = {
    ...
    () => ul(P),
    [P]
  ), Tt = L(() => !l || !R || !R.chapterNum || !vt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, vt]), qe = j(
    (b) => w ? $o(b, w) : !1,
    [w]
  ), Gt = j(
    (b) => (V) => w ? pl(b, V, w) : !1,
    ...
    (b, V) => (X) => w ? ga(b, V, X, w) : !1,
    [w]
  ), xe = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Me = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Ae = j(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && R && R.chapterNum !== void 0 && R.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), $t());
    },
    [p, R, $t]
  ), or = j(
    (b) => {
      var te, nr, pr;
      if (b.ctrlKey) return;
      const { isLetter: V, isDigit: X } = Mo(b.key);
      if ((x === "chapters" || x === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const St = (te = ht.current) == null ? void 0 : te.querySelector(
      ...
      if (x === "verses" && _t) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            pt !== 0 && (Ht = pt > 1 ? pt - 1 : St);
            break;
          case "ArrowRight":
            pt !== 0 && (Ht = pt < St ? pt + 1 : 1);
            break;
          case "ArrowUp":
            Ht = pt === 0 ? St : Math.max(1, pt - Yt);
            break;
          case "ArrowDown":
            Ht = pt === 0 ? 1 : Math.min(St, pt + Yt);
            break;
          default:
            return;
        }
        Ht !== pt && (b.preventDefault(), b.stopPropagation(), F(
          `${Mt} ${ce[Mt] || ""} ${Nt}:${Ht}`
        ), setTimeout(() => {
          const He = st.current[Ht];
          He && He.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((x === "chapters" || x === "books" && R) && _t) {
        const Mt = x === "chapters" ? I : R == null ? void 0 : R.book;
        if (!Mt) return;
        x === "chapters" && ((pr = ht.current) == null || pr.focus());
        const Nt = (() => {
          if (!$) return 1;
          const Yt = $.match(/(\d+)$/);
        ...
        switch (b.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            pt = Nt === 0 ? St : Math.max(1, Nt - Ht);
            break;
          case "ArrowDown":
            pt = Nt === 0 ? 1 : Math.min(St, Nt + Ht);
            break;
          default:
            return;
        }
        pt !== Nt && (b.preventDefault(), b.stopPropagation(), F(
          `${Mt} ${ce[Mt] || ""} ${pt}`
        ), setTimeout(() => {
          const Yt = bt.current[pt];
    ...
    const { isLetter: V, isDigit: X } = Mo(b.key);
    (V || X) && (b.preventDefault(), M((te) => te + b.key), zt.current.focus(), U(!1));
  }, []);
  return Wt(() => {
    const b = setTimeout(() => {
      if (k && x === "books" && K.current && ot.current) {
        const V = K.current, X = ot.current, _t = X.offsetTop, te = V.clientHeight, nr = X.clientHeight, pr = _t - te / 2 + nr / 2;
        V.scrollTo({
          top: Math.max(0, pr),
          behavior: "smooth"
        }), F(Bn(t.book));
    ...
    if (x === "chapters" && I) {
      const b = I === t.book, V = b ? t.chapterNum : 1;
      F(
        `${I} ${ce[I] || ""} ${V}`
      ), setTimeout(() => {
        if (K.current)
          if (b) {
            const X = bt.current[t.chapterNum];
  ...
  }, [x, I, R, t.book, t.chapterNum]), Wt(() => {
    if (x === "verses" && S && G !== void 0) {
      const b = S === t.book && G === t.chapterNum, V = b ? t.verseNum : 1;
      F(
        `${S} ${ce[S] || ""} ${G}:${V}`
      ), setTimeout(() => {
        if (K.current)
          if (b) {
            const X = st.current[t.verseNum];
            X && X.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            K.current.scrollTo({ top: 0 });
        ht.current && ht.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Se, { open: k, onOpenChange: H, modal: v, children: [
    /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(
      B,
      {
        ref: Q,
        ...
        children: g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: mt })
      }
    ) }),
    /* @__PURE__ */ a(
      Re,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: V } = b;
          k && Q.current && V instanceof Node && Q.current.contains(V) && (Et.current = !0, H(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          Be,
          {
            ...
            children: [
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: $e.map(({ onClick: b, disabled: V, title: X, icon: _t }) => /* @__PURE__ */ a(
                  B,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  B,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: x === "verses" ? O : qt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: C === "ltr" ? /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ls, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                x === "chapters" && I && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ie(I, n) }),
                x === "verses" && S && G !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ie(S, n)} ${G}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: x === "verses" ? Me : xe
                  }
                )
              ] }),
              !wt && /* @__PURE__ */ u(Ue, { ref: K, children: [
                x === "books" && /* @__PURE__ */ u(rt, { children: [
                  !R && Object.entries(Lt).map(([b, V]) => {
                    if (V.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(he, { heading: ut(b), children: V.map((X) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: X,
                            onSelect: (_t) => ie(_t),
                  ...
                  R && /* @__PURE__ */ a(he, { children: /* @__PURE__ */ a(
                    De,
                    {
                      ...
                      children: _e(
                        ...
                        n ? to(R.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  R && Tt && R.chapterNum && l && /* @__PURE__ */ u(rt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ie(R.book, n)} ${R.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Po,
                      {
                        ...
                        onVerseSelect: ne,
                        setVerseRef: yt,
                        isVerseDisabled: Ge(R.book, R.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  R && !Tt && pe(R.book) > 1 && /* @__PURE__ */ u(rt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ie(R.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Ao,
                      {
                        ...
                        setChapterRef: Dt,
                        isChapterDimmed: ft,
                        isChapterDisabled: Gt(R.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                x === "chapters" && I && /* @__PURE__ */ a(
                  Ao,
                  {
                    bookId: I,
                    scrRef: t,
...
function Io({
  ...
  const [k, _] = N(!1), $ = l ?? d, F = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], P = (M, x) => {
    const T = d(M), I = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, E = `${x ?? ""}${T}${I ?? ""}`;
    return /* @__PURE__ */ u(
      De,
      {
        value: T,
  ...
  return /* @__PURE__ */ u(Se, { open: k, onOpenChange: _, ...C, children: [
    ...
    /* @__PURE__ */ a(
      Re,
      {
        ...
        children: /* @__PURE__ */ u(Be, { children: [
          ...
          /* @__PURE__ */ a(Ue, { children: F(e) ? e.map((M) => /* @__PURE__ */ a(he, { heading: M.groupHeading, children: M.options.map((x) => P(x, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(he, { children: e.map((M) => P(M)) }) })
        ] })
      }
    )
  ] });
...
function Xu({
  ...
  const w = ma(l, "%webView_bookSelector_currentBook%"), p = ma(l, "%webView_bookSelector_choose%"), g = ma(l, "%webView_bookSelector_chooseBooks%"), [h, m] = N(
    "current book"
    /* CurrentBook */
  ), y = (v) => {
    m(v), t(v);
    ...
    Kn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Ct, { className: "tw:flex tw:items-center", children: o.map((v) => lt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            B,
            {
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Gn ? Wt : Y, Pr = { tag: Ja };
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : Y;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : Y;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Dl() {
  return function(t) {
    const [e] = be(), r = L(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = q(o);
    return Tl(() => {
...
function $l(t, e, r) {
  ...
  function d() {
    ...
    for (let D = 0; D < h.length; D++) {
      const C = h[D], k = s[D] || document.createElement("div"), _ = k.style;
      ...
      const P = ue(C.width);
      _.width !== P && (k.style.width = P, v = !0);
      const M = ue(C.height);
      _.height !== M && (k.style.height = M, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[D] = k;
    }
...
function Al(t, e = Ml) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = g.getNode(), y = m.getKey(), v = g.offset, D = h.getNode(), C = D.getKey(), k = h.offset, _ = t.getElementByKey(y), $ = t.getElementByKey(C), F = r === null || _ !== o || v !== n || y !== r.getKey(), P = i === null || $ !== s || k !== c || C !== i.getKey();
      if ((F || P) && _ !== null && $ !== null) {
        const M = function(x, T, I, E, S, W, G) {
          const Z = (x._window ? x._window.document : document).createRange();
          return Z.setStart(...Vo(T, I, E)), Z.setEnd(...Vo(S, W, G)), Z;
        }(t, g, m, _, h, D, $);
        d(), d = $l(t, M, e);
      }
      r = m, o = _, n = v, i = D, s = $, c = k;
    });
  }
...
function Vl(t) {
  ...
  if (fe(e)) r = Hs(e.focus, "next");
    ...
    r = r || Ys(je(), "previous").getFlipped().insert(Tr());
  }
...
let Yr, Ne = 0, Wr = 0, Ul = 0, Ka = 0, Br = 0;
function jo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
Pt.prototype.brand = Fl, Pt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ne !== 0 && Wr === 0 && e.l !== Ka && (e.l = Ka, Yr = { S: e, v: e.v, i: e.i, o: Yr });
...
} }), Ye.prototype = new Pt(), Ye.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Xn(this), Fo(this), Ne++;
  const t = nt;
...
ae({ build: (t, e, r) => ur(e), config: ar({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Jn() {
  const t = je(), e = Bt(), r = Tr();
  t.clear(), t.append(r), e !== null && r.select(), fe(e) && (e.format = 0);
}
function Zn(t, e = Jn) {
  return t.registerCommand(zn, (r) => (t.update(e), !0), Za);
}
ae({ build: (t, e, r) => ur(e), config: ar({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return me(() => Zn(t, o.value));
} });
function Gl(t) {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Dn, (o) => {
  const n = Bt();
  if (Sn(n) || fe(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, Rn) });
function ti(t, e) {
  let r;
...
function Yl(t) {
  return function(e) {
    return e.id === Ga;
  }(t) || ct(305, String(t.id), String(Ga)), Object.assign(t, { id: ri });
}
...
class Xl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && ct(307, String(r.id), String(ir)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ya && ct(310, String(r.id), String(ya)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Ir;
    }(e) || ct(313, String(e.id), String(Ir)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= xa;
    }(e) || ct(314, String(e.id), String(xa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= gr;
    }(e) || ct(316, String(e.id), String(gr)), e;
  }
...
const Zl = ae({ config: ar({ setOptions: Bo, updateOptions: Bo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class cr {
  ...
  static maybeFromEditor(e) {
    const r = e[Uo];
    return r && (r.PACKAGE_VERSION !== _a && ct(292, r.PACKAGE_VERSION, _a), r instanceof cr || ct(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ka(i) || ct(300, s, n || "[unknown]"), ka(c = i) || ct(304, String(c.id), String(no)), i = Object.assign(c, { id: Ga }), o.state = i;
    ...
    for (const w of c) {
      ...
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const g of Gl(p)) {
        if (typeof g != "function") {
          ...
          h && ct(302, p.name, g.replace.name, h.extension.name), o.set(g.replace, w);
        }
        r.add(g);
      }
      if (p.html) {
  ...
  return ze(t.registerCommand(ed, (s) => {
    ...
    if (uc(s.target)) {
      ...
      if (ad(c)) return function(d, l = !1) {
        const w = Bt(), p = d.isSelected(), g = d.getKey();
        let h;
        l && Sn(w) ? h = w : (h = hc(), gc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Rn), t.registerMutationListener(dr, (s, c) => {
    Bl(() => {
      let d = !1;
...
ae({ build: (t, e) => ur({ inheritEditableFromParent: e.inheritEditableFromParent }), config: ar({ $getParentEditor: function() {
  const t = fc();
...
ae({ build: (t, e, r) => ur(e), config: ar({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return me(() => {
...
function od(t, e, r = oi) {
  return ze(t.registerCommand(_c, (o) => {
    ...
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Tc : Ro : zc;
    return t.dispatchCommand(i, void 0);
  }, Za), t.registerCommand(Ro, () => {
...
ae({ build: (t, e, r) => ur(e), config: ar({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (fe(m)) {
                const y = m.anchor;
                let v = y.getNode(), D = 0, C = 0;
                if (Ia(v) && l >= 0 && w >= 0 && (D = l, C = l + w, m.setTextNodeRange(v, D, v, C)), D === C && p === "" || (m.insertRawText(p), v = y.getNode()), Ia(v)) {
                  D = g, C = g + h;
                  const k = v.getTextContentSize();
                  D = D > k ? k : D, C = C > k ? k : C, m.setTextNodeRange(v, D, v, C);
                }
...
ae({ build: (t, e, r) => ur(e), config: ar({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => me(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function ld(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const so = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : Y;
  ...
  return function(r, o) {
    ...
    return so(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (g) => r._onError(g), children: a(Us, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
...
function zd() {
  const { activeEditor: t } = li(), [e, r] = N([]), o = j((n) => {
    if (fe(n) || Yc(n)) {
      const i = [];
      Yo.forEach(({ format: s }) => {
...
function Zu({
  ...
  const [i, s] = N(Md), [c, d] = N(n), [l, w] = N(!1), p = q(void 0), g = q(null);
  Y(() => {
    let v = !0;
    const D = g.current;
    if (!D) return;
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Se, { open: l, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Re,
        {
          ...
          children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ue, { children: t.map((v) => /* @__PURE__ */ a(
            De,
            {
              onSelect: () => {
                d(v || void 0), w(!1);
...
function Xo({
  ...
  const h = j(
    ...
    [t.user]
  ), C = L(() => Lr(t.contents), [t.contents]), k = L(() => {
    if (o && c)
      return /* @__PURE__ */ u(rt, { children: [
        /* @__PURE__ */ u(
          Xe,
          {
            onClick: (_) => {
              _.stopPropagation(), l(!0), p(Od(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          !d && /* @__PURE__ */ u(rt, { children: [
            ...
            t.conflictResolutionAction ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: t.conflictResolutionAction === "merged" ? r["%conflict_note_outcome_merged%"] ?? "Merged the changes that Paratext ACCEPTED with the changes that Paratext REJECTED" : r["%conflict_note_outcome_replaced%"] ?? "Replaced the changes that Paratext ACCEPTED with the changes that Paratext REJECTED" })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: f(
        ...
        k && /* @__PURE__ */ u(Ce, { children: [
          /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(hs, {}) }) }),
...
function er({ className: t, size: e = "default", children: r, ...o }) {
  const n = Ut();
  return /* @__PURE__ */ u(
    It.Trigger,
    {
...
function Ud({
  ...
  const [d, l] = N("accept"), w = r ?? d, p = Ks(), g = n === "accept" ? "accept" : w, h = L(
    () => Jo(Lr(t.rejectedText ?? "")),
    [t.rejectedText]
  ), m = L(
    () => Jo(Lr(t.acceptedText ?? "")),
    [t.acceptedText]
  ), y = L(() => Lr(t.contents), [t.contents]);
  ...
  const D = (P) => {
    const M = P === "reject" ? "reject" : "accept";
    l(M), o == null || o(M);
  }, C = n === "none" && i !== void 0, _ = (C ? i : g) === "reject" ? t.rejectedResultText : t.resultText, $ = C && i === "merged", F = e["%conflict_note_stale_notice%"] ?? "The verse has been edited since this conflict was recorded, so rejecting is no longer available. Accept keeps the current text.";
  return /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", children: [
    ...
    n !== "none" && /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:gap-2", children: [
      ...
      /* @__PURE__ */ u(Qe, { value: g, onValueChange: D, disabled: c, children: [
        /* @__PURE__ */ a(
          er,
          {
            className: "tw:w-32",
        ...
        /* @__PURE__ */ u(rr, { children: [
          ...
          n === "accept" ? /* @__PURE__ */ a(Xt, { delayDuration: 0, children: /* @__PURE__ */ u(Jt, { children: [
            /* @__PURE__ */ a(Zt, { asChild: !0, children: /* @__PURE__ */ u("span", { className: "tw:block", children: [
              /* @__PURE__ */ a(Ft, { value: "reject", disabled: !0, "aria-describedby": p, children: e["%conflict_note_reject%"] ?? "Reject" }),
              /* @__PURE__ */ a("span", { id: p, className: "tw:sr-only", children: F })
            ] }) }),
            /* @__PURE__ */ a(Qt, { side: "right", children: F })
          ] }) }) : /* @__PURE__ */ a(Ft, { value: "reject", children: e["%conflict_note_reject%"] ?? "Reject" })
        ] })
      ] }),
      /* @__PURE__ */ a(B, { size: "sm", disabled: c, onClick: () => s == null ? void 0 : s(g), children: e["%conflict_note_resolve%"] ?? "Resolve" })
    ] }),
    ...
    !$ && /* @__PURE__ */ u(rt, { children: [
      ...
      /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
        ...
        /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: _ })
      ] })
    ] })
  ] });
}
...
function Kd({
  ...
  handleResolveConflict: M,
  getConflictResolutionOptionsCallback: x
}) {
  const [T, I] = N(Zo), [E, S] = N(), [W, G] = N(), Z = o, [wt, U] = N(!1), [Q, Et] = N(!1), [ht, zt] = N(!1), [K, ot] = N(!1), [bt, st] = N(!1), [tt, Vt] = N(_), [kt, Kt] = N(!1), Lt = q(void 0), [R, oe] = N(/* @__PURE__ */ new Map()), $t = l.type === "Conflict", [ne, ie] = N("none"), [se, Oe] = N("accept"), [$e, qt] = N(!1);
  Y(() => {
    let z = !0;
    return (async () => {
      const V = C ? await C(d) : !1;
      z && st(V);
    })(), () => {
      z = !1;
    };
  ...
  Y(() => {
    if (!o) {
      O.current !== "idle" && (S(void 0), G(void 0), O.current = "idle");
      return;
    }
    O.current === "idle" && (O.current = "pending"), K ? O.current === "pending" && P !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    P !== i && (S(P), O.current = "auto-populated") : O.current === "auto-populated" && (S(void 0), O.current = "pending");
  }, [o, P, K, i]);
  const H = L(() => e.filter((z) => !z.deleted), [e]);
  Y(() => {
    let z = !0;
    if (!o || !k) {
      oe(/* @__PURE__ */ new Map());
  ...
  const at = L(() => H[0], [H]), it = L(() => {
    if ($t) {
      for (let z = H.length - 1; z >= 0; z -= 1) {
        const b = H[z].conflictResolutionAction;
        if (b === "replaced") return "reject";
        if (b === "merged") return "merged";
      }
      return w === "Resolved" ? "accept" : void 0;
    }
  }, [$t, H, w]), xt = q(null), gt = q(void 0), ut = j(() => {
    var z;
    (z = gt.current) == null || z.call(gt), I(Zo);
  }, []), ft = j(() => {
    const z = !tt;
    Vt(z), Kt(!z), m == null || m(d, z);
  }, [tt, m, d]);
  Y(() => {
    U(!1);
  }, [o]), Y(() => {
  ...
  }, [i, r]), yt = L(() => H.slice(1), [H]), vt = L(() => yt.length ?? 0, [yt.length]), Tt = L(() => vt > 0, [vt]), qe = L(() => wt || vt <= 2 ? yt : yt.slice(-2), [yt, vt, wt]), Gt = L(() => wt || vt <= 2 ? 0 : vt - 2, [vt, wt]), Ge = L(
    () => vt === 1 ? mt.singleReply : ke(mt.multipleReplies, { count: vt }),
    [vt, mt]
  ), xe = L(
    () => Gt === 1 ? mt.singleReply : ke(mt.multipleReplies, { count: Gt }),
    [Gt, mt]
  );
  Y(() => {
    !o && Q && Tt && Et(!1);
  ...
  const Me = j(
    ...
    async (z) => {
      const b = ee(T) ? Jr(T) : void 0, V = z.status ? z.assignedUser : E ?? z.assignedUser, X = await p({
        ...z,
        contents: b,
        assignedUser: V
      });
      return X && (V !== void 0 && G(V), b && ut()), X;
    },
    [ut, T, p, E]
  ), or = j(
    async (z) => {
        ...
        children: /* @__PURE__ */ u(Pd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              Dt && /* @__PURE__ */ a(xr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Dt }),
              /* @__PURE__ */ a(
                B,
                {
                  variant: "ghost",
            ...
            $t && o ? /* @__PURE__ */ a(
              Ud,
              {
                ...
                onResolutionChange: Oe,
                availableActions: w === "Resolved" ? "none" : ne,
                resolvedResolution: it,
                onResolve: or,
                isResolving: $e
              }
            ) : /* @__PURE__ */ a(
              Xo,
              {
                ...
                isThreadExpanded: o,
                threadStatus: w,
                handleAddCommentToThread: Ae,
                handleUpdateComment: g,
                handleDeleteComment: h,
                onEditingChange: Et,
                canEditOrDelete: (!Q && R.get(at.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(rt, { children: [
              Gt > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onClick: (z) => {
                    z.stopPropagation(), U(!0);
                  },
                  role: "button",
                  tabIndex: 0,
                  onKeyDown: (z) => {
                    (z.key === "Enter" || z.key === " ") && (z.preventDefault(), z.stopPropagation(), U(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Je, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: xe }),
                      wt ? /* @__PURE__ */ a(ms, {}) : /* @__PURE__ */ a(lr, {})
                    ] })
                  ]
                }
              ),
              qe.map((z) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Xo,
                {
                  comment: z,
                  localizedStrings: r,
              ...
              v !== !1 && (!Q || ee(T)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (z) => {
                    wo(z) && (z.preventDefault(), z.stopPropagation(), (ee(T) || E !== void 0 && E !== W) && Me());
                  },
                  onKeyDown: (z) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (ee(T) || E !== W) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ke(
                      ...
                      /* @__PURE__ */ u(Se, { open: ht, onOpenChange: zt, children: [
                        ...
                        /* @__PURE__ */ a(
                          Re,
                          {
                            ...
                            children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ue, { children: y == null ? void 0 : y.map((z) => /* @__PURE__ */ a(
                              De,
                              {
                                onSelect: () => {
                                  S(z !== i ? z : void 0), O.current = "user-selected", G(void 0), zt(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function cp({
  ...
  const [k, _] = N(/* @__PURE__ */ new Set()), [$, F] = N(), [P, M] = N(), x = j(
    async (U) => {
      const Q = await i(U);
      return Q !== void 0 && U.assignedUser !== void 0 && U.assignedUser !== "" && M(U.assignedUser), Q;
    },
    [i]
  );
  Y(() => {
    m && (_((U) => new Set(U).add(m)), F(m));
  }, [m]);
  const T = r.filter(
    (U) => U.comments.some((Q) => !Q.deleted)
  ), I = T.map((U) => ({ id: U.id })), E = j(
    (U) => {
      _((Q) => new Set(Q).add(U.id)), F(U.id), y == null || y(U.id);
    },
    [y]
  ), S = j(
    (U) => {
      ...
      _((Et) => {
        const ht = new Set(Et);
        return ht.has(U) ? ht.delete(U) : ht.add(U), ht;
      }), F(U), y == null || y(Q ? void 0 : U);
    },
    [k, y]
  ), { listboxRef: W, activeId: G, handleKeyDown: Z } = Bi({
    options: I,
    onOptionSelect: E
  }), wt = j(
    (U) => {
      U.key === "Escape" ? ($ && k.has($) && (_((Q) => {
        const Et = new Set(Q);
        return Et.delete($), Et;
      }), F(void 0), y == null || y(void 0)), U.preventDefault(), U.stopPropagation()) : Z(U);
    },
    [$, k, Z, y]
  );
  return /* @__PURE__ */ a(
...
function qd({ table: t }) {
  return /* @__PURE__ */ u(Ce, { children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ u(
        Qe,
        {
          ...
          children: [
            /* @__PURE__ */ a(er, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(tr, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(rr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(Ft, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Jd({
  ...
  var F;
  const [w, p] = N([]), [g, h] = N([]), [m, y] = N({}), [v, D] = N({}), C = L(() => e ?? [], [e]), k = Pn({
    data: C,
    columns: t,
    getCoreRowModel: Vn(),
  ...
  let $;
  return d ? $ = Array.from({ length: 10 }).map((x, T) => `skeleton-row-${T}`).map((x) => /* @__PURE__ */ a(le, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(re, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Sa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((F = k.getRowModel().rows) == null ? void 0 : F.length) > 0 ? $ = k.getRowModel().rows.map((P) => /* @__PURE__ */ a(
    le,
    {
      onClick: () => s(P, k),
      "data-state": P.getIsSelected() && "selected",
      children: P.getVisibleCells().map((M) => /* @__PURE__ */ a(re, { children: vr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    P.id
  )) : $ = /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a(re, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(qd, { table: k }),
    /* @__PURE__ */ u(ia, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: k.getHeaderGroups().map((P) => /* @__PURE__ */ a(le, { children: P.headers.map((M) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : vr(M.column.columnDef.header, M.getContext()) }, M.id)) }, P.id)) }),
...
function hp({
  ...
  return /* @__PURE__ */ u(Se, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ a(Fe, { asChild: !0, children: o }),
...
function gp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ce, { children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(Te, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(dn, { children: l.itemType === 0 ? /* @__PURE__ */ a(rt, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ve,
        {
          checked: o[w][g],
...
function mi({
  ...
  const [D, C] = N(!1), k = j(
    (T) => {
      var E;
      const I = (E = t.find((S) => S.label === T)) == null ? void 0 : E.value;
      I && r(
    ...
    if (!g) return t;
    const T = t.filter((E) => E.starred).sort((E, S) => E.label.localeCompare(S.label)), I = t.filter((E) => !E.starred).sort((E, S) => {
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Se, { open: M, onOpenChange: w ?? C, children: [
    /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ u(
      B,
      {
        variant: y,
    ...
    /* @__PURE__ */ a(Re, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Be, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: P, children: s })
      ] }),
      /* @__PURE__ */ u(Ue, { children: [
        /* @__PURE__ */ a(ta, { children: c }),
        /* @__PURE__ */ a(he, { children: $.map((T) => /* @__PURE__ */ u(
          De,
          {
            value: T.label,
            onSelect: k,
...
function aw({
  ...
  const d = L(() => /Macintosh/i.test(navigator.userAgent), []), l = rn(n, "%undoButton_tooltip%"), w = rn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(lo, { children: [
    /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ u(Jt, { children: [
      /* @__PURE__ */ a(Zt, { asChild: !0, children: /* @__PURE__ */ a(
        B,
...
const nw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(rt, { children: [
...
function iw({
  ...
  const m = (v) => {
    ...
    var D, C, k, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((D = i.current) == null || D.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Ce, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ u(Jt, { children: [
      /* @__PURE__ */ a(Zt, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: nw(t, n, r) }) }) }),
...
const sw = (t, e) => t === "f" ? /* @__PURE__ */ u(rt, { children: [
  /* @__PURE__ */ a(vn, {}),
  " ",
...
function lw({
  ...
  return /* @__PURE__ */ u(Ce, { children: [
    /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ u(Jt, { children: [
      /* @__PURE__ */ a(Zt, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: sw(t, r) }) }) }),
      /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ a("p", { children: cw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Te, { style: { zIndex: wn }, children: [
...
function bp({
  ...
  const [m, y] = N("generated"), [v, D] = N("generated"), [C, k] = N("*"), [_, $] = N("*"), [F, P] = N("f"), [M, x] = N(!1), [T, I] = N(!0), [E, S] = N(!1), W = q(!1), G = q(""), [Z, wt] = N(!1), [U, Q] = N(), [Et, ht] = N(), [zt, K] = N(), [ot, bt] = N(), st = q(null), tt = L(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (H && Ar("note", H)) {
      const xt = (at = H.insert.note) == null ? void 0 : at.caller;
      let gt = "custom";
      xt === Va ? gt = "generated" : xt === La ? gt = "hidden" : xt && (k(xt), $(xt)), y(gt), D(gt), P(((it = H.insert.note) == null ? void 0 : it.style) ?? "f"), O = setTimeout(() => {
        var ut;
        (ut = w.current) == null || ut.applyUpdate([H]);
      }, 0);
    }
    return () => {
      O && clearTimeout(O);
  ...
  const kt = j(
    (O, H, at = !1) => {
      var xt, gt, ut;
      const it = (gt = (xt = w.current) == null ? void 0 : xt.getNoteOps(0)) == null ? void 0 : gt.at(0);
      if (it && Ar("note", it)) {
        if (it.insert.note) {
          let ft;
          O === "custom" ? ft = H : O === "generated" ? ft = Va : ft = La, it.insert.note.caller = ft;
        }
        r == null || r([it]), at && l && i && ((ut = l.current) == null || ut.replaceEmbedUpdate(i, [it]));
      }
    },
    [i, r, l]
  ), Kt = j(() => {
  ...
  const oe = () => {
    var H;
    const O = (H = p.current) == null ? void 0 : H.getElementsByClassName("editor-input")[0];
    ...
    var at, it, xt, gt, ut;
    P(O);
    const H = (it = (at = w.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : it.at(0);
    if (H && Ar("note", H)) {
      H.insert.note && (H.insert.note.style = O);
      const ft = (gt = (xt = H.insert.note) == null ? void 0 : xt.contents) == null ? void 0 : gt.ops;
      F !== "x" && O === "x" ? ft == null || ft.forEach((mt) => hw(mt)) : F === "x" && O !== "x" && (ft == null || ft.forEach((mt) => gw(mt))), (ut = w.current) == null || ut.applyUpdate([H, { delete: 1 }]);
    }
  }, se = (O) => {
    bt(O.contextMarker), S(O.canRedo);
  }, Oe = j(
    (O) => {
      var at, it, xt, gt, ut;
      const H = (it = (at = w.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : it.at(0);
      if (H && Ar("note", H)) {
        ...
        const ft = (xt = H.insert.note) == null ? void 0 : xt.style, mt = (ut = (gt = H.insert.note) == null ? void 0 : gt.contents) == null ? void 0 : ut.ops;
        if (ft || x(!1), x(
          ...
          W.current = !0, G.current = JSON.stringify(H), I(!0);
          return;
        }
        I(JSON.stringify(H) === G.current), kt(m, C);
      } else
        x(!1), I(!0);
    },
    [m, C, kt]
    ...
    if (g.current && Vt.length && O && O.rangeCount > 0) {
      const H = O.getRangeAt(0).getBoundingClientRect(), at = g.current.getBoundingClientRect();
      Q(H.left - at.left), ht(H.top - at.top), K(H.height), wt(!0);
    }
  }, [Vt, g]);
  Y(() => {
    const O = () => {
    ...
    var O;
    Z && ((O = st.current) == null || O.focus());
  }, [Z]), Y(() => {
    var at;
    const O = ((at = p.current) == null ? void 0 : at.querySelector(".editor-input")) ?? void 0, H = (it) => {
      !Z && O && document.activeElement === O && it.key === c ? (it.preventDefault(), $e()) : Z && it.key === "Escape" && (it.preventDefault(), wt(!1));
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ u(Jt, { children: [
              ...
              /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ a("p", { children: qt }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(rt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(rt, { children: mw(t.marker, c, o, l) })
      }
    )
  ] });
}
function yp({
  ...
  return Y(() => {
    var C;
    h >= 0 && h < D.current.length && ((C = D.current[h]) == null || C.focus());
  }, [h]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
  ...
  return /* @__PURE__ */ u(ia, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(sa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      le,
      {
        ...
        children: [
          /* @__PURE__ */ a(re, { children: _e(c.reference, "English") }),
...
function Dp({
  ...
  const h = we(r, "%webView_inventory_all%"), m = we(r, "%webView_inventory_approved%"), y = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), D = we(r, "%webView_inventory_scope_currentBook%"), C = we(r, "%webView_inventory_scope_chapter%"), k = we(r, "%webView_inventory_scope_verse%"), _ = we(r, "%webView_inventory_filter_text%"), $ = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), F = we(r, "%webView_inventory_no_results%"), [P, M] = N(!1), [x, T] = N("all"), [I, E] = N(""), [S, W] = N([]), G = L(() => {
    const K = t ?? [];
    ...
    const K = [];
    return G.forEach((ot) => {
      const bt = ot.items[0], st = K.find(
        (tt) => tt.items[0] === bt
      );
      st ? (st.count += ot.count, st.occurrences = st.occurrences.concat(ot.occurrences)) : K.push({
        items: [bt],
        count: ot.count,
  ...
  }, [P, G]), wt = L(() => Z.length === 0 ? [] : Cw(Z, x, I), [Z, x, I]), U = L(() => {
    var bt, st;
    if (!P) return d;
    const K = (bt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : bt.length;
    if (!K) return d;
    const ot = [];
    for (let tt = 0; tt < K; tt++)
      ot.push(
        _w(
          ((st = o == null ? void 0 : o.tableHeaders) == null ? void 0 : st[tt]) || "Additional Item",
          tt + 1
        )
      );
    return [...ot, ...d];
  ...
  Y(() => {
    wt.length === 0 ? W([]) : wt.length === 1 && W(wt[0].items);
  }, [wt]);
  const Q = (K, ot) => {
    ot.setRowSelection(() => {
      const st = {};
      return st[K.index] = !0, st;
    });
    const bt = K.original.items;
    W(bt), g && bt.length > 0 && g(bt[0]);
  }, Et = (K) => {
    ...
    if (Z.length === 0 || S.length === 0) return [];
    const K = Z.filter((ot) => is(
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        Qe,
        {
          ...
          defaultValue: x,
          children: [
            /* @__PURE__ */ a(er, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(tr, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(rr, { children: [
      ...
      /* @__PURE__ */ u(Qe, { onValueChange: (K) => Et(K), defaultValue: s, children: [
        /* @__PURE__ */ a(er, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(tr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(rr, { children: [
          /* @__PURE__ */ a(Ft, { value: "book", children: D }),
      ...
      o && /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ u(Jt, { children: [
        ...
        /* @__PURE__ */ a(Qt, { children: (o == null ? void 0 : o.checkboxText) ?? $ })
      ] }) })
    ] }),
...
const xi = aa(({ className: t, ...e }, r) => /* @__PURE__ */ a(Is, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Ta({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(rt, { children: [
      /* @__PURE__ */ a(le, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(re, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(Ct, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        le,
        {
          ...
          children: [
            /* @__PURE__ */ a(re, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(rt, { children: [
              /* @__PURE__ */ a(Le, { className: "tw:h-3.5 tw:w-3.5", "aria-hidden": !0 }),
...
function Rp({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = L(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = Tw(h), D = L(
    () => Array.from(new Set(t.map((S) => S.bestLanguageName))).map((S) => ({
      label: S,
      value: S
    })),
    [t]
  ), C = p.length === 0 && g.length === 0 && h.length === 0, k = ye(n, "%resourcePicker_title%"), _ = ye(n, "%resourcePicker_search_placeholder%"), $ = ye(n, "%resourcePicker_language_filter_any%"), F = ye(
    n,
    "%resourcePicker_section_already_selected%"
  ), P = ye(n, "%resourcePicker_section_installed%"), M = ye(
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = ye(n, "%resourcePicker_no_results%"), T = ye(n, "%resourcePicker_showing_count%"), I = L(() => {
  ...
  return /* @__PURE__ */ u(rt, { children: [
    ...
    E && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: ke(T, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !C && !e && /* @__PURE__ */ a(ia, { children: /* @__PURE__ */ u(sa, { children: [
        /* @__PURE__ */ a(Ta, { label: F, resources: p }),
        /* @__PURE__ */ a(Ta, { label: P, resources: g, onSelect: i }),
        /* @__PURE__ */ a(
          Ta,
          {
            label: M,
...
const Dw = "16rem", Sw = "3rem", yi = dt.createContext(void 0);
function da() {
  const t = dt.useContext(yi);
  if (!t)
...
function Rw({
  ...
  const [d, l] = dt.useState(t), w = e ?? d, p = dt.useCallback(
    ...
    [r, w]
  ), g = dt.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = Ut() === "ltr" ? s : s === "primary" ? "secondary" : "primary", D = dt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
const Pe = "scrBook", jw = "scrRef", We = "source", Fw = "details", Bw = "Scripture Reference", Uw = "Scripture Book", ki = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? lt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Pe ? _e(n.start) : void 0;
      },
...
const Gw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ra(t.start, t.end) === 0 ? `${pa(t.start)}+${e}` : `${pa(t.start)}+${e}-${pa(t.end)}+${r}`;
...
function Gp({
  ...
  const [l, w] = N([]), [p, g] = N([{ id: Pe, desc: !1 }]), [h, m] = N({}), y = L(
  ...
  Y(() => {
    if (c) {
      ...
      if (T.length === 1) {
        const I = y.find((E) => cn(E) === T[0]) || void 0;
        I && c(I);
      }
    }
  }, [h, y, c, D]);
  ...
  }, P = (x, T) => x.getIsGrouped() ? "" : f("banded-row", T % 2 === 0 ? "even" : "odd"), M = (x, T, I) => {
    if (!((x == null ? void 0 : x.length) === 0 || T.depth < I.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      Qe,
      {
        ...
        children: [
          /* @__PURE__ */ a(er, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(tr, {}) }),
          /* @__PURE__ */ a(rr, { position: "item-aligned", children: /* @__PURE__ */ a(Ld, { children: _.map((x) => /* @__PURE__ */ a(Ft, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ia, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(uo, { children: D.getHeaderGroups().map((x) => /* @__PURE__ */ a(le, { children: x.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ a(sa, { children: D.getRowModel().rows.map((x, T) => {
        const I = Ut();
        return /* @__PURE__ */ a(
          le,
          {
            ...
            children: x.getVisibleCells().map((E) => {
              if (!(E.getIsPlaceholder() || E.column.columnDef.enableGrouping && !E.getIsGrouped() && (E.column.columnDef.id !== We || !r)))
                return /* @__PURE__ */ a(
                  re,
                  {
                    className: f(
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !x.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ a($a, {}) : /* @__PURE__ */ a(Oa, {})),
                          " ",
...
function Hw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: m } = {
  ...
  }, [y, v] = N(!1), [D, C] = N(""), k = q(void 0), _ = q(!1), $ = L(
    () => _i(t),
    [t]
  ), F = L(() => {
    if (!D.trim()) {
    ...
    (E, S = !1) => {
      ...
      const W = $.findIndex((Q) => Q === k.current), G = $.findIndex((Q) => Q === E);
      if (W === -1 || G === -1) return;
      const [Z, wt] = [
        Math.min(W, G),
        Math.max(W, G)
      ], U = $.slice(Z, wt + 1).map((Q) => Q);
      r(
        e.includes(E) ? e.filter((Q) => !U.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...U])]
      );
    },
    [e, r, $]
  ), M = (E) => {
    P(E, _.current), _.current = !1;
  }, x = (E, S) => {
    E.preventDefault(), P(S, E.shiftKey);
  }, T = () => {
    r($.map((E) => E));
  }, I = () => {
    r([]);
          ...
          Be,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                ...
                /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: I, children: l })
              ] }),
              /* @__PURE__ */ u(Ue, { children: [
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === za ? za : ln
      ).map((d) => /* @__PURE__ */ a(xr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ie(d, n) }, d)),
...
function Yp({
  ...
  const _ = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), $ = Rt(s, "%webView_scope_selector_verse%"), F = Rt(s, "%webView_scope_selector_chapter%"), P = Rt(s, "%webView_scope_selector_book%"), M = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), x = Rt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), T = Rt(s, "%webView_scope_selector_current_book%"), I = Rt(s, "%webView_scope_selector_choose_books%"), E = Rt(s, "%webView_scope_selector_scope%"), S = Rt(s, "%webView_scope_selector_select_books%"), W = Rt(s, "%webView_scope_selector_range%"), G = Rt(s, "%webView_scope_selector_select_range%"), Z = Rt(s, "%webView_scope_selector_range_start%"), wt = Rt(s, "%webView_scope_selector_range_end%"), U = Rt(s, "%webView_scope_selector_ok%"), Q = Rt(s, "%webView_scope_selector_cancel%"), Et = Rt(s, "%webView_scope_selector_navigate%"), ht = (A) => {
    if (!m) return;
  ...
  ], K = (A, J, jt = !1) => /* @__PURE__ */ u(rt, { children: [
    A,
    J && !jt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), ot = e ? zt.filter((A) => e.includes(A.value)) : zt, bt = m ?? ha, st = w ?? bt, tt = p ?? bt, Vt = () => {
  }, kt = q(null), Kt = q(null), Lt = q(!1), R = q(null), oe = q(!1), [$t, ne] = N(void 0), ie = q(!1), se = q(!1), Oe = q(null), $e = j((A) => {
    if (A) {
      ne("start"), ie.current = !1;
      return;
    }
    ne((J) => J === "start" ? void 0 : J), ie.current && (ie.current = !1, requestAnimationFrame(() => {
      var jt;
      const J = (jt = kt.current) == null ? void 0 : jt.querySelector("button");
      J == null || J.click();
    }));
  }, []), qt = j((A) => {
    if (A) {
    ...
    (A) => {
      g == null || g(A), h == null || h(A), ie.current = !0;
    },
    [g, h]
  ), H = j(
    (A) => {
      h == null || h(A), se.current = !0;
    },
    [h]
  ), at = j(
    (A) => {
    ...
    [r, n, m, i]
  ), it = ot.find((A) => A.value === t), xt = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? ss(st, tt, {
  ...
  ), ut = ot.find((A) => A.value === "selectedBooks"), ft = ot.find((A) => A.value === "range"), [mt, Dt] = N(!1), [yt, vt] = N(void 0), [Tt, qe] = N(void 0), [Gt, Ge] = N(void 0), [xe, Me] = N(void 0), [Ae, or] = N([]), z = l === "dropdown" && yt === "selectedBooks", b = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
      selectedBookIds: z ? Ae : n,
      onChangeSelectedBookIds: z ? or : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), V = $t === "end", X = $t === "start", _t = "tw:text-muted-foreground", te = l === "dropdown" && yt === "range", nr = te ? Ge : O, Mt = te ? Me : h ? H : Vt, Nt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-start", className: f(V && _t), children: Z }),
      /* @__PURE__ */ a(
        fa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: kt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-end", className: f(X && _t), children: wt }),
      /* @__PURE__ */ a(
        fa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: D,
          disableReferencesUpTo: te ? Gt ?? st : st,
          onOpenChange: qt,
          onCloseAutoFocus: (A) => {
            var J;
            se.current && (se.current = !1, A.preventDefault(), (J = Oe.current) == null || J.focus());
          },
          className: f(X && _t),
          modal: !0,
          align: "start"
  ...
  const [Yt, He] = N(null), [Sr, Oi] = N(null), [Rr, $i] = N(null), Mi = 200, [Ai, Pi] = N(!1);
  Y(() => {
    if (!Rr || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([J]) => {
      Pi(J.contentRect.width < Mi);
    });
    return A.observe(Rr), () => A.disconnect();
  }, [Rr]);
  const go = j(
    (A) => {
      qe(A), Ge(st), Me(tt), or(n), Dt(!1), vt(A);
    },
    [st, tt, n]
  ), fo = j(() => {
    Tt !== void 0 && (Tt === "range" ? (Gt && (g == null || g(Gt)), xe && (h == null || h(xe))) : Tt === "selectedBooks" && i(Ae), at(Tt), vt(void 0), qe(void 0));
  }, [
    Tt,
    Gt,
    xe,
    ...
    A || (vt(void 0), qe(void 0));
  }, []), mo = j((A) => {
    var J;
    A.preventDefault(), (J = Ht.current) == null || J.focus();
  }, []), vo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Le, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(Ct, { children: E }),
      l === "dropdown" ? /* @__PURE__ */ u(Ce, { open: mt, onOpenChange: Dt, children: [
        ...
        /* @__PURE__ */ a(
          Te,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(wa, { container: Rr, children: [
              gt.map(({ value: A, label: J, dropdownLabel: jt, scrRefSuffix: hr, id: Ii }) => /* @__PURE__ */ u(
                Xe,
                {
                  ref: pt(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Le, { className: "tw:h-4 tw:w-4" }) }),
                    K(jt ?? J, hr, Ai)
                  ]
                },
                Ii
              ...
              y && /* @__PURE__ */ u(rt, { children: [
                /* @__PURE__ */ a(Ze, {}),
                /* @__PURE__ */ a(Cr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Et }),
                /* @__PURE__ */ a(
                  Xe,
                  {
                    ref: R,
                    ...
                    onSelect: (A) => {
                      var J, jt;
                      if (A.preventDefault(), Lt.current) {
                        Lt.current = !1;
                        return;
                      }
                      oe.current || (jt = (J = Kt.current) == null ? void 0 : J.querySelector("button")) == null || jt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          fa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var J;
                              A.preventDefault(), (J = R.current) == null || J.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(rt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: _e(m ?? ha, "id") }),
                              /* @__PURE__ */ a(lr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Kn,
        {
          ...
          children: ot.map(({ value: A, label: J, scrRefSuffix: jt, id: hr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Ba, { className: "tw:me-2", value: A, id: hr }),
            /* @__PURE__ */ a(Ct, { htmlFor: hr, children: K(J, jt) })
          ] }, hr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && Nt,
    l === "dropdown" && ut && /* @__PURE__ */ a(ja, { open: yt === "selectedBooks", onOpenChange: Or, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Oi,
        onCloseAutoFocus: mo,
        onEscapeKeyDown: (A) => {
          Sr != null && Sr.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(wa, { container: Sr, children: [
          /* @__PURE__ */ a(qr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Gr, { children: I }) }),
          b,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Or(!1), children: Q }),
            /* @__PURE__ */ a(B, { onClick: fo, children: U })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ft && /* @__PURE__ */ a(ja, { open: yt === "range", onOpenChange: Or, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: He,
        onCloseAutoFocus: mo,
        onEscapeKeyDown: (A) => {
          Yt != null && Yt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(wa, { container: Yt, children: [
          ...
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Or(!1), children: Q }),
            /* @__PURE__ */ a(B, { ref: Oe, onClick: fo, children: U })
          ] })
        ] })
      }
    ) })
...
function Wp({
  ...
  return /* @__PURE__ */ u(
    Qe,
    {
      ...
      children: [
        /* @__PURE__ */ a(er, { size: n, className: f("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          tr,
          {
...
function Ha({
  ...
  return /* @__PURE__ */ u(Ce, { variant: i, children: [
    /* @__PURE__ */ a(Ee, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ls, {}) }) }),
    /* @__PURE__ */ a(Te, { align: "start", style: { zIndex: ea }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(yn, { children: [
      /* @__PURE__ */ a(dn, { children: /* @__PURE__ */ a(Xt, { children: Ei(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Ze, {})
    ] }, d)) })
  ] });
}
const Ti = dt.forwardRef(
...
const zi = dt.forwardRef(({ className: t, ...e }, r) => {
  const o = Ut();
  return /* @__PURE__ */ a(
    de.Root,
    {
...
const Di = dt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  de.List,
  {
    ref: r,
    className: f(
...
const Zw = dt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  de.Trigger,
  {
    ref: r,
    ...e,
...
)), Si = dt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  de.Content,
  {
    ref: r,
    className: f(
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (D = d.current) == null || D.focus(), fr(d, [g, h]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(Qw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ea },
          children: /* @__PURE__ */ a(Xt, { children: Ri(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function oh({
  ...
  const l = du(
    ...
    var D, C, k, _, $, F;
    const v = y !== m ? ((C = (D = t[m]) == null ? void 0 : D.uiNames) == null ? void 0 : C[y]) ?? ((_ = (k = t[m]) == null ? void 0 : k.uiNames) == null ? void 0 : _.en) : void 0;
    return v ? `${($ = t[m]) == null ? void 0 : $.autonym} (${v})` : (F = t[m]) == null ? void 0 : F.autonym;
  };
  return /* @__PURE__ */ u("div", { id: d, className: f("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ u(
      Qe,
      {
        ...
        onOpenChange: (m) => p(m),
        children: [
          /* @__PURE__ */ a(er, { children: /* @__PURE__ */ a(tr, {}) }),
          /* @__PURE__ */ a(
            rr,
            {
              style: { zIndex: ea },
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Ce, { children: [
              /* @__PURE__ */ a(Ee, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
