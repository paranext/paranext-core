...
import { c as v, g as Me, a as qa, C as ze, A as ue, P as Pe, b as rr, B as W, d as Ve, e as Le, f as je, h as Te, i as Bi, k as Fi, j as Ui, E as Ki, l as Ga, r as ye, m as qi, n as un, o as ta, p as ea, L as zt, R as Ha, q as Gr, D as Ea, s as Ta, t as Sa, u as za, T as pn, v as Lr, w as jt, x as Ya, y as Bt, z as Ft, F as Ut, G as hn, H as Wa, I as Qe, J as Nr, K as Be, M as Fe, N as Ue, S as Cr, O as sr, Q as Gi, U as Sr, V as er, W as Ie, Z as ar, X as Oe, Y as cr, _ as Xa, $ as Ja, a0 as Hr, a1 as Za, a2 as gn, a3 as Hi, a4 as Yi, a5 as Wi, a6 as Ra, a7 as fn, a8 as ra, a9 as mn, aa as Xi, ab as Ji, ac as Zi, ad as Qi, ae as vn, af as ts, ag as la, ah as ko, ai as da, aj as es, ak as rs, al as as, am as os, an as ns, ao as zr, ap as Qa, aq as is, ar as ss } from "./resizable-CoRZwNAR.js";
import { as as mg, at as vg, au as bg, av as xg, aw as yg, ax as kg, ay as _g, az as Ng, aA as Cg, aB as Eg, aC as Tg, aD as Sg, aE as zg, aF as Rg, aG as Dg, aH as Mg, aI as Og, aJ as Ig, aK as $g, aL as Ag, aM as Pg, aN as Vg, aO as Lg, aP as jg, aQ as Bg } from "./resizable-CoRZwNAR.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as $e, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as Da, ChevronRight as Ma, ArrowLeft as cs, ArrowRight as ls, ChevronDown as wr, BoldIcon as ds, ItalicIcon as ws, X as to, AtSign as bn, Pencil as us, Trash2 as ps, ArrowUp as xn, MoreHorizontal as hs, MailOpen as gs, Mail as fs, ChevronUp as ms, FilterIcon as vs, ArrowLeftIcon as bs, ChevronLeftIcon as xs, ChevronRightIcon as ys, ArrowRightIcon as ks, Copy as yn, Filter as _s, User as Ns, Link as Cs, CircleHelp as Es, Undo as Ts, Redo as Ss, SquareX as kn, FunctionSquare as _n, SquareSigma as Nn, Ban as zs, AlertCircle as Oa, CircleCheckIcon as Rs, CircleXIcon as Ds, CircleHelpIcon as Ms, ArrowUpIcon as Os, ArrowDownIcon as Is, ScrollText as $s, ChevronsUpDown as As, MenuIcon as Ps, Menu as Vs, EllipsisVertical as Ls, MoreVertical as js } from "lucide-react";
import { Section as ut, getChaptersForBook as Bs, formatScrRef as Ce, getSectionForBook as yr, formatRelativeDate as Fs, formatReplacementString as tr, sanitizeHtml as eo, NumberFormat as Cn, formatBytes as Us, getCurrentLocale as Ks, MODIFIER_KEYS as qs, usfmMarkers as jr, getFormatCallerFunction as Gs, deepEqual as Hs, isString as Eo, compareScrRefs as Ia, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Ys, getLocalizeKeyForScrollGroupId as To, formatReplacementStringToArray as So, collectUsjMarkers as Ws } from "platform-bible-utils";
import Jt, { useRef as q, useMemo as $, useState as N, useCallback as L, useEffect as H, useImperativeHandle as Xs, useLayoutEffect as ne, createContext as ro, useContext as En, Component as Js, createElement as zo, Suspense as Zs, forwardRef as Tn, useId as Ro, Fragment as aa } from "react";
import { IconSelector as Sn, IconCheck as oa, IconChevronDown as Qs, IconChevronUp as tc, IconLayoutSidebar as ec, IconLayoutSidebarRight as rc, IconChevronRight as zn, IconSearch as ac, IconLoader as oc, IconAlertOctagon as nc, IconAlertTriangle as ic, IconInfoCircle as sc, IconCircleCheck as cc } from "@tabler/icons-react";
import { createEditor as Rn, $getRoot as Ae, $createParagraphNode as Rr, $getSelection as ee, HISTORY_MERGE_TAG as ao, ParagraphNode as Dn, TextNode as Mn, $getPreviousSelection as lc, $isRangeSelection as be, $caretFromPoint as dc, $getSiblingCaret as On, $getChildCaret as wc, $getAdjacentChildCaret as uc, $isChildCaret as pc, $normalizeCaret as hc, $setSelectionFromCaretRange as gc, $getCollapsedCaretRange as fc, $getCaretInDirection as Do, $splitAtPointCaretNext as mc, $isTextPointCaret as vc, $findMatchingParent as In, $isElementNode as Er, mergeRegister as Se, getDOMTextNode as bc, isHTMLElement as xc, CLEAR_EDITOR_COMMAND as $n, COMMAND_PRIORITY_EDITOR as oo, shallowMergeConfig as yc, defineExtension as se, safeCast as or, createState as kc, FORMAT_TEXT_COMMAND as An, $isNodeSelection as Pn, COMMAND_PRIORITY_LOW as Vn, RootNode as _c, LineBreakNode as Nc, TabNode as Cc, $isEditorState as Ec, createCommand as Tc, CLICK_COMMAND as Sc, isDOMNode as zc, $getNodeFromDOMNode as Rc, $createNodeSelection as Dc, $setSelection as Mc, $getEditor as Oc, DecoratorNode as $a, $getState as Ic, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as $c, $setState as Ac, addClassNamesToElement as Ln, $create as Pc, $getNodeByKey as Vc, removeClassNamesFromElement as Lc, KEY_TAB_COMMAND as jc, $isBlockElementNode as Bc, $createRangeSelection as Fc, $normalizeSelection__EXPERIMENTAL as Uc, OUTDENT_CONTENT_COMMAND as Kc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as qc, COMMAND_PRIORITY_CRITICAL as no, $isDecoratorNode as Gc, $isParagraphNode as Hc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as jn, $insertNodes as Yc } from "lexical";
...
import { Avatar as io, Select as Zt, Checkbox as Io, Slot as Dr, Tabs as pe, Menubar as ke, ContextMenu as At, Progress as $o, Slider as Or, Switch as Ao } from "radix-ui";
import { useReactTable as Fn, getFilteredRowModel as al, getSortedRowModel as Un, getPaginationRowModel as ol, getCoreRowModel as Kn, flexRender as kr, getGroupedRowModel as nl, getExpandedRowModel as il } from "@tanstack/react-table";
import sl from "markdown-to-jsx";
import { filterAndRankItems as Po, GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as Va, getDefaultViewOptions as cl, isInsertEmbedOpOfType as Ir, getMarkerMenuItems as ll, defaultStyleInfo as dl, Editorial as wl } from "@eten-tech-foundation/platform-editor";
...
function gl({
  ...
  const [h, g] = N(!1), f = w !== void 0, b = f ? w : h, m = (T) => {
    f || g(T), p == null || p(T);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Pe, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Ve, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Te, { heading: i, children: t.map((T) => /* @__PURE__ */ u(
      ze,
      {
        onSelect: () => E(T),
...
function ha({
  ...
  const B = ye(), [D, I] = N(!1), [P, S] = N(""), [V, X] = N(""), [_, rt] = N("books"), [F, Q] = N(void 0), [M, O] = N(
    void 0
  ), [Z, ot] = N(void 0), [Pt, Ot] = N(!1), Kt = q(null), Y = q(!1), nt = q(void 0), pt = q(void 0), st = q(void 0), gt = q(void 0), qt = q({}), Ct = q({}), bt = L(
    (y) => {
      e(y), c && c(y);
    },
    [e, c]
  ), xt = $(() => o ? o() : qi, [o]), Gt = $(() => ({
    [ut.OT]: xt.filter((J) => vt.isBookOT(J)),
    [ut.NT]: xt.filter((J) => vt.isBookNT(J)),
    [ut.DC]: xt.filter((J) => vt.isBookDC(J)),
    [ut.Extra]: xt.filter((J) => vt.extraBooks().includes(J))
  }), [xt]), yt = $(() => Object.values(Gt).flat(), [Gt]), Vt = $(() => {
    if (!V.trim()) return Gt;
    const y = {
      [ut.OT]: [],
      [ut.NT]: [],
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((it) => {
      y[it] = Gt[it].filter((Lt) => Ga(Lt, V, n));
    }), y;
  }, [Gt, V, n]), R = $(
    () => xl(V, yt, n),
    [V, yt, n]
  ...
  const _t = L(() => {
    if (R) {
      const y = R.chapterNum ?? 1, J = R.verseNum ?? 1;
      if (w && pa(R.book, y, J, w))
        return;
      bt({
        book: R.book,
        chapterNum: y,
    ...
    (y) => {
      const J = M ?? (R == null ? void 0 : R.book), it = Z ?? (R == null ? void 0 : R.chapterNum);
      !J || !it || (bt({
        book: J,
        chapterNum: it,
        verseNum: y
    ...
    (y) => {
      const J = _ === "chapters" ? F : R == null ? void 0 : R.book;
      if (J) {
        if (d && d(J, y) > 1) {
          O(J), ot(y), rt("verses"), S("");
          return;
        }
        bt({
          book: J,
    ...
    rt("books"), Q(void 0), O(void 0), ot(void 0), setTimeout(() => {
      pt.current && pt.current.focus();
    }, 0);
  }, []), ae = L(() => {
    const y = M;
    O(void 0), ot(void 0), y ? (Q(y), rt("chapters"), S("")) : Et();
  }, [M, Et]), Rt = L((y) => {
    I(y), y && (rt("books"), Q(void 0), O(void 0), ot(void 0), X(""));
  }, []);
  H(() => {
    z && Rt(!1);
  }, [z, Rt]);
  ...
  const { otLong: oe, ntLong: Qt, dcLong: he, extraLong: C } = {
    ...
    () => vl(V),
    [V]
  ), at = $(() => !d || !R || !R.chapterNum || !G ? !1 : d(R.book, R.chapterNum) > 0, [d, R, G]), dt = L(
    (y) => w ? Vo(y, w) : !1,
    [w]
  ), ht = L(
    (y) => (J) => w ? bl(y, J, w) : !1,
    ...
    (y, J) => (it) => w ? pa(y, J, it, w) : !1,
    [w]
  ), Nt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", It = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", He = L(
    (y) => {
    ...
    (y) => {
      var Ne, Re, We;
      if (y.ctrlKey) return;
      const { isLetter: J, isDigit: it } = Lo(y.key);
      ...
      if (_ === "verses" && Lt) {
        ...
        switch (y.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Yt = mt === 0 ? St : Math.max(1, mt - ge);
            break;
          case "ArrowDown":
            Yt = mt === 0 ? 1 : Math.min(St, mt + ge);
            break;
          default:
            return;
        }
      ...
      if ((_ === "chapters" || _ === "books" && R) && Lt) {
        const Mt = _ === "chapters" ? F : R == null ? void 0 : R.book;
        if (!Mt) return;
    ...
    const { isLetter: J, isDigit: it } = Lo(y.key);
    (J || it) && (y.preventDefault(), X((Ne) => Ne + y.key), pt.current.focus(), Ot(!1));
  }, []);
  return ne(() => {
    const y = setTimeout(() => {
      if (D && _ === "books" && st.current && gt.current) {
        const J = st.current, it = gt.current, Lt = it.offsetTop, Ne = J.clientHeight, Re = it.clientHeight, We = Lt - Ne / 2 + Re / 2;
        J.scrollTo({
          top: Math.max(0, We),
          behavior: "smooth"
        }), S(Gn(t.book));
    ...
    if (_ === "chapters" && F) {
      const y = F === t.book, J = y ? t.chapterNum : 1;
      S(
        `${F} ${ue[F] || ""} ${J}`
      ), setTimeout(() => {
        if (st.current)
  ...
  }, [_, F, R, t.book, t.chapterNum]), ne(() => {
    if (_ === "verses" && M && Z !== void 0) {
      const y = M === t.book && Z === t.chapterNum, J = y ? t.verseNum : 1;
      S(
        `${M} ${ue[M] || ""} ${Z}:${J}`
      ), setTimeout(() => {
        if (st.current)
    ...
    /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ u(
      W,
      {
        ...
        onClick: (y) => {
          Y.current && (Y.current = !1, y.preventDefault());
        },
        children: [
          h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: j }),
          f && /* @__PURE__ */ a(
            Sn,
            {
    ...
    /* @__PURE__ */ a(
      Ve,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: J } = y;
          D && Kt.current && J instanceof Node && Kt.current.contains(J) && (Y.current = !0, Rt(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Le,
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Ge.map(
                  ({ onClick: y, disabled: J, title: it, icon: Lt }) => /* @__PURE__ */ a(
                    W,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                _ === "chapters" && F && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Me(F, n) }),
                _ === "verses" && M && Z !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Me(M, n)} ${Z}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: _ === "verses" ? It : Nt
                  }
                )
              ] }),
              !Pt && /* @__PURE__ */ u(je, { ref: st, children: [
                _ === "books" && /* @__PURE__ */ u(lt, { children: [
                  !R && Object.entries(Vt).map(([y, J]) => {
                    if (J.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Te, { heading: U(y), children: J.map((it) => /* @__PURE__ */ a(
                          qn,
                          {
                            bookId: it,
                            onSelect: (Lt) => qe(Lt),
                ...
                _ === "chapters" && F && /* @__PURE__ */ a(
                  jo,
                  {
                    ...
                    onChapterSelect: ce,
                    setChapterRef: x,
                    isChapterDisabled: ht(F),
                    className: "tw:p-4"
                  }
                ),
                _ === "verses" && M && Z !== void 0 && d && /* @__PURE__ */ a(
                  Bo,
                  {
                    bookId: M,
                    chapterNum: Z,
...
function Fo({
  ...
  const [k, z] = N(!1), B = d ?? l, D = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], I = (P, S) => {
    const V = l(P), X = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, _ = `${S ?? ""}${V}${X ?? ""}`;
    return /* @__PURE__ */ u(
      ze,
      {
        value: V,
    ...
    /* @__PURE__ */ a(
      Ve,
      {
        ...
        children: /* @__PURE__ */ u(Le, { children: [
          ...
          /* @__PURE__ */ a(je, { children: D(e) ? e.map((P) => /* @__PURE__ */ a(Te, { heading: P.groupHeading, children: P.options.map((S) => I(S, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(Te, { children: e.map((P) => I(P)) }) })
        ] })
      }
    )
  ] });
...
function lp({
  ...
  const w = ga(d, "%webView_bookSelector_currentBook%"), p = ga(d, "%webView_bookSelector_choose%"), h = ga(d, "%webView_bookSelector_chooseBooks%"), [g, f] = N(
    "current book"
    /* CurrentBook */
  ), b = (m) => {
    f(m), t(m);
...
const Wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = Wn ? ne : H, Ar = { tag: ao };
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ne : H;
...
const Ml = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ne : H;
function Ol(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Il() {
  return function(t) {
    const [e] = _e(), r = $(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = q(o);
    return Ml(() => {
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Al = Xn && "documentMode" in document ? document.documentMode : null;
!(!Xn || !("InputEvent" in window) || Al) && "getTargetRanges" in new window.InputEvent("input");
function ve(t) {
  return `${t}px`;
}
...
function Vl(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < g.length; E++) {
      ...
      const B = ve(T.left - p);
      z.left !== B && (z.left = B, m = !0);
      const D = ve(T.top - h);
      z.top !== D && (k.style.top = D, m = !0);
      const I = ve(T.width);
      z.width !== I && (k.style.width = I, m = !0);
      const P = ve(T.height);
...
function jl(t, e = Ll) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, E = g.getNode(), T = E.getKey(), k = g.offset, z = t.getElementByKey(b), B = t.getElementByKey(T), D = r === null || z !== o || m !== n || b !== r.getKey(), I = i === null || B !== s || k !== c || T !== i.getKey();
      if ((D || I) && z !== null && B !== null) {
        const P = function(S, V, X, _, rt, F, Q) {
          const M = (S._window ? S._window.document : document).createRange();
          return M.setStart(...Uo(V, X, _)), M.setEnd(...Uo(rt, F, Q)), M;
        }(t, h, f, z, g, E, B);
        l(), l = Vl(t, P, e);
      }
      r = f, o = z, n = m, i = E, s = B, c = k;
    });
  }
...
function Fl(t) {
  const e = In(t, (r) => Er(r) && !r.isInline());
  return Er(e) || Yr(4, t.__key), e;
}
function Ul(t) {
  const e = ee() || lc();
  let r;
  if (be(e)) r = dc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = On(c, "next"));
    }
    r = r || wc(Ae(), "previous").getFlipped().insert(Rr());
  }
  const o = Kl(t, r), n = uc(o), i = pc(n) ? hc(n) : o;
  return gc(fc(i)), t.getLatest();
}
function Kl(t, e, r) {
  let o = Do(e, "next");
  for (let n = o; n; n = mc(n, r)) o = n;
  return vc(o) && Yr(283), o.insert(t.isInline() ? Rr().append(t) : t), Do(On(t.getLatest(), "next"), e.direction);
}
function ql(t) {
  const e = ee();
  if (!be(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = In(i, (d) => Er(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Wr, Ee = 0, Xr = 0, Yl = 0, ja = 0, Fr = 0;
function qo(t) {
  if (ct === void 0) return;
  let e = t.n;
...
function Xl(t) {
  ...
  Zn(this), ct = t, this.f &= -2, 8 & this.f && lo(this), ia();
}
function ir(t, e) {
...
Xt.prototype.brand = Gl, Xt.prototype.h = function() {
  return !0;
  ...
  return ct = t, Zn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Qn(this), Go(this), Ee++;
  const t = ct;
  return ct = this, Xl.bind(this, t);
...
function ei(t, e = ti) {
  return t.registerCommand($n, (r) => (t.update(e), !0), oo);
}
se({ build: (t, e, r) => mr(e), config: or({ $onClear: ti }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return xe(() => ei(t, o.value));
} });
function Jl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ma = kc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ri extends $a {
  $config() {
...
se({ name: "@lexical/extension/DecoratorText", nodes: () => [ri], register: (t, e, r) => t.registerCommand(An, (o) => {
  const n = ee();
  if (Pn(n) || be(n)) for (const i of n.getNodes()) Zl(i) && i.toggleFormat(o);
  return !1;
}, Vn) });
function ai(t, e) {
  let r;
...
const Ba = se({ build: (t) => ai(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const wo = 0, Fa = 1, ni = 2, va = 3, Pr = 4, nr = 5, ba = 6, br = 7;
function xa(t) {
  return t.id === wo;
}
function ii(t) {
...
function Ql(t) {
  return function(e) {
    return e.id === Fa;
  }(t) || wt(305, String(t.id), String(Fa)), Object.assign(t, { id: ni });
}
...
const ad = se({ config: or({ setOptions: Ho, updateOptions: Ho }), init: ({ $initialEditorState: t = rd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [_c, Mn, Nc, Cc, Dn] }), Yo = Symbol.for("@lexical/extension/LexicalBuilder");
function Wo() {
}
function od(t) {
  throw t;
...
class dr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      xa(i) || wt(300, s, n || "[unknown]"), xa(c = i) || wt(304, String(c.id), String(wo)), i = Object.assign(c, { id: Fa }), o.state = i;
...
const nd = /* @__PURE__ */ new Set(), Xo = se({ build(t, e, r) {
  const o = r.getDependency(Ba).output, n = Tr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ai(() => {
  }, () => xe(() => {
...
}, dependencies: [Ba], name: "@lexical/extension/NodeSelection" }), id = Tc("INSERT_HORIZONTAL_RULE_COMMAND");
class ur extends $a {
  static getType() {
...
se({ dependencies: [Ba, Xo], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Xo).output, n = Tr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Se(t.registerCommand(id, (s) => {
    const c = ee();
    if (!be(c)) return !1;
    ...
    return !0;
  }, oo), t.registerCommand(Sc, (s) => {
    if (zc(s.target)) {
      const c = Rc(s.target);
      if (cd(c)) return function(l, d = !1) {
        const w = ee(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Pn(w) ? g = w : (g = Dc(), Mc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Vn), t.registerMutationListener(ur, (s, c) => {
    Hl(() => {
      let l = !1;
...
function ld(t, e, r = si) {
  return Se(t.registerCommand(jc, (o) => {
    const n = ee();
    if (!be(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Kc : Oo : qc;
    return t.dispatchCommand(i, void 0);
  }, oo), t.registerCommand(Oo, () => {
...
se({ build: (t, e, r) => mr(e), config: or({ $canIndent: si, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (be(f)) {
                const b = f.anchor;
                let m = b.getNode(), E = 0, T = 0;
                if (Aa(m) && d >= 0 && w >= 0 && (E = d, T = d + w, f.setTextNodeRange(m, E, m, T)), E === T && p === "" || (f.insertRawText(p), m = b.getNode()), Aa(m)) {
                  E = h, T = h + g;
...
se({ build: (t, e, r) => mr(e), config: or({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => xe(() => r.getOutput().disabled.value ? void 0 : li(t)) });
function hd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const po = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ne : H;
...
function md({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    po(() => Se(Jc(n), li(n)), [n]);
  }(o), u(lt, { children: [t, a(vd, { content: e }), a(fd, { editor: o, ErrorBoundary: r })] });
}
...
function Cd(t, e) {
  ...
  return u(lt, { children: [a(_d, { editor: n, ...o, ref: e }), r != null && a(Ed, { editor: n, content: r })] });
}
...
function Rd({
  ...
  const [e] = _e(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = zd(), l = () => {
  };
...
function Md() {
  const { activeEditor: t } = ui(), [e, r] = N([]), o = L((n) => {
    if (be(n) || tl(n)) {
      const i = [];
      Qo.forEach(({ format: s }) => {
...
function Id({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Rd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Md, {}) }) }),
...
const Pd = "verseText", dp = Object.freeze([
...
function wp({
  ...
  const [i, s] = N(Vd), [c, l] = N(n), [d, w] = N(!1), p = q(void 0), h = q(null);
  H(() => {
    let m = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : go(m) && (m.preventDefault(), m.stopPropagation(), ie(i) && g());
        },
        onKeyDown: (m) => {
          ho(m), (m.key === "Enter" || m.key === " ") && m.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Jr,
          {
...
function en({
  ...
  const g = L(
    ...
    [t.user]
  ), T = $(() => eo(t.contents), [t.contents]), k = $(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), z = !!t.conflictResolutionAction && !k, B = $(() => {
    if (o && c)
      return /* @__PURE__ */ u(lt, { children: [
        /* @__PURE__ */ u(
          Qe,
          {
            onClick: (D) => {
              D.stopPropagation(), d(!0), p(Ad(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (D) => {
                D.key === "Escape" ? (D.preventDefault(), D.stopPropagation(), g()) : go(D) && (D.preventDefault(), D.stopPropagation(), ie(w) && f());
              },
              onKeyDown: (D) => {
                ho(D), (D.key === "Enter" || D.key === " ") && D.stopPropagation();
              },
              onClick: (D) => {
                D.stopPropagation();
              },
        ...
        B && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(hs, {}) }) }),
...
function yi({
  ...
  const [_, rt] = N(rn), [F, Q] = N(), [M, O] = N(), Z = o, [ot, Pt] = N(!1), [Ot, Kt] = N(!1), [Y, nt] = N(!1), [pt, st] = N(!1), [gt, qt] = N(!1), [Ct, bt] = N(z), [xt, Gt] = N(!1), yt = q(void 0), [Vt, R] = N(/* @__PURE__ */ new Map());
  H(() => {
    let x = !0;
    return (async () => {
      const G = T ? await T(l) : !1;
      x && qt(G);
    })(), () => {
      x = !1;
    };
  ...
  H(() => {
    if (!o) {
      kt.current !== "idle" && (Q(void 0), O(void 0), kt.current = "idle");
      return;
    }
    kt.current === "idle" && (kt.current = "pending"), pt ? kt.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (Q(I), kt.current = "auto-populated") : kt.current === "auto-populated" && (Q(void 0), kt.current = "pending");
  }, [o, I, pt, i]);
  const _t = $(
    () => P ?? e.filter((x) => !x.deleted),
    [P, e]
  );
  H(() => {
    let x = !0;
  ...
  const re = $(() => _t[0], [_t]), qe = q(null), ce = q(void 0), le = L(() => {
    var x;
    (x = ce.current) == null || x.call(ce), rt(rn);
  }, []), Ge = L(() => {
    const x = !Ct;
    bt(x), Gt(!x), f == null || f(l, x);
  }, [Ct, f, l]);
  H(() => {
    Pt(!1);
  }, [o]), H(() => {
    if (o && !Ct && !xt) {
      ...
      return yt.current = x, () => clearTimeout(x);
    }
  ...
  }, [i, r]), Rt = $(() => _t.slice(1), [_t]), Dt = $(() => Rt.length ?? 0, [Rt.length]), Ht = $(() => Dt > 0, [Dt]), oe = $(() => ot || Dt <= 2 ? Rt : Rt.slice(-2), [Rt, Dt, ot]), Qt = $(() => ot || Dt <= 2 ? 0 : Dt - 2, [Dt, ot]), he = $(
  ...
  const U = L(
    async (x) => {
      ...
      K && await p({ threadId: l, contents: K }) && le();
    },
    [
      le,
      _,
    ...
    async (x) => {
      const K = ie(_) ? Zr(_) : void 0, G = x.status ? x.assignedUser : F ?? x.assignedUser, at = await p({
        ...x,
        contents: K,
        assignedUser: G
      });
      return at && (G !== void 0 && O(G), K && le()), at;
    },
    [le, _, p, F]
  );
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              W,
              {
                ...
                children: Ct ? /* @__PURE__ */ a(gs, {}) : /* @__PURE__ */ a(fs, {})
              }
            ),
            V === void 0 ? (
        ...
        /* @__PURE__ */ u(lt, { children: [
          ...
          !o && ie(_) && /* @__PURE__ */ a(
            Jr,
            {
              ...
              onSerializedChange: (x) => rt(x),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(lt, { children: [
            X && oe.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Qt > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (x) => {
                  x.stopPropagation(), Pt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (x) => {
                  (x.key === "Enter" || x.key === " ") && (x.preventDefault(), x.stopPropagation(), Pt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Cr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: C }),
                    ot ? /* @__PURE__ */ a(ms, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            oe.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              en,
              {
                comment: x,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Kt,
                canEditOrDelete: (!Ot && Vt.get(x.id)) ?? !1
              }
            ) }, x.id)),
            m !== !1 && (!Ot || ie(_)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  go(x) && (x.preventDefault(), x.stopPropagation(), (ie(_) || F !== void 0 && F !== M) && U());
                },
                onKeyDown: (x) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    F !== void 0 && (ie(_) || F !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: tr(
                    ...
                    /* @__PURE__ */ u(Pe, { open: Y, onOpenChange: nt, children: [
                      /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ a(
                        W,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Ve,
                        {
                          ...
                          children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(je, { children: b == null ? void 0 : b.map((x) => /* @__PURE__ */ a(
                            ze,
                            {
                              onSelect: () => {
                                Q(x !== i ? x : void 0), kt.current = "user-selected", O(void 0), nt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), qd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Kr = (t) => qd(eo(t));
function qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Gd({
  ...
  const [s, c] = N("accept"), l = Ro(), d = Ro(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = $(
    () => Kr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = $(
    () => Kr(t.acceptedText ?? ""),
    ...
    () => Kr(t.mergedText ?? ""),
    [t.mergedText]
  ), T = $(() => eo(t.contents), [t.contents]);
  if (!vi(t))
    return /* @__PURE__ */ a(qr, { html: T });
  const k = (M) => {
    c(M === "reject" || M === "merge" ? M : "accept");
  }, z = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", B = g ? [
    {
      value: "merge",
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", X = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), _ = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : X, rt = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: E }) : X : _(M === "reject" ? t.rejectedResultText : t.resultText);
  }, F = (M) => p && M.value === "reject", Q = (M) => {
    const O = f === M.value, Z = `${d}-${M.value}`, ot = F(M);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(lt, { children: [
        ...
        /* @__PURE__ */ a(
          Ha,
          {
            ...
            children: D.map((M) => F(M) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Bt, { children: [
              /* @__PURE__ */ a(Ft, { asChild: !0, children: Q(M) }),
    ...
    if (e === "Resolved") {
      for (let T = o.length - 1; T >= 0; T -= 1)
        if (o[T].status === "Resolved")
          return bi(o[T].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function xp({
  ...
  const [T, k] = N(/* @__PURE__ */ new Set()), [z, B] = N(), [D, I] = N(), P = L(
    async (O) => {
      const Z = await i(O);
  ...
  H(() => {
    f && (k((O) => new Set(O).add(f)), B(f));
  }, [f]);
  const S = r.filter(
    (O) => O.comments.some((Z) => !Z.deleted)
  ), V = S.map((O) => ({ id: O.id })), X = L(
    (O) => {
      k((Z) => new Set(Z).add(O.id)), B(O.id), b == null || b(O.id);
    },
    [b]
  ), _ = L(
    (O) => {
      ...
      }), B(O), b == null || b(Z ? void 0 : O);
    },
    [T, b]
  ), { listboxRef: rt, activeId: F, handleKeyDown: Q } = Gi({
    options: V,
    onOptionSelect: X
  }), M = L(
    (O) => {
      O.key === "Escape" ? (z && T.has(z) && (k((Z) => {
        const ot = new Set(Z);
        return ot.delete(z), ot;
      }), B(void 0), b == null || b(void 0)), O.preventDefault(), O.stopPropagation()) : Q(O);
    },
    [z, T, Q, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: S.map((O) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: O.type === "Conflict" ? /* @__PURE__ */ a(Jd, { ...Z, conflictResolution: E }) : /* @__PURE__ */ a(yi, { ...Z })
          },
          O.id
        );
      })
...
function Zd({ table: t }) {
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ u(W, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function gr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Zt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Zt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Sn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function aw({
  ...
  var D;
  const [w, p] = N([]), [h, g] = N([]), [f, b] = N({}), [m, E] = N({}), T = $(() => e ?? [], [e]), k = Fn({
    data: T,
    columns: t,
    getCoreRowModel: Kn(),
  ...
  let B;
  return l ? B = Array.from({ length: 10 }).map((S, V) => `skeleton-row-${V}`).map((S) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: z.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((D = k.getRowModel().rows) == null ? void 0 : D.length) > 0 ? B = k.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    Oe,
    {
      onClick: () => s(I, k),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((P) => /* @__PURE__ */ a(cr, { children: kr(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    I.id
    ...
    /* @__PURE__ */ u(Xa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ja, { stickyHeader: i, children: k.getHeaderGroups().map((I) => /* @__PURE__ */ a(Oe, { children: I.headers.map((P) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : kr(P.column.columnDef.header, P.getContext()) }, P.id)) }, I.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(W, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(yn, {}) })
        ] }),
...
function Ep({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ u(W, { variant: "default", children: [
...
function uw(t, e, r) {
  var n, i;
  const { kind: o } = e;
  if (o === "enter" || ki(t) || qs.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  if (t.key === " ") {
    if (o === "backslash")
      return fe(t), (i = e.shouldSpaceCommit) != null && i.call(e, e.filter) ? (r.commit(), "ended") : (r.commitTyped(e.filter), r.dismiss(), "ended");
    fe(t);
    const s = e.filter.toLowerCase(), c = e.items.find((l) => l.marker.toLowerCase() === s);
    return c && r.commitItem(c.marker), r.dismiss(), "ended";
  }
  return t.key === "*" ? (fe(t), r.commitTypedCloser(e.filter), r.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (r.dismiss(), "ended") : (fe(t), r.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (fe(t), r.dismiss(), "ended") : t.key === "Backspace" || _i[o].test(t.key) ? (fe(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (o === "selection" && fe(t), r.dismiss(), "ended");
}
function _a(t, e) {
  var r;
...
const fw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(lt, { children: [
...
function mw({
  ...
  const i = q(null), s = q(null), c = q(!1), [l, d] = N(t), [w, p] = N(r), [h, g] = N(!1);
  H(() => {
    d(t);
  }, [t]), H(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(Be, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "outline", className: "tw:h-6", children: fw(t, n, r) }) }) }),
...
const vw = (t, e) => t === "f" ? /* @__PURE__ */ u(lt, { children: [
  /* @__PURE__ */ a(_n, {}),
  " ",
...
function xw({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "outline", className: "tw:h-6", children: vw(t, r) }) }) }),
      /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ a("p", { children: bw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ue, { style: { zIndex: fn }, children: [
...
function nn({
  ...
  return /* @__PURE__ */ u(
    ze,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(_w, { state: t.selectionState }),
...
function Rp({
  ...
  var he;
  const p = q(null), h = q(null), g = q(null), f = q(null);
  ne(() => {
    if (!f.current) return;
    const { width: C } = f.current.getBoundingClientRect();
    C > 0 && (f.current.style.width = `${C}px`);
  }, []);
  const [b, m] = N("generated"), [E, T] = N("generated"), [k, z] = N("*"), [B, D] = N("*"), [I, P] = N("f"), [S, V] = N(!1), [X, _] = N(!0), [rt, F] = N(!1), Q = q(!1), M = q(""), [O, Z] = N(!1), [ot, Pt] = N(), [Ot, Kt] = N(), [Y, nt] = N(), [pt, st] = N(), gt = q(null), qt = q(void 0), Ct = q(0), bt = q(void 0), xt = $(
    () => ({
      ...s,
  ...
  const yt = L(() => {
    var j, x, K;
    const C = (j = h.current) == null ? void 0 : j.querySelector(".editor-input"), U = C == null ? void 0 : C.querySelector("span.note"), tt = (K = (x = h.current) == null ? void 0 : x.ownerDocument.getSelection()) == null ? void 0 : K.anchorNode;
    return !!U && !!tt && U.contains(tt);
  }, []);
  H(() => {
    var x, K;
    let C, U, tt;
    Q.current = !1, bt.current = void 0, _(!0);
    const j = e == null ? void 0 : e.at(0);
    if (j && Ir("note", j)) {
      const G = (x = j.insert.note) == null ? void 0 : x.caller;
      let at = "custom";
      G === Pa ? at = "generated" : G === Va ? at = "hidden" : G && (z(G), D(G)), m(at), T(at), P(((K = j.insert.note) == null ? void 0 : K.style) ?? "f"), C = setTimeout(() => {
        var dt, ht, ft;
        (dt = p.current) == null || dt.applyUpdate([j]), (ht = p.current) == null || ht.selectNote(0), (ft = p.current) == null || ft.focus(), U = requestAnimationFrame(() => {
          tt = setTimeout(() => {
            var Nt, It;
            yt() || ((Nt = p.current) == null || Nt.selectNote(0), (It = p.current) == null || It.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      C && clearTimeout(C), U !== void 0 && cancelAnimationFrame(U), tt !== void 0 && clearTimeout(tt);
    };
  }, [e, i, yt]);
  const Vt = L(
    (C, U, tt = !1) => {
      var x, K, G;
      const j = (K = (x = p.current) == null ? void 0 : x.getNoteOps(0)) == null ? void 0 : K.at(0);
      if (j && Ir("note", j)) {
        if (j.insert.note) {
          let at;
          C === "custom" ? at = U : C === "generated" ? at = Pa : at = Va, j.insert.note.caller = at;
        }
        r == null || r([j]), tt && d && i && ((G = d.current) == null || G.replaceEmbedUpdate(i, [j]));
      }
    },
    [i, r, d]
  ), R = L(() => {
    var C;
    qt.current || (C = p.current) == null || C.commitPendingMarkerEdits(), Vt(b, k, !0), o();
  }, [b, k, o, Vt]), kt = q(R);
  ne(() => {
    kt.current = R;
  });
  const _t = q({ book: n.book, chapterNum: n.chapterNum });
  ne(() => {
    (_t.current.book !== n.book || _t.current.chapterNum !== n.chapterNum) && (_t.current = { book: n.book, chapterNum: n.chapterNum }, kt.current());
  }, [n.book, n.chapterNum]);
  const re = () => {
    var U;
    const C = (U = h.current) == null ? void 0 : U.getElementsByClassName("editor-input")[0];
    ...
    var tt, j, x, K, G;
    P(C);
    const U = (j = (tt = p.current) == null ? void 0 : tt.getNoteOps(0)) == null ? void 0 : j.at(0);
    if (U && Ir("note", U)) {
      U.insert.note && (U.insert.note.style = C);
      const at = (K = (x = U.insert.note) == null ? void 0 : x.contents) == null ? void 0 : K.ops;
      I !== "x" && C === "x" ? at == null || at.forEach((dt) => Tw(dt)) : I === "x" && C !== "x" && (at == null || at.forEach((dt) => Sw(dt))), (G = p.current) == null || G.applyUpdate([U, { delete: 1 }]);
    }
  }, Ge = (C) => {
    st(C.contextMarker), F(C.canRedo);
  }, Et = L(
    (C) => {
      var tt, j, x, K, G;
      const U = (j = (tt = p.current) == null ? void 0 : tt.getNoteOps(0)) == null ? void 0 : j.at(0);
      if (U && Ir("note", U)) {
        ...
        const at = (x = U.insert.note) == null ? void 0 : x.style, dt = (G = (K = U.insert.note) == null ? void 0 : K.contents) == null ? void 0 : G.ops;
        if (at || V(!1), V(
          at === "x" ? !!(dt != null && dt.every((ht) => {
            var Nt, It;
            if (!((Nt = ht.attributes) != null && Nt.char)) return !0;
            const ft = ((It = ht.attributes) == null ? void 0 : It.char).style;
          ...
          Q.current = !0, M.current = JSON.stringify(U), _(!0);
          return;
        }
    ...
    if (g.current && Gt.length && C && C.rangeCount > 0) {
      const U = C.getRangeAt(0).getBoundingClientRect(), tt = g.current.getBoundingClientRect();
      Pt(U.left - tt.left), Kt(U.top - tt.top), nt(U.height), Z(!0);
    }
  }, [Gt, g]), Rt = q(() => {
  }), Dt = L(
    (C, U, tt) => {
      const { anchorRect: j } = C;
      if (!w || !j) return;
      const { passive: x } = tt;
      Ct.current += 1;
      const K = Ct.current;
      qt.current = {
        ...
        keys: ww(x ? "backslash" : "selection"),
        onKey: (G) => Rt.current(G)
      }).then((G) => {
        var at, dt, ht, ft, Nt, It;
        if (_a(qt, K), G !== void 0) {
          ...
          const He = U.find((de) => de.marker === G);
        ...
        } else x || (It = p.current) == null || It.focus();
      }).catch(() => {
        var G;
        _a(qt, K), x || (G = p.current) == null || G.focus();
      });
    },
    [w]
  ), Ht = L(() => {
    ...
    if (!C) return !1;
    const U = ll(xt.styleInfo ?? dl, C);
    return U.length === 0 ? !1 : (Dt(C, U, { passive: !C.hasTextSelection }), !0);
    ...
    (C) => {
      ...
      uw(C, U, {
        ...
        commitTyped: (j) => {
          var x;
          return (x = p.current) == null ? void 0 : x.commitTypedMarker(j);
        },
        commitTypedAndReopen: (j) => {
          var x;
          (x = p.current) == null || x.commitTypedMarker(j, { trailingSpace: !1 }), Ht();
        },
        commitTypedCloser: (j) => {
          var x;
          return (x = p.current) == null ? void 0 : x.commitTypedCloser(j);
        },
        commitItem: (j) => {
          var K;
          const x = U.items.find((G) => G.marker === j);
          x && ((K = p.current) == null || K.applyMarkerMenuSelection(x, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  H(() => {
    ...
    const C = (U) => {
      var x, K;
      const tt = (x = h.current) == null ? void 0 : x.querySelector(".editor-input");
      if (!tt || U.target !== tt) return;
      const j = (K = p.current) == null ? void 0 : K.getSelection();
      j && (bt.current = j);
    };
    ...
    const C = () => {
      var j;
      return ((j = h.current) == null ? void 0 : j.querySelector(".editor-input")) ?? void 0;
    };
    if (((tt = xt.view) == null ? void 0 : tt.markerMode) === "editable") {
      const j = (K) => {
        var dt, ht, ft, Nt;
        if (ki(K)) return;
        const G = C();
        ...
        if (K.key === "Enter" && !yt()) {
          K.preventDefault(), K.stopPropagation(), (dt = p.current) == null || dt.selectNote(0), (ht = p.current) == null || ht.focus();
          return;
        }
        if (w && K.key === c) {
          if (!yt()) {
            K.preventDefault(), K.stopPropagation(), (ft = p.current) == null || ft.selectNote(0), (Nt = p.current) == null || Nt.focus();
            return;
          }
          Ht() && (K.preventDefault(), K.stopPropagation());
        }
      }, x = () => {
        var G, at;
        const K = C();
        !K || document.activeElement !== K || yt() || ((G = p.current) == null || G.selectNote(0), (at = p.current) == null || at.focus());
      };
      return document.addEventListener("keydown", j, { capture: !0 }), document.addEventListener("paste", x, { capture: !0 }), () => {
        document.removeEventListener("keydown", j, { capture: !0 }), document.removeEventListener("paste", x, { capture: !0 });
      };
    }
    const U = (j) => {
      const x = C();
      !O && x && document.activeElement === x && j.key === c ? (j.preventDefault(), ae()) : O && j.key === "Escape" && (j.preventDefault(), Z(!1));
    };
    ...
    const C = () => {
      var j, x, K;
      const U = ((j = h.current) == null ? void 0 : j.querySelector(".editor-input")) ?? void 0;
      if (!U || document.activeElement !== U) return;
      const tt = document.getSelection();
      tt && !tt.isCollapsed || yt() || ((x = p.current) == null || x.selectNote(0), (K = p.current) == null || K.focus());
    };
  ...
  return /* @__PURE__ */ u(lt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(lt, { children: Rw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Mp({
  ...
  const w = l ?? Gs(r, void 0), p = (k, z) => {
    d == null || d(k, z, n);
  }, h = i ? r.findIndex((k) => k === i) : -1, [g, f] = N(h), b = (k, z, B) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), d == null || d(z, B, n);
          break;
      }
  }, m = (k) => {
    if (r.length)
    ...
    /* @__PURE__ */ a(Za, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { className: o, children: Ow(c.text) })
        ]
      },
...
const $w = (t) => {
...
}, sa = (t, e, r) => /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
  /* @__PURE__ */ u(
    Ft,
    {
  ...
  return e ? e[1] : "";
}, Pw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Lp = Object.freeze([
...
function jp({
  ...
  const g = me(r, "%webView_inventory_all%"), f = me(r, "%webView_inventory_approved%"), b = me(r, "%webView_inventory_unapproved%"), m = me(r, "%webView_inventory_unknown%"), E = me(r, "%webView_inventory_scope_currentBook%"), T = me(r, "%webView_inventory_scope_chapter%"), k = me(r, "%webView_inventory_scope_verse%"), z = me(r, "%webView_inventory_filter_text%"), B = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), D = me(r, "%webView_inventory_no_results%"), [I, P] = N(!1), [S, V] = N("all"), [X, _] = N(""), [rt, F] = N([]), Q = $(() => {
    const Y = t ?? [];
    return Y.length === 0 ? [] : Lw(Y, n, i);
  }, [t, n, i]), M = $(() => {
    if (I) return Q;
    const Y = [];
    return Q.forEach((nt) => {
      const pt = nt.items[0], st = Y.find(
        (gt) => gt.items[0] === pt
      );
      st ? (st.count += nt.count, st.occurrences = st.occurrences.concat(nt.occurrences)) : Y.push({
        items: [pt],
        count: nt.count,
  ...
  }, [I, Q]), O = $(() => M.length === 0 ? [] : Vw(M, S, X), [M, S, X]), Z = $(() => {
    var pt, st;
    if (!I) return l;
    const Y = (pt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : pt.length;
    if (!Y) return l;
    const nt = [];
  ...
  const ot = (Y, nt) => {
    nt.setRowSelection(() => {
      const st = {};
      return st[Y.index] = !0, st;
    });
    const pt = Y.original.items;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(pr, { onValueChange: (Y) => Pt(Y), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
        ...
        /* @__PURE__ */ a(Ut, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const jw = "16rem", Bw = "3rem", Ci = Jt.createContext(void 0);
function ca() {
...
function Ww({
  ...
  const c = t ? Dr.Root : "button", { state: l } = ca(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Yw({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Uw,
    {
      ...
      children: /* @__PURE__ */ u(qw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Gw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Hw, { children: /* @__PURE__ */ a(
            Ww,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const De = "scrBook", Jw = "scrRef", Ze = "source", Zw = "details", Qw = "Scripture Reference", tu = "Scripture Book", Ei = "Type", eu = "Details";
function ru(t, e) {
  const r = e ?? !1;
  return [
    {
...
const au = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ia(t.start, t.end) === 0 ? `${wa(t.start)}+${e}` : `${wa(t.start)}+${e}-${wa(t.end)}+${r}`;
...
function eh({
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const X = b.find((_) => dn(_) === V[0]) || void 0;
        X && c(X);
      }
    }
  }, [g, b, c, E]);
  const T = n ?? tu, k = i ?? Ei, z = [
  ...
  }, I = (S, V) => S.getIsGrouped() ? "" : v("banded-row", V % 2 === 0 ? "even" : "odd"), P = (S, V, X) => {
    if (!((S == null ? void 0 : S.length) === 0 || V.depth < X.column.getGroupedIndex())) {
      if (V.getIsGrouped())
        switch (V.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(Qd, { children: z.map((S) => /* @__PURE__ */ a(we, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Xa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ja, { children: E.getHeaderGroups().map((S) => /* @__PURE__ */ a(Oe, { children: S.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(Za, { children: E.getRowModel().rows.map((S, V) => {
        const X = ye();
        return /* @__PURE__ */ a(
          Oe,
          {
                    ...
                    children: _.getIsGrouped() ? /* @__PURE__ */ u(
                      W,
                      {
                        ...
                        children: [
                          ...
                          !S.getIsExpanded() && (X === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
...
const Si = (t, e, r) => mo(t, e).every((o) => r.includes(o));
function ou({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [b, m] = N(!1), [E, T] = N(""), k = q(void 0), z = q(!1), B = $(
    () => Ti(t),
    [t]
  ), D = $(() => {
    if (!E.trim()) {
    ...
    (_, rt = !1) => {
      ...
      const F = B.findIndex((ot) => ot === k.current), Q = B.findIndex((ot) => ot === _);
      if (F === -1 || Q === -1) return;
      const [M, O] = [
        Math.min(F, Q),
        Math.max(F, Q)
      ], Z = B.slice(M, O + 1).map((ot) => ot);
      r(
        e.includes(_) ? e.filter((ot) => !Z.includes(ot)) : [.../* @__PURE__ */ new Set([...e, ...Z])]
      );
    },
    [e, r, B]
  ), P = (_) => {
    I(_, z.current), z.current = !1;
  }, S = (_, rt) => {
    _.preventDefault(), I(rt, _.shiftKey);
  }, V = () => {
    r(B.map((_) => _));
  }, X = () => {
    r([]);
          ...
          Le,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(W, { variant: "ghost", size: "sm", onClick: V, children: l }),
                /* @__PURE__ */ a(W, { variant: "ghost", size: "sm", onClick: X, children: d })
              ] }),
              /* @__PURE__ */ u(je, { children: [
                  ...
                  if (F.length !== 0)
                    return /* @__PURE__ */ u(aa, { children: [
                      /* @__PURE__ */ a(
                        Te,
                        {
                          heading: un(_, p, h, g, f),
                          children: F.map((Q) => /* @__PURE__ */ a(
                            qn,
                            {
                              bookId: Q,
                      ...
                      rt < Object.values(ut).length - 1 && /* @__PURE__ */ a(mn, {})
                    ] }, _);
                })
              ] })
            ]
...
function ah({
  ...
  const z = $t(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = $t(s, "%webView_scope_selector_verse%"), D = $t(s, "%webView_scope_selector_chapter%"), I = $t(s, "%webView_scope_selector_book%"), P = $t(
    s,
    "%webView_scope_selector_current_verse%"
  ), S = $t(
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = $t(s, "%webView_scope_selector_current_book%"), X = $t(s, "%webView_scope_selector_choose_books%"), _ = $t(s, "%webView_scope_selector_scope%"), rt = $t(s, "%webView_scope_selector_select_books%"), F = $t(s, "%webView_scope_selector_range%"), Q = $t(s, "%webView_scope_selector_select_range%"), M = $t(s, "%webView_scope_selector_range_start%"), O = $t(s, "%webView_scope_selector_range_end%"), Z = $t(s, "%webView_scope_selector_ok%"), ot = $t(s, "%webView_scope_selector_cancel%"), Pt = $t(s, "%webView_scope_selector_navigate%"), Ot = (A) => {
    if (!f) return;
  ...
  ], Y = (A, et, te = !1) => /* @__PURE__ */ u(lt, { children: [
    A,
    et && !te && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      et
    ] })
  ] }), nt = e ? Kt.filter((A) => e.includes(A.value)) : Kt, pt = f ?? ua, st = w ?? pt, gt = p ?? pt, qt = () => {
  }, Ct = q(null), bt = q(null), xt = q(!1), Gt = q(null), yt = q(!1), [Vt, R] = N(void 0), kt = q(!1), _t = q(!1), re = q(null), qe = L((A) => {
    if (A) {
    ...
    [r, n, f, i]
  ), ae = nt.find((A) => A.value === t), Rt = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Ys(st, gt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ae ? Y(ae.label, ae.scrRefSuffix) : t, Dt = nt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), Ht = nt.find((A) => A.value === "selectedBooks"), oe = nt.find((A) => A.value === "range"), [Qt, he] = N(!1), [C, U] = N(void 0), [tt, j] = N(void 0), [x, K] = N(void 0), [G, at] = N(void 0), [dt, ht] = N([]), ft = d === "dropdown" && C === "selectedBooks", Nt = /* @__PURE__ */ a(
    iu,
    {
      availableBookInfo: o,
  ...
  ), It = Vt === "end", He = Vt === "start", de = "tw:text-muted-foreground", Ye = d === "dropdown" && C === "range", y = Ye ? K : le, it = Ye ? at : g ? Ge : qt, Lt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-start", className: v(It && de), children: M }),
      /* @__PURE__ */ a(
        ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ct, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ha,
        {
          ...
          localizedStrings: m,
          getEndVerse: E,
          disableReferencesUpTo: Ye ? x ?? st : st,
          onOpenChange: ce,
          onCloseAutoFocus: (A) => {
            var et;
  ...
  const [Mt, Tt] = N(null), [St, mt] = N(null), [Yt, ge] = N(null), Xe = 200, [Ai, Pi] = N(!1);
  H(() => {
    if (!Yt || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([et]) => {
      Pi(et.contentRect.width < Xe);
    });
    return A.observe(Yt), () => A.disconnect();
  }, [Yt]);
  const vo = L(
    (A) => {
      j(A), K(st), at(gt), ht(n), he(!1), U(A);
    },
    [st, gt, n]
  ), bo = L(() => {
    tt !== void 0 && (tt === "range" ? (x && (h == null || h(x)), G && (g == null || g(G))) : tt === "selectedBooks" && i(dt), Et(tt), U(void 0), j(void 0));
  }, [
    tt,
    x,
    G,
  ...
  }, []), yo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a($e, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !T && /* @__PURE__ */ a(zt, { children: _ }),
      d === "dropdown" ? /* @__PURE__ */ u(Be, { open: Qt, onOpenChange: he, children: [
        ...
        /* @__PURE__ */ a(
          Ue,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(la, { container: Yt, children: [
              Dt.map(({ value: A, label: et, dropdownLabel: te, scrRefSuffix: vr, id: Vi }) => /* @__PURE__ */ u(
                Qe,
                {
                  ref: Re(A),
                        ...
                        children: /* @__PURE__ */ a(
                          ha,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(lt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ce(f ?? ua, "id") }),
                              /* @__PURE__ */ a(wr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ha,
        {
          ...
          children: nt.map(({ value: A, label: et, scrRefSuffix: te, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(zt, { htmlFor: vr, children: Y(et, te) })
          ] }, vr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && Lt,
    d === "dropdown" && Ht && /* @__PURE__ */ a(Ea, { open: C === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: mt,
        onCloseAutoFocus: xo,
        ...
        children: /* @__PURE__ */ u(la, { container: St, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: X }) }),
          Nt,
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(W, { variant: "outline", onClick: () => Mr(!1), children: ot }),
            /* @__PURE__ */ a(W, { onClick: bo, children: Z })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && oe && /* @__PURE__ */ a(Ea, { open: C === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: Tt,
        onCloseAutoFocus: xo,
        ...
        children: /* @__PURE__ */ u(la, { container: Mt, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: Q }) }),
          Lt,
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(W, { variant: "outline", onClick: () => Mr(!1), children: ot }),
            /* @__PURE__ */ a(W, { ref: re, onClick: bo, children: Z })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          fr,
          {
            ...
            style: { zIndex: ar },
            children: t.map((w) => /* @__PURE__ */ a(we, { value: `${w}`, children: l[To(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Ka({
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    /* @__PURE__ */ a(Fe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(W, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ps, {}) }) }),
...
Oi.displayName = pe.List.displayName;
const lu = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Trigger,
  {
    ref: r,
    ...e,
...
)), Ii = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Content,
  {
    ref: r,
    className: v(
...
Ii.displayName = pe.Content.displayName;
function dh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Mi, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(lu, { value: c.value, children: c.value }, c.key)) }),
...
function xu({
  ...
  if (ul(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(du, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(wu, { children: [
      /* @__PURE__ */ a(pu, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        hu,
        {
          style: { zIndex: ar },
...
function ph({
  ...
  const d = yu(
    ...
    var E, T, k, z, B, D;
    const m = b !== f ? ((T = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : T[b]) ?? ((z = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : z.en) : void 0;
    return m ? `${(B = t[f]) == null ? void 0 : B.autonym} (${m})` : (D = t[f]) == null ? void 0 : D.autonym;
  };
...
function mh({
  ...
  const c = t ? So(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Cu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
...
function Kh({
  ...
  const n = ye();
  return /* @__PURE__ */ u(Su, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(zu, {}),
    /* @__PURE__ */ u(
      Ke.Content,
      {
...
function ig({
  ...
  return /* @__PURE__ */ a(
    pe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Du({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function pg(t) {
  const e = $(() => Ws(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const Ou = () => {
  const [t, e] = N(
...
export {
  ...
  za as DialogTitle,
  kg as DialogTrigger,
  vh as DisabledActionTooltip,
  Eu as DisabledTooltipWrapper,
  Bh as Drawer,
  Uh as DrawerClose,
  Kh as DrawerContent,
  Yh as DrawerDescription,
  Gh as DrawerFooter,
  qh as DrawerHeader,
  zu as DrawerOverlay,
  Su as DrawerPortal,
  ...
  Mw as FootnoteItem,
  Mp as FootnoteList,
  hh as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Lp as INVENTORY_STRING_KEYS,
  ra as Input,
  gh as InterfaceLanguagePicker,
  jp as Inventory,
  Ra as Kbd,
  Ng as KbdGroup,
  zt as Label,
