...
var Xi = (t, e, r) => e in t ? Yi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Ht = (t, e, r) => Xi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as xe, a as Cr, C as Me, u as Do, T as jt, b as Ct, d as Et, e as Tt, A as pe, P as je, f as tr, B as tt, h as Be, i as Fe, j as Ue, k as ze, x as Ji, l as Zi, m as Qi, I as ts, n as so, r as Ne, o as es, p as _n, q as ia, s as sa, L as $t, R as co, t as Zr, D as ja, v as Ba, w as Fa, y as Ua, z as Nn, E as Kr, F as lo, G as Cn, H as wo, J as Ze, K as Rr, M as Ke, N as He, O as qe, S as zr, Q as cr, U as rs, V as Or, W as Qe, X as Ae, Z as er, Y as $e, _ as lr, $ as uo, a0 as po, a1 as Qr, a2 as ho, a3 as En, a4 as as, a5 as os, a6 as ns, a7 as Ka, a8 as Tn, a9 as ca, aa as is, ab as Sn, ac as ss, ad as cs, ae as ls, af as Mo, ag as ds, ah as ws, ai as us, aj as Rn, ak as zn, al as go, am as ps, an as Dn, ao as Na, ap as Oo, aq as Ca, ar as hs, as as gs, at as fs, au as ms, av as vs, aw as Ir, ax as fo, ay as bs, az as xs } from "./resizable-BTh0w_GD.js";
...
import { Check as Ve, Clock as Io, ChevronsLeft as $o, ChevronsRight as Po, ChevronLeft as Ha, ChevronRight as qa, ArrowLeft as ys, ArrowRight as ks, ChevronDown as ur, BoldIcon as _s, ItalicIcon as Ns, X as Mn, AtSign as On, Pencil as Cs, Trash2 as Ao, ArrowUp as In, MoreHorizontal as Es, MailOpen as Ts, Mail as Ss, ChevronUp as Rs, FilterIcon as zs, ArrowLeftIcon as Ds, ChevronLeftIcon as Ms, ChevronRightIcon as Os, ArrowRightIcon as Is, Copy as $n, Filter as $s, User as Ps, Link as As, CircleHelp as Vs, Undo as Ls, Redo as js, SquareX as Pn, FunctionSquare as An, SquareSigma as Vn, Ban as Bs, AlertCircle as Ga, CircleCheckIcon as Fs, CircleXIcon as Us, CircleHelpIcon as Ks, ArrowUpIcon as Hs, ArrowDownIcon as qs, ScrollText as Gs, ChevronsUpDown as Ws, MenuIcon as Ys, Menu as Xs, EllipsisVertical as Js, MoreVertical as Zs } from "lucide-react";
import { Section as It, getChaptersForBook as Qs, formatScrRef as Se, formatReplacementString as Pe, getSectionForBook as Hr, formatRelativeDate as tc, sanitizeHtml as mo, NumberFormat as Ln, formatBytes as ec, getCurrentLocale as rc, usfmMarkers as qr, isPlatformError as ac, ABORTED as oc, getErrorMessage as nc, getFormatCallerFunction as ic, deepEqual as sc, isString as Vo, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as cc, getLocalizeKeyForScrollGroupId as Lo, formatReplacementStringToArray as jo, collectUsjMarkers as lc } from "platform-bible-utils";
import Gt, { useRef as F, useMemo as $, createContext as $r, useContext as la, useState as k, useEffect as J, useCallback as A, useImperativeHandle as dc, useLayoutEffect as ee, Component as wc, createElement as Bo, Suspense as uc, forwardRef as jn, useId as Fo, Fragment as da } from "react";
import { IconSelector as Bn, IconCheck as wa, IconChevronDown as pc, IconChevronUp as hc, IconLayoutSidebar as gc, IconLayoutSidebarRight as fc, IconChevronRight as Fn, IconSearch as mc, IconLoader as vc, IconAlertOctagon as bc, IconAlertTriangle as xc, IconInfoCircle as yc, IconCircleCheck as kc } from "@tabler/icons-react";
import { createEditor as Un, $getRoot as Le, $createParagraphNode as Pr, $getSelection as re, HISTORY_MERGE_TAG as vo, ParagraphNode as Kn, TextNode as Hn, $getPreviousSelection as _c, $isRangeSelection as ke, $caretFromPoint as Nc, $getSiblingCaret as qn, $getChildCaret as Cc, $getAdjacentChildCaret as Ec, $isChildCaret as Tc, $normalizeCaret as Sc, $setSelectionFromCaretRange as Rc, $getCollapsedCaretRange as zc, $getCaretInDirection as Uo, $splitAtPointCaretNext as Dc, $isTextPointCaret as Mc, $findMatchingParent as Gn, $isElementNode as Dr, mergeRegister as De, getDOMTextNode as Oc, isHTMLElement as Ic, CLEAR_EDITOR_COMMAND as Wn, COMMAND_PRIORITY_EDITOR as bo, shallowMergeConfig as $c, defineExtension as le, safeCast as rr, createState as Pc, FORMAT_TEXT_COMMAND as Yn, $isNodeSelection as Xn, COMMAND_PRIORITY_LOW as Jn, RootNode as Ac, LineBreakNode as Vc, TabNode as Lc, $isEditorState as jc, createCommand as Bc, CLICK_COMMAND as Fc, isDOMNode as Uc, $getNodeFromDOMNode as Kc, $createNodeSelection as Hc, $setSelection as qc, $getEditor as Gc, DecoratorNode as Ya, $getState as Wc, toggleTextFormatType as Ko, TEXT_TYPE_TO_FORMAT as Yc, $setState as Xc, addClassNamesToElement as Zn, $create as Jc, $getNodeByKey as Zc, removeClassNamesFromElement as Qc, KEY_TAB_COMMAND as tl, $isBlockElementNode as el, $createRangeSelection as rl, $normalizeSelection__EXPERIMENTAL as al, OUTDENT_CONTENT_COMMAND as ol, INDENT_CONTENT_COMMAND as Ho, INSERT_TAB_COMMAND as nl, COMMAND_PRIORITY_CRITICAL as xo, $isDecoratorNode as il, $isParagraphNode as sl, $isTextNode as Xa, SELECTION_CHANGE_COMMAND as Qn, $insertNodes as cl } from "lexical";
...
import { Avatar as yo, Select as Wt, Checkbox as qo, Slot as Ar, Tabs as he, Menubar as Ce, ContextMenu as Bt, Progress as Go, Slider as Lr, Switch as Wo } from "radix-ui";
import { useReactTable as ei, getFilteredRowModel as ml, getSortedRowModel as ri, getPaginationRowModel as vl, getCoreRowModel as ai, flexRender as Er, getGroupedRowModel as bl, getExpandedRowModel as xl } from "@tanstack/react-table";
import yl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ja, HIDDEN_NOTE_CALLER as Za, getDefaultViewOptions as kl, isInsertEmbedOpOfType as kr, getMarkerMenuItems as _l, defaultStyleInfo as Nl, Editorial as Cl } from "@eten-tech-foundation/platform-editor";
...
function ni({
  ...
  const g = F(!1), f = () => {
    ...
    () => Cr(e, l),
    [e, l]
  ), x = !!p && !w, C = `${b} (${R})`, N = x ? h || `${C}, ${p}` : C, I = /* @__PURE__ */ u(
    Me,
    {
      ref: t,
...
function Dl({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: v
  } = Do(), [b, R] = k(!1), [x, C] = k(!1), N = F(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), I = n && e !== void 0, L = s ?? (e !== void 0 && !n);
  J(() => {
    var Y;
    zl();
    const rt = (Y = N.current) == null ? void 0 : Y.closest('button, [role="combobox"], [tabindex]');
    if (!rt) return;
    const D = (G) => !!G && G.scrollWidth > G.clientWidth, it = () => {
      Qa !== "pointer" && (L || D(h.current) || D(l.current)) && C(!0);
    }, S = () => C(!1);
    return rt.addEventListener("focus", it), rt.addEventListener("blur", S), () => {
      rt.removeEventListener("focus", it), rt.removeEventListener("blur", S);
    };
  }, [L, h, l]);
  const B = A(() => {
    L && R(!0), f(), I && w();
  ...
  const z = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), _ = I ? (
        ...
        children: [
          /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                q,
                q && W && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                W
              ]
            }
          ) }),
...
function Ml({
  ...
  const [h, g] = k(!1), f = w !== void 0, v = f ? w : h, b = (x) => {
    f || g(x), p == null || p(x);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(je, { open: v, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ a(Be, { id: i, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(ze, { heading: s, children: t.map((x) => /* @__PURE__ */ u(
      Me,
      {
        onSelect: () => R(x),
      ...
      if (i) {
        ...
        if (!w && l) {
          const g = ((f) => Object.keys(pe).find(
            (v) => pe[v].toLowerCase() === f.toLowerCase()
          ))(c);
          if (g && e.includes(g) && (w = g), !w && r) {
            const f = Array.from(r.entries()).find(
              ([, v]) => v.localizedName.toLowerCase() === c.toLowerCase()
            );
...
function to(t) {
  return {
    [It.OT]: t.filter((e) => Lt.isBookOT(e)),
    [It.NT]: t.filter((e) => Lt.isBookNT(e)),
    [It.DC]: t.filter((e) => Lt.isBookDC(e)),
    [It.Extra]: t.filter((e) => Lt.extraBooks().includes(e))
  };
}
function Vl(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : Lt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
...
function li({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(ze, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function Ra({
  ...
  const L = Ne(), B = Rl(), [O, z] = k(!1), [_, q] = k(""), [W, rt] = k(""), [D, it] = k("books"), [S, Y] = k(void 0), [G, U] = k(
    void 0
  ), [Q, wt] = k(void 0), [St, Z] = k(!1), [ut, ft] = k(!1), bt = F(null), yt = F(!1), _t = F(void 0), Nt = F(void 0), Yt = F(void 0), Xt = F(void 0), Dt = F({}), ae = F({}), mt = A(
    (y) => {
      e(y), l && l(y);
    },
    [e, l]
    ...
    projectBooksBySection: Jt,
    reachableBooksBySection: oe,
    reachableBooks: Ut,
    projectBooks: ge,
    booksOutsideProject: de
  } = $(
    () => Vl(se, Mt),
    [se, Mt]
  ), fe = de.has(t.book), Kt = $(() => W.trim() ? to(
    Ut.filter((y) => so(y, W, s))
  ) : ut ? oe : Jt, [
    Jt,
    oe,
    Ut,
  ...
  const we = A(() => {
    if (M) {
      const y = M.chapterNum ?? 1, at = M.verseNum ?? 1;
      if (p && Sa(M.book, y, at, p))
        return;
      mt({
        book: M.book,
        chapterNum: y,
    ...
    (y) => {
      const at = G ?? (M == null ? void 0 : M.book), nt = Q ?? (M == null ? void 0 : M.chapterNum);
      !at || !nt || (mt({
        book: at,
        chapterNum: nt,
        verseNum: y
    ...
    (y) => {
      const at = D === "chapters" ? S : M == null ? void 0 : M.book;
      if (at) {
        if (w && w(at, y) > 1) {
          U(at), wt(y), it("verses"), q("");
          return;
        }
        mt({
          book: at,
    ...
    it("books"), Y(void 0), U(void 0), wt(void 0), setTimeout(() => {
      Nt.current && Nt.current.focus();
    }, 0);
  }, []), V = A(() => {
    const y = G;
    U(void 0), wt(void 0), y ? (Y(y), it("chapters"), q("")) : E();
  }, [G, E]), K = A(
    (y) => {
      z(y), y && (it("books"), Y(void 0), U(void 0), wt(void 0), rt(""), ft(fe));
    },
    [fe]
  );
  J(() => {
  ...
  const { otLong: j, ntLong: ot, dcLong: lt, extraLong: dt } = {
    ...
    () => Se(
      t,
      s ? xe(t.book, s) : "English"
    ),
    [t, s]
  ), T = $(
    () => B >= Tr.TIGHT ? Cr(t.book, s) : xe(t.book, s),
    [t.book, s, B]
  ), vt = `${t.chapterNum}:${t.verseNum}`, ht = A((y) => (at) => {
    Dt.current[y] = at;
  }, []), Qt = A((y) => (at) => {
    ae.current[y] = at;
  }, []), ar = $(
    () => $l(W),
    [W]
  ), fa = $(() => !w || !M || !M.chapterNum || !ar ? !1 : w(M.book, M.chapterNum) > 0, [w, M, ar]), ma = D === "books" && !St && !W.trim() && de.size > 0, Vr = A(
    (y) => p ? Xo(y, p) : !1,
    [p]
  ), br = A(
    (y) => (at) => p ? Pl(y, at, p) : !1,
    ...
    (y, at) => (nt) => p ? Sa(y, at, nt, p) : !1,
    [p]
  ), xr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", We = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) || "Select verse", va = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", Ye = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", ba = A(
    (y) => Pe(Ye, {
      book: `${xe(y, s)} (${Cr(
        y,
        s
    ...
    [Ye, s]
  ), nr = (i == null ? void 0 : i["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", xa = (i == null ? void 0 : i["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", ya = A(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), h && h.includes(y.key) && M && M.chapterNum !== void 0 && M.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), we());
    },
    [h, M, we]
  ), ka = A(
    (y) => {
      var Te, P, et;
      if (y.ctrlKey) return;
      const { isLetter: at, isDigit: nt } = Jo(y.key);
      if ((D === "chapters" || D === "verses") && (y.key === " " || y.key === "Enter")) {
        const pt = y.target instanceof HTMLElement ? y.target : void 0;
        ...
        const Ft = (Te = _t.current) == null ? void 0 : Te.querySelector(
      ...
      if ((D === "chapters" || D === "verses") && (at || nt)) {
        y.preventDefault(), y.stopPropagation();
        return;
      }
      if (D === "chapters" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), E();
        return;
      }
      if (D === "verses" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), V();
        return;
      }
      const te = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key);
      if (D === "verses" && te) {
        const pt = G, xt = Q;
        if (!pt || !xt || !w) return;
        const Ft = w(pt, xt);
        if (!Ft) return;
        (P = _t.current) == null || P.focus();
        const zt = (() => {
          if (!_) return 1;
          const yr = _.match(/:(\d+)$/);
          return yr ? parseInt(yr[1], 10) : 0;
        })();
        let ve = zt;
        const Oe = 6;
        switch (y.key) {
          case "ArrowLeft":
            zt !== 0 && (ve = zt > 1 ? zt - 1 : Ft);
            break;
          case "ArrowRight":
            zt !== 0 && (ve = zt < Ft ? zt + 1 : 1);
            break;
          case "ArrowUp":
            ve = zt === 0 ? Ft : Math.max(1, zt - Oe);
            break;
          case "ArrowDown":
            ve = zt === 0 ? 1 : Math.min(Ft, zt + Oe);
            break;
          default:
            return;
        }
        ve !== zt && (y.preventDefault(), y.stopPropagation(), q(
          `${pt} ${pe[pt] || ""} ${xt}:${ve}`
        ), setTimeout(() => {
          const yr = ae.current[ve];
          yr && yr.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((D === "chapters" || D === "books" && M) && te) {
        const pt = D === "chapters" ? S : M == null ? void 0 : M.book;
        if (!pt) return;
        D === "chapters" && ((et = _t.current) == null || et.focus());
        const xt = (() => {
          if (!_) return 1;
          const Oe = _.match(/(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            xt !== 0 && (zt = xt > 1 ? xt - 1 : Ft);
            break;
          case "ArrowRight":
            xt !== 0 && (zt = xt < Ft ? xt + 1 : 1);
            break;
          case "ArrowUp":
            zt = xt === 0 ? Ft : Math.max(1, xt - ve);
            break;
          case "ArrowDown":
            zt = xt === 0 ? 1 : Math.min(Ft, xt + ve);
            break;
          default:
            return;
        }
        zt !== xt && (y.preventDefault(), y.stopPropagation(), q(
          `${pt} ${pe[pt] || ""} ${zt}`
        ), setTimeout(() => {
          const Oe = Dt.current[zt];
    ...
    if (y.key === "ArrowUp" || y.key === "ArrowDown") {
      (te = Nt.current) == null || te.focus();
      return;
    }
    const { isLetter: at, isDigit: nt } = Jo(y.key);
    (at || nt) && (y.preventDefault(), rt((Te) => Te + y.key), Nt.current.focus(), Z(!1));
  }, []);
  return ee(() => {
    const y = setTimeout(() => {
      if (O && D === "books" && Yt.current && Xt.current) {
        const at = Yt.current, nt = Xt.current, te = nt.offsetTop, Te = at.clientHeight, P = nt.clientHeight, et = te - Te / 2 + P / 2;
        at.scrollTo({
          top: Math.max(0, et),
          behavior: "smooth"
        }), q(ci(t.book));
    ...
    if (D === "chapters" && S) {
      ...
      q(
        ...
        if (Yt.current)
          if (y) {
            const nt = Dt.current[t.chapterNum];
  ...
  }, [D, S, M, t.book, t.chapterNum]), ee(() => {
    if (D === "verses" && G && Q !== void 0) {
      const y = G === t.book && Q === t.chapterNum, at = y ? t.verseNum : 1;
      q(
        `${G} ${pe[G] || ""} ${Q}:${at}`
      ), setTimeout(() => {
        if (Yt.current)
          if (y) {
            const nt = ae.current[t.verseNum];
            nt && nt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            Yt.current.scrollTo({ top: 0 });
        _t.current && _t.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(je, { open: O, onOpenChange: K, modal: x, children: [
    /* @__PURE__ */ a(tr, { asChild: !0, children: /* @__PURE__ */ u(
      tt,
      {
        ...
        onClick: (y) => {
          yt.current && (yt.current = !1, y.preventDefault());
        },
        children: [
          g ?? /* @__PURE__ */ a(
            Dl,
            {
              primary: T,
              secondary: vt,
              showSecondary: B < Tr.MINIMUM,
              isPartial: B >= Tr.TIGHT,
              fullText: Ot
            }
          ),
          v && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: at } = y;
          O && bt.current && at instanceof Node && bt.current.contains(at) && (yt.current = !0, K(!1));
        },
        onCloseAutoFocus: R,
        children: /* @__PURE__ */ u(
          Fe,
          {
            ...
            shouldFilter: !1,
            children: [
              D === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Zt.map(
                  ({ onClick: y, disabled: at, title: nt, icon: te }) => /* @__PURE__ */ a(
                    tt,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  tt,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: D === "verses" ? V : E,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: L === "ltr" ? /* @__PURE__ */ a(ys, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ks, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                D === "chapters" && S && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: xe(S, s) }),
                D === "verses" && G && Q !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${xe(G, s)} ${Q}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: D === "verses" ? We : xr
                  }
                )
              ] }),
              !St && /* @__PURE__ */ u(Ue, { ref: Yt, children: [
                D === "books" && /* @__PURE__ */ u(ct, { children: [
                  !M && Object.entries(Kt).map(([y, at]) => {
                    if (at.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ze, { heading: kt(y), children: at.map((nt) => /* @__PURE__ */ a(
                          ni,
                          {
                            bookId: nt,
                            onSelect: (te) => At(te),
                            ...
                            ref: nt === t.book ? Xt : void 0,
                            localizedBookNames: s,
                            disabled: Vr(nt),
                            dimmedReason: de.has(nt) ? va : void 0,
                            dimmedDescription: de.has(nt) ? ba(nt) : void 0
                          },
                          nt
                        )) }, y)
                      );
                  }),
                  M && /* @__PURE__ */ a(ze, { children: /* @__PURE__ */ a(
                    Me,
                    {
                      value: `${M.book} ${pe[M.book]} ${M.chapterNum || ""}:${M.verseNum || ""})}`,
                      onSelect: we,
                      disabled: !!p && Sa(
                        M.book,
                        M.chapterNum ?? 1,
                      ...
                      children: Se(
                        ...
                        // one control.
                        s ? Cr(M.book, s) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  M && fa && M.chapterNum && w && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${xe(M.book, s)} ${M.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Qo,
                      {
                        ...
                        onVerseSelect: ce,
                        setVerseRef: Qt,
                        isVerseDisabled: or(M.book, M.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  M && !fa && dr(M.book) > 1 && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: xe(M.book, s) }),
                    ...
                    /* @__PURE__ */ a(
                      Zo,
                      {
                        ...
                        setChapterRef: ht,
                        isChapterDimmed: Rt,
                        isChapterDisabled: br(M.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                D === "chapters" && S && /* @__PURE__ */ a(
                  Zo,
                  {
                    bookId: S,
                    scrRef: t,
                    onChapterSelect: ne,
                    setChapterRef: ht,
                    isChapterDisabled: br(S),
                    className: "tw:p-4"
                  }
                ),
                D === "verses" && G && Q !== void 0 && w && /* @__PURE__ */ a(
                  Qo,
                  {
                    bookId: G,
                    chapterNum: Q,
...
function tn({
  ...
  const [C, N] = k(!1), I = d ?? l, L = (O) => O.length > 0 && typeof O[0] == "object" && "options" in O[0], B = (O, z) => {
    const _ = l(O), q = typeof O == "object" && "secondaryLabel" in O ? O.secondaryLabel : void 0, W = `${z ?? ""}${_}${q ?? ""}`;
    return /* @__PURE__ */ u(
      Me,
      {
        value: _,
  ...
  return /* @__PURE__ */ u(je, { open: C, onOpenChange: N, ...x, children: [
    /* @__PURE__ */ a(tr, { asChild: !0, children: /* @__PURE__ */ u(
      tt,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          ...
          /* @__PURE__ */ a(Ue, { children: L(e) ? e.map((O) => /* @__PURE__ */ a(ze, { heading: O.groupHeading, children: O.options.map((z) => B(z, O.groupHeading)) }, O.groupHeading)) : /* @__PURE__ */ a(ze, { children: e.map((O) => B(O)) }) })
        ] })
      }
    )
  ] });
...
function Sp({
  ...
  const w = za(d, "%webView_bookSelector_currentBook%"), p = za(d, "%webView_bookSelector_choose%"), h = za(d, "%webView_bookSelector_chooseBooks%"), [g, f] = k(
    "current book"
    /* CurrentBook */
  ), v = (b) => {
    f(b), t(b);
    ...
    co,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a($t, { className: "tw:flex tw:items-center", children: o.map((b) => Lt.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ a(
            tt,
            {
...
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fl = wi ? ee : J, Br = { tag: vo };
function Ul({ initialConfig: t, children: e }) {
  const r = $(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: l } = t, d = Bl(null, o), w = Un({ editable: t.editable, html: l, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = Pr();
            g.append(f);
            const v = wi ? document.activeElement : null;
            (re() !== null || v !== null && v === p.getRootElement()) && f.select();
          }
        }, Br);
...
const Kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function Hl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return Kl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: s, dirtyLeaves: i, prevEditorState: c, tags: l }) => {
      e && s.size === 0 && i.size === 0 || t && l.has(vo) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const ko = {
...
const Xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function Jl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Zl() {
  return function(t) {
    const [e] = Ee(), r = $(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), s = F(o);
    return Xl(() => {
...
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, td = ui && "documentMode" in document ? document.documentMode : null;
!(!ui || !("InputEvent" in window) || td) && "getTargetRanges" in new window.InputEvent("input");
function ye(t) {
  return `${t}px`;
}
...
function rd(t, e, r) {
  ...
  function l() {
    ...
    var f, v;
    c.isConnected || (v = c, (f = n).insertBefore(v, f.firstChild));
    let b = !1;
    for (let R = 0; R < g.length; R++) {
      const x = g[R], C = i[R] || document.createElement("div"), N = C.style;
      N.position !== "absolute" && (N.position = "absolute", b = !0);
      const I = ye(x.left - p);
      N.left !== I && (N.left = I, b = !0);
      const L = ye(x.top - h);
      N.top !== L && (C.style.top = L, b = !0);
      const B = ye(x.width);
      N.width !== B && (C.style.width = B, b = !0);
      const O = ye(x.height);
      N.height !== O && (C.style.height = O, b = !0), C.parentNode !== c && (c.append(C), b = !0), i[R] = C;
    }
...
function ad(t) {
  for (const e of t) {
    const r = e.style;
    r.background !== "Highlight" && (r.background = "Highlight"), r.color !== "HighlightText" && (r.color = "HighlightText"), r.marginTop !== ye(-1.5) && (r.marginTop = ye(-1.5)), r.paddingTop !== ye(4) && (r.paddingTop = ye(4)), r.paddingBottom !== ye(0) && (r.paddingBottom = ye(0));
  }
}
function od(t, e = ad) {
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(O) {
        const z = O.getStartEndPoints();
        return O.isBackward() ? [z[1], z[0]] : z;
      }(p), f = h.getNode(), v = f.getKey(), b = h.offset, R = g.getNode(), x = R.getKey(), C = g.offset, N = t.getElementByKey(v), I = t.getElementByKey(x), L = r === null || N !== o || b !== n || v !== r.getKey(), B = s === null || I !== i || C !== c || x !== s.getKey();
      if ((L || B) && N !== null && I !== null) {
        const O = function(z, _, q, W, rt, D, it) {
          const S = (z._window ? z._window.document : document).createRange();
          return S.setStart(...en(_, q, W)), S.setEnd(...en(rt, D, it)), S;
        }(t, h, f, N, g, R, I);
        l(), l = rd(t, O, e);
      }
      r = f, o = N, n = b, s = R, i = I, c = C;
    });
  }
...
function id(t) {
  const e = Gn(t, (r) => Dr(r) && !r.isInline());
  return Dr(e) || ta(4, t.__key), e;
}
function sd(t) {
  const e = re() || _c();
  let r;
  if (ke(e)) r = Nc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = qn(c, "next"));
    }
    r = r || Cc(Le(), "previous").getFlipped().insert(Pr());
  }
...
function cd(t, e, r) {
  ...
  return Mc(o) && ta(283), o.insert(t.isInline() ? Pr().append(t) : t), Uo(qn(t.getLatest(), "next"), e.direction);
}
function ld(t) {
  const e = re();
  if (!ke(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(i)) continue;
    const c = Gn(s, (d) => Dr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let ea, Re = 0, ra = 0, ud = 0, ro = 0, Wr = 0;
function an(t) {
  if (st === void 0) return;
  let e = t.n;
...
function Xe(t, e) {
  qt.call(this, void 0), this.x = t, this.s = void 0, this.g = Wr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function pd(t, e) {
  return new Xe(t, e);
}
...
function hd(t) {
  ...
  hi(this), st = t, this.f &= -2, 8 & this.f && No(this), pa();
}
function sr(t, e) {
...
function vr(t, e = {}) {
  const r = {};
  for (const o in t) {
    const n = e[o], s = Mr(n === void 0 ? t[o] : n);
    r[o] = s;
  }
  return r;
}
qt.prototype.brand = dd, qt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Re !== 0 && ra === 0 && e.l !== ro && (e.l = ro, ea = { S: e, v: e.v, i: e.i, o: ea });
    })(this), this.v = t, this.i++, Wr++, Re++;
    try {
...
} }), Xe.prototype = new qt(), Xe.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Wr)) return !0;
  if (this.g = Wr, this.f |= 1, this.i > 0 && !pi(this)) return this.f &= -2, !0;
  const t = st;
  try {
    on(this), st = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, gi(this), on(this), Re++;
  const t = st;
  return st = this, hd.bind(this, t);
...
le({ build: (t, e, r) => vr(e), config: rr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function fi() {
  const t = Le(), e = re(), r = Pr();
  t.clear(), t.append(r), e !== null && r.select(), ke(e) && (e.format = 0);
}
function mi(t, e = fi) {
  return t.registerCommand(Wn, (r) => (t.update(e), !0), bo);
}
le({ build: (t, e, r) => vr(e), config: rr({ $onClear: fi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return _e(() => mi(t, o.value));
} });
function gd(t) {
...
le({ name: "@lexical/extension/DecoratorText", nodes: () => [vi], register: (t, e, r) => t.registerCommand(Yn, (o) => {
  const n = re();
  if (Xn(n) || ke(n)) for (const s of n.getNodes()) fd(s) && s.toggleFormat(o);
  return !1;
}, Jn) });
function bi(t, e) {
  let r;
  return Mr(t(), { unwatched() {
    r && (r(), r = void 0);
  }, watched() {
    this.value = t(), r = e(this);
  } });
}
const ao = le({ build: (t) => bi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Co = 0, oo = 1, yi = 2, Oa = 3, Fr = 4, ir = 5, Ia = 6, _r = 7;
function $a(t) {
  return t.id === Co;
}
function ki(t) {
...
function md(t) {
  return function(e) {
    return e.id === oo;
  }(t) || gt(305, String(t.id), String(oo)), Object.assign(t, { id: yi });
}
...
class bd {
  constructor(e, r) {
    ...
    Ht(this, "state");
    Ht(this, "_signal");
    this.builder = e, this.extension = r, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Co };
  }
  mergeConfigs() {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Fr && gt(307, String(r.id), String(ir)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
    const n = { ...r.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(s, i, c) {
      return Object.assign(s, { id: ir, output: i, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== ir && gt(308, String(o.id), String(ir));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(s) {
      return Object.assign(s, { id: Ia });
    }(o), () => {
      const s = this.state;
      s.id !== _r && gt(309, String(o.id), String(_r)), this.state = function(i) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ia && gt(310, String(r.id), String(Ia)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Fr;
    }(e) || gt(313, String(e.id), String(Fr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Oa;
    }(e) || gt(314, String(e.id), String(Oa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= _r;
    }(e) || gt(316, String(e.id), String(_r)), e;
  }
...
const yd = le({ config: rr({ setOptions: nn, updateOptions: nn }), init: ({ $initialEditorState: t = xd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Ac, Hn, Vc, Lc, Kn] }), sn = Symbol.for("@lexical/extension/LexicalBuilder");
function cn() {
}
function kd(t) {
  throw t;
...
class wr {
  ...
  static maybeFromEditor(e) {
    const r = e[sn];
    return r && (r.PACKAGE_VERSION !== Pa && gt(292, r.PACKAGE_VERSION, Pa), r instanceof wr || gt(293)), r;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(Un({ ...o, ...r ? { onError: (s) => {
      r(s, n);
    } } : {} }), { [sn]: this });
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      $a(s) || gt(300, i, n || "[unknown]"), $a(c = s) || gt(304, String(c.id), String(Co)), s = Object.assign(c, { id: oo }), o.state = s;
    ...
    for (const w of c) {
      ...
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of gd(p)) {
        if (typeof h != "function") {
          ...
          g && gt(302, p.name, h.replace.name, g.extension.name), o.set(h.replace, w);
        }
        r.add(h);
      }
      if (p.html) {
...
const _d = /* @__PURE__ */ new Set(), ln = le({ build(t, e, r) {
  const o = r.getDependency(ao).output, n = Mr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = bi(() => {
  }, () => _e(() => {
...
le({ dependencies: [ao, ln], name: "@lexical/extension/HorizontalRule", nodes: () => [pr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(ln).output, n = Mr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return De(t.registerCommand(Nd, (i) => {
    const c = re();
    if (!ke(c)) return !1;
    ...
    return !0;
  }, bo), t.registerCommand(Fc, (i) => {
    if (Uc(i.target)) {
      const c = Kc(i.target);
      if (Ed(c)) return function(l, d = !1) {
        const w = re(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Xn(w) ? g = w : (g = Hc(), qc(g)), p ? g.delete(h) : g.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  }, Jn), t.registerMutationListener(pr, (i, c) => {
    wd(() => {
      let l = !1;
      ...
      for (const [w, p] of i.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = g : (l = !0, d.set(w, { domNode: Mr(g), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) i.push(_e(() => {
      const d = c.value;
      d && (l.value ? Zn(d, s) : Qc(d, s));
    }));
    return De(...i);
  }));
} });
le({ build: (t, e) => vr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: rr({ $getParentEditor: function() {
  const t = Gc();
...
le({ build: (t, e, r) => vr(e), config: rr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return _e(() => {
...
function Td(t, e, r = _i) {
  return De(t.registerCommand(tl, (o) => {
    const n = re();
    if (!ke(n)) return !1;
    o.preventDefault();
    const s = function(i) {
...
le({ build: (t, e, r) => vr(e), config: rr({ $canIndent: _i, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: s } = r.getOutput();
  return _e(() => {
    if (!o.value) return Td(t, n, s);
  });
} });
const Sd = le({ name: "@lexical/react/ReactProvider" });
function Rd() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ke(f)) {
                const v = f.anchor;
                let b = v.getNode(), R = 0, x = 0;
                if (Xa(b) && d >= 0 && w >= 0 && (R = d, x = d + w, f.setTextNodeRange(b, R, b, x)), R === x && p === "" || (f.insertRawText(p), b = v.getNode()), Xa(b)) {
                  R = h, x = h + g;
                  const C = b.getTextContentSize();
                  R = R > C ? C : R, x = x > C ? C : x, f.setTextNodeRange(b, R, b, x);
                }
...
le({ build: (t, e, r) => vr(e), config: rr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => _e(() => r.getOutput().disabled.value ? void 0 : Ci(t)) });
function Md(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const To = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function Od({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, s] = k(() => r.getDecorators());
    return To(() => r.registerDecoratorListener((i) => {
      ul(() => {
        s(i);
      });
    }), [r]), J(() => {
...
function $d({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    To(() => De(wl(n), Ci(n)), [n]);
  }(o), u(ct, { children: [t, a(Pd, { content: e }), a(Id, { editor: o, ErrorBoundary: r })] });
}
...
const Vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function Ld({ onClear: t }) {
  const [e] = Ee();
  return Vd(() => mi(e, t), [e, t]), null;
}
const Ei = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function jd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: v, role: b = "textbox", spellCheck: R = !0, style: x, tabIndex: C, "data-testid": N, ...I }, L) {
  const [B, O] = k(t.isEditable()), z = A((q) => {
    q && q.ownerDocument && q.ownerDocument.defaultView ? t.setRootElement(q) : t.setRootElement(null);
  }, [t]), _ = $(() => /* @__PURE__ */ function(...q) {
    return (W) => {
      for (const rt of q) typeof rt == "function" ? rt(W) : rt != null && (rt.current = W);
    };
  }(L, z), [z, L]);
  return Ei(() => (O(t.isEditable()), t.registerEditableListener((q) => {
    O(q);
  })), [t]), a("div", { "aria-activedescendant": B ? e : void 0, "aria-autocomplete": B ? r : "none", "aria-controls": B ? o : void 0, "aria-describedby": n, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": B && b === "combobox" ? !!i : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": B ? p : void 0, "aria-readonly": !B || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: B, "data-testid": N, id: v, ref: _, role: b, spellCheck: R, style: x, tabIndex: C, ...I });
}
const Bd = jn(jd);
function wn(t) {
  return t.getEditorState().read(Ni(t.isComposing()));
...
function qd({
  ...
  return /* @__PURE__ */ a(Ti.Provider, { value: i, children: s });
}
function Si() {
  const t = la(Ti);
  if (!t)
...
function Wd({
  ...
  const [e] = Ee(), [r, o] = k(e), [n, s] = k("paragraph"), [i, c] = Gd(), l = () => {
  };
...
const un = [
  ...
  { format: "italic", icon: Ns, label: "Italic" }
...
function Xd() {
  const { activeEditor: t } = Si(), [e, r] = k([]), o = A((n) => {
    if (ke(n) || hl(n)) {
      const s = [];
      un.forEach(({ format: i }) => {
...
function Mi({
  ...
  return /* @__PURE__ */ u(lo, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
...
function zp({
  ...
  const [s, i] = k(aw), [c, l] = k(n), [d, w] = k(!1), p = F(void 0), h = F(null);
  J(() => {
    let b = !0;
    const R = h.current;
    if (!R) return;
  ...
  const g = A(() => {
    ...
    const b = oa(s);
    e(b, c);
  }, [s, e, c]), f = o["%commentEditor_placeholder%"] ?? "Type your comment here...", v = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(je, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Be,
        {
          ...
          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ue, { children: t.map((b) => /* @__PURE__ */ a(
            Me,
            {
              onSelect: () => {
                l(b || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : Ro(b) && (b.preventDefault(), b.stopPropagation(), ie(s) && g());
        },
        onKeyDown: (b) => {
          So(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          aa,
          {
...
function hn({
  ...
  const [w, p] = k(), h = l ?? w, g = h !== void 0, f = d !== void 0, v = A(
    (_) => {
      f || p(_), d == null || d(_);
    },
    [f, d]
  ...
  const R = A(
    (_) => {
      _ && _.stopPropagation(), v(void 0), i == null || i(!1);
    },
    [i, v]
  ), x = A(
    async (_) => {
      if (_ && _.stopPropagation(), !h || !n) return;
      await n(
        t.id,
        oa(h)
      ) && (v(void 0), i == null || i(!1));
    ...
    const _ = new Date(t.date), q = tc(
      _,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), W = _.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), N = $(() => t.user, [t.user]), I = $(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), L = $(() => mo(t.contents), [t.contents]), B = $(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), O = !!t.conflictResolutionAction && !B, z = $(() => {
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          Ze,
          {
            onClick: (_) => {
              _.stopPropagation(), v(tw(t.contents)), i == null || i(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u(
          Ze,
          {
            ...
            children: [
              /* @__PURE__ */ a(Ao, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(sw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(cw, { className: "tw:text-xs tw:font-medium", children: I }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            /* @__PURE__ */ a("p", { className: "tw:text-sm tw:font-medium", children: N }),
            /* @__PURE__ */ a("p", { className: "tw:text-xs tw:font-normal tw:text-muted-foreground", children: C }),
          ...
          g && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: b,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), R()) : Ro(_) && (_.preventDefault(), _.stopPropagation(), ie(h) && x());
              },
              onKeyDown: (_) => {
              ...
              children: /* @__PURE__ */ a(
                aa,
                {
                  ...
                  onSerializedChange: (_) => v(_),
                  actions: /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ a("div", { className: "tw:flex-1" }),
                    /* @__PURE__ */ u(Ct, { children: [
                      ...
                      /* @__PURE__ */ a(Tt, { children: r["%comment_aria_cancel_edit%"] ?? "Cancel edit" })
                    ] }),
                    /* @__PURE__ */ u(Ct, { children: [
                      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:inline-flex", children: /* @__PURE__ */ a(
                        tt,
                        {
                          size: "icon-sm",
                          onClick: x,
                      ...
                      /* @__PURE__ */ a(Tt, { children: r["%comment_aria_save_edit%"] ?? "Save edit" })
                    ] })
                  ] })
                }
              )
        ...
        z && /* @__PURE__ */ u(Ke, { children: [
          /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Es, {}) }) }),
          /* @__PURE__ */ a(qe, { align: "end", children: z })
        ] })
      ]
    }
  );
...
function Ai({
  ...
  var Ot;
  const [D, it] = k({}), S = W ?? D, Y = S.editorState ?? lw, G = S.assignedUser, U = rt !== void 0, Q = A(
    (T) => {
      const vt = { ...S, ...T };
      U || it(vt), rt == null || rt(l, rw(vt) ? void 0 : vt);
    },
    [U, S, rt, l]
  ), wt = A(
    (T, vt) => {
      const ht = { ...S.commentEdits };
      vt === void 0 ? delete ht[T] : ht[T] = vt, Q({
        commentEdits: no(ht) ? ht : void 0
      });
    },
    [S.commentEdits, Q]
  ), [St, Z] = k(), ut = o, [ft, bt] = k(!1), [yt, _t] = k(!1), Nt = yt || no(S.commentEdits), [Yt, Xt] = k(!1), [Dt, ae] = k(!1), [mt, se] = k(!1), [Mt, Jt] = k(N), [oe, Ut] = k(!1), ge = F(void 0), [de, fe] = k(/* @__PURE__ */ new Map());
  J(() => {
    let T = !0;
    return (async () => {
      const ht = x ? await x(l) : !1;
      T && se(ht);
    })(), () => {
      T = !1;
    };
    ...
    let T = !0;
    if (!o) {
      ae(!1), fe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const ht = R ? await R(l) : !1;
      T && ae(ht);
    })(), () => {
      T = !1;
    };
  ...
  J(() => {
    if (!o) {
      Kt.current !== "idle" && (Q({ assignedUser: void 0 }), Z(void 0), Kt.current = "idle");
      return;
    }
    Kt.current === "idle" && (Kt.current = "pending"), Dt ? Kt.current === "pending" && B !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    B !== s && (Q({ assignedUser: B }), Kt.current = "auto-populated") : Kt.current === "auto-populated" && (Q({ assignedUser: void 0 }), Kt.current = "pending");
  }, [o, B, Dt, s, Q]);
  const M = $(
    () => O ?? e.filter((T) => !T.deleted),
    [O, e]
  );
  J(() => {
    let T = !0;
  ...
  const Pt = $(() => M[0], [M]), we = F(null), ce = F(void 0), At = A(() => {
    var T;
    (T = ce.current) == null || T.call(ce), Q({ editorState: void 0 });
  }, [Q]), ne = A(
    (T) => {
      Q({ editorState: ie(T) ? T : void 0 });
    },
    [Q]
  ), me = A(() => {
    const T = !Mt;
    Jt(T), Ut(!T), f == null || f(l, T);
  }, [Mt, f, l]);
  J(() => {
    bt(!1);
  }, [o]), J(() => {
    if (o && !Mt && !oe) {
      ...
      return ge.current = T, () => clearTimeout(T);
    }
  ...
  }, [s, r]), V = $(() => M.slice(1), [M]), K = $(() => V.length ?? 0, [V.length]), H = $(() => K > 0, [K]), X = $(() => ft || K <= 2 ? V : V.slice(-2), [V, K, ft]), j = $(() => ft || K <= 2 ? 0 : K - 2, [K, ft]), ot = $(
    () => K === 1 ? Zt.singleReply : Pe(Zt.multipleReplies, { count: K }),
    [K, Zt]
  ), lt = $(
    () => j === 1 ? Zt.singleReply : Pe(Zt.multipleReplies, { count: j }),
    [j, Zt]
  );
  J(() => {
    !o && Nt && H && _t(!1);
  ...
  const dt = A(
    async (T) => {
      ...
      vt && await p({ threadId: l, contents: vt }) && At();
    },
    [
      At,
      Y,
    ...
    async (T) => {
      const vt = ie(Y) ? oa(Y) : void 0, ht = T.status ? T.assignedUser : G ?? T.assignedUser, Qt = await p({
        ...T,
        contents: vt,
        assignedUser: ht
      });
      return Qt && (ht !== void 0 && Z(ht), vt && At()), Qt;
    },
    [At, Y, p, G]
  );
  ...
  const Rt = /* @__PURE__ */ a(
    hn,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: kt,
      handleUpdateComment: h,
      handleDeleteComment: g,
      onEditingChange: _t,
      canEditOrDelete: (!Nt && de.get(Pt.id)) ?? !1,
      canUserResolveThread: mt,
      draftEditorState: (Ot = S.commentEdits) == null ? void 0 : Ot[Pt.id],
      onDraftEditorStateChange: (T) => wt(Pt.id, T)
    }
  );
  return /* @__PURE__ */ a(
    nw,
    {
      ...
      className: m(
        ...
        {
          "tw:bg-card": w !== "Resolved" && Mt,
          "tw:bg-muted": w === "Resolved",
          "tw:bg-accent": !Mt && w !== "Resolved"
        }
      ),
      onClick: () => {
        c(l);
      ...
      children: /* @__PURE__ */ u(iw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-2", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            E && /* @__PURE__ */ a(Rr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: E }),
            /* @__PURE__ */ a(
              tt,
              {
                variant: "ghost",
                ...
                children: Mt ? /* @__PURE__ */ a(Ts, {}) : /* @__PURE__ */ a(Ss, {})
              }
            ),
            _ === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: mt && w !== "Resolved",
                  onClick: () => kt({ threadId: l, status: "Resolved" }),
          ...
          /* @__PURE__ */ a("div", { className: "tw:flex tw:max-w-full tw:flex-wrap tw:items-baseline tw:gap-2", children: /* @__PURE__ */ u(
            "p",
            {
              ...
              className: m(
                ...
                {
                  "tw:overflow-visible tw:text-clip tw:whitespace-normal tw:break-words": ut
                },
                { "tw:whitespace-nowrap": !ut }
              ),
              children: [
                n && L ? /* @__PURE__ */ a(
                  tt,
        ...
        /* @__PURE__ */ u(ct, { children: [
          ...
          !o && ie(Y) && /* @__PURE__ */ a(
            aa,
            {
              ...
              onSerializedChange: ne,
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(ct, { children: [
            q && X.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            j > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (T) => {
                  (T.key === "Enter" || T.key === " ") && (T.preventDefault(), T.stopPropagation(), bt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(zr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: lt }),
                    ft ? /* @__PURE__ */ a(Rs, {}) : /* @__PURE__ */ a(ur, {})
                  ] })
                ]
              }
            ),
            X.map((T) => {
              ...
              return /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                hn,
                {
                  ...
                  handleDeleteComment: g,
                  onEditingChange: _t,
                  canEditOrDelete: (!Nt && de.get(T.id)) ?? !1,
                  draftEditorState: (vt = S.commentEdits) == null ? void 0 : vt[T.id],
                  onDraftEditorStateChange: (ht) => wt(T.id, ht)
                }
              ) }, T.id);
            }),
            b !== !1 && (!Nt || ie(Y)) && /* @__PURE__ */ a(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (T) => {
                  Ro(T) && (T.preventDefault(), T.stopPropagation(), (ie(Y) || G !== void 0 && G !== St) && dt());
                },
                onKeyDown: (T) => {
                ...
                children: /* @__PURE__ */ a(
                  aa,
                  {
                    ...
                    actions: /* @__PURE__ */ u(ct, { children: [
                      G !== void 0 && (ie(Y) || G !== St) ? /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Pe(
                      ...
                      /* @__PURE__ */ u(je, { open: Yt, onOpenChange: Xt, children: [
                        /* @__PURE__ */ u(Ct, { children: [
                          /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(tr, { asChild: !0, children: /* @__PURE__ */ a(
                            tt,
                            {
                              size: "icon-sm",
                              variant: "outline",
                              className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                              disabled: !Dt || !v || v.length === 0 || !v.includes(i),
                              "aria-label": r["%comment_aria_assign_user%"] ?? "Assign user",
                              children: /* @__PURE__ */ a(On, {})
                            }
                          ) }) }),
                          /* @__PURE__ */ a(Tt, { children: r["%comment_aria_assign_user%"] ?? "Assign user" })
                        ] }),
                        /* @__PURE__ */ a(
                          Be,
                          {
                            ...
                            children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ue, { children: v == null ? void 0 : v.map((T) => /* @__PURE__ */ a(
                              Me,
                              {
                                onSelect: () => {
                                  Q({
                                    assignedUser: T !== s ? T : void 0
                                  }), Kt.current = "user-selected", Z(void 0), Xt(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: Yr(T, r) })
                              },
                              T || "unassigned"
                            )) }) })
                          }
                      ...
                      /* @__PURE__ */ u(Ct, { children: [
                        /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:inline-flex", children: /* @__PURE__ */ a(
                          tt,
                          {
                            ...
                            onClick: dt,
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !ie(Y) && (G === void 0 || G === St),
                            "aria-label": r["%comment_aria_submit_comment%"] ?? "Submit comment",
                            children: /* @__PURE__ */ a(In, {})
                          }
                        ) }) }),
                        /* @__PURE__ */ a(Tt, { children: r["%comment_aria_submit_comment%"] ?? "Submit comment" })
                      ] })
                    ] })
                  }
                )
...
), ww = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Xr = (t) => ww(mo(t));
function Jr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function uw({
  ...
  const [i, c] = k("accept"), l = Fo(), d = Fo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : i, v = $(
    () => Xr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = $(
    () => Xr(t.acceptedText ?? ""),
    ...
    () => Xr(t.mergedText ?? ""),
    [t.mergedText]
  ), x = $(() => mo(t.contents), [t.contents]);
  if (!Ii(t))
    return /* @__PURE__ */ a(Jr, { html: x });
  const C = (S) => {
    c(S === "reject" || S === "merge" ? S : "accept");
  }, N = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", I = g ? [
    {
      value: "merge",
  ...
  const _ = e["%conflict_note_no_result%"] ?? "No result preview available.", q = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: _ }), W = (S) => S ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: S }) : q, rt = () => {
    const S = o ?? "accept";
    return S === "merged" ? t.mergedText ? /* @__PURE__ */ a(Jr, { html: R }) : q : W(S === "reject" ? t.rejectedResultText : t.resultText);
  }, D = (S) => p && S.value === "reject", it = (S) => {
    const Y = f === S.value, G = `${d}-${S.value}`, U = D(S);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          className: m(
            ...
            Y ? "tw:border-border tw:bg-accent/50" : "tw:border-transparent tw:hover:bg-accent/30",
      ...
      !w && !h && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          co,
          {
            ...
            children: L.map((S) => D(S) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Ct, { children: [
              /* @__PURE__ */ a(Et, { asChild: !0, children: it(S) }),
              /* @__PURE__ */ a(Tt, { children: N })
            ] }) }, S.value) : it(S))
          }
        ),
        /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Ct, { children: [
...
function fw({
  ...
  const [s, i] = k("loading"), [c, l] = k(!1), [d, w] = k(), p = n == null ? void 0 : n.getOptions, h = n == null ? void 0 : n.resolve;
  J(() => {
    let x = !0;
    if (!r) {
      i("loading");
...
function Lp({
  ...
  const [N, I] = k(/* @__PURE__ */ new Set()), [L, B] = k(), [O, z] = k(), _ = A(
    async (U) => {
      const Q = await s(U);
      return Q !== void 0 && U.assignedUser !== void 0 && U.assignedUser !== "" && z(U.assignedUser), Q;
    },
    [s]
  );
  J(() => {
    f && (I((U) => new Set(U).add(f)), B(f));
  }, [f]);
  const q = r.filter(
    (U) => U.comments.some((Q) => !Q.deleted)
  ), W = q.map((U) => ({ id: U.id })), rt = A(
    (U) => {
      I((Q) => new Set(Q).add(U.id)), B(U.id), v == null || v(U.id);
    },
    [v]
  ), D = A(
    (U) => {
      ...
      I((wt) => {
        const St = new Set(wt);
        return St.has(U) ? St.delete(U) : St.add(U), St;
      }), B(U), v == null || v(Q ? void 0 : U);
    },
    [N, v]
  ), { listboxRef: it, activeId: S, handleKeyDown: Y } = rs({
    options: W,
    onOptionSelect: rt
  }), G = A(
    (U) => {
      U.key === "Escape" ? (L && N.has(L) && (I((Q) => {
        const wt = new Set(Q);
        return wt.delete(L), wt;
      }), B(void 0), v == null || v(void 0)), U.preventDefault(), U.stopPropagation()) : Y(U);
    },
    [L, N, Y, v]
  );
  return /* @__PURE__ */ a(
      ...
      children: q.map((U) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: U.type === "Conflict" ? /* @__PURE__ */ a(mw, { ...Q, conflictResolution: R }) : /* @__PURE__ */ a(Ai, { ...Q })
          },
          U.id
        );
      })
...
function vw({ table: t }) {
  return /* @__PURE__ */ u(Ke, { children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(tt, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function fr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Wt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Wt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Bn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ue({
  ...
  return /* @__PURE__ */ u(
    Wt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Wt.ItemIndicator, { children: /* @__PURE__ */ a(wa, { className: "tw:pointer-events-none" }) }) }),
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ u(
        hr,
        {
          ...
          children: [
            /* @__PURE__ */ a(fr, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(gr, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(mr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ue, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function _w({
  ...
  var L;
  const [w, p] = k([]), [h, g] = k([]), [f, v] = k({}), [b, R] = k({}), x = $(() => e ?? [], [e]), C = ei({
    data: x,
    columns: t,
    getCoreRowModel: ai(),
  ...
  let I;
  return l ? I = Array.from({ length: 10 }).map((z, _) => `skeleton-row-${_}`).map((z) => /* @__PURE__ */ a($e, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(lr, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(cr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((L = C.getRowModel().rows) == null ? void 0 : L.length) > 0 ? I = C.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    $e,
    {
      onClick: () => i(B, C),
      "data-state": B.getIsSelected() && "selected",
      children: B.getVisibleCells().map((O) => /* @__PURE__ */ a(lr, { children: Er(O.column.columnDef.cell, O.getContext()) }, O.id))
    },
    B.id
  )) : I = /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(lr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(vw, { table: C }),
    /* @__PURE__ */ u(uo, { stickyHeader: s, children: [
      /* @__PURE__ */ a(po, { stickyHeader: s, children: C.getHeaderGroups().map((B) => /* @__PURE__ */ a($e, { children: B.headers.map((O) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: O.isPlaceholder ? void 0 : Er(O.column.columnDef.header, O.getContext()) }, O.id)) }, B.id)) }),
      /* @__PURE__ */ a(ho, { children: I })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(tt, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ a($n, {}) })
        ] }),
...
function Hp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ke, { children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(tt, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(qe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(En, { children: d.itemType === 0 ? /* @__PURE__ */ a(ct, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ae,
        {
          checked: o[w][h],
        ...
        as,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(os, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Qe, {})
    ] }, d.label)) })
      ...
      return /* @__PURE__ */ u(Rr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          tt,
          {
            ...
            children: /* @__PURE__ */ a(Mn, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function Rw({
  ...
  return /* @__PURE__ */ u(lo, { children: [
    ...
    e && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
        tt,
        {
          "aria-label": w,
...
function Mw({
  ...
  const n = F(null), s = F(null), i = F(!1), [c, l] = k(t), [d, w] = k(e), [p, h] = k(!1), g = F(!1), f = F(c);
  f.current = c;
  const v = F(d);
  v.current = d, J(() => {
    l(t);
  ...
  const b = (x) => {
    if (i.current = !1, h(x), !x) {
      const C = f.current, N = v.current;
      C !== "custom" || N ? (C !== t || N !== e) && r(C, N) : (l(t), w(e));
    }
  }, R = (x) => {
    var C, N, I, L;
    x.stopPropagation(), document.activeElement === s.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), i.current = !0) : document.activeElement === n.current && x.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), i.current = !1) : document.activeElement === n.current && x.key === "ArrowLeft" && ((I = n.current) == null ? void 0 : I.selectionStart) === 0 && ((L = s.current) == null || L.focus(), i.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && b(!1);
  };
  return /* @__PURE__ */ u(Ke, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: Dw(t, o, e) }) }) }),
...
const Ow = (t, e) => t === "f" ? /* @__PURE__ */ u(ct, { children: [
  /* @__PURE__ */ a(An, {}),
  " ",
...
function $w({
  ...
  return /* @__PURE__ */ u(Ke, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: Ow(t, r) }) }) }),
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: Iw(t, r) }) })
    ] }) }),
  ...
  return /* @__PURE__ */ u(
    Me,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(ss, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function Lw({
  ...
  return /* @__PURE__ */ u(Fe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ue, { children: [
      ...
      /* @__PURE__ */ a(ze, { children: i.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          mn,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(ze, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            mn,
            {
...
function Yp({
  ...
  var Zt;
  const h = F(null), g = F(null), f = F(null), v = F(null);
  ee(() => {
    if (!v.current) return;
    const { width: E } = v.current.getBoundingClientRect();
    E > 0 && (v.current.style.width = `${E}px`);
  }, []);
  const [b, R] = k("generated"), [x, C] = k("generated"), [N, I] = k("*"), [L, B] = k("*"), [O, z] = k("f"), [_, q] = k(!1), [W, rt] = k(!0), [D, it] = k(!1), S = F(!1), Y = F(""), [G, U] = k(!1), [Q, wt] = k(), [St, Z] = k(), [ut, ft] = k(), [bt, yt] = k(), _t = F(null), Nt = F(
    void 0
  ), Yt = F(0), Xt = F(void 0), Dt = $(
    () => ({
      ...i,
  ...
  J(() => {
    var E;
    G || (E = h.current) == null || E.focus();
  }, [O, G]);
  const mt = A(() => {
    var H, X, j;
    const E = (H = g.current) == null ? void 0 : H.querySelector(".editor-input"), V = E == null ? void 0 : E.querySelector("span.note"), K = (j = (X = g.current) == null ? void 0 : X.ownerDocument.getSelection()) == null ? void 0 : j.anchorNode;
    return !!V && !!K && V.contains(K);
  }, []);
  J(() => {
    var X, j;
    let E, V, K;
    S.current = !1, Xt.current = void 0, rt(!0);
    const H = e == null ? void 0 : e.at(0);
    if (H && kr("note", H)) {
      const ot = (X = H.insert.note) == null ? void 0 : X.caller;
      let lt = "custom";
      ot === Ja ? lt = "generated" : ot === Za ? lt = "hidden" : ot && (I(ot), B(ot)), R(lt), C(lt), z(((j = H.insert.note) == null ? void 0 : j.style) ?? "f"), E = setTimeout(() => {
        var dt, kt, Rt;
        (dt = h.current) == null || dt.applyUpdate([H]), (kt = h.current) == null || kt.selectNote(0), (Rt = h.current) == null || Rt.focus(), V = requestAnimationFrame(() => {
          K = setTimeout(() => {
            var Ot, T;
            mt() || ((Ot = h.current) == null || Ot.selectNote(0), (T = h.current) == null || T.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      E && clearTimeout(E), V !== void 0 && cancelAnimationFrame(V), K !== void 0 && clearTimeout(K);
    };
  }, [e, s, mt]);
  const se = A(
    (E = !1) => {
      var K, H, X;
      p == null || p();
      const V = (H = (K = h.current) == null ? void 0 : K.getNoteOps(0)) == null ? void 0 : H.at(0);
      V && kr("note", V) && (r == null || r([V]), E && d && s && ((X = d.current) == null || X.replaceEmbedUpdate(s, [V])));
    },
    [s, r, p, d]
  ), Mt = A(
    (E, V) => {
      var X, j, ot;
      const K = (j = (X = h.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : j.at(0);
      if (!K || !kr("note", K) || !K.insert.note) return;
      let H;
      E === "custom" ? H = V : E === "generated" ? H = Ja : H = Za, K.insert.note.caller !== H && (K.insert.note.caller = H, (ot = h.current) == null || ot.applyUpdate([K, { delete: 1 }]));
    },
    []
  ), Jt = A(() => {
    var E;
    Nt.current || (E = h.current) == null || E.commitPendingMarkerEdits(), se(!0), o();
  }, [o, se]), oe = F(Jt);
  ee(() => {
    oe.current = Jt;
  });
  const Ut = F({ book: n.book, chapterNum: n.chapterNum });
  ee(() => {
    (Ut.current.book !== n.book || Ut.current.chapterNum !== n.chapterNum) && (Ut.current = { book: n.book, chapterNum: n.chapterNum }, oe.current());
  }, [n.book, n.chapterNum]);
  const ge = () => {
    var V;
    const E = (V = g.current) == null ? void 0 : V.getElementsByClassName("editor-input")[0];
    E != null && E.textContent && navigator.clipboard.writeText(E.textContent);
  }, de = A(
    (E, V) => {
      p == null || p(), R(E), I(V), Mt(E, V);
    },
    [Mt, p]
  ), fe = (E) => {
    var K, H, X, j, ot;
    ...
    if (V && kr("note", V)) {
      ...
      const lt = (j = (X = V.insert.note) == null ? void 0 : X.contents) == null ? void 0 : j.ops;
      O !== "x" && E === "x" ? lt == null || lt.forEach((dt) => Fw(dt)) : O === "x" && E !== "x" && (lt == null || lt.forEach((dt) => Uw(dt))), (ot = h.current) == null || ot.applyUpdate([V, { delete: 1 }]);
    }
  }, Kt = (E) => {
    yt(E.contextMarker), it(E.canRedo);
  }, M = A(
    (E) => {
      var K, H, X, j, ot;
      const V = (H = (K = h.current) == null ? void 0 : K.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (V && kr("note", V)) {
        ...
        const lt = (X = V.insert.note) == null ? void 0 : X.style, dt = (ot = (j = V.insert.note) == null ? void 0 : j.contents) == null ? void 0 : ot.ops;
        if (lt || q(!1), q(
          lt === "x" ? !!(dt != null && dt.every((kt) => {
            var Ot, T;
            if (!((Ot = kt.attributes) != null && Ot.char)) return !0;
            const Rt = ((T = kt.attributes) == null ? void 0 : T.char).style;
          ...
          S.current = !0, Y.current = JSON.stringify(V), rt(!0);
          return;
        }
        rt(JSON.stringify(V) === Y.current), se();
      } else
        q(!1), rt(!0);
    },
    [se]
    ...
    if (f.current && ae.length && E && E.rangeCount > 0) {
      const V = E.getRangeAt(0).getBoundingClientRect(), K = f.current.getBoundingClientRect();
      wt(V.left - K.left), Z(V.top - K.top), ft(V.height), U(!0);
    }
  }, [ae, f]), we = F(() => {
  }), ce = A(
    (E, V, K) => {
      const { anchorRect: H } = E;
      if (!w || !H) return;
      const { passive: X } = K;
      cs({
        items: V,
        ...
        clearSessionIfCurrent: (j) => Mo(Nt, j),
        ...
        restoreSelectionIfLost: () => {
          ...
          if (!((j = h.current) != null && j.getSelection())) {
            const dt = Xt.current;
            dt ? (ot = h.current) == null || ot.setSelection(dt) : (lt = h.current) == null || lt.selectNote(0);
          }
        },
        focusEditor: () => {
          var j;
        ...
        applyItem: (j) => {
          var ot;
          return (ot = h.current) == null ? void 0 : ot.applyMarkerMenuSelection(j, {
            trigger: "backslash",
        ...
        onShowError: (j) => {
          (!ac(j) || j.code !== oc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${nc(j)}`
          );
        }
      });
    },
    ...
    var K;
    const E = (K = h.current) == null ? void 0 : K.getMarkerMenuContext();
    if (!E) return !1;
    const V = _l(Dt.styleInfo ?? Nl, E);
    return V.length === 0 ? !1 : (ce(E, V, { passive: !E.hasTextSelection }), !0);
  }, [ce, Dt.styleInfo]), ne = A(
    (E) => {
      const V = Nt.current;
      if (!V || !w) return;
      ls(E, V, {
        ...
        commitTyped: (H) => {
          var X;
          return (X = h.current) == null ? void 0 : X.commitTypedMarker(H);
        },
        commitTypedAndReopen: (H) => {
          var X;
          (X = h.current) == null || X.commitTypedMarker(H, { trailingSpace: !1 }), At();
        },
        commitTypedCloser: (H) => {
          var X;
          return (X = h.current) == null ? void 0 : X.commitTypedCloser(H);
        },
        commitItem: (H) => {
          var j;
          const X = V.items.find((ot) => ot.marker === H);
          X && ((j = h.current) == null || j.applyMarkerMenuSelection(X, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  J(() => {
    ...
    const E = (V) => {
      var X, j;
      const K = (X = g.current) == null ? void 0 : X.querySelector(".editor-input");
      if (!K || V.target !== K) return;
    ...
    var E;
    G && ((E = _t.current) == null || E.focus());
  }, [G]), J(() => {
    var K;
    const E = () => {
      var H;
      return ((H = g.current) == null ? void 0 : H.querySelector(".editor-input")) ?? void 0;
    };
    if (((K = Dt.view) == null ? void 0 : K.markerMode) === "editable") {
      const H = (j) => {
        var dt, kt, Rt, Ot;
        if (ws(j)) return;
        const ot = E();
        ...
        if (j.key === "Enter" && !mt()) {
          j.preventDefault(), j.stopPropagation(), (dt = h.current) == null || dt.selectNote(0), (kt = h.current) == null || kt.focus();
          return;
        }
        if (w && j.key === c) {
          if (!mt()) {
            j.preventDefault(), j.stopPropagation(), (Rt = h.current) == null || Rt.selectNote(0), (Ot = h.current) == null || Ot.focus();
            return;
          }
          At() && (j.preventDefault(), j.stopPropagation());
        }
      }, X = () => {
        var ot, lt;
        const j = E();
        !j || document.activeElement !== j || mt() || ((ot = h.current) == null || ot.selectNote(0), (lt = h.current) == null || lt.focus());
      };
      return document.addEventListener("keydown", H, { capture: !0 }), document.addEventListener("paste", X, { capture: !0 }), () => {
        document.removeEventListener("keydown", H, { capture: !0 }), document.removeEventListener("paste", X, { capture: !0 });
      };
    }
    const V = (H) => {
      const X = E();
      !G && X && document.activeElement === X && H.key === c ? (H.preventDefault(), Pt()) : G && H.key === "Escape" && (H.preventDefault(), U(!1));
    };
    ...
    Pt,
    c,
    (Zt = Dt.view) == null ? void 0 : Zt.markerMode,
    Dt.styleInfo,
    w,
    At,
    mt
    ...
    const E = () => {
      var H, X, j;
      const V = ((H = g.current) == null ? void 0 : H.querySelector(".editor-input")) ?? void 0;
      if (!V || document.activeElement !== V) return;
      const K = document.getSelection();
      K && !K.isCollapsed || mt() || ((X = h.current) == null || X.selectNote(0), (j = h.current) == null || j.focus());
    };
    return document.addEventListener("pointerup", E), document.addEventListener("selectionchange", E), () => {
      document.removeEventListener("pointerup", E), document.removeEventListener("selectionchange", E);
    };
  }, [mt]);
  const me = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(ct, { children: [
    /* @__PURE__ */ u("div", { ref: v, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(lo, { children: [
          /* @__PURE__ */ a(
            Rw,
            {
              onUndoClick: () => {
                var E;
                return (E = h.current) == null ? void 0 : E.undo();
              },
              onRedoClick: () => {
                var E;
                return (E = h.current) == null ? void 0 : E.redo();
              },
              canUndo: !W,
              canRedo: D,
              localizedStrings: l
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
              /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
                tt,
                {
                  "aria-label": me,
              ...
              /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: me }) })
            ] }) }) })
          ]
        }
      )
...
function Gw({
  ...
  /* @__PURE__ */ a("span", { className: m("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    t.category,
    o && /* @__PURE__ */ a("span", { className: "marker", children: "\\cat*" })
  ] }), h = i && /* @__PURE__ */ u(ct, { children: [
    zo(t.marker, [i], o, !1),
    " "
  ] }), g = !!l, f = !!w, v = !!p, b = e === "horizontal" ? "horizontal" : "vertical", R = o ? "marker-visible" : "", x = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = m(b, R);
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: Hw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Jp({
  ...
  const p = d ?? ic(r, void 0), h = (N, I) => {
    w == null || w(N, I, n);
  }, g = s ? r.findIndex((N) => N === s) : -1, [f, v] = k(g), b = (N, I, L) => {
    if (r.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), w == null || w(I, L, n);
          break;
      }
  }, R = (N) => {
    if (r.length)
      switch (N.key) {
        case "ArrowDown":
          N.preventDefault(), v((I) => Math.min(I + 1, r.length - 1));
          break;
        case "ArrowUp":
          N.preventDefault(), v((I) => Math.max(I - 1, 0));
          break;
      }
  }, x = F([]);
  J(() => {
  ...
  return J(() => {
    var N;
    C < 0 || C >= x.current.length || (N = x.current[C]) == null || N.scrollIntoView({ block: "nearest" });
  }, [C, i]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Gw,
                      {
                        footnote: N,
                        layout: o,
                        formatCaller: () => p(N.caller, I),
                        showMarkers: c
                      }
                    )
                  }
                ),
                I < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(zr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, B)
            );
          })
        }
    ...
    /* @__PURE__ */ a(ho, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      $e,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { className: o, children: Ww(c.text) })
        ]
      },
...
}, ha = (t, e, r) => /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
  /* @__PURE__ */ u(
    Et,
    {
...
function nh({
  ...
  const g = be(r, "%webView_inventory_all%"), f = be(r, "%webView_inventory_approved%"), v = be(r, "%webView_inventory_unapproved%"), b = be(r, "%webView_inventory_unknown%"), R = be(r, "%webView_inventory_scope_currentBook%"), x = be(r, "%webView_inventory_scope_chapter%"), C = be(r, "%webView_inventory_scope_verse%"), N = be(r, "%webView_inventory_filter_text%"), I = be(
    r,
    "%webView_inventory_show_additional_items%"
  ), L = be(r, "%webView_inventory_no_results%"), [B, O] = k(!1), [z, _] = k("all"), [q, W] = k(""), [rt, D] = k([]), it = $(() => {
    const Z = t ?? [];
    return Z.length === 0 ? [] : tu(Z, n, s);
  }, [t, n, s]), S = $(() => {
    if (B) return it;
    const Z = [];
    return it.forEach((ut) => {
      const ft = ut.items[0], bt = Z.find(
        (yt) => yt.items[0] === ft
      );
      bt ? (bt.count += ut.count, bt.occurrences = bt.occurrences.concat(ut.occurrences)) : Z.push({
        items: [ft],
        count: ut.count,
  ...
  }, [B, it]), Y = $(() => S.length === 0 ? [] : Qw(S, z, q), [S, z, q]), G = $(() => {
    var ft, bt;
    if (!B) return l;
    ...
    for (let yt = 0; yt < Z; yt++)
      ut.push(
        Jw(
          ((bt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : bt[yt]) || "Additional Item",
          yt + 1
        )
      );
    return [...ut, ...l];
  ...
  J(() => {
    Y.length === 0 ? D([]) : Y.length === 1 && D(Y[0].items);
  }, [Y]);
  const U = (Z, ut) => {
    ut.setRowSelection(() => {
      const bt = {};
      return bt[Z.index] = !0, bt;
    });
    ...
    if (S.length === 0 || rt.length === 0) return [];
    const Z = S.filter((ut) => sc(
      B ? ut.items : [ut.items[0]],
      rt
    ));
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        hr,
        {
          ...
          defaultValue: z,
          children: [
            /* @__PURE__ */ a(fr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(gr, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(mr, { children: [
              /* @__PURE__ */ a(ue, { value: "all", children: g }),
              /* @__PURE__ */ a(ue, { value: "approved", children: f }),
              /* @__PURE__ */ a(ue, { value: "unapproved", children: v }),
              /* @__PURE__ */ a(ue, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(hr, { onValueChange: (Z) => Q(Z), defaultValue: i, children: [
        /* @__PURE__ */ a(fr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(gr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(mr, { children: [
          /* @__PURE__ */ a(ue, { value: "book", children: R }),
          /* @__PURE__ */ a(ue, { value: "chapter", children: x }),
      ...
      o && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
        /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a($t, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? I })
        ] }) }),
        /* @__PURE__ */ a(Tt, { children: (o == null ? void 0 : o.checkboxText) ?? I })
      ] }) })
    ] }),
...
const eu = "16rem", ru = "3rem", Li = Gt.createContext(void 0);
function ga() {
  const t = Gt.useContext(Li);
  if (!t)
...
function au({
  ...
  const [l, d] = Gt.useState(t), w = e ?? l, p = Gt.useCallback(
    ...
    [r, w]
  ), h = Gt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", b = Ne() === "ltr" ? i : i === "primary" ? "secondary" : "primary", R = Gt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Li.Provider, { value: R, children: /* @__PURE__ */ a(
    "div",
    {
...
function du({
  ...
  const c = t ? Ar.Root : "button", { state: l } = ga(), d = /* @__PURE__ */ a(
    c,
    {
...
function wu({
  ...
  const d = A(
    ...
    (g) => {
      const f = r.find((v) => v.projectId === g);
...
const Ie = "scrBook", uu = "scrRef", Je = "source", pu = "details", hu = "Scripture Reference", gu = "Scripture Book", ji = "Type", fu = "Details";
function mu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Lt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ie ? Se(n.start) : void 0;
      },
...
function xh({
  ...
  const [d, w] = k([]), [p, h] = k([{ id: Ie, desc: !1 }]), [g, f] = k({}), v = $(
    () => t.flatMap((z) => z.data.map((_) => ({
      ..._,
      source: z.source
    }))),
    [t]
  ...
  J(() => {
    if (c) {
      const z = R.getSelectedRowModel().rowsById, _ = Object.keys(z);
      if (_.length === 1) {
        const q = v.find((W) => yn(W) === _[0]) || void 0;
        q && c(q);
      }
    }
  }, [g, v, c, R]);
  const x = n ?? gu, C = s ?? ji, N = [
    ...
    !z.getIsGrouped() && !z.getIsSelected() && z.getToggleSelectedHandler()(_);
  }, B = (z, _) => z.getIsGrouped() ? "" : m("banded-row", _ % 2 === 0 ? "even" : "odd"), O = (z, _, q) => {
    if (!((z == null ? void 0 : z.length) === 0 || _.depth < q.column.getGroupedIndex())) {
      if (_.getIsGrouped())
        switch (_.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      hr,
      {
        ...
        children: [
          /* @__PURE__ */ a(fr, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(gr, {}) }),
          /* @__PURE__ */ a(mr, { position: "item-aligned", children: /* @__PURE__ */ a(bw, { children: N.map((z) => /* @__PURE__ */ a(ue, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: R.getHeaderGroups().map((z) => /* @__PURE__ */ a($e, { children: z.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Qr, { colSpan: _.colSpan, className: "tw:sticky top-0", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          _.column.getCanGroup() ? /* @__PURE__ */ a(
            tt,
            {
              variant: "ghost",
          ...
          " ",
          Er(_.column.columnDef.header, _.getContext())
        ] }) }, _.id)
      )) }, z.id)) }),
      /* @__PURE__ */ a(ho, { children: R.getRowModel().rows.map((z, _) => {
        const q = Ne();
        return /* @__PURE__ */ a(
          $e,
          {
            ...
            className: m(B(z, _)),
            onClick: (W) => L(z, W),
            children: z.getVisibleCells().map((W) => {
              if (!(W.getIsPlaceholder() || W.column.columnDef.enableGrouping && !W.getIsGrouped() && (W.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  lr,
                  {
                    className: m(
                    ...
                    children: W.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        type: "button",
                        children: [
                          z.getIsExpanded() && /* @__PURE__ */ a(ur, {}),
                          !z.getIsExpanded() && (q === "ltr" ? /* @__PURE__ */ a(qa, {}) : /* @__PURE__ */ a(Ha, {})),
                          " ",
                          Er(W.column.columnDef.cell, W.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function bu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: v } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [b, R] = k(!1), [x, C] = k(""), N = F(void 0), I = F(!1), L = $(
    () => zn(t),
    [t]
  ), B = $(() => {
    if (!x.trim()) {
    ...
    (D, it = !1) => {
      if (!it || !N.current) {
        r(
          e.includes(D) ? e.filter((wt) => wt !== D) : [...e, D]
        ), N.current = D;
        return;
      }
      const S = L.findIndex((wt) => wt === N.current), Y = L.findIndex((wt) => wt === D);
      if (S === -1 || Y === -1) return;
      const [G, U] = [
        Math.min(S, Y),
        Math.max(S, Y)
      ], Q = L.slice(G, U + 1).map((wt) => wt);
      r(
        e.includes(D) ? e.filter((wt) => !Q.includes(wt)) : [.../* @__PURE__ */ new Set([...e, ...Q])]
      );
    },
    [e, r, L]
  ), z = (D) => {
    O(D, I.current), I.current = !1;
  }, _ = (D, it) => {
    D.preventDefault(), O(it, D.shiftKey);
  }, q = () => {
    r(L.map((D) => D));
  }, W = () => {
    r([]);
    ...
    () => Object.values(It).filter(
      (D) => (s == null ? void 0 : s[D]) !== void 0 && go(L, D).length === 0
    ).map((D) => ({ section: D, explanation: s == null ? void 0 : s[D] })),
    [s, L]
  );
  return /* @__PURE__ */ u(
    je,
              ...
              Fe,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u(Ue, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(It).filter((D) => B[D].length > 0).map((D, it) => {
                      const S = B[D];
                      return /* @__PURE__ */ u(da, { children: [
                        it > 0 && /* @__PURE__ */ a(Sn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          ze,
                          {
                            heading: _n(D, h, g, f, v),
                            children: S.map((Y) => /* @__PURE__ */ a(
                              ni,
                              {
                                bookId: Y,
                  ...
                  rt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: rt.map(({ section: D, explanation: it }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: it }, D)) })
                ]
              }
            )
          }
...
function yu({
  ...
  return /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
    /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
      xu,
      {
        className: o,
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === La ? La : kn
      ).map((d) => /* @__PURE__ */ a(Rr, { className: "tw:hover:bg-secondary", variant: "secondary", children: xe(d, n) }, d)),
...
function kh({
  ...
  const I = Vt(
    i,
    "%webView_scope_selector_selected_text%"
  ), L = Vt(i, "%webView_scope_selector_verse%"), B = Vt(i, "%webView_scope_selector_chapter%"), O = Vt(i, "%webView_scope_selector_book%"), z = Vt(
    i,
    "%webView_scope_selector_current_verse%"
  ), _ = Vt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), q = Vt(i, "%webView_scope_selector_current_book%"), W = Vt(i, "%webView_scope_selector_choose_books%"), rt = Vt(i, "%webView_scope_selector_scope%"), D = Vt(i, "%webView_scope_selector_select_books%"), it = Vt(i, "%webView_scope_selector_range%"), S = Vt(i, "%webView_scope_selector_select_range%"), Y = Vt(i, "%webView_scope_selector_range_start%"), G = Vt(i, "%webView_scope_selector_range_end%"), U = Vt(i, "%webView_scope_selector_ok%"), Q = Vt(i, "%webView_scope_selector_cancel%"), wt = Vt(i, "%webView_scope_selector_navigate%"), St = (P) => {
    if (!v) return;
    const et = v.book.toUpperCase();
    switch (P) {
      case "verse":
        return Se(v, "id");
      case "chapter":
        return `${et} ${v.chapterNum}`;
      case "book":
        return et;
      default:
        return;
    ...
    { value: "range", label: it, id: "scope-range" }
  ], ut = (P, et, pt = !1) => /* @__PURE__ */ u(ct, { children: [
    P,
    et && !pt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      et
    ] })
  ] }), ft = e ? Z.filter((P) => e.includes(P.value)) : Z, bt = v ?? Ta, yt = p ?? bt, _t = h ?? bt, Nt = () => {
  }, Yt = F(null), Xt = F(null), Dt = F(!1), ae = F(null), mt = F(!1), [se, Mt] = k(void 0), Jt = F(!1), oe = F(!1), Ut = F(null), ge = A((P) => {
    if (P) {
      Mt("start"), Jt.current = !1;
      return;
    }
    Mt((et) => et === "start" ? void 0 : et), Jt.current && (Jt.current = !1, requestAnimationFrame(() => {
      var pt;
      const et = (pt = Yt.current) == null ? void 0 : pt.querySelector("button");
      et == null || et.click();
    }));
  }, []), de = A((P) => {
    if (P) {
    ...
    (P) => {
      g == null || g(P), f == null || f(P), Jt.current = !0;
    },
    [g, f]
  ), Kt = A(
    (P) => {
      f == null || f(P), oe.current = !0;
    },
    [f]
  ), M = A(
    (P) => {
      r(P), P === "selectedBooks" && n.length === 0 && (v != null && v.book) && s([v.book]);
    },
    [r, n, v, s]
  ), Pt = ft.find((P) => P.value === t), we = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? cc(yt, _t, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Pt ? ut(Pt.label, Pt.scrRefSuffix) : t, ce = ft.filter(
    (P) => P.value !== "selectedBooks" && P.value !== "range"
  ), At = ft.find((P) => P.value === "selectedBooks"), ne = ft.find((P) => P.value === "range"), [me, Zt] = k(!1), [E, V] = k(void 0), [K, H] = k(void 0), [X, j] = k(void 0), [ot, lt] = k(void 0), [dt, kt] = k([]), Rt = w === "dropdown" && E === "selectedBooks", Ot = /* @__PURE__ */ a(
    _u,
    {
      availableBookInfo: o,
      selectedBookIds: Rt ? dt : n,
      onChangeSelectedBookIds: Rt ? kt : s,
      localizedStrings: i,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), T = se === "end", vt = se === "start", ht = "tw:text-muted-foreground", Qt = w === "dropdown" && E === "range", ar = Qt ? j : fe, ma = Qt ? lt : f ? Kt : Nt, Vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a($t, { htmlFor: "scope-range-start", className: m(T && ht), children: Y }),
      /* @__PURE__ */ a(
        Ra,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Yt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a($t, { htmlFor: "scope-range-end", className: m(vt && ht), children: G }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
          ...
          localizedStrings: R,
          getEndVerse: x,
          disableReferencesUpTo: Qt ? X ?? yt : yt,
          onOpenChange: de,
          onCloseAutoFocus: (P) => {
            var et;
            oe.current && (oe.current = !1, P.preventDefault(), (et = Ut.current) == null || et.focus());
          },
          className: m(vt && ht),
          modal: !0,
          align: "start"
  ...
  J(() => {
    ...
    const et = requestAnimationFrame(() => {
      P = requestAnimationFrame(() => {
        var pt;
        (pt = br.current[t]) == null || pt.focus();
      });
    });
    return () => {
      cancelAnimationFrame(et), P && cancelAnimationFrame(P);
    };
  }, [me, t]);
  const [We, va] = k(null), [Ye, ba] = k(null), [nr, xa] = k(null), ya = 200, [ka, _a] = k(!1);
  J(() => {
    if (!nr || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([et]) => {
      _a(et.contentRect.width < ya);
    });
    return P.observe(nr), () => P.disconnect();
  }, [nr]);
  const y = A(
    (P) => {
      H(P), j(yt), lt(_t), kt(n), Zt(!1), V(P);
    },
    [yt, _t, n]
  ), at = A(() => {
    K !== void 0 && (K === "range" ? (X && (g == null || g(X)), ot && (f == null || f(ot))) : K === "selectedBooks" && s(dt), M(K), V(void 0), H(void 0));
  }, [
    K,
    X,
    ot,
    ...
    var et;
    P.preventDefault(), (et = xr.current) == null || et.focus();
  }, []), Te = (P) => t === P ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a($t, { children: rt }),
      w === "dropdown" ? /* @__PURE__ */ u(Ke, { open: me, onOpenChange: Zt, children: [
        /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
          tt,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: we() }),
              /* @__PURE__ */ a(ur, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          qe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Na, { container: nr, children: [
              ce.map(({ value: P, label: et, dropdownLabel: pt, scrRefSuffix: xt, id: Ft }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: or(P),
              ...
              b && /* @__PURE__ */ u(ct, { children: [
                /* @__PURE__ */ a(Qe, {}),
                /* @__PURE__ */ a(Or, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: wt }),
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ref: ae,
                    ...
                    onSelect: (P) => {
                      var et, pt;
                      if (P.preventDefault(), Dt.current) {
                        Dt.current = !1;
                        return;
                      }
                      mt.current || (pt = (et = Xt.current) == null ? void 0 : et.querySelector("button")) == null || pt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (P) => {
                          const et = P.target instanceof HTMLElement ? P.target : void 0;
                          et != null && et.closest("button") && (Dt.current = !0, requestAnimationFrame(() => {
                            Dt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          Ra,
                          {
                            ...
                            onCloseAutoFocus: (P) => {
                              var et;
                              P.preventDefault(), (et = ae.current) == null || et.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(ct, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Se(v ?? Ta, "id") }),
                              /* @__PURE__ */ a(ur, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        co,
        {
          ...
          children: ft.map(({ value: P, label: et, scrRefSuffix: pt, id: xt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: P, id: xt }),
            /* @__PURE__ */ a($t, { htmlFor: xt, children: ut(et, pt) })
          ] }, xt))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && Vr,
    w === "dropdown" && At && /* @__PURE__ */ a(ja, { open: E === "selectedBooks", onOpenChange: nt, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: ba,
        onCloseAutoFocus: te,
        ...
        children: /* @__PURE__ */ u(Na, { container: Ye, children: [
          /* @__PURE__ */ a(Fa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ua, { children: W }) }),
          Ot,
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => nt(!1), children: Q }),
            /* @__PURE__ */ a(tt, { onClick: at, children: U })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && ne && /* @__PURE__ */ a(ja, { open: E === "range", onOpenChange: nt, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: va,
        onCloseAutoFocus: te,
        ...
        children: /* @__PURE__ */ u(Na, { container: We, children: [
          ...
          /* @__PURE__ */ u(Oo, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => nt(!1), children: Q }),
            /* @__PURE__ */ a(tt, { ref: Ut, onClick: at, children: U })
          ] })
        ] })
      }
    ) })
...
function _h({
  ...
  return /* @__PURE__ */ u(
    hr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(fr, { size: n, className: m("pr-twp tw:w-auto", s), children: /* @__PURE__ */ a(
          gr,
          {
        ...
        /* @__PURE__ */ a(
          mr,
          {
            ...
            style: { zIndex: er },
            children: t.map((w) => /* @__PURE__ */ a(ue, { value: `${w}`, children: l[Lo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Fi = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Et, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(gs, { children: c.label }),
    /* @__PURE__ */ a(fs, { children: /* @__PURE__ */ a(ms, { children: Fi(
      t,
      e,
      Bi(t, c.id),
      o
...
function io({
  ...
  return /* @__PURE__ */ u(Ke, { variant: s, children: [
    /* @__PURE__ */ a(He, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(tt, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(Ys, {}) }) }),
    /* @__PURE__ */ a(qe, { align: "start", style: { zIndex: er }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(da, { children: [
      /* @__PURE__ */ a(En, { children: /* @__PURE__ */ a(jt, { children: Fi(e.groups, e.items, l, t) }) }),
...
const Su = Object.freeze([520, 420, 340]), Ki = Gt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = Ui(n, Su), d = si() ?? l, w = d >= Tr.MINIMUM;
...
function Th({
  ...
  return /* @__PURE__ */ u(Ki, { className: `tw:w-full tw:border-b ${s}`, id: n, children: [
    r && /* @__PURE__ */ a(
      io,
      {
        onSelectMenuItem: t,
...
const Hi = Gt.forwardRef(({ className: t, ...e }, r) => {
  const o = Ne();
  return /* @__PURE__ */ a(
    he.Root,
    {
...
Hi.displayName = he.List.displayName;
const qi = Gt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.List,
  {
    ref: r,
    className: m(
...
qi.displayName = he.List.displayName;
const Ru = Gt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
...
)), Gi = Gt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Content,
  {
    ref: r,
    className: m(
...
function Rh({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Hi, { children: [
      /* @__PURE__ */ a(qi, { children: t.map((c) => /* @__PURE__ */ a(Ru, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (El(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (f = s.current) == null || f.focus(), Nr(s, [h, g]);
        break;
      case "alt+l":
        (v = i.current) == null || v.focus(), Nr(i, [h, g]);
        break;
      case "alt+n":
        (b = c.current) == null || b.focus(), Nr(c, [h, g]);
        break;
      case "alt+h":
        (R = l.current) == null || R.focus(), Nr(l, [h, g]);
        break;
    }
  }), J(() => {
    ...
    const w = new MutationObserver((g) => {
      g.forEach((f) => {
        if (f.attributeName === "data-state" && f.target instanceof HTMLElement) {
          const v = f.target.getAttribute("data-state");
          r(v === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ a(zu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Du, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: er },
          children: /* @__PURE__ */ a(jt, { children: Wi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Mh({
  ...
  const d = Fu(
    ...
    n && n(f), o && o([f, ...r.filter((v) => v !== f)]), s && r.find((v) => v === f) && s([...r.filter((v) => v !== f)]), p(!1);
  }, g = (f, v) => {
    var R, x, C, N, I, L;
    const b = v !== f ? ((x = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : x[v]) ?? ((N = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : N.en) : void 0;
    return b ? `${(I = t[f]) == null ? void 0 : I.autonym} (${b})` : (L = t[f]) == null ? void 0 : L.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: m("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ u(
      hr,
      {
        ...
        onOpenChange: (f) => p(f),
        children: [
          /* @__PURE__ */ a(fr, { children: /* @__PURE__ */ a(gr, {}) }),
          /* @__PURE__ */ a(
            mr,
            {
              style: { zIndex: er },
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a($t, { className: "tw:font-normal tw:text-muted-foreground", children: Pe(d, {
...
function Ih({
  ...
  const [i, c] = k(""), l = $(
    () => Uu(Object.entries(t)).map(([f, v]) => ({
      tag: f,
      info: v,
      keywords: [v.autonym, ...Object.values(v.uiNames ?? {}), ...v.otherNames ?? []]
    })),
    [t]
  ), d = $(() => {
    if (!i) return l;
    const f = i.toLowerCase();
    return l.filter(({ keywords: v }) => v.some((b) => b.toLowerCase().includes(f)));
  ...
  return /* @__PURE__ */ u(Fe, { id: s, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(bs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        "input",
        {
      ...
      /* @__PURE__ */ a(xs, { children: /* @__PURE__ */ a(mc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ue, { children: [
      ...
      d.map(({ tag: f, info: v }) => {
        ...
        return /* @__PURE__ */ u(
          Me,
          {
            ...
            onSelect: () => r(f),
            children: [
              /* @__PURE__ */ a("span", { dir: "auto", children: v.autonym }),
...
const Ju = (t, e, r = {}) => {
  ...
  const [e, r] = k(!1), [o, n] = k(!1), [s, i] = k(0), c = F(void 0), l = $(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
...
function yg(t) {
  const e = $(() => lc(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const Zu = () => {
  const [t, e] = k(
...
function Ng({ value: t, children: e }) {
  return /* @__PURE__ */ a(ii.Provider, { value: t, children: /* @__PURE__ */ a(ua.Provider, { value: t, children: e }) });
}
function tp(t, e = "top") {
