...
const po = ft.Root, gi = ft.Trigger, Wl = ft.Group, nh = ft.Portal, rh = ft.Sub, oh = ft.RadioGroup, Kl = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  ft.SubTrigger,
  {
    ref: o,
    className: N(
...
function ih({ scrRef: t, handleSubmit: e, getActiveBookIds: n }) {
  const r = xt(), [o, a] = ut(""), [i, l] = ut(
    ...
    mc.forEach(($) => {
      const F = o.match($);
      if (F) {
        const [B, D = void 0, U = void 0] = F.slice(1), nt = bc(B);
  ...
  return se(() => {
    ...
    const $ = setTimeout(() => {
      if (v && k.current && T.current) {
        const B = T.current.offsetTop - fc;
    ...
    /* @__PURE__ */ s(
      nr,
      {
        ...
        ref: k,
        children: /* @__PURE__ */ s("div", { className: "rtl:tw-ps-2", children: da.map(($, F) => {
          const B = C($);
          return B.length > 0 && /* @__PURE__ */ x("div", { children: [
            /* @__PURE__ */ s(rr, { className: "tw-font-semibold tw-text-foreground/80", children: wc[$] }),
            ...
            da.length - 1 !== F ? /* @__PURE__ */ s(or, {}) : void 0
          ] }, $);
        }) })
      }
    )
...
function wh({
  ...
  const f = Zt(n, "%webView_inventory_all%"), w = Zt(n, "%webView_inventory_approved%"), g = Zt(n, "%webView_inventory_unapproved%"), v = Zt(n, "%webView_inventory_unknown%"), m = Zt(n, "%webView_inventory_scope_currentBook%"), h = Zt(n, "%webView_inventory_scope_chapter%"), k = Zt(n, "%webView_inventory_scope_verse%"), T = Zt(n, "%webView_inventory_filter_text%"), C = Zt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [I, V] = ut("all"), [R, P] = ut(""), [G, M] = ut([]), Q = Ct(() => l ? r instanceof RegExp ? Uc(
    l,
    t,
    a,
    i,
...
function hh({
  ...
  se(() => {
    if (l) {
      ...
      if (P.length === 1) {
        const G = v.find((M) => wa(M) === P[0]) || void 0;
        G && l(G);
      }
    }
  }, [w, v, l, h]);
    ...
    !e && /* @__PURE__ */ x(
      Ve,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(ke, { position: "item-aligned", children: /* @__PURE__ */ s(_c, { children: C.map((R) => /* @__PURE__ */ s(Bt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(ar, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(ir, { children: h.getHeaderGroups().map((R) => /* @__PURE__ */ s(ie, { children: R.headers.filter((P) => P.column.columnDef.header).map((P) => (
      ...
      /* @__PURE__ */ s(sr, { children: h.getRowModel().rows.map((R, P) => {
        const G = xt();
        return /* @__PURE__ */ s(
          ie,
          {
                    ...
                    children: (() => M.getIsGrouped() ? /* @__PURE__ */ x(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (G === "ltr" ? /* @__PURE__ */ s(oi, {}) : /* @__PURE__ */ s(bl, {})),
                          " ",
...
function Ed() {
  return ma || (ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var b = c, I = d, V = l, R = i, P = e, G = p, M = r, Q = v, $ = g, F = n, B = a, D = o, U = f, nt = !1;
    function at(A) {
    ...
    st.AsyncMode = b, st.ConcurrentMode = I, st.ContextConsumer = V, st.ContextProvider = R, st.Element = P, st.ForwardRef = G, st.Fragment = M, st.Lazy = Q, st.Memo = $, st.Portal = F, st.Profiler = B, st.StrictMode = D, st.Suspense = U, st.isAsyncMode = at, st.isConcurrentMode = y, st.isContextConsumer = O, st.isContextProvider = X, st.isElement = Y, st.isForwardRef = L, st.isFragment = K, st.isLazy = q, st.isMemo = W, st.isPortal = H, st.isProfiler = J, st.isStrictMode = Z, st.isSuspense = dt, st.isValidElementType = C, st.typeOf = E;
  }()), st;
}
var ha;
function Zi() {
...
function Dd() {
  return Ea || (Ea = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var I = i, V = a, R = t, P = c, G = n, M = w, Q = f, $ = e, F = o, B = r, D = d, U = p, nt = !1, at = !1;
    function y(z) {
...
function op(t) {
  t.addEventListener("keydown", np, !0), t.addEventListener("mousedown", zr, !0), t.addEventListener("pointerdown", zr, !0), t.addEventListener("touchstart", zr, !0), t.addEventListener("visibilitychange", rp, !0);
}
function ap(t) {
  const {
    target: e
...
function ss() {
  ...
  function n() {
    return e.current ? (eo = !0, Qd.start(100, () => {
      eo = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
}), wr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], fr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], xp = [...wr, ...fr];
function Cn(t, e, n, r) {
  var o;
...
const Sp = Gt("border", Vt), Tp = Gt("borderTop", Vt), Cp = Gt("borderRight", Vt), Op = Gt("borderBottom", Vt), Rp = Gt("borderLeft", Vt), _p = Gt("borderColor"), Pp = Gt("borderTopColor"), $p = Gt("borderRightColor"), Ip = Gt("borderBottomColor"), Ap = Gt("borderLeftColor"), Mp = Gt("outline", Vt), Dp = Gt("outlineColor"), hr = (t) => {
...
mr(Sp, Tp, Cp, Op, Rp, _p, Pp, $p, Ip, Ap, hr, Mp, Dp);
const gr = (t) => {
...
mr(gr, br, vr, jp, Bp, Vp, zp, Fp, Lp, Gp, Up, Xp);
function Be(t, e) {
  return e === "grey" ? e : t;
}
const Yp = vt({
...
function Io(t = {}, ...e) {
  ...
  return d.applyStyles = au, d = e.reduce((p, f) => Qt(p, f), d), d.unstable_sxConfig = _({}, Po, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return $o({
      sx: f,
      theme: this
    });
...
function hu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const T = Il(i, _({
      ...
      if (process.env.NODE_ENV !== "production") {
        let M;
        c && (M = `${c}${Wt(d || "")}`), M === void 0 && (M = `Styled(${Vd(i)})`), G.displayName = M;
      }
...
function Qu(t) {
  const e = _({}, Ku, t.easing), n = _({}, Ju, t.duration);
  return _({
...
const lw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], cw = (t) => {
  ...
  const r = jo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, lw), v = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
function Ew(t) {
  ...
  const i = Nw(_({}, o, r)), l = Ga(r), c = Ga(o), d = e(i), p = ve(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
const Kn = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    children: r,
    container: o,
    disablePortal: a = !1
...
process.env.NODE_ENV !== "production" && (Kn["propTypes"] = Ad(Kn.propTypes));
...
function Kw(t) {
  ...
  if (!(!a || !i)) {
    var f = Ww(o.padding, n), w = Fo(a), g = c === "y" ? Ot : Rt, v = c === "y" ? Ft : Lt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = Pn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, E = f[g], b = T - w[p] - f[v], I = T / 2 - w[p] / 2 + C, V = mn(E, I, b), R = c;
...
function Ya(t) {
  ...
  if (g = Q.x, m = Q.y, c) {
    var $;
    return Object.assign({}, M, ($ = {}, $[E] = T ? "0" : "", $[C] = k ? "0" : "", $.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", $));
  }
...
function qa(t, e, n) {
  return e === Ns ? ro(lf(t, n)) : Te(e) ? df(e, n) : ro(cf(ce(t)));
}
function pf(t) {
...
function kn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Pw : l, d = n.rootBoundary, p = d === void 0 ? Ns : d, f = n.elementContext, w = f === void 0 ? sn : f, g = n.altBoundary, v = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Cs(typeof h != "number" ? h : Os(h, _n)), T = w === sn ? $w : sn, C = t.rects.popper, E = t.elements[v ? T : w], b = uf(Te(E) ? E : E.contextElement || ce(t.elements.popper), c, p, i), I = Ye(t.elements.reference), V = _s({
    reference: I,
    element: C,
    strategy: "absolute",
    placement: o
  }), R = ro(Object.assign({}, C, V)), P = w === sn ? R : I, G = {
...
function mf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Ht(h), T = k === h, C = c || (T || !v ? [Yn(h)] : ff(h)), E = [h].concat(C).reduce(function(L, K) {
      return L.concat(Ht(K) === Vo ? wf(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
      ...
      var M = E[G], Q = Ht(M), $ = He(M) === Ue, F = [Ot, Ft].indexOf(Q) >= 0, B = F ? "width" : "height", D = kn(e, {
        placement: M,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
...
function Sf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = kn(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Ht(e.placement), T = He(e.placement), C = !T, E = Lo(k), b = Ef(E), I = e.modifiersData.popperOffsets, V = e.rects.reference, R = e.rects.popper, P = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, G = typeof P == "number" ? {
    mainAxis: P,
    altAxis: P
    ...
    mainAxis: 0,
    altAxis: 0
  }, P), M = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, Q = {
    x: 0,
    y: 0
  };
  if (I) {
    if (a) {
      var $, F = E === "y" ? Ot : Rt, B = E === "y" ? Ft : Lt, D = E === "y" ? "height" : "width", U = I[E], nt = U + h[F], at = U - h[B], y = g ? -R[D] / 2 : 0, O = T === Ue ? V[D] : R[D], X = T === Ue ? -R[D] : -V[D], Y = e.elements.arrow, L = g && Y ? Fo(Y) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Ts(), q = K[F], W = K[B], H = mn(0, V[D], L[D]), J = C ? V[D] / 2 - y - H - q - G.mainAxis : O - H - q - G.mainAxis, Z = C ? -V[D] / 2 + y + H + W + G.mainAxis : X + H + W + G.mainAxis, dt = e.elements.arrow && Pn(e.elements.arrow), A = dt ? E === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Nt = ($ = M == null ? void 0 : M[E]) != null ? $ : 0, z = U + J - Nt - A, yt = U + Z - Nt, Ut = mn(g ? Jn(nt, z) : nt, U, g ? ye(at, yt) : at);
      I[E] = Ut, Q[E] = Ut - U;
    }
    if (l) {
      var de, St = E === "x" ? Ot : Rt, In = E === "x" ? Ft : Lt, Xt = I[b], Ce = b === "y" ? "height" : "width", pe = Xt + h[St], Oe = Xt - h[In], Re = [Ot, Rt].indexOf(k) !== -1, _e = (de = M == null ? void 0 : M[b]) != null ? de : 0, ue = Re ? pe : Xt - V[Ce] - R[Ce] - _e + G.altAxis, Ze = Re ? Xt + V[Ce] + R[Ce] - _e - G.altAxis : Oe, An = g && Re ? qw(ue, Xt, Ze) : mn(g ? ue : pe, Xt, g ? Ze : Oe);
      I[b] = An, Q[b] = An - Xt;
    }
    e.modifiersData[r] = Q;
  }
...
const Gf = () => Oo({
  ...
  } = e, h = kt(e, Vf), k = j.useRef(null), T = Ee(k, n), C = j.useRef(null), E = Ee(C, w), b = j.useRef(E);
  Ge(() => {
    b.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const I = Ff(p, i), [V, R] = j.useState(I), [P, G] = j.useState(Zn(o));
  j.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && P && Nr(P) && P.nodeType === 1) {
...
`));
  ...
  const Q = Gf(), $ = (r = v.root) != null ? r : "div", F = Tw({
    elementType: $,
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, T = kt(e, zf), [C, E] = j.useState(!0), b = () => {
    E(!1);
  }, I = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const G = Zn(r);
    V = G && Nr(G) ? Hn(G).body : Hn(null).body;
  }
...
const Zf = {
...
}, Lr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Yo = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = kt(e, Jf), T = dn(), C = j.useRef(), E = Is(), b = j.useRef(null), I = Ee(b, a.ref, n), V = (B) => (D) => {
    if (B) {
      const U = b.current;
      D === void 0 ? B(U) : B(U, D);
    }
    ...
    m === "auto" ? (at = E.transitions.getAutoHeightDuration(B.clientHeight), C.current = at) : at = D, B.style.transition = [E.transitions.create("opacity", {
      ...
      delay: Lr ? U : U || at * 0.333,
      easing: nt
    })].join(","), B.style.opacity = 0, B.style.transform = io(0.75), f && f(B);
  }), $ = V(w);
...
const ei = Yo, Qf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], tm = Rn($s, {
  ...
  const o = ms(), a = jo({
    ...
    slots: C,
    slotProps: E
  } = a, b = kt(a, Qf), I = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, V = _({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const js = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const I = jo({
    ...
    TransitionProps: Nt
  } = I, z = kt(I, rm), yt = /* @__PURE__ */ j.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
  }), Ut = Is(), de = Ut.direction === "rtl", [St, In] = j.useState(), [Xt, Ce] = j.useState(null), pe = j.useRef(!1), Oe = F || at, Re = dn(), _e = dn(), ue = dn(), Ze = dn(), [An, Ho] = is({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const qo = (tt) => {
    ...
    (tt) => {
      ni.start(800 + O, () => {
        Fn = !1;
      }), Ho(!1), Y && Jt && Y(tt), Re.start(Ut.transitions.duration.shortest, () => {
        pe.current = !1;
      });
    }
  ), Er = (tt) => {
    ...
    yt.props.onTouchEnd && yt.props.onTouchEnd(tt), Mn(), ue.start(X, () => {
      Dn(tt);
    });
  };
  j.useEffect(() => {
  ...
  M ? (tn.title = !Jt && Tr && !$ ? dt : null, tn["aria-describedby"] = Jt ? kr : null) : (tn["aria-label"] = Tr ? dt : null, tn["aria-labelledby"] = Jt && !Tr ? kr : null);
...
`));
  const qs = j.useMemo(() => {
    ...
    touch: pe.current
  }), Cr = am(nn), ra = (r = (o = Z.popper) != null ? o : P.Popper) != null ? r : im, oa = (a = (i = (l = Z.transition) != null ? l : P.Transition) != null ? i : A) != null ? a : ei, aa = (c = (d = Z.tooltip) != null ? d : P.Tooltip) != null ? c : sm, ia = (p = (f = Z.arrow) != null ? f : P.Arrow) != null ? p : lm, Ws = pn(ra, _({}, H, (w = J.popper) != null ? w : G.popper, {
    className: ve(Cr.popper, H == null ? void 0 : H.className, (g = (v = J.popper) != null ? v : G.popper) == null ? void 0 : g.className)
  }), nn), Ks = pn(oa, _({}, Nt, (m = J.transition) != null ? m : G.transition), nn), Js = pn(aa, _({}, (h = J.tooltip) != null ? h : G.tooltip, {
    className: ve(Cr.tooltip, (k = (T = J.tooltip) != null ? T : G.tooltip) == null ? void 0 : k.className)
  }), nn), Zs = pn(ia, _({}, (C = J.arrow) != null ? C : G.arrow, {
    className: ve(Cr.arrow, (E = (b = J.arrow) != null ? b : G.arrow) == null ? void 0 : E.className)
  }), nn);
  return /* @__PURE__ */ x(j.Fragment, {
    children: [/* @__PURE__ */ j.cloneElement(yt, jt), /* @__PURE__ */ s(ra, _({
      as: W ?? Ds,
      placement: q,
      anchorEl: at ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(aa, _({}, Js, {
          children: [dt, V ? /* @__PURE__ */ s(ia, _({}, Zs, {
            ref: Ce
          })) : null]
        }))
      }))
...
Pm.displayName = Yr.Root.displayName;
