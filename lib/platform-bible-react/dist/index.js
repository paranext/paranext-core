...
import { c as v, g as $e, a as Vr, C as er, L as Kn, t as _s, u as tn, T as Vt, b as bt, d as xt, e as yt, f as Hn, A as ba, D as Fe, h as Te, i as je, j as cr, k as We, B as et, x as Ns, l as Cs, m as Es, I as Ts, n as Co, o as Je, r as De, p as Ss, q as Gn, P as lr, s as Dr, v as dr, w as wr, y as Da, z as Ma, E as Eo, F as ur, G as Oa, H as $t, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as qn, S as da, U as So, V as jr, W as Ur, X as yr, Y as Rs, Z as ir, _ as Ze, $ as Ue, a0 as Ye, a1 as kr, a2 as Ro, a3 as Do, a4 as ya, a5 as Mo, a6 as Wn, a7 as Ds, a8 as Ms, a9 as Os, aa as wo, ab as Yn, ac as Ia, ad as Is, ae as Xn, af as zs, ag as Ps, ah as As, ai as en, aj as $s, ak as Vs, al as Ls, am as Zn, an as Jn, ao as Oo, ap as Bs, aq as Qn, ar as Ka, as as rn, at as Ha, au as Fs, av as js, aw as Us, ax as Ks, ay as Hs, az as Gs, aA as qs, aB as Ws, aC as Ys, aD as Io, aE as zo, aF as Xs, aG as Zs } from "./resizable-39QAMVZg.js";
import { aH as kf, aI as _f, aJ as Nf, aK as Cf, aL as Ef, aM as Tf, aN as Sf, aO as Rf, aP as Df, aQ as Mf, aR as Of, aS as If, aT as zf, aU as Pf, aV as Af, aW as $f, aX as Vf, aY as Lf, aZ as Bf, a_ as Ff, a$ as jf, b0 as Uf, b1 as Kf, b2 as Hf, b3 as Gf, b4 as qf, b5 as Wf, b6 as Yf, b7 as Xf, b8 as Zf, b9 as Jf, ba as Qf, bb as tm, bc as em, bd as rm, be as am, bf as om } from "./resizable-39QAMVZg.js";
...
import { Section as At, compareScrRefs as ka, getChaptersForBook as Ic, formatScrRef as Ve, formatReplacementString as Xe, getSectionForBook as wa, formatRelativeDate as zc, sanitizeHtml as Po, NumberFormat as ci, formatBytes as Pc, getCurrentLocale as Ac, usfmMarkers as ua, isPlatformError as $c, ABORTED as Vc, getErrorMessage as Lc, getFormatCallerFunction as Bc, deepEqual as Fc, isString as sn, scrRefToBBBCCCVVV as Ga, defaultScrRef as qa, formatScrRefRange as jc, getLocalizeKeyForScrollGroupId as cn, formatReplacementStringToArray as ln, collectUsjMarkers as Uc } from "platform-bible-utils";
import re, { useRef as L, useMemo as V, createContext as qr, useContext as za, useEffect as Z, useState as k, useCallback as F, useId as _a, useImperativeHandle as Kc, useLayoutEffect as Ht, Fragment as Wr, Component as Hc, createElement as dn, Suspense as Gc, forwardRef as Ao, memo as li } from "react";
import { IconSelector as di, IconCheck as Pa, IconChevronDown as qc, IconChevronUp as Wc, IconLayoutSidebar as Yc, IconLayoutSidebarRight as Xc, IconChevronRight as wi, IconSearch as Zc, IconLoader as Jc, IconAlertOctagon as Qc, IconAlertTriangle as tl, IconInfoCircle as el, IconCircleCheck as rl } from "@tabler/icons-react";
...
import { Avatar as Bo, Select as ae, Checkbox as hn, Slot as Xr, Tabs as ke, Menubar as Me, ContextMenu as Gt, Progress as gn, Slider as oa, Switch as fn } from "radix-ui";
...
function pd({
  ...
  Mi(), Z(() => {
    ...
    if (!$) return;
    const _ = (q) => !!q && q.scrollWidth > q.clientWidth, ot = () => {
...
function md({
  ...
  const [h, f] = k(!1), [b, x] = k(!1), g = _a(), E = L(!1), y = w !== void 0, C = y ? w : h, N = n === "" ? "" : se(n, gd), A = se(s, fd), R = (O) => {
...
function Ya({
  ...
  const R = De(), z = ud(), [M, T] = k(!1), [O, W] = k(""), [Y, $] = k(""), [_, ot] = k("books"), [P, X] = k(void 0), [q, B] = k(
    void 0
    ...
    if (!I) return;
    const m = O.startsWith(`${I.book} `) ? O : "", G = na(m), lt = Ar(m);
    return {
      book: I.book,
  ...
  const It = F(() => {
    ...
    (m) => {
      const G = q ?? (I == null ? void 0 : I.book), lt = at ?? (I == null ? void 0 : I.chapterNum);
      !G || !lt || (Mt({
        book: G,
        chapterNum: lt,
        verseNum: m
    ...
    (m) => {
      const G = _ === "chapters" ? P : I == null ? void 0 : I.book;
      if (G) {
        if (w && w(G, m) > 1) {
          B(G), ut(m), ot("verses"), W("");
          return;
        }
        Mt({
          book: G,
  ...
  const { otLong: Tt, ntLong: Wt, dcLong: ar, extraLong: Ke } = {
    ...
    [t.book, s, z]
  ), gr = `${t.chapterNum}:${t.verseNum}`, S = F((m) => (G) => {
    me.current[m] = G;
  }, []), ct = F((m) => (G) => {
    Dt.current[m] = G;
  }, []), wt = V(
    ...
    (m) => {
      ...
      if (!(!!G && !!((Zo = _t.current) != null && Zo.contains(G))) && (G != null && G.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
        const Bt = _t.current ? Td(_t.current) : [];
        if (Bt.length === 0) {
      ...
      if (_ === "books" && I && !dt && m.key === "Enter" && !(G !== Nt.current && !!(G != null && G.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (_ === "books" && !Ft && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
        const Bt = G === Nt.current ? Nt.current : void 0, pe = (Bt == null ? void 0 : Bt.selectionStart) ?? 0, Qt = (Bt == null ? void 0 : Bt.selectionEnd) ?? 0, xe = R === "rtl" ? m.key === "ArrowRight" : m.key === "ArrowLeft";
        if (!!Bt && (pe !== Qt || (xe ? pe > 0 : Qt < Bt.value.length))) return;
      }
      if (m.shiftKey || _ === "books" && G !== Nt.current && (G != null && G.closest('button, a, [role="button"]')))
        return;
      const St = (() => {
        const Bt = _ === "books" && I && zt && I.chapterNum ? { bookId: I.book, chapterNum: I.chapterNum } : void 0, pe = _ === "verses" ? { bookId: q, chapterNum: at } : Bt;
        if (pe) {
        ...
        if (_ === "chapters" || _ === "books" && I && qe(I.book) > 1) {
    ...
    const { isLetter: G, isDigit: lt } = mn(m.key);
    (G || lt) && (m.preventDefault(), $((St) => St + m.key), (Yt = Nt.current) == null || Yt.focus(), tt(!1));
  }, []);
  Ht(() => {
    const m = setTimeout(() => {
      if (M && _ === "books" && Et.current && oe.current) {
        const G = Et.current, lt = oe.current, jt = lt.offsetTop, Yt = G.clientHeight, St = lt.clientHeight, ie = jt - Yt / 2 + St / 2;
        G.scrollTo({
          top: Math.max(0, ie),
          behavior: "smooth"
        }), W(mo(t.book));
    ...
    if (_ === "verses" && q && at !== void 0) {
      const m = q === t.book && at === t.chapterNum, G = m ? t.verseNum : 1;
      W(
        pa(q, at, G)
      ), setTimeout(() => {
        if (Et.current)
  ...
  const rt = I ? `${I.book} ${I.chapterNum ?? ""} ${I.verseNum ?? ""} ${zt}` : "", Lt = L(""), ue = L(""), be = V(() => {
    ...
    const { book: m, chapterNum: G, verseNum: lt } = I;
    if (zt && G && w)
      return {
        max: w(m, G),
        initial: lt ?? (m === t.book && G === t.chapterNum ? t.verseNum : 1),
        parse: na,
        buildValue: (Yt) => pa(m, G, Yt)
      };
    const jt = qe(m);
    if (!(jt <= 1))
      return {
  ...
  return Ht(() => {
    ...
    const { max: m, initial: G, parse: lt, buildValue: jt } = be, Yt = (St) => {
      const ie = lt(St);
      return ie !== void 0 && ie >= 1 && ie <= m && St === jt(ie) ? ie : void 0;
    };
    if (Lt.current !== rt) {
      Lt.current = rt;
      const St = jt(Math.min(Math.max(G, 1), m));
      ue.current = St, W(St);
      return;
    }
    if (Yt(O) !== void 0) {
    ...
    W(
      Yt(ue.current) !== void 0 ? ue.current : jt(Math.min(Math.max(G, 1), m))
    );
          ...
          wr,
          {
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Ma, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: Q.map(
                      ({ onClick: m, disabled: G, title: lt, icon: jt, group: Yt }, St) => {
                        const ie = /* @__PURE__ */ a(
                          et,
                          {
                            variant: "ghost",
                ...
                _ === "verses" && q && at !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${$e(q, s)} ${at}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !dt && /* @__PURE__ */ u(ur, { ref: Et, children: [
                _ === "books" && /* @__PURE__ */ u(gt, { children: [
                  !I && Object.entries(ze).map(([m, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Je, { heading: Pe(m), children: G.map((lt) => /* @__PURE__ */ a(
                          Si,
                          {
                            bookId: lt,
                            onSelect: (jt) => K(jt),
                  ...
                  I && !zt && qe(I.book) > 1 && // No heading here either, for the same reason as the verse preview above:
                ...
                _ === "verses" && q && at !== void 0 && w && /* @__PURE__ */ a(
                  xn,
                  {
                    bookId: q,
                    chapterNum: at,
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Md = zi ? Ht : Z, sa = { tag: $o };
...
const Id = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Z;
...
const Ld = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Z;
function Bd(t) {
...
function Xd(t) {
  ...
  const o = Zd(t, r), n = il(o), s = sl(n) ? cl(n) : o;
...
let Ca, Le = 0, Ea = 0, ew = 0, yo = 0, ga = 0;
function Nn(t) {
  if (ht === void 0) return;
  let e = t.n;
...
ee.prototype.brand = Qd, ee.prototype.h = function() {
  return !0;
...
ge({ dependencies: [ko, Rn], name: "@lexical/extension/HorizontalRule", nodes: () => [Cr], register(t, e, r) {
  ...
  return Be(t.registerCommand(pw, (i) => {
    const c = ce();
    if (!Se(c)) return !1;
...
const Go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Z;
...
const Tw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Z;
...
function Ow(t, e) {
  ...
  return u(gt, { children: [a(Dw, { editor: n, ...o, ref: e }), r != null && a(Iw, { editor: n, content: r })] });
}
...
function $w({
  ...
  const [e] = Oe(), [r, o] = k(e), [n, s] = k("paragraph"), [i, c] = Aw(), d = () => {
  };
...
const Kw = "verseText", yh = Object.freeze([
...
function kh({
  ...
  const [s, i] = k(Gw), [c, d] = k(n), [l, w] = k(!1), p = L(void 0), h = L(null);
  Z(() => {
    let g = !0;
    const E = h.current;
    if (!E) return;
...
function Pn({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Xw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Zw, { className: "tw:text-xs tw:font-medium", children: z }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          b && /* @__PURE__ */ a(
            "div",
            {
              ...
              onKeyDown: ($) => {
                qo($), ($.key === "Enter" || $.key === " ") && $.stopPropagation();
              },
              onClick: ($) => {
                $.stopPropagation();
              },
...
const Jw = {
  ...
  var gr;
  const [ot, P] = k({}), X = $ ?? ot, q = X.editorState ?? Jw, B = X.assignedUser, at = _ !== void 0, ut = L(X);
  ut.current = X;
  const dt = F(
    (S) => {
  ...
  const Ke = F(
    ...
    async (S) => {
      const ct = de(q) ? Sa(q) : void 0, wt = S.status ? S.assignedUser : B ?? S.assignedUser, zt = await h({
        ...S,
        contents: ct,
        assignedUser: wt
      });
  ...
  const Ne = !Nt || !g || g.length === 0 || !g.includes(c), hr = !de(q) && (B === void 0 || B === pt), Zr = /* @__PURE__ */ a(
    Pn,
    {
      comment: It,
      localizedStrings: o,
          ...
          n && /* @__PURE__ */ u(gt, { children: [
            ...
            E !== !1 && (!qt || de(q)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  Wo(S) && (S.preventDefault(), S.stopPropagation(), (de(q) || B !== void 0 && B !== pt) && Ke());
                },
                onKeyDown: (S) => {
                ...
                children: /* @__PURE__ */ a(
                  Ta,
                  {
                    ...
                    actions: /* @__PURE__ */ u(gt, { children: [
                      B !== void 0 && (de(q) || B !== pt) ? /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Xe(
                        he(
                          "%comment_assigning_to%",
                          o,
...
function eu({
  ...
  const O = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: O }), Y = (P) => P ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: P }) : W, $ = () => {
    ...
    const X = b === P.value, q = `${l}-${P.value}`, B = _(P);
    return (
      ...
      children: W.map((B) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: B.type === "Conflict" ? /* @__PURE__ */ a(iu, { ...at, conflictResolution: E }) : /* @__PURE__ */ a(is, { ...at })
          },
          B.id
        );
      })
...
const Oh = "data-platform-content-zoom-root", su = Ao(
  function({ area: e, ...r }, o) {
    return /* @__PURE__ */ a(
      "div",
      {
...
function Vh({ id: t, label: e, groups: r }) {
  const [o, n] = k(
    Object.fromEntries(
      r.map(
...
function ku({
  ...
  return /* @__PURE__ */ u(Fe, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: yu(t, o, e) }) }) }),
...
function Cu({
  ...
  return /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: _u(t, r) }) }) }),
      /* @__PURE__ */ a(yt, { children: /* @__PURE__ */ a("p", { children: Nu(t, r) }) })
    ] }) }),
...
function jh({
  ...
  const [g, E] = k("generated"), [y, C] = k("generated"), [N, A] = k("*"), [R, z] = k("*"), [M, T] = k("f"), [O, W] = k(!1), [Y, $] = k(!0), [_, ot] = k(!1), P = L(!1), X = L(""), [q, B] = k(!1), [at, ut] = k(), [dt, tt] = k(), [pt, kt] = k(), [mt, Rt] = k(), Ft = L(null), Pt = L(
    void 0
  ...
  const _e = () => {
    ...
    if (K && Ir("note", K)) {
      ...
      M !== "x" && D === "x" ? st == null || st.forEach((it) => Ou(it)) : M === "x" && D !== "x" && (st == null || st.forEach((it) => Iu(it))), (nt = h.current) == null || nt.applyUpdate([K, { delete: 1 }]);
    }
  }, le = (D) => {
  ...
  Z(() => {
    ...
    const K = (H) => {
      const Q = D();
      !q && Q && document.activeElement === Q && H.key === c ? (H.preventDefault(), Zt()) : q && H.key === "Escape" && (H.preventDefault(), B(!1));
    };
...
const Bu = (t) => {
  ...
  return e ? e[1] : "";
}, ju = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Zh = Object.freeze([
...
function Jh({
  ...
  }, [z, ot]), X = V(() => P.length === 0 ? [] : Uu(P, T, W), [P, T, W]), q = V(() => {
    var kt, mt;
    if (!z) return d;
...
const Hu = "16rem", Gu = "3rem", cs = re.createContext(void 0);
function La() {
...
function tp({
  ...
  const c = t ? Xr.Root : "button", { state: d } = La(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Qu({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Wu,
    {
      ...
      children: /* @__PURE__ */ u(Xu, { children: [
        /* @__PURE__ */ u(Ln, { children: [
          ...
          /* @__PURE__ */ a(Fn, { children: /* @__PURE__ */ a(Zu, { children: Object.entries(e).map(([g, E]) => /* @__PURE__ */ a(Ju, { children: /* @__PURE__ */ a(
            tp,
            {
              onClick: () => p(g),
              isActive: x(g),
...
const Ge = "scrBook", rp = "scrRef", nr = "source", ap = "details", op = "Scripture Reference", np = "Scripture Book", ls = "Type", ip = "Details";
function sp(t, e) {
  const r = e ?? !1;
  return [
    {
...
function pg({
  ...
  const [l, w] = k([]), [p, h] = k([{ id: Ge, desc: !1 }]), [f, b] = k({}), x = V(
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(lu, { children: N.map((T) => /* @__PURE__ */ a(ye, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
...
function gg({
  ...
  const R = Ut(
  ...
  ] }), mt = e ? pt.filter((U) => e.includes(U.value)) : pt, Rt = g ?? qa, Ft = h ?? Rt, Pt = f ?? Rt, fe = () => {
  ...
  ), Ot = mt.find((U) => U.value === "selectedBooks"), qt = mt.find((U) => U.value === "range"), [It, D] = k(!1), [K, J] = k(void 0), [H, Q] = k(void 0), [j, nt] = k(void 0), [st, it] = k(void 0), [vt, Ct] = k([]), Tt = p === "dropdown" && K === "selectedBooks", Wt = /* @__PURE__ */ a(
    up,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a($t, { htmlFor: "scope-range-start", className: v(ar && Pe), children: q }),
      /* @__PURE__ */ a(
        Ya,
        {
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(bt, { children: [
  /* @__PURE__ */ a(xt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Gs, { children: /* @__PURE__ */ a(qs, { children: ps(
      t,
      e,
      ds(t, c.id),
      o
...
const vp = Object.freeze([520, 420, 340]), gs = re.forwardRef(
...
const bp = re.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ke.Trigger,
  {
    ref: r,
    ...e,
...
function vf({ value: t, children: e }) {
...
export {
  ...
  Oh as CONTENT_ZOOM_ROOT_ATTRIBUTE,
  ...
  Hg as ContextMenuLabel,
  Ag as ContextMenuPortal,
  Vg as ContextMenuRadioGroup,
  ...
  zg as ContextMenuTrigger,
  pu as DataTable,
  Rg as DestructiveKeyConfirmation,
  io as Dialog,
  Ef as DialogClose,
  so as DialogContent,
  ...
  Ah as ERROR_POPOVER_STRING_KEYS,
  xu as EditorKeyboardShortcuts,
  Mf as Empty,
  Of as EmptyContent,
  If as EmptyDescription,
  zf as EmptyHeader,
  Pf as EmptyMedia,
  Af as EmptyState,
  $f as EmptyTitle,
  ...
  $u as FootnoteItem,
  Kh as FootnoteList,
  Eg as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Zh as INVENTORY_STRING_KEYS,
  Ia as Input,
  Tg as InterfaceLanguagePicker,
  Jh as Inventory,
  wo as Kbd,
  Vf as KbdGroup,
  $t as Label,
  ...
  Yu as SidebarInset,
  Zu as SidebarMenu,
  ig as SidebarMenuAction,
  sg as SidebarMenuBadge,
  tp as SidebarMenuButton,
  Ju as SidebarMenuItem,
  cg as SidebarMenuSkeleton,
  lg as SidebarMenuSub,
  wg as SidebarMenuSubButton,
  dg as SidebarMenuSubItem,
  ...
  Gf as Spinner,
  nf as Switch,
  bf as TOOLTIP_DELAY_MS,
  No as TabDropdownMenu,
  yg as TabFloatingMenu,
  xg as TabToolbar,
  Ro as Table,
  Mo as TableBody,
  qf as TableCaption,
  ...
  Yf as Z_INDEX_CONNECTION_LOST,
  Xf as Z_INDEX_FIRST_RUN,
  Zf as Z_INDEX_MODAL,
  ...
  Wh as getLinesFromUSFM,
  Yh as getNumberFromUSFM,
  ju as getStatusForItem,
  _g as getToolbarOSReservedSpaceClassName,
  ...
  wf as useEvent,
  uf as useEventAsync,
  gf as useExtraValidMarkers,
  Rs as useListbox,
  Up as usePromise,
  mh as useRecentSearches,
  pf as useRetryablePromise,
