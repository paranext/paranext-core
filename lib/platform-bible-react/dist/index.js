...
import m, { forwardRef as Ue, useRef as nt, useMemo as H, useCallback as L, useState as I, useLayoutEffect as fn, createContext as Pr, useContext as zr, useEffect as Mt, Fragment as En } from "react";
import { Command as wt } from "cmdk";
import { X as Ye, Search as Vn, Check as Ct, ChevronsLeft as gn, ChevronsRight as bn, ChevronLeft as Pe, ChevronRight as Pt, ArrowLeft as Br, ArrowRight as jr, Circle as fe, ChevronsUpDown as Ke, FilterIcon as $r, ChevronDown as ge, ChevronUp as Lr, ArrowLeftIcon as Fr, ChevronLeftIcon as Gr, ChevronRightIcon as Xr, ArrowRightIcon as Hr, Copy as Ur, Filter as Yr, User as Kr, Link as qr, CircleHelp as Jr, Star as Wr, CircleCheckIcon as Zr, CircleXIcon as Qr, CircleHelpIcon as to, ArrowUpIcon as eo, ArrowDownIcon as no, ArrowUpDownIcon as ro, PanelLeft as oo, PanelRight as ao, ScrollText as so, MenuIcon as io, Menu as wo, EllipsisVertical as lo, LoaderCircle as co } from "lucide-react";
import { clsx as po } from "clsx";
import { extendTailwindMerge as mo } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { Section as V, doesBookMatchQuery as qe, getChaptersForBook as uo, formatScrRef as Wt, getSectionForBook as Zt, NumberFormat as ho, formatBytes as fo, getCurrentLocale as go, deepEqual as Je, isString as Te, compareScrRefs as ze, scrRefToBBBCCCVVV as Ee, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
import { useReactTable as Dn, getFilteredRowModel as bo, getSortedRowModel as On, getPaginationRowModel as vo, getCoreRowModel as In, flexRender as Qt, getGroupedRowModel as xo, getExpandedRowModel as yo } from "@tanstack/react-table";
import * as F from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as No } from "@radix-ui/react-dropdown-menu";
import * as K from "@radix-ui/react-select";
import ko from "markdown-to-jsx";
...
import { useHotkeys as Co } from "react-hotkeys-hook";
...
import { Toaster as _o } from "sonner";
import { toast as sw } from "sonner";
import * as Jt from "@radix-ui/react-slider";
import * as $e from "@radix-ui/react-switch";
const So = mo({ prefix: "tw-" });
function d(...t) {
  return So(po(t));
}
const Ro = "layoutDirection";
function et() {
  const t = localStorage.getItem(Ro);
  return t === "rtl" ? t : "ltr";
}
const To = ft.Portal, zn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
const Eo = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = et();
...
Eo.displayName = ft.Content.displayName;
...
Vo.displayName = ft.Title.displayName;
...
Mo.displayName = ft.Description.displayName;
...
const Bn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Separator,
  {
    ref: n,
...
var Do = Object.defineProperty, Oo = (t, e, n) => e in t ? Do(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => Oo(t, typeof e != "symbol" ? e + "" : e, n);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
const Un = z.allBookIds.filter(
  (t) => !z.isObsolete(z.bookIdToNumber(t))
), Vt = Object.fromEntries(
  Un.map((t) => [t, z.bookIdToEnglishName(t)])
), Yn = Ue(
  ({
    bookId: t,
    isSelected: e,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Lt : "button", { className: d(Ho({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
function Le(t, e, n) {
  return `${t} ${Vt[t]}${e ? ` ${tn(t, e)} ${At(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
const Ve = {
...
function Nn({
  ...
  if (t)
    return /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r("div", { className: d("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ht(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Gt,
      {
        value: `${t} ${Vt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ci({
  ...
  const i = et(), [w, p] = I(!1), [c, u] = I(""), [g, h] = I(""), [f, b] = I("books"), [v, x] = I(void 0), [C, y] = I(!1), D = nt(void 0), j = nt(void 0), W = nt(void 0), U = nt(void 0), gt = nt({}), k = H(() => o ? o() : Un, [o]), T = H(() => ({
    [V.OT]: k.filter((A) => z.isBookOT(A)),
    [V.NT]: k.filter((A) => z.isBookNT(A)),
    [V.DC]: k.filter((A) => z.isBookDC(A)),
    [V.Extra]: k.filter((A) => z.extraBooks().includes(A))
    ...
    (N) => {
      const A = f === "chapters" ? v : _ == null ? void 0 : _.book;
      A && (e({
        book: A,
        chapterNum: N,
        verseNum: 1
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: A, isDigit: J } = yn(N.key);
      if (f === "chapters") {
        if (N.key === "Backspace") {
      ...
      if ((f === "chapters" || f === "books" && _) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key)) {
        ...
        vt !== st && (N.preventDefault(), N.stopPropagation(), u(Le(ot, a, vt)), setTimeout(() => {
    ...
    const { isLetter: A, isDigit: J } = yn(N.key);
    (A || J) && (N.preventDefault(), h((ot) => ot + N.key), j.current.focus(), y(!1));
  }, []);
  return fn(() => {
    const N = setTimeout(() => {
      if (w && f === "books" && W.current && U.current) {
        const A = W.current, J = U.current, ot = J.offsetTop, st = A.clientHeight, St = J.clientHeight, vt = ot - st / 2 + St / 2;
        A.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), u(Le(t.book));
    ...
    if (f === "chapters" && v) {
      ...
      setTimeout(() => {
        if (W.current)
          if (N) {
            const A = gt.current[t.chapterNum];
      ...
      se,
      {
        ...
        children: [
          f === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Y.map(({ onClick: N, disabled: A, title: J, icon: ot }) => /* @__PURE__ */ r(
              O,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              O,
              {
                ...
                tabIndex: -1,
                children: i === "ltr" ? /* @__PURE__ */ r(Br, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(jr, { className: "tw-h-4 tw-w-4" })
              }
            ),
          ...
          !C && /* @__PURE__ */ l(we, { ref: W, children: [
            f === "books" && /* @__PURE__ */ l(te, { children: [
              !_ && Object.entries(B).map(([N, A]) => {
                if (A.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(zt, { heading: Vr(N), children: A.map((J) => /* @__PURE__ */ r(
                      Yn,
                      {
                        bookId: J,
                        onSelect: (ot) => R(ot),
...
), Q = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Mn.Root, { ref: n, className: d("pr-twp", qo(), t), ...e }));
Q.displayName = Mn.Root.displayName;
...
}), Kn = F.Trigger, qn = F.Group, Qo = F.Portal, ta = F.Sub, ea = F.RadioGroup;
function rn({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(nn.Provider, { value: n, children: /* @__PURE__ */ r(F.Root, { ...e }) });
}
const Jn = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = mt();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
Jn.displayName = F.SubTrigger.displayName;
...
Wn.displayName = F.SubContent.displayName;
...
xe.displayName = F.Content.displayName;
const Zn = m.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = et(), s = mt();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
Zn.displayName = F.Item.displayName;
const on = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
on.displayName = F.CheckboxItem.displayName;
const Qn = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(fe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Qn.displayName = F.RadioItem.displayName;
...
an.displayName = F.Label.displayName;
...
function ra({ table: t }) {
  return /* @__PURE__ */ l(rn, { children: [
    /* @__PURE__ */ r(No, { asChild: !0, children: /* @__PURE__ */ l(O, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Bt = K.Root, oa = K.Group, jt = K.Value, aa = _t(
...
), Ot = m.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = et();
  return /* @__PURE__ */ l(
    K.Trigger,
    {
...
const It = m.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = et();
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        Bt,
        {
          ...
          children: [
            /* @__PURE__ */ r(Ot, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(jt, { placeholder: t.getState().pagination.pageSize }) }),
...
function ha({
  ...
  var x;
  const [w, p] = I([]), [c, u] = I([]), [g, h] = I({}), [f, b] = I({}), v = Dn({
    data: e,
    columns: t,
    getCoreRowModel: In(),
    ...n && { getPaginationRowModel: vo() },
    onSortingChange: p,
    getSortedRowModel: On(),
    onColumnFiltersChange: u,
    getFilteredRowModel: bo(),
...
function hi({ id: t, markdown: e, className: n, anchorTarget: o }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(ko, { options: a, children: e }) });
}
...
function ga({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(O, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Ur, {}) })
    ] }),
...
function bi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(rn, { children: [
    /* @__PURE__ */ r(Kn, { asChild: !0, children: /* @__PURE__ */ l(O, { variant: "default", children: [
      /* @__PURE__ */ r(Yr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
...
function ya({
  ...
  const [g, h] = I(!1), f = L(
    ...
    const x = t.filter((y) => y.starred).sort((y, D) => y.label.localeCompare(D.label)), C = t.filter((y) => !y.starred).sort((y, D) => {
      const j = n.includes(y.value), W = n.includes(D.value);
      return j && !W ? -1 : !j && W ? 1 : y.label.localeCompare(D.label);
    });
    return [...x, ...C];
  }, [t, n, p]);
  ...
  return /* @__PURE__ */ l(Ne, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Ce, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      kt,
      {
        ...
        children: [
          /* @__PURE__ */ r($t, { children: `${z.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
ka.displayName = An.Root.displayName;
const rr = m.createContext({
  size: "default",
  variant: "default"
}), or = m.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = et();
  return /* @__PURE__ */ r(
    be.Root,
    {
...
const _e = (t) => t === "asc" ? /* @__PURE__ */ r(eo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(no, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ro, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ni = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(or, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        pe,
        {
          onClick: (p) => {
...
function Ei({
  ...
  const c = xt(n, "%webView_inventory_all%"), u = xt(n, "%webView_inventory_approved%"), g = xt(n, "%webView_inventory_unapproved%"), h = xt(n, "%webView_inventory_unknown%"), f = xt(n, "%webView_inventory_scope_currentBook%"), b = xt(n, "%webView_inventory_scope_chapter%"), v = xt(n, "%webView_inventory_scope_verse%"), x = xt(n, "%webView_inventory_filter_text%"), C = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, D] = I(!1), [j, W] = I("all"), [U, gt] = I(""), [k, T] = I([]), rt = H(() => t.length === 0 ? [] : Ra(t, a, s), [t, a, s]), B = H(() => {
    if (y) return rt;
    const S = [];
    return rt.forEach((Z) => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        Bt,
        {
          ...
          defaultValue: j,
          children: [
            /* @__PURE__ */ r(Ot, { className: "tw-m-1", children: /* @__PURE__ */ r(jt, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ l(Bt, { onValueChange: (S) => tt(S), defaultValue: i, children: [
        /* @__PURE__ */ r(Ot, { className: "tw-m-1", children: /* @__PURE__ */ r(jt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(It, { children: [
    ...
    $.length > 0 && /* @__PURE__ */ r("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ r(
      Na,
      {
        occurrenceData: $,
        setScriptureReference: e,
...
wn.displayName = Pn.Root.displayName;
...
const Ta = "16rem", Ea = "3rem", ar = m.createContext(void 0);
function Re() {
  const t = m.useContext(ar);
  if (!t)
...
const sr = m.forwardRef(
  ({
    ...
    const [c, u] = m.useState(t), g = e ?? c, h = m.useCallback(
      (D) => {
        const j = typeof D == "function" ? D(g) : D;
        n ? n(j) : u(j);
      },
      [n, g]
    ), f = m.useCallback(() => h((D) => !D), [h]), b = g ? "expanded" : "collapsed", C = et() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = m.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(ar.Provider, { value: y, children: /* @__PURE__ */ r(ln, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const ir = m.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Re();
...
const Va = m.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ l(
    O,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(oo, {}) : /* @__PURE__ */ r(ao, {}),
...
const za = _t(
  ...
  ({
    ...
    const p = t ? Lt : "button", { state: c } = Re(), u = /* @__PURE__ */ r(
      p,
      {
        ref: w,
        ...
        "data-size": o,
        "data-active": e,
        className: d(za({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Ba = m.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Lt : "button",
  {
    ref: a,
...
Ba.displayName = "SidebarMenuAction";
...
const $a = m.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
    ...
    /* @__PURE__ */ l(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(wr, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Nt = "scrBook", Ha = "scrRef", Et = "source", Ua = "details", Ya = "Scripture Reference", Ka = "Scripture Book", mr = "Type", qa = "Details";
function Ja(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? z.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Nt ? Wt(a.start) : void 0;
      },
...
const Wa = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || ze(t.start, t.end) === 0 ? `${Ee(t.start)}+${e}` : `${Ee(t.start)}+${e}-${Ee(t.end)}+${n}`;
...
function Mi({
  ...
  const x = Dn({
    ...
    getExpandedRowModel: yo(),
    getGroupedRowModel: xo(),
    getCoreRowModel: In(),
    getSortedRowModel: On(),
    getRowId: Sn,
    autoResetExpanded: !1,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      Bt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ot, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(jt, {}) }),
          /* @__PURE__ */ r(It, { position: "item-aligned", children: /* @__PURE__ */ r(oa, { children: D.map((k) => /* @__PURE__ */ r(ct, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
...
}), ur = (t, e, n) => mn(t, e).every((o) => n.includes(o));
function Za({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
...
function Qa({
  ...
  }, [x, C] = I(!1), [y, D] = I(""), j = nt(void 0), W = nt(!1);
  ...
  const U = H(() => z.allBookIds.filter(
    ...
    (R, tt = !1) => {
      ...
      const Y = U.findIndex((q) => q === j.current), $ = U.findIndex((q) => q === R);
      if (Y === -1 || $ === -1) return;
      const [S, Z] = [
        Math.min(Y, $),
        Math.max(Y, $)
    ...
    (R) => {
      ...
      n(
        ur(U, R, e) ? e.filter((Y) => !tt.includes(Y)) : [.../* @__PURE__ */ new Set([...e, ...tt])]
      );
    },
    [e, n, U]
  ), _ = () => {
                    ...
                    if (Y.length !== 0)
                      return /* @__PURE__ */ l(En, { children: [
                        /* @__PURE__ */ r(
                          zt,
                          {
                            heading: Hn(R, h, f, b, v),
                            children: Y.map(($) => /* @__PURE__ */ r(
                              Yn,
                              {
                                bookId: $,
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          It,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((p) => /* @__PURE__ */ r(ct, { value: `${p}`, children: i[P(p)] }, `${p}`))
          }
        )
      ]
    }
...
const fr = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(cn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(Qo, { children: /* @__PURE__ */ r(Wn, { children: fr(
      t,
      e,
      hr(t, w.id),
      o
...
function Tn({
  ...
  return /* @__PURE__ */ l(rn, { variant: s, children: [
    /* @__PURE__ */ r(Kn, { "aria-label": n, className: a, asChild: !0, id: i, children: /* @__PURE__ */ r(O, { variant: "ghost", size: "icon", children: o ?? /* @__PURE__ */ r(io, {}) }) }),
...
function ji({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(gr, { children: [
      /* @__PURE__ */ r(br, { children: t.map((i) => /* @__PURE__ */ r(ts, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(vr, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function es({ ...t }) {
...
const xr = m.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = m.useMemo(
    () => ({
      variant: e
    }),
...
xr.displayName = G.Root.displayName;
const yr = m.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    G.Trigger,
    {
...
Nr.displayName = G.SubTrigger.displayName;
const kr = m.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    G.SubContent,
    {
...
kr.displayName = G.SubContent.displayName;
const Cr = m.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = mt();
...
Cr.displayName = G.Content.displayName;
const _r = m.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ r(
    G.Item,
    {
...
_r.displayName = G.Item.displayName;
...
os.displayName = G.RadioItem.displayName;
...
as.displayName = G.Label.displayName;
...
Sr.displayName = G.Separator.displayName;
const qt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    ...
    return w.length > 0 && i < a.length - 1 && p.push(/* @__PURE__ */ r(Sr, {}, `separator-${s}`)), p;
  });
};
function ss({
  menuData: t,
  ...
  if (Co(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, g) => {
    var b, v, x, C;
    u.preventDefault();
    ...
    return /* @__PURE__ */ r(xr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, g]) => typeof u == "boolean" || typeof g == "boolean" ? 0 : u.order - g.order).map(([u, g]) => /* @__PURE__ */ l(es, { children: [
      /* @__PURE__ */ r(yr, { ref: c(u), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        Cr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(ln, { children: Rr(t.groups, t.items, u, e) })
        }
      )
    ] }, u)) });
}
...
function Fi({
  ...
  const p = is(
    ...
    return v ? `${(j = t[f]) == null ? void 0 : j.autonym} (${v})` : (W = t[f]) == null ? void 0 : W.autonym;
  };
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      Bt,
      {
        ...
        onOpenChange: (f) => u(f),
        children: [
          /* @__PURE__ */ r(Ot, { children: /* @__PURE__ */ r(jt, {}) }),
          /* @__PURE__ */ r(
            It,
            {
              className: "tw-z-[250]",
...
const ls = Ue(({ className: t, ...e }, n) => /* @__PURE__ */ r(co, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
const Hi = X.Root, Ui = X.Trigger, Yi = X.Group, Ki = X.Portal, qi = X.Sub, Ji = X.RadioGroup, ks = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: a,
    className: d(
...
ks.displayName = X.SubTrigger.displayName;
...
Cs.displayName = X.SubContent.displayName;
const _s = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(X.Portal, { children: /* @__PURE__ */ r(
  X.Content,
  {
    ref: n,
    className: d(
...
_s.displayName = X.Content.displayName;
...
Ss.displayName = X.Item.displayName;
const Rs = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ l(
  X.CheckboxItem,
  {
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
...
const Ts = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  X.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(fe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
...
Vs.displayName = X.Separator.displayName;
...
function Ds({
  ...
  return /* @__PURE__ */ r(Tr.Provider, { value: o, children: /* @__PURE__ */ r(
    pt.Root,
    {
...
const Wi = pt.Trigger, Os = pt.Portal, Zi = pt.Close, Er = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
const Is = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = m.useContext(Tr), i = {
...
zs.displayName = pt.Title.displayName;
...
Ls.displayName = $e.Root.displayName;
