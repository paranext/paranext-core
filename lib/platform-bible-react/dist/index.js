...
import p, { useCallback as X, useMemo as G, useState as P, useRef as H, useLayoutEffect as dn, createContext as Cr, useContext as _r, useEffect as Et, forwardRef as Cn, Fragment as _n } from "react";
...
import { getChaptersForBook as ea, formatScrRef as Jt, NumberFormat as na, formatBytes as ra, deepEqual as Ye, isString as Te, compareScrRefs as Ae, scrRefToBBBCCCVVV as Re, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
...
const ua = Ct(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Xt : "button", { className: l(ua({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
const Q = class D {
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Tt(i)), n ? new D(n, a.toString(), w, u) : new D();
  }
  /**
...
function gn({
  ...
  if (t)
    return /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r("div", { className: l("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ut(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Vt,
      {
        value: `${t} ${ot[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ti({
  ...
  const o = U(), [s, i] = P(!1), [w, u] = P(""), [c, m] = P(""), [g, h] = P("books"), [f, b] = P(void 0), [_, k] = P(!1), S = H(void 0), x = H(void 0), V = H(void 0), I = H(void 0), W = H({}), nt = G(() => a ? a() : Xn, [a]), it = G(() => ({
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: O, isDigit: L } = hn(N.key);
      if (g === "chapters") {
        if (N.key === "Backspace") {
        ...
        if (O || L) {
          if (N.preventDefault(), N.stopPropagation(), h("books"), b(void 0), L && f) {
            const Z = ot[f];
            m(`${Z} ${N.key}`);
          } else
            m(N.key);
    ...
    const { isLetter: O, isDigit: L } = hn(N.key);
    (O || L) && (N.preventDefault(), m((Z) => Z + N.key), x.current.focus(), k(!1));
  }, []);
  return dn(() => {
    const N = setTimeout(() => {
      if (s && g === "books" && V.current && I.current) {
        const O = V.current, L = I.current, Z = L.offsetTop, K = O.clientHeight, xt = L.clientHeight, ft = Z - K / 2 + xt / 2;
        O.scrollTo({
          top: Math.max(0, ft),
          behavior: "smooth"
        }), u(fn(t.book));
      ...
      ae,
      {
        ...
        children: [
          g === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Ht.map(({ onClick: N, disabled: O, title: L, icon: Z }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
              ...
              !y && Object.entries(v).map(([N, O]) => {
                if (O.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Pt, { heading: Da[N], children: O.map((L) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: l(
...
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Tn.Root, { ref: n, className: l("pr-twp", Ia(), t), ...e }));
Y.displayName = Tn.Root.displayName;
    ...
    Je,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Y, { className: "tw-flex tw-items-center", children: a.map((k) => M.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
function Ga({ table: t }) {
  return /* @__PURE__ */ d(Ze, { children: [
    /* @__PURE__ */ r(wa, { asChild: !0, children: /* @__PURE__ */ d(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Bt = F.Root, La = F.Group, jt = F.Value, Ha = Ct(
  ...
  return /* @__PURE__ */ d(
    F.Trigger,
    {
      className: l(Ha({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
const st = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  F.Item,
  {
    ref: a,
    className: l(
...
function eo({
  ...
  var k;
  const [w, u] = P([]), [c, m] = P([]), [g, h] = P({}), [f, b] = P({}), _ = Rn({
    data: e,
    columns: t,
    getCoreRowModel: Vn(),
...
function ri({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = G(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(la, { options: o, children: e }) });
}
...
function oi({
  ...
  return /* @__PURE__ */ d(ie, { children: [
    ...
    /* @__PURE__ */ r(Gt, { className: l("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      no,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function si({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ze, { children: [
    ...
    /* @__PURE__ */ r(ve, { children: n.map((c, m) => /* @__PURE__ */ d("div", { children: [
...
const oo = Ct(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: l("pr-twp", oo({ variant: e }), t), ...n })
);
...
wo.displayName = Dn.Root.displayName;
...
const Ce = (t) => t === "asc" ? /* @__PURE__ */ r(Hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Yr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }), di = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, co = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fi = Object.freeze([
...
function gi({
  ...
  const c = gt(n, "%webView_inventory_all%"), m = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = P(!1), [I, W] = P("all"), [nt, it] = P(""), [C, v] = P([]), y = G(() => t.length === 0 ? [] : uo(t, o, s), [t, o, s]), E = G(() => {
    if (x) return y;
    const T = [];
    return y.forEach((q) => {
...
const mo = "16rem", ho = "3rem", Qn = p.createContext(void 0);
function Se() {
...
const tr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), g = e ?? c, h = p.useCallback(
      ...
      [n, g]
    ), f = p.useCallback(() => h((V) => !V), [h]), b = g ? "expanded" : "collapsed", S = U() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = p.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
...
const er = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Se();
  ...
  ({
    ...
    const u = t ? Xt : "button", { state: c } = Se(), m = /* @__PURE__ */ r(
      u,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: l(ko({ variant: n, size: a }), s),
        ...i
      }
    );
...
const yt = "scrBook", Do = "scrRef", Rt = "source", Mo = "details", zo = "Scripture Reference", Oo = "Scripture Book", ir = "Type", Io = "Details";
function Ao(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, yn = (t) => `${Po({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function vi({
  sources: t,
  ...
  const [u, c] = P([]), [m, g] = P([{ id: yt, desc: !1 }]), [h, f] = P({}), b = G(
...
function Xo({
  ...
  const s = wn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
      ...
      /* @__PURE__ */ r(
        Je,
        {
          ...
          children: k.map(({ value: S, label: x, id: V }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(Y, { htmlFor: V, children: x })
          ] }, V))
        }
      )
    ] }),
...
function Ni({
  ...
  return /* @__PURE__ */ d(
    Bt,
    {
      ...
      children: [
        /* @__PURE__ */ r(Mt, { size: o, className: l("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          jt,
          {
            placeholder: i[A(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          zt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(st, { value: `${u}`, children: i[A(u)] }, `${u}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ d(an, { children: [
  /* @__PURE__ */ r(on, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    Yn,
    {
      onClick: () => {
        a(w);
...
function kn({
  ...
  return /* @__PURE__ */ d(Ze, { variant: s, children: [
    /* @__PURE__ */ r(Fn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Wr, {}) }) }),
    /* @__PURE__ */ r(ve, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w], u, c) => /* @__PURE__ */ d(_n, { children: [
...
function Ti({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(cr, { children: [
      /* @__PURE__ */ r(pr, { children: t.map((i) => /* @__PURE__ */ r(Go, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(ur, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function Lo({ ...t }) {
...
const br = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = lt();
...
Yo.displayName = j.CheckboxItem.displayName;
...
Uo.displayName = j.RadioItem.displayName;
...
const qt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, m) => c.order - m.order).map((c) => /* @__PURE__ */ d(an, { children: [
      /* @__PURE__ */ r(on, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        vr,
        {
          onClick: () => {
            a(c);
    ...
    return w.length > 0 && i < o.length - 1 && u.push(/* @__PURE__ */ r(xr, {}, `separator-${s}`)), u;
  });
};
function Ko({
  menuData: t,
  ...
  if (da(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    ...
    return /* @__PURE__ */ r(mr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ d(Lo, { children: [
...
const Zo = Cn(({ className: t, ...e }, n) => /* @__PURE__ */ r(ta, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
), ts = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(Qo({ variant: e }), t), ...n }));
...
rs.displayName = Ft.Root.displayName;
...
as.displayName = Ft.Image.displayName;
...
os.displayName = Ft.Fallback.displayName;
...
const zi = $.Root, Oi = $.Trigger, Ii = $.Group, Ai = $.Portal, Pi = $.Sub, Bi = $.RadioGroup, ps = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  $.SubTrigger,
  {
    ref: o,
    className: l(
...
us.displayName = $.SubContent.displayName;
const ms = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r($.Portal, { children: /* @__PURE__ */ r(
  $.Content,
  {
    ref: n,
    className: l(
...
ms.displayName = $.Content.displayName;
const hs = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Item,
  {
    ref: a,
    className: l(
...
const fs = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ d(
  $.CheckboxItem,
  {
    ref: o,
    className: l(
...
const gs = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  $.RadioItem,
  {
    ref: a,
    className: l(
...
const bs = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: a,
    className: l(
...
const ks = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
...
const Fi = et.Root, Ds = p.forwardRef(({ className: t, ...e }, n) => {
  const a = U();
  return /* @__PURE__ */ r(
    et.List,
    {
...
const As = (t, e, n = {}) => {
  ...
  const o = H(null), [s, i] = P(void 0), [w, u] = P(void 0), c = X(
    (h) => {
      i(h);
