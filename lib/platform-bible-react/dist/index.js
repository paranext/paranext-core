...
import { c as v, g as ue, a as ta, C as _e, u as $o, T as Dt, b as Ot, d as Mt, e as $t, A as ie, P as De, f as We, B as H, h as Oe, i as Me, j as $e, k as ye, x as Xi, l as Ji, m as Zi, n as Qi, o as so, r as fe, p as ts, q as Cn, s as la, t as da, L as Nt, R as co, v as ea, D as Ba, w as Fa, y as Ua, z as Ka, E as En, F as Hr, G as lo, H as Tn, I as wo, J as qe, K as kr, M as Ie, N as Pe, O as Ae, S as _r, Q as er, U as es, V as Er, W as Ge, X as Se, Z as Ye, Y as Ee, _ as rr, $ as uo, a0 as po, a1 as ra, a2 as ho, a3 as Sn, a4 as rs, a5 as as, a6 as os, a7 as Ha, a8 as zn, a9 as wa, aa as Rn, ab as ns, ac as is, ad as ss, ae as cs, af as Dn, ag as On, ah as go, ai as ls, aj as Mn, ak as Ca, al as Io, am as Ea, an as ds, ao as ws, ap as us, aq as ps, ar as hs, as as Tr, at as fo, au as gs, av as fs } from "./resizable-Ci-qItiT.js";
...
import { Section as _t, getChaptersForBook as Xs, formatScrRef as be, formatReplacementString as Te, getSectionForBook as qr, formatRelativeDate as Js, sanitizeHtml as vo, NumberFormat as Ln, formatBytes as Zs, getCurrentLocale as Qs, usfmMarkers as Gr, getFormatCallerFunction as tc, deepEqual as ec, isString as jo, compareScrRefs as Ya, scrRefToBBBCCCVVV as Ta, defaultScrRef as Sa, formatScrRefRange as rc, getLocalizeKeyForScrollGroupId as Lo, formatReplacementStringToArray as Bo, collectUsjMarkers as ac } from "platform-bible-utils";
...
import { Avatar as _o, Select as Ht, Checkbox as Go, Slot as zr, Tabs as se, Menubar as me, ContextMenu as It, Progress as Wo, Slider as jr, Switch as Yo } from "radix-ui";
import { useReactTable as ri, getFilteredRowModel as wl, getSortedRowModel as ai, getPaginationRowModel as ul, getCoreRowModel as oi, flexRender as xr, getGroupedRowModel as pl, getExpandedRowModel as hl } from "@tanstack/react-table";
import gl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Za, HIDDEN_NOTE_CALLER as Qa, getDefaultViewOptions as fl, isInsertEmbedOpOfType as Lr, Editorial as ml } from "@eten-tech-foundation/platform-editor";
...
function Ra({
  ...
  const { otLong: je, ntLong: Je, dcLong: ur, extraLong: pr } = {
    ...
    () => z >= Wr.TIGHT ? ta(t.book, i) : ue(t.book, i),
    [t.book, i, z]
  ), Le = `${t.chapterNum}:${t.verseNum}`, Mr = j((x) => (J) => {
    oe.current[x] = J;
  }, []), ba = j((x) => (J) => {
    Qt.current[x] = J;
  }, []), $r = M(
    () => Tl(R),
    [R]
  ), hr = M(() => !w || !E || !E.chapterNum || !$r ? !1 : w(E.book, E.chapterNum) > 0, [w, E, $r]), Ir = _ === "books" && !it && !R.trim() && rt.size > 0, gr = j(
    (x) => p ? Jo(x, p) : !1,
    [p]
  ), fr = j(
    (x) => (J) => p ? Sl(x, J, p) : !1,
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            _l,
            {
              primary: Ze,
              secondary: Le,
              showSecondary: z < Wr.MINIMUM,
              isPartial: z >= Wr.TIGHT,
              fullText: Or
            }
          ),
          b && /* @__PURE__ */ a(
        ...
        children: /* @__PURE__ */ u(
          Me,
          {
            ...
            children: [
                  ...
                  !E && Object.entries(wt).map(([x, J]) => {
                    if (J.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(ye, { heading: Rr(x), children: J.map((tt) => /* @__PURE__ */ a(
                          ni,
                          {
                            bookId: tt,
                            onSelect: (D) => Pt(D),
              ...
              Ir && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                H,
                {
                  variant: "ghost",
                  size: "sm",
...
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $l = li ? Yt : G, Fr = { tag: xo };
...
function Zl(t) {
  const e = Wn(t, (r) => Nr(r) && !r.isInline());
  return Nr(e) || aa(4, t.__key), e;
}
function Ql(t) {
  const e = Xt() || mc();
  let r;
  if (he(e)) r = vc(e.focus, "next");
    ...
    r = r || bc(Re(), "previous").getFlipped().insert(Sr());
  }
...
function td(t, e, r) {
  ...
  return Ec(o) && aa(283), o.insert(t.isInline() ? Sr().append(t) : t), Ko(Gn(t.getLatest(), "next"), e.direction);
}
function ed(t) {
  const e = Xt();
  if (!he(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Wn(i, (d) => Nr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let oa, xe = 0, na = 0, od = 0, ao = 0, Xr = 0;
function on(t) {
  if (at === void 0) return;
  let e = t.n;
...
Kt.prototype.brand = rd, Kt.prototype.h = function() {
  ...
  if (this.g = Xr, this.f |= 1, this.i > 0 && !wi(this)) return this.f &= -2, !0;
  const t = at;
  try {
    nn(this), at = this;
    const e = this.x();
...
const So = 0, no = 1, bi = 2, $a = 3, Ur = 4, Qe = 5, Ia = 6, vr = 7;
function Pa(t) {
  return t.id === So;
}
function xi(t) {
...
class wd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ur && lt(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Ur;
    }(e) || lt(313, String(e.id), String(Ur)), e.initResult;
  }
  getInitPeer(e) {
...
const gd = /* @__PURE__ */ new Set(), dn = ae({ build(t, e, r) {
  const o = r.getDependency(oo).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = mi(() => {
  }, () => ge(() => {
...
ae({ dependencies: [oo, dn], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(dn).output, n = Cr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
      ...
      children: /* @__PURE__ */ u(Jd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            et && /* @__PURE__ */ a(kr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: et }),
            /* @__PURE__ */ a(
              H,
              {
                variant: "ghost",
                        ...
                        Oe,
                        {
                          ...
                          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: b == null ? void 0 : b.map((O) => /* @__PURE__ */ a(
                            _e,
                            {
                              ...
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Jr(O, r) })
                            },
                            O || "unassigned"
                          )) }) })
                        }
...
), ew = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Zr = (t) => ew(vo(t));
function Qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function rw({
  ...
  const P = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: P }), L = (_) => _ ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: _ }) : U, Y = () => {
    const _ = o ?? "accept";
    return _ === "merged" ? t.mergedText ? /* @__PURE__ */ a(Qr, { html: T }) : U : L(_ === "reject" ? t.rejectedResultText : t.resultText);
...
function pw({
  ...
  return l ? B = Array.from({ length: 10 }).map((z, P) => `skeleton-row-${P}`).map((z) => /* @__PURE__ */ a(Ee, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: $.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((C = N.getRowModel().rows) == null ? void 0 : C.length) > 0 ? B = N.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    Ee,
    {
      ...
      children: V.getVisibleCells().map((A) => /* @__PURE__ */ a(rr, { children: xr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    V.id
    ...
    /* @__PURE__ */ u(uo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(po, { stickyHeader: i, children: N.getHeaderGroups().map((V) => /* @__PURE__ */ a(Ee, { children: V.headers.map((A) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : xr(A.column.columnDef.header, A.getContext()) }, A.id)) }, V.id)) }),
...
function Qw({
  ...
  const c = t ? zr.Root : "button", { state: l } = va(), d = /* @__PURE__ */ a(
    c,
    {
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      H,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          xr(L.column.columnDef.cell, L.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === La ? La : Nn
      ).map((d) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: ue(d, n) }, d)),
...
function uh({
  ...
  const B = zt(
  ...
  ), ut = pt.find((D) => D.value === "selectedBooks"), ft = pt.find((D) => D.value === "range"), [Pt, Lt] = k(!1), [Bt, qt] = k(void 0), [Zt, O] = k(void 0), [mt, Et] = k(void 0), [ee, je] = k(void 0), [Je, ur] = k([]), pr = w === "dropdown" && Bt === "selectedBooks", Rr = /* @__PURE__ */ a(
    uu,
    {
      availableBookInfo: o,
  ...
  ), Dr = Qt === "end", Or = Qt === "start", Ze = "tw:text-muted-foreground", Le = w === "dropdown" && Bt === "range", Mr = Le ? Et : Z, $r = Le ? je : f ? rt : gt, hr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: v(Dr && Ze), children: S }),
      /* @__PURE__ */ a(
        Ra,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ct, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: v(Or && Ze), children: K }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
  ...
  const [Be, Pr] = k(null), [Fe, xa] = k(null), [Ue, ya] = k(null), ka = 200, [_a, Na] = k(!1);
  G(() => {
          ...
          Ae,
          {
            ...
            children: /* @__PURE__ */ u(Ca, { container: Ue, children: [
              ...
              m && /* @__PURE__ */ u(nt, { children: [
                /* @__PURE__ */ a(Ge, {}),
                /* @__PURE__ */ a(Er, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: dt }),
                /* @__PURE__ */ a(
                  qe,
                  {
                    ref: Jt,
      ...
      Fa,
      {
        ...
        children: /* @__PURE__ */ u(Ca, { container: Fe, children: [
          ...
          /* @__PURE__ */ u(Io, { children: [
            ...
            /* @__PURE__ */ a(H, { onClick: Vr, children: ot })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && ft && /* @__PURE__ */ a(Ba, { open: Bt === "range", onOpenChange: x, children: /* @__PURE__ */ a(
      Fa,
      {
        ...
        children: /* @__PURE__ */ u(Ca, { container: Be, children: [
          ...
          /* @__PURE__ */ u(Io, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => x(!1), children: Q }),
            /* @__PURE__ */ a(H, { ref: ce, onClick: Vr, children: ot })
          ] })
        ] })
      }
    ) })
