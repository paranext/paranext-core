...
import { includes as Rr, Section as Z, getChaptersForBook as ts, formatScrRef as ye, getSectionForBook as fr, formatRelativeDate as es, formatReplacementString as xe, sanitizeHtml as wn, NumberFormat as rs, formatBytes as as, getCurrentLocale as os, usfmMarkers as jr, getFormatCallerFunction as ns, deepEqual as is, isString as vo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as ss, getLocalizeKeyForScrollGroupId as bo } from "platform-bible-utils";
import { Check as Ae, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as Oa, ChevronRight as $a, ArrowLeft as cs, ArrowRight as ls, ChevronDown as or, BoldIcon as ds, ItalicIcon as ws, X as ea, AtSign as un, Pencil as us, Trash2 as ps, ArrowUp as pn, MoreHorizontal as hs, MailOpen as gs, Mail as fs, ChevronUp as ms, FilterIcon as vs, ArrowLeftIcon as bs, ChevronLeftIcon as xs, ChevronRightIcon as ys, ArrowRightIcon as ks, Copy as hn, Filter as _s, User as Ns, Link as Cs, CircleHelp as Es, ChevronsUpDown as gn, Star as Ts, Undo as zs, Redo as Ds, SquareX as fn, FunctionSquare as mn, SquareSigma as vn, Ban as Ss, AlertCircle as Ma, CircleCheckIcon as Os, CircleXIcon as $s, CircleHelpIcon as Ms, ArrowUpIcon as Rs, ArrowDownIcon as As, Search as Ps, LoaderCircle as Is, ScrollText as Vs, MenuIcon as Ls, Menu as js, EllipsisVertical as Fs, MoreVertical as _o } from "lucide-react";
import ut, { useRef as q, useMemo as j, useState as N, useCallback as L, useEffect as Y, useLayoutEffect as Jt, createContext as Ya, useContext as bn, Component as Bs, createElement as No, Suspense as Us, forwardRef as ra, useId as Ks, Fragment as xn } from "react";
import { Dialog as he, Label as qs, RadioGroup as Ra, ToggleGroup as yn, Slot as sr, Avatar as Wa, Select as Pt, Checkbox as Co, Tabs as le, Menubar as me, ContextMenu as Dt, Progress as Eo, Slider as Ar, Switch as To } from "radix-ui";
import { createEditor as kn, $getRoot as Pe, $createParagraphNode as Er, $getSelection as jt, HISTORY_MERGE_TAG as Xa, ParagraphNode as _n, TextNode as Nn, $getPreviousSelection as Gs, $isRangeSelection as ge, $caretFromPoint as Hs, $getSiblingCaret as Cn, $getChildCaret as Ys, $getAdjacentChildCaret as Ws, $isChildCaret as Xs, $normalizeCaret as Js, $setSelectionFromCaretRange as Zs, $getCollapsedCaretRange as Qs, $getCaretInDirection as zo, $splitAtPointCaretNext as tc, $isTextPointCaret as ec, $findMatchingParent as En, $isElementNode as xr, mergeRegister as Ee, getDOMTextNode as rc, isHTMLElement as ac, CLEAR_EDITOR_COMMAND as Tn, COMMAND_PRIORITY_EDITOR as Ja, shallowMergeConfig as oc, defineExtension as ne, safeCast as Qe, createState as nc, FORMAT_TEXT_COMMAND as zn, $isNodeSelection as Dn, COMMAND_PRIORITY_LOW as Sn, RootNode as ic, LineBreakNode as sc, TabNode as cc, $isEditorState as lc, createCommand as dc, CLICK_COMMAND as wc, isDOMNode as uc, $getNodeFromDOMNode as pc, $createNodeSelection as hc, $setSelection as gc, $getEditor as fc, DecoratorNode as Aa, $getState as mc, toggleTextFormatType as Do, TEXT_TYPE_TO_FORMAT as vc, $setState as bc, addClassNamesToElement as On, $create as xc, $getNodeByKey as yc, removeClassNamesFromElement as kc, KEY_TAB_COMMAND as _c, $isBlockElementNode as Nc, $createRangeSelection as Cc, $normalizeSelection__EXPERIMENTAL as Ec, OUTDENT_CONTENT_COMMAND as Tc, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as zc, COMMAND_PRIORITY_CRITICAL as Za, $isDecoratorNode as Dc, $isParagraphNode as Sc, $isTextNode as Pa, SELECTION_CHANGE_COMMAND as $n, $insertNodes as Oc } from "lexical";
...
import { useReactTable as An, getFilteredRowModel as Jc, getSortedRowModel as Pn, getPaginationRowModel as Zc, getCoreRowModel as In, flexRender as mr, getGroupedRowModel as Qc, getExpandedRowModel as tl } from "@tanstack/react-table";
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = qn ? Jt : Y, Ir = { tag: Xa };
function xl({ initialConfig: t, children: e }) {
  const r = j(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = vl(null, o), w = kn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
function Dl() {
  return function(t) {
    const [e] = ve(), r = j(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = q(o);
    return Tl(() => {
...
function Vl(t) {
  ...
  if (ge(e)) r = Hs(e.focus, "next");
    ...
    r = r || Ys(Pe(), "previous").getFlipped().insert(Er());
  }
...
function Ll(t, e, r) {
  ...
  return ec(o) && Hr(283), o.insert(t.isInline() ? Er().append(t) : t), zo(Cn(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = jt();
  if (!ge(e)) return !1;
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [Zn], register: (t, e, r) => t.registerCommand(zn, (o) => {
  const n = jt();
  if (Dn(n) || ge(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, Sn) });
function Qn(t, e) {
  let r;
...
const Zl = ne({ config: Qe({ setOptions: Fo, updateOptions: Fo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ic, Nn, sc, cc, _n] }), Bo = Symbol.for("@lexical/extension/LexicalBuilder");
function Uo() {
}
function Ql(t) {
  throw t;
...
const td = /* @__PURE__ */ new Set(), Ko = ne({ build(t, e, r) {
  ...
  return Ee(t.registerCommand(ed, (s) => {
    ...
    if (uc(s.target)) {
      ...
      if (ad(c)) return function(d, l = !1) {
        ...
        let h;
        l && Dn(w) ? h = w : (h = hc(), gc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function od(t, e, r = ai) {
  return Ee(t.registerCommand(_c, (o) => {
    const n = jt();
    if (!ge(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
function Cd({
  ...
  const [e] = ve(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Nd(), d = () => {
  };
...
function zd() {
  const { activeEditor: t } = ci(), [e, r] = N([]), o = L((n) => {
    if (ge(n) || Yc(n)) {
      const i = [];
      Ho.forEach(({ format: s }) => {
...
function Qu({
  ...
  const [i, s] = N(Rd), [c, d] = N(n), [l, w] = N(!1), p = q(void 0), g = q(null);
  Y(() => {
    let v = !0;
    const T = g.current;
    if (!T) return;
...
function Wo({
  ...
  }, [t.date, r]), v = j(() => t.user, [t.user]), T = j(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), C = j(() => wn(t.contents), [t.contents]), k = j(() => {
    if (o && c)
      return /* @__PURE__ */ u(tt, { children: [
        /* @__PURE__ */ u(
          Ge,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Id, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Vd, { className: "tw:text-xs tw:font-medium", children: T }) }),
        ...
        k && /* @__PURE__ */ u(_e, { children: [
          /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(hs, {}) }) }),
...
function Ld({
  ...
  const Ot = j(() => e.filter((E) => !E.deleted), [e]);
  Y(() => {
    let E = !0;
    if (!o || !k) {
      Kt(/* @__PURE__ */ new Map());
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                B,
                {
                  ...
                  children: ot ? /* @__PURE__ */ a(gs, {}) : /* @__PURE__ */ a(fs, {})
                }
              ),
...
function sp({
  ...
  const [T, C] = N(/* @__PURE__ */ new Set()), [k, _] = N(), [I, F] = N(), V = L(
    async (M) => {
      const Q = await i(M);
...
function Na({ label: t, rawHtml: e }) {
  const r = j(() => qd(wn(e)), [e]), o = /* @__PURE__ */ a(
    "div",
    {
      className: Kd,
...
function Zd({
  ...
  var F;
  const [w, p] = N([]), [g, h] = N([]), [m, y] = N({}), [v, T] = N({}), C = j(() => e ?? [], [e]), k = An({
    data: C,
    columns: t,
    getCoreRowModel: In(),
...
function ow({
  ...
  const d = j(() => /Macintosh/i.test(navigator.userAgent), []), l = tn(n, "%undoButton_tooltip%"), w = tn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(co, { children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(
        B,
...
function sw({
  ...
  return /* @__PURE__ */ u(_e, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
function dw({
  ...
  return /* @__PURE__ */ u(_e, { children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
...
function kp({
  ...
  const [m, y] = N("generated"), [v, T] = N("generated"), [C, k] = N("*"), [_, I] = N("*"), [F, V] = N("f"), [$, x] = N(!1), [z, A] = N(!0), [S, O] = N(!1), W = q(!1), K = q(""), [M, Q] = N(!1), [mt, ct] = N(), [Bt, bt] = N(), [St, U] = N(), [rt, ot] = N(), nt = q(null), it = j(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
function $p({
  ...
  const h = de(r, "%webView_inventory_all%"), m = de(r, "%webView_inventory_approved%"), y = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), T = de(r, "%webView_inventory_scope_currentBook%"), C = de(r, "%webView_inventory_scope_chapter%"), k = de(r, "%webView_inventory_scope_verse%"), _ = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), F = de(r, "%webView_inventory_no_results%"), [V, $] = N(!1), [x, z] = N("all"), [A, S] = N(""), [O, W] = N([]), K = j(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : Tw(U, n, i);
  }, [t, n, i]), M = j(() => {
    if (V) return K;
    const U = [];
    return K.forEach((rt) => {
  ...
  }, [V, K]), Q = j(() => M.length === 0 ? [] : Ew(M, x, A), [M, x, A]), mt = j(() => {
    var ot, nt;
    if (!V) return d;
...
const xi = ra(({ className: t, ...e }, r) => /* @__PURE__ */ a(Is, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Rp({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = j(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = zw(h), T = j(
    ...
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = be(n, "%resourcePicker_no_results%"), z = be(n, "%resourcePicker_showing_count%"), A = j(() => {
...
const Sw = "16rem", Ow = "3rem", yi = ut.createContext(void 0);
function la() {
    ...
    Mw,
    {
      ...
      children: /* @__PURE__ */ u(Aw, { children: [
        /* @__PURE__ */ u(rn, { children: [
          ...
          /* @__PURE__ */ a(on, { children: /* @__PURE__ */ a(Pw, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(Iw, { children: /* @__PURE__ */ a(
            Lw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const $e = "scrBook", Fw = "scrRef", qe = "source", Bw = "details", Uw = "Scripture Reference", Kw = "Scripture Book", ki = "Type", qw = "Details";
function Gw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, nn = (t) => `${Hw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Wp({
  sources: t,
  ...
  const [l, w] = N([]), [p, g] = N([{ id: $e, desc: !1 }]), [h, m] = N({}), y = j(
    ...
    !e && /* @__PURE__ */ u(
      We,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ze, { position: "item-aligned", children: /* @__PURE__ */ a(jd, { children: _.map((x) => /* @__PURE__ */ a(Xt, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
...
function Yw({
  ...
  }, [y, v] = N(!1), [T, C] = N(""), k = q(void 0), _ = q(!1), I = j(
    () => _i(t),
    [t]
  ), F = j(() => {
    if (!T.trim()) {
...
function Jp({
  ...
  }, vt = q(null), Ut = q(null), Kt = q(!1), D = q(null), Ot = q(!1), [Vt, ie] = N(void 0), qt = q(!1), $t = q(!1), Se = q(null), Gt = L((R) => {
    if (R) {
...
function Ga({
  ...
  return /* @__PURE__ */ u(_e, { variant: i, children: [
    /* @__PURE__ */ a(Ne, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ls, {}) }) }),
