...
const ke = I.Trigger, rn = I.Group, Pr = I.Portal, Xr = I.Sub, ns = I.RadioGroup;
...
Lt.displayName = I.Separator.displayName;
...
function as({
  ...
  const o = $(), [i, w] = B(""), [s, p] = B(t.book), [m, u] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, b] = B(!1), [k, v] = B(h), N = Z(void 0), x = Z(void 0), _ = Z(void 0), j = et(
    ...
    ra.forEach((C) => {
      const z = C.exec(i);
      if (z) {
        const [A, G = void 0, F = void 0] = z.slice(1), Dt = sa(A);
        (O.isBookIdValid(A) || Dt) && y(
          Dt ?? A,
          !0,
          G ? parseInt(G, 10) : 1,
          F ? parseInt(F, 10) : 1
...
De.displayName = U.Input.displayName;
...
function _s({
  ...
  return /* @__PURE__ */ d(Wt, { variant: i, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(D, { variant: "ghost", className: "tw-h-6 tw-p-1", children: a ?? /* @__PURE__ */ r(kr, {}) }) }),
