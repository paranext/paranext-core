...
import p, { forwardRef as Re, createContext as ir, useContext as wr, useCallback as U, useState as j, useRef as q, useEffect as it, useLayoutEffect as Ze, useMemo as et, Fragment as dn } from "react";
...
import { ChevronRight as Ee, Check as Ct, Circle as De, X as Ve, Search as cn, ChevronsUpDown as Me, FilterIcon as pr, ChevronDown as Wt, ChevronUp as ur, ArrowLeftIcon as mr, ChevronLeftIcon as hr, ChevronRightIcon as fr, ArrowRightIcon as gr, Filter as br, User as vr, Link as xr, CircleHelp as yr, Star as Nr, CircleCheckIcon as kr, CircleXIcon as Cr, CircleHelpIcon as _r, ArrowUpIcon as Sr, ArrowDownIcon as Tr, ArrowUpDownIcon as Rr, PanelLeft as Er, PanelRight as Dr, ScrollText as Vr, ChevronLeft as Mr, MenuIcon as zr, Menu as Or, EllipsisVertical as Ir, LoaderCircle as Br, Copy as Pr } from "lucide-react";
import { formatScrRef as St, MODIFIER_KEYS as Ar, getChaptersForBook as jr, NumberFormat as Xr, formatBytes as Fr, deepEqual as ze, isString as ue, compareScrRefs as xe, scrRefToBBBCCCVVV as me, getLocalizeKeyForScrollGroupId as B } from "platform-bible-utils";
...
import { useReactTable as un, getFilteredRowModel as Gr, getSortedRowModel as mn, getPaginationRowModel as $r, getCoreRowModel as hn, flexRender as Xt, getGroupedRowModel as Lr, getExpandedRowModel as Yr } from "@tanstack/react-table";
...
const Ie = X.Trigger, bn = X.Group, Zr = X.Portal, Qr = X.Sub, Rs = X.RadioGroup;
...
var ea = Object.defineProperty, na = (t, e, n) => e in t ? ea(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => na(t, typeof e != "symbol" ? e + "" : e, n);
const yt = [
  "GEN",
  "EXO",
  "LEV",
...
const ha = 6, Fe = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), fa = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, en = ["OT", "NT", "DC"], ga = 96, ba = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), va = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', Pt = (t) => jr(M.bookIdToNumber(t));
function xa() {
...
function Ds({
  ...
  const o = H(), [s, i] = j(
    ...
    ba.forEach((h) => {
      const V = h.exec(w);
      if (V) {
        const [C, O = void 0, K = void 0] = V.slice(1), L = Na(C);
    ...
    (h, V) => {
      ...
      if (nn.has(C)) {
        if (m === u) {
          ...
          else C === "ArrowDown" ? L = ha : C === "ArrowUp" && (L = -6);
          if (v + L <= 0 || v + L > Pt(m))
            g(0);
          else if (L !== 0) {
      ...
      Yt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: en.map((h, V) => {
          ...
          return C.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(te, { className: "tw-font-semibold tw-text-foreground/80", children: fa[h] }),
...
const ka = ft(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Dt : "button", { className: d(ka({ variant: e, size: n, className: t })), ref: s, ...o })
);
P.displayName = "Button";
const Ca = ft(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(pn.Root, { ref: n, className: d("pr-twp", Ca(), t), ...e }));
...
const _a = wt.Portal, Rn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
    className: d(
...
Sa.displayName = wt.Content.displayName;
...
Ta.displayName = wt.Title.displayName;
...
Ra.displayName = wt.Description.displayName;
...
function Ma({ table: t }) {
  return /* @__PURE__ */ l(Qt, { children: [
    /* @__PURE__ */ r(cr, { asChild: !0, children: /* @__PURE__ */ l(P, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Tt = G.Root, za = G.Group, Rt = G.Value, Oa = ft(
  ...
  return /* @__PURE__ */ l(
    G.Trigger,
    {
      className: d(Oa({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
function zs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Hr, { options: o, children: e }) });
}
...
Ha.displayName = fn.Root.displayName;
...
const de = (t) => t === "asc" ? /* @__PURE__ */ r(Sr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Tr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Rr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), As = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(On, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Ut,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, qa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ls = Object.freeze([
...
function Ys({
  ...
  const u = pt(n, "%webView_inventory_all%"), f = pt(n, "%webView_inventory_approved%"), v = pt(n, "%webView_inventory_unapproved%"), g = pt(n, "%webView_inventory_unknown%"), m = pt(n, "%webView_inventory_scope_currentBook%"), N = pt(n, "%webView_inventory_scope_chapter%"), T = pt(n, "%webView_inventory_filter_text%"), y = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, _] = j(!1), [S, z] = j("all"), [$, gt] = j(""), [lt, k] = j([]), b = et(() => t.length === 0 ? [] : Ka(t, o, s), [t, o, s]), A = et(() => {
    if (x) return b;
    const D = [];
    return b.forEach((h) => {
...
const Wa = "16rem", Za = "3rem", In = p.createContext(void 0);
function pe() {
  const t = p.useContext(In);
  if (!t)
...
const Bn = p.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(In.Provider, { value: _, children: /* @__PURE__ */ r(qe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
function mo({
  ...
  return /* @__PURE__ */ r(
    Pn,
    {
      ...
      children: /* @__PURE__ */ l(jn, { children: [
        /* @__PURE__ */ l(_e, { children: [
          /* @__PURE__ */ r(Se, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Te, { children: /* @__PURE__ */ r(Xn, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(Fn, { children: /* @__PURE__ */ r(
            Gn,
            {
              onClick: () => u(g),
              isActive: v(g),
...
const ut = "scrBook", ho = "scrRef", xt = "source", fo = "details", go = "Scripture Reference", bo = "Scripture Book", Ln = "Type", vo = "Details";
function xo(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, an = (t) => `${yo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Us({
  sources: t,
    ...
    !e && /* @__PURE__ */ l(
      Tt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(kt, { position: "item-aligned", children: /* @__PURE__ */ r(za, { children: S.map((k) => /* @__PURE__ */ r(rt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      P,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ r(Ee, {}) : /* @__PURE__ */ r(Mr, {})),
                          " ",
...
function So({
  ...
  const z = et(() => M.allBookIds.filter(
    ...
    (b) => {
      ...
      n(
        Yn(z, b, e) ? e.filter((R) => !A.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...A])]
      );
    },
    [e, n, z]
  ), lt = () => {
              ...
              Object.values(mt).map((b, A) => {
                ...
                if (R.length !== 0)
                  return /* @__PURE__ */ l(dn, { children: [
                    ...
                    A < Object.values(mt).length - 1 && /* @__PURE__ */ r(En, {})
                  ] }, b);
              })
            ] })
          ]
...
const Un = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Ke, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(Zr, { children: /* @__PURE__ */ r(xn, { children: Un(
      t,
      e,
      Hn(t, w.id),
      a
...
function sn({
  ...
  return /* @__PURE__ */ l(Qt, { variant: s, children: [
    /* @__PURE__ */ r(Ie, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(P, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(zr, {}) }) }),
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ l(dn, { children: [
      /* @__PURE__ */ r(bn, { children: /* @__PURE__ */ r(qe, { children: Un(e.groups, e.items, w, t) }) }),
...
function ei({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(qn, { children: [
      /* @__PURE__ */ r(Jn, { children: t.map((i) => /* @__PURE__ */ r(To, { value: i.value, children: i.value }, i.key)) }),
...
Do.displayName = F.CheckboxItem.displayName;
...
Vo.displayName = F.RadioItem.displayName;
...
Mo.displayName = F.Label.displayName;
...
function zo({
  ...
  if (Ur(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (f, v) => {
    ...
    return /* @__PURE__ */ r(Wn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, f]) => typeof f == "object").sort(([, f], [, v]) => typeof f == "boolean" || typeof v == "boolean" ? 0 : f.order - v.order).map(([f, v]) => /* @__PURE__ */ l(Ro, { children: [
...
const Bo = Re(({ className: t, ...e }, n) => /* @__PURE__ */ r(Br, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function wi({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(P, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Pr, {}) })
    ] }),
...
), Ao = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(Po({ variant: e }), t), ...n }));
...
Fo.displayName = Vt.Root.displayName;
...
Go.displayName = Vt.Image.displayName;
...
$o.displayName = Vt.Fallback.displayName;
...
Ko.displayName = "Drawer";
const li = at.Trigger, Wo = at.Portal, di = at.Close, sr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
...
es.displayName = at.Title.displayName;
...
ns.displayName = at.Description.displayName;
...
rs.displayName = Ne.Root.displayName;
function ci({ ...t }) {
  return /* @__PURE__ */ r(
    qr,
    {
...
os.displayName = ke.Root.displayName;
const pi = Q.Root, ss = p.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.List,
    {
