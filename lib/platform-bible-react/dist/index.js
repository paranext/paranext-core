...
import { Slot as ke, Dialog as Wt, Popover as rr, Label as ci, RadioGroup as ra, Tooltip as Le, ToggleGroup as Ro, Separator as di, Avatar as ya, DropdownMenu as vt, Select as Et, Checkbox as Ua, Tabs as Kt, Menubar as Jt, ContextMenu as bt, Progress as Ka, Slider as dr, Switch as Ga } from "radix-ui";
...
import { includes as wr, Section as Y, getChaptersForBook as _i, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as Ni, formatReplacementString as fe, sanitizeHtml as Ci, NumberFormat as Ei, formatBytes as zi, getCurrentLocale as Ti, usfmMarkers as mr, getFormatCallerFunction as Si, deepEqual as Di, isString as qa, compareScrRefs as aa, scrRefToBBBCCCVVV as Fr, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
...
const Ye = 250, on = 300, kl = 400, _l = 450, Nl = 500, nn = Zt(
...
function Il({
  ...
  return /* @__PURE__ */ u(de, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ a(we, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(le, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      ce,
      {
        onSelect: () => h(p),
...
function Du(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (l) => !r(l, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function Vl(t, e, r, o) {
  const n = j(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const c = e[d - 1], w = Math.max(Ht(c), 1);
        o({
          book: c,
          chapterNum: w,
          verseNum: 1
...
function no({
  ...
  if (t)
    return /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: Ht(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
      ce,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function Ru({
  ...
  const c = st(), [w, g] = S(!1), [h, p] = S(""), [m, b] = S(""), [v, C] = S("books"), [y, N] = S(void 0), [_, I] = S(!1), $ = K(void 0), O = K(void 0), E = K(void 0), k = K(void 0), z = K({}), M = j(
    (R) => {
      e(R), l && l(R);
    },
    [e, l]
    ...
    (R) => {
      ...
      if (v === "chapters") {
        ...
        if (H || Z) {
          if (R.preventDefault(), R.stopPropagation(), C("books"), N(void 0), Z && y) {
            const ut = Re[y];
            b(`${ut} ${R.key}`);
          } else
            b(R.key);
    ...
    const { isLetter: H, isDigit: Z } = oo(R.key);
    (H || Z) && (R.preventDefault(), b((ut) => ut + R.key), O.current.focus(), I(!1));
  }, []);
  return At(() => {
    const R = setTimeout(() => {
      if (w && v === "books" && E.current && k.current) {
        const H = E.current, Z = k.current, ut = Z.offsetTop, ot = H.clientHeight, Dt = Z.clientHeight, D = ut - ot / 2 + Dt / 2;
        H.scrollTo({
          top: Math.max(0, D),
          behavior: "smooth"
        }), p(wa(t.book));
  ...
  }, [v, y, x, t.book, t.chapterNum]), /* @__PURE__ */ u(de, { open: w, onOpenChange: U, children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
      V,
      {
        ...
        children: /* @__PURE__ */ a("span", { className: "tw:truncate", children: ge })
      }
    ) }),
    /* @__PURE__ */ a(we, { id: d, forceMount: !0, className: "tw:w-[280px] tw:p-0", align: "center", children: /* @__PURE__ */ u(
      Ne,
      {
        ref: $,
        onKeyDown: Ft,
        ...
        children: [
          ...
          !_ && /* @__PURE__ */ u(Ce, { ref: E, children: [
            v === "books" && /* @__PURE__ */ u(et, { children: [
              !x && Object.entries(W).map(([R, H]) => {
                if (H.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ a(le, { heading: pe(R), children: H.map((Z) => /* @__PURE__ */ a(
                      un,
                      {
                        bookId: Z,
                        onSelect: (ut) => ct(ut),
              ...
              x && /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a(
                ce,
                {
              ...
              x && Ht(x.book) > 1 && /* @__PURE__ */ u(et, { children: [
...
function pa({
  ...
  const [N, _] = S(!1), I = c ?? d, $ = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], O = (E, k) => {
    const z = d(E), M = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, L = `${k ?? ""}${z}${M ?? ""}`;
    return /* @__PURE__ */ u(
      ce,
      {
        value: z,
  ...
  return /* @__PURE__ */ u(de, { open: N, onOpenChange: _, ...y, children: [
    ...
    /* @__PURE__ */ a(
      we,
      {
        ...
        children: /* @__PURE__ */ u(Ne, { children: [
          ...
          /* @__PURE__ */ a(Ce, { children: $(e) ? e.map((E) => /* @__PURE__ */ a(le, { heading: E.groupHeading, children: E.options.map((k) => O(k, E.groupHeading)) }, E.groupHeading)) : e.map((E) => O(E)) })
        ] })
      }
    )
  ] });
...
function Ou({
  ...
  const w = Ur(c, "%webView_bookSelector_currentBook%"), g = Ur(c, "%webView_bookSelector_choose%"), h = Ur(c, "%webView_bookSelector_chooseBooks%"), [p, m] = S(
    "current book"
    /* CurrentBook */
  ), b = (v) => {
    m(v), t(v);
...
function Ql() {
  return function(t) {
    const [e] = Qt(), r = P(() => t(e), [e, t]), [o, n] = S(() => r.initialValueFn()), i = K(o);
    return Jl(() => {
...
function oc(t, e, r) {
  ...
  function d() {
    ...
    for (let C = 0; C < p.length; C++) {
      ...
      const E = qt(y.height);
      _.height !== E && (N.style.height = E, v = !0), N.parentNode !== l && (l.append(N), v = !0), s[C] = N;
    }
...
function ic(t, e = nc) {
  ...
  function c(w) {
    w.read(() => {
      const g = Tt();
      if (!Yt(g)) return r = null, n = null, i = null, l = null, d(), void (d = () => {
      });
      const [h, p] = function(E) {
        const k = E.getStartEndPoints();
        return E.isBackward() ? [k[1], k[0]] : k;
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, C = p.getNode(), y = C.getKey(), N = p.offset, _ = t.getElementByKey(b), I = t.getElementByKey(y), $ = r === null || _ !== o || v !== n || b !== r.getKey(), O = i === null || I !== s || N !== l || y !== i.getKey();
      if (($ || O) && _ !== null && I !== null) {
        const E = function(k, z, M, L, q, A, W) {
          const x = (k._window ? k._window.document : document).createRange();
          return x.setStart(...io(z, M, L)), x.setEnd(...io(q, A, W)), x;
        }(t, h, m, _, p, C, I);
        d(), d = oc(t, E, e);
      }
      r = m, o = _, n = v, i = C, s = I, l = N;
    });
  }
  return c(t.getEditorState()), se(t.registerUpdateListener(({ editorState: w }) => c(w)), () => {
    d();
  });
}
function sc(t, e) {
...
function lc(t) {
  const e = Ko(t, (r) => oe(r) && !r.isInline());
  return oe(e) || _r(4, t.__key), e;
}
function cc(t) {
  const e = Tt() || fs();
  let r;
  if (Yt(e)) r = ms(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (r = Uo(l, "next"));
    }
    r = r || vs(ie(), "previous").getFlipped().insert(We());
  }
...
function wc(t) {
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const l = Ko(i, (c) => oe(c) && !c.isInline());
    if (l === null) continue;
    const d = l.getKey();
...
let Nr, ne = 0, Cr = 0, gc = 0, ha = 0, vr = 0;
function lo(t) {
  if (X === void 0) return;
  let e = t.n;
...
Ct.prototype.brand = uc, Ct.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ne !== 0 && Cr === 0 && e.l !== ha && (e.l = ha, Nr = { S: e, v: e.v, i: e.i, o: Nr });
    })(this), this.v = t, this.i++, vr++, ne++;
    try {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, bn(this), co(this), ne++;
  const t = X;
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [kn], register: (t, e, r) => t.registerCommand(Ho, (o) => {
  const n = Tt();
  if (Wo(n) || Yt(n)) for (const i of n.getNodes()) vc(i) && i.toggleFormat(o);
  return !1;
}, Yo) });
function _n(t, e) {
  let r;
...
jt({ dependencies: [fa, go], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return se(t.registerCommand(Ec, (s) => {
    ...
    const s = [];
    for (const { domNode: l, selectedSignal: d } of n.value.nodeSelections.values()) s.push(Xt(() => {
      const c = l.value;
...
function Sc(t, e, r = zn) {
  return se(t.registerCommand(qs, (o) => {
    const n = Tt();
    if (!Yt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Xt(() => r.getOutput().disabled.value ? void 0 : Sn(t)) });
function Oc(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function Lc({ content: t }) {
  const [e] = Qt(), r = function(n) {
    ...
    return Aa(() => {
      ...
      return l(), se(n.registerUpdateListener(() => {
        l();
...
function Xc({
  ...
  const [e] = Qt(), [r, o] = S(e), [n, i] = S("paragraph"), [s, l] = Yc(), d = () => {
  };
...
function Qc() {
  const { activeEditor: t } = $n(), [e, r] = S([]), o = j((n) => {
    if (Yt(n) || ll(n)) {
      const i = [];
      mo.forEach(({ format: s }) => {
...
function od(t, e) {
  ...
  const r = document.createElement("div"), o = ie().getChildren();
  for (let n = 0; n < o.length; n++)
    An(t, o[n], r, e);
  return r.innerHTML;
}
function An(t, e, r, o = null) {
  ...
  const i = oe(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && kr(e) && (s = ec(o, e, "clone"));
  const l = oe(s) ? s.getChildren() : [], d = Qs(t, s.getType());
  let c;
  ...
  for (let p = 0; p < l.length; p++) {
    ...
    !n && oe(e) && b && e.extractWithChild(m, o, "html") && (n = !0);
  }
  if (n && !i) {
...
function Pn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  }(t) && (s = s.concat(Qo())) : oe(l) && l.append(...h), s;
}
function nd(t, e, r) {
...
function Iu({
  ...
  const [i, s] = S(ld), [l, d] = S(n), [c, w] = S(!1), g = K(void 0), h = K(null);
  G(() => {
    let v = !0;
    const C = h.current;
    if (!C) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(de, { open: c, onOpenChange: w, children: [
      /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(
        V,
        {
          variant: "outline",
...
const Pu = Object.freeze([
  ...
  const n = K(null), [i, s] = S(void 0), [l, d] = S(void 0), c = j(
    (p) => {
      s(p);
    ...
    (p) => {
      var O;
      const m = p.target, b = (E) => E ? document.getElementById(E) : void 0, v = b(l), C = b(i);
      if (!!(v && m && v.contains(m) && m !== v) && g(m)) {
        ...
        if (p.key === "ArrowDown" || p.key === "ArrowUp") {
          ...
          const k = E.findIndex((M) => M === m);
          if (k === -1) return;
          let z;
          p.key === "ArrowDown" ? z = Math.min(k + 1, E.length - 1) : z = Math.max(k - 1, 0), z !== k && (p.preventDefault(), p.stopPropagation(), (O = E[z]) == null || O.focus());
          return;
        }
        return;
      }
...
function bo({
  ...
  const p = j(
    (_) => {
      _ && _.stopPropagation(), c(!1), g(void 0), s == null || s(!1);
    },
    [s]
  ), m = j(
    async (_) => {
    ...
    [t.user]
  ), y = P(() => Ci(t.contents), [t.contents]), N = P(() => {
    if (o && l)
      return /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ u(
          va,
          {
            onClick: (_) => {
              _.stopPropagation(), c(!0), g(id(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), p()) : La(_) && (_.preventDefault(), _.stopPropagation(), Ot(w) && m());
              },
              onKeyDown: (_) => {
                Ia(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
        ...
        N && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Pi, {}) }) }),
...
function _d({
  ...
  const [E, k] = S(xo), [z, M] = S(), [L, q] = S(), A = o, [W, x] = S(!1), [F, ct] = S(!1), [xt, Mt] = S(!1), [dt, St] = S(!1), [U, nt] = S(!1), [at, wt] = S(_), [zt, pe] = S(!1), yt = K(void 0), [ge, te] = S(/* @__PURE__ */ new Map());
  G(() => {
    let T = !0;
    return (async () => {
  ...
  G(() => {
    ...
    kt.current === "idle" && (kt.current = "pending"), dt ? kt.current === "pending" && O !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
  ...
  const ee = P(() => Ft[0], [Ft]), R = K(null), H = K(void 0), Z = j(() => {
    var T;
    (T = H.current) == null || T.call(H), k(xo);
  }, []), ut = j(() => {
    const T = !at;
    wt(T), pe(!T), m == null || m(d, T);
  }, [at, m, d]);
  G(() => {
    x(!1);
  }, [o]), G(() => {
  ...
  }, [i, r]), D = P(() => Ft.slice(1), [Ft]), B = P(() => D.length ?? 0, [D.length]), rt = P(() => B > 0, [B]), it = P(() => W || B <= 2 ? D : D.slice(-2), [D, B, W]), pt = P(() => W || B <= 2 ? 0 : B - 2, [B, W]), _t = P(
    () => B === 1 ? ot.singleReply : fe(ot.multipleReplies, { count: B }),
    [B, ot]
  ), Rt = P(
    () => pt === 1 ? ot.singleReply : fe(ot.multipleReplies, { count: pt }),
    [pt, ot]
  );
  G(() => {
    !o && F && rt && ct(!1);
  ...
  const mt = j(
    ...
    async (T) => {
      const gt = Ot(E) ? zr(E) : void 0, ht = T.status ? T.assignedUser : z ?? T.assignedUser, Bt = await g({
        ...T,
        contents: gt,
        assignedUser: ht
      });
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            ...
            /* @__PURE__ */ a(
              bo,
              {
                ...
                handleDeleteComment: p,
                onEditingChange: ct,
                canEditOrDelete: (!F && ge.get(ee.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(et, { children: [
              ...
              it.map((T) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                bo,
                {
                  ...
                  handleDeleteComment: p,
                  onEditingChange: ct,
                  canEditOrDelete: (!F && ge.get(T.id)) ?? !1
                }
              ) }, T.id)),
              v !== !1 && (!F || Ot(E)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (T) => {
                    La(T) && (T.preventDefault(), T.stopPropagation(), (Ot(E) || z !== void 0 && z !== L) && mt());
                  },
                  onKeyDown: (T) => {
                    Ia(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Er,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && (Ot(E) || z !== L) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: fe(
                      ...
                      /* @__PURE__ */ u(de, { open: xt, onOpenChange: Mt, children: [
                        /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
                          V,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ a(
                          we,
                          {
                            ...
                            children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: b == null ? void 0 : b.map((T) => /* @__PURE__ */ a(
                              ce,
                              {
                                onSelect: () => {
                                ...
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: xr(T, r) })
                              },
                              T || "unassigned"
                            )) }) })
                          }
...
function Gu({
  ...
  const [C, y] = S(/* @__PURE__ */ new Set()), [N, _] = S(), [I, $] = S(), O = j(
    async (x) => {
      const F = await i(x);
  ...
  const E = r.filter(
    ...
    [C, b]
  ), { listboxRef: L, activeId: q, handleKeyDown: A } = wd({
    options: k,
    onOptionSelect: z
  }), W = j(
    (x) => {
      ...
      }), _(void 0), b == null || b(void 0)), x.preventDefault(), x.stopPropagation()) : A(x);
    },
    [N, C, A, b]
  );
  return /* @__PURE__ */ a(
...
function Md({
  ...
  var $;
  const [w, g] = S([]), [h, p] = S([]), [m, b] = S({}), [v, C] = S({}), y = P(() => e ?? [], [e]), N = en({
    data: y,
    columns: t,
    getCoreRowModel: an(),
  ...
  let I;
  return d ? I = Array.from({ length: 10 }).map((k, z) => `skeleton-row-${z}`).map((k) => /* @__PURE__ */ a(ae, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, k)) : (($ = N.getRowModel().rows) == null ? void 0 : $.length) > 0 ? I = N.getRowModel().rows.map((O) => /* @__PURE__ */ a(
    ae,
    {
      onClick: () => s(O, N),
      "data-state": O.getIsSelected() && "selected",
      children: O.getVisibleCells().map((E) => /* @__PURE__ */ a(ve, { children: tr(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    O.id
  )) : I = /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a(ve, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: c }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(Nd, { table: N }),
    /* @__PURE__ */ u(Ir, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ja, { stickyHeader: i, children: N.getHeaderGroups().map((O) => /* @__PURE__ */ a(ae, { children: O.headers.map((E) => /* @__PURE__ */ a(Tr, { className: "tw:p-0", children: E.isPlaceholder ? void 0 : tr(E.column.columnDef.header, E.getContext()) }, E.id)) }, O.id)) }),
...
function Zu({
  ...
  return /* @__PURE__ */ u(de, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(we, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
...
function Qu({ id: t, label: e, groups: r }) {
  const [o, n] = S(
    Object.fromEntries(
      r.map(
...
function Kn({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(de, { open: E, onOpenChange: w ?? y, children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(
      V,
      {
        variant: b,
    ...
    /* @__PURE__ */ a(we, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
        ...
        /* @__PURE__ */ a(le, { children: I.map((z) => /* @__PURE__ */ u(
          ce,
          {
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Xi, { className: "tw:h-4 tw:w-4" }),
...
function Vd({
  ...
  const d = P(() => /Macintosh/i.test(navigator.userAgent), []), c = No(n, "%undoButton_tooltip%"), w = No(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Pa, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(
        V,
...
function Bd({
  ...
  const i = K(null), s = K(null), l = K(!1), [d, c] = S(t), [w, g] = S(r), [h, p] = S(!1);
  G(() => {
    c(t);
  }, [t]), G(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    ...
    var C, y, N, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Fd(t, n, r) }) }) }),
...
function Gd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Ud(t, r) }) }) }),
...
function ap({
  ...
  const [m, b] = S("generated"), [v, C] = S("generated"), [y, N] = S("*"), [_, I] = S("*"), [$, O] = S("f"), [E, k] = S(!1), [z, M] = S(!0), [L, q] = S(!1), A = K(!1), W = K(""), [x, F] = S(!1), [ct, xt] = S(), [Mt, dt] = S(), [St, U] = S(), [nt, at] = S(), wt = K(null), zt = P(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  G(() => {
    ...
    if (B && ur("note", B)) {
      ...
      let _t = "custom";
      pt === la ? _t = "generated" : pt === ca ? _t = "hidden" : pt && (N(pt), I(pt)), b(_t), C(_t), O(((it = B.insert.note) == null ? void 0 : it.style) ?? "f"), D = setTimeout(() => {
        var Rt;
  ...
  const yt = j(
    (D, B, rt = !1) => {
      ...
      if (it && ur("note", it)) {
        if (it.insert.note) {
          let mt;
          D === "custom" ? mt = B : D === "generated" ? mt = la : mt = ca, it.insert.note.caller = mt;
        }
  ...
  const Ft = () => {
    ...
    if (B && ur("note", B)) {
      ...
      $ !== "x" && D === "x" ? mt == null || mt.forEach(($t) => Xd($t)) : $ === "x" && D !== "x" && (mt == null || mt.forEach(($t) => Jd($t))), (Rt = w.current) == null || Rt.applyUpdate([B, { delete: 1 }]);
    }
  }, Z = (D) => {
    ...
    (D) => {
      ...
      if (B && ur("note", B)) {
        ...
        if (mt || k(!1), k(
          ...
          A.current = !0, W.current = JSON.stringify(B), M(!0);
          return;
        }
    ...
    if (h.current && pe.length && D && D.rangeCount > 0) {
  ...
  G(() => {
    ...
    var rt;
    const D = ((rt = g.current) == null ? void 0 : rt.querySelector(".editor-input")) ?? void 0, B = (it) => {
  ...
  const w = d ?? Si(r, void 0), g = (y, N) => {
    ...
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), c == null || c(N, _, n);
          break;
      }
  }, v = (y) => {
    if (r.length)
...
function aw({
  ...
  return /* @__PURE__ */ u(Ir, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(ja, { stickyHeader: !0, children: /* @__PURE__ */ u(ae, { children: [
...
const ow = (t) => {
  ...
  return e ? e[1] : "";
}, iw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", up = Object.freeze([
...
function pp({
  ...
  const p = Gt(r, "%webView_inventory_all%"), m = Gt(r, "%webView_inventory_approved%"), b = Gt(r, "%webView_inventory_unapproved%"), v = Gt(r, "%webView_inventory_unknown%"), C = Gt(r, "%webView_inventory_scope_currentBook%"), y = Gt(r, "%webView_inventory_scope_chapter%"), N = Gt(r, "%webView_inventory_scope_verse%"), _ = Gt(r, "%webView_inventory_filter_text%"), I = Gt(
    r,
    "%webView_inventory_show_additional_items%"
  ), $ = Gt(r, "%webView_inventory_no_results%"), [O, E] = S(!1), [k, z] = S("all"), [M, L] = S(""), [q, A] = S([]), W = P(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : lw(U, n, i);
  }, [t, n, i]), x = P(() => {
    if (O) return W;
    const U = [];
    return W.forEach((nt) => {
  ...
  }, [O, W]), F = P(() => x.length === 0 ? [] : sw(x, k, M), [x, k, M]), ct = P(() => {
    var at, wt;
    if (!O) return d;
...
function Zr({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(et, { children: [
      ...
      /* @__PURE__ */ a(Ir, { children: /* @__PURE__ */ a(Pr, { children: e.map((n) => /* @__PURE__ */ u(ae, { children: [
...
function hp({
  ...
  const [i, s] = S(""), [l, d] = S([]), c = P(
    () => t.filter((k) => !e || k.type === e).filter((k) => cw(k, i)).filter(
      (k) => l.length === 0 || l.includes(k.bestLanguageName)
    ),
    [t, e, i, l]
  ), w = P(
    () => c.filter((k) => r == null ? void 0 : r.includes(k.dblEntryUid)),
    [c, r]
  ), g = P(
    () => c.filter((k) => k.installed && !(r != null && r.includes(k.dblEntryUid))),
    [c, r]
  ), h = P(
    () => c.filter(
      (k) => !k.installed && !(r != null && r.includes(k.dblEntryUid))
    ),
    [c, r]
  ), p = P(
    () => Array.from(new Set(t.map((k) => k.bestLanguageName))).map((k) => ({
      label: k,
      value: k
    })),
    [t]
  ), m = w.length === 0 && g.length === 0 && h.length === 0, b = re(o, "%resourcePicker_title%"), v = re(o, "%resourcePicker_search_placeholder%"), C = re(o, "%resourcePicker_language_filter_any%"), y = re(
    o,
    "%resourcePicker_section_already_selected%"
  ), N = re(o, "%resourcePicker_section_installed%"), _ = re(
    o,
    "%resourcePicker_section_available_to_download%"
  ), I = re(o, "%resourcePicker_button_use%"), $ = re(o, "%resourcePicker_no_results%"), O = re(o, "%resourcePicker_showing_count%"), E = i.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(et, { children: [
    /* @__PURE__ */ a(sn, { className: "tw-px-4 tw-pt-4", children: /* @__PURE__ */ a(ln, { children: b }) }),
    ...
    E && /* @__PURE__ */ a("p", { className: "tw-px-4 tw-pb-1 tw-text-right tw-text-xs tw-text-muted-foreground", children: fe(O, {
      filtered: c.length,
      total: t.length
    }) }),
    /* @__PURE__ */ a("div", { className: "tw-flex-1 tw-overflow-y-auto tw-px-4 tw-pb-4", children: m ? /* @__PURE__ */ a("p", { className: "tw-py-8 tw-text-center tw-text-muted-foreground", children: $ }) : /* @__PURE__ */ u(et, { children: [
      /* @__PURE__ */ a(Zr, { label: y, resources: w }),
      /* @__PURE__ */ a(
        Zr,
        {
          label: N,
...
const dw = "16rem", ww = "3rem", Hn = tt.createContext(void 0);
function jr() {
...
function xw({
  ...
  return /* @__PURE__ */ a(
    pw,
    {
      ...
      children: /* @__PURE__ */ u(hw, { children: [
        /* @__PURE__ */ u(Eo, { children: [
          /* @__PURE__ */ a(zo, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(To, { children: /* @__PURE__ */ a(fw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(mw, { children: /* @__PURE__ */ a(
            bw,
            {
              onClick: () => c(h),
              isActive: g(h),
    ...
    /* @__PURE__ */ u(
      uw,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gw, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const he = "scrBook", yw = "scrRef", Se = "source", kw = "details", _w = "Scripture Reference", Nw = "Scripture Book", Wn = "Type", Cw = "Details";
function Ew(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? lt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === he ? De(n.start) : void 0;
      },
...
}, So = (t) => `${zw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Dp({
  sources: t,
  ...
  const [c, w] = S([]), [g, h] = S([{ id: he, desc: !1 }]), [p, m] = S({}), b = P(
  ...
  G(() => {
    if (l) {
      const k = C.getSelectedRowModel().rowsById, z = Object.keys(k);
      if (z.length === 1) {
        const M = b.find((L) => So(L) === z[0]) || void 0;
        M && l(M);
      }
    }
  }, [p, b, l, C]);
  const y = n ?? Nw, N = i ?? Wn, _ = [
  ...
  }, O = (k, z) => k.getIsGrouped() ? "" : f("banded-row", z % 2 === 0 ? "even" : "odd"), E = (k, z, M) => {
    if (!((k == null ? void 0 : k.length) === 0 || z.depth < M.column.getGroupedIndex())) {
      if (z.getIsGrouped())
        switch (z.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(Cd, { children: _.map((k) => /* @__PURE__ */ a(Ut, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ir, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(ja, { children: C.getHeaderGroups().map((k) => /* @__PURE__ */ a(ae, { children: k.headers.filter((z) => z.column.columnDef.header).map((z) => (
      ...
      /* @__PURE__ */ a(Pr, { children: C.getRowModel().rows.map((k, z) => {
        const M = st();
        return /* @__PURE__ */ a(
          ae,
          {
                  ...
                  ve,
                  {
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      V,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ a(Dr, {}),
                          !k.getIsExpanded() && (M === "ltr" ? /* @__PURE__ */ a(na, {}) : /* @__PURE__ */ a(oa, {})),
                          " ",
...
function Sw({
  ...
  }, [v, C] = S(!1), [y, N] = S(""), _ = K(void 0), I = K(!1);
  if (t.length !== lt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const $ = P(() => lt.allBookIds.filter(
    (A, W) => t[W] === "1" && !lt.isObsolete(lt.bookIdToNumber(A))
  ), [t]), O = P(() => {
    if (!y.trim()) {
      const x = {
        [Y.OT]: [],
    ...
    (A, W = !1) => {
      ...
      const x = $.findIndex((dt) => dt === _.current), F = $.findIndex((dt) => dt === A);
      if (x === -1 || F === -1) return;
      const [ct, xt] = [
        Math.min(x, F),
        Math.max(x, F)
      ], Mt = $.slice(ct, xt + 1).map((dt) => dt);
      r(
    ...
    (A) => {
      const W = Ba($, A).map((x) => x);
      r(
        Yn($, A, e) ? e.filter((x) => !W.includes(x)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, r, $]
  ), L = () => {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    /* @__PURE__ */ u(
      de,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(we, { className: "tw:w-full tw:p-0", align: "start", children: /* @__PURE__ */ u(
            Ne,
            {
              shouldFilter: !1,
              onKeyDown: (A) => {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  ...
                  /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: q, children: c })
                ] }),
                /* @__PURE__ */ u(Ce, { children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Qr ? Qr : Do
      ).map((A) => /* @__PURE__ */ a(Ue, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ve(A, n) }, A)),
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ss, {}) }) }),
...
const Dw = tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Kt.Trigger,
  {
    ref: r,
    ...e,
...
function Vp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Qn, { children: [
      /* @__PURE__ */ a(ti, { children: t.map((l) => /* @__PURE__ */ a(Dw, { value: l.value, children: l.value }, l.key)) }),
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const l = e.filter((c) => c.group === i).sort((c, w) => c.order - w.order).map((c) => /* @__PURE__ */ u(Pt, { children: [
      ...
      ) : /* @__PURE__ */ u(Lw, { children: [
        /* @__PURE__ */ a(Vw, { children: c.label }),
        /* @__PURE__ */ a(jw, { children: ri(
          t,
          e,
          Xn(t, c.id),
          o
    ...
    return l.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(Pw, {}, `separator-${i}`)), d;
  });
};
function Fw({
  menuData: t,
  ...
  if (fl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    return /* @__PURE__ */ a(Rw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u($w, { children: [
      /* @__PURE__ */ a(Ow, { ref: c(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        Aw,
        {
          style: { zIndex: Ye },
...
function Bp({
  ...
  return /* @__PURE__ */ u("div", { id: d, className: f("pr-twp tw:max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(ft, { className: "tw:font-normal tw:text-muted-foreground", children: fe(c, {
...
const Kw = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(ds, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Eg({
  ...
  return /* @__PURE__ */ a(
    Kt.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Ww({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
Jw(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
