...
function xh({ scrRef: t, handleSubmit: e }) {
  const n = St(), [r, o] = st(""), [a, s] = st(
    ...
    ct.bookNumberToId(t.bookNum)
  ), [f, w] = st(!1), [g, v] = st(f), m = ke(void 0), h = ke(void 0), k = ke(void 0), O = Pt(
    (A) => Ac(A).filter((M) => {
    ...
    /* @__PURE__ */ i(
      _n,
      {
        ...
        children: /* @__PURE__ */ y("div", { className: "rtl:tw-ps-2", children: [
          ...
          ma.map(
            (A, M) => O(A).length > 0 && /* @__PURE__ */ y("div", { children: [
              /* @__PURE__ */ i(Pn, { className: "tw-font-semibold tw-text-foreground/80", children: Pc[A] }),
              O(A).map((Y) => /* @__PURE__ */ i("div", { children: /* @__PURE__ */ i(
                Oc,
                {
                  bookId: Y,
...
const jc = Ze(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? Je : "button", { className: N(jc({ variant: e, size: n, className: t })), ref: a, ...o })
);
mt.displayName = "Button";
const Vc = Ze(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Ct = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(mi.Root, { ref: n, className: N("pr-twp", Vc(), t), ...e }));
...
function Jr({
  ...
  const [h, k] = st(!1);
  return /* @__PURE__ */ y($i, { open: h, onOpenChange: k, ...m, children: [
...
function ed({
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ y(In, { stickyHeader: a, children: [
      /* @__PURE__ */ i(An, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ i(Zt, { children: k.headers.map((O) => /* @__PURE__ */ i(fe, { children: O.isPlaceholder ? void 0 : hn(O.column.columnDef.header, O.getContext()) }, O.id)) }, k.id)) }),
      /* @__PURE__ */ i(Mn, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        Zt,
        {
          onClick: () => s(k, m),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((O) => /* @__PURE__ */ i(zt, { children: hn(O.column.columnDef.cell, O.getContext()) }, O.id))
        },
        k.id
...
const rd = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), ha = (t) => {
  ...
  {
    ref: o,
    className: N(ji({ variant: e, size: n, className: t })),
    ...r
  }
));
...
function Oh({
  ...
  const f = ie(n, "%webView_inventory_all%"), w = ie(n, "%webView_inventory_approved%"), g = ie(n, "%webView_inventory_unapproved%"), v = ie(n, "%webView_inventory_unknown%"), m = ie(n, "%webView_inventory_scope_currentBook%"), h = ie(n, "%webView_inventory_scope_chapter%"), k = ie(n, "%webView_inventory_scope_verse%"), O = ie(n, "%webView_inventory_filter_text%"), S = ie(
    n,
    "%webView_inventory_show_additional_items%"
    ...
    const x = [];
    return A.forEach((C) => {
      const G = C.items[0], X = x.find(
        (z) => z.items[0] === G
      );
      X ? (X.count += C.count, X.occurrences = X.occurrences.concat(C.occurrences)) : x.push({
        items: [G],
        count: C.count,
    ...
    /* @__PURE__ */ y("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ y(Ue, { onValueChange: (x) => tt(x), defaultValue: c, children: [
        ...
        /* @__PURE__ */ y(Oe, { children: [
          ...
          /* @__PURE__ */ i(Gt, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ i(
        Qe,
      ...
      o && /* @__PURE__ */ y("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ i(Ct, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? S })
      ] })
    ] }),
...
function dd({
  ...
  const [u, f] = st(!1), w = Pt(
    ...
    if (!l)
      return t;
    const m = t.filter((k) => k.starred).sort((k, O) => k.label.localeCompare(O.label)), h = t.filter((k) => !k.starred).sort((k, O) => {
      const S = n.includes(k.value), E = n.includes(O.value);
      return S && !E ? -1 : !S && E ? 1 : k.label.localeCompare(O.label);
    });
    return [...m, ...h];
  }, [t, n, l]);
...
const Hi = T.forwardRef(
  ({
    ...
    const [d, u] = T.useState(t), f = e ?? d, w = T.useCallback(
      (S) => {
        const E = typeof S == "function" ? S(f) : S;
        n ? n(E) : u(E);
      },
      [n, f]
    ), g = T.useCallback(() => w((S) => !S), [w]), v = f ? "expanded" : "collapsed", k = St() === "ltr" ? s : s === "primary" ? "secondary" : "primary", O = T.useMemo(
      () => ({
        state: v,
        open: f,
        setOpen: w,
    ...
    return /* @__PURE__ */ i(Xi.Provider, { value: O, children: /* @__PURE__ */ i(pd, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
function Ph({
  ...
  const k = o ?? Md, O = a ?? Qi, S = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [pe] },
    { label: `Group by ${O}`, value: [ve] },
    {
      label: `Group by ${k} and ${O}`,
      value: [pe, ve]
    },
    {
      label: `Group by ${O} and ${k}`,
      value: [ve, pe]
    }
  ], E = (_) => {
    d(JSON.parse(_));
  ...
  }, P = (_, $) => _.getIsGrouped() ? "" : N("banded-row", $ % 2 === 0 ? "even" : "odd"), L = (_, $, F) => {
    ...
    !e && /* @__PURE__ */ y(
      Ue,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Oe, { position: "item-aligned", children: /* @__PURE__ */ i(qc, { children: S.map((_) => /* @__PURE__ */ i(Gt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
...
function Fd() {
  ...
  return dt.AsyncMode = c, dt.ConcurrentMode = d, dt.ContextConsumer = l, dt.ContextProvider = s, dt.Element = e, dt.ForwardRef = u, dt.Fragment = r, dt.Lazy = v, dt.Memo = g, dt.Portal = n, dt.Profiler = a, dt.StrictMode = o, dt.Suspense = f, dt.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === f || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === s || b.$$typeof === l || b.$$typeof === u || b.$$typeof === h || b.$$typeof === k || b.$$typeof === O || b.$$typeof === m);
  }, dt.typeOf = S, dt;
}
var ut = {};
/** @license React v16.13.1
...
function Ud() {
  return ya || (ya = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function S(R) {
      ...
      R === r || R === d || R === a || R === o || R === f || R === w || typeof R == "object" && R !== null && (R.$$typeof === v || R.$$typeof === g || R.$$typeof === s || R.$$typeof === l || R.$$typeof === u || R.$$typeof === h || R.$$typeof === k || R.$$typeof === O || R.$$typeof === m);
    }
    function E(R) {
...
function Hd() {
  ...
  return Lr = function(l, c) {
      ...
      function X(q, W, K, H, Z, Q, lt) {
        if (H = H || w, Q = Q || K, lt !== n) {
          if (c) {
            ...
            var Et = H + ":" + K;
            !C[Et] && // Avoid spamming the console because they are often not actionable except for lib authors
            G < 3 && (a(
    ...
    function $(x) {
      ...
      for (var C = 0; C < x.length; C++) {
        ...
        if (typeof G != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ot(G) + " at index " + C + "."
          ), s;
      }
    ...
    function F() {
      function x(C, G, X, z, q) {
        return Y(C[G]) ? null : new m("Invalid " + z + " `" + q + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return h(x);
    }
    function D(x, C, G, X, z) {
      return new m(
        (x || "React class") + ": " + C + " type `" + G + "." + X + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + z + "`."
      );
    }
    function A(x) {
      function C(G, X, z, q, W) {
...
function eu() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, m = !1, h = !1, k = !1, O = !1, S;
    S = Symbol.for("react.module.reference");
    function E(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || O || j === r || j === d || j === u || k || j === g || v || m || h || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === f || j.$$typeof === a || j.$$typeof === s || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    wt.ContextConsumer = P, wt.ContextProvider = L, wt.Element = _, wt.ForwardRef = $, wt.Fragment = F, wt.Lazy = D, wt.Memo = A, wt.Portal = M, wt.Profiler = Y, wt.StrictMode = U, wt.Suspense = V, wt.SuspenseList = tt, wt.isAsyncMode = x, wt.isConcurrentMode = C, wt.isContextConsumer = G, wt.isContextProvider = X, wt.isElement = z, wt.isForwardRef = q, wt.isFragment = W, wt.isLazy = K, wt.isMemo = H, wt.isPortal = Z, wt.isProfiler = Q, wt.isStrictMode = lt, wt.isSuspense = R, wt.isSuspenseList = Et, wt.isValidElementType = E, wt.typeOf = b;
  }()), wt;
}
...
function Mp(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    let k = Zn;
    d === "Root" || d === "root" ? k = r : d ? k = o : $p(s) && (k = void 0);
    const O = Kl(s, I({
      shouldForwardProp: k,
      label: h
    }, g)), S = (b) => typeof b == "function" && b.__emotion_real !== b || Ne(b) ? (P) => Qn(b, I({}, P, {
      theme: Yn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Fa(m, "light", O, r), Fa(m, "dark", S, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, g = {
    dark: Gr,
    light: La
  };
...
function lw(t, e) {
  ...
  const g = o / 14, v = f || ((k) => `${k / d * g}rem`), m = (k, O, S, E, b) => I({
    fontFamily: r,
    fontWeight: k,
    fontSize: v(O),
...
function hf(t) {
  ...
  if (!(!a || !s)) {
    var f = mf(o.padding, n), w = Xo(a), g = c === "y" ? At : Mt, v = c === "y" ? Yt : Wt, m = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], k = Ln(a), O = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, S = m / 2 - h / 2, E = f[g], b = O - w[u] - f[v], P = O / 2 - w[u] / 2 + S, L = vn(E, P, b), _ = c;
...
function Ja(t) {
  ...
  g = h.x, m = h.y;
  var k = s.hasOwnProperty("x"), O = s.hasOwnProperty("y"), S = Mt, E = At, b = window;
  if (d) {
  ...
  if (g = A.x, m = A.y, c) {
    var M;
    return Object.assign({}, D, (M = {}, M[E] = O ? "0" : "", M[S] = k ? "0" : "", M.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", M));
  }
  return Object.assign({}, D, (e = {}, e[E] = O ? m + "px" : "", e[S] = k ? g + "px" : "", e.transform = "", e));
}
function xf(t) {
...
function Af(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Qt(h), O = k === h, S = c || (O || !v ? [tr(h)] : If(h)), E = [h].concat(S).reduce(function(z, q) {
...
function Gf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = Sn(e, {
    ...
    padding: f,
    altBoundary: u
  }), k = Qt(e.placement), O = Ke(e.placement), S = !O, E = Ho(k), b = Uf(E), P = e.modifiersData.popperOffsets, L = e.rects.reference, _ = e.rects.popper, $ = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, F = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
  ...
  if (P) {
    if (a) {
      var M, Y = E === "y" ? At : Mt, U = E === "y" ? Yt : Wt, V = E === "y" ? "height" : "width", tt = P[E], ot = tt + h[Y], at = tt - h[U], x = g ? -_[V] / 2 : 0, C = O === Ye ? L[V] : _[V], G = O === Ye ? -_[V] : -L[V], X = e.elements.arrow, z = g && X ? Xo(X) : {
        width: 0,
        height: 0
      }, q = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : _s(), W = q[Y], K = q[U], H = vn(0, L[V], z[V]), Z = S ? L[V] / 2 - x - H - W - F.mainAxis : C - H - W - F.mainAxis, Q = S ? -L[V] / 2 + x + H + K + F.mainAxis : G + H + K + F.mainAxis, lt = e.elements.arrow && Ln(e.elements.arrow), R = lt ? E === "y" ? lt.clientTop || 0 : lt.clientLeft || 0 : 0, Et = (M = D == null ? void 0 : D[E]) != null ? M : 0, j = tt + Z - Et - R, xt = tt + Q - Et, Ot = vn(g ? ir(ot, j) : ot, tt, g ? Te(at, xt) : at);
      P[E] = Ot, A[E] = Ot - tt;
    }
    if (l) {
      var oe, _t = E === "x" ? At : Mt, J = E === "x" ? Yt : Wt, nt = P[b], Nt = b === "y" ? "height" : "width", $t = nt + h[_t], Kt = nt - h[J], Ie = [At, Mt].indexOf(k) !== -1, Ae = (oe = D == null ? void 0 : D[b]) != null ? oe : 0, ge = Ie ? $t : nt - L[Nt] - _[Nt] - Ae + F.altAxis, en = Ie ? nt + L[Nt] + _[Nt] - Ae - F.altAxis : Kt, Fn = g && Ie ? ff(ge, nt, en) : vn(g ? ge : $t, nt, g ? en : Kt);
      P[b] = Fn, A[b] = Fn - nt;
    }
    e.modifiersData[r] = A;
  }
  ...
  return function(l, c, d) {
    ...
    var u = {
      ...
      setOptions: function(k) {
        var O = typeof k == "function" ? k(u.options) : k;
        m(), u.options = Object.assign({}, a, u.options, O), u.scrollParents = {
          reference: Pe(l) ? yn(l) : l.contextElement ? yn(l.contextElement) : [],
          popper: yn(c)
        };
        var S = Jf(Qf([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          var k = u.elements, O = k.reference, S = k.popper;
          if (ri(O, S)) {
            u.rects = {
              reference: qf(O, Ln(S), u.options.strategy === "fixed"),
              popper: Xo(S)
    ...
    function v() {
      u.orderedModifiers.forEach(function(h) {
        var k = h.name, O = h.options, S = O === void 0 ? {} : O, E = h.effect;
        if (typeof E == "function") {
          var b = E({
            state: u,
            name: k,
...
const lm = () => $o({
  ...
  } = e, h = Rt(e, om), k = B.useRef(null), O = Re(k, n), S = B.useRef(null), E = Re(S, w), b = B.useRef(E);
  He(() => {
    b.current = E;
  }, [E]), B.useImperativeHandle(w, () => S.current, []);
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, O = Rt(e, am), [S, E] = B.useState(!0), b = () => {
    E(!1);
  }, P = () => {
    E(!0);
  };
...
const gm = {
  ...
  const {
  ...
  } = e, k = Rt(e, hm), O = wn(), S = B.useRef(), E = Bs(), b = B.useRef(null), P = Re(b, a.ref, n), L = (U) => (V) => {
    if (U) {
      const tt = b.current;
    ...
    let x;
    m === "auto" ? (x = E.transitions.getAutoHeightDuration(U.clientHeight), S.current = x) : x = tt, U.style.transition = [E.transitions.create("opacity", {
      duration: x,
      delay: ot
    ...
    let at;
    m === "auto" ? (at = E.transitions.getAutoHeightDuration(U.clientHeight), S.current = at) : at = V, U.style.transition = [E.transitions.create("opacity", {
      duration: at,
      delay: tt
    }), E.transitions.create("transform", {
  ...
  return /* @__PURE__ */ i(h, I({
    ...
    onExiting: D,
    addEndListener: (U) => {
      m === "auto" && O.start(S.current || 0, U), r && r(b.current, U);
    },
...
const ii = Ko, bm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], vm = Vn(Ds, {
  ...
  const o = vs(), a = Lo({
    ...
    slots: S,
    slotProps: E
  } = a, b = Rt(a, bm), P = (r = S == null ? void 0 : S.root) != null ? r : c == null ? void 0 : c.Root, L = I({
    anchorEl: s,
    container: u,
    disablePortal: f,
    keepMounted: w,
...
const Ls = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r, o, a, s, l, c, d, u, f, w, g, v, m, h, k, O, S, E, b;
  const P = Lo({
    props: e,
    name: "MuiTooltip"
  }), {
...
`));
  const ol = B.useMemo(() => {
    ...
    className: Ee(_r.tooltip, (k = (O = Z.tooltip) != null ? O : F.tooltip) == null ? void 0 : k.className)
  }), an), ll = fn(da, I({}, (S = Z.arrow) != null ? S : F.arrow, {
...
function Dm({
  ...
  const [k] = uo(
    ...
    Pt(async () => (t == null ? void 0 : t(!0)) ?? n ?? k, [t, n, k, c]),
    n ?? k
  ), S = u && O ? O : k;
  return /* @__PURE__ */ y(de, { children: [
    /* @__PURE__ */ i(
...
const $e = lr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Rl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
), jm = T.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: N(Bm({ variant: e }), t), ...n }));
...
const zm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("div", { ref: n, className: N("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const Ws = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: N("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
  ...
  return /* @__PURE__ */ i(
    mt,
    {
      ...
      children: t ? /* @__PURE__ */ i($e, { size: 15 }) : /* @__PURE__ */ y(de, { children: [
        /* @__PURE__ */ i(_l, { size: 25, className: N("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Hh({
  ...
  return /* @__PURE__ */ i("div", { id: t, className: N("pr-twp tw-prose", n), children: /* @__PURE__ */ i(lc, { options: o, children: e }) });
}
...
function Zh({
  ...
  const f = t["%resources_action%"], w = t["%resources_any%"], g = t["%resources_dialog_subtitle%"], v = t["%resources_dialog_title%"], m = t["%resources_filterInput%"], h = t["%resources_filterBy%"], k = t["%resources_fullName%"], O = t["%resources_get%"], S = t["%resources_installed%"], E = t["%resources_language%"], b = t["%resources_languages%"], P = t["%resources_loadingResources%"], L = t["%resources_noResults%"], _ = t["%resources_open%"], $ = t["%resources_remove%"], F = t["%resources_results%"], D = t["%resources_showing%"], A = t["%resources_size%"], M = t["%resources_type%"], Y = t["%resources_types%"], U = t["%resources_type_DBL%"], V = t["%resources_type_ER%"], tt = t["%resources_type_SLR%"], ot = t["%resources_type_XR%"], at = t["%resources_type_unknown%"], x = t["%resources_update%"], [C, G] = st(!1);
  te(() => {
    if (!C) {
      if (a.length > 0) {
        G(!0);
...
function Qh({
  ...
  const c = Qm(
    ...
    var h, k, O, S, E, b;
    const m = v !== g ? ((k = (h = t[g]) == null ? void 0 : h.uiNames) == null ? void 0 : k[v]) ?? ((S = (O = t[g]) == null ? void 0 : O.uiNames) == null ? void 0 : S.en) : void 0;
