...
import p, { forwardRef as Yt, createContext as qn, useContext as Jn, useCallback as L, useState as P, useRef as Q, useEffect as at, useLayoutEffect as Fe, useMemo as tt, Fragment as Kn } from "react";
...
import { ChevronRight as be, Check as kt, Circle as ve, X as xe, Search as Je, ChevronsUpDown as Ke, FilterIcon as tr, ChevronDown as Lt, ChevronUp as er, ArrowLeftIcon as nr, ChevronLeftIcon as rr, ChevronRightIcon as ar, ArrowRightIcon as or, LoaderCircle as sr, Download as ir, Filter as wr, User as lr, Link as dr, CircleHelp as cr, Star as pr, CircleCheckIcon as ur, CircleXIcon as mr, CircleHelpIcon as hr, ArrowUpIcon as gr, ArrowDownIcon as fr, ArrowUpDownIcon as br, PanelLeft as vr, PanelRight as xr, ScrollText as yr, ChevronLeft as Nr, MenuIcon as kr, Menu as Cr, EllipsisVertical as Sr } from "lucide-react";
import { formatScrRef as bt, MODIFIER_KEYS as Rr, getChaptersForBook as Tr, NumberFormat as _r, formatBytes as Er, deepEqual as ye, isString as ae, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as V } from "platform-bible-utils";
...
import { useReactTable as Ze, getFilteredRowModel as zr, getSortedRowModel as Qe, getPaginationRowModel as Ir, getCoreRowModel as tn, flexRender as Dt, getGroupedRowModel as Mr, getExpandedRowModel as Dr } from "@tanstack/react-table";
...
const ke = O.Trigger, rn = O.Group, jr = O.Portal, Fr = O.Sub, ns = O.RadioGroup;
function Ut({ variant: t = "default", ...e }) {
  const n = p.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ r(Ne.Provider, { value: n, children: /* @__PURE__ */ r(O.Root, { ...e }) });
}
...
an.displayName = O.SubTrigger.displayName;
...
on.displayName = O.SubContent.displayName;
const At = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = Y();
  return /* @__PURE__ */ r(O.Portal, { children: /* @__PURE__ */ r(
    O.Content,
    {
      ref: o,
      sideOffset: e,
...
At.displayName = O.Content.displayName;
...
Ce.displayName = O.Item.displayName;
const Se = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    O.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(O.ItemIndicator, { children: /* @__PURE__ */ r(kt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Se.displayName = O.CheckboxItem.displayName;
const sn = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    O.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(O.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
sn.displayName = O.RadioItem.displayName;
const qt = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  O.Label,
  {
    ref: a,
...
qt.displayName = O.Label.displayName;
...
Xt.displayName = O.Separator.displayName;
...
var $r = Object.defineProperty, Yr = (t, e, n) => e in t ? $r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, _ = (t, e, n) => Yr(t, typeof e != "symbol" ? e + "" : e, n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
_(Z, "Original", new Z(rt.Original)), _(Z, "Septuagint", new Z(rt.Septuagint)), _(Z, "Vulgate", new Z(rt.Vulgate)), _(Z, "English", new Z(rt.English)), _(Z, "RussianProtestant", new Z(rt.RussianProtestant)), _(Z, "RussianOrthodox", new Z(rt.RussianOrthodox));
let pt = Z;
function $e(t, e) {
  const n = e[0];
...
const J = class M {
    ...
    if (_(this, "firstChapter"), _(this, "lastChapter"), _(this, "lastVerse"), _(this, "hasSegmentsDefined"), _(this, "text"), _(this, "BBBCCCVVVS"), _(this, "longHashCode"), _(this, "versification"), _(this, "rtlMark", "‏"), _(this, "_bookNum", 0), _(this, "_chapterNum", 0), _(this, "_verseNum", 0), _(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof M) {
          ...
          if (e == null) return;
          const s = e instanceof pt ? e : M.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return w && (c = new pt(w)), n ? new M(n, a.toString(), i, c) : new M();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const w = +s[1].trim();
          this.versification = new pt(rt[w]);
        } catch {
    ...
    if (a.length !== 2 || X.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !M.isVerseParseable(a[1]))
      throw new Et("Invalid reference : " + e);
...
_(J, "defaultVersification", pt.English), _(J, "verseRangeSeparator", "-"), _(J, "verseSequenceIndicator", ","), _(J, "verseRangeSeparators", [J.verseRangeSeparator]), _(J, "verseSequenceIndicators", [J.verseSequenceIndicator]), _(J, "chapterDigitShifter", 1e3), _(J, "bookDigitShifter", J.chapterDigitShifter * J.chapterDigitShifter), _(J, "bcvMaxValue", J.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
_(J, "ValidStatusType", un);
...
function na({
  ...
  const s = Array.from({ length: e }, (i, c) => c + 1), w = L(
    (i) => {
      o(i);
    },
    [o]
...
const ra = 6, Ee = X.allBookIds.filter((t) => !X.isObsolete(X.bookIdToNumber(t))), aa = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ye = ["OT", "NT", "DC"], oa = 96, sa = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), ia = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', zt = (t) => Tr(X.bookIdToNumber(t));
function wa() {
  return Ee.map((e) => X.bookIdToEnglishName(e));
}
function la(t) {
...
function da(t) {
  ...
  if (la(e))
    return Ee.find((a) => X.bookIdToEnglishName(a) === e);
}
function as({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = Y(), [s, w] = P(
    () => bt(t, "English")
  ), [i, c] = P(""), [u, g] = P(t.book), [b, f] = P(t.chapterNum ?? 0), [h, k] = P(t.book), [R, x] = P(!1), [y, C] = P(R), S = Q(void 0), j = Q(void 0), $ = Q(void 0), _t = L(
    (m) => {
      const z = a ? a() : Ee;
      return {
        OT: z.filter((v) => X.isBookOT(v)),
        NT: z.filter((v) => X.isBookNT(v)),
        DC: z.filter((v) => X.isBookDC(v))
      }[m].filter((v) => {
        const I = X.bookIdToEnglishName(v).toLowerCase(), q = i.replace(/[^a-zA-Z]/g, "").toLowerCase();
        return I.includes(q) || // Match book name
    ...
    w(bt(t, "English")), c(""), g(t.book), k(t.book);
  }, [t]), U = L((m) => {
    if (N.current) {
      N.current = !1;
      return;
    ...
    (m, z, v, I) => {
      if (f(t.book !== m ? 1 : t.chapterNum), z || zt(m) === -1) {
        e({
          book: m,
          chapterNum: v ?? 1,
          verseNum: I ?? 1
    ...
    sa.forEach((m) => {
      const z = m.exec(i);
      if (z) {
        const [v, I = void 0, q = void 0] = z.slice(1), G = da(v);
        (X.isBookIdValid(v) || G) && D(
          G ?? v,
          !0,
          I ? parseInt(I, 10) : 1,
          q ? parseInt(q, 10) : 1
    ...
    (m) => {
      R ? m.key === "ArrowDown" || m.key === "Tab" && !m.shiftKey ? ($ != null && $.current ? $.current.focus() : j.current && j.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === S.current && (x(!1), m.preventDefault(), m.stopPropagation()) : m.key !== "Tab" && x(!0);
    },
    [R]
  ), ft = L((m) => {
    if (!Rr.has(m.key)) {
      if (m.key === "Tab") {
        if (m.shiftKey)
          ...
          const z = [
            ...document.querySelectorAll(ia)
          ].filter(
            (I) => {
              var q, G;
              return I instanceof HTMLElement && ((I.offsetWidth > 0 || I.offsetHeight > 0) && !((q = j.current) != null && q.contains(I)) && !((G = S.current) != null && G.contains(I)) || I === m.target);
            }
          ), v = m.target instanceof HTMLElement ? z.indexOf(m.target) : -1;
          v >= 0 ? z[(v + 1) % z.length].focus() : S.current.focus();
        }
        m.preventDefault(), m.stopPropagation();
        return;
      }
      m.stopPropagation(), S.current.focus(), S.current.dispatchEvent(new KeyboardEvent("keydown", { ...m, view: void 0 }));
    }
  }, []), Ft = L(
    (m) => {
      const { key: z } = m;
      Le.has(z) || (ft(m), m.preventDefault());
    },
    [ft]
  ), E = L(
    (m, z) => {
      ...
      if (Le.has(v)) {
        if (h === u) {
          if (v === "Enter") {
            m.preventDefault(), D(u, !0, b);
            return;
          }
          const I = v === "ArrowRight" && !o || v === "ArrowRight" && o === "ltr" || v === "ArrowLeft" && o === "rtl", q = v === "ArrowLeft" && !o || v === "ArrowLeft" && o === "ltr" || v === "ArrowRight" && o === "rtl";
          let G = 0;
          if (I)
            if (b < zt(h))
              G = 1;
          ...
          else v === "ArrowDown" ? G = ra : v === "ArrowUp" && (G = -6);
          if (b + G <= 0 || b + G > zt(h))
            f(0);
          else if (G !== 0) {
            f(b + G), m.preventDefault();
            return;
          }
        }
        if (z === 0 && v === "ArrowUp") {
          m.preventDefault(), S.current.focus();
          return;
        }
        return;
      }
  ...
  return at(() => {
    u === h ? u === t.book ? f(t.chapterNum) : f(1) : f(0);
  }, [h, t.book, t.chapterNum, u]), at(() => {
    T();
  }, [T]), at(() => {
  }, [R, T]), Fe(() => {
    C(R);
    ...
    const m = setTimeout(() => {
      var z, v;
      if (y && j.current && $.current) {
        const q = $.current.offsetTop - oa;
        j.current.scrollTo({ top: q, behavior: "instant" }), S.current.focus();
      }
      !y && document.activeElement !== S.current && !((z = S.current) != null && z.contains(document.activeElement)) && document.activeElement !== j.current && !((v = j.current) != null && v.contains(document.activeElement)) && T();
    }, 10);
    return () => {
      clearTimeout(m);
    };
  }, [y, T]), /* @__PURE__ */ d(Ut, { modal: !1, open: R, onOpenChange: U, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Ar,
      {
        ...
        handleKeyDown: re,
        handleOnClick: () => {
          g(t.book), k(t.book), f(t.chapterNum > 0 ? t.chapterNum : 0), x(!0), S.current.focus();
        },
        onFocus: () => {
          N.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      At,
      {
        ...
        onFocus: (m) => {
          var z, v;
          !((z = S.current) != null && z.contains(m.relatedTarget)) && !((v = j.current) != null && v.contains(m.relatedTarget)) && S.current.select();
        },
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ye.map((m, z) => {
          const v = _t(m);
          return v.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(qt, { className: "tw-font-semibold tw-text-foreground/80", children: aa[m] }),
            v.map((I, q) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              ea,
              {
                bookId: I,
                handleSelectBook: () => D(I, !1),
                isSelected: u === I,
                handleHighlightBook: () => k(I),
                handleKeyDown: (G) => E(G, q),
                bookType: m,
                ref: (G) => {
                  u === I && ($.current = G);
                },
                children: /* @__PURE__ */ r(
                  na,
                  {
                    handleSelectChapter: ee,
                    endChapter: zt(I),
                    activeChapter: t.book === I ? t.chapterNum : 0,
                    highlightedChapter: b,
            ...
            Ye.length - 1 !== z ? /* @__PURE__ */ r(Xt, {}) : void 0
          ] }, m);
        }) })
      }
    )
...
const ca = dt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Ct : "button", { className: l(ca({ variant: e, size: n, className: t })), ref: s, ...o })
);
B.displayName = "Button";
const pa = dt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), H = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(We.Root, { ref: n, className: l("pr-twp", pa(), t), ...e }));
H.displayName = We.Root.displayName;
...
const ue = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Vt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ve, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ue.displayName = Vt.Item.displayName;
const hn = Bt.Root, gn = Bt.Trigger, ze = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = Y();
...
ze.displayName = Bt.Content.displayName;
const ua = ot.Portal, fn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ot.Overlay,
  {
    ref: n,
    className: l(
...
ma.displayName = ot.Content.displayName;
...
ha.displayName = ot.Title.displayName;
...
ga.displayName = ot.Description.displayName;
...
Me.displayName = K.Input.displayName;
...
De.displayName = K.List.displayName;
const Ve = p.forwardRef((t, e) => /* @__PURE__ */ r(K.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Ve.displayName = K.Empty.displayName;
...
bn.displayName = K.Group.displayName;
...
fa.displayName = K.Separator.displayName;
...
Be.displayName = K.Item.displayName;
function ba(t) {
...
function me({
  ...
  const [x, y] = P(!1);
  return /* @__PURE__ */ d(hn, { open: x, onOpenChange: y, ...R, children: [
    ...
    /* @__PURE__ */ r(
      ze,
      {
        ...
        children: /* @__PURE__ */ d(Ie, { children: [
          /* @__PURE__ */ r(Me, { placeholder: g, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(Ve, { children: b }),
          /* @__PURE__ */ r(De, { children: e.map((C) => /* @__PURE__ */ d(
            Be,
            {
              value: i(C),
              onSelect: () => {
...
var xa = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(xa || {});
...
function ss({
  ...
  const g = se(u, "%webView_bookSelector_currentBook%"), b = se(u, "%webView_bookSelector_choose%"), f = se(u, "%webView_bookSelector_chooseBooks%"), [h, k] = P(
    "current book"
    /* CURRENT_BOOK */
  ), R = (x) => {
    k(x), t(x);
    ...
    mn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(H, { className: "tw-flex tw-items-center", children: a.map((x) => X.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            B,
            {
...
function ya({ table: t }) {
  return /* @__PURE__ */ d(Ut, { children: [
    /* @__PURE__ */ r(Qn, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const vt = F.Root, Na = F.Group, xt = F.Value, ka = dt(
...
), ht = p.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = Y();
  return /* @__PURE__ */ d(
    F.Trigger,
    {
      className: l(ka({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
const gt = p.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = Y();
...
Ca.displayName = F.Label.displayName;
const et = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  F.Item,
  {
    ref: a,
    className: l(
...
et.displayName = F.Item.displayName;
...
Sa.displayName = F.Separator.displayName;
function Ra({ table: t }) {
      ...
      /* @__PURE__ */ d(
        vt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(gt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(et, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const Jt = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const Kt = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: l(
...
const Wt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Ea({
  ...
  var x;
  const [i, c] = P([]), [u, g] = P([]), [b, f] = P({}), [h, k] = P({}), R = Ze({
    data: e,
    columns: t,
    getCoreRowModel: tn(),
    ...n && { getPaginationRowModel: Ir() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(ya, { table: R }),
    /* @__PURE__ */ d(Jt, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Kt, { stickyHeader: s, children: R.getHeaderGroups().map((y) => /* @__PURE__ */ r(lt, { children: y.headers.map((C) => /* @__PURE__ */ r(Pt, { children: C.isPlaceholder ? void 0 : Dt(C.column.columnDef.header, C.getContext()) }, C.id)) }, y.id)) }),
      /* @__PURE__ */ r(Wt, { children: (x = R.getRowModel().rows) != null && x.length ? R.getRowModel().rows.map((y) => /* @__PURE__ */ r(
        lt,
        {
          onClick: () => w(y, R),
          "data-state": y.getIsSelected() && "selected",
          children: y.getVisibleCells().map((C) => /* @__PURE__ */ r(yt, { children: Dt(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        y.id
      )) : /* @__PURE__ */ r(lt, { children: /* @__PURE__ */ r(yt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && a && /* @__PURE__ */ r(Ra, { table: R })
  ] });
}
const jt = Yt(({ className: t, ...e }, n) => /* @__PURE__ */ r(sr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function cs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Vr, { options: o, children: e }) });
}
const za = Yt((t, e) => /* @__PURE__ */ d(
  B,
  {
    ref: e,
...
function ps({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ut, { children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(za, {}) }),
...
function Ma({ id: t, versionHistory: e }) {
  const [n, a] = P(!1), o = /* @__PURE__ */ new Date();
  function s(i) {
    const c = new Date(i), u = new Date(o.getTime() - c.getTime()), g = u.getUTCFullYear() - 1970, b = u.getUTCMonth(), f = u.getUTCDate() - 1;
    let h = "";
    return g > 0 ? h = `${g.toString()} year${g === 1 ? "" : "s"} ago` : b > 0 ? h = `${b.toString()} month${b === 1 ? "" : "s"} ago` : f === 0 ? h = "today" : h = `${f.toString()} day${f === 1 ? "" : "s"} ago`, h;
  }
...
function hs({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ d("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ r(Ma, { versionHistory: o }),
...
const Da = dt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: l("pr-twp", Da({ variant: e }), t), ...n })
);
...
function Va({
  ...
  const [b, f] = P(!1), h = L(
    (x) => {
      var C;
      const y = (C = t.find((S) => S.label === x)) == null ? void 0 : C.value;
      y && a(
        n.includes(y) ? n.filter((S) => S !== y) : [...n, y]
      );
    },
    [t, n, a]
  ), k = () => w || o, R = tt(() => {
    if (!c) return t;
    const x = t.filter((C) => C.starred).sort((C, S) => C.label.localeCompare(S.label)), y = t.filter((C) => !C.starred).sort((C, S) => {
      const j = n.includes(C.value), $ = n.includes(S.value);
      return j && !$ ? -1 : !j && $ ? 1 : C.label.localeCompare(S.label);
    });
    return [...x, ...y];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ d(hn, { open: b, onOpenChange: f, children: [
    /* @__PURE__ */ r(gn, { asChild: !0, children: /* @__PURE__ */ d(
      B,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(ze, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Ie, { children: [
      ...
      /* @__PURE__ */ d(De, { children: [
        ...
        /* @__PURE__ */ r(bn, { children: R.map((x) => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      ...
      return /* @__PURE__ */ d(yn, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        ...
        (h = t.find((k) => k.value === f)) == null ? void 0 : h.label
      ] }, f);
...
function Ba({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = tt(() => {
    const w = [];
    return t.forEach((i) => {
      w.some((c) => ye(c, i)) || w.push(i);
    }), w;
  }, [t]);
  return /* @__PURE__ */ d(Jt, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Kt, { stickyHeader: !0, children: /* @__PURE__ */ d(lt, { children: [
      /* @__PURE__ */ r(Pt, { children: a }),
      /* @__PURE__ */ r(Pt, { children: o })
    ] }) }),
    /* @__PURE__ */ r(Wt, { children: s.length > 0 && s.map((w) => /* @__PURE__ */ d(
      lt,
      {
        onClick: () => {
          e(w.reference);
...
Pa.displayName = en.Root.displayName;
const kn = p.createContext({
  size: "default",
  variant: "default"
}), Cn = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const w = Y();
  return /* @__PURE__ */ r(
    Ht.Root,
    {
...
Cn.displayName = Ht.Root.displayName;
const Gt = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const Zt = (t) => t === "asc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(br, { className: "tw-ms-2 tw-h-4 tw-w-4" }), fs = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ d(B, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Zt(e.getIsSorted())
  ] })
}), Oa = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ d(B, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    Zt(n.getIsSorted())
  ] })
}), bs = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ d(B, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Zt(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ d(B, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    Zt(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
  ...
  return e ? e[1] : "";
}, Aa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ks = Object.freeze([
...
function Cs({
  ...
  const u = it(n, "%webView_inventory_all%"), g = it(n, "%webView_inventory_approved%"), b = it(n, "%webView_inventory_unapproved%"), f = it(n, "%webView_inventory_unknown%"), h = it(n, "%webView_inventory_scope_currentBook%"), k = it(n, "%webView_inventory_scope_chapter%"), R = it(n, "%webView_inventory_filter_text%"), x = it(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, C] = P(!1), [S, j] = P("all"), [$, _t] = P(""), [ct, N] = P([]), T = tt(() => t.length === 0 ? [] : ja(t, o, s), [t, o, s]), U = tt(() => {
    if (y) return T;
    const E = [];
    return T.forEach((m) => {
      const z = m.items[0], v = E.find(
        (I) => I.items[0] === z
      );
      v ? (v.count += m.count, v.occurrences = v.occurrences.concat(m.occurrences)) : E.push({
        items: [z],
        count: m.count,
  ...
  }, [y, T]), D = tt(() => Xa(U, S, $), [U, S, $]), ee = tt(() => {
    var z, v;
    if (!y) return c;
    const E = (z = a == null ? void 0 : a.tableHeaders) == null ? void 0 : z.length;
    if (!E) return c;
    const m = [];
    for (let I = 0; I < E; I++)
      m.push(
        Oa(
          ((v = a == null ? void 0 : a.tableHeaders) == null ? void 0 : v[I]) || "Additional Item",
          I + 1
        )
      );
    return [...m, ...c];
  ...
  at(() => {
    D.length === 0 ? N([]) : D.length === 1 && N(D[0].items);
  }, [D]);
  const ne = (E, m) => {
    m.setRowSelection(() => {
      const z = {};
      return z[E.index] = !0, z;
    }), N(E.original.items);
  }, re = (E) => {
    if (E === "book" || E === "chapter")
      i(E);
    ...
    if (U.length === 0 || ct.length === 0) return [];
    const E = U.filter((m) => ye(
      y ? m.items : [m.items[0]],
      ct
    ));
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        vt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(gt, { children: [
              /* @__PURE__ */ r(et, { value: "all", children: u }),
              /* @__PURE__ */ r(et, { value: "approved", children: g }),
              /* @__PURE__ */ r(et, { value: "unapproved", children: b }),
              /* @__PURE__ */ r(et, { value: "unknown", children: f })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(vt, { onValueChange: (E) => re(E), defaultValue: w, children: [
        /* @__PURE__ */ r(ht, { className: "tw-m-1", children: /* @__PURE__ */ r(xt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(gt, { children: [
          /* @__PURE__ */ r(et, { value: "book", children: h }),
          /* @__PURE__ */ r(et, { value: "chapter", children: k })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Rt,
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(H, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? x })
      ] })
    ] }),
...
const Ae = Ot.Provider, Xe = Ot.Root, je = Ot.Trigger, Qt = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Ot.Content,
  {
    ref: a,
    sideOffset: e,
...
Qt.displayName = Ot.Content.displayName;
const Fa = "16rem", Ga = "3rem", Sn = p.createContext(void 0);
function te() {
...
const Rn = p.forwardRef(
  ({
    ...
    const [u, g] = p.useState(t), b = e ?? u, f = p.useCallback(
      (S) => {
        const j = typeof S == "function" ? S(b) : S;
        n ? n(j) : g(j);
      },
      [n, b]
    ), h = p.useCallback(() => f((S) => !S), [f]), k = b ? "expanded" : "collapsed", y = Y() === "ltr" ? w : w === "primary" ? "secondary" : "primary", C = p.useMemo(
      () => ({
        state: k,
        open: b,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(Sn.Provider, { value: C, children: /* @__PURE__ */ r(Ae, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Tn = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const w = te();
...
const Ka = dt(
  ...
  ({
    ...
    const c = t ? Ct : "button", { state: u } = te(), g = /* @__PURE__ */ r(
      c,
      {
        ref: i,
        ...
        "data-size": a,
        "data-active": e,
        className: l(Ka({ variant: n, size: a }), s),
        ...w
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(je, { asChild: !0, children: g }),
      /* @__PURE__ */ r(Qt, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : g;
  }
);
...
const no = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Ct : "a",
  {
    ref: s,
...
function ro({
  ...
  const u = L(
    ...
    (f) => {
      const h = n.find((k) => k.projectId === f);
    ...
    Tn,
    {
      ...
      children: /* @__PURE__ */ d(En, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(zn, { children: Object.entries(e).map(([f, h]) => /* @__PURE__ */ r(In, { children: /* @__PURE__ */ r(
            Mn,
            {
              onClick: () => u(f),
              isActive: b(f),
...
const wt = "scrBook", ao = "scrRef", ut = "source", oo = "details", so = "Scripture Reference", io = "Scripture Book", Vn = "Type", wo = "Details";
function lo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? X.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === wt ? bt(o.start) : void 0;
      },
...
}, Ue = (t) => `${co({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Rs({
  sources: t,
  ...
  const [c, u] = P([]), [g, b] = P([{ id: wt, desc: !1 }]), [f, h] = P({}), k = tt(
  ...
  const x = Ze({
    ...
    getExpandedRowModel: Dr(),
    getGroupedRowModel: Mr(),
    getCoreRowModel: tn(),
    getSortedRowModel: Qe(),
    getRowId: Ue,
    autoResetExpanded: !1,
  ...
  at(() => {
    if (i) {
      ...
      if (T.length === 1) {
        const U = k.find((D) => Ue(D) === T[0]) || void 0;
        U && i(U);
      }
    }
  }, [f, k, i, x]);
  const y = o ?? io, C = s ?? Vn, S = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [wt] },
    { label: `Group by ${C}`, value: [ut] },
    {
  ...
  }, _t = (N, T) => N.getIsGrouped() ? "" : l("banded-row", T % 2 === 0 ? "even" : "odd"), ct = (N, T, U) => {
    if (!((N == null ? void 0 : N.length) === 0 || T.depth < U.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(gt, { position: "item-aligned", children: /* @__PURE__ */ r(Na, { children: S.map((N) => /* @__PURE__ */ r(et, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Jt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Kt, { children: x.getHeaderGroups().map((N) => /* @__PURE__ */ r(lt, { children: N.headers.filter((T) => T.column.columnDef.header).map((T) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Pt, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Dt(T.column.columnDef.header, T.getContext())
        ] }) }, T.id)
      )) }, N.id)) }),
      /* @__PURE__ */ r(Wt, { children: x.getRowModel().rows.map((N, T) => {
        const U = Y();
        return /* @__PURE__ */ r(
          lt,
          {
            ...
            className: l(_t(N, T)),
            onClick: (D) => $(N, D),
            children: N.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== ut || !n)))
                return /* @__PURE__ */ r(
                  yt,
                  {
                    className: l(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ d(
                      B,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          N.getIsExpanded() && /* @__PURE__ */ r(Lt, {}),
                          !N.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(Nr, {})),
                          " ",
                          Dt(D.column.columnDef.cell, D.getContext()),
                          " (",
                          N.subRows.length,
                          ")"
                        ]
...
function Ts({
  ...
  return /* @__PURE__ */ d(
    vt,
    {
      ...
      children: [
        /* @__PURE__ */ r(ht, { size: o, className: l("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          xt,
          {
            placeholder: w[V(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          gt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(et, { value: `${c}`, children: w[V(c)] }, `${c}`))
          }
        )
      ]
    }
...
function $t({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
const Pn = (t, e, n, a) => n ? Object.entries(t).filter(
  ([s, w]) => "column" in w && w.column === n || s === n
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, c) => i.order - c.order).map((i) => /* @__PURE__ */ d(Xe, { children: [
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    Ce,
    {
      ...
      children: [
        i.iconPathBefore && /* @__PURE__ */ r($t, { icon: i.iconPathBefore, menuLabel: i.label, leading: !0 }),
        i.label,
        i.iconPathAfter && /* @__PURE__ */ r($t, { icon: i.iconPathAfter, menuLabel: i.label })
      ]
    },
    `dropdown-menu-item-${i.label}-${i.command}`
  ) : /* @__PURE__ */ d(Fr, { children: [
    /* @__PURE__ */ r(an, { children: i.label }),
    /* @__PURE__ */ r(jr, { children: /* @__PURE__ */ r(on, { children: Pn(
      t,
      e,
      Bn(t, i.id),
      a
...
function qe({
  ...
  return /* @__PURE__ */ d(Ut, { variant: s, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(kr, {}) }) }),
    /* @__PURE__ */ r(At, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, c]) => typeof i == "boolean" || typeof c == "boolean" ? 0 : i.order - c.order).map(([i], c, u) => /* @__PURE__ */ d(Kn, { children: [
      /* @__PURE__ */ r(rn, { children: /* @__PURE__ */ r(Ae, { children: Pn(e.groups, e.items, i, t) }) }),
...
On.displayName = W.List.displayName;
...
An.displayName = W.List.displayName;
...
Xn.displayName = W.Content.displayName;
function Ms({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(On, { children: [
      /* @__PURE__ */ r(An, { children: t.map((w) => /* @__PURE__ */ r(po, { value: w.value, children: w.value }, w.key)) }),
      t.map((w) => /* @__PURE__ */ r(Xn, { value: w.value, children: w.content }, w.key))
    ] })
  ] });
}
function uo({ ...t }) {
  return /* @__PURE__ */ r(A.Menu, { ...t });
}
function mo({ ...t }) {
  return /* @__PURE__ */ r(A.Sub, { "data-slot": "menubar-sub", ...t });
}
const jn = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
...
jn.displayName = A.Root.displayName;
const Fn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = nt();
  return /* @__PURE__ */ r(
    A.Trigger,
    {
...
Fn.displayName = A.Trigger.displayName;
...
Gn.displayName = A.SubTrigger.displayName;
...
$n.displayName = A.SubContent.displayName;
const Yn = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const w = nt();
...
Yn.displayName = A.Content.displayName;
const Ln = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = nt();
  return /* @__PURE__ */ r(
    A.Item,
    {
...
Ln.displayName = A.Item.displayName;
const ho = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    A.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(A.ItemIndicator, { children: /* @__PURE__ */ r(kt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
ho.displayName = A.CheckboxItem.displayName;
const go = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    A.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(A.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
go.displayName = A.RadioItem.displayName;
...
fo.displayName = A.Label.displayName;
...
Hn.displayName = A.Separator.displayName;
const It = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((u) => u.group === s).sort((u, g) => u.order - g.order).map((u) => /* @__PURE__ */ d(Xe, { children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: "command" in u ? /* @__PURE__ */ d(
        Ln,
        {
          ...
          children: [
            u.iconPathBefore && /* @__PURE__ */ r($t, { icon: u.iconPathBefore, menuLabel: u.label, leading: !0 }),
            u.label,
            u.iconPathAfter && /* @__PURE__ */ r($t, { icon: u.iconPathAfter, menuLabel: u.label })
          ]
        },
      ...
      u.tooltip && /* @__PURE__ */ r(Qt, { children: u.tooltip })
    ] }, `tooltip-${u.label}-${"command" in u ? u.command : u.id}`)), c = [...i];
    return i.length > 0 && w < o.length - 1 && c.push(/* @__PURE__ */ r(Hn, {}, `separator-${s}`)), c;
  });
};
function bo({
  menuData: t,
  ...
  const o = Q(void 0), s = Q(void 0), w = Q(void 0), i = Q(void 0), c = Q(void 0), u = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (Br(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    var k, R, x, y;
    g.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (k = s.current) == null || k.focus(), It(s, [f, h]);
        break;
      case "alt+l":
        (R = w.current) == null || R.focus(), It(w, [f, h]);
        break;
      case "alt+n":
        (x = i.current) == null || x.focus(), It(i, [f, h]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), It(c, [f, h]);
        break;
    }
  }), at(() => {
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ d(uo, { children: [
      /* @__PURE__ */ r(Fn, { ref: u(g), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        Yn,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Ae, { children: Un(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
...
function Bs({
  ...
  const c = vo(
    ...
    o && o(h), a && a([h, ...n.filter((k) => k !== h)]), s && n.find((k) => k === h) && s([...n.filter((k) => k !== h)]), g(!1);
  }, f = (h, k) => {
    var x, y, C, S, j, $;
    const R = k !== h ? ((y = (x = t[h]) == null ? void 0 : x.uiNames) == null ? void 0 : y[k]) ?? ((S = (C = t[h]) == null ? void 0 : C.uiNames) == null ? void 0 : S.en) : void 0;
    return R ? `${(j = t[h]) == null ? void 0 : j.autonym} (${R})` : ($ = t[h]) == null ? void 0 : $.autonym;
  };
      ...
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((h) => /* @__PURE__ */ r(et, { value: h, children: f(h, e) }, h))
            }
          )
        ]
      }
...
So.displayName = St.Root.displayName;
...
Ro.displayName = St.Image.displayName;
...
To.displayName = St.Fallback.displayName;
...
Vo.displayName = Mt.Root.displayName;
...
const Xs = W.Root, Po = p.forwardRef(({ className: t, ...e }, n) => {
  const a = Y();
  return /* @__PURE__ */ r(
    W.List,
    {
...
Po.displayName = W.List.displayName;
...
Oo.displayName = W.Trigger.displayName;
...
Ao.displayName = W.Content.displayName;
const js = (t, e) => {
  at(() => {
    if (!t) return () => {
    };
...
export {
  ...
  Rs as ScriptureResultsViewer,
  Ts as ScrollGroupSelector,
  Dn as SearchBar,
  vt as Select,
  gt as SelectContent,
  Na as SelectGroup,
  ...
  Es as SettingsListItem,
  ro as SettingsSidebar,
  Ss as SettingsSidebarContentSearch,
  Vo as Slider,
  As as Sonner,
  jt as Spinner,
  Bo as Switch,
  ...
  l as cn,
  Ns as getBookIdFromUSFM,
  xs as getLinesFromUSFM,
  ys as getNumberFromUSFM,
  Aa as getStatusForItem,
  Ds as getToolbarOSReservedSpaceClassName,
  bs as inventoryCountColumn,
  fs as inventoryItemColumn,
  vs as inventoryStatusColumn,
  ka as selectTriggerVariants,
  Ys as sonner,
  js as useEvent,
  Fs as useEventAsync,
  jo as usePromise
