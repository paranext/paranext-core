...
function sd({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = va(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, nd), P = re(s, id), T = (M) => {
...
function Ga({
  ...
  const T = Ce(), B = ed(), [z, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [G, it] = _(
    ...
    if (!$) return;
    const m = M.startsWith(`${$.book} `) ? M : "", H = ta(m), at = Ir(m);
    return {
      book: $.book,
  ...
  const Qt = j(() => {
    ...
    const m = G;
    it(void 0), dt(void 0), m ? (I(m), rt("chapters"), W("")) : et();
  }, [G, et]), ct = j(
    (m) => {
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (m) => $ ? !!$.chapterNum && !m.toString().includes($.chapterNum.toString()) : !1,
    [$]
  ), Pa = V(
    () => De(
      t,
    ...
    [t.book, s, B]
  ), $a = `${t.chapterNum}:${t.verseNum}`, Tr = j((m) => (H) => {
    Rt.current[m] = H;
  }, []), Sr = j((m) => (H) => {
    Nt.current[m] = H;
  }, []), sr = V(
    ...
    (m) => {
      (m.key === "Home" || m.key === "End") && m.stopPropagation(), h && h.includes(m.key) && $ && $.chapterNum !== void 0 && $.verseNum !== void 0 && (m.preventDefault(), m.stopPropagation(), Qt());
    },
    [h, $, Qt]
  ), Zr = j(
    (m) => {
      ...
      if (m.key === "Tab") {
        ...
        const de = At[At.length - 1], qt = m.shiftKey ? At[0] : de;
        document.activeElement === qt && (m.preventDefault(), m.stopPropagation(), (m.shiftKey ? de : At[0]).focus());
        return;
      }
      ...
      if (N === "books" && $ && !St && m.key === "Enter" && !(H !== gt.current && !!(H != null && H.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (!Ql(m.key) || St) return;
      if (N === "books" && !Ht && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
        const At = H === gt.current ? gt.current : void 0, de = (At == null ? void 0 : At.selectionStart) ?? 0, qt = (At == null ? void 0 : At.selectionEnd) ?? 0, he = T === "rtl" ? m.key === "ArrowRight" : m.key === "ArrowLeft";
    ...
    const { isLetter: H, isDigit: at } = gn(m.key);
  ...
  Jt(() => {
    ...
    if (N === "verses" && G && ot !== void 0) {
      const m = G === t.book && ot === t.chapterNum, H = m ? t.verseNum : 1;
      W(
        ca(G, ot, H)
      ), setTimeout(() => {
        if (xt.current)
  ...
  const Q = $ ? `${$.book} ${$.chapterNum ?? ""} ${$.verseNum ?? ""} ${be}` : "", $t = F(""), le = F(""), pe = V(() => {
    ...
    const { book: m, chapterNum: H, verseNum: at } = $;
    if (be && H && w)
      return {
        max: w(m, H),
        initial: at ?? (m === t.book && H === t.chapterNum ? t.verseNum : 1),
        parse: ta,
        buildValue: (Kt) => ca(m, H, Kt)
      };
    const Lt = Le(m);
    if (!(Lt <= 1))
      return {
            ...
            children: [
              ...
              !St && /* @__PURE__ */ u(or, { ref: xt, children: [
                N === "books" && /* @__PURE__ */ u(ht, { children: [
                  !$ && Object.entries(ve).map(([m, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ke, { heading: ir(m), children: H.map((at) => /* @__PURE__ */ a(
                          Ci,
                          {
                            bookId: at,
                            onSelect: (Lt) => K(Lt),
...
function sh({
  ...
  const w = qa(d, "%webView_bookSelector_currentBook%"), p = qa(d, "%webView_bookSelector_choose%"), h = qa(d, "%webView_bookSelector_chooseBooks%"), [g, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (b) => {
    f(b), t(b);
...
function Pd(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), g = Od(t, e);
    var f, x;
  ...
  return Oe(t.registerCommand(aw, (i) => {
    ...
    if (ul(i.target)) {
      ...
      if (nw(c)) return function(l, d = !1) {
        ...
        let g;
        d && fi(w) ? g = w : (g = hl(), gl(g)), p ? g.delete(h) : g.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(er, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        rr,
        {
          ...
          children: /* @__PURE__ */ a(ar, { children: /* @__PURE__ */ a(or, { children: t.map((b) => /* @__PURE__ */ a(
            qe,
            {
              onSelect: () => {
                l(b || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: to(b, o) })
            },
            b || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : Ho(b) && (b.preventDefault(), b.stopPropagation(), we(s) && g());
        },
        onKeyDown: (b) => {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : Ho(T) && (T.preventDefault(), T.stopPropagation(), we(w) && f());
              },
              onKeyDown: (T) => {
          ...
          o && /* @__PURE__ */ u(ht, { children: [
            ...
            b !== !1 && (!dt || we(U)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (y) => {
                  Ho(y) && (y.preventDefault(), y.stopPropagation(), (we(U) || N !== void 0 && N !== O) && S());
                },
                onKeyDown: (y) => {
...
function Uw({
  ...
  const [i, c] = _("accept"), l = va(), d = va(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : i, x = V(
    () => ua(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = V(
    () => ua(t.acceptedText ?? ""),
  ...
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), U = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : W, tt = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(pa, { html: R }) : W : U(O === "reject" ? t.rejectedResultText : t.resultText);
  }, N = (O) => p && O.value === "reject", rt = (O) => {
    const I = f === O.value, G = `${d}-${O.value}`, it = N(O);
    return (
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Ww, { ...G, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...G })
          },
          I.id
        );
      })
...
function tu({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, x] = _({}), [b, R] = _({}), k = V(() => e ?? [], [e]), C = yi({
    data: k,
    columns: t,
    getCoreRowModel: _i(),
...
function _h({
  ...
  return /* @__PURE__ */ u(er, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(rr, { id: s, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Sh({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, W] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [G, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
  ...
  const xt = j(() => {
    var y, q, A;
    const S = (y = g.current) == null ? void 0 : y.querySelector(".editor-input"), K = S == null ? void 0 : S.querySelector("span.note"), X = (A = (q = g.current) == null ? void 0 : q.ownerDocument.getSelection()) == null ? void 0 : A.anchorNode;
  ...
  Y(() => {
    ...
    if (y && Dr("note", y)) {
      ...
      let nt = "custom";
      et === uo ? nt = "generated" : et === po ? nt = "hidden" : et && (P(et), B(et)), R(nt), C(nt), D(((A = y.insert.note) == null ? void 0 : A.style) ?? "f"), S = setTimeout(() => {
        var ct, _t, Pt;
  ...
  const Gt = j(
    (S = !1) => {
      ...
      K && Dr("note", K) && (r == null || r([K]), S && d && s && ((q = d.current) == null || q.replaceEmbedUpdate(s, [K])));
    },
    [s, r, p, d]
  ), Rt = j(
    (S, K) => {
      ...
      let y;
      S === "custom" ? y = K : S === "generated" ? y = uo : y = po, X.insert.note.caller !== y && (X.insert.note.caller = y, (et = h.current) == null || et.applyUpdate([X, { delete: 1 }]));
    },
    []
  ), Nt = j(() => {
    var S;
    wt.current || (S = h.current) == null || S.commitPendingMarkerEdits(), Gt(!0), o();
  }, [o, Gt]), ft = F(Nt);
  Jt(() => {
    ft.current = Nt;
  });
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      z !== "x" && S === "x" ? nt == null || nt.forEach((ct) => bu(ct)) : z === "x" && S !== "x" && (nt == null || nt.forEach((ct) => xu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (S) => {
...
function ju({
  ...
  const c = t ? Gr.Root : "button", { state: l } = za(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Bu({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Pu,
    {
      ...
      children: /* @__PURE__ */ u(Au, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Vu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Lu, { children: /* @__PURE__ */ a(
            ju,
            {
              onClick: () => d(g),
              isActive: h(g),
...
function Qh({
  ...
  }, B = (D, M) => D.getIsGrouped() ? "" : v("banded-row", M % 2 === 0 ? "even" : "odd"), z = (D, M, W) => {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(To, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(So, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(je, { children: D.headers.filter((M) => M.column.columnDef.header).map((M) => (
...
function eg({
  ...
  const T = Bt(
  ...
  ] }), pt = e ? lt.filter((L) => e.includes(L.value)) : lt, It = b ?? Ka, Ht = h ?? It, wt = g ?? It, me = () => {
  ...
  ), mt = pt.find((L) => L.value === "selectedBooks"), ce = pt.find((L) => L.value === "range"), [Qt, S] = _(!1), [K, X] = _(void 0), [y, q] = _(void 0), [A, et] = _(void 0), [nt, ct] = _(void 0), [_t, Pt] = _([]), Vt = p === "dropdown" && K === "selectedBooks", te = /* @__PURE__ */ a(
    tp,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-start", className: v(Cr && ir), children: G }),
      /* @__PURE__ */ a(
        Ga,
        {
    ...
    /* @__PURE__ */ u("div", { ref: oe, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-end", className: v(Er && ir), children: it }),
      /* @__PURE__ */ a(
        Ga,
        {
          id: "scope-range-end",
  ...
  const Yr = j(
    (L) => {
      q(L), et(Ht), ct(wt), Pt(n), S(!1), X(L);
    },
    [Ht, wt, n]
  ), Xr = j(() => {
    y !== void 0 && (y === "range" ? (A && (f == null || f(A)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), zt(y), X(void 0), q(void 0));
  }, [
    y,
    A,
    nt,
                        ...
                        children: /* @__PURE__ */ a(
                          Ga,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(ht, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: De(b ?? Ka, "id") }),
                              /* @__PURE__ */ a(Qe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
...
function ko({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    ...
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: Pe }, children: w.map(({ columnKey: h, label: g }, f) => {
      const x = `${d}-${h}`;
      return /* @__PURE__ */ u(Kr, { children: [
        /* @__PURE__ */ u(Gn, { "aria-labelledby": p ? x : void 0, children: [
          p && /* @__PURE__ */ a(tr, { id: x, children: g }),
          /* @__PURE__ */ a(Ot, { children: cs(e.groups, e.items, h, t) })
        ] }),
        f < w.length - 1 && /* @__PURE__ */ a(Ze, {})
      ] }, h);
    }) })
  ] });
}
...
function pg({
  ...
  return /* @__PURE__ */ u(ar, { id: s, className: v("pr-twp", n), shouldFilter: !1, children: [
      ...
      /* @__PURE__ */ a(
        Tt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: sn(d, {
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(Kr, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
...
function qg({
  ...
  return /* @__PURE__ */ a(
    fe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Sp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
