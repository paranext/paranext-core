...
var Wi = (t, e, r) => e in t ? Yi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Ht = (t, e, r) => Wi(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Avatar as yo, Select as Yt, Checkbox as Ho, Slot as $r, Tabs as de, Menubar as xe, ContextMenu as Pt, Progress as qo, Slider as Lr, Switch as Go } from "radix-ui";
        ...
        children: [
          /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                Y,
                Y && j && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                j
              ]
            }
          ) }),
...
function Ra({
  ...
  const E = be(), F = Rl(), [O, z] = _(!1), [K, Y] = _(""), [j, Q] = _(""), [N, et] = _("books"), [D, M] = _(void 0), [q, nt] = _(
    void 0
  ...
  const yt = L(() => {
    ...
    const k = q;
    nt(void 0), ut(void 0), k ? (M(k), et("chapters"), Y("")) : S();
  }, [q, S]), G = L(
    (k) => {
  ...
  const { otLong: $, ntLong: tt, dcLong: ct, extraLong: pt } = {
    ...
    (k) => {
      ...
      if (N === "verses" && Qt) {
        ...
        pe !== kt && (k.preventDefault(), k.stopPropagation(), Y(
          `${lt} ${le[lt] || ""} ${bt}:${pe}`
        ), setTimeout(() => {
      ...
      if ((N === "chapters" || N === "books" && P) && Qt) {
        ...
        kt !== bt && (k.preventDefault(), k.stopPropagation(), Y(
          `${lt} ${le[lt] || ""} ${kt}`
        ), setTimeout(() => {
...
function Qo({
  ...
  const [C, T] = _(!1), I = d ?? l, E = (O) => O.length > 0 && typeof O[0] == "object" && "options" in O[0], F = (O, z) => {
    const K = l(O), Y = typeof O == "object" && "secondaryLabel" in O ? O.secondaryLabel : void 0, j = `${z ?? ""}${K}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      Se,
      {
        value: K,
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fl = di ? te : W, Br = { tag: vo };
...
const Kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
...
const Xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function Jl(t) {
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((E || F) && T !== null && I !== null) {
        const O = function(z, K, Y, j, Q, N, et) {
          const D = (z._window ? z._window.document : document).createRange();
          return D.setStart(...tn(K, Y, j)), D.setEnd(...tn(Q, N, et)), D;
        }(t, h, f, T, g, R, I);
        l(), l = rd(t, O, e);
      }
...
let ea, Ce = 0, ra = 0, ud = 0, ro = 0, Yr = 0;
function rn(t) {
  if (it === void 0) return;
  let e = t.n;
...
function We(t, e) {
  qt.call(this, void 0), this.x = t, this.s = void 0, this.g = Yr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function pd(t, e) {
  return new We(t, e);
}
...
qt.prototype.brand = dd, qt.prototype.h = function() {
  ...
  if (this.g = Yr, this.f |= 1, this.i > 0 && !ui(this)) return this.f &= -2, !0;
  const t = it;
  try {
    an(this), it = this;
    const e = this.x();
...
class mi extends Wa {
  $config() {
    return this.config("decorator-text", { extends: Wa, stateConfigs: [{ flat: !0, stateConfig: Ma }] });
  }
  getFormat() {
    return Yc(this, Ma);
  }
...
ie({ name: "@lexical/extension/DecoratorText", nodes: () => [mi], register: (t, e, r) => t.registerCommand(Yn, (o) => {
  const n = ee();
  if (Wn(n) || me(n)) for (const i of n.getNodes()) fd(i) && i.toggleFormat(o);
  return !1;
}, Xn) });
function vi(t, e) {
  let r;
  ...
  return Te(t.registerCommand(Nd, (s) => {
    ...
    if (Uc(s.target)) {
      ...
      if (Ed(c)) return function(l, d = !1) {
        ...
        let g;
        d && Wn(w) ? g = w : (g = Hc(), qc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
const To = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
...
const Vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function Ld({ onClear: t }) {
  const [e] = ye();
  return Vd(() => fi(e, t), [e, t]), null;
}
const Ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function jd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: v = "textbox", spellCheck: R = !0, style: y, tabIndex: C, "data-testid": T, ...I }, E) {
  const [F, O] = _(t.isEditable()), z = L((Y) => {
    Y && Y.ownerDocument && Y.ownerDocument.defaultView ? t.setRootElement(Y) : t.setRootElement(null);
  }, [t]), K = A(() => /* @__PURE__ */ function(...Y) {
    return (j) => {
      for (const Q of Y) typeof Q == "function" ? Q(j) : Q != null && (Q.current = j);
    };
  }(E, z), [z, E]);
  return Ci(() => (O(t.isEditable()), t.registerEditableListener((Y) => {
    O(Y);
...
function Zd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Yd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Xd, {}) }) }),
...
function Pi({
  ...
  const [j, Q] = _(hn), [N, et] = _(), [D, M] = _(), q = o, [nt, ot] = _(!1), [ut, jt] = _(!1), [J, st] = _(!1), [ft, mt] = _(!1), [vt, _t] = _(!1), [ht, Bt] = _(T), [re, St] = _(!1), Ft = U(void 0), [gt, Wt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let x = !0;
    return (async () => {
      const $ = y ? await y(l) : !1;
      ...
      children: /* @__PURE__ */ u(nw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        ...
        /* @__PURE__ */ u(dt, { children: [
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            Y && Zt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Kt > 0 && /* @__PURE__ */ u(
              "div",
              {
                        ...
                        Le,
                        {
                          ...
                          children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Be, { children: b == null ? void 0 : b.map((x) => /* @__PURE__ */ a(
                            Se,
                            {
                              ...
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Wr(x, r) })
                            },
                            x || "unassigned"
                          )) }) })
                        }
...
function dw({
  ...
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), j = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : Y, Q = () => {
    const D = o ?? "accept";
    return D === "merged" ? t.mergedText ? /* @__PURE__ */ a(Jr, { html: R }) : Y : j(D === "reject" ? t.rejectedResultText : t.resultText);
...
function Gp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [T, I] = _("*"), [E, F] = _("*"), [O, z] = _("f"), [K, Y] = _(!1), [j, Q] = _(!0), [N, et] = _(!1), D = U(!1), M = U(""), [q, nt] = _(!1), [ot, ut] = _(), [jt, J] = _(), [st, ft] = _(), [mt, vt] = _(), _t = U(null), ht = U(
    void 0
  ...
  const Wt = L(
    ...
    var S;
    ht.current || (S = h.current) == null || S.commitPendingMarkerEdits(), Wt(!0), o();
  }, [o, Wt]), At = U(Nt);
  te(() => {
    At.current = Nt;
  });
  ...
  const we = () => {
    ...
    (S) => {
      ...
      if (B && xr("note", B)) {
        ...
        Q(JSON.stringify(B) === M.current), Wt();
      } else
        Y(!1), Q(!0);
    },
    [Wt]
...
function ah({
  ...
  const g = he(r, "%webView_inventory_all%"), f = he(r, "%webView_inventory_approved%"), b = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), R = he(r, "%webView_inventory_scope_currentBook%"), y = he(r, "%webView_inventory_scope_chapter%"), C = he(r, "%webView_inventory_scope_verse%"), T = he(r, "%webView_inventory_filter_text%"), I = he(
    r,
    "%webView_inventory_show_additional_items%"
  ), E = he(r, "%webView_inventory_no_results%"), [F, O] = _(!1), [z, K] = _("all"), [Y, j] = _(""), [Q, N] = _([]), et = A(() => {
    const J = t ?? [];
  ...
  }, [F, et]), M = A(() => D.length === 0 ? [] : Jw(D, z, Y), [D, z, Y]), q = A(() => {
    var ft, mt;
    if (!F) return l;
...
const fu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ya(t.start, t.end) === 0 ? `${Ea(t.start)}+${e}` : `${Ea(t.start)}+${e}-${Ea(t.end)}+${r}`;
...
function vh({
  ...
  W(() => {
    if (c) {
      ...
      if (K.length === 1) {
        const Y = b.find((j) => yn(j) === K[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, R]);
  ...
  }, F = (z, K) => z.getIsGrouped() ? "" : m("banded-row", K % 2 === 0 ? "even" : "odd"), O = (z, K, Y) => {
    if (!((z == null ? void 0 : z.length) === 0 || K.depth < Y.column.getGroupedIndex())) {
      if (K.getIsGrouped())
        switch (K.depth) {
          case 1:
            return "tw:ps-4";
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(qa, {}) : /* @__PURE__ */ a(Ha, {})),
                          " ",
...
function xh({
  ...
  const I = zt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = zt(s, "%webView_scope_selector_current_book%"), j = zt(s, "%webView_scope_selector_choose_books%"), Q = zt(s, "%webView_scope_selector_scope%"), N = zt(s, "%webView_scope_selector_select_books%"), et = zt(s, "%webView_scope_selector_range%"), D = zt(s, "%webView_scope_selector_select_range%"), M = zt(s, "%webView_scope_selector_range_start%"), q = zt(s, "%webView_scope_selector_range_end%"), nt = zt(s, "%webView_scope_selector_ok%"), ot = zt(s, "%webView_scope_selector_cancel%"), ut = zt(s, "%webView_scope_selector_navigate%"), jt = (V) => {
    if (!b) return;
  ...
  }, Bt = U(null), re = U(null), St = U(!1), Ft = U(null), gt = U(!1), [Wt, xt] = _(void 0), Nt = U(!1), At = U(!1), Xt = U(null), we = L((V) => {
    if (V) {
  ...
  ), ae = Wt === "end", Pr = Wt === "start", qe = "tw:text-muted-foreground", ze = w === "dropdown" && S === "range", Ar = ze ? $ : Re, ma = ze ? ct : f ? oe : ht, Vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Ge, va] = _(null), [Ye, ba] = _(null), [ar, xa] = _(null), ya = 200, [ka, _a] = _(!1);
  W(() => {
...
function no({
  ...
  return /* @__PURE__ */ u(Fe, { variant: i, children: [
    /* @__PURE__ */ a(Ue, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(X, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ws, {}) }) }),
