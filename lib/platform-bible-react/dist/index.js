...
import p, { useCallback as L, useMemo as G, useState as I, useRef as U, useLayoutEffect as dn, createContext as Cr, useContext as _r, useEffect as Et, forwardRef as Cn, Fragment as _n } from "react";
...
const ho = Ct(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Lt : "button", { className: d(ho({ variant: e, size: n, className: t })), ref: i, ...a })
);
...
const ie = Qt.Root, we = Qt.Trigger, Gt = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = Y();
...
const Ln = M.allBookIds.filter(
  (t) => !M.isObsolete(M.bookIdToNumber(t))
), at = Object.fromEntries(
  Ln.map((t) => [t, M.bookIdToEnglishName(t)])
), zo = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon",
...
function ni({
  ...
  const a = Y(), [i, s] = I(!1), [w, m] = I(""), [c, u] = I(""), [g, h] = I("books"), [f, b] = I(void 0), [_, k] = I(!1), S = U(void 0), x = U(void 0), V = U(void 0), A = U(void 0), W = U({}), nt = G(() => o ? o() : Ln, [o]), it = G(() => ({
...
}), Fn = B.Trigger, Gn = B.Group, Lo = B.Portal, Fo = B.Sub, Go = B.RadioGroup;
...
const Bt = F.Root, Uo = F.Group, jt = F.Value, Yo = Ct(
...
Ko.displayName = F.Separator.displayName;
function Jo({ table: t }) {
...
function ii({
  ...
  return /* @__PURE__ */ l(ie, { onOpenChange: (c) => {
    ...
    /* @__PURE__ */ l(Gt, { className: d("tw-min-w-80 tw-max-w-96", a), children: [
...
function di({
  ...
  const s = G(() => ro(n), [n]), m = ((c) => {
    const g = oo().replace(/@posix$/i, ""), h = new Intl.DisplayNames(g, { type: "language" });
    return c.map((f) => h.of(f));
  })(o);
...
function la({
  ...
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ l(ie, { open: g, onOpenChange: h, children: [
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(oe, { children: [
...
function da({
  ...
  const o = n["%webView_inventory_occurrences_table_header_reference%"], a = n["%webView_inventory_occurrences_table_header_occurrence%"], i = G(() => {
    const s = [];
    return t.forEach((w) => {
...
function vi({
  ...
  const c = gt(n, "%webView_inventory_all%"), u = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = I(!1), [A, W] = I("all"), [nt, it] = I(""), [C, v] = I([]), y = G(() => t.length === 0 ? [] : ha(t, a, i), [t, a, i]), E = G(() => {
    if (x) return y;
    const T = [];
    return y.forEach((q) => {
...
const Fe = p.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Lt : "div",
  {
    ref: o,
...
const _a = Ct(
  ...
  ({
    ...
    const m = t ? Lt : "button", { state: c } = Se(), u = /* @__PURE__ */ r(
      m,
      {
        ref: w,
    ...
    er,
    {
      ...
      children: /* @__PURE__ */ l(rr, { children: [
        /* @__PURE__ */ l(Le, { children: [
          ...
          /* @__PURE__ */ r(Ge, { children: /* @__PURE__ */ r(or, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(ar, { children: /* @__PURE__ */ r(
            sr,
            {
              onClick: () => c(h),
              isActive: g(h),
...
function yi({
  ...
  const [m, c] = I([]), [u, g] = I([{ id: yt, desc: !1 }]), [h, f] = I({}), b = G(
...
const dr = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(an, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(Lo, { children: /* @__PURE__ */ r(Hn, { children: dr(
      t,
      e,
      lr(t, w.id),
      o
...
function kn({
  ...
  return /* @__PURE__ */ l(Ze, { variant: i, children: [
    /* @__PURE__ */ r(Fn, { "aria-label": n, className: a, asChild: !0, id: s, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: o ?? /* @__PURE__ */ r(Wr, {}) }) }),
...
), ns = p.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, role: "alert", className: d(es({ variant: e }), t), ...n }));
...
const Li = wt.Trigger, Cs = wt.Portal, Fi = wt.Close, kr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
...
const Bs = (t, e, n = {}) => {
  ...
  const a = U(null), [i, s] = I(void 0), [w, m] = I(void 0), c = L(
    (h) => {
      s(h);
