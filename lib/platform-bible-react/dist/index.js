...
import { ChevronRight as Ja, Check as Za, Circle as Qa, Search as es, History as ts } from "lucide-react";
import * as w from "react";
import Nt, { useMemo as Bt, useState as pt, useCallback as nt, useRef as yr, useEffect as Fn } from "react";
import * as he from "@radix-ui/react-dropdown-menu";
import ye, { clsx as ns } from "clsx";
import { twMerge as rs } from "tailwind-merge";
import { Button as os, Autocomplete as is, TextField as yi, FormControlLabel as vo, FormLabel as as, Checkbox as ss, MenuItem as ls, ListItemText as cs, ListItemIcon as xi, Menu as us, Grid as wi, List as ds, IconButton as Ei, Drawer as ps, Paper as fs, Slider as hs, Snackbar as ms, Switch as gs, AppBar as bs, Toolbar as vs } from "@mui/material";
import ys, { ThemeContext as xs, internal_processStyles as ws } from "@mui/styled-engine";
import * as Es from "react-dom";
import xn from "react-dom";
import { offsetBook as yo, FIRST_SCR_BOOK_NUM as Ts, offsetChapter as xo, FIRST_SCR_CHAPTER_NUM as ks, getChaptersForBook as Os, offsetVerse as wo, FIRST_SCR_VERSE_NUM as Ss } from "platform-bible-utils";
import Ps, { SelectColumn as Cs } from "react-data-grid";
function Je(...e) {
  return rs(ns(e));
}
const Rs = he.Root, Ns = he.Trigger, $s = w.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ be(
  he.SubTrigger,
  {
    ref: o,
    className: Je(
    ...
    children: [
      n,
      /* @__PURE__ */ k(Ja, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
$s.displayName = he.SubTrigger.displayName;
const Ms = w.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ k(
  he.SubContent,
  {
    ref: n,
    className: Je(
...
Ms.displayName = he.SubContent.displayName;
...
const _s = w.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ k(
  he.Item,
  {
    ref: r,
    className: Je(
...
_s.displayName = he.Item.displayName;
const Is = w.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ be(
  he.CheckboxItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ k("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ k(he.ItemIndicator, { children: /* @__PURE__ */ k(Za, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
Is.displayName = he.CheckboxItem.displayName;
const As = w.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ be(
  he.RadioItem,
  {
    ref: r,
    className: Je(
    ...
    ...n,
    children: [
      /* @__PURE__ */ k("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ k(he.ItemIndicator, { children: /* @__PURE__ */ k(Qa, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
As.displayName = he.RadioItem.displayName;
const Ds = w.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ k(
  he.Label,
  {
    ref: r,
...
Ds.displayName = he.Label.displayName;
const js = w.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ k(
  he.Separator,
  {
    ref: n,
...
js.displayName = he.Separator.displayName;
...
function Ls({ endChapter: e, activeChapter: t, handleSelectChapter: n }) {
...
function dh() {
  return /* @__PURE__ */ k("div", { children: /* @__PURE__ */ be(Rs, { children: [
    /* @__PURE__ */ k(
      es,
      {
        style: {
    ...
    /* @__PURE__ */ k(Ns, { style: { backgroundColor: "transparent", border: "none" }, children: /* @__PURE__ */ k(
      Bs,
      {
        value: "Hello",
        placeholder: "Hello"
...
function Hs() {
  return To || (To = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var h = c, S = u, P = l, A = s, I = t, D = d, B = r, z = v, G = b, L = n, _ = i, R = o, j = f, Q = !1;
    function Z(N) {
...
function Gs() {
  if (Ro)
    return lr;
  Ro = 1;
  var e = Oi(), t = Ws(), n = _r(), r = Si(), o = qs(), i = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var Ks = Oi(), Ys = !0;
  wr.exports = Gs()(Ks.isElement, Ys);
} else
  wr.exports = Xs()();
var Js = wr.exports;
const a = /* @__PURE__ */ Vs(Js);
function Lt(e, t) {
...
function Ge(e, t, n = {
  ...
  return dt(e) && dt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (dt(t[o]) && o in e && dt(e[o]) ? r[o] = Ge(e[o], t[o], n) : n.clone ? r[o] = dt(t[o]) ? Pi(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function Zs(e) {
  const {
...
function Ci(e, t, n, r, o) {
  ...
  let l;
  const c = i.type;
  return typeof c == "function" && !Zs(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function el(e, t, n, r, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof i == "function" && !Qs(i) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const tl = Lt(a.elementType, el), nl = "exact-prop: ​";
function Ni(e) {
...
function ol() {
  return Mo || (Mo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var S = s, P = i, A = e, I = c, D = n, B = p, z = f, G = t, L = o, _ = r, R = u, j = d, Q = !1, Z = !1;
    function O(C) {
...
function sl(e) {
  if (e != null) {
    ...
    if (typeof e == "object")
      switch (e.$$typeof) {
        case Nn.ForwardRef:
          return _o(e, e.render, "ForwardRef");
        case Nn.Memo:
          return _o(e, e.type, "memo");
        default:
          return;
      }
  }
...
const ll = a.oneOfType([a.func, a.object]), Ir = ll;
function Ve(e) {
  if (typeof e != "string")
...
const pl = typeof window < "u" ? w.useLayoutEffect : w.useEffect, ht = pl;
let Io = 0;
function fl(e) {
  const [t, n] = w.useState(e), r = e || t;
  return w.useEffect(() => {
    t == null && (Io += 1, n(`mui-${Io}`));
  }, [t]), r;
}
...
function Tl(e) {
  e.addEventListener("keydown", wl, !0), e.addEventListener("mousedown", ur, !0), e.addEventListener("pointerdown", ur, !0), e.addEventListener("touchstart", ur, !0), e.addEventListener("visibilitychange", El, !0);
}
function kl(e) {
  const {
    target: t
...
function Ai() {
  ...
  function n() {
    return t.current ? (kr = !0, vl.start(100, () => {
      kr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
function Nl(e, t = Number.MIN_SAFE_INTEGER, n = Number.MAX_SAFE_INTEGER) {
...
const Fl = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function Vl(e) {
...
function Ul(e) {
  return !(e.disabled || e.tagName === "INPUT" && e.type === "hidden" || zl(e));
}
function Hl(e) {
  const t = [], n = [];
  return Array.from(e.querySelectorAll(Fl)).forEach((r, o) => {
    const i = Vl(r);
...
const an = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  return /* @__PURE__ */ k(w.Fragment, {
    children: s && /* @__PURE__ */ Es.createPortal(r, s)
  });
});
...
function tc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), b = w.useRef(null), v = w.useRef(null), g = Ae(v, f), [m, E] = w.useState(!d), $ = Ql(c);
  let y = !0;
  ...
  }), A = w.useCallback(() => o.isTopModal(h()), [o]), I = on((R) => {
...
var Oe = "top", De = "bottom", je = "right", Se = "left", Ar = "auto", pn = [Oe, De, je, Se], It = "start", sn = "end", nc = "clippingParents", Gi = "viewport", qt = "popper", rc = "reference", Vo = /* @__PURE__ */ pn.reduce(function(e, t) {
  return e.concat([t + "-" + It, t + "-" + sn]);
}, []), Xi = /* @__PURE__ */ [].concat(pn, [Ar]).reduce(function(e, t) {
  return e.concat([t, t + "-" + It, t + "-" + sn]);
}, []), oc = "beforeRead", ic = "read", ac = "afterRead", sc = "beforeMain", lc = "main", cc = "afterMain", uc = "beforeWrite", dc = "write", pc = "afterWrite", fc = [oc, ic, ac, sc, lc, cc, uc, dc, pc];
function ze(e) {
...
function hc(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !Ie(i) || !ze(i) || (Object.assign(i.style, r), Object.keys(o).forEach(function(s) {
      var l = o[s];
...
function mc(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !Ie(o) || !ze(o) || (Object.assign(o.style, l), Object.keys(i).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
function Dt(e, t, n) {
  ...
  t && Ie(e) && (o = e.offsetWidth > 0 && At(r.width) / e.offsetWidth || 1, i = e.offsetHeight > 0 && At(r.height) / e.offsetHeight || 1);
...
function vc(e) {
  ...
  var o = zn(e);
  for (Dr(o) && (o = o.host); Ie(o) && ["html", "body"].indexOf(ze(o)) < 0; ) {
    var i = Ke(o);
...
function fn(e) {
  for (var t = $e(e), n = zo(e); n && bc(n) && Ke(n).position === "static"; )
    n = zo(n);
  return n && (ze(n) === "html" || ze(n) === "body" && Ke(n).position === "static") ? t : n || vc(e) || t;
}
function Br(e) {
...
function wc(e) {
  ...
  if (!(!i || !s)) {
    var f = xc(o.padding, n), p = jr(i), b = c === "y" ? Oe : Se, v = c === "y" ? De : je, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], E = fn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - m / 2, x = f[b], h = $ - p[d] - f[v], S = $ / 2 - p[d] / 2 + y, P = tn(x, S, h), A = c;
...
function Uo(e) {
  ...
  if (u) {
    ...
    if (S === $e(n) && (S = it(n), Ke(S).position !== "static" && l === "absolute" && (P = "scrollHeight", A = "scrollWidth")), S = S, o === Oe || (o === Se || o === je) && i === sn) {
      x = De;
      var I = f && S === h && h.visualViewport ? h.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        S[P]
      );
...
function Fr(e) {
  return Dt(it(e)).left + Lr(e).scrollLeft;
}
function Mc(e, t) {
  var n = $e(e), r = it(e), o = n.visualViewport, i = r.clientWidth, s = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function _c(e) {
  var t, n = it(e), r = Lr(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = ft(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = ft(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Fr(e), c = -r.scrollTop;
...
function ea(e) {
  return ["html", "body", "#document"].indexOf(ze(e)) >= 0 ? e.ownerDocument.body : Ie(e) && Vr(e) ? e : ea(zn(e));
}
function nn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function Wo(e, t, n) {
  return t === Gi ? Pr(Mc(e, n)) : gt(t) ? Ic(t, n) : Pr(_c(it(e)));
}
function Ac(e) {
  var t = nn(zn(e)), n = ["absolute", "fixed"].indexOf(Ke(e).position) >= 0, r = n && Ie(e) ? fn(e) : e;
  return gt(r) ? t.filter(function(o) {
    return gt(o) && Yi(o, r) && ze(o) !== "body";
  }) : [];
}
function Dc(e, t, n, r) {
  var o = t === "clippingParents" ? Ac(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], l = i.reduce(function(c, u) {
    var d = Wo(e, u, r);
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? nc : l, u = n.rootBoundary, d = u === void 0 ? Gi : u, f = n.elementContext, p = f === void 0 ? qt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, E = Zi(typeof m != "number" ? m : Qi(m, pn)), $ = p === qt ? rc : qt, y = e.rects.popper, x = e.elements[v ? $ : p], h = Dc(gt(x) ? x : x.contextElement || it(e.elements.popper), c, d, s), S = Dt(e.elements.reference), P = ta({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
  }), A = Pr(Object.assign({}, y, P)), I = p === qt ? A : S, D = {
  ...
  if (p === qt && B) {
    ...
    Object.keys(D).forEach(function(G) {
      var L = [je, De].indexOf(G) >= 0 ? 1 : -1, _ = [Oe, De].indexOf(G) >= 0 ? "y" : "x";
      D[G] += z[_] * L;
    });
  }
  return D;
...
function Lc(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Fe(m), $ = E === m, y = c || ($ || !v ? [Sn(m)] : Bc(m)), x = [m].concat(y).reduce(function(F, U) {
      return F.concat(Fe(U) === Ar ? jc(t, {
        placement: U,
        boundary: d,
        rootBoundary: f,
        padding: u,
    ...
    }, []), h = t.rects.reference, S = t.rects.popper, P = /* @__PURE__ */ new Map(), A = !0, I = x[0], D = 0; D < x.length; D++) {
      var B = x[D], z = Fe(B), G = jt(B) === It, L = [Oe, De].indexOf(z) >= 0, _ = L ? "width" : "height", R = ln(t, {
        placement: B,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function Kc(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = ln(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Fe(t.placement), $ = jt(t.placement), y = !$, x = Br(E), h = Xc(x), S = t.modifiersData.popperOffsets, P = t.rects.reference, A = t.rects.popper, I = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, D = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (S) {
    if (i) {
      var G, L = x === "y" ? Oe : Se, _ = x === "y" ? De : je, R = x === "y" ? "height" : "width", j = S[x], Q = j + m[L], Z = j - m[_], O = b ? -A[R] / 2 : 0, M = $ === It ? P[R] : A[R], V = $ === It ? -A[R] : -P[R], X = t.elements.arrow, F = b && X ? jr(X) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Ji(), W = U[L], q = U[_], H = tn(0, P[R], F[R]), K = y ? P[R] / 2 - O - H - W - D.mainAxis : M - H - W - D.mainAxis, Y = y ? -P[R] / 2 + O + H + q + D.mainAxis : V + H + q + D.mainAxis, ne = t.elements.arrow && fn(t.elements.arrow), N = ne ? x === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[x]) != null ? G : 0, C = j + K - J - N, re = j + Y - J, ge = tn(b ? _n(Q, C) : Q, j, b ? ft(Z, re) : Z);
      S[x] = ge, z[x] = ge - j;
    }
    if (l) {
      var Ee, fe = x === "x" ? Oe : Se, st = x === "x" ? De : je, Te = S[h], He = h === "y" ? "height" : "width", Pe = Te + m[fe], We = Te - m[st], ve = [Oe, Se].indexOf(E) !== -1, yt = (Ee = B == null ? void 0 : B[h]) != null ? Ee : 0, lt = ve ? Pe : Te - P[He] - A[He] - yt + D.altAxis, Vt = ve ? Te + P[He] + A[He] - yt - D.altAxis : We, bn = b && ve ? yc(lt, Te, Vt) : tn(b ? lt : Pe, Te, b ? Vt : We);
      S[h] = bn, z[h] = bn - Te;
    }
    t.modifiersData[r] = z;
  }
...
function eu(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ie(t), o = Ie(t) && Qc(t), i = it(t), s = Dt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Vr(i)) && (l = Zc(t)), Ie(t) ? (c = Dt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Fr(i))), {
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      setOptions: function(E) {
        ...
        var y = nu(ou([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!p) {
          ...
          if (Ko($, y)) {
            d.rects = {
              reference: eu($, fn(y), d.options.strategy === "fixed"),
              popper: jr(y)
            ...
            for (var x = 0; x < d.orderedModifiers.length; x++) {
              ...
              var h = d.orderedModifiers[x], S = h.fn, P = h.options, A = P === void 0 ? {} : P, I = h.name;
...
var au = [Rc, Gc, Pc, gc, Wc, Fc, Yc, Tc, zc], su = /* @__PURE__ */ iu({
  defaultModifiers: au
});
const na = "Popper";
function lu(e) {
...
Ll(na, ["root"]);
const cu = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], uu = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function du(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const fu = () => Ze({
  root: ["root"]
}, _l(lu)), hu = {}, mu = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, m = ce(t, cu), E = w.useRef(null), $ = Ae(E, n), y = w.useRef(null), x = Ae(y, p), h = w.useRef(x);
  ht(() => {
    h.current = x;
  }, [x]), w.useImperativeHandle(p, () => y.current, []);
  const S = du(d, s), [P, A] = w.useState(S), [I, D] = w.useState(In(o));
  w.useEffect(() => {
...
`));
  ...
  const z = fu(), G = (r = v.root) != null ? r : "div", L = mt({
    elementType: G,
...
function vu(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = ce(e, gu), i = bu(t), s = Object.keys(i);
  function l(p) {
...
const yu = {
  borderRadius: 4
}, xu = yu, wu = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.string, a.object, a.array]) : {}, at = wu;
function rn(e, t) {
  return t ? Ge(e, t, {
    clone: !1
...
const Ou = {
  ...
  if (e.length > 2)
    if (Jo[e])
      ...
      return [e];
  const [t, n] = e.split(""), r = Ou[t], o = Su[n] || "";
  return Array.isArray(o) ? o.map((i) => r + i) : [r + o];
}), Wn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], qn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Cu = [...Wn, ...qn];
function hn(e, t, n, r) {
  var o;
...
function Nu(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = Pu(n), i = Ru(o, r), s = e[n];
  return Ye(e, s, i);
}
function ia(e, t) {
  const n = oa(e.theme);
  return Object.keys(e).map((r) => Nu(e, t, r, n)).reduce(rn, {});
}
function de(e) {
  return ia(e, Wn);
}
de.propTypes = process.env.NODE_ENV !== "production" ? Wn.reduce((e, t) => (e[t] = at, e), {}) : {};
de.filterProps = Wn;
function pe(e) {
  return ia(e, qn);
}
pe.propTypes = process.env.NODE_ENV !== "production" ? qn.reduce((e, t) => (e[t] = at, e), {}) : {};
pe.filterProps = qn;
process.env.NODE_ENV !== "production" && Cu.reduce((e, t) => (e[t] = at, e), {});
function $u(e = 8) {
  if (e.mui)
    return e;
  const t = oa({
...
const Mu = Be("border", _e), _u = Be("borderTop", _e), Iu = Be("borderRight", _e), Au = Be("borderBottom", _e), Du = Be("borderLeft", _e), ju = Be("borderColor"), Bu = Be("borderTopColor"), Lu = Be("borderRightColor"), Fu = Be("borderBottomColor"), Vu = Be("borderLeftColor"), zu = Be("outline", _e), Uu = Be("outlineColor"), Xn = (e) => {
...
Gn(Mu, _u, Iu, Au, Du, ju, Bu, Lu, Fu, Vu, Xn, zu, Uu);
const Kn = (e) => {
...
Gn(Kn, Yn, Jn, Hu, Wu, qu, Gu, Xu, Ku, Yu, Ju, Zu);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const Qu = me({
...
function qr(e = {}, ...t) {
  ...
  return u.applyStyles = pd, u = t.reduce((d, f) => Ge(d, f), u), u.unstable_sxConfig = T({}, Hr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Wr({
      sx: f,
      theme: this
    });
...
const wd = qr(), Zo = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Tn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Td(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ws(s, (h) => h.filter((S) => !(S != null && S.__mui_systemSx)));
    const {
      name: c,
      slot: u,
      ...
      overridesResolver: p = Ed(Zo(u))
    } = l, b = ce(l, vd), v = d !== void 0 ? d : (
    ...
    let E = Pn;
    u === "Root" || u === "root" ? E = r : u ? E = o : xd(s) && (E = void 0);
    const $ = ys(s, T({
      shouldForwardProp: E,
      label: m
    }, b)), y = (h) => typeof h == "function" && h.__emotion_real !== h || dt(h) ? (S) => Cn(h, T({}, S, {
      theme: Tn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let B;
        c && (B = `${c}${Ve(u || "")}`), B === void 0 && (B = `Styled(${sl(s)})`), D.displayName = B;
      }
...
function Gr(e, t = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > n) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${n}].`), Nl(e, t, n);
}
function Sd(e) {
  e = e.slice(1);
...
function Qo(e) {
  e = bt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? bt(Pd(e)).values : e.values;
...
const $d = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ot = Ld, Fd = ["mode", "contrastThreshold", "tonalOffset"], ti = {
...
function ni(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Rd(e.main, o) : t === "dark" && (e.dark = Cd(e.main, i)));
}
function Vd(e = "light") {
  return e === "dark" ? {
    main: Tt[200],
...
function Gd(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ce(e, Fd), i = e.primary || Vd(t), s = e.secondary || zd(t), l = e.error || Ud(t), c = e.info || Hd(t), u = e.success || Wd(t), d = e.warning || qd(t);
  function f(g) {
...
const ep = ["none", ue(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ue(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ue(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ue(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ue(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ue(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ue(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ue(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ue(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ue(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ue(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ue(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ue(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ue(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ue(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ue(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ue(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ue(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ue(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ue(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ue(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ue(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ue(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ue(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], tp = ep, np = ["duration", "easing", "delay"], rp = {
...
function ap(e) {
  const t = T({}, rp, e.easing), n = T({}, op, e.duration);
  return T({
...
const sp = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, lp = sp, cp = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function up(e = {}, ...t) {
  const {
    mixins: n = {},
    palette: r = {},
...
const dp = up(), Xr = dp, Kr = "$$material", ca = (e) => Pn(e) && e !== "classes", pp = Td({
  themeId: Kr,
  defaultTheme: Xr,
...
var hp = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.shape({
  enter: a.number,
  exit: a.number,
  appear: a.number
}).isRequired]) : null;
...
var mp = function(t) {
  return t.scrollTop;
}, Qt = "unmounted", ct = "exited", ut = "entering", Ct = "entered", Rr = "exiting", et = /* @__PURE__ */ function(e) {
  fp(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return i.appearStatus = null, r.in ? l ? (c = ct, i.appearStatus = ut) : c = Ct : r.unmountOnExit || r.mountOnEnter ? c = Qt : c = ct, i.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== ut && s !== Ct && (i = ut) : (s === ut || s === Ct) && (i = Rr);
    }
...
const gp = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function Nr(e) {
  return `scale(${e}, ${e ** 2})`;
}
const bp = {
  ...
  } = t, E = ce(t, gp), $ = Jt(), y = w.useRef(), x = gn(), h = w.useRef(null), S = Ae(h, i.ref, n), P = (_) => (R) => {
    if (_) {
      const j = h.current;
      R === void 0 ? _(j) : _(j, R);
    }
...
const $r = Yr, vp = (e) => {
...
}, si = vp, yp = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], xp = we(ra, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = sa(), i = Qe({
    ...
    slots: y,
    slotProps: x
  } = i, h = ce(i, yp), S = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, P = T({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Ep = ot("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), rt = Ep, Tp = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function kp(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Op = (e) => {
...
const ma = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  const S = Qe({
    ...
    TransitionProps: J
  } = S, C = ce(S, Tp), re = /* @__PURE__ */ w.isValidElement(A) ? A : /* @__PURE__ */ k("span", {
    children: A
  }), ge = gn(), Ee = ge.direction === "rtl", [fe, st] = w.useState(), [Te, He] = w.useState(null), Pe = w.useRef(!1), We = L || Z, ve = Jt(), yt = Jt(), lt = Jt(), Vt = Jt(), [bn, ro] = Ii({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Qn = _i(O), zt = w.useRef(), vn = on(() => {
  ...
  const oo = (ee) => {
    ...
    Pe.current && ee.type !== "touchstart" || (fe && fe.removeAttribute("title"), yt.clear(), lt.clear(), R || kn && j ? yt.start(kn ? j : R, () => {
      oo(ee);
    }) : oo(ee));
  }, io = (ee) => {
    yt.clear(), lt.start(M, () => {
    ...
    fe || st(ee.currentTarget), La(ee), ao.current === !0 && (so(!0), er(ee));
  }, uo = (ee) => {
    Pe.current = !0;
    const Ce = re.props;
    Ce.onTouchStart && Ce.onTouchStart(ee);
  }, po = er, fo = io, Va = (ee) => {
    uo(ee), lt.clear(), ve.clear(), vn(), zt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Vt.start(Q, () => {
      document.body.style.WebkitUserSelect = zt.current, er(ee);
    });
  }, za = (ee) => {
    re.props.onTouchEnd && re.props.onTouchEnd(ee), vn(), lt.start(V, () => {
      yn(ee);
    });
  };
  w.useEffect(() => {
...
`));
  ...
  const Ht = {};
  _ || (Me.onTouchStart = Va, Me.onTouchEnd = za), G || (Me.onMouseOver = On(po, Me.onMouseOver), Me.onMouseLeave = On(fo, Me.onMouseLeave), We || (Ht.onMouseOver = po, Ht.onMouseLeave = fo)), z || (Me.onFocus = On(co, Me.onFocus), Me.onBlur = On(lo, Me.onBlur), We || (Ht.onFocus = co, Ht.onBlur = lo)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Wa = w.useMemo(() => {
    var ee;
    let Ce = [{
    ...
    touch: Pe.current
  }), rr = Op(Wt), ho = (r = (o = Y.popper) != null ? o : I.Popper) != null ? r : Sp, mo = (i = (s = (l = Y.transition) != null ? l : I.Transition) != null ? s : N) != null ? i : $r, go = (c = (u = Y.tooltip) != null ? u : I.Tooltip) != null ? c : Pp, bo = (d = (f = Y.arrow) != null ? f : I.Arrow) != null ? d : Cp, qa = Zt(ho, T({}, H, (p = K.popper) != null ? p : D.popper, {
...
const Mp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], _p = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  const r = Qe({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, b = ce(r, Mp), v = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", g = T({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
`)), Vi.configure(e);
  ...
  ownerDocument: xe,
  ownerWindow: _t,
  requirePropFactory: dl,
  setRef: $n,
  unstable_ClassNameGenerator: Ap,
...
}, Symbol.toStringTag, { value: "Module" })), jp = /* @__PURE__ */ zs(Dp);
var ui;
function Bp() {
...
var va = Jr.default = void 0, Fp = Lp(Bp()), Vp = Ya;
va = Jr.default = (0, Fp.default)(/* @__PURE__ */ (0, Vp.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function di(e, t, n) {
  ...
  const {
    ...
    ls,
    {
      ...
      children: n ? /* @__PURE__ */ be(Ln, { children: [
        di(i, n, !0),
        /* @__PURE__ */ k(cs, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ k(xi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ k(va, {}) }) : di(s, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ k(Rp, { title: r, placement: "right", children: /* @__PURE__ */ k("div", { children: E }) }) : E;
}
function xa(e) {
  return Object.entries(e.groups).map(([n, r]) => ({ id: n, group: r }));
}
function zp(e) {
  const [t, n] = pt(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (u) => {
    n(u.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
...
const Up = (e, t) => t.filter((o) => o.group === e).sort((o, i) => (o.order || 0) - (i.order || 0));
function Qr(e) {
  ...
  return /* @__PURE__ */ be(
    wi,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ k(ds, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ k(
          Hp,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Kp = ["children", "className", "component", "dense", "disablePadding", "subheader"], Yp = (e) => {
  const {
    classes: t,
    disablePadding: n,
    dense: r,
  ...
  return /* @__PURE__ */ k(Gp.Provider, {
    value: f,
    children: /* @__PURE__ */ be(Jp, T({
      as: s,
...
const Zp = Ea, Qp = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function mr(e, t, n) {
...
const ka = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  } = t, p = ce(t, Qp), b = w.useRef(null), v = w.useRef({
    keys: [],
    repeating: !0,
...
const ef = ka, tf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], nf = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  } = t, y = ce(t, tf), x = w.useRef(null), h = Ae(x, l.ref, n), S = (L) => (_) => {
    if (L) {
      const R = x.current;
      _ === void 0 ? L(R) : L(R, _);
    }
...
const af = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], sf = (e) => {
  const {
    classes: t,
    invisible: n
  } = e;
  ...
  const s = Qe({
    ...
    slotProps: v = {},
    slots: g = {},
    TransitionComponent: m = rf,
    transitionDuration: E
  } = s, $ = ce(s, af), y = T({}, s, {
    component: u,
    invisible: p
  }), x = sf(y), h = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ k(m, T({
    in: b,
    timeout: E
  }, $, {
    children: /* @__PURE__ */ k(lf, T({
      "aria-hidden": !0
    }, h, {
...
const df = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], pf = (e) => {
  const {
    open: t,
    exited: n,
    classes: r
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : ff, H = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : E.Backdrop) != null ? i : d, K = (l = G == null ? void 0 : G.root) != null ? l : $.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : $.backdrop, ne = mt({
    elementType: q,
    externalSlotProps: K,
  ...
  return !D && !z && (!X || V) ? null : /* @__PURE__ */ k(an, {
    ...
    children: /* @__PURE__ */ be(q, T({}, ne, {
      children: [!I && d ? /* @__PURE__ */ k(H, T({}, N)) : null, /* @__PURE__ */ k(Mn, {
        disableEnforceFocus: x,
        disableAutoFocus: y,
        disableRestoreFocus: P,
        isEnabled: M,
...
const Ef = ["onEntering"], Tf = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], kf = ["slotProps"];
function fi(e, t) {
  let n = 0;
...
const Of = (e) => {
  ...
  } = s, D = ce(s.TransitionProps, Ef), B = ce(s, Tf), z = (r = x == null ? void 0 : x.paper) != null ? r : $, G = w.useRef(), L = Ae(G, z.ref), _ = T({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
...
`));
    ...
    const st = Ee + C.height, Te = fe + C.width, He = _t(Rn(c)), Pe = He.innerHeight - m, We = He.innerWidth - m;
    if (m !== null && Ee < m) {
      const ve = Ee - m;
      Ee -= ve, re.vertical += ve;
    } else if (m !== null && st > Pe) {
      const ve = st - Pe;
      Ee -= ve, re.vertical += ve;
    }
...
`)), m !== null && fe < m) {
  ...
  const W = v || (c ? xe(Rn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : Sf, H = (i = y == null ? void 0 : y.paper) != null ? i : Ra, K = mt({
    elementType: H,
...
const Rf = ["onEntering"], Nf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], $f = {
  vertical: "top",
  horizontal: "right"
}, Mf = {
  vertical: "top",
  ...
  const i = Qe({
    ...
    slots: $ = {},
    slotProps: y = {}
  } = i, x = ce(i.TransitionProps, Rf), h = ce(i, Nf), S = gn(), P = S.direction === "rtl", A = T({}, i, {
    autoFocus: s,
    ...
    TransitionProps: x,
    variant: E
  }), I = _f(A), D = s && !u && p, B = w.useRef(null), z = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const _ = (r = $.paper) != null ? r : Af, R = (o = y.paper) != null ? o : b, j = mt({
    elementType: $.root,
  ...
  return /* @__PURE__ */ k(If, T({
    ...
    children: /* @__PURE__ */ k(Df, T({
      ...
      className: ye(I.list, d.className),
      children: l
    }))
  }));
});
...
const Mr = (e, t, n = {}) => {
  ...
  const [i, s] = pt(() => r.current), [l, c] = pt(!0);
  return Fn(() => {
    let u = !0;
    return c(!!e), (async () => {
      if (e) {
...
function Ff({
  ...
  Fn(() => {
    if (c) {
      ...
      if (x) {
        const h = x.getBoundingClientRect(), S = window.scrollY, P = window.scrollX, A = h.top + S + x.clientHeight, I = h.left + P;
        m({ top: A, left: I });
      }
    }
  }, [c, o]);
...
var Vf = Object.defineProperty, zf = (e, t, n) => t in e ? Vf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => (zf(e, typeof t != "symbol" ? t + "" : t, n), n);
const vt = [
  "GEN",
  "EXO",
  "LEV",
...
function gh({ scrRef: e, handleSubmit: t, id: n }) {
  const r = (c) => {
    t(c);
  }, o = (c, u) => {
  ...
  return /* @__PURE__ */ be("span", { id: n, children: [
    ...
    /* @__PURE__ */ k(
      ...
      {
        onClick: () => t(xo(e, 1)),
        isDisabled: e.chapterNum >= Os(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ k(
...
function bh({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = pt(""), i = (s) => {
    o(s), e(s);
  };
  return /* @__PURE__ */ k(fs, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ k(
    Bn,
    {
      isFullWidth: n,
...
const Qf = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ k(
  Fs,
  {
    ...r,
    isChecked: n,
...
function Eh({
  ...
  const i = yr(void 0);
  return /* @__PURE__ */ k("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ k(bs, { position: "static", id: r, children: /* @__PURE__ */ be(vs, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ k(
      Ff,
      {
        commandHandler: t,
