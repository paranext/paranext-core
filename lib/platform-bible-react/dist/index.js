import Ds, { jsx as s, jsxs as x, Fragment as tt } from "react/jsx-runtime";
import * as M from "react";
import A, { forwardRef as Zn, useCallback as $e, useState as de, useRef as gt, useEffect as it, useLayoutEffect as Jo, useMemo as Te } from "react";
import { History as Ms, ChevronRight as Wa, Check as xn, Circle as qa, ArrowDownWideNarrow as js, Clock as Bs, Bookmark as Vs, X as Ka, Search as Ja, ChevronsUpDown as Za, FilterIcon as zs, ChevronDown as Qn, ChevronUp as Fs, ArrowLeftIcon as Ls, ChevronLeftIcon as Us, ChevronRightIcon as Gs, ArrowRightIcon as Hs, CircleCheckIcon as Xs, CircleXIcon as Ys, CircleHelpIcon as Ws, ArrowUpIcon as qs, ArrowDownIcon as Ks, ArrowUpDownIcon as Js, Star as Zs, ChevronLeft as Qs, LoaderCircle as el, Download as tl, Filter as nl, User as rl, Link as ol, CircleHelp as al } from "lucide-react";
...
import { getChaptersForBook as cl, deepEqual as to, substring as dl, formatScrRef as Tr, compareScrRefs as Fr, scrRefToBBBCCCVVV as Cr, getLocalizeKeyForScrollGroupId as ue, NumberFormat as pl, formatBytes as ul } from "platform-bible-utils";
...
import { useReactTable as ei, getCoreRowModel as ti, getPaginationRowModel as fl, getSortedRowModel as ni, getFilteredRowModel as ml, flexRender as cn, getExpandedRowModel as hl, getGroupedRowModel as gl } from "@tanstack/react-table";
...
import { toast as sh } from "sonner";
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = a[0], a.length > 1)
        try {
          const i = +a[1].trim();
          this.versification = new ut(He[i]);
        } catch {
...
const ao = we.Root, fi = we.Trigger, Hl = we.Group, Nm = we.Portal, km = we.Sub, Em = we.RadioGroup, Xl = A.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ x(
  we.SubTrigger,
  {
    ref: o,
    className: T(
...
function Tm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = de(""), [o, a] = de(
    oe.bookNumberToId(e.bookNum)
  ), [i, l] = de(e.chapterNum ?? 0), [c, d] = de(
    oe.bookNumberToId(e.bookNum)
  ), [p, h] = de(!1), [f, b] = de(p), v = gt(void 0), w = gt(void 0), m = gt(void 0), N = $e(
    (k) => tc(k).filter((j) => {
      const D = oe.bookIdToEnglishName(j).toLowerCase(), J = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    ec.forEach((k) => {
      const j = n.match(k);
      if (j) {
        const [D, J = void 0, q = void 0] = j.slice(1), U = oc(D);
    ...
    (k) => {
      ...
      m.current !== null ? m.current.focus() : typeof w < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      w.current !== null && w.current.focus(), k.preventDefault()) : h(!0);
    },
    [p]
  ), S = (k) => {
    const { key: j } = k;
  ...
  }, [f]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(ao, { modal: !1, open: p, onOpenChange: E, children: [
    ...
    /* @__PURE__ */ x(
      tr,
      {
        ...
        children: [
          ...
          ea.map(
            (k, j) => N(k).length > 0 && /* @__PURE__ */ x("div", { children: [
              ...
              ea.length - 1 !== j ? /* @__PURE__ */ s(nr, {}) : void 0
            ] }, k)
          )
        ]
      }
...
), Be = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(Qa.Root, { ref: n, className: T("pr-twp", ic(), e), ...t }));
Be.displayName = Qa.Root.displayName;
...
gi.displayName = fn.Root.displayName;
const Gr = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  fn.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ s(fn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ s(qa, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Gr.displayName = fn.Item.displayName;
const bi = mn.Root, vi = mn.Trigger, so = A.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(mn.Portal, { children: /* @__PURE__ */ s(
  mn.Content,
  {
    ref: o,
    align: t,
...
function ta({
  ...
  const [w, m] = de(!1);
  return /* @__PURE__ */ x(bi, { open: w, onOpenChange: m, ...v, children: [
    ...
    /* @__PURE__ */ s(so, { align: h, className: "tw-w-[200px] tw-p-0", dir: f, children: /* @__PURE__ */ x(lo, { children: [
      /* @__PURE__ */ s(co, { dir: f, placeholder: c, className: "tw-text-inherit" }),
...
function wc({
  ...
  return /* @__PURE__ */ x(tt, { children: [
    /* @__PURE__ */ s(Be, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ s(
      ta,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ s(Be, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ s(
      ta,
      {
        isDisabled: o,
...
function Sm({
  ...
  const p = Sr(d, "%webView_bookSelector_currentBook%"), h = Sr(d, "%webView_bookSelector_choose%"), f = Sr(d, "%webView_bookSelector_chooseBooks%"), [b, v] = de(
    "current book"
    /* CURRENT_BOOK */
  ), w = (m) => {
    v(m), e(m);
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Be, { className: "tw-ml-1", children: p })
          ] }),
          /* @__PURE__ */ s(Be, { className: "tw-flex tw-items-center", children: t }),
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Be, { className: "tw-ml-1", children: f })
          ] }),
          /* @__PURE__ */ s(Be, { className: "tw-flex tw-items-center", children: r.map((m) => oe.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ s(
            me,
            {
...
const Bt = be.Root, hc = be.Group, Vt = be.Value, xt = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  be.Trigger,
  {
    ref: r,
    className: T(
...
const zt = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  "td",
  {
    ref: n,
...
function Nc({
  ...
  var m;
  const [l, c] = de([]), [d, p] = de([]), [h, f] = de({}), [b, v] = de({}), w = ei({
    data: t,
    columns: e,
    getCoreRowModel: ti(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ s(mc, { table: w }),
    /* @__PURE__ */ x(rr, { stickyHeader: a, children: [
      /* @__PURE__ */ s(or, { stickyHeader: a, children: w.getHeaderGroups().map((N) => /* @__PURE__ */ s(at, { children: N.headers.map(($) => /* @__PURE__ */ s(hn, { children: $.isPlaceholder ? void 0 : cn($.column.columnDef.header, $.getContext()) }, $.id)) }, N.id)) }),
      /* @__PURE__ */ s(ar, { children: (m = w.getRowModel().rows) != null && m.length ? w.getRowModel().rows.map((N) => /* @__PURE__ */ s(
        at,
        {
          onClick: () => i(N, w),
          "data-state": N.getIsSelected() && "selected",
          children: N.getVisibleCells().map(($) => /* @__PURE__ */ s(zt, { children: cn($.column.columnDef.cell, $.getContext()) }, $.id))
        },
        N.id
      )) : /* @__PURE__ */ s(at, { children: /* @__PURE__ */ s(zt, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function kc({
  ...
  return /* @__PURE__ */ x(rr, { stickyHeader: !0, children: [
    /* @__PURE__ */ s(or, { stickyHeader: !0, children: /* @__PURE__ */ x(at, { children: [
    ...
    /* @__PURE__ */ s(ar, { children: a.length > 0 && a.map((i) => /* @__PURE__ */ x(
      at,
      {
        ...
        children: [
          /* @__PURE__ */ s(zt, { children: `${oe.bookNumberToEnglishName(i.reference.bookNum)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ s(zt, { children: i.text })
        ]
      },
...
fo.displayName = Lr.Root.displayName;
...
const Ln = A.forwardRef(({ className: e, children: t, variant: n, size: r, ...o }, a) => {
...
const ir = (e) => e === "asc" ? /* @__PURE__ */ s(qs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ s(Ks, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Om = (e) => ({
  accessorKey: "item",
  ...
  return Ec(e).forEach((p) => {
    ...
    for (; h; ) {
      const f = [];
      h.forEach((m) => f.push(m));
      const b = h.index, v = a.find((m) => to(m.items, f)), w = {
        reference: {
      ...
      if (v)
        v.count += 1, v.occurrences.push(w);
      else {
        const m = {
          items: f,
          count: 1,
...
function $m({
  ...
  const h = Je(n, "%webView_inventory_all%"), f = Je(n, "%webView_inventory_approved%"), b = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), w = Je(n, "%webView_inventory_scope_currentBook%"), m = Je(n, "%webView_inventory_scope_chapter%"), N = Je(n, "%webView_inventory_scope_verse%"), $ = Je(n, "%webView_inventory_filter_text%"), C = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, g] = de(!1), [P, B] = de("all"), [H, S] = de(""), [_, k] = de([]), j = Te(() => l ? r instanceof RegExp ? Pc(
    l,
    e,
    a,
    i,
    ...
    const y = [];
    return j.forEach((O) => {
      const F = O.items[0], L = y.find(
        (z) => z.items[0] === F
      );
      L ? (L.count += O.count, L.occurrences = L.occurrences.concat(O.occurrences)) : y.push({
        items: [F],
        count: O.count,
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Bt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(Nt, { children: [
              ...
              /* @__PURE__ */ s(Me, { value: "approved", children: f }),
      ...
      /* @__PURE__ */ x(Bt, { onValueChange: (y) => ee(y), defaultValue: c, children: [
        /* @__PURE__ */ s(xt, { className: "tw-m-1", children: /* @__PURE__ */ s(Vt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ x(Nt, { children: [
          /* @__PURE__ */ s(Me, { value: "book", children: w }),
      ...
      o && /* @__PURE__ */ x("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ s(Be, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? C })
      ] })
    ] }),
...
function Im({
  ...
  const [d, p] = de(!1), h = $e(
    (v) => {
      r(
        n.includes(v) ? n.filter((w) => w !== v) : [...n, v]
      );
    },
    [n, r]
  ), f = () => {
    var v;
    return n.length === 1 ? ((v = e.find((w) => w.value === n[0])) == null ? void 0 : v.label) ?? o : i || o;
  }, b = Te(() => {
    if (!l)
      return e;
    const v = e.filter((m) => m.starred).sort((m, N) => m.label.localeCompare(N.label)), w = e.filter((m) => !m.starred).sort((m, N) => {
      const $ = n.includes(m.value), C = n.includes(N.value);
      return $ && !C ? -1 : !$ && C ? 1 : m.label.localeCompare(N.label);
    });
    return [...v, ...w];
  }, [e, n, l]);
          ...
          return /* @__PURE__ */ x(
            wo,
            {
              ...
              children: [
                ...
                t && /* @__PURE__ */ s("div", { className: "tw-w-10 tw-text-right tw-text-muted-foreground", children: w })
              ]
            },
            v.value
          );
...
const rt = "scrBook", Ic = "scrRef", wt = "source", Ac = "details", Dc = "Scripture Reference", Mc = "Scripture Book", Pi = "Type", jc = "Details";
function Bc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? oe.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === rt ? Tr(o.start) : void 0;
      },
      getGroupingValue: (r) => r.start.bookNum,
      sortingFn: (r, o) => Fr(r.original.start, o.original.start),
      enableGrouping: !0
    },
    {
...
const Vc = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || Fr(e.start, e.end) === 0 ? `${Cr(e.start)}+${t}` : `${Cr(e.start)}+${t}-${Cr(e.end)}+${n}`;
...
function Dm({
  ...
  const [d, p] = de([]), [h, f] = de([{ id: rt, desc: !1 }]), [b, v] = de({}), w = Te(
  ...
  it(() => {
    if (l) {
      const S = N.getSelectedRowModel().rowsById, _ = Object.keys(S);
      if (_.length === 1) {
        const k = w.find((j) => ra(j) === _[0]) || void 0;
        k && l(k);
      }
    }
  }, [b, w, l, N]);
  const $ = o ?? Mc, C = a ?? Pi, E = [
    ...
    { label: `Group by ${$}`, value: [rt] },
    { label: `Group by ${C}`, value: [wt] },
    {
      label: `Group by ${$} and ${C}`,
      value: [rt, wt]
    },
    {
      label: `Group by ${C} and ${$}`,
      value: [wt, rt]
    }
  ], g = (S) => {
    p(JSON.parse(S));
  ...
  }, B = (S, _) => S.getIsGrouped() ? "" : T("banded-row", _ % 2 === 0 ? "even" : "odd"), H = (S, _, k) => {
    ...
    !t && /* @__PURE__ */ x(
      Bt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(Nt, { position: "item-aligned", children: /* @__PURE__ */ s(hc, { children: E.map((S) => /* @__PURE__ */ s(Me, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(rr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ s(or, { children: N.getHeaderGroups().map((S) => /* @__PURE__ */ s(at, { children: S.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ s(hn, { colSpan: _.colSpan, className: "top-0 tw-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ x("div", { children: [
          _.column.getCanGroup() ? /* @__PURE__ */ s(
            me,
            {
              variant: "ghost",
          ...
          " ",
          cn(_.column.columnDef.header, _.getContext())
        ] }) }, _.id)
      )) }, S.id)) }),
      /* @__PURE__ */ s(ar, { children: N.getRowModel().rows.map((S, _) => /* @__PURE__ */ s(
        at,
        {
                ...
                zt,
                {
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ x(
                    me,
                    {
                      ...
                      type: "button",
                      children: [
                        S.getIsExpanded() && /* @__PURE__ */ s(Qn, {}),
                        !S.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ s(Wa, {}) : /* @__PURE__ */ s(Qs, {})),
                        " ",
...
function zm({
  ...
  return /* @__PURE__ */ s("div", { id: e, className: t, children: n.map((i) => /* @__PURE__ */ x("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    ...
    /* @__PURE__ */ s(Be, { children: a ? a(i) : i })
  ] }, i)) });
}
function zc(e) {
...
function Uc() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = d, ie.ContextConsumer = l, ie.ContextProvider = i, ie.Element = t, ie.ForwardRef = p, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = a, ie.StrictMode = o, ie.Suspense = h, ie.isAsyncMode = function(g) {
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === d || g === a || g === o || g === h || g === f || typeof g == "object" && g !== null && (g.$$typeof === v || g.$$typeof === b || g.$$typeof === i || g.$$typeof === l || g.$$typeof === p || g.$$typeof === m || g.$$typeof === N || g.$$typeof === $ || g.$$typeof === w);
  }, ie.typeOf = C, ie;
}
var se = {};
/** @license React v16.13.1
...
function Gc() {
  return aa || (aa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(I) {
      ...
      I === r || I === d || I === a || I === o || I === h || I === f || typeof I == "object" && I !== null && (I.$$typeof === v || I.$$typeof === b || I.$$typeof === i || I.$$typeof === l || I.$$typeof === p || I.$$typeof === m || I.$$typeof === N || I.$$typeof === $ || I.$$typeof === w);
    }
    function E(I) {
    ...
    var g = c, P = d, B = l, H = i, S = t, _ = p, k = r, j = v, D = b, J = n, q = a, U = o, ee = h, ae = !1;
    function re(I) {
      return ae || (ae = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), y(I) || E(I) === c;
    }
    function y(I) {
      return E(I) === d;
    }
    ...
    se.AsyncMode = g, se.ConcurrentMode = P, se.ContextConsumer = B, se.ContextProvider = H, se.Element = S, se.ForwardRef = _, se.Fragment = k, se.Lazy = j, se.Memo = D, se.Portal = J, se.Profiler = q, se.StrictMode = U, se.Suspense = ee, se.isAsyncMode = re, se.isConcurrentMode = y, se.isContextConsumer = O, se.isContextProvider = F, se.isElement = L, se.isForwardRef = z, se.isFragment = W, se.isLazy = X, se.isMemo = Y, se.isPortal = G, se.isProfiler = K, se.isStrictMode = Z, se.isSuspense = pe, se.isValidElementType = C, se.typeOf = E;
  }()), se;
}
var ia;
function Ai() {
  return ia || (ia = 1, process.env.NODE_ENV === "production" ? jn.exports = Uc() : jn.exports = Gc()), jn.exports;
}
/*
object-assign
(c) Sindre Sorhus
  ...
  return Dr = function(l, c) {
    ...
    function m(y) {
      ...
      function L(W, X, Y, G, K, Z, pe) {
        ...
        return X[Y] == null ? W ? X[Y] === null ? new w("The " + K + " `" + Z + "` is marked as required " + ("in `" + G + "`, but its value is `null`.")) : new w("The " + K + " `" + Z + "` is marked as required in " + ("`" + G + "`, but its value is `undefined`.")) : null : y(X, Y, G, K, Z);
      }
      var z = L.bind(null, !1);
      return z.isRequired = L.bind(null, !0), z;
    }
    function N(y) {
      function O(F, L, z, W, X, Y) {
        var G = F[L], K = U(G);
        if (K !== y) {
          var Z = ee(G);
          return new w(
    ...
    function P(y) {
      function O(F, L, z, W, X) {
        if (!(F[L] instanceof y)) {
          var Y = y.name || f, G = re(F[L]);
          return new w("Invalid " + W + " `" + X + "` of type " + ("`" + G + "` supplied to `" + z + "`, expected ") + ("instance of `" + Y + "`."));
        }
        return null;
      }
      return m(O);
    ...
    function B(y) {
      ...
      function O(F, L, z, W, X) {
        for (var Y = F[L], G = 0; G < y.length; G++)
          if (v(Y, y[G]))
            return null;
        var K = JSON.stringify(y, function(pe, I) {
          var xe = ee(I);
    ...
    function H(y) {
      function O(F, L, z, W, X) {
        ...
        var Y = F[L], G = U(Y);
        if (G !== "object")
          return new w("Invalid " + W + " `" + X + "` of type " + ("`" + G + "` supplied to `" + z + "`, expected an object."));
        for (var K in Y)
          if (r(Y, K)) {
            var Z = y(Y, K, z, W, X + "." + K, n);
            if (Z instanceof Error)
    ...
    function S(y) {
      ...
      for (var O = 0; O < y.length; O++) {
        ...
        if (typeof F != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ae(F) + " at index " + O + "."
          ), i;
      }
      function L(z, W, X, Y, G) {
        for (var K = [], Z = 0; Z < y.length; Z++) {
          var pe = y[Z], I = pe(z, W, X, Y, G, n);
          if (I == null)
            return null;
          I.data && r(I.data, "expectedType") && K.push(I.data.expectedType);
        }
        var xe = K.length > 0 ? ", expected one of type [" + K.join(", ") + "]" : "";
        return new w("Invalid " + Y + " `" + G + "` supplied to " + ("`" + X + "`" + xe + "."));
      }
      return m(L);
    }
    function _() {
      function y(O, F, L, z, W) {
        return J(O[F]) ? null : new w("Invalid " + z + " `" + W + "` supplied to " + ("`" + L + "`, expected a ReactNode."));
      }
      return m(y);
    }
    function k(y, O, F, L, z) {
      return new w(
        (y || "React class") + ": " + O + " type `" + F + "." + L + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + z + "`."
      );
    }
    function j(y) {
      function O(F, L, z, W, X) {
        var Y = F[L], G = U(Y);
        if (G !== "object")
          return new w("Invalid " + W + " `" + X + "` of type `" + G + "` " + ("supplied to `" + z + "`, expected `object`."));
        for (var K in y) {
          var Z = y[K];
          if (typeof Z != "function")
            return k(z, W, X, K, ee(Z));
          var pe = Z(Y, K, z, W, X + "." + K, n);
          if (pe)
            return pe;
        }
        return null;
...
const ji = ho(u.element, Mi);
ji.isRequired = ho(u.element.isRequired, Mi);
const Bi = ji, Qc = "exact-prop: ​";
function ed(e) {
...
function td() {
  ...
  return le.ContextConsumer = i, le.ContextProvider = a, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = f, le.Memo = h, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = d, le.SuspenseList = p, le.isAsyncMode = function() {
    return !1;
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === d || m === p || m === b || typeof m == "object" && m !== null && (m.$$typeof === f || m.$$typeof === h || m.$$typeof === a || m.$$typeof === i || m.$$typeof === c || m.$$typeof === v || m.getModuleId !== void 0);
  }, le.typeOf = w, le;
}
var ce = {};
/**
...
function nd() {
  return fa || (fa = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, w = !1, m = !1, N = !1, $ = !1, C;
    C = Symbol.for("react.module.reference");
    function E(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || $ || V === r || V === d || V === p || N || V === b || v || w || m || typeof V == "object" && V !== null && (V.$$typeof === f || V.$$typeof === h || V.$$typeof === a || V.$$typeof === i || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    var P = i, B = a, H = e, S = c, _ = n, k = f, j = h, D = t, J = o, q = r, U = d, ee = p, ae = !1, re = !1;
    function y(V) {
    ...
    ce.ContextConsumer = P, ce.ContextProvider = B, ce.Element = H, ce.ForwardRef = S, ce.Fragment = _, ce.Lazy = k, ce.Memo = j, ce.Portal = D, ce.Profiler = J, ce.StrictMode = q, ce.Suspense = U, ce.SuspenseList = ee, ce.isAsyncMode = y, ce.isConcurrentMode = O, ce.isContextConsumer = F, ce.isContextProvider = L, ce.isElement = z, ce.isForwardRef = W, ce.isFragment = X, ce.isLazy = Y, ce.isMemo = G, ce.isPortal = K, ce.isProfiler = Z, ce.isStrictMode = pe, ce.isSuspense = I, ce.isSuspenseList = xe, ce.isValidElementType = E, ce.typeOf = g;
  }()), ce;
}
...
const id = u.oneOfType([u.func, u.object]), zi = id;
function We(e) {
  if (typeof e != "string")
...
function ud(e, t) {
  ...
  return (o) => (a, i, l, c, d, ...p) => {
    const h = d || i, f = n == null ? void 0 : n[h];
    if (f) {
      const b = f(a, i, l, c, d, ...p);
      if (b)
        return b;
    }
...
function Ed(e) {
  e.addEventListener("keydown", Nd, !0), e.addEventListener("mousedown", jr, !0), e.addEventListener("pointerdown", jr, !0), e.addEventListener("touchstart", jr, !0), e.addEventListener("visibilitychange", kd, !0);
}
function Td(e) {
  const {
    target: t
...
function _d(e) {
  ...
  function d(f, b) {
    const v = i.indexOf(b);
    return `@media (min-width:${typeof t[f] == "number" ? t[f] : f}${n}) and (max-width:${(v !== -1 && typeof t[i[v]] == "number" ? t[i[v]] : b) - r / 100}${n})`;
  }
  function p(f) {
  ...
  function h(f) {
    const b = i.indexOf(f);
    return b === 0 ? l(i[1]) : b === i.length - 1 ? c(i[b]) : d(f, i[i.indexOf(f) + 1]).replace("@media", "@media not all and");
  }
  return R({
    keys: i,
    values: a,
...
function ve(e) {
  const {
    ...
    return Qe(i, l, (h) => {
      let f = Wn(d, o, h);
      return h === f && typeof h == "string" && (f = Wn(d, o, `${t}${h === "default" ? "" : We(h)}`, h)), n === !1 ? f : {
        [n]: f
      };
    });
  };
...
const Bd = {
  ...
  if (e.length > 2)
    if (Na[e])
      ...
      return [e];
  const [t, n] = e.split(""), r = Bd[t], o = Vd[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), dr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], pr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Fd = [...dr, ...pr];
function Cn(e, t, n, r) {
  var o;
...
function Ud(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = zd(n), a = Ld(o, r), i = e[n];
  return Qe(e, i, a);
}
function qi(e, t) {
  const n = Wi(e.theme);
  return Object.keys(e).map((r) => Ud(e, t, r, n)).reduce(pn, {});
}
function he(e) {
  return qi(e, dr);
}
...
function ur(...e) {
  const t = e.reduce((r, o) => (o.filterProps.forEach((a) => {
    r[a] = o;
  }), r), {}), n = (r) => Object.keys(r).reduce((o, a) => t[a] ? pn(o, t[a](r)) : o, {});
...
const Hd = Le("border", je), Xd = Le("borderTop", je), Yd = Le("borderRight", je), Wd = Le("borderBottom", je), qd = Le("borderLeft", je), Kd = Le("borderColor"), Jd = Le("borderTopColor"), Zd = Le("borderRightColor"), Qd = Le("borderBottomColor"), ep = Le("borderLeftColor"), tp = Le("outline", je), np = Le("outlineColor"), wr = (e) => {
...
function Ep() {
  function e(n, r, o, a) {
    ...
    return h ? h(i) : Qe(i, r, (v) => {
      let w = Wn(f, p, v);
      return v === w && typeof v == "string" && (w = Wn(f, p, `${n}${v === "default" ? "" : We(v)}`, v)), c === !1 ? w : {
        [c]: w
      };
    });
  }
...
function Mp(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    yl(i, (g) => g.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const $ = bl(i, R({
      shouldForwardProp: N,
      label: m
    }, b)), C = (g) => typeof g == "function" && g.__emotion_real !== g || ht(g) ? (P) => Gn(g, R({}, P, {
      theme: Bn({
        theme: P.theme,
        defaultTheme: n,
        themeId: t
      ...
      c && f && H.push((k) => {
        ...
        if (!j.components || !j.components[c] || !j.components[c].styleOverrides)
          return null;
        const D = j.components[c].styleOverrides, J = {};
        ...
        const D = Bn(R({}, k, {
          defaultTheme: n,
          themeId: t
        })), J = D == null || (j = D.components) == null || (j = j[c]) == null ? void 0 : j.variants;
        return Gn({
          variants: J
        }, R({}, k, {
          theme: D
      ...
      const S = H.length - P.length;
      if (Array.isArray(g) && S > 0) {
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${We(d || "")}`), k === void 0 && (k = `Styled(${ad(i)})`), _.displayName = k;
      }
...
function Ea(e) {
  e = Et(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Et(zp(e)).values : e.values;
...
const Gp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, At = Zp, Qp = ["mode", "contrastThreshold", "tonalOffset"], Ca = {
...
function Sa(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Lp(e.main, o) : t === "dark" && (e.dark = Fp(e.main, a)));
}
function eu(e = "light") {
  return e === "dark" ? {
    main: $t[200],
...
function iu(e) {
  ...
  function h(w) {
    const m = Ta(w, Br.text.primary) >= n ? Br.text.primary : Ca.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const N = Ta(w, m);
      N < 3 && console.error([`MUI: The contrast ratio of ${N}:1 for ${m} on ${w}`, "falls below the WCAG recommended absolute minimum contrast ratio of 3:1.", "https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
`));
    }
    return m;
  }
  const f = ({
    ...
    if (w = R({}, w), !w.main && w[N] && (w.main = w[N]), !w.hasOwnProperty("main"))
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The color${m ? ` (${m})` : ""} provided to augmentColor(color) is invalid.
The color object needs to have a \`main\` property or a \`${N}\` property.` : Ft(11, m ? ` (${m})` : "", N));
...
} });` : Ft(12, m ? ` (${m})` : "", JSON.stringify(w.main)));
    return Sa(w, "light", $, r), Sa(w, "dark", C, r), w.contrastText || (w.contrastText = h(w.main)), w;
  }, b = {
    dark: Br,
    light: Ca
  };
...
function cu(e, t) {
  ...
  const b = o / 14, v = h || ((N) => `${N / d * b}rem`), w = (N, $, C, E, g) => R({
    fontFamily: r,
    fontWeight: N,
    fontSize: v($),
    ...
    button: w(l, 14, 1.75, 0.4, Oa),
    caption: w(i, 12, 1.66, 0.4),
    overline: w(i, 12, 2.66, 1, Oa),
...
function ku(e = {}, ...t) {
  ...
  if (d = Ze(d, i), d = t.reduce((p, h) => Ze(p, h), d), process.env.NODE_ENV !== "production") {
    const p = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], h = (f, b) => {
      let v;
      for (v in f) {
        const w = f[v];
        if (p.indexOf(v) !== -1 && Object.keys(w).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const m = lr("", v);
            console.error([`MUI: The \`${b}\` component increases the CSS specificity of the \`${v}\` internal state.`, "You can not override it like this: ", JSON.stringify(f, null, 2), "", `Instead, you need to use the '&.${m}' syntax:`, JSON.stringify({
              root: {
                [`&.${m}`]: w
              }
...
const Ou = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ru = (e) => {
  ...
  const r = So({
    ...
    titleAccess: h,
    viewBox: f = "0 0 24 24"
  } = r, b = Ne(r, Ou), v = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", w = R({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), Iu = /* @__PURE__ */ Fc($u);
var $a;
function Au() {
...
var ts = mo.default = void 0, Mu = Du(Au()), ju = Ds;
ts = mo.default = (0, Mu.default)(/* @__PURE__ */ (0, ju.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Bu(e) {
...
}, zu = /* @__PURE__ */ M.createContext(Vu);
function Fu(e) {
  const {
...
function Gu(e) {
  ...
  if (!t) {
    const b = bt(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = R({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = R({}, n, o, r);
    return b.length > 0 && (w.className = b), Object.keys(v).length > 0 && (w.style = v), {
      props: w,
      internalRef: void 0
    };
  }
  const i = Lu(R({}, o, r)), l = Ia(r), c = Ia(o), d = t(i), p = bt(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = R({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = R({}, d, n, c, l);
...
function Xu(e) {
  ...
  const {
    ...
    externalSlotProps: l
  })), p = kt(d, l == null ? void 0 : l.ref, (t = e.additionalProps) == null ? void 0 : t.ref);
  return sn(n, R({}, c, {
    ref: p
  }), o);
}
...
var Ce = "top", ze = "bottom", Fe = "right", Se = "left", Ro = "auto", Rn = [Ce, ze, Fe, Se], Ut = "start", vn = "end", Ju = "clippingParents", os = "viewport", nn = "popper", Zu = "reference", Aa = /* @__PURE__ */ Rn.reduce(function(e, t) {
...
function cw(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !Ve(a) || !qe(a) || (Object.assign(a.style, r), Object.keys(o).forEach(function(i) {
      var l = o[i];
...
function dw(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !Ve(o) || !qe(o) || (Object.assign(o.style, l), Object.keys(a).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
function Ht(e, t, n) {
  ...
  t && Ve(e) && (o = e.offsetWidth > 0 && Gt(r.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && Gt(r.height) / e.offsetHeight || 1);
  var i = Tt(e) ? Ae(e) : window, l = i.visualViewport, c = !is() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, h = r.width / o, f = r.height / a;
  return {
    width: h,
    height: f,
    top: p,
...
function ww(e) {
  ...
  var o = br(e);
  for (Po(o) && (o = o.host); Ve(o) && ["html", "body"].indexOf(qe(o)) < 0; ) {
    var a = et(o);
...
function hw(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Xe(n.placement), c = $o(l), d = [Se, Fe].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var h = mw(o.padding, n), f = _o(a), b = c === "y" ? Ce : Se, v = c === "y" ? ze : Fe, w = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], m = i[c] - n.rects.reference[c], N = Pn(a), $ = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, C = w / 2 - m / 2, E = h[b], g = $ - f[p] - h[v], P = $ / 2 - f[p] / 2 + C, B = un(E, P, g), H = c;
...
function Ma(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, i = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, p = e.roundOffsets, h = e.isFixed, f = i.x, b = f === void 0 ? 0 : f, v = i.y, w = v === void 0 ? 0 : v, m = typeof p == "function" ? p({
    x: b,
    y: w
  }) : {
    x: b,
  ...
  b = m.x, w = m.y;
  var N = i.hasOwnProperty("x"), $ = i.hasOwnProperty("y"), C = Se, E = Ce, g = window;
  if (d) {
    var P = Pn(n), B = "clientHeight", H = "clientWidth";
    if (P === Ae(n) && (P = lt(n), et(P).position !== "static" && l === "absolute" && (B = "scrollHeight", H = "scrollWidth")), P = P, o === Ce || (o === Se || o === Fe) && a === vn) {
      E = ze;
      var S = h && P === g && g.visualViewport ? g.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        P[B]
      );
      w -= S - r.height, w *= c ? 1 : -1;
    }
    if (o === Se || (o === Ce || o === ze) && a === vn) {
      C = Fe;
      var _ = h && P === g && g.visualViewport ? g.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        P[H]
      );
      b -= _ - r.width, b *= c ? 1 : -1;
  ...
  if (b = j.x, w = j.y, c) {
    var D;
    return Object.assign({}, k, (D = {}, D[E] = $ ? "0" : "", D[C] = N ? "0" : "", D.transform = (g.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + w + "px)" : "translate3d(" + b + "px, " + w + "px, 0)", D));
  }
  return Object.assign({}, k, (t = {}, t[E] = $ ? w + "px" : "", t[C] = N ? b + "px" : "", t.transform = "", t));
}
function xw(e) {
...
function ps(e) {
  return ["html", "body", "#document"].indexOf(qe(e)) >= 0 ? e.ownerDocument.body : Ve(e) && Do(e) ? e : ps(br(e));
}
function wn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function Ba(e, t, n) {
  return t === os ? Kr(Sw(e, n)) : Tt(t) ? Rw(t, n) : Kr(Ow(lt(e)));
}
function Pw(e) {
  var t = wn(br(e)), n = ["absolute", "fixed"].indexOf(et(e).position) >= 0, r = n && Ve(e) ? Pn(e) : e;
  return Tt(r) ? t.filter(function(o) {
    return Tt(o) && ss(o, r) && qe(o) !== "body";
  }) : [];
}
function _w(e, t, n, r) {
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Ju : l, d = n.rootBoundary, p = d === void 0 ? os : d, h = n.elementContext, f = h === void 0 ? nn : h, b = n.altBoundary, v = b === void 0 ? !1 : b, w = n.padding, m = w === void 0 ? 0 : w, N = cs(typeof m != "number" ? m : ds(m, Rn)), $ = f === nn ? Zu : nn, C = e.rects.popper, E = e.elements[v ? $ : f], g = _w(Tt(E) ? E : E.contextElement || lt(e.elements.popper), c, p, i), P = Ht(e.elements.reference), B = us({
    reference: P,
    element: C,
    strategy: "absolute",
    placement: o
  }), H = Kr(Object.assign({}, C, B)), S = f === nn ? H : P, _ = {
    top: g.top - S.top + N.top,
    bottom: S.bottom - g.bottom + N.bottom,
    left: g.left - S.left + N.left,
    right: S.right - g.right + N.right
  }, k = e.modifiersData.offset;
  if (f === nn && k) {
    var j = k[o];
    Object.keys(_).forEach(function(D) {
      var J = [Fe, ze].indexOf(D) >= 0 ? 1 : -1, q = [Ce, ze].indexOf(D) >= 0 ? "y" : "x";
      _[D] += j[q] * J;
    });
  }
  return _;
...
function $w(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? as : c, p = Xt(r), h = p ? l ? Aa : Aa.filter(function(v) {
    return Xt(v) === p;
  }) : Rn, f = h.filter(function(v) {
    return d.indexOf(v) >= 0;
  });
  f.length === 0 && (f = h);
  var b = f.reduce(function(v, w) {
    return v[w] = yn(e, {
      placement: w,
      boundary: o,
      rootBoundary: a,
  ...
  return Object.keys(b).sort(function(v, w) {
    return b[v] - b[w];
  });
}
function Iw(e) {
...
function Aw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, f = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, w = n.allowedAutoPlacements, m = t.options.placement, N = Xe(m), $ = N === m, C = c || ($ || !v ? [Hn(m)] : Iw(m)), E = [m].concat(C).reduce(function(z, W) {
      return z.concat(Xe(W) === Ro ? $w(t, {
        placement: W,
        boundary: p,
        rootBoundary: h,
        padding: d,
    ...
    }, []), g = t.rects.reference, P = t.rects.popper, B = /* @__PURE__ */ new Map(), H = !0, S = E[0], _ = 0; _ < E.length; _++) {
      var k = E[_], j = Xe(k), D = Xt(k) === Ut, J = [Ce, ze].indexOf(j) >= 0, q = J ? "width" : "height", U = yn(t, {
        placement: k,
        boundary: p,
        rootBoundary: h,
        altBoundary: f,
        padding: d
      }), ee = J ? D ? Fe : Se : D ? ze : Ce;
      g[q] > P[q] && (ee = Hn(ee));
      var ae = Hn(ee), re = [];
      if (a && re.push(U[j] <= 0), l && re.push(U[ee] <= 0, U[ae] <= 0), re.every(function(z) {
        return z;
      })) {
        S = k, H = !1;
        break;
...
function za(e) {
  return [Ce, Fe, ze, Se].some(function(t) {
    return e[t] >= 0;
  });
}
function Mw(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, i = yn(t, {
    ...
    altBoundary: !0
  }), c = Va(i, r), d = Va(l, o, a), p = za(c), h = za(d);
  t.modifiersData[n] = {
...
function Bw(e, t, n) {
  ...
  return i = i || 0, l = (l || 0) * o, [Se, Fe].indexOf(r) >= 0 ? {
    x: l,
    y: i
  } : {
    x: i,
...
function Gw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, f = n.tether, b = f === void 0 ? !0 : f, v = n.tetherOffset, w = v === void 0 ? 0 : v, m = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: p
  }), N = Xe(t.placement), $ = Xt(t.placement), C = !$, E = $o(N), g = Uw(E), P = t.modifiersData.popperOffsets, B = t.rects.reference, H = t.rects.popper, S = typeof w == "function" ? w(Object.assign({}, t.rects, {
    placement: t.placement
  })) : w, _ = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
  ...
  if (P) {
    if (a) {
      var D, J = E === "y" ? Ce : Se, q = E === "y" ? ze : Fe, U = E === "y" ? "height" : "width", ee = P[E], ae = ee + m[J], re = ee - m[q], y = b ? -H[U] / 2 : 0, O = $ === Ut ? B[U] : H[U], F = $ === Ut ? -H[U] : -B[U], L = t.elements.arrow, z = b && L ? _o(L) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ls(), X = W[J], Y = W[q], G = un(0, B[U], z[U]), K = C ? B[U] / 2 - y - G - X - _.mainAxis : O - G - X - _.mainAxis, Z = C ? -B[U] / 2 + y + G + Y + _.mainAxis : F + G + Y + _.mainAxis, pe = t.elements.arrow && Pn(t.elements.arrow), I = pe ? E === "y" ? pe.clientTop || 0 : pe.clientLeft || 0 : 0, xe = (D = k == null ? void 0 : k[E]) != null ? D : 0, V = ee + K - xe - I, ye = ee + Z - xe, Ue = un(b ? Kn(ae, V) : ae, ee, b ? vt(re, ye) : re);
      P[E] = Ue, j[E] = Ue - ee;
    }
    if (l) {
      var ct, ke = E === "x" ? Ce : Se, $n = E === "x" ? ze : Fe, Ge = P[g], Ct = g === "y" ? "height" : "width", dt = Ge + m[ke], St = Ge - m[$n], Ot = [Ce, Se].indexOf(N) !== -1, Rt = (ct = k == null ? void 0 : k[g]) != null ? ct : 0, pt = Ot ? dt : Ge - B[Ct] - H[Ct] - Rt + _.altAxis, Wt = Ot ? Ge + B[Ct] + H[Ct] - Rt - _.altAxis : St, In = b && Ot ? fw(pt, Ge, Wt) : un(b ? pt : dt, Ge, b ? Wt : St);
      P[g] = In, j[g] = In - Ge;
    }
    t.modifiersData[r] = j;
  }
...
function qw(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ve(t), o = Ve(t) && Ww(t), a = lt(t), i = Ht(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Do(a)) && (l = Yw(t)), Ve(t) ? (c = Ht(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Ao(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(N) {
        var $ = typeof N == "function" ? N(p.options) : N;
        w(), p.options = Object.assign({}, a, p.options, $), p.scrollParents = {
          reference: Tt(l) ? wn(l) : l.contextElement ? wn(l.contextElement) : [],
          popper: wn(c)
        };
        var C = Jw(Qw([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          var N = p.elements, $ = N.reference, C = N.popper;
          if (La($, C)) {
            p.rects = {
              reference: qw($, Pn(C), p.options.strategy === "fixed"),
              popper: _o(C)
            ...
            for (var E = 0; E < p.orderedModifiers.length; E++) {
              ...
              var g = p.orderedModifiers[E], P = g.fn, B = g.options, H = B === void 0 ? {} : B, S = g.name;
    ...
    b.setOptions(d).then(function(m) {
      !f && d.onFirstUpdate && d.onFirstUpdate(m);
    });
    function v() {
      p.orderedModifiers.forEach(function(m) {
        var N = m.name, $ = m.options, C = $ === void 0 ? {} : $, E = m.effect;
        if (typeof E == "function") {
          var g = E({
            state: p,
            name: N,
...
var tf = [Ew, Lw, Nw, pw, zw, Dw, Hw, bw, jw], nf = /* @__PURE__ */ ef({
  defaultModifiers: tf
});
const ws = "Popper";
function rf(e) {
...
const cf = () => bo({
  root: ["root"]
}, Fu(rf)), df = {}, pf = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, m = Ne(t, of), N = M.useRef(null), $ = kt(N, n), C = M.useRef(null), E = kt(C, f), g = M.useRef(E);
  Lt(() => {
    g.current = E;
  }, [E]), M.useImperativeHandle(f, () => C.current, []);
  const P = sf(p, i), [B, H] = M.useState(P), [S, _] = M.useState(Jn(o));
  M.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && S && vr(S) && S.nodeType === 1) {
...
`));
  ...
  w !== null && (k.TransitionProps = w);
  const j = cf(), D = (r = v.root) != null ? r : "div", J = Xu({
    elementType: D,
  ...
  if (a)
    ...
    const _ = Jn(r);
    B = _ && vr(_) ? Xn(_).body : Xn(null).body;
  }
  const H = !p && c && (!w || C) ? "none" : void 0, S = w ? {
    in: p,
    onEnter: g,
    onExited: P
  } : void 0;
...
var ff = function(t) {
  return t.scrollTop;
}, ln = "unmounted", ft = "exited", mt = "entering", Mt = "entered", Zr = "exiting", nt = /* @__PURE__ */ function(e) {
  uf(t, e);
  function t(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Mn.findDOMNode(this), l], d = c[0], p = c[1], h = this.getTimeouts(), f = l ? h.appear : h.enter;
    if (!o && !i || Ua.disabled) {
      this.safeSetState({
        status: Mt
      }, function() {
...
const bf = {
  ...
  const {
  ...
  } = t, N = Ne(t, gf), $ = an(), C = M.useRef(), E = ms(), g = M.useRef(null), P = kt(g, a.ref, n), B = (q) => (U) => {
    if (q) {
      const ee = g.current;
    ...
    let y;
    w === "auto" ? (y = E.transitions.getAutoHeightDuration(q.clientHeight), C.current = y) : y = ee, q.style.transition = [E.transitions.create("opacity", {
      duration: y,
      delay: ae
    ...
    let re;
    w === "auto" ? (re = E.transitions.getAutoHeightDuration(q.clientHeight), C.current = re) : re = U, q.style.transition = [E.transitions.create("opacity", {
      duration: re,
      delay: ee
    }), E.transitions.create("transform", {
  ...
  return /* @__PURE__ */ s(m, R({
    ...
    onExiting: k,
    addEndListener: (q) => {
      w === "auto" && $.start(C.current || 0, q), r && r(g.current, q);
    },
...
const Ha = Mo, vf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], yf = On(fs, {
  ...
  const o = Ji(), a = So({
    ...
    slots: C,
    slotProps: E
  } = a, g = Ne(a, vf), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, B = R({
    anchorEl: i,
    container: p,
    disablePortal: h,
    keepMounted: f,
...
const Nf = Yi("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ot = Nf, kf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Ef(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Tf = (e) => {
  ...
  [`&[data-popper-placement*="right"] .${ot.arrow}`]: R({}, t.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${ot.arrow}`]: R({}, t.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  [`.${ot.popper}[data-popper-placement*="left"] &`]: R({
  ...
  [`.${ot.popper}[data-popper-placement*="right"] &`]: R({
  ...
  [`.${ot.popper}[data-popper-placement*="top"] &`]: R({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, t.touch && {
    marginBottom: "24px"
  }),
  [`.${ot.popper}[data-popper-placement*="bottom"] &`]: R({
...
const vs = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, i, l, c, d, p, h, f, b, v, w, m, N, $, C, E, g;
  const P = So({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: xe
  } = P, V = Ne(P, kf), ye = /* @__PURE__ */ M.isValidElement(H) ? H : /* @__PURE__ */ s("span", {
    children: H
  }), Ue = ms(), ct = Ue.direction === "rtl", [ke, $n] = M.useState(), [Ge, Ct] = M.useState(null), dt = M.useRef(!1), St = J || re, Ot = an(), Rt = an(), pt = an(), Wt = an(), [In, jo] = Li({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    M.useEffect(() => {
      ke && ke.disabled && !Q && pe !== "" && ke.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [pe, ke, Q]);
  }
  ...
  const Bo = (Q) => {
    ...
    (Q) => {
      Xa.start(800 + O, () => {
        zn = !1;
      }), jo(!1), L && Ke && L(Q), Ot.start(Ue.transitions.duration.shortest, () => {
        dt.current = !1;
      });
    }
  ), xr = (Q) => {
    dt.current && Q.type !== "touchstart" || (ke && ke.removeAttribute("title"), Rt.clear(), pt.clear(), U || zn && ee ? Rt.start(zn ? ee : U, () => {
      Bo(Q);
    }) : Bo(Q));
  }, Vo = (Q) => {
    Rt.clear(), pt.start(O, () => {
    ...
    onFocus: Es,
    ref: Ts
  } = Ui(), [, Fo] = M.useState(!1), Lo = (Q) => {
    ks(Q), zo.current === !1 && (Fo(!1), Vo(Q));
  }, Uo = (Q) => {
    ke || $n(Q.currentTarget), Es(Q), zo.current === !0 && (Fo(!0), xr(Q));
  }, Go = (Q) => {
    dt.current = !0;
    const Pe = ye.props;
    Pe.onTouchStart && Pe.onTouchStart(Q);
  }, Ho = xr, Xo = Vo, Cs = (Q) => {
    Go(Q), pt.clear(), Ot.clear(), An(), qt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Wt.start(ae, () => {
      document.body.style.WebkitUserSelect = qt.current, xr(Q);
    });
  }, Ss = (Q) => {
    ye.props.onTouchEnd && ye.props.onTouchEnd(Q), An(), pt.start(F, () => {
      Dn(Q);
    });
  };
  M.useEffect(() => {
  ...
  }, Kt = {}, kr = typeof pe == "string";
  k ? (Kt.title = !Ke && kr && !D ? pe : null, Kt["aria-describedby"] = Ke ? yr : null) : (Kt["aria-label"] = kr ? pe : null, Kt["aria-labelledby"] = Ke && !kr ? yr : null);
  const De = R({}, Kt, V, ye.props, {
    className: bt(V.className, ye.props.className),
    onTouchStart: Go,
    ref: Os
  }, re ? {
    onMouseMove: Rs
...
`));
  ...
  const Jt = {};
  q || (De.onTouchStart = Cs, De.onTouchEnd = Ss), D || (De.onMouseOver = Fn(Ho, De.onMouseOver), De.onMouseLeave = Fn(Xo, De.onMouseLeave), St || (Jt.onMouseOver = Ho, Jt.onMouseLeave = Xo)), j || (De.onFocus = Fn(Uo, De.onFocus), De.onBlur = Fn(Lo, De.onBlur), St || (Jt.onFocus = Uo, Jt.onBlur = Lo)), process.env.NODE_ENV !== "production" && ye.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ye.props.title}\` or the Tooltip component.`].join(`
`));
  const Ps = M.useMemo(() => {
    var Q;
    let Pe = [{
    ...
    touch: dt.current
  }), Er = Tf(Zt), Yo = (r = (o = Z.popper) != null ? o : S.Popper) != null ? r : Cf, Wo = (a = (i = (l = Z.transition) != null ? l : S.Transition) != null ? i : I) != null ? a : Ha, qo = (c = (d = Z.tooltip) != null ? d : S.Tooltip) != null ? c : Sf, Ko = (p = (h = Z.arrow) != null ? h : S.Arrow) != null ? p : Of, _s = sn(Yo, R({}, G, (f = K.popper) != null ? f : _.popper, {
    className: bt(Er.popper, G == null ? void 0 : G.className, (b = (v = K.popper) != null ? v : _.popper) == null ? void 0 : b.className)
  }), Zt), $s = sn(Wo, R({}, xe, (w = K.transition) != null ? w : _.transition), Zt), Is = sn(qo, R({}, (m = K.tooltip) != null ? m : _.tooltip, {
    className: bt(Er.tooltip, (N = ($ = K.tooltip) != null ? $ : _.tooltip) == null ? void 0 : N.className)
  }), Zt), As = sn(Ko, R({}, (C = K.arrow) != null ? C : _.arrow, {
    className: bt(Er.arrow, (E = (g = K.arrow) != null ? g : _.arrow) == null ? void 0 : E.className)
  }), Zt);
    ...
    children: [/* @__PURE__ */ M.cloneElement(ye, De), /* @__PURE__ */ s(Yo, R({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(qo, R({}, Is, {
          children: [pe, B ? /* @__PURE__ */ s(Ko, R({}, As, {
            ref: Ct
          })) : null]
        }))
      }))
...
function ys(e) {
  const {
    ...
    xl,
    {
      ...
      onClick: t,
      id: w,
      children: n ? /* @__PURE__ */ x(tt, { children: [
        Ya(a, n, !0),
...
function Pf(e) {
  const [t, n] = de(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = e, i = (d) => {
    n(d.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
...
function Ns(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: a, allowForLeadingIcons: i } = Te(() => {
    const p = o && o.length > 0 ? o : (
      ...
      (v, w) => (v.group.order || 0) - (w.group.order || 0)
    ), f = [];
    h.forEach((v) => {
...
const eo = (e, t, n = {}) => {
  ...
  const [a, i] = de(() => r.current), [l, c] = de(!0);
  return it(() => {
    let d = !0;
    return c(!!e), (async () => {
      if (e) {
...
function jf({
  ...
  it(() => {
    if (c) {
      ...
      if (E) {
        const g = E.getBoundingClientRect(), P = window.scrollY, B = window.scrollX, H = g.top + P + E.clientHeight, S = g.left + B;
        m({ top: H, left: S });
      }
    }
  }, [c, o]);
...
), Vf = A.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: T(Bf({ variant: t }), e), ...n }));
...
function Gm({ className: e, variant: t, ...n }) {
  return /* @__PURE__ */ s("div", { className: T("pr-twp", Lf({ variant: t }), e), ...n });
}
...
qf.displayName = on.Root.displayName;
...
const Xm = Re.Root, Jf = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Re.List,
  {
    ref: n,
    className: T(
...
function Ym({
  ...
  return /* @__PURE__ */ s(
    me,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ s(_n, { size: 15 }) : /* @__PURE__ */ x(tt, { children: [
...
function Wm({
  ...
  return /* @__PURE__ */ s(
    me,
    {
      ...
      onClick: t,
      ...r,
      children: e ? /* @__PURE__ */ x(tt, { children: [
...
function nm({ id: e, versionHistory: t }) {
  const [n, r] = de(!1), o = /* @__PURE__ */ new Date();
  function a(l) {
    const c = new Date(l), d = new Date(o.getTime() - c.getTime()), p = d.getUTCFullYear() - 1970, h = d.getUTCMonth(), f = d.getUTCDate() - 1;
    let b = "";
    return p > 0 ? b = `${p.toString()} year${p === 1 ? "" : "s"} ago` : h > 0 ? b = `${h.toString()} month${h === 1 ? "" : "s"} ago` : f === 0 ? b = "today" : b = `${f.toString()} day${f === 1 ? "" : "s"} ago`, b;
  }
...
function nh({
  ...
  ), [d, p] = de(t), [h, f] = de(!1), b = (w) => {
    p(w), o && o(w), r && r([w, ...n.filter((m) => m !== w)]), a && n.find((m) => m === w) && a([...n.filter((m) => m !== w)]), f(!1);
  }, v = (w, m) => {
    var $, C, E, g, P, B;
    const N = m !== w ? ((C = ($ = e[w]) == null ? void 0 : $.uiNames) == null ? void 0 : C[m]) ?? ((g = (E = e[w]) == null ? void 0 : E.uiNames) == null ? void 0 : g.en) : void 0;
    return N ? `${(P = e[w]) == null ? void 0 : P.autonym} (${N})` : (B = e[w]) == null ? void 0 : B.autonym;
  };
  return /* @__PURE__ */ x("div", { className: T("pr-twp tw-max-w-sm tw-p-4", l), children: [
    /* @__PURE__ */ x(
      Bt,
      {
        name: "uiLanguage",
        ...
        children: [
          ...
          /* @__PURE__ */ s(
            ...
            {
              style: { zIndex: 250 },
              children: Object.keys(e).map((w) => /* @__PURE__ */ s(Me, { value: w, children: v(w, t) }, w))
            }
          )
        ]
      }
    ),
    d !== "en" && /* @__PURE__ */ x(tt, { children: [
      /* @__PURE__ */ s(Be, { className: "tw-ml-3", children: c }),
      /* @__PURE__ */ s("div", { children: /* @__PURE__ */ x(Be, { children: [
        "Currently:",
        " ",
        (n == null ? void 0 : n.length) > 0 ? `${n.map((w) => v(w, t)).join(", ")}` : `${e.en.autonym}`
      ] }) })
    ] })
  ] });
}
...
export {
  ...
  zf as AlertTitle,
  Cm as BOOK_SELECTOR_STRING_KEYS,
  Gm as Badge,
  Tm as BookChapterControl,
  ...
  Wm as EnableButton,
  em as FilterButton,
  Zm as FilterDropdown,
  th as Footer,
  Af as GridMenu,
  jf as HamburgerMenuButton,
  _m as INVENTORY_STRING_KEYS,
  Fm as IconButton,
  kn as Input,
  Ym as InstallButton,
  $m as Inventory,
  Be as Label,
  Jm as MarkdownRenderer,
  ys as MenuItem,
  eh as MoreInfo,
  Im as MultiSelectComboBox,
  Am as NavigationContentSearch,
  Qm as NoExtensionsFound,
  gi as RadioGroup,
  Gr as RadioGroupItem,
  Dm as ScriptureResultsViewer,
  Mm as ScrollGroupSelector,
  _c as SearchBar,
  Bt as Select,
  Nt as SelectContent,
  hc as SelectGroup,
  ...
  Om as inventoryItemColumn,
  Pm as inventoryStatusColumn,
  sh as sonner,
  rh as useEvent,
  oh as useEventAsync,
  eo as usePromise
