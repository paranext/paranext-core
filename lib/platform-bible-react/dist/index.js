...
var yt = (t, e, n) => Ss(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as ct } from "react/jsx-runtime";
import v, { forwardRef as fn, useRef as q, useMemo as z, useState as D, useCallback as B, useLayoutEffect as Lt, createContext as $n, useContext as Cr, useEffect as Y, Component as Ds, createElement as Wr, Suspense as Ms, Fragment as Do } from "react";
import { Command as St } from "cmdk";
import { X as qe, Search as Mo, Check as jt, Clock as Jr, ChevronsLeft as Zr, ChevronsRight as Qr, ChevronLeft as ar, ChevronRight as je, ArrowLeft as Os, ArrowRight as Is, Circle as Ln, ChevronDown as He, BoldIcon as As, ItalicIcon as Ps, AtSign as Oo, Pencil as $s, Trash2 as Ls, ArrowUp as Io, MoreHorizontal as Vs, MailOpen as js, Mail as Fs, ChevronUp as Ao, FilterIcon as zs, ArrowLeftIcon as Bs, ChevronLeftIcon as Ks, ChevronRightIcon as Us, ArrowRightIcon as Gs, Copy as Po, Filter as qs, User as Hs, Link as Ys, CircleHelp as Xs, ChevronsUpDown as $o, Star as Ws, Undo as Js, Redo as Zs, SquareX as Lo, FunctionSquare as Vo, SquareSigma as jo, Ban as Qs, AlertCircle as sr, CircleCheckIcon as ti, CircleXIcon as ei, CircleHelpIcon as ni, ArrowUpIcon as ri, ArrowDownIcon as oi, PanelLeft as ai, PanelRight as si, ScrollText as ii, MenuIcon as li, Menu as ci, EllipsisVertical as wi, MoreVertical as to, LoaderCircle as di, GripVertical as pi } from "lucide-react";
...
import { includes as bn, Section as W, getChaptersForBook as fi, formatScrRef as Ce, getSectionForBook as sn, formatRelativeDate as hi, formatReplacementString as _e, sanitizeHtml as gi, NumberFormat as bi, formatBytes as vi, getCurrentLocale as xi, usfmMarkers as kn, getFormatCallerFunction as yi, deepEqual as Ni, isString as eo, compareScrRefs as ir, scrRefToBBBCCCVVV as Gn, getLocalizeKeyForScrollGroupId as et } from "platform-bible-utils";
...
import { createEditor as zo, $getRoot as ae, $createParagraphNode as Xe, $getSelection as Tt, HISTORY_MERGE_TAG as Er, ParagraphNode as Bo, TextNode as Ko, $isTokenOrSegmented as ki, $getCharacterOffsets as _i, $cloneWithPropertiesEphemeral as Ci, $getPreviousSelection as Ei, $isRangeSelection as Yt, $caretFromPoint as Ri, $getSiblingCaret as Uo, $getChildCaret as Ti, $getAdjacentChildCaret as Si, $isChildCaret as Di, $normalizeCaret as Mi, $setSelectionFromCaretRange as Oi, $getCollapsedCaretRange as Ii, $getCaretInDirection as no, $splitAtPointCaretNext as Ai, $isTextPointCaret as Pi, $findMatchingParent as Go, $isElementNode as ne, mergeRegister as se, getDOMTextNode as $i, isHTMLElement as qo, CLEAR_EDITOR_COMMAND as Ho, COMMAND_PRIORITY_EDITOR as Rr, shallowMergeConfig as Li, defineExtension as Vt, safeCast as Oe, createState as Vi, FORMAT_TEXT_COMMAND as Yo, $isNodeSelection as Xo, COMMAND_PRIORITY_LOW as Wo, RootNode as ji, LineBreakNode as Fi, TabNode as zi, $isEditorState as Bi, createCommand as Ki, CLICK_COMMAND as Ui, isDOMNode as Gi, $getNodeFromDOMNode as qi, $createNodeSelection as Hi, $setSelection as Yi, $getEditor as Xi, DecoratorNode as lr, $getState as Wi, toggleTextFormatType as ro, TEXT_TYPE_TO_FORMAT as Ji, $setState as Zi, addClassNamesToElement as Jo, $create as Qi, $getNodeByKey as tl, removeClassNamesFromElement as el, KEY_TAB_COMMAND as nl, $isBlockElementNode as En, $createRangeSelection as rl, $normalizeSelection__EXPERIMENTAL as ol, OUTDENT_CONTENT_COMMAND as al, INDENT_CONTENT_COMMAND as oo, INSERT_TAB_COMMAND as sl, COMMAND_PRIORITY_CRITICAL as Tr, $isDecoratorNode as il, $isParagraphNode as ll, $isTextNode as Rn, SELECTION_CHANGE_COMMAND as Zo, getRegisteredNode as cl, isDocumentFragment as ao, isDOMDocumentNode as wl, ArtificialNode__DO_NOT_USE as Qo, $createLineBreakNode as ta, $isRootOrShadowRoot as dl, isBlockDomNode as so, isInlineDomNode as io, $insertNodes as pl } from "lexical";
...
import { useReactTable as oa, getFilteredRowModel as yl, getSortedRowModel as aa, getPaginationRowModel as Nl, getCoreRowModel as sa, flexRender as ln, getGroupedRowModel as kl, getExpandedRowModel as _l } from "@tanstack/react-table";
import * as wt from "@radix-ui/react-select";
import Cl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as cr, HIDDEN_NOTE_CALLER as wr, getDefaultViewOptions as El, isInsertEmbedOpOfType as vn, Editorial as Rl } from "@eten-tech-foundation/platform-editor";
...
const Dl = mi({ prefix: "tw-" });
function h(...t) {
  return Dl(ui(t));
}
const Je = 250, ia = 300, Ml = 400, Ol = 450, Il = 500, Al = "layoutDirection";
function ut() {
  const t = localStorage.getItem(Al);
  return t === "rtl" ? t : "ltr";
}
const Pl = Ot.Root, Qp = Ot.Trigger, $l = Ot.Portal, tu = Ot.Close, la = v.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  Ot.Overlay,
  {
    ref: o,
    className: h(
...
la.displayName = Ot.Overlay.displayName;
const ca = v.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, s) => {
  const i = ut();
  return /* @__PURE__ */ p($l, { children: [
    /* @__PURE__ */ r(la, { className: n }),
    /* @__PURE__ */ p(
      Ot.Content,
      {
        ref: s,
...
ca.displayName = Ot.Content.displayName;
...
const da = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Ot.Title,
  {
    ref: n,
...
da.displayName = Ot.Title.displayName;
...
Vl.displayName = Ot.Description.displayName;
...
ce.displayName = St.List.displayName;
const hn = v.forwardRef((t, e) => /* @__PURE__ */ r(St.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
hn.displayName = St.Empty.displayName;
...
Xt.displayName = St.Group.displayName;
...
Dr.displayName = St.Separator.displayName;
...
pa.displayName = "CommandShortcut";
const ua = (t, e, n, o, a) => {
  switch (t) {
    case W.OT:
...
const ma = pt.allBookIds.filter(
  (t) => !pt.isObsolete(pt.bookIdToNumber(t))
), Ee = Object.fromEntries(
  ma.map((t) => [t, pt.bookIdToEnglishName(t)])
);
function Or(t, e, n) {
...
const fa = fn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ye : "button", { className: h(ha({ variant: e, size: n, className: t })), ref: s, ...a })
);
F.displayName = "Button";
const we = Fe.Root, ve = Fe.Trigger, Fl = Fe.Anchor, Zt = v.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = ut();
...
function mr(t, e, n) {
  return `${t} ${Ee[t]}${e ? ` ${Mr(t, e)} ${Le(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function zl({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(we, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Zt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(le, { children: /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ r(Xt, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      Jt,
      {
        onSelect: () => f(u),
...
function eu(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
  ...
  const o = Bl.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!d && c) {
          const u = ((g) => Object.keys(Ee).find(
            (y) => Ee[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function nu({
  ...
  const w = ut(), [d, m] = D(!1), [f, u] = D(""), [g, y] = D(""), [b, C] = D("books"), [x, _] = D(void 0), [k, $] = D(!1), V = q(void 0), A = q(void 0), R = q(void 0), S = q(void 0), T = q({}), P = B(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
  ), I = z(() => o ? o() : ma, [o]), H = z(() => ({
    [W.OT]: I.filter((E) => pt.isBookOT(E)),
    [W.NT]: I.filter((E) => pt.isBookNT(E)),
    [W.DC]: I.filter((E) => pt.isBookDC(E)),
    [W.Extra]: I.filter((E) => pt.extraBooks().includes(E))
  }), [I]), L = z(() => Object.values(H).flat(), [H]), J = z(() => {
    if (!g.trim()) return H;
    const M = {
      [W.OT]: [],
      [W.NT]: [],
    ...
    return [W.OT, W.NT, W.DC, W.Extra].forEach((j) => {
      M[j] = H[j].filter((X) => Or(X, g, a));
    }), M;
  }, [H, g, a]), N = z(
    () => Kl(g, L, a),
    [g, L, a]
    ...
    (M) => {
      const E = b === "chapters" ? x : N == null ? void 0 : N.book;
      E && (P({
        book: E,
        chapterNum: M,
        verseNum: 1
    ...
    (M) => {
      ...
      m(M), M && (C("books"), _(void 0), y(""));
    },
    [b, Ct]
  ), { otLong: it, ntLong: Z, dcLong: ft, extraLong: xt } = {
    ...
    (M) => N ? !!N.chapterNum && !M.toString().includes(N.chapterNum.toString()) : !1,
    [N]
  ), Ie = z(
    () => Ce(
      t,
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: E, isDigit: j } = lo(M.key);
      if (b === "chapters") {
        if (M.key === "Backspace") {
        ...
        if (E || j) {
          if (M.preventDefault(), M.stopPropagation(), C("books"), _(void 0), j && x) {
            const X = Ee[x];
            y(`${X} ${M.key}`);
          } else
            y(M.key);
      ...
      if ((b === "chapters" || b === "books" && N) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        const X = b === "chapters" ? x : N == null ? void 0 : N.book;
        if (!X) return;
        const G = (() => {
          if (!f) return 1;
          const rt = f.match(/(\d+)$/);
        ...
        switch (M.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            tt = G === 0 ? lt : Math.max(1, G - bt);
            break;
          case "ArrowDown":
            tt = G === 0 ? 1 : Math.min(lt, G + bt);
            break;
          default:
            return;
        }
        tt !== G && (M.preventDefault(), M.stopPropagation(), u(mr(X, a, tt)), setTimeout(() => {
          const rt = T.current[tt];
    ...
    const { isLetter: E, isDigit: j } = lo(M.key);
    (E || j) && (M.preventDefault(), y((X) => X + M.key), A.current.focus(), $(!1));
  }, []);
  return Lt(() => {
    const M = setTimeout(() => {
      if (d && b === "books" && R.current && S.current) {
        const E = R.current, j = S.current, X = j.offsetTop, G = E.clientHeight, lt = j.clientHeight, tt = X - G / 2 + lt / 2;
        E.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), u(mr(t.book));
  ...
  }, [b, x, N, t.book, t.chapterNum]), /* @__PURE__ */ p(we, { open: d, onOpenChange: K, children: [
    /* @__PURE__ */ r(ve, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
      ...
      le,
      {
        ...
        children: [
          b === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ht.map(({ onClick: M, disabled: E, title: j, icon: X }) => /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              F,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(Os, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Is, { className: "tw-h-4 tw-w-4" })
              }
            ),
            x && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Le(x, a) })
          ] }),
          !k && /* @__PURE__ */ p(ce, { ref: R, children: [
            b === "books" && /* @__PURE__ */ p(ct, { children: [
              !N && Object.entries(J).map(([M, E]) => {
                if (E.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Xt, { heading: pe(M), children: E.map((j) => /* @__PURE__ */ r(
                      fa,
                      {
                        bookId: j,
                        onSelect: (X) => mt(X),
              ...
              N && /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r(
                Jt,
                {
                  value: `${N.book} ${Ee[N.book]} ${N.chapterNum || ""}:${N.verseNum || ""})}`,
                  onSelect: U,
              ...
              N && Ht(N.book) > 1 && /* @__PURE__ */ p(ct, { children: [
...
), gt = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Fo.Root, { ref: n, className: h("pr-twp", Gl(), t), ...e }));
gt.displayName = Fo.Root.displayName;
...
function fr({
  ...
  const [_, k] = D(!1), $ = w ?? c, V = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], A = (R, S) => {
    const T = c(R), P = typeof R == "object" && "secondaryLabel" in R ? R.secondaryLabel : void 0, I = `${S ?? ""}${T}${P ?? ""}`;
    return /* @__PURE__ */ p(
      Jt,
      {
        value: T,
  ...
  return /* @__PURE__ */ p(we, { open: _, onOpenChange: k, ...x, children: [
    ...
    /* @__PURE__ */ r(
      Zt,
      {
        ...
        children: /* @__PURE__ */ p(le, { children: [
          ...
          /* @__PURE__ */ r(ce, { children: V(e) ? e.map((R) => /* @__PURE__ */ r(Xt, { heading: R.groupHeading, children: R.options.map((S) => A(S, R.groupHeading)) }, R.groupHeading)) : e.map((R) => A(R)) })
        ] })
      }
    )
  ] });
...
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Xl = ba ? Lt : Y, xn = { tag: Er };
function Wl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = Yl(null, o), d = zo({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Xe();
            u.append(g);
            const y = ba ? document.activeElement : null;
            (Tt() !== null || y !== null && y === m.getRootElement()) && g.select();
          }
        }, xn);
  ...
  }, []), r(ga.Provider, { value: n, children: e });
}
const Jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
...
const Ar = {
  ...
  mark: "",
  markOverlap: ""
}, kt = Te.Provider, Et = Te.Root, Rt = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Te.Trigger,
  {
    ref: o,
    className: e ? h(ha({ variant: e }), t) : t,
    ...n
  }
));
Rt.displayName = Te.Trigger.displayName;
const _t = v.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(Te.Portal, { children: /* @__PURE__ */ r(
  Te.Content,
  {
    ref: a,
    sideOffset: e,
...
_t.displayName = Te.Content.displayName;
const Pr = [
  ml,
  Bo,
  Ko,
...
const rc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
function oc(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function ac() {
  return function(t) {
    const [e] = Qt(), n = z(() => t(e), [e, t]), [o, a] = D(() => n.initialValueFn()), s = q(o);
    return rc(() => {
...
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, lc = va && "documentMode" in document ? document.documentMode : null;
!(!va || !("InputEvent" in window) || lc) && "getTargetRanges" in new window.InputEvent("input");
function qt(t) {
  return `${t}px`;
}
...
function wc(t, e, n) {
  ...
  function c() {
    ...
    const { left: m, top: f } = a.getBoundingClientRect(), u = sc(t, e);
    var g, y;
    ...
    for (let C = 0; C < u.length; C++) {
      ...
      const R = qt(x.height);
      k.height !== R && (_.style.height = R, b = !0), _.parentNode !== l && (l.append(_), b = !0), i[C] = _;
    }
  ...
  function w(d) {
    d.read(() => {
      ...
      const [f, u] = function(R) {
        const S = R.getStartEndPoints();
        return R.isBackward() ? [S[1], S[0]] : S;
      }(m), g = f.getNode(), y = g.getKey(), b = f.offset, C = u.getNode(), x = C.getKey(), _ = u.offset, k = t.getElementByKey(y), $ = t.getElementByKey(x), V = n === null || k !== o || b !== a || y !== n.getKey(), A = s === null || $ !== i || _ !== l || x !== s.getKey();
      if ((V || A) && k !== null && $ !== null) {
        const R = function(S, T, P, I, H, L, J) {
          const N = (S._window ? S._window.document : document).createRange();
          return N.setStart(...wo(T, P, I)), N.setEnd(...wo(H, L, J)), N;
        }(t, f, g, k, u, C, $);
        c(), c = wc(t, R, e);
      }
...
function uc(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? n !== null && (n(), n = null) : n === null && (n = pc(t, e));
  };
...
function mc(t) {
  const e = Go(t, (n) => ne(n) && !n.isInline());
  return ne(e) || Sn(4, t.__key), e;
}
function fc(t) {
  const e = Tt() || Ei();
  let n;
  if (Yt(e)) n = Ri(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), l = i[i.length - 1];
      l && (n = Uo(l, "next"));
    }
    n = n || Ti(ae(), "previous").getFlipped().insert(Xe());
  }
  const o = hc(t, n), a = Si(o), s = Di(a) ? Mi(a) : o;
  return Oi(Ii(s)), t.getLatest();
}
function hc(t, e, n) {
  let o = no(e, "next");
  for (let a = o; a; a = Ai(a, n)) o = a;
  return Pi(o) && Sn(283), o.insert(t.isInline() ? Xe().append(t) : t), no(Uo(t.getLatest(), "next"), e.direction);
}
function gc(t) {
  const e = Tt();
  if (!Yt(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Go(s, (w) => ne(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
function jn() {
  ...
  for (!function() {
    ...
    for (cn = void 0, Mn++; n !== void 0; ) {
      const o = n.u;
      if (n.u = void 0, n.f &= -3, !(8 & n.f) && xa(n)) try {
        n.c();
      } catch (a) {
        e || (t = a, e = !0);
      }
...
let Dn, re = 0, Mn = 0, xc = 0, gr = 0, _n = 0;
function uo(t) {
  if (Q === void 0) return;
  let e = t.n;
...
function Ne(t, e) {
  Nt.call(this, void 0), this.x = t, this.s = void 0, this.g = _n - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function yc(t, e) {
  return new Ne(t, e);
}
...
function $r(t) {
  ...
  t.x = void 0, t.s = void 0, Na(t);
}
function Nc(t) {
  if (Q !== this) throw new Error("Out-of-order effect");
  ya(this), Q = t, this.f &= -2, 8 & this.f && $r(this), jn();
}
function $e(t, e) {
...
Nt.prototype.brand = bc, Nt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      re !== 0 && Mn === 0 && e.l !== gr && (e.l = gr, Dn = { S: e, v: e.v, i: e.i, o: Dn });
    })(this), this.v = t, this.i++, _n++, re++;
    try {
...
} }), Ne.prototype = new Nt(), Ne.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === _n)) return !0;
  if (this.g = _n, this.f |= 1, this.i > 0 && !xa(this)) return this.f &= -2, !0;
  const t = Q;
  try {
    mo(this), Q = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Na(this), mo(this), re++;
  const t = Q;
  return Q = this, Nc.bind(this, t);
...
Vt({ build: (t, e, n) => Qe(e), config: Oe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function ka() {
  const t = ae(), e = Tt(), n = Xe();
  t.clear(), t.append(n), e !== null && n.select(), Yt(e) && (e.format = 0);
}
function _a(t, e = ka) {
  return t.registerCommand(Ho, (n) => (t.update(e), !0), Rr);
}
Vt({ build: (t, e, n) => Qe(e), config: Oe({ $onClear: ka }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return Wt(() => _a(t, o.value));
} });
function kc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Xn = Vi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ca extends lr {
  $config() {
...
Vt({ name: "@lexical/extension/DecoratorText", nodes: () => [Ca], register: (t, e, n) => t.registerCommand(Yo, (o) => {
  const a = Tt();
  if (Xo(a) || Yt(a)) for (const s of a.getNodes()) _c(s) && s.toggleFormat(o);
  return !1;
}, Wo) });
function Ea(t, e) {
  let n;
...
const br = Vt({ build: (t) => Ea(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Lr = 0, vr = 1, Ta = 2, Wn = 3, yn = 4, Pe = 5, Jn = 6, rn = 7;
function Zn(t) {
  return t.id === Lr;
}
function Sa(t) {
...
function Cc(t) {
  return function(e) {
    return e.id === vr;
  }(t) || nt(305, String(t.id), String(vr)), Object.assign(t, { id: Ta });
}
...
const Sc = Vt({ config: Oe({ setOptions: fo, updateOptions: fo }), init: ({ $initialEditorState: t = Tc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (Bi(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ji, Ko, Fi, zi, Bo] }), ho = Symbol.for("@lexical/extension/LexicalBuilder");
function go() {
}
function Dc(t) {
  throw t;
...
class Ve {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(zo({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [ho]: this });
...
const Mc = /* @__PURE__ */ new Set(), bo = Vt({ build(t, e, n) {
  const o = n.getDependency(br).output, a = pn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Ea(() => {
  }, () => Wt(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let c, w = !1;
    o.value.read(() => {
      if (Tt()) for (const [d, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(d);
          continue;
        }
  ...
  return { watchNodeKey: function(i) {
    const l = yc(() => (s.value || Mc).has(i)), { watchedNodeKeys: c } = a.peek();
    let w = c.get(i);
    const d = w !== void 0;
    return w = w || /* @__PURE__ */ new Set(), w.add(l), d || (c.set(i, w), a.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [br], name: "@lexical/extension/NodeSelection" }), Oc = Ki("INSERT_HORIZONTAL_RULE_COMMAND");
class ze extends lr {
  static getType() {
...
Vt({ dependencies: [br, bo], name: "@lexical/extension/HorizontalRule", nodes: () => [ze], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(bo).output, a = pn({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return se(t.registerCommand(Oc, (i) => {
    const l = Tt();
    if (!Yt(l)) return !1;
    ...
    return !0;
  }, Rr), t.registerCommand(Ui, (i) => {
    if (Gi(i.target)) {
      const l = qi(i.target);
      if (Ac(l)) return function(c, w = !1) {
        const d = Tt(), m = c.isSelected(), f = c.getKey();
        let u;
        w && Xo(d) ? u = d : (u = Hi(), Yi(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Wo), t.registerMutationListener(ze, (i, l) => {
    vc(() => {
      let c = !1;
    ...
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) i.push(Wt(() => {
      const w = l.value;
      w && (c.value ? Jo(w, s) : el(w, s));
    }));
    return se(...i);
  }));
} });
Vt({ build: (t, e) => Qe({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Oe({ $getParentEditor: function() {
  const t = Xi();
...
Vt({ build: (t, e, n) => Qe(e), config: Oe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, n) => {
  const o = n.getOutput();
  return Wt(() => {
...
function Pc(t, e, n = Da) {
  return se(t.registerCommand(nl, (o) => {
    ...
    const s = function(i) {
      ...
      const l = i.anchor, c = i.focus, w = c.isBefore(l) ? c : l, d = w.getNode(), m = mc(d);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = rl();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = ol(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? al : oo : sl;
    return t.dispatchCommand(s, void 0);
  }, Rr), t.registerCommand(oo, () => {
    const o = typeof e == "number" ? e : e ? e.peek() : null, a = Tt();
    if (!Yt(a)) return !1;
...
Vt({ build: (t, e, n) => Qe(e), config: Oe({ $canIndent: Da, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return Wt(() => {
    if (!o.value) return Pc(t, a, s);
  });
} });
const $c = Vt({ name: "@lexical/react/ReactProvider" });
function Lc() {
...
Vt({ build: (t, e, n) => Qe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => Wt(() => n.getOutput().disabled.value ? void 0 : Oa(t)) });
function Fc(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const jr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
  ...
  return function(n, o) {
    ...
    return jr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], d = r(o, { onError: (f) => n._onError(f), children: r(Ms, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(bl(d, m, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function Kc({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    jr(() => se(hl(a), Oa(a)), [a]);
  }(o), p(ct, { children: [t, r(Uc, { content: e }), r(Bc, { editor: o, ErrorBoundary: n })] });
}
...
function Gc({ defaultSelection: t }) {
  const [e] = Qt();
  return Y(() => {
    e.focus(() => {
...
const qc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
function Hc({ onClear: t }) {
  const [e] = Qt();
  return qc(() => _a(e, t), [e, t]), null;
}
const Ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
function Yc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: y, role: b = "textbox", spellCheck: C = !0, style: x, tabIndex: _, "data-testid": k, ...$ }, V) {
  const [A, R] = D(t.isEditable()), S = B((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? t.setRootElement(P) : t.setRootElement(null);
  }, [t]), T = z(() => /* @__PURE__ */ function(...P) {
    return (I) => {
      for (const H of P) typeof H == "function" ? H(I) : H != null && (H.current = I);
    };
  }(V, S), [S, V]);
  return Ia(() => (R(t.isEditable()), t.registerEditableListener((P) => {
    R(P);
...
function Jc(t, e) {
  ...
  return p(ct, { children: [r(Xc, { editor: a, ...o, ref: e }), n != null && r(Zc, { editor: a, content: n })] });
}
function Zc({ content: t, editor: e }) {
  const n = function(i) {
    ...
    return Ia(() => {
      ...
      return w(), se(i.registerUpdateListener(() => {
        w();
...
function ew() {
  const [t, e] = D(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Pl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(ca, { children: [
      /* @__PURE__ */ r(wa, { children: /* @__PURE__ */ r(da, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = B(
    (s, i, l = !1) => {
...
function nw({
  ...
  const [e] = Qt(), [n, o] = D(e), [a, s] = D("paragraph"), [i, l] = ew(), c = () => {
  };
...
const $a = be(
  ...
  {
    ref: a,
    className: h($a({ variant: e, size: n, className: t })),
    ...o
  }
));
ow.displayName = ea.Root.displayName;
const La = v.createContext({
  size: "default",
  variant: "default"
...
function aw() {
  const { activeEditor: t } = Pa(), [e, n] = D([]), o = B((a) => {
    if (Yt(a) || vl(a)) {
      const s = [];
      yo.forEach(({ format: i }) => {
  ...
  return rw(o), /* @__PURE__ */ r(
    Fr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: yo.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        wn,
        {
          value: a,
          "aria-label": i,
...
function iw({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    ...
    /* @__PURE__ */ p("div", { className: "tw-relative", children: [
      ...
      e && /* @__PURE__ */ r(Gc, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ r(
          Wl,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(iw, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ r(
                Zl,
                {
...
function cw(t, e) {
  ...
  let o = [];
  const a = [];
  for (const s of n) if (!ja.has(s.nodeName)) {
    const i = Fa(s, t, a, !1);
    i !== null && (o = o.concat(i));
  }
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Qo && i.insertAfter(ta());
    for (const i of s) {
...
function Va(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = ne(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && Rn(e) && (i = ic(o, e, "clone"));
  const l = ne(i) ? i.getChildren() : [], c = cl(t, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = Va(t, g, f, o);
    !a && ne(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((qo(d) || ao(d)) && d.append(f), n.append(d), m) {
      const u = m.call(i, d);
      u && (ao(d) ? d.replaceChildren(u) : d.replaceWith(u));
    }
  } else n.append(f);
  return a;
}
const ja = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Fa(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (ja.has(t.nodeName)) return i;
  let l = null;
  ...
  let f = [];
  const u = (l == null || !dl(l)) && (l != null && En(l) || o);
  for (let g = 0; g < m.length; g++) f.push(...Fa(m[g], e, n, u, new Map(a), l));
  return d != null && (f = d(f)), so(t) && (f = dw(t, f, u ? () => {
    const g = new Qo();
    return n.push(g), g;
  } : Xe)), l == null ? f.length > 0 ? i = i.concat(f) : so(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : io(g.nextSibling) && io(g.previousSibling);
  }(t) && (i = i.concat(ta())) : ne(l) && l.append(...f), i;
}
function dw(t, e, n) {
...
function Ba(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : Ba(e.children)
  ) : !1;
}
function Pt(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? Ba(t.root.children) : !1;
}
function pw(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = cw(e, a);
      ae().clear(), pl(s);
    },
    {
      discrete: !0
...
function su({
  ...
  const [s, i] = D(uw), [l, c] = D(a), [w, d] = D(!1), m = q(void 0), f = q(null);
  Y(() => {
    let x = !0;
    const _ = f.current;
    if (!_) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
          /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(qe, {}) }) }),
          /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: b }) })
        ] }) }),
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
          ...
          /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: y }) })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(we, { open: w, onOpenChange: d, children: [
      /* @__PURE__ */ r(ve, { asChild: !0, children: /* @__PURE__ */ p(
        F,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(
        Zt,
        {
          ...
          children: /* @__PURE__ */ r(le, { children: /* @__PURE__ */ r(ce, { children: t.map((x) => /* @__PURE__ */ r(
            Jt,
            {
              onSelect: () => {
                c(x || void 0), d(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (x) => {
          x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), n()) : Br(x) && (x.preventDefault(), x.stopPropagation(), Pt(s) && u());
        },
        onKeyDown: (x) => {
...
const iu = Object.freeze([
  ...
  const a = q(null), [s, i] = D(void 0), [l, c] = D(void 0), w = B(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || mw.includes(g)) return !0;
    ...
    (u) => {
      var A;
      const g = u.target, y = (R) => R ? document.getElementById(R) : void 0, b = y(l), C = y(s);
      if (!!(b && g && b.contains(g) && g !== b) && m(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const R = t.find((S) => S.id === l);
            R && w(R.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const S = R.findIndex((P) => P === g);
          if (S === -1) return;
          let T;
          u.key === "ArrowDown" ? T = Math.min(S + 1, R.length - 1) : T = Math.max(S - 1, 0), T !== S && (u.preventDefault(), u.stopPropagation(), (A = R[T]) == null || A.focus());
          return;
        }
        return;
      }
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: h("pr-twp", gw({ variant: e }), t), ...n })
);
...
const xw = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
Ke.displayName = ra.Root.displayName;
...
Ga.displayName = We.Root.displayName;
const Nw = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  We.Image,
  {
    ref: n,
...
Nw.displayName = We.Image.displayName;
...
qa.displayName = We.Fallback.displayName;
const Kr = $n(void 0);
function zt() {
  const t = Cr(Kr);
  if (!t)
...
}), Se = ot.Trigger, Ha = ot.Group, kw = ot.Portal, _w = ot.Sub, Cw = ot.RadioGroup;
...
const Ya = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = zt();
  return /* @__PURE__ */ p(
    ot.SubTrigger,
    {
...
Ya.displayName = ot.SubTrigger.displayName;
...
Xa.displayName = ot.SubContent.displayName;
const ie = v.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = ut();
...
ie.displayName = ot.Content.displayName;
...
const oe = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = ut(), i = zt();
  return /* @__PURE__ */ p(
    ot.CheckboxItem,
    {
      ...
      dir: s,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(jt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
oe.displayName = ot.CheckboxItem.displayName;
const Wa = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ut(), s = zt();
  return /* @__PURE__ */ p(
    ot.RadioItem,
    {
...
Wa.displayName = ot.RadioItem.displayName;
...
function No({
  ...
  const u = B(
    ...
    [t.user]
  ), x = z(() => gi(t.contents), [t.contents]), _ = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(ct, { children: [
        /* @__PURE__ */ p(
          An,
          {
            onClick: (k) => {
              k.stopPropagation(), w(!0), m(pw(t.contents)), i == null || i(!0);
            },
            children: [
              /* @__PURE__ */ r($s, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ga, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(qa, { className: "tw-text-xs tw-font-medium", children: C }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), u()) : Br(k) && (k.preventDefault(), k.stopPropagation(), Pt(d) && g());
              },
              onKeyDown: (k) => {
        ...
        _ && /* @__PURE__ */ p(ge, { children: [
          /* @__PURE__ */ r(Se, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Vs, {}) }) }),
...
function Rw({
  ...
  const [R, S] = D(ko), [T, P] = D(), [I, H] = D(), L = o, [J, N] = D(!1), [U, mt] = D(!1), [vt, Mt] = D(!1), [ht, Ct] = D(!1), [K, it] = D(!1), [Z, ft] = D(k), [xt, pe] = D(!1), ue = q(void 0), [Ie, me] = D(/* @__PURE__ */ new Map());
  Y(() => {
    let O = !0;
    return (async () => {
      const At = x ? await x(c) : !1;
      O && it(At);
    })(), () => {
      O = !1;
    };
    ...
    let O = !0;
    if (!o) {
      Ct(!1), me(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const At = C ? await C(c) : !1;
      O && Ct(At);
    })(), () => {
      O = !1;
    };
  }, [o, c, C]);
  const Ae = q(o), Bt = q(!1), fe = q(!1);
  Y(() => {
    const O = Ae.current && !o;
    if (Ae.current = o, !o) {
      O && (P(void 0), H(void 0)), Bt.current = !1, fe.current = !1;
      return;
    }
    ht ? !Bt.current && !fe.current && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    A !== s && (P(A), Bt.current = !0) : Bt.current && (P(void 0), Bt.current = !1, fe.current = !1);
  }, [o, A, ht, s]);
  const M = z(() => e.filter((O) => !O.deleted), [e]);
  Y(() => {
    let O = !0;
    if (!o || !_) {
      me(/* @__PURE__ */ new Map());
  ...
  const E = z(() => M[0], [M]), j = q(null), X = q(void 0), G = B(() => {
    var O;
    (O = X.current) == null || O.call(X), S(ko);
  }, []), lt = B(() => {
    const O = !Z;
    ft(O), pe(!O), g == null || g(c, O);
  }, [Z, g, c]);
  Y(() => {
    N(!1);
  }, [o]), Y(() => {
    if (o && !Z && !xt) {
      ...
      return ue.current = O, () => clearTimeout(O);
    }
  ...
  }, [s, n]), rt = z(() => M.slice(1), [M]), dt = z(() => rt.length ?? 0, [rt.length]), It = z(() => dt > 0, [dt]), te = z(() => J || dt <= 2 ? rt : rt.slice(-2), [rt, dt, J]), Kt = z(() => J || dt <= 2 ? 0 : dt - 2, [dt, J]), xe = z(
    () => dt === 1 ? tt.singleReply : _e(tt.multipleReplies, { count: dt }),
    [dt, tt]
  ), Es = z(
    () => Kt === 1 ? tt.singleReply : _e(tt.multipleReplies, { count: Kt }),
    [Kt, tt]
  );
  Y(() => {
    !o && U && It && mt(!1);
  ...
  const Yr = B(
    async (O) => {
      ...
      Ut && await m({ threadId: c, contents: Ut }) && G();
    },
    [
      G,
      R,
    ...
    async (O) => {
      const Ut = Pt(R) ? In(R) : void 0, At = O.status ? O.assignedUser : T ?? O.assignedUser, nn = await m({
        ...O,
        contents: Ut,
        assignedUser: At
      });
      return nn && (At !== void 0 && H(At), Ut && G()), nn;
    },
    [G, R, m, T]
  );
  if (M.length !== 0)
    return /* @__PURE__ */ r(
      Ka,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ p(Ua, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              bt && /* @__PURE__ */ r(Be, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: bt }),
              /* @__PURE__ */ r(
                F,
                {
                  variant: "ghost",
                  ...
                  children: Z ? /* @__PURE__ */ r(js, {}) : /* @__PURE__ */ r(Fs, {})
                }
              ),
              ...
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ p("span", { className: t, children: [
                    E.contextBefore,
                    /* @__PURE__ */ r("span", { className: "tw-font-bold", children: E.selectedText }),
                    E.contextAfter
                  ] })
                ]
              }
            ...
            /* @__PURE__ */ r(
              No,
              {
                ...
                isThreadExpanded: o,
                threadStatus: d,
                handleAddCommentToThread: Xr,
                handleUpdateComment: f,
                handleDeleteComment: u,
                onEditingChange: mt,
                canEditOrDelete: (!U && Ie.get(E.id)) ?? !1,
          ...
          /* @__PURE__ */ p(ct, { children: [
            It && !o && /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
              ...
              /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: xe })
            ] }),
            !o && Pt(R) && /* @__PURE__ */ r(
              On,
              {
                editorSerializedState: R,
                onSerializedChange: (O) => S(O),
            ...
            o && /* @__PURE__ */ p(ct, { children: [
              Kt > 0 && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (O) => {
                    (O.key === "Enter" || O.key === " ") && (O.preventDefault(), O.stopPropagation(), N(!0));
                  },
                  children: [
                    /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Ke, {}) }),
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                      /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: Es }),
                      J ? /* @__PURE__ */ r(Ao, {}) : /* @__PURE__ */ r(He, {})
                    ] })
                  ]
                }
              ),
              te.map((O) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
                No,
                {
                  ...
                  handleDeleteComment: u,
                  onEditingChange: mt,
                  canEditOrDelete: (!U && Ie.get(O.id)) ?? !1
                }
              ) }, O.id)),
              b !== !1 && (!U || Pt(R)) && /* @__PURE__ */ p(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (O) => {
                    Br(O) && (O.preventDefault(), O.stopPropagation(), (Pt(R) || T !== void 0 && T !== I) && Yr());
                  },
                  onKeyDown: (O) => {
                    zr(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ r(
                      On,
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      T !== void 0 && (Pt(R) || T !== I) && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: _e(
                      ...
                      /* @__PURE__ */ p(we, { open: vt, onOpenChange: Mt, children: [
                        /* @__PURE__ */ r(ve, { asChild: !0, children: /* @__PURE__ */ r(
                          F,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ r(
                          Zt,
                          {
                            ...
                            align: "end",
                            onKeyDown: (O) => {
                              O.key === "Escape" && (O.stopPropagation(), Mt(!1));
                            },
                            children: /* @__PURE__ */ r(le, { children: /* @__PURE__ */ r(ce, { children: y == null ? void 0 : y.map((O) => /* @__PURE__ */ r(
                              Jt,
                              {
                                onSelect: () => {
                                  P(O !== s ? O : void 0), Bt.current = !1, fe.current = !0, H(void 0), Mt(!1);
                                },
                                className: "tw-flex tw-items-center",
                                children: /* @__PURE__ */ r("span", { children: Cn(O, n) })
                              },
                              O || "unassigned"
                            )) }) })
                          }
...
function cu({
  ...
  const [C, x] = D(/* @__PURE__ */ new Set()), [_, k] = D(), [$, V] = D(), A = B(
    async (N) => {
      const U = await s(N);
  ...
  const R = n.filter(
    ...
    [C, y]
  ), { listboxRef: I, activeId: H, handleKeyDown: L } = hw({
    options: S,
    onOptionSelect: T
  }), J = B(
    (N) => {
      ...
      }), k(void 0), y == null || y(void 0)), N.preventDefault(), N.stopPropagation()) : L(N);
    },
    [_, C, L, y]
  );
  return /* @__PURE__ */ r(
...
function Tw({ table: t }) {
  return /* @__PURE__ */ p(ge, { children: [
    /* @__PURE__ */ r(xl, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(zs, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Ue = wt.Root, Sw = wt.Group, Ge = wt.Value, Dw = be(
  ...
  return /* @__PURE__ */ p(
    wt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(wt.Icon, { asChild: !0, children: /* @__PURE__ */ r(He, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
De.displayName = wt.Trigger.displayName;
...
Me.displayName = wt.Content.displayName;
const Mw = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Label,
  {
    ref: n,
...
Mw.displayName = wt.Label.displayName;
const $t = v.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  wt.Item,
  {
    ref: o,
    className: h(
...
$t.displayName = wt.Item.displayName;
...
Ow.displayName = wt.Separator.displayName;
function Iw({ table: t }) {
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ p(
        Ue,
        {
          ...
          children: [
            /* @__PURE__ */ r(De, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ge, { placeholder: t.getState().pagination.pageSize }) }),
...
const ee = v.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const l = v.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), Vw(u, g, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), Lw(l, y, d.key);
...
function Fw({
  ...
  var V;
  const [d, m] = D([]), [f, u] = D([]), [g, y] = D({}), [b, C] = D({}), x = z(() => e ?? [], [e]), _ = oa({
    data: x,
    columns: t,
    getCoreRowModel: sa(),
  ...
  let $;
  return c ? $ = Array.from({ length: 10 }).map((S, T) => `skeleton-row-${T}`).map((S) => /* @__PURE__ */ r(ee, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Re, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(xr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, S)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? $ = _.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    ee,
    {
      onClick: () => i(A, _),
    ...
    A.id
  )) : $ = /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(Re, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Tw, { table: _ }),
    /* @__PURE__ */ p(Fn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(zn, { stickyHeader: s, children: _.getHeaderGroups().map((A) => /* @__PURE__ */ r(ee, { children: A.headers.map((R) => /* @__PURE__ */ r(mn, { className: "tw-p-0", children: R.isPlaceholder ? void 0 : ln(R.column.columnDef.header, R.getContext()) }, R.id)) }, A.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Po, {}) })
        ] }),
...
function pu({
  ...
  return /* @__PURE__ */ p(we, { onOpenChange: (d) => {
    d || l(!1);
  }, children: [
...
function uu({ id: t, label: e, groups: n }) {
  const [o, a] = D(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ge, { children: [
    /* @__PURE__ */ r(Se, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "default", children: [
      /* @__PURE__ */ r(qs, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(He, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ie, { children: n.map((w, d) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(gn, { children: w.label }),
      /* @__PURE__ */ r(Ha, { children: w.itemType === 0 ? /* @__PURE__ */ r(ct, { children: w.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        oe,
        {
          checked: o[d][f],
        ...
        Cw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Wa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(tn, {})
    ] }, w.label)) })
...
function fu({
  ...
  const i = z(() => vi(n), [n]), c = ((w) => {
    const d = new Intl.DisplayNames(xi(), { type: "language" });
...
function Gw({
  ...
  const [C, x] = D(!1), _ = B(
    (T) => {
      var I;
      const P = (I = t.find((H) => H.label === T)) == null ? void 0 : I.value;
      P && n(
    ...
    if (!f) return t;
    const T = t.filter((I) => I.starred).sort((I, H) => I.label.localeCompare(H.label)), P = t.filter((I) => !I.starred).sort((I, H) => {
      const L = e.includes(I.value), J = e.includes(H.value);
      return L && !J ? -1 : !L && J ? 1 : I.label.localeCompare(H.label);
    });
    return [...T, ...P];
  }, [t, e, f]), V = () => {
    n(t.map((T) => T.value));
  ...
  return /* @__PURE__ */ r("div", { id: b, className: g, children: /* @__PURE__ */ p(we, { open: R, onOpenChange: d ?? x, children: [
    /* @__PURE__ */ r(ve, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: y,
        ...
        children: [
          ...
          /* @__PURE__ */ r($o, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Zt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(le, { children: [
        ...
        /* @__PURE__ */ r(Xt, { children: $.map((T) => /* @__PURE__ */ p(
          Jt,
          {
            ...
            children: [
              ...
              T.starred && /* @__PURE__ */ r(Ws, { className: "tw-h-4 tw-w-4" }),
...
function Hw({
  ...
  return /* @__PURE__ */ p(ct, { children: [
    ...
    e && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
      /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(
        F,
        {
          "aria-label": "Redo",
...
function Yw({ children: t, editorRef: e }) {
  const n = q(null);
  return Y(() => {
    var i;
...
const Xw = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(ct, { children: [
...
function Ww({
  ...
  const s = q(null), i = q(null), l = q(!1), [c, w] = D(t), [d, m] = D(n), [f, u] = D(!1);
  Y(() => {
    w(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  return /* @__PURE__ */ p(ge, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
      /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(Se, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Xw(t, a, n) }) }) }),
...
const Jw = (t, e) => t === "f" ? /* @__PURE__ */ p(ct, { children: [
  /* @__PURE__ */ r(Vo, {}),
  " ",
...
function Qw({
  ...
  return /* @__PURE__ */ p(ge, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
      /* @__PURE__ */ r(ul, { asChild: !0, children: /* @__PURE__ */ r(Se, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Jw(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: Zw(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(ie, { style: { zIndex: ia }, children: [
  ...
  return /* @__PURE__ */ p(
    Jt,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ r(pa, { className: "tw-font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function nd({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = D(""), [s, i] = z(() => {
...
function gu({
  ...
  const [g, y] = D("generated"), [b, C] = D("*"), [x, _] = D("f"), [k, $] = D(!1), [V, A] = D(!0), [R, S] = D(!1), T = q(!1), P = q(""), [I, H] = D(!1), [L, J] = D(), [N, U] = D(), [mt, vt] = D(), [Mt, ht] = D(), Ct = q(null), K = z(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...i.view ?? El(), noteMode: "expanded" }
    }),
    [i, l]
  ), it = z(
    () => rd(
  ...
  Y(() => {
    ...
    if (j && vn("note", j)) {
      const lt = (X = j.insert.note) == null ? void 0 : X.caller;
      let tt = "custom";
      lt === cr ? tt = "generated" : lt === wr ? tt = "hidden" : lt && C(lt), y(tt), _(((G = j.insert.note) == null ? void 0 : G.style) ?? "f"), E = setTimeout(() => {
        var bt;
        (bt = d.current) == null || bt.applyUpdate([j]);
      }, 0);
    }
    return () => {
      E && clearTimeout(E);
  ...
  const Z = B(
    (E, j, X = !1) => {
      var lt, tt, bt;
      const G = (tt = (lt = d.current) == null ? void 0 : lt.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (G && vn("note", G)) {
        if (G.insert.note) {
          let rt;
          E === "custom" ? rt = j : E === "generated" ? rt = cr : rt = wr, G.insert.note.caller = rt;
        }
        n == null || n([G]), X && w && s && ((bt = w.current) == null || bt.replaceEmbedUpdate(s, [G]));
      }
    },
    [s, n, w]
  ), ft = B(() => {
  ...
  const pe = q({ book: a.book, chapterNum: a.chapterNum });
  Lt(() => {
    (pe.current.book !== a.book || pe.current.chapterNum !== a.chapterNum) && (pe.current = { book: a.book, chapterNum: a.chapterNum }, xt.current());
  }, [a.book, a.chapterNum]);
  const ue = () => {
    var j;
    const E = (j = m.current) == null ? void 0 : j.getElementsByClassName("editor-input")[0];
    ...
    var X, G, lt, tt, bt;
    _(E);
    const j = (G = (X = d.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : G.at(0);
    if (j && vn("note", j)) {
      j.insert.note && (j.insert.note.style = E);
      const rt = (tt = (lt = j.insert.note) == null ? void 0 : lt.contents) == null ? void 0 : tt.ops;
      x !== "x" && E === "x" ? rt == null || rt.forEach((dt) => od(dt)) : x === "x" && E !== "x" && (rt == null || rt.forEach((dt) => ad(dt))), (bt = d.current) == null || bt.applyUpdate([j, { delete: 1 }]);
    }
  }, Bt = (E) => {
    ht(E.contextMarker), S(E.canRedo);
  }, fe = B(
    (E) => {
      var X, G, lt, tt, bt;
      const j = (G = (X = d.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : G.at(0);
      if (j && vn("note", j)) {
        ...
        const rt = (lt = j.insert.note) == null ? void 0 : lt.style, dt = (bt = (tt = j.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (rt || $(!1), $(
          rt === "x" ? !!(dt != null && dt.every((It) => {
            var Kt, xe;
            if (!((Kt = It.attributes) != null && Kt.char)) return !0;
            const te = ((xe = It.attributes) == null ? void 0 : xe.char).style;
            return te === "xt" || te === "xo" || te === "xq";
          })) : !!(dt != null && dt.every((It) => {
            var Kt, xe;
            if (!((Kt = It.attributes) != null && Kt.char)) return !0;
            const te = ((xe = It.attributes) == null ? void 0 : xe.char).style;
            return te === "ft" || te === "fr" || te === "fq";
          }))
        ), !T.current) {
          T.current = !0, P.current = JSON.stringify(j), A(!0);
          return;
        }
        A(JSON.stringify(j) === P.current), Z(g, b);
      } else
        $(!1), A(!0);
    },
    [g, b, Z]
    ...
    if (f.current && it.length && E && E.rangeCount > 0) {
      const j = E.getRangeAt(0).getBoundingClientRect(), X = f.current.getBoundingClientRect();
      J(j.left - X.left), U(j.top - X.top), vt(j.height), H(!0);
    }
  }, [it, f]);
  return Y(() => {
    const E = () => {
    ...
    var E;
    I && ((E = Ct.current) == null || E.focus());
  }, [I]), Y(() => {
    var X;
    const E = ((X = m.current) == null ? void 0 : X.querySelector(".editor-input")) ?? void 0, j = (G) => {
      !I && E && document.activeElement === E && G.key === l ? (G.preventDefault(), M()) : I && G.key === "Escape" && (G.preventDefault(), H(!1));
    };
    return document.addEventListener("keydown", j), () => {
      document.removeEventListener("keydown", j);
    };
  }, [I, M, l]), /* @__PURE__ */ p(ct, { children: [
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
            /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(qe, {}) }) }),
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(Yw, { editorRef: d, children: /* @__PURE__ */ r(
              Rl,
              {
                options: K,
                onStateChange: Bt,
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
              /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(
                F,
                {
                  onClick: ue,
  ...
  return /* @__PURE__ */ p(ct, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: id(t.marker, l, o, w) })
      }
    )
  ] });
}
...
function dd({
  ...
  return /* @__PURE__ */ p(Fn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(zn, { stickyHeader: !0, children: /* @__PURE__ */ p(ee, { children: [
    ...
    /* @__PURE__ */ r(Bn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      ee,
      {
        ...
        children: [
          /* @__PURE__ */ r(Re, { children: Ce(l.reference, "English") }),
          /* @__PURE__ */ r(Re, { className: o, children: wd(l.text) })
        ]
      },
...
const pd = (t) => {
  ...
  if (t === "desc")
    return /* @__PURE__ */ r(oi, { className: "tw-h-4 tw-w-4" });
}, Kn = (t, e, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
  /* @__PURE__ */ p(
    Rt,
    {
  ...
  return e ? e[1] : "";
}, md = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Eu = Object.freeze([
...
function Ru({
  ...
  const u = Gt(n, "%webView_inventory_all%"), g = Gt(n, "%webView_inventory_approved%"), y = Gt(n, "%webView_inventory_unapproved%"), b = Gt(n, "%webView_inventory_unknown%"), C = Gt(n, "%webView_inventory_scope_currentBook%"), x = Gt(n, "%webView_inventory_scope_chapter%"), _ = Gt(n, "%webView_inventory_scope_verse%"), k = Gt(n, "%webView_inventory_filter_text%"), $ = Gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = Gt(n, "%webView_inventory_no_results%"), [A, R] = D(!1), [S, T] = D("all"), [P, I] = D(""), [H, L] = D([]), J = z(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : hd(K, a, s);
  }, [t, a, s]), N = z(() => {
    if (A) return J;
    const K = [];
    return J.forEach((it) => {
      const Z = it.items[0], ft = K.find(
        (xt) => xt.items[0] === Z
      );
      ft ? (ft.count += it.count, ft.occurrences = ft.occurrences.concat(it.occurrences)) : K.push({
        items: [Z],
        count: it.count,
  ...
  }, [A, J]), U = z(() => N.length === 0 ? [] : fd(N, S, P), [N, S, P]), mt = z(() => {
    var Z, ft;
    if (!A) return c;
    const K = (Z = o == null ? void 0 : o.tableHeaders) == null ? void 0 : Z.length;
    if (!K) return c;
    const it = [];
    for (let xt = 0; xt < K; xt++)
      it.push(
        ud(
          ((ft = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ft[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [...it, ...c];
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        Ue,
        {
          ...
          defaultValue: S,
          children: [
            /* @__PURE__ */ r(De, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ge, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ p(Me, { children: [
              ...
              /* @__PURE__ */ r($t, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(Ue, { onValueChange: (K) => Mt(K), defaultValue: i, children: [
        /* @__PURE__ */ r(De, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ge, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Me, { children: [
          /* @__PURE__ */ r($t, { value: "book", children: C }),
          /* @__PURE__ */ r($t, { value: "chapter", children: x }),
      ...
      o && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Et, { children: [
        /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-w-fit tw-min-w-[26px] tw-items-center tw-rounded-md tw-border", children: [
          /* @__PURE__ */ r(
            Gr,
            {
        ...
        /* @__PURE__ */ r(_t, { children: (o == null ? void 0 : o.checkboxText) ?? $ })
      ] }) })
    ] }),
...
const gd = "16rem", bd = "3rem", ts = v.createContext(void 0);
function Un() {
  const t = v.useContext(ts);
  if (!t)
...
const es = v.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(ts.Provider, { value: x, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const ns = v.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Un();
...
const vd = v.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Un();
  return /* @__PURE__ */ p(
    F,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(ai, {}) : /* @__PURE__ */ r(si, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
vd.displayName = "SidebarTrigger";
...
kd.displayName = "SidebarFooter";
const _d = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Ke,
  {
    ref: n,
...
_d.displayName = "SidebarSeparator";
...
const Cd = v.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ye : "button",
  {
    ref: o,
...
Cd.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const c = t ? Ye : "button", { state: w } = Un(), d = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: h(Ed({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Rt, { asChild: !0, children: d }),
...
const Sd = v.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Od = v.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ye : "a",
  {
    ref: s,
...
function Id({
  ...
  return /* @__PURE__ */ r(
    ns,
    {
      ...
      children: /* @__PURE__ */ p(os, { children: [
        /* @__PURE__ */ p(yr, { children: [
          /* @__PURE__ */ r(Nr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(kr, { children: /* @__PURE__ */ r(as, { children: Object.entries(e).map(([f, u]) => /* @__PURE__ */ r(ss, { children: /* @__PURE__ */ r(
            is,
            {
              onClick: () => w(f),
              isActive: m(f),
...
const he = "scrBook", Ad = "scrRef", ke = "source", Pd = "details", $d = "Scripture Reference", Ld = "Scripture Book", ls = "Type", Vd = "Details";
function jd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? pt.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === he ? Ce(a.start) : void 0;
      },
...
}, To = (t) => `${Fd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Su({
  sources: t,
  ...
  const [w, d] = D([]), [m, f] = D([{ id: he, desc: !1 }]), [u, g] = D({}), y = z(
  ...
  Y(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const P = y.find((I) => To(I) === T[0]) || void 0;
        P && l(P);
      }
    }
  }, [u, y, l, C]);
  const x = a ?? Ld, _ = s ?? ls, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [he] },
  ...
  }, A = (S, T) => S.getIsGrouped() ? "" : h("banded-row", T % 2 === 0 ? "even" : "odd"), R = (S, T, P) => {
  ...
  return /* @__PURE__ */ p("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ p(
      Ue,
      {
        ...
        children: [
          /* @__PURE__ */ r(De, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ge, {}) }),
          /* @__PURE__ */ r(Me, { position: "item-aligned", children: /* @__PURE__ */ r(Sw, { children: k.map((S) => /* @__PURE__ */ r($t, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Fn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(zn, { children: C.getHeaderGroups().map((S) => /* @__PURE__ */ r(ee, { children: S.headers.filter((T) => T.column.columnDef.header).map((T) => (
        ...
        return /* @__PURE__ */ r(
          ee,
          {
            ...
            children: S.getVisibleCells().map((I) => {
              if (!(I.getIsPlaceholder() || I.column.columnDef.enableGrouping && !I.getIsGrouped() && (I.column.columnDef.id !== ke || !n)))
                return /* @__PURE__ */ r(
                  Re,
                  {
                    className: h(
...
function Bd({
  ...
  const V = z(() => pt.allBookIds.filter(
    ...
    (L, J = !1) => {
      ...
      const N = V.findIndex((ht) => ht === k.current), U = V.findIndex((ht) => ht === L);
      if (N === -1 || U === -1) return;
      const [mt, vt] = [
        Math.min(N, U),
        Math.max(N, U)
      ], Mt = V.slice(mt, vt + 1).map((ht) => ht);
      n(
        e.includes(L) ? e.filter((ht) => !Mt.includes(ht)) : [.../* @__PURE__ */ new Set([...e, ...Mt])]
      );
    },
    [e, n, V]
  ), S = (L) => {
    R(L, $.current), $.current = !1;
  }, T = (L, J) => {
    L.preventDefault(), R(J, L.shiftKey);
  }, P = B(
    (L) => {
      const J = Hr(V, L).map((N) => N);
      n(
        cs(V, L, e) ? e.filter((N) => !J.includes(N)) : [.../* @__PURE__ */ new Set([...e, ...J])]
      );
    },
    [e, n, V]
  ), I = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(W).map((L) => /* @__PURE__ */ r(
      zd,
      {
        section: L,
        availableBookIds: V,
            ...
            le,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: H, children: w })
                ] }),
                /* @__PURE__ */ p(ce, { children: [
                  /* @__PURE__ */ r(hn, { children: d }),
                  Object.values(W).map((L, J) => {
                    const N = A[L];
                    if (N.length !== 0)
                      return /* @__PURE__ */ p(Do, { children: [
                        ...
                        J < Object.values(W).length - 1 && /* @__PURE__ */ r(Dr, {})
                      ] }, L);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === nr ? nr : So
      ).map((L) => /* @__PURE__ */ r(Be, { className: "hover:tw-bg-secondary", variant: "secondary", children: Le(L, a) }, L)),
      e.length > nr && /* @__PURE__ */ r(
        Be,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - So} ${m}`
        }
      )
    ] })
  ] });
...
function Mu({
  ...
  const w = ye(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), f = ye(i, "%webView_scope_selector_current_book%"), u = ye(i, "%webView_scope_selector_choose_books%"), g = ye(i, "%webView_scope_selector_scope%"), y = ye(i, "%webView_scope_selector_select_books%"), b = [
...
function Ou({
  ...
  return /* @__PURE__ */ p(
    Ue,
    {
      ...
      children: [
        /* @__PURE__ */ r(De, { size: a, className: h("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Ge,
          {
        ...
        /* @__PURE__ */ r(
          Me,
          {
            ...
            style: { zIndex: Je },
            children: t.map((w) => /* @__PURE__ */ r($t, { value: `${w}`, children: l[et(w)] }, `${w}`))
          }
        )
      ]
    }
...
const ds = (t, e, n, o) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ p(Et, { children: [
  /* @__PURE__ */ r(Rt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    An,
    {
      onClick: () => {
        o(l);
  ...
  ) : /* @__PURE__ */ p(_w, { children: [
    /* @__PURE__ */ r(Ya, { children: l.label }),
    /* @__PURE__ */ r(kw, { children: /* @__PURE__ */ r(Xa, { children: ds(
      t,
      e,
      ws(t, l.id),
      o
...
function _r({
  ...
  return /* @__PURE__ */ p(ge, { variant: s, children: [
    /* @__PURE__ */ r(Se, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(li, {}) }) }),
    /* @__PURE__ */ r(ie, { align: "start", style: { zIndex: Je }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(Do, { children: [
      /* @__PURE__ */ r(Ha, { children: /* @__PURE__ */ r(kt, { children: ds(e.groups, e.items, c, t) }) }),
      w < d.length - 1 && /* @__PURE__ */ r(tn, {})
    ] }, c)) })
  ] });
}
const ps = v.forwardRef(
...
function $u({
  ...
  return /* @__PURE__ */ p(ps, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      _r,
      {
        onSelectMenuItem: t,
...
const us = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ r(
    Dt.Root,
    {
...
us.displayName = Dt.List.displayName;
...
ms.displayName = Dt.List.displayName;
const Kd = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Dt.Trigger,
  {
    ref: n,
    ...e,
...
)), fs = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Dt.Content,
  {
    ref: n,
    className: h(
...
fs.displayName = Dt.Content.displayName;
function Vu({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(us, { children: [
      /* @__PURE__ */ r(ms, { children: t.map((l) => /* @__PURE__ */ r(Kd, { value: l.value, children: l.value }, l.key)) }),
...
const hs = v.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = v.useMemo(
    () => ({
      variant: e
    }),
...
hs.displayName = at.Root.displayName;
const gs = v.forwardRef(({ className: t, ...e }, n) => {
  const o = zt();
  return /* @__PURE__ */ r(
    at.Trigger,
    {
      ...
      className: h(
        ...
        // CUSTOM
        "pr-twp",
        de({ variant: o.variant, className: t })
        // CUSTOM use context to add variants
      ),
      ...e
    }
...
gs.displayName = at.Trigger.displayName;
const bs = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = zt();
  return /* @__PURE__ */ p(
    at.SubTrigger,
    {
      ...
      className: h(
        ...
        e && "tw-pl-8",
        de({ variant: s.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...o,
...
bs.displayName = at.SubTrigger.displayName;
const vs = v.forwardRef(({ className: t, ...e }, n) => {
  const o = zt();
  return /* @__PURE__ */ r(
    at.SubContent,
    {
...
vs.displayName = at.SubContent.displayName;
const xs = v.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = zt();
...
xs.displayName = at.Content.displayName;
const ys = v.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ r(
    at.Item,
    {
      ...
      className: h(
        ...
        e && "tw-pl-8",
        de({ variant: a.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...n
...
ys.displayName = at.Item.displayName;
const qd = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = zt();
  return /* @__PURE__ */ p(
    at.CheckboxItem,
    {
...
qd.displayName = at.CheckboxItem.displayName;
const Hd = v.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ p(
    at.RadioItem,
    {
...
Hd.displayName = at.RadioItem.displayName;
const Yd = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  at.Label,
  {
    ref: o,
    className: h("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Ns.displayName = at.Separator.displayName;
const on = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, d) => w.order - d.order).map((w) => /* @__PURE__ */ p(Et, { children: [
      /* @__PURE__ */ r(Rt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ p(
        ys,
        {
          onClick: () => {
            o(w);
      ...
      ) : /* @__PURE__ */ p(Gd, { children: [
        /* @__PURE__ */ r(bs, { children: w.label }),
    ...
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ r(Ns, {}, `separator-${s}`)), c;
  });
};
function Xd({
  menuData: t,
  ...
  if (Tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    var g, y, b, C;
    d.preventDefault();
    ...
    return /* @__PURE__ */ r(hs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(Ud, { children: [
      /* @__PURE__ */ r(gs, { ref: w(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        xs,
        {
          style: { zIndex: Je },
          children: /* @__PURE__ */ r(kt, { children: ks(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
  ...
  return /* @__PURE__ */ p("div", { id: c, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ p(
      Ue,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(De, { children: /* @__PURE__ */ r(Ge, {}) }),
          /* @__PURE__ */ r(
            Me,
            {
              style: { zIndex: Je },
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(gt, { className: "tw-font-normal tw-text-muted-foreground", children: _e(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function Jd({ item: t, createLabel: e, createComplexLabel: n }) {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && w && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ge, { children: [
              /* @__PURE__ */ r(Se, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(to, {}) }) }),
              /* @__PURE__ */ r(ie, { align: "end", children: w })
            ] }) }),
            e && w && /* @__PURE__ */ p(ge, { children: [
              /* @__PURE__ */ r(Se, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(to, {}) }) }),
              /* @__PURE__ */ r(ie, { align: "end", children: w })
            ] })
          ] }),
...
const Zd = fn(({ className: t, ...e }, n) => /* @__PURE__ */ r(di, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
...
), tp = v.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const np = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
np.displayName = "AlertDescription";
const Gu = st.Root, qu = st.Trigger, Hu = st.Group, Yu = st.Portal, Xu = st.Sub, Wu = st.RadioGroup, rp = v.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  st.SubTrigger,
  {
    ref: a,
    className: h(
...
rp.displayName = st.SubTrigger.displayName;
...
op.displayName = st.SubContent.displayName;
const ap = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(st.Portal, { children: /* @__PURE__ */ r(
  st.Content,
  {
    ref: n,
    className: h(
...
ap.displayName = st.Content.displayName;
...
sp.displayName = st.Item.displayName;
const ip = v.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  st.CheckboxItem,
  {
    ref: a,
    className: h(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(st.ItemIndicator, { children: /* @__PURE__ */ r(jt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
ip.displayName = st.CheckboxItem.displayName;
const lp = v.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  st.RadioItem,
  {
    ref: o,
    className: h(
...
lp.displayName = st.RadioItem.displayName;
const cp = v.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  st.Label,
  {
    ref: o,
    className: h(
...
cp.displayName = st.Label.displayName;
const wp = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  st.Separator,
  {
    ref: n,
...
wp.displayName = st.Separator.displayName;
...
dp.displayName = "ContextMenuShortcut";
const _s = v.createContext({
  direction: "bottom"
});
function pp({
...
pp.displayName = "Drawer";
const Ju = Ft.Trigger, up = Ft.Portal, Zu = Ft.Close, Cs = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Ft.Overlay,
  {
    ref: n,
...
const mp = v.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = v.useContext(_s), i = {
...
gp.displayName = Ft.Title.displayName;
...
bp.displayName = Ft.Description.displayName;
const vp = v.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  pr.Root,
  {
    ref: o,
    className: h(
...
vp.displayName = pr.Root.displayName;
function Qu({
  className: t,
  ...e
}) {
...
function em({
  ...
  return /* @__PURE__ */ r(
    Sr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(pi, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function nm({ ...t }) {
...
const xp = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ p(
    an.Root,
    {
...
xp.displayName = an.Root.displayName;
...
yp.displayName = ur.Root.displayName;
const rm = Dt.Root, Np = v.forwardRef(({ className: t, ...e }, n) => {
  const o = ut();
  return /* @__PURE__ */ r(
    Dt.List,
    {
...
Np.displayName = Dt.List.displayName;
...
kp.displayName = Dt.Trigger.displayName;
...
_p.displayName = Dt.Content.displayName;
const Cp = v.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
      className: h(
...
export {
  ...
  cu as CommentList,
  Gu as ContextMenu,
  ip as ContextMenuCheckboxItem,
  ap as ContextMenuContent,
  Hu as ContextMenuGroup,
  sp as ContextMenuItem,
  cp as ContextMenuLabel,
  Yu as ContextMenuPortal,
  Wu as ContextMenuRadioGroup,
  lp as ContextMenuRadioItem,
  wp as ContextMenuSeparator,
  dp as ContextMenuShortcut,
  Xu as ContextMenuSub,
  op as ContextMenuSubContent,
  rp as ContextMenuSubTrigger,
  qu as ContextMenuTrigger,
  Fw as DataTable,
  Pl as Dialog,
  tu as DialogClose,
  ca as DialogContent,
  ...
  du as ERROR_POPOVER_STRING_KEYS,
  Yw as EditorKeyboardShortcuts,
  Bw as ErrorDump,
  pu as ErrorPopover,
  bu as FOOTNOTE_EDITOR_STRING_KEYS,
  hu as Filter,
  uu as FilterDropdown,
  fu as Footer,
  gu as FootnoteEditor,
  cd as FootnoteItem,
  vu as FootnoteList,
  Eu as INVENTORY_STRING_KEYS,
  en as Input,
  Ru as Inventory,
  gt as Label,
  td as MARKER_MENU_STRING_KEYS,
  wu as MarkdownRenderer,
  nd as MarkerMenu,
  mu as MoreInfo,
  ...
  em as ResizableHandle,
  tm as ResizablePanel,
  Qu as ResizablePanelGroup,
  Ku as ResultsCard,
  Du as SCOPE_SELECTOR_STRING_KEYS,
  Mu as ScopeSelector,
  Su as ScriptureResultsViewer,
  Ou as ScrollGroupSelector,
  qr as SearchBar,
  Ue as Select,
  Me as SelectContent,
  Sw as SelectGroup,
  ...
  gw as badgeVariants,
  ha as buttonVariants,
  h as cn,
  Cu as getBookIdFromUSFM,
  Kn as getInventoryHeader,
  ku as getLinesFromUSFM,
  _u as getNumberFromUSFM,
  md as getStatusForItem,
  ju as getToolbarOSReservedSpaceClassName,
  yu as inventoryCountColumn,
  xu as inventoryItemColumn,
