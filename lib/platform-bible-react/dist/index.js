...
var Ai = (t, e, r) => e in t ? Ii(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Kt = (t, e, r) => Ai(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Ee, a as Fa, C as ke, A as ie, P as De, b as We, B as q, d as Oe, e as Me, f as $e, h as xe, i as Pi, k as Vi, j as ji, E as Li, l as Ua, r as pe, m as Bi, n as ln, o as Qr, p as ta, L as Nt, R as Ka, q as qr, D as Na, s as Ca, t as Ea, u as Ta, T as dn, v as Vr, w as Pt, x as qa, y as Vt, z as jt, F as Lt, G as wn, H as Ga, I as Ge, J as kr, K as Ie, M as Ae, N as Pe, S as _r, O as er, Q as Fi, U as Er, V as Ye, W as ze, Z as Xe, X as Te, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as un, a3 as Ui, a4 as Ki, a5 as qi, a6 as za, a7 as pn, a8 as ea, a9 as hn, aa as Gi, ab as Hi, ac as Yi, ad as Wi, ae as gn, af as Xi, ag as sa, ah as xo, ai as ca, aj as Ji, ak as Zi, al as Qi, am as ts, an as es, ao as Tr, ap as Xa, aq as rs, ar as as } from "./resizable-C3AVzTx2.js";
import { as as Jh, at as Zh, au as Qh, av as tg, aw as eg, ax as rg, ay as ag, az as og, aA as ng, aB as ig, aC as sg, aD as cg, aE as lg, aF as dg, aG as wg, aH as ug, aI as pg, aJ as hg, aK as gg, aL as fg, aM as mg, aN as vg, aO as bg, aP as xg, aQ as yg } from "./resizable-C3AVzTx2.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Se, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Sa, ChevronRight as Ra, ArrowLeft as os, ArrowRight as ns, ChevronDown as nr, BoldIcon as is, ItalicIcon as ss, X as Ja, AtSign as fn, Pencil as cs, Trash2 as ls, ArrowUp as mn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as vn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Cs, AlertCircle as Da, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Rs, ScrollText as Ds, ChevronsUpDown as Os, MenuIcon as Ms, Menu as $s, EllipsisVertical as Is, MoreVertical as As } from "lucide-react";
import { Section as dt, getChaptersForBook as Ps, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Vs, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as kn, formatBytes as js, getCurrentLocale as Ls, usfmMarkers as jr, getFormatCallerFunction as Bs, deepEqual as Fs, isString as No, compareScrRefs as Oa, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as Co, formatReplacementStringToArray as Eo, collectUsjMarkers as Ks } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as qs, useLayoutEffect as Qt, createContext as Qa, useContext as _n, Component as Gs, createElement as To, Suspense as Hs, forwardRef as Nn, useId as zo, Fragment as ra } from "react";
import { IconSelector as Cn, IconCheck as aa, IconChevronDown as Ys, IconChevronUp as Ws, IconLayoutSidebar as Xs, IconLayoutSidebarRight as Js, IconChevronRight as En, IconSearch as Zs, IconLoader as Qs, IconAlertOctagon as tc, IconAlertTriangle as ec, IconInfoCircle as rc, IconCircleCheck as ac } from "@tabler/icons-react";
import { createEditor as Tn, $getRoot as Re, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as zn, TextNode as Sn, $getPreviousSelection as oc, $isRangeSelection as we, $caretFromPoint as nc, $getSiblingCaret as Rn, $getChildCaret as ic, $getAdjacentChildCaret as sc, $isChildCaret as cc, $normalizeCaret as lc, $setSelectionFromCaretRange as dc, $getCollapsedCaretRange as wc, $getCaretInDirection as So, $splitAtPointCaretNext as uc, $isTextPointCaret as pc, $findMatchingParent as Dn, $isElementNode as Nr, mergeRegister as ye, getDOMTextNode as hc, isHTMLElement as gc, CLEAR_EDITOR_COMMAND as On, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as fc, defineExtension as re, safeCast as Je, createState as mc, FORMAT_TEXT_COMMAND as Mn, $isNodeSelection as $n, COMMAND_PRIORITY_LOW as In, RootNode as vc, LineBreakNode as bc, TabNode as xc, $isEditorState as yc, createCommand as kc, CLICK_COMMAND as _c, isDOMNode as Nc, $getNodeFromDOMNode as Cc, $createNodeSelection as Ec, $setSelection as Tc, $getEditor as zc, DecoratorNode as Ma, $getState as Sc, toggleTextFormatType as Ro, TEXT_TYPE_TO_FORMAT as Rc, $setState as Dc, addClassNamesToElement as An, $create as Oc, $getNodeByKey as Mc, removeClassNamesFromElement as $c, KEY_TAB_COMMAND as Ic, $isBlockElementNode as Ac, $createRangeSelection as Pc, $normalizeSelection__EXPERIMENTAL as Vc, OUTDENT_CONTENT_COMMAND as jc, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as Lc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Bc, $isParagraphNode as Fc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Pn, $insertNodes as Uc } from "lexical";
import { HeadingNode as Kc, QuoteNode as qc, registerRichText as Gc } from "@lexical/rich-text";
import { flushSync as Hc, createPortal as Yc } from "react-dom";
...
import { Avatar as ao, Select as Gt, Checkbox as Oo, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Mo, Slider as Or, Switch as $o } from "radix-ui";
import { useReactTable as jn, getFilteredRowModel as Zc, getSortedRowModel as Ln, getPaginationRowModel as Qc, getCoreRowModel as Bn, flexRender as xr, getGroupedRowModel as tl, getExpandedRowModel as el } from "@tanstack/react-table";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as al, isInsertEmbedOpOfType as Mr, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
import { toast as _g } from "sonner";
...
function cl({
  ...
  const [h, g] = _(!1), f = w !== void 0, b = f ? w : h, m = (y) => {
    f || g(y), p == null || p(y);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(De, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Oe, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      ke,
      {
        onSelect: () => E(y),
...
function Kn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(xe, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function ua({
  ...
  const B = pe(), [z, I] = _(!1), [A, C] = _(""), [P, U] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
  ), [W, Z] = _(void 0), [Dt, Tt] = _(!1), Bt = F(null), K = F(!1), tt = F(void 0), wt = F(void 0), at = F(void 0), mt = F(void 0), ae = F({}), ut = F({}), bt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Ot = D(() => o ? o() : Bi, [o]), Ft = D(() => ({
    [dt.OT]: Ot.filter((G) => vt.isBookOT(G)),
    [dt.NT]: Ot.filter((G) => vt.isBookNT(G)),
    [dt.DC]: Ot.filter((G) => vt.isBookDC(G)),
    [dt.Extra]: Ot.filter((G) => vt.extraBooks().includes(G))
  }), [Ot]), Jt = D(() => Object.values(Ft).flat(), [Ft]), fe = D(() => {
    if (!P.trim()) return Ft;
    const x = {
      [dt.OT]: [],
      [dt.NT]: [],
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      x[rt] = Ft[rt].filter((At) => Ua(At, P, n));
    }), x;
  }, [Ft, P, n]), R = D(
    () => pl(P, Jt, n),
    [P, Jt, n]
  ...
  const Ct = L(() => {
    if (R) {
      const x = R.chapterNum ?? 1, G = R.verseNum ?? 1;
      if (w && wa(R.book, x, G, w))
        return;
      bt({
        book: R.book,
        chapterNum: x,
    ...
    (x) => {
      const G = T ?? (R == null ? void 0 : R.book), rt = W ?? (R == null ? void 0 : R.chapterNum);
      !G || !rt || (bt({
        book: G,
        chapterNum: rt,
        verseNum: x
    ...
    (x) => {
      const G = k === "chapters" ? j : R == null ? void 0 : R.book;
      if (G) {
        if (d && d(G, x) > 1) {
          $(G), Z(x), J("verses"), C("");
          return;
    ...
    J("books"), Y(void 0), $(void 0), Z(void 0), setTimeout(() => {
      wt.current && wt.current.focus();
    }, 0);
  }, []), ot = L(() => {
    const x = T;
    $(void 0), Z(void 0), x ? (Y(x), J("chapters"), C("")) : et();
  }, [T, et]), it = L((x) => {
    I(x), x && (J("books"), Y(void 0), $(void 0), Z(void 0), U(""));
  }, []);
  H(() => {
    O && it(!1);
  }, [O, it]);
  ...
  H(() => {
    var x;
    st !== 0 && ((x = wt.current) == null || x.focus());
  }, [st]), qs(
    N,
    () => ({
      open: () => {
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    () => wl(P),
    [P]
  ), oe = D(() => !d || !R || !R.chapterNum || !xt ? !1 : d(R.book, R.chapterNum) > 0, [d, R, xt]), Le = L(
    (x) => w ? Io(x, w) : !1,
    [w]
  ), ur = L(
    (x) => (G) => w ? ul(x, G, w) : !1,
    ...
    (x, G) => (rt) => w ? wa(x, G, rt, w) : !1,
    [w]
  ), hr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", gr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Rr = L(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && R && R.chapterNum !== void 0 && R.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), Ct());
    },
    [p, R, Ct]
  ), Ze = L(
    (x) => {
      var me, Ne, Fe;
      if (x.ctrlKey) return;
      const { isLetter: G, isDigit: rt } = Ao(x.key);
      if ((k === "chapters" || k === "verses") && (x.key === " " || x.key === "Enter")) {
        const Et = x.target instanceof HTMLElement ? x.target : void 0;
        if (!!(Et != null && Et.closest(
          'button, a, input, select, textarea, [role="button"]'
        ))) {
          x.stopPropagation();
          return;
        }
        const _t = (me = tt.current) == null ? void 0 : me.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (_t) {
          x.preventDefault(), x.stopPropagation(), _t.click();
          return;
        }
      }
      if ((k === "chapters" || k === "verses") && (G || rt)) {
        x.preventDefault(), x.stopPropagation();
        return;
      }
      if (k === "chapters" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), et();
        return;
      }
      if (k === "verses" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), ot();
        return;
      }
      ...
      if (k === "verses" && At) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            ft !== 0 && (Ut = ft > 1 ? ft - 1 : _t);
            break;
          case "ArrowRight":
            ft !== 0 && (Ut = ft < _t ? ft + 1 : 1);
            break;
          case "ArrowUp":
            Ut = ft === 0 ? _t : Math.max(1, ft - ce);
            break;
          case "ArrowDown":
            Ut = ft === 0 ? 1 : Math.min(_t, ft + ce);
            break;
          default:
            return;
        }
        Ut !== ft && (x.preventDefault(), x.stopPropagation(), C(
          `${Et} ${ie[Et] || ""} ${kt}:${Ut}`
        ), setTimeout(() => {
          const Ue = ut.current[Ut];
          Ue && Ue.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((k === "chapters" || k === "books" && R) && At) {
        const Et = k === "chapters" ? j : R == null ? void 0 : R.book;
        if (!Et) return;
        k === "chapters" && ((Fe = tt.current) == null || Fe.focus());
        const kt = (() => {
          if (!A) return 1;
          const ce = A.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            kt !== 0 && (ft = kt > 1 ? kt - 1 : _t);
            break;
          case "ArrowRight":
            kt !== 0 && (ft = kt < _t ? kt + 1 : 1);
            break;
          case "ArrowUp":
            ft = kt === 0 ? _t : Math.max(1, kt - Ut);
            break;
          case "ArrowDown":
            ft = kt === 0 ? 1 : Math.min(_t, kt + Ut);
            break;
          default:
            return;
        }
        ft !== kt && (x.preventDefault(), x.stopPropagation(), C(
          `${Et} ${ie[Et] || ""} ${ft}`
        ), setTimeout(() => {
          const ce = ae.current[ft];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (At = wt.current) == null || At.focus();
      return;
    }
    const { isLetter: G, isDigit: rt } = Ao(x.key);
    (G || rt) && (x.preventDefault(), U((me) => me + x.key), wt.current.focus(), Tt(!1));
  }, []);
  return Qt(() => {
    const x = setTimeout(() => {
      if (z && k === "books" && at.current && mt.current) {
        const G = at.current, rt = mt.current, At = rt.offsetTop, me = G.clientHeight, Ne = rt.clientHeight, Fe = At - me / 2 + Ne / 2;
        G.scrollTo({
          top: Math.max(0, Fe),
          behavior: "smooth"
        }), C(Un(t.book));
    ...
    if (k === "chapters" && j) {
      const x = j === t.book, G = x ? t.chapterNum : 1;
      C(
        `${j} ${ie[j] || ""} ${G}`
      ), setTimeout(() => {
        if (at.current)
  ...
  }, [k, j, R, t.book, t.chapterNum]), Qt(() => {
    if (k === "verses" && T && W !== void 0) {
      const x = T === t.book && W === t.chapterNum, G = x ? t.verseNum : 1;
      C(
        `${T} ${ie[T] || ""} ${W}:${G}`
      ), setTimeout(() => {
        if (at.current)
          if (x) {
            const rt = ut.current[t.verseNum];
            rt && rt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            at.current.scrollTo({ top: 0 });
        tt.current && tt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(De, { open: z, onOpenChange: it, modal: E, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        ...
        onClick: (x) => {
          K.current && (K.current = !1, x.preventDefault());
        },
        children: [
          h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: je }),
          f && /* @__PURE__ */ a(
            Cn,
            {
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: G } = x;
          z && Bt.current && G instanceof Node && Bt.current.contains(G) && (K.current = !0, it(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Me,
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Q.map(
                  ({ onClick: x, disabled: G, title: rt, icon: At }) => /* @__PURE__ */ a(
                    q,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  q,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: k === "verses" ? ot : et,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: B === "ltr" ? /* @__PURE__ */ a(os, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                k === "chapters" && j && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ee(j, n) }),
                k === "verses" && T && W !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ee(T, n)} ${W}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: k === "verses" ? gr : hr
                  }
                )
              ] }),
              !Dt && /* @__PURE__ */ u($e, { ref: at, children: [
                k === "books" && /* @__PURE__ */ u(ct, { children: [
                  !R && Object.entries(fe).map(([x, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: Ht(x), children: G.map((rt) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: rt,
                            onSelect: (At) => _e(At),
                  ...
                  R && oe && R.chapterNum && d && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ee(R.book, n)} ${R.chapterNum}` }),
                  ...
                  R && !oe && ar(R.book) > 1 && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ee(R.book, n) }),
                ...
                k === "verses" && T && W !== void 0 && d && /* @__PURE__ */ a(
                  Vo,
                  {
                    bookId: T,
                    chapterNum: W,
...
function jo({
  ...
  const [N, O] = _(!1), B = d ?? l, z = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
    const P = l(A), U = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, k = `${C ?? ""}${P}${U ?? ""}`;
    return /* @__PURE__ */ u(
      ke,
      {
        value: P,
  ...
  return /* @__PURE__ */ u(De, { open: N, onOpenChange: O, ...y, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        children: /* @__PURE__ */ u(Me, { children: [
          ...
          /* @__PURE__ */ a($e, { children: z(e) ? e.map((A) => /* @__PURE__ */ a(xe, { heading: A.groupHeading, children: A.options.map((C) => I(C, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((A) => I(A)) }) })
        ] })
      }
    )
  ] });
...
function Xu({
  ...
  const w = pa(d, "%webView_bookSelector_currentBook%"), p = pa(d, "%webView_bookSelector_choose%"), h = pa(d, "%webView_bookSelector_chooseBooks%"), [g, f] = _(
    "current book"
    /* CurrentBook */
  ), b = (m) => {
    f(m), t(m);
    ...
    Ka,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Nt, { className: "tw:flex tw:items-center", children: o.map((m) => vt.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            q,
            {
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = Gn ? Qt : H, Ir = { tag: to };
function vl({ initialConfig: t, children: e }) {
  const r = D(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = fl(null, o), w = Tn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function xl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = ge();
  return bl(() => {
...
class kl extends Gs {
  constructor(e) {
    super(e), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = ha;
  }
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && _l(e.resetKeys, n)) {
      var i, s;
...
function Nl({ children: t, onError: e }) {
  return a(kl, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Cl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function El(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Tl() {
  return function(t) {
    const [e] = ge(), r = D(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = F(o);
    return Cl(() => {
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Sl = Hn && "documentMode" in document ? document.documentMode : null;
!(!Hn || !("InputEvent" in window) || Sl) && "getTargetRanges" in new window.InputEvent("input");
function de(t) {
  return `${t}px`;
}
...
function Dl(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < g.length; E++) {
      const y = g[E], N = s[E] || document.createElement("div"), O = N.style;
      O.position !== "absolute" && (O.position = "absolute", m = !0);
      const B = de(y.left - p);
      O.left !== B && (O.left = B, m = !0);
      const z = de(y.top - h);
      O.top !== z && (N.style.top = z, m = !0);
      const I = de(y.width);
      O.width !== I && (N.style.width = I, m = !0);
      const A = de(y.height);
      O.height !== A && (N.style.height = A, m = !0), N.parentNode !== c && (c.append(N), m = !0), s[E] = N;
    }
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(A) {
        const C = A.getStartEndPoints();
        return A.isBackward() ? [C[1], C[0]] : C;
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, E = g.getNode(), y = E.getKey(), N = g.offset, O = t.getElementByKey(b), B = t.getElementByKey(y), z = r === null || O !== o || m !== n || b !== r.getKey(), I = i === null || B !== s || N !== c || y !== i.getKey();
      if ((z || I) && O !== null && B !== null) {
        const A = function(C, P, U, k, J, j, Y) {
          const T = (C._window ? C._window.document : document).createRange();
          return T.setStart(...Lo(P, U, k)), T.setEnd(...Lo(J, j, Y)), T;
        }(t, h, f, O, g, E, B);
        l(), l = Dl(t, A, e);
      }
      r = f, o = O, n = m, i = E, s = B, c = N;
    });
  }
  return d(t.getEditorState()), ye(t.registerUpdateListener(({ editorState: w }) => d(w)), () => {
    l();
  });
}
function $l(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = Ml(t, e));
  };
...
function Il(t) {
  const e = Dn(t, (r) => Nr(r) && !r.isInline());
  return Nr(e) || Hr(4, t.__key), e;
}
function Al(t) {
  const e = Xt() || oc();
  let r;
  if (we(e)) r = nc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Rn(c, "next"));
    }
    r = r || ic(Re(), "previous").getFlipped().insert(zr());
  }
  const o = Pl(t, r), n = sc(o), i = cc(n) ? lc(n) : o;
  return dc(wc(i)), t.getLatest();
}
function Pl(t, e, r) {
  let o = So(e, "next");
  for (let n = o; n; n = uc(n, r)) o = n;
  return pc(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), So(Rn(t.getLatest(), "next"), e.direction);
}
function Vl(t) {
  const e = Xt();
  if (!we(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Dn(i, (d) => Nr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Yr, be = 0, Wr = 0, Bl = 0, Va = 0, Br = 0;
function Fo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ke(t, e) {
  qt.call(this, void 0), this.x = t, this.s = void 0, this.g = Br - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Fl(t, e) {
  return new Ke(t, e);
}
...
function Ul(t) {
  ...
  Wn(this), nt = t, this.f &= -2, 8 & this.f && so(this), oa();
}
function tr(t, e) {
...
qt.prototype.brand = jl, qt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Wr === 0 && e.l !== Va && (e.l = Va, Yr = { S: e, v: e.v, i: e.i, o: Yr });
    })(this), this.v = t, this.i++, Br++, be++;
    try {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Xn(this), Uo(this), be++;
  const t = nt;
  return nt = this, Ul.bind(this, t);
...
function Zn(t, e = Jn) {
  return t.registerCommand(On, (r) => (t.update(e), !0), eo);
}
re({ build: (t, e, r) => wr(e), config: Je({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ue(() => Zn(t, o.value));
} });
function Kl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ga = mc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends Ma {
  $config() {
    return this.config("decorator-text", { extends: Ma, stateConfigs: [{ flat: !0, stateConfig: ga }] });
  }
  getFormat() {
    return Sc(this, ga);
  }
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Mn, (o) => {
  const n = Xt();
  if ($n(n) || we(n)) for (const i of n.getNodes()) ql(i) && i.toggleFormat(o);
  return !1;
}, In) });
function ti(t, e) {
  let r;
...
const ja = re({ build: (t) => ti(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const co = 0, La = 1, ri = 2, fa = 3, Ar = 4, Qe = 5, ma = 6, mr = 7;
function va(t) {
  return t.id === co;
}
function ai(t) {
...
function Gl(t) {
  return function(e) {
    return e.id === La;
  }(t) || lt(305, String(t.id), String(La)), Object.assign(t, { id: ri });
}
...
class Yl {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : fc;
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, l, d) {
      return Object.assign(c, { config: l, id: fa, registerState: d });
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ar && lt(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ma && lt(310, String(r.id), String(ma)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= fa;
    }(e) || lt(314, String(e.id), String(fa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const Xl = re({ config: Je({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (yc(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [vc, Sn, bc, xc, zn] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Go() {
}
function Jl(t) {
  throw t;
...
class or {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = ba, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[qo];
    return r && (r.PACKAGE_VERSION !== ba && lt(292, r.PACKAGE_VERSION, ba), r instanceof or || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(Tn({ ...o, ...r ? { onError: (i) => {
      r(i, n);
    } } : {} }), { [qo]: this });
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && lt(298, o.name), !n) {
      n = new Yl(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      va(i) || lt(300, s, n || "[unknown]"), va(c = i) || lt(304, String(c.id), String(co)), i = Object.assign(c, { id: La }), o.state = i;
      const l = this.outgoingConfigEdges.get(s);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = Gl(i), o.state = i, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of Kl(p)) {
...
const Zl = /* @__PURE__ */ new Set(), Ho = re({ build(t, e, r) {
  const o = r.getDependency(ja).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ti(() => {
  }, () => ue(() => {
...
re({ dependencies: [ja, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Ho).output, n = Cr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ye(t.registerCommand(Ql, (s) => {
    const c = Xt();
    if (!we(c)) return !1;
    ...
    return !0;
  }, eo), t.registerCommand(_c, (s) => {
    if (Nc(s.target)) {
      const c = Cc(s.target);
      if (ed(c)) return function(l, d = !1) {
        const w = Xt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && $n(w) ? g = w : (g = Ec(), Tc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, In), t.registerMutationListener(ir, (s, c) => {
    Ll(() => {
      let l = !1;
...
function rd(t, e, r = oi) {
  return ye(t.registerCommand(Ic, (o) => {
    const n = Xt();
    if (!we(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Ac(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Il(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Pc();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = Vc(g), g.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? jc : Do : Lc;
    return t.dispatchCommand(i, void 0);
  }, eo), t.registerCommand(Do, () => {
...
re({ build: (t, e, r) => wr(e), config: Je({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ue(() => {
    if (!o.value) return rd(t, n, i);
  });
} });
const ad = re({ name: "@lexical/react/ReactProvider" });
function od() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (we(f)) {
                const b = f.anchor;
                let m = b.getNode(), E = 0, y = 0;
                if ($a(m) && d >= 0 && w >= 0 && (E = d, y = d + w, f.setTextNodeRange(m, E, m, y)), E === y && p === "" || (f.insertRawText(p), m = b.getNode()), $a(m)) {
                  E = h, y = h + g;
                  const N = m.getTextContentSize();
                  E = E > N ? N : E, y = y > N ? N : y, f.setTextNodeRange(m, E, m, y);
                }
...
re({ build: (t, e, r) => wr(e), config: Je({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ue(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function sd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
  ...
  return function(r, o) {
    ...
    return wo(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(Hs, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && s.push(Yc(w, p, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function ld({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(ad.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && sd(320, n);
      return !0;
    }
    return !1;
...
function dd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = ge();
  return function(n) {
    wo(() => ye(Gc(n), ii(n)), [n]);
  }(o), u(ct, { children: [t, a(wd, { content: e }), a(ld, { editor: o, ErrorBoundary: r })] });
}
...
function ud({ defaultSelection: t }) {
  const [e] = ge();
  return H(() => {
    e.focus(() => {
...
const pd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function hd({ onClear: t }) {
  const [e] = ge();
  return pd(() => Zn(e, t), [e, t]), null;
}
const si = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function gd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: E = !0, style: y, tabIndex: N, "data-testid": O, ...B }, z) {
  const [I, A] = _(t.isEditable()), C = L((U) => {
    U && U.ownerDocument && U.ownerDocument.defaultView ? t.setRootElement(U) : t.setRootElement(null);
  }, [t]), P = D(() => /* @__PURE__ */ function(...U) {
    return (k) => {
      for (const J of U) typeof J == "function" ? J(k) : J != null && (J.current = k);
    };
  }(z, C), [C, z]);
  return si(() => (A(t.isEditable()), t.registerEditableListener((U) => {
    A(U);
  })), [t]), a("div", { "aria-activedescendant": I ? e : void 0, "aria-autocomplete": I ? r : "none", "aria-controls": I ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": I && m === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": I ? p : void 0, "aria-readonly": !I || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: I, "data-testid": O, id: b, ref: P, role: m, spellCheck: E, style: y, tabIndex: N, ...B });
}
const fd = Nn(gd);
function Wo(t) {
  return t.getEditorState().read(ni(t.isComposing()));
...
function vd(t, e) {
  ...
  return u(ct, { children: [a(fd, { editor: n, ...o, ref: e }), r != null && a(bd, { editor: n, content: r })] });
}
function bd({ content: t, editor: e }) {
  const r = function(s) {
    const [c, l] = _(() => Wo(s));
    return si(() => {
      function d() {
      ...
      return d(), ye(s.registerUpdateListener(() => {
        d();
...
function kd() {
  const [t, e] = _(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Na, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ca, { children: [
      /* @__PURE__ */ a(Ea, { children: /* @__PURE__ */ a(Ta, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function _d({
  ...
  const [e] = ge(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = kd(), l = () => {
  };
...
function Td({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(_d, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Cd, {}) }) }),
    /* @__PURE__ */ u("div", { className: "tw:relative", children: [
      ...
      e && /* @__PURE__ */ a(ud, { defaultSelection: "rootEnd" }),
...
function pi({
  ...
  return /* @__PURE__ */ u(qa, { children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      ...
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(wn, {}),
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { children: c }) })
    ] }) })
  ] });
}
const Rd = "verseText", Ju = Object.freeze([
...
function gi(t) {
  return (t == null ? void 0 : t.conflictType) === Rd;
}
function fi(t) {
...
function Zu({
  ...
  const [i, s] = _(Dd), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  H(() => {
    let m = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
      ...
      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
        q,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: xa(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        Oe,
        {
          ...
          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: t.map((m) => /* @__PURE__ */ a(
            ke,
            {
              ...
              children: /* @__PURE__ */ a("span", { children: xa(m, o) })
            },
            m || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : po(m) && (m.preventDefault(), m.stopPropagation(), ee(i) && g());
        },
        onKeyDown: (m) => {
          uo(m), (m.key === "Enter" || m.key === " ") && m.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Xr,
          {
...
function Zo({
  ...
  const g = L(
    ...
    const z = new Date(t.date), I = Vs(
      z,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), A = z.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), m = D(() => t.user, [t.user]), E = D(
    () => t.user.split(" ").map((z) => z[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = D(() => Za(t.contents), [t.contents]), N = D(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), O = !!t.conflictResolutionAction && !N, B = D(() => {
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          Ge,
          {
            onClick: (z) => {
              z.stopPropagation(), d(!0), p(Sd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Id, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ad, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (z) => {
                z.key === "Escape" ? (z.preventDefault(), z.stopPropagation(), g()) : po(z) && (z.preventDefault(), z.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (z) => {
                uo(z), (z.key === "Enter" || z.key === " ") && z.stopPropagation();
              },
              onClick: (z) => {
                z.stopPropagation();
              },
        ...
        B && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ds, {}) }) }),
          /* @__PURE__ */ a(Pe, { align: "end", children: B })
        ] })
      ]
    }
  );
  ...
  if (t)
    return /* @__PURE__ */ a(
      q,
      {
        ...
        "aria-label": o,
        children: /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" })
      }
    );
}
const Qo = {
...
function vi({
  ...
  const [k, J] = _(Qo), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Bt] = _(!1), [K, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(O), [Ot, Ft] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
      const xt = y ? await y(l) : !1;
      S && ae(xt);
    })(), () => {
      S = !1;
    };
  ...
  H(() => {
    if (!o) {
      yt.current !== "idle" && (Y(void 0), $(void 0), yt.current = "idle");
      return;
    }
    ...
    I !== i && (Y(I), yt.current = "auto-populated") : yt.current === "auto-populated" && (Y(void 0), yt.current = "pending");
  }, [o, I, wt, i]);
  const Ct = D(
  ...
  const Zt = D(() => Ct[0], [Ct]), _e = F(null), te = F(void 0), V = L(() => {
    var S;
    (S = te.current) == null || S.call(te), J(Qo);
  }, []), Q = L(() => {
    const S = !ut;
    bt(S), Ft(!S), f == null || f(l, S);
  }, [ut, f, l]);
  H(() => {
    Dt(!1);
  }, [o]), H(() => {
    if (o && !ut && !Ot) {
      ...
      return Jt.current = S, () => clearTimeout(S);
    }
  ...
  }, [i, r]), it = D(() => Ct.slice(1), [Ct]), st = D(() => it.length ?? 0, [it.length]), ht = D(() => st > 0, [st]), pt = D(() => Z || st <= 2 ? it : it.slice(-2), [it, st, Z]), gt = D(() => Z || st <= 2 ? 0 : st - 2, [st, Z]), Mt = D(
    () => st === 1 ? et.singleReply : He(et.multipleReplies, { count: st }),
    [st, et]
  ), zt = D(
    () => gt === 1 ? et.singleReply : He(et.multipleReplies, { count: gt }),
    [gt, et]
  );
  H(() => {
    !o && Tt && ht && Bt(!1);
  ...
  const Ht = L(
    async (S) => {
      ...
      It && await p({ threadId: l, contents: It }) && V();
    },
    [
      V,
      k,
    ...
    async (S) => {
      const It = ee(k) ? Jr(k) : void 0, xt = S.status ? S.assignedUser : j ?? S.assignedUser, oe = await p({
        ...S,
        contents: It,
        assignedUser: xt
      });
      return oe && (xt !== void 0 && $(xt), It && V()), oe;
    },
    [V, k, p, j]
  );
  ...
  const je = /* @__PURE__ */ a(
    Zo,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Bt,
      canEditOrDelete: (!Tt && fe.get(Zt.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    Md,
    {
      ...
      className: v(
        ...
        {
          "tw:bg-primary-foreground": !o && w !== "Resolved" && ut,
          "tw:bg-background": o && w !== "Resolved" && ut,
          "tw:bg-muted": w === "Resolved",
          "tw:bg-accent": !ut && !o && w !== "Resolved"
        }
      ),
      onClick: () => {
        c(l);
      ...
      children: /* @__PURE__ */ u($d, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              q,
              {
                ...
                children: ut ? /* @__PURE__ */ a(ws, {}) : /* @__PURE__ */ a(us, {})
              }
            ),
            P === void 0 ? (
            ...
            "p",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("span", { className: t, children: [
                  Zt.contextBefore,
                  /* @__PURE__ */ a("span", { className: "tw:font-bold", children: Zt.selectedText }),
                  Zt.contextAfter
                ] })
              ]
            }
        ...
        /* @__PURE__ */ u(ct, { children: [
          ht && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Mt })
          ] }),
          !o && ee(k) && /* @__PURE__ */ a(
            Xr,
            {
              editorSerializedState: k,
              onSerializedChange: (S) => J(S),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(ct, { children: [
            U && pt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            gt > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (S) => {
                  S.stopPropagation(), Dt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (S) => {
                  (S.key === "Enter" || S.key === " ") && (S.preventDefault(), S.stopPropagation(), Dt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(_r, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: zt }),
                    Z ? /* @__PURE__ */ a(ps, {}) : /* @__PURE__ */ a(nr, {})
                  ] })
                ]
              }
            ),
            pt.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Zo,
              {
                comment: S,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Bt,
                canEditOrDelete: (!Tt && fe.get(S.id)) ?? !1
              }
            ) }, S.id)),
            m !== !1 && (!Tt || ee(k)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (S) => {
                  po(S) && (S.preventDefault(), S.stopPropagation(), (ee(k) || j !== void 0 && j !== T) && Ht());
                },
                onKeyDown: (S) => {
                  uo(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Xr,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    j !== void 0 && (ee(k) || j !== T) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: He(
                    ...
                    /* @__PURE__ */ u(De, { open: K, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(
                        q,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Oe,
                        {
                          ...
                          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: b == null ? void 0 : b.map((S) => /* @__PURE__ */ a(
                            ke,
                            {
                              onSelect: () => {
                                Y(S !== i ? S : void 0), yt.current = "user-selected", $(void 0), tt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Fr(S, r) })
                            },
                            S || "unassigned"
                          )) }) })
                        }
...
), Vd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => Vd(Za(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function jd({
  ...
  const [s, c] = _("accept"), l = zo(), d = zo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = D(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = D(
    () => Ur(t.acceptedText ?? ""),
    ...
    () => Ur(t.mergedText ?? ""),
    [t.mergedText]
  ), y = D(() => Za(t.contents), [t.contents]);
  if (!gi(t))
    return /* @__PURE__ */ a(Kr, { html: y });
  const N = (T) => {
    c(T === "reject" || T === "merge" ? T : "accept");
  }, O = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", B = g ? [
    {
      value: "merge",
  ...
  let C;
  I ? C = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (C = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const P = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: P }), k = (T) => T ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: T }) : U, J = () => {
    const T = o ?? "accept";
    return T === "merged" ? t.mergedText ? /* @__PURE__ */ a(Kr, { html: E }) : U : k(T === "reject" ? t.rejectedResultText : t.resultText);
  }, j = (T) => p && T.value === "reject", Y = (T) => {
    const $ = f === T.value, W = `${d}-${T.value}`, Z = j(T);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          className: v(
            ...
            $ ? "tw:border-border tw:bg-accent/50" : "tw:border-transparent tw:hover:bg-accent/30",
            Z ? "tw:cursor-not-allowed tw:opacity-60" : "tw:cursor-pointer"
          ),
          children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              /* @__PURE__ */ a(
                qr,
                {
                  ...
                  "aria-label": T.label,
                  disabled: Z,
                  "aria-describedby": Z ? l : void 0
                }
              ),
              /* @__PURE__ */ a("span", { "aria-hidden": !0, className: "tw:font-medium", children: T.label })
            ] }),
            Z && // aria-describedby links the option to this visually-hidden notice so assistive tech
            // announces why the choice is read-only.
            /* @__PURE__ */ a("span", { id: l, className: "tw:sr-only", children: O }),
            /* @__PURE__ */ a(Kr, { html: T.html })
          ]
        },
        T.value
      )
  ...
  return (
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", onClick: (T) => T.stopPropagation(), children: [
      ...
      !w && !h && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          Ka,
          {
            ...
            children: z.map((T) => j(T) ? /* @__PURE__ */ a(Pt, { delayDuration: 0, children: /* @__PURE__ */ u(Vt, { children: [
              /* @__PURE__ */ a(jt, { asChild: !0, children: Y(T) }),
              /* @__PURE__ */ a(Lt, { children: O })
            ] }) }, T.value) : Y(T))
          }
        ),
...
function Kd(t) {
  ...
  } = t, c = D(() => e.filter((E) => !E.deleted), [e]), l = D(
    () => c.find((E) => E.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = Ud({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function sp({
  ...
  const [y, N] = _(/* @__PURE__ */ new Set()), [O, B] = _(), [z, I] = _(), A = L(
    async ($) => {
      const W = await i($);
      return W !== void 0 && $.assignedUser !== void 0 && $.assignedUser !== "" && I($.assignedUser), W;
    },
    [i]
  );
  H(() => {
    f && (N(($) => new Set($).add(f)), B(f));
  }, [f]);
  const C = r.filter(
    ($) => $.comments.some((W) => !W.deleted)
  ), P = C.map(($) => ({ id: $.id })), U = L(
    ($) => {
      N((W) => new Set(W).add($.id)), B($.id), b == null || b($.id);
    },
    [b]
  ), k = L(
    ($) => {
    ...
    [y, b]
  ), { listboxRef: J, activeId: j, handleKeyDown: Y } = Fi({
    options: P,
    onOptionSelect: U
  }), T = L(
    ($) => {
      $.key === "Escape" ? (O && y.has(O) && (N((W) => {
        const Z = new Set(W);
        return Z.delete(O), Z;
      }), B(void 0), b == null || b(void 0)), $.preventDefault(), $.stopPropagation()) : Y($);
    },
    [O, y, Y, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Kd, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(vi, { ...W })
          },
          $.id
        );
      })
...
function qd({ table: t }) {
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(hs, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(Pe, { align: "end", className: "tw:w-[150px]", children: [
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Gt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Gt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Cn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ne({
  ...
  return /* @__PURE__ */ u(
    Gt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Gt.ItemIndicator, { children: /* @__PURE__ */ a(aa, { className: "tw:pointer-events-none" }) }) }),
...
function Xd({
  ...
  var z;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [m, E] = _({}), y = D(() => e ?? [], [e]), N = jn({
    data: y,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  let B;
  return l ? B = Array.from({ length: 10 }).map((C, P) => `skeleton-row-${P}`).map((C) => /* @__PURE__ */ a(Te, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    Te,
    {
      onClick: () => s(I, N),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((A) => /* @__PURE__ */ a(rr, { children: xr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    I.id
  )) : B = /* @__PURE__ */ a(Te, { children: /* @__PURE__ */ a(rr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(qd, { table: N }),
    /* @__PURE__ */ u(Ha, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ya, { stickyHeader: i, children: N.getHeaderGroups().map((I) => /* @__PURE__ */ a(Te, { children: I.headers.map((A) => /* @__PURE__ */ a(Gr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : xr(A.column.columnDef.header, A.getContext()) }, A.id)) }, I.id)) }),
      /* @__PURE__ */ a(Wa, { children: B })
    ] }),
...
function pp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "default", children: [
      /* @__PURE__ */ a(bs, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(nr, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Pe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Er, { children: d.label }),
      /* @__PURE__ */ a(un, { children: d.itemType === 0 ? /* @__PURE__ */ a(ct, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ze,
        {
          checked: o[w][h],
      ...
      return /* @__PURE__ */ u(kr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          q,
          {
            ...
            children: /* @__PURE__ */ a(Ja, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function rw({
  ...
  const l = Ga(), d = en(n, "%undoButton_tooltip%"), w = en(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(qa, { children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(
        q,
      ...
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u("p", { children: [
        d,
...
function aw({
  ...
  return H(() => {
    var l;
    const i = Ga(), s = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
const ow = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ct, { children: [
...
function nw({
  ...
  const i = F(null), s = F(null), c = F(!1), [l, d] = _(t), [w, p] = _(r), [h, g] = _(!1);
  H(() => {
    d(t);
  }, [t]), H(() => {
    w !== r && p(r);
  ...
  const f = (m) => {
    ...
    var E, y, N, O;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((O = s.current) == null || O.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Ie, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: ow(t, n, r) }) }) }),
      /* @__PURE__ */ a(Lt, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      Pe,
      {
...
const iw = (t, e) => t === "f" ? /* @__PURE__ */ u(ct, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function cw({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: iw(t, r) }) }) }),
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { children: sw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Pe, { style: { zIndex: pn }, children: [
...
function dw({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Cs, { className: e, size: 16 });
}
function ww({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: t !== "none" && /* @__PURE__ */ a(Se, { size: 16 })
    }
  );
}
function rn({
  ...
  return /* @__PURE__ */ u(
    ke,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(ww, { state: t.selectionState }),
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(dw, { icon: t.icon }) }) }),
...
function mp({
  ...
  Qt(() => {
    if (!g.current) return;
    const { width: V } = g.current.getBoundingClientRect();
    V > 0 && (g.current.style.width = `${V}px`);
  }, []);
  const [f, b] = _("generated"), [m, E] = _("generated"), [y, N] = _("*"), [O, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [P, U] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, K] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Ia ? st = "generated" : it === Aa ? st = "hidden" : it && (N(it), B(it)), b(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), V = setTimeout(() => {
        var ht;
        (ht = w.current) == null || ht.applyUpdate([Q]);
      }, 0);
    }
    return () => {
      V && clearTimeout(V);
  ...
  const ut = L(
    (V, Q, et = !1) => {
      ...
      if (ot && Mr("note", ot)) {
        if (ot.insert.note) {
          let pt;
          V === "custom" ? pt = Q : V === "generated" ? pt = Ia : pt = Aa, ot.insert.note.caller = pt;
        }
        r == null || r([ot]), et && d && i && ((ht = d.current) == null || ht.replaceEmbedUpdate(i, [ot]));
      }
    },
    [i, r, d]
  ), bt = L(() => {
  ...
  const Ft = F({ book: n.book, chapterNum: n.chapterNum });
  Qt(() => {
    (Ft.current.book !== n.book || Ft.current.chapterNum !== n.chapterNum) && (Ft.current = { book: n.book, chapterNum: n.chapterNum }, Ot.current());
  }, [n.book, n.chapterNum]);
  const Jt = () => {
    var Q;
    const V = (Q = p.current) == null ? void 0 : Q.getElementsByClassName("editor-input")[0];
    ...
    if (Q && Mr("note", Q)) {
      Q.insert.note && (Q.insert.note.style = V);
      const pt = (st = (it = Q.insert.note) == null ? void 0 : it.contents) == null ? void 0 : st.ops;
      z !== "x" && V === "x" ? pt == null || pt.forEach((gt) => hw(gt)) : z === "x" && V !== "x" && (pt == null || pt.forEach((gt) => gw(gt))), (ht = w.current) == null || ht.applyUpdate([Q, { delete: 1 }]);
    }
  }, Ct = (V) => {
    wt(V.contextMarker), J(V.canRedo);
  }, Zt = L(
    (V) => {
      var et, ot, it, st, ht;
      const Q = (ot = (et = w.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : ot.at(0);
      if (Q && Mr("note", Q)) {
        V.content.length > 1 && setTimeout(() => {
          var Mt;
          (Mt = w.current) == null || Mt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const pt = (it = Q.insert.note) == null ? void 0 : it.style, gt = (ht = (st = Q.insert.note) == null ? void 0 : st.contents) == null ? void 0 : ht.ops;
        if (pt || C(!1), C(
          pt === "x" ? !!(gt != null && gt.every((Mt) => {
            var Ht, $t;
            if (!((Ht = Mt.attributes) != null && Ht.char)) return !0;
            const zt = (($t = Mt.attributes) == null ? void 0 : $t.char).style;
          ...
          j.current = !0, Y.current = JSON.stringify(Q), U(!0);
          return;
        }
        U(JSON.stringify(Q) === Y.current), ut(f, y);
      } else
        C(!1), U(!0);
    },
    [f, y, ut]
    ...
    if (h.current && ae.length && V && V.rangeCount > 0) {
      const Q = V.getRangeAt(0).getBoundingClientRect(), et = h.current.getBoundingClientRect();
      Z(Q.left - et.left), Tt(Q.top - et.top), K(Q.height), $(!0);
    }
  }, [ae, h]);
  H(() => {
    const V = () => {
    ...
    var V;
    T && ((V = at.current) == null || V.focus());
  }, [T]), H(() => {
    var et;
    const V = ((et = p.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, Q = (ot) => {
      !T && V && document.activeElement === V && ot.key === c ? (ot.preventDefault(), _e()) : T && ot.key === "Escape" && (ot.preventDefault(), $(!1));
    };
  ...
  return /* @__PURE__ */ u(ct, { children: [
    /* @__PURE__ */ u("div", { ref: g, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      /* @__PURE__ */ u("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(qa, { children: [
          /* @__PURE__ */ a(
            rw,
            {
              onUndoClick: () => {
                var V;
                return (V = w.current) == null ? void 0 : V.undo();
              },
              onRedoClick: () => {
                var V;
                return (V = w.current) == null ? void 0 : V.redo();
              },
              canUndo: !P,
              canRedo: k,
              localizedStrings: l
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
              ...
              /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { children: te }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: mw(t.marker, c, o, d) })
      }
    )
  ] });
}
function bp({
  ...
  const w = l ?? Bs(r, void 0), p = (y, N) => {
    d == null || d(y, N, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = _(h), b = (y, N, O) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), d == null || d(N, O, n);
          break;
      }
  }, m = (y) => {
    if (r.length)
  ...
  return H(() => {
    var y;
    g >= 0 && g < E.current.length && ((y = E.current[g]) == null || y.focus());
  }, [g]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function yw({
  ...
  const n = r["%webView_inventory_occurrences_table_header_reference%"], i = r["%webView_inventory_occurrences_table_header_occurrence%"], s = D(() => {
  ...
  return /* @__PURE__ */ u(Ha, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ya, { stickyHeader: !0, children: /* @__PURE__ */ u(Te, { children: [
      /* @__PURE__ */ a(Gr, { children: n }),
      /* @__PURE__ */ a(Gr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(Wa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Te,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ a(rr, { className: o, children: xw(c.text) })
        ]
      },
...
const kw = (t) => {
...
}, na = (t, e, r) => /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
  /* @__PURE__ */ u(
    jt,
    {
  ...
  /* @__PURE__ */ a(Lt, { side: "bottom", children: e })
] }) }), xp = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(dn, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Vr,
          {
            onClick: (l) => {
              l.stopPropagation(), ya(
                [c],
                "approved",
                e,
                r,
  ...
  return e ? e[1] : "";
}, Nw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ep = Object.freeze([
...
function Tp({
  ...
  const g = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), m = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), O = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = le(r, "%webView_inventory_no_results%"), [I, A] = _(!1), [C, P] = _("all"), [U, k] = _(""), [J, j] = _([]), Y = D(() => {
    const K = t ?? [];
    ...
    const K = [];
    return Y.forEach((tt) => {
      const wt = tt.items[0], at = K.find(
        (mt) => mt.items[0] === wt
      );
      at ? (at.count += tt.count, at.occurrences = at.occurrences.concat(tt.occurrences)) : K.push({
        items: [wt],
        count: tt.count,
  ...
  }, [I, Y]), $ = D(() => T.length === 0 ? [] : Cw(T, C, U), [T, C, U]), W = D(() => {
    var wt, at;
    if (!I) return l;
    const K = (wt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : wt.length;
    if (!K) return l;
    const tt = [];
  ...
  H(() => {
    $.length === 0 ? j([]) : $.length === 1 && j($[0].items);
  }, [$]);
  const Z = (K, tt) => {
    tt.setRowSelection(() => {
      const at = {};
      return at[K.index] = !0, at;
    });
    const wt = K.original.items;
    j(wt), h && wt.length > 0 && h(wt[0]);
  }, Dt = (K) => {
    ...
    if (T.length === 0 || J.length === 0) return [];
    const K = T.filter((tt) => Fs(
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
        ...
        /* @__PURE__ */ a(Lt, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const Tw = "16rem", zw = "3rem", yi = Wt.createContext(void 0);
function ia() {
...
function Sw({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    (N) => {
      const O = typeof N == "function" ? N(w) : N;
      r ? r(O) : d(O);
    },
    [r, w]
  ), h = Wt.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", m = pe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = Wt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(yi.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
...
function zp({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = ia();
  return /* @__PURE__ */ u(
    q,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Xs, {}) : /* @__PURE__ */ a(Js, {}),
...
function Aw({
  ...
  const c = t ? Sr.Root : "button", { state: l } = ia(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Iw({ variant: r, size: o }), i),
      ...s
    }
  );
...
function Pw({
  ...
  return /* @__PURE__ */ a(
    Rw,
    {
      ...
      children: /* @__PURE__ */ u(Ow, { children: [
        /* @__PURE__ */ u(an, { children: [
          /* @__PURE__ */ a(on, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(Mw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a($w, { children: /* @__PURE__ */ a(
            Aw,
            {
              onClick: () => d(g),
              isActive: h(g),
        ...
        /* @__PURE__ */ u(an, { children: [
          /* @__PURE__ */ a(on, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(nn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              className: v(
    ...
    /* @__PURE__ */ u(
      Sw,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Dw, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Ce = "scrBook", Vw = "scrRef", qe = "source", jw = "details", Lw = "Scripture Reference", Bw = "Scripture Book", ki = "Type", Fw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Ce,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Lw,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? vt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ce ? ve(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: jw,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Fw,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
const Kw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Oa(t.start, t.end) === 0 ? `${la(t.start)}+${e}` : `${la(t.start)}+${e}-${la(t.end)}+${r}`;
}, sn = (t) => `${Kw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Fp({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Ce, desc: !1 }]), [g, f] = _({}), b = D(
  ...
  H(() => {
    if (c) {
      ...
      if (P.length === 1) {
        const U = b.find((k) => sn(k) === P[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, b, c, E]);
  const y = n ?? Bw, N = i ?? ki, O = [
  ...
  }, I = (C, P) => C.getIsGrouped() ? "" : v("banded-row", P % 2 === 0 ? "even" : "odd"), A = (C, P, U) => {
    if (!((C == null ? void 0 : C.length) === 0 || P.depth < U.column.getGroupedIndex())) {
      if (P.getIsGrouped())
        switch (P.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Gd, { children: O.map((C) => /* @__PURE__ */ a(ne, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Te, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Gr, { colSpan: P.colSpan, className: "tw:sticky top-0", children: P.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Wa, { children: E.getRowModel().rows.map((C, P) => {
        const U = pe();
        return /* @__PURE__ */ a(
          Te,
          {
            ...
            children: C.getVisibleCells().map((k) => {
              if (!(k.getIsPlaceholder() || k.column.columnDef.enableGrouping && !k.getIsGrouped() && (k.column.columnDef.id !== qe || !r)))
                return /* @__PURE__ */ a(
                  rr,
                  {
                    className: v(
                    ...
                    children: k.getIsGrouped() ? /* @__PURE__ */ u(
                      q,
                      {
                        ...
                        type: "button",
                        children: [
                          C.getIsExpanded() && /* @__PURE__ */ a(nr, {}),
                          !C.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ a(Ra, {}) : /* @__PURE__ */ a(Sa, {})),
                          " ",
                          xr(k.column.columnDef.cell, k.getContext()),
                          " (",
                          C.subRows.length,
                          ")"
                        ]
...
const Ni = (t, e, r) => go(t, e).every((o) => r.includes(o));
function qw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [b, m] = _(!1), [E, y] = _(""), N = F(void 0), O = F(!1), B = D(
    () => _i(t),
    [t]
  ), z = D(() => {
    if (!E.trim()) {
    ...
    (k, J = !1) => {
      if (!J || !N.current) {
        r(
          e.includes(k) ? e.filter((Z) => Z !== k) : [...e, k]
        ), N.current = k;
        return;
      }
      const j = B.findIndex((Z) => Z === N.current), Y = B.findIndex((Z) => Z === k);
      if (j === -1 || Y === -1) return;
      const [T, $] = [
        Math.min(j, Y),
        Math.max(j, Y)
      ], W = B.slice(T, $ + 1).map((Z) => Z);
      r(
        e.includes(k) ? e.filter((Z) => !W.includes(Z)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, r, B]
  ), A = (k) => {
    I(k, O.current), O.current = !1;
  }, C = (k, J) => {
    k.preventDefault(), I(J, k.shiftKey);
  }, P = () => {
    r(B.map((k) => k));
  }, U = () => {
    r([]);
      ...
      children: [
        /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
          q,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a(Os, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(Oe, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Me,
          {
            shouldFilter: !1,
            onKeyDown: (k) => {
              k.key === "Enter" && (O.current = k.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                Qr,
              ...
              /* @__PURE__ */ u($e, { children: [
                ...
                Object.values(dt).map((k, J) => {
                  const j = z[k];
                  if (j.length !== 0)
                    return /* @__PURE__ */ u(ra, { children: [
                      /* @__PURE__ */ a(
                        xe,
                        {
                          heading: ln(k, p, h, g, f),
                          children: j.map((Y) => /* @__PURE__ */ a(
                            Fn,
                            {
                              bookId: Y,
                      ...
                      J < Object.values(dt).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, k);
                })
              ] })
            ]
...
function Gw({
  ...
  const i = go(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    q,
    {
      variant: "outline",
...
function Hw({
  ...
  const i = o["%webView_book_selector_more%"], s = D(
    () => _i(t),
    [t]
  ), c = L(
    (l) => {
      const d = go(s, l).map((w) => w);
      r(
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ka ? ka : cn
      ).map((l) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ee(l, n) }, l)),
      e.length > ka && /* @__PURE__ */ a(
        kr,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - cn} ${i}`
        }
      )
    ] })
  ] });
...
function Kp({
  ...
  const O = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = St(s, "%webView_scope_selector_verse%"), z = St(s, "%webView_scope_selector_chapter%"), I = St(s, "%webView_scope_selector_book%"), A = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), C = St(
    s,
    "%webView_scope_selector_current_chapter%"
  ), P = St(s, "%webView_scope_selector_current_book%"), U = St(s, "%webView_scope_selector_choose_books%"), k = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), $ = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Dt = St(s, "%webView_scope_selector_navigate%"), Tt = (M) => {
    if (!f) return;
  ...
  ], K = (M, X, Yt = !1) => /* @__PURE__ */ u(ct, { children: [
    M,
    X && !Yt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), tt = e ? Bt.filter((M) => e.includes(M.value)) : Bt, wt = f ?? da, at = w ?? wt, mt = p ?? wt, ae = () => {
  }, ut = F(null), bt = F(null), Ot = F(!1), Ft = F(null), Jt = F(!1), [fe, R] = _(void 0), yt = F(!1), Ct = F(!1), Zt = F(null), _e = L((M) => {
    if (M) {
      R("start"), yt.current = !1;
      return;
    }
    R((X) => X === "start" ? void 0 : X), yt.current && (yt.current = !1, requestAnimationFrame(() => {
      var Yt;
      const X = (Yt = ut.current) == null ? void 0 : Yt.querySelector("button");
      X == null || X.click();
    }));
  }, []), te = L((M) => {
    if (M) {
    ...
    (M) => {
      h == null || h(M), g == null || g(M), yt.current = !0;
    },
    [h, g]
  ), Q = L(
    (M) => {
      g == null || g(M), Ct.current = !0;
    },
    [g]
  ), et = L(
    (M) => {
    ...
    [r, n, f, i]
  ), ot = tt.find((M) => M.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Us(at, mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ot ? K(ot.label, ot.scrRefSuffix) : t, st = tt.filter(
    (M) => M.value !== "selectedBooks" && M.value !== "range"
  ), ht = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [gt, Mt] = _(!1), [zt, Ht] = _(void 0), [$t, je] = _(void 0), [S, It] = _(void 0), [xt, oe] = _(void 0), [Le, ur] = _([]), pr = d === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Hw,
    {
      availableBookInfo: o,
      selectedBookIds: pr ? Le : n,
      onChangeSelectedBookIds: pr ? ur : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", Be = d === "dropdown" && zt === "range", x = Be ? It : V, rt = Be ? oe : g ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: v(gr && Ze), children: T }),
      /* @__PURE__ */ a(
        ua,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ut, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: v(Rr && Ze), children: $ }),
      /* @__PURE__ */ a(
        ua,
        {
          id: "scope-range-end",
          ...
          localizedStrings: m,
          getEndVerse: E,
          disableReferencesUpTo: Be ? S ?? at : at,
          onOpenChange: te,
          onCloseAutoFocus: (M) => {
            var X;
            Ct.current && (Ct.current = !1, M.preventDefault(), (X = Zt.current) == null || X.focus());
          },
          className: v(Rr && Ze),
          modal: !0,
          align: "start"
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Ut, ce] = _(null), Ue = 200, [Oi, Mi] = _(!1);
  H(() => {
    if (!Ut || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([X]) => {
      Mi(X.contentRect.width < Ue);
    });
    return M.observe(Ut), () => M.disconnect();
  }, [Ut]);
  const fo = L(
    (M) => {
      je(M), It(at), oe(mt), ur(n), Mt(!1), Ht(M);
    },
    [at, mt, n]
  ), mo = L(() => {
    $t !== void 0 && ($t === "range" ? (S && (h == null || h(S)), xt && (g == null || g(xt))) : $t === "selectedBooks" && i(Le), et($t), Ht(void 0), je(void 0));
  }, [
    $t,
    S,
    xt,
    ...
    M || (Ht(void 0), je(void 0));
  }, []), vo = L((M) => {
    var X;
    M.preventDefault(), (X = Fe.current) == null || X.focus();
  }, []), bo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(Nt, { children: k }),
      d === "dropdown" ? /* @__PURE__ */ u(Ie, { open: gt, onOpenChange: Mt, children: [
        /* @__PURE__ */ a(Ae, { asChild: !0, children: /* @__PURE__ */ u(
          q,
          {
            ref: Fe,
            variant: "outline",
        ...
        /* @__PURE__ */ a(
          Pe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(sa, { container: Ut, children: [
              st.map(({ value: M, label: X, dropdownLabel: Yt, scrRefSuffix: fr, id: $i }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: Ne(M),
                  ...
                  children: [
                    t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" }) }),
                    K(Yt ?? X, fr, Oi)
                  ]
                },
                $i
              ...
              b && /* @__PURE__ */ u(ct, { children: [
                ...
                /* @__PURE__ */ a(
                  Ge,
                  {
                    ...
                    onSelect: (M) => {
                      var X, Yt;
                      if (M.preventDefault(), Ot.current) {
                        Ot.current = !1;
                        return;
                      }
                      Jt.current || (Yt = (X = bt.current) == null ? void 0 : X.querySelector("button")) == null || Yt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (M) => {
                          ...
                          X != null && X.closest("button") && (Ot.current = !0, requestAnimationFrame(() => {
                            Ot.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ua,
                          {
                            ...
                            onCloseAutoFocus: (M) => {
                              var X;
                              M.preventDefault(), (X = Ft.current) == null || X.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(ct, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ve(f ?? da, "id") }),
                              /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ka,
        {
          ...
          children: tt.map(({ value: M, label: X, scrRefSuffix: Yt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(qr, { className: "tw:me-2", value: M, id: fr }),
            /* @__PURE__ */ a(Nt, { htmlFor: fr, children: K(X, Yt) })
          ] }, fr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && At,
    d === "dropdown" && ht && /* @__PURE__ */ a(Na, { open: zt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ca,
      {
        ref: ft,
        onCloseAutoFocus: vo,
        onEscapeKeyDown: (M) => {
          _t != null && _t.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(sa, { container: _t, children: [
          /* @__PURE__ */ a(Ea, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ta, { children: U }) }),
          hr,
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Dr(!1), children: Z }),
            /* @__PURE__ */ a(q, { onClick: mo, children: W })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && pt && /* @__PURE__ */ a(Na, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ca,
      {
        ref: kt,
        onCloseAutoFocus: vo,
        onEscapeKeyDown: (M) => {
          Et != null && Et.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(sa, { container: Et, children: [
          /* @__PURE__ */ a(Ea, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ta, { children: Y }) }),
          At,
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Dr(!1), children: Z }),
            /* @__PURE__ */ a(q, { ref: Zt, onClick: mo, children: W })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: Xe },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: l[Co(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ei = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ u(Ji, { children: [
    /* @__PURE__ */ a(Zi, { children: c.label }),
    /* @__PURE__ */ a(Qi, { children: /* @__PURE__ */ a(ts, { children: Ei(
      t,
      e,
      Ci(t, c.id),
      o
  ...
  c.tooltip && /* @__PURE__ */ a(Lt, { children: c.tooltip })
...
function Ba({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    /* @__PURE__ */ a(Ae, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ms, {}) }) }),
    /* @__PURE__ */ a(Pe, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ra, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Pt, { children: Ei(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(Ye, {})
    ] }, l)) })
  ] });
}
const Ti = Wt.forwardRef(
...
function Wp({
  ...
  return /* @__PURE__ */ u(Ti, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Ba,
      {
        onSelectMenuItem: t,
...
const zi = Wt.forwardRef(({ className: t, ...e }, r) => {
  const o = pe();
  return /* @__PURE__ */ a(
    se.Root,
    {
...
const Xw = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Trigger,
  {
    ref: r,
    ...e,
...
)), Ri = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Content,
  {
    ref: r,
    className: v(
...
Ri.displayName = se.Content.displayName;
function Jp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(zi, { children: [
      /* @__PURE__ */ a(Si, { children: t.map((c) => /* @__PURE__ */ a(Xw, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(Ri, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function Jw({
  ...
  return /* @__PURE__ */ a(
    he.Trigger,
    {
      ...
      className: v(
        ...
        Xa({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
  ...
  return /* @__PURE__ */ a(
    he.Item,
    {
      ...
      className: v(
        ...
        // CUSTOM: Apply variant-driven styles from menu context
        Xa({ variant: n.variant, className: t })
      ),
      ...o
    }
  );
...
const vr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Vt, { children: [
      ...
      d.tooltip && /* @__PURE__ */ a(Lt, { children: d.tooltip })
...
function su({
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Jw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Zw, { children: [
      /* @__PURE__ */ a(tu, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        eu,
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(Pt, { children: Di(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function th({
  ...
  const d = cu(
    ...
    var E, y, N, O, B, z;
    const m = b !== f ? ((y = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : y[b]) ?? ((O = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : O.en) : void 0;
  ...
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Nt, { className: "tw:font-normal tw:text-muted-foreground", children: He(d, {
...
function rh({
  ...
  return /* @__PURE__ */ u(Me, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(rs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(as, { children: /* @__PURE__ */ a(Zs, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u($e, { children: [
...
function du({ item: t, createLabel: e, createComplexLabel: r }) {
...
function oh({
  ...
  const c = t ? Eo(r, { key: o }).join("") : "", {
    anchorRect: l,
    message: d,
    confirmingKeyLabel: w,
    showArrow: p
  } = uu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
    ...
    /* @__PURE__ */ u(Vt, { open: t, onOpenChange: () => {
      ...
      /* @__PURE__ */ a(
        Lt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Eo(d, {
            key: /* @__PURE__ */ a(
              za,
              {
                className: v(
            ...
            /* @__PURE__ */ a(ra, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
...
function nh({
  ...
  return /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(Vt, { children: [
    ...
    t && /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { className: "tw:max-w-xs tw:whitespace-pre-line", children: e }) })
  ] }) });
}
function ih({
  cardKey: t,
            ...
            d && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ie, { children: [
                  /* @__PURE__ */ a(Ae, { className: v(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    q,
                    {
                  ...
                  /* @__PURE__ */ a(Pe, { align: "end", children: d })
                ] })
              }
            )
          ] }),
...
function lh({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: s.map((c) => {
    let l = "upcoming";
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(ra, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function _h({
  ...
  return /* @__PURE__ */ u(
    Rt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Rt.ItemIndicator, { children: /* @__PURE__ */ a(aa, {}) }) }),
        e
      ]
    }
  );
  ...
  return /* @__PURE__ */ a(
    sl,
    {
      ...
      icons: {
        ...
        info: /* @__PURE__ */ a(rc, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(ec, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(tc, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(Qs, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function Bh({
  ...
  return /* @__PURE__ */ a(
    se.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", mu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Hh(t) {
  const e = D(() => Ks(t).slice().sort().join(" "), [t]);
  return D(() => e ? e.split(" ") : [], [e]);
}
const xu = () => {
  const [t, e] = _(
...
export {
  ...
  ph as ContextMenu,
  _h as ContextMenuCheckboxItem,
  bh as ContextMenuContent,
  gh as ContextMenuGroup,
  xh as ContextMenuItem,
  Ch as ContextMenuLabel,
  fh as ContextMenuPortal,
  vh as ContextMenuRadioGroup,
  Nh as ContextMenuRadioItem,
  Eh as ContextMenuSeparator,
  Th as ContextMenuShortcut,
  mh as ContextMenuSub,
  kh as ContextMenuSubContent,
  yh as ContextMenuSubTrigger,
  hh as ContextMenuTrigger,
  Xd as DataTable,
  oh as DestructiveKeyConfirmation,
  Na as Dialog,
  Zh as DialogClose,
  Ca as DialogContent,
  Qh as DialogDescription,
  xo as DialogFooter,
  Ea as DialogHeader,
  tg as DialogOverlay,
  eg as DialogPortal,
  Ta as DialogTitle,
  rg as DialogTrigger,
  nh as DisabledActionTooltip,
  pu as DisabledTooltipWrapper,
  zh as Drawer,
  Rh as DrawerClose,
  Dh as DrawerContent,
  ...
  bw as FootnoteItem,
  bp as FootnoteList,
  eh as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  ...
  uw as MarkerMenu,
  hp as MoreInfo,
  qi as MultiSelectComboBox,
  Jp as NavigationContentSearch,
  De as Popover,
  Hi as PopoverAnchor,
  Oe as PopoverContent,
  ng as PopoverDescription,
  ig as PopoverHeader,
  ...
  hg as Z_INDEX_FIRST_RUN,
  pn as Z_INDEX_FOOTNOTE_EDITOR,
  gg as Z_INDEX_MODAL,
  fg as Z_INDEX_MODAL_BACKDROP,
  ...
  ep as getCommentThreadElementId,
  ...
  Kh as useEvent,
  qh as useEventAsync,
  Hh as useExtraValidMarkers,
  Fi as useListbox,
  bu as usePromise,
  Hu as useRecentSearches,
  ia as useSidebar,
  Gh as useStylesheet,
  Yh as useTabIconSelection,
  yg as useTruncationTooltip,
