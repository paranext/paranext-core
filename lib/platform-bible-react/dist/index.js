...
import { X as He, Search as Sn, ChevronsLeft as pn, ChevronsRight as mn, ChevronLeft as Ie, ChevronRight as Pt, ArrowLeft as Er, ArrowRight as Vr, Circle as he, ChevronsUpDown as Ue, Check as Ct, FilterIcon as Mr, ChevronDown as fe, ChevronUp as Dr, ArrowLeftIcon as zr, ChevronLeftIcon as Or, ChevronRightIcon as Ir, ArrowRightIcon as Pr, Copy as Ar, Filter as Br, User as jr, Link as $r, CircleHelp as Lr, Star as Gr, CircleCheckIcon as Fr, CircleXIcon as Xr, CircleHelpIcon as Hr, ArrowUpIcon as Ur, ArrowDownIcon as Yr, ArrowUpDownIcon as qr, PanelLeft as Kr, PanelRight as Jr, ScrollText as Wr, MenuIcon as Zr, Menu as Qr, EllipsisVertical as to, LoaderCircle as eo } from "lucide-react";
...
const bo = mt.Portal, zn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
    className: c(
...
vo.displayName = mt.Content.displayName;
...
yo.displayName = mt.Description.displayName;
...
R(ot, "Original", new ot(ct.Original)), R(ot, "Septuagint", new ot(ct.Septuagint)), R(ot, "Vulgate", new ot(ct.Vulgate)), R(ot, "English", new ot(ct.English)), R(ot, "RussianProtestant", new ot(ct.RussianProtestant)), R(ot, "RussianOrthodox", new ot(ct.RussianOrthodox));
let Tt = ot;
function hn(t, e) {
  const n = e[0];
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = i[0], i.length > 1)
        try {
          const s = +i[1].trim();
          this.versification = new Tt(ct[s]);
        } catch {
...
function bn({
  ...
  if (t)
    return /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: pt(t) }, (s, w) => w + 1).map((s) => /* @__PURE__ */ r(
      Vt,
      {
        value: `${t} ${at[t] || ""} ${s}`,
        onSelect: () => n(s),
      ...
      if ((g === "chapters" || g === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key)) {
        ...
        switch (N.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            ft = K === 0 ? vt : Math.max(1, K - dn);
            break;
          case "ArrowDown":
            ft = K === 0 ? 1 : Math.min(vt, K + dn);
            break;
          default:
            return;
        }
  ...
  return cn(() => {
    const N = setTimeout(() => {
      if (i && g === "books" && V.current && P.current) {
        const O = V.current, H = P.current, Z = H.offsetTop, K = O.clientHeight, vt = H.clientHeight, ft = Z - K / 2 + vt / 2;
        O.scrollTo({
          top: Math.max(0, ft),
          behavior: "smooth"
        }), p(gn(t.book));
        ...
        children: [
          ...
          !_ && /* @__PURE__ */ d(se, { ref: V, children: [
            g === "books" && /* @__PURE__ */ d(Zt, { children: [
              ...
              y && pt(y.book) > 1 && /* @__PURE__ */ d(Zt, { children: [
...
const Bt = G.Root, Yo = G.Group, jt = G.Value, qo = kt(
...
const Nt = m.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, i) => {
...
function oa({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(ye, { stickyHeader: i, children: [
      /* @__PURE__ */ r(Ne, { stickyHeader: i, children: _.getHeaderGroups().map((S) => /* @__PURE__ */ r(Nt, { children: S.headers.map((x) => /* @__PURE__ */ r(ne, { children: x.isPlaceholder ? void 0 : Wt(x.column.columnDef.header, x.getContext()) }, x.id)) }, S.id)) }),
      /* @__PURE__ */ r(ke, { children: (k = _.getRowModel().rows) != null && k.length ? _.getRowModel().rows.map((S) => /* @__PURE__ */ r(
        ...
        S.id
      )) : /* @__PURE__ */ r(Nt, { children: /* @__PURE__ */ r($t, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function ca({
  ...
  return /* @__PURE__ */ d(ye, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ne, { stickyHeader: !0, children: /* @__PURE__ */ d(Nt, { children: [
...
function xi({
  ...
  const l = gt(n, "%webView_inventory_all%"), u = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    ...
    var dt, ht;
    if (!x) return p;
    const T = (dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt.length;
    if (!T) return p;
    const q = [];
    for (let bt = 0; bt < T; bt++)
      q.push(
        ma(
          ((ht = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ht[bt]) || "Additional Item",
          bt + 1
        )
      );
    return [...q, ...p];
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(Bt, { onValueChange: (T) => lt(T), defaultValue: s, children: [
...
const xt = "scrBook", Oa = "scrRef", Rt = "source", Ia = "details", Pa = "Scripture Reference", Aa = "Scripture Book", ir = "Type", Ba = "Details";
function ja(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? D.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === xt ? Jt(a.start) : void 0;
      },
...
function Ni({
  ...
  const [p, l] = I([]), [u, g] = I([{ id: xt, desc: !1 }]), [h, f] = I({}), b = F(
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ne, { children: k.getHeaderGroups().map((C) => /* @__PURE__ */ r(Nt, { children: C.headers.filter((v) => v.column.columnDef.header).map((v) => (
        ...
        /* @__PURE__ */ r(
          "span",
          {
            className: c(
              ...
              {
                "tw-border-s-red-200": It(t) === yt.OT,
                "tw-border-s-purple-200": It(t) === yt.NT,
                "tw-border-s-indigo-200": It(t) === yt.DC,
                "tw-border-s-yellow-200": It(t) === yt.Extra
              }
            ),
  ...
  const P = F(() => D.allBookIds.filter(
    ...
    (v, y = !1) => {
      ...
      const [Ot, Ht] = [
        Math.min(E, J),
        Math.max(E, J)
      ], lt = P.slice(Ot, Ht + 1).map((rt) => rt);
      n(
        e.includes(v) ? e.filter((rt) => !lt.includes(rt)) : [.../* @__PURE__ */ new Set([...e, ...lt])]
      );
    },
    [e, n, P]
  ), nt = L(
              ...
              Object.values(yt).map((v, y) => {
                ...
                if (E.length !== 0)
                  return /* @__PURE__ */ d(_n, { children: [
                    ...
                    y < Object.values(yt).length - 1 && /* @__PURE__ */ r(On, {})
                  ] }, v);
              })
            ] })
          ]
  ...
  return /* @__PURE__ */ d(
    j.SubTrigger,
    {
      ...
      className: c(
        ...
        e && "tw-pl-8",
        _t({ variant: i.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...o,
...
const Ka = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    j.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const vs = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  $.CheckboxItem,
  {
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
